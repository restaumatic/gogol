                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.Get '[Core.JSON] ListPaymentsResponse
...
newAdSenseAccountsPaymentsList parent
  = AdSenseAccountsPaymentsList{xgafv = Core.Nothing,
                                accessToken = Core.Nothing, callback = Core.Nothing,
                                parent = parent, uploadType = Core.Nothing,
                                uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AdSenseAccountsPaymentsList where
        type Rs AdSenseAccountsPaymentsList = ListPaymentsResponse
        type Scopes AdSenseAccountsPaymentsList =
        ...
        requestClient AdSenseAccountsPaymentsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy AdSenseAccountsPaymentsListResource)
                      Core.mempty
