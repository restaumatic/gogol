...
newAdSenseAccountsPolicyIssuesGet name
  = AdSenseAccountsPolicyIssuesGet{xgafv = Core.Nothing,
                                   accessToken = Core.Nothing, callback = Core.Nothing, name = name,
                                   uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AdSenseAccountsPolicyIssuesGet where
        ...
        requestClient AdSenseAccountsPolicyIssuesGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy AdSenseAccountsPolicyIssuesGetResource)
                      Core.mempty
