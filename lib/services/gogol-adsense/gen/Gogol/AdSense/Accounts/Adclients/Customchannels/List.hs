                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] ListCustomChannelsResponse
...
newAdSenseAccountsAdclientsCustomchannelsList parent
  = AdSenseAccountsAdclientsCustomchannelsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           AdSenseAccountsAdclientsCustomchannelsList
         where
        type Rs AdSenseAccountsAdclientsCustomchannelsList =
             ListCustomChannelsResponse
        type Scopes AdSenseAccountsAdclientsCustomchannelsList =
             '[Adsense'FullControl, Adsense'Readonly]
        requestClient AdSenseAccountsAdclientsCustomchannelsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AdSenseAccountsAdclientsCustomchannelsListResource)
                      Core.mempty
