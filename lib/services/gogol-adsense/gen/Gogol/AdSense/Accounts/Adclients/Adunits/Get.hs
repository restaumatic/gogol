...
newAdSenseAccountsAdclientsAdunitsGet name
  = AdSenseAccountsAdclientsAdunitsGet{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       name = name, uploadType = Core.Nothing,
                                       uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AdSenseAccountsAdclientsAdunitsGet
         where
        type Rs AdSenseAccountsAdclientsAdunitsGet = AdUnit
        type Scopes AdSenseAccountsAdclientsAdunitsGet =
