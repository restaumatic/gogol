                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.Get '[Core.JSON] AdUnitAdCode
...
newAdSenseAccountsAdclientsAdunitsGetAdcode name
  = AdSenseAccountsAdclientsAdunitsGetAdcode{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           AdSenseAccountsAdclientsAdunitsGetAdcode
         where
        type Rs AdSenseAccountsAdclientsAdunitsGetAdcode = AdUnitAdCode
        type Scopes AdSenseAccountsAdclientsAdunitsGetAdcode =
             '[Adsense'FullControl, Adsense'Readonly]
        requestClient AdSenseAccountsAdclientsAdunitsGetAdcode{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AdSenseAccountsAdclientsAdunitsGetAdcodeResource)
                      Core.mempty
