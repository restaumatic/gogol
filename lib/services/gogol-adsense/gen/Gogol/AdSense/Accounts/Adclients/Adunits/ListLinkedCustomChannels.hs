...
type AdSenseAccountsAdclientsAdunitsListLinkedCustomChannelsResource
     =
     "v2" Core.:>
       Core.CaptureMode "parent" "listLinkedCustomChannels" Core.Text
         Core.:>
                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.Get '[Core.JSON] ListLinkedCustomChannelsResponse
...
newAdSenseAccountsAdclientsAdunitsListLinkedCustomChannels parent
  = AdSenseAccountsAdclientsAdunitsListLinkedCustomChannels{xgafv =
                                                              Core.Nothing,
...
instance Core.GoogleRequest
           AdSenseAccountsAdclientsAdunitsListLinkedCustomChannels
         where
        type Rs AdSenseAccountsAdclientsAdunitsListLinkedCustomChannels =
             ListLinkedCustomChannelsResponse
        type Scopes AdSenseAccountsAdclientsAdunitsListLinkedCustomChannels
