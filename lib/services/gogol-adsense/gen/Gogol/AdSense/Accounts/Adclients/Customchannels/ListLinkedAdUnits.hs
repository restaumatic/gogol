...
type AdSenseAccountsAdclientsCustomchannelsListLinkedAdUnitsResource
     =
     "v2" Core.:>
       Core.CaptureMode "parent" "listLinkedAdUnits" Core.Text Core.:>
                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.Get '[Core.JSON] ListLinkedAdUnitsResponse
...
newAdSenseAccountsAdclientsCustomchannelsListLinkedAdUnits parent
  = AdSenseAccountsAdclientsCustomchannelsListLinkedAdUnits{xgafv =
                                                              Core.Nothing,
...
instance Core.GoogleRequest
           AdSenseAccountsAdclientsCustomchannelsListLinkedAdUnits
         where
        type Rs AdSenseAccountsAdclientsCustomchannelsListLinkedAdUnits =
             ListLinkedAdUnitsResponse
        type Scopes AdSenseAccountsAdclientsCustomchannelsListLinkedAdUnits
