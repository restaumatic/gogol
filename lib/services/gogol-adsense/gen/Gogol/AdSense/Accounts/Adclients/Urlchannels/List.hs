...
-- |
-- Module      : Gogol.AdSense.Accounts.Adclients.Urlchannels.List
                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] ListUrlChannelsResponse
...
newAdSenseAccountsAdclientsUrlchannelsList parent
  = AdSenseAccountsAdclientsUrlchannelsList{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            pageSize = Core.Nothing, pageToken = Core.Nothing,
                                            parent = parent, uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AdSenseAccountsAdclientsUrlchannelsList
         where
        type Rs AdSenseAccountsAdclientsUrlchannelsList =
             ListUrlChannelsResponse
        type Scopes AdSenseAccountsAdclientsUrlchannelsList =
             '[Adsense'FullControl, Adsense'Readonly]
        requestClient AdSenseAccountsAdclientsUrlchannelsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AdSenseAccountsAdclientsUrlchannelsListResource)
                      Core.mempty
