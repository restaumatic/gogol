                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.Get '[Core.JSON] AdClientAdCode
...
newAdSenseAccountsAdclientsGetAdcode name
  = AdSenseAccountsAdclientsGetAdcode{xgafv = Core.Nothing,
                                      accessToken = Core.Nothing, callback = Core.Nothing,
                                      name = name, uploadType = Core.Nothing,
                                      uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AdSenseAccountsAdclientsGetAdcode where
        type Rs AdSenseAccountsAdclientsGetAdcode = AdClientAdCode
        type Scopes AdSenseAccountsAdclientsGetAdcode =
