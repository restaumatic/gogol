...
newAdSenseAccountsAdclientsList parent
  = AdSenseAccountsAdclientsList{xgafv = Core.Nothing,
                                 accessToken = Core.Nothing, callback = Core.Nothing,
                                 pageSize = Core.Nothing, pageToken = Core.Nothing, parent = parent,
                                 uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AdSenseAccountsAdclientsList where
        type Rs AdSenseAccountsAdclientsList = ListAdClientsResponse
        ...
        requestClient AdSenseAccountsAdclientsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy AdSenseAccountsAdclientsListResource)
                      Core.mempty
