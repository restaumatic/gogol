...
-- |
-- Module      : Gogol.AdSense.Accounts.Adclients.Adunits.List
                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] ListAdUnitsResponse
...
newAdSenseAccountsAdclientsAdunitsList parent
  = AdSenseAccountsAdclientsAdunitsList{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        pageSize = Core.Nothing, pageToken = Core.Nothing,
                                        parent = parent, uploadType = Core.Nothing,
                                        uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AdSenseAccountsAdclientsAdunitsList
         where
        type Rs AdSenseAccountsAdclientsAdunitsList = ListAdUnitsResponse
        type Scopes AdSenseAccountsAdclientsAdunitsList =
        ...
        requestClient AdSenseAccountsAdclientsAdunitsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AdSenseAccountsAdclientsAdunitsListResource)
                      Core.mempty
