...
-- |
-- Module      : Gogol.AdSense.Accounts.Sites.Get
...
newAdSenseAccountsSitesGet name
  = AdSenseAccountsSitesGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest AdSenseAccountsSitesGet where
        ...
        type Scopes AdSenseAccountsSitesGet =
        ...
        requestClient AdSenseAccountsSitesGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy AdSenseAccountsSitesGetResource)
                      Core.mempty
