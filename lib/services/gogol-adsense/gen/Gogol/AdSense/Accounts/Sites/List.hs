                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] ListSitesResponse
...
newAdSenseAccountsSitesList parent
  = AdSenseAccountsSitesList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest AdSenseAccountsSitesList where
        ...
        type Scopes AdSenseAccountsSitesList =
        ...
        requestClient AdSenseAccountsSitesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy AdSenseAccountsSitesListResource)
                      Core.mempty
