                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.Get '[Core.JSON] SavedReport
...
instance Core.GoogleRequest AdSenseAccountsReportsGetSaved where
        ...
        requestClient AdSenseAccountsReportsGetSaved{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy AdSenseAccountsReportsGetSavedResource)
                      Core.mempty
