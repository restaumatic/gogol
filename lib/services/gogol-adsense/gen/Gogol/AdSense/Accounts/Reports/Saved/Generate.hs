             ...
             Core.QueryParam "access_token" Core.Text Core.:>
               Core.QueryParam "callback" Core.Text Core.:>
                 Core.QueryParam "currencyCode" Core.Text Core.:>
                   Core.QueryParam "dateRange" AccountsReportsSavedGenerateDateRange
                     Core.:>
...
newAdSenseAccountsReportsSavedGenerate name
  = AdSenseAccountsReportsSavedGenerate{xgafv = Core.Nothing,
                                        ...
                                        startDateDay = Core.Nothing, startDateMonth = Core.Nothing,
                                        startDateYear = Core.Nothing, uploadType = Core.Nothing,
                                        uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AdSenseAccountsReportsSavedGenerate
         where
        type Rs AdSenseAccountsReportsSavedGenerate = ReportResult
        type Scopes AdSenseAccountsReportsSavedGenerate =
