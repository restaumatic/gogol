...
-- |
-- Module      : Gogol.AdSense.Accounts.Reports.Saved.List
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] ListSavedReportsResponse
...
newAdSenseAccountsReportsSavedList parent
  = AdSenseAccountsReportsSavedList{xgafv = Core.Nothing,
                                    accessToken = Core.Nothing, callback = Core.Nothing,
                                    pageSize = Core.Nothing, pageToken = Core.Nothing,
                                    parent = parent, uploadType = Core.Nothing,
                                    uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AdSenseAccountsReportsSavedList where
        type Rs AdSenseAccountsReportsSavedList = ListSavedReportsResponse
        type Scopes AdSenseAccountsReportsSavedList =
        ...
        requestClient AdSenseAccountsReportsSavedList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy AdSenseAccountsReportsSavedListResource)
                      Core.mempty
