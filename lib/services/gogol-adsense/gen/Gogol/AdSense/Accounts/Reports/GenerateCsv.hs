...
type AdSenseAccountsReportsGenerateCsvResource =
     "v2" Core.:>
       Core.Capture "account" Core.Text Core.:>
         "reports:generateCsv" Core.:>
           Core.QueryParam "$.xgafv" Xgafv Core.:>
             Core.QueryParam "access_token" Core.Text Core.:>
               Core.QueryParam "callback" Core.Text Core.:>
                 Core.QueryParam "currencyCode" Core.Text Core.:>
                   Core.QueryParam "dateRange" AccountsReportsGenerateCsvDateRange
                     Core.:>
                     Core.QueryParams "dimensions" AccountsReportsGenerateCsvDimensions
                       Core.:>
                             ...
                             Core.QueryParams "filters" Core.Text Core.:>
                               Core.QueryParam "languageCode" Core.Text Core.:>
                                 Core.QueryParam "limit" Core.Int32 Core.:>
                                   Core.QueryParams "metrics" AccountsReportsGenerateCsvMetrics
                                     Core.:>
...
newAdSenseAccountsReportsGenerateCsv account
  = AdSenseAccountsReportsGenerateCsv{xgafv = Core.Nothing,
...
instance Core.GoogleRequest AdSenseAccountsReportsGenerateCsv where
        type Rs AdSenseAccountsReportsGenerateCsv = HttpBody
        type Scopes AdSenseAccountsReportsGenerateCsv =
