...
type AdSenseAccountsReportsGenerateResource =
     "v2" Core.:>
       Core.Capture "account" Core.Text Core.:>
         "reports:generate" Core.:>
           Core.QueryParam "$.xgafv" Xgafv Core.:>
             Core.QueryParam "access_token" Core.Text Core.:>
               Core.QueryParam "callback" Core.Text Core.:>
                 Core.QueryParam "currencyCode" Core.Text Core.:>
                   Core.QueryParam "dateRange" AccountsReportsGenerateDateRange
                     Core.:>
                     Core.QueryParams "dimensions" AccountsReportsGenerateDimensions
                       Core.:>
                       Core.QueryParam "endDate.day" Core.Int32 Core.:>
                         Core.QueryParam "endDate.month" Core.Int32 Core.:>
                           Core.QueryParam "endDate.year" Core.Int32 Core.:>
                             Core.QueryParams "filters" Core.Text Core.:>
                               Core.QueryParam "languageCode" Core.Text Core.:>
                                 Core.QueryParam "limit" Core.Int32 Core.:>
                                   Core.QueryParams "metrics" AccountsReportsGenerateMetrics Core.:>
                                     Core.QueryParams "orderBy" Core.Text Core.:>
                                       Core.QueryParam "reportingTimeZone"
                                         AccountsReportsGenerateReportingTimeZone
                                         Core.:>
                                         Core.QueryParam "startDate.day" Core.Int32 Core.:>
                                           Core.QueryParam "startDate.month" Core.Int32 Core.:>
                                             Core.QueryParam "startDate.year" Core.Int32 Core.:>
                                               Core.QueryParam "uploadType" Core.Text Core.:>
                                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                                     Core.Get '[Core.JSON] ReportResult
...
newAdSenseAccountsReportsGenerate account
  = AdSenseAccountsReportsGenerate{xgafv = Core.Nothing,
                                   accessToken = Core.Nothing, account = account,
                                   callback = Core.Nothing, currencyCode = Core.Nothing,
                                   dateRange = Core.Nothing, dimensions = Core.Nothing,
                                   endDateDay = Core.Nothing, endDateMonth = Core.Nothing,
                                   endDateYear = Core.Nothing, filters = Core.Nothing,
                                   languageCode = Core.Nothing, limit = Core.Nothing,
                                   metrics = Core.Nothing, orderBy = Core.Nothing,
                                   reportingTimeZone = Core.Nothing, startDateDay = Core.Nothing,
                                   startDateMonth = Core.Nothing, startDateYear = Core.Nothing,
                                   uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AdSenseAccountsReportsGenerate where
        type Rs AdSenseAccountsReportsGenerate = ReportResult
        type Scopes AdSenseAccountsReportsGenerate =
             '[Adsense'FullControl, Adsense'Readonly]
        requestClient AdSenseAccountsReportsGenerate{..}
          = go account xgafv accessToken callback currencyCode dateRange
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy AdSenseAccountsReportsGenerateResource)
                      Core.mempty
