...
newAdSenseAccountsReportsSavedGenerateCsv name
  = AdSenseAccountsReportsSavedGenerateCsv{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           currencyCode = Core.Nothing, dateRange = Core.Nothing,
                                           endDateDay = Core.Nothing, endDateMonth = Core.Nothing,
                                           endDateYear = Core.Nothing, languageCode = Core.Nothing,
                                           name = name, reportingTimeZone = Core.Nothing,
                                           startDateDay = Core.Nothing,
                                           startDateMonth = Core.Nothing,
                                           startDateYear = Core.Nothing, uploadType = Core.Nothing,
                                           uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AdSenseAccountsReportsSavedGenerateCsv
         where
        type Rs AdSenseAccountsReportsSavedGenerateCsv = HttpBody
        type Scopes AdSenseAccountsReportsSavedGenerateCsv =
             '[Adsense'FullControl, Adsense'Readonly]
        requestClient AdSenseAccountsReportsSavedGenerateCsv{..}
          = go name xgafv accessToken callback currencyCode dateRange
              endDateDay
              endDateMonth
              endDateYear
              languageCode
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AdSenseAccountsReportsSavedGenerateCsvResource)
                      Core.mempty
