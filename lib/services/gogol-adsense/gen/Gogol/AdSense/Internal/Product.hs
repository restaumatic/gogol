...
newAccount 
    ::  Account
newAccount
  = Account{createTime = Core.Nothing, displayName = Core.Nothing,
            name = Core.Nothing, pendingTasks = Core.Nothing,
            premium = Core.Nothing, state = Core.Nothing,
...
newAdBlockingRecoveryTag 
    ::  AdBlockingRecoveryTag
newAdBlockingRecoveryTag
  = AdBlockingRecoveryTag{errorProtectionCode = Core.Nothing,
                          tag = Core.Nothing}
          ...
          = Core.withObject "AdBlockingRecoveryTag"
              (\ o ->
                 AdBlockingRecoveryTag Core.<$>
                   (o Core..:? "errorProtectionCode") Core.<*> (o Core..:? "tag"))

instance Core.ToJSON AdBlockingRecoveryTag where
        toJSON AdBlockingRecoveryTag{..}
          = Core.object
              (Core.catMaybes
                 [("errorProtectionCode" Core..=) Core.<$> errorProtectionCode,
                  ("tag" Core..=) Core.<$> tag])
...
newAdClient 
    ::  AdClient
newAdClient
  = AdClient{name = Core.Nothing, productCode = Core.Nothing,
             reportingDimensionId = Core.Nothing, state = Core.Nothing}
instance Core.FromJSON AdClient where
        parseJSON
          = Core.withObject "AdClient"
              (\ o ->
                 AdClient Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "productCode") Core.<*>
          ...
          = Core.object
              (Core.catMaybes
                 [("name" Core..=) Core.<$> name,
                  ...
                  ("reportingDimensionId" Core..=) Core.<$> reportingDimensionId,
                  ("state" Core..=) Core.<$> state])
...
newAdClientAdCode 
    ::  AdClientAdCode
newAdClientAdCode
  = AdClientAdCode{adCode = Core.Nothing, ampBody = Core.Nothing,
...
instance Core.FromJSON AdClientAdCode where
        parseJSON
          = Core.withObject "AdClientAdCode"
              (\ o ->
                 AdClientAdCode Core.<$>
                   (o Core..:? "adCode") Core.<*> (o Core..:? "ampBody") Core.<*>
                     (o Core..:? "ampHead"))
...
newAdUnit 
    ::  AdUnit
newAdUnit
  = AdUnit{contentAdsSettings = Core.Nothing,
...
instance Core.ToJSON AdUnit where
        toJSON AdUnit{..}
          = Core.object
              (Core.catMaybes
                 [("contentAdsSettings" Core..=) Core.<$> contentAdsSettings,
                  ("displayName" Core..=) Core.<$> displayName,
                  ("name" Core..=) Core.<$> name,
                  ("reportingDimensionId" Core..=) Core.<$> reportingDimensionId,
                  ("state" Core..=) Core.<$> state])
...
instance Core.ToJSON AdUnitAdCode where
        toJSON AdUnitAdCode{..}
          = Core.object (Core.catMaybes [("adCode" Core..=) Core.<$> adCode])
...
newAlert 
    ::  Alert
newAlert
  = Alert{message = Core.Nothing, name = Core.Nothing,
...
instance Core.ToJSON ContentAdsSettings where
        toJSON ContentAdsSettings{..}
          = Core.object
              (Core.catMaybes
                 [("size" Core..=) Core.<$> size, ("type" Core..=) Core.<$> type'])
...
newCustomChannel 
    ::  CustomChannel
newCustomChannel
  = CustomChannel{active = Core.Nothing, displayName = Core.Nothing,
                  name = Core.Nothing, reportingDimensionId = Core.Nothing}
instance Core.FromJSON CustomChannel where
        parseJSON
          = Core.withObject "CustomChannel"
              (\ o ->
                 CustomChannel Core.<$>
                   (o Core..:? "active") Core.<*> (o Core..:? "displayName") Core.<*>
                     (o Core..:? "name")
                     Core.<*> (o Core..:? "reportingDimensionId"))
...
newHeader 
    ::  Header
newHeader
  = Header{currencyCode = Core.Nothing, name = Core.Nothing,
           type' = Core.Nothing}
instance Core.FromJSON Header where
        parseJSON
          = Core.withObject "Header"
              (\ o ->
                 Header Core.<$>
                   (o Core..:? "currencyCode") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "type"))
...
newListAdClientsResponse 
    ::  ListAdClientsResponse
newListAdClientsResponse
  = ListAdClientsResponse{adClients = Core.Nothing,
                          nextPageToken = Core.Nothing}
          ...
          = Core.withObject "ListAdClientsResponse"
              (\ o ->
                 ListAdClientsResponse Core.<$>
                   (o Core..:? "adClients") Core.<*> (o Core..:? "nextPageToken"))
...
newListAdUnitsResponse 
    ::  ListAdUnitsResponse
newListAdUnitsResponse
  = ListAdUnitsResponse{adUnits = Core.Nothing,
                        nextPageToken = Core.Nothing}
          ...
          = Core.withObject "ListAdUnitsResponse"
              (\ o ->
                 ListAdUnitsResponse Core.<$>
                   (o Core..:? "adUnits") Core.<*> (o Core..:? "nextPageToken"))
...
instance Core.FromJSON ListAlertsResponse where
        parseJSON
          = Core.withObject "ListAlertsResponse"
              (\ o -> ListAlertsResponse Core.<$> (o Core..:? "alerts"))

instance Core.ToJSON ListAlertsResponse where
        toJSON ListAlertsResponse{..}
          = Core.object (Core.catMaybes [("alerts" Core..=) Core.<$> alerts])
...
newListChildAccountsResponse 
    ::  ListChildAccountsResponse
newListChildAccountsResponse
  = ListChildAccountsResponse{accounts = Core.Nothing,
                              nextPageToken = Core.Nothing}
...
newListCustomChannelsResponse 
    ::  ListCustomChannelsResponse
newListCustomChannelsResponse
  = ListCustomChannelsResponse{customChannels = Core.Nothing,
                               nextPageToken = Core.Nothing}
...
newListLinkedAdUnitsResponse 
    ::  ListLinkedAdUnitsResponse
newListLinkedAdUnitsResponse
  = ListLinkedAdUnitsResponse{adUnits = Core.Nothing,
                              nextPageToken = Core.Nothing}
...
newListLinkedCustomChannelsResponse 
    :: 
                                    ListLinkedCustomChannelsResponse
newListLinkedCustomChannelsResponse
  = ListLinkedCustomChannelsResponse{customChannels = Core.Nothing,
                                     nextPageToken = Core.Nothing}
instance Core.FromJSON ListLinkedCustomChannelsResponse where
        parseJSON
...
--
-- /See:/ 'newListPolicyIssuesResponse' smart constructor.
data ListPolicyIssuesResponse = ListPolicyIssuesResponse
    {
    ...
    , policyIssues :: (Core.Maybe [PolicyIssue])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'ListPolicyIssuesResponse' with the minimum fields required to make a request.
newListPolicyIssuesResponse 
    ::  ListPolicyIssuesResponse
newListPolicyIssuesResponse
  = ListPolicyIssuesResponse{nextPageToken = Core.Nothing,
                             policyIssues = Core.Nothing}
instance Core.FromJSON ListPolicyIssuesResponse where
        parseJSON
          = Core.withObject "ListPolicyIssuesResponse"
              (\ o ->
                 ListPolicyIssuesResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "policyIssues"))

instance Core.ToJSON ListPolicyIssuesResponse where
        toJSON ListPolicyIssuesResponse{..}
          = Core.object
              (Core.catMaybes
                 [("nextPageToken" Core..=) Core.<$> nextPageToken,
                  ("policyIssues" Core..=) Core.<$> policyIssues])
...
newListSavedReportsResponse 
    ::  ListSavedReportsResponse
newListSavedReportsResponse
  = ListSavedReportsResponse{nextPageToken = Core.Nothing,
          ...
          = Core.withObject "ListSavedReportsResponse"
              (\ o ->
                 ListSavedReportsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "savedReports"))
...
newListSitesResponse 
    ::  ListSitesResponse
newListSitesResponse
  = ListSitesResponse{nextPageToken = Core.Nothing,
                      sites = Core.Nothing}
          ...
          = Core.withObject "ListSitesResponse"
              (\ o ->
                 ListSitesResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "sites"))
...
newListUrlChannelsResponse 
    ::  ListUrlChannelsResponse
newListUrlChannelsResponse
  = ListUrlChannelsResponse{nextPageToken = Core.Nothing,
          ...
          = Core.withObject "ListUrlChannelsResponse"
              (\ o ->
                 ListUrlChannelsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "urlChannels"))
...
newPayment 
    ::  Payment
newPayment
  = Payment{amount = Core.Nothing, date = Core.Nothing,
            name = Core.Nothing}
instance Core.FromJSON Payment where
        parseJSON
          = Core.withObject "Payment"
              (\ o ->
                 Payment Core.<$>
                   (o Core..:? "amount") Core.<*> (o Core..:? "date") Core.<*>
                     (o Core..:? "name"))
          ...
          = Core.object
              (Core.catMaybes
                 [("amount" Core..=) Core.<$> amount,
                  ("date" Core..=) Core.<$> date, ("name" Core..=) Core.<$> name])
...
--
-- /See:/ 'newPolicyIssue' smart constructor.
data PolicyIssue = PolicyIssue
    {
      -- | Required. The most severe action taken on the entity over the past seven days.
      action :: (Core.Maybe PolicyIssue_Action)
    ...
    , policyTopics :: (Core.Maybe [PolicyTopic])
    ...
    , siteSection :: (Core.Maybe Core.Text)
    ...
    , warningEscalationDate :: (Core.Maybe Date)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'PolicyIssue' with the minimum fields required to make a request.
newPolicyIssue 
    ::  PolicyIssue
newPolicyIssue
  = PolicyIssue{action = Core.Nothing, adClients = Core.Nothing,
                adRequestCount = Core.Nothing, entityType = Core.Nothing,
                firstDetectedDate = Core.Nothing, lastDetectedDate = Core.Nothing,
                name = Core.Nothing, policyTopics = Core.Nothing,
                site = Core.Nothing, siteSection = Core.Nothing,
                uri = Core.Nothing, warningEscalationDate = Core.Nothing}
instance Core.FromJSON PolicyIssue where
        parseJSON
          = Core.withObject "PolicyIssue"
              (\ o ->
                 PolicyIssue Core.<$>
                   (o Core..:? "action") Core.<*> (o Core..:? "adClients") Core.<*>
                     (o Core..:? "adRequestCount" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "entityType")
                     Core.<*> (o Core..:? "firstDetectedDate")
                     Core.<*> (o Core..:? "lastDetectedDate")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "policyTopics")
                     Core.<*> (o Core..:? "site")
                     Core.<*> (o Core..:? "siteSection")
                     Core.<*> (o Core..:? "uri")
                     Core.<*> (o Core..:? "warningEscalationDate"))

instance Core.ToJSON PolicyIssue where
        toJSON PolicyIssue{..}
          = Core.object
              (Core.catMaybes
                 [("action" Core..=) Core.<$> action,
                  ("adClients" Core..=) Core.<$> adClients,
                  ("adRequestCount" Core..=) Core.. Core.AsText Core.<$>
                    adRequestCount,
                  ("entityType" Core..=) Core.<$> entityType,
                  ("firstDetectedDate" Core..=) Core.<$> firstDetectedDate,
                  ("lastDetectedDate" Core..=) Core.<$> lastDetectedDate,
                  ("name" Core..=) Core.<$> name,
                  ("policyTopics" Core..=) Core.<$> policyTopics,
                  ("site" Core..=) Core.<$> site,
                  ("siteSection" Core..=) Core.<$> siteSection,
                  ("uri" Core..=) Core.<$> uri,
                  ("warningEscalationDate" Core..=) Core.<$> warningEscalationDate])
...
-- | Creates a value of 'PolicyTopic' with the minimum fields required to make a request.
newPolicyTopic 
    ::  PolicyTopic
newPolicyTopic
...
instance Core.FromJSON PolicyTopic where
        parseJSON
          = Core.withObject "PolicyTopic"
              (\ o ->
                 PolicyTopic Core.<$>
                   (o Core..:? "mustFix") Core.<*> (o Core..:? "topic") Core.<*>
                     (o Core..:? "type"))
          ...
          = Core.object
              (Core.catMaybes
                 [("mustFix" Core..=) Core.<$> mustFix,
                  ("topic" Core..=) Core.<$> topic, ("type" Core..=) Core.<$> type'])
...
newReportResult 
    ::  ReportResult
newReportResult
  = ReportResult{averages = Core.Nothing, endDate = Core.Nothing,
                 headers = Core.Nothing, rows = Core.Nothing,
                 startDate = Core.Nothing, totalMatchedRows = Core.Nothing,
                 totals = Core.Nothing, warnings = Core.Nothing}
instance Core.FromJSON ReportResult where
        parseJSON
          = Core.withObject "ReportResult"
              (\ o ->
                 ReportResult Core.<$>
                   (o Core..:? "averages") Core.<*> (o Core..:? "endDate") Core.<*>
                     (o Core..:? "headers")
                     Core.<*> (o Core..:? "rows")
                     Core.<*> (o Core..:? "startDate")
                     Core.<*>
                     (o Core..:? "totalMatchedRows" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "totals")
          ...
          = Core.object
              (Core.catMaybes
                 [("averages" Core..=) Core.<$> averages,
                  ...
                  ("totalMatchedRows" Core..=) Core.. Core.AsText Core.<$>
                    totalMatchedRows,
...
newSavedReport 
    ::  SavedReport
newSavedReport
  = SavedReport{name = Core.Nothing, title = Core.Nothing}
...
newSite 
    ::  Site
newSite
  = Site{autoAdsEnabled = Core.Nothing, domain = Core.Nothing,
         name = Core.Nothing, reportingDimensionId = Core.Nothing,
         state = Core.Nothing}
instance Core.FromJSON Site where
        parseJSON
          = Core.withObject "Site"
              (\ o ->
                 Site Core.<$>
                   (o Core..:? "autoAdsEnabled") Core.<*> (o Core..:? "domain")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "reportingDimensionId")
                     Core.<*> (o Core..:? "state"))
...
newUrlChannel 
    ::  UrlChannel
newUrlChannel
  = UrlChannel{name = Core.Nothing,
               reportingDimensionId = Core.Nothing, uriPattern = Core.Nothing}
instance Core.FromJSON UrlChannel where
        parseJSON
          = Core.withObject "UrlChannel"
              (\ o ->
                 UrlChannel Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "reportingDimensionId")
