...
newAccount 
    ::  Account
newAccount
  = Account{id = Core.Nothing, kind = "adexchangeseller#account",
            name = Core.Nothing}
        ...
        parseJSON
          = Core.withObject "Account"
              (\ o ->
                 Account Core.<$>
                   (o Core..:? "id") Core.<*>
                     (o Core..:? "kind" Core..!= "adexchangeseller#account")
                     Core.<*> (o Core..:? "name"))
...
newAccounts
  = Accounts{etag = Core.Nothing, items = Core.Nothing,
             kind = "adexchangeseller#accounts", nextPageToken = Core.Nothing}
              ...
              (\ o ->
                 Accounts Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "items") Core.<*>
                     (o Core..:? "kind" Core..!= "adexchangeseller#accounts")
...
newAdClient
  = AdClient{arcOptIn = Core.Nothing, id = Core.Nothing,
             kind = "adexchangeseller#adClient", productCode = Core.Nothing,
              ...
              (\ o ->
                 AdClient Core.<$>
                   (o Core..:? "arcOptIn") Core.<*> (o Core..:? "id") Core.<*>
                     (o Core..:? "kind" Core..!= "adexchangeseller#adClient")
...
newAdClients
  = AdClients{etag = Core.Nothing, items = Core.Nothing,
              kind = "adexchangeseller#adClients", nextPageToken = Core.Nothing}
        ...
        parseJSON
          = Core.withObject "AdClients"
              (\ o ->
                 AdClients Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "items") Core.<*>
                     (o Core..:? "kind" Core..!= "adexchangeseller#adClients")
                     Core.<*> (o Core..:? "nextPageToken"))
...
newAlert 
    ::  Alert
newAlert
  = Alert{id = Core.Nothing, kind = "adexchangeseller#alert",
        ...
        parseJSON
          = Core.withObject "Alert"
              (\ o ->
                 Alert Core.<$>
                   (o Core..:? "id") Core.<*>
                     (o Core..:? "kind" Core..!= "adexchangeseller#alert")
                     Core.<*> (o Core..:? "message")
...
instance Core.FromJSON Alerts where
        parseJSON
          = Core.withObject "Alerts"
              (\ o ->
                 Alerts Core.<$>
                   (o Core..:? "items") Core.<*>
                     (o Core..:? "kind" Core..!= "adexchangeseller#alerts"))
...
newCustomChannel
  = CustomChannel{code = Core.Nothing, id = Core.Nothing,
                  kind = "adexchangeseller#customChannel", name = Core.Nothing,
              ...
              (\ o ->
                 CustomChannel Core.<$>
                   (o Core..:? "code") Core.<*> (o Core..:? "id") Core.<*>
                     (o Core..:? "kind" Core..!= "adexchangeseller#customChannel")
                     Core.<*> (o Core..:? "name")
...
newCustomChannel_TargetingInfo 
    ::  CustomChannel_TargetingInfo
newCustomChannel_TargetingInfo
  = CustomChannel_TargetingInfo{adsAppearOn = Core.Nothing,
                                description = Core.Nothing, location = Core.Nothing,
                                siteLanguage = Core.Nothing}
instance Core.FromJSON CustomChannel_TargetingInfo where
        parseJSON
          = Core.withObject "CustomChannel_TargetingInfo"
              (\ o ->
                 CustomChannel_TargetingInfo Core.<$>
                   (o Core..:? "adsAppearOn") Core.<*> (o Core..:? "description")
        ...
        parseJSON
          = Core.withObject "CustomChannels"
              (\ o ->
                 CustomChannels Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "items") Core.<*>
                     (o Core..:? "kind" Core..!= "adexchangeseller#customChannels")
                     Core.<*> (o Core..:? "nextPageToken"))
        ...
        parseJSON
          = Core.withObject "Metadata"
              (\ o ->
                 Metadata Core.<$>
                   (o Core..:? "items") Core.<*>
                     (o Core..:? "kind" Core..!= "adexchangeseller#metadata"))
...
newPreferredDeal 
    ::  PreferredDeal
newPreferredDeal
  = PreferredDeal{advertiserName = Core.Nothing,
                  buyerNetworkName = Core.Nothing, currencyCode = Core.Nothing,
                  endTime = Core.Nothing, fixedCpm = Core.Nothing, id = Core.Nothing,
                  kind = "adexchangeseller#preferredDeal", startTime = Core.Nothing}
instance Core.FromJSON PreferredDeal where
        parseJSON
          = Core.withObject "PreferredDeal"
              (\ o ->
                 PreferredDeal Core.<$>
                   (o Core..:? "advertiserName") Core.<*>
                     (o Core..:? "buyerNetworkName")
                     ...
                     Core.<*>
                     (o Core..:? "kind" Core..!= "adexchangeseller#preferredDeal")
                     Core.<*>
...
newPreferredDeals 
    ::  PreferredDeals
newPreferredDeals
  = PreferredDeals{items = Core.Nothing,
                   kind = "adexchangeseller#preferredDeals"}
instance Core.FromJSON PreferredDeals where
        parseJSON
          = Core.withObject "PreferredDeals"
              (\ o ->
                 PreferredDeals Core.<$>
                   (o Core..:? "items") Core.<*>
                     (o Core..:? "kind" Core..!= "adexchangeseller#preferredDeals"))
...
newReport
  = Report{averages = Core.Nothing, headers = Core.Nothing,
           kind = "adexchangeseller#report", rows = Core.Nothing,
              ...
              (\ o ->
                 Report Core.<$>
                   (o Core..:? "averages") Core.<*> (o Core..:? "headers") Core.<*>
                     (o Core..:? "kind" Core..!= "adexchangeseller#report")
                     Core.<*> (o Core..:? "rows")
                     Core.<*>
...
newReportingMetadataEntry 
    ::  ReportingMetadataEntry
newReportingMetadataEntry
  = ReportingMetadataEntry{compatibleDimensions = Core.Nothing,
                           compatibleMetrics = Core.Nothing, id = Core.Nothing,
                           kind = "adexchangeseller#reportingMetadataEntry",
                           requiredDimensions = Core.Nothing, requiredMetrics = Core.Nothing,
                           supportedProducts = Core.Nothing}
instance Core.FromJSON ReportingMetadataEntry where
        parseJSON
          = Core.withObject "ReportingMetadataEntry"
              (\ o ->
                 ReportingMetadataEntry Core.<$>
                   (o Core..:? "compatibleDimensions") Core.<*>
                     (o Core..:? "compatibleMetrics")
                     Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "kind" Core..!=
...
newSavedReport 
    ::  SavedReport
newSavedReport
  = SavedReport{id = Core.Nothing,
                kind = "adexchangeseller#savedReport", name = Core.Nothing}
        ...
        parseJSON
          = Core.withObject "SavedReport"
              (\ o ->
                 SavedReport Core.<$>
                   (o Core..:? "id") Core.<*>
                     (o Core..:? "kind" Core..!= "adexchangeseller#savedReport")
                     Core.<*> (o Core..:? "name"))
...
newSavedReports 
    ::  SavedReports
newSavedReports
  = SavedReports{etag = Core.Nothing, items = Core.Nothing,
                 kind = "adexchangeseller#savedReports",
                 nextPageToken = Core.Nothing}
instance Core.FromJSON SavedReports where
        parseJSON
          = Core.withObject "SavedReports"
              (\ o ->
                 SavedReports Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "items") Core.<*>
                     (o Core..:? "kind" Core..!= "adexchangeseller#savedReports")
                     Core.<*> (o Core..:? "nextPageToken"))
...
newUrlChannel 
    ::  UrlChannel
newUrlChannel
  = UrlChannel{id = Core.Nothing,
               kind = "adexchangeseller#urlChannel", urlPattern = Core.Nothing}
        ...
        parseJSON
          = Core.withObject "UrlChannel"
              (\ o ->
                 UrlChannel Core.<$>
                   (o Core..:? "id") Core.<*>
                     (o Core..:? "kind" Core..!= "adexchangeseller#urlChannel")
        ...
        parseJSON
          = Core.withObject "UrlChannels"
              (\ o ->
                 UrlChannels Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "items") Core.<*>
                     (o Core..:? "kind" Core..!= "adexchangeseller#urlChannels")
                     Core.<*> (o Core..:? "nextPageToken"))
