...
newAdExchangeSellerAccountsUrlchannelsList accountId adClientId
  = AdExchangeSellerAccountsUrlchannelsList{accountId = accountId,
                                            adClientId = adClientId, maxResults = Core.Nothing,
                                            pageToken = Core.Nothing}
instance Core.GoogleRequest AdExchangeSellerAccountsUrlchannelsList
         where
        type Rs AdExchangeSellerAccountsUrlchannelsList = UrlChannels
        type Scopes AdExchangeSellerAccountsUrlchannelsList =
