...
newAdExchangeSellerAccountsAdclientsList accountId
  = AdExchangeSellerAccountsAdclientsList{accountId = accountId,
                                          maxResults = Core.Nothing, pageToken = Core.Nothing}
instance Core.GoogleRequest AdExchangeSellerAccountsAdclientsList
         where
        ...
        requestClient AdExchangeSellerAccountsAdclientsList{..}
          = go accountId maxResults pageToken (Core.Just Core.AltJSON)
