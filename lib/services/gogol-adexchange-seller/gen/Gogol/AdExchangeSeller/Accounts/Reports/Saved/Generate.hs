       ...
       "v2.0" Core.:>
         "accounts" Core.:>
           Core.Capture "accountId" Core.Text Core.:>
             "reports" Core.:>
               Core.Capture "savedReportId" Core.Text Core.:>
...
newAdExchangeSellerAccountsReportsSavedGenerate 
    ...
    -> AdExchangeSellerAccountsReportsSavedGenerate
newAdExchangeSellerAccountsReportsSavedGenerate accountId
  savedReportId
  = AdExchangeSellerAccountsReportsSavedGenerate{accountId =
                                                   accountId,
...
instance Core.GoogleRequest
        ...
        type Scopes AdExchangeSellerAccountsReportsSavedGenerate =
             '[Adexchange'Seller, Adexchange'Seller'Readonly]
        requestClient AdExchangeSellerAccountsReportsSavedGenerate{..}
          = go accountId savedReportId locale maxResults startIndex
