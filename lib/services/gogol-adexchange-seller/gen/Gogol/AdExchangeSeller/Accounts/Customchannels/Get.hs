...
newAdExchangeSellerAccountsCustomchannelsGet 
    ...
    -> AdExchangeSellerAccountsCustomchannelsGet
newAdExchangeSellerAccountsCustomchannelsGet accountId adClientId
  customChannelId
  = AdExchangeSellerAccountsCustomchannelsGet{accountId = accountId,
...
instance Core.GoogleRequest
        ...
        requestClient AdExchangeSellerAccountsCustomchannelsGet{..}
          = go accountId adClientId customChannelId (Core.Just Core.AltJSON)
