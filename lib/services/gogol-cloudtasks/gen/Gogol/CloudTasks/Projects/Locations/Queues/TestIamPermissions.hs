...
newCloudTasksProjectsLocationsQueuesTestIamPermissions 
    ...
    -> CloudTasksProjectsLocationsQueuesTestIamPermissions
newCloudTasksProjectsLocationsQueuesTestIamPermissions payload
  resource
  = CloudTasksProjectsLocationsQueuesTestIamPermissions{xgafv =
                                                          Core.Nothing,
...
instance Core.GoogleRequest
           CloudTasksProjectsLocationsQueuesTestIamPermissions
         where
        type Rs CloudTasksProjectsLocationsQueuesTestIamPermissions =
             TestIamPermissionsResponse
        type Scopes CloudTasksProjectsLocationsQueuesTestIamPermissions =
