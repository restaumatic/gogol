                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] CmekConfig Core.:>
                         Core.Patch '[Core.JSON] CmekConfig
...
newCloudTasksProjectsLocationsUpdateCmekConfig name payload
  = CloudTasksProjectsLocationsUpdateCmekConfig{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes CloudTasksProjectsLocationsUpdateCmekConfig =
