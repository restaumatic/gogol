...
newCloudTasksProjectsLocationsQueuesTasksList parent
  = CloudTasksProjectsLocationsQueuesTasksList{xgafv = Core.Nothing,
                                               accessToken = Core.Nothing, callback = Core.Nothing,
                                               pageSize = Core.Nothing, pageToken = Core.Nothing,
                                               parent = parent, responseView = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Rs CloudTasksProjectsLocationsQueuesTasksList =
             ListTasksResponse
        type Scopes CloudTasksProjectsLocationsQueuesTasksList =
