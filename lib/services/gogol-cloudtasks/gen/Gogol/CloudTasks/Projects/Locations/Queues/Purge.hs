...
type CloudTasksProjectsLocationsQueuesPurgeResource =
     "v2" Core.:>
       Core.CaptureMode "name" "purge" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] PurgeQueueRequest Core.:>
...
newCloudTasksProjectsLocationsQueuesPurge name payload
  = CloudTasksProjectsLocationsQueuesPurge{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           name = name, payload = payload,
                                           uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudTasksProjectsLocationsQueuesPurge
         where
        type Rs CloudTasksProjectsLocationsQueuesPurge = Queue
        type Scopes CloudTasksProjectsLocationsQueuesPurge =
