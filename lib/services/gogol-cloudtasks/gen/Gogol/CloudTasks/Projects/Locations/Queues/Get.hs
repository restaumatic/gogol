...
newCloudTasksProjectsLocationsQueuesGet name
  = CloudTasksProjectsLocationsQueuesGet{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         name = name, uploadType = Core.Nothing,
                                         uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudTasksProjectsLocationsQueuesGet
         where
        type Rs CloudTasksProjectsLocationsQueuesGet = Queue
        type Scopes CloudTasksProjectsLocationsQueuesGet =
