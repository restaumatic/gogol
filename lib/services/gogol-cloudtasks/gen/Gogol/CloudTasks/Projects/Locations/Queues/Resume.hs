               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] ResumeQueueRequest Core.:>
...
newCloudTasksProjectsLocationsQueuesResume name payload
  = CloudTasksProjectsLocationsQueuesResume{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            name = name, payload = payload,
                                            uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudTasksProjectsLocationsQueuesResume
         where
        type Rs CloudTasksProjectsLocationsQueuesResume = Queue
        type Scopes CloudTasksProjectsLocationsQueuesResume =
