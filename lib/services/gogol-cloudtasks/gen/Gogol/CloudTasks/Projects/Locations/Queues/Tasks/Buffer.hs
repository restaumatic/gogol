...
newCloudTasksProjectsLocationsQueuesTasksBuffer 
    ...
    -> CloudTasksProjectsLocationsQueuesTasksBuffer
newCloudTasksProjectsLocationsQueuesTasksBuffer payload queue
  taskId
  = CloudTasksProjectsLocationsQueuesTasksBuffer{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Rs CloudTasksProjectsLocationsQueuesTasksBuffer =
             BufferTaskResponse
        type Scopes CloudTasksProjectsLocationsQueuesTasksBuffer =
             '[CloudPlatform'FullControl]
        requestClient CloudTasksProjectsLocationsQueuesTasksBuffer{..}
          = go queue taskId xgafv accessToken callback uploadType
              uploadProtocol
