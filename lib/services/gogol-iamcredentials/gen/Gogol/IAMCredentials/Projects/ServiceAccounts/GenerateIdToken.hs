...
type IAMCredentialsProjectsServiceAccountsGenerateIdTokenResource =
     "v1" Core.:>
       Core.CaptureMode "name" "generateIdToken" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] GenerateIdTokenRequest Core.:>
...
newIAMCredentialsProjectsServiceAccountsGenerateIdToken 
    ...
    -> IAMCredentialsProjectsServiceAccountsGenerateIdToken
newIAMCredentialsProjectsServiceAccountsGenerateIdToken name
  payload
  = IAMCredentialsProjectsServiceAccountsGenerateIdToken{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           IAMCredentialsProjectsServiceAccountsGenerateIdToken
         where
        type Rs IAMCredentialsProjectsServiceAccountsGenerateIdToken =
             GenerateIdTokenResponse
        type Scopes IAMCredentialsProjectsServiceAccountsGenerateIdToken =
