...
newIAMCredentialsProjectsServiceAccountsSignJwt name payload
  = IAMCredentialsProjectsServiceAccountsSignJwt{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Rs IAMCredentialsProjectsServiceAccountsSignJwt =
             SignJwtResponse
        type Scopes IAMCredentialsProjectsServiceAccountsSignJwt =
             '[CloudPlatform'FullControl]
        requestClient IAMCredentialsProjectsServiceAccountsSignJwt{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy IAMCredentialsProjectsServiceAccountsSignJwtResource)
                      Core.mempty
