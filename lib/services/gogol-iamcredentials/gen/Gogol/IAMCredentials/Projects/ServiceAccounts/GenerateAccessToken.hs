...
type IAMCredentialsProjectsServiceAccountsGenerateAccessTokenResource
     =
     "v1" Core.:>
       Core.CaptureMode "name" "generateAccessToken" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] GenerateAccessTokenRequest Core.:>
                       Core.Post '[Core.JSON] GenerateAccessTokenResponse
...
newIAMCredentialsProjectsServiceAccountsGenerateAccessToken 
    ...
    -> IAMCredentialsProjectsServiceAccountsGenerateAccessToken
newIAMCredentialsProjectsServiceAccountsGenerateAccessToken name
  payload
  = IAMCredentialsProjectsServiceAccountsGenerateAccessToken{xgafv =
                                                               Core.Nothing,
...
instance Core.GoogleRequest
           IAMCredentialsProjectsServiceAccountsGenerateAccessToken
         where
        type Rs IAMCredentialsProjectsServiceAccountsGenerateAccessToken =
