                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.Get '[Core.JSON] ServiceAccountAllowedLocations
...
newIAMCredentialsProjectsServiceAccountsGetAllowedLocations name
  = IAMCredentialsProjectsServiceAccountsGetAllowedLocations{xgafv =
                                                               Core.Nothing,
...
instance Core.GoogleRequest
           IAMCredentialsProjectsServiceAccountsGetAllowedLocations
         where
        type Rs IAMCredentialsProjectsServiceAccountsGetAllowedLocations =
