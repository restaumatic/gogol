...
module Gogol.IAMCredentials.Internal.Product
  (
    ...
    WorkforcePoolAllowedLocations (..),
    newWorkforcePoolAllowedLocations,

    -- * WorkloadIdentityPoolAllowedLocations
    WorkloadIdentityPoolAllowedLocations (..),
    newWorkloadIdentityPoolAllowedLocations,
  ) where
...
newGenerateAccessTokenRequest 
    ::  GenerateAccessTokenRequest
newGenerateAccessTokenRequest
  = GenerateAccessTokenRequest{delegates = Core.Nothing,
                               lifetime = Core.Nothing, scope = Core.Nothing}
instance Core.FromJSON GenerateAccessTokenRequest where
        parseJSON
          = Core.withObject "GenerateAccessTokenRequest"
              (\ o ->
                 GenerateAccessTokenRequest Core.<$>
                   (o Core..:? "delegates") Core.<*> (o Core..:? "lifetime") Core.<*>
                     (o Core..:? "scope"))
...
newGenerateAccessTokenResponse 
    ::  GenerateAccessTokenResponse
newGenerateAccessTokenResponse
  = GenerateAccessTokenResponse{accessToken = Core.Nothing,
                                expireTime = Core.Nothing}
instance Core.FromJSON GenerateAccessTokenResponse where
        parseJSON
...
instance Core.ToJSON GenerateAccessTokenResponse where
...
data GenerateIdTokenRequest = GenerateIdTokenRequest
    ...
    , organizationNumberIncluded :: (Core.Maybe Core.Bool)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newGenerateIdTokenRequest 
    ::  GenerateIdTokenRequest
newGenerateIdTokenRequest
  = GenerateIdTokenRequest{audience = Core.Nothing,
                           delegates = Core.Nothing, includeEmail = Core.Nothing,
                           organizationNumberIncluded = Core.Nothing}
instance Core.FromJSON GenerateIdTokenRequest where
        parseJSON
          = Core.withObject "GenerateIdTokenRequest"
              (\ o ->
                 GenerateIdTokenRequest Core.<$>
                   (o Core..:? "audience") Core.<*> (o Core..:? "delegates") Core.<*>
                     (o Core..:? "includeEmail")
                     Core.<*> (o Core..:? "organizationNumberIncluded"))
          ...
          = Core.object
              (Core.catMaybes
                 [("audience" Core..=) Core.<$> audience,
                  ...
                  ("organizationNumberIncluded" Core..=) Core.<$>
...
--
-- /See:/ 'newServiceAccountAllowedLocations' smart constructor.
data ServiceAccountAllowedLocations = ServiceAccountAllowedLocations
    {
      -- | Output only. The hex encoded bitmap of the trust boundary locations
      encodedLocations :: (Core.Maybe Core.Text)
...
-- | Creates a value of 'ServiceAccountAllowedLocations' with the minimum fields required to make a request.
newServiceAccountAllowedLocations 
    ::  ServiceAccountAllowedLocations
newServiceAccountAllowedLocations
  = ServiceAccountAllowedLocations{encodedLocations = Core.Nothing,
                                   locations = Core.Nothing}
instance Core.FromJSON ServiceAccountAllowedLocations where
        parseJSON
          = Core.withObject "ServiceAccountAllowedLocations"
              (\ o ->
                 ServiceAccountAllowedLocations Core.<$>
                   (o Core..:? "encodedLocations") Core.<*> (o Core..:? "locations"))

instance Core.ToJSON ServiceAccountAllowedLocations where
        toJSON ServiceAccountAllowedLocations{..}
          = Core.object
              (Core.catMaybes
                 [("encodedLocations" Core..=) Core.<$> encodedLocations,
          ...
          = Core.withObject "SignBlobRequest"
              (\ o ->
                 SignBlobRequest Core.<$>
                   (o Core..:? "delegates") Core.<*> (o Core..:? "payload"))
          ...
          = Core.withObject "SignBlobResponse"
              (\ o ->
                 SignBlobResponse Core.<$>
                   (o Core..:? "keyId") Core.<*> (o Core..:? "signedBlob"))
          ...
          = Core.withObject "SignJwtResponse"
              (\ o ->
                 SignJwtResponse Core.<$>
                   (o Core..:? "keyId") Core.<*> (o Core..:? "signedJwt"))
...
--
-- /See:/ 'newWorkforcePoolAllowedLocations' smart constructor.
data WorkforcePoolAllowedLocations = WorkforcePoolAllowedLocations
    {
      -- | Output only. The hex encoded bitmap of the trust boundary locations
      encodedLocations :: (Core.Maybe Core.Text)
      -- | Output only. The human readable trust boundary locations. For example, [\"us-central1\", \"europe-west1\"]
...
-- | Creates a value of 'WorkforcePoolAllowedLocations' with the minimum fields required to make a request.
newWorkforcePoolAllowedLocations 
    ::  WorkforcePoolAllowedLocations
newWorkforcePoolAllowedLocations
  = WorkforcePoolAllowedLocations{encodedLocations = Core.Nothing,
                                  locations = Core.Nothing}
instance Core.FromJSON WorkforcePoolAllowedLocations where
        parseJSON
          = Core.withObject "WorkforcePoolAllowedLocations"
              (\ o ->
                 WorkforcePoolAllowedLocations Core.<$>
                   (o Core..:? "encodedLocations") Core.<*> (o Core..:? "locations"))

instance Core.ToJSON WorkforcePoolAllowedLocations where
        toJSON WorkforcePoolAllowedLocations{..}
          = Core.object
              (Core.catMaybes
                 [("encodedLocations" Core..=) Core.<$> encodedLocations,
                  ("locations" Core..=) Core.<$> locations])
...
--
-- /See:/ 'newWorkloadIdentityPoolAllowedLocations' smart constructor.
data WorkloadIdentityPoolAllowedLocations = WorkloadIdentityPoolAllowedLocations
    {
      -- | Output only. The hex encoded bitmap of the trust boundary locations
      encodedLocations :: (Core.Maybe Core.Text)
      -- | Output only. The human readable trust boundary locations. For example, [\"us-central1\", \"europe-west1\"]
...
-- | Creates a value of 'WorkloadIdentityPoolAllowedLocations' with the minimum fields required to make a request.
newWorkloadIdentityPoolAllowedLocations 
    :: 
                                        WorkloadIdentityPoolAllowedLocations
newWorkloadIdentityPoolAllowedLocations
  = WorkloadIdentityPoolAllowedLocations{encodedLocations =
                                           Core.Nothing,
                                         locations = Core.Nothing}
instance Core.FromJSON WorkloadIdentityPoolAllowedLocations where
        parseJSON
          = Core.withObject "WorkloadIdentityPoolAllowedLocations"
              (\ o ->
                 WorkloadIdentityPoolAllowedLocations Core.<$>
                   (o Core..:? "encodedLocations") Core.<*> (o Core..:? "locations"))

instance Core.ToJSON WorkloadIdentityPoolAllowedLocations where
        toJSON WorkloadIdentityPoolAllowedLocations{..}
          = Core.object
              (Core.catMaybes
                 [("encodedLocations" Core..=) Core.<$> encodedLocations,
                  ("locations" Core..=) Core.<$> locations])
