...
data CheckUpgradeResponse = CheckUpgradeResponse
    ...
    , configConflicts :: (Core.Maybe [ConfigConflict])
          ...
          = Core.withObject "CheckUpgradeResponse"
              (\ o ->
                 CheckUpgradeResponse Core.<$>
                   (o Core..:? "buildLogUri") Core.<*> (o Core..:? "configConflicts")
          ...
          = Core.object
              (Core.catMaybes
                 [("buildLogUri" Core..=) Core.<$> buildLogUri,
                  ("configConflicts" Core..=) Core.<$> configConflicts,
...
--
-- /See:/ 'newConfigConflict' smart constructor.
data ConfigConflict = ConfigConflict
    {
      -- | Conflict message.
      message :: (Core.Maybe Core.Text)
      -- | Conflict type. It can be blocking or non-blocking.
    , type' :: (Core.Maybe ConfigConflict_Type)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'ConfigConflict' with the minimum fields required to make a request.
newConfigConflict 
    ::  ConfigConflict
newConfigConflict
  = ConfigConflict{message = Core.Nothing, type' = Core.Nothing}
instance Core.FromJSON ConfigConflict where
        parseJSON
          = Core.withObject "ConfigConflict"
              (\ o ->
                 ConfigConflict Core.<$>
                   (o Core..:? "message") Core.<*> (o Core..:? "type"))

instance Core.ToJSON ConfigConflict where
        toJSON ConfigConflict{..}
          = Core.object
              (Core.catMaybes
