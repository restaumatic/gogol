...
newComposerProjectsLocationsOperationsDelete name
  = ComposerProjectsLocationsOperationsDelete{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           ComposerProjectsLocationsOperationsDelete
         where
        type Rs ComposerProjectsLocationsOperationsDelete = Empty
        type Scopes ComposerProjectsLocationsOperationsDelete =
             '[CloudPlatform'FullControl]
        requestClient ComposerProjectsLocationsOperationsDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ComposerProjectsLocationsOperationsDeleteResource)
                      Core.mempty
