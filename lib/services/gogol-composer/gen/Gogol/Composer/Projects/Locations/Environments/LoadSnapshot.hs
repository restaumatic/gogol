...
type ComposerProjectsLocationsEnvironmentsLoadSnapshotResource =
     "v1" Core.:>
       Core.CaptureMode "environment" "loadSnapshot" Core.Text Core.:>
...
newComposerProjectsLocationsEnvironmentsLoadSnapshot 
    ...
    -> ComposerProjectsLocationsEnvironmentsLoadSnapshot
newComposerProjectsLocationsEnvironmentsLoadSnapshot environment
  payload
  = ComposerProjectsLocationsEnvironmentsLoadSnapshot{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           ComposerProjectsLocationsEnvironmentsLoadSnapshot
         where
        type Rs ComposerProjectsLocationsEnvironmentsLoadSnapshot =
             Operation
        type Scopes ComposerProjectsLocationsEnvironmentsLoadSnapshot =
             '[CloudPlatform'FullControl]
        requestClient ComposerProjectsLocationsEnvironmentsLoadSnapshot{..}
