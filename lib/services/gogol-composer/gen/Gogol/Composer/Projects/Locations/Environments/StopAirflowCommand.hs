...
type ComposerProjectsLocationsEnvironmentsStopAirflowCommandResource
     =
     "v1" Core.:>
       Core.CaptureMode "environment" "stopAirflowCommand" Core.Text
         Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] StopAirflowCommandRequest Core.:>
...
newComposerProjectsLocationsEnvironmentsStopAirflowCommand
  environment payload
  = ComposerProjectsLocationsEnvironmentsStopAirflowCommand{xgafv =
                                                              Core.Nothing,
...
instance Core.GoogleRequest
           ComposerProjectsLocationsEnvironmentsStopAirflowCommand
         where
        type Rs ComposerProjectsLocationsEnvironmentsStopAirflowCommand =
             StopAirflowCommandResponse
        type Scopes ComposerProjectsLocationsEnvironmentsStopAirflowCommand
