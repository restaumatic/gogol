...
newComposerProjectsLocationsEnvironmentsDelete name
  = ComposerProjectsLocationsEnvironmentsDelete{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           ComposerProjectsLocationsEnvironmentsDelete
         where
        type Rs ComposerProjectsLocationsEnvironmentsDelete = Operation
        type Scopes ComposerProjectsLocationsEnvironmentsDelete =
             '[CloudPlatform'FullControl]
        requestClient ComposerProjectsLocationsEnvironmentsDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ComposerProjectsLocationsEnvironmentsDeleteResource)
                      Core.mempty
