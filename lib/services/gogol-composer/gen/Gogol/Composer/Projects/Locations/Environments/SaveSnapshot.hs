...
type ComposerProjectsLocationsEnvironmentsSaveSnapshotResource =
     "v1" Core.:>
       Core.CaptureMode "environment" "saveSnapshot" Core.Text Core.:>
...
newComposerProjectsLocationsEnvironmentsSaveSnapshot 
    ...
    -> ComposerProjectsLocationsEnvironmentsSaveSnapshot
newComposerProjectsLocationsEnvironmentsSaveSnapshot environment
  payload
  = ComposerProjectsLocationsEnvironmentsSaveSnapshot{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           ComposerProjectsLocationsEnvironmentsSaveSnapshot
         where
        type Rs ComposerProjectsLocationsEnvironmentsSaveSnapshot =
             Operation
        type Scopes ComposerProjectsLocationsEnvironmentsSaveSnapshot =
             '[CloudPlatform'FullControl]
        requestClient ComposerProjectsLocationsEnvironmentsSaveSnapshot{..}
          = go environment xgafv accessToken callback uploadType
              uploadProtocol
