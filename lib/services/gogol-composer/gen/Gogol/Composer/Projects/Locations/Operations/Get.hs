...
newComposerProjectsLocationsOperationsGet name
  = ComposerProjectsLocationsOperationsGet{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           name = name, uploadType = Core.Nothing,
                                           uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComposerProjectsLocationsOperationsGet
         where
        type Rs ComposerProjectsLocationsOperationsGet = Operation
        type Scopes ComposerProjectsLocationsOperationsGet =
             '[CloudPlatform'FullControl]
        requestClient ComposerProjectsLocationsOperationsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ComposerProjectsLocationsOperationsGetResource)
                      Core.mempty
