           ...
           Core.QueryParam "$.xgafv" Xgafv Core.:>
             Core.QueryParam "access_token" Core.Text Core.:>
               Core.QueryParam "callback" Core.Text Core.:>
                 Core.QueryParam "includePastReleases" Core.Bool Core.:>
                   Core.QueryParam "pageSize" Core.Int32 Core.:>
                     Core.QueryParam "pageToken" Core.Text Core.:>
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] ListImageVersionsResponse
...
newComposerProjectsLocationsImageVersionsList parent
  = ComposerProjectsLocationsImageVersionsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           ComposerProjectsLocationsImageVersionsList
         where
        type Rs ComposerProjectsLocationsImageVersionsList =
             ListImageVersionsResponse
        type Scopes ComposerProjectsLocationsImageVersionsList =
             '[CloudPlatform'FullControl]
        requestClient ComposerProjectsLocationsImageVersionsList{..}
          = go parent xgafv accessToken callback includePastReleases pageSize
              pageToken
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ComposerProjectsLocationsImageVersionsListResource)
                      Core.mempty
