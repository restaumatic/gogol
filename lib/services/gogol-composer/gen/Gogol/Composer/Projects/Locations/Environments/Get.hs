...
newComposerProjectsLocationsEnvironmentsGet name
  = ComposerProjectsLocationsEnvironmentsGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           ComposerProjectsLocationsEnvironmentsGet
         where
        type Rs ComposerProjectsLocationsEnvironmentsGet = Environment
        type Scopes ComposerProjectsLocationsEnvironmentsGet =
             '[CloudPlatform'FullControl]
        requestClient ComposerProjectsLocationsEnvironmentsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ComposerProjectsLocationsEnvironmentsGetResource)
                      Core.mempty
