...
type ComposerProjectsLocationsEnvironmentsExecuteAirflowCommandResource
     =
     "v1" Core.:>
       Core.CaptureMode "environment" "executeAirflowCommand" Core.Text
         Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] ExecuteAirflowCommandRequest Core.:>
...
newComposerProjectsLocationsEnvironmentsExecuteAirflowCommand
  environment payload
  = ComposerProjectsLocationsEnvironmentsExecuteAirflowCommand{xgafv
                                                                 = Core.Nothing,
...
instance Core.GoogleRequest
           ComposerProjectsLocationsEnvironmentsExecuteAirflowCommand
         where
        type Rs ComposerProjectsLocationsEnvironmentsExecuteAirflowCommand
