...
type ComposerProjectsLocationsEnvironmentsCheckUpgradeResource =
     "v1" Core.:>
       Core.CaptureMode "environment" "checkUpgrade" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] CheckUpgradeRequest Core.:>
...
newComposerProjectsLocationsEnvironmentsCheckUpgrade 
    ...
    -> ComposerProjectsLocationsEnvironmentsCheckUpgrade
newComposerProjectsLocationsEnvironmentsCheckUpgrade environment
  payload
  = ComposerProjectsLocationsEnvironmentsCheckUpgrade{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           ComposerProjectsLocationsEnvironmentsCheckUpgrade
         where
        type Rs ComposerProjectsLocationsEnvironmentsCheckUpgrade =
             Operation
        type Scopes ComposerProjectsLocationsEnvironmentsCheckUpgrade =
