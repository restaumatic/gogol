...
type ComposerProjectsLocationsEnvironmentsPollAirflowCommandResource
     =
     "v1" Core.:>
       Core.CaptureMode "environment" "pollAirflowCommand" Core.Text
         Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] PollAirflowCommandRequest Core.:>
...
newComposerProjectsLocationsEnvironmentsPollAirflowCommand
  environment payload
  = ComposerProjectsLocationsEnvironmentsPollAirflowCommand{xgafv =
                                                              Core.Nothing,
...
instance Core.GoogleRequest
           ComposerProjectsLocationsEnvironmentsPollAirflowCommand
         where
        type Rs ComposerProjectsLocationsEnvironmentsPollAirflowCommand =
             PollAirflowCommandResponse
        type Scopes ComposerProjectsLocationsEnvironmentsPollAirflowCommand
