...
newComposerProjectsLocationsEnvironmentsCreate parent payload
  = ComposerProjectsLocationsEnvironmentsCreate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           ComposerProjectsLocationsEnvironmentsCreate
         where
        type Rs ComposerProjectsLocationsEnvironmentsCreate = Operation
        type Scopes ComposerProjectsLocationsEnvironmentsCreate =
             '[CloudPlatform'FullControl]
        requestClient ComposerProjectsLocationsEnvironmentsCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ComposerProjectsLocationsEnvironmentsCreateResource)
                      Core.mempty
