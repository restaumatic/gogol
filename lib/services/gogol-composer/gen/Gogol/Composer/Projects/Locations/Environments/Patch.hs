...
newComposerProjectsLocationsEnvironmentsPatch name payload
  = ComposerProjectsLocationsEnvironmentsPatch{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           ComposerProjectsLocationsEnvironmentsPatch
         where
        type Rs ComposerProjectsLocationsEnvironmentsPatch = Operation
        type Scopes ComposerProjectsLocationsEnvironmentsPatch =
             '[CloudPlatform'FullControl]
        requestClient ComposerProjectsLocationsEnvironmentsPatch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ComposerProjectsLocationsEnvironmentsPatchResource)
                      Core.mempty
