...
type ComposerProjectsLocationsEnvironmentsDatabaseFailoverResource
     =
     "v1" Core.:>
       Core.CaptureMode "environment" "databaseFailover" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] DatabaseFailoverRequest Core.:>
...
newComposerProjectsLocationsEnvironmentsDatabaseFailover
  environment payload
  = ComposerProjectsLocationsEnvironmentsDatabaseFailover{xgafv =
                                                            Core.Nothing,
...
instance Core.GoogleRequest
           ComposerProjectsLocationsEnvironmentsDatabaseFailover
         where
        type Rs ComposerProjectsLocationsEnvironmentsDatabaseFailover =
             Operation
        type Scopes ComposerProjectsLocationsEnvironmentsDatabaseFailover =
