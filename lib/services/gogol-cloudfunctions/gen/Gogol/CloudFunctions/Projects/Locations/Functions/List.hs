                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Get '[Core.JSON] ListFunctionsResponse
...
newCloudFunctionsProjectsLocationsFunctionsList parent
  = CloudFunctionsProjectsLocationsFunctionsList{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
           CloudFunctionsProjectsLocationsFunctionsList
         where
        type Rs CloudFunctionsProjectsLocationsFunctionsList =
             ListFunctionsResponse
        type Scopes CloudFunctionsProjectsLocationsFunctionsList =
