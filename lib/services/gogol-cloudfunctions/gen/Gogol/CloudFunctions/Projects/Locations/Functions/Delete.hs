...
newCloudFunctionsProjectsLocationsFunctionsDelete name
  = CloudFunctionsProjectsLocationsFunctionsDelete{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           CloudFunctionsProjectsLocationsFunctionsDelete
         where
        type Rs CloudFunctionsProjectsLocationsFunctionsDelete = Operation
        type Scopes CloudFunctionsProjectsLocationsFunctionsDelete =
             '[CloudPlatform'FullControl]
        requestClient CloudFunctionsProjectsLocationsFunctionsDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudFunctionsProjectsLocationsFunctionsDeleteResource)
                      Core.mempty
