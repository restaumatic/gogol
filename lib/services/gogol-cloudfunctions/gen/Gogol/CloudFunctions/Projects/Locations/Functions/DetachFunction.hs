...
type CloudFunctionsProjectsLocationsFunctionsDetachFunctionResource
     =
     "v2" Core.:>
       Core.CaptureMode "name" "detachFunction" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] DetachFunctionRequest Core.:>
...
newCloudFunctionsProjectsLocationsFunctionsDetachFunction 
    ...
    -> CloudFunctionsProjectsLocationsFunctionsDetachFunction
newCloudFunctionsProjectsLocationsFunctionsDetachFunction name
  payload
  = CloudFunctionsProjectsLocationsFunctionsDetachFunction{xgafv =
                                                             Core.Nothing,
...
instance Core.GoogleRequest
           CloudFunctionsProjectsLocationsFunctionsDetachFunction
         where
        type Rs CloudFunctionsProjectsLocationsFunctionsDetachFunction =
             Operation
        type Scopes CloudFunctionsProjectsLocationsFunctionsDetachFunction
