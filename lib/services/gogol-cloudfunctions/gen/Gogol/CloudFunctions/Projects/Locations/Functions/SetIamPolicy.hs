...
newCloudFunctionsProjectsLocationsFunctionsSetIamPolicy 
    ...
    -> CloudFunctionsProjectsLocationsFunctionsSetIamPolicy
newCloudFunctionsProjectsLocationsFunctionsSetIamPolicy payload
  resource
  = CloudFunctionsProjectsLocationsFunctionsSetIamPolicy{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           CloudFunctionsProjectsLocationsFunctionsSetIamPolicy
         where
        type Rs CloudFunctionsProjectsLocationsFunctionsSetIamPolicy =
             Policy
        type Scopes CloudFunctionsProjectsLocationsFunctionsSetIamPolicy =
