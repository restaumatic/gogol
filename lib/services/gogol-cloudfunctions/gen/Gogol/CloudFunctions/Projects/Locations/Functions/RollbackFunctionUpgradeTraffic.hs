...
type CloudFunctionsProjectsLocationsFunctionsRollbackFunctionUpgradeTrafficResource
     =
     "v2" Core.:>
       Core.CaptureMode "name" "rollbackFunctionUpgradeTraffic" Core.Text
         Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] RollbackFunctionUpgradeTrafficRequest
...
newCloudFunctionsProjectsLocationsFunctionsRollbackFunctionUpgradeTraffic
  name payload
  = CloudFunctionsProjectsLocationsFunctionsRollbackFunctionUpgradeTraffic{xgafv
                                                                             = Core.Nothing,
                                                                           accessToken =
                                                                             Core.Nothing,
