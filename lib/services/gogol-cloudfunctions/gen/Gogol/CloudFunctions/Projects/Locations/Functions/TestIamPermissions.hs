...
type CloudFunctionsProjectsLocationsFunctionsTestIamPermissionsResource
     =
     "v2" Core.:>
...
-- | Returns permissions that a caller has on the specified resource. If the resource does not exist, this will return an empty set of permissions, not a @NOT_FOUND@ error. Note: This operation is designed to be used for building permission-aware UIs and command-line tools, not for authorization checking. This operation may \"fail open\" without warning.
--
-- /See:/ 'newCloudFunctionsProjectsLocationsFunctionsTestIamPermissions' smart constructor.
data CloudFunctionsProjectsLocationsFunctionsTestIamPermissions = CloudFunctionsProjectsLocationsFunctionsTestIamPermissions
    {
      -- | V1 error format.
...
-- | Creates a value of 'CloudFunctionsProjectsLocationsFunctionsTestIamPermissions' with the minimum fields required to make a request.
newCloudFunctionsProjectsLocationsFunctionsTestIamPermissions 
    :: 
...
newCloudFunctionsProjectsLocationsFunctionsTestIamPermissions
  payload resource
  = CloudFunctionsProjectsLocationsFunctionsTestIamPermissions{xgafv
                                                                 = Core.Nothing,
...
instance Core.GoogleRequest
           CloudFunctionsProjectsLocationsFunctionsTestIamPermissions
         where
        type Rs CloudFunctionsProjectsLocationsFunctionsTestIamPermissions
