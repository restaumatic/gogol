...
type CloudFunctionsProjectsLocationsFunctionsSetupFunctionUpgradeConfigResource
     =
     "v2" Core.:>
       Core.CaptureMode "name" "setupFunctionUpgradeConfig" Core.Text
         Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] SetupFunctionUpgradeConfigRequest Core.:>
...
newCloudFunctionsProjectsLocationsFunctionsSetupFunctionUpgradeConfig
  name payload
  = CloudFunctionsProjectsLocationsFunctionsSetupFunctionUpgradeConfig{xgafv
                                                                         = Core.Nothing,
