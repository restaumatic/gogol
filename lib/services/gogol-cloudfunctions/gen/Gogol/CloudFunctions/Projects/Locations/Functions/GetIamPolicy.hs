...
newCloudFunctionsProjectsLocationsFunctionsGetIamPolicy resource
  = CloudFunctionsProjectsLocationsFunctionsGetIamPolicy{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           CloudFunctionsProjectsLocationsFunctionsGetIamPolicy
         where
        type Rs CloudFunctionsProjectsLocationsFunctionsGetIamPolicy =
             Policy
        type Scopes CloudFunctionsProjectsLocationsFunctionsGetIamPolicy =
