...
type CloudFunctionsProjectsLocationsFunctionsAbortFunctionUpgradeResource
     =
     "v2" Core.:>
       Core.CaptureMode "name" "abortFunctionUpgrade" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] AbortFunctionUpgradeRequest Core.:>
...
newCloudFunctionsProjectsLocationsFunctionsAbortFunctionUpgrade
  name payload
  = CloudFunctionsProjectsLocationsFunctionsAbortFunctionUpgrade{xgafv
                                                                   = Core.Nothing,
