                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] GenerateUploadUrlRequest Core.:>
...
newCloudFunctionsProjectsLocationsFunctionsGenerateUploadUrl 
    ...
    -> CloudFunctionsProjectsLocationsFunctionsGenerateUploadUrl
newCloudFunctionsProjectsLocationsFunctionsGenerateUploadUrl parent
  payload
  = CloudFunctionsProjectsLocationsFunctionsGenerateUploadUrl{xgafv =
                                                                Core.Nothing,
...
instance Core.GoogleRequest
           CloudFunctionsProjectsLocationsFunctionsGenerateUploadUrl
         where
        type Rs CloudFunctionsProjectsLocationsFunctionsGenerateUploadUrl =
