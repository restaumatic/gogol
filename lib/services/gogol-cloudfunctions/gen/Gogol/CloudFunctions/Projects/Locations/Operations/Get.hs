...
newCloudFunctionsProjectsLocationsOperationsGet name
  = CloudFunctionsProjectsLocationsOperationsGet{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
           CloudFunctionsProjectsLocationsOperationsGet
         where
        type Rs CloudFunctionsProjectsLocationsOperationsGet = Operation
        type Scopes CloudFunctionsProjectsLocationsOperationsGet =
             '[CloudPlatform'FullControl]
        requestClient CloudFunctionsProjectsLocationsOperationsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudFunctionsProjectsLocationsOperationsGetResource)
                      Core.mempty
