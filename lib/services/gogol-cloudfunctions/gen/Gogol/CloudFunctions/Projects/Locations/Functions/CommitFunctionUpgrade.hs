...
type CloudFunctionsProjectsLocationsFunctionsCommitFunctionUpgradeResource
     =
     "v2" Core.:>
       Core.CaptureMode "name" "commitFunctionUpgrade" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] CommitFunctionUpgradeRequest Core.:>
...
newCloudFunctionsProjectsLocationsFunctionsCommitFunctionUpgrade
  name payload
  = CloudFunctionsProjectsLocationsFunctionsCommitFunctionUpgrade{xgafv
                                                                    = Core.Nothing,
