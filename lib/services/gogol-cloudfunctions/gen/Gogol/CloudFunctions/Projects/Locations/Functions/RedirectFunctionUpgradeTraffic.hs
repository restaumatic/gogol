...
type CloudFunctionsProjectsLocationsFunctionsRedirectFunctionUpgradeTrafficResource
     =
     "v2" Core.:>
       Core.CaptureMode "name" "redirectFunctionUpgradeTraffic" Core.Text
         Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] RedirectFunctionUpgradeTrafficRequest
...
newCloudFunctionsProjectsLocationsFunctionsRedirectFunctionUpgradeTraffic
  name payload
  = CloudFunctionsProjectsLocationsFunctionsRedirectFunctionUpgradeTraffic{xgafv
                                                                             = Core.Nothing,
                                                                           accessToken =
                                                                             Core.Nothing,
