...
type CloudFunctionsProjectsLocationsFunctionsGenerateDownloadUrlResource
     =
     "v2" Core.:>
       Core.CaptureMode "name" "generateDownloadUrl" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] GenerateDownloadUrlRequest Core.:>
...
newCloudFunctionsProjectsLocationsFunctionsGenerateDownloadUrl 
    ...
    -> CloudFunctionsProjectsLocationsFunctionsGenerateDownloadUrl
newCloudFunctionsProjectsLocationsFunctionsGenerateDownloadUrl name
  payload
  = CloudFunctionsProjectsLocationsFunctionsGenerateDownloadUrl{xgafv
                                                                  = Core.Nothing,
...
instance Core.GoogleRequest
           CloudFunctionsProjectsLocationsFunctionsGenerateDownloadUrl
         where
        type Rs CloudFunctionsProjectsLocationsFunctionsGenerateDownloadUrl
