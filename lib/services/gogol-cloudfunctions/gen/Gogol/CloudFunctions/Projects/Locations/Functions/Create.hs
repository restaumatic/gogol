           ...
           Core.QueryParam "$.xgafv" Xgafv Core.:>
             Core.QueryParam "access_token" Core.Text Core.:>
               Core.QueryParam "callback" Core.Text Core.:>
                 Core.QueryParam "functionId" Core.Text Core.:>
...
newCloudFunctionsProjectsLocationsFunctionsCreate parent payload
  = CloudFunctionsProjectsLocationsFunctionsCreate{xgafv =
                                                     Core.Nothing,
                                                   accessToken = Core.Nothing,
                                                   callback = Core.Nothing,
                                                   functionId = Core.Nothing, parent = parent,
                                                   payload = payload, uploadType = Core.Nothing,
                                                   uploadProtocol = Core.Nothing}
instance Core.GoogleRequest
           CloudFunctionsProjectsLocationsFunctionsCreate
         where
        type Rs CloudFunctionsProjectsLocationsFunctionsCreate = Operation
        type Scopes CloudFunctionsProjectsLocationsFunctionsCreate =
             '[CloudPlatform'FullControl]
        requestClient CloudFunctionsProjectsLocationsFunctionsCreate{..}
          = go parent xgafv accessToken callback functionId uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudFunctionsProjectsLocationsFunctionsCreateResource)
                      Core.mempty
