  ...
  (
    ...
    UpgradeInfo_UpgradeState
      (
        ...
        UpgradeInfo_UpgradeState_INELIGIBLEFORUPGRADEUNTILREDEPLOYMENT,
...
pattern UpgradeInfo_UpgradeState_INELIGIBLEFORUPGRADEUNTILREDEPLOYMENT :: UpgradeInfo_UpgradeState
pattern UpgradeInfo_UpgradeState_INELIGIBLEFORUPGRADEUNTILREDEPLOYMENT = UpgradeInfo_UpgradeState "INELIGIBLE_FOR_UPGRADE_UNTIL_REDEPLOYMENT"
