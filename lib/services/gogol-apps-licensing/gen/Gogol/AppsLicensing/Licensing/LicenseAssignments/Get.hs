...
--
-- /See:/ <https://developers.google.com/workspace/admin/licensing/ Enterprise License Manager API Reference> for @licensing.licenseAssignments.get@.
module Gogol.AppsLicensing.Licensing.LicenseAssignments.Get
    (
    -- * Resource
                             ...
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.Get '[Core.JSON] LicenseAssignment
...
newLicensingLicenseAssignmentsGet productId skuId userId
  = LicensingLicenseAssignmentsGet{xgafv = Core.Nothing,
                                   accessToken = Core.Nothing, callback = Core.Nothing,
                                   productId = productId, skuId = skuId, uploadType = Core.Nothing,
