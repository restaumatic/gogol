...
--
-- /See:/ <https://developers.google.com/workspace/admin/licensing/ Enterprise License Manager API Reference> for @licensing.licenseAssignments.patch@.
module Gogol.AppsLicensing.Licensing.LicenseAssignments.Patch
    (
    -- * Resource
                             ...
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.ReqBody '[Core.JSON] LicenseAssignment Core.:>
                                     Core.Patch '[Core.JSON] LicenseAssignment
...
newLicensingLicenseAssignmentsPatch payload productId skuId userId
  = LicensingLicenseAssignmentsPatch{xgafv = Core.Nothing,
...
instance Core.GoogleRequest LicensingLicenseAssignmentsPatch where
        ...
        requestClient LicensingLicenseAssignmentsPatch{..}
          = go productId skuId userId xgafv accessToken callback uploadType
              uploadProtocol
