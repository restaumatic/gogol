...
--
-- /See:/ <https://developers.google.com/workspace/admin/licensing/ Enterprise License Manager API Reference> for @licensing.licenseAssignments.listForProduct@.
module Gogol.AppsLicensing.Licensing.LicenseAssignments.ListForProduct
    (
    -- * Resource
...
newLicensingLicenseAssignmentsListForProduct customerId productId
  = LicensingLicenseAssignmentsListForProduct{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           LicensingLicenseAssignmentsListForProduct
         where
        type Rs LicensingLicenseAssignmentsListForProduct =
             LicenseAssignmentList
        type Scopes LicensingLicenseAssignmentsListForProduct =
             '[Apps'Licensing]
        requestClient LicensingLicenseAssignmentsListForProduct{..}
          = go productId (Core.Just customerId) xgafv accessToken callback
