...
--
-- /See:/ <https://developers.google.com/workspace/admin/licensing/ Enterprise License Manager API Reference> for @licensing.licenseAssignments.listForProductAndSku@.
module Gogol.AppsLicensing.Licensing.LicenseAssignments.ListForProductAndSku
    (
    -- * Resource
         ...
         "v1" Core.:>
           "product" Core.:>
             Core.Capture "productId" Core.Text Core.:>
               "sku" Core.:>
                 Core.Capture "skuId" Core.Text Core.:>
                   "users" Core.:>
                                 ...
                                 Core.QueryParam "uploadType" Core.Text Core.:>
                                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                                     Core.QueryParam "alt" Core.AltJSON Core.:>
                                       Core.Get '[Core.JSON] LicenseAssignmentList
...
newLicensingLicenseAssignmentsListForProductAndSku 
    ...
    -> LicensingLicenseAssignmentsListForProductAndSku
newLicensingLicenseAssignmentsListForProductAndSku customerId
  productId skuId
  = LicensingLicenseAssignmentsListForProductAndSku{xgafv =
                                                      Core.Nothing,
                                                    accessToken = Core.Nothing,
                                                    callback = Core.Nothing,
                                                    customerId = customerId, maxResults = 100,
                                                    pageToken = "", productId = productId,
                                                    skuId = skuId, uploadType = Core.Nothing,
                                                    uploadProtocol = Core.Nothing}
instance Core.GoogleRequest
           LicensingLicenseAssignmentsListForProductAndSku
         where
        type Rs LicensingLicenseAssignmentsListForProductAndSku =
             LicenseAssignmentList
        type Scopes LicensingLicenseAssignmentsListForProductAndSku =
             '[Apps'Licensing]
        requestClient LicensingLicenseAssignmentsListForProductAndSku{..}
          = go productId skuId (Core.Just customerId) xgafv accessToken
              callback
