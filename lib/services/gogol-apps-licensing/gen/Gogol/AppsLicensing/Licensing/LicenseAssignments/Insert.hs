...
-- Assign a license.
--
-- /See:/ <https://developers.google.com/workspace/admin/licensing/ Enterprise License Manager API Reference> for @licensing.licenseAssignments.insert@.
module Gogol.AppsLicensing.Licensing.LicenseAssignments.Insert
    (
    -- * Resource
                           ...
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.ReqBody '[Core.JSON] LicenseAssignmentInsert Core.:>
                                   Core.Post '[Core.JSON] LicenseAssignment
...
newLicensingLicenseAssignmentsInsert payload productId skuId
  = LicensingLicenseAssignmentsInsert{xgafv = Core.Nothing,
                                      accessToken = Core.Nothing, callback = Core.Nothing,
                                      payload = payload, productId = productId, skuId = skuId,
...
instance Core.GoogleRequest LicensingLicenseAssignmentsInsert where
        ...
        requestClient LicensingLicenseAssignmentsInsert{..}
          = go productId skuId xgafv accessToken callback uploadType
              uploadProtocol
