...
-- Revoke a license.
--
-- /See:/ <https://developers.google.com/workspace/admin/licensing/ Enterprise License Manager API Reference> for @licensing.licenseAssignments.delete@.
module Gogol.AppsLicensing.Licensing.LicenseAssignments.Delete
    (
    -- * Resource
...
newLicensingLicenseAssignmentsDelete productId skuId userId
  = LicensingLicenseAssignmentsDelete{xgafv = Core.Nothing,
