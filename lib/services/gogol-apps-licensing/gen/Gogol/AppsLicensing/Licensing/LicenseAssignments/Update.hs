...
--
-- /See:/ <https://developers.google.com/workspace/admin/licensing/ Enterprise License Manager API Reference> for @licensing.licenseAssignments.update@.
module Gogol.AppsLicensing.Licensing.LicenseAssignments.Update
    (
    -- * Resource
                               ...
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.ReqBody '[Core.JSON] LicenseAssignment Core.:>
                                     Core.Put '[Core.JSON] LicenseAssignment
...
newLicensingLicenseAssignmentsUpdate payload productId skuId userId
  = LicensingLicenseAssignmentsUpdate{xgafv = Core.Nothing,
