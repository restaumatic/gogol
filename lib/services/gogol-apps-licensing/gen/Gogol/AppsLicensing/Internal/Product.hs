...
newLicenseAssignment 
    ::  LicenseAssignment
newLicenseAssignment
  = LicenseAssignment{etags = Core.Nothing,
                      kind = "licensing#licenseAssignment", productId = Core.Nothing,
                      productName = Core.Nothing, selfLink = Core.Nothing,
          ...
          = Core.withObject "LicenseAssignment"
              (\ o ->
                 LicenseAssignment Core.<$>
                   (o Core..:? "etags") Core.<*>
                     (o Core..:? "kind" Core..!= "licensing#licenseAssignment")
...
newLicenseAssignmentList 
    ::  LicenseAssignmentList
newLicenseAssignmentList
  = LicenseAssignmentList{etag = Core.Nothing, items = Core.Nothing,
              ...
              (\ o ->
                 LicenseAssignmentList Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "items") Core.<*>
                     (o Core..:? "kind" Core..!= "licensing#licenseAssignmentList")
