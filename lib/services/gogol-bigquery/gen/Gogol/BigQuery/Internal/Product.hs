...
module Gogol.BigQuery.Internal.Product
  (
    ...
    IncrementalResultStats (..),
    newIncrementalResultStats,

    -- * IndexPruningStats
    IndexPruningStats (..),
    newIndexPruningStats,
...
data DataFormatOptions = DataFormatOptions
    {
      ...
      timestampOutputFormat :: (Core.Maybe DataFormatOptions_TimestampOutputFormat)
...
newDataFormatOptions 
    ::  DataFormatOptions
newDataFormatOptions
  = DataFormatOptions{timestampOutputFormat = Core.Nothing,
                      useInt64Timestamp = Core.Nothing}
instance Core.FromJSON DataFormatOptions where
        parseJSON
          = Core.withObject "DataFormatOptions"
              (\ o ->
                 DataFormatOptions Core.<$>
                   (o Core..:? "timestampOutputFormat") Core.<*>
...
instance Core.ToJSON DataFormatOptions where
        toJSON DataFormatOptions{..}
          = Core.object
              (Core.catMaybes
                 [("timestampOutputFormat" Core..=) Core.<$> timestampOutputFormat,
...
-- | Data policy option. For more information, see <https://cloud.google.com/bigquery/docs/column-data-masking#data-policies-on-column/ Mask data by applying data policies to a column>.
--
...
data ExternalDataConfiguration = ExternalDataConfiguration
    ...
    , timestampTargetPrecision :: (Core.Maybe [Core.Int32])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newExternalDataConfiguration
  = ExternalDataConfiguration{autodetect = Core.Nothing,
                              ...
                              timestampTargetPrecision = Core.Nothing}
              ...
              (\ o ->
                 ExternalDataConfiguration Core.<$>
                   (o Core..:? "autodetect") Core.<*> (o Core..:? "avroOptions")
                     ...
                     Core.<*> (o Core..:? "timestampTargetPrecision"))
          ...
          = Core.object
              (Core.catMaybes
                 [("autodetect" Core..=) Core.<$> autodetect,
                  ...
                  ("timestampTargetPrecision" Core..=) Core.<$>
...
--
-- /See:/ 'newExternalRuntimeOptions' smart constructor.
data ExternalRuntimeOptions = ExternalRuntimeOptions
    {
      -- | Optional. Amount of CPU provisioned for a Python UDF container instance. For more information, see <https://cloud.google.com/bigquery/docs/user-defined-functions-python#configure-container-limits Configure container limits for Python UDFs>
      containerCpu :: (Core.Maybe Core.Double)
      -- | Optional. Amount of memory provisioned for a Python UDF container instance. Format: {number}{unit} where unit is one of \"M\", \"G\", \"Mi\" and \"Gi\" (e.g. 1G, 512Mi). If not specified, the default value is 512Mi. For more information, see <https://cloud.google.com/bigquery/docs/user-defined-functions-python#configure-container-limits Configure container limits for Python UDFs>
    , containerMemory :: (Core.Maybe Core.Text)
    ...
    , runtimeConnection :: (Core.Maybe Core.Text)
      -- | Optional. Language runtime version. Example: @python-3.11@.
    , runtimeVersion :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'ExternalRuntimeOptions' with the minimum fields required to make a request.
newExternalRuntimeOptions 
    ::  ExternalRuntimeOptions
newExternalRuntimeOptions
  = ExternalRuntimeOptions{containerCpu = Core.Nothing,
                           containerMemory = Core.Nothing, maxBatchingRows = Core.Nothing,
                           runtimeConnection = Core.Nothing, runtimeVersion = Core.Nothing}
instance Core.FromJSON ExternalRuntimeOptions where
        parseJSON
          = Core.withObject "ExternalRuntimeOptions"
              (\ o ->
                 ExternalRuntimeOptions Core.<$>
                   (o Core..:? "containerCpu") Core.<*> (o Core..:? "containerMemory")
                     Core.<*>
                     (o Core..:? "maxBatchingRows" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "runtimeConnection")
                     Core.<*> (o Core..:? "runtimeVersion"))

instance Core.ToJSON ExternalRuntimeOptions where
        toJSON ExternalRuntimeOptions{..}
          = Core.object
              (Core.catMaybes
                 [("containerCpu" Core..=) Core.<$> containerCpu,
                  ("containerMemory" Core..=) Core.<$> containerMemory,
                  ("maxBatchingRows" Core..=) Core.. Core.AsText Core.<$>
                    maxBatchingRows,
                  ("runtimeConnection" Core..=) Core.<$> runtimeConnection,
...
newExternalServiceCost 
    ::  ExternalServiceCost
newExternalServiceCost
  = ExternalServiceCost{billingMethod = Core.Nothing,
                        bytesBilled = Core.Nothing, bytesProcessed = Core.Nothing,
                        externalService = Core.Nothing, reservedSlotCount = Core.Nothing,
                        slotMs = Core.Nothing}
...
--
-- /See:/ 'newIncrementalResultStats' smart constructor.
data IncrementalResultStats = IncrementalResultStats
    {
      -- | Reason why incremental query results are\/were not written by the query.
      disabledReason :: (Core.Maybe IncrementalResultStats_DisabledReason)
    ...
    , resultSetLastModifyTime :: (Core.Maybe Core.DateTime)
    ...
    , resultSetLastReplaceTime :: (Core.Maybe Core.DateTime)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'IncrementalResultStats' with the minimum fields required to make a request.
newIncrementalResultStats 
    ::  IncrementalResultStats
newIncrementalResultStats
  = IncrementalResultStats{disabledReason = Core.Nothing,
                           resultSetLastModifyTime = Core.Nothing,
                           resultSetLastReplaceTime = Core.Nothing}
instance Core.FromJSON IncrementalResultStats where
        parseJSON
          = Core.withObject "IncrementalResultStats"
              (\ o ->
                 IncrementalResultStats Core.<$>
                   (o Core..:? "disabledReason") Core.<*>
                     (o Core..:? "resultSetLastModifyTime")
                     Core.<*> (o Core..:? "resultSetLastReplaceTime"))

instance Core.ToJSON IncrementalResultStats where
        toJSON IncrementalResultStats{..}
          = Core.object
              (Core.catMaybes
                 [("disabledReason" Core..=) Core.<$> disabledReason,
                  ("resultSetLastModifyTime" Core..=) Core.<$>
                    resultSetLastModifyTime,
                  ("resultSetLastReplaceTime" Core..=) Core.<$>
                    resultSetLastReplaceTime])


-- | Statistics for index pruning.
--
-- /See:/ 'newIndexPruningStats' smart constructor.
data IndexPruningStats = IndexPruningStats
    {
      -- | The base table reference.
      baseTable :: (Core.Maybe TableReference)
      -- | The number of parallel inputs after index pruning.
    , postIndexPruningParallelInputCount :: (Core.Maybe Core.Int64)
      -- | The number of parallel inputs before index pruning.
    , preIndexPruningParallelInputCount :: (Core.Maybe Core.Int64)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'IndexPruningStats' with the minimum fields required to make a request.
newIndexPruningStats 
    ::  IndexPruningStats
newIndexPruningStats
  = IndexPruningStats{baseTable = Core.Nothing,
                      postIndexPruningParallelInputCount = Core.Nothing,
                      preIndexPruningParallelInputCount = Core.Nothing}
instance Core.FromJSON IndexPruningStats where
        parseJSON
          = Core.withObject "IndexPruningStats"
              (\ o ->
                 IndexPruningStats Core.<$>
                   (o Core..:? "baseTable") Core.<*>
                     (o Core..:? "postIndexPruningParallelInputCount" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "preIndexPruningParallelInputCount" Core.<&>
                        Core.fmap Core.fromAsText))

instance Core.ToJSON IndexPruningStats where
        toJSON IndexPruningStats{..}
          = Core.object
              (Core.catMaybes
                 [("baseTable" Core..=) Core.<$> baseTable,
                  ("postIndexPruningParallelInputCount" Core..=) Core.. Core.AsText
                    Core.<$> postIndexPruningParallelInputCount,
                  ("preIndexPruningParallelInputCount" Core..=) Core.. Core.AsText
                    Core.<$> preIndexPruningParallelInputCount])
...
data JobConfiguration = JobConfiguration
    ...
    , maxSlots :: (Core.Maybe Core.Int32)
...
newJobConfiguration
  = JobConfiguration{copy = Core.Nothing, dryRun = Core.Nothing,
                     ...
                     maxSlots = Core.Nothing, query = Core.Nothing,
...
data JobConfigurationLoad = JobConfigurationLoad
    ...
    , schemaInlineFormat :: (Core.Maybe Core.Text)
      -- | Allows the schema of the destination table to be updated as a side effect of the load job if a schema is autodetected or supplied in the job configuration. Schema update options are supported in three cases: when writeDisposition is WRITE/APPEND; when writeDisposition is WRITE/TRUNCATE/DATA; when writeDisposition is WRITE/TRUNCATE and the destination table is a partition of a table, specified by partition decorators. For normal tables, WRITE/TRUNCATE will always overwrite the schema. One or more of the following values are specified: * ALLOW/FIELD/ADDITION: allow adding a nullable field to the schema. * ALLOW/FIELD_RELAXATION: allow relaxing a required field in the original schema to nullable.
...
data JobConfigurationQuery = JobConfigurationQuery
    ...
    , queryParameters :: (Core.Maybe [QueryParameter])
      -- | Range partitioning specification for the destination table. Only one of timePartitioning and rangePartitioning should be specified.
    , rangePartitioning :: (Core.Maybe RangePartitioning)
      -- | Allows the schema of the destination table to be updated as a side effect of the query job. Schema update options are supported in three cases: when writeDisposition is WRITE/APPEND; when writeDisposition is WRITE/TRUNCATE/DATA; when writeDisposition is WRITE/TRUNCATE and the destination table is a partition of a table, specified by partition decorators. For normal tables, WRITE/TRUNCATE will always overwrite the schema. One or more of the following values are specified: * ALLOW/FIELD/ADDITION: allow adding a nullable field to the schema. * ALLOW/FIELD_RELAXATION: allow relaxing a required field in the original schema to nullable.
    , schemaUpdateOptions :: (Core.Maybe [Core.Text])
...
-- | Reason about why a Job was created from a <https://cloud.google.com/bigquery/docs/reference/rest/v2/jobs/query jobs.query> method when used with @JOB_CREATION_OPTIONAL@ Job creation mode. For <https://cloud.google.com/bigquery/docs/reference/rest/v2/jobs/insert jobs.insert> method calls it will always be @REQUESTED@.
--
...
data JobStatistics = JobStatistics
    ...
    , reservationGroupPath :: (Core.Maybe [Core.Text])
...
newJobStatistics
  = JobStatistics{completionRatio = Core.Nothing,
                  ...
                  reservationGroupPath = Core.Nothing,
              ...
              (\ o ->
                 JobStatistics Core.<$>
                   (o Core..:? "completionRatio") Core.<*> (o Core..:? "copy")
                     ...
                     Core.<*> (o Core..:? "reservationGroupPath")
          ...
          = Core.object
              (Core.catMaybes
                 [("completionRatio" Core..=) Core.<$> completionRatio,
                  ...
                  ("reservationGroupPath" Core..=) Core.<$> reservationGroupPath,
...
data JobStatistics2 = JobStatistics2
    ...
    , incrementalResultStats :: (Core.Maybe IncrementalResultStats)
    ...
    , totalServicesSkuSlotMs :: (Core.Maybe Core.Int64)
      -- | Output only. Slot-milliseconds for the job.
    , totalSlotMs :: (Core.Maybe Core.Int64)
...
newJobStatistics2
  = JobStatistics2{biEngineStatistics = Core.Nothing,
                   ...
                   incrementalResultStats = Core.Nothing,
                   ...
                   totalServicesSkuSlotMs = Core.Nothing, totalSlotMs = Core.Nothing,
              ...
              (\ o ->
                 JobStatistics2 Core.<$>
                   (o Core..:? "biEngineStatistics") Core.<*>
                     ...
                     Core.<*> (o Core..:? "incrementalResultStats")
                     ...
                     (o Core..:? "totalPartitionsProcessed" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "totalServicesSkuSlotMs" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "totalSlotMs" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
          ...
          = Core.object
              (Core.catMaybes
                 [("biEngineStatistics" Core..=) Core.<$> biEngineStatistics,
                  ...
                  ("incrementalResultStats" Core..=) Core.<$> incrementalResultStats,
                  ...
                  ("totalServicesSkuSlotMs" Core..=) Core.. Core.AsText Core.<$>
...
--
-- /See:/ 'newPruningStats' smart constructor.
data PruningStats = PruningStats
    {
      -- | The number of parallel inputs matched.
      postCmetaPruningParallelInputCount :: (Core.Maybe Core.Int64)
      -- | The number of partitions matched.
    , postCmetaPruningPartitionCount :: (Core.Maybe Core.Int64)
      -- | The number of parallel inputs scanned.
    , preCmetaPruningParallelInputCount :: (Core.Maybe Core.Int64)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'PruningStats' with the minimum fields required to make a request.
newPruningStats 
    ::  PruningStats
newPruningStats
  = PruningStats{postCmetaPruningParallelInputCount = Core.Nothing,
                 postCmetaPruningPartitionCount = Core.Nothing,
                 preCmetaPruningParallelInputCount = Core.Nothing}
instance Core.FromJSON PruningStats where
        parseJSON
          = Core.withObject "PruningStats"
              (\ o ->
                 PruningStats Core.<$>
                   (o Core..:? "postCmetaPruningParallelInputCount" Core.<&>
                      Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "postCmetaPruningPartitionCount" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "preCmetaPruningParallelInputCount" Core.<&>
                        Core.fmap Core.fromAsText))

instance Core.ToJSON PruningStats where
        toJSON PruningStats{..}
          = Core.object
              (Core.catMaybes
                 [("postCmetaPruningParallelInputCount" Core..=) Core.. Core.AsText
                    Core.<$> postCmetaPruningParallelInputCount,
                  ("postCmetaPruningPartitionCount" Core..=) Core.. Core.AsText
                    Core.<$> postCmetaPruningPartitionCount,
                  ("preCmetaPruningParallelInputCount" Core..=) Core.. Core.AsText
                    Core.<$> preCmetaPruningParallelInputCount])


-- | Options for a user-defined Python function.
--
-- /See:/ 'newPythonOptions' smart constructor.
data PythonOptions = PythonOptions
    {
      ...
      -- | Optional. A list of Python package names along with versions to be installed. Example: [\"pandas>=2.1\", \"google-cloud-translate==3.11\"]. For more information, see <https://cloud.google.com/bigquery/docs/user-defined-functions-python#third-party-packages Use third-party packages>.
    , packages :: (Core.Maybe [Core.Text])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'PythonOptions' with the minimum fields required to make a request.
newPythonOptions 
    ::  PythonOptions
newPythonOptions
  = PythonOptions{entryPoint = Core.Nothing, packages = Core.Nothing}
instance Core.FromJSON PythonOptions where
        parseJSON
          = Core.withObject "PythonOptions"
              (\ o ->
                 PythonOptions Core.<$>
                   (o Core..:? "entryPoint") Core.<*> (o Core..:? "packages"))

instance Core.ToJSON PythonOptions where
        toJSON PythonOptions{..}
          = Core.object
              (Core.catMaybes
...
newQueryParameterType
  = QueryParameterType{arrayType = Core.Nothing,
                       ...
                       timestampPrecision = 6, type' = Core.Nothing}
              ...
              (\ o ->
                 QueryParameterType Core.<$>
                   (o Core..:? "arrayType") Core.<*> (o Core..:? "rangeElementType")
                     ...
                     Core.<*> (o Core..:? "timestampPrecision" Core..!= 6)
                     Core.<*> (o Core..:? "type"))
          ...
          = Core.object
              (Core.catMaybes
                 [("arrayType" Core..=) Core.<$> arrayType,
                  ...
                  Core.Just ("timestampPrecision" .= Core.AsText timestampPrecision),
                  ("type" Core..=) Core.<$> type'])
...
newQueryRequest
  = QueryRequest{connectionProperties = Core.Nothing,
                 ...
                 maxSlots = Core.Nothing, maximumBytesBilled = Core.Nothing,
                 parameterMode = Core.Nothing, preserveNulls = Core.Nothing,
                 query = Core.Nothing, queryParameters = Core.Nothing,
                 requestId = Core.Nothing, reservation = Core.Nothing,
                 timeoutMs = Core.Nothing, useLegacySql = Core.True,
                 useQueryCache = Core.True, writeIncrementalResults = Core.Nothing}
...
data QueryResponse = QueryResponse
    ...
    , errors :: (Core.Maybe [ErrorProto])
      -- | Whether the query has completed or not. If rows or totalRows are present, this will always be true. If this is false, totalRows will not be available.
    , jobComplete :: (Core.Maybe Core.Bool)
      -- | Optional. The reason why a Job was created. Only relevant when a job/reference is present in the response. If job/reference is not present it will always be unset.
    , jobCreationReason :: (Core.Maybe JobCreationReason)
...
data Routine = Routine
    ...
    , determinismLevel :: (Core.Maybe Routine_DeterminismLevel)
      -- | Output only. A hash of this resource.
    , etag :: (Core.Maybe Core.Text)
      -- | Optional. Options for the runtime of the external system executing the routine. This field is only applicable for Python UDFs. <https://cloud.google.com/products/#product-launch-stages Preview>
    , externalRuntimeOptions :: (Core.Maybe ExternalRuntimeOptions)
    ...
    , lastModifiedTime :: (Core.Maybe Core.Int64)
      -- | Optional. Options for the Python UDF. <https://cloud.google.com/products/#product-launch-stages Preview>
    , pythonOptions :: (Core.Maybe PythonOptions)
...
newRoutine
  = Routine{arguments = Core.Nothing, creationTime = Core.Nothing,
            ...
            etag = Core.Nothing, externalRuntimeOptions = Core.Nothing,
            importedLibraries = Core.Nothing, language = Core.Nothing,
            lastModifiedTime = Core.Nothing, pythonOptions = Core.Nothing,
              ...
              (\ o ->
                 Routine Core.<$>
                   (o Core..:? "arguments") Core.<*>
                     ...
                     Core.<*> (o Core..:? "etag")
                     Core.<*> (o Core..:? "externalRuntimeOptions")
                     Core.<*> (o Core..:? "importedLibraries")
                     Core.<*> (o Core..:? "language")
                     Core.<*>
                     (o Core..:? "lastModifiedTime" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "pythonOptions")
          ...
          = Core.object
              (Core.catMaybes
                 [("arguments" Core..=) Core.<$> arguments,
                  ...
                  ("etag" Core..=) Core.<$> etag,
                  ("externalRuntimeOptions" Core..=) Core.<$> externalRuntimeOptions,
                  ("importedLibraries" Core..=) Core.<$> importedLibraries,
                  ("language" Core..=) Core.<$> language,
                  ("lastModifiedTime" Core..=) Core.. Core.AsText Core.<$>
                    lastModifiedTime,
                  ("pythonOptions" Core..=) Core.<$> pythonOptions,
...
data SearchStatistics = SearchStatistics
    {
      ...
      indexPruningStats :: (Core.Maybe [IndexPruningStats])
...
newSearchStatistics 
    ::  SearchStatistics
newSearchStatistics
  = SearchStatistics{indexPruningStats = Core.Nothing,
          ...
          = Core.withObject "SearchStatistics"
              (\ o ->
                 SearchStatistics Core.<$>
                   (o Core..:? "indexPruningStats") Core.<*>
                     (o Core..:? "indexUnusedReasons")
...
instance Core.ToJSON SearchStatistics where
        toJSON SearchStatistics{..}
          = Core.object
              (Core.catMaybes
                 [("indexPruningStats" Core..=) Core.<$> indexPruningStats,
...
newTableFieldSchema
  = TableFieldSchema{categories = Core.Nothing,
                     ...
                     scale = Core.Nothing, timestampPrecision = 6, type' = Core.Nothing}
...
data TableMetadataCacheUsage = TableMetadataCacheUsage
    {
      ...
      -- | The column metadata index pruning statistics.
    , pruningStats :: (Core.Maybe PruningStats)
...
newTableMetadataCacheUsage
  = TableMetadataCacheUsage{explanation = Core.Nothing,
                            pruningStats = Core.Nothing, staleness = Core.Nothing,
                            tableReference = Core.Nothing, tableType = Core.Nothing,
          ...
          = Core.withObject "TableMetadataCacheUsage"
              (\ o ->
                 TableMetadataCacheUsage Core.<$>
                   (o Core..:? "explanation") Core.<*> (o Core..:? "pruningStats")
                     Core.<*> (o Core..:? "staleness")
                     Core.<*> (o Core..:? "tableReference")
          ...
          = Core.object
              (Core.catMaybes
                 [("explanation" Core..=) Core.<$> explanation,
                  ("pruningStats" Core..=) Core.<$> pruningStats,
...
data TrainingOptions = TrainingOptions
    ...
    , endpointIdleTtl :: (Core.Maybe Core.Duration)
    ...
    , huggingFaceModelId :: (Core.Maybe Core.Text)
    ...
    , maxParallelTrials :: (Core.Maybe Core.Int64)
      -- | The maximum number of machine replicas that will be deployed on an endpoint. The default value is equal to min/replica/count.
    , maxReplicaCount :: (Core.Maybe Core.Int64)
    ...
    , minReplicaCount :: (Core.Maybe Core.Int64)
      -- | Minimum split loss for boosted tree models.
    ...
    , modelGardenModelName :: (Core.Maybe Core.Text)
      -- | The model registry.
    ...
    , reservationAffinityKey :: (Core.Maybe Core.Text)
      -- | Specifies the reservation affinity type used to configure a Vertex AI resource. The default value is @NO_RESERVATION@.
    , reservationAffinityType :: (Core.Maybe TrainingOptions_ReservationAffinityType)
    ...
    , reservationAffinityValues :: (Core.Maybe [Core.Text])
...
newTrainingOptions
  = TrainingOptions{activationFn = Core.Nothing,
                    ...
                    enableGlobalExplain = Core.Nothing, endpointIdleTtl = Core.Nothing,
                    feedbackType = Core.Nothing, fitIntercept = Core.Nothing,
                    ...
                    huggingFaceModelId = Core.Nothing, includeDrift = Core.Nothing,
                    initialLearnRate = Core.Nothing, inputLabelColumns = Core.Nothing,
                    ...
                    learnRate = Core.Nothing, learnRateStrategy = Core.Nothing,
                    lossType = Core.Nothing, machineType = Core.Nothing,
                    maxIterations = Core.Nothing, maxParallelTrials = Core.Nothing,
                    maxReplicaCount = Core.Nothing, maxTimeSeriesLength = Core.Nothing,
                    maxTreeDepth = Core.Nothing, minAprioriSupport = Core.Nothing,
                    minRelativeProgress = Core.Nothing, minReplicaCount = Core.Nothing,
                    minSplitLoss = Core.Nothing, minTimeSeriesLength = Core.Nothing,
                    minTreeChildWeight = Core.Nothing,
                    modelGardenModelName = Core.Nothing, modelRegistry = Core.Nothing,
                    ...
                    reservationAffinityKey = Core.Nothing,
                    reservationAffinityType = Core.Nothing,
                    reservationAffinityValues = Core.Nothing,
              ...
              (\ o ->
                 TrainingOptions Core.<$>
                   (o Core..:? "activationFn") Core.<*>
                     ...
                     Core.<*> (o Core..:? "huggingFaceModelId")
                     ...
                     Core.<*>
                     (o Core..:? "maxReplicaCount" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "minReplicaCount" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "minSplitLoss")
                     Core.<*>
                     ...
                     (o Core..:? "minTreeChildWeight" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "modelGardenModelName")
                     ...
                     Core.<*> (o Core..:? "reservationAffinityKey")
                     Core.<*> (o Core..:? "reservationAffinityType")
                     Core.<*> (o Core..:? "reservationAffinityValues")
                     Core.<*>
          ...
          = Core.object
              (Core.catMaybes
                 [("activationFn" Core..=) Core.<$> activationFn,
                  ...
                  ("endpointIdleTtl" Core..=) Core.<$> endpointIdleTtl,
                  ...
                  ("huggingFaceModelId" Core..=) Core.<$> huggingFaceModelId,
                  ...
                  ("maxParallelTrials" Core..=) Core.. Core.AsText Core.<$>
                    maxParallelTrials,
                  ("maxReplicaCount" Core..=) Core.. Core.AsText Core.<$>
                    maxReplicaCount,
                  ...
                  ("minReplicaCount" Core..=) Core.. Core.AsText Core.<$>
                    minReplicaCount,
                  ("minSplitLoss" Core..=) Core.<$> minSplitLoss,
                  ...
                  ("minTreeChildWeight" Core..=) Core.. Core.AsText Core.<$>
                    minTreeChildWeight,
                  ("modelGardenModelName" Core..=) Core.<$> modelGardenModelName,
                  ...
                  ("reservationAffinityKey" Core..=) Core.<$> reservationAffinityKey,
                  ("reservationAffinityType" Core..=) Core.<$>
                    reservationAffinityType,
                  ("reservationAffinityValues" Core..=) Core.<$>
