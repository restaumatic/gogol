             ...
             "jobs" Core.:>
               Core.QueryParam "$.xgafv" Xgafv Core.:>
                 Core.QueryParam "access_token" Core.Text Core.:>
                   Core.QueryParam "allUsers" Core.Bool Core.:>
                     Core.QueryParam "callback" Core.Text Core.:>
                       Core.QueryParam "maxCreationTime" Core.Word64 Core.:>
                         Core.QueryParam "maxResults" Core.Word32 Core.:>
                           Core.QueryParam "minCreationTime" Core.Word64 Core.:>
                             Core.QueryParam "pageToken" Core.Text Core.:>
                               Core.QueryParam "parentJobId" Core.Text Core.:>
                                 Core.QueryParam "projection" JobsListProjection Core.:>
                                   Core.QueryParams "stateFilter" JobsListStateFilter Core.:>
                                     Core.QueryParam "uploadType" Core.Text Core.:>
                                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                                         Core.QueryParam "alt" Core.AltJSON Core.:>
                                           Core.Get '[Core.JSON] JobList
...
newBigQueryJobsList projectId
  = BigQueryJobsList{xgafv = Core.Nothing,
                     accessToken = Core.Nothing, allUsers = Core.Nothing,
                     callback = Core.Nothing, maxCreationTime = Core.Nothing,
                     maxResults = Core.Nothing, minCreationTime = Core.Nothing,
                     pageToken = Core.Nothing, parentJobId = Core.Nothing,
                     projectId = projectId, projection = Core.Nothing,
                     stateFilter = Core.Nothing, uploadType = Core.Nothing,
                     uploadProtocol = Core.Nothing}
instance Core.GoogleRequest BigQueryJobsList where
        type Rs BigQueryJobsList = JobList
        type Scopes BigQueryJobsList =
             '[Bigquery'FullControl, CloudPlatform'FullControl,
               CloudPlatform'ReadOnly]
        requestClient BigQueryJobsList{..}
          = go projectId xgafv accessToken allUsers callback maxCreationTime
              maxResults
              minCreationTime
              pageToken
              parentJobId
