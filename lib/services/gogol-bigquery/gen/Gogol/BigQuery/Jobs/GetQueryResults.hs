                 ...
                 Core.QueryParam "$.xgafv" Xgafv Core.:>
                   Core.QueryParam "access_token" Core.Text Core.:>
                     Core.QueryParam "callback" Core.Text Core.:>
                       Core.QueryParam "formatOptions.timestampOutputFormat"
...
data BigQueryJobsGetQueryResults = BigQueryJobsGetQueryResults
    ...
    , formatOptionsTimestampOutputFormat :: (Core.Maybe JobsGetQueryResultsFormatOptionsTimestampOutputFormat)
...
newBigQueryJobsGetQueryResults jobId projectId
  = BigQueryJobsGetQueryResults{xgafv = Core.Nothing,
                                ...
                                formatOptionsTimestampOutputFormat = Core.Nothing,
