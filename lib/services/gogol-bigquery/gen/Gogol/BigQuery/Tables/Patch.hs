...
newBigQueryTablesPatch datasetId payload projectId tableId
  = BigQueryTablesPatch{xgafv = Core.Nothing,
                        accessToken = Core.Nothing, autodetectSchema = Core.Nothing,
...
instance Core.GoogleRequest BigQueryTablesPatch where
        ...
        type Scopes BigQueryTablesPatch =
             '[Bigquery'FullControl, CloudPlatform'FullControl]
        requestClient BigQueryTablesPatch{..}
          = go projectId datasetId tableId xgafv accessToken autodetectSchema
              callback
              uploadType
              uploadProtocol
