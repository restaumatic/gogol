...
newBigQueryTablesSetIamPolicy payload resource
  = BigQueryTablesSetIamPolicy{xgafv = Core.Nothing,
                               accessToken = Core.Nothing, callback = Core.Nothing,
                               payload = payload, resource = resource, uploadType = Core.Nothing,
                               uploadProtocol = Core.Nothing}
instance Core.GoogleRequest BigQueryTablesSetIamPolicy where
        ...
        requestClient BigQueryTablesSetIamPolicy{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy BigQueryTablesSetIamPolicyResource)
                      Core.mempty
