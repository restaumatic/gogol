       ...
       "v2" Core.:>
         "projects" Core.:>
           Core.Capture "projectId" Core.Text Core.:>
             "datasets" Core.:>
               Core.CaptureMode "datasetId" "undelete" Core.Text Core.:>
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] UndeleteDatasetRequest Core.:>
...
newBigQueryDatasetsUndelete datasetId payload projectId
  = BigQueryDatasetsUndelete{xgafv = Core.Nothing,
...
instance Core.GoogleRequest BigQueryDatasetsUndelete where
        ...
        requestClient BigQueryDatasetsUndelete{..}
          = go projectId datasetId xgafv accessToken callback uploadType
              uploadProtocol
