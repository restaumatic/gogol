             ...
             "datasets" Core.:>
               Core.Capture "datasetId" Core.Text Core.:>
                 Core.QueryParam "$.xgafv" Xgafv Core.:>
                   Core.QueryParam "accessPolicyVersion" Core.Int32 Core.:>
                     Core.QueryParam "access_token" Core.Text Core.:>
                       Core.QueryParam "callback" Core.Text Core.:>
                         Core.QueryParam "updateMode" DatasetsPatchUpdateMode Core.:>
...
data BigQueryDatasetsPatch = BigQueryDatasetsPatch
    ...
    , updateMode :: (Core.Maybe DatasetsPatchUpdateMode)
...
newBigQueryDatasetsPatch datasetId payload projectId
  = BigQueryDatasetsPatch{xgafv = Core.Nothing,
                          accessPolicyVersion = Core.Nothing, accessToken = Core.Nothing,
                          callback = Core.Nothing, datasetId = datasetId, payload = payload,
                          projectId = projectId, updateMode = Core.Nothing,
...
instance Core.GoogleRequest BigQueryDatasetsPatch where
        ...
        type Scopes BigQueryDatasetsPatch =
             '[Bigquery'FullControl, CloudPlatform'FullControl]
        requestClient BigQueryDatasetsPatch{..}
          = go projectId datasetId xgafv accessPolicyVersion accessToken
              callback
              updateMode
              uploadType
              uploadProtocol
