...
newBigQueryDatasetsDelete datasetId projectId
  = BigQueryDatasetsDelete{xgafv = Core.Nothing,
                           accessToken = Core.Nothing, callback = Core.Nothing,
                           datasetId = datasetId, deleteContents = Core.Nothing,
...
instance Core.GoogleRequest BigQueryDatasetsDelete where
        ...
        requestClient BigQueryDatasetsDelete{..}
          = go projectId datasetId xgafv accessToken callback deleteContents
              uploadType
              uploadProtocol
