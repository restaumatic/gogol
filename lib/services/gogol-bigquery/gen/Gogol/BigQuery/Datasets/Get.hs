                   ...
                   Core.QueryParam "accessPolicyVersion" Core.Int32 Core.:>
                     Core.QueryParam "access_token" Core.Text Core.:>
                       Core.QueryParam "callback" Core.Text Core.:>
                         Core.QueryParam "datasetView" DatasetsGetDatasetView Core.:>
...
newBigQueryDatasetsGet datasetId projectId
  = BigQueryDatasetsGet{xgafv = Core.Nothing,
                        accessPolicyVersion = Core.Nothing, accessToken = Core.Nothing,
                        callback = Core.Nothing, datasetId = datasetId,
                        datasetView = Core.Nothing, projectId = projectId,
...
instance Core.GoogleRequest BigQueryDatasetsGet where
        ...
        requestClient BigQueryDatasetsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy BigQueryDatasetsGetResource)
                      Core.mempty
