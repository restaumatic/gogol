...
newBigQueryDatasetsInsert payload projectId
  = BigQueryDatasetsInsert{xgafv = Core.Nothing,
                           accessPolicyVersion = Core.Nothing, accessToken = Core.Nothing,
                           callback = Core.Nothing, payload = payload, projectId = projectId,
...
instance Core.GoogleRequest BigQueryDatasetsInsert where
        ...
        requestClient BigQueryDatasetsInsert{..}
          = go projectId xgafv accessPolicyVersion accessToken callback
              uploadType
              uploadProtocol
