...
newBigQueryModelsPatch datasetId modelId payload projectId
  = BigQueryModelsPatch{xgafv = Core.Nothing,
                        accessToken = Core.Nothing, callback = Core.Nothing,
                        datasetId = datasetId, modelId = modelId, payload = payload,
...
instance Core.GoogleRequest BigQueryModelsPatch where
        ...
        requestClient BigQueryModelsPatch{..}
          = go projectId datasetId modelId xgafv accessToken callback
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy BigQueryModelsPatchResource)
                      Core.mempty
