                                 ...
                                 Core.QueryParam "uploadType" Core.Text Core.:>
                                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                                     Core.QueryParam "alt" Core.AltJSON Core.:>
                                       Core.Get '[Core.JSON] ListRoutinesResponse
...
newBigQueryRoutinesList datasetId projectId
  = BigQueryRoutinesList{xgafv = Core.Nothing,
                         accessToken = Core.Nothing, callback = Core.Nothing,
                         datasetId = datasetId, filter = Core.Nothing,
                         maxResults = Core.Nothing, pageToken = Core.Nothing,
                         projectId = projectId, readMask = Core.Nothing,
...
instance Core.GoogleRequest BigQueryRoutinesList where
        ...
        requestClient BigQueryRoutinesList{..}
          = go projectId datasetId xgafv accessToken callback filter
              maxResults
              pageToken
              readMask
              uploadType
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy BigQueryRoutinesListResource)
                      Core.mempty
