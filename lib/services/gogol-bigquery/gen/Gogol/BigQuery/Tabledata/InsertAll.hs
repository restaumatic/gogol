                             ...
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.ReqBody '[Core.JSON] TableDataInsertAllRequest Core.:>
                                     Core.Post '[Core.JSON] TableDataInsertAllResponse
...
newBigQueryTabledataInsertAll datasetId payload projectId tableId
  = BigQueryTabledataInsertAll{xgafv = Core.Nothing,
                               accessToken = Core.Nothing, callback = Core.Nothing,
                               datasetId = datasetId, payload = payload, projectId = projectId,
                               tableId = tableId, uploadType = Core.Nothing,
                               uploadProtocol = Core.Nothing}
instance Core.GoogleRequest BigQueryTabledataInsertAll where
        type Rs BigQueryTabledataInsertAll = TableDataInsertAllResponse
        ...
        requestClient BigQueryTabledataInsertAll{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy BigQueryTabledataInsertAllResource)
                      Core.mempty
