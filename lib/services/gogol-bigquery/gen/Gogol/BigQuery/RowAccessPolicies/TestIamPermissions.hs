...
newBigQueryRowAccessPoliciesTestIamPermissions payload resource
  = BigQueryRowAccessPoliciesTestIamPermissions{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes BigQueryRowAccessPoliciesTestIamPermissions =
             '[Bigquery'FullControl, CloudPlatform'FullControl,
               CloudPlatform'ReadOnly]
        requestClient BigQueryRowAccessPoliciesTestIamPermissions{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy BigQueryRowAccessPoliciesTestIamPermissionsResource)
                      Core.mempty
