...
newBigQueryRowAccessPoliciesGetIamPolicy payload resource
  = BigQueryRowAccessPoliciesGetIamPolicy{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          payload = payload, resource = resource,
                                          uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest BigQueryRowAccessPoliciesGetIamPolicy
         where
        type Rs BigQueryRowAccessPoliciesGetIamPolicy = Policy
        type Scopes BigQueryRowAccessPoliciesGetIamPolicy =
             '[Bigquery'FullControl, CloudPlatform'FullControl,
               CloudPlatform'ReadOnly]
        requestClient BigQueryRowAccessPoliciesGetIamPolicy{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy BigQueryRowAccessPoliciesGetIamPolicyResource)
                      Core.mempty
