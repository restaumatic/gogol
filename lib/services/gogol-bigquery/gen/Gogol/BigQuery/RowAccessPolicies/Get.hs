                               ...
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.Get '[Core.JSON] RowAccessPolicy
...
newBigQueryRowAccessPoliciesGet 
    ...
    -> BigQueryRowAccessPoliciesGet
newBigQueryRowAccessPoliciesGet datasetId policyId projectId
  tableId
  = BigQueryRowAccessPoliciesGet{xgafv = Core.Nothing,
                                 accessToken = Core.Nothing, callback = Core.Nothing,
                                 datasetId = datasetId, policyId = policyId, projectId = projectId,
...
instance Core.GoogleRequest BigQueryRowAccessPoliciesGet where
        ...
        type Scopes BigQueryRowAccessPoliciesGet =
