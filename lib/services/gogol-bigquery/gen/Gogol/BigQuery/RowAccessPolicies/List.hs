                                 ...
                                 Core.QueryParam "uploadType" Core.Text Core.:>
                                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                                     Core.QueryParam "alt" Core.AltJSON Core.:>
                                       Core.Get '[Core.JSON] ListRowAccessPoliciesResponse
...
newBigQueryRowAccessPoliciesList datasetId projectId tableId
  = BigQueryRowAccessPoliciesList{xgafv = Core.Nothing,
                                  accessToken = Core.Nothing, callback = Core.Nothing,
                                  datasetId = datasetId, pageSize = Core.Nothing,
...
instance Core.GoogleRequest BigQueryRowAccessPoliciesList where
        type Rs BigQueryRowAccessPoliciesList =
             ListRowAccessPoliciesResponse
        type Scopes BigQueryRowAccessPoliciesList =
