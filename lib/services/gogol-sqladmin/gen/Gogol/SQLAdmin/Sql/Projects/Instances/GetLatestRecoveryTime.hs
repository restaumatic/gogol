...
--
-- /See:/ <https://cloud.google.com/sql/docs Cloud SQL Admin API Reference> for @sql.projects.instances.getLatestRecoveryTime@.
module Gogol.SQLAdmin.Sql.Projects.Instances.GetLatestRecoveryTime
    (
    -- * Resource
                 ...
                 Core.QueryParam "$.xgafv" Xgafv Core.:>
                   Core.QueryParam "access_token" Core.Text Core.:>
                     Core.QueryParam "callback" Core.Text Core.:>
                       Core.QueryParam "sourceInstanceDeletionTime" Core.DateTime Core.:>
