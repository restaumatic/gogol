...
module Gogol.SQLAdmin.Internal.Product
  (
    ...
    InstancesPreCheckMajorVersionUpgradeRequest (..),
    newInstancesPreCheckMajorVersionUpgradeRequest,
    ...
    PreCheckMajorVersionUpgradeContext (..),
    newPreCheckMajorVersionUpgradeContext,
    ...
    SqlInstancesExecuteSqlResponse (..),
    newSqlInstancesExecuteSqlResponse,
...
data CloneContext = CloneContext
    ...
    , sourceInstanceDeletionTime :: (Core.Maybe Core.DateTime)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newCloneContext
  = CloneContext{allocatedIpRange = Core.Nothing,
                 ...
                 sourceInstanceDeletionTime = Core.Nothing}
              ...
              (\ o ->
                 CloneContext Core.<$>
                   (o Core..:? "allocatedIpRange") Core.<*>
                     ...
                     Core.<*> (o Core..:? "sourceInstanceDeletionTime"))
          ...
          = Core.object
              (Core.catMaybes
                 [("allocatedIpRange" Core..=) Core.<$> allocatedIpRange,
                  ...
                  ("sourceInstanceDeletionTime" Core..=) Core.<$>
...
newColumn 
    ::  Column
newColumn = Column{name = Core.Nothing, type' = Core.Nothing}
instance Core.FromJSON Column where
        parseJSON
          = Core.withObject "Column"
              (\ o ->
                 Column Core.<$> (o Core..:? "name") Core.<*> (o Core..:? "type"))
...
data ConnectSettings = ConnectSettings
    ...
    , kind :: (Core.Maybe Core.Text)
      -- | Optional. Output only. mdx/protocol/support controls how the client uses metadata exchange when connecting to the instance. The values in the list representing parts of the MDX protocol that are supported by this instance. When the list is empty, the instance does not support MDX, so the client must not send an MDX request. The default is empty.
    , mdxProtocolSupport :: (Core.Maybe [ConnectSettings_MdxProtocolSupportItem])
...
newConnectSettings
  = ConnectSettings{backendType = Core.Nothing,
                    ...
                    dnsNames = Core.Nothing, ipAddresses = Core.Nothing,
                    kind = Core.Nothing, mdxProtocolSupport = Core.Nothing,
                    nodeCount = Core.Nothing, nodes = Core.Nothing,
                    pscEnabled = Core.Nothing, region = Core.Nothing,
                    serverCaCert = Core.Nothing, serverCaMode = Core.Nothing}
              ...
              (\ o ->
                 ConnectSettings Core.<$>
                   (o Core..:? "backendType") Core.<*>
                     ...
                     Core.<*> (o Core..:? "kind")
                     Core.<*> (o Core..:? "mdxProtocolSupport")
          ...
          = Core.object
              (Core.catMaybes
                 [("backendType" Core..=) Core.<$> backendType,
                  ...
                  ("ipAddresses" Core..=) Core.<$> ipAddresses,
                  ("kind" Core..=) Core.<$> kind,
                  ("mdxProtocolSupport" Core..=) Core.<$> mdxProtocolSupport,
...
data ConnectionPoolConfig = ConnectionPoolConfig
    ...
    , poolerCount :: (Core.Maybe Core.Int32)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newConnectionPoolConfig
  = ConnectionPoolConfig{connectionPoolingEnabled = Core.Nothing,
                         flags = Core.Nothing, poolerCount = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("connectionPoolingEnabled" Core..=) Core.<$>
                  ...
                  ("poolerCount" Core..=) Core.<$> poolerCount])
...
newDatabaseInstance
  = DatabaseInstance{availableMaintenanceVersions = Core.Nothing,
                     backendType = Core.Nothing, connectionName = Core.Nothing,
                     createTime = Core.Nothing, currentDiskSize = Core.Nothing,
...
--
-- /See:/ 'newExecuteSqlPayload' smart constructor.
data ExecuteSqlPayload = ExecuteSqlPayload
    {
      ...
      autoIamAuthn :: (Core.Maybe Core.Bool)
    ...
    , partialResultMode :: (Core.Maybe ExecuteSqlPayload_PartialResultMode)
      -- | Optional. The maximum number of rows returned per SQL statement.
    , rowLimit :: (Core.Maybe Core.Int64)
    ...
    , sqlStatement :: (Core.Maybe Core.Text)
...
-- | Creates a value of 'ExecuteSqlPayload' with the minimum fields required to make a request.
newExecuteSqlPayload 
    ::  ExecuteSqlPayload
newExecuteSqlPayload
  = ExecuteSqlPayload{autoIamAuthn = Core.Nothing,
                      database = Core.Nothing, partialResultMode = Core.Nothing,
                      rowLimit = Core.Nothing, sqlStatement = Core.Nothing,
                      user = Core.Nothing}
instance Core.FromJSON ExecuteSqlPayload where
        parseJSON
          = Core.withObject "ExecuteSqlPayload"
              (\ o ->
                 ExecuteSqlPayload Core.<$>
                   (o Core..:? "autoIamAuthn") Core.<*> (o Core..:? "database")
                     Core.<*> (o Core..:? "partialResultMode")
                     Core.<*> (o Core..:? "rowLimit" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "sqlStatement")
                     Core.<*> (o Core..:? "user"))

instance Core.ToJSON ExecuteSqlPayload where
        toJSON ExecuteSqlPayload{..}
          = Core.object
              (Core.catMaybes
                 [("autoIamAuthn" Core..=) Core.<$> autoIamAuthn,
                  ("database" Core..=) Core.<$> database,
                  ("partialResultMode" Core..=) Core.<$> partialResultMode,
                  ("rowLimit" Core..=) Core.. Core.AsText Core.<$> rowLimit,
                  ("sqlStatement" Core..=) Core.<$> sqlStatement,
                  ("user" Core..=) Core.<$> user])
...
--
-- /See:/ 'newFinalBackupConfig' smart constructor.
data FinalBackupConfig = FinalBackupConfig
    {
      -- | Whether the final backup is enabled for the instance.
      enabled :: (Core.Maybe Core.Bool)
      -- | The number of days to retain the final backup after the instance deletion. The final backup will be purged at (time/of/instance/deletion + retention/days).
    , retentionDays :: (Core.Maybe Core.Int32)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'FinalBackupConfig' with the minimum fields required to make a request.
newFinalBackupConfig 
    ::  FinalBackupConfig
newFinalBackupConfig
  = FinalBackupConfig{enabled = Core.Nothing,
                      retentionDays = Core.Nothing}
instance Core.FromJSON FinalBackupConfig where
        parseJSON
          = Core.withObject "FinalBackupConfig"
              (\ o ->
                 FinalBackupConfig Core.<$>
                   (o Core..:? "enabled") Core.<*> (o Core..:? "retentionDays"))

instance Core.ToJSON FinalBackupConfig where
        toJSON FinalBackupConfig{..}
          = Core.object
              (Core.catMaybes
                 [("enabled" Core..=) Core.<$> enabled,
...
--
-- /See:/ 'newInstancesPreCheckMajorVersionUpgradeRequest' smart constructor.
newtype InstancesPreCheckMajorVersionUpgradeRequest = InstancesPreCheckMajorVersionUpgradeRequest
    {
      -- | Required. Contains details about the pre-check major version upgrade operation.
      preCheckMajorVersionUpgradeContext :: (Core.Maybe PreCheckMajorVersionUpgradeContext)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'InstancesPreCheckMajorVersionUpgradeRequest' with the minimum fields required to make a request.
newInstancesPreCheckMajorVersionUpgradeRequest 
    :: 
                                               InstancesPreCheckMajorVersionUpgradeRequest
newInstancesPreCheckMajorVersionUpgradeRequest
  = InstancesPreCheckMajorVersionUpgradeRequest{preCheckMajorVersionUpgradeContext
                                                  = Core.Nothing}
instance Core.FromJSON InstancesPreCheckMajorVersionUpgradeRequest
         where
        parseJSON
          = Core.withObject "InstancesPreCheckMajorVersionUpgradeRequest"
              (\ o ->
                 InstancesPreCheckMajorVersionUpgradeRequest Core.<$>
                   (o Core..:? "preCheckMajorVersionUpgradeContext"))

instance Core.ToJSON InstancesPreCheckMajorVersionUpgradeRequest
         where
        toJSON InstancesPreCheckMajorVersionUpgradeRequest{..}
          = Core.object
              (Core.catMaybes
                 [("preCheckMajorVersionUpgradeContext" Core..=) Core.<$>
                    preCheckMajorVersionUpgradeContext])
...
data InstancesRestoreBackupRequest = InstancesRestoreBackupRequest
    ...
    , restoreBackupContext :: (Core.Maybe RestoreBackupContext)
      -- | Optional. This field has the same purpose as restore/instance/settings, changes any instance settings stored in the backup you are restoring from. With the difference that these fields are cleared in the settings.
    , restoreInstanceClearOverridesFieldNames :: (Core.Maybe [Core.Text])
...
newInstancesRestoreBackupRequest
  = InstancesRestoreBackupRequest{backup = Core.Nothing,
                                  ...
                                  restoreInstanceClearOverridesFieldNames = Core.Nothing,
              ...
              (\ o ->
                 InstancesRestoreBackupRequest Core.<$>
                   (o Core..:? "backup") Core.<*> (o Core..:? "backupdrBackup")
                     ...
                     Core.<*> (o Core..:? "restoreInstanceClearOverridesFieldNames")
          ...
          = Core.object
              (Core.catMaybes
                 [("backup" Core..=) Core.<$> backup,
                  ...
                  ("restoreInstanceClearOverridesFieldNames" Core..=) Core.<$>
...
newMessage 
    ::  Message
newMessage
  = Message{message = Core.Nothing, severity = Core.Nothing}
instance Core.FromJSON Message where
        parseJSON
          = Core.withObject "Message"
              (\ o ->
                 Message Core.<$>
                   (o Core..:? "message") Core.<*> (o Core..:? "severity"))
...
newtype Metadata = Metadata
    {
      ...
      sqlStatementExecutionTime :: (Core.Maybe Core.Duration)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newMetadata 
    ::  Metadata
newMetadata = Metadata{sqlStatementExecutionTime = Core.Nothing}
instance Core.FromJSON Metadata where
        parseJSON
          = Core.withObject "Metadata"
              (\ o -> Metadata Core.<$> (o Core..:? "sqlStatementExecutionTime"))

instance Core.ToJSON Metadata where
        toJSON Metadata{..}
          = Core.object
              (Core.catMaybes
                 [("sqlStatementExecutionTime" Core..=) Core.<$>
...
data Operation = Operation
    ...
    , operationType :: (Core.Maybe Operation_OperationType)
      -- | This field is only populated when the operation/type is PRE/CHECK/MAJOR/VERSION_UPGRADE. The PreCheckMajorVersionUpgradeContext message itself contains the details for that pre-check, such as the target database version for the upgrade and the results of the check (including any warnings or errors found).
    , preCheckMajorVersionUpgradeContext :: (Core.Maybe PreCheckMajorVersionUpgradeContext)
      -- | The URI of this resource.
    , selfLink :: (Core.Maybe Core.Text)
...
newOperation
  = Operation{acquireSsrsLeaseContext = Core.Nothing,
              ...
              preCheckMajorVersionUpgradeContext = Core.Nothing,
              selfLink = Core.Nothing, startTime = Core.Nothing,
              ...
              (\ o ->
                 Operation Core.<$>
                   (o Core..:? "acquireSsrsLeaseContext") Core.<*>
                     ...
                     Core.<*> (o Core..:? "preCheckMajorVersionUpgradeContext")
                     Core.<*> (o Core..:? "selfLink")
                     Core.<*> (o Core..:? "startTime")
                     Core.<*> (o Core..:? "status")
...
--
-- /See:/ 'newPreCheckMajorVersionUpgradeContext' smart constructor.
data PreCheckMajorVersionUpgradeContext = PreCheckMajorVersionUpgradeContext
    {
      -- | Optional. This is always @sql#preCheckMajorVersionUpgradeContext@.
      kind :: (Core.Maybe Core.Text)
      -- | Output only. The responses from the precheck operation.
    , preCheckResponse :: (Core.Maybe [PreCheckResponse])
      -- | Required. The target database version to upgrade to.
    , targetDatabaseVersion :: (Core.Maybe
   PreCheckMajorVersionUpgradeContext_TargetDatabaseVersion)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'PreCheckMajorVersionUpgradeContext' with the minimum fields required to make a request.
newPreCheckMajorVersionUpgradeContext 
    :: 
                                      PreCheckMajorVersionUpgradeContext
newPreCheckMajorVersionUpgradeContext
  = PreCheckMajorVersionUpgradeContext{kind = Core.Nothing,
                                       preCheckResponse = Core.Nothing,
                                       targetDatabaseVersion = Core.Nothing}
instance Core.FromJSON PreCheckMajorVersionUpgradeContext where
        parseJSON
          = Core.withObject "PreCheckMajorVersionUpgradeContext"
              (\ o ->
                 PreCheckMajorVersionUpgradeContext Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "preCheckResponse")
                     Core.<*> (o Core..:? "targetDatabaseVersion"))

instance Core.ToJSON PreCheckMajorVersionUpgradeContext where
        toJSON PreCheckMajorVersionUpgradeContext{..}
          = Core.object
              (Core.catMaybes
                 [("kind" Core..=) Core.<$> kind,
                  ("preCheckResponse" Core..=) Core.<$> preCheckResponse,
                  ("targetDatabaseVersion" Core..=) Core.<$> targetDatabaseVersion])


-- | Structured PreCheckResponse containing message, type, and required actions.
--
-- /See:/ 'newPreCheckResponse' smart constructor.
data PreCheckResponse = PreCheckResponse
    {
      -- | The actions that the user needs to take. Use repeated for multiple actions.
      actionsRequired :: (Core.Maybe [Core.Text])
      -- | The message to be displayed to the user.
    , message :: (Core.Maybe Core.Text)
      -- | The type of message whether it is an info, warning, or error.
    , messageType :: (Core.Maybe PreCheckResponse_MessageType)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'PreCheckResponse' with the minimum fields required to make a request.
newPreCheckResponse 
    ::  PreCheckResponse
newPreCheckResponse
  = PreCheckResponse{actionsRequired = Core.Nothing,
                     message = Core.Nothing, messageType = Core.Nothing}
instance Core.FromJSON PreCheckResponse where
        parseJSON
          = Core.withObject "PreCheckResponse"
              (\ o ->
                 PreCheckResponse Core.<$>
                   (o Core..:? "actionsRequired") Core.<*> (o Core..:? "message")
                     Core.<*> (o Core..:? "messageType"))

instance Core.ToJSON PreCheckResponse where
        toJSON PreCheckResponse{..}
          = Core.object
              (Core.catMaybes
                 [("actionsRequired" Core..=) Core.<$> actionsRequired,
                  ("message" Core..=) Core.<$> message,
...
--
-- /See:/ 'newQueryResult' smart constructor.
data QueryResult = QueryResult
    ...
    , partialResult :: (Core.Maybe Core.Bool)
      -- | Rows returned by the SQL statement.
    , rows :: (Core.Maybe [Row])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'QueryResult' with the minimum fields required to make a request.
newQueryResult 
    ::  QueryResult
newQueryResult
  = QueryResult{columns = Core.Nothing, message = Core.Nothing,
                partialResult = Core.Nothing, rows = Core.Nothing}
instance Core.FromJSON QueryResult where
        parseJSON
          = Core.withObject "QueryResult"
              (\ o ->
                 QueryResult Core.<$>
                   (o Core..:? "columns") Core.<*> (o Core..:? "message") Core.<*>
                     (o Core..:? "partialResult")
                     Core.<*> (o Core..:? "rows"))

instance Core.ToJSON QueryResult where
        toJSON QueryResult{..}
          = Core.object
              (Core.catMaybes
                 [("columns" Core..=) Core.<$> columns,
                  ("message" Core..=) Core.<$> message,
                  ("partialResult" Core..=) Core.<$> partialResult,
                  ("rows" Core..=) Core.<$> rows])


-- | The read pool auto-scale configuration.
--
-- /See:/ 'newReadPoolAutoScaleConfig' smart constructor.
data ReadPoolAutoScaleConfig = ReadPoolAutoScaleConfig
    {
    ...
    , scaleInCooldownSeconds :: (Core.Maybe Core.Int32)
      -- | The cooldown period for scale-out operations.
    , scaleOutCooldownSeconds :: (Core.Maybe Core.Int32)
      -- | Optional. Target metrics for read pool auto scaling.
    , targetMetrics :: (Core.Maybe [TargetMetric])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'ReadPoolAutoScaleConfig' with the minimum fields required to make a request.
newReadPoolAutoScaleConfig 
    ::  ReadPoolAutoScaleConfig
newReadPoolAutoScaleConfig
  = ReadPoolAutoScaleConfig{disableScaleIn = Core.Nothing,
                            enabled = Core.Nothing, maxNodeCount = Core.Nothing,
                            minNodeCount = Core.Nothing, scaleInCooldownSeconds = Core.Nothing,
                            scaleOutCooldownSeconds = Core.Nothing,
                            targetMetrics = Core.Nothing}
instance Core.FromJSON ReadPoolAutoScaleConfig where
        parseJSON
          = Core.withObject "ReadPoolAutoScaleConfig"
              (\ o ->
                 ReadPoolAutoScaleConfig Core.<$>
                   (o Core..:? "disableScaleIn") Core.<*> (o Core..:? "enabled")
                     Core.<*> (o Core..:? "maxNodeCount")
                     Core.<*> (o Core..:? "minNodeCount")
                     Core.<*> (o Core..:? "scaleInCooldownSeconds")
                     Core.<*> (o Core..:? "scaleOutCooldownSeconds")
                     Core.<*> (o Core..:? "targetMetrics"))

instance Core.ToJSON ReadPoolAutoScaleConfig where
        toJSON ReadPoolAutoScaleConfig{..}
          = Core.object
              (Core.catMaybes
                 [("disableScaleIn" Core..=) Core.<$> disableScaleIn,
                  ...
                  ("scaleInCooldownSeconds" Core..=) Core.<$> scaleInCooldownSeconds,
                  ("scaleOutCooldownSeconds" Core..=) Core.<$>
                    scaleOutCooldownSeconds,
                  ("targetMetrics" Core..=) Core.<$> targetMetrics])
...
newRow 
    ::  Row
newRow = Row{values = Core.Nothing}
instance Core.FromJSON Row where
        parseJSON
          = Core.withObject "Row" (\ o -> Row Core.<$> (o Core..:? "values"))
...
data Settings = Settings
    ...
    , finalBackupConfig :: (Core.Maybe FinalBackupConfig)
    ...
    , readPoolAutoScaleConfig :: (Core.Maybe ReadPoolAutoScaleConfig)
...
newSettings
  = Settings{activationPolicy = Core.Nothing,
             ...
             finalBackupConfig = Core.Nothing, insightsConfig = Core.Nothing,
             ipConfiguration = Core.Nothing, kind = Core.Nothing,
             locationPreference = Core.Nothing,
             maintenanceWindow = Core.Nothing,
             passwordValidationPolicy = Core.Nothing,
             pricingPlan = Core.Nothing, readPoolAutoScaleConfig = Core.Nothing,
              ...
              (\ o ->
                 Settings Core.<$>
                   (o Core..:? "activationPolicy") Core.<*>
                     ...
                     Core.<*> (o Core..:? "readPoolAutoScaleConfig")
          ...
          = Core.object
              (Core.catMaybes
                 [("activationPolicy" Core..=) Core.<$> activationPolicy,
                  ...
                  ("finalBackupConfig" Core..=) Core.<$> finalBackupConfig,
                  ...
                  ("readPoolAutoScaleConfig" Core..=) Core.<$>
                    readPoolAutoScaleConfig,
...
data SqlActiveDirectoryConfig = SqlActiveDirectoryConfig
    {
      ...
      adminCredentialSecretName :: (Core.Maybe Core.Text)
    ...
    , mode :: (Core.Maybe SqlActiveDirectoryConfig_Mode)
...
newSqlActiveDirectoryConfig 
    ::  SqlActiveDirectoryConfig
newSqlActiveDirectoryConfig
  = SqlActiveDirectoryConfig{adminCredentialSecretName =
                               Core.Nothing,
                             dnsServers = Core.Nothing, domain = Core.Nothing,
                             kind = Core.Nothing, mode = Core.Nothing,
          ...
          = Core.withObject "SqlActiveDirectoryConfig"
              (\ o ->
                 SqlActiveDirectoryConfig Core.<$>
                   (o Core..:? "adminCredentialSecretName") Core.<*>
                     (o Core..:? "dnsServers")
                     Core.<*> (o Core..:? "domain")
                     Core.<*> (o Core..:? "kind")
                     Core.<*> (o Core..:? "mode")
                     Core.<*> (o Core..:? "organizationalUnit"))

instance Core.ToJSON SqlActiveDirectoryConfig where
        toJSON SqlActiveDirectoryConfig{..}
          = Core.object
              (Core.catMaybes
                 [("adminCredentialSecretName" Core..=) Core.<$>
                    adminCredentialSecretName,
                  ("dnsServers" Core..=) Core.<$> dnsServers,
                  ("domain" Core..=) Core.<$> domain, ("kind" Core..=) Core.<$> kind,
                  ("mode" Core..=) Core.<$> mode,
...
--
-- /See:/ 'newSqlInstancesExecuteSqlResponse' smart constructor.
data SqlInstancesExecuteSqlResponse = SqlInstancesExecuteSqlResponse
    {
    ...
    , results :: (Core.Maybe [QueryResult])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'SqlInstancesExecuteSqlResponse' with the minimum fields required to make a request.
newSqlInstancesExecuteSqlResponse 
    ::  SqlInstancesExecuteSqlResponse
newSqlInstancesExecuteSqlResponse
  = SqlInstancesExecuteSqlResponse{messages = Core.Nothing,
                                   metadata = Core.Nothing, results = Core.Nothing}
instance Core.FromJSON SqlInstancesExecuteSqlResponse where
        parseJSON
          = Core.withObject "SqlInstancesExecuteSqlResponse"
              (\ o ->
                 SqlInstancesExecuteSqlResponse Core.<$>
                   (o Core..:? "messages") Core.<*> (o Core..:? "metadata") Core.<*>
                     (o Core..:? "results"))

instance Core.ToJSON SqlInstancesExecuteSqlResponse where
        toJSON SqlInstancesExecuteSqlResponse{..}
          = Core.object
              (Core.catMaybes
...
data SqlInstancesGetLatestRecoveryTimeResponse = SqlInstancesGetLatestRecoveryTimeResponse
    {
      ...
      earliestRecoveryTime :: (Core.Maybe Core.DateTime)
...
newSqlInstancesGetLatestRecoveryTimeResponse 
    :: 
                                             SqlInstancesGetLatestRecoveryTimeResponse
newSqlInstancesGetLatestRecoveryTimeResponse
  = SqlInstancesGetLatestRecoveryTimeResponse{earliestRecoveryTime =
                                                Core.Nothing,
                                              kind = Core.Nothing,
          ...
          = Core.withObject "SqlInstancesGetLatestRecoveryTimeResponse"
              (\ o ->
                 SqlInstancesGetLatestRecoveryTimeResponse Core.<$>
                   (o Core..:? "earliestRecoveryTime") Core.<*> (o Core..:? "kind")
...
instance Core.ToJSON SqlInstancesGetLatestRecoveryTimeResponse
        ...
        toJSON SqlInstancesGetLatestRecoveryTimeResponse{..}
          = Core.object
              (Core.catMaybes
                 [("earliestRecoveryTime" Core..=) Core.<$> earliestRecoveryTime,
                  ("kind" Core..=) Core.<$> kind,
...
data SqlInstancesStartExternalSyncRequest = SqlInstancesStartExternalSyncRequest
    ...
    , replicaOverwriteEnabled :: (Core.Maybe Core.Bool)
...
newSqlInstancesStartExternalSyncRequest
  = SqlInstancesStartExternalSyncRequest{migrationType =
                                         ...
                                         replicaOverwriteEnabled = Core.Nothing,
              ...
              (\ o ->
                 SqlInstancesStartExternalSyncRequest Core.<$>
                   (o Core..:? "migrationType") Core.<*>
                     ...
                     Core.<*> (o Core..:? "replicaOverwriteEnabled")
          ...
          = Core.object
              (Core.catMaybes
                 [("migrationType" Core..=) Core.<$> migrationType,
                  ...
                  ("replicaOverwriteEnabled" Core..=) Core.<$>
...
--
-- /See:/ 'newTargetMetric' smart constructor.
data TargetMetric = TargetMetric
    {
      -- | The metric name to be used for auto scaling.
      metric :: (Core.Maybe Core.Text)
      -- | The target value for the metric.
    , targetValue :: (Core.Maybe Core.Double)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'TargetMetric' with the minimum fields required to make a request.
newTargetMetric 
    ::  TargetMetric
newTargetMetric
  = TargetMetric{metric = Core.Nothing, targetValue = Core.Nothing}
instance Core.FromJSON TargetMetric where
        parseJSON
          = Core.withObject "TargetMetric"
              (\ o ->
                 TargetMetric Core.<$>
                   (o Core..:? "metric") Core.<*> (o Core..:? "targetValue"))

instance Core.ToJSON TargetMetric where
        toJSON TargetMetric{..}
          = Core.object
              (Core.catMaybes
                 [("metric" Core..=) Core.<$> metric,
                  ("targetValue" Core..=) Core.<$> targetValue])
...
data User = User
    ...
    , iamStatus :: (Core.Maybe User_IamStatus)
...
newUser
  = User{dualPasswordType = Core.Nothing, etag = Core.Nothing,
         host = Core.Nothing, iamStatus = Core.Nothing,
         instance' = Core.Nothing, kind = Core.Nothing, name = Core.Nothing,
         password = Core.Nothing, passwordPolicy = Core.Nothing,
         project = Core.Nothing, sqlserverUserDetails = Core.Nothing,
         type' = Core.Nothing}
...
data Value = Value
    {
      ...
      nullValue :: (Core.Maybe Core.Bool)
...
newValue 
    ::  Value
newValue = Value{nullValue = Core.Nothing, value = Core.Nothing}
instance Core.FromJSON Value where
        parseJSON
          = Core.withObject "Value"
              (\ o ->
                 Value Core.<$>
                   (o Core..:? "nullValue") Core.<*> (o Core..:? "value"))
