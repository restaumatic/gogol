...
--
-- /See:/ <https://cloud.google.com/sql/docs Cloud SQL Admin API Reference>
module Gogol.SQLAdmin
    (
    -- * Configuration
      sQLAdminService
...
import Gogol.SQLAdmin.Sql.Instances.ExecuteSql
...
import Gogol.SQLAdmin.Sql.Instances.PreCheckMajorVersionUpgrade
