                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] GoogleCloudDialogflowCxV3ListAgentsResponse
...
newDialogFlowProjectsLocationsAgentsList parent
  = DialogFlowProjectsLocationsAgentsList{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          pageSize = Core.Nothing, pageToken = Core.Nothing,
                                          parent = parent, uploadType = Core.Nothing,
                                          uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DialogFlowProjectsLocationsAgentsList
         where
        type Rs DialogFlowProjectsLocationsAgentsList =
             GoogleCloudDialogflowCxV3ListAgentsResponse
        type Scopes DialogFlowProjectsLocationsAgentsList =
