                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.Get '[Core.JSON] GoogleCloudDialogflowCxV3Generator
...
newDialogFlowProjectsLocationsAgentsGeneratorsGet name
  = DialogFlowProjectsLocationsAgentsGeneratorsGet{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsGeneratorsGet
         where
        type Rs DialogFlowProjectsLocationsAgentsGeneratorsGet =
             GoogleCloudDialogflowCxV3Generator
        type Scopes DialogFlowProjectsLocationsAgentsGeneratorsGet =
