...
newDialogFlowProjectsLocationsAgentsEntityTypesDelete name
  = DialogFlowProjectsLocationsAgentsEntityTypesDelete{xgafv =
                                                         Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsEntityTypesDelete
         where
        type Rs DialogFlowProjectsLocationsAgentsEntityTypesDelete =
             GoogleProtobufEmpty
        type Scopes DialogFlowProjectsLocationsAgentsEntityTypesDelete =
