...
newDialogFlowProjectsLocationsAgentsDelete name
  = DialogFlowProjectsLocationsAgentsDelete{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            name = name, uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DialogFlowProjectsLocationsAgentsDelete
         where
        type Rs DialogFlowProjectsLocationsAgentsDelete =
             GoogleProtobufEmpty
        type Scopes DialogFlowProjectsLocationsAgentsDelete =
