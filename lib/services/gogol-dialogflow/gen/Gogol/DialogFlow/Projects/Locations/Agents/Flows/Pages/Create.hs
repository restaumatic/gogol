                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] GoogleCloudDialogflowCxV3Page Core.:>
                           Core.Post '[Core.JSON] GoogleCloudDialogflowCxV3Page
...
newDialogFlowProjectsLocationsAgentsFlowsPagesCreate parent payload
  = DialogFlowProjectsLocationsAgentsFlowsPagesCreate{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsFlowsPagesCreate
         where
        type Rs DialogFlowProjectsLocationsAgentsFlowsPagesCreate =
             GoogleCloudDialogflowCxV3Page
        type Scopes DialogFlowProjectsLocationsAgentsFlowsPagesCreate =
