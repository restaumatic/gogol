...
newDialogFlowProjectsLocationsSecuritySettingsDelete name
  = DialogFlowProjectsLocationsSecuritySettingsDelete{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsSecuritySettingsDelete
         where
        type Rs DialogFlowProjectsLocationsSecuritySettingsDelete =
             GoogleProtobufEmpty
        type Scopes DialogFlowProjectsLocationsSecuritySettingsDelete =
