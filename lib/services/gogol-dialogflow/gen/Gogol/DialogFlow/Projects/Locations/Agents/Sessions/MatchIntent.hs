...
type DialogFlowProjectsLocationsAgentsSessionsMatchIntentResource =
     "v3" Core.:>
       Core.CaptureMode "session" "matchIntent" Core.Text Core.:>
                 ...
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON]
                       ...
                       Core.:>
                       Core.Post '[Core.JSON] GoogleCloudDialogflowCxV3MatchIntentResponse
...
newDialogFlowProjectsLocationsAgentsSessionsMatchIntent 
    ...
    -> DialogFlowProjectsLocationsAgentsSessionsMatchIntent
newDialogFlowProjectsLocationsAgentsSessionsMatchIntent payload
  session
  = DialogFlowProjectsLocationsAgentsSessionsMatchIntent{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsSessionsMatchIntent
         where
        type Rs DialogFlowProjectsLocationsAgentsSessionsMatchIntent =
             GoogleCloudDialogflowCxV3MatchIntentResponse
        type Scopes DialogFlowProjectsLocationsAgentsSessionsMatchIntent =
