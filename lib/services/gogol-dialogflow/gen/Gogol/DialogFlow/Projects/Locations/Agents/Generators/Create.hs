                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] GoogleCloudDialogflowCxV3Generator
...
newDialogFlowProjectsLocationsAgentsGeneratorsCreate parent payload
  = DialogFlowProjectsLocationsAgentsGeneratorsCreate{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsGeneratorsCreate
         where
        type Rs DialogFlowProjectsLocationsAgentsGeneratorsCreate =
             GoogleCloudDialogflowCxV3Generator
        type Scopes DialogFlowProjectsLocationsAgentsGeneratorsCreate =
