...
type DialogFlowProjectsLocationsAgentsFlowsTrainResource =
     "v3" Core.:>
       Core.CaptureMode "name" "train" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] GoogleCloudDialogflowCxV3TrainFlowRequest
...
newDialogFlowProjectsLocationsAgentsFlowsTrain name payload
  = DialogFlowProjectsLocationsAgentsFlowsTrain{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsFlowsTrain
         where
        type Rs DialogFlowProjectsLocationsAgentsFlowsTrain =
             GoogleLongrunningOperation
        type Scopes DialogFlowProjectsLocationsAgentsFlowsTrain =
