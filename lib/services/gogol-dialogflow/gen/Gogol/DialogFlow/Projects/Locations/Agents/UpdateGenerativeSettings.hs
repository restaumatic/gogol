                   ...
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON]
                         ...
                         Core.:>
                         Core.Patch '[Core.JSON] GoogleCloudDialogflowCxV3GenerativeSettings
...
newDialogFlowProjectsLocationsAgentsUpdateGenerativeSettings 
    ...
    -> DialogFlowProjectsLocationsAgentsUpdateGenerativeSettings
newDialogFlowProjectsLocationsAgentsUpdateGenerativeSettings name
  payload
  = DialogFlowProjectsLocationsAgentsUpdateGenerativeSettings{xgafv =
                                                                Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsUpdateGenerativeSettings
         where
        type Rs DialogFlowProjectsLocationsAgentsUpdateGenerativeSettings =
             GoogleCloudDialogflowCxV3GenerativeSettings
        type Scopes
               DialogFlowProjectsLocationsAgentsUpdateGenerativeSettings
