                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.Get '[Core.JSON] GoogleCloudDialogflowCxV3GenerativeSettings
...
newDialogFlowProjectsLocationsAgentsGetGenerativeSettings name
  = DialogFlowProjectsLocationsAgentsGetGenerativeSettings{xgafv =
                                                             Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsGetGenerativeSettings
         where
        type Rs DialogFlowProjectsLocationsAgentsGetGenerativeSettings =
             GoogleCloudDialogflowCxV3GenerativeSettings
        type Scopes DialogFlowProjectsLocationsAgentsGetGenerativeSettings
