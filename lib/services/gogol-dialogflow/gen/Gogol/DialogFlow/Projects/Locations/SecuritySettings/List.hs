...
newDialogFlowProjectsLocationsSecuritySettingsList parent
  = DialogFlowProjectsLocationsSecuritySettingsList{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsSecuritySettingsList
         where
        type Rs DialogFlowProjectsLocationsSecuritySettingsList =
             GoogleCloudDialogflowCxV3ListSecuritySettingsResponse
        type Scopes DialogFlowProjectsLocationsSecuritySettingsList =
