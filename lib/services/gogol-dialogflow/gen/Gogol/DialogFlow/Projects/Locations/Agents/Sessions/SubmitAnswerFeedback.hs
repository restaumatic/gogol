...
type DialogFlowProjectsLocationsAgentsSessionsSubmitAnswerFeedbackResource
     =
     "v3" Core.:>
       Core.CaptureMode "session" "submitAnswerFeedback" Core.Text Core.:>
                 ...
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON]
                       ...
                       Core.:>
                       Core.Post '[Core.JSON] GoogleCloudDialogflowCxV3AnswerFeedback
...
newDialogFlowProjectsLocationsAgentsSessionsSubmitAnswerFeedback
  payload session
  = DialogFlowProjectsLocationsAgentsSessionsSubmitAnswerFeedback{xgafv
                                                                    = Core.Nothing,
