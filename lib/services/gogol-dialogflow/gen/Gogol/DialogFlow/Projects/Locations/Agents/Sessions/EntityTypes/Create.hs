                   ...
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON]
                         ...
                         Core.:>
                         Core.Post '[Core.JSON] GoogleCloudDialogflowCxV3SessionEntityType
...
newDialogFlowProjectsLocationsAgentsSessionsEntityTypesCreate
  parent payload
  = DialogFlowProjectsLocationsAgentsSessionsEntityTypesCreate{xgafv
                                                                 = Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsSessionsEntityTypesCreate
         where
        type Rs DialogFlowProjectsLocationsAgentsSessionsEntityTypesCreate
             = GoogleCloudDialogflowCxV3SessionEntityType
        type Scopes
               DialogFlowProjectsLocationsAgentsSessionsEntityTypesCreate
