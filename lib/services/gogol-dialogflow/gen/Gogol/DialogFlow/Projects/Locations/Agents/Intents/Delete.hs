...
newDialogFlowProjectsLocationsAgentsIntentsDelete name
  = DialogFlowProjectsLocationsAgentsIntentsDelete{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsIntentsDelete
         where
        type Rs DialogFlowProjectsLocationsAgentsIntentsDelete =
             GoogleProtobufEmpty
        type Scopes DialogFlowProjectsLocationsAgentsIntentsDelete =
