                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] GoogleCloudDialogflowCxV3EntityType
...
newDialogFlowProjectsLocationsAgentsEntityTypesCreate 
    ...
    -> DialogFlowProjectsLocationsAgentsEntityTypesCreate
newDialogFlowProjectsLocationsAgentsEntityTypesCreate parent
  payload
  = DialogFlowProjectsLocationsAgentsEntityTypesCreate{xgafv =
                                                         Core.Nothing,
                                                       accessToken = Core.Nothing,
                                                       callback = Core.Nothing,
                                                       languageCode = Core.Nothing, parent = parent,
                                                       payload = payload, uploadType = Core.Nothing,
                                                       uploadProtocol = Core.Nothing}
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsEntityTypesCreate
         where
        type Rs DialogFlowProjectsLocationsAgentsEntityTypesCreate =
             GoogleCloudDialogflowCxV3EntityType
        type Scopes DialogFlowProjectsLocationsAgentsEntityTypesCreate =
             '[CloudPlatform'FullControl, Dialogflow'FullControl]
        requestClient
          DialogFlowProjectsLocationsAgentsEntityTypesCreate{..}
          = go parent xgafv accessToken callback languageCode uploadType
              uploadProtocol
