...
newDialogFlowProjectsLocationsAgentsValidate name payload
  = DialogFlowProjectsLocationsAgentsValidate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsValidate
         where
        type Rs DialogFlowProjectsLocationsAgentsValidate =
             GoogleCloudDialogflowCxV3AgentValidationResult
        type Scopes DialogFlowProjectsLocationsAgentsValidate =
