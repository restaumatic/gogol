                     ...
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] GoogleCloudDialogflowCxV3Flow Core.:>
                           Core.Post '[Core.JSON] GoogleCloudDialogflowCxV3Flow
...
newDialogFlowProjectsLocationsAgentsFlowsCreate parent payload
  = DialogFlowProjectsLocationsAgentsFlowsCreate{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsFlowsCreate
         where
        type Rs DialogFlowProjectsLocationsAgentsFlowsCreate =
             GoogleCloudDialogflowCxV3Flow
        type Scopes DialogFlowProjectsLocationsAgentsFlowsCreate =
