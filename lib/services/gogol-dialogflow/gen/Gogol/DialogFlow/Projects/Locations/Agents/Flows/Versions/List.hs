                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] GoogleCloudDialogflowCxV3ListVersionsResponse
...
newDialogFlowProjectsLocationsAgentsFlowsVersionsList parent
  = DialogFlowProjectsLocationsAgentsFlowsVersionsList{xgafv =
                                                         Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsFlowsVersionsList
         where
        type Rs DialogFlowProjectsLocationsAgentsFlowsVersionsList =
             GoogleCloudDialogflowCxV3ListVersionsResponse
        type Scopes DialogFlowProjectsLocationsAgentsFlowsVersionsList =
