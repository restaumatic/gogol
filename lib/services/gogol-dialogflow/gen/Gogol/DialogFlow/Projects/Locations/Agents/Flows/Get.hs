                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.Get '[Core.JSON] GoogleCloudDialogflowCxV3Flow
...
newDialogFlowProjectsLocationsAgentsFlowsGet name
  = DialogFlowProjectsLocationsAgentsFlowsGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsFlowsGet
         where
        type Rs DialogFlowProjectsLocationsAgentsFlowsGet =
             GoogleCloudDialogflowCxV3Flow
        type Scopes DialogFlowProjectsLocationsAgentsFlowsGet =
