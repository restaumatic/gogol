                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] GoogleCloudDialogflowCxV3TestCase Core.:>
                         Core.Post '[Core.JSON] GoogleCloudDialogflowCxV3TestCase
...
newDialogFlowProjectsLocationsAgentsTestCasesCreate parent payload
  = DialogFlowProjectsLocationsAgentsTestCasesCreate{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsTestCasesCreate
         where
        type Rs DialogFlowProjectsLocationsAgentsTestCasesCreate =
             GoogleCloudDialogflowCxV3TestCase
        type Scopes DialogFlowProjectsLocationsAgentsTestCasesCreate =
