                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] GoogleCloudDialogflowCxV3Intent Core.:>
                           Core.Post '[Core.JSON] GoogleCloudDialogflowCxV3Intent
...
newDialogFlowProjectsLocationsAgentsIntentsCreate parent payload
  = DialogFlowProjectsLocationsAgentsIntentsCreate{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsIntentsCreate
         where
        type Rs DialogFlowProjectsLocationsAgentsIntentsCreate =
             GoogleCloudDialogflowCxV3Intent
        type Scopes DialogFlowProjectsLocationsAgentsIntentsCreate =
