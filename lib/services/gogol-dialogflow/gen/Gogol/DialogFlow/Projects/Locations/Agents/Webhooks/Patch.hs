                   ...
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] GoogleCloudDialogflowCxV3Webhook Core.:>
                         Core.Patch '[Core.JSON] GoogleCloudDialogflowCxV3Webhook
...
newDialogFlowProjectsLocationsAgentsWebhooksPatch name payload
  = DialogFlowProjectsLocationsAgentsWebhooksPatch{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsWebhooksPatch
         where
        type Rs DialogFlowProjectsLocationsAgentsWebhooksPatch =
             GoogleCloudDialogflowCxV3Webhook
        type Scopes DialogFlowProjectsLocationsAgentsWebhooksPatch =
