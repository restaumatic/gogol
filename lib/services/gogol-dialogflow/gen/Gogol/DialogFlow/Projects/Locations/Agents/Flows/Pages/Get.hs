                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.Get '[Core.JSON] GoogleCloudDialogflowCxV3Page
...
newDialogFlowProjectsLocationsAgentsFlowsPagesGet name
  = DialogFlowProjectsLocationsAgentsFlowsPagesGet{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsFlowsPagesGet
         where
        type Rs DialogFlowProjectsLocationsAgentsFlowsPagesGet =
             GoogleCloudDialogflowCxV3Page
        type Scopes DialogFlowProjectsLocationsAgentsFlowsPagesGet =
