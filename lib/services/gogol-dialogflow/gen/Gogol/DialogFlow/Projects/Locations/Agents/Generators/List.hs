...
newDialogFlowProjectsLocationsAgentsGeneratorsList parent
  = DialogFlowProjectsLocationsAgentsGeneratorsList{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsGeneratorsList
         where
        type Rs DialogFlowProjectsLocationsAgentsGeneratorsList =
             GoogleCloudDialogflowCxV3ListGeneratorsResponse
        type Scopes DialogFlowProjectsLocationsAgentsGeneratorsList =
