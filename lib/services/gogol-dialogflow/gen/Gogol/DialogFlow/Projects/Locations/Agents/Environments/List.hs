...
newDialogFlowProjectsLocationsAgentsEnvironmentsList parent
  = DialogFlowProjectsLocationsAgentsEnvironmentsList{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsEnvironmentsList
         where
        type Rs DialogFlowProjectsLocationsAgentsEnvironmentsList =
             GoogleCloudDialogflowCxV3ListEnvironmentsResponse
        type Scopes DialogFlowProjectsLocationsAgentsEnvironmentsList =
