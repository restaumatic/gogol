...
newDialogFlowProjectsLocationsAgentsFlowsPagesDelete name
  = DialogFlowProjectsLocationsAgentsFlowsPagesDelete{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsFlowsPagesDelete
         where
        type Rs DialogFlowProjectsLocationsAgentsFlowsPagesDelete =
             GoogleProtobufEmpty
        type Scopes DialogFlowProjectsLocationsAgentsFlowsPagesDelete =
