...
newDialogFlowProjectsLocationsAgentsGeneratorsPatch name payload
  = DialogFlowProjectsLocationsAgentsGeneratorsPatch{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsGeneratorsPatch
         where
        type Rs DialogFlowProjectsLocationsAgentsGeneratorsPatch =
             GoogleCloudDialogflowCxV3Generator
        type Scopes DialogFlowProjectsLocationsAgentsGeneratorsPatch =
