                   ...
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] GoogleCloudDialogflowCxV3SecuritySettings
                         Core.:>
                         Core.Patch '[Core.JSON] GoogleCloudDialogflowCxV3SecuritySettings
...
newDialogFlowProjectsLocationsSecuritySettingsPatch name payload
  = DialogFlowProjectsLocationsSecuritySettingsPatch{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsSecuritySettingsPatch
         where
        type Rs DialogFlowProjectsLocationsSecuritySettingsPatch =
             GoogleCloudDialogflowCxV3SecuritySettings
        type Scopes DialogFlowProjectsLocationsSecuritySettingsPatch =
