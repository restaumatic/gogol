...
type DialogFlowProjectsLocationsAgentsSessionsFulfillIntentResource
     =
     "v3" Core.:>
       Core.CaptureMode "session" "fulfillIntent" Core.Text Core.:>
...
newDialogFlowProjectsLocationsAgentsSessionsFulfillIntent 
    ...
    -> DialogFlowProjectsLocationsAgentsSessionsFulfillIntent
newDialogFlowProjectsLocationsAgentsSessionsFulfillIntent payload
  session
  = DialogFlowProjectsLocationsAgentsSessionsFulfillIntent{xgafv =
                                                             Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsSessionsFulfillIntent
         where
        type Rs DialogFlowProjectsLocationsAgentsSessionsFulfillIntent =
             GoogleCloudDialogflowCxV3FulfillIntentResponse
        type Scopes DialogFlowProjectsLocationsAgentsSessionsFulfillIntent
