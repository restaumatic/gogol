...
newDialogFlowProjectsLocationsAgentsFlowsVersionsDelete name
  = DialogFlowProjectsLocationsAgentsFlowsVersionsDelete{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsFlowsVersionsDelete
         where
        type Rs DialogFlowProjectsLocationsAgentsFlowsVersionsDelete =
             GoogleProtobufEmpty
        type Scopes DialogFlowProjectsLocationsAgentsFlowsVersionsDelete =
