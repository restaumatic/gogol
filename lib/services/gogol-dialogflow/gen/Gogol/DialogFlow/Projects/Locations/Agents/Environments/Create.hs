                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] GoogleCloudDialogflowCxV3Environment
...
newDialogFlowProjectsLocationsAgentsEnvironmentsCreate 
    ...
    -> DialogFlowProjectsLocationsAgentsEnvironmentsCreate
newDialogFlowProjectsLocationsAgentsEnvironmentsCreate parent
  payload
  = DialogFlowProjectsLocationsAgentsEnvironmentsCreate{xgafv =
                                                          Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsEnvironmentsCreate
         where
        type Rs DialogFlowProjectsLocationsAgentsEnvironmentsCreate =
             GoogleLongrunningOperation
        type Scopes DialogFlowProjectsLocationsAgentsEnvironmentsCreate =
