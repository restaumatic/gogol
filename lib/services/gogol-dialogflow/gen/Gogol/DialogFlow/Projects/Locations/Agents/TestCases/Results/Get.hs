               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.Get '[Core.JSON] GoogleCloudDialogflowCxV3TestCaseResult
...
newDialogFlowProjectsLocationsAgentsTestCasesResultsGet name
  = DialogFlowProjectsLocationsAgentsTestCasesResultsGet{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsTestCasesResultsGet
         where
        type Rs DialogFlowProjectsLocationsAgentsTestCasesResultsGet =
             GoogleCloudDialogflowCxV3TestCaseResult
        type Scopes DialogFlowProjectsLocationsAgentsTestCasesResultsGet =
