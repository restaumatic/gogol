...
newDialogFlowProjectsLocationsAgentsTransitionRouteGroupsPatch 
    ...
    -> DialogFlowProjectsLocationsAgentsTransitionRouteGroupsPatch
newDialogFlowProjectsLocationsAgentsTransitionRouteGroupsPatch name
  payload
  = DialogFlowProjectsLocationsAgentsTransitionRouteGroupsPatch{xgafv
                                                                  = Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsTransitionRouteGroupsPatch
         where
        type Rs DialogFlowProjectsLocationsAgentsTransitionRouteGroupsPatch
             = GoogleCloudDialogflowCxV3TransitionRouteGroup
        type Scopes
               DialogFlowProjectsLocationsAgentsTransitionRouteGroupsPatch
