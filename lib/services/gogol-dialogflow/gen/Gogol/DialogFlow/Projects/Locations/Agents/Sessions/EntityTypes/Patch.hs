                   ...
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON]
                         ...
                         Core.:>
                         Core.Patch '[Core.JSON] GoogleCloudDialogflowCxV3SessionEntityType
...
newDialogFlowProjectsLocationsAgentsSessionsEntityTypesPatch 
    ...
    -> DialogFlowProjectsLocationsAgentsSessionsEntityTypesPatch
newDialogFlowProjectsLocationsAgentsSessionsEntityTypesPatch name
  payload
  = DialogFlowProjectsLocationsAgentsSessionsEntityTypesPatch{xgafv =
                                                                Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsSessionsEntityTypesPatch
         where
        type Rs DialogFlowProjectsLocationsAgentsSessionsEntityTypesPatch =
             GoogleCloudDialogflowCxV3SessionEntityType
        type Scopes
               DialogFlowProjectsLocationsAgentsSessionsEntityTypesPatch
