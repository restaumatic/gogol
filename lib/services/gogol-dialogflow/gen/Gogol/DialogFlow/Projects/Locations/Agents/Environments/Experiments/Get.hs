               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.Get '[Core.JSON] GoogleCloudDialogflowCxV3Experiment
...
newDialogFlowProjectsLocationsAgentsEnvironmentsExperimentsGet name
  = DialogFlowProjectsLocationsAgentsEnvironmentsExperimentsGet{xgafv
                                                                  = Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsEnvironmentsExperimentsGet
         where
        type Rs DialogFlowProjectsLocationsAgentsEnvironmentsExperimentsGet
