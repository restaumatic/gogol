                   ...
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] GoogleCloudDialogflowCxV3TestCase Core.:>
                         Core.Patch '[Core.JSON] GoogleCloudDialogflowCxV3TestCase
...
newDialogFlowProjectsLocationsAgentsTestCasesPatch name payload
  = DialogFlowProjectsLocationsAgentsTestCasesPatch{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsTestCasesPatch
         where
        type Rs DialogFlowProjectsLocationsAgentsTestCasesPatch =
             GoogleCloudDialogflowCxV3TestCase
        type Scopes DialogFlowProjectsLocationsAgentsTestCasesPatch =
