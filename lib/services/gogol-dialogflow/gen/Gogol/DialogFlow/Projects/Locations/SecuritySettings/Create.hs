                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] GoogleCloudDialogflowCxV3SecuritySettings
                         Core.:>
                         Core.Post '[Core.JSON] GoogleCloudDialogflowCxV3SecuritySettings
...
newDialogFlowProjectsLocationsSecuritySettingsCreate parent payload
  = DialogFlowProjectsLocationsSecuritySettingsCreate{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsSecuritySettingsCreate
         where
        type Rs DialogFlowProjectsLocationsSecuritySettingsCreate =
             GoogleCloudDialogflowCxV3SecuritySettings
        type Scopes DialogFlowProjectsLocationsSecuritySettingsCreate =
