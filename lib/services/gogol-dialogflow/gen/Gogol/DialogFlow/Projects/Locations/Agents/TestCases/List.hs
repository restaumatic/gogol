                   ...
                   Core.QueryParam "pageToken" Core.Text Core.:>
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "view" ProjectsLocationsAgentsTestCasesListView
                           Core.:>
...
newDialogFlowProjectsLocationsAgentsTestCasesList parent
  = DialogFlowProjectsLocationsAgentsTestCasesList{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsTestCasesList
         where
        type Rs DialogFlowProjectsLocationsAgentsTestCasesList =
             GoogleCloudDialogflowCxV3ListTestCasesResponse
        type Scopes DialogFlowProjectsLocationsAgentsTestCasesList =
