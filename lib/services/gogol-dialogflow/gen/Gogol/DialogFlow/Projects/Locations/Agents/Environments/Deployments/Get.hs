               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.Get '[Core.JSON] GoogleCloudDialogflowCxV3Deployment
...
newDialogFlowProjectsLocationsAgentsEnvironmentsDeploymentsGet name
  = DialogFlowProjectsLocationsAgentsEnvironmentsDeploymentsGet{xgafv
                                                                  = Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsEnvironmentsDeploymentsGet
         where
        type Rs DialogFlowProjectsLocationsAgentsEnvironmentsDeploymentsGet
