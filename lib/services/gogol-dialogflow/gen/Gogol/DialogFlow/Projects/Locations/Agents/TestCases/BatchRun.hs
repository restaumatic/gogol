...
newDialogFlowProjectsLocationsAgentsTestCasesBatchRun 
    ...
    -> DialogFlowProjectsLocationsAgentsTestCasesBatchRun
newDialogFlowProjectsLocationsAgentsTestCasesBatchRun parent
  payload
  = DialogFlowProjectsLocationsAgentsTestCasesBatchRun{xgafv =
                                                         Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsTestCasesBatchRun
         where
        type Rs DialogFlowProjectsLocationsAgentsTestCasesBatchRun =
             GoogleLongrunningOperation
        type Scopes DialogFlowProjectsLocationsAgentsTestCasesBatchRun =
