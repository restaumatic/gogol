...
newDialogFlowProjectsLocationsAgentsTestCasesImport parent payload
  = DialogFlowProjectsLocationsAgentsTestCasesImport{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsTestCasesImport
         where
        type Rs DialogFlowProjectsLocationsAgentsTestCasesImport =
             GoogleLongrunningOperation
        type Scopes DialogFlowProjectsLocationsAgentsTestCasesImport =
