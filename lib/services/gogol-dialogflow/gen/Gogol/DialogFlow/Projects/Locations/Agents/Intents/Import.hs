...
newDialogFlowProjectsLocationsAgentsIntentsImport parent payload
  = DialogFlowProjectsLocationsAgentsIntentsImport{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsIntentsImport
         where
        type Rs DialogFlowProjectsLocationsAgentsIntentsImport =
             GoogleLongrunningOperation
        type Scopes DialogFlowProjectsLocationsAgentsIntentsImport =
