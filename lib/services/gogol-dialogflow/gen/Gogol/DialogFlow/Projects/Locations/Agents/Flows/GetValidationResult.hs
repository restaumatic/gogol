                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.Get '[Core.JSON] GoogleCloudDialogflowCxV3FlowValidationResult
...
newDialogFlowProjectsLocationsAgentsFlowsGetValidationResult name
  = DialogFlowProjectsLocationsAgentsFlowsGetValidationResult{xgafv =
                                                                Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsFlowsGetValidationResult
         where
        type Rs DialogFlowProjectsLocationsAgentsFlowsGetValidationResult =
