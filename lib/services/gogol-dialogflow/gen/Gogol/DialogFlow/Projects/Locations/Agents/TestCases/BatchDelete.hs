...
newDialogFlowProjectsLocationsAgentsTestCasesBatchDelete 
    ...
    -> DialogFlowProjectsLocationsAgentsTestCasesBatchDelete
newDialogFlowProjectsLocationsAgentsTestCasesBatchDelete parent
  payload
  = DialogFlowProjectsLocationsAgentsTestCasesBatchDelete{xgafv =
                                                            Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsTestCasesBatchDelete
         where
        type Rs DialogFlowProjectsLocationsAgentsTestCasesBatchDelete =
             GoogleProtobufEmpty
        type Scopes DialogFlowProjectsLocationsAgentsTestCasesBatchDelete =
