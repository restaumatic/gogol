...
newDialogFlowProjectsLocationsAgentsEntityTypesList parent
  = DialogFlowProjectsLocationsAgentsEntityTypesList{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsEntityTypesList
         where
        type Rs DialogFlowProjectsLocationsAgentsEntityTypesList =
             GoogleCloudDialogflowCxV3ListEntityTypesResponse
        type Scopes DialogFlowProjectsLocationsAgentsEntityTypesList =
