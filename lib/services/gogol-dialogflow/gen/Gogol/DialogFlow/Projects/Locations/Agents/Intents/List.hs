                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Get '[Core.JSON] GoogleCloudDialogflowCxV3ListIntentsResponse
...
newDialogFlowProjectsLocationsAgentsIntentsList parent
  = DialogFlowProjectsLocationsAgentsIntentsList{xgafv =
                                                   Core.Nothing,
                                                 accessToken = Core.Nothing,
                                                 callback = Core.Nothing, intentView = Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsIntentsList
         where
        type Rs DialogFlowProjectsLocationsAgentsIntentsList =
             GoogleCloudDialogflowCxV3ListIntentsResponse
        type Scopes DialogFlowProjectsLocationsAgentsIntentsList =
             '[CloudPlatform'FullControl, Dialogflow'FullControl]
        requestClient DialogFlowProjectsLocationsAgentsIntentsList{..}
          = go parent xgafv accessToken callback intentView languageCode
              pageSize
              pageToken
              uploadType
              uploadProtocol
