               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.Get '[Core.JSON] GoogleCloudDialogflowCxV3Environment
...
newDialogFlowProjectsLocationsAgentsEnvironmentsGet name
  = DialogFlowProjectsLocationsAgentsEnvironmentsGet{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsEnvironmentsGet
         where
        type Rs DialogFlowProjectsLocationsAgentsEnvironmentsGet =
             GoogleCloudDialogflowCxV3Environment
        type Scopes DialogFlowProjectsLocationsAgentsEnvironmentsGet =
