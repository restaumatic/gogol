               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.Get '[Core.JSON] GoogleCloudDialogflowCxV3SecuritySettings
...
newDialogFlowProjectsLocationsSecuritySettingsGet name
  = DialogFlowProjectsLocationsSecuritySettingsGet{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsSecuritySettingsGet
         where
        type Rs DialogFlowProjectsLocationsSecuritySettingsGet =
             GoogleCloudDialogflowCxV3SecuritySettings
        type Scopes DialogFlowProjectsLocationsSecuritySettingsGet =
