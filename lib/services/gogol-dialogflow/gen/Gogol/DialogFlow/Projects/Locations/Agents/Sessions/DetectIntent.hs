...
type DialogFlowProjectsLocationsAgentsSessionsDetectIntentResource
     =
     "v3" Core.:>
       Core.CaptureMode "session" "detectIntent" Core.Text Core.:>
...
newDialogFlowProjectsLocationsAgentsSessionsDetectIntent 
    ...
    -> DialogFlowProjectsLocationsAgentsSessionsDetectIntent
newDialogFlowProjectsLocationsAgentsSessionsDetectIntent payload
  session
  = DialogFlowProjectsLocationsAgentsSessionsDetectIntent{xgafv =
                                                            Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsSessionsDetectIntent
         where
        type Rs DialogFlowProjectsLocationsAgentsSessionsDetectIntent =
             GoogleCloudDialogflowCxV3DetectIntentResponse
        type Scopes DialogFlowProjectsLocationsAgentsSessionsDetectIntent =
