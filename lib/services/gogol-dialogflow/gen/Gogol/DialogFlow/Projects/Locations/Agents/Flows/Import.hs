...
newDialogFlowProjectsLocationsAgentsFlowsImport parent payload
  = DialogFlowProjectsLocationsAgentsFlowsImport{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsFlowsImport
         where
        type Rs DialogFlowProjectsLocationsAgentsFlowsImport =
             GoogleLongrunningOperation
        type Scopes DialogFlowProjectsLocationsAgentsFlowsImport =
