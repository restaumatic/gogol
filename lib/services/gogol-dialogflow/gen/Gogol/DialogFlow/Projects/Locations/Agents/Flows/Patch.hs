                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] GoogleCloudDialogflowCxV3Flow Core.:>
                           Core.Patch '[Core.JSON] GoogleCloudDialogflowCxV3Flow
...
newDialogFlowProjectsLocationsAgentsFlowsPatch name payload
  = DialogFlowProjectsLocationsAgentsFlowsPatch{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsFlowsPatch
         where
        type Rs DialogFlowProjectsLocationsAgentsFlowsPatch =
             GoogleCloudDialogflowCxV3Flow
        type Scopes DialogFlowProjectsLocationsAgentsFlowsPatch =
