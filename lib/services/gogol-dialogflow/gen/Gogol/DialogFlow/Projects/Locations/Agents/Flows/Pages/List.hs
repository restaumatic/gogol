                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] GoogleCloudDialogflowCxV3ListPagesResponse
...
newDialogFlowProjectsLocationsAgentsFlowsPagesList parent
  = DialogFlowProjectsLocationsAgentsFlowsPagesList{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsFlowsPagesList
         where
        type Rs DialogFlowProjectsLocationsAgentsFlowsPagesList =
             GoogleCloudDialogflowCxV3ListPagesResponse
        type Scopes DialogFlowProjectsLocationsAgentsFlowsPagesList =
