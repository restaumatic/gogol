...
newDialogFlowProjectsLocationsOperationsGet name
  = DialogFlowProjectsLocationsOperationsGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsOperationsGet
         where
        type Rs DialogFlowProjectsLocationsOperationsGet =
             GoogleLongrunningOperation
        type Scopes DialogFlowProjectsLocationsOperationsGet =
