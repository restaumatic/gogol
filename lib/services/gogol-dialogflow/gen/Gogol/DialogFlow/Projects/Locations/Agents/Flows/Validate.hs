...
type DialogFlowProjectsLocationsAgentsFlowsValidateResource =
     "v3" Core.:>
       Core.CaptureMode "name" "validate" Core.Text Core.:>
...
newDialogFlowProjectsLocationsAgentsFlowsValidate name payload
  = DialogFlowProjectsLocationsAgentsFlowsValidate{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsFlowsValidate
         where
        type Rs DialogFlowProjectsLocationsAgentsFlowsValidate =
             GoogleCloudDialogflowCxV3FlowValidationResult
        type Scopes DialogFlowProjectsLocationsAgentsFlowsValidate =
