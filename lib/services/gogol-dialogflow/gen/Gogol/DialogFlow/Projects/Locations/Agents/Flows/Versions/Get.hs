               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.Get '[Core.JSON] GoogleCloudDialogflowCxV3Version
...
newDialogFlowProjectsLocationsAgentsFlowsVersionsGet name
  = DialogFlowProjectsLocationsAgentsFlowsVersionsGet{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsFlowsVersionsGet
         where
        type Rs DialogFlowProjectsLocationsAgentsFlowsVersionsGet =
             GoogleCloudDialogflowCxV3Version
        type Scopes DialogFlowProjectsLocationsAgentsFlowsVersionsGet =
