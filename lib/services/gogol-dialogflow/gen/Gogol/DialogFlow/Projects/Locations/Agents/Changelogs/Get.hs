               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.Get '[Core.JSON] GoogleCloudDialogflowCxV3Changelog
...
newDialogFlowProjectsLocationsAgentsChangelogsGet name
  = DialogFlowProjectsLocationsAgentsChangelogsGet{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsChangelogsGet
         where
        type Rs DialogFlowProjectsLocationsAgentsChangelogsGet =
             GoogleCloudDialogflowCxV3Changelog
        type Scopes DialogFlowProjectsLocationsAgentsChangelogsGet =
