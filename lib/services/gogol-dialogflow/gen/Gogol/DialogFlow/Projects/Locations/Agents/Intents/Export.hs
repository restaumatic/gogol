...
newDialogFlowProjectsLocationsAgentsIntentsExport parent payload
  = DialogFlowProjectsLocationsAgentsIntentsExport{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsIntentsExport
         where
        type Rs DialogFlowProjectsLocationsAgentsIntentsExport =
             GoogleLongrunningOperation
        type Scopes DialogFlowProjectsLocationsAgentsIntentsExport =
