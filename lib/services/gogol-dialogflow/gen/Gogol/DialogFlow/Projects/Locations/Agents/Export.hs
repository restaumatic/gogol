...
newDialogFlowProjectsLocationsAgentsExport name payload
  = DialogFlowProjectsLocationsAgentsExport{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            name = name, payload = payload,
                                            uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DialogFlowProjectsLocationsAgentsExport
         where
        type Rs DialogFlowProjectsLocationsAgentsExport =
             GoogleLongrunningOperation
        type Scopes DialogFlowProjectsLocationsAgentsExport =
