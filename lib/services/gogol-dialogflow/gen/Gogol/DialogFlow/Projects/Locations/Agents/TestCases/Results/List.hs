...
newDialogFlowProjectsLocationsAgentsTestCasesResultsList parent
  = DialogFlowProjectsLocationsAgentsTestCasesResultsList{xgafv =
                                                            Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsTestCasesResultsList
         where
        type Rs DialogFlowProjectsLocationsAgentsTestCasesResultsList =
             GoogleCloudDialogflowCxV3ListTestCaseResultsResponse
        type Scopes DialogFlowProjectsLocationsAgentsTestCasesResultsList =
