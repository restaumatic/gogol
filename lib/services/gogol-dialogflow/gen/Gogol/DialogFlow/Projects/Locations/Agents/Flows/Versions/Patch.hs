                   ...
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] GoogleCloudDialogflowCxV3Version Core.:>
                         Core.Patch '[Core.JSON] GoogleCloudDialogflowCxV3Version
...
newDialogFlowProjectsLocationsAgentsFlowsVersionsPatch name payload
  = DialogFlowProjectsLocationsAgentsFlowsVersionsPatch{xgafv =
                                                          Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsFlowsVersionsPatch
         where
        type Rs DialogFlowProjectsLocationsAgentsFlowsVersionsPatch =
             GoogleCloudDialogflowCxV3Version
        type Scopes DialogFlowProjectsLocationsAgentsFlowsVersionsPatch =
