...
type DialogFlowProjectsLocationsAgentsFlowsVersionsCompareVersionsResource
     =
     "v3" Core.:>
       Core.CaptureMode "baseVersion" "compareVersions" Core.Text Core.:>
...
newDialogFlowProjectsLocationsAgentsFlowsVersionsCompareVersions
  baseVersion payload
  = DialogFlowProjectsLocationsAgentsFlowsVersionsCompareVersions{xgafv
                                                                    = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        requestClient
          DialogFlowProjectsLocationsAgentsFlowsVersionsCompareVersions{..}
          = go baseVersion xgafv accessToken callback uploadType
              uploadProtocol
