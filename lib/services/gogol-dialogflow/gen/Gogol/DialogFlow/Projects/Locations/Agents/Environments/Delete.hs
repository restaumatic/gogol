...
newDialogFlowProjectsLocationsAgentsEnvironmentsDelete name
  = DialogFlowProjectsLocationsAgentsEnvironmentsDelete{xgafv =
                                                          Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsEnvironmentsDelete
         where
        type Rs DialogFlowProjectsLocationsAgentsEnvironmentsDelete =
             GoogleProtobufEmpty
        type Scopes DialogFlowProjectsLocationsAgentsEnvironmentsDelete =
