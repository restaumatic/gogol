...
newDialogFlowProjectsLocationsAgentsWebhooksDelete name
  = DialogFlowProjectsLocationsAgentsWebhooksDelete{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsWebhooksDelete
         where
        type Rs DialogFlowProjectsLocationsAgentsWebhooksDelete =
             GoogleProtobufEmpty
        type Scopes DialogFlowProjectsLocationsAgentsWebhooksDelete =
