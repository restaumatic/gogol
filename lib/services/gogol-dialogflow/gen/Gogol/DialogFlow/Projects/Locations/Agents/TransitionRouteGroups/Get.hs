                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.Get '[Core.JSON] GoogleCloudDialogflowCxV3TransitionRouteGroup
...
newDialogFlowProjectsLocationsAgentsTransitionRouteGroupsGet name
  = DialogFlowProjectsLocationsAgentsTransitionRouteGroupsGet{xgafv =
                                                                Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsTransitionRouteGroupsGet
         where
        type Rs DialogFlowProjectsLocationsAgentsTransitionRouteGroupsGet =
