                     ...
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] GoogleCloudDialogflowCxV3Page Core.:>
                           Core.Patch '[Core.JSON] GoogleCloudDialogflowCxV3Page
...
newDialogFlowProjectsLocationsAgentsFlowsPagesPatch name payload
  = DialogFlowProjectsLocationsAgentsFlowsPagesPatch{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsFlowsPagesPatch
         where
        type Rs DialogFlowProjectsLocationsAgentsFlowsPagesPatch =
             GoogleCloudDialogflowCxV3Page
        type Scopes DialogFlowProjectsLocationsAgentsFlowsPagesPatch =
             '[CloudPlatform'FullControl, Dialogflow'FullControl]
        requestClient DialogFlowProjectsLocationsAgentsFlowsPagesPatch{..}
          = go name xgafv accessToken callback languageCode updateMask
              uploadType
              uploadProtocol
