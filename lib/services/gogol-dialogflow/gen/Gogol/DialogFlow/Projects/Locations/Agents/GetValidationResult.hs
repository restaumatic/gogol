...
newDialogFlowProjectsLocationsAgentsGetValidationResult name
  = DialogFlowProjectsLocationsAgentsGetValidationResult{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsGetValidationResult
         where
        type Rs DialogFlowProjectsLocationsAgentsGetValidationResult =
             GoogleCloudDialogflowCxV3AgentValidationResult
        type Scopes DialogFlowProjectsLocationsAgentsGetValidationResult =
