...
newDialogFlowProjectsLocationsAgentsGeneratorsDelete name
  = DialogFlowProjectsLocationsAgentsGeneratorsDelete{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsGeneratorsDelete
         where
        type Rs DialogFlowProjectsLocationsAgentsGeneratorsDelete =
             GoogleProtobufEmpty
        type Scopes DialogFlowProjectsLocationsAgentsGeneratorsDelete =
