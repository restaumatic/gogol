                     ...
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] GoogleCloudDialogflowCxV3Intent Core.:>
                           Core.Patch '[Core.JSON] GoogleCloudDialogflowCxV3Intent
...
newDialogFlowProjectsLocationsAgentsIntentsPatch name payload
  = DialogFlowProjectsLocationsAgentsIntentsPatch{xgafv =
                                                    Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsIntentsPatch
         where
        type Rs DialogFlowProjectsLocationsAgentsIntentsPatch =
             GoogleCloudDialogflowCxV3Intent
        type Scopes DialogFlowProjectsLocationsAgentsIntentsPatch =
