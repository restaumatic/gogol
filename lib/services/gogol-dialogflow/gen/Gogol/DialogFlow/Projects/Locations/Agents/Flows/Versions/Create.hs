                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] GoogleCloudDialogflowCxV3Version Core.:>
...
newDialogFlowProjectsLocationsAgentsFlowsVersionsCreate 
    ...
    -> DialogFlowProjectsLocationsAgentsFlowsVersionsCreate
newDialogFlowProjectsLocationsAgentsFlowsVersionsCreate parent
  payload
  = DialogFlowProjectsLocationsAgentsFlowsVersionsCreate{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsFlowsVersionsCreate
         where
        type Rs DialogFlowProjectsLocationsAgentsFlowsVersionsCreate =
             GoogleLongrunningOperation
        type Scopes DialogFlowProjectsLocationsAgentsFlowsVersionsCreate =
