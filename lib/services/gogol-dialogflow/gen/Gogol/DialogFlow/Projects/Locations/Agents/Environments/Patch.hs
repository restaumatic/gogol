...
newDialogFlowProjectsLocationsAgentsEnvironmentsPatch name payload
  = DialogFlowProjectsLocationsAgentsEnvironmentsPatch{xgafv =
                                                         Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsEnvironmentsPatch
         where
        type Rs DialogFlowProjectsLocationsAgentsEnvironmentsPatch =
             GoogleLongrunningOperation
        type Scopes DialogFlowProjectsLocationsAgentsEnvironmentsPatch =
