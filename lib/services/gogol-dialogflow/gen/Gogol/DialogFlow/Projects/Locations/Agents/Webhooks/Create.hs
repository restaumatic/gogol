                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] GoogleCloudDialogflowCxV3Webhook Core.:>
                         Core.Post '[Core.JSON] GoogleCloudDialogflowCxV3Webhook
...
newDialogFlowProjectsLocationsAgentsWebhooksCreate parent payload
  = DialogFlowProjectsLocationsAgentsWebhooksCreate{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsWebhooksCreate
         where
        type Rs DialogFlowProjectsLocationsAgentsWebhooksCreate =
             GoogleCloudDialogflowCxV3Webhook
        type Scopes DialogFlowProjectsLocationsAgentsWebhooksCreate =
