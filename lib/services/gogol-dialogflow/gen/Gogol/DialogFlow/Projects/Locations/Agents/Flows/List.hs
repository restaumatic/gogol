                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] GoogleCloudDialogflowCxV3ListFlowsResponse
...
newDialogFlowProjectsLocationsAgentsFlowsList parent
  = DialogFlowProjectsLocationsAgentsFlowsList{xgafv = Core.Nothing,
                                               accessToken = Core.Nothing, callback = Core.Nothing,
                                               languageCode = Core.Nothing, pageSize = Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsFlowsList
         where
        type Rs DialogFlowProjectsLocationsAgentsFlowsList =
             GoogleCloudDialogflowCxV3ListFlowsResponse
        type Scopes DialogFlowProjectsLocationsAgentsFlowsList =
