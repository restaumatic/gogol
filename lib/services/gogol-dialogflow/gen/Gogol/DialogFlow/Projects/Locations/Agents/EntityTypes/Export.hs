...
newDialogFlowProjectsLocationsAgentsEntityTypesExport 
    ...
    -> DialogFlowProjectsLocationsAgentsEntityTypesExport
newDialogFlowProjectsLocationsAgentsEntityTypesExport parent
  payload
  = DialogFlowProjectsLocationsAgentsEntityTypesExport{xgafv =
                                                         Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsEntityTypesExport
         where
        type Rs DialogFlowProjectsLocationsAgentsEntityTypesExport =
             GoogleLongrunningOperation
        type Scopes DialogFlowProjectsLocationsAgentsEntityTypesExport =
