                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] GoogleCloudDialogflowCxV3ListWebhooksResponse
...
newDialogFlowProjectsLocationsAgentsWebhooksList parent
  = DialogFlowProjectsLocationsAgentsWebhooksList{xgafv =
                                                    Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsWebhooksList
         where
        type Rs DialogFlowProjectsLocationsAgentsWebhooksList =
             GoogleCloudDialogflowCxV3ListWebhooksResponse
        type Scopes DialogFlowProjectsLocationsAgentsWebhooksList =
