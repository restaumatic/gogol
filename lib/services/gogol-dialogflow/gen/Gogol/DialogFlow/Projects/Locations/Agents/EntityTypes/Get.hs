                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.Get '[Core.JSON] GoogleCloudDialogflowCxV3EntityType
...
newDialogFlowProjectsLocationsAgentsEntityTypesGet name
  = DialogFlowProjectsLocationsAgentsEntityTypesGet{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsEntityTypesGet
         where
        type Rs DialogFlowProjectsLocationsAgentsEntityTypesGet =
             GoogleCloudDialogflowCxV3EntityType
        type Scopes DialogFlowProjectsLocationsAgentsEntityTypesGet =
