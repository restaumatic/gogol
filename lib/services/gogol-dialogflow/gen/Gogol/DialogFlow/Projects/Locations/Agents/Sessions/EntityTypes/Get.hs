               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.Get '[Core.JSON] GoogleCloudDialogflowCxV3SessionEntityType
...
newDialogFlowProjectsLocationsAgentsSessionsEntityTypesGet name
  = DialogFlowProjectsLocationsAgentsSessionsEntityTypesGet{xgafv =
                                                              Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsSessionsEntityTypesGet
         where
        type Rs DialogFlowProjectsLocationsAgentsSessionsEntityTypesGet =
             GoogleCloudDialogflowCxV3SessionEntityType
        type Scopes DialogFlowProjectsLocationsAgentsSessionsEntityTypesGet
