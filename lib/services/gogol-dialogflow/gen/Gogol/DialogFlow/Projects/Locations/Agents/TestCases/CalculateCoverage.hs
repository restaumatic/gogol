...
newDialogFlowProjectsLocationsAgentsTestCasesCalculateCoverage
  agent
  = DialogFlowProjectsLocationsAgentsTestCasesCalculateCoverage{xgafv
                                                                  = Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsTestCasesCalculateCoverage
         where
        type Rs DialogFlowProjectsLocationsAgentsTestCasesCalculateCoverage
             = GoogleCloudDialogflowCxV3CalculateCoverageResponse
        type Scopes
               DialogFlowProjectsLocationsAgentsTestCasesCalculateCoverage
        ...
        requestClient
          DialogFlowProjectsLocationsAgentsTestCasesCalculateCoverage{..}
          = go agent xgafv accessToken callback type' uploadType
              uploadProtocol
