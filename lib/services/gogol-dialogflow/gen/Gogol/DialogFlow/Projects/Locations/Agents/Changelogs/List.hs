...
newDialogFlowProjectsLocationsAgentsChangelogsList parent
  = DialogFlowProjectsLocationsAgentsChangelogsList{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsChangelogsList
         where
        type Rs DialogFlowProjectsLocationsAgentsChangelogsList =
             GoogleCloudDialogflowCxV3ListChangelogsResponse
        type Scopes DialogFlowProjectsLocationsAgentsChangelogsList =
