...
newDialogFlowProjectsLocationsAgentsEntityTypesPatch name payload
  = DialogFlowProjectsLocationsAgentsEntityTypesPatch{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsEntityTypesPatch
         where
        type Rs DialogFlowProjectsLocationsAgentsEntityTypesPatch =
             GoogleCloudDialogflowCxV3EntityType
        type Scopes DialogFlowProjectsLocationsAgentsEntityTypesPatch =
