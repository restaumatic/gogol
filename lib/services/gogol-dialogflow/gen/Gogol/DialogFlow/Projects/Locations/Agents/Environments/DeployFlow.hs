...
type DialogFlowProjectsLocationsAgentsEnvironmentsDeployFlowResource
     =
     "v3" Core.:>
       Core.CaptureMode "environment" "deployFlow" Core.Text Core.:>
...
newDialogFlowProjectsLocationsAgentsEnvironmentsDeployFlow
  environment payload
  = DialogFlowProjectsLocationsAgentsEnvironmentsDeployFlow{xgafv =
                                                              Core.Nothing,
...
instance Core.GoogleRequest
           DialogFlowProjectsLocationsAgentsEnvironmentsDeployFlow
         where
        type Rs DialogFlowProjectsLocationsAgentsEnvironmentsDeployFlow =
             GoogleLongrunningOperation
        type Scopes DialogFlowProjectsLocationsAgentsEnvironmentsDeployFlow
