...
module Gogol.DialogFlow.Internal.Sum
  (
    ...
    -- * GoogleCloudDialogflowCxV3InlineSchema_Type
    GoogleCloudDialogflowCxV3InlineSchema_Type
      (
        GoogleCloudDialogflowCxV3InlineSchema_Type_DATATYPEUNSPECIFIED,
        GoogleCloudDialogflowCxV3InlineSchema_Type_String,
        GoogleCloudDialogflowCxV3InlineSchema_Type_Number,
        GoogleCloudDialogflowCxV3InlineSchema_Type_Boolean,
        GoogleCloudDialogflowCxV3InlineSchema_Type_Array,
        ..
      ),
    ...
    -- * GoogleCloudDialogflowCxV3ParameterDefinition_Type
    GoogleCloudDialogflowCxV3ParameterDefinition_Type
      (
        GoogleCloudDialogflowCxV3ParameterDefinition_Type_PARAMETERTYPEUNSPECIFIED,
        GoogleCloudDialogflowCxV3ParameterDefinition_Type_String,
        GoogleCloudDialogflowCxV3ParameterDefinition_Type_Number,
        GoogleCloudDialogflowCxV3ParameterDefinition_Type_Boolean,
        GoogleCloudDialogflowCxV3ParameterDefinition_Type_Null,
        GoogleCloudDialogflowCxV3ParameterDefinition_Type_Object,
        GoogleCloudDialogflowCxV3ParameterDefinition_Type_List,
        ..
      ),

    -- * GoogleCloudDialogflowCxV3Playbook_PlaybookType
    GoogleCloudDialogflowCxV3Playbook_PlaybookType
      (
        GoogleCloudDialogflowCxV3Playbook_PlaybookType_PLAYBOOKTYPEUNSPECIFIED,
        GoogleCloudDialogflowCxV3Playbook_PlaybookType_Task,
        GoogleCloudDialogflowCxV3Playbook_PlaybookType_Routine,
        ..
      ),
    ...
    -- * GoogleCloudDialogflowV2ToolCall_State
    GoogleCloudDialogflowV2ToolCall_State
      (
        GoogleCloudDialogflowV2ToolCall_State_STATEUNSPECIFIED,
        GoogleCloudDialogflowV2ToolCall_State_Triggered,
        GoogleCloudDialogflowV2ToolCall_State_NEEDSCONFIRMATION,
        ..
      ),
    ...
    -- * GoogleCloudDialogflowV2beta1ToolCall_State
    GoogleCloudDialogflowV2beta1ToolCall_State
      (
        GoogleCloudDialogflowV2beta1ToolCall_State_STATEUNSPECIFIED,
        GoogleCloudDialogflowV2beta1ToolCall_State_Triggered,
        GoogleCloudDialogflowV2beta1ToolCall_State_NEEDSCONFIRMATION,
        ..
      ),
...
newtype GoogleCloudDialogflowCxV3InlineSchema_Type = GoogleCloudDialogflowCxV3InlineSchema_Type { fromGoogleCloudDialogflowCxV3InlineSchema_Type :: Core.Text }
    deriving stock (Core.Show, Core.Read, Core.Eq, Core.Ord, Core.Generic)
    deriving newtype
      ( Core.Hashable
      , Core.ToHttpApiData
...
-- | Not specified.
pattern GoogleCloudDialogflowCxV3InlineSchema_Type_DATATYPEUNSPECIFIED :: GoogleCloudDialogflowCxV3InlineSchema_Type
pattern GoogleCloudDialogflowCxV3InlineSchema_Type_DATATYPEUNSPECIFIED = GoogleCloudDialogflowCxV3InlineSchema_Type "DATA_TYPE_UNSPECIFIED"

-- | Represents any string value.
pattern GoogleCloudDialogflowCxV3InlineSchema_Type_String :: GoogleCloudDialogflowCxV3InlineSchema_Type
pattern GoogleCloudDialogflowCxV3InlineSchema_Type_String = GoogleCloudDialogflowCxV3InlineSchema_Type "STRING"

-- | Represents any number value.
pattern GoogleCloudDialogflowCxV3InlineSchema_Type_Number :: GoogleCloudDialogflowCxV3InlineSchema_Type
pattern GoogleCloudDialogflowCxV3InlineSchema_Type_Number = GoogleCloudDialogflowCxV3InlineSchema_Type "NUMBER"

-- | Represents a boolean value.
pattern GoogleCloudDialogflowCxV3InlineSchema_Type_Boolean :: GoogleCloudDialogflowCxV3InlineSchema_Type
pattern GoogleCloudDialogflowCxV3InlineSchema_Type_Boolean = GoogleCloudDialogflowCxV3InlineSchema_Type "BOOLEAN"

-- | Represents a repeated value.
pattern GoogleCloudDialogflowCxV3InlineSchema_Type_Array :: GoogleCloudDialogflowCxV3InlineSchema_Type
pattern GoogleCloudDialogflowCxV3InlineSchema_Type_Array = GoogleCloudDialogflowCxV3InlineSchema_Type "ARRAY"
...
-- | Type of parameter.
newtype GoogleCloudDialogflowCxV3ParameterDefinition_Type = GoogleCloudDialogflowCxV3ParameterDefinition_Type { fromGoogleCloudDialogflowCxV3ParameterDefinition_Type :: Core.Text }
    deriving stock (Core.Show, Core.Read, Core.Eq, Core.Ord, Core.Generic)
    deriving newtype
      ( Core.Hashable
      , Core.ToHttpApiData
...
pattern GoogleCloudDialogflowCxV3ParameterDefinition_Type_PARAMETERTYPEUNSPECIFIED :: GoogleCloudDialogflowCxV3ParameterDefinition_Type
pattern GoogleCloudDialogflowCxV3ParameterDefinition_Type_PARAMETERTYPEUNSPECIFIED = GoogleCloudDialogflowCxV3ParameterDefinition_Type "PARAMETER_TYPE_UNSPECIFIED"

-- | Represents any string value.
pattern GoogleCloudDialogflowCxV3ParameterDefinition_Type_String :: GoogleCloudDialogflowCxV3ParameterDefinition_Type
pattern GoogleCloudDialogflowCxV3ParameterDefinition_Type_String = GoogleCloudDialogflowCxV3ParameterDefinition_Type "STRING"

-- | Represents any number value.
pattern GoogleCloudDialogflowCxV3ParameterDefinition_Type_Number :: GoogleCloudDialogflowCxV3ParameterDefinition_Type
pattern GoogleCloudDialogflowCxV3ParameterDefinition_Type_Number = GoogleCloudDialogflowCxV3ParameterDefinition_Type "NUMBER"

-- | Represents a boolean value.
pattern GoogleCloudDialogflowCxV3ParameterDefinition_Type_Boolean :: GoogleCloudDialogflowCxV3ParameterDefinition_Type
pattern GoogleCloudDialogflowCxV3ParameterDefinition_Type_Boolean = GoogleCloudDialogflowCxV3ParameterDefinition_Type "BOOLEAN"

-- | Represents a null value.
pattern GoogleCloudDialogflowCxV3ParameterDefinition_Type_Null :: GoogleCloudDialogflowCxV3ParameterDefinition_Type
pattern GoogleCloudDialogflowCxV3ParameterDefinition_Type_Null = GoogleCloudDialogflowCxV3ParameterDefinition_Type "NULL"

-- | Represents any object value.
pattern GoogleCloudDialogflowCxV3ParameterDefinition_Type_Object :: GoogleCloudDialogflowCxV3ParameterDefinition_Type
pattern GoogleCloudDialogflowCxV3ParameterDefinition_Type_Object = GoogleCloudDialogflowCxV3ParameterDefinition_Type "OBJECT"

-- | Represents a repeated value.
pattern GoogleCloudDialogflowCxV3ParameterDefinition_Type_List :: GoogleCloudDialogflowCxV3ParameterDefinition_Type
pattern GoogleCloudDialogflowCxV3ParameterDefinition_Type_List = GoogleCloudDialogflowCxV3ParameterDefinition_Type "LIST"
...
newtype GoogleCloudDialogflowCxV3Playbook_PlaybookType = GoogleCloudDialogflowCxV3Playbook_PlaybookType { fromGoogleCloudDialogflowCxV3Playbook_PlaybookType :: Core.Text }
    deriving stock (Core.Show, Core.Read, Core.Eq, Core.Ord, Core.Generic)
    deriving newtype
      ( Core.Hashable
      , Core.ToHttpApiData
...
pattern GoogleCloudDialogflowCxV3Playbook_PlaybookType_PLAYBOOKTYPEUNSPECIFIED :: GoogleCloudDialogflowCxV3Playbook_PlaybookType
pattern GoogleCloudDialogflowCxV3Playbook_PlaybookType_PLAYBOOKTYPEUNSPECIFIED = GoogleCloudDialogflowCxV3Playbook_PlaybookType "PLAYBOOK_TYPE_UNSPECIFIED"

-- | Task playbook.
pattern GoogleCloudDialogflowCxV3Playbook_PlaybookType_Task :: GoogleCloudDialogflowCxV3Playbook_PlaybookType
pattern GoogleCloudDialogflowCxV3Playbook_PlaybookType_Task = GoogleCloudDialogflowCxV3Playbook_PlaybookType "TASK"

-- | Routine playbook.
pattern GoogleCloudDialogflowCxV3Playbook_PlaybookType_Routine :: GoogleCloudDialogflowCxV3Playbook_PlaybookType
pattern GoogleCloudDialogflowCxV3Playbook_PlaybookType_Routine = GoogleCloudDialogflowCxV3Playbook_PlaybookType "ROUTINE"
...
newtype GoogleCloudDialogflowV2ToolCall_State = GoogleCloudDialogflowV2ToolCall_State { fromGoogleCloudDialogflowV2ToolCall_State :: Core.Text }
    deriving stock (Core.Show, Core.Read, Core.Eq, Core.Ord, Core.Generic)
    deriving newtype
      ( Core.Hashable
      , Core.ToHttpApiData
...
-- | Default value.
pattern GoogleCloudDialogflowV2ToolCall_State_STATEUNSPECIFIED :: GoogleCloudDialogflowV2ToolCall_State
pattern GoogleCloudDialogflowV2ToolCall_State_STATEUNSPECIFIED = GoogleCloudDialogflowV2ToolCall_State "STATE_UNSPECIFIED"

-- | The tool call has been triggered.
pattern GoogleCloudDialogflowV2ToolCall_State_Triggered :: GoogleCloudDialogflowV2ToolCall_State
pattern GoogleCloudDialogflowV2ToolCall_State_Triggered = GoogleCloudDialogflowV2ToolCall_State "TRIGGERED"

-- | The tool call requires confirmation from a human.
pattern GoogleCloudDialogflowV2ToolCall_State_NEEDSCONFIRMATION :: GoogleCloudDialogflowV2ToolCall_State
pattern GoogleCloudDialogflowV2ToolCall_State_NEEDSCONFIRMATION = GoogleCloudDialogflowV2ToolCall_State "NEEDS_CONFIRMATION"
...
-- | Output only. State of the tool call
newtype GoogleCloudDialogflowV2beta1ToolCall_State = GoogleCloudDialogflowV2beta1ToolCall_State { fromGoogleCloudDialogflowV2beta1ToolCall_State :: Core.Text }
    deriving stock (Core.Show, Core.Read, Core.Eq, Core.Ord, Core.Generic)
    deriving newtype
      ( Core.Hashable
      , Core.ToHttpApiData
...
-- | Default value.
pattern GoogleCloudDialogflowV2beta1ToolCall_State_STATEUNSPECIFIED :: GoogleCloudDialogflowV2beta1ToolCall_State
pattern GoogleCloudDialogflowV2beta1ToolCall_State_STATEUNSPECIFIED = GoogleCloudDialogflowV2beta1ToolCall_State "STATE_UNSPECIFIED"

-- | The tool call has been triggered.
pattern GoogleCloudDialogflowV2beta1ToolCall_State_Triggered :: GoogleCloudDialogflowV2beta1ToolCall_State
pattern GoogleCloudDialogflowV2beta1ToolCall_State_Triggered = GoogleCloudDialogflowV2beta1ToolCall_State "TRIGGERED"

-- | The tool call requires confirmation from a human.
pattern GoogleCloudDialogflowV2beta1ToolCall_State_NEEDSCONFIRMATION :: GoogleCloudDialogflowV2beta1ToolCall_State
pattern GoogleCloudDialogflowV2beta1ToolCall_State_NEEDSCONFIRMATION = GoogleCloudDialogflowV2beta1ToolCall_State "NEEDS_CONFIRMATION"
