...
--
-- /See:/ 'newInsertPersonRequest' smart constructor.
data InsertPersonRequest = InsertPersonRequest
    {
...
-- | Creates a value of 'InsertPersonRequest' with the minimum fields required to make a request.
newInsertPersonRequest 
    ::  InsertPersonRequest
newInsertPersonRequest
  = InsertPersonRequest{endOfSegmentLocation = Core.Nothing,
                        location = Core.Nothing, personProperties = Core.Nothing}
instance Core.FromJSON InsertPersonRequest where
        parseJSON
          = Core.withObject "InsertPersonRequest"
              (\ o ->
                 InsertPersonRequest Core.<$>
                   (o Core..:? "endOfSegmentLocation") Core.<*>
                     (o Core..:? "location")
                     Core.<*> (o Core..:? "personProperties"))

instance Core.ToJSON InsertPersonRequest where
        toJSON InsertPersonRequest{..}
          = Core.object
              (Core.catMaybes
                 [("endOfSegmentLocation" Core..=) Core.<$> endOfSegmentLocation,
                  ("location" Core..=) Core.<$> location,
...
data Request' = Request'
    ...
    , insertPageBreak :: (Core.Maybe InsertPageBreakRequest)
      -- | Inserts a person mention.
    , insertPerson :: (Core.Maybe InsertPersonRequest)
...
newRequest
  = Request'{createFooter = Core.Nothing,
             ...
             insertPerson = Core.Nothing, insertSectionBreak = Core.Nothing,
             insertTable = Core.Nothing, insertTableColumn = Core.Nothing,
             insertTableRow = Core.Nothing, insertText = Core.Nothing,
             mergeTableCells = Core.Nothing, pinTableHeaderRows = Core.Nothing,
          ...
          = Core.object
              (Core.catMaybes
                 [("createFooter" Core..=) Core.<$> createFooter,
                  ...
                  ("insertPerson" Core..=) Core.<$> insertPerson,
