...
--
-- /See:/ <https://developers.google.com/workspace/docs/ Google Docs API Reference> for @docs.documents.get@.
module Gogol.Docs.Documents.Get
    (
    -- * Resource
           ...
           Core.QueryParam "$.xgafv" Xgafv Core.:>
             Core.QueryParam "access_token" Core.Text Core.:>
               Core.QueryParam "callback" Core.Text Core.:>
                 Core.QueryParam "includeTabsContent" Core.Bool Core.:>
...
newDocsDocumentsGet documentId
  = DocsDocumentsGet{xgafv = Core.Nothing,
                     accessToken = Core.Nothing, callback = Core.Nothing,
                     documentId = documentId, includeTabsContent = Core.Nothing,
                     suggestionsViewMode = Core.Nothing, uploadType = Core.Nothing,
                     uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DocsDocumentsGet where
        type Rs DocsDocumentsGet = Document
        type Scopes DocsDocumentsGet =
             '[Documents'FullControl, Documents'Readonly, Drive'FullControl,
               Drive'File, Drive'Readonly]
        requestClient DocsDocumentsGet{..}
          = go documentId xgafv accessToken callback includeTabsContent
              suggestionsViewMode
              uploadType
              uploadProtocol
