...
--
-- /See:/ <https://developers.google.com/workspace/docs/ Google Docs API Reference> for @docs.documents.batchUpdate@.
module Gogol.Docs.Documents.BatchUpdate
    (
    -- * Resource
...
type DocsDocumentsBatchUpdateResource =
     "v1" Core.:>
       "documents" Core.:>
         Core.CaptureMode "documentId" "batchUpdate" Core.Text Core.:>
                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] BatchUpdateDocumentRequest Core.:>
                         Core.Post '[Core.JSON] BatchUpdateDocumentResponse
...
newDocsDocumentsBatchUpdate documentId payload
  = DocsDocumentsBatchUpdate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DocsDocumentsBatchUpdate where
        type Rs DocsDocumentsBatchUpdate = BatchUpdateDocumentResponse
        type Scopes DocsDocumentsBatchUpdate =
             '[Documents'FullControl, Drive'FullControl, Drive'File]
        requestClient DocsDocumentsBatchUpdate{..}
          = go documentId xgafv accessToken callback uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy DocsDocumentsBatchUpdateResource)
                      Core.mempty
