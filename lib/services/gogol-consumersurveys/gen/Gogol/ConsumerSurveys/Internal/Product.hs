...
newMobileAppPanel 
    ::  MobileAppPanel
newMobileAppPanel
  = MobileAppPanel{country = Core.Nothing,
                   isPublicPanel = Core.Nothing, language = Core.Nothing,
                   mobileAppPanelId = Core.Nothing, name = Core.Nothing,
                   owners = Core.Nothing}
instance Core.FromJSON MobileAppPanel where
        parseJSON
          = Core.withObject "MobileAppPanel"
              (\ o ->
                 MobileAppPanel Core.<$>
                   (o Core..:? "country") Core.<*> (o Core..:? "isPublicPanel")
          ...
          = Core.object
              (Core.catMaybes
                 [("country" Core..=) Core.<$> country,
                  ...
                  ("mobileAppPanelId" Core..=) Core.<$> mobileAppPanelId,
                  ("name" Core..=) Core.<$> name,
...
newMobileAppPanelsListResponse 
    ::  MobileAppPanelsListResponse
newMobileAppPanelsListResponse
  = MobileAppPanelsListResponse{pageInfo = Core.Nothing,
                                requestId = Core.Nothing, resources = Core.Nothing,
                                tokenPagination = Core.Nothing}
instance Core.FromJSON MobileAppPanelsListResponse where
        parseJSON
          = Core.withObject "MobileAppPanelsListResponse"
              (\ o ->
                 MobileAppPanelsListResponse Core.<$>
                   (o Core..:? "pageInfo") Core.<*> (o Core..:? "requestId") Core.<*>
                     (o Core..:? "resources")
...
instance Core.FromJSON ResultsGetRequest where
        parseJSON
          = Core.withObject "ResultsGetRequest"
              (\ o -> ResultsGetRequest Core.<$> (o Core..:? "resultMask"))

instance Core.ToJSON ResultsGetRequest where
        toJSON ResultsGetRequest{..}
          = Core.object
              (Core.catMaybes [("resultMask" Core..=) Core.<$> resultMask])
...
newResultsMask 
    ::  ResultsMask
newResultsMask
  = ResultsMask{fields = Core.Nothing, projection = Core.Nothing}
instance Core.FromJSON ResultsMask where
        parseJSON
          = Core.withObject "ResultsMask"
              (\ o ->
                 ResultsMask Core.<$>
                   (o Core..:? "fields") Core.<*> (o Core..:? "projection"))
...
newSurvey 
    ::  Survey
newSurvey
  = Survey{audience = Core.Nothing, cost = Core.Nothing,
           customerData = Core.Nothing, description = Core.Nothing,
           owners = Core.Nothing, questions = Core.Nothing,
           rejectionReason = Core.Nothing, state = Core.Nothing,
           surveyUrlId = Core.Nothing, title = Core.Nothing,
           wantedResponseCount = Core.Nothing}
instance Core.FromJSON Survey where
        parseJSON
          = Core.withObject "Survey"
              (\ o ->
                 Survey Core.<$>
                   (o Core..:? "audience") Core.<*> (o Core..:? "cost") Core.<*>
                     (o Core..:? "customerData")
          ...
          = Core.object
              (Core.catMaybes
                 [("audience" Core..=) Core.<$> audience,
                  ...
                  ("wantedResponseCount" Core..=) Core.<$> wantedResponseCount])
...
newSurveyAudience 
    ::  SurveyAudience
newSurveyAudience
  = SurveyAudience{ages = Core.Nothing, country = Core.Nothing,
                   countrySubdivision = Core.Nothing, gender = Core.Nothing,
                   languages = Core.Nothing, mobileAppPanelId = Core.Nothing,
                   populationSource = Core.Nothing}
instance Core.FromJSON SurveyAudience where
        parseJSON
          = Core.withObject "SurveyAudience"
              (\ o ->
                 SurveyAudience Core.<$>
                   (o Core..:? "ages") Core.<*> (o Core..:? "country") Core.<*>
                     (o Core..:? "countrySubdivision")
                     Core.<*> (o Core..:? "gender")
        ...
        toJSON SurveyAudience{..}
          = Core.object
              (Core.catMaybes
                 [("ages" Core..=) Core.<$> ages,
                  ("country" Core..=) Core.<$> country,
                  ("countrySubdivision" Core..=) Core.<$> countrySubdivision,
                  ("gender" Core..=) Core.<$> gender,
                  ("languages" Core..=) Core.<$> languages,
                  ("mobileAppPanelId" Core..=) Core.<$> mobileAppPanelId,
                  ("populationSource" Core..=) Core.<$> populationSource])
...
newSurveyCost 
    ::  SurveyCost
newSurveyCost
  = SurveyCost{costPerResponseNanos = Core.Nothing,
               currencyCode = Core.Nothing,
               maxCostPerResponseNanos = Core.Nothing, nanos = Core.Nothing}
instance Core.FromJSON SurveyCost where
        parseJSON
          = Core.withObject "SurveyCost"
              (\ o ->
                 SurveyCost Core.<$>
                   (o Core..:? "costPerResponseNanos" Core.<&>
                      Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "currencyCode")
                     Core.<*>
                     (o Core..:? "maxCostPerResponseNanos" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "nanos" Core.<&> Core.fmap Core.fromAsText))

instance Core.ToJSON SurveyCost where
        toJSON SurveyCost{..}
          = Core.object
              (Core.catMaybes
                 [("costPerResponseNanos" Core..=) Core.. Core.AsText Core.<$>
                    costPerResponseNanos,
                  ("currencyCode" Core..=) Core.<$> currencyCode,
                  ("maxCostPerResponseNanos" Core..=) Core.. Core.AsText Core.<$>
...
newSurveyQuestion 
    ::  SurveyQuestion
newSurveyQuestion
  = SurveyQuestion{answerOrder = Core.Nothing,
                   answers = Core.Nothing, hasOther = Core.Nothing,
                   highValueLabel = Core.Nothing, images = Core.Nothing,
                   lastAnswerPositionPinned = Core.Nothing,
                   lowValueLabel = Core.Nothing, mustPickSuggestion = Core.Nothing,
                   numStars = Core.Nothing, openTextPlaceholder = Core.Nothing,
                   openTextSuggestions = Core.Nothing, question = Core.Nothing,
                   sentimentText = Core.Nothing, singleLineResponse = Core.Nothing,
                   thresholdAnswers = Core.Nothing, type' = Core.Nothing,
                   unitOfMeasurementLabel = Core.Nothing, videoId = Core.Nothing}
instance Core.FromJSON SurveyQuestion where
        parseJSON
          = Core.withObject "SurveyQuestion"
              (\ o ->
                 SurveyQuestion Core.<$>
                   (o Core..:? "answerOrder") Core.<*> (o Core..:? "answers") Core.<*>
                     (o Core..:? "hasOther")
          ...
          = Core.object
              (Core.catMaybes
                 [("answerOrder" Core..=) Core.<$> answerOrder,
                  ...
                  ("lastAnswerPositionPinned" Core..=) Core.<$>
                    lastAnswerPositionPinned,
                  ("lowValueLabel" Core..=) Core.<$> lowValueLabel,
                  ("mustPickSuggestion" Core..=) Core.<$> mustPickSuggestion,
                  ("numStars" Core..=) Core.<$> numStars,
                  ("openTextPlaceholder" Core..=) Core.<$> openTextPlaceholder,
                  ("openTextSuggestions" Core..=) Core.<$> openTextSuggestions,
                  ("question" Core..=) Core.<$> question,
                  ("sentimentText" Core..=) Core.<$> sentimentText,
                  ("singleLineResponse" Core..=) Core.<$> singleLineResponse,
                  ("thresholdAnswers" Core..=) Core.<$> thresholdAnswers,
                  ("type" Core..=) Core.<$> type',
                  ("unitOfMeasurementLabel" Core..=) Core.<$> unitOfMeasurementLabel,
...
newSurveyQuestionImage 
    ::  SurveyQuestionImage
newSurveyQuestionImage
  = SurveyQuestionImage{altText = Core.Nothing, data' = Core.Nothing,
                        url = Core.Nothing}
instance Core.FromJSON SurveyQuestionImage where
        parseJSON
          = Core.withObject "SurveyQuestionImage"
              (\ o ->
                 SurveyQuestionImage Core.<$>
                   (o Core..:? "altText") Core.<*> (o Core..:? "data") Core.<*>
                     (o Core..:? "url"))
          ...
          = Core.object
              (Core.catMaybes
                 [("altText" Core..=) Core.<$> altText,
                  ("data" Core..=) Core.<$> data', ("url" Core..=) Core.<$> url])
...
instance Core.FromJSON SurveyRejection where
        parseJSON
          = Core.withObject "SurveyRejection"
              (\ o ->
                 SurveyRejection Core.<$>
                   (o Core..:? "explanation") Core.<*> (o Core..:? "type"))
...
instance Core.FromJSON SurveyResults where
        parseJSON
          = Core.withObject "SurveyResults"
              (\ o ->
                 SurveyResults Core.<$>
                   (o Core..:? "status") Core.<*> (o Core..:? "surveyUrlId"))
...
newSurveysDeleteResponse 
    ::  SurveysDeleteResponse
newSurveysDeleteResponse
  = SurveysDeleteResponse{requestId = Core.Nothing}
instance Core.FromJSON SurveysDeleteResponse where
        parseJSON
          = Core.withObject "SurveysDeleteResponse"
              (\ o -> SurveysDeleteResponse Core.<$> (o Core..:? "requestId"))
...
newSurveysListResponse 
    ::  SurveysListResponse
newSurveysListResponse
  = SurveysListResponse{pageInfo = Core.Nothing,
                        requestId = Core.Nothing, resources = Core.Nothing,
                        tokenPagination = Core.Nothing}
instance Core.FromJSON SurveysListResponse where
        parseJSON
          = Core.withObject "SurveysListResponse"
              (\ o ->
                 SurveysListResponse Core.<$>
                   (o Core..:? "pageInfo") Core.<*> (o Core..:? "requestId") Core.<*>
                     (o Core..:? "resources")
                     Core.<*> (o Core..:? "tokenPagination"))
...
instance Core.FromJSON SurveysStartRequest where
        parseJSON
          = Core.withObject "SurveysStartRequest"
              (\ o ->
                 SurveysStartRequest Core.<$>
                   (o Core..:? "maxCostPerResponseNanos" Core.<&>
                      Core.fmap Core.fromAsText))
...
newSurveysStartResponse 
    ::  SurveysStartResponse
newSurveysStartResponse
  = SurveysStartResponse{requestId = Core.Nothing}
instance Core.FromJSON SurveysStartResponse where
        parseJSON
          = Core.withObject "SurveysStartResponse"
              (\ o -> SurveysStartResponse Core.<$> (o Core..:? "requestId"))
...
newSurveysStopResponse 
    ::  SurveysStopResponse
newSurveysStopResponse
  = SurveysStopResponse{requestId = Core.Nothing}
instance Core.FromJSON SurveysStopResponse where
        parseJSON
          = Core.withObject "SurveysStopResponse"
              (\ o -> SurveysStopResponse Core.<$> (o Core..:? "requestId"))
