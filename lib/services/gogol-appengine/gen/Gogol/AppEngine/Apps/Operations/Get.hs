...
newAppEngineAppsOperationsGet appsId operationsId
  = AppEngineAppsOperationsGet{xgafv = Core.Nothing,
                               accessToken = Core.Nothing, appsId = appsId,
                               callback = Core.Nothing, operationsId = operationsId,
...
instance Core.GoogleRequest AppEngineAppsOperationsGet where
        ...
        requestClient AppEngineAppsOperationsGet{..}
          = go appsId operationsId xgafv accessToken callback uploadType
              uploadProtocol
