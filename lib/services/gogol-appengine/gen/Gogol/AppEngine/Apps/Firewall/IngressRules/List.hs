               ...
               Core.QueryParam "$.xgafv" Xgafv Core.:>
                 Core.QueryParam "access_token" Core.Text Core.:>
                   Core.QueryParam "callback" Core.Text Core.:>
                     Core.QueryParam "matchingAddress" Core.Text Core.:>
                       Core.QueryParam "pageSize" Core.Int32 Core.:>
                         Core.QueryParam "pageToken" Core.Text Core.:>
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.Get '[Core.JSON] ListIngressRulesResponse
...
newAppEngineAppsFirewallIngressRulesList appsId
  = AppEngineAppsFirewallIngressRulesList{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, appsId = appsId,
                                          callback = Core.Nothing, matchingAddress = Core.Nothing,
                                          pageSize = Core.Nothing, pageToken = Core.Nothing,
                                          uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AppEngineAppsFirewallIngressRulesList
         where
        type Rs AppEngineAppsFirewallIngressRulesList =
             ListIngressRulesResponse
        type Scopes AppEngineAppsFirewallIngressRulesList =
             '[Appengine'Admin, CloudPlatform'FullControl,
               CloudPlatform'ReadOnly]
        requestClient AppEngineAppsFirewallIngressRulesList{..}
          = go appsId xgafv accessToken callback matchingAddress pageSize
              pageToken
              uploadType
              uploadProtocol
