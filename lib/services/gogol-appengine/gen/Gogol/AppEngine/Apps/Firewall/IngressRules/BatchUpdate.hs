                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] BatchUpdateIngressRulesRequest Core.:>
                             Core.Post '[Core.JSON] BatchUpdateIngressRulesResponse
...
newAppEngineAppsFirewallIngressRulesBatchUpdate appsId payload
  = AppEngineAppsFirewallIngressRulesBatchUpdate{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes AppEngineAppsFirewallIngressRulesBatchUpdate =
