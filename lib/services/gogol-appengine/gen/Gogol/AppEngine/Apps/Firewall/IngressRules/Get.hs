...
newAppEngineAppsFirewallIngressRulesGet appsId ingressRulesId
  = AppEngineAppsFirewallIngressRulesGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest AppEngineAppsFirewallIngressRulesGet
         where
        ...
        requestClient AppEngineAppsFirewallIngressRulesGet{..}
          = go appsId ingressRulesId xgafv accessToken callback uploadType
              uploadProtocol
