                           ...
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.ReqBody '[Core.JSON] FirewallRule Core.:>
                                 Core.Patch '[Core.JSON] FirewallRule
...
newAppEngineAppsFirewallIngressRulesPatch 
    ...
    -> AppEngineAppsFirewallIngressRulesPatch
newAppEngineAppsFirewallIngressRulesPatch appsId ingressRulesId
  payload
  = AppEngineAppsFirewallIngressRulesPatch{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, appsId = appsId,
                                           callback = Core.Nothing, ingressRulesId = ingressRulesId,
                                           payload = payload, updateMask = Core.Nothing,
                                           uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AppEngineAppsFirewallIngressRulesPatch
         where
        type Rs AppEngineAppsFirewallIngressRulesPatch = FirewallRule
        type Scopes AppEngineAppsFirewallIngressRulesPatch =
             '[CloudPlatform'FullControl]
        requestClient AppEngineAppsFirewallIngressRulesPatch{..}
          = go appsId ingressRulesId xgafv accessToken callback updateMask
              uploadType
              uploadProtocol
