...
type AppEngineAppsListRuntimesResource =
     "v1" Core.:>
       "apps" Core.:>
         Core.CaptureMode "appsId" "listRuntimes" Core.Text Core.:>
           Core.QueryParam "$.xgafv" Xgafv Core.:>
             Core.QueryParam "access_token" Core.Text Core.:>
               Core.QueryParam "callback" Core.Text Core.:>
                 Core.QueryParam "environment" AppsListRuntimesEnvironment Core.:>
...
newAppEngineAppsListRuntimes appsId
  = AppEngineAppsListRuntimes{xgafv = Core.Nothing,
                              accessToken = Core.Nothing, appsId = appsId,
                              callback = Core.Nothing, environment = Core.Nothing,
...
instance Core.GoogleRequest AppEngineAppsListRuntimes where
        ...
        requestClient AppEngineAppsListRuntimes{..}
          = go appsId xgafv accessToken callback environment uploadType
              uploadProtocol
