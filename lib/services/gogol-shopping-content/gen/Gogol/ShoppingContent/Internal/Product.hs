...
newAccount 
    ::  Account
newAccount
  = Account{accountManagement = Core.Nothing,
            adsLinks = Core.Nothing, adultContent = Core.Nothing,
            automaticImprovements = Core.Nothing,
            automaticLabelIds = Core.Nothing, businessIdentity = Core.Nothing,
            businessInformation = Core.Nothing,
            conversionSettings = Core.Nothing, cssId = Core.Nothing,
            googleMyBusinessLink = Core.Nothing, id = Core.Nothing,
            kind = Core.Nothing, labelIds = Core.Nothing, name = Core.Nothing,
            sellerId = Core.Nothing, users = Core.Nothing,
            websiteUrl = Core.Nothing, youtubeChannelLinks = Core.Nothing}
instance Core.FromJSON Account where
        parseJSON
          = Core.withObject "Account"
              (\ o ->
                 Account Core.<$>
                   (o Core..:? "accountManagement") Core.<*> (o Core..:? "adsLinks")
                     Core.<*> (o Core..:? "adultContent")
                     Core.<*> (o Core..:? "automaticImprovements")
                     Core.<*>
                     (o Core..:? "automaticLabelIds" Core.<&>
          ...
          = Core.object
              (Core.catMaybes
                 [("accountManagement" Core..=) Core.<$> accountManagement,
                  ...
                  ("automaticLabelIds" Core..=) Core.. Core.fmap Core.AsText Core.<$>
                    automaticLabelIds,
                  ...
                  ("kind" Core..=) Core.<$> kind,
                  ("labelIds" Core..=) Core.. Core.fmap Core.AsText Core.<$>
                    labelIds,
                  ("name" Core..=) Core.<$> name,
...
newAccountAddress 
    ::  AccountAddress
newAccountAddress
  = AccountAddress{country = Core.Nothing, locality = Core.Nothing,
                   postalCode = Core.Nothing, region = Core.Nothing,
                   streetAddress = Core.Nothing}
instance Core.FromJSON AccountAddress where
        parseJSON
          = Core.withObject "AccountAddress"
              (\ o ->
                 AccountAddress Core.<$>
                   (o Core..:? "country") Core.<*> (o Core..:? "locality") Core.<*>
                     (o Core..:? "postalCode")
                     Core.<*> (o Core..:? "region")
...
instance Core.FromJSON AccountAdsLink where
        parseJSON
          = Core.withObject "AccountAdsLink"
              (\ o ->
                 AccountAdsLink Core.<$>
                   (o Core..:? "adsId" Core.<&> Core.fmap Core.fromAsText) Core.<*>
                     (o Core..:? "status"))
...
newAccountAutomaticImprovements 
    ::  AccountAutomaticImprovements
newAccountAutomaticImprovements
  = AccountAutomaticImprovements{imageImprovements = Core.Nothing,
                                 itemUpdates = Core.Nothing, shippingImprovements = Core.Nothing}
instance Core.FromJSON AccountAutomaticImprovements where
        parseJSON
          = Core.withObject "AccountAutomaticImprovements"
              (\ o ->
                 AccountAutomaticImprovements Core.<$>
                   (o Core..:? "imageImprovements") Core.<*>
                     (o Core..:? "itemUpdates")
...
newAccountBusinessIdentity 
    ::  AccountBusinessIdentity
newAccountBusinessIdentity
  = AccountBusinessIdentity{blackOwned = Core.Nothing,
                            includeForPromotions = Core.Nothing, latinoOwned = Core.Nothing,
                            smallBusiness = Core.Nothing, veteranOwned = Core.Nothing,
                            womenOwned = Core.Nothing}
instance Core.FromJSON AccountBusinessIdentity where
        parseJSON
          = Core.withObject "AccountBusinessIdentity"
              (\ o ->
                 AccountBusinessIdentity Core.<$>
                   (o Core..:? "blackOwned") Core.<*>
                     (o Core..:? "includeForPromotions")
...
newAccountBusinessInformation 
    ::  AccountBusinessInformation
newAccountBusinessInformation
  = AccountBusinessInformation{address = Core.Nothing,
                               customerService = Core.Nothing,
                               koreanBusinessRegistrationNumber = Core.Nothing,
                               phoneNumber = Core.Nothing, phoneVerificationStatus = Core.Nothing}
instance Core.FromJSON AccountBusinessInformation where
        parseJSON
          = Core.withObject "AccountBusinessInformation"
              (\ o ->
                 AccountBusinessInformation Core.<$>
                   (o Core..:? "address") Core.<*> (o Core..:? "customerService")
          ...
          = Core.object
              (Core.catMaybes
                 [("address" Core..=) Core.<$> address,
                  ...
                  ("koreanBusinessRegistrationNumber" Core..=) Core.<$>
                    koreanBusinessRegistrationNumber,
                  ("phoneNumber" Core..=) Core.<$> phoneNumber,
                  ("phoneVerificationStatus" Core..=) Core.<$>
...
newAccountConversionSettings 
    ::  AccountConversionSettings
newAccountConversionSettings
  = AccountConversionSettings{freeListingsAutoTaggingEnabled =
                                Core.Nothing}
instance Core.FromJSON AccountConversionSettings where
        parseJSON
          = Core.withObject "AccountConversionSettings"
              (\ o ->
                 AccountConversionSettings Core.<$>
                   (o Core..:? "freeListingsAutoTaggingEnabled"))

instance Core.ToJSON AccountConversionSettings where
        toJSON AccountConversionSettings{..}
          = Core.object
              (Core.catMaybes
                 [("freeListingsAutoTaggingEnabled" Core..=) Core.<$>
...
newAccountCredentials 
    ::  AccountCredentials
newAccountCredentials
  = AccountCredentials{accessToken = Core.Nothing,
                       expiresIn = Core.Nothing, purpose = Core.Nothing}
instance Core.FromJSON AccountCredentials where
        parseJSON
          = Core.withObject "AccountCredentials"
              (\ o ->
                 AccountCredentials Core.<$>
                   (o Core..:? "accessToken") Core.<*>
                     (o Core..:? "expiresIn" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "purpose"))
...
newAccountCustomerService 
    ::  AccountCustomerService
newAccountCustomerService
  = AccountCustomerService{email = Core.Nothing,
                           phoneNumber = Core.Nothing, url = Core.Nothing}
instance Core.FromJSON AccountCustomerService where
        parseJSON
          = Core.withObject "AccountCustomerService"
              (\ o ->
                 AccountCustomerService Core.<$>
...
newAccountGoogleMyBusinessLink 
    ::  AccountGoogleMyBusinessLink
newAccountGoogleMyBusinessLink
  = AccountGoogleMyBusinessLink{gmbAccountId = Core.Nothing,
                                gmbEmail = Core.Nothing, status = Core.Nothing}
instance Core.FromJSON AccountGoogleMyBusinessLink where
        parseJSON
          = Core.withObject "AccountGoogleMyBusinessLink"
              (\ o ->
                 AccountGoogleMyBusinessLink Core.<$>
                   (o Core..:? "gmbAccountId") Core.<*> (o Core..:? "gmbEmail")
                     Core.<*> (o Core..:? "status"))
...
newAccountIdentifier 
    ::  AccountIdentifier
newAccountIdentifier
  = AccountIdentifier{aggregatorId = Core.Nothing,
                      merchantId = Core.Nothing}
instance Core.FromJSON AccountIdentifier where
        parseJSON
          = Core.withObject "AccountIdentifier"
              (\ o ->
                 AccountIdentifier Core.<$>
                   (o Core..:? "aggregatorId" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
...
instance Core.FromJSON AccountIdentityType where
        parseJSON
          = Core.withObject "AccountIdentityType"
...
newAccountImageImprovements 
    ::  AccountImageImprovements
newAccountImageImprovements
  = AccountImageImprovements{accountImageImprovementsSettings =
                               Core.Nothing,
                             effectiveAllowAutomaticImageImprovements = Core.Nothing}
instance Core.FromJSON AccountImageImprovements where
        parseJSON
          = Core.withObject "AccountImageImprovements"
              (\ o ->
                 AccountImageImprovements Core.<$>
                   (o Core..:? "accountImageImprovementsSettings") Core.<*>
                     (o Core..:? "effectiveAllowAutomaticImageImprovements"))

instance Core.ToJSON AccountImageImprovements where
        toJSON AccountImageImprovements{..}
          = Core.object
              (Core.catMaybes
                 [("accountImageImprovementsSettings" Core..=) Core.<$>
                    accountImageImprovementsSettings,
                  ("effectiveAllowAutomaticImageImprovements" Core..=) Core.<$>
...
newAccountIssue 
    ::  AccountIssue
newAccountIssue
  = AccountIssue{actions = Core.Nothing, impact = Core.Nothing,
...
instance Core.FromJSON AccountIssue where
        parseJSON
          = Core.withObject "AccountIssue"
              (\ o ->
                 AccountIssue Core.<$>
                   (o Core..:? "actions") Core.<*> (o Core..:? "impact") Core.<*>
                     (o Core..:? "prerenderedContent")
          ...
          = Core.object
              (Core.catMaybes
                 [("actions" Core..=) Core.<$> actions,
                  ...
                  ("prerenderedOutOfCourtDisputeSettlement" Core..=) Core.<$>
...
newAccountIssueImpact 
    ::  AccountIssueImpact
newAccountIssueImpact
  = AccountIssueImpact{breakdowns = Core.Nothing,
                       message = Core.Nothing, severity = Core.Nothing}
instance Core.FromJSON AccountIssueImpact where
        parseJSON
          = Core.withObject "AccountIssueImpact"
              (\ o ->
                 AccountIssueImpact Core.<$>
                   (o Core..:? "breakdowns") Core.<*> (o Core..:? "message") Core.<*>
                     (o Core..:? "severity"))
...
newAccountItemUpdates 
    ::  AccountItemUpdates
newAccountItemUpdates
  = AccountItemUpdates{accountItemUpdatesSettings = Core.Nothing,
...
instance Core.FromJSON AccountItemUpdates where
        parseJSON
          = Core.withObject "AccountItemUpdates"
              (\ o ->
                 AccountItemUpdates Core.<$>
                   (o Core..:? "accountItemUpdatesSettings") Core.<*>
                     (o Core..:? "effectiveAllowAvailabilityUpdates")
...
instance Core.ToJSON AccountItemUpdates where
        toJSON AccountItemUpdates{..}
          = Core.object
              (Core.catMaybes
                 [("accountItemUpdatesSettings" Core..=) Core.<$>
                    accountItemUpdatesSettings,
                  ("effectiveAllowAvailabilityUpdates" Core..=) Core.<$>
                    effectiveAllowAvailabilityUpdates,
                  ("effectiveAllowConditionUpdates" Core..=) Core.<$>
                    effectiveAllowConditionUpdates,
                  ("effectiveAllowPriceUpdates" Core..=) Core.<$>
                    effectiveAllowPriceUpdates,
                  ("effectiveAllowStrictAvailabilityUpdates" Core..=) Core.<$>
...
newAccountItemUpdatesSettings 
    ::  AccountItemUpdatesSettings
newAccountItemUpdatesSettings
  = AccountItemUpdatesSettings{allowAvailabilityUpdates =
                                 Core.Nothing,
...
instance Core.FromJSON AccountItemUpdatesSettings where
        parseJSON
          = Core.withObject "AccountItemUpdatesSettings"
              (\ o ->
                 AccountItemUpdatesSettings Core.<$>
                   (o Core..:? "allowAvailabilityUpdates") Core.<*>
                     (o Core..:? "allowConditionUpdates")
...
instance Core.ToJSON AccountItemUpdatesSettings where
        toJSON AccountItemUpdatesSettings{..}
          = Core.object
              (Core.catMaybes
                 [("allowAvailabilityUpdates" Core..=) Core.<$>
                  ...
                  ("allowStrictAvailabilityUpdates" Core..=) Core.<$>
...
newAccountLabel 
    ::  AccountLabel
newAccountLabel
  = AccountLabel{accountId = Core.Nothing,
                 description = Core.Nothing, labelId = Core.Nothing,
                 labelType = Core.Nothing, name = Core.Nothing}
instance Core.FromJSON AccountLabel where
        parseJSON
          = Core.withObject "AccountLabel"
              (\ o ->
                 AccountLabel Core.<$>
...
newAccountReturnCarrier 
    ::  AccountReturnCarrier
newAccountReturnCarrier
  = AccountReturnCarrier{carrierAccountId = Core.Nothing,
                         carrierAccountName = Core.Nothing,
                         carrierAccountNumber = Core.Nothing, carrierCode = Core.Nothing}
instance Core.FromJSON AccountReturnCarrier where
        parseJSON
          = Core.withObject "AccountReturnCarrier"
              (\ o ->
                 AccountReturnCarrier Core.<$>
                   (o Core..:? "carrierAccountId" Core.<&> Core.fmap Core.fromAsText)
...
instance Core.ToJSON AccountReturnCarrier where
        toJSON AccountReturnCarrier{..}
          = Core.object
              (Core.catMaybes
                 [("carrierAccountId" Core..=) Core.. Core.AsText Core.<$>
                    carrierAccountId,
...
newAccountShippingImprovements 
    ::  AccountShippingImprovements
newAccountShippingImprovements
  = AccountShippingImprovements{allowShippingImprovements =
                                  Core.Nothing}
instance Core.FromJSON AccountShippingImprovements where
        parseJSON
          = Core.withObject "AccountShippingImprovements"
              (\ o ->
                 AccountShippingImprovements Core.<$>
                   (o Core..:? "allowShippingImprovements"))

instance Core.ToJSON AccountShippingImprovements where
        toJSON AccountShippingImprovements{..}
          = Core.object
              (Core.catMaybes
                 [("allowShippingImprovements" Core..=) Core.<$>
...
newAccountStatus 
    ::  AccountStatus
newAccountStatus
  = AccountStatus{accountId = Core.Nothing,
                  accountLevelIssues = Core.Nothing,
                  accountManagement = Core.Nothing, kind = Core.Nothing,
                  products = Core.Nothing, websiteClaimed = Core.Nothing}
instance Core.FromJSON AccountStatus where
        parseJSON
          = Core.withObject "AccountStatus"
              (\ o ->
                 AccountStatus Core.<$>
                   (o Core..:? "accountId") Core.<*> (o Core..:? "accountLevelIssues")
...
newAccountStatusAccountLevelIssue 
    ::  AccountStatusAccountLevelIssue
newAccountStatusAccountLevelIssue
  = AccountStatusAccountLevelIssue{country = Core.Nothing,
                                   destination = Core.Nothing, detail = Core.Nothing,
                                   documentation = Core.Nothing, id = Core.Nothing,
                                   severity = Core.Nothing, title = Core.Nothing}
instance Core.FromJSON AccountStatusAccountLevelIssue where
        parseJSON
          = Core.withObject "AccountStatusAccountLevelIssue"
              (\ o ->
                 AccountStatusAccountLevelIssue Core.<$>
                   (o Core..:? "country") Core.<*> (o Core..:? "destination") Core.<*>
                     (o Core..:? "detail")
          ...
          = Core.object
              (Core.catMaybes
                 [("country" Core..=) Core.<$> country,
                  ...
                  ("id" Core..=) Core.<$> id, ("severity" Core..=) Core.<$> severity,
                  ("title" Core..=) Core.<$> title])
...
newAccountStatusItemLevelIssue 
    ::  AccountStatusItemLevelIssue
newAccountStatusItemLevelIssue
  = AccountStatusItemLevelIssue{attributeName = Core.Nothing,
                                code = Core.Nothing, description = Core.Nothing,
                                detail = Core.Nothing, documentation = Core.Nothing,
                                numItems = Core.Nothing, resolution = Core.Nothing,
                                servability = Core.Nothing}
instance Core.FromJSON AccountStatusItemLevelIssue where
        parseJSON
          = Core.withObject "AccountStatusItemLevelIssue"
              (\ o ->
                 AccountStatusItemLevelIssue Core.<$>
                   (o Core..:? "attributeName") Core.<*> (o Core..:? "code") Core.<*>
                     (o Core..:? "description")
                     Core.<*> (o Core..:? "detail")
                     Core.<*> (o Core..:? "documentation")
...
newAccountStatusProducts 
    ::  AccountStatusProducts
newAccountStatusProducts
  = AccountStatusProducts{channel = Core.Nothing,
                          country = Core.Nothing, destination = Core.Nothing,
                          itemLevelIssues = Core.Nothing, statistics = Core.Nothing}
instance Core.FromJSON AccountStatusProducts where
        parseJSON
          = Core.withObject "AccountStatusProducts"
              (\ o ->
                 AccountStatusProducts Core.<$>
                   (o Core..:? "channel") Core.<*> (o Core..:? "country") Core.<*>
                     (o Core..:? "destination")
...
newAccountStatusStatistics 
    ::  AccountStatusStatistics
newAccountStatusStatistics
  = AccountStatusStatistics{active = Core.Nothing,
                            disapproved = Core.Nothing, expiring = Core.Nothing,
                            pending = Core.Nothing}
instance Core.FromJSON AccountStatusStatistics where
        parseJSON
          = Core.withObject "AccountStatusStatistics"
              (\ o ->
                 AccountStatusStatistics Core.<$>
                   (o Core..:? "active" Core.<&> Core.fmap Core.fromAsText) Core.<*>
                     (o Core..:? "disapproved" Core.<&> Core.fmap Core.fromAsText)
...
newAccountTax 
    ::  AccountTax
newAccountTax
  = AccountTax{accountId = Core.Nothing, kind = Core.Nothing,
               rules = Core.Nothing}
instance Core.FromJSON AccountTax where
        parseJSON
          = Core.withObject "AccountTax"
              (\ o ->
                 AccountTax Core.<$>
                   (o Core..:? "accountId" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "kind")
...
instance Core.ToJSON AccountTax where
        toJSON AccountTax{..}
          = Core.object
              (Core.catMaybes
                 [("accountId" Core..=) Core.. Core.AsText Core.<$> accountId,
                  ("kind" Core..=) Core.<$> kind, ("rules" Core..=) Core.<$> rules])
...
newAccountTaxTaxRule 
    ::  AccountTaxTaxRule
newAccountTaxTaxRule
  = AccountTaxTaxRule{country = Core.Nothing,
                      locationId = Core.Nothing, ratePercent = Core.Nothing,
                      shippingTaxed = Core.Nothing, useGlobalRate = Core.Nothing}
instance Core.FromJSON AccountTaxTaxRule where
        parseJSON
          = Core.withObject "AccountTaxTaxRule"
              (\ o ->
                 AccountTaxTaxRule Core.<$>
                   (o Core..:? "country") Core.<*>
                     (o Core..:? "locationId" Core.<&> Core.fmap Core.fromAsText)
...
newAccountUser 
    ::  AccountUser
newAccountUser
  = AccountUser{admin = Core.Nothing, emailAddress = Core.Nothing,
                orderManager = Core.Nothing, paymentsAnalyst = Core.Nothing,
                paymentsManager = Core.Nothing, readOnly = Core.Nothing,
                reportingManager = Core.Nothing}
instance Core.FromJSON AccountUser where
        parseJSON
          = Core.withObject "AccountUser"
              (\ o ->
                 AccountUser Core.<$>
                   (o Core..:? "admin") Core.<*> (o Core..:? "emailAddress") Core.<*>
                     (o Core..:? "orderManager")
...
newAccountYouTubeChannelLink 
    ::  AccountYouTubeChannelLink
newAccountYouTubeChannelLink
  = AccountYouTubeChannelLink{channelId = Core.Nothing,
                              status = Core.Nothing}
instance Core.FromJSON AccountYouTubeChannelLink where
        parseJSON
          = Core.withObject "AccountYouTubeChannelLink"
              (\ o ->
                 AccountYouTubeChannelLink Core.<$>
                   (o Core..:? "channelId") Core.<*> (o Core..:? "status"))
...
newAccountsAuthInfoResponse 
    ::  AccountsAuthInfoResponse
newAccountsAuthInfoResponse
  = AccountsAuthInfoResponse{accountIdentifiers = Core.Nothing,
                             kind = Core.Nothing}
instance Core.FromJSON AccountsAuthInfoResponse where
        parseJSON
          = Core.withObject "AccountsAuthInfoResponse"
              (\ o ->
                 AccountsAuthInfoResponse Core.<$>
                   (o Core..:? "accountIdentifiers") Core.<*> (o Core..:? "kind"))
...
instance Core.FromJSON AccountsClaimWebsiteResponse where
        parseJSON
          = Core.withObject "AccountsClaimWebsiteResponse"
...
instance Core.FromJSON AccountsCustomBatchRequest where
        parseJSON
          = Core.withObject "AccountsCustomBatchRequest"
...
newAccountsCustomBatchRequestEntry 
    :: 
                                   AccountsCustomBatchRequestEntry
newAccountsCustomBatchRequestEntry
  = AccountsCustomBatchRequestEntry{account = Core.Nothing,
                                    accountId = Core.Nothing, batchId = Core.Nothing,
                                    force = Core.Nothing, labelIds = Core.Nothing,
                                    linkRequest = Core.Nothing, merchantId = Core.Nothing,
                                    method = Core.Nothing, overwrite = Core.Nothing,
                                    view = Core.Nothing}
instance Core.FromJSON AccountsCustomBatchRequestEntry where
        parseJSON
          = Core.withObject "AccountsCustomBatchRequestEntry"
              (\ o ->
                 AccountsCustomBatchRequestEntry Core.<$>
                   (o Core..:? "account") Core.<*>
                     (o Core..:? "accountId" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "batchId")
                     Core.<*> (o Core..:? "force")
...
newAccountsCustomBatchRequestEntryLinkRequest 
    :: 
                                              AccountsCustomBatchRequestEntryLinkRequest
newAccountsCustomBatchRequestEntryLinkRequest
  = AccountsCustomBatchRequestEntryLinkRequest{action = Core.Nothing,
                                               linkType = Core.Nothing,
                                               linkedAccountId = Core.Nothing,
                                               services = Core.Nothing}
instance Core.FromJSON AccountsCustomBatchRequestEntryLinkRequest
         where
        parseJSON
          = Core.withObject "AccountsCustomBatchRequestEntryLinkRequest"
              (\ o ->
                 AccountsCustomBatchRequestEntryLinkRequest Core.<$>
                   (o Core..:? "action") Core.<*> (o Core..:? "linkType") Core.<*>
                     (o Core..:? "linkedAccountId")
                     Core.<*> (o Core..:? "services"))

instance Core.ToJSON AccountsCustomBatchRequestEntryLinkRequest
         where
...
newAccountsCustomBatchResponse 
    ::  AccountsCustomBatchResponse
newAccountsCustomBatchResponse
  = AccountsCustomBatchResponse{entries = Core.Nothing,
                                kind = Core.Nothing}
instance Core.FromJSON AccountsCustomBatchResponse where
        parseJSON
          = Core.withObject "AccountsCustomBatchResponse"
              (\ o ->
                 AccountsCustomBatchResponse Core.<$>
                   (o Core..:? "entries") Core.<*> (o Core..:? "kind"))
...
newAccountsCustomBatchResponseEntry 
    :: 
                                    AccountsCustomBatchResponseEntry
newAccountsCustomBatchResponseEntry
  = AccountsCustomBatchResponseEntry{account = Core.Nothing,
                                     batchId = Core.Nothing, errors = Core.Nothing,
                                     kind = Core.Nothing}
instance Core.FromJSON AccountsCustomBatchResponseEntry where
        parseJSON
          = Core.withObject "AccountsCustomBatchResponseEntry"
              (\ o ->
                 AccountsCustomBatchResponseEntry Core.<$>
                   (o Core..:? "account") Core.<*> (o Core..:? "batchId") Core.<*>
                     (o Core..:? "errors")
                     Core.<*> (o Core..:? "kind"))
...
newAccountsLinkRequest 
    ::  AccountsLinkRequest
newAccountsLinkRequest
  = AccountsLinkRequest{action = Core.Nothing,
                        eCommercePlatformLinkInfo = Core.Nothing, linkType = Core.Nothing,
                        linkedAccountId = Core.Nothing,
                        paymentServiceProviderLinkInfo = Core.Nothing,
                        services = Core.Nothing}
instance Core.FromJSON AccountsLinkRequest where
        parseJSON
          = Core.withObject "AccountsLinkRequest"
              (\ o ->
                 AccountsLinkRequest Core.<$>
                   (o Core..:? "action") Core.<*>
                     (o Core..:? "eCommercePlatformLinkInfo")
...
instance Core.ToJSON AccountsLinkRequest where
        toJSON AccountsLinkRequest{..}
          = Core.object
              (Core.catMaybes
                 [("action" Core..=) Core.<$> action,
                  ("eCommercePlatformLinkInfo" Core..=) Core.<$>
                    eCommercePlatformLinkInfo,
                  ("linkType" Core..=) Core.<$> linkType,
                  ("linkedAccountId" Core..=) Core.<$> linkedAccountId,
                  ("paymentServiceProviderLinkInfo" Core..=) Core.<$>
                    paymentServiceProviderLinkInfo,
                  ("services" Core..=) Core.<$> services])
...
instance Core.FromJSON AccountsLinkResponse where
        parseJSON
          = Core.withObject "AccountsLinkResponse"
...
newAccountsListLinksResponse 
    ::  AccountsListLinksResponse
newAccountsListLinksResponse
  = AccountsListLinksResponse{kind = Core.Nothing,
                              links = Core.Nothing, nextPageToken = Core.Nothing}
instance Core.FromJSON AccountsListLinksResponse where
        parseJSON
          = Core.withObject "AccountsListLinksResponse"
              (\ o ->
                 AccountsListLinksResponse Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "links") Core.<*>
...
instance Core.ToJSON AccountsListLinksResponse where
        toJSON AccountsListLinksResponse{..}
          = Core.object
              (Core.catMaybes
                 [("kind" Core..=) Core.<$> kind, ("links" Core..=) Core.<$> links,
...
newAccountsListResponse 
    ::  AccountsListResponse
newAccountsListResponse
  = AccountsListResponse{kind = Core.Nothing,
                         nextPageToken = Core.Nothing, resources = Core.Nothing}
...
instance Core.FromJSON AccountsUpdateLabelsRequest where
        parseJSON
          = Core.withObject "AccountsUpdateLabelsRequest"
              (\ o ->
                 AccountsUpdateLabelsRequest Core.<$>
                   (o Core..:? "labelIds" Core.<&>
                      Core.fmap (Core.fmap Core.fromAsText)))
...
instance Core.FromJSON AccountsUpdateLabelsResponse where
        parseJSON
          = Core.withObject "AccountsUpdateLabelsResponse"
...
instance Core.FromJSON AccountstatusesCustomBatchRequest where
        parseJSON
          = Core.withObject "AccountstatusesCustomBatchRequest"
              (\ o ->
...
newAccountstatusesCustomBatchRequestEntry 
    :: 
                                          AccountstatusesCustomBatchRequestEntry
newAccountstatusesCustomBatchRequestEntry
  = AccountstatusesCustomBatchRequestEntry{accountId = Core.Nothing,
                                           batchId = Core.Nothing, destinations = Core.Nothing,
                                           merchantId = Core.Nothing, method = Core.Nothing}
instance Core.FromJSON AccountstatusesCustomBatchRequestEntry where
        parseJSON
          = Core.withObject "AccountstatusesCustomBatchRequestEntry"
              (\ o ->
                 AccountstatusesCustomBatchRequestEntry Core.<$>
                   (o Core..:? "accountId" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "batchId")
...
newAccountstatusesCustomBatchResponse 
    :: 
                                      AccountstatusesCustomBatchResponse
newAccountstatusesCustomBatchResponse
  = AccountstatusesCustomBatchResponse{entries = Core.Nothing,
                                       kind = Core.Nothing}
instance Core.FromJSON AccountstatusesCustomBatchResponse where
        parseJSON
          = Core.withObject "AccountstatusesCustomBatchResponse"
              (\ o ->
                 AccountstatusesCustomBatchResponse Core.<$>
                   (o Core..:? "entries") Core.<*> (o Core..:? "kind"))
...
newAccountstatusesCustomBatchResponseEntry 
    :: 
                                           AccountstatusesCustomBatchResponseEntry
newAccountstatusesCustomBatchResponseEntry
  = AccountstatusesCustomBatchResponseEntry{accountStatus =
                                              Core.Nothing,
                                            batchId = Core.Nothing, errors = Core.Nothing}
instance Core.FromJSON AccountstatusesCustomBatchResponseEntry
         where
        parseJSON
          = Core.withObject "AccountstatusesCustomBatchResponseEntry"
              (\ o ->
                 AccountstatusesCustomBatchResponseEntry Core.<$>
                   (o Core..:? "accountStatus") Core.<*> (o Core..:? "batchId")
                     Core.<*> (o Core..:? "errors"))
...
newAccountstatusesListResponse 
    ::  AccountstatusesListResponse
newAccountstatusesListResponse
  = AccountstatusesListResponse{kind = Core.Nothing,
                                nextPageToken = Core.Nothing, resources = Core.Nothing}
instance Core.FromJSON AccountstatusesListResponse where
        parseJSON
          = Core.withObject "AccountstatusesListResponse"
              (\ o ->
                 AccountstatusesListResponse Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "resources"))
...
instance Core.FromJSON AccounttaxCustomBatchRequest where
        parseJSON
          = Core.withObject "AccounttaxCustomBatchRequest"
              (\ o ->
...
newAccounttaxCustomBatchRequestEntry 
    :: 
                                     AccounttaxCustomBatchRequestEntry
newAccounttaxCustomBatchRequestEntry
  = AccounttaxCustomBatchRequestEntry{accountId = Core.Nothing,
                                      accountTax = Core.Nothing, batchId = Core.Nothing,
                                      merchantId = Core.Nothing, method = Core.Nothing}
instance Core.FromJSON AccounttaxCustomBatchRequestEntry where
        parseJSON
          = Core.withObject "AccounttaxCustomBatchRequestEntry"
              (\ o ->
                 AccounttaxCustomBatchRequestEntry Core.<$>
                   (o Core..:? "accountId" Core.<&> Core.fmap Core.fromAsText)
...
newAccounttaxCustomBatchResponse 
    ::  AccounttaxCustomBatchResponse
newAccounttaxCustomBatchResponse
  = AccounttaxCustomBatchResponse{entries = Core.Nothing,
                                  kind = Core.Nothing}
instance Core.FromJSON AccounttaxCustomBatchResponse where
        parseJSON
          = Core.withObject "AccounttaxCustomBatchResponse"
              (\ o ->
                 AccounttaxCustomBatchResponse Core.<$>
                   (o Core..:? "entries") Core.<*> (o Core..:? "kind"))
...
newAccounttaxCustomBatchResponseEntry 
    :: 
                                      AccounttaxCustomBatchResponseEntry
newAccounttaxCustomBatchResponseEntry
  = AccounttaxCustomBatchResponseEntry{accountTax = Core.Nothing,
                                       batchId = Core.Nothing, errors = Core.Nothing,
                                       kind = Core.Nothing}
instance Core.FromJSON AccounttaxCustomBatchResponseEntry where
        parseJSON
          = Core.withObject "AccounttaxCustomBatchResponseEntry"
              (\ o ->
                 AccounttaxCustomBatchResponseEntry Core.<$>
                   (o Core..:? "accountTax") Core.<*> (o Core..:? "batchId") Core.<*>
                     (o Core..:? "errors")
                     Core.<*> (o Core..:? "kind"))
...
newAccounttaxListResponse 
    ::  AccounttaxListResponse
newAccounttaxListResponse
  = AccounttaxListResponse{kind = Core.Nothing,
                           nextPageToken = Core.Nothing, resources = Core.Nothing}
instance Core.FromJSON AccounttaxListResponse where
        parseJSON
          = Core.withObject "AccounttaxListResponse"
              (\ o ->
                 AccounttaxListResponse Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "resources"))
...
newAction 
    ::  Action
newAction
  = Action{builtinSimpleAction = Core.Nothing,
           builtinUserInputAction = Core.Nothing, buttonLabel = Core.Nothing,
           externalAction = Core.Nothing, isAvailable = Core.Nothing,
           reasons = Core.Nothing}
instance Core.FromJSON Action where
        parseJSON
          = Core.withObject "Action"
              (\ o ->
                 Action Core.<$>
                   (o Core..:? "builtinSimpleAction") Core.<*>
                     (o Core..:? "builtinUserInputAction")
...
newActionFlow 
    ::  ActionFlow
newActionFlow
  = ActionFlow{dialogButtonLabel = Core.Nothing,
               dialogCallout = Core.Nothing, dialogMessage = Core.Nothing,
               dialogTitle = Core.Nothing, id = Core.Nothing,
               inputs = Core.Nothing, label = Core.Nothing}
instance Core.FromJSON ActionFlow where
        parseJSON
          = Core.withObject "ActionFlow"
              (\ o ->
                 ActionFlow Core.<$>
                   (o Core..:? "dialogButtonLabel") Core.<*>
                     (o Core..:? "dialogCallout")
          ...
          = Core.object
              (Core.catMaybes
                 [("dialogButtonLabel" Core..=) Core.<$> dialogButtonLabel,
                  ...
                  ("id" Core..=) Core.<$> id, ("inputs" Core..=) Core.<$> inputs,
...
newActionInput 
    ::  ActionInput
newActionInput
  = ActionInput{actionFlowId = Core.Nothing,
                inputValues = Core.Nothing}
instance Core.FromJSON ActionInput where
        parseJSON
          = Core.withObject "ActionInput"
              (\ o ->
                 ActionInput Core.<$>
                   (o Core..:? "actionFlowId") Core.<*> (o Core..:? "inputValues"))
...
newActionReason 
    ::  ActionReason
newActionReason
  = ActionReason{action = Core.Nothing, detail = Core.Nothing,
                 message = Core.Nothing}
instance Core.FromJSON ActionReason where
        parseJSON
          = Core.withObject "ActionReason"
              (\ o ->
                 ActionReason Core.<$>
                   (o Core..:? "action") Core.<*> (o Core..:? "detail") Core.<*>
                     (o Core..:? "message"))
...
newAddress 
    ::  Address
newAddress
  = Address{administrativeArea = Core.Nothing, city = Core.Nothing,
            country = Core.Nothing, postalCode = Core.Nothing,
            streetAddress = Core.Nothing}
instance Core.FromJSON Address where
        parseJSON
          = Core.withObject "Address"
              (\ o ->
                 Address Core.<$>
                   (o Core..:? "administrativeArea") Core.<*> (o Core..:? "city")
                     Core.<*> (o Core..:? "country")
...
newAlternateDisputeResolution 
    ::  AlternateDisputeResolution
newAlternateDisputeResolution
  = AlternateDisputeResolution{label = Core.Nothing,
                               uri = Core.Nothing}
instance Core.FromJSON AlternateDisputeResolution where
        parseJSON
          = Core.withObject "AlternateDisputeResolution"
              (\ o ->
                 AlternateDisputeResolution Core.<$>
                   (o Core..:? "label") Core.<*> (o Core..:? "uri"))
...
newAttributionSettings 
    ::  AttributionSettings
newAttributionSettings
  = AttributionSettings{attributionLookbackWindowInDays =
                          Core.Nothing,
                        attributionModel = Core.Nothing, conversionType = Core.Nothing}
instance Core.FromJSON AttributionSettings where
        parseJSON
          = Core.withObject "AttributionSettings"
              (\ o ->
                 AttributionSettings Core.<$>
                   (o Core..:? "attributionLookbackWindowInDays") Core.<*>
                     (o Core..:? "attributionModel")
...
instance Core.ToJSON AttributionSettings where
        toJSON AttributionSettings{..}
          = Core.object
              (Core.catMaybes
                 [("attributionLookbackWindowInDays" Core..=) Core.<$>
...
newAttributionSettingsConversionType 
    :: 
                                     AttributionSettingsConversionType
newAttributionSettingsConversionType
  = AttributionSettingsConversionType{includeInReporting =
                                        Core.Nothing,
                                      name = Core.Nothing}
instance Core.FromJSON AttributionSettingsConversionType where
        parseJSON
          = Core.withObject "AttributionSettingsConversionType"
              (\ o ->
                 AttributionSettingsConversionType Core.<$>
                   (o Core..:? "includeInReporting") Core.<*> (o Core..:? "name"))
...
newBestSellers 
    ::  BestSellers
newBestSellers
  = BestSellers{categoryId = Core.Nothing,
                countryCode = Core.Nothing, previousRank = Core.Nothing,
                previousRelativeDemand = Core.Nothing, rank = Core.Nothing,
                relativeDemand = Core.Nothing, relativeDemandChange = Core.Nothing,
                reportDate = Core.Nothing, reportGranularity = Core.Nothing}
instance Core.FromJSON BestSellers where
        parseJSON
          = Core.withObject "BestSellers"
              (\ o ->
                 BestSellers Core.<$>
                   (o Core..:? "categoryId" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "countryCode")
                     Core.<*>
                     (o Core..:? "previousRank" Core.<&> Core.fmap Core.fromAsText)
...
instance Core.FromJSON Breakdown where
        parseJSON
          = Core.withObject "Breakdown"
              (\ o ->
                 Breakdown Core.<$>
                   (o Core..:? "details") Core.<*> (o Core..:? "regions"))
...
instance Core.FromJSON BreakdownRegion where
        parseJSON
          = Core.withObject "BreakdownRegion"
              (\ o ->
                 BreakdownRegion Core.<$>
                   (o Core..:? "code") Core.<*> (o Core..:? "name"))
...
newBuiltInSimpleAction 
    ::  BuiltInSimpleAction
newBuiltInSimpleAction
  = BuiltInSimpleAction{additionalContent = Core.Nothing,
                        attributeCode = Core.Nothing, type' = Core.Nothing}
instance Core.FromJSON BuiltInSimpleAction where
        parseJSON
          = Core.withObject "BuiltInSimpleAction"
              (\ o ->
                 BuiltInSimpleAction Core.<$>
                   (o Core..:? "additionalContent") Core.<*>
                     (o Core..:? "attributeCode")
                     Core.<*> (o Core..:? "type"))
...
newBuiltInSimpleActionAdditionalContent 
    :: 
                                        BuiltInSimpleActionAdditionalContent
newBuiltInSimpleActionAdditionalContent
  = BuiltInSimpleActionAdditionalContent{paragraphs = Core.Nothing,
                                         title = Core.Nothing}
instance Core.FromJSON BuiltInSimpleActionAdditionalContent where
        parseJSON
          = Core.withObject "BuiltInSimpleActionAdditionalContent"
              (\ o ->
                 BuiltInSimpleActionAdditionalContent Core.<$>
                   (o Core..:? "paragraphs") Core.<*> (o Core..:? "title"))
...
newBuiltInUserInputAction 
    ::  BuiltInUserInputAction
newBuiltInUserInputAction
  = BuiltInUserInputAction{actionContext = Core.Nothing,
                           flows = Core.Nothing}
instance Core.FromJSON BuiltInUserInputAction where
        parseJSON
          = Core.withObject "BuiltInUserInputAction"
              (\ o ->
                 BuiltInUserInputAction Core.<$>
                   (o Core..:? "actionContext") Core.<*> (o Core..:? "flows"))
...
instance Core.FromJSON BusinessDayConfig where
        parseJSON
          = Core.withObject "BusinessDayConfig"
...
instance Core.FromJSON Callout where
        parseJSON
          = Core.withObject "Callout"
              (\ o ->
                 Callout Core.<$>
                   (o Core..:? "fullMessage") Core.<*> (o Core..:? "styleHint"))
...
newCarrierRate 
    ::  CarrierRate
newCarrierRate
  = CarrierRate{carrierName = Core.Nothing,
                carrierService = Core.Nothing, flatAdjustment = Core.Nothing,
                name = Core.Nothing, originPostalCode = Core.Nothing,
                percentageAdjustment = Core.Nothing}
instance Core.FromJSON CarrierRate where
        parseJSON
          = Core.withObject "CarrierRate"
              (\ o ->
                 CarrierRate Core.<$>
                   (o Core..:? "carrierName") Core.<*> (o Core..:? "carrierService")
...
newCarriersCarrier 
    ::  CarriersCarrier
newCarriersCarrier
  = CarriersCarrier{country = Core.Nothing,
                    eddServices = Core.Nothing, name = Core.Nothing,
                    services = Core.Nothing}
instance Core.FromJSON CarriersCarrier where
        parseJSON
          = Core.withObject "CarriersCarrier"
              (\ o ->
                 CarriersCarrier Core.<$>
                   (o Core..:? "country") Core.<*> (o Core..:? "eddServices") Core.<*>
                     (o Core..:? "name")
                     Core.<*> (o Core..:? "services"))
...
newCheckoutSettings 
    ::  CheckoutSettings
newCheckoutSettings
  = CheckoutSettings{effectiveEnrollmentState = Core.Nothing,
                     effectiveReviewState = Core.Nothing,
                     effectiveUriSettings = Core.Nothing,
                     enrollmentState = Core.Nothing, merchantId = Core.Nothing,
                     reviewState = Core.Nothing, uriSettings = Core.Nothing}
instance Core.FromJSON CheckoutSettings where
        parseJSON
          = Core.withObject "CheckoutSettings"
              (\ o ->
                 CheckoutSettings Core.<$>
                   (o Core..:? "effectiveEnrollmentState") Core.<*>
                     (o Core..:? "effectiveReviewState")
...
instance Core.ToJSON CheckoutSettings where
        toJSON CheckoutSettings{..}
          = Core.object
              (Core.catMaybes
                 [("effectiveEnrollmentState" Core..=) Core.<$>
...
newCloudExportAdditionalProperties 
    :: 
                                   CloudExportAdditionalProperties
newCloudExportAdditionalProperties
  = CloudExportAdditionalProperties{boolValue = Core.Nothing,
                                    floatValue = Core.Nothing, intValue = Core.Nothing,
                                    maxValue = Core.Nothing, minValue = Core.Nothing,
                                    propertyName = Core.Nothing, textValue = Core.Nothing,
                                    unitCode = Core.Nothing}
instance Core.FromJSON CloudExportAdditionalProperties where
        parseJSON
          = Core.withObject "CloudExportAdditionalProperties"
              (\ o ->
                 CloudExportAdditionalProperties Core.<$>
                   (o Core..:? "boolValue") Core.<*> (o Core..:? "floatValue")
                     Core.<*>
          ...
          = Core.object
              (Core.catMaybes
                 [("boolValue" Core..=) Core.<$> boolValue,
                  ...
                  ("intValue" Core..=) Core.. Core.fmap Core.AsText Core.<$>
                    intValue,
...
newCollection 
    ::  Collection
newCollection
  = Collection{customLabel0 = Core.Nothing,
               customLabel1 = Core.Nothing, customLabel2 = Core.Nothing,
               customLabel3 = Core.Nothing, customLabel4 = Core.Nothing,
               featuredProduct = Core.Nothing, headline = Core.Nothing,
               id = Core.Nothing, imageLink = Core.Nothing,
               language = Core.Nothing, link = Core.Nothing,
               mobileLink = Core.Nothing, productCountry = Core.Nothing}
instance Core.FromJSON Collection where
        parseJSON
          = Core.withObject "Collection"
              (\ o ->
                 Collection Core.<$>
                   (o Core..:? "customLabel0") Core.<*> (o Core..:? "customLabel1")
          ...
          = Core.object
              (Core.catMaybes
                 [("customLabel0" Core..=) Core.<$> customLabel0,
                  ...
                  ("headline" Core..=) Core.<$> headline, ("id" Core..=) Core.<$> id,
...
newCollectionFeaturedProduct 
    ::  CollectionFeaturedProduct
newCollectionFeaturedProduct
  = CollectionFeaturedProduct{offerId = Core.Nothing,
                              x = Core.Nothing, y = Core.Nothing}
instance Core.FromJSON CollectionFeaturedProduct where
        parseJSON
          = Core.withObject "CollectionFeaturedProduct"
              (\ o ->
                 CollectionFeaturedProduct Core.<$>
                   (o Core..:? "offerId") Core.<*> (o Core..:? "x") Core.<*>
                     (o Core..:? "y"))
...
instance Core.ToJSON CollectionFeaturedProduct where
        toJSON CollectionFeaturedProduct{..}
          = Core.object
              (Core.catMaybes
                 [("offerId" Core..=) Core.<$> offerId, ("x" Core..=) Core.<$> x,
                  ("y" Core..=) Core.<$> y])
...
newCollectionStatus 
    ::  CollectionStatus
newCollectionStatus
  = CollectionStatus{collectionLevelIssuses = Core.Nothing,
                     creationDate = Core.Nothing, destinationStatuses = Core.Nothing,
                     id = Core.Nothing, lastUpdateDate = Core.Nothing}
instance Core.FromJSON CollectionStatus where
        parseJSON
          = Core.withObject "CollectionStatus"
              (\ o ->
                 CollectionStatus Core.<$>
                   (o Core..:? "collectionLevelIssuses") Core.<*>
                     (o Core..:? "creationDate")
...
instance Core.ToJSON CollectionStatus where
        toJSON CollectionStatus{..}
          = Core.object
              (Core.catMaybes
                 [("collectionLevelIssuses" Core..=) Core.<$>
...
newCollectionStatusDestinationStatus 
    :: 
                                     CollectionStatusDestinationStatus
newCollectionStatusDestinationStatus
  = CollectionStatusDestinationStatus{approvedCountries =
                                        Core.Nothing,
...
instance Core.FromJSON CollectionStatusDestinationStatus where
        parseJSON
          = Core.withObject "CollectionStatusDestinationStatus"
              (\ o ->
                 CollectionStatusDestinationStatus Core.<$>
...
newCollectionStatusItemLevelIssue 
    ::  CollectionStatusItemLevelIssue
newCollectionStatusItemLevelIssue
  = CollectionStatusItemLevelIssue{applicableCountries =
                                     Core.Nothing,
                                   attributeName = Core.Nothing, code = Core.Nothing,
                                   description = Core.Nothing, destination = Core.Nothing,
                                   detail = Core.Nothing, documentation = Core.Nothing,
                                   resolution = Core.Nothing, servability = Core.Nothing}
instance Core.FromJSON CollectionStatusItemLevelIssue where
        parseJSON
          = Core.withObject "CollectionStatusItemLevelIssue"
              (\ o ->
                 CollectionStatusItemLevelIssue Core.<$>
                   (o Core..:? "applicableCountries") Core.<*>
                     (o Core..:? "attributeName")
                     Core.<*> (o Core..:? "code")
                     Core.<*> (o Core..:? "description")
...
newCompetitiveVisibility 
    ::  CompetitiveVisibility
newCompetitiveVisibility
  = CompetitiveVisibility{adsOrganicRatio = Core.Nothing,
                          categoryBenchmarkVisibilityTrend = Core.Nothing,
                          categoryId = Core.Nothing, countryCode = Core.Nothing,
                          date = Core.Nothing, domain = Core.Nothing,
                          higherPositionRate = Core.Nothing, isYourDomain = Core.Nothing,
                          pageOverlapRate = Core.Nothing, rank = Core.Nothing,
                          relativeVisibility = Core.Nothing, trafficSource = Core.Nothing,
                          yourDomainVisibilityTrend = Core.Nothing}
instance Core.FromJSON CompetitiveVisibility where
        parseJSON
          = Core.withObject "CompetitiveVisibility"
              (\ o ->
                 CompetitiveVisibility Core.<$>
                   (o Core..:? "adsOrganicRatio") Core.<*>
                     (o Core..:? "categoryBenchmarkVisibilityTrend")
                     Core.<*>
                     (o Core..:? "categoryId" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "countryCode")
                     Core.<*> (o Core..:? "date")
          ...
          = Core.object
              (Core.catMaybes
                 [("adsOrganicRatio" Core..=) Core.<$> adsOrganicRatio,
                  ("categoryBenchmarkVisibilityTrend" Core..=) Core.<$>
                    categoryBenchmarkVisibilityTrend,
                  ("categoryId" Core..=) Core.. Core.AsText Core.<$> categoryId,
                  ("countryCode" Core..=) Core.<$> countryCode,
                  ("date" Core..=) Core.<$> date, ("domain" Core..=) Core.<$> domain,
                  ...
                  ("yourDomainVisibilityTrend" Core..=) Core.<$>
...
newConversionSource 
    ::  ConversionSource
newConversionSource
  = ConversionSource{conversionSourceId = Core.Nothing,
                     expireTime = Core.Nothing, googleAnalyticsLink = Core.Nothing,
                     merchantCenterDestination = Core.Nothing, state = Core.Nothing}
instance Core.FromJSON ConversionSource where
        parseJSON
          = Core.withObject "ConversionSource"
              (\ o ->
                 ConversionSource Core.<$>
                   (o Core..:? "conversionSourceId") Core.<*>
                     (o Core..:? "expireTime")
          ...
          = Core.object
              (Core.catMaybes
                 [("conversionSourceId" Core..=) Core.<$> conversionSourceId,
                  ...
                  ("merchantCenterDestination" Core..=) Core.<$>
                    merchantCenterDestination,
...
newCss 
    ::  Css
newCss
  = Css{cssDomainId = Core.Nothing, cssGroupId = Core.Nothing,
        displayName = Core.Nothing, fullName = Core.Nothing,
        homepageUri = Core.Nothing, labelIds = Core.Nothing}
instance Core.FromJSON Css where
        parseJSON
          = Core.withObject "Css"
              (\ o ->
                 Css Core.<$>
                   (o Core..:? "cssDomainId" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "cssGroupId" Core.<&> Core.fmap Core.fromAsText)
...
newCustomAttribute 
    ::  CustomAttribute
newCustomAttribute
  = CustomAttribute{groupValues = Core.Nothing, name = Core.Nothing,
                    value = Core.Nothing}
          ...
          = Core.withObject "CustomAttribute"
              (\ o ->
                 CustomAttribute Core.<$>
                   (o Core..:? "groupValues") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "value"))
...
newCutoffTime 
    ::  CutoffTime
newCutoffTime
  = CutoffTime{hour = Core.Nothing, minute = Core.Nothing,
               timezone = Core.Nothing}
instance Core.FromJSON CutoffTime where
        parseJSON
          = Core.withObject "CutoffTime"
              (\ o ->
                 CutoffTime Core.<$>
                   (o Core..:? "hour") Core.<*> (o Core..:? "minute") Core.<*>
                     (o Core..:? "timezone"))
...
newDatafeed 
    ::  Datafeed
newDatafeed
  = Datafeed{attributeLanguage = Core.Nothing,
             contentType = Core.Nothing, fetchSchedule = Core.Nothing,
             fileName = Core.Nothing, format = Core.Nothing, id = Core.Nothing,
             kind = Core.Nothing, name = Core.Nothing, targets = Core.Nothing}
instance Core.FromJSON Datafeed where
        parseJSON
          = Core.withObject "Datafeed"
              (\ o ->
                 Datafeed Core.<$>
                   (o Core..:? "attributeLanguage") Core.<*>
                     (o Core..:? "contentType")
...
newDatafeedFetchSchedule 
    ::  DatafeedFetchSchedule
newDatafeedFetchSchedule
  = DatafeedFetchSchedule{dayOfMonth = Core.Nothing,
                          fetchUrl = Core.Nothing, hour = Core.Nothing,
                          minuteOfHour = Core.Nothing, password = Core.Nothing,
                          paused = Core.Nothing, timeZone = Core.Nothing,
                          username = Core.Nothing, weekday = Core.Nothing}
instance Core.FromJSON DatafeedFetchSchedule where
        parseJSON
          = Core.withObject "DatafeedFetchSchedule"
              (\ o ->
                 DatafeedFetchSchedule Core.<$>
                   (o Core..:? "dayOfMonth") Core.<*> (o Core..:? "fetchUrl") Core.<*>
                     (o Core..:? "hour")
...
newDatafeedFormat 
    ::  DatafeedFormat
newDatafeedFormat
  = DatafeedFormat{columnDelimiter = Core.Nothing,
                   fileEncoding = Core.Nothing, quotingMode = Core.Nothing}
instance Core.FromJSON DatafeedFormat where
        parseJSON
          = Core.withObject "DatafeedFormat"
              (\ o ->
                 DatafeedFormat Core.<$>
                   (o Core..:? "columnDelimiter") Core.<*> (o Core..:? "fileEncoding")
...
newDatafeedStatus 
    ::  DatafeedStatus
newDatafeedStatus
  = DatafeedStatus{country = Core.Nothing, datafeedId = Core.Nothing,
                   errors = Core.Nothing, feedLabel = Core.Nothing,
                   itemsTotal = Core.Nothing, itemsValid = Core.Nothing,
                   kind = Core.Nothing, language = Core.Nothing,
                   lastUploadDate = Core.Nothing, processingStatus = Core.Nothing,
                   warnings = Core.Nothing}
instance Core.FromJSON DatafeedStatus where
        parseJSON
          = Core.withObject "DatafeedStatus"
              (\ o ->
                 DatafeedStatus Core.<$>
                   (o Core..:? "country") Core.<*>
                     (o Core..:? "datafeedId" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "errors")
                     Core.<*> (o Core..:? "feedLabel")
                     Core.<*>
                     (o Core..:? "itemsTotal" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "itemsValid" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "kind")
                     Core.<*> (o Core..:? "language")
...
newDatafeedStatusError 
    ::  DatafeedStatusError
newDatafeedStatusError
  = DatafeedStatusError{code = Core.Nothing, count = Core.Nothing,
                        examples = Core.Nothing, message = Core.Nothing}
instance Core.FromJSON DatafeedStatusError where
        parseJSON
          = Core.withObject "DatafeedStatusError"
              (\ o ->
                 DatafeedStatusError Core.<$>
                   (o Core..:? "code") Core.<*>
...
newDatafeedStatusExample 
    ::  DatafeedStatusExample
newDatafeedStatusExample
  = DatafeedStatusExample{itemId = Core.Nothing,
                          lineNumber = Core.Nothing, value = Core.Nothing}
instance Core.FromJSON DatafeedStatusExample where
        parseJSON
          = Core.withObject "DatafeedStatusExample"
              (\ o ->
                 DatafeedStatusExample Core.<$>
                   (o Core..:? "itemId") Core.<*>
                     (o Core..:? "lineNumber" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "value"))
...
newDatafeedTarget 
    ::  DatafeedTarget
newDatafeedTarget
  = DatafeedTarget{country = Core.Nothing,
                   excludedDestinations = Core.Nothing, feedLabel = Core.Nothing,
                   includedDestinations = Core.Nothing, language = Core.Nothing,
                   targetCountries = Core.Nothing}
instance Core.FromJSON DatafeedTarget where
        parseJSON
          = Core.withObject "DatafeedTarget"
              (\ o ->
                 DatafeedTarget Core.<$>
                   (o Core..:? "country") Core.<*> (o Core..:? "excludedDestinations")
                     Core.<*> (o Core..:? "feedLabel")
...
instance Core.FromJSON DatafeedsCustomBatchRequest where
        parseJSON
          = Core.withObject "DatafeedsCustomBatchRequest"
              (\ o ->
...
newDatafeedsCustomBatchRequestEntry 
    :: 
                                    DatafeedsCustomBatchRequestEntry
newDatafeedsCustomBatchRequestEntry
  = DatafeedsCustomBatchRequestEntry{batchId = Core.Nothing,
                                     datafeed = Core.Nothing, datafeedId = Core.Nothing,
                                     merchantId = Core.Nothing, method = Core.Nothing}
instance Core.FromJSON DatafeedsCustomBatchRequestEntry where
        parseJSON
          = Core.withObject "DatafeedsCustomBatchRequestEntry"
              (\ o ->
                 DatafeedsCustomBatchRequestEntry Core.<$>
                   (o Core..:? "batchId") Core.<*> (o Core..:? "datafeed") Core.<*>
                     (o Core..:? "datafeedId" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "merchantId" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "method"))
...
newDatafeedsCustomBatchResponse 
    ::  DatafeedsCustomBatchResponse
newDatafeedsCustomBatchResponse
  = DatafeedsCustomBatchResponse{entries = Core.Nothing,
                                 kind = Core.Nothing}
instance Core.FromJSON DatafeedsCustomBatchResponse where
        parseJSON
          = Core.withObject "DatafeedsCustomBatchResponse"
              (\ o ->
                 DatafeedsCustomBatchResponse Core.<$>
                   (o Core..:? "entries") Core.<*> (o Core..:? "kind"))
...
newDatafeedsCustomBatchResponseEntry 
    :: 
                                     DatafeedsCustomBatchResponseEntry
newDatafeedsCustomBatchResponseEntry
  = DatafeedsCustomBatchResponseEntry{batchId = Core.Nothing,
                                      datafeed = Core.Nothing, errors = Core.Nothing}
instance Core.FromJSON DatafeedsCustomBatchResponseEntry where
        parseJSON
          = Core.withObject "DatafeedsCustomBatchResponseEntry"
              (\ o ->
                 DatafeedsCustomBatchResponseEntry Core.<$>
                   (o Core..:? "batchId") Core.<*> (o Core..:? "datafeed") Core.<*>
                     (o Core..:? "errors"))
...
instance Core.FromJSON DatafeedsFetchNowResponse where
        parseJSON
          = Core.withObject "DatafeedsFetchNowResponse"
...
newDatafeedsListResponse 
    ::  DatafeedsListResponse
newDatafeedsListResponse
  = DatafeedsListResponse{kind = Core.Nothing,
                          nextPageToken = Core.Nothing, resources = Core.Nothing}
instance Core.FromJSON DatafeedsListResponse where
        parseJSON
          = Core.withObject "DatafeedsListResponse"
              (\ o ->
                 DatafeedsListResponse Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "resources"))
...
instance Core.FromJSON DatafeedstatusesCustomBatchRequest where
        parseJSON
          = Core.withObject "DatafeedstatusesCustomBatchRequest"
              (\ o ->
...
newDatafeedstatusesCustomBatchRequestEntry 
    :: 
                                           DatafeedstatusesCustomBatchRequestEntry
newDatafeedstatusesCustomBatchRequestEntry
  = DatafeedstatusesCustomBatchRequestEntry{batchId = Core.Nothing,
                                            country = Core.Nothing, datafeedId = Core.Nothing,
                                            feedLabel = Core.Nothing, language = Core.Nothing,
                                            merchantId = Core.Nothing, method = Core.Nothing}
instance Core.FromJSON DatafeedstatusesCustomBatchRequestEntry
         where
        parseJSON
          = Core.withObject "DatafeedstatusesCustomBatchRequestEntry"
              (\ o ->
                 DatafeedstatusesCustomBatchRequestEntry Core.<$>
                   (o Core..:? "batchId") Core.<*> (o Core..:? "country") Core.<*>
                     (o Core..:? "datafeedId" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "feedLabel")
                     Core.<*> (o Core..:? "language")
                     Core.<*>
...
newDatafeedstatusesCustomBatchResponse 
    :: 
                                       DatafeedstatusesCustomBatchResponse
newDatafeedstatusesCustomBatchResponse
  = DatafeedstatusesCustomBatchResponse{entries = Core.Nothing,
                                        kind = Core.Nothing}
instance Core.FromJSON DatafeedstatusesCustomBatchResponse where
        parseJSON
          = Core.withObject "DatafeedstatusesCustomBatchResponse"
              (\ o ->
                 DatafeedstatusesCustomBatchResponse Core.<$>
                   (o Core..:? "entries") Core.<*> (o Core..:? "kind"))
...
newDatafeedstatusesCustomBatchResponseEntry 
    :: 
                                            DatafeedstatusesCustomBatchResponseEntry
newDatafeedstatusesCustomBatchResponseEntry
  = DatafeedstatusesCustomBatchResponseEntry{batchId = Core.Nothing,
                                             datafeedStatus = Core.Nothing, errors = Core.Nothing}
instance Core.FromJSON DatafeedstatusesCustomBatchResponseEntry
         where
        parseJSON
          = Core.withObject "DatafeedstatusesCustomBatchResponseEntry"
              (\ o ->
                 DatafeedstatusesCustomBatchResponseEntry Core.<$>
                   (o Core..:? "batchId") Core.<*> (o Core..:? "datafeedStatus")
                     Core.<*> (o Core..:? "errors"))
...
newDatafeedstatusesListResponse 
    ::  DatafeedstatusesListResponse
newDatafeedstatusesListResponse
  = DatafeedstatusesListResponse{kind = Core.Nothing,
                                 nextPageToken = Core.Nothing, resources = Core.Nothing}
instance Core.FromJSON DatafeedstatusesListResponse where
        parseJSON
          = Core.withObject "DatafeedstatusesListResponse"
              (\ o ->
                 DatafeedstatusesListResponse Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "resources"))
...
newDateTime 
    ::  DateTime'
newDateTime
  = DateTime'{day = Core.Nothing, hours = Core.Nothing,
              minutes = Core.Nothing, month = Core.Nothing, nanos = Core.Nothing,
              seconds = Core.Nothing, timeZone = Core.Nothing,
              utcOffset = Core.Nothing, year = Core.Nothing}
instance Core.FromJSON DateTime' where
        parseJSON
          = Core.withObject "DateTime'"
              (\ o ->
                 DateTime' Core.<$>
                   (o Core..:? "day") Core.<*> (o Core..:? "hours") Core.<*>
                     (o Core..:? "minutes")
                     Core.<*> (o Core..:? "month")
                     Core.<*> (o Core..:? "nanos")
                     Core.<*> (o Core..:? "seconds")
...
instance Core.ToJSON DateTime' where
        toJSON DateTime'{..}
          = Core.object
              (Core.catMaybes
                 [("day" Core..=) Core.<$> day, ("hours" Core..=) Core.<$> hours,
                  ("minutes" Core..=) Core.<$> minutes,
                  ("month" Core..=) Core.<$> month, ("nanos" Core..=) Core.<$> nanos,
...
newDeliveryArea 
    ::  DeliveryArea
newDeliveryArea
  = DeliveryArea{countryCode = Core.Nothing,
                 postalCodeRange = Core.Nothing, regionCode = Core.Nothing}
instance Core.FromJSON DeliveryArea where
        parseJSON
          = Core.withObject "DeliveryArea"
              (\ o ->
                 DeliveryArea Core.<$>
                   (o Core..:? "countryCode") Core.<*> (o Core..:? "postalCodeRange")
...
newDeliveryAreaPostalCodeRange 
    ::  DeliveryAreaPostalCodeRange
newDeliveryAreaPostalCodeRange
  = DeliveryAreaPostalCodeRange{firstPostalCode = Core.Nothing,
                                lastPostalCode = Core.Nothing}
instance Core.FromJSON DeliveryAreaPostalCodeRange where
        parseJSON
          = Core.withObject "DeliveryAreaPostalCodeRange"
              (\ o ->
                 DeliveryAreaPostalCodeRange Core.<$>
                   (o Core..:? "firstPostalCode") Core.<*>
                     (o Core..:? "lastPostalCode"))
...
newDeliveryTime 
    ::  DeliveryTime
newDeliveryTime
  = DeliveryTime{cutoffTime = Core.Nothing,
...
instance Core.FromJSON DeliveryTime where
        parseJSON
          = Core.withObject "DeliveryTime"
              (\ o ->
                 DeliveryTime Core.<$>
                   (o Core..:? "cutoffTime") Core.<*>
                     (o Core..:? "handlingBusinessDayConfig")
          ...
          = Core.object
              (Core.catMaybes
                 [("cutoffTime" Core..=) Core.<$> cutoffTime,
                  ("handlingBusinessDayConfig" Core..=) Core.<$>
                  ...
                  ("transitBusinessDayConfig" Core..=) Core.<$>
                    transitBusinessDayConfig,
                  ("transitTimeTable" Core..=) Core.<$> transitTimeTable,
                  ("warehouseBasedDeliveryTimes" Core..=) Core.<$>
...
instance Core.FromJSON ECommercePlatformLinkInfo where
        parseJSON
          = Core.withObject "ECommercePlatformLinkInfo"
              (\ o ->
                 ECommercePlatformLinkInfo Core.<$>
                   (o Core..:? "externalAccountId"))
...
newError 
    ::  Error'
newError
  = Error'{domain = Core.Nothing, message = Core.Nothing,
           reason = Core.Nothing}
instance Core.FromJSON Error' where
        parseJSON
          = Core.withObject "Error'"
              (\ o ->
                 Error' Core.<$>
                   (o Core..:? "domain") Core.<*> (o Core..:? "message") Core.<*>
                     (o Core..:? "reason"))
...
newErrors 
    ::  Errors
newErrors
  = Errors{code = Core.Nothing, errors = Core.Nothing,
           message = Core.Nothing}
instance Core.FromJSON Errors where
        parseJSON
          = Core.withObject "Errors"
              (\ o ->
                 Errors Core.<$>
                   (o Core..:? "code") Core.<*> (o Core..:? "errors") Core.<*>
                     (o Core..:? "message"))
...
instance Core.FromJSON ExternalAction where
        parseJSON
          = Core.withObject "ExternalAction"
              (\ o ->
                 ExternalAction Core.<$>
                   (o Core..:? "type") Core.<*> (o Core..:? "uri"))
...
newFreeListingsProgramStatus 
    ::  FreeListingsProgramStatus
newFreeListingsProgramStatus
  = FreeListingsProgramStatus{globalState = Core.Nothing,
                              regionStatuses = Core.Nothing}
instance Core.FromJSON FreeListingsProgramStatus where
        parseJSON
          = Core.withObject "FreeListingsProgramStatus"
              (\ o ->
                 FreeListingsProgramStatus Core.<$>
                   (o Core..:? "globalState") Core.<*> (o Core..:? "regionStatuses"))
...
data FreeListingsProgramStatusRegionStatus = FreeListingsProgramStatusRegionStatus
   ...
   FreeListingsProgramStatusRegionStatus_EligibilityStatus)
    ...
    , reviewEligibilityStatus :: (Core.Maybe
   FreeListingsProgramStatusRegionStatus_ReviewEligibilityStatus)
    ...
    , reviewIneligibilityReason :: (Core.Maybe
   FreeListingsProgramStatusRegionStatus_ReviewIneligibilityReason)
    ...
    , reviewIneligibilityReasonDetails :: (Core.Maybe
   FreeListingsProgramStatusReviewIneligibilityReasonDetails)
...
newFreeListingsProgramStatusRegionStatus 
    :: 
                                         FreeListingsProgramStatusRegionStatus
newFreeListingsProgramStatusRegionStatus
  = FreeListingsProgramStatusRegionStatus{disapprovalDate =
                                            Core.Nothing,
...
instance Core.FromJSON FreeListingsProgramStatusRegionStatus where
        parseJSON
          = Core.withObject "FreeListingsProgramStatusRegionStatus"
              (\ o ->
                 FreeListingsProgramStatusRegionStatus Core.<$>
                   (o Core..:? "disapprovalDate") Core.<*>
                     (o Core..:? "eligibilityStatus")
          ...
          = Core.object
              (Core.catMaybes
                 [("disapprovalDate" Core..=) Core.<$> disapprovalDate,
                  ...
                  ("reviewEligibilityStatus" Core..=) Core.<$>
                    reviewEligibilityStatus,
                  ("reviewIneligibilityReason" Core..=) Core.<$>
                    reviewIneligibilityReason,
                  ("reviewIneligibilityReasonDescription" Core..=) Core.<$>
                    reviewIneligibilityReasonDescription,
                  ("reviewIneligibilityReasonDetails" Core..=) Core.<$>
...
newFreeListingsProgramStatusReviewIneligibilityReasonDetails 
    :: 
                                                             FreeListingsProgramStatusReviewIneligibilityReasonDetails
newFreeListingsProgramStatusReviewIneligibilityReasonDetails
  = FreeListingsProgramStatusReviewIneligibilityReasonDetails{cooldownTime
                                                                = Core.Nothing}
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "FreeListingsProgramStatusReviewIneligibilityReasonDetails"
              (\ o ->
                 FreeListingsProgramStatusReviewIneligibilityReasonDetails Core.<$>
                   (o Core..:? "cooldownTime"))
...
newFreeShippingThreshold 
    ::  FreeShippingThreshold
newFreeShippingThreshold
  = FreeShippingThreshold{country = Core.Nothing,
                          priceThreshold = Core.Nothing}
instance Core.FromJSON FreeShippingThreshold where
        parseJSON
          = Core.withObject "FreeShippingThreshold"
              (\ o ->
                 FreeShippingThreshold Core.<$>
                   (o Core..:? "country") Core.<*> (o Core..:? "priceThreshold"))
...
newGenerateRecommendationsResponse 
    :: 
                                   GenerateRecommendationsResponse
newGenerateRecommendationsResponse
  = GenerateRecommendationsResponse{recommendations = Core.Nothing,
                                    responseToken = Core.Nothing}
instance Core.FromJSON GenerateRecommendationsResponse where
        parseJSON
          = Core.withObject "GenerateRecommendationsResponse"
              (\ o ->
                 GenerateRecommendationsResponse Core.<$>
                   (o Core..:? "recommendations") Core.<*>
                     (o Core..:? "responseToken"))
...
newGmbAccountsGmbAccount 
    ::  GmbAccountsGmbAccount
newGmbAccountsGmbAccount
  = GmbAccountsGmbAccount{email = Core.Nothing,
                          listingCount = Core.Nothing, name = Core.Nothing,
                          type' = Core.Nothing}
instance Core.FromJSON GmbAccountsGmbAccount where
        parseJSON
          = Core.withObject "GmbAccountsGmbAccount"
              (\ o ->
                 GmbAccountsGmbAccount Core.<$>
                   (o Core..:? "email") Core.<*>
                     (o Core..:? "listingCount" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "type"))
...
newGoogleAnalyticsLink 
    ::  GoogleAnalyticsLink
newGoogleAnalyticsLink
  = GoogleAnalyticsLink{attributionSettings = Core.Nothing,
                        propertyId = Core.Nothing, propertyName = Core.Nothing}
instance Core.FromJSON GoogleAnalyticsLink where
        parseJSON
          = Core.withObject "GoogleAnalyticsLink"
              (\ o ->
                 GoogleAnalyticsLink Core.<$>
                   (o Core..:? "attributionSettings") Core.<*>
                     (o Core..:? "propertyId" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "propertyName"))
...
newHeaders 
    ::  Headers
newHeaders
  = Headers{locations = Core.Nothing, numberOfItems = Core.Nothing,
            postalCodeGroupNames = Core.Nothing, prices = Core.Nothing,
            weights = Core.Nothing}
instance Core.FromJSON Headers where
        parseJSON
          = Core.withObject "Headers"
              (\ o ->
                 Headers Core.<$>
                   (o Core..:? "locations") Core.<*> (o Core..:? "numberOfItems")
...
newHolidayCutoff 
    ::  HolidayCutoff
newHolidayCutoff
  = HolidayCutoff{deadlineDate = Core.Nothing,
                  deadlineHour = Core.Nothing, deadlineTimezone = Core.Nothing,
                  holidayId = Core.Nothing, visibleFromDate = Core.Nothing}
instance Core.FromJSON HolidayCutoff where
        parseJSON
          = Core.withObject "HolidayCutoff"
              (\ o ->
                 HolidayCutoff Core.<$>
                   (o Core..:? "deadlineDate") Core.<*> (o Core..:? "deadlineHour")
...
newHolidaysHoliday 
    ::  HolidaysHoliday
newHolidaysHoliday
  = HolidaysHoliday{countryCode = Core.Nothing, date = Core.Nothing,
                    deliveryGuaranteeDate = Core.Nothing,
                    deliveryGuaranteeHour = Core.Nothing, id = Core.Nothing,
                    type' = Core.Nothing}
instance Core.FromJSON HolidaysHoliday where
        parseJSON
          = Core.withObject "HolidaysHoliday"
              (\ o ->
                 HolidaysHoliday Core.<$>
                   (o Core..:? "countryCode") Core.<*> (o Core..:? "date") Core.<*>
                     (o Core..:? "deliveryGuaranteeDate")
                     Core.<*>
                     (o Core..:? "deliveryGuaranteeHour" Core.<&>
          ...
          = Core.object
              (Core.catMaybes
                 [("countryCode" Core..=) Core.<$> countryCode,
                  ...
                  ("deliveryGuaranteeHour" Core..=) Core.. Core.AsText Core.<$>
...
newInputField 
    ::  InputField
newInputField
  = InputField{checkboxInput = Core.Nothing,
               choiceInput = Core.Nothing, id = Core.Nothing,
               label = Core.Nothing, required = Core.Nothing,
               textInput = Core.Nothing}
instance Core.FromJSON InputField where
        parseJSON
          = Core.withObject "InputField"
              (\ o ->
                 InputField Core.<$>
                   (o Core..:? "checkboxInput") Core.<*> (o Core..:? "choiceInput")
                     Core.<*> (o Core..:? "id")
                     Core.<*> (o Core..:? "label")
          ...
          = Core.object
              (Core.catMaybes
                 [("checkboxInput" Core..=) Core.<$> checkboxInput,
                  ...
                  ("id" Core..=) Core.<$> id, ("label" Core..=) Core.<$> label,
...
instance Core.FromJSON InputFieldCheckboxInput where
        parseJSON
          = Core.withObject "InputFieldCheckboxInput"
...
instance Core.FromJSON InputFieldChoiceInput where
        parseJSON
          = Core.withObject "InputFieldChoiceInput"
...
newInputFieldChoiceInputChoiceInputOption 
    :: 
                                          InputFieldChoiceInputChoiceInputOption
newInputFieldChoiceInputChoiceInputOption
  = InputFieldChoiceInputChoiceInputOption{additionalInput =
                                             Core.Nothing,
                                           id = Core.Nothing, label = Core.Nothing}
instance Core.FromJSON InputFieldChoiceInputChoiceInputOption where
        parseJSON
          = Core.withObject "InputFieldChoiceInputChoiceInputOption"
              (\ o ->
                 InputFieldChoiceInputChoiceInputOption Core.<$>
                   (o Core..:? "additionalInput") Core.<*> (o Core..:? "id") Core.<*>
                     (o Core..:? "label"))
...
newInputFieldTextInput 
    ::  InputFieldTextInput
newInputFieldTextInput
  = InputFieldTextInput{additionalInfo = Core.Nothing,
                        ariaLabel = Core.Nothing, formatInfo = Core.Nothing,
                        type' = Core.Nothing}
instance Core.FromJSON InputFieldTextInput where
        parseJSON
          = Core.withObject "InputFieldTextInput"
              (\ o ->
                 InputFieldTextInput Core.<$>
                   (o Core..:? "additionalInfo") Core.<*> (o Core..:? "ariaLabel")
...
newInputValue 
    ::  InputValue
newInputValue
  = InputValue{checkboxInputValue = Core.Nothing,
               choiceInputValue = Core.Nothing, inputFieldId = Core.Nothing,
               textInputValue = Core.Nothing}
instance Core.FromJSON InputValue where
        parseJSON
          = Core.withObject "InputValue"
              (\ o ->
                 InputValue Core.<$>
                   (o Core..:? "checkboxInputValue") Core.<*>
                     (o Core..:? "choiceInputValue")
...
instance Core.FromJSON InputValueCheckboxInputValue where
        parseJSON
          = Core.withObject "InputValueCheckboxInputValue"
...
instance Core.FromJSON InputValueChoiceInputValue where
        parseJSON
          = Core.withObject "InputValueChoiceInputValue"
              (\ o ->
                 InputValueChoiceInputValue Core.<$>
                   (o Core..:? "choiceInputOptionId"))
...
instance Core.FromJSON InputValueTextInputValue where
        parseJSON
          = Core.withObject "InputValueTextInputValue"
...
instance Core.FromJSON InsertCheckoutSettingsRequest where
        parseJSON
          = Core.withObject "InsertCheckoutSettingsRequest"
              (\ o ->
...
newInstallment 
    ::  Installment
newInstallment
  = Installment{amount = Core.Nothing, creditType = Core.Nothing,
                downpayment = Core.Nothing, months = Core.Nothing}
instance Core.FromJSON Installment where
        parseJSON
          = Core.withObject "Installment"
              (\ o ->
                 Installment Core.<$>
                   (o Core..:? "amount") Core.<*> (o Core..:? "creditType") Core.<*>
                     (o Core..:? "downpayment")
...
instance Core.FromJSON LiaAboutPageSettings where
        parseJSON
          = Core.withObject "LiaAboutPageSettings"
              (\ o ->
                 LiaAboutPageSettings Core.<$>
                   (o Core..:? "status") Core.<*> (o Core..:? "url"))
...
newLiaCountrySettings 
    ::  LiaCountrySettings
newLiaCountrySettings
  = LiaCountrySettings{about = Core.Nothing, country = Core.Nothing,
                       hostedLocalStorefrontActive = Core.Nothing,
                       inventory = Core.Nothing, omnichannelExperience = Core.Nothing,
                       onDisplayToOrder = Core.Nothing, posDataProvider = Core.Nothing,
                       storePickupActive = Core.Nothing}
instance Core.FromJSON LiaCountrySettings where
        parseJSON
          = Core.withObject "LiaCountrySettings"
              (\ o ->
                 LiaCountrySettings Core.<$>
                   (o Core..:? "about") Core.<*> (o Core..:? "country") Core.<*>
                     (o Core..:? "hostedLocalStorefrontActive")
          ...
          = Core.object
              (Core.catMaybes
                 [("about" Core..=) Core.<$> about,
                  ("country" Core..=) Core.<$> country,
                  ("hostedLocalStorefrontActive" Core..=) Core.<$>
...
newLiaInventorySettings 
    ::  LiaInventorySettings
newLiaInventorySettings
  = LiaInventorySettings{inventoryVerificationContactEmail =
                           Core.Nothing,
...
instance Core.FromJSON LiaInventorySettings where
        parseJSON
          = Core.withObject "LiaInventorySettings"
              (\ o ->
                 LiaInventorySettings Core.<$>
                   (o Core..:? "inventoryVerificationContactEmail") Core.<*>
                     (o Core..:? "inventoryVerificationContactName")
...
instance Core.ToJSON LiaInventorySettings where
        toJSON LiaInventorySettings{..}
          = Core.object
              (Core.catMaybes
                 [("inventoryVerificationContactEmail" Core..=) Core.<$>
                    inventoryVerificationContactEmail,
                  ("inventoryVerificationContactName" Core..=) Core.<$>
                    inventoryVerificationContactName,
                  ("inventoryVerificationContactStatus" Core..=) Core.<$>
...
newLiaOmnichannelExperience 
    ::  LiaOmnichannelExperience
newLiaOmnichannelExperience
  = LiaOmnichannelExperience{country = Core.Nothing,
                             lsfType = Core.Nothing, pickupTypes = Core.Nothing}
instance Core.FromJSON LiaOmnichannelExperience where
        parseJSON
          = Core.withObject "LiaOmnichannelExperience"
              (\ o ->
                 LiaOmnichannelExperience Core.<$>
                   (o Core..:? "country") Core.<*> (o Core..:? "lsfType") Core.<*>
                     (o Core..:? "pickupTypes"))
...
newLiaOnDisplayToOrderSettings 
    ::  LiaOnDisplayToOrderSettings
newLiaOnDisplayToOrderSettings
  = LiaOnDisplayToOrderSettings{shippingCostPolicyUrl = Core.Nothing,
                                status = Core.Nothing}
instance Core.FromJSON LiaOnDisplayToOrderSettings where
        parseJSON
          = Core.withObject "LiaOnDisplayToOrderSettings"
              (\ o ->
                 LiaOnDisplayToOrderSettings Core.<$>
                   (o Core..:? "shippingCostPolicyUrl") Core.<*>
                     (o Core..:? "status"))
...
newLiaPosDataProvider 
    ::  LiaPosDataProvider
newLiaPosDataProvider
  = LiaPosDataProvider{posDataProviderId = Core.Nothing,
                       posExternalAccountId = Core.Nothing}
instance Core.FromJSON LiaPosDataProvider where
        parseJSON
          = Core.withObject "LiaPosDataProvider"
              (\ o ->
                 LiaPosDataProvider Core.<$>
                   (o Core..:? "posDataProviderId" Core.<&> Core.fmap Core.fromAsText)
...
instance Core.ToJSON LiaPosDataProvider where
        toJSON LiaPosDataProvider{..}
          = Core.object
              (Core.catMaybes
                 [("posDataProviderId" Core..=) Core.. Core.AsText Core.<$>
                    posDataProviderId,
...
newLiaSettings 
    ::  LiaSettings
newLiaSettings
  = LiaSettings{accountId = Core.Nothing,
                countrySettings = Core.Nothing, kind = Core.Nothing}
instance Core.FromJSON LiaSettings where
        parseJSON
          = Core.withObject "LiaSettings"
              (\ o ->
                 LiaSettings Core.<$>
                   (o Core..:? "accountId" Core.<&> Core.fmap Core.fromAsText)
...
instance Core.FromJSON LiasettingsCustomBatchRequest where
        parseJSON
          = Core.withObject "LiasettingsCustomBatchRequest"
              (\ o ->
...
newLiasettingsCustomBatchRequestEntry 
    :: 
                                      LiasettingsCustomBatchRequestEntry
newLiasettingsCustomBatchRequestEntry
  = LiasettingsCustomBatchRequestEntry{accountId = Core.Nothing,
                                       batchId = Core.Nothing, contactEmail = Core.Nothing,
                                       contactName = Core.Nothing, country = Core.Nothing,
                                       gmbEmail = Core.Nothing, liaSettings = Core.Nothing,
                                       merchantId = Core.Nothing, method = Core.Nothing,
...
instance Core.FromJSON LiasettingsCustomBatchRequestEntry where
        parseJSON
          = Core.withObject "LiasettingsCustomBatchRequestEntry"
              (\ o ->
                 LiasettingsCustomBatchRequestEntry Core.<$>
                   (o Core..:? "accountId" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "batchId")
...
newLiasettingsCustomBatchResponse 
    ::  LiasettingsCustomBatchResponse
newLiasettingsCustomBatchResponse
  = LiasettingsCustomBatchResponse{entries = Core.Nothing,
                                   kind = Core.Nothing}
instance Core.FromJSON LiasettingsCustomBatchResponse where
        parseJSON
          = Core.withObject "LiasettingsCustomBatchResponse"
              (\ o ->
                 LiasettingsCustomBatchResponse Core.<$>
                   (o Core..:? "entries") Core.<*> (o Core..:? "kind"))
...
newLiasettingsCustomBatchResponseEntry 
    :: 
                                       LiasettingsCustomBatchResponseEntry
newLiasettingsCustomBatchResponseEntry
  = LiasettingsCustomBatchResponseEntry{batchId = Core.Nothing,
                                        errors = Core.Nothing, gmbAccounts = Core.Nothing,
                                        kind = Core.Nothing, liaSettings = Core.Nothing,
                                        omnichannelExperience = Core.Nothing,
                                        posDataProviders = Core.Nothing}
instance Core.FromJSON LiasettingsCustomBatchResponseEntry where
        parseJSON
          = Core.withObject "LiasettingsCustomBatchResponseEntry"
              (\ o ->
                 LiasettingsCustomBatchResponseEntry Core.<$>
                   (o Core..:? "batchId") Core.<*> (o Core..:? "errors") Core.<*>
                     (o Core..:? "gmbAccounts")
                     Core.<*> (o Core..:? "kind")
                     Core.<*> (o Core..:? "liaSettings")
                     Core.<*> (o Core..:? "omnichannelExperience")
...
newLiasettingsGetAccessibleGmbAccountsResponse 
    :: 
                                               LiasettingsGetAccessibleGmbAccountsResponse
newLiasettingsGetAccessibleGmbAccountsResponse
  = LiasettingsGetAccessibleGmbAccountsResponse{accountId =
                                                  Core.Nothing,
                                                gmbAccounts = Core.Nothing, kind = Core.Nothing}
instance Core.FromJSON LiasettingsGetAccessibleGmbAccountsResponse
         where
        parseJSON
          = Core.withObject "LiasettingsGetAccessibleGmbAccountsResponse"
              (\ o ->
                 LiasettingsGetAccessibleGmbAccountsResponse Core.<$>
                   (o Core..:? "accountId" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "gmbAccounts")
                     Core.<*> (o Core..:? "kind"))

instance Core.ToJSON LiasettingsGetAccessibleGmbAccountsResponse
         where
...
newLiasettingsListPosDataProvidersResponse 
    :: 
                                           LiasettingsListPosDataProvidersResponse
newLiasettingsListPosDataProvidersResponse
  = LiasettingsListPosDataProvidersResponse{kind = Core.Nothing,
                                            posDataProviders = Core.Nothing}
instance Core.FromJSON LiasettingsListPosDataProvidersResponse
         where
        parseJSON
          = Core.withObject "LiasettingsListPosDataProvidersResponse"
              (\ o ->
                 LiasettingsListPosDataProvidersResponse Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "posDataProviders"))
...
newLiasettingsListResponse 
    ::  LiasettingsListResponse
newLiasettingsListResponse
  = LiasettingsListResponse{kind = Core.Nothing,
                            nextPageToken = Core.Nothing, resources = Core.Nothing}
instance Core.FromJSON LiasettingsListResponse where
        parseJSON
          = Core.withObject "LiasettingsListResponse"
              (\ o ->
                 LiasettingsListResponse Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "resources"))
...
instance Core.FromJSON LiasettingsRequestGmbAccessResponse where
        parseJSON
          = Core.withObject "LiasettingsRequestGmbAccessResponse"
              (\ o ->
...
newLiasettingsRequestInventoryVerificationResponse 
    :: 
                                                   LiasettingsRequestInventoryVerificationResponse
newLiasettingsRequestInventoryVerificationResponse
  = LiasettingsRequestInventoryVerificationResponse{kind =
                                                      Core.Nothing}
instance Core.FromJSON
           LiasettingsRequestInventoryVerificationResponse
         where
        parseJSON
          = Core.withObject "LiasettingsRequestInventoryVerificationResponse"
              (\ o ->
                 LiasettingsRequestInventoryVerificationResponse Core.<$>
                   (o Core..:? "kind"))
...
newLiasettingsSetInventoryVerificationContactResponse 
    :: 
                                                      LiasettingsSetInventoryVerificationContactResponse
newLiasettingsSetInventoryVerificationContactResponse
  = LiasettingsSetInventoryVerificationContactResponse{kind =
                                                         Core.Nothing}
instance Core.FromJSON
           LiasettingsSetInventoryVerificationContactResponse
         where
        parseJSON
          = Core.withObject
              "LiasettingsSetInventoryVerificationContactResponse"
              (\ o ->
                 LiasettingsSetInventoryVerificationContactResponse Core.<$>
                   (o Core..:? "kind"))
...
instance Core.FromJSON LiasettingsSetPosDataProviderResponse where
        parseJSON
          = Core.withObject "LiasettingsSetPosDataProviderResponse"
              (\ o ->
...
instance Core.FromJSON LinkService where
        parseJSON
          = Core.withObject "LinkService"
              (\ o ->
                 LinkService Core.<$>
                   (o Core..:? "service") Core.<*> (o Core..:? "status"))
...
newLinkedAccount 
    ::  LinkedAccount
newLinkedAccount
  = LinkedAccount{linkedAccountId = Core.Nothing,
                  services = Core.Nothing}
instance Core.FromJSON LinkedAccount where
        parseJSON
          = Core.withObject "LinkedAccount"
              (\ o ->
                 LinkedAccount Core.<$>
                   (o Core..:? "linkedAccountId") Core.<*> (o Core..:? "services"))
...
newListAccountLabelsResponse 
    ::  ListAccountLabelsResponse
newListAccountLabelsResponse
  = ListAccountLabelsResponse{accountLabels = Core.Nothing,
                              nextPageToken = Core.Nothing}
instance Core.FromJSON ListAccountLabelsResponse where
        parseJSON
          = Core.withObject "ListAccountLabelsResponse"
              (\ o ->
                 ListAccountLabelsResponse Core.<$>
                   (o Core..:? "accountLabels") Core.<*> (o Core..:? "nextPageToken"))
...
newListAccountReturnCarrierResponse 
    :: 
                                    ListAccountReturnCarrierResponse
newListAccountReturnCarrierResponse
  = ListAccountReturnCarrierResponse{accountReturnCarriers =
                                       Core.Nothing}
instance Core.FromJSON ListAccountReturnCarrierResponse where
        parseJSON
          = Core.withObject "ListAccountReturnCarrierResponse"
              (\ o ->
                 ListAccountReturnCarrierResponse Core.<$>
                   (o Core..:? "accountReturnCarriers"))
...
newListCollectionStatusesResponse 
    ::  ListCollectionStatusesResponse
newListCollectionStatusesResponse
  = ListCollectionStatusesResponse{nextPageToken = Core.Nothing,
                                   resources = Core.Nothing}
instance Core.FromJSON ListCollectionStatusesResponse where
        parseJSON
          = Core.withObject "ListCollectionStatusesResponse"
              (\ o ->
                 ListCollectionStatusesResponse Core.<$>
...
newListCollectionsResponse 
    ::  ListCollectionsResponse
newListCollectionsResponse
  = ListCollectionsResponse{nextPageToken = Core.Nothing,
                            resources = Core.Nothing}
instance Core.FromJSON ListCollectionsResponse where
        parseJSON
          = Core.withObject "ListCollectionsResponse"
              (\ o ->
...
newListConversionSourcesResponse 
    ::  ListConversionSourcesResponse
newListConversionSourcesResponse
  = ListConversionSourcesResponse{conversionSources = Core.Nothing,
                                  nextPageToken = Core.Nothing}
instance Core.FromJSON ListConversionSourcesResponse where
        parseJSON
          = Core.withObject "ListConversionSourcesResponse"
              (\ o ->
                 ListConversionSourcesResponse Core.<$>
                   (o Core..:? "conversionSources") Core.<*>
                     (o Core..:? "nextPageToken"))
...
newListCssesResponse 
    ::  ListCssesResponse
newListCssesResponse
  = ListCssesResponse{csses = Core.Nothing,
                      nextPageToken = Core.Nothing}
instance Core.FromJSON ListCssesResponse where
        parseJSON
          = Core.withObject "ListCssesResponse"
              (\ o ->
                 ListCssesResponse Core.<$>
                   (o Core..:? "csses") Core.<*> (o Core..:? "nextPageToken"))
...
newListMethodQuotasResponse 
    ::  ListMethodQuotasResponse
newListMethodQuotasResponse
  = ListMethodQuotasResponse{methodQuotas = Core.Nothing,
                             nextPageToken = Core.Nothing}
instance Core.FromJSON ListMethodQuotasResponse where
        parseJSON
          = Core.withObject "ListMethodQuotasResponse"
              (\ o ->
                 ListMethodQuotasResponse Core.<$>
                   (o Core..:? "methodQuotas") Core.<*> (o Core..:? "nextPageToken"))
...
newListPromotionResponse 
    ::  ListPromotionResponse
newListPromotionResponse
  = ListPromotionResponse{nextPageToken = Core.Nothing,
                          promotions = Core.Nothing}
instance Core.FromJSON ListPromotionResponse where
        parseJSON
          = Core.withObject "ListPromotionResponse"
              (\ o ->
                 ListPromotionResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "promotions"))
...
newListRegionsResponse 
    ::  ListRegionsResponse
newListRegionsResponse
  = ListRegionsResponse{nextPageToken = Core.Nothing,
                        regions = Core.Nothing}
instance Core.FromJSON ListRegionsResponse where
        parseJSON
          = Core.withObject "ListRegionsResponse"
              (\ o ->
                 ListRegionsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "regions"))
...
instance Core.FromJSON ListReturnPolicyOnlineResponse where
        parseJSON
          = Core.withObject "ListReturnPolicyOnlineResponse"
              (\ o ->
                 ListReturnPolicyOnlineResponse Core.<$>
                   (o Core..:? "returnPolicies"))
...
newLocalInventory 
    ::  LocalInventory
newLocalInventory
  = LocalInventory{availability = Core.Nothing,
                   customAttributes = Core.Nothing,
                   instoreProductLocation = Core.Nothing, kind = Core.Nothing,
                   pickupMethod = Core.Nothing, pickupSla = Core.Nothing,
                   price = Core.Nothing, quantity = Core.Nothing,
                   salePrice = Core.Nothing, salePriceEffectiveDate = Core.Nothing,
                   storeCode = Core.Nothing}
instance Core.FromJSON LocalInventory where
        parseJSON
          = Core.withObject "LocalInventory"
              (\ o ->
                 LocalInventory Core.<$>
                   (o Core..:? "availability") Core.<*>
                     (o Core..:? "customAttributes")
...
instance Core.FromJSON LocalinventoryCustomBatchRequest where
        parseJSON
          = Core.withObject "LocalinventoryCustomBatchRequest"
              (\ o ->
...
newLocalinventoryCustomBatchRequestEntry 
    :: 
                                         LocalinventoryCustomBatchRequestEntry
newLocalinventoryCustomBatchRequestEntry
  = LocalinventoryCustomBatchRequestEntry{batchId = Core.Nothing,
                                          localInventory = Core.Nothing, merchantId = Core.Nothing,
                                          method = Core.Nothing, productId = Core.Nothing}
instance Core.FromJSON LocalinventoryCustomBatchRequestEntry where
        parseJSON
          = Core.withObject "LocalinventoryCustomBatchRequestEntry"
              (\ o ->
                 LocalinventoryCustomBatchRequestEntry Core.<$>
                   (o Core..:? "batchId") Core.<*> (o Core..:? "localInventory")
                     Core.<*>
                     (o Core..:? "merchantId" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "method")
...
newLocalinventoryCustomBatchResponse 
    :: 
                                     LocalinventoryCustomBatchResponse
newLocalinventoryCustomBatchResponse
  = LocalinventoryCustomBatchResponse{entries = Core.Nothing,
                                      kind = Core.Nothing}
instance Core.FromJSON LocalinventoryCustomBatchResponse where
        parseJSON
          = Core.withObject "LocalinventoryCustomBatchResponse"
              (\ o ->
                 LocalinventoryCustomBatchResponse Core.<$>
                   (o Core..:? "entries") Core.<*> (o Core..:? "kind"))
...
newLocalinventoryCustomBatchResponseEntry 
    :: 
                                          LocalinventoryCustomBatchResponseEntry
newLocalinventoryCustomBatchResponseEntry
  = LocalinventoryCustomBatchResponseEntry{batchId = Core.Nothing,
                                           errors = Core.Nothing, kind = Core.Nothing}
instance Core.FromJSON LocalinventoryCustomBatchResponseEntry where
        parseJSON
          = Core.withObject "LocalinventoryCustomBatchResponseEntry"
              (\ o ->
                 LocalinventoryCustomBatchResponseEntry Core.<$>
                   (o Core..:? "batchId") Core.<*> (o Core..:? "errors") Core.<*>
                     (o Core..:? "kind"))
...
newLoyaltyProgram 
    ::  LoyaltyProgram
newLoyaltyProgram
  = LoyaltyProgram{cashbackForFutureUse = Core.Nothing,
                   loyaltyPoints = Core.Nothing,
                   memberPriceEffectiveDate = Core.Nothing, price = Core.Nothing,
                   programLabel = Core.Nothing, shippingLabel = Core.Nothing,
                   tierLabel = Core.Nothing}
instance Core.FromJSON LoyaltyProgram where
        parseJSON
          = Core.withObject "LoyaltyProgram"
              (\ o ->
                 LoyaltyProgram Core.<$>
                   (o Core..:? "cashbackForFutureUse") Core.<*>
                     (o Core..:? "loyaltyPoints" Core.<&> Core.fmap Core.fromAsText)
          ...
          = Core.object
              (Core.catMaybes
                 [("cashbackForFutureUse" Core..=) Core.<$> cashbackForFutureUse,
                  ("loyaltyPoints" Core..=) Core.. Core.AsText Core.<$>
                    loyaltyPoints,
                  ("memberPriceEffectiveDate" Core..=) Core.<$>
...
newMerchantCenterDestination 
    ::  MerchantCenterDestination
newMerchantCenterDestination
  = MerchantCenterDestination{attributionSettings = Core.Nothing,
                              currencyCode = Core.Nothing, destinationId = Core.Nothing,
                              displayName = Core.Nothing}
instance Core.FromJSON MerchantCenterDestination where
        parseJSON
          = Core.withObject "MerchantCenterDestination"
              (\ o ->
...
newMethodQuota 
    ::  MethodQuota
newMethodQuota
  = MethodQuota{method = Core.Nothing, quotaLimit = Core.Nothing,
                quotaMinuteLimit = Core.Nothing, quotaUsage = Core.Nothing}
instance Core.FromJSON MethodQuota where
        parseJSON
          = Core.withObject "MethodQuota"
              (\ o ->
                 MethodQuota Core.<$>
                   (o Core..:? "method") Core.<*>
                     (o Core..:? "quotaLimit" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "quotaMinuteLimit" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "quotaUsage" Core.<&> Core.fmap Core.fromAsText))
          ...
          = Core.object
              (Core.catMaybes
                 [("method" Core..=) Core.<$> method,
                  ...
                  ("quotaMinuteLimit" Core..=) Core.. Core.AsText Core.<$>
                    quotaMinuteLimit,
...
newMetrics 
    ::  Metrics
newMetrics
  = Metrics{aos = Core.Nothing, aovMicros = Core.Nothing,
            clicks = Core.Nothing, conversionRate = Core.Nothing,
            conversionValueMicros = Core.Nothing, conversions = Core.Nothing,
            ctr = Core.Nothing, daysToShip = Core.Nothing,
            impressions = Core.Nothing, itemDaysToShip = Core.Nothing,
            itemFillRate = Core.Nothing, orderedItemSalesMicros = Core.Nothing,
            orderedItems = Core.Nothing, orders = Core.Nothing,
            rejectedItems = Core.Nothing, returnRate = Core.Nothing,
            returnedItems = Core.Nothing, returnsMicros = Core.Nothing,
            shippedItemSalesMicros = Core.Nothing, shippedItems = Core.Nothing,
            shippedOrders = Core.Nothing, unshippedItems = Core.Nothing,
...
instance Core.FromJSON Metrics where
        parseJSON
          = Core.withObject "Metrics"
              (\ o ->
                 Metrics Core.<$>
                   (o Core..:? "aos") Core.<*> (o Core..:? "aovMicros") Core.<*>
                     (o Core..:? "clicks" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "conversionRate")
                     Core.<*>
                     (o Core..:? "conversionValueMicros" Core.<&>
                        Core.fmap Core.fromAsText)
                     ...
                     Core.<*>
                     (o Core..:? "orderedItemSalesMicros" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "orderedItems" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "orders" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "rejectedItems" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "returnRate")
                     Core.<*>
                     (o Core..:? "returnedItems" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "returnsMicros" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "shippedItemSalesMicros" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "shippedItems" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "shippedOrders" Core.<&> Core.fmap Core.fromAsText)
          ...
          = Core.object
              (Core.catMaybes
                 [("aos" Core..=) Core.<$> aos,
                  ...
                  ("conversionValueMicros" Core..=) Core.. Core.AsText Core.<$>
                  ...
                  ("orderedItemSalesMicros" Core..=) Core.. Core.AsText Core.<$>
                    orderedItemSalesMicros,
                  ("orderedItems" Core..=) Core.. Core.AsText Core.<$> orderedItems,
                  ("orders" Core..=) Core.. Core.AsText Core.<$> orders,
                  ("rejectedItems" Core..=) Core.. Core.AsText Core.<$>
                    rejectedItems,
                  ("returnRate" Core..=) Core.<$> returnRate,
                  ("returnedItems" Core..=) Core.. Core.AsText Core.<$>
                    returnedItems,
                  ("returnsMicros" Core..=) Core.. Core.AsText Core.<$>
                    returnsMicros,
                  ("shippedItemSalesMicros" Core..=) Core.. Core.AsText Core.<$>
                    shippedItemSalesMicros,
                  ("shippedItems" Core..=) Core.. Core.AsText Core.<$> shippedItems,
                  ("shippedOrders" Core..=) Core.. Core.AsText Core.<$>
                    shippedOrders,
...
instance Core.FromJSON MinimumOrderValueTable where
        parseJSON
          = Core.withObject "MinimumOrderValueTable"
              (\ o ->
                 MinimumOrderValueTable Core.<$>
                   (o Core..:? "storeCodeSetWithMovs"))
...
newMinimumOrderValueTableStoreCodeSetWithMov 
    :: 
                                             MinimumOrderValueTableStoreCodeSetWithMov
newMinimumOrderValueTableStoreCodeSetWithMov
  = MinimumOrderValueTableStoreCodeSetWithMov{storeCodes =
                                                Core.Nothing,
                                              value = Core.Nothing}
instance Core.FromJSON MinimumOrderValueTableStoreCodeSetWithMov
         where
        parseJSON
          = Core.withObject "MinimumOrderValueTableStoreCodeSetWithMov"
              (\ o ->
                 MinimumOrderValueTableStoreCodeSetWithMov Core.<$>
                   (o Core..:? "storeCodes") Core.<*> (o Core..:? "value"))

instance Core.ToJSON MinimumOrderValueTableStoreCodeSetWithMov
         where
...
newOrderTrackingSignal 
    ::  OrderTrackingSignal
newOrderTrackingSignal
  = OrderTrackingSignal{customerShippingFee = Core.Nothing,
                        deliveryPostalCode = Core.Nothing,
                        deliveryRegionCode = Core.Nothing, lineItems = Core.Nothing,
                        merchantId = Core.Nothing, orderCreatedTime = Core.Nothing,
                        orderId = Core.Nothing, orderTrackingSignalId = Core.Nothing,
                        shipmentLineItemMapping = Core.Nothing,
                        shippingInfo = Core.Nothing}
instance Core.FromJSON OrderTrackingSignal where
        parseJSON
          = Core.withObject "OrderTrackingSignal"
              (\ o ->
                 OrderTrackingSignal Core.<$>
                   (o Core..:? "customerShippingFee") Core.<*>
                     (o Core..:? "deliveryPostalCode")
                     ...
                     Core.<*> (o Core..:? "orderId")
                     Core.<*>
                     (o Core..:? "orderTrackingSignalId" Core.<&>
                        Core.fmap Core.fromAsText)
          ...
          = Core.object
              (Core.catMaybes
                 [("customerShippingFee" Core..=) Core.<$> customerShippingFee,
                  ...
                  ("orderTrackingSignalId" Core..=) Core.. Core.AsText Core.<$>
                    orderTrackingSignalId,
                  ("shipmentLineItemMapping" Core..=) Core.<$>
...
newOrderTrackingSignalLineItemDetails 
    :: 
                                      OrderTrackingSignalLineItemDetails
newOrderTrackingSignalLineItemDetails
  = OrderTrackingSignalLineItemDetails{brand = Core.Nothing,
                                       gtin = Core.Nothing, lineItemId = Core.Nothing,
                                       mpn = Core.Nothing, productDescription = Core.Nothing,
                                       productId = Core.Nothing, productTitle = Core.Nothing,
                                       quantity = Core.Nothing, sku = Core.Nothing,
                                       upc = Core.Nothing}
instance Core.FromJSON OrderTrackingSignalLineItemDetails where
        parseJSON
          = Core.withObject "OrderTrackingSignalLineItemDetails"
              (\ o ->
                 OrderTrackingSignalLineItemDetails Core.<$>
                   (o Core..:? "brand") Core.<*> (o Core..:? "gtin") Core.<*>
                     (o Core..:? "lineItemId")
                     Core.<*> (o Core..:? "mpn")
...
instance Core.ToJSON OrderTrackingSignalLineItemDetails where
        toJSON OrderTrackingSignalLineItemDetails{..}
          = Core.object
              (Core.catMaybes
                 [("brand" Core..=) Core.<$> brand, ("gtin" Core..=) Core.<$> gtin,
                  ...
                  ("sku" Core..=) Core.<$> sku, ("upc" Core..=) Core.<$> upc])
...
newOrderTrackingSignalShipmentLineItemMapping 
    :: 
                                              OrderTrackingSignalShipmentLineItemMapping
newOrderTrackingSignalShipmentLineItemMapping
  = OrderTrackingSignalShipmentLineItemMapping{lineItemId =
                                                 Core.Nothing,
                                               quantity = Core.Nothing, shipmentId = Core.Nothing}
instance Core.FromJSON OrderTrackingSignalShipmentLineItemMapping
         where
        parseJSON
          = Core.withObject "OrderTrackingSignalShipmentLineItemMapping"
              (\ o ->
                 OrderTrackingSignalShipmentLineItemMapping Core.<$>
                   (o Core..:? "lineItemId") Core.<*>
                     (o Core..:? "quantity" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "shipmentId"))

instance Core.ToJSON OrderTrackingSignalShipmentLineItemMapping
         where
...
newOrderTrackingSignalShippingInfo 
    :: 
                                   OrderTrackingSignalShippingInfo
newOrderTrackingSignalShippingInfo
  = OrderTrackingSignalShippingInfo{actualDeliveryTime =
                                      Core.Nothing,
                                    carrierName = Core.Nothing, carrierServiceName = Core.Nothing,
                                    earliestDeliveryPromiseTime = Core.Nothing,
                                    latestDeliveryPromiseTime = Core.Nothing,
                                    originPostalCode = Core.Nothing,
                                    originRegionCode = Core.Nothing, shipmentId = Core.Nothing,
                                    shippedTime = Core.Nothing, shippingStatus = Core.Nothing,
                                    trackingId = Core.Nothing}
instance Core.FromJSON OrderTrackingSignalShippingInfo where
        parseJSON
          = Core.withObject "OrderTrackingSignalShippingInfo"
              (\ o ->
                 OrderTrackingSignalShippingInfo Core.<$>
                   (o Core..:? "actualDeliveryTime") Core.<*>
                     (o Core..:? "carrierName")
          ...
          = Core.object
              (Core.catMaybes
                 [("actualDeliveryTime" Core..=) Core.<$> actualDeliveryTime,
                  ...
                  ("earliestDeliveryPromiseTime" Core..=) Core.<$>
                    earliestDeliveryPromiseTime,
                  ("latestDeliveryPromiseTime" Core..=) Core.<$>
...
instance Core.FromJSON PaymentServiceProviderLinkInfo where
        parseJSON
          = Core.withObject "PaymentServiceProviderLinkInfo"
              (\ o ->
                 PaymentServiceProviderLinkInfo Core.<$>
                   (o Core..:? "externalAccountBusinessCountry") Core.<*>
                     (o Core..:? "externalAccountId"))
...
instance Core.ToJSON PaymentServiceProviderLinkInfo where
        toJSON PaymentServiceProviderLinkInfo{..}
          = Core.object
              (Core.catMaybes
                 [("externalAccountBusinessCountry" Core..=) Core.<$>
...
newPickupCarrierService 
    ::  PickupCarrierService
newPickupCarrierService
  = PickupCarrierService{carrierName = Core.Nothing,
                         serviceName = Core.Nothing}
instance Core.FromJSON PickupCarrierService where
        parseJSON
          = Core.withObject "PickupCarrierService"
              (\ o ->
                 PickupCarrierService Core.<$>
                   (o Core..:? "carrierName") Core.<*> (o Core..:? "serviceName"))
...
newPickupServicesPickupService 
    ::  PickupServicesPickupService
newPickupServicesPickupService
  = PickupServicesPickupService{carrierName = Core.Nothing,
                                country = Core.Nothing, serviceName = Core.Nothing}
instance Core.FromJSON PickupServicesPickupService where
        parseJSON
          = Core.withObject "PickupServicesPickupService"
              (\ o ->
                 PickupServicesPickupService Core.<$>
                   (o Core..:? "carrierName") Core.<*> (o Core..:? "country") Core.<*>
                     (o Core..:? "serviceName"))
...
instance Core.FromJSON PosCustomBatchRequest where
        parseJSON
          = Core.withObject "PosCustomBatchRequest"
...
newPosCustomBatchRequestEntry 
    ::  PosCustomBatchRequestEntry
newPosCustomBatchRequestEntry
  = PosCustomBatchRequestEntry{batchId = Core.Nothing,
                               inventory = Core.Nothing, merchantId = Core.Nothing,
                               method = Core.Nothing, sale = Core.Nothing, store = Core.Nothing,
                               storeCode = Core.Nothing, targetMerchantId = Core.Nothing}
instance Core.FromJSON PosCustomBatchRequestEntry where
        parseJSON
          = Core.withObject "PosCustomBatchRequestEntry"
              (\ o ->
                 PosCustomBatchRequestEntry Core.<$>
                   (o Core..:? "batchId") Core.<*> (o Core..:? "inventory") Core.<*>
                     (o Core..:? "merchantId" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "method")
                     Core.<*> (o Core..:? "sale")
                     Core.<*> (o Core..:? "store")
                     Core.<*> (o Core..:? "storeCode")
                     Core.<*>
                     (o Core..:? "targetMerchantId" Core.<&> Core.fmap Core.fromAsText))
          ...
          = Core.object
              (Core.catMaybes
                 [("batchId" Core..=) Core.<$> batchId,
                  ("inventory" Core..=) Core.<$> inventory,
                  ("merchantId" Core..=) Core.. Core.AsText Core.<$> merchantId,
                  ("method" Core..=) Core.<$> method, ("sale" Core..=) Core.<$> sale,
                  ("store" Core..=) Core.<$> store,
                  ("storeCode" Core..=) Core.<$> storeCode,
                  ("targetMerchantId" Core..=) Core.. Core.AsText Core.<$>
                    targetMerchantId])
...
newPosCustomBatchResponse 
    ::  PosCustomBatchResponse
newPosCustomBatchResponse
  = PosCustomBatchResponse{entries = Core.Nothing,
                           kind = Core.Nothing}
instance Core.FromJSON PosCustomBatchResponse where
        parseJSON
          = Core.withObject "PosCustomBatchResponse"
              (\ o ->
                 PosCustomBatchResponse Core.<$>
                   (o Core..:? "entries") Core.<*> (o Core..:? "kind"))
...
newPosCustomBatchResponseEntry 
    ::  PosCustomBatchResponseEntry
newPosCustomBatchResponseEntry
  = PosCustomBatchResponseEntry{batchId = Core.Nothing,
                                errors = Core.Nothing, inventory = Core.Nothing,
                                kind = Core.Nothing, sale = Core.Nothing, store = Core.Nothing}
instance Core.FromJSON PosCustomBatchResponseEntry where
        parseJSON
          = Core.withObject "PosCustomBatchResponseEntry"
              (\ o ->
                 PosCustomBatchResponseEntry Core.<$>
                   (o Core..:? "batchId") Core.<*> (o Core..:? "errors") Core.<*>
                     (o Core..:? "inventory")
                     Core.<*> (o Core..:? "kind")
                     Core.<*> (o Core..:? "sale")
          ...
          = Core.object
              (Core.catMaybes
                 [("batchId" Core..=) Core.<$> batchId,
                  ("errors" Core..=) Core.<$> errors,
                  ("inventory" Core..=) Core.<$> inventory,
                  ("kind" Core..=) Core.<$> kind, ("sale" Core..=) Core.<$> sale,
                  ("store" Core..=) Core.<$> store])
...
newPosDataProviders 
    ::  PosDataProviders
newPosDataProviders
  = PosDataProviders{country = Core.Nothing,
                     posDataProviders = Core.Nothing}
instance Core.FromJSON PosDataProviders where
        parseJSON
          = Core.withObject "PosDataProviders"
              (\ o ->
                 PosDataProviders Core.<$>
                   (o Core..:? "country") Core.<*> (o Core..:? "posDataProviders"))
...
newPosDataProvidersPosDataProvider 
    :: 
                                   PosDataProvidersPosDataProvider
newPosDataProvidersPosDataProvider
  = PosDataProvidersPosDataProvider{displayName = Core.Nothing,
                                    fullName = Core.Nothing, providerId = Core.Nothing}
instance Core.FromJSON PosDataProvidersPosDataProvider where
        parseJSON
          = Core.withObject "PosDataProvidersPosDataProvider"
              (\ o ->
                 PosDataProvidersPosDataProvider Core.<$>
                   (o Core..:? "displayName") Core.<*> (o Core..:? "fullName")
                     Core.<*>
                     (o Core..:? "providerId" Core.<&> Core.fmap Core.fromAsText))
...
newPosInventory 
    ::  PosInventory
newPosInventory
  = PosInventory{contentLanguage = Core.Nothing, gtin = Core.Nothing,
                 itemId = Core.Nothing, kind = Core.Nothing,
                 pickupMethod = Core.Nothing, pickupSla = Core.Nothing,
                 price = Core.Nothing, quantity = Core.Nothing,
                 storeCode = Core.Nothing, targetCountry = Core.Nothing,
                 timestamp = Core.Nothing}
instance Core.FromJSON PosInventory where
        parseJSON
          = Core.withObject "PosInventory"
              (\ o ->
                 PosInventory Core.<$>
                   (o Core..:? "contentLanguage") Core.<*> (o Core..:? "gtin")
                     Core.<*> (o Core..:? "itemId")
                     Core.<*> (o Core..:? "kind")
                     Core.<*> (o Core..:? "pickupMethod")
                     Core.<*> (o Core..:? "pickupSla")
          ...
          = Core.object
              (Core.catMaybes
                 [("contentLanguage" Core..=) Core.<$> contentLanguage,
                  ("gtin" Core..=) Core.<$> gtin, ("itemId" Core..=) Core.<$> itemId,
                  ("kind" Core..=) Core.<$> kind,
                  ("pickupMethod" Core..=) Core.<$> pickupMethod,
                  ("pickupSla" Core..=) Core.<$> pickupSla,
                  ("price" Core..=) Core.<$> price,
...
newPosInventoryRequest 
    ::  PosInventoryRequest
newPosInventoryRequest
  = PosInventoryRequest{contentLanguage = Core.Nothing,
                        gtin = Core.Nothing, itemId = Core.Nothing,
                        pickupMethod = Core.Nothing, pickupSla = Core.Nothing,
                        price = Core.Nothing, quantity = Core.Nothing,
                        storeCode = Core.Nothing, targetCountry = Core.Nothing,
                        timestamp = Core.Nothing}
instance Core.FromJSON PosInventoryRequest where
        parseJSON
          = Core.withObject "PosInventoryRequest"
              (\ o ->
                 PosInventoryRequest Core.<$>
                   (o Core..:? "contentLanguage") Core.<*> (o Core..:? "gtin")
                     Core.<*> (o Core..:? "itemId")
                     Core.<*> (o Core..:? "pickupMethod")
                     Core.<*> (o Core..:? "pickupSla")
...
newPosInventoryResponse 
    ::  PosInventoryResponse
newPosInventoryResponse
  = PosInventoryResponse{contentLanguage = Core.Nothing,
                         gtin = Core.Nothing, itemId = Core.Nothing, kind = Core.Nothing,
                         pickupMethod = Core.Nothing, pickupSla = Core.Nothing,
                         price = Core.Nothing, quantity = Core.Nothing,
                         storeCode = Core.Nothing, targetCountry = Core.Nothing,
                         timestamp = Core.Nothing}
instance Core.FromJSON PosInventoryResponse where
        parseJSON
          = Core.withObject "PosInventoryResponse"
              (\ o ->
                 PosInventoryResponse Core.<$>
                   (o Core..:? "contentLanguage") Core.<*> (o Core..:? "gtin")
                     Core.<*> (o Core..:? "itemId")
                     Core.<*> (o Core..:? "kind")
                     Core.<*> (o Core..:? "pickupMethod")
...
instance Core.FromJSON PosListResponse where
        parseJSON
          = Core.withObject "PosListResponse"
              (\ o ->
                 PosListResponse Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "resources"))
...
newPosSale 
    ::  PosSale
newPosSale
  = PosSale{contentLanguage = Core.Nothing, gtin = Core.Nothing,
            itemId = Core.Nothing, kind = Core.Nothing, price = Core.Nothing,
            quantity = Core.Nothing, saleId = Core.Nothing,
            storeCode = Core.Nothing, targetCountry = Core.Nothing,
            timestamp = Core.Nothing}
instance Core.FromJSON PosSale where
        parseJSON
          = Core.withObject "PosSale"
              (\ o ->
                 PosSale Core.<$>
                   (o Core..:? "contentLanguage") Core.<*> (o Core..:? "gtin")
                     Core.<*> (o Core..:? "itemId")
        ...
        toJSON PosSale{..}
          = Core.object
              (Core.catMaybes
                 [("contentLanguage" Core..=) Core.<$> contentLanguage,
                  ("gtin" Core..=) Core.<$> gtin, ("itemId" Core..=) Core.<$> itemId,
                  ("kind" Core..=) Core.<$> kind, ("price" Core..=) Core.<$> price,
                  ("quantity" Core..=) Core.. Core.AsText Core.<$> quantity,
...
newPosSaleRequest 
    ::  PosSaleRequest
newPosSaleRequest
  = PosSaleRequest{contentLanguage = Core.Nothing,
                   gtin = Core.Nothing, itemId = Core.Nothing, price = Core.Nothing,
                   quantity = Core.Nothing, saleId = Core.Nothing,
                   storeCode = Core.Nothing, targetCountry = Core.Nothing,
                   timestamp = Core.Nothing}
instance Core.FromJSON PosSaleRequest where
        parseJSON
          = Core.withObject "PosSaleRequest"
              (\ o ->
                 PosSaleRequest Core.<$>
                   (o Core..:? "contentLanguage") Core.<*> (o Core..:? "gtin")
                     Core.<*> (o Core..:? "itemId")
...
newPosSaleResponse 
    ::  PosSaleResponse
newPosSaleResponse
  = PosSaleResponse{contentLanguage = Core.Nothing,
                    gtin = Core.Nothing, itemId = Core.Nothing, kind = Core.Nothing,
                    price = Core.Nothing, quantity = Core.Nothing,
                    saleId = Core.Nothing, storeCode = Core.Nothing,
                    targetCountry = Core.Nothing, timestamp = Core.Nothing}
instance Core.FromJSON PosSaleResponse where
        parseJSON
          = Core.withObject "PosSaleResponse"
              (\ o ->
                 PosSaleResponse Core.<$>
                   (o Core..:? "contentLanguage") Core.<*> (o Core..:? "gtin")
                     Core.<*> (o Core..:? "itemId")
                     Core.<*> (o Core..:? "kind")
                     Core.<*> (o Core..:? "price")
...
newPosStore 
    ::  PosStore
newPosStore
  = PosStore{gcidCategory = Core.Nothing, kind = Core.Nothing,
             matchingStatus = Core.Nothing, matchingStatusHint = Core.Nothing,
             phoneNumber = Core.Nothing, placeId = Core.Nothing,
             storeAddress = Core.Nothing, storeCode = Core.Nothing,
             storeName = Core.Nothing, websiteUrl = Core.Nothing}
instance Core.FromJSON PosStore where
        parseJSON
          = Core.withObject "PosStore"
              (\ o ->
                 PosStore Core.<$>
                   (o Core..:? "gcidCategory") Core.<*> (o Core..:? "kind") Core.<*>
                     (o Core..:? "matchingStatus")
...
newPostalCodeGroup 
    ::  PostalCodeGroup
newPostalCodeGroup
  = PostalCodeGroup{country = Core.Nothing, name = Core.Nothing,
                    postalCodeRanges = Core.Nothing}
instance Core.FromJSON PostalCodeGroup where
        parseJSON
          = Core.withObject "PostalCodeGroup"
              (\ o ->
                 PostalCodeGroup Core.<$>
                   (o Core..:? "country") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "postalCodeRanges"))
...
newPostalCodeRange 
    ::  PostalCodeRange
newPostalCodeRange
  = PostalCodeRange{postalCodeRangeBegin = Core.Nothing,
                    postalCodeRangeEnd = Core.Nothing}
instance Core.FromJSON PostalCodeRange where
        parseJSON
          = Core.withObject "PostalCodeRange"
              (\ o ->
                 PostalCodeRange Core.<$>
                   (o Core..:? "postalCodeRangeBegin") Core.<*>
                     (o Core..:? "postalCodeRangeEnd"))
...
instance Core.FromJSON Price where
        parseJSON
          = Core.withObject "Price"
              (\ o ->
                 Price Core.<$>
                   (o Core..:? "currency") Core.<*> (o Core..:? "value"))
...
newPriceCompetitiveness 
    ::  PriceCompetitiveness
newPriceCompetitiveness
  = PriceCompetitiveness{benchmarkPriceCurrencyCode = Core.Nothing,
                         benchmarkPriceMicros = Core.Nothing, countryCode = Core.Nothing}
instance Core.FromJSON PriceCompetitiveness where
        parseJSON
          = Core.withObject "PriceCompetitiveness"
              (\ o ->
                 PriceCompetitiveness Core.<$>
                   (o Core..:? "benchmarkPriceCurrencyCode") Core.<*>
                     (o Core..:? "benchmarkPriceMicros" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "countryCode"))
...
instance Core.ToJSON PriceCompetitiveness where
        toJSON PriceCompetitiveness{..}
          = Core.object
              (Core.catMaybes
                 [("benchmarkPriceCurrencyCode" Core..=) Core.<$>
                    benchmarkPriceCurrencyCode,
                  ("benchmarkPriceMicros" Core..=) Core.. Core.AsText Core.<$>
...
newPriceInsights 
    ::  PriceInsights
newPriceInsights
  = PriceInsights{effectiveness = Core.Nothing,
...
instance Core.FromJSON PriceInsights where
        parseJSON
          = Core.withObject "PriceInsights"
              (\ o ->
                 PriceInsights Core.<$>
                   (o Core..:? "effectiveness") Core.<*>
                     (o Core..:? "predictedClicksChangeFraction")
                     ...
                     Core.<*>
                     (o Core..:? "predictedMonthlyGrossProfitChangeCurrencyCode")
                     Core.<*>
                     (o Core..:? "predictedMonthlyGrossProfitChangeMicros" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "suggestedPriceCurrencyCode")
                     Core.<*>
                     (o Core..:? "suggestedPriceMicros" Core.<&>
                        Core.fmap Core.fromAsText))
...
data Product = Product
    ...
    , maximumRetailPrice :: (Core.Maybe Price)
      -- | The energy efficiency class as defined in EU directive 2010\/30\/EU.
...
newProduct 
    ::  Product
newProduct
  = Product{additionalImageLinks = Core.Nothing,
            additionalSizeType = Core.Nothing, adsGrouping = Core.Nothing,
            adsLabels = Core.Nothing, adsRedirect = Core.Nothing,
            adult = Core.Nothing, ageGroup = Core.Nothing,
            autoPricingMinPrice = Core.Nothing, availability = Core.Nothing,
            availabilityDate = Core.Nothing, brand = Core.Nothing,
            canonicalLink = Core.Nothing, certifications = Core.Nothing,
            channel = Core.Nothing,
            cloudExportAdditionalProperties = Core.Nothing,
            color = Core.Nothing, condition = Core.Nothing,
            contentLanguage = Core.Nothing, costOfGoodsSold = Core.Nothing,
            customAttributes = Core.Nothing, customLabel0 = Core.Nothing,
            customLabel1 = Core.Nothing, customLabel2 = Core.Nothing,
            customLabel3 = Core.Nothing, customLabel4 = Core.Nothing,
            description = Core.Nothing, disclosureDate = Core.Nothing,
            displayAdsId = Core.Nothing, displayAdsLink = Core.Nothing,
            displayAdsSimilarIds = Core.Nothing,
            displayAdsTitle = Core.Nothing, displayAdsValue = Core.Nothing,
            energyEfficiencyClass = Core.Nothing,
            excludedDestinations = Core.Nothing, expirationDate = Core.Nothing,
            externalSellerId = Core.Nothing, feedLabel = Core.Nothing,
            freeShippingThreshold = Core.Nothing, gender = Core.Nothing,
            googleProductCategory = Core.Nothing, gtin = Core.Nothing,
            id = Core.Nothing, identifierExists = Core.Nothing,
            imageLink = Core.Nothing, includedDestinations = Core.Nothing,
            installment = Core.Nothing, isBundle = Core.Nothing,
            itemGroupId = Core.Nothing, kind = Core.Nothing,
            lifestyleImageLinks = Core.Nothing, link = Core.Nothing,
            linkTemplate = Core.Nothing, loyaltyProgram = Core.Nothing,
            loyaltyPrograms = Core.Nothing, material = Core.Nothing,
            maxEnergyEfficiencyClass = Core.Nothing,
            maxHandlingTime = Core.Nothing, maximumRetailPrice = Core.Nothing,
            minEnergyEfficiencyClass = Core.Nothing,
            minHandlingTime = Core.Nothing, mobileLink = Core.Nothing,
            mobileLinkTemplate = Core.Nothing, mpn = Core.Nothing,
            multipack = Core.Nothing, offerId = Core.Nothing,
            pattern' = Core.Nothing, pause = Core.Nothing,
            pickupMethod = Core.Nothing, pickupSla = Core.Nothing,
            price = Core.Nothing, productDetails = Core.Nothing,
            productHeight = Core.Nothing, productHighlights = Core.Nothing,
            productLength = Core.Nothing, productTypes = Core.Nothing,
            productWeight = Core.Nothing, productWidth = Core.Nothing,
            promotionIds = Core.Nothing, salePrice = Core.Nothing,
            salePriceEffectiveDate = Core.Nothing,
            sellOnGoogleQuantity = Core.Nothing, shipping = Core.Nothing,
            shippingHeight = Core.Nothing, shippingLabel = Core.Nothing,
            shippingLength = Core.Nothing, shippingWeight = Core.Nothing,
            shippingWidth = Core.Nothing,
            shoppingAdsExcludedCountries = Core.Nothing,
            sizeSystem = Core.Nothing, sizeType = Core.Nothing,
            sizes = Core.Nothing, source = Core.Nothing,
            structuredDescription = Core.Nothing,
            structuredTitle = Core.Nothing, subscriptionCost = Core.Nothing,
            sustainabilityIncentives = Core.Nothing,
            targetCountry = Core.Nothing, taxCategory = Core.Nothing,
            taxes = Core.Nothing, title = Core.Nothing,
            transitTimeLabel = Core.Nothing,
            unitPricingBaseMeasure = Core.Nothing,
            unitPricingMeasure = Core.Nothing, virtualModelLink = Core.Nothing}
instance Core.FromJSON Product where
        parseJSON
          = Core.withObject "Product"
              (\ o ->
                 Product Core.<$>
                   (o Core..:? "additionalImageLinks") Core.<*>
                     (o Core..:? "additionalSizeType")
                     ...
                     Core.<*>
                     (o Core..:? "maxHandlingTime" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "maximumRetailPrice")
                     Core.<*> (o Core..:? "minEnergyEfficiencyClass")
                     Core.<*>
                     (o Core..:? "minHandlingTime" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "mobileLink")
                     Core.<*> (o Core..:? "mobileLinkTemplate")
                     Core.<*> (o Core..:? "mpn")
                     Core.<*>
                     (o Core..:? "multipack" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "offerId")
                     Core.<*> (o Core..:? "pattern")
                     Core.<*> (o Core..:? "pause")
                     Core.<*> (o Core..:? "pickupMethod")
                     ...
                     Core.<*> (o Core..:? "salePriceEffectiveDate")
                     Core.<*>
                     (o Core..:? "sellOnGoogleQuantity" Core.<&>
                        Core.fmap Core.fromAsText)
          ...
          = Core.object
              (Core.catMaybes
                 [("additionalImageLinks" Core..=) Core.<$> additionalImageLinks,
                  ...
                  ("channel" Core..=) Core.<$> channel,
                  ("cloudExportAdditionalProperties" Core..=) Core.<$>
                    cloudExportAdditionalProperties,
                  ...
                  ("gtin" Core..=) Core.<$> gtin, ("id" Core..=) Core.<$> id,
                  ...
                  ("maxEnergyEfficiencyClass" Core..=) Core.<$>
                    maxEnergyEfficiencyClass,
                  ("maxHandlingTime" Core..=) Core.. Core.AsText Core.<$>
                    maxHandlingTime,
                  ("maximumRetailPrice" Core..=) Core.<$> maximumRetailPrice,
                  ("minEnergyEfficiencyClass" Core..=) Core.<$>
                    minEnergyEfficiencyClass,
                  ("minHandlingTime" Core..=) Core.. Core.AsText Core.<$>
                    minHandlingTime,
                  ("mobileLink" Core..=) Core.<$> mobileLink,
                  ...
                  ("salePrice" Core..=) Core.<$> salePrice,
                  ("salePriceEffectiveDate" Core..=) Core.<$> salePriceEffectiveDate,
                  ("sellOnGoogleQuantity" Core..=) Core.. Core.AsText Core.<$>
                  ...
                  ("shoppingAdsExcludedCountries" Core..=) Core.<$>
                  ...
                  ("sustainabilityIncentives" Core..=) Core.<$>
                    sustainabilityIncentives,
                  ("targetCountry" Core..=) Core.<$> targetCountry,
                  ("taxCategory" Core..=) Core.<$> taxCategory,
                  ("taxes" Core..=) Core.<$> taxes, ("title" Core..=) Core.<$> title,
...
newProductCertification 
    ::  ProductCertification
newProductCertification
  = ProductCertification{certificationAuthority = Core.Nothing,
                         certificationCode = Core.Nothing, certificationName = Core.Nothing,
          ...
          = Core.withObject "ProductCertification"
              (\ o ->
                 ProductCertification Core.<$>
                   (o Core..:? "certificationAuthority") Core.<*>
                     (o Core..:? "certificationCode")
...
instance Core.ToJSON ProductCertification where
        toJSON ProductCertification{..}
          = Core.object
              (Core.catMaybes
                 [("certificationAuthority" Core..=) Core.<$>
...
newProductCluster 
    ::  ProductCluster
newProductCluster
  = ProductCluster{brand = Core.Nothing,
                   brandInventoryStatus = Core.Nothing, categoryL1 = Core.Nothing,
                   categoryL2 = Core.Nothing, categoryL3 = Core.Nothing,
                   categoryL4 = Core.Nothing, categoryL5 = Core.Nothing,
                   inventoryStatus = Core.Nothing, title = Core.Nothing,
                   variantGtins = Core.Nothing}
instance Core.FromJSON ProductCluster where
        parseJSON
          = Core.withObject "ProductCluster"
              (\ o ->
                 ProductCluster Core.<$>
                   (o Core..:? "brand") Core.<*> (o Core..:? "brandInventoryStatus")
...
newProductDeliveryTime 
    ::  ProductDeliveryTime
newProductDeliveryTime
  = ProductDeliveryTime{areaDeliveryTimes = Core.Nothing,
                        productId = Core.Nothing}
instance Core.FromJSON ProductDeliveryTime where
        parseJSON
          = Core.withObject "ProductDeliveryTime"
              (\ o ->
                 ProductDeliveryTime Core.<$>
                   (o Core..:? "areaDeliveryTimes") Core.<*> (o Core..:? "productId"))
...
newProductDeliveryTimeAreaDeliveryTime 
    :: 
                                       ProductDeliveryTimeAreaDeliveryTime
newProductDeliveryTimeAreaDeliveryTime
  = ProductDeliveryTimeAreaDeliveryTime{deliveryArea = Core.Nothing,
                                        deliveryTime = Core.Nothing}
instance Core.FromJSON ProductDeliveryTimeAreaDeliveryTime where
        parseJSON
          = Core.withObject "ProductDeliveryTimeAreaDeliveryTime"
              (\ o ->
                 ProductDeliveryTimeAreaDeliveryTime Core.<$>
                   (o Core..:? "deliveryArea") Core.<*> (o Core..:? "deliveryTime"))
...
newProductDeliveryTimeAreaDeliveryTimeDeliveryTime 
    :: 
                                                   ProductDeliveryTimeAreaDeliveryTimeDeliveryTime
newProductDeliveryTimeAreaDeliveryTimeDeliveryTime
  = ProductDeliveryTimeAreaDeliveryTimeDeliveryTime{maxHandlingTimeDays
                                                      = Core.Nothing,
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "ProductDeliveryTimeAreaDeliveryTimeDeliveryTime"
              (\ o ->
                 ProductDeliveryTimeAreaDeliveryTimeDeliveryTime Core.<$>
                   (o Core..:? "maxHandlingTimeDays") Core.<*>
                     (o Core..:? "maxTransitTimeDays")
...
instance Core.FromJSON ProductDimension where
        parseJSON
          = Core.withObject "ProductDimension"
              (\ o ->
                 ProductDimension Core.<$>
                   (o Core..:? "unit") Core.<*> (o Core..:? "value"))
...
newProductIssue 
    ::  ProductIssue
newProductIssue
  = ProductIssue{actions = Core.Nothing, impact = Core.Nothing,
                 prerenderedContent = Core.Nothing,
                 prerenderedOutOfCourtDisputeSettlement = Core.Nothing,
                 title = Core.Nothing}
instance Core.FromJSON ProductIssue where
        parseJSON
          = Core.withObject "ProductIssue"
              (\ o ->
                 ProductIssue Core.<$>
                   (o Core..:? "actions") Core.<*> (o Core..:? "impact") Core.<*>
                     (o Core..:? "prerenderedContent")
...
newProductIssueImpact 
    ::  ProductIssueImpact
newProductIssueImpact
  = ProductIssueImpact{breakdowns = Core.Nothing,
                       message = Core.Nothing, severity = Core.Nothing}
instance Core.FromJSON ProductIssueImpact where
        parseJSON
          = Core.withObject "ProductIssueImpact"
              (\ o ->
                 ProductIssueImpact Core.<$>
                   (o Core..:? "breakdowns") Core.<*> (o Core..:? "message") Core.<*>
                     (o Core..:? "severity"))
...
newProductProductDetail 
    ::  ProductProductDetail
newProductProductDetail
  = ProductProductDetail{attributeName = Core.Nothing,
                         attributeValue = Core.Nothing, sectionName = Core.Nothing}
instance Core.FromJSON ProductProductDetail where
        parseJSON
          = Core.withObject "ProductProductDetail"
              (\ o ->
                 ProductProductDetail Core.<$>
...
newProductShipping 
    ::  ProductShipping
newProductShipping
  = ProductShipping{country = Core.Nothing,
                    locationGroupName = Core.Nothing, locationId = Core.Nothing,
                    maxHandlingTime = Core.Nothing, maxTransitTime = Core.Nothing,
                    minHandlingTime = Core.Nothing, minTransitTime = Core.Nothing,
                    postalCode = Core.Nothing, price = Core.Nothing,
                    region = Core.Nothing, service = Core.Nothing}
instance Core.FromJSON ProductShipping where
        parseJSON
          = Core.withObject "ProductShipping"
              (\ o ->
                 ProductShipping Core.<$>
                   (o Core..:? "country") Core.<*> (o Core..:? "locationGroupName")
                     Core.<*>
                     (o Core..:? "locationId" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "maxHandlingTime" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "maxTransitTime" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "minHandlingTime" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "minTransitTime" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "postalCode")
                     Core.<*> (o Core..:? "price")
                     Core.<*> (o Core..:? "region")
                     Core.<*> (o Core..:? "service"))
          ...
          = Core.object
              (Core.catMaybes
                 [("country" Core..=) Core.<$> country,
                  ...
                  ("maxHandlingTime" Core..=) Core.. Core.AsText Core.<$>
                    maxHandlingTime,
                  ("maxTransitTime" Core..=) Core.. Core.AsText Core.<$>
                    maxTransitTime,
                  ("minHandlingTime" Core..=) Core.. Core.AsText Core.<$>
                    minHandlingTime,
                  ("minTransitTime" Core..=) Core.. Core.AsText Core.<$>
                    minTransitTime,
                  ("postalCode" Core..=) Core.<$> postalCode,
                  ("price" Core..=) Core.<$> price,
                  ("region" Core..=) Core.<$> region,
...
newProductShippingDimension 
    ::  ProductShippingDimension
newProductShippingDimension
  = ProductShippingDimension{unit = Core.Nothing,
                             value = Core.Nothing}
instance Core.FromJSON ProductShippingDimension where
        parseJSON
          = Core.withObject "ProductShippingDimension"
              (\ o ->
                 ProductShippingDimension Core.<$>
                   (o Core..:? "unit") Core.<*> (o Core..:? "value"))
...
instance Core.FromJSON ProductShippingWeight where
        parseJSON
          = Core.withObject "ProductShippingWeight"
              (\ o ->
                 ProductShippingWeight Core.<$>
                   (o Core..:? "unit") Core.<*> (o Core..:? "value"))
...
newProductStatus 
    ::  ProductStatus
newProductStatus
  = ProductStatus{creationDate = Core.Nothing,
                  destinationStatuses = Core.Nothing,
                  googleExpirationDate = Core.Nothing,
                  itemLevelIssues = Core.Nothing, kind = Core.Nothing,
                  lastUpdateDate = Core.Nothing, link = Core.Nothing,
                  productId = Core.Nothing, title = Core.Nothing}
instance Core.FromJSON ProductStatus where
        parseJSON
          = Core.withObject "ProductStatus"
              (\ o ->
                 ProductStatus Core.<$>
                   (o Core..:? "creationDate") Core.<*>
                     (o Core..:? "destinationStatuses")
...
newProductStatusDestinationStatus 
    ::  ProductStatusDestinationStatus
newProductStatusDestinationStatus
  = ProductStatusDestinationStatus{approvedCountries = Core.Nothing,
                                   destination = Core.Nothing, disapprovedCountries = Core.Nothing,
                                   pendingCountries = Core.Nothing, status = Core.Nothing}
instance Core.FromJSON ProductStatusDestinationStatus where
        parseJSON
          = Core.withObject "ProductStatusDestinationStatus"
              (\ o ->
                 ProductStatusDestinationStatus Core.<$>
                   (o Core..:? "approvedCountries") Core.<*>
                     (o Core..:? "destination")
                     Core.<*> (o Core..:? "disapprovedCountries")
                     Core.<*> (o Core..:? "pendingCountries")
...
newProductStatusItemLevelIssue 
    ::  ProductStatusItemLevelIssue
newProductStatusItemLevelIssue
  = ProductStatusItemLevelIssue{applicableCountries = Core.Nothing,
                                attributeName = Core.Nothing, code = Core.Nothing,
                                description = Core.Nothing, destination = Core.Nothing,
                                detail = Core.Nothing, documentation = Core.Nothing,
                                resolution = Core.Nothing, servability = Core.Nothing}
instance Core.FromJSON ProductStatusItemLevelIssue where
        parseJSON
          = Core.withObject "ProductStatusItemLevelIssue"
              (\ o ->
                 ProductStatusItemLevelIssue Core.<$>
                   (o Core..:? "applicableCountries") Core.<*>
                     (o Core..:? "attributeName")
                     Core.<*> (o Core..:? "code")
                     Core.<*> (o Core..:? "description")
...
newProductStructuredDescription 
    ::  ProductStructuredDescription
newProductStructuredDescription
  = ProductStructuredDescription{content = Core.Nothing,
                                 digitalSourceType = Core.Nothing}
instance Core.FromJSON ProductStructuredDescription where
        parseJSON
          = Core.withObject "ProductStructuredDescription"
              (\ o ->
                 ProductStructuredDescription Core.<$>
                   (o Core..:? "content") Core.<*> (o Core..:? "digitalSourceType"))
...
newProductStructuredTitle 
    ::  ProductStructuredTitle
newProductStructuredTitle
  = ProductStructuredTitle{content = Core.Nothing,
                           digitalSourceType = Core.Nothing}
instance Core.FromJSON ProductStructuredTitle where
        parseJSON
          = Core.withObject "ProductStructuredTitle"
              (\ o ->
                 ProductStructuredTitle Core.<$>
                   (o Core..:? "content") Core.<*> (o Core..:? "digitalSourceType"))
...
newProductSubscriptionCost 
    ::  ProductSubscriptionCost
newProductSubscriptionCost
  = ProductSubscriptionCost{amount = Core.Nothing,
                            period = Core.Nothing, periodLength = Core.Nothing}
instance Core.FromJSON ProductSubscriptionCost where
        parseJSON
          = Core.withObject "ProductSubscriptionCost"
              (\ o ->
                 ProductSubscriptionCost Core.<$>
                   (o Core..:? "amount") Core.<*> (o Core..:? "period") Core.<*>
                     (o Core..:? "periodLength" Core.<&> Core.fmap Core.fromAsText))
...
newProductSustainabilityIncentive 
    ::  ProductSustainabilityIncentive
newProductSustainabilityIncentive
  = ProductSustainabilityIncentive{amount = Core.Nothing,
                                   percentage = Core.Nothing, type' = Core.Nothing}
instance Core.FromJSON ProductSustainabilityIncentive where
        parseJSON
          = Core.withObject "ProductSustainabilityIncentive"
              (\ o ->
                 ProductSustainabilityIncentive Core.<$>
                   (o Core..:? "amount") Core.<*> (o Core..:? "percentage") Core.<*>
                     (o Core..:? "type"))
...
newProductTax 
    ::  ProductTax
newProductTax
  = ProductTax{country = Core.Nothing, locationId = Core.Nothing,
               postalCode = Core.Nothing, rate = Core.Nothing,
               region = Core.Nothing, taxShip = Core.Nothing}
instance Core.FromJSON ProductTax where
        parseJSON
          = Core.withObject "ProductTax"
              (\ o ->
                 ProductTax Core.<$>
                   (o Core..:? "country") Core.<*>
                     (o Core..:? "locationId" Core.<&> Core.fmap Core.fromAsText)
          ...
          = Core.object
              (Core.catMaybes
                 [("country" Core..=) Core.<$> country,
                  ("locationId" Core..=) Core.. Core.AsText Core.<$> locationId,
                  ("postalCode" Core..=) Core.<$> postalCode,
                  ("rate" Core..=) Core.<$> rate, ("region" Core..=) Core.<$> region,
...
newProductUnitPricingBaseMeasure 
    ::  ProductUnitPricingBaseMeasure
newProductUnitPricingBaseMeasure
  = ProductUnitPricingBaseMeasure{unit = Core.Nothing,
                                  value = Core.Nothing}
instance Core.FromJSON ProductUnitPricingBaseMeasure where
        parseJSON
          = Core.withObject "ProductUnitPricingBaseMeasure"
              (\ o ->
                 ProductUnitPricingBaseMeasure Core.<$>
                   (o Core..:? "unit") Core.<*>
                     (o Core..:? "value" Core.<&> Core.fmap Core.fromAsText))
...
newProductUnitPricingMeasure 
    ::  ProductUnitPricingMeasure
newProductUnitPricingMeasure
  = ProductUnitPricingMeasure{unit = Core.Nothing,
                              value = Core.Nothing}
instance Core.FromJSON ProductUnitPricingMeasure where
        parseJSON
          = Core.withObject "ProductUnitPricingMeasure"
              (\ o ->
                 ProductUnitPricingMeasure Core.<$>
                   (o Core..:? "unit") Core.<*> (o Core..:? "value"))
...
newProductView 
    ::  ProductView
newProductView
  = ProductView{aggregatedDestinationStatus = Core.Nothing,
                availability = Core.Nothing, brand = Core.Nothing,
                categoryL1 = Core.Nothing, categoryL2 = Core.Nothing,
                categoryL3 = Core.Nothing, categoryL4 = Core.Nothing,
                categoryL5 = Core.Nothing, channel = Core.Nothing,
                clickPotential = Core.Nothing, clickPotentialRank = Core.Nothing,
                condition = Core.Nothing, creationTime = Core.Nothing,
                currencyCode = Core.Nothing, expirationDate = Core.Nothing,
                gtin = Core.Nothing, id = Core.Nothing, itemGroupId = Core.Nothing,
                itemIssues = Core.Nothing, languageCode = Core.Nothing,
                offerId = Core.Nothing, priceMicros = Core.Nothing,
                productTypeL1 = Core.Nothing, productTypeL2 = Core.Nothing,
                productTypeL3 = Core.Nothing, productTypeL4 = Core.Nothing,
                productTypeL5 = Core.Nothing, shippingLabel = Core.Nothing,
                title = Core.Nothing}
instance Core.FromJSON ProductView where
        parseJSON
          = Core.withObject "ProductView"
              (\ o ->
                 ProductView Core.<$>
                   (o Core..:? "aggregatedDestinationStatus") Core.<*>
                     (o Core..:? "availability")
                     Core.<*> (o Core..:? "brand")
                     Core.<*> (o Core..:? "categoryL1")
                     Core.<*> (o Core..:? "categoryL2")
                     ...
                     Core.<*>
                     (o Core..:? "clickPotentialRank" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "condition")
                     ...
                     Core.<*> (o Core..:? "offerId")
                     Core.<*>
                     (o Core..:? "priceMicros" Core.<&> Core.fmap Core.fromAsText)
...
instance Core.ToJSON ProductView where
        toJSON ProductView{..}
          = Core.object
              (Core.catMaybes
                 [("aggregatedDestinationStatus" Core..=) Core.<$>
                  ...
                  ("clickPotentialRank" Core..=) Core.. Core.AsText Core.<$>
                    clickPotentialRank,
                  ("condition" Core..=) Core.<$> condition,
...
newProductViewItemIssue 
    ::  ProductViewItemIssue
newProductViewItemIssue
  = ProductViewItemIssue{issueType = Core.Nothing,
                         resolution = Core.Nothing, severity = Core.Nothing}
instance Core.FromJSON ProductViewItemIssue where
        parseJSON
          = Core.withObject "ProductViewItemIssue"
              (\ o ->
                 ProductViewItemIssue Core.<$>
                   (o Core..:? "issueType") Core.<*> (o Core..:? "resolution")
                     Core.<*> (o Core..:? "severity"))
...
newProductViewItemIssueIssueSeverityPerDestination 
    :: 
                                                   ProductViewItemIssueIssueSeverityPerDestination
newProductViewItemIssueIssueSeverityPerDestination
  = ProductViewItemIssueIssueSeverityPerDestination{demotedCountries
                                                      = Core.Nothing,
                                                    destination = Core.Nothing,
                                                    disapprovedCountries = Core.Nothing}
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "ProductViewItemIssueIssueSeverityPerDestination"
              (\ o ->
                 ProductViewItemIssueIssueSeverityPerDestination Core.<$>
                   (o Core..:? "demotedCountries") Core.<*> (o Core..:? "destination")
                     Core.<*> (o Core..:? "disapprovedCountries"))
...
newProductViewItemIssueItemIssueSeverity 
    :: 
                                         ProductViewItemIssueItemIssueSeverity
newProductViewItemIssueItemIssueSeverity
  = ProductViewItemIssueItemIssueSeverity{aggregatedSeverity =
                                            Core.Nothing,
                                          severityPerDestination = Core.Nothing}
instance Core.FromJSON ProductViewItemIssueItemIssueSeverity where
        parseJSON
          = Core.withObject "ProductViewItemIssueItemIssueSeverity"
              (\ o ->
                 ProductViewItemIssueItemIssueSeverity Core.<$>
                   (o Core..:? "aggregatedSeverity") Core.<*>
                     (o Core..:? "severityPerDestination"))
          ...
          = Core.object
              (Core.catMaybes
                 [("aggregatedSeverity" Core..=) Core.<$> aggregatedSeverity,
                  ("severityPerDestination" Core..=) Core.<$>
...
newProductViewItemIssueItemIssueType 
    :: 
                                     ProductViewItemIssueItemIssueType
newProductViewItemIssueItemIssueType
  = ProductViewItemIssueItemIssueType{canonicalAttribute =
                                        Core.Nothing,
                                      code = Core.Nothing}
instance Core.FromJSON ProductViewItemIssueItemIssueType where
        parseJSON
          = Core.withObject "ProductViewItemIssueItemIssueType"
              (\ o ->
                 ProductViewItemIssueItemIssueType Core.<$>
                   (o Core..:? "canonicalAttribute") Core.<*> (o Core..:? "code"))
...
instance Core.FromJSON ProductsCustomBatchRequest where
        parseJSON
          = Core.withObject "ProductsCustomBatchRequest"
...
newProductsCustomBatchRequestEntry 
    :: 
                                   ProductsCustomBatchRequestEntry
newProductsCustomBatchRequestEntry
  = ProductsCustomBatchRequestEntry{batchId = Core.Nothing,
                                    feedId = Core.Nothing, merchantId = Core.Nothing,
                                    method = Core.Nothing, product = Core.Nothing,
                                    productId = Core.Nothing, updateMask = Core.Nothing}
instance Core.FromJSON ProductsCustomBatchRequestEntry where
        parseJSON
          = Core.withObject "ProductsCustomBatchRequestEntry"
              (\ o ->
                 ProductsCustomBatchRequestEntry Core.<$>
                   (o Core..:? "batchId") Core.<*>
                     (o Core..:? "feedId" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "merchantId" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "method")
                     Core.<*> (o Core..:? "product")
...
newProductsCustomBatchResponse 
    ::  ProductsCustomBatchResponse
newProductsCustomBatchResponse
  = ProductsCustomBatchResponse{entries = Core.Nothing,
                                kind = Core.Nothing}
instance Core.FromJSON ProductsCustomBatchResponse where
        parseJSON
          = Core.withObject "ProductsCustomBatchResponse"
              (\ o ->
                 ProductsCustomBatchResponse Core.<$>
                   (o Core..:? "entries") Core.<*> (o Core..:? "kind"))
...
newProductsCustomBatchResponseEntry 
    :: 
                                    ProductsCustomBatchResponseEntry
newProductsCustomBatchResponseEntry
  = ProductsCustomBatchResponseEntry{batchId = Core.Nothing,
                                     errors = Core.Nothing, kind = Core.Nothing,
                                     product = Core.Nothing}
instance Core.FromJSON ProductsCustomBatchResponseEntry where
        parseJSON
          = Core.withObject "ProductsCustomBatchResponseEntry"
              (\ o ->
                 ProductsCustomBatchResponseEntry Core.<$>
                   (o Core..:? "batchId") Core.<*> (o Core..:? "errors") Core.<*>
                     (o Core..:? "kind")
                     Core.<*> (o Core..:? "product"))
...
instance Core.ToJSON ProductsCustomBatchResponseEntry where
        toJSON ProductsCustomBatchResponseEntry{..}
          = Core.object
              (Core.catMaybes
                 [("batchId" Core..=) Core.<$> batchId,
                  ("errors" Core..=) Core.<$> errors, ("kind" Core..=) Core.<$> kind,
                  ("product" Core..=) Core.<$> product])
...
newProductsListResponse 
    ::  ProductsListResponse
newProductsListResponse
  = ProductsListResponse{kind = Core.Nothing,
                         nextPageToken = Core.Nothing, resources = Core.Nothing}
...
instance Core.FromJSON ProductstatusesCustomBatchRequest where
        parseJSON
          = Core.withObject "ProductstatusesCustomBatchRequest"
              (\ o ->
...
newProductstatusesCustomBatchRequestEntry 
    :: 
                                          ProductstatusesCustomBatchRequestEntry
newProductstatusesCustomBatchRequestEntry
  = ProductstatusesCustomBatchRequestEntry{batchId = Core.Nothing,
...
instance Core.FromJSON ProductstatusesCustomBatchRequestEntry where
        parseJSON
          = Core.withObject "ProductstatusesCustomBatchRequestEntry"
              (\ o ->
                 ProductstatusesCustomBatchRequestEntry Core.<$>
                   (o Core..:? "batchId") Core.<*> (o Core..:? "destinations")
...
newProductstatusesCustomBatchResponse 
    :: 
                                      ProductstatusesCustomBatchResponse
newProductstatusesCustomBatchResponse
  = ProductstatusesCustomBatchResponse{entries = Core.Nothing,
                                       kind = Core.Nothing}
instance Core.FromJSON ProductstatusesCustomBatchResponse where
        parseJSON
          = Core.withObject "ProductstatusesCustomBatchResponse"
              (\ o ->
                 ProductstatusesCustomBatchResponse Core.<$>
                   (o Core..:? "entries") Core.<*> (o Core..:? "kind"))
...
newProductstatusesCustomBatchResponseEntry 
    :: 
                                           ProductstatusesCustomBatchResponseEntry
newProductstatusesCustomBatchResponseEntry
  = ProductstatusesCustomBatchResponseEntry{batchId = Core.Nothing,
                                            errors = Core.Nothing, kind = Core.Nothing,
                                            productStatus = Core.Nothing}
instance Core.FromJSON ProductstatusesCustomBatchResponseEntry
         where
        parseJSON
          = Core.withObject "ProductstatusesCustomBatchResponseEntry"
              (\ o ->
                 ProductstatusesCustomBatchResponseEntry Core.<$>
                   (o Core..:? "batchId") Core.<*> (o Core..:? "errors") Core.<*>
                     (o Core..:? "kind")
...
newProductstatusesListResponse 
    ::  ProductstatusesListResponse
newProductstatusesListResponse
  = ProductstatusesListResponse{kind = Core.Nothing,
                                nextPageToken = Core.Nothing, resources = Core.Nothing}
instance Core.FromJSON ProductstatusesListResponse where
        parseJSON
          = Core.withObject "ProductstatusesListResponse"
              (\ o ->
                 ProductstatusesListResponse Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "resources"))
...
data Promotion = Promotion
    ...
    , customRedemptionRestriction :: (Core.Maybe Core.Text)
    ...
    , maxDiscountAmount :: (Core.Maybe PriceAmount)
    ...
    , redemptionRestriction :: (Core.Maybe Promotion_RedemptionRestriction)
...
newPromotion 
    ::  Promotion
newPromotion
  = Promotion{brand = Core.Nothing, brandExclusion = Core.Nothing,
              contentLanguage = Core.Nothing, couponValueType = Core.Nothing,
              customRedemptionRestriction = Core.Nothing,
              freeGiftDescription = Core.Nothing, freeGiftItemId = Core.Nothing,
              freeGiftValue = Core.Nothing, genericRedemptionCode = Core.Nothing,
              getThisQuantityDiscounted = Core.Nothing, id = Core.Nothing,
              itemGroupId = Core.Nothing, itemGroupIdExclusion = Core.Nothing,
              itemId = Core.Nothing, itemIdExclusion = Core.Nothing,
              limitQuantity = Core.Nothing, limitValue = Core.Nothing,
              longTitle = Core.Nothing, maxDiscountAmount = Core.Nothing,
              minimumPurchaseAmount = Core.Nothing,
              minimumPurchaseQuantity = Core.Nothing, moneyBudget = Core.Nothing,
              moneyOffAmount = Core.Nothing, offerType = Core.Nothing,
              orderLimit = Core.Nothing, percentOff = Core.Nothing,
              productApplicability = Core.Nothing, productType = Core.Nothing,
              ...
              promotionId = Core.Nothing, promotionStatus = Core.Nothing,
              promotionUrl = Core.Nothing, redemptionChannel = Core.Nothing,
              redemptionRestriction = Core.Nothing,
              shippingServiceNames = Core.Nothing,
              storeApplicability = Core.Nothing, storeCode = Core.Nothing,
              storeCodeExclusion = Core.Nothing, targetCountry = Core.Nothing}
instance Core.FromJSON Promotion where
        parseJSON
          = Core.withObject "Promotion"
              (\ o ->
                 Promotion Core.<$>
                   (o Core..:? "brand") Core.<*> (o Core..:? "brandExclusion")
                     Core.<*> (o Core..:? "contentLanguage")
                     Core.<*> (o Core..:? "couponValueType")
                     Core.<*> (o Core..:? "customRedemptionRestriction")
                     ...
                     Core.<*> (o Core..:? "redemptionRestriction")
          ...
          = Core.object
              (Core.catMaybes
                 [("brand" Core..=) Core.<$> brand,
                  ...
                  ("customRedemptionRestriction" Core..=) Core.<$>
                  ...
                  ("getThisQuantityDiscounted" Core..=) Core.<$>
                  ...
                  ("maxDiscountAmount" Core..=) Core.<$> maxDiscountAmount,
                  ("minimumPurchaseAmount" Core..=) Core.<$> minimumPurchaseAmount,
                  ("minimumPurchaseQuantity" Core..=) Core.<$>
                  ...
                  ("promotionDestinationIds" Core..=) Core.<$>
                    promotionDestinationIds,
                  ("promotionDisplayDates" Core..=) Core.<$> promotionDisplayDates,
                  ("promotionDisplayTimePeriod" Core..=) Core.<$>
                    promotionDisplayTimePeriod,
                  ("promotionEffectiveDates" Core..=) Core.<$>
                    promotionEffectiveDates,
                  ("promotionEffectiveTimePeriod" Core..=) Core.<$>
                  ...
                  ("redemptionRestriction" Core..=) Core.<$> redemptionRestriction,
...
newPromotionPromotionStatus 
    ::  PromotionPromotionStatus
newPromotionPromotionStatus
  = PromotionPromotionStatus{creationDate = Core.Nothing,
                             destinationStatuses = Core.Nothing, lastUpdateDate = Core.Nothing,
                             promotionIssue = Core.Nothing}
instance Core.FromJSON PromotionPromotionStatus where
        parseJSON
          = Core.withObject "PromotionPromotionStatus"
              (\ o ->
                 PromotionPromotionStatus Core.<$>
                   (o Core..:? "creationDate") Core.<*>
                     (o Core..:? "destinationStatuses")
                     Core.<*> (o Core..:? "lastUpdateDate")
...
newPromotionPromotionStatusDestinationStatus 
    :: 
                                             PromotionPromotionStatusDestinationStatus
newPromotionPromotionStatusDestinationStatus
  = PromotionPromotionStatusDestinationStatus{destination =
                                                Core.Nothing,
                                              status = Core.Nothing}
instance Core.FromJSON PromotionPromotionStatusDestinationStatus
         where
        parseJSON
          = Core.withObject "PromotionPromotionStatusDestinationStatus"
              (\ o ->
                 PromotionPromotionStatusDestinationStatus Core.<$>
                   (o Core..:? "destination") Core.<*> (o Core..:? "status"))

instance Core.ToJSON PromotionPromotionStatusDestinationStatus
         where
...
newPromotionPromotionStatusPromotionIssue 
    :: 
                                          PromotionPromotionStatusPromotionIssue
newPromotionPromotionStatusPromotionIssue
  = PromotionPromotionStatusPromotionIssue{code = Core.Nothing,
                                           detail = Core.Nothing}
instance Core.FromJSON PromotionPromotionStatusPromotionIssue where
        parseJSON
          = Core.withObject "PromotionPromotionStatusPromotionIssue"
              (\ o ->
                 PromotionPromotionStatusPromotionIssue Core.<$>
                   (o Core..:? "code") Core.<*> (o Core..:? "detail"))
...
newPubsubNotificationSettings 
    ::  PubsubNotificationSettings
newPubsubNotificationSettings
  = PubsubNotificationSettings{cloudTopicName = Core.Nothing,
                               kind = Core.Nothing, registeredEvents = Core.Nothing}
instance Core.FromJSON PubsubNotificationSettings where
        parseJSON
          = Core.withObject "PubsubNotificationSettings"
              (\ o ->
                 PubsubNotificationSettings Core.<$>
                   (o Core..:? "cloudTopicName") Core.<*> (o Core..:? "kind") Core.<*>
                     (o Core..:? "registeredEvents"))
...
newRateGroup 
    ::  RateGroup
newRateGroup
  = RateGroup{applicableShippingLabels = Core.Nothing,
              carrierRates = Core.Nothing, mainTable = Core.Nothing,
              name = Core.Nothing, singleValue = Core.Nothing,
              subtables = Core.Nothing}
instance Core.FromJSON RateGroup where
        parseJSON
          = Core.withObject "RateGroup"
              (\ o ->
                 RateGroup Core.<$>
                   (o Core..:? "applicableShippingLabels") Core.<*>
                     (o Core..:? "carrierRates")
...
instance Core.ToJSON RateGroup where
        toJSON RateGroup{..}
          = Core.object
              (Core.catMaybes
                 [("applicableShippingLabels" Core..=) Core.<$>
...
newRecommendation 
    ::  Recommendation
newRecommendation
  = Recommendation{additionalCallToAction = Core.Nothing,
                   additionalDescriptions = Core.Nothing, creative = Core.Nothing,
                   defaultCallToAction = Core.Nothing,
                   defaultDescription = Core.Nothing, numericalImpact = Core.Nothing,
                   paid = Core.Nothing, recommendationName = Core.Nothing,
                   subType = Core.Nothing, title = Core.Nothing, type' = Core.Nothing}
instance Core.FromJSON Recommendation where
        parseJSON
          = Core.withObject "Recommendation"
              (\ o ->
                 Recommendation Core.<$>
                   (o Core..:? "additionalCallToAction") Core.<*>
                     (o Core..:? "additionalDescriptions")
...
instance Core.ToJSON Recommendation where
        toJSON Recommendation{..}
          = Core.object
              (Core.catMaybes
                 [("additionalCallToAction" Core..=) Core.<$>
...
newRecommendationCallToAction 
    ::  RecommendationCallToAction
newRecommendationCallToAction
  = RecommendationCallToAction{intent = Core.Nothing,
                               localizedText = Core.Nothing, uri = Core.Nothing}
instance Core.FromJSON RecommendationCallToAction where
        parseJSON
          = Core.withObject "RecommendationCallToAction"
              (\ o ->
                 RecommendationCallToAction Core.<$>
                   (o Core..:? "intent") Core.<*> (o Core..:? "localizedText")
                     Core.<*> (o Core..:? "uri"))
...
instance Core.FromJSON RecommendationCreative where
        parseJSON
          = Core.withObject "RecommendationCreative"
              (\ o ->
                 RecommendationCreative Core.<$>
                   (o Core..:? "type") Core.<*> (o Core..:? "uri"))
...
newRecommendationDescription 
    ::  RecommendationDescription
newRecommendationDescription
  = RecommendationDescription{text = Core.Nothing,
                              type' = Core.Nothing}
instance Core.FromJSON RecommendationDescription where
        parseJSON
          = Core.withObject "RecommendationDescription"
              (\ o ->
                 RecommendationDescription Core.<$>
                   (o Core..:? "text") Core.<*> (o Core..:? "type"))
...
newRegion 
    ::  Region
newRegion
  = Region{displayName = Core.Nothing, geotargetArea = Core.Nothing,
           merchantId = Core.Nothing, postalCodeArea = Core.Nothing,
           regionId = Core.Nothing, regionalInventoryEligible = Core.Nothing,
...
instance Core.FromJSON Region where
        parseJSON
          = Core.withObject "Region"
              (\ o ->
                 Region Core.<$>
                   (o Core..:? "displayName") Core.<*> (o Core..:? "geotargetArea")
                     Core.<*>
                     (o Core..:? "merchantId" Core.<&> Core.fmap Core.fromAsText)
          ...
          = Core.object
              (Core.catMaybes
                 [("displayName" Core..=) Core.<$> displayName,
                  ...
                  ("regionalInventoryEligible" Core..=) Core.<$>
...
instance Core.FromJSON RegionGeoTargetArea where
        parseJSON
          = Core.withObject "RegionGeoTargetArea"
              (\ o ->
                 RegionGeoTargetArea Core.<$>
                   (o Core..:? "geotargetCriteriaIds" Core.<&>
                      Core.fmap (Core.fmap Core.fromAsText)))
...
instance Core.ToJSON RegionGeoTargetArea where
        toJSON RegionGeoTargetArea{..}
          = Core.object
              (Core.catMaybes
                 [("geotargetCriteriaIds" Core..=) Core.. Core.fmap Core.AsText
...
newRegionPostalCodeArea 
    ::  RegionPostalCodeArea
newRegionPostalCodeArea
  = RegionPostalCodeArea{postalCodes = Core.Nothing,
                         regionCode = Core.Nothing}
instance Core.FromJSON RegionPostalCodeArea where
        parseJSON
          = Core.withObject "RegionPostalCodeArea"
              (\ o ->
                 RegionPostalCodeArea Core.<$>
                   (o Core..:? "postalCodes") Core.<*> (o Core..:? "regionCode"))
...
newRegionPostalCodeAreaPostalCodeRange 
    :: 
                                       RegionPostalCodeAreaPostalCodeRange
newRegionPostalCodeAreaPostalCodeRange
  = RegionPostalCodeAreaPostalCodeRange{begin = Core.Nothing,
                                        end = Core.Nothing}
instance Core.FromJSON RegionPostalCodeAreaPostalCodeRange where
        parseJSON
          = Core.withObject "RegionPostalCodeAreaPostalCodeRange"
              (\ o ->
                 RegionPostalCodeAreaPostalCodeRange Core.<$>
                   (o Core..:? "begin") Core.<*> (o Core..:? "end"))
...
newRegionalInventory 
    ::  RegionalInventory
newRegionalInventory
  = RegionalInventory{availability = Core.Nothing,
                      customAttributes = Core.Nothing, kind = Core.Nothing,
                      price = Core.Nothing, regionId = Core.Nothing,
                      salePrice = Core.Nothing, salePriceEffectiveDate = Core.Nothing}
instance Core.FromJSON RegionalInventory where
        parseJSON
          = Core.withObject "RegionalInventory"
              (\ o ->
          ...
          = Core.object
              (Core.catMaybes
                 [("availability" Core..=) Core.<$> availability,
                  ...
                  ("regionId" Core..=) Core.<$> regionId,
                  ("salePrice" Core..=) Core.<$> salePrice,
                  ("salePriceEffectiveDate" Core..=) Core.<$>
...
instance Core.FromJSON RegionalinventoryCustomBatchRequest where
        parseJSON
          = Core.withObject "RegionalinventoryCustomBatchRequest"
              (\ o ->
                 RegionalinventoryCustomBatchRequest Core.<$>
                   (o Core..:? "entries"))
...
newRegionalinventoryCustomBatchRequestEntry 
    :: 
                                            RegionalinventoryCustomBatchRequestEntry
newRegionalinventoryCustomBatchRequestEntry
  = RegionalinventoryCustomBatchRequestEntry{batchId = Core.Nothing,
                                             merchantId = Core.Nothing, method = Core.Nothing,
                                             productId = Core.Nothing,
                                             regionalInventory = Core.Nothing}
instance Core.FromJSON RegionalinventoryCustomBatchRequestEntry
         where
        parseJSON
          = Core.withObject "RegionalinventoryCustomBatchRequestEntry"
              (\ o ->
                 RegionalinventoryCustomBatchRequestEntry Core.<$>
                   (o Core..:? "batchId") Core.<*>
                     (o Core..:? "merchantId" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "method")
                     Core.<*> (o Core..:? "productId")
...
newRegionalinventoryCustomBatchResponse 
    :: 
                                        RegionalinventoryCustomBatchResponse
newRegionalinventoryCustomBatchResponse
  = RegionalinventoryCustomBatchResponse{entries = Core.Nothing,
                                         kind = Core.Nothing}
instance Core.FromJSON RegionalinventoryCustomBatchResponse where
        parseJSON
          = Core.withObject "RegionalinventoryCustomBatchResponse"
              (\ o ->
                 RegionalinventoryCustomBatchResponse Core.<$>
                   (o Core..:? "entries") Core.<*> (o Core..:? "kind"))
...
newRegionalinventoryCustomBatchResponseEntry 
    :: 
                                             RegionalinventoryCustomBatchResponseEntry
newRegionalinventoryCustomBatchResponseEntry
  = RegionalinventoryCustomBatchResponseEntry{batchId = Core.Nothing,
                                              errors = Core.Nothing, kind = Core.Nothing,
                                              regionalInventory = Core.Nothing}
instance Core.FromJSON RegionalinventoryCustomBatchResponseEntry
         where
        parseJSON
          = Core.withObject "RegionalinventoryCustomBatchResponseEntry"
              (\ o ->
                 RegionalinventoryCustomBatchResponseEntry Core.<$>
                   (o Core..:? "batchId") Core.<*> (o Core..:? "errors") Core.<*>
                     (o Core..:? "kind")
                     Core.<*> (o Core..:? "regionalInventory"))

instance Core.ToJSON RegionalinventoryCustomBatchResponseEntry
         where
...
data RenderAccountIssuesRequestPayload = RenderAccountIssuesRequestPayload
    ...
    , userInputActionOption :: (Core.Maybe
...
newRenderAccountIssuesRequestPayload 
    :: 
                                     RenderAccountIssuesRequestPayload
newRenderAccountIssuesRequestPayload
  = RenderAccountIssuesRequestPayload{contentOption = Core.Nothing,
                                      userInputActionOption = Core.Nothing}
instance Core.FromJSON RenderAccountIssuesRequestPayload where
        parseJSON
          = Core.withObject "RenderAccountIssuesRequestPayload"
              (\ o ->
                 RenderAccountIssuesRequestPayload Core.<$>
                   (o Core..:? "contentOption") Core.<*>
                     (o Core..:? "userInputActionOption"))
...
newRenderAccountIssuesResponse 
    ::  RenderAccountIssuesResponse
newRenderAccountIssuesResponse
  = RenderAccountIssuesResponse{alternateDisputeResolution =
                                  Core.Nothing,
                                issues = Core.Nothing}
instance Core.FromJSON RenderAccountIssuesResponse where
        parseJSON
          = Core.withObject "RenderAccountIssuesResponse"
              (\ o ->
                 RenderAccountIssuesResponse Core.<$>
                   (o Core..:? "alternateDisputeResolution") Core.<*>
                     (o Core..:? "issues"))
...
instance Core.ToJSON RenderAccountIssuesResponse where
        toJSON RenderAccountIssuesResponse{..}
          = Core.object
              (Core.catMaybes
                 [("alternateDisputeResolution" Core..=) Core.<$>
                    alternateDisputeResolution,
...
newRenderProductIssuesRequestPayload 
    :: 
                                     RenderProductIssuesRequestPayload
newRenderProductIssuesRequestPayload
  = RenderProductIssuesRequestPayload{contentOption = Core.Nothing,
                                      userInputActionOption = Core.Nothing}
instance Core.FromJSON RenderProductIssuesRequestPayload where
        parseJSON
          = Core.withObject "RenderProductIssuesRequestPayload"
              (\ o ->
                 RenderProductIssuesRequestPayload Core.<$>
                   (o Core..:? "contentOption") Core.<*>
                     (o Core..:? "userInputActionOption"))
...
newRenderProductIssuesResponse 
    ::  RenderProductIssuesResponse
newRenderProductIssuesResponse
  = RenderProductIssuesResponse{alternateDisputeResolution =
                                  Core.Nothing,
                                issues = Core.Nothing}
instance Core.FromJSON RenderProductIssuesResponse where
        parseJSON
          = Core.withObject "RenderProductIssuesResponse"
              (\ o ->
                 RenderProductIssuesResponse Core.<$>
                   (o Core..:? "alternateDisputeResolution") Core.<*>
                     (o Core..:? "issues"))
...
newReportInteractionRequest 
    ::  ReportInteractionRequest
newReportInteractionRequest
  = ReportInteractionRequest{interactionType = Core.Nothing,
                             responseToken = Core.Nothing, subtype = Core.Nothing,
                             type' = Core.Nothing}
instance Core.FromJSON ReportInteractionRequest where
        parseJSON
          = Core.withObject "ReportInteractionRequest"
              (\ o ->
                 ReportInteractionRequest Core.<$>
                   (o Core..:? "interactionType") Core.<*>
                     (o Core..:? "responseToken")
                     Core.<*> (o Core..:? "subtype")
                     Core.<*> (o Core..:? "type"))
...
newReportRow 
    ::  ReportRow
newReportRow
  = ReportRow{bestSellers = Core.Nothing, brand = Core.Nothing,
              competitiveVisibility = Core.Nothing, metrics = Core.Nothing,
              priceCompetitiveness = Core.Nothing, priceInsights = Core.Nothing,
              productCluster = Core.Nothing, productView = Core.Nothing,
              segments = Core.Nothing, topicTrends = Core.Nothing}
instance Core.FromJSON ReportRow where
        parseJSON
          = Core.withObject "ReportRow"
              (\ o ->
                 ReportRow Core.<$>
                   (o Core..:? "bestSellers") Core.<*> (o Core..:? "brand") Core.<*>
                     (o Core..:? "competitiveVisibility")
                     Core.<*> (o Core..:? "metrics")
...
data RequestPhoneVerificationRequest = RequestPhoneVerificationRequest
    ...
    , phoneVerificationMethod :: (Core.Maybe
...
newRequestPhoneVerificationRequest 
    :: 
                                   RequestPhoneVerificationRequest
newRequestPhoneVerificationRequest
  = RequestPhoneVerificationRequest{languageCode = Core.Nothing,
                                    phoneNumber = Core.Nothing, phoneRegionCode = Core.Nothing,
                                    phoneVerificationMethod = Core.Nothing}
instance Core.FromJSON RequestPhoneVerificationRequest where
        parseJSON
          = Core.withObject "RequestPhoneVerificationRequest"
              (\ o ->
                 RequestPhoneVerificationRequest Core.<$>
                   (o Core..:? "languageCode") Core.<*> (o Core..:? "phoneNumber")
          ...
          = Core.object
              (Core.catMaybes
                 [("languageCode" Core..=) Core.<$> languageCode,
                  ...
                  ("phoneVerificationMethod" Core..=) Core.<$>
...
instance Core.FromJSON RequestPhoneVerificationResponse where
        parseJSON
          = Core.withObject "RequestPhoneVerificationResponse"
              (\ o ->
                 RequestPhoneVerificationResponse Core.<$>
                   (o Core..:? "verificationId"))
...
instance Core.FromJSON RequestReviewFreeListingsRequest where
        parseJSON
          = Core.withObject "RequestReviewFreeListingsRequest"
              (\ o ->
                 RequestReviewFreeListingsRequest Core.<$>
                   (o Core..:? "regionCode"))
...
instance Core.FromJSON RequestReviewShoppingAdsRequest where
        parseJSON
          = Core.withObject "RequestReviewShoppingAdsRequest"
              (\ o ->
...
newReturnAddress 
    ::  ReturnAddress
newReturnAddress
  = ReturnAddress{address = Core.Nothing, country = Core.Nothing,
                  kind = Core.Nothing, label = Core.Nothing,
                  phoneNumber = Core.Nothing, returnAddressId = Core.Nothing}
instance Core.FromJSON ReturnAddress where
        parseJSON
          = Core.withObject "ReturnAddress"
              (\ o ->
                 ReturnAddress Core.<$>
                   (o Core..:? "address") Core.<*> (o Core..:? "country") Core.<*>
                     (o Core..:? "kind")
                     Core.<*> (o Core..:? "label")
                     Core.<*> (o Core..:? "phoneNumber")
        ...
        toJSON ReturnAddress{..}
          = Core.object
              (Core.catMaybes
                 [("address" Core..=) Core.<$> address,
                  ("country" Core..=) Core.<$> country,
                  ("kind" Core..=) Core.<$> kind, ("label" Core..=) Core.<$> label,
                  ("phoneNumber" Core..=) Core.<$> phoneNumber,
...
newReturnAddressAddress 
    ::  ReturnAddressAddress
newReturnAddressAddress
  = ReturnAddressAddress{country = Core.Nothing,
                         locality = Core.Nothing, postalCode = Core.Nothing,
                         recipientName = Core.Nothing, region = Core.Nothing,
                         streetAddress = Core.Nothing}
instance Core.FromJSON ReturnAddressAddress where
        parseJSON
          = Core.withObject "ReturnAddressAddress"
              (\ o ->
                 ReturnAddressAddress Core.<$>
                   (o Core..:? "country") Core.<*> (o Core..:? "locality") Core.<*>
                     (o Core..:? "postalCode")
...
newReturnPolicy 
    ::  ReturnPolicy
newReturnPolicy
  = ReturnPolicy{country = Core.Nothing, kind = Core.Nothing,
                 label = Core.Nothing, name = Core.Nothing,
                 nonFreeReturnReasons = Core.Nothing, policy = Core.Nothing,
                 returnPolicyId = Core.Nothing, returnShippingFee = Core.Nothing,
                 seasonalOverrides = Core.Nothing}
instance Core.FromJSON ReturnPolicy where
        parseJSON
          = Core.withObject "ReturnPolicy"
              (\ o ->
                 ReturnPolicy Core.<$>
                   (o Core..:? "country") Core.<*> (o Core..:? "kind") Core.<*>
                     (o Core..:? "label")
                     Core.<*> (o Core..:? "name")
...
newReturnPolicyOnline 
    ::  ReturnPolicyOnline
newReturnPolicyOnline
  = ReturnPolicyOnline{countries = Core.Nothing,
                       itemConditions = Core.Nothing, label = Core.Nothing,
                       name = Core.Nothing, policy = Core.Nothing,
                       restockingFee = Core.Nothing, returnMethods = Core.Nothing,
                       returnPolicyId = Core.Nothing, returnPolicyUri = Core.Nothing,
                       returnReasonCategoryInfo = Core.Nothing}
instance Core.FromJSON ReturnPolicyOnline where
        parseJSON
          = Core.withObject "ReturnPolicyOnline"
              (\ o ->
                 ReturnPolicyOnline Core.<$>
                   (o Core..:? "countries") Core.<*> (o Core..:? "itemConditions")
                     Core.<*> (o Core..:? "label")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "policy")
          ...
          = Core.object
              (Core.catMaybes
                 [("countries" Core..=) Core.<$> countries,
                  ...
                  ("returnReasonCategoryInfo" Core..=) Core.<$>
...
newReturnPolicyOnlinePolicy 
    ::  ReturnPolicyOnlinePolicy
newReturnPolicyOnlinePolicy
  = ReturnPolicyOnlinePolicy{days = Core.Nothing,
                             type' = Core.Nothing}
instance Core.FromJSON ReturnPolicyOnlinePolicy where
        parseJSON
          = Core.withObject "ReturnPolicyOnlinePolicy"
              (\ o ->
                 ReturnPolicyOnlinePolicy Core.<$>
                   (o Core..:? "days" Core.<&> Core.fmap Core.fromAsText) Core.<*>
                     (o Core..:? "type"))
...
newReturnPolicyOnlineRestockingFee 
    :: 
                                   ReturnPolicyOnlineRestockingFee
newReturnPolicyOnlineRestockingFee
  = ReturnPolicyOnlineRestockingFee{fixedFee = Core.Nothing,
                                    microPercent = Core.Nothing}
instance Core.FromJSON ReturnPolicyOnlineRestockingFee where
        parseJSON
          = Core.withObject "ReturnPolicyOnlineRestockingFee"
              (\ o ->
                 ReturnPolicyOnlineRestockingFee Core.<$>
                   (o Core..:? "fixedFee") Core.<*> (o Core..:? "microPercent"))
...
newReturnPolicyOnlineReturnReasonCategoryInfo 
    :: 
                                              ReturnPolicyOnlineReturnReasonCategoryInfo
newReturnPolicyOnlineReturnReasonCategoryInfo
  = ReturnPolicyOnlineReturnReasonCategoryInfo{returnLabelSource =
                                                 Core.Nothing,
                                               returnReasonCategory = Core.Nothing,
                                               returnShippingFee = Core.Nothing}
instance Core.FromJSON ReturnPolicyOnlineReturnReasonCategoryInfo
         where
        parseJSON
          = Core.withObject "ReturnPolicyOnlineReturnReasonCategoryInfo"
              (\ o ->
                 ReturnPolicyOnlineReturnReasonCategoryInfo Core.<$>
                   (o Core..:? "returnLabelSource") Core.<*>
                     (o Core..:? "returnReasonCategory")
                     Core.<*> (o Core..:? "returnShippingFee"))

instance Core.ToJSON ReturnPolicyOnlineReturnReasonCategoryInfo
         where
...
newReturnPolicyOnlineReturnShippingFee 
    :: 
                                       ReturnPolicyOnlineReturnShippingFee
newReturnPolicyOnlineReturnShippingFee
  = ReturnPolicyOnlineReturnShippingFee{fixedFee = Core.Nothing,
                                        type' = Core.Nothing}
instance Core.FromJSON ReturnPolicyOnlineReturnShippingFee where
        parseJSON
          = Core.withObject "ReturnPolicyOnlineReturnShippingFee"
              (\ o ->
                 ReturnPolicyOnlineReturnShippingFee Core.<$>
                   (o Core..:? "fixedFee") Core.<*> (o Core..:? "type"))
...
newReturnPolicyPolicy 
    ::  ReturnPolicyPolicy
newReturnPolicyPolicy
  = ReturnPolicyPolicy{lastReturnDate = Core.Nothing,
                       numberOfDays = Core.Nothing, type' = Core.Nothing}
instance Core.FromJSON ReturnPolicyPolicy where
        parseJSON
          = Core.withObject "ReturnPolicyPolicy"
              (\ o ->
                 ReturnPolicyPolicy Core.<$>
                   (o Core..:? "lastReturnDate") Core.<*>
                     (o Core..:? "numberOfDays" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "type"))
...
newReturnPolicySeasonalOverride 
    ::  ReturnPolicySeasonalOverride
newReturnPolicySeasonalOverride
  = ReturnPolicySeasonalOverride{endDate = Core.Nothing,
                                 name = Core.Nothing, policy = Core.Nothing,
                                 startDate = Core.Nothing}
instance Core.FromJSON ReturnPolicySeasonalOverride where
        parseJSON
          = Core.withObject "ReturnPolicySeasonalOverride"
              (\ o ->
                 ReturnPolicySeasonalOverride Core.<$>
                   (o Core..:? "endDate") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "policy")
...
instance Core.FromJSON ReturnaddressCustomBatchRequest where
        parseJSON
          = Core.withObject "ReturnaddressCustomBatchRequest"
              (\ o ->
...
newReturnaddressCustomBatchRequestEntry 
    :: 
                                        ReturnaddressCustomBatchRequestEntry
newReturnaddressCustomBatchRequestEntry
  = ReturnaddressCustomBatchRequestEntry{batchId = Core.Nothing,
                                         merchantId = Core.Nothing, method = Core.Nothing,
                                         returnAddress = Core.Nothing,
                                         returnAddressId = Core.Nothing}
instance Core.FromJSON ReturnaddressCustomBatchRequestEntry where
        parseJSON
          = Core.withObject "ReturnaddressCustomBatchRequestEntry"
              (\ o ->
                 ReturnaddressCustomBatchRequestEntry Core.<$>
                   (o Core..:? "batchId") Core.<*>
                     (o Core..:? "merchantId" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "method")
...
newReturnaddressCustomBatchResponse 
    :: 
                                    ReturnaddressCustomBatchResponse
newReturnaddressCustomBatchResponse
  = ReturnaddressCustomBatchResponse{entries = Core.Nothing,
                                     kind = Core.Nothing}
instance Core.FromJSON ReturnaddressCustomBatchResponse where
        parseJSON
          = Core.withObject "ReturnaddressCustomBatchResponse"
              (\ o ->
                 ReturnaddressCustomBatchResponse Core.<$>
                   (o Core..:? "entries") Core.<*> (o Core..:? "kind"))
...
newReturnaddressCustomBatchResponseEntry 
    :: 
                                         ReturnaddressCustomBatchResponseEntry
newReturnaddressCustomBatchResponseEntry
  = ReturnaddressCustomBatchResponseEntry{batchId = Core.Nothing,
                                          errors = Core.Nothing, kind = Core.Nothing,
                                          returnAddress = Core.Nothing}
instance Core.FromJSON ReturnaddressCustomBatchResponseEntry where
        parseJSON
          = Core.withObject "ReturnaddressCustomBatchResponseEntry"
              (\ o ->
                 ReturnaddressCustomBatchResponseEntry Core.<$>
                   (o Core..:? "batchId") Core.<*> (o Core..:? "errors") Core.<*>
                     (o Core..:? "kind")
                     Core.<*> (o Core..:? "returnAddress"))
...
newReturnaddressListResponse 
    ::  ReturnaddressListResponse
newReturnaddressListResponse
  = ReturnaddressListResponse{kind = Core.Nothing,
                              nextPageToken = Core.Nothing, resources = Core.Nothing}
instance Core.FromJSON ReturnaddressListResponse where
        parseJSON
          = Core.withObject "ReturnaddressListResponse"
              (\ o ->
                 ReturnaddressListResponse Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "resources"))
...
instance Core.FromJSON ReturnpolicyCustomBatchRequest where
        parseJSON
          = Core.withObject "ReturnpolicyCustomBatchRequest"
              (\ o ->
...
newReturnpolicyCustomBatchRequestEntry 
    :: 
                                       ReturnpolicyCustomBatchRequestEntry
newReturnpolicyCustomBatchRequestEntry
  = ReturnpolicyCustomBatchRequestEntry{batchId = Core.Nothing,
                                        merchantId = Core.Nothing, method = Core.Nothing,
                                        returnPolicy = Core.Nothing, returnPolicyId = Core.Nothing}
instance Core.FromJSON ReturnpolicyCustomBatchRequestEntry where
        parseJSON
          = Core.withObject "ReturnpolicyCustomBatchRequestEntry"
              (\ o ->
                 ReturnpolicyCustomBatchRequestEntry Core.<$>
                   (o Core..:? "batchId") Core.<*>
                     (o Core..:? "merchantId" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "method")
...
newReturnpolicyCustomBatchResponse 
    :: 
                                   ReturnpolicyCustomBatchResponse
newReturnpolicyCustomBatchResponse
  = ReturnpolicyCustomBatchResponse{entries = Core.Nothing,
                                    kind = Core.Nothing}
instance Core.FromJSON ReturnpolicyCustomBatchResponse where
        parseJSON
          = Core.withObject "ReturnpolicyCustomBatchResponse"
              (\ o ->
                 ReturnpolicyCustomBatchResponse Core.<$>
                   (o Core..:? "entries") Core.<*> (o Core..:? "kind"))
...
newReturnpolicyCustomBatchResponseEntry 
    :: 
                                        ReturnpolicyCustomBatchResponseEntry
newReturnpolicyCustomBatchResponseEntry
  = ReturnpolicyCustomBatchResponseEntry{batchId = Core.Nothing,
                                         errors = Core.Nothing, kind = Core.Nothing,
                                         returnPolicy = Core.Nothing}
instance Core.FromJSON ReturnpolicyCustomBatchResponseEntry where
        parseJSON
          = Core.withObject "ReturnpolicyCustomBatchResponseEntry"
              (\ o ->
                 ReturnpolicyCustomBatchResponseEntry Core.<$>
                   (o Core..:? "batchId") Core.<*> (o Core..:? "errors") Core.<*>
                     (o Core..:? "kind")
                     Core.<*> (o Core..:? "returnPolicy"))
...
newReturnpolicyListResponse 
    ::  ReturnpolicyListResponse
newReturnpolicyListResponse
  = ReturnpolicyListResponse{kind = Core.Nothing,
                             resources = Core.Nothing}
instance Core.FromJSON ReturnpolicyListResponse where
        parseJSON
          = Core.withObject "ReturnpolicyListResponse"
              (\ o ->
                 ReturnpolicyListResponse Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "resources"))
...
newSearchRequest 
    ::  SearchRequest
newSearchRequest
  = SearchRequest{pageSize = Core.Nothing, pageToken = Core.Nothing,
                  query = Core.Nothing}
instance Core.FromJSON SearchRequest where
        parseJSON
          = Core.withObject "SearchRequest"
              (\ o ->
                 SearchRequest Core.<$>
...
newSearchResponse 
    ::  SearchResponse
newSearchResponse
  = SearchResponse{nextPageToken = Core.Nothing,
...
newSegments 
    ::  Segments
newSegments
  = Segments{brand = Core.Nothing, categoryL1 = Core.Nothing,
             categoryL2 = Core.Nothing, categoryL3 = Core.Nothing,
             categoryL4 = Core.Nothing, categoryL5 = Core.Nothing,
             currencyCode = Core.Nothing, customLabel0 = Core.Nothing,
             customLabel1 = Core.Nothing, customLabel2 = Core.Nothing,
             customLabel3 = Core.Nothing, customLabel4 = Core.Nothing,
             customerCountryCode = Core.Nothing, date = Core.Nothing,
             offerId = Core.Nothing, productTypeL1 = Core.Nothing,
             productTypeL2 = Core.Nothing, productTypeL3 = Core.Nothing,
             productTypeL4 = Core.Nothing, productTypeL5 = Core.Nothing,
             program = Core.Nothing, title = Core.Nothing, week = Core.Nothing}
instance Core.FromJSON Segments where
        parseJSON
          = Core.withObject "Segments"
              (\ o ->
                 Segments Core.<$>
                   (o Core..:? "brand") Core.<*> (o Core..:? "categoryL1") Core.<*>
                     (o Core..:? "categoryL2")
                     Core.<*> (o Core..:? "categoryL3")
                     Core.<*> (o Core..:? "categoryL4")
                     Core.<*> (o Core..:? "categoryL5")
          ...
          = Core.object
              (Core.catMaybes
                 [("brand" Core..=) Core.<$> brand,
                  ...
                  ("title" Core..=) Core.<$> title, ("week" Core..=) Core.<$> week])
...
newService 
    ::  Service
newService
  = Service{active = Core.Nothing, currency = Core.Nothing,
            deliveryCountry = Core.Nothing, deliveryTime = Core.Nothing,
            eligibility = Core.Nothing, minimumOrderValue = Core.Nothing,
            minimumOrderValueTable = Core.Nothing, name = Core.Nothing,
            pickupService = Core.Nothing, rateGroups = Core.Nothing,
            shipmentType = Core.Nothing, storeConfig = Core.Nothing}
instance Core.FromJSON Service where
        parseJSON
          = Core.withObject "Service"
              (\ o ->
                 Service Core.<$>
                   (o Core..:? "active") Core.<*> (o Core..:? "currency") Core.<*>
                     (o Core..:? "deliveryCountry")
...
newServiceStoreConfig 
    ::  ServiceStoreConfig
newServiceStoreConfig
  = ServiceStoreConfig{cutoffConfig = Core.Nothing,
                       serviceRadius = Core.Nothing, storeCodes = Core.Nothing,
                       storeServiceType = Core.Nothing}
instance Core.FromJSON ServiceStoreConfig where
        parseJSON
          = Core.withObject "ServiceStoreConfig"
              (\ o ->
                 ServiceStoreConfig Core.<$>
                   (o Core..:? "cutoffConfig") Core.<*> (o Core..:? "serviceRadius")
...
newServiceStoreConfigCutoffConfig 
    ::  ServiceStoreConfigCutoffConfig
newServiceStoreConfigCutoffConfig
  = ServiceStoreConfigCutoffConfig{localCutoffTime = Core.Nothing,
...
instance Core.FromJSON ServiceStoreConfigCutoffConfig where
        parseJSON
          = Core.withObject "ServiceStoreConfigCutoffConfig"
              (\ o ->
                 ServiceStoreConfigCutoffConfig Core.<$>
                   (o Core..:? "localCutoffTime") Core.<*>
                     (o Core..:? "noDeliveryPostCutoff")
                     Core.<*>
                     (o Core..:? "storeCloseOffsetHours" Core.<&>
                        Core.fmap Core.fromAsText))
          ...
          = Core.object
              (Core.catMaybes
                 [("localCutoffTime" Core..=) Core.<$> localCutoffTime,
                  ...
                  ("storeCloseOffsetHours" Core..=) Core.. Core.AsText Core.<$>
...
newServiceStoreConfigCutoffConfigLocalCutoffTime 
    :: 
                                                 ServiceStoreConfigCutoffConfigLocalCutoffTime
newServiceStoreConfigCutoffConfigLocalCutoffTime
  = ServiceStoreConfigCutoffConfigLocalCutoffTime{hour =
                                                    Core.Nothing,
                                                  minute = Core.Nothing}
instance Core.FromJSON
           ServiceStoreConfigCutoffConfigLocalCutoffTime
         where
        parseJSON
          = Core.withObject "ServiceStoreConfigCutoffConfigLocalCutoffTime"
              (\ o ->
                 ServiceStoreConfigCutoffConfigLocalCutoffTime Core.<$>
                   (o Core..:? "hour" Core.<&> Core.fmap Core.fromAsText) Core.<*>
                     (o Core..:? "minute" Core.<&> Core.fmap Core.fromAsText))

instance Core.ToJSON ServiceStoreConfigCutoffConfigLocalCutoffTime
         where
...
newShippingSettings 
    ::  ShippingSettings
newShippingSettings
  = ShippingSettings{accountId = Core.Nothing,
                     postalCodeGroups = Core.Nothing, services = Core.Nothing,
                     warehouses = Core.Nothing}
instance Core.FromJSON ShippingSettings where
        parseJSON
          = Core.withObject "ShippingSettings"
              (\ o ->
...
instance Core.FromJSON ShippingsettingsCustomBatchRequest where
        parseJSON
          = Core.withObject "ShippingsettingsCustomBatchRequest"
              (\ o ->
...
newShippingsettingsCustomBatchRequestEntry 
    :: 
                                           ShippingsettingsCustomBatchRequestEntry
newShippingsettingsCustomBatchRequestEntry
  = ShippingsettingsCustomBatchRequestEntry{accountId = Core.Nothing,
                                            batchId = Core.Nothing, merchantId = Core.Nothing,
                                            method = Core.Nothing, shippingSettings = Core.Nothing}
instance Core.FromJSON ShippingsettingsCustomBatchRequestEntry
         where
        parseJSON
          = Core.withObject "ShippingsettingsCustomBatchRequestEntry"
              (\ o ->
                 ShippingsettingsCustomBatchRequestEntry Core.<$>
                   (o Core..:? "accountId" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "batchId")
                     Core.<*>
                     (o Core..:? "merchantId" Core.<&> Core.fmap Core.fromAsText)
...
newShippingsettingsCustomBatchResponse 
    :: 
                                       ShippingsettingsCustomBatchResponse
newShippingsettingsCustomBatchResponse
  = ShippingsettingsCustomBatchResponse{entries = Core.Nothing,
                                        kind = Core.Nothing}
instance Core.FromJSON ShippingsettingsCustomBatchResponse where
        parseJSON
          = Core.withObject "ShippingsettingsCustomBatchResponse"
              (\ o ->
                 ShippingsettingsCustomBatchResponse Core.<$>
                   (o Core..:? "entries") Core.<*> (o Core..:? "kind"))
...
newShippingsettingsCustomBatchResponseEntry 
    :: 
                                            ShippingsettingsCustomBatchResponseEntry
newShippingsettingsCustomBatchResponseEntry
  = ShippingsettingsCustomBatchResponseEntry{batchId = Core.Nothing,
                                             errors = Core.Nothing, kind = Core.Nothing,
                                             shippingSettings = Core.Nothing}
instance Core.FromJSON ShippingsettingsCustomBatchResponseEntry
         where
        parseJSON
          = Core.withObject "ShippingsettingsCustomBatchResponseEntry"
              (\ o ->
                 ShippingsettingsCustomBatchResponseEntry Core.<$>
                   (o Core..:? "batchId") Core.<*> (o Core..:? "errors") Core.<*>
                     (o Core..:? "kind")
                     Core.<*> (o Core..:? "shippingSettings"))
...
newShippingsettingsGetSupportedCarriersResponse 
    :: 
                                                ShippingsettingsGetSupportedCarriersResponse
newShippingsettingsGetSupportedCarriersResponse
  = ShippingsettingsGetSupportedCarriersResponse{carriers =
                                                   Core.Nothing,
                                                 kind = Core.Nothing}
instance Core.FromJSON ShippingsettingsGetSupportedCarriersResponse
         where
        parseJSON
          = Core.withObject "ShippingsettingsGetSupportedCarriersResponse"
              (\ o ->
                 ShippingsettingsGetSupportedCarriersResponse Core.<$>
                   (o Core..:? "carriers") Core.<*> (o Core..:? "kind"))

instance Core.ToJSON ShippingsettingsGetSupportedCarriersResponse
         where
...
newShippingsettingsGetSupportedHolidaysResponse 
    :: 
                                                ShippingsettingsGetSupportedHolidaysResponse
newShippingsettingsGetSupportedHolidaysResponse
  = ShippingsettingsGetSupportedHolidaysResponse{holidays =
                                                   Core.Nothing,
                                                 kind = Core.Nothing}
instance Core.FromJSON ShippingsettingsGetSupportedHolidaysResponse
         where
        parseJSON
          = Core.withObject "ShippingsettingsGetSupportedHolidaysResponse"
              (\ o ->
                 ShippingsettingsGetSupportedHolidaysResponse Core.<$>
                   (o Core..:? "holidays") Core.<*> (o Core..:? "kind"))

instance Core.ToJSON ShippingsettingsGetSupportedHolidaysResponse
         where
...
newShippingsettingsGetSupportedPickupServicesResponse 
    :: 
                                                      ShippingsettingsGetSupportedPickupServicesResponse
newShippingsettingsGetSupportedPickupServicesResponse
  = ShippingsettingsGetSupportedPickupServicesResponse{kind =
                                                         Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "ShippingsettingsGetSupportedPickupServicesResponse"
              (\ o ->
                 ShippingsettingsGetSupportedPickupServicesResponse Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "pickupServices"))
...
newShippingsettingsListResponse 
    ::  ShippingsettingsListResponse
newShippingsettingsListResponse
  = ShippingsettingsListResponse{kind = Core.Nothing,
                                 nextPageToken = Core.Nothing, resources = Core.Nothing}
instance Core.FromJSON ShippingsettingsListResponse where
        parseJSON
          = Core.withObject "ShippingsettingsListResponse"
              (\ o ->
                 ShippingsettingsListResponse Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "resources"))
...
newShoppingAdsProgramStatus 
    ::  ShoppingAdsProgramStatus
newShoppingAdsProgramStatus
  = ShoppingAdsProgramStatus{globalState = Core.Nothing,
                             regionStatuses = Core.Nothing}
instance Core.FromJSON ShoppingAdsProgramStatus where
        parseJSON
          = Core.withObject "ShoppingAdsProgramStatus"
              (\ o ->
                 ShoppingAdsProgramStatus Core.<$>
                   (o Core..:? "globalState") Core.<*> (o Core..:? "regionStatuses"))
...
newShoppingAdsProgramStatusRegionStatus 
    :: 
                                        ShoppingAdsProgramStatusRegionStatus
newShoppingAdsProgramStatusRegionStatus
  = ShoppingAdsProgramStatusRegionStatus{disapprovalDate =
                                           Core.Nothing,
                                         eligibilityStatus = Core.Nothing,
                                         onboardingIssues = Core.Nothing,
                                         regionCodes = Core.Nothing,
...
instance Core.FromJSON ShoppingAdsProgramStatusRegionStatus where
        parseJSON
          = Core.withObject "ShoppingAdsProgramStatusRegionStatus"
              (\ o ->
                 ShoppingAdsProgramStatusRegionStatus Core.<$>
                   (o Core..:? "disapprovalDate") Core.<*>
                     (o Core..:? "eligibilityStatus")
                     Core.<*> (o Core..:? "onboardingIssues")
                     Core.<*> (o Core..:? "regionCodes")
...
newShoppingAdsProgramStatusReviewIneligibilityReasonDetails 
    :: 
                                                            ShoppingAdsProgramStatusReviewIneligibilityReasonDetails
newShoppingAdsProgramStatusReviewIneligibilityReasonDetails
  = ShoppingAdsProgramStatusReviewIneligibilityReasonDetails{cooldownTime
                                                               = Core.Nothing}
instance Core.FromJSON
           ShoppingAdsProgramStatusReviewIneligibilityReasonDetails
         where
        parseJSON
          = Core.withObject
              "ShoppingAdsProgramStatusReviewIneligibilityReasonDetails"
              (\ o ->
                 ShoppingAdsProgramStatusReviewIneligibilityReasonDetails Core.<$>
                   (o Core..:? "cooldownTime"))
...
newTable 
    ::  Table
newTable
  = Table{columnHeaders = Core.Nothing, name = Core.Nothing,
          rowHeaders = Core.Nothing, rows = Core.Nothing}
instance Core.FromJSON Table where
        parseJSON
          = Core.withObject "Table"
              (\ o ->
                 Table Core.<$>
                   (o Core..:? "columnHeaders") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "rowHeaders")
                     Core.<*> (o Core..:? "rows"))
...
newTextWithTooltip 
    ::  TextWithTooltip
newTextWithTooltip
  = TextWithTooltip{simpleTooltipValue = Core.Nothing,
                    simpleValue = Core.Nothing, tooltipIconStyle = Core.Nothing}
instance Core.FromJSON TextWithTooltip where
        parseJSON
          = Core.withObject "TextWithTooltip"
              (\ o ->
                 TextWithTooltip Core.<$>
                   (o Core..:? "simpleTooltipValue") Core.<*>
                     (o Core..:? "simpleValue")
...
newTopicTrends 
    ::  TopicTrends
newTopicTrends
  = TopicTrends{customerCountryCode = Core.Nothing,
                date = Core.Nothing, last120DaysSearchInterest = Core.Nothing,
                ...
                searchInterest = Core.Nothing, topic = Core.Nothing}
instance Core.FromJSON TopicTrends where
        parseJSON
          = Core.withObject "TopicTrends"
              (\ o ->
                 TopicTrends Core.<$>
                   (o Core..:? "customerCountryCode") Core.<*> (o Core..:? "date")
        ...
        toJSON TopicTrends{..}
          = Core.object
              (Core.catMaybes
                 [("customerCountryCode" Core..=) Core.<$> customerCountryCode,
                  ("date" Core..=) Core.<$> date,
                  ("last120DaysSearchInterest" Core..=) Core.<$>
                    last120DaysSearchInterest,
                  ("last30DaysSearchInterest" Core..=) Core.<$>
                    last30DaysSearchInterest,
                  ("last7DaysSearchInterest" Core..=) Core.<$>
                    last7DaysSearchInterest,
                  ("last90DaysSearchInterest" Core..=) Core.<$>
                    last90DaysSearchInterest,
                  ("next7DaysSearchInterest" Core..=) Core.<$>
...
newTransitTable 
    ::  TransitTable
newTransitTable
  = TransitTable{postalCodeGroupNames = Core.Nothing,
                 rows = Core.Nothing, transitTimeLabels = Core.Nothing}
instance Core.FromJSON TransitTable where
        parseJSON
          = Core.withObject "TransitTable"
              (\ o ->
                 TransitTable Core.<$>
                   (o Core..:? "postalCodeGroupNames") Core.<*> (o Core..:? "rows")
...
instance Core.FromJSON TransitTableTransitTimeRow where
        parseJSON
          = Core.withObject "TransitTableTransitTimeRow"
...
newTransitTableTransitTimeRowTransitTimeValue 
    :: 
                                              TransitTableTransitTimeRowTransitTimeValue
newTransitTableTransitTimeRowTransitTimeValue
  = TransitTableTransitTimeRowTransitTimeValue{maxTransitTimeInDays =
                                                 Core.Nothing,
                                               minTransitTimeInDays = Core.Nothing}
instance Core.FromJSON TransitTableTransitTimeRowTransitTimeValue
         where
        parseJSON
          = Core.withObject "TransitTableTransitTimeRowTransitTimeValue"
              (\ o ->
                 TransitTableTransitTimeRowTransitTimeValue Core.<$>
                   (o Core..:? "maxTransitTimeInDays") Core.<*>
                     (o Core..:? "minTransitTimeInDays"))

instance Core.ToJSON TransitTableTransitTimeRowTransitTimeValue
         where
...
newTriggerActionPayload 
    ::  TriggerActionPayload
newTriggerActionPayload
  = TriggerActionPayload{actionContext = Core.Nothing,
                         actionInput = Core.Nothing}
instance Core.FromJSON TriggerActionPayload where
        parseJSON
          = Core.withObject "TriggerActionPayload"
              (\ o ->
                 TriggerActionPayload Core.<$>
                   (o Core..:? "actionContext") Core.<*> (o Core..:? "actionInput"))
...
instance Core.FromJSON TriggerActionResponse where
        parseJSON
          = Core.withObject "TriggerActionResponse"
...
instance Core.FromJSON UndeleteConversionSourceRequest where
        parseJSON
          = Core.withObject "UndeleteConversionSourceRequest"
...
newUrlSettings 
    ::  UrlSettings
newUrlSettings
  = UrlSettings{cartUriTemplate = Core.Nothing,
                checkoutUriTemplate = Core.Nothing}
instance Core.FromJSON UrlSettings where
        parseJSON
          = Core.withObject "UrlSettings"
              (\ o ->
                 UrlSettings Core.<$>
                   (o Core..:? "cartUriTemplate") Core.<*>
                     (o Core..:? "checkoutUriTemplate"))
...
newValue 
    ::  Value
newValue
  = Value{carrierRateName = Core.Nothing, flatRate = Core.Nothing,
          noShipping = Core.Nothing, pricePercentage = Core.Nothing,
...
instance Core.FromJSON Value where
        parseJSON
          = Core.withObject "Value"
              (\ o ->
                 Value Core.<$>
                   (o Core..:? "carrierRateName") Core.<*> (o Core..:? "flatRate")
...
newVerifyPhoneNumberRequest 
    ::  VerifyPhoneNumberRequest
newVerifyPhoneNumberRequest
  = VerifyPhoneNumberRequest{phoneVerificationMethod = Core.Nothing,
                             verificationCode = Core.Nothing, verificationId = Core.Nothing}
instance Core.FromJSON VerifyPhoneNumberRequest where
        parseJSON
          = Core.withObject "VerifyPhoneNumberRequest"
              (\ o ->
                 VerifyPhoneNumberRequest Core.<$>
                   (o Core..:? "phoneVerificationMethod") Core.<*>
                     (o Core..:? "verificationCode")
...
instance Core.FromJSON VerifyPhoneNumberResponse where
        parseJSON
          = Core.withObject "VerifyPhoneNumberResponse"
              (\ o ->
                 VerifyPhoneNumberResponse Core.<$>
                   (o Core..:? "verifiedPhoneNumber"))
...
newWarehouse 
    ::  Warehouse
newWarehouse
  = Warehouse{businessDayConfig = Core.Nothing,
              cutoffTime = Core.Nothing, handlingDays = Core.Nothing,
              name = Core.Nothing, shippingAddress = Core.Nothing}
instance Core.FromJSON Warehouse where
        parseJSON
          = Core.withObject "Warehouse"
              (\ o ->
                 Warehouse Core.<$>
                   (o Core..:? "businessDayConfig") Core.<*> (o Core..:? "cutoffTime")
                     Core.<*>
                     (o Core..:? "handlingDays" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "name")
...
newWarehouseBasedDeliveryTime 
    ::  WarehouseBasedDeliveryTime
newWarehouseBasedDeliveryTime
  = WarehouseBasedDeliveryTime{carrier = Core.Nothing,
                               carrierService = Core.Nothing,
                               originAdministrativeArea = Core.Nothing, originCity = Core.Nothing,
                               originCountry = Core.Nothing, originPostalCode = Core.Nothing,
                               originStreetAddress = Core.Nothing, warehouseName = Core.Nothing}
instance Core.FromJSON WarehouseBasedDeliveryTime where
        parseJSON
          = Core.withObject "WarehouseBasedDeliveryTime"
              (\ o ->
                 WarehouseBasedDeliveryTime Core.<$>
                   (o Core..:? "carrier") Core.<*> (o Core..:? "carrierService")
          ...
          = Core.object
              (Core.catMaybes
                 [("carrier" Core..=) Core.<$> carrier,
                  ("carrierService" Core..=) Core.<$> carrierService,
                  ("originAdministrativeArea" Core..=) Core.<$>
...
instance Core.FromJSON WarehouseCutoffTime where
        parseJSON
          = Core.withObject "WarehouseCutoffTime"
              (\ o ->
                 WarehouseCutoffTime Core.<$>
                   (o Core..:? "hour") Core.<*> (o Core..:? "minute"))
