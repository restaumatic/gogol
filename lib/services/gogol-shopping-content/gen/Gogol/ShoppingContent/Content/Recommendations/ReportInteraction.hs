                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] ReportInteractionRequest Core.:>
                             Core.Post '[Core.JSON] ()
...
newContentRecommendationsReportInteraction merchantId payload
  = ContentRecommendationsReportInteraction{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            merchantId = merchantId, payload = payload,
                                            uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ContentRecommendationsReportInteraction
         where
        type Rs ContentRecommendationsReportInteraction = ()
        type Scopes ContentRecommendationsReportInteraction =
             '[Content'FullControl]
