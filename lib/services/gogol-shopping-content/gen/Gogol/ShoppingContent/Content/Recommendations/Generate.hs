             ...
             "generate" Core.:>
               Core.QueryParam "$.xgafv" Xgafv Core.:>
                 Core.QueryParam "access_token" Core.Text Core.:>
                   Core.QueryParams "allowedTag" Core.Text Core.:>
                     Core.QueryParam "callback" Core.Text Core.:>
                       Core.QueryParam "languageCode" Core.Text Core.:>
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Get '[Core.JSON] GenerateRecommendationsResponse
...
newContentRecommendationsGenerate merchantId
  = ContentRecommendationsGenerate{xgafv = Core.Nothing,
                                   accessToken = Core.Nothing, allowedTag = Core.Nothing,
                                   callback = Core.Nothing, languageCode = Core.Nothing,
                                   merchantId = merchantId, uploadType = Core.Nothing,
                                   uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ContentRecommendationsGenerate where
        type Rs ContentRecommendationsGenerate =
             GenerateRecommendationsResponse
        type Scopes ContentRecommendationsGenerate = '[Content'FullControl]
        requestClient ContentRecommendationsGenerate{..}
          = go merchantId xgafv accessToken
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ContentRecommendationsGenerateResource)
                      Core.mempty
