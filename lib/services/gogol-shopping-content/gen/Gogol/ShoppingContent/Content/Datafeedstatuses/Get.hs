                 ...
                 Core.QueryParam "access_token" Core.Text Core.:>
                   Core.QueryParam "callback" Core.Text Core.:>
                     Core.QueryParam "country" Core.Text Core.:>
                       Core.QueryParam "feedLabel" Core.Text Core.:>
                         Core.QueryParam "language" Core.Text Core.:>
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.Get '[Core.JSON] DatafeedStatus
...
newContentDatafeedstatusesGet datafeedId merchantId
  = ContentDatafeedstatusesGet{xgafv = Core.Nothing,
                               accessToken = Core.Nothing, callback = Core.Nothing,
                               country = Core.Nothing, datafeedId = datafeedId,
...
instance Core.GoogleRequest ContentDatafeedstatusesGet where
        ...
        requestClient ContentDatafeedstatusesGet{..}
          = go merchantId datafeedId xgafv accessToken callback country
              feedLabel
              language
              uploadType
              uploadProtocol
