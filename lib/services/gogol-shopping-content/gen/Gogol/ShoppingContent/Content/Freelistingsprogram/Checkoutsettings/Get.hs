                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] CheckoutSettings
...
newContentFreelistingsprogramCheckoutsettingsGet merchantId
  = ContentFreelistingsprogramCheckoutsettingsGet{xgafv =
                                                    Core.Nothing,
...
instance Core.GoogleRequest
           ContentFreelistingsprogramCheckoutsettingsGet
         where
        type Rs ContentFreelistingsprogramCheckoutsettingsGet =
             CheckoutSettings
        type Scopes ContentFreelistingsprogramCheckoutsettingsGet =
             '[Content'FullControl]
