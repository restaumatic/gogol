                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] RequestReviewFreeListingsRequest Core.:>
                             Core.Post '[Core.JSON] ()
...
newContentFreelistingsprogramRequestreview merchantId payload
  = ContentFreelistingsprogramRequestreview{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            merchantId = merchantId, payload = payload,
                                            uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ContentFreelistingsprogramRequestreview
         where
