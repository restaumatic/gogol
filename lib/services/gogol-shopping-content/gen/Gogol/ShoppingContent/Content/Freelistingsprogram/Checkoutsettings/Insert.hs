                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] InsertCheckoutSettingsRequest Core.:>
                             Core.Post '[Core.JSON] CheckoutSettings
...
newContentFreelistingsprogramCheckoutsettingsInsert 
    ...
    -> ContentFreelistingsprogramCheckoutsettingsInsert
newContentFreelistingsprogramCheckoutsettingsInsert merchantId
  payload
  = ContentFreelistingsprogramCheckoutsettingsInsert{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           ContentFreelistingsprogramCheckoutsettingsInsert
         where
        type Rs ContentFreelistingsprogramCheckoutsettingsInsert =
             CheckoutSettings
        type Scopes ContentFreelistingsprogramCheckoutsettingsInsert =
             '[Content'FullControl]
