                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] ProductsCustomBatchRequest Core.:>
                           Core.Post '[Core.JSON] ProductsCustomBatchResponse
...
newContentProductsCustombatch payload
  = ContentProductsCustombatch{xgafv = Core.Nothing,
                               accessToken = Core.Nothing, callback = Core.Nothing,
                               payload = payload, uploadType = Core.Nothing,
                               uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ContentProductsCustombatch where
        type Rs ContentProductsCustombatch = ProductsCustomBatchResponse
        type Scopes ContentProductsCustombatch = '[Content'FullControl]
        requestClient ContentProductsCustombatch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ContentProductsCustombatchResource)
                      Core.mempty
