...
newContentProductsInsert merchantId payload
  = ContentProductsInsert{xgafv = Core.Nothing,
                          accessToken = Core.Nothing, callback = Core.Nothing,
                          feedId = Core.Nothing, merchantId = merchantId, payload = payload,
...
instance Core.GoogleRequest ContentProductsInsert where
        ...
        type Scopes ContentProductsInsert = '[Content'FullControl]
        requestClient ContentProductsInsert{..}
          = go merchantId xgafv accessToken callback feedId uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ContentProductsInsertResource)
                      Core.mempty
