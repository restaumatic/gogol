...
newContentProductsDelete merchantId productId
  = ContentProductsDelete{xgafv = Core.Nothing,
                          accessToken = Core.Nothing, callback = Core.Nothing,
                          feedId = Core.Nothing, merchantId = merchantId,
                          productId = productId, uploadType = Core.Nothing,
                          uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ContentProductsDelete where
        type Rs ContentProductsDelete = ()
        type Scopes ContentProductsDelete = '[Content'FullControl]
        requestClient ContentProductsDelete{..}
          = go merchantId productId xgafv accessToken callback feedId
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ContentProductsDeleteResource)
                      Core.mempty
