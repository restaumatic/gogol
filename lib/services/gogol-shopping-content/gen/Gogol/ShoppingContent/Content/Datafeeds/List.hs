...
-- |
-- Module      : Gogol.ShoppingContent.Content.Datafeeds.List
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] DatafeedsListResponse
...
newContentDatafeedsList merchantId
  = ContentDatafeedsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ContentDatafeedsList where
        ...
        type Scopes ContentDatafeedsList = '[Content'FullControl]
        requestClient ContentDatafeedsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ContentDatafeedsListResource)
                      Core.mempty
