                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] DatafeedsCustomBatchRequest Core.:>
...
newContentDatafeedsCustombatch payload
  = ContentDatafeedsCustombatch{xgafv = Core.Nothing,
                                accessToken = Core.Nothing, callback = Core.Nothing,
                                payload = payload, uploadType = Core.Nothing,
                                uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ContentDatafeedsCustombatch where
        type Rs ContentDatafeedsCustombatch = DatafeedsCustomBatchResponse
        type Scopes ContentDatafeedsCustombatch = '[Content'FullControl]
        requestClient ContentDatafeedsCustombatch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ContentDatafeedsCustombatchResource)
                      Core.mempty
