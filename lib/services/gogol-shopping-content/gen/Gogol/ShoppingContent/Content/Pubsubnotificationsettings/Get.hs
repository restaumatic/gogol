...
newContentPubsubnotificationsettingsGet merchantId
  = ContentPubsubnotificationsettingsGet{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         merchantId = merchantId, uploadType = Core.Nothing,
                                         uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ContentPubsubnotificationsettingsGet
         where
        type Rs ContentPubsubnotificationsettingsGet =
             PubsubNotificationSettings
        type Scopes ContentPubsubnotificationsettingsGet =
             '[Content'FullControl]
        requestClient ContentPubsubnotificationsettingsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ContentPubsubnotificationsettingsGetResource)
                      Core.mempty
