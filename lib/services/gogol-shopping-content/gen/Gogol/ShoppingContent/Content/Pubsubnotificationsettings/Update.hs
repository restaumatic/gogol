                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] PubsubNotificationSettings Core.:>
                           Core.Put '[Core.JSON] PubsubNotificationSettings
...
newContentPubsubnotificationsettingsUpdate merchantId payload
  = ContentPubsubnotificationsettingsUpdate{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            merchantId = merchantId, payload = payload,
                                            uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ContentPubsubnotificationsettingsUpdate
         where
        type Rs ContentPubsubnotificationsettingsUpdate =
             PubsubNotificationSettings
        type Scopes ContentPubsubnotificationsettingsUpdate =
             '[Content'FullControl]
        requestClient ContentPubsubnotificationsettingsUpdate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ContentPubsubnotificationsettingsUpdateResource)
                      Core.mempty
