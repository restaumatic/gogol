                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] ReturnPolicyOnline
...
newContentReturnpolicyonlineGet merchantId returnPolicyId
  = ContentReturnpolicyonlineGet{xgafv = Core.Nothing,
                                 accessToken = Core.Nothing, callback = Core.Nothing,
                                 merchantId = merchantId, returnPolicyId = returnPolicyId,
                                 uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ContentReturnpolicyonlineGet where
        type Rs ContentReturnpolicyonlineGet = ReturnPolicyOnline
        type Scopes ContentReturnpolicyonlineGet = '[Content'FullControl]
        requestClient ContentReturnpolicyonlineGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ContentReturnpolicyonlineGetResource)
                      Core.mempty
