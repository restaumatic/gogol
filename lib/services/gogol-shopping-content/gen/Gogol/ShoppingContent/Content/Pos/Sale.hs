                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] PosSaleRequest Core.:>
                               Core.Post '[Core.JSON] PosSaleResponse
...
newContentPosSale merchantId payload targetMerchantId
  = ContentPosSale{xgafv = Core.Nothing, accessToken = Core.Nothing,
                   callback = Core.Nothing, merchantId = merchantId,
                   payload = payload, targetMerchantId = targetMerchantId,
