...
newContentReturnaddressList merchantId
  = ContentReturnaddressList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ContentReturnaddressList where
        type Rs ContentReturnaddressList = ReturnaddressListResponse
        type Scopes ContentReturnaddressList = '[Content'FullControl]
        requestClient ContentReturnaddressList{..}
          = go merchantId xgafv accessToken callback country maxResults
              pageToken
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ContentReturnaddressListResource)
                      Core.mempty
