                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] ReturnaddressCustomBatchRequest Core.:>
                           Core.Post '[Core.JSON] ReturnaddressCustomBatchResponse
...
newContentReturnaddressCustombatch payload
  = ContentReturnaddressCustombatch{xgafv = Core.Nothing,
