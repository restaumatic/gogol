                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] AccounttaxListResponse
...
newContentAccounttaxList merchantId
  = ContentAccounttaxList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ContentAccounttaxList where
        type Rs ContentAccounttaxList = AccounttaxListResponse
        type Scopes ContentAccounttaxList = '[Content'FullControl]
        requestClient ContentAccounttaxList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ContentAccounttaxListResource)
                      Core.mempty
