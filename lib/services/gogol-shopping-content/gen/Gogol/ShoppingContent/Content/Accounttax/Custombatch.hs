                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] AccounttaxCustomBatchRequest Core.:>
                           Core.Post '[Core.JSON] AccounttaxCustomBatchResponse
...
newContentAccounttaxCustombatch payload
  = ContentAccounttaxCustombatch{xgafv = Core.Nothing,
                                 accessToken = Core.Nothing, callback = Core.Nothing,
                                 payload = payload, uploadType = Core.Nothing,
                                 uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ContentAccounttaxCustombatch where
        type Rs ContentAccounttaxCustombatch =
             AccounttaxCustomBatchResponse
        type Scopes ContentAccounttaxCustombatch = '[Content'FullControl]
        requestClient ContentAccounttaxCustombatch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ContentAccounttaxCustombatchResource)
                      Core.mempty
