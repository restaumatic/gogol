         ...
         Core.Capture "merchantId" Core.Word64 Core.:>
           "liasettings" Core.:>
             Core.Capture "accountId" Core.Word64 Core.:>
               "setinventoryverificationcontact" Core.:>
                 Core.QueryParam "country" Core.Text Core.:>
                   Core.QueryParam "language" Core.Text Core.:>
                     Core.QueryParam "contactName" Core.Text Core.:>
                       Core.QueryParam "contactEmail" Core.Text Core.:>
...
newContentLiasettingsSetinventoryverificationcontact 
    ...
    -> ContentLiasettingsSetinventoryverificationcontact
newContentLiasettingsSetinventoryverificationcontact accountId
  contactEmail contactName country language merchantId
  = ContentLiasettingsSetinventoryverificationcontact{xgafv =
                                                        Core.Nothing,
                                                      ...
                                                      language = language, merchantId = merchantId,
                                                      uploadType = Core.Nothing,
                                                      uploadProtocol = Core.Nothing}
instance Core.GoogleRequest
           ContentLiasettingsSetinventoryverificationcontact
         where
        type Rs ContentLiasettingsSetinventoryverificationcontact =
             LiasettingsSetInventoryVerificationContactResponse
        type Scopes ContentLiasettingsSetinventoryverificationcontact =
             '[Content'FullControl]
        requestClient ContentLiasettingsSetinventoryverificationcontact{..}
          = go merchantId accountId (Core.Just country) (Core.Just language)
