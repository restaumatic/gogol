                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] LiasettingsGetAccessibleGmbAccountsResponse
...
newContentLiasettingsGetaccessiblegmbaccounts accountId merchantId
  = ContentLiasettingsGetaccessiblegmbaccounts{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           ContentLiasettingsGetaccessiblegmbaccounts
         where
        type Rs ContentLiasettingsGetaccessiblegmbaccounts =
             LiasettingsGetAccessibleGmbAccountsResponse
        type Scopes ContentLiasettingsGetaccessiblegmbaccounts =
             '[Content'FullControl]
        requestClient ContentLiasettingsGetaccessiblegmbaccounts{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ContentLiasettingsGetaccessiblegmbaccountsResource)
                      Core.mempty
