...
newContentLiasettingsRequestinventoryverification 
    ...
    -> ContentLiasettingsRequestinventoryverification
newContentLiasettingsRequestinventoryverification accountId country
  merchantId
  = ContentLiasettingsRequestinventoryverification{xgafv =
                                                     Core.Nothing,
                                                   accessToken = Core.Nothing,
                                                   accountId = accountId, callback = Core.Nothing,
                                                   country = country, merchantId = merchantId,
                                                   uploadType = Core.Nothing,
                                                   uploadProtocol = Core.Nothing}
instance Core.GoogleRequest
           ContentLiasettingsRequestinventoryverification
         where
        type Rs ContentLiasettingsRequestinventoryverification =
             LiasettingsRequestInventoryVerificationResponse
        type Scopes ContentLiasettingsRequestinventoryverification =
             '[Content'FullControl]
        requestClient ContentLiasettingsRequestinventoryverification{..}
          = go merchantId accountId country xgafv accessToken callback
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ContentLiasettingsRequestinventoryverificationResource)
                      Core.mempty
