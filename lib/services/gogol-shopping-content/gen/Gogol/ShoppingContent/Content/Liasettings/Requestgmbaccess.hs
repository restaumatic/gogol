                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Post '[Core.JSON] LiasettingsRequestGmbAccessResponse
...
newContentLiasettingsRequestgmbaccess accountId gmbEmail merchantId
  = ContentLiasettingsRequestgmbaccess{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, accountId = accountId,
                                       callback = Core.Nothing, gmbEmail = gmbEmail,
                                       merchantId = merchantId, uploadType = Core.Nothing,
                                       uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ContentLiasettingsRequestgmbaccess
         where
        ...
        requestClient ContentLiasettingsRequestgmbaccess{..}
          = go merchantId accountId (Core.Just gmbEmail) xgafv accessToken
              callback
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ContentLiasettingsRequestgmbaccessResource)
                      Core.mempty
