                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.Get '[Core.JSON] LiasettingsListPosDataProvidersResponse
...
newContentLiasettingsListposdataproviders 
    :: 
                                          ContentLiasettingsListposdataproviders
newContentLiasettingsListposdataproviders
  = ContentLiasettingsListposdataproviders{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ContentLiasettingsListposdataproviders
         where
        type Rs ContentLiasettingsListposdataproviders =
             LiasettingsListPosDataProvidersResponse
        type Scopes ContentLiasettingsListposdataproviders =
             '[Content'FullControl]
