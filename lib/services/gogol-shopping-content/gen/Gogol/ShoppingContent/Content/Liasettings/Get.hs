                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] LiaSettings
...
newContentLiasettingsGet accountId merchantId
  = ContentLiasettingsGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ContentLiasettingsGet where
        ...
        type Scopes ContentLiasettingsGet = '[Content'FullControl]
        requestClient ContentLiasettingsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ContentLiasettingsGetResource)
                      Core.mempty
