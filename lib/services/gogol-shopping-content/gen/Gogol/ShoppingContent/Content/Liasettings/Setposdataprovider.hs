...
-- |
-- Module      : Gogol.ShoppingContent.Content.Liasettings.Setposdataprovider
         ...
         Core.Capture "merchantId" Core.Word64 Core.:>
           "liasettings" Core.:>
             Core.Capture "accountId" Core.Word64 Core.:>
               "setposdataprovider" Core.:>
                 Core.QueryParam "country" Core.Text Core.:>
                   Core.QueryParam "$.xgafv" Xgafv Core.:>
                     Core.QueryParam "access_token" Core.Text Core.:>
                       Core.QueryParam "callback" Core.Text Core.:>
                         Core.QueryParam "posDataProviderId" Core.Word64 Core.:>
                           Core.QueryParam "posExternalAccountId" Core.Text Core.:>
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.Post '[Core.JSON] LiasettingsSetPosDataProviderResponse
...
newContentLiasettingsSetposdataprovider 
    ...
    -> ContentLiasettingsSetposdataprovider
newContentLiasettingsSetposdataprovider accountId country
  merchantId
  = ContentLiasettingsSetposdataprovider{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, accountId = accountId,
                                         callback = Core.Nothing, country = country,
                                         merchantId = merchantId, posDataProviderId = Core.Nothing,
                                         posExternalAccountId = Core.Nothing,
                                         uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ContentLiasettingsSetposdataprovider
         where
        type Rs ContentLiasettingsSetposdataprovider =
             LiasettingsSetPosDataProviderResponse
        type Scopes ContentLiasettingsSetposdataprovider =
             '[Content'FullControl]
        requestClient ContentLiasettingsSetposdataprovider{..}
          = go merchantId accountId (Core.Just country) xgafv accessToken
              callback
              posDataProviderId
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ContentLiasettingsSetposdataproviderResource)
                      Core.mempty
