         ...
         Core.Capture "merchantId" Core.Word64 Core.:>
           "liasettings" Core.:>
             Core.Capture "accountId" Core.Word64 Core.:>
               "setomnichannelexperience" Core.:>
                 Core.QueryParam "$.xgafv" Xgafv Core.:>
                   Core.QueryParam "access_token" Core.Text Core.:>
                     Core.QueryParam "callback" Core.Text Core.:>
                       Core.QueryParam "country" Core.Text Core.:>
                         Core.QueryParam "lsfType" Core.Text Core.:>
                           Core.QueryParams "pickupTypes" Core.Text Core.:>
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.Post '[Core.JSON] LiaOmnichannelExperience
...
newContentLiasettingsSetomnichannelexperience accountId merchantId
  = ContentLiasettingsSetomnichannelexperience{xgafv = Core.Nothing,
                                               accessToken = Core.Nothing, accountId = accountId,
                                               callback = Core.Nothing, country = Core.Nothing,
                                               lsfType = Core.Nothing, merchantId = merchantId,
...
instance Core.GoogleRequest
           ContentLiasettingsSetomnichannelexperience
         where
        type Rs ContentLiasettingsSetomnichannelexperience =
             LiaOmnichannelExperience
        type Scopes ContentLiasettingsSetomnichannelexperience =
             '[Content'FullControl]
        requestClient ContentLiasettingsSetomnichannelexperience{..}
          = go merchantId accountId xgafv accessToken callback country
              lsfType
