                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] CollectionStatus
...
newContentCollectionstatusesGet collectionId merchantId
  = ContentCollectionstatusesGet{xgafv = Core.Nothing,
                                 accessToken = Core.Nothing, callback = Core.Nothing,
                                 collectionId = collectionId, merchantId = merchantId,
...
instance Core.GoogleRequest ContentCollectionstatusesGet where
        ...
        requestClient ContentCollectionstatusesGet{..}
          = go merchantId collectionId xgafv accessToken callback uploadType
              uploadProtocol
