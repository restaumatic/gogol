                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] AccountstatusesCustomBatchRequest Core.:>
                           Core.Post '[Core.JSON] AccountstatusesCustomBatchResponse
...
newContentAccountstatusesCustombatch payload
  = ContentAccountstatusesCustombatch{xgafv = Core.Nothing,
                                      accessToken = Core.Nothing, callback = Core.Nothing,
                                      payload = payload, uploadType = Core.Nothing,
                                      uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ContentAccountstatusesCustombatch where
        type Rs ContentAccountstatusesCustombatch =
             AccountstatusesCustomBatchResponse
        type Scopes ContentAccountstatusesCustombatch =
             '[Content'FullControl]
