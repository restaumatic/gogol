                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] LocalinventoryCustomBatchRequest Core.:>
                           Core.Post '[Core.JSON] LocalinventoryCustomBatchResponse
...
newContentLocalinventoryCustombatch payload
  = ContentLocalinventoryCustombatch{xgafv = Core.Nothing,
                                     accessToken = Core.Nothing, callback = Core.Nothing,
                                     payload = payload, uploadType = Core.Nothing,
                                     uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ContentLocalinventoryCustombatch where
        type Rs ContentLocalinventoryCustombatch =
             LocalinventoryCustomBatchResponse
        type Scopes ContentLocalinventoryCustombatch =
             '[Content'FullControl]
