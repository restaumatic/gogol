                           ...
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.Get '[Core.JSON] ListPromotionResponse
...
newContentPromotionsList merchantId
  = ContentPromotionsList{xgafv = Core.Nothing,
                          accessToken = Core.Nothing, callback = Core.Nothing,
                          countryCode = Core.Nothing, languageCode = Core.Nothing,
...
instance Core.GoogleRequest ContentPromotionsList where
        ...
        requestClient ContentPromotionsList{..}
          = go merchantId xgafv accessToken callback countryCode languageCode
              pageSize
              pageToken
              uploadType
              uploadProtocol
