                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] AccountsLinkRequest Core.:>
...
newContentAccountsLink accountId merchantId payload
  = ContentAccountsLink{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ContentAccountsLink where
        ...
        type Scopes ContentAccountsLink = '[Content'FullControl]
        requestClient ContentAccountsLink{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ContentAccountsLinkResource)
                      Core.mempty
