                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] AccountLabel Core.:>
                             Core.Post '[Core.JSON] AccountLabel
...
newContentAccountsLabelsCreate accountId payload
  = ContentAccountsLabelsCreate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ContentAccountsLabelsCreate where
        type Rs ContentAccountsLabelsCreate = AccountLabel
        type Scopes ContentAccountsLabelsCreate = '[Content'FullControl]
        requestClient ContentAccountsLabelsCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ContentAccountsLabelsCreateResource)
                      Core.mempty
