                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.Get '[Core.JSON] AccountsAuthInfoResponse
...
newContentAccountsAuthinfo 
    ::  ContentAccountsAuthinfo
newContentAccountsAuthinfo
  = ContentAccountsAuthinfo{xgafv = Core.Nothing,
                            accessToken = Core.Nothing, callback = Core.Nothing,
                            uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ContentAccountsAuthinfo where
        type Rs ContentAccountsAuthinfo = AccountsAuthInfoResponse
        type Scopes ContentAccountsAuthinfo = '[Content'FullControl]
        requestClient ContentAccountsAuthinfo{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ContentAccountsAuthinfoResource)
                      Core.mempty
