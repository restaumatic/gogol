                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] AccountReturnCarrier Core.:>
...
newContentAccountsReturncarrierPatch 
    ...
    -> ContentAccountsReturncarrierPatch
newContentAccountsReturncarrierPatch accountId carrierAccountId
  payload
  = ContentAccountsReturncarrierPatch{xgafv = Core.Nothing,
                                      accessToken = Core.Nothing, accountId = accountId,
                                      callback = Core.Nothing, carrierAccountId = carrierAccountId,
                                      payload = payload, uploadType = Core.Nothing,
                                      uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ContentAccountsReturncarrierPatch where
        type Rs ContentAccountsReturncarrierPatch = AccountReturnCarrier
        type Scopes ContentAccountsReturncarrierPatch =
             '[Content'FullControl]
        requestClient ContentAccountsReturncarrierPatch{..}
          = go accountId carrierAccountId xgafv accessToken callback
              uploadType
              uploadProtocol
