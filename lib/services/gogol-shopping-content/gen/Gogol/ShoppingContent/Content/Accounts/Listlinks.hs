...
newContentAccountsListlinks accountId merchantId
  = ContentAccountsListlinks{xgafv = Core.Nothing,
                             accessToken = Core.Nothing, accountId = accountId,
                             callback = Core.Nothing, maxResults = Core.Nothing,
                             merchantId = merchantId, pageToken = Core.Nothing,
                             uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ContentAccountsListlinks where
        type Rs ContentAccountsListlinks = AccountsListLinksResponse
        type Scopes ContentAccountsListlinks = '[Content'FullControl]
        requestClient ContentAccountsListlinks{..}
          = go merchantId accountId xgafv accessToken callback maxResults
              pageToken
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ContentAccountsListlinksResource)
                      Core.mempty
