                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] ListAccountReturnCarrierResponse
...
newContentAccountsReturncarrierList accountId
  = ContentAccountsReturncarrierList{xgafv = Core.Nothing,
                                     accessToken = Core.Nothing, accountId = accountId,
                                     callback = Core.Nothing, uploadType = Core.Nothing,
                                     uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ContentAccountsReturncarrierList where
        type Rs ContentAccountsReturncarrierList =
             ListAccountReturnCarrierResponse
        type Scopes ContentAccountsReturncarrierList =
             '[Content'FullControl]
        requestClient ContentAccountsReturncarrierList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ContentAccountsReturncarrierListResource)
                      Core.mempty
