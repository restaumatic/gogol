                       ...
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] AccountReturnCarrier Core.:>
                             Core.Post '[Core.JSON] AccountReturnCarrier
...
newContentAccountsReturncarrierCreate accountId payload
  = ContentAccountsReturncarrierCreate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ContentAccountsReturncarrierCreate
         where
