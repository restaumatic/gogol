...
newContentAccountsReturncarrierDelete accountId carrierAccountId
  = ContentAccountsReturncarrierDelete{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ContentAccountsReturncarrierDelete
         where
        ...
        requestClient ContentAccountsReturncarrierDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ContentAccountsReturncarrierDeleteResource)
                      Core.mempty
