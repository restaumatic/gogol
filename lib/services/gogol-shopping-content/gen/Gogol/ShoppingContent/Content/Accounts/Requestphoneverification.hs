                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] RequestPhoneVerificationRequest Core.:>
                               Core.Post '[Core.JSON] RequestPhoneVerificationResponse
...
newContentAccountsRequestphoneverification 
    ...
    -> ContentAccountsRequestphoneverification
newContentAccountsRequestphoneverification accountId merchantId
  payload
  = ContentAccountsRequestphoneverification{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, accountId = accountId,
                                            callback = Core.Nothing, merchantId = merchantId,
                                            payload = payload, uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ContentAccountsRequestphoneverification
         where
        type Rs ContentAccountsRequestphoneverification =
             RequestPhoneVerificationResponse
        type Scopes ContentAccountsRequestphoneverification =
             '[Content'FullControl]
        requestClient ContentAccountsRequestphoneverification{..}
          = go merchantId accountId xgafv accessToken callback uploadType
              uploadProtocol
