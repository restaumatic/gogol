                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] VerifyPhoneNumberRequest Core.:>
                               Core.Post '[Core.JSON] VerifyPhoneNumberResponse
...
newContentAccountsVerifyphonenumber accountId merchantId payload
  = ContentAccountsVerifyphonenumber{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ContentAccountsVerifyphonenumber where
        type Rs ContentAccountsVerifyphonenumber =
             VerifyPhoneNumberResponse
        type Scopes ContentAccountsVerifyphonenumber =
             '[Content'FullControl]
        requestClient ContentAccountsVerifyphonenumber{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ContentAccountsVerifyphonenumberResource)
                      Core.mempty
