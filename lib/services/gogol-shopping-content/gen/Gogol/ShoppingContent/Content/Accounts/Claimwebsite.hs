                 ...
                 Core.QueryParam "$.xgafv" Xgafv Core.:>
                   Core.QueryParam "access_token" Core.Text Core.:>
                     Core.QueryParam "callback" Core.Text Core.:>
                       Core.QueryParam "overwrite" Core.Bool Core.:>
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Post '[Core.JSON] AccountsClaimWebsiteResponse
...
newContentAccountsClaimwebsite accountId merchantId
  = ContentAccountsClaimwebsite{xgafv = Core.Nothing,
                                accessToken = Core.Nothing, accountId = accountId,
                                callback = Core.Nothing, merchantId = merchantId,
                                overwrite = Core.Nothing, uploadType = Core.Nothing,
...
instance Core.GoogleRequest ContentAccountsClaimwebsite where
        ...
        requestClient ContentAccountsClaimwebsite{..}
          = go merchantId accountId xgafv accessToken callback overwrite
              uploadType
              uploadProtocol
