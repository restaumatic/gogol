                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] ProductDeliveryTime Core.:>
                           Core.Post '[Core.JSON] ProductDeliveryTime
...
newContentProductdeliverytimeCreate merchantId payload
  = ContentProductdeliverytimeCreate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ContentProductdeliverytimeCreate where
        ...
        type Scopes ContentProductdeliverytimeCreate =
             '[Content'FullControl]
