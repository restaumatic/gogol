...
newContentProductdeliverytimeDelete merchantId productId
  = ContentProductdeliverytimeDelete{xgafv = Core.Nothing,
                                     accessToken = Core.Nothing, callback = Core.Nothing,
                                     merchantId = merchantId, productId = productId,
                                     uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ContentProductdeliverytimeDelete where
        ...
        requestClient ContentProductdeliverytimeDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ContentProductdeliverytimeDeleteResource)
                      Core.mempty
