             ...
             Core.QueryParam "$.xgafv" Xgafv Core.:>
               Core.QueryParam "access_token" Core.Text Core.:>
                 Core.QueryParam "callback" Core.Text Core.:>
                   Core.QueryParam "regionId" Core.Text Core.:>
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] Region Core.:>
                             Core.Post '[Core.JSON] Region
...
newContentRegionsCreate merchantId payload
  = ContentRegionsCreate{xgafv = Core.Nothing,
                         accessToken = Core.Nothing, callback = Core.Nothing,
                         merchantId = merchantId, payload = payload,
                         regionId = Core.Nothing, uploadType = Core.Nothing,
                         uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ContentRegionsCreate where
        type Rs ContentRegionsCreate = Region
        type Scopes ContentRegionsCreate = '[Content'FullControl]
        requestClient ContentRegionsCreate{..}
          = go merchantId xgafv accessToken callback regionId uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ContentRegionsCreateResource)
                      Core.mempty
