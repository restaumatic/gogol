...
newContentRegionsPatch merchantId payload regionId
  = ContentRegionsPatch{xgafv = Core.Nothing,
                        accessToken = Core.Nothing, callback = Core.Nothing,
                        merchantId = merchantId, payload = payload, regionId = regionId,
...
instance Core.GoogleRequest ContentRegionsPatch where
        ...
        requestClient ContentRegionsPatch{..}
          = go merchantId regionId xgafv accessToken callback updateMask
              uploadType
              uploadProtocol
