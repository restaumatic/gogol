                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.ReqBody '[Core.JSON] RenderAccountIssuesRequestPayload Core.:>
                                 Core.Post '[Core.JSON] RenderAccountIssuesResponse
...
newContentMerchantsupportRenderaccountissues merchantId payload
  = ContentMerchantsupportRenderaccountissues{xgafv = Core.Nothing,
                                              accessToken = Core.Nothing, callback = Core.Nothing,
                                              languageCode = Core.Nothing, merchantId = merchantId,
                                              payload = payload, timeZone = Core.Nothing,
                                              uploadType = Core.Nothing,
                                              uploadProtocol = Core.Nothing}
instance Core.GoogleRequest
           ContentMerchantsupportRenderaccountissues
         where
        type Rs ContentMerchantsupportRenderaccountissues =
             RenderAccountIssuesResponse
        type Scopes ContentMerchantsupportRenderaccountissues =
             '[Content'FullControl]
        requestClient ContentMerchantsupportRenderaccountissues{..}
          = go merchantId xgafv accessToken callback languageCode timeZone
              uploadType
              uploadProtocol
