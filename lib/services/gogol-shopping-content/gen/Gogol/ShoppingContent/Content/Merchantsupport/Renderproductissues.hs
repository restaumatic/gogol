                           ...
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.ReqBody '[Core.JSON] RenderProductIssuesRequestPayload Core.:>
                                   Core.Post '[Core.JSON] RenderProductIssuesResponse
...
newContentMerchantsupportRenderproductissues 
    ...
    -> ContentMerchantsupportRenderproductissues
newContentMerchantsupportRenderproductissues merchantId payload
  productId
  = ContentMerchantsupportRenderproductissues{xgafv = Core.Nothing,
                                              accessToken = Core.Nothing, callback = Core.Nothing,
                                              languageCode = Core.Nothing, merchantId = merchantId,
                                              payload = payload, productId = productId,
                                              timeZone = Core.Nothing, uploadType = Core.Nothing,
                                              uploadProtocol = Core.Nothing}
instance Core.GoogleRequest
           ContentMerchantsupportRenderproductissues
         where
        type Rs ContentMerchantsupportRenderproductissues =
             RenderProductIssuesResponse
        type Scopes ContentMerchantsupportRenderproductissues =
             '[Content'FullControl]
        requestClient ContentMerchantsupportRenderproductissues{..}
          = go merchantId productId xgafv accessToken callback languageCode
              timeZone
              uploadType
              uploadProtocol
