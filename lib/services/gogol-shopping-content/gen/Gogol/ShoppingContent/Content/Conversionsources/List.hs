                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Get '[Core.JSON] ListConversionSourcesResponse
...
newContentConversionsourcesList merchantId
  = ContentConversionsourcesList{xgafv = Core.Nothing,
                                 accessToken = Core.Nothing, callback = Core.Nothing,
                                 merchantId = merchantId, pageSize = Core.Nothing,
                                 pageToken = Core.Nothing, showDeleted = Core.Nothing,
                                 uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ContentConversionsourcesList where
        type Rs ContentConversionsourcesList =
             ListConversionSourcesResponse
        type Scopes ContentConversionsourcesList = '[Content'FullControl]
        requestClient ContentConversionsourcesList{..}
          = go merchantId xgafv accessToken callback pageSize pageToken
              showDeleted
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ContentConversionsourcesListResource)
                      Core.mempty
