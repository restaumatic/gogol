       ...
       "v2.1" Core.:>
         Core.Capture "merchantId" Core.Int64 Core.:>
           "conversionsources" Core.:>
             Core.CaptureMode "conversionSourceId" "undelete" Core.Text Core.:>
                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] UndeleteConversionSourceRequest Core.:>
                             Core.Post '[Core.JSON] ()
...
newContentConversionsourcesUndelete 
    ...
    -> ContentConversionsourcesUndelete
newContentConversionsourcesUndelete conversionSourceId merchantId
  payload
  = ContentConversionsourcesUndelete{xgafv = Core.Nothing,
