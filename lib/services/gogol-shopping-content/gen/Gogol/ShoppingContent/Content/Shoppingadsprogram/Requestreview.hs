                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] RequestReviewShoppingAdsRequest Core.:>
                             Core.Post '[Core.JSON] ()
...
instance Core.GoogleRequest ContentShoppingadsprogramRequestreview
        ...
        requestClient ContentShoppingadsprogramRequestreview{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ContentShoppingadsprogramRequestreviewResource)
                      Core.mempty
