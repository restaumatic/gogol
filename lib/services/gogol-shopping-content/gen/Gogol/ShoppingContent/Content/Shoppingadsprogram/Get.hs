...
newContentShoppingadsprogramGet merchantId
  = ContentShoppingadsprogramGet{xgafv = Core.Nothing,
                                 accessToken = Core.Nothing, callback = Core.Nothing,
                                 merchantId = merchantId, uploadType = Core.Nothing,
                                 uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ContentShoppingadsprogramGet where
        type Rs ContentShoppingadsprogramGet = ShoppingAdsProgramStatus
        type Scopes ContentShoppingadsprogramGet = '[Content'FullControl]
        requestClient ContentShoppingadsprogramGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ContentShoppingadsprogramGetResource)
                      Core.mempty
