                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] ShippingsettingsListResponse
...
newContentShippingsettingsList merchantId
  = ContentShippingsettingsList{xgafv = Core.Nothing,
                                accessToken = Core.Nothing, callback = Core.Nothing,
                                maxResults = Core.Nothing, merchantId = merchantId,
                                pageToken = Core.Nothing, uploadType = Core.Nothing,
                                uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ContentShippingsettingsList where
        type Rs ContentShippingsettingsList = ShippingsettingsListResponse
        type Scopes ContentShippingsettingsList = '[Content'FullControl]
        requestClient ContentShippingsettingsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ContentShippingsettingsListResource)
                      Core.mempty
