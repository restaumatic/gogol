...
newContentShippingsettingsUpdate accountId merchantId payload
  = ContentShippingsettingsUpdate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ContentShippingsettingsUpdate where
        type Rs ContentShippingsettingsUpdate = ShippingSettings
        type Scopes ContentShippingsettingsUpdate = '[Content'FullControl]
        requestClient ContentShippingsettingsUpdate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ContentShippingsettingsUpdateResource)
                      Core.mempty
