                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.Get '[Core.JSON] ShippingsettingsGetSupportedCarriersResponse
...
newContentShippingsettingsGetsupportedcarriers merchantId
  = ContentShippingsettingsGetsupportedcarriers{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           ContentShippingsettingsGetsupportedcarriers
         where
        type Rs ContentShippingsettingsGetsupportedcarriers =
             ShippingsettingsGetSupportedCarriersResponse
        type Scopes ContentShippingsettingsGetsupportedcarriers =
             '[Content'FullControl]
