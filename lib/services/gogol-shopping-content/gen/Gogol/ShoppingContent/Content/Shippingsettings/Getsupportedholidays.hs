                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.Get '[Core.JSON] ShippingsettingsGetSupportedHolidaysResponse
...
newContentShippingsettingsGetsupportedholidays merchantId
  = ContentShippingsettingsGetsupportedholidays{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           ContentShippingsettingsGetsupportedholidays
         where
        type Rs ContentShippingsettingsGetsupportedholidays =
             ShippingsettingsGetSupportedHolidaysResponse
        type Scopes ContentShippingsettingsGetsupportedholidays =
             '[Content'FullControl]
