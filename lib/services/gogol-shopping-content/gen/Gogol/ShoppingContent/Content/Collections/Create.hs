                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] Collection Core.:>
                           Core.Post '[Core.JSON] Collection
...
newContentCollectionsCreate merchantId payload
  = ContentCollectionsCreate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ContentCollectionsCreate where
        ...
        type Scopes ContentCollectionsCreate = '[Content'FullControl]
        requestClient ContentCollectionsCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ContentCollectionsCreateResource)
                      Core.mempty
