                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] ListCssesResponse
...
newContentCssesList cssGroupId
  = ContentCssesList{xgafv = Core.Nothing,
                     accessToken = Core.Nothing, callback = Core.Nothing,
                     cssGroupId = cssGroupId, pageSize = Core.Nothing,
...
instance Core.GoogleRequest ContentCssesList where
        ...
        requestClient ContentCssesList{..}
          = go cssGroupId xgafv accessToken callback pageSize pageToken
              uploadType
              uploadProtocol
