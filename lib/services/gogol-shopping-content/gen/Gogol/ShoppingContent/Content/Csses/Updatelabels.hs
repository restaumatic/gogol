...
newContentCssesUpdatelabels cssDomainId cssGroupId payload
  = ContentCssesUpdatelabels{xgafv = Core.Nothing,
                             accessToken = Core.Nothing, callback = Core.Nothing,
                             cssDomainId = cssDomainId, cssGroupId = cssGroupId,
...
instance Core.GoogleRequest ContentCssesUpdatelabels where
        ...
        type Scopes ContentCssesUpdatelabels = '[Content'FullControl]
        requestClient ContentCssesUpdatelabels{..}
          = go cssGroupId cssDomainId xgafv accessToken callback uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ContentCssesUpdatelabelsResource)
                      Core.mempty
