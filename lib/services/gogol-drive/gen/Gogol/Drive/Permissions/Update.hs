...
--
-- /See:/ <https://developers.google.com/workspace/drive/ Google Drive API Reference> for @drive.permissions.update@.
module Gogol.Drive.Permissions.Update
    (
    -- * Resource
                   ...
                   Core.QueryParam "access_token" Core.Text Core.:>
                     Core.QueryParam "callback" Core.Text Core.:>
                       Core.QueryParam "enforceExpansiveAccess" Core.Bool Core.:>
                         Core.QueryParam "removeExpiration" Core.Bool Core.:>
                                     ...
                                     Core.QueryParam "useDomainAdminAccess" Core.Bool Core.:>
                                       Core.QueryParam "alt" Core.AltJSON Core.:>
                                         Core.ReqBody '[Core.JSON] Permission Core.:>
                                           Core.Patch '[Core.JSON] Permission
...
newDrivePermissionsUpdate fileId payload permissionId
  = DrivePermissionsUpdate{xgafv = Core.Nothing,
                           accessToken = Core.Nothing, callback = Core.Nothing,
                           enforceExpansiveAccess = Core.False, fileId = fileId,
                           payload = payload, permissionId = permissionId,
                           removeExpiration = Core.False, supportsAllDrives = Core.False,
                           supportsTeamDrives = Core.False, transferOwnership = Core.False,
...
instance Core.GoogleRequest DrivePermissionsUpdate where
        ...
        type Scopes DrivePermissionsUpdate =
