...
--
-- /See:/ <https://developers.google.com/workspace/drive/ Google Drive API Reference> for @drive.permissions.delete@.
module Gogol.Drive.Permissions.Delete
    (
    -- * Resource
...
newDrivePermissionsDelete fileId permissionId
  = DrivePermissionsDelete{xgafv = Core.Nothing,
                           accessToken = Core.Nothing, callback = Core.Nothing,
                           enforceExpansiveAccess = Core.False, fileId = fileId,
                           permissionId = permissionId, supportsAllDrives = Core.False,
...
instance Core.GoogleRequest DrivePermissionsDelete where
        ...
        type Scopes DrivePermissionsDelete =
