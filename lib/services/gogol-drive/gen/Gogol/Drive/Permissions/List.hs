...
--
-- /See:/ <https://developers.google.com/workspace/drive/ Google Drive API Reference> for @drive.permissions.list@.
module Gogol.Drive.Permissions.List
    (
    -- * Resource
...
newDrivePermissionsList fileId
  = DrivePermissionsList{xgafv = Core.Nothing,
                         accessToken = Core.Nothing, callback = Core.Nothing,
                         fileId = fileId, includePermissionsForView = Core.Nothing,
...
instance Core.GoogleRequest DrivePermissionsList where
        ...
        type Scopes DrivePermissionsList =
             '[Drive'FullControl, Drive'File, Drive'Meet'Readonly,
               Drive'Metadata, Drive'Metadata'Readonly, Drive'Photos'Readonly,
               Drive'Readonly]
        requestClient DrivePermissionsList{..}
          = go fileId xgafv accessToken callback includePermissionsForView
              pageSize
              pageToken
