...
--
-- Gets a shared drive\'s metadata by ID. For more information, see <https://developers.google.com/workspace/drive/api/guides/manage-shareddrives Manage shared drives>.
--
