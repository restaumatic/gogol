...
--
-- Updates the metadata for a shared drive. For more information, see <https://developers.google.com/workspace/drive/api/guides/manage-shareddrives Manage shared drives>.
--
