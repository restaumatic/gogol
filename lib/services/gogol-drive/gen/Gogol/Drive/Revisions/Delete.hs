...
--
-- Permanently deletes a file version. You can only delete revisions for files with binary content in Google Drive, like images or videos. Revisions for other files, like Google Docs or Sheets, and the last remaining file version can\'t be deleted. For more information, see <https://developers.google.com/drive/api/guides/manage-revisions Manage file revisions>.
--
