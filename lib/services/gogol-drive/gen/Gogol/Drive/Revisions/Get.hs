...
--
-- Gets a revision\'s metadata or content by ID. For more information, see <https://developers.google.com/workspace/drive/api/guides/manage-revisions Manage file revisions>.
--
