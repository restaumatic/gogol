...
--
-- Updates a revision with patch semantics. For more information, see <https://developers.google.com/workspace/drive/api/guides/manage-revisions Manage file revisions>.
--
