...
--
-- Stops watching resources through this channel. For more information, see <https://developers.google.com/workspace/drive/api/guides/push Notifications for resource changes>.
--
-- /See:/ <https://developers.google.com/workspace/drive/ Google Drive API Reference> for @drive.channels.stop@.
module Gogol.Drive.Channels.Stop
    (
    -- * Resource
...
newDriveChannelsStop payload
  = DriveChannelsStop{xgafv = Core.Nothing,
