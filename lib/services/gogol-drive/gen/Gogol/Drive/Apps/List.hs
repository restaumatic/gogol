...
--
-- Lists a user\'s installed apps. For more information, see <https://developers.google.com/workspace/drive/api/guides/user-info Return user info>.
--
-- /See:/ <https://developers.google.com/workspace/drive/ Google Drive API Reference> for @drive.apps.list@.
module Gogol.Drive.Apps.List
    (
    -- * Resource
         ...
         "apps" Core.:>
           Core.QueryParam "$.xgafv" Xgafv Core.:>
             Core.QueryParam "access_token" Core.Text Core.:>
               Core.QueryParam "appFilterExtensions" Core.Text Core.:>
                 Core.QueryParam "appFilterMimeTypes" Core.Text Core.:>
                   Core.QueryParam "callback" Core.Text Core.:>
                     Core.QueryParam "languageCode" Core.Text Core.:>
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] AppList
...
newDriveAppsList 
    ::  DriveAppsList
newDriveAppsList
  = DriveAppsList{xgafv = Core.Nothing, accessToken = Core.Nothing,
                  appFilterExtensions = "", appFilterMimeTypes = "",
                  callback = Core.Nothing, languageCode = Core.Nothing,
...
instance Core.GoogleRequest DriveAppsList where
        ...
        requestClient DriveAppsList{..}
          = go xgafv accessToken (Core.Just appFilterExtensions)
              ...
              driveService
          where go
                  = Core.buildClient (Core.Proxy :: Core.Proxy DriveAppsListResource)
                      Core.mempty
