...
--
-- /See:/ <https://developers.google.com/workspace/drive/ Google Drive API Reference> for @drive.replies.create@.
module Gogol.Drive.Replies.Create
    (
    -- * Resource
...
newDriveRepliesCreate commentId fileId payload
  = DriveRepliesCreate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DriveRepliesCreate where
        ...
        type Scopes DriveRepliesCreate = '[Drive'FullControl, Drive'File]
