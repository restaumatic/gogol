...
--
-- /See:/ <https://developers.google.com/workspace/drive/ Google Drive API Reference> for @drive.replies.update@.
module Gogol.Drive.Replies.Update
    (
    -- * Resource
...
newDriveRepliesUpdate commentId fileId payload replyId
  = DriveRepliesUpdate{xgafv = Core.Nothing,
                       accessToken = Core.Nothing, callback = Core.Nothing,
                       commentId = commentId, fileId = fileId, payload = payload,
                       replyId = replyId, uploadType = Core.Nothing,
                       uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DriveRepliesUpdate where
        type Rs DriveRepliesUpdate = Reply
        type Scopes DriveRepliesUpdate = '[Drive'FullControl, Drive'File]
        requestClient DriveRepliesUpdate{..}
          = go fileId commentId replyId xgafv accessToken callback uploadType
              uploadProtocol
