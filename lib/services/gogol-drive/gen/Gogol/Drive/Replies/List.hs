...
--
-- /See:/ <https://developers.google.com/workspace/drive/ Google Drive API Reference> for @drive.replies.list@.
module Gogol.Drive.Replies.List
    (
    -- * Resource
...
newDriveRepliesList commentId fileId
  = DriveRepliesList{xgafv = Core.Nothing,
                     accessToken = Core.Nothing, callback = Core.Nothing,
                     commentId = commentId, fileId = fileId,
                     includeDeleted = Core.False, pageSize = 20,
