...
-- Deletes a reply.
--
-- /See:/ <https://developers.google.com/workspace/drive/ Google Drive API Reference> for @drive.replies.delete@.
module Gogol.Drive.Replies.Delete
    (
    -- * Resource
...
newDriveRepliesDelete commentId fileId replyId
  = DriveRepliesDelete{xgafv = Core.Nothing,
                       accessToken = Core.Nothing, callback = Core.Nothing,
                       commentId = commentId, fileId = fileId, replyId = replyId,
...
instance Core.GoogleRequest DriveRepliesDelete where
        ...
        type Scopes DriveRepliesDelete = '[Drive'FullControl, Drive'File]
