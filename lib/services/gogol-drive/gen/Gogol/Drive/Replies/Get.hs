...
-- Gets a reply by ID.
--
-- /See:/ <https://developers.google.com/workspace/drive/ Google Drive API Reference> for @drive.replies.get@.
module Gogol.Drive.Replies.Get
    (
    -- * Resource
...
newDriveRepliesGet commentId fileId replyId
  = DriveRepliesGet{xgafv = Core.Nothing, accessToken = Core.Nothing,
                    callback = Core.Nothing, commentId = commentId, fileId = fileId,
                    includeDeleted = Core.False, replyId = replyId,
...
instance Core.GoogleRequest DriveRepliesGet where
        ...
        requestClient DriveRepliesGet{..}
          = go fileId commentId replyId xgafv accessToken callback
