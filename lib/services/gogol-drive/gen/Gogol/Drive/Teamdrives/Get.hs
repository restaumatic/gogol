...
--
-- /See:/ <https://developers.google.com/workspace/drive/ Google Drive API Reference> for @drive.teamdrives.get@.
module Gogol.Drive.Teamdrives.Get
    (
    -- * Resource
...
newDriveTeamdrivesGet teamDriveId
  = DriveTeamdrivesGet{xgafv = Core.Nothing,
                       accessToken = Core.Nothing, callback = Core.Nothing,
                       teamDriveId = teamDriveId, uploadType = Core.Nothing,
...
instance Core.GoogleRequest DriveTeamdrivesGet where
        ...
        type Scopes DriveTeamdrivesGet =
             '[Drive'FullControl, Drive'Readonly]
        requestClient DriveTeamdrivesGet{..}
          = go teamDriveId xgafv accessToken callback uploadType
              uploadProtocol
