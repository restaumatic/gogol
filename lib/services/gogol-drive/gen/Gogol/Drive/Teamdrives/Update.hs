...
--
-- /See:/ <https://developers.google.com/workspace/drive/ Google Drive API Reference> for @drive.teamdrives.update@.
module Gogol.Drive.Teamdrives.Update
    (
    -- * Resource
                       ...
                       Core.QueryParam "useDomainAdminAccess" Core.Bool Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] TeamDrive Core.:>
                             Core.Patch '[Core.JSON] TeamDrive
...
newDriveTeamdrivesUpdate payload teamDriveId
  = DriveTeamdrivesUpdate{xgafv = Core.Nothing,
                          accessToken = Core.Nothing, callback = Core.Nothing,
                          payload = payload, teamDriveId = teamDriveId,
