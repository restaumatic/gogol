...
--
-- /See:/ <https://developers.google.com/workspace/drive/ Google Drive API Reference> for @drive.teamdrives.list@.
module Gogol.Drive.Teamdrives.List
    (
    -- * Resource
                         ...
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "useDomainAdminAccess" Core.Bool Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Get '[Core.JSON] TeamDriveList
...
newDriveTeamdrivesList 
    ::  DriveTeamdrivesList
newDriveTeamdrivesList
  = DriveTeamdrivesList{xgafv = Core.Nothing,
                        accessToken = Core.Nothing, callback = Core.Nothing, pageSize = 10,
                        pageToken = Core.Nothing, q = Core.Nothing,
...
instance Core.GoogleRequest DriveTeamdrivesList where
        ...
        type Scopes DriveTeamdrivesList =
