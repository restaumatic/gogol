...
--
-- Subscribes to changes for a user. For more information, see <https://developers.google.com/workspace/drive/api/guides/push Notifications for resource changes>.
--
-- /See:/ <https://developers.google.com/workspace/drive/ Google Drive API Reference> for @drive.changes.watch@.
module Gogol.Drive.Changes.Watch
    (
    -- * Resource
                 ...
                 Core.QueryParam "access_token" Core.Text Core.:>
                   Core.QueryParam "callback" Core.Text Core.:>
                     Core.QueryParam "driveId" Core.Text Core.:>
                       Core.QueryParam "includeCorpusRemovals" Core.Bool Core.:>
                               ...
                               Core.QueryParam "includeRemoved" Core.Bool Core.:>
                                 Core.QueryParam "includeTeamDriveItems" Core.Bool Core.:>
                                   Core.QueryParam "pageSize" Core.Int32 Core.:>
                                     Core.QueryParam "restrictToMyDrive" Core.Bool Core.:>
...
newDriveChangesWatch pageToken payload
  = DriveChangesWatch{xgafv = Core.Nothing,
                      accessToken = Core.Nothing, callback = Core.Nothing,
                      driveId = Core.Nothing, includeCorpusRemovals = Core.False,
                      includeItemsFromAllDrives = Core.False,
                      includeLabels = Core.Nothing,
                      includePermissionsForView = Core.Nothing,
                      includeRemoved = Core.True, includeTeamDriveItems = Core.False,
                      pageSize = 100, pageToken = pageToken, payload = payload,
                      restrictToMyDrive = Core.False, spaces = "drive",
                      supportsAllDrives = Core.False, supportsTeamDrives = Core.False,
                      teamDriveId = Core.Nothing, uploadType = Core.Nothing,
...
instance Core.GoogleRequest DriveChangesWatch where
        ...
        requestClient DriveChangesWatch{..}
          = go (Core.Just pageToken) xgafv accessToken callback driveId
