...
--
-- Lists the changes for a user or shared drive. For more information, see <https://developers.google.com/workspace/drive/api/guides/manage-changes Retrieve changes>.
--
-- /See:/ <https://developers.google.com/workspace/drive/ Google Drive API Reference> for @drive.changes.list@.
module Gogol.Drive.Changes.List
    (
    -- * Resource
...
newDriveChangesList pageToken
  = DriveChangesList{xgafv = Core.Nothing,
