...
--
-- Gets the starting pageToken for listing future changes. For more information, see <https://developers.google.com/workspace/drive/api/guides/manage-changes Retrieve changes>.
--
-- /See:/ <https://developers.google.com/workspace/drive/ Google Drive API Reference> for @drive.changes.getStartPageToken@.
module Gogol.Drive.Changes.GetStartPageToken
    (
    -- * Resource
...
newDriveChangesGetStartPageToken 
    ::  DriveChangesGetStartPageToken
newDriveChangesGetStartPageToken
  = DriveChangesGetStartPageToken{xgafv = Core.Nothing,
                                  accessToken = Core.Nothing, callback = Core.Nothing,
                                  driveId = Core.Nothing, supportsAllDrives = Core.False,
                                  supportsTeamDrives = Core.False, teamDriveId = Core.Nothing,
                                  uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DriveChangesGetStartPageToken where
        type Rs DriveChangesGetStartPageToken = StartPageToken
        ...
        requestClient DriveChangesGetStartPageToken{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy DriveChangesGetStartPageTokenResource)
                      Core.mempty
