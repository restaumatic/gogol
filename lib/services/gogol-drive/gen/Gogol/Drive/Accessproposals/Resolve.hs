...
--
-- Approves or denies an access proposal. For more information, see <https://developers.google.com/workspace/drive/api/guides/pending-access Manage pending access proposals>.
--
