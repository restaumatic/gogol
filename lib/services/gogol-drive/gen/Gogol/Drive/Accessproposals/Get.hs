...
--
-- Retrieves an access proposal by ID. For more information, see <https://developers.google.com/workspace/drive/api/guides/pending-access Manage pending access proposals>.
--
