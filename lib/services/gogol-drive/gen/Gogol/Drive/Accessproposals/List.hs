...
--
-- List the access proposals on a file. For more information, see <https://developers.google.com/workspace/drive/api/guides/pending-access Manage pending access proposals>. Note: Only approvers are able to list access proposals on a file. If the user isn\'t an approver, a 403 error is returned.
--
