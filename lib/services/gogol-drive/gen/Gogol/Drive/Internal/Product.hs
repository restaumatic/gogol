...
module Gogol.Drive.Internal.Product
  (
    ...
    DownloadRestrictionsMetadata (..),
    newDownloadRestrictionsMetadata,
...
data AccessProposal = AccessProposal
    ...
    , requesterEmailAddress :: (Core.Maybe Core.Text)
      -- | A wrapper for the role and view of an access proposal. For more information, see <https://developers.google.com/workspace/drive/api/guides/ref-roles Roles and permissions>.
...
--
-- /See:/ 'newDownloadRestrictionsMetadata' smart constructor.
data DownloadRestrictionsMetadata = DownloadRestrictionsMetadata
    {
      ...
      effectiveDownloadRestrictionWithContext :: (Core.Maybe DownloadRestriction)
    ...
    , itemDownloadRestriction :: (Core.Maybe DownloadRestriction)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'DownloadRestrictionsMetadata' with the minimum fields required to make a request.
newDownloadRestrictionsMetadata 
    ::  DownloadRestrictionsMetadata
newDownloadRestrictionsMetadata
  = DownloadRestrictionsMetadata{effectiveDownloadRestrictionWithContext
                                   = Core.Nothing,
                                 itemDownloadRestriction = Core.Nothing}
instance Core.FromJSON DownloadRestrictionsMetadata where
        parseJSON
          = Core.withObject "DownloadRestrictionsMetadata"
              (\ o ->
                 DownloadRestrictionsMetadata Core.<$>
                   (o Core..:? "effectiveDownloadRestrictionWithContext") Core.<*>
                     (o Core..:? "itemDownloadRestriction"))

instance Core.ToJSON DownloadRestrictionsMetadata where
        toJSON DownloadRestrictionsMetadata{..}
          = Core.object
              (Core.catMaybes
                 [("effectiveDownloadRestrictionWithContext" Core..=) Core.<$>
                    effectiveDownloadRestrictionWithContext,
                  ("itemDownloadRestriction" Core..=) Core.<$>
...
data Drive_Capabilities = Drive_Capabilities
    ...
    , canChangeDownloadRestriction :: (Core.Maybe Core.Bool)
...
newDrive_Capabilities
  = Drive_Capabilities{canAddChildren = Core.Nothing,
                       ...
                       canChangeDownloadRestriction = Core.Nothing,
              ...
              (\ o ->
                 Drive_Capabilities Core.<$>
                   (o Core..:? "canAddChildren") Core.<*>
                     ...
                     Core.<*> (o Core..:? "canChangeDownloadRestriction")
          ...
          = Core.object
              (Core.catMaybes
                 [("canAddChildren" Core..=) Core.<$> canAddChildren,
                  ...
                  ("canChangeDownloadRestriction" Core..=) Core.<$>
...
data File = File
    {
      ...
      -- | Output only. Capabilities the current user has on this file. Each capability corresponds to a fine-grained action that a user may take. For more information, see <https://developers.google.com/workspace/drive/api/guides/manage-sharing#capabilities Understand file capabilities>.
    ...
    , downloadRestrictions :: (Core.Maybe DownloadRestrictionsMetadata)
    ...
    , fileExtension :: (Core.Maybe Core.Text)
      -- | The color for a folder or a shortcut to a folder as an RGB hex string. The supported colors are published in the @folderColorPalette@ field of the </workspace/drive/api/reference/rest/v3/about about> resource. If an unsupported color is specified, the closest color in the palette is used instead.
    ...
    , md5Checksum :: (Core.Maybe Core.Text)
      -- | The MIME type of the file. Google Drive attempts to automatically detect an appropriate value from uploaded content, if no value is provided. The value cannot be changed unless a new revision is uploaded. If a file is created with a Google Doc MIME type, the uploaded content is imported, if possible. The supported import formats are published in the </workspace/drive/api/reference/rest/v3/about about> resource.
    , mimeType :: (Core.Maybe Core.Text)
...
newFile
  = File{appProperties = Core.Nothing, capabilities = Core.Nothing,
         ...
         downloadRestrictions = Core.Nothing, driveId = Core.Nothing,
         explicitlyTrashed = Core.Nothing, exportLinks = Core.Nothing,
         fileExtension = Core.Nothing, folderColorRgb = Core.Nothing,
              ...
              (\ o ->
                 File Core.<$>
                   (o Core..:? "appProperties") Core.<*> (o Core..:? "capabilities")
                     ...
                     Core.<*> (o Core..:? "downloadRestrictions")
                     Core.<*> (o Core..:? "driveId")
          ...
          = Core.object
              (Core.catMaybes
                 [("appProperties" Core..=) Core.<$> appProperties,
                  ...
                  ("downloadRestrictions" Core..=) Core.<$> downloadRestrictions,
                  ("driveId" Core..=) Core.<$> driveId,
...
data File_Capabilities = File_Capabilities
    ...
    , canChangeItemDownloadRestriction :: (Core.Maybe Core.Bool)
...
newFile_Capabilities
  = File_Capabilities{canAcceptOwnership = Core.Nothing,
                      ...
                      canChangeItemDownloadRestriction = Core.Nothing,
              ...
              (\ o ->
                 File_Capabilities Core.<$>
                   (o Core..:? "canAcceptOwnership") Core.<*>
                     ...
                     Core.<*> (o Core..:? "canChangeItemDownloadRestriction")
          ...
          = Core.object
              (Core.catMaybes
                 [("canAcceptOwnership" Core..=) Core.<$> canAcceptOwnership,
                  ...
                  ("canChangeItemDownloadRestriction" Core..=) Core.<$>
...
data File_ContentHints_Thumbnail = File_ContentHints_Thumbnail
    {
      -- | The thumbnail data encoded with URL-safe Base64 (<https://datatracker.ietf.org/doc/html/rfc4648#section-5 RFC 4648 section 5>).
...
data ResolveAccessProposalRequest = ResolveAccessProposalRequest
    {
      ...
      -- | Optional. The roles that the approver has allowed, if any. For more information, see <https://developers.google.com/workspace/drive/api/guides/ref-roles Roles and permissions>. Note: This field is required for the @ACCEPT@ action.
    , role' :: (Core.Maybe [Core.Text])
