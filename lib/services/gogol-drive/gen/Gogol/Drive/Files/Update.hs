...
--
-- Updates a file\'s metadata, content, or both. When calling this method, only populate fields in the request that you want to modify. When updating fields, some fields might be changed automatically, such as @modifiedDate@. This method supports patch semantics. This method supports an /\/upload/ URI and accepts uploaded media with the following characteristics: - /Maximum file size:/ 5,120 GB - /Accepted Media MIME types:/ @*\/*@ (Specify a valid MIME type, rather than the literal @*\/*@ value. The literal @*\/*@ is only used to indicate that any valid MIME type can be uploaded. For more information, see </workspace/drive/api/guides/mime-types Google Workspace and Google Drive supported MIME types>.) For more information on uploading files, see </workspace/drive/api/guides/manage-uploads Upload file data>.
--
