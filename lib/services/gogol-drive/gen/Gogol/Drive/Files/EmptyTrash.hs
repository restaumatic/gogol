...
--
-- Permanently deletes all of the user\'s trashed files. For more information, see <https://developers.google.com/workspace/drive/api/guides/delete Trash or delete files and folders>.
--
