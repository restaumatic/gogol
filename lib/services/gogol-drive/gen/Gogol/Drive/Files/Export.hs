...
--
-- Exports a Google Workspace document to the requested MIME type and returns exported byte content. For more information, see <https://developers.google.com/workspace/drive/api/guides/manage-downloads Download and export files>. Note that the exported content is limited to 10 MB.
--
...
data DriveFilesExport = DriveFilesExport
    ...
    , callback :: (Core.Maybe Core.Text)
      -- | The ID of the file.
    , fileId :: Core.Text
      -- | Required. The MIME type of the format requested for this export. For a list of supported MIME types, see </workspace/drive/api/guides/ref-export-formats Export MIME types for Google Workspace documents>.
    , mimeType :: Core.Text
...
newDriveFilesExport 
    ...
    -> Core.Text
       -- ^  Required. The MIME type of the format requested for this export. For a list of supported MIME types, see </workspace/drive/api/guides/ref-export-formats Export MIME types for Google Workspace documents>. See 'mimeType'.
    -> DriveFilesExport
