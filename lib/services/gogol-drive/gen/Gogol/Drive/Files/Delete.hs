...
--
-- Permanently deletes a file owned by the user without moving it to the trash. For more information, see <https://developers.google.com/workspace/drive/api/guides/delete Trash or delete files and folders>. If the file belongs to a shared drive, the user must be an @organizer@ on the parent folder. If the target is a folder, all descendants owned by the user are also deleted.
--
