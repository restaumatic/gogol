...
--
-- Gets a file\'s metadata or content by ID. For more information, see </workspace/drive/api/guides/search-files Search for files and folders>. If you provide the URL parameter @alt=media@, then the response includes the file contents in the response body. Downloading content with @alt=media@ only works if the file is stored in Drive. To download Google Docs, Sheets, and Slides use </workspace/drive/api/reference/rest/v3/files/export files.export> instead. For more information, see </workspace/drive/api/guides/manage-downloads Download and export files>.
--
