...
--
-- Gets a comment by ID. For more information, see <https://developers.google.com/workspace/drive/api/guides/manage-comments Manage comments and replies>. Required: The @fields@ parameter must be set. To return the exact fields you need, see <https://developers.google.com/workspace/drive/api/guides/fields-parameter Return specific fields>.
--
-- /See:/ <https://developers.google.com/workspace/drive/ Google Drive API Reference> for @drive.comments.get@.
module Gogol.Drive.Comments.Get
    (
    -- * Resource
...
newDriveCommentsGet commentId fileId
  = DriveCommentsGet{xgafv = Core.Nothing,
                     accessToken = Core.Nothing, callback = Core.Nothing,
                     commentId = commentId, fileId = fileId,
                     includeDeleted = Core.False, uploadType = Core.Nothing,
