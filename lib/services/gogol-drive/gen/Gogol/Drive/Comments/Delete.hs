...
--
-- Deletes a comment. For more information, see <https://developers.google.com/workspace/drive/api/guides/manage-comments Manage comments and replies>.
--
-- /See:/ <https://developers.google.com/workspace/drive/ Google Drive API Reference> for @drive.comments.delete@.
module Gogol.Drive.Comments.Delete
    (
    -- * Resource
...
newDriveCommentsDelete commentId fileId
  = DriveCommentsDelete{xgafv = Core.Nothing,
                        accessToken = Core.Nothing, callback = Core.Nothing,
                        commentId = commentId, fileId = fileId, uploadType = Core.Nothing,
