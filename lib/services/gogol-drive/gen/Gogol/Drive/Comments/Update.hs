...
--
-- Updates a comment with patch semantics. For more information, see <https://developers.google.com/workspace/drive/api/guides/manage-comments Manage comments and replies>. Required: The @fields@ parameter must be set. To return the exact fields you need, see <https://developers.google.com/workspace/drive/api/guides/fields-parameter Return specific fields>.
--
-- /See:/ <https://developers.google.com/workspace/drive/ Google Drive API Reference> for @drive.comments.update@.
module Gogol.Drive.Comments.Update
    (
    -- * Resource
...
newDriveCommentsUpdate commentId fileId payload
  = DriveCommentsUpdate{xgafv = Core.Nothing,
                        accessToken = Core.Nothing, callback = Core.Nothing,
                        commentId = commentId, fileId = fileId, payload = payload,
...
instance Core.GoogleRequest DriveCommentsUpdate where
        ...
        requestClient DriveCommentsUpdate{..}
          = go fileId commentId xgafv accessToken callback uploadType
              uploadProtocol
