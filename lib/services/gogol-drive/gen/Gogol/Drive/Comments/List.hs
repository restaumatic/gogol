...
--
-- Lists a file\'s comments. For more information, see <https://developers.google.com/workspace/drive/api/guides/manage-comments Manage comments and replies>. Required: The @fields@ parameter must be set. To return the exact fields you need, see <https://developers.google.com/workspace/drive/api/guides/fields-parameter Return specific fields>.
--
-- /See:/ <https://developers.google.com/workspace/drive/ Google Drive API Reference> for @drive.comments.list@.
module Gogol.Drive.Comments.List
    (
    -- * Resource
...
newDriveCommentsList fileId
  = DriveCommentsList{xgafv = Core.Nothing,
                      accessToken = Core.Nothing, callback = Core.Nothing,
                      fileId = fileId, includeDeleted = Core.False, pageSize = 20,
                      pageToken = Core.Nothing, startModifiedTime = Core.Nothing,
...
instance Core.GoogleRequest DriveCommentsList where
        ...
        requestClient DriveCommentsList{..}
          = go fileId xgafv accessToken callback (Core.Just includeDeleted)
              (Core.Just pageSize)
              pageToken
              startModifiedTime
              uploadType
