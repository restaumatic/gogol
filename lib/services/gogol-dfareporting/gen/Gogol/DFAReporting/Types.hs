...
-- | Default request referring to version @v5@ of the Campaign Manager 360 API. This contains the host and root path used as a starting point for constructing service requests.
dFAReportingService :: Core.ServiceConfig
dFAReportingService
  = Core.defaultService (Core.ServiceId "dfareporting:v5")
