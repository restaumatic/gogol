...
module Gogol.DFAReporting.Internal.Product
  (
    ...
    DynamicProfileFeedSettings (..),
    newDynamicProfileFeedSettings,

    -- * DynamicProfileVersion
    DynamicProfileVersion (..),
    newDynamicProfileVersion,
...
data Advertiser = Advertiser
    ...
    , euPoliticalAdsDeclaration :: (Core.Maybe Advertiser_EuPoliticalAdsDeclaration)
...
newAdvertiser
  = Advertiser{accountId = Core.Nothing,
               ...
               euPoliticalAdsDeclaration = Core.Nothing,
              ...
              (\ o ->
                 Advertiser Core.<$>
                   (o Core..:? "accountId" Core.<&> Core.fmap Core.fromAsText)
                     ...
                     Core.<*> (o Core..:? "euPoliticalAdsDeclaration")
                     Core.<*>
          ...
          = Core.object
              (Core.catMaybes
                 [("accountId" Core..=) Core.. Core.AsText Core.<$> accountId,
                  ...
                  ("euPoliticalAdsDeclaration" Core..=) Core.<$>
...
data Campaign = Campaign
    ...
    , euPoliticalAdsDeclaration :: (Core.Maybe Campaign_EuPoliticalAdsDeclaration)
...
--
-- /See:/ 'newContentSource' smart constructor.
data ContentSource = ContentSource
    {
      ...
      contentSourceName :: (Core.Maybe Core.Text)
    ...
    , metaData :: (Core.Maybe ContentSourceMetaData)
      -- | Required. The link to the file of the content source.
    , resourceLink :: (Core.Maybe Core.Text)
      -- | Required. The resource type of the content source.
    , resourceType :: (Core.Maybe ContentSource_ResourceType)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'ContentSource' with the minimum fields required to make a request.
newContentSource 
    ::  ContentSource
newContentSource
  = ContentSource{contentSourceName = Core.Nothing,
                  createInfo = Core.Nothing, lastModifiedInfo = Core.Nothing,
                  metaData = Core.Nothing, resourceLink = Core.Nothing,
                  resourceType = Core.Nothing}
instance Core.FromJSON ContentSource where
        parseJSON
          = Core.withObject "ContentSource"
              (\ o ->
                 ContentSource Core.<$>
                   (o Core..:? "contentSourceName") Core.<*> (o Core..:? "createInfo")
                     Core.<*> (o Core..:? "lastModifiedInfo")
                     Core.<*> (o Core..:? "metaData")
                     Core.<*> (o Core..:? "resourceLink")
                     Core.<*> (o Core..:? "resourceType"))

instance Core.ToJSON ContentSource where
        toJSON ContentSource{..}
          = Core.object
              (Core.catMaybes
                 [("contentSourceName" Core..=) Core.<$> contentSourceName,
                  ("createInfo" Core..=) Core.<$> createInfo,
                  ("lastModifiedInfo" Core..=) Core.<$> lastModifiedInfo,
                  ("metaData" Core..=) Core.<$> metaData,
                  ("resourceLink" Core..=) Core.<$> resourceLink,
                  ("resourceType" Core..=) Core.<$> resourceType])


-- | Contains the meta data of the content source. This is a read-only field.
--
-- /See:/ 'newContentSourceMetaData' smart constructor.
data ContentSourceMetaData = ContentSourceMetaData
    {
    ...
    , rowNumber :: (Core.Maybe Core.Int32)
      -- | Output only. The separator of the content source.
    , separator :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'ContentSourceMetaData' with the minimum fields required to make a request.
newContentSourceMetaData 
    ::  ContentSourceMetaData
newContentSourceMetaData
  = ContentSourceMetaData{charset = Core.Nothing,
                          fieldNames = Core.Nothing, rowNumber = Core.Nothing,
                          separator = Core.Nothing}
instance Core.FromJSON ContentSourceMetaData where
        parseJSON
          = Core.withObject "ContentSourceMetaData"
              (\ o ->
                 ContentSourceMetaData Core.<$>
                   (o Core..:? "charset") Core.<*> (o Core..:? "fieldNames") Core.<*>
                     (o Core..:? "rowNumber")
                     Core.<*> (o Core..:? "separator"))

instance Core.ToJSON ContentSourceMetaData where
        toJSON ContentSourceMetaData{..}
          = Core.object
              (Core.catMaybes
                 [("charset" Core..=) Core.<$> charset,
                  ("fieldNames" Core..=) Core.<$> fieldNames,
                  ("rowNumber" Core..=) Core.<$> rowNumber,
...
newCreative
  = Creative{accountId = Core.Nothing, active = Core.Nothing,
             ...
             counterCustomEvents = Core.Nothing, creativeAssets = Core.Nothing,
             creativeFieldAssignments = Core.Nothing,
             customKeyValues = Core.Nothing, exitCustomEvents = Core.Nothing,
             fsCommand = Core.Nothing, htmlCode = Core.Nothing,
             htmlCodeLocked = Core.Nothing, id = Core.Nothing,
...
data CustomRule = CustomRule
    ...
    , ruleBlocks :: (Core.Maybe [RuleBlock])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newCustomRule 
    ::  CustomRule
newCustomRule
  = CustomRule{name = Core.Nothing, priority = Core.Nothing,
               ruleBlocks = Core.Nothing}
instance Core.FromJSON CustomRule where
        parseJSON
          = Core.withObject "CustomRule"
              (\ o ->
                 CustomRule Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "priority") Core.<*>
                     (o Core..:? "ruleBlocks"))
          ...
          = Core.object
              (Core.catMaybes
                 [("name" Core..=) Core.<$> name,
                  ...
                  ("ruleBlocks" Core..=) Core.<$> ruleBlocks])


-- | Contains custom value field information.
--
-- /See:/ 'newCustomValueField' smart constructor.
data CustomValueField = CustomValueField
    {
      -- | Optional. Field ID in the element.
      fieldId :: (Core.Maybe Core.Int32)
      -- | Optional. Custom key used to match for auto filtering.
    , requestKey :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'CustomValueField' with the minimum fields required to make a request.
newCustomValueField 
    ::  CustomValueField
newCustomValueField
  = CustomValueField{fieldId = Core.Nothing,
                     requestKey = Core.Nothing}
instance Core.FromJSON CustomValueField where
        parseJSON
          = Core.withObject "CustomValueField"
              (\ o ->
                 CustomValueField Core.<$>
                   (o Core..:? "fieldId") Core.<*> (o Core..:? "requestKey"))

instance Core.ToJSON CustomValueField where
        toJSON CustomValueField{..}
          = Core.object
              (Core.catMaybes
                 [("fieldId" Core..=) Core.<$> fieldId,
                  ("requestKey" Core..=) Core.<$> requestKey])
...
--
-- /See:/ 'newDependentFieldValue' smart constructor.
data DependentFieldValue = DependentFieldValue
    {
      -- | Optional. The ID of the element that value\'s field will match against.
      elementId :: (Core.Maybe Core.Int64)
      -- | Optional. The field id of the dependent field.
    , fieldId :: (Core.Maybe Core.Int32)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'DependentFieldValue' with the minimum fields required to make a request.
newDependentFieldValue 
    ::  DependentFieldValue
newDependentFieldValue
  = DependentFieldValue{elementId = Core.Nothing,
                        fieldId = Core.Nothing}
instance Core.FromJSON DependentFieldValue where
        parseJSON
          = Core.withObject "DependentFieldValue"
              (\ o ->
                 DependentFieldValue Core.<$>
                   (o Core..:? "elementId" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "fieldId"))

instance Core.ToJSON DependentFieldValue where
        toJSON DependentFieldValue{..}
          = Core.object
              (Core.catMaybes
                 [("elementId" Core..=) Core.. Core.AsText Core.<$> elementId,
                  ("fieldId" Core..=) Core.<$> fieldId])
...
--
-- /See:/ 'newDynamicFeed' smart constructor.
data DynamicFeed = DynamicFeed
    {
      -- | Required. The content source of the dynamic feed. This is a required field.
      contentSource :: (Core.Maybe ContentSource)
    ...
    , status :: (Core.Maybe DynamicFeed_Status)
      -- | Required. Advertiser ID of this dynamic feed. This is a required field.
    , studioAdvertiserId :: (Core.Maybe Core.Int64)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'DynamicFeed' with the minimum fields required to make a request.
newDynamicFeed 
    ::  DynamicFeed
newDynamicFeed
  = DynamicFeed{contentSource = Core.Nothing,
                createInfo = Core.Nothing, dynamicFeedId = Core.Nothing,
                dynamicFeedName = Core.Nothing, element = Core.Nothing,
                feedIngestionStatus = Core.Nothing, feedSchedule = Core.Nothing,
                hasPublished = Core.Nothing, lastModifiedInfo = Core.Nothing,
                status = Core.Nothing, studioAdvertiserId = Core.Nothing}
instance Core.FromJSON DynamicFeed where
        parseJSON
          = Core.withObject "DynamicFeed"
              (\ o ->
                 DynamicFeed Core.<$>
                   (o Core..:? "contentSource") Core.<*> (o Core..:? "createInfo")
                     Core.<*>
                     (o Core..:? "dynamicFeedId" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "dynamicFeedName")
                     Core.<*> (o Core..:? "element")
                     Core.<*> (o Core..:? "feedIngestionStatus")
                     Core.<*> (o Core..:? "feedSchedule")
                     Core.<*> (o Core..:? "hasPublished")
                     Core.<*> (o Core..:? "lastModifiedInfo")
                     Core.<*> (o Core..:? "status")
                     Core.<*>
                     (o Core..:? "studioAdvertiserId" Core.<&>
...
instance Core.ToJSON DynamicFeed where
        toJSON DynamicFeed{..}
          = Core.object
              (Core.catMaybes
                 [("contentSource" Core..=) Core.<$> contentSource,
                  ("createInfo" Core..=) Core.<$> createInfo,
                  ("dynamicFeedId" Core..=) Core.. Core.AsText Core.<$>
                    dynamicFeedId,
                  ("dynamicFeedName" Core..=) Core.<$> dynamicFeedName,
                  ("element" Core..=) Core.<$> element,
                  ("feedIngestionStatus" Core..=) Core.<$> feedIngestionStatus,
                  ("feedSchedule" Core..=) Core.<$> feedSchedule,
                  ("hasPublished" Core..=) Core.<$> hasPublished,
                  ("lastModifiedInfo" Core..=) Core.<$> lastModifiedInfo,
                  ("status" Core..=) Core.<$> status,
                  ("studioAdvertiserId" Core..=) Core.. Core.AsText Core.<$>
                    studioAdvertiserId])
...
--
-- /See:/ 'newDynamicFeedsInsertRequest' smart constructor.
data DynamicFeedsInsertRequest = DynamicFeedsInsertRequest
    {
      -- | Required. Dynamic feed to insert.
      dynamicFeed :: (Core.Maybe DynamicFeed)
      -- | Required. Dynamic profile ID of the inserted dynamic feed.
    , dynamicProfileId :: (Core.Maybe Core.Int64)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'DynamicFeedsInsertRequest' with the minimum fields required to make a request.
newDynamicFeedsInsertRequest 
    ::  DynamicFeedsInsertRequest
newDynamicFeedsInsertRequest
  = DynamicFeedsInsertRequest{dynamicFeed = Core.Nothing,
                              dynamicProfileId = Core.Nothing}
instance Core.FromJSON DynamicFeedsInsertRequest where
        parseJSON
          = Core.withObject "DynamicFeedsInsertRequest"
              (\ o ->
                 DynamicFeedsInsertRequest Core.<$>
                   (o Core..:? "dynamicFeed") Core.<*>
                     (o Core..:? "dynamicProfileId" Core.<&> Core.fmap Core.fromAsText))

instance Core.ToJSON DynamicFeedsInsertRequest where
        toJSON DynamicFeedsInsertRequest{..}
          = Core.object
              (Core.catMaybes
                 [("dynamicFeed" Core..=) Core.<$> dynamicFeed,
                  ("dynamicProfileId" Core..=) Core.. Core.AsText Core.<$>
                    dynamicProfileId])


-- | Contains dynamic profile information.
--
-- /See:/ 'newDynamicProfile' smart constructor.
data DynamicProfile = DynamicProfile
    {
      -- | Optional. Active version of the dynamic profile.
      active :: (Core.Maybe DynamicProfileVersion)
      -- | Optional. Archive status of this dynamic profile.
    , archiveStatus :: (Core.Maybe DynamicProfile_ArchiveStatus)
    ...
    , draft :: (Core.Maybe DynamicProfileVersion)
    ...
    , status :: (Core.Maybe DynamicProfile_Status)
      -- | Required. Advertiser ID of this dynamic profile. This is a required field on insertion.
    , studioAdvertiserId :: (Core.Maybe Core.Int64)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'DynamicProfile' with the minimum fields required to make a request.
newDynamicProfile 
    ::  DynamicProfile
newDynamicProfile
  = DynamicProfile{active = Core.Nothing,
                   archiveStatus = Core.Nothing, createInfo = Core.Nothing,
                   description = Core.Nothing, draft = Core.Nothing,
                   dynamicProfileId = Core.Nothing, kind = Core.Nothing,
                   lastModifiedInfo = Core.Nothing, name = Core.Nothing,
                   status = Core.Nothing, studioAdvertiserId = Core.Nothing}
instance Core.FromJSON DynamicProfile where
        parseJSON
          = Core.withObject "DynamicProfile"
              (\ o ->
                 DynamicProfile Core.<$>
                   (o Core..:? "active") Core.<*> (o Core..:? "archiveStatus")
                     Core.<*> (o Core..:? "createInfo")
                     Core.<*> (o Core..:? "description")
                     Core.<*> (o Core..:? "draft")
                     Core.<*>
...
instance Core.ToJSON DynamicProfile where
        toJSON DynamicProfile{..}
          = Core.object
              (Core.catMaybes
                 [("active" Core..=) Core.<$> active,
                  ("archiveStatus" Core..=) Core.<$> archiveStatus,
                  ("createInfo" Core..=) Core.<$> createInfo,
                  ("description" Core..=) Core.<$> description,
...
--
-- /See:/ 'newDynamicProfileFeedSettings' smart constructor.
data DynamicProfileFeedSettings = DynamicProfileFeedSettings
    {
    ...
    , dynamicRules :: (Core.Maybe DynamicRules)
...
-- | Creates a value of 'DynamicProfileFeedSettings' with the minimum fields required to make a request.
newDynamicProfileFeedSettings 
    ::  DynamicProfileFeedSettings
newDynamicProfileFeedSettings
  = DynamicProfileFeedSettings{dynamicFeedId = Core.Nothing,
                               dynamicRules = Core.Nothing, quantity = Core.Nothing}
instance Core.FromJSON DynamicProfileFeedSettings where
        parseJSON
          = Core.withObject "DynamicProfileFeedSettings"
              (\ o ->
                 DynamicProfileFeedSettings Core.<$>
                   (o Core..:? "dynamicFeedId" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "dynamicRules")
                     Core.<*> (o Core..:? "quantity"))

instance Core.ToJSON DynamicProfileFeedSettings where
        toJSON DynamicProfileFeedSettings{..}
          = Core.object
              (Core.catMaybes
                 [("dynamicFeedId" Core..=) Core.. Core.AsText Core.<$>
                    dynamicFeedId,
                  ("dynamicRules" Core..=) Core.<$> dynamicRules,
                  ("quantity" Core..=) Core.<$> quantity])


-- | Contains dynamic profile version information.
--
-- /See:/ 'newDynamicProfileVersion' smart constructor.
data DynamicProfileVersion = DynamicProfileVersion
    {
      -- | Optional. Associated dynamic feeds and their settings (including dynamic rules) for this dynamic profile version.
      dynamicProfileFeedSettings :: (Core.Maybe [DynamicProfileFeedSettings])
...
-- | Creates a value of 'DynamicProfileVersion' with the minimum fields required to make a request.
newDynamicProfileVersion 
    ::  DynamicProfileVersion
newDynamicProfileVersion
  = DynamicProfileVersion{dynamicProfileFeedSettings = Core.Nothing,
                          versionId = Core.Nothing}
instance Core.FromJSON DynamicProfileVersion where
        parseJSON
          = Core.withObject "DynamicProfileVersion"
              (\ o ->
                 DynamicProfileVersion Core.<$>
                   (o Core..:? "dynamicProfileFeedSettings") Core.<*>
                     (o Core..:? "versionId" Core.<&> Core.fmap Core.fromAsText))

instance Core.ToJSON DynamicProfileVersion where
        toJSON DynamicProfileVersion{..}
          = Core.object
              (Core.catMaybes
                 [("dynamicProfileFeedSettings" Core..=) Core.<$>
                    dynamicProfileFeedSettings,
...
data DynamicRules = DynamicRules
    ...
    , rotationType :: (Core.Maybe DynamicRules_RotationType)
      -- | Optional. The type of the rule, the default value is OPEN.
    , ruleType :: (Core.Maybe DynamicRules_RuleType)
    ...
    , weightFieldId :: (Core.Maybe Core.Int32)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'DynamicRules' with the minimum fields required to make a request.
newDynamicRules 
    ::  DynamicRules
newDynamicRules
  = DynamicRules{autoTargetedFieldIds = Core.Nothing,
                 customRules = Core.Nothing, customValueFields = Core.Nothing,
                 proximityFilter = Core.Nothing,
                 remarketingValueAttributes = Core.Nothing,
                 rotationType = Core.Nothing, ruleType = Core.Nothing,
                 weightFieldId = Core.Nothing}
instance Core.FromJSON DynamicRules where
        parseJSON
          = Core.withObject "DynamicRules"
              (\ o ->
                 DynamicRules Core.<$>
                   (o Core..:? "autoTargetedFieldIds") Core.<*>
                     (o Core..:? "customRules")
                     Core.<*> (o Core..:? "customValueFields")
                     Core.<*> (o Core..:? "proximityFilter")
                     Core.<*> (o Core..:? "remarketingValueAttributes")
                     Core.<*> (o Core..:? "rotationType")
                     Core.<*> (o Core..:? "ruleType")
                     Core.<*> (o Core..:? "weightFieldId"))

instance Core.ToJSON DynamicRules where
        toJSON DynamicRules{..}
          = Core.object
              (Core.catMaybes
                 [("autoTargetedFieldIds" Core..=) Core.<$> autoTargetedFieldIds,
                  ("customRules" Core..=) Core.<$> customRules,
                  ("customValueFields" Core..=) Core.<$> customValueFields,
                  ("proximityFilter" Core..=) Core.<$> proximityFilter,
                  ("remarketingValueAttributes" Core..=) Core.<$>
                    remarketingValueAttributes,
                  ("rotationType" Core..=) Core.<$> rotationType,
                  ("ruleType" Core..=) Core.<$> ruleType,
                  ("weightFieldId" Core..=) Core.<$> weightFieldId])
...
--
-- /See:/ 'newElement' smart constructor.
data Element = Element
    {
      -- | Optional. The field ID to specify the active field in the feed.
      activeFieldId :: (Core.Maybe Core.Int32)
    ...
    , defaultFieldId :: (Core.Maybe Core.Int32)
    ...
    , feedFields :: (Core.Maybe [FeedField])
    ...
    , isLocalTimestamp :: (Core.Maybe Core.Bool)
    ...
    , startTimestampFieldId :: (Core.Maybe Core.Int32)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'Element' with the minimum fields required to make a request.
newElement 
    ::  Element
newElement
  = Element{activeFieldId = Core.Nothing, createInfo = Core.Nothing,
            defaultFieldId = Core.Nothing, elementName = Core.Nothing,
            endTimestampFieldId = Core.Nothing,
            externalIdFieldId = Core.Nothing, feedFields = Core.Nothing,
            isLocalTimestamp = Core.Nothing, lastModifiedInfo = Core.Nothing,
            proximityTargetingFieldId = Core.Nothing,
            reportingLabelFieldId = Core.Nothing,
            startTimestampFieldId = Core.Nothing}
instance Core.FromJSON Element where
        parseJSON
          = Core.withObject "Element"
              (\ o ->
                 Element Core.<$>
                   (o Core..:? "activeFieldId") Core.<*> (o Core..:? "createInfo")
                     Core.<*> (o Core..:? "defaultFieldId")
                     Core.<*> (o Core..:? "elementName")
                     Core.<*> (o Core..:? "endTimestampFieldId")
                     Core.<*> (o Core..:? "externalIdFieldId")
                     Core.<*> (o Core..:? "feedFields")
                     Core.<*> (o Core..:? "isLocalTimestamp")
                     Core.<*> (o Core..:? "lastModifiedInfo")
                     Core.<*> (o Core..:? "proximityTargetingFieldId")
                     Core.<*> (o Core..:? "reportingLabelFieldId")
                     Core.<*> (o Core..:? "startTimestampFieldId"))

instance Core.ToJSON Element where
        toJSON Element{..}
          = Core.object
              (Core.catMaybes
                 [("activeFieldId" Core..=) Core.<$> activeFieldId,
                  ("createInfo" Core..=) Core.<$> createInfo,
                  ("defaultFieldId" Core..=) Core.<$> defaultFieldId,
                  ("elementName" Core..=) Core.<$> elementName,
                  ("endTimestampFieldId" Core..=) Core.<$> endTimestampFieldId,
                  ("externalIdFieldId" Core..=) Core.<$> externalIdFieldId,
                  ("feedFields" Core..=) Core.<$> feedFields,
                  ("isLocalTimestamp" Core..=) Core.<$> isLocalTimestamp,
                  ("lastModifiedInfo" Core..=) Core.<$> lastModifiedInfo,
                  ("proximityTargetingFieldId" Core..=) Core.<$>
                    proximityTargetingFieldId,
                  ("reportingLabelFieldId" Core..=) Core.<$> reportingLabelFieldId,
                  ("startTimestampFieldId" Core..=) Core.<$> startTimestampFieldId])
...
--
-- /See:/ 'newFeedField' smart constructor.
data FeedField = FeedField
    {
      -- | Optional. The default value of the field.
      defaultValue :: (Core.Maybe Core.Text)
      -- | Optional. Whether the field is filterable. Could be set as true when the field type is any of the following and is not renderable: - STRING - BOOL - COUNTRY/CODE/ISO - CM360/SITE/ID - CM360/KEYWORD - CM360/CREATIVE/ID - CM360/PLACEMENT/ID - CM360/AD/ID - CM360/ADVERTISER/ID - CM360/CAMPAIGN/ID - CITY - REGION - POSTAL/CODE - METRO - CUSTOM/VALUE - REMARKETING/VALUE - GEO/CANONICAL - STRING/LIST - CREATIVE/DIMENSION - USERLIST/ID - CM360/DYNAMIC/TARGETING/KEY - DV360/LINE/ITEM/ID
    ...
    , name :: (Core.Maybe Core.Text)
      -- | Optional. Whether the field is able to display. Could be set as true when the field type is not in any of the following and the field is not filterable: - COUNTRY/CODE/ISO - CITY - REGION - POSTAL/CODE - METRO - GEO/CANONICAL - USERLIST/ID - CONTEXTUAL/KEYWORD - CM360/DYNAMIC/TARGETING_KEY - WEIGHT
    , renderable :: (Core.Maybe Core.Bool)
      -- | Optional. Whether the field is required and should not be empty in the feed. Could be set as true when the field type is any of the following: - GPA/SERVED/IMAGE/URL - GPA/SERVED/ASSET/URL - ASSET/LIBRARY/HANDLE - ASSET/LIBRARY/VIDEO/HANDLE - ASSET/LIBRARY/DIRECTORY/HANDLE
    , required :: (Core.Maybe Core.Bool)
      -- | Required. The type of the field.
    , type' :: (Core.Maybe FeedField_Type)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'FeedField' with the minimum fields required to make a request.
newFeedField 
    ::  FeedField
newFeedField
  = FeedField{defaultValue = Core.Nothing, filterable = Core.Nothing,
              id = Core.Nothing, name = Core.Nothing, renderable = Core.Nothing,
              required = Core.Nothing, type' = Core.Nothing}
instance Core.FromJSON FeedField where
        parseJSON
          = Core.withObject "FeedField"
              (\ o ->
                 FeedField Core.<$>
                   (o Core..:? "defaultValue") Core.<*> (o Core..:? "filterable")
                     Core.<*> (o Core..:? "id")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "renderable")
                     Core.<*> (o Core..:? "required")
                     Core.<*> (o Core..:? "type"))

instance Core.ToJSON FeedField where
        toJSON FeedField{..}
          = Core.object
              (Core.catMaybes
                 [("defaultValue" Core..=) Core.<$> defaultValue,
                  ...
                  ("renderable" Core..=) Core.<$> renderable,
...
--
-- /See:/ 'newFeedIngestionStatus' smart constructor.
data FeedIngestionStatus = FeedIngestionStatus
    {
      -- | Output only. The ingestion error records of the feed.
      ingestionErrorRecords :: (Core.Maybe [IngestionErrorRecord])
      -- | Output only. The ingestion status of the feed.
    , ingestionStatus :: (Core.Maybe IngestionStatus)
      -- | Output only. The processing state of the feed.
    , state :: (Core.Maybe FeedIngestionStatus_State)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'FeedIngestionStatus' with the minimum fields required to make a request.
newFeedIngestionStatus 
    ::  FeedIngestionStatus
newFeedIngestionStatus
  = FeedIngestionStatus{ingestionErrorRecords = Core.Nothing,
                        ingestionStatus = Core.Nothing, state = Core.Nothing}
instance Core.FromJSON FeedIngestionStatus where
        parseJSON
          = Core.withObject "FeedIngestionStatus"
              (\ o ->
                 FeedIngestionStatus Core.<$>
                   (o Core..:? "ingestionErrorRecords") Core.<*>
                     (o Core..:? "ingestionStatus")
                     Core.<*> (o Core..:? "state"))

instance Core.ToJSON FeedIngestionStatus where
        toJSON FeedIngestionStatus{..}
          = Core.object
              (Core.catMaybes
                 [("ingestionErrorRecords" Core..=) Core.<$> ingestionErrorRecords,
                  ("ingestionStatus" Core..=) Core.<$> ingestionStatus,
                  ("state" Core..=) Core.<$> state])


-- | Contains the schedule of the dynamic feed.
--
-- /See:/ 'newFeedSchedule' smart constructor.
data FeedSchedule = FeedSchedule
    {
...
-- | Creates a value of 'FeedSchedule' with the minimum fields required to make a request.
newFeedSchedule 
    ::  FeedSchedule
newFeedSchedule
  = FeedSchedule{repeatValue = Core.Nothing,
                 scheduleEnabled = Core.Nothing, startHour = Core.Nothing,
                 startMinute = Core.Nothing, timeZone = Core.Nothing}
instance Core.FromJSON FeedSchedule where
        parseJSON
          = Core.withObject "FeedSchedule"
              (\ o ->
                 FeedSchedule Core.<$>
                   (o Core..:? "repeatValue" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "scheduleEnabled")
                     Core.<*> (o Core..:? "startHour")
                     Core.<*> (o Core..:? "startMinute")
                     Core.<*> (o Core..:? "timeZone"))

instance Core.ToJSON FeedSchedule where
        toJSON FeedSchedule{..}
          = Core.object
              (Core.catMaybes
                 [("repeatValue" Core..=) Core.. Core.AsText Core.<$> repeatValue,
                  ("scheduleEnabled" Core..=) Core.<$> scheduleEnabled,
...
data FieldError = FieldError
    ...
    , fieldValues :: (Core.Maybe [Core.Text])
      -- | Output only. The ingestion error of the field.
    , ingestionError :: (Core.Maybe FieldError_IngestionError)
      -- | Output only. Incidcates whether the field has error or warning.
    , isError :: (Core.Maybe Core.Bool)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'FieldError' with the minimum fields required to make a request.
newFieldError 
    ::  FieldError
newFieldError
  = FieldError{fieldId = Core.Nothing, fieldName = Core.Nothing,
               fieldValues = Core.Nothing, ingestionError = Core.Nothing,
               isError = Core.Nothing}
instance Core.FromJSON FieldError where
        parseJSON
          = Core.withObject "FieldError"
              (\ o ->
                 FieldError Core.<$>
                   (o Core..:? "fieldId") Core.<*> (o Core..:? "fieldName") Core.<*>
                     (o Core..:? "fieldValues")
                     Core.<*> (o Core..:? "ingestionError")
                     Core.<*> (o Core..:? "isError"))

instance Core.ToJSON FieldError where
        toJSON FieldError{..}
          = Core.object
              (Core.catMaybes
                 [("fieldId" Core..=) Core.<$> fieldId,
                  ...
                  ("ingestionError" Core..=) Core.<$> ingestionError,
...
data FieldFilter = FieldFilter
    {
      -- | Optional. The boolean values, only applicable when rhs/value/type is BOOL.
      boolValue :: (Core.Maybe Core.Bool)
      -- | Optional. The dependent values, only applicable when rhs/value/type is DEPENDENT.
    , dependentFieldValue :: (Core.Maybe DependentFieldValue)
      -- | Optional. The field ID on the left hand side of the expression.
    , fieldId :: (Core.Maybe Core.Int32)
      -- | Optional. Left hand side of the expression match type.
    , matchType :: (Core.Maybe FieldFilter_MatchType)
      -- | Optional. The request value, only applicable when rhs/value/type is REQUEST.
    , requestValue :: (Core.Maybe RequestValue)
      -- | Optional. The string value, only applicable when rhs/value/type is STRING.
    , stringValue :: (Core.Maybe Core.Text)
      -- | Optional. Right hand side of the expression.
    , valueType :: (Core.Maybe FieldFilter_ValueType)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newFieldFilter 
    ::  FieldFilter
newFieldFilter
  = FieldFilter{boolValue = Core.Nothing,
                dependentFieldValue = Core.Nothing, fieldId = Core.Nothing,
                matchType = Core.Nothing, requestValue = Core.Nothing,
                stringValue = Core.Nothing, valueType = Core.Nothing}
              ...
              (\ o ->
                 FieldFilter Core.<$>
                   (o Core..:? "boolValue") Core.<*>
                     (o Core..:? "dependentFieldValue")
                     Core.<*> (o Core..:? "fieldId")
                     Core.<*> (o Core..:? "matchType")
                     Core.<*> (o Core..:? "requestValue")
          ...
          = Core.object
              (Core.catMaybes
                 [("boolValue" Core..=) Core.<$> boolValue,
                  ("dependentFieldValue" Core..=) Core.<$> dependentFieldValue,
                  ("fieldId" Core..=) Core.<$> fieldId,
                  ("matchType" Core..=) Core.<$> matchType,
                  ("requestValue" Core..=) Core.<$> requestValue,
...
data FloodlightActivity = FloodlightActivity
    ...
    , conversionCategory :: (Core.Maybe FloodlightActivity_ConversionCategory)
...
newFloodlightActivity
  = FloodlightActivity{accountId = Core.Nothing,
                       ...
                       conversionCategory = Core.Nothing, countingMethod = Core.Nothing,
                       defaultTags = Core.Nothing, expectedUrl = Core.Nothing,
              ...
              (\ o ->
                 FloodlightActivity Core.<$>
                   (o Core..:? "accountId" Core.<&> Core.fmap Core.fromAsText)
                     ...
                     Core.<*> (o Core..:? "conversionCategory")
          ...
          = Core.object
              (Core.catMaybes
                 [("accountId" Core..=) Core.. Core.AsText Core.<$> accountId,
                  ...
                  ("conversionCategory" Core..=) Core.<$> conversionCategory,
...
--
-- /See:/ 'newIngestionErrorRecord' smart constructor.
data IngestionErrorRecord = IngestionErrorRecord
    {
      -- | Output only. The list of field errors of the ingestion error record.
      errors :: (Core.Maybe [FieldError])
      -- | Output only. The record ID of the ingestion error record.
    , recordId :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'IngestionErrorRecord' with the minimum fields required to make a request.
newIngestionErrorRecord 
    ::  IngestionErrorRecord
newIngestionErrorRecord
  = IngestionErrorRecord{errors = Core.Nothing,
                         recordId = Core.Nothing}
instance Core.FromJSON IngestionErrorRecord where
        parseJSON
          = Core.withObject "IngestionErrorRecord"
              (\ o ->
                 IngestionErrorRecord Core.<$>
                   (o Core..:? "errors") Core.<*> (o Core..:? "recordId"))

instance Core.ToJSON IngestionErrorRecord where
        toJSON IngestionErrorRecord{..}
          = Core.object
              (Core.catMaybes
                 [("errors" Core..=) Core.<$> errors,
                  ("recordId" Core..=) Core.<$> recordId])
...
data IngestionStatus = IngestionStatus
    {
      ...
      numActiveRows :: (Core.Maybe Core.Int64)
    ...
    , numRowsWithErrors :: (Core.Maybe Core.Int64)
      -- | Output only. The total number of warnings in the feed.
    , numWarningsTotal :: (Core.Maybe Core.Int64)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'IngestionStatus' with the minimum fields required to make a request.
newIngestionStatus 
    ::  IngestionStatus
newIngestionStatus
  = IngestionStatus{numActiveRows = Core.Nothing,
                    numRowsProcessed = Core.Nothing, numRowsTotal = Core.Nothing,
                    numRowsWithErrors = Core.Nothing, numWarningsTotal = Core.Nothing}
instance Core.FromJSON IngestionStatus where
        parseJSON
          = Core.withObject "IngestionStatus"
              (\ o ->
                 IngestionStatus Core.<$>
                   (o Core..:? "numActiveRows" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "numRowsProcessed" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "numRowsTotal" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "numRowsWithErrors" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "numWarningsTotal" Core.<&> Core.fmap Core.fromAsText))

instance Core.ToJSON IngestionStatus where
        toJSON IngestionStatus{..}
          = Core.object
              (Core.catMaybes
                 [("numActiveRows" Core..=) Core.. Core.AsText Core.<$>
                    numActiveRows,
                  ("numRowsProcessed" Core..=) Core.. Core.AsText Core.<$>
                    numRowsProcessed,
                  ("numRowsTotal" Core..=) Core.. Core.AsText Core.<$> numRowsTotal,
                  ("numRowsWithErrors" Core..=) Core.. Core.AsText Core.<$>
                    numRowsWithErrors,
                  ("numWarningsTotal" Core..=) Core.. Core.AsText Core.<$>
                    numWarningsTotal])
...
data Placement = Placement
    ...
    , allowOnYoutube :: (Core.Maybe Core.Bool)
    ...
    , youtubeSettings :: (Core.Maybe YoutubeSettings)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newPlacement
  = Placement{accountId = Core.Nothing, activeStatus = Core.Nothing,
              ...
              advertiserId = Core.Nothing,
              advertiserIdDimensionValue = Core.Nothing,
              allowOnYoutube = Core.Nothing, campaignId = Core.Nothing,
              campaignIdDimensionValue = Core.Nothing, comment = Core.Nothing,
              compatibility = Core.Nothing, contentCategoryId = Core.Nothing,
              ...
              wrappingOptOut = Core.Nothing, youtubeSettings = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("accountId" Core..=) Core.. Core.AsText Core.<$> accountId,
                  ...
                  ("advertiserIdDimensionValue" Core..=) Core.<$>
                    advertiserIdDimensionValue,
                  ("allowOnYoutube" Core..=) Core.<$> allowOnYoutube,
                  ("campaignId" Core..=) Core.. Core.AsText Core.<$> campaignId,
                  ("campaignIdDimensionValue" Core..=) Core.<$>
                    campaignIdDimensionValue,
                  ("comment" Core..=) Core.<$> comment,
                  ...
                  ("youtubeSettings" Core..=) Core.<$> youtubeSettings])
...
--
-- /See:/ 'newProximityFilter' smart constructor.
data ProximityFilter = ProximityFilter
    {
      -- | Optional. Field ID in the element.
      fieldId :: (Core.Maybe Core.Int32)
      -- | Optional. The radius bucket type of the proximity filter
    , radiusBucketType :: (Core.Maybe ProximityFilter_RadiusBucketType)
      -- | Optional. The units of the radius value
    , radiusUnitType :: (Core.Maybe ProximityFilter_RadiusUnitType)
      -- | Optional. Radius length in units defined by radius_units.
    , radiusValue :: (Core.Maybe Core.Int32)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'ProximityFilter' with the minimum fields required to make a request.
newProximityFilter 
    ::  ProximityFilter
newProximityFilter
  = ProximityFilter{fieldId = Core.Nothing,
                    radiusBucketType = Core.Nothing, radiusUnitType = Core.Nothing,
                    radiusValue = Core.Nothing}
instance Core.FromJSON ProximityFilter where
        parseJSON
          = Core.withObject "ProximityFilter"
              (\ o ->
                 ProximityFilter Core.<$>
                   (o Core..:? "fieldId") Core.<*> (o Core..:? "radiusBucketType")
                     Core.<*> (o Core..:? "radiusUnitType")
                     Core.<*> (o Core..:? "radiusValue"))

instance Core.ToJSON ProximityFilter where
        toJSON ProximityFilter{..}
          = Core.object
              (Core.catMaybes
                 [("fieldId" Core..=) Core.<$> fieldId,
                  ("radiusBucketType" Core..=) Core.<$> radiusBucketType,
                  ("radiusUnitType" Core..=) Core.<$> radiusUnitType,
                  ("radiusValue" Core..=) Core.<$> radiusValue])
...
--
-- /See:/ 'newRemarketingValueAttribute' smart constructor.
data RemarketingValueAttribute = RemarketingValueAttribute
    {
      -- | Optional. Field ID in the element.
      fieldId :: (Core.Maybe Core.Int32)
      -- | Optional. Remarketing user attribute IDs for auto filtering.
    , userAttributeIds :: (Core.Maybe [Core.Int64])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'RemarketingValueAttribute' with the minimum fields required to make a request.
newRemarketingValueAttribute 
    ::  RemarketingValueAttribute
newRemarketingValueAttribute
  = RemarketingValueAttribute{fieldId = Core.Nothing,
                              userAttributeIds = Core.Nothing}
instance Core.FromJSON RemarketingValueAttribute where
        parseJSON
          = Core.withObject "RemarketingValueAttribute"
              (\ o ->
                 RemarketingValueAttribute Core.<$>
                   (o Core..:? "fieldId") Core.<*>
                     (o Core..:? "userAttributeIds" Core.<&>
                        Core.fmap (Core.fmap Core.fromAsText)))

instance Core.ToJSON RemarketingValueAttribute where
        toJSON RemarketingValueAttribute{..}
          = Core.object
              (Core.catMaybes
                 [("fieldId" Core..=) Core.<$> fieldId,
                  ("userAttributeIds" Core..=) Core.. Core.fmap Core.AsText Core.<$>
                    userAttributeIds])
...
--
-- /See:/ 'newRequestValue' smart constructor.
data RequestValue = RequestValue
    {
      -- | Optional. User attribute IDs in the request that should be excluded. Used only when the field type is REMARKETING/VALUE or USER/ATTRIBUTE_ID.
      excludeFromUserAttributeIds :: (Core.Maybe [Core.Int64])
      -- | Optional. Custom key in the request. Used only when the field type is CUSTOM_VALUE.
    , key :: (Core.Maybe Core.Text)
      -- | Optional. User attribute IDs in the request. Used only when the field type is REMARKETING/VALUE or USER/ATTRIBUTE_ID.
    , userAttributeIds :: (Core.Maybe [Core.Int64])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'RequestValue' with the minimum fields required to make a request.
newRequestValue 
    ::  RequestValue
newRequestValue
  = RequestValue{excludeFromUserAttributeIds = Core.Nothing,
                 key = Core.Nothing, userAttributeIds = Core.Nothing}
instance Core.FromJSON RequestValue where
        parseJSON
          = Core.withObject "RequestValue"
              (\ o ->
                 RequestValue Core.<$>
                   (o Core..:? "excludeFromUserAttributeIds" Core.<&>
                      Core.fmap (Core.fmap Core.fromAsText))
                     Core.<*> (o Core..:? "key")
                     Core.<*>
                     (o Core..:? "userAttributeIds" Core.<&>
...
instance Core.ToJSON RequestValue where
        toJSON RequestValue{..}
          = Core.object
              (Core.catMaybes
                 [("excludeFromUserAttributeIds" Core..=) Core..
                    Core.fmap Core.AsText
                    Core.<$> excludeFromUserAttributeIds,
                  ("key" Core..=) Core.<$> key,
                  ("userAttributeIds" Core..=) Core.. Core.fmap Core.AsText Core.<$>
                    userAttributeIds])
...
--
-- /See:/ 'newRuleBlock' smart constructor.
newtype RuleBlock = RuleBlock
    {
...
-- | Creates a value of 'RuleBlock' with the minimum fields required to make a request.
newRuleBlock 
    ::  RuleBlock
newRuleBlock = RuleBlock{fieldFilter = Core.Nothing}
instance Core.FromJSON RuleBlock where
        parseJSON
          = Core.withObject "RuleBlock"
              (\ o -> RuleBlock Core.<$> (o Core..:? "fieldFilter"))

instance Core.ToJSON RuleBlock where
        toJSON RuleBlock{..}
          = Core.object
              (Core.catMaybes [("fieldFilter" Core..=) Core.<$> fieldFilter])
...
--
-- /See:/ 'newYoutubeSettings' smart constructor.
data YoutubeSettings = YoutubeSettings
    {
      -- | Optional. The IDs of the creatives to use for the business logo. Currently only one creative is supported.
      businessLogoCreativeIds :: (Core.Maybe [Core.Int64])
      -- | Optional. The business name.
    , businessName :: (Core.Maybe Core.Text)
      -- | Optional. The call to actions. Currently only one call to action is supported.
    , callToActions :: (Core.Maybe [YoutubeSettings_CallToActionsItem])
      -- | Optional. The descriptions. Currently only one description is supported.
    , descriptions :: (Core.Maybe [Core.Text])
      -- | Optional. The headlines associated with the call to actions. Currently only one headline is supported.
    , headlines :: (Core.Maybe [Core.Text])
      -- | Optional. The long headlines. Currently only one long headline is supported.
    , longHeadlines :: (Core.Maybe [Core.Text])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'YoutubeSettings' with the minimum fields required to make a request.
newYoutubeSettings 
    ::  YoutubeSettings
newYoutubeSettings
  = YoutubeSettings{businessLogoCreativeIds = Core.Nothing,
                    businessName = Core.Nothing, callToActions = Core.Nothing,
                    descriptions = Core.Nothing, headlines = Core.Nothing,
                    longHeadlines = Core.Nothing}
instance Core.FromJSON YoutubeSettings where
        parseJSON
          = Core.withObject "YoutubeSettings"
              (\ o ->
                 YoutubeSettings Core.<$>
                   (o Core..:? "businessLogoCreativeIds" Core.<&>
                      Core.fmap (Core.fmap Core.fromAsText))
                     Core.<*> (o Core..:? "businessName")
                     Core.<*> (o Core..:? "callToActions")
                     Core.<*> (o Core..:? "descriptions")
                     Core.<*> (o Core..:? "headlines")
                     Core.<*> (o Core..:? "longHeadlines"))

instance Core.ToJSON YoutubeSettings where
        toJSON YoutubeSettings{..}
          = Core.object
              (Core.catMaybes
                 [("businessLogoCreativeIds" Core..=) Core.. Core.fmap Core.AsText
                    Core.<$> businessLogoCreativeIds,
                  ("businessName" Core..=) Core.<$> businessName,
                  ("callToActions" Core..=) Core.<$> callToActions,
                  ("descriptions" Core..=) Core.<$> descriptions,
                  ("headlines" Core..=) Core.<$> headlines,
                  ("longHeadlines" Core..=) Core.<$> longHeadlines])
