...
newBigtableAdminProjectsInstancesTestIamPermissions 
    ...
    -> BigtableAdminProjectsInstancesTestIamPermissions
newBigtableAdminProjectsInstancesTestIamPermissions payload
  resource
  = BigtableAdminProjectsInstancesTestIamPermissions{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           BigtableAdminProjectsInstancesTestIamPermissions
         where
        type Rs BigtableAdminProjectsInstancesTestIamPermissions =
             TestIamPermissionsResponse
        type Scopes BigtableAdminProjectsInstancesTestIamPermissions =
             '[Bigtable'Admin, Bigtable'Admin'Cluster, Bigtable'Admin'Instance,
               CloudBigtable'Admin, CloudBigtable'Admin'Cluster,
               CloudPlatform'FullControl]
        requestClient BigtableAdminProjectsInstancesTestIamPermissions{..}
