...
-- |
-- Module      : Gogol.BigtableAdmin.Projects.Instances.Clusters.Backups.List
...
newBigtableAdminProjectsInstancesClustersBackupsList parent
  = BigtableAdminProjectsInstancesClustersBackupsList{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           BigtableAdminProjectsInstancesClustersBackupsList
         where
        type Rs BigtableAdminProjectsInstancesClustersBackupsList =
             ListBackupsResponse
        type Scopes BigtableAdminProjectsInstancesClustersBackupsList =
             '[Bigtable'Admin, Bigtable'Admin'Table, CloudBigtable'Admin,
               CloudBigtable'Admin'Table, CloudPlatform'FullControl]
        requestClient BigtableAdminProjectsInstancesClustersBackupsList{..}
