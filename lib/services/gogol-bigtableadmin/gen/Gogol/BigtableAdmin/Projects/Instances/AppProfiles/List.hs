                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] ListAppProfilesResponse
...
newBigtableAdminProjectsInstancesAppProfilesList parent
  = BigtableAdminProjectsInstancesAppProfilesList{xgafv =
                                                    Core.Nothing,
...
instance Core.GoogleRequest
           BigtableAdminProjectsInstancesAppProfilesList
         where
        type Rs BigtableAdminProjectsInstancesAppProfilesList =
             ListAppProfilesResponse
        type Scopes BigtableAdminProjectsInstancesAppProfilesList =
             '[Bigtable'Admin, Bigtable'Admin'Cluster, Bigtable'Admin'Instance,
               CloudBigtable'Admin, CloudBigtable'Admin'Cluster,
               CloudPlatform'FullControl]
        requestClient BigtableAdminProjectsInstancesAppProfilesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy BigtableAdminProjectsInstancesAppProfilesListResource)
                      Core.mempty
