...
newBigtableAdminProjectsInstancesTablesAuthorizedViewsPatch 
    ...
    -> BigtableAdminProjectsInstancesTablesAuthorizedViewsPatch
newBigtableAdminProjectsInstancesTablesAuthorizedViewsPatch name
  payload
  = BigtableAdminProjectsInstancesTablesAuthorizedViewsPatch{xgafv =
                                                               Core.Nothing,
...
instance Core.GoogleRequest
           BigtableAdminProjectsInstancesTablesAuthorizedViewsPatch
         where
        type Rs BigtableAdminProjectsInstancesTablesAuthorizedViewsPatch =
             Operation
        type Scopes
               BigtableAdminProjectsInstancesTablesAuthorizedViewsPatch
             =
