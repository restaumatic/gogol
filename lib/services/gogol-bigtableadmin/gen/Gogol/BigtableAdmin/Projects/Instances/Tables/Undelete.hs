               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] UndeleteTableRequest Core.:>
...
newBigtableAdminProjectsInstancesTablesUndelete name payload
  = BigtableAdminProjectsInstancesTablesUndelete{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
           BigtableAdminProjectsInstancesTablesUndelete
         where
        type Rs BigtableAdminProjectsInstancesTablesUndelete = Operation
        type Scopes BigtableAdminProjectsInstancesTablesUndelete =
             '[Bigtable'Admin, Bigtable'Admin'Table, CloudBigtable'Admin,
               CloudBigtable'Admin'Table, CloudPlatform'FullControl]
        requestClient BigtableAdminProjectsInstancesTablesUndelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy BigtableAdminProjectsInstancesTablesUndeleteResource)
                      Core.mempty
