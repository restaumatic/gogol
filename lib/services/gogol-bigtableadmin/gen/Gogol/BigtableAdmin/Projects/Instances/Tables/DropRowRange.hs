...
type BigtableAdminProjectsInstancesTablesDropRowRangeResource =
     "v2" Core.:>
       Core.CaptureMode "name" "dropRowRange" Core.Text Core.:>
...
newBigtableAdminProjectsInstancesTablesDropRowRange name payload
  = BigtableAdminProjectsInstancesTablesDropRowRange{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes BigtableAdminProjectsInstancesTablesDropRowRange =
