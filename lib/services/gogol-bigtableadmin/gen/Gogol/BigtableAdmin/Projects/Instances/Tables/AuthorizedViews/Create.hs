         ...
         "authorizedViews" Core.:>
           Core.QueryParam "$.xgafv" Xgafv Core.:>
             Core.QueryParam "access_token" Core.Text Core.:>
               Core.QueryParam "authorizedViewId" Core.Text Core.:>
...
newBigtableAdminProjectsInstancesTablesAuthorizedViewsCreate 
    ...
    -> BigtableAdminProjectsInstancesTablesAuthorizedViewsCreate
newBigtableAdminProjectsInstancesTablesAuthorizedViewsCreate parent
  payload
  = BigtableAdminProjectsInstancesTablesAuthorizedViewsCreate{xgafv =
                                                                Core.Nothing,
...
instance Core.GoogleRequest
           BigtableAdminProjectsInstancesTablesAuthorizedViewsCreate
         where
        type Rs BigtableAdminProjectsInstancesTablesAuthorizedViewsCreate =
             Operation
        type Scopes
               BigtableAdminProjectsInstancesTablesAuthorizedViewsCreate
             =
        ...
        requestClient
          BigtableAdminProjectsInstancesTablesAuthorizedViewsCreate{..}
          = go parent xgafv accessToken authorizedViewId callback uploadType
              uploadProtocol
