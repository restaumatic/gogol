...
type BigtableAdminProjectsInstancesTablesGenerateConsistencyTokenResource
     =
     "v2" Core.:>
       Core.CaptureMode "name" "generateConsistencyToken" Core.Text
         Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] GenerateConsistencyTokenRequest Core.:>
                       Core.Post '[Core.JSON] GenerateConsistencyTokenResponse
...
newBigtableAdminProjectsInstancesTablesGenerateConsistencyToken
  name payload
  = BigtableAdminProjectsInstancesTablesGenerateConsistencyToken{xgafv
                                                                   = Core.Nothing,
