                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Get '[Core.JSON] ListHotTabletsResponse
...
newBigtableAdminProjectsInstancesClustersHotTabletsList parent
  = BigtableAdminProjectsInstancesClustersHotTabletsList{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           BigtableAdminProjectsInstancesClustersHotTabletsList
         where
        type Rs BigtableAdminProjectsInstancesClustersHotTabletsList =
             ListHotTabletsResponse
        type Scopes BigtableAdminProjectsInstancesClustersHotTabletsList =
             '[Bigtable'Admin, Bigtable'Admin'Cluster, Bigtable'Admin'Instance,
               CloudBigtable'Admin, CloudBigtable'Admin'Cluster,
               CloudPlatform'FullControl]
        requestClient
          BigtableAdminProjectsInstancesClustersHotTabletsList{..}
          = go parent xgafv accessToken callback endTime pageSize pageToken
              startTime
              uploadType
              uploadProtocol
