...
newBigtableAdminProjectsInstancesTablesAuthorizedViewsGet name
  = BigtableAdminProjectsInstancesTablesAuthorizedViewsGet{xgafv =
                                                             Core.Nothing,
...
instance Core.GoogleRequest
           BigtableAdminProjectsInstancesTablesAuthorizedViewsGet
         where
        type Rs BigtableAdminProjectsInstancesTablesAuthorizedViewsGet =
             AuthorizedView
        type Scopes BigtableAdminProjectsInstancesTablesAuthorizedViewsGet
             =
