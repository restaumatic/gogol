...
type BigtableAdminProjectsInstancesTablesModifyColumnFamiliesResource
     =
     "v2" Core.:>
       Core.CaptureMode "name" "modifyColumnFamilies" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] ModifyColumnFamiliesRequest Core.:>
...
newBigtableAdminProjectsInstancesTablesModifyColumnFamilies 
    ...
    -> BigtableAdminProjectsInstancesTablesModifyColumnFamilies
newBigtableAdminProjectsInstancesTablesModifyColumnFamilies name
  payload
  = BigtableAdminProjectsInstancesTablesModifyColumnFamilies{xgafv =
                                                               Core.Nothing,
...
instance Core.GoogleRequest
           BigtableAdminProjectsInstancesTablesModifyColumnFamilies
         where
        type Rs BigtableAdminProjectsInstancesTablesModifyColumnFamilies =
             Table
        type Scopes
               BigtableAdminProjectsInstancesTablesModifyColumnFamilies
             =
