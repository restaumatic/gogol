...
newBigtableAdminProjectsInstancesAppProfilesDelete name
  = BigtableAdminProjectsInstancesAppProfilesDelete{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes BigtableAdminProjectsInstancesAppProfilesDelete =
        ...
        requestClient BigtableAdminProjectsInstancesAppProfilesDelete{..}
          = go name xgafv accessToken callback ignoreWarnings uploadType
              uploadProtocol
