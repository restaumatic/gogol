...
-- |
-- Module      : Gogol.BigtableAdmin.Projects.Instances.AppProfiles.Create
         ...
         "appProfiles" Core.:>
           Core.QueryParam "$.xgafv" Xgafv Core.:>
             Core.QueryParam "access_token" Core.Text Core.:>
               Core.QueryParam "appProfileId" Core.Text Core.:>
                 Core.QueryParam "callback" Core.Text Core.:>
                   Core.QueryParam "ignoreWarnings" Core.Bool Core.:>
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] AppProfile Core.:>
                             Core.Post '[Core.JSON] AppProfile
...
newBigtableAdminProjectsInstancesAppProfilesCreate parent payload
  = BigtableAdminProjectsInstancesAppProfilesCreate{xgafv =
                                                      Core.Nothing,
                                                    accessToken = Core.Nothing,
                                                    appProfileId = Core.Nothing,
                                                    callback = Core.Nothing,
                                                    ignoreWarnings = Core.Nothing, parent = parent,
                                                    payload = payload, uploadType = Core.Nothing,
                                                    uploadProtocol = Core.Nothing}
instance Core.GoogleRequest
           BigtableAdminProjectsInstancesAppProfilesCreate
         where
        type Rs BigtableAdminProjectsInstancesAppProfilesCreate =
             AppProfile
        type Scopes BigtableAdminProjectsInstancesAppProfilesCreate =
             '[Bigtable'Admin, Bigtable'Admin'Cluster, Bigtable'Admin'Instance,
               CloudBigtable'Admin, CloudBigtable'Admin'Cluster,
               CloudPlatform'FullControl]
        requestClient BigtableAdminProjectsInstancesAppProfilesCreate{..}
          = go parent xgafv accessToken appProfileId callback ignoreWarnings
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy BigtableAdminProjectsInstancesAppProfilesCreateResource)
                      Core.mempty
