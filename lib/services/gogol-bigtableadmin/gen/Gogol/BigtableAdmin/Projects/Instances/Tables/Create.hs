...
newBigtableAdminProjectsInstancesTablesCreate parent payload
  = BigtableAdminProjectsInstancesTablesCreate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           BigtableAdminProjectsInstancesTablesCreate
         where
        type Rs BigtableAdminProjectsInstancesTablesCreate = Table
        type Scopes BigtableAdminProjectsInstancesTablesCreate =
             '[Bigtable'Admin, Bigtable'Admin'Table, CloudBigtable'Admin,
               CloudBigtable'Admin'Table, CloudPlatform'FullControl]
        requestClient BigtableAdminProjectsInstancesTablesCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy BigtableAdminProjectsInstancesTablesCreateResource)
                      Core.mempty
