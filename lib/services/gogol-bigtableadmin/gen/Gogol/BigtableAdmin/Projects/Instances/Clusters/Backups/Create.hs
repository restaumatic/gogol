...
newBigtableAdminProjectsInstancesClustersBackupsCreate 
    ...
    -> BigtableAdminProjectsInstancesClustersBackupsCreate
newBigtableAdminProjectsInstancesClustersBackupsCreate parent
  payload
  = BigtableAdminProjectsInstancesClustersBackupsCreate{xgafv =
                                                          Core.Nothing,
...
instance Core.GoogleRequest
           BigtableAdminProjectsInstancesClustersBackupsCreate
         where
        type Rs BigtableAdminProjectsInstancesClustersBackupsCreate =
             Operation
        type Scopes BigtableAdminProjectsInstancesClustersBackupsCreate =
             '[Bigtable'Admin, Bigtable'Admin'Table, CloudBigtable'Admin,
               CloudBigtable'Admin'Table, CloudPlatform'FullControl]
        requestClient
          BigtableAdminProjectsInstancesClustersBackupsCreate{..}
          = go parent xgafv accessToken backupId callback uploadType
              uploadProtocol
