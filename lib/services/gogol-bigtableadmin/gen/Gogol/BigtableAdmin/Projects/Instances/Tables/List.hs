                   ...
                   Core.QueryParam "pageToken" Core.Text Core.:>
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "view" ProjectsInstancesTablesListView Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] ListTablesResponse
...
newBigtableAdminProjectsInstancesTablesList parent
  = BigtableAdminProjectsInstancesTablesList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           BigtableAdminProjectsInstancesTablesList
         where
        type Rs BigtableAdminProjectsInstancesTablesList =
             ListTablesResponse
        type Scopes BigtableAdminProjectsInstancesTablesList =
             '[Bigtable'Admin, Bigtable'Admin'Table, CloudBigtable'Admin,
               CloudBigtable'Admin'Table, CloudPlatform'FullControl,
               CloudPlatform'ReadOnly]
        requestClient BigtableAdminProjectsInstancesTablesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy BigtableAdminProjectsInstancesTablesListResource)
                      Core.mempty
