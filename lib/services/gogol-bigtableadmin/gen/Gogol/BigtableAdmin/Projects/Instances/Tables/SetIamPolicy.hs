...
newBigtableAdminProjectsInstancesTablesSetIamPolicy 
    ...
    -> BigtableAdminProjectsInstancesTablesSetIamPolicy
newBigtableAdminProjectsInstancesTablesSetIamPolicy payload
  resource
  = BigtableAdminProjectsInstancesTablesSetIamPolicy{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           BigtableAdminProjectsInstancesTablesSetIamPolicy
         where
        type Rs BigtableAdminProjectsInstancesTablesSetIamPolicy = Policy
        type Scopes BigtableAdminProjectsInstancesTablesSetIamPolicy =
             '[Bigtable'Admin, Bigtable'Admin'Table, CloudBigtable'Admin,
               CloudBigtable'Admin'Table, CloudPlatform'FullControl]
        requestClient BigtableAdminProjectsInstancesTablesSetIamPolicy{..}
