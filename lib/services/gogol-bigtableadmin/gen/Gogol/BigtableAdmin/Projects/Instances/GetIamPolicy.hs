...
-- |
-- Module      : Gogol.BigtableAdmin.Projects.Instances.GetIamPolicy
...
-- 'BigtableAdminProjectsInstancesGetIamPolicy' request conforms to.
type BigtableAdminProjectsInstancesGetIamPolicyResource =
     "v2" Core.:>
...
-- | Gets the access control policy for an instance resource. Returns an empty policy if an instance exists but does not have a policy set.
--
-- /See:/ 'newBigtableAdminProjectsInstancesGetIamPolicy' smart constructor.
data BigtableAdminProjectsInstancesGetIamPolicy = BigtableAdminProjectsInstancesGetIamPolicy
    {
      -- | V1 error format.
...
-- | Creates a value of 'BigtableAdminProjectsInstancesGetIamPolicy' with the minimum fields required to make a request.
newBigtableAdminProjectsInstancesGetIamPolicy 
    :: 
                                              GetIamPolicyRequest
...
newBigtableAdminProjectsInstancesGetIamPolicy payload resource
  = BigtableAdminProjectsInstancesGetIamPolicy{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           BigtableAdminProjectsInstancesGetIamPolicy
         where
        type Rs BigtableAdminProjectsInstancesGetIamPolicy = Policy
        type Scopes BigtableAdminProjectsInstancesGetIamPolicy =
             '[Bigtable'Admin, Bigtable'Admin'Cluster, Bigtable'Admin'Instance,
               CloudBigtable'Admin, CloudBigtable'Admin'Cluster,
               CloudPlatform'FullControl]
        requestClient BigtableAdminProjectsInstancesGetIamPolicy{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy BigtableAdminProjectsInstancesGetIamPolicyResource)
                      Core.mempty
