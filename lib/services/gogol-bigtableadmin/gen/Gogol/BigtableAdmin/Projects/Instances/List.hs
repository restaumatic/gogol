...
newBigtableAdminProjectsInstancesList parent
  = BigtableAdminProjectsInstancesList{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       pageToken = Core.Nothing, parent = parent,
                                       uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest BigtableAdminProjectsInstancesList
         where
        type Rs BigtableAdminProjectsInstancesList = ListInstancesResponse
        type Scopes BigtableAdminProjectsInstancesList =
