                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] RestoreTableRequest Core.:>
...
newBigtableAdminProjectsInstancesTablesRestore parent payload
  = BigtableAdminProjectsInstancesTablesRestore{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           BigtableAdminProjectsInstancesTablesRestore
         where
        type Rs BigtableAdminProjectsInstancesTablesRestore = Operation
        type Scopes BigtableAdminProjectsInstancesTablesRestore =
             '[Bigtable'Admin, Bigtable'Admin'Table, CloudBigtable'Admin,
               CloudBigtable'Admin'Table, CloudPlatform'FullControl]
        requestClient BigtableAdminProjectsInstancesTablesRestore{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy BigtableAdminProjectsInstancesTablesRestoreResource)
                      Core.mempty
