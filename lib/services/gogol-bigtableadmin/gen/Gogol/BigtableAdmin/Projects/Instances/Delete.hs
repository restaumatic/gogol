...
newBigtableAdminProjectsInstancesDelete name
  = BigtableAdminProjectsInstancesDelete{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         name = name, uploadType = Core.Nothing,
                                         uploadProtocol = Core.Nothing}
instance Core.GoogleRequest BigtableAdminProjectsInstancesDelete
         where
        ...
        requestClient BigtableAdminProjectsInstancesDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy BigtableAdminProjectsInstancesDeleteResource)
                      Core.mempty
