...
newBigtableAdminProjectsInstancesLogicalViewsSetIamPolicy 
    ...
    -> BigtableAdminProjectsInstancesLogicalViewsSetIamPolicy
newBigtableAdminProjectsInstancesLogicalViewsSetIamPolicy payload
  resource
  = BigtableAdminProjectsInstancesLogicalViewsSetIamPolicy{xgafv =
                                                             Core.Nothing,
...
instance Core.GoogleRequest
           BigtableAdminProjectsInstancesLogicalViewsSetIamPolicy
         where
        type Rs BigtableAdminProjectsInstancesLogicalViewsSetIamPolicy =
             Policy
        type Scopes BigtableAdminProjectsInstancesLogicalViewsSetIamPolicy
             =
