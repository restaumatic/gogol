...
newBigtableAdminProjectsInstancesClustersCreate parent payload
  = BigtableAdminProjectsInstancesClustersCreate{xgafv =
                                                   Core.Nothing,
                                                 accessToken = Core.Nothing,
                                                 callback = Core.Nothing, clusterId = Core.Nothing,
...
instance Core.GoogleRequest
           BigtableAdminProjectsInstancesClustersCreate
         where
        type Rs BigtableAdminProjectsInstancesClustersCreate = Operation
        type Scopes BigtableAdminProjectsInstancesClustersCreate =
             '[Bigtable'Admin, Bigtable'Admin'Cluster, Bigtable'Admin'Instance,
               CloudBigtable'Admin, CloudBigtable'Admin'Cluster,
               CloudPlatform'FullControl]
        requestClient BigtableAdminProjectsInstancesClustersCreate{..}
          = go parent xgafv accessToken callback clusterId uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy BigtableAdminProjectsInstancesClustersCreateResource)
                      Core.mempty
