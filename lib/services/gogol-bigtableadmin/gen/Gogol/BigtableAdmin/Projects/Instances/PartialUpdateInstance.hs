...
newBigtableAdminProjectsInstancesPartialUpdateInstance name payload
  = BigtableAdminProjectsInstancesPartialUpdateInstance{xgafv =
                                                          Core.Nothing,
...
instance Core.GoogleRequest
           BigtableAdminProjectsInstancesPartialUpdateInstance
         where
        type Rs BigtableAdminProjectsInstancesPartialUpdateInstance =
             Operation
        type Scopes BigtableAdminProjectsInstancesPartialUpdateInstance =
