...
-- |
-- Module      : Gogol.BigtableAdmin.Projects.Instances.Tables.CheckConsistency
...
type BigtableAdminProjectsInstancesTablesCheckConsistencyResource =
     "v2" Core.:>
       Core.CaptureMode "name" "checkConsistency" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] CheckConsistencyRequest Core.:>
                       Core.Post '[Core.JSON] CheckConsistencyResponse
...
newBigtableAdminProjectsInstancesTablesCheckConsistency 
    ...
    -> BigtableAdminProjectsInstancesTablesCheckConsistency
newBigtableAdminProjectsInstancesTablesCheckConsistency name
  payload
  = BigtableAdminProjectsInstancesTablesCheckConsistency{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           BigtableAdminProjectsInstancesTablesCheckConsistency
         where
        type Rs BigtableAdminProjectsInstancesTablesCheckConsistency =
             CheckConsistencyResponse
        type Scopes BigtableAdminProjectsInstancesTablesCheckConsistency =
