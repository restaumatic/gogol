...
newBigtableAdminProjectsInstancesTablesTestIamPermissions 
    ...
    -> BigtableAdminProjectsInstancesTablesTestIamPermissions
newBigtableAdminProjectsInstancesTablesTestIamPermissions payload
  resource
  = BigtableAdminProjectsInstancesTablesTestIamPermissions{xgafv =
                                                             Core.Nothing,
...
instance Core.GoogleRequest
           BigtableAdminProjectsInstancesTablesTestIamPermissions
         where
        type Rs BigtableAdminProjectsInstancesTablesTestIamPermissions =
             TestIamPermissionsResponse
        type Scopes BigtableAdminProjectsInstancesTablesTestIamPermissions
             =
