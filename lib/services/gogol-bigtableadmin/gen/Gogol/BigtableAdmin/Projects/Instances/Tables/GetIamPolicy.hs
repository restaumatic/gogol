...
newBigtableAdminProjectsInstancesTablesGetIamPolicy 
    ...
    -> BigtableAdminProjectsInstancesTablesGetIamPolicy
newBigtableAdminProjectsInstancesTablesGetIamPolicy payload
  resource
  = BigtableAdminProjectsInstancesTablesGetIamPolicy{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           BigtableAdminProjectsInstancesTablesGetIamPolicy
         where
        type Rs BigtableAdminProjectsInstancesTablesGetIamPolicy = Policy
        type Scopes BigtableAdminProjectsInstancesTablesGetIamPolicy =
             '[Bigtable'Admin, Bigtable'Admin'Table, CloudBigtable'Admin,
               CloudBigtable'Admin'Table, CloudPlatform'FullControl]
        requestClient BigtableAdminProjectsInstancesTablesGetIamPolicy{..}
