...
newBigtableAdminProjectsInstancesClustersPartialUpdateCluster 
    ...
    -> BigtableAdminProjectsInstancesClustersPartialUpdateCluster
newBigtableAdminProjectsInstancesClustersPartialUpdateCluster name
  payload
  = BigtableAdminProjectsInstancesClustersPartialUpdateCluster{xgafv
                                                                 = Core.Nothing,
...
instance Core.GoogleRequest
           BigtableAdminProjectsInstancesClustersPartialUpdateCluster
         where
        type Rs BigtableAdminProjectsInstancesClustersPartialUpdateCluster
             = Operation
        type Scopes
               BigtableAdminProjectsInstancesClustersPartialUpdateCluster
             =
