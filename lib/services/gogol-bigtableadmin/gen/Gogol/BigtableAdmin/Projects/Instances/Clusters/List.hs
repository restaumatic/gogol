...
-- |
-- Module      : Gogol.BigtableAdmin.Projects.Instances.Clusters.List
...
newBigtableAdminProjectsInstancesClustersList parent
  = BigtableAdminProjectsInstancesClustersList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           BigtableAdminProjectsInstancesClustersList
         where
        type Rs BigtableAdminProjectsInstancesClustersList =
             ListClustersResponse
        type Scopes BigtableAdminProjectsInstancesClustersList =
             '[Bigtable'Admin, Bigtable'Admin'Cluster, Bigtable'Admin'Instance,
               CloudBigtable'Admin, CloudBigtable'Admin'Cluster,
               CloudPlatform'FullControl, CloudPlatform'ReadOnly]
        requestClient BigtableAdminProjectsInstancesClustersList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy BigtableAdminProjectsInstancesClustersListResource)
                      Core.mempty
