...
newBigtableAdminProjectsInstancesTablesAuthorizedViewsList parent
  = BigtableAdminProjectsInstancesTablesAuthorizedViewsList{xgafv =
                                                              Core.Nothing,
...
instance Core.GoogleRequest
           BigtableAdminProjectsInstancesTablesAuthorizedViewsList
         where
        type Rs BigtableAdminProjectsInstancesTablesAuthorizedViewsList =
             ListAuthorizedViewsResponse
        type Scopes BigtableAdminProjectsInstancesTablesAuthorizedViewsList
             =
