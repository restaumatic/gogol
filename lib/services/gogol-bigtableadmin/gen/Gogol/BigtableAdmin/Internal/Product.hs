...
newCreateBackupMetadata 
    ::  CreateBackupMetadata
newCreateBackupMetadata
  = CreateBackupMetadata{endTime = Core.Nothing,
                         finishTime = Core.Nothing, name = Core.Nothing,
                         requestTime = Core.Nothing, sourceTable = Core.Nothing,
                         startTime = Core.Nothing}
          ...
          = Core.withObject "CreateBackupMetadata"
              (\ o ->
                 CreateBackupMetadata Core.<$>
                   (o Core..:? "endTime") Core.<*> (o Core..:? "finishTime") Core.<*>
                     (o Core..:? "name")
                     Core.<*> (o Core..:? "requestTime")
                     Core.<*> (o Core..:? "sourceTable")
                     Core.<*> (o Core..:? "startTime"))
...
newCreateLogicalViewMetadata
  = CreateLogicalViewMetadata{endTime = Core.Nothing,
                              finishTime = Core.Nothing, originalRequest = Core.Nothing,
                              requestTime = Core.Nothing, startTime = Core.Nothing}
...
--
-- /See:/ 'newCreateSchemaBundleMetadata' smart constructor.
data CreateSchemaBundleMetadata = CreateSchemaBundleMetadata
    {
      -- | The time at which the operation failed or was completed successfully.
      finishTime :: (Core.Maybe Core.DateTime)
...
-- | Creates a value of 'CreateSchemaBundleMetadata' with the minimum fields required to make a request.
newCreateSchemaBundleMetadata 
    ::  CreateSchemaBundleMetadata
newCreateSchemaBundleMetadata
  = CreateSchemaBundleMetadata{finishTime = Core.Nothing,
                               name = Core.Nothing, requestTime = Core.Nothing}
instance Core.FromJSON CreateSchemaBundleMetadata where
        parseJSON
          = Core.withObject "CreateSchemaBundleMetadata"
              (\ o ->
                 CreateSchemaBundleMetadata Core.<$>
                   (o Core..:? "finishTime") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "requestTime"))

instance Core.ToJSON CreateSchemaBundleMetadata where
        toJSON CreateSchemaBundleMetadata{..}
          = Core.object
              (Core.catMaybes
                 [("finishTime" Core..=) Core.<$> finishTime,
                  ("name" Core..=) Core.<$> name,
...
--
-- /See:/ 'newGoogleBigtableAdminV2MaterializedViewClusterState' smart constructor.
newtype GoogleBigtableAdminV2MaterializedViewClusterState = GoogleBigtableAdminV2MaterializedViewClusterState
    {
      -- | Output only. The state of the materialized view in this cluster.
      replicationState :: (Core.Maybe
   GoogleBigtableAdminV2MaterializedViewClusterState_ReplicationState)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'GoogleBigtableAdminV2MaterializedViewClusterState' with the minimum fields required to make a request.
newGoogleBigtableAdminV2MaterializedViewClusterState 
    :: 
                                                     GoogleBigtableAdminV2MaterializedViewClusterState
newGoogleBigtableAdminV2MaterializedViewClusterState
  = GoogleBigtableAdminV2MaterializedViewClusterState{replicationState
                                                        = Core.Nothing}
instance Core.FromJSON
           GoogleBigtableAdminV2MaterializedViewClusterState
         where
        parseJSON
          = Core.withObject
              "GoogleBigtableAdminV2MaterializedViewClusterState"
              (\ o ->
                 GoogleBigtableAdminV2MaterializedViewClusterState Core.<$>
                   (o Core..:? "replicationState"))

instance Core.ToJSON
           GoogleBigtableAdminV2MaterializedViewClusterState
         where
        toJSON GoogleBigtableAdminV2MaterializedViewClusterState{..}
          = Core.object
              (Core.catMaybes
                 [("replicationState" Core..=) Core.<$> replicationState])
...
--
-- /See:/ 'newGoogleBigtableAdminV2TypeEnum' smart constructor.
data GoogleBigtableAdminV2TypeEnum = GoogleBigtableAdminV2TypeEnum
    {
      -- | The fully qualified name of the protobuf enum message, including package. In the format of \"foo.bar.EnumMessage\".
      enumName :: (Core.Maybe Core.Text)
      -- | The ID of the schema bundle that this enum is defined in.
    , schemaBundleId :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'GoogleBigtableAdminV2TypeEnum' with the minimum fields required to make a request.
newGoogleBigtableAdminV2TypeEnum 
    ::  GoogleBigtableAdminV2TypeEnum
newGoogleBigtableAdminV2TypeEnum
  = GoogleBigtableAdminV2TypeEnum{enumName = Core.Nothing,
                                  schemaBundleId = Core.Nothing}
instance Core.FromJSON GoogleBigtableAdminV2TypeEnum where
        parseJSON
          = Core.withObject "GoogleBigtableAdminV2TypeEnum"
              (\ o ->
                 GoogleBigtableAdminV2TypeEnum Core.<$>
                   (o Core..:? "enumName") Core.<*> (o Core..:? "schemaBundleId"))

instance Core.ToJSON GoogleBigtableAdminV2TypeEnum where
        toJSON GoogleBigtableAdminV2TypeEnum{..}
          = Core.object
              (Core.catMaybes
                 [("enumName" Core..=) Core.<$> enumName,
                  ("schemaBundleId" Core..=) Core.<$> schemaBundleId])
...
--
-- /See:/ 'newGoogleBigtableAdminV2TypeProto' smart constructor.
data GoogleBigtableAdminV2TypeProto = GoogleBigtableAdminV2TypeProto
    {
      -- | The fully qualified name of the protobuf message, including package. In the format of \"foo.bar.Message\".
      messageName :: (Core.Maybe Core.Text)
      -- | The ID of the schema bundle that this proto is defined in.
    , schemaBundleId :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'GoogleBigtableAdminV2TypeProto' with the minimum fields required to make a request.
newGoogleBigtableAdminV2TypeProto 
    ::  GoogleBigtableAdminV2TypeProto
newGoogleBigtableAdminV2TypeProto
  = GoogleBigtableAdminV2TypeProto{messageName = Core.Nothing,
                                   schemaBundleId = Core.Nothing}
instance Core.FromJSON GoogleBigtableAdminV2TypeProto where
        parseJSON
          = Core.withObject "GoogleBigtableAdminV2TypeProto"
              (\ o ->
                 GoogleBigtableAdminV2TypeProto Core.<$>
                   (o Core..:? "messageName") Core.<*> (o Core..:? "schemaBundleId"))

instance Core.ToJSON GoogleBigtableAdminV2TypeProto where
        toJSON GoogleBigtableAdminV2TypeProto{..}
          = Core.object
              (Core.catMaybes
                 [("messageName" Core..=) Core.<$> messageName,
                  ("schemaBundleId" Core..=) Core.<$> schemaBundleId])
...
newListOperationsResponse
  = ListOperationsResponse{nextPageToken = Core.Nothing,
                           operations = Core.Nothing, unreachable = Core.Nothing}
...
--
-- /See:/ 'newListSchemaBundlesResponse' smart constructor.
data ListSchemaBundlesResponse = ListSchemaBundlesResponse
    {
      -- | A token, which can be sent as @page_token@ to retrieve the next page. If this field is omitted, there are no subsequent pages.
      nextPageToken :: (Core.Maybe Core.Text)
      -- | The schema bundles from the specified table.
    , schemaBundles :: (Core.Maybe [SchemaBundle])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'ListSchemaBundlesResponse' with the minimum fields required to make a request.
newListSchemaBundlesResponse 
    ::  ListSchemaBundlesResponse
newListSchemaBundlesResponse
  = ListSchemaBundlesResponse{nextPageToken = Core.Nothing,
                              schemaBundles = Core.Nothing}
instance Core.FromJSON ListSchemaBundlesResponse where
        parseJSON
          = Core.withObject "ListSchemaBundlesResponse"
              (\ o ->
                 ListSchemaBundlesResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "schemaBundles"))

instance Core.ToJSON ListSchemaBundlesResponse where
        toJSON ListSchemaBundlesResponse{..}
          = Core.object
              (Core.catMaybes
                 [("nextPageToken" Core..=) Core.<$> nextPageToken,
                  ("schemaBundles" Core..=) Core.<$> schemaBundles])
...
data MaterializedView = MaterializedView
    {
      ...
      clusterStates :: (Core.Maybe MaterializedView_ClusterStates)
...
newMaterializedView 
    ::  MaterializedView
newMaterializedView
  = MaterializedView{clusterStates = Core.Nothing,
                     deletionProtection = Core.Nothing, etag = Core.Nothing,
                     name = Core.Nothing, query = Core.Nothing}
...
-- | Output only. Map from cluster ID to per-cluster materialized view state. If it could not be determined whether or not the materialized view has data in a particular cluster (for example, if its zone is unavailable), then there will be an entry for the cluster with @STATE_NOT_KNOWN@ state. Views: @REPLICATION_VIEW@, @FULL@.
--
-- /See:/ 'newMaterializedView_ClusterStates' smart constructor.
newtype MaterializedView_ClusterStates = MaterializedView_ClusterStates
    {
...
-- | Creates a value of 'MaterializedView_ClusterStates' with the minimum fields required to make a request.
newMaterializedView_ClusterStates 
    :: 
                                  Core.HashMap Core.Text
                                    GoogleBigtableAdminV2MaterializedViewClusterState
       -- ^  See 'additional'.
    -> MaterializedView_ClusterStates
newMaterializedView_ClusterStates additional
  = MaterializedView_ClusterStates{additional = additional}
instance Core.FromJSON MaterializedView_ClusterStates where
        parseJSON
          = Core.withObject "MaterializedView_ClusterStates"
              (\ o ->
                 MaterializedView_ClusterStates Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON MaterializedView_ClusterStates where
        toJSON MaterializedView_ClusterStates{..} = Core.toJSON additional
...
--
-- /See:/ 'newProtoSchema' smart constructor.
newtype ProtoSchema = ProtoSchema
    {
      -- | Required. Contains a protobuf-serialized <https://github.com/protocolbuffers/protobuf/blob/main/src/google/protobuf/descriptor.proto google.protobuf.FileDescriptorSet>, which could include multiple proto files. To generate it, <https://grpc.io/docs/protoc-installation/ install> and run @protoc@ with @--include_imports@ and @--descriptor_set_out@. For example, to generate for moon\/shot\/app.proto, run @$protoc --proto_path=\/app_path --proto_path=\/lib_path \\ --include_imports \\ --descriptor_set_out=descriptors.pb \\ moon\/shot\/app.proto@ For more details, see protobuffer <https://developers.google.com/protocol-buffers/docs/techniques#self-description self description>.
      protoDescriptors :: (Core.Maybe Core.Base64)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'ProtoSchema' with the minimum fields required to make a request.
newProtoSchema 
    ::  ProtoSchema
newProtoSchema = ProtoSchema{protoDescriptors = Core.Nothing}
instance Core.FromJSON ProtoSchema where
        parseJSON
          = Core.withObject "ProtoSchema"
              (\ o -> ProtoSchema Core.<$> (o Core..:? "protoDescriptors"))

instance Core.ToJSON ProtoSchema where
        toJSON ProtoSchema{..}
          = Core.object
              (Core.catMaybes
...
--
-- /See:/ 'newSchemaBundle' smart constructor.
data SchemaBundle = SchemaBundle
    ...
    , protoSchema :: (Core.Maybe ProtoSchema)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'SchemaBundle' with the minimum fields required to make a request.
newSchemaBundle 
    ::  SchemaBundle
newSchemaBundle
  = SchemaBundle{etag = Core.Nothing, name = Core.Nothing,
                 protoSchema = Core.Nothing}
instance Core.FromJSON SchemaBundle where
        parseJSON
          = Core.withObject "SchemaBundle"
              (\ o ->
                 SchemaBundle Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "protoSchema"))

instance Core.ToJSON SchemaBundle where
        toJSON SchemaBundle{..}
          = Core.object
              (Core.catMaybes
                 [("etag" Core..=) Core.<$> etag, ("name" Core..=) Core.<$> name,
                  ("protoSchema" Core..=) Core.<$> protoSchema])
...
data Type = Type
    ...
    , dateType :: (Core.Maybe GoogleBigtableAdminV2TypeDate)
      -- | Enum
    , enumType :: (Core.Maybe GoogleBigtableAdminV2TypeEnum)
      -- | Float32
    ...
    , mapType :: (Core.Maybe GoogleBigtableAdminV2TypeMap)
      -- | Proto
    , protoType :: (Core.Maybe GoogleBigtableAdminV2TypeProto)
      -- | String
...
newType
  = Type{aggregateType = Core.Nothing, arrayType = Core.Nothing,
         ...
         dateType = Core.Nothing, enumType = Core.Nothing,
         float32Type = Core.Nothing, float64Type = Core.Nothing,
         int64Type = Core.Nothing, mapType = Core.Nothing,
         protoType = Core.Nothing, stringType = Core.Nothing,
...
--
-- /See:/ 'newUpdateSchemaBundleMetadata' smart constructor.
data UpdateSchemaBundleMetadata = UpdateSchemaBundleMetadata
    {
      -- | The time at which the operation failed or was completed successfully.
      finishTime :: (Core.Maybe Core.DateTime)
      -- | The unique name identifying this schema bundle. Values are of the form @projects\/{project}\/instances\/{instance}\/tables\/{table}\/schemaBundles\/{schema_bundle}@
...
-- | Creates a value of 'UpdateSchemaBundleMetadata' with the minimum fields required to make a request.
newUpdateSchemaBundleMetadata 
    ::  UpdateSchemaBundleMetadata
newUpdateSchemaBundleMetadata
  = UpdateSchemaBundleMetadata{finishTime = Core.Nothing,
                               name = Core.Nothing, requestTime = Core.Nothing}
instance Core.FromJSON UpdateSchemaBundleMetadata where
        parseJSON
          = Core.withObject "UpdateSchemaBundleMetadata"
              (\ o ->
                 UpdateSchemaBundleMetadata Core.<$>
                   (o Core..:? "finishTime") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "requestTime"))

instance Core.ToJSON UpdateSchemaBundleMetadata where
        toJSON UpdateSchemaBundleMetadata{..}
          = Core.object
              (Core.catMaybes
                 [("finishTime" Core..=) Core.<$> finishTime,
                  ("name" Core..=) Core.<$> name,
...
newUpdateTableMetadata 
    ::  UpdateTableMetadata
newUpdateTableMetadata
  = UpdateTableMetadata{endTime = Core.Nothing,
                        finishTime = Core.Nothing, name = Core.Nothing,
                        requestTime = Core.Nothing, startTime = Core.Nothing}
