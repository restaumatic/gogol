...
newAvail 
    ::  Avail
newAvail
  = Avail{altId = Core.Nothing, availId = Core.Nothing,
          captionExemption = Core.Nothing, captionIncluded = Core.Nothing,
          contentId = Core.Nothing, displayName = Core.Nothing,
          encodeId = Core.Nothing, end = Core.Nothing,
          episodeAltId = Core.Nothing, episodeNumber = Core.Nothing,
          episodeTitleInternalAlias = Core.Nothing,
          formatProfile = Core.Nothing, licenseType = Core.Nothing,
          pphNames = Core.Nothing, priceType = Core.Nothing,
          priceValue = Core.Nothing, productId = Core.Nothing,
          ratingReason = Core.Nothing, ratingSystem = Core.Nothing,
          ratingValue = Core.Nothing, releaseDate = Core.Nothing,
          seasonAltId = Core.Nothing, seasonNumber = Core.Nothing,
          seasonTitleInternalAlias = Core.Nothing,
          seriesAltId = Core.Nothing,
          seriesTitleInternalAlias = Core.Nothing, start = Core.Nothing,
          storeLanguage = Core.Nothing, suppressionLiftDate = Core.Nothing,
          territory = Core.Nothing, titleInternalAlias = Core.Nothing,
          videoId = Core.Nothing, workType = Core.Nothing}
instance Core.FromJSON Avail where
        parseJSON
          = Core.withObject "Avail"
              (\ o ->
                 Avail Core.<$>
                   (o Core..:? "altId") Core.<*> (o Core..:? "availId") Core.<*>
                     (o Core..:? "captionExemption")
          ...
          = Core.object
              (Core.catMaybes
                 [("altId" Core..=) Core.<$> altId,
                  ...
                  ("episodeTitleInternalAlias" Core..=) Core.<$>
                  ...
                  ("seasonTitleInternalAlias" Core..=) Core.<$>
                    seasonTitleInternalAlias,
                  ("seriesAltId" Core..=) Core.<$> seriesAltId,
                  ("seriesTitleInternalAlias" Core..=) Core.<$>
...
newListAvailsResponse 
    ::  ListAvailsResponse
newListAvailsResponse
  = ListAvailsResponse{avails = Core.Nothing,
                       nextPageToken = Core.Nothing, totalSize = Core.Nothing}
instance Core.FromJSON ListAvailsResponse where
        parseJSON
          = Core.withObject "ListAvailsResponse"
              (\ o ->
                 ListAvailsResponse Core.<$>
                   (o Core..:? "avails") Core.<*> (o Core..:? "nextPageToken")
...
newListOrdersResponse 
    ::  ListOrdersResponse
newListOrdersResponse
  = ListOrdersResponse{nextPageToken = Core.Nothing,
                       orders = Core.Nothing, totalSize = Core.Nothing}
instance Core.FromJSON ListOrdersResponse where
        parseJSON
          = Core.withObject "ListOrdersResponse"
              (\ o ->
                 ListOrdersResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "orders")
                     Core.<*> (o Core..:? "totalSize"))
...
newListStoreInfosResponse 
    ::  ListStoreInfosResponse
newListStoreInfosResponse
  = ListStoreInfosResponse{nextPageToken = Core.Nothing,
                           storeInfos = Core.Nothing, totalSize = Core.Nothing}
instance Core.FromJSON ListStoreInfosResponse where
        parseJSON
          = Core.withObject "ListStoreInfosResponse"
              (\ o ->
                 ListStoreInfosResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "storeInfos")
                     Core.<*> (o Core..:? "totalSize"))
...
newOrder 
    ::  Order
newOrder
  = Order{approvedTime = Core.Nothing, channelId = Core.Nothing,
          channelName = Core.Nothing, countries = Core.Nothing,
          customId = Core.Nothing, earliestAvailStartTime = Core.Nothing,
          episodeName = Core.Nothing, legacyPriority = Core.Nothing,
          name = Core.Nothing, normalizedPriority = Core.Nothing,
          orderId = Core.Nothing, orderedTime = Core.Nothing,
          pphName = Core.Nothing, priority = Core.Nothing,
          receivedTime = Core.Nothing, rejectionNote = Core.Nothing,
          seasonName = Core.Nothing, showName = Core.Nothing,
          status = Core.Nothing, statusDetail = Core.Nothing,
          studioName = Core.Nothing, type' = Core.Nothing,
...
instance Core.FromJSON Order where
        parseJSON
          = Core.withObject "Order"
              (\ o ->
                 Order Core.<$>
                   (o Core..:? "approvedTime") Core.<*> (o Core..:? "channelId")
...
newStoreInfo 
    ::  StoreInfo
newStoreInfo
  = StoreInfo{audioTracks = Core.Nothing, country = Core.Nothing,
              editLevelEidr = Core.Nothing, episodeNumber = Core.Nothing,
              hasAudio51 = Core.Nothing, hasEstOffer = Core.Nothing,
              hasHdOffer = Core.Nothing, hasInfoCards = Core.Nothing,
              hasSdOffer = Core.Nothing, hasVodOffer = Core.Nothing,
              liveTime = Core.Nothing, mid = Core.Nothing, name = Core.Nothing,
              pphNames = Core.Nothing, seasonId = Core.Nothing,
              seasonName = Core.Nothing, seasonNumber = Core.Nothing,
              showId = Core.Nothing, showName = Core.Nothing,
              studioName = Core.Nothing, subtitles = Core.Nothing,
              titleLevelEidr = Core.Nothing, trailerId = Core.Nothing,
              type' = Core.Nothing, videoId = Core.Nothing}
instance Core.FromJSON StoreInfo where
        parseJSON
          = Core.withObject "StoreInfo"
              (\ o ->
                 StoreInfo Core.<$>
                   (o Core..:? "audioTracks") Core.<*> (o Core..:? "country") Core.<*>
                     (o Core..:? "editLevelEidr")
                     Core.<*> (o Core..:? "episodeNumber")
