...
newPlayMoviesPartnerAccountsOrdersGet accountId orderId
  = PlayMoviesPartnerAccountsOrdersGet{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, accountId = accountId,
                                       bearerToken = Core.Nothing, callback = Core.Nothing,
                                       orderId = orderId, pp = Core.True, uploadType = Core.Nothing,
                                       uploadProtocol = Core.Nothing}
instance Core.GoogleRequest PlayMoviesPartnerAccountsOrdersGet
         where
        type Rs PlayMoviesPartnerAccountsOrdersGet = Order
        type Scopes PlayMoviesPartnerAccountsOrdersGet =
             '[PlaymoviesPartner'Readonly]
        requestClient PlayMoviesPartnerAccountsOrdersGet{..}
          = go accountId orderId xgafv accessToken bearerToken callback
              (Core.Just pp)
              uploadType
              uploadProtocol
