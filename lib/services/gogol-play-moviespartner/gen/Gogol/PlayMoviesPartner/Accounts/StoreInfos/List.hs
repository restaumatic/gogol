               ...
               Core.QueryParam "access_token" Core.Text Core.:>
                 Core.QueryParam "bearer_token" Core.Text Core.:>
                   Core.QueryParam "callback" Core.Text Core.:>
                     Core.QueryParams "countries" Core.Text Core.:>
                       Core.QueryParams "mids" Core.Text Core.:>
                             ...
                             Core.QueryParam "pageToken" Core.Text Core.:>
                               Core.QueryParam "pp" Core.Bool Core.:>
                                 Core.QueryParams "pphNames" Core.Text Core.:>
                                   Core.QueryParams "seasonIds" Core.Text Core.:>
                                     Core.QueryParams "studioNames" Core.Text Core.:>
                                       Core.QueryParam "uploadType" Core.Text Core.:>
                                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                                           Core.QueryParam "videoId" Core.Text Core.:>
                                             Core.QueryParams "videoIds" Core.Text Core.:>
                                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                                 Core.Get '[Core.JSON] ListStoreInfosResponse
...
newPlayMoviesPartnerAccountsStoreInfosList accountId
  = PlayMoviesPartnerAccountsStoreInfosList{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, accountId = accountId,
                                            bearerToken = Core.Nothing, callback = Core.Nothing,
                                            countries = Core.Nothing, mids = Core.Nothing,
                                            name = Core.Nothing, pageSize = Core.Nothing,
                                            pageToken = Core.Nothing, pp = Core.True,
                                            pphNames = Core.Nothing, seasonIds = Core.Nothing,
                                            studioNames = Core.Nothing, uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing, videoId = Core.Nothing,
                                            videoIds = Core.Nothing}
instance Core.GoogleRequest PlayMoviesPartnerAccountsStoreInfosList
         where
        type Rs PlayMoviesPartnerAccountsStoreInfosList =
             ListStoreInfosResponse
        type Scopes PlayMoviesPartnerAccountsStoreInfosList =
             '[PlaymoviesPartner'Readonly]
        requestClient PlayMoviesPartnerAccountsStoreInfosList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy PlayMoviesPartnerAccountsStoreInfosListResource)
                      Core.mempty
