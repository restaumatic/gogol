           ...
           "avails" Core.:>
             Core.QueryParam "$.xgafv" Xgafv Core.:>
               Core.QueryParam "access_token" Core.Text Core.:>
                 Core.QueryParam "altId" Core.Text Core.:>
                   Core.QueryParams "altIds" Core.Text Core.:>
                             ...
                             Core.QueryParam "pp" Core.Bool Core.:>
                               Core.QueryParams "pphNames" Core.Text Core.:>
                                 Core.QueryParams "studioNames" Core.Text Core.:>
                                   Core.QueryParams "territories" Core.Text Core.:>
                                     Core.QueryParam "title" Core.Text Core.:>
                                       Core.QueryParam "uploadType" Core.Text Core.:>
                                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                                           Core.QueryParams "videoIds" Core.Text Core.:>
                                             Core.QueryParam "alt" Core.AltJSON Core.:>
                                               Core.Get '[Core.JSON] ListAvailsResponse
...
newPlayMoviesPartnerAccountsAvailsList accountId
  = PlayMoviesPartnerAccountsAvailsList{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, accountId = accountId,
                                        altId = Core.Nothing, altIds = Core.Nothing,
                                        bearerToken = Core.Nothing, callback = Core.Nothing,
                                        pageSize = Core.Nothing, pageToken = Core.Nothing,
                                        pp = Core.True, pphNames = Core.Nothing,
                                        studioNames = Core.Nothing, territories = Core.Nothing,
                                        title = Core.Nothing, uploadType = Core.Nothing,
                                        uploadProtocol = Core.Nothing, videoIds = Core.Nothing}
instance Core.GoogleRequest PlayMoviesPartnerAccountsAvailsList
         where
        type Rs PlayMoviesPartnerAccountsAvailsList = ListAvailsResponse
        type Scopes PlayMoviesPartnerAccountsAvailsList =
             '[PlaymoviesPartner'Readonly]
        requestClient PlayMoviesPartnerAccountsAvailsList{..}
          = go accountId xgafv accessToken altId
