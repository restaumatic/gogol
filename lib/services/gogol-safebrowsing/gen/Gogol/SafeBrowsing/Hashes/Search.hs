         ...
         Core.QueryParam "$.xgafv" Xgafv Core.:>
           Core.QueryParam "access_token" Core.Text Core.:>
             Core.QueryParam "callback" Core.Text Core.:>
               Core.QueryParams "hashPrefixes" Core.Base64 Core.:>
...
newSafeBrowsingHashesSearch 
    ::  SafeBrowsingHashesSearch
newSafeBrowsingHashesSearch
  = SafeBrowsingHashesSearch{xgafv = Core.Nothing,
                             accessToken = Core.Nothing, callback = Core.Nothing,
                             hashPrefixes = Core.Nothing, uploadType = Core.Nothing,
                             uploadProtocol = Core.Nothing}
instance Core.GoogleRequest SafeBrowsingHashesSearch where
        type Rs SafeBrowsingHashesSearch =
             GoogleSecuritySafebrowsingV5SearchHashesResponse
