...
newAcl 
    ::  Acl
newAcl
  = Acl{description = Core.Nothing, items = Core.Nothing,
        kind = "plus#acl"}
instance Core.FromJSON Acl where
        parseJSON
          = Core.withObject "Acl"
              (\ o ->
                 Acl Core.<$>
                   (o Core..:? "description") Core.<*> (o Core..:? "items") Core.<*>
                     (o Core..:? "kind" Core..!= "plus#acl"))
...
newActivity_Object
  = Activity_Object{actor = Core.Nothing, attachments = Core.Nothing,
                    ...
                    resharers = Core.Nothing, url = Core.Nothing}
...
newActivity_Object_AttachmentsItem
  = Activity_Object_AttachmentsItem{content = Core.Nothing,
                                    ...
                                    thumbnails = Core.Nothing, url = Core.Nothing}
...
newPerson 
    ::  Person
newPerson
  = Person{aboutMe = Core.Nothing, ageRange = Core.Nothing,
           birthday = Core.Nothing, braggingRights = Core.Nothing,
           circledByCount = Core.Nothing, cover = Core.Nothing,
           currentLocation = Core.Nothing, displayName = Core.Nothing,
           domain = Core.Nothing, emails = Core.Nothing, etag = Core.Nothing,
           gender = Core.Nothing, id = Core.Nothing, image = Core.Nothing,
           isPlusUser = Core.Nothing, kind = "plus#person",
           language = Core.Nothing, name = Core.Nothing,
           nickname = Core.Nothing, objectType = Core.Nothing,
           occupation = Core.Nothing, organizations = Core.Nothing,
           placesLived = Core.Nothing, plusOneCount = Core.Nothing,
           relationshipStatus = Core.Nothing, skills = Core.Nothing,
           tagline = Core.Nothing, url = Core.Nothing, urls = Core.Nothing,
...
instance Core.FromJSON Person where
        parseJSON
          = Core.withObject "Person"
              (\ o ->
                 Person Core.<$>
                   (o Core..:? "aboutMe") Core.<*> (o Core..:? "ageRange") Core.<*>
                     (o Core..:? "birthday")
...
newPerson_AgeRange 
    ::  Person_AgeRange
newPerson_AgeRange
  = Person_AgeRange{max = Core.Nothing, min = Core.Nothing}
...
newPlusAclentryResource 
    ::  PlusAclentryResource
newPlusAclentryResource
  = PlusAclentryResource{displayName = Core.Nothing,
