...
--
-- /See:/ <https://developers.google.com/workspace/slides/ Google Slides API Reference> for @slides.presentations.get@.
module Gogol.Slides.Presentations.Get
    (
    -- * Resource
                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.Get '[Core.JSON] Presentation
...
newSlidesPresentationsGet presentationId
  = SlidesPresentationsGet{xgafv = Core.Nothing,
                           accessToken = Core.Nothing, callback = Core.Nothing,
                           presentationId = presentationId, uploadType = Core.Nothing,
                           uploadProtocol = Core.Nothing}
instance Core.GoogleRequest SlidesPresentationsGet where
        type Rs SlidesPresentationsGet = Presentation
        type Scopes SlidesPresentationsGet =
        ...
        requestClient SlidesPresentationsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy SlidesPresentationsGetResource)
                      Core.mempty
