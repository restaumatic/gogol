...
--
-- /See:/ <https://developers.google.com/workspace/slides/ Google Slides API Reference> for @slides.presentations.create@.
module Gogol.Slides.Presentations.Create
    (
    -- * Resource
...
newSlidesPresentationsCreate payload
  = SlidesPresentationsCreate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest SlidesPresentationsCreate where
        ...
        type Scopes SlidesPresentationsCreate =
             '[Drive'FullControl, Drive'File, Presentations'FullControl]
        requestClient SlidesPresentationsCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy SlidesPresentationsCreateResource)
                      Core.mempty
