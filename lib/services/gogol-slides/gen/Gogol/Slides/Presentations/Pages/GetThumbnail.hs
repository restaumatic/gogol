...
--
-- Generates a thumbnail of the latest version of the specified page in the presentation and returns a URL to the thumbnail image. This request counts as an <https://developers.google.com/workspace/slides/limits expensive read request> for quota purposes.
--
-- /See:/ <https://developers.google.com/workspace/slides/ Google Slides API Reference> for @slides.presentations.pages.getThumbnail@.
module Gogol.Slides.Presentations.Pages.GetThumbnail
    (
    -- * Resource
...
newSlidesPresentationsPagesGetThumbnail pageObjectId presentationId
  = SlidesPresentationsPagesGetThumbnail{xgafv = Core.Nothing,
...
instance Core.GoogleRequest SlidesPresentationsPagesGetThumbnail
         where
        ...
        type Scopes SlidesPresentationsPagesGetThumbnail =
             '[Drive'FullControl, Drive'File, Drive'Readonly,
               Presentations'FullControl, Presentations'Readonly]
        requestClient SlidesPresentationsPagesGetThumbnail{..}
          = go presentationId pageObjectId xgafv accessToken callback
