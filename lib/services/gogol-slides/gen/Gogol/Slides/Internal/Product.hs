...
newAffineTransform 
    ::  AffineTransform
newAffineTransform
  = AffineTransform{scaleX = Core.Nothing, scaleY = Core.Nothing,
                    shearX = Core.Nothing, shearY = Core.Nothing,
                    translateX = Core.Nothing, translateY = Core.Nothing,
                    unit = Core.Nothing}
          ...
          = Core.withObject "AffineTransform"
              (\ o ->
                 AffineTransform Core.<$>
                   (o Core..:? "scaleX") Core.<*> (o Core..:? "scaleY") Core.<*>
                     (o Core..:? "shearX")
                     Core.<*> (o Core..:? "shearY")
...
newAutoText 
    ::  AutoText
newAutoText
  = AutoText{content = Core.Nothing, style = Core.Nothing,
             type' = Core.Nothing}
instance Core.FromJSON AutoText where
        parseJSON
          = Core.withObject "AutoText"
              (\ o ->
                 AutoText Core.<$>
                   (o Core..:? "content") Core.<*> (o Core..:? "style") Core.<*>
                     (o Core..:? "type"))
          ...
          = Core.object
              (Core.catMaybes
                 [("content" Core..=) Core.<$> content,
                  ("style" Core..=) Core.<$> style, ("type" Core..=) Core.<$> type'])
...
newAutofit 
    ::  Autofit
newAutofit
  = Autofit{autofitType = Core.Nothing, fontScale = Core.Nothing,
...
instance Core.FromJSON Autofit where
        parseJSON
          = Core.withObject "Autofit"
              (\ o ->
                 Autofit Core.<$>
                   (o Core..:? "autofitType") Core.<*> (o Core..:? "fontScale")
          ...
          = Core.object
              (Core.catMaybes
                 [("autofitType" Core..=) Core.<$> autofitType,
                  ...
                  ("lineSpacingReduction" Core..=) Core.<$> lineSpacingReduction])
...
newBatchUpdatePresentationRequest 
    ::  BatchUpdatePresentationRequest
newBatchUpdatePresentationRequest
  = BatchUpdatePresentationRequest{requests = Core.Nothing,
...
newBatchUpdatePresentationResponse 
    :: 
                                   BatchUpdatePresentationResponse
newBatchUpdatePresentationResponse
  = BatchUpdatePresentationResponse{presentationId = Core.Nothing,
                                    replies = Core.Nothing, writeControl = Core.Nothing}
instance Core.FromJSON BatchUpdatePresentationResponse where
        parseJSON
          = Core.withObject "BatchUpdatePresentationResponse"
              (\ o ->
                 BatchUpdatePresentationResponse Core.<$>
                   (o Core..:? "presentationId") Core.<*> (o Core..:? "replies")
...
newBullet 
    ::  Bullet
newBullet
  = Bullet{bulletStyle = Core.Nothing, glyph = Core.Nothing,
           listId = Core.Nothing, nestingLevel = Core.Nothing}
instance Core.FromJSON Bullet where
        parseJSON
          = Core.withObject "Bullet"
              (\ o ->
                 Bullet Core.<$>
                   (o Core..:? "bulletStyle") Core.<*> (o Core..:? "glyph") Core.<*>
                     (o Core..:? "listId")
...
newColorStop 
    ::  ColorStop
newColorStop
  = ColorStop{alpha = Core.Nothing, color = Core.Nothing,
...
instance Core.FromJSON ColorStop where
        parseJSON
          = Core.withObject "ColorStop"
              (\ o ->
                 ColorStop Core.<$>
                   (o Core..:? "alpha") Core.<*> (o Core..:? "color") Core.<*>
                     (o Core..:? "position"))
...
newCreateImageRequest 
    ::  CreateImageRequest
newCreateImageRequest
  = CreateImageRequest{elementProperties = Core.Nothing,
                       objectId = Core.Nothing, url = Core.Nothing}
instance Core.FromJSON CreateImageRequest where
        parseJSON
          = Core.withObject "CreateImageRequest"
              (\ o ->
                 CreateImageRequest Core.<$>
                   (o Core..:? "elementProperties") Core.<*> (o Core..:? "objectId")
                     Core.<*> (o Core..:? "url"))
...
instance Core.ToJSON CreateImageRequest where
        toJSON CreateImageRequest{..}
          = Core.object
              (Core.catMaybes
                 [("elementProperties" Core..=) Core.<$> elementProperties,
...
newCreateImageResponse 
    ::  CreateImageResponse
newCreateImageResponse
  = CreateImageResponse{objectId = Core.Nothing}
instance Core.FromJSON CreateImageResponse where
        parseJSON
          = Core.withObject "CreateImageResponse"
              (\ o -> CreateImageResponse Core.<$> (o Core..:? "objectId"))
...
newCreateLineRequest 
    ::  CreateLineRequest
newCreateLineRequest
  = CreateLineRequest{category = Core.Nothing,
                      elementProperties = Core.Nothing, lineCategory = Core.Nothing,
          ...
          = Core.withObject "CreateLineRequest"
              (\ o ->
                 CreateLineRequest Core.<$>
                   (o Core..:? "category") Core.<*> (o Core..:? "elementProperties")
...
instance Core.FromJSON CreateLineResponse where
        parseJSON
          = Core.withObject "CreateLineResponse"
              (\ o -> CreateLineResponse Core.<$> (o Core..:? "objectId"))
...
newCreateParagraphBulletsRequest
  = CreateParagraphBulletsRequest{bulletPreset = Core.Nothing,
                                  cellLocation = Core.Nothing, objectId = Core.Nothing,
          ...
          = Core.withObject "CreateParagraphBulletsRequest"
              (\ o ->
                 CreateParagraphBulletsRequest Core.<$>
                   (o Core..:? "bulletPreset") Core.<*> (o Core..:? "cellLocation")
                     Core.<*> (o Core..:? "objectId")
...
newCreateShapeRequest 
    ::  CreateShapeRequest
newCreateShapeRequest
  = CreateShapeRequest{elementProperties = Core.Nothing,
                       objectId = Core.Nothing, shapeType = Core.Nothing}
...
newCreateShapeResponse 
    ::  CreateShapeResponse
newCreateShapeResponse
  = CreateShapeResponse{objectId = Core.Nothing}
instance Core.FromJSON CreateShapeResponse where
        parseJSON
          = Core.withObject "CreateShapeResponse"
              (\ o -> CreateShapeResponse Core.<$> (o Core..:? "objectId"))
...
newCreateSheetsChartRequest 
    ::  CreateSheetsChartRequest
newCreateSheetsChartRequest
  = CreateSheetsChartRequest{chartId = Core.Nothing,
                             elementProperties = Core.Nothing, linkingMode = Core.Nothing,
                             objectId = Core.Nothing, spreadsheetId = Core.Nothing}
          ...
          = Core.withObject "CreateSheetsChartRequest"
              (\ o ->
                 CreateSheetsChartRequest Core.<$>
                   (o Core..:? "chartId") Core.<*> (o Core..:? "elementProperties")
...
instance Core.FromJSON CreateSheetsChartResponse where
        parseJSON
          = Core.withObject "CreateSheetsChartResponse"
              (\ o -> CreateSheetsChartResponse Core.<$> (o Core..:? "objectId"))
...
newCreateSlideRequest 
    ::  CreateSlideRequest
newCreateSlideRequest
  = CreateSlideRequest{insertionIndex = Core.Nothing,
                       objectId = Core.Nothing, placeholderIdMappings = Core.Nothing,
          ...
          = Core.withObject "CreateSlideRequest"
              (\ o ->
                 CreateSlideRequest Core.<$>
                   (o Core..:? "insertionIndex") Core.<*> (o Core..:? "objectId")
          ...
          = Core.object
              (Core.catMaybes
                 [("insertionIndex" Core..=) Core.<$> insertionIndex,
                  ("objectId" Core..=) Core.<$> objectId,
                  ("placeholderIdMappings" Core..=) Core.<$> placeholderIdMappings,
                  ("slideLayoutReference" Core..=) Core.<$> slideLayoutReference])
...
newCreateSlideResponse 
    ::  CreateSlideResponse
newCreateSlideResponse
  = CreateSlideResponse{objectId = Core.Nothing}
instance Core.FromJSON CreateSlideResponse where
        parseJSON
          = Core.withObject "CreateSlideResponse"
              (\ o -> CreateSlideResponse Core.<$> (o Core..:? "objectId"))
...
newCreateTableRequest 
    ::  CreateTableRequest
newCreateTableRequest
  = CreateTableRequest{columns = Core.Nothing,
                       elementProperties = Core.Nothing, objectId = Core.Nothing,
                       rows = Core.Nothing}
          ...
          = Core.withObject "CreateTableRequest"
              (\ o ->
                 CreateTableRequest Core.<$>
                   (o Core..:? "columns") Core.<*> (o Core..:? "elementProperties")
                     Core.<*> (o Core..:? "objectId")
                     Core.<*> (o Core..:? "rows"))
...
newCreateTableResponse 
    ::  CreateTableResponse
newCreateTableResponse
  = CreateTableResponse{objectId = Core.Nothing}
instance Core.FromJSON CreateTableResponse where
        parseJSON
          = Core.withObject "CreateTableResponse"
              (\ o -> CreateTableResponse Core.<$> (o Core..:? "objectId"))
...
newCreateVideoRequest 
    ::  CreateVideoRequest
newCreateVideoRequest
  = CreateVideoRequest{elementProperties = Core.Nothing,
                       id = Core.Nothing, objectId = Core.Nothing, source = Core.Nothing}
instance Core.FromJSON CreateVideoRequest where
        parseJSON
          = Core.withObject "CreateVideoRequest"
              (\ o ->
                 CreateVideoRequest Core.<$>
                   (o Core..:? "elementProperties") Core.<*> (o Core..:? "id")
                     Core.<*> (o Core..:? "objectId")
                     Core.<*> (o Core..:? "source"))
...
instance Core.ToJSON CreateVideoRequest where
        toJSON CreateVideoRequest{..}
          = Core.object
              (Core.catMaybes
                 [("elementProperties" Core..=) Core.<$> elementProperties,
                  ("id" Core..=) Core.<$> id, ("objectId" Core..=) Core.<$> objectId,
...
newCreateVideoResponse 
    ::  CreateVideoResponse
newCreateVideoResponse
  = CreateVideoResponse{objectId = Core.Nothing}
instance Core.FromJSON CreateVideoResponse where
        parseJSON
          = Core.withObject "CreateVideoResponse"
              (\ o -> CreateVideoResponse Core.<$> (o Core..:? "objectId"))
...
newCropProperties 
    ::  CropProperties
newCropProperties
  = CropProperties{angle = Core.Nothing, bottomOffset = Core.Nothing,
                   leftOffset = Core.Nothing, rightOffset = Core.Nothing,
...
instance Core.FromJSON CropProperties where
        parseJSON
          = Core.withObject "CropProperties"
              (\ o ->
                 CropProperties Core.<$>
                   (o Core..:? "angle") Core.<*> (o Core..:? "bottomOffset") Core.<*>
                     (o Core..:? "leftOffset")
...
newDeleteObjectRequest 
    ::  DeleteObjectRequest
newDeleteObjectRequest
  = DeleteObjectRequest{objectId = Core.Nothing}
instance Core.FromJSON DeleteObjectRequest where
        parseJSON
          = Core.withObject "DeleteObjectRequest"
              (\ o -> DeleteObjectRequest Core.<$> (o Core..:? "objectId"))
...
newDeleteParagraphBulletsRequest 
    ::  DeleteParagraphBulletsRequest
newDeleteParagraphBulletsRequest
  = DeleteParagraphBulletsRequest{cellLocation = Core.Nothing,
                                  objectId = Core.Nothing, textRange = Core.Nothing}
          ...
          = Core.withObject "DeleteParagraphBulletsRequest"
              (\ o ->
                 DeleteParagraphBulletsRequest Core.<$>
                   (o Core..:? "cellLocation") Core.<*> (o Core..:? "objectId")
                     Core.<*> (o Core..:? "textRange"))
...
newDeleteTableColumnRequest 
    ::  DeleteTableColumnRequest
newDeleteTableColumnRequest
  = DeleteTableColumnRequest{cellLocation = Core.Nothing,
          ...
          = Core.withObject "DeleteTableColumnRequest"
              (\ o ->
                 DeleteTableColumnRequest Core.<$>
                   (o Core..:? "cellLocation") Core.<*> (o Core..:? "tableObjectId"))
...
newDeleteTableRowRequest 
    ::  DeleteTableRowRequest
newDeleteTableRowRequest
  = DeleteTableRowRequest{cellLocation = Core.Nothing,
                          tableObjectId = Core.Nothing}
...
newDeleteTextRequest 
    ::  DeleteTextRequest
newDeleteTextRequest
  = DeleteTextRequest{cellLocation = Core.Nothing,
                      objectId = Core.Nothing, textRange = Core.Nothing}
...
newDuplicateObjectRequest 
    ::  DuplicateObjectRequest
newDuplicateObjectRequest
  = DuplicateObjectRequest{objectId = Core.Nothing,
          ...
          = Core.withObject "DuplicateObjectRequest"
              (\ o ->
                 DuplicateObjectRequest Core.<$>
                   (o Core..:? "objectId") Core.<*> (o Core..:? "objectIds"))
...
instance Core.FromJSON DuplicateObjectRequest_ObjectIds where
        parseJSON
          = Core.withObject "DuplicateObjectRequest_ObjectIds"
              (\ o ->
                 DuplicateObjectRequest_ObjectIds Core.<$> (Core.parseJSONObject o))
...
newDuplicateObjectResponse 
    ::  DuplicateObjectResponse
newDuplicateObjectResponse
  = DuplicateObjectResponse{objectId = Core.Nothing}
instance Core.FromJSON DuplicateObjectResponse where
        parseJSON
          = Core.withObject "DuplicateObjectResponse"
              (\ o -> DuplicateObjectResponse Core.<$> (o Core..:? "objectId"))
...
instance Core.ToJSON Group where
        toJSON Group{..}
          = Core.object
              (Core.catMaybes [("children" Core..=) Core.<$> children])
...
newGroupObjectsRequest 
    ::  GroupObjectsRequest
newGroupObjectsRequest
  = GroupObjectsRequest{childrenObjectIds = Core.Nothing,
...
instance Core.ToJSON GroupObjectsRequest where
        toJSON GroupObjectsRequest{..}
          = Core.object
              (Core.catMaybes
                 [("childrenObjectIds" Core..=) Core.<$> childrenObjectIds,
...
newGroupObjectsResponse 
    ::  GroupObjectsResponse
newGroupObjectsResponse
  = GroupObjectsResponse{objectId = Core.Nothing}
instance Core.FromJSON GroupObjectsResponse where
        parseJSON
          = Core.withObject "GroupObjectsResponse"
              (\ o -> GroupObjectsResponse Core.<$> (o Core..:? "objectId"))
...
newImage 
    ::  Image
newImage
  = Image{contentUrl = Core.Nothing, imageProperties = Core.Nothing,
          placeholder = Core.Nothing, sourceUrl = Core.Nothing}
instance Core.FromJSON Image where
        parseJSON
          = Core.withObject "Image"
              (\ o ->
                 Image Core.<$>
                   (o Core..:? "contentUrl") Core.<*> (o Core..:? "imageProperties")
...
newImageProperties 
    ::  ImageProperties
newImageProperties
  = ImageProperties{brightness = Core.Nothing,
                    contrast = Core.Nothing, cropProperties = Core.Nothing,
                    link = Core.Nothing, outline = Core.Nothing,
                    recolor = Core.Nothing, shadow = Core.Nothing,
          ...
          = Core.withObject "ImageProperties"
              (\ o ->
                 ImageProperties Core.<$>
                   (o Core..:? "brightness") Core.<*> (o Core..:? "contrast") Core.<*>
                     (o Core..:? "cropProperties")
                     Core.<*> (o Core..:? "link")
                     Core.<*> (o Core..:? "outline")
                     Core.<*> (o Core..:? "recolor")
                     Core.<*> (o Core..:? "shadow")
...
newInsertTableColumnsRequest 
    ::  InsertTableColumnsRequest
newInsertTableColumnsRequest
  = InsertTableColumnsRequest{cellLocation = Core.Nothing,
                              insertRight = Core.Nothing, number = Core.Nothing,
                              tableObjectId = Core.Nothing}
          ...
          = Core.withObject "InsertTableColumnsRequest"
              (\ o ->
                 InsertTableColumnsRequest Core.<$>
                   (o Core..:? "cellLocation") Core.<*> (o Core..:? "insertRight")
                     Core.<*> (o Core..:? "number")
...
newInsertTableRowsRequest 
    ::  InsertTableRowsRequest
newInsertTableRowsRequest
  = InsertTableRowsRequest{cellLocation = Core.Nothing,
                           insertBelow = Core.Nothing, number = Core.Nothing,
                           tableObjectId = Core.Nothing}
          ...
          = Core.withObject "InsertTableRowsRequest"
              (\ o ->
                 InsertTableRowsRequest Core.<$>
                   (o Core..:? "cellLocation") Core.<*> (o Core..:? "insertBelow")
                     Core.<*> (o Core..:? "number")
                     Core.<*> (o Core..:? "tableObjectId"))
...
newInsertTextRequest 
    ::  InsertTextRequest
newInsertTextRequest
  = InsertTextRequest{cellLocation = Core.Nothing,
                      insertionIndex = Core.Nothing, objectId = Core.Nothing,
                      text = Core.Nothing}
          ...
          = Core.withObject "InsertTextRequest"
              (\ o ->
                 InsertTextRequest Core.<$>
                   (o Core..:? "cellLocation") Core.<*> (o Core..:? "insertionIndex")
                     Core.<*> (o Core..:? "objectId")
                     Core.<*> (o Core..:? "text"))
...
newLayoutPlaceholderIdMapping 
    ::  LayoutPlaceholderIdMapping
newLayoutPlaceholderIdMapping
  = LayoutPlaceholderIdMapping{layoutPlaceholder = Core.Nothing,
                               layoutPlaceholderObjectId = Core.Nothing, objectId = Core.Nothing}
...
instance Core.ToJSON LayoutPlaceholderIdMapping where
        toJSON LayoutPlaceholderIdMapping{..}
          = Core.object
              (Core.catMaybes
                 [("layoutPlaceholder" Core..=) Core.<$> layoutPlaceholder,
...
newLayoutProperties 
    ::  LayoutProperties
newLayoutProperties
  = LayoutProperties{displayName = Core.Nothing,
                     masterObjectId = Core.Nothing, name = Core.Nothing}
instance Core.FromJSON LayoutProperties where
        parseJSON
          = Core.withObject "LayoutProperties"
              (\ o ->
                 LayoutProperties Core.<$>
                   (o Core..:? "displayName") Core.<*> (o Core..:? "masterObjectId")
                     Core.<*> (o Core..:? "name"))
...
newLayoutReference 
    ::  LayoutReference
newLayoutReference
  = LayoutReference{layoutId = Core.Nothing,
                    predefinedLayout = Core.Nothing}
instance Core.FromJSON LayoutReference where
        parseJSON
          = Core.withObject "LayoutReference"
              (\ o ->
                 LayoutReference Core.<$>
                   (o Core..:? "layoutId") Core.<*> (o Core..:? "predefinedLayout"))
          ...
          = Core.object
              (Core.catMaybes
                 [("layoutId" Core..=) Core.<$> layoutId,
                  ("predefinedLayout" Core..=) Core.<$> predefinedLayout])
...
newLine 
    ::  Line
newLine
  = Line{lineCategory = Core.Nothing, lineProperties = Core.Nothing,
...
instance Core.FromJSON Line where
        parseJSON
          = Core.withObject "Line"
              (\ o ->
                 Line Core.<$>
                   (o Core..:? "lineCategory") Core.<*> (o Core..:? "lineProperties")
...
newLineConnection 
    ::  LineConnection
newLineConnection
  = LineConnection{connectedObjectId = Core.Nothing,
...
instance Core.ToJSON LineConnection where
        toJSON LineConnection{..}
          = Core.object
              (Core.catMaybes
                 [("connectedObjectId" Core..=) Core.<$> connectedObjectId,
                  ("connectionSiteIndex" Core..=) Core.<$> connectionSiteIndex])
...
instance Core.ToJSON LineFill where
        toJSON LineFill{..}
          = Core.object
              (Core.catMaybes [("solidFill" Core..=) Core.<$> solidFill])
...
newLineProperties 
    ::  LineProperties
newLineProperties
  = LineProperties{dashStyle = Core.Nothing, endArrow = Core.Nothing,
                   endConnection = Core.Nothing, lineFill = Core.Nothing,
                   link = Core.Nothing, startArrow = Core.Nothing,
                   startConnection = Core.Nothing, weight = Core.Nothing}
instance Core.FromJSON LineProperties where
        parseJSON
          = Core.withObject "LineProperties"
              (\ o ->
                 LineProperties Core.<$>
                   (o Core..:? "dashStyle") Core.<*> (o Core..:? "endArrow") Core.<*>
                     (o Core..:? "endConnection")
...
newLink 
    ::  Link
newLink
  = Link{pageObjectId = Core.Nothing, relativeLink = Core.Nothing,
         slideIndex = Core.Nothing, url = Core.Nothing}
instance Core.FromJSON Link where
        parseJSON
          = Core.withObject "Link"
              (\ o ->
                 Link Core.<$>
                   (o Core..:? "pageObjectId") Core.<*> (o Core..:? "relativeLink")
...
instance Core.FromJSON List where
        parseJSON
          = Core.withObject "List"
              (\ o ->
                 List Core.<$>
                   (o Core..:? "listId") Core.<*> (o Core..:? "nestingLevel"))
...
newList_NestingLevel 
    :: 
       ...
       -- ^  See 'additional'.
    -> List_NestingLevel
newList_NestingLevel additional
  = List_NestingLevel{additional = additional}
instance Core.FromJSON List_NestingLevel where
        parseJSON
          = Core.withObject "List_NestingLevel"
              (\ o -> List_NestingLevel Core.<$> (Core.parseJSONObject o))
...
instance Core.FromJSON MasterProperties where
        parseJSON
          = Core.withObject "MasterProperties"
              (\ o -> MasterProperties Core.<$> (o Core..:? "displayName"))
...
newMergeTableCellsRequest 
    ::  MergeTableCellsRequest
newMergeTableCellsRequest
  = MergeTableCellsRequest{objectId = Core.Nothing,
          ...
          = Core.withObject "MergeTableCellsRequest"
              (\ o ->
                 MergeTableCellsRequest Core.<$>
                   (o Core..:? "objectId") Core.<*> (o Core..:? "tableRange"))
...
instance Core.FromJSON NestingLevel where
        parseJSON
          = Core.withObject "NestingLevel"
              (\ o -> NestingLevel Core.<$> (o Core..:? "bulletStyle"))

instance Core.ToJSON NestingLevel where
        toJSON NestingLevel{..}
          = Core.object
              (Core.catMaybes [("bulletStyle" Core..=) Core.<$> bulletStyle])
...
newNotesProperties 
    ::  NotesProperties
newNotesProperties
  = NotesProperties{speakerNotesObjectId = Core.Nothing}
instance Core.FromJSON NotesProperties where
        parseJSON
          = Core.withObject "NotesProperties"
              (\ o ->
                 NotesProperties Core.<$> (o Core..:? "speakerNotesObjectId"))

instance Core.ToJSON NotesProperties where
        toJSON NotesProperties{..}
          = Core.object
              (Core.catMaybes
                 [("speakerNotesObjectId" Core..=) Core.<$> speakerNotesObjectId])
...
instance Core.FromJSON OptionalColor where
        parseJSON
          = Core.withObject "OptionalColor"
              (\ o -> OptionalColor Core.<$> (o Core..:? "opaqueColor"))

instance Core.ToJSON OptionalColor where
        toJSON OptionalColor{..}
          = Core.object
              (Core.catMaybes [("opaqueColor" Core..=) Core.<$> opaqueColor])
...
newOutline 
    ::  Outline
newOutline
  = Outline{dashStyle = Core.Nothing, outlineFill = Core.Nothing,
            propertyState = Core.Nothing, weight = Core.Nothing}
instance Core.FromJSON Outline where
        parseJSON
          = Core.withObject "Outline"
              (\ o ->
                 Outline Core.<$>
                   (o Core..:? "dashStyle") Core.<*> (o Core..:? "outlineFill")
...
instance Core.FromJSON OutlineFill where
        parseJSON
          = Core.withObject "OutlineFill"
              (\ o -> OutlineFill Core.<$> (o Core..:? "solidFill"))
...
newPage 
    ::  Page
newPage
  = Page{layoutProperties = Core.Nothing,
         masterProperties = Core.Nothing, notesProperties = Core.Nothing,
         objectId = Core.Nothing, pageElements = Core.Nothing,
         pageProperties = Core.Nothing, pageType = Core.Nothing,
         revisionId = Core.Nothing, slideProperties = Core.Nothing}
...
instance Core.ToJSON Page where
        toJSON Page{..}
          = Core.object
              (Core.catMaybes
                 [("layoutProperties" Core..=) Core.<$> layoutProperties,
                  ("masterProperties" Core..=) Core.<$> masterProperties,
                  ...
                  ("slideProperties" Core..=) Core.<$> slideProperties])
...
newPageBackgroundFill 
    ::  PageBackgroundFill
newPageBackgroundFill
  = PageBackgroundFill{propertyState = Core.Nothing,
                       solidFill = Core.Nothing, stretchedPictureFill = Core.Nothing}
instance Core.FromJSON PageBackgroundFill where
        parseJSON
          = Core.withObject "PageBackgroundFill"
              (\ o ->
                 PageBackgroundFill Core.<$>
                   (o Core..:? "propertyState") Core.<*> (o Core..:? "solidFill")
          ...
          = Core.object
              (Core.catMaybes
                 [("propertyState" Core..=) Core.<$> propertyState,
                  ...
                  ("stretchedPictureFill" Core..=) Core.<$> stretchedPictureFill])
...
data PageElement = PageElement
    ...
    , size :: (Core.Maybe Size)
      -- | A Speaker Spotlight.
    , speakerSpotlight :: (Core.Maybe SpeakerSpotlight)
...
newPageElement 
    ::  PageElement
newPageElement
  = PageElement{description = Core.Nothing,
                elementGroup = Core.Nothing, image = Core.Nothing,
                line = Core.Nothing, objectId = Core.Nothing, shape = Core.Nothing,
                sheetsChart = Core.Nothing, size = Core.Nothing,
                speakerSpotlight = Core.Nothing, table = Core.Nothing,
                title = Core.Nothing, transform = Core.Nothing,
                video = Core.Nothing, wordArt = Core.Nothing}
instance Core.FromJSON PageElement where
        parseJSON
          = Core.withObject "PageElement"
              (\ o ->
                 PageElement Core.<$>
                   (o Core..:? "description") Core.<*> (o Core..:? "elementGroup")
                     Core.<*> (o Core..:? "image")
                     Core.<*> (o Core..:? "line")
                     Core.<*> (o Core..:? "objectId")
                     Core.<*> (o Core..:? "shape")
          ...
          = Core.object
              (Core.catMaybes
                 [("description" Core..=) Core.<$> description,
                  ...
                  ("image" Core..=) Core.<$> image, ("line" Core..=) Core.<$> line,
                  ("objectId" Core..=) Core.<$> objectId,
                  ("shape" Core..=) Core.<$> shape,
                  ("sheetsChart" Core..=) Core.<$> sheetsChart,
                  ("size" Core..=) Core.<$> size,
                  ("speakerSpotlight" Core..=) Core.<$> speakerSpotlight,
                  ("table" Core..=) Core.<$> table, ("title" Core..=) Core.<$> title,
...
newPageElementProperties 
    ::  PageElementProperties
newPageElementProperties
  = PageElementProperties{pageObjectId = Core.Nothing,
                          size = Core.Nothing, transform = Core.Nothing}
instance Core.FromJSON PageElementProperties where
        parseJSON
          = Core.withObject "PageElementProperties"
              (\ o ->
                 PageElementProperties Core.<$>
                   (o Core..:? "pageObjectId") Core.<*> (o Core..:? "size") Core.<*>
                     (o Core..:? "transform"))
...
newPageProperties 
    ::  PageProperties
newPageProperties
  = PageProperties{colorScheme = Core.Nothing,
                   pageBackgroundFill = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("colorScheme" Core..=) Core.<$> colorScheme,
                  ("pageBackgroundFill" Core..=) Core.<$> pageBackgroundFill])
...
newParagraphStyle
  = ParagraphStyle{alignment = Core.Nothing,
                   direction = Core.Nothing, indentEnd = Core.Nothing,
                   indentFirstLine = Core.Nothing, indentStart = Core.Nothing,
                   lineSpacing = Core.Nothing, spaceAbove = Core.Nothing,
...
instance Core.FromJSON ParagraphStyle where
        parseJSON
          = Core.withObject "ParagraphStyle"
              (\ o ->
                 ParagraphStyle Core.<$>
                   (o Core..:? "alignment") Core.<*> (o Core..:? "direction") Core.<*>
                     (o Core..:? "indentEnd")
...
newPlaceholder 
    ::  Placeholder
newPlaceholder
  = Placeholder{index = Core.Nothing, parentObjectId = Core.Nothing,
                type' = Core.Nothing}
instance Core.FromJSON Placeholder where
        parseJSON
          = Core.withObject "Placeholder"
              (\ o ->
                 Placeholder Core.<$>
                   (o Core..:? "index") Core.<*> (o Core..:? "parentObjectId")
                     Core.<*> (o Core..:? "type"))
...
newPresentation 
    ::  Presentation
newPresentation
  = Presentation{layouts = Core.Nothing, locale = Core.Nothing,
                 masters = Core.Nothing, notesMaster = Core.Nothing,
                 pageSize = Core.Nothing, presentationId = Core.Nothing,
                 revisionId = Core.Nothing, slides = Core.Nothing,
                 title = Core.Nothing}
instance Core.FromJSON Presentation where
        parseJSON
          = Core.withObject "Presentation"
              (\ o ->
                 Presentation Core.<$>
                   (o Core..:? "layouts") Core.<*> (o Core..:? "locale") Core.<*>
                     (o Core..:? "masters")
...
newRange 
    ::  Range
newRange
  = Range{endIndex = Core.Nothing, startIndex = Core.Nothing,
          type' = Core.Nothing}
...
newRecolor 
    ::  Recolor
newRecolor
  = Recolor{name = Core.Nothing, recolorStops = Core.Nothing}
instance Core.FromJSON Recolor where
        parseJSON
          = Core.withObject "Recolor"
              (\ o ->
                 Recolor Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "recolorStops"))
...
instance Core.FromJSON RefreshSheetsChartRequest where
        parseJSON
          = Core.withObject "RefreshSheetsChartRequest"
              (\ o -> RefreshSheetsChartRequest Core.<$> (o Core..:? "objectId"))
...
newReplaceAllShapesWithImageRequest 
    :: 
                                    ReplaceAllShapesWithImageRequest
newReplaceAllShapesWithImageRequest
  = ReplaceAllShapesWithImageRequest{containsText = Core.Nothing,
                                     imageReplaceMethod = Core.Nothing, imageUrl = Core.Nothing,
                                     pageObjectIds = Core.Nothing, replaceMethod = Core.Nothing}
instance Core.FromJSON ReplaceAllShapesWithImageRequest where
        parseJSON
...
newReplaceAllShapesWithImageResponse 
    :: 
                                     ReplaceAllShapesWithImageResponse
newReplaceAllShapesWithImageResponse
  = ReplaceAllShapesWithImageResponse{occurrencesChanged =
                                        Core.Nothing}
instance Core.FromJSON ReplaceAllShapesWithImageResponse where
        parseJSON
...
instance Core.ToJSON ReplaceAllShapesWithImageResponse where
...
newReplaceAllShapesWithSheetsChartRequest 
    :: 
                                          ReplaceAllShapesWithSheetsChartRequest
newReplaceAllShapesWithSheetsChartRequest
  = ReplaceAllShapesWithSheetsChartRequest{chartId = Core.Nothing,
                                           containsText = Core.Nothing, linkingMode = Core.Nothing,
                                           pageObjectIds = Core.Nothing,
                                           spreadsheetId = Core.Nothing}
instance Core.FromJSON ReplaceAllShapesWithSheetsChartRequest where
        parseJSON
          = Core.withObject "ReplaceAllShapesWithSheetsChartRequest"
              (\ o ->
                 ReplaceAllShapesWithSheetsChartRequest Core.<$>
                   (o Core..:? "chartId") Core.<*> (o Core..:? "containsText")
                     Core.<*> (o Core..:? "linkingMode")
                     Core.<*> (o Core..:? "pageObjectIds")
                     Core.<*> (o Core..:? "spreadsheetId"))

instance Core.ToJSON ReplaceAllShapesWithSheetsChartRequest where
...
newReplaceAllShapesWithSheetsChartResponse 
    :: 
                                           ReplaceAllShapesWithSheetsChartResponse
newReplaceAllShapesWithSheetsChartResponse
  = ReplaceAllShapesWithSheetsChartResponse{occurrencesChanged =
                                              Core.Nothing}
instance Core.FromJSON ReplaceAllShapesWithSheetsChartResponse
         where
        parseJSON
          = Core.withObject "ReplaceAllShapesWithSheetsChartResponse"
              (\ o ->
                 ReplaceAllShapesWithSheetsChartResponse Core.<$>
                   (o Core..:? "occurrencesChanged"))

instance Core.ToJSON ReplaceAllShapesWithSheetsChartResponse where
...
newReplaceImageRequest
  = ReplaceImageRequest{imageObjectId = Core.Nothing,
                        imageReplaceMethod = Core.Nothing, url = Core.Nothing}
...
newRequest 
    ::  Request'
newRequest
  = Request'{createImage = Core.Nothing, createLine = Core.Nothing,
             createParagraphBullets = Core.Nothing, createShape = Core.Nothing,
             createSheetsChart = Core.Nothing, createSlide = Core.Nothing,
             createTable = Core.Nothing, createVideo = Core.Nothing,
             deleteObject = Core.Nothing, deleteParagraphBullets = Core.Nothing,
             deleteTableColumn = Core.Nothing, deleteTableRow = Core.Nothing,
             deleteText = Core.Nothing, duplicateObject = Core.Nothing,
             groupObjects = Core.Nothing, insertTableColumns = Core.Nothing,
             insertTableRows = Core.Nothing, insertText = Core.Nothing,
             mergeTableCells = Core.Nothing, refreshSheetsChart = Core.Nothing,
             replaceAllShapesWithImage = Core.Nothing,
             replaceAllShapesWithSheetsChart = Core.Nothing,
             replaceAllText = Core.Nothing, replaceImage = Core.Nothing,
             rerouteLine = Core.Nothing, ungroupObjects = Core.Nothing,
...
instance Core.FromJSON Request' where
        parseJSON
          = Core.withObject "Request'"
              (\ o ->
                 Request' Core.<$>
                   (o Core..:? "createImage") Core.<*> (o Core..:? "createLine")
          ...
          = Core.object
              (Core.catMaybes
                 [("createImage" Core..=) Core.<$> createImage,
                  ...
                  ("createSheetsChart" Core..=) Core.<$> createSheetsChart,
                  ...
                  ("updateImageProperties" Core..=) Core.<$> updateImageProperties,
                  ("updateLineCategory" Core..=) Core.<$> updateLineCategory,
                  ("updateLineProperties" Core..=) Core.<$> updateLineProperties,
                  ...
                  ("updatePageProperties" Core..=) Core.<$> updatePageProperties,
                  ("updateParagraphStyle" Core..=) Core.<$> updateParagraphStyle,
                  ("updateShapeProperties" Core..=) Core.<$> updateShapeProperties,
                  ("updateSlideProperties" Core..=) Core.<$> updateSlideProperties,
                  ("updateSlidesPosition" Core..=) Core.<$> updateSlidesPosition,
                  ...
                  ("updateVideoProperties" Core..=) Core.<$> updateVideoProperties])
...
instance Core.FromJSON RerouteLineRequest where
        parseJSON
          = Core.withObject "RerouteLineRequest"
              (\ o -> RerouteLineRequest Core.<$> (o Core..:? "objectId"))
...
newResponse 
    ::  Response
newResponse
  = Response{createImage = Core.Nothing, createLine = Core.Nothing,
             createShape = Core.Nothing, createSheetsChart = Core.Nothing,
             createSlide = Core.Nothing, createTable = Core.Nothing,
             createVideo = Core.Nothing, duplicateObject = Core.Nothing,
...
newShadow 
    ::  Shadow
newShadow
  = Shadow{alignment = Core.Nothing, alpha = Core.Nothing,
           blurRadius = Core.Nothing, color = Core.Nothing,
           propertyState = Core.Nothing, rotateWithShape = Core.Nothing,
           transform = Core.Nothing, type' = Core.Nothing}
instance Core.FromJSON Shadow where
        parseJSON
          = Core.withObject "Shadow"
              (\ o ->
                 Shadow Core.<$>
                   (o Core..:? "alignment") Core.<*> (o Core..:? "alpha") Core.<*>
                     (o Core..:? "blurRadius")
                     Core.<*> (o Core..:? "color")
                     Core.<*> (o Core..:? "propertyState")
...
-- | A PageElement kind representing a generic shape that doesn\'t have a more specific classification. For more information, see <https://developers.google.com/workspace/slides/api/guides/transform Size and position page elements>.
--
...
newShape 
    ::  Shape
newShape
  = Shape{placeholder = Core.Nothing, shapeProperties = Core.Nothing,
          shapeType = Core.Nothing, text = Core.Nothing}
instance Core.FromJSON Shape where
        parseJSON
          = Core.withObject "Shape"
              (\ o ->
                 Shape Core.<$>
                   (o Core..:? "placeholder") Core.<*> (o Core..:? "shapeProperties")
                     Core.<*> (o Core..:? "shapeType")
                     Core.<*> (o Core..:? "text"))
...
newShapeBackgroundFill 
    ::  ShapeBackgroundFill
newShapeBackgroundFill
  = ShapeBackgroundFill{propertyState = Core.Nothing,
...
newShapeProperties 
    ::  ShapeProperties
newShapeProperties
  = ShapeProperties{autofit = Core.Nothing,
                    contentAlignment = Core.Nothing, link = Core.Nothing,
                    outline = Core.Nothing, shadow = Core.Nothing,
          ...
          = Core.withObject "ShapeProperties"
              (\ o ->
                 ShapeProperties Core.<$>
                   (o Core..:? "autofit") Core.<*> (o Core..:? "contentAlignment")
                     Core.<*> (o Core..:? "link")
                     Core.<*> (o Core..:? "outline")
                     Core.<*> (o Core..:? "shadow")
          ...
          = Core.object
              (Core.catMaybes
                 [("autofit" Core..=) Core.<$> autofit,
                  ...
                  ("outline" Core..=) Core.<$> outline,
                  ("shadow" Core..=) Core.<$> shadow,
                  ("shapeBackgroundFill" Core..=) Core.<$> shapeBackgroundFill])
...
newSheetsChart 
    ::  SheetsChart
newSheetsChart
  = SheetsChart{chartId = Core.Nothing, contentUrl = Core.Nothing,
                sheetsChartProperties = Core.Nothing, spreadsheetId = Core.Nothing}
instance Core.FromJSON SheetsChart where
        parseJSON
          = Core.withObject "SheetsChart"
              (\ o ->
                 SheetsChart Core.<$>
                   (o Core..:? "chartId") Core.<*> (o Core..:? "contentUrl") Core.<*>
                     (o Core..:? "sheetsChartProperties")
                     Core.<*> (o Core..:? "spreadsheetId"))
        ...
        toJSON SheetsChart{..}
          = Core.object
              (Core.catMaybes
                 [("chartId" Core..=) Core.<$> chartId,
                  ("contentUrl" Core..=) Core.<$> contentUrl,
                  ("sheetsChartProperties" Core..=) Core.<$> sheetsChartProperties,
                  ("spreadsheetId" Core..=) Core.<$> spreadsheetId])
...
instance Core.FromJSON SheetsChartProperties where
        parseJSON
          = Core.withObject "SheetsChartProperties"
              (\ o ->
                 SheetsChartProperties Core.<$> (o Core..:? "chartImageProperties"))

instance Core.ToJSON SheetsChartProperties where
        toJSON SheetsChartProperties{..}
          = Core.object
              (Core.catMaybes
                 [("chartImageProperties" Core..=) Core.<$> chartImageProperties])
...
newSlideProperties 
    ::  SlideProperties
newSlideProperties
  = SlideProperties{isSkipped = Core.Nothing,
                    layoutObjectId = Core.Nothing, masterObjectId = Core.Nothing,
          ...
          = Core.withObject "SlideProperties"
              (\ o ->
                 SlideProperties Core.<$>
                   (o Core..:? "isSkipped") Core.<*> (o Core..:? "layoutObjectId")
...
newSolidFill 
    ::  SolidFill
newSolidFill
  = SolidFill{alpha = Core.Nothing, color = Core.Nothing}
...
--
-- /See:/ 'newSpeakerSpotlight' smart constructor.
newtype SpeakerSpotlight = SpeakerSpotlight
    {
      -- | The properties of the Speaker Spotlight.
      speakerSpotlightProperties :: (Core.Maybe SpeakerSpotlightProperties)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'SpeakerSpotlight' with the minimum fields required to make a request.
newSpeakerSpotlight 
    ::  SpeakerSpotlight
newSpeakerSpotlight
  = SpeakerSpotlight{speakerSpotlightProperties = Core.Nothing}
instance Core.FromJSON SpeakerSpotlight where
        parseJSON
          = Core.withObject "SpeakerSpotlight"
              (\ o ->
                 SpeakerSpotlight Core.<$>
                   (o Core..:? "speakerSpotlightProperties"))

instance Core.ToJSON SpeakerSpotlight where
        toJSON SpeakerSpotlight{..}
          = Core.object
              (Core.catMaybes
                 [("speakerSpotlightProperties" Core..=) Core.<$>
                    speakerSpotlightProperties])


-- | The properties of the SpeakerSpotlight.
--
-- /See:/ 'newSpeakerSpotlightProperties' smart constructor.
data SpeakerSpotlightProperties = SpeakerSpotlightProperties
    {
...
-- | Creates a value of 'SpeakerSpotlightProperties' with the minimum fields required to make a request.
newSpeakerSpotlightProperties 
    ::  SpeakerSpotlightProperties
newSpeakerSpotlightProperties
  = SpeakerSpotlightProperties{outline = Core.Nothing,
                               shadow = Core.Nothing}
instance Core.FromJSON SpeakerSpotlightProperties where
        parseJSON
          = Core.withObject "SpeakerSpotlightProperties"
              (\ o ->
                 SpeakerSpotlightProperties Core.<$>
                   (o Core..:? "outline") Core.<*> (o Core..:? "shadow"))

instance Core.ToJSON SpeakerSpotlightProperties where
        toJSON SpeakerSpotlightProperties{..}
          = Core.object
              (Core.catMaybes
                 [("outline" Core..=) Core.<$> outline,
                  ("shadow" Core..=) Core.<$> shadow])
...
newStretchedPictureFill 
    ::  StretchedPictureFill
newStretchedPictureFill
  = StretchedPictureFill{contentUrl = Core.Nothing,
                         size = Core.Nothing}
          ...
          = Core.withObject "StretchedPictureFill"
              (\ o ->
                 StretchedPictureFill Core.<$>
                   (o Core..:? "contentUrl") Core.<*> (o Core..:? "size"))
...
newTable 
    ::  Table
newTable
  = Table{columns = Core.Nothing,
          horizontalBorderRows = Core.Nothing, rows = Core.Nothing,
          tableColumns = Core.Nothing, tableRows = Core.Nothing,
...
instance Core.FromJSON Table where
        parseJSON
          = Core.withObject "Table"
              (\ o ->
                 Table Core.<$>
                   (o Core..:? "columns") Core.<*> (o Core..:? "horizontalBorderRows")
                     Core.<*> (o Core..:? "rows")
...
instance Core.ToJSON Table where
        toJSON Table{..}
          = Core.object
              (Core.catMaybes
                 [("columns" Core..=) Core.<$> columns,
                  ("horizontalBorderRows" Core..=) Core.<$> horizontalBorderRows,
                  ("rows" Core..=) Core.<$> rows,
                  ("tableColumns" Core..=) Core.<$> tableColumns,
                  ("tableRows" Core..=) Core.<$> tableRows,
                  ("verticalBorderRows" Core..=) Core.<$> verticalBorderRows])
...
newTableBorderCell 
    ::  TableBorderCell
newTableBorderCell
  = TableBorderCell{location = Core.Nothing,
          ...
          = Core.object
              (Core.catMaybes
                 [("location" Core..=) Core.<$> location,
                  ("tableBorderProperties" Core..=) Core.<$> tableBorderProperties])
...
instance Core.FromJSON TableBorderFill where
        parseJSON
          = Core.withObject "TableBorderFill"
              (\ o -> TableBorderFill Core.<$> (o Core..:? "solidFill"))
...
newTableBorderProperties 
    ::  TableBorderProperties
newTableBorderProperties
  = TableBorderProperties{dashStyle = Core.Nothing,
                          tableBorderFill = Core.Nothing, weight = Core.Nothing}
instance Core.FromJSON TableBorderProperties where
        parseJSON
          = Core.withObject "TableBorderProperties"
              (\ o ->
                 TableBorderProperties Core.<$>
                   (o Core..:? "dashStyle") Core.<*> (o Core..:? "tableBorderFill")
                     Core.<*> (o Core..:? "weight"))
...
instance Core.FromJSON TableBorderRow where
        parseJSON
          = Core.withObject "TableBorderRow"
              (\ o -> TableBorderRow Core.<$> (o Core..:? "tableBorderCells"))

instance Core.ToJSON TableBorderRow where
        toJSON TableBorderRow{..}
          = Core.object
              (Core.catMaybes
                 [("tableBorderCells" Core..=) Core.<$> tableBorderCells])
...
newTableCell 
    ::  TableCell
newTableCell
  = TableCell{columnSpan = Core.Nothing, location = Core.Nothing,
              rowSpan = Core.Nothing, tableCellProperties = Core.Nothing,
              text = Core.Nothing}
instance Core.FromJSON TableCell where
        parseJSON
          = Core.withObject "TableCell"
              (\ o ->
                 TableCell Core.<$>
                   (o Core..:? "columnSpan") Core.<*> (o Core..:? "location") Core.<*>
                     (o Core..:? "rowSpan")
          ...
          = Core.object
              (Core.catMaybes
                 [("columnSpan" Core..=) Core.<$> columnSpan,
                  ...
                  ("tableCellProperties" Core..=) Core.<$> tableCellProperties,
                  ("text" Core..=) Core.<$> text])
...
newTableCellBackgroundFill 
    ::  TableCellBackgroundFill
newTableCellBackgroundFill
  = TableCellBackgroundFill{propertyState = Core.Nothing,
                            solidFill = Core.Nothing}
...
newTableCellProperties 
    ::  TableCellProperties
newTableCellProperties
  = TableCellProperties{contentAlignment = Core.Nothing,
...
newTableRange 
    ::  TableRange
newTableRange
  = TableRange{columnSpan = Core.Nothing, location = Core.Nothing,
...
newTableRow 
    ::  TableRow
newTableRow
  = TableRow{rowHeight = Core.Nothing, tableCells = Core.Nothing,
...
instance Core.FromJSON TableRow where
        parseJSON
          = Core.withObject "TableRow"
              (\ o ->
                 TableRow Core.<$>
                   (o Core..:? "rowHeight") Core.<*> (o Core..:? "tableCells")
          ...
          = Core.object
              (Core.catMaybes
                 [("rowHeight" Core..=) Core.<$> rowHeight,
                  ...
                  ("tableRowProperties" Core..=) Core.<$> tableRowProperties])
...
newTextContent 
    ::  TextContent
newTextContent
  = TextContent{lists = Core.Nothing, textElements = Core.Nothing}
instance Core.FromJSON TextContent where
        parseJSON
          = Core.withObject "TextContent"
              (\ o ->
                 TextContent Core.<$>
                   (o Core..:? "lists") Core.<*> (o Core..:? "textElements"))
...
newTextContent_Lists 
    :: 
       ...
       -- ^  See 'additional'.
    -> TextContent_Lists
newTextContent_Lists additional
  = TextContent_Lists{additional = additional}
instance Core.FromJSON TextContent_Lists where
        parseJSON
          = Core.withObject "TextContent_Lists"
              (\ o -> TextContent_Lists Core.<$> (Core.parseJSONObject o))
...
newTextElement 
    ::  TextElement
newTextElement
  = TextElement{autoText = Core.Nothing, endIndex = Core.Nothing,
                paragraphMarker = Core.Nothing, startIndex = Core.Nothing,
...
instance Core.FromJSON TextElement where
        parseJSON
          = Core.withObject "TextElement"
              (\ o ->
                 TextElement Core.<$>
                   (o Core..:? "autoText") Core.<*> (o Core..:? "endIndex") Core.<*>
                     (o Core..:? "paragraphMarker")
...
newTextStyle
  = TextStyle{backgroundColor = Core.Nothing,
              ...
              fontFamily = Core.Nothing, fontSize = Core.Nothing,
              foregroundColor = Core.Nothing, italic = Core.Nothing,
              link = Core.Nothing, smallCaps = Core.Nothing,
              strikethrough = Core.Nothing, underline = Core.Nothing,
...
newThemeColorPair 
    ::  ThemeColorPair
newThemeColorPair
  = ThemeColorPair{color = Core.Nothing, type' = Core.Nothing}
...
newThumbnail 
    ::  Thumbnail
newThumbnail
  = Thumbnail{contentUrl = Core.Nothing, height = Core.Nothing,
              width = Core.Nothing}
instance Core.FromJSON Thumbnail where
        parseJSON
          = Core.withObject "Thumbnail"
              (\ o ->
                 Thumbnail Core.<$>
                   (o Core..:? "contentUrl") Core.<*> (o Core..:? "height") Core.<*>
                     (o Core..:? "width"))
...
newUngroupObjectsRequest 
    ::  UngroupObjectsRequest
newUngroupObjectsRequest
  = UngroupObjectsRequest{objectIds = Core.Nothing}
instance Core.FromJSON UngroupObjectsRequest where
        parseJSON
          = Core.withObject "UngroupObjectsRequest"
              (\ o -> UngroupObjectsRequest Core.<$> (o Core..:? "objectIds"))
...
newUnmergeTableCellsRequest 
    ::  UnmergeTableCellsRequest
newUnmergeTableCellsRequest
  = UnmergeTableCellsRequest{objectId = Core.Nothing,
                             tableRange = Core.Nothing}
...
newUpdateImagePropertiesRequest 
    ::  UpdateImagePropertiesRequest
newUpdateImagePropertiesRequest
  = UpdateImagePropertiesRequest{fields = Core.Nothing,
                                 imageProperties = Core.Nothing, objectId = Core.Nothing}
          ...
          = Core.withObject "UpdateImagePropertiesRequest"
              (\ o ->
                 UpdateImagePropertiesRequest Core.<$>
                   (o Core..:? "fields") Core.<*> (o Core..:? "imageProperties")
                     Core.<*> (o Core..:? "objectId"))
...
newUpdateLineCategoryRequest 
    ::  UpdateLineCategoryRequest
newUpdateLineCategoryRequest
  = UpdateLineCategoryRequest{lineCategory = Core.Nothing,
                              objectId = Core.Nothing}
          ...
          = Core.withObject "UpdateLineCategoryRequest"
              (\ o ->
                 UpdateLineCategoryRequest Core.<$>
                   (o Core..:? "lineCategory") Core.<*> (o Core..:? "objectId"))
...
newUpdateLinePropertiesRequest 
    ::  UpdateLinePropertiesRequest
newUpdateLinePropertiesRequest
  = UpdateLinePropertiesRequest{fields = Core.Nothing,
                                lineProperties = Core.Nothing, objectId = Core.Nothing}
          ...
          = Core.withObject "UpdateLinePropertiesRequest"
              (\ o ->
                 UpdateLinePropertiesRequest Core.<$>
                   (o Core..:? "fields") Core.<*> (o Core..:? "lineProperties")
                     Core.<*> (o Core..:? "objectId"))
...
newUpdatePageElementAltTextRequest 
    :: 
                                   UpdatePageElementAltTextRequest
newUpdatePageElementAltTextRequest
  = UpdatePageElementAltTextRequest{description = Core.Nothing,
                                    objectId = Core.Nothing, title = Core.Nothing}
instance Core.FromJSON UpdatePageElementAltTextRequest where
        parseJSON
          = Core.withObject "UpdatePageElementAltTextRequest"
              (\ o ->
                 UpdatePageElementAltTextRequest Core.<$>
                   (o Core..:? "description") Core.<*> (o Core..:? "objectId")
                     Core.<*> (o Core..:? "title"))
...
newUpdatePageElementTransformRequest 
    :: 
                                     UpdatePageElementTransformRequest
newUpdatePageElementTransformRequest
  = UpdatePageElementTransformRequest{applyMode = Core.Nothing,
                                      objectId = Core.Nothing, transform = Core.Nothing}
instance Core.FromJSON UpdatePageElementTransformRequest where
        parseJSON
          = Core.withObject "UpdatePageElementTransformRequest"
              (\ o ->
                 UpdatePageElementTransformRequest Core.<$>
                   (o Core..:? "applyMode") Core.<*> (o Core..:? "objectId") Core.<*>
                     (o Core..:? "transform"))

instance Core.ToJSON UpdatePageElementTransformRequest where
...
newUpdatePageElementsZOrderRequest 
    :: 
                                   UpdatePageElementsZOrderRequest
newUpdatePageElementsZOrderRequest
  = UpdatePageElementsZOrderRequest{operation = Core.Nothing,
                                    pageElementObjectIds = Core.Nothing}
instance Core.FromJSON UpdatePageElementsZOrderRequest where
        parseJSON
          ...
          = Core.object
              (Core.catMaybes
                 [("operation" Core..=) Core.<$> operation,
                  ("pageElementObjectIds" Core..=) Core.<$> pageElementObjectIds])
...
newUpdatePagePropertiesRequest 
    ::  UpdatePagePropertiesRequest
newUpdatePagePropertiesRequest
  = UpdatePagePropertiesRequest{fields = Core.Nothing,
                                objectId = Core.Nothing, pageProperties = Core.Nothing}
          ...
          = Core.withObject "UpdatePagePropertiesRequest"
              (\ o ->
                 UpdatePagePropertiesRequest Core.<$>
                   (o Core..:? "fields") Core.<*> (o Core..:? "objectId") Core.<*>
                     (o Core..:? "pageProperties"))
...
newUpdateParagraphStyleRequest 
    ::  UpdateParagraphStyleRequest
newUpdateParagraphStyleRequest
  = UpdateParagraphStyleRequest{cellLocation = Core.Nothing,
                                fields = Core.Nothing, objectId = Core.Nothing,
                                style = Core.Nothing, textRange = Core.Nothing}
          ...
          = Core.withObject "UpdateParagraphStyleRequest"
              (\ o ->
                 UpdateParagraphStyleRequest Core.<$>
                   (o Core..:? "cellLocation") Core.<*> (o Core..:? "fields") Core.<*>
                     (o Core..:? "objectId")
                     Core.<*> (o Core..:? "style")
                     Core.<*> (o Core..:? "textRange"))
...
newUpdateShapePropertiesRequest 
    ::  UpdateShapePropertiesRequest
newUpdateShapePropertiesRequest
  = UpdateShapePropertiesRequest{fields = Core.Nothing,
                                 objectId = Core.Nothing, shapeProperties = Core.Nothing}
...
newUpdateSlidePropertiesRequest 
    ::  UpdateSlidePropertiesRequest
newUpdateSlidePropertiesRequest
  = UpdateSlidePropertiesRequest{fields = Core.Nothing,
                                 objectId = Core.Nothing, slideProperties = Core.Nothing}
...
newUpdateSlidesPositionRequest 
    ::  UpdateSlidesPositionRequest
newUpdateSlidesPositionRequest
  = UpdateSlidesPositionRequest{insertionIndex = Core.Nothing,
...
newUpdateTableBorderPropertiesRequest 
    :: 
                                      UpdateTableBorderPropertiesRequest
newUpdateTableBorderPropertiesRequest
  = UpdateTableBorderPropertiesRequest{borderPosition = Core.Nothing,
                                       fields = Core.Nothing, objectId = Core.Nothing,
                                       tableBorderProperties = Core.Nothing,
                                       tableRange = Core.Nothing}
instance Core.FromJSON UpdateTableBorderPropertiesRequest where
        parseJSON
          = Core.withObject "UpdateTableBorderPropertiesRequest"
              (\ o ->
                 UpdateTableBorderPropertiesRequest Core.<$>
                   (o Core..:? "borderPosition") Core.<*> (o Core..:? "fields")
                     Core.<*> (o Core..:? "objectId")
                     Core.<*> (o Core..:? "tableBorderProperties")
                     Core.<*> (o Core..:? "tableRange"))

instance Core.ToJSON UpdateTableBorderPropertiesRequest where
...
newUpdateTableCellPropertiesRequest 
    :: 
                                    UpdateTableCellPropertiesRequest
newUpdateTableCellPropertiesRequest
  = UpdateTableCellPropertiesRequest{fields = Core.Nothing,
                                     objectId = Core.Nothing, tableCellProperties = Core.Nothing,
                                     tableRange = Core.Nothing}
instance Core.FromJSON UpdateTableCellPropertiesRequest where
        parseJSON
          = Core.withObject "UpdateTableCellPropertiesRequest"
              (\ o ->
                 UpdateTableCellPropertiesRequest Core.<$>
                   (o Core..:? "fields") Core.<*> (o Core..:? "objectId") Core.<*>
                     (o Core..:? "tableCellProperties")
                     Core.<*> (o Core..:? "tableRange"))
...
newUpdateTableRowPropertiesRequest 
    :: 
                                   UpdateTableRowPropertiesRequest
newUpdateTableRowPropertiesRequest
  = UpdateTableRowPropertiesRequest{fields = Core.Nothing,
                                    objectId = Core.Nothing, rowIndices = Core.Nothing,
                                    tableRowProperties = Core.Nothing}
instance Core.FromJSON UpdateTableRowPropertiesRequest where
        parseJSON
...
newUpdateTextStyleRequest 
    ::  UpdateTextStyleRequest
newUpdateTextStyleRequest
  = UpdateTextStyleRequest{cellLocation = Core.Nothing,
                           fields = Core.Nothing, objectId = Core.Nothing,
                           style = Core.Nothing, textRange = Core.Nothing}
...
newUpdateVideoPropertiesRequest 
    ::  UpdateVideoPropertiesRequest
newUpdateVideoPropertiesRequest
  = UpdateVideoPropertiesRequest{fields = Core.Nothing,
                                 objectId = Core.Nothing, videoProperties = Core.Nothing}
        ...
        toJSON UpdateVideoPropertiesRequest{..}
          = Core.object
              (Core.catMaybes
                 [("fields" Core..=) Core.<$> fields,
                  ("objectId" Core..=) Core.<$> objectId,
                  ("videoProperties" Core..=) Core.<$> videoProperties])
...
newVideo 
    ::  Video
newVideo
  = Video{id = Core.Nothing, source = Core.Nothing,
          url = Core.Nothing, videoProperties = Core.Nothing}
instance Core.FromJSON Video where
        parseJSON
          = Core.withObject "Video"
              (\ o ->
                 Video Core.<$>
                   (o Core..:? "id") Core.<*> (o Core..:? "source") Core.<*>
                     (o Core..:? "url")
...
instance Core.ToJSON Video where
        toJSON Video{..}
          = Core.object
              (Core.catMaybes
                 [("id" Core..=) Core.<$> id, ("source" Core..=) Core.<$> source,
                  ("url" Core..=) Core.<$> url,
                  ("videoProperties" Core..=) Core.<$> videoProperties])
...
newVideoProperties 
    ::  VideoProperties
newVideoProperties
  = VideoProperties{autoPlay = Core.Nothing, end = Core.Nothing,
                    mute = Core.Nothing, outline = Core.Nothing, start = Core.Nothing}
instance Core.FromJSON VideoProperties where
        parseJSON
          = Core.withObject "VideoProperties"
              (\ o ->
                 VideoProperties Core.<$>
                   (o Core..:? "autoPlay") Core.<*> (o Core..:? "end") Core.<*>
                     (o Core..:? "mute")
                     Core.<*> (o Core..:? "outline")
                     Core.<*> (o Core..:? "start"))
          ...
          = Core.object
              (Core.catMaybes
                 [("autoPlay" Core..=) Core.<$> autoPlay,
                  ("end" Core..=) Core.<$> end, ("mute" Core..=) Core.<$> mute,
                  ("outline" Core..=) Core.<$> outline,
...
instance Core.ToJSON WordArt where
        toJSON WordArt{..}
          = Core.object
              (Core.catMaybes [("renderedText" Core..=) Core.<$> renderedText])
...
instance Core.FromJSON WriteControl where
        parseJSON
          = Core.withObject "WriteControl"
              (\ o -> WriteControl Core.<$> (o Core..:? "requiredRevisionId"))
