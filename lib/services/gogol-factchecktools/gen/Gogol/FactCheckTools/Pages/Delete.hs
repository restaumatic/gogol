...
newFactCheckToolsPagesDelete name
  = FactCheckToolsPagesDelete{xgafv = Core.Nothing,
...
instance Core.GoogleRequest FactCheckToolsPagesDelete where
        type Rs FactCheckToolsPagesDelete = GoogleProtobufEmpty
        ...
        requestClient FactCheckToolsPagesDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy FactCheckToolsPagesDeleteResource)
                      Core.mempty
