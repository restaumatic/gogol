...
-- |
-- Module      : Gogol.FactCheckTools.Claims.Search
           ...
           Core.QueryParam "access_token" Core.Text Core.:>
             Core.QueryParam "callback" Core.Text Core.:>
               Core.QueryParam "languageCode" Core.Text Core.:>
                 Core.QueryParam "maxAgeDays" Core.Int32 Core.:>
                   Core.QueryParam "offset" Core.Int32 Core.:>
                     Core.QueryParam "pageSize" Core.Int32 Core.:>
                       Core.QueryParam "pageToken" Core.Text Core.:>
                         Core.QueryParam "query" Core.Text Core.:>
                           Core.QueryParam "reviewPublisherSiteFilter" Core.Text Core.:>
...
newFactCheckToolsClaimsSearch 
    ::  FactCheckToolsClaimsSearch
newFactCheckToolsClaimsSearch
  = FactCheckToolsClaimsSearch{xgafv = Core.Nothing,
                               accessToken = Core.Nothing, callback = Core.Nothing,
                               languageCode = Core.Nothing, maxAgeDays = Core.Nothing,
                               offset = Core.Nothing, pageSize = Core.Nothing,
...
instance Core.GoogleRequest FactCheckToolsClaimsSearch where
        type Rs FactCheckToolsClaimsSearch =
             GoogleFactcheckingFactchecktoolsV1alpha1FactCheckedClaimSearchResponse
        type Scopes FactCheckToolsClaimsSearch = '[]
        requestClient FactCheckToolsClaimsSearch{..}
          = go xgafv accessToken callback languageCode maxAgeDays offset
              pageSize
              pageToken
              query
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy FactCheckToolsClaimsSearchResource)
                      Core.mempty
