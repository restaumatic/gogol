...
newMonitoringServicesServiceLevelObjectivesDelete name
  = MonitoringServicesServiceLevelObjectivesDelete{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           MonitoringServicesServiceLevelObjectivesDelete
         where
        type Rs MonitoringServicesServiceLevelObjectivesDelete = Empty
        type Scopes MonitoringServicesServiceLevelObjectivesDelete =
             '[CloudPlatform'FullControl, Monitoring'FullControl]
        requestClient MonitoringServicesServiceLevelObjectivesDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy MonitoringServicesServiceLevelObjectivesDeleteResource)
                      Core.mempty
