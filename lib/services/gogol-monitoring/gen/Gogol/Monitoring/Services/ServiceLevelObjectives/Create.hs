           ...
           Core.QueryParam "$.xgafv" Xgafv Core.:>
             Core.QueryParam "access_token" Core.Text Core.:>
               Core.QueryParam "callback" Core.Text Core.:>
                 Core.QueryParam "serviceLevelObjectiveId" Core.Text Core.:>
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] ServiceLevelObjective Core.:>
                           Core.Post '[Core.JSON] ServiceLevelObjective
...
newMonitoringServicesServiceLevelObjectivesCreate parent payload
  = MonitoringServicesServiceLevelObjectivesCreate{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           MonitoringServicesServiceLevelObjectivesCreate
         where
        type Rs MonitoringServicesServiceLevelObjectivesCreate =
             ServiceLevelObjective
        type Scopes MonitoringServicesServiceLevelObjectivesCreate =
             '[CloudPlatform'FullControl, Monitoring'FullControl]
        requestClient MonitoringServicesServiceLevelObjectivesCreate{..}
          = go parent xgafv accessToken callback serviceLevelObjectiveId
              uploadType
              uploadProtocol
