                     ...
                     Core.QueryParam "pageToken" Core.Text Core.:>
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "view" ServicesServiceLevelObjectivesListView
                             Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Get '[Core.JSON] ListServiceLevelObjectivesResponse
...
newMonitoringServicesServiceLevelObjectivesList parent
  = MonitoringServicesServiceLevelObjectivesList{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
           MonitoringServicesServiceLevelObjectivesList
         where
        type Rs MonitoringServicesServiceLevelObjectivesList =
             ListServiceLevelObjectivesResponse
        type Scopes MonitoringServicesServiceLevelObjectivesList =
             '[CloudPlatform'FullControl, Monitoring'FullControl,
               Monitoring'Read]
        requestClient MonitoringServicesServiceLevelObjectivesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy MonitoringServicesServiceLevelObjectivesListResource)
                      Core.mempty
