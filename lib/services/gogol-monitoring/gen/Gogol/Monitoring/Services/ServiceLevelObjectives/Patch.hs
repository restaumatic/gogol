                   ...
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] ServiceLevelObjective Core.:>
                         Core.Patch '[Core.JSON] ServiceLevelObjective
...
newMonitoringServicesServiceLevelObjectivesPatch name payload
  = MonitoringServicesServiceLevelObjectivesPatch{xgafv =
                                                    Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Rs MonitoringServicesServiceLevelObjectivesPatch =
             ServiceLevelObjective
        type Scopes MonitoringServicesServiceLevelObjectivesPatch =
             '[CloudPlatform'FullControl, Monitoring'FullControl]
        requestClient MonitoringServicesServiceLevelObjectivesPatch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy MonitoringServicesServiceLevelObjectivesPatchResource)
                      Core.mempty
