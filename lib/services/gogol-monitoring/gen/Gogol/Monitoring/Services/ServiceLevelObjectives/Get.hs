             ...
             Core.QueryParam "callback" Core.Text Core.:>
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "view" ServicesServiceLevelObjectivesGetView
                     Core.:>
...
newMonitoringServicesServiceLevelObjectivesGet name
  = MonitoringServicesServiceLevelObjectivesGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes MonitoringServicesServiceLevelObjectivesGet =
             '[CloudPlatform'FullControl, Monitoring'FullControl,
               Monitoring'Read]
        requestClient MonitoringServicesServiceLevelObjectivesGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy MonitoringServicesServiceLevelObjectivesGetResource)
                      Core.mempty
