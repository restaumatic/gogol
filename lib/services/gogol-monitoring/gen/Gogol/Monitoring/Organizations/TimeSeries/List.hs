...
-- |
-- Module      : Gogol.Monitoring.Organizations.TimeSeries.List
...
data MonitoringOrganizationsTimeSeriesList = MonitoringOrganizationsTimeSeriesList
    ...
    , aggregationCrossSeriesReducer :: (Core.Maybe
   OrganizationsTimeSeriesListAggregationCrossSeriesReducer)
...
newMonitoringOrganizationsTimeSeriesList name
  = MonitoringOrganizationsTimeSeriesList{xgafv = Core.Nothing,
                                          ...
                                          view = Core.Nothing}
instance Core.GoogleRequest MonitoringOrganizationsTimeSeriesList
         where
        type Rs MonitoringOrganizationsTimeSeriesList =
             ListTimeSeriesResponse
        type Scopes MonitoringOrganizationsTimeSeriesList =
             '[CloudPlatform'FullControl, Monitoring'FullControl,
               Monitoring'Read]
        requestClient MonitoringOrganizationsTimeSeriesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy MonitoringOrganizationsTimeSeriesListResource)
                      Core.mempty
