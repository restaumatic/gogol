...
newMonitoringProjectsMonitoredResourceDescriptorsGet name
  = MonitoringProjectsMonitoredResourceDescriptorsGet{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           MonitoringProjectsMonitoredResourceDescriptorsGet
         where
        type Rs MonitoringProjectsMonitoredResourceDescriptorsGet =
             MonitoredResourceDescriptor
        type Scopes MonitoringProjectsMonitoredResourceDescriptorsGet =
             '[CloudPlatform'FullControl, Monitoring'FullControl,
               Monitoring'Read, Monitoring'Write]
        requestClient MonitoringProjectsMonitoredResourceDescriptorsGet{..}
