...
newMonitoringProjectsMonitoredResourceDescriptorsList name
  = MonitoringProjectsMonitoredResourceDescriptorsList{xgafv =
                                                         Core.Nothing,
...
instance Core.GoogleRequest
           MonitoringProjectsMonitoredResourceDescriptorsList
         where
        type Rs MonitoringProjectsMonitoredResourceDescriptorsList =
             ListMonitoredResourceDescriptorsResponse
        type Scopes MonitoringProjectsMonitoredResourceDescriptorsList =
