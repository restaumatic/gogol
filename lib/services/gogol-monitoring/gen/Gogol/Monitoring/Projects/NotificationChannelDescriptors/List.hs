...
type MonitoringProjectsNotificationChannelDescriptorsListResource =
     "v3" Core.:>
       Core.Capture "name" Core.Text Core.:>
         "notificationChannelDescriptors" Core.:>
                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] ListNotificationChannelDescriptorsResponse
...
newMonitoringProjectsNotificationChannelDescriptorsList name
  = MonitoringProjectsNotificationChannelDescriptorsList{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           MonitoringProjectsNotificationChannelDescriptorsList
         where
        type Rs MonitoringProjectsNotificationChannelDescriptorsList =
             ListNotificationChannelDescriptorsResponse
        type Scopes MonitoringProjectsNotificationChannelDescriptorsList =
