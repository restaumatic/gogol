...
newMonitoringProjectsNotificationChannelDescriptorsGet name
  = MonitoringProjectsNotificationChannelDescriptorsGet{xgafv =
                                                          Core.Nothing,
...
instance Core.GoogleRequest
           MonitoringProjectsNotificationChannelDescriptorsGet
         where
        type Rs MonitoringProjectsNotificationChannelDescriptorsGet =
             NotificationChannelDescriptor
        type Scopes MonitoringProjectsNotificationChannelDescriptorsGet =
