         ...
         "groups" Core.:>
           Core.QueryParam "$.xgafv" Xgafv Core.:>
             Core.QueryParam "access_token" Core.Text Core.:>
               Core.QueryParam "ancestorsOfGroup" Core.Text Core.:>
                 Core.QueryParam "callback" Core.Text Core.:>
                   Core.QueryParam "childrenOfGroup" Core.Text Core.:>
                     Core.QueryParam "descendantsOfGroup" Core.Text Core.:>
...
newMonitoringProjectsGroupsList name
  = MonitoringProjectsGroupsList{xgafv = Core.Nothing,
                                 accessToken = Core.Nothing, ancestorsOfGroup = Core.Nothing,
                                 callback = Core.Nothing, childrenOfGroup = Core.Nothing,
                                 descendantsOfGroup = Core.Nothing, name = name,
...
instance Core.GoogleRequest MonitoringProjectsGroupsList where
        ...
        type Scopes MonitoringProjectsGroupsList =
             '[CloudPlatform'FullControl, Monitoring'FullControl,
               Monitoring'Read]
        requestClient MonitoringProjectsGroupsList{..}
          = go name xgafv accessToken ancestorsOfGroup callback
              childrenOfGroup
              descendantsOfGroup
              pageSize
              pageToken
