...
instance Core.GoogleRequest MonitoringProjectsGroupsGet where
        ...
        requestClient MonitoringProjectsGroupsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy MonitoringProjectsGroupsGetResource)
                      Core.mempty
