                           ...
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.Get '[Core.JSON] ListGroupMembersResponse
...
newMonitoringProjectsGroupsMembersList name
  = MonitoringProjectsGroupsMembersList{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        filter = Core.Nothing, intervalEndTime = Core.Nothing,
...
instance Core.GoogleRequest MonitoringProjectsGroupsMembersList
         where
        type Rs MonitoringProjectsGroupsMembersList =
             ListGroupMembersResponse
        type Scopes MonitoringProjectsGroupsMembersList =
             '[CloudPlatform'FullControl, Monitoring'FullControl,
               Monitoring'Read]
        requestClient MonitoringProjectsGroupsMembersList{..}
          = go name xgafv accessToken callback filter intervalEndTime
              intervalStartTime
              pageSize
              pageToken
              uploadType
