...
newMonitoringProjectsGroupsCreate name payload
  = MonitoringProjectsGroupsCreate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest MonitoringProjectsGroupsCreate where
        type Rs MonitoringProjectsGroupsCreate = Group
        type Scopes MonitoringProjectsGroupsCreate =
        ...
        requestClient MonitoringProjectsGroupsCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy MonitoringProjectsGroupsCreateResource)
                      Core.mempty
