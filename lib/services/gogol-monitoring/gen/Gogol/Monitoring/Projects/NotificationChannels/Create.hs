...
newMonitoringProjectsNotificationChannelsCreate name payload
  = MonitoringProjectsNotificationChannelsCreate{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
           MonitoringProjectsNotificationChannelsCreate
         where
        type Rs MonitoringProjectsNotificationChannelsCreate =
             NotificationChannel
        type Scopes MonitoringProjectsNotificationChannelsCreate =
