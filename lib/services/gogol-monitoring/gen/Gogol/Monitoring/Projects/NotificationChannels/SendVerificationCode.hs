...
-- |
-- Module      : Gogol.Monitoring.Projects.NotificationChannels.SendVerificationCode
...
type MonitoringProjectsNotificationChannelsSendVerificationCodeResource
     =
     "v3" Core.:>
       Core.CaptureMode "name" "sendVerificationCode" Core.Text Core.:>
...
newMonitoringProjectsNotificationChannelsSendVerificationCode 
    ...
    -> MonitoringProjectsNotificationChannelsSendVerificationCode
newMonitoringProjectsNotificationChannelsSendVerificationCode name
  payload
  = MonitoringProjectsNotificationChannelsSendVerificationCode{xgafv
                                                                 = Core.Nothing,
...
instance Core.GoogleRequest
           MonitoringProjectsNotificationChannelsSendVerificationCode
         where
        type Rs MonitoringProjectsNotificationChannelsSendVerificationCode
             = Empty
        type Scopes
               MonitoringProjectsNotificationChannelsSendVerificationCode
