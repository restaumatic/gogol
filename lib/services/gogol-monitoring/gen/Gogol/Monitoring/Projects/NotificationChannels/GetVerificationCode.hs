...
type MonitoringProjectsNotificationChannelsGetVerificationCodeResource
     =
     "v3" Core.:>
       Core.CaptureMode "name" "getVerificationCode" Core.Text Core.:>
...
newMonitoringProjectsNotificationChannelsGetVerificationCode 
    ...
    -> MonitoringProjectsNotificationChannelsGetVerificationCode
newMonitoringProjectsNotificationChannelsGetVerificationCode name
  payload
  = MonitoringProjectsNotificationChannelsGetVerificationCode{xgafv =
                                                                Core.Nothing,
...
instance Core.GoogleRequest
           MonitoringProjectsNotificationChannelsGetVerificationCode
         where
        type Rs MonitoringProjectsNotificationChannelsGetVerificationCode =
             GetNotificationChannelVerificationCodeResponse
        type Scopes
               MonitoringProjectsNotificationChannelsGetVerificationCode
