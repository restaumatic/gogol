                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Get '[Core.JSON] ListNotificationChannelsResponse
...
newMonitoringProjectsNotificationChannelsList name
  = MonitoringProjectsNotificationChannelsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes MonitoringProjectsNotificationChannelsList =
