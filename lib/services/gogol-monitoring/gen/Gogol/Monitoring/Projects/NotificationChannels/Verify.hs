               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] VerifyNotificationChannelRequest Core.:>
                       Core.Post '[Core.JSON] NotificationChannel
...
newMonitoringProjectsNotificationChannelsVerify name payload
  = MonitoringProjectsNotificationChannelsVerify{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Rs MonitoringProjectsNotificationChannelsVerify =
             NotificationChannel
        type Scopes MonitoringProjectsNotificationChannelsVerify =
             '[CloudPlatform'FullControl, Monitoring'FullControl]
        requestClient MonitoringProjectsNotificationChannelsVerify{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy MonitoringProjectsNotificationChannelsVerifyResource)
                      Core.mempty
