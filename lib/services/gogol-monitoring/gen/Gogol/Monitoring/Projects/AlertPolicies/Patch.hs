...
newMonitoringProjectsAlertPoliciesPatch name payload
  = MonitoringProjectsAlertPoliciesPatch{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         name = name, payload = payload, updateMask = Core.Nothing,
                                         uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest MonitoringProjectsAlertPoliciesPatch
         where
        type Rs MonitoringProjectsAlertPoliciesPatch = AlertPolicy
        type Scopes MonitoringProjectsAlertPoliciesPatch =
             '[CloudPlatform'FullControl, Monitoring'FullControl]
        requestClient MonitoringProjectsAlertPoliciesPatch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy MonitoringProjectsAlertPoliciesPatchResource)
                      Core.mempty
