...
newMonitoringProjectsAlertPoliciesList name
  = MonitoringProjectsAlertPoliciesList{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        filter = Core.Nothing, name = name, orderBy = Core.Nothing,
                                        pageSize = Core.Nothing, pageToken = Core.Nothing,
                                        uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest MonitoringProjectsAlertPoliciesList
         where
        ...
        requestClient MonitoringProjectsAlertPoliciesList{..}
          = go name xgafv accessToken callback filter orderBy pageSize
              pageToken
              uploadType
              uploadProtocol
