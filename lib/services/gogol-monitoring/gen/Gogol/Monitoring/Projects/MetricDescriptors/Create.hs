                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] MetricDescriptor Core.:>
                         Core.Post '[Core.JSON] MetricDescriptor
...
newMonitoringProjectsMetricDescriptorsCreate name payload
  = MonitoringProjectsMetricDescriptorsCreate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           MonitoringProjectsMetricDescriptorsCreate
         where
        type Rs MonitoringProjectsMetricDescriptorsCreate =
             MetricDescriptor
        type Scopes MonitoringProjectsMetricDescriptorsCreate =
