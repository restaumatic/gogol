...
newMonitoringProjectsMetricDescriptorsDelete name
  = MonitoringProjectsMetricDescriptorsDelete{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           MonitoringProjectsMetricDescriptorsDelete
         where
        type Rs MonitoringProjectsMetricDescriptorsDelete = Empty
        type Scopes MonitoringProjectsMetricDescriptorsDelete =
             '[CloudPlatform'FullControl, Monitoring'FullControl]
        requestClient MonitoringProjectsMetricDescriptorsDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy MonitoringProjectsMetricDescriptorsDeleteResource)
                      Core.mempty
