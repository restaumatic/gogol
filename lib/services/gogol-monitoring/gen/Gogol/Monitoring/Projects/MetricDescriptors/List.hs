         ...
         "metricDescriptors" Core.:>
           Core.QueryParam "$.xgafv" Xgafv Core.:>
             Core.QueryParam "access_token" Core.Text Core.:>
               Core.QueryParam "activeOnly" Core.Bool Core.:>
...
newMonitoringProjectsMetricDescriptorsList name
  = MonitoringProjectsMetricDescriptorsList{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, activeOnly = Core.Nothing,
...
instance Core.GoogleRequest MonitoringProjectsMetricDescriptorsList
         where
        ...
        requestClient MonitoringProjectsMetricDescriptorsList{..}
          = go name xgafv accessToken activeOnly callback filter pageSize
              pageToken
              uploadType
              uploadProtocol
