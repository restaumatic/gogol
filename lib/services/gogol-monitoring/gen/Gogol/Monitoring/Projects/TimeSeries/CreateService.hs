                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] CreateTimeSeriesRequest Core.:>
...
newMonitoringProjectsTimeSeriesCreateService name payload
  = MonitoringProjectsTimeSeriesCreateService{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes MonitoringProjectsTimeSeriesCreateService =
