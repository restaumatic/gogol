...
-- |
-- Module      : Gogol.Monitoring.Projects.TimeSeries.List
...
-- 'MonitoringProjectsTimeSeriesList' request conforms to.
type MonitoringProjectsTimeSeriesListResource =
     "v3" Core.:>
                                           ...
                                           Core.QueryParam "secondaryAggregation.perSeriesAligner"
                                             ...
                                             Core.QueryParam "uploadType" Core.Text Core.:>
                                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                                 Core.QueryParam "view" ProjectsTimeSeriesListView
                                                   Core.:>
...
-- | Lists time series that match a filter.
--
-- /See:/ 'newMonitoringProjectsTimeSeriesList' smart constructor.
data MonitoringProjectsTimeSeriesList = MonitoringProjectsTimeSeriesList
    {
      -- | V1 error format.
    ...
    , aggregationPerSeriesAligner :: (Core.Maybe ProjectsTimeSeriesListAggregationPerSeriesAligner)
      -- | JSONP
   ...
   ProjectsTimeSeriesListSecondaryAggregationPerSeriesAligner)
    ...
    , view :: (Core.Maybe ProjectsTimeSeriesListView)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'MonitoringProjectsTimeSeriesList' with the minimum fields required to make a request.
newMonitoringProjectsTimeSeriesList 
    :: 
                                    Core.Text
    ...
    -> MonitoringProjectsTimeSeriesList
newMonitoringProjectsTimeSeriesList name
  = MonitoringProjectsTimeSeriesList{xgafv = Core.Nothing,
                                     ...
                                     view = Core.Nothing}
instance Core.GoogleRequest MonitoringProjectsTimeSeriesList where
        type Rs MonitoringProjectsTimeSeriesList = ListTimeSeriesResponse
        type Scopes MonitoringProjectsTimeSeriesList =
        ...
        requestClient MonitoringProjectsTimeSeriesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy MonitoringProjectsTimeSeriesListResource)
                      Core.mempty
