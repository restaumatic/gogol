                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] ListUptimeCheckConfigsResponse
...
newMonitoringProjectsUptimeCheckConfigsList parent
  = MonitoringProjectsUptimeCheckConfigsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes MonitoringProjectsUptimeCheckConfigsList =
             '[CloudPlatform'FullControl, Monitoring'FullControl,
               Monitoring'Read]
        requestClient MonitoringProjectsUptimeCheckConfigsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy MonitoringProjectsUptimeCheckConfigsListResource)
                      Core.mempty
