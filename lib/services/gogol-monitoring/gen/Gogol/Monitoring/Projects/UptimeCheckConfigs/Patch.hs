...
newMonitoringProjectsUptimeCheckConfigsPatch name payload
  = MonitoringProjectsUptimeCheckConfigsPatch{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        requestClient MonitoringProjectsUptimeCheckConfigsPatch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy MonitoringProjectsUptimeCheckConfigsPatchResource)
                      Core.mempty
