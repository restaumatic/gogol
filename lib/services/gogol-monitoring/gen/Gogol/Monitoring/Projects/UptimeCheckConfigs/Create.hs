                   ...
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] UptimeCheckConfig Core.:>
                         Core.Post '[Core.JSON] UptimeCheckConfig
...
newMonitoringProjectsUptimeCheckConfigsCreate parent payload
  = MonitoringProjectsUptimeCheckConfigsCreate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           MonitoringProjectsUptimeCheckConfigsCreate
         where
        type Rs MonitoringProjectsUptimeCheckConfigsCreate =
             UptimeCheckConfig
        type Scopes MonitoringProjectsUptimeCheckConfigsCreate =
             '[CloudPlatform'FullControl, Monitoring'FullControl]
        requestClient MonitoringProjectsUptimeCheckConfigsCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy MonitoringProjectsUptimeCheckConfigsCreateResource)
                      Core.mempty
