                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] CreateCollectdTimeSeriesRequest Core.:>
                         Core.Post '[Core.JSON] CreateCollectdTimeSeriesResponse
...
newMonitoringProjectsCollectdTimeSeriesCreate name payload
  = MonitoringProjectsCollectdTimeSeriesCreate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes MonitoringProjectsCollectdTimeSeriesCreate =
             '[CloudPlatform'FullControl, Monitoring'FullControl,
               Monitoring'Write]
        requestClient MonitoringProjectsCollectdTimeSeriesCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy MonitoringProjectsCollectdTimeSeriesCreateResource)
                      Core.mempty
