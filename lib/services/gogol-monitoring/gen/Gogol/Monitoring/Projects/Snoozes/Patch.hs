...
newMonitoringProjectsSnoozesPatch name payload
  = MonitoringProjectsSnoozesPatch{xgafv = Core.Nothing,
...
instance Core.GoogleRequest MonitoringProjectsSnoozesPatch where
        ...
        requestClient MonitoringProjectsSnoozesPatch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy MonitoringProjectsSnoozesPatchResource)
                      Core.mempty
