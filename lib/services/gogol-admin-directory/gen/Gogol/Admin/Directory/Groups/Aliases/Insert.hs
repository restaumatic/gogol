...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.groups.aliases.insert@.
module Gogol.Admin.Directory.Groups.Aliases.Insert
    (
    -- * Resource
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] Alias Core.:>
                               Core.Post '[Core.JSON] Alias
...
newDirectoryGroupsAliasesInsert groupKey payload
  = DirectoryGroupsAliasesInsert{xgafv = Core.Nothing,
                                 accessToken = Core.Nothing, callback = Core.Nothing,
                                 groupKey = groupKey, payload = payload, uploadType = Core.Nothing,
                                 uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DirectoryGroupsAliasesInsert where
        type Rs DirectoryGroupsAliasesInsert = Alias
        type Scopes DirectoryGroupsAliasesInsert = '[Admin'Directory'Group]
        requestClient DirectoryGroupsAliasesInsert{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy DirectoryGroupsAliasesInsertResource)
                      Core.mempty
