...
data DirectoryGroupsList = DirectoryGroupsList
    ...
    , pageToken :: (Core.Maybe Core.Text)
      -- | Query string search. Contains one or more search clauses, each with a field, operator, and value. For complete documentation, go to <https://developers.google.com/workspace/admin/directory/v1/guides/search-groups Search for groups>.
