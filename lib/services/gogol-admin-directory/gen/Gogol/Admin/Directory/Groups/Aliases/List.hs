...
-- |
-- Module      : Gogol.Admin.Directory.Groups.Aliases.List
...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.groups.aliases.list@.
module Gogol.Admin.Directory.Groups.Aliases.List
    (
    -- * Resource
...
newDirectoryGroupsAliasesList groupKey
  = DirectoryGroupsAliasesList{xgafv = Core.Nothing,
                               accessToken = Core.Nothing, callback = Core.Nothing,
                               groupKey = groupKey, uploadType = Core.Nothing,
                               uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DirectoryGroupsAliasesList where
        type Rs DirectoryGroupsAliasesList = Aliases
        type Scopes DirectoryGroupsAliasesList =
        ...
        requestClient DirectoryGroupsAliasesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy DirectoryGroupsAliasesListResource)
                      Core.mempty
