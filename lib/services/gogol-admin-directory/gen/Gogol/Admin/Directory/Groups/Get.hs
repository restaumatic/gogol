...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.groups.get@.
module Gogol.Admin.Directory.Groups.Get
    (
    -- * Resource
...
newDirectoryGroupsGet groupKey
  = DirectoryGroupsGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DirectoryGroupsGet where
        ...
        type Scopes DirectoryGroupsGet =
