...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.customers.get@.
module Gogol.Admin.Directory.Customers.Get
    (
    -- * Resource
...
newDirectoryCustomersGet customerKey
  = DirectoryCustomersGet{xgafv = Core.Nothing,
                          accessToken = Core.Nothing, callback = Core.Nothing,
                          customerKey = customerKey, uploadType = Core.Nothing,
...
instance Core.GoogleRequest DirectoryCustomersGet where
        ...
        type Scopes DirectoryCustomersGet =
             '[Admin'Directory'Customer, Admin'Directory'Customer'Readonly]
        requestClient DirectoryCustomersGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy DirectoryCustomersGetResource)
                      Core.mempty
