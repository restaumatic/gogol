...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.roleAssignments.list@.
module Gogol.Admin.Directory.RoleAssignments.List
    (
    -- * Resource
                 ...
                 Core.QueryParam "$.xgafv" Xgafv Core.:>
                   Core.QueryParam "access_token" Core.Text Core.:>
                     Core.QueryParam "callback" Core.Text Core.:>
                       Core.QueryParam "includeIndirectRoleAssignments" Core.Bool Core.:>
...
newDirectoryRoleAssignmentsList customer
  = DirectoryRoleAssignmentsList{xgafv = Core.Nothing,
                                 accessToken = Core.Nothing, callback = Core.Nothing,
                                 customer = customer, includeIndirectRoleAssignments = Core.Nothing,
                                 maxResults = Core.Nothing, pageToken = Core.Nothing,
                                 roleId = Core.Nothing, uploadType = Core.Nothing,
                                 uploadProtocol = Core.Nothing, userKey = Core.Nothing}
instance Core.GoogleRequest DirectoryRoleAssignmentsList where
        type Rs DirectoryRoleAssignmentsList = RoleAssignments
        ...
        requestClient DirectoryRoleAssignmentsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy DirectoryRoleAssignmentsListResource)
                      Core.mempty
