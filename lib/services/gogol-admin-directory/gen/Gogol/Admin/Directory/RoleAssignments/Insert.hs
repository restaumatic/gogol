...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.roleAssignments.insert@.
module Gogol.Admin.Directory.RoleAssignments.Insert
    (
    -- * Resource
...
newDirectoryRoleAssignmentsInsert customer payload
  = DirectoryRoleAssignmentsInsert{xgafv = Core.Nothing,
