...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.roleAssignments.get@.
module Gogol.Admin.Directory.RoleAssignments.Get
    (
    -- * Resource
           ...
           "customer" Core.:>
             Core.Capture "customer" Core.Text Core.:>
               "roleassignments" Core.:>
                 Core.Capture "roleAssignmentId" Core.Text Core.:>
                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Get '[Core.JSON] RoleAssignment
...
instance Core.GoogleRequest DirectoryRoleAssignmentsGet where
        ...
        requestClient DirectoryRoleAssignmentsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy DirectoryRoleAssignmentsGetResource)
                      Core.mempty
