...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.privileges.list@.
module Gogol.Admin.Directory.Privileges.List
    (
    -- * Resource
...
newDirectoryPrivilegesList customer
  = DirectoryPrivilegesList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DirectoryPrivilegesList where
        ...
        type Scopes DirectoryPrivilegesList =
