...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.mobiledevices.get@.
module Gogol.Admin.Directory.Mobiledevices.Get
    (
    -- * Resource
                     ...
                     Core.QueryParam "$.xgafv" Xgafv Core.:>
                       Core.QueryParam "access_token" Core.Text Core.:>
                         Core.QueryParam "callback" Core.Text Core.:>
                           Core.QueryParam "projection" MobiledevicesGetProjection Core.:>
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.Get '[Core.JSON] MobileDevice
...
newDirectoryMobiledevicesGet customerId resourceId
  = DirectoryMobiledevicesGet{xgafv = Core.Nothing,
                              accessToken = Core.Nothing, callback = Core.Nothing,
                              customerId = customerId, projection = Core.Nothing,
...
instance Core.GoogleRequest DirectoryMobiledevicesGet where
        ...
        type Scopes DirectoryMobiledevicesGet =
        ...
        requestClient DirectoryMobiledevicesGet{..}
          = go customerId resourceId xgafv accessToken callback projection
              uploadType
              uploadProtocol
