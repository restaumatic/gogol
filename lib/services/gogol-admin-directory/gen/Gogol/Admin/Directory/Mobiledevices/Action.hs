...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.mobiledevices.action@.
module Gogol.Admin.Directory.Mobiledevices.Action
    (
    -- * Resource
                             ...
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.ReqBody '[Core.JSON] MobileDeviceAction Core.:>
                                     Core.Post '[Core.JSON] ()
...
newDirectoryMobiledevicesAction customerId payload resourceId
  = DirectoryMobiledevicesAction{xgafv = Core.Nothing,
