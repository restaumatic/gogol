...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.mobiledevices.delete@.
module Gogol.Admin.Directory.Mobiledevices.Delete
    (
    -- * Resource
...
newDirectoryMobiledevicesDelete customerId resourceId
  = DirectoryMobiledevicesDelete{xgafv = Core.Nothing,
