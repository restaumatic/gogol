...
--
-- Retrieves a paginated list of all user-owned mobile devices for an account. To retrieve a list that includes company-owned devices, use the Cloud Identity <https://cloud.google.com/identity/docs/concepts/overview-devices Devices API> instead. This method times out after 60 minutes. For more information, see <https://developers.google.com/workspace/admin/directory/v1/guides/troubleshoot-error-codes Troubleshoot error codes>.
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.mobiledevices.list@.
module Gogol.Admin.Directory.Mobiledevices.List
    (
    -- * Resource
                     ...
                     Core.QueryParam "access_token" Core.Text Core.:>
                       Core.QueryParam "callback" Core.Text Core.:>
                         Core.QueryParam "maxResults" Core.Int32 Core.:>
                           Core.QueryParam "orderBy" MobiledevicesListOrderBy Core.:>
                             Core.QueryParam "pageToken" Core.Text Core.:>
                               Core.QueryParam "projection" MobiledevicesListProjection Core.:>
                                 Core.QueryParam "query" Core.Text Core.:>
                                   Core.QueryParam "sortOrder" MobiledevicesListSortOrder Core.:>
...
newDirectoryMobiledevicesList customerId
  = DirectoryMobiledevicesList{xgafv = Core.Nothing,
                               accessToken = Core.Nothing, callback = Core.Nothing,
                               customerId = customerId, maxResults = 100, orderBy = Core.Nothing,
                               pageToken = Core.Nothing, projection = Core.Nothing,
                               query = Core.Nothing, sortOrder = Core.Nothing,
                               uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DirectoryMobiledevicesList where
        ...
        requestClient DirectoryMobiledevicesList{..}
          = go customerId xgafv accessToken callback (Core.Just maxResults)
              orderBy
              pageToken
              projection
              query
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy DirectoryMobiledevicesListResource)
                      Core.mempty
