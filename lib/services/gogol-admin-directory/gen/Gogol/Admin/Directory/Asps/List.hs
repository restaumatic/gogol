...
-- |
-- Module      : Gogol.Admin.Directory.Asps.List
...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.asps.list@.
module Gogol.Admin.Directory.Asps.List
    (
    -- * Resource
...
newDirectoryAspsList userKey
  = DirectoryAspsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DirectoryAspsList where
        ...
        type Scopes DirectoryAspsList = '[Admin'Directory'User'Security]
