...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.asps.get@.
module Gogol.Admin.Directory.Asps.Get
    (
    -- * Resource
...
newDirectoryAspsGet codeId userKey
  = DirectoryAspsGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DirectoryAspsGet where
        ...
        type Scopes DirectoryAspsGet = '[Admin'Directory'User'Security]
