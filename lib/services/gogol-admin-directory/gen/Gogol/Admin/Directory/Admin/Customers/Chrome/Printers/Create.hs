...
-- |
-- Module      : Gogol.Admin.Directory.Admin.Customers.Chrome.Printers.Create
...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @admin.customers.chrome.printers.create@.
module Gogol.Admin.Directory.Admin.Customers.Chrome.Printers.Create
    (
    -- * Resource
...
newAdminCustomersChromePrintersCreate parent payload
  = AdminCustomersChromePrintersCreate{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       parent = parent, payload = payload,
                                       uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AdminCustomersChromePrintersCreate
         where
        type Rs AdminCustomersChromePrintersCreate = Printer
        type Scopes AdminCustomersChromePrintersCreate =
        ...
        requestClient AdminCustomersChromePrintersCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AdminCustomersChromePrintersCreateResource)
                      Core.mempty
