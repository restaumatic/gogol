...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @admin.customer.devices.chromeos.issueCommand@.
module Gogol.Admin.Directory.Admin.Customer.Devices.Chromeos.IssueCommand
    (
    -- * Resource
         ...
         "v1" Core.:>
           "customer" Core.:>
             Core.Capture "customerId" Core.Text Core.:>
               "devices" Core.:>
                 "chromeos" Core.:>
                   Core.CaptureMode "deviceId" "issueCommand" Core.Text Core.:>
...
newAdminCustomerDevicesChromeosIssueCommand 
    ...
    -> AdminCustomerDevicesChromeosIssueCommand
newAdminCustomerDevicesChromeosIssueCommand customerId deviceId
  payload
  = AdminCustomerDevicesChromeosIssueCommand{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        requestClient AdminCustomerDevicesChromeosIssueCommand{..}
          = go customerId deviceId xgafv accessToken callback uploadType
              uploadProtocol
