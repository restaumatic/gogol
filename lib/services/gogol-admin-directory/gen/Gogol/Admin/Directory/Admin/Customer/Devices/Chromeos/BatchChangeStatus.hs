...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @admin.customer.devices.chromeos.batchChangeStatus@.
module Gogol.Admin.Directory.Admin.Customer.Devices.Chromeos.BatchChangeStatus
    (
    -- * Resource
         ...
         "v1" Core.:>
           "customer" Core.:>
             Core.Capture "customerId" Core.Text Core.:>
               "devices" Core.:>
                 "chromeos:batchChangeStatus" Core.:>
                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.ReqBody '[Core.JSON] BatchChangeChromeOsDeviceStatusRequest
                                 Core.:>
                                 Core.Post '[Core.JSON] BatchChangeChromeOsDeviceStatusResponse
...
newAdminCustomerDevicesChromeosBatchChangeStatus customerId payload
  = AdminCustomerDevicesChromeosBatchChangeStatus{xgafv =
                                                    Core.Nothing,
                                                  accessToken = Core.Nothing,
                                                  callback = Core.Nothing, customerId = customerId,
                                                  payload = payload, uploadType = Core.Nothing,
                                                  uploadProtocol = Core.Nothing}
instance Core.GoogleRequest
           AdminCustomerDevicesChromeosBatchChangeStatus
         where
        type Rs AdminCustomerDevicesChromeosBatchChangeStatus =
             BatchChangeChromeOsDeviceStatusResponse
        type Scopes AdminCustomerDevicesChromeosBatchChangeStatus =
