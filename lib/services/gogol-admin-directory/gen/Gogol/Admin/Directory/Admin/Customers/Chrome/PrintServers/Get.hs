...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @admin.customers.chrome.printServers.get@.
module Gogol.Admin.Directory.Admin.Customers.Chrome.PrintServers.Get
    (
    -- * Resource
...
newAdminCustomersChromePrintServersGet 
    :: 
                                       Core.Text
       -- ^  Required. The <https://developers.google.com/workspace/admin/directory/reference/rest/v1/customers unique ID> of the customer\'s Google Workspace account. Format: @customers\/{id}@ See 'name'.
    -> AdminCustomersChromePrintServersGet
newAdminCustomersChromePrintServersGet name
  = AdminCustomersChromePrintServersGet{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        name = name, uploadType = Core.Nothing,
                                        uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AdminCustomersChromePrintServersGet
         where
        type Rs AdminCustomersChromePrintServersGet = PrintServer
        ...
        requestClient AdminCustomersChromePrintServersGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AdminCustomersChromePrintServersGetResource)
                      Core.mempty
