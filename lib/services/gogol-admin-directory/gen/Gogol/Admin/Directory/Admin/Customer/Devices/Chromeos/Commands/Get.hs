...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @admin.customer.devices.chromeos.commands.get@.
module Gogol.Admin.Directory.Admin.Customer.Devices.Chromeos.Commands.Get
    (
    -- * Resource
               ...
               "devices" Core.:>
                 "chromeos" Core.:>
                   Core.Capture "deviceId" Core.Text Core.:>
                     "commands" Core.:>
                       Core.Capture "commandId" Core.Int64 Core.:>
                               ...
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.Get '[Core.JSON] DirectoryChromeosdevicesCommand
...
newAdminCustomerDevicesChromeosCommandsGet 
    ...
    -> AdminCustomerDevicesChromeosCommandsGet
newAdminCustomerDevicesChromeosCommandsGet commandId customerId
  deviceId
  = AdminCustomerDevicesChromeosCommandsGet{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            commandId = commandId, customerId = customerId,
                                            deviceId = deviceId, uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AdminCustomerDevicesChromeosCommandsGet
         where
        type Rs AdminCustomerDevicesChromeosCommandsGet =
             DirectoryChromeosdevicesCommand
        type Scopes AdminCustomerDevicesChromeosCommandsGet =
        ...
        requestClient AdminCustomerDevicesChromeosCommandsGet{..}
          = go customerId deviceId commandId xgafv accessToken callback
              uploadType
              uploadProtocol
