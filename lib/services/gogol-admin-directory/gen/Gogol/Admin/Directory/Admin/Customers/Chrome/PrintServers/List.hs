...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @admin.customers.chrome.printServers.list@.
module Gogol.Admin.Directory.Admin.Customers.Chrome.PrintServers.List
    (
    -- * Resource
                                 ...
                                 Core.QueryParam "uploadType" Core.Text Core.:>
                                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                                     Core.QueryParam "alt" Core.AltJSON Core.:>
                                       Core.Get '[Core.JSON] ListPrintServersResponse
...
newAdminCustomersChromePrintServersList parent
  = AdminCustomersChromePrintServersList{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         filter = Core.Nothing, orderBy = Core.Nothing,
                                         orgUnitId = Core.Nothing, pageSize = Core.Nothing,
                                         pageToken = Core.Nothing, parent = parent,
                                         uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AdminCustomersChromePrintServersList
         where
        type Rs AdminCustomersChromePrintServersList =
             ListPrintServersResponse
        type Scopes AdminCustomersChromePrintServersList =
             '[Admin'Chrome'Printers, Admin'Chrome'Printers'Readonly]
        requestClient AdminCustomersChromePrintServersList{..}
          = go parent xgafv accessToken callback filter orderBy orgUnitId
              pageSize
              pageToken
              uploadType
              uploadProtocol
