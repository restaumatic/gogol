...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @admin.customers.chrome.printers.batchDeletePrinters@.
module Gogol.Admin.Directory.Admin.Customers.Chrome.Printers.BatchDeletePrinters
    (
    -- * Resource
       ...
       "directory" Core.:>
         "v1" Core.:>
           Core.Capture "parent" Core.Text Core.:>
             "chrome" Core.:>
               "printers:batchDeletePrinters" Core.:>
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] BatchDeletePrintersRequest Core.:>
                               Core.Post '[Core.JSON] BatchDeletePrintersResponse
...
newAdminCustomersChromePrintersBatchDeletePrinters parent payload
  = AdminCustomersChromePrintersBatchDeletePrinters{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           AdminCustomersChromePrintersBatchDeletePrinters
         where
        type Rs AdminCustomersChromePrintersBatchDeletePrinters =
             BatchDeletePrintersResponse
        type Scopes AdminCustomersChromePrintersBatchDeletePrinters =
