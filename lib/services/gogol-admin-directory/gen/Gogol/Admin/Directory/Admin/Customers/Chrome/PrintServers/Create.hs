...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @admin.customers.chrome.printServers.create@.
module Gogol.Admin.Directory.Admin.Customers.Chrome.PrintServers.Create
    (
    -- * Resource
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] PrintServer Core.:>
                               Core.Post '[Core.JSON] PrintServer
...
newAdminCustomersChromePrintServersCreate parent payload
  = AdminCustomersChromePrintServersCreate{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           parent = parent, payload = payload,
                                           uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AdminCustomersChromePrintServersCreate
         where
        type Rs AdminCustomersChromePrintServersCreate = PrintServer
        type Scopes AdminCustomersChromePrintServersCreate =
