...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @admin.customers.chrome.printServers.delete@.
module Gogol.Admin.Directory.Admin.Customers.Chrome.PrintServers.Delete
    (
    -- * Resource
...
newAdminCustomersChromePrintServersDelete name
  = AdminCustomersChromePrintServersDelete{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           name = name, uploadType = Core.Nothing,
                                           uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AdminCustomersChromePrintServersDelete
         where
