...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @admin.customers.chrome.printServers.batchCreatePrintServers@.
module Gogol.Admin.Directory.Admin.Customers.Chrome.PrintServers.BatchCreatePrintServers
    (
    -- * Resource
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] BatchCreatePrintServersRequest Core.:>
                               Core.Post '[Core.JSON] BatchCreatePrintServersResponse
...
newAdminCustomersChromePrintServersBatchCreatePrintServers 
    :: 
                                                           Core.Text
       -- ^  Required. The <https://developers.google.com/workspace/admin/directory/reference/rest/v1/customers unique ID> of the customer\'s Google Workspace account. Format: @customers\/{id}@ See 'parent'.
    -> BatchCreatePrintServersRequest
       -- ^  Multipart request metadata. See 'payload'.
    -> AdminCustomersChromePrintServersBatchCreatePrintServers
newAdminCustomersChromePrintServersBatchCreatePrintServers parent
  payload
  = AdminCustomersChromePrintServersBatchCreatePrintServers{xgafv =
                                                              Core.Nothing,
...
instance Core.GoogleRequest
           AdminCustomersChromePrintServersBatchCreatePrintServers
         where
        type Rs AdminCustomersChromePrintServersBatchCreatePrintServers =
             BatchCreatePrintServersResponse
        type Scopes AdminCustomersChromePrintServersBatchCreatePrintServers
