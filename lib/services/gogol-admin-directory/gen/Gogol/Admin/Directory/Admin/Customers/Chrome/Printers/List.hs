...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @admin.customers.chrome.printers.list@.
module Gogol.Admin.Directory.Admin.Customers.Chrome.Printers.List
    (
    -- * Resource
                                 ...
                                 Core.QueryParam "uploadType" Core.Text Core.:>
                                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                                     Core.QueryParam "alt" Core.AltJSON Core.:>
                                       Core.Get '[Core.JSON] ListPrintersResponse
...
newAdminCustomersChromePrintersList parent
  = AdminCustomersChromePrintersList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest AdminCustomersChromePrintersList where
        ...
        type Scopes AdminCustomersChromePrintersList =
