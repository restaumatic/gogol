...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @admin.customers.chrome.printers.listPrinterModels@.
module Gogol.Admin.Directory.Admin.Customers.Chrome.Printers.ListPrinterModels
    (
    -- * Resource
       ...
       "directory" Core.:>
         "v1" Core.:>
           Core.Capture "parent" Core.Text Core.:>
             "chrome" Core.:>
               "printers:listPrinterModels" Core.:>
                             ...
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.Get '[Core.JSON] ListPrinterModelsResponse
...
newAdminCustomersChromePrintersListPrinterModels parent
  = AdminCustomersChromePrintersListPrinterModels{xgafv =
                                                    Core.Nothing,
...
instance Core.GoogleRequest
           AdminCustomersChromePrintersListPrinterModels
         where
        type Rs AdminCustomersChromePrintersListPrinterModels =
             ListPrinterModelsResponse
        type Scopes AdminCustomersChromePrintersListPrinterModels =
             '[Admin'Chrome'Printers, Admin'Chrome'Printers'Readonly]
        requestClient AdminCustomersChromePrintersListPrinterModels{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AdminCustomersChromePrintersListPrinterModelsResource)
                      Core.mempty
