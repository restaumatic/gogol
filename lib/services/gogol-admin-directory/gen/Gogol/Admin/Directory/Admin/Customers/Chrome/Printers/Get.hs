...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @admin.customers.chrome.printers.get@.
module Gogol.Admin.Directory.Admin.Customers.Chrome.Printers.Get
    (
    -- * Resource
...
newAdminCustomersChromePrintersGet name
  = AdminCustomersChromePrintersGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest AdminCustomersChromePrintersGet where
        ...
        type Scopes AdminCustomersChromePrintersGet =
