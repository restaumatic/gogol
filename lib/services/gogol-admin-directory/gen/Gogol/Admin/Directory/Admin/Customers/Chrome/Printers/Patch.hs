...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @admin.customers.chrome.printers.patch@.
module Gogol.Admin.Directory.Admin.Customers.Chrome.Printers.Patch
    (
    -- * Resource
             ...
             Core.QueryParam "$.xgafv" Xgafv Core.:>
               Core.QueryParam "access_token" Core.Text Core.:>
                 Core.QueryParam "callback" Core.Text Core.:>
                   Core.QueryParam "clearMask" Core.FieldMask Core.:>
                     Core.QueryParam "updateMask" Core.FieldMask Core.:>
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] Printer Core.:>
                               Core.Patch '[Core.JSON] Printer
...
newAdminCustomersChromePrintersPatch 
    :: 
                                     Core.Text
       -- ^  Identifier. The resource name of the Printer object, in the format customers\/{customer-id}\/printers\/{printer-id} (During printer creation leave empty) See 'name'.
    -> Printer
       -- ^  Multipart request metadata. See 'payload'.
    -> AdminCustomersChromePrintersPatch
newAdminCustomersChromePrintersPatch name payload
  = AdminCustomersChromePrintersPatch{xgafv = Core.Nothing,
                                      accessToken = Core.Nothing, callback = Core.Nothing,
                                      clearMask = Core.Nothing, name = name, payload = payload,
                                      updateMask = Core.Nothing, uploadType = Core.Nothing,
                                      uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AdminCustomersChromePrintersPatch where
        type Rs AdminCustomersChromePrintersPatch = Printer
        type Scopes AdminCustomersChromePrintersPatch =
             '[Admin'Chrome'Printers]
        requestClient AdminCustomersChromePrintersPatch{..}
          = go name xgafv accessToken callback clearMask updateMask
              uploadType
              uploadProtocol
