...
-- Deletes a @Printer@.
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @admin.customers.chrome.printers.delete@.
module Gogol.Admin.Directory.Admin.Customers.Chrome.Printers.Delete
    (
    -- * Resource
...
newAdminCustomersChromePrintersDelete name
  = AdminCustomersChromePrintersDelete{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       name = name, uploadType = Core.Nothing,
                                       uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AdminCustomersChromePrintersDelete
         where
        type Rs AdminCustomersChromePrintersDelete = Empty
        type Scopes AdminCustomersChromePrintersDelete =
