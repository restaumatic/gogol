...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @admin.customers.chrome.printers.batchCreatePrinters@.
module Gogol.Admin.Directory.Admin.Customers.Chrome.Printers.BatchCreatePrinters
    (
    -- * Resource
       ...
       "directory" Core.:>
         "v1" Core.:>
           Core.Capture "parent" Core.Text Core.:>
             "chrome" Core.:>
               "printers:batchCreatePrinters" Core.:>
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] BatchCreatePrintersRequest Core.:>
                               Core.Post '[Core.JSON] BatchCreatePrintersResponse
...
newAdminCustomersChromePrintersBatchCreatePrinters parent payload
  = AdminCustomersChromePrintersBatchCreatePrinters{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           AdminCustomersChromePrintersBatchCreatePrinters
         where
        type Rs AdminCustomersChromePrintersBatchCreatePrinters =
             BatchCreatePrintersResponse
        type Scopes AdminCustomersChromePrintersBatchCreatePrinters =
             '[Admin'Chrome'Printers]
        requestClient AdminCustomersChromePrintersBatchCreatePrinters{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AdminCustomersChromePrintersBatchCreatePrintersResource)
                      Core.mempty
