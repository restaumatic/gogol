...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @admin.customers.chrome.printServers.batchDeletePrintServers@.
module Gogol.Admin.Directory.Admin.Customers.Chrome.PrintServers.BatchDeletePrintServers
    (
    -- * Resource
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] BatchDeletePrintServersRequest Core.:>
                               Core.Post '[Core.JSON] BatchDeletePrintServersResponse
...
data AdminCustomersChromePrintServersBatchDeletePrintServers = AdminCustomersChromePrintServersBatchDeletePrintServers
    ...
    , callback :: (Core.Maybe Core.Text)
      -- | Required. The <https://developers.google.com/workspace/admin/directory/reference/rest/v1/customers unique ID> of the customer\'s Google Workspace account. Format: @customers\/{customer.id}@
    , parent :: Core.Text
...
newAdminCustomersChromePrintServersBatchDeletePrintServers 
    :: 
                                                           Core.Text
       -- ^  Required. The <https://developers.google.com/workspace/admin/directory/reference/rest/v1/customers unique ID> of the customer\'s Google Workspace account. Format: @customers\/{customer.id}@ See 'parent'.
    -> BatchDeletePrintServersRequest
       -- ^  Multipart request metadata. See 'payload'.
    -> AdminCustomersChromePrintServersBatchDeletePrintServers
newAdminCustomersChromePrintServersBatchDeletePrintServers parent
  payload
  = AdminCustomersChromePrintServersBatchDeletePrintServers{xgafv =
                                                              Core.Nothing,
...
instance Core.GoogleRequest
           AdminCustomersChromePrintServersBatchDeletePrintServers
         where
        type Rs AdminCustomersChromePrintServersBatchDeletePrintServers =
             BatchDeletePrintServersResponse
        type Scopes AdminCustomersChromePrintServersBatchDeletePrintServers
