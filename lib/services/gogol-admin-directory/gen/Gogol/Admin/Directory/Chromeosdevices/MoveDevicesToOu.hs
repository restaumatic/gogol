...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.chromeosdevices.moveDevicesToOu@.
module Gogol.Admin.Directory.Chromeosdevices.MoveDevicesToOu
    (
    -- * Resource
                             ...
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.ReqBody '[Core.JSON] ChromeOsMoveDevicesToOu Core.:>
                                     Core.Post '[Core.JSON] ()
...
newDirectoryChromeosdevicesMoveDevicesToOu 
    ...
    -> DirectoryChromeosdevicesMoveDevicesToOu
newDirectoryChromeosdevicesMoveDevicesToOu customerId orgUnitPath
  payload
  = DirectoryChromeosdevicesMoveDevicesToOu{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            customerId = customerId, orgUnitPath = orgUnitPath,
                                            payload = payload, uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DirectoryChromeosdevicesMoveDevicesToOu
         where
        ...
        requestClient DirectoryChromeosdevicesMoveDevicesToOu{..}
          = go customerId (Core.Just orgUnitPath) xgafv accessToken callback
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DirectoryChromeosdevicesMoveDevicesToOuResource)
                      Core.mempty
