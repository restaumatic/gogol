...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.chromeosdevices.list@.
module Gogol.Admin.Directory.Chromeosdevices.List
    (
    -- * Resource
                   ...
                   Core.QueryParam "$.xgafv" Xgafv Core.:>
                     Core.QueryParam "access_token" Core.Text Core.:>
                       Core.QueryParam "callback" Core.Text Core.:>
                         Core.QueryParam "includeChildOrgunits" Core.Bool Core.:>
                           Core.QueryParam "maxResults" Core.Int32 Core.:>
                             Core.QueryParam "orderBy" ChromeosdevicesListOrderBy Core.:>
                               Core.QueryParam "orgUnitPath" Core.Text Core.:>
                                 Core.QueryParam "pageToken" Core.Text Core.:>
                                   Core.QueryParam "projection" ChromeosdevicesListProjection
                                     Core.:>
                                     Core.QueryParam "query" Core.Text Core.:>
                                       Core.QueryParam "sortOrder" ChromeosdevicesListSortOrder
                                         Core.:>
                                         Core.QueryParam "uploadType" Core.Text Core.:>
                                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                                             Core.QueryParam "alt" Core.AltJSON Core.:>
                                               Core.Get '[Core.JSON] ChromeOsDevices
...
newDirectoryChromeosdevicesList customerId
  = DirectoryChromeosdevicesList{xgafv = Core.Nothing,
                                 accessToken = Core.Nothing, callback = Core.Nothing,
                                 customerId = customerId, includeChildOrgunits = Core.Nothing,
                                 maxResults = 100, orderBy = Core.Nothing,
                                 orgUnitPath = Core.Nothing, pageToken = Core.Nothing,
                                 projection = Core.Nothing, query = Core.Nothing,
                                 sortOrder = Core.Nothing, uploadType = Core.Nothing,
                                 uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DirectoryChromeosdevicesList where
        type Rs DirectoryChromeosdevicesList = ChromeOsDevices
        ...
        requestClient DirectoryChromeosdevicesList{..}
          = go customerId xgafv accessToken callback includeChildOrgunits
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy DirectoryChromeosdevicesListResource)
                      Core.mempty
