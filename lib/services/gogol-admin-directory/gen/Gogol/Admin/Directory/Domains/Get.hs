...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.domains.get@.
module Gogol.Admin.Directory.Domains.Get
    (
    -- * Resource
...
newDirectoryDomainsGet customer domainName
  = DirectoryDomainsGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DirectoryDomainsGet where
        ...
        requestClient DirectoryDomainsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy DirectoryDomainsGetResource)
                      Core.mempty
