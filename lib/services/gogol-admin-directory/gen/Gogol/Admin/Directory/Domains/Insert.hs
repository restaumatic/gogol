...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.domains.insert@.
module Gogol.Admin.Directory.Domains.Insert
    (
    -- * Resource
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] Domains Core.:>
                               Core.Post '[Core.JSON] Domains
...
newDirectoryDomainsInsert customer payload
  = DirectoryDomainsInsert{xgafv = Core.Nothing,
