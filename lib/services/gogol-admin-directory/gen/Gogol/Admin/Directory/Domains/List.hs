...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.domains.list@.
module Gogol.Admin.Directory.Domains.List
    (
    -- * Resource
...
newDirectoryDomainsList customer
  = DirectoryDomainsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DirectoryDomainsList where
        ...
        type Scopes DirectoryDomainsList =
        ...
        requestClient DirectoryDomainsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy DirectoryDomainsListResource)
                      Core.mempty
