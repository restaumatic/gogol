...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.domainAliases.get@.
module Gogol.Admin.Directory.DomainAliases.Get
    (
    -- * Resource
                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Get '[Core.JSON] DomainAlias
...
newDirectoryDomainAliasesGet customer domainAliasName
  = DirectoryDomainAliasesGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DirectoryDomainAliasesGet where
        ...
        type Scopes DirectoryDomainAliasesGet =
