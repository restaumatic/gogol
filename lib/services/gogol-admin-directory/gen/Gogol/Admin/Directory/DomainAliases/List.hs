...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.domainAliases.list@.
module Gogol.Admin.Directory.DomainAliases.List
    (
    -- * Resource
                 ...
                 Core.QueryParam "$.xgafv" Xgafv Core.:>
                   Core.QueryParam "access_token" Core.Text Core.:>
                     Core.QueryParam "callback" Core.Text Core.:>
                       Core.QueryParam "parentDomainName" Core.Text Core.:>
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Get '[Core.JSON] DomainAliases
...
newDirectoryDomainAliasesList customer
  = DirectoryDomainAliasesList{xgafv = Core.Nothing,
                               accessToken = Core.Nothing, callback = Core.Nothing,
                               customer = customer, parentDomainName = Core.Nothing,
...
instance Core.GoogleRequest DirectoryDomainAliasesList where
        ...
        requestClient DirectoryDomainAliasesList{..}
          = go customer xgafv accessToken callback parentDomainName
              uploadType
              uploadProtocol
