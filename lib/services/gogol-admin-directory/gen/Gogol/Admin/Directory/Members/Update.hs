...
-- |
-- Module      : Gogol.Admin.Directory.Members.Update
...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.members.update@.
module Gogol.Admin.Directory.Members.Update
    (
    -- * Resource
...
newDirectoryMembersUpdate groupKey memberKey payload
  = DirectoryMembersUpdate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DirectoryMembersUpdate where
        ...
        type Scopes DirectoryMembersUpdate =
        ...
        requestClient DirectoryMembersUpdate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy DirectoryMembersUpdateResource)
                      Core.mempty
