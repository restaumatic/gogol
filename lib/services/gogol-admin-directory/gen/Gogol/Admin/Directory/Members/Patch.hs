...
--
-- Updates the membership properties of a user in the specified group. This method supports <https://developers.google.com/workspace/admin/directory/v1/guides/performance#patch patch semantics>.
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.members.patch@.
module Gogol.Admin.Directory.Members.Patch
    (
    -- * Resource
                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.ReqBody '[Core.JSON] Member Core.:>
                                 Core.Patch '[Core.JSON] Member
...
newDirectoryMembersPatch groupKey memberKey payload
  = DirectoryMembersPatch{xgafv = Core.Nothing,
                          accessToken = Core.Nothing, callback = Core.Nothing,
                          groupKey = groupKey, memberKey = memberKey, payload = payload,
...
instance Core.GoogleRequest DirectoryMembersPatch where
        ...
        type Scopes DirectoryMembersPatch =
