...
--
-- Retrieves a paginated list of all members in a group. This method times out after 60 minutes. For more information, see <https://developers.google.com/workspace/admin/directory/v1/guides/troubleshoot-error-codes Troubleshoot error codes>.
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.members.list@.
module Gogol.Admin.Directory.Members.List
    (
    -- * Resource
                 ...
                 Core.QueryParam "$.xgafv" Xgafv Core.:>
                   Core.QueryParam "access_token" Core.Text Core.:>
                     Core.QueryParam "callback" Core.Text Core.:>
                       Core.QueryParam "includeDerivedMembership" Core.Bool Core.:>
                         Core.QueryParam "maxResults" Core.Int32 Core.:>
                           Core.QueryParam "pageToken" Core.Text Core.:>
                             Core.QueryParam "roles" Core.Text Core.:>
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.Get '[Core.JSON] Members
...
newDirectoryMembersList groupKey
  = DirectoryMembersList{xgafv = Core.Nothing,
                         accessToken = Core.Nothing, callback = Core.Nothing,
                         groupKey = groupKey, includeDerivedMembership = Core.Nothing,
                         maxResults = 200, pageToken = Core.Nothing, roles = Core.Nothing,
...
instance Core.GoogleRequest DirectoryMembersList where
        ...
        requestClient DirectoryMembersList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy DirectoryMembersListResource)
                      Core.mempty
