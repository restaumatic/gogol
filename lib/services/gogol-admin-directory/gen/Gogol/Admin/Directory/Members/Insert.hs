...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.members.insert@.
module Gogol.Admin.Directory.Members.Insert
    (
    -- * Resource
...
newDirectoryMembersInsert groupKey payload
  = DirectoryMembersInsert{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DirectoryMembersInsert where
        ...
        type Scopes DirectoryMembersInsert =
