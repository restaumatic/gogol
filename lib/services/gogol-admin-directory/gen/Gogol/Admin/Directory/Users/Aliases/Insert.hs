...
-- Adds an alias.
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.users.aliases.insert@.
module Gogol.Admin.Directory.Users.Aliases.Insert
    (
    -- * Resource
...
newDirectoryUsersAliasesInsert payload userKey
  = DirectoryUsersAliasesInsert{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DirectoryUsersAliasesInsert where
        ...
        type Scopes DirectoryUsersAliasesInsert =
