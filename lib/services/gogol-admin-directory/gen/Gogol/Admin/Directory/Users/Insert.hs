...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.users.insert@.
module Gogol.Admin.Directory.Users.Insert
    (
    -- * Resource
             ...
             Core.QueryParam "$.xgafv" Xgafv Core.:>
               Core.QueryParam "access_token" Core.Text Core.:>
                 Core.QueryParam "callback" Core.Text Core.:>
                   Core.QueryParam "resolveConflictAccount" Core.Bool Core.:>
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] User Core.:> Core.Post '[Core.JSON] User
...
newDirectoryUsersInsert payload
  = DirectoryUsersInsert{xgafv = Core.Nothing,
                         accessToken = Core.Nothing, callback = Core.Nothing,
                         payload = payload, resolveConflictAccount = Core.Nothing,
...
instance Core.GoogleRequest DirectoryUsersInsert where
        ...
        requestClient DirectoryUsersInsert{..}
          = go xgafv accessToken callback resolveConflictAccount uploadType
              uploadProtocol
