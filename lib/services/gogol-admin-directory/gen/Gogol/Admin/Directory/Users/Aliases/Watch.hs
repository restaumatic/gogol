...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.users.aliases.watch@.
module Gogol.Admin.Directory.Users.Aliases.Watch
    (
    -- * Resource
                   ...
                   Core.QueryParam "$.xgafv" Xgafv Core.:>
                     Core.QueryParam "access_token" Core.Text Core.:>
                       Core.QueryParam "callback" Core.Text Core.:>
                         Core.QueryParam "event" UsersAliasesWatchEvent Core.:>
...
newDirectoryUsersAliasesWatch payload userKey
  = DirectoryUsersAliasesWatch{xgafv = Core.Nothing,
                               accessToken = Core.Nothing, callback = Core.Nothing,
                               event = Core.Nothing, payload = payload, uploadType = Core.Nothing,
...
instance Core.GoogleRequest DirectoryUsersAliasesWatch where
        ...
        type Scopes DirectoryUsersAliasesWatch =
