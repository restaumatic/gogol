...
-- Retrieves a user.
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.users.get@.
module Gogol.Admin.Directory.Users.Get
    (
    -- * Resource
                 ...
                 Core.QueryParam "access_token" Core.Text Core.:>
                   Core.QueryParam "callback" Core.Text Core.:>
                     Core.QueryParam "customFieldMask" Core.Text Core.:>
                       Core.QueryParam "projection" UsersGetProjection Core.:>
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "viewType" UsersGetViewType Core.:>
...
newDirectoryUsersGet userKey
  = DirectoryUsersGet{xgafv = Core.Nothing,
                      accessToken = Core.Nothing, callback = Core.Nothing,
                      customFieldMask = Core.Nothing,
                      projection = UsersGetProjection_Basic, uploadType = Core.Nothing,
...
instance Core.GoogleRequest DirectoryUsersGet where
        ...
        type Scopes DirectoryUsersGet =
             '[Admin'Directory'User, Admin'Directory'User'Readonly]
        requestClient DirectoryUsersGet{..}
          = go userKey xgafv accessToken callback customFieldMask
