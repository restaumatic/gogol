...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.users.list@.
module Gogol.Admin.Directory.Users.List
    (
    -- * Resource
                           ...
                           Core.QueryParam "maxResults" Core.Int32 Core.:>
                             Core.QueryParam "orderBy" UsersListOrderBy Core.:>
                               Core.QueryParam "pageToken" Core.Text Core.:>
                                 Core.QueryParam "projection" UsersListProjection Core.:>
                                   Core.QueryParam "query" Core.Text Core.:>
                                     Core.QueryParam "showDeleted" Core.Text Core.:>
                                       Core.QueryParam "sortOrder" UsersListSortOrder Core.:>
                                         Core.QueryParam "uploadType" Core.Text Core.:>
                                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                                             Core.QueryParam "viewType" UsersListViewType Core.:>
...
data DirectoryUsersList = DirectoryUsersList
    ...
    , projection :: UsersListProjection
      -- | Query string for searching user fields. For more information on constructing user queries, see <https://developers.google.com/workspace/admin/directory/v1/guides/search-users Search for Users>.
...
newDirectoryUsersList 
    ::  DirectoryUsersList
newDirectoryUsersList
  = DirectoryUsersList{xgafv = Core.Nothing,
                       ...
                       projection = UsersListProjection_Basic, query = Core.Nothing,
                       showDeleted = Core.Nothing, sortOrder = Core.Nothing,
