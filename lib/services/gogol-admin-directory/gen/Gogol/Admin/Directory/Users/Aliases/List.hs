...
-- |
-- Module      : Gogol.Admin.Directory.Users.Aliases.List
...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.users.aliases.list@.
module Gogol.Admin.Directory.Users.Aliases.List
    (
    -- * Resource
                 ...
                 Core.QueryParam "$.xgafv" Xgafv Core.:>
                   Core.QueryParam "access_token" Core.Text Core.:>
                     Core.QueryParam "callback" Core.Text Core.:>
                       Core.QueryParam "event" UsersAliasesListEvent Core.:>
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Get '[Core.JSON] Aliases
...
newDirectoryUsersAliasesList userKey
  = DirectoryUsersAliasesList{xgafv = Core.Nothing,
                              accessToken = Core.Nothing, callback = Core.Nothing,
                              event = Core.Nothing, uploadType = Core.Nothing,
...
instance Core.GoogleRequest DirectoryUsersAliasesList where
        ...
        type Scopes DirectoryUsersAliasesList =
             '[Admin'Directory'User, Admin'Directory'User'Alias,
               Admin'Directory'User'Alias'Readonly, Admin'Directory'User'Readonly]
        requestClient DirectoryUsersAliasesList{..}
          = go userKey xgafv accessToken callback event uploadType
              uploadProtocol
              (Core.Just Core.AltJSON)
              adminDirectoryService
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy DirectoryUsersAliasesListResource)
                      Core.mempty
