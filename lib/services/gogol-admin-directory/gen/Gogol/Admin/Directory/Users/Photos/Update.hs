...
-- |
-- Module      : Gogol.Admin.Directory.Users.Photos.Update
...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.users.photos.update@.
module Gogol.Admin.Directory.Users.Photos.Update
    (
    -- * Resource
                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.ReqBody '[Core.JSON] UserPhoto Core.:>
                                 Core.Put '[Core.JSON] UserPhoto
...
newDirectoryUsersPhotosUpdate payload userKey
  = DirectoryUsersPhotosUpdate{xgafv = Core.Nothing,
                               accessToken = Core.Nothing, callback = Core.Nothing,
                               payload = payload, uploadType = Core.Nothing,
                               uploadProtocol = Core.Nothing, userKey = userKey}
instance Core.GoogleRequest DirectoryUsersPhotosUpdate where
        type Rs DirectoryUsersPhotosUpdate = UserPhoto
        type Scopes DirectoryUsersPhotosUpdate = '[Admin'Directory'User]
        requestClient DirectoryUsersPhotosUpdate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy DirectoryUsersPhotosUpdateResource)
                      Core.mempty
