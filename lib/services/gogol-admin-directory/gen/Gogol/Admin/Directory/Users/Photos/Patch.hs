...
--
-- Adds a photo for the user. This method supports <https://developers.google.com/workspace/admin/directory/v1/guides/performance#patch patch semantics>.
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.users.photos.patch@.
module Gogol.Admin.Directory.Users.Photos.Patch
    (
    -- * Resource
                           ...
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.ReqBody '[Core.JSON] UserPhoto Core.:>
                                 Core.Patch '[Core.JSON] UserPhoto
...
newDirectoryUsersPhotosPatch payload userKey
  = DirectoryUsersPhotosPatch{xgafv = Core.Nothing,
