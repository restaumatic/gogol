...
data DirectoryUsersWatch = DirectoryUsersWatch
    ...
    , projection :: UsersWatchProjection
      -- | Query string search. Contains one or more search clauses, each with a field, operator, and value. For complete documentation, go to <https://developers.google.com/workspace/admin/directory/v1/guides/search-users Search for users>.
