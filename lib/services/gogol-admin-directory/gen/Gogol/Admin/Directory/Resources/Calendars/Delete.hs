...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.resources.calendars.delete@.
module Gogol.Admin.Directory.Resources.Calendars.Delete
    (
    -- * Resource
...
newDirectoryResourcesCalendarsDelete calendarResourceId customer
  = DirectoryResourcesCalendarsDelete{xgafv = Core.Nothing,
                                      accessToken = Core.Nothing,
                                      calendarResourceId = calendarResourceId,
                                      callback = Core.Nothing, customer = customer,
                                      uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DirectoryResourcesCalendarsDelete where
