...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.resources.calendars.update@.
module Gogol.Admin.Directory.Resources.Calendars.Update
    (
    -- * Resource
...
newDirectoryResourcesCalendarsUpdate 
    ...
    -> DirectoryResourcesCalendarsUpdate
newDirectoryResourcesCalendarsUpdate calendarResourceId customer
  payload
  = DirectoryResourcesCalendarsUpdate{xgafv = Core.Nothing,
                                      accessToken = Core.Nothing,
                                      calendarResourceId = calendarResourceId,
                                      callback = Core.Nothing, customer = customer,
                                      payload = payload, uploadType = Core.Nothing,
                                      uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DirectoryResourcesCalendarsUpdate where
        type Rs DirectoryResourcesCalendarsUpdate = CalendarResource
