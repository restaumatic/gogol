...
-- Updates a building.
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.resources.buildings.update@.
module Gogol.Admin.Directory.Resources.Buildings.Update
    (
    -- * Resource
         ...
         "v1" Core.:>
           "customer" Core.:>
             Core.Capture "customer" Core.Text Core.:>
               "resources" Core.:>
                 "buildings" Core.:>
                   Core.Capture "buildingId" Core.Text Core.:>
                     Core.QueryParam "$.xgafv" Xgafv Core.:>
                       Core.QueryParam "access_token" Core.Text Core.:>
                         Core.QueryParam "callback" Core.Text Core.:>
                           Core.QueryParam "coordinatesSource"
                             ResourcesBuildingsUpdateCoordinatesSource
                             Core.:>
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.ReqBody '[Core.JSON] Building Core.:>
                                     Core.Put '[Core.JSON] Building
...
newDirectoryResourcesBuildingsUpdate buildingId customer payload
  = DirectoryResourcesBuildingsUpdate{xgafv = Core.Nothing,
                                      accessToken = Core.Nothing, buildingId = buildingId,
...
instance Core.GoogleRequest DirectoryResourcesBuildingsUpdate where
        type Rs DirectoryResourcesBuildingsUpdate = Building
        type Scopes DirectoryResourcesBuildingsUpdate =
             '[Admin'Directory'Resource'Calendar]
        requestClient DirectoryResourcesBuildingsUpdate{..}
          = go customer buildingId xgafv accessToken callback
