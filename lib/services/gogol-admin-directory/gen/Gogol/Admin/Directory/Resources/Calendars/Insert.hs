...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.resources.calendars.insert@.
module Gogol.Admin.Directory.Resources.Calendars.Insert
    (
    -- * Resource
                           ...
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.ReqBody '[Core.JSON] CalendarResource Core.:>
                                 Core.Post '[Core.JSON] CalendarResource
...
newDirectoryResourcesCalendarsInsert customer payload
  = DirectoryResourcesCalendarsInsert{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DirectoryResourcesCalendarsInsert where
        ...
        type Scopes DirectoryResourcesCalendarsInsert =
