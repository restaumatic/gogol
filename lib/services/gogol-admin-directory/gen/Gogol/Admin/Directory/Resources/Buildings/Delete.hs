...
-- Deletes a building.
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.resources.buildings.delete@.
module Gogol.Admin.Directory.Resources.Buildings.Delete
    (
    -- * Resource
...
newDirectoryResourcesBuildingsDelete buildingId customer
  = DirectoryResourcesBuildingsDelete{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DirectoryResourcesBuildingsDelete where
        ...
        type Scopes DirectoryResourcesBuildingsDelete =
