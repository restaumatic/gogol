...
-- Patches a feature.
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.resources.features.patch@.
module Gogol.Admin.Directory.Resources.Features.Patch
    (
    -- * Resource
...
newDirectoryResourcesFeaturesPatch customer featureKey payload
  = DirectoryResourcesFeaturesPatch{xgafv = Core.Nothing,
                                    accessToken = Core.Nothing, callback = Core.Nothing,
                                    customer = customer, featureKey = featureKey, payload = payload,
