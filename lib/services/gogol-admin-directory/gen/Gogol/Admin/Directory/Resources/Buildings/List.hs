...
-- |
-- Module      : Gogol.Admin.Directory.Resources.Buildings.List
...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.resources.buildings.list@.
module Gogol.Admin.Directory.Resources.Buildings.List
    (
    -- * Resource
...
instance Core.GoogleRequest DirectoryResourcesBuildingsList where
        ...
        requestClient DirectoryResourcesBuildingsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy DirectoryResourcesBuildingsListResource)
                      Core.mempty
