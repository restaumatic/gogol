...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.resources.buildings.get@.
module Gogol.Admin.Directory.Resources.Buildings.Get
    (
    -- * Resource
...
newDirectoryResourcesBuildingsGet buildingId customer
  = DirectoryResourcesBuildingsGet{xgafv = Core.Nothing,
