...
-- Renames a feature.
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.resources.features.rename@.
module Gogol.Admin.Directory.Resources.Features.Rename
    (
    -- * Resource
                             ...
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.ReqBody '[Core.JSON] FeatureRename Core.:>
                                     Core.Post '[Core.JSON] ()
...
newDirectoryResourcesFeaturesRename customer oldName payload
  = DirectoryResourcesFeaturesRename{xgafv = Core.Nothing,
                                     accessToken = Core.Nothing, callback = Core.Nothing,
                                     customer = customer, oldName = oldName, payload = payload,
...
instance Core.GoogleRequest DirectoryResourcesFeaturesRename where
        ...
        requestClient DirectoryResourcesFeaturesRename{..}
          = go customer oldName xgafv accessToken callback uploadType
              uploadProtocol
