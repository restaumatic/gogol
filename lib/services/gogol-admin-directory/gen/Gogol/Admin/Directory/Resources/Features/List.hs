...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.resources.features.list@.
module Gogol.Admin.Directory.Resources.Features.List
    (
    -- * Resource
...
newDirectoryResourcesFeaturesList customer
  = DirectoryResourcesFeaturesList{xgafv = Core.Nothing,
                                   accessToken = Core.Nothing, callback = Core.Nothing,
                                   customer = customer, maxResults = Core.Nothing,
                                   pageToken = Core.Nothing, uploadType = Core.Nothing,
                                   uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DirectoryResourcesFeaturesList where
        type Rs DirectoryResourcesFeaturesList = Features
        type Scopes DirectoryResourcesFeaturesList =
        ...
        requestClient DirectoryResourcesFeaturesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy DirectoryResourcesFeaturesListResource)
                      Core.mempty
