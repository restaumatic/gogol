...
-- Inserts a building.
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.resources.buildings.insert@.
module Gogol.Admin.Directory.Resources.Buildings.Insert
    (
    -- * Resource
...
newDirectoryResourcesBuildingsInsert customer payload
  = DirectoryResourcesBuildingsInsert{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DirectoryResourcesBuildingsInsert where
        ...
        type Scopes DirectoryResourcesBuildingsInsert =
