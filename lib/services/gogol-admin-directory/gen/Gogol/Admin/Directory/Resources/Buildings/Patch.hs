...
-- Patches a building.
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.resources.buildings.patch@.
module Gogol.Admin.Directory.Resources.Buildings.Patch
    (
    -- * Resource
...
newDirectoryResourcesBuildingsPatch buildingId customer payload
  = DirectoryResourcesBuildingsPatch{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DirectoryResourcesBuildingsPatch where
        ...
        type Scopes DirectoryResourcesBuildingsPatch =
