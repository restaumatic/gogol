...
-- Inserts a feature.
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.resources.features.insert@.
module Gogol.Admin.Directory.Resources.Features.Insert
    (
    -- * Resource
...
newDirectoryResourcesFeaturesInsert customer payload
  = DirectoryResourcesFeaturesInsert{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DirectoryResourcesFeaturesInsert where
        ...
        type Scopes DirectoryResourcesFeaturesInsert =
