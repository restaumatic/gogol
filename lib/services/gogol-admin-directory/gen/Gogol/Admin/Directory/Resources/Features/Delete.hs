...
-- Deletes a feature.
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.resources.features.delete@.
module Gogol.Admin.Directory.Resources.Features.Delete
    (
    -- * Resource
...
newDirectoryResourcesFeaturesDelete customer featureKey
  = DirectoryResourcesFeaturesDelete{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DirectoryResourcesFeaturesDelete where
        ...
        type Scopes DirectoryResourcesFeaturesDelete =
