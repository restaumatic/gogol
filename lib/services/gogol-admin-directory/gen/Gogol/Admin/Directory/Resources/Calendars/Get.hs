...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.resources.calendars.get@.
module Gogol.Admin.Directory.Resources.Calendars.Get
    (
    -- * Resource
...
newDirectoryResourcesCalendarsGet calendarResourceId customer
  = DirectoryResourcesCalendarsGet{xgafv = Core.Nothing,
                                   accessToken = Core.Nothing,
                                   calendarResourceId = calendarResourceId, callback = Core.Nothing,
                                   customer = customer, uploadType = Core.Nothing,
                                   uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DirectoryResourcesCalendarsGet where
        type Rs DirectoryResourcesCalendarsGet = CalendarResource
        ...
        requestClient DirectoryResourcesCalendarsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy DirectoryResourcesCalendarsGetResource)
                      Core.mempty
