...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.tokens.get@.
module Gogol.Admin.Directory.Tokens.Get
    (
    -- * Resource
...
newDirectoryTokensGet clientId userKey
  = DirectoryTokensGet{xgafv = Core.Nothing,
