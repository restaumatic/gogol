...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.orgunits.get@.
module Gogol.Admin.Directory.Orgunits.Get
    (
    -- * Resource
...
newDirectoryOrgunitsGet customerId orgUnitPath
  = DirectoryOrgunitsGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DirectoryOrgunitsGet where
        ...
        type Scopes DirectoryOrgunitsGet =
