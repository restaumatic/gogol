...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.orgunits.insert@.
module Gogol.Admin.Directory.Orgunits.Insert
    (
    -- * Resource
...
newDirectoryOrgunitsInsert customerId payload
  = DirectoryOrgunitsInsert{xgafv = Core.Nothing,
