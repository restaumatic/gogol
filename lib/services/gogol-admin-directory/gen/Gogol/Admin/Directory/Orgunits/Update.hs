...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.orgunits.update@.
module Gogol.Admin.Directory.Orgunits.Update
    (
    -- * Resource
...
newDirectoryOrgunitsUpdate customerId orgUnitPath payload
  = DirectoryOrgunitsUpdate{xgafv = Core.Nothing,
