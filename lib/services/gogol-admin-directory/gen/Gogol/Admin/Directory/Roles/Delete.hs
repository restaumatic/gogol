...
-- Deletes a role.
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.roles.delete@.
module Gogol.Admin.Directory.Roles.Delete
    (
    -- * Resource
...
newDirectoryRolesDelete customer roleId
  = DirectoryRolesDelete{xgafv = Core.Nothing,
                         accessToken = Core.Nothing, callback = Core.Nothing,
                         customer = customer, roleId = roleId, uploadType = Core.Nothing,
