...
-- Creates a role.
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.roles.insert@.
module Gogol.Admin.Directory.Roles.Insert
    (
    -- * Resource
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] Role Core.:> Core.Post '[Core.JSON] Role
...
newDirectoryRolesInsert customer payload
  = DirectoryRolesInsert{xgafv = Core.Nothing,
                         accessToken = Core.Nothing, callback = Core.Nothing,
                         customer = customer, payload = payload, uploadType = Core.Nothing,
                         uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DirectoryRolesInsert where
        ...
        requestClient DirectoryRolesInsert{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy DirectoryRolesInsertResource)
                      Core.mempty
