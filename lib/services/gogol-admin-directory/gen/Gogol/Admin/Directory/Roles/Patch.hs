...
-- Patches a role.
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.roles.patch@.
module Gogol.Admin.Directory.Roles.Patch
    (
    -- * Resource
                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.ReqBody '[Core.JSON] Role Core.:> Core.Patch '[Core.JSON] Role
...
newDirectoryRolesPatch customer payload roleId
  = DirectoryRolesPatch{xgafv = Core.Nothing,
