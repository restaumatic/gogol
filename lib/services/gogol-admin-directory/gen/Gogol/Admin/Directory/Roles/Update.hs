...
-- Updates a role.
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.roles.update@.
module Gogol.Admin.Directory.Roles.Update
    (
    -- * Resource
                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.ReqBody '[Core.JSON] Role Core.:> Core.Put '[Core.JSON] Role
...
newDirectoryRolesUpdate customer payload roleId
  = DirectoryRolesUpdate{xgafv = Core.Nothing,
                         accessToken = Core.Nothing, callback = Core.Nothing,
                         customer = customer, payload = payload, roleId = roleId,
...
instance Core.GoogleRequest DirectoryRolesUpdate where
        ...
        requestClient DirectoryRolesUpdate{..}
          = go customer roleId xgafv accessToken callback uploadType
              uploadProtocol
