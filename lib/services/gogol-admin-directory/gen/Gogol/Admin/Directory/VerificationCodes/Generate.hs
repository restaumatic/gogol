...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.verificationCodes.generate@.
module Gogol.Admin.Directory.VerificationCodes.Generate
    (
    -- * Resource
...
newDirectoryVerificationCodesGenerate userKey
  = DirectoryVerificationCodesGenerate{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       uploadType = Core.Nothing, uploadProtocol = Core.Nothing,
                                       userKey = userKey}
instance Core.GoogleRequest DirectoryVerificationCodesGenerate
         where
        ...
        requestClient DirectoryVerificationCodesGenerate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DirectoryVerificationCodesGenerateResource)
                      Core.mempty
