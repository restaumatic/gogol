...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.verificationCodes.invalidate@.
module Gogol.Admin.Directory.VerificationCodes.Invalidate
    (
    -- * Resource
...
newDirectoryVerificationCodesInvalidate userKey
  = DirectoryVerificationCodesInvalidate{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         uploadType = Core.Nothing, uploadProtocol = Core.Nothing,
                                         userKey = userKey}
instance Core.GoogleRequest DirectoryVerificationCodesInvalidate
         where
        type Rs DirectoryVerificationCodesInvalidate = ()
        type Scopes DirectoryVerificationCodesInvalidate =
