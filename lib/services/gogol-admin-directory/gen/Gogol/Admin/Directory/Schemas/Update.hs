...
-- Updates a schema.
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.schemas.update@.
module Gogol.Admin.Directory.Schemas.Update
    (
    -- * Resource
...
newDirectorySchemasUpdate customerId payload schemaKey
  = DirectorySchemasUpdate{xgafv = Core.Nothing,
