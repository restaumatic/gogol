...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @directory.schemas.list@.
module Gogol.Admin.Directory.Schemas.List
    (
    -- * Resource
...
newDirectorySchemasList customerId
  = DirectorySchemasList{xgafv = Core.Nothing,
                         accessToken = Core.Nothing, callback = Core.Nothing,
                         customerId = customerId, uploadType = Core.Nothing,
                         uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DirectorySchemasList where
        ...
        requestClient DirectorySchemasList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy DirectorySchemasListResource)
                      Core.mempty
