...
module Gogol.Admin.Directory.Internal.Sum
  (
    ...
    -- * ChromeOsDevice_OsVersionCompliance
    ChromeOsDevice_OsVersionCompliance
      (
        ChromeOsDevice_OsVersionCompliance_ComplianceUnspecified,
        ChromeOsDevice_OsVersionCompliance_Compliant,
        ChromeOsDevice_OsVersionCompliance_Pending,
        ChromeOsDevice_OsVersionCompliance_NotCompliant,
        ..
      ),
...
newtype ChromeOsDevice_OsVersionCompliance = ChromeOsDevice_OsVersionCompliance { fromChromeOsDevice_OsVersionCompliance :: Core.Text }
    deriving stock (Core.Show, Core.Read, Core.Eq, Core.Ord, Core.Generic)
    deriving newtype
      ( Core.Hashable
      , Core.ToHttpApiData
...
pattern ChromeOsDevice_OsVersionCompliance_ComplianceUnspecified :: ChromeOsDevice_OsVersionCompliance
pattern ChromeOsDevice_OsVersionCompliance_ComplianceUnspecified = ChromeOsDevice_OsVersionCompliance "complianceUnspecified"

-- | Compliance status compliant.
pattern ChromeOsDevice_OsVersionCompliance_Compliant :: ChromeOsDevice_OsVersionCompliance
pattern ChromeOsDevice_OsVersionCompliance_Compliant = ChromeOsDevice_OsVersionCompliance "compliant"

-- | Compliance status pending.
pattern ChromeOsDevice_OsVersionCompliance_Pending :: ChromeOsDevice_OsVersionCompliance
pattern ChromeOsDevice_OsVersionCompliance_Pending = ChromeOsDevice_OsVersionCompliance "pending"

-- | Compliance status not compliant.
pattern ChromeOsDevice_OsVersionCompliance_NotCompliant :: ChromeOsDevice_OsVersionCompliance
pattern ChromeOsDevice_OsVersionCompliance_NotCompliant = ChromeOsDevice_OsVersionCompliance "notCompliant"
