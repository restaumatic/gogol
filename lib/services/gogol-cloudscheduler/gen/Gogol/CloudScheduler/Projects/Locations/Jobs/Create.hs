...
newCloudSchedulerProjectsLocationsJobsCreate parent payload
  = CloudSchedulerProjectsLocationsJobsCreate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           CloudSchedulerProjectsLocationsJobsCreate
         where
        type Rs CloudSchedulerProjectsLocationsJobsCreate = Job
        type Scopes CloudSchedulerProjectsLocationsJobsCreate =
             '[CloudPlatform'FullControl]
        requestClient CloudSchedulerProjectsLocationsJobsCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudSchedulerProjectsLocationsJobsCreateResource)
                      Core.mempty
