               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] PauseJobRequest Core.:>
...
newCloudSchedulerProjectsLocationsJobsPause name payload
  = CloudSchedulerProjectsLocationsJobsPause{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           CloudSchedulerProjectsLocationsJobsPause
         where
        type Rs CloudSchedulerProjectsLocationsJobsPause = Job
        type Scopes CloudSchedulerProjectsLocationsJobsPause =
             '[CloudPlatform'FullControl]
        requestClient CloudSchedulerProjectsLocationsJobsPause{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudSchedulerProjectsLocationsJobsPauseResource)
                      Core.mempty
