...
newCloudSchedulerProjectsLocationsJobsGet name
  = CloudSchedulerProjectsLocationsJobsGet{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           name = name, uploadType = Core.Nothing,
                                           uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudSchedulerProjectsLocationsJobsGet
         where
        type Rs CloudSchedulerProjectsLocationsJobsGet = Job
        type Scopes CloudSchedulerProjectsLocationsJobsGet =
             '[CloudPlatform'FullControl]
        requestClient CloudSchedulerProjectsLocationsJobsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudSchedulerProjectsLocationsJobsGetResource)
                      Core.mempty
