...
newCloudSchedulerProjectsLocationsJobsPatch name payload
  = CloudSchedulerProjectsLocationsJobsPatch{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           CloudSchedulerProjectsLocationsJobsPatch
         where
        type Rs CloudSchedulerProjectsLocationsJobsPatch = Job
        type Scopes CloudSchedulerProjectsLocationsJobsPatch =
             '[CloudPlatform'FullControl]
        requestClient CloudSchedulerProjectsLocationsJobsPatch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudSchedulerProjectsLocationsJobsPatchResource)
                      Core.mempty
