...
newCloudSchedulerProjectsLocationsJobsDelete name
  = CloudSchedulerProjectsLocationsJobsDelete{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           CloudSchedulerProjectsLocationsJobsDelete
         where
        type Rs CloudSchedulerProjectsLocationsJobsDelete = Empty
        type Scopes CloudSchedulerProjectsLocationsJobsDelete =
             '[CloudPlatform'FullControl]
        requestClient CloudSchedulerProjectsLocationsJobsDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudSchedulerProjectsLocationsJobsDeleteResource)
                      Core.mempty
