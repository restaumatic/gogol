...
type PlayCustomAppAccountsCustomAppsCreateResource =
     "playcustomapp" Core.:>
       "v1" Core.:>
         "accounts" Core.:>
           Core.Capture "account" Core.Int64 Core.:>
             "customApps" Core.:>
                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] CustomApp Core.:>
                             Core.Post '[Core.JSON] CustomApp
       Core.:<|>
       "upload" Core.:>
         "playcustomapp" Core.:>
           "v1" Core.:>
                           ...
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.QueryParam "uploadType" Core.Multipart Core.:>
                                 Core.MultipartRelated '[Core.JSON] CustomApp Core.:>
                                   Core.Post '[Core.JSON] CustomApp
...
newPlayCustomAppAccountsCustomAppsCreate account payload
  = PlayCustomAppAccountsCustomAppsCreate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest PlayCustomAppAccountsCustomAppsCreate
         where
        type Rs PlayCustomAppAccountsCustomAppsCreate = CustomApp
        type Scopes PlayCustomAppAccountsCustomAppsCreate =
             '[Androidpublisher'FullControl]
        requestClient PlayCustomAppAccountsCustomAppsCreate{..}
          = go account xgafv accessToken callback uploadType uploadProtocol
          ...
          where go Core.:<|> _
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy PlayCustomAppAccountsCustomAppsCreateResource)
                      Core.mempty

instance Core.GoogleRequest
           (Core.MediaUpload PlayCustomAppAccountsCustomAppsCreate)
         where
        type Rs (Core.MediaUpload PlayCustomAppAccountsCustomAppsCreate) =
             CustomApp
        type Scopes
               (Core.MediaUpload PlayCustomAppAccountsCustomAppsCreate)
             = Core.Scopes PlayCustomAppAccountsCustomAppsCreate
        requestClient
          (Core.MediaUpload PlayCustomAppAccountsCustomAppsCreate{..} body)
          = go account xgafv accessToken callback uploadType uploadProtocol
              (Core.Just Core.AltJSON)
