...
newCustomApp 
    ::  CustomApp
newCustomApp
  = CustomApp{languageCode = Core.Nothing,
              organizations = Core.Nothing, packageName = Core.Nothing,
              title = Core.Nothing}
instance Core.FromJSON CustomApp where
        parseJSON
          = Core.withObject "CustomApp"
              (\ o ->
                 CustomApp Core.<$>
                   (o Core..:? "languageCode") Core.<*> (o Core..:? "organizations")
...
newOrganization 
    ::  Organization
newOrganization
  = Organization{organizationId = Core.Nothing,
