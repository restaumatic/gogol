           ...
           Core.Capture "accountId" Core.Text Core.:>
             "adclients" Core.:>
               Core.Capture "adClientId" Core.Text Core.:>
                 "adunits" Core.:>
                   Core.Capture "adUnitId" Core.Text Core.:>
                     "adcode" Core.:>
                       Core.QueryParams "hostCustomChannelId" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] AdCode
...
newAdSenseHostAccountsAdunitsGetAdCode 
    ...
    -> AdSenseHostAccountsAdunitsGetAdCode
newAdSenseHostAccountsAdunitsGetAdCode accountId adClientId
  adUnitId
  = AdSenseHostAccountsAdunitsGetAdCode{accountId = accountId,
                                        adClientId = adClientId, adUnitId = adUnitId,
                                        hostCustomChannelId = Core.Nothing}
instance Core.GoogleRequest AdSenseHostAccountsAdunitsGetAdCode
         where
        type Rs AdSenseHostAccountsAdunitsGetAdCode = AdCode
        type Scopes AdSenseHostAccountsAdunitsGetAdCode =
             '[Adsensehost'FullControl]
        requestClient AdSenseHostAccountsAdunitsGetAdCode{..}
          = go accountId adClientId adUnitId
