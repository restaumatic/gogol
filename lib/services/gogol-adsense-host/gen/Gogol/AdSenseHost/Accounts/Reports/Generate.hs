...
newAdSenseHostAccountsReportsGenerate accountId endDate startDate
  = AdSenseHostAccountsReportsGenerate{accountId = accountId,
...
instance Core.GoogleRequest AdSenseHostAccountsReportsGenerate
         where
        type Rs AdSenseHostAccountsReportsGenerate = Report
        type Scopes AdSenseHostAccountsReportsGenerate =
        ...
        requestClient AdSenseHostAccountsReportsGenerate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AdSenseHostAccountsReportsGenerateResource)
                      Core.mempty
