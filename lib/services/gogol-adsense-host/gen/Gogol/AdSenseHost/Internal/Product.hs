...
-- |
-- Module      : Gogol.AdSenseHost.Internal.Product
...
newAccount 
    ::  Account
newAccount
  = Account{id = Core.Nothing, kind = "adsensehost#account",
        ...
        parseJSON
          = Core.withObject "Account"
              (\ o ->
                 Account Core.<$>
                   (o Core..:? "id") Core.<*>
                     (o Core..:? "kind" Core..!= "adsensehost#account")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "status"))
...
newAccounts 
    ::  Accounts
newAccounts
  = Accounts{etag = Core.Nothing, items = Core.Nothing,
              ...
              (\ o ->
                 Accounts Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "items") Core.<*>
                     (o Core..:? "kind" Core..!= "adsensehost#accounts"))
...
newAdClient 
    ::  AdClient
newAdClient
  = AdClient{arcOptIn = Core.Nothing, id = Core.Nothing,
             kind = "adsensehost#adClient", productCode = Core.Nothing,
...
instance Core.FromJSON AdClient where
        parseJSON
          = Core.withObject "AdClient"
              (\ o ->
                 AdClient Core.<$>
                   (o Core..:? "arcOptIn") Core.<*> (o Core..:? "id") Core.<*>
                     (o Core..:? "kind" Core..!= "adsensehost#adClient")
...
newAdClients 
    ::  AdClients
newAdClients
  = AdClients{etag = Core.Nothing, items = Core.Nothing,
              kind = "adsensehost#adClients", nextPageToken = Core.Nothing}
instance Core.FromJSON AdClients where
        parseJSON
          = Core.withObject "AdClients"
              (\ o ->
                 AdClients Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "items") Core.<*>
                     (o Core..:? "kind" Core..!= "adsensehost#adClients")
...
newAdCode 
    ::  AdCode
newAdCode
  = AdCode{adCode = Core.Nothing, kind = "adsensehost#adCode"}
instance Core.FromJSON AdCode where
        parseJSON
          = Core.withObject "AdCode"
              (\ o ->
                 AdCode Core.<$>
                   (o Core..:? "adCode") Core.<*>
                     (o Core..:? "kind" Core..!= "adsensehost#adCode"))
...
newAdStyle 
    ::  AdStyle
newAdStyle
  = AdStyle{colors = Core.Nothing, corners = Core.Nothing,
            font = Core.Nothing, kind = "adsensehost#adStyle"}
instance Core.FromJSON AdStyle where
        parseJSON
          = Core.withObject "AdStyle"
              (\ o ->
                 AdStyle Core.<$>
                   (o Core..:? "colors") Core.<*> (o Core..:? "corners") Core.<*>
                     (o Core..:? "font")
          ...
          = Core.object
              (Core.catMaybes
                 [("colors" Core..=) Core.<$> colors,
                  ...
                  ("font" Core..=) Core.<$> font, Core.Just ("kind" Core..= kind)])
...
newAdStyle_Colors 
    ::  AdStyle_Colors
newAdStyle_Colors
  = AdStyle_Colors{background = Core.Nothing, border = Core.Nothing,
                   text = Core.Nothing, title = Core.Nothing, url = Core.Nothing}
instance Core.FromJSON AdStyle_Colors where
        parseJSON
          = Core.withObject "AdStyle_Colors"
              (\ o ->
                 AdStyle_Colors Core.<$>
                   (o Core..:? "background") Core.<*> (o Core..:? "border") Core.<*>
                     (o Core..:? "text")
                     Core.<*> (o Core..:? "title")
                     Core.<*> (o Core..:? "url"))
          ...
          = Core.object
              (Core.catMaybes
                 [("background" Core..=) Core.<$> background,
                  ("border" Core..=) Core.<$> border, ("text" Core..=) Core.<$> text,
...
newAdStyle_Font 
    ::  AdStyle_Font
newAdStyle_Font
  = AdStyle_Font{family = Core.Nothing, size = Core.Nothing}
instance Core.FromJSON AdStyle_Font where
        parseJSON
          = Core.withObject "AdStyle_Font"
              (\ o ->
                 AdStyle_Font Core.<$>
                   (o Core..:? "family") Core.<*> (o Core..:? "size"))
...
newAdUnit 
    ::  AdUnit
newAdUnit
  = AdUnit{code = Core.Nothing, contentAdsSettings = Core.Nothing,
           customStyle = Core.Nothing, id = Core.Nothing,
           kind = "adsensehost#adUnit",
           mobileContentAdsSettings = Core.Nothing, name = Core.Nothing,
           status = Core.Nothing}
instance Core.FromJSON AdUnit where
        parseJSON
          = Core.withObject "AdUnit"
              (\ o ->
                 AdUnit Core.<$>
                   (o Core..:? "code") Core.<*> (o Core..:? "contentAdsSettings")
          ...
          = Core.object
              (Core.catMaybes
                 [("code" Core..=) Core.<$> code,
                  ...
                  ("id" Core..=) Core.<$> id, Core.Just ("kind" Core..= kind),
                  ("mobileContentAdsSettings" Core..=) Core.<$>
...
newAdUnit_ContentAdsSettings 
    ::  AdUnit_ContentAdsSettings
newAdUnit_ContentAdsSettings
  = AdUnit_ContentAdsSettings{backupOption = Core.Nothing,
                              size = Core.Nothing, type' = Core.Nothing}
instance Core.FromJSON AdUnit_ContentAdsSettings where
        parseJSON
          = Core.withObject "AdUnit_ContentAdsSettings"
              (\ o ->
                 AdUnit_ContentAdsSettings Core.<$>
                   (o Core..:? "backupOption") Core.<*> (o Core..:? "size") Core.<*>
                     (o Core..:? "type"))
...
newAdUnit_ContentAdsSettings_BackupOption 
    :: 
                                          AdUnit_ContentAdsSettings_BackupOption
newAdUnit_ContentAdsSettings_BackupOption
  = AdUnit_ContentAdsSettings_BackupOption{color = Core.Nothing,
                                           type' = Core.Nothing, url = Core.Nothing}
instance Core.FromJSON AdUnit_ContentAdsSettings_BackupOption where
        parseJSON
          = Core.withObject "AdUnit_ContentAdsSettings_BackupOption"
              (\ o ->
                 AdUnit_ContentAdsSettings_BackupOption Core.<$>
                   (o Core..:? "color") Core.<*> (o Core..:? "type") Core.<*>
                     (o Core..:? "url"))

instance Core.ToJSON AdUnit_ContentAdsSettings_BackupOption where
        toJSON AdUnit_ContentAdsSettings_BackupOption{..}
          = Core.object
              (Core.catMaybes
                 [("color" Core..=) Core.<$> color, ("type" Core..=) Core.<$> type',
                  ("url" Core..=) Core.<$> url])
...
newAdUnit_MobileContentAdsSettings 
    :: 
                                   AdUnit_MobileContentAdsSettings
newAdUnit_MobileContentAdsSettings
  = AdUnit_MobileContentAdsSettings{markupLanguage = Core.Nothing,
                                    scriptingLanguage = Core.Nothing, size = Core.Nothing,
                                    type' = Core.Nothing}
instance Core.FromJSON AdUnit_MobileContentAdsSettings where
        parseJSON
          = Core.withObject "AdUnit_MobileContentAdsSettings"
              (\ o ->
                 AdUnit_MobileContentAdsSettings Core.<$>
                   (o Core..:? "markupLanguage") Core.<*>
                     (o Core..:? "scriptingLanguage")
                     Core.<*> (o Core..:? "size")
                     Core.<*> (o Core..:? "type"))
          ...
          = Core.object
              (Core.catMaybes
                 [("markupLanguage" Core..=) Core.<$> markupLanguage,
                  ("scriptingLanguage" Core..=) Core.<$> scriptingLanguage,
                  ("size" Core..=) Core.<$> size, ("type" Core..=) Core.<$> type'])
...
newAdUnits 
    ::  AdUnits
newAdUnits
  = AdUnits{etag = Core.Nothing, items = Core.Nothing,
            kind = "adsensehost#adUnits", nextPageToken = Core.Nothing}
instance Core.FromJSON AdUnits where
        parseJSON
          = Core.withObject "AdUnits"
              (\ o ->
                 AdUnits Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "items") Core.<*>
                     (o Core..:? "kind" Core..!= "adsensehost#adUnits")
                     Core.<*> (o Core..:? "nextPageToken"))
...
newAssociationSession 
    ::  AssociationSession
newAssociationSession
  = AssociationSession{accountId = Core.Nothing, id = Core.Nothing,
                       kind = "adsensehost#associationSession",
                       productCodes = Core.Nothing, redirectUrl = Core.Nothing,
                       status = Core.Nothing, userLocale = Core.Nothing,
                       websiteLocale = Core.Nothing, websiteUrl = Core.Nothing}
instance Core.FromJSON AssociationSession where
        parseJSON
          = Core.withObject "AssociationSession"
              (\ o ->
                 AssociationSession Core.<$>
                   (o Core..:? "accountId") Core.<*> (o Core..:? "id") Core.<*>
                     (o Core..:? "kind" Core..!= "adsensehost#associationSession")
...
newCustomChannel 
    ::  CustomChannel
newCustomChannel
  = CustomChannel{code = Core.Nothing, id = Core.Nothing,
                  kind = "adsensehost#customChannel", name = Core.Nothing}
instance Core.FromJSON CustomChannel where
        parseJSON
          = Core.withObject "CustomChannel"
              (\ o ->
                 CustomChannel Core.<$>
                   (o Core..:? "code") Core.<*> (o Core..:? "id") Core.<*>
                     (o Core..:? "kind" Core..!= "adsensehost#customChannel")
                     Core.<*> (o Core..:? "name"))
...
instance Core.ToJSON CustomChannel where
        toJSON CustomChannel{..}
          = Core.object
              (Core.catMaybes
                 [("code" Core..=) Core.<$> code, ("id" Core..=) Core.<$> id,
...
newCustomChannels 
    ::  CustomChannels
newCustomChannels
  = CustomChannels{etag = Core.Nothing, items = Core.Nothing,
                   kind = "adsensehost#customChannels", nextPageToken = Core.Nothing}
instance Core.FromJSON CustomChannels where
        parseJSON
          = Core.withObject "CustomChannels"
              (\ o ->
                 CustomChannels Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "items") Core.<*>
                     (o Core..:? "kind" Core..!= "adsensehost#customChannels")
                     Core.<*> (o Core..:? "nextPageToken"))
...
newReport 
    ::  Report
newReport
  = Report{averages = Core.Nothing, headers = Core.Nothing,
           kind = "adsensehost#report", rows = Core.Nothing,
           totalMatchedRows = Core.Nothing, totals = Core.Nothing,
...
instance Core.FromJSON Report where
        parseJSON
          = Core.withObject "Report"
              (\ o ->
                 Report Core.<$>
                   (o Core..:? "averages") Core.<*> (o Core..:? "headers") Core.<*>
                     (o Core..:? "kind" Core..!= "adsensehost#report")
                     Core.<*> (o Core..:? "rows")
                     Core.<*>
...
newReport_HeadersItem 
    ::  Report_HeadersItem
newReport_HeadersItem
  = Report_HeadersItem{currency = Core.Nothing, name = Core.Nothing,
                       type' = Core.Nothing}
instance Core.FromJSON Report_HeadersItem where
        parseJSON
          = Core.withObject "Report_HeadersItem"
              (\ o ->
                 Report_HeadersItem Core.<$>
                   (o Core..:? "currency") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "type"))
...
newUrlChannel 
    ::  UrlChannel
newUrlChannel
  = UrlChannel{id = Core.Nothing, kind = "adsensehost#urlChannel",
        ...
        parseJSON
          = Core.withObject "UrlChannel"
              (\ o ->
                 UrlChannel Core.<$>
                   (o Core..:? "id") Core.<*>
                     (o Core..:? "kind" Core..!= "adsensehost#urlChannel")
...
newUrlChannels 
    ::  UrlChannels
newUrlChannels
  = UrlChannels{etag = Core.Nothing, items = Core.Nothing,
                kind = "adsensehost#urlChannels", nextPageToken = Core.Nothing}
instance Core.FromJSON UrlChannels where
        parseJSON
          = Core.withObject "UrlChannels"
              (\ o ->
                 UrlChannels Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "items") Core.<*>
                     (o Core..:? "kind" Core..!= "adsensehost#urlChannels")
                     Core.<*> (o Core..:? "nextPageToken"))
