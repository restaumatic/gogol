...
newAdSenseHostCustomchannelsPatch 
    ...
    -> AdSenseHostCustomchannelsPatch
newAdSenseHostCustomchannelsPatch adClientId customChannelId
  payload
  = AdSenseHostCustomchannelsPatch{adClientId = adClientId,
                                   customChannelId = customChannelId, payload = payload}
