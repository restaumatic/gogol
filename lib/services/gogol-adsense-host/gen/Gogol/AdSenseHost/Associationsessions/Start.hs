     ...
     "adsensehost" Core.:>
       "v4.1" Core.:>
         "associationsessions" Core.:>
           "start" Core.:>
             Core.QueryParams "productCode" AssociationsessionsStartProductCode
               Core.:>
               Core.QueryParam "websiteUrl" Core.Text Core.:>
                 Core.QueryParam "callbackUrl" Core.Text Core.:>
                   Core.QueryParam "userLocale" Core.Text Core.:>
                     Core.QueryParam "websiteLocale" Core.Text Core.:>
...
newAdSenseHostAssociationsessionsStart productCode websiteUrl
  = AdSenseHostAssociationsessionsStart{callbackUrl = Core.Nothing,
                                        productCode = productCode, userLocale = Core.Nothing,
                                        websiteLocale = Core.Nothing, websiteUrl = websiteUrl}
instance Core.GoogleRequest AdSenseHostAssociationsessionsStart
         where
        type Rs AdSenseHostAssociationsessionsStart = AssociationSession
        type Scopes AdSenseHostAssociationsessionsStart =
             '[Adsensehost'FullControl]
        requestClient AdSenseHostAssociationsessionsStart{..}
          = go productCode (Core.Just websiteUrl) callbackUrl userLocale
              websiteLocale
