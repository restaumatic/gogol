...
newAdSenseHostReportsGenerate endDate startDate
  = AdSenseHostReportsGenerate{dimension = Core.Nothing,
                               endDate = endDate, filter = Core.Nothing, locale = Core.Nothing,
                               maxResults = Core.Nothing, metric = Core.Nothing,
                               sort = Core.Nothing, startDate = startDate,
                               startIndex = Core.Nothing}
instance Core.GoogleRequest AdSenseHostReportsGenerate where
        type Rs AdSenseHostReportsGenerate = Report
        type Scopes AdSenseHostReportsGenerate = '[Adsensehost'FullControl]
        requestClient AdSenseHostReportsGenerate{..}
          = go (Core.Just startDate) (Core.Just endDate)
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy AdSenseHostReportsGenerateResource)
                      Core.mempty
