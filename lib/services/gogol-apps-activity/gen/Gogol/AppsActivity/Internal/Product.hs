...
newActivity 
    ::  Activity
newActivity
  = Activity{combinedEvent = Core.Nothing,
...
instance Core.FromJSON Activity where
        parseJSON
          = Core.withObject "Activity"
              (\ o ->
                 Activity Core.<$>
                   (o Core..:? "combinedEvent") Core.<*> (o Core..:? "singleEvents"))
...
newEvent 
    ::  Event
newEvent
  = Event{additionalEventTypes = Core.Nothing,
          eventTimeMillis = Core.Nothing, fromUserDeletion = Core.Nothing,
          move = Core.Nothing, permissionChanges = Core.Nothing,
          primaryEventType = Core.Nothing, rename = Core.Nothing,
          target = Core.Nothing, user = Core.Nothing}
instance Core.FromJSON Event where
        parseJSON
          = Core.withObject "Event"
              (\ o ->
                 Event Core.<$>
                   (o Core..:? "additionalEventTypes") Core.<*>
                     (o Core..:? "eventTimeMillis" Core.<&> Core.fmap Core.fromAsText)
          ...
          = Core.object
              (Core.catMaybes
                 [("additionalEventTypes" Core..=) Core.<$> additionalEventTypes,
                  ("eventTimeMillis" Core..=) Core.. Core.AsText Core.<$>
                    eventTimeMillis,
...
newListActivitiesResponse 
    ::  ListActivitiesResponse
newListActivitiesResponse
  = ListActivitiesResponse{activities = Core.Nothing,
                           nextPageToken = Core.Nothing}
instance Core.FromJSON ListActivitiesResponse where
        parseJSON
          = Core.withObject "ListActivitiesResponse"
              (\ o ->
                 ListActivitiesResponse Core.<$>
...
newParent 
    ::  Parent
newParent
  = Parent{id = Core.Nothing, isRoot = Core.Nothing,
           title = Core.Nothing}
instance Core.FromJSON Parent where
        parseJSON
          = Core.withObject "Parent"
              (\ o ->
                 Parent Core.<$>
                   (o Core..:? "id") Core.<*> (o Core..:? "isRoot") Core.<*>
                     (o Core..:? "title"))
...
instance Core.ToJSON Parent where
        toJSON Parent{..}
          = Core.object
              (Core.catMaybes
                 [("id" Core..=) Core.<$> id, ("isRoot" Core..=) Core.<$> isRoot,
...
newPermission 
    ::  Permission
newPermission
  = Permission{name = Core.Nothing, permissionId = Core.Nothing,
               role' = Core.Nothing, type' = Core.Nothing, user = Core.Nothing,
...
instance Core.FromJSON Permission where
        parseJSON
          = Core.withObject "Permission"
              (\ o ->
                 Permission Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "permissionId") Core.<*>
                     (o Core..:? "role")
                     Core.<*> (o Core..:? "type")
                     Core.<*> (o Core..:? "user")
...
newTarget 
    ::  Target
newTarget
  = Target{id = Core.Nothing, mimeType = Core.Nothing,
           name = Core.Nothing}
instance Core.FromJSON Target where
        parseJSON
          = Core.withObject "Target"
              (\ o ->
                 Target Core.<$>
                   (o Core..:? "id") Core.<*> (o Core..:? "mimeType") Core.<*>
                     (o Core..:? "name"))
...
newUser 
    ::  User
newUser
  = User{isDeleted = Core.Nothing, isMe = Core.Nothing,
...
instance Core.FromJSON User where
        parseJSON
          = Core.withObject "User"
              (\ o ->
                 User Core.<$>
                   (o Core..:? "isDeleted") Core.<*> (o Core..:? "isMe") Core.<*>
                     (o Core..:? "name")
          ...
          = Core.object
              (Core.catMaybes
                 [("isDeleted" Core..=) Core.<$> isDeleted,
                  ("isMe" Core..=) Core.<$> isMe, ("name" Core..=) Core.<$> name,
                  ("permissionId" Core..=) Core.<$> permissionId,
