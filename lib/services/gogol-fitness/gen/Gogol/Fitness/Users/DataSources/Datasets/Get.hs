...
newFitnessUsersDataSourcesDatasetsGet dataSourceId datasetId userId
  = FitnessUsersDataSourcesDatasetsGet{xgafv = Core.Nothing,
                                       ...
                                       userId = userId}
instance Core.GoogleRequest FitnessUsersDataSourcesDatasetsGet
         where
        ...
        requestClient FitnessUsersDataSourcesDatasetsGet{..}
          = go userId dataSourceId datasetId xgafv accessToken callback limit
              pageToken
              uploadType
              uploadProtocol
