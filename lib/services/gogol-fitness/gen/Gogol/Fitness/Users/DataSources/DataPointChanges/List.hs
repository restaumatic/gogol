                             ...
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.Get '[Core.JSON] ListDataPointChangesResponse
...
newFitnessUsersDataSourcesDataPointChangesList dataSourceId userId
  = FitnessUsersDataSourcesDataPointChangesList{xgafv = Core.Nothing,
                                                accessToken = Core.Nothing, callback = Core.Nothing,
                                                dataSourceId = dataSourceId, limit = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes FitnessUsersDataSourcesDataPointChangesList =
        ...
        requestClient FitnessUsersDataSourcesDataPointChangesList{..}
          = go userId dataSourceId xgafv accessToken callback limit pageToken
              uploadType
              uploadProtocol
