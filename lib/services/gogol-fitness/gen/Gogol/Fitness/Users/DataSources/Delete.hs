...
newFitnessUsersDataSourcesDelete dataSourceId userId
  = FitnessUsersDataSourcesDelete{xgafv = Core.Nothing,
                                  accessToken = Core.Nothing, callback = Core.Nothing,
                                  dataSourceId = dataSourceId, uploadType = Core.Nothing,
...
instance Core.GoogleRequest FitnessUsersDataSourcesDelete where
        ...
        requestClient FitnessUsersDataSourcesDelete{..}
          = go userId dataSourceId xgafv accessToken callback uploadType
              uploadProtocol
