...
newFitnessUsersDataSourcesDatasetsDelete 
    ...
    -> FitnessUsersDataSourcesDatasetsDelete
newFitnessUsersDataSourcesDatasetsDelete dataSourceId datasetId
  userId
  = FitnessUsersDataSourcesDatasetsDelete{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          dataSourceId = dataSourceId, datasetId = datasetId,
                                          uploadType = Core.Nothing, uploadProtocol = Core.Nothing,
                                          userId = userId}
instance Core.GoogleRequest FitnessUsersDataSourcesDatasetsDelete
         where
