...
newFitnessUsersDataSourcesDatasetsPatch 
    ...
    -> FitnessUsersDataSourcesDatasetsPatch
newFitnessUsersDataSourcesDatasetsPatch dataSourceId datasetId
  payload userId
  = FitnessUsersDataSourcesDatasetsPatch{xgafv = Core.Nothing,
...
instance Core.GoogleRequest FitnessUsersDataSourcesDatasetsPatch
         where
        type Rs FitnessUsersDataSourcesDatasetsPatch = Dataset
        type Scopes FitnessUsersDataSourcesDatasetsPatch =
             '[Fitness'Activity'Write, Fitness'BloodGlucose'Write,
               Fitness'BloodPressure'Write, Fitness'Body'Write,
               Fitness'BodyTemperature'Write, Fitness'HeartRate'Write,
               Fitness'Location'Write, Fitness'Nutrition'Write,
               Fitness'OxygenSaturation'Write, Fitness'ReproductiveHealth'Write,
               Fitness'Sleep'Write]
        requestClient FitnessUsersDataSourcesDatasetsPatch{..}
          = go userId dataSourceId datasetId xgafv accessToken callback
              uploadType
              uploadProtocol
