                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] AggregateRequest Core.:>
                             Core.Post '[Core.JSON] AggregateResponse
...
newFitnessUsersDatasetAggregate payload userId
  = FitnessUsersDatasetAggregate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest FitnessUsersDatasetAggregate where
        ...
        type Scopes FitnessUsersDatasetAggregate =
