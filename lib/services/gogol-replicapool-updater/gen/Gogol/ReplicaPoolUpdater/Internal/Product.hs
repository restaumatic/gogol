...
newInstanceUpdate 
    ::  InstanceUpdate
newInstanceUpdate
  = InstanceUpdate{error = Core.Nothing, instance' = Core.Nothing,
                   status = Core.Nothing}
instance Core.FromJSON InstanceUpdate where
        parseJSON
          = Core.withObject "InstanceUpdate"
              (\ o ->
                 InstanceUpdate Core.<$>
                   (o Core..:? "error") Core.<*> (o Core..:? "instance") Core.<*>
                     (o Core..:? "status"))
...
newInstanceUpdate_Error_ErrorsItem 
    :: 
                                   InstanceUpdate_Error_ErrorsItem
newInstanceUpdate_Error_ErrorsItem
  = InstanceUpdate_Error_ErrorsItem{code = Core.Nothing,
                                    location = Core.Nothing, message = Core.Nothing}
instance Core.FromJSON InstanceUpdate_Error_ErrorsItem where
        parseJSON
          = Core.withObject "InstanceUpdate_Error_ErrorsItem"
              (\ o ->
                 InstanceUpdate_Error_ErrorsItem Core.<$>
                   (o Core..:? "code") Core.<*> (o Core..:? "location") Core.<*>
                     (o Core..:? "message"))

instance Core.ToJSON InstanceUpdate_Error_ErrorsItem where
...
newInstanceUpdateList 
    ::  InstanceUpdateList
newInstanceUpdateList
  = InstanceUpdateList{items = Core.Nothing,
...
newOperation
  = Operation{clientOperationId = Core.Nothing,
              creationTimestamp = Core.Nothing, endTime = Core.Nothing,
              error = Core.Nothing, httpErrorMessage = Core.Nothing,
              httpErrorStatusCode = Core.Nothing, id = Core.Nothing,
              insertTime = Core.Nothing, kind = "replicapoolupdater#operation",
              ...
              user = Core.Nothing, warnings = Core.Nothing, zone = Core.Nothing}
              ...
              (\ o ->
                 Operation Core.<$>
                   (o Core..:? "clientOperationId") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "kind" Core..!= "replicapoolupdater#operation")
                     Core.<*> (o Core..:? "name")
...
newOperation_Error_ErrorsItem 
    ::  Operation_Error_ErrorsItem
newOperation_Error_ErrorsItem
  = Operation_Error_ErrorsItem{code = Core.Nothing,
                               location = Core.Nothing, message = Core.Nothing}
...
newOperationList 
    ::  OperationList
newOperationList
  = OperationList{id = Core.Nothing, items = Core.Nothing,
...
instance Core.FromJSON OperationList where
        parseJSON
          = Core.withObject "OperationList"
              (\ o ->
                 OperationList Core.<$>
                   (o Core..:? "id") Core.<*> (o Core..:? "items") Core.<*>
                     (o Core..:? "kind" Core..!= "replicapoolupdater#operationList")
                     Core.<*> (o Core..:? "nextPageToken")
                     Core.<*> (o Core..:? "selfLink"))
...
newRollingUpdate 
    ::  RollingUpdate
newRollingUpdate
  = RollingUpdate{actionType = Core.Nothing,
                  creationTimestamp = Core.Nothing, description = Core.Nothing,
                  error = Core.Nothing, id = Core.Nothing,
                  instanceGroup = Core.Nothing, instanceGroupManager = Core.Nothing,
                  instanceTemplate = Core.Nothing,
                  kind = "replicapoolupdater#rollingUpdate",
                  oldInstanceTemplate = Core.Nothing, policy = Core.Nothing,
...
instance Core.FromJSON RollingUpdate where
        parseJSON
          = Core.withObject "RollingUpdate"
              (\ o ->
                 RollingUpdate Core.<$>
                   (o Core..:? "actionType") Core.<*> (o Core..:? "creationTimestamp")
                     ...
                     Core.<*>
                     (o Core..:? "kind" Core..!= "replicapoolupdater#rollingUpdate")
          ...
          = Core.object
              (Core.catMaybes
                 [("actionType" Core..=) Core.<$> actionType,
                  ...
                  ("error" Core..=) Core.<$> error, ("id" Core..=) Core.<$> id,
                  ("instanceGroup" Core..=) Core.<$> instanceGroup,
                  ("instanceGroupManager" Core..=) Core.<$> instanceGroupManager,
                  ("instanceTemplate" Core..=) Core.<$> instanceTemplate,
                  Core.Just ("kind" Core..= kind),
                  ("oldInstanceTemplate" Core..=) Core.<$> oldInstanceTemplate,
...
instance Core.FromJSON RollingUpdate_Error where
        parseJSON
          = Core.withObject "RollingUpdate_Error"
              (\ o -> RollingUpdate_Error Core.<$> (o Core..:? "errors"))
...
newRollingUpdate_Error_ErrorsItem 
    ::  RollingUpdate_Error_ErrorsItem
newRollingUpdate_Error_ErrorsItem
  = RollingUpdate_Error_ErrorsItem{code = Core.Nothing,
                                   location = Core.Nothing, message = Core.Nothing}
instance Core.FromJSON RollingUpdate_Error_ErrorsItem where
        parseJSON
...
instance Core.ToJSON RollingUpdate_Error_ErrorsItem where
...
newRollingUpdate_Policy 
    ::  RollingUpdate_Policy
newRollingUpdate_Policy
  = RollingUpdate_Policy{autoPauseAfterInstances = Core.Nothing,
          ...
          = Core.object
              (Core.catMaybes
                 [("autoPauseAfterInstances" Core..=) Core.<$>
                  ...
                  ("maxNumFailedInstances" Core..=) Core.<$> maxNumFailedInstances,
...
newRollingUpdateList 
    ::  RollingUpdateList
newRollingUpdateList
  = RollingUpdateList{items = Core.Nothing,
          ...
          = Core.withObject "RollingUpdateList"
              (\ o ->
                 RollingUpdateList Core.<$>
                   (o Core..:? "items") Core.<*>
                     (o Core..:? "kind" Core..!= "replicapoolupdater#rollingUpdateList")
                     Core.<*> (o Core..:? "nextPageToken")
                     Core.<*> (o Core..:? "selfLink"))
