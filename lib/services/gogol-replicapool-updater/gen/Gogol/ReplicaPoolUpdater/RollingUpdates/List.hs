                     ...
                     Core.QueryParam "maxResults" Core.Word32 Core.:>
                       Core.QueryParam "pageToken" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] RollingUpdateList
...
newReplicaPoolUpdaterRollingUpdatesList project zone
  = ReplicaPoolUpdaterRollingUpdatesList{filter = Core.Nothing,
                                         maxResults = 500, pageToken = Core.Nothing,
                                         project = project, zone = zone}
instance Core.GoogleRequest ReplicaPoolUpdaterRollingUpdatesList
         where
        type Rs ReplicaPoolUpdaterRollingUpdatesList = RollingUpdateList
        type Scopes ReplicaPoolUpdaterRollingUpdatesList =
