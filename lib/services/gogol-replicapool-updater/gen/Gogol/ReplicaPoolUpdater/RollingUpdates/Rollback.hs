...
newReplicaPoolUpdaterRollingUpdatesRollback 
    ...
    -> ReplicaPoolUpdaterRollingUpdatesRollback
newReplicaPoolUpdaterRollingUpdatesRollback project rollingUpdate
  zone
  = ReplicaPoolUpdaterRollingUpdatesRollback{project = project,
                                             rollingUpdate = rollingUpdate, zone = zone}
instance Core.GoogleRequest
           ReplicaPoolUpdaterRollingUpdatesRollback
         where
        type Rs ReplicaPoolUpdaterRollingUpdatesRollback = Operation
        type Scopes ReplicaPoolUpdaterRollingUpdatesRollback =
