...
newReplicaPoolUpdaterRollingUpdatesCancel 
    ...
    -> ReplicaPoolUpdaterRollingUpdatesCancel
newReplicaPoolUpdaterRollingUpdatesCancel project rollingUpdate
  zone
  = ReplicaPoolUpdaterRollingUpdatesCancel{project = project,
                                           rollingUpdate = rollingUpdate, zone = zone}
instance Core.GoogleRequest ReplicaPoolUpdaterRollingUpdatesCancel
         where
        type Rs ReplicaPoolUpdaterRollingUpdatesCancel = Operation
        type Scopes ReplicaPoolUpdaterRollingUpdatesCancel =
