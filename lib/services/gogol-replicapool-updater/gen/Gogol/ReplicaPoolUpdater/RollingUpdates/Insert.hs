               ...
               Core.Capture "zone" Core.Text Core.:>
                 "rollingUpdates" Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] RollingUpdate Core.:>
...
newReplicaPoolUpdaterRollingUpdatesInsert payload project zone
  = ReplicaPoolUpdaterRollingUpdatesInsert{payload = payload,
                                           project = project, zone = zone}
instance Core.GoogleRequest ReplicaPoolUpdaterRollingUpdatesInsert
         where
        type Rs ReplicaPoolUpdaterRollingUpdatesInsert = Operation
        type Scopes ReplicaPoolUpdaterRollingUpdatesInsert =
             '[CloudPlatform'FullControl, Replicapool'FullControl]
        requestClient ReplicaPoolUpdaterRollingUpdatesInsert{..}
          = go project zone (Core.Just Core.AltJSON) payload
