...
newReplicaPoolUpdaterRollingUpdatesListInstanceUpdates 
    ...
    -> ReplicaPoolUpdaterRollingUpdatesListInstanceUpdates
newReplicaPoolUpdaterRollingUpdatesListInstanceUpdates project
  rollingUpdate zone
  = ReplicaPoolUpdaterRollingUpdatesListInstanceUpdates{filter =
                                                          Core.Nothing,
...
instance Core.GoogleRequest
           ReplicaPoolUpdaterRollingUpdatesListInstanceUpdates
         where
        type Rs ReplicaPoolUpdaterRollingUpdatesListInstanceUpdates =
             InstanceUpdateList
        type Scopes ReplicaPoolUpdaterRollingUpdatesListInstanceUpdates =
             '[CloudPlatform'FullControl, CloudPlatform'ReadOnly,
               Replicapool'FullControl, Replicapool'Readonly]
        requestClient
          ReplicaPoolUpdaterRollingUpdatesListInstanceUpdates{..}
          = go project zone rollingUpdate filter (Core.Just maxResults)
              pageToken
