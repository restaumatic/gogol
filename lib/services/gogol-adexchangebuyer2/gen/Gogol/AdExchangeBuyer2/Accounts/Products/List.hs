...
newAdExchangeBuyer2AccountsProductsList accountId
  = AdExchangeBuyer2AccountsProductsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest AdExchangeBuyer2AccountsProductsList
         where
        type Rs AdExchangeBuyer2AccountsProductsList = ListProductsResponse
        type Scopes AdExchangeBuyer2AccountsProductsList =
             '[Adexchange'Buyer]
        requestClient AdExchangeBuyer2AccountsProductsList{..}
          = go accountId xgafv accessToken callback filter pageSize pageToken
              uploadType
              uploadProtocol
