...
newAdExchangeBuyer2AccountsProductsGet accountId productId
  = AdExchangeBuyer2AccountsProductsGet{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, accountId = accountId,
                                        callback = Core.Nothing, productId = productId,
                                        uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AdExchangeBuyer2AccountsProductsGet
         where
        ...
        requestClient AdExchangeBuyer2AccountsProductsGet{..}
          = go accountId productId xgafv accessToken callback uploadType
              uploadProtocol
