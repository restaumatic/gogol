                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] ListPublisherProfilesResponse
...
newAdExchangeBuyer2AccountsPublisherProfilesList accountId
  = AdExchangeBuyer2AccountsPublisherProfilesList{xgafv =
                                                    Core.Nothing,
...
instance Core.GoogleRequest
           AdExchangeBuyer2AccountsPublisherProfilesList
         where
        type Rs AdExchangeBuyer2AccountsPublisherProfilesList =
             ListPublisherProfilesResponse
        type Scopes AdExchangeBuyer2AccountsPublisherProfilesList =
             '[Adexchange'Buyer]
