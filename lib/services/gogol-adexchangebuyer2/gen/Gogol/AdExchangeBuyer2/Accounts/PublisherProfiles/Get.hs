       ...
       "accounts" Core.:>
         Core.Capture "accountId" Core.Text Core.:>
           "publisherProfiles" Core.:>
             Core.Capture "publisherProfileId" Core.Text Core.:>
                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] PublisherProfile
...
newAdExchangeBuyer2AccountsPublisherProfilesGet 
    ...
    -> AdExchangeBuyer2AccountsPublisherProfilesGet
newAdExchangeBuyer2AccountsPublisherProfilesGet accountId
  publisherProfileId
  = AdExchangeBuyer2AccountsPublisherProfilesGet{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
           AdExchangeBuyer2AccountsPublisherProfilesGet
         where
        type Rs AdExchangeBuyer2AccountsPublisherProfilesGet =
             PublisherProfile
        type Scopes AdExchangeBuyer2AccountsPublisherProfilesGet =
             '[Adexchange'Buyer]
        requestClient AdExchangeBuyer2AccountsPublisherProfilesGet{..}
          = go accountId publisherProfileId xgafv accessToken callback
              uploadType
              uploadProtocol
