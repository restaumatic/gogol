...
newAdExchangeBuyer2AccountsProposalsGet accountId proposalId
  = AdExchangeBuyer2AccountsProposalsGet{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, accountId = accountId,
                                         callback = Core.Nothing, proposalId = proposalId,
                                         uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AdExchangeBuyer2AccountsProposalsGet
         where
