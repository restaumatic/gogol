...
newAdExchangeBuyer2AccountsProposalsCreate accountId payload
  = AdExchangeBuyer2AccountsProposalsCreate{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, accountId = accountId,
                                            callback = Core.Nothing, payload = payload,
                                            uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AdExchangeBuyer2AccountsProposalsCreate
         where
        type Rs AdExchangeBuyer2AccountsProposalsCreate = Proposal
        type Scopes AdExchangeBuyer2AccountsProposalsCreate =
             '[Adexchange'Buyer]
