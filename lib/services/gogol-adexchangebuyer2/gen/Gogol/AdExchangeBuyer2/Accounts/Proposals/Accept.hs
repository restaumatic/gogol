     ...
     "v2beta1" Core.:>
       "accounts" Core.:>
         Core.Capture "accountId" Core.Text Core.:>
           "proposals" Core.:>
             Core.CaptureMode "proposalId" "accept" Core.Text Core.:>
                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] AcceptProposalRequest Core.:>
                             Core.Post '[Core.JSON] Proposal
...
newAdExchangeBuyer2AccountsProposalsAccept 
    ...
    -> AdExchangeBuyer2AccountsProposalsAccept
newAdExchangeBuyer2AccountsProposalsAccept accountId payload
  proposalId
  = AdExchangeBuyer2AccountsProposalsAccept{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, accountId = accountId,
                                            callback = Core.Nothing, payload = payload,
                                            proposalId = proposalId, uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AdExchangeBuyer2AccountsProposalsAccept
         where
        type Rs AdExchangeBuyer2AccountsProposalsAccept = Proposal
        type Scopes AdExchangeBuyer2AccountsProposalsAccept =
             '[Adexchange'Buyer]
        requestClient AdExchangeBuyer2AccountsProposalsAccept{..}
          = go accountId proposalId xgafv accessToken callback uploadType
              uploadProtocol
