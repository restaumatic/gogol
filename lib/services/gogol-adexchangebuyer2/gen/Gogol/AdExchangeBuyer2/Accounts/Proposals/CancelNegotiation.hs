     ...
     "v2beta1" Core.:>
       "accounts" Core.:>
         Core.Capture "accountId" Core.Text Core.:>
           "proposals" Core.:>
             Core.CaptureMode "proposalId" "cancelNegotiation" Core.Text Core.:>
                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] CancelNegotiationRequest Core.:>
...
newAdExchangeBuyer2AccountsProposalsCancelNegotiation 
    ...
    -> AdExchangeBuyer2AccountsProposalsCancelNegotiation
newAdExchangeBuyer2AccountsProposalsCancelNegotiation accountId
  payload proposalId
  = AdExchangeBuyer2AccountsProposalsCancelNegotiation{xgafv =
                                                         Core.Nothing,
...
instance Core.GoogleRequest
           AdExchangeBuyer2AccountsProposalsCancelNegotiation
         where
        type Rs AdExchangeBuyer2AccountsProposalsCancelNegotiation =
             Proposal
        type Scopes AdExchangeBuyer2AccountsProposalsCancelNegotiation =
             '[Adexchange'Buyer]
        requestClient
          AdExchangeBuyer2AccountsProposalsCancelNegotiation{..}
