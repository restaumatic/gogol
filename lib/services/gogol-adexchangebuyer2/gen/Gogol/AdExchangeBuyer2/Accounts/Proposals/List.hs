               ...
               Core.QueryParam "access_token" Core.Text Core.:>
                 Core.QueryParam "callback" Core.Text Core.:>
                   Core.QueryParam "filter" Core.Text Core.:>
                     Core.QueryParam "filterSyntax" AccountsProposalsListFilterSyntax
                       Core.:>
                           ...
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.Get '[Core.JSON] ListProposalsResponse
...
newAdExchangeBuyer2AccountsProposalsList accountId
  = AdExchangeBuyer2AccountsProposalsList{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, accountId = accountId,
                                          callback = Core.Nothing, filter = Core.Nothing,
                                          filterSyntax = Core.Nothing, pageSize = Core.Nothing,
                                          pageToken = Core.Nothing, uploadType = Core.Nothing,
                                          uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AdExchangeBuyer2AccountsProposalsList
         where
        type Rs AdExchangeBuyer2AccountsProposalsList =
             ListProposalsResponse
        type Scopes AdExchangeBuyer2AccountsProposalsList =
             '[Adexchange'Buyer]
        requestClient AdExchangeBuyer2AccountsProposalsList{..}
          = go accountId xgafv accessToken callback filter filterSyntax
              pageSize
              pageToken
              uploadType
              uploadProtocol
