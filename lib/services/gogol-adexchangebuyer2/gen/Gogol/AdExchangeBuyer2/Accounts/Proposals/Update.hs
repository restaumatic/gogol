...
newAdExchangeBuyer2AccountsProposalsUpdate 
    ...
    -> AdExchangeBuyer2AccountsProposalsUpdate
newAdExchangeBuyer2AccountsProposalsUpdate accountId payload
  proposalId
  = AdExchangeBuyer2AccountsProposalsUpdate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest AdExchangeBuyer2AccountsProposalsUpdate
         where
        type Rs AdExchangeBuyer2AccountsProposalsUpdate = Proposal
        type Scopes AdExchangeBuyer2AccountsProposalsUpdate =
             '[Adexchange'Buyer]
