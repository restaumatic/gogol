     ...
     "v2beta1" Core.:>
       "accounts" Core.:>
         Core.Capture "accountId" Core.Text Core.:>
           "proposals" Core.:>
             Core.CaptureMode "proposalId" "addNote" Core.Text Core.:>
                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] AddNoteRequest Core.:>
                             Core.Post '[Core.JSON] Note
...
newAdExchangeBuyer2AccountsProposalsAddNote 
    ...
    -> AdExchangeBuyer2AccountsProposalsAddNote
newAdExchangeBuyer2AccountsProposalsAddNote accountId payload
  proposalId
  = AdExchangeBuyer2AccountsProposalsAddNote{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes AdExchangeBuyer2AccountsProposalsAddNote =
             '[Adexchange'Buyer]
