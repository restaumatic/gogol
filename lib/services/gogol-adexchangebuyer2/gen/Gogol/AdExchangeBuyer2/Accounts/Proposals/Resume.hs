     ...
     "v2beta1" Core.:>
       "accounts" Core.:>
         Core.Capture "accountId" Core.Text Core.:>
           "proposals" Core.:>
             Core.CaptureMode "proposalId" "resume" Core.Text Core.:>
                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] ResumeProposalRequest Core.:>
...
newAdExchangeBuyer2AccountsProposalsResume 
    ...
    -> AdExchangeBuyer2AccountsProposalsResume
newAdExchangeBuyer2AccountsProposalsResume accountId payload
  proposalId
  = AdExchangeBuyer2AccountsProposalsResume{xgafv = Core.Nothing,
...
instance Core.GoogleRequest AdExchangeBuyer2AccountsProposalsResume
         where
