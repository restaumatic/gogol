     ...
     "v2beta1" Core.:>
       "accounts" Core.:>
         Core.Capture "accountId" Core.Text Core.:>
           "proposals" Core.:>
             Core.CaptureMode "proposalId" "pause" Core.Text Core.:>
                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] PauseProposalRequest Core.:>
...
newAdExchangeBuyer2AccountsProposalsPause 
    ...
    -> AdExchangeBuyer2AccountsProposalsPause
newAdExchangeBuyer2AccountsProposalsPause accountId payload
  proposalId
  = AdExchangeBuyer2AccountsProposalsPause{xgafv = Core.Nothing,
...
instance Core.GoogleRequest AdExchangeBuyer2AccountsProposalsPause
         where
        type Rs AdExchangeBuyer2AccountsProposalsPause = Proposal
        type Scopes AdExchangeBuyer2AccountsProposalsPause =
             '[Adexchange'Buyer]
