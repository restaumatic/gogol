     ...
     "v2beta1" Core.:>
       "accounts" Core.:>
         Core.Capture "accountId" Core.Text Core.:>
           "proposals" Core.:>
             Core.CaptureMode "proposalId" "completeSetup" Core.Text Core.:>
                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] CompleteSetupRequest Core.:>
...
newAdExchangeBuyer2AccountsProposalsCompleteSetup 
    ...
    -> AdExchangeBuyer2AccountsProposalsCompleteSetup
newAdExchangeBuyer2AccountsProposalsCompleteSetup accountId payload
  proposalId
  = AdExchangeBuyer2AccountsProposalsCompleteSetup{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes AdExchangeBuyer2AccountsProposalsCompleteSetup =
             '[Adexchange'Buyer]
