                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] ClientUserInvitation Core.:>
                               Core.Post '[Core.JSON] ClientUserInvitation
...
newAdExchangeBuyer2AccountsClientsInvitationsCreate 
    ...
    -> AdExchangeBuyer2AccountsClientsInvitationsCreate
newAdExchangeBuyer2AccountsClientsInvitationsCreate accountId
  clientAccountId payload
  = AdExchangeBuyer2AccountsClientsInvitationsCreate{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           AdExchangeBuyer2AccountsClientsInvitationsCreate
         where
        type Rs AdExchangeBuyer2AccountsClientsInvitationsCreate =
             ClientUserInvitation
        type Scopes AdExchangeBuyer2AccountsClientsInvitationsCreate =
             '[Adexchange'Buyer]
        requestClient AdExchangeBuyer2AccountsClientsInvitationsCreate{..}
          = go accountId clientAccountId xgafv accessToken callback
              uploadType
              uploadProtocol
