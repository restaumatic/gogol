...
newAdExchangeBuyer2AccountsClientsUpdate 
    ...
    -> AdExchangeBuyer2AccountsClientsUpdate
newAdExchangeBuyer2AccountsClientsUpdate accountId clientAccountId
  payload
  = AdExchangeBuyer2AccountsClientsUpdate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest AdExchangeBuyer2AccountsClientsUpdate
         where
        type Rs AdExchangeBuyer2AccountsClientsUpdate = Client
        type Scopes AdExchangeBuyer2AccountsClientsUpdate =
             '[Adexchange'Buyer]
