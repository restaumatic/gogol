         ...
         Core.Capture "accountId" Core.Int64 Core.:>
           "clients" Core.:>
             Core.Capture "clientAccountId" Core.Int64 Core.:>
               "invitations" Core.:>
                 Core.Capture "invitationId" Core.Int64 Core.:>
                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Get '[Core.JSON] ClientUserInvitation
...
newAdExchangeBuyer2AccountsClientsInvitationsGet 
    ...
    -> AdExchangeBuyer2AccountsClientsInvitationsGet
newAdExchangeBuyer2AccountsClientsInvitationsGet accountId
  clientAccountId invitationId
  = AdExchangeBuyer2AccountsClientsInvitationsGet{xgafv =
                                                    Core.Nothing,
...
instance Core.GoogleRequest
           AdExchangeBuyer2AccountsClientsInvitationsGet
         where
        type Rs AdExchangeBuyer2AccountsClientsInvitationsGet =
             ClientUserInvitation
        type Scopes AdExchangeBuyer2AccountsClientsInvitationsGet =
             '[Adexchange'Buyer]
        requestClient AdExchangeBuyer2AccountsClientsInvitationsGet{..}
          = go accountId clientAccountId invitationId xgafv accessToken
              callback
              uploadType
              uploadProtocol
