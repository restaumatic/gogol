                           ...
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.Get '[Core.JSON] ListClientUserInvitationsResponse
...
newAdExchangeBuyer2AccountsClientsInvitationsList 
    ...
    -> AdExchangeBuyer2AccountsClientsInvitationsList
newAdExchangeBuyer2AccountsClientsInvitationsList accountId
  clientAccountId
  = AdExchangeBuyer2AccountsClientsInvitationsList{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           AdExchangeBuyer2AccountsClientsInvitationsList
         where
        type Rs AdExchangeBuyer2AccountsClientsInvitationsList =
             ListClientUserInvitationsResponse
        type Scopes AdExchangeBuyer2AccountsClientsInvitationsList =
             '[Adexchange'Buyer]
        requestClient AdExchangeBuyer2AccountsClientsInvitationsList{..}
          = go accountId clientAccountId xgafv accessToken callback pageSize
              pageToken
              uploadType
              uploadProtocol
