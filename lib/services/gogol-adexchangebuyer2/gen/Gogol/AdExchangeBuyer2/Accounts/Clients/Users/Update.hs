                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.ReqBody '[Core.JSON] ClientUser Core.:>
                                 Core.Put '[Core.JSON] ClientUser
...
newAdExchangeBuyer2AccountsClientsUsersUpdate 
    ...
    -> AdExchangeBuyer2AccountsClientsUsersUpdate
newAdExchangeBuyer2AccountsClientsUsersUpdate accountId
  clientAccountId payload userId
  = AdExchangeBuyer2AccountsClientsUsersUpdate{xgafv = Core.Nothing,
                                               accessToken = Core.Nothing, accountId = accountId,
                                               callback = Core.Nothing,
                                               clientAccountId = clientAccountId, payload = payload,
...
instance Core.GoogleRequest
        ...
        type Scopes AdExchangeBuyer2AccountsClientsUsersUpdate =
             '[Adexchange'Buyer]
        requestClient AdExchangeBuyer2AccountsClientsUsersUpdate{..}
          = go accountId clientAccountId userId xgafv accessToken callback
              uploadType
              uploadProtocol
