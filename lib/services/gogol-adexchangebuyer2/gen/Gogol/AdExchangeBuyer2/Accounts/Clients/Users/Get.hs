...
newAdExchangeBuyer2AccountsClientsUsersGet 
    ...
    -> AdExchangeBuyer2AccountsClientsUsersGet
newAdExchangeBuyer2AccountsClientsUsersGet accountId
  clientAccountId userId
  = AdExchangeBuyer2AccountsClientsUsersGet{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, accountId = accountId,
                                            callback = Core.Nothing,
                                            clientAccountId = clientAccountId,
                                            uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing, userId = userId}
instance Core.GoogleRequest AdExchangeBuyer2AccountsClientsUsersGet
         where
