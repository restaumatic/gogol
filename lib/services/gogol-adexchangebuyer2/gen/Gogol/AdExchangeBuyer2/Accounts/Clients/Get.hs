...
newAdExchangeBuyer2AccountsClientsGet accountId clientAccountId
  = AdExchangeBuyer2AccountsClientsGet{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, accountId = accountId,
                                       callback = Core.Nothing, clientAccountId = clientAccountId,
                                       uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AdExchangeBuyer2AccountsClientsGet
         where
        type Rs AdExchangeBuyer2AccountsClientsGet = Client
        type Scopes AdExchangeBuyer2AccountsClientsGet =
             '[Adexchange'Buyer]
