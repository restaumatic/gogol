     ...
     "v2beta1" Core.:>
       "accounts" Core.:>
         Core.Capture "accountId" Core.Text Core.:>
           "creatives" Core.:>
             Core.CaptureMode "creativeId" "watch" Core.Text Core.:>
                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] WatchCreativeRequest Core.:>
...
newAdExchangeBuyer2AccountsCreativesWatch 
    ...
    -> AdExchangeBuyer2AccountsCreativesWatch
newAdExchangeBuyer2AccountsCreativesWatch accountId creativeId
  payload
  = AdExchangeBuyer2AccountsCreativesWatch{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, accountId = accountId,
                                           callback = Core.Nothing, creativeId = creativeId,
                                           payload = payload, uploadType = Core.Nothing,
                                           uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AdExchangeBuyer2AccountsCreativesWatch
         where
        type Rs AdExchangeBuyer2AccountsCreativesWatch = Empty
        type Scopes AdExchangeBuyer2AccountsCreativesWatch =
             '[Adexchange'Buyer]
        requestClient AdExchangeBuyer2AccountsCreativesWatch{..}
          = go accountId creativeId xgafv accessToken callback uploadType
              uploadProtocol
