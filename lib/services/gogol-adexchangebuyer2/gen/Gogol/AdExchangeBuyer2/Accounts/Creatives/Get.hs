...
newAdExchangeBuyer2AccountsCreativesGet accountId creativeId
  = AdExchangeBuyer2AccountsCreativesGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest AdExchangeBuyer2AccountsCreativesGet
         where
        type Rs AdExchangeBuyer2AccountsCreativesGet = Creative
        type Scopes AdExchangeBuyer2AccountsCreativesGet =
             '[Adexchange'Buyer]
