                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] RemoveDealAssociationRequest Core.:>
...
newAdExchangeBuyer2AccountsCreativesDealAssociationsRemove 
    ...
    -> AdExchangeBuyer2AccountsCreativesDealAssociationsRemove
newAdExchangeBuyer2AccountsCreativesDealAssociationsRemove
  accountId creativeId payload
  = AdExchangeBuyer2AccountsCreativesDealAssociationsRemove{xgafv =
                                                              Core.Nothing,
...
instance Core.GoogleRequest
           AdExchangeBuyer2AccountsCreativesDealAssociationsRemove
         where
        type Rs AdExchangeBuyer2AccountsCreativesDealAssociationsRemove =
             Empty
        type Scopes AdExchangeBuyer2AccountsCreativesDealAssociationsRemove
             = '[Adexchange'Buyer]
        requestClient
          AdExchangeBuyer2AccountsCreativesDealAssociationsRemove{..}
