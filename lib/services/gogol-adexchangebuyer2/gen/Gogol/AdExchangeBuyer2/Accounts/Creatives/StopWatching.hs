     ...
     "v2beta1" Core.:>
       "accounts" Core.:>
         Core.Capture "accountId" Core.Text Core.:>
           "creatives" Core.:>
             Core.CaptureMode "creativeId" "stopWatching" Core.Text Core.:>
                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] StopWatchingCreativeRequest Core.:>
...
newAdExchangeBuyer2AccountsCreativesStopWatching 
    ...
    -> AdExchangeBuyer2AccountsCreativesStopWatching
newAdExchangeBuyer2AccountsCreativesStopWatching accountId
  creativeId payload
  = AdExchangeBuyer2AccountsCreativesStopWatching{xgafv =
                                                    Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes AdExchangeBuyer2AccountsCreativesStopWatching =
             '[Adexchange'Buyer]
