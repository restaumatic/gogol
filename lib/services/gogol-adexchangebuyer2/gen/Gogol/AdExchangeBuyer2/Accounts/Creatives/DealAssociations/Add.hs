                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] AddDealAssociationRequest Core.:>
...
newAdExchangeBuyer2AccountsCreativesDealAssociationsAdd 
    ...
    -> AdExchangeBuyer2AccountsCreativesDealAssociationsAdd
newAdExchangeBuyer2AccountsCreativesDealAssociationsAdd accountId
  creativeId payload
  = AdExchangeBuyer2AccountsCreativesDealAssociationsAdd{xgafv =
                                                           Core.Nothing,
                                                         accessToken = Core.Nothing,
                                                         accountId = accountId,
                                                         callback = Core.Nothing,
                                                         creativeId = creativeId, payload = payload,
                                                         uploadType = Core.Nothing,
                                                         uploadProtocol = Core.Nothing}
instance Core.GoogleRequest
           AdExchangeBuyer2AccountsCreativesDealAssociationsAdd
         where
        type Rs AdExchangeBuyer2AccountsCreativesDealAssociationsAdd =
             Empty
        type Scopes AdExchangeBuyer2AccountsCreativesDealAssociationsAdd =
             '[Adexchange'Buyer]
        requestClient
          AdExchangeBuyer2AccountsCreativesDealAssociationsAdd{..}
