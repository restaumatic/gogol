                             ...
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.Get '[Core.JSON] ListDealAssociationsResponse
...
newAdExchangeBuyer2AccountsCreativesDealAssociationsList 
    ...
    -> AdExchangeBuyer2AccountsCreativesDealAssociationsList
newAdExchangeBuyer2AccountsCreativesDealAssociationsList accountId
  creativeId
  = AdExchangeBuyer2AccountsCreativesDealAssociationsList{xgafv =
                                                            Core.Nothing,
...
instance Core.GoogleRequest
           AdExchangeBuyer2AccountsCreativesDealAssociationsList
         where
        type Rs AdExchangeBuyer2AccountsCreativesDealAssociationsList =
             ListDealAssociationsResponse
        type Scopes AdExchangeBuyer2AccountsCreativesDealAssociationsList =
             '[Adexchange'Buyer]
        requestClient
          AdExchangeBuyer2AccountsCreativesDealAssociationsList{..}
          = go accountId creativeId xgafv accessToken callback pageSize
              pageToken
              query
              uploadType
              uploadProtocol
