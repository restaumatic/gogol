                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Get '[Core.JSON] ListCreativesResponse
...
newAdExchangeBuyer2AccountsCreativesList accountId
  = AdExchangeBuyer2AccountsCreativesList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest AdExchangeBuyer2AccountsCreativesList
         where
        type Rs AdExchangeBuyer2AccountsCreativesList =
             ListCreativesResponse
        type Scopes AdExchangeBuyer2AccountsCreativesList =
             '[Adexchange'Buyer]
        requestClient AdExchangeBuyer2AccountsCreativesList{..}
          = go accountId xgafv accessToken callback pageSize pageToken query
              uploadType
              uploadProtocol
