...
newAdExchangeBuyer2AccountsCreativesCreate accountId payload
  = AdExchangeBuyer2AccountsCreativesCreate{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, accountId = accountId,
                                            callback = Core.Nothing, duplicateIdMode = Core.Nothing,
                                            payload = payload, uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AdExchangeBuyer2AccountsCreativesCreate
         where
        ...
        requestClient AdExchangeBuyer2AccountsCreativesCreate{..}
          = go accountId xgafv accessToken callback duplicateIdMode
              uploadType
              uploadProtocol
