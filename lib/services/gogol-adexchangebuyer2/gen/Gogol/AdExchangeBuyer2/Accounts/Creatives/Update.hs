...
newAdExchangeBuyer2AccountsCreativesUpdate 
    ...
    -> AdExchangeBuyer2AccountsCreativesUpdate
newAdExchangeBuyer2AccountsCreativesUpdate accountId creativeId
  payload
  = AdExchangeBuyer2AccountsCreativesUpdate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest AdExchangeBuyer2AccountsCreativesUpdate
         where
        type Rs AdExchangeBuyer2AccountsCreativesUpdate = Creative
        type Scopes AdExchangeBuyer2AccountsCreativesUpdate =
             '[Adexchange'Buyer]
