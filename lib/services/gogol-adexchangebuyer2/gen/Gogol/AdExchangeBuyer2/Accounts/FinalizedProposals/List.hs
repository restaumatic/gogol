...
newAdExchangeBuyer2AccountsFinalizedProposalsList accountId
  = AdExchangeBuyer2AccountsFinalizedProposalsList{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           AdExchangeBuyer2AccountsFinalizedProposalsList
         where
        type Rs AdExchangeBuyer2AccountsFinalizedProposalsList =
             ListProposalsResponse
        type Scopes AdExchangeBuyer2AccountsFinalizedProposalsList =
             '[Adexchange'Buyer]
