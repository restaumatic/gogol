                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] ResumeProposalDealsRequest Core.:>
...
newAdExchangeBuyer2AccountsFinalizedProposalsResume 
    ...
    -> AdExchangeBuyer2AccountsFinalizedProposalsResume
newAdExchangeBuyer2AccountsFinalizedProposalsResume accountId
  payload proposalId
  = AdExchangeBuyer2AccountsFinalizedProposalsResume{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes AdExchangeBuyer2AccountsFinalizedProposalsResume =
             '[Adexchange'Buyer]
