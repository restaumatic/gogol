                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] PauseProposalDealsRequest Core.:>
...
newAdExchangeBuyer2AccountsFinalizedProposalsPause 
    ...
    -> AdExchangeBuyer2AccountsFinalizedProposalsPause
newAdExchangeBuyer2AccountsFinalizedProposalsPause accountId
  payload proposalId
  = AdExchangeBuyer2AccountsFinalizedProposalsPause{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes AdExchangeBuyer2AccountsFinalizedProposalsPause =
             '[Adexchange'Buyer]
