...
newAdExchangeBuyer2BuyersFilterSetsBidMetricsList filterSetName
  = AdExchangeBuyer2BuyersFilterSetsBidMetricsList{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           AdExchangeBuyer2BuyersFilterSetsBidMetricsList
         where
        type Rs AdExchangeBuyer2BuyersFilterSetsBidMetricsList =
             ListBidMetricsResponse
        type Scopes AdExchangeBuyer2BuyersFilterSetsBidMetricsList =
             '[Adexchange'Buyer]
