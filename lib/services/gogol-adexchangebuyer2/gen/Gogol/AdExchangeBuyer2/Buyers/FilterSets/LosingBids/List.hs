...
newAdExchangeBuyer2BuyersFilterSetsLosingBidsList filterSetName
  = AdExchangeBuyer2BuyersFilterSetsLosingBidsList{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           AdExchangeBuyer2BuyersFilterSetsLosingBidsList
         where
        type Rs AdExchangeBuyer2BuyersFilterSetsLosingBidsList =
             ListLosingBidsResponse
        type Scopes AdExchangeBuyer2BuyersFilterSetsLosingBidsList =
             '[Adexchange'Buyer]
