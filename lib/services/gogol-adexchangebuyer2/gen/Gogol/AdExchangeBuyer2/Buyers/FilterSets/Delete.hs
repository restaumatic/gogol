...
newAdExchangeBuyer2BuyersFilterSetsDelete name
  = AdExchangeBuyer2BuyersFilterSetsDelete{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           name = name, uploadType = Core.Nothing,
                                           uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AdExchangeBuyer2BuyersFilterSetsDelete
         where
        type Rs AdExchangeBuyer2BuyersFilterSetsDelete = Empty
        type Scopes AdExchangeBuyer2BuyersFilterSetsDelete =
             '[Adexchange'Buyer]
