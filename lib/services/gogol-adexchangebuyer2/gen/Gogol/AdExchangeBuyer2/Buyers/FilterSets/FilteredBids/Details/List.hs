                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Get '[Core.JSON] ListCreativeStatusBreakdownByDetailResponse
...
newAdExchangeBuyer2BuyersFilterSetsFilteredBidsDetailsList
  ...
  = AdExchangeBuyer2BuyersFilterSetsFilteredBidsDetailsList{xgafv =
                                                              Core.Nothing,
...
instance Core.GoogleRequest
           AdExchangeBuyer2BuyersFilterSetsFilteredBidsDetailsList
         where
        type Rs AdExchangeBuyer2BuyersFilterSetsFilteredBidsDetailsList =
             ListCreativeStatusBreakdownByDetailResponse
        type Scopes AdExchangeBuyer2BuyersFilterSetsFilteredBidsDetailsList
             = '[Adexchange'Buyer]
        requestClient
          AdExchangeBuyer2BuyersFilterSetsFilteredBidsDetailsList{..}
          = go filterSetName creativeStatusId xgafv accessToken callback
              pageSize
              pageToken
              uploadType
              uploadProtocol
