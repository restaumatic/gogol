...
newAdExchangeBuyer2BuyersFilterSetsBidResponseErrorsList
  filterSetName
  = AdExchangeBuyer2BuyersFilterSetsBidResponseErrorsList{xgafv =
                                                            Core.Nothing,
...
instance Core.GoogleRequest
           AdExchangeBuyer2BuyersFilterSetsBidResponseErrorsList
         where
        type Rs AdExchangeBuyer2BuyersFilterSetsBidResponseErrorsList =
             ListBidResponseErrorsResponse
        type Scopes AdExchangeBuyer2BuyersFilterSetsBidResponseErrorsList =
             '[Adexchange'Buyer]
        requestClient
          AdExchangeBuyer2BuyersFilterSetsBidResponseErrorsList{..}
