...
newAdExchangeBuyer2BuyersFilterSetsGet name
  = AdExchangeBuyer2BuyersFilterSetsGet{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        name = name, uploadType = Core.Nothing,
                                        uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AdExchangeBuyer2BuyersFilterSetsGet
         where
        type Rs AdExchangeBuyer2BuyersFilterSetsGet = FilterSet
        type Scopes AdExchangeBuyer2BuyersFilterSetsGet =
             '[Adexchange'Buyer]
