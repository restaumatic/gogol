...
newAdExchangeBuyer2BuyersFilterSetsImpressionMetricsList
  filterSetName
  = AdExchangeBuyer2BuyersFilterSetsImpressionMetricsList{xgafv =
                                                            Core.Nothing,
...
instance Core.GoogleRequest
           AdExchangeBuyer2BuyersFilterSetsImpressionMetricsList
         where
        type Rs AdExchangeBuyer2BuyersFilterSetsImpressionMetricsList =
             ListImpressionMetricsResponse
        type Scopes AdExchangeBuyer2BuyersFilterSetsImpressionMetricsList =
             '[Adexchange'Buyer]
        requestClient
          AdExchangeBuyer2BuyersFilterSetsImpressionMetricsList{..}
