...
newAdExchangeBuyer2BuyersFilterSetsFilteredBidRequestsList
  filterSetName
  = AdExchangeBuyer2BuyersFilterSetsFilteredBidRequestsList{xgafv =
                                                              Core.Nothing,
...
instance Core.GoogleRequest
           AdExchangeBuyer2BuyersFilterSetsFilteredBidRequestsList
         where
        type Rs AdExchangeBuyer2BuyersFilterSetsFilteredBidRequestsList =
             ListFilteredBidRequestsResponse
        type Scopes AdExchangeBuyer2BuyersFilterSetsFilteredBidRequestsList
             = '[Adexchange'Buyer]
        requestClient
          AdExchangeBuyer2BuyersFilterSetsFilteredBidRequestsList{..}
