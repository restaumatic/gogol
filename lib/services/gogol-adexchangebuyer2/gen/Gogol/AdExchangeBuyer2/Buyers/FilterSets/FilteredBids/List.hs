...
newAdExchangeBuyer2BuyersFilterSetsFilteredBidsList filterSetName
  = AdExchangeBuyer2BuyersFilterSetsFilteredBidsList{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           AdExchangeBuyer2BuyersFilterSetsFilteredBidsList
         where
        type Rs AdExchangeBuyer2BuyersFilterSetsFilteredBidsList =
             ListFilteredBidsResponse
        type Scopes AdExchangeBuyer2BuyersFilterSetsFilteredBidsList =
             '[Adexchange'Buyer]
