                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] ListBidResponsesWithoutBidsResponse
...
newAdExchangeBuyer2BuyersFilterSetsBidResponsesWithoutBidsList
  filterSetName
  = AdExchangeBuyer2BuyersFilterSetsBidResponsesWithoutBidsList{xgafv
                                                                  = Core.Nothing,
...
instance Core.GoogleRequest
           AdExchangeBuyer2BuyersFilterSetsBidResponsesWithoutBidsList
         where
        type Rs AdExchangeBuyer2BuyersFilterSetsBidResponsesWithoutBidsList
