...
newAbsoluteDateRange 
    ::  AbsoluteDateRange
newAbsoluteDateRange
  = AbsoluteDateRange{endDate = Core.Nothing,
          ...
          = Core.withObject "AcceptProposalRequest"
              (\ o ->
                 AcceptProposalRequest Core.<$>
                   (o Core..:? "proposalRevision" Core.<&> Core.fmap Core.fromAsText))

instance Core.ToJSON AcceptProposalRequest where
        toJSON AcceptProposalRequest{..}
          = Core.object
              (Core.catMaybes
                 [("proposalRevision" Core..=) Core.. Core.AsText Core.<$>
                    proposalRevision])
...
newAdSize 
    ::  AdSize
newAdSize
  = AdSize{height = Core.Nothing, sizeType = Core.Nothing,
           width = Core.Nothing}
...
newAdTechnologyProviders 
    ::  AdTechnologyProviders
newAdTechnologyProviders
  = AdTechnologyProviders{detectedProviderIds = Core.Nothing,
...
newBidMetricsRow 
    ::  BidMetricsRow
newBidMetricsRow
  = BidMetricsRow{bids = Core.Nothing, bidsInAuction = Core.Nothing,
                  billedImpressions = Core.Nothing, impressionsWon = Core.Nothing,
                  measurableImpressions = Core.Nothing,
                  reachedQueries = Core.Nothing, rowDimensions = Core.Nothing,
...
instance Core.FromJSON BidMetricsRow where
        parseJSON
          = Core.withObject "BidMetricsRow"
              (\ o ->
                 BidMetricsRow Core.<$>
                   (o Core..:? "bids") Core.<*> (o Core..:? "bidsInAuction") Core.<*>
                     (o Core..:? "billedImpressions")
...
newBidResponseWithoutBidsStatusRow 
    :: 
                                   BidResponseWithoutBidsStatusRow
newBidResponseWithoutBidsStatusRow
  = BidResponseWithoutBidsStatusRow{impressionCount = Core.Nothing,
                                    rowDimensions = Core.Nothing, status = Core.Nothing}
...
newCalloutStatusRow 
    ::  CalloutStatusRow
newCalloutStatusRow
  = CalloutStatusRow{calloutStatusId = Core.Nothing,
                     impressionCount = Core.Nothing, rowDimensions = Core.Nothing}
...
newClient 
    ::  Client
newClient
  = Client{clientAccountId = Core.Nothing, clientName = Core.Nothing,
           entityId = Core.Nothing, entityName = Core.Nothing,
           entityType = Core.Nothing, partnerClientId = Core.Nothing,
...
instance Core.FromJSON Client where
        parseJSON
          = Core.withObject "Client"
              (\ o ->
                 Client Core.<$>
                   (o Core..:? "clientAccountId" Core.<&> Core.fmap Core.fromAsText)
...
instance Core.ToJSON Client where
        toJSON Client{..}
          = Core.object
              (Core.catMaybes
                 [("clientAccountId" Core..=) Core.. Core.AsText Core.<$>
                    clientAccountId,
...
newClientUser 
    ::  ClientUser
newClientUser
  = ClientUser{clientAccountId = Core.Nothing, email = Core.Nothing,
               status = Core.Nothing, userId = Core.Nothing}
...
newClientUserInvitation 
    ::  ClientUserInvitation
newClientUserInvitation
  = ClientUserInvitation{clientAccountId = Core.Nothing,
                         email = Core.Nothing, invitationId = Core.Nothing}
              ...
              (\ o ->
                 ClientUserInvitation Core.<$>
                   (o Core..:? "clientAccountId" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "email")
                     Core.<*>
                     (o Core..:? "invitationId" Core.<&> Core.fmap Core.fromAsText))
...
newCorrection 
    ::  Correction
newCorrection
  = Correction{contexts = Core.Nothing, details = Core.Nothing,
               type' = Core.Nothing}
...
newCreative 
    ::  Creative
newCreative
  = Creative{accountId = Core.Nothing,
             adChoicesDestinationUrl = Core.Nothing,
             adTechnologyProviders = Core.Nothing,
             advertiserName = Core.Nothing, agencyId = Core.Nothing,
             apiUpdateTime = Core.Nothing, attributes = Core.Nothing,
             clickThroughUrls = Core.Nothing, corrections = Core.Nothing,
             creativeId = Core.Nothing, dealsStatus = Core.Nothing,
             declaredClickThroughUrls = Core.Nothing,
             detectedAdvertiserIds = Core.Nothing,
             detectedDomains = Core.Nothing, detectedLanguages = Core.Nothing,
             detectedProductCategories = Core.Nothing,
             detectedSensitiveCategories = Core.Nothing, html = Core.Nothing,
             impressionTrackingUrls = Core.Nothing, native = Core.Nothing,
             openAuctionStatus = Core.Nothing,
             restrictedCategories = Core.Nothing,
             servingRestrictions = Core.Nothing, vendorIds = Core.Nothing,
             version = Core.Nothing, video = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("accountId" Core..=) Core.<$> accountId,
                  ...
                  ("detectedAdvertiserIds" Core..=) Core.. Core.fmap Core.AsText
...
newCreativeDealAssociation 
    ::  CreativeDealAssociation
newCreativeDealAssociation
  = CreativeDealAssociation{accountId = Core.Nothing,
                            creativeId = Core.Nothing, dealsId = Core.Nothing}
instance Core.FromJSON CreativeDealAssociation where
        parseJSON
          = Core.withObject "CreativeDealAssociation"
              (\ o ->
                 CreativeDealAssociation Core.<$>
                   (o Core..:? "accountId") Core.<*> (o Core..:? "creativeId")
                     Core.<*> (o Core..:? "dealsId"))
...
newCreativeRestrictions 
    ::  CreativeRestrictions
newCreativeRestrictions
  = CreativeRestrictions{creativeFormat = Core.Nothing,
...
newCreativeSize 
    ::  CreativeSize
newCreativeSize
  = CreativeSize{allowedFormats = Core.Nothing,
...
newCreativeSpecification 
    ::  CreativeSpecification
newCreativeSpecification
  = CreativeSpecification{creativeCompanionSizes = Core.Nothing,
...
newCreativeStatusRow 
    ::  CreativeStatusRow
newCreativeStatusRow
  = CreativeStatusRow{bidCount = Core.Nothing,
                      creativeStatusId = Core.Nothing, rowDimensions = Core.Nothing}
instance Core.FromJSON CreativeStatusRow where
        parseJSON
          = Core.withObject "CreativeStatusRow"
              (\ o ->
                 CreativeStatusRow Core.<$>
                   (o Core..:? "bidCount") Core.<*> (o Core..:? "creativeStatusId")
                     Core.<*> (o Core..:? "rowDimensions"))
...
newCriteriaTargeting 
    ::  CriteriaTargeting
newCriteriaTargeting
  = CriteriaTargeting{excludedCriteriaIds = Core.Nothing,
...
instance Core.ToJSON CriteriaTargeting where
        toJSON CriteriaTargeting{..}
          = Core.object
              (Core.catMaybes
                 [("excludedCriteriaIds" Core..=) Core.. Core.fmap Core.AsText
                    Core.<$> excludedCriteriaIds,
                  ("targetedCriteriaIds" Core..=) Core.. Core.fmap Core.AsText
...
newDayPart 
    ::  DayPart
newDayPart
  = DayPart{dayOfWeek = Core.Nothing, endTime = Core.Nothing,
...
instance Core.FromJSON DayPart where
        parseJSON
          = Core.withObject "DayPart"
              (\ o ->
                 DayPart Core.<$>
                   (o Core..:? "dayOfWeek") Core.<*> (o Core..:? "endTime") Core.<*>
                     (o Core..:? "startTime"))
...
newDayPartTargeting 
    ::  DayPartTargeting
newDayPartTargeting
  = DayPartTargeting{dayParts = Core.Nothing,
...
newDeal 
    ::  Deal
newDeal
  = Deal{availableEndTime = Core.Nothing,
         availableStartTime = Core.Nothing, buyerPrivateData = Core.Nothing,
         createProductId = Core.Nothing,
         createProductRevision = Core.Nothing, createTime = Core.Nothing,
         ...
         dealTerms = Core.Nothing, deliveryControl = Core.Nothing,
         description = Core.Nothing, displayName = Core.Nothing,
         externalDealId = Core.Nothing, isSetupComplete = Core.Nothing,
         programmaticCreativeSource = Core.Nothing,
         proposalId = Core.Nothing, sellerContacts = Core.Nothing,
         syndicationProduct = Core.Nothing, targeting = Core.Nothing,
         targetingCriterion = Core.Nothing, updateTime = Core.Nothing,
          ...
          = Core.object
              (Core.catMaybes
                 [("availableEndTime" Core..=) Core.<$> availableEndTime,
                  ...
                  ("createProductRevision" Core..=) Core.. Core.AsText Core.<$>
...
newDealPauseStatus 
    ::  DealPauseStatus
newDealPauseStatus
  = DealPauseStatus{buyerPauseReason = Core.Nothing,
                    firstPausedBy = Core.Nothing, hasBuyerPaused = Core.Nothing,
                    hasSellerPaused = Core.Nothing, sellerPauseReason = Core.Nothing}
...
instance Core.FromJSON DealTerms where
        parseJSON
          = Core.withObject "DealTerms"
              (\ o ->
                 DealTerms Core.<$>
                   (o Core..:? "brandingType") Core.<*> (o Core..:? "description")
...
newFilterSet 
    ::  FilterSet
newFilterSet
  = FilterSet{absoluteDateRange = Core.Nothing,
              breakdownDimensions = Core.Nothing, creativeId = Core.Nothing,
              dealId = Core.Nothing, environment = Core.Nothing,
              format = Core.Nothing, formats = Core.Nothing, name = Core.Nothing,
              platforms = Core.Nothing, publisherIdentifiers = Core.Nothing,
              realtimeTimeRange = Core.Nothing, relativeDateRange = Core.Nothing,
...
newFilteredBidCreativeRow 
    ::  FilteredBidCreativeRow
newFilteredBidCreativeRow
  = FilteredBidCreativeRow{bidCount = Core.Nothing,
                           creativeId = Core.Nothing, rowDimensions = Core.Nothing}
instance Core.FromJSON FilteredBidCreativeRow where
        parseJSON
          = Core.withObject "FilteredBidCreativeRow"
              (\ o ->
                 FilteredBidCreativeRow Core.<$>
                   (o Core..:? "bidCount") Core.<*> (o Core..:? "creativeId") Core.<*>
                     (o Core..:? "rowDimensions"))
...
newFilteredBidDetailRow 
    ::  FilteredBidDetailRow
newFilteredBidDetailRow
  = FilteredBidDetailRow{bidCount = Core.Nothing,
                         detail = Core.Nothing, detailId = Core.Nothing,
          ...
          = Core.withObject "FilteredBidDetailRow"
              (\ o ->
                 FilteredBidDetailRow Core.<$>
                   (o Core..:? "bidCount") Core.<*> (o Core..:? "detail") Core.<*>
                     (o Core..:? "detailId")
                     Core.<*> (o Core..:? "rowDimensions"))
...
newFirstPartyMobileApplicationTargeting 
    :: 
                                        FirstPartyMobileApplicationTargeting
newFirstPartyMobileApplicationTargeting
  = FirstPartyMobileApplicationTargeting{excludedAppIds =
                                           Core.Nothing,
                                         targetedAppIds = Core.Nothing}
instance Core.FromJSON FirstPartyMobileApplicationTargeting where
        parseJSON
          = Core.withObject "FirstPartyMobileApplicationTargeting"
              (\ o ->
...
newFrequencyCap 
    ::  FrequencyCap
newFrequencyCap
  = FrequencyCap{maxImpressions = Core.Nothing,
...
newGuaranteedFixedPriceTerms 
    ::  GuaranteedFixedPriceTerms
newGuaranteedFixedPriceTerms
  = GuaranteedFixedPriceTerms{fixedPrices = Core.Nothing,
                              guaranteedImpressions = Core.Nothing,
                              guaranteedLooks = Core.Nothing, impressionCap = Core.Nothing,
                              minimumDailyLooks = Core.Nothing,
                              percentShareOfVoice = Core.Nothing, reservationType = Core.Nothing}
              ...
              (\ o ->
                 GuaranteedFixedPriceTerms Core.<$>
                   (o Core..:? "fixedPrices") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "impressionCap" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "minimumDailyLooks" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
              ...
              (Core.catMaybes
                 [("fixedPrices" Core..=) Core.<$> fixedPrices,
                  ...
                  ("minimumDailyLooks" Core..=) Core.. Core.AsText Core.<$>
                    minimumDailyLooks,
                  ("percentShareOfVoice" Core..=) Core.. Core.AsText Core.<$>
                    percentShareOfVoice,
...
newHtmlContent 
    ::  HtmlContent
newHtmlContent
  = HtmlContent{height = Core.Nothing, snippet = Core.Nothing,
                width = Core.Nothing}
instance Core.FromJSON HtmlContent where
        parseJSON
          = Core.withObject "HtmlContent"
              (\ o ->
                 HtmlContent Core.<$>
                   (o Core..:? "height") Core.<*> (o Core..:? "snippet") Core.<*>
                     (o Core..:? "width"))
...
newImage 
    ::  Image
newImage
  = Image{height = Core.Nothing, url = Core.Nothing,
          width = Core.Nothing}
...
newImpressionMetricsRow 
    ::  ImpressionMetricsRow
newImpressionMetricsRow
  = ImpressionMetricsRow{availableImpressions = Core.Nothing,
                         bidRequests = Core.Nothing, inventoryMatches = Core.Nothing,
                         responsesWithBids = Core.Nothing, rowDimensions = Core.Nothing,
...
newInventorySizeTargeting 
    ::  InventorySizeTargeting
newInventorySizeTargeting
  = InventorySizeTargeting{excludedInventorySizes = Core.Nothing,
...
newListBidMetricsResponse 
    ::  ListBidMetricsResponse
newListBidMetricsResponse
  = ListBidMetricsResponse{bidMetricsRows = Core.Nothing,
...
newListBidResponseErrorsResponse 
    ::  ListBidResponseErrorsResponse
newListBidResponseErrorsResponse
  = ListBidResponseErrorsResponse{calloutStatusRows = Core.Nothing,
                                  nextPageToken = Core.Nothing}
...
newListBidResponsesWithoutBidsResponse 
    :: 
                                       ListBidResponsesWithoutBidsResponse
newListBidResponsesWithoutBidsResponse
  = ListBidResponsesWithoutBidsResponse{bidResponseWithoutBidsStatusRows
                                          = Core.Nothing,
                                        nextPageToken = Core.Nothing}
instance Core.FromJSON ListBidResponsesWithoutBidsResponse where
        parseJSON
          = Core.withObject "ListBidResponsesWithoutBidsResponse"
              (\ o ->
                 ListBidResponsesWithoutBidsResponse Core.<$>
                   (o Core..:? "bidResponseWithoutBidsStatusRows") Core.<*>
                     (o Core..:? "nextPageToken"))
...
instance Core.ToJSON ListBidResponsesWithoutBidsResponse where
        toJSON ListBidResponsesWithoutBidsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("bidResponseWithoutBidsStatusRows" Core..=) Core.<$>
...
newListClientUserInvitationsResponse 
    :: 
                                     ListClientUserInvitationsResponse
newListClientUserInvitationsResponse
  = ListClientUserInvitationsResponse{invitations = Core.Nothing,
                                      nextPageToken = Core.Nothing}
...
newListClientUsersResponse 
    ::  ListClientUsersResponse
newListClientUsersResponse
  = ListClientUsersResponse{nextPageToken = Core.Nothing,
                            users = Core.Nothing}
...
newListClientsResponse 
    ::  ListClientsResponse
newListClientsResponse
  = ListClientsResponse{clients = Core.Nothing,
                        nextPageToken = Core.Nothing}
          ...
          = Core.withObject "ListClientsResponse"
              (\ o ->
                 ListClientsResponse Core.<$>
                   (o Core..:? "clients") Core.<*> (o Core..:? "nextPageToken"))
...
newListCreativeStatusBreakdownByCreativeResponse 
    :: 
                                                 ListCreativeStatusBreakdownByCreativeResponse
newListCreativeStatusBreakdownByCreativeResponse
  = ListCreativeStatusBreakdownByCreativeResponse{filteredBidCreativeRows
                                                    = Core.Nothing,
                                                  nextPageToken = Core.Nothing}
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "ListCreativeStatusBreakdownByCreativeResponse"
              (\ o ->
                 ListCreativeStatusBreakdownByCreativeResponse Core.<$>
                   (o Core..:? "filteredBidCreativeRows") Core.<*>
                     (o Core..:? "nextPageToken"))

instance Core.ToJSON ListCreativeStatusBreakdownByCreativeResponse
         where
...
newListCreativeStatusBreakdownByDetailResponse 
    :: 
                                               ListCreativeStatusBreakdownByDetailResponse
newListCreativeStatusBreakdownByDetailResponse
  = ListCreativeStatusBreakdownByDetailResponse{detailType =
                                                  Core.Nothing,
                                                filteredBidDetailRows = Core.Nothing,
                                                nextPageToken = Core.Nothing}
instance Core.FromJSON ListCreativeStatusBreakdownByDetailResponse
         where
        parseJSON
          = Core.withObject "ListCreativeStatusBreakdownByDetailResponse"
              (\ o ->
...
instance Core.ToJSON ListCreativeStatusBreakdownByDetailResponse
         where
...
newListCreativesResponse 
    ::  ListCreativesResponse
newListCreativesResponse
  = ListCreativesResponse{creatives = Core.Nothing,
                          nextPageToken = Core.Nothing}
          ...
          = Core.withObject "ListCreativesResponse"
              (\ o ->
                 ListCreativesResponse Core.<$>
                   (o Core..:? "creatives") Core.<*> (o Core..:? "nextPageToken"))
...
newListDealAssociationsResponse 
    ::  ListDealAssociationsResponse
newListDealAssociationsResponse
  = ListDealAssociationsResponse{associations = Core.Nothing,
                                 nextPageToken = Core.Nothing}
          ...
          = Core.withObject "ListDealAssociationsResponse"
              (\ o ->
                 ListDealAssociationsResponse Core.<$>
                   (o Core..:? "associations") Core.<*> (o Core..:? "nextPageToken"))
...
newListFilterSetsResponse 
    ::  ListFilterSetsResponse
newListFilterSetsResponse
  = ListFilterSetsResponse{filterSets = Core.Nothing,
                           nextPageToken = Core.Nothing}
          ...
          = Core.withObject "ListFilterSetsResponse"
              (\ o ->
                 ListFilterSetsResponse Core.<$>
                   (o Core..:? "filterSets") Core.<*> (o Core..:? "nextPageToken"))
...
newListFilteredBidRequestsResponse 
    :: 
                                   ListFilteredBidRequestsResponse
newListFilteredBidRequestsResponse
  = ListFilteredBidRequestsResponse{calloutStatusRows = Core.Nothing,
                                    nextPageToken = Core.Nothing}
...
newListFilteredBidsResponse 
    ::  ListFilteredBidsResponse
newListFilteredBidsResponse
  = ListFilteredBidsResponse{creativeStatusRows = Core.Nothing,
                             nextPageToken = Core.Nothing}
...
newListImpressionMetricsResponse 
    ::  ListImpressionMetricsResponse
newListImpressionMetricsResponse
  = ListImpressionMetricsResponse{impressionMetricsRows =
                                    Core.Nothing,
                                  nextPageToken = Core.Nothing}
...
newListLosingBidsResponse 
    ::  ListLosingBidsResponse
newListLosingBidsResponse
  = ListLosingBidsResponse{creativeStatusRows = Core.Nothing,
                           nextPageToken = Core.Nothing}
...
newListNonBillableWinningBidsResponse 
    :: 
                                      ListNonBillableWinningBidsResponse
newListNonBillableWinningBidsResponse
  = ListNonBillableWinningBidsResponse{nextPageToken = Core.Nothing,
                                       nonBillableWinningBidStatusRows = Core.Nothing}
instance Core.FromJSON ListNonBillableWinningBidsResponse where
        parseJSON
          = Core.withObject "ListNonBillableWinningBidsResponse"
              (\ o ->
...
newListProposalsResponse 
    ::  ListProposalsResponse
newListProposalsResponse
  = ListProposalsResponse{nextPageToken = Core.Nothing,
          ...
          = Core.withObject "ListProposalsResponse"
              (\ o ->
                 ListProposalsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "proposals"))
...
newListPublisherProfilesResponse 
    ::  ListPublisherProfilesResponse
newListPublisherProfilesResponse
  = ListPublisherProfilesResponse{nextPageToken = Core.Nothing,
...
newMarketplaceTargeting 
    ::  MarketplaceTargeting
newMarketplaceTargeting
  = MarketplaceTargeting{geoTargeting = Core.Nothing,
                         inventorySizeTargeting = Core.Nothing,
                         placementTargeting = Core.Nothing,
                         technologyTargeting = Core.Nothing, videoTargeting = Core.Nothing}
...
instance Core.FromJSON MetricValue where
        parseJSON
          = Core.withObject "MetricValue"
              (\ o ->
                 MetricValue Core.<$>
                   (o Core..:? "value" Core.<&> Core.fmap Core.fromAsText) Core.<*>
                     (o Core..:? "variance" Core.<&> Core.fmap Core.fromAsText))
...
newNativeContent 
    ::  NativeContent
newNativeContent
  = NativeContent{advertiserName = Core.Nothing,
                  ...
                  image = Core.Nothing, logo = Core.Nothing,
                  priceDisplayText = Core.Nothing, starRating = Core.Nothing,
                  storeUrl = Core.Nothing, videoUrl = Core.Nothing}
instance Core.FromJSON NativeContent where
        parseJSON
          = Core.withObject "NativeContent"
              (\ o ->
                 NativeContent Core.<$>
                   (o Core..:? "advertiserName") Core.<*> (o Core..:? "appIcon")
                     Core.<*> (o Core..:? "body")
          ...
          = Core.object
              (Core.catMaybes
                 [("advertiserName" Core..=) Core.<$> advertiserName,
                  ...
                  ("image" Core..=) Core.<$> image, ("logo" Core..=) Core.<$> logo,
...
newNonBillableWinningBidStatusRow 
    ::  NonBillableWinningBidStatusRow
newNonBillableWinningBidStatusRow
  = NonBillableWinningBidStatusRow{bidCount = Core.Nothing,
                                   rowDimensions = Core.Nothing, status = Core.Nothing}
          ...
          = Core.withObject "NonBillableWinningBidStatusRow"
              (\ o ->
                 NonBillableWinningBidStatusRow Core.<$>
                   (o Core..:? "bidCount") Core.<*> (o Core..:? "rowDimensions")
                     Core.<*> (o Core..:? "status"))
...
newNonGuaranteedAuctionTerms 
    ::  NonGuaranteedAuctionTerms
newNonGuaranteedAuctionTerms
  = NonGuaranteedAuctionTerms{autoOptimizePrivateAuction =
                                Core.Nothing,
...
newNote 
    ::  Note
newNote
  = Note{createTime = Core.Nothing, creatorRole = Core.Nothing,
...
instance Core.FromJSON Note where
        parseJSON
          = Core.withObject "Note"
              (\ o ->
                 Note Core.<$>
                   (o Core..:? "createTime") Core.<*> (o Core..:? "creatorRole")
                     Core.<*> (o Core..:? "note")
                     Core.<*> (o Core..:? "noteId")
                     Core.<*>
                     (o Core..:? "proposalRevision" Core.<&> Core.fmap Core.fromAsText))
          ...
          = Core.object
              (Core.catMaybes
                 [("createTime" Core..=) Core.<$> createTime,
                  ...
                  ("note" Core..=) Core.<$> note, ("noteId" Core..=) Core.<$> noteId,
                  ("proposalRevision" Core..=) Core.. Core.AsText Core.<$>
                    proposalRevision])
...
newOperatingSystemTargeting 
    ::  OperatingSystemTargeting
newOperatingSystemTargeting
  = OperatingSystemTargeting{operatingSystemCriteria = Core.Nothing,
...
newPauseProposalDealsRequest 
    ::  PauseProposalDealsRequest
newPauseProposalDealsRequest
  = PauseProposalDealsRequest{externalDealIds = Core.Nothing,
                              reason = Core.Nothing}
          ...
          = Core.withObject "PauseProposalDealsRequest"
              (\ o ->
                 PauseProposalDealsRequest Core.<$>
                   (o Core..:? "externalDealIds") Core.<*> (o Core..:? "reason"))
...
newPlacementTargeting 
    ::  PlacementTargeting
newPlacementTargeting
  = PlacementTargeting{mobileApplicationTargeting = Core.Nothing,
...
instance Core.FromJSON Price where
        parseJSON
          = Core.withObject "Price"
              (\ o ->
                 Price Core.<$>
                   (o Core..:? "amount") Core.<*> (o Core..:? "pricingType"))
...
newPricePerBuyer 
    ::  PricePerBuyer
newPricePerBuyer
  = PricePerBuyer{advertiserIds = Core.Nothing, buyer = Core.Nothing,
                  price = Core.Nothing}
instance Core.FromJSON PricePerBuyer where
        parseJSON
          = Core.withObject "PricePerBuyer"
              (\ o ->
                 PricePerBuyer Core.<$>
                   (o Core..:? "advertiserIds") Core.<*> (o Core..:? "buyer") Core.<*>
                     (o Core..:? "price"))
...
newProduct 
    ::  Product
newProduct
  = Product{availableEndTime = Core.Nothing,
            availableStartTime = Core.Nothing, createTime = Core.Nothing,
            creatorContacts = Core.Nothing, displayName = Core.Nothing,
            hasCreatorSignedOff = Core.Nothing, productId = Core.Nothing,
            productRevision = Core.Nothing, publisherProfileId = Core.Nothing,
            seller = Core.Nothing, syndicationProduct = Core.Nothing,
            targetingCriterion = Core.Nothing, terms = Core.Nothing,
            updateTime = Core.Nothing, webPropertyCode = Core.Nothing}
              ...
              (\ o ->
                 Product Core.<$>
                   (o Core..:? "availableEndTime") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "productRevision" Core.<&> Core.fmap Core.fromAsText)
          ...
          = Core.object
              (Core.catMaybes
                 [("availableEndTime" Core..=) Core.<$> availableEndTime,
                  ...
                  ("productRevision" Core..=) Core.. Core.AsText Core.<$>
                    productRevision,
...
newProposal
  = Proposal{billedBuyer = Core.Nothing, buyer = Core.Nothing,
             ...
             deals = Core.Nothing, displayName = Core.Nothing,
             isRenegotiating = Core.Nothing, isSetupComplete = Core.Nothing,
             lastUpdaterOrCommentorRole = Core.Nothing, notes = Core.Nothing,
             originatorRole = Core.Nothing, privateAuctionId = Core.Nothing,
             proposalId = Core.Nothing, proposalRevision = Core.Nothing,
             proposalState = Core.Nothing, seller = Core.Nothing,
             sellerContacts = Core.Nothing, termsAndConditions = Core.Nothing,
...
newPublisherProfile 
    ::  PublisherProfile
newPublisherProfile
  = PublisherProfile{audienceDescription = Core.Nothing,
                     buyerPitchStatement = Core.Nothing,
                     directDealsContact = Core.Nothing, displayName = Core.Nothing,
                     domains = Core.Nothing, googlePlusUrl = Core.Nothing,
                     isParent = Core.Nothing, logoUrl = Core.Nothing,
                     mediaKitUrl = Core.Nothing, mobileApps = Core.Nothing,
                     overview = Core.Nothing, programmaticDealsContact = Core.Nothing,
                     publisherProfileId = Core.Nothing, rateCardInfoUrl = Core.Nothing,
                     samplePageUrl = Core.Nothing, seller = Core.Nothing,
...
newPublisherProfileMobileApplication 
    :: 
                                     PublisherProfileMobileApplication
newPublisherProfileMobileApplication
  = PublisherProfileMobileApplication{appStore = Core.Nothing,
                                      externalAppId = Core.Nothing, name = Core.Nothing}
...
newRelativeDateRange 
    ::  RelativeDateRange
newRelativeDateRange
  = RelativeDateRange{durationDays = Core.Nothing,
          ...
          = Core.withObject "RelativeDateRange"
              (\ o ->
                 RelativeDateRange Core.<$>
                   (o Core..:? "durationDays") Core.<*> (o Core..:? "offsetDays"))
...
newRowDimensions 
    ::  RowDimensions
newRowDimensions
  = RowDimensions{publisherIdentifier = Core.Nothing,
...
newServingContext 
    ::  ServingContext
newServingContext
  = ServingContext{all = Core.Nothing, appType = Core.Nothing,
                   auctionType = Core.Nothing, location = Core.Nothing,
                   platform = Core.Nothing, securityType = Core.Nothing}
instance Core.FromJSON ServingContext where
        parseJSON
          = Core.withObject "ServingContext"
              (\ o ->
                 ServingContext Core.<$>
                   (o Core..:? "all") Core.<*> (o Core..:? "appType") Core.<*>
                     (o Core..:? "auctionType")
...
newServingRestriction 
    ::  ServingRestriction
newServingRestriction
  = ServingRestriction{contexts = Core.Nothing,
                       disapproval = Core.Nothing, disapprovalReasons = Core.Nothing,
                       status = Core.Nothing}
          ...
          = Core.withObject "ServingRestriction"
              (\ o ->
                 ServingRestriction Core.<$>
                   (o Core..:? "contexts") Core.<*> (o Core..:? "disapproval")
...
newTargetingCriteria 
    ::  TargetingCriteria
newTargetingCriteria
  = TargetingCriteria{exclusions = Core.Nothing,
...
newTargetingValue
  = TargetingValue{creativeSizeValue = Core.Nothing,
                   dayPartTargetingValue = Core.Nothing, longValue = Core.Nothing,
...
newTechnologyTargeting 
    ::  TechnologyTargeting
newTechnologyTargeting
  = TechnologyTargeting{deviceCapabilityTargeting = Core.Nothing,
...
newUrlTargeting 
    ::  UrlTargeting
newUrlTargeting
  = UrlTargeting{excludedUrls = Core.Nothing,
...
instance Core.FromJSON UrlTargeting where
        parseJSON
          = Core.withObject "UrlTargeting"
              (\ o ->
                 UrlTargeting Core.<$>
                   (o Core..:? "excludedUrls") Core.<*> (o Core..:? "targetedUrls"))
...
newVideoContent 
    ::  VideoContent
newVideoContent
  = VideoContent{videoUrl = Core.Nothing,
...
instance Core.FromJSON VideoContent where
        parseJSON
          = Core.withObject "VideoContent"
              (\ o ->
                 VideoContent Core.<$>
                   (o Core..:? "videoUrl") Core.<*> (o Core..:? "videoVastXml"))
...
newVideoTargeting 
    ::  VideoTargeting
newVideoTargeting
  = VideoTargeting{excludedPositionTypes = Core.Nothing,
