  ...
  (
    ...
    NonBillableWinningBidStatusRow_Status
      (
        ...
        NonBillableWinningBidStatusRow_Status_OVERDELIVEREDIMPRESSION,
        ..
      ),
...
pattern NonBillableWinningBidStatusRow_Status_OVERDELIVEREDIMPRESSION :: NonBillableWinningBidStatusRow_Status
pattern NonBillableWinningBidStatusRow_Status_OVERDELIVEREDIMPRESSION = NonBillableWinningBidStatusRow_Status "OVERDELIVERED_IMPRESSION"
