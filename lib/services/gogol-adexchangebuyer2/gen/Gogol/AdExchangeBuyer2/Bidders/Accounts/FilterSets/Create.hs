...
newAdExchangeBuyer2BiddersAccountsFilterSetsCreate 
    ...
    -> AdExchangeBuyer2BiddersAccountsFilterSetsCreate
newAdExchangeBuyer2BiddersAccountsFilterSetsCreate ownerName
  payload
  = AdExchangeBuyer2BiddersAccountsFilterSetsCreate{xgafv =
                                                      Core.Nothing,
                                                    accessToken = Core.Nothing,
                                                    callback = Core.Nothing,
                                                    isTransient = Core.Nothing,
                                                    ownerName = ownerName, payload = payload,
...
instance Core.GoogleRequest
        ...
        type Scopes AdExchangeBuyer2BiddersAccountsFilterSetsCreate =
             '[Adexchange'Buyer]
