                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] ListLosingBidsResponse
...
newAdExchangeBuyer2BiddersAccountsFilterSetsLosingBidsList
  filterSetName
  = AdExchangeBuyer2BiddersAccountsFilterSetsLosingBidsList{xgafv =
                                                              Core.Nothing,
...
instance Core.GoogleRequest
           AdExchangeBuyer2BiddersAccountsFilterSetsLosingBidsList
         where
        type Rs AdExchangeBuyer2BiddersAccountsFilterSetsLosingBidsList =
             ListLosingBidsResponse
        type Scopes AdExchangeBuyer2BiddersAccountsFilterSetsLosingBidsList
             = '[Adexchange'Buyer]
        requestClient
          AdExchangeBuyer2BiddersAccountsFilterSetsLosingBidsList{..}
