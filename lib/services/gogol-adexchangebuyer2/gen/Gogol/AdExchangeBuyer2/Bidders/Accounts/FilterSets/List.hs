...
newAdExchangeBuyer2BiddersAccountsFilterSetsList ownerName
  = AdExchangeBuyer2BiddersAccountsFilterSetsList{xgafv =
                                                    Core.Nothing,
                                                  accessToken = Core.Nothing,
                                                  callback = Core.Nothing, ownerName = ownerName,
...
instance Core.GoogleRequest
           AdExchangeBuyer2BiddersAccountsFilterSetsList
         where
        type Rs AdExchangeBuyer2BiddersAccountsFilterSetsList =
             ListFilterSetsResponse
        type Scopes AdExchangeBuyer2BiddersAccountsFilterSetsList =
             '[Adexchange'Buyer]
        requestClient AdExchangeBuyer2BiddersAccountsFilterSetsList{..}
          = go ownerName xgafv accessToken callback pageSize pageToken
              uploadType
              uploadProtocol
