...
newAdExchangeBuyer2BiddersAccountsFilterSetsBidMetricsList
  filterSetName
  = AdExchangeBuyer2BiddersAccountsFilterSetsBidMetricsList{xgafv =
                                                              Core.Nothing,
...
instance Core.GoogleRequest
           AdExchangeBuyer2BiddersAccountsFilterSetsBidMetricsList
         where
        type Rs AdExchangeBuyer2BiddersAccountsFilterSetsBidMetricsList =
             ListBidMetricsResponse
        type Scopes AdExchangeBuyer2BiddersAccountsFilterSetsBidMetricsList
             = '[Adexchange'Buyer]
        requestClient
          AdExchangeBuyer2BiddersAccountsFilterSetsBidMetricsList{..}
