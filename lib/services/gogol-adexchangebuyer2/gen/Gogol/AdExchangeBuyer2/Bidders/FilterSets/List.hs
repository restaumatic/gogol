...
newAdExchangeBuyer2BiddersFilterSetsList ownerName
  = AdExchangeBuyer2BiddersFilterSetsList{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          ownerName = ownerName, pageSize = Core.Nothing,
                                          pageToken = Core.Nothing, uploadType = Core.Nothing,
                                          uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AdExchangeBuyer2BiddersFilterSetsList
         where
