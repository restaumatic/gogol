                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] ListBidResponseErrorsResponse
...
newAdExchangeBuyer2BiddersFilterSetsBidResponseErrorsList
  filterSetName
  = AdExchangeBuyer2BiddersFilterSetsBidResponseErrorsList{xgafv =
                                                             Core.Nothing,
...
instance Core.GoogleRequest
           AdExchangeBuyer2BiddersFilterSetsBidResponseErrorsList
         where
        type Rs AdExchangeBuyer2BiddersFilterSetsBidResponseErrorsList =
             ListBidResponseErrorsResponse
        type Scopes AdExchangeBuyer2BiddersFilterSetsBidResponseErrorsList
             = '[Adexchange'Buyer]
        requestClient
          AdExchangeBuyer2BiddersFilterSetsBidResponseErrorsList{..}
          = go filterSetName xgafv accessToken callback pageSize pageToken
              uploadType
              uploadProtocol
