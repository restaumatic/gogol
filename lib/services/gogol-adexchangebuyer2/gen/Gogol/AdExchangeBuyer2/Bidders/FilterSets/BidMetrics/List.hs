...
newAdExchangeBuyer2BiddersFilterSetsBidMetricsList filterSetName
  = AdExchangeBuyer2BiddersFilterSetsBidMetricsList{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           AdExchangeBuyer2BiddersFilterSetsBidMetricsList
         where
        type Rs AdExchangeBuyer2BiddersFilterSetsBidMetricsList =
             ListBidMetricsResponse
        type Scopes AdExchangeBuyer2BiddersFilterSetsBidMetricsList =
             '[Adexchange'Buyer]
