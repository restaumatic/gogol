...
newAdExchangeBuyer2BiddersFilterSetsDelete name
  = AdExchangeBuyer2BiddersFilterSetsDelete{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            name = name, uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AdExchangeBuyer2BiddersFilterSetsDelete
         where
        type Rs AdExchangeBuyer2BiddersFilterSetsDelete = Empty
        type Scopes AdExchangeBuyer2BiddersFilterSetsDelete =
             '[Adexchange'Buyer]
