...
newAdExchangeBuyer2BiddersFilterSetsFilteredBidsList filterSetName
  = AdExchangeBuyer2BiddersFilterSetsFilteredBidsList{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           AdExchangeBuyer2BiddersFilterSetsFilteredBidsList
         where
        type Rs AdExchangeBuyer2BiddersFilterSetsFilteredBidsList =
             ListFilteredBidsResponse
        type Scopes AdExchangeBuyer2BiddersFilterSetsFilteredBidsList =
             '[Adexchange'Buyer]
