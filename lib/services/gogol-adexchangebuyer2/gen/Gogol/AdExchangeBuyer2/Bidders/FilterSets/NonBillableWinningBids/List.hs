                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] ListNonBillableWinningBidsResponse
...
newAdExchangeBuyer2BiddersFilterSetsNonBillableWinningBidsList
  filterSetName
  = AdExchangeBuyer2BiddersFilterSetsNonBillableWinningBidsList{xgafv
                                                                  = Core.Nothing,
...
instance Core.GoogleRequest
           AdExchangeBuyer2BiddersFilterSetsNonBillableWinningBidsList
         where
        type Rs AdExchangeBuyer2BiddersFilterSetsNonBillableWinningBidsList
