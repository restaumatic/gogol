                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] ListImpressionMetricsResponse
...
newAdExchangeBuyer2BiddersFilterSetsImpressionMetricsList
  filterSetName
  = AdExchangeBuyer2BiddersFilterSetsImpressionMetricsList{xgafv =
                                                             Core.Nothing,
...
instance Core.GoogleRequest
           AdExchangeBuyer2BiddersFilterSetsImpressionMetricsList
         where
        type Rs AdExchangeBuyer2BiddersFilterSetsImpressionMetricsList =
             ListImpressionMetricsResponse
        type Scopes AdExchangeBuyer2BiddersFilterSetsImpressionMetricsList
             = '[Adexchange'Buyer]
        requestClient
          AdExchangeBuyer2BiddersFilterSetsImpressionMetricsList{..}
