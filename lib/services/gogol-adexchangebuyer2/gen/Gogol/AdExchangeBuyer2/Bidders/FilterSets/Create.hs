...
newAdExchangeBuyer2BiddersFilterSetsCreate ownerName payload
  = AdExchangeBuyer2BiddersFilterSetsCreate{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            isTransient = Core.Nothing, ownerName = ownerName,
                                            payload = payload, uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AdExchangeBuyer2BiddersFilterSetsCreate
         where
        type Rs AdExchangeBuyer2BiddersFilterSetsCreate = FilterSet
        type Scopes AdExchangeBuyer2BiddersFilterSetsCreate =
             '[Adexchange'Buyer]
        requestClient AdExchangeBuyer2BiddersFilterSetsCreate{..}
          = go ownerName xgafv accessToken callback isTransient uploadType
              uploadProtocol
