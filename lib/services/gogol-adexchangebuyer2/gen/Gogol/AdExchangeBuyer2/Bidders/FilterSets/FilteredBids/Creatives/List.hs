                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Get '[Core.JSON] ListCreativeStatusBreakdownByCreativeResponse
...
newAdExchangeBuyer2BiddersFilterSetsFilteredBidsCreativesList
  ...
  = AdExchangeBuyer2BiddersFilterSetsFilteredBidsCreativesList{xgafv
                                                                 = Core.Nothing,
...
instance Core.GoogleRequest
           AdExchangeBuyer2BiddersFilterSetsFilteredBidsCreativesList
         where
        type Rs AdExchangeBuyer2BiddersFilterSetsFilteredBidsCreativesList
