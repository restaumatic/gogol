...
newAdExchangeBuyer2BiddersFilterSetsLosingBidsList filterSetName
  = AdExchangeBuyer2BiddersFilterSetsLosingBidsList{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           AdExchangeBuyer2BiddersFilterSetsLosingBidsList
         where
        type Rs AdExchangeBuyer2BiddersFilterSetsLosingBidsList =
             ListLosingBidsResponse
        type Scopes AdExchangeBuyer2BiddersFilterSetsLosingBidsList =
             '[Adexchange'Buyer]
