...
newAdExchangeBuyer2BiddersFilterSetsGet name
  = AdExchangeBuyer2BiddersFilterSetsGet{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         name = name, uploadType = Core.Nothing,
                                         uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AdExchangeBuyer2BiddersFilterSetsGet
         where
        type Rs AdExchangeBuyer2BiddersFilterSetsGet = FilterSet
        type Scopes AdExchangeBuyer2BiddersFilterSetsGet =
             '[Adexchange'Buyer]
