...
--
-- /See:/ <https://cloud.google.com/assured-workloads/access-approval/docs Access Approval API Reference> for @accessapproval.organizations.approvalRequests.get@.
module Gogol.AccessApproval.Organizations.ApprovalRequests.Get
    (
    -- * Resource
...
newAccessApprovalOrganizationsApprovalRequestsGet name
  = AccessApprovalOrganizationsApprovalRequestsGet{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           AccessApprovalOrganizationsApprovalRequestsGet
         where
        type Rs AccessApprovalOrganizationsApprovalRequestsGet =
             ApprovalRequest
        type Scopes AccessApprovalOrganizationsApprovalRequestsGet =
             '[CloudPlatform'FullControl]
        requestClient AccessApprovalOrganizationsApprovalRequestsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AccessApprovalOrganizationsApprovalRequestsGetResource)
                      Core.mempty
