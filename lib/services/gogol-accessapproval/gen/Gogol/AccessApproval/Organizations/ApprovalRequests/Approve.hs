...
newAccessApprovalOrganizationsApprovalRequestsApprove name payload
  = AccessApprovalOrganizationsApprovalRequestsApprove{xgafv =
                                                         Core.Nothing,
...
instance Core.GoogleRequest
           AccessApprovalOrganizationsApprovalRequestsApprove
         where
        type Rs AccessApprovalOrganizationsApprovalRequestsApprove =
             ApprovalRequest
        type Scopes AccessApprovalOrganizationsApprovalRequestsApprove =
