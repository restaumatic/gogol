...
newAccessApprovalProjectsUpdateAccessApprovalSettings name payload
  = AccessApprovalProjectsUpdateAccessApprovalSettings{xgafv =
                                                         Core.Nothing,
...
instance Core.GoogleRequest
           AccessApprovalProjectsUpdateAccessApprovalSettings
         where
        type Rs AccessApprovalProjectsUpdateAccessApprovalSettings =
             AccessApprovalSettings
        type Scopes AccessApprovalProjectsUpdateAccessApprovalSettings =
