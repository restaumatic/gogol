...
newAccessApprovalProjectsApprovalRequestsList parent
  = AccessApprovalProjectsApprovalRequestsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           AccessApprovalProjectsApprovalRequestsList
         where
        type Rs AccessApprovalProjectsApprovalRequestsList =
             ListApprovalRequestsResponse
        type Scopes AccessApprovalProjectsApprovalRequestsList =
