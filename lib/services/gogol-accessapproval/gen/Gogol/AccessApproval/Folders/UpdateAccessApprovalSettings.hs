...
newAccessApprovalFoldersUpdateAccessApprovalSettings name payload
  = AccessApprovalFoldersUpdateAccessApprovalSettings{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           AccessApprovalFoldersUpdateAccessApprovalSettings
         where
        type Rs AccessApprovalFoldersUpdateAccessApprovalSettings =
             AccessApprovalSettings
        type Scopes AccessApprovalFoldersUpdateAccessApprovalSettings =
