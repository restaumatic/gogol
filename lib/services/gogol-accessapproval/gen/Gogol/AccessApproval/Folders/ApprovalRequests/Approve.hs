...
--
-- /See:/ <https://cloud.google.com/assured-workloads/access-approval/docs Access Approval API Reference> for @accessapproval.folders.approvalRequests.approve@.
module Gogol.AccessApproval.Folders.ApprovalRequests.Approve
    (
    -- * Resource
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] ApproveApprovalRequestMessage Core.:>
...
newAccessApprovalFoldersApprovalRequestsApprove name payload
  = AccessApprovalFoldersApprovalRequestsApprove{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
           AccessApprovalFoldersApprovalRequestsApprove
         where
        type Rs AccessApprovalFoldersApprovalRequestsApprove =
             ApprovalRequest
        type Scopes AccessApprovalFoldersApprovalRequestsApprove =
             '[CloudPlatform'FullControl]
        requestClient AccessApprovalFoldersApprovalRequestsApprove{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AccessApprovalFoldersApprovalRequestsApproveResource)
                      Core.mempty
