...
--
-- /See:/ <https://cloud.google.com/assured-workloads/access-approval/docs Access Approval API Reference> for @accessapproval.folders.approvalRequests.list@.
module Gogol.AccessApproval.Folders.ApprovalRequests.List
    (
    -- * Resource
...
newAccessApprovalFoldersApprovalRequestsList parent
  = AccessApprovalFoldersApprovalRequestsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           AccessApprovalFoldersApprovalRequestsList
         where
        type Rs AccessApprovalFoldersApprovalRequestsList =
             ListApprovalRequestsResponse
        type Scopes AccessApprovalFoldersApprovalRequestsList =
             '[CloudPlatform'FullControl]
        requestClient AccessApprovalFoldersApprovalRequestsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AccessApprovalFoldersApprovalRequestsListResource)
                      Core.mempty
