       ...
       "v1" Core.:>
         "webResource" Core.:>
           Core.QueryParam "alt" Core.AltJSON Core.:>
             Core.Get '[Core.JSON] SiteVerificationWebResourceListResponse
...
newSiteVerificationWebResourceList
  = SiteVerificationWebResourceList
instance Core.GoogleRequest SiteVerificationWebResourceList where
        type Rs SiteVerificationWebResourceList =
             SiteVerificationWebResourceListResponse
        type Scopes SiteVerificationWebResourceList =
        ...
        requestClient SiteVerificationWebResourceList{}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy SiteVerificationWebResourceListResource)
                      Core.mempty
