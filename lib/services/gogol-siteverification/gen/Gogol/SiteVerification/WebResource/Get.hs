         ...
         "webResource" Core.:>
           Core.Capture "id" Core.Text Core.:>
             Core.QueryParam "alt" Core.AltJSON Core.:>
               Core.Get '[Core.JSON] SiteVerificationWebResourceResource
...
newSiteVerificationWebResourceGet 
    ...
    -> SiteVerificationWebResourceGet
newSiteVerificationWebResourceGet id
  = SiteVerificationWebResourceGet{id = id}
instance Core.GoogleRequest SiteVerificationWebResourceGet where
        ...
        requestClient SiteVerificationWebResourceGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy SiteVerificationWebResourceGetResource)
                      Core.mempty
