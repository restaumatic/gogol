...
type SiteVerificationWebResourceInsertResource =
     "siteVerification" Core.:>
       "v1" Core.:>
         "webResource" Core.:>
           Core.QueryParam "verificationMethod" Core.Text Core.:>
             Core.QueryParam "alt" Core.AltJSON Core.:>
               Core.ReqBody '[Core.JSON] SiteVerificationWebResourceResource
...
newSiteVerificationWebResourceInsert payload verificationMethod
  = SiteVerificationWebResourceInsert{payload = payload,
...
instance Core.GoogleRequest SiteVerificationWebResourceInsert where
        ...
        requestClient SiteVerificationWebResourceInsert{..}
          = go (Core.Just verificationMethod) (Core.Just Core.AltJSON)
              payload
