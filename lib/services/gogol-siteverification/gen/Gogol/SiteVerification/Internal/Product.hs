...
newSiteVerificationWebResourceGettokenRequest 
    :: 
                                              SiteVerificationWebResourceGettokenRequest
newSiteVerificationWebResourceGettokenRequest
  = SiteVerificationWebResourceGettokenRequest{site = Core.Nothing,
                                               verificationMethod = Core.Nothing}
instance Core.FromJSON SiteVerificationWebResourceGettokenRequest
         where
        parseJSON
          = Core.withObject "SiteVerificationWebResourceGettokenRequest"
              (\ o ->
                 SiteVerificationWebResourceGettokenRequest Core.<$>
                   (o Core..:? "site") Core.<*> (o Core..:? "verificationMethod"))

instance Core.ToJSON SiteVerificationWebResourceGettokenRequest
         where
...
newSiteVerificationWebResourceGettokenRequest_Site 
    :: 
                                                   SiteVerificationWebResourceGettokenRequest_Site
newSiteVerificationWebResourceGettokenRequest_Site
  = SiteVerificationWebResourceGettokenRequest_Site{identifier =
                                                      Core.Nothing,
                                                    type' = Core.Nothing}
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "SiteVerificationWebResourceGettokenRequest_Site"
              (\ o ->
                 SiteVerificationWebResourceGettokenRequest_Site Core.<$>
...
newSiteVerificationWebResourceGettokenResponse 
    :: 
                                               SiteVerificationWebResourceGettokenResponse
newSiteVerificationWebResourceGettokenResponse
  = SiteVerificationWebResourceGettokenResponse{method =
                                                  Core.Nothing,
                                                token = Core.Nothing}
instance Core.FromJSON SiteVerificationWebResourceGettokenResponse
         where
        parseJSON
          = Core.withObject "SiteVerificationWebResourceGettokenResponse"
              (\ o ->
                 SiteVerificationWebResourceGettokenResponse Core.<$>
                   (o Core..:? "method") Core.<*> (o Core..:? "token"))

instance Core.ToJSON SiteVerificationWebResourceGettokenResponse
         where
...
instance Core.FromJSON SiteVerificationWebResourceListResponse
         where
        parseJSON
          = Core.withObject "SiteVerificationWebResourceListResponse"
              (\ o ->
                 SiteVerificationWebResourceListResponse Core.<$>
                   (o Core..:? "items"))
...
newSiteVerificationWebResourceResource 
    :: 
                                       SiteVerificationWebResourceResource
newSiteVerificationWebResourceResource
  = SiteVerificationWebResourceResource{id = Core.Nothing,
                                        owners = Core.Nothing, site = Core.Nothing}
instance Core.FromJSON SiteVerificationWebResourceResource where
        parseJSON
          = Core.withObject "SiteVerificationWebResourceResource"
              (\ o ->
                 SiteVerificationWebResourceResource Core.<$>
                   (o Core..:? "id") Core.<*> (o Core..:? "owners") Core.<*>
                     (o Core..:? "site"))
...
instance Core.ToJSON SiteVerificationWebResourceResource where
        toJSON SiteVerificationWebResourceResource{..}
          = Core.object
              (Core.catMaybes
                 [("id" Core..=) Core.<$> id, ("owners" Core..=) Core.<$> owners,
                  ("site" Core..=) Core.<$> site])
...
newSiteVerificationWebResourceResource_Site 
    :: 
                                            SiteVerificationWebResourceResource_Site
newSiteVerificationWebResourceResource_Site
  = SiteVerificationWebResourceResource_Site{identifier =
                                               Core.Nothing,
                                             type' = Core.Nothing}
instance Core.FromJSON SiteVerificationWebResourceResource_Site
         where
        parseJSON
          = Core.withObject "SiteVerificationWebResourceResource_Site"
              (\ o ->
                 SiteVerificationWebResourceResource_Site Core.<$>
                   (o Core..:? "identifier") Core.<*> (o Core..:? "type"))
