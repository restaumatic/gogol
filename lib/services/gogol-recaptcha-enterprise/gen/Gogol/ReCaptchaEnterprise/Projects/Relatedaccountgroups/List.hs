...
newReCaptchaEnterpriseProjectsRelatedaccountgroupsList parent
  = ReCaptchaEnterpriseProjectsRelatedaccountgroupsList{xgafv =
                                                          Core.Nothing,
...
instance Core.GoogleRequest
           ReCaptchaEnterpriseProjectsRelatedaccountgroupsList
         where
        type Rs ReCaptchaEnterpriseProjectsRelatedaccountgroupsList =
             GoogleCloudRecaptchaenterpriseV1ListRelatedAccountGroupsResponse
        type Scopes ReCaptchaEnterpriseProjectsRelatedaccountgroupsList =
