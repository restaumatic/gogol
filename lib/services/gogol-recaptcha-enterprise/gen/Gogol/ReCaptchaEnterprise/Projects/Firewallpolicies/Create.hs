...
newReCaptchaEnterpriseProjectsFirewallpoliciesCreate parent payload
  = ReCaptchaEnterpriseProjectsFirewallpoliciesCreate{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           ReCaptchaEnterpriseProjectsFirewallpoliciesCreate
         where
        type Rs ReCaptchaEnterpriseProjectsFirewallpoliciesCreate =
             GoogleCloudRecaptchaenterpriseV1FirewallPolicy
        type Scopes ReCaptchaEnterpriseProjectsFirewallpoliciesCreate =
