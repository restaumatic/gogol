...
newReCaptchaEnterpriseProjectsFirewallpoliciesGet name
  = ReCaptchaEnterpriseProjectsFirewallpoliciesGet{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           ReCaptchaEnterpriseProjectsFirewallpoliciesGet
         where
        type Rs ReCaptchaEnterpriseProjectsFirewallpoliciesGet =
             GoogleCloudRecaptchaenterpriseV1FirewallPolicy
        type Scopes ReCaptchaEnterpriseProjectsFirewallpoliciesGet =
             '[CloudPlatform'FullControl]
        requestClient ReCaptchaEnterpriseProjectsFirewallpoliciesGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ReCaptchaEnterpriseProjectsFirewallpoliciesGetResource)
                      Core.mempty
