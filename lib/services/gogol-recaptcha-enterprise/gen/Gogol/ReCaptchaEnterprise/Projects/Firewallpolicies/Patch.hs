...
newReCaptchaEnterpriseProjectsFirewallpoliciesPatch name payload
  = ReCaptchaEnterpriseProjectsFirewallpoliciesPatch{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           ReCaptchaEnterpriseProjectsFirewallpoliciesPatch
         where
        type Rs ReCaptchaEnterpriseProjectsFirewallpoliciesPatch =
             GoogleCloudRecaptchaenterpriseV1FirewallPolicy
        type Scopes ReCaptchaEnterpriseProjectsFirewallpoliciesPatch =
