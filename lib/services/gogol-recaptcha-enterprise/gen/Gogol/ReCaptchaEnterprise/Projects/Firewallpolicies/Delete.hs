...
newReCaptchaEnterpriseProjectsFirewallpoliciesDelete name
  = ReCaptchaEnterpriseProjectsFirewallpoliciesDelete{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           ReCaptchaEnterpriseProjectsFirewallpoliciesDelete
         where
        type Rs ReCaptchaEnterpriseProjectsFirewallpoliciesDelete =
             GoogleProtobufEmpty
        type Scopes ReCaptchaEnterpriseProjectsFirewallpoliciesDelete =
             '[CloudPlatform'FullControl]
        requestClient ReCaptchaEnterpriseProjectsFirewallpoliciesDelete{..}
