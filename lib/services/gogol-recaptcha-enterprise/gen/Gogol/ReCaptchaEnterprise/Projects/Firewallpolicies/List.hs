...
newReCaptchaEnterpriseProjectsFirewallpoliciesList parent
  = ReCaptchaEnterpriseProjectsFirewallpoliciesList{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           ReCaptchaEnterpriseProjectsFirewallpoliciesList
         where
        type Rs ReCaptchaEnterpriseProjectsFirewallpoliciesList =
             GoogleCloudRecaptchaenterpriseV1ListFirewallPoliciesResponse
        type Scopes ReCaptchaEnterpriseProjectsFirewallpoliciesList =
