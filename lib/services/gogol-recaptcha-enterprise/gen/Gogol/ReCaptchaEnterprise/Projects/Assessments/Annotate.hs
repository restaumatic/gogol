...
type ReCaptchaEnterpriseProjectsAssessmentsAnnotateResource =
     "v1" Core.:>
       Core.CaptureMode "name" "annotate" Core.Text Core.:>
...
newReCaptchaEnterpriseProjectsAssessmentsAnnotate name payload
  = ReCaptchaEnterpriseProjectsAssessmentsAnnotate{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           ReCaptchaEnterpriseProjectsAssessmentsAnnotate
         where
        type Rs ReCaptchaEnterpriseProjectsAssessmentsAnnotate =
             GoogleCloudRecaptchaenterpriseV1AnnotateAssessmentResponse
        type Scopes ReCaptchaEnterpriseProjectsAssessmentsAnnotate =
