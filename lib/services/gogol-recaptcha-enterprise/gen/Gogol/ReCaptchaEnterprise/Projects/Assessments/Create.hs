                   ...
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON]
                         ...
                         Core.:>
                         Core.Post '[Core.JSON] GoogleCloudRecaptchaenterpriseV1Assessment
...
newReCaptchaEnterpriseProjectsAssessmentsCreate parent payload
  = ReCaptchaEnterpriseProjectsAssessmentsCreate{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Rs ReCaptchaEnterpriseProjectsAssessmentsCreate =
             GoogleCloudRecaptchaenterpriseV1Assessment
        type Scopes ReCaptchaEnterpriseProjectsAssessmentsCreate =
