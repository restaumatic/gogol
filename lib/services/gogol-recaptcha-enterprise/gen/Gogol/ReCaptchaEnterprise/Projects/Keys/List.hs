...
newReCaptchaEnterpriseProjectsKeysList parent
  = ReCaptchaEnterpriseProjectsKeysList{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        pageSize = Core.Nothing, pageToken = Core.Nothing,
                                        parent = parent, uploadType = Core.Nothing,
                                        uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ReCaptchaEnterpriseProjectsKeysList
         where
        ...
        requestClient ReCaptchaEnterpriseProjectsKeysList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ReCaptchaEnterpriseProjectsKeysListResource)
                      Core.mempty
