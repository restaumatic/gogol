...
type ReCaptchaEnterpriseProjectsKeysRemoveIpOverrideResource =
     "v1" Core.:>
       Core.CaptureMode "name" "removeIpOverride" Core.Text Core.:>
...
newReCaptchaEnterpriseProjectsKeysRemoveIpOverride name payload
  = ReCaptchaEnterpriseProjectsKeysRemoveIpOverride{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           ReCaptchaEnterpriseProjectsKeysRemoveIpOverride
         where
        type Rs ReCaptchaEnterpriseProjectsKeysRemoveIpOverride =
             GoogleCloudRecaptchaenterpriseV1RemoveIpOverrideResponse
        type Scopes ReCaptchaEnterpriseProjectsKeysRemoveIpOverride =
