...
type ReCaptchaEnterpriseProjectsKeysListIpOverridesResource =
     "v1" Core.:>
       Core.CaptureMode "parent" "listIpOverrides" Core.Text Core.:>
...
newReCaptchaEnterpriseProjectsKeysListIpOverrides parent
  = ReCaptchaEnterpriseProjectsKeysListIpOverrides{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           ReCaptchaEnterpriseProjectsKeysListIpOverrides
         where
        type Rs ReCaptchaEnterpriseProjectsKeysListIpOverrides =
             GoogleCloudRecaptchaenterpriseV1ListIpOverridesResponse
        type Scopes ReCaptchaEnterpriseProjectsKeysListIpOverrides =
             '[CloudPlatform'FullControl]
        requestClient ReCaptchaEnterpriseProjectsKeysListIpOverrides{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ReCaptchaEnterpriseProjectsKeysListIpOverridesResource)
                      Core.mempty
