...
type ReCaptchaEnterpriseProjectsKeysAddIpOverrideResource =
     "v1" Core.:>
       Core.CaptureMode "name" "addIpOverride" Core.Text Core.:>
...
newReCaptchaEnterpriseProjectsKeysAddIpOverride name payload
  = ReCaptchaEnterpriseProjectsKeysAddIpOverride{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
           ReCaptchaEnterpriseProjectsKeysAddIpOverride
         where
        type Rs ReCaptchaEnterpriseProjectsKeysAddIpOverride =
             GoogleCloudRecaptchaenterpriseV1AddIpOverrideResponse
        type Scopes ReCaptchaEnterpriseProjectsKeysAddIpOverride =
