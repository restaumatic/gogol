...
module Gogol.ReCaptchaEnterprise.Internal.Product
  (
    ...
    GoogleCloudRecaptchaenterpriseV1PhoneAuthenticationEvent (..),
    newGoogleCloudRecaptchaenterpriseV1PhoneAuthenticationEvent,
    ...
    GoogleCloudRecaptchaenterpriseV1WebKeySettingsActionSettings (..),
    newGoogleCloudRecaptchaenterpriseV1WebKeySettingsActionSettings,

    -- * GoogleCloudRecaptchaenterpriseV1WebKeySettingsChallengeSettings
    GoogleCloudRecaptchaenterpriseV1WebKeySettingsChallengeSettings (..),
    newGoogleCloudRecaptchaenterpriseV1WebKeySettingsChallengeSettings,

    -- * GoogleCloudRecaptchaenterpriseV1WebKeySettingsChallengeSettings_ActionSettings
    GoogleCloudRecaptchaenterpriseV1WebKeySettingsChallengeSettings_ActionSettings (..),
    newGoogleCloudRecaptchaenterpriseV1WebKeySettingsChallengeSettings_ActionSettings,
...
data GoogleCloudRecaptchaenterpriseV1AnnotateAssessmentRequest = GoogleCloudRecaptchaenterpriseV1AnnotateAssessmentRequest
   ...
   GoogleCloudRecaptchaenterpriseV1AnnotateAssessmentRequest_Annotation)
    ...
    , phoneAuthenticationEvent :: (Core.Maybe
   GoogleCloudRecaptchaenterpriseV1PhoneAuthenticationEvent)
              ...
              (\ o ->
                 GoogleCloudRecaptchaenterpriseV1AnnotateAssessmentRequest Core.<$>
                   (o Core..:? "accountId") Core.<*> (o Core..:? "annotation")
                     ...
                     Core.<*> (o Core..:? "phoneAuthenticationEvent")
                     Core.<*> (o Core..:? "reasons")
          ...
          = Core.object
              (Core.catMaybes
                 [("accountId" Core..=) Core.<$> accountId,
                  ...
                  ("phoneAuthenticationEvent" Core..=) Core.<$>
                    phoneAuthenticationEvent,
...
--
-- /See:/ 'newGoogleCloudRecaptchaenterpriseV1PhoneAuthenticationEvent' smart constructor.
data GoogleCloudRecaptchaenterpriseV1PhoneAuthenticationEvent = GoogleCloudRecaptchaenterpriseV1PhoneAuthenticationEvent
    {
...
-- | Creates a value of 'GoogleCloudRecaptchaenterpriseV1PhoneAuthenticationEvent' with the minimum fields required to make a request.
newGoogleCloudRecaptchaenterpriseV1PhoneAuthenticationEvent 
    :: 
                                                            GoogleCloudRecaptchaenterpriseV1PhoneAuthenticationEvent
newGoogleCloudRecaptchaenterpriseV1PhoneAuthenticationEvent
  = GoogleCloudRecaptchaenterpriseV1PhoneAuthenticationEvent{eventTime
                                                               = Core.Nothing,
                                                             phoneNumber = Core.Nothing}
instance Core.FromJSON
           GoogleCloudRecaptchaenterpriseV1PhoneAuthenticationEvent
        ...
        parseJSON
          = Core.withObject
              "GoogleCloudRecaptchaenterpriseV1PhoneAuthenticationEvent"
              (\ o ->
                 GoogleCloudRecaptchaenterpriseV1PhoneAuthenticationEvent Core.<$>
                   (o Core..:? "eventTime") Core.<*> (o Core..:? "phoneNumber"))

instance Core.ToJSON
           GoogleCloudRecaptchaenterpriseV1PhoneAuthenticationEvent
         where
        toJSON GoogleCloudRecaptchaenterpriseV1PhoneAuthenticationEvent{..}
          = Core.object
              (Core.catMaybes
...
newGoogleCloudRecaptchaenterpriseV1WebKeySettings
  = GoogleCloudRecaptchaenterpriseV1WebKeySettings{allowAllDomains =
                                                   ...
                                                   challengeSettings = Core.Nothing,
          ...
          = Core.object
              (Core.catMaybes
                 [("allowAllDomains" Core..=) Core.<$> allowAllDomains,
                  ...
                  ("challengeSettings" Core..=) Core.<$> challengeSettings,
                  ("integrationType" Core..=) Core.<$> integrationType])


-- | Per-action challenge settings.
--
-- /See:/ 'newGoogleCloudRecaptchaenterpriseV1WebKeySettingsActionSettings' smart constructor.
newtype GoogleCloudRecaptchaenterpriseV1WebKeySettingsActionSettings = GoogleCloudRecaptchaenterpriseV1WebKeySettingsActionSettings
    {
...
-- | Creates a value of 'GoogleCloudRecaptchaenterpriseV1WebKeySettingsActionSettings' with the minimum fields required to make a request.
newGoogleCloudRecaptchaenterpriseV1WebKeySettingsActionSettings 
    :: 
                                                                GoogleCloudRecaptchaenterpriseV1WebKeySettingsActionSettings
newGoogleCloudRecaptchaenterpriseV1WebKeySettingsActionSettings
  = GoogleCloudRecaptchaenterpriseV1WebKeySettingsActionSettings{scoreThreshold
                                                                   = Core.Nothing}
instance Core.FromJSON
           GoogleCloudRecaptchaenterpriseV1WebKeySettingsActionSettings
         where
...
-- | Settings for POLICY/BASED/CHALLENGE keys to control when a challenge is triggered.
--
-- /See:/ 'newGoogleCloudRecaptchaenterpriseV1WebKeySettingsChallengeSettings' smart constructor.
data GoogleCloudRecaptchaenterpriseV1WebKeySettingsChallengeSettings = GoogleCloudRecaptchaenterpriseV1WebKeySettingsChallengeSettings
    {
   ...
   GoogleCloudRecaptchaenterpriseV1WebKeySettingsChallengeSettings_ActionSettings)
    ...
    , defaultSettings :: (Core.Maybe
   GoogleCloudRecaptchaenterpriseV1WebKeySettingsActionSettings)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'GoogleCloudRecaptchaenterpriseV1WebKeySettingsChallengeSettings' with the minimum fields required to make a request.
newGoogleCloudRecaptchaenterpriseV1WebKeySettingsChallengeSettings 
    :: 
                                                                   GoogleCloudRecaptchaenterpriseV1WebKeySettingsChallengeSettings
newGoogleCloudRecaptchaenterpriseV1WebKeySettingsChallengeSettings
  = GoogleCloudRecaptchaenterpriseV1WebKeySettingsChallengeSettings{actionSettings
                                                                      = Core.Nothing,
                                                                    defaultSettings = Core.Nothing}
instance Core.FromJSON
           GoogleCloudRecaptchaenterpriseV1WebKeySettingsChallengeSettings
         where
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 GoogleCloudRecaptchaenterpriseV1WebKeySettingsChallengeSettings
                   Core.<$>
                   (o Core..:? "actionSettings") Core.<*>
                     (o Core..:? "defaultSettings"))
...
instance Core.ToJSON
        ...
        toJSON
          ...
          = Core.object
              (Core.catMaybes
                 [("actionSettings" Core..=) Core.<$> actionSettings,
                  ("defaultSettings" Core..=) Core.<$> defaultSettings])


-- | Optional. The action to score threshold map. The action name should be the same as the action name passed in the @data-action@ attribute (see https:\/\/cloud.google.com\/recaptcha\/docs\/actions-website). Action names are case-insensitive. There is a maximum of 100 action settings. An action name has a maximum length of 100.
--
-- /See:/ 'newGoogleCloudRecaptchaenterpriseV1WebKeySettingsChallengeSettings_ActionSettings' smart constructor.
newtype GoogleCloudRecaptchaenterpriseV1WebKeySettingsChallengeSettings_ActionSettings = GoogleCloudRecaptchaenterpriseV1WebKeySettingsChallengeSettings_ActionSettings
    {
...
-- | Creates a value of 'GoogleCloudRecaptchaenterpriseV1WebKeySettingsChallengeSettings_ActionSettings' with the minimum fields required to make a request.
newGoogleCloudRecaptchaenterpriseV1WebKeySettingsChallengeSettings_ActionSettings 
    :: 
                                                                                  Core.HashMap
                                                                                    Core.Text
...
newGoogleCloudRecaptchaenterpriseV1WebKeySettingsChallengeSettings_ActionSettings
  additional
  = GoogleCloudRecaptchaenterpriseV1WebKeySettingsChallengeSettings_ActionSettings{additional
                                                                                     = additional}
instance Core.FromJSON
           GoogleCloudRecaptchaenterpriseV1WebKeySettingsChallengeSettings_ActionSettings
         where
