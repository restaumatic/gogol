...
newVideoIntelligenceVideosAnnotate payload
  = VideoIntelligenceVideosAnnotate{xgafv = Core.Nothing,
                                    accessToken = Core.Nothing, callback = Core.Nothing,
                                    payload = payload, uploadType = Core.Nothing,
                                    uploadProtocol = Core.Nothing}
instance Core.GoogleRequest VideoIntelligenceVideosAnnotate where
        type Rs VideoIntelligenceVideosAnnotate =
             GoogleLongrunning_Operation
        type Scopes VideoIntelligenceVideosAnnotate =
