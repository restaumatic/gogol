...
module Gogol.Sheets.Internal.Product
  (
    ...
    TableColumnDataValidationRule (..),
    newTableColumnDataValidationRule,
...
newAddConditionalFormatRuleRequest 
    :: 
                                   AddConditionalFormatRuleRequest
newAddConditionalFormatRuleRequest
  = AddConditionalFormatRuleRequest{index = Core.Nothing,
                                    rule = Core.Nothing}
...
newAddDataSourceResponse 
    ::  AddDataSourceResponse
newAddDataSourceResponse
  = AddDataSourceResponse{dataExecutionStatus = Core.Nothing,
...
--
-- /See:/ 'newAddTableRequest' smart constructor.
newtype AddTableRequest = AddTableRequest
    {
...
-- | Creates a value of 'AddTableRequest' with the minimum fields required to make a request.
newAddTableRequest 
    ::  AddTableRequest
newAddTableRequest = AddTableRequest{table = Core.Nothing}
instance Core.FromJSON AddTableRequest where
        parseJSON
          = Core.withObject "AddTableRequest"
              (\ o -> AddTableRequest Core.<$> (o Core..:? "table"))

instance Core.ToJSON AddTableRequest where
        toJSON AddTableRequest{..}
          = Core.object (Core.catMaybes [("table" Core..=) Core.<$> table])


-- | The result of adding a table.
--
-- /See:/ 'newAddTableResponse' smart constructor.
newtype AddTableResponse = AddTableResponse
    {
...
-- | Creates a value of 'AddTableResponse' with the minimum fields required to make a request.
newAddTableResponse 
    ::  AddTableResponse
newAddTableResponse = AddTableResponse{table = Core.Nothing}
instance Core.FromJSON AddTableResponse where
        parseJSON
          = Core.withObject "AddTableResponse"
              (\ o -> AddTableResponse Core.<$> (o Core..:? "table"))

instance Core.ToJSON AddTableResponse where
        toJSON AddTableResponse{..}
          = Core.object (Core.catMaybes [("table" Core..=) Core.<$> table])
...
newAppendCellsRequest 
    ::  AppendCellsRequest
newAppendCellsRequest
  = AppendCellsRequest{fields = Core.Nothing, rows = Core.Nothing,
                       sheetId = Core.Nothing, tableId = Core.Nothing}
instance Core.FromJSON AppendCellsRequest where
        parseJSON
          = Core.withObject "AppendCellsRequest"
              (\ o ->
                 AppendCellsRequest Core.<$>
                   (o Core..:? "fields") Core.<*> (o Core..:? "rows") Core.<*>
                     (o Core..:? "sheetId")
                     Core.<*> (o Core..:? "tableId"))
...
newAppendDimensionRequest 
    ::  AppendDimensionRequest
newAppendDimensionRequest
  = AppendDimensionRequest{dimension = Core.Nothing,
                           length = Core.Nothing, sheetId = Core.Nothing}
instance Core.FromJSON AppendDimensionRequest where
        parseJSON
          = Core.withObject "AppendDimensionRequest"
              (\ o ->
                 AppendDimensionRequest Core.<$>
                   (o Core..:? "dimension") Core.<*> (o Core..:? "length") Core.<*>
                     (o Core..:? "sheetId"))
...
newAppendValuesResponse 
    ::  AppendValuesResponse
newAppendValuesResponse
  = AppendValuesResponse{spreadsheetId = Core.Nothing,
                         tableRange = Core.Nothing, updates = Core.Nothing}
instance Core.FromJSON AppendValuesResponse where
        parseJSON
          = Core.withObject "AppendValuesResponse"
              (\ o ->
                 AppendValuesResponse Core.<$>
                   (o Core..:? "spreadsheetId") Core.<*> (o Core..:? "tableRange")
                     Core.<*> (o Core..:? "updates"))
...
newAutoFillRequest 
    ::  AutoFillRequest
newAutoFillRequest
  = AutoFillRequest{range = Core.Nothing,
          ...
          = Core.withObject "AutoFillRequest"
              (\ o ->
                 AutoFillRequest Core.<$>
                   (o Core..:? "range") Core.<*> (o Core..:? "sourceAndDestination")
...
newAutoResizeDimensionsRequest 
    ::  AutoResizeDimensionsRequest
newAutoResizeDimensionsRequest
  = AutoResizeDimensionsRequest{dataSourceSheetDimensions =
                                  Core.Nothing,
...
data BandedRange = BandedRange
    {
      -- | The ID of the banded range. If unset, refer to banded/range/reference.
      bandedRangeId :: (Core.Maybe Core.Int32)
      -- | Output only. The reference of the banded range, used to identify the ID that is not supported by the banded/range/id.
    , bandedRangeReference :: (Core.Maybe Core.Text)
...
newBandedRange 
    ::  BandedRange
newBandedRange
  = BandedRange{bandedRangeId = Core.Nothing,
                bandedRangeReference = Core.Nothing,
                columnProperties = Core.Nothing, range = Core.Nothing,
          ...
          = Core.object
              (Core.catMaybes
                 [("bandedRangeId" Core..=) Core.<$> bandedRangeId,
                  ("bandedRangeReference" Core..=) Core.<$> bandedRangeReference,
...
newBandingProperties 
    ::  BandingProperties
newBandingProperties
  = BandingProperties{firstBandColor = Core.Nothing,
                      firstBandColorStyle = Core.Nothing, footerColor = Core.Nothing,
                      footerColorStyle = Core.Nothing, headerColor = Core.Nothing,
                      headerColorStyle = Core.Nothing, secondBandColor = Core.Nothing,
...
newBaselineValueFormat 
    ::  BaselineValueFormat
newBaselineValueFormat
  = BaselineValueFormat{comparisonType = Core.Nothing,
                        description = Core.Nothing, negativeColor = Core.Nothing,
                        negativeColorStyle = Core.Nothing, position = Core.Nothing,
                        positiveColor = Core.Nothing, positiveColorStyle = Core.Nothing,
          ...
          = Core.withObject "BaselineValueFormat"
              (\ o ->
                 BaselineValueFormat Core.<$>
                   (o Core..:? "comparisonType") Core.<*> (o Core..:? "description")
...
newBasicChartAxis 
    ::  BasicChartAxis
newBasicChartAxis
  = BasicChartAxis{format = Core.Nothing, position = Core.Nothing,
                   title = Core.Nothing, titleTextPosition = Core.Nothing,
...
instance Core.FromJSON BasicChartAxis where
        parseJSON
          = Core.withObject "BasicChartAxis"
              (\ o ->
                 BasicChartAxis Core.<$>
                   (o Core..:? "format") Core.<*> (o Core..:? "position") Core.<*>
                     (o Core..:? "title")
          ...
          = Core.withObject "BasicChartDomain"
              (\ o ->
                 BasicChartDomain Core.<$>
                   (o Core..:? "domain") Core.<*> (o Core..:? "reversed"))
...
newBasicChartSeries 
    ::  BasicChartSeries
newBasicChartSeries
  = BasicChartSeries{color = Core.Nothing, colorStyle = Core.Nothing,
                     dataLabel = Core.Nothing, lineStyle = Core.Nothing,
                     pointStyle = Core.Nothing, series = Core.Nothing,
                     styleOverrides = Core.Nothing, targetAxis = Core.Nothing,
                     type' = Core.Nothing}
          ...
          = Core.withObject "BasicChartSeries"
              (\ o ->
                 BasicChartSeries Core.<$>
                   (o Core..:? "color") Core.<*> (o Core..:? "colorStyle") Core.<*>
                     (o Core..:? "dataLabel")
...
newBasicChartSpec 
    ::  BasicChartSpec
newBasicChartSpec
  = BasicChartSpec{axis = Core.Nothing, chartType = Core.Nothing,
                   compareMode = Core.Nothing, domains = Core.Nothing,
                   headerCount = Core.Nothing, interpolateNulls = Core.Nothing,
                   legendPosition = Core.Nothing, lineSmoothing = Core.Nothing,
                   series = Core.Nothing, stackedType = Core.Nothing,
                   threeDimensional = Core.Nothing, totalDataLabel = Core.Nothing}
instance Core.FromJSON BasicChartSpec where
        parseJSON
          = Core.withObject "BasicChartSpec"
              (\ o ->
                 BasicChartSpec Core.<$>
                   (o Core..:? "axis") Core.<*> (o Core..:? "chartType") Core.<*>
                     (o Core..:? "compareMode")
                     Core.<*> (o Core..:? "domains")
...
newBasicFilter 
    ::  BasicFilter
newBasicFilter
  = BasicFilter{criteria = Core.Nothing, filterSpecs = Core.Nothing,
                range = Core.Nothing, sortSpecs = Core.Nothing,
...
instance Core.FromJSON BasicFilter where
        parseJSON
          = Core.withObject "BasicFilter"
              (\ o ->
                 BasicFilter Core.<$>
                   (o Core..:? "criteria") Core.<*> (o Core..:? "filterSpecs")
                     Core.<*> (o Core..:? "range")
...
newBasicSeriesDataPointStyleOverride 
    :: 
                                     BasicSeriesDataPointStyleOverride
newBasicSeriesDataPointStyleOverride
  = BasicSeriesDataPointStyleOverride{color = Core.Nothing,
                                      colorStyle = Core.Nothing, index = Core.Nothing,
...
instance Core.FromJSON BatchClearValuesByDataFilterRequest where
        parseJSON
          = Core.withObject "BatchClearValuesByDataFilterRequest"
              (\ o ->
...
data BatchClearValuesByDataFilterResponse = BatchClearValuesByDataFilterResponse
    {
      -- | The ranges that were cleared, in <https://developers.google.com/workspace/sheets/api/guides/concepts#cell A1 notation>. If the requests are for an unbounded range or a ranger larger than the bounds of the sheet, this is the actual ranges that were cleared, bounded to the sheet\'s limits.
...
newBatchClearValuesByDataFilterResponse 
    :: 
                                        BatchClearValuesByDataFilterResponse
newBatchClearValuesByDataFilterResponse
  = BatchClearValuesByDataFilterResponse{clearedRanges =
                                           Core.Nothing,
                                         spreadsheetId = Core.Nothing}
instance Core.FromJSON BatchClearValuesByDataFilterResponse where
        parseJSON
          = Core.withObject "BatchClearValuesByDataFilterResponse"
              (\ o ->
                 BatchClearValuesByDataFilterResponse Core.<$>
                   (o Core..:? "clearedRanges") Core.<*> (o Core..:? "spreadsheetId"))
...
newtype BatchClearValuesRequest = BatchClearValuesRequest
    {
      -- | The ranges to clear, in <https://developers.google.com/workspace/sheets/api/guides/concepts#cell A1 notation or R1C1 notation>.
...
newBatchClearValuesResponse 
    ::  BatchClearValuesResponse
newBatchClearValuesResponse
  = BatchClearValuesResponse{clearedRanges = Core.Nothing,
                             spreadsheetId = Core.Nothing}
...
newBatchGetValuesByDataFilterRequest 
    :: 
                                     BatchGetValuesByDataFilterRequest
newBatchGetValuesByDataFilterRequest
  = BatchGetValuesByDataFilterRequest{dataFilters = Core.Nothing,
...
newBatchGetValuesByDataFilterResponse 
    :: 
                                      BatchGetValuesByDataFilterResponse
newBatchGetValuesByDataFilterResponse
  = BatchGetValuesByDataFilterResponse{spreadsheetId = Core.Nothing,
                                       valueRanges = Core.Nothing}
instance Core.FromJSON BatchGetValuesByDataFilterResponse where
        parseJSON
          = Core.withObject "BatchGetValuesByDataFilterResponse"
              (\ o ->
                 BatchGetValuesByDataFilterResponse Core.<$>
                   (o Core..:? "spreadsheetId") Core.<*> (o Core..:? "valueRanges"))
...
newBatchGetValuesResponse 
    ::  BatchGetValuesResponse
newBatchGetValuesResponse
  = BatchGetValuesResponse{spreadsheetId = Core.Nothing,
                           valueRanges = Core.Nothing}
...
newBatchUpdateSpreadsheetRequest 
    ::  BatchUpdateSpreadsheetRequest
newBatchUpdateSpreadsheetRequest
  = BatchUpdateSpreadsheetRequest{includeSpreadsheetInResponse =
                                    Core.Nothing,
                                  requests = Core.Nothing, responseIncludeGridData = Core.Nothing,
...
newBatchUpdateSpreadsheetResponse 
    ::  BatchUpdateSpreadsheetResponse
newBatchUpdateSpreadsheetResponse
  = BatchUpdateSpreadsheetResponse{replies = Core.Nothing,
                                   spreadsheetId = Core.Nothing, updatedSpreadsheet = Core.Nothing}
          ...
          = Core.withObject "BatchUpdateSpreadsheetResponse"
              (\ o ->
                 BatchUpdateSpreadsheetResponse Core.<$>
                   (o Core..:? "replies") Core.<*> (o Core..:? "spreadsheetId")
...
newBatchUpdateValuesByDataFilterRequest 
    :: 
                                        BatchUpdateValuesByDataFilterRequest
newBatchUpdateValuesByDataFilterRequest
  = BatchUpdateValuesByDataFilterRequest{data' = Core.Nothing,
...
instance Core.FromJSON BatchUpdateValuesByDataFilterRequest where
        parseJSON
          = Core.withObject "BatchUpdateValuesByDataFilterRequest"
              (\ o ->
                 BatchUpdateValuesByDataFilterRequest Core.<$>
                   (o Core..:? "data") Core.<*> (o Core..:? "includeValuesInResponse")
...
newBatchUpdateValuesByDataFilterResponse 
    :: 
                                         BatchUpdateValuesByDataFilterResponse
newBatchUpdateValuesByDataFilterResponse
  = BatchUpdateValuesByDataFilterResponse{responses = Core.Nothing,
                                          spreadsheetId = Core.Nothing,
...
instance Core.FromJSON BatchUpdateValuesByDataFilterResponse where
        parseJSON
          = Core.withObject "BatchUpdateValuesByDataFilterResponse"
              (\ o ->
                 BatchUpdateValuesByDataFilterResponse Core.<$>
                   (o Core..:? "responses") Core.<*> (o Core..:? "spreadsheetId")
...
newBatchUpdateValuesRequest 
    ::  BatchUpdateValuesRequest
newBatchUpdateValuesRequest
  = BatchUpdateValuesRequest{data' = Core.Nothing,
                             includeValuesInResponse = Core.Nothing,
                             responseDateTimeRenderOption = Core.Nothing,
                             responseValueRenderOption = Core.Nothing,
                             valueInputOption = Core.Nothing}
...
newBatchUpdateValuesResponse 
    ::  BatchUpdateValuesResponse
newBatchUpdateValuesResponse
  = BatchUpdateValuesResponse{responses = Core.Nothing,
                              spreadsheetId = Core.Nothing, totalUpdatedCells = Core.Nothing,
                              totalUpdatedColumns = Core.Nothing,
                              totalUpdatedRows = Core.Nothing, totalUpdatedSheets = Core.Nothing}
...
newBigQueryDataSourceSpec 
    ::  BigQueryDataSourceSpec
newBigQueryDataSourceSpec
  = BigQueryDataSourceSpec{projectId = Core.Nothing,
                           querySpec = Core.Nothing, tableSpec = Core.Nothing}
instance Core.FromJSON BigQueryDataSourceSpec where
        parseJSON
          = Core.withObject "BigQueryDataSourceSpec"
              (\ o ->
                 BigQueryDataSourceSpec Core.<$>
                   (o Core..:? "projectId") Core.<*> (o Core..:? "querySpec") Core.<*>
                     (o Core..:? "tableSpec"))
...
newBigQueryTableSpec 
    ::  BigQueryTableSpec
newBigQueryTableSpec
  = BigQueryTableSpec{datasetId = Core.Nothing,
                      tableId = Core.Nothing, tableProjectId = Core.Nothing}
instance Core.FromJSON BigQueryTableSpec where
        parseJSON
          = Core.withObject "BigQueryTableSpec"
              (\ o ->
                 BigQueryTableSpec Core.<$>
                   (o Core..:? "datasetId") Core.<*> (o Core..:? "tableId") Core.<*>
                     (o Core..:? "tableProjectId"))
...
instance Core.FromJSON BooleanRule where
        parseJSON
          = Core.withObject "BooleanRule"
              (\ o ->
                 BooleanRule Core.<$>
                   (o Core..:? "condition") Core.<*> (o Core..:? "format"))
...
newBorder 
    ::  Border
newBorder
  = Border{color = Core.Nothing, colorStyle = Core.Nothing,
           style = Core.Nothing, width = Core.Nothing}
...
newBorders 
    ::  Borders
newBorders
  = Borders{bottom = Core.Nothing, left = Core.Nothing,
            right = Core.Nothing, top = Core.Nothing}
...
newBubbleChartSpec 
    ::  BubbleChartSpec
newBubbleChartSpec
  = BubbleChartSpec{bubbleBorderColor = Core.Nothing,
                    bubbleBorderColorStyle = Core.Nothing, bubbleLabels = Core.Nothing,
                    bubbleMaxRadiusSize = Core.Nothing,
                    bubbleMinRadiusSize = Core.Nothing, bubbleOpacity = Core.Nothing,
                    bubbleSizes = Core.Nothing, bubbleTextStyle = Core.Nothing,
                    domain = Core.Nothing, groupIds = Core.Nothing,
                    legendPosition = Core.Nothing, series = Core.Nothing}
...
newCancelDataSourceRefreshRequest 
    ::  CancelDataSourceRefreshRequest
newCancelDataSourceRefreshRequest
  = CancelDataSourceRefreshRequest{dataSourceId = Core.Nothing,
                                   isAll = Core.Nothing, references = Core.Nothing}
instance Core.FromJSON CancelDataSourceRefreshRequest where
        parseJSON
          = Core.withObject "CancelDataSourceRefreshRequest"
              (\ o ->
                 CancelDataSourceRefreshRequest Core.<$>
                   (o Core..:? "dataSourceId") Core.<*> (o Core..:? "isAll") Core.<*>
                     (o Core..:? "references"))
...
instance Core.FromJSON CancelDataSourceRefreshResponse where
        parseJSON
          = Core.withObject "CancelDataSourceRefreshResponse"
              (\ o ->
...
newCancelDataSourceRefreshStatus 
    ::  CancelDataSourceRefreshStatus
newCancelDataSourceRefreshStatus
  = CancelDataSourceRefreshStatus{reference = Core.Nothing,
                                  refreshCancellationStatus = Core.Nothing}
instance Core.FromJSON CancelDataSourceRefreshStatus where
        parseJSON
          = Core.withObject "CancelDataSourceRefreshStatus"
              (\ o ->
                 CancelDataSourceRefreshStatus Core.<$>
                   (o Core..:? "reference") Core.<*>
                     (o Core..:? "refreshCancellationStatus"))
          ...
          = Core.object
              (Core.catMaybes
                 [("reference" Core..=) Core.<$> reference,
                  ("refreshCancellationStatus" Core..=) Core.<$>
                    refreshCancellationStatus])
...
newCandlestickData 
    ::  CandlestickData
newCandlestickData
  = CandlestickData{closeSeries = Core.Nothing,
                    highSeries = Core.Nothing, lowSeries = Core.Nothing,
          ...
          = Core.withObject "CandlestickData"
              (\ o ->
                 CandlestickData Core.<$>
                   (o Core..:? "closeSeries") Core.<*> (o Core..:? "highSeries")
...
newCellData 
    ::  CellData
newCellData
  = CellData{chipRuns = Core.Nothing,
             dataSourceFormula = Core.Nothing, dataSourceTable = Core.Nothing,
             dataValidation = Core.Nothing, effectiveFormat = Core.Nothing,
             effectiveValue = Core.Nothing, formattedValue = Core.Nothing,
             hyperlink = Core.Nothing, note = Core.Nothing,
             pivotTable = Core.Nothing, textFormatRuns = Core.Nothing,
             userEnteredFormat = Core.Nothing, userEnteredValue = Core.Nothing}
instance Core.FromJSON CellData where
        parseJSON
          = Core.withObject "CellData"
              (\ o ->
                 CellData Core.<$>
                   (o Core..:? "chipRuns") Core.<*> (o Core..:? "dataSourceFormula")
...
newCellFormat 
    ::  CellFormat
newCellFormat
  = CellFormat{backgroundColor = Core.Nothing,
               backgroundColorStyle = Core.Nothing, borders = Core.Nothing,
               horizontalAlignment = Core.Nothing,
               hyperlinkDisplayType = Core.Nothing, numberFormat = Core.Nothing,
               padding = Core.Nothing, textDirection = Core.Nothing,
               textFormat = Core.Nothing, textRotation = Core.Nothing,
               verticalAlignment = Core.Nothing, wrapStrategy = Core.Nothing}
...
newChartAxisViewWindowOptions 
    ::  ChartAxisViewWindowOptions
newChartAxisViewWindowOptions
  = ChartAxisViewWindowOptions{viewWindowMax = Core.Nothing,
                               viewWindowMin = Core.Nothing, viewWindowMode = Core.Nothing}
          ...
          = Core.withObject "ChartAxisViewWindowOptions"
              (\ o ->
                 ChartAxisViewWindowOptions Core.<$>
                   (o Core..:? "viewWindowMax") Core.<*> (o Core..:? "viewWindowMin")
...
newChartCustomNumberFormatOptions 
    ::  ChartCustomNumberFormatOptions
newChartCustomNumberFormatOptions
  = ChartCustomNumberFormatOptions{prefix = Core.Nothing,
                                   suffix = Core.Nothing}
...
newChartData 
    ::  ChartData
newChartData
  = ChartData{aggregateType = Core.Nothing,
              columnReference = Core.Nothing, groupRule = Core.Nothing,
...
newChartGroupRule 
    ::  ChartGroupRule
newChartGroupRule
  = ChartGroupRule{dateTimeRule = Core.Nothing,
...
instance Core.FromJSON ChartGroupRule where
        parseJSON
          = Core.withObject "ChartGroupRule"
              (\ o ->
                 ChartGroupRule Core.<$>
                   (o Core..:? "dateTimeRule") Core.<*> (o Core..:? "histogramRule"))
...
newChartHistogramRule 
    ::  ChartHistogramRule
newChartHistogramRule
  = ChartHistogramRule{intervalSize = Core.Nothing,
          ...
          = Core.withObject "ChartHistogramRule"
              (\ o ->
                 ChartHistogramRule Core.<$>
                   (o Core..:? "intervalSize") Core.<*> (o Core..:? "maxValue")
...
newChartSpec 
    ::  ChartSpec
newChartSpec
  = ChartSpec{altText = Core.Nothing, backgroundColor = Core.Nothing,
              backgroundColorStyle = Core.Nothing, basicChart = Core.Nothing,
              bubbleChart = Core.Nothing, candlestickChart = Core.Nothing,
              dataSourceChartProperties = Core.Nothing,
              filterSpecs = Core.Nothing, fontName = Core.Nothing,
              hiddenDimensionStrategy = Core.Nothing,
              histogramChart = Core.Nothing, maximized = Core.Nothing,
              orgChart = Core.Nothing, pieChart = Core.Nothing,
              scorecardChart = Core.Nothing, sortSpecs = Core.Nothing,
              subtitle = Core.Nothing, subtitleTextFormat = Core.Nothing,
              subtitleTextPosition = Core.Nothing, title = Core.Nothing,
              titleTextFormat = Core.Nothing, titleTextPosition = Core.Nothing,
              treemapChart = Core.Nothing, waterfallChart = Core.Nothing}
instance Core.FromJSON ChartSpec where
        parseJSON
          = Core.withObject "ChartSpec"
              (\ o ->
                 ChartSpec Core.<$>
                   (o Core..:? "altText") Core.<*> (o Core..:? "backgroundColor")
...
-- | Creates a value of 'Chip' with the minimum fields required to make a request.
newChip 
    ::  Chip
newChip
  = Chip{personProperties = Core.Nothing,
         richLinkProperties = Core.Nothing}
instance Core.FromJSON Chip where
        parseJSON
          = Core.withObject "Chip"
              (\ o ->
                 Chip Core.<$>
                   (o Core..:? "personProperties") Core.<*>
                     (o Core..:? "richLinkProperties"))

instance Core.ToJSON Chip where
        toJSON Chip{..}
          = Core.object
              (Core.catMaybes
...
--
-- /See:/ 'newChipRun' smart constructor.
data ChipRun = ChipRun
    {
      -- | Optional. The chip of this run.
      chip :: (Core.Maybe Chip)
      -- | Required. The zero-based character index where this run starts, in UTF-16 code units.
    , startIndex :: (Core.Maybe Core.Int32)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'ChipRun' with the minimum fields required to make a request.
newChipRun 
    ::  ChipRun
newChipRun
  = ChipRun{chip = Core.Nothing, startIndex = Core.Nothing}
instance Core.FromJSON ChipRun where
        parseJSON
          = Core.withObject "ChipRun"
              (\ o ->
                 ChipRun Core.<$>
                   (o Core..:? "chip") Core.<*> (o Core..:? "startIndex"))

instance Core.ToJSON ChipRun where
        toJSON ChipRun{..}
          = Core.object
              (Core.catMaybes
                 [("chip" Core..=) Core.<$> chip,
...
newClearValuesResponse 
    ::  ClearValuesResponse
newClearValuesResponse
  = ClearValuesResponse{clearedRange = Core.Nothing,
                        spreadsheetId = Core.Nothing}
          ...
          = Core.withObject "ClearValuesResponse"
              (\ o ->
                 ClearValuesResponse Core.<$>
                   (o Core..:? "clearedRange") Core.<*> (o Core..:? "spreadsheetId"))
...
data ColorStyle = ColorStyle
    {
      -- | RGB color. The <https://developers.google.com/workspace/sheets/api/reference/rest/v4/spreadsheets/other#Color.FIELDS.alpha alpha> value in the <https://developers.google.com/workspace/sheets/api/reference/rest/v4/spreadsheets/other#color Color> object isn\'t generally supported.
...
instance Core.FromJSON ColorStyle where
        parseJSON
          = Core.withObject "ColorStyle"
              (\ o ->
                 ColorStyle Core.<$>
                   (o Core..:? "rgbColor") Core.<*> (o Core..:? "themeColor"))
...
newConditionValue 
    ::  ConditionValue
newConditionValue
  = ConditionValue{relativeDate = Core.Nothing,
...
newConditionalFormatRule 
    ::  ConditionalFormatRule
newConditionalFormatRule
  = ConditionalFormatRule{booleanRule = Core.Nothing,
                          gradientRule = Core.Nothing, ranges = Core.Nothing}
instance Core.FromJSON ConditionalFormatRule where
        parseJSON
          = Core.withObject "ConditionalFormatRule"
              (\ o ->
                 ConditionalFormatRule Core.<$>
                   (o Core..:? "booleanRule") Core.<*> (o Core..:? "gradientRule")
                     Core.<*> (o Core..:? "ranges"))
...
newCopyPasteRequest 
    ::  CopyPasteRequest
newCopyPasteRequest
  = CopyPasteRequest{destination = Core.Nothing,
                     pasteOrientation = Core.Nothing, pasteType = Core.Nothing,
                     source = Core.Nothing}
          ...
          = Core.withObject "CopyPasteRequest"
              (\ o ->
                 CopyPasteRequest Core.<$>
                   (o Core..:? "destination") Core.<*> (o Core..:? "pasteOrientation")
...
newCopySheetToAnotherSpreadsheetRequest 
    :: 
                                        CopySheetToAnotherSpreadsheetRequest
newCopySheetToAnotherSpreadsheetRequest
  = CopySheetToAnotherSpreadsheetRequest{destinationSpreadsheetId =
                                           Core.Nothing}
instance Core.FromJSON CopySheetToAnotherSpreadsheetRequest where
        parseJSON
          = Core.withObject "CopySheetToAnotherSpreadsheetRequest"
              (\ o ->
...
newCutPasteRequest 
    ::  CutPasteRequest
newCutPasteRequest
  = CutPasteRequest{destination = Core.Nothing,
                    pasteType = Core.Nothing, source = Core.Nothing}
instance Core.FromJSON CutPasteRequest where
        parseJSON
          = Core.withObject "CutPasteRequest"
              (\ o ->
                 CutPasteRequest Core.<$>
                   (o Core..:? "destination") Core.<*> (o Core..:? "pasteType")
                     Core.<*> (o Core..:? "source"))
...
newDataExecutionStatus 
    ::  DataExecutionStatus
newDataExecutionStatus
  = DataExecutionStatus{errorCode = Core.Nothing,
                        errorMessage = Core.Nothing, lastRefreshTime = Core.Nothing,
                        state = Core.Nothing}
...
newDataFilter 
    ::  DataFilter
newDataFilter
  = DataFilter{a1Range = Core.Nothing,
               developerMetadataLookup = Core.Nothing, gridRange = Core.Nothing}
...
newDataFilterValueRange 
    ::  DataFilterValueRange
newDataFilterValueRange
  = DataFilterValueRange{dataFilter = Core.Nothing,
                         majorDimension = Core.Nothing, values = Core.Nothing}
instance Core.FromJSON DataFilterValueRange where
        parseJSON
          = Core.withObject "DataFilterValueRange"
              (\ o ->
                 DataFilterValueRange Core.<$>
                   (o Core..:? "dataFilter") Core.<*> (o Core..:? "majorDimension")
                     Core.<*> (o Core..:? "values"))
...
newDataLabel 
    ::  DataLabel
newDataLabel
  = DataLabel{customLabelData = Core.Nothing,
              placement = Core.Nothing, textFormat = Core.Nothing,
              type' = Core.Nothing}
instance Core.FromJSON DataLabel where
        parseJSON
          = Core.withObject "DataLabel"
              (\ o ->
                 DataLabel Core.<$>
                   (o Core..:? "customLabelData") Core.<*> (o Core..:? "placement")
                     Core.<*> (o Core..:? "textFormat")
                     Core.<*> (o Core..:? "type"))
...
newDataSource 
    ::  DataSource
newDataSource
  = DataSource{calculatedColumns = Core.Nothing,
               dataSourceId = Core.Nothing, sheetId = Core.Nothing,
               spec = Core.Nothing}
...
newDataSourceChartProperties 
    ::  DataSourceChartProperties
newDataSourceChartProperties
  = DataSourceChartProperties{dataExecutionStatus = Core.Nothing,
...
newDataSourceColumn 
    ::  DataSourceColumn
newDataSourceColumn
  = DataSourceColumn{formula = Core.Nothing,
          ...
          = Core.withObject "DataSourceColumn"
              (\ o ->
                 DataSourceColumn Core.<$>
                   (o Core..:? "formula") Core.<*> (o Core..:? "reference"))
...
newDataSourceFormula 
    ::  DataSourceFormula
newDataSourceFormula
  = DataSourceFormula{dataExecutionStatus = Core.Nothing,
                      dataSourceId = Core.Nothing}
...
newDataSourceObjectReference 
    ::  DataSourceObjectReference
newDataSourceObjectReference
  = DataSourceObjectReference{chartId = Core.Nothing,
                              dataSourceFormulaCell = Core.Nothing,
                              dataSourcePivotTableAnchorCell = Core.Nothing,
                              dataSourceTableAnchorCell = Core.Nothing, sheetId = Core.Nothing}
...
newDataSourceParameter 
    ::  DataSourceParameter
newDataSourceParameter
  = DataSourceParameter{name = Core.Nothing,
                        namedRangeId = Core.Nothing, range = Core.Nothing}
...
newDataSourceRefreshMonthlySchedule 
    :: 
                                    DataSourceRefreshMonthlySchedule
newDataSourceRefreshMonthlySchedule
  = DataSourceRefreshMonthlySchedule{daysOfMonth = Core.Nothing,
          ...
          = Core.withObject "DataSourceRefreshMonthlySchedule"
              (\ o ->
                 DataSourceRefreshMonthlySchedule Core.<$>
                   (o Core..:? "daysOfMonth") Core.<*> (o Core..:? "startTime"))
...
newDataSourceRefreshSchedule 
    ::  DataSourceRefreshSchedule
newDataSourceRefreshSchedule
  = DataSourceRefreshSchedule{dailySchedule = Core.Nothing,
                              enabled = Core.Nothing, monthlySchedule = Core.Nothing,
                              nextRun = Core.Nothing, refreshScope = Core.Nothing,
          ...
          = Core.withObject "DataSourceRefreshSchedule"
              (\ o ->
                 DataSourceRefreshSchedule Core.<$>
                   (o Core..:? "dailySchedule") Core.<*> (o Core..:? "enabled")
...
newDataSourceRefreshWeeklySchedule 
    :: 
                                   DataSourceRefreshWeeklySchedule
newDataSourceRefreshWeeklySchedule
  = DataSourceRefreshWeeklySchedule{daysOfWeek = Core.Nothing,
                                    startTime = Core.Nothing}
          ...
          = Core.withObject "DataSourceRefreshWeeklySchedule"
              (\ o ->
                 DataSourceRefreshWeeklySchedule Core.<$>
                   (o Core..:? "daysOfWeek") Core.<*> (o Core..:? "startTime"))
...
newDataSourceSheetDimensionRange 
    ::  DataSourceSheetDimensionRange
newDataSourceSheetDimensionRange
  = DataSourceSheetDimensionRange{columnReferences = Core.Nothing,
          ...
          = Core.withObject "DataSourceSheetDimensionRange"
              (\ o ->
                 DataSourceSheetDimensionRange Core.<$>
                   (o Core..:? "columnReferences") Core.<*> (o Core..:? "sheetId"))
...
newDataSourceSheetProperties 
    ::  DataSourceSheetProperties
newDataSourceSheetProperties
  = DataSourceSheetProperties{columns = Core.Nothing,
          ...
          = Core.withObject "DataSourceSheetProperties"
              (\ o ->
                 DataSourceSheetProperties Core.<$>
                   (o Core..:? "columns") Core.<*> (o Core..:? "dataExecutionStatus")
...
newDataSourceSpec 
    ::  DataSourceSpec
newDataSourceSpec
  = DataSourceSpec{bigQuery = Core.Nothing, looker = Core.Nothing,
...
instance Core.FromJSON DataSourceSpec where
        parseJSON
          = Core.withObject "DataSourceSpec"
              (\ o ->
                 DataSourceSpec Core.<$>
                   (o Core..:? "bigQuery") Core.<*> (o Core..:? "looker") Core.<*>
                     (o Core..:? "parameters"))
...
newDataSourceTable 
    ::  DataSourceTable
newDataSourceTable
  = DataSourceTable{columnSelectionType = Core.Nothing,
                    columns = Core.Nothing, dataExecutionStatus = Core.Nothing,
                    dataSourceId = Core.Nothing, filterSpecs = Core.Nothing,
                    rowLimit = Core.Nothing, sortSpecs = Core.Nothing}
instance Core.FromJSON DataSourceTable where
        parseJSON
          = Core.withObject "DataSourceTable"
              (\ o ->
                 DataSourceTable Core.<$>
                   (o Core..:? "columnSelectionType") Core.<*> (o Core..:? "columns")
...
newDataValidationRule 
    ::  DataValidationRule
newDataValidationRule
  = DataValidationRule{condition = Core.Nothing,
                       inputMessage = Core.Nothing, showCustomUi = Core.Nothing,
                       strict = Core.Nothing}
          ...
          = Core.withObject "DataValidationRule"
              (\ o ->
                 DataValidationRule Core.<$>
                   (o Core..:? "condition") Core.<*> (o Core..:? "inputMessage")
...
newDeleteConditionalFormatRuleRequest 
    :: 
                                      DeleteConditionalFormatRuleRequest
newDeleteConditionalFormatRuleRequest
  = DeleteConditionalFormatRuleRequest{index = Core.Nothing,
                                       sheetId = Core.Nothing}
instance Core.FromJSON DeleteConditionalFormatRuleRequest where
        parseJSON
          = Core.withObject "DeleteConditionalFormatRuleRequest"
              (\ o ->
...
instance Core.FromJSON DeleteConditionalFormatRuleResponse where
        parseJSON
          = Core.withObject "DeleteConditionalFormatRuleResponse"
              (\ o ->
...
newDeleteDeveloperMetadataResponse 
    :: 
                                   DeleteDeveloperMetadataResponse
newDeleteDeveloperMetadataResponse
  = DeleteDeveloperMetadataResponse{deletedDeveloperMetadata =
                                      Core.Nothing}
...
newDeleteDuplicatesRequest 
    ::  DeleteDuplicatesRequest
newDeleteDuplicatesRequest
  = DeleteDuplicatesRequest{comparisonColumns = Core.Nothing,
                            range = Core.Nothing}
          ...
          = Core.withObject "DeleteDuplicatesRequest"
              (\ o ->
                 DeleteDuplicatesRequest Core.<$>
                   (o Core..:? "comparisonColumns") Core.<*> (o Core..:? "range"))
...
newDeleteRangeRequest 
    ::  DeleteRangeRequest
newDeleteRangeRequest
  = DeleteRangeRequest{range = Core.Nothing,
          ...
          = Core.withObject "DeleteRangeRequest"
              (\ o ->
                 DeleteRangeRequest Core.<$>
                   (o Core..:? "range") Core.<*> (o Core..:? "shiftDimension"))
...
--
-- /See:/ 'newDeleteTableRequest' smart constructor.
...
-- | Creates a value of 'DeleteTableRequest' with the minimum fields required to make a request.
newDeleteTableRequest 
    ::  DeleteTableRequest
newDeleteTableRequest = DeleteTableRequest{tableId = Core.Nothing}
instance Core.FromJSON DeleteTableRequest where
        parseJSON
          = Core.withObject "DeleteTableRequest"
              (\ o -> DeleteTableRequest Core.<$> (o Core..:? "tableId"))

instance Core.ToJSON DeleteTableRequest where
        toJSON DeleteTableRequest{..}
          = Core.object
              (Core.catMaybes [("tableId" Core..=) Core.<$> tableId])
...
newDeveloperMetadata 
    ::  DeveloperMetadata
newDeveloperMetadata
  = DeveloperMetadata{location = Core.Nothing,
                      metadataId = Core.Nothing, metadataKey = Core.Nothing,
                      metadataValue = Core.Nothing, visibility = Core.Nothing}
instance Core.FromJSON DeveloperMetadata where
        parseJSON
          = Core.withObject "DeveloperMetadata"
              (\ o ->
                 DeveloperMetadata Core.<$>
                   (o Core..:? "location") Core.<*> (o Core..:? "metadataId") Core.<*>
                     (o Core..:? "metadataKey")
...
newDeveloperMetadataLocation 
    ::  DeveloperMetadataLocation
newDeveloperMetadataLocation
  = DeveloperMetadataLocation{dimensionRange = Core.Nothing,
                              locationType = Core.Nothing, sheetId = Core.Nothing,
          ...
          = Core.withObject "DeveloperMetadataLocation"
              (\ o ->
                 DeveloperMetadataLocation Core.<$>
                   (o Core..:? "dimensionRange") Core.<*> (o Core..:? "locationType")
                     Core.<*> (o Core..:? "sheetId")
...
newDeveloperMetadataLookup 
    ::  DeveloperMetadataLookup
newDeveloperMetadataLookup
  = DeveloperMetadataLookup{locationMatchingStrategy = Core.Nothing,
                            locationType = Core.Nothing, metadataId = Core.Nothing,
                            metadataKey = Core.Nothing, metadataLocation = Core.Nothing,
                            metadataValue = Core.Nothing, visibility = Core.Nothing}
...
newDimensionGroup 
    ::  DimensionGroup
newDimensionGroup
  = DimensionGroup{collapsed = Core.Nothing, depth = Core.Nothing,
                   range = Core.Nothing}
instance Core.FromJSON DimensionGroup where
        parseJSON
          = Core.withObject "DimensionGroup"
              (\ o ->
                 DimensionGroup Core.<$>
                   (o Core..:? "collapsed") Core.<*> (o Core..:? "depth") Core.<*>
                     (o Core..:? "range"))
...
newDimensionProperties 
    ::  DimensionProperties
newDimensionProperties
  = DimensionProperties{dataSourceColumnReference = Core.Nothing,
                        developerMetadata = Core.Nothing, hiddenByFilter = Core.Nothing,
                        hiddenByUser = Core.Nothing, pixelSize = Core.Nothing}
...
newDimensionRange 
    ::  DimensionRange
newDimensionRange
  = DimensionRange{dimension = Core.Nothing, endIndex = Core.Nothing,
                   sheetId = Core.Nothing, startIndex = Core.Nothing}
instance Core.FromJSON DimensionRange where
        parseJSON
          = Core.withObject "DimensionRange"
              (\ o ->
                 DimensionRange Core.<$>
                   (o Core..:? "dimension") Core.<*> (o Core..:? "endIndex") Core.<*>
                     (o Core..:? "sheetId")
...
newDuplicateSheetRequest 
    ::  DuplicateSheetRequest
newDuplicateSheetRequest
  = DuplicateSheetRequest{insertSheetIndex = Core.Nothing,
                          newSheetId' = Core.Nothing, newSheetName' = Core.Nothing,
          ...
          = Core.withObject "DuplicateSheetRequest"
              (\ o ->
                 DuplicateSheetRequest Core.<$>
                   (o Core..:? "insertSheetIndex") Core.<*> (o Core..:? "newSheetId")
...
newEditors 
    ::  Editors
newEditors
  = Editors{domainUsersCanEdit = Core.Nothing, groups = Core.Nothing,
            users = Core.Nothing}
instance Core.FromJSON Editors where
        parseJSON
          = Core.withObject "Editors"
              (\ o ->
                 Editors Core.<$>
                   (o Core..:? "domainUsersCanEdit") Core.<*> (o Core..:? "groups")
                     Core.<*> (o Core..:? "users"))
...
newEmbeddedChart 
    ::  EmbeddedChart
newEmbeddedChart
  = EmbeddedChart{border = Core.Nothing, chartId = Core.Nothing,
                  position = Core.Nothing, spec = Core.Nothing}
instance Core.FromJSON EmbeddedChart where
        parseJSON
          = Core.withObject "EmbeddedChart"
              (\ o ->
                 EmbeddedChart Core.<$>
                   (o Core..:? "border") Core.<*> (o Core..:? "chartId") Core.<*>
                     (o Core..:? "position")
                     Core.<*> (o Core..:? "spec"))
          ...
          = Core.withObject "EmbeddedObjectBorder"
              (\ o ->
                 EmbeddedObjectBorder Core.<$>
                   (o Core..:? "color") Core.<*> (o Core..:? "colorStyle"))
...
newEmbeddedObjectPosition 
    ::  EmbeddedObjectPosition
newEmbeddedObjectPosition
  = EmbeddedObjectPosition{newSheet' = Core.Nothing,
                           overlayPosition = Core.Nothing, sheetId = Core.Nothing}
instance Core.FromJSON EmbeddedObjectPosition where
        parseJSON
          = Core.withObject "EmbeddedObjectPosition"
              (\ o ->
                 EmbeddedObjectPosition Core.<$>
                   (o Core..:? "newSheet") Core.<*> (o Core..:? "overlayPosition")
                     Core.<*> (o Core..:? "sheetId"))
...
newExtendedValue 
    ::  ExtendedValue
newExtendedValue
  = ExtendedValue{boolValue = Core.Nothing,
                  errorValue = Core.Nothing, formulaValue = Core.Nothing,
...
instance Core.FromJSON ExtendedValue where
        parseJSON
          = Core.withObject "ExtendedValue"
              (\ o ->
                 ExtendedValue Core.<$>
                   (o Core..:? "boolValue") Core.<*> (o Core..:? "errorValue")
...
newFilterCriteria 
    ::  FilterCriteria
newFilterCriteria
  = FilterCriteria{condition = Core.Nothing,
                   hiddenValues = Core.Nothing, visibleBackgroundColor = Core.Nothing,
...
instance Core.FromJSON FilterCriteria where
        parseJSON
          = Core.withObject "FilterCriteria"
              (\ o ->
                 FilterCriteria Core.<$>
                   (o Core..:? "condition") Core.<*> (o Core..:? "hiddenValues")
...
newFilterSpec 
    ::  FilterSpec
newFilterSpec
  = FilterSpec{columnIndex = Core.Nothing,
...
data FilterView = FilterView
    ...
    , filterViewId :: (Core.Maybe Core.Int32)
      -- | The named range this filter view is backed by, if any. When writing, only one of range or named/range/id or table_id may be set.
    , namedRangeId :: (Core.Maybe Core.Text)
      -- | The range this filter view covers. When writing, only one of range or named/range/id or table_id may be set.
    , range :: (Core.Maybe GridRange)
      -- | The sort order per column. Later specifications are used when values are equal in the earlier specifications.
    , sortSpecs :: (Core.Maybe [SortSpec])
      -- | The table this filter view is backed by, if any. When writing, only one of range or named/range/id or table_id may be set.
    , tableId :: (Core.Maybe Core.Text)
...
newFilterView 
    ::  FilterView
newFilterView
  = FilterView{criteria = Core.Nothing, filterSpecs = Core.Nothing,
               filterViewId = Core.Nothing, namedRangeId = Core.Nothing,
               range = Core.Nothing, sortSpecs = Core.Nothing,
               tableId = Core.Nothing, title = Core.Nothing}
...
newFindReplaceRequest 
    ::  FindReplaceRequest
newFindReplaceRequest
  = FindReplaceRequest{allSheets = Core.Nothing, find = Core.Nothing,
                       includeFormulas = Core.Nothing, matchCase = Core.Nothing,
                       matchEntireCell = Core.Nothing, range = Core.Nothing,
                       replacement = Core.Nothing, searchByRegex = Core.Nothing,
                       sheetId = Core.Nothing}
          ...
          = Core.withObject "FindReplaceRequest"
              (\ o ->
                 FindReplaceRequest Core.<$>
                   (o Core..:? "allSheets") Core.<*> (o Core..:? "find") Core.<*>
                     (o Core..:? "includeFormulas")
...
newFindReplaceResponse 
    ::  FindReplaceResponse
newFindReplaceResponse
  = FindReplaceResponse{formulasChanged = Core.Nothing,
                        occurrencesChanged = Core.Nothing, rowsChanged = Core.Nothing,
                        sheetsChanged = Core.Nothing, valuesChanged = Core.Nothing}
...
data GetSpreadsheetByDataFilterRequest = GetSpreadsheetByDataFilterRequest
    ...
    , excludeTablesInBandedRanges :: (Core.Maybe Core.Bool)
...
newGetSpreadsheetByDataFilterRequest 
    :: 
                                     GetSpreadsheetByDataFilterRequest
newGetSpreadsheetByDataFilterRequest
  = GetSpreadsheetByDataFilterRequest{dataFilters = Core.Nothing,
                                      excludeTablesInBandedRanges = Core.Nothing,
          ...
          = Core.withObject "GetSpreadsheetByDataFilterRequest"
              (\ o ->
                 GetSpreadsheetByDataFilterRequest Core.<$>
                   (o Core..:? "dataFilters") Core.<*>
                     (o Core..:? "excludeTablesInBandedRanges")
...
instance Core.ToJSON GetSpreadsheetByDataFilterRequest where
        toJSON GetSpreadsheetByDataFilterRequest{..}
          = Core.object
              (Core.catMaybes
                 [("dataFilters" Core..=) Core.<$> dataFilters,
                  ("excludeTablesInBandedRanges" Core..=) Core.<$>
...
newGradientRule 
    ::  GradientRule
newGradientRule
  = GradientRule{maxpoint = Core.Nothing, midpoint = Core.Nothing,
...
instance Core.FromJSON GradientRule where
        parseJSON
          = Core.withObject "GradientRule"
              (\ o ->
                 GradientRule Core.<$>
                   (o Core..:? "maxpoint") Core.<*> (o Core..:? "midpoint") Core.<*>
                     (o Core..:? "minpoint"))
...
newGridCoordinate 
    ::  GridCoordinate
newGridCoordinate
  = GridCoordinate{columnIndex = Core.Nothing,
                   rowIndex = Core.Nothing, sheetId = Core.Nothing}
...
newGridData 
    ::  GridData
newGridData
  = GridData{columnMetadata = Core.Nothing, rowData = Core.Nothing,
             rowMetadata = Core.Nothing, startColumn = Core.Nothing,
...
instance Core.FromJSON GridData where
        parseJSON
          = Core.withObject "GridData"
              (\ o ->
                 GridData Core.<$>
                   (o Core..:? "columnMetadata") Core.<*> (o Core..:? "rowData")
...
newGridProperties 
    ::  GridProperties
newGridProperties
  = GridProperties{columnCount = Core.Nothing,
                   columnGroupControlAfter = Core.Nothing,
                   frozenColumnCount = Core.Nothing, frozenRowCount = Core.Nothing,
                   hideGridlines = Core.Nothing, rowCount = Core.Nothing,
...
newGridRange 
    ::  GridRange
newGridRange
  = GridRange{endColumnIndex = Core.Nothing,
              endRowIndex = Core.Nothing, sheetId = Core.Nothing,
              startColumnIndex = Core.Nothing, startRowIndex = Core.Nothing}
instance Core.FromJSON GridRange where
        parseJSON
          = Core.withObject "GridRange"
              (\ o ->
                 GridRange Core.<$>
                   (o Core..:? "endColumnIndex") Core.<*> (o Core..:? "endRowIndex")
                     Core.<*> (o Core..:? "sheetId")
...
newHistogramChartSpec 
    ::  HistogramChartSpec
newHistogramChartSpec
  = HistogramChartSpec{bucketSize = Core.Nothing,
                       legendPosition = Core.Nothing, outlierPercentile = Core.Nothing,
                       series = Core.Nothing, showItemDividers = Core.Nothing}
instance Core.FromJSON HistogramChartSpec where
        parseJSON
          = Core.withObject "HistogramChartSpec"
              (\ o ->
                 HistogramChartSpec Core.<$>
                   (o Core..:? "bucketSize") Core.<*> (o Core..:? "legendPosition")
...
newHistogramRule 
    ::  HistogramRule
newHistogramRule
  = HistogramRule{end = Core.Nothing, interval = Core.Nothing,
                  start = Core.Nothing}
instance Core.FromJSON HistogramRule where
        parseJSON
          = Core.withObject "HistogramRule"
              (\ o ->
                 HistogramRule Core.<$>
                   (o Core..:? "end") Core.<*> (o Core..:? "interval") Core.<*>
                     (o Core..:? "start"))
...
newHistogramSeries 
    ::  HistogramSeries
newHistogramSeries
  = HistogramSeries{barColor = Core.Nothing,
                    barColorStyle = Core.Nothing, data' = Core.Nothing}
instance Core.FromJSON HistogramSeries where
        parseJSON
          = Core.withObject "HistogramSeries"
              (\ o ->
                 HistogramSeries Core.<$>
                   (o Core..:? "barColor") Core.<*> (o Core..:? "barColorStyle")
                     Core.<*> (o Core..:? "data"))
...
newInsertDimensionRequest 
    ::  InsertDimensionRequest
newInsertDimensionRequest
  = InsertDimensionRequest{inheritFromBefore = Core.Nothing,
                           range = Core.Nothing}
          ...
          = Core.withObject "InsertDimensionRequest"
              (\ o ->
                 InsertDimensionRequest Core.<$>
                   (o Core..:? "inheritFromBefore") Core.<*> (o Core..:? "range"))
...
newInsertRangeRequest 
    ::  InsertRangeRequest
newInsertRangeRequest
  = InsertRangeRequest{range = Core.Nothing,
                       shiftDimension = Core.Nothing}
...
newInterpolationPoint 
    ::  InterpolationPoint
newInterpolationPoint
  = InterpolationPoint{color = Core.Nothing,
                       colorStyle = Core.Nothing, type' = Core.Nothing,
                       value = Core.Nothing}
...
newIterativeCalculationSettings 
    ::  IterativeCalculationSettings
newIterativeCalculationSettings
  = IterativeCalculationSettings{convergenceThreshold = Core.Nothing,
...
newKeyValueFormat 
    ::  KeyValueFormat
newKeyValueFormat
  = KeyValueFormat{position = Core.Nothing,
                   textFormat = Core.Nothing}
instance Core.FromJSON KeyValueFormat where
        parseJSON
          = Core.withObject "KeyValueFormat"
              (\ o ->
                 KeyValueFormat Core.<$>
                   (o Core..:? "position") Core.<*> (o Core..:? "textFormat"))
...
newLookerDataSourceSpec 
    ::  LookerDataSourceSpec
newLookerDataSourceSpec
  = LookerDataSourceSpec{explore = Core.Nothing,
                         instanceUri = Core.Nothing, model = Core.Nothing}
instance Core.FromJSON LookerDataSourceSpec where
        parseJSON
          = Core.withObject "LookerDataSourceSpec"
              (\ o ->
                 LookerDataSourceSpec Core.<$>
                   (o Core..:? "explore") Core.<*> (o Core..:? "instanceUri") Core.<*>
                     (o Core..:? "model"))
          ...
          = Core.withObject "ManualRuleGroup"
              (\ o ->
                 ManualRuleGroup Core.<$>
                   (o Core..:? "groupName") Core.<*> (o Core..:? "items"))
...
newMatchedDeveloperMetadata 
    ::  MatchedDeveloperMetadata
newMatchedDeveloperMetadata
  = MatchedDeveloperMetadata{dataFilters = Core.Nothing,
...
newMatchedValueRange 
    ::  MatchedValueRange
newMatchedValueRange
  = MatchedValueRange{dataFilters = Core.Nothing,
          ...
          = Core.withObject "MatchedValueRange"
              (\ o ->
                 MatchedValueRange Core.<$>
                   (o Core..:? "dataFilters") Core.<*> (o Core..:? "valueRange"))
          ...
          = Core.withObject "MergeCellsRequest"
              (\ o ->
                 MergeCellsRequest Core.<$>
                   (o Core..:? "mergeType") Core.<*> (o Core..:? "range"))
...
newMoveDimensionRequest 
    ::  MoveDimensionRequest
newMoveDimensionRequest
  = MoveDimensionRequest{destinationIndex = Core.Nothing,
                         source = Core.Nothing}
          ...
          = Core.withObject "MoveDimensionRequest"
              (\ o ->
                 MoveDimensionRequest Core.<$>
                   (o Core..:? "destinationIndex") Core.<*> (o Core..:? "source"))
...
data NumberFormat = NumberFormat
    {
      -- | Pattern string used for formatting. If not set, a default pattern based on the user\'s locale will be used if necessary for the given type. See the <https://developers.google.com/workspace/sheets/api/guides/formats Date and Number Formats guide> for more information about the supported patterns.
...
newOrgChartSpec 
    ::  OrgChartSpec
newOrgChartSpec
  = OrgChartSpec{labels = Core.Nothing, nodeColor = Core.Nothing,
                 nodeColorStyle = Core.Nothing, nodeSize = Core.Nothing,
                 parentLabels = Core.Nothing, selectedNodeColor = Core.Nothing,
                 selectedNodeColorStyle = Core.Nothing, tooltips = Core.Nothing}
instance Core.FromJSON OrgChartSpec where
        parseJSON
          = Core.withObject "OrgChartSpec"
              (\ o ->
                 OrgChartSpec Core.<$>
                   (o Core..:? "labels") Core.<*> (o Core..:? "nodeColor") Core.<*>
                     (o Core..:? "nodeColorStyle")
...
newOverlayPosition 
    ::  OverlayPosition
newOverlayPosition
  = OverlayPosition{anchorCell = Core.Nothing,
                    heightPixels = Core.Nothing, offsetXPixels = Core.Nothing,
                    offsetYPixels = Core.Nothing, widthPixels = Core.Nothing}
instance Core.FromJSON OverlayPosition where
        parseJSON
          = Core.withObject "OverlayPosition"
              (\ o ->
                 OverlayPosition Core.<$>
                   (o Core..:? "anchorCell") Core.<*> (o Core..:? "heightPixels")
...
newPadding 
    ::  Padding
newPadding
  = Padding{bottom = Core.Nothing, left = Core.Nothing,
            right = Core.Nothing, top = Core.Nothing}
...
newPasteDataRequest 
    ::  PasteDataRequest
newPasteDataRequest
  = PasteDataRequest{coordinate = Core.Nothing, data' = Core.Nothing,
                     delimiter = Core.Nothing, html = Core.Nothing,
                     type' = Core.Nothing}
          ...
          = Core.withObject "PasteDataRequest"
              (\ o ->
                 PasteDataRequest Core.<$>
                   (o Core..:? "coordinate") Core.<*> (o Core..:? "data") Core.<*>
                     (o Core..:? "delimiter")
                     Core.<*> (o Core..:? "html")
                     Core.<*> (o Core..:? "type"))
          ...
          = Core.object
              (Core.catMaybes
                 [("coordinate" Core..=) Core.<$> coordinate,
                  ...
                  ("html" Core..=) Core.<$> html, ("type" Core..=) Core.<$> type'])
...
data PersonProperties = PersonProperties
    {
      ...
      displayFormat :: (Core.Maybe PersonProperties_DisplayFormat)
...
newPersonProperties 
    ::  PersonProperties
newPersonProperties
  = PersonProperties{displayFormat = Core.Nothing,
                     email = Core.Nothing}
          ...
          = Core.withObject "PersonProperties"
              (\ o ->
                 PersonProperties Core.<$>
                   (o Core..:? "displayFormat") Core.<*> (o Core..:? "email"))

instance Core.ToJSON PersonProperties where
        toJSON PersonProperties{..}
          = Core.object
              (Core.catMaybes
                 [("displayFormat" Core..=) Core.<$> displayFormat,
...
newPieChartSpec 
    ::  PieChartSpec
newPieChartSpec
  = PieChartSpec{domain = Core.Nothing,
                 legendPosition = Core.Nothing, pieHole = Core.Nothing,
                 series = Core.Nothing, threeDimensional = Core.Nothing}
instance Core.FromJSON PieChartSpec where
        parseJSON
          = Core.withObject "PieChartSpec"
              (\ o ->
                 PieChartSpec Core.<$>
                   (o Core..:? "domain") Core.<*> (o Core..:? "legendPosition")
                     Core.<*> (o Core..:? "pieHole")
                     Core.<*> (o Core..:? "series")
                     Core.<*> (o Core..:? "threeDimensional"))
...
newPivotFilterCriteria 
    ::  PivotFilterCriteria
newPivotFilterCriteria
  = PivotFilterCriteria{condition = Core.Nothing,
                        visibleByDefault = Core.Nothing, visibleValues = Core.Nothing}
instance Core.FromJSON PivotFilterCriteria where
        parseJSON
          = Core.withObject "PivotFilterCriteria"
              (\ o ->
                 PivotFilterCriteria Core.<$>
                   (o Core..:? "condition") Core.<*> (o Core..:? "visibleByDefault")
...
newPivotFilterSpec 
    ::  PivotFilterSpec
newPivotFilterSpec
  = PivotFilterSpec{columnOffsetIndex = Core.Nothing,
                    dataSourceColumnReference = Core.Nothing,
                    filterCriteria = Core.Nothing}
...
newPivotGroup 
    ::  PivotGroup
newPivotGroup
  = PivotGroup{dataSourceColumnReference = Core.Nothing,
               groupLimit = Core.Nothing, groupRule = Core.Nothing,
               label = Core.Nothing, repeatHeadings = Core.Nothing,
               showTotals = Core.Nothing, sortOrder = Core.Nothing,
               sourceColumnOffset = Core.Nothing, valueBucket = Core.Nothing,
...
newPivotGroupLimit 
    ::  PivotGroupLimit
newPivotGroupLimit
  = PivotGroupLimit{applyOrder = Core.Nothing,
          ...
          = Core.withObject "PivotGroupLimit"
              (\ o ->
                 PivotGroupLimit Core.<$>
                   (o Core..:? "applyOrder") Core.<*> (o Core..:? "countLimit"))
...
newPivotGroupRule 
    ::  PivotGroupRule
newPivotGroupRule
  = PivotGroupRule{dateTimeRule = Core.Nothing,
                   histogramRule = Core.Nothing, manualRule = Core.Nothing}
...
newPivotGroupSortValueBucket 
    ::  PivotGroupSortValueBucket
newPivotGroupSortValueBucket
  = PivotGroupSortValueBucket{buckets = Core.Nothing,
          ...
          = Core.withObject "PivotGroupSortValueBucket"
              (\ o ->
                 PivotGroupSortValueBucket Core.<$>
                   (o Core..:? "buckets") Core.<*> (o Core..:? "valuesIndex"))
...
newPivotGroupValueMetadata 
    ::  PivotGroupValueMetadata
newPivotGroupValueMetadata
  = PivotGroupValueMetadata{collapsed = Core.Nothing,
                            value = Core.Nothing}
          ...
          = Core.withObject "PivotGroupValueMetadata"
              (\ o ->
                 PivotGroupValueMetadata Core.<$>
                   (o Core..:? "collapsed") Core.<*> (o Core..:? "value"))
...
newPivotTable 
    ::  PivotTable
newPivotTable
  = PivotTable{columns = Core.Nothing, criteria = Core.Nothing,
               dataExecutionStatus = Core.Nothing, dataSourceId = Core.Nothing,
               filterSpecs = Core.Nothing, rows = Core.Nothing,
               source = Core.Nothing, valueLayout = Core.Nothing,
               values = Core.Nothing}
instance Core.FromJSON PivotTable where
        parseJSON
          = Core.withObject "PivotTable"
              (\ o ->
                 PivotTable Core.<$>
                   (o Core..:? "columns") Core.<*> (o Core..:? "criteria") Core.<*>
          ...
          = Core.object
              (Core.catMaybes
                 [("columns" Core..=) Core.<$> columns,
                  ...
                  ("dataSourceId" Core..=) Core.<$> dataSourceId,
                  ("filterSpecs" Core..=) Core.<$> filterSpecs,
                  ("rows" Core..=) Core.<$> rows, ("source" Core..=) Core.<$> source,
...
newPivotValue 
    ::  PivotValue
newPivotValue
  = PivotValue{calculatedDisplayType = Core.Nothing,
               dataSourceColumnReference = Core.Nothing, formula = Core.Nothing,
               name = Core.Nothing, sourceColumnOffset = Core.Nothing,
...
data ProtectedRange = ProtectedRange
    ...
    , editors :: (Core.Maybe Editors)
      -- | The named range this protected range is backed by, if any. When writing, only one of range or named/range/id or table_id may be set.
    , namedRangeId :: (Core.Maybe Core.Text)
      -- | The ID of the protected range. This field is read-only.
    , protectedRangeId :: (Core.Maybe Core.Int32)
      -- | The range that is being protected. The range may be fully unbounded, in which case this is considered a protected sheet. When writing, only one of range or named/range/id or table_id may be set.
    , range :: (Core.Maybe GridRange)
      -- | True if the user who requested this protected range can edit the protected area. This field is read-only.
    , requestingUserCanEdit :: (Core.Maybe Core.Bool)
      -- | The table this protected range is backed by, if any. When writing, only one of range or named/range/id or table_id may be set.
    , tableId :: (Core.Maybe Core.Text)
...
newProtectedRange 
    ::  ProtectedRange
newProtectedRange
  = ProtectedRange{description = Core.Nothing,
                   editors = Core.Nothing, namedRangeId = Core.Nothing,
                   protectedRangeId = Core.Nothing, range = Core.Nothing,
                   requestingUserCanEdit = Core.Nothing, tableId = Core.Nothing,
                   unprotectedRanges = Core.Nothing, warningOnly = Core.Nothing}
instance Core.FromJSON ProtectedRange where
        parseJSON
          = Core.withObject "ProtectedRange"
              (\ o ->
                 ProtectedRange Core.<$>
                   (o Core..:? "description") Core.<*> (o Core..:? "editors") Core.<*>
                     (o Core..:? "namedRangeId")
...
newRefreshCancellationStatus 
    ::  RefreshCancellationStatus
newRefreshCancellationStatus
  = RefreshCancellationStatus{errorCode = Core.Nothing,
                              state = Core.Nothing}
instance Core.FromJSON RefreshCancellationStatus where
        parseJSON
          = Core.withObject "RefreshCancellationStatus"
              (\ o ->
                 RefreshCancellationStatus Core.<$>
                   (o Core..:? "errorCode") Core.<*> (o Core..:? "state"))
...
newRefreshDataSourceObjectExecutionStatus 
    :: 
                                          RefreshDataSourceObjectExecutionStatus
newRefreshDataSourceObjectExecutionStatus
  = RefreshDataSourceObjectExecutionStatus{dataExecutionStatus =
                                             Core.Nothing,
                                           reference = Core.Nothing}
instance Core.FromJSON RefreshDataSourceObjectExecutionStatus where
        parseJSON
          = Core.withObject "RefreshDataSourceObjectExecutionStatus"
              (\ o ->
...
newRefreshDataSourceRequest 
    ::  RefreshDataSourceRequest
newRefreshDataSourceRequest
  = RefreshDataSourceRequest{dataSourceId = Core.Nothing,
                             force = Core.Nothing, isAll = Core.Nothing,
          ...
          = Core.withObject "RefreshDataSourceRequest"
              (\ o ->
                 RefreshDataSourceRequest Core.<$>
                   (o Core..:? "dataSourceId") Core.<*> (o Core..:? "force") Core.<*>
                     (o Core..:? "isAll")
...
instance Core.ToJSON RefreshDataSourceRequest where
        toJSON RefreshDataSourceRequest{..}
          = Core.object
              (Core.catMaybes
                 [("dataSourceId" Core..=) Core.<$> dataSourceId,
                  ("force" Core..=) Core.<$> force, ("isAll" Core..=) Core.<$> isAll,
                  ("references" Core..=) Core.<$> references])
...
newRepeatCellRequest 
    ::  RepeatCellRequest
newRepeatCellRequest
  = RepeatCellRequest{cell = Core.Nothing, fields = Core.Nothing,
                      range = Core.Nothing}
          ...
          = Core.withObject "RepeatCellRequest"
              (\ o ->
                 RepeatCellRequest Core.<$>
                   (o Core..:? "cell") Core.<*> (o Core..:? "fields") Core.<*>
                     (o Core..:? "range"))
...
data Request' = Request'
    ...
    , addSlicer :: (Core.Maybe AddSlicerRequest)
      -- | Adds a table.
    , addTable :: (Core.Maybe AddTableRequest)
    ...
    , deleteTable :: (Core.Maybe DeleteTableRequest)
    ...
    , updateSpreadsheetProperties :: (Core.Maybe UpdateSpreadsheetPropertiesRequest)
      -- | Updates a table.
    , updateTable :: (Core.Maybe UpdateTableRequest)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newRequest 
    ::  Request'
newRequest
  = Request'{addBanding = Core.Nothing, addChart = Core.Nothing,
             addConditionalFormatRule = Core.Nothing,
             addDataSource = Core.Nothing, addDimensionGroup = Core.Nothing,
             addFilterView = Core.Nothing, addNamedRange = Core.Nothing,
             addProtectedRange = Core.Nothing, addSheet = Core.Nothing,
             addSlicer = Core.Nothing, addTable = Core.Nothing,
             appendCells = Core.Nothing, appendDimension = Core.Nothing,
             autoFill = Core.Nothing, autoResizeDimensions = Core.Nothing,
             cancelDataSourceRefresh = Core.Nothing,
             clearBasicFilter = Core.Nothing, copyPaste = Core.Nothing,
             createDeveloperMetadata = Core.Nothing, cutPaste = Core.Nothing,
             ...
             deleteFilterView = Core.Nothing, deleteNamedRange = Core.Nothing,
             deleteProtectedRange = Core.Nothing, deleteRange = Core.Nothing,
             deleteSheet = Core.Nothing, deleteTable = Core.Nothing,
             duplicateFilterView = Core.Nothing, duplicateSheet = Core.Nothing,
             findReplace = Core.Nothing, insertDimension = Core.Nothing,
             insertRange = Core.Nothing, mergeCells = Core.Nothing,
             moveDimension = Core.Nothing, pasteData = Core.Nothing,
             randomizeRange = Core.Nothing, refreshDataSource = Core.Nothing,
             repeatCell = Core.Nothing, setBasicFilter = Core.Nothing,
             setDataValidation = Core.Nothing, sortRange = Core.Nothing,
             textToColumns = Core.Nothing, trimWhitespace = Core.Nothing,
             unmergeCells = Core.Nothing, updateBanding = Core.Nothing,
             updateBorders = Core.Nothing, updateCells = Core.Nothing,
             ...
             updateFilterView = Core.Nothing, updateNamedRange = Core.Nothing,
             ...
             updateTable = Core.Nothing}
instance Core.FromJSON Request' where
        parseJSON
          = Core.withObject "Request'"
              (\ o ->
                 Request' Core.<$>
                   (o Core..:? "addBanding") Core.<*> (o Core..:? "addChart") Core.<*>
                     (o Core..:? "addConditionalFormatRule")
          ...
          = Core.object
              (Core.catMaybes
                 [("addBanding" Core..=) Core.<$> addBanding,
                  ...
                  ("cancelDataSourceRefresh" Core..=) Core.<$>
                  ...
                  ("deleteTable" Core..=) Core.<$> deleteTable,
                  ...
                  ("updateTable" Core..=) Core.<$> updateTable])
...
data Response = Response
    ...
    , addTable :: (Core.Maybe AddTableResponse)
...
newResponse 
    ::  Response
newResponse
  = Response{addBanding = Core.Nothing, addChart = Core.Nothing,
             addDataSource = Core.Nothing, addDimensionGroup = Core.Nothing,
             addFilterView = Core.Nothing, addNamedRange = Core.Nothing,
             addProtectedRange = Core.Nothing, addSheet = Core.Nothing,
             addSlicer = Core.Nothing, addTable = Core.Nothing,
             ...
             deleteDuplicates = Core.Nothing,
             duplicateFilterView = Core.Nothing, duplicateSheet = Core.Nothing,
             findReplace = Core.Nothing, refreshDataSource = Core.Nothing,
...
data RichLinkProperties = RichLinkProperties
    {
      -- | Output only. The <https://developers.google.com/drive/api/v3/mime-types MIME type> of the link, if there\'s one (for example, when it\'s a file in Drive).
...
newScorecardChartSpec 
    ::  ScorecardChartSpec
newScorecardChartSpec
  = ScorecardChartSpec{aggregateType = Core.Nothing,
                       baselineValueData = Core.Nothing,
                       baselineValueFormat = Core.Nothing,
                       customFormatOptions = Core.Nothing, keyValueData = Core.Nothing,
                       keyValueFormat = Core.Nothing, numberFormatSource = Core.Nothing,
...
newSearchDeveloperMetadataResponse 
    :: 
                                   SearchDeveloperMetadataResponse
newSearchDeveloperMetadataResponse
  = SearchDeveloperMetadataResponse{matchedDeveloperMetadata =
                                      Core.Nothing}
...
newSetDataValidationRequest 
    ::  SetDataValidationRequest
newSetDataValidationRequest
  = SetDataValidationRequest{filteredRowsIncluded = Core.Nothing,
                             range = Core.Nothing, rule = Core.Nothing}
          ...
          = Core.withObject "SetDataValidationRequest"
              (\ o ->
                 SetDataValidationRequest Core.<$>
                   (o Core..:? "filteredRowsIncluded") Core.<*> (o Core..:? "range")
                     Core.<*> (o Core..:? "rule"))
          ...
          = Core.object
              (Core.catMaybes
                 [("filteredRowsIncluded" Core..=) Core.<$> filteredRowsIncluded,
                  ("range" Core..=) Core.<$> range, ("rule" Core..=) Core.<$> rule])
...
newSheet 
    ::  Sheet
newSheet
  = Sheet{bandedRanges = Core.Nothing, basicFilter = Core.Nothing,
          charts = Core.Nothing, columnGroups = Core.Nothing,
          conditionalFormats = Core.Nothing, data' = Core.Nothing,
          developerMetadata = Core.Nothing, filterViews = Core.Nothing,
          merges = Core.Nothing, properties = Core.Nothing,
          protectedRanges = Core.Nothing, rowGroups = Core.Nothing,
          slicers = Core.Nothing, tables = Core.Nothing}
instance Core.FromJSON Sheet where
        parseJSON
          = Core.withObject "Sheet"
              (\ o ->
                 Sheet Core.<$>
                   (o Core..:? "bandedRanges") Core.<*> (o Core..:? "basicFilter")
                     Core.<*> (o Core..:? "charts")
...
newSheetProperties 
    ::  SheetProperties
newSheetProperties
  = SheetProperties{dataSourceSheetProperties = Core.Nothing,
                    gridProperties = Core.Nothing, hidden = Core.Nothing,
                    index = Core.Nothing, rightToLeft = Core.Nothing,
                    sheetId = Core.Nothing, sheetType = Core.Nothing,
                    tabColor = Core.Nothing, tabColorStyle = Core.Nothing,
                    title = Core.Nothing}
...
newSlicer 
    ::  Slicer
newSlicer
  = Slicer{position = Core.Nothing, slicerId = Core.Nothing,
           spec = Core.Nothing}
instance Core.FromJSON Slicer where
        parseJSON
          = Core.withObject "Slicer"
              (\ o ->
                 Slicer Core.<$>
                   (o Core..:? "position") Core.<*> (o Core..:? "slicerId") Core.<*>
                     (o Core..:? "spec"))
...
newSlicerSpec 
    ::  SlicerSpec
newSlicerSpec
  = SlicerSpec{applyToPivotTables = Core.Nothing,
               backgroundColor = Core.Nothing,
               backgroundColorStyle = Core.Nothing, columnIndex = Core.Nothing,
               dataRange = Core.Nothing, filterCriteria = Core.Nothing,
               horizontalAlignment = Core.Nothing, textFormat = Core.Nothing,
               title = Core.Nothing}
          ...
          = Core.withObject "SortRangeRequest"
              (\ o ->
                 SortRangeRequest Core.<$>
                   (o Core..:? "range") Core.<*> (o Core..:? "sortSpecs"))
...
newSortSpec 
    ::  SortSpec
newSortSpec
  = SortSpec{backgroundColor = Core.Nothing,
             backgroundColorStyle = Core.Nothing,
             dataSourceColumnReference = Core.Nothing,
             dimensionIndex = Core.Nothing, foregroundColor = Core.Nothing,
             foregroundColorStyle = Core.Nothing, sortOrder = Core.Nothing}
...
newSourceAndDestination 
    ::  SourceAndDestination
newSourceAndDestination
  = SourceAndDestination{dimension = Core.Nothing,
                         fillLength = Core.Nothing, source = Core.Nothing}
instance Core.FromJSON SourceAndDestination where
        parseJSON
          = Core.withObject "SourceAndDestination"
              (\ o ->
                 SourceAndDestination Core.<$>
                   (o Core..:? "dimension") Core.<*> (o Core..:? "fillLength")
                     Core.<*> (o Core..:? "source"))
...
newSpreadsheet 
    ::  Spreadsheet
newSpreadsheet
  = Spreadsheet{dataSourceSchedules = Core.Nothing,
                dataSources = Core.Nothing, developerMetadata = Core.Nothing,
                namedRanges = Core.Nothing, properties = Core.Nothing,
                sheets = Core.Nothing, spreadsheetId = Core.Nothing,
...
newSpreadsheetProperties 
    ::  SpreadsheetProperties
newSpreadsheetProperties
  = SpreadsheetProperties{autoRecalc = Core.Nothing,
                          defaultFormat = Core.Nothing,
                          importFunctionsExternalUrlAccessAllowed = Core.Nothing,
                          iterativeCalculationSettings = Core.Nothing, locale = Core.Nothing,
                          spreadsheetTheme = Core.Nothing, timeZone = Core.Nothing,
                          title = Core.Nothing}
          ...
          = Core.withObject "SpreadsheetProperties"
              (\ o ->
                 SpreadsheetProperties Core.<$>
                   (o Core..:? "autoRecalc") Core.<*> (o Core..:? "defaultFormat")
          ...
          = Core.object
              (Core.catMaybes
                 [("autoRecalc" Core..=) Core.<$> autoRecalc,
                  ...
                  ("importFunctionsExternalUrlAccessAllowed" Core..=) Core.<$>
...
newSpreadsheetTheme 
    ::  SpreadsheetTheme
newSpreadsheetTheme
  = SpreadsheetTheme{primaryFontFamily = Core.Nothing,
...
data Table = Table
    {
      ...
      columnProperties :: (Core.Maybe [TableColumnProperties])
      -- | The table name. This is unique to all tables in the same spreadsheet.
    , name :: (Core.Maybe Core.Text)
      -- | The table range.
    , range :: (Core.Maybe GridRange)
      -- | The table rows properties.
    , rowsProperties :: (Core.Maybe TableRowsProperties)
      -- | The id of the table.
    , tableId :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newTable 
    ::  Table
newTable
  = Table{columnProperties = Core.Nothing, name = Core.Nothing,
          range = Core.Nothing, rowsProperties = Core.Nothing,
          tableId = Core.Nothing}
instance Core.FromJSON Table where
        parseJSON
          = Core.withObject "Table"
              (\ o ->
                 Table Core.<$>
                   (o Core..:? "columnProperties") Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "range")
                     Core.<*> (o Core..:? "rowsProperties")
                     Core.<*> (o Core..:? "tableId"))
          ...
          = Core.object
              (Core.catMaybes
                 [("columnProperties" Core..=) Core.<$> columnProperties,
                  ...
                  ("rowsProperties" Core..=) Core.<$> rowsProperties,
                  ("tableId" Core..=) Core.<$> tableId])


-- | A data validation rule for a column in a table.
--
-- /See:/ 'newTableColumnDataValidationRule' smart constructor.
newtype TableColumnDataValidationRule = TableColumnDataValidationRule
    {
      -- | The condition that data in the cell must match. Valid only if the [BooleanCondition.type] is ONE/OF/LIST.
      condition :: (Core.Maybe BooleanCondition)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'TableColumnDataValidationRule' with the minimum fields required to make a request.
newTableColumnDataValidationRule 
    ::  TableColumnDataValidationRule
newTableColumnDataValidationRule
  = TableColumnDataValidationRule{condition = Core.Nothing}
instance Core.FromJSON TableColumnDataValidationRule where
        parseJSON
          = Core.withObject "TableColumnDataValidationRule"
              (\ o ->
                 TableColumnDataValidationRule Core.<$> (o Core..:? "condition"))

instance Core.ToJSON TableColumnDataValidationRule where
        toJSON TableColumnDataValidationRule{..}
          = Core.object
...
data TableColumnProperties = TableColumnProperties
    ...
    , columnName :: (Core.Maybe Core.Text)
      -- | The column type.
    , columnType :: (Core.Maybe TableColumnProperties_ColumnType)
      -- | The column data validation rule. Only set for dropdown column type.
    , dataValidationRule :: (Core.Maybe TableColumnDataValidationRule)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newTableColumnProperties 
    ::  TableColumnProperties
newTableColumnProperties
  = TableColumnProperties{columnIndex = Core.Nothing,
                          columnName = Core.Nothing, columnType = Core.Nothing,
                          dataValidationRule = Core.Nothing}
instance Core.FromJSON TableColumnProperties where
        parseJSON
          = Core.withObject "TableColumnProperties"
              (\ o ->
                 TableColumnProperties Core.<$>
                   (o Core..:? "columnIndex") Core.<*> (o Core..:? "columnName")
                     Core.<*> (o Core..:? "columnType")
                     Core.<*> (o Core..:? "dataValidationRule"))
          ...
          = Core.object
              (Core.catMaybes
                 [("columnIndex" Core..=) Core.<$> columnIndex,
                  ...
                  ("dataValidationRule" Core..=) Core.<$> dataValidationRule])


-- | The table row properties.
--
-- /See:/ 'newTableRowsProperties' smart constructor.
data TableRowsProperties = TableRowsProperties
    {
      ...
      firstBandColorStyle :: (Core.Maybe ColorStyle)
      -- | The color of the last row. If this field is not set a footer is not added, the last row is filled with either first/band/color/style or second/band/color/style, depending on the color of the previous row. If updating an existing table without a footer to have a footer, the range will be expanded by 1 row. If updating an existing table with a footer and removing a footer, the range will be shrunk by 1 row.
    , footerColorStyle :: (Core.Maybe ColorStyle)
...
-- | Creates a value of 'TableRowsProperties' with the minimum fields required to make a request.
newTableRowsProperties 
    ::  TableRowsProperties
newTableRowsProperties
  = TableRowsProperties{firstBandColorStyle = Core.Nothing,
                        footerColorStyle = Core.Nothing, headerColorStyle = Core.Nothing,
                        secondBandColorStyle = Core.Nothing}
instance Core.FromJSON TableRowsProperties where
        parseJSON
          = Core.withObject "TableRowsProperties"
              (\ o ->
                 TableRowsProperties Core.<$>
                   (o Core..:? "firstBandColorStyle") Core.<*>
                     (o Core..:? "footerColorStyle")
                     Core.<*> (o Core..:? "headerColorStyle")
                     Core.<*> (o Core..:? "secondBandColorStyle"))

instance Core.ToJSON TableRowsProperties where
        toJSON TableRowsProperties{..}
          = Core.object
              (Core.catMaybes
                 [("firstBandColorStyle" Core..=) Core.<$> firstBandColorStyle,
                  ("footerColorStyle" Core..=) Core.<$> footerColorStyle,
...
newTextFormat 
    ::  TextFormat
newTextFormat
  = TextFormat{bold = Core.Nothing, fontFamily = Core.Nothing,
               fontSize = Core.Nothing, foregroundColor = Core.Nothing,
               foregroundColorStyle = Core.Nothing, italic = Core.Nothing,
               link = Core.Nothing, strikethrough = Core.Nothing,
...
instance Core.FromJSON TextFormat where
        parseJSON
          = Core.withObject "TextFormat"
              (\ o ->
                 TextFormat Core.<$>
                   (o Core..:? "bold") Core.<*> (o Core..:? "fontFamily") Core.<*>
                     (o Core..:? "fontSize")
                     Core.<*> (o Core..:? "foregroundColor")
                     Core.<*> (o Core..:? "foregroundColorStyle")
                     Core.<*> (o Core..:? "italic")
...
instance Core.FromJSON TextFormatRun where
        parseJSON
          = Core.withObject "TextFormatRun"
              (\ o ->
                 TextFormatRun Core.<$>
                   (o Core..:? "format") Core.<*> (o Core..:? "startIndex"))
...
instance Core.FromJSON TextRotation where
        parseJSON
          = Core.withObject "TextRotation"
              (\ o ->
                 TextRotation Core.<$>
                   (o Core..:? "angle") Core.<*> (o Core..:? "vertical"))
...
newTextToColumnsRequest 
    ::  TextToColumnsRequest
newTextToColumnsRequest
  = TextToColumnsRequest{delimiter = Core.Nothing,
                         delimiterType = Core.Nothing, source = Core.Nothing}
instance Core.FromJSON TextToColumnsRequest where
        parseJSON
          = Core.withObject "TextToColumnsRequest"
              (\ o ->
                 TextToColumnsRequest Core.<$>
                   (o Core..:? "delimiter") Core.<*> (o Core..:? "delimiterType")
                     Core.<*> (o Core..:? "source"))
...
instance Core.FromJSON ThemeColorPair where
        parseJSON
          = Core.withObject "ThemeColorPair"
              (\ o ->
                 ThemeColorPair Core.<$>
                   (o Core..:? "color") Core.<*> (o Core..:? "colorType"))
...
newTreemapChartColorScale 
    ::  TreemapChartColorScale
newTreemapChartColorScale
  = TreemapChartColorScale{maxValueColor = Core.Nothing,
                           maxValueColorStyle = Core.Nothing, midValueColor = Core.Nothing,
                           midValueColorStyle = Core.Nothing, minValueColor = Core.Nothing,
                           minValueColorStyle = Core.Nothing, noDataColor = Core.Nothing,
...
newTreemapChartSpec 
    ::  TreemapChartSpec
newTreemapChartSpec
  = TreemapChartSpec{colorData = Core.Nothing,
                     colorScale = Core.Nothing, headerColor = Core.Nothing,
                     headerColorStyle = Core.Nothing, hideTooltips = Core.Nothing,
                     hintedLevels = Core.Nothing, labels = Core.Nothing,
                     levels = Core.Nothing, maxValue = Core.Nothing,
                     minValue = Core.Nothing, parentLabels = Core.Nothing,
                     sizeData = Core.Nothing, textFormat = Core.Nothing}
instance Core.FromJSON TreemapChartSpec where
        parseJSON
          = Core.withObject "TreemapChartSpec"
              (\ o ->
                 TreemapChartSpec Core.<$>
                   (o Core..:? "colorData") Core.<*> (o Core..:? "colorScale")
                     Core.<*> (o Core..:? "headerColor")
                     Core.<*> (o Core..:? "headerColorStyle")
...
newUpdateBandingRequest 
    ::  UpdateBandingRequest
newUpdateBandingRequest
  = UpdateBandingRequest{bandedRange = Core.Nothing,
                         fields = Core.Nothing}
          ...
          = Core.withObject "UpdateBandingRequest"
              (\ o ->
                 UpdateBandingRequest Core.<$>
                   (o Core..:? "bandedRange") Core.<*> (o Core..:? "fields"))
...
newUpdateBordersRequest 
    ::  UpdateBordersRequest
newUpdateBordersRequest
  = UpdateBordersRequest{bottom = Core.Nothing,
                         innerHorizontal = Core.Nothing, innerVertical = Core.Nothing,
                         left = Core.Nothing, range = Core.Nothing, right = Core.Nothing,
                         top = Core.Nothing}
          ...
          = Core.withObject "UpdateBordersRequest"
              (\ o ->
                 UpdateBordersRequest Core.<$>
                   (o Core..:? "bottom") Core.<*> (o Core..:? "innerHorizontal")
          ...
          = Core.object
              (Core.catMaybes
                 [("bottom" Core..=) Core.<$> bottom,
                  ...
                  ("left" Core..=) Core.<$> left, ("range" Core..=) Core.<$> range,
                  ("right" Core..=) Core.<$> right, ("top" Core..=) Core.<$> top])
...
newUpdateCellsRequest 
    ::  UpdateCellsRequest
newUpdateCellsRequest
  = UpdateCellsRequest{fields = Core.Nothing, range = Core.Nothing,
                       rows = Core.Nothing, start = Core.Nothing}
...
instance Core.ToJSON UpdateCellsRequest where
        toJSON UpdateCellsRequest{..}
          = Core.object
              (Core.catMaybes
                 [("fields" Core..=) Core.<$> fields,
                  ("range" Core..=) Core.<$> range, ("rows" Core..=) Core.<$> rows,
                  ("start" Core..=) Core.<$> start])
...
newUpdateChartSpecRequest 
    ::  UpdateChartSpecRequest
newUpdateChartSpecRequest
  = UpdateChartSpecRequest{chartId = Core.Nothing,
                           spec = Core.Nothing}
...
newUpdateConditionalFormatRuleRequest 
    :: 
                                      UpdateConditionalFormatRuleRequest
newUpdateConditionalFormatRuleRequest
  = UpdateConditionalFormatRuleRequest{index = Core.Nothing,
                                       newIndex' = Core.Nothing, rule = Core.Nothing,
                                       sheetId = Core.Nothing}
instance Core.FromJSON UpdateConditionalFormatRuleRequest where
        parseJSON
          = Core.withObject "UpdateConditionalFormatRuleRequest"
              (\ o ->
                 UpdateConditionalFormatRuleRequest Core.<$>
                   (o Core..:? "index") Core.<*> (o Core..:? "newIndex") Core.<*>
                     (o Core..:? "rule")
                     Core.<*> (o Core..:? "sheetId"))
...
newUpdateConditionalFormatRuleResponse 
    :: 
                                       UpdateConditionalFormatRuleResponse
newUpdateConditionalFormatRuleResponse
  = UpdateConditionalFormatRuleResponse{newIndex' = Core.Nothing,
                                        newRule' = Core.Nothing, oldIndex = Core.Nothing,
                                        oldRule = Core.Nothing}
instance Core.FromJSON UpdateConditionalFormatRuleResponse where
        parseJSON
          = Core.withObject "UpdateConditionalFormatRuleResponse"
              (\ o ->
                 UpdateConditionalFormatRuleResponse Core.<$>
                   (o Core..:? "newIndex") Core.<*> (o Core..:? "newRule") Core.<*>
                     (o Core..:? "oldIndex")
                     Core.<*> (o Core..:? "oldRule"))
...
newUpdateDataSourceRequest 
    ::  UpdateDataSourceRequest
newUpdateDataSourceRequest
  = UpdateDataSourceRequest{dataSource = Core.Nothing,
                            fields = Core.Nothing}
          ...
          = Core.withObject "UpdateDataSourceRequest"
              (\ o ->
                 UpdateDataSourceRequest Core.<$>
                   (o Core..:? "dataSource") Core.<*> (o Core..:? "fields"))
...
newUpdateDataSourceResponse 
    ::  UpdateDataSourceResponse
newUpdateDataSourceResponse
  = UpdateDataSourceResponse{dataExecutionStatus = Core.Nothing,
                             dataSource = Core.Nothing}
...
newUpdateDeveloperMetadataRequest 
    ::  UpdateDeveloperMetadataRequest
newUpdateDeveloperMetadataRequest
  = UpdateDeveloperMetadataRequest{dataFilters = Core.Nothing,
                                   developerMetadata = Core.Nothing, fields = Core.Nothing}
...
newUpdateDimensionGroupRequest 
    ::  UpdateDimensionGroupRequest
newUpdateDimensionGroupRequest
  = UpdateDimensionGroupRequest{dimensionGroup = Core.Nothing,
                                fields = Core.Nothing}
          ...
          = Core.withObject "UpdateDimensionGroupRequest"
              (\ o ->
                 UpdateDimensionGroupRequest Core.<$>
                   (o Core..:? "dimensionGroup") Core.<*> (o Core..:? "fields"))
...
newUpdateDimensionPropertiesRequest 
    :: 
                                    UpdateDimensionPropertiesRequest
newUpdateDimensionPropertiesRequest
  = UpdateDimensionPropertiesRequest{dataSourceSheetRange =
                                       Core.Nothing,
          ...
          = Core.withObject "UpdateDimensionPropertiesRequest"
              (\ o ->
                 UpdateDimensionPropertiesRequest Core.<$>
                   (o Core..:? "dataSourceSheetRange") Core.<*> (o Core..:? "fields")
                     Core.<*> (o Core..:? "properties")
                     Core.<*> (o Core..:? "range"))
...
newUpdateEmbeddedObjectBorderRequest 
    :: 
                                     UpdateEmbeddedObjectBorderRequest
newUpdateEmbeddedObjectBorderRequest
  = UpdateEmbeddedObjectBorderRequest{border = Core.Nothing,
                                      fields = Core.Nothing, objectId = Core.Nothing}
          ...
          = Core.withObject "UpdateEmbeddedObjectBorderRequest"
              (\ o ->
                 UpdateEmbeddedObjectBorderRequest Core.<$>
                   (o Core..:? "border") Core.<*> (o Core..:? "fields") Core.<*>
                     (o Core..:? "objectId"))
...
newUpdateEmbeddedObjectPositionRequest 
    :: 
                                       UpdateEmbeddedObjectPositionRequest
newUpdateEmbeddedObjectPositionRequest
  = UpdateEmbeddedObjectPositionRequest{fields = Core.Nothing,
                                        newPosition' = Core.Nothing, objectId = Core.Nothing}
instance Core.FromJSON UpdateEmbeddedObjectPositionRequest where
        parseJSON
          = Core.withObject "UpdateEmbeddedObjectPositionRequest"
              (\ o ->
                 UpdateEmbeddedObjectPositionRequest Core.<$>
                   (o Core..:? "fields") Core.<*> (o Core..:? "newPosition") Core.<*>
                     (o Core..:? "objectId"))
...
instance Core.FromJSON UpdateEmbeddedObjectPositionResponse where
        parseJSON
          = Core.withObject "UpdateEmbeddedObjectPositionResponse"
              (\ o ->
...
newUpdateFilterViewRequest 
    ::  UpdateFilterViewRequest
newUpdateFilterViewRequest
  = UpdateFilterViewRequest{fields = Core.Nothing,
                            filter = Core.Nothing}
...
newUpdateNamedRangeRequest 
    ::  UpdateNamedRangeRequest
newUpdateNamedRangeRequest
  = UpdateNamedRangeRequest{fields = Core.Nothing,
          ...
          = Core.withObject "UpdateNamedRangeRequest"
              (\ o ->
                 UpdateNamedRangeRequest Core.<$>
                   (o Core..:? "fields") Core.<*> (o Core..:? "namedRange"))
...
newUpdateProtectedRangeRequest 
    ::  UpdateProtectedRangeRequest
newUpdateProtectedRangeRequest
  = UpdateProtectedRangeRequest{fields = Core.Nothing,
          ...
          = Core.withObject "UpdateProtectedRangeRequest"
              (\ o ->
                 UpdateProtectedRangeRequest Core.<$>
                   (o Core..:? "fields") Core.<*> (o Core..:? "protectedRange"))
...
newUpdateSheetPropertiesRequest 
    ::  UpdateSheetPropertiesRequest
newUpdateSheetPropertiesRequest
  = UpdateSheetPropertiesRequest{fields = Core.Nothing,
          ...
          = Core.withObject "UpdateSheetPropertiesRequest"
              (\ o ->
                 UpdateSheetPropertiesRequest Core.<$>
                   (o Core..:? "fields") Core.<*> (o Core..:? "properties"))
...
newUpdateSlicerSpecRequest 
    ::  UpdateSlicerSpecRequest
newUpdateSlicerSpecRequest
  = UpdateSlicerSpecRequest{fields = Core.Nothing,
                            slicerId = Core.Nothing, spec = Core.Nothing}
instance Core.FromJSON UpdateSlicerSpecRequest where
        parseJSON
          = Core.withObject "UpdateSlicerSpecRequest"
              (\ o ->
                 UpdateSlicerSpecRequest Core.<$>
                   (o Core..:? "fields") Core.<*> (o Core..:? "slicerId") Core.<*>
                     (o Core..:? "spec"))
...
newUpdateSpreadsheetPropertiesRequest 
    :: 
                                      UpdateSpreadsheetPropertiesRequest
newUpdateSpreadsheetPropertiesRequest
  = UpdateSpreadsheetPropertiesRequest{fields = Core.Nothing,
                                       properties = Core.Nothing}
instance Core.FromJSON UpdateSpreadsheetPropertiesRequest where
        parseJSON
          = Core.withObject "UpdateSpreadsheetPropertiesRequest"
              (\ o ->
...
--
-- /See:/ 'newUpdateTableRequest' smart constructor.
data UpdateTableRequest = UpdateTableRequest
    {
...
-- | Creates a value of 'UpdateTableRequest' with the minimum fields required to make a request.
newUpdateTableRequest 
    ::  UpdateTableRequest
newUpdateTableRequest
  = UpdateTableRequest{fields = Core.Nothing, table = Core.Nothing}
instance Core.FromJSON UpdateTableRequest where
        parseJSON
          = Core.withObject "UpdateTableRequest"
              (\ o ->
                 UpdateTableRequest Core.<$>
                   (o Core..:? "fields") Core.<*> (o Core..:? "table"))

instance Core.ToJSON UpdateTableRequest where
        toJSON UpdateTableRequest{..}
          = Core.object
              (Core.catMaybes
                 [("fields" Core..=) Core.<$> fields,
...
data UpdateValuesByDataFilterResponse = UpdateValuesByDataFilterResponse
    ...
    , updatedData :: (Core.Maybe ValueRange)
      -- | The range (in <https://developers.google.com/workspace/sheets/api/guides/concepts#cell A1 notation>) that updates were applied to.
...
newUpdateValuesByDataFilterResponse 
    :: 
                                    UpdateValuesByDataFilterResponse
newUpdateValuesByDataFilterResponse
  = UpdateValuesByDataFilterResponse{dataFilter = Core.Nothing,
                                     updatedCells = Core.Nothing, updatedColumns = Core.Nothing,
                                     updatedData = Core.Nothing, updatedRange = Core.Nothing,
          ...
          = Core.withObject "UpdateValuesByDataFilterResponse"
              (\ o ->
                 UpdateValuesByDataFilterResponse Core.<$>
                   (o Core..:? "dataFilter") Core.<*> (o Core..:? "updatedCells")
...
newUpdateValuesResponse 
    ::  UpdateValuesResponse
newUpdateValuesResponse
  = UpdateValuesResponse{spreadsheetId = Core.Nothing,
                         updatedCells = Core.Nothing, updatedColumns = Core.Nothing,
                         updatedData = Core.Nothing, updatedRange = Core.Nothing,
                         updatedRows = Core.Nothing}
          ...
          = Core.withObject "UpdateValuesResponse"
              (\ o ->
                 UpdateValuesResponse Core.<$>
                   (o Core..:? "spreadsheetId") Core.<*> (o Core..:? "updatedCells")
                     Core.<*> (o Core..:? "updatedColumns")
                     Core.<*> (o Core..:? "updatedData")
                     Core.<*> (o Core..:? "updatedRange")
                     Core.<*> (o Core..:? "updatedRows"))
...
newValueRange 
    ::  ValueRange
newValueRange
  = ValueRange{majorDimension = Core.Nothing, range = Core.Nothing,
               values = Core.Nothing}
instance Core.FromJSON ValueRange where
        parseJSON
          = Core.withObject "ValueRange"
              (\ o ->
                 ValueRange Core.<$>
                   (o Core..:? "majorDimension") Core.<*> (o Core..:? "range")
                     Core.<*> (o Core..:? "values"))
...
newWaterfallChartColumnStyle 
    ::  WaterfallChartColumnStyle
newWaterfallChartColumnStyle
  = WaterfallChartColumnStyle{color = Core.Nothing,
                              colorStyle = Core.Nothing, label = Core.Nothing}
...
newWaterfallChartCustomSubtotal 
    ::  WaterfallChartCustomSubtotal
newWaterfallChartCustomSubtotal
  = WaterfallChartCustomSubtotal{dataIsSubtotal = Core.Nothing,
                                 label = Core.Nothing, subtotalIndex = Core.Nothing}
          ...
          = Core.withObject "WaterfallChartCustomSubtotal"
              (\ o ->
                 WaterfallChartCustomSubtotal Core.<$>
                   (o Core..:? "dataIsSubtotal") Core.<*> (o Core..:? "label")
...
newWaterfallChartDomain 
    ::  WaterfallChartDomain
newWaterfallChartDomain
  = WaterfallChartDomain{data' = Core.Nothing,
...
newWaterfallChartSeries 
    ::  WaterfallChartSeries
newWaterfallChartSeries
  = WaterfallChartSeries{customSubtotals = Core.Nothing,
                         data' = Core.Nothing, dataLabel = Core.Nothing,
          ...
          = Core.withObject "WaterfallChartSeries"
              (\ o ->
                 WaterfallChartSeries Core.<$>
                   (o Core..:? "customSubtotals") Core.<*> (o Core..:? "data")
...
newWaterfallChartSpec 
    ::  WaterfallChartSpec
newWaterfallChartSpec
  = WaterfallChartSpec{connectorLineStyle = Core.Nothing,
                       domain = Core.Nothing, firstValueIsTotal = Core.Nothing,
                       hideConnectorLines = Core.Nothing, series = Core.Nothing,
                       stackedType = Core.Nothing, totalDataLabel = Core.Nothing}
instance Core.FromJSON WaterfallChartSpec where
        parseJSON
          = Core.withObject "WaterfallChartSpec"
              (\ o ->
                 WaterfallChartSpec Core.<$>
                   (o Core..:? "connectorLineStyle") Core.<*> (o Core..:? "domain")
