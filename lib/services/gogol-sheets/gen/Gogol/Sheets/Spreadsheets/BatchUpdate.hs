...
--
-- /See:/ <https://developers.google.com/workspace/sheets/ Google Sheets API Reference> for @sheets.spreadsheets.batchUpdate@.
module Gogol.Sheets.Spreadsheets.BatchUpdate
    (
    -- * Resource
...
type SheetsSpreadsheetsBatchUpdateResource =
     "v4" Core.:>
       "spreadsheets" Core.:>
         Core.CaptureMode "spreadsheetId" "batchUpdate" Core.Text Core.:>
                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] BatchUpdateSpreadsheetRequest Core.:>
                         Core.Post '[Core.JSON] BatchUpdateSpreadsheetResponse
...
newSheetsSpreadsheetsBatchUpdate payload spreadsheetId
  = SheetsSpreadsheetsBatchUpdate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest SheetsSpreadsheetsBatchUpdate where
        type Rs SheetsSpreadsheetsBatchUpdate =
             BatchUpdateSpreadsheetResponse
        type Scopes SheetsSpreadsheetsBatchUpdate =
