...
--
-- /See:/ <https://developers.google.com/workspace/sheets/ Google Sheets API Reference> for @sheets.spreadsheets.developerMetadata.get@.
module Gogol.Sheets.Spreadsheets.DeveloperMetadata.Get
    (
    -- * Resource
...
newSheetsSpreadsheetsDeveloperMetadataGet metadataId spreadsheetId
  = SheetsSpreadsheetsDeveloperMetadataGet{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           metadataId = metadataId, spreadsheetId = spreadsheetId,
                                           uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest SheetsSpreadsheetsDeveloperMetadataGet
         where
        ...
        requestClient SheetsSpreadsheetsDeveloperMetadataGet{..}
          = go spreadsheetId metadataId xgafv accessToken callback uploadType
              uploadProtocol
