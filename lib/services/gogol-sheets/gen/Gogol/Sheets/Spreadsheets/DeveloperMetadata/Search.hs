...
--
-- /See:/ <https://developers.google.com/workspace/sheets/ Google Sheets API Reference> for @sheets.spreadsheets.developerMetadata.search@.
module Gogol.Sheets.Spreadsheets.DeveloperMetadata.Search
    (
    -- * Resource
                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] SearchDeveloperMetadataRequest Core.:>
                           Core.Post '[Core.JSON] SearchDeveloperMetadataResponse
...
newSheetsSpreadsheetsDeveloperMetadataSearch payload spreadsheetId
  = SheetsSpreadsheetsDeveloperMetadataSearch{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           SheetsSpreadsheetsDeveloperMetadataSearch
         where
        type Rs SheetsSpreadsheetsDeveloperMetadataSearch =
             SearchDeveloperMetadataResponse
        type Scopes SheetsSpreadsheetsDeveloperMetadataSearch =
