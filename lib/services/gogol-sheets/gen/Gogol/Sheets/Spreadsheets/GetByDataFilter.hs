...
--
-- Returns the spreadsheet at the given ID. The caller must specify the spreadsheet ID. This method differs from GetSpreadsheet in that it allows selecting which subsets of spreadsheet data to return by specifying a dataFilters parameter. Multiple DataFilters can be specified. Specifying one or more data filters returns the portions of the spreadsheet that intersect ranges matched by any of the filters. By default, data within grids is not returned. You can include grid data one of 2 ways: * Specify a <https://developers.google.com/workspace/sheets/api/guides/field-masks field mask> listing your desired fields using the @fields@ URL parameter in HTTP * Set the includeGridData parameter to true. If a field mask is set, the @includeGridData@ parameter is ignored For large spreadsheets, as a best practice, retrieve only the specific spreadsheet fields that you want.
--
-- /See:/ <https://developers.google.com/workspace/sheets/ Google Sheets API Reference> for @sheets.spreadsheets.getByDataFilter@.
module Gogol.Sheets.Spreadsheets.GetByDataFilter
    (
    -- * Resource
...
type SheetsSpreadsheetsGetByDataFilterResource =
     "v4" Core.:>
       "spreadsheets" Core.:>
         Core.CaptureMode "spreadsheetId" "getByDataFilter" Core.Text
           Core.:>
                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] GetSpreadsheetByDataFilterRequest Core.:>
                         Core.Post '[Core.JSON] Spreadsheet
...
newSheetsSpreadsheetsGetByDataFilter payload spreadsheetId
  = SheetsSpreadsheetsGetByDataFilter{xgafv = Core.Nothing,
                                      accessToken = Core.Nothing, callback = Core.Nothing,
                                      payload = payload, spreadsheetId = spreadsheetId,
