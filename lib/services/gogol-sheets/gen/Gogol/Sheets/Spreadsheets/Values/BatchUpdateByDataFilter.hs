...
--
-- /See:/ <https://developers.google.com/workspace/sheets/ Google Sheets API Reference> for @sheets.spreadsheets.values.batchUpdateByDataFilter@.
module Gogol.Sheets.Spreadsheets.Values.BatchUpdateByDataFilter
    (
    -- * Resource
     ...
     "v4" Core.:>
       "spreadsheets" Core.:>
         Core.Capture "spreadsheetId" Core.Text Core.:>
           "values:batchUpdateByDataFilter" Core.:>
                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] BatchUpdateValuesByDataFilterRequest
                           Core.:>
                           Core.Post '[Core.JSON] BatchUpdateValuesByDataFilterResponse
...
newSheetsSpreadsheetsValuesBatchUpdateByDataFilter 
    ...
    -> SheetsSpreadsheetsValuesBatchUpdateByDataFilter
newSheetsSpreadsheetsValuesBatchUpdateByDataFilter payload
  spreadsheetId
  = SheetsSpreadsheetsValuesBatchUpdateByDataFilter{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           SheetsSpreadsheetsValuesBatchUpdateByDataFilter
         where
        type Rs SheetsSpreadsheetsValuesBatchUpdateByDataFilter =
             BatchUpdateValuesByDataFilterResponse
        type Scopes SheetsSpreadsheetsValuesBatchUpdateByDataFilter =
