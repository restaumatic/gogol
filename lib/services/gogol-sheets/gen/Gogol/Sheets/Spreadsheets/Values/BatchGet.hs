...
--
-- /See:/ <https://developers.google.com/workspace/sheets/ Google Sheets API Reference> for @sheets.spreadsheets.values.batchGet@.
module Gogol.Sheets.Spreadsheets.Values.BatchGet
    (
    -- * Resource
                           ...
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "valueRenderOption"
                               ...
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.Get '[Core.JSON] BatchGetValuesResponse
...
newSheetsSpreadsheetsValuesBatchGet spreadsheetId
  = SheetsSpreadsheetsValuesBatchGet{xgafv = Core.Nothing,
                                     accessToken = Core.Nothing, callback = Core.Nothing,
                                     dateTimeRenderOption = Core.Nothing,
                                     majorDimension = Core.Nothing, ranges = Core.Nothing,
...
instance Core.GoogleRequest SheetsSpreadsheetsValuesBatchGet where
        ...
        type Scopes SheetsSpreadsheetsValuesBatchGet =
        ...
        requestClient SheetsSpreadsheetsValuesBatchGet{..}
          = go spreadsheetId xgafv accessToken callback dateTimeRenderOption
              majorDimension
