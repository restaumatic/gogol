...
--
-- /See:/ <https://developers.google.com/workspace/sheets/ Google Sheets API Reference> for @sheets.spreadsheets.values.clear@.
module Gogol.Sheets.Spreadsheets.Values.Clear
    (
    -- * Resource
     ...
     "v4" Core.:>
       "spreadsheets" Core.:>
         Core.Capture "spreadsheetId" Core.Text Core.:>
           "values" Core.:>
             Core.CaptureMode "range" "clear" Core.Text Core.:>
                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] ClearValuesRequest Core.:>
                             Core.Post '[Core.JSON] ClearValuesResponse
...
data SheetsSpreadsheetsValuesClear = SheetsSpreadsheetsValuesClear
    ...
    , payload :: ClearValuesRequest
      -- | The <https://developers.google.com/workspace/sheets/api/guides/concepts#cell A1 notation or R1C1 notation> of the values to clear.
    , range :: Core.Text
...
newSheetsSpreadsheetsValuesClear 
    ...
    -> Core.Text
       -- ^  The <https://developers.google.com/workspace/sheets/api/guides/concepts#cell A1 notation or R1C1 notation> of the values to clear. See 'range'.
    -> Core.Text
       -- ^  The ID of the spreadsheet to update. See 'spreadsheetId'.
    -> SheetsSpreadsheetsValuesClear
newSheetsSpreadsheetsValuesClear payload range spreadsheetId
  = SheetsSpreadsheetsValuesClear{xgafv = Core.Nothing,
                                  accessToken = Core.Nothing, callback = Core.Nothing,
                                  payload = payload, range = range, spreadsheetId = spreadsheetId,
...
instance Core.GoogleRequest SheetsSpreadsheetsValuesClear where
        ...
        type Scopes SheetsSpreadsheetsValuesClear =
             '[Drive'FullControl, Drive'File, Spreadsheets'FullControl]
        requestClient SheetsSpreadsheetsValuesClear{..}
          = go spreadsheetId range xgafv accessToken callback uploadType
              uploadProtocol
