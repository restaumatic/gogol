...
--
-- /See:/ <https://developers.google.com/workspace/sheets/ Google Sheets API Reference> for @sheets.spreadsheets.values.get@.
module Gogol.Sheets.Spreadsheets.Values.Get
    (
    -- * Resource
...
data SheetsSpreadsheetsValuesGet = SheetsSpreadsheetsValuesGet
    ...
    , majorDimension :: (Core.Maybe SpreadsheetsValuesGetMajorDimension)
      -- | The <https://developers.google.com/workspace/sheets/api/guides/concepts#cell A1 notation or R1C1 notation> of the range to retrieve values from.
    , range :: Core.Text
...
newSheetsSpreadsheetsValuesGet 
    :: 
                               Core.Text
       -- ^  The <https://developers.google.com/workspace/sheets/api/guides/concepts#cell A1 notation or R1C1 notation> of the range to retrieve values from. See 'range'.
    -> Core.Text
       -- ^  The ID of the spreadsheet to retrieve data from. See 'spreadsheetId'.
    -> SheetsSpreadsheetsValuesGet
newSheetsSpreadsheetsValuesGet range spreadsheetId
  = SheetsSpreadsheetsValuesGet{xgafv = Core.Nothing,
                                accessToken = Core.Nothing, callback = Core.Nothing,
                                dateTimeRenderOption = Core.Nothing, majorDimension = Core.Nothing,
...
instance Core.GoogleRequest SheetsSpreadsheetsValuesGet where
        ...
        type Scopes SheetsSpreadsheetsValuesGet =
