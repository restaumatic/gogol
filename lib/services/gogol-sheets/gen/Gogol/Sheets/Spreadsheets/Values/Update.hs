...
--
-- /See:/ <https://developers.google.com/workspace/sheets/ Google Sheets API Reference> for @sheets.spreadsheets.values.update@.
module Gogol.Sheets.Spreadsheets.Values.Update
    (
    -- * Resource
     ...
     "v4" Core.:>
       "spreadsheets" Core.:>
         Core.Capture "spreadsheetId" Core.Text Core.:>
           "values" Core.:>
             Core.Capture "range" Core.Text Core.:>
                               ...
                               Core.QueryParam "valueInputOption"
                                 ...
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.ReqBody '[Core.JSON] ValueRange Core.:>
                                     Core.Put '[Core.JSON] UpdateValuesResponse
...
data SheetsSpreadsheetsValuesUpdate = SheetsSpreadsheetsValuesUpdate
    ...
    , payload :: ValueRange
      -- | The <https://developers.google.com/workspace/sheets/api/guides/concepts#cell A1 notation> of the values to update.
    , range :: Core.Text
...
newSheetsSpreadsheetsValuesUpdate 
    ...
    -> Core.Text
       -- ^  The <https://developers.google.com/workspace/sheets/api/guides/concepts#cell A1 notation> of the values to update. See 'range'.
    -> Core.Text
       -- ^  The ID of the spreadsheet to update. See 'spreadsheetId'.
    -> SheetsSpreadsheetsValuesUpdate
newSheetsSpreadsheetsValuesUpdate payload range spreadsheetId
  = SheetsSpreadsheetsValuesUpdate{xgafv = Core.Nothing,
                                   accessToken = Core.Nothing, callback = Core.Nothing,
                                   includeValuesInResponse = Core.Nothing, payload = payload,
...
instance Core.GoogleRequest SheetsSpreadsheetsValuesUpdate where
        ...
        type Scopes SheetsSpreadsheetsValuesUpdate =
