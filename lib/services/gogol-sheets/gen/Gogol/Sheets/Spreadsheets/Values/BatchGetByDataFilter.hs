...
--
-- /See:/ <https://developers.google.com/workspace/sheets/ Google Sheets API Reference> for @sheets.spreadsheets.values.batchGetByDataFilter@.
module Gogol.Sheets.Spreadsheets.Values.BatchGetByDataFilter
    (
    -- * Resource
                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] BatchGetValuesByDataFilterRequest Core.:>
                           Core.Post '[Core.JSON] BatchGetValuesByDataFilterResponse
...
newSheetsSpreadsheetsValuesBatchGetByDataFilter 
    ...
    -> SheetsSpreadsheetsValuesBatchGetByDataFilter
newSheetsSpreadsheetsValuesBatchGetByDataFilter payload
  spreadsheetId
  = SheetsSpreadsheetsValuesBatchGetByDataFilter{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes SheetsSpreadsheetsValuesBatchGetByDataFilter =
