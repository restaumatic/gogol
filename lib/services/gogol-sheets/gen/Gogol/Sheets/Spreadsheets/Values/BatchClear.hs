...
--
-- /See:/ <https://developers.google.com/workspace/sheets/ Google Sheets API Reference> for @sheets.spreadsheets.values.batchClear@.
module Gogol.Sheets.Spreadsheets.Values.BatchClear
    (
    -- * Resource
                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] BatchClearValuesRequest Core.:>
                           Core.Post '[Core.JSON] BatchClearValuesResponse
...
newSheetsSpreadsheetsValuesBatchClear payload spreadsheetId
  = SheetsSpreadsheetsValuesBatchClear{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       payload = payload, spreadsheetId = spreadsheetId,
                                       uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest SheetsSpreadsheetsValuesBatchClear
         where
        type Rs SheetsSpreadsheetsValuesBatchClear =
             BatchClearValuesResponse
        type Scopes SheetsSpreadsheetsValuesBatchClear =
