...
--
-- Appends values to a spreadsheet. The input range is used to search for existing data and find a \"table\" within that range. Values will be appended to the next row of the table, starting with the first column of the table. See the <https://developers.google.com/workspace/sheets/api/guides/values#appending_values guide> and <https://developers.google.com/workspace/sheets/api/samples/writing#append_values sample code> for specific details of how tables are detected and data is appended. The caller must specify the spreadsheet ID, range, and a valueInputOption. The @valueInputOption@ only controls how the input data will be added to the sheet (column-wise or row-wise), it does not influence what cell the data starts being written to.
--
-- /See:/ <https://developers.google.com/workspace/sheets/ Google Sheets API Reference> for @sheets.spreadsheets.values.append@.
module Gogol.Sheets.Spreadsheets.Values.Append
    (
    -- * Resource
               ...
               Core.QueryParam "$.xgafv" Xgafv Core.:>
                 Core.QueryParam "access_token" Core.Text Core.:>
                   Core.QueryParam "callback" Core.Text Core.:>
                     Core.QueryParam "includeValuesInResponse" Core.Bool Core.:>
                               ...
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "valueInputOption"
                                   ...
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.ReqBody '[Core.JSON] ValueRange Core.:>
                                       Core.Post '[Core.JSON] AppendValuesResponse
...
data SheetsSpreadsheetsValuesAppend = SheetsSpreadsheetsValuesAppend
    ...
    , payload :: ValueRange
      -- | The <https://developers.google.com/workspace/sheets/api/guides/concepts#cell A1 notation> of a range to search for a logical table of data. Values are appended after the last row of the table.
    , range :: Core.Text
...
newSheetsSpreadsheetsValuesAppend 
    ...
    -> Core.Text
       -- ^  The <https://developers.google.com/workspace/sheets/api/guides/concepts#cell A1 notation> of a range to search for a logical table of data. Values are appended after the last row of the table. See 'range'.
    -> Core.Text
       -- ^  The ID of the spreadsheet to update. See 'spreadsheetId'.
    -> SheetsSpreadsheetsValuesAppend
newSheetsSpreadsheetsValuesAppend payload range spreadsheetId
  = SheetsSpreadsheetsValuesAppend{xgafv = Core.Nothing,
                                   accessToken = Core.Nothing, callback = Core.Nothing,
                                   includeValuesInResponse = Core.Nothing,
                                   insertDataOption = Core.Nothing, payload = payload,
                                   range = range, responseDateTimeRenderOption = Core.Nothing,
                                   responseValueRenderOption = Core.Nothing,
                                   spreadsheetId = spreadsheetId, uploadType = Core.Nothing,
                                   uploadProtocol = Core.Nothing, valueInputOption = Core.Nothing}
