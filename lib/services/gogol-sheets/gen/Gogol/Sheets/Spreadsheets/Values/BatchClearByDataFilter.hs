...
--
-- /See:/ <https://developers.google.com/workspace/sheets/ Google Sheets API Reference> for @sheets.spreadsheets.values.batchClearByDataFilter@.
module Gogol.Sheets.Spreadsheets.Values.BatchClearByDataFilter
    (
    -- * Resource
                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] BatchClearValuesByDataFilterRequest
...
newSheetsSpreadsheetsValuesBatchClearByDataFilter 
    ...
    -> SheetsSpreadsheetsValuesBatchClearByDataFilter
newSheetsSpreadsheetsValuesBatchClearByDataFilter payload
  spreadsheetId
  = SheetsSpreadsheetsValuesBatchClearByDataFilter{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           SheetsSpreadsheetsValuesBatchClearByDataFilter
         where
        type Rs SheetsSpreadsheetsValuesBatchClearByDataFilter =
             BatchClearValuesByDataFilterResponse
        type Scopes SheetsSpreadsheetsValuesBatchClearByDataFilter =
