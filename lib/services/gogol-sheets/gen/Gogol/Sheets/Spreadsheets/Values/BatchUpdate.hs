...
--
-- /See:/ <https://developers.google.com/workspace/sheets/ Google Sheets API Reference> for @sheets.spreadsheets.values.batchUpdate@.
module Gogol.Sheets.Spreadsheets.Values.BatchUpdate
    (
    -- * Resource
                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] BatchUpdateValuesRequest Core.:>
                           Core.Post '[Core.JSON] BatchUpdateValuesResponse
...
newSheetsSpreadsheetsValuesBatchUpdate payload spreadsheetId
  = SheetsSpreadsheetsValuesBatchUpdate{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        payload = payload, spreadsheetId = spreadsheetId,
                                        uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest SheetsSpreadsheetsValuesBatchUpdate
         where
        type Rs SheetsSpreadsheetsValuesBatchUpdate =
             BatchUpdateValuesResponse
        type Scopes SheetsSpreadsheetsValuesBatchUpdate =
