...
--
-- /See:/ <https://developers.google.com/workspace/sheets/ Google Sheets API Reference> for @sheets.spreadsheets.sheets.copyTo@.
module Gogol.Sheets.Spreadsheets.Sheets.CopyTo
    (
    -- * Resource
     ...
     "v4" Core.:>
       "spreadsheets" Core.:>
         Core.Capture "spreadsheetId" Core.Text Core.:>
           "sheets" Core.:>
             Core.CaptureMode "sheetId" "copyTo" Core.Int32 Core.:>
                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] CopySheetToAnotherSpreadsheetRequest
...
newSheetsSpreadsheetsSheetsCopyTo payload sheetId spreadsheetId
  = SheetsSpreadsheetsSheetsCopyTo{xgafv = Core.Nothing,
                                   accessToken = Core.Nothing, callback = Core.Nothing,
                                   payload = payload, sheetId = sheetId,
...
instance Core.GoogleRequest SheetsSpreadsheetsSheetsCopyTo where
        ...
        requestClient SheetsSpreadsheetsSheetsCopyTo{..}
          = go spreadsheetId sheetId xgafv accessToken callback uploadType
              uploadProtocol
