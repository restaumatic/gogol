...
type PubSubProjectsSchemasListRevisionsResource =
     "v1" Core.:>
       Core.CaptureMode "name" "listRevisions" Core.Text Core.:>
                 ...
                 Core.QueryParam "pageToken" Core.Text Core.:>
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "view" ProjectsSchemasListRevisionsView Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] ListSchemaRevisionsResponse
...
newPubSubProjectsSchemasListRevisions name
  = PubSubProjectsSchemasListRevisions{xgafv = Core.Nothing,
...
instance Core.GoogleRequest PubSubProjectsSchemasListRevisions
         where
        type Rs PubSubProjectsSchemasListRevisions =
             ListSchemaRevisionsResponse
        type Scopes PubSubProjectsSchemasListRevisions =
