                   ...
                   Core.QueryParam "pageToken" Core.Text Core.:>
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "view" ProjectsSchemasListView Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] ListSchemasResponse
...
newPubSubProjectsSchemasList parent
  = PubSubProjectsSchemasList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest PubSubProjectsSchemasList where
        ...
        type Scopes PubSubProjectsSchemasList =
