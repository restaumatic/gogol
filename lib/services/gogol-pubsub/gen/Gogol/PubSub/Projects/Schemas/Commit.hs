...
type PubSubProjectsSchemasCommitResource =
     "v1" Core.:>
       Core.CaptureMode "name" "commit" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] CommitSchemaRequest Core.:>
...
newPubSubProjectsSchemasCommit name payload
  = PubSubProjectsSchemasCommit{xgafv = Core.Nothing,
...
instance Core.GoogleRequest PubSubProjectsSchemasCommit where
        ...
        type Scopes PubSubProjectsSchemasCommit =
