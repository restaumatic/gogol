           ...
           Core.QueryParam "$.xgafv" Xgafv Core.:>
             Core.QueryParam "access_token" Core.Text Core.:>
               Core.QueryParam "callback" Core.Text Core.:>
                 Core.QueryParam "schemaId" Core.Text Core.:>
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] Schema Core.:>
                           Core.Post '[Core.JSON] Schema
...
newPubSubProjectsSchemasCreate parent payload
  = PubSubProjectsSchemasCreate{xgafv = Core.Nothing,
                                accessToken = Core.Nothing, callback = Core.Nothing,
                                parent = parent, payload = payload, schemaId = Core.Nothing,
                                uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest PubSubProjectsSchemasCreate where
        type Rs PubSubProjectsSchemasCreate = Schema
        type Scopes PubSubProjectsSchemasCreate =
             '[CloudPlatform'FullControl, Pubsub'FullControl]
        requestClient PubSubProjectsSchemasCreate{..}
          = go parent xgafv accessToken callback schemaId uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy PubSubProjectsSchemasCreateResource)
                      Core.mempty
