...
type PubSubProjectsSchemasDeleteRevisionResource =
     "v1" Core.:>
       Core.CaptureMode "name" "deleteRevision" Core.Text Core.:>
...
newPubSubProjectsSchemasDeleteRevision name
  = PubSubProjectsSchemasDeleteRevision{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        name = name, revisionId = Core.Nothing,
                                        uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest PubSubProjectsSchemasDeleteRevision
         where
        type Rs PubSubProjectsSchemasDeleteRevision = Schema
        type Scopes PubSubProjectsSchemasDeleteRevision =
             '[CloudPlatform'FullControl, Pubsub'FullControl]
        requestClient PubSubProjectsSchemasDeleteRevision{..}
          = go name xgafv accessToken callback revisionId uploadType
              uploadProtocol
