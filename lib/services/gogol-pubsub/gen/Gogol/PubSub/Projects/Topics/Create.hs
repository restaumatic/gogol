...
-- |
-- Module      : Gogol.PubSub.Projects.Topics.Create
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] Topic Core.:> Core.Put '[Core.JSON] Topic
...
newPubSubProjectsTopicsCreate name payload
  = PubSubProjectsTopicsCreate{xgafv = Core.Nothing,
                               accessToken = Core.Nothing, callback = Core.Nothing, name = name,
                               payload = payload, uploadType = Core.Nothing,
                               uploadProtocol = Core.Nothing}
instance Core.GoogleRequest PubSubProjectsTopicsCreate where
        type Rs PubSubProjectsTopicsCreate = Topic
        type Scopes PubSubProjectsTopicsCreate =
        ...
        requestClient PubSubProjectsTopicsCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy PubSubProjectsTopicsCreateResource)
                      Core.mempty
