                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] ListTopicSubscriptionsResponse
...
newPubSubProjectsTopicsSubscriptionsList topic
  = PubSubProjectsTopicsSubscriptionsList{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          pageSize = Core.Nothing, pageToken = Core.Nothing,
                                          topic = topic, uploadType = Core.Nothing,
                                          uploadProtocol = Core.Nothing}
instance Core.GoogleRequest PubSubProjectsTopicsSubscriptionsList
         where
        type Rs PubSubProjectsTopicsSubscriptionsList =
             ListTopicSubscriptionsResponse
        type Scopes PubSubProjectsTopicsSubscriptionsList =
             '[CloudPlatform'FullControl, Pubsub'FullControl]
        requestClient PubSubProjectsTopicsSubscriptionsList{..}
          = go topic xgafv accessToken callback pageSize pageToken uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy PubSubProjectsTopicsSubscriptionsListResource)
                      Core.mempty
