                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] ListTopicsResponse
...
newPubSubProjectsTopicsList project
  = PubSubProjectsTopicsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest PubSubProjectsTopicsList where
        ...
        type Scopes PubSubProjectsTopicsList =
        ...
        requestClient PubSubProjectsTopicsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy PubSubProjectsTopicsListResource)
                      Core.mempty
