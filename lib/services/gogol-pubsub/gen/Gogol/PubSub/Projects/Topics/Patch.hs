...
newPubSubProjectsTopicsPatch name payload
  = PubSubProjectsTopicsPatch{xgafv = Core.Nothing,
                              accessToken = Core.Nothing, callback = Core.Nothing, name = name,
                              payload = payload, uploadType = Core.Nothing,
                              uploadProtocol = Core.Nothing}
instance Core.GoogleRequest PubSubProjectsTopicsPatch where
        ...
        requestClient PubSubProjectsTopicsPatch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy PubSubProjectsTopicsPatchResource)
                      Core.mempty
