...
newPubSubProjectsTopicsGetIamPolicy resource
  = PubSubProjectsTopicsGetIamPolicy{xgafv = Core.Nothing,
                                     accessToken = Core.Nothing, callback = Core.Nothing,
                                     optionsRequestedPolicyVersion = Core.Nothing,
                                     resource = resource, uploadType = Core.Nothing,
                                     uploadProtocol = Core.Nothing}
instance Core.GoogleRequest PubSubProjectsTopicsGetIamPolicy where
        type Rs PubSubProjectsTopicsGetIamPolicy = Policy
        type Scopes PubSubProjectsTopicsGetIamPolicy =
        ...
        requestClient PubSubProjectsTopicsGetIamPolicy{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy PubSubProjectsTopicsGetIamPolicyResource)
                      Core.mempty
