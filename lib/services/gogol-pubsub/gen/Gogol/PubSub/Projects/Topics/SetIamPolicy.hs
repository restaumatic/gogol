...
newPubSubProjectsTopicsSetIamPolicy payload resource
  = PubSubProjectsTopicsSetIamPolicy{xgafv = Core.Nothing,
                                     accessToken = Core.Nothing, callback = Core.Nothing,
                                     payload = payload, resource = resource,
                                     uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest PubSubProjectsTopicsSetIamPolicy where
        type Rs PubSubProjectsTopicsSetIamPolicy = Policy
        type Scopes PubSubProjectsTopicsSetIamPolicy =
        ...
        requestClient PubSubProjectsTopicsSetIamPolicy{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy PubSubProjectsTopicsSetIamPolicyResource)
                      Core.mempty
