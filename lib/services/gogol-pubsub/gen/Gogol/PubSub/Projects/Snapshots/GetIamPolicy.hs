...
-- |
-- Module      : Gogol.PubSub.Projects.Snapshots.GetIamPolicy
...
-- 'PubSubProjectsSnapshotsGetIamPolicy' request conforms to.
type PubSubProjectsSnapshotsGetIamPolicyResource =
     "v1" Core.:>
...
-- | Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
--
-- /See:/ 'newPubSubProjectsSnapshotsGetIamPolicy' smart constructor.
data PubSubProjectsSnapshotsGetIamPolicy = PubSubProjectsSnapshotsGetIamPolicy
    {
      -- | V1 error format.
...
-- | Creates a value of 'PubSubProjectsSnapshotsGetIamPolicy' with the minimum fields required to make a request.
newPubSubProjectsSnapshotsGetIamPolicy 
    :: 
                                       Core.Text
    ...
    -> PubSubProjectsSnapshotsGetIamPolicy
newPubSubProjectsSnapshotsGetIamPolicy resource
  = PubSubProjectsSnapshotsGetIamPolicy{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        optionsRequestedPolicyVersion = Core.Nothing,
                                        resource = resource, uploadType = Core.Nothing,
                                        uploadProtocol = Core.Nothing}
instance Core.GoogleRequest PubSubProjectsSnapshotsGetIamPolicy
         where
        type Rs PubSubProjectsSnapshotsGetIamPolicy = Policy
        type Scopes PubSubProjectsSnapshotsGetIamPolicy =
             '[CloudPlatform'FullControl, Pubsub'FullControl]
        requestClient PubSubProjectsSnapshotsGetIamPolicy{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy PubSubProjectsSnapshotsGetIamPolicyResource)
                      Core.mempty
