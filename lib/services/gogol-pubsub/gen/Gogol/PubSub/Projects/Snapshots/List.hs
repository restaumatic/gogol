...
newPubSubProjectsSnapshotsList project
  = PubSubProjectsSnapshotsList{xgafv = Core.Nothing,
                                accessToken = Core.Nothing, callback = Core.Nothing,
                                pageSize = Core.Nothing, pageToken = Core.Nothing,
                                project = project, uploadType = Core.Nothing,
                                uploadProtocol = Core.Nothing}
instance Core.GoogleRequest PubSubProjectsSnapshotsList where
        type Rs PubSubProjectsSnapshotsList = ListSnapshotsResponse
        ...
        requestClient PubSubProjectsSnapshotsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy PubSubProjectsSnapshotsListResource)
                      Core.mempty
