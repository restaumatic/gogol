...
-- |
-- Module      : Gogol.PubSub.Projects.Snapshots.SetIamPolicy
...
-- 'PubSubProjectsSnapshotsSetIamPolicy' request conforms to.
type PubSubProjectsSnapshotsSetIamPolicyResource =
     "v1" Core.:>
...
-- | Sets the access control policy on the specified resource. Replaces any existing policy. Can return @NOT_FOUND@, @INVALID_ARGUMENT@, and @PERMISSION_DENIED@ errors.
--
-- /See:/ 'newPubSubProjectsSnapshotsSetIamPolicy' smart constructor.
data PubSubProjectsSnapshotsSetIamPolicy = PubSubProjectsSnapshotsSetIamPolicy
    {
      -- | V1 error format.
...
-- | Creates a value of 'PubSubProjectsSnapshotsSetIamPolicy' with the minimum fields required to make a request.
newPubSubProjectsSnapshotsSetIamPolicy 
    :: 
                                       SetIamPolicyRequest
    ...
    -> PubSubProjectsSnapshotsSetIamPolicy
newPubSubProjectsSnapshotsSetIamPolicy payload resource
  = PubSubProjectsSnapshotsSetIamPolicy{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        payload = payload, resource = resource,
                                        uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest PubSubProjectsSnapshotsSetIamPolicy
         where
        type Rs PubSubProjectsSnapshotsSetIamPolicy = Policy
        type Scopes PubSubProjectsSnapshotsSetIamPolicy =
             '[CloudPlatform'FullControl, Pubsub'FullControl]
        requestClient PubSubProjectsSnapshotsSetIamPolicy{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy PubSubProjectsSnapshotsSetIamPolicyResource)
                      Core.mempty
