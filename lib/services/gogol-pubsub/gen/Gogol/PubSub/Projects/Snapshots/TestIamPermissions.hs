...
newPubSubProjectsSnapshotsTestIamPermissions payload resource
  = PubSubProjectsSnapshotsTestIamPermissions{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           PubSubProjectsSnapshotsTestIamPermissions
         where
        type Rs PubSubProjectsSnapshotsTestIamPermissions =
             TestIamPermissionsResponse
        type Scopes PubSubProjectsSnapshotsTestIamPermissions =
             '[CloudPlatform'FullControl, Pubsub'FullControl]
        requestClient PubSubProjectsSnapshotsTestIamPermissions{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy PubSubProjectsSnapshotsTestIamPermissionsResource)
                      Core.mempty
