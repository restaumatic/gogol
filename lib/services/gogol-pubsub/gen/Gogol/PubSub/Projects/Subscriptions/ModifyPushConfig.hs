...
-- |
-- Module      : Gogol.PubSub.Projects.Subscriptions.ModifyPushConfig
...
type PubSubProjectsSubscriptionsModifyPushConfigResource =
     "v1" Core.:>
       Core.CaptureMode "subscription" "modifyPushConfig" Core.Text
         Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] ModifyPushConfigRequest Core.:>
...
newPubSubProjectsSubscriptionsModifyPushConfig payload subscription
  = PubSubProjectsSubscriptionsModifyPushConfig{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           PubSubProjectsSubscriptionsModifyPushConfig
         where
        type Rs PubSubProjectsSubscriptionsModifyPushConfig = Empty
        type Scopes PubSubProjectsSubscriptionsModifyPushConfig =
             '[CloudPlatform'FullControl, Pubsub'FullControl]
        requestClient PubSubProjectsSubscriptionsModifyPushConfig{..}
          = go subscription xgafv accessToken callback uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy PubSubProjectsSubscriptionsModifyPushConfigResource)
                      Core.mempty
