...
type PubSubProjectsSubscriptionsSeekResource =
     "v1" Core.:>
       Core.CaptureMode "subscription" "seek" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] SeekRequest Core.:>
                       Core.Post '[Core.JSON] SeekResponse
...
newPubSubProjectsSubscriptionsSeek payload subscription
  = PubSubProjectsSubscriptionsSeek{xgafv = Core.Nothing,
                                    accessToken = Core.Nothing, callback = Core.Nothing,
                                    payload = payload, subscription = subscription,
                                    uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest PubSubProjectsSubscriptionsSeek where
        type Rs PubSubProjectsSubscriptionsSeek = SeekResponse
        type Scopes PubSubProjectsSubscriptionsSeek =
        ...
        requestClient PubSubProjectsSubscriptionsSeek{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy PubSubProjectsSubscriptionsSeekResource)
                      Core.mempty
