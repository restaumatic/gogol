...
newPubSubProjectsSubscriptionsDelete subscription
  = PubSubProjectsSubscriptionsDelete{xgafv = Core.Nothing,
                                      accessToken = Core.Nothing, callback = Core.Nothing,
                                      subscription = subscription, uploadType = Core.Nothing,
                                      uploadProtocol = Core.Nothing}
instance Core.GoogleRequest PubSubProjectsSubscriptionsDelete where
        type Rs PubSubProjectsSubscriptionsDelete = Empty
        type Scopes PubSubProjectsSubscriptionsDelete =
