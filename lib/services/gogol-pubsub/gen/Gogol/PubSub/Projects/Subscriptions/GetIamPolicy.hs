...
-- |
-- Module      : Gogol.PubSub.Projects.Subscriptions.GetIamPolicy
...
-- 'PubSubProjectsSubscriptionsGetIamPolicy' request conforms to.
type PubSubProjectsSubscriptionsGetIamPolicyResource =
     "v1" Core.:>
...
-- | Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
--
-- /See:/ 'newPubSubProjectsSubscriptionsGetIamPolicy' smart constructor.
data PubSubProjectsSubscriptionsGetIamPolicy = PubSubProjectsSubscriptionsGetIamPolicy
    {
      -- | V1 error format.
...
-- | Creates a value of 'PubSubProjectsSubscriptionsGetIamPolicy' with the minimum fields required to make a request.
newPubSubProjectsSubscriptionsGetIamPolicy 
    :: 
                                           Core.Text
    ...
    -> PubSubProjectsSubscriptionsGetIamPolicy
newPubSubProjectsSubscriptionsGetIamPolicy resource
  = PubSubProjectsSubscriptionsGetIamPolicy{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            optionsRequestedPolicyVersion = Core.Nothing,
                                            resource = resource, uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest PubSubProjectsSubscriptionsGetIamPolicy
         where
        type Rs PubSubProjectsSubscriptionsGetIamPolicy = Policy
        type Scopes PubSubProjectsSubscriptionsGetIamPolicy =
             '[CloudPlatform'FullControl, Pubsub'FullControl]
        requestClient PubSubProjectsSubscriptionsGetIamPolicy{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy PubSubProjectsSubscriptionsGetIamPolicyResource)
                      Core.mempty
