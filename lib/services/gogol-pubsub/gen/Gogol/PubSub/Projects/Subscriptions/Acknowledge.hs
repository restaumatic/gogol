...
type PubSubProjectsSubscriptionsAcknowledgeResource =
     "v1" Core.:>
       Core.CaptureMode "subscription" "acknowledge" Core.Text Core.:>
...
newPubSubProjectsSubscriptionsAcknowledge payload subscription
  = PubSubProjectsSubscriptionsAcknowledge{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           payload = payload, subscription = subscription,
                                           uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest PubSubProjectsSubscriptionsAcknowledge
         where
