...
type PubSubProjectsSubscriptionsModifyAckDeadlineResource =
     "v1" Core.:>
       Core.CaptureMode "subscription" "modifyAckDeadline" Core.Text
         Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] ModifyAckDeadlineRequest Core.:>
...
newPubSubProjectsSubscriptionsModifyAckDeadline 
    ...
    -> PubSubProjectsSubscriptionsModifyAckDeadline
newPubSubProjectsSubscriptionsModifyAckDeadline payload
  subscription
  = PubSubProjectsSubscriptionsModifyAckDeadline{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes PubSubProjectsSubscriptionsModifyAckDeadline =
