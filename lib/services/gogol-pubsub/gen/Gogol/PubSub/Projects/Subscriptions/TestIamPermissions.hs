...
-- |
-- Module      : Gogol.PubSub.Projects.Subscriptions.TestIamPermissions
...
-- 'PubSubProjectsSubscriptionsTestIamPermissions' request conforms to.
type PubSubProjectsSubscriptionsTestIamPermissionsResource =
     "v1" Core.:>
...
-- | Returns permissions that a caller has on the specified resource. If the resource does not exist, this will return an empty set of permissions, not a @NOT_FOUND@ error. Note: This operation is designed to be used for building permission-aware UIs and command-line tools, not for authorization checking. This operation may \"fail open\" without warning.
--
-- /See:/ 'newPubSubProjectsSubscriptionsTestIamPermissions' smart constructor.
data PubSubProjectsSubscriptionsTestIamPermissions = PubSubProjectsSubscriptionsTestIamPermissions
    {
      -- | V1 error format.
...
-- | Creates a value of 'PubSubProjectsSubscriptionsTestIamPermissions' with the minimum fields required to make a request.
newPubSubProjectsSubscriptionsTestIamPermissions 
    :: 
    ...
    -> PubSubProjectsSubscriptionsTestIamPermissions
newPubSubProjectsSubscriptionsTestIamPermissions payload resource
  = PubSubProjectsSubscriptionsTestIamPermissions{xgafv =
                                                    Core.Nothing,
...
instance Core.GoogleRequest
           PubSubProjectsSubscriptionsTestIamPermissions
         where
        type Rs PubSubProjectsSubscriptionsTestIamPermissions =
             TestIamPermissionsResponse
        type Scopes PubSubProjectsSubscriptionsTestIamPermissions =
             '[CloudPlatform'FullControl, Pubsub'FullControl]
        requestClient PubSubProjectsSubscriptionsTestIamPermissions{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy PubSubProjectsSubscriptionsTestIamPermissionsResource)
                      Core.mempty
