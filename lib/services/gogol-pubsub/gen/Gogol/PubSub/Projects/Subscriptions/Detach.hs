...
type PubSubProjectsSubscriptionsDetachResource =
     "v1" Core.:>
       Core.CaptureMode "subscription" "detach" Core.Text Core.:>
...
newPubSubProjectsSubscriptionsDetach subscription
  = PubSubProjectsSubscriptionsDetach{xgafv = Core.Nothing,
                                      accessToken = Core.Nothing, callback = Core.Nothing,
                                      subscription = subscription, uploadType = Core.Nothing,
                                      uploadProtocol = Core.Nothing}
instance Core.GoogleRequest PubSubProjectsSubscriptionsDetach where
