...
newPubSubProjectsSubscriptionsSetIamPolicy payload resource
  = PubSubProjectsSubscriptionsSetIamPolicy{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            payload = payload, resource = resource,
                                            uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest PubSubProjectsSubscriptionsSetIamPolicy
         where
        type Rs PubSubProjectsSubscriptionsSetIamPolicy = Policy
        type Scopes PubSubProjectsSubscriptionsSetIamPolicy =
             '[CloudPlatform'FullControl, Pubsub'FullControl]
        requestClient PubSubProjectsSubscriptionsSetIamPolicy{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy PubSubProjectsSubscriptionsSetIamPolicyResource)
                      Core.mempty
