...
type PubSubProjectsSubscriptionsPullResource =
     "v1" Core.:>
       Core.CaptureMode "subscription" "pull" Core.Text Core.:>
...
newPubSubProjectsSubscriptionsPull payload subscription
  = PubSubProjectsSubscriptionsPull{xgafv = Core.Nothing,
                                    accessToken = Core.Nothing, callback = Core.Nothing,
                                    payload = payload, subscription = subscription,
                                    uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest PubSubProjectsSubscriptionsPull where
        type Rs PubSubProjectsSubscriptionsPull = PullResponse
        ...
        requestClient PubSubProjectsSubscriptionsPull{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy PubSubProjectsSubscriptionsPullResource)
                      Core.mempty
