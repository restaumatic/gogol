               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] UpdateSubscriptionRequest Core.:>
...
newPubSubProjectsSubscriptionsPatch name payload
  = PubSubProjectsSubscriptionsPatch{xgafv = Core.Nothing,
                                     accessToken = Core.Nothing, callback = Core.Nothing,
                                     name = name, payload = payload, uploadType = Core.Nothing,
                                     uploadProtocol = Core.Nothing}
instance Core.GoogleRequest PubSubProjectsSubscriptionsPatch where
        type Rs PubSubProjectsSubscriptionsPatch = Subscription
        type Scopes PubSubProjectsSubscriptionsPatch =
        ...
        requestClient PubSubProjectsSubscriptionsPatch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy PubSubProjectsSubscriptionsPatchResource)
                      Core.mempty
