...
newAnalyticsHubSubscriptionInfo 
    ::  AnalyticsHubSubscriptionInfo
newAnalyticsHubSubscriptionInfo
  = AnalyticsHubSubscriptionInfo{listing = Core.Nothing,
                                 subscription = Core.Nothing}
instance Core.FromJSON AnalyticsHubSubscriptionInfo where
        parseJSON
          = Core.withObject "AnalyticsHubSubscriptionInfo"
              (\ o ->
                 AnalyticsHubSubscriptionInfo Core.<$>
                   (o Core..:? "listing") Core.<*> (o Core..:? "subscription"))
...
newAvroConfig 
    ::  AvroConfig
newAvroConfig
  = AvroConfig{useTopicSchema = Core.Nothing,
...
instance Core.FromJSON AvroConfig where
        parseJSON
          = Core.withObject "AvroConfig"
              (\ o ->
                 AvroConfig Core.<$>
                   (o Core..:? "useTopicSchema") Core.<*>
                     (o Core..:? "writeMetadata"))
...
newAwsKinesis 
    ::  AwsKinesis
newAwsKinesis
  = AwsKinesis{awsRoleArn = Core.Nothing, consumerArn = Core.Nothing,
               gcpServiceAccount = Core.Nothing, state = Core.Nothing,
               streamArn = Core.Nothing}
instance Core.FromJSON AwsKinesis where
        parseJSON
          = Core.withObject "AwsKinesis"
              (\ o ->
                 AwsKinesis Core.<$>
                   (o Core..:? "awsRoleArn") Core.<*> (o Core..:? "consumerArn")
...
newAwsMsk 
    ::  AwsMsk
newAwsMsk
  = AwsMsk{awsRoleArn = Core.Nothing, clusterArn = Core.Nothing,
           gcpServiceAccount = Core.Nothing, state = Core.Nothing,
           topic = Core.Nothing}
instance Core.FromJSON AwsMsk where
        parseJSON
          = Core.withObject "AwsMsk"
              (\ o ->
                 AwsMsk Core.<$>
                   (o Core..:? "awsRoleArn") Core.<*> (o Core..:? "clusterArn")
                     Core.<*> (o Core..:? "gcpServiceAccount")
                     Core.<*> (o Core..:? "state")
                     Core.<*> (o Core..:? "topic"))
...
newAzureEventHubs 
    ::  AzureEventHubs
newAzureEventHubs
  = AzureEventHubs{clientId = Core.Nothing, eventHub = Core.Nothing,
                   gcpServiceAccount = Core.Nothing, namespace = Core.Nothing,
                   resourceGroup = Core.Nothing, state = Core.Nothing,
                   subscriptionId = Core.Nothing, tenantId = Core.Nothing}
instance Core.FromJSON AzureEventHubs where
        parseJSON
          = Core.withObject "AzureEventHubs"
              (\ o ->
                 AzureEventHubs Core.<$>
                   (o Core..:? "clientId") Core.<*> (o Core..:? "eventHub") Core.<*>
                     (o Core..:? "gcpServiceAccount")
...
newBigQueryConfig 
    ::  BigQueryConfig
newBigQueryConfig
  = BigQueryConfig{dropUnknownFields = Core.Nothing,
                   serviceAccountEmail = Core.Nothing, state = Core.Nothing,
                   table = Core.Nothing, useTableSchema = Core.Nothing,
                   useTopicSchema = Core.Nothing, writeMetadata = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("dropUnknownFields" Core..=) Core.<$> dropUnknownFields,
                  ...
                  ("state" Core..=) Core.<$> state, ("table" Core..=) Core.<$> table,
...
newCloudStorage 
    ::  CloudStorage
newCloudStorage
  = CloudStorage{avroFormat = Core.Nothing, bucket = Core.Nothing,
                 matchGlob = Core.Nothing, minimumObjectCreateTime = Core.Nothing,
                 pubsubAvroFormat = Core.Nothing, state = Core.Nothing,
                 textFormat = Core.Nothing}
instance Core.FromJSON CloudStorage where
        parseJSON
          = Core.withObject "CloudStorage"
              (\ o ->
                 CloudStorage Core.<$>
                   (o Core..:? "avroFormat") Core.<*> (o Core..:? "bucket") Core.<*>
                     (o Core..:? "matchGlob")
          ...
          = Core.object
              (Core.catMaybes
                 [("avroFormat" Core..=) Core.<$> avroFormat,
                  ...
                  ("minimumObjectCreateTime" Core..=) Core.<$>
...
newCloudStorageConfig 
    ::  CloudStorageConfig
newCloudStorageConfig
  = CloudStorageConfig{avroConfig = Core.Nothing,
                       bucket = Core.Nothing, filenameDatetimeFormat = Core.Nothing,
                       filenamePrefix = Core.Nothing, filenameSuffix = Core.Nothing,
                       maxBytes = Core.Nothing, maxDuration = Core.Nothing,
                       maxMessages = Core.Nothing, serviceAccountEmail = Core.Nothing,
                       state = Core.Nothing, textConfig = Core.Nothing}
instance Core.FromJSON CloudStorageConfig where
        parseJSON
          = Core.withObject "CloudStorageConfig"
              (\ o ->
                 CloudStorageConfig Core.<$>
                   (o Core..:? "avroConfig") Core.<*> (o Core..:? "bucket") Core.<*>
                     (o Core..:? "filenameDatetimeFormat")
                     ...
                     Core.<*>
                     (o Core..:? "maxMessages" Core.<&> Core.fmap Core.fromAsText)
...
newConfluentCloud 
    ::  ConfluentCloud
newConfluentCloud
  = ConfluentCloud{bootstrapServer = Core.Nothing,
                   clusterId = Core.Nothing, gcpServiceAccount = Core.Nothing,
                   identityPoolId = Core.Nothing, state = Core.Nothing,
                   topic = Core.Nothing}
instance Core.FromJSON ConfluentCloud where
        parseJSON
          = Core.withObject "ConfluentCloud"
              (\ o ->
                 ConfluentCloud Core.<$>
                   (o Core..:? "bootstrapServer") Core.<*> (o Core..:? "clusterId")
                     Core.<*> (o Core..:? "gcpServiceAccount")
...
newCreateSnapshotRequest 
    ::  CreateSnapshotRequest
newCreateSnapshotRequest
  = CreateSnapshotRequest{labels = Core.Nothing,
                          subscription = Core.Nothing}
          ...
          = Core.withObject "CreateSnapshotRequest"
              (\ o ->
                 CreateSnapshotRequest Core.<$>
                   (o Core..:? "labels") Core.<*> (o Core..:? "subscription"))
...
newDeadLetterPolicy 
    ::  DeadLetterPolicy
newDeadLetterPolicy
  = DeadLetterPolicy{deadLetterTopic = Core.Nothing,
...
newIngestionDataSourceSettings 
    ::  IngestionDataSourceSettings
newIngestionDataSourceSettings
  = IngestionDataSourceSettings{awsKinesis = Core.Nothing,
                                awsMsk = Core.Nothing, azureEventHubs = Core.Nothing,
                                cloudStorage = Core.Nothing, confluentCloud = Core.Nothing,
                                platformLogsSettings = Core.Nothing}
instance Core.FromJSON IngestionDataSourceSettings where
        parseJSON
          = Core.withObject "IngestionDataSourceSettings"
              (\ o ->
                 IngestionDataSourceSettings Core.<$>
                   (o Core..:? "awsKinesis") Core.<*> (o Core..:? "awsMsk") Core.<*>
                     (o Core..:? "azureEventHubs")
...
instance Core.FromJSON JavaScriptUDF where
        parseJSON
          = Core.withObject "JavaScriptUDF"
              (\ o ->
                 JavaScriptUDF Core.<$>
                   (o Core..:? "code") Core.<*> (o Core..:? "functionName"))
...
newListSchemaRevisionsResponse 
    ::  ListSchemaRevisionsResponse
newListSchemaRevisionsResponse
  = ListSchemaRevisionsResponse{nextPageToken = Core.Nothing,
          ...
          = Core.withObject "ListSchemaRevisionsResponse"
              (\ o ->
                 ListSchemaRevisionsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "schemas"))
...
newListSchemasResponse 
    ::  ListSchemasResponse
newListSchemasResponse
  = ListSchemasResponse{nextPageToken = Core.Nothing,
                        schemas = Core.Nothing}
...
newListTopicSnapshotsResponse 
    ::  ListTopicSnapshotsResponse
newListTopicSnapshotsResponse
  = ListTopicSnapshotsResponse{nextPageToken = Core.Nothing,
                               snapshots = Core.Nothing}
...
newListTopicSubscriptionsResponse 
    ::  ListTopicSubscriptionsResponse
newListTopicSubscriptionsResponse
  = ListTopicSubscriptionsResponse{nextPageToken = Core.Nothing,
                                   subscriptions = Core.Nothing}
...
newListTopicsResponse 
    ::  ListTopicsResponse
newListTopicsResponse
  = ListTopicsResponse{nextPageToken = Core.Nothing,
                       topics = Core.Nothing}
          ...
          = Core.withObject "ListTopicsResponse"
              (\ o ->
                 ListTopicsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "topics"))
          ...
          = Core.withObject "MessageStoragePolicy"
              (\ o ->
                 MessageStoragePolicy Core.<$>
                   (o Core..:? "allowedPersistenceRegions") Core.<*>
                     (o Core..:? "enforceInTransit"))
...
newMessageTransform 
    ::  MessageTransform
newMessageTransform
  = MessageTransform{disabled = Core.Nothing, enabled = Core.Nothing,
                     javascriptUdf = Core.Nothing}
instance Core.FromJSON MessageTransform where
        parseJSON
          = Core.withObject "MessageTransform"
              (\ o ->
                 MessageTransform Core.<$>
                   (o Core..:? "disabled") Core.<*> (o Core..:? "enabled") Core.<*>
                     (o Core..:? "javascriptUdf"))
...
newModifyAckDeadlineRequest 
    ::  ModifyAckDeadlineRequest
newModifyAckDeadlineRequest
  = ModifyAckDeadlineRequest{ackDeadlineSeconds = Core.Nothing,
                             ackIds = Core.Nothing}
          ...
          = Core.withObject "ModifyAckDeadlineRequest"
              (\ o ->
                 ModifyAckDeadlineRequest Core.<$>
                   (o Core..:? "ackDeadlineSeconds") Core.<*> (o Core..:? "ackIds"))
...
instance Core.FromJSON PlatformLogsSettings where
        parseJSON
          = Core.withObject "PlatformLogsSettings"
...
instance Core.FromJSON PubSubAvroFormat where
        parseJSON
          = Core.withObject "PubSubAvroFormat"
...
newPullRequest 
    ::  PullRequest
newPullRequest
  = PullRequest{maxMessages = Core.Nothing,
...
newPushConfig 
    ::  PushConfig
newPushConfig
  = PushConfig{attributes = Core.Nothing, noWrapper = Core.Nothing,
               oidcToken = Core.Nothing, pubsubWrapper = Core.Nothing,
...
instance Core.FromJSON PushConfig where
        parseJSON
          = Core.withObject "PushConfig"
              (\ o ->
                 PushConfig Core.<$>
                   (o Core..:? "attributes") Core.<*> (o Core..:? "noWrapper")
...
newReceivedMessage 
    ::  ReceivedMessage
newReceivedMessage
  = ReceivedMessage{ackId = Core.Nothing,
                    deliveryAttempt = Core.Nothing, message = Core.Nothing}
instance Core.FromJSON ReceivedMessage where
        parseJSON
          = Core.withObject "ReceivedMessage"
              (\ o ->
                 ReceivedMessage Core.<$>
                   (o Core..:? "ackId") Core.<*> (o Core..:? "deliveryAttempt")
                     Core.<*> (o Core..:? "message"))
...
newRetryPolicy 
    ::  RetryPolicy
newRetryPolicy
  = RetryPolicy{maximumBackoff = Core.Nothing,
...
newSchema 
    ::  Schema
newSchema
  = Schema{definition = Core.Nothing, name = Core.Nothing,
...
instance Core.FromJSON Schema where
        parseJSON
          = Core.withObject "Schema"
              (\ o ->
                 Schema Core.<$>
                   (o Core..:? "definition") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "revisionCreateTime")
...
newSchemaSettings 
    ::  SchemaSettings
newSchemaSettings
  = SchemaSettings{encoding = Core.Nothing,
                   firstRevisionId = Core.Nothing, lastRevisionId = Core.Nothing,
                   schema = Core.Nothing}
instance Core.FromJSON SchemaSettings where
        parseJSON
          = Core.withObject "SchemaSettings"
              (\ o ->
                 SchemaSettings Core.<$>
                   (o Core..:? "encoding") Core.<*> (o Core..:? "firstRevisionId")
...
newSnapshot 
    ::  Snapshot
newSnapshot
  = Snapshot{expireTime = Core.Nothing, labels = Core.Nothing,
             name = Core.Nothing, topic = Core.Nothing}
instance Core.FromJSON Snapshot where
        parseJSON
          = Core.withObject "Snapshot"
              (\ o ->
                 Snapshot Core.<$>
                   (o Core..:? "expireTime") Core.<*> (o Core..:? "labels") Core.<*>
                     (o Core..:? "name")
                     Core.<*> (o Core..:? "topic"))
...
newSubscription 
    ::  Subscription
newSubscription
  = Subscription{ackDeadlineSeconds = Core.Nothing,
                 analyticsHubSubscriptionInfo = Core.Nothing,
                 bigqueryConfig = Core.Nothing, cloudStorageConfig = Core.Nothing,
                 deadLetterPolicy = Core.Nothing, detached = Core.Nothing,
                 enableExactlyOnceDelivery = Core.Nothing,
                 enableMessageOrdering = Core.Nothing,
                 expirationPolicy = Core.Nothing, filter = Core.Nothing,
                 labels = Core.Nothing, messageRetentionDuration = Core.Nothing,
                 messageTransforms = Core.Nothing, name = Core.Nothing,
                 pushConfig = Core.Nothing, retainAckedMessages = Core.Nothing,
                 retryPolicy = Core.Nothing, state = Core.Nothing,
                 topic = Core.Nothing, topicMessageRetentionDuration = Core.Nothing}
              ...
              (\ o ->
                 Subscription Core.<$>
                   (o Core..:? "ackDeadlineSeconds") Core.<*>
                     (o Core..:? "analyticsHubSubscriptionInfo")
...
instance Core.ToJSON Subscription where
        toJSON Subscription{..}
          = Core.object
              (Core.catMaybes
                 [("ackDeadlineSeconds" Core..=) Core.<$> ackDeadlineSeconds,
                  ("analyticsHubSubscriptionInfo" Core..=) Core.<$>
                    analyticsHubSubscriptionInfo,
                  ...
                  ("state" Core..=) Core.<$> state, ("topic" Core..=) Core.<$> topic,
...
newTopic 
    ::  Topic
newTopic
  = Topic{ingestionDataSourceSettings = Core.Nothing,
          kmsKeyName = Core.Nothing, labels = Core.Nothing,
          messageRetentionDuration = Core.Nothing,
          messageStoragePolicy = Core.Nothing,
          messageTransforms = Core.Nothing, name = Core.Nothing,
          satisfiesPzs = Core.Nothing, schemaSettings = Core.Nothing,
          state = Core.Nothing}
instance Core.FromJSON Topic where
        parseJSON
          = Core.withObject "Topic"
              (\ o ->
                 Topic Core.<$>
                   (o Core..:? "ingestionDataSourceSettings") Core.<*>
                     (o Core..:? "kmsKeyName")
                     Core.<*> (o Core..:? "labels")
                     Core.<*> (o Core..:? "messageRetentionDuration")
...
instance Core.ToJSON Topic where
        toJSON Topic{..}
          = Core.object
              (Core.catMaybes
                 [("ingestionDataSourceSettings" Core..=) Core.<$>
                    ingestionDataSourceSettings,
...
newUpdateSnapshotRequest 
    ::  UpdateSnapshotRequest
newUpdateSnapshotRequest
  = UpdateSnapshotRequest{snapshot = Core.Nothing,
          ...
          = Core.withObject "UpdateSnapshotRequest"
              (\ o ->
                 UpdateSnapshotRequest Core.<$>
                   (o Core..:? "snapshot") Core.<*> (o Core..:? "updateMask"))
...
newUpdateSubscriptionRequest 
    ::  UpdateSubscriptionRequest
newUpdateSubscriptionRequest
  = UpdateSubscriptionRequest{subscription = Core.Nothing,
                              updateMask = Core.Nothing}
          ...
          = Core.withObject "UpdateSubscriptionRequest"
              (\ o ->
                 UpdateSubscriptionRequest Core.<$>
                   (o Core..:? "subscription") Core.<*> (o Core..:? "updateMask"))
...
newUpdateTopicRequest 
    ::  UpdateTopicRequest
newUpdateTopicRequest
  = UpdateTopicRequest{topic = Core.Nothing,
                       updateMask = Core.Nothing}
          ...
          = Core.withObject "UpdateTopicRequest"
              (\ o ->
                 UpdateTopicRequest Core.<$>
                   (o Core..:? "topic") Core.<*> (o Core..:? "updateMask"))
...
newValidateMessageRequest 
    ::  ValidateMessageRequest
newValidateMessageRequest
  = ValidateMessageRequest{encoding = Core.Nothing,
                           message = Core.Nothing, name = Core.Nothing, schema = Core.Nothing}
instance Core.FromJSON ValidateMessageRequest where
        parseJSON
          = Core.withObject "ValidateMessageRequest"
              (\ o ->
                 ValidateMessageRequest Core.<$>
                   (o Core..:? "encoding") Core.<*> (o Core..:? "message") Core.<*>
                     (o Core..:? "name")
                     Core.<*> (o Core..:? "schema"))
