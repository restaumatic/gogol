...
newAutoForwarding 
    ::  AutoForwarding
newAutoForwarding
  = AutoForwarding{disposition = Core.Nothing,
                   emailAddress = Core.Nothing, enabled = Core.Nothing}
instance Core.FromJSON AutoForwarding where
        parseJSON
          = Core.withObject "AutoForwarding"
              (\ o ->
                 AutoForwarding Core.<$>
                   (o Core..:? "disposition") Core.<*> (o Core..:? "emailAddress")
                     Core.<*> (o Core..:? "enabled"))
...
newBatchModifyMessagesRequest 
    ::  BatchModifyMessagesRequest
newBatchModifyMessagesRequest
  = BatchModifyMessagesRequest{addLabelIds = Core.Nothing,
                               ids = Core.Nothing, removeLabelIds = Core.Nothing}
          ...
          = Core.withObject "BatchModifyMessagesRequest"
              (\ o ->
                 BatchModifyMessagesRequest Core.<$>
                   (o Core..:? "addLabelIds") Core.<*> (o Core..:? "ids") Core.<*>
...
newCseIdentity 
    ::  CseIdentity
newCseIdentity
  = CseIdentity{emailAddress = Core.Nothing,
          ...
          = Core.object
              (Core.catMaybes
                 [("emailAddress" Core..=) Core.<$> emailAddress,
                  ...
                  ("signAndEncryptKeyPairs" Core..=) Core.<$>
                    signAndEncryptKeyPairs])


-- | A client-side encryption S\/MIME key pair, which is comprised of a public key, its certificate chain, and metadata for its paired private key. Gmail uses the key pair to complete the following tasks: - Sign outgoing client-side encrypted messages. - Save and reopen drafts of client-side encrypted messages. - Save and reopen sent messages. - Decrypt incoming or archived S\/MIME messages. For administrators managing identities and keypairs for users in their organization, requests require authorization with a <https://developers.google.com/identity/protocols/OAuth2ServiceAccount service account> that has <https://developers.google.com/identity/protocols/OAuth2ServiceAccount#delegatingauthority domain-wide delegation authority> to impersonate users with the @https:\/\/www.googleapis.com\/auth\/gmail.settings.basic@ scope. For users managing their own identities and keypairs, requests require <https://support.google.com/a/answer/14153163 hardware key encryption> turned on and configured.
--
...
newCseKeyPair 
    ::  CseKeyPair
newCseKeyPair
  = CseKeyPair{disableTime = Core.Nothing,
               enablementState = Core.Nothing, keyPairId = Core.Nothing,
               pem = Core.Nothing, pkcs7 = Core.Nothing,
...
instance Core.FromJSON CseKeyPair where
        parseJSON
          = Core.withObject "CseKeyPair"
              (\ o ->
                 CseKeyPair Core.<$>
                   (o Core..:? "disableTime") Core.<*> (o Core..:? "enablementState")
          ...
          = Core.object
              (Core.catMaybes
                 [("disableTime" Core..=) Core.<$> disableTime,
                  ...
                  ("pem" Core..=) Core.<$> pem, ("pkcs7" Core..=) Core.<$> pkcs7,
...
newCsePrivateKeyMetadata 
    ::  CsePrivateKeyMetadata
newCsePrivateKeyMetadata
  = CsePrivateKeyMetadata{hardwareKeyMetadata = Core.Nothing,
          ...
          = Core.withObject "CsePrivateKeyMetadata"
              (\ o ->
                 CsePrivateKeyMetadata Core.<$>
                   (o Core..:? "hardwareKeyMetadata") Core.<*>
                     (o Core..:? "kaclsKeyMetadata")
...
newDelegate 
    ::  Delegate
newDelegate
  = Delegate{delegateEmail = Core.Nothing,
...
newFilter 
    ::  Filter
newFilter
  = Filter{action = Core.Nothing, criteria = Core.Nothing,
           id = Core.Nothing}
instance Core.FromJSON Filter where
        parseJSON
          = Core.withObject "Filter"
              (\ o ->
                 Filter Core.<$>
                   (o Core..:? "action") Core.<*> (o Core..:? "criteria") Core.<*>
                     (o Core..:? "id"))
...
newFilterAction 
    ::  FilterAction
newFilterAction
  = FilterAction{addLabelIds = Core.Nothing, forward = Core.Nothing,
...
instance Core.FromJSON FilterAction where
        parseJSON
          = Core.withObject "FilterAction"
              (\ o ->
                 FilterAction Core.<$>
                   (o Core..:? "addLabelIds") Core.<*> (o Core..:? "forward") Core.<*>
                     (o Core..:? "removeLabelIds"))
...
newFilterCriteria 
    ::  FilterCriteria
newFilterCriteria
  = FilterCriteria{excludeChats = Core.Nothing, from = Core.Nothing,
                   hasAttachment = Core.Nothing, negatedQuery = Core.Nothing,
                   query = Core.Nothing, size = Core.Nothing,
                   sizeComparison = Core.Nothing, subject = Core.Nothing,
                   to = Core.Nothing}
instance Core.FromJSON FilterCriteria where
        parseJSON
          = Core.withObject "FilterCriteria"
              (\ o ->
                 FilterCriteria Core.<$>
                   (o Core..:? "excludeChats") Core.<*> (o Core..:? "from") Core.<*>
                     (o Core..:? "hasAttachment")
          ...
          = Core.object
              (Core.catMaybes
                 [("excludeChats" Core..=) Core.<$> excludeChats,
                  ...
                  ("query" Core..=) Core.<$> query, ("size" Core..=) Core.<$> size,
                  ("sizeComparison" Core..=) Core.<$> sizeComparison,
                  ("subject" Core..=) Core.<$> subject, ("to" Core..=) Core.<$> to])
...
newForwardingAddress 
    ::  ForwardingAddress
newForwardingAddress
  = ForwardingAddress{forwardingEmail = Core.Nothing,
                      verificationStatus = Core.Nothing}
...
-- | Metadata for hardware keys. If <https://support.google.com/a/answer/14153163 hardware key encryption> is set up for the Google Workspace organization, users can optionally store their private key on their smart card and use it to sign and decrypt email messages in Gmail by inserting their smart card into a reader attached to their Windows device.
--
...
instance Core.FromJSON HardwareKeyMetadata where
        parseJSON
          = Core.withObject "HardwareKeyMetadata"
...
newHistory 
    ::  History
newHistory
  = History{id = Core.Nothing, labelsAdded = Core.Nothing,
            labelsRemoved = Core.Nothing, messages = Core.Nothing,
            messagesAdded = Core.Nothing, messagesDeleted = Core.Nothing}
...
newHistoryLabelAdded 
    ::  HistoryLabelAdded
newHistoryLabelAdded
  = HistoryLabelAdded{labelIds = Core.Nothing,
          ...
          = Core.withObject "HistoryLabelAdded"
              (\ o ->
                 HistoryLabelAdded Core.<$>
                   (o Core..:? "labelIds") Core.<*> (o Core..:? "message"))
...
newHistoryLabelRemoved 
    ::  HistoryLabelRemoved
newHistoryLabelRemoved
  = HistoryLabelRemoved{labelIds = Core.Nothing,
                        message = Core.Nothing}
...
newImapSettings 
    ::  ImapSettings
newImapSettings
  = ImapSettings{autoExpunge = Core.Nothing, enabled = Core.Nothing,
                 expungeBehavior = Core.Nothing, maxFolderSize = Core.Nothing}
instance Core.FromJSON ImapSettings where
        parseJSON
          = Core.withObject "ImapSettings"
              (\ o ->
                 ImapSettings Core.<$>
                   (o Core..:? "autoExpunge") Core.<*> (o Core..:? "enabled") Core.<*>
                     (o Core..:? "expungeBehavior")
...
newKaclsKeyMetadata 
    ::  KaclsKeyMetadata
newKaclsKeyMetadata
  = KaclsKeyMetadata{kaclsData = Core.Nothing,
          ...
          = Core.withObject "KaclsKeyMetadata"
              (\ o ->
                 KaclsKeyMetadata Core.<$>
                   (o Core..:? "kaclsData") Core.<*> (o Core..:? "kaclsUri"))
...
newLabel 
    ::  Label
newLabel
  = Label{color = Core.Nothing, id = Core.Nothing,
          labelListVisibility = Core.Nothing,
          messageListVisibility = Core.Nothing, messagesTotal = Core.Nothing,
          messagesUnread = Core.Nothing, name = Core.Nothing,
          threadsTotal = Core.Nothing, threadsUnread = Core.Nothing,
          type' = Core.Nothing}
instance Core.FromJSON Label where
        parseJSON
          = Core.withObject "Label"
              (\ o ->
                 Label Core.<$>
                   (o Core..:? "color") Core.<*> (o Core..:? "id") Core.<*>
                     (o Core..:? "labelListVisibility")
...
instance Core.ToJSON Label where
        toJSON Label{..}
          = Core.object
              (Core.catMaybes
                 [("color" Core..=) Core.<$> color, ("id" Core..=) Core.<$> id,
...
newLabelColor 
    ::  LabelColor
newLabelColor
  = LabelColor{backgroundColor = Core.Nothing,
...
instance Core.FromJSON LabelColor where
        parseJSON
          = Core.withObject "LabelColor"
              (\ o ->
                 LabelColor Core.<$>
                   (o Core..:? "backgroundColor") Core.<*> (o Core..:? "textColor"))
...
newListCseIdentitiesResponse 
    ::  ListCseIdentitiesResponse
newListCseIdentitiesResponse
  = ListCseIdentitiesResponse{cseIdentities = Core.Nothing,
          ...
          = Core.withObject "ListCseIdentitiesResponse"
              (\ o ->
                 ListCseIdentitiesResponse Core.<$>
                   (o Core..:? "cseIdentities") Core.<*> (o Core..:? "nextPageToken"))
...
newListCseKeyPairsResponse 
    ::  ListCseKeyPairsResponse
newListCseKeyPairsResponse
  = ListCseKeyPairsResponse{cseKeyPairs = Core.Nothing,
                            nextPageToken = Core.Nothing}
          ...
          = Core.withObject "ListCseKeyPairsResponse"
              (\ o ->
                 ListCseKeyPairsResponse Core.<$>
                   (o Core..:? "cseKeyPairs") Core.<*> (o Core..:? "nextPageToken"))
...
data ListDraftsResponse = ListDraftsResponse
    {
      -- | List of drafts. Note that the @Message@ property in each @Draft@ resource only contains an @id@ and a @threadId@. The <https://developers.google.com/workspace/gmail/api/v1/reference/users/messages/get messages.get> method can fetch additional message details.
...
newListDraftsResponse 
    ::  ListDraftsResponse
newListDraftsResponse
  = ListDraftsResponse{drafts = Core.Nothing,
                       nextPageToken = Core.Nothing, resultSizeEstimate = Core.Nothing}
instance Core.FromJSON ListDraftsResponse where
        parseJSON
          = Core.withObject "ListDraftsResponse"
              (\ o ->
                 ListDraftsResponse Core.<$>
                   (o Core..:? "drafts") Core.<*> (o Core..:? "nextPageToken")
...
newListForwardingAddressesResponse 
    :: 
                                   ListForwardingAddressesResponse
newListForwardingAddressesResponse
  = ListForwardingAddressesResponse{forwardingAddresses =
                                      Core.Nothing}
...
newListHistoryResponse 
    ::  ListHistoryResponse
newListHistoryResponse
  = ListHistoryResponse{history = Core.Nothing,
                        historyId = Core.Nothing, nextPageToken = Core.Nothing}
          ...
          = Core.withObject "ListHistoryResponse"
              (\ o ->
                 ListHistoryResponse Core.<$>
                   (o Core..:? "history") Core.<*>
                     (o Core..:? "historyId" Core.<&> Core.fmap Core.fromAsText)
...
newtype ListLabelsResponse = ListLabelsResponse
    {
      -- | List of labels. Note that each label resource only contains an @id@, @name@, @messageListVisibility@, @labelListVisibility@, and @type@. The <https://developers.google.com/workspace/gmail/api/v1/reference/users/labels/get labels.get> method can fetch additional label details.
...
data ListThreadsResponse = ListThreadsResponse
    {
      ...
      -- | Estimated total number of results.
    , resultSizeEstimate :: (Core.Maybe Core.Word32)
      -- | List of threads. Note that each thread resource does not contain a list of @messages@. The list of @messages@ for a given thread can be fetched using the <https://developers.google.com/workspace/gmail/api/v1/reference/users/threads/get threads.get> method.
...
newListThreadsResponse 
    ::  ListThreadsResponse
newListThreadsResponse
  = ListThreadsResponse{nextPageToken = Core.Nothing,
                        resultSizeEstimate = Core.Nothing, threads = Core.Nothing}
...
newMessage 
    ::  Message
newMessage
  = Message{historyId = Core.Nothing, id = Core.Nothing,
            internalDate = Core.Nothing, labelIds = Core.Nothing,
            payload = Core.Nothing, raw = Core.Nothing,
            sizeEstimate = Core.Nothing, snippet = Core.Nothing,
              ...
              (\ o ->
                 Message Core.<$>
                   (o Core..:? "historyId" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "internalDate" Core.<&> Core.fmap Core.fromAsText)
          ...
          = Core.object
              (Core.catMaybes
                 [("historyId" Core..=) Core.. Core.AsText Core.<$> historyId,
                  ...
                  ("labelIds" Core..=) Core.<$> labelIds,
                  ("payload" Core..=) Core.<$> payload, ("raw" Core..=) Core.<$> raw,
...
newMessagePart 
    ::  MessagePart
newMessagePart
  = MessagePart{body = Core.Nothing, filename = Core.Nothing,
                headers = Core.Nothing, mimeType = Core.Nothing,
                partId = Core.Nothing, parts = Core.Nothing}
instance Core.FromJSON MessagePart where
        parseJSON
          = Core.withObject "MessagePart"
              (\ o ->
                 MessagePart Core.<$>
                   (o Core..:? "body") Core.<*> (o Core..:? "filename") Core.<*>
                     (o Core..:? "headers")
...
newMessagePartBody 
    ::  MessagePartBody
newMessagePartBody
  = MessagePartBody{attachmentId = Core.Nothing,
                    data' = Core.Nothing, size = Core.Nothing}
instance Core.FromJSON MessagePartBody where
        parseJSON
          = Core.withObject "MessagePartBody"
              (\ o ->
                 MessagePartBody Core.<$>
                   (o Core..:? "attachmentId") Core.<*> (o Core..:? "data") Core.<*>
                     (o Core..:? "size"))
          ...
          = Core.object
              (Core.catMaybes
                 [("attachmentId" Core..=) Core.<$> attachmentId,
                  ("data" Core..=) Core.<$> data', ("size" Core..=) Core.<$> size])
...
newModifyMessageRequest 
    ::  ModifyMessageRequest
newModifyMessageRequest
  = ModifyMessageRequest{addLabelIds = Core.Nothing,
                         removeLabelIds = Core.Nothing}
          ...
          = Core.withObject "ModifyMessageRequest"
              (\ o ->
                 ModifyMessageRequest Core.<$>
                   (o Core..:? "addLabelIds") Core.<*> (o Core..:? "removeLabelIds"))
...
newModifyThreadRequest 
    ::  ModifyThreadRequest
newModifyThreadRequest
  = ModifyThreadRequest{addLabelIds = Core.Nothing,
                        removeLabelIds = Core.Nothing}
...
newPopSettings 
    ::  PopSettings
newPopSettings
  = PopSettings{accessWindow = Core.Nothing,
...
instance Core.FromJSON PopSettings where
        parseJSON
          = Core.withObject "PopSettings"
              (\ o ->
                 PopSettings Core.<$>
                   (o Core..:? "accessWindow") Core.<*> (o Core..:? "disposition"))
...
newProfile 
    ::  Profile
newProfile
  = Profile{emailAddress = Core.Nothing, historyId = Core.Nothing,
            messagesTotal = Core.Nothing, threadsTotal = Core.Nothing}
...
newSendAs 
    ::  SendAs
newSendAs
  = SendAs{displayName = Core.Nothing, isDefault = Core.Nothing,
           isPrimary = Core.Nothing, replyToAddress = Core.Nothing,
           sendAsEmail = Core.Nothing, signature = Core.Nothing,
           smtpMsa = Core.Nothing, treatAsAlias = Core.Nothing,
           verificationStatus = Core.Nothing}
instance Core.FromJSON SendAs where
        parseJSON
          = Core.withObject "SendAs"
              (\ o ->
                 SendAs Core.<$>
                   (o Core..:? "displayName") Core.<*> (o Core..:? "isDefault")
...
newSignAndEncryptKeyPairs 
    ::  SignAndEncryptKeyPairs
newSignAndEncryptKeyPairs
  = SignAndEncryptKeyPairs{encryptionKeyPairId = Core.Nothing,
                           signingKeyPairId = Core.Nothing}
instance Core.FromJSON SignAndEncryptKeyPairs where
        parseJSON
          = Core.withObject "SignAndEncryptKeyPairs"
              (\ o ->
                 SignAndEncryptKeyPairs Core.<$>
                   (o Core..:? "encryptionKeyPairId") Core.<*>
                     (o Core..:? "signingKeyPairId"))
...
newSmimeInfo 
    ::  SmimeInfo
newSmimeInfo
  = SmimeInfo{encryptedKeyPassword = Core.Nothing,
              expiration = Core.Nothing, id = Core.Nothing,
              isDefault = Core.Nothing, issuerCn = Core.Nothing,
              pem = Core.Nothing, pkcs12 = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("encryptedKeyPassword" Core..=) Core.<$> encryptedKeyPassword,
                  ...
                  ("pem" Core..=) Core.<$> pem, ("pkcs12" Core..=) Core.<$> pkcs12])
...
newSmtpMsa 
    ::  SmtpMsa
newSmtpMsa
  = SmtpMsa{host = Core.Nothing, password = Core.Nothing,
            port = Core.Nothing, securityMode = Core.Nothing,
...
instance Core.FromJSON SmtpMsa where
        parseJSON
          = Core.withObject "SmtpMsa"
              (\ o ->
                 SmtpMsa Core.<$>
                   (o Core..:? "host") Core.<*> (o Core..:? "password") Core.<*>
                     (o Core..:? "port")
...
newThread 
    ::  Thread
newThread
  = Thread{historyId = Core.Nothing, id = Core.Nothing,
           messages = Core.Nothing, snippet = Core.Nothing}
...
instance Core.ToJSON Thread where
        toJSON Thread{..}
          = Core.object
              (Core.catMaybes
                 [("historyId" Core..=) Core.. Core.AsText Core.<$> historyId,
                  ("id" Core..=) Core.<$> id, ("messages" Core..=) Core.<$> messages,
                  ("snippet" Core..=) Core.<$> snippet])
...
newVacationSettings 
    ::  VacationSettings
newVacationSettings
  = VacationSettings{enableAutoReply = Core.Nothing,
                     endTime = Core.Nothing, responseBodyHtml = Core.Nothing,
                     responseBodyPlainText = Core.Nothing,
                     responseSubject = Core.Nothing, restrictToContacts = Core.Nothing,
                     restrictToDomain = Core.Nothing, startTime = Core.Nothing}
              ...
              (\ o ->
                 VacationSettings Core.<$>
                   (o Core..:? "enableAutoReply") Core.<*>
                     (o Core..:? "endTime" Core.<&> Core.fmap Core.fromAsText)
...
newWatchRequest 
    ::  WatchRequest
newWatchRequest
  = WatchRequest{labelFilterAction = Core.Nothing,
                 labelFilterBehavior = Core.Nothing, labelIds = Core.Nothing,
...
newWatchResponse 
    ::  WatchResponse
newWatchResponse
  = WatchResponse{expiration = Core.Nothing,
