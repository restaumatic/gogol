...
--
-- /See:/ <https://developers.google.com/workspace/gmail/api/ Gmail API Reference> for @gmail.users.getProfile@.
module Gogol.Gmail.Users.GetProfile
    (
    -- * Resource
...
newGmailUsersGetProfile 
    ::  GmailUsersGetProfile
newGmailUsersGetProfile
  = GmailUsersGetProfile{xgafv = Core.Nothing,
...
instance Core.GoogleRequest GmailUsersGetProfile where
        ...
        type Scopes GmailUsersGetProfile =
             '[Gmail'FullControl, Gmail'Compose, Gmail'Metadata, Gmail'Modify,
               Gmail'Readonly]
        requestClient GmailUsersGetProfile{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy GmailUsersGetProfileResource)
                      Core.mempty
