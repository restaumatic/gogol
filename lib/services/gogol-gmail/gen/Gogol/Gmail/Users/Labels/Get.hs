...
--
-- /See:/ <https://developers.google.com/workspace/gmail/api/ Gmail API Reference> for @gmail.users.labels.get@.
module Gogol.Gmail.Users.Labels.Get
    (
    -- * Resource
...
newGmailUsersLabelsGet id
  = GmailUsersLabelsGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest GmailUsersLabelsGet where
        ...
        type Scopes GmailUsersLabelsGet =
             '[Gmail'FullControl, Gmail'Labels, Gmail'Metadata, Gmail'Modify,
               Gmail'Readonly]
        requestClient GmailUsersLabelsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy GmailUsersLabelsGetResource)
                      Core.mempty
