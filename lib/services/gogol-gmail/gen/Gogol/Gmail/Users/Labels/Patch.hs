...
--
-- /See:/ <https://developers.google.com/workspace/gmail/api/ Gmail API Reference> for @gmail.users.labels.patch@.
module Gogol.Gmail.Users.Labels.Patch
    (
    -- * Resource
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] Label Core.:>
                               Core.Patch '[Core.JSON] Label
...
newGmailUsersLabelsPatch id payload
  = GmailUsersLabelsPatch{xgafv = Core.Nothing,
...
instance Core.GoogleRequest GmailUsersLabelsPatch where
        ...
        type Scopes GmailUsersLabelsPatch =
