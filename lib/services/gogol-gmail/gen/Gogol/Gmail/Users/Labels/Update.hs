...
--
-- /See:/ <https://developers.google.com/workspace/gmail/api/ Gmail API Reference> for @gmail.users.labels.update@.
module Gogol.Gmail.Users.Labels.Update
    (
    -- * Resource
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] Label Core.:> Core.Put '[Core.JSON] Label
...
newGmailUsersLabelsUpdate id payload
  = GmailUsersLabelsUpdate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest GmailUsersLabelsUpdate where
        ...
        type Scopes GmailUsersLabelsUpdate =
