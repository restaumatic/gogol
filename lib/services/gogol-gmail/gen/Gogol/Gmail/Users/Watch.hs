...
--
-- /See:/ <https://developers.google.com/workspace/gmail/api/ Gmail API Reference> for @gmail.users.watch@.
module Gogol.Gmail.Users.Watch
    (
    -- * Resource
                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] WatchRequest Core.:>
                             Core.Post '[Core.JSON] WatchResponse
...
newGmailUsersWatch payload
  = GmailUsersWatch{xgafv = Core.Nothing, accessToken = Core.Nothing,
