...
--
-- /See:/ <https://developers.google.com/workspace/gmail/api/ Gmail API Reference> for @gmail.users.settings.sendAs.get@.
module Gogol.Gmail.Users.Settings.SendAs.Get
    (
    -- * Resource
...
newGmailUsersSettingsSendAsGet sendAsEmail
  = GmailUsersSettingsSendAsGet{xgafv = Core.Nothing,
