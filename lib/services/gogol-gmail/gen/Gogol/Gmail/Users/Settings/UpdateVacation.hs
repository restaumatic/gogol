...
--
-- /See:/ <https://developers.google.com/workspace/gmail/api/ Gmail API Reference> for @gmail.users.settings.updateVacation@.
module Gogol.Gmail.Users.Settings.UpdateVacation
    (
    -- * Resource
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] VacationSettings Core.:>
                               Core.Put '[Core.JSON] VacationSettings
...
newGmailUsersSettingsUpdateVacation payload
  = GmailUsersSettingsUpdateVacation{xgafv = Core.Nothing,
                                     accessToken = Core.Nothing, callback = Core.Nothing,
                                     payload = payload, uploadType = Core.Nothing,
                                     uploadProtocol = Core.Nothing, userId = "me"}
instance Core.GoogleRequest GmailUsersSettingsUpdateVacation where
        type Rs GmailUsersSettingsUpdateVacation = VacationSettings
        ...
        requestClient GmailUsersSettingsUpdateVacation{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy GmailUsersSettingsUpdateVacationResource)
                      Core.mempty
