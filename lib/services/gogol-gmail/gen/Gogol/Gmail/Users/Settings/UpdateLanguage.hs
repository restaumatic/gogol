...
--
-- /See:/ <https://developers.google.com/workspace/gmail/api/ Gmail API Reference> for @gmail.users.settings.updateLanguage@.
module Gogol.Gmail.Users.Settings.UpdateLanguage
    (
    -- * Resource
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] LanguageSettings Core.:>
                               Core.Put '[Core.JSON] LanguageSettings
...
newGmailUsersSettingsUpdateLanguage payload
  = GmailUsersSettingsUpdateLanguage{xgafv = Core.Nothing,
...
instance Core.GoogleRequest GmailUsersSettingsUpdateLanguage where
        ...
        type Scopes GmailUsersSettingsUpdateLanguage =
