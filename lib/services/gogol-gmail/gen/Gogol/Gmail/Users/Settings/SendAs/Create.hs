...
--
-- /See:/ <https://developers.google.com/workspace/gmail/api/ Gmail API Reference> for @gmail.users.settings.sendAs.create@.
module Gogol.Gmail.Users.Settings.SendAs.Create
    (
    -- * Resource
...
newGmailUsersSettingsSendAsCreate payload
  = GmailUsersSettingsSendAsCreate{xgafv = Core.Nothing,
                                   accessToken = Core.Nothing, callback = Core.Nothing,
                                   payload = payload, uploadType = Core.Nothing,
                                   uploadProtocol = Core.Nothing, userId = "me"}
instance Core.GoogleRequest GmailUsersSettingsSendAsCreate where
        type Rs GmailUsersSettingsSendAsCreate = SendAs
        type Scopes GmailUsersSettingsSendAsCreate =
        ...
        requestClient GmailUsersSettingsSendAsCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy GmailUsersSettingsSendAsCreateResource)
                      Core.mempty
