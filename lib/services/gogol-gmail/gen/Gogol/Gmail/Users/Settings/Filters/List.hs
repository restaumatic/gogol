...
--
-- /See:/ <https://developers.google.com/workspace/gmail/api/ Gmail API Reference> for @gmail.users.settings.filters.list@.
module Gogol.Gmail.Users.Settings.Filters.List
    (
    -- * Resource
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] ListFiltersResponse
...
newGmailUsersSettingsFiltersList 
    ::  GmailUsersSettingsFiltersList
newGmailUsersSettingsFiltersList
  = GmailUsersSettingsFiltersList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest GmailUsersSettingsFiltersList where
        ...
        type Scopes GmailUsersSettingsFiltersList =
