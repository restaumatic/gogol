...
--
-- /See:/ <https://developers.google.com/workspace/gmail/api/ Gmail API Reference> for @gmail.users.settings.sendAs.smimeInfo.list@.
module Gogol.Gmail.Users.Settings.SendAs.SmimeInfo.List
    (
    -- * Resource
                           ...
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.Get '[Core.JSON] ListSmimeInfoResponse
...
newGmailUsersSettingsSendAsSmimeInfoList sendAsEmail
  = GmailUsersSettingsSendAsSmimeInfoList{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          sendAsEmail = sendAsEmail, uploadType = Core.Nothing,
                                          uploadProtocol = Core.Nothing, userId = "me"}
instance Core.GoogleRequest GmailUsersSettingsSendAsSmimeInfoList
         where
        type Rs GmailUsersSettingsSendAsSmimeInfoList =
             ListSmimeInfoResponse
        type Scopes GmailUsersSettingsSendAsSmimeInfoList =
