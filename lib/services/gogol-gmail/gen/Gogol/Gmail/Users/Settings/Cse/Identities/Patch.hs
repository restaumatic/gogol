         ...
         "users" Core.:>
           Core.Capture "userId" Core.Text Core.:>
             "settings" Core.:>
               "cse" Core.:>
                 "identities" Core.:>
                   Core.Capture "emailAddress" Core.Text Core.:>
                             ...
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.ReqBody '[Core.JSON] CseIdentity Core.:>
                                   Core.Patch '[Core.JSON] CseIdentity
...
newGmailUsersSettingsCseIdentitiesPatch emailAddress payload
  = GmailUsersSettingsCseIdentitiesPatch{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         emailAddress = emailAddress, payload = payload,
                                         uploadType = Core.Nothing, uploadProtocol = Core.Nothing,
                                         userId = "me"}
instance Core.GoogleRequest GmailUsersSettingsCseIdentitiesPatch
         where
        type Rs GmailUsersSettingsCseIdentitiesPatch = CseIdentity
        type Scopes GmailUsersSettingsCseIdentitiesPatch =
             '[Gmail'Settings'Basic, Gmail'Settings'Sharing]
        requestClient GmailUsersSettingsCseIdentitiesPatch{..}
          = go userId emailAddress xgafv accessToken callback uploadType
              uploadProtocol
