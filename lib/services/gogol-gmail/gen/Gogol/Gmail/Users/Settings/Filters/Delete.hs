...
--
-- /See:/ <https://developers.google.com/workspace/gmail/api/ Gmail API Reference> for @gmail.users.settings.filters.delete@.
module Gogol.Gmail.Users.Settings.Filters.Delete
    (
    -- * Resource
...
newGmailUsersSettingsFiltersDelete id
  = GmailUsersSettingsFiltersDelete{xgafv = Core.Nothing,
