...
--
-- Retrieves an existing client-side encryption key pair. For administrators managing identities and keypairs for users in their organization, requests require authorization with a <https://developers.google.com/identity/protocols/OAuth2ServiceAccount service account> that has <https://developers.google.com/identity/protocols/OAuth2ServiceAccount#delegatingauthority domain-wide delegation authority> to impersonate users with the @https:\/\/www.googleapis.com\/auth\/gmail.settings.basic@ scope. For users managing their own identities and keypairs, requests require <https://support.google.com/a/answer/14153163 hardware key encryption> turned on and configured.
--
-- /See:/ <https://developers.google.com/workspace/gmail/api/ Gmail API Reference> for @gmail.users.settings.cse.keypairs.get@.
module Gogol.Gmail.Users.Settings.Cse.Keypairs.Get
    (
    -- * Resource
         ...
         "users" Core.:>
           Core.Capture "userId" Core.Text Core.:>
             "settings" Core.:>
               "cse" Core.:>
                 "keypairs" Core.:>
                   Core.Capture "keyPairId" Core.Text Core.:>
...
newGmailUsersSettingsCseKeypairsGet keyPairId
  = GmailUsersSettingsCseKeypairsGet{xgafv = Core.Nothing,
                                     accessToken = Core.Nothing, callback = Core.Nothing,
                                     keyPairId = keyPairId, uploadType = Core.Nothing,
...
instance Core.GoogleRequest GmailUsersSettingsCseKeypairsGet where
        ...
        type Scopes GmailUsersSettingsCseKeypairsGet =
