         ...
         "users" Core.:>
           Core.Capture "userId" Core.Text Core.:>
             "settings" Core.:>
               "cse" Core.:>
                 "keypairs" Core.:>
                   Core.CaptureMode "keyPairId" "disable" Core.Text Core.:>
                           ...
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.ReqBody '[Core.JSON] DisableCseKeyPairRequest Core.:>
                                   Core.Post '[Core.JSON] CseKeyPair
...
newGmailUsersSettingsCseKeypairsDisable keyPairId payload
  = GmailUsersSettingsCseKeypairsDisable{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         keyPairId = keyPairId, payload = payload,
                                         uploadType = Core.Nothing, uploadProtocol = Core.Nothing,
                                         userId = "me"}
instance Core.GoogleRequest GmailUsersSettingsCseKeypairsDisable
         where
        type Rs GmailUsersSettingsCseKeypairsDisable = CseKeyPair
        type Scopes GmailUsersSettingsCseKeypairsDisable =
             '[Gmail'Settings'Basic, Gmail'Settings'Sharing]
        requestClient GmailUsersSettingsCseKeypairsDisable{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy GmailUsersSettingsCseKeypairsDisableResource)
                      Core.mempty
