...
--
-- /See:/ <https://developers.google.com/workspace/gmail/api/ Gmail API Reference> for @gmail.users.settings.sendAs.smimeInfo.insert@.
module Gogol.Gmail.Users.Settings.SendAs.SmimeInfo.Insert
    (
    -- * Resource
                           ...
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.ReqBody '[Core.JSON] SmimeInfo Core.:>
                                   Core.Post '[Core.JSON] SmimeInfo
...
newGmailUsersSettingsSendAsSmimeInfoInsert payload sendAsEmail
  = GmailUsersSettingsSendAsSmimeInfoInsert{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            payload = payload, sendAsEmail = sendAsEmail,
                                            uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing, userId = "me"}
instance Core.GoogleRequest GmailUsersSettingsSendAsSmimeInfoInsert
         where
        type Rs GmailUsersSettingsSendAsSmimeInfoInsert = SmimeInfo
        type Scopes GmailUsersSettingsSendAsSmimeInfoInsert =
             '[Gmail'Settings'Basic, Gmail'Settings'Sharing]
        requestClient GmailUsersSettingsSendAsSmimeInfoInsert{..}
          = go userId sendAsEmail xgafv accessToken callback uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy GmailUsersSettingsSendAsSmimeInfoInsertResource)
                      Core.mempty
