...
--
-- /See:/ <https://developers.google.com/workspace/gmail/api/ Gmail API Reference> for @gmail.users.settings.forwardingAddresses.delete@.
module Gogol.Gmail.Users.Settings.ForwardingAddresses.Delete
    (
    -- * Resource
...
newGmailUsersSettingsForwardingAddressesDelete forwardingEmail
  = GmailUsersSettingsForwardingAddressesDelete{xgafv = Core.Nothing,
