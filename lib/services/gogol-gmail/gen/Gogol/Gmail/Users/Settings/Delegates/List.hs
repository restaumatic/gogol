...
--
-- /See:/ <https://developers.google.com/workspace/gmail/api/ Gmail API Reference> for @gmail.users.settings.delegates.list@.
module Gogol.Gmail.Users.Settings.Delegates.List
    (
    -- * Resource
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] ListDelegatesResponse
...
newGmailUsersSettingsDelegatesList 
    :: 
                                   GmailUsersSettingsDelegatesList
newGmailUsersSettingsDelegatesList
  = GmailUsersSettingsDelegatesList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest GmailUsersSettingsDelegatesList where
        ...
        type Scopes GmailUsersSettingsDelegatesList =
