...
--
-- /See:/ <https://developers.google.com/workspace/gmail/api/ Gmail API Reference> for @gmail.users.settings.sendAs.verify@.
module Gogol.Gmail.Users.Settings.SendAs.Verify
    (
    -- * Resource
...
newGmailUsersSettingsSendAsVerify sendAsEmail
  = GmailUsersSettingsSendAsVerify{xgafv = Core.Nothing,
...
instance Core.GoogleRequest GmailUsersSettingsSendAsVerify where
        ...
        type Scopes GmailUsersSettingsSendAsVerify =
