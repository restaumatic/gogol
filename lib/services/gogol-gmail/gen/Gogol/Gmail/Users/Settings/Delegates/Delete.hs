...
--
-- /See:/ <https://developers.google.com/workspace/gmail/api/ Gmail API Reference> for @gmail.users.settings.delegates.delete@.
module Gogol.Gmail.Users.Settings.Delegates.Delete
    (
    -- * Resource
...
newGmailUsersSettingsDelegatesDelete delegateEmail
  = GmailUsersSettingsDelegatesDelete{xgafv = Core.Nothing,
