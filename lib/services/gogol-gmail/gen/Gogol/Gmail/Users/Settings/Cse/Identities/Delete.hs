...
newGmailUsersSettingsCseIdentitiesDelete cseEmailAddress
  = GmailUsersSettingsCseIdentitiesDelete{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          cseEmailAddress = cseEmailAddress,
                                          uploadType = Core.Nothing, uploadProtocol = Core.Nothing,
                                          userId = "me"}
instance Core.GoogleRequest GmailUsersSettingsCseIdentitiesDelete
         where
        type Rs GmailUsersSettingsCseIdentitiesDelete = ()
        type Scopes GmailUsersSettingsCseIdentitiesDelete =
             '[Gmail'Settings'Basic, Gmail'Settings'Sharing]
        requestClient GmailUsersSettingsCseIdentitiesDelete{..}
          = go userId cseEmailAddress xgafv accessToken callback uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy GmailUsersSettingsCseIdentitiesDeleteResource)
                      Core.mempty
