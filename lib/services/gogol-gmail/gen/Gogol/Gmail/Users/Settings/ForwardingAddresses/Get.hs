...
--
-- /See:/ <https://developers.google.com/workspace/gmail/api/ Gmail API Reference> for @gmail.users.settings.forwardingAddresses.get@.
module Gogol.Gmail.Users.Settings.ForwardingAddresses.Get
    (
    -- * Resource
...
newGmailUsersSettingsForwardingAddressesGet forwardingEmail
  = GmailUsersSettingsForwardingAddressesGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        requestClient GmailUsersSettingsForwardingAddressesGet{..}
          = go userId forwardingEmail xgafv accessToken callback uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy GmailUsersSettingsForwardingAddressesGetResource)
                      Core.mempty
