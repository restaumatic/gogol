...
--
-- /See:/ <https://developers.google.com/workspace/gmail/api/ Gmail API Reference> for @gmail.users.settings.updatePop@.
module Gogol.Gmail.Users.Settings.UpdatePop
    (
    -- * Resource
...
newGmailUsersSettingsUpdatePop payload
  = GmailUsersSettingsUpdatePop{xgafv = Core.Nothing,
