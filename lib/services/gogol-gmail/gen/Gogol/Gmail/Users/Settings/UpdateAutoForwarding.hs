...
--
-- /See:/ <https://developers.google.com/workspace/gmail/api/ Gmail API Reference> for @gmail.users.settings.updateAutoForwarding@.
module Gogol.Gmail.Users.Settings.UpdateAutoForwarding
    (
    -- * Resource
...
newGmailUsersSettingsUpdateAutoForwarding payload
  = GmailUsersSettingsUpdateAutoForwarding{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           payload = payload, uploadType = Core.Nothing,
                                           uploadProtocol = Core.Nothing, userId = "me"}
instance Core.GoogleRequest GmailUsersSettingsUpdateAutoForwarding
         where
