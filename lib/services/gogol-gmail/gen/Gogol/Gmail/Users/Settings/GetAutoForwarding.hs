...
--
-- /See:/ <https://developers.google.com/workspace/gmail/api/ Gmail API Reference> for @gmail.users.settings.getAutoForwarding@.
module Gogol.Gmail.Users.Settings.GetAutoForwarding
    (
    -- * Resource
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] AutoForwarding
...
newGmailUsersSettingsGetAutoForwarding 
    :: 
                                       GmailUsersSettingsGetAutoForwarding
newGmailUsersSettingsGetAutoForwarding
  = GmailUsersSettingsGetAutoForwarding{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        uploadType = Core.Nothing, uploadProtocol = Core.Nothing,
                                        userId = "me"}
instance Core.GoogleRequest GmailUsersSettingsGetAutoForwarding
         where
        type Rs GmailUsersSettingsGetAutoForwarding = AutoForwarding
        type Scopes GmailUsersSettingsGetAutoForwarding =
        ...
        requestClient GmailUsersSettingsGetAutoForwarding{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy GmailUsersSettingsGetAutoForwardingResource)
                      Core.mempty
