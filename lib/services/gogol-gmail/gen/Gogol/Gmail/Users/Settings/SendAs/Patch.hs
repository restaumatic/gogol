...
--
-- /See:/ <https://developers.google.com/workspace/gmail/api/ Gmail API Reference> for @gmail.users.settings.sendAs.patch@.
module Gogol.Gmail.Users.Settings.SendAs.Patch
    (
    -- * Resource
...
newGmailUsersSettingsSendAsPatch payload sendAsEmail
  = GmailUsersSettingsSendAsPatch{xgafv = Core.Nothing,
                                  accessToken = Core.Nothing, callback = Core.Nothing,
                                  payload = payload, sendAsEmail = sendAsEmail,
                                  uploadType = Core.Nothing, uploadProtocol = Core.Nothing,
                                  userId = "me"}
instance Core.GoogleRequest GmailUsersSettingsSendAsPatch where
        type Rs GmailUsersSettingsSendAsPatch = SendAs
        type Scopes GmailUsersSettingsSendAsPatch =
        ...
        requestClient GmailUsersSettingsSendAsPatch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy GmailUsersSettingsSendAsPatchResource)
                      Core.mempty
