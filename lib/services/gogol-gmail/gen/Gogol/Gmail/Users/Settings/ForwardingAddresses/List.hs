...
--
-- /See:/ <https://developers.google.com/workspace/gmail/api/ Gmail API Reference> for @gmail.users.settings.forwardingAddresses.list@.
module Gogol.Gmail.Users.Settings.ForwardingAddresses.List
    (
    -- * Resource
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] ListForwardingAddressesResponse
...
newGmailUsersSettingsForwardingAddressesList 
    :: 
                                             GmailUsersSettingsForwardingAddressesList
newGmailUsersSettingsForwardingAddressesList
  = GmailUsersSettingsForwardingAddressesList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        requestClient GmailUsersSettingsForwardingAddressesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy GmailUsersSettingsForwardingAddressesListResource)
                      Core.mempty
