...
--
-- /See:/ <https://developers.google.com/workspace/gmail/api/ Gmail API Reference> for @gmail.users.settings.getVacation@.
module Gogol.Gmail.Users.Settings.GetVacation
    (
    -- * Resource
...
newGmailUsersSettingsGetVacation 
    ::  GmailUsersSettingsGetVacation
newGmailUsersSettingsGetVacation
  = GmailUsersSettingsGetVacation{xgafv = Core.Nothing,
