...
--
-- /See:/ <https://developers.google.com/workspace/gmail/api/ Gmail API Reference> for @gmail.users.settings.sendAs.list@.
module Gogol.Gmail.Users.Settings.SendAs.List
    (
    -- * Resource
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] ListSendAsResponse
...
newGmailUsersSettingsSendAsList 
    ::  GmailUsersSettingsSendAsList
newGmailUsersSettingsSendAsList
  = GmailUsersSettingsSendAsList{xgafv = Core.Nothing,
                                 accessToken = Core.Nothing, callback = Core.Nothing,
                                 uploadType = Core.Nothing, uploadProtocol = Core.Nothing,
                                 userId = "me"}
instance Core.GoogleRequest GmailUsersSettingsSendAsList where
        type Rs GmailUsersSettingsSendAsList = ListSendAsResponse
        type Scopes GmailUsersSettingsSendAsList =
        ...
        requestClient GmailUsersSettingsSendAsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy GmailUsersSettingsSendAsListResource)
                      Core.mempty
