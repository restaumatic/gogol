...
newGmailUsersSettingsCseIdentitiesGet cseEmailAddress
  = GmailUsersSettingsCseIdentitiesGet{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       cseEmailAddress = cseEmailAddress, uploadType = Core.Nothing,
                                       uploadProtocol = Core.Nothing, userId = "me"}
instance Core.GoogleRequest GmailUsersSettingsCseIdentitiesGet
         where
        type Rs GmailUsersSettingsCseIdentitiesGet = CseIdentity
        ...
        requestClient GmailUsersSettingsCseIdentitiesGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy GmailUsersSettingsCseIdentitiesGetResource)
                      Core.mempty
