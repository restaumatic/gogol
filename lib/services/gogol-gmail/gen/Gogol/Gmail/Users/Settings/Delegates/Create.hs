...
--
-- /See:/ <https://developers.google.com/workspace/gmail/api/ Gmail API Reference> for @gmail.users.settings.delegates.create@.
module Gogol.Gmail.Users.Settings.Delegates.Create
    (
    -- * Resource
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] Delegate Core.:>
                               Core.Post '[Core.JSON] Delegate
...
newGmailUsersSettingsDelegatesCreate payload
  = GmailUsersSettingsDelegatesCreate{xgafv = Core.Nothing,
                                      accessToken = Core.Nothing, callback = Core.Nothing,
                                      payload = payload, uploadType = Core.Nothing,
                                      uploadProtocol = Core.Nothing, userId = "me"}
instance Core.GoogleRequest GmailUsersSettingsDelegatesCreate where
        type Rs GmailUsersSettingsDelegatesCreate = Delegate
        type Scopes GmailUsersSettingsDelegatesCreate =
