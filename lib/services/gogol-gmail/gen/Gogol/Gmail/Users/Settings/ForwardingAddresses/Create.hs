...
--
-- /See:/ <https://developers.google.com/workspace/gmail/api/ Gmail API Reference> for @gmail.users.settings.forwardingAddresses.create@.
module Gogol.Gmail.Users.Settings.ForwardingAddresses.Create
    (
    -- * Resource
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] ForwardingAddress Core.:>
                               Core.Post '[Core.JSON] ForwardingAddress
...
newGmailUsersSettingsForwardingAddressesCreate payload
  = GmailUsersSettingsForwardingAddressesCreate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           GmailUsersSettingsForwardingAddressesCreate
         where
        type Rs GmailUsersSettingsForwardingAddressesCreate =
             ForwardingAddress
        type Scopes GmailUsersSettingsForwardingAddressesCreate =
             '[Gmail'Settings'Sharing]
        requestClient GmailUsersSettingsForwardingAddressesCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy GmailUsersSettingsForwardingAddressesCreateResource)
                      Core.mempty
