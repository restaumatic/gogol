...
--
-- /See:/ <https://developers.google.com/workspace/gmail/api/ Gmail API Reference> for @gmail.users.settings.sendAs.update@.
module Gogol.Gmail.Users.Settings.SendAs.Update
    (
    -- * Resource
                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.ReqBody '[Core.JSON] SendAs Core.:>
                                 Core.Put '[Core.JSON] SendAs
...
newGmailUsersSettingsSendAsUpdate payload sendAsEmail
  = GmailUsersSettingsSendAsUpdate{xgafv = Core.Nothing,
                                   accessToken = Core.Nothing, callback = Core.Nothing,
                                   payload = payload, sendAsEmail = sendAsEmail,
                                   uploadType = Core.Nothing, uploadProtocol = Core.Nothing,
                                   userId = "me"}
instance Core.GoogleRequest GmailUsersSettingsSendAsUpdate where
        type Rs GmailUsersSettingsSendAsUpdate = SendAs
        type Scopes GmailUsersSettingsSendAsUpdate =
        ...
        requestClient GmailUsersSettingsSendAsUpdate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy GmailUsersSettingsSendAsUpdateResource)
                      Core.mempty
