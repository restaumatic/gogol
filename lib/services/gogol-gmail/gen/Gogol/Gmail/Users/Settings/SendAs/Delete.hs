...
--
-- /See:/ <https://developers.google.com/workspace/gmail/api/ Gmail API Reference> for @gmail.users.settings.sendAs.delete@.
module Gogol.Gmail.Users.Settings.SendAs.Delete
    (
    -- * Resource
...
newGmailUsersSettingsSendAsDelete sendAsEmail
  = GmailUsersSettingsSendAsDelete{xgafv = Core.Nothing,
                                   accessToken = Core.Nothing, callback = Core.Nothing,
                                   sendAsEmail = sendAsEmail, uploadType = Core.Nothing,
                                   uploadProtocol = Core.Nothing, userId = "me"}
instance Core.GoogleRequest GmailUsersSettingsSendAsDelete where
        ...
        requestClient GmailUsersSettingsSendAsDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy GmailUsersSettingsSendAsDeleteResource)
                      Core.mempty
