...
-- Gets IMAP settings.
--
-- /See:/ <https://developers.google.com/workspace/gmail/api/ Gmail API Reference> for @gmail.users.settings.getImap@.
module Gogol.Gmail.Users.Settings.GetImap
    (
    -- * Resource
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] ImapSettings
...
newGmailUsersSettingsGetImap 
    ::  GmailUsersSettingsGetImap
newGmailUsersSettingsGetImap
  = GmailUsersSettingsGetImap{xgafv = Core.Nothing,
...
instance Core.GoogleRequest GmailUsersSettingsGetImap where
        ...
        type Scopes GmailUsersSettingsGetImap =
