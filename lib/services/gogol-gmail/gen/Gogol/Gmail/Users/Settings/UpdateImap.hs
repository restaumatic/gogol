...
--
-- /See:/ <https://developers.google.com/workspace/gmail/api/ Gmail API Reference> for @gmail.users.settings.updateImap@.
module Gogol.Gmail.Users.Settings.UpdateImap
    (
    -- * Resource
...
newGmailUsersSettingsUpdateImap payload
  = GmailUsersSettingsUpdateImap{xgafv = Core.Nothing,
