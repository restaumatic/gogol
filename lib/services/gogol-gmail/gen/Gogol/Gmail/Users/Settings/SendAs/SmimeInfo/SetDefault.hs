...
--
-- /See:/ <https://developers.google.com/workspace/gmail/api/ Gmail API Reference> for @gmail.users.settings.sendAs.smimeInfo.setDefault@.
module Gogol.Gmail.Users.Settings.SendAs.SmimeInfo.SetDefault
    (
    -- * Resource
...
newGmailUsersSettingsSendAsSmimeInfoSetDefault id sendAsEmail
  = GmailUsersSettingsSendAsSmimeInfoSetDefault{xgafv = Core.Nothing,
