...
-- |
-- Module      : Gogol.Gmail.Users.Settings.GetPop
...
-- Gets POP settings.
--
-- /See:/ <https://developers.google.com/workspace/gmail/api/ Gmail API Reference> for @gmail.users.settings.getPop@.
module Gogol.Gmail.Users.Settings.GetPop
    (
    -- * Resource
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] PopSettings
...
newGmailUsersSettingsGetPop 
    ::  GmailUsersSettingsGetPop
newGmailUsersSettingsGetPop
  = GmailUsersSettingsGetPop{xgafv = Core.Nothing,
...
instance Core.GoogleRequest GmailUsersSettingsGetPop where
        ...
        type Scopes GmailUsersSettingsGetPop =
        ...
        requestClient GmailUsersSettingsGetPop{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy GmailUsersSettingsGetPopResource)
                      Core.mempty
