...
--
-- /See:/ <https://developers.google.com/workspace/gmail/api/ Gmail API Reference> for @gmail.users.settings.getLanguage@.
module Gogol.Gmail.Users.Settings.GetLanguage
    (
    -- * Resource
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] LanguageSettings
...
newGmailUsersSettingsGetLanguage 
    ::  GmailUsersSettingsGetLanguage
newGmailUsersSettingsGetLanguage
  = GmailUsersSettingsGetLanguage{xgafv = Core.Nothing,
...
instance Core.GoogleRequest GmailUsersSettingsGetLanguage where
        ...
        type Scopes GmailUsersSettingsGetLanguage =
