...
--
-- /See:/ <https://developers.google.com/workspace/gmail/api/ Gmail API Reference> for @gmail.users.settings.sendAs.smimeInfo.get@.
module Gogol.Gmail.Users.Settings.SendAs.SmimeInfo.Get
    (
    -- * Resource
...
newGmailUsersSettingsSendAsSmimeInfoGet id sendAsEmail
  = GmailUsersSettingsSendAsSmimeInfoGet{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         id = id, sendAsEmail = sendAsEmail,
                                         uploadType = Core.Nothing, uploadProtocol = Core.Nothing,
                                         userId = "me"}
instance Core.GoogleRequest GmailUsersSettingsSendAsSmimeInfoGet
         where
        type Rs GmailUsersSettingsSendAsSmimeInfoGet = SmimeInfo
        ...
        requestClient GmailUsersSettingsSendAsSmimeInfoGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy GmailUsersSettingsSendAsSmimeInfoGetResource)
                      Core.mempty
