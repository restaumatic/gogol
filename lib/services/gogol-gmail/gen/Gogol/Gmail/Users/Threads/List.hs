...
-- |
-- Module      : Gogol.Gmail.Users.Threads.List
...
--
-- /See:/ <https://developers.google.com/workspace/gmail/api/ Gmail API Reference> for @gmail.users.threads.list@.
module Gogol.Gmail.Users.Threads.List
    (
    -- * Resource
                               ...
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.Get '[Core.JSON] ListThreadsResponse
...
newGmailUsersThreadsList 
    ::  GmailUsersThreadsList
newGmailUsersThreadsList
  = GmailUsersThreadsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest GmailUsersThreadsList where
        ...
        type Scopes GmailUsersThreadsList =
        ...
        requestClient GmailUsersThreadsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy GmailUsersThreadsListResource)
                      Core.mempty
