...
--
-- /See:/ <https://developers.google.com/workspace/gmail/api/ Gmail API Reference> for @gmail.users.threads.untrash@.
module Gogol.Gmail.Users.Threads.Untrash
    (
    -- * Resource
...
newGmailUsersThreadsUntrash id
  = GmailUsersThreadsUntrash{xgafv = Core.Nothing,
...
instance Core.GoogleRequest GmailUsersThreadsUntrash where
        ...
        requestClient GmailUsersThreadsUntrash{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy GmailUsersThreadsUntrashResource)
                      Core.mempty
