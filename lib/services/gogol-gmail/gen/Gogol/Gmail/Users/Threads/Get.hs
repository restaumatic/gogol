...
--
-- /See:/ <https://developers.google.com/workspace/gmail/api/ Gmail API Reference> for @gmail.users.threads.get@.
module Gogol.Gmail.Users.Threads.Get
    (
    -- * Resource
                 ...
                 Core.QueryParam "$.xgafv" Xgafv Core.:>
                   Core.QueryParam "access_token" Core.Text Core.:>
                     Core.QueryParam "callback" Core.Text Core.:>
                       Core.QueryParam "format" UsersThreadsGetFormat Core.:>
...
newGmailUsersThreadsGet id
  = GmailUsersThreadsGet{xgafv = Core.Nothing,
                         accessToken = Core.Nothing, callback = Core.Nothing,
                         format = UsersThreadsGetFormat_Full, id = id,
                         metadataHeaders = Core.Nothing, uploadType = Core.Nothing,
...
instance Core.GoogleRequest GmailUsersThreadsGet where
        ...
        type Scopes GmailUsersThreadsGet =
             '[Gmail'FullControl, Gmail'Addons'Current'Message'Action,
               ...
               Gmail'Addons'Current'Message'Readonly, Gmail'Metadata,
               Gmail'Modify, Gmail'Readonly]
        requestClient GmailUsersThreadsGet{..}
          = go userId id xgafv accessToken callback (Core.Just format)
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy GmailUsersThreadsGetResource)
                      Core.mempty
