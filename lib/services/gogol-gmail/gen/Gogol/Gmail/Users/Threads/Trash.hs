...
--
-- /See:/ <https://developers.google.com/workspace/gmail/api/ Gmail API Reference> for @gmail.users.threads.trash@.
module Gogol.Gmail.Users.Threads.Trash
    (
    -- * Resource
...
newGmailUsersThreadsTrash id
  = GmailUsersThreadsTrash{xgafv = Core.Nothing,
...
instance Core.GoogleRequest GmailUsersThreadsTrash where
        ...
        type Scopes GmailUsersThreadsTrash =
