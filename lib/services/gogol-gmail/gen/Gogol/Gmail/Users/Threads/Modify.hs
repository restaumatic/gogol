...
--
-- /See:/ <https://developers.google.com/workspace/gmail/api/ Gmail API Reference> for @gmail.users.threads.modify@.
module Gogol.Gmail.Users.Threads.Modify
    (
    -- * Resource
                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.ReqBody '[Core.JSON] ModifyThreadRequest Core.:>
...
newGmailUsersThreadsModify id payload
  = GmailUsersThreadsModify{xgafv = Core.Nothing,
...
instance Core.GoogleRequest GmailUsersThreadsModify where
        ...
        type Scopes GmailUsersThreadsModify =
