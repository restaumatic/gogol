...
--
-- /See:/ <https://developers.google.com/workspace/gmail/api/ Gmail API Reference> for @gmail.users.messages.delete@.
module Gogol.Gmail.Users.Messages.Delete
    (
    -- * Resource
...
newGmailUsersMessagesDelete id
  = GmailUsersMessagesDelete{xgafv = Core.Nothing,
...
instance Core.GoogleRequest GmailUsersMessagesDelete where
        ...
        type Scopes GmailUsersMessagesDelete = '[Gmail'FullControl]
        requestClient GmailUsersMessagesDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy GmailUsersMessagesDeleteResource)
                      Core.mempty
