...
--
-- /See:/ <https://developers.google.com/workspace/gmail/api/ Gmail API Reference> for @gmail.users.messages.insert@.
module Gogol.Gmail.Users.Messages.Insert
    (
    -- * Resource
...
newGmailUsersMessagesInsert payload
  = GmailUsersMessagesInsert{xgafv = Core.Nothing,
...
instance Core.GoogleRequest GmailUsersMessagesInsert where
        ...
        type Scopes GmailUsersMessagesInsert =
...
instance Core.GoogleRequest
        ...
        type Scopes (Core.MediaUpload GmailUsersMessagesInsert) =
