...
--
-- Sends the specified message to the recipients in the @To@, @Cc@, and @Bcc@ headers. For example usage, see <https://developers.google.com/workspace/gmail/api/guides/sending Sending email>.
--
-- /See:/ <https://developers.google.com/workspace/gmail/api/ Gmail API Reference> for @gmail.users.messages.send@.
module Gogol.Gmail.Users.Messages.Send
    (
    -- * Resource
...
newGmailUsersMessagesSend payload
  = GmailUsersMessagesSend{xgafv = Core.Nothing,
...
instance Core.GoogleRequest GmailUsersMessagesSend where
        ...
        type Scopes GmailUsersMessagesSend =
             '[Gmail'FullControl, Gmail'Addons'Current'Action'Compose,
               Gmail'Compose, Gmail'Modify, Gmail'Send]
...
instance Core.GoogleRequest
        ...
        type Scopes (Core.MediaUpload GmailUsersMessagesSend) =
