...
--
-- /See:/ <https://developers.google.com/workspace/gmail/api/ Gmail API Reference> for @gmail.users.messages.trash@.
module Gogol.Gmail.Users.Messages.Trash
    (
    -- * Resource
...
newGmailUsersMessagesTrash id
  = GmailUsersMessagesTrash{xgafv = Core.Nothing,
...
instance Core.GoogleRequest GmailUsersMessagesTrash where
        ...
        type Scopes GmailUsersMessagesTrash =
        ...
        requestClient GmailUsersMessagesTrash{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy GmailUsersMessagesTrashResource)
                      Core.mempty
