...
--
-- /See:/ <https://developers.google.com/workspace/gmail/api/ Gmail API Reference> for @gmail.users.messages.batchDelete@.
module Gogol.Gmail.Users.Messages.BatchDelete
    (
    -- * Resource
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] BatchDeleteMessagesRequest Core.:>
                               Core.Post '[Core.JSON] ()
...
newGmailUsersMessagesBatchDelete payload
  = GmailUsersMessagesBatchDelete{xgafv = Core.Nothing,
                                  accessToken = Core.Nothing, callback = Core.Nothing,
                                  payload = payload, uploadType = Core.Nothing,
                                  uploadProtocol = Core.Nothing, userId = "me"}
instance Core.GoogleRequest GmailUsersMessagesBatchDelete where
        type Rs GmailUsersMessagesBatchDelete = ()
        type Scopes GmailUsersMessagesBatchDelete = '[Gmail'FullControl]
        requestClient GmailUsersMessagesBatchDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy GmailUsersMessagesBatchDeleteResource)
                      Core.mempty
