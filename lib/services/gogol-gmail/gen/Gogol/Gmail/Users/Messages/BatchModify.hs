...
--
-- /See:/ <https://developers.google.com/workspace/gmail/api/ Gmail API Reference> for @gmail.users.messages.batchModify@.
module Gogol.Gmail.Users.Messages.BatchModify
    (
    -- * Resource
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] BatchModifyMessagesRequest Core.:>
                               Core.Post '[Core.JSON] ()
...
newGmailUsersMessagesBatchModify payload
  = GmailUsersMessagesBatchModify{xgafv = Core.Nothing,
                                  accessToken = Core.Nothing, callback = Core.Nothing,
                                  payload = payload, uploadType = Core.Nothing,
                                  uploadProtocol = Core.Nothing, userId = "me"}
instance Core.GoogleRequest GmailUsersMessagesBatchModify where
        ...
        requestClient GmailUsersMessagesBatchModify{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy GmailUsersMessagesBatchModifyResource)
                      Core.mempty
