...
--
-- /See:/ <https://developers.google.com/workspace/gmail/api/ Gmail API Reference> for @gmail.users.messages.import@.
module Gogol.Gmail.Users.Messages.Import
    (
    -- * Resource
                 ...
                 Core.QueryParam "$.xgafv" Xgafv Core.:>
                   Core.QueryParam "access_token" Core.Text Core.:>
                     Core.QueryParam "callback" Core.Text Core.:>
                       Core.QueryParam "deleted" Core.Bool Core.:>
                         Core.QueryParam "internalDateSource"
                           UsersMessagesImportInternalDateSource
                           Core.:>
                           Core.QueryParam "neverMarkSpam" Core.Bool Core.:>
                             Core.QueryParam "processForCalendar" Core.Bool Core.:>
                                     ...
                                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                                       Core.QueryParam "alt" Core.AltJSON Core.:>
                                         Core.QueryParam "uploadType" Core.Multipart Core.:>
                                           Core.MultipartRelated '[Core.JSON] Message Core.:>
                                             Core.Post '[Core.JSON] Message
...
newGmailUsersMessagesImport payload
  = GmailUsersMessagesImport{xgafv = Core.Nothing,
                             accessToken = Core.Nothing, callback = Core.Nothing,
                             deleted = Core.False,
                             internalDateSource =
                               UsersMessagesImportInternalDateSource_DateHeader,
                             neverMarkSpam = Core.False, payload = payload,
                             processForCalendar = Core.False, uploadType = Core.Nothing,
...
instance Core.GoogleRequest GmailUsersMessagesImport where
        ...
        type Scopes GmailUsersMessagesImport =
             '[Gmail'FullControl, Gmail'Insert, Gmail'Modify]
        requestClient GmailUsersMessagesImport{..}
          = go userId xgafv accessToken callback (Core.Just deleted)
...
instance Core.GoogleRequest
        ...
        type Scopes (Core.MediaUpload GmailUsersMessagesImport) =
