...
--
-- /See:/ <https://developers.google.com/workspace/gmail/api/ Gmail API Reference> for @gmail.users.messages.untrash@.
module Gogol.Gmail.Users.Messages.Untrash
    (
    -- * Resource
...
newGmailUsersMessagesUntrash id
  = GmailUsersMessagesUntrash{xgafv = Core.Nothing,
...
instance Core.GoogleRequest GmailUsersMessagesUntrash where
        ...
        type Scopes GmailUsersMessagesUntrash =
        ...
        requestClient GmailUsersMessagesUntrash{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy GmailUsersMessagesUntrashResource)
                      Core.mempty
