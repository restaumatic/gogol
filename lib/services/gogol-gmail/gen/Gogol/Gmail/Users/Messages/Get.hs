...
--
-- /See:/ <https://developers.google.com/workspace/gmail/api/ Gmail API Reference> for @gmail.users.messages.get@.
module Gogol.Gmail.Users.Messages.Get
    (
    -- * Resource
                 ...
                 Core.QueryParam "$.xgafv" Xgafv Core.:>
                   Core.QueryParam "access_token" Core.Text Core.:>
                     Core.QueryParam "callback" Core.Text Core.:>
                       Core.QueryParam "format" UsersMessagesGetFormat Core.:>
...
newGmailUsersMessagesGet id
  = GmailUsersMessagesGet{xgafv = Core.Nothing,
                          accessToken = Core.Nothing, callback = Core.Nothing,
                          format = UsersMessagesGetFormat_Full, id = id,
...
instance Core.GoogleRequest GmailUsersMessagesGet where
        ...
        type Scopes GmailUsersMessagesGet =
