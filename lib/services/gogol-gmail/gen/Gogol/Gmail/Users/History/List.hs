...
--
-- /See:/ <https://developers.google.com/workspace/gmail/api/ Gmail API Reference> for @gmail.users.history.list@.
module Gogol.Gmail.Users.History.List
    (
    -- * Resource
               ...
               Core.QueryParam "$.xgafv" Xgafv Core.:>
                 Core.QueryParam "access_token" Core.Text Core.:>
                   Core.QueryParam "callback" Core.Text Core.:>
                     Core.QueryParams "historyTypes" UsersHistoryListHistoryTypes
                       Core.:>
                       Core.QueryParam "labelId" Core.Text Core.:>
                         Core.QueryParam "maxResults" Core.Word32 Core.:>
                           Core.QueryParam "pageToken" Core.Text Core.:>
                             Core.QueryParam "startHistoryId" Core.Word64 Core.:>
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.Get '[Core.JSON] ListHistoryResponse
...
newGmailUsersHistoryList 
    ::  GmailUsersHistoryList
newGmailUsersHistoryList
  = GmailUsersHistoryList{xgafv = Core.Nothing,
                          accessToken = Core.Nothing, callback = Core.Nothing,
                          historyTypes = Core.Nothing, labelId = Core.Nothing,
                          maxResults = 100, pageToken = Core.Nothing,
                          startHistoryId = Core.Nothing, uploadType = Core.Nothing,
...
instance Core.GoogleRequest GmailUsersHistoryList where
        ...
        type Scopes GmailUsersHistoryList =
        ...
        requestClient GmailUsersHistoryList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy GmailUsersHistoryListResource)
                      Core.mempty
