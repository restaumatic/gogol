...
--
-- /See:/ <https://developers.google.com/workspace/gmail/api/ Gmail API Reference> for @gmail.users.stop@.
module Gogol.Gmail.Users.Stop
    (
    -- * Resource
...
newGmailUsersStop 
    ::  GmailUsersStop
newGmailUsersStop
  = GmailUsersStop{xgafv = Core.Nothing, accessToken = Core.Nothing,
