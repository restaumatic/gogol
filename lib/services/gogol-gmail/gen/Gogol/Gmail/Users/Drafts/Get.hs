...
--
-- /See:/ <https://developers.google.com/workspace/gmail/api/ Gmail API Reference> for @gmail.users.drafts.get@.
module Gogol.Gmail.Users.Drafts.Get
    (
    -- * Resource
...
newGmailUsersDraftsGet id
  = GmailUsersDraftsGet{xgafv = Core.Nothing,
                        accessToken = Core.Nothing, callback = Core.Nothing,
                        format = UsersDraftsGetFormat_Full, id = id,
