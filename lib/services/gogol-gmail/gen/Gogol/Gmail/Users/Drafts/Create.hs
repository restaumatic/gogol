...
--
-- /See:/ <https://developers.google.com/workspace/gmail/api/ Gmail API Reference> for @gmail.users.drafts.create@.
module Gogol.Gmail.Users.Drafts.Create
    (
    -- * Resource
...
newGmailUsersDraftsCreate payload
  = GmailUsersDraftsCreate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest GmailUsersDraftsCreate where
        ...
        type Scopes GmailUsersDraftsCreate =
        ...
        requestClient GmailUsersDraftsCreate{..}
          ...
          where go Core.:<|> _
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy GmailUsersDraftsCreateResource)
                      Core.mempty

instance Core.GoogleRequest
           (Core.MediaUpload GmailUsersDraftsCreate)
         where
        type Rs (Core.MediaUpload GmailUsersDraftsCreate) = Draft
        type Scopes (Core.MediaUpload GmailUsersDraftsCreate) =
             Core.Scopes GmailUsersDraftsCreate
        requestClient (Core.MediaUpload GmailUsersDraftsCreate{..} body)
          = go userId xgafv accessToken callback uploadType uploadProtocol
              (Core.Just Core.AltJSON)
