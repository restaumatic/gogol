...
-- |
-- Module      : Gogol.Gmail.Users.Drafts.Update
...
--
-- /See:/ <https://developers.google.com/workspace/gmail/api/ Gmail API Reference> for @gmail.users.drafts.update@.
module Gogol.Gmail.Users.Drafts.Update
    (
    -- * Resource
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] Draft Core.:> Core.Put '[Core.JSON] Draft
       Core.:<|>
       "upload" Core.:>
         "gmail" Core.:>
           "v1" Core.:>
                             ...
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.QueryParam "uploadType" Core.Multipart Core.:>
                                   Core.MultipartRelated '[Core.JSON] Draft Core.:>
                                     Core.Put '[Core.JSON] Draft
...
newGmailUsersDraftsUpdate id payload
  = GmailUsersDraftsUpdate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest GmailUsersDraftsUpdate where
        ...
        type Scopes GmailUsersDraftsUpdate =
             '[Gmail'FullControl, Gmail'Addons'Current'Action'Compose,
               Gmail'Compose, Gmail'Modify]
        requestClient GmailUsersDraftsUpdate{..}
          = go userId id xgafv accessToken callback uploadType uploadProtocol
              (Core.Just Core.AltJSON)
              payload
              gmailService
          where go Core.:<|> _
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy GmailUsersDraftsUpdateResource)
                      Core.mempty

instance Core.GoogleRequest
           (Core.MediaUpload GmailUsersDraftsUpdate)
         where
        type Rs (Core.MediaUpload GmailUsersDraftsUpdate) = Draft
        type Scopes (Core.MediaUpload GmailUsersDraftsUpdate) =
             Core.Scopes GmailUsersDraftsUpdate
        requestClient (Core.MediaUpload GmailUsersDraftsUpdate{..} body)
          = go userId id xgafv accessToken callback uploadType uploadProtocol
              (Core.Just Core.AltJSON)
