...
--
-- /See:/ <https://developers.google.com/workspace/gmail/api/ Gmail API Reference> for @gmail.users.drafts.list@.
module Gogol.Gmail.Users.Drafts.List
    (
    -- * Resource
...
newGmailUsersDraftsList 
    ::  GmailUsersDraftsList
newGmailUsersDraftsList
  = GmailUsersDraftsList{xgafv = Core.Nothing,
                         accessToken = Core.Nothing, callback = Core.Nothing,
                         includeSpamTrash = Core.False, maxResults = 100,
