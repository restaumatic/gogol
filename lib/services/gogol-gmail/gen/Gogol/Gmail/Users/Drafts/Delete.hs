...
--
-- /See:/ <https://developers.google.com/workspace/gmail/api/ Gmail API Reference> for @gmail.users.drafts.delete@.
module Gogol.Gmail.Users.Drafts.Delete
    (
    -- * Resource
...
newGmailUsersDraftsDelete id
  = GmailUsersDraftsDelete{xgafv = Core.Nothing,
...
instance Core.GoogleRequest GmailUsersDraftsDelete where
        ...
        type Scopes GmailUsersDraftsDelete =
