...
newAnalyticsSnapshot 
    ::  AnalyticsSnapshot
newAnalyticsSnapshot
  = AnalyticsSnapshot{browsers = Core.Nothing,
                      countries = Core.Nothing, longUrlClicks = Core.Nothing,
                      platforms = Core.Nothing, referrers = Core.Nothing,
          ...
          = Core.withObject "AnalyticsSnapshot"
              (\ o ->
                 AnalyticsSnapshot Core.<$>
                   (o Core..:? "browsers") Core.<*> (o Core..:? "countries") Core.<*>
                     (o Core..:? "longUrlClicks" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "platforms")
                     Core.<*> (o Core..:? "referrers")
                     Core.<*>
                     (o Core..:? "shortUrlClicks" Core.<&> Core.fmap Core.fromAsText))
          ...
          = Core.object
              (Core.catMaybes
                 [("browsers" Core..=) Core.<$> browsers,
                  ...
                  ("shortUrlClicks" Core..=) Core.. Core.AsText Core.<$>
                    shortUrlClicks])
...
newAnalyticsSummary 
    ::  AnalyticsSummary
newAnalyticsSummary
  = AnalyticsSummary{allTime = Core.Nothing, day = Core.Nothing,
                     month = Core.Nothing, twoHours = Core.Nothing, week = Core.Nothing}
instance Core.FromJSON AnalyticsSummary where
        parseJSON
          = Core.withObject "AnalyticsSummary"
              (\ o ->
                 AnalyticsSummary Core.<$>
                   (o Core..:? "allTime") Core.<*> (o Core..:? "day") Core.<*>
                     (o Core..:? "month")
...
newStringCount 
    ::  StringCount
newStringCount
  = StringCount{count = Core.Nothing, id = Core.Nothing}
...
newUrl 
    ::  Url
newUrl
  = Url{analytics = Core.Nothing, created = Core.Nothing,
        id = Core.Nothing, kind = "urlshortener#url",
        longUrl = Core.Nothing, status = Core.Nothing}
instance Core.FromJSON Url where
        parseJSON
          = Core.withObject "Url"
              (\ o ->
                 Url Core.<$>
                   (o Core..:? "analytics") Core.<*> (o Core..:? "created") Core.<*>
                     (o Core..:? "id")
                     Core.<*> (o Core..:? "kind" Core..!= "urlshortener#url")
                     Core.<*> (o Core..:? "longUrl")
                     Core.<*> (o Core..:? "status"))
...
newUrlHistory 
    ::  UrlHistory
newUrlHistory
  = UrlHistory{items = Core.Nothing, itemsPerPage = Core.Nothing,
               kind = "urlshortener#urlHistory", nextPageToken = Core.Nothing,
              ...
              (\ o ->
                 UrlHistory Core.<$>
                   (o Core..:? "items") Core.<*> (o Core..:? "itemsPerPage") Core.<*>
                     (o Core..:? "kind" Core..!= "urlshortener#urlHistory")
