                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] ListInstanceConfigOperationsResponse
...
newSpannerProjectsInstanceConfigOperationsList parent
  = SpannerProjectsInstanceConfigOperationsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes SpannerProjectsInstanceConfigOperationsList =
