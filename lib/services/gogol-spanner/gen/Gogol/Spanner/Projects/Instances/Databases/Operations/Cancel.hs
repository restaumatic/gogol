...
newSpannerProjectsInstancesDatabasesOperationsCancel name
  = SpannerProjectsInstancesDatabasesOperationsCancel{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           SpannerProjectsInstancesDatabasesOperationsCancel
         where
        type Rs SpannerProjectsInstancesDatabasesOperationsCancel = Empty
        type Scopes SpannerProjectsInstancesDatabasesOperationsCancel =
             '[CloudPlatform'FullControl, Spanner'Admin]
        requestClient SpannerProjectsInstancesDatabasesOperationsCancel{..}
