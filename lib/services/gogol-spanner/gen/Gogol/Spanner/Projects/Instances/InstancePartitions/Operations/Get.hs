...
newSpannerProjectsInstancesInstancePartitionsOperationsGet name
  = SpannerProjectsInstancesInstancePartitionsOperationsGet{xgafv =
                                                              Core.Nothing,
...
instance Core.GoogleRequest
           SpannerProjectsInstancesInstancePartitionsOperationsGet
         where
        type Rs SpannerProjectsInstancesInstancePartitionsOperationsGet =
             Operation
        type Scopes SpannerProjectsInstancesInstancePartitionsOperationsGet
