...
newSpannerProjectsInstancesBackupsGet name
  = SpannerProjectsInstancesBackupsGet{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       name = name, uploadType = Core.Nothing,
                                       uploadProtocol = Core.Nothing}
instance Core.GoogleRequest SpannerProjectsInstancesBackupsGet
         where
        type Rs SpannerProjectsInstancesBackupsGet = Backup
        type Scopes SpannerProjectsInstancesBackupsGet =
