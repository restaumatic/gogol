...
type SpannerProjectsInstancesDatabasesSessionsReadResource =
     "v1" Core.:>
       Core.CaptureMode "session" "read" Core.Text Core.:>
...
newSpannerProjectsInstancesDatabasesSessionsRead payload session
  = SpannerProjectsInstancesDatabasesSessionsRead{xgafv =
                                                    Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes SpannerProjectsInstancesDatabasesSessionsRead =
