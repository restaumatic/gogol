...
newSpannerProjectsInstancesBackupsDelete name
  = SpannerProjectsInstancesBackupsDelete{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          name = name, uploadType = Core.Nothing,
                                          uploadProtocol = Core.Nothing}
instance Core.GoogleRequest SpannerProjectsInstancesBackupsDelete
         where
        type Rs SpannerProjectsInstancesBackupsDelete = Empty
        type Scopes SpannerProjectsInstancesBackupsDelete =
             '[CloudPlatform'FullControl, Spanner'Admin]
        requestClient SpannerProjectsInstancesBackupsDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy SpannerProjectsInstancesBackupsDeleteResource)
                      Core.mempty
