...
newSpannerProjectsInstancesDatabasesDatabaseRolesList parent
  = SpannerProjectsInstancesDatabasesDatabaseRolesList{xgafv =
                                                         Core.Nothing,
...
instance Core.GoogleRequest
           SpannerProjectsInstancesDatabasesDatabaseRolesList
         where
        type Rs SpannerProjectsInstancesDatabasesDatabaseRolesList =
             ListDatabaseRolesResponse
        type Scopes SpannerProjectsInstancesDatabasesDatabaseRolesList =
