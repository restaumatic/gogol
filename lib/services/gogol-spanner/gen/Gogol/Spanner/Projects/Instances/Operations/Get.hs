...
newSpannerProjectsInstancesOperationsGet name
  = SpannerProjectsInstancesOperationsGet{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          name = name, uploadType = Core.Nothing,
                                          uploadProtocol = Core.Nothing}
instance Core.GoogleRequest SpannerProjectsInstancesOperationsGet
         where
        type Rs SpannerProjectsInstancesOperationsGet = Operation
        type Scopes SpannerProjectsInstancesOperationsGet =
