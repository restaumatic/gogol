...
type SpannerProjectsInstancesDatabasesSessionsBatchWriteResource =
     "v1" Core.:>
       Core.CaptureMode "session" "batchWrite" Core.Text Core.:>
...
newSpannerProjectsInstancesDatabasesSessionsBatchWrite 
    ...
    -> SpannerProjectsInstancesDatabasesSessionsBatchWrite
newSpannerProjectsInstancesDatabasesSessionsBatchWrite payload
  session
  = SpannerProjectsInstancesDatabasesSessionsBatchWrite{xgafv =
                                                          Core.Nothing,
...
instance Core.GoogleRequest
           SpannerProjectsInstancesDatabasesSessionsBatchWrite
         where
        type Rs SpannerProjectsInstancesDatabasesSessionsBatchWrite =
             BatchWriteResponse
        type Scopes SpannerProjectsInstancesDatabasesSessionsBatchWrite =
