                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] CreateInstancePartitionRequest Core.:>
...
newSpannerProjectsInstancesInstancePartitionsCreate parent payload
  = SpannerProjectsInstancesInstancePartitionsCreate{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           SpannerProjectsInstancesInstancePartitionsCreate
         where
        type Rs SpannerProjectsInstancesInstancePartitionsCreate =
             Operation
        type Scopes SpannerProjectsInstancesInstancePartitionsCreate =
