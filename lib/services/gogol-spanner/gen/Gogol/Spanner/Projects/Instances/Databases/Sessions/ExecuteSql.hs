...
type SpannerProjectsInstancesDatabasesSessionsExecuteSqlResource =
     "v1" Core.:>
       Core.CaptureMode "session" "executeSql" Core.Text Core.:>
...
newSpannerProjectsInstancesDatabasesSessionsExecuteSql 
    ...
    -> SpannerProjectsInstancesDatabasesSessionsExecuteSql
newSpannerProjectsInstancesDatabasesSessionsExecuteSql payload
  session
  = SpannerProjectsInstancesDatabasesSessionsExecuteSql{xgafv =
                                                          Core.Nothing,
...
instance Core.GoogleRequest
           SpannerProjectsInstancesDatabasesSessionsExecuteSql
         where
        type Rs SpannerProjectsInstancesDatabasesSessionsExecuteSql =
             ResultSet
        type Scopes SpannerProjectsInstancesDatabasesSessionsExecuteSql =
