...
newSpannerProjectsInstancesDatabasesBackupSchedulesCreate 
    ...
    -> SpannerProjectsInstancesDatabasesBackupSchedulesCreate
newSpannerProjectsInstancesDatabasesBackupSchedulesCreate parent
  payload
  = SpannerProjectsInstancesDatabasesBackupSchedulesCreate{xgafv =
                                                             Core.Nothing,
...
instance Core.GoogleRequest
           SpannerProjectsInstancesDatabasesBackupSchedulesCreate
         where
        type Rs SpannerProjectsInstancesDatabasesBackupSchedulesCreate =
             BackupSchedule
        type Scopes SpannerProjectsInstancesDatabasesBackupSchedulesCreate
             = '[CloudPlatform'FullControl, Spanner'Admin]
        requestClient
          SpannerProjectsInstancesDatabasesBackupSchedulesCreate{..}
          = go parent xgafv accessToken backupScheduleId callback uploadType
              uploadProtocol
