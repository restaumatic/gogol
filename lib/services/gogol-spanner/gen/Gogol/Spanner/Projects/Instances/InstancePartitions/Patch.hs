               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] UpdateInstancePartitionRequest Core.:>
...
newSpannerProjectsInstancesInstancePartitionsPatch name payload
  = SpannerProjectsInstancesInstancePartitionsPatch{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           SpannerProjectsInstancesInstancePartitionsPatch
         where
        type Rs SpannerProjectsInstancesInstancePartitionsPatch = Operation
        type Scopes SpannerProjectsInstancesInstancePartitionsPatch =
             '[CloudPlatform'FullControl, Spanner'Admin]
        requestClient SpannerProjectsInstancesInstancePartitionsPatch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy SpannerProjectsInstancesInstancePartitionsPatchResource)
                      Core.mempty
