...
type SpannerProjectsInstancesDatabasesAddSplitPointsResource =
     "v1" Core.:>
       Core.CaptureMode "database" "addSplitPoints" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] AddSplitPointsRequest Core.:>
                       Core.Post '[Core.JSON] AddSplitPointsResponse
...
newSpannerProjectsInstancesDatabasesAddSplitPoints 
    :: 
                                                   Core.Text
       -- ^  Required. The database on whose tables or indexes the split points are to be added. Values are of the form @projects\/\/instances\/\/databases\/@. See 'database'.
    -> AddSplitPointsRequest
       -- ^  Multipart request metadata. See 'payload'.
    -> SpannerProjectsInstancesDatabasesAddSplitPoints
newSpannerProjectsInstancesDatabasesAddSplitPoints database payload
  = SpannerProjectsInstancesDatabasesAddSplitPoints{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           SpannerProjectsInstancesDatabasesAddSplitPoints
         where
        type Rs SpannerProjectsInstancesDatabasesAddSplitPoints =
             AddSplitPointsResponse
        type Scopes SpannerProjectsInstancesDatabasesAddSplitPoints =
