...
newSpannerProjectsInstancesDatabasesTestIamPermissions 
    ...
    -> SpannerProjectsInstancesDatabasesTestIamPermissions
newSpannerProjectsInstancesDatabasesTestIamPermissions payload
  resource
  = SpannerProjectsInstancesDatabasesTestIamPermissions{xgafv =
                                                          Core.Nothing,
...
instance Core.GoogleRequest
           SpannerProjectsInstancesDatabasesTestIamPermissions
         where
        type Rs SpannerProjectsInstancesDatabasesTestIamPermissions =
             TestIamPermissionsResponse
        type Scopes SpannerProjectsInstancesDatabasesTestIamPermissions =
