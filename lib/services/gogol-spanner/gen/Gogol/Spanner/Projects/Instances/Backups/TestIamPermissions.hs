...
newSpannerProjectsInstancesBackupsTestIamPermissions 
    ...
    -> SpannerProjectsInstancesBackupsTestIamPermissions
newSpannerProjectsInstancesBackupsTestIamPermissions payload
  resource
  = SpannerProjectsInstancesBackupsTestIamPermissions{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           SpannerProjectsInstancesBackupsTestIamPermissions
         where
        type Rs SpannerProjectsInstancesBackupsTestIamPermissions =
             TestIamPermissionsResponse
        type Scopes SpannerProjectsInstancesBackupsTestIamPermissions =
             '[CloudPlatform'FullControl, Spanner'Admin]
        requestClient SpannerProjectsInstancesBackupsTestIamPermissions{..}
