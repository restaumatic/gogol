...
newSpannerProjectsInstancesOperationsList name
  = SpannerProjectsInstancesOperationsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest SpannerProjectsInstancesOperationsList
         where
        type Rs SpannerProjectsInstancesOperationsList =
             ListOperationsResponse
        type Scopes SpannerProjectsInstancesOperationsList =
             '[CloudPlatform'FullControl, Spanner'Admin]
        requestClient SpannerProjectsInstancesOperationsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy SpannerProjectsInstancesOperationsListResource)
                      Core.mempty
