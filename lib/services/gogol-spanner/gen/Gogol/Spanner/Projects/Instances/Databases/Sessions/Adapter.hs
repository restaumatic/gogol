                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] AdapterSession Core.:>
                         Core.Post '[Core.JSON] AdapterSession
...
newSpannerProjectsInstancesDatabasesSessionsAdapter parent payload
  = SpannerProjectsInstancesDatabasesSessionsAdapter{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           SpannerProjectsInstancesDatabasesSessionsAdapter
         where
        type Rs SpannerProjectsInstancesDatabasesSessionsAdapter =
             AdapterSession
        type Scopes SpannerProjectsInstancesDatabasesSessionsAdapter =
