...
newSpannerProjectsInstancesBackupsCopy parent payload
  = SpannerProjectsInstancesBackupsCopy{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        parent = parent, payload = payload,
                                        uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest SpannerProjectsInstancesBackupsCopy
         where
        type Rs SpannerProjectsInstancesBackupsCopy = Operation
        type Scopes SpannerProjectsInstancesBackupsCopy =
