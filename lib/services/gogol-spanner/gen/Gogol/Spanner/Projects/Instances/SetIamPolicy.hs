...
instance Core.GoogleRequest SpannerProjectsInstancesSetIamPolicy
        ...
        requestClient SpannerProjectsInstancesSetIamPolicy{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy SpannerProjectsInstancesSetIamPolicyResource)
                      Core.mempty
