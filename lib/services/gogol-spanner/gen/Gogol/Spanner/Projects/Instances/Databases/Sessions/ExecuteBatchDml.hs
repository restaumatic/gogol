...
type SpannerProjectsInstancesDatabasesSessionsExecuteBatchDmlResource
     =
     "v1" Core.:>
       Core.CaptureMode "session" "executeBatchDml" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] ExecuteBatchDmlRequest Core.:>
...
newSpannerProjectsInstancesDatabasesSessionsExecuteBatchDml 
    ...
    -> SpannerProjectsInstancesDatabasesSessionsExecuteBatchDml
newSpannerProjectsInstancesDatabasesSessionsExecuteBatchDml payload
  session
  = SpannerProjectsInstancesDatabasesSessionsExecuteBatchDml{xgafv =
                                                               Core.Nothing,
...
instance Core.GoogleRequest
           SpannerProjectsInstancesDatabasesSessionsExecuteBatchDml
         where
        type Rs SpannerProjectsInstancesDatabasesSessionsExecuteBatchDml =
