               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.Get '[Core.JSON] InstancePartition
...
newSpannerProjectsInstancesInstancePartitionsGet name
  = SpannerProjectsInstancesInstancePartitionsGet{xgafv =
                                                    Core.Nothing,
...
instance Core.GoogleRequest
           SpannerProjectsInstancesInstancePartitionsGet
         where
        type Rs SpannerProjectsInstancesInstancePartitionsGet =
             InstancePartition
        type Scopes SpannerProjectsInstancesInstancePartitionsGet =
