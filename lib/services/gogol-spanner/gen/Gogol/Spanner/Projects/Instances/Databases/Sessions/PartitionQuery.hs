...
type SpannerProjectsInstancesDatabasesSessionsPartitionQueryResource
     =
     "v1" Core.:>
       Core.CaptureMode "session" "partitionQuery" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] PartitionQueryRequest Core.:>
                       Core.Post '[Core.JSON] PartitionResponse
...
newSpannerProjectsInstancesDatabasesSessionsPartitionQuery 
    ...
    -> SpannerProjectsInstancesDatabasesSessionsPartitionQuery
newSpannerProjectsInstancesDatabasesSessionsPartitionQuery payload
  session
  = SpannerProjectsInstancesDatabasesSessionsPartitionQuery{xgafv =
                                                              Core.Nothing,
...
instance Core.GoogleRequest
           SpannerProjectsInstancesDatabasesSessionsPartitionQuery
         where
        type Rs SpannerProjectsInstancesDatabasesSessionsPartitionQuery =
             PartitionResponse
        type Scopes SpannerProjectsInstancesDatabasesSessionsPartitionQuery
