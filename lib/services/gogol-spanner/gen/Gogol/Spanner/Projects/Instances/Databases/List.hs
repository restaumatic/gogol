...
-- |
-- Module      : Gogol.Spanner.Projects.Instances.Databases.List
                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] ListDatabasesResponse
...
newSpannerProjectsInstancesDatabasesList parent
  = SpannerProjectsInstancesDatabasesList{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          pageSize = Core.Nothing, pageToken = Core.Nothing,
                                          parent = parent, uploadType = Core.Nothing,
                                          uploadProtocol = Core.Nothing}
instance Core.GoogleRequest SpannerProjectsInstancesDatabasesList
         where
        type Rs SpannerProjectsInstancesDatabasesList =
             ListDatabasesResponse
        type Scopes SpannerProjectsInstancesDatabasesList =
             '[CloudPlatform'FullControl, Spanner'Admin]
        requestClient SpannerProjectsInstancesDatabasesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy SpannerProjectsInstancesDatabasesListResource)
                      Core.mempty
