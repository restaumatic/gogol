...
newSpannerProjectsInstancesOperationsCancel name
  = SpannerProjectsInstancesOperationsCancel{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           SpannerProjectsInstancesOperationsCancel
         where
        type Rs SpannerProjectsInstancesOperationsCancel = Empty
        type Scopes SpannerProjectsInstancesOperationsCancel =
             '[CloudPlatform'FullControl, Spanner'Admin]
        requestClient SpannerProjectsInstancesOperationsCancel{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy SpannerProjectsInstancesOperationsCancelResource)
                      Core.mempty
