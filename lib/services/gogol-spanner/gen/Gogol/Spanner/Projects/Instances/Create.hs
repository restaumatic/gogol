...
newSpannerProjectsInstancesCreate parent payload
  = SpannerProjectsInstancesCreate{xgafv = Core.Nothing,
                                   accessToken = Core.Nothing, callback = Core.Nothing,
                                   parent = parent, payload = payload, uploadType = Core.Nothing,
                                   uploadProtocol = Core.Nothing}
instance Core.GoogleRequest SpannerProjectsInstancesCreate where
        type Rs SpannerProjectsInstancesCreate = Operation
        type Scopes SpannerProjectsInstancesCreate =
        ...
        requestClient SpannerProjectsInstancesCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy SpannerProjectsInstancesCreateResource)
                      Core.mempty
