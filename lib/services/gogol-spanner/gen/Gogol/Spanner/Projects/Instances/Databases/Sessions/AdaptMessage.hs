...
type SpannerProjectsInstancesDatabasesSessionsAdaptMessageResource
     =
     "v1" Core.:>
       Core.CaptureMode "name" "adaptMessage" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] AdaptMessageRequest Core.:>
                       Core.Post '[Core.JSON] AdaptMessageResponse
...
newSpannerProjectsInstancesDatabasesSessionsAdaptMessage 
    ...
    -> SpannerProjectsInstancesDatabasesSessionsAdaptMessage
newSpannerProjectsInstancesDatabasesSessionsAdaptMessage name
  payload
  = SpannerProjectsInstancesDatabasesSessionsAdaptMessage{xgafv =
                                                            Core.Nothing,
...
instance Core.GoogleRequest
           SpannerProjectsInstancesDatabasesSessionsAdaptMessage
         where
        type Rs SpannerProjectsInstancesDatabasesSessionsAdaptMessage =
             AdaptMessageResponse
        type Scopes SpannerProjectsInstancesDatabasesSessionsAdaptMessage =
