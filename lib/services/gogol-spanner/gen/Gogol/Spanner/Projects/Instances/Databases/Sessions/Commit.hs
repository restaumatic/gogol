...
type SpannerProjectsInstancesDatabasesSessionsCommitResource =
     "v1" Core.:>
       Core.CaptureMode "session" "commit" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] CommitRequest Core.:>
                       Core.Post '[Core.JSON] CommitResponse
...
newSpannerProjectsInstancesDatabasesSessionsCommit payload session
  = SpannerProjectsInstancesDatabasesSessionsCommit{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           SpannerProjectsInstancesDatabasesSessionsCommit
         where
        type Rs SpannerProjectsInstancesDatabasesSessionsCommit =
             CommitResponse
        type Scopes SpannerProjectsInstancesDatabasesSessionsCommit =
