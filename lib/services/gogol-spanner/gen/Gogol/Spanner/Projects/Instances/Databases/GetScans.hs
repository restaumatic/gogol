                   ...
                   Core.QueryParam "startTime" Core.DateTime Core.:>
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "view" ProjectsInstancesDatabasesGetScansView
                           Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] Scan
...
newSpannerProjectsInstancesDatabasesGetScans name
  = SpannerProjectsInstancesDatabasesGetScans{xgafv = Core.Nothing,
                                              accessToken = Core.Nothing, callback = Core.Nothing,
                                              endTime = Core.Nothing, name = name,
...
instance Core.GoogleRequest
        ...
        type Scopes SpannerProjectsInstancesDatabasesGetScans =
             '[CloudPlatform'FullControl, Spanner'Data]
        requestClient SpannerProjectsInstancesDatabasesGetScans{..}
          = go name xgafv accessToken callback endTime startTime uploadType
              uploadProtocol
              view
