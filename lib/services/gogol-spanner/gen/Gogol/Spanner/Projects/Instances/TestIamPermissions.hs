...
newSpannerProjectsInstancesTestIamPermissions payload resource
  = SpannerProjectsInstancesTestIamPermissions{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes SpannerProjectsInstancesTestIamPermissions =
             '[CloudPlatform'FullControl, Spanner'Admin]
        requestClient SpannerProjectsInstancesTestIamPermissions{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy SpannerProjectsInstancesTestIamPermissionsResource)
                      Core.mempty
