...
newSpannerProjectsInstancesDatabasesBackupSchedulesDelete name
  = SpannerProjectsInstancesDatabasesBackupSchedulesDelete{xgafv =
                                                             Core.Nothing,
...
instance Core.GoogleRequest
           SpannerProjectsInstancesDatabasesBackupSchedulesDelete
         where
        type Rs SpannerProjectsInstancesDatabasesBackupSchedulesDelete =
             Empty
        type Scopes SpannerProjectsInstancesDatabasesBackupSchedulesDelete
