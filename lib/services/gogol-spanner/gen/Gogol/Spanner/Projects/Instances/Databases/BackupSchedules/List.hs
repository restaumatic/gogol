...
newSpannerProjectsInstancesDatabasesBackupSchedulesList parent
  = SpannerProjectsInstancesDatabasesBackupSchedulesList{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           SpannerProjectsInstancesDatabasesBackupSchedulesList
         where
        type Rs SpannerProjectsInstancesDatabasesBackupSchedulesList =
             ListBackupSchedulesResponse
        type Scopes SpannerProjectsInstancesDatabasesBackupSchedulesList =
