...
newSpannerProjectsInstancesBackupsSetIamPolicy payload resource
  = SpannerProjectsInstancesBackupsSetIamPolicy{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           SpannerProjectsInstancesBackupsSetIamPolicy
         where
        type Rs SpannerProjectsInstancesBackupsSetIamPolicy = Policy
        type Scopes SpannerProjectsInstancesBackupsSetIamPolicy =
             '[CloudPlatform'FullControl, Spanner'Admin]
        requestClient SpannerProjectsInstancesBackupsSetIamPolicy{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy SpannerProjectsInstancesBackupsSetIamPolicyResource)
                      Core.mempty
