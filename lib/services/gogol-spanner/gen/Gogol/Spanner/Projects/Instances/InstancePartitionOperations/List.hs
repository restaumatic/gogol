                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Get '[Core.JSON] ListInstancePartitionOperationsResponse
...
newSpannerProjectsInstancesInstancePartitionOperationsList parent
  = SpannerProjectsInstancesInstancePartitionOperationsList{xgafv =
                                                              Core.Nothing,
...
instance Core.GoogleRequest
           SpannerProjectsInstancesInstancePartitionOperationsList
         where
        type Rs SpannerProjectsInstancesInstancePartitionOperationsList =
             ListInstancePartitionOperationsResponse
        type Scopes SpannerProjectsInstancesInstancePartitionOperationsList
