                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.Get '[Core.JSON] GetDatabaseDdlResponse
...
newSpannerProjectsInstancesDatabasesGetDdl database
  = SpannerProjectsInstancesDatabasesGetDdl{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            database = database, uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest SpannerProjectsInstancesDatabasesGetDdl
         where
        type Rs SpannerProjectsInstancesDatabasesGetDdl =
             GetDatabaseDdlResponse
        type Scopes SpannerProjectsInstancesDatabasesGetDdl =
