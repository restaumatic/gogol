               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] UpdateInstanceRequest Core.:>
...
newSpannerProjectsInstancesPatch name payload
  = SpannerProjectsInstancesPatch{xgafv = Core.Nothing,
                                  accessToken = Core.Nothing, callback = Core.Nothing, name = name,
                                  payload = payload, uploadType = Core.Nothing,
                                  uploadProtocol = Core.Nothing}
instance Core.GoogleRequest SpannerProjectsInstancesPatch where
        type Rs SpannerProjectsInstancesPatch = Operation
        type Scopes SpannerProjectsInstancesPatch =
        ...
        requestClient SpannerProjectsInstancesPatch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy SpannerProjectsInstancesPatchResource)
                      Core.mempty
