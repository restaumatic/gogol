...
type SpannerProjectsInstancesDatabasesSessionsPartitionReadResource
     =
     "v1" Core.:>
       Core.CaptureMode "session" "partitionRead" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] PartitionReadRequest Core.:>
...
newSpannerProjectsInstancesDatabasesSessionsPartitionRead 
    ...
    -> SpannerProjectsInstancesDatabasesSessionsPartitionRead
newSpannerProjectsInstancesDatabasesSessionsPartitionRead payload
  session
  = SpannerProjectsInstancesDatabasesSessionsPartitionRead{xgafv =
                                                             Core.Nothing,
...
instance Core.GoogleRequest
           SpannerProjectsInstancesDatabasesSessionsPartitionRead
         where
        type Rs SpannerProjectsInstancesDatabasesSessionsPartitionRead =
             PartitionResponse
        type Scopes SpannerProjectsInstancesDatabasesSessionsPartitionRead
