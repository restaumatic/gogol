...
newSpannerProjectsInstancesDatabasesSessionsList database
  = SpannerProjectsInstancesDatabasesSessionsList{xgafv =
                                                    Core.Nothing,
...
instance Core.GoogleRequest
           SpannerProjectsInstancesDatabasesSessionsList
         where
        type Rs SpannerProjectsInstancesDatabasesSessionsList =
             ListSessionsResponse
        type Scopes SpannerProjectsInstancesDatabasesSessionsList =
             '[CloudPlatform'FullControl, Spanner'Data]
        requestClient SpannerProjectsInstancesDatabasesSessionsList{..}
          = go database xgafv accessToken callback filter pageSize pageToken
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy SpannerProjectsInstancesDatabasesSessionsListResource)
                      Core.mempty
