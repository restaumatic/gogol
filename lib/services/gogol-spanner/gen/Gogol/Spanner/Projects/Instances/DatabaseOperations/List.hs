                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] ListDatabaseOperationsResponse
...
newSpannerProjectsInstancesDatabaseOperationsList parent
  = SpannerProjectsInstancesDatabaseOperationsList{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           SpannerProjectsInstancesDatabaseOperationsList
         where
        type Rs SpannerProjectsInstancesDatabaseOperationsList =
             ListDatabaseOperationsResponse
        type Scopes SpannerProjectsInstancesDatabaseOperationsList =
