                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] BatchCreateSessionsRequest Core.:>
...
newSpannerProjectsInstancesDatabasesSessionsBatchCreate 
    ...
    -> SpannerProjectsInstancesDatabasesSessionsBatchCreate
newSpannerProjectsInstancesDatabasesSessionsBatchCreate database
  payload
  = SpannerProjectsInstancesDatabasesSessionsBatchCreate{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           SpannerProjectsInstancesDatabasesSessionsBatchCreate
         where
        type Rs SpannerProjectsInstancesDatabasesSessionsBatchCreate =
             BatchCreateSessionsResponse
        type Scopes SpannerProjectsInstancesDatabasesSessionsBatchCreate =
