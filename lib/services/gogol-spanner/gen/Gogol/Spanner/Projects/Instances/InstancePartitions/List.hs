           ...
           Core.QueryParam "$.xgafv" Xgafv Core.:>
             Core.QueryParam "access_token" Core.Text Core.:>
               Core.QueryParam "callback" Core.Text Core.:>
                 Core.QueryParam "instancePartitionDeadline" Core.DateTime Core.:>
                   Core.QueryParam "pageSize" Core.Int32 Core.:>
                     Core.QueryParam "pageToken" Core.Text Core.:>
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] ListInstancePartitionsResponse
...
newSpannerProjectsInstancesInstancePartitionsList parent
  = SpannerProjectsInstancesInstancePartitionsList{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           SpannerProjectsInstancesInstancePartitionsList
         where
        type Rs SpannerProjectsInstancesInstancePartitionsList =
             ListInstancePartitionsResponse
        type Scopes SpannerProjectsInstancesInstancePartitionsList =
             '[CloudPlatform'FullControl, Spanner'Admin]
        requestClient SpannerProjectsInstancesInstancePartitionsList{..}
          = go parent xgafv accessToken callback instancePartitionDeadline
              pageSize
              pageToken
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy SpannerProjectsInstancesInstancePartitionsListResource)
                      Core.mempty
