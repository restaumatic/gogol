...
newSpannerProjectsInstancesDatabasesPatch name payload
  = SpannerProjectsInstancesDatabasesPatch{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           name = name, payload = payload,
                                           updateMask = Core.Nothing, uploadType = Core.Nothing,
                                           uploadProtocol = Core.Nothing}
instance Core.GoogleRequest SpannerProjectsInstancesDatabasesPatch
         where
        type Rs SpannerProjectsInstancesDatabasesPatch = Operation
        type Scopes SpannerProjectsInstancesDatabasesPatch =
