...
type SpannerProjectsInstancesDatabasesChangequorumResource =
     "v1" Core.:>
       Core.CaptureMode "name" "changequorum" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] ChangeQuorumRequest Core.:>
...
newSpannerProjectsInstancesDatabasesChangequorum name payload
  = SpannerProjectsInstancesDatabasesChangequorum{xgafv =
                                                    Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes SpannerProjectsInstancesDatabasesChangequorum =
