...
-- |
-- Module      : Gogol.Spanner.Projects.Instances.Databases.Sessions.StreamingRead
...
type SpannerProjectsInstancesDatabasesSessionsStreamingReadResource
     =
     "v1" Core.:>
       Core.CaptureMode "session" "streamingRead" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] ReadRequest Core.:>
...
newSpannerProjectsInstancesDatabasesSessionsStreamingRead 
    ...
    -> SpannerProjectsInstancesDatabasesSessionsStreamingRead
newSpannerProjectsInstancesDatabasesSessionsStreamingRead payload
  session
  = SpannerProjectsInstancesDatabasesSessionsStreamingRead{xgafv =
                                                             Core.Nothing,
...
instance Core.GoogleRequest
           SpannerProjectsInstancesDatabasesSessionsStreamingRead
         where
        type Rs SpannerProjectsInstancesDatabasesSessionsStreamingRead =
             PartialResultSet
        type Scopes SpannerProjectsInstancesDatabasesSessionsStreamingRead
             = '[CloudPlatform'FullControl, Spanner'Data]
        requestClient
          SpannerProjectsInstancesDatabasesSessionsStreamingRead{..}
          = go session xgafv accessToken callback uploadType uploadProtocol
