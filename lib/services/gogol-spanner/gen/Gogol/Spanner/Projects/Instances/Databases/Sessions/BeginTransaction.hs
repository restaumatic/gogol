...
type SpannerProjectsInstancesDatabasesSessionsBeginTransactionResource
     =
     "v1" Core.:>
       Core.CaptureMode "session" "beginTransaction" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] BeginTransactionRequest Core.:>
                       Core.Post '[Core.JSON] Transaction
...
newSpannerProjectsInstancesDatabasesSessionsBeginTransaction
  payload session
  = SpannerProjectsInstancesDatabasesSessionsBeginTransaction{xgafv =
                                                                Core.Nothing,
...
instance Core.GoogleRequest
           SpannerProjectsInstancesDatabasesSessionsBeginTransaction
         where
        type Rs SpannerProjectsInstancesDatabasesSessionsBeginTransaction =
             Transaction
        type Scopes
               SpannerProjectsInstancesDatabasesSessionsBeginTransaction
