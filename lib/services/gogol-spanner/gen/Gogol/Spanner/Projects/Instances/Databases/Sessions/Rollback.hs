...
type SpannerProjectsInstancesDatabasesSessionsRollbackResource =
     "v1" Core.:>
       Core.CaptureMode "session" "rollback" Core.Text Core.:>
...
newSpannerProjectsInstancesDatabasesSessionsRollback 
    ...
    -> SpannerProjectsInstancesDatabasesSessionsRollback
newSpannerProjectsInstancesDatabasesSessionsRollback payload
  session
  = SpannerProjectsInstancesDatabasesSessionsRollback{xgafv =
                                                        Core.Nothing,
                                                      accessToken = Core.Nothing,
                                                      callback = Core.Nothing, payload = payload,
                                                      session = session, uploadType = Core.Nothing,
                                                      uploadProtocol = Core.Nothing}
instance Core.GoogleRequest
           SpannerProjectsInstancesDatabasesSessionsRollback
         where
        type Rs SpannerProjectsInstancesDatabasesSessionsRollback = Empty
        type Scopes SpannerProjectsInstancesDatabasesSessionsRollback =
             '[CloudPlatform'FullControl, Spanner'Data]
        requestClient SpannerProjectsInstancesDatabasesSessionsRollback{..}
