...
-- |
-- Module      : Gogol.Spanner.Projects.Instances.Databases.Operations.Delete
...
newSpannerProjectsInstancesDatabasesOperationsDelete name
  = SpannerProjectsInstancesDatabasesOperationsDelete{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           SpannerProjectsInstancesDatabasesOperationsDelete
         where
        type Rs SpannerProjectsInstancesDatabasesOperationsDelete = Empty
        type Scopes SpannerProjectsInstancesDatabasesOperationsDelete =
             '[CloudPlatform'FullControl, Spanner'Admin]
        requestClient SpannerProjectsInstancesDatabasesOperationsDelete{..}
