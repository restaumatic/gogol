                   ...
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] BackupSchedule Core.:>
                         Core.Patch '[Core.JSON] BackupSchedule
...
newSpannerProjectsInstancesDatabasesBackupSchedulesPatch 
    ...
    -> SpannerProjectsInstancesDatabasesBackupSchedulesPatch
newSpannerProjectsInstancesDatabasesBackupSchedulesPatch name
  payload
  = SpannerProjectsInstancesDatabasesBackupSchedulesPatch{xgafv =
                                                            Core.Nothing,
...
instance Core.GoogleRequest
           SpannerProjectsInstancesDatabasesBackupSchedulesPatch
         where
        type Rs SpannerProjectsInstancesDatabasesBackupSchedulesPatch =
             BackupSchedule
        type Scopes SpannerProjectsInstancesDatabasesBackupSchedulesPatch =
