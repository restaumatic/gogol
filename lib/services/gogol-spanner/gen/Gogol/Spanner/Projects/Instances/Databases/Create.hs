                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] CreateDatabaseRequest Core.:>
...
newSpannerProjectsInstancesDatabasesCreate parent payload
  = SpannerProjectsInstancesDatabasesCreate{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            parent = parent, payload = payload,
                                            uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest SpannerProjectsInstancesDatabasesCreate
         where
        type Rs SpannerProjectsInstancesDatabasesCreate = Operation
        type Scopes SpannerProjectsInstancesDatabasesCreate =
             '[CloudPlatform'FullControl, Spanner'Admin]
        requestClient SpannerProjectsInstancesDatabasesCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy SpannerProjectsInstancesDatabasesCreateResource)
                      Core.mempty
