                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] CreateInstanceConfigRequest Core.:>
...
newSpannerProjectsInstanceConfigsCreate parent payload
  = SpannerProjectsInstanceConfigsCreate{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         parent = parent, payload = payload,
                                         uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest SpannerProjectsInstanceConfigsCreate
         where
        type Rs SpannerProjectsInstanceConfigsCreate = Operation
        type Scopes SpannerProjectsInstanceConfigsCreate =
             '[CloudPlatform'FullControl, Spanner'Admin]
        requestClient SpannerProjectsInstanceConfigsCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy SpannerProjectsInstanceConfigsCreateResource)
                      Core.mempty
