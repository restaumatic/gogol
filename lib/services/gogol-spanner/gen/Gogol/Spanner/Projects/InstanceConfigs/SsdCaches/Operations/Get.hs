...
newSpannerProjectsInstanceConfigsSsdCachesOperationsGet name
  = SpannerProjectsInstanceConfigsSsdCachesOperationsGet{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           SpannerProjectsInstanceConfigsSsdCachesOperationsGet
         where
        type Rs SpannerProjectsInstanceConfigsSsdCachesOperationsGet =
             Operation
        type Scopes SpannerProjectsInstanceConfigsSsdCachesOperationsGet =
