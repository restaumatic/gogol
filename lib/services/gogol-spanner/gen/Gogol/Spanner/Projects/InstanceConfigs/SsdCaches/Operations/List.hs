...
newSpannerProjectsInstanceConfigsSsdCachesOperationsList name
  = SpannerProjectsInstanceConfigsSsdCachesOperationsList{xgafv =
                                                            Core.Nothing,
...
instance Core.GoogleRequest
           SpannerProjectsInstanceConfigsSsdCachesOperationsList
         where
        type Rs SpannerProjectsInstanceConfigsSsdCachesOperationsList =
             ListOperationsResponse
        type Scopes SpannerProjectsInstanceConfigsSsdCachesOperationsList =
