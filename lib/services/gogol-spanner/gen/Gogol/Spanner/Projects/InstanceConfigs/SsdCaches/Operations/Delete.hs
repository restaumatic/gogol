...
newSpannerProjectsInstanceConfigsSsdCachesOperationsDelete name
  = SpannerProjectsInstanceConfigsSsdCachesOperationsDelete{xgafv =
                                                              Core.Nothing,
...
instance Core.GoogleRequest
           SpannerProjectsInstanceConfigsSsdCachesOperationsDelete
         where
        type Rs SpannerProjectsInstanceConfigsSsdCachesOperationsDelete =
             Empty
        type Scopes SpannerProjectsInstanceConfigsSsdCachesOperationsDelete
