...
newSpannerProjectsInstanceConfigsSsdCachesOperationsCancel name
  = SpannerProjectsInstanceConfigsSsdCachesOperationsCancel{xgafv =
                                                              Core.Nothing,
...
instance Core.GoogleRequest
           SpannerProjectsInstanceConfigsSsdCachesOperationsCancel
         where
        type Rs SpannerProjectsInstanceConfigsSsdCachesOperationsCancel =
             Empty
        type Scopes SpannerProjectsInstanceConfigsSsdCachesOperationsCancel
