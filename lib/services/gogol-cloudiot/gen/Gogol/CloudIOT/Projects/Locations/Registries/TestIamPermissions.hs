...
newCloudIOTProjectsLocationsRegistriesTestIamPermissions 
    ...
    -> CloudIOTProjectsLocationsRegistriesTestIamPermissions
newCloudIOTProjectsLocationsRegistriesTestIamPermissions payload
  resource
  = CloudIOTProjectsLocationsRegistriesTestIamPermissions{xgafv =
                                                            Core.Nothing,
...
instance Core.GoogleRequest
           CloudIOTProjectsLocationsRegistriesTestIamPermissions
         where
        type Rs CloudIOTProjectsLocationsRegistriesTestIamPermissions =
             TestIamPermissionsResponse
        type Scopes CloudIOTProjectsLocationsRegistriesTestIamPermissions =
