...
newCloudIOTProjectsLocationsRegistriesGroupsSetIamPolicy 
    ...
    -> CloudIOTProjectsLocationsRegistriesGroupsSetIamPolicy
newCloudIOTProjectsLocationsRegistriesGroupsSetIamPolicy payload
  resource
  = CloudIOTProjectsLocationsRegistriesGroupsSetIamPolicy{xgafv =
                                                            Core.Nothing,
...
instance Core.GoogleRequest
           CloudIOTProjectsLocationsRegistriesGroupsSetIamPolicy
         where
        type Rs CloudIOTProjectsLocationsRegistriesGroupsSetIamPolicy =
             Policy
        type Scopes CloudIOTProjectsLocationsRegistriesGroupsSetIamPolicy =
