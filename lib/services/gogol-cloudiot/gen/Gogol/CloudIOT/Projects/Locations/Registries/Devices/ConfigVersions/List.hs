           ...
           Core.QueryParam "$.xgafv" Xgafv Core.:>
             Core.QueryParam "access_token" Core.Text Core.:>
               Core.QueryParam "callback" Core.Text Core.:>
                 Core.QueryParam "numVersions" Core.Int32 Core.:>
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.Get '[Core.JSON] ListDeviceConfigVersionsResponse
...
newCloudIOTProjectsLocationsRegistriesDevicesConfigVersionsList
  name
  = CloudIOTProjectsLocationsRegistriesDevicesConfigVersionsList{xgafv
                                                                   = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        requestClient
          CloudIOTProjectsLocationsRegistriesDevicesConfigVersionsList{..}
          = go name xgafv accessToken callback numVersions uploadType
              uploadProtocol
