           ...
           Core.QueryParam "$.xgafv" Xgafv Core.:>
             Core.QueryParam "access_token" Core.Text Core.:>
               Core.QueryParam "callback" Core.Text Core.:>
                 Core.QueryParam "numStates" Core.Int32 Core.:>
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.Get '[Core.JSON] ListDeviceStatesResponse
...
newCloudIOTProjectsLocationsRegistriesDevicesStatesList name
  = CloudIOTProjectsLocationsRegistriesDevicesStatesList{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           CloudIOTProjectsLocationsRegistriesDevicesStatesList
         where
        type Rs CloudIOTProjectsLocationsRegistriesDevicesStatesList =
             ListDeviceStatesResponse
        type Scopes CloudIOTProjectsLocationsRegistriesDevicesStatesList =
             '[CloudPlatform'FullControl, Cloudiot'FullControl]
        requestClient
          CloudIOTProjectsLocationsRegistriesDevicesStatesList{..}
          = go name xgafv accessToken callback numStates uploadType
              uploadProtocol
