...
-- |
-- Module      : Gogol.CloudIOT.Projects.Locations.Registries.Devices.List
...
-- 'CloudIOTProjectsLocationsRegistriesDevicesList' request conforms to.
type CloudIOTProjectsLocationsRegistriesDevicesListResource =
     "v1" Core.:>
                 ...
                 Core.QueryParams "deviceIds" Core.Text Core.:>
                   Core.QueryParams "deviceNumIds" Core.Word64 Core.:>
                     Core.QueryParam "fieldMask" Core.FieldMask Core.:>
                       Core.QueryParam "gatewayListOptions.associationsDeviceId" Core.Text
                         Core.:>
                         Core.QueryParam "gatewayListOptions.associationsGatewayId"
                           Core.Text
                           Core.:>
...
-- | List devices in a device registry.
--
-- /See:/ 'newCloudIOTProjectsLocationsRegistriesDevicesList' smart constructor.
data CloudIOTProjectsLocationsRegistriesDevicesList = CloudIOTProjectsLocationsRegistriesDevicesList
    {
      -- | V1 error format.
...
-- | Creates a value of 'CloudIOTProjectsLocationsRegistriesDevicesList' with the minimum fields required to make a request.
newCloudIOTProjectsLocationsRegistriesDevicesList 
    :: 
                                                  Core.Text
    ...
    -> CloudIOTProjectsLocationsRegistriesDevicesList
newCloudIOTProjectsLocationsRegistriesDevicesList parent
  = CloudIOTProjectsLocationsRegistriesDevicesList{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           CloudIOTProjectsLocationsRegistriesDevicesList
         where
        type Rs CloudIOTProjectsLocationsRegistriesDevicesList =
             ListDevicesResponse
        type Scopes CloudIOTProjectsLocationsRegistriesDevicesList =
             '[CloudPlatform'FullControl, Cloudiot'FullControl]
        requestClient CloudIOTProjectsLocationsRegistriesDevicesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudIOTProjectsLocationsRegistriesDevicesListResource)
                      Core.mempty
