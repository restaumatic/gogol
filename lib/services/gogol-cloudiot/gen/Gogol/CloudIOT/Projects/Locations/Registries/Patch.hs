                   ...
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] DeviceRegistry Core.:>
                         Core.Patch '[Core.JSON] DeviceRegistry
...
newCloudIOTProjectsLocationsRegistriesPatch name payload
  = CloudIOTProjectsLocationsRegistriesPatch{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           CloudIOTProjectsLocationsRegistriesPatch
         where
        type Rs CloudIOTProjectsLocationsRegistriesPatch = DeviceRegistry
        type Scopes CloudIOTProjectsLocationsRegistriesPatch =
             '[CloudPlatform'FullControl, Cloudiot'FullControl]
        requestClient CloudIOTProjectsLocationsRegistriesPatch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudIOTProjectsLocationsRegistriesPatchResource)
                      Core.mempty
