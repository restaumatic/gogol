                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] DeviceRegistry Core.:>
                         Core.Post '[Core.JSON] DeviceRegistry
...
newCloudIOTProjectsLocationsRegistriesCreate parent payload
  = CloudIOTProjectsLocationsRegistriesCreate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           CloudIOTProjectsLocationsRegistriesCreate
         where
        type Rs CloudIOTProjectsLocationsRegistriesCreate = DeviceRegistry
        type Scopes CloudIOTProjectsLocationsRegistriesCreate =
             '[CloudPlatform'FullControl, Cloudiot'FullControl]
        requestClient CloudIOTProjectsLocationsRegistriesCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudIOTProjectsLocationsRegistriesCreateResource)
                      Core.mempty
