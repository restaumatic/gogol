...
type CloudIOTProjectsLocationsRegistriesDevicesSendCommandToDeviceResource
     =
     "v1" Core.:>
       Core.CaptureMode "name" "sendCommandToDevice" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] SendCommandToDeviceRequest Core.:>
                       Core.Post '[Core.JSON] SendCommandToDeviceResponse
...
newCloudIOTProjectsLocationsRegistriesDevicesSendCommandToDevice
  name payload
  = CloudIOTProjectsLocationsRegistriesDevicesSendCommandToDevice{xgafv
                                                                    = Core.Nothing,
