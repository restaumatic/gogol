...
newCloudIOTProjectsLocationsRegistriesGroupsGetIamPolicy 
    ...
    -> CloudIOTProjectsLocationsRegistriesGroupsGetIamPolicy
newCloudIOTProjectsLocationsRegistriesGroupsGetIamPolicy payload
  resource
  = CloudIOTProjectsLocationsRegistriesGroupsGetIamPolicy{xgafv =
                                                            Core.Nothing,
...
instance Core.GoogleRequest
           CloudIOTProjectsLocationsRegistriesGroupsGetIamPolicy
         where
        type Rs CloudIOTProjectsLocationsRegistriesGroupsGetIamPolicy =
             Policy
        type Scopes CloudIOTProjectsLocationsRegistriesGroupsGetIamPolicy =
