...
newCloudIOTProjectsLocationsRegistriesDevicesGet name
  = CloudIOTProjectsLocationsRegistriesDevicesGet{xgafv =
                                                    Core.Nothing,
                                                  accessToken = Core.Nothing,
                                                  callback = Core.Nothing, fieldMask = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes CloudIOTProjectsLocationsRegistriesDevicesGet =
