...
newCloudIOTProjectsLocationsRegistriesList parent
  = CloudIOTProjectsLocationsRegistriesList{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            pageSize = Core.Nothing, pageToken = Core.Nothing,
                                            parent = parent, uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudIOTProjectsLocationsRegistriesList
         where
        ...
        requestClient CloudIOTProjectsLocationsRegistriesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudIOTProjectsLocationsRegistriesListResource)
                      Core.mempty
