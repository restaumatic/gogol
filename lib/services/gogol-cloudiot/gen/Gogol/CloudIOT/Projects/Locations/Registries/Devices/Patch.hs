                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] Device Core.:>
                         Core.Patch '[Core.JSON] Device
...
newCloudIOTProjectsLocationsRegistriesDevicesPatch name payload
  = CloudIOTProjectsLocationsRegistriesDevicesPatch{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           CloudIOTProjectsLocationsRegistriesDevicesPatch
         where
        type Rs CloudIOTProjectsLocationsRegistriesDevicesPatch = Device
        type Scopes CloudIOTProjectsLocationsRegistriesDevicesPatch =
             '[CloudPlatform'FullControl, Cloudiot'FullControl]
        requestClient CloudIOTProjectsLocationsRegistriesDevicesPatch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudIOTProjectsLocationsRegistriesDevicesPatchResource)
                      Core.mempty
