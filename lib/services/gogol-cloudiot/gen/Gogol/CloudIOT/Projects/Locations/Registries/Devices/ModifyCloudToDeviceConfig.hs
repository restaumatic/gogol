...
type CloudIOTProjectsLocationsRegistriesDevicesModifyCloudToDeviceConfigResource
     =
     "v1" Core.:>
       Core.CaptureMode "name" "modifyCloudToDeviceConfig" Core.Text
         Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] ModifyCloudToDeviceConfigRequest Core.:>
                       Core.Post '[Core.JSON] DeviceConfig
...
newCloudIOTProjectsLocationsRegistriesDevicesModifyCloudToDeviceConfig
  name payload
  = CloudIOTProjectsLocationsRegistriesDevicesModifyCloudToDeviceConfig{xgafv
                                                                          = Core.Nothing,
