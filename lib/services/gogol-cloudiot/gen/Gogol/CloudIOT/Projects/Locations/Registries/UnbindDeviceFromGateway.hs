...
type CloudIOTProjectsLocationsRegistriesUnbindDeviceFromGatewayResource
     =
     "v1" Core.:>
       Core.CaptureMode "parent" "unbindDeviceFromGateway" Core.Text
         Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] UnbindDeviceFromGatewayRequest Core.:>
                       Core.Post '[Core.JSON] UnbindDeviceFromGatewayResponse
...
newCloudIOTProjectsLocationsRegistriesUnbindDeviceFromGateway
  parent payload
  = CloudIOTProjectsLocationsRegistriesUnbindDeviceFromGateway{xgafv
                                                                 = Core.Nothing,
...
instance Core.GoogleRequest
           CloudIOTProjectsLocationsRegistriesUnbindDeviceFromGateway
         where
        type Rs CloudIOTProjectsLocationsRegistriesUnbindDeviceFromGateway
