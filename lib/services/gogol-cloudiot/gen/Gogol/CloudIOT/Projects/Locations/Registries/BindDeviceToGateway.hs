...
type CloudIOTProjectsLocationsRegistriesBindDeviceToGatewayResource
     =
     "v1" Core.:>
       Core.CaptureMode "parent" "bindDeviceToGateway" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] BindDeviceToGatewayRequest Core.:>
...
newCloudIOTProjectsLocationsRegistriesBindDeviceToGateway 
    ...
    -> CloudIOTProjectsLocationsRegistriesBindDeviceToGateway
newCloudIOTProjectsLocationsRegistriesBindDeviceToGateway parent
  payload
  = CloudIOTProjectsLocationsRegistriesBindDeviceToGateway{xgafv =
                                                             Core.Nothing,
...
instance Core.GoogleRequest
           CloudIOTProjectsLocationsRegistriesBindDeviceToGateway
         where
        type Rs CloudIOTProjectsLocationsRegistriesBindDeviceToGateway =
             BindDeviceToGatewayResponse
        type Scopes CloudIOTProjectsLocationsRegistriesBindDeviceToGateway
