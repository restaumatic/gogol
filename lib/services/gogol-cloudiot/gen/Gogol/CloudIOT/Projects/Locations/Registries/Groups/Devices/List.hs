...
newCloudIOTProjectsLocationsRegistriesGroupsDevicesList parent
  = CloudIOTProjectsLocationsRegistriesGroupsDevicesList{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           CloudIOTProjectsLocationsRegistriesGroupsDevicesList
         where
        type Rs CloudIOTProjectsLocationsRegistriesGroupsDevicesList =
             ListDevicesResponse
        type Scopes CloudIOTProjectsLocationsRegistriesGroupsDevicesList =
