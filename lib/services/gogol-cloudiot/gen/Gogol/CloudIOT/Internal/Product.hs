...
newBindDeviceToGatewayRequest 
    ::  BindDeviceToGatewayRequest
newBindDeviceToGatewayRequest
  = BindDeviceToGatewayRequest{deviceId = Core.Nothing,
                               gatewayId = Core.Nothing}
instance Core.FromJSON BindDeviceToGatewayRequest where
        parseJSON
          = Core.withObject "BindDeviceToGatewayRequest"
              (\ o ->
                 BindDeviceToGatewayRequest Core.<$>
                   (o Core..:? "deviceId") Core.<*> (o Core..:? "gatewayId"))
...
instance Core.FromJSON BindDeviceToGatewayResponse where
        parseJSON
          = Core.withObject "BindDeviceToGatewayResponse"
              (\ o -> Core.pure BindDeviceToGatewayResponse)

instance Core.ToJSON BindDeviceToGatewayResponse where
...
newDevice 
    ::  Device
newDevice
  = Device{blocked = Core.Nothing, config = Core.Nothing,
           credentials = Core.Nothing, gatewayConfig = Core.Nothing,
           id = Core.Nothing, lastConfigAckTime = Core.Nothing,
           lastConfigSendTime = Core.Nothing, lastErrorStatus = Core.Nothing,
           lastErrorTime = Core.Nothing, lastEventTime = Core.Nothing,
           lastHeartbeatTime = Core.Nothing, lastStateTime = Core.Nothing,
           logLevel = Core.Nothing, metadata = Core.Nothing,
           name = Core.Nothing, numId = Core.Nothing, state = Core.Nothing}
instance Core.FromJSON Device where
        parseJSON
          = Core.withObject "Device"
              (\ o ->
                 Device Core.<$>
                   (o Core..:? "blocked") Core.<*> (o Core..:? "config") Core.<*>
                     (o Core..:? "credentials")
                     ...
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "numId" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "state"))
          ...
          = Core.object
              (Core.catMaybes
                 [("blocked" Core..=) Core.<$> blocked,
                  ...
                  ("id" Core..=) Core.<$> id,
                  ("lastConfigAckTime" Core..=) Core.<$> lastConfigAckTime,
                  ("lastConfigSendTime" Core..=) Core.<$> lastConfigSendTime,
                  ("lastErrorStatus" Core..=) Core.<$> lastErrorStatus,
                  ("lastErrorTime" Core..=) Core.<$> lastErrorTime,
                  ("lastEventTime" Core..=) Core.<$> lastEventTime,
                  ("lastHeartbeatTime" Core..=) Core.<$> lastHeartbeatTime,
...
newDevice_Metadata 
    :: 
       ...
       -- ^  See 'additional'.
    -> Device_Metadata
newDevice_Metadata additional
  = Device_Metadata{additional = additional}
instance Core.FromJSON Device_Metadata where
        parseJSON
          = Core.withObject "Device_Metadata"
              (\ o -> Device_Metadata Core.<$> (Core.parseJSONObject o))
...
newDeviceConfig 
    ::  DeviceConfig
newDeviceConfig
  = DeviceConfig{binaryData = Core.Nothing,
                 cloudUpdateTime = Core.Nothing, deviceAckTime = Core.Nothing,
...
instance Core.FromJSON DeviceConfig where
        parseJSON
          = Core.withObject "DeviceConfig"
              (\ o ->
                 DeviceConfig Core.<$>
                   (o Core..:? "binaryData") Core.<*> (o Core..:? "cloudUpdateTime")
...
newDeviceCredential 
    ::  DeviceCredential
newDeviceCredential
  = DeviceCredential{expirationTime = Core.Nothing,
          ...
          = Core.withObject "DeviceCredential"
              (\ o ->
                 DeviceCredential Core.<$>
                   (o Core..:? "expirationTime") Core.<*> (o Core..:? "publicKey"))
...
newDeviceRegistry 
    ::  DeviceRegistry
newDeviceRegistry
  = DeviceRegistry{credentials = Core.Nothing,
                   eventNotificationConfigs = Core.Nothing, httpConfig = Core.Nothing,
                   id = Core.Nothing, logLevel = Core.Nothing,
                   mqttConfig = Core.Nothing, name = Core.Nothing,
          ...
          = Core.object
              (Core.catMaybes
                 [("credentials" Core..=) Core.<$> credentials,
                  ...
                  ("id" Core..=) Core.<$> id, ("logLevel" Core..=) Core.<$> logLevel,
...
instance Core.FromJSON DeviceState where
        parseJSON
          = Core.withObject "DeviceState"
              (\ o ->
                 DeviceState Core.<$>
                   (o Core..:? "binaryData") Core.<*> (o Core..:? "updateTime"))
...
newEventNotificationConfig 
    ::  EventNotificationConfig
newEventNotificationConfig
  = EventNotificationConfig{pubsubTopicName = Core.Nothing,
                            subfolderMatches = Core.Nothing}
...
instance Core.ToJSON EventNotificationConfig where
        toJSON EventNotificationConfig{..}
          = Core.object
              (Core.catMaybes
                 [("pubsubTopicName" Core..=) Core.<$> pubsubTopicName,
                  ("subfolderMatches" Core..=) Core.<$> subfolderMatches])
...
newGatewayConfig 
    ::  GatewayConfig
newGatewayConfig
  = GatewayConfig{gatewayAuthMethod = Core.Nothing,
                  gatewayType = Core.Nothing, lastAccessedGatewayId = Core.Nothing,
...
instance Core.ToJSON GatewayConfig where
        toJSON GatewayConfig{..}
          = Core.object
              (Core.catMaybes
                 [("gatewayAuthMethod" Core..=) Core.<$> gatewayAuthMethod,
                  ("gatewayType" Core..=) Core.<$> gatewayType,
                  ("lastAccessedGatewayId" Core..=) Core.<$> lastAccessedGatewayId,
...
instance Core.FromJSON HttpConfig where
        parseJSON
          = Core.withObject "HttpConfig"
              (\ o -> HttpConfig Core.<$> (o Core..:? "httpEnabledState"))

instance Core.ToJSON HttpConfig where
        toJSON HttpConfig{..}
          = Core.object
              (Core.catMaybes
                 [("httpEnabledState" Core..=) Core.<$> httpEnabledState])
...
instance Core.FromJSON ListDeviceConfigVersionsResponse where
        parseJSON
...
instance Core.ToJSON ListDeviceConfigVersionsResponse where
        toJSON ListDeviceConfigVersionsResponse{..}
          = Core.object
              (Core.catMaybes [("deviceConfigs" Core..=) Core.<$> deviceConfigs])
...
newListDeviceRegistriesResponse 
    ::  ListDeviceRegistriesResponse
newListDeviceRegistriesResponse
  = ListDeviceRegistriesResponse{deviceRegistries = Core.Nothing,
                                 nextPageToken = Core.Nothing}
instance Core.FromJSON ListDeviceRegistriesResponse where
        parseJSON
...
instance Core.ToJSON ListDeviceRegistriesResponse where
        toJSON ListDeviceRegistriesResponse{..}
          = Core.object
              (Core.catMaybes
                 [("deviceRegistries" Core..=) Core.<$> deviceRegistries,
...
instance Core.FromJSON ListDeviceStatesResponse where
        parseJSON
          = Core.withObject "ListDeviceStatesResponse"
              (\ o ->
                 ListDeviceStatesResponse Core.<$> (o Core..:? "deviceStates"))

instance Core.ToJSON ListDeviceStatesResponse where
        toJSON ListDeviceStatesResponse{..}
          = Core.object
              (Core.catMaybes [("deviceStates" Core..=) Core.<$> deviceStates])
...
newModifyCloudToDeviceConfigRequest 
    :: 
                                    ModifyCloudToDeviceConfigRequest
newModifyCloudToDeviceConfigRequest
  = ModifyCloudToDeviceConfigRequest{binaryData = Core.Nothing,
                                     versionToUpdate = Core.Nothing}
instance Core.FromJSON ModifyCloudToDeviceConfigRequest where
        parseJSON
          = Core.withObject "ModifyCloudToDeviceConfigRequest"
              (\ o ->
                 ModifyCloudToDeviceConfigRequest Core.<$>
                   (o Core..:? "binaryData") Core.<*>
                     (o Core..:? "versionToUpdate" Core.<&> Core.fmap Core.fromAsText))
...
instance Core.ToJSON ModifyCloudToDeviceConfigRequest where
        toJSON ModifyCloudToDeviceConfigRequest{..}
          = Core.object
              (Core.catMaybes
                 [("binaryData" Core..=) Core.<$> binaryData,
                  ("versionToUpdate" Core..=) Core.. Core.AsText Core.<$>
                    versionToUpdate])
...
instance Core.FromJSON MqttConfig where
        parseJSON
          = Core.withObject "MqttConfig"
              (\ o -> MqttConfig Core.<$> (o Core..:? "mqttEnabledState"))

instance Core.ToJSON MqttConfig where
        toJSON MqttConfig{..}
          = Core.object
              (Core.catMaybes
                 [("mqttEnabledState" Core..=) Core.<$> mqttEnabledState])
...
newPublicKeyCertificate 
    ::  PublicKeyCertificate
newPublicKeyCertificate
  = PublicKeyCertificate{certificate = Core.Nothing,
                         format = Core.Nothing, x509Details = Core.Nothing}
instance Core.FromJSON PublicKeyCertificate where
        parseJSON
          = Core.withObject "PublicKeyCertificate"
              (\ o ->
                 PublicKeyCertificate Core.<$>
                   (o Core..:? "certificate") Core.<*> (o Core..:? "format") Core.<*>
                     (o Core..:? "x509Details"))
...
instance Core.ToJSON PublicKeyCredential where
        toJSON PublicKeyCredential{..}
          = Core.object
              (Core.catMaybes
                 [("format" Core..=) Core.<$> format, ("key" Core..=) Core.<$> key])
...
newRegistryCredential 
    ::  RegistryCredential
newRegistryCredential
  = RegistryCredential{publicKeyCertificate = Core.Nothing}
instance Core.FromJSON RegistryCredential where
        parseJSON
          = Core.withObject "RegistryCredential"
              (\ o ->
                 RegistryCredential Core.<$> (o Core..:? "publicKeyCertificate"))

instance Core.ToJSON RegistryCredential where
        toJSON RegistryCredential{..}
          = Core.object
              (Core.catMaybes
                 [("publicKeyCertificate" Core..=) Core.<$> publicKeyCertificate])
...
newSendCommandToDeviceRequest 
    ::  SendCommandToDeviceRequest
newSendCommandToDeviceRequest
  = SendCommandToDeviceRequest{binaryData = Core.Nothing,
                               subfolder = Core.Nothing}
instance Core.FromJSON SendCommandToDeviceRequest where
        parseJSON
          = Core.withObject "SendCommandToDeviceRequest"
              (\ o ->
                 SendCommandToDeviceRequest Core.<$>
                   (o Core..:? "binaryData") Core.<*> (o Core..:? "subfolder"))
...
instance Core.FromJSON SendCommandToDeviceResponse where
        parseJSON
          = Core.withObject "SendCommandToDeviceResponse"
              (\ o -> Core.pure SendCommandToDeviceResponse)

instance Core.ToJSON SendCommandToDeviceResponse where
        toJSON = Core.const Core.emptyObject
...
instance Core.FromJSON StateNotificationConfig where
        parseJSON
          = Core.withObject "StateNotificationConfig"
              (\ o ->
                 StateNotificationConfig Core.<$> (o Core..:? "pubsubTopicName"))
...
newUnbindDeviceFromGatewayRequest 
    ::  UnbindDeviceFromGatewayRequest
newUnbindDeviceFromGatewayRequest
  = UnbindDeviceFromGatewayRequest{deviceId = Core.Nothing,
                                   gatewayId = Core.Nothing}
instance Core.FromJSON UnbindDeviceFromGatewayRequest where
        parseJSON
...
instance Core.ToJSON UnbindDeviceFromGatewayRequest where
...
newUnbindDeviceFromGatewayResponse
  = UnbindDeviceFromGatewayResponse
instance Core.FromJSON UnbindDeviceFromGatewayResponse where
        parseJSON
          = Core.withObject "UnbindDeviceFromGatewayResponse"
              (\ o -> Core.pure UnbindDeviceFromGatewayResponse)

instance Core.ToJSON UnbindDeviceFromGatewayResponse where
        toJSON = Core.const Core.emptyObject
...
newX509CertificateDetails 
    ::  X509CertificateDetails
newX509CertificateDetails
  = X509CertificateDetails{expiryTime = Core.Nothing,
                           issuer = Core.Nothing, publicKeyType = Core.Nothing,
                           signatureAlgorithm = Core.Nothing, startTime = Core.Nothing,
          ...
          = Core.withObject "X509CertificateDetails"
              (\ o ->
                 X509CertificateDetails Core.<$>
                   (o Core..:? "expiryTime") Core.<*> (o Core..:? "issuer") Core.<*>
                     (o Core..:? "publicKeyType")
