...
newBloggerPostUserInfosGet blogId postId userId
  = BloggerPostUserInfosGet{xgafv = Core.Nothing,
                            accessToken = Core.Nothing, blogId = blogId,
                            callback = Core.Nothing, maxComments = Core.Nothing,
...
instance Core.GoogleRequest BloggerPostUserInfosGet where
        ...
        requestClient BloggerPostUserInfosGet{..}
          = go userId blogId postId xgafv accessToken callback maxComments
              uploadType
              uploadProtocol
