                     ...
                     Core.QueryParam "callback" Core.Text Core.:>
                       Core.QueryParam "endDate" Core.Text Core.:>
                         Core.QueryParam "fetchBodies" Core.Bool Core.:>
                           Core.QueryParam "labels" Core.Text Core.:>
                             Core.QueryParam "maxResults" Core.Word32 Core.:>
                               Core.QueryParam "orderBy" PostUserInfosListOrderBy Core.:>
                                 Core.QueryParam "pageToken" Core.Text Core.:>
                                   Core.QueryParam "startDate" Core.Text Core.:>
                                     Core.QueryParams "status" PostUserInfosListStatus Core.:>
                                       Core.QueryParam "uploadType" Core.Text Core.:>
                                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                                           Core.QueryParam "view" PostUserInfosListView Core.:>
                                             Core.QueryParam "alt" Core.AltJSON Core.:>
                                               Core.Get '[Core.JSON] PostUserInfosList
...
newBloggerPostUserInfosList blogId userId
  = BloggerPostUserInfosList{xgafv = Core.Nothing,
                             accessToken = Core.Nothing, blogId = blogId,
                             callback = Core.Nothing, endDate = Core.Nothing,
                             fetchBodies = Core.False, labels = Core.Nothing,
                             maxResults = Core.Nothing,
                             orderBy = PostUserInfosListOrderBy_Published,
                             pageToken = Core.Nothing, startDate = Core.Nothing,
                             status = Core.Nothing, uploadType = Core.Nothing,
...
instance Core.GoogleRequest BloggerPostUserInfosList where
        ...
        type Scopes BloggerPostUserInfosList =
             '[Blogger'FullControl, Blogger'Readonly]
        requestClient BloggerPostUserInfosList{..}
          = go userId blogId xgafv accessToken callback endDate
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy BloggerPostUserInfosListResource)
                      Core.mempty
