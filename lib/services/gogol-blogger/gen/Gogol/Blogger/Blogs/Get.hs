                 ...
                 Core.QueryParam "maxPosts" Core.Word32 Core.:>
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "view" BlogsGetView Core.:>
...
newBloggerBlogsGet blogId
  = BloggerBlogsGet{xgafv = Core.Nothing, accessToken = Core.Nothing,
                    blogId = blogId, callback = Core.Nothing, maxPosts = Core.Nothing,
...
instance Core.GoogleRequest BloggerBlogsGet where
        ...
        type Scopes BloggerBlogsGet =
             '[Blogger'FullControl, Blogger'Readonly]
        requestClient BloggerBlogsGet{..}
          = go blogId xgafv accessToken callback maxPosts uploadType
              uploadProtocol
              view
