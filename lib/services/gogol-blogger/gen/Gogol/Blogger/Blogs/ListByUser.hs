             ...
             Core.QueryParam "$.xgafv" Xgafv Core.:>
               Core.QueryParam "access_token" Core.Text Core.:>
                 Core.QueryParam "callback" Core.Text Core.:>
                   Core.QueryParam "fetchUserInfo" Core.Bool Core.:>
                     Core.QueryParams "role" BlogsListByUserRole Core.:>
                       Core.QueryParams "status" BlogsListByUserStatus Core.:>
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "view" BlogsListByUserView Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.Get '[Core.JSON] BlogList
...
newBloggerBlogsListByUser userId
  = BloggerBlogsListByUser{xgafv = Core.Nothing,
                           accessToken = Core.Nothing, callback = Core.Nothing,
                           fetchUserInfo = Core.Nothing, role' = Core.Nothing,
                           status = [BlogsListByUserStatus_Live], uploadType = Core.Nothing,
...
instance Core.GoogleRequest BloggerBlogsListByUser where
        ...
        type Scopes BloggerBlogsListByUser =
             '[Blogger'FullControl, Blogger'Readonly]
        requestClient BloggerBlogsListByUser{..}
          = go userId xgafv accessToken callback fetchUserInfo
