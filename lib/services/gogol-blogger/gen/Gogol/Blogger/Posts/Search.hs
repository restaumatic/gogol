                   ...
                   Core.QueryParam "access_token" Core.Text Core.:>
                     Core.QueryParam "callback" Core.Text Core.:>
                       Core.QueryParam "fetchBodies" Core.Bool Core.:>
                         Core.QueryParam "orderBy" PostsSearchOrderBy Core.:>
...
newBloggerPostsSearch blogId q
  = BloggerPostsSearch{xgafv = Core.Nothing,
                       accessToken = Core.Nothing, blogId = blogId,
                       callback = Core.Nothing, fetchBodies = Core.True,
                       orderBy = PostsSearchOrderBy_Published, q = q,
...
instance Core.GoogleRequest BloggerPostsSearch where
        ...
        type Scopes BloggerPostsSearch =
             '[Blogger'FullControl, Blogger'Readonly]
        requestClient BloggerPostsSearch{..}
          = go blogId (Core.Just q) xgafv accessToken callback
