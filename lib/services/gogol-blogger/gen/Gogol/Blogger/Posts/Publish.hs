...
newBloggerPostsPublish blogId postId
  = BloggerPostsPublish{xgafv = Core.Nothing,
                        accessToken = Core.Nothing, blogId = blogId,
                        callback = Core.Nothing, postId = postId,
                        publishDate = Core.Nothing, uploadType = Core.Nothing,
...
instance Core.GoogleRequest BloggerPostsPublish where
        ...
        requestClient BloggerPostsPublish{..}
          = go blogId postId xgafv accessToken callback publishDate
              uploadType
              uploadProtocol
