                         ...
                         Core.QueryParam "maxComments" Core.Word32 Core.:>
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "view" PostsGetView Core.:>
...
newBloggerPostsGet blogId postId
  = BloggerPostsGet{xgafv = Core.Nothing, accessToken = Core.Nothing,
                    blogId = blogId, callback = Core.Nothing, fetchBody = Core.True,
