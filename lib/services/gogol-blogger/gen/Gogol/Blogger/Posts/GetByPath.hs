...
newBloggerPostsGetByPath blogId path
  = BloggerPostsGetByPath{xgafv = Core.Nothing,
                          accessToken = Core.Nothing, blogId = blogId,
                          callback = Core.Nothing, maxComments = Core.Nothing, path = path,
                          uploadType = Core.Nothing, uploadProtocol = Core.Nothing,
                          view = Core.Nothing}
instance Core.GoogleRequest BloggerPostsGetByPath where
        ...
        requestClient BloggerPostsGetByPath{..}
          = go blogId (Core.Just path) xgafv accessToken callback maxComments
              uploadType
              uploadProtocol
              view
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy BloggerPostsGetByPathResource)
                      Core.mempty
