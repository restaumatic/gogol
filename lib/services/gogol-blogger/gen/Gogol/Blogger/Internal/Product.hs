...
newBlog 
    ::  Blog
newBlog
  = Blog{customMetaData = Core.Nothing, description = Core.Nothing,
         id = Core.Nothing, kind = Core.Nothing, locale = Core.Nothing,
         name = Core.Nothing, pages = Core.Nothing, posts = Core.Nothing,
         published = Core.Nothing, selfLink = Core.Nothing,
         status = Core.Nothing, updated = Core.Nothing, url = Core.Nothing}
instance Core.FromJSON Blog where
        parseJSON
          = Core.withObject "Blog"
              (\ o ->
                 Blog Core.<$>
                   (o Core..:? "customMetaData") Core.<*> (o Core..:? "description")
                     Core.<*> (o Core..:? "id")
                     Core.<*> (o Core..:? "kind")
                     Core.<*> (o Core..:? "locale")
                     Core.<*> (o Core..:? "name")
          ...
          = Core.object
              (Core.catMaybes
                 [("customMetaData" Core..=) Core.<$> customMetaData,
                  ...
                  ("locale" Core..=) Core.<$> locale, ("name" Core..=) Core.<$> name,
                  ("pages" Core..=) Core.<$> pages, ("posts" Core..=) Core.<$> posts,
...
newBlog_Locale 
    ::  Blog_Locale
newBlog_Locale
  = Blog_Locale{country = Core.Nothing, language = Core.Nothing,
                variant = Core.Nothing}
instance Core.FromJSON Blog_Locale where
        parseJSON
          = Core.withObject "Blog_Locale"
              (\ o ->
                 Blog_Locale Core.<$>
                   (o Core..:? "country") Core.<*> (o Core..:? "language") Core.<*>
                     (o Core..:? "variant"))
...
newBlog_Pages 
    ::  Blog_Pages
newBlog_Pages
  = Blog_Pages{selfLink = Core.Nothing, totalItems = Core.Nothing}
instance Core.FromJSON Blog_Pages where
        parseJSON
          = Core.withObject "Blog_Pages"
              (\ o ->
                 Blog_Pages Core.<$>
...
newBlog_Posts 
    ::  Blog_Posts
newBlog_Posts
  = Blog_Posts{items = Core.Nothing, selfLink = Core.Nothing,
               totalItems = Core.Nothing}
instance Core.FromJSON Blog_Posts where
        parseJSON
          = Core.withObject "Blog_Posts"
              (\ o ->
                 Blog_Posts Core.<$>
                   (o Core..:? "items") Core.<*> (o Core..:? "selfLink") Core.<*>
                     (o Core..:? "totalItems"))
...
newBlogList 
    ::  BlogList
newBlogList
  = BlogList{blogUserInfos = Core.Nothing, items = Core.Nothing,
             kind = Core.Nothing}
instance Core.FromJSON BlogList where
        parseJSON
          = Core.withObject "BlogList"
              (\ o ->
                 BlogList Core.<$>
                   (o Core..:? "blogUserInfos") Core.<*> (o Core..:? "items") Core.<*>
                     (o Core..:? "kind"))
...
newBlogPerUserInfo 
    ::  BlogPerUserInfo
newBlogPerUserInfo
  = BlogPerUserInfo{blogId = Core.Nothing,
                    hasAdminAccess = Core.Nothing, kind = Core.Nothing,
                    photosAlbumKey = Core.Nothing, role' = Core.Nothing,
                    userId = Core.Nothing}
instance Core.FromJSON BlogPerUserInfo where
        parseJSON
          = Core.withObject "BlogPerUserInfo"
              (\ o ->
                 BlogPerUserInfo Core.<$>
                   (o Core..:? "blogId") Core.<*> (o Core..:? "hasAdminAccess")
                     Core.<*> (o Core..:? "kind")
...
newBlogUserInfo 
    ::  BlogUserInfo
newBlogUserInfo
  = BlogUserInfo{blog = Core.Nothing, blogUserInfo = Core.Nothing,
                 kind = Core.Nothing}
instance Core.FromJSON BlogUserInfo where
        parseJSON
          = Core.withObject "BlogUserInfo"
              (\ o ->
                 BlogUserInfo Core.<$>
                   (o Core..:? "blog") Core.<*> (o Core..:? "blog_user_info") Core.<*>
                     (o Core..:? "kind"))
...
newComment 
    ::  Comment
newComment
  = Comment{author = Core.Nothing, blog = Core.Nothing,
            content = Core.Nothing, id = Core.Nothing,
            inReplyTo = Core.Nothing, kind = Core.Nothing, post = Core.Nothing,
            published = Core.Nothing, selfLink = Core.Nothing,
            status = Core.Nothing, updated = Core.Nothing}
instance Core.FromJSON Comment where
        parseJSON
          = Core.withObject "Comment"
              (\ o ->
                 Comment Core.<$>
                   (o Core..:? "author") Core.<*> (o Core..:? "blog") Core.<*>
                     (o Core..:? "content")
                     Core.<*> (o Core..:? "id")
          ...
          = Core.object
              (Core.catMaybes
                 [("author" Core..=) Core.<$> author,
                  ...
                  ("kind" Core..=) Core.<$> kind, ("post" Core..=) Core.<$> post,
                  ("published" Core..=) Core.<$> published,
                  ("selfLink" Core..=) Core.<$> selfLink,
                  ("status" Core..=) Core.<$> status,
                  ("updated" Core..=) Core.<$> updated])
...
newComment_Author 
    ::  Comment_Author
newComment_Author
  = Comment_Author{displayName = Core.Nothing, id = Core.Nothing,
                   image = Core.Nothing, url = Core.Nothing}
instance Core.FromJSON Comment_Author where
        parseJSON
          = Core.withObject "Comment_Author"
              (\ o ->
                 Comment_Author Core.<$>
...
instance Core.FromJSON Comment_Author_Image where
        parseJSON
          = Core.withObject "Comment_Author_Image"
              (\ o -> Comment_Author_Image Core.<$> (o Core..:? "url"))
...
instance Core.FromJSON Comment_InReplyTo where
        parseJSON
          = Core.withObject "Comment_InReplyTo"
...
newCommentList 
    ::  CommentList
newCommentList
  = CommentList{etag = Core.Nothing, items = Core.Nothing,
...
newPage 
    ::  Page
newPage
  = Page{author = Core.Nothing, blog = Core.Nothing,
         content = Core.Nothing, etag = Core.Nothing, id = Core.Nothing,
         kind = Core.Nothing, published = Core.Nothing,
         selfLink = Core.Nothing, status = Core.Nothing,
         title = Core.Nothing, trashed = Core.Nothing,
...
newPage_Author 
    ::  Page_Author
newPage_Author
  = Page_Author{displayName = Core.Nothing, id = Core.Nothing,
                image = Core.Nothing, url = Core.Nothing}
instance Core.FromJSON Page_Author where
        parseJSON
          = Core.withObject "Page_Author"
              (\ o ->
                 Page_Author Core.<$>
                   (o Core..:? "displayName") Core.<*> (o Core..:? "id") Core.<*>
                     (o Core..:? "image")
...
instance Core.FromJSON Page_Author_Image where
        parseJSON
          = Core.withObject "Page_Author_Image"
              (\ o -> Page_Author_Image Core.<$> (o Core..:? "url"))
...
newPageList 
    ::  PageList
newPageList
  = PageList{etag = Core.Nothing, items = Core.Nothing,
             kind = Core.Nothing, nextPageToken = Core.Nothing}
instance Core.FromJSON PageList where
        parseJSON
          = Core.withObject "PageList"
              (\ o ->
                 PageList Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "items") Core.<*>
                     (o Core..:? "kind")
...
newPageviews 
    ::  Pageviews
newPageviews
  = Pageviews{blogId = Core.Nothing, counts = Core.Nothing,
              kind = Core.Nothing}
instance Core.FromJSON Pageviews where
        parseJSON
          = Core.withObject "Pageviews"
              (\ o ->
                 Pageviews Core.<$>
                   (o Core..:? "blogId") Core.<*> (o Core..:? "counts") Core.<*>
                     (o Core..:? "kind"))
...
newPageviews_CountsItem 
    ::  Pageviews_CountsItem
newPageviews_CountsItem
  = Pageviews_CountsItem{count = Core.Nothing,
                         timeRange = Core.Nothing}
instance Core.FromJSON Pageviews_CountsItem where
        parseJSON
          = Core.withObject "Pageviews_CountsItem"
              (\ o ->
                 Pageviews_CountsItem Core.<$>
...
newPost 
    ::  Post'
newPost
  = Post'{author = Core.Nothing, blog = Core.Nothing,
          content = Core.Nothing, customMetaData = Core.Nothing,
          etag = Core.Nothing, id = Core.Nothing, images = Core.Nothing,
          kind = Core.Nothing, labels = Core.Nothing,
          location = Core.Nothing, published = Core.Nothing,
          readerComments = Core.Nothing, replies = Core.Nothing,
          selfLink = Core.Nothing, status = Core.Nothing,
          title = Core.Nothing, titleLink = Core.Nothing,
          trashed = Core.Nothing, updated = Core.Nothing, url = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("author" Core..=) Core.<$> author,
                  ...
                  ("customMetaData" Core..=) Core.<$> customMetaData,
                  ("etag" Core..=) Core.<$> etag, ("id" Core..=) Core.<$> id,
                  ("images" Core..=) Core.<$> images, ("kind" Core..=) Core.<$> kind,
...
newPost_Author 
    ::  Post_Author
newPost_Author
  = Post_Author{displayName = Core.Nothing, id = Core.Nothing,
                image = Core.Nothing, url = Core.Nothing}
instance Core.FromJSON Post_Author where
        parseJSON
          = Core.withObject "Post_Author"
              (\ o ->
                 Post_Author Core.<$>
                   (o Core..:? "displayName") Core.<*> (o Core..:? "id") Core.<*>
                     (o Core..:? "image")
...
instance Core.FromJSON Post_Author_Image where
        parseJSON
          = Core.withObject "Post_Author_Image"
              (\ o -> Post_Author_Image Core.<$> (o Core..:? "url"))
...
instance Core.FromJSON Post_ImagesItem where
        parseJSON
          = Core.withObject "Post_ImagesItem"
...
newPost_Location 
    ::  Post_Location
newPost_Location
  = Post_Location{lat = Core.Nothing, lng = Core.Nothing,
                  name = Core.Nothing, span = Core.Nothing}
instance Core.FromJSON Post_Location where
        parseJSON
          = Core.withObject "Post_Location"
              (\ o ->
                 Post_Location Core.<$>
                   (o Core..:? "lat") Core.<*> (o Core..:? "lng") Core.<*>
                     (o Core..:? "name")
                     Core.<*> (o Core..:? "span"))
...
instance Core.ToJSON Post_Location where
        toJSON Post_Location{..}
          = Core.object
              (Core.catMaybes
                 [("lat" Core..=) Core.<$> lat, ("lng" Core..=) Core.<$> lng,
                  ("name" Core..=) Core.<$> name, ("span" Core..=) Core.<$> span])
...
newPost_Replies 
    ::  Post_Replies
newPost_Replies
  = Post_Replies{items = Core.Nothing, selfLink = Core.Nothing,
                 totalItems = Core.Nothing}
instance Core.FromJSON Post_Replies where
        parseJSON
          = Core.withObject "Post_Replies"
              (\ o ->
                 Post_Replies Core.<$>
                   (o Core..:? "items") Core.<*> (o Core..:? "selfLink") Core.<*>
                     (o Core..:? "totalItems" Core.<&> Core.fmap Core.fromAsText))
        ...
        toJSON Post_Replies{..}
          = Core.object
              (Core.catMaybes
                 [("items" Core..=) Core.<$> items,
                  ("selfLink" Core..=) Core.<$> selfLink,
                  ("totalItems" Core..=) Core.. Core.AsText Core.<$> totalItems])
...
newPostList 
    ::  PostList
newPostList
  = PostList{etag = Core.Nothing, items = Core.Nothing,
             kind = Core.Nothing, nextPageToken = Core.Nothing,
             prevPageToken = Core.Nothing}
instance Core.FromJSON PostList where
        parseJSON
          = Core.withObject "PostList"
              (\ o ->
                 PostList Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "items") Core.<*>
                     (o Core..:? "kind")
...
newPostPerUserInfo 
    ::  PostPerUserInfo
newPostPerUserInfo
  = PostPerUserInfo{blogId = Core.Nothing,
                    hasEditAccess = Core.Nothing, kind = Core.Nothing,
                    postId = Core.Nothing, userId = Core.Nothing}
instance Core.FromJSON PostPerUserInfo where
        parseJSON
          = Core.withObject "PostPerUserInfo"
              (\ o ->
                 PostPerUserInfo Core.<$>
                   (o Core..:? "blogId") Core.<*> (o Core..:? "hasEditAccess")
                     Core.<*> (o Core..:? "kind")
                     Core.<*> (o Core..:? "postId")
                     Core.<*> (o Core..:? "userId"))
          ...
          = Core.object
              (Core.catMaybes
                 [("blogId" Core..=) Core.<$> blogId,
                  ...
                  ("kind" Core..=) Core.<$> kind, ("postId" Core..=) Core.<$> postId,
                  ("userId" Core..=) Core.<$> userId])
...
newPostUserInfo 
    ::  PostUserInfo
newPostUserInfo
  = PostUserInfo{kind = Core.Nothing, post = Core.Nothing,
                 postUserInfo = Core.Nothing}
instance Core.FromJSON PostUserInfo where
        parseJSON
          = Core.withObject "PostUserInfo"
              (\ o ->
                 PostUserInfo Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "post") Core.<*>
                     (o Core..:? "post_user_info"))
...
newPostUserInfosList 
    ::  PostUserInfosList
newPostUserInfosList
  = PostUserInfosList{items = Core.Nothing, kind = Core.Nothing,
                      nextPageToken = Core.Nothing}
instance Core.FromJSON PostUserInfosList where
        parseJSON
          = Core.withObject "PostUserInfosList"
              (\ o ->
                 PostUserInfosList Core.<$>
...
newUser 
    ::  User
newUser
  = User{about = Core.Nothing, blogs = Core.Nothing,
         created = Core.Nothing, displayName = Core.Nothing,
         id = Core.Nothing, kind = Core.Nothing, locale = Core.Nothing,
         selfLink = Core.Nothing, url = Core.Nothing}
instance Core.FromJSON User where
        parseJSON
          = Core.withObject "User"
              (\ o ->
                 User Core.<$>
                   (o Core..:? "about") Core.<*> (o Core..:? "blogs") Core.<*>
                     (o Core..:? "created")
...
newUser_Locale 
    ::  User_Locale
newUser_Locale
  = User_Locale{country = Core.Nothing, language = Core.Nothing,
                variant = Core.Nothing}
instance Core.FromJSON User_Locale where
        parseJSON
          = Core.withObject "User_Locale"
              (\ o ->
                 User_Locale Core.<$>
                   (o Core..:? "country") Core.<*> (o Core..:? "language") Core.<*>
                     (o Core..:? "variant"))
