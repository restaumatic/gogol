                   ...
                   Core.QueryParam "callback" Core.Text Core.:>
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "view" PagesGetView Core.:>
...
newBloggerPagesGet blogId pageId
  = BloggerPagesGet{xgafv = Core.Nothing, accessToken = Core.Nothing,
                    blogId = blogId, callback = Core.Nothing, pageId = pageId,
...
instance Core.GoogleRequest BloggerPagesGet where
        ...
        type Scopes BloggerPagesGet =
             '[Blogger'FullControl, Blogger'Readonly]
        requestClient BloggerPagesGet{..}
          = go blogId pageId xgafv accessToken callback uploadType
              uploadProtocol
              view
