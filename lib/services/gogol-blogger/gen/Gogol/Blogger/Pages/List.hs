                   ...
                   Core.QueryParam "fetchBodies" Core.Bool Core.:>
                     Core.QueryParam "maxResults" Core.Word32 Core.:>
                       Core.QueryParam "pageToken" Core.Text Core.:>
                         Core.QueryParams "status" PagesListStatus Core.:>
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "view" PagesListView Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.Get '[Core.JSON] PageList
...
newBloggerPagesList blogId
  = BloggerPagesList{xgafv = Core.Nothing,
                     accessToken = Core.Nothing, blogId = blogId,
                     callback = Core.Nothing, fetchBodies = Core.Nothing,
...
instance Core.GoogleRequest BloggerPagesList where
        ...
        type Scopes BloggerPagesList =
             '[Blogger'FullControl, Blogger'Readonly]
        requestClient BloggerPagesList{..}
          = go blogId xgafv accessToken callback fetchBodies maxResults
              pageToken
