                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] Page Core.:> Core.Post '[Core.JSON] Page
...
newBloggerPagesInsert blogId payload
  = BloggerPagesInsert{xgafv = Core.Nothing,
                       accessToken = Core.Nothing, blogId = blogId,
                       callback = Core.Nothing, isDraft = Core.Nothing, payload = payload,
...
instance Core.GoogleRequest BloggerPagesInsert where
        ...
        type Scopes BloggerPagesInsert = '[Blogger'FullControl]
        requestClient BloggerPagesInsert{..}
          = go blogId xgafv accessToken callback isDraft uploadType
              uploadProtocol
