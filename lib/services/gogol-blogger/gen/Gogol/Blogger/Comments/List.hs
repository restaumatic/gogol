                           ...
                           Core.QueryParam "maxResults" Core.Word32 Core.:>
                             Core.QueryParam "pageToken" Core.Text Core.:>
                               Core.QueryParam "startDate" Core.Text Core.:>
                                 Core.QueryParam "status" CommentsListStatus Core.:>
                                   Core.QueryParam "uploadType" Core.Text Core.:>
                                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                                       Core.QueryParam "view" CommentsListView Core.:>
...
newBloggerCommentsList blogId postId
  = BloggerCommentsList{xgafv = Core.Nothing,
                        accessToken = Core.Nothing, blogId = blogId,
                        callback = Core.Nothing, endDate = Core.Nothing,
                        fetchBodies = Core.Nothing, maxResults = Core.Nothing,
                        pageToken = Core.Nothing, postId = postId,
...
instance Core.GoogleRequest BloggerCommentsList where
        ...
        type Scopes BloggerCommentsList =
             '[Blogger'FullControl, Blogger'Readonly]
        requestClient BloggerCommentsList{..}
          = go blogId postId xgafv accessToken callback endDate fetchBodies
              maxResults
              pageToken
              startDate
              status
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy BloggerCommentsListResource)
                      Core.mempty
