                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] VideoAbuseReportReasonListResponse
...
newYouTubeVideoAbuseReportReasonsList part
  = YouTubeVideoAbuseReportReasonsList{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       hl = "en-US", part = part, uploadType = Core.Nothing,
                                       uploadProtocol = Core.Nothing}
instance Core.GoogleRequest YouTubeVideoAbuseReportReasonsList
         where
