               ...
               Core.QueryParam "access_token" Core.Text Core.:>
                 Core.QueryParam "callback" Core.Text Core.:>
                   Core.QueryParam "channelId" Core.Text Core.:>
                     Core.QueryParam "channelType" SearchListChannelType Core.:>
                       Core.QueryParam "eventType" SearchListEventType Core.:>
                           ...
                           Core.QueryParam "forDeveloper" Core.Bool Core.:>
                             Core.QueryParam "forMine" Core.Bool Core.:>
                               Core.QueryParam "location" Core.Text Core.:>
                                 Core.QueryParam "locationRadius" Core.Text Core.:>
                                   Core.QueryParam "maxResults" Core.Word32 Core.:>
                                     Core.QueryParam "onBehalfOfContentOwner" Core.Text Core.:>
                                       Core.QueryParam "order" SearchListOrder Core.:>
                                         Core.QueryParam "pageToken" Core.Text Core.:>
                                           Core.QueryParam "publishedAfter" Core.DateTime Core.:>
                                             Core.QueryParam "publishedBefore" Core.DateTime Core.:>
                                               Core.QueryParam "q" Core.Text Core.:>
                                                 Core.QueryParam "regionCode" Core.Text Core.:>
                                                   Core.QueryParam "relevanceLanguage" Core.Text
                                                     Core.:>
                                                     Core.QueryParam "safeSearch"
                                                       SearchListSafeSearch
                                                       Core.:>
                                                       Core.QueryParam "topicId" Core.Text Core.:>
                                                         Core.QueryParams "type" Core.Text Core.:>
                                                           Core.QueryParam "uploadType" Core.Text
                                                             Core.:>
                                                             Core.QueryParam "upload_protocol"
                                                               Core.Text
                                                               Core.:>
                                                               Core.QueryParam "videoCaption"
                                                                 SearchListVideoCaption
                                                                 Core.:>
                                                                 Core.QueryParam "videoCategoryId"
                                                                   Core.Text
                                                                   Core.:>
                                                                   Core.QueryParam "videoDefinition"
...
newYouTubeSearchList part
  = YouTubeSearchList{xgafv = Core.Nothing,
                      accessToken = Core.Nothing, callback = Core.Nothing,
                      channelId = Core.Nothing, channelType = Core.Nothing,
                      eventType = Core.Nothing, forContentOwner = Core.Nothing,
                      forDeveloper = Core.Nothing, forMine = Core.Nothing,
                      location = Core.Nothing, locationRadius = Core.Nothing,
                      maxResults = 5, onBehalfOfContentOwner = Core.Nothing,
                      order = SearchListOrder_Relevance, pageToken = Core.Nothing,
                      part = part, publishedAfter = Core.Nothing,
                      publishedBefore = Core.Nothing, q = Core.Nothing,
                      regionCode = Core.Nothing, relevanceLanguage = Core.Nothing,
                      safeSearch = SearchListSafeSearch_Moderate, topicId = Core.Nothing,
                      type' = Core.Nothing, uploadType = Core.Nothing,
                      uploadProtocol = Core.Nothing, videoCaption = Core.Nothing,
                      videoCategoryId = Core.Nothing, videoDefinition = Core.Nothing,
                      videoDimension = Core.Nothing, videoDuration = Core.Nothing,
                      videoEmbeddable = Core.Nothing, videoLicense = Core.Nothing,
                      videoPaidProductPlacement = Core.Nothing,
                      videoSyndicated = Core.Nothing, videoType = Core.Nothing}
instance Core.GoogleRequest YouTubeSearchList where
        ...
        requestClient YouTubeSearchList{..}
          = go part xgafv accessToken callback channelId channelType
              eventType
              forContentOwner
              forDeveloper
              forMine
