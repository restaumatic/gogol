...
newYouTubeSubscriptionsList part
  = YouTubeSubscriptionsList{xgafv = Core.Nothing,
                             accessToken = Core.Nothing, callback = Core.Nothing,
                             channelId = Core.Nothing, forChannelId = Core.Nothing,
                             id = Core.Nothing, maxResults = 5, mine = Core.Nothing,
                             myRecentSubscribers = Core.Nothing, mySubscribers = Core.Nothing,
                             onBehalfOfContentOwner = Core.Nothing,
                             onBehalfOfContentOwnerChannel = Core.Nothing,
                             order = SubscriptionsListOrder_Relevance, pageToken = Core.Nothing,
                             part = part, uploadType = Core.Nothing,
                             uploadProtocol = Core.Nothing}
instance Core.GoogleRequest YouTubeSubscriptionsList where
        type Rs YouTubeSubscriptionsList = SubscriptionListResponse
        type Scopes YouTubeSubscriptionsList =
             '[Youtube'FullControl, Youtube'ForceSsl, Youtube'Readonly,
               Youtubepartner'FullControl]
        requestClient YouTubeSubscriptionsList{..}
          = go part xgafv accessToken callback channelId forChannelId
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy YouTubeSubscriptionsListResource)
                      Core.mempty
