...
newAbuseReport 
    ::  AbuseReport
newAbuseReport
  = AbuseReport{abuseTypes = Core.Nothing,
                description = Core.Nothing, relatedEntities = Core.Nothing,
...
instance Core.FromJSON AbuseReport where
        parseJSON
          = Core.withObject "AbuseReport"
              (\ o ->
                 AbuseReport Core.<$>
                   (o Core..:? "abuseTypes") Core.<*> (o Core..:? "description")
...
instance Core.FromJSON AccessPolicy where
        parseJSON
          = Core.withObject "AccessPolicy"
              (\ o ->
                 AccessPolicy Core.<$>
                   (o Core..:? "allowed") Core.<*> (o Core..:? "exception"))
...
newActivity 
    ::  Activity
newActivity
  = Activity{contentDetails = Core.Nothing, etag = Core.Nothing,
             id = Core.Nothing, kind = "youtube#activity",
...
instance Core.FromJSON Activity where
        parseJSON
          = Core.withObject "Activity"
              (\ o ->
                 Activity Core.<$>
                   (o Core..:? "contentDetails") Core.<*> (o Core..:? "etag") Core.<*>
                     (o Core..:? "id")
...
newActivityContentDetails 
    ::  ActivityContentDetails
newActivityContentDetails
  = ActivityContentDetails{bulletin = Core.Nothing,
                           channelItem = Core.Nothing, comment = Core.Nothing,
                           favorite = Core.Nothing, like = Core.Nothing,
                           playlistItem = Core.Nothing, promotedItem = Core.Nothing,
                           recommendation = Core.Nothing, social = Core.Nothing,
                           subscription = Core.Nothing, upload = Core.Nothing}
instance Core.FromJSON ActivityContentDetails where
        parseJSON
          = Core.withObject "ActivityContentDetails"
              (\ o ->
                 ActivityContentDetails Core.<$>
                   (o Core..:? "bulletin") Core.<*> (o Core..:? "channelItem")
                     Core.<*> (o Core..:? "comment")
...
instance Core.FromJSON ActivityContentDetailsBulletin where
        parseJSON
          = Core.withObject "ActivityContentDetailsBulletin"
              (\ o ->
                 ActivityContentDetailsBulletin Core.<$> (o Core..:? "resourceId"))

instance Core.ToJSON ActivityContentDetailsBulletin where
        toJSON ActivityContentDetailsBulletin{..}
          = Core.object
              (Core.catMaybes [("resourceId" Core..=) Core.<$> resourceId])
...
instance Core.FromJSON ActivityContentDetailsChannelItem where
        parseJSON
...
instance Core.ToJSON ActivityContentDetailsChannelItem where
...
instance Core.FromJSON ActivityContentDetailsComment where
        parseJSON
          = Core.withObject "ActivityContentDetailsComment"
              (\ o ->
                 ActivityContentDetailsComment Core.<$> (o Core..:? "resourceId"))
...
instance Core.FromJSON ActivityContentDetailsFavorite where
        parseJSON
          = Core.withObject "ActivityContentDetailsFavorite"
              (\ o ->
                 ActivityContentDetailsFavorite Core.<$> (o Core..:? "resourceId"))
...
instance Core.FromJSON ActivityContentDetailsLike where
        parseJSON
          = Core.withObject "ActivityContentDetailsLike"
              (\ o ->
                 ActivityContentDetailsLike Core.<$> (o Core..:? "resourceId"))
...
newActivityContentDetailsPlaylistItem 
    :: 
                                      ActivityContentDetailsPlaylistItem
newActivityContentDetailsPlaylistItem
  = ActivityContentDetailsPlaylistItem{playlistId = Core.Nothing,
                                       playlistItemId = Core.Nothing, resourceId = Core.Nothing}
instance Core.FromJSON ActivityContentDetailsPlaylistItem where
        parseJSON
          = Core.withObject "ActivityContentDetailsPlaylistItem"
              (\ o ->
                 ActivityContentDetailsPlaylistItem Core.<$>
                   (o Core..:? "playlistId") Core.<*> (o Core..:? "playlistItemId")
                     Core.<*> (o Core..:? "resourceId"))

instance Core.ToJSON ActivityContentDetailsPlaylistItem where
...
newActivityContentDetailsPromotedItem 
    :: 
                                      ActivityContentDetailsPromotedItem
newActivityContentDetailsPromotedItem
  = ActivityContentDetailsPromotedItem{adTag = Core.Nothing,
                                       clickTrackingUrl = Core.Nothing,
                                       creativeViewUrl = Core.Nothing, ctaType = Core.Nothing,
                                       customCtaButtonText = Core.Nothing,
                                       descriptionText = Core.Nothing,
                                       destinationUrl = Core.Nothing, forecastingUrl = Core.Nothing,
                                       impressionUrl = Core.Nothing, videoId = Core.Nothing}
instance Core.FromJSON ActivityContentDetailsPromotedItem where
        parseJSON
          = Core.withObject "ActivityContentDetailsPromotedItem"
              (\ o ->
                 ActivityContentDetailsPromotedItem Core.<$>
                   (o Core..:? "adTag") Core.<*> (o Core..:? "clickTrackingUrl")
...
instance Core.ToJSON ActivityContentDetailsPromotedItem where
          ...
          = Core.object
              (Core.catMaybes
                 [("adTag" Core..=) Core.<$> adTag,
                  ...
                  ("customCtaButtonText" Core..=) Core.<$> customCtaButtonText,
...
newActivityContentDetailsRecommendation 
    :: 
                                        ActivityContentDetailsRecommendation
newActivityContentDetailsRecommendation
  = ActivityContentDetailsRecommendation{reason = Core.Nothing,
                                         resourceId = Core.Nothing, seedResourceId = Core.Nothing}
instance Core.FromJSON ActivityContentDetailsRecommendation where
        parseJSON
          = Core.withObject "ActivityContentDetailsRecommendation"
              (\ o ->
                 ActivityContentDetailsRecommendation Core.<$>
                   (o Core..:? "reason") Core.<*> (o Core..:? "resourceId") Core.<*>
                     (o Core..:? "seedResourceId"))

instance Core.ToJSON ActivityContentDetailsRecommendation where
...
newActivityContentDetailsSocial 
    ::  ActivityContentDetailsSocial
newActivityContentDetailsSocial
  = ActivityContentDetailsSocial{author = Core.Nothing,
                                 imageUrl = Core.Nothing, referenceUrl = Core.Nothing,
                                 resourceId = Core.Nothing, type' = Core.Nothing}
          ...
          = Core.withObject "ActivityContentDetailsSocial"
              (\ o ->
                 ActivityContentDetailsSocial Core.<$>
                   (o Core..:? "author") Core.<*> (o Core..:? "imageUrl") Core.<*>
                     (o Core..:? "referenceUrl")
                     Core.<*> (o Core..:? "resourceId")
                     Core.<*> (o Core..:? "type"))
...
instance Core.FromJSON ActivityContentDetailsSubscription where
        parseJSON
          = Core.withObject "ActivityContentDetailsSubscription"
              (\ o ->
                 ActivityContentDetailsSubscription Core.<$>
                   (o Core..:? "resourceId"))

instance Core.ToJSON ActivityContentDetailsSubscription where
...
newActivityListResponse 
    ::  ActivityListResponse
newActivityListResponse
  = ActivityListResponse{etag = Core.Nothing, eventId = Core.Nothing,
                         items = Core.Nothing, kind = "youtube#activityListResponse",
                         nextPageToken = Core.Nothing, pageInfo = Core.Nothing,
                         prevPageToken = Core.Nothing, tokenPagination = Core.Nothing,
          ...
          = Core.withObject "ActivityListResponse"
              (\ o ->
                 ActivityListResponse Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "eventId") Core.<*>
                     (o Core..:? "items")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "youtube#activityListResponse")
...
newActivitySnippet 
    ::  ActivitySnippet
newActivitySnippet
  = ActivitySnippet{channelId = Core.Nothing,
                    channelTitle = Core.Nothing, description = Core.Nothing,
                    groupId = Core.Nothing, publishedAt = Core.Nothing,
                    thumbnails = Core.Nothing, title = Core.Nothing,
                    type' = Core.Nothing}
          ...
          = Core.withObject "ActivitySnippet"
              (\ o ->
                 ActivitySnippet Core.<$>
                   (o Core..:? "channelId") Core.<*> (o Core..:? "channelTitle")
...
newCaption 
    ::  Caption
newCaption
  = Caption{etag = Core.Nothing, id = Core.Nothing,
            kind = "youtube#caption", snippet = Core.Nothing}
instance Core.FromJSON Caption where
        parseJSON
          = Core.withObject "Caption"
              (\ o ->
                 Caption Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "id") Core.<*>
...
newCaptionListResponse 
    ::  CaptionListResponse
newCaptionListResponse
  = CaptionListResponse{etag = Core.Nothing, eventId = Core.Nothing,
                        items = Core.Nothing, kind = "youtube#captionListResponse",
                        visitorId = Core.Nothing}
          ...
          = Core.withObject "CaptionListResponse"
              (\ o ->
                 CaptionListResponse Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "eventId") Core.<*>
                     (o Core..:? "items")
                     Core.<*> (o Core..:? "kind" Core..!= "youtube#captionListResponse")
                     Core.<*> (o Core..:? "visitorId"))
...
newCaptionSnippet 
    ::  CaptionSnippet
newCaptionSnippet
  = CaptionSnippet{audioTrackType = Core.Nothing,
                   failureReason = Core.Nothing, isAutoSynced = Core.Nothing,
                   isCC = Core.Nothing, isDraft = Core.Nothing,
                   isEasyReader = Core.Nothing, isLarge = Core.Nothing,
                   language = Core.Nothing, lastUpdated = Core.Nothing,
                   name = Core.Nothing, status = Core.Nothing,
                   trackKind = Core.Nothing, videoId = Core.Nothing}
instance Core.FromJSON CaptionSnippet where
        parseJSON
          = Core.withObject "CaptionSnippet"
              (\ o ->
                 CaptionSnippet Core.<$>
                   (o Core..:? "audioTrackType") Core.<*> (o Core..:? "failureReason")
...
newCdnSettings 
    ::  CdnSettings
newCdnSettings
  = CdnSettings{format = Core.Nothing, frameRate = Core.Nothing,
                ingestionInfo = Core.Nothing, ingestionType = Core.Nothing,
...
instance Core.FromJSON CdnSettings where
        parseJSON
          = Core.withObject "CdnSettings"
              (\ o ->
                 CdnSettings Core.<$>
                   (o Core..:? "format") Core.<*> (o Core..:? "frameRate") Core.<*>
                     (o Core..:? "ingestionInfo")
...
newChannel 
    ::  Channel
newChannel
  = Channel{auditDetails = Core.Nothing,
            brandingSettings = Core.Nothing, contentDetails = Core.Nothing,
            contentOwnerDetails = Core.Nothing, conversionPings = Core.Nothing,
            etag = Core.Nothing, id = Core.Nothing, kind = "youtube#channel",
            localizations = Core.Nothing, snippet = Core.Nothing,
          ...
          = Core.object
              (Core.catMaybes
                 [("auditDetails" Core..=) Core.<$> auditDetails,
                  ("brandingSettings" Core..=) Core.<$> brandingSettings,
                  ("contentDetails" Core..=) Core.<$> contentDetails,
                  ("contentOwnerDetails" Core..=) Core.<$> contentOwnerDetails,
...
instance Core.FromJSON Channel_Localizations where
        parseJSON
          = Core.withObject "Channel_Localizations"
              (\ o -> Channel_Localizations Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON Channel_Localizations where
        toJSON Channel_Localizations{..} = Core.toJSON additional
...
newChannelAuditDetails 
    ::  ChannelAuditDetails
newChannelAuditDetails
  = ChannelAuditDetails{communityGuidelinesGoodStanding =
                          Core.Nothing,
          ...
          = Core.withObject "ChannelAuditDetails"
              (\ o ->
                 ChannelAuditDetails Core.<$>
                   (o Core..:? "communityGuidelinesGoodStanding") Core.<*>
                     (o Core..:? "contentIdClaimsGoodStanding")
...
newChannelBannerResource 
    ::  ChannelBannerResource
newChannelBannerResource
  = ChannelBannerResource{etag = Core.Nothing,
                          kind = "youtube#channelBannerResource", url = Core.Nothing}
          ...
          = Core.withObject "ChannelBannerResource"
              (\ o ->
                 ChannelBannerResource Core.<$>
                   (o Core..:? "etag") Core.<*>
                     (o Core..:? "kind" Core..!= "youtube#channelBannerResource")
                     Core.<*> (o Core..:? "url"))
...
newChannelBrandingSettings 
    ::  ChannelBrandingSettings
newChannelBrandingSettings
  = ChannelBrandingSettings{channel = Core.Nothing,
                            hints = Core.Nothing, image = Core.Nothing, watch = Core.Nothing}
instance Core.FromJSON ChannelBrandingSettings where
        parseJSON
          = Core.withObject "ChannelBrandingSettings"
              (\ o ->
                 ChannelBrandingSettings Core.<$>
                   (o Core..:? "channel") Core.<*> (o Core..:? "hints") Core.<*>
                     (o Core..:? "image")
                     Core.<*> (o Core..:? "watch"))
          ...
          = Core.object
              (Core.catMaybes
                 [("channel" Core..=) Core.<$> channel,
                  ("hints" Core..=) Core.<$> hints, ("image" Core..=) Core.<$> image,
...
instance Core.FromJSON ChannelContentDetails where
        parseJSON
          = Core.withObject "ChannelContentDetails"
              (\ o ->
                 ChannelContentDetails Core.<$> (o Core..:? "relatedPlaylists"))

instance Core.ToJSON ChannelContentDetails where
        toJSON ChannelContentDetails{..}
          = Core.object
              (Core.catMaybes
                 [("relatedPlaylists" Core..=) Core.<$> relatedPlaylists])
...
newChannelContentDetails_RelatedPlaylists 
    :: 
                                          ChannelContentDetails_RelatedPlaylists
newChannelContentDetails_RelatedPlaylists
  = ChannelContentDetails_RelatedPlaylists{favorites = Core.Nothing,
                                           likes = Core.Nothing, uploads = Core.Nothing,
                                           watchHistory = Core.Nothing, watchLater = Core.Nothing}
instance Core.FromJSON ChannelContentDetails_RelatedPlaylists where
        parseJSON
          = Core.withObject "ChannelContentDetails_RelatedPlaylists"
              (\ o ->
                 ChannelContentDetails_RelatedPlaylists Core.<$>
                   (o Core..:? "favorites") Core.<*> (o Core..:? "likes") Core.<*>
                     (o Core..:? "uploads")
                     Core.<*> (o Core..:? "watchHistory")
                     Core.<*> (o Core..:? "watchLater"))

instance Core.ToJSON ChannelContentDetails_RelatedPlaylists where
...
newChannelContentOwnerDetails 
    ::  ChannelContentOwnerDetails
newChannelContentOwnerDetails
  = ChannelContentOwnerDetails{contentOwner = Core.Nothing,
          ...
          = Core.withObject "ChannelContentOwnerDetails"
              (\ o ->
                 ChannelContentOwnerDetails Core.<$>
                   (o Core..:? "contentOwner") Core.<*> (o Core..:? "timeLinked"))
...
newChannelListResponse 
    ::  ChannelListResponse
newChannelListResponse
  = ChannelListResponse{etag = Core.Nothing, eventId = Core.Nothing,
                        items = Core.Nothing, kind = "youtube#channelListResponse",
                        nextPageToken = Core.Nothing, pageInfo = Core.Nothing,
                        prevPageToken = Core.Nothing, tokenPagination = Core.Nothing,
                        visitorId = Core.Nothing}
          ...
          = Core.withObject "ChannelListResponse"
              (\ o ->
                 ChannelListResponse Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "eventId") Core.<*>
                     (o Core..:? "items")
                     Core.<*> (o Core..:? "kind" Core..!= "youtube#channelListResponse")
                     Core.<*> (o Core..:? "nextPageToken")
                     Core.<*> (o Core..:? "pageInfo")
                     Core.<*> (o Core..:? "prevPageToken")
                     Core.<*> (o Core..:? "tokenPagination")
...
newChannelLocalization 
    ::  ChannelLocalization
newChannelLocalization
  = ChannelLocalization{description = Core.Nothing,
                        title = Core.Nothing}
          ...
          = Core.withObject "ChannelLocalization"
              (\ o ->
                 ChannelLocalization Core.<$>
                   (o Core..:? "description") Core.<*> (o Core..:? "title"))
...
newChannelProfileDetails 
    ::  ChannelProfileDetails
newChannelProfileDetails
  = ChannelProfileDetails{channelId = Core.Nothing,
                          channelUrl = Core.Nothing, displayName = Core.Nothing,
          ...
          = Core.withObject "ChannelProfileDetails"
              (\ o ->
                 ChannelProfileDetails Core.<$>
                   (o Core..:? "channelId") Core.<*> (o Core..:? "channelUrl")
          ...
          = Core.object
              (Core.catMaybes
                 [("channelId" Core..=) Core.<$> channelId,
                  ...
                  ("profileImageUrl" Core..=) Core.<$> profileImageUrl])
...
newChannelSection 
    ::  ChannelSection
newChannelSection
  = ChannelSection{contentDetails = Core.Nothing,
                   etag = Core.Nothing, id = Core.Nothing,
                   kind = "youtube#channelSection", localizations = Core.Nothing,
                   snippet = Core.Nothing, targeting = Core.Nothing}
...
instance Core.FromJSON ChannelSection_Localizations where
        parseJSON
          = Core.withObject "ChannelSection_Localizations"
              (\ o ->
                 ChannelSection_Localizations Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON ChannelSection_Localizations where
        toJSON ChannelSection_Localizations{..} = Core.toJSON additional
...
newChannelSectionContentDetails 
    ::  ChannelSectionContentDetails
newChannelSectionContentDetails
  = ChannelSectionContentDetails{channels = Core.Nothing,
          ...
          = Core.withObject "ChannelSectionContentDetails"
              (\ o ->
                 ChannelSectionContentDetails Core.<$>
                   (o Core..:? "channels") Core.<*> (o Core..:? "playlists"))
...
newChannelSectionListResponse 
    ::  ChannelSectionListResponse
newChannelSectionListResponse
  = ChannelSectionListResponse{etag = Core.Nothing,
                               eventId = Core.Nothing, items = Core.Nothing,
              ...
              (\ o ->
                 ChannelSectionListResponse Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "eventId") Core.<*>
                     (o Core..:? "items")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "youtube#channelSectionListResponse")
                     Core.<*> (o Core..:? "visitorId"))
...
instance Core.FromJSON ChannelSectionLocalization where
        parseJSON
          = Core.withObject "ChannelSectionLocalization"
              (\ o -> ChannelSectionLocalization Core.<$> (o Core..:? "title"))
...
newChannelSectionSnippet 
    ::  ChannelSectionSnippet
newChannelSectionSnippet
  = ChannelSectionSnippet{channelId = Core.Nothing,
                          defaultLanguage = Core.Nothing, localized = Core.Nothing,
                          position = Core.Nothing, style = Core.Nothing,
          ...
          = Core.withObject "ChannelSectionSnippet"
              (\ o ->
                 ChannelSectionSnippet Core.<$>
                   (o Core..:? "channelId") Core.<*> (o Core..:? "defaultLanguage")
          ...
          = Core.object
              (Core.catMaybes
                 [("channelId" Core..=) Core.<$> channelId,
                  ...
                  ("style" Core..=) Core.<$> style, ("title" Core..=) Core.<$> title,
                  ("type" Core..=) Core.<$> type'])
...
newChannelSectionTargeting 
    ::  ChannelSectionTargeting
newChannelSectionTargeting
  = ChannelSectionTargeting{countries = Core.Nothing,
                            languages = Core.Nothing, regions = Core.Nothing}
instance Core.FromJSON ChannelSectionTargeting where
        parseJSON
          = Core.withObject "ChannelSectionTargeting"
              (\ o ->
                 ChannelSectionTargeting Core.<$>
                   (o Core..:? "countries") Core.<*> (o Core..:? "languages") Core.<*>
                     (o Core..:? "regions"))
...
newChannelSettings 
    ::  ChannelSettings
newChannelSettings
  = ChannelSettings{country = Core.Nothing,
                    defaultLanguage = Core.Nothing, defaultTab = Core.Nothing,
                    description = Core.Nothing, featuredChannelsTitle = Core.Nothing,
                    featuredChannelsUrls = Core.Nothing, keywords = Core.Nothing,
                    moderateComments = Core.Nothing, profileColor = Core.Nothing,
                    showBrowseView = Core.Nothing, showRelatedChannels = Core.Nothing,
                    title = Core.Nothing, trackingAnalyticsAccountId = Core.Nothing,
          ...
          = Core.withObject "ChannelSettings"
              (\ o ->
                 ChannelSettings Core.<$>
                   (o Core..:? "country") Core.<*> (o Core..:? "defaultLanguage")
          ...
          = Core.object
              (Core.catMaybes
                 [("country" Core..=) Core.<$> country,
                  ...
                  ("description" Core..=) Core.<$> description,
                  ("featuredChannelsTitle" Core..=) Core.<$> featuredChannelsTitle,
                  ("featuredChannelsUrls" Core..=) Core.<$> featuredChannelsUrls,
                  ("keywords" Core..=) Core.<$> keywords,
                  ("moderateComments" Core..=) Core.<$> moderateComments,
                  ("profileColor" Core..=) Core.<$> profileColor,
                  ("showBrowseView" Core..=) Core.<$> showBrowseView,
                  ("showRelatedChannels" Core..=) Core.<$> showRelatedChannels,
                  ("title" Core..=) Core.<$> title,
                  ("trackingAnalyticsAccountId" Core..=) Core.<$>
                    trackingAnalyticsAccountId,
                  ("unsubscribedTrailer" Core..=) Core.<$> unsubscribedTrailer])
...
newChannelSnippet 
    ::  ChannelSnippet
newChannelSnippet
  = ChannelSnippet{country = Core.Nothing, customUrl = Core.Nothing,
                   defaultLanguage = Core.Nothing, description = Core.Nothing,
                   localized = Core.Nothing, publishedAt = Core.Nothing,
                   thumbnails = Core.Nothing, title = Core.Nothing}
instance Core.FromJSON ChannelSnippet where
        parseJSON
          = Core.withObject "ChannelSnippet"
              (\ o ->
                 ChannelSnippet Core.<$>
                   (o Core..:? "country") Core.<*> (o Core..:? "customUrl") Core.<*>
...
newChannelStatistics 
    ::  ChannelStatistics
newChannelStatistics
  = ChannelStatistics{commentCount = Core.Nothing,
                      hiddenSubscriberCount = Core.Nothing,
                      subscriberCount = Core.Nothing, videoCount = Core.Nothing,
          ...
          = Core.withObject "ChannelStatistics"
              (\ o ->
                 ChannelStatistics Core.<$>
                   (o Core..:? "commentCount" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "hiddenSubscriberCount")
                     Core.<*>
                     (o Core..:? "subscriberCount" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "videoCount" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "viewCount" Core.<&> Core.fmap Core.fromAsText))

instance Core.ToJSON ChannelStatistics where
        toJSON ChannelStatistics{..}
          = Core.object
              (Core.catMaybes
                 [("commentCount" Core..=) Core.. Core.AsText Core.<$> commentCount,
                  ("hiddenSubscriberCount" Core..=) Core.<$> hiddenSubscriberCount,
                  ("subscriberCount" Core..=) Core.. Core.AsText Core.<$>
                    subscriberCount,
                  ("videoCount" Core..=) Core.. Core.AsText Core.<$> videoCount,
                  ("viewCount" Core..=) Core.. Core.AsText Core.<$> viewCount])
...
newChannelStatus 
    ::  ChannelStatus
newChannelStatus
  = ChannelStatus{isChannelMonetizationEnabled = Core.Nothing,
                  isLinked = Core.Nothing, longUploadsStatus = Core.Nothing,
                  madeForKids = Core.Nothing, privacyStatus = Core.Nothing,
...
instance Core.FromJSON ChannelStatus where
        parseJSON
          = Core.withObject "ChannelStatus"
              (\ o ->
                 ChannelStatus Core.<$>
                   (o Core..:? "isChannelMonetizationEnabled") Core.<*>
                     (o Core..:? "isLinked")
...
instance Core.ToJSON ChannelStatus where
        toJSON ChannelStatus{..}
          = Core.object
              (Core.catMaybes
                 [("isChannelMonetizationEnabled" Core..=) Core.<$>
...
data ChannelToStoreLinkDetails = ChannelToStoreLinkDetails
    {
      ...
      billingDetails :: (Core.Maybe ChannelToStoreLinkDetailsBillingDetails)
      -- | Information specific to merchant affiliate program (read-only).
    , merchantAffiliateProgramDetails :: (Core.Maybe
   ChannelToStoreLinkDetailsMerchantAffiliateProgramDetails)
...
newChannelToStoreLinkDetails 
    ::  ChannelToStoreLinkDetails
newChannelToStoreLinkDetails
  = ChannelToStoreLinkDetails{billingDetails = Core.Nothing,
                              merchantAffiliateProgramDetails = Core.Nothing,
                              merchantId = Core.Nothing, storeName = Core.Nothing,
          ...
          = Core.withObject "ChannelToStoreLinkDetails"
              (\ o ->
                 ChannelToStoreLinkDetails Core.<$>
                   (o Core..:? "billingDetails") Core.<*>
                     (o Core..:? "merchantAffiliateProgramDetails")
                     Core.<*>
...
instance Core.ToJSON ChannelToStoreLinkDetails where
        toJSON ChannelToStoreLinkDetails{..}
          = Core.object
              (Core.catMaybes
                 [("billingDetails" Core..=) Core.<$> billingDetails,
                  ("merchantAffiliateProgramDetails" Core..=) Core.<$>
...
--
-- /See:/ 'newChannelToStoreLinkDetailsBillingDetails' smart constructor.
newtype ChannelToStoreLinkDetailsBillingDetails = ChannelToStoreLinkDetailsBillingDetails
    {
      -- | The current billing profile status.
      billingStatus :: (Core.Maybe ChannelToStoreLinkDetailsBillingDetails_BillingStatus)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'ChannelToStoreLinkDetailsBillingDetails' with the minimum fields required to make a request.
newChannelToStoreLinkDetailsBillingDetails 
    :: 
                                           ChannelToStoreLinkDetailsBillingDetails
newChannelToStoreLinkDetailsBillingDetails
  = ChannelToStoreLinkDetailsBillingDetails{billingStatus =
                                              Core.Nothing}
instance Core.FromJSON ChannelToStoreLinkDetailsBillingDetails
         where
        parseJSON
          = Core.withObject "ChannelToStoreLinkDetailsBillingDetails"
              (\ o ->
                 ChannelToStoreLinkDetailsBillingDetails Core.<$>
                   (o Core..:? "billingStatus"))

instance Core.ToJSON ChannelToStoreLinkDetailsBillingDetails where
        toJSON ChannelToStoreLinkDetailsBillingDetails{..}
          = Core.object
              (Core.catMaybes [("billingStatus" Core..=) Core.<$> billingStatus])


-- | Information specific to merchant affiliate program.
--
-- /See:/ 'newChannelToStoreLinkDetailsMerchantAffiliateProgramDetails' smart constructor.
newtype ChannelToStoreLinkDetailsMerchantAffiliateProgramDetails = ChannelToStoreLinkDetailsMerchantAffiliateProgramDetails
    {
...
-- | Creates a value of 'ChannelToStoreLinkDetailsMerchantAffiliateProgramDetails' with the minimum fields required to make a request.
newChannelToStoreLinkDetailsMerchantAffiliateProgramDetails 
    :: 
                                                            ChannelToStoreLinkDetailsMerchantAffiliateProgramDetails
newChannelToStoreLinkDetailsMerchantAffiliateProgramDetails
  = ChannelToStoreLinkDetailsMerchantAffiliateProgramDetails{status =
                                                               Core.Nothing}
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "ChannelToStoreLinkDetailsMerchantAffiliateProgramDetails"
              (\ o ->
                 ChannelToStoreLinkDetailsMerchantAffiliateProgramDetails Core.<$>
                   (o Core..:? "status"))

instance Core.ToJSON
           ChannelToStoreLinkDetailsMerchantAffiliateProgramDetails
         where
        toJSON ChannelToStoreLinkDetailsMerchantAffiliateProgramDetails{..}
...
newChannelTopicDetails 
    ::  ChannelTopicDetails
newChannelTopicDetails
  = ChannelTopicDetails{topicCategories = Core.Nothing,
          ...
          = Core.withObject "ChannelTopicDetails"
              (\ o ->
                 ChannelTopicDetails Core.<$>
                   (o Core..:? "topicCategories") Core.<*> (o Core..:? "topicIds"))
...
newComment 
    ::  Comment
newComment
  = Comment{etag = Core.Nothing, id = Core.Nothing,
            kind = "youtube#comment", snippet = Core.Nothing}
...
newCommentListResponse 
    ::  CommentListResponse
newCommentListResponse
  = CommentListResponse{etag = Core.Nothing, eventId = Core.Nothing,
                        items = Core.Nothing, kind = "youtube#commentListResponse",
                        nextPageToken = Core.Nothing, pageInfo = Core.Nothing,
                        tokenPagination = Core.Nothing, visitorId = Core.Nothing}
          ...
          = Core.withObject "CommentListResponse"
              (\ o ->
                 CommentListResponse Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "eventId") Core.<*>
                     (o Core..:? "items")
                     Core.<*> (o Core..:? "kind" Core..!= "youtube#commentListResponse")
                     Core.<*> (o Core..:? "nextPageToken")
                     Core.<*> (o Core..:? "pageInfo")
                     Core.<*> (o Core..:? "tokenPagination")
                     Core.<*> (o Core..:? "visitorId"))
...
newCommentSnippet 
    ::  CommentSnippet
newCommentSnippet
  = CommentSnippet{authorChannelId = Core.Nothing,
                   authorChannelUrl = Core.Nothing, authorDisplayName = Core.Nothing,
                   authorProfileImageUrl = Core.Nothing, canRate = Core.Nothing,
                   channelId = Core.Nothing, likeCount = Core.Nothing,
                   moderationStatus = Core.Nothing, parentId = Core.Nothing,
                   postId = Core.Nothing, publishedAt = Core.Nothing,
                   textDisplay = Core.Nothing, textOriginal = Core.Nothing,
                   updatedAt = Core.Nothing, videoId = Core.Nothing,
...
instance Core.ToJSON CommentSnippet where
        toJSON CommentSnippet{..}
          = Core.object
              (Core.catMaybes
                 [("authorChannelId" Core..=) Core.<$> authorChannelId,
                  ("authorChannelUrl" Core..=) Core.<$> authorChannelUrl,
                  ("authorDisplayName" Core..=) Core.<$> authorDisplayName,
                  ("authorProfileImageUrl" Core..=) Core.<$> authorProfileImageUrl,
                  ("canRate" Core..=) Core.<$> canRate,
                  ("channelId" Core..=) Core.<$> channelId,
                  ("likeCount" Core..=) Core.<$> likeCount,
                  ("moderationStatus" Core..=) Core.<$> moderationStatus,
...
instance Core.FromJSON CommentSnippetAuthorChannelId where
        parseJSON
          = Core.withObject "CommentSnippetAuthorChannelId"
              (\ o ->
                 CommentSnippetAuthorChannelId Core.<$> (o Core..:? "value"))
...
newCommentThread 
    ::  CommentThread
newCommentThread
  = CommentThread{etag = Core.Nothing, id = Core.Nothing,
                  kind = "youtube#commentThread", replies = Core.Nothing,
                  snippet = Core.Nothing}
...
newCommentThreadListResponse 
    ::  CommentThreadListResponse
newCommentThreadListResponse
  = CommentThreadListResponse{etag = Core.Nothing,
                              eventId = Core.Nothing, items = Core.Nothing,
              ...
              (\ o ->
                 CommentThreadListResponse Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "eventId") Core.<*>
                     (o Core..:? "items")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "youtube#commentThreadListResponse")
                     Core.<*> (o Core..:? "nextPageToken")
                     Core.<*> (o Core..:? "pageInfo")
                     Core.<*> (o Core..:? "tokenPagination")
                     Core.<*> (o Core..:? "visitorId"))
...
data CommentThreadSnippet = CommentThreadSnippet
    {
      ...
      -- | The YouTube channel the comments in the thread refer to or the channel with the video the comments refer to. If neither video/id nor post/id is set the comments refer to the channel itself.
    , channelId :: (Core.Maybe Core.Text)
...
newCommentThreadSnippet 
    ::  CommentThreadSnippet
newCommentThreadSnippet
  = CommentThreadSnippet{canReply = Core.Nothing,
                         channelId = Core.Nothing, isPublic = Core.Nothing,
                         postId = Core.Nothing, topLevelComment = Core.Nothing,
                         totalReplyCount = Core.Nothing, videoId = Core.Nothing}
instance Core.FromJSON CommentThreadSnippet where
        parseJSON
          = Core.withObject "CommentThreadSnippet"
              (\ o ->
                 CommentThreadSnippet Core.<$>
                   (o Core..:? "canReply") Core.<*> (o Core..:? "channelId") Core.<*>
                     (o Core..:? "isPublic")
                     Core.<*> (o Core..:? "postId")
...
newContentRating 
    ::  ContentRating
newContentRating
  = ContentRating{acbRating = Core.Nothing,
                  agcomRating = Core.Nothing, anatelRating = Core.Nothing,
                  bbfcRating = Core.Nothing, bfvcRating = Core.Nothing,
                  bmukkRating = Core.Nothing, catvRating = Core.Nothing,
                  catvfrRating = Core.Nothing, cbfcRating = Core.Nothing,
                  cccRating = Core.Nothing, cceRating = Core.Nothing,
                  chfilmRating = Core.Nothing, chvrsRating = Core.Nothing,
                  cicfRating = Core.Nothing, cnaRating = Core.Nothing,
                  cncRating = Core.Nothing, csaRating = Core.Nothing,
                  cscfRating = Core.Nothing, czfilmRating = Core.Nothing,
                  djctqRating = Core.Nothing, djctqRatingReasons = Core.Nothing,
                  ecbmctRating = Core.Nothing, eefilmRating = Core.Nothing,
                  egfilmRating = Core.Nothing, eirinRating = Core.Nothing,
                  fcbmRating = Core.Nothing, fcoRating = Core.Nothing,
                  fmocRating = Core.Nothing, fpbRating = Core.Nothing,
                  fpbRatingReasons = Core.Nothing, fskRating = Core.Nothing,
                  grfilmRating = Core.Nothing, icaaRating = Core.Nothing,
                  ifcoRating = Core.Nothing, ilfilmRating = Core.Nothing,
                  incaaRating = Core.Nothing, kfcbRating = Core.Nothing,
                  kijkwijzerRating = Core.Nothing, kmrbRating = Core.Nothing,
                  lsfRating = Core.Nothing, mccaaRating = Core.Nothing,
                  mccypRating = Core.Nothing, mcstRating = Core.Nothing,
                  mdaRating = Core.Nothing, medietilsynetRating = Core.Nothing,
                  mekuRating = Core.Nothing, menaMpaaRating = Core.Nothing,
                  mibacRating = Core.Nothing, mocRating = Core.Nothing,
                  moctwRating = Core.Nothing, mpaaRating = Core.Nothing,
                  mpaatRating = Core.Nothing, mtrcbRating = Core.Nothing,
                  nbcRating = Core.Nothing, nbcplRating = Core.Nothing,
                  nfrcRating = Core.Nothing, nfvcbRating = Core.Nothing,
                  nkclvRating = Core.Nothing, nmcRating = Core.Nothing,
                  oflcRating = Core.Nothing, pefilmRating = Core.Nothing,
                  rcnofRating = Core.Nothing, resorteviolenciaRating = Core.Nothing,
                  rtcRating = Core.Nothing, rteRating = Core.Nothing,
                  russiaRating = Core.Nothing, skfilmRating = Core.Nothing,
                  smaisRating = Core.Nothing, smsaRating = Core.Nothing,
                  tvpgRating = Core.Nothing, ytRating = Core.Nothing}
instance Core.FromJSON ContentRating where
        parseJSON
          = Core.withObject "ContentRating"
              (\ o ->
                 ContentRating Core.<$>
                   (o Core..:? "acbRating") Core.<*> (o Core..:? "agcomRating")
          ...
          = Core.object
              (Core.catMaybes
                 [("acbRating" Core..=) Core.<$> acbRating,
                  ...
                  ("djctqRatingReasons" Core..=) Core.<$> djctqRatingReasons,
                  ...
                  ("fpbRatingReasons" Core..=) Core.<$> fpbRatingReasons,
                  ...
                  ("kijkwijzerRating" Core..=) Core.<$> kijkwijzerRating,
                  ...
                  ("medietilsynetRating" Core..=) Core.<$> medietilsynetRating,
                  ...
                  ("resorteviolenciaRating" Core..=) Core.<$> resorteviolenciaRating,
...
newCuepoint 
    ::  Cuepoint
newCuepoint
  = Cuepoint{cueType = Core.Nothing, durationSecs = Core.Nothing,
             etag = Core.Nothing, id = Core.Nothing,
             insertionOffsetTimeMs = Core.Nothing, walltimeMs = Core.Nothing}
instance Core.FromJSON Cuepoint where
        parseJSON
          = Core.withObject "Cuepoint"
              (\ o ->
                 Cuepoint Core.<$>
                   (o Core..:? "cueType") Core.<*> (o Core..:? "durationSecs")
                     Core.<*> (o Core..:? "etag")
                     Core.<*> (o Core..:? "id")
                     Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "walltimeMs" Core.<&> Core.fmap Core.fromAsText))
          ...
          = Core.object
              (Core.catMaybes
                 [("cueType" Core..=) Core.<$> cueType,
                  ...
                  ("etag" Core..=) Core.<$> etag, ("id" Core..=) Core.<$> id,
                  ("insertionOffsetTimeMs" Core..=) Core.. Core.AsText Core.<$>
                    insertionOffsetTimeMs,
                  ("walltimeMs" Core..=) Core.. Core.AsText Core.<$> walltimeMs])


-- | Schedule to insert cuepoints into a broadcast by ads automator.
--
-- /See:/ 'newCuepointSchedule' smart constructor.
data CuepointSchedule = CuepointSchedule
    {
    ...
    , pauseAdsUntil :: (Core.Maybe Core.Text)
      -- | Interval frequency in seconds that api uses to insert cuepoints automatically.
    , repeatIntervalSecs :: (Core.Maybe Core.Int32)
      -- | The strategy to use when scheduling cuepoints.
    , scheduleStrategy :: (Core.Maybe CuepointSchedule_ScheduleStrategy)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'CuepointSchedule' with the minimum fields required to make a request.
newCuepointSchedule 
    ::  CuepointSchedule
newCuepointSchedule
  = CuepointSchedule{enabled = Core.Nothing,
                     pauseAdsUntil = Core.Nothing, repeatIntervalSecs = Core.Nothing,
                     scheduleStrategy = Core.Nothing}
instance Core.FromJSON CuepointSchedule where
        parseJSON
          = Core.withObject "CuepointSchedule"
              (\ o ->
                 CuepointSchedule Core.<$>
                   (o Core..:? "enabled") Core.<*> (o Core..:? "pauseAdsUntil")
                     Core.<*> (o Core..:? "repeatIntervalSecs")
                     Core.<*> (o Core..:? "scheduleStrategy"))

instance Core.ToJSON CuepointSchedule where
        toJSON CuepointSchedule{..}
          = Core.object
              (Core.catMaybes
                 [("enabled" Core..=) Core.<$> enabled,
                  ("pauseAdsUntil" Core..=) Core.<$> pauseAdsUntil,
                  ("repeatIntervalSecs" Core..=) Core.<$> repeatIntervalSecs,
                  ("scheduleStrategy" Core..=) Core.<$> scheduleStrategy])
...
newEntity 
    ::  Entity
newEntity
  = Entity{id = Core.Nothing, typeId = Core.Nothing,
           url = Core.Nothing}
instance Core.FromJSON Entity where
        parseJSON
          = Core.withObject "Entity"
              (\ o ->
                 Entity Core.<$>
                   (o Core..:? "id") Core.<*> (o Core..:? "typeId") Core.<*>
                     (o Core..:? "url"))
...
instance Core.ToJSON Entity where
        toJSON Entity{..}
          = Core.object
              (Core.catMaybes
                 [("id" Core..=) Core.<$> id, ("typeId" Core..=) Core.<$> typeId,
                  ("url" Core..=) Core.<$> url])
...
newGeoPoint 
    ::  GeoPoint
newGeoPoint
  = GeoPoint{altitude = Core.Nothing, latitude = Core.Nothing,
...
newI18nLanguage 
    ::  I18nLanguage
newI18nLanguage
  = I18nLanguage{etag = Core.Nothing, id = Core.Nothing,
                 kind = "youtube#i18nLanguage", snippet = Core.Nothing}
...
newI18nLanguageListResponse 
    ::  I18nLanguageListResponse
newI18nLanguageListResponse
  = I18nLanguageListResponse{etag = Core.Nothing,
                             eventId = Core.Nothing, items = Core.Nothing,
              ...
              (\ o ->
                 I18nLanguageListResponse Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "eventId") Core.<*>
                     (o Core..:? "items")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "youtube#i18nLanguageListResponse")
                     Core.<*> (o Core..:? "visitorId"))
...
instance Core.ToJSON I18nLanguageSnippet where
        toJSON I18nLanguageSnippet{..}
          = Core.object
              (Core.catMaybes
                 [("hl" Core..=) Core.<$> hl, ("name" Core..=) Core.<$> name])
...
newI18nRegion 
    ::  I18nRegion
newI18nRegion
  = I18nRegion{etag = Core.Nothing, id = Core.Nothing,
               kind = "youtube#i18nRegion", snippet = Core.Nothing}
...
newI18nRegionListResponse 
    ::  I18nRegionListResponse
newI18nRegionListResponse
  = I18nRegionListResponse{etag = Core.Nothing,
                           eventId = Core.Nothing, items = Core.Nothing,
                           kind = "youtube#i18nRegionListResponse", visitorId = Core.Nothing}
              ...
              (\ o ->
                 I18nRegionListResponse Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "eventId") Core.<*>
                     (o Core..:? "items")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "youtube#i18nRegionListResponse")
                     Core.<*> (o Core..:? "visitorId"))
...
instance Core.ToJSON I18nRegionSnippet where
        toJSON I18nRegionSnippet{..}
          = Core.object
              (Core.catMaybes
                 [("gl" Core..=) Core.<$> gl, ("name" Core..=) Core.<$> name])
...
newImageSettings 
    ::  ImageSettings
newImageSettings
  = ImageSettings{backgroundImageUrl = Core.Nothing,
                  bannerExternalUrl = Core.Nothing, bannerImageUrl = Core.Nothing,
                  ...
                  trackingImageUrl = Core.Nothing, watchIconImageUrl = Core.Nothing}
...
instance Core.ToJSON ImageSettings where
        toJSON ImageSettings{..}
          = Core.object
              (Core.catMaybes
                 [("backgroundImageUrl" Core..=) Core.<$> backgroundImageUrl,
                  ("bannerExternalUrl" Core..=) Core.<$> bannerExternalUrl,
                  ("bannerImageUrl" Core..=) Core.<$> bannerImageUrl,
                  ("bannerMobileExtraHdImageUrl" Core..=) Core.<$>
                    bannerMobileExtraHdImageUrl,
                  ("bannerMobileHdImageUrl" Core..=) Core.<$> bannerMobileHdImageUrl,
                  ("bannerMobileImageUrl" Core..=) Core.<$> bannerMobileImageUrl,
                  ...
                  ("bannerTabletHdImageUrl" Core..=) Core.<$> bannerTabletHdImageUrl,
                  ("bannerTabletImageUrl" Core..=) Core.<$> bannerTabletImageUrl,
                  ("bannerTabletLowImageUrl" Core..=) Core.<$>
                    bannerTabletLowImageUrl,
                  ("bannerTvHighImageUrl" Core..=) Core.<$> bannerTvHighImageUrl,
                  ("bannerTvImageUrl" Core..=) Core.<$> bannerTvImageUrl,
                  ("bannerTvLowImageUrl" Core..=) Core.<$> bannerTvLowImageUrl,
                  ("bannerTvMediumImageUrl" Core..=) Core.<$> bannerTvMediumImageUrl,
                  ("largeBrandedBannerImageImapScript" Core..=) Core.<$>
                    largeBrandedBannerImageImapScript,
                  ("largeBrandedBannerImageUrl" Core..=) Core.<$>
                    largeBrandedBannerImageUrl,
                  ("smallBrandedBannerImageImapScript" Core..=) Core.<$>
                    smallBrandedBannerImageImapScript,
                  ("smallBrandedBannerImageUrl" Core..=) Core.<$>
                    smallBrandedBannerImageUrl,
                  ("trackingImageUrl" Core..=) Core.<$> trackingImageUrl,
                  ("watchIconImageUrl" Core..=) Core.<$> watchIconImageUrl])
...
newIngestionInfo 
    ::  IngestionInfo
newIngestionInfo
  = IngestionInfo{backupIngestionAddress = Core.Nothing,
                  ingestionAddress = Core.Nothing,
                  rtmpsBackupIngestionAddress = Core.Nothing,
                  rtmpsIngestionAddress = Core.Nothing, streamName = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("backupIngestionAddress" Core..=) Core.<$>
                  ...
                  ("ingestionAddress" Core..=) Core.<$> ingestionAddress,
                  ("rtmpsBackupIngestionAddress" Core..=) Core.<$>
                    rtmpsBackupIngestionAddress,
                  ("rtmpsIngestionAddress" Core..=) Core.<$> rtmpsIngestionAddress,
...
newInvideoBranding 
    ::  InvideoBranding
newInvideoBranding
  = InvideoBranding{imageBytes = Core.Nothing,
                    imageUrl = Core.Nothing, position = Core.Nothing,
                    targetChannelId = Core.Nothing, timing = Core.Nothing}
instance Core.FromJSON InvideoBranding where
        parseJSON
          = Core.withObject "InvideoBranding"
              (\ o ->
                 InvideoBranding Core.<$>
                   (o Core..:? "imageBytes") Core.<*> (o Core..:? "imageUrl") Core.<*>
                     (o Core..:? "position")
...
newInvideoPosition 
    ::  InvideoPosition
newInvideoPosition
  = InvideoPosition{cornerPosition = Core.Nothing,
                    type' = Core.Nothing}
          ...
          = Core.withObject "InvideoPosition"
              (\ o ->
                 InvideoPosition Core.<$>
                   (o Core..:? "cornerPosition") Core.<*> (o Core..:? "type"))
...
newInvideoTiming 
    ::  InvideoTiming
newInvideoTiming
  = InvideoTiming{durationMs = Core.Nothing, offsetMs = Core.Nothing,
                  type' = Core.Nothing}
              ...
              (\ o ->
                 InvideoTiming Core.<$>
                   (o Core..:? "durationMs" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "offsetMs" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "type"))
          ...
          = Core.object
              (Core.catMaybes
                 [("durationMs" Core..=) Core.. Core.AsText Core.<$> durationMs,
                  ("offsetMs" Core..=) Core.. Core.AsText Core.<$> offsetMs,
                  ("type" Core..=) Core.<$> type'])
...
instance Core.FromJSON LevelDetails where
        parseJSON
          = Core.withObject "LevelDetails"
              (\ o -> LevelDetails Core.<$> (o Core..:? "displayName"))
...
data LiveBroadcast = LiveBroadcast
    ...
    , monetizationDetails :: (Core.Maybe LiveBroadcastMonetizationDetails)
...
newLiveBroadcast 
    ::  LiveBroadcast
newLiveBroadcast
  = LiveBroadcast{contentDetails = Core.Nothing, etag = Core.Nothing,
                  id = Core.Nothing, kind = "youtube#liveBroadcast",
                  monetizationDetails = Core.Nothing, snippet = Core.Nothing,
                  statistics = Core.Nothing, status = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("contentDetails" Core..=) Core.<$> contentDetails,
                  ("etag" Core..=) Core.<$> etag, ("id" Core..=) Core.<$> id,
                  Core.Just ("kind" Core..= kind),
                  ("monetizationDetails" Core..=) Core.<$> monetizationDetails,
                  ("snippet" Core..=) Core.<$> snippet,
                  ("statistics" Core..=) Core.<$> statistics,
                  ("status" Core..=) Core.<$> status])
...
newLiveBroadcastContentDetails 
    ::  LiveBroadcastContentDetails
newLiveBroadcastContentDetails
  = LiveBroadcastContentDetails{boundStreamId = Core.Nothing,
                                boundStreamLastUpdateTimeMs = Core.Nothing,
                                closedCaptionsType = Core.Nothing, enableAutoStart = Core.Nothing,
                                enableAutoStop = Core.Nothing, enableClosedCaptions = Core.Nothing,
                                enableContentEncryption = Core.Nothing, enableDvr = Core.Nothing,
                                enableEmbed = Core.Nothing, enableLowLatency = Core.Nothing,
                                latencyPreference = Core.Nothing, mesh = Core.Nothing,
                                monitorStream = Core.Nothing, projection = Core.Nothing,
                                recordFromStart = Core.Nothing, startWithSlate = Core.Nothing,
          ...
          = Core.object
              (Core.catMaybes
                 [("boundStreamId" Core..=) Core.<$> boundStreamId,
                  ...
                  ("closedCaptionsType" Core..=) Core.<$> closedCaptionsType,
                  ("enableAutoStart" Core..=) Core.<$> enableAutoStart,
                  ("enableAutoStop" Core..=) Core.<$> enableAutoStop,
                  ("enableClosedCaptions" Core..=) Core.<$> enableClosedCaptions,
                  ("enableContentEncryption" Core..=) Core.<$>
                    enableContentEncryption,
                  ("enableDvr" Core..=) Core.<$> enableDvr,
                  ("enableEmbed" Core..=) Core.<$> enableEmbed,
                  ("enableLowLatency" Core..=) Core.<$> enableLowLatency,
                  ("latencyPreference" Core..=) Core.<$> latencyPreference,
                  ("mesh" Core..=) Core.<$> mesh,
...
newLiveBroadcastListResponse 
    ::  LiveBroadcastListResponse
newLiveBroadcastListResponse
  = LiveBroadcastListResponse{etag = Core.Nothing,
                              eventId = Core.Nothing, items = Core.Nothing,
              ...
              (\ o ->
                 LiveBroadcastListResponse Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "eventId") Core.<*>
                     (o Core..:? "items")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "youtube#liveBroadcastListResponse")
                     Core.<*> (o Core..:? "nextPageToken")
                     Core.<*> (o Core..:? "pageInfo")
                     Core.<*> (o Core..:? "prevPageToken")
                     Core.<*> (o Core..:? "tokenPagination")
...
--
-- /See:/ 'newLiveBroadcastMonetizationDetails' smart constructor.
newtype LiveBroadcastMonetizationDetails = LiveBroadcastMonetizationDetails
    {

      cuepointSchedule :: (Core.Maybe CuepointSchedule)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newLiveBroadcastMonetizationDetails 
    :: 
                                    LiveBroadcastMonetizationDetails
newLiveBroadcastMonetizationDetails
  = LiveBroadcastMonetizationDetails{cuepointSchedule = Core.Nothing}
instance Core.FromJSON LiveBroadcastMonetizationDetails where
        parseJSON
          = Core.withObject "LiveBroadcastMonetizationDetails"
              (\ o ->
                 LiveBroadcastMonetizationDetails Core.<$>
                   (o Core..:? "cuepointSchedule"))

instance Core.ToJSON LiveBroadcastMonetizationDetails where
        toJSON LiveBroadcastMonetizationDetails{..}
          = Core.object
              (Core.catMaybes
                 [("cuepointSchedule" Core..=) Core.<$> cuepointSchedule])
...
newLiveBroadcastSnippet 
    ::  LiveBroadcastSnippet
newLiveBroadcastSnippet
  = LiveBroadcastSnippet{actualEndTime = Core.Nothing,
                         actualStartTime = Core.Nothing, channelId = Core.Nothing,
                         description = Core.Nothing, isDefaultBroadcast = Core.Nothing,
                         liveChatId = Core.Nothing, publishedAt = Core.Nothing,
                         scheduledEndTime = Core.Nothing, scheduledStartTime = Core.Nothing,
                         thumbnails = Core.Nothing, title = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("actualEndTime" Core..=) Core.<$> actualEndTime,
                  ...
                  ("channelId" Core..=) Core.<$> channelId,
                  ("description" Core..=) Core.<$> description,
                  ("isDefaultBroadcast" Core..=) Core.<$> isDefaultBroadcast,
                  ("liveChatId" Core..=) Core.<$> liveChatId,
                  ("publishedAt" Core..=) Core.<$> publishedAt,
                  ("scheduledEndTime" Core..=) Core.<$> scheduledEndTime,
                  ("scheduledStartTime" Core..=) Core.<$> scheduledStartTime,
                  ("thumbnails" Core..=) Core.<$> thumbnails,
                  ("title" Core..=) Core.<$> title])
...
instance Core.ToJSON LiveBroadcastStatistics where
        toJSON LiveBroadcastStatistics{..}
          = Core.object
              (Core.catMaybes
                 [("concurrentViewers" Core..=) Core.. Core.AsText Core.<$>
                    concurrentViewers])
...
newLiveBroadcastStatus 
    ::  LiveBroadcastStatus
newLiveBroadcastStatus
  = LiveBroadcastStatus{lifeCycleStatus = Core.Nothing,
                        liveBroadcastPriority = Core.Nothing, madeForKids = Core.Nothing,
                        privacyStatus = Core.Nothing, recordingStatus = Core.Nothing,
                        selfDeclaredMadeForKids = Core.Nothing}
...
instance Core.ToJSON LiveBroadcastStatus where
        toJSON LiveBroadcastStatus{..}
          = Core.object
              (Core.catMaybes
                 [("lifeCycleStatus" Core..=) Core.<$> lifeCycleStatus,
                  ("liveBroadcastPriority" Core..=) Core.<$> liveBroadcastPriority,
                  ("madeForKids" Core..=) Core.<$> madeForKids,
                  ("privacyStatus" Core..=) Core.<$> privacyStatus,
...
newLiveChatBan 
    ::  LiveChatBan
newLiveChatBan
  = LiveChatBan{etag = Core.Nothing, id = Core.Nothing,
                kind = "youtube#liveChatBan", snippet = Core.Nothing}
...
newLiveChatBanSnippet 
    ::  LiveChatBanSnippet
newLiveChatBanSnippet
  = LiveChatBanSnippet{banDurationSeconds = Core.Nothing,
                       bannedUserDetails = Core.Nothing, liveChatId = Core.Nothing,
                       type' = Core.Nothing}
...
instance Core.ToJSON LiveChatBanSnippet where
        toJSON LiveChatBanSnippet{..}
          = Core.object
              (Core.catMaybes
                 [("banDurationSeconds" Core..=) Core.. Core.AsText Core.<$>
                    banDurationSeconds,
                  ("bannedUserDetails" Core..=) Core.<$> bannedUserDetails,
                  ("liveChatId" Core..=) Core.<$> liveChatId,
                  ("type" Core..=) Core.<$> type'])
...
newLiveChatFanFundingEventDetails 
    ::  LiveChatFanFundingEventDetails
newLiveChatFanFundingEventDetails
  = LiveChatFanFundingEventDetails{amountDisplayString =
                                     Core.Nothing,
                                   amountMicros = Core.Nothing, currency = Core.Nothing,
              ...
              (\ o ->
                 LiveChatFanFundingEventDetails Core.<$>
                   (o Core..:? "amountDisplayString") Core.<*>
                     (o Core..:? "amountMicros" Core.<&> Core.fmap Core.fromAsText)
...
instance Core.ToJSON LiveChatFanFundingEventDetails where
        toJSON LiveChatFanFundingEventDetails{..}
          = Core.object
              (Core.catMaybes
                 [("amountDisplayString" Core..=) Core.<$> amountDisplayString,
                  ("amountMicros" Core..=) Core.. Core.AsText Core.<$> amountMicros,
...
instance Core.FromJSON LiveChatGiftMembershipReceivedDetails where
        parseJSON
          = Core.withObject "LiveChatGiftMembershipReceivedDetails"
              (\ o ->
                 LiveChatGiftMembershipReceivedDetails Core.<$>
                   (o Core..:? "associatedMembershipGiftingMessageId") Core.<*>
                     (o Core..:? "gifterChannelId")
                     Core.<*> (o Core..:? "memberLevelName"))

instance Core.ToJSON LiveChatGiftMembershipReceivedDetails where
        toJSON LiveChatGiftMembershipReceivedDetails{..}
          = Core.object
              (Core.catMaybes
                 [("associatedMembershipGiftingMessageId" Core..=) Core.<$>
                    associatedMembershipGiftingMessageId,
                  ("gifterChannelId" Core..=) Core.<$> gifterChannelId,
                  ("memberLevelName" Core..=) Core.<$> memberLevelName])
...
newLiveChatMemberMilestoneChatDetails
  = LiveChatMemberMilestoneChatDetails{memberLevelName =
                                         Core.Nothing,
                                       memberMonth = Core.Nothing, userComment = Core.Nothing}
instance Core.FromJSON LiveChatMemberMilestoneChatDetails where
        parseJSON
          = Core.withObject "LiveChatMemberMilestoneChatDetails"
              (\ o ->
                 LiveChatMemberMilestoneChatDetails Core.<$>
                   (o Core..:? "memberLevelName") Core.<*> (o Core..:? "memberMonth")
                     Core.<*> (o Core..:? "userComment"))

instance Core.ToJSON LiveChatMemberMilestoneChatDetails where
...
instance Core.FromJSON LiveChatMembershipGiftingDetails where
        parseJSON
...
instance Core.ToJSON LiveChatMembershipGiftingDetails where
        toJSON LiveChatMembershipGiftingDetails{..}
          = Core.object
              (Core.catMaybes
                 [("giftMembershipsCount" Core..=) Core.<$> giftMembershipsCount,
...
newLiveChatMessage 
    ::  LiveChatMessage
newLiveChatMessage
  = LiveChatMessage{authorDetails = Core.Nothing,
                    etag = Core.Nothing, id = Core.Nothing,
                    kind = "youtube#liveChatMessage", snippet = Core.Nothing}
instance Core.FromJSON LiveChatMessage where
        parseJSON
          = Core.withObject "LiveChatMessage"
              (\ o ->
                 LiveChatMessage Core.<$>
                   (o Core..:? "authorDetails") Core.<*> (o Core..:? "etag") Core.<*>
                     (o Core..:? "id")
                     Core.<*> (o Core..:? "kind" Core..!= "youtube#liveChatMessage")
                     Core.<*> (o Core..:? "snippet"))
...
newLiveChatMessageAuthorDetails 
    ::  LiveChatMessageAuthorDetails
newLiveChatMessageAuthorDetails
  = LiveChatMessageAuthorDetails{channelId = Core.Nothing,
                                 channelUrl = Core.Nothing, displayName = Core.Nothing,
                                 isChatModerator = Core.Nothing, isChatOwner = Core.Nothing,
                                 isChatSponsor = Core.Nothing, isVerified = Core.Nothing,
                                 profileImageUrl = Core.Nothing}
...
instance Core.ToJSON LiveChatMessageDeletedDetails where
        toJSON LiveChatMessageDeletedDetails{..}
          = Core.object
              (Core.catMaybes
                 [("deletedMessageId" Core..=) Core.<$> deletedMessageId])
...
data LiveChatMessageListResponse = LiveChatMessageListResponse
    {
      ...
      activePollItem :: (Core.Maybe LiveChatMessage)
      -- | Etag of this resource.
    , etag :: (Core.Maybe Core.Text)
      -- | Serialized EventId of the request which produced this response.
    , eventId :: (Core.Maybe Core.Text)
...
newLiveChatMessageListResponse 
    ::  LiveChatMessageListResponse
newLiveChatMessageListResponse
  = LiveChatMessageListResponse{activePollItem = Core.Nothing,
                                etag = Core.Nothing, eventId = Core.Nothing, items = Core.Nothing,
                                kind = "youtube#liveChatMessageListResponse",
                                nextPageToken = Core.Nothing, offlineAt = Core.Nothing,
                                pageInfo = Core.Nothing, pollingIntervalMillis = Core.Nothing,
                                tokenPagination = Core.Nothing, visitorId = Core.Nothing}
          ...
          = Core.withObject "LiveChatMessageListResponse"
              (\ o ->
                 LiveChatMessageListResponse Core.<$>
                   (o Core..:? "activePollItem") Core.<*> (o Core..:? "etag") Core.<*>
                     (o Core..:? "eventId")
                     Core.<*> (o Core..:? "items")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "youtube#liveChatMessageListResponse")
                     Core.<*> (o Core..:? "nextPageToken")
...
instance Core.ToJSON LiveChatMessageListResponse where
        toJSON LiveChatMessageListResponse{..}
          = Core.object
              (Core.catMaybes
                 [("activePollItem" Core..=) Core.<$> activePollItem,
                  ("etag" Core..=) Core.<$> etag,
                  ("eventId" Core..=) Core.<$> eventId,
                  ("items" Core..=) Core.<$> items, Core.Just ("kind" Core..= kind),
                  ("nextPageToken" Core..=) Core.<$> nextPageToken,
                  ...
                  ("pageInfo" Core..=) Core.<$> pageInfo,
                  ("pollingIntervalMillis" Core..=) Core.<$> pollingIntervalMillis,
                  ("tokenPagination" Core..=) Core.<$> tokenPagination,
                  ("visitorId" Core..=) Core.<$> visitorId])
...
newLiveChatMessageRetractedDetails
  = LiveChatMessageRetractedDetails{retractedMessageId =
                                      Core.Nothing}
instance Core.FromJSON LiveChatMessageRetractedDetails where
        parseJSON
...
instance Core.ToJSON LiveChatMessageRetractedDetails where
        toJSON LiveChatMessageRetractedDetails{..}
          = Core.object
              (Core.catMaybes
                 [("retractedMessageId" Core..=) Core.<$> retractedMessageId])
...
data LiveChatMessageSnippet = LiveChatMessageSnippet
    ...
    , pollDetails :: (Core.Maybe LiveChatPollDetails)
...
newLiveChatMessageSnippet 
    ::  LiveChatMessageSnippet
newLiveChatMessageSnippet
  = LiveChatMessageSnippet{authorChannelId = Core.Nothing,
                           displayMessage = Core.Nothing,
                           fanFundingEventDetails = Core.Nothing,
                           giftMembershipReceivedDetails = Core.Nothing,
                           hasDisplayContent = Core.Nothing, liveChatId = Core.Nothing,
                           ...
                           newSponsorDetails' = Core.Nothing, pollDetails = Core.Nothing,
                           publishedAt = Core.Nothing, superChatDetails = Core.Nothing,
                           superStickerDetails = Core.Nothing,
                           textMessageDetails = Core.Nothing, type' = Core.Nothing,
          ...
          = Core.object
              (Core.catMaybes
                 [("authorChannelId" Core..=) Core.<$> authorChannelId,
                  ...
                  ("fanFundingEventDetails" Core..=) Core.<$> fanFundingEventDetails,
                  ("giftMembershipReceivedDetails" Core..=) Core.<$>
                    giftMembershipReceivedDetails,
                  ("hasDisplayContent" Core..=) Core.<$> hasDisplayContent,
                  ("liveChatId" Core..=) Core.<$> liveChatId,
                  ("memberMilestoneChatDetails" Core..=) Core.<$>
                    memberMilestoneChatDetails,
                  ("membershipGiftingDetails" Core..=) Core.<$>
                    membershipGiftingDetails,
                  ("messageDeletedDetails" Core..=) Core.<$> messageDeletedDetails,
                  ("messageRetractedDetails" Core..=) Core.<$>
                    messageRetractedDetails,
                  ("newSponsorDetails" Core..=) Core.<$> newSponsorDetails',
                  ("pollDetails" Core..=) Core.<$> pollDetails,
                  ("publishedAt" Core..=) Core.<$> publishedAt,
                  ("superChatDetails" Core..=) Core.<$> superChatDetails,
                  ("superStickerDetails" Core..=) Core.<$> superStickerDetails,
                  ("textMessageDetails" Core..=) Core.<$> textMessageDetails,
                  ("type" Core..=) Core.<$> type',
                  ("userBannedDetails" Core..=) Core.<$> userBannedDetails])
...
newLiveChatModerator 
    ::  LiveChatModerator
newLiveChatModerator
  = LiveChatModerator{etag = Core.Nothing, id = Core.Nothing,
                      kind = "youtube#liveChatModerator", snippet = Core.Nothing}
          ...
          = Core.withObject "LiveChatModerator"
              (\ o ->
                 LiveChatModerator Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "id") Core.<*>
                     (o Core..:? "kind" Core..!= "youtube#liveChatModerator")
                     Core.<*> (o Core..:? "snippet"))
...
newLiveChatModeratorListResponse 
    ::  LiveChatModeratorListResponse
newLiveChatModeratorListResponse
  = LiveChatModeratorListResponse{etag = Core.Nothing,
                                  eventId = Core.Nothing, items = Core.Nothing,
...
newLiveChatModeratorSnippet 
    ::  LiveChatModeratorSnippet
newLiveChatModeratorSnippet
  = LiveChatModeratorSnippet{liveChatId = Core.Nothing,
          ...
          = Core.withObject "LiveChatModeratorSnippet"
              (\ o ->
                 LiveChatModeratorSnippet Core.<$>
                   (o Core..:? "liveChatId") Core.<*> (o Core..:? "moderatorDetails"))
...
instance Core.ToJSON LiveChatModeratorSnippet where
        toJSON LiveChatModeratorSnippet{..}
          = Core.object
              (Core.catMaybes
                 [("liveChatId" Core..=) Core.<$> liveChatId,
                  ("moderatorDetails" Core..=) Core.<$> moderatorDetails])
...
newLiveChatNewSponsorDetails 
    ::  LiveChatNewSponsorDetails
newLiveChatNewSponsorDetails
  = LiveChatNewSponsorDetails{isUpgrade = Core.Nothing,
                              memberLevelName = Core.Nothing}
          ...
          = Core.withObject "LiveChatNewSponsorDetails"
              (\ o ->
                 LiveChatNewSponsorDetails Core.<$>
                   (o Core..:? "isUpgrade") Core.<*> (o Core..:? "memberLevelName"))
...
--
-- /See:/ 'newLiveChatPollDetails' smart constructor.
data LiveChatPollDetails = LiveChatPollDetails
    {

      metadata :: (Core.Maybe LiveChatPollDetailsPollMetadata)

    , status :: (Core.Maybe LiveChatPollDetails_Status)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'LiveChatPollDetails' with the minimum fields required to make a request.
newLiveChatPollDetails 
    ::  LiveChatPollDetails
newLiveChatPollDetails
  = LiveChatPollDetails{metadata = Core.Nothing,
                        status = Core.Nothing}
instance Core.FromJSON LiveChatPollDetails where
        parseJSON
          = Core.withObject "LiveChatPollDetails"
              (\ o ->
                 LiveChatPollDetails Core.<$>
                   (o Core..:? "metadata") Core.<*> (o Core..:? "status"))

instance Core.ToJSON LiveChatPollDetails where
        toJSON LiveChatPollDetails{..}
          = Core.object
              (Core.catMaybes
...
--
-- /See:/ 'newLiveChatPollDetailsPollMetadata' smart constructor.
data LiveChatPollDetailsPollMetadata = LiveChatPollDetailsPollMetadata
    {
      -- | The options will be returned in the order that is displayed in 1P
      options :: (Core.Maybe [LiveChatPollDetailsPollMetadataPollOption])

    , questionText :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'LiveChatPollDetailsPollMetadata' with the minimum fields required to make a request.
newLiveChatPollDetailsPollMetadata 
    :: 
                                   LiveChatPollDetailsPollMetadata
newLiveChatPollDetailsPollMetadata
  = LiveChatPollDetailsPollMetadata{options = Core.Nothing,
                                    questionText = Core.Nothing}
instance Core.FromJSON LiveChatPollDetailsPollMetadata where
        parseJSON
          = Core.withObject "LiveChatPollDetailsPollMetadata"
              (\ o ->
                 LiveChatPollDetailsPollMetadata Core.<$>
                   (o Core..:? "options") Core.<*> (o Core..:? "questionText"))

instance Core.ToJSON LiveChatPollDetailsPollMetadata where
        toJSON LiveChatPollDetailsPollMetadata{..}
          = Core.object
              (Core.catMaybes
                 [("options" Core..=) Core.<$> options,
                  ("questionText" Core..=) Core.<$> questionText])


--
-- /See:/ 'newLiveChatPollDetailsPollMetadataPollOption' smart constructor.
data LiveChatPollDetailsPollMetadataPollOption = LiveChatPollDetailsPollMetadataPollOption
    {

      optionText :: (Core.Maybe Core.Text)

    , tally :: (Core.Maybe Core.Int64)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'LiveChatPollDetailsPollMetadataPollOption' with the minimum fields required to make a request.
newLiveChatPollDetailsPollMetadataPollOption 
    :: 
                                             LiveChatPollDetailsPollMetadataPollOption
newLiveChatPollDetailsPollMetadataPollOption
  = LiveChatPollDetailsPollMetadataPollOption{optionText =
                                                Core.Nothing,
                                              tally = Core.Nothing}
instance Core.FromJSON LiveChatPollDetailsPollMetadataPollOption
         where
        parseJSON
          = Core.withObject "LiveChatPollDetailsPollMetadataPollOption"
              (\ o ->
                 LiveChatPollDetailsPollMetadataPollOption Core.<$>
                   (o Core..:? "optionText") Core.<*>
                     (o Core..:? "tally" Core.<&> Core.fmap Core.fromAsText))

instance Core.ToJSON LiveChatPollDetailsPollMetadataPollOption
         where
        toJSON LiveChatPollDetailsPollMetadataPollOption{..}
          = Core.object
              (Core.catMaybes
                 [("optionText" Core..=) Core.<$> optionText,
                  ("tally" Core..=) Core.. Core.AsText Core.<$> tally])
...
newLiveChatSuperChatDetails 
    ::  LiveChatSuperChatDetails
newLiveChatSuperChatDetails
  = LiveChatSuperChatDetails{amountDisplayString = Core.Nothing,
                             amountMicros = Core.Nothing, currency = Core.Nothing,
                             tier = Core.Nothing, userComment = Core.Nothing}
...
newLiveChatSuperStickerDetails 
    ::  LiveChatSuperStickerDetails
newLiveChatSuperStickerDetails
  = LiveChatSuperStickerDetails{amountDisplayString = Core.Nothing,
                                amountMicros = Core.Nothing, currency = Core.Nothing,
                                superStickerMetadata = Core.Nothing, tier = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("amountDisplayString" Core..=) Core.<$> amountDisplayString,
                  ("amountMicros" Core..=) Core.. Core.AsText Core.<$> amountMicros,
                  ("currency" Core..=) Core.<$> currency,
                  ("superStickerMetadata" Core..=) Core.<$> superStickerMetadata,
                  ("tier" Core..=) Core.<$> tier])
...
instance Core.FromJSON LiveChatTextMessageDetails where
        parseJSON
          = Core.withObject "LiveChatTextMessageDetails"
              (\ o ->
                 LiveChatTextMessageDetails Core.<$> (o Core..:? "messageText"))

instance Core.ToJSON LiveChatTextMessageDetails where
        toJSON LiveChatTextMessageDetails{..}
          = Core.object
              (Core.catMaybes [("messageText" Core..=) Core.<$> messageText])
...
newLiveChatUserBannedMessageDetails
  = LiveChatUserBannedMessageDetails{banDurationSeconds =
                                       Core.Nothing,
                                     banType = Core.Nothing, bannedUserDetails = Core.Nothing}
instance Core.FromJSON LiveChatUserBannedMessageDetails where
        parseJSON
...
newLiveStream 
    ::  LiveStream
newLiveStream
  = LiveStream{cdn = Core.Nothing, contentDetails = Core.Nothing,
               etag = Core.Nothing, id = Core.Nothing,
               kind = "youtube#liveStream", snippet = Core.Nothing,
               status = Core.Nothing}
instance Core.FromJSON LiveStream where
        parseJSON
          = Core.withObject "LiveStream"
              (\ o ->
                 LiveStream Core.<$>
                   (o Core..:? "cdn") Core.<*> (o Core..:? "contentDetails") Core.<*>
                     (o Core..:? "etag")
                     Core.<*> (o Core..:? "id")
...
newLiveStreamConfigurationIssue 
    ::  LiveStreamConfigurationIssue
newLiveStreamConfigurationIssue
  = LiveStreamConfigurationIssue{description = Core.Nothing,
                                 reason = Core.Nothing, severity = Core.Nothing,
                                 type' = Core.Nothing}
          ...
          = Core.withObject "LiveStreamConfigurationIssue"
              (\ o ->
                 LiveStreamConfigurationIssue Core.<$>
                   (o Core..:? "description") Core.<*> (o Core..:? "reason") Core.<*>
                     (o Core..:? "severity")
                     Core.<*> (o Core..:? "type"))
...
newLiveStreamContentDetails 
    ::  LiveStreamContentDetails
newLiveStreamContentDetails
  = LiveStreamContentDetails{closedCaptionsIngestionUrl =
                               Core.Nothing,
...
newLiveStreamHealthStatus 
    ::  LiveStreamHealthStatus
newLiveStreamHealthStatus
  = LiveStreamHealthStatus{configurationIssues = Core.Nothing,
                           lastUpdateTimeSeconds = Core.Nothing, status = Core.Nothing}
...
instance Core.ToJSON LiveStreamHealthStatus where
        toJSON LiveStreamHealthStatus{..}
          = Core.object
              (Core.catMaybes
                 [("configurationIssues" Core..=) Core.<$> configurationIssues,
                  ("lastUpdateTimeSeconds" Core..=) Core.. Core.AsText Core.<$>
...
newLiveStreamListResponse 
    ::  LiveStreamListResponse
newLiveStreamListResponse
  = LiveStreamListResponse{etag = Core.Nothing,
                           eventId = Core.Nothing, items = Core.Nothing,
              ...
              (\ o ->
                 LiveStreamListResponse Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "eventId") Core.<*>
                     (o Core..:? "items")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "youtube#liveStreamListResponse")
                     Core.<*> (o Core..:? "nextPageToken")
                     Core.<*> (o Core..:? "pageInfo")
                     Core.<*> (o Core..:? "prevPageToken")
                     Core.<*> (o Core..:? "tokenPagination")
...
newLiveStreamSnippet 
    ::  LiveStreamSnippet
newLiveStreamSnippet
  = LiveStreamSnippet{channelId = Core.Nothing,
                      description = Core.Nothing, isDefaultStream = Core.Nothing,
                      publishedAt = Core.Nothing, title = Core.Nothing}
instance Core.FromJSON LiveStreamSnippet where
        parseJSON
          = Core.withObject "LiveStreamSnippet"
              (\ o ->
                 LiveStreamSnippet Core.<$>
                   (o Core..:? "channelId") Core.<*> (o Core..:? "description")
...
newLiveStreamStatus 
    ::  LiveStreamStatus
newLiveStreamStatus
  = LiveStreamStatus{healthStatus = Core.Nothing,
          ...
          = Core.withObject "LiveStreamStatus"
              (\ o ->
                 LiveStreamStatus Core.<$>
                   (o Core..:? "healthStatus") Core.<*> (o Core..:? "streamStatus"))
...
newLocalizedProperty 
    ::  LocalizedProperty
newLocalizedProperty
  = LocalizedProperty{default' = Core.Nothing,
                      defaultLanguage = Core.Nothing, localized = Core.Nothing}
          ...
          = Core.withObject "LocalizedProperty"
              (\ o ->
                 LocalizedProperty Core.<$>
                   (o Core..:? "default") Core.<*> (o Core..:? "defaultLanguage")
                     Core.<*> (o Core..:? "localized"))
          ...
          = Core.withObject "LocalizedString"
              (\ o ->
                 LocalizedString Core.<$>
                   (o Core..:? "language") Core.<*> (o Core..:? "value"))
...
newMember 
    ::  Member
newMember
  = Member{etag = Core.Nothing, kind = "youtube#member",
           snippet = Core.Nothing}
...
newMemberListResponse 
    ::  MemberListResponse
newMemberListResponse
  = MemberListResponse{etag = Core.Nothing, eventId = Core.Nothing,
                       items = Core.Nothing, kind = "youtube#memberListResponse",
                       nextPageToken = Core.Nothing, pageInfo = Core.Nothing,
                       tokenPagination = Core.Nothing, visitorId = Core.Nothing}
          ...
          = Core.withObject "MemberListResponse"
              (\ o ->
                 MemberListResponse Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "eventId") Core.<*>
                     (o Core..:? "items")
                     Core.<*> (o Core..:? "kind" Core..!= "youtube#memberListResponse")
                     Core.<*> (o Core..:? "nextPageToken")
                     Core.<*> (o Core..:? "pageInfo")
                     Core.<*> (o Core..:? "tokenPagination")
                     Core.<*> (o Core..:? "visitorId"))
...
newMemberSnippet 
    ::  MemberSnippet
newMemberSnippet
  = MemberSnippet{creatorChannelId = Core.Nothing,
                  memberDetails = Core.Nothing, membershipsDetails = Core.Nothing}
...
instance Core.ToJSON MemberSnippet where
        toJSON MemberSnippet{..}
          = Core.object
              (Core.catMaybes
                 [("creatorChannelId" Core..=) Core.<$> creatorChannelId,
                  ("memberDetails" Core..=) Core.<$> memberDetails,
                  ("membershipsDetails" Core..=) Core.<$> membershipsDetails])
...
newMembershipsDetails 
    ::  MembershipsDetails
newMembershipsDetails
  = MembershipsDetails{accessibleLevels = Core.Nothing,
...
instance Core.ToJSON MembershipsDetails where
        toJSON MembershipsDetails{..}
          = Core.object
              (Core.catMaybes
                 [("accessibleLevels" Core..=) Core.<$> accessibleLevels,
                  ("highestAccessibleLevel" Core..=) Core.<$> highestAccessibleLevel,
                  ("highestAccessibleLevelDisplayName" Core..=) Core.<$>
                    highestAccessibleLevelDisplayName,
                  ("membershipsDuration" Core..=) Core.<$> membershipsDuration,
...
newMembershipsDuration 
    ::  MembershipsDuration
newMembershipsDuration
  = MembershipsDuration{memberSince = Core.Nothing,
...
newMembershipsDurationAtLevel 
    ::  MembershipsDurationAtLevel
newMembershipsDurationAtLevel
  = MembershipsDurationAtLevel{level = Core.Nothing,
          ...
          = Core.withObject "MembershipsDurationAtLevel"
              (\ o ->
                 MembershipsDurationAtLevel Core.<$>
                   (o Core..:? "level") Core.<*> (o Core..:? "memberSince") Core.<*>
                     (o Core..:? "memberTotalDurationMonths"))
...
newMembershipsLevel 
    ::  MembershipsLevel
newMembershipsLevel
  = MembershipsLevel{etag = Core.Nothing, id = Core.Nothing,
                     kind = "youtube#membershipsLevel", snippet = Core.Nothing}
          ...
          = Core.withObject "MembershipsLevel"
              (\ o ->
                 MembershipsLevel Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "id") Core.<*>
                     (o Core..:? "kind" Core..!= "youtube#membershipsLevel")
                     Core.<*> (o Core..:? "snippet"))
...
newMembershipsLevelListResponse 
    ::  MembershipsLevelListResponse
newMembershipsLevelListResponse
  = MembershipsLevelListResponse{etag = Core.Nothing,
                                 eventId = Core.Nothing, items = Core.Nothing,
              ...
              (\ o ->
                 MembershipsLevelListResponse Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "eventId") Core.<*>
                     (o Core..:? "items")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "youtube#membershipsLevelListResponse")
                     Core.<*> (o Core..:? "visitorId"))
...
newMembershipsLevelSnippet 
    ::  MembershipsLevelSnippet
newMembershipsLevelSnippet
  = MembershipsLevelSnippet{creatorChannelId = Core.Nothing,
...
newMonitorStreamInfo 
    ::  MonitorStreamInfo
newMonitorStreamInfo
  = MonitorStreamInfo{broadcastStreamDelayMs = Core.Nothing,
                      embedHtml = Core.Nothing, enableMonitorStream = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("broadcastStreamDelayMs" Core..=) Core.<$>
                  ...
                  ("enableMonitorStream" Core..=) Core.<$> enableMonitorStream])
...
newPageInfo 
    ::  PageInfo
newPageInfo
  = PageInfo{resultsPerPage = Core.Nothing,
...
instance Core.FromJSON PageInfo where
        parseJSON
          = Core.withObject "PageInfo"
              (\ o ->
                 PageInfo Core.<$>
                   (o Core..:? "resultsPerPage") Core.<*> (o Core..:? "totalResults"))
...
newPlaylist 
    ::  Playlist
newPlaylist
  = Playlist{contentDetails = Core.Nothing, etag = Core.Nothing,
             id = Core.Nothing, kind = "youtube#playlist",
             localizations = Core.Nothing, player = Core.Nothing,
             snippet = Core.Nothing, status = Core.Nothing}
...
instance Core.FromJSON Playlist_Localizations where
        parseJSON
          = Core.withObject "Playlist_Localizations"
              (\ o -> Playlist_Localizations Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON Playlist_Localizations where
        toJSON Playlist_Localizations{..} = Core.toJSON additional
...
newPlaylistContentDetails 
    ::  PlaylistContentDetails
newPlaylistContentDetails
  = PlaylistContentDetails{itemCount = Core.Nothing}
instance Core.FromJSON PlaylistContentDetails where
        parseJSON
          = Core.withObject "PlaylistContentDetails"
              (\ o -> PlaylistContentDetails Core.<$> (o Core..:? "itemCount"))

instance Core.ToJSON PlaylistContentDetails where
        toJSON PlaylistContentDetails{..}
          = Core.object
              (Core.catMaybes [("itemCount" Core..=) Core.<$> itemCount])


--
-- /See:/ 'newPlaylistImage' smart constructor.
data PlaylistImage = PlaylistImage
    ...
    , snippet :: (Core.Maybe PlaylistImageSnippet)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'PlaylistImage' with the minimum fields required to make a request.
newPlaylistImage 
    ::  PlaylistImage
newPlaylistImage
  = PlaylistImage{id = Core.Nothing, kind = "youtube#playlistImage",
                  snippet = Core.Nothing}
instance Core.FromJSON PlaylistImage where
        parseJSON
          = Core.withObject "PlaylistImage"
              (\ o ->
                 PlaylistImage Core.<$>
                   (o Core..:? "id") Core.<*>
                     (o Core..:? "kind" Core..!= "youtube#playlistImage")
                     Core.<*> (o Core..:? "snippet"))

instance Core.ToJSON PlaylistImage where
        toJSON PlaylistImage{..}
          = Core.object
              (Core.catMaybes
...
--
-- /See:/ 'newPlaylistImageListResponse' smart constructor.
data PlaylistImageListResponse = PlaylistImageListResponse
    {

      items :: (Core.Maybe [PlaylistImage])
...
-- | Creates a value of 'PlaylistImageListResponse' with the minimum fields required to make a request.
newPlaylistImageListResponse 
    ::  PlaylistImageListResponse
newPlaylistImageListResponse
  = PlaylistImageListResponse{items = Core.Nothing,
                              kind = "youtube#playlistImageListResponse",
                              nextPageToken = Core.Nothing, pageInfo = Core.Nothing,
                              prevPageToken = Core.Nothing}
instance Core.FromJSON PlaylistImageListResponse where
        parseJSON
          = Core.withObject "PlaylistImageListResponse"
              (\ o ->
                 PlaylistImageListResponse Core.<$>
                   (o Core..:? "items") Core.<*>
                     (o Core..:? "kind" Core..!= "youtube#playlistImageListResponse")
                     Core.<*> (o Core..:? "nextPageToken")
                     Core.<*> (o Core..:? "pageInfo")
                     Core.<*> (o Core..:? "prevPageToken"))

instance Core.ToJSON PlaylistImageListResponse where
        toJSON PlaylistImageListResponse{..}
          = Core.object
              (Core.catMaybes
                 [("items" Core..=) Core.<$> items, Core.Just ("kind" Core..= kind),
                  ("nextPageToken" Core..=) Core.<$> nextPageToken,
...
--
-- /See:/ 'newPlaylistImageSnippet' smart constructor.
data PlaylistImageSnippet = PlaylistImageSnippet
    {
      -- | The image height.
    ...
    , playlistId :: (Core.Maybe Core.Text)
      -- | The image type.
    , type' :: (Core.Maybe PlaylistImageSnippet_Type)
      -- | The image width.
    , width :: (Core.Maybe Core.Int32)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'PlaylistImageSnippet' with the minimum fields required to make a request.
newPlaylistImageSnippet 
    ::  PlaylistImageSnippet
newPlaylistImageSnippet
  = PlaylistImageSnippet{height = Core.Nothing,
                         playlistId = Core.Nothing, type' = Core.Nothing,
                         width = Core.Nothing}
instance Core.FromJSON PlaylistImageSnippet where
        parseJSON
          = Core.withObject "PlaylistImageSnippet"
              (\ o ->
                 PlaylistImageSnippet Core.<$>
                   (o Core..:? "height") Core.<*> (o Core..:? "playlistId") Core.<*>
                     (o Core..:? "type")
                     Core.<*> (o Core..:? "width"))

instance Core.ToJSON PlaylistImageSnippet where
        toJSON PlaylistImageSnippet{..}
          = Core.object
              (Core.catMaybes
                 [("height" Core..=) Core.<$> height,
                  ("playlistId" Core..=) Core.<$> playlistId,
                  ("type" Core..=) Core.<$> type', ("width" Core..=) Core.<$> width])
...
newPlaylistItem 
    ::  PlaylistItem
newPlaylistItem
  = PlaylistItem{contentDetails = Core.Nothing, etag = Core.Nothing,
                 id = Core.Nothing, kind = "youtube#playlistItem",
                 snippet = Core.Nothing, status = Core.Nothing}
...
newPlaylistItemContentDetails 
    ::  PlaylistItemContentDetails
newPlaylistItemContentDetails
  = PlaylistItemContentDetails{endAt = Core.Nothing,
                               note = Core.Nothing, startAt = Core.Nothing,
                               videoId = Core.Nothing, videoPublishedAt = Core.Nothing}
          ...
          = Core.withObject "PlaylistItemContentDetails"
              (\ o ->
                 PlaylistItemContentDetails Core.<$>
                   (o Core..:? "endAt") Core.<*> (o Core..:? "note") Core.<*>
                     (o Core..:? "startAt")
                     Core.<*> (o Core..:? "videoId")
...
instance Core.ToJSON PlaylistItemContentDetails where
        toJSON PlaylistItemContentDetails{..}
          = Core.object
              (Core.catMaybes
                 [("endAt" Core..=) Core.<$> endAt, ("note" Core..=) Core.<$> note,
                  ("startAt" Core..=) Core.<$> startAt,
                  ("videoId" Core..=) Core.<$> videoId,
                  ("videoPublishedAt" Core..=) Core.<$> videoPublishedAt])
...
newPlaylistItemListResponse 
    ::  PlaylistItemListResponse
newPlaylistItemListResponse
  = PlaylistItemListResponse{etag = Core.Nothing,
                             eventId = Core.Nothing, items = Core.Nothing,
              ...
              (\ o ->
                 PlaylistItemListResponse Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "eventId") Core.<*>
                     (o Core..:? "items")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "youtube#playlistItemListResponse")
                     Core.<*> (o Core..:? "nextPageToken")
                     Core.<*> (o Core..:? "pageInfo")
                     Core.<*> (o Core..:? "prevPageToken")
                     Core.<*> (o Core..:? "tokenPagination")
...
newPlaylistItemSnippet 
    ::  PlaylistItemSnippet
newPlaylistItemSnippet
  = PlaylistItemSnippet{channelId = Core.Nothing,
                        channelTitle = Core.Nothing, description = Core.Nothing,
                        playlistId = Core.Nothing, position = Core.Nothing,
                        publishedAt = Core.Nothing, resourceId = Core.Nothing,
                        thumbnails = Core.Nothing, title = Core.Nothing,
          ...
          = Core.object
              (Core.catMaybes
                 [("channelId" Core..=) Core.<$> channelId,
                  ...
                  ("thumbnails" Core..=) Core.<$> thumbnails,
                  ("title" Core..=) Core.<$> title,
                  ("videoOwnerChannelId" Core..=) Core.<$> videoOwnerChannelId,
...
newPlaylistListResponse 
    ::  PlaylistListResponse
newPlaylistListResponse
  = PlaylistListResponse{etag = Core.Nothing, eventId = Core.Nothing,
                         items = Core.Nothing, kind = "youtube#playlistListResponse",
                         nextPageToken = Core.Nothing, pageInfo = Core.Nothing,
                         prevPageToken = Core.Nothing, tokenPagination = Core.Nothing,
                         visitorId = Core.Nothing}
              ...
              (\ o ->
                 PlaylistListResponse Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "eventId") Core.<*>
                     (o Core..:? "items")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "youtube#playlistListResponse")
                     Core.<*> (o Core..:? "nextPageToken")
                     Core.<*> (o Core..:? "pageInfo")
                     Core.<*> (o Core..:? "prevPageToken")
                     Core.<*> (o Core..:? "tokenPagination")
...
newPlaylistLocalization 
    ::  PlaylistLocalization
newPlaylistLocalization
  = PlaylistLocalization{description = Core.Nothing,
                         title = Core.Nothing}
...
instance Core.FromJSON PlaylistPlayer where
        parseJSON
          = Core.withObject "PlaylistPlayer"
              (\ o -> PlaylistPlayer Core.<$> (o Core..:? "embedHtml"))

instance Core.ToJSON PlaylistPlayer where
        toJSON PlaylistPlayer{..}
          = Core.object
              (Core.catMaybes [("embedHtml" Core..=) Core.<$> embedHtml])
...
newPlaylistSnippet 
    ::  PlaylistSnippet
newPlaylistSnippet
  = PlaylistSnippet{channelId = Core.Nothing,
                    channelTitle = Core.Nothing, defaultLanguage = Core.Nothing,
                    description = Core.Nothing, localized = Core.Nothing,
                    publishedAt = Core.Nothing, tags = Core.Nothing,
                    thumbnailVideoId = Core.Nothing, thumbnails = Core.Nothing,
                    title = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("channelId" Core..=) Core.<$> channelId,
                  ...
                  ("publishedAt" Core..=) Core.<$> publishedAt,
                  ("tags" Core..=) Core.<$> tags,
                  ("thumbnailVideoId" Core..=) Core.<$> thumbnailVideoId,
                  ("thumbnails" Core..=) Core.<$> thumbnails,
                  ("title" Core..=) Core.<$> title])
...
data PlaylistStatus = PlaylistStatus
    {
      -- | The playlist\'s podcast status.
      podcastStatus :: (Core.Maybe PlaylistStatus_PodcastStatus)
...
newPlaylistStatus 
    ::  PlaylistStatus
newPlaylistStatus
  = PlaylistStatus{podcastStatus = Core.Nothing,
...
instance Core.FromJSON PlaylistStatus where
        parseJSON
          = Core.withObject "PlaylistStatus"
              (\ o ->
                 PlaylistStatus Core.<$>
                   (o Core..:? "podcastStatus") Core.<*> (o Core..:? "privacyStatus"))

instance Core.ToJSON PlaylistStatus where
        toJSON PlaylistStatus{..}
          = Core.object
              (Core.catMaybes
                 [("podcastStatus" Core..=) Core.<$> podcastStatus,
                  ("privacyStatus" Core..=) Core.<$> privacyStatus])
...
newPropertyValue 
    ::  PropertyValue
newPropertyValue
  = PropertyValue{property = Core.Nothing, value = Core.Nothing}
instance Core.FromJSON PropertyValue where
        parseJSON
          = Core.withObject "PropertyValue"
              (\ o ->
                 PropertyValue Core.<$>
                   (o Core..:? "property") Core.<*> (o Core..:? "value"))
...
instance Core.ToJSON RelatedEntity where
        toJSON RelatedEntity{..}
          = Core.object (Core.catMaybes [("entity" Core..=) Core.<$> entity])
...
newResourceId 
    ::  ResourceId
newResourceId
  = ResourceId{channelId = Core.Nothing, kind = Core.Nothing,
               playlistId = Core.Nothing, videoId = Core.Nothing}
instance Core.FromJSON ResourceId where
        parseJSON
          = Core.withObject "ResourceId"
              (\ o ->
                 ResourceId Core.<$>
                   (o Core..:? "channelId") Core.<*> (o Core..:? "kind") Core.<*>
                     (o Core..:? "playlistId")
                     Core.<*> (o Core..:? "videoId"))
...
newSearchListResponse 
    ::  SearchListResponse
newSearchListResponse
  = SearchListResponse{etag = Core.Nothing, eventId = Core.Nothing,
                       items = Core.Nothing, kind = "youtube#searchListResponse",
                       nextPageToken = Core.Nothing, pageInfo = Core.Nothing,
                       prevPageToken = Core.Nothing, regionCode = Core.Nothing,
                       tokenPagination = Core.Nothing, visitorId = Core.Nothing}
          ...
          = Core.withObject "SearchListResponse"
              (\ o ->
                 SearchListResponse Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "eventId") Core.<*>
                     (o Core..:? "items")
                     Core.<*> (o Core..:? "kind" Core..!= "youtube#searchListResponse")
                     Core.<*> (o Core..:? "nextPageToken")
                     Core.<*> (o Core..:? "pageInfo")
                     Core.<*> (o Core..:? "prevPageToken")
...
newSearchResult 
    ::  SearchResult
newSearchResult
  = SearchResult{etag = Core.Nothing, id = Core.Nothing,
                 kind = "youtube#searchResult", snippet = Core.Nothing}
...
newSearchResultSnippet 
    ::  SearchResultSnippet
newSearchResultSnippet
  = SearchResultSnippet{channelId = Core.Nothing,
                        channelTitle = Core.Nothing, description = Core.Nothing,
                        liveBroadcastContent = Core.Nothing, publishedAt = Core.Nothing,
                        thumbnails = Core.Nothing, title = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("channelId" Core..=) Core.<$> channelId,
                  ("channelTitle" Core..=) Core.<$> channelTitle,
                  ("description" Core..=) Core.<$> description,
                  ("liveBroadcastContent" Core..=) Core.<$> liveBroadcastContent,
                  ("publishedAt" Core..=) Core.<$> publishedAt,
                  ("thumbnails" Core..=) Core.<$> thumbnails,
                  ("title" Core..=) Core.<$> title])
...
newSubscription 
    ::  Subscription
newSubscription
  = Subscription{contentDetails = Core.Nothing, etag = Core.Nothing,
                 id = Core.Nothing, kind = "youtube#subscription",
                 snippet = Core.Nothing, subscriberSnippet = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("contentDetails" Core..=) Core.<$> contentDetails,
                  ...
                  Core.Just ("kind" Core..= kind),
                  ("snippet" Core..=) Core.<$> snippet,
                  ("subscriberSnippet" Core..=) Core.<$> subscriberSnippet])
...
newSubscriptionContentDetails 
    ::  SubscriptionContentDetails
newSubscriptionContentDetails
  = SubscriptionContentDetails{activityType = Core.Nothing,
                               newItemCount' = Core.Nothing, totalItemCount = Core.Nothing}
          ...
          = Core.withObject "SubscriptionContentDetails"
              (\ o ->
                 SubscriptionContentDetails Core.<$>
                   (o Core..:? "activityType") Core.<*> (o Core..:? "newItemCount")
...
newSubscriptionListResponse 
    ::  SubscriptionListResponse
newSubscriptionListResponse
  = SubscriptionListResponse{etag = Core.Nothing,
                             eventId = Core.Nothing, items = Core.Nothing,
              ...
              (\ o ->
                 SubscriptionListResponse Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "eventId") Core.<*>
                     (o Core..:? "items")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "youtube#subscriptionListResponse")
                     Core.<*> (o Core..:? "nextPageToken")
                     Core.<*> (o Core..:? "pageInfo")
                     Core.<*> (o Core..:? "prevPageToken")
                     Core.<*> (o Core..:? "tokenPagination")
...
newSubscriptionSnippet 
    ::  SubscriptionSnippet
newSubscriptionSnippet
  = SubscriptionSnippet{channelId = Core.Nothing,
                        description = Core.Nothing, publishedAt = Core.Nothing,
                        resourceId = Core.Nothing, thumbnails = Core.Nothing,
                        title = Core.Nothing}
...
newSubscriptionSubscriberSnippet 
    ::  SubscriptionSubscriberSnippet
newSubscriptionSubscriberSnippet
  = SubscriptionSubscriberSnippet{channelId = Core.Nothing,
...
newSuperChatEvent 
    ::  SuperChatEvent
newSuperChatEvent
  = SuperChatEvent{etag = Core.Nothing, id = Core.Nothing,
                   kind = "youtube#superChatEvent", snippet = Core.Nothing}
...
newSuperChatEventListResponse 
    ::  SuperChatEventListResponse
newSuperChatEventListResponse
  = SuperChatEventListResponse{etag = Core.Nothing,
                               eventId = Core.Nothing, items = Core.Nothing,
              ...
              (\ o ->
                 SuperChatEventListResponse Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "eventId") Core.<*>
                     (o Core..:? "items")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "youtube#superChatEventListResponse")
                     Core.<*> (o Core..:? "nextPageToken")
                     Core.<*> (o Core..:? "pageInfo")
                     Core.<*> (o Core..:? "tokenPagination")
                     Core.<*> (o Core..:? "visitorId"))
...
newSuperChatEventSnippet 
    ::  SuperChatEventSnippet
newSuperChatEventSnippet
  = SuperChatEventSnippet{amountMicros = Core.Nothing,
                          channelId = Core.Nothing, commentText = Core.Nothing,
                          createdAt = Core.Nothing, currency = Core.Nothing,
                          displayString = Core.Nothing, isSuperStickerEvent = Core.Nothing,
                          messageType = Core.Nothing, superStickerMetadata = Core.Nothing,
          ...
          = Core.object
              (Core.catMaybes
                 [("amountMicros" Core..=) Core.. Core.AsText Core.<$> amountMicros,
                  ...
                  ("isSuperStickerEvent" Core..=) Core.<$> isSuperStickerEvent,
                  ("messageType" Core..=) Core.<$> messageType,
                  ("superStickerMetadata" Core..=) Core.<$> superStickerMetadata,
                  ("supporterDetails" Core..=) Core.<$> supporterDetails])
...
newSuperStickerMetadata 
    ::  SuperStickerMetadata
newSuperStickerMetadata
  = SuperStickerMetadata{altText = Core.Nothing,
                         altTextLanguage = Core.Nothing, stickerId = Core.Nothing}
instance Core.FromJSON SuperStickerMetadata where
        parseJSON
          = Core.withObject "SuperStickerMetadata"
              (\ o ->
                 SuperStickerMetadata Core.<$>
                   (o Core..:? "altText") Core.<*> (o Core..:? "altTextLanguage")
...
newTestItem 
    ::  TestItem
newTestItem
  = TestItem{etag = Core.Nothing, featuredPart = Core.Nothing,
             gaia = Core.Nothing, id = Core.Nothing, snippet = Core.Nothing}
instance Core.FromJSON TestItem where
        parseJSON
          = Core.withObject "TestItem"
              (\ o ->
                 TestItem Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "featuredPart") Core.<*>
                     (o Core..:? "gaia" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "id")
                     Core.<*> (o Core..:? "snippet"))
          ...
          = Core.object
              (Core.catMaybes
                 [("etag" Core..=) Core.<$> etag,
                  ...
                  ("id" Core..=) Core.<$> id, ("snippet" Core..=) Core.<$> snippet])
...
newThirdPartyLink 
    ::  ThirdPartyLink
newThirdPartyLink
  = ThirdPartyLink{etag = Core.Nothing,
                   kind = "youtube#thirdPartyLink", linkingToken = Core.Nothing,
                   snippet = Core.Nothing, status = Core.Nothing}
...
newThirdPartyLinkListResponse 
    ::  ThirdPartyLinkListResponse
newThirdPartyLinkListResponse
  = ThirdPartyLinkListResponse{etag = Core.Nothing,
                               items = Core.Nothing, kind = "youtube#thirdPartyLinkListResponse"}
              ...
              (\ o ->
                 ThirdPartyLinkListResponse Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "items") Core.<*>
                     (o Core..:? "kind" Core..!= "youtube#thirdPartyLinkListResponse"))
...
newThirdPartyLinkSnippet 
    ::  ThirdPartyLinkSnippet
newThirdPartyLinkSnippet
  = ThirdPartyLinkSnippet{channelToStoreLink = Core.Nothing,
                          type' = Core.Nothing}
          ...
          = Core.withObject "ThirdPartyLinkSnippet"
              (\ o ->
                 ThirdPartyLinkSnippet Core.<$>
                   (o Core..:? "channelToStoreLink") Core.<*> (o Core..:? "type"))

instance Core.ToJSON ThirdPartyLinkSnippet where
        toJSON ThirdPartyLinkSnippet{..}
          = Core.object
              (Core.catMaybes
                 [("channelToStoreLink" Core..=) Core.<$> channelToStoreLink,
                  ("type" Core..=) Core.<$> type'])
...
newThumbnail 
    ::  Thumbnail
newThumbnail
  = Thumbnail{height = Core.Nothing, url = Core.Nothing,
              width = Core.Nothing}
instance Core.FromJSON Thumbnail where
        parseJSON
          = Core.withObject "Thumbnail"
              (\ o ->
                 Thumbnail Core.<$>
                   (o Core..:? "height") Core.<*> (o Core..:? "url") Core.<*>
                     (o Core..:? "width"))
...
instance Core.ToJSON Thumbnail where
        toJSON Thumbnail{..}
          = Core.object
              (Core.catMaybes
                 [("height" Core..=) Core.<$> height, ("url" Core..=) Core.<$> url,
...
newThumbnailDetails 
    ::  ThumbnailDetails
newThumbnailDetails
  = ThumbnailDetails{default' = Core.Nothing, high = Core.Nothing,
                     maxres = Core.Nothing, medium = Core.Nothing,
          ...
          = Core.withObject "ThumbnailDetails"
              (\ o ->
                 ThumbnailDetails Core.<$>
                   (o Core..:? "default") Core.<*> (o Core..:? "high") Core.<*>
                     (o Core..:? "maxres")
                     Core.<*> (o Core..:? "medium")
...
instance Core.ToJSON ThumbnailDetails where
        toJSON ThumbnailDetails{..}
          = Core.object
              (Core.catMaybes
                 [("default" Core..=) Core.<$> default',
                  ("high" Core..=) Core.<$> high, ("maxres" Core..=) Core.<$> maxres,
...
newThumbnailSetResponse 
    ::  ThumbnailSetResponse
newThumbnailSetResponse
  = ThumbnailSetResponse{etag = Core.Nothing, eventId = Core.Nothing,
                         items = Core.Nothing, kind = "youtube#thumbnailSetResponse",
                         visitorId = Core.Nothing}
              ...
              (\ o ->
                 ThumbnailSetResponse Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "eventId") Core.<*>
                     (o Core..:? "items")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "youtube#thumbnailSetResponse")
                     Core.<*> (o Core..:? "visitorId"))
...
data Video = Video
    ...
    , paidProductPlacementDetails :: (Core.Maybe VideoPaidProductPlacementDetails)
...
newVideo 
    ::  Video
newVideo
  = Video{ageGating = Core.Nothing, contentDetails = Core.Nothing,
          etag = Core.Nothing, fileDetails = Core.Nothing, id = Core.Nothing,
          kind = "youtube#video", liveStreamingDetails = Core.Nothing,
          localizations = Core.Nothing, monetizationDetails = Core.Nothing,
          paidProductPlacementDetails = Core.Nothing, player = Core.Nothing,
          processingDetails = Core.Nothing, projectDetails = Core.Nothing,
          recordingDetails = Core.Nothing, snippet = Core.Nothing,
          statistics = Core.Nothing, status = Core.Nothing,
          suggestions = Core.Nothing, topicDetails = Core.Nothing}
instance Core.FromJSON Video where
        parseJSON
          = Core.withObject "Video"
              (\ o ->
                 Video Core.<$>
                   (o Core..:? "ageGating") Core.<*> (o Core..:? "contentDetails")
                     Core.<*> (o Core..:? "etag")
                     ...
                     Core.<*> (o Core..:? "localizations")
                     Core.<*> (o Core..:? "monetizationDetails")
                     Core.<*> (o Core..:? "paidProductPlacementDetails")
                     Core.<*> (o Core..:? "player")
          ...
          = Core.object
              (Core.catMaybes
                 [("ageGating" Core..=) Core.<$> ageGating,
                  ...
                  ("id" Core..=) Core.<$> id, Core.Just ("kind" Core..= kind),
                  ("liveStreamingDetails" Core..=) Core.<$> liveStreamingDetails,
                  ("localizations" Core..=) Core.<$> localizations,
                  ("monetizationDetails" Core..=) Core.<$> monetizationDetails,
                  ("paidProductPlacementDetails" Core..=) Core.<$>
                    paidProductPlacementDetails,
                  ("player" Core..=) Core.<$> player,
                  ("processingDetails" Core..=) Core.<$> processingDetails,
                  ("projectDetails" Core..=) Core.<$> projectDetails,
                  ("recordingDetails" Core..=) Core.<$> recordingDetails,
                  ("snippet" Core..=) Core.<$> snippet,
                  ("statistics" Core..=) Core.<$> statistics,
                  ("status" Core..=) Core.<$> status,
...
instance Core.FromJSON Video_Localizations where
        parseJSON
          = Core.withObject "Video_Localizations"
              (\ o -> Video_Localizations Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON Video_Localizations where
        toJSON Video_Localizations{..} = Core.toJSON additional
...
newVideoAbuseReport 
    ::  VideoAbuseReport
newVideoAbuseReport
  = VideoAbuseReport{comments = Core.Nothing,
                     language = Core.Nothing, reasonId = Core.Nothing,
                     secondaryReasonId = Core.Nothing, videoId = Core.Nothing}
instance Core.FromJSON VideoAbuseReport where
        parseJSON
          = Core.withObject "VideoAbuseReport"
              (\ o ->
                 VideoAbuseReport Core.<$>
                   (o Core..:? "comments") Core.<*> (o Core..:? "language") Core.<*>
                     (o Core..:? "reasonId")
          ...
          = Core.object
              (Core.catMaybes
                 [("comments" Core..=) Core.<$> comments,
                  ...
                  ("secondaryReasonId" Core..=) Core.<$> secondaryReasonId,
                  ("videoId" Core..=) Core.<$> videoId])
...
newVideoAbuseReportReason 
    ::  VideoAbuseReportReason
newVideoAbuseReportReason
  = VideoAbuseReportReason{etag = Core.Nothing, id = Core.Nothing,
                           kind = "youtube#videoAbuseReportReason", snippet = Core.Nothing}
          ...
          = Core.withObject "VideoAbuseReportReason"
              (\ o ->
                 VideoAbuseReportReason Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "id") Core.<*>
                     (o Core..:? "kind" Core..!= "youtube#videoAbuseReportReason")
                     Core.<*> (o Core..:? "snippet"))
...
newVideoAbuseReportReasonListResponse 
    :: 
                                      VideoAbuseReportReasonListResponse
newVideoAbuseReportReasonListResponse
  = VideoAbuseReportReasonListResponse{etag = Core.Nothing,
                                       eventId = Core.Nothing, items = Core.Nothing,
                                       kind = "youtube#videoAbuseReportReasonListResponse",
                                       visitorId = Core.Nothing}
instance Core.FromJSON VideoAbuseReportReasonListResponse where
        parseJSON
          = Core.withObject "VideoAbuseReportReasonListResponse"
              (\ o ->
...
instance Core.ToJSON VideoAbuseReportReasonListResponse where
...
newVideoAbuseReportReasonSnippet 
    ::  VideoAbuseReportReasonSnippet
newVideoAbuseReportReasonSnippet
  = VideoAbuseReportReasonSnippet{label = Core.Nothing,
          ...
          = Core.withObject "VideoAbuseReportReasonSnippet"
              (\ o ->
                 VideoAbuseReportReasonSnippet Core.<$>
                   (o Core..:? "label") Core.<*> (o Core..:? "secondaryReasons"))
          ...
          = Core.object
              (Core.catMaybes
                 [("label" Core..=) Core.<$> label,
                  ("secondaryReasons" Core..=) Core.<$> secondaryReasons])
...
newVideoAbuseReportSecondaryReason 
    :: 
                                   VideoAbuseReportSecondaryReason
newVideoAbuseReportSecondaryReason
  = VideoAbuseReportSecondaryReason{id = Core.Nothing,
                                    label = Core.Nothing}
instance Core.FromJSON VideoAbuseReportSecondaryReason where
        parseJSON
...
newVideoAgeGating 
    ::  VideoAgeGating
newVideoAgeGating
  = VideoAgeGating{alcoholContent = Core.Nothing,
                   restricted = Core.Nothing, videoGameRating = Core.Nothing}
instance Core.FromJSON VideoAgeGating where
        parseJSON
          = Core.withObject "VideoAgeGating"
              (\ o ->
                 VideoAgeGating Core.<$>
                   (o Core..:? "alcoholContent") Core.<*> (o Core..:? "restricted")
          ...
          = Core.object
              (Core.catMaybes
                 [("alcoholContent" Core..=) Core.<$> alcoholContent,
                  ...
                  ("videoGameRating" Core..=) Core.<$> videoGameRating])
...
newVideoCategory 
    ::  VideoCategory
newVideoCategory
  = VideoCategory{etag = Core.Nothing, id = Core.Nothing,
                  kind = "youtube#videoCategory", snippet = Core.Nothing}
...
newVideoCategoryListResponse 
    ::  VideoCategoryListResponse
newVideoCategoryListResponse
  = VideoCategoryListResponse{etag = Core.Nothing,
                              eventId = Core.Nothing, items = Core.Nothing,
              ...
              (\ o ->
                 VideoCategoryListResponse Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "eventId") Core.<*>
                     (o Core..:? "items")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "youtube#videoCategoryListResponse")
                     Core.<*> (o Core..:? "nextPageToken")
                     Core.<*> (o Core..:? "pageInfo")
                     Core.<*> (o Core..:? "prevPageToken")
                     Core.<*> (o Core..:? "tokenPagination")
...
newVideoCategorySnippet 
    ::  VideoCategorySnippet
newVideoCategorySnippet
  = VideoCategorySnippet{assignable = Core.Nothing,
                         channelId = "UCBR8-60-B28hp2BmDPdntcQ", title = Core.Nothing}
              ...
              (\ o ->
                 VideoCategorySnippet Core.<$>
                   (o Core..:? "assignable") Core.<*>
                     (o Core..:? "channelId" Core..!= "UCBR8-60-B28hp2BmDPdntcQ")
                     Core.<*> (o Core..:? "title"))
...
newVideoContentDetails 
    ::  VideoContentDetails
newVideoContentDetails
  = VideoContentDetails{caption = Core.Nothing,
                        contentRating = Core.Nothing, countryRestriction = Core.Nothing,
                        definition = Core.Nothing, dimension = Core.Nothing,
                        duration = Core.Nothing, hasCustomThumbnail = Core.Nothing,
                        licensedContent = Core.Nothing, projection = Core.Nothing,
          ...
          = Core.withObject "VideoContentDetails"
              (\ o ->
                 VideoContentDetails Core.<$>
                   (o Core..:? "caption") Core.<*> (o Core..:? "contentRating")
          ...
          = Core.object
              (Core.catMaybes
                 [("caption" Core..=) Core.<$> caption,
                  ...
                  ("countryRestriction" Core..=) Core.<$> countryRestriction,
                  ("definition" Core..=) Core.<$> definition,
                  ("dimension" Core..=) Core.<$> dimension,
                  ("duration" Core..=) Core.<$> duration,
                  ("hasCustomThumbnail" Core..=) Core.<$> hasCustomThumbnail,
                  ("licensedContent" Core..=) Core.<$> licensedContent,
                  ("projection" Core..=) Core.<$> projection,
                  ("regionRestriction" Core..=) Core.<$> regionRestriction])
...
newVideoContentDetailsRegionRestriction 
    :: 
                                        VideoContentDetailsRegionRestriction
newVideoContentDetailsRegionRestriction
  = VideoContentDetailsRegionRestriction{allowed = Core.Nothing,
                                         blocked = Core.Nothing}
instance Core.FromJSON VideoContentDetailsRegionRestriction where
        parseJSON
          = Core.withObject "VideoContentDetailsRegionRestriction"
              (\ o ->
                 VideoContentDetailsRegionRestriction Core.<$>
                   (o Core..:? "allowed") Core.<*> (o Core..:? "blocked"))

instance Core.ToJSON VideoContentDetailsRegionRestriction where
...
newVideoFileDetails 
    ::  VideoFileDetails
newVideoFileDetails
  = VideoFileDetails{audioStreams = Core.Nothing,
                     bitrateBps = Core.Nothing, container = Core.Nothing,
                     creationTime = Core.Nothing, durationMs = Core.Nothing,
                     fileName = Core.Nothing, fileSize = Core.Nothing,
                     fileType = Core.Nothing, videoStreams = Core.Nothing}
              ...
              (\ o ->
                 VideoFileDetails Core.<$>
                   (o Core..:? "audioStreams") Core.<*>
                     (o Core..:? "bitrateBps" Core.<&> Core.fmap Core.fromAsText)
          ...
          = Core.object
              (Core.catMaybes
                 [("audioStreams" Core..=) Core.<$> audioStreams,
                  ("bitrateBps" Core..=) Core.. Core.AsText Core.<$> bitrateBps,
...
newVideoFileDetailsAudioStream 
    ::  VideoFileDetailsAudioStream
newVideoFileDetailsAudioStream
  = VideoFileDetailsAudioStream{bitrateBps = Core.Nothing,
                                channelCount = Core.Nothing, codec = Core.Nothing,
                                vendor = Core.Nothing}
...
newVideoFileDetailsVideoStream 
    ::  VideoFileDetailsVideoStream
newVideoFileDetailsVideoStream
  = VideoFileDetailsVideoStream{aspectRatio = Core.Nothing,
                                bitrateBps = Core.Nothing, codec = Core.Nothing,
                                frameRateFps = Core.Nothing, heightPixels = Core.Nothing,
                                rotation = Core.Nothing, vendor = Core.Nothing,
...
newVideoGetRatingResponse 
    ::  VideoGetRatingResponse
newVideoGetRatingResponse
  = VideoGetRatingResponse{etag = Core.Nothing,
                           eventId = Core.Nothing, items = Core.Nothing,
                           kind = "youtube#videoGetRatingResponse", visitorId = Core.Nothing}
              ...
              (\ o ->
                 VideoGetRatingResponse Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "eventId") Core.<*>
                     (o Core..:? "items")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "youtube#videoGetRatingResponse")
                     Core.<*> (o Core..:? "visitorId"))
...
newVideoListResponse 
    ::  VideoListResponse
newVideoListResponse
  = VideoListResponse{etag = Core.Nothing, eventId = Core.Nothing,
                      items = Core.Nothing, kind = "youtube#videoListResponse",
                      nextPageToken = Core.Nothing, pageInfo = Core.Nothing,
                      prevPageToken = Core.Nothing, tokenPagination = Core.Nothing,
                      visitorId = Core.Nothing}
          ...
          = Core.withObject "VideoListResponse"
              (\ o ->
                 VideoListResponse Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "eventId") Core.<*>
                     (o Core..:? "items")
                     Core.<*> (o Core..:? "kind" Core..!= "youtube#videoListResponse")
                     Core.<*> (o Core..:? "nextPageToken")
                     Core.<*> (o Core..:? "pageInfo")
                     Core.<*> (o Core..:? "prevPageToken")
                     Core.<*> (o Core..:? "tokenPagination")
...
newVideoLiveStreamingDetails 
    ::  VideoLiveStreamingDetails
newVideoLiveStreamingDetails
  = VideoLiveStreamingDetails{activeLiveChatId = Core.Nothing,
                              actualEndTime = Core.Nothing, actualStartTime = Core.Nothing,
                              concurrentViewers = Core.Nothing, scheduledEndTime = Core.Nothing,
              ...
              (\ o ->
                 VideoLiveStreamingDetails Core.<$>
                   (o Core..:? "activeLiveChatId") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "concurrentViewers" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "scheduledEndTime")
                     Core.<*> (o Core..:? "scheduledStartTime"))
...
instance Core.ToJSON VideoLiveStreamingDetails where
        toJSON VideoLiveStreamingDetails{..}
          = Core.object
              (Core.catMaybes
                 [("activeLiveChatId" Core..=) Core.<$> activeLiveChatId,
                  ("actualEndTime" Core..=) Core.<$> actualEndTime,
                  ("actualStartTime" Core..=) Core.<$> actualStartTime,
                  ("concurrentViewers" Core..=) Core.. Core.AsText Core.<$>
                    concurrentViewers,
...
newVideoLocalization 
    ::  VideoLocalization
newVideoLocalization
  = VideoLocalization{description = Core.Nothing,
                      title = Core.Nothing}
...
--
-- /See:/ 'newVideoPaidProductPlacementDetails' smart constructor.
newtype VideoPaidProductPlacementDetails = VideoPaidProductPlacementDetails
    {
      ...
      hasPaidProductPlacement :: (Core.Maybe Core.Bool)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newVideoPaidProductPlacementDetails 
    :: 
                                    VideoPaidProductPlacementDetails
newVideoPaidProductPlacementDetails
  = VideoPaidProductPlacementDetails{hasPaidProductPlacement =
                                       Core.Nothing}
instance Core.FromJSON VideoPaidProductPlacementDetails where
        parseJSON
          = Core.withObject "VideoPaidProductPlacementDetails"
              (\ o ->
                 VideoPaidProductPlacementDetails Core.<$>
                   (o Core..:? "hasPaidProductPlacement"))

instance Core.ToJSON VideoPaidProductPlacementDetails where
        toJSON VideoPaidProductPlacementDetails{..}
          = Core.object
              (Core.catMaybes
                 [("hasPaidProductPlacement" Core..=) Core.<$>
...
newVideoPlayer 
    ::  VideoPlayer
newVideoPlayer
  = VideoPlayer{embedHeight = Core.Nothing, embedHtml = Core.Nothing,
...
instance Core.FromJSON VideoPlayer where
        parseJSON
          = Core.withObject "VideoPlayer"
              (\ o ->
                 VideoPlayer Core.<$>
                   (o Core..:? "embedHeight" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "embedHtml")
                     Core.<*>
                     (o Core..:? "embedWidth" Core.<&> Core.fmap Core.fromAsText))

instance Core.ToJSON VideoPlayer where
        toJSON VideoPlayer{..}
          = Core.object
              (Core.catMaybes
                 [("embedHeight" Core..=) Core.. Core.AsText Core.<$> embedHeight,
                  ("embedHtml" Core..=) Core.<$> embedHtml,
                  ("embedWidth" Core..=) Core.. Core.AsText Core.<$> embedWidth])
...
newVideoProcessingDetails 
    ::  VideoProcessingDetails
newVideoProcessingDetails
  = VideoProcessingDetails{editorSuggestionsAvailability =
                             Core.Nothing,
                           fileDetailsAvailability = Core.Nothing,
                           processingFailureReason = Core.Nothing,
                           processingIssuesAvailability = Core.Nothing,
                           processingProgress = Core.Nothing, processingStatus = Core.Nothing,
          ...
          = Core.object
              (Core.catMaybes
                 [("editorSuggestionsAvailability" Core..=) Core.<$>
                  ...
                  ("processingProgress" Core..=) Core.<$> processingProgress,
...
newVideoProcessingDetailsProcessingProgress 
    :: 
                                            VideoProcessingDetailsProcessingProgress
newVideoProcessingDetailsProcessingProgress
  = VideoProcessingDetailsProcessingProgress{partsProcessed =
                                               Core.Nothing,
                                             partsTotal = Core.Nothing, timeLeftMs = Core.Nothing}
instance Core.FromJSON VideoProcessingDetailsProcessingProgress
         where
        parseJSON
          = Core.withObject "VideoProcessingDetailsProcessingProgress"
              (\ o ->
                 VideoProcessingDetailsProcessingProgress Core.<$>
                   (o Core..:? "partsProcessed" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "partsTotal" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "timeLeftMs" Core.<&> Core.fmap Core.fromAsText))

instance Core.ToJSON VideoProcessingDetailsProcessingProgress where
        toJSON VideoProcessingDetailsProcessingProgress{..}
          = Core.object
              (Core.catMaybes
                 [("partsProcessed" Core..=) Core.. Core.AsText Core.<$>
                    partsProcessed,
                  ("partsTotal" Core..=) Core.. Core.AsText Core.<$> partsTotal,
                  ("timeLeftMs" Core..=) Core.. Core.AsText Core.<$> timeLeftMs])
...
newVideoRating 
    ::  VideoRating
newVideoRating
  = VideoRating{rating = Core.Nothing, videoId = Core.Nothing}
instance Core.FromJSON VideoRating where
        parseJSON
          = Core.withObject "VideoRating"
              (\ o ->
                 VideoRating Core.<$>
                   (o Core..:? "rating") Core.<*> (o Core..:? "videoId"))
...
newVideoRecordingDetails 
    ::  VideoRecordingDetails
newVideoRecordingDetails
  = VideoRecordingDetails{location = Core.Nothing,
                          locationDescription = Core.Nothing, recordingDate = Core.Nothing}
instance Core.FromJSON VideoRecordingDetails where
        parseJSON
          = Core.withObject "VideoRecordingDetails"
              (\ o ->
                 VideoRecordingDetails Core.<$>
                   (o Core..:? "location") Core.<*> (o Core..:? "locationDescription")
          ...
          = Core.object
              (Core.catMaybes
                 [("location" Core..=) Core.<$> location,
                  ("locationDescription" Core..=) Core.<$> locationDescription,
...
newVideoSnippet 
    ::  VideoSnippet
newVideoSnippet
  = VideoSnippet{categoryId = Core.Nothing, channelId = Core.Nothing,
                 channelTitle = Core.Nothing, defaultAudioLanguage = Core.Nothing,
                 defaultLanguage = Core.Nothing, description = Core.Nothing,
                 liveBroadcastContent = Core.Nothing, localized = Core.Nothing,
                 publishedAt = Core.Nothing, tags = Core.Nothing,
                 thumbnails = Core.Nothing, title = Core.Nothing}
instance Core.FromJSON VideoSnippet where
        parseJSON
          = Core.withObject "VideoSnippet"
              (\ o ->
                 VideoSnippet Core.<$>
                   (o Core..:? "categoryId") Core.<*> (o Core..:? "channelId")
          ...
          = Core.object
              (Core.catMaybes
                 [("categoryId" Core..=) Core.<$> categoryId,
                  ("channelId" Core..=) Core.<$> channelId,
                  ("channelTitle" Core..=) Core.<$> channelTitle,
                  ("defaultAudioLanguage" Core..=) Core.<$> defaultAudioLanguage,
                  ("defaultLanguage" Core..=) Core.<$> defaultLanguage,
                  ("description" Core..=) Core.<$> description,
                  ("liveBroadcastContent" Core..=) Core.<$> liveBroadcastContent,
                  ("localized" Core..=) Core.<$> localized,
...
newVideoStatistics 
    ::  VideoStatistics
newVideoStatistics
  = VideoStatistics{commentCount = Core.Nothing,
                    dislikeCount = Core.Nothing, favoriteCount = Core.Nothing,
                    likeCount = Core.Nothing, viewCount = Core.Nothing}
          ...
          = Core.withObject "VideoStatistics"
              (\ o ->
                 VideoStatistics Core.<$>
                   (o Core..:? "commentCount" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "dislikeCount" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "favoriteCount" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "likeCount" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "viewCount" Core.<&> Core.fmap Core.fromAsText))
...
instance Core.ToJSON VideoStatistics where
        toJSON VideoStatistics{..}
          = Core.object
              (Core.catMaybes
                 [("commentCount" Core..=) Core.. Core.AsText Core.<$> commentCount,
                  ("dislikeCount" Core..=) Core.. Core.AsText Core.<$> dislikeCount,
                  ("favoriteCount" Core..=) Core.. Core.AsText Core.<$>
                    favoriteCount,
                  ("likeCount" Core..=) Core.. Core.AsText Core.<$> likeCount,
                  ("viewCount" Core..=) Core.. Core.AsText Core.<$> viewCount])
...
data VideoStatus = VideoStatus
    {
      ...
      containsSyntheticMedia :: (Core.Maybe Core.Bool)
...
newVideoStatus 
    ::  VideoStatus
newVideoStatus
  = VideoStatus{containsSyntheticMedia = Core.Nothing,
                embeddable = Core.Nothing, failureReason = Core.Nothing,
                license = Core.Nothing, madeForKids = Core.Nothing,
                privacyStatus = Core.Nothing, publicStatsViewable = Core.Nothing,
                publishAt = Core.Nothing, rejectionReason = Core.Nothing,
                selfDeclaredMadeForKids = Core.Nothing,
...
instance Core.FromJSON VideoStatus where
        parseJSON
          = Core.withObject "VideoStatus"
              (\ o ->
                 VideoStatus Core.<$>
                   (o Core..:? "containsSyntheticMedia") Core.<*>
                     (o Core..:? "embeddable")
...
instance Core.ToJSON VideoStatus where
        toJSON VideoStatus{..}
          = Core.object
              (Core.catMaybes
                 [("containsSyntheticMedia" Core..=) Core.<$>
                  ...
                  ("madeForKids" Core..=) Core.<$> madeForKids,
                  ("privacyStatus" Core..=) Core.<$> privacyStatus,
                  ("publicStatsViewable" Core..=) Core.<$> publicStatsViewable,
...
newVideoSuggestions 
    ::  VideoSuggestions
newVideoSuggestions
  = VideoSuggestions{editorSuggestions = Core.Nothing,
                     processingErrors = Core.Nothing, processingHints = Core.Nothing,
                     processingWarnings = Core.Nothing, tagSuggestions = Core.Nothing}
...
instance Core.ToJSON VideoSuggestions where
        toJSON VideoSuggestions{..}
          = Core.object
              (Core.catMaybes
                 [("editorSuggestions" Core..=) Core.<$> editorSuggestions,
                  ("processingErrors" Core..=) Core.<$> processingErrors,
                  ("processingHints" Core..=) Core.<$> processingHints,
                  ("processingWarnings" Core..=) Core.<$> processingWarnings,
...
newVideoSuggestionsTagSuggestion 
    ::  VideoSuggestionsTagSuggestion
newVideoSuggestionsTagSuggestion
  = VideoSuggestionsTagSuggestion{categoryRestricts = Core.Nothing,
                                  tag = Core.Nothing}
...
newVideoTopicDetails 
    ::  VideoTopicDetails
newVideoTopicDetails
  = VideoTopicDetails{relevantTopicIds = Core.Nothing,
                      topicCategories = Core.Nothing, topicIds = Core.Nothing}
...
newVideoTrainability 
    ::  VideoTrainability
newVideoTrainability
  = VideoTrainability{etag = Core.Nothing,
                      kind = "youtube#videoTrainability", permitted = Core.Nothing,
                      videoId = Core.Nothing}
instance Core.FromJSON VideoTrainability where
        parseJSON
          = Core.withObject "VideoTrainability"
              (\ o ->
                 VideoTrainability Core.<$>
                   (o Core..:? "etag") Core.<*>
                     (o Core..:? "kind" Core..!= "youtube#videoTrainability")
...
newWatchSettings 
    ::  WatchSettings
newWatchSettings
  = WatchSettings{backgroundColor = Core.Nothing,
                  featuredPlaylistId = Core.Nothing, textColor = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("backgroundColor" Core..=) Core.<$> backgroundColor,
                  ("featuredPlaylistId" Core..=) Core.<$> featuredPlaylistId,
