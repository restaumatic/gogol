...
-- |
-- Module      : Gogol.YouTube.LiveStreams.Delete
...
newYouTubeLiveStreamsDelete id
  = YouTubeLiveStreamsDelete{xgafv = Core.Nothing,
...
instance Core.GoogleRequest YouTubeLiveStreamsDelete where
        ...
        type Scopes YouTubeLiveStreamsDelete =
        ...
        requestClient YouTubeLiveStreamsDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy YouTubeLiveStreamsDeleteResource)
                      Core.mempty
