...
instance Core.GoogleRequest YouTubeLiveStreamsUpdate where
        ...
        requestClient YouTubeLiveStreamsUpdate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy YouTubeLiveStreamsUpdateResource)
                      Core.mempty
