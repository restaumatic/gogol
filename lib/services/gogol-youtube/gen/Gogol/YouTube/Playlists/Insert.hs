                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] Playlist Core.:>
                               Core.Post '[Core.JSON] Playlist
...
newYouTubePlaylistsInsert part payload
  = YouTubePlaylistsInsert{xgafv = Core.Nothing,
...
instance Core.GoogleRequest YouTubePlaylistsInsert where
        ...
        type Scopes YouTubePlaylistsInsert =
        ...
        requestClient YouTubePlaylistsInsert{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy YouTubePlaylistsInsertResource)
                      Core.mempty
