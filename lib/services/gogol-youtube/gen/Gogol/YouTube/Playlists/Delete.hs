...
-- |
-- Module      : Gogol.YouTube.Playlists.Delete
...
newYouTubePlaylistsDelete id
  = YouTubePlaylistsDelete{xgafv = Core.Nothing,
...
instance Core.GoogleRequest YouTubePlaylistsDelete where
        ...
        type Scopes YouTubePlaylistsDelete =
        ...
        requestClient YouTubePlaylistsDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy YouTubePlaylistsDeleteResource)
                      Core.mempty
