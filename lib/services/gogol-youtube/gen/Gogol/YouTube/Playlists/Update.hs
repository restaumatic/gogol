...
newYouTubePlaylistsUpdate part payload
  = YouTubePlaylistsUpdate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest YouTubePlaylistsUpdate where
        ...
        type Scopes YouTubePlaylistsUpdate =
        ...
        requestClient YouTubePlaylistsUpdate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy YouTubePlaylistsUpdateResource)
                      Core.mempty
