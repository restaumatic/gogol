                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] AbuseReport Core.:>
                           Core.Post '[Core.JSON] AbuseReport
...
newYouTubeAbuseReportsInsert part payload
  = YouTubeAbuseReportsInsert{xgafv = Core.Nothing,
...
instance Core.GoogleRequest YouTubeAbuseReportsInsert where
        ...
        type Scopes YouTubeAbuseReportsInsert =
