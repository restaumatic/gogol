...
instance Core.GoogleRequest YouTubeChannelSectionsDelete where
        ...
        requestClient YouTubeChannelSectionsDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy YouTubeChannelSectionsDeleteResource)
                      Core.mempty
