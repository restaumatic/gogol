                       ...
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] ChannelSection Core.:>
                             Core.Put '[Core.JSON] ChannelSection
...
newYouTubeChannelSectionsUpdate part payload
  = YouTubeChannelSectionsUpdate{xgafv = Core.Nothing,
                                 accessToken = Core.Nothing, callback = Core.Nothing,
                                 onBehalfOfContentOwner = Core.Nothing, part = part,
                                 payload = payload, uploadType = Core.Nothing,
                                 uploadProtocol = Core.Nothing}
instance Core.GoogleRequest YouTubeChannelSectionsUpdate where
        type Rs YouTubeChannelSectionsUpdate = ChannelSection
        type Scopes YouTubeChannelSectionsUpdate =
        ...
        requestClient YouTubeChannelSectionsUpdate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy YouTubeChannelSectionsUpdateResource)
                      Core.mempty
