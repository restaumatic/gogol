...
-- |
-- Module      : Gogol.YouTube.ChannelSections.Insert
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] ChannelSection Core.:>
                               Core.Post '[Core.JSON] ChannelSection
...
instance Core.GoogleRequest YouTubeChannelSectionsInsert where
        ...
        requestClient YouTubeChannelSectionsInsert{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy YouTubeChannelSectionsInsertResource)
                      Core.mempty
