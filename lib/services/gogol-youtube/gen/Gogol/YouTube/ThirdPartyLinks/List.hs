               ...
               Core.QueryParam "access_token" Core.Text Core.:>
                 Core.QueryParam "callback" Core.Text Core.:>
                   Core.QueryParam "externalChannelId" Core.Text Core.:>
                     Core.QueryParam "linkingToken" Core.Text Core.:>
                       Core.QueryParam "type" ThirdPartyLinksListType Core.:>
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Get '[Core.JSON] ThirdPartyLinkListResponse
...
newYouTubeThirdPartyLinksList part
  = YouTubeThirdPartyLinksList{xgafv = Core.Nothing,
                               accessToken = Core.Nothing, callback = Core.Nothing,
                               externalChannelId = Core.Nothing, linkingToken = Core.Nothing,
                               part = part, type' = Core.Nothing, uploadType = Core.Nothing,
                               uploadProtocol = Core.Nothing}
instance Core.GoogleRequest YouTubeThirdPartyLinksList where
        type Rs YouTubeThirdPartyLinksList = ThirdPartyLinkListResponse
        type Scopes YouTubeThirdPartyLinksList = '[]
        requestClient YouTubeThirdPartyLinksList{..}
          = go part xgafv accessToken callback externalChannelId linkingToken
              type'
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy YouTubeThirdPartyLinksListResource)
                      Core.mempty
