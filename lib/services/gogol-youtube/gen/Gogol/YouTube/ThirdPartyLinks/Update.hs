...
newYouTubeThirdPartyLinksUpdate part payload
  = YouTubeThirdPartyLinksUpdate{xgafv = Core.Nothing,
                                 accessToken = Core.Nothing, callback = Core.Nothing,
                                 externalChannelId = Core.Nothing, part = part, payload = payload,
                                 uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest YouTubeThirdPartyLinksUpdate where
        ...
        requestClient YouTubeThirdPartyLinksUpdate{..}
          = go part xgafv accessToken callback externalChannelId uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy YouTubeThirdPartyLinksUpdateResource)
                      Core.mempty
