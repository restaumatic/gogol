...
instance Core.GoogleRequest YouTubeThirdPartyLinksInsert where
        ...
        requestClient YouTubeThirdPartyLinksInsert{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy YouTubeThirdPartyLinksInsertResource)
                      Core.mempty
