                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Get '[Core.JSON] SuperChatEventListResponse
...
newYouTubeSuperChatEventsList part
  = YouTubeSuperChatEventsList{xgafv = Core.Nothing,
                               accessToken = Core.Nothing, callback = Core.Nothing,
                               hl = Core.Nothing, maxResults = 5, pageToken = Core.Nothing,
...
instance Core.GoogleRequest YouTubeSuperChatEventsList where
        ...
        type Scopes YouTubeSuperChatEventsList =
             '[Youtube'FullControl, Youtube'ForceSsl, Youtube'Readonly]
        requestClient YouTubeSuperChatEventsList{..}
          = go part xgafv accessToken callback hl (Core.Just maxResults)
              pageToken
              uploadType
              uploadProtocol
