                     ...
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] CommentThread Core.:>
                           Core.Put '[Core.JSON] CommentThread
...
newYouTubeYoutubeV3UpdateCommentThreads payload
  = YouTubeYoutubeV3UpdateCommentThreads{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         part = Core.Nothing, payload = payload,
                                         uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest YouTubeYoutubeV3UpdateCommentThreads
         where
        ...
        requestClient YouTubeYoutubeV3UpdateCommentThreads{..}
          = go xgafv accessToken callback (part Core.^. Core._Default)
              uploadType
              uploadProtocol
