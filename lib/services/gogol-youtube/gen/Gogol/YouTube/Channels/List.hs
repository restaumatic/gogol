               ...
               Core.QueryParam "access_token" Core.Text Core.:>
                 Core.QueryParam "callback" Core.Text Core.:>
                   Core.QueryParam "categoryId" Core.Text Core.:>
                     Core.QueryParam "forHandle" Core.Text Core.:>
                                         ...
                                         Core.QueryParam "uploadType" Core.Text Core.:>
                                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                                             Core.QueryParam "alt" Core.AltJSON Core.:>
                                               Core.Get '[Core.JSON] ChannelListResponse
...
data YouTubeChannelsList = YouTubeChannelsList
    ...
    , forHandle :: (Core.Maybe Core.Text)
...
newYouTubeChannelsList part
  = YouTubeChannelsList{xgafv = Core.Nothing,
                        accessToken = Core.Nothing, callback = Core.Nothing,
                        categoryId = Core.Nothing, forHandle = Core.Nothing,
                        forUsername = Core.Nothing, hl = Core.Nothing, id = Core.Nothing,
                        managedByMe = Core.Nothing, maxResults = 5, mine = Core.Nothing,
...
instance Core.GoogleRequest YouTubeChannelsList where
        ...
        type Scopes YouTubeChannelsList =
             '[Youtube'FullControl, Youtube'ForceSsl, Youtube'Readonly,
               Youtubepartner'FullControl, YoutubepartnerChannelAudit'FullControl]
        requestClient YouTubeChannelsList{..}
          = go part xgafv accessToken callback categoryId forHandle
              forUsername
              hl
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy YouTubeChannelsListResource)
                      Core.mempty
