...
-- |
-- Module      : Gogol.YouTube.Thumbnails.Set
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Post '[Core.JSON] ThumbnailSetResponse
       Core.:<|>
       "upload" Core.:>
         "youtube" Core.:>
           "v3" Core.:>
                             ...
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.QueryParam "uploadType" Core.AltMedia Core.:>
                                   Core.AltMedia Core.:> Core.Post '[Core.JSON] ThumbnailSetResponse
...
newYouTubeThumbnailsSet videoId
  = YouTubeThumbnailsSet{xgafv = Core.Nothing,
                         accessToken = Core.Nothing, callback = Core.Nothing,
                         onBehalfOfContentOwner = Core.Nothing, uploadType = Core.Nothing,
                         uploadProtocol = Core.Nothing, videoId = videoId}
instance Core.GoogleRequest YouTubeThumbnailsSet where
        type Rs YouTubeThumbnailsSet = ThumbnailSetResponse
        type Scopes YouTubeThumbnailsSet =
             '[Youtube'FullControl, Youtube'ForceSsl, Youtube'Upload,
               Youtubepartner'FullControl]
        requestClient YouTubeThumbnailsSet{..}
          = go (Core.Just videoId) xgafv accessToken callback
          ...
          where go Core.:<|> _
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy YouTubeThumbnailsSetResource)
                      Core.mempty

instance Core.GoogleRequest (Core.MediaUpload YouTubeThumbnailsSet)
         where
        type Rs (Core.MediaUpload YouTubeThumbnailsSet) =
             ThumbnailSetResponse
        type Scopes (Core.MediaUpload YouTubeThumbnailsSet) =
             Core.Scopes YouTubeThumbnailsSet
        requestClient (Core.MediaUpload YouTubeThumbnailsSet{..} body)
          = go (Core.Just videoId) xgafv accessToken callback
              onBehalfOfContentOwner
              uploadType
              uploadProtocol
