                       ...
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] PlaylistImage Core.:>
                             Core.Put '[Core.JSON] PlaylistImage
       Core.:<|>
       "upload" Core.:>
         "youtube" Core.:>
           "v3" Core.:>
...
newYouTubePlaylistImagesUpdate payload
  = YouTubePlaylistImagesUpdate{xgafv = Core.Nothing,
                                accessToken = Core.Nothing, callback = Core.Nothing,
                                onBehalfOfContentOwner = Core.Nothing, part = Core.Nothing,
...
instance Core.GoogleRequest YouTubePlaylistImagesUpdate where
        ...
        type Scopes YouTubePlaylistImagesUpdate =
...
instance Core.GoogleRequest
         ...
         where
        type Rs (Core.MediaUpload YouTubePlaylistImagesUpdate) =
             PlaylistImage
        type Scopes (Core.MediaUpload YouTubePlaylistImagesUpdate) =
