                             ...
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.Get '[Core.JSON] PlaylistImageListResponse
...
newYouTubePlaylistImagesList 
    ::  YouTubePlaylistImagesList
newYouTubePlaylistImagesList
  = YouTubePlaylistImagesList{xgafv = Core.Nothing,
                              accessToken = Core.Nothing, callback = Core.Nothing,
                              maxResults = 5, onBehalfOfContentOwner = Core.Nothing,
                              onBehalfOfContentOwnerChannel = Core.Nothing,
                              pageToken = Core.Nothing, parent = Core.Nothing,
                              part = Core.Nothing, uploadType = Core.Nothing,
