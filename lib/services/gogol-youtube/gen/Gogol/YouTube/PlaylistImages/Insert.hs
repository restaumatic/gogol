                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] PlaylistImage Core.:>
                               Core.Post '[Core.JSON] PlaylistImage
       Core.:<|>
       "upload" Core.:>
         "youtube" Core.:>
           "v3" Core.:>
                             ...
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.QueryParam "uploadType" Core.Multipart Core.:>
                                   Core.MultipartRelated '[Core.JSON] PlaylistImage Core.:>
                                     Core.Post '[Core.JSON] PlaylistImage
...
newYouTubePlaylistImagesInsert payload
  = YouTubePlaylistImagesInsert{xgafv = Core.Nothing,
                                accessToken = Core.Nothing, callback = Core.Nothing,
                                onBehalfOfContentOwner = Core.Nothing,
                                onBehalfOfContentOwnerChannel = Core.Nothing, part = Core.Nothing,
...
instance Core.GoogleRequest YouTubePlaylistImagesInsert where
        ...
        type Scopes YouTubePlaylistImagesInsert =
             '[Youtube'FullControl, Youtube'ForceSsl,
               Youtubepartner'FullControl]
        requestClient YouTubePlaylistImagesInsert{..}
          = go xgafv accessToken callback onBehalfOfContentOwner
...
instance Core.GoogleRequest
         ...
         where
        type Rs (Core.MediaUpload YouTubePlaylistImagesInsert) =
             PlaylistImage
        type Scopes (Core.MediaUpload YouTubePlaylistImagesInsert) =
