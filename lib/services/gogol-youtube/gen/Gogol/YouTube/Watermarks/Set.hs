                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] InvideoBranding Core.:>
                               Core.Post '[Core.JSON] ()
       Core.:<|>
       "upload" Core.:>
         "youtube" Core.:>
                             ...
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.QueryParam "uploadType" Core.Multipart Core.:>
                                   Core.MultipartRelated '[Core.JSON] InvideoBranding Core.:>
                                     Core.Post '[Core.JSON] ()
...
newYouTubeWatermarksSet channelId payload
  = YouTubeWatermarksSet{xgafv = Core.Nothing,
                         accessToken = Core.Nothing, callback = Core.Nothing,
                         channelId = channelId, onBehalfOfContentOwner = Core.Nothing,
...
instance Core.GoogleRequest YouTubeWatermarksSet where
        ...
        requestClient YouTubeWatermarksSet{..}
          ...
          where go Core.:<|> _
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy YouTubeWatermarksSetResource)
                      Core.mempty

instance Core.GoogleRequest (Core.MediaUpload YouTubeWatermarksSet)
         where
        type Rs (Core.MediaUpload YouTubeWatermarksSet) = ()
        type Scopes (Core.MediaUpload YouTubeWatermarksSet) =
             Core.Scopes YouTubeWatermarksSet
        requestClient (Core.MediaUpload YouTubeWatermarksSet{..} body)
          = go (Core.Just channelId) xgafv accessToken callback
              onBehalfOfContentOwner
              uploadType
              uploadProtocol
