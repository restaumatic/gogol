         ...
         "videos" Core.:>
           "rate" Core.:>
             Core.QueryParam "id" Core.Text Core.:>
               Core.QueryParam "rating" VideosRateRating Core.:>
