                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] VideoGetRatingResponse
...
newYouTubeVideosGetRating id
  = YouTubeVideosGetRating{xgafv = Core.Nothing,
...
instance Core.GoogleRequest YouTubeVideosGetRating where
        type Rs YouTubeVideosGetRating = VideoGetRatingResponse
        type Scopes YouTubeVideosGetRating =
             '[Youtube'FullControl, Youtube'ForceSsl,
               Youtubepartner'FullControl]
        requestClient YouTubeVideosGetRating{..}
          = go id xgafv accessToken callback onBehalfOfContentOwner
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy YouTubeVideosGetRatingResource)
                      Core.mempty
