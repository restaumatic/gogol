...
newYouTubeVideosList part
  = YouTubeVideosList{xgafv = Core.Nothing,
                      accessToken = Core.Nothing, callback = Core.Nothing,
                      chart = Core.Nothing, hl = Core.Nothing, id = Core.Nothing,
                      locale = Core.Nothing, maxHeight = Core.Nothing, maxResults = 5,
                      maxWidth = Core.Nothing, myRating = Core.Nothing,
                      onBehalfOfContentOwner = Core.Nothing, pageToken = Core.Nothing,
                      part = part, regionCode = Core.Nothing, uploadType = Core.Nothing,
                      uploadProtocol = Core.Nothing, videoCategoryId = "0"}
instance Core.GoogleRequest YouTubeVideosList where
        type Rs YouTubeVideosList = VideoListResponse
        type Scopes YouTubeVideosList =
             '[Youtube'FullControl, Youtube'ForceSsl, Youtube'Readonly,
               Youtubepartner'FullControl]
        requestClient YouTubeVideosList{..}
          = go part xgafv accessToken callback chart hl
