                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] VideoAbuseReport Core.:>
                             Core.Post '[Core.JSON] ()
...
newYouTubeVideosReportAbuse payload
  = YouTubeVideosReportAbuse{xgafv = Core.Nothing,
...
instance Core.GoogleRequest YouTubeVideosReportAbuse where
        ...
        type Scopes YouTubeVideosReportAbuse =
        ...
        requestClient YouTubeVideosReportAbuse{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy YouTubeVideosReportAbuseResource)
                      Core.mempty
