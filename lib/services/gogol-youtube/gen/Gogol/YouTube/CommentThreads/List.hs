           ...
           Core.QueryParams "part" Core.Text Core.:>
             Core.QueryParam "$.xgafv" Xgafv Core.:>
               Core.QueryParam "access_token" Core.Text Core.:>
                 Core.QueryParam "allThreadsRelatedToChannelId" Core.Text Core.:>
                       ...
                       Core.QueryParams "id" Core.Text Core.:>
                         Core.QueryParam "maxResults" Core.Word32 Core.:>
                           Core.QueryParam "moderationStatus"
                             ...
                             Core.:>
                             Core.QueryParam "order" CommentThreadsListOrder Core.:>
                               Core.QueryParam "pageToken" Core.Text Core.:>
                                 Core.QueryParam "postId" Core.Text Core.:>
                                   Core.QueryParam "searchTerms" Core.Text Core.:>
                                     Core.QueryParam "textFormat" CommentThreadsListTextFormat
                                       Core.:>
                                       Core.QueryParam "uploadType" Core.Text Core.:>
                                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                                           Core.QueryParam "videoId" Core.Text Core.:>
                                             Core.QueryParam "alt" Core.AltJSON Core.:>
                                               Core.Get '[Core.JSON] CommentThreadListResponse
...
newYouTubeCommentThreadsList part
  = YouTubeCommentThreadsList{xgafv = Core.Nothing,
                              accessToken = Core.Nothing,
                              allThreadsRelatedToChannelId = Core.Nothing,
                              callback = Core.Nothing, channelId = Core.Nothing,
                              id = Core.Nothing, maxResults = 20,
                              moderationStatus = CommentThreadsListModerationStatus_Published,
                              order = CommentThreadsListOrder_Time, pageToken = Core.Nothing,
                              part = part, postId = Core.Nothing, searchTerms = Core.Nothing,
...
instance Core.GoogleRequest YouTubeCommentThreadsList where
        ...
        requestClient YouTubeCommentThreadsList{..}
          = go part xgafv accessToken allThreadsRelatedToChannelId callback
              channelId
