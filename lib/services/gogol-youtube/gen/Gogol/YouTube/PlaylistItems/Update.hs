                       ...
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] PlaylistItem Core.:>
                             Core.Put '[Core.JSON] PlaylistItem
...
instance Core.GoogleRequest YouTubePlaylistItemsUpdate where
        ...
        requestClient YouTubePlaylistItemsUpdate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy YouTubePlaylistItemsUpdateResource)
                      Core.mempty
