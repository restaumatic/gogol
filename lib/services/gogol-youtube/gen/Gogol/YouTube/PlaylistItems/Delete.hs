...
instance Core.GoogleRequest YouTubePlaylistItemsDelete where
        ...
        requestClient YouTubePlaylistItemsDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy YouTubePlaylistItemsDeleteResource)
                      Core.mempty
