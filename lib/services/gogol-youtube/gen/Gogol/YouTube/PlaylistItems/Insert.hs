                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] PlaylistItem Core.:>
                             Core.Post '[Core.JSON] PlaylistItem
...
instance Core.GoogleRequest YouTubePlaylistItemsInsert where
        ...
        requestClient YouTubePlaylistItemsInsert{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy YouTubePlaylistItemsInsertResource)
                      Core.mempty
