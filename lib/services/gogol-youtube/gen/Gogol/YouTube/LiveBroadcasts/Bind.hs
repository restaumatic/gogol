                     ...
                     Core.QueryParam "callback" Core.Text Core.:>
                       Core.QueryParam "onBehalfOfContentOwner" Core.Text Core.:>
                         Core.QueryParam "onBehalfOfContentOwnerChannel" Core.Text Core.:>
                           Core.QueryParam "streamId" Core.Text Core.:>
...
instance Core.GoogleRequest YouTubeLiveBroadcastsBind where
        ...
        requestClient YouTubeLiveBroadcastsBind{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy YouTubeLiveBroadcastsBindResource)
                      Core.mempty
