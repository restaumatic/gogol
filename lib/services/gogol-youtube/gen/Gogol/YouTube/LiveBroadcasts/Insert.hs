                         ...
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] LiveBroadcast Core.:>
                               Core.Post '[Core.JSON] LiveBroadcast
...
instance Core.GoogleRequest YouTubeLiveBroadcastsInsert where
        ...
        requestClient YouTubeLiveBroadcastsInsert{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy YouTubeLiveBroadcastsInsertResource)
                      Core.mempty
