...
type YouTubeLiveBroadcastsTransitionResource =
     "youtube" Core.:>
       "v3" Core.:>
         "liveBroadcasts" Core.:>
           "transition" Core.:>
             Core.QueryParam "broadcastStatus"
...
newYouTubeLiveBroadcastsTransition broadcastStatus id part
  = YouTubeLiveBroadcastsTransition{xgafv = Core.Nothing,
                                    accessToken = Core.Nothing, broadcastStatus = broadcastStatus,
...
instance Core.GoogleRequest YouTubeLiveBroadcastsTransition where
        ...
        type Scopes YouTubeLiveBroadcastsTransition =
             '[Youtube'FullControl, Youtube'ForceSsl]
        requestClient YouTubeLiveBroadcastsTransition{..}
          = go (Core.Just broadcastStatus) (Core.Just id) part xgafv
              accessToken
              callback
