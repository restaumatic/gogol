...
newYouTubeLiveBroadcastsDelete id
  = YouTubeLiveBroadcastsDelete{xgafv = Core.Nothing,
...
instance Core.GoogleRequest YouTubeLiveBroadcastsDelete where
        ...
        requestClient YouTubeLiveBroadcastsDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy YouTubeLiveBroadcastsDeleteResource)
                      Core.mempty
