           ...
           Core.QueryParams "part" Core.Text Core.:>
             Core.QueryParam "$.xgafv" Xgafv Core.:>
               Core.QueryParam "access_token" Core.Text Core.:>
                 Core.QueryParam "broadcastStatus" LiveBroadcastsListBroadcastStatus
                   Core.:>
                   Core.QueryParam "broadcastType" LiveBroadcastsListBroadcastType
                     Core.:>
                                   ...
                                   Core.QueryParam "uploadType" Core.Text Core.:>
                                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                                       Core.QueryParam "alt" Core.AltJSON Core.:>
                                         Core.Get '[Core.JSON] LiveBroadcastListResponse
...
newYouTubeLiveBroadcastsList part
  = YouTubeLiveBroadcastsList{xgafv = Core.Nothing,
                              accessToken = Core.Nothing, broadcastStatus = Core.Nothing,
                              broadcastType = LiveBroadcastsListBroadcastType_Event,
                              callback = Core.Nothing, id = Core.Nothing, maxResults = 5,
                              mine = Core.Nothing, onBehalfOfContentOwner = Core.Nothing,
                              onBehalfOfContentOwnerChannel = Core.Nothing,
                              pageToken = Core.Nothing, part = part, uploadType = Core.Nothing,
