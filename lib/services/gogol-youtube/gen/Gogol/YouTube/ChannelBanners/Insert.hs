                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.ReqBody '[Core.JSON] ChannelBannerResource Core.:>
                                 Core.Post '[Core.JSON] ChannelBannerResource
       Core.:<|>
       "upload" Core.:>
         "youtube" Core.:>
           "v3" Core.:>
                               ...
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.QueryParam "uploadType" Core.Multipart Core.:>
                                     Core.MultipartRelated '[Core.JSON] ChannelBannerResource
...
newYouTubeChannelBannersInsert payload
  = YouTubeChannelBannersInsert{xgafv = Core.Nothing,
                                accessToken = Core.Nothing, callback = Core.Nothing,
                                channelId = Core.Nothing, onBehalfOfContentOwner = Core.Nothing,
                                onBehalfOfContentOwnerChannel = Core.Nothing, payload = payload,
...
instance Core.GoogleRequest YouTubeChannelBannersInsert where
        ...
        type Scopes YouTubeChannelBannersInsert =
             '[Youtube'FullControl, Youtube'ForceSsl, Youtube'Upload]
        requestClient YouTubeChannelBannersInsert{..}
          = go xgafv accessToken callback channelId onBehalfOfContentOwner
...
instance Core.GoogleRequest
         ...
         where
        type Rs (Core.MediaUpload YouTubeChannelBannersInsert) =
             ChannelBannerResource
        type Scopes (Core.MediaUpload YouTubeChannelBannersInsert) =
