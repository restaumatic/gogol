...
newYouTubeVideoCategoriesList part
  = YouTubeVideoCategoriesList{xgafv = Core.Nothing,
                               accessToken = Core.Nothing, callback = Core.Nothing, hl = "en-US",
                               id = Core.Nothing, part = part, regionCode = Core.Nothing,
                               uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest YouTubeVideoCategoriesList where
        type Rs YouTubeVideoCategoriesList = VideoCategoryListResponse
        ...
        requestClient YouTubeVideoCategoriesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy YouTubeVideoCategoriesListResource)
                      Core.mempty
