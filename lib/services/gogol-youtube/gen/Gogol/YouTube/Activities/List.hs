               ...
               Core.QueryParam "access_token" Core.Text Core.:>
                 Core.QueryParam "callback" Core.Text Core.:>
                   Core.QueryParam "channelId" Core.Text Core.:>
                     Core.QueryParam "home" Core.Bool Core.:>
                                   ...
                                   Core.QueryParam "uploadType" Core.Text Core.:>
                                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                                       Core.QueryParam "alt" Core.AltJSON Core.:>
                                         Core.Get '[Core.JSON] ActivityListResponse
...
newYouTubeActivitiesList part
  = YouTubeActivitiesList{xgafv = Core.Nothing,
                          accessToken = Core.Nothing, callback = Core.Nothing,
                          channelId = Core.Nothing, home = Core.Nothing, maxResults = 5,
                          mine = Core.Nothing, pageToken = Core.Nothing, part = part,
                          publishedAfter = Core.Nothing, publishedBefore = Core.Nothing,
                          regionCode = Core.Nothing, uploadType = Core.Nothing,
                          uploadProtocol = Core.Nothing}
instance Core.GoogleRequest YouTubeActivitiesList where
        type Rs YouTubeActivitiesList = ActivityListResponse
        type Scopes YouTubeActivitiesList =
             '[Youtube'FullControl, Youtube'ForceSsl, Youtube'Readonly]
        requestClient YouTubeActivitiesList{..}
          = go part xgafv accessToken callback channelId home
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy YouTubeActivitiesListResource)
                      Core.mempty
