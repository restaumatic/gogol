             ...
             Core.QueryParam "$.xgafv" Xgafv Core.:>
               Core.QueryParam "access_token" Core.Text Core.:>
                 Core.QueryParam "callback" Core.Text Core.:>
                   Core.QueryParam "filterByMemberChannelId" Core.Text Core.:>
                     Core.QueryParam "hasAccessToLevel" Core.Text Core.:>
                       Core.QueryParam "maxResults" Core.Word32 Core.:>
                         Core.QueryParam "mode" MembersListMode Core.:>
                           Core.QueryParam "pageToken" Core.Text Core.:>
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.Get '[Core.JSON] MemberListResponse
...
newYouTubeMembersList part
  = YouTubeMembersList{xgafv = Core.Nothing,
                       accessToken = Core.Nothing, callback = Core.Nothing,
                       filterByMemberChannelId = Core.Nothing,
                       hasAccessToLevel = Core.Nothing, maxResults = 5,
                       mode = MembersListMode_AllCurrent, pageToken = Core.Nothing,
...
instance Core.GoogleRequest YouTubeMembersList where
        ...
        type Scopes YouTubeMembersList =
             '[Youtube'ChannelMemberships'Creator]
        requestClient YouTubeMembersList{..}
          = go part xgafv accessToken callback filterByMemberChannelId
              hasAccessToLevel
