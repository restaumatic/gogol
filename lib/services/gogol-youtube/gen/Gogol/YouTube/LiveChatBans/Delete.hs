...
-- |
-- Module      : Gogol.YouTube.LiveChatBans.Delete
...
newYouTubeLiveChatBansDelete id
  = YouTubeLiveChatBansDelete{xgafv = Core.Nothing,
...
instance Core.GoogleRequest YouTubeLiveChatBansDelete where
        ...
        type Scopes YouTubeLiveChatBansDelete =
        ...
        requestClient YouTubeLiveChatBansDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy YouTubeLiveChatBansDeleteResource)
                      Core.mempty
