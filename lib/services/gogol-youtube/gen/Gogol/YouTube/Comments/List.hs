                     ...
                     Core.QueryParam "maxResults" Core.Word32 Core.:>
                       Core.QueryParam "pageToken" Core.Text Core.:>
                         Core.QueryParam "parentId" Core.Text Core.:>
                           Core.QueryParam "textFormat" CommentsListTextFormat Core.:>
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.Get '[Core.JSON] CommentListResponse
...
newYouTubeCommentsList part
  = YouTubeCommentsList{xgafv = Core.Nothing,
                        accessToken = Core.Nothing, callback = Core.Nothing,
                        id = Core.Nothing, maxResults = 20, pageToken = Core.Nothing,
                        parentId = Core.Nothing, part = part,
