...
type YouTubeCommentsSetModerationStatusResource =
     "youtube" Core.:>
       "v3" Core.:>
         "comments" Core.:>
           "setModerationStatus" Core.:>
             Core.QueryParams "id" Core.Text Core.:>
               Core.QueryParam "moderationStatus"
                 CommentsSetModerationStatusModerationStatus
                 Core.:>
                 Core.QueryParam "$.xgafv" Xgafv Core.:>
                   Core.QueryParam "access_token" Core.Text Core.:>
                     Core.QueryParam "banAuthor" Core.Bool Core.:>
...
newYouTubeCommentsSetModerationStatus 
    ...
    -> CommentsSetModerationStatusModerationStatus
       -- ^  Specifies the requested moderation status. Note, comments can be in statuses, which are not available through this call. For example, this call does not allow to mark a comment as \'likely spam\'. Valid values: \'heldForReview\', \'published\' or \'rejected\'. See 'moderationStatus'.
    -> YouTubeCommentsSetModerationStatus
newYouTubeCommentsSetModerationStatus id moderationStatus
  = YouTubeCommentsSetModerationStatus{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, banAuthor = Core.False,
                                       callback = Core.Nothing, id = id,
                                       moderationStatus = moderationStatus,
                                       uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest YouTubeCommentsSetModerationStatus
         where
        type Rs YouTubeCommentsSetModerationStatus = ()
        type Scopes YouTubeCommentsSetModerationStatus =
             '[Youtube'ForceSsl]
        requestClient YouTubeCommentsSetModerationStatus{..}
          = go id (Core.Just moderationStatus) xgafv accessToken
              (Core.Just banAuthor)
              callback
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy YouTubeCommentsSetModerationStatusResource)
                      Core.mempty
