                 ...
                 Core.QueryParam "access_token" Core.Text Core.:>
                   Core.QueryParam "callback" Core.Text Core.:>
                     Core.QueryParam "id" Core.Text Core.:>
                       Core.QueryParam "status" LiveChatMessagesTransitionStatus Core.:>
...
newYouTubeLiveChatMessagesTransition 
    :: 
                                     YouTubeLiveChatMessagesTransition
newYouTubeLiveChatMessagesTransition
  = YouTubeLiveChatMessagesTransition{xgafv = Core.Nothing,
                                      accessToken = Core.Nothing, callback = Core.Nothing,
                                      id = Core.Nothing, status = Core.Nothing,
...
instance Core.GoogleRequest YouTubeLiveChatMessagesTransition where
        ...
        type Scopes YouTubeLiveChatMessagesTransition =
             '[Youtube'FullControl, Youtube'ForceSsl]
        requestClient YouTubeLiveChatMessagesTransition{..}
          = go xgafv accessToken callback id status uploadType uploadProtocol
