...
newYouTubeLiveChatMessagesInsert part payload
  = YouTubeLiveChatMessagesInsert{xgafv = Core.Nothing,
                                  accessToken = Core.Nothing, callback = Core.Nothing, part = part,
                                  payload = payload, uploadType = Core.Nothing,
                                  uploadProtocol = Core.Nothing}
instance Core.GoogleRequest YouTubeLiveChatMessagesInsert where
        type Rs YouTubeLiveChatMessagesInsert = LiveChatMessage
        ...
        requestClient YouTubeLiveChatMessagesInsert{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy YouTubeLiveChatMessagesInsertResource)
                      Core.mempty
