...
newLoggingBillingAccountsGetCmekSettings name
  = LoggingBillingAccountsGetCmekSettings{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          name = name, uploadType = Core.Nothing,
                                          uploadProtocol = Core.Nothing}
instance Core.GoogleRequest LoggingBillingAccountsGetCmekSettings
         where
        type Rs LoggingBillingAccountsGetCmekSettings = CmekSettings
        type Scopes LoggingBillingAccountsGetCmekSettings =
             '[CloudPlatform'FullControl, CloudPlatform'ReadOnly, Logging'Admin,
               Logging'Read]
        requestClient LoggingBillingAccountsGetCmekSettings{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingBillingAccountsGetCmekSettingsResource)
                      Core.mempty
