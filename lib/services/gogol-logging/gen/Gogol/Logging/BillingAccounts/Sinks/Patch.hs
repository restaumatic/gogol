         ...
         Core.QueryParam "$.xgafv" Xgafv Core.:>
           Core.QueryParam "access_token" Core.Text Core.:>
             Core.QueryParam "callback" Core.Text Core.:>
               Core.QueryParam "customWriterIdentity" Core.Text Core.:>
                 Core.QueryParam "uniqueWriterIdentity" Core.Bool Core.:>
...
newLoggingBillingAccountsSinksPatch payload sinkName
  = LoggingBillingAccountsSinksPatch{xgafv = Core.Nothing,
                                     accessToken = Core.Nothing, callback = Core.Nothing,
                                     customWriterIdentity = Core.Nothing, payload = payload,
                                     sinkName = sinkName, uniqueWriterIdentity = Core.Nothing,
                                     updateMask = Core.Nothing, uploadType = Core.Nothing,
                                     uploadProtocol = Core.Nothing}
instance Core.GoogleRequest LoggingBillingAccountsSinksPatch where
        ...
        requestClient LoggingBillingAccountsSinksPatch{..}
          = go sinkName xgafv accessToken callback customWriterIdentity
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy LoggingBillingAccountsSinksPatchResource)
                      Core.mempty
