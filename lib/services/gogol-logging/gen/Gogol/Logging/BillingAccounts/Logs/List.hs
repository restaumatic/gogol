...
newLoggingBillingAccountsLogsList parent
  = LoggingBillingAccountsLogsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest LoggingBillingAccountsLogsList where
        type Rs LoggingBillingAccountsLogsList = ListLogsResponse
        ...
        requestClient LoggingBillingAccountsLogsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy LoggingBillingAccountsLogsListResource)
                      Core.mempty
