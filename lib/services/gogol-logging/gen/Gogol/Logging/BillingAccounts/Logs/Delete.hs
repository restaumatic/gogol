...
newLoggingBillingAccountsLogsDelete logName
  = LoggingBillingAccountsLogsDelete{xgafv = Core.Nothing,
                                     accessToken = Core.Nothing, callback = Core.Nothing,
                                     logName = logName, uploadType = Core.Nothing,
                                     uploadProtocol = Core.Nothing}
instance Core.GoogleRequest LoggingBillingAccountsLogsDelete where
        ...
        requestClient LoggingBillingAccountsLogsDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy LoggingBillingAccountsLogsDeleteResource)
                      Core.mempty
