...
newLoggingBillingAccountsExclusionsList parent
  = LoggingBillingAccountsExclusionsList{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         pageSize = Core.Nothing, pageToken = Core.Nothing,
                                         parent = parent, uploadType = Core.Nothing,
                                         uploadProtocol = Core.Nothing}
instance Core.GoogleRequest LoggingBillingAccountsExclusionsList
         where
        type Rs LoggingBillingAccountsExclusionsList =
             ListExclusionsResponse
        type Scopes LoggingBillingAccountsExclusionsList =
