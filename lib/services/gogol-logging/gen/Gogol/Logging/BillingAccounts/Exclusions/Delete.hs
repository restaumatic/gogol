...
newLoggingBillingAccountsExclusionsDelete name
  = LoggingBillingAccountsExclusionsDelete{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           name = name, uploadType = Core.Nothing,
                                           uploadProtocol = Core.Nothing}
instance Core.GoogleRequest LoggingBillingAccountsExclusionsDelete
         where
        type Rs LoggingBillingAccountsExclusionsDelete = Empty
        type Scopes LoggingBillingAccountsExclusionsDelete =
             '[CloudPlatform'FullControl, Logging'Admin]
        requestClient LoggingBillingAccountsExclusionsDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingBillingAccountsExclusionsDeleteResource)
                      Core.mempty
