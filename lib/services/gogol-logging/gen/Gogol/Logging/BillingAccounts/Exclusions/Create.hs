...
newLoggingBillingAccountsExclusionsCreate parent payload
  = LoggingBillingAccountsExclusionsCreate{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           parent = parent, payload = payload,
                                           uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest LoggingBillingAccountsExclusionsCreate
         where
        type Rs LoggingBillingAccountsExclusionsCreate = LogExclusion
        type Scopes LoggingBillingAccountsExclusionsCreate =
