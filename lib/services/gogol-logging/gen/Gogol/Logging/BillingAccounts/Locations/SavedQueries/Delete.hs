...
newLoggingBillingAccountsLocationsSavedQueriesDelete name
  = LoggingBillingAccountsLocationsSavedQueriesDelete{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           LoggingBillingAccountsLocationsSavedQueriesDelete
         where
        type Rs LoggingBillingAccountsLocationsSavedQueriesDelete = Empty
        type Scopes LoggingBillingAccountsLocationsSavedQueriesDelete =
             '[CloudPlatform'FullControl, Logging'Admin]
        requestClient LoggingBillingAccountsLocationsSavedQueriesDelete{..}
