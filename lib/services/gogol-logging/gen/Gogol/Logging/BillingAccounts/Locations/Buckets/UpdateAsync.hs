...
-- |
-- Module      : Gogol.Logging.BillingAccounts.Locations.Buckets.UpdateAsync
...
--
-- /See:/ <https://cloud.google.com/logging/docs/ Cloud Logging API Reference> for @logging.billingAccounts.locations.buckets.updateAsync@.
module Gogol.Logging.BillingAccounts.Locations.Buckets.UpdateAsync
    (
    -- * Resource
...
-- | A resource alias for @logging.billingAccounts.locations.buckets.updateAsync@ method which the
-- 'LoggingBillingAccountsLocationsBucketsUpdateAsync' request conforms to.
type LoggingBillingAccountsLocationsBucketsUpdateAsyncResource =
     "v2" Core.:>
       Core.CaptureMode "name" "updateAsync" Core.Text Core.:>
...
-- | Updates a log bucket asynchronously.If the bucket has a lifecycle/state of DELETE/REQUESTED, then FAILED_PRECONDITION will be returned.After a bucket has been created, the bucket\'s location cannot be changed.
--
-- /See:/ 'newLoggingBillingAccountsLocationsBucketsUpdateAsync' smart constructor.
data LoggingBillingAccountsLocationsBucketsUpdateAsync = LoggingBillingAccountsLocationsBucketsUpdateAsync
    {
      -- | V1 error format.
...
-- | Creates a value of 'LoggingBillingAccountsLocationsBucketsUpdateAsync' with the minimum fields required to make a request.
newLoggingBillingAccountsLocationsBucketsUpdateAsync 
    :: 
                                                     Core.Text
    ...
    -> LoggingBillingAccountsLocationsBucketsUpdateAsync
newLoggingBillingAccountsLocationsBucketsUpdateAsync name payload
  = LoggingBillingAccountsLocationsBucketsUpdateAsync{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           LoggingBillingAccountsLocationsBucketsUpdateAsync
         where
        type Rs LoggingBillingAccountsLocationsBucketsUpdateAsync =
             Operation
        type Scopes LoggingBillingAccountsLocationsBucketsUpdateAsync =
             '[CloudPlatform'FullControl, Logging'Admin]
        requestClient LoggingBillingAccountsLocationsBucketsUpdateAsync{..}
