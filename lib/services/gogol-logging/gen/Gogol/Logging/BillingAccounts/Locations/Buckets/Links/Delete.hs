...
newLoggingBillingAccountsLocationsBucketsLinksDelete name
  = LoggingBillingAccountsLocationsBucketsLinksDelete{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           LoggingBillingAccountsLocationsBucketsLinksDelete
         where
        type Rs LoggingBillingAccountsLocationsBucketsLinksDelete =
             Operation
        type Scopes LoggingBillingAccountsLocationsBucketsLinksDelete =
             '[CloudPlatform'FullControl, Logging'Admin]
        requestClient LoggingBillingAccountsLocationsBucketsLinksDelete{..}
