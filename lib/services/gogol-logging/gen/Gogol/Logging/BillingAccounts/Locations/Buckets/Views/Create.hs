...
newLoggingBillingAccountsLocationsBucketsViewsCreate parent payload
  = LoggingBillingAccountsLocationsBucketsViewsCreate{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           LoggingBillingAccountsLocationsBucketsViewsCreate
         where
        type Rs LoggingBillingAccountsLocationsBucketsViewsCreate = LogView
        type Scopes LoggingBillingAccountsLocationsBucketsViewsCreate =
             '[CloudPlatform'FullControl, Logging'Admin]
        requestClient LoggingBillingAccountsLocationsBucketsViewsCreate{..}
