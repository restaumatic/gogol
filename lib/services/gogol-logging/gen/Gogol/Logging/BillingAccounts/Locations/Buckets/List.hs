...
newLoggingBillingAccountsLocationsBucketsList parent
  = LoggingBillingAccountsLocationsBucketsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           LoggingBillingAccountsLocationsBucketsList
         where
        type Rs LoggingBillingAccountsLocationsBucketsList =
             ListBucketsResponse
        type Scopes LoggingBillingAccountsLocationsBucketsList =
