...
newLoggingBillingAccountsLocationsSavedQueriesList parent
  = LoggingBillingAccountsLocationsSavedQueriesList{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           LoggingBillingAccountsLocationsSavedQueriesList
         where
        type Rs LoggingBillingAccountsLocationsSavedQueriesList =
             ListSavedQueriesResponse
        type Scopes LoggingBillingAccountsLocationsSavedQueriesList =
