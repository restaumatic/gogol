...
newLoggingBillingAccountsLocationsBucketsPatch name payload
  = LoggingBillingAccountsLocationsBucketsPatch{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           LoggingBillingAccountsLocationsBucketsPatch
         where
        type Rs LoggingBillingAccountsLocationsBucketsPatch = LogBucket
        type Scopes LoggingBillingAccountsLocationsBucketsPatch =
             '[CloudPlatform'FullControl, Logging'Admin]
        requestClient LoggingBillingAccountsLocationsBucketsPatch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingBillingAccountsLocationsBucketsPatchResource)
                      Core.mempty
