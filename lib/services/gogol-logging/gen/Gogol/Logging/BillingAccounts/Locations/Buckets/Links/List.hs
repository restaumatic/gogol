...
newLoggingBillingAccountsLocationsBucketsLinksList parent
  = LoggingBillingAccountsLocationsBucketsLinksList{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           LoggingBillingAccountsLocationsBucketsLinksList
         where
        type Rs LoggingBillingAccountsLocationsBucketsLinksList =
             ListLinksResponse
        type Scopes LoggingBillingAccountsLocationsBucketsLinksList =
             '[CloudPlatform'FullControl, CloudPlatform'ReadOnly, Logging'Admin,
               Logging'Read]
        requestClient LoggingBillingAccountsLocationsBucketsLinksList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingBillingAccountsLocationsBucketsLinksListResource)
                      Core.mempty
