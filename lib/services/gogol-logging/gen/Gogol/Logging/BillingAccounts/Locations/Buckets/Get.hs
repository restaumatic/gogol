...
newLoggingBillingAccountsLocationsBucketsGet name
  = LoggingBillingAccountsLocationsBucketsGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           LoggingBillingAccountsLocationsBucketsGet
         where
        type Rs LoggingBillingAccountsLocationsBucketsGet = LogBucket
        type Scopes LoggingBillingAccountsLocationsBucketsGet =
             '[CloudPlatform'FullControl, CloudPlatform'ReadOnly, Logging'Admin,
               Logging'Read]
        requestClient LoggingBillingAccountsLocationsBucketsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingBillingAccountsLocationsBucketsGetResource)
                      Core.mempty
