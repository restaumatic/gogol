...
newLoggingBillingAccountsLocationsBucketsViewsPatch name payload
  = LoggingBillingAccountsLocationsBucketsViewsPatch{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           LoggingBillingAccountsLocationsBucketsViewsPatch
         where
        type Rs LoggingBillingAccountsLocationsBucketsViewsPatch = LogView
        type Scopes LoggingBillingAccountsLocationsBucketsViewsPatch =
             '[CloudPlatform'FullControl, Logging'Admin]
        requestClient LoggingBillingAccountsLocationsBucketsViewsPatch{..}
