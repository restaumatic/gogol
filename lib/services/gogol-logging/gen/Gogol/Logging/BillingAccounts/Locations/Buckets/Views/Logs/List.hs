...
-- |
-- Module      : Gogol.Logging.BillingAccounts.Locations.Buckets.Views.Logs.List
...
--
-- /See:/ <https://cloud.google.com/logging/docs/ Cloud Logging API Reference> for @logging.billingAccounts.locations.buckets.views.logs.list@.
module Gogol.Logging.BillingAccounts.Locations.Buckets.Views.Logs.List
    (
    -- * Resource
...
-- | A resource alias for @logging.billingAccounts.locations.buckets.views.logs.list@ method which the
-- 'LoggingBillingAccountsLocationsBucketsViewsLogsList' request conforms to.
type LoggingBillingAccountsLocationsBucketsViewsLogsListResource =
     "v2" Core.:>
...
-- | Lists the logs in projects, organizations, folders, or billing accounts. Only logs that have entries are listed.
--
-- /See:/ 'newLoggingBillingAccountsLocationsBucketsViewsLogsList' smart constructor.
data LoggingBillingAccountsLocationsBucketsViewsLogsList = LoggingBillingAccountsLocationsBucketsViewsLogsList
    {
      -- | V1 error format.
...
-- | Creates a value of 'LoggingBillingAccountsLocationsBucketsViewsLogsList' with the minimum fields required to make a request.
newLoggingBillingAccountsLocationsBucketsViewsLogsList 
    :: 
                                                       Core.Text
    ...
    -> LoggingBillingAccountsLocationsBucketsViewsLogsList
newLoggingBillingAccountsLocationsBucketsViewsLogsList parent
  = LoggingBillingAccountsLocationsBucketsViewsLogsList{xgafv =
                                                          Core.Nothing,
...
instance Core.GoogleRequest
           LoggingBillingAccountsLocationsBucketsViewsLogsList
         where
        type Rs LoggingBillingAccountsLocationsBucketsViewsLogsList =
             ListLogsResponse
        type Scopes LoggingBillingAccountsLocationsBucketsViewsLogsList =
