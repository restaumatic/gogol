...
newLoggingBillingAccountsLocationsBucketsViewsList parent
  = LoggingBillingAccountsLocationsBucketsViewsList{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           LoggingBillingAccountsLocationsBucketsViewsList
         where
        type Rs LoggingBillingAccountsLocationsBucketsViewsList =
             ListViewsResponse
        type Scopes LoggingBillingAccountsLocationsBucketsViewsList =
