...
newLoggingBillingAccountsLocationsSavedQueriesGet name
  = LoggingBillingAccountsLocationsSavedQueriesGet{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           LoggingBillingAccountsLocationsSavedQueriesGet
         where
        type Rs LoggingBillingAccountsLocationsSavedQueriesGet = SavedQuery
        type Scopes LoggingBillingAccountsLocationsSavedQueriesGet =
             '[CloudPlatform'FullControl, CloudPlatform'ReadOnly, Logging'Admin,
               Logging'Read]
        requestClient LoggingBillingAccountsLocationsSavedQueriesGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingBillingAccountsLocationsSavedQueriesGetResource)
                      Core.mempty
