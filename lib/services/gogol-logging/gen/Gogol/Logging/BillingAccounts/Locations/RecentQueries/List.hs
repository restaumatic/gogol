...
-- |
-- Module      : Gogol.Logging.BillingAccounts.Locations.RecentQueries.List
...
--
-- /See:/ <https://cloud.google.com/logging/docs/ Cloud Logging API Reference> for @logging.billingAccounts.locations.recentQueries.list@.
module Gogol.Logging.BillingAccounts.Locations.RecentQueries.List
    (
    -- * Resource
...
-- | A resource alias for @logging.billingAccounts.locations.recentQueries.list@ method which the
-- 'LoggingBillingAccountsLocationsRecentQueriesList' request conforms to.
type LoggingBillingAccountsLocationsRecentQueriesListResource =
     "v2" Core.:>
...
-- | Lists the RecentQueries that were created by the user making the request.
--
-- /See:/ 'newLoggingBillingAccountsLocationsRecentQueriesList' smart constructor.
data LoggingBillingAccountsLocationsRecentQueriesList = LoggingBillingAccountsLocationsRecentQueriesList
    {
      -- | V1 error format.
...
-- | Creates a value of 'LoggingBillingAccountsLocationsRecentQueriesList' with the minimum fields required to make a request.
newLoggingBillingAccountsLocationsRecentQueriesList 
    :: 
                                                    Core.Text
    ...
    -> LoggingBillingAccountsLocationsRecentQueriesList
newLoggingBillingAccountsLocationsRecentQueriesList parent
  = LoggingBillingAccountsLocationsRecentQueriesList{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           LoggingBillingAccountsLocationsRecentQueriesList
         where
        type Rs LoggingBillingAccountsLocationsRecentQueriesList =
             ListRecentQueriesResponse
        type Scopes LoggingBillingAccountsLocationsRecentQueriesList =
             '[CloudPlatform'FullControl, CloudPlatform'ReadOnly, Logging'Admin,
               Logging'Read]
        requestClient LoggingBillingAccountsLocationsRecentQueriesList{..}
