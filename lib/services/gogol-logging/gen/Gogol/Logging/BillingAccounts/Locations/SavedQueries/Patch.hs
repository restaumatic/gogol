...
newLoggingBillingAccountsLocationsSavedQueriesPatch name payload
  = LoggingBillingAccountsLocationsSavedQueriesPatch{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           LoggingBillingAccountsLocationsSavedQueriesPatch
         where
        type Rs LoggingBillingAccountsLocationsSavedQueriesPatch =
             SavedQuery
        type Scopes LoggingBillingAccountsLocationsSavedQueriesPatch =
             '[CloudPlatform'FullControl, Logging'Admin]
        requestClient LoggingBillingAccountsLocationsSavedQueriesPatch{..}
