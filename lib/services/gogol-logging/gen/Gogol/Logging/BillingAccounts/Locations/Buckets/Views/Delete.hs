...
newLoggingBillingAccountsLocationsBucketsViewsDelete name
  = LoggingBillingAccountsLocationsBucketsViewsDelete{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           LoggingBillingAccountsLocationsBucketsViewsDelete
         where
        type Rs LoggingBillingAccountsLocationsBucketsViewsDelete = Empty
        type Scopes LoggingBillingAccountsLocationsBucketsViewsDelete =
             '[CloudPlatform'FullControl, Logging'Admin]
        requestClient LoggingBillingAccountsLocationsBucketsViewsDelete{..}
