...
newLoggingFoldersSinksUpdate payload sinkName
  = LoggingFoldersSinksUpdate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest LoggingFoldersSinksUpdate where
        ...
        requestClient LoggingFoldersSinksUpdate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy LoggingFoldersSinksUpdateResource)
                      Core.mempty
