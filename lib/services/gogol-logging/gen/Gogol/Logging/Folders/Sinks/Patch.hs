...
newLoggingFoldersSinksPatch payload sinkName
  = LoggingFoldersSinksPatch{xgafv = Core.Nothing,
...
instance Core.GoogleRequest LoggingFoldersSinksPatch where
        ...
        requestClient LoggingFoldersSinksPatch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy LoggingFoldersSinksPatchResource)
                      Core.mempty
