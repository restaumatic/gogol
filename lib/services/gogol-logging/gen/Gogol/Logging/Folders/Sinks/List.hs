...
newLoggingFoldersSinksList parent
  = LoggingFoldersSinksList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest LoggingFoldersSinksList where
        ...
        requestClient LoggingFoldersSinksList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy LoggingFoldersSinksListResource)
                      Core.mempty
