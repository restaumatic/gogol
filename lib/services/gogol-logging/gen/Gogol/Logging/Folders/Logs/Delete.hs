...
newLoggingFoldersLogsDelete logName
  = LoggingFoldersLogsDelete{xgafv = Core.Nothing,
                             accessToken = Core.Nothing, callback = Core.Nothing,
                             logName = logName, uploadType = Core.Nothing,
                             uploadProtocol = Core.Nothing}
instance Core.GoogleRequest LoggingFoldersLogsDelete where
        ...
        requestClient LoggingFoldersLogsDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy LoggingFoldersLogsDeleteResource)
                      Core.mempty
