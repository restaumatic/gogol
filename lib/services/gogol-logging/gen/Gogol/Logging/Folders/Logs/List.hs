...
-- |
-- Module      : Gogol.Logging.Folders.Logs.List
...
newLoggingFoldersLogsList parent
  = LoggingFoldersLogsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest LoggingFoldersLogsList where
        ...
        type Scopes LoggingFoldersLogsList =
        ...
        requestClient LoggingFoldersLogsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy LoggingFoldersLogsListResource)
                      Core.mempty
