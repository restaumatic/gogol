...
-- |
-- Module      : Gogol.Logging.Folders.Exclusions.Create
...
newLoggingFoldersExclusionsCreate parent payload
  = LoggingFoldersExclusionsCreate{xgafv = Core.Nothing,
                                   accessToken = Core.Nothing, callback = Core.Nothing,
                                   parent = parent, payload = payload, uploadType = Core.Nothing,
                                   uploadProtocol = Core.Nothing}
instance Core.GoogleRequest LoggingFoldersExclusionsCreate where
        type Rs LoggingFoldersExclusionsCreate = LogExclusion
        type Scopes LoggingFoldersExclusionsCreate =
        ...
        requestClient LoggingFoldersExclusionsCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy LoggingFoldersExclusionsCreateResource)
                      Core.mempty
