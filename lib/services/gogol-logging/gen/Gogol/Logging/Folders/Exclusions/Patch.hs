...
newLoggingFoldersExclusionsPatch name payload
  = LoggingFoldersExclusionsPatch{xgafv = Core.Nothing,
...
instance Core.GoogleRequest LoggingFoldersExclusionsPatch where
        ...
        requestClient LoggingFoldersExclusionsPatch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy LoggingFoldersExclusionsPatchResource)
                      Core.mempty
