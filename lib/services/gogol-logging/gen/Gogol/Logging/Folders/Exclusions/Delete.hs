...
newLoggingFoldersExclusionsDelete name
  = LoggingFoldersExclusionsDelete{xgafv = Core.Nothing,
                                   accessToken = Core.Nothing, callback = Core.Nothing, name = name,
                                   uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest LoggingFoldersExclusionsDelete where
        type Rs LoggingFoldersExclusionsDelete = Empty
        type Scopes LoggingFoldersExclusionsDelete =
        ...
        requestClient LoggingFoldersExclusionsDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy LoggingFoldersExclusionsDeleteResource)
                      Core.mempty
