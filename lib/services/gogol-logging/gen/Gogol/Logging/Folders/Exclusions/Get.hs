...
instance Core.GoogleRequest LoggingFoldersExclusionsGet where
        ...
        requestClient LoggingFoldersExclusionsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy LoggingFoldersExclusionsGetResource)
                      Core.mempty
