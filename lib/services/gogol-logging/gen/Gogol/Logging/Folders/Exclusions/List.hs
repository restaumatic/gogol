...
newLoggingFoldersExclusionsList parent
  = LoggingFoldersExclusionsList{xgafv = Core.Nothing,
                                 accessToken = Core.Nothing, callback = Core.Nothing,
                                 pageSize = Core.Nothing, pageToken = Core.Nothing, parent = parent,
                                 uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest LoggingFoldersExclusionsList where
        type Rs LoggingFoldersExclusionsList = ListExclusionsResponse
        type Scopes LoggingFoldersExclusionsList =
        ...
        requestClient LoggingFoldersExclusionsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy LoggingFoldersExclusionsListResource)
                      Core.mempty
