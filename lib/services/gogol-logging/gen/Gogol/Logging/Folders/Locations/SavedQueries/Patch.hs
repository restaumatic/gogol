...
newLoggingFoldersLocationsSavedQueriesPatch name payload
  = LoggingFoldersLocationsSavedQueriesPatch{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           LoggingFoldersLocationsSavedQueriesPatch
         where
        type Rs LoggingFoldersLocationsSavedQueriesPatch = SavedQuery
        type Scopes LoggingFoldersLocationsSavedQueriesPatch =
             '[CloudPlatform'FullControl, Logging'Admin]
        requestClient LoggingFoldersLocationsSavedQueriesPatch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingFoldersLocationsSavedQueriesPatchResource)
                      Core.mempty
