...
newLoggingFoldersLocationsBucketsUndelete name payload
  = LoggingFoldersLocationsBucketsUndelete{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           name = name, payload = payload,
                                           uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest LoggingFoldersLocationsBucketsUndelete
         where
        type Rs LoggingFoldersLocationsBucketsUndelete = Empty
        type Scopes LoggingFoldersLocationsBucketsUndelete =
