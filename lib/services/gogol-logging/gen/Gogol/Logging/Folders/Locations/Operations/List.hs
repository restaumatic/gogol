...
-- |
-- Module      : Gogol.Logging.Folders.Locations.Operations.List
...
newLoggingFoldersLocationsOperationsList name
  = LoggingFoldersLocationsOperationsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest LoggingFoldersLocationsOperationsList
         where
        type Rs LoggingFoldersLocationsOperationsList =
             ListOperationsResponse
        type Scopes LoggingFoldersLocationsOperationsList =
             '[CloudPlatform'FullControl, CloudPlatform'ReadOnly, Logging'Admin,
               Logging'Read]
        requestClient LoggingFoldersLocationsOperationsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingFoldersLocationsOperationsListResource)
                      Core.mempty
