...
-- |
-- Module      : Gogol.Logging.Folders.Locations.SavedQueries.List
...
--
-- /See:/ <https://cloud.google.com/logging/docs/ Cloud Logging API Reference> for @logging.folders.locations.savedQueries.list@.
module Gogol.Logging.Folders.Locations.SavedQueries.List
    (
    -- * Resource
...
-- | A resource alias for @logging.folders.locations.savedQueries.list@ method which the
-- 'LoggingFoldersLocationsSavedQueriesList' request conforms to.
type LoggingFoldersLocationsSavedQueriesListResource =
     "v2" Core.:>
...
-- | Lists the SavedQueries that were created by the user making the request.
--
-- /See:/ 'newLoggingFoldersLocationsSavedQueriesList' smart constructor.
data LoggingFoldersLocationsSavedQueriesList = LoggingFoldersLocationsSavedQueriesList
    {
      -- | V1 error format.
...
-- | Creates a value of 'LoggingFoldersLocationsSavedQueriesList' with the minimum fields required to make a request.
newLoggingFoldersLocationsSavedQueriesList 
    :: 
                                           Core.Text
       -- ^  Required. The resource to which the listed queries belong. \"projects\/[PROJECT/ID]\/locations\/[LOCATION/ID]\" \"organizations\/[ORGANIZATION/ID]\/locations\/[LOCATION/ID]\" \"billingAccounts\/[BILLING/ACCOUNT/ID]\/locations\/[LOCATION/ID]\" \"folders\/[FOLDER/ID]\/locations\/[LOCATION/ID]\" For example: \"projects\/my-project\/locations\/us-central1\" Note: The locations portion of the resource must be specified. To get a list of all saved queries, a wildcard character - can be used for LOCATION/ID, for example: \"projects\/my-project\/locations\/-\" See 'parent'.
    -> LoggingFoldersLocationsSavedQueriesList
newLoggingFoldersLocationsSavedQueriesList parent
  = LoggingFoldersLocationsSavedQueriesList{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            filter = Core.Nothing, pageSize = Core.Nothing,
                                            pageToken = Core.Nothing, parent = parent,
                                            uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest LoggingFoldersLocationsSavedQueriesList
         where
        type Rs LoggingFoldersLocationsSavedQueriesList =
             ListSavedQueriesResponse
        type Scopes LoggingFoldersLocationsSavedQueriesList =
             '[CloudPlatform'FullControl, CloudPlatform'ReadOnly, Logging'Admin,
               Logging'Read]
        requestClient LoggingFoldersLocationsSavedQueriesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingFoldersLocationsSavedQueriesListResource)
                      Core.mempty
