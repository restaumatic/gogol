...
newLoggingFoldersLocationsBucketsViewsCreate parent payload
  = LoggingFoldersLocationsBucketsViewsCreate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           LoggingFoldersLocationsBucketsViewsCreate
         where
        type Rs LoggingFoldersLocationsBucketsViewsCreate = LogView
        type Scopes LoggingFoldersLocationsBucketsViewsCreate =
             '[CloudPlatform'FullControl, Logging'Admin]
        requestClient LoggingFoldersLocationsBucketsViewsCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingFoldersLocationsBucketsViewsCreateResource)
                      Core.mempty
