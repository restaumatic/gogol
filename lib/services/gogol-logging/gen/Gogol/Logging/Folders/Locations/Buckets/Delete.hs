...
newLoggingFoldersLocationsBucketsDelete name
  = LoggingFoldersLocationsBucketsDelete{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         name = name, uploadType = Core.Nothing,
                                         uploadProtocol = Core.Nothing}
instance Core.GoogleRequest LoggingFoldersLocationsBucketsDelete
         where
        type Rs LoggingFoldersLocationsBucketsDelete = Empty
        type Scopes LoggingFoldersLocationsBucketsDelete =
             '[CloudPlatform'FullControl, Logging'Admin]
        requestClient LoggingFoldersLocationsBucketsDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingFoldersLocationsBucketsDeleteResource)
                      Core.mempty
