...
newLoggingFoldersLocationsBucketsList parent
  = LoggingFoldersLocationsBucketsList{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       pageSize = Core.Nothing, pageToken = Core.Nothing,
                                       parent = parent, uploadType = Core.Nothing,
                                       uploadProtocol = Core.Nothing}
instance Core.GoogleRequest LoggingFoldersLocationsBucketsList
         where
        type Rs LoggingFoldersLocationsBucketsList = ListBucketsResponse
        type Scopes LoggingFoldersLocationsBucketsList =
        ...
        requestClient LoggingFoldersLocationsBucketsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingFoldersLocationsBucketsListResource)
                      Core.mempty
