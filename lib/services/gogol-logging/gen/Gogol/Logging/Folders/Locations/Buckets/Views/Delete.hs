...
-- |
-- Module      : Gogol.Logging.Folders.Locations.Buckets.Views.Delete
...
-- 'LoggingFoldersLocationsBucketsViewsDelete' request conforms to.
type LoggingFoldersLocationsBucketsViewsDeleteResource =
     "v2" Core.:>
...
-- | Deletes a view on a log bucket. If an UNAVAILABLE error is returned, this indicates that system is not in a state where it can delete the view. If this occurs, please try again in a few minutes.
--
-- /See:/ 'newLoggingFoldersLocationsBucketsViewsDelete' smart constructor.
data LoggingFoldersLocationsBucketsViewsDelete = LoggingFoldersLocationsBucketsViewsDelete
    {
      -- | V1 error format.
...
-- | Creates a value of 'LoggingFoldersLocationsBucketsViewsDelete' with the minimum fields required to make a request.
newLoggingFoldersLocationsBucketsViewsDelete 
    :: 
                                             Core.Text
    ...
    -> LoggingFoldersLocationsBucketsViewsDelete
newLoggingFoldersLocationsBucketsViewsDelete name
  = LoggingFoldersLocationsBucketsViewsDelete{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           LoggingFoldersLocationsBucketsViewsDelete
         where
        type Rs LoggingFoldersLocationsBucketsViewsDelete = Empty
        type Scopes LoggingFoldersLocationsBucketsViewsDelete =
             '[CloudPlatform'FullControl, Logging'Admin]
        requestClient LoggingFoldersLocationsBucketsViewsDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingFoldersLocationsBucketsViewsDeleteResource)
                      Core.mempty
