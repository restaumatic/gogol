...
data LoggingFoldersLocationsLogScopesCreate = LoggingFoldersLocationsLogScopesCreate
    ...
    , logScopeId :: (Core.Maybe Core.Text)
      -- | Required. The parent resource in which to create the log scope: \"projects\/[PROJECT/ID]\/locations\/[LOCATION/ID]\" \"organizations\/[ORGANIZATION/ID]\/locations\/[LOCATION/ID]\" \"folders\/[FOLDER/ID]\/locations\/[LOCATION/ID]\" For example:\"projects\/my-project\/locations\/global\"
    , parent :: Core.Text
...
newLoggingFoldersLocationsLogScopesCreate 
    :: 
                                          Core.Text
       -- ^  Required. The parent resource in which to create the log scope: \"projects\/[PROJECT/ID]\/locations\/[LOCATION/ID]\" \"organizations\/[ORGANIZATION/ID]\/locations\/[LOCATION/ID]\" \"folders\/[FOLDER/ID]\/locations\/[LOCATION/ID]\" For example:\"projects\/my-project\/locations\/global\" See 'parent'.
    -> LogScope
