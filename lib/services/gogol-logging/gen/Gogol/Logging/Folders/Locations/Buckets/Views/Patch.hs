...
newLoggingFoldersLocationsBucketsViewsPatch name payload
  = LoggingFoldersLocationsBucketsViewsPatch{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           LoggingFoldersLocationsBucketsViewsPatch
         where
        type Rs LoggingFoldersLocationsBucketsViewsPatch = LogView
        type Scopes LoggingFoldersLocationsBucketsViewsPatch =
             '[CloudPlatform'FullControl, Logging'Admin]
        requestClient LoggingFoldersLocationsBucketsViewsPatch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingFoldersLocationsBucketsViewsPatchResource)
                      Core.mempty
