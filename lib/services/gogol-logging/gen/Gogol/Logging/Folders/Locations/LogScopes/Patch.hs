...
newLoggingFoldersLocationsLogScopesPatch name payload
  = LoggingFoldersLocationsLogScopesPatch{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          name = name, payload = payload, updateMask = Core.Nothing,
                                          uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest LoggingFoldersLocationsLogScopesPatch
         where
        type Rs LoggingFoldersLocationsLogScopesPatch = LogScope
        type Scopes LoggingFoldersLocationsLogScopesPatch =
             '[CloudPlatform'FullControl, Logging'Admin]
        requestClient LoggingFoldersLocationsLogScopesPatch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingFoldersLocationsLogScopesPatchResource)
                      Core.mempty
