...
newLoggingFoldersLocationsLogScopesList parent
  = LoggingFoldersLocationsLogScopesList{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         pageSize = Core.Nothing, pageToken = Core.Nothing,
                                         parent = parent, uploadType = Core.Nothing,
                                         uploadProtocol = Core.Nothing}
instance Core.GoogleRequest LoggingFoldersLocationsLogScopesList
         where
        ...
        type Scopes LoggingFoldersLocationsLogScopesList =
             '[CloudPlatform'FullControl, CloudPlatform'ReadOnly, Logging'Admin,
               Logging'Read]
        requestClient LoggingFoldersLocationsLogScopesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingFoldersLocationsLogScopesListResource)
                      Core.mempty
