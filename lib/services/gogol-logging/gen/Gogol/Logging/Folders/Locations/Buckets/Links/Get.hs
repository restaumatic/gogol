...
newLoggingFoldersLocationsBucketsLinksGet name
  = LoggingFoldersLocationsBucketsLinksGet{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           name = name, uploadType = Core.Nothing,
                                           uploadProtocol = Core.Nothing}
instance Core.GoogleRequest LoggingFoldersLocationsBucketsLinksGet
         where
        ...
        type Scopes LoggingFoldersLocationsBucketsLinksGet =
             '[CloudPlatform'FullControl, CloudPlatform'ReadOnly, Logging'Admin,
               Logging'Read]
        requestClient LoggingFoldersLocationsBucketsLinksGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingFoldersLocationsBucketsLinksGetResource)
                      Core.mempty
