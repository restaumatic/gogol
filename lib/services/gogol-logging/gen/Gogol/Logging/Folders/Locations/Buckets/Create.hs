...
newLoggingFoldersLocationsBucketsCreate parent payload
  = LoggingFoldersLocationsBucketsCreate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest LoggingFoldersLocationsBucketsCreate
         where
        type Rs LoggingFoldersLocationsBucketsCreate = LogBucket
        type Scopes LoggingFoldersLocationsBucketsCreate =
             '[CloudPlatform'FullControl, Logging'Admin]
        requestClient LoggingFoldersLocationsBucketsCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingFoldersLocationsBucketsCreateResource)
                      Core.mempty
