...
newLoggingFoldersLocationsBucketsViewsGet name
  = LoggingFoldersLocationsBucketsViewsGet{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           name = name, uploadType = Core.Nothing,
                                           uploadProtocol = Core.Nothing}
instance Core.GoogleRequest LoggingFoldersLocationsBucketsViewsGet
         where
        type Rs LoggingFoldersLocationsBucketsViewsGet = LogView
        type Scopes LoggingFoldersLocationsBucketsViewsGet =
             '[CloudPlatform'FullControl, CloudPlatform'ReadOnly, Logging'Admin,
               Logging'Read]
        requestClient LoggingFoldersLocationsBucketsViewsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingFoldersLocationsBucketsViewsGetResource)
                      Core.mempty
