...
newLoggingFoldersLocationsBucketsUpdateAsync name payload
  = LoggingFoldersLocationsBucketsUpdateAsync{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           LoggingFoldersLocationsBucketsUpdateAsync
         where
        type Rs LoggingFoldersLocationsBucketsUpdateAsync = Operation
        type Scopes LoggingFoldersLocationsBucketsUpdateAsync =
             '[CloudPlatform'FullControl, Logging'Admin]
        requestClient LoggingFoldersLocationsBucketsUpdateAsync{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingFoldersLocationsBucketsUpdateAsyncResource)
                      Core.mempty
