...
-- |
-- Module      : Gogol.Logging.Folders.Locations.RecentQueries.List
...
--
-- /See:/ <https://cloud.google.com/logging/docs/ Cloud Logging API Reference> for @logging.folders.locations.recentQueries.list@.
module Gogol.Logging.Folders.Locations.RecentQueries.List
    (
    -- * Resource
...
-- | A resource alias for @logging.folders.locations.recentQueries.list@ method which the
-- 'LoggingFoldersLocationsRecentQueriesList' request conforms to.
type LoggingFoldersLocationsRecentQueriesListResource =
     "v2" Core.:>
...
-- | Lists the RecentQueries that were created by the user making the request.
--
-- /See:/ 'newLoggingFoldersLocationsRecentQueriesList' smart constructor.
data LoggingFoldersLocationsRecentQueriesList = LoggingFoldersLocationsRecentQueriesList
    {
      -- | V1 error format.
...
-- | Creates a value of 'LoggingFoldersLocationsRecentQueriesList' with the minimum fields required to make a request.
newLoggingFoldersLocationsRecentQueriesList 
    :: 
                                            Core.Text
    ...
    -> LoggingFoldersLocationsRecentQueriesList
newLoggingFoldersLocationsRecentQueriesList parent
  = LoggingFoldersLocationsRecentQueriesList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           LoggingFoldersLocationsRecentQueriesList
         where
        type Rs LoggingFoldersLocationsRecentQueriesList =
             ListRecentQueriesResponse
        type Scopes LoggingFoldersLocationsRecentQueriesList =
             '[CloudPlatform'FullControl, CloudPlatform'ReadOnly, Logging'Admin,
               Logging'Read]
        requestClient LoggingFoldersLocationsRecentQueriesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingFoldersLocationsRecentQueriesListResource)
                      Core.mempty
