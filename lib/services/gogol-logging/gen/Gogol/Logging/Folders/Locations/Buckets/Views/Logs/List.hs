...
newLoggingFoldersLocationsBucketsViewsLogsList parent
  = LoggingFoldersLocationsBucketsViewsLogsList{xgafv = Core.Nothing,
                                                accessToken = Core.Nothing, callback = Core.Nothing,
                                                pageSize = Core.Nothing, pageToken = Core.Nothing,
                                                parent = parent, resourceNames = Core.Nothing,
                                                uploadType = Core.Nothing,
                                                uploadProtocol = Core.Nothing}
instance Core.GoogleRequest
           LoggingFoldersLocationsBucketsViewsLogsList
         where
        type Rs LoggingFoldersLocationsBucketsViewsLogsList =
             ListLogsResponse
        type Scopes LoggingFoldersLocationsBucketsViewsLogsList =
             '[CloudPlatform'FullControl, CloudPlatform'ReadOnly, Logging'Admin,
               Logging'Read]
        requestClient LoggingFoldersLocationsBucketsViewsLogsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingFoldersLocationsBucketsViewsLogsListResource)
                      Core.mempty
