...
newLoggingFoldersLocationsBucketsLinksCreate parent payload
  = LoggingFoldersLocationsBucketsLinksCreate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           LoggingFoldersLocationsBucketsLinksCreate
         where
        type Rs LoggingFoldersLocationsBucketsLinksCreate = Operation
        type Scopes LoggingFoldersLocationsBucketsLinksCreate =
             '[CloudPlatform'FullControl, Logging'Admin]
        requestClient LoggingFoldersLocationsBucketsLinksCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingFoldersLocationsBucketsLinksCreateResource)
                      Core.mempty
