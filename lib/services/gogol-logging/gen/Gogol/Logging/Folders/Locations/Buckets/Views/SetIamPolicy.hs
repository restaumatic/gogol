...
newLoggingFoldersLocationsBucketsViewsSetIamPolicy payload resource
  = LoggingFoldersLocationsBucketsViewsSetIamPolicy{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           LoggingFoldersLocationsBucketsViewsSetIamPolicy
         where
        type Rs LoggingFoldersLocationsBucketsViewsSetIamPolicy = Policy
        type Scopes LoggingFoldersLocationsBucketsViewsSetIamPolicy =
             '[CloudPlatform'FullControl, Logging'Admin]
        requestClient LoggingFoldersLocationsBucketsViewsSetIamPolicy{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingFoldersLocationsBucketsViewsSetIamPolicyResource)
                      Core.mempty
