...
newLoggingFoldersLocationsOperationsCancel name payload
  = LoggingFoldersLocationsOperationsCancel{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            name = name, payload = payload,
                                            uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest LoggingFoldersLocationsOperationsCancel
         where
        type Rs LoggingFoldersLocationsOperationsCancel = Empty
        type Scopes LoggingFoldersLocationsOperationsCancel =
             '[CloudPlatform'FullControl, Logging'Admin]
        requestClient LoggingFoldersLocationsOperationsCancel{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingFoldersLocationsOperationsCancelResource)
                      Core.mempty
