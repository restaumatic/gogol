...
newLoggingFoldersLocationsBucketsLinksList parent
  = LoggingFoldersLocationsBucketsLinksList{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            pageSize = Core.Nothing, pageToken = Core.Nothing,
                                            parent = parent, uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest LoggingFoldersLocationsBucketsLinksList
         where
        type Rs LoggingFoldersLocationsBucketsLinksList = ListLinksResponse
        type Scopes LoggingFoldersLocationsBucketsLinksList =
             '[CloudPlatform'FullControl, CloudPlatform'ReadOnly, Logging'Admin,
               Logging'Read]
        requestClient LoggingFoldersLocationsBucketsLinksList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingFoldersLocationsBucketsLinksListResource)
                      Core.mempty
