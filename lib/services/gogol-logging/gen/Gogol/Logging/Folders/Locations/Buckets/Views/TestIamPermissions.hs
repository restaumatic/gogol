...
newLoggingFoldersLocationsBucketsViewsTestIamPermissions 
    ...
    -> LoggingFoldersLocationsBucketsViewsTestIamPermissions
newLoggingFoldersLocationsBucketsViewsTestIamPermissions payload
  resource
  = LoggingFoldersLocationsBucketsViewsTestIamPermissions{xgafv =
                                                            Core.Nothing,
...
instance Core.GoogleRequest
           LoggingFoldersLocationsBucketsViewsTestIamPermissions
         where
        type Rs LoggingFoldersLocationsBucketsViewsTestIamPermissions =
             TestIamPermissionsResponse
        type Scopes LoggingFoldersLocationsBucketsViewsTestIamPermissions =
