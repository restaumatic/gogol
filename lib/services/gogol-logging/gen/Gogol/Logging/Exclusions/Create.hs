...
newLoggingExclusionsCreate parent payload
  = LoggingExclusionsCreate{xgafv = Core.Nothing,
                            accessToken = Core.Nothing, callback = Core.Nothing,
                            parent = parent, payload = payload, uploadType = Core.Nothing,
                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest LoggingExclusionsCreate where
        ...
        requestClient LoggingExclusionsCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy LoggingExclusionsCreateResource)
                      Core.mempty
