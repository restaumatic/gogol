...
newLoggingOrganizationsSinksGet sinkName
  = LoggingOrganizationsSinksGet{xgafv = Core.Nothing,
                                 accessToken = Core.Nothing, callback = Core.Nothing,
                                 sinkName = sinkName, uploadType = Core.Nothing,
                                 uploadProtocol = Core.Nothing}
instance Core.GoogleRequest LoggingOrganizationsSinksGet where
        type Rs LoggingOrganizationsSinksGet = LogSink
        type Scopes LoggingOrganizationsSinksGet =
        ...
        requestClient LoggingOrganizationsSinksGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy LoggingOrganizationsSinksGetResource)
                      Core.mempty
