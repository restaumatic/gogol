...
newLoggingOrganizationsSinksUpdate payload sinkName
  = LoggingOrganizationsSinksUpdate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest LoggingOrganizationsSinksUpdate where
        ...
        requestClient LoggingOrganizationsSinksUpdate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy LoggingOrganizationsSinksUpdateResource)
                      Core.mempty
