...
newLoggingOrganizationsSinksList parent
  = LoggingOrganizationsSinksList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest LoggingOrganizationsSinksList where
        type Rs LoggingOrganizationsSinksList = ListSinksResponse
        ...
        requestClient LoggingOrganizationsSinksList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy LoggingOrganizationsSinksListResource)
                      Core.mempty
