...
newLoggingOrganizationsSinksPatch payload sinkName
  = LoggingOrganizationsSinksPatch{xgafv = Core.Nothing,
...
instance Core.GoogleRequest LoggingOrganizationsSinksPatch where
        ...
        requestClient LoggingOrganizationsSinksPatch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy LoggingOrganizationsSinksPatchResource)
                      Core.mempty
