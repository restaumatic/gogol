...
newLoggingOrganizationsSinksCreate parent payload
  = LoggingOrganizationsSinksCreate{xgafv = Core.Nothing,
                                    accessToken = Core.Nothing, callback = Core.Nothing,
                                    customWriterIdentity = Core.Nothing, parent = parent,
                                    payload = payload, uniqueWriterIdentity = Core.Nothing,
                                    uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest LoggingOrganizationsSinksCreate where
        ...
        requestClient LoggingOrganizationsSinksCreate{..}
          = go parent xgafv accessToken callback customWriterIdentity
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy LoggingOrganizationsSinksCreateResource)
                      Core.mempty
