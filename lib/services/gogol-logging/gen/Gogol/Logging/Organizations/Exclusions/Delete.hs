...
newLoggingOrganizationsExclusionsDelete name
  = LoggingOrganizationsExclusionsDelete{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         name = name, uploadType = Core.Nothing,
                                         uploadProtocol = Core.Nothing}
instance Core.GoogleRequest LoggingOrganizationsExclusionsDelete
         where
        type Rs LoggingOrganizationsExclusionsDelete = Empty
        type Scopes LoggingOrganizationsExclusionsDelete =
