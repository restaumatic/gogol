...
newLoggingOrganizationsExclusionsList parent
  = LoggingOrganizationsExclusionsList{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       pageSize = Core.Nothing, pageToken = Core.Nothing,
                                       parent = parent, uploadType = Core.Nothing,
                                       uploadProtocol = Core.Nothing}
instance Core.GoogleRequest LoggingOrganizationsExclusionsList
         where
        type Rs LoggingOrganizationsExclusionsList = ListExclusionsResponse
        type Scopes LoggingOrganizationsExclusionsList =
        ...
        requestClient LoggingOrganizationsExclusionsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingOrganizationsExclusionsListResource)
                      Core.mempty
