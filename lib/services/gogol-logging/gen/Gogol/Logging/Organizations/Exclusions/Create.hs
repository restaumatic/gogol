...
newLoggingOrganizationsExclusionsCreate parent payload
  = LoggingOrganizationsExclusionsCreate{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         parent = parent, payload = payload,
                                         uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest LoggingOrganizationsExclusionsCreate
         where
        type Rs LoggingOrganizationsExclusionsCreate = LogExclusion
        type Scopes LoggingOrganizationsExclusionsCreate =
             '[CloudPlatform'FullControl, Logging'Admin]
        requestClient LoggingOrganizationsExclusionsCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingOrganizationsExclusionsCreateResource)
                      Core.mempty
