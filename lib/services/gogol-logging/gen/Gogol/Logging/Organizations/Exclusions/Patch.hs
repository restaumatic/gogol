...
newLoggingOrganizationsExclusionsPatch name payload
  = LoggingOrganizationsExclusionsPatch{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        name = name, payload = payload, updateMask = Core.Nothing,
                                        uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest LoggingOrganizationsExclusionsPatch
         where
        type Rs LoggingOrganizationsExclusionsPatch = LogExclusion
        ...
        requestClient LoggingOrganizationsExclusionsPatch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingOrganizationsExclusionsPatchResource)
                      Core.mempty
