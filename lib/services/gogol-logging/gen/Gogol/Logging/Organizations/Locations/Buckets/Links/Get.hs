...
newLoggingOrganizationsLocationsBucketsLinksGet name
  = LoggingOrganizationsLocationsBucketsLinksGet{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
           LoggingOrganizationsLocationsBucketsLinksGet
         where
        type Rs LoggingOrganizationsLocationsBucketsLinksGet = Link
        type Scopes LoggingOrganizationsLocationsBucketsLinksGet =
             '[CloudPlatform'FullControl, CloudPlatform'ReadOnly, Logging'Admin,
               Logging'Read]
        requestClient LoggingOrganizationsLocationsBucketsLinksGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingOrganizationsLocationsBucketsLinksGetResource)
                      Core.mempty
