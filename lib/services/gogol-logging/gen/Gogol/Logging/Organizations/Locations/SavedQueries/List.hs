...
-- |
-- Module      : Gogol.Logging.Organizations.Locations.SavedQueries.List
...
--
-- /See:/ <https://cloud.google.com/logging/docs/ Cloud Logging API Reference> for @logging.organizations.locations.savedQueries.list@.
module Gogol.Logging.Organizations.Locations.SavedQueries.List
    (
    -- * Resource
...
-- | A resource alias for @logging.organizations.locations.savedQueries.list@ method which the
-- 'LoggingOrganizationsLocationsSavedQueriesList' request conforms to.
type LoggingOrganizationsLocationsSavedQueriesListResource =
     "v2" Core.:>
...
-- | Lists the SavedQueries that were created by the user making the request.
--
-- /See:/ 'newLoggingOrganizationsLocationsSavedQueriesList' smart constructor.
data LoggingOrganizationsLocationsSavedQueriesList = LoggingOrganizationsLocationsSavedQueriesList
    {
      -- | V1 error format.
...
-- | Creates a value of 'LoggingOrganizationsLocationsSavedQueriesList' with the minimum fields required to make a request.
newLoggingOrganizationsLocationsSavedQueriesList 
    :: 
                                                 Core.Text
       -- ^  Required. The resource to which the listed queries belong. \"projects\/[PROJECT/ID]\/locations\/[LOCATION/ID]\" \"organizations\/[ORGANIZATION/ID]\/locations\/[LOCATION/ID]\" \"billingAccounts\/[BILLING/ACCOUNT/ID]\/locations\/[LOCATION/ID]\" \"folders\/[FOLDER/ID]\/locations\/[LOCATION/ID]\" For example: \"projects\/my-project\/locations\/us-central1\" Note: The locations portion of the resource must be specified. To get a list of all saved queries, a wildcard character - can be used for LOCATION/ID, for example: \"projects\/my-project\/locations\/-\" See 'parent'.
    -> LoggingOrganizationsLocationsSavedQueriesList
newLoggingOrganizationsLocationsSavedQueriesList parent
  = LoggingOrganizationsLocationsSavedQueriesList{xgafv =
                                                    Core.Nothing,
...
instance Core.GoogleRequest
           LoggingOrganizationsLocationsSavedQueriesList
         where
        type Rs LoggingOrganizationsLocationsSavedQueriesList =
             ListSavedQueriesResponse
        type Scopes LoggingOrganizationsLocationsSavedQueriesList =
             '[CloudPlatform'FullControl, CloudPlatform'ReadOnly, Logging'Admin,
               Logging'Read]
        requestClient LoggingOrganizationsLocationsSavedQueriesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingOrganizationsLocationsSavedQueriesListResource)
                      Core.mempty
