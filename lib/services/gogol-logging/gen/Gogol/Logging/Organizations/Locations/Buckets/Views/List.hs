...
newLoggingOrganizationsLocationsBucketsViewsList parent
  = LoggingOrganizationsLocationsBucketsViewsList{xgafv =
                                                    Core.Nothing,
...
instance Core.GoogleRequest
           LoggingOrganizationsLocationsBucketsViewsList
         where
        type Rs LoggingOrganizationsLocationsBucketsViewsList =
             ListViewsResponse
        type Scopes LoggingOrganizationsLocationsBucketsViewsList =
             '[CloudPlatform'FullControl, CloudPlatform'ReadOnly, Logging'Admin,
               Logging'Read]
        requestClient LoggingOrganizationsLocationsBucketsViewsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingOrganizationsLocationsBucketsViewsListResource)
                      Core.mempty
