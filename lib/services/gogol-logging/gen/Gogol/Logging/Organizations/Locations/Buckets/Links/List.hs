...
newLoggingOrganizationsLocationsBucketsLinksList parent
  = LoggingOrganizationsLocationsBucketsLinksList{xgafv =
                                                    Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Rs LoggingOrganizationsLocationsBucketsLinksList =
             ListLinksResponse
        type Scopes LoggingOrganizationsLocationsBucketsLinksList =
             '[CloudPlatform'FullControl, CloudPlatform'ReadOnly, Logging'Admin,
               Logging'Read]
        requestClient LoggingOrganizationsLocationsBucketsLinksList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingOrganizationsLocationsBucketsLinksListResource)
                      Core.mempty
