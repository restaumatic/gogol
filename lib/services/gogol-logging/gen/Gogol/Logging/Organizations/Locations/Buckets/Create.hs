...
newLoggingOrganizationsLocationsBucketsCreate parent payload
  = LoggingOrganizationsLocationsBucketsCreate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           LoggingOrganizationsLocationsBucketsCreate
         where
        type Rs LoggingOrganizationsLocationsBucketsCreate = LogBucket
        type Scopes LoggingOrganizationsLocationsBucketsCreate =
             '[CloudPlatform'FullControl, Logging'Admin]
        requestClient LoggingOrganizationsLocationsBucketsCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingOrganizationsLocationsBucketsCreateResource)
                      Core.mempty
