...
-- |
-- Module      : Gogol.Logging.Organizations.Locations.Buckets.Views.Logs.List
...
--
-- /See:/ <https://cloud.google.com/logging/docs/ Cloud Logging API Reference> for @logging.organizations.locations.buckets.views.logs.list@.
module Gogol.Logging.Organizations.Locations.Buckets.Views.Logs.List
    (
    -- * Resource
...
-- | A resource alias for @logging.organizations.locations.buckets.views.logs.list@ method which the
-- 'LoggingOrganizationsLocationsBucketsViewsLogsList' request conforms to.
type LoggingOrganizationsLocationsBucketsViewsLogsListResource =
     "v2" Core.:>
...
-- | Lists the logs in projects, organizations, folders, or billing accounts. Only logs that have entries are listed.
--
-- /See:/ 'newLoggingOrganizationsLocationsBucketsViewsLogsList' smart constructor.
data LoggingOrganizationsLocationsBucketsViewsLogsList = LoggingOrganizationsLocationsBucketsViewsLogsList
    {
      -- | V1 error format.
...
-- | Creates a value of 'LoggingOrganizationsLocationsBucketsViewsLogsList' with the minimum fields required to make a request.
newLoggingOrganizationsLocationsBucketsViewsLogsList 
    :: 
                                                     Core.Text
    ...
    -> LoggingOrganizationsLocationsBucketsViewsLogsList
newLoggingOrganizationsLocationsBucketsViewsLogsList parent
  = LoggingOrganizationsLocationsBucketsViewsLogsList{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           LoggingOrganizationsLocationsBucketsViewsLogsList
         where
        type Rs LoggingOrganizationsLocationsBucketsViewsLogsList =
             ListLogsResponse
        type Scopes LoggingOrganizationsLocationsBucketsViewsLogsList =
             '[CloudPlatform'FullControl, CloudPlatform'ReadOnly, Logging'Admin,
               Logging'Read]
        requestClient LoggingOrganizationsLocationsBucketsViewsLogsList{..}
