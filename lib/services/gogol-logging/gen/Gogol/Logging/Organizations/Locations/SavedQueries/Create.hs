...
newLoggingOrganizationsLocationsSavedQueriesCreate parent payload
  = LoggingOrganizationsLocationsSavedQueriesCreate{xgafv =
                                                      Core.Nothing,
                                                    accessToken = Core.Nothing,
                                                    callback = Core.Nothing, parent = parent,
                                                    payload = payload, savedQueryId = Core.Nothing,
                                                    uploadType = Core.Nothing,
                                                    uploadProtocol = Core.Nothing}
instance Core.GoogleRequest
           LoggingOrganizationsLocationsSavedQueriesCreate
         where
        type Rs LoggingOrganizationsLocationsSavedQueriesCreate =
             SavedQuery
        type Scopes LoggingOrganizationsLocationsSavedQueriesCreate =
