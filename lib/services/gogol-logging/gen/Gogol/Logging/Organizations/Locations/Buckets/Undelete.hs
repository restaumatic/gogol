...
newLoggingOrganizationsLocationsBucketsUndelete name payload
  = LoggingOrganizationsLocationsBucketsUndelete{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
           LoggingOrganizationsLocationsBucketsUndelete
         where
        type Rs LoggingOrganizationsLocationsBucketsUndelete = Empty
        type Scopes LoggingOrganizationsLocationsBucketsUndelete =
             '[CloudPlatform'FullControl, Logging'Admin]
        requestClient LoggingOrganizationsLocationsBucketsUndelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingOrganizationsLocationsBucketsUndeleteResource)
                      Core.mempty
