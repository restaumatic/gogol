...
newLoggingOrganizationsLocationsBucketsGet name
  = LoggingOrganizationsLocationsBucketsGet{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            name = name, uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest LoggingOrganizationsLocationsBucketsGet
         where
        type Rs LoggingOrganizationsLocationsBucketsGet = LogBucket
        type Scopes LoggingOrganizationsLocationsBucketsGet =
             '[CloudPlatform'FullControl, CloudPlatform'ReadOnly, Logging'Admin,
               Logging'Read]
        requestClient LoggingOrganizationsLocationsBucketsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingOrganizationsLocationsBucketsGetResource)
                      Core.mempty
