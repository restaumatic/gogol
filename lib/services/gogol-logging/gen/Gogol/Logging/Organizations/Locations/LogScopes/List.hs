...
newLoggingOrganizationsLocationsLogScopesList parent
  = LoggingOrganizationsLocationsLogScopesList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes LoggingOrganizationsLocationsLogScopesList =
             '[CloudPlatform'FullControl, CloudPlatform'ReadOnly, Logging'Admin,
               Logging'Read]
        requestClient LoggingOrganizationsLocationsLogScopesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingOrganizationsLocationsLogScopesListResource)
                      Core.mempty
