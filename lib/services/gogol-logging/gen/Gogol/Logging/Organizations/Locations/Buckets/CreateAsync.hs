...
newLoggingOrganizationsLocationsBucketsCreateAsync parent payload
  = LoggingOrganizationsLocationsBucketsCreateAsync{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           LoggingOrganizationsLocationsBucketsCreateAsync
         where
        type Rs LoggingOrganizationsLocationsBucketsCreateAsync = Operation
        type Scopes LoggingOrganizationsLocationsBucketsCreateAsync =
             '[CloudPlatform'FullControl, Logging'Admin]
        requestClient LoggingOrganizationsLocationsBucketsCreateAsync{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingOrganizationsLocationsBucketsCreateAsyncResource)
                      Core.mempty
