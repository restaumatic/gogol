...
-- |
-- Module      : Gogol.Logging.Organizations.Locations.RecentQueries.List
...
--
-- /See:/ <https://cloud.google.com/logging/docs/ Cloud Logging API Reference> for @logging.organizations.locations.recentQueries.list@.
module Gogol.Logging.Organizations.Locations.RecentQueries.List
    (
    -- * Resource
...
-- | A resource alias for @logging.organizations.locations.recentQueries.list@ method which the
-- 'LoggingOrganizationsLocationsRecentQueriesList' request conforms to.
type LoggingOrganizationsLocationsRecentQueriesListResource =
     "v2" Core.:>
...
-- | Lists the RecentQueries that were created by the user making the request.
--
-- /See:/ 'newLoggingOrganizationsLocationsRecentQueriesList' smart constructor.
data LoggingOrganizationsLocationsRecentQueriesList = LoggingOrganizationsLocationsRecentQueriesList
    {
      -- | V1 error format.
...
-- | Creates a value of 'LoggingOrganizationsLocationsRecentQueriesList' with the minimum fields required to make a request.
newLoggingOrganizationsLocationsRecentQueriesList 
    :: 
                                                  Core.Text
    ...
    -> LoggingOrganizationsLocationsRecentQueriesList
newLoggingOrganizationsLocationsRecentQueriesList parent
  = LoggingOrganizationsLocationsRecentQueriesList{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           LoggingOrganizationsLocationsRecentQueriesList
         where
        type Rs LoggingOrganizationsLocationsRecentQueriesList =
             ListRecentQueriesResponse
        type Scopes LoggingOrganizationsLocationsRecentQueriesList =
             '[CloudPlatform'FullControl, CloudPlatform'ReadOnly, Logging'Admin,
               Logging'Read]
        requestClient LoggingOrganizationsLocationsRecentQueriesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingOrganizationsLocationsRecentQueriesListResource)
                      Core.mempty
