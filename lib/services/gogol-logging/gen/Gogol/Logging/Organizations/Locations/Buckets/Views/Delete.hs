...
newLoggingOrganizationsLocationsBucketsViewsDelete name
  = LoggingOrganizationsLocationsBucketsViewsDelete{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           LoggingOrganizationsLocationsBucketsViewsDelete
         where
        type Rs LoggingOrganizationsLocationsBucketsViewsDelete = Empty
        type Scopes LoggingOrganizationsLocationsBucketsViewsDelete =
             '[CloudPlatform'FullControl, Logging'Admin]
        requestClient LoggingOrganizationsLocationsBucketsViewsDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingOrganizationsLocationsBucketsViewsDeleteResource)
                      Core.mempty
