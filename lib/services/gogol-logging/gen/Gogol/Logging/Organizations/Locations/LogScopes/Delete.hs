...
data LoggingOrganizationsLocationsLogScopesDelete = LoggingOrganizationsLocationsLogScopesDelete
    ...
    , callback :: (Core.Maybe Core.Text)
      -- | Required. The resource name of the log scope to delete: \"projects\/[PROJECT/ID]\/locations\/[LOCATION/ID]\" \"organizations\/[ORGANIZATION/ID]\/locations\/[LOCATION/ID]\" \"folders\/[FOLDER/ID]\/locations\/[LOCATION/ID]\" For example:\"projects\/my-project\/locations\/global\/logScopes\/my-log-scope\"
    , name :: Core.Text
...
newLoggingOrganizationsLocationsLogScopesDelete 
    :: 
                                                Core.Text
       -- ^  Required. The resource name of the log scope to delete: \"projects\/[PROJECT/ID]\/locations\/[LOCATION/ID]\" \"organizations\/[ORGANIZATION/ID]\/locations\/[LOCATION/ID]\" \"folders\/[FOLDER/ID]\/locations\/[LOCATION/ID]\" For example:\"projects\/my-project\/locations\/global\/logScopes\/my-log-scope\" See 'name'.
    -> LoggingOrganizationsLocationsLogScopesDelete
