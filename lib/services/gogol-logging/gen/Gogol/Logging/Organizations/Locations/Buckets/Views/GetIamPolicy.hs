...
newLoggingOrganizationsLocationsBucketsViewsGetIamPolicy 
    ...
    -> LoggingOrganizationsLocationsBucketsViewsGetIamPolicy
newLoggingOrganizationsLocationsBucketsViewsGetIamPolicy payload
  resource
  = LoggingOrganizationsLocationsBucketsViewsGetIamPolicy{xgafv =
                                                            Core.Nothing,
...
instance Core.GoogleRequest
           LoggingOrganizationsLocationsBucketsViewsGetIamPolicy
         where
        type Rs LoggingOrganizationsLocationsBucketsViewsGetIamPolicy =
             Policy
        type Scopes LoggingOrganizationsLocationsBucketsViewsGetIamPolicy =
