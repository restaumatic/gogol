...
newLoggingOrganizationsLocationsBucketsLinksCreate parent payload
  = LoggingOrganizationsLocationsBucketsLinksCreate{xgafv =
                                                      Core.Nothing,
                                                    accessToken = Core.Nothing,
                                                    callback = Core.Nothing, linkId = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes LoggingOrganizationsLocationsBucketsLinksCreate =
