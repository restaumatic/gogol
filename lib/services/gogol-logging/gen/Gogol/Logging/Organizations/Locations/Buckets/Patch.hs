...
-- |
-- Module      : Gogol.Logging.Organizations.Locations.Buckets.Patch
...
-- 'LoggingOrganizationsLocationsBucketsPatch' request conforms to.
type LoggingOrganizationsLocationsBucketsPatchResource =
     "v2" Core.:>
...
-- | Updates a log bucket.If the bucket has a lifecycle/state of DELETE/REQUESTED, then FAILED_PRECONDITION will be returned.After a bucket has been created, the bucket\'s location cannot be changed.
--
-- /See:/ 'newLoggingOrganizationsLocationsBucketsPatch' smart constructor.
data LoggingOrganizationsLocationsBucketsPatch = LoggingOrganizationsLocationsBucketsPatch
    {
      -- | V1 error format.
...
-- | Creates a value of 'LoggingOrganizationsLocationsBucketsPatch' with the minimum fields required to make a request.
newLoggingOrganizationsLocationsBucketsPatch 
    :: 
                                             Core.Text
    ...
    -> LoggingOrganizationsLocationsBucketsPatch
newLoggingOrganizationsLocationsBucketsPatch name payload
  = LoggingOrganizationsLocationsBucketsPatch{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           LoggingOrganizationsLocationsBucketsPatch
         where
        type Rs LoggingOrganizationsLocationsBucketsPatch = LogBucket
        type Scopes LoggingOrganizationsLocationsBucketsPatch =
             '[CloudPlatform'FullControl, Logging'Admin]
        requestClient LoggingOrganizationsLocationsBucketsPatch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingOrganizationsLocationsBucketsPatchResource)
                      Core.mempty
