...
newLoggingOrganizationsLocationsOperationsList name
  = LoggingOrganizationsLocationsOperationsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes LoggingOrganizationsLocationsOperationsList =
             '[CloudPlatform'FullControl, CloudPlatform'ReadOnly, Logging'Admin,
               Logging'Read]
        requestClient LoggingOrganizationsLocationsOperationsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingOrganizationsLocationsOperationsListResource)
                      Core.mempty
