...
-- |
-- Module      : Gogol.Logging.Organizations.Locations.SavedQueries.Patch
...
--
-- /See:/ <https://cloud.google.com/logging/docs/ Cloud Logging API Reference> for @logging.organizations.locations.savedQueries.patch@.
module Gogol.Logging.Organizations.Locations.SavedQueries.Patch
    (
    -- * Resource
...
-- | A resource alias for @logging.organizations.locations.savedQueries.patch@ method which the
-- 'LoggingOrganizationsLocationsSavedQueriesPatch' request conforms to.
type LoggingOrganizationsLocationsSavedQueriesPatchResource =
     "v2" Core.:>
...
-- | Updates an existing SavedQuery.
--
-- /See:/ 'newLoggingOrganizationsLocationsSavedQueriesPatch' smart constructor.
data LoggingOrganizationsLocationsSavedQueriesPatch = LoggingOrganizationsLocationsSavedQueriesPatch
    {
      -- | V1 error format.
...
-- | Creates a value of 'LoggingOrganizationsLocationsSavedQueriesPatch' with the minimum fields required to make a request.
newLoggingOrganizationsLocationsSavedQueriesPatch 
    :: 
                                                  Core.Text
    ...
    -> LoggingOrganizationsLocationsSavedQueriesPatch
newLoggingOrganizationsLocationsSavedQueriesPatch name payload
  = LoggingOrganizationsLocationsSavedQueriesPatch{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           LoggingOrganizationsLocationsSavedQueriesPatch
         where
        type Rs LoggingOrganizationsLocationsSavedQueriesPatch = SavedQuery
        type Scopes LoggingOrganizationsLocationsSavedQueriesPatch =
             '[CloudPlatform'FullControl, Logging'Admin]
        requestClient LoggingOrganizationsLocationsSavedQueriesPatch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingOrganizationsLocationsSavedQueriesPatchResource)
                      Core.mempty
