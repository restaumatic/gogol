...
newLoggingOrganizationsLocationsBucketsList parent
  = LoggingOrganizationsLocationsBucketsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes LoggingOrganizationsLocationsBucketsList =
             '[CloudPlatform'FullControl, CloudPlatform'ReadOnly, Logging'Admin,
               Logging'Read]
        requestClient LoggingOrganizationsLocationsBucketsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingOrganizationsLocationsBucketsListResource)
                      Core.mempty
