...
newLoggingOrganizationsLocationsBucketsViewsSetIamPolicy 
    ...
    -> LoggingOrganizationsLocationsBucketsViewsSetIamPolicy
newLoggingOrganizationsLocationsBucketsViewsSetIamPolicy payload
  resource
  = LoggingOrganizationsLocationsBucketsViewsSetIamPolicy{xgafv =
                                                            Core.Nothing,
...
instance Core.GoogleRequest
           LoggingOrganizationsLocationsBucketsViewsSetIamPolicy
         where
        type Rs LoggingOrganizationsLocationsBucketsViewsSetIamPolicy =
             Policy
        type Scopes LoggingOrganizationsLocationsBucketsViewsSetIamPolicy =
