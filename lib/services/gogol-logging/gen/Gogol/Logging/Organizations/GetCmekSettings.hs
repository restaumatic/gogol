...
newLoggingOrganizationsGetCmekSettings name
  = LoggingOrganizationsGetCmekSettings{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        name = name, uploadType = Core.Nothing,
                                        uploadProtocol = Core.Nothing}
instance Core.GoogleRequest LoggingOrganizationsGetCmekSettings
         where
        type Rs LoggingOrganizationsGetCmekSettings = CmekSettings
        ...
        requestClient LoggingOrganizationsGetCmekSettings{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingOrganizationsGetCmekSettingsResource)
                      Core.mempty
