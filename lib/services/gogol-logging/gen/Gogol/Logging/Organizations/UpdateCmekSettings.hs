...
newLoggingOrganizationsUpdateCmekSettings name payload
  = LoggingOrganizationsUpdateCmekSettings{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           name = name, payload = payload,
                                           updateMask = Core.Nothing, uploadType = Core.Nothing,
                                           uploadProtocol = Core.Nothing}
instance Core.GoogleRequest LoggingOrganizationsUpdateCmekSettings
         where
        type Rs LoggingOrganizationsUpdateCmekSettings = CmekSettings
        type Scopes LoggingOrganizationsUpdateCmekSettings =
             '[CloudPlatform'FullControl, Logging'Admin]
        requestClient LoggingOrganizationsUpdateCmekSettings{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingOrganizationsUpdateCmekSettingsResource)
                      Core.mempty
