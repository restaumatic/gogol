...
-- |
-- Module      : Gogol.Logging.Projects.Metrics.List
                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] ListLogMetricsResponse
...
newLoggingProjectsMetricsList parent
  = LoggingProjectsMetricsList{xgafv = Core.Nothing,
                               accessToken = Core.Nothing, callback = Core.Nothing,
                               pageSize = Core.Nothing, pageToken = Core.Nothing, parent = parent,
                               uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest LoggingProjectsMetricsList where
        type Rs LoggingProjectsMetricsList = ListLogMetricsResponse
        type Scopes LoggingProjectsMetricsList =
        ...
        requestClient LoggingProjectsMetricsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy LoggingProjectsMetricsListResource)
                      Core.mempty
