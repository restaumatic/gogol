...
newLoggingProjectsMetricsDelete metricName
  = LoggingProjectsMetricsDelete{xgafv = Core.Nothing,
                                 accessToken = Core.Nothing, callback = Core.Nothing,
                                 metricName = metricName, uploadType = Core.Nothing,
                                 uploadProtocol = Core.Nothing}
instance Core.GoogleRequest LoggingProjectsMetricsDelete where
        ...
        requestClient LoggingProjectsMetricsDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy LoggingProjectsMetricsDeleteResource)
                      Core.mempty
