...
newLoggingProjectsSinksUpdate payload sinkName
  = LoggingProjectsSinksUpdate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest LoggingProjectsSinksUpdate where
        ...
        requestClient LoggingProjectsSinksUpdate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy LoggingProjectsSinksUpdateResource)
                      Core.mempty
