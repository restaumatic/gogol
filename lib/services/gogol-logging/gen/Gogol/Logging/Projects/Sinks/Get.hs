...
newLoggingProjectsSinksGet sinkName
  = LoggingProjectsSinksGet{xgafv = Core.Nothing,
                            accessToken = Core.Nothing, callback = Core.Nothing,
                            sinkName = sinkName, uploadType = Core.Nothing,
                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest LoggingProjectsSinksGet where
        ...
        requestClient LoggingProjectsSinksGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy LoggingProjectsSinksGetResource)
                      Core.mempty
