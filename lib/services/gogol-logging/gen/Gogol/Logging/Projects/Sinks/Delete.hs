...
-- |
-- Module      : Gogol.Logging.Projects.Sinks.Delete
...
newLoggingProjectsSinksDelete sinkName
  = LoggingProjectsSinksDelete{xgafv = Core.Nothing,
                               accessToken = Core.Nothing, callback = Core.Nothing,
                               sinkName = sinkName, uploadType = Core.Nothing,
                               uploadProtocol = Core.Nothing}
instance Core.GoogleRequest LoggingProjectsSinksDelete where
        type Rs LoggingProjectsSinksDelete = Empty
        type Scopes LoggingProjectsSinksDelete =
        ...
        requestClient LoggingProjectsSinksDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy LoggingProjectsSinksDeleteResource)
                      Core.mempty
