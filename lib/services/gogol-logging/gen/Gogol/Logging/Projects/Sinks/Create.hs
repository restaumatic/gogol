...
newLoggingProjectsSinksCreate parent payload
  = LoggingProjectsSinksCreate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest LoggingProjectsSinksCreate where
        ...
        requestClient LoggingProjectsSinksCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy LoggingProjectsSinksCreateResource)
                      Core.mempty
