...
newLoggingProjectsExclusionsPatch name payload
  = LoggingProjectsExclusionsPatch{xgafv = Core.Nothing,
...
instance Core.GoogleRequest LoggingProjectsExclusionsPatch where
        type Rs LoggingProjectsExclusionsPatch = LogExclusion
        type Scopes LoggingProjectsExclusionsPatch =
        ...
        requestClient LoggingProjectsExclusionsPatch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy LoggingProjectsExclusionsPatchResource)
                      Core.mempty
