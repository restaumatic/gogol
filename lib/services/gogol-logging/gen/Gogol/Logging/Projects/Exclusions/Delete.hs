...
newLoggingProjectsExclusionsDelete name
  = LoggingProjectsExclusionsDelete{xgafv = Core.Nothing,
                                    accessToken = Core.Nothing, callback = Core.Nothing,
                                    name = name, uploadType = Core.Nothing,
                                    uploadProtocol = Core.Nothing}
instance Core.GoogleRequest LoggingProjectsExclusionsDelete where
        ...
        requestClient LoggingProjectsExclusionsDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy LoggingProjectsExclusionsDeleteResource)
                      Core.mempty
