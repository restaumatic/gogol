...
-- |
-- Module      : Gogol.Logging.Projects.Exclusions.List
                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] ListExclusionsResponse
...
newLoggingProjectsExclusionsList parent
  = LoggingProjectsExclusionsList{xgafv = Core.Nothing,
                                  accessToken = Core.Nothing, callback = Core.Nothing,
                                  pageSize = Core.Nothing, pageToken = Core.Nothing,
                                  parent = parent, uploadType = Core.Nothing,
                                  uploadProtocol = Core.Nothing}
instance Core.GoogleRequest LoggingProjectsExclusionsList where
        type Rs LoggingProjectsExclusionsList = ListExclusionsResponse
        type Scopes LoggingProjectsExclusionsList =
        ...
        requestClient LoggingProjectsExclusionsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy LoggingProjectsExclusionsListResource)
                      Core.mempty
