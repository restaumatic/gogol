...
newLoggingProjectsLocationsBucketsViewsGetIamPolicy 
    ...
    -> LoggingProjectsLocationsBucketsViewsGetIamPolicy
newLoggingProjectsLocationsBucketsViewsGetIamPolicy payload
  resource
  = LoggingProjectsLocationsBucketsViewsGetIamPolicy{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes LoggingProjectsLocationsBucketsViewsGetIamPolicy =
