...
newLoggingProjectsLocationsBucketsViewsList parent
  = LoggingProjectsLocationsBucketsViewsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes LoggingProjectsLocationsBucketsViewsList =
             '[CloudPlatform'FullControl, CloudPlatform'ReadOnly, Logging'Admin,
               Logging'Read]
        requestClient LoggingProjectsLocationsBucketsViewsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingProjectsLocationsBucketsViewsListResource)
                      Core.mempty
