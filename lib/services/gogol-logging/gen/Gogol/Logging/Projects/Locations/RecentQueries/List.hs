...
newLoggingProjectsLocationsRecentQueriesList parent
  = LoggingProjectsLocationsRecentQueriesList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes LoggingProjectsLocationsRecentQueriesList =
             '[CloudPlatform'FullControl, CloudPlatform'ReadOnly, Logging'Admin,
               Logging'Read]
        requestClient LoggingProjectsLocationsRecentQueriesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingProjectsLocationsRecentQueriesListResource)
                      Core.mempty
