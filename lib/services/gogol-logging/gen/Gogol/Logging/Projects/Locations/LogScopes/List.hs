...
newLoggingProjectsLocationsLogScopesList parent
  = LoggingProjectsLocationsLogScopesList{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          pageSize = Core.Nothing, pageToken = Core.Nothing,
                                          parent = parent, uploadType = Core.Nothing,
                                          uploadProtocol = Core.Nothing}
instance Core.GoogleRequest LoggingProjectsLocationsLogScopesList
         where
        type Rs LoggingProjectsLocationsLogScopesList =
             ListLogScopesResponse
        type Scopes LoggingProjectsLocationsLogScopesList =
