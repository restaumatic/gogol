...
newLoggingProjectsLocationsLogScopesPatch name payload
  = LoggingProjectsLocationsLogScopesPatch{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           name = name, payload = payload,
                                           updateMask = Core.Nothing, uploadType = Core.Nothing,
                                           uploadProtocol = Core.Nothing}
instance Core.GoogleRequest LoggingProjectsLocationsLogScopesPatch
         where
        type Rs LoggingProjectsLocationsLogScopesPatch = LogScope
        type Scopes LoggingProjectsLocationsLogScopesPatch =
