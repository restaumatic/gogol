...
newLoggingProjectsLocationsBucketsLinksDelete name
  = LoggingProjectsLocationsBucketsLinksDelete{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           LoggingProjectsLocationsBucketsLinksDelete
         where
        type Rs LoggingProjectsLocationsBucketsLinksDelete = Operation
        type Scopes LoggingProjectsLocationsBucketsLinksDelete =
             '[CloudPlatform'FullControl, Logging'Admin]
        requestClient LoggingProjectsLocationsBucketsLinksDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingProjectsLocationsBucketsLinksDeleteResource)
                      Core.mempty
