               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] UndeleteBucketRequest Core.:>
...
newLoggingProjectsLocationsBucketsUndelete name payload
  = LoggingProjectsLocationsBucketsUndelete{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            name = name, payload = payload,
                                            uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest LoggingProjectsLocationsBucketsUndelete
         where
        type Rs LoggingProjectsLocationsBucketsUndelete = Empty
        type Scopes LoggingProjectsLocationsBucketsUndelete =
             '[CloudPlatform'FullControl, Logging'Admin]
        requestClient LoggingProjectsLocationsBucketsUndelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingProjectsLocationsBucketsUndeleteResource)
                      Core.mempty
