...
newLoggingProjectsLocationsSavedQueriesCreate parent payload
  = LoggingProjectsLocationsSavedQueriesCreate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           LoggingProjectsLocationsSavedQueriesCreate
         where
        type Rs LoggingProjectsLocationsSavedQueriesCreate = SavedQuery
        type Scopes LoggingProjectsLocationsSavedQueriesCreate =
             '[CloudPlatform'FullControl, Logging'Admin]
        requestClient LoggingProjectsLocationsSavedQueriesCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingProjectsLocationsSavedQueriesCreateResource)
                      Core.mempty
