...
newLoggingProjectsLocationsBucketsViewsGet name
  = LoggingProjectsLocationsBucketsViewsGet{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            name = name, uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest LoggingProjectsLocationsBucketsViewsGet
         where
        type Rs LoggingProjectsLocationsBucketsViewsGet = LogView
        type Scopes LoggingProjectsLocationsBucketsViewsGet =
             '[CloudPlatform'FullControl, CloudPlatform'ReadOnly, Logging'Admin,
               Logging'Read]
        requestClient LoggingProjectsLocationsBucketsViewsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingProjectsLocationsBucketsViewsGetResource)
                      Core.mempty
