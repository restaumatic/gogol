...
-- |
-- Module      : Gogol.Logging.Projects.Locations.Buckets.Views.Logs.List
...
--
-- /See:/ <https://cloud.google.com/logging/docs/ Cloud Logging API Reference> for @logging.projects.locations.buckets.views.logs.list@.
module Gogol.Logging.Projects.Locations.Buckets.Views.Logs.List
    (
    -- * Resource
...
-- | A resource alias for @logging.projects.locations.buckets.views.logs.list@ method which the
-- 'LoggingProjectsLocationsBucketsViewsLogsList' request conforms to.
type LoggingProjectsLocationsBucketsViewsLogsListResource =
     "v2" Core.:>
...
-- | Lists the logs in projects, organizations, folders, or billing accounts. Only logs that have entries are listed.
--
-- /See:/ 'newLoggingProjectsLocationsBucketsViewsLogsList' smart constructor.
data LoggingProjectsLocationsBucketsViewsLogsList = LoggingProjectsLocationsBucketsViewsLogsList
    {
      -- | V1 error format.
...
-- | Creates a value of 'LoggingProjectsLocationsBucketsViewsLogsList' with the minimum fields required to make a request.
newLoggingProjectsLocationsBucketsViewsLogsList 
    :: 
                                                Core.Text
    ...
    -> LoggingProjectsLocationsBucketsViewsLogsList
newLoggingProjectsLocationsBucketsViewsLogsList parent
  = LoggingProjectsLocationsBucketsViewsLogsList{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
           LoggingProjectsLocationsBucketsViewsLogsList
         where
        type Rs LoggingProjectsLocationsBucketsViewsLogsList =
             ListLogsResponse
        type Scopes LoggingProjectsLocationsBucketsViewsLogsList =
             '[CloudPlatform'FullControl, CloudPlatform'ReadOnly, Logging'Admin,
               Logging'Read]
        requestClient LoggingProjectsLocationsBucketsViewsLogsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingProjectsLocationsBucketsViewsLogsListResource)
                      Core.mempty
