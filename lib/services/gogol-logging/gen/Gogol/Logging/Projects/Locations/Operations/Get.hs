...
newLoggingProjectsLocationsOperationsGet name
  = LoggingProjectsLocationsOperationsGet{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          name = name, uploadType = Core.Nothing,
                                          uploadProtocol = Core.Nothing}
instance Core.GoogleRequest LoggingProjectsLocationsOperationsGet
         where
        type Rs LoggingProjectsLocationsOperationsGet = Operation
        type Scopes LoggingProjectsLocationsOperationsGet =
             '[CloudPlatform'FullControl, CloudPlatform'ReadOnly, Logging'Admin,
               Logging'Read]
        requestClient LoggingProjectsLocationsOperationsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingProjectsLocationsOperationsGetResource)
                      Core.mempty
