...
newLoggingProjectsLocationsBucketsGet name
  = LoggingProjectsLocationsBucketsGet{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       name = name, uploadType = Core.Nothing,
                                       uploadProtocol = Core.Nothing}
instance Core.GoogleRequest LoggingProjectsLocationsBucketsGet
         where
        type Rs LoggingProjectsLocationsBucketsGet = LogBucket
        type Scopes LoggingProjectsLocationsBucketsGet =
