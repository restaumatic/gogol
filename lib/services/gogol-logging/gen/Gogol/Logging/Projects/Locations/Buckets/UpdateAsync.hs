...
newLoggingProjectsLocationsBucketsUpdateAsync name payload
  = LoggingProjectsLocationsBucketsUpdateAsync{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           LoggingProjectsLocationsBucketsUpdateAsync
         where
        type Rs LoggingProjectsLocationsBucketsUpdateAsync = Operation
        type Scopes LoggingProjectsLocationsBucketsUpdateAsync =
             '[CloudPlatform'FullControl, Logging'Admin]
        requestClient LoggingProjectsLocationsBucketsUpdateAsync{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingProjectsLocationsBucketsUpdateAsyncResource)
                      Core.mempty
