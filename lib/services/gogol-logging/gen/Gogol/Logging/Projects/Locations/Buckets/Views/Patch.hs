...
newLoggingProjectsLocationsBucketsViewsPatch name payload
  = LoggingProjectsLocationsBucketsViewsPatch{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           LoggingProjectsLocationsBucketsViewsPatch
         where
        type Rs LoggingProjectsLocationsBucketsViewsPatch = LogView
        type Scopes LoggingProjectsLocationsBucketsViewsPatch =
             '[CloudPlatform'FullControl, Logging'Admin]
        requestClient LoggingProjectsLocationsBucketsViewsPatch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingProjectsLocationsBucketsViewsPatchResource)
                      Core.mempty
