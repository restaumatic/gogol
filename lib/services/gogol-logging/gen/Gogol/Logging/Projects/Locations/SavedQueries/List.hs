...
newLoggingProjectsLocationsSavedQueriesList parent
  = LoggingProjectsLocationsSavedQueriesList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes LoggingProjectsLocationsSavedQueriesList =
             '[CloudPlatform'FullControl, CloudPlatform'ReadOnly, Logging'Admin,
               Logging'Read]
        requestClient LoggingProjectsLocationsSavedQueriesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingProjectsLocationsSavedQueriesListResource)
                      Core.mempty
