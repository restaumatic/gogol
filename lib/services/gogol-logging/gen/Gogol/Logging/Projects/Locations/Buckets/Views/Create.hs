...
newLoggingProjectsLocationsBucketsViewsCreate parent payload
  = LoggingProjectsLocationsBucketsViewsCreate{xgafv = Core.Nothing,
                                               accessToken = Core.Nothing, callback = Core.Nothing,
                                               parent = parent, payload = payload,
                                               uploadType = Core.Nothing,
                                               uploadProtocol = Core.Nothing, viewId = Core.Nothing}
instance Core.GoogleRequest
           LoggingProjectsLocationsBucketsViewsCreate
         where
        type Rs LoggingProjectsLocationsBucketsViewsCreate = LogView
        type Scopes LoggingProjectsLocationsBucketsViewsCreate =
             '[CloudPlatform'FullControl, Logging'Admin]
        requestClient LoggingProjectsLocationsBucketsViewsCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingProjectsLocationsBucketsViewsCreateResource)
                      Core.mempty
