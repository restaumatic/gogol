...
data LoggingProjectsLocationsLogScopesGet = LoggingProjectsLocationsLogScopesGet
    ...
    , callback :: (Core.Maybe Core.Text)
      -- | Required. The resource name of the log scope: \"projects\/[PROJECT/ID]\/locations\/[LOCATION/ID]\" \"organizations\/[ORGANIZATION/ID]\/locations\/[LOCATION/ID]\" \"folders\/[FOLDER/ID]\/locations\/[LOCATION/ID]\" For example:\"projects\/my-project\/locations\/global\/logScopes\/my-log-scope\"
    , name :: Core.Text
...
newLoggingProjectsLocationsLogScopesGet 
    :: 
                                        Core.Text
       -- ^  Required. The resource name of the log scope: \"projects\/[PROJECT/ID]\/locations\/[LOCATION/ID]\" \"organizations\/[ORGANIZATION/ID]\/locations\/[LOCATION/ID]\" \"folders\/[FOLDER/ID]\/locations\/[LOCATION/ID]\" For example:\"projects\/my-project\/locations\/global\/logScopes\/my-log-scope\" See 'name'.
    -> LoggingProjectsLocationsLogScopesGet
