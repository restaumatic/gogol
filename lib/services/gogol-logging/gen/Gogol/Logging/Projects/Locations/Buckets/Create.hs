...
newLoggingProjectsLocationsBucketsCreate parent payload
  = LoggingProjectsLocationsBucketsCreate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest LoggingProjectsLocationsBucketsCreate
         where
        type Rs LoggingProjectsLocationsBucketsCreate = LogBucket
        type Scopes LoggingProjectsLocationsBucketsCreate =
             '[CloudPlatform'FullControl, Logging'Admin]
        requestClient LoggingProjectsLocationsBucketsCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingProjectsLocationsBucketsCreateResource)
                      Core.mempty
