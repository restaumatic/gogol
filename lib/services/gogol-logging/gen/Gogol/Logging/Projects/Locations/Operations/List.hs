...
newLoggingProjectsLocationsOperationsList name
  = LoggingProjectsLocationsOperationsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest LoggingProjectsLocationsOperationsList
         where
        type Rs LoggingProjectsLocationsOperationsList =
             ListOperationsResponse
        type Scopes LoggingProjectsLocationsOperationsList =
             '[CloudPlatform'FullControl, CloudPlatform'ReadOnly, Logging'Admin,
               Logging'Read]
        requestClient LoggingProjectsLocationsOperationsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingProjectsLocationsOperationsListResource)
                      Core.mempty
