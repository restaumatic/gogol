...
newLoggingProjectsLocationsBucketsViewsSetIamPolicy 
    ...
    -> LoggingProjectsLocationsBucketsViewsSetIamPolicy
newLoggingProjectsLocationsBucketsViewsSetIamPolicy payload
  resource
  = LoggingProjectsLocationsBucketsViewsSetIamPolicy{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes LoggingProjectsLocationsBucketsViewsSetIamPolicy =
