...
newLoggingLocationsBucketsViewsTestIamPermissions payload resource
  = LoggingLocationsBucketsViewsTestIamPermissions{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           LoggingLocationsBucketsViewsTestIamPermissions
         where
        type Rs LoggingLocationsBucketsViewsTestIamPermissions =
             TestIamPermissionsResponse
        type Scopes LoggingLocationsBucketsViewsTestIamPermissions =
             '[CloudPlatform'FullControl, CloudPlatform'ReadOnly, Logging'Admin,
               Logging'Read]
        requestClient LoggingLocationsBucketsViewsTestIamPermissions{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingLocationsBucketsViewsTestIamPermissionsResource)
                      Core.mempty
