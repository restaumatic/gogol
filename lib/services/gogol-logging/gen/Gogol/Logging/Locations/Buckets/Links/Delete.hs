...
newLoggingLocationsBucketsLinksDelete name
  = LoggingLocationsBucketsLinksDelete{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       name = name, uploadType = Core.Nothing,
                                       uploadProtocol = Core.Nothing}
instance Core.GoogleRequest LoggingLocationsBucketsLinksDelete
         where
        type Rs LoggingLocationsBucketsLinksDelete = Operation
        ...
        requestClient LoggingLocationsBucketsLinksDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingLocationsBucketsLinksDeleteResource)
                      Core.mempty
