...
newLoggingLocationsBucketsLinksCreate parent payload
  = LoggingLocationsBucketsLinksCreate{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       linkId = Core.Nothing, parent = parent, payload = payload,
                                       uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest LoggingLocationsBucketsLinksCreate
         where
        type Rs LoggingLocationsBucketsLinksCreate = Operation
        type Scopes LoggingLocationsBucketsLinksCreate =
