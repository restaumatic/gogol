...
newLoggingLocationsBucketsViewsGet name
  = LoggingLocationsBucketsViewsGet{xgafv = Core.Nothing,
                                    accessToken = Core.Nothing, callback = Core.Nothing,
                                    name = name, uploadType = Core.Nothing,
                                    uploadProtocol = Core.Nothing}
instance Core.GoogleRequest LoggingLocationsBucketsViewsGet where
        ...
        requestClient LoggingLocationsBucketsViewsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy LoggingLocationsBucketsViewsGetResource)
                      Core.mempty
