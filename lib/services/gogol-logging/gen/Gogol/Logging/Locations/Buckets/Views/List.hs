...
newLoggingLocationsBucketsViewsList parent
  = LoggingLocationsBucketsViewsList{xgafv = Core.Nothing,
                                     accessToken = Core.Nothing, callback = Core.Nothing,
                                     pageSize = Core.Nothing, pageToken = Core.Nothing,
                                     parent = parent, uploadType = Core.Nothing,
                                     uploadProtocol = Core.Nothing}
instance Core.GoogleRequest LoggingLocationsBucketsViewsList where
        type Rs LoggingLocationsBucketsViewsList = ListViewsResponse
        type Scopes LoggingLocationsBucketsViewsList =
        ...
        requestClient LoggingLocationsBucketsViewsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy LoggingLocationsBucketsViewsListResource)
                      Core.mempty
