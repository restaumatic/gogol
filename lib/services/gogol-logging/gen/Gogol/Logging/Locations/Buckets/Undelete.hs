...
newLoggingLocationsBucketsUndelete name payload
  = LoggingLocationsBucketsUndelete{xgafv = Core.Nothing,
                                    accessToken = Core.Nothing, callback = Core.Nothing,
                                    name = name, payload = payload, uploadType = Core.Nothing,
                                    uploadProtocol = Core.Nothing}
instance Core.GoogleRequest LoggingLocationsBucketsUndelete where
        type Rs LoggingLocationsBucketsUndelete = Empty
        type Scopes LoggingLocationsBucketsUndelete =
        ...
        requestClient LoggingLocationsBucketsUndelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy LoggingLocationsBucketsUndeleteResource)
                      Core.mempty
