...
newLoggingLocationsBucketsUpdateAsync name payload
  = LoggingLocationsBucketsUpdateAsync{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       name = name, payload = payload, updateMask = Core.Nothing,
                                       uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest LoggingLocationsBucketsUpdateAsync
         where
        type Rs LoggingLocationsBucketsUpdateAsync = Operation
        type Scopes LoggingLocationsBucketsUpdateAsync =
        ...
        requestClient LoggingLocationsBucketsUpdateAsync{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingLocationsBucketsUpdateAsyncResource)
                      Core.mempty
