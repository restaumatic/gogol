...
instance Core.GoogleRequest LoggingLocationsBucketsGet where
        ...
        requestClient LoggingLocationsBucketsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy LoggingLocationsBucketsGetResource)
                      Core.mempty
