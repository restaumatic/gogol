...
newLoggingLocationsBucketsViewsCreate parent payload
  = LoggingLocationsBucketsViewsCreate{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       parent = parent, payload = payload,
                                       uploadType = Core.Nothing, uploadProtocol = Core.Nothing,
                                       viewId = Core.Nothing}
instance Core.GoogleRequest LoggingLocationsBucketsViewsCreate
         where
        type Rs LoggingLocationsBucketsViewsCreate = LogView
        type Scopes LoggingLocationsBucketsViewsCreate =
        ...
        requestClient LoggingLocationsBucketsViewsCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingLocationsBucketsViewsCreateResource)
                      Core.mempty
