...
newLoggingLocationsBucketsLinksGet name
  = LoggingLocationsBucketsLinksGet{xgafv = Core.Nothing,
                                    accessToken = Core.Nothing, callback = Core.Nothing,
                                    name = name, uploadType = Core.Nothing,
                                    uploadProtocol = Core.Nothing}
instance Core.GoogleRequest LoggingLocationsBucketsLinksGet where
        ...
        requestClient LoggingLocationsBucketsLinksGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy LoggingLocationsBucketsLinksGetResource)
                      Core.mempty
