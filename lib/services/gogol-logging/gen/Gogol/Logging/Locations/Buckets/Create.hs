...
newLoggingLocationsBucketsCreate parent payload
  = LoggingLocationsBucketsCreate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest LoggingLocationsBucketsCreate where
        ...
        requestClient LoggingLocationsBucketsCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy LoggingLocationsBucketsCreateResource)
                      Core.mempty
