...
newLoggingLocationsBucketsViewsDelete name
  = LoggingLocationsBucketsViewsDelete{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       name = name, uploadType = Core.Nothing,
                                       uploadProtocol = Core.Nothing}
instance Core.GoogleRequest LoggingLocationsBucketsViewsDelete
         where
        type Rs LoggingLocationsBucketsViewsDelete = Empty
        type Scopes LoggingLocationsBucketsViewsDelete =
