...
newLoggingLocationsBucketsViewsGetIamPolicy payload resource
  = LoggingLocationsBucketsViewsGetIamPolicy{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        requestClient LoggingLocationsBucketsViewsGetIamPolicy{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingLocationsBucketsViewsGetIamPolicyResource)
                      Core.mempty
