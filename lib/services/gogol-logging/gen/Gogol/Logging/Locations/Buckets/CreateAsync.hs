...
newLoggingLocationsBucketsCreateAsync parent payload
  = LoggingLocationsBucketsCreateAsync{xgafv = Core.Nothing,
...
instance Core.GoogleRequest LoggingLocationsBucketsCreateAsync
         where
        type Rs LoggingLocationsBucketsCreateAsync = Operation
        ...
        requestClient LoggingLocationsBucketsCreateAsync{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingLocationsBucketsCreateAsyncResource)
                      Core.mempty
