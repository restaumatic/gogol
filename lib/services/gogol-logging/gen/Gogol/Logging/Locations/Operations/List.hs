...
newLoggingLocationsOperationsList name
  = LoggingLocationsOperationsList{xgafv = Core.Nothing,
                                   accessToken = Core.Nothing, callback = Core.Nothing,
                                   filter = Core.Nothing, name = name, pageSize = Core.Nothing,
                                   pageToken = Core.Nothing, uploadType = Core.Nothing,
                                   uploadProtocol = Core.Nothing}
instance Core.GoogleRequest LoggingLocationsOperationsList where
        type Rs LoggingLocationsOperationsList = ListOperationsResponse
        type Scopes LoggingLocationsOperationsList =
        ...
        requestClient LoggingLocationsOperationsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy LoggingLocationsOperationsListResource)
                      Core.mempty
