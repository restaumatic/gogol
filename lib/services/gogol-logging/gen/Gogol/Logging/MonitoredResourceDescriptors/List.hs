...
-- |
-- Module      : Gogol.Logging.MonitoredResourceDescriptors.List
...
type LoggingMonitoredResourceDescriptorsListResource =
     "v2" Core.:>
       "monitoredResourceDescriptors" Core.:>
                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.Get '[Core.JSON] ListMonitoredResourceDescriptorsResponse
...
newLoggingMonitoredResourceDescriptorsList 
    :: 
                                           LoggingMonitoredResourceDescriptorsList
newLoggingMonitoredResourceDescriptorsList
  = LoggingMonitoredResourceDescriptorsList{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            pageSize = Core.Nothing, pageToken = Core.Nothing,
                                            uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest LoggingMonitoredResourceDescriptorsList
         where
        type Rs LoggingMonitoredResourceDescriptorsList =
             ListMonitoredResourceDescriptorsResponse
        type Scopes LoggingMonitoredResourceDescriptorsList =
             '[CloudPlatform'FullControl, CloudPlatform'ReadOnly, Logging'Admin,
               Logging'Read]
        requestClient LoggingMonitoredResourceDescriptorsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy LoggingMonitoredResourceDescriptorsListResource)
                      Core.mempty
