               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] CreateProjectRequest Core.:>
                       Core.Post '[Core.JSON] Project
...
newScriptProjectsCreate payload
  = ScriptProjectsCreate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ScriptProjectsCreate where
        ...
        requestClient ScriptProjectsCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ScriptProjectsCreateResource)
                      Core.mempty
