                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] UpdateDeploymentRequest Core.:>
                             Core.Put '[Core.JSON] Deployment
...
newScriptProjectsDeploymentsUpdate deploymentId payload scriptId
  = ScriptProjectsDeploymentsUpdate{xgafv = Core.Nothing,
                                    accessToken = Core.Nothing, callback = Core.Nothing,
                                    deploymentId = deploymentId, payload = payload,
                                    scriptId = scriptId, uploadType = Core.Nothing,
                                    uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ScriptProjectsDeploymentsUpdate where
        type Rs ScriptProjectsDeploymentsUpdate = Deployment
        type Scopes ScriptProjectsDeploymentsUpdate = '[Script'Deployments]
        requestClient ScriptProjectsDeploymentsUpdate{..}
          = go scriptId deploymentId xgafv accessToken callback uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ScriptProjectsDeploymentsUpdateResource)
                      Core.mempty
