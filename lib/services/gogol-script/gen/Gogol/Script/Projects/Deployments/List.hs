                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] ListDeploymentsResponse
...
newScriptProjectsDeploymentsList scriptId
  = ScriptProjectsDeploymentsList{xgafv = Core.Nothing,
                                  accessToken = Core.Nothing, callback = Core.Nothing,
                                  pageSize = Core.Nothing, pageToken = Core.Nothing,
                                  scriptId = scriptId, uploadType = Core.Nothing,
                                  uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ScriptProjectsDeploymentsList where
        type Rs ScriptProjectsDeploymentsList = ListDeploymentsResponse
        type Scopes ScriptProjectsDeploymentsList =
             '[Script'Deployments, Script'Deployments'Readonly]
        requestClient ScriptProjectsDeploymentsList{..}
          = go scriptId xgafv accessToken callback pageSize pageToken
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ScriptProjectsDeploymentsListResource)
                      Core.mempty
