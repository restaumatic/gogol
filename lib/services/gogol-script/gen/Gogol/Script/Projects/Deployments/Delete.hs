...
newScriptProjectsDeploymentsDelete deploymentId scriptId
  = ScriptProjectsDeploymentsDelete{xgafv = Core.Nothing,
                                    accessToken = Core.Nothing, callback = Core.Nothing,
                                    deploymentId = deploymentId, scriptId = scriptId,
                                    uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ScriptProjectsDeploymentsDelete where
        type Rs ScriptProjectsDeploymentsDelete = Empty
        type Scopes ScriptProjectsDeploymentsDelete = '[Script'Deployments]
        requestClient ScriptProjectsDeploymentsDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ScriptProjectsDeploymentsDeleteResource)
                      Core.mempty
