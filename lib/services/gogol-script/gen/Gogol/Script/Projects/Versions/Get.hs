     ...
     "v1" Core.:>
       "projects" Core.:>
         Core.Capture "scriptId" Core.Text Core.:>
           "versions" Core.:>
             Core.Capture "versionNumber" Core.Int32 Core.:>
