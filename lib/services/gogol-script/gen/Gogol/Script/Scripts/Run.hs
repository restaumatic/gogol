...
newScriptScriptsRun payload scriptId
  = ScriptScriptsRun{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ScriptScriptsRun where
        ...
        type Scopes ScriptScriptsRun =
             '[Gmail'FullControl, Calendar'Feeds'FullControl,
               M8'Feeds'FullControl, Admin'Directory'Group, Admin'Directory'User,
               Documents'FullControl, Drive'FullControl, Forms'FullControl,
               Forms'Currentonly, Groups'FullControl, Spreadsheets'FullControl,
               Userinfo'Email]
