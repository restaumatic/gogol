                 ...
                 Core.QueryParam "pageToken" Core.Text Core.:>
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "userProcessFilter.deploymentId" Core.Text Core.:>
                         Core.QueryParam "userProcessFilter.endTime" Core.DateTime Core.:>
                           Core.QueryParam "userProcessFilter.functionName" Core.Text Core.:>
                             Core.QueryParam "userProcessFilter.projectName" Core.Text Core.:>
                               Core.QueryParam "userProcessFilter.scriptId" Core.Text Core.:>
                                 Core.QueryParam "userProcessFilter.startTime" Core.DateTime Core.:>
                                   Core.QueryParams "userProcessFilter.statuses"
                                     ...
                                     Core.QueryParams "userProcessFilter.types"
                                       ...
                                       Core.:>
                                       Core.QueryParams "userProcessFilter.userAccessLevels"
                                         ProcessesListUserProcessFilterUserAccessLevels
                                         Core.:>
                                         Core.QueryParam "alt" Core.AltJSON Core.:>
                                           Core.Get '[Core.JSON] ListUserProcessesResponse
...
newScriptProcessesList 
    ::  ScriptProcessesList
newScriptProcessesList
  = ScriptProcessesList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ScriptProcessesList where
        type Rs ScriptProcessesList = ListUserProcessesResponse
        ...
        requestClient ScriptProcessesList{..}
          = go xgafv accessToken callback pageSize pageToken uploadType
              ...
              (userProcessFilterUserAccessLevels Core.^. Core._Default)
              (Core.Just Core.AltJSON)
              scriptService
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ScriptProcessesListResource)
                      Core.mempty
