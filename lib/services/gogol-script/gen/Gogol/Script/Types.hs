...
type Calendar'Feeds'FullControl =
...
type Script'Deployments =
     "https://www.googleapis.com/auth/script.deployments"

-- | View Google Apps Script deployments
type Script'Deployments'Readonly =
