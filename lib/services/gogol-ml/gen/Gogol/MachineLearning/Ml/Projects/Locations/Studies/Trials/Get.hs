               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.Get '[Core.JSON] GoogleCloudMlV1__Trial
...
newMlProjectsLocationsStudiesTrialsGet name
  = MlProjectsLocationsStudiesTrialsGet{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        name = name, uploadType = Core.Nothing,
                                        uploadProtocol = Core.Nothing}
instance Core.GoogleRequest MlProjectsLocationsStudiesTrialsGet
         where
        type Rs MlProjectsLocationsStudiesTrialsGet =
             GoogleCloudMlV1__Trial
        type Scopes MlProjectsLocationsStudiesTrialsGet =
