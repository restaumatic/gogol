               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] GoogleCloudMlV1__StopTrialRequest Core.:>
                       Core.Post '[Core.JSON] GoogleCloudMlV1__Trial
...
newMlProjectsLocationsStudiesTrialsStop name payload
  = MlProjectsLocationsStudiesTrialsStop{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         name = name, payload = payload, uploadType = Core.Nothing,
                                         uploadProtocol = Core.Nothing}
instance Core.GoogleRequest MlProjectsLocationsStudiesTrialsStop
         where
        type Rs MlProjectsLocationsStudiesTrialsStop =
             GoogleCloudMlV1__Trial
        type Scopes MlProjectsLocationsStudiesTrialsStop =
             '[CloudPlatform'FullControl]
        requestClient MlProjectsLocationsStudiesTrialsStop{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy MlProjectsLocationsStudiesTrialsStopResource)
                      Core.mempty
