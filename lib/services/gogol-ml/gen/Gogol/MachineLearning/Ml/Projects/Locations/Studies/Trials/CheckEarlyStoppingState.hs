...
type MlProjectsLocationsStudiesTrialsCheckEarlyStoppingStateResource
     =
     "v1" Core.:>
       Core.CaptureMode "name" "checkEarlyStoppingState" Core.Text Core.:>
...
newMlProjectsLocationsStudiesTrialsCheckEarlyStoppingState 
    ...
    -> MlProjectsLocationsStudiesTrialsCheckEarlyStoppingState
newMlProjectsLocationsStudiesTrialsCheckEarlyStoppingState name
  payload
  = MlProjectsLocationsStudiesTrialsCheckEarlyStoppingState{xgafv =
                                                              Core.Nothing,
...
instance Core.GoogleRequest
           MlProjectsLocationsStudiesTrialsCheckEarlyStoppingState
         where
        type Rs MlProjectsLocationsStudiesTrialsCheckEarlyStoppingState =
             GoogleLongrunning__Operation
        type Scopes MlProjectsLocationsStudiesTrialsCheckEarlyStoppingState
