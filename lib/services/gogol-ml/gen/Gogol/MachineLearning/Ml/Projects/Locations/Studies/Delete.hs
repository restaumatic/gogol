...
newMlProjectsLocationsStudiesDelete name
  = MlProjectsLocationsStudiesDelete{xgafv = Core.Nothing,
                                     accessToken = Core.Nothing, callback = Core.Nothing,
                                     name = name, uploadType = Core.Nothing,
                                     uploadProtocol = Core.Nothing}
instance Core.GoogleRequest MlProjectsLocationsStudiesDelete where
        type Rs MlProjectsLocationsStudiesDelete = GoogleProtobuf__Empty
        type Scopes MlProjectsLocationsStudiesDelete =
        ...
        requestClient MlProjectsLocationsStudiesDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy MlProjectsLocationsStudiesDeleteResource)
                      Core.mempty
