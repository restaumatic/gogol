                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] GoogleCloudMlV1__SuggestTrialsRequest
...
newMlProjectsLocationsStudiesTrialsSuggest parent payload
  = MlProjectsLocationsStudiesTrialsSuggest{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            parent = parent, payload = payload,
                                            uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest MlProjectsLocationsStudiesTrialsSuggest
         where
        type Rs MlProjectsLocationsStudiesTrialsSuggest =
             GoogleLongrunning__Operation
        type Scopes MlProjectsLocationsStudiesTrialsSuggest =
             '[CloudPlatform'FullControl]
        requestClient MlProjectsLocationsStudiesTrialsSuggest{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy MlProjectsLocationsStudiesTrialsSuggestResource)
                      Core.mempty
