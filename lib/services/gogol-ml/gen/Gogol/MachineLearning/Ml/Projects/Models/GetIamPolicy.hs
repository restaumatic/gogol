...
-- |
-- Module      : Gogol.MachineLearning.Ml.Projects.Models.GetIamPolicy
                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.Get '[Core.JSON] GoogleIamV1__Policy
...
newMlProjectsModelsGetIamPolicy resource
  = MlProjectsModelsGetIamPolicy{xgafv = Core.Nothing,
                                 accessToken = Core.Nothing, callback = Core.Nothing,
                                 optionsRequestedPolicyVersion = Core.Nothing, resource = resource,
                                 uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest MlProjectsModelsGetIamPolicy where
        type Rs MlProjectsModelsGetIamPolicy = GoogleIamV1__Policy
        type Scopes MlProjectsModelsGetIamPolicy =
        ...
        requestClient MlProjectsModelsGetIamPolicy{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy MlProjectsModelsGetIamPolicyResource)
                      Core.mempty
