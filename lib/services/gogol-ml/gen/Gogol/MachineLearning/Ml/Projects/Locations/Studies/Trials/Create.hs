                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] GoogleCloudMlV1__Trial Core.:>
...
newMlProjectsLocationsStudiesTrialsCreate parent payload
  = MlProjectsLocationsStudiesTrialsCreate{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           parent = parent, payload = payload,
                                           uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest MlProjectsLocationsStudiesTrialsCreate
         where
        type Rs MlProjectsLocationsStudiesTrialsCreate =
             GoogleCloudMlV1__Trial
        type Scopes MlProjectsLocationsStudiesTrialsCreate =
