                   ...
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] GoogleCloudMlV1__Job Core.:>
                         Core.Patch '[Core.JSON] GoogleCloudMlV1__Job
...
newMlProjectsJobsPatch name payload
  = MlProjectsJobsPatch{xgafv = Core.Nothing,
...
instance Core.GoogleRequest MlProjectsJobsPatch where
        ...
        type Scopes MlProjectsJobsPatch = '[CloudPlatform'FullControl]
        requestClient MlProjectsJobsPatch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy MlProjectsJobsPatchResource)
                      Core.mempty
