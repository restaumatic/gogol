                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] GoogleCloudMlV1__Version Core.:>
                         Core.Post '[Core.JSON] GoogleLongrunning__Operation
...
newMlProjectsModelsVersionsCreate parent payload
  = MlProjectsModelsVersionsCreate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest MlProjectsModelsVersionsCreate where
        type Rs MlProjectsModelsVersionsCreate =
             GoogleLongrunning__Operation
        type Scopes MlProjectsModelsVersionsCreate =
