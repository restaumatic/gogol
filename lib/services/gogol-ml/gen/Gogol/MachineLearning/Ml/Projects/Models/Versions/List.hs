                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] GoogleCloudMlV1__ListVersionsResponse
...
newMlProjectsModelsVersionsList parent
  = MlProjectsModelsVersionsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest MlProjectsModelsVersionsList where
        type Rs MlProjectsModelsVersionsList =
             GoogleCloudMlV1__ListVersionsResponse
        type Scopes MlProjectsModelsVersionsList =
        ...
        requestClient MlProjectsModelsVersionsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy MlProjectsModelsVersionsListResource)
                      Core.mempty
