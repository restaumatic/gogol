...
-- |
-- Module      : Gogol.MachineLearning.Ml.Projects.Models.Versions.Delete
...
newMlProjectsModelsVersionsDelete name
  = MlProjectsModelsVersionsDelete{xgafv = Core.Nothing,
                                   accessToken = Core.Nothing, callback = Core.Nothing, name = name,
                                   uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest MlProjectsModelsVersionsDelete where
        type Rs MlProjectsModelsVersionsDelete =
             GoogleLongrunning__Operation
        type Scopes MlProjectsModelsVersionsDelete =
        ...
        requestClient MlProjectsModelsVersionsDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy MlProjectsModelsVersionsDeleteResource)
                      Core.mempty
