...
newMlProjectsLocationsStudiesTrialsDelete name
  = MlProjectsLocationsStudiesTrialsDelete{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           name = name, uploadType = Core.Nothing,
                                           uploadProtocol = Core.Nothing}
instance Core.GoogleRequest MlProjectsLocationsStudiesTrialsDelete
         where
        type Rs MlProjectsLocationsStudiesTrialsDelete =
             GoogleProtobuf__Empty
        type Scopes MlProjectsLocationsStudiesTrialsDelete =
             '[CloudPlatform'FullControl]
        requestClient MlProjectsLocationsStudiesTrialsDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy MlProjectsLocationsStudiesTrialsDeleteResource)
                      Core.mempty
