                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] GoogleCloudMlV1__ListJobsResponse
...
newMlProjectsJobsList parent
  = MlProjectsJobsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest MlProjectsJobsList where
        type Rs MlProjectsJobsList = GoogleCloudMlV1__ListJobsResponse
        type Scopes MlProjectsJobsList =
