                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] GoogleCloudMlV1__Study Core.:>
                           Core.Post '[Core.JSON] GoogleCloudMlV1__Study
...
newMlProjectsLocationsStudiesCreate parent payload
  = MlProjectsLocationsStudiesCreate{xgafv = Core.Nothing,
                                     accessToken = Core.Nothing, callback = Core.Nothing,
                                     parent = parent, payload = payload, studyId = Core.Nothing,
...
instance Core.GoogleRequest MlProjectsLocationsStudiesCreate where
        ...
        requestClient MlProjectsLocationsStudiesCreate{..}
          = go parent xgafv accessToken callback studyId uploadType
              uploadProtocol
