...
type MlProjectsModelsVersionsSetDefaultResource =
     "v1" Core.:>
       Core.CaptureMode "name" "setDefault" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] GoogleCloudMlV1__SetDefaultVersionRequest
...
newMlProjectsModelsVersionsSetDefault name payload
  = MlProjectsModelsVersionsSetDefault{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       name = name, payload = payload, uploadType = Core.Nothing,
                                       uploadProtocol = Core.Nothing}
instance Core.GoogleRequest MlProjectsModelsVersionsSetDefault
         where
        ...
        requestClient MlProjectsModelsVersionsSetDefault{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy MlProjectsModelsVersionsSetDefaultResource)
                      Core.mempty
