...
newMlProjectsLocationsStudiesGet name
  = MlProjectsLocationsStudiesGet{xgafv = Core.Nothing,
                                  accessToken = Core.Nothing, callback = Core.Nothing, name = name,
                                  uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest MlProjectsLocationsStudiesGet where
        type Rs MlProjectsLocationsStudiesGet = GoogleCloudMlV1__Study
        ...
        requestClient MlProjectsLocationsStudiesGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy MlProjectsLocationsStudiesGetResource)
                      Core.mempty
