...
-- |
-- Module      : Gogol.MachineLearning.Ml.Projects.Models.TestIamPermissions
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] GoogleIamV1__TestIamPermissionsRequest
                       Core.:>
                       Core.Post '[Core.JSON] GoogleIamV1__TestIamPermissionsResponse
...
newMlProjectsModelsTestIamPermissions payload resource
  = MlProjectsModelsTestIamPermissions{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       payload = payload, resource = resource,
                                       uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest MlProjectsModelsTestIamPermissions
         where
        type Rs MlProjectsModelsTestIamPermissions =
             GoogleIamV1__TestIamPermissionsResponse
        type Scopes MlProjectsModelsTestIamPermissions =
        ...
        requestClient MlProjectsModelsTestIamPermissions{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy MlProjectsModelsTestIamPermissionsResource)
                      Core.mempty
