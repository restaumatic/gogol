...
newMlProjectsLocationsOperationsGet name
  = MlProjectsLocationsOperationsGet{xgafv = Core.Nothing,
                                     accessToken = Core.Nothing, callback = Core.Nothing,
                                     name = name, uploadType = Core.Nothing,
                                     uploadProtocol = Core.Nothing}
instance Core.GoogleRequest MlProjectsLocationsOperationsGet where
        ...
        requestClient MlProjectsLocationsOperationsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy MlProjectsLocationsOperationsGetResource)
                      Core.mempty
