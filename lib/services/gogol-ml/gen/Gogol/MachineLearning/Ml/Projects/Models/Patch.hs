                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] GoogleCloudMlV1__Model Core.:>
                         Core.Patch '[Core.JSON] GoogleLongrunning__Operation
...
newMlProjectsModelsPatch name payload
  = MlProjectsModelsPatch{xgafv = Core.Nothing,
...
instance Core.GoogleRequest MlProjectsModelsPatch where
        type Rs MlProjectsModelsPatch = GoogleLongrunning__Operation
        type Scopes MlProjectsModelsPatch = '[CloudPlatform'FullControl]
        requestClient MlProjectsModelsPatch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy MlProjectsModelsPatchResource)
                      Core.mempty
