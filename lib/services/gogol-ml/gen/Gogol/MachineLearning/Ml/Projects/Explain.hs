...
-- |
-- Module      : Gogol.MachineLearning.Ml.Projects.Explain
...
type MlProjectsExplainResource =
     "v1" Core.:>
       Core.CaptureMode "name" "explain" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] GoogleCloudMlV1__ExplainRequest Core.:>
                       Core.Post '[Core.JSON] GoogleApi__HttpBody
...
newMlProjectsExplain name payload
  = MlProjectsExplain{xgafv = Core.Nothing,
...
instance Core.GoogleRequest MlProjectsExplain where
        ...
        type Scopes MlProjectsExplain = '[CloudPlatform'FullControl]
