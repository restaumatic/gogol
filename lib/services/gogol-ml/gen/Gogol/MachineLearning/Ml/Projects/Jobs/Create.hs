                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] GoogleCloudMlV1__Job Core.:>
                         Core.Post '[Core.JSON] GoogleCloudMlV1__Job
...
newMlProjectsJobsCreate parent payload
  = MlProjectsJobsCreate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest MlProjectsJobsCreate where
        ...
        type Scopes MlProjectsJobsCreate = '[CloudPlatform'FullControl]
        requestClient MlProjectsJobsCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy MlProjectsJobsCreateResource)
                      Core.mempty
