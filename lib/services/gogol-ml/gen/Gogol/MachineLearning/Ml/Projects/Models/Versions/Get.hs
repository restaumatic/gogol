               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.Get '[Core.JSON] GoogleCloudMlV1__Version
...
newMlProjectsModelsVersionsGet name
  = MlProjectsModelsVersionsGet{xgafv = Core.Nothing,
                                accessToken = Core.Nothing, callback = Core.Nothing, name = name,
                                uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest MlProjectsModelsVersionsGet where
        type Rs MlProjectsModelsVersionsGet = GoogleCloudMlV1__Version
        type Scopes MlProjectsModelsVersionsGet =
        ...
        requestClient MlProjectsModelsVersionsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy MlProjectsModelsVersionsGetResource)
                      Core.mempty
