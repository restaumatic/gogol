...
-- |
-- Module      : Gogol.MachineLearning.Ml.Projects.Locations.Studies.Trials.ListOptimalTrials
                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] GoogleCloudMlV1__ListOptimalTrialsRequest
                         Core.:>
                         Core.Post '[Core.JSON] GoogleCloudMlV1__ListOptimalTrialsResponse
...
newMlProjectsLocationsStudiesTrialsListOptimalTrials parent payload
  = MlProjectsLocationsStudiesTrialsListOptimalTrials{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           MlProjectsLocationsStudiesTrialsListOptimalTrials
         where
        type Rs MlProjectsLocationsStudiesTrialsListOptimalTrials =
             GoogleCloudMlV1__ListOptimalTrialsResponse
        type Scopes MlProjectsLocationsStudiesTrialsListOptimalTrials =
             '[CloudPlatform'FullControl]
        requestClient MlProjectsLocationsStudiesTrialsListOptimalTrials{..}
