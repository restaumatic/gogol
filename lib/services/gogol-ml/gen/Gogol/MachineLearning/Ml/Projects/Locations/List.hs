                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] GoogleCloudMlV1__ListLocationsResponse
...
instance Core.GoogleRequest MlProjectsLocationsList where
        ...
        requestClient MlProjectsLocationsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy MlProjectsLocationsListResource)
                      Core.mempty
