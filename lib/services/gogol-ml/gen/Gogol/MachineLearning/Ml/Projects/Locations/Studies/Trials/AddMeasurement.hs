...
type MlProjectsLocationsStudiesTrialsAddMeasurementResource =
     "v1" Core.:>
       Core.CaptureMode "name" "addMeasurement" Core.Text Core.:>
...
newMlProjectsLocationsStudiesTrialsAddMeasurement name payload
  = MlProjectsLocationsStudiesTrialsAddMeasurement{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           MlProjectsLocationsStudiesTrialsAddMeasurement
         where
        type Rs MlProjectsLocationsStudiesTrialsAddMeasurement =
             GoogleCloudMlV1__Trial
        type Scopes MlProjectsLocationsStudiesTrialsAddMeasurement =
