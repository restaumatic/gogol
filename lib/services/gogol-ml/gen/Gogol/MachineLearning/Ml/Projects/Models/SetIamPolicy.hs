...
newMlProjectsModelsSetIamPolicy payload resource
  = MlProjectsModelsSetIamPolicy{xgafv = Core.Nothing,
                                 accessToken = Core.Nothing, callback = Core.Nothing,
                                 payload = payload, resource = resource, uploadType = Core.Nothing,
                                 uploadProtocol = Core.Nothing}
instance Core.GoogleRequest MlProjectsModelsSetIamPolicy where
        type Rs MlProjectsModelsSetIamPolicy = GoogleIamV1__Policy
        ...
        requestClient MlProjectsModelsSetIamPolicy{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy MlProjectsModelsSetIamPolicyResource)
                      Core.mempty
