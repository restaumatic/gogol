               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] GoogleCloudMlV1__CompleteTrialRequest
...
newMlProjectsLocationsStudiesTrialsComplete name payload
  = MlProjectsLocationsStudiesTrialsComplete{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           MlProjectsLocationsStudiesTrialsComplete
         where
        type Rs MlProjectsLocationsStudiesTrialsComplete =
             GoogleCloudMlV1__Trial
        type Scopes MlProjectsLocationsStudiesTrialsComplete =
             '[CloudPlatform'FullControl]
        requestClient MlProjectsLocationsStudiesTrialsComplete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy MlProjectsLocationsStudiesTrialsCompleteResource)
                      Core.mempty
