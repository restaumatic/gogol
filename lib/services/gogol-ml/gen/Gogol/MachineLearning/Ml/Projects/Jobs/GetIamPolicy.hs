...
newMlProjectsJobsGetIamPolicy resource
  = MlProjectsJobsGetIamPolicy{xgafv = Core.Nothing,
                               accessToken = Core.Nothing, callback = Core.Nothing,
                               optionsRequestedPolicyVersion = Core.Nothing, resource = resource,
                               uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest MlProjectsJobsGetIamPolicy where
        type Rs MlProjectsJobsGetIamPolicy = GoogleIamV1__Policy
        type Scopes MlProjectsJobsGetIamPolicy =
        ...
        requestClient MlProjectsJobsGetIamPolicy{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy MlProjectsJobsGetIamPolicyResource)
                      Core.mempty
