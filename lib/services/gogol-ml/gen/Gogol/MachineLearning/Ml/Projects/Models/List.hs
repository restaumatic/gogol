                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] GoogleCloudMlV1__ListModelsResponse
...
newMlProjectsModelsList parent
  = MlProjectsModelsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest MlProjectsModelsList where
        type Rs MlProjectsModelsList = GoogleCloudMlV1__ListModelsResponse
        type Scopes MlProjectsModelsList =
        ...
        requestClient MlProjectsModelsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy MlProjectsModelsListResource)
                      Core.mempty
