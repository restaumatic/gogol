                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.Get '[Core.JSON] GoogleCloudMlV1__ListStudiesResponse
...
newMlProjectsLocationsStudiesList parent
  = MlProjectsLocationsStudiesList{xgafv = Core.Nothing,
                                   accessToken = Core.Nothing, callback = Core.Nothing,
                                   parent = parent, uploadType = Core.Nothing,
                                   uploadProtocol = Core.Nothing}
instance Core.GoogleRequest MlProjectsLocationsStudiesList where
        type Rs MlProjectsLocationsStudiesList =
             GoogleCloudMlV1__ListStudiesResponse
        type Scopes MlProjectsLocationsStudiesList =
        ...
        requestClient MlProjectsLocationsStudiesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy MlProjectsLocationsStudiesListResource)
                      Core.mempty
