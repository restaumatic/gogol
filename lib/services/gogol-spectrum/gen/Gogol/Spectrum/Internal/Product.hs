...
newAntennaCharacteristics 
    ::  AntennaCharacteristics
newAntennaCharacteristics
  = AntennaCharacteristics{height = Core.Nothing,
                           heightType = Core.Nothing, heightUncertainty = Core.Nothing}
instance Core.FromJSON AntennaCharacteristics where
        parseJSON
          = Core.withObject "AntennaCharacteristics"
              (\ o ->
                 AntennaCharacteristics Core.<$>
                   (o Core..:? "height") Core.<*> (o Core..:? "heightType") Core.<*>
                     (o Core..:? "heightUncertainty"))
          ...
          = Core.object
              (Core.catMaybes
                 [("height" Core..=) Core.<$> height,
                  ...
                  ("heightUncertainty" Core..=) Core.<$> heightUncertainty])
...
newDatabaseSpec 
    ::  DatabaseSpec
newDatabaseSpec
  = DatabaseSpec{name = Core.Nothing, uri = Core.Nothing}
...
instance Core.FromJSON DbUpdateSpec where
        parseJSON
          = Core.withObject "DbUpdateSpec"
              (\ o -> DbUpdateSpec Core.<$> (o Core..:? "databases"))

instance Core.ToJSON DbUpdateSpec where
        toJSON DbUpdateSpec{..}
          = Core.object
              (Core.catMaybes [("databases" Core..=) Core.<$> databases])
...
newDeviceDescriptor 
    ::  DeviceDescriptor
newDeviceDescriptor
  = DeviceDescriptor{etsiEnDeviceCategory = Core.Nothing,
                     etsiEnDeviceEmissionsClass = Core.Nothing,
                     etsiEnDeviceType = Core.Nothing, etsiEnTechnologyId = Core.Nothing,
                     fccId = Core.Nothing, fccTvbdDeviceType = Core.Nothing,
                     manufacturerId = Core.Nothing, modelId = Core.Nothing,
                     rulesetIds = Core.Nothing, serialNumber = Core.Nothing}
...
instance Core.ToJSON DeviceDescriptor where
        toJSON DeviceDescriptor{..}
          = Core.object
              (Core.catMaybes
                 [("etsiEnDeviceCategory" Core..=) Core.<$> etsiEnDeviceCategory,
                  ("etsiEnDeviceEmissionsClass" Core..=) Core.<$>
                    etsiEnDeviceEmissionsClass,
                  ("etsiEnDeviceType" Core..=) Core.<$> etsiEnDeviceType,
                  ("etsiEnTechnologyId" Core..=) Core.<$> etsiEnTechnologyId,
                  ("fccId" Core..=) Core.<$> fccId,
                  ("fccTvbdDeviceType" Core..=) Core.<$> fccTvbdDeviceType,
...
newDeviceOwner 
    ::  DeviceOwner
newDeviceOwner
  = DeviceOwner{operator = Core.Nothing, owner = Core.Nothing}
instance Core.FromJSON DeviceOwner where
        parseJSON
          = Core.withObject "DeviceOwner"
              (\ o ->
                 DeviceOwner Core.<$>
                   (o Core..:? "operator") Core.<*> (o Core..:? "owner"))
...
newDeviceValidity 
    ::  DeviceValidity
newDeviceValidity
  = DeviceValidity{deviceDesc = Core.Nothing, isValid = Core.Nothing,
                   reason = Core.Nothing}
instance Core.FromJSON DeviceValidity where
        parseJSON
          = Core.withObject "DeviceValidity"
              (\ o ->
                 DeviceValidity Core.<$>
                   (o Core..:? "deviceDesc") Core.<*> (o Core..:? "isValid") Core.<*>
                     (o Core..:? "reason"))
...
newEventTime 
    ::  EventTime
newEventTime
  = EventTime{startTime = Core.Nothing, stopTime = Core.Nothing}
instance Core.FromJSON EventTime where
        parseJSON
          = Core.withObject "EventTime"
              (\ o ->
                 EventTime Core.<$>
                   (o Core..:? "startTime") Core.<*> (o Core..:? "stopTime"))
...
newFrequencyRange 
    ::  FrequencyRange
newFrequencyRange
  = FrequencyRange{channelId = Core.Nothing,
                   maxPowerDBm = Core.Nothing, startHz = Core.Nothing,
                   stopHz = Core.Nothing}
instance Core.FromJSON FrequencyRange where
        parseJSON
          = Core.withObject "FrequencyRange"
              (\ o ->
                 FrequencyRange Core.<$>
                   (o Core..:? "channelId") Core.<*> (o Core..:? "maxPowerDBm")
                     Core.<*> (o Core..:? "startHz")
                     Core.<*> (o Core..:? "stopHz"))
...
newGeoLocation 
    ::  GeoLocation
newGeoLocation
  = GeoLocation{confidence = Core.Nothing, point = Core.Nothing,
                region = Core.Nothing}
instance Core.FromJSON GeoLocation where
        parseJSON
          = Core.withObject "GeoLocation"
              (\ o ->
                 GeoLocation Core.<$>
                   (o Core..:? "confidence") Core.<*> (o Core..:? "point") Core.<*>
                     (o Core..:? "region"))
...
newGeoLocationEllipse 
    ::  GeoLocationEllipse
newGeoLocationEllipse
  = GeoLocationEllipse{center = Core.Nothing,
                       orientation = Core.Nothing, semiMajorAxis = Core.Nothing,
          ...
          = Core.withObject "GeoLocationEllipse"
              (\ o ->
                 GeoLocationEllipse Core.<$>
                   (o Core..:? "center") Core.<*> (o Core..:? "orientation") Core.<*>
                     (o Core..:? "semiMajorAxis")
...
newGeoLocationPoint 
    ::  GeoLocationPoint
newGeoLocationPoint
  = GeoLocationPoint{latitude = Core.Nothing,
...
instance Core.FromJSON GeoLocationPolygon where
        parseJSON
          = Core.withObject "GeoLocationPolygon"
              (\ o -> GeoLocationPolygon Core.<$> (o Core..:? "exterior"))

instance Core.ToJSON GeoLocationPolygon where
        toJSON GeoLocationPolygon{..}
          = Core.object
              (Core.catMaybes [("exterior" Core..=) Core.<$> exterior])
...
newGeoSpectrumSchedule 
    ::  GeoSpectrumSchedule
newGeoSpectrumSchedule
  = GeoSpectrumSchedule{location = Core.Nothing,
          ...
          = Core.withObject "GeoSpectrumSchedule"
              (\ o ->
                 GeoSpectrumSchedule Core.<$>
                   (o Core..:? "location") Core.<*> (o Core..:? "spectrumSchedules"))
          ...
          = Core.object
              (Core.catMaybes
                 [("location" Core..=) Core.<$> location,
                  ("spectrumSchedules" Core..=) Core.<$> spectrumSchedules])
...
newPawsGetSpectrumBatchRequest 
    ::  PawsGetSpectrumBatchRequest
newPawsGetSpectrumBatchRequest
  = PawsGetSpectrumBatchRequest{antenna = Core.Nothing,
                                capabilities = Core.Nothing, deviceDesc = Core.Nothing,
                                locations = Core.Nothing, masterDeviceDesc = Core.Nothing,
                                owner = Core.Nothing, requestType = Core.Nothing,
                                type' = Core.Nothing, version = Core.Nothing}
instance Core.FromJSON PawsGetSpectrumBatchRequest where
        parseJSON
          = Core.withObject "PawsGetSpectrumBatchRequest"
              (\ o ->
                 PawsGetSpectrumBatchRequest Core.<$>
                   (o Core..:? "antenna") Core.<*> (o Core..:? "capabilities")
...
instance Core.ToJSON PawsGetSpectrumBatchRequest where
          ...
          = Core.object
              (Core.catMaybes
                 [("antenna" Core..=) Core.<$> antenna,
                  ...
                  ("masterDeviceDesc" Core..=) Core.<$> masterDeviceDesc,
                  ("owner" Core..=) Core.<$> owner,
...
newPawsGetSpectrumBatchResponse 
    ::  PawsGetSpectrumBatchResponse
newPawsGetSpectrumBatchResponse
  = PawsGetSpectrumBatchResponse{databaseChange = Core.Nothing,
                                 deviceDesc = Core.Nothing, geoSpectrumSchedules = Core.Nothing,
                                 kind = "spectrum#pawsGetSpectrumBatchResponse",
                                 maxContiguousBwHz = Core.Nothing, maxTotalBwHz = Core.Nothing,
                                 needsSpectrumReport = Core.Nothing, rulesetInfo = Core.Nothing,
                                 timestamp = Core.Nothing, type' = Core.Nothing,
                                 version = Core.Nothing}
instance Core.FromJSON PawsGetSpectrumBatchResponse where
        parseJSON
          = Core.withObject "PawsGetSpectrumBatchResponse"
              (\ o ->
                 PawsGetSpectrumBatchResponse Core.<$>
                   (o Core..:? "databaseChange") Core.<*> (o Core..:? "deviceDesc")
...
instance Core.ToJSON PawsGetSpectrumBatchResponse where
        toJSON PawsGetSpectrumBatchResponse{..}
          = Core.object
              (Core.catMaybes
                 [("databaseChange" Core..=) Core.<$> databaseChange,
                  ("deviceDesc" Core..=) Core.<$> deviceDesc,
                  ("geoSpectrumSchedules" Core..=) Core.<$> geoSpectrumSchedules,
                  Core.Just ("kind" Core..= kind),
                  ("maxContiguousBwHz" Core..=) Core.<$> maxContiguousBwHz,
                  ("maxTotalBwHz" Core..=) Core.<$> maxTotalBwHz,
                  ("needsSpectrumReport" Core..=) Core.<$> needsSpectrumReport,
...
newPawsGetSpectrumRequest 
    ::  PawsGetSpectrumRequest
newPawsGetSpectrumRequest
  = PawsGetSpectrumRequest{antenna = Core.Nothing,
                           capabilities = Core.Nothing, deviceDesc = Core.Nothing,
                           location = Core.Nothing, masterDeviceDesc = Core.Nothing,
                           owner = Core.Nothing, requestType = Core.Nothing,
                           type' = Core.Nothing, version = Core.Nothing}
...
newPawsGetSpectrumResponse 
    ::  PawsGetSpectrumResponse
newPawsGetSpectrumResponse
  = PawsGetSpectrumResponse{databaseChange = Core.Nothing,
                            deviceDesc = Core.Nothing,
                            kind = "spectrum#pawsGetSpectrumResponse",
                            maxContiguousBwHz = Core.Nothing, maxTotalBwHz = Core.Nothing,
                            needsSpectrumReport = Core.Nothing, rulesetInfo = Core.Nothing,
                            spectrumSchedules = Core.Nothing, timestamp = Core.Nothing,
                            type' = Core.Nothing, version = Core.Nothing}
          ...
          = Core.withObject "PawsGetSpectrumResponse"
              (\ o ->
                 PawsGetSpectrumResponse Core.<$>
                   (o Core..:? "databaseChange") Core.<*> (o Core..:? "deviceDesc")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "spectrum#pawsGetSpectrumResponse")
                     Core.<*> (o Core..:? "maxContiguousBwHz")
                     Core.<*> (o Core..:? "maxTotalBwHz")
                     Core.<*> (o Core..:? "needsSpectrumReport")
                     Core.<*> (o Core..:? "rulesetInfo")
...
newPawsInitRequest 
    ::  PawsInitRequest
newPawsInitRequest
  = PawsInitRequest{deviceDesc = Core.Nothing,
          ...
          = Core.withObject "PawsInitRequest"
              (\ o ->
                 PawsInitRequest Core.<$>
                   (o Core..:? "deviceDesc") Core.<*> (o Core..:? "location") Core.<*>
                     (o Core..:? "type")
                     Core.<*> (o Core..:? "version"))
...
newPawsInitResponse 
    ::  PawsInitResponse
newPawsInitResponse
  = PawsInitResponse{databaseChange = Core.Nothing,
                     kind = "spectrum#pawsInitResponse", rulesetInfo = Core.Nothing,
                     type' = Core.Nothing, version = Core.Nothing}
              ...
              (\ o ->
                 PawsInitResponse Core.<$>
                   (o Core..:? "databaseChange") Core.<*>
                     (o Core..:? "kind" Core..!= "spectrum#pawsInitResponse")
                     Core.<*> (o Core..:? "rulesetInfo")
                     Core.<*> (o Core..:? "type")
                     Core.<*> (o Core..:? "version"))
...
newPawsNotifySpectrumUseRequest 
    ::  PawsNotifySpectrumUseRequest
newPawsNotifySpectrumUseRequest
  = PawsNotifySpectrumUseRequest{deviceDesc = Core.Nothing,
                                 location = Core.Nothing, spectra = Core.Nothing,
                                 type' = Core.Nothing, version = Core.Nothing}
instance Core.FromJSON PawsNotifySpectrumUseRequest where
        parseJSON
...
instance Core.ToJSON PawsNotifySpectrumUseRequest where
...
newPawsNotifySpectrumUseResponse 
    ::  PawsNotifySpectrumUseResponse
newPawsNotifySpectrumUseResponse
  = PawsNotifySpectrumUseResponse{kind =
                                    "spectrum#pawsNotifySpectrumUseResponse",
                                  type' = Core.Nothing, version = Core.Nothing}
instance Core.FromJSON PawsNotifySpectrumUseResponse where
        parseJSON
...
instance Core.ToJSON PawsNotifySpectrumUseResponse where
        toJSON PawsNotifySpectrumUseResponse{..}
          = Core.object
              (Core.catMaybes
                 [Core.Just ("kind" Core..= kind), ("type" Core..=) Core.<$> type',
                  ("version" Core..=) Core.<$> version])
...
newPawsRegisterRequest 
    ::  PawsRegisterRequest
newPawsRegisterRequest
  = PawsRegisterRequest{antenna = Core.Nothing,
                        deviceDesc = Core.Nothing, deviceOwner = Core.Nothing,
                        location = Core.Nothing, type' = Core.Nothing,
                        version = Core.Nothing}
          ...
          = Core.withObject "PawsRegisterRequest"
              (\ o ->
                 PawsRegisterRequest Core.<$>
                   (o Core..:? "antenna") Core.<*> (o Core..:? "deviceDesc") Core.<*>
                     (o Core..:? "deviceOwner")
                     Core.<*> (o Core..:? "location")
                     Core.<*> (o Core..:? "type")
                     Core.<*> (o Core..:? "version"))
...
newPawsRegisterResponse 
    ::  PawsRegisterResponse
newPawsRegisterResponse
  = PawsRegisterResponse{databaseChange = Core.Nothing,
                         kind = "spectrum#pawsRegisterResponse", type' = Core.Nothing,
                         version = Core.Nothing}
          ...
          = Core.withObject "PawsRegisterResponse"
              (\ o ->
                 PawsRegisterResponse Core.<$>
                   (o Core..:? "databaseChange") Core.<*>
                     (o Core..:? "kind" Core..!= "spectrum#pawsRegisterResponse")
                     Core.<*> (o Core..:? "type")
                     Core.<*> (o Core..:? "version"))
...
newPawsVerifyDeviceRequest 
    ::  PawsVerifyDeviceRequest
newPawsVerifyDeviceRequest
  = PawsVerifyDeviceRequest{deviceDescs = Core.Nothing,
                            type' = Core.Nothing, version = Core.Nothing}
          ...
          = Core.withObject "PawsVerifyDeviceRequest"
              (\ o ->
                 PawsVerifyDeviceRequest Core.<$>
                   (o Core..:? "deviceDescs") Core.<*> (o Core..:? "type") Core.<*>
                     (o Core..:? "version"))
...
newPawsVerifyDeviceResponse 
    ::  PawsVerifyDeviceResponse
newPawsVerifyDeviceResponse
  = PawsVerifyDeviceResponse{databaseChange = Core.Nothing,
                             deviceValidities = Core.Nothing,
                             kind = "spectrum#pawsVerifyDeviceResponse", type' = Core.Nothing,
                             version = Core.Nothing}
          ...
          = Core.withObject "PawsVerifyDeviceResponse"
              (\ o ->
                 PawsVerifyDeviceResponse Core.<$>
                   (o Core..:? "databaseChange") Core.<*>
                     (o Core..:? "deviceValidities")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "spectrum#pawsVerifyDeviceResponse")
                     Core.<*> (o Core..:? "type")
                     Core.<*> (o Core..:? "version"))
...
instance Core.ToJSON PawsVerifyDeviceResponse where
        toJSON PawsVerifyDeviceResponse{..}
          = Core.object
              (Core.catMaybes
                 [("databaseChange" Core..=) Core.<$> databaseChange,
                  ("deviceValidities" Core..=) Core.<$> deviceValidities,
                  Core.Just ("kind" Core..= kind), ("type" Core..=) Core.<$> type',
                  ("version" Core..=) Core.<$> version])
...
newRulesetInfo 
    ::  RulesetInfo
newRulesetInfo
  = RulesetInfo{authority = Core.Nothing,
                maxLocationChange = Core.Nothing, maxPollingSecs = Core.Nothing,
...
instance Core.FromJSON RulesetInfo where
        parseJSON
          = Core.withObject "RulesetInfo"
              (\ o ->
                 RulesetInfo Core.<$>
                   (o Core..:? "authority") Core.<*> (o Core..:? "maxLocationChange")
          ...
          = Core.object
              (Core.catMaybes
                 [("authority" Core..=) Core.<$> authority,
                  ("maxLocationChange" Core..=) Core.<$> maxLocationChange,
...
newSpectrumMessage 
    ::  SpectrumMessage
newSpectrumMessage
  = SpectrumMessage{bandwidth = Core.Nothing,
                    frequencyRanges = Core.Nothing}
instance Core.FromJSON SpectrumMessage where
        parseJSON
          = Core.withObject "SpectrumMessage"
              (\ o ->
                 SpectrumMessage Core.<$>
                   (o Core..:? "bandwidth") Core.<*> (o Core..:? "frequencyRanges"))
...
newSpectrumSchedule 
    ::  SpectrumSchedule
newSpectrumSchedule
  = SpectrumSchedule{eventTime = Core.Nothing,
          ...
          = Core.withObject "SpectrumSchedule"
              (\ o ->
                 SpectrumSchedule Core.<$>
                   (o Core..:? "eventTime") Core.<*> (o Core..:? "spectra"))
...
newVcard 
    ::  Vcard
newVcard
  = Vcard{adr = Core.Nothing, email = Core.Nothing,
          fn = Core.Nothing, org = Core.Nothing, tel = Core.Nothing}
instance Core.FromJSON Vcard where
        parseJSON
          = Core.withObject "Vcard"
              (\ o ->
                 Vcard Core.<$>
                   (o Core..:? "adr") Core.<*> (o Core..:? "email") Core.<*>
                     (o Core..:? "fn")
                     Core.<*> (o Core..:? "org")
                     Core.<*> (o Core..:? "tel"))
...
instance Core.ToJSON Vcard where
        toJSON Vcard{..}
          = Core.object
              (Core.catMaybes
                 [("adr" Core..=) Core.<$> adr, ("email" Core..=) Core.<$> email,
                  ("fn" Core..=) Core.<$> fn, ("org" Core..=) Core.<$> org,
                  ("tel" Core..=) Core.<$> tel])
...
newVcardAddress 
    ::  VcardAddress
newVcardAddress
  = VcardAddress{code = Core.Nothing, country = Core.Nothing,
                 locality = Core.Nothing, pobox = Core.Nothing,
                 region = Core.Nothing, street = Core.Nothing}
