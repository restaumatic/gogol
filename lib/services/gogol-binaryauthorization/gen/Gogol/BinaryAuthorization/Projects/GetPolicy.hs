...
newBinaryAuthorizationProjectsGetPolicy name
  = BinaryAuthorizationProjectsGetPolicy{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         name = name, uploadType = Core.Nothing,
                                         uploadProtocol = Core.Nothing}
instance Core.GoogleRequest BinaryAuthorizationProjectsGetPolicy
         where
        type Rs BinaryAuthorizationProjectsGetPolicy = Policy
        type Scopes BinaryAuthorizationProjectsGetPolicy =
