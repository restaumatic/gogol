               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] EvaluateGkePolicyRequest Core.:>
...
newBinaryAuthorizationProjectsPlatformsGkePoliciesEvaluate 
    ...
    -> BinaryAuthorizationProjectsPlatformsGkePoliciesEvaluate
newBinaryAuthorizationProjectsPlatformsGkePoliciesEvaluate name
  payload
  = BinaryAuthorizationProjectsPlatformsGkePoliciesEvaluate{xgafv =
                                                              Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes BinaryAuthorizationProjectsPlatformsGkePoliciesEvaluate
