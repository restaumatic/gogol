...
newBinaryAuthorizationProjectsPlatformsPoliciesGet name
  = BinaryAuthorizationProjectsPlatformsPoliciesGet{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           BinaryAuthorizationProjectsPlatformsPoliciesGet
         where
        type Rs BinaryAuthorizationProjectsPlatformsPoliciesGet =
             PlatformPolicy
        type Scopes BinaryAuthorizationProjectsPlatformsPoliciesGet =
