                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] PlatformPolicy Core.:>
                           Core.Post '[Core.JSON] PlatformPolicy
...
newBinaryAuthorizationProjectsPlatformsPoliciesCreate 
    ...
    -> BinaryAuthorizationProjectsPlatformsPoliciesCreate
newBinaryAuthorizationProjectsPlatformsPoliciesCreate parent
  payload
  = BinaryAuthorizationProjectsPlatformsPoliciesCreate{xgafv =
                                                         Core.Nothing,
                                                       accessToken = Core.Nothing,
                                                       callback = Core.Nothing, parent = parent,
                                                       payload = payload, policyId = Core.Nothing,
                                                       uploadType = Core.Nothing,
                                                       uploadProtocol = Core.Nothing}
instance Core.GoogleRequest
           BinaryAuthorizationProjectsPlatformsPoliciesCreate
         where
        type Rs BinaryAuthorizationProjectsPlatformsPoliciesCreate =
             PlatformPolicy
        type Scopes BinaryAuthorizationProjectsPlatformsPoliciesCreate =
             '[CloudPlatform'FullControl]
        requestClient
          BinaryAuthorizationProjectsPlatformsPoliciesCreate{..}
          = go parent xgafv accessToken callback policyId uploadType
              uploadProtocol
