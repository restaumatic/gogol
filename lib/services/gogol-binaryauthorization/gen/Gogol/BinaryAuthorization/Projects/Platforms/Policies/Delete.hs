...
newBinaryAuthorizationProjectsPlatformsPoliciesDelete name
  = BinaryAuthorizationProjectsPlatformsPoliciesDelete{xgafv =
                                                         Core.Nothing,
...
instance Core.GoogleRequest
           BinaryAuthorizationProjectsPlatformsPoliciesDelete
         where
        type Rs BinaryAuthorizationProjectsPlatformsPoliciesDelete = Empty
        type Scopes BinaryAuthorizationProjectsPlatformsPoliciesDelete =
