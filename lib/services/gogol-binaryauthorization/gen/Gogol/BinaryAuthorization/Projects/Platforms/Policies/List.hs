                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] ListPlatformPoliciesResponse
...
newBinaryAuthorizationProjectsPlatformsPoliciesList parent
  = BinaryAuthorizationProjectsPlatformsPoliciesList{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           BinaryAuthorizationProjectsPlatformsPoliciesList
         where
        type Rs BinaryAuthorizationProjectsPlatformsPoliciesList =
             ListPlatformPoliciesResponse
        type Scopes BinaryAuthorizationProjectsPlatformsPoliciesList =
