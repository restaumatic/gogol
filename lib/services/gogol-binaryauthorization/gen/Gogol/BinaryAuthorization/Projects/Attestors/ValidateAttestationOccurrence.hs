...
type BinaryAuthorizationProjectsAttestorsValidateAttestationOccurrenceResource
     =
     "v1" Core.:>
       Core.CaptureMode "attestor" "validateAttestationOccurrence"
         Core.Text
         Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] ValidateAttestationOccurrenceRequest
                       Core.:>
                       Core.Post '[Core.JSON] ValidateAttestationOccurrenceResponse
...
newBinaryAuthorizationProjectsAttestorsValidateAttestationOccurrence
  attestor payload
  = BinaryAuthorizationProjectsAttestorsValidateAttestationOccurrence{xgafv
                                                                        = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        requestClient
          BinaryAuthorizationProjectsAttestorsValidateAttestationOccurrence{..}
          = go attestor xgafv accessToken callback uploadType uploadProtocol
