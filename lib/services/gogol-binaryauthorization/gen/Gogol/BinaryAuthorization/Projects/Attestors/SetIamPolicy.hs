...
newBinaryAuthorizationProjectsAttestorsSetIamPolicy 
    ...
    -> BinaryAuthorizationProjectsAttestorsSetIamPolicy
newBinaryAuthorizationProjectsAttestorsSetIamPolicy payload
  resource
  = BinaryAuthorizationProjectsAttestorsSetIamPolicy{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           BinaryAuthorizationProjectsAttestorsSetIamPolicy
         where
        type Rs BinaryAuthorizationProjectsAttestorsSetIamPolicy =
             IamPolicy
        type Scopes BinaryAuthorizationProjectsAttestorsSetIamPolicy =
             '[CloudPlatform'FullControl]
        requestClient BinaryAuthorizationProjectsAttestorsSetIamPolicy{..}
