...
newBinaryAuthorizationProjectsAttestorsGet name
  = BinaryAuthorizationProjectsAttestorsGet{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            name = name, uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest BinaryAuthorizationProjectsAttestorsGet
         where
        type Rs BinaryAuthorizationProjectsAttestorsGet = Attestor
        type Scopes BinaryAuthorizationProjectsAttestorsGet =
             '[CloudPlatform'FullControl]
        requestClient BinaryAuthorizationProjectsAttestorsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy BinaryAuthorizationProjectsAttestorsGetResource)
                      Core.mempty
