...
newBinaryAuthorizationProjectsAttestorsUpdate name payload
  = BinaryAuthorizationProjectsAttestorsUpdate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           BinaryAuthorizationProjectsAttestorsUpdate
         where
        type Rs BinaryAuthorizationProjectsAttestorsUpdate = Attestor
        type Scopes BinaryAuthorizationProjectsAttestorsUpdate =
             '[CloudPlatform'FullControl]
        requestClient BinaryAuthorizationProjectsAttestorsUpdate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy BinaryAuthorizationProjectsAttestorsUpdateResource)
                      Core.mempty
