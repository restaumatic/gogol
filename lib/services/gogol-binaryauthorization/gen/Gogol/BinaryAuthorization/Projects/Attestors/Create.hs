...
newBinaryAuthorizationProjectsAttestorsCreate parent payload
  = BinaryAuthorizationProjectsAttestorsCreate{xgafv = Core.Nothing,
                                               accessToken = Core.Nothing,
                                               attestorId = Core.Nothing, callback = Core.Nothing,
...
instance Core.GoogleRequest
           BinaryAuthorizationProjectsAttestorsCreate
         where
        type Rs BinaryAuthorizationProjectsAttestorsCreate = Attestor
        type Scopes BinaryAuthorizationProjectsAttestorsCreate =
             '[CloudPlatform'FullControl]
        requestClient BinaryAuthorizationProjectsAttestorsCreate{..}
          = go parent xgafv accessToken attestorId callback uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy BinaryAuthorizationProjectsAttestorsCreateResource)
                      Core.mempty
