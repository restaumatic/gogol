...
instance Core.GoogleRequest
           BinaryAuthorizationProjectsPolicySetIamPolicy
         where
        type Rs BinaryAuthorizationProjectsPolicySetIamPolicy = IamPolicy
        type Scopes BinaryAuthorizationProjectsPolicySetIamPolicy =
             '[CloudPlatform'FullControl]
        requestClient BinaryAuthorizationProjectsPolicySetIamPolicy{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy BinaryAuthorizationProjectsPolicySetIamPolicyResource)
                      Core.mempty
