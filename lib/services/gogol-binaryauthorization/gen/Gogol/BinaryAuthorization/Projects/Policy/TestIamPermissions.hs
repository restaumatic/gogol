...
newBinaryAuthorizationProjectsPolicyTestIamPermissions 
    ...
    -> BinaryAuthorizationProjectsPolicyTestIamPermissions
newBinaryAuthorizationProjectsPolicyTestIamPermissions payload
  resource
  = BinaryAuthorizationProjectsPolicyTestIamPermissions{xgafv =
                                                          Core.Nothing,
...
instance Core.GoogleRequest
           BinaryAuthorizationProjectsPolicyTestIamPermissions
         where
        type Rs BinaryAuthorizationProjectsPolicyTestIamPermissions =
             TestIamPermissionsResponse
        type Scopes BinaryAuthorizationProjectsPolicyTestIamPermissions =
