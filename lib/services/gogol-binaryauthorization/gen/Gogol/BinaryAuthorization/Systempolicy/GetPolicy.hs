...
newBinaryAuthorizationSystempolicyGetPolicy name
  = BinaryAuthorizationSystempolicyGetPolicy{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           BinaryAuthorizationSystempolicyGetPolicy
         where
        type Rs BinaryAuthorizationSystempolicyGetPolicy = Policy
        type Scopes BinaryAuthorizationSystempolicyGetPolicy =
             '[CloudPlatform'FullControl]
        requestClient BinaryAuthorizationSystempolicyGetPolicy{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy BinaryAuthorizationSystempolicyGetPolicyResource)
                      Core.mempty
