...
newAdmissionRule 
    ::  AdmissionRule
newAdmissionRule
  = AdmissionRule{enforcementMode = Core.Nothing,
...
instance Core.ToJSON AdmissionRule where
        toJSON AdmissionRule{..}
          = Core.object
              (Core.catMaybes
                 [("enforcementMode" Core..=) Core.<$> enforcementMode,
                  ("evaluationMode" Core..=) Core.<$> evaluationMode,
                  ("requireAttestationsBy" Core..=) Core.<$> requireAttestationsBy])
...
instance Core.FromJSON AdmissionWhitelistPattern where
        parseJSON
          = Core.withObject "AdmissionWhitelistPattern"
              (\ o ->
                 AdmissionWhitelistPattern Core.<$> (o Core..:? "namePattern"))

instance Core.ToJSON AdmissionWhitelistPattern where
        toJSON AdmissionWhitelistPattern{..}
          = Core.object
              (Core.catMaybes [("namePattern" Core..=) Core.<$> namePattern])
...
instance Core.FromJSON AllowlistResult where
        parseJSON
          = Core.withObject "AllowlistResult"
              (\ o -> AllowlistResult Core.<$> (o Core..:? "matchedPattern"))
...
newAttestationAuthenticator 
    ::  AttestationAuthenticator
newAttestationAuthenticator
  = AttestationAuthenticator{displayName = Core.Nothing,
                             pkixPublicKeySet = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("displayName" Core..=) Core.<$> displayName,
                  ("pkixPublicKeySet" Core..=) Core.<$> pkixPublicKeySet])
...
instance Core.ToJSON AttestationSource where
        toJSON AttestationSource{..}
          = Core.object
              (Core.catMaybes
                 [("containerAnalysisAttestationProjects" Core..=) Core.<$>
...
newAttestor 
    ::  Attestor
newAttestor
  = Attestor{description = Core.Nothing, etag = Core.Nothing,
          ...
          = Core.object
              (Core.catMaybes
                 [("description" Core..=) Core.<$> description,
                  ...
                  ("userOwnedGrafeasNote" Core..=) Core.<$> userOwnedGrafeasNote])
...
newAttestorPublicKey 
    ::  AttestorPublicKey
newAttestorPublicKey
  = AttestorPublicKey{asciiArmoredPgpPublicKey = Core.Nothing,
                      comment = Core.Nothing, id = Core.Nothing,
          ...
          = Core.object
              (Core.catMaybes
                 [("asciiArmoredPgpPublicKey" Core..=) Core.<$>
                  ...
                  ("comment" Core..=) Core.<$> comment, ("id" Core..=) Core.<$> id,
...
newCheck 
    ::  Check
newCheck
  = Check{alwaysDeny = Core.Nothing, displayName = Core.Nothing,
          imageAllowlist = Core.Nothing, imageFreshnessCheck = Core.Nothing,
          sigstoreSignatureCheck = Core.Nothing,
          simpleSigningAttestationCheck = Core.Nothing,
          slsaCheck = Core.Nothing, trustedDirectoryCheck = Core.Nothing,
...
instance Core.FromJSON Check where
        parseJSON
          = Core.withObject "Check"
              (\ o ->
                 Check Core.<$>
                   (o Core..:? "alwaysDeny") Core.<*> (o Core..:? "displayName")
          ...
          = Core.object
              (Core.catMaybes
                 [("alwaysDeny" Core..=) Core.<$> alwaysDeny,
                  ...
                  ("imageFreshnessCheck" Core..=) Core.<$> imageFreshnessCheck,
                  ("sigstoreSignatureCheck" Core..=) Core.<$> sigstoreSignatureCheck,
                  ("simpleSigningAttestationCheck" Core..=) Core.<$>
                    simpleSigningAttestationCheck,
                  ("slsaCheck" Core..=) Core.<$> slsaCheck,
                  ("trustedDirectoryCheck" Core..=) Core.<$> trustedDirectoryCheck,
                  ("vulnerabilityCheck" Core..=) Core.<$> vulnerabilityCheck])
...
newCheckResult 
    ::  CheckResult
newCheckResult
  = CheckResult{allowlistResult = Core.Nothing,
                displayName = Core.Nothing, evaluationResult = Core.Nothing,
                explanation = Core.Nothing, index = Core.Nothing,
                type' = Core.Nothing}
instance Core.FromJSON CheckResult where
        parseJSON
          = Core.withObject "CheckResult"
              (\ o ->
                 CheckResult Core.<$>
                   (o Core..:? "allowlistResult") Core.<*> (o Core..:? "displayName")
                     Core.<*> (o Core..:? "evaluationResult")
                     Core.<*> (o Core..:? "explanation")
                     Core.<*> (o Core..:? "index" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "type"))
...
instance Core.ToJSON CheckResult where
        toJSON CheckResult{..}
          = Core.object
              (Core.catMaybes
                 [("allowlistResult" Core..=) Core.<$> allowlistResult,
                  ("displayName" Core..=) Core.<$> displayName,
...
newCheckSet 
    ::  CheckSet
newCheckSet
  = CheckSet{checks = Core.Nothing, displayName = Core.Nothing,
             imageAllowlist = Core.Nothing, scope = Core.Nothing}
instance Core.FromJSON CheckSet where
        parseJSON
          = Core.withObject "CheckSet"
              (\ o ->
                 CheckSet Core.<$>
                   (o Core..:? "checks") Core.<*> (o Core..:? "displayName") Core.<*>
...
newCheckSetResult 
    ::  CheckSetResult
newCheckSetResult
  = CheckSetResult{allowlistResult = Core.Nothing,
                   checkResults = Core.Nothing, displayName = Core.Nothing,
                   explanation = Core.Nothing, index = Core.Nothing,
                   scope = Core.Nothing}
instance Core.FromJSON CheckSetResult where
        parseJSON
          = Core.withObject "CheckSetResult"
              (\ o ->
                 CheckSetResult Core.<$>
                   (o Core..:? "allowlistResult") Core.<*> (o Core..:? "checkResults")
...
instance Core.FromJSON EvaluateGkePolicyRequest_Resource where
        parseJSON
...
instance Core.ToJSON EvaluateGkePolicyRequest_Resource where
...
newEvaluateGkePolicyResponse 
    ::  EvaluateGkePolicyResponse
newEvaluateGkePolicyResponse
  = EvaluateGkePolicyResponse{results = Core.Nothing,
                              verdict = Core.Nothing}
instance Core.FromJSON EvaluateGkePolicyResponse where
        parseJSON
          = Core.withObject "EvaluateGkePolicyResponse"
              (\ o ->
                 EvaluateGkePolicyResponse Core.<$>
                   (o Core..:? "results") Core.<*> (o Core..:? "verdict"))
...
instance Core.FromJSON EvaluationResult where
        parseJSON
          = Core.withObject "EvaluationResult"
              (\ o -> EvaluationResult Core.<$> (o Core..:? "verdict"))

instance Core.ToJSON EvaluationResult where
        toJSON EvaluationResult{..}
          = Core.object
              (Core.catMaybes [("verdict" Core..=) Core.<$> verdict])
...
newGkePolicy 
    ::  GkePolicy
newGkePolicy
  = GkePolicy{checkSets = Core.Nothing,
...
instance Core.FromJSON GkePolicy where
        parseJSON
          = Core.withObject "GkePolicy"
              (\ o ->
                 GkePolicy Core.<$>
                   (o Core..:? "checkSets") Core.<*> (o Core..:? "imageAllowlist"))
...
newIamPolicy 
    ::  IamPolicy
newIamPolicy
  = IamPolicy{bindings = Core.Nothing, etag = Core.Nothing,
...
instance Core.FromJSON ImageAllowlist where
        parseJSON
          = Core.withObject "ImageAllowlist"
              (\ o -> ImageAllowlist Core.<$> (o Core..:? "allowPattern"))

instance Core.ToJSON ImageAllowlist where
        toJSON ImageAllowlist{..}
          = Core.object
              (Core.catMaybes [("allowPattern" Core..=) Core.<$> allowPattern])
...
newImageResult 
    ::  ImageResult
newImageResult
  = ImageResult{allowlistResult = Core.Nothing,
                checkSetResult = Core.Nothing, explanation = Core.Nothing,
                imageUri = Core.Nothing, verdict = Core.Nothing}
...
newListAttestorsResponse 
    ::  ListAttestorsResponse
newListAttestorsResponse
  = ListAttestorsResponse{attestors = Core.Nothing,
          ...
          = Core.withObject "ListAttestorsResponse"
              (\ o ->
                 ListAttestorsResponse Core.<$>
                   (o Core..:? "attestors") Core.<*> (o Core..:? "nextPageToken"))
...
newListPlatformPoliciesResponse 
    ::  ListPlatformPoliciesResponse
newListPlatformPoliciesResponse
  = ListPlatformPoliciesResponse{nextPageToken = Core.Nothing,
                                 platformPolicies = Core.Nothing}
instance Core.FromJSON ListPlatformPoliciesResponse where
        parseJSON
...
instance Core.ToJSON ListPlatformPoliciesResponse where
        toJSON ListPlatformPoliciesResponse{..}
          = Core.object
              (Core.catMaybes
                 [("nextPageToken" Core..=) Core.<$> nextPageToken,
                  ("platformPolicies" Core..=) Core.<$> platformPolicies])
...
newPkixPublicKey 
    ::  PkixPublicKey
newPkixPublicKey
  = PkixPublicKey{keyId = Core.Nothing, publicKeyPem = Core.Nothing,
...
instance Core.FromJSON PkixPublicKey where
        parseJSON
          = Core.withObject "PkixPublicKey"
              (\ o ->
                 PkixPublicKey Core.<$>
                   (o Core..:? "keyId") Core.<*> (o Core..:? "publicKeyPem") Core.<*>
...
newPkixPublicKeySet 
    ::  PkixPublicKeySet
newPkixPublicKeySet
  = PkixPublicKeySet{pkixPublicKeys = Core.Nothing}
instance Core.FromJSON PkixPublicKeySet where
        parseJSON
          = Core.withObject "PkixPublicKeySet"
              (\ o -> PkixPublicKeySet Core.<$> (o Core..:? "pkixPublicKeys"))
...
newPlatformPolicy 
    ::  PlatformPolicy
newPlatformPolicy
  = PlatformPolicy{description = Core.Nothing, etag = Core.Nothing,
                   gkePolicy = Core.Nothing, name = Core.Nothing,
...
newPodResult 
    ::  PodResult
newPodResult
  = PodResult{imageResults = Core.Nothing,
              kubernetesNamespace = Core.Nothing,
              kubernetesServiceAccount = Core.Nothing, podName = Core.Nothing,
              verdict = Core.Nothing}
...
newPolicy 
    ::  Policy
newPolicy
  = Policy{admissionWhitelistPatterns = Core.Nothing,
           clusterAdmissionRules = Core.Nothing,
           defaultAdmissionRule = Core.Nothing, description = Core.Nothing,
           etag = Core.Nothing, globalPolicyEvaluationMode = Core.Nothing,
              ...
              (\ o ->
                 Policy Core.<$>
                   (o Core..:? "admissionWhitelistPatterns") Core.<*>
                     ...
                     Core.<*> (o Core..:? "istioServiceIdentityAdmissionRules")
                     Core.<*> (o Core..:? "kubernetesNamespaceAdmissionRules")
                     Core.<*> (o Core..:? "kubernetesServiceAccountAdmissionRules")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "updateTime"))
          ...
          = Core.object
              (Core.catMaybes
                 [("admissionWhitelistPatterns" Core..=) Core.<$>
                  ...
                  ("clusterAdmissionRules" Core..=) Core.<$> clusterAdmissionRules,
                  ("defaultAdmissionRule" Core..=) Core.<$> defaultAdmissionRule,
                  ("description" Core..=) Core.<$> description,
                  ("etag" Core..=) Core.<$> etag,
                  ("globalPolicyEvaluationMode" Core..=) Core.<$>
                    globalPolicyEvaluationMode,
                  ("istioServiceIdentityAdmissionRules" Core..=) Core.<$>
                    istioServiceIdentityAdmissionRules,
                  ("kubernetesNamespaceAdmissionRules" Core..=) Core.<$>
                    kubernetesNamespaceAdmissionRules,
                  ("kubernetesServiceAccountAdmissionRules" Core..=) Core.<$>
...
instance Core.FromJSON Policy_ClusterAdmissionRules where
        parseJSON
          = Core.withObject "Policy_ClusterAdmissionRules"
              (\ o ->
                 Policy_ClusterAdmissionRules Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON Policy_ClusterAdmissionRules where
        toJSON Policy_ClusterAdmissionRules{..} = Core.toJSON additional
...
newPolicy_IstioServiceIdentityAdmissionRules additional
  = Policy_IstioServiceIdentityAdmissionRules{additional =
                                                additional}
instance Core.FromJSON Policy_IstioServiceIdentityAdmissionRules
         where
        parseJSON
          = Core.withObject "Policy_IstioServiceIdentityAdmissionRules"
              (\ o ->
                 Policy_IstioServiceIdentityAdmissionRules Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON Policy_IstioServiceIdentityAdmissionRules
         where
...
instance Core.FromJSON Policy_KubernetesNamespaceAdmissionRules
         where
        parseJSON
          = Core.withObject "Policy_KubernetesNamespaceAdmissionRules"
              (\ o ->
                 Policy_KubernetesNamespaceAdmissionRules Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON Policy_KubernetesNamespaceAdmissionRules where
...
newPolicy_KubernetesServiceAccountAdmissionRules additional
  = Policy_KubernetesServiceAccountAdmissionRules{additional =
                                                    additional}
instance Core.FromJSON
           Policy_KubernetesServiceAccountAdmissionRules
         where
        parseJSON
          = Core.withObject "Policy_KubernetesServiceAccountAdmissionRules"
              (\ o ->
                 Policy_KubernetesServiceAccountAdmissionRules Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON Policy_KubernetesServiceAccountAdmissionRules
         where
        toJSON Policy_KubernetesServiceAccountAdmissionRules{..}
          = Core.toJSON additional
...
newScope 
    ::  Scope
newScope
  = Scope{kubernetesNamespace = Core.Nothing,
...
newSigstoreAuthority 
    ::  SigstoreAuthority
newSigstoreAuthority
  = SigstoreAuthority{displayName = Core.Nothing,
                      publicKeySet = Core.Nothing}
instance Core.FromJSON SigstoreAuthority where
        parseJSON
          = Core.withObject "SigstoreAuthority"
              (\ o ->
                 SigstoreAuthority Core.<$>
                   (o Core..:? "displayName") Core.<*> (o Core..:? "publicKeySet"))
...
instance Core.FromJSON SigstoreSignatureCheck where
        parseJSON
          = Core.withObject "SigstoreSignatureCheck"
              (\ o ->
                 SigstoreSignatureCheck Core.<$> (o Core..:? "sigstoreAuthorities"))

instance Core.ToJSON SigstoreSignatureCheck where
        toJSON SigstoreSignatureCheck{..}
          = Core.object
              (Core.catMaybes
                 [("sigstoreAuthorities" Core..=) Core.<$> sigstoreAuthorities])
...
instance Core.FromJSON SimpleSigningAttestationCheck where
        parseJSON
...
instance Core.ToJSON SimpleSigningAttestationCheck where
...
instance Core.FromJSON TrustedDirectoryCheck where
        parseJSON
          = Core.withObject "TrustedDirectoryCheck"
              (\ o ->
                 TrustedDirectoryCheck Core.<$> (o Core..:? "trustedDirPatterns"))

instance Core.ToJSON TrustedDirectoryCheck where
        toJSON TrustedDirectoryCheck{..}
          = Core.object
              (Core.catMaybes
                 [("trustedDirPatterns" Core..=) Core.<$> trustedDirPatterns])
...
newUserOwnedGrafeasNote
  = UserOwnedGrafeasNote{delegationServiceAccountEmail =
                           Core.Nothing,
                         noteReference = Core.Nothing, publicKeys = Core.Nothing}
...
newValidateAttestationOccurrenceRequest 
    :: 
                                        ValidateAttestationOccurrenceRequest
newValidateAttestationOccurrenceRequest
  = ValidateAttestationOccurrenceRequest{attestation = Core.Nothing,
                                         occurrenceNote = Core.Nothing,
                                         occurrenceResourceUri = Core.Nothing}
instance Core.FromJSON ValidateAttestationOccurrenceRequest where
        parseJSON
          = Core.withObject "ValidateAttestationOccurrenceRequest"
              (\ o ->
                 ValidateAttestationOccurrenceRequest Core.<$>
                   (o Core..:? "attestation") Core.<*> (o Core..:? "occurrenceNote")
                     Core.<*> (o Core..:? "occurrenceResourceUri"))

instance Core.ToJSON ValidateAttestationOccurrenceRequest where
        toJSON ValidateAttestationOccurrenceRequest{..}
          = Core.object
              (Core.catMaybes
                 [("attestation" Core..=) Core.<$> attestation,
                  ("occurrenceNote" Core..=) Core.<$> occurrenceNote,
                  ("occurrenceResourceUri" Core..=) Core.<$> occurrenceResourceUri])
...
newValidateAttestationOccurrenceResponse
  = ValidateAttestationOccurrenceResponse{denialReason =
                                            Core.Nothing,
                                          result = Core.Nothing}
instance Core.FromJSON ValidateAttestationOccurrenceResponse where
        parseJSON
          = Core.withObject "ValidateAttestationOccurrenceResponse"
              (\ o ->
                 ValidateAttestationOccurrenceResponse Core.<$>
                   (o Core..:? "denialReason") Core.<*> (o Core..:? "result"))

instance Core.ToJSON ValidateAttestationOccurrenceResponse where
...
data VerificationRule = VerificationRule
    ...
    , customConstraints :: (Core.Maybe Core.Text)
...
newVerificationRule 
    ::  VerificationRule
newVerificationRule
  = VerificationRule{attestationSource = Core.Nothing,
                     configBasedBuildRequired = Core.Nothing,
                     customConstraints = Core.Nothing, trustedBuilder = Core.Nothing,
...
instance Core.ToJSON VerificationRule where
        toJSON VerificationRule{..}
          = Core.object
              (Core.catMaybes
                 [("attestationSource" Core..=) Core.<$> attestationSource,
                  ("configBasedBuildRequired" Core..=) Core.<$>
                    configBasedBuildRequired,
                  ("customConstraints" Core..=) Core.<$> customConstraints,
...
newVulnerabilityCheck 
    ::  VulnerabilityCheck
newVulnerabilityCheck
  = VulnerabilityCheck{allowedCves = Core.Nothing,
          ...
          = Core.withObject "VulnerabilityCheck"
              (\ o ->
                 VulnerabilityCheck Core.<$>
                   (o Core..:? "allowedCves") Core.<*> (o Core..:? "blockedCves")
                     Core.<*> (o Core..:? "containerAnalysisVulnerabilityProjects")
          ...
          = Core.object
              (Core.catMaybes
                 [("allowedCves" Core..=) Core.<$> allowedCves,
                  ...
                  ("containerAnalysisVulnerabilityProjects" Core..=) Core.<$>
                    containerAnalysisVulnerabilityProjects,
                  ("maximumFixableSeverity" Core..=) Core.<$> maximumFixableSeverity,
