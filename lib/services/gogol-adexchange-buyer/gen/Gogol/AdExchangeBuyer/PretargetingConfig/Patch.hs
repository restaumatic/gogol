...
newAdExchangeBuyerPretargetingConfigPatch 
    ...
    -> AdExchangeBuyerPretargetingConfigPatch
newAdExchangeBuyerPretargetingConfigPatch accountId configId
  payload
  = AdExchangeBuyerPretargetingConfigPatch{accountId = accountId,
                                           configId = configId, payload = payload}
instance Core.GoogleRequest AdExchangeBuyerPretargetingConfigPatch
         where
