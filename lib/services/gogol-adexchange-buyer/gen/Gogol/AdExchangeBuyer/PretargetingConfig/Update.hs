             ...
             Core.Capture "configId" Core.Int64 Core.:>
               Core.QueryParam "alt" Core.AltJSON Core.:>
                 Core.ReqBody '[Core.JSON] PretargetingConfig Core.:>
                   Core.Put '[Core.JSON] PretargetingConfig
...
newAdExchangeBuyerPretargetingConfigUpdate 
    ...
    -> AdExchangeBuyerPretargetingConfigUpdate
newAdExchangeBuyerPretargetingConfigUpdate accountId configId
  payload
  = AdExchangeBuyerPretargetingConfigUpdate{accountId = accountId,
                                            configId = configId, payload = payload}
instance Core.GoogleRequest AdExchangeBuyerPretargetingConfigUpdate
         where
        type Rs AdExchangeBuyerPretargetingConfigUpdate =
             PretargetingConfig
        type Scopes AdExchangeBuyerPretargetingConfigUpdate =
             '[Adexchange'Buyer]
        requestClient AdExchangeBuyerPretargetingConfigUpdate{..}
          = go accountId configId (Core.Just Core.AltJSON) payload
              adExchangeBuyerService
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AdExchangeBuyerPretargetingConfigUpdateResource)
                      Core.mempty
