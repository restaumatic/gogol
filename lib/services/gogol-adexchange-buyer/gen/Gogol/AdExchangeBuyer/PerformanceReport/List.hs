...
newAdExchangeBuyerPerformanceReportList 
    ...
    -> AdExchangeBuyerPerformanceReportList
newAdExchangeBuyerPerformanceReportList accountId endDateTime
  startDateTime
  = AdExchangeBuyerPerformanceReportList{accountId = accountId,
                                         endDateTime = endDateTime, maxResults = Core.Nothing,
                                         pageToken = Core.Nothing, startDateTime = startDateTime}
instance Core.GoogleRequest AdExchangeBuyerPerformanceReportList
         where
