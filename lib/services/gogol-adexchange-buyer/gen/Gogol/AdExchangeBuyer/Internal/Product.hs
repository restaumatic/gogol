...
newAccount 
    ::  Account
newAccount
  = Account{applyPretargetingToNonGuaranteedDeals = Core.Nothing,
            bidderLocation = Core.Nothing, cookieMatchingNid = Core.Nothing,
            cookieMatchingUrl = Core.Nothing, id = Core.Nothing,
...
instance Core.FromJSON Account where
        parseJSON
          = Core.withObject "Account"
              (\ o ->
                 Account Core.<$>
                   (o Core..:? "applyPretargetingToNonGuaranteedDeals") Core.<*>
                     (o Core..:? "bidderLocation")
                     Core.<*> (o Core..:? "cookieMatchingNid")
                     Core.<*> (o Core..:? "cookieMatchingUrl")
                     Core.<*> (o Core..:? "id")
                     Core.<*> (o Core..:? "kind" Core..!= "adexchangebuyer#account")
...
instance Core.ToJSON Account where
        toJSON Account{..}
          = Core.object
              (Core.catMaybes
                 [("applyPretargetingToNonGuaranteedDeals" Core..=) Core.<$>
                    applyPretargetingToNonGuaranteedDeals,
                  ("bidderLocation" Core..=) Core.<$> bidderLocation,
                  ("cookieMatchingNid" Core..=) Core.<$> cookieMatchingNid,
                  ("cookieMatchingUrl" Core..=) Core.<$> cookieMatchingUrl,
                  ("id" Core..=) Core.<$> id, Core.Just ("kind" Core..= kind),
                  ("maximumActiveCreatives" Core..=) Core.<$> maximumActiveCreatives,
                  ("maximumTotalQps" Core..=) Core.<$> maximumTotalQps,
                  ("numberActiveCreatives" Core..=) Core.<$> numberActiveCreatives])
...
newAccount_BidderLocationItem 
    ::  Account_BidderLocationItem
newAccount_BidderLocationItem
  = Account_BidderLocationItem{bidProtocol = Core.Nothing,
                               maximumQps = Core.Nothing, region = Core.Nothing,
                               url = Core.Nothing}
instance Core.FromJSON Account_BidderLocationItem where
        parseJSON
          = Core.withObject "Account_BidderLocationItem"
              (\ o ->
                 Account_BidderLocationItem Core.<$>
                   (o Core..:? "bidProtocol") Core.<*> (o Core..:? "maximumQps")
                     Core.<*> (o Core..:? "region")
                     Core.<*> (o Core..:? "url"))
          ...
          = Core.object
              (Core.catMaybes
                 [("bidProtocol" Core..=) Core.<$> bidProtocol,
                  ...
                  ("region" Core..=) Core.<$> region, ("url" Core..=) Core.<$> url])
...
newAccountsList 
    ::  AccountsList
newAccountsList
  = AccountsList{items = Core.Nothing,
                 kind = "adexchangebuyer#accountsList"}
instance Core.FromJSON AccountsList where
        parseJSON
          = Core.withObject "AccountsList"
              (\ o ->
                 AccountsList Core.<$>
                   (o Core..:? "items") Core.<*>
                     (o Core..:? "kind" Core..!= "adexchangebuyer#accountsList"))
...
newAddOrderDealsRequest 
    ::  AddOrderDealsRequest
newAddOrderDealsRequest
  = AddOrderDealsRequest{deals = Core.Nothing,
                         proposalRevisionNumber = Core.Nothing, updateAction = Core.Nothing}
instance Core.FromJSON AddOrderDealsRequest where
        parseJSON
          = Core.withObject "AddOrderDealsRequest"
              (\ o ->
                 AddOrderDealsRequest Core.<$>
                   (o Core..:? "deals") Core.<*>
                     (o Core..:? "proposalRevisionNumber" Core.<&>
          ...
          = Core.object
              (Core.catMaybes
                 [("deals" Core..=) Core.<$> deals,
                  ("proposalRevisionNumber" Core..=) Core.. Core.AsText Core.<$>
...
newAddOrderDealsResponse 
    ::  AddOrderDealsResponse
newAddOrderDealsResponse
  = AddOrderDealsResponse{deals = Core.Nothing,
                          proposalRevisionNumber = Core.Nothing}
instance Core.FromJSON AddOrderDealsResponse where
        parseJSON
          = Core.withObject "AddOrderDealsResponse"
              (\ o ->
                 AddOrderDealsResponse Core.<$>
                   (o Core..:? "deals") Core.<*>
                     (o Core..:? "proposalRevisionNumber" Core.<&>
                        Core.fmap Core.fromAsText))
...
newAddOrderNotesRequest 
    ::  AddOrderNotesRequest
newAddOrderNotesRequest
  = AddOrderNotesRequest{notes = Core.Nothing}
instance Core.FromJSON AddOrderNotesRequest where
        parseJSON
          = Core.withObject "AddOrderNotesRequest"
              (\ o -> AddOrderNotesRequest Core.<$> (o Core..:? "notes"))
...
newAddOrderNotesResponse 
    ::  AddOrderNotesResponse
newAddOrderNotesResponse
  = AddOrderNotesResponse{notes = Core.Nothing}
instance Core.FromJSON AddOrderNotesResponse where
        parseJSON
          = Core.withObject "AddOrderNotesResponse"
              (\ o -> AddOrderNotesResponse Core.<$> (o Core..:? "notes"))
...
newBillingInfo 
    ::  BillingInfo
newBillingInfo
  = BillingInfo{accountId = Core.Nothing, accountName = Core.Nothing,
                billingId = Core.Nothing, kind = "adexchangebuyer#billingInfo"}
instance Core.FromJSON BillingInfo where
        parseJSON
          = Core.withObject "BillingInfo"
              (\ o ->
                 BillingInfo Core.<$>
                   (o Core..:? "accountId") Core.<*> (o Core..:? "accountName")
                     Core.<*> (o Core..:? "billingId")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "adexchangebuyer#billingInfo"))
...
newBillingInfoList 
    ::  BillingInfoList
newBillingInfoList
  = BillingInfoList{items = Core.Nothing,
                    kind = "adexchangebuyer#billingInfoList"}
instance Core.FromJSON BillingInfoList where
        parseJSON
          = Core.withObject "BillingInfoList"
              (\ o ->
                 BillingInfoList Core.<$>
                   (o Core..:? "items") Core.<*>
                     (o Core..:? "kind" Core..!= "adexchangebuyer#billingInfoList"))
...
newBudget 
    ::  Budget
newBudget
  = Budget{accountId = Core.Nothing, billingId = Core.Nothing,
           budgetAmount = Core.Nothing, currencyCode = Core.Nothing,
           id = Core.Nothing, kind = "adexchangebuyer#budget"}
instance Core.FromJSON Budget where
        parseJSON
          = Core.withObject "Budget"
              (\ o ->
                 Budget Core.<$>
                   (o Core..:? "accountId" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "billingId" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "budgetAmount" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "currencyCode")
                     Core.<*> (o Core..:? "id")
                     Core.<*> (o Core..:? "kind" Core..!= "adexchangebuyer#budget"))
          ...
          = Core.object
              (Core.catMaybes
                 [("accountId" Core..=) Core.. Core.AsText Core.<$> accountId,
                  ("billingId" Core..=) Core.. Core.AsText Core.<$> billingId,
                  ("budgetAmount" Core..=) Core.. Core.AsText Core.<$> budgetAmount,
...
newCreateOrdersRequest 
    ::  CreateOrdersRequest
newCreateOrdersRequest
  = CreateOrdersRequest{proposals = Core.Nothing,
                        webPropertyCode = Core.Nothing}
instance Core.FromJSON CreateOrdersRequest where
        parseJSON
          = Core.withObject "CreateOrdersRequest"
              (\ o ->
                 CreateOrdersRequest Core.<$>
                   (o Core..:? "proposals") Core.<*> (o Core..:? "webPropertyCode"))
...
newCreateOrdersResponse 
    ::  CreateOrdersResponse
newCreateOrdersResponse
  = CreateOrdersResponse{proposals = Core.Nothing}
instance Core.FromJSON CreateOrdersResponse where
        parseJSON
          = Core.withObject "CreateOrdersResponse"
              (\ o -> CreateOrdersResponse Core.<$> (o Core..:? "proposals"))

instance Core.ToJSON CreateOrdersResponse where
        toJSON CreateOrdersResponse{..}
          = Core.object
              (Core.catMaybes [("proposals" Core..=) Core.<$> proposals])
...
newCreative 
    ::  Creative
newCreative
  = Creative{hTMLSnippet = Core.Nothing, accountId = Core.Nothing,
             adChoicesDestinationUrl = Core.Nothing,
             adTechnologyProviders = Core.Nothing, advertiserId = Core.Nothing,
             advertiserName = Core.Nothing, agencyId = Core.Nothing,
             apiUploadTimestamp = Core.Nothing, attribute = Core.Nothing,
             buyerCreativeId = Core.Nothing, clickThroughUrl = Core.Nothing,
             corrections = Core.Nothing,
             creativeStatusIdentityType = Core.Nothing,
             dealsStatus = Core.Nothing, detectedDomains = Core.Nothing,
             filteringReasons = Core.Nothing, height = Core.Nothing,
             impressionTrackingUrl = Core.Nothing,
             kind = "adexchangebuyer#creative", languages = Core.Nothing,
             nativeAd = Core.Nothing, openAuctionStatus = Core.Nothing,
             productCategories = Core.Nothing,
             restrictedCategories = Core.Nothing,
             sensitiveCategories = Core.Nothing,
             servingRestrictions = Core.Nothing, vendorType = Core.Nothing,
             version = Core.Nothing, videoURL = Core.Nothing,
             videoVastXML = Core.Nothing, width = Core.Nothing}
instance Core.FromJSON Creative where
        parseJSON
          = Core.withObject "Creative"
              (\ o ->
                 Creative Core.<$>
                   (o Core..:? "HTMLSnippet") Core.<*> (o Core..:? "accountId")
                     ...
                     Core.<*> (o Core..:? "kind" Core..!= "adexchangebuyer#creative")
          ...
          = Core.object
              (Core.catMaybes
                 [("HTMLSnippet" Core..=) Core.<$> hTMLSnippet,
                  ...
                  ("advertiserId" Core..=) Core.. Core.fmap Core.AsText Core.<$>
                    advertiserId,
                  ("advertiserName" Core..=) Core.<$> advertiserName,
                  ("agencyId" Core..=) Core.. Core.AsText Core.<$> agencyId,
                  ("apiUploadTimestamp" Core..=) Core.<$> apiUploadTimestamp,
                  ...
                  ("creativeStatusIdentityType" Core..=) Core.<$>
                    creativeStatusIdentityType,
                  ("dealsStatus" Core..=) Core.<$> dealsStatus,
                  ("detectedDomains" Core..=) Core.<$> detectedDomains,
                  ("filteringReasons" Core..=) Core.<$> filteringReasons,
                  ("height" Core..=) Core.<$> height,
                  ("impressionTrackingUrl" Core..=) Core.<$> impressionTrackingUrl,
                  Core.Just ("kind" Core..= kind),
                  ...
                  ("sensitiveCategories" Core..=) Core.<$> sensitiveCategories,
...
newCreative_AdTechnologyProviders 
    ::  Creative_AdTechnologyProviders
newCreative_AdTechnologyProviders
  = Creative_AdTechnologyProviders{detectedProviderIds =
                                     Core.Nothing,
                                   hasUnidentifiedProvider = Core.Nothing}
instance Core.FromJSON Creative_AdTechnologyProviders where
        parseJSON
          = Core.withObject "Creative_AdTechnologyProviders"
              (\ o ->
                 Creative_AdTechnologyProviders Core.<$>
...
instance Core.ToJSON Creative_AdTechnologyProviders where
        toJSON Creative_AdTechnologyProviders{..}
          = Core.object
              (Core.catMaybes
                 [("detectedProviderIds" Core..=) Core.. Core.fmap Core.AsText
...
newCreative_CorrectionsItem 
    ::  Creative_CorrectionsItem
newCreative_CorrectionsItem
  = Creative_CorrectionsItem{contexts = Core.Nothing,
                             details = Core.Nothing, reason = Core.Nothing}
instance Core.FromJSON Creative_CorrectionsItem where
        parseJSON
          = Core.withObject "Creative_CorrectionsItem"
              (\ o ->
                 Creative_CorrectionsItem Core.<$>
                   (o Core..:? "contexts") Core.<*> (o Core..:? "details") Core.<*>
                     (o Core..:? "reason"))
...
newCreative_CorrectionsItem_ContextsItem 
    :: 
                                         Creative_CorrectionsItem_ContextsItem
newCreative_CorrectionsItem_ContextsItem
  = Creative_CorrectionsItem_ContextsItem{auctionType = Core.Nothing,
                                          contextType = Core.Nothing, geoCriteriaId = Core.Nothing,
                                          platform = Core.Nothing}
instance Core.FromJSON Creative_CorrectionsItem_ContextsItem where
        parseJSON
          = Core.withObject "Creative_CorrectionsItem_ContextsItem"
              (\ o ->
                 Creative_CorrectionsItem_ContextsItem Core.<$>
                   (o Core..:? "auctionType") Core.<*> (o Core..:? "contextType")
                     Core.<*> (o Core..:? "geoCriteriaId")
                     Core.<*> (o Core..:? "platform"))

instance Core.ToJSON Creative_CorrectionsItem_ContextsItem where
...
newCreative_FilteringReasons 
    ::  Creative_FilteringReasons
newCreative_FilteringReasons
  = Creative_FilteringReasons{date = Core.Nothing,
                              reasons = Core.Nothing}
instance Core.FromJSON Creative_FilteringReasons where
        parseJSON
          = Core.withObject "Creative_FilteringReasons"
              (\ o ->
                 Creative_FilteringReasons Core.<$>
                   (o Core..:? "date") Core.<*> (o Core..:? "reasons"))
...
newCreative_FilteringReasons_ReasonsItem 
    :: 
                                         Creative_FilteringReasons_ReasonsItem
newCreative_FilteringReasons_ReasonsItem
  = Creative_FilteringReasons_ReasonsItem{filteringCount =
                                            Core.Nothing,
                                          filteringStatus = Core.Nothing}
instance Core.FromJSON Creative_FilteringReasons_ReasonsItem where
        parseJSON
          = Core.withObject "Creative_FilteringReasons_ReasonsItem"
              (\ o ->
                 Creative_FilteringReasons_ReasonsItem Core.<$>
                   (o Core..:? "filteringCount" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "filteringStatus"))

instance Core.ToJSON Creative_FilteringReasons_ReasonsItem where
        toJSON Creative_FilteringReasons_ReasonsItem{..}
          = Core.object
              (Core.catMaybes
                 [("filteringCount" Core..=) Core.. Core.AsText Core.<$>
                    filteringCount,
                  ("filteringStatus" Core..=) Core.<$> filteringStatus])
...
newCreative_NativeAd 
    ::  Creative_NativeAd
newCreative_NativeAd
  = Creative_NativeAd{advertiser = Core.Nothing,
                      appIcon = Core.Nothing, body = Core.Nothing,
                      callToAction = Core.Nothing, clickLinkUrl = Core.Nothing,
                      clickTrackingUrl = Core.Nothing, headline = Core.Nothing,
                      image = Core.Nothing, impressionTrackingUrl = Core.Nothing,
                      logo = Core.Nothing, price = Core.Nothing,
                      starRating = Core.Nothing, videoURL = Core.Nothing}
instance Core.FromJSON Creative_NativeAd where
        parseJSON
          = Core.withObject "Creative_NativeAd"
              (\ o ->
                 Creative_NativeAd Core.<$>
                   (o Core..:? "advertiser") Core.<*> (o Core..:? "appIcon") Core.<*>
                     (o Core..:? "body")
          ...
          = Core.object
              (Core.catMaybes
                 [("advertiser" Core..=) Core.<$> advertiser,
                  ...
                  ("impressionTrackingUrl" Core..=) Core.<$> impressionTrackingUrl,
                  ("logo" Core..=) Core.<$> logo, ("price" Core..=) Core.<$> price,
...
newCreative_NativeAd_AppIcon 
    ::  Creative_NativeAd_AppIcon
newCreative_NativeAd_AppIcon
  = Creative_NativeAd_AppIcon{height = Core.Nothing,
                              url = Core.Nothing, width = Core.Nothing}
instance Core.FromJSON Creative_NativeAd_AppIcon where
        parseJSON
          = Core.withObject "Creative_NativeAd_AppIcon"
              (\ o ->
                 Creative_NativeAd_AppIcon Core.<$>
...
newCreative_NativeAd_Image 
    ::  Creative_NativeAd_Image
newCreative_NativeAd_Image
  = Creative_NativeAd_Image{height = Core.Nothing,
                            url = Core.Nothing, width = Core.Nothing}
instance Core.FromJSON Creative_NativeAd_Image where
        parseJSON
          = Core.withObject "Creative_NativeAd_Image"
              (\ o ->
                 Creative_NativeAd_Image Core.<$>
                   (o Core..:? "height") Core.<*> (o Core..:? "url") Core.<*>
                     (o Core..:? "width"))
...
newCreative_NativeAd_Logo 
    ::  Creative_NativeAd_Logo
newCreative_NativeAd_Logo
  = Creative_NativeAd_Logo{height = Core.Nothing, url = Core.Nothing,
                           width = Core.Nothing}
instance Core.FromJSON Creative_NativeAd_Logo where
        parseJSON
          = Core.withObject "Creative_NativeAd_Logo"
              (\ o ->
                 Creative_NativeAd_Logo Core.<$>
                   (o Core..:? "height") Core.<*> (o Core..:? "url") Core.<*>
                     (o Core..:? "width"))
...
newCreative_ServingRestrictionsItem 
    :: 
                                    Creative_ServingRestrictionsItem
newCreative_ServingRestrictionsItem
  = Creative_ServingRestrictionsItem{contexts = Core.Nothing,
                                     disapprovalReasons = Core.Nothing, reason = Core.Nothing}
instance Core.FromJSON Creative_ServingRestrictionsItem where
        parseJSON
          = Core.withObject "Creative_ServingRestrictionsItem"
              (\ o ->
                 Creative_ServingRestrictionsItem Core.<$>
                   (o Core..:? "contexts") Core.<*> (o Core..:? "disapprovalReasons")
                     Core.<*> (o Core..:? "reason"))
...
newCreative_ServingRestrictionsItem_ContextsItem 
    :: 
                                                 Creative_ServingRestrictionsItem_ContextsItem
newCreative_ServingRestrictionsItem_ContextsItem
  = Creative_ServingRestrictionsItem_ContextsItem{auctionType =
                                                    Core.Nothing,
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "Creative_ServingRestrictionsItem_ContextsItem"
              (\ o ->
                 Creative_ServingRestrictionsItem_ContextsItem Core.<$>
                   (o Core..:? "auctionType") Core.<*> (o Core..:? "contextType")
                     Core.<*> (o Core..:? "geoCriteriaId")
                     Core.<*> (o Core..:? "platform"))

instance Core.ToJSON Creative_ServingRestrictionsItem_ContextsItem
         where
        toJSON Creative_ServingRestrictionsItem_ContextsItem{..}
          = Core.object
              (Core.catMaybes
                 [("auctionType" Core..=) Core.<$> auctionType,
                  ("contextType" Core..=) Core.<$> contextType,
...
newCreative_ServingRestrictionsItem_DisapprovalReasonsItem 
    :: 
                                                           Creative_ServingRestrictionsItem_DisapprovalReasonsItem
newCreative_ServingRestrictionsItem_DisapprovalReasonsItem
  = Creative_ServingRestrictionsItem_DisapprovalReasonsItem{details =
                                                              Core.Nothing,
                                                            reason = Core.Nothing}
instance Core.FromJSON
           Creative_ServingRestrictionsItem_DisapprovalReasonsItem
        ...
        parseJSON
          = Core.withObject
              "Creative_ServingRestrictionsItem_DisapprovalReasonsItem"
              (\ o ->
                 Creative_ServingRestrictionsItem_DisapprovalReasonsItem Core.<$>
                   (o Core..:? "details") Core.<*> (o Core..:? "reason"))

instance Core.ToJSON
           Creative_ServingRestrictionsItem_DisapprovalReasonsItem
         where
        toJSON Creative_ServingRestrictionsItem_DisapprovalReasonsItem{..}
          = Core.object
              (Core.catMaybes
                 [("details" Core..=) Core.<$> details,
                  ("reason" Core..=) Core.<$> reason])
...
newCreativeDealIds 
    ::  CreativeDealIds
newCreativeDealIds
  = CreativeDealIds{dealStatuses = Core.Nothing,
                    kind = "adexchangebuyer#creativeDealIds"}
instance Core.FromJSON CreativeDealIds where
        parseJSON
          = Core.withObject "CreativeDealIds"
              (\ o ->
                 CreativeDealIds Core.<$>
                   (o Core..:? "dealStatuses") Core.<*>
                     (o Core..:? "kind" Core..!= "adexchangebuyer#creativeDealIds"))
...
newCreativeDealIds_DealStatusesItem 
    :: 
                                    CreativeDealIds_DealStatusesItem
newCreativeDealIds_DealStatusesItem
  = CreativeDealIds_DealStatusesItem{arcStatus = Core.Nothing,
                                     dealId = Core.Nothing, webPropertyId = Core.Nothing}
instance Core.FromJSON CreativeDealIds_DealStatusesItem where
        parseJSON
          = Core.withObject "CreativeDealIds_DealStatusesItem"
              (\ o ->
                 CreativeDealIds_DealStatusesItem Core.<$>
                   (o Core..:? "arcStatus") Core.<*>
                     (o Core..:? "dealId" Core.<&> Core.fmap Core.fromAsText)
...
newCreativesList 
    ::  CreativesList
newCreativesList
  = CreativesList{items = Core.Nothing,
                  kind = "adexchangebuyer#creativesList",
                  nextPageToken = Core.Nothing}
instance Core.FromJSON CreativesList where
        parseJSON
          = Core.withObject "CreativesList"
              (\ o ->
                 CreativesList Core.<$>
                   (o Core..:? "items") Core.<*>
                     (o Core..:? "kind" Core..!= "adexchangebuyer#creativesList")
...
newDealServingMetadata 
    ::  DealServingMetadata
newDealServingMetadata
  = DealServingMetadata{alcoholAdsAllowed = Core.Nothing,
...
instance Core.ToJSON DealServingMetadata where
        toJSON DealServingMetadata{..}
          = Core.object
              (Core.catMaybes
                 [("alcoholAdsAllowed" Core..=) Core.<$> alcoholAdsAllowed,
...
newDealServingMetadataDealPauseStatus 
    :: 
                                      DealServingMetadataDealPauseStatus
newDealServingMetadataDealPauseStatus
  = DealServingMetadataDealPauseStatus{buyerPauseReason =
                                         Core.Nothing,
                                       firstPausedBy = Core.Nothing, hasBuyerPaused = Core.Nothing,
                                       hasSellerPaused = Core.Nothing,
                                       sellerPauseReason = Core.Nothing}
instance Core.FromJSON DealServingMetadataDealPauseStatus where
        parseJSON
          = Core.withObject "DealServingMetadataDealPauseStatus"
              (\ o ->
                 DealServingMetadataDealPauseStatus Core.<$>
...
instance Core.ToJSON DealServingMetadataDealPauseStatus where
...
newDealTerms 
    ::  DealTerms
newDealTerms
  = DealTerms{brandingType = Core.Nothing,
              crossListedExternalDealIdType = Core.Nothing,
              description = Core.Nothing, estimatedGrossSpend = Core.Nothing,
              ...
              (\ o ->
                 DealTerms Core.<$>
                   (o Core..:? "brandingType") Core.<*>
                     (o Core..:? "crossListedExternalDealIdType")
          ...
          = Core.object
              (Core.catMaybes
                 [("brandingType" Core..=) Core.<$> brandingType,
                  ("crossListedExternalDealIdType" Core..=) Core.<$>
                    crossListedExternalDealIdType,
                  ("description" Core..=) Core.<$> description,
                  ("estimatedGrossSpend" Core..=) Core.<$> estimatedGrossSpend,
                  ("estimatedImpressionsPerDay" Core..=) Core.. Core.AsText Core.<$>
                  ...
                  ("rubiconNonGuaranteedTerms" Core..=) Core.<$>
...
newDealTermsGuaranteedFixedPriceTerms 
    :: 
                                      DealTermsGuaranteedFixedPriceTerms
newDealTermsGuaranteedFixedPriceTerms
  = DealTermsGuaranteedFixedPriceTerms{billingInfo = Core.Nothing,
                                       fixedPrices = Core.Nothing,
                                       guaranteedImpressions = Core.Nothing,
                                       guaranteedLooks = Core.Nothing,
                                       minimumDailyLooks = Core.Nothing}
instance Core.FromJSON DealTermsGuaranteedFixedPriceTerms where
        parseJSON
          = Core.withObject "DealTermsGuaranteedFixedPriceTerms"
              (\ o ->
                 DealTermsGuaranteedFixedPriceTerms Core.<$>
                   (o Core..:? "billingInfo") Core.<*> (o Core..:? "fixedPrices")
                     Core.<*>
                     (o Core..:? "guaranteedImpressions" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "guaranteedLooks" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "minimumDailyLooks" Core.<&>
                        Core.fmap Core.fromAsText))

instance Core.ToJSON DealTermsGuaranteedFixedPriceTerms where
        toJSON DealTermsGuaranteedFixedPriceTerms{..}
          = Core.object
              (Core.catMaybes
                 [("billingInfo" Core..=) Core.<$> billingInfo,
                  ("fixedPrices" Core..=) Core.<$> fixedPrices,
                  ("guaranteedImpressions" Core..=) Core.. Core.AsText Core.<$>
                    guaranteedImpressions,
                  ("guaranteedLooks" Core..=) Core.. Core.AsText Core.<$>
                    guaranteedLooks,
                  ("minimumDailyLooks" Core..=) Core.. Core.AsText Core.<$>
                    minimumDailyLooks])
...
newDealTermsGuaranteedFixedPriceTermsBillingInfo 
    :: 
                                                 DealTermsGuaranteedFixedPriceTermsBillingInfo
newDealTermsGuaranteedFixedPriceTermsBillingInfo
  = DealTermsGuaranteedFixedPriceTermsBillingInfo{currencyConversionTimeMs
                                                    = Core.Nothing,
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "DealTermsGuaranteedFixedPriceTermsBillingInfo"
              (\ o ->
                 DealTermsGuaranteedFixedPriceTermsBillingInfo Core.<$>
                   (o Core..:? "currencyConversionTimeMs" Core.<&>
                      Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "dfpLineItemId" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "originalContractedQuantity" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "price"))

instance Core.ToJSON DealTermsGuaranteedFixedPriceTermsBillingInfo
         where
        toJSON DealTermsGuaranteedFixedPriceTermsBillingInfo{..}
          = Core.object
              (Core.catMaybes
                 [("currencyConversionTimeMs" Core..=) Core.. Core.AsText Core.<$>
                    currencyConversionTimeMs,
                  ("dfpLineItemId" Core..=) Core.. Core.AsText Core.<$>
                    dfpLineItemId,
                  ("originalContractedQuantity" Core..=) Core.. Core.AsText Core.<$>
...
newDealTermsNonGuaranteedAuctionTerms 
    :: 
                                      DealTermsNonGuaranteedAuctionTerms
newDealTermsNonGuaranteedAuctionTerms
  = DealTermsNonGuaranteedAuctionTerms{autoOptimizePrivateAuction =
                                         Core.Nothing,
                                       reservePricePerBuyers = Core.Nothing}
instance Core.FromJSON DealTermsNonGuaranteedAuctionTerms where
        parseJSON
          = Core.withObject "DealTermsNonGuaranteedAuctionTerms"
              (\ o ->
                 DealTermsNonGuaranteedAuctionTerms Core.<$>
                   (o Core..:? "autoOptimizePrivateAuction") Core.<*>
                     (o Core..:? "reservePricePerBuyers"))

instance Core.ToJSON DealTermsNonGuaranteedAuctionTerms where
        toJSON DealTermsNonGuaranteedAuctionTerms{..}
          = Core.object
              (Core.catMaybes
                 [("autoOptimizePrivateAuction" Core..=) Core.<$>
                    autoOptimizePrivateAuction,
                  ("reservePricePerBuyers" Core..=) Core.<$> reservePricePerBuyers])
...
instance Core.FromJSON DealTermsNonGuaranteedFixedPriceTerms where
        parseJSON
          = Core.withObject "DealTermsNonGuaranteedFixedPriceTerms"
              (\ o ->
                 DealTermsNonGuaranteedFixedPriceTerms Core.<$>
                   (o Core..:? "fixedPrices"))

instance Core.ToJSON DealTermsNonGuaranteedFixedPriceTerms where
...
newDealTermsRubiconNonGuaranteedTerms 
    :: 
                                      DealTermsRubiconNonGuaranteedTerms
newDealTermsRubiconNonGuaranteedTerms
  = DealTermsRubiconNonGuaranteedTerms{priorityPrice = Core.Nothing,
                                       standardPrice = Core.Nothing}
instance Core.FromJSON DealTermsRubiconNonGuaranteedTerms where
        parseJSON
          = Core.withObject "DealTermsRubiconNonGuaranteedTerms"
              (\ o ->
                 DealTermsRubiconNonGuaranteedTerms Core.<$>
                   (o Core..:? "priorityPrice") Core.<*> (o Core..:? "standardPrice"))

instance Core.ToJSON DealTermsRubiconNonGuaranteedTerms where
...
newDeleteOrderDealsRequest 
    ::  DeleteOrderDealsRequest
newDeleteOrderDealsRequest
  = DeleteOrderDealsRequest{dealIds = Core.Nothing,
                            proposalRevisionNumber = Core.Nothing, updateAction = Core.Nothing}
instance Core.FromJSON DeleteOrderDealsRequest where
        parseJSON
          = Core.withObject "DeleteOrderDealsRequest"
              (\ o ->
                 DeleteOrderDealsRequest Core.<$>
                   (o Core..:? "dealIds") Core.<*>
                     (o Core..:? "proposalRevisionNumber" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "updateAction"))
...
newDeleteOrderDealsResponse 
    ::  DeleteOrderDealsResponse
newDeleteOrderDealsResponse
  = DeleteOrderDealsResponse{deals = Core.Nothing,
                             proposalRevisionNumber = Core.Nothing}
instance Core.FromJSON DeleteOrderDealsResponse where
        parseJSON
          = Core.withObject "DeleteOrderDealsResponse"
              (\ o ->
                 DeleteOrderDealsResponse Core.<$>
                   (o Core..:? "deals") Core.<*>
                     (o Core..:? "proposalRevisionNumber" Core.<&>
                        Core.fmap Core.fromAsText))
...
newDeliveryControl 
    ::  DeliveryControl
newDeliveryControl
  = DeliveryControl{creativeBlockingLevel = Core.Nothing,
                    deliveryRateType = Core.Nothing, frequencyCaps = Core.Nothing}
...
newDeliveryControlFrequencyCap 
    ::  DeliveryControlFrequencyCap
newDeliveryControlFrequencyCap
  = DeliveryControlFrequencyCap{maxImpressions = Core.Nothing,
                                numTimeUnits = Core.Nothing, timeUnitType = Core.Nothing}
instance Core.FromJSON DeliveryControlFrequencyCap where
        parseJSON
          = Core.withObject "DeliveryControlFrequencyCap"
              (\ o ->
                 DeliveryControlFrequencyCap Core.<$>
                   (o Core..:? "maxImpressions") Core.<*> (o Core..:? "numTimeUnits")
...
newDimension 
    ::  Dimension
newDimension
  = Dimension{dimensionType = Core.Nothing,
...
newDimensionDimensionValue 
    ::  DimensionDimensionValue
newDimensionDimensionValue
  = DimensionDimensionValue{id = Core.Nothing, name = Core.Nothing,
                            percentage = Core.Nothing}
instance Core.FromJSON DimensionDimensionValue where
        parseJSON
          = Core.withObject "DimensionDimensionValue"
              (\ o ->
                 DimensionDimensionValue Core.<$>
...
newEditAllOrderDealsRequest 
    ::  EditAllOrderDealsRequest
newEditAllOrderDealsRequest
  = EditAllOrderDealsRequest{deals = Core.Nothing,
                             proposal = Core.Nothing, proposalRevisionNumber = Core.Nothing,
                             updateAction = Core.Nothing}
instance Core.FromJSON EditAllOrderDealsRequest where
        parseJSON
          = Core.withObject "EditAllOrderDealsRequest"
              (\ o ->
                 EditAllOrderDealsRequest Core.<$>
                   (o Core..:? "deals") Core.<*> (o Core..:? "proposal") Core.<*>
                     (o Core..:? "proposalRevisionNumber" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "updateAction"))
...
newEditAllOrderDealsResponse 
    ::  EditAllOrderDealsResponse
newEditAllOrderDealsResponse
  = EditAllOrderDealsResponse{deals = Core.Nothing,
                              orderRevisionNumber = Core.Nothing}
instance Core.FromJSON EditAllOrderDealsResponse where
        parseJSON
          = Core.withObject "EditAllOrderDealsResponse"
              (\ o ->
                 EditAllOrderDealsResponse Core.<$>
                   (o Core..:? "deals") Core.<*>
                     (o Core..:? "orderRevisionNumber" Core.<&>
                        Core.fmap Core.fromAsText))
...
instance Core.ToJSON EditAllOrderDealsResponse where
        toJSON EditAllOrderDealsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("deals" Core..=) Core.<$> deals,
                  ("orderRevisionNumber" Core..=) Core.. Core.AsText Core.<$>
                    orderRevisionNumber])
...
instance Core.FromJSON GetOffersResponse where
        parseJSON
          = Core.withObject "GetOffersResponse"
              (\ o -> GetOffersResponse Core.<$> (o Core..:? "products"))

instance Core.ToJSON GetOffersResponse where
        toJSON GetOffersResponse{..}
          = Core.object
              (Core.catMaybes [("products" Core..=) Core.<$> products])
...
newGetOrderDealsResponse 
    ::  GetOrderDealsResponse
newGetOrderDealsResponse
  = GetOrderDealsResponse{deals = Core.Nothing}
instance Core.FromJSON GetOrderDealsResponse where
        parseJSON
          = Core.withObject "GetOrderDealsResponse"
              (\ o -> GetOrderDealsResponse Core.<$> (o Core..:? "deals"))

instance Core.ToJSON GetOrderDealsResponse where
        toJSON GetOrderDealsResponse{..}
          = Core.object (Core.catMaybes [("deals" Core..=) Core.<$> deals])
...
newGetOrderNotesResponse 
    ::  GetOrderNotesResponse
newGetOrderNotesResponse
  = GetOrderNotesResponse{notes = Core.Nothing}
instance Core.FromJSON GetOrderNotesResponse where
        parseJSON
          = Core.withObject "GetOrderNotesResponse"
              (\ o -> GetOrderNotesResponse Core.<$> (o Core..:? "notes"))
...
instance Core.FromJSON GetOrdersResponse where
        parseJSON
          = Core.withObject "GetOrdersResponse"
              (\ o -> GetOrdersResponse Core.<$> (o Core..:? "proposals"))
...
instance Core.FromJSON GetPublisherProfilesByAccountIdResponse
         where
        parseJSON
          = Core.withObject "GetPublisherProfilesByAccountIdResponse"
              (\ o ->
                 GetPublisherProfilesByAccountIdResponse Core.<$>
                   (o Core..:? "profiles"))

instance Core.ToJSON GetPublisherProfilesByAccountIdResponse where
        toJSON GetPublisherProfilesByAccountIdResponse{..}
          = Core.object
              (Core.catMaybes [("profiles" Core..=) Core.<$> profiles])
...
newMarketplaceDeal 
    ::  MarketplaceDeal
newMarketplaceDeal
  = MarketplaceDeal{buyerPrivateData = Core.Nothing,
                    creationTimeMs = Core.Nothing,
                    creativePreApprovalPolicy = Core.Nothing,
                    creativeSafeFrameCompatibility = Core.Nothing,
                    dealId = Core.Nothing, dealServingMetadata = Core.Nothing,
                    deliveryControl = Core.Nothing, externalDealId = Core.Nothing,
                    flightEndTimeMs = Core.Nothing, flightStartTimeMs = Core.Nothing,
                    inventoryDescription = Core.Nothing, isRfpTemplate = Core.Nothing,
                    isSetupComplete = Core.Nothing,
                    kind = "adexchangebuyer#marketplaceDeal",
                    lastUpdateTimeMs = Core.Nothing,
                    makegoodRequestedReason = Core.Nothing, name = Core.Nothing,
                    productId = Core.Nothing, productRevisionNumber = Core.Nothing,
                    programmaticCreativeSource = Core.Nothing,
                    proposalId = Core.Nothing, sellerContacts = Core.Nothing,
                    sharedTargetings = Core.Nothing, syndicationProduct = Core.Nothing,
                    terms = Core.Nothing, webPropertyCode = Core.Nothing}
instance Core.FromJSON MarketplaceDeal where
        parseJSON
          = Core.withObject "MarketplaceDeal"
              (\ o ->
                 MarketplaceDeal Core.<$>
                   (o Core..:? "buyerPrivateData") Core.<*>
                     (o Core..:? "creationTimeMs" Core.<&> Core.fmap Core.fromAsText)
                     ...
                     Core.<*>
                     (o Core..:? "flightEndTimeMs" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "flightStartTimeMs" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "inventoryDescription")
                     Core.<*> (o Core..:? "isRfpTemplate")
                     Core.<*> (o Core..:? "isSetupComplete")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "adexchangebuyer#marketplaceDeal")
                     Core.<*>
                     (o Core..:? "lastUpdateTimeMs" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "makegoodRequestedReason")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "productId")
                     Core.<*>
                     (o Core..:? "productRevisionNumber" Core.<&>
                        Core.fmap Core.fromAsText)
          ...
          = Core.object
              (Core.catMaybes
                 [("buyerPrivateData" Core..=) Core.<$> buyerPrivateData,
                  ("creationTimeMs" Core..=) Core.. Core.AsText Core.<$>
                    creationTimeMs,
                  ...
                  ("flightEndTimeMs" Core..=) Core.. Core.AsText Core.<$>
                    flightEndTimeMs,
                  ("flightStartTimeMs" Core..=) Core.. Core.AsText Core.<$>
                    flightStartTimeMs,
                  ("inventoryDescription" Core..=) Core.<$> inventoryDescription,
                  ("isRfpTemplate" Core..=) Core.<$> isRfpTemplate,
                  ("isSetupComplete" Core..=) Core.<$> isSetupComplete,
                  Core.Just ("kind" Core..= kind),
                  ("lastUpdateTimeMs" Core..=) Core.. Core.AsText Core.<$>
                    lastUpdateTimeMs,
                  ("makegoodRequestedReason" Core..=) Core.<$>
                    makegoodRequestedReason,
                  ("name" Core..=) Core.<$> name,
                  ("productId" Core..=) Core.<$> productId,
                  ("productRevisionNumber" Core..=) Core.. Core.AsText Core.<$>
                  ...
                  ("sharedTargetings" Core..=) Core.<$> sharedTargetings,
...
instance Core.FromJSON MarketplaceDealParty where
        parseJSON
          = Core.withObject "MarketplaceDealParty"
              (\ o ->
                 MarketplaceDealParty Core.<$>
                   (o Core..:? "buyer") Core.<*> (o Core..:? "seller"))
...
newMarketplaceLabel 
    ::  MarketplaceLabel
newMarketplaceLabel
  = MarketplaceLabel{accountId = Core.Nothing,
                     createTimeMs = Core.Nothing,
                     deprecatedMarketplaceDealParty = Core.Nothing,
                     label = Core.Nothing}
instance Core.FromJSON MarketplaceLabel where
        parseJSON
          = Core.withObject "MarketplaceLabel"
              (\ o ->
                 MarketplaceLabel Core.<$>
                   (o Core..:? "accountId") Core.<*>
                     (o Core..:? "createTimeMs" Core.<&> Core.fmap Core.fromAsText)
...
instance Core.ToJSON MarketplaceLabel where
        toJSON MarketplaceLabel{..}
          = Core.object
              (Core.catMaybes
                 [("accountId" Core..=) Core.<$> accountId,
                  ("createTimeMs" Core..=) Core.. Core.AsText Core.<$> createTimeMs,
                  ("deprecatedMarketplaceDealParty" Core..=) Core.<$>
...
newMarketplaceNote 
    ::  MarketplaceNote
newMarketplaceNote
  = MarketplaceNote{creatorRole = Core.Nothing,
                    dealId = Core.Nothing, kind = "adexchangebuyer#marketplaceNote",
                    note = Core.Nothing, noteId = Core.Nothing,
                    proposalId = Core.Nothing, proposalRevisionNumber = Core.Nothing,
                    timestampMs = Core.Nothing}
instance Core.FromJSON MarketplaceNote where
        parseJSON
          = Core.withObject "MarketplaceNote"
              (\ o ->
                 MarketplaceNote Core.<$>
                   (o Core..:? "creatorRole") Core.<*> (o Core..:? "dealId") Core.<*>
                     (o Core..:? "kind" Core..!= "adexchangebuyer#marketplaceNote")
                     Core.<*> (o Core..:? "note")
                     Core.<*> (o Core..:? "noteId")
                     Core.<*> (o Core..:? "proposalId")
                     Core.<*>
                     (o Core..:? "proposalRevisionNumber" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "timestampMs" Core.<&> Core.fmap Core.fromAsText))
          ...
          = Core.object
              (Core.catMaybes
                 [("creatorRole" Core..=) Core.<$> creatorRole,
                  ("dealId" Core..=) Core.<$> dealId,
                  Core.Just ("kind" Core..= kind), ("note" Core..=) Core.<$> note,
                  ("noteId" Core..=) Core.<$> noteId,
                  ("proposalId" Core..=) Core.<$> proposalId,
                  ("proposalRevisionNumber" Core..=) Core.. Core.AsText Core.<$>
                    proposalRevisionNumber,
                  ("timestampMs" Core..=) Core.. Core.AsText Core.<$> timestampMs])
...
newMobileApplication 
    ::  MobileApplication
newMobileApplication
  = MobileApplication{appStore = Core.Nothing,
                      externalAppId = Core.Nothing}
instance Core.FromJSON MobileApplication where
        parseJSON
          = Core.withObject "MobileApplication"
              (\ o ->
                 MobileApplication Core.<$>
                   (o Core..:? "appStore") Core.<*> (o Core..:? "externalAppId"))
...
newPerformanceReport 
    ::  PerformanceReport
newPerformanceReport
  = PerformanceReport{bidRate = Core.Nothing,
                      bidRequestRate = Core.Nothing, calloutStatusRate = Core.Nothing,
                      cookieMatcherStatusRate = Core.Nothing,
                      creativeStatusRate = Core.Nothing, filteredBidRate = Core.Nothing,
                      ...
                      noQuotaInRegion = Core.Nothing, outOfQuota = Core.Nothing,
                      pixelMatchRequests = Core.Nothing,
                      pixelMatchResponses = Core.Nothing,
                      quotaConfiguredLimit = Core.Nothing,
                      quotaThrottledLimit = Core.Nothing, region = Core.Nothing,
                      successfulRequestRate = Core.Nothing, timestamp = Core.Nothing,
                      unsuccessfulRequestRate = Core.Nothing}
instance Core.FromJSON PerformanceReport where
        parseJSON
          = Core.withObject "PerformanceReport"
              (\ o ->
                 PerformanceReport Core.<$>
                   (o Core..:? "bidRate") Core.<*> (o Core..:? "bidRequestRate")
                     ...
                     Core.<*>
                     (o Core..:? "kind" Core..!= "adexchangebuyer#performanceReport")
                     ...
                     Core.<*>
                     (o Core..:? "timestamp" Core.<&> Core.fmap Core.fromAsText)
          ...
          = Core.object
              (Core.catMaybes
                 [("bidRate" Core..=) Core.<$> bidRate,
                  ...
                  ("calloutStatusRate" Core..=) Core.<$> calloutStatusRate,
                  ("cookieMatcherStatusRate" Core..=) Core.<$>
                    cookieMatcherStatusRate,
                  ("creativeStatusRate" Core..=) Core.<$> creativeStatusRate,
                  ("filteredBidRate" Core..=) Core.<$> filteredBidRate,
                  ("hostedMatchStatusRate" Core..=) Core.<$> hostedMatchStatusRate,
                  ("inventoryMatchRate" Core..=) Core.<$> inventoryMatchRate,
                  Core.Just ("kind" Core..= kind),
                  ("latency50thPercentile" Core..=) Core.<$> latency50thPercentile,
                  ("latency85thPercentile" Core..=) Core.<$> latency85thPercentile,
                  ("latency95thPercentile" Core..=) Core.<$> latency95thPercentile,
                  ("noQuotaInRegion" Core..=) Core.<$> noQuotaInRegion,
                  ("outOfQuota" Core..=) Core.<$> outOfQuota,
                  ("pixelMatchRequests" Core..=) Core.<$> pixelMatchRequests,
                  ("pixelMatchResponses" Core..=) Core.<$> pixelMatchResponses,
                  ("quotaConfiguredLimit" Core..=) Core.<$> quotaConfiguredLimit,
                  ("quotaThrottledLimit" Core..=) Core.<$> quotaThrottledLimit,
                  ("region" Core..=) Core.<$> region,
                  ("successfulRequestRate" Core..=) Core.<$> successfulRequestRate,
                  ("timestamp" Core..=) Core.. Core.AsText Core.<$> timestamp,
                  ("unsuccessfulRequestRate" Core..=) Core.<$>
...
instance Core.ToJSON PerformanceReportList where
        toJSON PerformanceReportList{..}
          = Core.object
              (Core.catMaybes
                 [Core.Just ("kind" Core..= kind),
                  ("performanceReport" Core..=) Core.<$> performanceReport])
...
newPretargetingConfig 
    ::  PretargetingConfig
newPretargetingConfig
  = PretargetingConfig{billingId = Core.Nothing,
                       configId = Core.Nothing, configName = Core.Nothing,
                       creativeType = Core.Nothing, dimensions = Core.Nothing,
                       excludedContentLabels = Core.Nothing,
                       excludedGeoCriteriaIds = Core.Nothing,
                       excludedPlacements = Core.Nothing,
                       excludedUserLists = Core.Nothing, excludedVerticals = Core.Nothing,
                       geoCriteriaIds = Core.Nothing, isActive = Core.Nothing,
                       kind = "adexchangebuyer#pretargetingConfig",
                       languages = Core.Nothing, maximumQps = Core.Nothing,
                       minimumViewabilityDecile = Core.Nothing,
                       mobileCarriers = Core.Nothing, mobileDevices = Core.Nothing,
                       mobileOperatingSystemVersions = Core.Nothing,
                       placements = Core.Nothing, platforms = Core.Nothing,
                       supportedCreativeAttributes = Core.Nothing,
                       userIdentifierDataRequired = Core.Nothing,
                       userLists = Core.Nothing, vendorTypes = Core.Nothing,
                       verticals = Core.Nothing, videoPlayerSizes = Core.Nothing}
instance Core.FromJSON PretargetingConfig where
        parseJSON
          = Core.withObject "PretargetingConfig"
              (\ o ->
                 PretargetingConfig Core.<$>
                   (o Core..:? "billingId" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "configId" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "configName")
                     Core.<*> (o Core..:? "creativeType")
                     Core.<*> (o Core..:? "dimensions")
                     Core.<*>
                     (o Core..:? "excludedContentLabels" Core.<&>
                        Core.fmap (Core.fmap Core.fromAsText))
                     Core.<*>
                     (o Core..:? "excludedGeoCriteriaIds" Core.<&>
                        Core.fmap (Core.fmap Core.fromAsText))
                     Core.<*> (o Core..:? "excludedPlacements")
                     Core.<*>
                     (o Core..:? "excludedUserLists" Core.<&>
                        Core.fmap (Core.fmap Core.fromAsText))
                     Core.<*>
                     (o Core..:? "excludedVerticals" Core.<&>
                        Core.fmap (Core.fmap Core.fromAsText))
                     Core.<*>
                     (o Core..:? "geoCriteriaIds" Core.<&>
                        Core.fmap (Core.fmap Core.fromAsText))
                     Core.<*> (o Core..:? "isActive")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "adexchangebuyer#pretargetingConfig")
                     Core.<*> (o Core..:? "languages")
                     Core.<*>
                     (o Core..:? "maximumQps" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "minimumViewabilityDecile")
                     Core.<*>
                     (o Core..:? "mobileCarriers" Core.<&>
                        Core.fmap (Core.fmap Core.fromAsText))
                     Core.<*>
                     (o Core..:? "mobileDevices" Core.<&>
                        Core.fmap (Core.fmap Core.fromAsText))
                     Core.<*>
                     (o Core..:? "mobileOperatingSystemVersions" Core.<&>
                        Core.fmap (Core.fmap Core.fromAsText))
                     Core.<*> (o Core..:? "placements")
                     Core.<*> (o Core..:? "platforms")
                     Core.<*>
                     (o Core..:? "supportedCreativeAttributes" Core.<&>
                        Core.fmap (Core.fmap Core.fromAsText))
                     Core.<*> (o Core..:? "userIdentifierDataRequired")
                     Core.<*>
                     (o Core..:? "userLists" Core.<&>
                        Core.fmap (Core.fmap Core.fromAsText))
                     Core.<*>
                     (o Core..:? "vendorTypes" Core.<&>
                        Core.fmap (Core.fmap Core.fromAsText))
                     Core.<*>
                     (o Core..:? "verticals" Core.<&>
                        Core.fmap (Core.fmap Core.fromAsText))
...
instance Core.ToJSON PretargetingConfig where
        toJSON PretargetingConfig{..}
          = Core.object
              (Core.catMaybes
                 [("billingId" Core..=) Core.. Core.AsText Core.<$> billingId,
                  ("configId" Core..=) Core.. Core.AsText Core.<$> configId,
                  ("configName" Core..=) Core.<$> configName,
                  ("creativeType" Core..=) Core.<$> creativeType,
                  ("dimensions" Core..=) Core.<$> dimensions,
                  ("excludedContentLabels" Core..=) Core.. Core.fmap Core.AsText
                    Core.<$> excludedContentLabels,
                  ("excludedGeoCriteriaIds" Core..=) Core.. Core.fmap Core.AsText
                    Core.<$> excludedGeoCriteriaIds,
                  ("excludedPlacements" Core..=) Core.<$> excludedPlacements,
                  ("excludedUserLists" Core..=) Core.. Core.fmap Core.AsText Core.<$>
                    excludedUserLists,
                  ("excludedVerticals" Core..=) Core.. Core.fmap Core.AsText Core.<$>
                    excludedVerticals,
                  ("geoCriteriaIds" Core..=) Core.. Core.fmap Core.AsText Core.<$>
                    geoCriteriaIds,
                  ("isActive" Core..=) Core.<$> isActive,
                  Core.Just ("kind" Core..= kind),
                  ("languages" Core..=) Core.<$> languages,
                  ("maximumQps" Core..=) Core.. Core.AsText Core.<$> maximumQps,
                  ("minimumViewabilityDecile" Core..=) Core.<$>
                    minimumViewabilityDecile,
                  ("mobileCarriers" Core..=) Core.. Core.fmap Core.AsText Core.<$>
                    mobileCarriers,
                  ("mobileDevices" Core..=) Core.. Core.fmap Core.AsText Core.<$>
                    mobileDevices,
                  ("mobileOperatingSystemVersions" Core..=) Core..
                    Core.fmap Core.AsText
                    Core.<$> mobileOperatingSystemVersions,
                  ("placements" Core..=) Core.<$> placements,
                  ("platforms" Core..=) Core.<$> platforms,
                  ("supportedCreativeAttributes" Core..=) Core..
                    Core.fmap Core.AsText
                    Core.<$> supportedCreativeAttributes,
                  ("userIdentifierDataRequired" Core..=) Core.<$>
                    userIdentifierDataRequired,
                  ("userLists" Core..=) Core.. Core.fmap Core.AsText Core.<$>
                    userLists,
                  ("vendorTypes" Core..=) Core.. Core.fmap Core.AsText Core.<$>
                    vendorTypes,
                  ("verticals" Core..=) Core.. Core.fmap Core.AsText Core.<$>
                    verticals,
                  ("videoPlayerSizes" Core..=) Core.<$> videoPlayerSizes])
...
newPretargetingConfig_DimensionsItem 
    :: 
                                     PretargetingConfig_DimensionsItem
newPretargetingConfig_DimensionsItem
  = PretargetingConfig_DimensionsItem{height = Core.Nothing,
                                      width = Core.Nothing}
instance Core.FromJSON PretargetingConfig_DimensionsItem where
        parseJSON
          = Core.withObject "PretargetingConfig_DimensionsItem"
              (\ o ->
                 PretargetingConfig_DimensionsItem Core.<$>
                   (o Core..:? "height" Core.<&> Core.fmap Core.fromAsText) Core.<*>
                     (o Core..:? "width" Core.<&> Core.fmap Core.fromAsText))

instance Core.ToJSON PretargetingConfig_DimensionsItem where
...
newPretargetingConfig_ExcludedPlacementsItem 
    :: 
                                             PretargetingConfig_ExcludedPlacementsItem
newPretargetingConfig_ExcludedPlacementsItem
  = PretargetingConfig_ExcludedPlacementsItem{token = Core.Nothing,
                                              type' = Core.Nothing}
instance Core.FromJSON PretargetingConfig_ExcludedPlacementsItem
         where
        parseJSON
          = Core.withObject "PretargetingConfig_ExcludedPlacementsItem"
              (\ o ->
                 PretargetingConfig_ExcludedPlacementsItem Core.<$>
                   (o Core..:? "token") Core.<*> (o Core..:? "type"))

instance Core.ToJSON PretargetingConfig_ExcludedPlacementsItem
         where
...
newPretargetingConfig_PlacementsItem 
    :: 
                                     PretargetingConfig_PlacementsItem
newPretargetingConfig_PlacementsItem
  = PretargetingConfig_PlacementsItem{token = Core.Nothing,
                                      type' = Core.Nothing}
instance Core.FromJSON PretargetingConfig_PlacementsItem where
        parseJSON
          = Core.withObject "PretargetingConfig_PlacementsItem"
              (\ o ->
                 PretargetingConfig_PlacementsItem Core.<$>
                   (o Core..:? "token") Core.<*> (o Core..:? "type"))

instance Core.ToJSON PretargetingConfig_PlacementsItem where
...
newPretargetingConfig_VideoPlayerSizesItem 
    :: 
                                           PretargetingConfig_VideoPlayerSizesItem
newPretargetingConfig_VideoPlayerSizesItem
  = PretargetingConfig_VideoPlayerSizesItem{aspectRatio =
                                              Core.Nothing,
                                            minHeight = Core.Nothing, minWidth = Core.Nothing}
instance Core.FromJSON PretargetingConfig_VideoPlayerSizesItem
         where
        parseJSON
          = Core.withObject "PretargetingConfig_VideoPlayerSizesItem"
              (\ o ->
                 PretargetingConfig_VideoPlayerSizesItem Core.<$>
                   (o Core..:? "aspectRatio") Core.<*>
                     (o Core..:? "minHeight" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "minWidth" Core.<&> Core.fmap Core.fromAsText))

instance Core.ToJSON PretargetingConfig_VideoPlayerSizesItem where
        toJSON PretargetingConfig_VideoPlayerSizesItem{..}
          = Core.object
              (Core.catMaybes
                 [("aspectRatio" Core..=) Core.<$> aspectRatio,
                  ("minHeight" Core..=) Core.. Core.AsText Core.<$> minHeight,
                  ("minWidth" Core..=) Core.. Core.AsText Core.<$> minWidth])
...
newPretargetingConfigList 
    ::  PretargetingConfigList
newPretargetingConfigList
  = PretargetingConfigList{items = Core.Nothing,
                           kind = "adexchangebuyer#pretargetingConfigList"}
instance Core.FromJSON PretargetingConfigList where
        parseJSON
          = Core.withObject "PretargetingConfigList"
              (\ o ->
                 PretargetingConfigList Core.<$>
                   (o Core..:? "items") Core.<*>
                     (o Core..:? "kind" Core..!=
...
newPrice 
    ::  Price
newPrice
  = Price{amountMicros = Core.Nothing, currencyCode = Core.Nothing,
          expectedCpmMicros = Core.Nothing, pricingType = Core.Nothing}
instance Core.FromJSON Price where
        parseJSON
          = Core.withObject "Price"
              (\ o ->
                 Price Core.<$>
                   (o Core..:? "amountMicros") Core.<*> (o Core..:? "currencyCode")
          ...
          = Core.object
              (Core.catMaybes
                 [("amountMicros" Core..=) Core.<$> amountMicros,
                  ("currencyCode" Core..=) Core.<$> currencyCode,
                  ("expectedCpmMicros" Core..=) Core.<$> expectedCpmMicros,
...
newPricePerBuyer 
    ::  PricePerBuyer
newPricePerBuyer
  = PricePerBuyer{auctionTier = Core.Nothing,
                  billedBuyer = Core.Nothing, buyer = Core.Nothing,
                  price = Core.Nothing}
instance Core.FromJSON PricePerBuyer where
        parseJSON
          = Core.withObject "PricePerBuyer"
              (\ o ->
                 PricePerBuyer Core.<$>
                   (o Core..:? "auctionTier") Core.<*> (o Core..:? "billedBuyer")
                     Core.<*> (o Core..:? "buyer")
                     Core.<*> (o Core..:? "price"))
...
newPrivateData 
    ::  PrivateData
newPrivateData
  = PrivateData{referenceId = Core.Nothing,
                referencePayload = Core.Nothing}
instance Core.FromJSON PrivateData where
        parseJSON
          = Core.withObject "PrivateData"
              (\ o ->
                 PrivateData Core.<$>
                   (o Core..:? "referenceId") Core.<*>
                     (o Core..:? "referencePayload"))
          ...
          = Core.object
              (Core.catMaybes
                 [("referenceId" Core..=) Core.<$> referenceId,
                  ("referencePayload" Core..=) Core.<$> referencePayload])
...
newProduct 
    ::  Product
newProduct
  = Product{billedBuyer = Core.Nothing, buyer = Core.Nothing,
            creationTimeMs = Core.Nothing, creatorContacts = Core.Nothing,
            creatorRole = Core.Nothing, deliveryControl = Core.Nothing,
            flightEndTimeMs = Core.Nothing, flightStartTimeMs = Core.Nothing,
            hasCreatorSignedOff = Core.Nothing, inventorySource = Core.Nothing,
            kind = "adexchangebuyer#product", labels = Core.Nothing,
            lastUpdateTimeMs = Core.Nothing, legacyOfferId = Core.Nothing,
            marketplacePublisherProfileId = Core.Nothing, name = Core.Nothing,
            privateAuctionId = Core.Nothing, productId = Core.Nothing,
            publisherProfileId = Core.Nothing,
            publisherProvidedForecast = Core.Nothing,
            revisionNumber = Core.Nothing, seller = Core.Nothing,
            sharedTargetings = Core.Nothing, state = Core.Nothing,
            syndicationProduct = Core.Nothing, terms = Core.Nothing,
            webPropertyCode = Core.Nothing}
instance Core.FromJSON Product where
        parseJSON
          = Core.withObject "Product"
              (\ o ->
                 Product Core.<$>
                   (o Core..:? "billedBuyer") Core.<*> (o Core..:? "buyer") Core.<*>
                     (o Core..:? "creationTimeMs" Core.<&> Core.fmap Core.fromAsText)
                     ...
                     Core.<*> (o Core..:? "kind" Core..!= "adexchangebuyer#product")
                     Core.<*> (o Core..:? "labels")
                     Core.<*>
                     (o Core..:? "lastUpdateTimeMs" Core.<&> Core.fmap Core.fromAsText)
                     ...
                     Core.<*>
                     (o Core..:? "revisionNumber" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "seller")
                     Core.<*> (o Core..:? "sharedTargetings")
                     Core.<*> (o Core..:? "state")
                     Core.<*> (o Core..:? "syndicationProduct")
...
newProposal 
    ::  Proposal
newProposal
  = Proposal{billedBuyer = Core.Nothing, buyer = Core.Nothing,
             buyerContacts = Core.Nothing, buyerPrivateData = Core.Nothing,
             dbmAdvertiserIds = Core.Nothing, hasBuyerSignedOff = Core.Nothing,
             hasSellerSignedOff = Core.Nothing, inventorySource = Core.Nothing,
             isRenegotiating = Core.Nothing, isSetupComplete = Core.Nothing,
             kind = "adexchangebuyer#proposal", labels = Core.Nothing,
             lastUpdaterOrCommentorRole = Core.Nothing, name = Core.Nothing,
             negotiationId = Core.Nothing, originatorRole = Core.Nothing,
             privateAuctionId = Core.Nothing, proposalId = Core.Nothing,
             proposalState = Core.Nothing, revisionNumber = Core.Nothing,
             revisionTimeMs = Core.Nothing, seller = Core.Nothing,
              ...
              (\ o ->
                 Proposal Core.<$>
                   (o Core..:? "billedBuyer") Core.<*> (o Core..:? "buyer") Core.<*>
                     ...
                     Core.<*> (o Core..:? "isSetupComplete")
                     Core.<*> (o Core..:? "kind" Core..!= "adexchangebuyer#proposal")
                     Core.<*> (o Core..:? "labels")
                     ...
                     (o Core..:? "revisionNumber" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "revisionTimeMs" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "seller")
                     Core.<*> (o Core..:? "sellerContacts"))
          ...
          = Core.object
              (Core.catMaybes
                 [("billedBuyer" Core..=) Core.<$> billedBuyer,
                  ...
                  ("buyerPrivateData" Core..=) Core.<$> buyerPrivateData,
                  ("dbmAdvertiserIds" Core..=) Core.<$> dbmAdvertiserIds,
                  ("hasBuyerSignedOff" Core..=) Core.<$> hasBuyerSignedOff,
                  ("hasSellerSignedOff" Core..=) Core.<$> hasSellerSignedOff,
                  ("inventorySource" Core..=) Core.<$> inventorySource,
                  ...
                  ("revisionNumber" Core..=) Core.. Core.AsText Core.<$>
                    revisionNumber,
                  ("revisionTimeMs" Core..=) Core.. Core.AsText Core.<$>
                    revisionTimeMs,
                  ("seller" Core..=) Core.<$> seller,
                  ("sellerContacts" Core..=) Core.<$> sellerContacts])
...
newPublisherProfileApiProto 
    ::  PublisherProfileApiProto
newPublisherProfileApiProto
  = PublisherProfileApiProto{audience = Core.Nothing,
                             buyerPitchStatement = Core.Nothing, directContact = Core.Nothing,
                             exchange = Core.Nothing, forecastInventory = Core.Nothing,
                             googlePlusLink = Core.Nothing, isParent = Core.Nothing,
                             isPublished = Core.Nothing,
                             kind = "adexchangebuyer#publisherProfileApiProto",
                             logoUrl = Core.Nothing, mediaKitLink = Core.Nothing,
                             name = Core.Nothing, overview = Core.Nothing,
                             profileId = Core.Nothing, programmaticContact = Core.Nothing,
                             publisherAppIds = Core.Nothing, publisherApps = Core.Nothing,
                             publisherDomains = Core.Nothing, publisherProfileId = Core.Nothing,
                             publisherProvidedForecast = Core.Nothing,
                             rateCardInfoLink = Core.Nothing, samplePageLink = Core.Nothing,
                             seller = Core.Nothing, state = Core.Nothing,
                             topHeadlines = Core.Nothing}
instance Core.FromJSON PublisherProfileApiProto where
        parseJSON
          = Core.withObject "PublisherProfileApiProto"
              (\ o ->
                 PublisherProfileApiProto Core.<$>
                   (o Core..:? "audience") Core.<*> (o Core..:? "buyerPitchStatement")
          ...
          = Core.object
              (Core.catMaybes
                 [("audience" Core..=) Core.<$> audience,
                  ...
                  ("forecastInventory" Core..=) Core.<$> forecastInventory,
                  ...
                  ("programmaticContact" Core..=) Core.<$> programmaticContact,
                  ("publisherAppIds" Core..=) Core.. Core.fmap Core.AsText Core.<$>
                    publisherAppIds,
                  ("publisherApps" Core..=) Core.<$> publisherApps,
                  ("publisherDomains" Core..=) Core.<$> publisherDomains,
                  ("publisherProfileId" Core..=) Core.<$> publisherProfileId,
                  ("publisherProvidedForecast" Core..=) Core.<$>
                    publisherProvidedForecast,
                  ("rateCardInfoLink" Core..=) Core.<$> rateCardInfoLink,
...
newPublisherProvidedForecast 
    ::  PublisherProvidedForecast
newPublisherProvidedForecast
  = PublisherProvidedForecast{dimensions = Core.Nothing,
                              weeklyImpressions = Core.Nothing, weeklyUniques = Core.Nothing}
instance Core.FromJSON PublisherProvidedForecast where
        parseJSON
          = Core.withObject "PublisherProvidedForecast"
              (\ o ->
                 PublisherProvidedForecast Core.<$>
                   (o Core..:? "dimensions") Core.<*>
                     (o Core..:? "weeklyImpressions" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "weeklyUniques" Core.<&> Core.fmap Core.fromAsText))
...
instance Core.ToJSON PublisherProvidedForecast where
        toJSON PublisherProvidedForecast{..}
          = Core.object
              (Core.catMaybes
                 [("dimensions" Core..=) Core.<$> dimensions,
                  ("weeklyImpressions" Core..=) Core.. Core.AsText Core.<$>
                    weeklyImpressions,
                  ("weeklyUniques" Core..=) Core.. Core.AsText Core.<$>
                    weeklyUniques])
...
instance Core.FromJSON Seller where
        parseJSON
          = Core.withObject "Seller"
              (\ o ->
                 Seller Core.<$>
                   (o Core..:? "accountId") Core.<*> (o Core..:? "subAccountId"))
...
newSharedTargeting 
    ::  SharedTargeting
newSharedTargeting
  = SharedTargeting{exclusions = Core.Nothing,
                    inclusions = Core.Nothing, key = Core.Nothing}
instance Core.FromJSON SharedTargeting where
        parseJSON
          = Core.withObject "SharedTargeting"
              (\ o ->
                 SharedTargeting Core.<$>
                   (o Core..:? "exclusions") Core.<*> (o Core..:? "inclusions")
                     Core.<*> (o Core..:? "key"))
...
newTargetingValue 
    ::  TargetingValue
newTargetingValue
  = TargetingValue{creativeSizeValue = Core.Nothing,
                   dayPartTargetingValue = Core.Nothing,
                   demogAgeCriteriaValue = Core.Nothing,
                   demogGenderCriteriaValue = Core.Nothing, longValue = Core.Nothing,
              ...
              (\ o ->
                 TargetingValue Core.<$>
                   (o Core..:? "creativeSizeValue") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "longValue" Core.<&> Core.fmap Core.fromAsText)
          ...
          = Core.object
              (Core.catMaybes
                 [("creativeSizeValue" Core..=) Core.<$> creativeSizeValue,
                  ...
                  ("demogAgeCriteriaValue" Core..=) Core.<$> demogAgeCriteriaValue,
                  ("demogGenderCriteriaValue" Core..=) Core.<$>
                    demogGenderCriteriaValue,
                  ("longValue" Core..=) Core.. Core.AsText Core.<$> longValue,
                  ("requestPlatformTargetingValue" Core..=) Core.<$>
...
newTargetingValueCreativeSize 
    ::  TargetingValueCreativeSize
newTargetingValueCreativeSize
  = TargetingValueCreativeSize{allowedFormats = Core.Nothing,
                               companionSizes = Core.Nothing, creativeSizeType = Core.Nothing,
                               nativeTemplate = Core.Nothing, size = Core.Nothing,
                               skippableAdType = Core.Nothing}
instance Core.FromJSON TargetingValueCreativeSize where
        parseJSON
          = Core.withObject "TargetingValueCreativeSize"
              (\ o ->
                 TargetingValueCreativeSize Core.<$>
...
newTargetingValueDayPartTargeting 
    ::  TargetingValueDayPartTargeting
newTargetingValueDayPartTargeting
  = TargetingValueDayPartTargeting{dayParts = Core.Nothing,
                                   timeZoneType = Core.Nothing}
instance Core.FromJSON TargetingValueDayPartTargeting where
        parseJSON
          = Core.withObject "TargetingValueDayPartTargeting"
              (\ o ->
                 TargetingValueDayPartTargeting Core.<$>
                   (o Core..:? "dayParts") Core.<*> (o Core..:? "timeZoneType"))
...
newTargetingValueDayPartTargetingDayPart 
    :: 
                                         TargetingValueDayPartTargetingDayPart
newTargetingValueDayPartTargetingDayPart
  = TargetingValueDayPartTargetingDayPart{dayOfWeek = Core.Nothing,
                                          endHour = Core.Nothing, endMinute = Core.Nothing,
                                          startHour = Core.Nothing, startMinute = Core.Nothing}
instance Core.FromJSON TargetingValueDayPartTargetingDayPart where
        parseJSON
          = Core.withObject "TargetingValueDayPartTargetingDayPart"
              (\ o ->
                 TargetingValueDayPartTargetingDayPart Core.<$>
                   (o Core..:? "dayOfWeek") Core.<*> (o Core..:? "endHour") Core.<*>
                     (o Core..:? "endMinute")
                     Core.<*> (o Core..:? "startHour")
                     Core.<*> (o Core..:? "startMinute"))

instance Core.ToJSON TargetingValueDayPartTargetingDayPart where
...
newTargetingValueDemogAgeCriteria 
    ::  TargetingValueDemogAgeCriteria
newTargetingValueDemogAgeCriteria
  = TargetingValueDemogAgeCriteria{demogAgeCriteriaIds =
                                     Core.Nothing}
instance Core.FromJSON TargetingValueDemogAgeCriteria where
        parseJSON
          = Core.withObject "TargetingValueDemogAgeCriteria"
              (\ o ->
                 TargetingValueDemogAgeCriteria Core.<$>
                   (o Core..:? "demogAgeCriteriaIds"))

instance Core.ToJSON TargetingValueDemogAgeCriteria where
        toJSON TargetingValueDemogAgeCriteria{..}
          = Core.object
              (Core.catMaybes
                 [("demogAgeCriteriaIds" Core..=) Core.<$> demogAgeCriteriaIds])
...
newTargetingValueDemogGenderCriteria
  = TargetingValueDemogGenderCriteria{demogGenderCriteriaIds =
                                        Core.Nothing}
instance Core.FromJSON TargetingValueDemogGenderCriteria where
        parseJSON
          = Core.withObject "TargetingValueDemogGenderCriteria"
              (\ o ->
                 TargetingValueDemogGenderCriteria Core.<$>
                   (o Core..:? "demogGenderCriteriaIds"))

instance Core.ToJSON TargetingValueDemogGenderCriteria where
        toJSON TargetingValueDemogGenderCriteria{..}
          = Core.object
              (Core.catMaybes
                 [("demogGenderCriteriaIds" Core..=) Core.<$>
...
newTargetingValueRequestPlatformTargeting 
    :: 
                                          TargetingValueRequestPlatformTargeting
newTargetingValueRequestPlatformTargeting
  = TargetingValueRequestPlatformTargeting{requestPlatforms =
                                             Core.Nothing}
instance Core.FromJSON TargetingValueRequestPlatformTargeting where
        parseJSON
          = Core.withObject "TargetingValueRequestPlatformTargeting"
              (\ o ->
                 TargetingValueRequestPlatformTargeting Core.<$>
                   (o Core..:? "requestPlatforms"))

instance Core.ToJSON TargetingValueRequestPlatformTargeting where
        toJSON TargetingValueRequestPlatformTargeting{..}
          = Core.object
              (Core.catMaybes
                 [("requestPlatforms" Core..=) Core.<$> requestPlatforms])
...
instance Core.FromJSON TargetingValueSize where
        parseJSON
          = Core.withObject "TargetingValueSize"
              (\ o ->
                 TargetingValueSize Core.<$>
...
newUpdatePrivateAuctionProposalRequest 
    :: 
                                       UpdatePrivateAuctionProposalRequest
newUpdatePrivateAuctionProposalRequest
  = UpdatePrivateAuctionProposalRequest{externalDealId =
                                          Core.Nothing,
                                        note = Core.Nothing, proposalRevisionNumber = Core.Nothing,
                                        updateAction = Core.Nothing}
instance Core.FromJSON UpdatePrivateAuctionProposalRequest where
        parseJSON
          = Core.withObject "UpdatePrivateAuctionProposalRequest"
              (\ o ->
                 UpdatePrivateAuctionProposalRequest Core.<$>
                   (o Core..:? "externalDealId") Core.<*> (o Core..:? "note") Core.<*>
                     (o Core..:? "proposalRevisionNumber" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "updateAction"))

instance Core.ToJSON UpdatePrivateAuctionProposalRequest where
