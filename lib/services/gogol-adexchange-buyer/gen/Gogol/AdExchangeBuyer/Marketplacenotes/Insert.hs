             ...
             "notes" Core.:>
               "insert" Core.:>
                 Core.QueryParam "alt" Core.AltJSON Core.:>
                   Core.ReqBody '[Core.JSON] AddOrderNotesRequest Core.:>
                     Core.Post '[Core.JSON] AddOrderNotesResponse
...
newAdExchangeBuyerMarketplacenotesInsert payload proposalId
  = AdExchangeBuyerMarketplacenotesInsert{payload = payload,
                                          proposalId = proposalId}
instance Core.GoogleRequest AdExchangeBuyerMarketplacenotesInsert
         where
