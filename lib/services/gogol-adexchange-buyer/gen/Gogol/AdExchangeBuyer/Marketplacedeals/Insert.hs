             ...
             "deals" Core.:>
               "insert" Core.:>
                 Core.QueryParam "alt" Core.AltJSON Core.:>
                   Core.ReqBody '[Core.JSON] AddOrderDealsRequest Core.:>
                     Core.Post '[Core.JSON] AddOrderDealsResponse
...
newAdExchangeBuyerMarketplacedealsInsert payload proposalId
  = AdExchangeBuyerMarketplacedealsInsert{payload = payload,
                                          proposalId = proposalId}
instance Core.GoogleRequest AdExchangeBuyerMarketplacedealsInsert
         where
        type Rs AdExchangeBuyerMarketplacedealsInsert =
             AddOrderDealsResponse
        type Scopes AdExchangeBuyerMarketplacedealsInsert =
             '[Adexchange'Buyer]
