             ...
             Core.Capture "buyerCreativeId" Core.Text Core.:>
               "listDeals" Core.:>
                 Core.QueryParam "alt" Core.AltJSON Core.:>
                   Core.Get '[Core.JSON] CreativeDealIds
...
newAdExchangeBuyerCreativesListDeals accountId buyerCreativeId
  = AdExchangeBuyerCreativesListDeals{accountId = accountId,
                                      buyerCreativeId = buyerCreativeId}
instance Core.GoogleRequest AdExchangeBuyerCreativesListDeals where
        type Rs AdExchangeBuyerCreativesListDeals = CreativeDealIds
        type Scopes AdExchangeBuyerCreativesListDeals = '[Adexchange'Buyer]
        requestClient AdExchangeBuyerCreativesListDeals{..}
          = go accountId buyerCreativeId (Core.Just Core.AltJSON)
