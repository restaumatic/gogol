...
newAdExchangeBuyerCreativesRemoveDeal 
    ...
    -> AdExchangeBuyerCreativesRemoveDeal
newAdExchangeBuyerCreativesRemoveDeal accountId buyerCreativeId
  dealId
  = AdExchangeBuyerCreativesRemoveDeal{accountId = accountId,
                                       buyerCreativeId = buyerCreativeId, dealId = dealId}
instance Core.GoogleRequest AdExchangeBuyerCreativesRemoveDeal
         where
        ...
        requestClient AdExchangeBuyerCreativesRemoveDeal{..}
          = go accountId buyerCreativeId dealId (Core.Just Core.AltJSON)
