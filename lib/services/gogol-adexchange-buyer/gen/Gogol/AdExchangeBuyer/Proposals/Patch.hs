         ...
         "proposals" Core.:>
           Core.Capture "proposalId" Core.Text Core.:>
             Core.Capture "revisionNumber" Core.Int64 Core.:>
               Core.Capture "updateAction" ProposalsPatchUpdateAction Core.:>
...
newAdExchangeBuyerProposalsPatch 
    ...
    -> AdExchangeBuyerProposalsPatch
newAdExchangeBuyerProposalsPatch payload proposalId revisionNumber
  updateAction
  = AdExchangeBuyerProposalsPatch{payload = payload,
