...
newAdaptiveMtDataset 
    ::  AdaptiveMtDataset
newAdaptiveMtDataset
  = AdaptiveMtDataset{createTime = Core.Nothing,
                      displayName = Core.Nothing, exampleCount = Core.Nothing,
                      name = Core.Nothing, sourceLanguageCode = Core.Nothing,
                      targetLanguageCode = Core.Nothing, updateTime = Core.Nothing}
instance Core.FromJSON AdaptiveMtDataset where
        parseJSON
          = Core.withObject "AdaptiveMtDataset"
              (\ o ->
                 AdaptiveMtDataset Core.<$>
...
newAdaptiveMtFile 
    ::  AdaptiveMtFile
newAdaptiveMtFile
  = AdaptiveMtFile{createTime = Core.Nothing,
                   displayName = Core.Nothing, entryCount = Core.Nothing,
                   name = Core.Nothing, updateTime = Core.Nothing}
instance Core.FromJSON AdaptiveMtFile where
        parseJSON
          = Core.withObject "AdaptiveMtFile"
              (\ o ->
                 AdaptiveMtFile Core.<$>
                   (o Core..:? "createTime") Core.<*> (o Core..:? "displayName")
...
newAdaptiveMtSentence 
    ::  AdaptiveMtSentence
newAdaptiveMtSentence
  = AdaptiveMtSentence{createTime = Core.Nothing,
                       name = Core.Nothing, sourceSentence = Core.Nothing,
                       targetSentence = Core.Nothing, updateTime = Core.Nothing}
instance Core.FromJSON AdaptiveMtSentence where
        parseJSON
          = Core.withObject "AdaptiveMtSentence"
              (\ o ->
                 AdaptiveMtSentence Core.<$>
                   (o Core..:? "createTime") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "sourceSentence")
...
newAdaptiveMtTranslateRequest 
    ::  AdaptiveMtTranslateRequest
newAdaptiveMtTranslateRequest
  = AdaptiveMtTranslateRequest{content = Core.Nothing,
                               dataset = Core.Nothing, glossaryConfig = Core.Nothing,
                               referenceSentenceConfig = Core.Nothing}
instance Core.FromJSON AdaptiveMtTranslateRequest where
        parseJSON
          = Core.withObject "AdaptiveMtTranslateRequest"
              (\ o ->
                 AdaptiveMtTranslateRequest Core.<$>
                   (o Core..:? "content") Core.<*> (o Core..:? "dataset") Core.<*>
          ...
          = Core.object
              (Core.catMaybes
                 [("content" Core..=) Core.<$> content,
                  ...
                  ("referenceSentenceConfig" Core..=) Core.<$>
                    referenceSentenceConfig])
...
newAdaptiveMtTranslateResponse 
    ::  AdaptiveMtTranslateResponse
newAdaptiveMtTranslateResponse
  = AdaptiveMtTranslateResponse{glossaryTranslations = Core.Nothing,
                                languageCode = Core.Nothing, translations = Core.Nothing}
instance Core.FromJSON AdaptiveMtTranslateResponse where
        parseJSON
          = Core.withObject "AdaptiveMtTranslateResponse"
              (\ o ->
                 AdaptiveMtTranslateResponse Core.<$>
...
instance Core.FromJSON AdaptiveMtTranslation where
        parseJSON
          = Core.withObject "AdaptiveMtTranslation"
              (\ o ->
...
newBatchTranslateDocumentRequest
  = BatchTranslateDocumentRequest{customizedAttribution =
                                  ...
                                  formatConversions = Core.Nothing, glossaries = Core.Nothing,
                                  inputConfigs = Core.Nothing, models = Core.Nothing,
                                  outputConfig = Core.Nothing, sourceLanguageCode = Core.Nothing,
              ...
              (\ o ->
                 BatchTranslateDocumentRequest Core.<$>
                   (o Core..:? "customizedAttribution") Core.<*>
                     (o Core..:? "enableRotationCorrection")
...
newBatchTranslateDocumentRequest_FormatConversions additional
  = BatchTranslateDocumentRequest_FormatConversions{additional =
                                                      additional}
instance Core.FromJSON
           BatchTranslateDocumentRequest_FormatConversions
         where
        parseJSON
          = Core.withObject "BatchTranslateDocumentRequest_FormatConversions"
              (\ o ->
                 BatchTranslateDocumentRequest_FormatConversions Core.<$>
...
instance Core.FromJSON BatchTranslateDocumentRequest_Glossaries
         where
        parseJSON
          = Core.withObject "BatchTranslateDocumentRequest_Glossaries"
              (\ o ->
...
instance Core.FromJSON BatchTranslateDocumentRequest_Models where
        parseJSON
          = Core.withObject "BatchTranslateDocumentRequest_Models"
              (\ o ->
...
newBatchTranslateTextRequest 
    ::  BatchTranslateTextRequest
newBatchTranslateTextRequest
  = BatchTranslateTextRequest{glossaries = Core.Nothing,
                              inputConfigs = Core.Nothing, labels = Core.Nothing,
                              models = Core.Nothing, outputConfig = Core.Nothing,
          ...
          = Core.withObject "BatchTranslateTextRequest"
              (\ o ->
                 BatchTranslateTextRequest Core.<$>
                   (o Core..:? "glossaries") Core.<*> (o Core..:? "inputConfigs")
                     Core.<*> (o Core..:? "labels")
                     Core.<*> (o Core..:? "models")
                     Core.<*> (o Core..:? "outputConfig")
                     Core.<*> (o Core..:? "sourceLanguageCode")
...
instance Core.FromJSON BatchTranslateTextRequest_Glossaries where
        parseJSON
          = Core.withObject "BatchTranslateTextRequest_Glossaries"
              (\ o ->
...
newDataset 
    ::  Dataset
newDataset
  = Dataset{createTime = Core.Nothing, displayName = Core.Nothing,
            exampleCount = Core.Nothing, name = Core.Nothing,
            sourceLanguageCode = Core.Nothing,
            targetLanguageCode = Core.Nothing, testExampleCount = Core.Nothing,
            trainExampleCount = Core.Nothing, updateTime = Core.Nothing,
...
newDetectLanguageRequest 
    ::  DetectLanguageRequest
newDetectLanguageRequest
  = DetectLanguageRequest{content = Core.Nothing,
                          labels = Core.Nothing, mimeType = Core.Nothing,
                          model = Core.Nothing}
          ...
          = Core.withObject "DetectLanguageRequest"
              (\ o ->
                 DetectLanguageRequest Core.<$>
                   (o Core..:? "content") Core.<*> (o Core..:? "labels") Core.<*>
                     (o Core..:? "mimeType")
                     Core.<*> (o Core..:? "model"))
...
newDocumentInputConfig 
    ::  DocumentInputConfig
newDocumentInputConfig
  = DocumentInputConfig{content = Core.Nothing,
...
newDocumentOutputConfig 
    ::  DocumentOutputConfig
newDocumentOutputConfig
  = DocumentOutputConfig{gcsDestination = Core.Nothing,
          ...
          = Core.withObject "DocumentOutputConfig"
              (\ o ->
                 DocumentOutputConfig Core.<$>
                   (o Core..:? "gcsDestination") Core.<*> (o Core..:? "mimeType"))
...
newDocumentTranslation 
    ::  DocumentTranslation
newDocumentTranslation
  = DocumentTranslation{byteStreamOutputs = Core.Nothing,
                        detectedLanguageCode = Core.Nothing, mimeType = Core.Nothing}
...
newExample 
    ::  Example
newExample
  = Example{name = Core.Nothing, sourceText = Core.Nothing,
            targetText = Core.Nothing, usage = Core.Nothing}
instance Core.FromJSON Example where
        parseJSON
          = Core.withObject "Example"
              (\ o ->
                 Example Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "sourceText") Core.<*>
                     (o Core..:? "targetText")
                     Core.<*> (o Core..:? "usage"))
...
newFileInputSource 
    ::  FileInputSource
newFileInputSource
  = FileInputSource{content = Core.Nothing,
                    displayName = Core.Nothing, mimeType = Core.Nothing}
instance Core.FromJSON FileInputSource where
        parseJSON
          = Core.withObject "FileInputSource"
              (\ o ->
                 FileInputSource Core.<$>
...
newGlossary 
    ::  Glossary
newGlossary
  = Glossary{displayName = Core.Nothing, endTime = Core.Nothing,
             entryCount = Core.Nothing, inputConfig = Core.Nothing,
             languageCodesSet = Core.Nothing, languagePair = Core.Nothing,
             name = Core.Nothing, submitTime = Core.Nothing}
instance Core.FromJSON Glossary where
        parseJSON
          = Core.withObject "Glossary"
              (\ o ->
                 Glossary Core.<$>
                   (o Core..:? "displayName") Core.<*> (o Core..:? "endTime") Core.<*>
                     (o Core..:? "entryCount")
...
newGlossaryConfig 
    ::  GlossaryConfig
newGlossaryConfig
  = GlossaryConfig{contextualTranslationEnabled = Core.Nothing,
                   glossary = Core.Nothing, ignoreCase = Core.Nothing}
instance Core.FromJSON GlossaryConfig where
        parseJSON
          = Core.withObject "GlossaryConfig"
              (\ o ->
                 GlossaryConfig Core.<$>
                   (o Core..:? "contextualTranslationEnabled") Core.<*>
                     (o Core..:? "glossary")
...
instance Core.ToJSON GlossaryConfig where
        toJSON GlossaryConfig{..}
          = Core.object
              (Core.catMaybes
                 [("contextualTranslationEnabled" Core..=) Core.<$>
...
newGlossaryEntry 
    ::  GlossaryEntry
newGlossaryEntry
  = GlossaryEntry{description = Core.Nothing, name = Core.Nothing,
                  termsPair = Core.Nothing, termsSet = Core.Nothing}
...
instance Core.FromJSON GlossaryTerm where
        parseJSON
          = Core.withObject "GlossaryTerm"
              (\ o ->
                 GlossaryTerm Core.<$>
                   (o Core..:? "languageCode") Core.<*> (o Core..:? "text"))
...
newGlossaryTermsPair 
    ::  GlossaryTermsPair
newGlossaryTermsPair
  = GlossaryTermsPair{sourceTerm = Core.Nothing,
          ...
          = Core.withObject "GlossaryTermsPair"
              (\ o ->
                 GlossaryTermsPair Core.<$>
                   (o Core..:? "sourceTerm") Core.<*> (o Core..:? "targetTerm"))
...
newImportAdaptiveMtFileRequest 
    ::  ImportAdaptiveMtFileRequest
newImportAdaptiveMtFileRequest
  = ImportAdaptiveMtFileRequest{fileInputSource = Core.Nothing,
                                gcsInputSource = Core.Nothing}
instance Core.FromJSON ImportAdaptiveMtFileRequest where
        parseJSON
          = Core.withObject "ImportAdaptiveMtFileRequest"
              (\ o ->
                 ImportAdaptiveMtFileRequest Core.<$>
                   (o Core..:? "fileInputSource") Core.<*>
                     (o Core..:? "gcsInputSource"))
...
instance Core.FromJSON ImportAdaptiveMtFileResponse where
        parseJSON
          = Core.withObject "ImportAdaptiveMtFileResponse"
              (\ o ->
                 ImportAdaptiveMtFileResponse Core.<$>
                   (o Core..:? "adaptiveMtFile"))
...
instance Core.FromJSON InputConfig where
        parseJSON
          = Core.withObject "InputConfig"
              (\ o ->
                 InputConfig Core.<$>
                   (o Core..:? "gcsSource") Core.<*> (o Core..:? "mimeType"))
...
instance Core.FromJSON InputFile where
        parseJSON
          = Core.withObject "InputFile"
              (\ o ->
                 InputFile Core.<$>
                   (o Core..:? "gcsSource") Core.<*> (o Core..:? "usage"))
...
newLanguageCodePair 
    ::  LanguageCodePair
newLanguageCodePair
  = LanguageCodePair{sourceLanguageCode = Core.Nothing,
...
newListAdaptiveMtDatasetsResponse 
    ::  ListAdaptiveMtDatasetsResponse
newListAdaptiveMtDatasetsResponse
  = ListAdaptiveMtDatasetsResponse{adaptiveMtDatasets = Core.Nothing,
                                   nextPageToken = Core.Nothing}
instance Core.FromJSON ListAdaptiveMtDatasetsResponse where
        parseJSON
          = Core.withObject "ListAdaptiveMtDatasetsResponse"
              (\ o ->
                 ListAdaptiveMtDatasetsResponse Core.<$>
                   (o Core..:? "adaptiveMtDatasets") Core.<*>
...
newListAdaptiveMtFilesResponse 
    ::  ListAdaptiveMtFilesResponse
newListAdaptiveMtFilesResponse
  = ListAdaptiveMtFilesResponse{adaptiveMtFiles = Core.Nothing,
                                nextPageToken = Core.Nothing}
instance Core.FromJSON ListAdaptiveMtFilesResponse where
        parseJSON
          = Core.withObject "ListAdaptiveMtFilesResponse"
              (\ o ->
                 ListAdaptiveMtFilesResponse Core.<$>
                   (o Core..:? "adaptiveMtFiles") Core.<*>
                     (o Core..:? "nextPageToken"))
...
instance Core.FromJSON ListAdaptiveMtSentencesResponse where
        parseJSON
          = Core.withObject "ListAdaptiveMtSentencesResponse"
              (\ o ->
                 ListAdaptiveMtSentencesResponse Core.<$>
                   (o Core..:? "adaptiveMtSentences") Core.<*>
                     (o Core..:? "nextPageToken"))
...
newListExamplesResponse 
    ::  ListExamplesResponse
newListExamplesResponse
  = ListExamplesResponse{examples = Core.Nothing,
                         nextPageToken = Core.Nothing}
          ...
          = Core.withObject "ListExamplesResponse"
              (\ o ->
                 ListExamplesResponse Core.<$>
                   (o Core..:? "examples") Core.<*> (o Core..:? "nextPageToken"))
...
newListGlossariesResponse 
    ::  ListGlossariesResponse
newListGlossariesResponse
  = ListGlossariesResponse{glossaries = Core.Nothing,
                           nextPageToken = Core.Nothing}
          ...
          = Core.withObject "ListGlossariesResponse"
              (\ o ->
                 ListGlossariesResponse Core.<$>
                   (o Core..:? "glossaries") Core.<*> (o Core..:? "nextPageToken"))
...
newListGlossaryEntriesResponse 
    ::  ListGlossaryEntriesResponse
newListGlossaryEntriesResponse
  = ListGlossaryEntriesResponse{glossaryEntries = Core.Nothing,
                                nextPageToken = Core.Nothing}
...
newModel 
    ::  Model
newModel
  = Model{createTime = Core.Nothing, dataset = Core.Nothing,
...
instance Core.FromJSON Model where
        parseJSON
          = Core.withObject "Model"
              (\ o ->
                 Model Core.<$>
                   (o Core..:? "createTime") Core.<*> (o Core..:? "dataset") Core.<*>
                     (o Core..:? "displayName")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "sourceLanguageCode")
                     Core.<*> (o Core..:? "targetLanguageCode")
...
instance Core.FromJSON ReferenceSentenceConfig where
        parseJSON
          = Core.withObject "ReferenceSentenceConfig"
              (\ o ->
                 ReferenceSentenceConfig Core.<$>
                   (o Core..:? "referenceSentencePairLists") Core.<*>
                     (o Core..:? "sourceLanguageCode")
                     Core.<*> (o Core..:? "targetLanguageCode"))
...
instance Core.ToJSON ReferenceSentenceConfig where
        toJSON ReferenceSentenceConfig{..}
          = Core.object
              (Core.catMaybes
                 [("referenceSentencePairLists" Core..=) Core.<$>
...
newReferenceSentencePair 
    ::  ReferenceSentencePair
newReferenceSentencePair
  = ReferenceSentencePair{sourceSentence = Core.Nothing,
                          targetSentence = Core.Nothing}
instance Core.FromJSON ReferenceSentencePair where
        parseJSON
          = Core.withObject "ReferenceSentencePair"
              (\ o ->
                 ReferenceSentencePair Core.<$>
                   (o Core..:? "sourceSentence") Core.<*>
                     (o Core..:? "targetSentence"))
...
instance Core.FromJSON ReferenceSentencePairList where
        parseJSON
          = Core.withObject "ReferenceSentencePairList"
              (\ o ->
                 ReferenceSentencePairList Core.<$>
                   (o Core..:? "referenceSentencePairs"))

instance Core.ToJSON ReferenceSentencePairList where
        toJSON ReferenceSentencePairList{..}
          = Core.object
              (Core.catMaybes
                 [("referenceSentencePairs" Core..=) Core.<$>
...
newRomanizeTextRequest 
    ::  RomanizeTextRequest
newRomanizeTextRequest
  = RomanizeTextRequest{contents = Core.Nothing,
                        sourceLanguageCode = Core.Nothing}
instance Core.FromJSON RomanizeTextRequest where
        parseJSON
          = Core.withObject "RomanizeTextRequest"
              (\ o ->
                 RomanizeTextRequest Core.<$>
                   (o Core..:? "contents") Core.<*> (o Core..:? "sourceLanguageCode"))
...
instance Core.FromJSON RomanizeTextResponse where
        parseJSON
          = Core.withObject "RomanizeTextResponse"
...
newSupportedLanguage 
    ::  SupportedLanguage
newSupportedLanguage
  = SupportedLanguage{displayName = Core.Nothing,
                      languageCode = Core.Nothing, supportSource = Core.Nothing,
...
newTranslateDocumentRequest 
    ::  TranslateDocumentRequest
newTranslateDocumentRequest
  = TranslateDocumentRequest{customizedAttribution = Core.Nothing,
                             documentInputConfig = Core.Nothing,
                             documentOutputConfig = Core.Nothing,
                             enableRotationCorrection = Core.Nothing,
                             enableShadowRemovalNativePdf = Core.Nothing,
                             glossaryConfig = Core.Nothing,
                             isTranslateNativePdfOnly = Core.Nothing, labels = Core.Nothing,
                             model = Core.Nothing, sourceLanguageCode = Core.Nothing,
                             targetLanguageCode = Core.Nothing}
...
newTranslateDocumentResponse 
    ::  TranslateDocumentResponse
newTranslateDocumentResponse
  = TranslateDocumentResponse{documentTranslation = Core.Nothing,
                              glossaryConfig = Core.Nothing,
                              glossaryDocumentTranslation = Core.Nothing, model = Core.Nothing}
...
newTranslateTextRequest 
    ::  TranslateTextRequest
newTranslateTextRequest
  = TranslateTextRequest{contents = Core.Nothing,
                         glossaryConfig = Core.Nothing, labels = Core.Nothing,
                         mimeType = Core.Nothing, model = Core.Nothing,
                         sourceLanguageCode = Core.Nothing,
                         targetLanguageCode = Core.Nothing,
          ...
          = Core.withObject "TranslateTextRequest"
              (\ o ->
                 TranslateTextRequest Core.<$>
                   (o Core..:? "contents") Core.<*> (o Core..:? "glossaryConfig")
                     Core.<*> (o Core..:? "labels")
                     Core.<*> (o Core..:? "mimeType")
                     Core.<*> (o Core..:? "model")
                     Core.<*> (o Core..:? "sourceLanguageCode")
...
newTranslateTextResponse 
    ::  TranslateTextResponse
newTranslateTextResponse
  = TranslateTextResponse{glossaryTranslations = Core.Nothing,
...
newTranslation 
    ::  Translation
newTranslation
  = Translation{detectedLanguageCode = Core.Nothing,
                glossaryConfig = Core.Nothing, model = Core.Nothing,
...
instance Core.FromJSON TransliterationConfig where
        parseJSON
          = Core.withObject "TransliterationConfig"
              (\ o ->
                 TransliterationConfig Core.<$>
                   (o Core..:? "enableTransliteration"))
