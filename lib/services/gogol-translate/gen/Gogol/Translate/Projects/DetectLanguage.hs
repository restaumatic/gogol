...
newTranslateProjectsDetectLanguage parent payload
  = TranslateProjectsDetectLanguage{xgafv = Core.Nothing,
                                    accessToken = Core.Nothing, callback = Core.Nothing,
                                    parent = parent, payload = payload, uploadType = Core.Nothing,
                                    uploadProtocol = Core.Nothing}
instance Core.GoogleRequest TranslateProjectsDetectLanguage where
        type Rs TranslateProjectsDetectLanguage = DetectLanguageResponse
        ...
        requestClient TranslateProjectsDetectLanguage{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy TranslateProjectsDetectLanguageResource)
                      Core.mempty
