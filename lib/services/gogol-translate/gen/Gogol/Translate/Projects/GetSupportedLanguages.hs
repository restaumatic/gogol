           ...
           Core.QueryParam "$.xgafv" Xgafv Core.:>
             Core.QueryParam "access_token" Core.Text Core.:>
               Core.QueryParam "callback" Core.Text Core.:>
                 Core.QueryParam "displayLanguageCode" Core.Text Core.:>
                   Core.QueryParam "model" Core.Text Core.:>
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] SupportedLanguages
...
newTranslateProjectsGetSupportedLanguages parent
  = TranslateProjectsGetSupportedLanguages{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           displayLanguageCode = Core.Nothing, model = Core.Nothing,
                                           parent = parent, uploadType = Core.Nothing,
                                           uploadProtocol = Core.Nothing}
instance Core.GoogleRequest TranslateProjectsGetSupportedLanguages
         where
        type Rs TranslateProjectsGetSupportedLanguages = SupportedLanguages
        type Scopes TranslateProjectsGetSupportedLanguages =
             '[CloudPlatform'FullControl, CloudTranslation'FullControl]
        requestClient TranslateProjectsGetSupportedLanguages{..}
          = go parent xgafv accessToken callback displayLanguageCode model
              uploadType
              uploadProtocol
