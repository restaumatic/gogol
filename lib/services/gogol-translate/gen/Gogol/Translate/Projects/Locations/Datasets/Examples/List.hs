                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] ListExamplesResponse
...
newTranslateProjectsLocationsDatasetsExamplesList parent
  = TranslateProjectsLocationsDatasetsExamplesList{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           TranslateProjectsLocationsDatasetsExamplesList
         where
        type Rs TranslateProjectsLocationsDatasetsExamplesList =
             ListExamplesResponse
        type Scopes TranslateProjectsLocationsDatasetsExamplesList =
             '[CloudPlatform'FullControl, CloudTranslation'FullControl]
        requestClient TranslateProjectsLocationsDatasetsExamplesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy TranslateProjectsLocationsDatasetsExamplesListResource)
                      Core.mempty
