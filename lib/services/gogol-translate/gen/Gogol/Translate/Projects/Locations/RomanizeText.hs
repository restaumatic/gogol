...
type TranslateProjectsLocationsRomanizeTextResource =
     "v3" Core.:>
       Core.CaptureMode "parent" "romanizeText" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] RomanizeTextRequest Core.:>
                       Core.Post '[Core.JSON] RomanizeTextResponse
...
newTranslateProjectsLocationsRomanizeText parent payload
  = TranslateProjectsLocationsRomanizeText{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           parent = parent, payload = payload,
                                           uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest TranslateProjectsLocationsRomanizeText
         where
        type Rs TranslateProjectsLocationsRomanizeText =
             RomanizeTextResponse
        type Scopes TranslateProjectsLocationsRomanizeText =
