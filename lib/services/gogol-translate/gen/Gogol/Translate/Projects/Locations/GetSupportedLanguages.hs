...
newTranslateProjectsLocationsGetSupportedLanguages parent
  = TranslateProjectsLocationsGetSupportedLanguages{xgafv =
                                                      Core.Nothing,
                                                    accessToken = Core.Nothing,
                                                    callback = Core.Nothing,
                                                    displayLanguageCode = Core.Nothing,
                                                    model = Core.Nothing, parent = parent,
                                                    uploadType = Core.Nothing,
                                                    uploadProtocol = Core.Nothing}
instance Core.GoogleRequest
           TranslateProjectsLocationsGetSupportedLanguages
         where
        type Rs TranslateProjectsLocationsGetSupportedLanguages =
             SupportedLanguages
        type Scopes TranslateProjectsLocationsGetSupportedLanguages =
