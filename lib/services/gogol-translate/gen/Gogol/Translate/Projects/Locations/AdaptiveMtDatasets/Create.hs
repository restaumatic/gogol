...
newTranslateProjectsLocationsAdaptiveMtDatasetsCreate 
    ...
    -> TranslateProjectsLocationsAdaptiveMtDatasetsCreate
newTranslateProjectsLocationsAdaptiveMtDatasetsCreate parent
  payload
  = TranslateProjectsLocationsAdaptiveMtDatasetsCreate{xgafv =
                                                         Core.Nothing,
...
instance Core.GoogleRequest
           TranslateProjectsLocationsAdaptiveMtDatasetsCreate
         where
        type Rs TranslateProjectsLocationsAdaptiveMtDatasetsCreate =
             AdaptiveMtDataset
        type Scopes TranslateProjectsLocationsAdaptiveMtDatasetsCreate =
