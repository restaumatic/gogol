...
type TranslateProjectsLocationsBatchTranslateTextResource =
     "v3" Core.:>
       Core.CaptureMode "parent" "batchTranslateText" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] BatchTranslateTextRequest Core.:>
...
newTranslateProjectsLocationsBatchTranslateText parent payload
  = TranslateProjectsLocationsBatchTranslateText{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes TranslateProjectsLocationsBatchTranslateText =
