                   ...
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] GlossaryEntry Core.:>
                         Core.Post '[Core.JSON] GlossaryEntry
...
newTranslateProjectsLocationsGlossariesGlossaryEntriesCreate 
    ...
    -> TranslateProjectsLocationsGlossariesGlossaryEntriesCreate
newTranslateProjectsLocationsGlossariesGlossaryEntriesCreate parent
  payload
  = TranslateProjectsLocationsGlossariesGlossaryEntriesCreate{xgafv =
                                                                Core.Nothing,
...
instance Core.GoogleRequest
           TranslateProjectsLocationsGlossariesGlossaryEntriesCreate
         where
        type Rs TranslateProjectsLocationsGlossariesGlossaryEntriesCreate =
             GlossaryEntry
        type Scopes
               TranslateProjectsLocationsGlossariesGlossaryEntriesCreate
