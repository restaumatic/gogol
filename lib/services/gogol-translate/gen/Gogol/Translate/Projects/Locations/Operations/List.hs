...
newTranslateProjectsLocationsOperationsList name
  = TranslateProjectsLocationsOperationsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           TranslateProjectsLocationsOperationsList
         where
        type Rs TranslateProjectsLocationsOperationsList =
             ListOperationsResponse
        type Scopes TranslateProjectsLocationsOperationsList =
             '[CloudPlatform'FullControl, CloudTranslation'FullControl]
        requestClient TranslateProjectsLocationsOperationsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy TranslateProjectsLocationsOperationsListResource)
                      Core.mempty
