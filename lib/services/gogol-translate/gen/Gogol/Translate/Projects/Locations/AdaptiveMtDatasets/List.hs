                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] ListAdaptiveMtDatasetsResponse
...
newTranslateProjectsLocationsAdaptiveMtDatasetsList parent
  = TranslateProjectsLocationsAdaptiveMtDatasetsList{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           TranslateProjectsLocationsAdaptiveMtDatasetsList
         where
        type Rs TranslateProjectsLocationsAdaptiveMtDatasetsList =
             ListAdaptiveMtDatasetsResponse
        type Scopes TranslateProjectsLocationsAdaptiveMtDatasetsList =
