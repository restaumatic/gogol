                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] ListGlossaryEntriesResponse
...
newTranslateProjectsLocationsGlossariesGlossaryEntriesList parent
  = TranslateProjectsLocationsGlossariesGlossaryEntriesList{xgafv =
                                                              Core.Nothing,
...
instance Core.GoogleRequest
           TranslateProjectsLocationsGlossariesGlossaryEntriesList
         where
        type Rs TranslateProjectsLocationsGlossariesGlossaryEntriesList =
             ListGlossaryEntriesResponse
        type Scopes TranslateProjectsLocationsGlossariesGlossaryEntriesList
