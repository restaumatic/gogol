...
newTranslateProjectsLocationsModelsList parent
  = TranslateProjectsLocationsModelsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest TranslateProjectsLocationsModelsList
         where
        type Rs TranslateProjectsLocationsModelsList = ListModelsResponse
        type Scopes TranslateProjectsLocationsModelsList =
