...
type TranslateProjectsLocationsDetectLanguageResource =
     "v3" Core.:>
       Core.CaptureMode "parent" "detectLanguage" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] DetectLanguageRequest Core.:>
                       Core.Post '[Core.JSON] DetectLanguageResponse
...
newTranslateProjectsLocationsDetectLanguage parent payload
  = TranslateProjectsLocationsDetectLanguage{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           TranslateProjectsLocationsDetectLanguage
         where
        type Rs TranslateProjectsLocationsDetectLanguage =
             DetectLanguageResponse
        type Scopes TranslateProjectsLocationsDetectLanguage =
             '[CloudPlatform'FullControl, CloudTranslation'FullControl]
        requestClient TranslateProjectsLocationsDetectLanguage{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy TranslateProjectsLocationsDetectLanguageResource)
                      Core.mempty
