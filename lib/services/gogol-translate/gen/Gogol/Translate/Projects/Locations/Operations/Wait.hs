...
type TranslateProjectsLocationsOperationsWaitResource =
     "v3" Core.:>
       Core.CaptureMode "name" "wait" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] WaitOperationRequest Core.:>
...
newTranslateProjectsLocationsOperationsWait name payload
  = TranslateProjectsLocationsOperationsWait{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           TranslateProjectsLocationsOperationsWait
         where
        type Rs TranslateProjectsLocationsOperationsWait = Operation
        type Scopes TranslateProjectsLocationsOperationsWait =
             '[CloudPlatform'FullControl, CloudTranslation'FullControl]
        requestClient TranslateProjectsLocationsOperationsWait{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy TranslateProjectsLocationsOperationsWaitResource)
                      Core.mempty
