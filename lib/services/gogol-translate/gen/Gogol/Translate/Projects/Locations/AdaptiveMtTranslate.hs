...
type TranslateProjectsLocationsAdaptiveMtTranslateResource =
     "v3" Core.:>
       Core.CaptureMode "parent" "adaptiveMtTranslate" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] AdaptiveMtTranslateRequest Core.:>
                       Core.Post '[Core.JSON] AdaptiveMtTranslateResponse
...
newTranslateProjectsLocationsAdaptiveMtTranslate parent payload
  = TranslateProjectsLocationsAdaptiveMtTranslate{xgafv =
                                                    Core.Nothing,
...
instance Core.GoogleRequest
           TranslateProjectsLocationsAdaptiveMtTranslate
         where
        type Rs TranslateProjectsLocationsAdaptiveMtTranslate =
             AdaptiveMtTranslateResponse
        type Scopes TranslateProjectsLocationsAdaptiveMtTranslate =
