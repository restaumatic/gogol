               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.Get '[Core.JSON] GlossaryEntry
...
newTranslateProjectsLocationsGlossariesGlossaryEntriesGet name
  = TranslateProjectsLocationsGlossariesGlossaryEntriesGet{xgafv =
                                                             Core.Nothing,
...
instance Core.GoogleRequest
           TranslateProjectsLocationsGlossariesGlossaryEntriesGet
         where
        type Rs TranslateProjectsLocationsGlossariesGlossaryEntriesGet =
             GlossaryEntry
        type Scopes TranslateProjectsLocationsGlossariesGlossaryEntriesGet
