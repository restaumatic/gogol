...
type TranslateProjectsLocationsAdaptiveMtDatasetsImportAdaptiveMtFileResource
     =
     "v3" Core.:>
       Core.CaptureMode "parent" "importAdaptiveMtFile" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] ImportAdaptiveMtFileRequest Core.:>
...
newTranslateProjectsLocationsAdaptiveMtDatasetsImportAdaptiveMtFile
  parent payload
  = TranslateProjectsLocationsAdaptiveMtDatasetsImportAdaptiveMtFile{xgafv
                                                                       = Core.Nothing,
