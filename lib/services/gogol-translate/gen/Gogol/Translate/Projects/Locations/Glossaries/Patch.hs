...
newTranslateProjectsLocationsGlossariesPatch name payload
  = TranslateProjectsLocationsGlossariesPatch{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           TranslateProjectsLocationsGlossariesPatch
         where
        type Rs TranslateProjectsLocationsGlossariesPatch = Operation
        type Scopes TranslateProjectsLocationsGlossariesPatch =
             '[CloudPlatform'FullControl, CloudTranslation'FullControl]
        requestClient TranslateProjectsLocationsGlossariesPatch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy TranslateProjectsLocationsGlossariesPatchResource)
                      Core.mempty
