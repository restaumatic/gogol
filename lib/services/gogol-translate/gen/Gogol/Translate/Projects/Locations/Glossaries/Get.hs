...
newTranslateProjectsLocationsGlossariesGet name
  = TranslateProjectsLocationsGlossariesGet{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            name = name, uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest TranslateProjectsLocationsGlossariesGet
         where
        type Rs TranslateProjectsLocationsGlossariesGet = Glossary
        type Scopes TranslateProjectsLocationsGlossariesGet =
             '[CloudPlatform'FullControl, CloudTranslation'FullControl]
        requestClient TranslateProjectsLocationsGlossariesGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy TranslateProjectsLocationsGlossariesGetResource)
                      Core.mempty
