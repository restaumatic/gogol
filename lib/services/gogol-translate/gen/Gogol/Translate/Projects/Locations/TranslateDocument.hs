...
type TranslateProjectsLocationsTranslateDocumentResource =
     "v3" Core.:>
       Core.CaptureMode "parent" "translateDocument" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] TranslateDocumentRequest Core.:>
                       Core.Post '[Core.JSON] TranslateDocumentResponse
...
newTranslateProjectsLocationsTranslateDocument parent payload
  = TranslateProjectsLocationsTranslateDocument{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           TranslateProjectsLocationsTranslateDocument
         where
        type Rs TranslateProjectsLocationsTranslateDocument =
             TranslateDocumentResponse
        type Scopes TranslateProjectsLocationsTranslateDocument =
