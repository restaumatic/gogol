               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.Get '[Core.JSON] AdaptiveMtDataset
...
newTranslateProjectsLocationsAdaptiveMtDatasetsGet name
  = TranslateProjectsLocationsAdaptiveMtDatasetsGet{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           TranslateProjectsLocationsAdaptiveMtDatasetsGet
         where
        type Rs TranslateProjectsLocationsAdaptiveMtDatasetsGet =
             AdaptiveMtDataset
        type Scopes TranslateProjectsLocationsAdaptiveMtDatasetsGet =
