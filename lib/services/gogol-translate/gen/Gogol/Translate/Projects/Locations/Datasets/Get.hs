...
newTranslateProjectsLocationsDatasetsGet name
  = TranslateProjectsLocationsDatasetsGet{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          name = name, uploadType = Core.Nothing,
                                          uploadProtocol = Core.Nothing}
instance Core.GoogleRequest TranslateProjectsLocationsDatasetsGet
         where
        type Rs TranslateProjectsLocationsDatasetsGet = Dataset
        type Scopes TranslateProjectsLocationsDatasetsGet =
