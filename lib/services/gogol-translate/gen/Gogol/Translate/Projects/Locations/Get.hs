...
instance Core.GoogleRequest TranslateProjectsLocationsGet where
        ...
        requestClient TranslateProjectsLocationsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy TranslateProjectsLocationsGetResource)
                      Core.mempty
