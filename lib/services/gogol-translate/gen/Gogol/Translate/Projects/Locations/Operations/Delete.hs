...
newTranslateProjectsLocationsOperationsDelete name
  = TranslateProjectsLocationsOperationsDelete{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           TranslateProjectsLocationsOperationsDelete
         where
        type Rs TranslateProjectsLocationsOperationsDelete = Empty
        type Scopes TranslateProjectsLocationsOperationsDelete =
             '[CloudPlatform'FullControl, CloudTranslation'FullControl]
        requestClient TranslateProjectsLocationsOperationsDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy TranslateProjectsLocationsOperationsDeleteResource)
                      Core.mempty
