...
newTranslateProjectsLocationsDatasetsList parent
  = TranslateProjectsLocationsDatasetsList{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           pageSize = Core.Nothing, pageToken = Core.Nothing,
                                           parent = parent, uploadType = Core.Nothing,
                                           uploadProtocol = Core.Nothing}
instance Core.GoogleRequest TranslateProjectsLocationsDatasetsList
         where
        type Rs TranslateProjectsLocationsDatasetsList =
             ListDatasetsResponse
        type Scopes TranslateProjectsLocationsDatasetsList =
