...
newTranslateProjectsLocationsModelsCreate parent payload
  = TranslateProjectsLocationsModelsCreate{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           parent = parent, payload = payload,
                                           uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest TranslateProjectsLocationsModelsCreate
         where
        type Rs TranslateProjectsLocationsModelsCreate = Operation
        type Scopes TranslateProjectsLocationsModelsCreate =
