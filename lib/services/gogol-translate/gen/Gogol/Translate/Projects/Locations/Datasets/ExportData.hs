...
type TranslateProjectsLocationsDatasetsExportDataResource =
     "v3" Core.:>
       Core.CaptureMode "dataset" "exportData" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] ExportDataRequest Core.:>
...
newTranslateProjectsLocationsDatasetsExportData dataset payload
  = TranslateProjectsLocationsDatasetsExportData{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes TranslateProjectsLocationsDatasetsExportData =
