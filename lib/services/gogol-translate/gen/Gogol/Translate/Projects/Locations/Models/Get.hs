...
newTranslateProjectsLocationsModelsGet name
  = TranslateProjectsLocationsModelsGet{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        name = name, uploadType = Core.Nothing,
                                        uploadProtocol = Core.Nothing}
instance Core.GoogleRequest TranslateProjectsLocationsModelsGet
         where
        type Rs TranslateProjectsLocationsModelsGet = Model
        type Scopes TranslateProjectsLocationsModelsGet =
        ...
        requestClient TranslateProjectsLocationsModelsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy TranslateProjectsLocationsModelsGetResource)
                      Core.mempty
