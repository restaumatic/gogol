...
type TranslateProjectsLocationsTranslateTextResource =
     "v3" Core.:>
       Core.CaptureMode "parent" "translateText" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] TranslateTextRequest Core.:>
                       Core.Post '[Core.JSON] TranslateTextResponse
...
newTranslateProjectsLocationsTranslateText parent payload
  = TranslateProjectsLocationsTranslateText{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            parent = parent, payload = payload,
                                            uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest TranslateProjectsLocationsTranslateText
         where
        type Rs TranslateProjectsLocationsTranslateText =
             TranslateTextResponse
        type Scopes TranslateProjectsLocationsTranslateText =
