...
type TranslateProjectsLocationsBatchTranslateDocumentResource =
     "v3" Core.:>
       Core.CaptureMode "parent" "batchTranslateDocument" Core.Text
         Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] BatchTranslateDocumentRequest Core.:>
...
newTranslateProjectsLocationsBatchTranslateDocument parent payload
  = TranslateProjectsLocationsBatchTranslateDocument{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           TranslateProjectsLocationsBatchTranslateDocument
         where
        type Rs TranslateProjectsLocationsBatchTranslateDocument =
             Operation
        type Scopes TranslateProjectsLocationsBatchTranslateDocument =
             '[CloudPlatform'FullControl, CloudTranslation'FullControl]
        requestClient TranslateProjectsLocationsBatchTranslateDocument{..}
