...
newTranslateProjectsLocationsGlossariesList parent
  = TranslateProjectsLocationsGlossariesList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        requestClient TranslateProjectsLocationsGlossariesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy TranslateProjectsLocationsGlossariesListResource)
                      Core.mempty
