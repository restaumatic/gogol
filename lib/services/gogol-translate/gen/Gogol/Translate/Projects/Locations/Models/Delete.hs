...
newTranslateProjectsLocationsModelsDelete name
  = TranslateProjectsLocationsModelsDelete{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           name = name, uploadType = Core.Nothing,
                                           uploadProtocol = Core.Nothing}
instance Core.GoogleRequest TranslateProjectsLocationsModelsDelete
         where
        type Rs TranslateProjectsLocationsModelsDelete = Operation
        type Scopes TranslateProjectsLocationsModelsDelete =
