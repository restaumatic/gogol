...
newTranslateProjectsLocationsList name
  = TranslateProjectsLocationsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest TranslateProjectsLocationsList where
        type Rs TranslateProjectsLocationsList = ListLocationsResponse
        ...
        requestClient TranslateProjectsLocationsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy TranslateProjectsLocationsListResource)
                      Core.mempty
