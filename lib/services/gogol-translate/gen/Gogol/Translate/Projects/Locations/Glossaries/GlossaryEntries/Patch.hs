...
newTranslateProjectsLocationsGlossariesGlossaryEntriesPatch 
    ...
    -> TranslateProjectsLocationsGlossariesGlossaryEntriesPatch
newTranslateProjectsLocationsGlossariesGlossaryEntriesPatch name
  payload
  = TranslateProjectsLocationsGlossariesGlossaryEntriesPatch{xgafv =
                                                               Core.Nothing,
...
instance Core.GoogleRequest
           TranslateProjectsLocationsGlossariesGlossaryEntriesPatch
         where
        type Rs TranslateProjectsLocationsGlossariesGlossaryEntriesPatch =
             GlossaryEntry
        type Scopes
               TranslateProjectsLocationsGlossariesGlossaryEntriesPatch
