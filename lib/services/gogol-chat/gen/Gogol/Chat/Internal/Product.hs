...
--
-- /See:/ 'newCalendarEventLinkData' smart constructor.
data CalendarEventLinkData = CalendarEventLinkData
    {
      -- | The <https://developers.google.com/workspace/calendar/api/v3/reference/calendars Calendar identifier> of the linked Calendar.
      calendarId :: (Core.Maybe Core.Text)
      -- | The <https://developers.google.com/workspace/calendar/api/v3/reference/events Event identifier> of the linked Calendar event.
    , eventId :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'CalendarEventLinkData' with the minimum fields required to make a request.
newCalendarEventLinkData 
    ::  CalendarEventLinkData
newCalendarEventLinkData
  = CalendarEventLinkData{calendarId = Core.Nothing,
                          eventId = Core.Nothing}
instance Core.FromJSON CalendarEventLinkData where
        parseJSON
          = Core.withObject "CalendarEventLinkData"
              (\ o ->
                 CalendarEventLinkData Core.<$>
                   (o Core..:? "calendarId") Core.<*> (o Core..:? "eventId"))

instance Core.ToJSON CalendarEventLinkData where
        toJSON CalendarEventLinkData{..}
          = Core.object
              (Core.catMaybes
...
-- | The common event object is the portion of the overall event object that carries general, host-independent information to the add-on from the user\'s client. This information includes details such as the user\'s locale, host app, and platform. In addition to homepage and contextual triggers, add-ons construct and pass event objects to <https://developers.google.com/workspace/add-ons/concepts/actions#callback_functions action callback functions> when the user interacts with widgets. Your add-on\'s callback function can query the common event object to determine the contents of open widgets in the user\'s client. For example, your add-on can locate the text a user has entered into a <https://developers.google.com/apps-script/reference/card-service/text-input TextInput> widget in the @eventObject.commentEventObject.formInputs@ object. For Chat apps, the name of the function that the user invoked when interacting with a widget.
--
-- /See:/ 'newCommonEventObject' smart constructor.
data CommonEventObject = CommonEventObject
    {
      -- | A map containing the current values of the widgets in the displayed card. The map keys are the string IDs assigned with each widget. The structure of the map value object is dependent on the widget type: __Note__: The following examples are formatted for Apps Script\'s V8 runtime. If you\'re using Rhino runtime, you must add @[\"\"]@ after the value. For example, instead of @e.commonEventObject.formInputs.employeeName.stringInputs.value[0]@, format the event object as @e.commonEventObject.formInputs.employeeName[\"\"].stringInputs.value[0]@. To learn more about runtimes in Apps Script, see the <https://developers.google.com/apps-script/guides/v8-runtime V8 Runtime Overview>. * Single-valued widgets (for example, a text box): a list of strings (only one element). __Example__: for a text input widget with @employeeName@ as its ID, access the text input value with: @e.commonEventObject.formInputs.employeeName.stringInputs.value[0]@. * Multi-valued widgets (for example, checkbox groups): a list of strings.
      -- __Example__: for a multi-value widget with @participants@ as its ID, access the value array with: @e.commonEventObject.formInputs.participants.stringInputs.value@. * __A date-time picker__: a <https://developers.google.com/workspace/add-ons/concepts/event-objects#date-time-input DateTimeInput object>. __Example__: For a picker with an ID of @myDTPicker@, access the <https://developers.google.com/workspace/add-ons/concepts/event-objects#date-time-input DateTimeInput> object using @e.commonEventObject.formInputs.myDTPicker.dateTimeInput@. * __A date-only picker__: a <https://developers.google.com/workspace/add-ons/concepts/event-objects#date-input DateInput object>. __Example__: For a picker with an ID of @myDatePicker@, access the <https://developers.google.com/workspace/add-ons/concepts/event-objects#date-input DateInput> object using @e.commonEventObject.formInputs.myDatePicker.dateInput@. * __A time-only picker__: a
      -- <https://developers.google.com/workspace/add-ons/concepts/event-objects#time-input TimeInput object>. __Example__: For a picker with an ID of @myTimePicker@, access the <https://developers.google.com/workspace/add-ons/concepts/event-objects#time-input TimeInput> object using @e.commonEventObject.formInputs.myTimePicker.timeInput@.
    ...
    , hostApp :: (Core.Maybe CommonEventObject_HostApp)
      -- | Name of the function to invoke. This field doesn\'t populate for Google Workspace Add-ons that extend Google Chat. Instead, to receive function data like identifiers, add-ons that extend Chat should use the @parameters@ field. See <https://developers.google.com/workspace/add-ons/chat/build Build interactive interfaces for Chat apps>.
    , invokedFunction :: (Core.Maybe Core.Text)
      -- | Any additional parameters you supply to an action using <https://developers.google.com/workspace/add-ons/reference/rpc/google.apps.card.v1#google.apps.card.v1.Action.ActionParameter actionParameters> or <https://developers.google.com/apps-script/reference/card-service/action#setparametersparameters Action.setParameters()>. __Developer Preview:__ For <https://developers.google.com/workspace/add-ons/chat add-ons that extend Google Chat>, to suggest items based on what the users type in multiselect menus, use the value of the @\"autocomplete_widget_query\"@ key (@event.commonEventObject.parameters[\"autocomplete_widget_query\"]@). You can use this value to query a database and suggest selectable items to users as they type. For details, see <https://developers.google.com/workspace/add-ons/chat/collect-information Collect and process information from Google Chat users>.
    ...
    , platform :: (Core.Maybe CommonEventObject_Platform)
      -- | __Disabled by default.__ The timezone ID and offset from Coordinated Universal Time (UTC). To turn on this field, you must set @addOns.common.useLocaleFromApp@ to @true@ in your add-on\'s manifest. Your add-on\'s scope list must also include @https:\/\/www.googleapis.com\/auth\/script.locale@. See <https://developers.google.com/workspace/add-ons/how-tos/access-user-locale Accessing user locale and timezone> for more details. Only supported for the event types <https://developers.google.com/chat/api/reference/rest/v1/EventType#ENUM_VALUES.CARD_CLICKED CARD_CLICKED> and <https://developers.google.com/chat/api/reference/rest/v1/DialogEventType#ENUM_VALUES.SUBMIT_DIALOG SUBMIT_DIALOG>.
    , timeZone :: (Core.Maybe TimeZone)
      -- | __Disabled by default.__ The user\'s language and country\/region identifier in the format of <https://wikipedia.org/wiki/ISO_639_macrolanguage ISO 639> language code-<https://wikipedia.org/wiki/ISO_3166 ISO 3166> country\/region code. For example, @en-US@. To turn on this field, you must set @addOns.common.useLocaleFromApp@ to @true@ in your add-on\'s manifest. Your add-on\'s scope list must also include @https:\/\/www.googleapis.com\/auth\/script.locale@. See <https://developers.google.com/workspace/add-ons/how-tos/access-user-locale Accessing user locale and timezone> for more details.
...
data GoogleAppsCardV1Card = GoogleAppsCardV1Card
    ...
    , expressionData :: (Core.Maybe [GoogleAppsCardV1ExpressionData])
...
newGoogleAppsCardV1Card
  = GoogleAppsCardV1Card{cardActions = Core.Nothing,
                         displayStyle = Core.Nothing, expressionData = Core.Nothing,
                         fixedFooter = Core.Nothing, header = Core.Nothing,
                         name = Core.Nothing, peekCardHeader = Core.Nothing,
                         sectionDividerStyle = Core.Nothing, sections = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("cardActions" Core..=) Core.<$> cardActions,
                  ...
                  ("expressionData" Core..=) Core.<$> expressionData,
...
-- | A card that can be displayed as a carousel item. <https://developers.google.com/workspace/chat Google Chat apps>:
--
...
--
-- /See:/ 'newGoogleAppsCardV1CommonWidgetAction' smart constructor.
newtype GoogleAppsCardV1CommonWidgetAction = GoogleAppsCardV1CommonWidgetAction
    {
      -- | The action to update the visibility of a widget.
      updateVisibilityAction :: (Core.Maybe GoogleAppsCardV1UpdateVisibilityAction)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'GoogleAppsCardV1CommonWidgetAction' with the minimum fields required to make a request.
newGoogleAppsCardV1CommonWidgetAction 
    :: 
                                      GoogleAppsCardV1CommonWidgetAction
newGoogleAppsCardV1CommonWidgetAction
  = GoogleAppsCardV1CommonWidgetAction{updateVisibilityAction =
                                         Core.Nothing}
instance Core.FromJSON GoogleAppsCardV1CommonWidgetAction where
        parseJSON
          = Core.withObject "GoogleAppsCardV1CommonWidgetAction"
              (\ o ->
                 GoogleAppsCardV1CommonWidgetAction Core.<$>
                   (o Core..:? "updateVisibilityAction"))

instance Core.ToJSON GoogleAppsCardV1CommonWidgetAction where
        toJSON GoogleAppsCardV1CommonWidgetAction{..}
          = Core.object
              (Core.catMaybes
                 [("updateVisibilityAction" Core..=) Core.<$>
...
--
-- /See:/ 'newGoogleAppsCardV1Condition' smart constructor.
data GoogleAppsCardV1Condition = GoogleAppsCardV1Condition
    {
      -- | The unique identifier of the ActionRule.
      actionRuleId :: (Core.Maybe Core.Text)
      -- | The condition that is determined by the expression data.
    , expressionDataCondition :: (Core.Maybe GoogleAppsCardV1ExpressionDataCondition)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'GoogleAppsCardV1Condition' with the minimum fields required to make a request.
newGoogleAppsCardV1Condition 
    ::  GoogleAppsCardV1Condition
newGoogleAppsCardV1Condition
  = GoogleAppsCardV1Condition{actionRuleId = Core.Nothing,
                              expressionDataCondition = Core.Nothing}
instance Core.FromJSON GoogleAppsCardV1Condition where
        parseJSON
          = Core.withObject "GoogleAppsCardV1Condition"
              (\ o ->
                 GoogleAppsCardV1Condition Core.<$>
                   (o Core..:? "actionRuleId") Core.<*>
                     (o Core..:? "expressionDataCondition"))

instance Core.ToJSON GoogleAppsCardV1Condition where
        toJSON GoogleAppsCardV1Condition{..}
          = Core.object
              (Core.catMaybes
                 [("actionRuleId" Core..=) Core.<$> actionRuleId,
                  ("expressionDataCondition" Core..=) Core.<$>
...
--
-- /See:/ 'newGoogleAppsCardV1DataSourceConfig' smart constructor.
data GoogleAppsCardV1DataSourceConfig = GoogleAppsCardV1DataSourceConfig
    {
    ...
    , remoteDataSource :: (Core.Maybe GoogleAppsCardV1Action)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'GoogleAppsCardV1DataSourceConfig' with the minimum fields required to make a request.
newGoogleAppsCardV1DataSourceConfig 
    :: 
                                    GoogleAppsCardV1DataSourceConfig
newGoogleAppsCardV1DataSourceConfig
  = GoogleAppsCardV1DataSourceConfig{platformDataSource =
                                       Core.Nothing,
                                     remoteDataSource = Core.Nothing}
instance Core.FromJSON GoogleAppsCardV1DataSourceConfig where
        parseJSON
          = Core.withObject "GoogleAppsCardV1DataSourceConfig"
              (\ o ->
                 GoogleAppsCardV1DataSourceConfig Core.<$>
                   (o Core..:? "platformDataSource") Core.<*>
                     (o Core..:? "remoteDataSource"))

instance Core.ToJSON GoogleAppsCardV1DataSourceConfig where
        toJSON GoogleAppsCardV1DataSourceConfig{..}
          = Core.object
              (Core.catMaybes
                 [("platformDataSource" Core..=) Core.<$> platformDataSource,
                  ("remoteDataSource" Core..=) Core.<$> remoteDataSource])
...
newGoogleAppsCardV1DateTimePicker 
    ::  GoogleAppsCardV1DateTimePicker
newGoogleAppsCardV1DateTimePicker
  = GoogleAppsCardV1DateTimePicker{hostAppDataSource = Core.Nothing,
                                   label = Core.Nothing, name = Core.Nothing,
                                   onChangeAction = Core.Nothing, timezoneOffsetDate = Core.Nothing,
                                   type' = Core.Nothing, valueMsEpoch = Core.Nothing}
          ...
          = Core.withObject "GoogleAppsCardV1DateTimePicker"
              (\ o ->
                 GoogleAppsCardV1DateTimePicker Core.<$>
                   (o Core..:? "hostAppDataSource") Core.<*> (o Core..:? "label")
                     Core.<*> (o Core..:? "name")
...
data GoogleAppsCardV1DecoratedText = GoogleAppsCardV1DecoratedText
    {
      ...
      -- | @TextParagraph@ equivalent of @bottom_label@. Always wraps. Allows for more complex formatting than @bottom_label@. <https://developers.google.com/workspace/chat Google Chat apps>:
    , bottomLabelText :: (Core.Maybe GoogleAppsCardV1TextParagraph)
      -- | A button that a user can click to trigger an action.
    , button :: (Core.Maybe GoogleAppsCardV1Button)
      -- | @TextParagraph@ equivalent of @text@. Allows for more complex formatting than @text@. <https://developers.google.com/workspace/chat Google Chat apps>:
    , contentText :: (Core.Maybe GoogleAppsCardV1TextParagraph)
    ...
    , startIconVerticalAlignment :: (Core.Maybe
   GoogleAppsCardV1DecoratedText_StartIconVerticalAlignment)
    ...
    , topLabel :: (Core.Maybe Core.Text)
      -- | @TextParagraph@ equivalent of @top_label@. Always truncates. Allows for more complex formatting than @top_label@. <https://developers.google.com/workspace/chat Google Chat apps>:
    , topLabelText :: (Core.Maybe GoogleAppsCardV1TextParagraph)
...
newGoogleAppsCardV1DecoratedText
  = GoogleAppsCardV1DecoratedText{bottomLabel = Core.Nothing,
                                  bottomLabelText = Core.Nothing, button = Core.Nothing,
                                  contentText = Core.Nothing, endIcon = Core.Nothing,
                                  icon = Core.Nothing, onClick = Core.Nothing,
                                  startIcon = Core.Nothing,
                                  startIconVerticalAlignment = Core.Nothing,
                                  switchControl = Core.Nothing, text = Core.Nothing,
                                  topLabel = Core.Nothing, topLabelText = Core.Nothing,
          ...
          = Core.withObject "GoogleAppsCardV1DecoratedText"
              (\ o ->
                 GoogleAppsCardV1DecoratedText Core.<$>
                   (o Core..:? "bottomLabel") Core.<*> (o Core..:? "bottomLabelText")
                     Core.<*> (o Core..:? "button")
                     Core.<*> (o Core..:? "contentText")
                     Core.<*> (o Core..:? "endIcon")
                     Core.<*> (o Core..:? "icon")
                     Core.<*> (o Core..:? "onClick")
                     Core.<*> (o Core..:? "startIcon")
                     Core.<*> (o Core..:? "startIconVerticalAlignment")
                     Core.<*> (o Core..:? "switchControl")
                     Core.<*> (o Core..:? "text")
                     Core.<*> (o Core..:? "topLabel")
                     Core.<*> (o Core..:? "topLabelText")
...
--
-- /See:/ 'newGoogleAppsCardV1EventAction' smart constructor.
data GoogleAppsCardV1EventAction = GoogleAppsCardV1EventAction
    {
      -- | The unique identifier of the ActionRule.
      actionRuleId :: (Core.Maybe Core.Text)
      -- | Common widget action.
    , commonWidgetAction :: (Core.Maybe GoogleAppsCardV1CommonWidgetAction)
      -- | The list of triggers that will be triggered after the EventAction is executed.
    , postEventTriggers :: (Core.Maybe [GoogleAppsCardV1Trigger])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'GoogleAppsCardV1EventAction' with the minimum fields required to make a request.
newGoogleAppsCardV1EventAction 
    ::  GoogleAppsCardV1EventAction
newGoogleAppsCardV1EventAction
  = GoogleAppsCardV1EventAction{actionRuleId = Core.Nothing,
                                commonWidgetAction = Core.Nothing,
                                postEventTriggers = Core.Nothing}
instance Core.FromJSON GoogleAppsCardV1EventAction where
        parseJSON
          = Core.withObject "GoogleAppsCardV1EventAction"
              (\ o ->
                 GoogleAppsCardV1EventAction Core.<$>
                   (o Core..:? "actionRuleId") Core.<*>
                     (o Core..:? "commonWidgetAction")
                     Core.<*> (o Core..:? "postEventTriggers"))

instance Core.ToJSON GoogleAppsCardV1EventAction where
        toJSON GoogleAppsCardV1EventAction{..}
          = Core.object
              (Core.catMaybes
                 [("actionRuleId" Core..=) Core.<$> actionRuleId,
                  ("commonWidgetAction" Core..=) Core.<$> commonWidgetAction,
                  ("postEventTriggers" Core..=) Core.<$> postEventTriggers])
...
--
-- /See:/ 'newGoogleAppsCardV1ExpressionData' smart constructor.
data GoogleAppsCardV1ExpressionData = GoogleAppsCardV1ExpressionData
    {
      -- | The list of conditions that are determined by the expression evaluation result.
      conditions :: (Core.Maybe [GoogleAppsCardV1Condition])
      -- | The list of actions that the ExpressionData can be used.
    , eventActions :: (Core.Maybe [GoogleAppsCardV1EventAction])
...
-- | Creates a value of 'GoogleAppsCardV1ExpressionData' with the minimum fields required to make a request.
newGoogleAppsCardV1ExpressionData 
    ::  GoogleAppsCardV1ExpressionData
newGoogleAppsCardV1ExpressionData
  = GoogleAppsCardV1ExpressionData{conditions = Core.Nothing,
                                   eventActions = Core.Nothing, expression = Core.Nothing,
                                   id = Core.Nothing}
instance Core.FromJSON GoogleAppsCardV1ExpressionData where
        parseJSON
          = Core.withObject "GoogleAppsCardV1ExpressionData"
              (\ o ->
                 GoogleAppsCardV1ExpressionData Core.<$>
                   (o Core..:? "conditions") Core.<*> (o Core..:? "eventActions")
                     Core.<*> (o Core..:? "expression")
                     Core.<*> (o Core..:? "id"))

instance Core.ToJSON GoogleAppsCardV1ExpressionData where
        toJSON GoogleAppsCardV1ExpressionData{..}
          = Core.object
              (Core.catMaybes
                 [("conditions" Core..=) Core.<$> conditions,
                  ("eventActions" Core..=) Core.<$> eventActions,
...
--
-- /See:/ 'newGoogleAppsCardV1ExpressionDataCondition' smart constructor.
newtype GoogleAppsCardV1ExpressionDataCondition = GoogleAppsCardV1ExpressionDataCondition
    {
      -- | The type of the condition.
      conditionType :: (Core.Maybe GoogleAppsCardV1ExpressionDataCondition_ConditionType)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'GoogleAppsCardV1ExpressionDataCondition' with the minimum fields required to make a request.
newGoogleAppsCardV1ExpressionDataCondition 
    :: 
                                           GoogleAppsCardV1ExpressionDataCondition
newGoogleAppsCardV1ExpressionDataCondition
  = GoogleAppsCardV1ExpressionDataCondition{conditionType =
                                              Core.Nothing}
instance Core.FromJSON GoogleAppsCardV1ExpressionDataCondition
         where
        parseJSON
          = Core.withObject "GoogleAppsCardV1ExpressionDataCondition"
              (\ o ->
                 GoogleAppsCardV1ExpressionDataCondition Core.<$>
                   (o Core..:? "conditionType"))

instance Core.ToJSON GoogleAppsCardV1ExpressionDataCondition where
        toJSON GoogleAppsCardV1ExpressionDataCondition{..}
          = Core.object
              (Core.catMaybes [("conditionType" Core..=) Core.<$> conditionType])
...
-- | A list of widgets that can be displayed in a containing layout, such as a @CarouselCard@. <https://developers.google.com/workspace/chat Google Chat apps>:
--
...
newGoogleAppsCardV1Section
  = GoogleAppsCardV1Section{collapseControl = Core.Nothing,
                            ...
                            id = Core.Nothing, uncollapsibleWidgetsCount = Core.Nothing,
                            widgets = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("collapseControl" Core..=) Core.<$> collapseControl,
                  ...
                  ("header" Core..=) Core.<$> header, ("id" Core..=) Core.<$> id,
...
data GoogleAppsCardV1SelectionInput = GoogleAppsCardV1SelectionInput
    {
      ...
      dataSourceConfigs :: (Core.Maybe [GoogleAppsCardV1DataSourceConfig])
...
newGoogleAppsCardV1SelectionInput 
    ::  GoogleAppsCardV1SelectionInput
newGoogleAppsCardV1SelectionInput
  = GoogleAppsCardV1SelectionInput{dataSourceConfigs = Core.Nothing,
                                   externalDataSource = Core.Nothing, hintText = Core.Nothing,
          ...
          = Core.withObject "GoogleAppsCardV1SelectionInput"
              (\ o ->
                 GoogleAppsCardV1SelectionInput Core.<$>
                   (o Core..:? "dataSourceConfigs") Core.<*>
                     (o Core..:? "externalDataSource")
...
instance Core.ToJSON GoogleAppsCardV1SelectionInput where
        toJSON GoogleAppsCardV1SelectionInput{..}
          = Core.object
              (Core.catMaybes
                 [("dataSourceConfigs" Core..=) Core.<$> dataSourceConfigs,
...
newGoogleAppsCardV1TextInput
  = GoogleAppsCardV1TextInput{autoCompleteAction = Core.Nothing,
                              hintText = Core.Nothing, hostAppDataSource = Core.Nothing,
                              initialSuggestions = Core.Nothing, label = Core.Nothing,
                              name = Core.Nothing, onChangeAction = Core.Nothing,
                              placeholderText = Core.Nothing, type' = Core.Nothing,
                              validation = Core.Nothing, value = Core.Nothing}
...
data GoogleAppsCardV1TextParagraph = GoogleAppsCardV1TextParagraph
    ...
    , textSyntax :: (Core.Maybe GoogleAppsCardV1TextParagraph_TextSyntax)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newGoogleAppsCardV1TextParagraph
  = GoogleAppsCardV1TextParagraph{maxLines = Core.Nothing,
                                  text = Core.Nothing, textSyntax = Core.Nothing}
          ...
          = Core.withObject "GoogleAppsCardV1TextParagraph"
              (\ o ->
                 GoogleAppsCardV1TextParagraph Core.<$>
                   (o Core..:? "maxLines") Core.<*> (o Core..:? "text") Core.<*>
                     (o Core..:? "textSyntax"))
          ...
          = Core.object
              (Core.catMaybes
                 [("maxLines" Core..=) Core.<$> maxLines,
                  ("text" Core..=) Core.<$> text,
                  ("textSyntax" Core..=) Core.<$> textSyntax])


-- | Represents a trigger. Only supported by Google Workspace Workflow, but not Google Chat apps or Google Workspace add-ons.
--
-- /See:/ 'newGoogleAppsCardV1Trigger' smart constructor.
newtype GoogleAppsCardV1Trigger = GoogleAppsCardV1Trigger
    {
      -- | The unique identifier of the ActionRule.
      actionRuleId :: (Core.Maybe Core.Text)
    }
...
-- | Creates a value of 'GoogleAppsCardV1Trigger' with the minimum fields required to make a request.
newGoogleAppsCardV1Trigger 
    ::  GoogleAppsCardV1Trigger
newGoogleAppsCardV1Trigger
  = GoogleAppsCardV1Trigger{actionRuleId = Core.Nothing}
instance Core.FromJSON GoogleAppsCardV1Trigger where
        parseJSON
          = Core.withObject "GoogleAppsCardV1Trigger"
              (\ o ->
                 GoogleAppsCardV1Trigger Core.<$> (o Core..:? "actionRuleId"))

instance Core.ToJSON GoogleAppsCardV1Trigger where
        toJSON GoogleAppsCardV1Trigger{..}
          = Core.object
              (Core.catMaybes [("actionRuleId" Core..=) Core.<$> actionRuleId])
...
--
-- /See:/ 'newGoogleAppsCardV1UpdateVisibilityAction' smart constructor.
newtype GoogleAppsCardV1UpdateVisibilityAction = GoogleAppsCardV1UpdateVisibilityAction
    {
      -- | The new visibility.
      visibility :: (Core.Maybe GoogleAppsCardV1UpdateVisibilityAction_Visibility)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'GoogleAppsCardV1UpdateVisibilityAction' with the minimum fields required to make a request.
newGoogleAppsCardV1UpdateVisibilityAction 
    :: 
                                          GoogleAppsCardV1UpdateVisibilityAction
newGoogleAppsCardV1UpdateVisibilityAction
  = GoogleAppsCardV1UpdateVisibilityAction{visibility = Core.Nothing}
instance Core.FromJSON GoogleAppsCardV1UpdateVisibilityAction where
        parseJSON
          = Core.withObject "GoogleAppsCardV1UpdateVisibilityAction"
              (\ o ->
                 GoogleAppsCardV1UpdateVisibilityAction Core.<$>
                   (o Core..:? "visibility"))

instance Core.ToJSON GoogleAppsCardV1UpdateVisibilityAction where
        toJSON GoogleAppsCardV1UpdateVisibilityAction{..}
          = Core.object
              (Core.catMaybes [("visibility" Core..=) Core.<$> visibility])
...
data GoogleAppsCardV1Widget = GoogleAppsCardV1Widget
    ...
    , visibility :: (Core.Maybe GoogleAppsCardV1Widget_Visibility)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newGoogleAppsCardV1Widget
  = GoogleAppsCardV1Widget{buttonList = Core.Nothing,
                           ...
                           eventActions = Core.Nothing, grid = Core.Nothing,
                           horizontalAlignment = Core.Nothing, id = Core.Nothing,
          ...
          = Core.object
              (Core.catMaybes
                 [("chatDataSource" Core..=) Core.<$> chatDataSource,
                  ("workflowDataSource" Core..=) Core.<$> workflowDataSource])
...
--
-- /See:/ 'newMeetSpaceLinkData' smart constructor.
data MeetSpaceLinkData = MeetSpaceLinkData
    {
      -- | Optional. Output only. If the Meet is a Huddle, indicates the status of the huddle. Otherwise, this is unset.
      huddleStatus :: (Core.Maybe MeetSpaceLinkData_HuddleStatus)
      -- | Meeting code of the linked Meet space.
    , meetingCode :: (Core.Maybe Core.Text)
      -- | Indicates the type of the Meet space.
    , type' :: (Core.Maybe MeetSpaceLinkData_Type)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'MeetSpaceLinkData' with the minimum fields required to make a request.
newMeetSpaceLinkData 
    ::  MeetSpaceLinkData
newMeetSpaceLinkData
  = MeetSpaceLinkData{huddleStatus = Core.Nothing,
                      meetingCode = Core.Nothing, type' = Core.Nothing}
instance Core.FromJSON MeetSpaceLinkData where
        parseJSON
          = Core.withObject "MeetSpaceLinkData"
              (\ o ->
                 MeetSpaceLinkData Core.<$>
                   (o Core..:? "huddleStatus") Core.<*> (o Core..:? "meetingCode")
                     Core.<*> (o Core..:? "type"))

instance Core.ToJSON MeetSpaceLinkData where
        toJSON MeetSpaceLinkData{..}
          = Core.object
              (Core.catMaybes
                 [("huddleStatus" Core..=) Core.<$> huddleStatus,
...
data Message = Message
    ...
    , privateMessageViewer :: (Core.Maybe User)
      -- | Optional. Information about a message that another message quotes. When you create a message, you can quote messages within the same thread, or quote a root message to create a new root message. However, you can\'t quote a message reply from a different thread. When you update a message, you can\'t add or replace the @quotedMessageMetadata@ field, but you can remove it. For example usage, see <https://developers.google.com/workspace/chat/create-messages#quote-a-message Quote another message>.
...
-- | Information about a message that another message quotes. When you create a message, you can quote messages within the same thread, or quote a root message to create a new root message. However, you can\'t quote a message reply from a different thread. When you update a message, you can\'t add or replace the @quotedMessageMetadata@ field, but you can remove it. For example usage, see <https://developers.google.com/workspace/chat/create-messages#quote-a-message Quote another message>.
--
...
newRichLinkMetadata 
    ::  RichLinkMetadata
newRichLinkMetadata
  = RichLinkMetadata{calendarEventLinkData = Core.Nothing,
                     chatSpaceLinkData = Core.Nothing, driveLinkData = Core.Nothing,
                     meetSpaceLinkData = Core.Nothing, richLinkType = Core.Nothing,
                     uri = Core.Nothing}
          ...
          = Core.withObject "RichLinkMetadata"
              (\ o ->
                 RichLinkMetadata Core.<$>
                   (o Core..:? "calendarEventLinkData") Core.<*>
                     (o Core..:? "chatSpaceLinkData")
                     Core.<*> (o Core..:? "driveLinkData")
                     Core.<*> (o Core..:? "meetSpaceLinkData")
...
instance Core.ToJSON RichLinkMetadata where
        toJSON RichLinkMetadata{..}
          = Core.object
              (Core.catMaybes
                 [("calendarEventLinkData" Core..=) Core.<$> calendarEventLinkData,
                  ("chatSpaceLinkData" Core..=) Core.<$> chatSpaceLinkData,
                  ("driveLinkData" Core..=) Core.<$> driveLinkData,
                  ("meetSpaceLinkData" Core..=) Core.<$> meetSpaceLinkData,
...
data Space = Space
    ...
    , createTime :: (Core.Maybe Core.DateTime)
      -- | Optional. Immutable. The customer id of the domain of the space. Required only when creating a space with <https://developers.google.com/workspace/chat/authenticate-authorize-chat-app app authentication> and @SpaceType@ is @SPACE@, otherwise should not be set. In the format @customers\/{customer}@, where @customer@ is the @id@ from the <https://developers.google.com/admin-sdk/directory/reference/rest/v1/customers Admin SDK customer resource>. Private apps can also use the @customers\/my_customer@ alias to create the space in the same Google Workspace organization as the app. For DMs, this field isn\'t populated.
...
newSpace
  = Space{accessSettings = Core.Nothing,
          ...
          customer = Core.Nothing, displayName = Core.Nothing,
          externalUserAllowed = Core.Nothing, importMode = Core.Nothing,
          importModeExpireTime = Core.Nothing, lastActiveTime = Core.Nothing,
          membershipCount = Core.Nothing, name = Core.Nothing,
...
--
-- /See:/ 'newWorkflowDataSourceMarkup' smart constructor.
data WorkflowDataSourceMarkup = WorkflowDataSourceMarkup
    {
      -- | Whether to include variables from the previous step in the data source.
      includeVariables :: (Core.Maybe Core.Bool)
      -- | The type of data source.
    , type' :: (Core.Maybe WorkflowDataSourceMarkup_Type)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'WorkflowDataSourceMarkup' with the minimum fields required to make a request.
newWorkflowDataSourceMarkup 
    ::  WorkflowDataSourceMarkup
newWorkflowDataSourceMarkup
  = WorkflowDataSourceMarkup{includeVariables = Core.Nothing,
                             type' = Core.Nothing}
instance Core.FromJSON WorkflowDataSourceMarkup where
        parseJSON
          = Core.withObject "WorkflowDataSourceMarkup"
              (\ o ->
                 WorkflowDataSourceMarkup Core.<$>
                   (o Core..:? "includeVariables") Core.<*> (o Core..:? "type"))

instance Core.ToJSON WorkflowDataSourceMarkup where
        toJSON WorkflowDataSourceMarkup{..}
          = Core.object
              (Core.catMaybes
                 [("includeVariables" Core..=) Core.<$> includeVariables,
                  ("type" Core..=) Core.<$> type'])
