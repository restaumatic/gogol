...
-- @https:\/\/www.googleapis.com\/auth\/chat.memberships.app@ (to add the calling app to the space) - @https:\/\/www.googleapis.com\/auth\/chat.import@ (import mode spaces only) - User authentication grants administrator privileges when an administrator account authenticates, @use_admin_access@ is @true@, and the following authorization scope is used: - @https:\/\/www.googleapis.com\/auth\/chat.admin.memberships@ App authentication is not supported for the following use cases: - Inviting users external to the Workspace organization that owns the space. - Adding a Google Group to a space. - Adding a Chat app to a space. For example usage, see: - <https://developers.google.com/workspace/chat/create-members#create-user-membership Invite or add a user to a space>. - <https://developers.google.com/workspace/chat/create-members#create-group-membership Invite or add a Google Group to a space>. - <https://developers.google.com/workspace/chat/create-members#create-membership-calling-api Add the Chat app to a space>.
--
-- /See:/ <https://developers.google.com/workspace/chat Google Chat API Reference> for @chat.spaces.members.create@.
module Gogol.Chat.Spaces.Members.Create
    (
    -- * Resource
