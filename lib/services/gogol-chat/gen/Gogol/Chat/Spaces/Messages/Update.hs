...
--
-- /See:/ <https://developers.google.com/workspace/chat Google Chat API Reference> for @chat.spaces.messages.update@.
module Gogol.Chat.Spaces.Messages.Update
    (
    -- * Resource
