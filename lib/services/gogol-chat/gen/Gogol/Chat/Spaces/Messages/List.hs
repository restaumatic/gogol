...
--
-- Lists messages in a space that the caller is a member of, including messages from blocked members and spaces. System messages, like those announcing new space members, aren\'t included. If you list messages from a space with no messages, the response is an empty object. When using a REST\/HTTP interface, the response contains an empty JSON object, @{}@. For an example, see <https://developers.google.com/workspace/chat/api/guides/v1/messages/list List messages>. Supports the following types of <https://developers.google.com/workspace/chat/authenticate-authorize authentication>: - <https://developers.google.com/workspace/chat/authenticate-authorize-chat-app App authentication> with <https://support.google.com/a?p=chat-app-auth administrator approval> in <https://developers.google.com/workspace/preview Developer Preview> with the authorization scope: - @https:\/\/www.googleapis.com\/auth\/chat.app.messages.readonly@. When using this authentication scope, this method only returns public messages in a space. It
-- doesn\'t include private messages. - <https://developers.google.com/workspace/chat/authenticate-authorize-chat-user User authentication> with one of the following authorization scopes: - @https:\/\/www.googleapis.com\/auth\/chat.messages.readonly@ - @https:\/\/www.googleapis.com\/auth\/chat.messages@ - @https:\/\/www.googleapis.com\/auth\/chat.import@ (import mode spaces only)
--
-- /See:/ <https://developers.google.com/workspace/chat Google Chat API Reference> for @chat.spaces.messages.list@.
module Gogol.Chat.Spaces.Messages.List
    (
    -- * Resource
...
instance Core.GoogleRequest ChatSpacesMessagesList where
        ...
        type Scopes ChatSpacesMessagesList =
             '[Chat'App'Messages'Readonly, Chat'Import, Chat'Messages,
