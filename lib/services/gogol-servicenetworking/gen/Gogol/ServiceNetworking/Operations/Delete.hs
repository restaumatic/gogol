...
newServiceNetworkingOperationsDelete name
  = ServiceNetworkingOperationsDelete{xgafv = Core.Nothing,
                                      accessToken = Core.Nothing, callback = Core.Nothing,
                                      name = name, uploadType = Core.Nothing,
                                      uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ServiceNetworkingOperationsDelete where
        type Rs ServiceNetworkingOperationsDelete = Empty
        type Scopes ServiceNetworkingOperationsDelete =
