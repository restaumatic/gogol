...
type ServiceNetworkingServicesProjectsGlobalNetworksUpdateConsumerConfigResource
     =
     "v1" Core.:>
       Core.CaptureMode "parent" "updateConsumerConfig" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] UpdateConsumerConfigRequest Core.:>
...
newServiceNetworkingServicesProjectsGlobalNetworksUpdateConsumerConfig
  parent payload
  = ServiceNetworkingServicesProjectsGlobalNetworksUpdateConsumerConfig{xgafv
                                                                          = Core.Nothing,
