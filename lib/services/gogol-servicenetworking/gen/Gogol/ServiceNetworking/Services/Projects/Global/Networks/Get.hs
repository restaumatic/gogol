         ...
         Core.QueryParam "$.xgafv" Xgafv Core.:>
           Core.QueryParam "access_token" Core.Text Core.:>
             Core.QueryParam "callback" Core.Text Core.:>
               Core.QueryParam "includeUsedIpRanges" Core.Bool Core.:>
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.Get '[Core.JSON] ConsumerConfig
...
newServiceNetworkingServicesProjectsGlobalNetworksGet name
  = ServiceNetworkingServicesProjectsGlobalNetworksGet{xgafv =
                                                         Core.Nothing,
...
instance Core.GoogleRequest
           ServiceNetworkingServicesProjectsGlobalNetworksGet
         where
        type Rs ServiceNetworkingServicesProjectsGlobalNetworksGet =
             ConsumerConfig
        type Scopes ServiceNetworkingServicesProjectsGlobalNetworksGet =
             '[CloudPlatform'FullControl, Service'Management]
        requestClient
          ServiceNetworkingServicesProjectsGlobalNetworksGet{..}
          = go name xgafv accessToken callback includeUsedIpRanges uploadType
              uploadProtocol
