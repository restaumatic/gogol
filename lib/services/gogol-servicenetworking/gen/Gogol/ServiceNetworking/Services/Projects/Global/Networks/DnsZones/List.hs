                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.Get '[Core.JSON] ListDnsZonesResponse
...
newServiceNetworkingServicesProjectsGlobalNetworksDnsZonesList
  parent
  = ServiceNetworkingServicesProjectsGlobalNetworksDnsZonesList{xgafv
                                                                  = Core.Nothing,
...
instance Core.GoogleRequest
           ServiceNetworkingServicesProjectsGlobalNetworksDnsZonesList
         where
        type Rs ServiceNetworkingServicesProjectsGlobalNetworksDnsZonesList
