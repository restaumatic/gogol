...
newServiceNetworkingServicesDnsRecordSetsList parent
  = ServiceNetworkingServicesDnsRecordSetsList{xgafv = Core.Nothing,
                                               accessToken = Core.Nothing, callback = Core.Nothing,
                                               consumerNetwork = Core.Nothing, parent = parent,
...
instance Core.GoogleRequest
        ...
        type Scopes ServiceNetworkingServicesDnsRecordSetsList =
             '[CloudPlatform'FullControl, Service'Management]
        requestClient ServiceNetworkingServicesDnsRecordSetsList{..}
          = go parent xgafv accessToken callback consumerNetwork uploadType
              uploadProtocol
              zone
