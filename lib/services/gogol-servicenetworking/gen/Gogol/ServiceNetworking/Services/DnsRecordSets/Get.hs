...
newServiceNetworkingServicesDnsRecordSetsGet parent
  = ServiceNetworkingServicesDnsRecordSetsGet{xgafv = Core.Nothing,
                                              accessToken = Core.Nothing, callback = Core.Nothing,
                                              consumerNetwork = Core.Nothing, domain = Core.Nothing,
                                              parent = parent, type' = Core.Nothing,
                                              uploadType = Core.Nothing,
                                              uploadProtocol = Core.Nothing, zone = Core.Nothing}
instance Core.GoogleRequest
           ServiceNetworkingServicesDnsRecordSetsGet
         where
        type Rs ServiceNetworkingServicesDnsRecordSetsGet = DnsRecordSet
        type Scopes ServiceNetworkingServicesDnsRecordSetsGet =
             '[CloudPlatform'FullControl, Service'Management]
        requestClient ServiceNetworkingServicesDnsRecordSetsGet{..}
          = go parent xgafv accessToken callback consumerNetwork domain type'
              uploadType
              uploadProtocol
              zone
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ServiceNetworkingServicesDnsRecordSetsGetResource)
                      Core.mempty
