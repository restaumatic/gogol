                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] RemoveDnsRecordSetRequest Core.:>
...
newServiceNetworkingServicesDnsRecordSetsRemove parent payload
  = ServiceNetworkingServicesDnsRecordSetsRemove{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes ServiceNetworkingServicesDnsRecordSetsRemove =
