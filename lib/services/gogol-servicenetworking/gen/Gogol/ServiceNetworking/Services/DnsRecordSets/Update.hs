                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] UpdateDnsRecordSetRequest Core.:>
...
newServiceNetworkingServicesDnsRecordSetsUpdate parent payload
  = ServiceNetworkingServicesDnsRecordSetsUpdate{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
           ServiceNetworkingServicesDnsRecordSetsUpdate
         where
        type Rs ServiceNetworkingServicesDnsRecordSetsUpdate = Operation
        type Scopes ServiceNetworkingServicesDnsRecordSetsUpdate =
             '[CloudPlatform'FullControl, Service'Management]
        requestClient ServiceNetworkingServicesDnsRecordSetsUpdate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ServiceNetworkingServicesDnsRecordSetsUpdateResource)
                      Core.mempty
