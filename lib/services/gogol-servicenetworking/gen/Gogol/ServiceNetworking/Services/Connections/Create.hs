...
newServiceNetworkingServicesConnectionsCreate parent payload
  = ServiceNetworkingServicesConnectionsCreate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           ServiceNetworkingServicesConnectionsCreate
         where
        type Rs ServiceNetworkingServicesConnectionsCreate = Operation
        type Scopes ServiceNetworkingServicesConnectionsCreate =
             '[CloudPlatform'FullControl, Service'Management]
        requestClient ServiceNetworkingServicesConnectionsCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ServiceNetworkingServicesConnectionsCreateResource)
                      Core.mempty
