...
newServiceNetworkingServicesConnectionsPatch name payload
  = ServiceNetworkingServicesConnectionsPatch{xgafv = Core.Nothing,
                                              accessToken = Core.Nothing, callback = Core.Nothing,
                                              force = Core.Nothing, name = name, payload = payload,
                                              updateMask = Core.Nothing, uploadType = Core.Nothing,
                                              uploadProtocol = Core.Nothing}
instance Core.GoogleRequest
           ServiceNetworkingServicesConnectionsPatch
         where
        type Rs ServiceNetworkingServicesConnectionsPatch = Operation
        type Scopes ServiceNetworkingServicesConnectionsPatch =
             '[CloudPlatform'FullControl, Service'Management]
        requestClient ServiceNetworkingServicesConnectionsPatch{..}
          = go name xgafv accessToken callback force updateMask uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ServiceNetworkingServicesConnectionsPatchResource)
                      Core.mempty
