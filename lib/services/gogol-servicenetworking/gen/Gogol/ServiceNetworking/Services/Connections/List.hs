...
instance Core.GoogleRequest
        ...
        requestClient ServiceNetworkingServicesConnectionsList{..}
          = go parent xgafv accessToken callback network uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ServiceNetworkingServicesConnectionsListResource)
                      Core.mempty
