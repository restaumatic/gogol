               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] DeleteConnectionRequest Core.:>
...
newServiceNetworkingServicesConnectionsDeleteConnection 
    ...
    -> ServiceNetworkingServicesConnectionsDeleteConnection
newServiceNetworkingServicesConnectionsDeleteConnection name
  payload
  = ServiceNetworkingServicesConnectionsDeleteConnection{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           ServiceNetworkingServicesConnectionsDeleteConnection
         where
        type Rs ServiceNetworkingServicesConnectionsDeleteConnection =
             Operation
        type Scopes ServiceNetworkingServicesConnectionsDeleteConnection =
