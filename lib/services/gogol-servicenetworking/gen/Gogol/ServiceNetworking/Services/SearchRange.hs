...
type ServiceNetworkingServicesSearchRangeResource =
     "v1" Core.:>
       Core.CaptureMode "parent" "searchRange" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] SearchRangeRequest Core.:>
...
newServiceNetworkingServicesSearchRange parent payload
  = ServiceNetworkingServicesSearchRange{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         parent = parent, payload = payload,
                                         uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ServiceNetworkingServicesSearchRange
         where
        type Rs ServiceNetworkingServicesSearchRange = Operation
        type Scopes ServiceNetworkingServicesSearchRange =
             '[CloudPlatform'FullControl, Service'Management]
        requestClient ServiceNetworkingServicesSearchRange{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ServiceNetworkingServicesSearchRangeResource)
                      Core.mempty
