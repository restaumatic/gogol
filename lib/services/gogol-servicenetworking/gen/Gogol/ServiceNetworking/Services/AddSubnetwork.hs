...
type ServiceNetworkingServicesAddSubnetworkResource =
     "v1" Core.:>
       Core.CaptureMode "parent" "addSubnetwork" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] AddSubnetworkRequest Core.:>
...
newServiceNetworkingServicesAddSubnetwork parent payload
  = ServiceNetworkingServicesAddSubnetwork{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           parent = parent, payload = payload,
                                           uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ServiceNetworkingServicesAddSubnetwork
         where
        type Rs ServiceNetworkingServicesAddSubnetwork = Operation
        type Scopes ServiceNetworkingServicesAddSubnetwork =
             '[CloudPlatform'FullControl, Service'Management]
        requestClient ServiceNetworkingServicesAddSubnetwork{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ServiceNetworkingServicesAddSubnetworkResource)
                      Core.mempty
