...
type ServiceNetworkingServicesEnableVpcServiceControlsResource =
     "v1" Core.:>
       Core.CaptureMode "parent" "enableVpcServiceControls" Core.Text
         Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] EnableVpcServiceControlsRequest Core.:>
...
newServiceNetworkingServicesEnableVpcServiceControls parent payload
  = ServiceNetworkingServicesEnableVpcServiceControls{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           ServiceNetworkingServicesEnableVpcServiceControls
         where
        type Rs ServiceNetworkingServicesEnableVpcServiceControls =
             Operation
        type Scopes ServiceNetworkingServicesEnableVpcServiceControls =
             '[CloudPlatform'FullControl, Service'Management]
        requestClient ServiceNetworkingServicesEnableVpcServiceControls{..}
