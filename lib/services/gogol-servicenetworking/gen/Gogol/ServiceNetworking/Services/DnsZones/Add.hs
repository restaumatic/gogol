                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] AddDnsZoneRequest Core.:>
...
newServiceNetworkingServicesDnsZonesAdd parent payload
  = ServiceNetworkingServicesDnsZonesAdd{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         parent = parent, payload = payload,
                                         uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ServiceNetworkingServicesDnsZonesAdd
         where
        type Rs ServiceNetworkingServicesDnsZonesAdd = Operation
        type Scopes ServiceNetworkingServicesDnsZonesAdd =
