...
type ServiceNetworkingServicesDisableVpcServiceControlsResource =
     "v1" Core.:>
       Core.CaptureMode "parent" "disableVpcServiceControls" Core.Text
         Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] DisableVpcServiceControlsRequest Core.:>
...
newServiceNetworkingServicesDisableVpcServiceControls 
    ...
    -> ServiceNetworkingServicesDisableVpcServiceControls
newServiceNetworkingServicesDisableVpcServiceControls parent
  payload
  = ServiceNetworkingServicesDisableVpcServiceControls{xgafv =
                                                         Core.Nothing,
...
instance Core.GoogleRequest
           ServiceNetworkingServicesDisableVpcServiceControls
         where
        type Rs ServiceNetworkingServicesDisableVpcServiceControls =
             Operation
        type Scopes ServiceNetworkingServicesDisableVpcServiceControls =
