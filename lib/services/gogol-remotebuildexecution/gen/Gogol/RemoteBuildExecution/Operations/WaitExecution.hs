...
type RemoteBuildExecutionOperationsWaitExecutionResource =
     "v2" Core.:>
       Core.CaptureMode "name" "waitExecution" Core.Text Core.:>
...
newRemoteBuildExecutionOperationsWaitExecution name payload
  = RemoteBuildExecutionOperationsWaitExecution{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           RemoteBuildExecutionOperationsWaitExecution
         where
        type Rs RemoteBuildExecutionOperationsWaitExecution =
             GoogleLongrunningOperation
        type Scopes RemoteBuildExecutionOperationsWaitExecution =
             '[CloudPlatform'FullControl]
        requestClient RemoteBuildExecutionOperationsWaitExecution{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy RemoteBuildExecutionOperationsWaitExecutionResource)
                      Core.mempty
