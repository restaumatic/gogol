...
newBuildBazelRemoteExecutionV2Action 
    :: 
                                     BuildBazelRemoteExecutionV2Action
newBuildBazelRemoteExecutionV2Action
  = BuildBazelRemoteExecutionV2Action{commandDigest = Core.Nothing,
                                      doNotCache = Core.Nothing, inputRootDigest = Core.Nothing,
                                      platform = Core.Nothing, salt = Core.Nothing,
                                      timeout = Core.Nothing}
instance Core.FromJSON BuildBazelRemoteExecutionV2Action where
        parseJSON
          = Core.withObject "BuildBazelRemoteExecutionV2Action"
              (\ o ->
                 BuildBazelRemoteExecutionV2Action Core.<$>
                   (o Core..:? "commandDigest") Core.<*> (o Core..:? "doNotCache")
                     Core.<*> (o Core..:? "inputRootDigest")
                     Core.<*> (o Core..:? "platform")
                     Core.<*> (o Core..:? "salt")
                     Core.<*> (o Core..:? "timeout"))

instance Core.ToJSON BuildBazelRemoteExecutionV2Action where
...
newBuildBazelRemoteExecutionV2ActionCacheUpdateCapabilities 
    :: 
                                                            BuildBazelRemoteExecutionV2ActionCacheUpdateCapabilities
newBuildBazelRemoteExecutionV2ActionCacheUpdateCapabilities
  = BuildBazelRemoteExecutionV2ActionCacheUpdateCapabilities{updateEnabled
                                                               = Core.Nothing}
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "BuildBazelRemoteExecutionV2ActionCacheUpdateCapabilities"
              (\ o ->
                 BuildBazelRemoteExecutionV2ActionCacheUpdateCapabilities Core.<$>
                   (o Core..:? "updateEnabled"))

instance Core.ToJSON
           BuildBazelRemoteExecutionV2ActionCacheUpdateCapabilities
         where
        toJSON BuildBazelRemoteExecutionV2ActionCacheUpdateCapabilities{..}
          = Core.object
              (Core.catMaybes [("updateEnabled" Core..=) Core.<$> updateEnabled])
...
newBuildBazelRemoteExecutionV2ActionResult 
    :: 
                                           BuildBazelRemoteExecutionV2ActionResult
newBuildBazelRemoteExecutionV2ActionResult
  = BuildBazelRemoteExecutionV2ActionResult{executionMetadata =
                                              Core.Nothing,
                                            ...
                                            stderrDigest = Core.Nothing, stderrRaw = Core.Nothing,
                                            stdoutDigest = Core.Nothing, stdoutRaw = Core.Nothing}
instance Core.FromJSON BuildBazelRemoteExecutionV2ActionResult
         where
        parseJSON
          = Core.withObject "BuildBazelRemoteExecutionV2ActionResult"
              (\ o ->
                 BuildBazelRemoteExecutionV2ActionResult Core.<$>
                   (o Core..:? "executionMetadata") Core.<*> (o Core..:? "exitCode")
...
instance Core.ToJSON BuildBazelRemoteExecutionV2ActionResult where
        toJSON BuildBazelRemoteExecutionV2ActionResult{..}
          = Core.object
              (Core.catMaybes
                 [("executionMetadata" Core..=) Core.<$> executionMetadata,
                  ("exitCode" Core..=) Core.<$> exitCode,
                  ("outputDirectories" Core..=) Core.<$> outputDirectories,
                  ("outputDirectorySymlinks" Core..=) Core.<$>
                    outputDirectorySymlinks,
                  ("outputFileSymlinks" Core..=) Core.<$> outputFileSymlinks,
...
newBuildBazelRemoteExecutionV2BatchReadBlobsRequest 
    :: 
                                                    BuildBazelRemoteExecutionV2BatchReadBlobsRequest
newBuildBazelRemoteExecutionV2BatchReadBlobsRequest
  = BuildBazelRemoteExecutionV2BatchReadBlobsRequest{digests =
                                                       Core.Nothing}
instance Core.FromJSON
           BuildBazelRemoteExecutionV2BatchReadBlobsRequest
         where
        parseJSON
          = Core.withObject
              "BuildBazelRemoteExecutionV2BatchReadBlobsRequest"
              (\ o ->
                 BuildBazelRemoteExecutionV2BatchReadBlobsRequest Core.<$>
                   (o Core..:? "digests"))

instance Core.ToJSON
           BuildBazelRemoteExecutionV2BatchReadBlobsRequest
         where
        toJSON BuildBazelRemoteExecutionV2BatchReadBlobsRequest{..}
          = Core.object
              (Core.catMaybes [("digests" Core..=) Core.<$> digests])
...
newBuildBazelRemoteExecutionV2BatchReadBlobsResponse 
    :: 
                                                     BuildBazelRemoteExecutionV2BatchReadBlobsResponse
newBuildBazelRemoteExecutionV2BatchReadBlobsResponse
  = BuildBazelRemoteExecutionV2BatchReadBlobsResponse{responses =
                                                        Core.Nothing}
instance Core.FromJSON
           BuildBazelRemoteExecutionV2BatchReadBlobsResponse
         where
        parseJSON
          = Core.withObject
              "BuildBazelRemoteExecutionV2BatchReadBlobsResponse"
              (\ o ->
                 BuildBazelRemoteExecutionV2BatchReadBlobsResponse Core.<$>
                   (o Core..:? "responses"))

instance Core.ToJSON
           BuildBazelRemoteExecutionV2BatchReadBlobsResponse
         where
        toJSON BuildBazelRemoteExecutionV2BatchReadBlobsResponse{..}
          = Core.object
...
newBuildBazelRemoteExecutionV2BatchReadBlobsResponseResponse 
    :: 
                                                             BuildBazelRemoteExecutionV2BatchReadBlobsResponseResponse
newBuildBazelRemoteExecutionV2BatchReadBlobsResponseResponse
  = BuildBazelRemoteExecutionV2BatchReadBlobsResponseResponse{data' =
                                                                Core.Nothing,
                                                              digest = Core.Nothing,
                                                              status = Core.Nothing}
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "BuildBazelRemoteExecutionV2BatchReadBlobsResponseResponse"
              (\ o ->
                 BuildBazelRemoteExecutionV2BatchReadBlobsResponseResponse Core.<$>
                   (o Core..:? "data") Core.<*> (o Core..:? "digest") Core.<*>
                     (o Core..:? "status"))
...
newBuildBazelRemoteExecutionV2BatchUpdateBlobsRequest 
    :: 
                                                      BuildBazelRemoteExecutionV2BatchUpdateBlobsRequest
newBuildBazelRemoteExecutionV2BatchUpdateBlobsRequest
  = BuildBazelRemoteExecutionV2BatchUpdateBlobsRequest{requests =
                                                         Core.Nothing}
instance Core.FromJSON
           BuildBazelRemoteExecutionV2BatchUpdateBlobsRequest
         where
        parseJSON
          = Core.withObject
              "BuildBazelRemoteExecutionV2BatchUpdateBlobsRequest"
              (\ o ->
                 BuildBazelRemoteExecutionV2BatchUpdateBlobsRequest Core.<$>
                   (o Core..:? "requests"))

instance Core.ToJSON
           BuildBazelRemoteExecutionV2BatchUpdateBlobsRequest
         where
        toJSON BuildBazelRemoteExecutionV2BatchUpdateBlobsRequest{..}
          = Core.object
...
newBuildBazelRemoteExecutionV2BatchUpdateBlobsRequestRequest 
    :: 
                                                             BuildBazelRemoteExecutionV2BatchUpdateBlobsRequestRequest
newBuildBazelRemoteExecutionV2BatchUpdateBlobsRequestRequest
  = BuildBazelRemoteExecutionV2BatchUpdateBlobsRequestRequest{data' =
                                                                Core.Nothing,
                                                              digest = Core.Nothing}
instance Core.FromJSON
           BuildBazelRemoteExecutionV2BatchUpdateBlobsRequestRequest
        ...
        parseJSON
          = Core.withObject
              "BuildBazelRemoteExecutionV2BatchUpdateBlobsRequestRequest"
              (\ o ->
                 BuildBazelRemoteExecutionV2BatchUpdateBlobsRequestRequest Core.<$>
...
newBuildBazelRemoteExecutionV2BatchUpdateBlobsResponse 
    :: 
                                                       BuildBazelRemoteExecutionV2BatchUpdateBlobsResponse
newBuildBazelRemoteExecutionV2BatchUpdateBlobsResponse
  = BuildBazelRemoteExecutionV2BatchUpdateBlobsResponse{responses =
                                                          Core.Nothing}
instance Core.FromJSON
           BuildBazelRemoteExecutionV2BatchUpdateBlobsResponse
         where
        parseJSON
          = Core.withObject
              "BuildBazelRemoteExecutionV2BatchUpdateBlobsResponse"
              (\ o ->
                 BuildBazelRemoteExecutionV2BatchUpdateBlobsResponse Core.<$>
                   (o Core..:? "responses"))

instance Core.ToJSON
           BuildBazelRemoteExecutionV2BatchUpdateBlobsResponse
         where
        toJSON BuildBazelRemoteExecutionV2BatchUpdateBlobsResponse{..}
          = Core.object
              (Core.catMaybes [("responses" Core..=) Core.<$> responses])
...
newBuildBazelRemoteExecutionV2BatchUpdateBlobsResponseResponse 
    :: 
                                                               BuildBazelRemoteExecutionV2BatchUpdateBlobsResponseResponse
newBuildBazelRemoteExecutionV2BatchUpdateBlobsResponseResponse
  = BuildBazelRemoteExecutionV2BatchUpdateBlobsResponseResponse{digest
                                                                  = Core.Nothing,
                                                                status = Core.Nothing}
instance Core.FromJSON
           BuildBazelRemoteExecutionV2BatchUpdateBlobsResponseResponse
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 BuildBazelRemoteExecutionV2BatchUpdateBlobsResponseResponse
                   Core.<$> (o Core..:? "digest") Core.<*> (o Core..:? "status"))
...
newBuildBazelRemoteExecutionV2CacheCapabilities 
    :: 
                                                BuildBazelRemoteExecutionV2CacheCapabilities
newBuildBazelRemoteExecutionV2CacheCapabilities
  = BuildBazelRemoteExecutionV2CacheCapabilities{actionCacheUpdateCapabilities
                                                   = Core.Nothing,
...
instance Core.FromJSON BuildBazelRemoteExecutionV2CacheCapabilities
         where
        parseJSON
          = Core.withObject "BuildBazelRemoteExecutionV2CacheCapabilities"
              (\ o ->
...
instance Core.ToJSON BuildBazelRemoteExecutionV2CacheCapabilities
         where
        toJSON BuildBazelRemoteExecutionV2CacheCapabilities{..}
          = Core.object
              (Core.catMaybes
                 [("actionCacheUpdateCapabilities" Core..=) Core.<$>
                  ...
                  ("maxBatchTotalSizeBytes" Core..=) Core.. Core.AsText Core.<$>
                    maxBatchTotalSizeBytes,
                  ("supportedCompressor" Core..=) Core.<$> supportedCompressor,
...
newBuildBazelRemoteExecutionV2Command 
    :: 
                                      BuildBazelRemoteExecutionV2Command
newBuildBazelRemoteExecutionV2Command
  = BuildBazelRemoteExecutionV2Command{arguments = Core.Nothing,
                                       environmentVariables = Core.Nothing,
                                       outputDirectories = Core.Nothing, outputFiles = Core.Nothing,
                                       outputNodeProperties = Core.Nothing,
                                       outputPaths = Core.Nothing, platform = Core.Nothing,
                                       workingDirectory = Core.Nothing}
instance Core.FromJSON BuildBazelRemoteExecutionV2Command where
        parseJSON
          = Core.withObject "BuildBazelRemoteExecutionV2Command"
              (\ o ->
...
instance Core.ToJSON BuildBazelRemoteExecutionV2Command where
          ...
          = Core.object
              (Core.catMaybes
                 [("arguments" Core..=) Core.<$> arguments,
                  ...
                  ("outputDirectories" Core..=) Core.<$> outputDirectories,
                  ("outputFiles" Core..=) Core.<$> outputFiles,
                  ("outputNodeProperties" Core..=) Core.<$> outputNodeProperties,
...
newBuildBazelRemoteExecutionV2CommandEnvironmentVariable 
    :: 
                                                         BuildBazelRemoteExecutionV2CommandEnvironmentVariable
newBuildBazelRemoteExecutionV2CommandEnvironmentVariable
  = BuildBazelRemoteExecutionV2CommandEnvironmentVariable{name =
                                                            Core.Nothing,
                                                          value = Core.Nothing}
instance Core.FromJSON
           BuildBazelRemoteExecutionV2CommandEnvironmentVariable
        ...
        parseJSON
          = Core.withObject
              "BuildBazelRemoteExecutionV2CommandEnvironmentVariable"
              (\ o ->
                 BuildBazelRemoteExecutionV2CommandEnvironmentVariable Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "value"))

instance Core.ToJSON
           BuildBazelRemoteExecutionV2CommandEnvironmentVariable
         where
        toJSON BuildBazelRemoteExecutionV2CommandEnvironmentVariable{..}
          = Core.object
              (Core.catMaybes
...
newBuildBazelRemoteExecutionV2Digest 
    :: 
                                     BuildBazelRemoteExecutionV2Digest
newBuildBazelRemoteExecutionV2Digest
  = BuildBazelRemoteExecutionV2Digest{hash = Core.Nothing,
                                      sizeBytes = Core.Nothing}
instance Core.FromJSON BuildBazelRemoteExecutionV2Digest where
        parseJSON
...
instance Core.ToJSON BuildBazelRemoteExecutionV2Digest where
...
newBuildBazelRemoteExecutionV2Directory 
    :: 
                                        BuildBazelRemoteExecutionV2Directory
newBuildBazelRemoteExecutionV2Directory
  = BuildBazelRemoteExecutionV2Directory{directories = Core.Nothing,
                                         files = Core.Nothing, nodeProperties = Core.Nothing,
                                         symlinks = Core.Nothing}
instance Core.FromJSON BuildBazelRemoteExecutionV2Directory where
        parseJSON
          = Core.withObject "BuildBazelRemoteExecutionV2Directory"
              (\ o ->
                 BuildBazelRemoteExecutionV2Directory Core.<$>
                   (o Core..:? "directories") Core.<*> (o Core..:? "files") Core.<*>
                     (o Core..:? "nodeProperties")
                     Core.<*> (o Core..:? "symlinks"))

instance Core.ToJSON BuildBazelRemoteExecutionV2Directory where
...
newBuildBazelRemoteExecutionV2DirectoryNode 
    :: 
                                            BuildBazelRemoteExecutionV2DirectoryNode
newBuildBazelRemoteExecutionV2DirectoryNode
  = BuildBazelRemoteExecutionV2DirectoryNode{digest = Core.Nothing,
                                             name = Core.Nothing}
instance Core.FromJSON BuildBazelRemoteExecutionV2DirectoryNode
         where
        parseJSON
          = Core.withObject "BuildBazelRemoteExecutionV2DirectoryNode"
              (\ o ->
                 BuildBazelRemoteExecutionV2DirectoryNode Core.<$>
                   (o Core..:? "digest") Core.<*> (o Core..:? "name"))

instance Core.ToJSON BuildBazelRemoteExecutionV2DirectoryNode where
...
newBuildBazelRemoteExecutionV2ExecuteOperationMetadata 
    :: 
                                                       BuildBazelRemoteExecutionV2ExecuteOperationMetadata
newBuildBazelRemoteExecutionV2ExecuteOperationMetadata
  = BuildBazelRemoteExecutionV2ExecuteOperationMetadata{actionDigest
                                                          = Core.Nothing,
                                                        stage = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "BuildBazelRemoteExecutionV2ExecuteOperationMetadata"
              (\ o ->
                 BuildBazelRemoteExecutionV2ExecuteOperationMetadata Core.<$>
                   (o Core..:? "actionDigest") Core.<*> (o Core..:? "stage") Core.<*>
                     (o Core..:? "stderrStreamName")
                     Core.<*> (o Core..:? "stdoutStreamName"))

instance Core.ToJSON
           BuildBazelRemoteExecutionV2ExecuteOperationMetadata
         where
        toJSON BuildBazelRemoteExecutionV2ExecuteOperationMetadata{..}
          = Core.object
              (Core.catMaybes
                 [("actionDigest" Core..=) Core.<$> actionDigest,
                  ("stage" Core..=) Core.<$> stage,
                  ("stderrStreamName" Core..=) Core.<$> stderrStreamName,
                  ("stdoutStreamName" Core..=) Core.<$> stdoutStreamName])
...
newBuildBazelRemoteExecutionV2ExecuteRequest 
    :: 
                                             BuildBazelRemoteExecutionV2ExecuteRequest
newBuildBazelRemoteExecutionV2ExecuteRequest
  = BuildBazelRemoteExecutionV2ExecuteRequest{actionDigest =
                                                Core.Nothing,
                                              executionPolicy = Core.Nothing,
                                              resultsCachePolicy = Core.Nothing,
                                              skipCacheLookup = Core.Nothing}
instance Core.FromJSON BuildBazelRemoteExecutionV2ExecuteRequest
         where
        parseJSON
          = Core.withObject "BuildBazelRemoteExecutionV2ExecuteRequest"
              (\ o ->
                 BuildBazelRemoteExecutionV2ExecuteRequest Core.<$>
                   (o Core..:? "actionDigest") Core.<*> (o Core..:? "executionPolicy")
                     Core.<*> (o Core..:? "resultsCachePolicy")
                     Core.<*> (o Core..:? "skipCacheLookup"))

instance Core.ToJSON BuildBazelRemoteExecutionV2ExecuteRequest
         where
          ...
          = Core.object
              (Core.catMaybes
                 [("actionDigest" Core..=) Core.<$> actionDigest,
                  ...
                  ("resultsCachePolicy" Core..=) Core.<$> resultsCachePolicy,
...
newBuildBazelRemoteExecutionV2ExecuteResponse 
    :: 
                                              BuildBazelRemoteExecutionV2ExecuteResponse
newBuildBazelRemoteExecutionV2ExecuteResponse
  = BuildBazelRemoteExecutionV2ExecuteResponse{cachedResult =
                                                 Core.Nothing,
                                               message = Core.Nothing, result = Core.Nothing,
                                               serverLogs = Core.Nothing, status = Core.Nothing}
instance Core.FromJSON BuildBazelRemoteExecutionV2ExecuteResponse
         where
        parseJSON
          = Core.withObject "BuildBazelRemoteExecutionV2ExecuteResponse"
              (\ o ->
                 BuildBazelRemoteExecutionV2ExecuteResponse Core.<$>
                   (o Core..:? "cachedResult") Core.<*> (o Core..:? "message")
                     Core.<*> (o Core..:? "result")
                     Core.<*> (o Core..:? "serverLogs")
                     Core.<*> (o Core..:? "status"))

instance Core.ToJSON BuildBazelRemoteExecutionV2ExecuteResponse
         where
...
newBuildBazelRemoteExecutionV2ExecuteResponse_ServerLogs additional
  = BuildBazelRemoteExecutionV2ExecuteResponse_ServerLogs{additional
                                                            = additional}
instance Core.FromJSON
           BuildBazelRemoteExecutionV2ExecuteResponse_ServerLogs
         where
        parseJSON
          = Core.withObject
              "BuildBazelRemoteExecutionV2ExecuteResponse_ServerLogs"
              (\ o ->
                 BuildBazelRemoteExecutionV2ExecuteResponse_ServerLogs Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON
           BuildBazelRemoteExecutionV2ExecuteResponse_ServerLogs
         where
        toJSON BuildBazelRemoteExecutionV2ExecuteResponse_ServerLogs{..}
...
newBuildBazelRemoteExecutionV2ExecutedActionMetadata 
    :: 
                                                     BuildBazelRemoteExecutionV2ExecutedActionMetadata
newBuildBazelRemoteExecutionV2ExecutedActionMetadata
  = BuildBazelRemoteExecutionV2ExecutedActionMetadata{auxiliaryMetadata
                                                        = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "BuildBazelRemoteExecutionV2ExecutedActionMetadata"
              (\ o ->
                 BuildBazelRemoteExecutionV2ExecutedActionMetadata Core.<$>
                   (o Core..:? "auxiliaryMetadata") Core.<*>
                     ...
                     Core.<*> (o Core..:? "outputUploadCompletedTimestamp")
...
instance Core.ToJSON
           BuildBazelRemoteExecutionV2ExecutedActionMetadata
         where
        toJSON BuildBazelRemoteExecutionV2ExecutedActionMetadata{..}
          = Core.object
              (Core.catMaybes
                 [("auxiliaryMetadata" Core..=) Core.<$> auxiliaryMetadata,
                  ...
                  ("workerStartTimestamp" Core..=) Core.<$> workerStartTimestamp])
...
newBuildBazelRemoteExecutionV2ExecutedActionMetadata_AuxiliaryMetadataItem
  additional
  = BuildBazelRemoteExecutionV2ExecutedActionMetadata_AuxiliaryMetadataItem{additional
                                                                              = additional}
instance Core.FromJSON
           BuildBazelRemoteExecutionV2ExecutedActionMetadata_AuxiliaryMetadataItem
         where
...
newBuildBazelRemoteExecutionV2ExecutionCapabilities 
    :: 
                                                    BuildBazelRemoteExecutionV2ExecutionCapabilities
newBuildBazelRemoteExecutionV2ExecutionCapabilities
  = BuildBazelRemoteExecutionV2ExecutionCapabilities{digestFunction =
                                                       Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "BuildBazelRemoteExecutionV2ExecutionCapabilities"
              (\ o ->
                 BuildBazelRemoteExecutionV2ExecutionCapabilities Core.<$>
                   (o Core..:? "digestFunction") Core.<*> (o Core..:? "execEnabled")
...
instance Core.ToJSON
           BuildBazelRemoteExecutionV2ExecutionCapabilities
         where
        toJSON BuildBazelRemoteExecutionV2ExecutionCapabilities{..}
          = Core.object
              (Core.catMaybes
                 [("digestFunction" Core..=) Core.<$> digestFunction,
...
newBuildBazelRemoteExecutionV2ExecutionPolicy 
    :: 
                                              BuildBazelRemoteExecutionV2ExecutionPolicy
newBuildBazelRemoteExecutionV2ExecutionPolicy
  = BuildBazelRemoteExecutionV2ExecutionPolicy{priority =
                                                 Core.Nothing}
instance Core.FromJSON BuildBazelRemoteExecutionV2ExecutionPolicy
         where
        parseJSON
          = Core.withObject "BuildBazelRemoteExecutionV2ExecutionPolicy"
              (\ o ->
                 BuildBazelRemoteExecutionV2ExecutionPolicy Core.<$>
                   (o Core..:? "priority"))

instance Core.ToJSON BuildBazelRemoteExecutionV2ExecutionPolicy
         where
...
newBuildBazelRemoteExecutionV2FileNode 
    :: 
                                       BuildBazelRemoteExecutionV2FileNode
newBuildBazelRemoteExecutionV2FileNode
  = BuildBazelRemoteExecutionV2FileNode{digest = Core.Nothing,
                                        isExecutable = Core.Nothing, name = Core.Nothing,
                                        nodeProperties = Core.Nothing}
instance Core.FromJSON BuildBazelRemoteExecutionV2FileNode where
        parseJSON
          = Core.withObject "BuildBazelRemoteExecutionV2FileNode"
              (\ o ->
                 BuildBazelRemoteExecutionV2FileNode Core.<$>
                   (o Core..:? "digest") Core.<*> (o Core..:? "isExecutable") Core.<*>
                     (o Core..:? "name")
                     Core.<*> (o Core..:? "nodeProperties"))

instance Core.ToJSON BuildBazelRemoteExecutionV2FileNode where
...
newBuildBazelRemoteExecutionV2FindMissingBlobsRequest 
    :: 
                                                      BuildBazelRemoteExecutionV2FindMissingBlobsRequest
newBuildBazelRemoteExecutionV2FindMissingBlobsRequest
  = BuildBazelRemoteExecutionV2FindMissingBlobsRequest{blobDigests =
                                                         Core.Nothing}
instance Core.FromJSON
           BuildBazelRemoteExecutionV2FindMissingBlobsRequest
         where
        parseJSON
          = Core.withObject
              "BuildBazelRemoteExecutionV2FindMissingBlobsRequest"
              (\ o ->
                 BuildBazelRemoteExecutionV2FindMissingBlobsRequest Core.<$>
                   (o Core..:? "blobDigests"))

instance Core.ToJSON
           BuildBazelRemoteExecutionV2FindMissingBlobsRequest
         where
        toJSON BuildBazelRemoteExecutionV2FindMissingBlobsRequest{..}
          = Core.object
              (Core.catMaybes [("blobDigests" Core..=) Core.<$> blobDigests])
...
newBuildBazelRemoteExecutionV2FindMissingBlobsResponse 
    :: 
                                                       BuildBazelRemoteExecutionV2FindMissingBlobsResponse
newBuildBazelRemoteExecutionV2FindMissingBlobsResponse
  = BuildBazelRemoteExecutionV2FindMissingBlobsResponse{missingBlobDigests
                                                          = Core.Nothing}
instance Core.FromJSON
           BuildBazelRemoteExecutionV2FindMissingBlobsResponse
         where
        parseJSON
          = Core.withObject
              "BuildBazelRemoteExecutionV2FindMissingBlobsResponse"
              (\ o ->
                 BuildBazelRemoteExecutionV2FindMissingBlobsResponse Core.<$>
                   (o Core..:? "missingBlobDigests"))

instance Core.ToJSON
           BuildBazelRemoteExecutionV2FindMissingBlobsResponse
         where
        toJSON BuildBazelRemoteExecutionV2FindMissingBlobsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("missingBlobDigests" Core..=) Core.<$> missingBlobDigests])
...
newBuildBazelRemoteExecutionV2GetTreeResponse 
    :: 
                                              BuildBazelRemoteExecutionV2GetTreeResponse
newBuildBazelRemoteExecutionV2GetTreeResponse
  = BuildBazelRemoteExecutionV2GetTreeResponse{directories =
                                                 Core.Nothing,
                                               nextPageToken = Core.Nothing}
instance Core.FromJSON BuildBazelRemoteExecutionV2GetTreeResponse
         where
        parseJSON
          = Core.withObject "BuildBazelRemoteExecutionV2GetTreeResponse"
              (\ o ->
                 BuildBazelRemoteExecutionV2GetTreeResponse Core.<$>
                   (o Core..:? "directories") Core.<*> (o Core..:? "nextPageToken"))

instance Core.ToJSON BuildBazelRemoteExecutionV2GetTreeResponse
         where
...
newBuildBazelRemoteExecutionV2LogFile 
    :: 
                                      BuildBazelRemoteExecutionV2LogFile
newBuildBazelRemoteExecutionV2LogFile
  = BuildBazelRemoteExecutionV2LogFile{digest = Core.Nothing,
                                       humanReadable = Core.Nothing}
instance Core.FromJSON BuildBazelRemoteExecutionV2LogFile where
        parseJSON
          = Core.withObject "BuildBazelRemoteExecutionV2LogFile"
              (\ o ->
                 BuildBazelRemoteExecutionV2LogFile Core.<$>
                   (o Core..:? "digest") Core.<*> (o Core..:? "humanReadable"))

instance Core.ToJSON BuildBazelRemoteExecutionV2LogFile where
...
newBuildBazelRemoteExecutionV2NodeProperties 
    :: 
                                             BuildBazelRemoteExecutionV2NodeProperties
newBuildBazelRemoteExecutionV2NodeProperties
  = BuildBazelRemoteExecutionV2NodeProperties{mtime = Core.Nothing,
                                              properties = Core.Nothing, unixMode = Core.Nothing}
instance Core.FromJSON BuildBazelRemoteExecutionV2NodeProperties
         where
        parseJSON
          = Core.withObject "BuildBazelRemoteExecutionV2NodeProperties"
              (\ o ->
                 BuildBazelRemoteExecutionV2NodeProperties Core.<$>
                   (o Core..:? "mtime") Core.<*> (o Core..:? "properties") Core.<*>
                     (o Core..:? "unixMode"))

instance Core.ToJSON BuildBazelRemoteExecutionV2NodeProperties
         where
...
newBuildBazelRemoteExecutionV2NodeProperty 
    :: 
                                           BuildBazelRemoteExecutionV2NodeProperty
newBuildBazelRemoteExecutionV2NodeProperty
  = BuildBazelRemoteExecutionV2NodeProperty{name = Core.Nothing,
                                            value = Core.Nothing}
instance Core.FromJSON BuildBazelRemoteExecutionV2NodeProperty
         where
        parseJSON
          = Core.withObject "BuildBazelRemoteExecutionV2NodeProperty"
              (\ o ->
                 BuildBazelRemoteExecutionV2NodeProperty Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "value"))

instance Core.ToJSON BuildBazelRemoteExecutionV2NodeProperty where
...
newBuildBazelRemoteExecutionV2OutputDirectory 
    :: 
                                              BuildBazelRemoteExecutionV2OutputDirectory
newBuildBazelRemoteExecutionV2OutputDirectory
  = BuildBazelRemoteExecutionV2OutputDirectory{path = Core.Nothing,
                                               treeDigest = Core.Nothing}
instance Core.FromJSON BuildBazelRemoteExecutionV2OutputDirectory
         where
        parseJSON
          = Core.withObject "BuildBazelRemoteExecutionV2OutputDirectory"
              (\ o ->
                 BuildBazelRemoteExecutionV2OutputDirectory Core.<$>
                   (o Core..:? "path") Core.<*> (o Core..:? "treeDigest"))

instance Core.ToJSON BuildBazelRemoteExecutionV2OutputDirectory
         where
...
newBuildBazelRemoteExecutionV2OutputFile 
    :: 
                                         BuildBazelRemoteExecutionV2OutputFile
newBuildBazelRemoteExecutionV2OutputFile
  = BuildBazelRemoteExecutionV2OutputFile{contents = Core.Nothing,
                                          digest = Core.Nothing, isExecutable = Core.Nothing,
                                          nodeProperties = Core.Nothing, path = Core.Nothing}
instance Core.FromJSON BuildBazelRemoteExecutionV2OutputFile where
        parseJSON
          = Core.withObject "BuildBazelRemoteExecutionV2OutputFile"
              (\ o ->
                 BuildBazelRemoteExecutionV2OutputFile Core.<$>
                   (o Core..:? "contents") Core.<*> (o Core..:? "digest") Core.<*>
                     (o Core..:? "isExecutable")
                     Core.<*> (o Core..:? "nodeProperties")
                     Core.<*> (o Core..:? "path"))

instance Core.ToJSON BuildBazelRemoteExecutionV2OutputFile where
...
newBuildBazelRemoteExecutionV2OutputSymlink 
    :: 
                                            BuildBazelRemoteExecutionV2OutputSymlink
newBuildBazelRemoteExecutionV2OutputSymlink
  = BuildBazelRemoteExecutionV2OutputSymlink{nodeProperties =
                                               Core.Nothing,
                                             path = Core.Nothing, target = Core.Nothing}
instance Core.FromJSON BuildBazelRemoteExecutionV2OutputSymlink
         where
        parseJSON
          = Core.withObject "BuildBazelRemoteExecutionV2OutputSymlink"
              (\ o ->
                 BuildBazelRemoteExecutionV2OutputSymlink Core.<$>
                   (o Core..:? "nodeProperties") Core.<*> (o Core..:? "path") Core.<*>
                     (o Core..:? "target"))

instance Core.ToJSON BuildBazelRemoteExecutionV2OutputSymlink where
...
instance Core.FromJSON BuildBazelRemoteExecutionV2Platform where
        parseJSON
          = Core.withObject "BuildBazelRemoteExecutionV2Platform"
              (\ o ->
                 BuildBazelRemoteExecutionV2Platform Core.<$>
                   (o Core..:? "properties"))

instance Core.ToJSON BuildBazelRemoteExecutionV2Platform where
...
newBuildBazelRemoteExecutionV2PlatformProperty 
    :: 
                                               BuildBazelRemoteExecutionV2PlatformProperty
newBuildBazelRemoteExecutionV2PlatformProperty
  = BuildBazelRemoteExecutionV2PlatformProperty{name = Core.Nothing,
                                                value = Core.Nothing}
instance Core.FromJSON BuildBazelRemoteExecutionV2PlatformProperty
         where
        parseJSON
          = Core.withObject "BuildBazelRemoteExecutionV2PlatformProperty"
              (\ o ->
                 BuildBazelRemoteExecutionV2PlatformProperty Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "value"))

instance Core.ToJSON BuildBazelRemoteExecutionV2PlatformProperty
         where
        toJSON BuildBazelRemoteExecutionV2PlatformProperty{..}
          = Core.object
              (Core.catMaybes
                 [("name" Core..=) Core.<$> name, ("value" Core..=) Core.<$> value])
...
newBuildBazelRemoteExecutionV2PriorityCapabilities 
    :: 
                                                   BuildBazelRemoteExecutionV2PriorityCapabilities
newBuildBazelRemoteExecutionV2PriorityCapabilities
  = BuildBazelRemoteExecutionV2PriorityCapabilities{priorities =
                                                      Core.Nothing}
instance Core.FromJSON
           BuildBazelRemoteExecutionV2PriorityCapabilities
         where
        parseJSON
          = Core.withObject "BuildBazelRemoteExecutionV2PriorityCapabilities"
              (\ o ->
                 BuildBazelRemoteExecutionV2PriorityCapabilities Core.<$>
                   (o Core..:? "priorities"))

instance Core.ToJSON
           BuildBazelRemoteExecutionV2PriorityCapabilities
         where
        toJSON BuildBazelRemoteExecutionV2PriorityCapabilities{..}
          = Core.object
              (Core.catMaybes [("priorities" Core..=) Core.<$> priorities])
...
newBuildBazelRemoteExecutionV2PriorityCapabilitiesPriorityRange 
    :: 
                                                                BuildBazelRemoteExecutionV2PriorityCapabilitiesPriorityRange
newBuildBazelRemoteExecutionV2PriorityCapabilitiesPriorityRange
  = BuildBazelRemoteExecutionV2PriorityCapabilitiesPriorityRange{maxPriority
                                                                   = Core.Nothing,
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 BuildBazelRemoteExecutionV2PriorityCapabilitiesPriorityRange
                   Core.<$>
                   (o Core..:? "maxPriority") Core.<*> (o Core..:? "minPriority"))
...
newBuildBazelRemoteExecutionV2RequestMetadata 
    :: 
                                              BuildBazelRemoteExecutionV2RequestMetadata
newBuildBazelRemoteExecutionV2RequestMetadata
  = BuildBazelRemoteExecutionV2RequestMetadata{actionId =
                                                 Core.Nothing,
                                               actionMnemonic = Core.Nothing,
                                               configurationId = Core.Nothing,
                                               correlatedInvocationsId = Core.Nothing,
                                               targetId = Core.Nothing, toolDetails = Core.Nothing,
                                               toolInvocationId = Core.Nothing}
instance Core.FromJSON BuildBazelRemoteExecutionV2RequestMetadata
         where
        parseJSON
          = Core.withObject "BuildBazelRemoteExecutionV2RequestMetadata"
              (\ o ->
                 BuildBazelRemoteExecutionV2RequestMetadata Core.<$>
                   (o Core..:? "actionId") Core.<*> (o Core..:? "actionMnemonic")
...
instance Core.ToJSON BuildBazelRemoteExecutionV2RequestMetadata
         where
          ...
          = Core.object
              (Core.catMaybes
                 [("actionId" Core..=) Core.<$> actionId,
                  ...
                  ("toolInvocationId" Core..=) Core.<$> toolInvocationId])
...
newBuildBazelRemoteExecutionV2ResultsCachePolicy 
    :: 
                                                 BuildBazelRemoteExecutionV2ResultsCachePolicy
newBuildBazelRemoteExecutionV2ResultsCachePolicy
  = BuildBazelRemoteExecutionV2ResultsCachePolicy{priority =
                                                    Core.Nothing}
instance Core.FromJSON
           BuildBazelRemoteExecutionV2ResultsCachePolicy
         where
        parseJSON
          = Core.withObject "BuildBazelRemoteExecutionV2ResultsCachePolicy"
              (\ o ->
                 BuildBazelRemoteExecutionV2ResultsCachePolicy Core.<$>
                   (o Core..:? "priority"))

instance Core.ToJSON BuildBazelRemoteExecutionV2ResultsCachePolicy
         where
        toJSON BuildBazelRemoteExecutionV2ResultsCachePolicy{..}
          = Core.object
              (Core.catMaybes [("priority" Core..=) Core.<$> priority])
...
newBuildBazelRemoteExecutionV2ServerCapabilities 
    :: 
                                                 BuildBazelRemoteExecutionV2ServerCapabilities
newBuildBazelRemoteExecutionV2ServerCapabilities
  = BuildBazelRemoteExecutionV2ServerCapabilities{cacheCapabilities =
                                                    Core.Nothing,
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "BuildBazelRemoteExecutionV2ServerCapabilities"
              (\ o ->
                 BuildBazelRemoteExecutionV2ServerCapabilities Core.<$>
...
instance Core.ToJSON BuildBazelRemoteExecutionV2ServerCapabilities
         where
        toJSON BuildBazelRemoteExecutionV2ServerCapabilities{..}
          = Core.object
              (Core.catMaybes
                 [("cacheCapabilities" Core..=) Core.<$> cacheCapabilities,
                  ("deprecatedApiVersion" Core..=) Core.<$> deprecatedApiVersion,
                  ("executionCapabilities" Core..=) Core.<$> executionCapabilities,
...
newBuildBazelRemoteExecutionV2SymlinkNode 
    :: 
                                          BuildBazelRemoteExecutionV2SymlinkNode
newBuildBazelRemoteExecutionV2SymlinkNode
  = BuildBazelRemoteExecutionV2SymlinkNode{name = Core.Nothing,
                                           nodeProperties = Core.Nothing, target = Core.Nothing}
instance Core.FromJSON BuildBazelRemoteExecutionV2SymlinkNode where
        parseJSON
          = Core.withObject "BuildBazelRemoteExecutionV2SymlinkNode"
              (\ o ->
                 BuildBazelRemoteExecutionV2SymlinkNode Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "nodeProperties") Core.<*>
                     (o Core..:? "target"))

instance Core.ToJSON BuildBazelRemoteExecutionV2SymlinkNode where
...
newBuildBazelRemoteExecutionV2ToolDetails 
    :: 
                                          BuildBazelRemoteExecutionV2ToolDetails
newBuildBazelRemoteExecutionV2ToolDetails
  = BuildBazelRemoteExecutionV2ToolDetails{toolName = Core.Nothing,
                                           toolVersion = Core.Nothing}
instance Core.FromJSON BuildBazelRemoteExecutionV2ToolDetails where
        parseJSON
          = Core.withObject "BuildBazelRemoteExecutionV2ToolDetails"
              (\ o ->
                 BuildBazelRemoteExecutionV2ToolDetails Core.<$>
                   (o Core..:? "toolName") Core.<*> (o Core..:? "toolVersion"))

instance Core.ToJSON BuildBazelRemoteExecutionV2ToolDetails where
...
newBuildBazelRemoteExecutionV2Tree 
    :: 
                                   BuildBazelRemoteExecutionV2Tree
newBuildBazelRemoteExecutionV2Tree
  = BuildBazelRemoteExecutionV2Tree{children = Core.Nothing,
                                    root = Core.Nothing}
instance Core.FromJSON BuildBazelRemoteExecutionV2Tree where
        parseJSON
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "BuildBazelRemoteExecutionV2WaitExecutionRequest"
              (\ o -> Core.pure BuildBazelRemoteExecutionV2WaitExecutionRequest)
...
newBuildBazelSemverSemVer 
    ::  BuildBazelSemverSemVer
newBuildBazelSemverSemVer
  = BuildBazelSemverSemVer{major = Core.Nothing,
                           minor = Core.Nothing, patch = Core.Nothing,
          ...
          = Core.withObject "BuildBazelSemverSemVer"
              (\ o ->
                 BuildBazelSemverSemVer Core.<$>
                   (o Core..:? "major") Core.<*> (o Core..:? "minor") Core.<*>
                     (o Core..:? "patch")
          ...
          = Core.object
              (Core.catMaybes
                 [("major" Core..=) Core.<$> major,
                  ("minor" Core..=) Core.<$> minor, ("patch" Core..=) Core.<$> patch,
...
newGoogleDevtoolsRemotebuildbotCommandDurations 
    :: 
                                                GoogleDevtoolsRemotebuildbotCommandDurations
newGoogleDevtoolsRemotebuildbotCommandDurations
  = GoogleDevtoolsRemotebuildbotCommandDurations{casRelease =
                                                   Core.Nothing,
                                                 ...
                                                 isoPrepDone = Core.Nothing, overall = Core.Nothing,
                                                 stdout = Core.Nothing, upload = Core.Nothing,
                                                 uploadStartTime = Core.Nothing}
instance Core.FromJSON GoogleDevtoolsRemotebuildbotCommandDurations
         where
        parseJSON
          = Core.withObject "GoogleDevtoolsRemotebuildbotCommandDurations"
              (\ o ->
...
instance Core.ToJSON GoogleDevtoolsRemotebuildbotCommandDurations
         where
        toJSON GoogleDevtoolsRemotebuildbotCommandDurations{..}
          = Core.object
              (Core.catMaybes
                 [("casRelease" Core..=) Core.<$> casRelease,
                  ("cmWaitForAssignment" Core..=) Core.<$> cmWaitForAssignment,
                  ("dockerPrep" Core..=) Core.<$> dockerPrep,
                  ("dockerPrepStartTime" Core..=) Core.<$> dockerPrepStartTime,
                  ("download" Core..=) Core.<$> download,
                  ("downloadStartTime" Core..=) Core.<$> downloadStartTime,
                  ...
                  ("uploadStartTime" Core..=) Core.<$> uploadStartTime])
...
newGoogleDevtoolsRemotebuildbotCommandEvents 
    :: 
                                             GoogleDevtoolsRemotebuildbotCommandEvents
newGoogleDevtoolsRemotebuildbotCommandEvents
  = GoogleDevtoolsRemotebuildbotCommandEvents{cmUsage = Core.Nothing,
                                              dockerCacheHit = Core.Nothing,
                                              dockerImageName = Core.Nothing,
                                              inputCacheMiss = Core.Nothing,
                                              numErrors = Core.Nothing, numWarnings = Core.Nothing,
                                              outputLocation = Core.Nothing,
                                              usedAsyncContainer = Core.Nothing}
instance Core.FromJSON GoogleDevtoolsRemotebuildbotCommandEvents
         where
        parseJSON
          = Core.withObject "GoogleDevtoolsRemotebuildbotCommandEvents"
              (\ o ->
                 GoogleDevtoolsRemotebuildbotCommandEvents Core.<$>
                   (o Core..:? "cmUsage") Core.<*> (o Core..:? "dockerCacheHit")
                     Core.<*> (o Core..:? "dockerImageName")
                     Core.<*> (o Core..:? "inputCacheMiss")
                     Core.<*>
                     (o Core..:? "numErrors" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "numWarnings" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "outputLocation")
                     Core.<*> (o Core..:? "usedAsyncContainer"))

instance Core.ToJSON GoogleDevtoolsRemotebuildbotCommandEvents
         where
          ...
          = Core.object
              (Core.catMaybes
                 [("cmUsage" Core..=) Core.<$> cmUsage,
                  ...
                  ("numErrors" Core..=) Core.. Core.AsText Core.<$> numErrors,
                  ("numWarnings" Core..=) Core.. Core.AsText Core.<$> numWarnings,
                  ("outputLocation" Core..=) Core.<$> outputLocation,
                  ("usedAsyncContainer" Core..=) Core.<$> usedAsyncContainer])
...
newGoogleDevtoolsRemotebuildbotCommandStatus 
    :: 
                                             GoogleDevtoolsRemotebuildbotCommandStatus
newGoogleDevtoolsRemotebuildbotCommandStatus
  = GoogleDevtoolsRemotebuildbotCommandStatus{code = Core.Nothing,
                                              message = Core.Nothing}
instance Core.FromJSON GoogleDevtoolsRemotebuildbotCommandStatus
         where
        parseJSON
          = Core.withObject "GoogleDevtoolsRemotebuildbotCommandStatus"
              (\ o ->
                 GoogleDevtoolsRemotebuildbotCommandStatus Core.<$>
                   (o Core..:? "code") Core.<*> (o Core..:? "message"))

instance Core.ToJSON GoogleDevtoolsRemotebuildbotCommandStatus
         where
...
newGoogleDevtoolsRemotebuildbotResourceUsage 
    :: 
                                             GoogleDevtoolsRemotebuildbotResourceUsage
newGoogleDevtoolsRemotebuildbotResourceUsage
  = GoogleDevtoolsRemotebuildbotResourceUsage{cpuUsedPercent =
                                                Core.Nothing,
                                              diskUsage = Core.Nothing, memoryUsage = Core.Nothing,
                                              totalDiskIoStats = Core.Nothing}
instance Core.FromJSON GoogleDevtoolsRemotebuildbotResourceUsage
         where
        parseJSON
          = Core.withObject "GoogleDevtoolsRemotebuildbotResourceUsage"
              (\ o ->
                 GoogleDevtoolsRemotebuildbotResourceUsage Core.<$>
                   (o Core..:? "cpuUsedPercent") Core.<*> (o Core..:? "diskUsage")
                     Core.<*> (o Core..:? "memoryUsage")
                     Core.<*> (o Core..:? "totalDiskIoStats"))

instance Core.ToJSON GoogleDevtoolsRemotebuildbotResourceUsage
         where
          ...
          = Core.object
              (Core.catMaybes
                 [("cpuUsedPercent" Core..=) Core.<$> cpuUsedPercent,
                  ...
                  ("totalDiskIoStats" Core..=) Core.<$> totalDiskIoStats])
...
newGoogleDevtoolsRemotebuildbotResourceUsageIOStats 
    :: 
                                                    GoogleDevtoolsRemotebuildbotResourceUsageIOStats
newGoogleDevtoolsRemotebuildbotResourceUsageIOStats
  = GoogleDevtoolsRemotebuildbotResourceUsageIOStats{readBytesCount =
                                                       Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleDevtoolsRemotebuildbotResourceUsageIOStats"
              (\ o ->
                 GoogleDevtoolsRemotebuildbotResourceUsageIOStats Core.<$>
                   (o Core..:? "readBytesCount" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "readCount" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "readTimeMs" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "writeBytesCount" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "writeCount" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "writeTimeMs" Core.<&> Core.fmap Core.fromAsText))

instance Core.ToJSON
           GoogleDevtoolsRemotebuildbotResourceUsageIOStats
         where
        toJSON GoogleDevtoolsRemotebuildbotResourceUsageIOStats{..}
          = Core.object
              (Core.catMaybes
                 [("readBytesCount" Core..=) Core.. Core.AsText Core.<$>
                    readBytesCount,
                  ("readCount" Core..=) Core.. Core.AsText Core.<$> readCount,
                  ("readTimeMs" Core..=) Core.. Core.AsText Core.<$> readTimeMs,
                  ("writeBytesCount" Core..=) Core.. Core.AsText Core.<$>
                    writeBytesCount,
                  ("writeCount" Core..=) Core.. Core.AsText Core.<$> writeCount,
                  ("writeTimeMs" Core..=) Core.. Core.AsText Core.<$> writeTimeMs])
...
newGoogleDevtoolsRemotebuildbotResourceUsageStat 
    :: 
                                                 GoogleDevtoolsRemotebuildbotResourceUsageStat
newGoogleDevtoolsRemotebuildbotResourceUsageStat
  = GoogleDevtoolsRemotebuildbotResourceUsageStat{total =
                                                    Core.Nothing,
                                                  used = Core.Nothing}
instance Core.FromJSON
           GoogleDevtoolsRemotebuildbotResourceUsageStat
         where
        parseJSON
          = Core.withObject "GoogleDevtoolsRemotebuildbotResourceUsageStat"
              (\ o ->
                 GoogleDevtoolsRemotebuildbotResourceUsageStat Core.<$>
                   (o Core..:? "total" Core.<&> Core.fmap Core.fromAsText) Core.<*>
                     (o Core..:? "used" Core.<&> Core.fmap Core.fromAsText))

instance Core.ToJSON GoogleDevtoolsRemotebuildbotResourceUsageStat
         where
        toJSON GoogleDevtoolsRemotebuildbotResourceUsageStat{..}
          = Core.object
              (Core.catMaybes
...
newGoogleDevtoolsRemotebuildexecutionAdminV1alphaAcceleratorConfig 
    :: 
                                                                   GoogleDevtoolsRemotebuildexecutionAdminV1alphaAcceleratorConfig
newGoogleDevtoolsRemotebuildexecutionAdminV1alphaAcceleratorConfig
  = GoogleDevtoolsRemotebuildexecutionAdminV1alphaAcceleratorConfig{acceleratorCount
                                                                      = Core.Nothing,
...
newGoogleDevtoolsRemotebuildexecutionAdminV1alphaAutoscale 
    :: 
                                                           GoogleDevtoolsRemotebuildexecutionAdminV1alphaAutoscale
newGoogleDevtoolsRemotebuildexecutionAdminV1alphaAutoscale
  = GoogleDevtoolsRemotebuildexecutionAdminV1alphaAutoscale{maxSize =
                                                              Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleDevtoolsRemotebuildexecutionAdminV1alphaAutoscale"
              (\ o ->
                 GoogleDevtoolsRemotebuildexecutionAdminV1alphaAutoscale Core.<$>
                   (o Core..:? "maxSize" Core.<&> Core.fmap Core.fromAsText) Core.<*>
                     (o Core..:? "minSize" Core.<&> Core.fmap Core.fromAsText))

instance Core.ToJSON
           GoogleDevtoolsRemotebuildexecutionAdminV1alphaAutoscale
         where
        toJSON GoogleDevtoolsRemotebuildexecutionAdminV1alphaAutoscale{..}
          = Core.object
              (Core.catMaybes
                 [("maxSize" Core..=) Core.. Core.AsText Core.<$> maxSize,
                  ("minSize" Core..=) Core.. Core.AsText Core.<$> minSize])
...
newGoogleDevtoolsRemotebuildexecutionAdminV1alphaCreateInstanceRequest 
    :: 
                                                                       GoogleDevtoolsRemotebuildexecutionAdminV1alphaCreateInstanceRequest
newGoogleDevtoolsRemotebuildexecutionAdminV1alphaCreateInstanceRequest
  = GoogleDevtoolsRemotebuildexecutionAdminV1alphaCreateInstanceRequest{instance'
                                                                          = Core.Nothing,
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 GoogleDevtoolsRemotebuildexecutionAdminV1alphaCreateInstanceRequest
                   Core.<$>
                   (o Core..:? "instance") Core.<*> (o Core..:? "instanceId") Core.<*>
                     (o Core..:? "parent"))
...
newGoogleDevtoolsRemotebuildexecutionAdminV1alphaCreateWorkerPoolRequest 
    :: 
                                                                         GoogleDevtoolsRemotebuildexecutionAdminV1alphaCreateWorkerPoolRequest
newGoogleDevtoolsRemotebuildexecutionAdminV1alphaCreateWorkerPoolRequest
  = GoogleDevtoolsRemotebuildexecutionAdminV1alphaCreateWorkerPoolRequest{parent
                                                                            = Core.Nothing,
                                                                          poolId = Core.Nothing,
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 GoogleDevtoolsRemotebuildexecutionAdminV1alphaCreateWorkerPoolRequest
                   Core.<$>
                   (o Core..:? "parent") Core.<*> (o Core..:? "poolId") Core.<*>
                     (o Core..:? "workerPool"))
...
newGoogleDevtoolsRemotebuildexecutionAdminV1alphaDeleteInstanceRequest 
    :: 
                                                                       GoogleDevtoolsRemotebuildexecutionAdminV1alphaDeleteInstanceRequest
newGoogleDevtoolsRemotebuildexecutionAdminV1alphaDeleteInstanceRequest
  = GoogleDevtoolsRemotebuildexecutionAdminV1alphaDeleteInstanceRequest{name
                                                                          = Core.Nothing}
instance Core.FromJSON
           GoogleDevtoolsRemotebuildexecutionAdminV1alphaDeleteInstanceRequest
         where
...
newGoogleDevtoolsRemotebuildexecutionAdminV1alphaDeleteWorkerPoolRequest 
    :: 
                                                                         GoogleDevtoolsRemotebuildexecutionAdminV1alphaDeleteWorkerPoolRequest
newGoogleDevtoolsRemotebuildexecutionAdminV1alphaDeleteWorkerPoolRequest
  = GoogleDevtoolsRemotebuildexecutionAdminV1alphaDeleteWorkerPoolRequest{name
                                                                            = Core.Nothing}
instance Core.FromJSON
           GoogleDevtoolsRemotebuildexecutionAdminV1alphaDeleteWorkerPoolRequest
         where
...
newGoogleDevtoolsRemotebuildexecutionAdminV1alphaFeaturePolicy 
    :: 
                                                               GoogleDevtoolsRemotebuildexecutionAdminV1alphaFeaturePolicy
newGoogleDevtoolsRemotebuildexecutionAdminV1alphaFeaturePolicy
  = GoogleDevtoolsRemotebuildexecutionAdminV1alphaFeaturePolicy{containerImageSources
                                                                  = Core.Nothing,
...
instance Core.ToJSON
        ...
        toJSON
          ...
          = Core.object
              (Core.catMaybes
                 [("containerImageSources" Core..=) Core.<$> containerImageSources,
                  ("dockerAddCapabilities" Core..=) Core.<$> dockerAddCapabilities,
                  ("dockerChrootPath" Core..=) Core.<$> dockerChrootPath,
                  ("dockerNetwork" Core..=) Core.<$> dockerNetwork,
                  ("dockerPrivileged" Core..=) Core.<$> dockerPrivileged,
...
newGoogleDevtoolsRemotebuildexecutionAdminV1alphaFeaturePolicyFeature 
    :: 
                                                                      GoogleDevtoolsRemotebuildexecutionAdminV1alphaFeaturePolicyFeature
newGoogleDevtoolsRemotebuildexecutionAdminV1alphaFeaturePolicyFeature
  = GoogleDevtoolsRemotebuildexecutionAdminV1alphaFeaturePolicyFeature{allowedValues
                                                                         = Core.Nothing,
                                                                       policy = Core.Nothing}
instance Core.FromJSON
           GoogleDevtoolsRemotebuildexecutionAdminV1alphaFeaturePolicyFeature
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 GoogleDevtoolsRemotebuildexecutionAdminV1alphaFeaturePolicyFeature
                   Core.<$>
                   (o Core..:? "allowedValues") Core.<*> (o Core..:? "policy"))
...
newGoogleDevtoolsRemotebuildexecutionAdminV1alphaGetInstanceRequest 
    :: 
                                                                    GoogleDevtoolsRemotebuildexecutionAdminV1alphaGetInstanceRequest
newGoogleDevtoolsRemotebuildexecutionAdminV1alphaGetInstanceRequest
  = GoogleDevtoolsRemotebuildexecutionAdminV1alphaGetInstanceRequest{name
                                                                       = Core.Nothing}
instance Core.FromJSON
           GoogleDevtoolsRemotebuildexecutionAdminV1alphaGetInstanceRequest
         where
...
newGoogleDevtoolsRemotebuildexecutionAdminV1alphaGetWorkerPoolRequest 
    :: 
                                                                      GoogleDevtoolsRemotebuildexecutionAdminV1alphaGetWorkerPoolRequest
newGoogleDevtoolsRemotebuildexecutionAdminV1alphaGetWorkerPoolRequest
  = GoogleDevtoolsRemotebuildexecutionAdminV1alphaGetWorkerPoolRequest{name
                                                                         = Core.Nothing}
instance Core.FromJSON
           GoogleDevtoolsRemotebuildexecutionAdminV1alphaGetWorkerPoolRequest
         where
...
newGoogleDevtoolsRemotebuildexecutionAdminV1alphaInstance 
    :: 
                                                          GoogleDevtoolsRemotebuildexecutionAdminV1alphaInstance
newGoogleDevtoolsRemotebuildexecutionAdminV1alphaInstance
  = GoogleDevtoolsRemotebuildexecutionAdminV1alphaInstance{featurePolicy
                                                             = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleDevtoolsRemotebuildexecutionAdminV1alphaInstance"
              (\ o ->
                 GoogleDevtoolsRemotebuildexecutionAdminV1alphaInstance Core.<$>
                   (o Core..:? "featurePolicy") Core.<*> (o Core..:? "location")
...
instance Core.ToJSON
           GoogleDevtoolsRemotebuildexecutionAdminV1alphaInstance
         where
        toJSON GoogleDevtoolsRemotebuildexecutionAdminV1alphaInstance{..}
          = Core.object
              (Core.catMaybes
...
newGoogleDevtoolsRemotebuildexecutionAdminV1alphaListInstancesRequest 
    :: 
                                                                      GoogleDevtoolsRemotebuildexecutionAdminV1alphaListInstancesRequest
newGoogleDevtoolsRemotebuildexecutionAdminV1alphaListInstancesRequest
  = GoogleDevtoolsRemotebuildexecutionAdminV1alphaListInstancesRequest{parent
                                                                         = Core.Nothing}
instance Core.FromJSON
           GoogleDevtoolsRemotebuildexecutionAdminV1alphaListInstancesRequest
         where
...
instance Core.ToJSON
        ...
        toJSON
          GoogleDevtoolsRemotebuildexecutionAdminV1alphaListInstancesRequest{..}
          = Core.object (Core.catMaybes [("parent" Core..=) Core.<$> parent])
...
newGoogleDevtoolsRemotebuildexecutionAdminV1alphaListInstancesResponse 
    :: 
                                                                       GoogleDevtoolsRemotebuildexecutionAdminV1alphaListInstancesResponse
newGoogleDevtoolsRemotebuildexecutionAdminV1alphaListInstancesResponse
  = GoogleDevtoolsRemotebuildexecutionAdminV1alphaListInstancesResponse{instances
                                                                          = Core.Nothing}
instance Core.FromJSON
           GoogleDevtoolsRemotebuildexecutionAdminV1alphaListInstancesResponse
         where
...
newGoogleDevtoolsRemotebuildexecutionAdminV1alphaListWorkerPoolsRequest 
    :: 
                                                                        GoogleDevtoolsRemotebuildexecutionAdminV1alphaListWorkerPoolsRequest
newGoogleDevtoolsRemotebuildexecutionAdminV1alphaListWorkerPoolsRequest
  = GoogleDevtoolsRemotebuildexecutionAdminV1alphaListWorkerPoolsRequest{filter
                                                                           = Core.Nothing,
                                                                         parent = Core.Nothing}
instance Core.FromJSON
           GoogleDevtoolsRemotebuildexecutionAdminV1alphaListWorkerPoolsRequest
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 GoogleDevtoolsRemotebuildexecutionAdminV1alphaListWorkerPoolsRequest
                   Core.<$> (o Core..:? "filter") Core.<*> (o Core..:? "parent"))
...
newGoogleDevtoolsRemotebuildexecutionAdminV1alphaListWorkerPoolsResponse 
    :: 
                                                                         GoogleDevtoolsRemotebuildexecutionAdminV1alphaListWorkerPoolsResponse
newGoogleDevtoolsRemotebuildexecutionAdminV1alphaListWorkerPoolsResponse
  = GoogleDevtoolsRemotebuildexecutionAdminV1alphaListWorkerPoolsResponse{workerPools
                                                                            = Core.Nothing}
instance Core.FromJSON
           GoogleDevtoolsRemotebuildexecutionAdminV1alphaListWorkerPoolsResponse
         where
...
instance Core.ToJSON
        ...
        toJSON
          GoogleDevtoolsRemotebuildexecutionAdminV1alphaListWorkerPoolsResponse{..}
          = Core.object
              (Core.catMaybes [("workerPools" Core..=) Core.<$> workerPools])
...
newGoogleDevtoolsRemotebuildexecutionAdminV1alphaUpdateInstanceRequest 
    :: 
                                                                       GoogleDevtoolsRemotebuildexecutionAdminV1alphaUpdateInstanceRequest
newGoogleDevtoolsRemotebuildexecutionAdminV1alphaUpdateInstanceRequest
  = GoogleDevtoolsRemotebuildexecutionAdminV1alphaUpdateInstanceRequest{instance'
                                                                          = Core.Nothing,
                                                                        loggingEnabled =
                                                                          Core.Nothing,
                                                                        name = Core.Nothing,
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 GoogleDevtoolsRemotebuildexecutionAdminV1alphaUpdateInstanceRequest
                   Core.<$>
                   (o Core..:? "instance") Core.<*> (o Core..:? "loggingEnabled")
                     Core.<*> (o Core..:? "name")
...
newGoogleDevtoolsRemotebuildexecutionAdminV1alphaUpdateWorkerPoolRequest 
    :: 
                                                                         GoogleDevtoolsRemotebuildexecutionAdminV1alphaUpdateWorkerPoolRequest
newGoogleDevtoolsRemotebuildexecutionAdminV1alphaUpdateWorkerPoolRequest
  = GoogleDevtoolsRemotebuildexecutionAdminV1alphaUpdateWorkerPoolRequest{updateMask
                                                                            = Core.Nothing,
                                                                          workerPool = Core.Nothing}
instance Core.FromJSON
           GoogleDevtoolsRemotebuildexecutionAdminV1alphaUpdateWorkerPoolRequest
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 GoogleDevtoolsRemotebuildexecutionAdminV1alphaUpdateWorkerPoolRequest
                   Core.<$>
                   (o Core..:? "updateMask") Core.<*> (o Core..:? "workerPool"))
...
newGoogleDevtoolsRemotebuildexecutionAdminV1alphaWorkerConfig 
    :: 
                                                              GoogleDevtoolsRemotebuildexecutionAdminV1alphaWorkerConfig
newGoogleDevtoolsRemotebuildexecutionAdminV1alphaWorkerConfig
  = GoogleDevtoolsRemotebuildexecutionAdminV1alphaWorkerConfig{accelerator
                                                                 = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleDevtoolsRemotebuildexecutionAdminV1alphaWorkerConfig"
              (\ o ->
                 GoogleDevtoolsRemotebuildexecutionAdminV1alphaWorkerConfig Core.<$>
...
newGoogleDevtoolsRemotebuildexecutionAdminV1alphaWorkerConfig_Labels
  additional
  = GoogleDevtoolsRemotebuildexecutionAdminV1alphaWorkerConfig_Labels{additional
                                                                        = additional}
instance Core.FromJSON
           GoogleDevtoolsRemotebuildexecutionAdminV1alphaWorkerConfig_Labels
         where
...
newGoogleDevtoolsRemotebuildexecutionAdminV1alphaWorkerPool 
    :: 
                                                            GoogleDevtoolsRemotebuildexecutionAdminV1alphaWorkerPool
newGoogleDevtoolsRemotebuildexecutionAdminV1alphaWorkerPool
  = GoogleDevtoolsRemotebuildexecutionAdminV1alphaWorkerPool{autoscale
                                                               = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleDevtoolsRemotebuildexecutionAdminV1alphaWorkerPool"
              (\ o ->
                 GoogleDevtoolsRemotebuildexecutionAdminV1alphaWorkerPool Core.<$>
                   (o Core..:? "autoscale") Core.<*> (o Core..:? "channel") Core.<*>
                     (o Core..:? "name")
                     Core.<*> (o Core..:? "state")
...
instance Core.ToJSON
           GoogleDevtoolsRemotebuildexecutionAdminV1alphaWorkerPool
         where
        toJSON GoogleDevtoolsRemotebuildexecutionAdminV1alphaWorkerPool{..}
          = Core.object
              (Core.catMaybes
...
newGoogleDevtoolsRemoteworkersV1test2AdminTemp 
    :: 
                                               GoogleDevtoolsRemoteworkersV1test2AdminTemp
newGoogleDevtoolsRemoteworkersV1test2AdminTemp
  = GoogleDevtoolsRemoteworkersV1test2AdminTemp{arg = Core.Nothing,
                                                command = Core.Nothing}
instance Core.FromJSON GoogleDevtoolsRemoteworkersV1test2AdminTemp
         where
        parseJSON
          = Core.withObject "GoogleDevtoolsRemoteworkersV1test2AdminTemp"
              (\ o ->
                 GoogleDevtoolsRemoteworkersV1test2AdminTemp Core.<$>
                   (o Core..:? "arg") Core.<*> (o Core..:? "command"))

instance Core.ToJSON GoogleDevtoolsRemoteworkersV1test2AdminTemp
         where
        toJSON GoogleDevtoolsRemoteworkersV1test2AdminTemp{..}
          = Core.object
              (Core.catMaybes
                 [("arg" Core..=) Core.<$> arg,
...
newGoogleDevtoolsRemoteworkersV1test2Blob 
    :: 
                                          GoogleDevtoolsRemoteworkersV1test2Blob
newGoogleDevtoolsRemoteworkersV1test2Blob
  = GoogleDevtoolsRemoteworkersV1test2Blob{contents = Core.Nothing,
                                           digest = Core.Nothing}
instance Core.FromJSON GoogleDevtoolsRemoteworkersV1test2Blob where
        parseJSON
          = Core.withObject "GoogleDevtoolsRemoteworkersV1test2Blob"
              (\ o ->
                 GoogleDevtoolsRemoteworkersV1test2Blob Core.<$>
                   (o Core..:? "contents") Core.<*> (o Core..:? "digest"))

instance Core.ToJSON GoogleDevtoolsRemoteworkersV1test2Blob where
...
newGoogleDevtoolsRemoteworkersV1test2CommandOutputs 
    :: 
                                                    GoogleDevtoolsRemoteworkersV1test2CommandOutputs
newGoogleDevtoolsRemoteworkersV1test2CommandOutputs
  = GoogleDevtoolsRemoteworkersV1test2CommandOutputs{exitCode =
                                                       Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleDevtoolsRemoteworkersV1test2CommandOutputs"
              (\ o ->
                 GoogleDevtoolsRemoteworkersV1test2CommandOutputs Core.<$>
                   (o Core..:? "exitCode") Core.<*> (o Core..:? "outputs"))

instance Core.ToJSON
           GoogleDevtoolsRemoteworkersV1test2CommandOutputs
         where
        toJSON GoogleDevtoolsRemoteworkersV1test2CommandOutputs{..}
          = Core.object
              (Core.catMaybes
                 [("exitCode" Core..=) Core.<$> exitCode,
...
newGoogleDevtoolsRemoteworkersV1test2CommandOverhead 
    :: 
                                                     GoogleDevtoolsRemoteworkersV1test2CommandOverhead
newGoogleDevtoolsRemoteworkersV1test2CommandOverhead
  = GoogleDevtoolsRemoteworkersV1test2CommandOverhead{duration =
                                                        Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleDevtoolsRemoteworkersV1test2CommandOverhead"
              (\ o ->
                 GoogleDevtoolsRemoteworkersV1test2CommandOverhead Core.<$>
                   (o Core..:? "duration") Core.<*> (o Core..:? "overhead"))

instance Core.ToJSON
           GoogleDevtoolsRemoteworkersV1test2CommandOverhead
         where
        toJSON GoogleDevtoolsRemoteworkersV1test2CommandOverhead{..}
          = Core.object
              (Core.catMaybes
...
newGoogleDevtoolsRemoteworkersV1test2CommandResult 
    :: 
                                                   GoogleDevtoolsRemoteworkersV1test2CommandResult
newGoogleDevtoolsRemoteworkersV1test2CommandResult
  = GoogleDevtoolsRemoteworkersV1test2CommandResult{duration =
                                                      Core.Nothing,
                                                    exitCode = Core.Nothing,
                                                    metadata = Core.Nothing, outputs = Core.Nothing,
                                                    overhead = Core.Nothing, status = Core.Nothing}
instance Core.FromJSON
           GoogleDevtoolsRemoteworkersV1test2CommandResult
         where
        parseJSON
          = Core.withObject "GoogleDevtoolsRemoteworkersV1test2CommandResult"
              (\ o ->
                 GoogleDevtoolsRemoteworkersV1test2CommandResult Core.<$>
                   (o Core..:? "duration") Core.<*> (o Core..:? "exitCode") Core.<*>
                     (o Core..:? "metadata")
                     Core.<*> (o Core..:? "outputs")
...
instance Core.ToJSON
           GoogleDevtoolsRemoteworkersV1test2CommandResult
         where
        toJSON GoogleDevtoolsRemoteworkersV1test2CommandResult{..}
          = Core.object
              (Core.catMaybes
                 [("duration" Core..=) Core.<$> duration,
                  ("exitCode" Core..=) Core.<$> exitCode,
...
newGoogleDevtoolsRemoteworkersV1test2CommandResult_MetadataItem
  additional
  = GoogleDevtoolsRemoteworkersV1test2CommandResult_MetadataItem{additional
                                                                   = additional}
instance Core.FromJSON
           GoogleDevtoolsRemoteworkersV1test2CommandResult_MetadataItem
         where
...
newGoogleDevtoolsRemoteworkersV1test2CommandTask 
    :: 
                                                 GoogleDevtoolsRemoteworkersV1test2CommandTask
newGoogleDevtoolsRemoteworkersV1test2CommandTask
  = GoogleDevtoolsRemoteworkersV1test2CommandTask{expectedOutputs =
                                                    Core.Nothing,
                                                  inputs = Core.Nothing, timeouts = Core.Nothing}
instance Core.FromJSON
           GoogleDevtoolsRemoteworkersV1test2CommandTask
         where
        parseJSON
          = Core.withObject "GoogleDevtoolsRemoteworkersV1test2CommandTask"
              (\ o ->
                 GoogleDevtoolsRemoteworkersV1test2CommandTask Core.<$>
                   (o Core..:? "expectedOutputs") Core.<*> (o Core..:? "inputs")
                     Core.<*> (o Core..:? "timeouts"))

instance Core.ToJSON GoogleDevtoolsRemoteworkersV1test2CommandTask
         where
        toJSON GoogleDevtoolsRemoteworkersV1test2CommandTask{..}
          = Core.object
              (Core.catMaybes
                 [("expectedOutputs" Core..=) Core.<$> expectedOutputs,
...
newGoogleDevtoolsRemoteworkersV1test2CommandTaskInputs 
    :: 
                                                       GoogleDevtoolsRemoteworkersV1test2CommandTaskInputs
newGoogleDevtoolsRemoteworkersV1test2CommandTaskInputs
  = GoogleDevtoolsRemoteworkersV1test2CommandTaskInputs{arguments =
                                                          Core.Nothing,
                                                        environmentVariables = Core.Nothing,
                                                        files = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleDevtoolsRemoteworkersV1test2CommandTaskInputs"
              (\ o ->
                 GoogleDevtoolsRemoteworkersV1test2CommandTaskInputs Core.<$>
                   (o Core..:? "arguments") Core.<*>
                     (o Core..:? "environmentVariables")
                     Core.<*> (o Core..:? "files")
...
instance Core.ToJSON
           GoogleDevtoolsRemoteworkersV1test2CommandTaskInputs
         where
        toJSON GoogleDevtoolsRemoteworkersV1test2CommandTaskInputs{..}
          = Core.object
              (Core.catMaybes
                 [("arguments" Core..=) Core.<$> arguments,
                  ("environmentVariables" Core..=) Core.<$> environmentVariables,
...
newGoogleDevtoolsRemoteworkersV1test2CommandTaskInputsEnvironmentVariable 
    :: 
                                                                          GoogleDevtoolsRemoteworkersV1test2CommandTaskInputsEnvironmentVariable
newGoogleDevtoolsRemoteworkersV1test2CommandTaskInputsEnvironmentVariable
  = GoogleDevtoolsRemoteworkersV1test2CommandTaskInputsEnvironmentVariable{name
                                                                             = Core.Nothing,
                                                                           value = Core.Nothing}
instance Core.FromJSON
           GoogleDevtoolsRemoteworkersV1test2CommandTaskInputsEnvironmentVariable
...
newGoogleDevtoolsRemoteworkersV1test2CommandTaskOutputs 
    :: 
                                                        GoogleDevtoolsRemoteworkersV1test2CommandTaskOutputs
newGoogleDevtoolsRemoteworkersV1test2CommandTaskOutputs
  = GoogleDevtoolsRemoteworkersV1test2CommandTaskOutputs{directories
                                                           = Core.Nothing,
                                                         files = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleDevtoolsRemoteworkersV1test2CommandTaskOutputs"
              (\ o ->
                 GoogleDevtoolsRemoteworkersV1test2CommandTaskOutputs Core.<$>
                   (o Core..:? "directories") Core.<*> (o Core..:? "files") Core.<*>
                     (o Core..:? "stderrDestination")
                     Core.<*> (o Core..:? "stdoutDestination"))

instance Core.ToJSON
           GoogleDevtoolsRemoteworkersV1test2CommandTaskOutputs
         where
        toJSON GoogleDevtoolsRemoteworkersV1test2CommandTaskOutputs{..}
          = Core.object
              (Core.catMaybes
                 [("directories" Core..=) Core.<$> directories,
                  ("files" Core..=) Core.<$> files,
                  ("stderrDestination" Core..=) Core.<$> stderrDestination,
                  ("stdoutDestination" Core..=) Core.<$> stdoutDestination])
...
newGoogleDevtoolsRemoteworkersV1test2CommandTaskTimeouts 
    :: 
                                                         GoogleDevtoolsRemoteworkersV1test2CommandTaskTimeouts
newGoogleDevtoolsRemoteworkersV1test2CommandTaskTimeouts
  = GoogleDevtoolsRemoteworkersV1test2CommandTaskTimeouts{execution =
                                                            Core.Nothing,
                                                          idle = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleDevtoolsRemoteworkersV1test2CommandTaskTimeouts"
              (\ o ->
                 GoogleDevtoolsRemoteworkersV1test2CommandTaskTimeouts Core.<$>
                   (o Core..:? "execution") Core.<*> (o Core..:? "idle") Core.<*>
                     (o Core..:? "shutdown"))

instance Core.ToJSON
           GoogleDevtoolsRemoteworkersV1test2CommandTaskTimeouts
         where
        toJSON GoogleDevtoolsRemoteworkersV1test2CommandTaskTimeouts{..}
          = Core.object
              (Core.catMaybes
                 [("execution" Core..=) Core.<$> execution,
                  ("idle" Core..=) Core.<$> idle,
...
newGoogleDevtoolsRemoteworkersV1test2Digest 
    :: 
                                            GoogleDevtoolsRemoteworkersV1test2Digest
newGoogleDevtoolsRemoteworkersV1test2Digest
  = GoogleDevtoolsRemoteworkersV1test2Digest{hash = Core.Nothing,
                                             sizeBytes = Core.Nothing}
instance Core.FromJSON GoogleDevtoolsRemoteworkersV1test2Digest
         where
        parseJSON
          = Core.withObject "GoogleDevtoolsRemoteworkersV1test2Digest"
              (\ o ->
                 GoogleDevtoolsRemoteworkersV1test2Digest Core.<$>
                   (o Core..:? "hash") Core.<*>
                     (o Core..:? "sizeBytes" Core.<&> Core.fmap Core.fromAsText))

instance Core.ToJSON GoogleDevtoolsRemoteworkersV1test2Digest where
...
newGoogleDevtoolsRemoteworkersV1test2Directory 
    :: 
                                               GoogleDevtoolsRemoteworkersV1test2Directory
newGoogleDevtoolsRemoteworkersV1test2Directory
  = GoogleDevtoolsRemoteworkersV1test2Directory{directories =
                                                  Core.Nothing,
                                                files = Core.Nothing}
instance Core.FromJSON GoogleDevtoolsRemoteworkersV1test2Directory
         where
        parseJSON
          = Core.withObject "GoogleDevtoolsRemoteworkersV1test2Directory"
              (\ o ->
                 GoogleDevtoolsRemoteworkersV1test2Directory Core.<$>
                   (o Core..:? "directories") Core.<*> (o Core..:? "files"))

instance Core.ToJSON GoogleDevtoolsRemoteworkersV1test2Directory
         where
        toJSON GoogleDevtoolsRemoteworkersV1test2Directory{..}
          = Core.object
              (Core.catMaybes
                 [("directories" Core..=) Core.<$> directories,
                  ("files" Core..=) Core.<$> files])
...
newGoogleDevtoolsRemoteworkersV1test2DirectoryMetadata 
    :: 
                                                       GoogleDevtoolsRemoteworkersV1test2DirectoryMetadata
newGoogleDevtoolsRemoteworkersV1test2DirectoryMetadata
  = GoogleDevtoolsRemoteworkersV1test2DirectoryMetadata{digest =
                                                          Core.Nothing,
                                                        path = Core.Nothing}
instance Core.FromJSON
           GoogleDevtoolsRemoteworkersV1test2DirectoryMetadata
        ...
        parseJSON
          = Core.withObject
              "GoogleDevtoolsRemoteworkersV1test2DirectoryMetadata"
              (\ o ->
                 GoogleDevtoolsRemoteworkersV1test2DirectoryMetadata Core.<$>
                   (o Core..:? "digest") Core.<*> (o Core..:? "path"))

instance Core.ToJSON
           GoogleDevtoolsRemoteworkersV1test2DirectoryMetadata
         where
        toJSON GoogleDevtoolsRemoteworkersV1test2DirectoryMetadata{..}
          = Core.object
              (Core.catMaybes
                 [("digest" Core..=) Core.<$> digest,
                  ("path" Core..=) Core.<$> path])
...
newGoogleDevtoolsRemoteworkersV1test2FileMetadata 
    :: 
                                                  GoogleDevtoolsRemoteworkersV1test2FileMetadata
newGoogleDevtoolsRemoteworkersV1test2FileMetadata
  = GoogleDevtoolsRemoteworkersV1test2FileMetadata{contents =
                                                     Core.Nothing,
                                                   digest = Core.Nothing,
                                                   isExecutable = Core.Nothing, path = Core.Nothing}
instance Core.FromJSON
           GoogleDevtoolsRemoteworkersV1test2FileMetadata
         where
        parseJSON
          = Core.withObject "GoogleDevtoolsRemoteworkersV1test2FileMetadata"
              (\ o ->
                 GoogleDevtoolsRemoteworkersV1test2FileMetadata Core.<$>
                   (o Core..:? "contents") Core.<*> (o Core..:? "digest") Core.<*>
                     (o Core..:? "isExecutable")
                     Core.<*> (o Core..:? "path"))

instance Core.ToJSON GoogleDevtoolsRemoteworkersV1test2FileMetadata
         where
        toJSON GoogleDevtoolsRemoteworkersV1test2FileMetadata{..}
          = Core.object
              (Core.catMaybes
                 [("contents" Core..=) Core.<$> contents,
                  ("digest" Core..=) Core.<$> digest,
