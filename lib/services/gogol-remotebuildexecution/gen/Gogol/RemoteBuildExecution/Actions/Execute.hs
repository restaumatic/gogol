                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] BuildBazelRemoteExecutionV2ExecuteRequest
...
newRemoteBuildExecutionActionsExecute instanceName payload
  = RemoteBuildExecutionActionsExecute{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       instanceName = instanceName, payload = payload,
                                       uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest RemoteBuildExecutionActionsExecute
         where
        ...
        requestClient RemoteBuildExecutionActionsExecute{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy RemoteBuildExecutionActionsExecuteResource)
                      Core.mempty
