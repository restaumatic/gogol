       ...
       Core.Capture "instanceName" Core.Text Core.:>
         "blobs" Core.:>
           Core.Capture "hash" Core.Text Core.:>
             Core.CaptureMode "sizeBytes" "getTree" Core.Int64 Core.:>
                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Get '[Core.JSON] BuildBazelRemoteExecutionV2GetTreeResponse
...
newRemoteBuildExecutionBlobsGetTree hash instanceName sizeBytes
  = RemoteBuildExecutionBlobsGetTree{xgafv = Core.Nothing,
...
instance Core.GoogleRequest RemoteBuildExecutionBlobsGetTree where
        ...
        requestClient RemoteBuildExecutionBlobsGetTree{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy RemoteBuildExecutionBlobsGetTreeResource)
                      Core.mempty
