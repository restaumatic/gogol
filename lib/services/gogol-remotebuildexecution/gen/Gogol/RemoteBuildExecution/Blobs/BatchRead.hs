...
newRemoteBuildExecutionBlobsBatchRead instanceName payload
  = RemoteBuildExecutionBlobsBatchRead{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       instanceName = instanceName, payload = payload,
                                       uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest RemoteBuildExecutionBlobsBatchRead
         where
        type Rs RemoteBuildExecutionBlobsBatchRead =
             BuildBazelRemoteExecutionV2BatchReadBlobsResponse
        type Scopes RemoteBuildExecutionBlobsBatchRead =
