...
newRemoteBuildExecutionBlobsFindMissing instanceName payload
  = RemoteBuildExecutionBlobsFindMissing{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         instanceName = instanceName, payload = payload,
                                         uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest RemoteBuildExecutionBlobsFindMissing
         where
        type Rs RemoteBuildExecutionBlobsFindMissing =
             BuildBazelRemoteExecutionV2FindMissingBlobsResponse
        type Scopes RemoteBuildExecutionBlobsFindMissing =
             '[CloudPlatform'FullControl]
        requestClient RemoteBuildExecutionBlobsFindMissing{..}
          = go instanceName xgafv accessToken callback uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy RemoteBuildExecutionBlobsFindMissingResource)
                      Core.mempty
