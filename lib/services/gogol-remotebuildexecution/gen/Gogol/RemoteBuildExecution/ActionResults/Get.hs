       ...
       Core.Capture "instanceName" Core.Text Core.:>
         "actionResults" Core.:>
           Core.Capture "hash" Core.Text Core.:>
             Core.Capture "sizeBytes" Core.Int64 Core.:>
               Core.QueryParam "$.xgafv" Xgafv Core.:>
                 Core.QueryParam "access_token" Core.Text Core.:>
                   Core.QueryParam "callback" Core.Text Core.:>
                     Core.QueryParams "inlineOutputFiles" Core.Text Core.:>
                       Core.QueryParam "inlineStderr" Core.Bool Core.:>
                         Core.QueryParam "inlineStdout" Core.Bool Core.:>
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.Get '[Core.JSON] BuildBazelRemoteExecutionV2ActionResult
...
newRemoteBuildExecutionActionResultsGet hash instanceName sizeBytes
  = RemoteBuildExecutionActionResultsGet{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         hash = hash, inlineOutputFiles = Core.Nothing,
                                         inlineStderr = Core.Nothing, inlineStdout = Core.Nothing,
                                         instanceName = instanceName, sizeBytes = sizeBytes,
                                         uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest RemoteBuildExecutionActionResultsGet
         where
        type Rs RemoteBuildExecutionActionResultsGet =
             BuildBazelRemoteExecutionV2ActionResult
        type Scopes RemoteBuildExecutionActionResultsGet =
             '[CloudPlatform'FullControl]
        requestClient RemoteBuildExecutionActionResultsGet{..}
          = go instanceName hash sizeBytes xgafv accessToken callback
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy RemoteBuildExecutionActionResultsGetResource)
                      Core.mempty
