               ...
               Core.QueryParam "$.xgafv" Xgafv Core.:>
                 Core.QueryParam "access_token" Core.Text Core.:>
                   Core.QueryParam "callback" Core.Text Core.:>
                     Core.QueryParam "resultsCachePolicy.priority" Core.Int32 Core.:>
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] BuildBazelRemoteExecutionV2ActionResult
                               Core.:>
                               Core.Put '[Core.JSON] BuildBazelRemoteExecutionV2ActionResult
...
newRemoteBuildExecutionActionResultsUpdate 
    ...
    -> RemoteBuildExecutionActionResultsUpdate
newRemoteBuildExecutionActionResultsUpdate hash instanceName
  payload sizeBytes
  = RemoteBuildExecutionActionResultsUpdate{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            hash = hash, instanceName = instanceName,
                                            payload = payload,
                                            resultsCachePolicyPriority = Core.Nothing,
                                            sizeBytes = sizeBytes, uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest RemoteBuildExecutionActionResultsUpdate
         where
        type Rs RemoteBuildExecutionActionResultsUpdate =
             BuildBazelRemoteExecutionV2ActionResult
        type Scopes RemoteBuildExecutionActionResultsUpdate =
