                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.Get '[Core.JSON] BuildBazelRemoteExecutionV2ServerCapabilities
...
newRemoteBuildExecutionGetCapabilities instanceName
  = RemoteBuildExecutionGetCapabilities{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        instanceName = instanceName, uploadType = Core.Nothing,
                                        uploadProtocol = Core.Nothing}
instance Core.GoogleRequest RemoteBuildExecutionGetCapabilities
         where
        type Rs RemoteBuildExecutionGetCapabilities =
             BuildBazelRemoteExecutionV2ServerCapabilities
        type Scopes RemoteBuildExecutionGetCapabilities =
        ...
        requestClient RemoteBuildExecutionGetCapabilities{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy RemoteBuildExecutionGetCapabilitiesResource)
                      Core.mempty
