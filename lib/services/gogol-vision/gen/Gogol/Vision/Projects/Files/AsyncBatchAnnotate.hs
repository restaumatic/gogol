...
newVisionProjectsFilesAsyncBatchAnnotate parent payload
  = VisionProjectsFilesAsyncBatchAnnotate{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          parent = parent, payload = payload,
                                          uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest VisionProjectsFilesAsyncBatchAnnotate
         where
        type Rs VisionProjectsFilesAsyncBatchAnnotate = Operation
        type Scopes VisionProjectsFilesAsyncBatchAnnotate =
