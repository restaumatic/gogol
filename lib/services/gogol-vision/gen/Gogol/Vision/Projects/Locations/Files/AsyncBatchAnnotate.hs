...
newVisionProjectsLocationsFilesAsyncBatchAnnotate parent payload
  = VisionProjectsLocationsFilesAsyncBatchAnnotate{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           VisionProjectsLocationsFilesAsyncBatchAnnotate
         where
        type Rs VisionProjectsLocationsFilesAsyncBatchAnnotate = Operation
        type Scopes VisionProjectsLocationsFilesAsyncBatchAnnotate =
             '[CloudPlatform'FullControl, CloudVision'FullControl]
        requestClient VisionProjectsLocationsFilesAsyncBatchAnnotate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy VisionProjectsLocationsFilesAsyncBatchAnnotateResource)
                      Core.mempty
