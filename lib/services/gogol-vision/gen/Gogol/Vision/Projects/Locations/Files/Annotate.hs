...
newVisionProjectsLocationsFilesAnnotate parent payload
  = VisionProjectsLocationsFilesAnnotate{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         parent = parent, payload = payload,
                                         uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest VisionProjectsLocationsFilesAnnotate
         where
        type Rs VisionProjectsLocationsFilesAnnotate =
             GoogleCloudVisionV1p2beta1BatchAnnotateFilesResponse
        type Scopes VisionProjectsLocationsFilesAnnotate =
