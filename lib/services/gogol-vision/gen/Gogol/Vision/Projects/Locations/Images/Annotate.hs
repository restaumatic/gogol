...
newVisionProjectsLocationsImagesAnnotate parent payload
  = VisionProjectsLocationsImagesAnnotate{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          parent = parent, payload = payload,
                                          uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest VisionProjectsLocationsImagesAnnotate
         where
        type Rs VisionProjectsLocationsImagesAnnotate =
             GoogleCloudVisionV1p2beta1BatchAnnotateImagesResponse
        type Scopes VisionProjectsLocationsImagesAnnotate =
