...
newVisionProjectsImagesAsyncBatchAnnotate parent payload
  = VisionProjectsImagesAsyncBatchAnnotate{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           parent = parent, payload = payload,
                                           uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest VisionProjectsImagesAsyncBatchAnnotate
         where
        type Rs VisionProjectsImagesAsyncBatchAnnotate = Operation
        type Scopes VisionProjectsImagesAsyncBatchAnnotate =
