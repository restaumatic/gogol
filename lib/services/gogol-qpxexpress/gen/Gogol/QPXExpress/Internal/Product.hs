...
newAircraftData 
    ::  AircraftData
newAircraftData
  = AircraftData{code = Core.Nothing,
                 kind = "qpxexpress#aircraftData", name = Core.Nothing}
instance Core.FromJSON AircraftData where
        parseJSON
          = Core.withObject "AircraftData"
              (\ o ->
                 AircraftData Core.<$>
                   (o Core..:? "code") Core.<*>
                     (o Core..:? "kind" Core..!= "qpxexpress#aircraftData")
                     Core.<*> (o Core..:? "name"))
...
instance Core.ToJSON AircraftData where
        toJSON AircraftData{..}
          = Core.object
              (Core.catMaybes
                 [("code" Core..=) Core.<$> code, Core.Just ("kind" Core..= kind),
                  ("name" Core..=) Core.<$> name])
...
newAirportData 
    ::  AirportData
newAirportData
  = AirportData{city = Core.Nothing, code = Core.Nothing,
                kind = "qpxexpress#airportData", name = Core.Nothing}
instance Core.FromJSON AirportData where
        parseJSON
          = Core.withObject "AirportData"
              (\ o ->
                 AirportData Core.<$>
                   (o Core..:? "city") Core.<*> (o Core..:? "code") Core.<*>
                     (o Core..:? "kind" Core..!= "qpxexpress#airportData")
                     Core.<*> (o Core..:? "name"))
...
instance Core.ToJSON AirportData where
        toJSON AirportData{..}
          = Core.object
              (Core.catMaybes
                 [("city" Core..=) Core.<$> city, ("code" Core..=) Core.<$> code,
...
newBagDescriptor 
    ::  BagDescriptor
newBagDescriptor
  = BagDescriptor{commercialName = Core.Nothing,
                  count = Core.Nothing, description = Core.Nothing,
                  kind = "qpxexpress#bagDescriptor", subcode = Core.Nothing}
instance Core.FromJSON BagDescriptor where
        parseJSON
          = Core.withObject "BagDescriptor"
              (\ o ->
                 BagDescriptor Core.<$>
                   (o Core..:? "commercialName") Core.<*> (o Core..:? "count")
...
newCarrierData 
    ::  CarrierData
newCarrierData
  = CarrierData{code = Core.Nothing, kind = "qpxexpress#carrierData",
                name = Core.Nothing}
instance Core.FromJSON CarrierData where
        parseJSON
          = Core.withObject "CarrierData"
              (\ o ->
                 CarrierData Core.<$>
                   (o Core..:? "code") Core.<*>
                     (o Core..:? "kind" Core..!= "qpxexpress#carrierData")
                     Core.<*> (o Core..:? "name"))
...
newCityData 
    ::  CityData
newCityData
  = CityData{code = Core.Nothing, country = Core.Nothing,
             kind = "qpxexpress#cityData", name = Core.Nothing}
instance Core.FromJSON CityData where
        parseJSON
          = Core.withObject "CityData"
              (\ o ->
                 CityData Core.<$>
                   (o Core..:? "code") Core.<*> (o Core..:? "country") Core.<*>
                     (o Core..:? "kind" Core..!= "qpxexpress#cityData")
                     Core.<*> (o Core..:? "name"))
...
newData 
    ::  Data'
newData
  = Data'{aircraft = Core.Nothing, airport = Core.Nothing,
          carrier = Core.Nothing, city = Core.Nothing,
          kind = "qpxexpress#data", tax = Core.Nothing}
instance Core.FromJSON Data' where
        parseJSON
          = Core.withObject "Data'"
              (\ o ->
                 Data' Core.<$>
                   (o Core..:? "aircraft") Core.<*> (o Core..:? "airport") Core.<*>
                     (o Core..:? "carrier")
                     Core.<*> (o Core..:? "city")
          ...
          = Core.object
              (Core.catMaybes
                 [("aircraft" Core..=) Core.<$> aircraft,
                  ...
                  ("city" Core..=) Core.<$> city, Core.Just ("kind" Core..= kind),
                  ("tax" Core..=) Core.<$> tax])
...
newFareInfo 
    ::  FareInfo
newFareInfo
  = FareInfo{basisCode = Core.Nothing, carrier = Core.Nothing,
             destination = Core.Nothing, id = Core.Nothing,
             kind = "qpxexpress#fareInfo", origin = Core.Nothing,
             private = Core.Nothing}
instance Core.FromJSON FareInfo where
        parseJSON
          = Core.withObject "FareInfo"
              (\ o ->
                 FareInfo Core.<$>
                   (o Core..:? "basisCode") Core.<*> (o Core..:? "carrier") Core.<*>
                     (o Core..:? "destination")
                     Core.<*> (o Core..:? "id")
...
instance Core.FromJSON FlightInfo where
        parseJSON
          = Core.withObject "FlightInfo"
              (\ o ->
                 FlightInfo Core.<$>
                   (o Core..:? "carrier") Core.<*> (o Core..:? "number"))
...
newFreeBaggageAllowance 
    ::  FreeBaggageAllowance
newFreeBaggageAllowance
  = FreeBaggageAllowance{bagDescriptor = Core.Nothing,
                         kilos = Core.Nothing, kilosPerPiece = Core.Nothing,
                         kind = "qpxexpress#freeBaggageAllowance", pieces = Core.Nothing,
                         pounds = Core.Nothing}
instance Core.FromJSON FreeBaggageAllowance where
        parseJSON
          = Core.withObject "FreeBaggageAllowance"
              (\ o ->
                 FreeBaggageAllowance Core.<$>
                   (o Core..:? "bagDescriptor") Core.<*> (o Core..:? "kilos") Core.<*>
                     (o Core..:? "kilosPerPiece")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "qpxexpress#freeBaggageAllowance")
                     Core.<*> (o Core..:? "pieces")
                     Core.<*> (o Core..:? "pounds"))
...
newLegInfo 
    ::  LegInfo
newLegInfo
  = LegInfo{aircraft = Core.Nothing, arrivalTime = Core.Nothing,
            changePlane = Core.Nothing, connectionDuration = Core.Nothing,
            departureTime = Core.Nothing, destination = Core.Nothing,
            destinationTerminal = Core.Nothing, duration = Core.Nothing,
            id = Core.Nothing, kind = "qpxexpress#legInfo",
            meal = Core.Nothing, mileage = Core.Nothing,
            onTimePerformance = Core.Nothing,
            operatingDisclosure = Core.Nothing, origin = Core.Nothing,
            originTerminal = Core.Nothing, secure = Core.Nothing}
instance Core.FromJSON LegInfo where
        parseJSON
          = Core.withObject "LegInfo"
              (\ o ->
                 LegInfo Core.<$>
                   (o Core..:? "aircraft") Core.<*> (o Core..:? "arrivalTime")
          ...
          = Core.object
              (Core.catMaybes
                 [("aircraft" Core..=) Core.<$> aircraft,
                  ...
                  ("duration" Core..=) Core.<$> duration, ("id" Core..=) Core.<$> id,
                  Core.Just ("kind" Core..= kind), ("meal" Core..=) Core.<$> meal,
...
newPassengerCounts 
    ::  PassengerCounts
newPassengerCounts
  = PassengerCounts{adultCount = Core.Nothing,
                    childCount = Core.Nothing, infantInLapCount = Core.Nothing,
                    infantInSeatCount = Core.Nothing,
                    kind = "qpxexpress#passengerCounts", seniorCount = Core.Nothing}
instance Core.FromJSON PassengerCounts where
        parseJSON
          = Core.withObject "PassengerCounts"
              (\ o ->
                 PassengerCounts Core.<$>
                   (o Core..:? "adultCount") Core.<*> (o Core..:? "childCount")
...
newPricingInfo 
    ::  PricingInfo
newPricingInfo
  = PricingInfo{baseFareTotal = Core.Nothing, fare = Core.Nothing,
                fareCalculation = Core.Nothing, kind = "qpxexpress#pricingInfo",
                latestTicketingTime = Core.Nothing, passengers = Core.Nothing,
                ptc = Core.Nothing, refundable = Core.Nothing,
                saleFareTotal = Core.Nothing, saleTaxTotal = Core.Nothing,
                saleTotal = Core.Nothing, segmentPricing = Core.Nothing,
                tax = Core.Nothing}
instance Core.FromJSON PricingInfo where
        parseJSON
          = Core.withObject "PricingInfo"
              (\ o ->
                 PricingInfo Core.<$>
                   (o Core..:? "baseFareTotal") Core.<*> (o Core..:? "fare") Core.<*>
                     (o Core..:? "fareCalculation")
...
newSegmentInfo 
    ::  SegmentInfo
newSegmentInfo
  = SegmentInfo{bookingCode = Core.Nothing,
                bookingCodeCount = Core.Nothing, cabin = Core.Nothing,
                connectionDuration = Core.Nothing, duration = Core.Nothing,
                flight = Core.Nothing, id = Core.Nothing,
                kind = "qpxexpress#segmentInfo", leg = Core.Nothing,
                marriedSegmentGroup = Core.Nothing,
                subjectToGovernmentApproval = Core.Nothing}
instance Core.FromJSON SegmentInfo where
        parseJSON
          = Core.withObject "SegmentInfo"
              (\ o ->
                 SegmentInfo Core.<$>
                   (o Core..:? "bookingCode") Core.<*> (o Core..:? "bookingCodeCount")
                     Core.<*> (o Core..:? "cabin")
                     Core.<*> (o Core..:? "connectionDuration")
                     Core.<*> (o Core..:? "duration")
                     Core.<*> (o Core..:? "flight")
          ...
          = Core.object
              (Core.catMaybes
                 [("bookingCode" Core..=) Core.<$> bookingCode,
                  ...
                  ("flight" Core..=) Core.<$> flight, ("id" Core..=) Core.<$> id,
                  Core.Just ("kind" Core..= kind), ("leg" Core..=) Core.<$> leg,
                  ("marriedSegmentGroup" Core..=) Core.<$> marriedSegmentGroup,
                  ("subjectToGovernmentApproval" Core..=) Core.<$>
...
newSegmentPricing 
    ::  SegmentPricing
newSegmentPricing
  = SegmentPricing{fareId = Core.Nothing,
                   freeBaggageOption = Core.Nothing,
                   kind = "qpxexpress#segmentPricing", segmentId = Core.Nothing}
instance Core.FromJSON SegmentPricing where
        parseJSON
          = Core.withObject "SegmentPricing"
              (\ o ->
                 SegmentPricing Core.<$>
                   (o Core..:? "fareId") Core.<*> (o Core..:? "freeBaggageOption")
...
newSliceInfo 
    ::  SliceInfo
newSliceInfo
  = SliceInfo{duration = Core.Nothing, kind = "qpxexpress#sliceInfo",
              segment = Core.Nothing}
instance Core.FromJSON SliceInfo where
        parseJSON
          = Core.withObject "SliceInfo"
              (\ o ->
                 SliceInfo Core.<$>
                   (o Core..:? "duration") Core.<*>
                     (o Core..:? "kind" Core..!= "qpxexpress#sliceInfo")
                     Core.<*> (o Core..:? "segment"))
...
newSliceInput 
    ::  SliceInput
newSliceInput
  = SliceInput{alliance = Core.Nothing, date = Core.Nothing,
               destination = Core.Nothing, kind = "qpxexpress#sliceInput",
               maxConnectionDuration = Core.Nothing, maxStops = Core.Nothing,
               origin = Core.Nothing, permittedCarrier = Core.Nothing,
               permittedDepartureTime = Core.Nothing,
               preferredCabin = Core.Nothing, prohibitedCarrier = Core.Nothing}
instance Core.FromJSON SliceInput where
        parseJSON
          = Core.withObject "SliceInput"
              (\ o ->
                 SliceInput Core.<$>
                   (o Core..:? "alliance") Core.<*> (o Core..:? "date") Core.<*>
                     (o Core..:? "destination")
...
newTaxData 
    ::  TaxData
newTaxData
  = TaxData{id = Core.Nothing, kind = "qpxexpress#taxData",
            name = Core.Nothing}
instance Core.FromJSON TaxData where
        parseJSON
          = Core.withObject "TaxData"
              (\ o ->
                 TaxData Core.<$>
                   (o Core..:? "id") Core.<*>
                     (o Core..:? "kind" Core..!= "qpxexpress#taxData")
                     Core.<*> (o Core..:? "name"))
...
newTaxInfo 
    ::  TaxInfo
newTaxInfo
  = TaxInfo{chargeType = Core.Nothing, code = Core.Nothing,
            country = Core.Nothing, id = Core.Nothing,
            kind = "qpxexpress#taxInfo", salePrice = Core.Nothing}
instance Core.FromJSON TaxInfo where
        parseJSON
          = Core.withObject "TaxInfo"
              (\ o ->
                 TaxInfo Core.<$>
                   (o Core..:? "chargeType") Core.<*> (o Core..:? "code") Core.<*>
                     (o Core..:? "country")
                     Core.<*> (o Core..:? "id")
          ...
          = Core.object
              (Core.catMaybes
                 [("chargeType" Core..=) Core.<$> chargeType,
                  ("code" Core..=) Core.<$> code,
                  ("country" Core..=) Core.<$> country, ("id" Core..=) Core.<$> id,
                  Core.Just ("kind" Core..= kind),
...
newTimeOfDayRange 
    ::  TimeOfDayRange
newTimeOfDayRange
  = TimeOfDayRange{earliestTime = Core.Nothing,
                   kind = "qpxexpress#timeOfDayRange", latestTime = Core.Nothing}
instance Core.FromJSON TimeOfDayRange where
        parseJSON
          = Core.withObject "TimeOfDayRange"
              (\ o ->
                 TimeOfDayRange Core.<$>
                   (o Core..:? "earliestTime") Core.<*>
                     (o Core..:? "kind" Core..!= "qpxexpress#timeOfDayRange")
...
newTripOption 
    ::  TripOption
newTripOption
  = TripOption{id = Core.Nothing, kind = "qpxexpress#tripOption",
               pricing = Core.Nothing, saleTotal = Core.Nothing,
               slice = Core.Nothing}
instance Core.FromJSON TripOption where
        parseJSON
          = Core.withObject "TripOption"
              (\ o ->
                 TripOption Core.<$>
                   (o Core..:? "id") Core.<*>
                     (o Core..:? "kind" Core..!= "qpxexpress#tripOption")
                     Core.<*> (o Core..:? "pricing")
                     Core.<*> (o Core..:? "saleTotal")
                     Core.<*> (o Core..:? "slice"))
...
newTripOptionsRequest 
    ::  TripOptionsRequest
newTripOptionsRequest
  = TripOptionsRequest{maxPrice = Core.Nothing,
                       passengers = Core.Nothing, refundable = Core.Nothing,
                       saleCountry = Core.Nothing, slice = Core.Nothing,
                       solutions = Core.Nothing, ticketingCountry = Core.Nothing}
instance Core.FromJSON TripOptionsRequest where
        parseJSON
          = Core.withObject "TripOptionsRequest"
              (\ o ->
                 TripOptionsRequest Core.<$>
                   (o Core..:? "maxPrice") Core.<*> (o Core..:? "passengers") Core.<*>
                     (o Core..:? "refundable")
...
newTripOptionsResponse 
    ::  TripOptionsResponse
newTripOptionsResponse
  = TripOptionsResponse{data' = Core.Nothing,
                        kind = "qpxexpress#tripOptions", requestId = Core.Nothing,
                        tripOption = Core.Nothing}
instance Core.FromJSON TripOptionsResponse where
        parseJSON
          = Core.withObject "TripOptionsResponse"
              (\ o ->
                 TripOptionsResponse Core.<$>
                   (o Core..:? "data") Core.<*>
                     (o Core..:? "kind" Core..!= "qpxexpress#tripOptions")
...
instance Core.FromJSON TripsSearchRequest where
        parseJSON
          = Core.withObject "TripsSearchRequest"
...
newTripsSearchResponse 
    ::  TripsSearchResponse
newTripsSearchResponse
  = TripsSearchResponse{kind = "qpxExpress#tripsSearch",
                        trips = Core.Nothing}
instance Core.FromJSON TripsSearchResponse where
        parseJSON
          = Core.withObject "TripsSearchResponse"
              (\ o ->
                 TripsSearchResponse Core.<$>
                   (o Core..:? "kind" Core..!= "qpxExpress#tripsSearch") Core.<*>
                     (o Core..:? "trips"))
