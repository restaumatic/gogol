...
newRedisProjectsLocationsInstancesPatch name payload
  = RedisProjectsLocationsInstancesPatch{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         name = name, payload = payload, updateMask = Core.Nothing,
                                         uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest RedisProjectsLocationsInstancesPatch
         where
        type Rs RedisProjectsLocationsInstancesPatch = Operation
        type Scopes RedisProjectsLocationsInstancesPatch =
             '[CloudPlatform'FullControl]
        requestClient RedisProjectsLocationsInstancesPatch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy RedisProjectsLocationsInstancesPatchResource)
                      Core.mempty
