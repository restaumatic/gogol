                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] ListBackupCollectionsResponse
...
newRedisProjectsLocationsBackupCollectionsList 
    :: 
                                               Core.Text
       -- ^  Required. The resource name of the backupCollection location using the form: @projects\/{project_id}\/locations\/{location_id}@ where @location_id@ refers to a Google Cloud region. See 'parent'.
    -> RedisProjectsLocationsBackupCollectionsList
newRedisProjectsLocationsBackupCollectionsList parent
  = RedisProjectsLocationsBackupCollectionsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           RedisProjectsLocationsBackupCollectionsList
         where
        type Rs RedisProjectsLocationsBackupCollectionsList =
             ListBackupCollectionsResponse
        type Scopes RedisProjectsLocationsBackupCollectionsList =
