...
newRedisProjectsLocationsOperationsList name
  = RedisProjectsLocationsOperationsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest RedisProjectsLocationsOperationsList
         where
        type Rs RedisProjectsLocationsOperationsList =
             ListOperationsResponse
        type Scopes RedisProjectsLocationsOperationsList =
             '[CloudPlatform'FullControl]
        requestClient RedisProjectsLocationsOperationsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy RedisProjectsLocationsOperationsListResource)
                      Core.mempty
