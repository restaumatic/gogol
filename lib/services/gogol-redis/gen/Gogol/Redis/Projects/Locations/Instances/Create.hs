...
newRedisProjectsLocationsInstancesCreate parent payload
  = RedisProjectsLocationsInstancesCreate{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          instanceId = Core.Nothing, parent = parent,
                                          payload = payload, uploadType = Core.Nothing,
                                          uploadProtocol = Core.Nothing}
instance Core.GoogleRequest RedisProjectsLocationsInstancesCreate
         where
        type Rs RedisProjectsLocationsInstancesCreate = Operation
        type Scopes RedisProjectsLocationsInstancesCreate =
             '[CloudPlatform'FullControl]
        requestClient RedisProjectsLocationsInstancesCreate{..}
          = go parent xgafv accessToken callback instanceId uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy RedisProjectsLocationsInstancesCreateResource)
                      Core.mempty
