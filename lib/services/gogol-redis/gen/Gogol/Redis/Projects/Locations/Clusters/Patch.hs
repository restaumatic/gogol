...
newRedisProjectsLocationsClustersPatch name payload
  = RedisProjectsLocationsClustersPatch{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        name = name, payload = payload, requestId = Core.Nothing,
                                        updateMask = Core.Nothing, uploadType = Core.Nothing,
                                        uploadProtocol = Core.Nothing}
instance Core.GoogleRequest RedisProjectsLocationsClustersPatch
         where
        type Rs RedisProjectsLocationsClustersPatch = Operation
        type Scopes RedisProjectsLocationsClustersPatch =
             '[CloudPlatform'FullControl]
        requestClient RedisProjectsLocationsClustersPatch{..}
          = go name xgafv accessToken callback requestId updateMask
              uploadType
              uploadProtocol
