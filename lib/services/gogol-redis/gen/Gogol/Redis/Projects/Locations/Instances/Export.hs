               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] ExportInstanceRequest Core.:>
...
newRedisProjectsLocationsInstancesExport name payload
  = RedisProjectsLocationsInstancesExport{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          name = name, payload = payload, uploadType = Core.Nothing,
                                          uploadProtocol = Core.Nothing}
instance Core.GoogleRequest RedisProjectsLocationsInstancesExport
         where
        type Rs RedisProjectsLocationsInstancesExport = Operation
        type Scopes RedisProjectsLocationsInstancesExport =
             '[CloudPlatform'FullControl]
        requestClient RedisProjectsLocationsInstancesExport{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy RedisProjectsLocationsInstancesExportResource)
                      Core.mempty
