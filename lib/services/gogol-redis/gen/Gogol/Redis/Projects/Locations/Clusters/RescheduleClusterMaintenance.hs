...
type RedisProjectsLocationsClustersRescheduleClusterMaintenanceResource
     =
     "v1" Core.:>
       Core.CaptureMode "name" "rescheduleClusterMaintenance" Core.Text
         Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] RescheduleClusterMaintenanceRequest
...
newRedisProjectsLocationsClustersRescheduleClusterMaintenance 
    :: 
                                                              Core.Text
       -- ^  Required. Redis Cluster instance resource name using the form: @projects\/{project_id}\/locations\/{location_id}\/clusters\/{cluster_id}@ where @location_id@ refers to a Google Cloud region. See 'name'.
    -> RescheduleClusterMaintenanceRequest
       -- ^  Multipart request metadata. See 'payload'.
    -> RedisProjectsLocationsClustersRescheduleClusterMaintenance
newRedisProjectsLocationsClustersRescheduleClusterMaintenance name
  payload
  = RedisProjectsLocationsClustersRescheduleClusterMaintenance{xgafv
                                                                 = Core.Nothing,
...
instance Core.GoogleRequest
           RedisProjectsLocationsClustersRescheduleClusterMaintenance
         where
        type Rs RedisProjectsLocationsClustersRescheduleClusterMaintenance
             = Operation
        type Scopes
               RedisProjectsLocationsClustersRescheduleClusterMaintenance
