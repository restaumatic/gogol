...
newRedisProjectsLocationsInstancesGet name
  = RedisProjectsLocationsInstancesGet{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       name = name, uploadType = Core.Nothing,
                                       uploadProtocol = Core.Nothing}
instance Core.GoogleRequest RedisProjectsLocationsInstancesGet
         where
        ...
        requestClient RedisProjectsLocationsInstancesGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy RedisProjectsLocationsInstancesGetResource)
                      Core.mempty
