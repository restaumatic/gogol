               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] ExportBackupRequest Core.:>
...
newRedisProjectsLocationsBackupCollectionsBackupsExport 
    ...
    -> RedisProjectsLocationsBackupCollectionsBackupsExport
newRedisProjectsLocationsBackupCollectionsBackupsExport name
  payload
  = RedisProjectsLocationsBackupCollectionsBackupsExport{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           RedisProjectsLocationsBackupCollectionsBackupsExport
         where
        type Rs RedisProjectsLocationsBackupCollectionsBackupsExport =
             Operation
        type Scopes RedisProjectsLocationsBackupCollectionsBackupsExport =
