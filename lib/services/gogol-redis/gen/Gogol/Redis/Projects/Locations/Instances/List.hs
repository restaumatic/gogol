...
newRedisProjectsLocationsInstancesList parent
  = RedisProjectsLocationsInstancesList{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        pageSize = Core.Nothing, pageToken = Core.Nothing,
                                        parent = parent, uploadType = Core.Nothing,
                                        uploadProtocol = Core.Nothing}
instance Core.GoogleRequest RedisProjectsLocationsInstancesList
         where
        type Rs RedisProjectsLocationsInstancesList = ListInstancesResponse
        ...
        requestClient RedisProjectsLocationsInstancesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy RedisProjectsLocationsInstancesListResource)
                      Core.mempty
