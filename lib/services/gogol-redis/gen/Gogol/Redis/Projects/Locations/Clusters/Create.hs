...
newRedisProjectsLocationsClustersCreate 
    :: 
                                        Core.Text
       -- ^  Required. The resource name of the cluster location using the form: @projects\/{project_id}\/locations\/{location_id}@ where @location_id@ refers to a Google Cloud region. See 'parent'.
    -> Cluster
       -- ^  Multipart request metadata. See 'payload'.
    -> RedisProjectsLocationsClustersCreate
newRedisProjectsLocationsClustersCreate parent payload
  = RedisProjectsLocationsClustersCreate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest RedisProjectsLocationsClustersCreate
         where
        type Rs RedisProjectsLocationsClustersCreate = Operation
        type Scopes RedisProjectsLocationsClustersCreate =
             '[CloudPlatform'FullControl]
        requestClient RedisProjectsLocationsClustersCreate{..}
          = go parent xgafv accessToken callback clusterId requestId
              uploadType
              uploadProtocol
