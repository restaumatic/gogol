...
newRedisProjectsLocationsClustersGetCertificateAuthority 
    :: 
                                                         Core.Text
       -- ^  Required. Redis cluster certificate authority resource name using the form: @projects\/{project_id}\/locations\/{location_id}\/clusters\/{cluster_id}\/certificateAuthority@ where @location_id@ refers to a Google Cloud region. See 'name'.
    -> RedisProjectsLocationsClustersGetCertificateAuthority
newRedisProjectsLocationsClustersGetCertificateAuthority name
  = RedisProjectsLocationsClustersGetCertificateAuthority{xgafv =
                                                            Core.Nothing,
...
instance Core.GoogleRequest
           RedisProjectsLocationsClustersGetCertificateAuthority
         where
        type Rs RedisProjectsLocationsClustersGetCertificateAuthority =
             CertificateAuthority
        type Scopes RedisProjectsLocationsClustersGetCertificateAuthority =
