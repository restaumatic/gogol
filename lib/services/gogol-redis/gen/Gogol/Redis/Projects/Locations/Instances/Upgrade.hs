...
type RedisProjectsLocationsInstancesUpgradeResource =
     "v1" Core.:>
       Core.CaptureMode "name" "upgrade" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] UpgradeInstanceRequest Core.:>
...
newRedisProjectsLocationsInstancesUpgrade name payload
  = RedisProjectsLocationsInstancesUpgrade{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           name = name, payload = payload,
                                           uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest RedisProjectsLocationsInstancesUpgrade
         where
        type Rs RedisProjectsLocationsInstancesUpgrade = Operation
        type Scopes RedisProjectsLocationsInstancesUpgrade =
