...
newRedisProjectsLocationsClustersDelete name
  = RedisProjectsLocationsClustersDelete{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         name = name, requestId = Core.Nothing,
                                         uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest RedisProjectsLocationsClustersDelete
         where
        ...
        requestClient RedisProjectsLocationsClustersDelete{..}
          = go name xgafv accessToken callback requestId uploadType
              uploadProtocol
