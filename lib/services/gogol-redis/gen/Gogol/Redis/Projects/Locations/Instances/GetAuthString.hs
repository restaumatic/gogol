                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.Get '[Core.JSON] InstanceAuthString
...
newRedisProjectsLocationsInstancesGetAuthString name
  = RedisProjectsLocationsInstancesGetAuthString{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
           RedisProjectsLocationsInstancesGetAuthString
         where
        type Rs RedisProjectsLocationsInstancesGetAuthString =
             InstanceAuthString
        type Scopes RedisProjectsLocationsInstancesGetAuthString =
             '[CloudPlatform'FullControl]
        requestClient RedisProjectsLocationsInstancesGetAuthString{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy RedisProjectsLocationsInstancesGetAuthStringResource)
                      Core.mempty
