               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] ImportInstanceRequest Core.:>
...
newRedisProjectsLocationsInstancesImport name payload
  = RedisProjectsLocationsInstancesImport{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          name = name, payload = payload, uploadType = Core.Nothing,
                                          uploadProtocol = Core.Nothing}
instance Core.GoogleRequest RedisProjectsLocationsInstancesImport
         where
        type Rs RedisProjectsLocationsInstancesImport = Operation
        type Scopes RedisProjectsLocationsInstancesImport =
             '[CloudPlatform'FullControl]
        requestClient RedisProjectsLocationsInstancesImport{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy RedisProjectsLocationsInstancesImportResource)
                      Core.mempty
