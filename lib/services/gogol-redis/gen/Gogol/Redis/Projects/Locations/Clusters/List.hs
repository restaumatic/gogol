...
newRedisProjectsLocationsClustersList parent
  = RedisProjectsLocationsClustersList{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       pageSize = Core.Nothing, pageToken = Core.Nothing,
                                       parent = parent, uploadType = Core.Nothing,
                                       uploadProtocol = Core.Nothing}
instance Core.GoogleRequest RedisProjectsLocationsClustersList
         where
        type Rs RedisProjectsLocationsClustersList = ListClustersResponse
        type Scopes RedisProjectsLocationsClustersList =
