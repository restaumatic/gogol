...
newRedisProjectsLocationsBackupCollectionsBackupsList parent
  = RedisProjectsLocationsBackupCollectionsBackupsList{xgafv =
                                                         Core.Nothing,
...
instance Core.GoogleRequest
           RedisProjectsLocationsBackupCollectionsBackupsList
         where
        type Rs RedisProjectsLocationsBackupCollectionsBackupsList =
             ListBackupsResponse
        type Scopes RedisProjectsLocationsBackupCollectionsBackupsList =
