...
newRedisProjectsLocationsOperationsGet name
  = RedisProjectsLocationsOperationsGet{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        name = name, uploadType = Core.Nothing,
                                        uploadProtocol = Core.Nothing}
instance Core.GoogleRequest RedisProjectsLocationsOperationsGet
         where
        type Rs RedisProjectsLocationsOperationsGet = Operation
        type Scopes RedisProjectsLocationsOperationsGet =
        ...
        requestClient RedisProjectsLocationsOperationsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy RedisProjectsLocationsOperationsGetResource)
                      Core.mempty
