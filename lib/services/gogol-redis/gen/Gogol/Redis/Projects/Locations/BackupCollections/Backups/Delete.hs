...
newRedisProjectsLocationsBackupCollectionsBackupsDelete name
  = RedisProjectsLocationsBackupCollectionsBackupsDelete{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           RedisProjectsLocationsBackupCollectionsBackupsDelete
         where
        type Rs RedisProjectsLocationsBackupCollectionsBackupsDelete =
             Operation
        type Scopes RedisProjectsLocationsBackupCollectionsBackupsDelete =
