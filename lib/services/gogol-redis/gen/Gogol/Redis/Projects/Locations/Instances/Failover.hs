...
type RedisProjectsLocationsInstancesFailoverResource =
     "v1" Core.:>
       Core.CaptureMode "name" "failover" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] FailoverInstanceRequest Core.:>
...
newRedisProjectsLocationsInstancesFailover name payload
  = RedisProjectsLocationsInstancesFailover{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            name = name, payload = payload,
                                            uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest RedisProjectsLocationsInstancesFailover
         where
        type Rs RedisProjectsLocationsInstancesFailover = Operation
        type Scopes RedisProjectsLocationsInstancesFailover =
             '[CloudPlatform'FullControl]
        requestClient RedisProjectsLocationsInstancesFailover{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy RedisProjectsLocationsInstancesFailoverResource)
                      Core.mempty
