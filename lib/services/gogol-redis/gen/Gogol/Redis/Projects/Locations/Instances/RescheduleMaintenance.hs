...
type RedisProjectsLocationsInstancesRescheduleMaintenanceResource =
     "v1" Core.:>
       Core.CaptureMode "name" "rescheduleMaintenance" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] RescheduleMaintenanceRequest Core.:>
...
newRedisProjectsLocationsInstancesRescheduleMaintenance 
    ...
    -> RedisProjectsLocationsInstancesRescheduleMaintenance
newRedisProjectsLocationsInstancesRescheduleMaintenance name
  payload
  = RedisProjectsLocationsInstancesRescheduleMaintenance{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           RedisProjectsLocationsInstancesRescheduleMaintenance
         where
        type Rs RedisProjectsLocationsInstancesRescheduleMaintenance =
             Operation
        type Scopes RedisProjectsLocationsInstancesRescheduleMaintenance =
