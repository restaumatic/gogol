...
newRedisProjectsLocationsOperationsDelete name
  = RedisProjectsLocationsOperationsDelete{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           name = name, uploadType = Core.Nothing,
                                           uploadProtocol = Core.Nothing}
instance Core.GoogleRequest RedisProjectsLocationsOperationsDelete
         where
        type Rs RedisProjectsLocationsOperationsDelete = Empty
        type Scopes RedisProjectsLocationsOperationsDelete =
             '[CloudPlatform'FullControl]
        requestClient RedisProjectsLocationsOperationsDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy RedisProjectsLocationsOperationsDeleteResource)
                      Core.mempty
