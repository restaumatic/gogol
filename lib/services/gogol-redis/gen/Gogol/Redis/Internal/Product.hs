...
newBackupCollection
  = BackupCollection{cluster = Core.Nothing,
                     ...
                     kmsKey = Core.Nothing, lastBackupTime = Core.Nothing,
                     name = Core.Nothing, totalBackupCount = Core.Nothing,
                     totalBackupSizeBytes = Core.Nothing, uid = Core.Nothing}
              ...
              (\ o ->
                 BackupCollection Core.<$>
                   (o Core..:? "cluster") Core.<*> (o Core..:? "clusterUid") Core.<*>
                     (o Core..:? "createTime")
                     Core.<*> (o Core..:? "kmsKey")
                     Core.<*> (o Core..:? "lastBackupTime")
                     Core.<*> (o Core..:? "name")
                     Core.<*>
                     (o Core..:? "totalBackupCount" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "totalBackupSizeBytes" Core.<&>
          ...
          = Core.object
              (Core.catMaybes
                 [("cluster" Core..=) Core.<$> cluster,
                  ...
                  ("lastBackupTime" Core..=) Core.<$> lastBackupTime,
                  ("name" Core..=) Core.<$> name,
                  ("totalBackupCount" Core..=) Core.. Core.AsText Core.<$>
                    totalBackupCount,
                  ("totalBackupSizeBytes" Core..=) Core.. Core.AsText Core.<$>
...
--
-- /See:/ 'newBackupDRConfiguration' smart constructor.
newtype BackupDRConfiguration = BackupDRConfiguration
    {
      -- | Indicates if the resource is managed by BackupDR.
      backupdrManaged :: (Core.Maybe Core.Bool)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'BackupDRConfiguration' with the minimum fields required to make a request.
newBackupDRConfiguration 
    ::  BackupDRConfiguration
newBackupDRConfiguration
  = BackupDRConfiguration{backupdrManaged = Core.Nothing}
instance Core.FromJSON BackupDRConfiguration where
        parseJSON
          = Core.withObject "BackupDRConfiguration"
              (\ o ->
                 BackupDRConfiguration Core.<$> (o Core..:? "backupdrManaged"))

instance Core.ToJSON BackupDRConfiguration where
        toJSON BackupDRConfiguration{..}
          = Core.object
              (Core.catMaybes
                 [("backupdrManaged" Core..=) Core.<$> backupdrManaged])


-- | BackupDRMetadata contains information about the backup and disaster recovery metadata of a database resource.
--
-- /See:/ 'newBackupDRMetadata' smart constructor.
data BackupDRMetadata = BackupDRMetadata
    {
    ...
    , backupdrConfiguration :: (Core.Maybe BackupDRConfiguration)
...
-- | Creates a value of 'BackupDRMetadata' with the minimum fields required to make a request.
newBackupDRMetadata 
    ::  BackupDRMetadata
newBackupDRMetadata
  = BackupDRMetadata{backupConfiguration = Core.Nothing,
                     backupRun = Core.Nothing, backupdrConfiguration = Core.Nothing,
                     fullResourceName = Core.Nothing, lastRefreshTime = Core.Nothing,
                     resourceId = Core.Nothing}
instance Core.FromJSON BackupDRMetadata where
        parseJSON
          = Core.withObject "BackupDRMetadata"
              (\ o ->
                 BackupDRMetadata Core.<$>
                   (o Core..:? "backupConfiguration") Core.<*>
                     (o Core..:? "backupRun")
                     Core.<*> (o Core..:? "backupdrConfiguration")
                     Core.<*> (o Core..:? "fullResourceName")
                     Core.<*> (o Core..:? "lastRefreshTime")
                     Core.<*> (o Core..:? "resourceId"))

instance Core.ToJSON BackupDRMetadata where
        toJSON BackupDRMetadata{..}
          = Core.object
              (Core.catMaybes
                 [("backupConfiguration" Core..=) Core.<$> backupConfiguration,
                  ("backupRun" Core..=) Core.<$> backupRun,
                  ("backupdrConfiguration" Core..=) Core.<$> backupdrConfiguration,
...
data Cluster = Cluster
    {
      ...
      allowFewerZonesDeployment :: (Core.Maybe Core.Bool)
    ...
    , effectiveMaintenanceVersion :: (Core.Maybe Core.Text)
    ...
    , maintenanceSchedule :: (Core.Maybe ClusterMaintenanceSchedule)
      -- | Optional. This field can be used to trigger self service update to indicate the desired maintenance version. The input to this field can be determined by the available/maintenance/versions field.
...
newCluster 
    ::  Cluster
newCluster
  = Cluster{allowFewerZonesDeployment = Core.Nothing,
            ...
            effectiveMaintenanceVersion = Core.Nothing,
            encryptionInfo = Core.Nothing, gcsSource = Core.Nothing,
            kmsKey = Core.Nothing, labels = Core.Nothing,
            ...
            replicaCount = Core.Nothing, satisfiesPzi = Core.Nothing,
            satisfiesPzs = Core.Nothing, shardCount = Core.Nothing,
...
instance Core.FromJSON Cluster where
        parseJSON
          = Core.withObject "Cluster"
              (\ o ->
                 Cluster Core.<$>
                   (o Core..:? "allowFewerZonesDeployment") Core.<*>
                     (o Core..:? "asyncClusterEndpointsDeletionEnabled")
                     ...
                     Core.<*> (o Core..:? "effectiveMaintenanceVersion")
                     Core.<*> (o Core..:? "encryptionInfo")
...
instance Core.ToJSON Cluster where
        toJSON Cluster{..}
          = Core.object
              (Core.catMaybes
                 [("allowFewerZonesDeployment" Core..=) Core.<$>
                  ...
                  ("effectiveMaintenanceVersion" Core..=) Core.<$>
...
--
-- /See:/ 'newConfigBasedSignalData' smart constructor.
data ConfigBasedSignalData = ConfigBasedSignalData
    {
    ...
    , signalBoolValue :: (Core.Maybe Core.Bool)
      -- | Required. Signal type of the signal
    , signalType :: (Core.Maybe ConfigBasedSignalData_SignalType)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'ConfigBasedSignalData' with the minimum fields required to make a request.
newConfigBasedSignalData 
    ::  ConfigBasedSignalData
newConfigBasedSignalData
  = ConfigBasedSignalData{fullResourceName = Core.Nothing,
                          lastRefreshTime = Core.Nothing, resourceId = Core.Nothing,
                          signalBoolValue = Core.Nothing, signalType = Core.Nothing}
instance Core.FromJSON ConfigBasedSignalData where
        parseJSON
          = Core.withObject "ConfigBasedSignalData"
              (\ o ->
                 ConfigBasedSignalData Core.<$>
                   (o Core..:? "fullResourceName") Core.<*>
                     (o Core..:? "lastRefreshTime")
                     Core.<*> (o Core..:? "resourceId")
                     Core.<*> (o Core..:? "signalBoolValue")
                     Core.<*> (o Core..:? "signalType"))

instance Core.ToJSON ConfigBasedSignalData where
        toJSON ConfigBasedSignalData{..}
          = Core.object
              (Core.catMaybes
                 [("fullResourceName" Core..=) Core.<$> fullResourceName,
                  ("lastRefreshTime" Core..=) Core.<$> lastRefreshTime,
                  ("resourceId" Core..=) Core.<$> resourceId,
                  ("signalBoolValue" Core..=) Core.<$> signalBoolValue,
...
data DatabaseResourceFeed = DatabaseResourceFeed
    {
      ...
      backupdrMetadata :: (Core.Maybe BackupDRMetadata)
    ...
    , configBasedSignalData :: (Core.Maybe ConfigBasedSignalData)
      -- | Database resource signal data is used to ingest signals from database resource signal feeds.
    , databaseResourceSignalData :: (Core.Maybe DatabaseResourceSignalData)
    ...
    , skipIngestion :: (Core.Maybe Core.Bool)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newDatabaseResourceFeed 
    ::  DatabaseResourceFeed
newDatabaseResourceFeed
  = DatabaseResourceFeed{backupdrMetadata = Core.Nothing,
                         configBasedSignalData = Core.Nothing,
                         databaseResourceSignalData = Core.Nothing,
                         feedTimestamp = Core.Nothing, feedType = Core.Nothing,
                         ...
                         resourceMetadata = Core.Nothing, skipIngestion = Core.Nothing}
instance Core.FromJSON DatabaseResourceFeed where
        parseJSON
          = Core.withObject "DatabaseResourceFeed"
              (\ o ->
                 DatabaseResourceFeed Core.<$>
                   (o Core..:? "backupdrMetadata") Core.<*>
                     (o Core..:? "configBasedSignalData")
                     Core.<*> (o Core..:? "databaseResourceSignalData")
                     ...
                     Core.<*> (o Core..:? "skipIngestion"))

instance Core.ToJSON DatabaseResourceFeed where
        toJSON DatabaseResourceFeed{..}
          = Core.object
              (Core.catMaybes
                 [("backupdrMetadata" Core..=) Core.<$> backupdrMetadata,
                  ("configBasedSignalData" Core..=) Core.<$> configBasedSignalData,
                  ("databaseResourceSignalData" Core..=) Core.<$>
                    databaseResourceSignalData,
                  ...
                  ("skipIngestion" Core..=) Core.<$> skipIngestion])
...
data DatabaseResourceMetadata = DatabaseResourceMetadata
    ...
    , maintenanceInfo :: (Core.Maybe ResourceMaintenanceInfo)
...
newDatabaseResourceMetadata
  = DatabaseResourceMetadata{availabilityConfiguration =
                             ...
                             backupdrConfiguration = Core.Nothing, creationTime = Core.Nothing,
                             currentState = Core.Nothing, customMetadata = Core.Nothing,
                             edition = Core.Nothing, entitlements = Core.Nothing,
                             expectedState = Core.Nothing, gcbdrConfiguration = Core.Nothing,
                             id = Core.Nothing, instanceType = Core.Nothing,
                             location = Core.Nothing, machineConfiguration = Core.Nothing,
                             maintenanceInfo = Core.Nothing, primaryResourceId = Core.Nothing,
          ...
          = Core.object
              (Core.catMaybes
                 [("availabilityConfiguration" Core..=) Core.<$>
                  ...
                  ("maintenanceInfo" Core..=) Core.<$> maintenanceInfo,
...
--
-- /See:/ 'newDatabaseResourceSignalData' smart constructor.
data DatabaseResourceSignalData = DatabaseResourceSignalData
    {
      -- | Required. Full Resource name of the source resource.
      fullResourceName :: (Core.Maybe Core.Text)
      -- | Required. Last time signal was refreshed
    ...
    , signalState :: (Core.Maybe DatabaseResourceSignalData_SignalState)
      -- | Required. Signal type of the signal
    , signalType :: (Core.Maybe DatabaseResourceSignalData_SignalType)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'DatabaseResourceSignalData' with the minimum fields required to make a request.
newDatabaseResourceSignalData 
    ::  DatabaseResourceSignalData
newDatabaseResourceSignalData
  = DatabaseResourceSignalData{fullResourceName = Core.Nothing,
                               lastRefreshTime = Core.Nothing, resourceId = Core.Nothing,
                               signalBoolValue = Core.Nothing, signalState = Core.Nothing,
                               signalType = Core.Nothing}
instance Core.FromJSON DatabaseResourceSignalData where
        parseJSON
          = Core.withObject "DatabaseResourceSignalData"
              (\ o ->
                 DatabaseResourceSignalData Core.<$>
                   (o Core..:? "fullResourceName") Core.<*>
                     (o Core..:? "lastRefreshTime")
                     Core.<*> (o Core..:? "resourceId")
                     Core.<*> (o Core..:? "signalBoolValue")
                     Core.<*> (o Core..:? "signalState")
                     Core.<*> (o Core..:? "signalType"))

instance Core.ToJSON DatabaseResourceSignalData where
        toJSON DatabaseResourceSignalData{..}
          = Core.object
              (Core.catMaybes
                 [("fullResourceName" Core..=) Core.<$> fullResourceName,
                  ("lastRefreshTime" Core..=) Core.<$> lastRefreshTime,
                  ("resourceId" Core..=) Core.<$> resourceId,
                  ("signalBoolValue" Core..=) Core.<$> signalBoolValue,
                  ("signalState" Core..=) Core.<$> signalState,
                  ("signalType" Core..=) Core.<$> signalType])
...
newProduct 
    ::  Product
newProduct
  = Product{engine = Core.Nothing, minorVersion = Core.Nothing,
...
instance Core.FromJSON Product where
        parseJSON
          = Core.withObject "Product"
              (\ o ->
                 Product Core.<$>
                   (o Core..:? "engine") Core.<*> (o Core..:? "minorVersion") Core.<*>
                     (o Core..:? "type")
                     Core.<*> (o Core..:? "version"))
...
--
-- /See:/ 'newResourceMaintenanceDenySchedule' smart constructor.
data ResourceMaintenanceDenySchedule = ResourceMaintenanceDenySchedule
    {
    ...
    , startDate :: (Core.Maybe Date)
      -- | Optional. Time in UTC when the deny period starts on start/date and ends on end/date.
    , time :: (Core.Maybe TimeOfDay')
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'ResourceMaintenanceDenySchedule' with the minimum fields required to make a request.
newResourceMaintenanceDenySchedule 
    :: 
                                   ResourceMaintenanceDenySchedule
newResourceMaintenanceDenySchedule
  = ResourceMaintenanceDenySchedule{endDate = Core.Nothing,
                                    startDate = Core.Nothing, time = Core.Nothing}
instance Core.FromJSON ResourceMaintenanceDenySchedule where
        parseJSON
          = Core.withObject "ResourceMaintenanceDenySchedule"
              (\ o ->
                 ResourceMaintenanceDenySchedule Core.<$>
                   (o Core..:? "endDate") Core.<*> (o Core..:? "startDate") Core.<*>
                     (o Core..:? "time"))

instance Core.ToJSON ResourceMaintenanceDenySchedule where
        toJSON ResourceMaintenanceDenySchedule{..}
          = Core.object
              (Core.catMaybes
...
--
-- /See:/ 'newResourceMaintenanceInfo' smart constructor.
data ResourceMaintenanceInfo = ResourceMaintenanceInfo
    {
      -- | Optional. List of Deny maintenance period for the database resource.
      denyMaintenanceSchedules :: (Core.Maybe [ResourceMaintenanceDenySchedule])
      -- | Optional. Maintenance window for the database resource.
    , maintenanceSchedule :: (Core.Maybe ResourceMaintenanceSchedule)
      -- | Optional. Current Maintenance version of the database resource. Example: \"MYSQL/8/0/41.R20250531.01/15\"
    , maintenanceVersion :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'ResourceMaintenanceInfo' with the minimum fields required to make a request.
newResourceMaintenanceInfo 
    ::  ResourceMaintenanceInfo
newResourceMaintenanceInfo
  = ResourceMaintenanceInfo{denyMaintenanceSchedules = Core.Nothing,
                            maintenanceSchedule = Core.Nothing,
                            maintenanceVersion = Core.Nothing}
instance Core.FromJSON ResourceMaintenanceInfo where
        parseJSON
          = Core.withObject "ResourceMaintenanceInfo"
              (\ o ->
                 ResourceMaintenanceInfo Core.<$>
                   (o Core..:? "denyMaintenanceSchedules") Core.<*>
                     (o Core..:? "maintenanceSchedule")
                     Core.<*> (o Core..:? "maintenanceVersion"))

instance Core.ToJSON ResourceMaintenanceInfo where
        toJSON ResourceMaintenanceInfo{..}
          = Core.object
              (Core.catMaybes
                 [("denyMaintenanceSchedules" Core..=) Core.<$>
...
--
-- /See:/ 'newResourceMaintenanceSchedule' smart constructor.
data ResourceMaintenanceSchedule = ResourceMaintenanceSchedule
    {
      -- | Optional. Preferred day of the week for maintenance, e.g. MONDAY, TUESDAY, etc.
      day :: (Core.Maybe ResourceMaintenanceSchedule_Day)
    ...
    , phase :: (Core.Maybe ResourceMaintenanceSchedule_Phase)
      -- | Optional. Preferred time to start the maintenance operation on the specified day.
    , time :: (Core.Maybe TimeOfDay')
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'ResourceMaintenanceSchedule' with the minimum fields required to make a request.
newResourceMaintenanceSchedule 
    ::  ResourceMaintenanceSchedule
newResourceMaintenanceSchedule
  = ResourceMaintenanceSchedule{day = Core.Nothing,
                                phase = Core.Nothing, time = Core.Nothing}
instance Core.FromJSON ResourceMaintenanceSchedule where
        parseJSON
          = Core.withObject "ResourceMaintenanceSchedule"
              (\ o ->
                 ResourceMaintenanceSchedule Core.<$>
                   (o Core..:? "day") Core.<*> (o Core..:? "phase") Core.<*>
                     (o Core..:? "time"))

instance Core.ToJSON ResourceMaintenanceSchedule where
        toJSON ResourceMaintenanceSchedule{..}
          = Core.object
              (Core.catMaybes
                 [("day" Core..=) Core.<$> day, ("phase" Core..=) Core.<$> phase,
                  ("time" Core..=) Core.<$> time])
