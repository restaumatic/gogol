                           ...
                           Core.QueryParam "callback" Core.Text Core.:>
                             Core.QueryParam "maxResults" Core.Int32 Core.:>
                               Core.QueryParam "pageToken" Core.Text Core.:>
                                 Core.QueryParam "sortBy" ManagedZoneOperationsListSortBy Core.:>
                                   Core.QueryParam "uploadType" Core.Text Core.:>
                                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                                       Core.QueryParam "alt" Core.AltJSON Core.:>
                                         Core.Get '[Core.JSON] ManagedZoneOperationsListResponse
...
newDNSManagedZoneOperationsList managedZone project
  = DNSManagedZoneOperationsList{xgafv = Core.Nothing,
