...
newDNSManagedZoneOperationsGet managedZone operation project
  = DNSManagedZoneOperationsGet{xgafv = Core.Nothing,
                                accessToken = Core.Nothing, callback = Core.Nothing,
                                clientOperationId = Core.Nothing, location = "global",
                                managedZone = managedZone, operation = operation,
...
instance Core.GoogleRequest DNSManagedZoneOperationsGet where
        ...
        type Scopes DNSManagedZoneOperationsGet =
             '[CloudPlatform'FullControl, CloudPlatform'ReadOnly,
               Ndev'Clouddns'Readonly, Ndev'Clouddns'Readwrite]
        requestClient DNSManagedZoneOperationsGet{..}
          = go project location managedZone operation xgafv accessToken
              callback
              clientOperationId
              uploadType
              uploadProtocol
