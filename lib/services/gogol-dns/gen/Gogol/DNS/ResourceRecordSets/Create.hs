                                 ...
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.ReqBody '[Core.JSON] ResourceRecordSet Core.:>
                                       Core.Post '[Core.JSON] ResourceRecordSet
...
newDNSResourceRecordSetsCreate managedZone payload project
  = DNSResourceRecordSetsCreate{xgafv = Core.Nothing,
                                accessToken = Core.Nothing, callback = Core.Nothing,
                                clientOperationId = Core.Nothing, location = "global",
                                managedZone = managedZone, payload = payload, project = project,
...
instance Core.GoogleRequest DNSResourceRecordSetsCreate where
        ...
        type Scopes DNSResourceRecordSetsCreate =
