                                   ...
                                   Core.QueryParam "uploadType" Core.Text Core.:>
                                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                                       Core.QueryParam "alt" Core.AltJSON Core.:>
                                         Core.ReqBody '[Core.JSON] ResourceRecordSet Core.:>
                                           Core.Patch '[Core.JSON] ResourceRecordSet
...
newDNSResourceRecordSetsPatch 
    ...
    -> Core.Text
       -- ^  RRSet type. See 'type''.
    -> DNSResourceRecordSetsPatch
newDNSResourceRecordSetsPatch managedZone name payload project
  type'
  = DNSResourceRecordSetsPatch{xgafv = Core.Nothing,
                               accessToken = Core.Nothing, callback = Core.Nothing,
                               clientOperationId = Core.Nothing, location = "global",
                               managedZone = managedZone, name = name, payload = payload,
                               project = project, type' = type', uploadType = Core.Nothing,
                               uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DNSResourceRecordSetsPatch where
        type Rs DNSResourceRecordSetsPatch = ResourceRecordSet
        type Scopes DNSResourceRecordSetsPatch =
             '[CloudPlatform'FullControl, Ndev'Clouddns'Readwrite]
        requestClient DNSResourceRecordSetsPatch{..}
          = go project location managedZone name type' xgafv accessToken
              callback
              clientOperationId
              uploadType
              uploadProtocol
