                                     ...
                                     Core.QueryParam "uploadType" Core.Text Core.:>
                                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                                         Core.QueryParam "alt" Core.AltJSON Core.:>
                                           Core.Get '[Core.JSON] ResourceRecordSetsListResponse
...
newDNSResourceRecordSetsList managedZone project
  = DNSResourceRecordSetsList{xgafv = Core.Nothing,
                              accessToken = Core.Nothing, callback = Core.Nothing,
                              location = "global", managedZone = managedZone,
                              maxResults = Core.Nothing, name = Core.Nothing,
                              pageToken = Core.Nothing, project = project, type' = Core.Nothing,
...
instance Core.GoogleRequest DNSResourceRecordSetsList where
        ...
        type Scopes DNSResourceRecordSetsList =
