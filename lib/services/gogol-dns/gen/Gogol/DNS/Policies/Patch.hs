                               ...
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.ReqBody '[Core.JSON] Policy Core.:>
                                     Core.Patch '[Core.JSON] PoliciesPatchResponse
...
newDNSPoliciesPatch payload policy project
  = DNSPoliciesPatch{xgafv = Core.Nothing,
                     accessToken = Core.Nothing, callback = Core.Nothing,
                     clientOperationId = Core.Nothing, location = "global",
                     payload = payload, policy = policy, project = project,
...
instance Core.GoogleRequest DNSPoliciesPatch where
        ...
        type Scopes DNSPoliciesPatch =
             '[CloudPlatform'FullControl, Ndev'Clouddns'Readwrite]
        requestClient DNSPoliciesPatch{..}
          = go project location policy xgafv accessToken callback
              clientOperationId
              uploadType
              uploadProtocol
