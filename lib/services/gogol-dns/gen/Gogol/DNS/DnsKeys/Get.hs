               ...
               Core.Capture "location" Core.Text Core.:>
                 "managedZones" Core.:>
                   Core.Capture "managedZone" Core.Text Core.:>
                     "dnsKeys" Core.:>
                       Core.Capture "dnsKeyId" Core.Text Core.:>
                         Core.QueryParam "$.xgafv" Xgafv Core.:>
                           Core.QueryParam "access_token" Core.Text Core.:>
                             Core.QueryParam "callback" Core.Text Core.:>
                               Core.QueryParam "clientOperationId" Core.Text Core.:>
                                 Core.QueryParam "digestType" Core.Text Core.:>
                                   Core.QueryParam "uploadType" Core.Text Core.:>
                                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                                       Core.QueryParam "alt" Core.AltJSON Core.:>
                                         Core.Get '[Core.JSON] DnsKey
...
newDNSDnsKeysGet dnsKeyId managedZone project
  = DNSDnsKeysGet{xgafv = Core.Nothing, accessToken = Core.Nothing,
                  callback = Core.Nothing, clientOperationId = Core.Nothing,
                  digestType = Core.Nothing, dnsKeyId = dnsKeyId,
                  location = "global", managedZone = managedZone, project = project,
...
instance Core.GoogleRequest DNSDnsKeysGet where
        ...
        type Scopes DNSDnsKeysGet =
             '[CloudPlatform'FullControl, CloudPlatform'ReadOnly,
               Ndev'Clouddns'Readonly, Ndev'Clouddns'Readwrite]
        requestClient DNSDnsKeysGet{..}
          = go project location managedZone dnsKeyId xgafv accessToken
              callback
              clientOperationId
              digestType
              uploadType
              ...
              dNSService
          where go
                  = Core.buildClient (Core.Proxy :: Core.Proxy DNSDnsKeysGetResource)
                      Core.mempty
