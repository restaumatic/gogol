                                   ...
                                   Core.QueryParam "uploadType" Core.Text Core.:>
                                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                                       Core.QueryParam "alt" Core.AltJSON Core.:>
                                         Core.Get '[Core.JSON] DnsKeysListResponse
...
newDNSDnsKeysList managedZone project
  = DNSDnsKeysList{xgafv = Core.Nothing, accessToken = Core.Nothing,
                   callback = Core.Nothing, digestType = Core.Nothing,
                   location = "global", managedZone = managedZone,
