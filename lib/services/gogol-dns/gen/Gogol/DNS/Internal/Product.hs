...
newChange 
    ::  Change
newChange
  = Change{additions = Core.Nothing, deletions = Core.Nothing,
           id = Core.Nothing, isServing = Core.Nothing, kind = "dns#change",
...
instance Core.FromJSON Change where
        parseJSON
          = Core.withObject "Change"
              (\ o ->
                 Change Core.<$>
                   (o Core..:? "additions") Core.<*> (o Core..:? "deletions") Core.<*>
                     (o Core..:? "id")
...
newChangesListResponse 
    ::  ChangesListResponse
newChangesListResponse
  = ChangesListResponse{changes = Core.Nothing,
                        header = Core.Nothing, kind = "dns#changesListResponse",
                        nextPageToken = Core.Nothing}
instance Core.FromJSON ChangesListResponse where
        parseJSON
          = Core.withObject "ChangesListResponse"
              (\ o ->
                 ChangesListResponse Core.<$>
                   (o Core..:? "changes") Core.<*> (o Core..:? "header") Core.<*>
                     (o Core..:? "kind" Core..!= "dns#changesListResponse")
...
newDnsKey 
    ::  DnsKey
newDnsKey
  = DnsKey{algorithm = Core.Nothing, creationTime = Core.Nothing,
           description = Core.Nothing, digests = Core.Nothing,
           id = Core.Nothing, isActive = Core.Nothing,
           keyLength = Core.Nothing, keyTag = Core.Nothing,
           kind = "dns#dnsKey", publicKey = Core.Nothing,
           type' = Core.Nothing}
instance Core.FromJSON DnsKey where
        parseJSON
          = Core.withObject "DnsKey"
              (\ o ->
                 DnsKey Core.<$>
                   (o Core..:? "algorithm") Core.<*> (o Core..:? "creationTime")
          ...
          = Core.object
              (Core.catMaybes
                 [("algorithm" Core..=) Core.<$> algorithm,
                  ...
                  ("digests" Core..=) Core.<$> digests, ("id" Core..=) Core.<$> id,
...
instance Core.FromJSON DnsKeyDigest where
        parseJSON
          = Core.withObject "DnsKeyDigest"
              (\ o ->
                 DnsKeyDigest Core.<$>
                   (o Core..:? "digest") Core.<*> (o Core..:? "type"))
...
newDnsKeySpec 
    ::  DnsKeySpec
newDnsKeySpec
  = DnsKeySpec{algorithm = Core.Nothing, keyLength = Core.Nothing,
               keyType = Core.Nothing, kind = "dns#dnsKeySpec"}
instance Core.FromJSON DnsKeySpec where
        parseJSON
          = Core.withObject "DnsKeySpec"
              (\ o ->
                 DnsKeySpec Core.<$>
                   (o Core..:? "algorithm") Core.<*> (o Core..:? "keyLength") Core.<*>
                     (o Core..:? "keyType")
...
newDnsKeysListResponse 
    ::  DnsKeysListResponse
newDnsKeysListResponse
  = DnsKeysListResponse{dnsKeys = Core.Nothing,
                        header = Core.Nothing, kind = "dns#dnsKeysListResponse",
                        nextPageToken = Core.Nothing}
instance Core.FromJSON DnsKeysListResponse where
        parseJSON
          = Core.withObject "DnsKeysListResponse"
              (\ o ->
                 DnsKeysListResponse Core.<$>
                   (o Core..:? "dnsKeys") Core.<*> (o Core..:? "header") Core.<*>
                     (o Core..:? "kind" Core..!= "dns#dnsKeysListResponse")
                     Core.<*> (o Core..:? "nextPageToken"))
...
newManagedZone 
    ::  ManagedZone
newManagedZone
  = ManagedZone{cloudLoggingConfig = Core.Nothing,
                creationTime = Core.Nothing, description = Core.Nothing,
                dnsName = Core.Nothing, dnssecConfig = Core.Nothing,
                forwardingConfig = Core.Nothing, id = Core.Nothing,
                kind = "dns#managedZone", labels = Core.Nothing,
                name = Core.Nothing, nameServerSet = Core.Nothing,
                nameServers = Core.Nothing, peeringConfig = Core.Nothing,
                privateVisibilityConfig = Core.Nothing,
                reverseLookupConfig = Core.Nothing,
                serviceDirectoryConfig = Core.Nothing, visibility = Core.Nothing}
instance Core.FromJSON ManagedZone where
        parseJSON
          = Core.withObject "ManagedZone"
              (\ o ->
                 ManagedZone Core.<$>
                   (o Core..:? "cloudLoggingConfig") Core.<*>
                     (o Core..:? "creationTime")
                     Core.<*> (o Core..:? "description")
                     Core.<*> (o Core..:? "dnsName")
          ...
          = Core.object
              (Core.catMaybes
                 [("cloudLoggingConfig" Core..=) Core.<$> cloudLoggingConfig,
                  ...
                  ("privateVisibilityConfig" Core..=) Core.<$>
...
instance Core.FromJSON ManagedZone_Labels where
        parseJSON
          = Core.withObject "ManagedZone_Labels"
...
newManagedZoneCloudLoggingConfig 
    ::  ManagedZoneCloudLoggingConfig
newManagedZoneCloudLoggingConfig
  = ManagedZoneCloudLoggingConfig{enableLogging = Core.Nothing,
                                  kind = "dns#managedZoneCloudLoggingConfig"}
instance Core.FromJSON ManagedZoneCloudLoggingConfig where
        parseJSON
          = Core.withObject "ManagedZoneCloudLoggingConfig"
              (\ o ->
                 ManagedZoneCloudLoggingConfig Core.<$>
                   (o Core..:? "enableLogging") Core.<*>
                     (o Core..:? "kind" Core..!= "dns#managedZoneCloudLoggingConfig"))
...
newManagedZoneDnsSecConfig 
    ::  ManagedZoneDnsSecConfig
newManagedZoneDnsSecConfig
  = ManagedZoneDnsSecConfig{defaultKeySpecs = Core.Nothing,
                            kind = "dns#managedZoneDnsSecConfig", nonExistence = Core.Nothing,
                            state = Core.Nothing}
instance Core.FromJSON ManagedZoneDnsSecConfig where
        parseJSON
          = Core.withObject "ManagedZoneDnsSecConfig"
              (\ o ->
                 ManagedZoneDnsSecConfig Core.<$>
                   (o Core..:? "defaultKeySpecs") Core.<*>
                     (o Core..:? "kind" Core..!= "dns#managedZoneDnsSecConfig")
...
newManagedZoneForwardingConfig 
    ::  ManagedZoneForwardingConfig
newManagedZoneForwardingConfig
  = ManagedZoneForwardingConfig{kind =
                                  "dns#managedZoneForwardingConfig",
                                targetNameServers = Core.Nothing}
instance Core.FromJSON ManagedZoneForwardingConfig where
        parseJSON
          = Core.withObject "ManagedZoneForwardingConfig"
              (\ o ->
                 ManagedZoneForwardingConfig Core.<$>
                   (o Core..:? "kind" Core..!= "dns#managedZoneForwardingConfig")
...
instance Core.FromJSON ManagedZoneForwardingConfigNameServerTarget
         where
        parseJSON
          = Core.withObject "ManagedZoneForwardingConfigNameServerTarget"
              (\ o ->
                 ManagedZoneForwardingConfigNameServerTarget Core.<$>
                   (o Core..:? "forwardingPath") Core.<*> (o Core..:? "ipv4Address")
                     Core.<*>
                     (o Core..:? "kind" Core..!=
                        "dns#managedZoneForwardingConfigNameServerTarget"))

instance Core.ToJSON ManagedZoneForwardingConfigNameServerTarget
         where
...
newManagedZoneOperationsListResponse 
    :: 
                                     ManagedZoneOperationsListResponse
newManagedZoneOperationsListResponse
  = ManagedZoneOperationsListResponse{header = Core.Nothing,
...
instance Core.FromJSON ManagedZoneOperationsListResponse where
        parseJSON
          = Core.withObject "ManagedZoneOperationsListResponse"
              (\ o ->
                 ManagedZoneOperationsListResponse Core.<$>
                   (o Core..:? "header") Core.<*>
                     (o Core..:? "kind" Core..!=
...
newManagedZonePeeringConfig 
    ::  ManagedZonePeeringConfig
newManagedZonePeeringConfig
  = ManagedZonePeeringConfig{kind = "dns#managedZonePeeringConfig",
                             targetNetwork = Core.Nothing}
instance Core.FromJSON ManagedZonePeeringConfig where
        parseJSON
          = Core.withObject "ManagedZonePeeringConfig"
              (\ o ->
                 ManagedZonePeeringConfig Core.<$>
                   (o Core..:? "kind" Core..!= "dns#managedZonePeeringConfig")
...
newManagedZonePeeringConfigTargetNetwork 
    :: 
                                         ManagedZonePeeringConfigTargetNetwork
newManagedZonePeeringConfigTargetNetwork
  = ManagedZonePeeringConfigTargetNetwork{deactivateTime =
                                            Core.Nothing,
...
instance Core.FromJSON ManagedZonePeeringConfigTargetNetwork where
        parseJSON
          = Core.withObject "ManagedZonePeeringConfigTargetNetwork"
              (\ o ->
                 ManagedZonePeeringConfigTargetNetwork Core.<$>
                   (o Core..:? "deactivateTime") Core.<*>
                     (o Core..:? "kind" Core..!=
...
newManagedZonePrivateVisibilityConfig 
    :: 
                                      ManagedZonePrivateVisibilityConfig
newManagedZonePrivateVisibilityConfig
  = ManagedZonePrivateVisibilityConfig{gkeClusters = Core.Nothing,
                                       kind = "dns#managedZonePrivateVisibilityConfig",
                                       networks = Core.Nothing}
instance Core.FromJSON ManagedZonePrivateVisibilityConfig where
        parseJSON
          = Core.withObject "ManagedZonePrivateVisibilityConfig"
              (\ o ->
                 ManagedZonePrivateVisibilityConfig Core.<$>
                   (o Core..:? "gkeClusters") Core.<*>
                     (o Core..:? "kind" Core..!=
...
newManagedZonePrivateVisibilityConfigGKECluster 
    :: 
                                                ManagedZonePrivateVisibilityConfigGKECluster
newManagedZonePrivateVisibilityConfigGKECluster
  = ManagedZonePrivateVisibilityConfigGKECluster{gkeClusterName =
                                                   Core.Nothing,
                                                 kind =
                                                   "dns#managedZonePrivateVisibilityConfigGKECluster"}
instance Core.FromJSON ManagedZonePrivateVisibilityConfigGKECluster
         where
        parseJSON
          = Core.withObject "ManagedZonePrivateVisibilityConfigGKECluster"
              (\ o ->
                 ManagedZonePrivateVisibilityConfigGKECluster Core.<$>
                   (o Core..:? "gkeClusterName") Core.<*>
                     (o Core..:? "kind" Core..!=
                        "dns#managedZonePrivateVisibilityConfigGKECluster"))

instance Core.ToJSON ManagedZonePrivateVisibilityConfigGKECluster
         where
...
newManagedZonePrivateVisibilityConfigNetwork 
    :: 
                                             ManagedZonePrivateVisibilityConfigNetwork
newManagedZonePrivateVisibilityConfigNetwork
  = ManagedZonePrivateVisibilityConfigNetwork{kind =
                                                "dns#managedZonePrivateVisibilityConfigNetwork",
                                              networkUrl = Core.Nothing}
instance Core.FromJSON ManagedZonePrivateVisibilityConfigNetwork
         where
        parseJSON
          = Core.withObject "ManagedZonePrivateVisibilityConfigNetwork"
              (\ o ->
                 ManagedZonePrivateVisibilityConfigNetwork Core.<$>
                   (o Core..:? "kind" Core..!=
                      "dns#managedZonePrivateVisibilityConfigNetwork")
                     Core.<*> (o Core..:? "networkUrl"))

instance Core.ToJSON ManagedZonePrivateVisibilityConfigNetwork
         where
...
newManagedZoneReverseLookupConfig 
    ::  ManagedZoneReverseLookupConfig
newManagedZoneReverseLookupConfig
  = ManagedZoneReverseLookupConfig{kind =
                                     "dns#managedZoneReverseLookupConfig"}
instance Core.FromJSON ManagedZoneReverseLookupConfig where
        parseJSON
          = Core.withObject "ManagedZoneReverseLookupConfig"
              (\ o ->
                 ManagedZoneReverseLookupConfig Core.<$>
                   (o Core..:? "kind" Core..!= "dns#managedZoneReverseLookupConfig"))
...
newManagedZoneServiceDirectoryConfig 
    :: 
                                     ManagedZoneServiceDirectoryConfig
newManagedZoneServiceDirectoryConfig
  = ManagedZoneServiceDirectoryConfig{kind =
...
instance Core.FromJSON ManagedZoneServiceDirectoryConfig where
        parseJSON
          = Core.withObject "ManagedZoneServiceDirectoryConfig"
              (\ o ->
                 ManagedZoneServiceDirectoryConfig Core.<$>
                   (o Core..:? "kind" Core..!=
                      "dns#managedZoneServiceDirectoryConfig")
...
newManagedZoneServiceDirectoryConfigNamespace 
    :: 
                                              ManagedZoneServiceDirectoryConfigNamespace
newManagedZoneServiceDirectoryConfigNamespace
  = ManagedZoneServiceDirectoryConfigNamespace{deletionTime =
                                                 Core.Nothing,
                                               kind =
                                                 "dns#managedZoneServiceDirectoryConfigNamespace",
                                               namespaceUrl = Core.Nothing}
instance Core.FromJSON ManagedZoneServiceDirectoryConfigNamespace
         where
        parseJSON
          = Core.withObject "ManagedZoneServiceDirectoryConfigNamespace"
              (\ o ->
                 ManagedZoneServiceDirectoryConfigNamespace Core.<$>
                   (o Core..:? "deletionTime") Core.<*>
                     (o Core..:? "kind" Core..!=
                        "dns#managedZoneServiceDirectoryConfigNamespace")
                     Core.<*> (o Core..:? "namespaceUrl"))

instance Core.ToJSON ManagedZoneServiceDirectoryConfigNamespace
         where
...
newManagedZonesListResponse 
    ::  ManagedZonesListResponse
newManagedZonesListResponse
  = ManagedZonesListResponse{header = Core.Nothing,
                             kind = "dns#managedZonesListResponse", managedZones = Core.Nothing,
                             nextPageToken = Core.Nothing}
instance Core.FromJSON ManagedZonesListResponse where
        parseJSON
          = Core.withObject "ManagedZonesListResponse"
              (\ o ->
                 ManagedZonesListResponse Core.<$>
                   (o Core..:? "header") Core.<*>
                     (o Core..:? "kind" Core..!= "dns#managedZonesListResponse")
...
newOperation 
    ::  Operation
newOperation
  = Operation{dnsKeyContext = Core.Nothing, id = Core.Nothing,
              kind = "dns#operation", startTime = Core.Nothing,
              status = Core.Nothing, type' = Core.Nothing, user = Core.Nothing,
...
instance Core.FromJSON Operation where
        parseJSON
          = Core.withObject "Operation"
              (\ o ->
                 Operation Core.<$>
                   (o Core..:? "dnsKeyContext") Core.<*> (o Core..:? "id") Core.<*>
                     (o Core..:? "kind" Core..!= "dns#operation")
                     Core.<*> (o Core..:? "startTime")
                     Core.<*> (o Core..:? "status")
                     Core.<*> (o Core..:? "type")
                     Core.<*> (o Core..:? "user")
...
newOperationDnsKeyContext 
    ::  OperationDnsKeyContext
newOperationDnsKeyContext
  = OperationDnsKeyContext{newValue' = Core.Nothing,
                           oldValue = Core.Nothing}
instance Core.FromJSON OperationDnsKeyContext where
        parseJSON
          = Core.withObject "OperationDnsKeyContext"
              (\ o ->
                 OperationDnsKeyContext Core.<$>
                   (o Core..:? "newValue") Core.<*> (o Core..:? "oldValue"))
...
newOperationManagedZoneContext 
    ::  OperationManagedZoneContext
newOperationManagedZoneContext
  = OperationManagedZoneContext{newValue' = Core.Nothing,
                                oldValue = Core.Nothing}
instance Core.FromJSON OperationManagedZoneContext where
        parseJSON
          = Core.withObject "OperationManagedZoneContext"
              (\ o ->
                 OperationManagedZoneContext Core.<$>
                   (o Core..:? "newValue") Core.<*> (o Core..:? "oldValue"))
...
newPoliciesListResponse 
    ::  PoliciesListResponse
newPoliciesListResponse
  = PoliciesListResponse{header = Core.Nothing,
                         kind = "dns#policiesListResponse", nextPageToken = Core.Nothing,
                         policies = Core.Nothing}
instance Core.FromJSON PoliciesListResponse where
        parseJSON
          = Core.withObject "PoliciesListResponse"
              (\ o ->
                 PoliciesListResponse Core.<$>
                   (o Core..:? "header") Core.<*>
                     (o Core..:? "kind" Core..!= "dns#policiesListResponse")
                     Core.<*> (o Core..:? "nextPageToken")
...
newPoliciesPatchResponse 
    ::  PoliciesPatchResponse
newPoliciesPatchResponse
  = PoliciesPatchResponse{header = Core.Nothing,
                          policy = Core.Nothing}
instance Core.FromJSON PoliciesPatchResponse where
        parseJSON
          = Core.withObject "PoliciesPatchResponse"
              (\ o ->
                 PoliciesPatchResponse Core.<$>
                   (o Core..:? "header") Core.<*> (o Core..:? "policy"))
...
newPoliciesUpdateResponse 
    ::  PoliciesUpdateResponse
newPoliciesUpdateResponse
  = PoliciesUpdateResponse{header = Core.Nothing,
                           policy = Core.Nothing}
instance Core.FromJSON PoliciesUpdateResponse where
        parseJSON
          = Core.withObject "PoliciesUpdateResponse"
              (\ o ->
                 PoliciesUpdateResponse Core.<$>
                   (o Core..:? "header") Core.<*> (o Core..:? "policy"))
...
newPolicy 
    ::  Policy
newPolicy
  = Policy{alternativeNameServerConfig = Core.Nothing,
           description = Core.Nothing, enableInboundForwarding = Core.Nothing,
           enableLogging = Core.Nothing, id = Core.Nothing,
           kind = "dns#policy", name = Core.Nothing, networks = Core.Nothing}
instance Core.FromJSON Policy where
        parseJSON
          = Core.withObject "Policy"
              (\ o ->
                 Policy Core.<$>
                   (o Core..:? "alternativeNameServerConfig") Core.<*>
                     (o Core..:? "description")
...
instance Core.ToJSON Policy where
        toJSON Policy{..}
          = Core.object
              (Core.catMaybes
                 [("alternativeNameServerConfig" Core..=) Core.<$>
                    alternativeNameServerConfig,
                  ("description" Core..=) Core.<$> description,
                  ("enableInboundForwarding" Core..=) Core.<$>
...
newPolicyAlternativeNameServerConfig 
    :: 
                                     PolicyAlternativeNameServerConfig
newPolicyAlternativeNameServerConfig
  = PolicyAlternativeNameServerConfig{kind =
                                        "dns#policyAlternativeNameServerConfig",
                                      targetNameServers = Core.Nothing}
instance Core.FromJSON PolicyAlternativeNameServerConfig where
        parseJSON
          = Core.withObject "PolicyAlternativeNameServerConfig"
              (\ o ->
                 PolicyAlternativeNameServerConfig Core.<$>
                   (o Core..:? "kind" Core..!=
                      "dns#policyAlternativeNameServerConfig")
                     Core.<*> (o Core..:? "targetNameServers"))
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "PolicyAlternativeNameServerConfigTargetNameServer"
              (\ o ->
                 PolicyAlternativeNameServerConfigTargetNameServer Core.<$>
                   (o Core..:? "forwardingPath") Core.<*> (o Core..:? "ipv4Address")
                     Core.<*>
                     (o Core..:? "kind" Core..!=
                        "dns#policyAlternativeNameServerConfigTargetNameServer"))
...
newPolicyNetwork 
    ::  PolicyNetwork
newPolicyNetwork
  = PolicyNetwork{kind = "dns#policyNetwork",
                  networkUrl = Core.Nothing}
instance Core.FromJSON PolicyNetwork where
        parseJSON
          = Core.withObject "PolicyNetwork"
              (\ o ->
                 PolicyNetwork Core.<$>
                   (o Core..:? "kind" Core..!= "dns#policyNetwork") Core.<*>
                     (o Core..:? "networkUrl"))
...
newProject 
    ::  Project
newProject
  = Project{id = Core.Nothing, kind = "dns#project",
            number = Core.Nothing, quota = Core.Nothing}
...
newQuota 
    ::  Quota
newQuota
  = Quota{dnsKeysPerManagedZone = Core.Nothing,
          itemsPerRoutingPolicy = Core.Nothing, kind = "dns#quota",
          managedZones = Core.Nothing, managedZonesPerNetwork = Core.Nothing,
          networksPerManagedZone = Core.Nothing,
          networksPerPolicy = Core.Nothing,
          peeringZonesPerTargetNetwork = Core.Nothing,
          policies = Core.Nothing, resourceRecordsPerRrset = Core.Nothing,
...
instance Core.FromJSON Quota where
        parseJSON
          = Core.withObject "Quota"
              (\ o ->
                 Quota Core.<$>
                   (o Core..:? "dnsKeysPerManagedZone") Core.<*>
                     (o Core..:? "itemsPerRoutingPolicy")
          ...
          = Core.object
              (Core.catMaybes
                 [("dnsKeysPerManagedZone" Core..=) Core.<$> dnsKeysPerManagedZone,
                  ...
                  ("peeringZonesPerTargetNetwork" Core..=) Core.<$>
                    peeringZonesPerTargetNetwork,
                  ("policies" Core..=) Core.<$> policies,
                  ("resourceRecordsPerRrset" Core..=) Core.<$>
                    resourceRecordsPerRrset,
                  ("rrsetAdditionsPerChange" Core..=) Core.<$>
                    rrsetAdditionsPerChange,
                  ("rrsetDeletionsPerChange" Core..=) Core.<$>
                    rrsetDeletionsPerChange,
                  ("rrsetsPerManagedZone" Core..=) Core.<$> rrsetsPerManagedZone,
                  ("targetNameServersPerManagedZone" Core..=) Core.<$>
                    targetNameServersPerManagedZone,
                  ("targetNameServersPerPolicy" Core..=) Core.<$>
                    targetNameServersPerPolicy,
                  ("totalRrdataSizePerChange" Core..=) Core.<$>
...
newRRSetRoutingPolicy 
    ::  RRSetRoutingPolicy
newRRSetRoutingPolicy
  = RRSetRoutingPolicy{geo = Core.Nothing,
                       kind = "dns#rRSetRoutingPolicy", wrr = Core.Nothing}
instance Core.FromJSON RRSetRoutingPolicy where
        parseJSON
          = Core.withObject "RRSetRoutingPolicy"
              (\ o ->
                 RRSetRoutingPolicy Core.<$>
                   (o Core..:? "geo") Core.<*>
                     (o Core..:? "kind" Core..!= "dns#rRSetRoutingPolicy")
                     Core.<*> (o Core..:? "wrr"))
...
instance Core.ToJSON RRSetRoutingPolicy where
        toJSON RRSetRoutingPolicy{..}
          = Core.object
              (Core.catMaybes
                 [("geo" Core..=) Core.<$> geo, Core.Just ("kind" Core..= kind),
                  ("wrr" Core..=) Core.<$> wrr])
...
newRRSetRoutingPolicyGeoPolicy 
    ::  RRSetRoutingPolicyGeoPolicy
newRRSetRoutingPolicyGeoPolicy
  = RRSetRoutingPolicyGeoPolicy{items = Core.Nothing,
                                kind = "dns#rRSetRoutingPolicyGeoPolicy"}
instance Core.FromJSON RRSetRoutingPolicyGeoPolicy where
        parseJSON
          = Core.withObject "RRSetRoutingPolicyGeoPolicy"
              (\ o ->
                 RRSetRoutingPolicyGeoPolicy Core.<$>
                   (o Core..:? "items") Core.<*>
                     (o Core..:? "kind" Core..!= "dns#rRSetRoutingPolicyGeoPolicy"))
...
newRRSetRoutingPolicyGeoPolicyGeoPolicyItem 
    :: 
                                            RRSetRoutingPolicyGeoPolicyGeoPolicyItem
newRRSetRoutingPolicyGeoPolicyGeoPolicyItem
  = RRSetRoutingPolicyGeoPolicyGeoPolicyItem{kind =
                                               "dns#rRSetRoutingPolicyGeoPolicyGeoPolicyItem",
                                             location = Core.Nothing, rrdatas = Core.Nothing,
                                             signatureRrdatas = Core.Nothing}
instance Core.FromJSON RRSetRoutingPolicyGeoPolicyGeoPolicyItem
         where
        parseJSON
          = Core.withObject "RRSetRoutingPolicyGeoPolicyGeoPolicyItem"
              (\ o ->
                 RRSetRoutingPolicyGeoPolicyGeoPolicyItem Core.<$>
                   (o Core..:? "kind" Core..!=
                      "dns#rRSetRoutingPolicyGeoPolicyGeoPolicyItem")
...
newRRSetRoutingPolicyWrrPolicy 
    ::  RRSetRoutingPolicyWrrPolicy
newRRSetRoutingPolicyWrrPolicy
  = RRSetRoutingPolicyWrrPolicy{items = Core.Nothing,
                                kind = "dns#rRSetRoutingPolicyWrrPolicy"}
instance Core.FromJSON RRSetRoutingPolicyWrrPolicy where
        parseJSON
          = Core.withObject "RRSetRoutingPolicyWrrPolicy"
              (\ o ->
                 RRSetRoutingPolicyWrrPolicy Core.<$>
                   (o Core..:? "items") Core.<*>
                     (o Core..:? "kind" Core..!= "dns#rRSetRoutingPolicyWrrPolicy"))
...
newRRSetRoutingPolicyWrrPolicyWrrPolicyItem 
    :: 
                                            RRSetRoutingPolicyWrrPolicyWrrPolicyItem
newRRSetRoutingPolicyWrrPolicyWrrPolicyItem
  = RRSetRoutingPolicyWrrPolicyWrrPolicyItem{kind =
                                               "dns#rRSetRoutingPolicyWrrPolicyWrrPolicyItem",
                                             rrdatas = Core.Nothing,
                                             signatureRrdatas = Core.Nothing, weight = Core.Nothing}
instance Core.FromJSON RRSetRoutingPolicyWrrPolicyWrrPolicyItem
         where
        parseJSON
          = Core.withObject "RRSetRoutingPolicyWrrPolicyWrrPolicyItem"
              (\ o ->
                 RRSetRoutingPolicyWrrPolicyWrrPolicyItem Core.<$>
                   (o Core..:? "kind" Core..!=
                      "dns#rRSetRoutingPolicyWrrPolicyWrrPolicyItem")
                     Core.<*> (o Core..:? "rrdatas")
                     Core.<*> (o Core..:? "signatureRrdatas")
...
newResourceRecordSet 
    ::  ResourceRecordSet
newResourceRecordSet
  = ResourceRecordSet{kind = "dns#resourceRecordSet",
                      name = Core.Nothing, routingPolicy = Core.Nothing,
                      rrdatas = Core.Nothing, signatureRrdatas = Core.Nothing,
                      ttl = Core.Nothing, type' = Core.Nothing}
instance Core.FromJSON ResourceRecordSet where
        parseJSON
          = Core.withObject "ResourceRecordSet"
              (\ o ->
                 ResourceRecordSet Core.<$>
                   (o Core..:? "kind" Core..!= "dns#resourceRecordSet") Core.<*>
                     (o Core..:? "name")
          ...
          = Core.object
              (Core.catMaybes
                 [Core.Just ("kind" Core..= kind), ("name" Core..=) Core.<$> name,
                  ...
                  ("rrdatas" Core..=) Core.<$> rrdatas,
                  ("signatureRrdatas" Core..=) Core.<$> signatureRrdatas,
                  ("ttl" Core..=) Core.<$> ttl, ("type" Core..=) Core.<$> type'])
...
newResourceRecordSetsListResponse 
    ::  ResourceRecordSetsListResponse
newResourceRecordSetsListResponse
  = ResourceRecordSetsListResponse{header = Core.Nothing,
                                   kind = "dns#resourceRecordSetsListResponse",
                                   nextPageToken = Core.Nothing, rrsets = Core.Nothing}
instance Core.FromJSON ResourceRecordSetsListResponse where
        parseJSON
          = Core.withObject "ResourceRecordSetsListResponse"
              (\ o ->
                 ResourceRecordSetsListResponse Core.<$>
                   (o Core..:? "header") Core.<*>
                     (o Core..:? "kind" Core..!= "dns#resourceRecordSetsListResponse")
                     Core.<*> (o Core..:? "nextPageToken")
                     Core.<*> (o Core..:? "rrsets"))
...
instance Core.FromJSON ResponseHeader where
        parseJSON
          = Core.withObject "ResponseHeader"
...
newResponsePoliciesListResponse 
    ::  ResponsePoliciesListResponse
newResponsePoliciesListResponse
  = ResponsePoliciesListResponse{header = Core.Nothing,
                                 nextPageToken = Core.Nothing, responsePolicies = Core.Nothing}
instance Core.FromJSON ResponsePoliciesListResponse where
        parseJSON
          = Core.withObject "ResponsePoliciesListResponse"
              (\ o ->
                 ResponsePoliciesListResponse Core.<$>
                   (o Core..:? "header") Core.<*> (o Core..:? "nextPageToken")
...
newResponsePoliciesPatchResponse 
    ::  ResponsePoliciesPatchResponse
newResponsePoliciesPatchResponse
  = ResponsePoliciesPatchResponse{header = Core.Nothing,
                                  responsePolicy = Core.Nothing}
instance Core.FromJSON ResponsePoliciesPatchResponse where
        parseJSON
          = Core.withObject "ResponsePoliciesPatchResponse"
              (\ o ->
                 ResponsePoliciesPatchResponse Core.<$>
                   (o Core..:? "header") Core.<*> (o Core..:? "responsePolicy"))
...
newResponsePoliciesUpdateResponse 
    ::  ResponsePoliciesUpdateResponse
newResponsePoliciesUpdateResponse
  = ResponsePoliciesUpdateResponse{header = Core.Nothing,
                                   responsePolicy = Core.Nothing}
instance Core.FromJSON ResponsePoliciesUpdateResponse where
        parseJSON
          = Core.withObject "ResponsePoliciesUpdateResponse"
              (\ o ->
                 ResponsePoliciesUpdateResponse Core.<$>
                   (o Core..:? "header") Core.<*> (o Core..:? "responsePolicy"))
...
newResponsePolicy 
    ::  ResponsePolicy
newResponsePolicy
  = ResponsePolicy{description = Core.Nothing,
                   gkeClusters = Core.Nothing, id = Core.Nothing,
                   kind = "dns#responsePolicy", networks = Core.Nothing,
                   responsePolicyName = Core.Nothing}
instance Core.FromJSON ResponsePolicy where
        parseJSON
          = Core.withObject "ResponsePolicy"
              (\ o ->
                 ResponsePolicy Core.<$>
                   (o Core..:? "description") Core.<*> (o Core..:? "gkeClusters")
                     Core.<*> (o Core..:? "id" Core.<&> Core.fmap Core.fromAsText)
...
newResponsePolicyGKECluster 
    ::  ResponsePolicyGKECluster
newResponsePolicyGKECluster
  = ResponsePolicyGKECluster{gkeClusterName = Core.Nothing,
                             kind = "dns#responsePolicyGKECluster"}
instance Core.FromJSON ResponsePolicyGKECluster where
        parseJSON
          = Core.withObject "ResponsePolicyGKECluster"
              (\ o ->
                 ResponsePolicyGKECluster Core.<$>
                   (o Core..:? "gkeClusterName") Core.<*>
                     (o Core..:? "kind" Core..!= "dns#responsePolicyGKECluster"))
...
newResponsePolicyNetwork 
    ::  ResponsePolicyNetwork
newResponsePolicyNetwork
  = ResponsePolicyNetwork{kind = "dns#responsePolicyNetwork",
                          networkUrl = Core.Nothing}
instance Core.FromJSON ResponsePolicyNetwork where
        parseJSON
          = Core.withObject "ResponsePolicyNetwork"
              (\ o ->
                 ResponsePolicyNetwork Core.<$>
                   (o Core..:? "kind" Core..!= "dns#responsePolicyNetwork") Core.<*>
                     (o Core..:? "networkUrl"))
...
newResponsePolicyRule 
    ::  ResponsePolicyRule
newResponsePolicyRule
  = ResponsePolicyRule{behavior = Core.Nothing,
                       dnsName = Core.Nothing, kind = "dns#responsePolicyRule",
                       localData = Core.Nothing, ruleName = Core.Nothing}
instance Core.FromJSON ResponsePolicyRule where
        parseJSON
          = Core.withObject "ResponsePolicyRule"
              (\ o ->
                 ResponsePolicyRule Core.<$>
                   (o Core..:? "behavior") Core.<*> (o Core..:? "dnsName") Core.<*>
                     (o Core..:? "kind" Core..!= "dns#responsePolicyRule")
...
instance Core.FromJSON ResponsePolicyRuleLocalData where
        parseJSON
          = Core.withObject "ResponsePolicyRuleLocalData"
              (\ o ->
...
newResponsePolicyRulesListResponse 
    :: 
                                   ResponsePolicyRulesListResponse
newResponsePolicyRulesListResponse
  = ResponsePolicyRulesListResponse{header = Core.Nothing,
                                    nextPageToken = Core.Nothing,
                                    responsePolicyRules = Core.Nothing}
instance Core.FromJSON ResponsePolicyRulesListResponse where
        parseJSON
          = Core.withObject "ResponsePolicyRulesListResponse"
              (\ o ->
                 ResponsePolicyRulesListResponse Core.<$>
                   (o Core..:? "header") Core.<*> (o Core..:? "nextPageToken")
...
newResponsePolicyRulesPatchResponse 
    :: 
                                    ResponsePolicyRulesPatchResponse
newResponsePolicyRulesPatchResponse
  = ResponsePolicyRulesPatchResponse{header = Core.Nothing,
                                     responsePolicyRule = Core.Nothing}
instance Core.FromJSON ResponsePolicyRulesPatchResponse where
        parseJSON
          = Core.withObject "ResponsePolicyRulesPatchResponse"
              (\ o ->
                 ResponsePolicyRulesPatchResponse Core.<$>
                   (o Core..:? "header") Core.<*> (o Core..:? "responsePolicyRule"))
...
newResponsePolicyRulesUpdateResponse 
    :: 
                                     ResponsePolicyRulesUpdateResponse
newResponsePolicyRulesUpdateResponse
  = ResponsePolicyRulesUpdateResponse{header = Core.Nothing,
                                      responsePolicyRule = Core.Nothing}
instance Core.FromJSON ResponsePolicyRulesUpdateResponse where
        parseJSON
          = Core.withObject "ResponsePolicyRulesUpdateResponse"
              (\ o ->
                 ResponsePolicyRulesUpdateResponse Core.<$>
                   (o Core..:? "header") Core.<*> (o Core..:? "responsePolicyRule"))
