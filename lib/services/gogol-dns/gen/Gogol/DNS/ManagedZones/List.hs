                   ...
                   Core.QueryParam "$.xgafv" Xgafv Core.:>
                     Core.QueryParam "access_token" Core.Text Core.:>
                       Core.QueryParam "callback" Core.Text Core.:>
                         Core.QueryParam "dnsName" Core.Text Core.:>
                           Core.QueryParam "maxResults" Core.Int32 Core.:>
                             Core.QueryParam "pageToken" Core.Text Core.:>
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.Get '[Core.JSON] ManagedZonesListResponse
...
newDNSManagedZonesList project
  = DNSManagedZonesList{xgafv = Core.Nothing,
                        accessToken = Core.Nothing, callback = Core.Nothing,
                        dnsName = Core.Nothing, location = "global",
...
instance Core.GoogleRequest DNSManagedZonesList where
        ...
        type Scopes DNSManagedZonesList =
             '[CloudPlatform'FullControl, CloudPlatform'ReadOnly,
               Ndev'Clouddns'Readonly, Ndev'Clouddns'Readwrite]
        requestClient DNSManagedZonesList{..}
          = go project location xgafv accessToken callback dnsName maxResults
              pageToken
              uploadType
              uploadProtocol
