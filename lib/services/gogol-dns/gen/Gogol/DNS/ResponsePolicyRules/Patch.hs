                                   ...
                                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                                     Core.QueryParam "alt" Core.AltJSON Core.:>
                                       Core.ReqBody '[Core.JSON] ResponsePolicyRule Core.:>
                                         Core.Patch '[Core.JSON] ResponsePolicyRulesPatchResponse
...
newDNSResponsePolicyRulesPatch 
    ...
    -> DNSResponsePolicyRulesPatch
newDNSResponsePolicyRulesPatch payload project responsePolicy
  responsePolicyRule
  = DNSResponsePolicyRulesPatch{xgafv = Core.Nothing,
