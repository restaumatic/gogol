                                 ...
                                 Core.QueryParam "uploadType" Core.Text Core.:>
                                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                                     Core.QueryParam "alt" Core.AltJSON Core.:>
                                       Core.Get '[Core.JSON] ResponsePolicyRule
...
newDNSResponsePolicyRulesGet 
    ...
    -> DNSResponsePolicyRulesGet
newDNSResponsePolicyRulesGet project responsePolicy
  responsePolicyRule
  = DNSResponsePolicyRulesGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DNSResponsePolicyRulesGet where
        ...
        type Scopes DNSResponsePolicyRulesGet =
