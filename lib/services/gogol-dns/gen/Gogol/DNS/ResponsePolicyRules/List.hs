                                 ...
                                 Core.QueryParam "uploadType" Core.Text Core.:>
                                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                                     Core.QueryParam "alt" Core.AltJSON Core.:>
                                       Core.Get '[Core.JSON] ResponsePolicyRulesListResponse
...
newDNSResponsePolicyRulesList project responsePolicy
  = DNSResponsePolicyRulesList{xgafv = Core.Nothing,
                               accessToken = Core.Nothing, callback = Core.Nothing,
                               location = "global", maxResults = Core.Nothing,
...
instance Core.GoogleRequest DNSResponsePolicyRulesList where
        type Rs DNSResponsePolicyRulesList =
             ResponsePolicyRulesListResponse
        type Scopes DNSResponsePolicyRulesList =
