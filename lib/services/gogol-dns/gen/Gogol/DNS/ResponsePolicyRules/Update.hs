                                 ...
                                 Core.QueryParam "uploadType" Core.Text Core.:>
                                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                                     Core.QueryParam "alt" Core.AltJSON Core.:>
                                       Core.ReqBody '[Core.JSON] ResponsePolicyRule Core.:>
                                         Core.Put '[Core.JSON] ResponsePolicyRulesUpdateResponse
...
newDNSResponsePolicyRulesUpdate 
    ...
    -> DNSResponsePolicyRulesUpdate
newDNSResponsePolicyRulesUpdate payload project responsePolicy
  responsePolicyRule
  = DNSResponsePolicyRulesUpdate{xgafv = Core.Nothing,
                                 accessToken = Core.Nothing, callback = Core.Nothing,
                                 clientOperationId = Core.Nothing, location = "global",
                                 payload = payload, project = project,
                                 responsePolicy = responsePolicy,
                                 responsePolicyRule = responsePolicyRule, uploadType = Core.Nothing,
                                 uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DNSResponsePolicyRulesUpdate where
        type Rs DNSResponsePolicyRulesUpdate =
             ResponsePolicyRulesUpdateResponse
        type Scopes DNSResponsePolicyRulesUpdate =
             '[CloudPlatform'FullControl, Ndev'Clouddns'Readwrite]
        requestClient DNSResponsePolicyRulesUpdate{..}
          = go project location responsePolicy responsePolicyRule xgafv
              accessToken
              callback
              clientOperationId
              uploadType
