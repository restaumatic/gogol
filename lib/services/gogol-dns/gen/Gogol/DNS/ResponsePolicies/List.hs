                             ...
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.Get '[Core.JSON] ResponsePoliciesListResponse
...
newDNSResponsePoliciesList project
  = DNSResponsePoliciesList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DNSResponsePoliciesList where
        ...
        type Scopes DNSResponsePoliciesList =
             '[CloudPlatform'FullControl, CloudPlatform'ReadOnly,
               Ndev'Clouddns'Readonly, Ndev'Clouddns'Readwrite]
        requestClient DNSResponsePoliciesList{..}
          = go project location xgafv accessToken callback maxResults
              pageToken
              uploadType
              uploadProtocol
