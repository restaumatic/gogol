                             ...
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.ReqBody '[Core.JSON] ResponsePolicy Core.:>
                                   Core.Post '[Core.JSON] ResponsePolicy
...
newDNSResponsePoliciesCreate payload project
  = DNSResponsePoliciesCreate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DNSResponsePoliciesCreate where
        ...
        type Scopes DNSResponsePoliciesCreate =
             '[CloudPlatform'FullControl, Ndev'Clouddns'Readwrite]
        requestClient DNSResponsePoliciesCreate{..}
          = go project location xgafv accessToken callback clientOperationId
              uploadType
              uploadProtocol
