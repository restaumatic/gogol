                             ...
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.ReqBody '[Core.JSON] ResponsePolicy Core.:>
                                     Core.Put '[Core.JSON] ResponsePoliciesUpdateResponse
...
newDNSResponsePoliciesUpdate payload project responsePolicy
  = DNSResponsePoliciesUpdate{xgafv = Core.Nothing,
                              accessToken = Core.Nothing, callback = Core.Nothing,
                              clientOperationId = Core.Nothing, location = "global",
                              payload = payload, project = project,
                              responsePolicy = responsePolicy, uploadType = Core.Nothing,
...
instance Core.GoogleRequest DNSResponsePoliciesUpdate where
        ...
        type Scopes DNSResponsePoliciesUpdate =
             '[CloudPlatform'FullControl, Ndev'Clouddns'Readwrite]
        requestClient DNSResponsePoliciesUpdate{..}
          = go project location responsePolicy xgafv accessToken callback
              clientOperationId
              uploadType
              uploadProtocol
