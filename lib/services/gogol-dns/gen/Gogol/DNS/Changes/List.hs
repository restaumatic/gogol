                           ...
                           Core.QueryParam "callback" Core.Text Core.:>
                             Core.QueryParam "maxResults" Core.Int32 Core.:>
                               Core.QueryParam "pageToken" Core.Text Core.:>
                                 Core.QueryParam "sortBy" ChangesListSortBy Core.:>
                                   Core.QueryParam "sortOrder" Core.Text Core.:>
                                     Core.QueryParam "uploadType" Core.Text Core.:>
                                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                                         Core.QueryParam "alt" Core.AltJSON Core.:>
                                           Core.Get '[Core.JSON] ChangesListResponse
...
newDNSChangesList managedZone project
  = DNSChangesList{xgafv = Core.Nothing, accessToken = Core.Nothing,
                   callback = Core.Nothing, location = "global",
                   managedZone = managedZone, maxResults = Core.Nothing,
...
instance Core.GoogleRequest DNSChangesList where
        ...
        type Scopes DNSChangesList =
             '[CloudPlatform'FullControl, CloudPlatform'ReadOnly,
               Ndev'Clouddns'Readonly, Ndev'Clouddns'Readwrite]
        requestClient DNSChangesList{..}
          = go project location managedZone xgafv accessToken callback
              maxResults
              pageToken
              (Core.Just sortBy)
              sortOrder
