...
instance Core.FromJSON Accelerator where
        parseJSON
          = Core.withObject "Accelerator"
              (\ o ->
                 Accelerator Core.<$>
                   (o Core..:? "acceleratorType") Core.<*> (o Core..:? "state"))
...
newDnsPeering 
    ::  DnsPeering
newDnsPeering
  = DnsPeering{description = Core.Nothing, domain = Core.Nothing,
               name = Core.Nothing, targetNetwork = Core.Nothing,
...
instance Core.FromJSON DnsPeering where
        parseJSON
          = Core.withObject "DnsPeering"
              (\ o ->
                 DnsPeering Core.<$>
                   (o Core..:? "description") Core.<*> (o Core..:? "domain") Core.<*>
                     (o Core..:? "name")
...
newInstance 
    ::  Instance
newInstance
  = Instance{accelerators = Core.Nothing, apiEndpoint = Core.Nothing,
             availableVersion = Core.Nothing, createTime = Core.Nothing,
             cryptoKeyConfig = Core.Nothing,
             dataplexDataLineageIntegrationEnabled = Core.Nothing,
             dataprocServiceAccount = Core.Nothing, description = Core.Nothing,
             disabledReason = Core.Nothing, displayName = Core.Nothing,
             enableRbac = Core.Nothing, enableStackdriverLogging = Core.Nothing,
             enableStackdriverMonitoring = Core.Nothing,
             enableZoneSeparation = Core.Nothing,
             eventPublishConfig = Core.Nothing, gcsBucket = Core.Nothing,
             labels = Core.Nothing, loggingConfig = Core.Nothing,
             maintenanceEvents = Core.Nothing, maintenancePolicy = Core.Nothing,
             name = Core.Nothing, networkConfig = Core.Nothing,
             options = Core.Nothing, p4ServiceAccount = Core.Nothing,
             patchRevision = Core.Nothing, privateInstance = Core.Nothing,
             satisfiesPzi = Core.Nothing, satisfiesPzs = Core.Nothing,
             serviceAccount = Core.Nothing, serviceEndpoint = Core.Nothing,
             state = Core.Nothing, stateMessage = Core.Nothing,
             tags = Core.Nothing, tenantProjectId = Core.Nothing,
...
instance Core.FromJSON Instance where
        parseJSON
          = Core.withObject "Instance"
              (\ o ->
                 Instance Core.<$>
                   (o Core..:? "accelerators") Core.<*> (o Core..:? "apiEndpoint")
          ...
          = Core.object
              (Core.catMaybes
                 [("accelerators" Core..=) Core.<$> accelerators,
                  ...
                  ("dataplexDataLineageIntegrationEnabled" Core..=) Core.<$>
                  ...
                  ("workforceIdentityServiceEndpoint" Core..=) Core.<$>
...
newListAvailableVersionsResponse 
    ::  ListAvailableVersionsResponse
newListAvailableVersionsResponse
  = ListAvailableVersionsResponse{availableVersions = Core.Nothing,
...
newListDnsPeeringsResponse 
    ::  ListDnsPeeringsResponse
newListDnsPeeringsResponse
  = ListDnsPeeringsResponse{dnsPeerings = Core.Nothing,
          ...
          = Core.withObject "ListDnsPeeringsResponse"
              (\ o ->
                 ListDnsPeeringsResponse Core.<$>
                   (o Core..:? "dnsPeerings") Core.<*> (o Core..:? "nextPageToken"))
...
instance Core.ToJSON LoggingConfig where
        toJSON LoggingConfig{..}
          = Core.object
              (Core.catMaybes
                 [("instanceCloudLoggingDisabled" Core..=) Core.<$>
...
newMaintenanceEvent 
    ::  MaintenanceEvent
newMaintenanceEvent
  = MaintenanceEvent{endTime = Core.Nothing,
                     startTime = Core.Nothing, state = Core.Nothing}
instance Core.FromJSON MaintenanceEvent where
        parseJSON
          = Core.withObject "MaintenanceEvent"
              (\ o ->
                 MaintenanceEvent Core.<$>
...
newMaintenancePolicy 
    ::  MaintenancePolicy
newMaintenancePolicy
  = MaintenancePolicy{maintenanceExclusionWindow = Core.Nothing,
          ...
          = Core.withObject "MaintenancePolicy"
              (\ o ->
                 MaintenancePolicy Core.<$>
                   (o Core..:? "maintenanceExclusionWindow") Core.<*>
                     (o Core..:? "maintenanceWindow"))

instance Core.ToJSON MaintenancePolicy where
        toJSON MaintenancePolicy{..}
          = Core.object
              (Core.catMaybes
                 [("maintenanceExclusionWindow" Core..=) Core.<$>
...
newNetworkConfig 
    ::  NetworkConfig
newNetworkConfig
  = NetworkConfig{connectionType = Core.Nothing,
                  ipAllocation = Core.Nothing, network = Core.Nothing,
...
instance Core.FromJSON NetworkConfig where
        parseJSON
          = Core.withObject "NetworkConfig"
              (\ o ->
                 NetworkConfig Core.<$>
                   (o Core..:? "connectionType") Core.<*> (o Core..:? "ipAllocation")
                     Core.<*> (o Core..:? "network")
          ...
          = Core.object
              (Core.catMaybes
                 [("connectionType" Core..=) Core.<$> connectionType,
                  ...
                  ("privateServiceConnectConfig" Core..=) Core.<$>
                    privateServiceConnectConfig])
...
newOperationMetadata 
    ::  OperationMetadata
newOperationMetadata
  = OperationMetadata{additionalStatus = Core.Nothing,
                      apiVersion = Core.Nothing, createTime = Core.Nothing,
                      endTime = Core.Nothing, requestedCancellation = Core.Nothing,
          ...
          = Core.withObject "OperationMetadata"
              (\ o ->
                 OperationMetadata Core.<$>
                   (o Core..:? "additionalStatus") Core.<*> (o Core..:? "apiVersion")
                     Core.<*> (o Core..:? "createTime")
                     Core.<*> (o Core..:? "endTime")
...
instance Core.FromJSON OperationMetadata_AdditionalStatus where
        parseJSON
          = Core.withObject "OperationMetadata_AdditionalStatus"
              (\ o ->
...
instance Core.ToJSON PrivateServiceConnectConfig where
        toJSON PrivateServiceConnectConfig{..}
          = Core.object
              (Core.catMaybes
                 [("effectiveUnreachableCidrBlock" Core..=) Core.<$>
...
newVersion 
    ::  Version
newVersion
  = Version{availableFeatures = Core.Nothing,
            defaultVersion = Core.Nothing, type' = Core.Nothing,
