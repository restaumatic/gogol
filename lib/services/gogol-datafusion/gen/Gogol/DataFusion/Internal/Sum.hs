  ...
  (
    ...
    Instance_DisabledReasonItem
      (
        ...
        Instance_DisabledReasonItem_PROJECTSTATEOFF,
        ..
      ),
...
pattern Instance_DisabledReasonItem_PROJECTSTATEOFF :: Instance_DisabledReasonItem
pattern Instance_DisabledReasonItem_PROJECTSTATEOFF = Instance_DisabledReasonItem "PROJECT_STATE_OFF"
...
pattern Instance_State_Enabling :: Instance_State
pattern Instance_State_Enabling = Instance_State "ENABLING"
