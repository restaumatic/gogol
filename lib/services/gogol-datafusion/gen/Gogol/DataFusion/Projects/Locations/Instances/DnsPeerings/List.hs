                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] ListDnsPeeringsResponse
...
newDataFusionProjectsLocationsInstancesDnsPeeringsList parent
  = DataFusionProjectsLocationsInstancesDnsPeeringsList{xgafv =
                                                          Core.Nothing,
...
instance Core.GoogleRequest
           DataFusionProjectsLocationsInstancesDnsPeeringsList
         where
        type Rs DataFusionProjectsLocationsInstancesDnsPeeringsList =
             ListDnsPeeringsResponse
        type Scopes DataFusionProjectsLocationsInstancesDnsPeeringsList =
