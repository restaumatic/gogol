               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] RestartInstanceRequest Core.:>
...
newDataFusionProjectsLocationsInstancesRestart name payload
  = DataFusionProjectsLocationsInstancesRestart{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           DataFusionProjectsLocationsInstancesRestart
         where
        type Rs DataFusionProjectsLocationsInstancesRestart = Operation
        type Scopes DataFusionProjectsLocationsInstancesRestart =
             '[CloudPlatform'FullControl]
        requestClient DataFusionProjectsLocationsInstancesRestart{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DataFusionProjectsLocationsInstancesRestartResource)
                      Core.mempty
