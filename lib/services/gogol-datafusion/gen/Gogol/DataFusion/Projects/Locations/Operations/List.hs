...
newDataFusionProjectsLocationsOperationsList name
  = DataFusionProjectsLocationsOperationsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           DataFusionProjectsLocationsOperationsList
         where
        type Rs DataFusionProjectsLocationsOperationsList =
             ListOperationsResponse
        type Scopes DataFusionProjectsLocationsOperationsList =
             '[CloudPlatform'FullControl]
        requestClient DataFusionProjectsLocationsOperationsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DataFusionProjectsLocationsOperationsListResource)
                      Core.mempty
