...
newDataFusionProjectsLocationsInstancesDnsPeeringsDelete name
  = DataFusionProjectsLocationsInstancesDnsPeeringsDelete{xgafv =
                                                            Core.Nothing,
...
instance Core.GoogleRequest
           DataFusionProjectsLocationsInstancesDnsPeeringsDelete
         where
        type Rs DataFusionProjectsLocationsInstancesDnsPeeringsDelete =
             Empty
        type Scopes DataFusionProjectsLocationsInstancesDnsPeeringsDelete =
