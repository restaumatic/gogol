...
newDataFusionProjectsLocationsInstancesList parent
  = DataFusionProjectsLocationsInstancesList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           DataFusionProjectsLocationsInstancesList
         where
        type Rs DataFusionProjectsLocationsInstancesList =
             ListInstancesResponse
        type Scopes DataFusionProjectsLocationsInstancesList =
             '[CloudPlatform'FullControl]
        requestClient DataFusionProjectsLocationsInstancesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DataFusionProjectsLocationsInstancesListResource)
                      Core.mempty
