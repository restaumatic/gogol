...
newDataFusionProjectsLocationsInstancesGet name
  = DataFusionProjectsLocationsInstancesGet{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            name = name, uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DataFusionProjectsLocationsInstancesGet
         where
        type Rs DataFusionProjectsLocationsInstancesGet = Instance
        type Scopes DataFusionProjectsLocationsInstancesGet =
             '[CloudPlatform'FullControl]
        requestClient DataFusionProjectsLocationsInstancesGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DataFusionProjectsLocationsInstancesGetResource)
                      Core.mempty
