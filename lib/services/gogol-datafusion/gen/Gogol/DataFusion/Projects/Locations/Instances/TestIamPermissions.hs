...
newDataFusionProjectsLocationsInstancesTestIamPermissions 
    ...
    -> DataFusionProjectsLocationsInstancesTestIamPermissions
newDataFusionProjectsLocationsInstancesTestIamPermissions payload
  resource
  = DataFusionProjectsLocationsInstancesTestIamPermissions{xgafv =
                                                             Core.Nothing,
...
instance Core.GoogleRequest
           DataFusionProjectsLocationsInstancesTestIamPermissions
         where
        type Rs DataFusionProjectsLocationsInstancesTestIamPermissions =
             TestIamPermissionsResponse
        type Scopes DataFusionProjectsLocationsInstancesTestIamPermissions
