...
newDataFusionProjectsLocationsOperationsGet name
  = DataFusionProjectsLocationsOperationsGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           DataFusionProjectsLocationsOperationsGet
         where
        type Rs DataFusionProjectsLocationsOperationsGet = Operation
        type Scopes DataFusionProjectsLocationsOperationsGet =
             '[CloudPlatform'FullControl]
        requestClient DataFusionProjectsLocationsOperationsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DataFusionProjectsLocationsOperationsGetResource)
                      Core.mempty
