...
newDataFusionProjectsLocationsOperationsDelete name
  = DataFusionProjectsLocationsOperationsDelete{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           DataFusionProjectsLocationsOperationsDelete
         where
        type Rs DataFusionProjectsLocationsOperationsDelete = Empty
        type Scopes DataFusionProjectsLocationsOperationsDelete =
             '[CloudPlatform'FullControl]
        requestClient DataFusionProjectsLocationsOperationsDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DataFusionProjectsLocationsOperationsDeleteResource)
                      Core.mempty
