...
newDataFusionProjectsLocationsVersionsList parent
  = DataFusionProjectsLocationsVersionsList{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            latestPatchOnly = Core.Nothing, pageSize = Core.Nothing,
                                            pageToken = Core.Nothing, parent = parent,
                                            uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DataFusionProjectsLocationsVersionsList
         where
        type Rs DataFusionProjectsLocationsVersionsList =
             ListAvailableVersionsResponse
        type Scopes DataFusionProjectsLocationsVersionsList =
             '[CloudPlatform'FullControl]
        requestClient DataFusionProjectsLocationsVersionsList{..}
          = go parent xgafv accessToken callback latestPatchOnly pageSize
              pageToken
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DataFusionProjectsLocationsVersionsListResource)
                      Core.mempty
