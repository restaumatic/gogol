...
newDataFusionProjectsLocationsOperationsCancel name payload
  = DataFusionProjectsLocationsOperationsCancel{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           DataFusionProjectsLocationsOperationsCancel
         where
        type Rs DataFusionProjectsLocationsOperationsCancel = Empty
        type Scopes DataFusionProjectsLocationsOperationsCancel =
             '[CloudPlatform'FullControl]
        requestClient DataFusionProjectsLocationsOperationsCancel{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DataFusionProjectsLocationsOperationsCancelResource)
                      Core.mempty
