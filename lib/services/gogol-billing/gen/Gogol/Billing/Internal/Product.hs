...
newAggregationInfo 
    ::  AggregationInfo
newAggregationInfo
  = AggregationInfo{aggregationCount = Core.Nothing,
...
instance Core.ToJSON AggregationInfo where
        toJSON AggregationInfo{..}
          = Core.object
              (Core.catMaybes
                 [("aggregationCount" Core..=) Core.<$> aggregationCount,
                  ("aggregationInterval" Core..=) Core.<$> aggregationInterval,
                  ("aggregationLevel" Core..=) Core.<$> aggregationLevel])
...
newBillingAccount 
    ::  BillingAccount
newBillingAccount
  = BillingAccount{currencyCode = Core.Nothing,
                   displayName = Core.Nothing, masterBillingAccount = Core.Nothing,
                   name = Core.Nothing, open = Core.Nothing, parent = Core.Nothing}
instance Core.FromJSON BillingAccount where
        parseJSON
          = Core.withObject "BillingAccount"
              (\ o ->
                 BillingAccount Core.<$>
                   (o Core..:? "currencyCode") Core.<*> (o Core..:? "displayName")
          ...
          = Core.object
              (Core.catMaybes
                 [("currencyCode" Core..=) Core.<$> currencyCode,
                  ...
                  ("masterBillingAccount" Core..=) Core.<$> masterBillingAccount,
                  ("name" Core..=) Core.<$> name, ("open" Core..=) Core.<$> open,
...
newCategory 
    ::  Category
newCategory
  = Category{resourceFamily = Core.Nothing,
             resourceGroup = Core.Nothing, serviceDisplayName = Core.Nothing,
...
instance Core.FromJSON Category where
        parseJSON
          = Core.withObject "Category"
              (\ o ->
                 Category Core.<$>
                   (o Core..:? "resourceFamily") Core.<*> (o Core..:? "resourceGroup")
          ...
          = Core.object
              (Core.catMaybes
                 [("resourceFamily" Core..=) Core.<$> resourceFamily,
                  ...
                  ("serviceDisplayName" Core..=) Core.<$> serviceDisplayName,
...
newGeoTaxonomy 
    ::  GeoTaxonomy
newGeoTaxonomy
  = GeoTaxonomy{regions = Core.Nothing, type' = Core.Nothing}
...
newListBillingAccountsResponse 
    ::  ListBillingAccountsResponse
newListBillingAccountsResponse
  = ListBillingAccountsResponse{billingAccounts = Core.Nothing,
...
instance Core.ToJSON ListBillingAccountsResponse where
        toJSON ListBillingAccountsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("billingAccounts" Core..=) Core.<$> billingAccounts,
...
newListProjectBillingInfoResponse 
    ::  ListProjectBillingInfoResponse
newListProjectBillingInfoResponse
  = ListProjectBillingInfoResponse{nextPageToken = Core.Nothing,
...
instance Core.ToJSON ListProjectBillingInfoResponse where
        toJSON ListProjectBillingInfoResponse{..}
          = Core.object
              (Core.catMaybes
                 [("nextPageToken" Core..=) Core.<$> nextPageToken,
                  ("projectBillingInfo" Core..=) Core.<$> projectBillingInfo])
...
newListSkusResponse 
    ::  ListSkusResponse
newListSkusResponse
  = ListSkusResponse{nextPageToken = Core.Nothing,
                     skus = Core.Nothing}
          ...
          = Core.withObject "ListSkusResponse"
              (\ o ->
                 ListSkusResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "skus"))
...
--
-- /See:/ 'newMoveBillingAccountRequest' smart constructor.
newtype MoveBillingAccountRequest = MoveBillingAccountRequest
    {
...
-- | Creates a value of 'MoveBillingAccountRequest' with the minimum fields required to make a request.
newMoveBillingAccountRequest 
    ::  MoveBillingAccountRequest
newMoveBillingAccountRequest
  = MoveBillingAccountRequest{destinationParent = Core.Nothing}
instance Core.FromJSON MoveBillingAccountRequest where
        parseJSON
          = Core.withObject "MoveBillingAccountRequest"
              (\ o ->
                 MoveBillingAccountRequest Core.<$>
                   (o Core..:? "destinationParent"))

instance Core.ToJSON MoveBillingAccountRequest where
        toJSON MoveBillingAccountRequest{..}
          = Core.object
              (Core.catMaybes
...
newPricingExpression 
    ::  PricingExpression
newPricingExpression
  = PricingExpression{baseUnit = Core.Nothing,
                      baseUnitConversionFactor = Core.Nothing,
                      baseUnitDescription = Core.Nothing, displayQuantity = Core.Nothing,
                      tieredRates = Core.Nothing, usageUnit = Core.Nothing,
...
newPricingInfo 
    ::  PricingInfo
newPricingInfo
  = PricingInfo{aggregationInfo = Core.Nothing,
                currencyConversionRate = Core.Nothing,
                effectiveTime = Core.Nothing, pricingExpression = Core.Nothing,
...
instance Core.ToJSON PricingInfo where
        toJSON PricingInfo{..}
          = Core.object
              (Core.catMaybes
                 [("aggregationInfo" Core..=) Core.<$> aggregationInfo,
                  ("currencyConversionRate" Core..=) Core.<$> currencyConversionRate,
                  ("effectiveTime" Core..=) Core.<$> effectiveTime,
                  ("pricingExpression" Core..=) Core.<$> pricingExpression,
...
newProjectBillingInfo 
    ::  ProjectBillingInfo
newProjectBillingInfo
  = ProjectBillingInfo{billingAccountName = Core.Nothing,
                       billingEnabled = Core.Nothing, name = Core.Nothing,
...
instance Core.ToJSON ProjectBillingInfo where
        toJSON ProjectBillingInfo{..}
          = Core.object
              (Core.catMaybes
                 [("billingAccountName" Core..=) Core.<$> billingAccountName,
...
newService 
    ::  Service
newService
  = Service{businessEntityName = Core.Nothing,
...
instance Core.ToJSON Service where
        toJSON Service{..}
          = Core.object
              (Core.catMaybes
                 [("businessEntityName" Core..=) Core.<$> businessEntityName,
                  ("displayName" Core..=) Core.<$> displayName,
                  ("name" Core..=) Core.<$> name,
...
newSku 
    ::  Sku
newSku
  = Sku{category = Core.Nothing, description = Core.Nothing,
        geoTaxonomy = Core.Nothing, name = Core.Nothing,
        pricingInfo = Core.Nothing, serviceProviderName = Core.Nothing,
        serviceRegions = Core.Nothing, skuId = Core.Nothing}
instance Core.FromJSON Sku where
        parseJSON
          = Core.withObject "Sku"
              (\ o ->
                 Sku Core.<$>
                   (o Core..:? "category") Core.<*> (o Core..:? "description")
...
newTierRate 
    ::  TierRate
newTierRate
  = TierRate{startUsageAmount = Core.Nothing,
...
instance Core.FromJSON TierRate where
        parseJSON
          = Core.withObject "TierRate"
              (\ o ->
                 TierRate Core.<$>
                   (o Core..:? "startUsageAmount") Core.<*> (o Core..:? "unitPrice"))

instance Core.ToJSON TierRate where
        toJSON TierRate{..}
          = Core.object
              (Core.catMaybes
                 [("startUsageAmount" Core..=) Core.<$> startUsageAmount,
