...
newCloudbillingBillingAccountsProjectsList name
  = CloudbillingBillingAccountsProjectsList{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            name = name, pageSize = Core.Nothing,
                                            pageToken = Core.Nothing, uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudbillingBillingAccountsProjectsList
         where
        ...
        requestClient CloudbillingBillingAccountsProjectsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudbillingBillingAccountsProjectsListResource)
                      Core.mempty
