...
--
-- /See:/ <https://cloud.google.com/billing/docs/apis Cloud Billing API Reference> for @cloudbilling.billingAccounts.getIamPolicy@.
module Gogol.Billing.Cloudbilling.BillingAccounts.GetIamPolicy
    (
    -- * Resource
...
newCloudbillingBillingAccountsGetIamPolicy resource
  = CloudbillingBillingAccountsGetIamPolicy{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            optionsRequestedPolicyVersion = Core.Nothing,
                                            resource = resource, uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudbillingBillingAccountsGetIamPolicy
         where
        type Rs CloudbillingBillingAccountsGetIamPolicy = Policy
        type Scopes CloudbillingBillingAccountsGetIamPolicy =
             '[CloudBilling'FullControl, CloudBilling'Readonly,
               CloudPlatform'FullControl]
        requestClient CloudbillingBillingAccountsGetIamPolicy{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudbillingBillingAccountsGetIamPolicyResource)
                      Core.mempty
