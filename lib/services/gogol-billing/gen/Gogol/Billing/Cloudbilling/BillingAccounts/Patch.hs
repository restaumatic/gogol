...
newCloudbillingBillingAccountsPatch name payload
  = CloudbillingBillingAccountsPatch{xgafv = Core.Nothing,
                                     accessToken = Core.Nothing, callback = Core.Nothing,
                                     name = name, payload = payload, updateMask = Core.Nothing,
                                     uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudbillingBillingAccountsPatch where
        type Rs CloudbillingBillingAccountsPatch = BillingAccount
        ...
        requestClient CloudbillingBillingAccountsPatch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy CloudbillingBillingAccountsPatchResource)
                      Core.mempty
