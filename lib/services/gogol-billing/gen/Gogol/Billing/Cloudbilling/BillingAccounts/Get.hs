...
--
-- /See:/ <https://cloud.google.com/billing/docs/apis Cloud Billing API Reference> for @cloudbilling.billingAccounts.get@.
module Gogol.Billing.Cloudbilling.BillingAccounts.Get
    (
    -- * Resource
...
newCloudbillingBillingAccountsGet name
  = CloudbillingBillingAccountsGet{xgafv = Core.Nothing,
                                   accessToken = Core.Nothing, callback = Core.Nothing, name = name,
                                   uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudbillingBillingAccountsGet where
        type Rs CloudbillingBillingAccountsGet = BillingAccount
        ...
        requestClient CloudbillingBillingAccountsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy CloudbillingBillingAccountsGetResource)
                      Core.mempty
