...
-- |
-- Module      : Gogol.Billing.Cloudbilling.BillingAccounts.SubAccounts.Create
...
--
-- /See:/ <https://cloud.google.com/billing/docs/apis Cloud Billing API Reference> for @cloudbilling.billingAccounts.subAccounts.create@.
module Gogol.Billing.Cloudbilling.BillingAccounts.SubAccounts.Create
    (
    -- * Resource
...
-- | A resource alias for @cloudbilling.billingAccounts.subAccounts.create@ method which the
-- 'CloudbillingBillingAccountsSubAccountsCreate' request conforms to.
type CloudbillingBillingAccountsSubAccountsCreateResource =
     "v1" Core.:>
...
-- | This method creates <https://cloud.google.com/billing/docs/concepts#subaccounts billing subaccounts>. Google Cloud resellers should use the Channel Services APIs, <https://cloud.google.com/channel/docs/reference/rest/v1/accounts.customers/create accounts.customers.create> and <https://cloud.google.com/channel/docs/reference/rest/v1/accounts.customers.entitlements/create accounts.customers.entitlements.create>. When creating a subaccount, the current authenticated user must have the @billing.accounts.update@ IAM permission on the parent account, which is typically given to billing account <https://cloud.google.com/billing/docs/how-to/billing-access administrators>. This method will return an error if the parent account has not been provisioned for subaccounts.
--
-- /See:/ 'newCloudbillingBillingAccountsSubAccountsCreate' smart constructor.
data CloudbillingBillingAccountsSubAccountsCreate = CloudbillingBillingAccountsSubAccountsCreate
    {
      -- | V1 error format.
...
-- | Creates a value of 'CloudbillingBillingAccountsSubAccountsCreate' with the minimum fields required to make a request.
newCloudbillingBillingAccountsSubAccountsCreate 
    :: 
                                                Core.Text
    ...
    -> CloudbillingBillingAccountsSubAccountsCreate
newCloudbillingBillingAccountsSubAccountsCreate parent payload
  = CloudbillingBillingAccountsSubAccountsCreate{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
           CloudbillingBillingAccountsSubAccountsCreate
         where
        type Rs CloudbillingBillingAccountsSubAccountsCreate =
             BillingAccount
        type Scopes CloudbillingBillingAccountsSubAccountsCreate =
             '[CloudBilling'FullControl, CloudPlatform'FullControl]
        requestClient CloudbillingBillingAccountsSubAccountsCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudbillingBillingAccountsSubAccountsCreateResource)
                      Core.mempty
