...
newCloudbillingBillingAccountsCreate payload
  = CloudbillingBillingAccountsCreate{xgafv = Core.Nothing,
                                      accessToken = Core.Nothing, callback = Core.Nothing,
                                      parent = Core.Nothing, payload = payload,
                                      uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudbillingBillingAccountsCreate where
        type Rs CloudbillingBillingAccountsCreate = BillingAccount
        ...
        requestClient CloudbillingBillingAccountsCreate{..}
          = go xgafv accessToken callback parent uploadType uploadProtocol
