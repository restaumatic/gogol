...
newCloudbillingBillingAccountsSubAccountsList parent
  = CloudbillingBillingAccountsSubAccountsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           CloudbillingBillingAccountsSubAccountsList
         where
        type Rs CloudbillingBillingAccountsSubAccountsList =
             ListBillingAccountsResponse
        type Scopes CloudbillingBillingAccountsSubAccountsList =
