...
type CloudbillingOrganizationsBillingAccountsMoveResource =
     "v1" Core.:>
       Core.Capture "destinationParent" Core.Text Core.:>
...
newCloudbillingOrganizationsBillingAccountsMove 
    ...
    -> CloudbillingOrganizationsBillingAccountsMove
newCloudbillingOrganizationsBillingAccountsMove destinationParent
  name
  = CloudbillingOrganizationsBillingAccountsMove{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
           CloudbillingOrganizationsBillingAccountsMove
         where
        type Rs CloudbillingOrganizationsBillingAccountsMove =
             BillingAccount
        type Scopes CloudbillingOrganizationsBillingAccountsMove =
             '[CloudBilling'FullControl, CloudPlatform'FullControl]
        requestClient CloudbillingOrganizationsBillingAccountsMove{..}
          = go destinationParent name xgafv accessToken callback uploadType
              uploadProtocol
