...
newCloudbillingOrganizationsBillingAccountsList parent
  = CloudbillingOrganizationsBillingAccountsList{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes CloudbillingOrganizationsBillingAccountsList =
             '[CloudBilling'FullControl, CloudBilling'Readonly,
               CloudPlatform'FullControl]
        requestClient CloudbillingOrganizationsBillingAccountsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudbillingOrganizationsBillingAccountsListResource)
                      Core.mempty
