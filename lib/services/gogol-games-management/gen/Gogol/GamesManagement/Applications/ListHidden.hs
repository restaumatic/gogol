...
--
-- /See:/ <https://developers.google.com/games/ Google Play Games Services Management API Reference> for @gamesManagement.applications.listHidden@.
module Gogol.GamesManagement.Applications.ListHidden
    (
    -- * Resource
                           ...
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.Get '[Core.JSON] HiddenPlayerList
...
newGamesManagementApplicationsListHidden applicationId
  = GamesManagementApplicationsListHidden{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, applicationId = applicationId,
                                          callback = Core.Nothing, maxResults = Core.Nothing,
                                          pageToken = Core.Nothing, uploadType = Core.Nothing,
                                          uploadProtocol = Core.Nothing}
instance Core.GoogleRequest GamesManagementApplicationsListHidden
         where
        type Rs GamesManagementApplicationsListHidden = HiddenPlayerList
        type Scopes GamesManagementApplicationsListHidden =
             '[Games'FullControl]
