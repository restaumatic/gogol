...
--
-- /See:/ <https://developers.google.com/games/ Google Play Games Services Management API Reference> for @gamesManagement.achievements.resetAllForAllPlayers@.
module Gogol.GamesManagement.Achievements.ResetAllForAllPlayers
    (
    -- * Resource
...
newGamesManagementAchievementsResetAllForAllPlayers 
    :: 
                                                    GamesManagementAchievementsResetAllForAllPlayers
newGamesManagementAchievementsResetAllForAllPlayers
  = GamesManagementAchievementsResetAllForAllPlayers{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           GamesManagementAchievementsResetAllForAllPlayers
         where
        type Rs GamesManagementAchievementsResetAllForAllPlayers = ()
        type Scopes GamesManagementAchievementsResetAllForAllPlayers =
             '[Games'FullControl]
        requestClient GamesManagementAchievementsResetAllForAllPlayers{..}
