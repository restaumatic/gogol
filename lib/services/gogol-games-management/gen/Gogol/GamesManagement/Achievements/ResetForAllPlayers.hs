...
--
-- /See:/ <https://developers.google.com/games/ Google Play Games Services Management API Reference> for @gamesManagement.achievements.resetForAllPlayers@.
module Gogol.GamesManagement.Achievements.ResetForAllPlayers
    (
    -- * Resource
...
newGamesManagementAchievementsResetForAllPlayers achievementId
  = GamesManagementAchievementsResetForAllPlayers{xgafv =
                                                    Core.Nothing,
...
instance Core.GoogleRequest
           GamesManagementAchievementsResetForAllPlayers
         where
        type Rs GamesManagementAchievementsResetForAllPlayers = ()
        type Scopes GamesManagementAchievementsResetForAllPlayers =
             '[Games'FullControl]
        requestClient GamesManagementAchievementsResetForAllPlayers{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy GamesManagementAchievementsResetForAllPlayersResource)
                      Core.mempty
