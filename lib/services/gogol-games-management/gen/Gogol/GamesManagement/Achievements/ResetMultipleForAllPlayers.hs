...
--
-- /See:/ <https://developers.google.com/games/ Google Play Games Services Management API Reference> for @gamesManagement.achievements.resetMultipleForAllPlayers@.
module Gogol.GamesManagement.Achievements.ResetMultipleForAllPlayers
    (
    -- * Resource
                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] AchievementResetMultipleForAllRequest
...
newGamesManagementAchievementsResetMultipleForAllPlayers payload
  = GamesManagementAchievementsResetMultipleForAllPlayers{xgafv =
                                                            Core.Nothing,
...
instance Core.GoogleRequest
           GamesManagementAchievementsResetMultipleForAllPlayers
         where
        type Rs GamesManagementAchievementsResetMultipleForAllPlayers = ()
        type Scopes GamesManagementAchievementsResetMultipleForAllPlayers =
             '[Games'FullControl]
        requestClient
          GamesManagementAchievementsResetMultipleForAllPlayers{..}
