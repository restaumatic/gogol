...
--
-- /See:/ <https://developers.google.com/games/ Google Play Games Services Management API Reference> for @gamesManagement.achievements.resetAll@.
module Gogol.GamesManagement.Achievements.ResetAll
    (
    -- * Resource
                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.Post '[Core.JSON] AchievementResetAllResponse
...
newGamesManagementAchievementsResetAll 
    :: 
                                       GamesManagementAchievementsResetAll
newGamesManagementAchievementsResetAll
  = GamesManagementAchievementsResetAll{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest GamesManagementAchievementsResetAll
         where
        type Rs GamesManagementAchievementsResetAll =
             AchievementResetAllResponse
        type Scopes GamesManagementAchievementsResetAll =
             '[Games'FullControl]
