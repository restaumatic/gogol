...
newAchievementResetAllResponse 
    ::  AchievementResetAllResponse
newAchievementResetAllResponse
  = AchievementResetAllResponse{kind = Core.Nothing,
                                results = Core.Nothing}
instance Core.FromJSON AchievementResetAllResponse where
        parseJSON
          = Core.withObject "AchievementResetAllResponse"
              (\ o ->
                 AchievementResetAllResponse Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "results"))
...
newAchievementResetMultipleForAllRequest 
    :: 
                                         AchievementResetMultipleForAllRequest
newAchievementResetMultipleForAllRequest
  = AchievementResetMultipleForAllRequest{achievementIds =
                                            Core.Nothing,
                                          kind = Core.Nothing}
instance Core.FromJSON AchievementResetMultipleForAllRequest where
        parseJSON
          = Core.withObject "AchievementResetMultipleForAllRequest"
              (\ o ->
                 AchievementResetMultipleForAllRequest Core.<$>
                   (o Core..:? "achievement_ids") Core.<*> (o Core..:? "kind"))

instance Core.ToJSON AchievementResetMultipleForAllRequest where
...
newAchievementResetResponse 
    ::  AchievementResetResponse
newAchievementResetResponse
  = AchievementResetResponse{currentState = Core.Nothing,
                             definitionId = Core.Nothing, kind = Core.Nothing,
          ...
          = Core.withObject "AchievementResetResponse"
              (\ o ->
                 AchievementResetResponse Core.<$>
                   (o Core..:? "currentState") Core.<*> (o Core..:? "definitionId")
                     Core.<*> (o Core..:? "kind")
...
newEventsResetMultipleForAllRequest 
    :: 
                                    EventsResetMultipleForAllRequest
newEventsResetMultipleForAllRequest
  = EventsResetMultipleForAllRequest{eventIds = Core.Nothing,
                                     kind = Core.Nothing}
instance Core.FromJSON EventsResetMultipleForAllRequest where
        parseJSON
          = Core.withObject "EventsResetMultipleForAllRequest"
              (\ o ->
                 EventsResetMultipleForAllRequest Core.<$>
                   (o Core..:? "event_ids") Core.<*> (o Core..:? "kind"))

instance Core.ToJSON EventsResetMultipleForAllRequest where
...
newGamesPlayerExperienceInfoResource 
    :: 
                                     GamesPlayerExperienceInfoResource
newGamesPlayerExperienceInfoResource
  = GamesPlayerExperienceInfoResource{currentExperiencePoints =
                                        Core.Nothing,
                                      currentLevel = Core.Nothing,
                                      lastLevelUpTimestampMillis = Core.Nothing,
                                      nextLevel = Core.Nothing}
instance Core.FromJSON GamesPlayerExperienceInfoResource where
        parseJSON
...
instance Core.ToJSON GamesPlayerExperienceInfoResource where
...
newGamesPlayerLevelResource 
    ::  GamesPlayerLevelResource
newGamesPlayerLevelResource
  = GamesPlayerLevelResource{level = Core.Nothing,
...
newHiddenPlayer 
    ::  HiddenPlayer
newHiddenPlayer
  = HiddenPlayer{hiddenTimeMillis = Core.Nothing,
                 kind = Core.Nothing, player = Core.Nothing}
instance Core.FromJSON HiddenPlayer where
        parseJSON
          = Core.withObject "HiddenPlayer"
              (\ o ->
                 HiddenPlayer Core.<$>
                   (o Core..:? "hiddenTimeMillis" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "kind")
                     Core.<*> (o Core..:? "player"))
...
instance Core.ToJSON HiddenPlayer where
        toJSON HiddenPlayer{..}
          = Core.object
              (Core.catMaybes
                 [("hiddenTimeMillis" Core..=) Core.. Core.AsText Core.<$>
                    hiddenTimeMillis,
                  ("kind" Core..=) Core.<$> kind,
...
newHiddenPlayerList 
    ::  HiddenPlayerList
newHiddenPlayerList
  = HiddenPlayerList{items = Core.Nothing, kind = Core.Nothing,
...
newPlayer
  = Player{avatarImageUrl = Core.Nothing,
           ...
           experienceInfo = Core.Nothing, kind = Core.Nothing,
...
newPlayerScoreResetAllResponse 
    ::  PlayerScoreResetAllResponse
newPlayerScoreResetAllResponse
  = PlayerScoreResetAllResponse{kind = Core.Nothing,
                                results = Core.Nothing}
instance Core.FromJSON PlayerScoreResetAllResponse where
        parseJSON
...
newPlayerScoreResetResponse 
    ::  PlayerScoreResetResponse
newPlayerScoreResetResponse
  = PlayerScoreResetResponse{definitionId = Core.Nothing,
                             kind = Core.Nothing, resetScoreTimeSpans = Core.Nothing}
        ...
        toJSON PlayerScoreResetResponse{..}
          = Core.object
              (Core.catMaybes
                 [("definitionId" Core..=) Core.<$> definitionId,
                  ("kind" Core..=) Core.<$> kind,
                  ("resetScoreTimeSpans" Core..=) Core.<$> resetScoreTimeSpans])
...
newProfileSettings 
    ::  ProfileSettings
newProfileSettings
  = ProfileSettings{kind = Core.Nothing,
          ...
          = Core.withObject "ProfileSettings"
              (\ o ->
                 ProfileSettings Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "profileVisible"))
...
newScoresResetMultipleForAllRequest 
    :: 
                                    ScoresResetMultipleForAllRequest
newScoresResetMultipleForAllRequest
  = ScoresResetMultipleForAllRequest{kind = Core.Nothing,
                                     leaderboardIds = Core.Nothing}
instance Core.FromJSON ScoresResetMultipleForAllRequest where
        parseJSON
          = Core.withObject "ScoresResetMultipleForAllRequest"
              (\ o ->
                 ScoresResetMultipleForAllRequest Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "leaderboard_ids"))
