...
--
-- /See:/ <https://developers.google.com/games/ Google Play Games Services Management API Reference> for @gamesManagement.players.hide@.
module Gogol.GamesManagement.Players.Hide
    (
    -- * Resource
...
newGamesManagementPlayersHide applicationId playerId
  = GamesManagementPlayersHide{xgafv = Core.Nothing,
