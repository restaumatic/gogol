...
--
-- /See:/ <https://developers.google.com/games/ Google Play Games Services Management API Reference> for @gamesManagement.scores.resetForAllPlayers@.
module Gogol.GamesManagement.Scores.ResetForAllPlayers
    (
    -- * Resource
...
newGamesManagementScoresResetForAllPlayers leaderboardId
  = GamesManagementScoresResetForAllPlayers{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            leaderboardId = leaderboardId,
                                            uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest GamesManagementScoresResetForAllPlayers
         where
        type Rs GamesManagementScoresResetForAllPlayers = ()
        type Scopes GamesManagementScoresResetForAllPlayers =
             '[Games'FullControl]
