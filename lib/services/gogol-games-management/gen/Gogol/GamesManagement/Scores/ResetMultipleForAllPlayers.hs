...
--
-- /See:/ <https://developers.google.com/games/ Google Play Games Services Management API Reference> for @gamesManagement.scores.resetMultipleForAllPlayers@.
module Gogol.GamesManagement.Scores.ResetMultipleForAllPlayers
    (
    -- * Resource
                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] ScoresResetMultipleForAllRequest Core.:>
                           Core.Post '[Core.JSON] ()
...
newGamesManagementScoresResetMultipleForAllPlayers payload
  = GamesManagementScoresResetMultipleForAllPlayers{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes GamesManagementScoresResetMultipleForAllPlayers =
             '[Games'FullControl]
