...
--
-- /See:/ <https://developers.google.com/games/ Google Play Games Services Management API Reference> for @gamesManagement.scores.resetAllForAllPlayers@.
module Gogol.GamesManagement.Scores.ResetAllForAllPlayers
    (
    -- * Resource
...
newGamesManagementScoresResetAllForAllPlayers 
    :: 
                                              GamesManagementScoresResetAllForAllPlayers
newGamesManagementScoresResetAllForAllPlayers
  = GamesManagementScoresResetAllForAllPlayers{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes GamesManagementScoresResetAllForAllPlayers =
             '[Games'FullControl]
        requestClient GamesManagementScoresResetAllForAllPlayers{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy GamesManagementScoresResetAllForAllPlayersResource)
                      Core.mempty
