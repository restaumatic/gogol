...
--
-- /See:/ <https://developers.google.com/games/ Google Play Games Services Management API Reference> for @gamesManagement.scores.resetAll@.
module Gogol.GamesManagement.Scores.ResetAll
    (
    -- * Resource
...
newGamesManagementScoresResetAll 
    ::  GamesManagementScoresResetAll
newGamesManagementScoresResetAll
  = GamesManagementScoresResetAll{xgafv = Core.Nothing,
