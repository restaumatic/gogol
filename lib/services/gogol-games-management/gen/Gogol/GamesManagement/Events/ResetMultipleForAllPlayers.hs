...
--
-- /See:/ <https://developers.google.com/games/ Google Play Games Services Management API Reference> for @gamesManagement.events.resetMultipleForAllPlayers@.
module Gogol.GamesManagement.Events.ResetMultipleForAllPlayers
    (
    -- * Resource
                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] EventsResetMultipleForAllRequest Core.:>
                           Core.Post '[Core.JSON] ()
...
newGamesManagementEventsResetMultipleForAllPlayers payload
  = GamesManagementEventsResetMultipleForAllPlayers{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           GamesManagementEventsResetMultipleForAllPlayers
         where
        type Rs GamesManagementEventsResetMultipleForAllPlayers = ()
        type Scopes GamesManagementEventsResetMultipleForAllPlayers =
             '[Games'FullControl]
        requestClient GamesManagementEventsResetMultipleForAllPlayers{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy GamesManagementEventsResetMultipleForAllPlayersResource)
                      Core.mempty
