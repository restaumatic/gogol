...
--
-- /See:/ <https://developers.google.com/games/ Google Play Games Services Management API Reference> for @gamesManagement.events.resetForAllPlayers@.
module Gogol.GamesManagement.Events.ResetForAllPlayers
    (
    -- * Resource
...
newGamesManagementEventsResetForAllPlayers eventId
  = GamesManagementEventsResetForAllPlayers{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            eventId = eventId, uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest GamesManagementEventsResetForAllPlayers
         where
