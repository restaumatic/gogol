...
--
-- /See:/ <https://developers.google.com/games/ Google Play Games Services Management API Reference> for @gamesManagement.events.resetAllForAllPlayers@.
module Gogol.GamesManagement.Events.ResetAllForAllPlayers
    (
    -- * Resource
...
newGamesManagementEventsResetAllForAllPlayers 
    :: 
                                              GamesManagementEventsResetAllForAllPlayers
newGamesManagementEventsResetAllForAllPlayers
  = GamesManagementEventsResetAllForAllPlayers{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           GamesManagementEventsResetAllForAllPlayers
         where
        type Rs GamesManagementEventsResetAllForAllPlayers = ()
        type Scopes GamesManagementEventsResetAllForAllPlayers =
             '[Games'FullControl]
        requestClient GamesManagementEventsResetAllForAllPlayers{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy GamesManagementEventsResetAllForAllPlayersResource)
                      Core.mempty
