...
--
-- /See:/ <https://developers.google.com/games/ Google Play Games Services Management API Reference> for @gamesManagement.events.resetAll@.
module Gogol.GamesManagement.Events.ResetAll
    (
    -- * Resource
...
newGamesManagementEventsResetAll 
    ::  GamesManagementEventsResetAll
newGamesManagementEventsResetAll
  = GamesManagementEventsResetAll{xgafv = Core.Nothing,
