...
-- |
-- Module      : Gogol.Indexing.Internal.Product
...
newPublishUrlNotificationResponse 
    ::  PublishUrlNotificationResponse
newPublishUrlNotificationResponse
  = PublishUrlNotificationResponse{urlNotificationMetadata =
                                     Core.Nothing}
instance Core.FromJSON PublishUrlNotificationResponse where
        parseJSON
          = Core.withObject "PublishUrlNotificationResponse"
              (\ o ->
                 PublishUrlNotificationResponse Core.<$>
                   (o Core..:? "urlNotificationMetadata"))

instance Core.ToJSON PublishUrlNotificationResponse where
        toJSON PublishUrlNotificationResponse{..}
          = Core.object
              (Core.catMaybes
                 [("urlNotificationMetadata" Core..=) Core.<$>
                    urlNotificationMetadata])
...
newUrlNotification 
    ::  UrlNotification
newUrlNotification
  = UrlNotification{notifyTime = Core.Nothing, type' = Core.Nothing,
                    url = Core.Nothing}
instance Core.FromJSON UrlNotification where
        parseJSON
          = Core.withObject "UrlNotification"
              (\ o ->
                 UrlNotification Core.<$>
                   (o Core..:? "notifyTime") Core.<*> (o Core..:? "type") Core.<*>
                     (o Core..:? "url"))
...
newUrlNotificationMetadata 
    ::  UrlNotificationMetadata
newUrlNotificationMetadata
  = UrlNotificationMetadata{latestRemove = Core.Nothing,
                            latestUpdate = Core.Nothing, url = Core.Nothing}
instance Core.FromJSON UrlNotificationMetadata where
        parseJSON
          = Core.withObject "UrlNotificationMetadata"
              (\ o ->
                 UrlNotificationMetadata Core.<$>
                   (o Core..:? "latestRemove") Core.<*> (o Core..:? "latestUpdate")
                     Core.<*> (o Core..:? "url"))
