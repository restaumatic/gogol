...
newListReposResponse 
    ::  ListReposResponse
newListReposResponse
  = ListReposResponse{nextPageToken = Core.Nothing,
                      repos = Core.Nothing}
          ...
          = Core.withObject "ListReposResponse"
              (\ o ->
                 ListReposResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "repos"))
...
newMirrorConfig 
    ::  MirrorConfig
newMirrorConfig
  = MirrorConfig{deployKeyId = Core.Nothing, url = Core.Nothing,
...
instance Core.FromJSON MirrorConfig where
        parseJSON
          = Core.withObject "MirrorConfig"
              (\ o ->
                 MirrorConfig Core.<$>
                   (o Core..:? "deployKeyId") Core.<*> (o Core..:? "url") Core.<*>
                     (o Core..:? "webhookId"))
...
newProjectConfig 
    ::  ProjectConfig
newProjectConfig
  = ProjectConfig{enablePrivateKeyCheck = Core.Nothing,
                  name = Core.Nothing, pubsubConfigs = Core.Nothing}
instance Core.FromJSON ProjectConfig where
        parseJSON
          = Core.withObject "ProjectConfig"
              (\ o ->
                 ProjectConfig Core.<$>
                   (o Core..:? "enablePrivateKeyCheck") Core.<*> (o Core..:? "name")
...
instance Core.ToJSON ProjectConfig where
        toJSON ProjectConfig{..}
          = Core.object
              (Core.catMaybes
                 [("enablePrivateKeyCheck" Core..=) Core.<$> enablePrivateKeyCheck,
                  ("name" Core..=) Core.<$> name,
...
instance Core.FromJSON ProjectConfig_PubsubConfigs where
        parseJSON
          = Core.withObject "ProjectConfig_PubsubConfigs"
              (\ o ->
                 ProjectConfig_PubsubConfigs Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON ProjectConfig_PubsubConfigs where
        toJSON ProjectConfig_PubsubConfigs{..} = Core.toJSON additional
...
newPubsubConfig 
    ::  PubsubConfig
newPubsubConfig
  = PubsubConfig{messageFormat = Core.Nothing,
                 serviceAccountEmail = Core.Nothing, topic = Core.Nothing}
...
newRepo 
    ::  Repo
newRepo
  = Repo{mirrorConfig = Core.Nothing, name = Core.Nothing,
         pubsubConfigs = Core.Nothing, size = Core.Nothing,
         url = Core.Nothing}
instance Core.FromJSON Repo where
        parseJSON
          = Core.withObject "Repo"
              (\ o ->
                 Repo Core.<$>
                   (o Core..:? "mirrorConfig") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "pubsubConfigs")
...
newRepo_PubsubConfigs 
    :: 
       ...
       -- ^  See 'additional'.
    -> Repo_PubsubConfigs
newRepo_PubsubConfigs additional
  = Repo_PubsubConfigs{additional = additional}
instance Core.FromJSON Repo_PubsubConfigs where
        parseJSON
          = Core.withObject "Repo_PubsubConfigs"
              (\ o -> Repo_PubsubConfigs Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON Repo_PubsubConfigs where
        toJSON Repo_PubsubConfigs{..} = Core.toJSON additional
...
newSyncRepoMetadata 
    ::  SyncRepoMetadata
newSyncRepoMetadata
  = SyncRepoMetadata{name = Core.Nothing, startTime = Core.Nothing,
                     statusMessage = Core.Nothing, updateTime = Core.Nothing}
instance Core.FromJSON SyncRepoMetadata where
        parseJSON
          = Core.withObject "SyncRepoMetadata"
              (\ o ->
                 SyncRepoMetadata Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "startTime") Core.<*>
                     (o Core..:? "statusMessage")
...
newUpdateProjectConfigRequest 
    ::  UpdateProjectConfigRequest
newUpdateProjectConfigRequest
  = UpdateProjectConfigRequest{projectConfig = Core.Nothing,
                               updateMask = Core.Nothing}
          ...
          = Core.withObject "UpdateProjectConfigRequest"
              (\ o ->
                 UpdateProjectConfigRequest Core.<$>
                   (o Core..:? "projectConfig") Core.<*> (o Core..:? "updateMask"))
          ...
          = Core.withObject "UpdateRepoRequest"
              (\ o ->
                 UpdateRepoRequest Core.<$>
                   (o Core..:? "repo") Core.<*> (o Core..:? "updateMask"))
