...
--
-- /See:/ <https://cloud.google.com/source-repositories/docs Cloud Source Repositories API Reference> for @sourcerepo.projects.repos.list@.
module Gogol.SourceRepo.Projects.Repos.List
    (
    -- * Resource
...
newSourceRepoProjectsReposList name
  = SourceRepoProjectsReposList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest SourceRepoProjectsReposList where
        type Rs SourceRepoProjectsReposList = ListReposResponse
        type Scopes SourceRepoProjectsReposList =
             '[CloudPlatform'FullControl, Source'FullControl, Source'ReadOnly,
               Source'ReadWrite]
        requestClient SourceRepoProjectsReposList{..}
          = go name xgafv accessToken callback pageSize pageToken uploadType
              uploadProtocol
              (Core.Just Core.AltJSON)
              sourceRepoService
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy SourceRepoProjectsReposListResource)
                      Core.mempty
