...
newSourceRepoProjectsReposTestIamPermissions payload resource
  = SourceRepoProjectsReposTestIamPermissions{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes SourceRepoProjectsReposTestIamPermissions =
             '[CloudPlatform'FullControl, Source'FullControl, Source'ReadOnly,
               Source'ReadWrite]
        requestClient SourceRepoProjectsReposTestIamPermissions{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy SourceRepoProjectsReposTestIamPermissionsResource)
                      Core.mempty
