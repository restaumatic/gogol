...
newSourceRepoProjectsReposPatch name payload
  = SourceRepoProjectsReposPatch{xgafv = Core.Nothing,
                                 accessToken = Core.Nothing, callback = Core.Nothing, name = name,
                                 payload = payload, uploadType = Core.Nothing,
                                 uploadProtocol = Core.Nothing}
instance Core.GoogleRequest SourceRepoProjectsReposPatch where
        ...
        requestClient SourceRepoProjectsReposPatch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy SourceRepoProjectsReposPatchResource)
                      Core.mempty
