...
--
-- /See:/ <https://developers.google.com/workspace/tasks/ Google Tasks API Reference> for @tasks.tasks.clear@.
module Gogol.AppsTasks.Tasks.Clear
    (
    -- * Resource
...
newTasksTasksClear tasklist
  = TasksTasksClear{xgafv = Core.Nothing, accessToken = Core.Nothing,
                    callback = Core.Nothing, tasklist = tasklist,
