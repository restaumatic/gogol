...
--
-- /See:/ <https://developers.google.com/workspace/tasks/ Google Tasks API Reference> for @tasks.tasks.patch@.
module Gogol.AppsTasks.Tasks.Patch
    (
    -- * Resource
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] Task Core.:> Core.Patch '[Core.JSON] Task
...
newTasksTasksPatch payload task tasklist
  = TasksTasksPatch{xgafv = Core.Nothing, accessToken = Core.Nothing,
                    callback = Core.Nothing, payload = payload, task = task,
...
instance Core.GoogleRequest TasksTasksPatch where
        ...
        requestClient TasksTasksPatch{..}
          = go tasklist task xgafv accessToken callback uploadType
              uploadProtocol
