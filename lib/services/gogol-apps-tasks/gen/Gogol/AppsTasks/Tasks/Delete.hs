...
--
-- /See:/ <https://developers.google.com/workspace/tasks/ Google Tasks API Reference> for @tasks.tasks.delete@.
module Gogol.AppsTasks.Tasks.Delete
    (
    -- * Resource
...
newTasksTasksDelete task tasklist
  = TasksTasksDelete{xgafv = Core.Nothing,
                     accessToken = Core.Nothing, callback = Core.Nothing, task = task,
