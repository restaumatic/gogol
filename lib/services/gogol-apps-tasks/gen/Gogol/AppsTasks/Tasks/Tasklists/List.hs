...
--
-- /See:/ <https://developers.google.com/workspace/tasks/ Google Tasks API Reference> for @tasks.tasklists.list@.
module Gogol.AppsTasks.Tasks.Tasklists.List
    (
    -- * Resource
...
newTasksTasklistsList 
    ::  TasksTasklistsList
newTasksTasklistsList
  = TasksTasklistsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest TasksTasklistsList where
        ...
        requestClient TasksTasklistsList{..}
          = go xgafv accessToken callback maxResults pageToken uploadType
              uploadProtocol
