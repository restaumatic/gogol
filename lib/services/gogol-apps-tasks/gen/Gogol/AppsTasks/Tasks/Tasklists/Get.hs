...
--
-- /See:/ <https://developers.google.com/workspace/tasks/ Google Tasks API Reference> for @tasks.tasklists.get@.
module Gogol.AppsTasks.Tasks.Tasklists.Get
    (
    -- * Resource
...
newTasksTasklistsGet tasklist
  = TasksTasklistsGet{xgafv = Core.Nothing,
