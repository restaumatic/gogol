...
--
-- /See:/ <https://developers.google.com/workspace/tasks/ Google Tasks API Reference> for @tasks.tasks.insert@.
module Gogol.AppsTasks.Tasks.Insert
    (
    -- * Resource
                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.ReqBody '[Core.JSON] Task Core.:> Core.Post '[Core.JSON] Task
...
newTasksTasksInsert payload tasklist
  = TasksTasksInsert{xgafv = Core.Nothing,
                     accessToken = Core.Nothing, callback = Core.Nothing,
                     parent = Core.Nothing, payload = payload, previous = Core.Nothing,
...
instance Core.GoogleRequest TasksTasksInsert where
        ...
        requestClient TasksTasksInsert{..}
          = go tasklist xgafv accessToken callback parent previous uploadType
              uploadProtocol
