...
--
-- /See:/ <https://developers.google.com/workspace/tasks/ Google Tasks API Reference> for @tasks.tasks.list@.
module Gogol.AppsTasks.Tasks.List
    (
    -- * Resource
                           ...
                           Core.QueryParam "dueMin" Core.Text Core.:>
                             Core.QueryParam "maxResults" Core.Int32 Core.:>
                               Core.QueryParam "pageToken" Core.Text Core.:>
                                 Core.QueryParam "showAssigned" Core.Bool Core.:>
                                   Core.QueryParam "showCompleted" Core.Bool Core.:>
                                     Core.QueryParam "showDeleted" Core.Bool Core.:>
                                       Core.QueryParam "showHidden" Core.Bool Core.:>
...
data TasksTasksList = TasksTasksList
    ...
    , showAssigned :: (Core.Maybe Core.Bool)
...
newTasksTasksList tasklist
  = TasksTasksList{xgafv = Core.Nothing, accessToken = Core.Nothing,
                   callback = Core.Nothing, completedMax = Core.Nothing,
                   completedMin = Core.Nothing, dueMax = Core.Nothing,
                   dueMin = Core.Nothing, maxResults = Core.Nothing,
                   pageToken = Core.Nothing, showAssigned = Core.Nothing,
                   showCompleted = Core.Nothing, showDeleted = Core.Nothing,
                   showHidden = Core.Nothing, tasklist = tasklist,
...
instance Core.GoogleRequest TasksTasksList where
        ...
        type Scopes TasksTasksList = '[Tasks'FullControl, Tasks'Readonly]
        requestClient TasksTasksList{..}
          = go tasklist xgafv accessToken callback completedMax completedMin
              dueMax
              dueMin
              maxResults
              pageToken
