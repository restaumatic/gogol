...
--
-- /See:/ <https://developers.google.com/workspace/tasks/ Google Tasks API Reference> for @tasks.tasks.update@.
module Gogol.AppsTasks.Tasks.Update
    (
    -- * Resource
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] Task Core.:> Core.Put '[Core.JSON] Task
...
newTasksTasksUpdate payload task tasklist
  = TasksTasksUpdate{xgafv = Core.Nothing,
                     accessToken = Core.Nothing, callback = Core.Nothing,
                     payload = payload, task = task, tasklist = tasklist,
