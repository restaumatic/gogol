...
--
-- /See:/ <https://developers.google.com/workspace/tasks/ Google Tasks API Reference> for @tasks.tasks.move@.
module Gogol.AppsTasks.Tasks.Move
    (
    -- * Resource
                   ...
                   Core.QueryParam "$.xgafv" Xgafv Core.:>
                     Core.QueryParam "access_token" Core.Text Core.:>
                       Core.QueryParam "callback" Core.Text Core.:>
                         Core.QueryParam "destinationTasklist" Core.Text Core.:>
...
newTasksTasksMove task tasklist
  = TasksTasksMove{xgafv = Core.Nothing, accessToken = Core.Nothing,
                   callback = Core.Nothing, destinationTasklist = Core.Nothing,
                   parent = Core.Nothing, previous = Core.Nothing, task = task,
                   tasklist = tasklist, uploadType = Core.Nothing,
...
instance Core.GoogleRequest TasksTasksMove where
        ...
        requestClient TasksTasksMove{..}
          = go tasklist task xgafv accessToken callback destinationTasklist
              parent
              previous
              uploadType
              uploadProtocol
