...
newAssignmentInfo 
    ::  AssignmentInfo
newAssignmentInfo
  = AssignmentInfo{driveResourceInfo = Core.Nothing,
                   linkToTask = Core.Nothing, spaceInfo = Core.Nothing,
                   surfaceType = Core.Nothing}
instance Core.FromJSON AssignmentInfo where
        parseJSON
          = Core.withObject "AssignmentInfo"
              (\ o ->
                 AssignmentInfo Core.<$>
                   (o Core..:? "driveResourceInfo") Core.<*> (o Core..:? "linkToTask")
...
newDriveResourceInfo 
    ::  DriveResourceInfo
newDriveResourceInfo
  = DriveResourceInfo{driveFileId = Core.Nothing,
                      resourceKey = Core.Nothing}
instance Core.FromJSON DriveResourceInfo where
        parseJSON
          = Core.withObject "DriveResourceInfo"
              (\ o ->
                 DriveResourceInfo Core.<$>
                   (o Core..:? "driveFileId") Core.<*> (o Core..:? "resourceKey"))
...
newTask 
    ::  Task
newTask
  = Task{assignmentInfo = Core.Nothing, completed = Core.Nothing,
         deleted = Core.Nothing, due = Core.Nothing, etag = Core.Nothing,
         hidden = Core.Nothing, id = Core.Nothing, kind = Core.Nothing,
         links = Core.Nothing, notes = Core.Nothing, parent = Core.Nothing,
         position = Core.Nothing, selfLink = Core.Nothing,
         status = Core.Nothing, title = Core.Nothing,
         updated = Core.Nothing, webViewLink = Core.Nothing}
instance Core.FromJSON Task where
        parseJSON
          = Core.withObject "Task"
              (\ o ->
                 Task Core.<$>
                   (o Core..:? "assignmentInfo") Core.<*> (o Core..:? "completed")
                     Core.<*> (o Core..:? "deleted")
                     Core.<*> (o Core..:? "due")
                     Core.<*> (o Core..:? "etag")
                     Core.<*> (o Core..:? "hidden")
          ...
          = Core.object
              (Core.catMaybes
                 [("assignmentInfo" Core..=) Core.<$> assignmentInfo,
                  ...
                  ("deleted" Core..=) Core.<$> deleted, ("due" Core..=) Core.<$> due,
                  ("etag" Core..=) Core.<$> etag, ("hidden" Core..=) Core.<$> hidden,
                  ("id" Core..=) Core.<$> id, ("kind" Core..=) Core.<$> kind,
                  ("links" Core..=) Core.<$> links, ("notes" Core..=) Core.<$> notes,
...
data Task_LinksItem = Task_LinksItem
    ...
    , link :: (Core.Maybe Core.Text)
      -- | Type of the link, e.g. \"email\", \"generic\", \"chat/message\", \"keep/note\".
...
newTask_LinksItem 
    ::  Task_LinksItem
newTask_LinksItem
  = Task_LinksItem{description = Core.Nothing, link = Core.Nothing,
                   type' = Core.Nothing}
instance Core.FromJSON Task_LinksItem where
        parseJSON
          = Core.withObject "Task_LinksItem"
              (\ o ->
                 Task_LinksItem Core.<$>
                   (o Core..:? "description") Core.<*> (o Core..:? "link") Core.<*>
                     (o Core..:? "type"))
          ...
          = Core.object
              (Core.catMaybes
                 [("description" Core..=) Core.<$> description,
                  ("link" Core..=) Core.<$> link, ("type" Core..=) Core.<$> type'])
...
newTaskList 
    ::  TaskList
newTaskList
  = TaskList{etag = Core.Nothing, id = Core.Nothing,
             kind = Core.Nothing, selfLink = Core.Nothing, title = Core.Nothing,
...
newTaskLists 
    ::  TaskLists
newTaskLists
  = TaskLists{etag = Core.Nothing, items = Core.Nothing,
...
newTasks 
    ::  Tasks
newTasks
  = Tasks{etag = Core.Nothing, items = Core.Nothing,
          kind = Core.Nothing, nextPageToken = Core.Nothing}
