...
newAnalyticsInfo 
    ::  AnalyticsInfo
newAnalyticsInfo
  = AnalyticsInfo{googlePlayAnalytics = Core.Nothing,
                  itunesConnectAnalytics = Core.Nothing}
...
instance Core.ToJSON AnalyticsInfo where
        toJSON AnalyticsInfo{..}
          = Core.object
              (Core.catMaybes
                 [("googlePlayAnalytics" Core..=) Core.<$> googlePlayAnalytics,
...
newAndroidInfo 
    ::  AndroidInfo
newAndroidInfo
  = AndroidInfo{androidFallbackLink = Core.Nothing,
...
instance Core.ToJSON AndroidInfo where
        toJSON AndroidInfo{..}
          = Core.object
              (Core.catMaybes
                 [("androidFallbackLink" Core..=) Core.<$> androidFallbackLink,
...
newCreateManagedShortLinkRequest 
    ::  CreateManagedShortLinkRequest
newCreateManagedShortLinkRequest
  = CreateManagedShortLinkRequest{dynamicLinkInfo = Core.Nothing,
                                  longDynamicLink = Core.Nothing, name = Core.Nothing,
                                  sdkVersion = Core.Nothing, suffix = Core.Nothing}
instance Core.FromJSON CreateManagedShortLinkRequest where
        parseJSON
...
instance Core.ToJSON CreateManagedShortLinkRequest where
        toJSON CreateManagedShortLinkRequest{..}
          = Core.object
              (Core.catMaybes
                 [("dynamicLinkInfo" Core..=) Core.<$> dynamicLinkInfo,
...
newCreateManagedShortLinkResponse 
    ::  CreateManagedShortLinkResponse
newCreateManagedShortLinkResponse
  = CreateManagedShortLinkResponse{managedShortLink = Core.Nothing,
                                   previewLink = Core.Nothing, warning = Core.Nothing}
instance Core.FromJSON CreateManagedShortLinkResponse where
        parseJSON
          = Core.withObject "CreateManagedShortLinkResponse"
              (\ o ->
                 CreateManagedShortLinkResponse Core.<$>
                   (o Core..:? "managedShortLink") Core.<*> (o Core..:? "previewLink")
                     Core.<*> (o Core..:? "warning"))
...
instance Core.ToJSON CreateManagedShortLinkResponse where
        toJSON CreateManagedShortLinkResponse{..}
          = Core.object
              (Core.catMaybes
                 [("managedShortLink" Core..=) Core.<$> managedShortLink,
...
newCreateShortDynamicLinkRequest 
    ::  CreateShortDynamicLinkRequest
newCreateShortDynamicLinkRequest
  = CreateShortDynamicLinkRequest{dynamicLinkInfo = Core.Nothing,
                                  longDynamicLink = Core.Nothing, sdkVersion = Core.Nothing,
                                  suffix = Core.Nothing}
instance Core.FromJSON CreateShortDynamicLinkRequest where
        parseJSON
...
instance Core.ToJSON CreateShortDynamicLinkRequest where
...
newCreateShortDynamicLinkResponse 
    ::  CreateShortDynamicLinkResponse
newCreateShortDynamicLinkResponse
  = CreateShortDynamicLinkResponse{previewLink = Core.Nothing,
                                   shortLink = Core.Nothing, warning = Core.Nothing}
instance Core.FromJSON CreateShortDynamicLinkResponse where
        parseJSON
          = Core.withObject "CreateShortDynamicLinkResponse"
              (\ o ->
                 CreateShortDynamicLinkResponse Core.<$>
                   (o Core..:? "previewLink") Core.<*> (o Core..:? "shortLink")
                     Core.<*> (o Core..:? "warning"))
...
instance Core.FromJSON DesktopInfo where
        parseJSON
          = Core.withObject "DesktopInfo"
              (\ o -> DesktopInfo Core.<$> (o Core..:? "desktopFallbackLink"))

instance Core.ToJSON DesktopInfo where
        toJSON DesktopInfo{..}
          = Core.object
              (Core.catMaybes
                 [("desktopFallbackLink" Core..=) Core.<$> desktopFallbackLink])
...
instance Core.ToJSON DeviceInfo where
        toJSON DeviceInfo{..}
          = Core.object
              (Core.catMaybes
                 [("deviceModelName" Core..=) Core.<$> deviceModelName,
                  ("languageCode" Core..=) Core.<$> languageCode,
                  ("languageCodeFromWebview" Core..=) Core.<$>
                    languageCodeFromWebview,
                  ("languageCodeRaw" Core..=) Core.<$> languageCodeRaw,
                  ("screenResolutionHeight" Core..=) Core.. Core.AsText Core.<$>
                    screenResolutionHeight,
                  ("screenResolutionWidth" Core..=) Core.. Core.AsText Core.<$>
...
newDynamicLinkEventStat 
    ::  DynamicLinkEventStat
newDynamicLinkEventStat
  = DynamicLinkEventStat{count = Core.Nothing, event = Core.Nothing,
...
newDynamicLinkInfo 
    ::  DynamicLinkInfo
newDynamicLinkInfo
  = DynamicLinkInfo{analyticsInfo = Core.Nothing,
                    androidInfo = Core.Nothing, desktopInfo = Core.Nothing,
                    domainUriPrefix = Core.Nothing, dynamicLinkDomain = Core.Nothing,
                    iosInfo = Core.Nothing, link = Core.Nothing,
                    navigationInfo = Core.Nothing, socialMetaTagInfo = Core.Nothing}
instance Core.FromJSON DynamicLinkInfo where
        parseJSON
          = Core.withObject "DynamicLinkInfo"
              (\ o ->
                 DynamicLinkInfo Core.<$>
                   (o Core..:? "analyticsInfo") Core.<*> (o Core..:? "androidInfo")
          ...
          = Core.object
              (Core.catMaybes
                 [("analyticsInfo" Core..=) Core.<$> analyticsInfo,
                  ...
                  ("dynamicLinkDomain" Core..=) Core.<$> dynamicLinkDomain,
                  ("iosInfo" Core..=) Core.<$> iosInfo,
                  ("link" Core..=) Core.<$> link,
                  ("navigationInfo" Core..=) Core.<$> navigationInfo,
                  ("socialMetaTagInfo" Core..=) Core.<$> socialMetaTagInfo])
...
newDynamicLinkStats 
    ::  DynamicLinkStats
newDynamicLinkStats
  = DynamicLinkStats{linkEventStats = Core.Nothing,
          ...
          = Core.withObject "DynamicLinkStats"
              (\ o ->
                 DynamicLinkStats Core.<$>
                   (o Core..:? "linkEventStats") Core.<*> (o Core..:? "warnings"))
...
newDynamicLinkWarning 
    ::  DynamicLinkWarning
newDynamicLinkWarning
  = DynamicLinkWarning{warningCode = Core.Nothing,
                       warningDocumentLink = Core.Nothing, warningMessage = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("warningCode" Core..=) Core.<$> warningCode,
                  ("warningDocumentLink" Core..=) Core.<$> warningDocumentLink,
...
newGetIosPostInstallAttributionRequest 
    :: 
                                       GetIosPostInstallAttributionRequest
newGetIosPostInstallAttributionRequest
  = GetIosPostInstallAttributionRequest{appInstallationTime =
                                          Core.Nothing,
                                        bundleId = Core.Nothing, device = Core.Nothing,
                                        iosVersion = Core.Nothing, retrievalMethod = Core.Nothing,
                                        sdkVersion = Core.Nothing,
                                        uniqueMatchLinkToCheck = Core.Nothing,
                                        visualStyle = Core.Nothing}
instance Core.FromJSON GetIosPostInstallAttributionRequest where
        parseJSON
          = Core.withObject "GetIosPostInstallAttributionRequest"
              (\ o ->
...
instance Core.ToJSON GetIosPostInstallAttributionRequest where
        toJSON GetIosPostInstallAttributionRequest{..}
          = Core.object
              (Core.catMaybes
                 [("appInstallationTime" Core..=) Core.. Core.AsText Core.<$>
                    appInstallationTime,
                  ...
                  ("sdkVersion" Core..=) Core.<$> sdkVersion,
                  ("uniqueMatchLinkToCheck" Core..=) Core.<$> uniqueMatchLinkToCheck,
...
newGetIosPostInstallAttributionResponse 
    :: 
                                        GetIosPostInstallAttributionResponse
newGetIosPostInstallAttributionResponse
  = GetIosPostInstallAttributionResponse{appMinimumVersion =
                                           Core.Nothing,
                                         attributionConfidence = Core.Nothing,
                                         deepLink = Core.Nothing,
                                         externalBrowserDestinationLink = Core.Nothing,
                                         fallbackLink = Core.Nothing, invitationId = Core.Nothing,
                                         isStrongMatchExecutable = Core.Nothing,
                                         matchMessage = Core.Nothing,
                                         requestIpVersion = Core.Nothing,
                                         requestedLink = Core.Nothing, resolvedLink = Core.Nothing,
                                         utmCampaign = Core.Nothing, utmContent = Core.Nothing,
                                         utmMedium = Core.Nothing, utmSource = Core.Nothing,
                                         utmTerm = Core.Nothing}
instance Core.FromJSON GetIosPostInstallAttributionResponse where
        parseJSON
          = Core.withObject "GetIosPostInstallAttributionResponse"
              (\ o ->
                 GetIosPostInstallAttributionResponse Core.<$>
                   (o Core..:? "appMinimumVersion") Core.<*>
                     (o Core..:? "attributionConfidence")
                     Core.<*> (o Core..:? "deepLink")
                     Core.<*> (o Core..:? "externalBrowserDestinationLink")
...
instance Core.ToJSON GetIosPostInstallAttributionResponse where
        toJSON GetIosPostInstallAttributionResponse{..}
          = Core.object
              (Core.catMaybes
                 [("appMinimumVersion" Core..=) Core.<$> appMinimumVersion,
                  ("attributionConfidence" Core..=) Core.<$> attributionConfidence,
                  ...
                  ("requestIpVersion" Core..=) Core.<$> requestIpVersion,
...
newGetIosReopenAttributionRequest 
    ::  GetIosReopenAttributionRequest
newGetIosReopenAttributionRequest
  = GetIosReopenAttributionRequest{bundleId = Core.Nothing,
                                   requestedLink = Core.Nothing, sdkVersion = Core.Nothing}
instance Core.FromJSON GetIosReopenAttributionRequest where
        parseJSON
          = Core.withObject "GetIosReopenAttributionRequest"
              (\ o ->
                 GetIosReopenAttributionRequest Core.<$>
                   (o Core..:? "bundleId") Core.<*> (o Core..:? "requestedLink")
                     Core.<*> (o Core..:? "sdkVersion"))

instance Core.ToJSON GetIosReopenAttributionRequest where
...
newGetIosReopenAttributionResponse 
    :: 
                                   GetIosReopenAttributionResponse
newGetIosReopenAttributionResponse
  = GetIosReopenAttributionResponse{deepLink = Core.Nothing,
                                    invitationId = Core.Nothing, iosMinAppVersion = Core.Nothing,
                                    resolvedLink = Core.Nothing, utmCampaign = Core.Nothing,
                                    utmContent = Core.Nothing, utmMedium = Core.Nothing,
                                    utmSource = Core.Nothing, utmTerm = Core.Nothing,
                                    warning = Core.Nothing}
instance Core.FromJSON GetIosReopenAttributionResponse where
        parseJSON
          = Core.withObject "GetIosReopenAttributionResponse"
              (\ o ->
                 GetIosReopenAttributionResponse Core.<$>
                   (o Core..:? "deepLink") Core.<*> (o Core..:? "invitationId")
...
instance Core.ToJSON GetIosReopenAttributionResponse where
        toJSON GetIosReopenAttributionResponse{..}
          = Core.object
              (Core.catMaybes
                 [("deepLink" Core..=) Core.<$> deepLink,
                  ("invitationId" Core..=) Core.<$> invitationId,
                  ("iosMinAppVersion" Core..=) Core.<$> iosMinAppVersion,
                  ("resolvedLink" Core..=) Core.<$> resolvedLink,
                  ("utmCampaign" Core..=) Core.<$> utmCampaign,
                  ("utmContent" Core..=) Core.<$> utmContent,
                  ("utmMedium" Core..=) Core.<$> utmMedium,
...
newGooglePlayAnalytics 
    ::  GooglePlayAnalytics
newGooglePlayAnalytics
  = GooglePlayAnalytics{gclid = Core.Nothing,
                        utmCampaign = Core.Nothing, utmContent = Core.Nothing,
                        utmMedium = Core.Nothing, utmSource = Core.Nothing,
                        utmTerm = Core.Nothing}
          ...
          = Core.withObject "GooglePlayAnalytics"
              (\ o ->
                 GooglePlayAnalytics Core.<$>
                   (o Core..:? "gclid") Core.<*> (o Core..:? "utmCampaign") Core.<*>
                     (o Core..:? "utmContent")
                     Core.<*> (o Core..:? "utmMedium")
                     Core.<*> (o Core..:? "utmSource")
                     Core.<*> (o Core..:? "utmTerm"))
...
newITunesConnectAnalytics 
    ::  ITunesConnectAnalytics
newITunesConnectAnalytics
  = ITunesConnectAnalytics{at = Core.Nothing, ct = Core.Nothing,
                           mt = Core.Nothing, pt = Core.Nothing}
...
instance Core.ToJSON ITunesConnectAnalytics where
        toJSON ITunesConnectAnalytics{..}
          = Core.object
              (Core.catMaybes
                 [("at" Core..=) Core.<$> at, ("ct" Core..=) Core.<$> ct,
                  ("mt" Core..=) Core.<$> mt, ("pt" Core..=) Core.<$> pt])
...
newIosInfo 
    ::  IosInfo
newIosInfo
  = IosInfo{iosAppStoreId = Core.Nothing, iosBundleId = Core.Nothing,
            iosCustomScheme = Core.Nothing, iosFallbackLink = Core.Nothing,
            iosIpadBundleId = Core.Nothing, iosIpadFallbackLink = Core.Nothing,
...
instance Core.FromJSON IosInfo where
        parseJSON
          = Core.withObject "IosInfo"
              (\ o ->
                 IosInfo Core.<$>
                   (o Core..:? "iosAppStoreId") Core.<*> (o Core..:? "iosBundleId")
          ...
          = Core.object
              (Core.catMaybes
                 [("iosAppStoreId" Core..=) Core.<$> iosAppStoreId,
                  ...
                  ("iosIpadFallbackLink" Core..=) Core.<$> iosIpadFallbackLink,
...
newManagedShortLink 
    ::  ManagedShortLink
newManagedShortLink
  = ManagedShortLink{creationTime = Core.Nothing,
                     flaggedAttribute = Core.Nothing, info = Core.Nothing,
                     link = Core.Nothing, linkName = Core.Nothing,
          ...
          = Core.object
              (Core.catMaybes
                 [("creationTime" Core..=) Core.<$> creationTime,
                  ("flaggedAttribute" Core..=) Core.<$> flaggedAttribute,
                  ("info" Core..=) Core.<$> info, ("link" Core..=) Core.<$> link,
...
newNavigationInfo 
    ::  NavigationInfo
newNavigationInfo
  = NavigationInfo{enableForcedRedirect = Core.Nothing}
instance Core.FromJSON NavigationInfo where
        parseJSON
          = Core.withObject "NavigationInfo"
              (\ o ->
                 NavigationInfo Core.<$> (o Core..:? "enableForcedRedirect"))

instance Core.ToJSON NavigationInfo where
        toJSON NavigationInfo{..}
          = Core.object
              (Core.catMaybes
                 [("enableForcedRedirect" Core..=) Core.<$> enableForcedRedirect])
...
newSocialMetaTagInfo 
    ::  SocialMetaTagInfo
newSocialMetaTagInfo
  = SocialMetaTagInfo{socialDescription = Core.Nothing,
                      socialImageLink = Core.Nothing, socialTitle = Core.Nothing}
...
instance Core.ToJSON SocialMetaTagInfo where
        toJSON SocialMetaTagInfo{..}
          = Core.object
              (Core.catMaybes
                 [("socialDescription" Core..=) Core.<$> socialDescription,
...
newSuffix 
    ::  Suffix
newSuffix
  = Suffix{customSuffix = Core.Nothing, option = Core.Nothing}
instance Core.FromJSON Suffix where
        parseJSON
          = Core.withObject "Suffix"
              (\ o ->
                 Suffix Core.<$>
                   (o Core..:? "customSuffix") Core.<*> (o Core..:? "option"))
