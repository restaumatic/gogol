...
type FirebaseDynamicLinksGetLinkStatsResource =
     "v1" Core.:>
       Core.Capture "dynamicLink" Core.Text Core.:>
         "linkStats" Core.:>
           Core.QueryParam "$.xgafv" Xgafv Core.:>
             Core.QueryParam "access_token" Core.Text Core.:>
               Core.QueryParam "callback" Core.Text Core.:>
                 Core.QueryParam "durationDays" Core.Int64 Core.:>
                   Core.QueryParam "sdkVersion" Core.Text Core.:>
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] DynamicLinkStats
...
newFirebaseDynamicLinksGetLinkStats dynamicLink
  = FirebaseDynamicLinksGetLinkStats{xgafv = Core.Nothing,
                                     accessToken = Core.Nothing, callback = Core.Nothing,
                                     durationDays = Core.Nothing, dynamicLink = dynamicLink,
                                     sdkVersion = Core.Nothing, uploadType = Core.Nothing,
                                     uploadProtocol = Core.Nothing}
instance Core.GoogleRequest FirebaseDynamicLinksGetLinkStats where
        type Rs FirebaseDynamicLinksGetLinkStats = DynamicLinkStats
        type Scopes FirebaseDynamicLinksGetLinkStats =
             '[Firebase'FullControl]
        requestClient FirebaseDynamicLinksGetLinkStats{..}
          = go dynamicLink xgafv accessToken callback durationDays sdkVersion
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy FirebaseDynamicLinksGetLinkStatsResource)
                      Core.mempty
