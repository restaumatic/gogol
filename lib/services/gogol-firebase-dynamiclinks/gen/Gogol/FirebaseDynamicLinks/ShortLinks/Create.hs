               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] CreateShortDynamicLinkRequest Core.:>
                       Core.Post '[Core.JSON] CreateShortDynamicLinkResponse
...
newFirebaseDynamicLinksShortLinksCreate payload
  = FirebaseDynamicLinksShortLinksCreate{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         payload = payload, uploadType = Core.Nothing,
                                         uploadProtocol = Core.Nothing}
instance Core.GoogleRequest FirebaseDynamicLinksShortLinksCreate
         where
        type Rs FirebaseDynamicLinksShortLinksCreate =
             CreateShortDynamicLinkResponse
        type Scopes FirebaseDynamicLinksShortLinksCreate =
             '[Firebase'FullControl]
        requestClient FirebaseDynamicLinksShortLinksCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy FirebaseDynamicLinksShortLinksCreateResource)
                      Core.mempty
