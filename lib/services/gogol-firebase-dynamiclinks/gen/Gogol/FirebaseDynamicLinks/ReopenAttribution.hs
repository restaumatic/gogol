               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] GetIosReopenAttributionRequest Core.:>
                       Core.Post '[Core.JSON] GetIosReopenAttributionResponse
...
newFirebaseDynamicLinksReopenAttribution payload
  = FirebaseDynamicLinksReopenAttribution{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          payload = payload, uploadType = Core.Nothing,
                                          uploadProtocol = Core.Nothing}
instance Core.GoogleRequest FirebaseDynamicLinksReopenAttribution
         where
