               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] CreateManagedShortLinkRequest Core.:>
...
newFirebaseDynamicLinksManagedShortLinksCreate payload
  = FirebaseDynamicLinksManagedShortLinksCreate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes FirebaseDynamicLinksManagedShortLinksCreate =
             '[Firebase'FullControl]
        requestClient FirebaseDynamicLinksManagedShortLinksCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy FirebaseDynamicLinksManagedShortLinksCreateResource)
                      Core.mempty
