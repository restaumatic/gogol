...
-- |
-- Module      : Gogol.TPU.Projects.Locations.RuntimeVersions.List
                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Get '[Core.JSON] ListRuntimeVersionsResponse
...
newTPUProjectsLocationsRuntimeVersionsList parent
  = TPUProjectsLocationsRuntimeVersionsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest TPUProjectsLocationsRuntimeVersionsList
         where
        type Rs TPUProjectsLocationsRuntimeVersionsList =
             ListRuntimeVersionsResponse
        type Scopes TPUProjectsLocationsRuntimeVersionsList =
             '[CloudPlatform'FullControl]
        requestClient TPUProjectsLocationsRuntimeVersionsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy TPUProjectsLocationsRuntimeVersionsListResource)
                      Core.mempty
