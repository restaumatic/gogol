...
newTPUProjectsLocationsOperationsGet name
  = TPUProjectsLocationsOperationsGet{xgafv = Core.Nothing,
                                      accessToken = Core.Nothing, callback = Core.Nothing,
                                      name = name, uploadType = Core.Nothing,
                                      uploadProtocol = Core.Nothing}
instance Core.GoogleRequest TPUProjectsLocationsOperationsGet where
        type Rs TPUProjectsLocationsOperationsGet = Operation
        type Scopes TPUProjectsLocationsOperationsGet =
