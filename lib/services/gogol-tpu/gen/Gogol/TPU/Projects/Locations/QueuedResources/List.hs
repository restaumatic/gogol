...
instance Core.GoogleRequest TPUProjectsLocationsQueuedResourcesList
        ...
        requestClient TPUProjectsLocationsQueuedResourcesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy TPUProjectsLocationsQueuedResourcesListResource)
                      Core.mempty
