               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] ResetQueuedResourceRequest Core.:>
...
newTPUProjectsLocationsQueuedResourcesReset name payload
  = TPUProjectsLocationsQueuedResourcesReset{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           TPUProjectsLocationsQueuedResourcesReset
         where
        type Rs TPUProjectsLocationsQueuedResourcesReset = Operation
        type Scopes TPUProjectsLocationsQueuedResourcesReset =
             '[CloudPlatform'FullControl]
        requestClient TPUProjectsLocationsQueuedResourcesReset{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy TPUProjectsLocationsQueuedResourcesResetResource)
                      Core.mempty
