...
newTPUProjectsLocationsNodesCreate parent payload
  = TPUProjectsLocationsNodesCreate{xgafv = Core.Nothing,
                                    accessToken = Core.Nothing, callback = Core.Nothing,
                                    nodeId = Core.Nothing, parent = parent, payload = payload,
                                    uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest TPUProjectsLocationsNodesCreate where
        ...
        requestClient TPUProjectsLocationsNodesCreate{..}
          = go parent xgafv accessToken callback nodeId uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy TPUProjectsLocationsNodesCreateResource)
                      Core.mempty
