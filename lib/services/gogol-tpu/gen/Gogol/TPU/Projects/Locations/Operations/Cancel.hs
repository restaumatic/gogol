...
newTPUProjectsLocationsOperationsCancel name
  = TPUProjectsLocationsOperationsCancel{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         name = name, uploadType = Core.Nothing,
                                         uploadProtocol = Core.Nothing}
instance Core.GoogleRequest TPUProjectsLocationsOperationsCancel
         where
        type Rs TPUProjectsLocationsOperationsCancel = Empty
        type Scopes TPUProjectsLocationsOperationsCancel =
             '[CloudPlatform'FullControl]
        requestClient TPUProjectsLocationsOperationsCancel{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy TPUProjectsLocationsOperationsCancelResource)
                      Core.mempty
