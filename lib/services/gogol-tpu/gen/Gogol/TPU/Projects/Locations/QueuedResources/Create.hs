...
newTPUProjectsLocationsQueuedResourcesCreate parent payload
  = TPUProjectsLocationsQueuedResourcesCreate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           TPUProjectsLocationsQueuedResourcesCreate
         where
        type Rs TPUProjectsLocationsQueuedResourcesCreate = Operation
        type Scopes TPUProjectsLocationsQueuedResourcesCreate =
             '[CloudPlatform'FullControl]
        requestClient TPUProjectsLocationsQueuedResourcesCreate{..}
          = go parent xgafv accessToken callback queuedResourceId requestId
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy TPUProjectsLocationsQueuedResourcesCreateResource)
                      Core.mempty
