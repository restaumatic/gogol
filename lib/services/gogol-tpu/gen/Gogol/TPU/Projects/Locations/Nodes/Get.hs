...
newTPUProjectsLocationsNodesGet name
  = TPUProjectsLocationsNodesGet{xgafv = Core.Nothing,
                                 accessToken = Core.Nothing, callback = Core.Nothing, name = name,
                                 uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest TPUProjectsLocationsNodesGet where
        type Rs TPUProjectsLocationsNodesGet = Node
        type Scopes TPUProjectsLocationsNodesGet =
        ...
        requestClient TPUProjectsLocationsNodesGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy TPUProjectsLocationsNodesGetResource)
                      Core.mempty
