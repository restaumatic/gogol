...
type TPUProjectsLocationsGenerateServiceIdentityResource =
     "v2" Core.:>
       Core.CaptureMode "parent" "generateServiceIdentity" Core.Text
         Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] GenerateServiceIdentityRequest Core.:>
                       Core.Post '[Core.JSON] GenerateServiceIdentityResponse
...
newTPUProjectsLocationsGenerateServiceIdentity parent payload
  = TPUProjectsLocationsGenerateServiceIdentity{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           TPUProjectsLocationsGenerateServiceIdentity
         where
        type Rs TPUProjectsLocationsGenerateServiceIdentity =
             GenerateServiceIdentityResponse
        type Scopes TPUProjectsLocationsGenerateServiceIdentity =
             '[CloudPlatform'FullControl]
        requestClient TPUProjectsLocationsGenerateServiceIdentity{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy TPUProjectsLocationsGenerateServiceIdentityResource)
                      Core.mempty
