...
newTPUProjectsLocationsQueuedResourcesDelete name
  = TPUProjectsLocationsQueuedResourcesDelete{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes TPUProjectsLocationsQueuedResourcesDelete =
             '[CloudPlatform'FullControl]
        requestClient TPUProjectsLocationsQueuedResourcesDelete{..}
          = go name xgafv accessToken callback force requestId uploadType
              uploadProtocol
