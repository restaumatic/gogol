               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.Get '[Core.JSON] QueuedResource
...
newTPUProjectsLocationsQueuedResourcesGet name
  = TPUProjectsLocationsQueuedResourcesGet{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           name = name, uploadType = Core.Nothing,
                                           uploadProtocol = Core.Nothing}
instance Core.GoogleRequest TPUProjectsLocationsQueuedResourcesGet
         where
        type Rs TPUProjectsLocationsQueuedResourcesGet = QueuedResource
        type Scopes TPUProjectsLocationsQueuedResourcesGet =
