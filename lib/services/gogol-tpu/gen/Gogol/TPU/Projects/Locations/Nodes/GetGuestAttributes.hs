...
type TPUProjectsLocationsNodesGetGuestAttributesResource =
     "v2" Core.:>
       Core.CaptureMode "name" "getGuestAttributes" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] GetGuestAttributesRequest Core.:>
...
newTPUProjectsLocationsNodesGetGuestAttributes name payload
  = TPUProjectsLocationsNodesGetGuestAttributes{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes TPUProjectsLocationsNodesGetGuestAttributes =
             '[CloudPlatform'FullControl]
        requestClient TPUProjectsLocationsNodesGetGuestAttributes{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy TPUProjectsLocationsNodesGetGuestAttributesResource)
                      Core.mempty
