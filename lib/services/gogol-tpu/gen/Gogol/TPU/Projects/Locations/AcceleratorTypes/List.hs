                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Get '[Core.JSON] ListAcceleratorTypesResponse
...
newTPUProjectsLocationsAcceleratorTypesList parent
  = TPUProjectsLocationsAcceleratorTypesList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        requestClient TPUProjectsLocationsAcceleratorTypesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy TPUProjectsLocationsAcceleratorTypesListResource)
                      Core.mempty
