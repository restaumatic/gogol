...
type DatastoreProjectsExportResource =
     "v1" Core.:>
       "projects" Core.:>
         Core.CaptureMode "projectId" "export" Core.Text Core.:>
...
newDatastoreProjectsExport payload projectId
  = DatastoreProjectsExport{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DatastoreProjectsExport where
        type Rs DatastoreProjectsExport = GoogleLongrunningOperation
        type Scopes DatastoreProjectsExport =
        ...
        requestClient DatastoreProjectsExport{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy DatastoreProjectsExportResource)
                      Core.mempty
