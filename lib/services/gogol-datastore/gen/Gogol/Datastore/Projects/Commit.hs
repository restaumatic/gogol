...
type DatastoreProjectsCommitResource =
     "v1" Core.:>
       "projects" Core.:>
         Core.CaptureMode "projectId" "commit" Core.Text Core.:>
...
newDatastoreProjectsCommit payload projectId
  = DatastoreProjectsCommit{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DatastoreProjectsCommit where
        ...
        type Scopes DatastoreProjectsCommit =
        ...
        requestClient DatastoreProjectsCommit{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy DatastoreProjectsCommitResource)
                      Core.mempty
