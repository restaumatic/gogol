...
type DatastoreProjectsLookupResource =
     "v1" Core.:>
       "projects" Core.:>
         Core.CaptureMode "projectId" "lookup" Core.Text Core.:>
                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] LookupRequest Core.:>
                         Core.Post '[Core.JSON] LookupResponse
...
newDatastoreProjectsLookup payload projectId
  = DatastoreProjectsLookup{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DatastoreProjectsLookup where
        ...
        type Scopes DatastoreProjectsLookup =
