                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] GoogleDatastoreAdminV1Index Core.:>
...
newDatastoreProjectsIndexesCreate payload projectId
  = DatastoreProjectsIndexesCreate{xgafv = Core.Nothing,
                                   accessToken = Core.Nothing, callback = Core.Nothing,
                                   payload = payload, projectId = projectId,
                                   uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DatastoreProjectsIndexesCreate where
        type Rs DatastoreProjectsIndexesCreate = GoogleLongrunningOperation
        type Scopes DatastoreProjectsIndexesCreate =
        ...
        requestClient DatastoreProjectsIndexesCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy DatastoreProjectsIndexesCreateResource)
                      Core.mempty
