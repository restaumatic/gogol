                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Get '[Core.JSON] GoogleDatastoreAdminV1ListIndexesResponse
...
newDatastoreProjectsIndexesList projectId
  = DatastoreProjectsIndexesList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DatastoreProjectsIndexesList where
        ...
        requestClient DatastoreProjectsIndexesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy DatastoreProjectsIndexesListResource)
                      Core.mempty
