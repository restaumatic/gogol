...
type DatastoreProjectsImportResource =
     "v1" Core.:>
       "projects" Core.:>
         Core.CaptureMode "projectId" "import" Core.Text Core.:>
...
newDatastoreProjectsImport payload projectId
  = DatastoreProjectsImport{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DatastoreProjectsImport where
        type Rs DatastoreProjectsImport = GoogleLongrunningOperation
        type Scopes DatastoreProjectsImport =
        ...
        requestClient DatastoreProjectsImport{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy DatastoreProjectsImportResource)
                      Core.mempty
