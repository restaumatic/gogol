...
type DatastoreProjectsRunAggregationQueryResource =
     "v1" Core.:>
       "projects" Core.:>
         Core.CaptureMode "projectId" "runAggregationQuery" Core.Text
           Core.:>
                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] RunAggregationQueryRequest Core.:>
...
instance Core.GoogleRequest DatastoreProjectsRunAggregationQuery
        ...
        requestClient DatastoreProjectsRunAggregationQuery{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DatastoreProjectsRunAggregationQueryResource)
                      Core.mempty
