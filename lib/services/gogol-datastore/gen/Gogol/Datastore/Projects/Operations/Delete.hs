...
newDatastoreProjectsOperationsDelete name
  = DatastoreProjectsOperationsDelete{xgafv = Core.Nothing,
                                      accessToken = Core.Nothing, callback = Core.Nothing,
                                      name = name, uploadType = Core.Nothing,
                                      uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DatastoreProjectsOperationsDelete where
        type Rs DatastoreProjectsOperationsDelete = Empty
        type Scopes DatastoreProjectsOperationsDelete =
