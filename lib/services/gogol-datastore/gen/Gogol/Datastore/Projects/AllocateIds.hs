...
type DatastoreProjectsAllocateIdsResource =
     "v1" Core.:>
       "projects" Core.:>
         Core.CaptureMode "projectId" "allocateIds" Core.Text Core.:>
                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] AllocateIdsRequest Core.:>
                         Core.Post '[Core.JSON] AllocateIdsResponse
...
newDatastoreProjectsAllocateIds payload projectId
  = DatastoreProjectsAllocateIds{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DatastoreProjectsAllocateIds where
        ...
        type Scopes DatastoreProjectsAllocateIds =
