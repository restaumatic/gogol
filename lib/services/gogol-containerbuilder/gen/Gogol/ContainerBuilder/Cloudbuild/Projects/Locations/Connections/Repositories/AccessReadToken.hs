...
type CloudbuildProjectsLocationsConnectionsRepositoriesAccessReadTokenResource
     =
     "v2" Core.:>
       Core.CaptureMode "repository" "accessReadToken" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] FetchReadTokenRequest Core.:>
                       Core.Post '[Core.JSON] FetchReadTokenResponse
...
newCloudbuildProjectsLocationsConnectionsRepositoriesAccessReadToken
  payload repository
  = CloudbuildProjectsLocationsConnectionsRepositoriesAccessReadToken{xgafv
                                                                        = Core.Nothing,
