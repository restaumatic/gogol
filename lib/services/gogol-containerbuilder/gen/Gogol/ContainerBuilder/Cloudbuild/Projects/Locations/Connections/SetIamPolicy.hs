...
newCloudbuildProjectsLocationsConnectionsSetIamPolicy 
    ...
    -> CloudbuildProjectsLocationsConnectionsSetIamPolicy
newCloudbuildProjectsLocationsConnectionsSetIamPolicy payload
  resource
  = CloudbuildProjectsLocationsConnectionsSetIamPolicy{xgafv =
                                                         Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes CloudbuildProjectsLocationsConnectionsSetIamPolicy =
