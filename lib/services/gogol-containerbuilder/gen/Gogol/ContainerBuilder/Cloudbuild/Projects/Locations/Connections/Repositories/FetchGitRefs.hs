...
newCloudbuildProjectsLocationsConnectionsRepositoriesFetchGitRefs
  repository
  = CloudbuildProjectsLocationsConnectionsRepositoriesFetchGitRefs{xgafv
                                                                     = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        requestClient
          CloudbuildProjectsLocationsConnectionsRepositoriesFetchGitRefs{..}
          = go repository xgafv accessToken callback pageSize pageToken
              refType
              uploadType
              uploadProtocol
