...
type CloudbuildProjectsLocationsConnectionsFetchLinkableRepositoriesResource
     =
     "v2" Core.:>
       Core.CaptureMode "connection" "fetchLinkableRepositories" Core.Text
         Core.:>
                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.Get '[Core.JSON] FetchLinkableRepositoriesResponse
...
newCloudbuildProjectsLocationsConnectionsFetchLinkableRepositories
  connection
  = CloudbuildProjectsLocationsConnectionsFetchLinkableRepositories{xgafv
                                                                      = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        requestClient
          CloudbuildProjectsLocationsConnectionsFetchLinkableRepositories{..}
          = go connection xgafv accessToken callback pageSize pageToken
              uploadType
              uploadProtocol
