...
type CloudbuildProjectsLocationsConnectionsProcessWebhookResource =
     "v2" Core.:>
       Core.Capture "parent" Core.Text Core.:>
         "connections:processWebhook" Core.:>
           Core.QueryParam "$.xgafv" Xgafv Core.:>
             Core.QueryParam "access_token" Core.Text Core.:>
               Core.QueryParam "callback" Core.Text Core.:>
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "webhookKey" Core.Text Core.:>
...
newCloudbuildProjectsLocationsConnectionsProcessWebhook 
    ...
    -> CloudbuildProjectsLocationsConnectionsProcessWebhook
newCloudbuildProjectsLocationsConnectionsProcessWebhook parent
  payload
  = CloudbuildProjectsLocationsConnectionsProcessWebhook{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           CloudbuildProjectsLocationsConnectionsProcessWebhook
         where
        type Rs CloudbuildProjectsLocationsConnectionsProcessWebhook =
             Empty
        type Scopes CloudbuildProjectsLocationsConnectionsProcessWebhook =
             '[]
        requestClient
          CloudbuildProjectsLocationsConnectionsProcessWebhook{..}
