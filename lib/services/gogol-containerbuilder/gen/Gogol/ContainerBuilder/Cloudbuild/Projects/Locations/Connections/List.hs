...
newCloudbuildProjectsLocationsConnectionsList parent
  = CloudbuildProjectsLocationsConnectionsList{xgafv = Core.Nothing,
                                               accessToken = Core.Nothing, callback = Core.Nothing,
                                               pageSize = Core.Nothing, pageToken = Core.Nothing,
                                               parent = parent, returnPartialSuccess = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes CloudbuildProjectsLocationsConnectionsList =
