...
newCloudbuildProjectsLocationsConnectionsCreate parent payload
  = CloudbuildProjectsLocationsConnectionsCreate{xgafv =
                                                   Core.Nothing,
                                                 accessToken = Core.Nothing,
                                                 callback = Core.Nothing,
                                                 connectionId = Core.Nothing, parent = parent,
...
instance Core.GoogleRequest
        ...
        type Scopes CloudbuildProjectsLocationsConnectionsCreate =
             '[CloudPlatform'FullControl]
        requestClient CloudbuildProjectsLocationsConnectionsCreate{..}
          = go parent xgafv accessToken callback connectionId uploadType
              uploadProtocol
