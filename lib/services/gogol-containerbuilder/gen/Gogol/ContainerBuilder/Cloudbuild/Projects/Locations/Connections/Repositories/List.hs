                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Get '[Core.JSON] ListRepositoriesResponse
...
newCloudbuildProjectsLocationsConnectionsRepositoriesList parent
  = CloudbuildProjectsLocationsConnectionsRepositoriesList{xgafv =
                                                             Core.Nothing,
...
instance Core.GoogleRequest
           CloudbuildProjectsLocationsConnectionsRepositoriesList
         where
        type Rs CloudbuildProjectsLocationsConnectionsRepositoriesList =
