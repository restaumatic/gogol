...
type CloudbuildProjectsLocationsConnectionsRepositoriesAccessReadWriteTokenResource
     =
     "v2" Core.:>
       Core.CaptureMode "repository" "accessReadWriteToken" Core.Text
         Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] FetchReadWriteTokenRequest Core.:>
...
newCloudbuildProjectsLocationsConnectionsRepositoriesAccessReadWriteToken
  payload repository
  = CloudbuildProjectsLocationsConnectionsRepositoriesAccessReadWriteToken{xgafv
                                                                             = Core.Nothing,
                                                                           accessToken =
                                                                             Core.Nothing,
