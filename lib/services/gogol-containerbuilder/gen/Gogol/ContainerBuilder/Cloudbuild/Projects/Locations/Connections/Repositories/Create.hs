...
newCloudbuildProjectsLocationsConnectionsRepositoriesCreate 
    ...
    -> CloudbuildProjectsLocationsConnectionsRepositoriesCreate
newCloudbuildProjectsLocationsConnectionsRepositoriesCreate parent
  payload
  = CloudbuildProjectsLocationsConnectionsRepositoriesCreate{xgafv =
                                                               Core.Nothing,
...
instance Core.GoogleRequest
           CloudbuildProjectsLocationsConnectionsRepositoriesCreate
         where
        type Rs CloudbuildProjectsLocationsConnectionsRepositoriesCreate =
             Operation
        type Scopes
               CloudbuildProjectsLocationsConnectionsRepositoriesCreate
        ...
        requestClient
          CloudbuildProjectsLocationsConnectionsRepositoriesCreate{..}
          = go parent xgafv accessToken callback repositoryId uploadType
              uploadProtocol
