...
newCloudbuildProjectsLocationsConnectionsPatch name payload
  = CloudbuildProjectsLocationsConnectionsPatch{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes CloudbuildProjectsLocationsConnectionsPatch =
             '[CloudPlatform'FullControl]
        requestClient CloudbuildProjectsLocationsConnectionsPatch{..}
          = go name xgafv accessToken allowMissing callback etag updateMask
              uploadType
              uploadProtocol
