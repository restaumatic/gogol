...
newCloudbuildProjectsLocationsConnectionsGetIamPolicy resource
  = CloudbuildProjectsLocationsConnectionsGetIamPolicy{xgafv =
                                                         Core.Nothing,
...
instance Core.GoogleRequest
           CloudbuildProjectsLocationsConnectionsGetIamPolicy
         where
        type Rs CloudbuildProjectsLocationsConnectionsGetIamPolicy = Policy
        type Scopes CloudbuildProjectsLocationsConnectionsGetIamPolicy =
