...
newCloudbuildProjectsLocationsConnectionsGet name
  = CloudbuildProjectsLocationsConnectionsGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           CloudbuildProjectsLocationsConnectionsGet
         where
        type Rs CloudbuildProjectsLocationsConnectionsGet = Connection
        type Scopes CloudbuildProjectsLocationsConnectionsGet =
             '[CloudPlatform'FullControl]
        requestClient CloudbuildProjectsLocationsConnectionsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudbuildProjectsLocationsConnectionsGetResource)
                      Core.mempty
