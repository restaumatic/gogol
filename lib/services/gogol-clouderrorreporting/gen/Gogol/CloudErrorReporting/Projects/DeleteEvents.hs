...
newCloudErrorReportingProjectsDeleteEvents projectName
  = CloudErrorReportingProjectsDeleteEvents{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            projectName = projectName, uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudErrorReportingProjectsDeleteEvents
         where
        ...
        requestClient CloudErrorReportingProjectsDeleteEvents{..}
          = go projectName xgafv accessToken callback uploadType
              uploadProtocol
