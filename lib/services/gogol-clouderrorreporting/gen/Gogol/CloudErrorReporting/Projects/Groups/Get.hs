...
newCloudErrorReportingProjectsGroupsGet groupName
  = CloudErrorReportingProjectsGroupsGet{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         groupName = groupName, uploadType = Core.Nothing,
                                         uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudErrorReportingProjectsGroupsGet
         where
        ...
        requestClient CloudErrorReportingProjectsGroupsGet{..}
          = go groupName xgafv accessToken callback uploadType uploadProtocol
