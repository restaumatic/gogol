...
newCloudErrorReportingProjectsEventsReport payload projectName
  = CloudErrorReportingProjectsEventsReport{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            payload = payload, projectName = projectName,
                                            uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudErrorReportingProjectsEventsReport
         where
