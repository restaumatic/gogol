...
newCloudErrorReportingProjectsEventsList projectName
  = CloudErrorReportingProjectsEventsList{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          groupId = Core.Nothing, pageSize = Core.Nothing,
                                          pageToken = Core.Nothing, projectName = projectName,
                                          serviceFilterResourceType = Core.Nothing,
                                          serviceFilterService = Core.Nothing,
                                          serviceFilterVersion = Core.Nothing,
                                          timeRangePeriod = Core.Nothing, uploadType = Core.Nothing,
                                          uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudErrorReportingProjectsEventsList
         where
        ...
        requestClient CloudErrorReportingProjectsEventsList{..}
          = go projectName xgafv accessToken callback groupId pageSize
              pageToken
