...
newCloudErrorReportingProjectsLocationsGroupsUpdate name payload
  = CloudErrorReportingProjectsLocationsGroupsUpdate{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           CloudErrorReportingProjectsLocationsGroupsUpdate
         where
        type Rs CloudErrorReportingProjectsLocationsGroupsUpdate =
             ErrorGroup
        type Scopes CloudErrorReportingProjectsLocationsGroupsUpdate =
