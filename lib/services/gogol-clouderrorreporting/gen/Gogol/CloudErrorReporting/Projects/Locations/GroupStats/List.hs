                 ...
                 Core.QueryParam "alignmentTime" Core.DateTime Core.:>
                   Core.QueryParam "callback" Core.Text Core.:>
                     Core.QueryParams "groupId" Core.Text Core.:>
                       Core.QueryParam "order" ProjectsLocationsGroupStatsListOrder
                         Core.:>
...
newCloudErrorReportingProjectsLocationsGroupStatsList projectName
  = CloudErrorReportingProjectsLocationsGroupStatsList{xgafv =
                                                         Core.Nothing,
...
instance Core.GoogleRequest
           CloudErrorReportingProjectsLocationsGroupStatsList
         where
        type Rs CloudErrorReportingProjectsLocationsGroupStatsList =
             ListGroupStatsResponse
        type Scopes CloudErrorReportingProjectsLocationsGroupStatsList =
