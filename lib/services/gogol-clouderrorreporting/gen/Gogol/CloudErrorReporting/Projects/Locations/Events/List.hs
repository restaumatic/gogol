...
newCloudErrorReportingProjectsLocationsEventsList projectName
  = CloudErrorReportingProjectsLocationsEventsList{xgafv =
                                                     Core.Nothing,
                                                   accessToken = Core.Nothing,
                                                   callback = Core.Nothing, groupId = Core.Nothing,
...
instance Core.GoogleRequest
           CloudErrorReportingProjectsLocationsEventsList
         where
        type Rs CloudErrorReportingProjectsLocationsEventsList =
             ListEventsResponse
        type Scopes CloudErrorReportingProjectsLocationsEventsList =
