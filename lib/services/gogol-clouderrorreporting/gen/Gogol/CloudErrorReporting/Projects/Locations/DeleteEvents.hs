...
newCloudErrorReportingProjectsLocationsDeleteEvents projectName
  = CloudErrorReportingProjectsLocationsDeleteEvents{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           CloudErrorReportingProjectsLocationsDeleteEvents
         where
        type Rs CloudErrorReportingProjectsLocationsDeleteEvents =
             DeleteEventsResponse
        type Scopes CloudErrorReportingProjectsLocationsDeleteEvents =
