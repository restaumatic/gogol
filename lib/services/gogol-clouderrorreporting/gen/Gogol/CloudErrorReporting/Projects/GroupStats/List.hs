         ...
         "groupStats" Core.:>
           Core.QueryParam "$.xgafv" Xgafv Core.:>
             Core.QueryParam "access_token" Core.Text Core.:>
               Core.QueryParam "alignment" ProjectsGroupStatsListAlignment Core.:>
                 Core.QueryParam "alignmentTime" Core.DateTime Core.:>
                   Core.QueryParam "callback" Core.Text Core.:>
                     Core.QueryParams "groupId" Core.Text Core.:>
                       Core.QueryParam "order" ProjectsGroupStatsListOrder Core.:>
                         Core.QueryParam "pageSize" Core.Int32 Core.:>
                           Core.QueryParam "pageToken" Core.Text Core.:>
                             Core.QueryParam "serviceFilter.resourceType" Core.Text Core.:>
                               Core.QueryParam "serviceFilter.service" Core.Text Core.:>
                                 Core.QueryParam "serviceFilter.version" Core.Text Core.:>
                                   Core.QueryParam "timeRange.period"
                                     ProjectsGroupStatsListTimeRangePeriod
                                     Core.:>
                                     Core.QueryParam "timedCountDuration" Core.Duration Core.:>
                                       Core.QueryParam "uploadType" Core.Text Core.:>
                                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                                           Core.QueryParam "alt" Core.AltJSON Core.:>
                                             Core.Get '[Core.JSON] ListGroupStatsResponse
...
newCloudErrorReportingProjectsGroupStatsList projectName
  = CloudErrorReportingProjectsGroupStatsList{xgafv = Core.Nothing,
                                              accessToken = Core.Nothing, alignment = Core.Nothing,
                                              alignmentTime = Core.Nothing, callback = Core.Nothing,
                                              groupId = Core.Nothing, order = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        requestClient CloudErrorReportingProjectsGroupStatsList{..}
          = go projectName xgafv accessToken alignment alignmentTime callback
