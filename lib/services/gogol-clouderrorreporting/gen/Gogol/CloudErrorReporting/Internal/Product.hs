...
newErrorContext 
    ::  ErrorContext
newErrorContext
  = ErrorContext{httpRequest = Core.Nothing,
                 reportLocation = Core.Nothing, sourceReferences = Core.Nothing,
                 user = Core.Nothing}
instance Core.FromJSON ErrorContext where
        parseJSON
          = Core.withObject "ErrorContext"
              (\ o ->
                 ErrorContext Core.<$>
                   (o Core..:? "httpRequest") Core.<*> (o Core..:? "reportLocation")
...
newErrorEvent 
    ::  ErrorEvent
newErrorEvent
  = ErrorEvent{context = Core.Nothing, eventTime = Core.Nothing,
               message = Core.Nothing, serviceContext = Core.Nothing}
instance Core.FromJSON ErrorEvent where
        parseJSON
          = Core.withObject "ErrorEvent"
              (\ o ->
                 ErrorEvent Core.<$>
                   (o Core..:? "context") Core.<*> (o Core..:? "eventTime") Core.<*>
                     (o Core..:? "message")
...
newErrorGroup 
    ::  ErrorGroup
newErrorGroup
  = ErrorGroup{groupId = Core.Nothing, name = Core.Nothing,
               resolutionStatus = Core.Nothing, trackingIssues = Core.Nothing}
instance Core.FromJSON ErrorGroup where
        parseJSON
          = Core.withObject "ErrorGroup"
              (\ o ->
                 ErrorGroup Core.<$>
                   (o Core..:? "groupId") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "resolutionStatus")
...
newErrorGroupStats 
    ::  ErrorGroupStats
newErrorGroupStats
  = ErrorGroupStats{affectedServices = Core.Nothing,
                    affectedUsersCount = Core.Nothing, count = Core.Nothing,
                    firstSeenTime = Core.Nothing, group' = Core.Nothing,
                    lastSeenTime = Core.Nothing, numAffectedServices = Core.Nothing,
                    representative = Core.Nothing, timedCounts = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("affectedServices" Core..=) Core.<$> affectedServices,
                  ("affectedUsersCount" Core..=) Core.. Core.AsText Core.<$>
                    affectedUsersCount,
...
newHttpRequestContext 
    ::  HttpRequestContext
newHttpRequestContext
  = HttpRequestContext{method = Core.Nothing,
                       referrer = Core.Nothing, remoteIp = Core.Nothing,
                       responseStatusCode = Core.Nothing, url = Core.Nothing,
          ...
          = Core.withObject "HttpRequestContext"
              (\ o ->
                 HttpRequestContext Core.<$>
                   (o Core..:? "method") Core.<*> (o Core..:? "referrer") Core.<*>
                     (o Core..:? "remoteIp")
...
newListEventsResponse 
    ::  ListEventsResponse
newListEventsResponse
  = ListEventsResponse{errorEvents = Core.Nothing,
                       nextPageToken = Core.Nothing, timeRangeBegin = Core.Nothing}
instance Core.FromJSON ListEventsResponse where
        parseJSON
          = Core.withObject "ListEventsResponse"
              (\ o ->
                 ListEventsResponse Core.<$>
                   (o Core..:? "errorEvents") Core.<*> (o Core..:? "nextPageToken")
...
newListGroupStatsResponse 
    ::  ListGroupStatsResponse
newListGroupStatsResponse
  = ListGroupStatsResponse{errorGroupStats = Core.Nothing,
                           nextPageToken = Core.Nothing, timeRangeBegin = Core.Nothing}
...
newReportedErrorEvent 
    ::  ReportedErrorEvent
newReportedErrorEvent
  = ReportedErrorEvent{context = Core.Nothing,
...
newServiceContext 
    ::  ServiceContext
newServiceContext
  = ServiceContext{resourceType = Core.Nothing,
...
instance Core.FromJSON ServiceContext where
        parseJSON
          = Core.withObject "ServiceContext"
              (\ o ->
                 ServiceContext Core.<$>
                   (o Core..:? "resourceType") Core.<*> (o Core..:? "service")
                     Core.<*> (o Core..:? "version"))
...
newSourceLocation 
    ::  SourceLocation
newSourceLocation
  = SourceLocation{filePath = Core.Nothing,
...
instance Core.FromJSON SourceLocation where
        parseJSON
          = Core.withObject "SourceLocation"
              (\ o ->
                 SourceLocation Core.<$>
                   (o Core..:? "filePath") Core.<*> (o Core..:? "functionName")
...
newTimedCount 
    ::  TimedCount
newTimedCount
  = TimedCount{count = Core.Nothing, endTime = Core.Nothing,
