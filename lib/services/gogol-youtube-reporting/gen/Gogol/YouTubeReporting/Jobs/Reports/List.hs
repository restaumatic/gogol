             ...
             Core.QueryParam "$.xgafv" Xgafv Core.:>
               Core.QueryParam "access_token" Core.Text Core.:>
                 Core.QueryParam "callback" Core.Text Core.:>
                   Core.QueryParam "createdAfter" Core.DateTime Core.:>
                     Core.QueryParam "onBehalfOfContentOwner" Core.Text Core.:>
                       Core.QueryParam "pageSize" Core.Int32 Core.:>
                         Core.QueryParam "pageToken" Core.Text Core.:>
                           Core.QueryParam "startTimeAtOrAfter" Core.DateTime Core.:>
                             Core.QueryParam "startTimeBefore" Core.DateTime Core.:>
...
newYouTubeReportingJobsReportsList jobId
  = YouTubeReportingJobsReportsList{xgafv = Core.Nothing,
                                    accessToken = Core.Nothing, callback = Core.Nothing,
                                    createdAfter = Core.Nothing, jobId = jobId,
                                    onBehalfOfContentOwner = Core.Nothing, pageSize = Core.Nothing,
                                    pageToken = Core.Nothing, startTimeAtOrAfter = Core.Nothing,
                                    startTimeBefore = Core.Nothing, uploadType = Core.Nothing,
