...
newYouTubeReportingJobsDelete jobId
  = YouTubeReportingJobsDelete{xgafv = Core.Nothing,
                               accessToken = Core.Nothing, callback = Core.Nothing, jobId = jobId,
                               onBehalfOfContentOwner = Core.Nothing, uploadType = Core.Nothing,
                               uploadProtocol = Core.Nothing}
instance Core.GoogleRequest YouTubeReportingJobsDelete where
        ...
        requestClient YouTubeReportingJobsDelete{..}
          = go jobId xgafv accessToken callback onBehalfOfContentOwner
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy YouTubeReportingJobsDeleteResource)
                      Core.mempty
