...
newYouTubeReportingMediaDownload resourceName
  = YouTubeReportingMediaDownload{xgafv = Core.Nothing,
...
instance Core.GoogleRequest YouTubeReportingMediaDownload where
        ...
        type Scopes YouTubeReportingMediaDownload =
...
instance Core.GoogleRequest
         ...
         where
        type Rs (Core.MediaDownload YouTubeReportingMediaDownload) =
             Core.Stream
        type Scopes (Core.MediaDownload YouTubeReportingMediaDownload) =
