...
newGdataBlobstore2Info 
    ::  GdataBlobstore2Info
newGdataBlobstore2Info
  = GdataBlobstore2Info{blobGeneration = Core.Nothing,
                        blobId = Core.Nothing, downloadReadHandle = Core.Nothing,
                        readToken = Core.Nothing, uploadMetadataContainer = Core.Nothing}
instance Core.FromJSON GdataBlobstore2Info where
        parseJSON
          = Core.withObject "GdataBlobstore2Info"
              (\ o ->
                 GdataBlobstore2Info Core.<$>
                   (o Core..:? "blobGeneration" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "blobId")
...
instance Core.ToJSON GdataBlobstore2Info where
        toJSON GdataBlobstore2Info{..}
          = Core.object
              (Core.catMaybes
                 [("blobGeneration" Core..=) Core.. Core.AsText Core.<$>
                    blobGeneration,
                  ("blobId" Core..=) Core.<$> blobId,
                  ("downloadReadHandle" Core..=) Core.<$> downloadReadHandle,
...
newGdataCompositeMedia 
    ::  GdataCompositeMedia
newGdataCompositeMedia
  = GdataCompositeMedia{blobRef = Core.Nothing,
                        blobstore2Info = Core.Nothing, cosmoBinaryReference = Core.Nothing,
                        crc32cHash = Core.Nothing, inline = Core.Nothing,
                        length = Core.Nothing, md5Hash = Core.Nothing,
                        objectId = Core.Nothing, path = Core.Nothing,
                        referenceType = Core.Nothing, sha1Hash = Core.Nothing}
instance Core.FromJSON GdataCompositeMedia where
        parseJSON
          = Core.withObject "GdataCompositeMedia"
              (\ o ->
                 GdataCompositeMedia Core.<$>
                   (o Core..:? "blobRef") Core.<*> (o Core..:? "blobstore2Info")
                     Core.<*> (o Core..:? "cosmoBinaryReference")
                     Core.<*> (o Core..:? "crc32cHash")
                     Core.<*> (o Core..:? "inline")
                     Core.<*> (o Core..:? "length" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "md5Hash")
          ...
          = Core.object
              (Core.catMaybes
                 [("blobRef" Core..=) Core.<$> blobRef,
                  ...
                  ("cosmoBinaryReference" Core..=) Core.<$> cosmoBinaryReference,
                  ("crc32cHash" Core..=) Core.<$> crc32cHash,
                  ("inline" Core..=) Core.<$> inline,
                  ("length" Core..=) Core.. Core.AsText Core.<$> length,
...
newGdataContentTypeInfo 
    ::  GdataContentTypeInfo
newGdataContentTypeInfo
  = GdataContentTypeInfo{bestGuess = Core.Nothing,
                         fromBytes = Core.Nothing, fromFileName = Core.Nothing,
                         fromHeader = Core.Nothing, fromUrlPath = Core.Nothing}
instance Core.FromJSON GdataContentTypeInfo where
        parseJSON
          = Core.withObject "GdataContentTypeInfo"
              (\ o ->
                 GdataContentTypeInfo Core.<$>
                   (o Core..:? "bestGuess") Core.<*> (o Core..:? "fromBytes") Core.<*>
                     (o Core..:? "fromFileName")
...
newGdataDiffChecksumsResponse 
    ::  GdataDiffChecksumsResponse
newGdataDiffChecksumsResponse
  = GdataDiffChecksumsResponse{checksumsLocation = Core.Nothing,
                               chunkSizeBytes = Core.Nothing, objectLocation = Core.Nothing,
                               objectSizeBytes = Core.Nothing, objectVersion = Core.Nothing}
instance Core.FromJSON GdataDiffChecksumsResponse where
        parseJSON
          = Core.withObject "GdataDiffChecksumsResponse"
              (\ o ->
                 GdataDiffChecksumsResponse Core.<$>
                   (o Core..:? "checksumsLocation") Core.<*>
                     (o Core..:? "chunkSizeBytes" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "objectLocation")
                     Core.<*>
                     (o Core..:? "objectSizeBytes" Core.<&> Core.fmap Core.fromAsText)
...
instance Core.ToJSON GdataDiffChecksumsResponse where
        toJSON GdataDiffChecksumsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("checksumsLocation" Core..=) Core.<$> checksumsLocation,
                  ("chunkSizeBytes" Core..=) Core.. Core.AsText Core.<$>
                    chunkSizeBytes,
                  ("objectLocation" Core..=) Core.<$> objectLocation,
                  ("objectSizeBytes" Core..=) Core.. Core.AsText Core.<$>
                    objectSizeBytes,
...
instance Core.FromJSON GdataDiffDownloadResponse where
        parseJSON
          = Core.withObject "GdataDiffDownloadResponse"
              (\ o ->
                 GdataDiffDownloadResponse Core.<$> (o Core..:? "objectLocation"))
...
newGdataDiffUploadRequest 
    ::  GdataDiffUploadRequest
newGdataDiffUploadRequest
  = GdataDiffUploadRequest{checksumsInfo = Core.Nothing,
                           objectInfo = Core.Nothing, objectVersion = Core.Nothing}
instance Core.FromJSON GdataDiffUploadRequest where
        parseJSON
          = Core.withObject "GdataDiffUploadRequest"
              (\ o ->
                 GdataDiffUploadRequest Core.<$>
                   (o Core..:? "checksumsInfo") Core.<*> (o Core..:? "objectInfo")
                     Core.<*> (o Core..:? "objectVersion"))
...
newGdataDiffUploadResponse 
    ::  GdataDiffUploadResponse
newGdataDiffUploadResponse
  = GdataDiffUploadResponse{objectVersion = Core.Nothing,
                            originalObject = Core.Nothing}
...
newGdataDiffVersionResponse 
    ::  GdataDiffVersionResponse
newGdataDiffVersionResponse
  = GdataDiffVersionResponse{objectSizeBytes = Core.Nothing,
...
newGdataDownloadParameters 
    ::  GdataDownloadParameters
newGdataDownloadParameters
  = GdataDownloadParameters{allowGzipCompression = Core.Nothing,
                            ignoreRange = Core.Nothing}
...
instance Core.ToJSON GdataDownloadParameters where
        toJSON GdataDownloadParameters{..}
          = Core.object
              (Core.catMaybes
                 [("allowGzipCompression" Core..=) Core.<$> allowGzipCompression,
...
newGdataMedia 
    ::  GdataMedia
newGdataMedia
  = GdataMedia{algorithm = Core.Nothing,
               bigstoreObjectRef = Core.Nothing, blobRef = Core.Nothing,
               blobstore2Info = Core.Nothing, compositeMedia = Core.Nothing,
               contentType = Core.Nothing, contentTypeInfo = Core.Nothing,
               cosmoBinaryReference = Core.Nothing, crc32cHash = Core.Nothing,
               ...
               downloadParameters = Core.Nothing, filename = Core.Nothing,
               hash = Core.Nothing, hashVerified = Core.Nothing,
               inline = Core.Nothing, isPotentialRetry = Core.Nothing,
               length = Core.Nothing, md5Hash = Core.Nothing,
               mediaId = Core.Nothing, objectId = Core.Nothing,
               path = Core.Nothing, referenceType = Core.Nothing,
               sha1Hash = Core.Nothing, sha256Hash = Core.Nothing,
               timestamp = Core.Nothing, token = Core.Nothing}
instance Core.FromJSON GdataMedia where
        parseJSON
          = Core.withObject "GdataMedia"
              (\ o ->
                 GdataMedia Core.<$>
                   (o Core..:? "algorithm") Core.<*> (o Core..:? "bigstoreObjectRef")
                     Core.<*> (o Core..:? "blobRef")
          ...
          = Core.object
              (Core.catMaybes
                 [("algorithm" Core..=) Core.<$> algorithm,
                  ("bigstoreObjectRef" Core..=) Core.<$> bigstoreObjectRef,
                  ("blobRef" Core..=) Core.<$> blobRef,
                  ("blobstore2Info" Core..=) Core.<$> blobstore2Info,
                  ...
                  ("cosmoBinaryReference" Core..=) Core.<$> cosmoBinaryReference,
                  ("crc32cHash" Core..=) Core.<$> crc32cHash,
                  ("diffChecksumsResponse" Core..=) Core.<$> diffChecksumsResponse,
                  ("diffDownloadResponse" Core..=) Core.<$> diffDownloadResponse,
                  ("diffUploadRequest" Core..=) Core.<$> diffUploadRequest,
                  ("diffUploadResponse" Core..=) Core.<$> diffUploadResponse,
                  ("diffVersionResponse" Core..=) Core.<$> diffVersionResponse,
                  ("downloadParameters" Core..=) Core.<$> downloadParameters,
                  ("filename" Core..=) Core.<$> filename,
                  ("hash" Core..=) Core.<$> hash,
                  ("hashVerified" Core..=) Core.<$> hashVerified,
                  ("inline" Core..=) Core.<$> inline,
                  ("isPotentialRetry" Core..=) Core.<$> isPotentialRetry,
                  ("length" Core..=) Core.. Core.AsText Core.<$> length,
                  ("md5Hash" Core..=) Core.<$> md5Hash,
...
newGdataObjectId 
    ::  GdataObjectId
newGdataObjectId
  = GdataObjectId{bucketName = Core.Nothing,
                  generation = Core.Nothing, objectName = Core.Nothing}
...
newJob 
    ::  Job
newJob
  = Job{createTime = Core.Nothing, expireTime = Core.Nothing,
        id = Core.Nothing, name = Core.Nothing,
        reportTypeId = Core.Nothing, systemManaged = Core.Nothing}
instance Core.FromJSON Job where
        parseJSON
          = Core.withObject "Job"
              (\ o ->
                 Job Core.<$>
                   (o Core..:? "createTime") Core.<*> (o Core..:? "expireTime")
                     Core.<*> (o Core..:? "id")
                     Core.<*> (o Core..:? "name")
...
newListReportsResponse 
    ::  ListReportsResponse
newListReportsResponse
  = ListReportsResponse{nextPageToken = Core.Nothing,
          ...
          = Core.withObject "ListReportsResponse"
              (\ o ->
                 ListReportsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "reports"))
...
newReport 
    ::  Report
newReport
  = Report{createTime = Core.Nothing, downloadUrl = Core.Nothing,
           endTime = Core.Nothing, id = Core.Nothing,
           jobExpireTime = Core.Nothing, jobId = Core.Nothing,
...
newReportType 
    ::  ReportType
newReportType
  = ReportType{deprecateTime = Core.Nothing, id = Core.Nothing,
               name = Core.Nothing, systemManaged = Core.Nothing}
instance Core.FromJSON ReportType where
        parseJSON
          = Core.withObject "ReportType"
              (\ o ->
                 ReportType Core.<$>
                   (o Core..:? "deprecateTime") Core.<*> (o Core..:? "id") Core.<*>
                     (o Core..:? "name")
                     Core.<*> (o Core..:? "systemManaged"))
