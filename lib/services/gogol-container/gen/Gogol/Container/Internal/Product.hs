...
module Gogol.Container.Internal.Product
  (
    ...
    -- * EvictionGracePeriod
    EvictionGracePeriod (..),
    newEvictionGracePeriod,

    -- * EvictionMinimumReclaim
    EvictionMinimumReclaim (..),
    newEvictionMinimumReclaim,
...
data AddonsConfig = AddonsConfig
    ...
    , lustreCsiDriverConfig :: (Core.Maybe LustreCsiDriverConfig)
...
newAddonsConfig
  = AddonsConfig{cloudRunConfig = Core.Nothing,
                 ...
                 lustreCsiDriverConfig = Core.Nothing,
              ...
              (\ o ->
                 AddonsConfig Core.<$>
                   (o Core..:? "cloudRunConfig") Core.<*>
                     ...
                     Core.<*> (o Core..:? "lustreCsiDriverConfig")
          ...
          = Core.object
              (Core.catMaybes
                 [("cloudRunConfig" Core..=) Core.<$> cloudRunConfig,
                  ...
                  ("lustreCsiDriverConfig" Core..=) Core.<$> lustreCsiDriverConfig,
...
newtype AutoIpamConfig = AutoIpamConfig
    {
...
data Autopilot = Autopilot
    ...
    , privilegedAdmissionConfig :: (Core.Maybe PrivilegedAdmissionConfig)
...
newAutopilot
  = Autopilot{enabled = Core.Nothing,
              privilegedAdmissionConfig = Core.Nothing,
        ...
        parseJSON
          = Core.withObject "Autopilot"
              (\ o ->
                 Autopilot Core.<$>
                   (o Core..:? "enabled") Core.<*>
                     (o Core..:? "privilegedAdmissionConfig")
...
instance Core.ToJSON Autopilot where
        toJSON Autopilot{..}
          = Core.object
              (Core.catMaybes
                 [("enabled" Core..=) Core.<$> enabled,
                  ("privilegedAdmissionConfig" Core..=) Core.<$>
                    privilegedAdmissionConfig,
...
--
-- /See:/ 'newAutoscaledRolloutPolicy' smart constructor.
newtype AutoscaledRolloutPolicy = AutoscaledRolloutPolicy
    {
      ...
      waitForDrainDuration :: (Core.Maybe Core.Duration)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'AutoscaledRolloutPolicy' with the minimum fields required to make a request.
newAutoscaledRolloutPolicy 
    ::  AutoscaledRolloutPolicy
newAutoscaledRolloutPolicy
  = AutoscaledRolloutPolicy{waitForDrainDuration = Core.Nothing}
instance Core.FromJSON AutoscaledRolloutPolicy where
        parseJSON
          = Core.withObject "AutoscaledRolloutPolicy"
              (\ o ->
                 AutoscaledRolloutPolicy Core.<$>
                   (o Core..:? "waitForDrainDuration"))

instance Core.ToJSON AutoscaledRolloutPolicy where
        toJSON AutoscaledRolloutPolicy{..}
          = Core.object
              (Core.catMaybes
                 [("waitForDrainDuration" Core..=) Core.<$> waitForDrainDuration])
...
data BlueGreenSettings = BlueGreenSettings
    {
      ...
      autoscaledRolloutPolicy :: (Core.Maybe AutoscaledRolloutPolicy)
...
newBlueGreenSettings 
    ::  BlueGreenSettings
newBlueGreenSettings
  = BlueGreenSettings{autoscaledRolloutPolicy = Core.Nothing,
          ...
          = Core.withObject "BlueGreenSettings"
              (\ o ->
                 BlueGreenSettings Core.<$>
                   (o Core..:? "autoscaledRolloutPolicy") Core.<*>
                     (o Core..:? "nodePoolSoakDuration")
...
instance Core.ToJSON BlueGreenSettings where
        toJSON BlueGreenSettings{..}
          = Core.object
              (Core.catMaybes
                 [("autoscaledRolloutPolicy" Core..=) Core.<$>
                    autoscaledRolloutPolicy,
...
--
-- /See:/ 'newBootDisk' smart constructor.
data BootDisk = BootDisk
    ...
    , provisionedThroughput :: (Core.Maybe Core.Int64)
      -- | Disk size in GB. Replaces NodeConfig.disk/size/gb
    , sizeGb :: (Core.Maybe Core.Int64)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'BootDisk' with the minimum fields required to make a request.
newBootDisk 
    ::  BootDisk
newBootDisk
  = BootDisk{diskType = Core.Nothing, provisionedIops = Core.Nothing,
             provisionedThroughput = Core.Nothing, sizeGb = Core.Nothing}
instance Core.FromJSON BootDisk where
        parseJSON
          = Core.withObject "BootDisk"
              (\ o ->
                 BootDisk Core.<$>
                   (o Core..:? "diskType") Core.<*>
                     (o Core..:? "provisionedIops" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "provisionedThroughput" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "sizeGb" Core.<&> Core.fmap Core.fromAsText))

instance Core.ToJSON BootDisk where
        toJSON BootDisk{..}
          = Core.object
              (Core.catMaybes
                 [("diskType" Core..=) Core.<$> diskType,
                  ("provisionedIops" Core..=) Core.. Core.AsText Core.<$>
                    provisionedIops,
                  ("provisionedThroughput" Core..=) Core.. Core.AsText Core.<$>
                    provisionedThroughput,
                  ("sizeGb" Core..=) Core.. Core.AsText Core.<$> sizeGb])
...
data ClusterAutoscaling = ClusterAutoscaling
    ...
    , defaultComputeClassConfig :: (Core.Maybe DefaultComputeClassConfig)
...
newClusterAutoscaling
  = ClusterAutoscaling{autoprovisioningLocations = Core.Nothing,
                       ...
                       defaultComputeClassConfig = Core.Nothing,
              ...
              (\ o ->
                 ClusterAutoscaling Core.<$>
                   (o Core..:? "autoprovisioningLocations") Core.<*>
                     ...
                     Core.<*> (o Core..:? "defaultComputeClassConfig")
          ...
          = Core.object
              (Core.catMaybes
                 [("autoprovisioningLocations" Core..=) Core.<$>
                  ...
                  ("defaultComputeClassConfig" Core..=) Core.<$>
                    defaultComputeClassConfig,
...
data ClusterUpdate = ClusterUpdate
    ...
    , desiredNetworkTierConfig :: (Core.Maybe NetworkTierConfig)
...
newClusterUpdate
  = ClusterUpdate{additionalPodRangesConfig = Core.Nothing,
                  ...
                  desiredNetworkTierConfig = Core.Nothing,
              ...
              (\ o ->
                 ClusterUpdate Core.<$>
                   (o Core..:? "additionalPodRangesConfig") Core.<*>
                     ...
                     Core.<*> (o Core..:? "desiredNetworkTierConfig")
          ...
          = Core.object
              (Core.catMaybes
                 [("additionalPodRangesConfig" Core..=) Core.<$>
                  ...
                  ("desiredNetworkTierConfig" Core..=) Core.<$>
...
data DNSEndpointConfig = DNSEndpointConfig
    ...
    , enableK8sCertsViaDns :: (Core.Maybe Core.Bool)
      -- | Controls whether the k8s token auth is allowed via DNS.
    , enableK8sTokensViaDns :: (Core.Maybe Core.Bool)
...
newDNSEndpointConfig
  = DNSEndpointConfig{allowExternalTraffic = Core.Nothing,
                      enableK8sCertsViaDns = Core.Nothing,
                      enableK8sTokensViaDns = Core.Nothing, endpoint = Core.Nothing}
              ...
              (\ o ->
                 DNSEndpointConfig Core.<$>
                   (o Core..:? "allowExternalTraffic") Core.<*>
                     (o Core..:? "enableK8sCertsViaDns")
                     Core.<*> (o Core..:? "enableK8sTokensViaDns")
                     Core.<*> (o Core..:? "endpoint"))
          ...
          = Core.object
              (Core.catMaybes
                 [("allowExternalTraffic" Core..=) Core.<$> allowExternalTraffic,
                  ("enableK8sCertsViaDns" Core..=) Core.<$> enableK8sCertsViaDns,
                  ("enableK8sTokensViaDns" Core..=) Core.<$> enableK8sTokensViaDns,
                  ("endpoint" Core..=) Core.<$> endpoint])
...
--
-- /See:/ 'newDefaultComputeClassConfig' smart constructor.
newtype DefaultComputeClassConfig = DefaultComputeClassConfig
    {
...
-- | Creates a value of 'DefaultComputeClassConfig' with the minimum fields required to make a request.
newDefaultComputeClassConfig 
    ::  DefaultComputeClassConfig
newDefaultComputeClassConfig
  = DefaultComputeClassConfig{enabled = Core.Nothing}
instance Core.FromJSON DefaultComputeClassConfig where
        parseJSON
          = Core.withObject "DefaultComputeClassConfig"
              (\ o -> DefaultComputeClassConfig Core.<$> (o Core..:? "enabled"))

instance Core.ToJSON DefaultComputeClassConfig where
        toJSON DefaultComputeClassConfig{..}
          = Core.object
              (Core.catMaybes [("enabled" Core..=) Core.<$> enabled])
...
--
-- /See:/ 'newEvictionGracePeriod' smart constructor.
data EvictionGracePeriod = EvictionGracePeriod
    {
      ...
      imagefsAvailable :: (Core.Maybe Core.Text)
    ...
    , imagefsInodesFree :: (Core.Maybe Core.Text)
    ...
    , memoryAvailable :: (Core.Maybe Core.Text)
    ...
    , nodefsAvailable :: (Core.Maybe Core.Text)
    ...
    , nodefsInodesFree :: (Core.Maybe Core.Text)
    ...
    , pidAvailable :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'EvictionGracePeriod' with the minimum fields required to make a request.
newEvictionGracePeriod 
    ::  EvictionGracePeriod
newEvictionGracePeriod
  = EvictionGracePeriod{imagefsAvailable = Core.Nothing,
                        imagefsInodesFree = Core.Nothing, memoryAvailable = Core.Nothing,
                        nodefsAvailable = Core.Nothing, nodefsInodesFree = Core.Nothing,
                        pidAvailable = Core.Nothing}
instance Core.FromJSON EvictionGracePeriod where
        parseJSON
          = Core.withObject "EvictionGracePeriod"
              (\ o ->
                 EvictionGracePeriod Core.<$>
                   (o Core..:? "imagefsAvailable") Core.<*>
                     (o Core..:? "imagefsInodesFree")
                     Core.<*> (o Core..:? "memoryAvailable")
                     Core.<*> (o Core..:? "nodefsAvailable")
                     Core.<*> (o Core..:? "nodefsInodesFree")
                     Core.<*> (o Core..:? "pidAvailable"))

instance Core.ToJSON EvictionGracePeriod where
        toJSON EvictionGracePeriod{..}
          = Core.object
              (Core.catMaybes
                 [("imagefsAvailable" Core..=) Core.<$> imagefsAvailable,
                  ("imagefsInodesFree" Core..=) Core.<$> imagefsInodesFree,
                  ("memoryAvailable" Core..=) Core.<$> memoryAvailable,
                  ("nodefsAvailable" Core..=) Core.<$> nodefsAvailable,
                  ("nodefsInodesFree" Core..=) Core.<$> nodefsInodesFree,
                  ("pidAvailable" Core..=) Core.<$> pidAvailable])


-- | Eviction minimum reclaims are the resource amounts of minimum reclaims for each eviction signal.
--
-- /See:/ 'newEvictionMinimumReclaim' smart constructor.
data EvictionMinimumReclaim = EvictionMinimumReclaim
    {
...
-- | Creates a value of 'EvictionMinimumReclaim' with the minimum fields required to make a request.
newEvictionMinimumReclaim 
    ::  EvictionMinimumReclaim
newEvictionMinimumReclaim
  = EvictionMinimumReclaim{imagefsAvailable = Core.Nothing,
                           imagefsInodesFree = Core.Nothing, memoryAvailable = Core.Nothing,
                           nodefsAvailable = Core.Nothing, nodefsInodesFree = Core.Nothing,
                           pidAvailable = Core.Nothing}
instance Core.FromJSON EvictionMinimumReclaim where
        parseJSON
          = Core.withObject "EvictionMinimumReclaim"
              (\ o ->
                 EvictionMinimumReclaim Core.<$>
                   (o Core..:? "imagefsAvailable") Core.<*>
                     (o Core..:? "imagefsInodesFree")
                     Core.<*> (o Core..:? "memoryAvailable")
                     Core.<*> (o Core..:? "nodefsAvailable")
...
instance Core.ToJSON EvictionMinimumReclaim where
        toJSON EvictionMinimumReclaim{..}
          = Core.object
              (Core.catMaybes
                 [("imagefsAvailable" Core..=) Core.<$> imagefsAvailable,
                  ("imagefsInodesFree" Core..=) Core.<$> imagefsInodesFree,
...
--
-- /See:/ 'newEvictionSignals' smart constructor.
data EvictionSignals = EvictionSignals
    {
...
-- | Creates a value of 'EvictionSignals' with the minimum fields required to make a request.
newEvictionSignals 
    ::  EvictionSignals
newEvictionSignals
  = EvictionSignals{imagefsAvailable = Core.Nothing,
                    imagefsInodesFree = Core.Nothing, memoryAvailable = Core.Nothing,
                    nodefsAvailable = Core.Nothing, nodefsInodesFree = Core.Nothing,
                    pidAvailable = Core.Nothing}
instance Core.FromJSON EvictionSignals where
        parseJSON
          = Core.withObject "EvictionSignals"
              (\ o ->
                 EvictionSignals Core.<$>
                   (o Core..:? "imagefsAvailable") Core.<*>
                     (o Core..:? "imagefsInodesFree")
                     Core.<*> (o Core..:? "memoryAvailable")
                     Core.<*> (o Core..:? "nodefsAvailable")
...
instance Core.ToJSON EvictionSignals where
        toJSON EvictionSignals{..}
          = Core.object
              (Core.catMaybes
                 [("imagefsAvailable" Core..=) Core.<$> imagefsAvailable,
                  ("imagefsInodesFree" Core..=) Core.<$> imagefsInodesFree,
...
data Fleet = Fleet
    ...
    , membershipType :: (Core.Maybe Fleet_MembershipType)
...
newFleet 
    ::  Fleet
newFleet
  = Fleet{membership = Core.Nothing, membershipType = Core.Nothing,
          preRegistered = Core.Nothing, project = Core.Nothing}
instance Core.FromJSON Fleet where
        parseJSON
          = Core.withObject "Fleet"
              (\ o ->
                 Fleet Core.<$>
                   (o Core..:? "membership") Core.<*> (o Core..:? "membershipType")
          ...
          = Core.object
              (Core.catMaybes
                 [("membership" Core..=) Core.<$> membership,
                  ("membershipType" Core..=) Core.<$> membershipType,
...
data IPAllocationPolicy = IPAllocationPolicy
    ...
    , networkTierConfig :: (Core.Maybe NetworkTierConfig)
...
newIPAllocationPolicy
  = IPAllocationPolicy{additionalIpRangesConfigs = Core.Nothing,
                       ...
                       ipv6AccessType = Core.Nothing, networkTierConfig = Core.Nothing,
                       nodeIpv4Cidr = Core.Nothing, nodeIpv4CidrBlock = Core.Nothing,
          ...
          = Core.object
              (Core.catMaybes
                 [("additionalIpRangesConfigs" Core..=) Core.<$>
                  ...
                  ("networkTierConfig" Core..=) Core.<$> networkTierConfig,
...
data LinuxNodeConfig = LinuxNodeConfig
    ...
    , hugepages :: (Core.Maybe HugepagesConfig)
      -- | The Linux kernel parameters to be applied to the nodes and all pods running on the nodes. The following parameters are supported. net.core.busy/poll net.core.busy/read net.core.netdev/max/backlog net.core.rmem/max net.core.rmem/default net.core.wmem/default net.core.wmem/max net.core.optmem/max net.core.somaxconn net.ipv4.tcp/rmem net.ipv4.tcp/wmem net.ipv4.tcp/tw/reuse net.ipv4.tcp/max/orphans net.netfilter.nf/conntrack/max net.netfilter.nf/conntrack/buckets net.netfilter.nf/conntrack/tcp/timeout/close/wait net.netfilter.nf/conntrack/tcp/timeout/time/wait net.netfilter.nf/conntrack/tcp/timeout/established net.netfilter.nf/conntrack/acct kernel.shmmni kernel.shmmax kernel.shmall fs.aio-max-nr fs.file-max fs.inotify.max/user/instances fs.inotify.max/user/watches fs.nr/open vm.dirty/background/ratio vm.dirty/expire/centisecs vm.dirty/ratio vm.dirty/writeback/centisecs vm.max/map/count vm.overcommit/memory vm.overcommit/ratio vm.vfs/cache/pressure vm.swappiness vm.watermark/scale/factor vm.min/free_kbytes
    ...
    , transparentHugepageDefrag :: (Core.Maybe LinuxNodeConfig_TransparentHugepageDefrag)
    ...
    , transparentHugepageEnabled :: (Core.Maybe LinuxNodeConfig_TransparentHugepageEnabled)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newLinuxNodeConfig
  = LinuxNodeConfig{cgroupMode = Core.Nothing,
                    ...
                    transparentHugepageDefrag = Core.Nothing,
                    transparentHugepageEnabled = Core.Nothing}
              ...
              (\ o ->
                 LinuxNodeConfig Core.<$>
                   (o Core..:? "cgroupMode") Core.<*> (o Core..:? "hugepages")
                     Core.<*> (o Core..:? "sysctls")
                     Core.<*> (o Core..:? "transparentHugepageDefrag")
                     Core.<*> (o Core..:? "transparentHugepageEnabled"))
          ...
          = Core.object
              (Core.catMaybes
                 [("cgroupMode" Core..=) Core.<$> cgroupMode,
                  ...
                  ("transparentHugepageDefrag" Core..=) Core.<$>
                    transparentHugepageDefrag,
                  ("transparentHugepageEnabled" Core..=) Core.<$>
...
-- | Configuration for the Lustre CSI driver.
--
-- /See:/ 'newLustreCsiDriverConfig' smart constructor.
data LustreCsiDriverConfig = LustreCsiDriverConfig
    {
      ...
      enableLegacyLustrePort :: (Core.Maybe Core.Bool)
      -- | Whether the Lustre CSI driver is enabled for this cluster.
    , enabled :: (Core.Maybe Core.Bool)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'LustreCsiDriverConfig' with the minimum fields required to make a request.
newLustreCsiDriverConfig 
    ::  LustreCsiDriverConfig
newLustreCsiDriverConfig
  = LustreCsiDriverConfig{enableLegacyLustrePort = Core.Nothing,
                          enabled = Core.Nothing}
instance Core.FromJSON LustreCsiDriverConfig where
        parseJSON
          = Core.withObject "LustreCsiDriverConfig"
              (\ o ->
                 LustreCsiDriverConfig Core.<$>
                   (o Core..:? "enableLegacyLustrePort") Core.<*>
                     (o Core..:? "enabled"))

instance Core.ToJSON LustreCsiDriverConfig where
        toJSON LustreCsiDriverConfig{..}
          = Core.object
              (Core.catMaybes
                 [("enableLegacyLustrePort" Core..=) Core.<$>
...
--
-- /See:/ 'newNetworkTierConfig' smart constructor.
newtype NetworkTierConfig = NetworkTierConfig
    {
      -- | Network tier configuration.
      networkTier :: (Core.Maybe NetworkTierConfig_NetworkTier)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'NetworkTierConfig' with the minimum fields required to make a request.
newNetworkTierConfig 
    ::  NetworkTierConfig
newNetworkTierConfig
  = NetworkTierConfig{networkTier = Core.Nothing}
instance Core.FromJSON NetworkTierConfig where
        parseJSON
          = Core.withObject "NetworkTierConfig"
              (\ o -> NetworkTierConfig Core.<$> (o Core..:? "networkTier"))

instance Core.ToJSON NetworkTierConfig where
        toJSON NetworkTierConfig{..}
          = Core.object
              (Core.catMaybes [("networkTier" Core..=) Core.<$> networkTier])
...
newNodeConfig
  = NodeConfig{accelerators = Core.Nothing,
               advancedMachineFeatures = Core.Nothing, bootDisk = Core.Nothing,
...
data NodeKubeletConfig = NodeKubeletConfig
    ...
    , cpuManagerPolicy :: (Core.Maybe Core.Text)
      -- | Optional. eviction/max/pod/grace/period_seconds is the maximum allowed grace period (in seconds) to use when terminating pods in response to a soft eviction threshold being met. This value effectively caps the Pod\'s terminationGracePeriodSeconds value during soft evictions. Default: 0. Range: [0, 300].
    , evictionMaxPodGracePeriodSeconds :: (Core.Maybe Core.Int32)
      -- | Optional. eviction/minimum/reclaim is a map of signal names to quantities that defines minimum reclaims, which describe the minimum amount of a given resource the kubelet will reclaim when performing a pod eviction while that resource is under pressure.
    , evictionMinimumReclaim :: (Core.Maybe EvictionMinimumReclaim)
    ...
    , evictionSoft :: (Core.Maybe EvictionSignals)
      -- | Optional. eviction/soft/grace_period is a map of signal names to quantities that defines grace periods for each soft eviction signal. The grace period is the amount of time that a pod must be under pressure before an eviction occurs.
    , evictionSoftGracePeriod :: (Core.Maybe EvictionGracePeriod)
    ...
    , maxParallelImagePulls :: (Core.Maybe Core.Int32)
    ...
    , singleProcessOomKill :: (Core.Maybe Core.Bool)
...
newNodeKubeletConfig
  = NodeKubeletConfig{allowedUnsafeSysctls = Core.Nothing,
                      ...
                      evictionMaxPodGracePeriodSeconds = Core.Nothing,
                      evictionMinimumReclaim = Core.Nothing, evictionSoft = Core.Nothing,
                      evictionSoftGracePeriod = Core.Nothing,
                      ...
                      insecureKubeletReadonlyPortEnabled = Core.Nothing,
                      maxParallelImagePulls = Core.Nothing, memoryManager = Core.Nothing,
                      podPidsLimit = Core.Nothing, singleProcessOomKill = Core.Nothing,
              ...
              (\ o ->
                 NodeKubeletConfig Core.<$>
                   (o Core..:? "allowedUnsafeSysctls") Core.<*>
                     ...
                     Core.<*> (o Core..:? "evictionMaxPodGracePeriodSeconds")
                     Core.<*> (o Core..:? "evictionMinimumReclaim")
                     Core.<*> (o Core..:? "evictionSoft")
                     Core.<*> (o Core..:? "evictionSoftGracePeriod")
          ...
          = Core.object
              (Core.catMaybes
                 [("allowedUnsafeSysctls" Core..=) Core.<$> allowedUnsafeSysctls,
                  ...
                  ("evictionMaxPodGracePeriodSeconds" Core..=) Core.<$>
                    evictionMaxPodGracePeriodSeconds,
                  ("evictionMinimumReclaim" Core..=) Core.<$> evictionMinimumReclaim,
                  ("evictionSoft" Core..=) Core.<$> evictionSoft,
                  ("evictionSoftGracePeriod" Core..=) Core.<$>
                  ...
                  ("insecureKubeletReadonlyPortEnabled" Core..=) Core.<$>
                    insecureKubeletReadonlyPortEnabled,
                  ("maxParallelImagePulls" Core..=) Core.<$> maxParallelImagePulls,
                  ("memoryManager" Core..=) Core.<$> memoryManager,
                  ("podPidsLimit" Core..=) Core.. Core.AsText Core.<$> podPidsLimit,
                  ("singleProcessOomKill" Core..=) Core.<$> singleProcessOomKill,
...
newNodeNetworkConfig
  = NodeNetworkConfig{additionalNodeNetworkConfigs = Core.Nothing,
                      ...
                      networkPerformanceConfig = Core.Nothing,
                      networkTierConfig = Core.Nothing,
                      podCidrOverprovisionConfig = Core.Nothing,
...
--
-- /See:/ 'newPrivilegedAdmissionConfig' smart constructor.
newtype PrivilegedAdmissionConfig = PrivilegedAdmissionConfig
    {
      ...
      allowlistPaths :: (Core.Maybe [Core.Text])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'PrivilegedAdmissionConfig' with the minimum fields required to make a request.
newPrivilegedAdmissionConfig 
    ::  PrivilegedAdmissionConfig
newPrivilegedAdmissionConfig
  = PrivilegedAdmissionConfig{allowlistPaths = Core.Nothing}
instance Core.FromJSON PrivilegedAdmissionConfig where
        parseJSON
          = Core.withObject "PrivilegedAdmissionConfig"
              (\ o ->
                 PrivilegedAdmissionConfig Core.<$> (o Core..:? "allowlistPaths"))

instance Core.ToJSON PrivilegedAdmissionConfig where
        toJSON PrivilegedAdmissionConfig{..}
          = Core.object
              (Core.catMaybes
                 [("allowlistPaths" Core..=) Core.<$> allowlistPaths])
...
-- | Collection of <https://%7B$universe.dns_names.final_documentation_domain%7D/resource-manager/docs/creating-managing-labels Resource Manager labels>.
--
...
--
-- /See:/ 'newRotationConfig' smart constructor.
data RotationConfig = RotationConfig
    {
      -- | Whether the rotation is enabled.
      enabled :: (Core.Maybe Core.Bool)
      -- | The interval between two consecutive rotations. Default rotation interval is 2 minutes.
    , rotationInterval :: (Core.Maybe Core.Duration)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'RotationConfig' with the minimum fields required to make a request.
newRotationConfig 
    ::  RotationConfig
newRotationConfig
  = RotationConfig{enabled = Core.Nothing,
                   rotationInterval = Core.Nothing}
instance Core.FromJSON RotationConfig where
        parseJSON
          = Core.withObject "RotationConfig"
              (\ o ->
                 RotationConfig Core.<$>
                   (o Core..:? "enabled") Core.<*> (o Core..:? "rotationInterval"))

instance Core.ToJSON RotationConfig where
        toJSON RotationConfig{..}
          = Core.object
              (Core.catMaybes
                 [("enabled" Core..=) Core.<$> enabled,
                  ("rotationInterval" Core..=) Core.<$> rotationInterval])
...
data SecretManagerConfig = SecretManagerConfig
    {
      -- | Enable\/Disable Secret Manager Config.
      enabled :: (Core.Maybe Core.Bool)
      -- | Rotation config for secret manager.
    , rotationConfig :: (Core.Maybe RotationConfig)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newSecretManagerConfig
  = SecretManagerConfig{enabled = Core.Nothing,
                        rotationConfig = Core.Nothing}
instance Core.FromJSON SecretManagerConfig where
        parseJSON
          = Core.withObject "SecretManagerConfig"
              (\ o ->
                 SecretManagerConfig Core.<$>
                   (o Core..:? "enabled") Core.<*> (o Core..:? "rotationConfig"))
...
instance Core.ToJSON SecretManagerConfig where
        toJSON SecretManagerConfig{..}
          = Core.object
              (Core.catMaybes
                 [("enabled" Core..=) Core.<$> enabled,
                  ("rotationConfig" Core..=) Core.<$> rotationConfig])
...
data SoleTenantConfig = SoleTenantConfig
    {
...
newSoleTenantConfig 
    ::  SoleTenantConfig
newSoleTenantConfig
  = SoleTenantConfig{minNodeCpus = Core.Nothing,
                     nodeAffinities = Core.Nothing}
instance Core.FromJSON SoleTenantConfig where
        parseJSON
          = Core.withObject "SoleTenantConfig"
              (\ o ->
                 SoleTenantConfig Core.<$>
                   (o Core..:? "minNodeCpus") Core.<*> (o Core..:? "nodeAffinities"))
...
newUpdateNodePoolRequest
  = UpdateNodePoolRequest{accelerators = Core.Nothing,
                          bootDisk = Core.Nothing, clusterId = Core.Nothing,
                          confidentialNodes = Core.Nothing, containerdConfig = Core.Nothing,
                          diskSizeGb = Core.Nothing, diskType = Core.Nothing,
                          etag = Core.Nothing, fastSocket = Core.Nothing,
                          flexStart = Core.Nothing, gcfsConfig = Core.Nothing,
                          gvnic = Core.Nothing, imageType = Core.Nothing,
                          kubeletConfig = Core.Nothing, labels = Core.Nothing,
                          linuxNodeConfig = Core.Nothing, locations = Core.Nothing,
                          loggingConfig = Core.Nothing, machineType = Core.Nothing,
                          maxRunDuration = Core.Nothing, name = Core.Nothing,
                          nodeNetworkConfig = Core.Nothing, nodePoolId = Core.Nothing,
                          nodeVersion = Core.Nothing, projectId = Core.Nothing,
                          queuedProvisioning = Core.Nothing, resourceLabels = Core.Nothing,
                          resourceManagerTags = Core.Nothing, storagePools = Core.Nothing,
                          tags = Core.Nothing, taints = Core.Nothing,
                          upgradeSettings = Core.Nothing, windowsNodeConfig = Core.Nothing,
          ...
          = Core.withObject "UpdateNodePoolRequest"
              (\ o ->
                 UpdateNodePoolRequest Core.<$>
                   (o Core..:? "accelerators") Core.<*> (o Core..:? "bootDisk")
