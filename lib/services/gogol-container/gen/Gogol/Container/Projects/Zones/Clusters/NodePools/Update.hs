                               ...
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.ReqBody '[Core.JSON] UpdateNodePoolRequest Core.:>
...
newContainerProjectsZonesClustersNodePoolsUpdate 
    ...
    -> ContainerProjectsZonesClustersNodePoolsUpdate
newContainerProjectsZonesClustersNodePoolsUpdate clusterId
  nodePoolId payload projectId zone
  = ContainerProjectsZonesClustersNodePoolsUpdate{xgafv =
                                                    Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes ContainerProjectsZonesClustersNodePoolsUpdate =
