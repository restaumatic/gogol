...
newContainerProjectsZonesOperationsGet operationId projectId zone
  = ContainerProjectsZonesOperationsGet{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        name = Core.Nothing, operationId = operationId,
                                        projectId = projectId, uploadType = Core.Nothing,
                                        uploadProtocol = Core.Nothing, zone = zone}
instance Core.GoogleRequest ContainerProjectsZonesOperationsGet
         where
        ...
        requestClient ContainerProjectsZonesOperationsGet{..}
          = go projectId zone operationId xgafv accessToken callback name
              uploadType
              uploadProtocol
