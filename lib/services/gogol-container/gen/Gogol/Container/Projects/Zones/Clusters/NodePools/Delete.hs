...
newContainerProjectsZonesClustersNodePoolsDelete 
    ...
    -> ContainerProjectsZonesClustersNodePoolsDelete
newContainerProjectsZonesClustersNodePoolsDelete clusterId
  nodePoolId projectId zone
  = ContainerProjectsZonesClustersNodePoolsDelete{xgafv =
                                                    Core.Nothing,
                                                  accessToken = Core.Nothing,
                                                  callback = Core.Nothing, clusterId = clusterId,
                                                  name = Core.Nothing, nodePoolId = nodePoolId,
                                                  projectId = projectId, uploadType = Core.Nothing,
                                                  uploadProtocol = Core.Nothing, zone = zone}
instance Core.GoogleRequest
           ContainerProjectsZonesClustersNodePoolsDelete
         where
        type Rs ContainerProjectsZonesClustersNodePoolsDelete = Operation
        type Scopes ContainerProjectsZonesClustersNodePoolsDelete =
             '[CloudPlatform'FullControl]
        requestClient ContainerProjectsZonesClustersNodePoolsDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ContainerProjectsZonesClustersNodePoolsDeleteResource)
                      Core.mempty
