                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Get '[Core.JSON] ListUsableSubnetworksResponse
...
newContainerProjectsAggregatedUsableSubnetworksList parent
  = ContainerProjectsAggregatedUsableSubnetworksList{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           ContainerProjectsAggregatedUsableSubnetworksList
         where
        type Rs ContainerProjectsAggregatedUsableSubnetworksList =
             ListUsableSubnetworksResponse
        type Scopes ContainerProjectsAggregatedUsableSubnetworksList =
