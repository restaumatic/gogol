...
--
-- /See:/ <https://cloud.google.com/kubernetes-engine/docs/ Kubernetes Engine API Reference> for @container.projects.locations.clusters.setAddons@.
module Gogol.Container.Projects.Locations.Clusters.SetAddons
    (
    -- * Resource
...
newContainerProjectsLocationsClustersSetAddons name payload
  = ContainerProjectsLocationsClustersSetAddons{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           ContainerProjectsLocationsClustersSetAddons
         where
        type Rs ContainerProjectsLocationsClustersSetAddons = Operation
        type Scopes ContainerProjectsLocationsClustersSetAddons =
             '[CloudPlatform'FullControl]
        requestClient ContainerProjectsLocationsClustersSetAddons{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ContainerProjectsLocationsClustersSetAddonsResource)
                      Core.mempty
