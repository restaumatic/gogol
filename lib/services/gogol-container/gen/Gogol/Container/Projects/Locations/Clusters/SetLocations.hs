...
type ContainerProjectsLocationsClustersSetLocationsResource =
     "v1" Core.:>
       Core.CaptureMode "name" "setLocations" Core.Text Core.:>
...
newContainerProjectsLocationsClustersSetLocations name payload
  = ContainerProjectsLocationsClustersSetLocations{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes ContainerProjectsLocationsClustersSetLocations =
