...
type ContainerProjectsLocationsClustersCompleteIpRotationResource =
     "v1" Core.:>
       Core.CaptureMode "name" "completeIpRotation" Core.Text Core.:>
...
newContainerProjectsLocationsClustersCompleteIpRotation name
  payload
  = ContainerProjectsLocationsClustersCompleteIpRotation{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           ContainerProjectsLocationsClustersCompleteIpRotation
         where
        type Rs ContainerProjectsLocationsClustersCompleteIpRotation =
             Operation
        type Scopes ContainerProjectsLocationsClustersCompleteIpRotation =
