...
newContainerProjectsLocationsClustersNodePoolsCreate parent payload
  = ContainerProjectsLocationsClustersNodePoolsCreate{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           ContainerProjectsLocationsClustersNodePoolsCreate
         where
        type Rs ContainerProjectsLocationsClustersNodePoolsCreate =
             Operation
        type Scopes ContainerProjectsLocationsClustersNodePoolsCreate =
