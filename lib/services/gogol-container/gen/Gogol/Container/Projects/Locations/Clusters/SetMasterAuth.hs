...
--
-- /See:/ <https://cloud.google.com/kubernetes-engine/docs/ Kubernetes Engine API Reference> for @container.projects.locations.clusters.setMasterAuth@.
module Gogol.Container.Projects.Locations.Clusters.SetMasterAuth
    (
    -- * Resource
...
type ContainerProjectsLocationsClustersSetMasterAuthResource =
     "v1" Core.:>
       Core.CaptureMode "name" "setMasterAuth" Core.Text Core.:>
...
newContainerProjectsLocationsClustersSetMasterAuth name payload
  = ContainerProjectsLocationsClustersSetMasterAuth{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           ContainerProjectsLocationsClustersSetMasterAuth
         where
        type Rs ContainerProjectsLocationsClustersSetMasterAuth = Operation
        type Scopes ContainerProjectsLocationsClustersSetMasterAuth =
             '[CloudPlatform'FullControl]
        requestClient ContainerProjectsLocationsClustersSetMasterAuth{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ContainerProjectsLocationsClustersSetMasterAuthResource)
                      Core.mempty
