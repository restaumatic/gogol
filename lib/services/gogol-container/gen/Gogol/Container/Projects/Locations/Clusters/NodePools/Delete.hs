...
--
-- /See:/ <https://cloud.google.com/kubernetes-engine/docs/ Kubernetes Engine API Reference> for @container.projects.locations.clusters.nodePools.delete@.
module Gogol.Container.Projects.Locations.Clusters.NodePools.Delete
    (
    -- * Resource
...
newContainerProjectsLocationsClustersNodePoolsDelete name
  = ContainerProjectsLocationsClustersNodePoolsDelete{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           ContainerProjectsLocationsClustersNodePoolsDelete
         where
        type Rs ContainerProjectsLocationsClustersNodePoolsDelete =
             Operation
        type Scopes ContainerProjectsLocationsClustersNodePoolsDelete =
             '[CloudPlatform'FullControl]
        requestClient ContainerProjectsLocationsClustersNodePoolsDelete{..}
