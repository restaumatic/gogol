...
type ContainerProjectsLocationsClustersSetLegacyAbacResource =
     "v1" Core.:>
       Core.CaptureMode "name" "setLegacyAbac" Core.Text Core.:>
...
newContainerProjectsLocationsClustersSetLegacyAbac name payload
  = ContainerProjectsLocationsClustersSetLegacyAbac{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes ContainerProjectsLocationsClustersSetLegacyAbac =
