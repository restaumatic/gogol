...
newContainerProjectsLocationsOperationsGet name
  = ContainerProjectsLocationsOperationsGet{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            name = name, operationId = Core.Nothing,
                                            projectId = Core.Nothing, uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing, zone = Core.Nothing}
instance Core.GoogleRequest ContainerProjectsLocationsOperationsGet
         where
        ...
        requestClient ContainerProjectsLocationsOperationsGet{..}
          = go name xgafv accessToken callback operationId projectId
              uploadType
              uploadProtocol
              zone
