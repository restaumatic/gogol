...
--
-- /See:/ <https://cloud.google.com/kubernetes-engine/docs/ Kubernetes Engine API Reference> for @container.projects.locations.clusters.setNetworkPolicy@.
module Gogol.Container.Projects.Locations.Clusters.SetNetworkPolicy
    (
    -- * Resource
...
type ContainerProjectsLocationsClustersSetNetworkPolicyResource =
     "v1" Core.:>
       Core.CaptureMode "name" "setNetworkPolicy" Core.Text Core.:>
...
newContainerProjectsLocationsClustersSetNetworkPolicy name payload
  = ContainerProjectsLocationsClustersSetNetworkPolicy{xgafv =
                                                         Core.Nothing,
...
instance Core.GoogleRequest
           ContainerProjectsLocationsClustersSetNetworkPolicy
         where
        type Rs ContainerProjectsLocationsClustersSetNetworkPolicy =
             Operation
        type Scopes ContainerProjectsLocationsClustersSetNetworkPolicy =
