...
newContainerProjectsLocationsClustersNodePoolsUpdate name payload
  = ContainerProjectsLocationsClustersNodePoolsUpdate{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           ContainerProjectsLocationsClustersNodePoolsUpdate
         where
        type Rs ContainerProjectsLocationsClustersNodePoolsUpdate =
             Operation
        type Scopes ContainerProjectsLocationsClustersNodePoolsUpdate =
