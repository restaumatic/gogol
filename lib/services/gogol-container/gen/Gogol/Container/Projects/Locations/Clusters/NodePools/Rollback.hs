...
newContainerProjectsLocationsClustersNodePoolsRollback name payload
  = ContainerProjectsLocationsClustersNodePoolsRollback{xgafv =
                                                          Core.Nothing,
...
instance Core.GoogleRequest
           ContainerProjectsLocationsClustersNodePoolsRollback
         where
        type Rs ContainerProjectsLocationsClustersNodePoolsRollback =
             Operation
        type Scopes ContainerProjectsLocationsClustersNodePoolsRollback =
