...
newContainerProjectsLocationsClustersNodePoolsSetSize name payload
  = ContainerProjectsLocationsClustersNodePoolsSetSize{xgafv =
                                                         Core.Nothing,
...
instance Core.GoogleRequest
           ContainerProjectsLocationsClustersNodePoolsSetSize
         where
        type Rs ContainerProjectsLocationsClustersNodePoolsSetSize =
             Operation
        type Scopes ContainerProjectsLocationsClustersNodePoolsSetSize =
