...
--
-- /See:/ <https://cloud.google.com/kubernetes-engine/docs/ Kubernetes Engine API Reference> for @container.projects.locations.clusters.setLogging@.
module Gogol.Container.Projects.Locations.Clusters.SetLogging
    (
    -- * Resource
...
type ContainerProjectsLocationsClustersSetLoggingResource =
     "v1" Core.:>
       Core.CaptureMode "name" "setLogging" Core.Text Core.:>
...
newContainerProjectsLocationsClustersSetLogging name payload
  = ContainerProjectsLocationsClustersSetLogging{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
           ContainerProjectsLocationsClustersSetLogging
         where
        type Rs ContainerProjectsLocationsClustersSetLogging = Operation
        type Scopes ContainerProjectsLocationsClustersSetLogging =
             '[CloudPlatform'FullControl]
        requestClient ContainerProjectsLocationsClustersSetLogging{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ContainerProjectsLocationsClustersSetLoggingResource)
                      Core.mempty
