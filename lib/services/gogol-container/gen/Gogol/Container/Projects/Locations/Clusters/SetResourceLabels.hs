...
type ContainerProjectsLocationsClustersSetResourceLabelsResource =
     "v1" Core.:>
       Core.CaptureMode "name" "setResourceLabels" Core.Text Core.:>
...
newContainerProjectsLocationsClustersSetResourceLabels name payload
  = ContainerProjectsLocationsClustersSetResourceLabels{xgafv =
                                                          Core.Nothing,
...
instance Core.GoogleRequest
           ContainerProjectsLocationsClustersSetResourceLabels
         where
        type Rs ContainerProjectsLocationsClustersSetResourceLabels =
             Operation
        type Scopes ContainerProjectsLocationsClustersSetResourceLabels =
