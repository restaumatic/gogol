...
type ContainerProjectsLocationsClustersCheckAutopilotCompatibilityResource
     =
     "v1" Core.:>
       Core.CaptureMode "name" "checkAutopilotCompatibility" Core.Text
         Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.Get '[Core.JSON] CheckAutopilotCompatibilityResponse
...
newContainerProjectsLocationsClustersCheckAutopilotCompatibility
  name
  = ContainerProjectsLocationsClustersCheckAutopilotCompatibility{xgafv
                                                                    = Core.Nothing,
