...
--
-- /See:/ <https://cloud.google.com/kubernetes-engine/docs/ Kubernetes Engine API Reference> for @container.projects.locations.clusters.startIpRotation@.
module Gogol.Container.Projects.Locations.Clusters.StartIpRotation
    (
    -- * Resource
...
type ContainerProjectsLocationsClustersStartIpRotationResource =
     "v1" Core.:>
       Core.CaptureMode "name" "startIpRotation" Core.Text Core.:>
...
newContainerProjectsLocationsClustersStartIpRotation name payload
  = ContainerProjectsLocationsClustersStartIpRotation{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           ContainerProjectsLocationsClustersStartIpRotation
         where
        type Rs ContainerProjectsLocationsClustersStartIpRotation =
             Operation
        type Scopes ContainerProjectsLocationsClustersStartIpRotation =
             '[CloudPlatform'FullControl]
        requestClient ContainerProjectsLocationsClustersStartIpRotation{..}
