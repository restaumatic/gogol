...
type ContainerProjectsLocationsClustersUpdateMasterResource =
     "v1" Core.:>
       Core.CaptureMode "name" "updateMaster" Core.Text Core.:>
...
newContainerProjectsLocationsClustersUpdateMaster name payload
  = ContainerProjectsLocationsClustersUpdateMaster{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes ContainerProjectsLocationsClustersUpdateMaster =
