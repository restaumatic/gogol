...
newContainerProjectsLocationsOperationsCancel name payload
  = ContainerProjectsLocationsOperationsCancel{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           ContainerProjectsLocationsOperationsCancel
         where
        type Rs ContainerProjectsLocationsOperationsCancel = Empty
        type Scopes ContainerProjectsLocationsOperationsCancel =
             '[CloudPlatform'FullControl]
        requestClient ContainerProjectsLocationsOperationsCancel{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ContainerProjectsLocationsOperationsCancelResource)
                      Core.mempty
