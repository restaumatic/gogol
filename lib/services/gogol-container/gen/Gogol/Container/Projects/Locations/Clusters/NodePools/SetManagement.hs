...
type ContainerProjectsLocationsClustersNodePoolsSetManagementResource
     =
     "v1" Core.:>
       Core.CaptureMode "name" "setManagement" Core.Text Core.:>
...
newContainerProjectsLocationsClustersNodePoolsSetManagement 
    ...
    -> ContainerProjectsLocationsClustersNodePoolsSetManagement
newContainerProjectsLocationsClustersNodePoolsSetManagement name
  payload
  = ContainerProjectsLocationsClustersNodePoolsSetManagement{xgafv =
                                                               Core.Nothing,
...
instance Core.GoogleRequest
           ContainerProjectsLocationsClustersNodePoolsSetManagement
         where
        type Rs ContainerProjectsLocationsClustersNodePoolsSetManagement =
             Operation
        type Scopes
               ContainerProjectsLocationsClustersNodePoolsSetManagement
