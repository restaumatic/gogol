...
type ContainerProjectsLocationsClustersNodePoolsSetAutoscalingResource
     =
     "v1" Core.:>
       Core.CaptureMode "name" "setAutoscaling" Core.Text Core.:>
...
newContainerProjectsLocationsClustersNodePoolsSetAutoscaling 
    ...
    -> ContainerProjectsLocationsClustersNodePoolsSetAutoscaling
newContainerProjectsLocationsClustersNodePoolsSetAutoscaling name
  payload
  = ContainerProjectsLocationsClustersNodePoolsSetAutoscaling{xgafv =
                                                                Core.Nothing,
...
instance Core.GoogleRequest
           ContainerProjectsLocationsClustersNodePoolsSetAutoscaling
         where
        type Rs ContainerProjectsLocationsClustersNodePoolsSetAutoscaling =
             Operation
        type Scopes
               ContainerProjectsLocationsClustersNodePoolsSetAutoscaling
