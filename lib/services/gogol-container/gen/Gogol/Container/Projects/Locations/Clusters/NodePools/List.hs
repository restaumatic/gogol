...
--
-- /See:/ <https://cloud.google.com/kubernetes-engine/docs/ Kubernetes Engine API Reference> for @container.projects.locations.clusters.nodePools.list@.
module Gogol.Container.Projects.Locations.Clusters.NodePools.List
    (
    -- * Resource
...
newContainerProjectsLocationsClustersNodePoolsList parent
  = ContainerProjectsLocationsClustersNodePoolsList{xgafv =
                                                      Core.Nothing,
                                                    accessToken = Core.Nothing,
                                                    callback = Core.Nothing,
                                                    clusterId = Core.Nothing, parent = parent,
...
instance Core.GoogleRequest
           ContainerProjectsLocationsClustersNodePoolsList
         where
        type Rs ContainerProjectsLocationsClustersNodePoolsList =
             ListNodePoolsResponse
        type Scopes ContainerProjectsLocationsClustersNodePoolsList =
             '[CloudPlatform'FullControl]
        requestClient ContainerProjectsLocationsClustersNodePoolsList{..}
          = go parent xgafv accessToken callback clusterId projectId
              uploadType
              uploadProtocol
              zone
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ContainerProjectsLocationsClustersNodePoolsListResource)
                      Core.mempty
