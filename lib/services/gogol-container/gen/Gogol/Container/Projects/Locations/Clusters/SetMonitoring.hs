...
type ContainerProjectsLocationsClustersSetMonitoringResource =
     "v1" Core.:>
       Core.CaptureMode "name" "setMonitoring" Core.Text Core.:>
...
newContainerProjectsLocationsClustersSetMonitoring name payload
  = ContainerProjectsLocationsClustersSetMonitoring{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes ContainerProjectsLocationsClustersSetMonitoring =
