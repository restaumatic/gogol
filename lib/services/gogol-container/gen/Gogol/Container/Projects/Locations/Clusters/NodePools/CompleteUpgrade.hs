...
type ContainerProjectsLocationsClustersNodePoolsCompleteUpgradeResource
     =
     "v1" Core.:>
       Core.CaptureMode "name" "completeUpgrade" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] CompleteNodePoolUpgradeRequest Core.:>
...
newContainerProjectsLocationsClustersNodePoolsCompleteUpgrade 
    ...
    -> ContainerProjectsLocationsClustersNodePoolsCompleteUpgrade
newContainerProjectsLocationsClustersNodePoolsCompleteUpgrade name
  payload
  = ContainerProjectsLocationsClustersNodePoolsCompleteUpgrade{xgafv
                                                                 = Core.Nothing,
...
instance Core.GoogleRequest
           ContainerProjectsLocationsClustersNodePoolsCompleteUpgrade
         where
        type Rs ContainerProjectsLocationsClustersNodePoolsCompleteUpgrade
             = Empty
        type Scopes
               ContainerProjectsLocationsClustersNodePoolsCompleteUpgrade
