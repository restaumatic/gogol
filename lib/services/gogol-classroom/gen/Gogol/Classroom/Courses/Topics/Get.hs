...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.topics.get@.
module Gogol.Classroom.Courses.Topics.Get
    (
    -- * Resource
...
newClassroomCoursesTopicsGet courseId id
  = ClassroomCoursesTopicsGet{xgafv = Core.Nothing,
