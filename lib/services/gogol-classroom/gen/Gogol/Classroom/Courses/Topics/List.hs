...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.topics.list@.
module Gogol.Classroom.Courses.Topics.List
    (
    -- * Resource
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] ListTopicResponse
...
newClassroomCoursesTopicsList courseId
  = ClassroomCoursesTopicsList{xgafv = Core.Nothing,
                               accessToken = Core.Nothing, callback = Core.Nothing,
                               courseId = courseId, pageSize = Core.Nothing,
                               pageToken = Core.Nothing, uploadType = Core.Nothing,
                               uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ClassroomCoursesTopicsList where
        type Rs ClassroomCoursesTopicsList = ListTopicResponse
        type Scopes ClassroomCoursesTopicsList =
        ...
        requestClient ClassroomCoursesTopicsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ClassroomCoursesTopicsListResource)
                      Core.mempty
