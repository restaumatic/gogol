...
-- |
-- Module      : Gogol.Classroom.Courses.Topics.Delete
...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.topics.delete@.
module Gogol.Classroom.Courses.Topics.Delete
    (
    -- * Resource
...
newClassroomCoursesTopicsDelete courseId id
  = ClassroomCoursesTopicsDelete{xgafv = Core.Nothing,
                                 accessToken = Core.Nothing, callback = Core.Nothing,
                                 courseId = courseId, id = id, uploadType = Core.Nothing,
                                 uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ClassroomCoursesTopicsDelete where
        type Rs ClassroomCoursesTopicsDelete = Empty
        type Scopes ClassroomCoursesTopicsDelete = '[Classroom'Topics]
        requestClient ClassroomCoursesTopicsDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ClassroomCoursesTopicsDeleteResource)
                      Core.mempty
