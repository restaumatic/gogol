...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.topics.create@.
module Gogol.Classroom.Courses.Topics.Create
    (
    -- * Resource
...
newClassroomCoursesTopicsCreate courseId payload
  = ClassroomCoursesTopicsCreate{xgafv = Core.Nothing,
                                 accessToken = Core.Nothing, callback = Core.Nothing,
                                 courseId = courseId, payload = payload, uploadType = Core.Nothing,
