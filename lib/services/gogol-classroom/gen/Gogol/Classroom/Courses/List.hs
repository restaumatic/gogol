...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.list@.
module Gogol.Classroom.Courses.List
    (
    -- * Resource
         ...
         Core.QueryParam "$.xgafv" Xgafv Core.:>
           Core.QueryParam "access_token" Core.Text Core.:>
             Core.QueryParam "callback" Core.Text Core.:>
               Core.QueryParams "courseStates" CoursesListCourseStates Core.:>
                 Core.QueryParam "pageSize" Core.Int32 Core.:>
                   Core.QueryParam "pageToken" Core.Text Core.:>
                     Core.QueryParam "studentId" Core.Text Core.:>
                       Core.QueryParam "teacherId" Core.Text Core.:>
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Get '[Core.JSON] ListCoursesResponse
...
newClassroomCoursesList 
    ::  ClassroomCoursesList
newClassroomCoursesList
  = ClassroomCoursesList{xgafv = Core.Nothing,
                         accessToken = Core.Nothing, callback = Core.Nothing,
                         courseStates = Core.Nothing, pageSize = Core.Nothing,
                         pageToken = Core.Nothing, studentId = Core.Nothing,
                         teacherId = Core.Nothing, uploadType = Core.Nothing,
                         uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ClassroomCoursesList where
        type Rs ClassroomCoursesList = ListCoursesResponse
        type Scopes ClassroomCoursesList =
