...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.announcements.addOnAttachments.list@.
module Gogol.Classroom.Courses.Announcements.AddOnAttachments.List
    (
    -- * Resource
...
newClassroomCoursesAnnouncementsAddOnAttachmentsList 
    ...
    -> ClassroomCoursesAnnouncementsAddOnAttachmentsList
newClassroomCoursesAnnouncementsAddOnAttachmentsList courseId
  itemId
  = ClassroomCoursesAnnouncementsAddOnAttachmentsList{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           ClassroomCoursesAnnouncementsAddOnAttachmentsList
         where
        type Rs ClassroomCoursesAnnouncementsAddOnAttachmentsList =
             ListAddOnAttachmentsResponse
        type Scopes ClassroomCoursesAnnouncementsAddOnAttachmentsList =
