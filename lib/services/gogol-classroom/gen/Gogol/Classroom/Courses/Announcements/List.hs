...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.announcements.list@.
module Gogol.Classroom.Courses.Announcements.List
    (
    -- * Resource
...
newClassroomCoursesAnnouncementsList courseId
  = ClassroomCoursesAnnouncementsList{xgafv = Core.Nothing,
                                      accessToken = Core.Nothing, announcementStates = Core.Nothing,
...
instance Core.GoogleRequest ClassroomCoursesAnnouncementsList where
