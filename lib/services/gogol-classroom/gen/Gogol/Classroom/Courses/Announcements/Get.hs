...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.announcements.get@.
module Gogol.Classroom.Courses.Announcements.Get
    (
    -- * Resource
                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] Announcement
...
newClassroomCoursesAnnouncementsGet courseId id
  = ClassroomCoursesAnnouncementsGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ClassroomCoursesAnnouncementsGet where
        ...
        type Scopes ClassroomCoursesAnnouncementsGet =
