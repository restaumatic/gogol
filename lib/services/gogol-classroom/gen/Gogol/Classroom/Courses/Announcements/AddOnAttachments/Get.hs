...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.announcements.addOnAttachments.get@.
module Gogol.Classroom.Courses.Announcements.AddOnAttachments.Get
    (
    -- * Resource
...
newClassroomCoursesAnnouncementsAddOnAttachmentsGet 
    ...
    -> ClassroomCoursesAnnouncementsAddOnAttachmentsGet
newClassroomCoursesAnnouncementsAddOnAttachmentsGet attachmentId
  courseId itemId
  = ClassroomCoursesAnnouncementsAddOnAttachmentsGet{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           ClassroomCoursesAnnouncementsAddOnAttachmentsGet
         where
        type Rs ClassroomCoursesAnnouncementsAddOnAttachmentsGet =
             AddOnAttachment
        type Scopes ClassroomCoursesAnnouncementsAddOnAttachmentsGet =
