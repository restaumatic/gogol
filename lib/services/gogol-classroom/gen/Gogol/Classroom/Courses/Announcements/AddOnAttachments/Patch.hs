...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.announcements.addOnAttachments.patch@.
module Gogol.Classroom.Courses.Announcements.AddOnAttachments.Patch
    (
    -- * Resource
...
newClassroomCoursesAnnouncementsAddOnAttachmentsPatch 
    ...
    -> ClassroomCoursesAnnouncementsAddOnAttachmentsPatch
newClassroomCoursesAnnouncementsAddOnAttachmentsPatch attachmentId
  courseId itemId payload
  = ClassroomCoursesAnnouncementsAddOnAttachmentsPatch{xgafv =
                                                         Core.Nothing,
...
instance Core.GoogleRequest
           ClassroomCoursesAnnouncementsAddOnAttachmentsPatch
         where
        type Rs ClassroomCoursesAnnouncementsAddOnAttachmentsPatch =
             AddOnAttachment
        type Scopes ClassroomCoursesAnnouncementsAddOnAttachmentsPatch =
