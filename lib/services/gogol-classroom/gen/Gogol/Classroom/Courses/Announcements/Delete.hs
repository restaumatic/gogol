...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.announcements.delete@.
module Gogol.Classroom.Courses.Announcements.Delete
    (
    -- * Resource
...
newClassroomCoursesAnnouncementsDelete courseId id
  = ClassroomCoursesAnnouncementsDelete{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        courseId = courseId, id = id, uploadType = Core.Nothing,
                                        uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ClassroomCoursesAnnouncementsDelete
         where
        type Rs ClassroomCoursesAnnouncementsDelete = Empty
        type Scopes ClassroomCoursesAnnouncementsDelete =
        ...
        requestClient ClassroomCoursesAnnouncementsDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ClassroomCoursesAnnouncementsDeleteResource)
                      Core.mempty
