...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.announcements.addOnAttachments.create@.
module Gogol.Classroom.Courses.Announcements.AddOnAttachments.Create
    (
    -- * Resource
...
newClassroomCoursesAnnouncementsAddOnAttachmentsCreate 
    ...
    -> ClassroomCoursesAnnouncementsAddOnAttachmentsCreate
newClassroomCoursesAnnouncementsAddOnAttachmentsCreate courseId
  itemId payload
  = ClassroomCoursesAnnouncementsAddOnAttachmentsCreate{xgafv =
                                                          Core.Nothing,
                                                        accessToken = Core.Nothing,
                                                        addOnToken = Core.Nothing,
                                                        callback = Core.Nothing,
                                                        courseId = courseId, itemId = itemId,
                                                        payload = payload, postId = Core.Nothing,
                                                        uploadType = Core.Nothing,
                                                        uploadProtocol = Core.Nothing}
instance Core.GoogleRequest
           ClassroomCoursesAnnouncementsAddOnAttachmentsCreate
         where
        type Rs ClassroomCoursesAnnouncementsAddOnAttachmentsCreate =
             AddOnAttachment
        type Scopes ClassroomCoursesAnnouncementsAddOnAttachmentsCreate =
