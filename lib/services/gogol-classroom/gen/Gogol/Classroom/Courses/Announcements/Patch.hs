...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.announcements.patch@.
module Gogol.Classroom.Courses.Announcements.Patch
    (
    -- * Resource
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] Announcement Core.:>
                               Core.Patch '[Core.JSON] Announcement
...
newClassroomCoursesAnnouncementsPatch courseId id payload
  = ClassroomCoursesAnnouncementsPatch{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       courseId = courseId, id = id, payload = payload,
                                       updateMask = Core.Nothing, uploadType = Core.Nothing,
                                       uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ClassroomCoursesAnnouncementsPatch
         where
        type Rs ClassroomCoursesAnnouncementsPatch = Announcement
        type Scopes ClassroomCoursesAnnouncementsPatch =
             '[Classroom'Announcements]
        requestClient ClassroomCoursesAnnouncementsPatch{..}
          = go courseId id xgafv accessToken callback updateMask uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ClassroomCoursesAnnouncementsPatchResource)
                      Core.mempty
