...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.announcements.getAddOnContext@.
module Gogol.Classroom.Courses.Announcements.GetAddOnContext
    (
    -- * Resource
...
newClassroomCoursesAnnouncementsGetAddOnContext courseId itemId
  = ClassroomCoursesAnnouncementsGetAddOnContext{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
        ...
        requestClient ClassroomCoursesAnnouncementsGetAddOnContext{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ClassroomCoursesAnnouncementsGetAddOnContextResource)
                      Core.mempty
