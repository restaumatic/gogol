...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.announcements.addOnAttachments.delete@.
module Gogol.Classroom.Courses.Announcements.AddOnAttachments.Delete
    (
    -- * Resource
...
newClassroomCoursesAnnouncementsAddOnAttachmentsDelete 
    ...
    -> ClassroomCoursesAnnouncementsAddOnAttachmentsDelete
newClassroomCoursesAnnouncementsAddOnAttachmentsDelete attachmentId
  courseId itemId
  = ClassroomCoursesAnnouncementsAddOnAttachmentsDelete{xgafv =
                                                          Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes ClassroomCoursesAnnouncementsAddOnAttachmentsDelete =
