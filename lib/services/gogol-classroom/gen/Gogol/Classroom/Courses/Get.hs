...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.get@.
module Gogol.Classroom.Courses.Get
    (
    -- * Resource
...
newClassroomCoursesGet id
  = ClassroomCoursesGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ClassroomCoursesGet where
        ...
        type Scopes ClassroomCoursesGet =
        ...
        requestClient ClassroomCoursesGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ClassroomCoursesGetResource)
                      Core.mempty
