...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.posts.addOnAttachments.get@.
module Gogol.Classroom.Courses.Posts.AddOnAttachments.Get
    (
    -- * Resource
...
newClassroomCoursesPostsAddOnAttachmentsGet 
    ...
    -> ClassroomCoursesPostsAddOnAttachmentsGet
newClassroomCoursesPostsAddOnAttachmentsGet attachmentId courseId
  postId
  = ClassroomCoursesPostsAddOnAttachmentsGet{xgafv = Core.Nothing,
