...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.posts.addOnAttachments.studentSubmissions.get@.
module Gogol.Classroom.Courses.Posts.AddOnAttachments.StudentSubmissions.Get
    (
    -- * Resource
                               ...
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.Get '[Core.JSON] AddOnAttachmentStudentSubmission
...
newClassroomCoursesPostsAddOnAttachmentsStudentSubmissionsGet
  ...
  = ClassroomCoursesPostsAddOnAttachmentsStudentSubmissionsGet{xgafv
                                                                 = Core.Nothing,
...
instance Core.GoogleRequest
           ClassroomCoursesPostsAddOnAttachmentsStudentSubmissionsGet
         where
        type Rs ClassroomCoursesPostsAddOnAttachmentsStudentSubmissionsGet
