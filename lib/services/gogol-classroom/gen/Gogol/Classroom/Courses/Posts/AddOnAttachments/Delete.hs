...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.posts.addOnAttachments.delete@.
module Gogol.Classroom.Courses.Posts.AddOnAttachments.Delete
    (
    -- * Resource
...
newClassroomCoursesPostsAddOnAttachmentsDelete 
    ...
    -> ClassroomCoursesPostsAddOnAttachmentsDelete
newClassroomCoursesPostsAddOnAttachmentsDelete attachmentId
  courseId postId
  = ClassroomCoursesPostsAddOnAttachmentsDelete{xgafv = Core.Nothing,
                                                accessToken = Core.Nothing,
                                                attachmentId = attachmentId,
                                                callback = Core.Nothing, courseId = courseId,
                                                itemId = Core.Nothing, postId = postId,
