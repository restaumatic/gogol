...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.posts.addOnAttachments.list@.
module Gogol.Classroom.Courses.Posts.AddOnAttachments.List
    (
    -- * Resource
...
newClassroomCoursesPostsAddOnAttachmentsList courseId postId
  = ClassroomCoursesPostsAddOnAttachmentsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           ClassroomCoursesPostsAddOnAttachmentsList
         where
        type Rs ClassroomCoursesPostsAddOnAttachmentsList =
        ...
        requestClient ClassroomCoursesPostsAddOnAttachmentsList{..}
          = go courseId postId xgafv accessToken callback itemId pageSize
              pageToken
              uploadType
              uploadProtocol
