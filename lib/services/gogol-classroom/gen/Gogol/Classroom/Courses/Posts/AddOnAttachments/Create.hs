...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.posts.addOnAttachments.create@.
module Gogol.Classroom.Courses.Posts.AddOnAttachments.Create
    (
    -- * Resource
...
newClassroomCoursesPostsAddOnAttachmentsCreate 
    ...
    -> ClassroomCoursesPostsAddOnAttachmentsCreate
newClassroomCoursesPostsAddOnAttachmentsCreate courseId payload
  postId
  = ClassroomCoursesPostsAddOnAttachmentsCreate{xgafv = Core.Nothing,
                                                accessToken = Core.Nothing,
                                                addOnToken = Core.Nothing, callback = Core.Nothing,
...
instance Core.GoogleRequest
           ClassroomCoursesPostsAddOnAttachmentsCreate
         where
        type Rs ClassroomCoursesPostsAddOnAttachmentsCreate =
             AddOnAttachment
        ...
        requestClient ClassroomCoursesPostsAddOnAttachmentsCreate{..}
          = go courseId postId xgafv accessToken addOnToken callback itemId
              uploadType
              uploadProtocol
