...
-- |
-- Module      : Gogol.Classroom.Courses.Posts.AddOnAttachments.StudentSubmissions.Patch
...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.posts.addOnAttachments.studentSubmissions.patch@.
module Gogol.Classroom.Courses.Posts.AddOnAttachments.StudentSubmissions.Patch
    (
    -- * Resource
...
-- | A resource alias for @classroom.courses.posts.addOnAttachments.studentSubmissions.patch@ method which the
-- 'ClassroomCoursesPostsAddOnAttachmentsStudentSubmissionsPatch' request conforms to.
type ClassroomCoursesPostsAddOnAttachmentsStudentSubmissionsPatchResource
     =
     "v1" Core.:>
       "courses" Core.:>
               ...
               "addOnAttachments" Core.:>
                 Core.Capture "attachmentId" Core.Text Core.:>
                   "studentSubmissions" Core.:>
                     Core.Capture "submissionId" Core.Text Core.:>
                                 ...
                                 Core.QueryParam "uploadType" Core.Text Core.:>
                                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                                     Core.QueryParam "alt" Core.AltJSON Core.:>
                                       Core.ReqBody '[Core.JSON] AddOnAttachmentStudentSubmission
                                         Core.:>
                                         Core.Patch '[Core.JSON] AddOnAttachmentStudentSubmission

-- | Updates data associated with an add-on attachment submission. Requires the add-on to have been the original creator of the attachment and the attachment to have a positive @max_points@ value set. This method returns the following error codes: * @PERMISSION_DENIED@ for access errors. * @INVALID_ARGUMENT@ if the request is malformed. * @NOT_FOUND@ if one of the identified resources does not exist.
--
-- /See:/ 'newClassroomCoursesPostsAddOnAttachmentsStudentSubmissionsPatch' smart constructor.
data ClassroomCoursesPostsAddOnAttachmentsStudentSubmissionsPatch = ClassroomCoursesPostsAddOnAttachmentsStudentSubmissionsPatch
    {
      -- | V1 error format.
...
-- | Creates a value of 'ClassroomCoursesPostsAddOnAttachmentsStudentSubmissionsPatch' with the minimum fields required to make a request.
newClassroomCoursesPostsAddOnAttachmentsStudentSubmissionsPatch 
    :: 
                                                                Core.Text
    ...
    -> ClassroomCoursesPostsAddOnAttachmentsStudentSubmissionsPatch
newClassroomCoursesPostsAddOnAttachmentsStudentSubmissionsPatch
  attachmentId courseId payload postId submissionId
  = ClassroomCoursesPostsAddOnAttachmentsStudentSubmissionsPatch{xgafv
                                                                   = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        requestClient
          ClassroomCoursesPostsAddOnAttachmentsStudentSubmissionsPatch{..}
          = go courseId postId attachmentId submissionId xgafv accessToken
              callback
              itemId
              updateMask
              uploadType
