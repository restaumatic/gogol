...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.posts.addOnAttachments.patch@.
module Gogol.Classroom.Courses.Posts.AddOnAttachments.Patch
    (
    -- * Resource
...
newClassroomCoursesPostsAddOnAttachmentsPatch 
    ...
    -> ClassroomCoursesPostsAddOnAttachmentsPatch
newClassroomCoursesPostsAddOnAttachmentsPatch attachmentId courseId
  payload postId
  = ClassroomCoursesPostsAddOnAttachmentsPatch{xgafv = Core.Nothing,
                                               accessToken = Core.Nothing,
                                               attachmentId = attachmentId, callback = Core.Nothing,
...
instance Core.GoogleRequest
           ClassroomCoursesPostsAddOnAttachmentsPatch
         where
        type Rs ClassroomCoursesPostsAddOnAttachmentsPatch =
             AddOnAttachment
