...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.courseWork.patch@.
module Gogol.Classroom.Courses.CourseWork.Patch
    (
    -- * Resource
...
newClassroomCoursesCourseWorkPatch courseId id payload
  = ClassroomCoursesCourseWorkPatch{xgafv = Core.Nothing,
                                    accessToken = Core.Nothing, callback = Core.Nothing,
                                    courseId = courseId, id = id, payload = payload,
                                    updateMask = Core.Nothing, uploadType = Core.Nothing,
                                    uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ClassroomCoursesCourseWorkPatch where
        ...
        requestClient ClassroomCoursesCourseWorkPatch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ClassroomCoursesCourseWorkPatchResource)
                      Core.mempty
