...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.courseWork.addOnAttachments.delete@.
module Gogol.Classroom.Courses.CourseWork.AddOnAttachments.Delete
    (
    -- * Resource
...
newClassroomCoursesCourseWorkAddOnAttachmentsDelete 
    ...
    -> ClassroomCoursesCourseWorkAddOnAttachmentsDelete
newClassroomCoursesCourseWorkAddOnAttachmentsDelete attachmentId
  courseId itemId
  = ClassroomCoursesCourseWorkAddOnAttachmentsDelete{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes ClassroomCoursesCourseWorkAddOnAttachmentsDelete =
