...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.courseWork.rubrics.delete@.
module Gogol.Classroom.Courses.CourseWork.Rubrics.Delete
    (
    -- * Resource
...
newClassroomCoursesCourseWorkRubricsDelete courseId courseWorkId id
  = ClassroomCoursesCourseWorkRubricsDelete{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            courseId = courseId, courseWorkId = courseWorkId,
                                            id = id, uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ClassroomCoursesCourseWorkRubricsDelete
         where
        type Rs ClassroomCoursesCourseWorkRubricsDelete = Empty
        type Scopes ClassroomCoursesCourseWorkRubricsDelete =
