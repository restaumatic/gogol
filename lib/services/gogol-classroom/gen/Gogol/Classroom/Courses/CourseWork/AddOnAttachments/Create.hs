...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.courseWork.addOnAttachments.create@.
module Gogol.Classroom.Courses.CourseWork.AddOnAttachments.Create
    (
    -- * Resource
...
newClassroomCoursesCourseWorkAddOnAttachmentsCreate 
    ...
    -> ClassroomCoursesCourseWorkAddOnAttachmentsCreate
newClassroomCoursesCourseWorkAddOnAttachmentsCreate courseId itemId
  payload
  = ClassroomCoursesCourseWorkAddOnAttachmentsCreate{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           ClassroomCoursesCourseWorkAddOnAttachmentsCreate
         where
        type Rs ClassroomCoursesCourseWorkAddOnAttachmentsCreate =
             AddOnAttachment
        type Scopes ClassroomCoursesCourseWorkAddOnAttachmentsCreate =
             '[Classroom'Addons'Teacher]
        requestClient ClassroomCoursesCourseWorkAddOnAttachmentsCreate{..}
          = go courseId itemId xgafv accessToken addOnToken callback postId
              uploadType
              uploadProtocol
