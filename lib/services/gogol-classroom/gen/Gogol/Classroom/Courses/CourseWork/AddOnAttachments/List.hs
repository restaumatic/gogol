...
-- |
-- Module      : Gogol.Classroom.Courses.CourseWork.AddOnAttachments.List
...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.courseWork.addOnAttachments.list@.
module Gogol.Classroom.Courses.CourseWork.AddOnAttachments.List
    (
    -- * Resource
...
-- | A resource alias for @classroom.courses.courseWork.addOnAttachments.list@ method which the
-- 'ClassroomCoursesCourseWorkAddOnAttachmentsList' request conforms to.
type ClassroomCoursesCourseWorkAddOnAttachmentsListResource =
     "v1" Core.:>
       "courses" Core.:>
                             ...
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.Get '[Core.JSON] ListAddOnAttachmentsResponse

-- | Returns all attachments created by an add-on under the post. Requires the add-on to have active attachments on the post or have permission to create new attachments on the post. This method returns the following error codes: * @PERMISSION_DENIED@ for access errors. * @INVALID_ARGUMENT@ if the request is malformed. * @NOT_FOUND@ if one of the identified resources does not exist.
--
-- /See:/ 'newClassroomCoursesCourseWorkAddOnAttachmentsList' smart constructor.
data ClassroomCoursesCourseWorkAddOnAttachmentsList = ClassroomCoursesCourseWorkAddOnAttachmentsList
    {
      -- | V1 error format.
...
-- | Creates a value of 'ClassroomCoursesCourseWorkAddOnAttachmentsList' with the minimum fields required to make a request.
newClassroomCoursesCourseWorkAddOnAttachmentsList 
    :: 
                                                  Core.Text
    ...
    -> ClassroomCoursesCourseWorkAddOnAttachmentsList
newClassroomCoursesCourseWorkAddOnAttachmentsList courseId itemId
  = ClassroomCoursesCourseWorkAddOnAttachmentsList{xgafv =
                                                     Core.Nothing,
                                                   accessToken = Core.Nothing,
                                                   callback = Core.Nothing, courseId = courseId,
                                                   itemId = itemId, pageSize = Core.Nothing,
                                                   pageToken = Core.Nothing, postId = Core.Nothing,
                                                   uploadType = Core.Nothing,
                                                   uploadProtocol = Core.Nothing}
instance Core.GoogleRequest
           ClassroomCoursesCourseWorkAddOnAttachmentsList
         where
        type Rs ClassroomCoursesCourseWorkAddOnAttachmentsList =
             ListAddOnAttachmentsResponse
        type Scopes ClassroomCoursesCourseWorkAddOnAttachmentsList =
             '[Classroom'Addons'Student, Classroom'Addons'Teacher]
        requestClient ClassroomCoursesCourseWorkAddOnAttachmentsList{..}
          = go courseId itemId xgafv accessToken callback pageSize pageToken
              postId
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ClassroomCoursesCourseWorkAddOnAttachmentsListResource)
                      Core.mempty
