...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.courseWork.getAddOnContext@.
module Gogol.Classroom.Courses.CourseWork.GetAddOnContext
    (
    -- * Resource
...
newClassroomCoursesCourseWorkGetAddOnContext courseId itemId
  = ClassroomCoursesCourseWorkGetAddOnContext{xgafv = Core.Nothing,
                                              ...
                                              postId = Core.Nothing, uploadType = Core.Nothing,
