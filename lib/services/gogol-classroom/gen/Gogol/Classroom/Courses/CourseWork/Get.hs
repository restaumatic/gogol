...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.courseWork.get@.
module Gogol.Classroom.Courses.CourseWork.Get
    (
    -- * Resource
...
newClassroomCoursesCourseWorkGet courseId id
  = ClassroomCoursesCourseWorkGet{xgafv = Core.Nothing,
