...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.courseWork.updateRubric@.
module Gogol.Classroom.Courses.CourseWork.UpdateRubric
    (
    -- * Resource
...
newClassroomCoursesCourseWorkUpdateRubric 
    ...
    -> ClassroomCoursesCourseWorkUpdateRubric
newClassroomCoursesCourseWorkUpdateRubric courseId courseWorkId
  payload
  = ClassroomCoursesCourseWorkUpdateRubric{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           courseId = courseId, courseWorkId = courseWorkId,
                                           id = Core.Nothing, payload = payload,
                                           updateMask = Core.Nothing, uploadType = Core.Nothing,
                                           uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ClassroomCoursesCourseWorkUpdateRubric
         where
        type Rs ClassroomCoursesCourseWorkUpdateRubric = Rubric
        type Scopes ClassroomCoursesCourseWorkUpdateRubric =
             '[Classroom'Coursework'Students]
        requestClient ClassroomCoursesCourseWorkUpdateRubric{..}
          = go courseId courseWorkId xgafv accessToken callback id updateMask
              uploadType
              uploadProtocol
