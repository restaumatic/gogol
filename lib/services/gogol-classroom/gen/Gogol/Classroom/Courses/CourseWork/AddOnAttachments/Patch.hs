...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.courseWork.addOnAttachments.patch@.
module Gogol.Classroom.Courses.CourseWork.AddOnAttachments.Patch
    (
    -- * Resource
...
newClassroomCoursesCourseWorkAddOnAttachmentsPatch 
    ...
    -> ClassroomCoursesCourseWorkAddOnAttachmentsPatch
newClassroomCoursesCourseWorkAddOnAttachmentsPatch attachmentId
  courseId itemId payload
  = ClassroomCoursesCourseWorkAddOnAttachmentsPatch{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           ClassroomCoursesCourseWorkAddOnAttachmentsPatch
         where
        type Rs ClassroomCoursesCourseWorkAddOnAttachmentsPatch =
             AddOnAttachment
        ...
        requestClient ClassroomCoursesCourseWorkAddOnAttachmentsPatch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ClassroomCoursesCourseWorkAddOnAttachmentsPatchResource)
                      Core.mempty
