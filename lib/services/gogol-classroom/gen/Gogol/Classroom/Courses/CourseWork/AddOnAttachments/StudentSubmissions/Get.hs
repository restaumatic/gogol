...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.courseWork.addOnAttachments.studentSubmissions.get@.
module Gogol.Classroom.Courses.CourseWork.AddOnAttachments.StudentSubmissions.Get
    (
    -- * Resource
...
newClassroomCoursesCourseWorkAddOnAttachmentsStudentSubmissionsGet
  ...
  = ClassroomCoursesCourseWorkAddOnAttachmentsStudentSubmissionsGet{xgafv
                                                                      = Core.Nothing,
