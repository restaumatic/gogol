...
-- |
-- Module      : Gogol.Classroom.Courses.CourseWork.StudentSubmissions.ModifyAttachments
...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.courseWork.studentSubmissions.modifyAttachments@.
module Gogol.Classroom.Courses.CourseWork.StudentSubmissions.ModifyAttachments
    (
    -- * Resource
           ...
           "courseWork" Core.:>
             Core.Capture "courseWorkId" Core.Text Core.:>
               "studentSubmissions" Core.:>
                 Core.CaptureMode "id" "modifyAttachments" Core.Text Core.:>
                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.ReqBody '[Core.JSON] ModifyAttachmentsRequest Core.:>
                                 Core.Post '[Core.JSON] StudentSubmission
...
newClassroomCoursesCourseWorkStudentSubmissionsModifyAttachments 
    ...
    -> ClassroomCoursesCourseWorkStudentSubmissionsModifyAttachments
newClassroomCoursesCourseWorkStudentSubmissionsModifyAttachments
  courseId courseWorkId id payload
  = ClassroomCoursesCourseWorkStudentSubmissionsModifyAttachments{xgafv
                                                                    = Core.Nothing,
