                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] Rubric Core.:>
                               Core.Post '[Core.JSON] Rubric
...
newClassroomCoursesCourseWorkRubricsCreate 
    ...
    -> ClassroomCoursesCourseWorkRubricsCreate
newClassroomCoursesCourseWorkRubricsCreate courseId courseWorkId
  payload
  = ClassroomCoursesCourseWorkRubricsCreate{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            courseId = courseId, courseWorkId = courseWorkId,
                                            payload = payload, uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ClassroomCoursesCourseWorkRubricsCreate
         where
        type Rs ClassroomCoursesCourseWorkRubricsCreate = Rubric
        type Scopes ClassroomCoursesCourseWorkRubricsCreate =
             '[Classroom'Coursework'Students]
        requestClient ClassroomCoursesCourseWorkRubricsCreate{..}
          = go courseId courseWorkId xgafv accessToken callback uploadType
              uploadProtocol
