...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.courseWork.list@.
module Gogol.Classroom.Courses.CourseWork.List
    (
    -- * Resource
             ...
             Core.QueryParam "$.xgafv" Xgafv Core.:>
               Core.QueryParam "access_token" Core.Text Core.:>
                 Core.QueryParam "callback" Core.Text Core.:>
                   Core.QueryParams "courseWorkStates"
                           ...
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.Get '[Core.JSON] ListCourseWorkResponse
...
newClassroomCoursesCourseWorkList courseId
  = ClassroomCoursesCourseWorkList{xgafv = Core.Nothing,
                                   accessToken = Core.Nothing, callback = Core.Nothing,
                                   courseId = courseId, courseWorkStates = Core.Nothing,
                                   orderBy = Core.Nothing, pageSize = Core.Nothing,
                                   pageToken = Core.Nothing, uploadType = Core.Nothing,
                                   uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ClassroomCoursesCourseWorkList where
        type Rs ClassroomCoursesCourseWorkList = ListCourseWorkResponse
        type Scopes ClassroomCoursesCourseWorkList =
        ...
        requestClient ClassroomCoursesCourseWorkList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ClassroomCoursesCourseWorkListResource)
                      Core.mempty
