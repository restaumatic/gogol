...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.courseWork.studentSubmissions.return@.
module Gogol.Classroom.Courses.CourseWork.StudentSubmissions.Return
    (
    -- * Resource
                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.ReqBody '[Core.JSON] ReturnStudentSubmissionRequest Core.:>
...
newClassroomCoursesCourseWorkStudentSubmissionsReturn 
    ...
    -> ClassroomCoursesCourseWorkStudentSubmissionsReturn
newClassroomCoursesCourseWorkStudentSubmissionsReturn courseId
  courseWorkId id payload
  = ClassroomCoursesCourseWorkStudentSubmissionsReturn{xgafv =
                                                         Core.Nothing,
...
instance Core.GoogleRequest
           ClassroomCoursesCourseWorkStudentSubmissionsReturn
         where
        type Rs ClassroomCoursesCourseWorkStudentSubmissionsReturn = Empty
        type Scopes ClassroomCoursesCourseWorkStudentSubmissionsReturn =
