...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.courseWork.create@.
module Gogol.Classroom.Courses.CourseWork.Create
    (
    -- * Resource
...
newClassroomCoursesCourseWorkCreate courseId payload
  = ClassroomCoursesCourseWorkCreate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ClassroomCoursesCourseWorkCreate where
        ...
        type Scopes ClassroomCoursesCourseWorkCreate =
