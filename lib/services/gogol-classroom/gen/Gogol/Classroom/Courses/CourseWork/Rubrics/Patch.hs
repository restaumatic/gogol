...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.courseWork.rubrics.patch@.
module Gogol.Classroom.Courses.CourseWork.Rubrics.Patch
    (
    -- * Resource
...
newClassroomCoursesCourseWorkRubricsPatch 
    ...
    -> ClassroomCoursesCourseWorkRubricsPatch
newClassroomCoursesCourseWorkRubricsPatch courseId courseWorkId id
  payload
  = ClassroomCoursesCourseWorkRubricsPatch{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           courseId = courseId, courseWorkId = courseWorkId,
                                           id = id, payload = payload, updateMask = Core.Nothing,
                                           uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ClassroomCoursesCourseWorkRubricsPatch
         where
        type Rs ClassroomCoursesCourseWorkRubricsPatch = Rubric
        type Scopes ClassroomCoursesCourseWorkRubricsPatch =
             '[Classroom'Coursework'Students]
        requestClient ClassroomCoursesCourseWorkRubricsPatch{..}
          = go courseId courseWorkId id xgafv accessToken callback updateMask
              uploadType
              uploadProtocol
