...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.courseWork.studentSubmissions.list@.
module Gogol.Classroom.Courses.CourseWork.StudentSubmissions.List
    (
    -- * Resource
                 ...
                 Core.QueryParam "$.xgafv" Xgafv Core.:>
                   Core.QueryParam "access_token" Core.Text Core.:>
                     Core.QueryParam "callback" Core.Text Core.:>
                       Core.QueryParam "late" CoursesCourseWorkStudentSubmissionsListLate
                         Core.:>
                         Core.QueryParam "pageSize" Core.Int32 Core.:>
                           Core.QueryParam "pageToken" Core.Text Core.:>
                             Core.QueryParams "states"
                                 ...
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "userId" Core.Text Core.:>
                                     Core.QueryParam "alt" Core.AltJSON Core.:>
                                       Core.Get '[Core.JSON] ListStudentSubmissionsResponse
...
newClassroomCoursesCourseWorkStudentSubmissionsList 
    ...
    -> ClassroomCoursesCourseWorkStudentSubmissionsList
newClassroomCoursesCourseWorkStudentSubmissionsList courseId
  courseWorkId
  = ClassroomCoursesCourseWorkStudentSubmissionsList{xgafv =
                                                       Core.Nothing,
                                                     accessToken = Core.Nothing,
                                                     callback = Core.Nothing, courseId = courseId,
                                                     courseWorkId = courseWorkId,
                                                     late = Core.Nothing, pageSize = Core.Nothing,
...
instance Core.GoogleRequest
           ClassroomCoursesCourseWorkStudentSubmissionsList
         where
        type Rs ClassroomCoursesCourseWorkStudentSubmissionsList =
             ListStudentSubmissionsResponse
        type Scopes ClassroomCoursesCourseWorkStudentSubmissionsList =
             '[Classroom'Coursework'Me, Classroom'Coursework'Me'Readonly,
               Classroom'Coursework'Students,
               Classroom'Coursework'Students'Readonly,
               Classroom'StudentSubmissions'Me'Readonly,
               Classroom'StudentSubmissions'Students'Readonly]
        requestClient ClassroomCoursesCourseWorkStudentSubmissionsList{..}
          = go courseId courseWorkId xgafv accessToken callback late pageSize
              pageToken
