...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.courseWork.rubrics.get@.
module Gogol.Classroom.Courses.CourseWork.Rubrics.Get
    (
    -- * Resource
...
newClassroomCoursesCourseWorkRubricsGet courseId courseWorkId id
  = ClassroomCoursesCourseWorkRubricsGet{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         courseId = courseId, courseWorkId = courseWorkId, id = id,
                                         uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ClassroomCoursesCourseWorkRubricsGet
         where
        type Rs ClassroomCoursesCourseWorkRubricsGet = Rubric
        type Scopes ClassroomCoursesCourseWorkRubricsGet =
