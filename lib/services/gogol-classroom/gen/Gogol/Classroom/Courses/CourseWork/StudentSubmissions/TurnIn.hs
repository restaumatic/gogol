...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.courseWork.studentSubmissions.turnIn@.
module Gogol.Classroom.Courses.CourseWork.StudentSubmissions.TurnIn
    (
    -- * Resource
                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.ReqBody '[Core.JSON] TurnInStudentSubmissionRequest Core.:>
...
newClassroomCoursesCourseWorkStudentSubmissionsTurnIn 
    ...
    -> ClassroomCoursesCourseWorkStudentSubmissionsTurnIn
newClassroomCoursesCourseWorkStudentSubmissionsTurnIn courseId
  courseWorkId id payload
  = ClassroomCoursesCourseWorkStudentSubmissionsTurnIn{xgafv =
                                                         Core.Nothing,
...
instance Core.GoogleRequest
           ClassroomCoursesCourseWorkStudentSubmissionsTurnIn
         where
        type Rs ClassroomCoursesCourseWorkStudentSubmissionsTurnIn = Empty
        type Scopes ClassroomCoursesCourseWorkStudentSubmissionsTurnIn =
