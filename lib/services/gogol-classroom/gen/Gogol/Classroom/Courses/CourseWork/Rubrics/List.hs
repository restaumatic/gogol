...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.courseWork.rubrics.list@.
module Gogol.Classroom.Courses.CourseWork.Rubrics.List
    (
    -- * Resource
                           ...
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.Get '[Core.JSON] ListRubricsResponse
...
newClassroomCoursesCourseWorkRubricsList courseId courseWorkId
  = ClassroomCoursesCourseWorkRubricsList{xgafv = Core.Nothing,
