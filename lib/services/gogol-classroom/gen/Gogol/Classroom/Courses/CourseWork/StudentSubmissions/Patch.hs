...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.courseWork.studentSubmissions.patch@.
module Gogol.Classroom.Courses.CourseWork.StudentSubmissions.Patch
    (
    -- * Resource
                           ...
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.ReqBody '[Core.JSON] StudentSubmission Core.:>
                                   Core.Patch '[Core.JSON] StudentSubmission
...
newClassroomCoursesCourseWorkStudentSubmissionsPatch 
    ...
    -> ClassroomCoursesCourseWorkStudentSubmissionsPatch
newClassroomCoursesCourseWorkStudentSubmissionsPatch courseId
  courseWorkId id payload
  = ClassroomCoursesCourseWorkStudentSubmissionsPatch{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           ClassroomCoursesCourseWorkStudentSubmissionsPatch
         where
        type Rs ClassroomCoursesCourseWorkStudentSubmissionsPatch =
             StudentSubmission
        type Scopes ClassroomCoursesCourseWorkStudentSubmissionsPatch =
