...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.courseWork.addOnAttachments.studentSubmissions.patch@.
module Gogol.Classroom.Courses.CourseWork.AddOnAttachments.StudentSubmissions.Patch
    (
    -- * Resource
...
newClassroomCoursesCourseWorkAddOnAttachmentsStudentSubmissionsPatch 
    ...
    -> ClassroomCoursesCourseWorkAddOnAttachmentsStudentSubmissionsPatch
newClassroomCoursesCourseWorkAddOnAttachmentsStudentSubmissionsPatch
  attachmentId courseId itemId payload submissionId
  = ClassroomCoursesCourseWorkAddOnAttachmentsStudentSubmissionsPatch{xgafv
                                                                        = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        requestClient
          ClassroomCoursesCourseWorkAddOnAttachmentsStudentSubmissionsPatch{..}
          = go courseId itemId attachmentId submissionId xgafv accessToken
              callback
              postId
              updateMask
              uploadType
