...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.courseWork.delete@.
module Gogol.Classroom.Courses.CourseWork.Delete
    (
    -- * Resource
...
newClassroomCoursesCourseWorkDelete courseId id
  = ClassroomCoursesCourseWorkDelete{xgafv = Core.Nothing,
                                     accessToken = Core.Nothing, callback = Core.Nothing,
                                     courseId = courseId, id = id, uploadType = Core.Nothing,
                                     uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ClassroomCoursesCourseWorkDelete where
        ...
        requestClient ClassroomCoursesCourseWorkDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ClassroomCoursesCourseWorkDeleteResource)
                      Core.mempty
