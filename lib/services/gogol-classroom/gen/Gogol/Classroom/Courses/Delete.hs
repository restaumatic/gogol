...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.delete@.
module Gogol.Classroom.Courses.Delete
    (
    -- * Resource
...
newClassroomCoursesDelete id
  = ClassroomCoursesDelete{xgafv = Core.Nothing,
