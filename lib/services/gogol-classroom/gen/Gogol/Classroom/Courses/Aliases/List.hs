...
-- |
-- Module      : Gogol.Classroom.Courses.Aliases.List
...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.aliases.list@.
module Gogol.Classroom.Courses.Aliases.List
    (
    -- * Resource
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] ListCourseAliasesResponse
...
newClassroomCoursesAliasesList courseId
  = ClassroomCoursesAliasesList{xgafv = Core.Nothing,
                                accessToken = Core.Nothing, callback = Core.Nothing,
                                courseId = courseId, pageSize = Core.Nothing,
                                pageToken = Core.Nothing, uploadType = Core.Nothing,
                                uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ClassroomCoursesAliasesList where
        type Rs ClassroomCoursesAliasesList = ListCourseAliasesResponse
        type Scopes ClassroomCoursesAliasesList =
        ...
        requestClient ClassroomCoursesAliasesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ClassroomCoursesAliasesListResource)
                      Core.mempty
