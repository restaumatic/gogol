...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.aliases.create@.
module Gogol.Classroom.Courses.Aliases.Create
    (
    -- * Resource
...
newClassroomCoursesAliasesCreate courseId payload
  = ClassroomCoursesAliasesCreate{xgafv = Core.Nothing,
