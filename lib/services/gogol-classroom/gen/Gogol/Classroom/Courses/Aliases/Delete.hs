...
-- |
-- Module      : Gogol.Classroom.Courses.Aliases.Delete
...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.aliases.delete@.
module Gogol.Classroom.Courses.Aliases.Delete
    (
    -- * Resource
...
newClassroomCoursesAliasesDelete alias courseId
  = ClassroomCoursesAliasesDelete{xgafv = Core.Nothing,
                                  accessToken = Core.Nothing, alias = alias,
                                  callback = Core.Nothing, courseId = courseId,
                                  uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ClassroomCoursesAliasesDelete where
        type Rs ClassroomCoursesAliasesDelete = Empty
        type Scopes ClassroomCoursesAliasesDelete = '[Classroom'Courses]
        requestClient ClassroomCoursesAliasesDelete{..}
          = go courseId alias xgafv accessToken callback uploadType
              uploadProtocol
              (Core.Just Core.AltJSON)
              classroomService
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ClassroomCoursesAliasesDeleteResource)
                      Core.mempty
