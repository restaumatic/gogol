...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.teachers.get@.
module Gogol.Classroom.Courses.Teachers.Get
    (
    -- * Resource
...
newClassroomCoursesTeachersGet courseId userId
  = ClassroomCoursesTeachersGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ClassroomCoursesTeachersGet where
        ...
        type Scopes ClassroomCoursesTeachersGet =
