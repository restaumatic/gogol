                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] Teacher Core.:>
                           Core.Post '[Core.JSON] Teacher
...
newClassroomCoursesTeachersCreate courseId payload
  = ClassroomCoursesTeachersCreate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ClassroomCoursesTeachersCreate where
        ...
        type Scopes ClassroomCoursesTeachersCreate =
