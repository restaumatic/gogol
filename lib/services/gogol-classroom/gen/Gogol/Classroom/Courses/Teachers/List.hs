...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.teachers.list@.
module Gogol.Classroom.Courses.Teachers.List
    (
    -- * Resource
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] ListTeachersResponse
...
newClassroomCoursesTeachersList courseId
  = ClassroomCoursesTeachersList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ClassroomCoursesTeachersList where
        ...
        type Scopes ClassroomCoursesTeachersList =
