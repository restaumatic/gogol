...
newClassroomCoursesStudentsCreate courseId payload
  = ClassroomCoursesStudentsCreate{xgafv = Core.Nothing,
                                   accessToken = Core.Nothing, callback = Core.Nothing,
                                   courseId = courseId, enrollmentCode = Core.Nothing,
                                   payload = payload, uploadType = Core.Nothing,
                                   uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ClassroomCoursesStudentsCreate where
        type Rs ClassroomCoursesStudentsCreate = Student
        type Scopes ClassroomCoursesStudentsCreate =
             '[Classroom'Profile'Emails, Classroom'Profile'Photos,
               Classroom'Rosters]
        requestClient ClassroomCoursesStudentsCreate{..}
          = go courseId xgafv accessToken callback enrollmentCode uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ClassroomCoursesStudentsCreateResource)
                      Core.mempty
