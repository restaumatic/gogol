...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.students.list@.
module Gogol.Classroom.Courses.Students.List
    (
    -- * Resource
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] ListStudentsResponse
...
newClassroomCoursesStudentsList courseId
  = ClassroomCoursesStudentsList{xgafv = Core.Nothing,
                                 accessToken = Core.Nothing, callback = Core.Nothing,
                                 courseId = courseId, pageSize = Core.Nothing,
                                 pageToken = Core.Nothing, uploadType = Core.Nothing,
                                 uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ClassroomCoursesStudentsList where
        type Rs ClassroomCoursesStudentsList = ListStudentsResponse
        type Scopes ClassroomCoursesStudentsList =
        ...
        requestClient ClassroomCoursesStudentsList{..}
          = go courseId xgafv accessToken callback pageSize pageToken
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ClassroomCoursesStudentsListResource)
                      Core.mempty
