...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.students.get@.
module Gogol.Classroom.Courses.Students.Get
    (
    -- * Resource
...
newClassroomCoursesStudentsGet courseId userId
  = ClassroomCoursesStudentsGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ClassroomCoursesStudentsGet where
        ...
        type Scopes ClassroomCoursesStudentsGet =
