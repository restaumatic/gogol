...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.students.delete@.
module Gogol.Classroom.Courses.Students.Delete
    (
    -- * Resource
...
newClassroomCoursesStudentsDelete courseId userId
  = ClassroomCoursesStudentsDelete{xgafv = Core.Nothing,
