...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.courseWorkMaterials.patch@.
module Gogol.Classroom.Courses.CourseWorkMaterials.Patch
    (
    -- * Resource
...
newClassroomCoursesCourseWorkMaterialsPatch courseId id payload
  = ClassroomCoursesCourseWorkMaterialsPatch{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        requestClient ClassroomCoursesCourseWorkMaterialsPatch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ClassroomCoursesCourseWorkMaterialsPatchResource)
                      Core.mempty
