...
-- |
-- Module      : Gogol.Classroom.Courses.CourseWorkMaterials.AddOnAttachments.Delete
...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.courseWorkMaterials.addOnAttachments.delete@.
module Gogol.Classroom.Courses.CourseWorkMaterials.AddOnAttachments.Delete
    (
    -- * Resource
...
-- | A resource alias for @classroom.courses.courseWorkMaterials.addOnAttachments.delete@ method which the
-- 'ClassroomCoursesCourseWorkMaterialsAddOnAttachmentsDelete' request conforms to.
type ClassroomCoursesCourseWorkMaterialsAddOnAttachmentsDeleteResource
     =
     "v1" Core.:>
       "courses" Core.:>
...
-- | Deletes an add-on attachment. Requires the add-on to have been the original creator of the attachment. This method returns the following error codes: * @PERMISSION_DENIED@ for access errors. * @INVALID_ARGUMENT@ if the request is malformed. * @NOT_FOUND@ if one of the identified resources does not exist.
--
-- /See:/ 'newClassroomCoursesCourseWorkMaterialsAddOnAttachmentsDelete' smart constructor.
data ClassroomCoursesCourseWorkMaterialsAddOnAttachmentsDelete = ClassroomCoursesCourseWorkMaterialsAddOnAttachmentsDelete
    {
      -- | V1 error format.
...
-- | Creates a value of 'ClassroomCoursesCourseWorkMaterialsAddOnAttachmentsDelete' with the minimum fields required to make a request.
newClassroomCoursesCourseWorkMaterialsAddOnAttachmentsDelete 
    :: 
                                                             Core.Text
...
newClassroomCoursesCourseWorkMaterialsAddOnAttachmentsDelete
  ...
  = ClassroomCoursesCourseWorkMaterialsAddOnAttachmentsDelete{xgafv =
                                                                Core.Nothing,
...
instance Core.GoogleRequest
           ClassroomCoursesCourseWorkMaterialsAddOnAttachmentsDelete
         where
        type Rs ClassroomCoursesCourseWorkMaterialsAddOnAttachmentsDelete =
             Empty
        type Scopes
               ClassroomCoursesCourseWorkMaterialsAddOnAttachmentsDelete
