...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.courseWorkMaterials.addOnAttachments.list@.
module Gogol.Classroom.Courses.CourseWorkMaterials.AddOnAttachments.List
    (
    -- * Resource
...
newClassroomCoursesCourseWorkMaterialsAddOnAttachmentsList 
    ...
    -> ClassroomCoursesCourseWorkMaterialsAddOnAttachmentsList
newClassroomCoursesCourseWorkMaterialsAddOnAttachmentsList courseId
  itemId
  = ClassroomCoursesCourseWorkMaterialsAddOnAttachmentsList{xgafv =
                                                              Core.Nothing,
...
instance Core.GoogleRequest
           ClassroomCoursesCourseWorkMaterialsAddOnAttachmentsList
         where
        type Rs ClassroomCoursesCourseWorkMaterialsAddOnAttachmentsList =
             ListAddOnAttachmentsResponse
        type Scopes ClassroomCoursesCourseWorkMaterialsAddOnAttachmentsList
