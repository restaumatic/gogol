...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.courseWorkMaterials.delete@.
module Gogol.Classroom.Courses.CourseWorkMaterials.Delete
    (
    -- * Resource
...
newClassroomCoursesCourseWorkMaterialsDelete courseId id
  = ClassroomCoursesCourseWorkMaterialsDelete{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           ClassroomCoursesCourseWorkMaterialsDelete
         where
        type Rs ClassroomCoursesCourseWorkMaterialsDelete = Empty
        type Scopes ClassroomCoursesCourseWorkMaterialsDelete =
             '[Classroom'Courseworkmaterials]
        requestClient ClassroomCoursesCourseWorkMaterialsDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ClassroomCoursesCourseWorkMaterialsDeleteResource)
                      Core.mempty
