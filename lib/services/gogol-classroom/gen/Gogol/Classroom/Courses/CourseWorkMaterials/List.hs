...
-- |
-- Module      : Gogol.Classroom.Courses.CourseWorkMaterials.List
...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.courseWorkMaterials.list@.
module Gogol.Classroom.Courses.CourseWorkMaterials.List
    (
    -- * Resource
             ...
             Core.QueryParam "$.xgafv" Xgafv Core.:>
               Core.QueryParam "access_token" Core.Text Core.:>
                 Core.QueryParam "callback" Core.Text Core.:>
                   Core.QueryParams "courseWorkMaterialStates"
                     CoursesCourseWorkMaterialsListCourseWorkMaterialStates
                     Core.:>
                     Core.QueryParam "materialDriveId" Core.Text Core.:>
                       Core.QueryParam "materialLink" Core.Text Core.:>
                               ...
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.Get '[Core.JSON] ListCourseWorkMaterialResponse
...
data ClassroomCoursesCourseWorkMaterialsList = ClassroomCoursesCourseWorkMaterialsList
    ...
    , courseWorkMaterialStates :: (Core.Maybe
   [CoursesCourseWorkMaterialsListCourseWorkMaterialStates])
...
newClassroomCoursesCourseWorkMaterialsList courseId
  = ClassroomCoursesCourseWorkMaterialsList{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            courseId = courseId,
                                            courseWorkMaterialStates = Core.Nothing,
                                            materialDriveId = Core.Nothing,
                                            materialLink = Core.Nothing, orderBy = Core.Nothing,
                                            pageSize = Core.Nothing, pageToken = Core.Nothing,
                                            uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ClassroomCoursesCourseWorkMaterialsList
         where
        type Rs ClassroomCoursesCourseWorkMaterialsList =
             ListCourseWorkMaterialResponse
        type Scopes ClassroomCoursesCourseWorkMaterialsList =
             '[Classroom'Courseworkmaterials,
               Classroom'Courseworkmaterials'Readonly]
        requestClient ClassroomCoursesCourseWorkMaterialsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ClassroomCoursesCourseWorkMaterialsListResource)
                      Core.mempty
