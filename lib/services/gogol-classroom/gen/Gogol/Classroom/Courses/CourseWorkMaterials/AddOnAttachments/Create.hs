...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.courseWorkMaterials.addOnAttachments.create@.
module Gogol.Classroom.Courses.CourseWorkMaterials.AddOnAttachments.Create
    (
    -- * Resource
...
newClassroomCoursesCourseWorkMaterialsAddOnAttachmentsCreate
  ...
  = ClassroomCoursesCourseWorkMaterialsAddOnAttachmentsCreate{xgafv =
                                                                Core.Nothing,
...
instance Core.GoogleRequest
           ClassroomCoursesCourseWorkMaterialsAddOnAttachmentsCreate
         where
        type Rs ClassroomCoursesCourseWorkMaterialsAddOnAttachmentsCreate =
             AddOnAttachment
        type Scopes
               ClassroomCoursesCourseWorkMaterialsAddOnAttachmentsCreate
