...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.courseWorkMaterials.get@.
module Gogol.Classroom.Courses.CourseWorkMaterials.Get
    (
    -- * Resource
                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] CourseWorkMaterial
...
newClassroomCoursesCourseWorkMaterialsGet courseId id
  = ClassroomCoursesCourseWorkMaterialsGet{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           courseId = courseId, id = id, uploadType = Core.Nothing,
                                           uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ClassroomCoursesCourseWorkMaterialsGet
         where
        type Rs ClassroomCoursesCourseWorkMaterialsGet = CourseWorkMaterial
        type Scopes ClassroomCoursesCourseWorkMaterialsGet =
             '[Classroom'Courseworkmaterials,
               Classroom'Courseworkmaterials'Readonly]
        requestClient ClassroomCoursesCourseWorkMaterialsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ClassroomCoursesCourseWorkMaterialsGetResource)
                      Core.mempty
