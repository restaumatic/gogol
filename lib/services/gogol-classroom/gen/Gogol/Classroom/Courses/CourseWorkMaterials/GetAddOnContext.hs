...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.courseWorkMaterials.getAddOnContext@.
module Gogol.Classroom.Courses.CourseWorkMaterials.GetAddOnContext
    (
    -- * Resource
...
newClassroomCoursesCourseWorkMaterialsGetAddOnContext 
    ...
    -> ClassroomCoursesCourseWorkMaterialsGetAddOnContext
newClassroomCoursesCourseWorkMaterialsGetAddOnContext courseId
  itemId
  = ClassroomCoursesCourseWorkMaterialsGetAddOnContext{xgafv =
                                                         Core.Nothing,
...
instance Core.GoogleRequest
           ClassroomCoursesCourseWorkMaterialsGetAddOnContext
         where
        type Rs ClassroomCoursesCourseWorkMaterialsGetAddOnContext =
             AddOnContext
        type Scopes ClassroomCoursesCourseWorkMaterialsGetAddOnContext =
             '[Classroom'Addons'Student, Classroom'Addons'Teacher]
        requestClient
          ClassroomCoursesCourseWorkMaterialsGetAddOnContext{..}
          = go courseId itemId xgafv accessToken addOnToken attachmentId
              callback
              postId
              uploadType
              uploadProtocol
