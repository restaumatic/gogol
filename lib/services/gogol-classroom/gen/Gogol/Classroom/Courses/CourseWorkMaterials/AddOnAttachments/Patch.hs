...
-- |
-- Module      : Gogol.Classroom.Courses.CourseWorkMaterials.AddOnAttachments.Patch
...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.courseWorkMaterials.addOnAttachments.patch@.
module Gogol.Classroom.Courses.CourseWorkMaterials.AddOnAttachments.Patch
    (
    -- * Resource
...
-- | A resource alias for @classroom.courses.courseWorkMaterials.addOnAttachments.patch@ method which the
-- 'ClassroomCoursesCourseWorkMaterialsAddOnAttachmentsPatch' request conforms to.
type ClassroomCoursesCourseWorkMaterialsAddOnAttachmentsPatchResource
     =
     "v1" Core.:>
       "courses" Core.:>
                             ...
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.ReqBody '[Core.JSON] AddOnAttachment Core.:>
                                     Core.Patch '[Core.JSON] AddOnAttachment

-- | Updates an add-on attachment. Requires the add-on to have been the original creator of the attachment. This method returns the following error codes: * @PERMISSION_DENIED@ for access errors. * @INVALID_ARGUMENT@ if the request is malformed. * @NOT_FOUND@ if one of the identified resources does not exist.
--
-- /See:/ 'newClassroomCoursesCourseWorkMaterialsAddOnAttachmentsPatch' smart constructor.
data ClassroomCoursesCourseWorkMaterialsAddOnAttachmentsPatch = ClassroomCoursesCourseWorkMaterialsAddOnAttachmentsPatch
    {
      -- | V1 error format.
...
-- | Creates a value of 'ClassroomCoursesCourseWorkMaterialsAddOnAttachmentsPatch' with the minimum fields required to make a request.
newClassroomCoursesCourseWorkMaterialsAddOnAttachmentsPatch 
    :: 
                                                            Core.Text
    ...
    -> ClassroomCoursesCourseWorkMaterialsAddOnAttachmentsPatch
newClassroomCoursesCourseWorkMaterialsAddOnAttachmentsPatch
  attachmentId courseId itemId payload
  = ClassroomCoursesCourseWorkMaterialsAddOnAttachmentsPatch{xgafv =
                                                               Core.Nothing,
...
instance Core.GoogleRequest
           ClassroomCoursesCourseWorkMaterialsAddOnAttachmentsPatch
         where
        type Rs ClassroomCoursesCourseWorkMaterialsAddOnAttachmentsPatch =
             AddOnAttachment
        type Scopes
               ClassroomCoursesCourseWorkMaterialsAddOnAttachmentsPatch
