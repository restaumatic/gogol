...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.courseWorkMaterials.create@.
module Gogol.Classroom.Courses.CourseWorkMaterials.Create
    (
    -- * Resource
                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] CourseWorkMaterial Core.:>
                           Core.Post '[Core.JSON] CourseWorkMaterial
...
newClassroomCoursesCourseWorkMaterialsCreate courseId payload
  = ClassroomCoursesCourseWorkMaterialsCreate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           ClassroomCoursesCourseWorkMaterialsCreate
         where
        type Rs ClassroomCoursesCourseWorkMaterialsCreate =
             CourseWorkMaterial
        type Scopes ClassroomCoursesCourseWorkMaterialsCreate =
             '[Classroom'Courseworkmaterials]
        requestClient ClassroomCoursesCourseWorkMaterialsCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ClassroomCoursesCourseWorkMaterialsCreateResource)
                      Core.mempty
