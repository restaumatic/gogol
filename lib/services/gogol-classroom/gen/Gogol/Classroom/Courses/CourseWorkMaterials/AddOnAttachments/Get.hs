...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.courses.courseWorkMaterials.addOnAttachments.get@.
module Gogol.Classroom.Courses.CourseWorkMaterials.AddOnAttachments.Get
    (
    -- * Resource
...
newClassroomCoursesCourseWorkMaterialsAddOnAttachmentsGet
  ...
  = ClassroomCoursesCourseWorkMaterialsAddOnAttachmentsGet{xgafv =
                                                             Core.Nothing,
...
instance Core.GoogleRequest
           ClassroomCoursesCourseWorkMaterialsAddOnAttachmentsGet
         where
        type Rs ClassroomCoursesCourseWorkMaterialsAddOnAttachmentsGet =
             AddOnAttachment
        type Scopes ClassroomCoursesCourseWorkMaterialsAddOnAttachmentsGet
