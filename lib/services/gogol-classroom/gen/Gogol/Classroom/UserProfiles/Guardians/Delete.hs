...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.userProfiles.guardians.delete@.
module Gogol.Classroom.UserProfiles.Guardians.Delete
    (
    -- * Resource
...
newClassroomUserProfilesGuardiansDelete guardianId studentId
  = ClassroomUserProfilesGuardiansDelete{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         guardianId = guardianId, studentId = studentId,
                                         uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ClassroomUserProfilesGuardiansDelete
         where
        ...
        requestClient ClassroomUserProfilesGuardiansDelete{..}
          = go studentId guardianId xgafv accessToken callback uploadType
              uploadProtocol
