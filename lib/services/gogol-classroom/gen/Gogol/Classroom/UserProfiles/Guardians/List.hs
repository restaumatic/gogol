...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.userProfiles.guardians.list@.
module Gogol.Classroom.UserProfiles.Guardians.List
    (
    -- * Resource
                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Get '[Core.JSON] ListGuardiansResponse
...
newClassroomUserProfilesGuardiansList studentId
  = ClassroomUserProfilesGuardiansList{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       invitedEmailAddress = Core.Nothing, pageSize = Core.Nothing,
                                       pageToken = Core.Nothing, studentId = studentId,
                                       uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ClassroomUserProfilesGuardiansList
         where
        type Rs ClassroomUserProfilesGuardiansList = ListGuardiansResponse
        type Scopes ClassroomUserProfilesGuardiansList =
