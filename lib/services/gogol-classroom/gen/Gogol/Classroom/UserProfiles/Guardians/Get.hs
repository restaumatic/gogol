...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.userProfiles.guardians.get@.
module Gogol.Classroom.UserProfiles.Guardians.Get
    (
    -- * Resource
...
newClassroomUserProfilesGuardiansGet guardianId studentId
  = ClassroomUserProfilesGuardiansGet{xgafv = Core.Nothing,
