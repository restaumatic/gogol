...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.userProfiles.guardianInvitations.patch@.
module Gogol.Classroom.UserProfiles.GuardianInvitations.Patch
    (
    -- * Resource
                         ...
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] GuardianInvitation Core.:>
                               Core.Patch '[Core.JSON] GuardianInvitation
...
newClassroomUserProfilesGuardianInvitationsPatch 
    ...
    -> ClassroomUserProfilesGuardianInvitationsPatch
newClassroomUserProfilesGuardianInvitationsPatch invitationId
  payload studentId
  = ClassroomUserProfilesGuardianInvitationsPatch{xgafv =
                                                    Core.Nothing,
                                                  accessToken = Core.Nothing,
                                                  callback = Core.Nothing,
                                                  invitationId = invitationId, payload = payload,
                                                  studentId = studentId, updateMask = Core.Nothing,
                                                  uploadType = Core.Nothing,
                                                  uploadProtocol = Core.Nothing}
instance Core.GoogleRequest
           ClassroomUserProfilesGuardianInvitationsPatch
         where
        type Rs ClassroomUserProfilesGuardianInvitationsPatch =
             GuardianInvitation
        type Scopes ClassroomUserProfilesGuardianInvitationsPatch =
             '[Classroom'Guardianlinks'Students]
        requestClient ClassroomUserProfilesGuardianInvitationsPatch{..}
          = go studentId invitationId xgafv accessToken callback updateMask
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ClassroomUserProfilesGuardianInvitationsPatchResource)
                      Core.mempty
