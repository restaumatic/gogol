...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.userProfiles.guardianInvitations.get@.
module Gogol.Classroom.UserProfiles.GuardianInvitations.Get
    (
    -- * Resource
...
newClassroomUserProfilesGuardianInvitationsGet 
    ...
    -> ClassroomUserProfilesGuardianInvitationsGet
newClassroomUserProfilesGuardianInvitationsGet invitationId
  studentId
  = ClassroomUserProfilesGuardianInvitationsGet{xgafv = Core.Nothing,
                                                accessToken = Core.Nothing, callback = Core.Nothing,
                                                invitationId = invitationId, studentId = studentId,
...
instance Core.GoogleRequest
        ...
        type Rs ClassroomUserProfilesGuardianInvitationsGet =
             GuardianInvitation
        type Scopes ClassroomUserProfilesGuardianInvitationsGet =
             '[Classroom'Guardianlinks'Students,
               Classroom'Guardianlinks'Students'Readonly]
        requestClient ClassroomUserProfilesGuardianInvitationsGet{..}
          = go studentId invitationId xgafv accessToken callback uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ClassroomUserProfilesGuardianInvitationsGetResource)
                      Core.mempty
