...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.userProfiles.guardianInvitations.list@.
module Gogol.Classroom.UserProfiles.GuardianInvitations.List
    (
    -- * Resource
             ...
             Core.QueryParam "$.xgafv" Xgafv Core.:>
               Core.QueryParam "access_token" Core.Text Core.:>
                 Core.QueryParam "callback" Core.Text Core.:>
                   Core.QueryParam "invitedEmailAddress" Core.Text Core.:>
                     Core.QueryParam "pageSize" Core.Int32 Core.:>
                       Core.QueryParam "pageToken" Core.Text Core.:>
                         Core.QueryParams "states" UserProfilesGuardianInvitationsListStates
                           Core.:>
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.Get '[Core.JSON] ListGuardianInvitationsResponse
...
newClassroomUserProfilesGuardianInvitationsList studentId
  = ClassroomUserProfilesGuardianInvitationsList{xgafv =
                                                   Core.Nothing,
                                                 accessToken = Core.Nothing,
                                                 callback = Core.Nothing,
                                                 invitedEmailAddress = Core.Nothing,
                                                 pageSize = Core.Nothing, pageToken = Core.Nothing,
                                                 states = Core.Nothing, studentId = studentId,
                                                 uploadType = Core.Nothing,
                                                 uploadProtocol = Core.Nothing}
instance Core.GoogleRequest
           ClassroomUserProfilesGuardianInvitationsList
         where
        type Rs ClassroomUserProfilesGuardianInvitationsList =
             ListGuardianInvitationsResponse
        type Scopes ClassroomUserProfilesGuardianInvitationsList =
             '[Classroom'Guardianlinks'Students,
               Classroom'Guardianlinks'Students'Readonly]
        requestClient ClassroomUserProfilesGuardianInvitationsList{..}
          = go studentId xgafv accessToken callback invitedEmailAddress
              pageSize
              pageToken
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ClassroomUserProfilesGuardianInvitationsListResource)
                      Core.mempty
