...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.userProfiles.guardianInvitations.create@.
module Gogol.Classroom.UserProfiles.GuardianInvitations.Create
    (
    -- * Resource
...
newClassroomUserProfilesGuardianInvitationsCreate payload studentId
  = ClassroomUserProfilesGuardianInvitationsCreate{xgafv =
                                                     Core.Nothing,
                                                   accessToken = Core.Nothing,
                                                   callback = Core.Nothing, payload = payload,
                                                   studentId = studentId, uploadType = Core.Nothing,
                                                   uploadProtocol = Core.Nothing}
instance Core.GoogleRequest
           ClassroomUserProfilesGuardianInvitationsCreate
         where
        type Rs ClassroomUserProfilesGuardianInvitationsCreate =
             GuardianInvitation
        type Scopes ClassroomUserProfilesGuardianInvitationsCreate =
             '[Classroom'Guardianlinks'Students]
        requestClient ClassroomUserProfilesGuardianInvitationsCreate{..}
          = go studentId xgafv accessToken callback uploadType uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ClassroomUserProfilesGuardianInvitationsCreateResource)
                      Core.mempty
