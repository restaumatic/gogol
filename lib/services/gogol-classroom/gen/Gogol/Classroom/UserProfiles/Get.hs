...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.userProfiles.get@.
module Gogol.Classroom.UserProfiles.Get
    (
    -- * Resource
...
newClassroomUserProfilesGet userId
  = ClassroomUserProfilesGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ClassroomUserProfilesGet where
        ...
        type Scopes ClassroomUserProfilesGet =
