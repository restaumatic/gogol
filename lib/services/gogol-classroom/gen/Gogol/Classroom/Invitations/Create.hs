...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.invitations.create@.
module Gogol.Classroom.Invitations.Create
    (
    -- * Resource
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] Invitation Core.:>
                       Core.Post '[Core.JSON] Invitation
...
newClassroomInvitationsCreate payload
  = ClassroomInvitationsCreate{xgafv = Core.Nothing,
                               accessToken = Core.Nothing, callback = Core.Nothing,
                               payload = payload, uploadType = Core.Nothing,
                               uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ClassroomInvitationsCreate where
        type Rs ClassroomInvitationsCreate = Invitation
        type Scopes ClassroomInvitationsCreate = '[Classroom'Rosters]
        requestClient ClassroomInvitationsCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ClassroomInvitationsCreateResource)
                      Core.mempty
