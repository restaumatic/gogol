...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.invitations.delete@.
module Gogol.Classroom.Invitations.Delete
    (
    -- * Resource
...
newClassroomInvitationsDelete id
  = ClassroomInvitationsDelete{xgafv = Core.Nothing,
                               accessToken = Core.Nothing, callback = Core.Nothing, id = id,
                               uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ClassroomInvitationsDelete where
        type Rs ClassroomInvitationsDelete = Empty
        type Scopes ClassroomInvitationsDelete = '[Classroom'Rosters]
        requestClient ClassroomInvitationsDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ClassroomInvitationsDeleteResource)
                      Core.mempty
