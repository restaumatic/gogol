...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.invitations.get@.
module Gogol.Classroom.Invitations.Get
    (
    -- * Resource
...
newClassroomInvitationsGet id
  = ClassroomInvitationsGet{xgafv = Core.Nothing,
