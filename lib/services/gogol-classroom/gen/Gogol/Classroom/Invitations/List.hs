...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.invitations.list@.
module Gogol.Classroom.Invitations.List
    (
    -- * Resource
         ...
         Core.QueryParam "$.xgafv" Xgafv Core.:>
           Core.QueryParam "access_token" Core.Text Core.:>
             Core.QueryParam "callback" Core.Text Core.:>
               Core.QueryParam "courseId" Core.Text Core.:>
...
newClassroomInvitationsList 
    ::  ClassroomInvitationsList
newClassroomInvitationsList
  = ClassroomInvitationsList{xgafv = Core.Nothing,
                             accessToken = Core.Nothing, callback = Core.Nothing,
                             courseId = Core.Nothing, pageSize = Core.Nothing,
...
instance Core.GoogleRequest ClassroomInvitationsList where
        ...
        type Scopes ClassroomInvitationsList =
             '[Classroom'Rosters, Classroom'Rosters'Readonly]
        requestClient ClassroomInvitationsList{..}
          = go xgafv accessToken callback courseId pageSize pageToken
              uploadType
              uploadProtocol
              userId
