...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.registrations.delete@.
module Gogol.Classroom.Registrations.Delete
    (
    -- * Resource
...
newClassroomRegistrationsDelete registrationId
  = ClassroomRegistrationsDelete{xgafv = Core.Nothing,
                                 accessToken = Core.Nothing, callback = Core.Nothing,
                                 registrationId = registrationId, uploadType = Core.Nothing,
...
instance Core.GoogleRequest ClassroomRegistrationsDelete where
        ...
        requestClient ClassroomRegistrationsDelete{..}
          = go registrationId xgafv accessToken callback uploadType
              uploadProtocol
