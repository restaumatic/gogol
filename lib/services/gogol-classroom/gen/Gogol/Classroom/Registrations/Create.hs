...
-- |
-- Module      : Gogol.Classroom.Registrations.Create
...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference> for @classroom.registrations.create@.
module Gogol.Classroom.Registrations.Create
    (
    -- * Resource
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] Registration Core.:>
                       Core.Post '[Core.JSON] Registration
...
newClassroomRegistrationsCreate payload
  = ClassroomRegistrationsCreate{xgafv = Core.Nothing,
                                 accessToken = Core.Nothing, callback = Core.Nothing,
                                 payload = payload, uploadType = Core.Nothing,
                                 uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ClassroomRegistrationsCreate where
        type Rs ClassroomRegistrationsCreate = Registration
        type Scopes ClassroomRegistrationsCreate =
        ...
        requestClient ClassroomRegistrationsCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ClassroomRegistrationsCreateResource)
                      Core.mempty
