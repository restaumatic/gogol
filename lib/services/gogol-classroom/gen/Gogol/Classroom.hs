...
--
-- /See:/ <https://developers.google.com/workspace/classroom/ Google Classroom API Reference>
module Gogol.Classroom
    (
    -- * Configuration
      classroomService
...
import Gogol.Classroom.Courses.GetGradingPeriodSettings
...
import Gogol.Classroom.Courses.UpdateGradingPeriodSettings
