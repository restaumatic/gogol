                   ...
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] DeviceSession Core.:>
                         Core.Post '[Core.JSON] DeviceSession
...
newTestingProjectsDeviceSessionsCreate parent payload
  = TestingProjectsDeviceSessionsCreate{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        parent = parent, payload = payload,
                                        uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest TestingProjectsDeviceSessionsCreate
         where
        type Rs TestingProjectsDeviceSessionsCreate = DeviceSession
        type Scopes TestingProjectsDeviceSessionsCreate =
