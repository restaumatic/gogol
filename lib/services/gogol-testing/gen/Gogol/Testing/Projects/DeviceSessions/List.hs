                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] ListDeviceSessionsResponse
...
newTestingProjectsDeviceSessionsList parent
  = TestingProjectsDeviceSessionsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest TestingProjectsDeviceSessionsList where
        type Rs TestingProjectsDeviceSessionsList =
             ListDeviceSessionsResponse
        type Scopes TestingProjectsDeviceSessionsList =
