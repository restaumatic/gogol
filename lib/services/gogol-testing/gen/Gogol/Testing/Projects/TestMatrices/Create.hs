...
--
-- /See:/ <https://firebase.google.com/docs/test-lab/ Cloud Testing API Reference> for @testing.projects.testMatrices.create@.
module Gogol.Testing.Projects.TestMatrices.Create
    (
    -- * Resource
...
newTestingProjectsTestMatricesCreate payload projectId
  = TestingProjectsTestMatricesCreate{xgafv = Core.Nothing,
                                      accessToken = Core.Nothing, callback = Core.Nothing,
                                      payload = payload, projectId = projectId,
                                      requestId = Core.Nothing, uploadType = Core.Nothing,
                                      uploadProtocol = Core.Nothing}
instance Core.GoogleRequest TestingProjectsTestMatricesCreate where
        type Rs TestingProjectsTestMatricesCreate = TestMatrix
        type Scopes TestingProjectsTestMatricesCreate =
             '[CloudPlatform'FullControl]
        requestClient TestingProjectsTestMatricesCreate{..}
          = go projectId xgafv accessToken callback requestId uploadType
              uploadProtocol
