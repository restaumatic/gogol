     ...
     "v1" Core.:>
       "projects" Core.:>
         Core.Capture "projectId" Core.Text Core.:>
           "testMatrices" Core.:>
             Core.CaptureMode "testMatrixId" "cancel" Core.Text Core.:>
...
newTestingProjectsTestMatricesCancel projectId testMatrixId
  = TestingProjectsTestMatricesCancel{xgafv = Core.Nothing,
                                      accessToken = Core.Nothing, callback = Core.Nothing,
                                      projectId = projectId, testMatrixId = testMatrixId,
                                      uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest TestingProjectsTestMatricesCancel where
        ...
        requestClient TestingProjectsTestMatricesCancel{..}
          = go projectId testMatrixId xgafv accessToken callback uploadType
              uploadProtocol
