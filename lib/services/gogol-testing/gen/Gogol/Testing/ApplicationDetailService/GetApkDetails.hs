         ...
         "getApkDetails" Core.:>
           Core.QueryParam "$.xgafv" Xgafv Core.:>
             Core.QueryParam "access_token" Core.Text Core.:>
               Core.QueryParam "bundleLocation.gcsPath" Core.Text Core.:>
...
newTestingApplicationDetailServiceGetApkDetails payload
  = TestingApplicationDetailServiceGetApkDetails{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes TestingApplicationDetailServiceGetApkDetails =
             '[CloudPlatform'FullControl]
        requestClient TestingApplicationDetailServiceGetApkDetails{..}
          = go xgafv accessToken bundleLocationGcsPath callback uploadType
              uploadProtocol
