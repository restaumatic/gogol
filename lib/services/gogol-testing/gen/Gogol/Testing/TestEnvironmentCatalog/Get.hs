           ...
           Core.QueryParam "$.xgafv" Xgafv Core.:>
             Core.QueryParam "access_token" Core.Text Core.:>
               Core.QueryParam "callback" Core.Text Core.:>
                 Core.QueryParam "includeViewableModels" Core.Bool Core.:>
...
data TestingTestEnvironmentCatalogGet = TestingTestEnvironmentCatalogGet
    ...
    , includeViewableModels :: (Core.Maybe Core.Bool)
...
newTestingTestEnvironmentCatalogGet environmentType
  = TestingTestEnvironmentCatalogGet{xgafv = Core.Nothing,
                                     accessToken = Core.Nothing, callback = Core.Nothing,
                                     environmentType = environmentType,
                                     includeViewableModels = Core.Nothing, projectId = Core.Nothing,
