...
newAsset 
    ::  Asset
newAsset
  = Asset{authorName = Core.Nothing, createTime = Core.Nothing,
          description = Core.Nothing, displayName = Core.Nothing,
          formats = Core.Nothing, isCurated = Core.Nothing,
          license = Core.Nothing, metadata = Core.Nothing,
          name = Core.Nothing, presentationParams = Core.Nothing,
          remixInfo = Core.Nothing, thumbnail = Core.Nothing,
...
instance Core.FromJSON Asset where
        parseJSON
          = Core.withObject "Asset"
              (\ o ->
                 Asset Core.<$>
                   (o Core..:? "authorName") Core.<*> (o Core..:? "createTime")
          ...
          = Core.object
              (Core.catMaybes
                 [("authorName" Core..=) Core.<$> authorName,
                  ...
                  ("name" Core..=) Core.<$> name,
                  ("presentationParams" Core..=) Core.<$> presentationParams,
...
newAssetImportMessage 
    ::  AssetImportMessage
newAssetImportMessage
  = AssetImportMessage{code = Core.Nothing, filePath = Core.Nothing,
                       imageError = Core.Nothing, objParseError = Core.Nothing}
instance Core.FromJSON AssetImportMessage where
        parseJSON
          = Core.withObject "AssetImportMessage"
              (\ o ->
                 AssetImportMessage Core.<$>
                   (o Core..:? "code") Core.<*> (o Core..:? "filePath") Core.<*>
                     (o Core..:? "imageError")
...
newFile 
    ::  File
newFile
  = File{contentType = Core.Nothing, relativePath = Core.Nothing,
         url = Core.Nothing}
instance Core.FromJSON File where
        parseJSON
          = Core.withObject "File"
              (\ o ->
                 File Core.<$>
                   (o Core..:? "contentType") Core.<*> (o Core..:? "relativePath")
                     Core.<*> (o Core..:? "url"))
...
newFormat 
    ::  Format
newFormat
  = Format{formatComplexity = Core.Nothing,
           formatType = Core.Nothing, resources = Core.Nothing,
           root = Core.Nothing}
instance Core.FromJSON Format where
        parseJSON
          = Core.withObject "Format"
              (\ o ->
                 Format Core.<$>
                   (o Core..:? "formatComplexity") Core.<*> (o Core..:? "formatType")
...
instance Core.ToJSON Format where
        toJSON Format{..}
          = Core.object
              (Core.catMaybes
                 [("formatComplexity" Core..=) Core.<$> formatComplexity,
...
newFormatComplexity 
    ::  FormatComplexity
newFormatComplexity
  = FormatComplexity{lodHint = Core.Nothing,
                     triangleCount = Core.Nothing}
instance Core.FromJSON FormatComplexity where
        parseJSON
          = Core.withObject "FormatComplexity"
              (\ o ->
                 FormatComplexity Core.<$>
                   (o Core..:? "lodHint") Core.<*>
                     (o Core..:? "triangleCount" Core.<&> Core.fmap Core.fromAsText))
          ...
          = Core.object
              (Core.catMaybes
                 [("lodHint" Core..=) Core.<$> lodHint,
                  ("triangleCount" Core..=) Core.. Core.AsText Core.<$>
                    triangleCount])
...
newImageError 
    ::  ImageError
newImageError
  = ImageError{code = Core.Nothing, filePath = Core.Nothing}
instance Core.FromJSON ImageError where
        parseJSON
          = Core.withObject "ImageError"
              (\ o ->
                 ImageError Core.<$>
                   (o Core..:? "code") Core.<*> (o Core..:? "filePath"))
...
newListAssetsResponse 
    ::  ListAssetsResponse
newListAssetsResponse
  = ListAssetsResponse{assets = Core.Nothing,
          ...
          = Core.withObject "ListAssetsResponse"
              (\ o ->
                 ListAssetsResponse Core.<$>
                   (o Core..:? "assets") Core.<*> (o Core..:? "nextPageToken")
...
newListLikedAssetsResponse 
    ::  ListLikedAssetsResponse
newListLikedAssetsResponse
  = ListLikedAssetsResponse{assets = Core.Nothing,
                            nextPageToken = Core.Nothing, totalSize = Core.Nothing}
instance Core.FromJSON ListLikedAssetsResponse where
        parseJSON
          = Core.withObject "ListLikedAssetsResponse"
              (\ o ->
                 ListLikedAssetsResponse Core.<$>
                   (o Core..:? "assets") Core.<*> (o Core..:? "nextPageToken")
                     Core.<*> (o Core..:? "totalSize"))
...
newListUserAssetsResponse 
    ::  ListUserAssetsResponse
newListUserAssetsResponse
  = ListUserAssetsResponse{nextPageToken = Core.Nothing,
                           totalSize = Core.Nothing, userAssets = Core.Nothing}
instance Core.FromJSON ListUserAssetsResponse where
        parseJSON
          = Core.withObject "ListUserAssetsResponse"
              (\ o ->
                 ListUserAssetsResponse Core.<$>
...
newObjParseError 
    ::  ObjParseError
newObjParseError
  = ObjParseError{code = Core.Nothing, endIndex = Core.Nothing,
                  filePath = Core.Nothing, line = Core.Nothing,
                  lineNumber = Core.Nothing, startIndex = Core.Nothing}
instance Core.FromJSON ObjParseError where
        parseJSON
          = Core.withObject "ObjParseError"
              (\ o ->
                 ObjParseError Core.<$>
                   (o Core..:? "code") Core.<*> (o Core..:? "endIndex") Core.<*>
                     (o Core..:? "filePath")
                     Core.<*> (o Core..:? "line")
...
newPresentationParams 
    ::  PresentationParams
newPresentationParams
  = PresentationParams{backgroundColor = Core.Nothing,
                       colorSpace = Core.Nothing, orientingRotation = Core.Nothing}
instance Core.FromJSON PresentationParams where
        parseJSON
          = Core.withObject "PresentationParams"
              (\ o ->
                 PresentationParams Core.<$>
                   (o Core..:? "backgroundColor") Core.<*> (o Core..:? "colorSpace")
          ...
          = Core.object
              (Core.catMaybes
                 [("backgroundColor" Core..=) Core.<$> backgroundColor,
                  ...
                  ("orientingRotation" Core..=) Core.<$> orientingRotation])
...
newQuaternion 
    ::  Quaternion
newQuaternion
  = Quaternion{w = Core.Nothing, x = Core.Nothing, y = Core.Nothing,
               z = Core.Nothing}
instance Core.FromJSON Quaternion where
        parseJSON
          = Core.withObject "Quaternion"
              (\ o ->
                 Quaternion Core.<$>
                   (o Core..:? "w") Core.<*> (o Core..:? "x") Core.<*>
                     (o Core..:? "y")
                     Core.<*> (o Core..:? "z"))
...
instance Core.ToJSON Quaternion where
        toJSON Quaternion{..}
          = Core.object
              (Core.catMaybes
                 [("w" Core..=) Core.<$> w, ("x" Core..=) Core.<$> x,
                  ("y" Core..=) Core.<$> y, ("z" Core..=) Core.<$> z])
...
instance Core.FromJSON RemixInfo where
        parseJSON
          = Core.withObject "RemixInfo"
              (\ o -> RemixInfo Core.<$> (o Core..:? "sourceAsset"))

instance Core.ToJSON RemixInfo where
        toJSON RemixInfo{..}
          = Core.object
              (Core.catMaybes [("sourceAsset" Core..=) Core.<$> sourceAsset])
...
newStartAssetImportResponse 
    ::  StartAssetImportResponse
newStartAssetImportResponse
  = StartAssetImportResponse{assetId = Core.Nothing,
                             assetImportId = Core.Nothing, assetImportMessages = Core.Nothing,
                             publishUrl = Core.Nothing}
instance Core.FromJSON StartAssetImportResponse where
        parseJSON
          = Core.withObject "StartAssetImportResponse"
              (\ o ->
                 StartAssetImportResponse Core.<$>
                   (o Core..:? "assetId") Core.<*> (o Core..:? "assetImportId")
          ...
          = Core.object
              (Core.catMaybes
                 [("assetId" Core..=) Core.<$> assetId,
                  ...
                  ("assetImportMessages" Core..=) Core.<$> assetImportMessages,
...
instance Core.FromJSON UserAsset where
        parseJSON
          = Core.withObject "UserAsset"
              (\ o -> UserAsset Core.<$> (o Core..:? "asset"))

instance Core.ToJSON UserAsset where
        toJSON UserAsset{..}
          = Core.object (Core.catMaybes [("asset" Core..=) Core.<$> asset])
