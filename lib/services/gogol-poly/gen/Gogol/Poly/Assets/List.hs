                 ...
                 Core.QueryParam "curated" Core.Bool Core.:>
                   Core.QueryParam "format" Core.Text Core.:>
                     Core.QueryParam "keywords" Core.Text Core.:>
                       Core.QueryParam "maxComplexity" AssetsListMaxComplexity Core.:>
...
newPolyAssetsList 
    ::  PolyAssetsList
newPolyAssetsList
  = PolyAssetsList{xgafv = Core.Nothing, accessToken = Core.Nothing,
                   callback = Core.Nothing, category = Core.Nothing,
                   curated = Core.Nothing, format = Core.Nothing,
                   keywords = Core.Nothing, maxComplexity = Core.Nothing,
...
instance Core.GoogleRequest PolyAssetsList where
        ...
        requestClient PolyAssetsList{..}
          = go xgafv accessToken callback category curated format keywords
              maxComplexity
              orderBy
              pageSize
              pageToken
