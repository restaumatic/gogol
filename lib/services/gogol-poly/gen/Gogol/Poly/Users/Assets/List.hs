                       ...
                       Core.QueryParam "pageToken" Core.Text Core.:>
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "visibility" UsersAssetsListVisibility Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.Get '[Core.JSON] ListUserAssetsResponse
...
newPolyUsersAssetsList name
  = PolyUsersAssetsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest PolyUsersAssetsList where
        ...
        requestClient PolyUsersAssetsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy PolyUsersAssetsListResource)
                      Core.mempty
