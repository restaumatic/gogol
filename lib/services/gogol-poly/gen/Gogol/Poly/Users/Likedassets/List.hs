                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Get '[Core.JSON] ListLikedAssetsResponse
...
newPolyUsersLikedassetsList name
  = PolyUsersLikedassetsList{xgafv = Core.Nothing,
                             accessToken = Core.Nothing, callback = Core.Nothing,
                             format = Core.Nothing, name = name, orderBy = Core.Nothing,
...
instance Core.GoogleRequest PolyUsersLikedassetsList where
        type Rs PolyUsersLikedassetsList = ListLikedAssetsResponse
        type Scopes PolyUsersLikedassetsList = '[]
        requestClient PolyUsersLikedassetsList{..}
          = go name xgafv accessToken callback format orderBy pageSize
              pageToken
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy PolyUsersLikedassetsListResource)
                      Core.mempty
