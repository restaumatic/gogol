...
type PeoplePeopleSearchDirectoryPeopleResource =
     "v1" Core.:>
       "people:searchDirectoryPeople" Core.:>
                   ...
                   Core.QueryParam "pageToken" Core.Text Core.:>
                     Core.QueryParam "query" Core.Text Core.:>
                       Core.QueryParam "readMask" Core.FieldMask Core.:>
                         Core.QueryParams "sources" PeopleSearchDirectoryPeopleSources
                           Core.:>
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.Get '[Core.JSON] SearchDirectoryPeopleResponse
...
newPeoplePeopleSearchDirectoryPeople 
    :: 
                                     PeoplePeopleSearchDirectoryPeople
newPeoplePeopleSearchDirectoryPeople
  = PeoplePeopleSearchDirectoryPeople{xgafv = Core.Nothing,
...
instance Core.GoogleRequest PeoplePeopleSearchDirectoryPeople where
        type Rs PeoplePeopleSearchDirectoryPeople =
             SearchDirectoryPeopleResponse
        type Scopes PeoplePeopleSearchDirectoryPeople =
             '[Directory'Readonly]
