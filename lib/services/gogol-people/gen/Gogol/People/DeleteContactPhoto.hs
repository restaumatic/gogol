...
type PeoplePeopleDeleteContactPhotoResource =
     "v1" Core.:>
       Core.CaptureMode "resourceName" "deleteContactPhoto" Core.Text
         Core.:>
         Core.QueryParam "$.xgafv" Xgafv Core.:>
           Core.QueryParam "access_token" Core.Text Core.:>
             Core.QueryParam "callback" Core.Text Core.:>
               Core.QueryParam "personFields" Core.FieldMask Core.:>
                 Core.QueryParams "sources" PeopleDeleteContactPhotoSources Core.:>
...
newPeoplePeopleDeleteContactPhoto resourceName
  = PeoplePeopleDeleteContactPhoto{xgafv = Core.Nothing,
                                   accessToken = Core.Nothing, callback = Core.Nothing,
                                   personFields = Core.Nothing, resourceName = resourceName,
                                   sources = Core.Nothing, uploadType = Core.Nothing,
