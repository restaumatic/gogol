...
newPeopleOtherContactsSearch 
    ::  PeopleOtherContactsSearch
newPeopleOtherContactsSearch
  = PeopleOtherContactsSearch{xgafv = Core.Nothing,
                              accessToken = Core.Nothing, callback = Core.Nothing,
                              pageSize = Core.Nothing, query = Core.Nothing,
                              readMask = Core.Nothing, uploadType = Core.Nothing,
...
instance Core.GoogleRequest PeopleOtherContactsSearch where
        ...
        requestClient PeopleOtherContactsSearch{..}
          = go xgafv accessToken callback pageSize query readMask uploadType
              uploadProtocol
