...
type PeopleOtherContactsCopyOtherContactToMyContactsGroupResource =
     "v1" Core.:>
       Core.CaptureMode "resourceName" "copyOtherContactToMyContactsGroup"
         Core.Text
         Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] CopyOtherContactToMyContactsGroupRequest
...
newPeopleOtherContactsCopyOtherContactToMyContactsGroup 
    ...
    -> PeopleOtherContactsCopyOtherContactToMyContactsGroup
newPeopleOtherContactsCopyOtherContactToMyContactsGroup payload
  resourceName
  = PeopleOtherContactsCopyOtherContactToMyContactsGroup{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           PeopleOtherContactsCopyOtherContactToMyContactsGroup
         where
        type Rs PeopleOtherContactsCopyOtherContactToMyContactsGroup =
             Person
        type Scopes PeopleOtherContactsCopyOtherContactToMyContactsGroup =
