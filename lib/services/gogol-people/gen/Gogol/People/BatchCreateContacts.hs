...
type PeoplePeopleBatchCreateContactsResource =
     "v1" Core.:>
       "people:batchCreateContacts" Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] BatchCreateContactsRequest Core.:>
                       Core.Post '[Core.JSON] BatchCreateContactsResponse
...
newPeoplePeopleBatchCreateContacts payload
  = PeoplePeopleBatchCreateContacts{xgafv = Core.Nothing,
                                    accessToken = Core.Nothing, callback = Core.Nothing,
                                    payload = payload, uploadType = Core.Nothing,
                                    uploadProtocol = Core.Nothing}
instance Core.GoogleRequest PeoplePeopleBatchCreateContacts where
        type Rs PeoplePeopleBatchCreateContacts =
             BatchCreateContactsResponse
        type Scopes PeoplePeopleBatchCreateContacts =
