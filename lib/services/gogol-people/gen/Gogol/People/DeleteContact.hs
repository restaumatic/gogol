...
type PeoplePeopleDeleteContactResource =
     "v1" Core.:>
       Core.CaptureMode "resourceName" "deleteContact" Core.Text Core.:>
...
newPeoplePeopleDeleteContact resourceName
  = PeoplePeopleDeleteContact{xgafv = Core.Nothing,
...
instance Core.GoogleRequest PeoplePeopleDeleteContact where
        ...
        type Scopes PeoplePeopleDeleteContact = '[Contacts'FullControl]
        requestClient PeoplePeopleDeleteContact{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy PeoplePeopleDeleteContactResource)
                      Core.mempty
