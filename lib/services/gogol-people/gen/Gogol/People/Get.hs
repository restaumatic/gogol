...
newPeoplePeopleGet resourceName
  = PeoplePeopleGet{xgafv = Core.Nothing, accessToken = Core.Nothing,
                    callback = Core.Nothing, personFields = Core.Nothing,
...
instance Core.GoogleRequest PeoplePeopleGet where
        ...
        type Scopes PeoplePeopleGet =
             '[Contacts'FullControl, Contacts'Other'Readonly, Contacts'Readonly,
               Directory'Readonly, User'Addresses'Read, User'Birthday'Read,
               User'Emails'Read, User'Gender'Read, User'Organization'Read,
               User'Phonenumbers'Read, Userinfo'Email, Userinfo'Profile]
