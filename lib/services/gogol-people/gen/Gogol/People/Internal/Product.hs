...
newAddress 
    ::  Address
newAddress
  = Address{city = Core.Nothing, country = Core.Nothing,
            countryCode = Core.Nothing, extendedAddress = Core.Nothing,
            formattedType = Core.Nothing, formattedValue = Core.Nothing,
            metadata = Core.Nothing, poBox = Core.Nothing,
            postalCode = Core.Nothing, region = Core.Nothing,
            streetAddress = Core.Nothing, type' = Core.Nothing}
instance Core.FromJSON Address where
        parseJSON
          = Core.withObject "Address"
              (\ o ->
                 Address Core.<$>
                   (o Core..:? "city") Core.<*> (o Core..:? "country") Core.<*>
                     (o Core..:? "countryCode")
...
instance Core.FromJSON AgeRangeType where
        parseJSON
          = Core.withObject "AgeRangeType"
              (\ o ->
                 AgeRangeType Core.<$>
                   (o Core..:? "ageRange") Core.<*> (o Core..:? "metadata"))
...
newBatchCreateContactsRequest 
    ::  BatchCreateContactsRequest
newBatchCreateContactsRequest
  = BatchCreateContactsRequest{contacts = Core.Nothing,
                               readMask = Core.Nothing, sources = Core.Nothing}
instance Core.FromJSON BatchCreateContactsRequest where
        parseJSON
          = Core.withObject "BatchCreateContactsRequest"
              (\ o ->
                 BatchCreateContactsRequest Core.<$>
                   (o Core..:? "contacts") Core.<*> (o Core..:? "readMask") Core.<*>
                     (o Core..:? "sources"))
...
instance Core.FromJSON BatchCreateContactsResponse where
        parseJSON
          = Core.withObject "BatchCreateContactsResponse"
              (\ o ->
                 BatchCreateContactsResponse Core.<$> (o Core..:? "createdPeople"))

instance Core.ToJSON BatchCreateContactsResponse where
        toJSON BatchCreateContactsResponse{..}
          = Core.object
              (Core.catMaybes [("createdPeople" Core..=) Core.<$> createdPeople])
...
instance Core.FromJSON BatchDeleteContactsRequest where
        parseJSON
          = Core.withObject "BatchDeleteContactsRequest"
              (\ o ->
                 BatchDeleteContactsRequest Core.<$> (o Core..:? "resourceNames"))
...
instance Core.FromJSON BatchGetContactGroupsResponse where
        parseJSON
          = Core.withObject "BatchGetContactGroupsResponse"
              (\ o ->
                 BatchGetContactGroupsResponse Core.<$> (o Core..:? "responses"))
...
newBatchUpdateContactsRequest 
    ::  BatchUpdateContactsRequest
newBatchUpdateContactsRequest
  = BatchUpdateContactsRequest{contacts = Core.Nothing,
                               readMask = Core.Nothing, sources = Core.Nothing,
                               updateMask = Core.Nothing}
instance Core.FromJSON BatchUpdateContactsRequest where
        parseJSON
          = Core.withObject "BatchUpdateContactsRequest"
              (\ o ->
                 BatchUpdateContactsRequest Core.<$>
                   (o Core..:? "contacts") Core.<*> (o Core..:? "readMask") Core.<*>
                     (o Core..:? "sources")
...
instance Core.FromJSON BatchUpdateContactsRequest_Contacts where
        parseJSON
          = Core.withObject "BatchUpdateContactsRequest_Contacts"
              (\ o ->
                 BatchUpdateContactsRequest_Contacts Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON BatchUpdateContactsRequest_Contacts where
...
instance Core.FromJSON BatchUpdateContactsResponse where
        parseJSON
          = Core.withObject "BatchUpdateContactsResponse"
              (\ o ->
                 BatchUpdateContactsResponse Core.<$> (o Core..:? "updateResult"))

instance Core.ToJSON BatchUpdateContactsResponse where
        toJSON BatchUpdateContactsResponse{..}
          = Core.object
              (Core.catMaybes [("updateResult" Core..=) Core.<$> updateResult])
...
instance Core.FromJSON BatchUpdateContactsResponse_UpdateResult
         where
        parseJSON
          = Core.withObject "BatchUpdateContactsResponse_UpdateResult"
              (\ o ->
                 BatchUpdateContactsResponse_UpdateResult Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON BatchUpdateContactsResponse_UpdateResult where
...
newBiography 
    ::  Biography
newBiography
  = Biography{contentType = Core.Nothing, metadata = Core.Nothing,
              value = Core.Nothing}
instance Core.FromJSON Biography where
        parseJSON
          = Core.withObject "Biography"
              (\ o ->
                 Biography Core.<$>
                   (o Core..:? "contentType") Core.<*> (o Core..:? "metadata")
                     Core.<*> (o Core..:? "value"))
...
newBirthday 
    ::  Birthday
newBirthday
  = Birthday{date = Core.Nothing, metadata = Core.Nothing,
             text = Core.Nothing}
instance Core.FromJSON Birthday where
        parseJSON
          = Core.withObject "Birthday"
              (\ o ->
                 Birthday Core.<$>
                   (o Core..:? "date") Core.<*> (o Core..:? "metadata") Core.<*>
                     (o Core..:? "text"))
...
instance Core.FromJSON BraggingRights where
        parseJSON
          = Core.withObject "BraggingRights"
              (\ o ->
                 BraggingRights Core.<$>
                   (o Core..:? "metadata") Core.<*> (o Core..:? "value"))
...
newCalendarUrl 
    ::  CalendarUrl
newCalendarUrl
  = CalendarUrl{formattedType = Core.Nothing,
                metadata = Core.Nothing, type' = Core.Nothing, url = Core.Nothing}
instance Core.FromJSON CalendarUrl where
        parseJSON
          = Core.withObject "CalendarUrl"
              (\ o ->
                 CalendarUrl Core.<$>
                   (o Core..:? "formattedType") Core.<*> (o Core..:? "metadata")
                     Core.<*> (o Core..:? "type")
                     Core.<*> (o Core..:? "url"))
...
newClientData 
    ::  ClientData
newClientData
  = ClientData{key = Core.Nothing, metadata = Core.Nothing,
               value = Core.Nothing}
instance Core.FromJSON ClientData where
        parseJSON
          = Core.withObject "ClientData"
              (\ o ->
                 ClientData Core.<$>
                   (o Core..:? "key") Core.<*> (o Core..:? "metadata") Core.<*>
                     (o Core..:? "value"))
...
newContactGroup 
    ::  ContactGroup
newContactGroup
  = ContactGroup{clientData = Core.Nothing, etag = Core.Nothing,
                 formattedName = Core.Nothing, groupType = Core.Nothing,
                 memberCount = Core.Nothing, memberResourceNames = Core.Nothing,
                 metadata = Core.Nothing, name = Core.Nothing,
                 resourceName = Core.Nothing}
instance Core.FromJSON ContactGroup where
        parseJSON
          = Core.withObject "ContactGroup"
              (\ o ->
                 ContactGroup Core.<$>
                   (o Core..:? "clientData") Core.<*> (o Core..:? "etag") Core.<*>
                     (o Core..:? "formattedName")
          ...
          = Core.object
              (Core.catMaybes
                 [("clientData" Core..=) Core.<$> clientData,
                  ...
                  ("memberResourceNames" Core..=) Core.<$> memberResourceNames,
                  ("metadata" Core..=) Core.<$> metadata,
                  ("name" Core..=) Core.<$> name,
...
newContactGroupMembership 
    ::  ContactGroupMembership
newContactGroupMembership
  = ContactGroupMembership{contactGroupId = Core.Nothing,
                           contactGroupResourceName = Core.Nothing}
instance Core.FromJSON ContactGroupMembership where
        parseJSON
          = Core.withObject "ContactGroupMembership"
              (\ o ->
                 ContactGroupMembership Core.<$>
                   (o Core..:? "contactGroupId") Core.<*>
                     (o Core..:? "contactGroupResourceName"))
          ...
          = Core.object
              (Core.catMaybes
                 [("contactGroupId" Core..=) Core.<$> contactGroupId,
                  ("contactGroupResourceName" Core..=) Core.<$>
...
newContactGroupMetadata 
    ::  ContactGroupMetadata
newContactGroupMetadata
  = ContactGroupMetadata{deleted = Core.Nothing,
                         updateTime = Core.Nothing}
instance Core.FromJSON ContactGroupMetadata where
        parseJSON
          = Core.withObject "ContactGroupMetadata"
              (\ o ->
                 ContactGroupMetadata Core.<$>
                   (o Core..:? "deleted") Core.<*> (o Core..:? "updateTime"))
...
newContactGroupResponse 
    ::  ContactGroupResponse
newContactGroupResponse
  = ContactGroupResponse{contactGroup = Core.Nothing,
                         requestedResourceName = Core.Nothing, status = Core.Nothing}
instance Core.FromJSON ContactGroupResponse where
        parseJSON
          = Core.withObject "ContactGroupResponse"
              (\ o ->
                 ContactGroupResponse Core.<$>
                   (o Core..:? "contactGroup") Core.<*>
                     (o Core..:? "requestedResourceName")
                     Core.<*> (o Core..:? "status"))
...
instance Core.FromJSON ContactToCreate where
        parseJSON
          = Core.withObject "ContactToCreate"
              (\ o -> ContactToCreate Core.<$> (o Core..:? "contactPerson"))

instance Core.ToJSON ContactToCreate where
        toJSON ContactToCreate{..}
          = Core.object
              (Core.catMaybes [("contactPerson" Core..=) Core.<$> contactPerson])
...
newCopyOtherContactToMyContactsGroupRequest 
    :: 
                                            CopyOtherContactToMyContactsGroupRequest
newCopyOtherContactToMyContactsGroupRequest
  = CopyOtherContactToMyContactsGroupRequest{copyMask = Core.Nothing,
                                             readMask = Core.Nothing, sources = Core.Nothing}
instance Core.FromJSON CopyOtherContactToMyContactsGroupRequest
         where
        parseJSON
          = Core.withObject "CopyOtherContactToMyContactsGroupRequest"
              (\ o ->
                 CopyOtherContactToMyContactsGroupRequest Core.<$>
                   (o Core..:? "copyMask") Core.<*> (o Core..:? "readMask") Core.<*>
                     (o Core..:? "sources"))

instance Core.ToJSON CopyOtherContactToMyContactsGroupRequest where
...
newCoverPhoto 
    ::  CoverPhoto
newCoverPhoto
  = CoverPhoto{default' = Core.Nothing, metadata = Core.Nothing,
               url = Core.Nothing}
instance Core.FromJSON CoverPhoto where
        parseJSON
          = Core.withObject "CoverPhoto"
              (\ o ->
                 CoverPhoto Core.<$>
                   (o Core..:? "default") Core.<*> (o Core..:? "metadata") Core.<*>
                     (o Core..:? "url"))
...
newCreateContactGroupRequest 
    ::  CreateContactGroupRequest
newCreateContactGroupRequest
  = CreateContactGroupRequest{contactGroup = Core.Nothing,
                              readGroupFields = Core.Nothing}
instance Core.FromJSON CreateContactGroupRequest where
        parseJSON
          = Core.withObject "CreateContactGroupRequest"
              (\ o ->
                 CreateContactGroupRequest Core.<$>
                   (o Core..:? "contactGroup") Core.<*>
                     (o Core..:? "readGroupFields"))
...
instance Core.FromJSON DeleteContactPhotoResponse where
        parseJSON
          = Core.withObject "DeleteContactPhotoResponse"
              (\ o -> DeleteContactPhotoResponse Core.<$> (o Core..:? "person"))
...
newDomainMembership 
    ::  DomainMembership
newDomainMembership
  = DomainMembership{inViewerDomain = Core.Nothing}
instance Core.FromJSON DomainMembership where
        parseJSON
          = Core.withObject "DomainMembership"
              (\ o -> DomainMembership Core.<$> (o Core..:? "inViewerDomain"))
...
newEmailAddress 
    ::  EmailAddress
newEmailAddress
  = EmailAddress{displayName = Core.Nothing,
                 formattedType = Core.Nothing, metadata = Core.Nothing,
...
instance Core.FromJSON EmailAddress where
        parseJSON
          = Core.withObject "EmailAddress"
              (\ o ->
                 EmailAddress Core.<$>
                   (o Core..:? "displayName") Core.<*> (o Core..:? "formattedType")
                     Core.<*> (o Core..:? "metadata")
                     Core.<*> (o Core..:? "type")
                     Core.<*> (o Core..:? "value"))
...
newEvent 
    ::  Event
newEvent
  = Event{date = Core.Nothing, formattedType = Core.Nothing,
          metadata = Core.Nothing, type' = Core.Nothing}
instance Core.FromJSON Event where
        parseJSON
          = Core.withObject "Event"
              (\ o ->
                 Event Core.<$>
                   (o Core..:? "date") Core.<*> (o Core..:? "formattedType") Core.<*>
                     (o Core..:? "metadata")
                     Core.<*> (o Core..:? "type"))
...
newExternalId 
    ::  ExternalId
newExternalId
  = ExternalId{formattedType = Core.Nothing, metadata = Core.Nothing,
               type' = Core.Nothing, value = Core.Nothing}
instance Core.FromJSON ExternalId where
        parseJSON
          = Core.withObject "ExternalId"
              (\ o ->
                 ExternalId Core.<$>
                   (o Core..:? "formattedType") Core.<*> (o Core..:? "metadata")
                     Core.<*> (o Core..:? "type")
...
newFieldMetadata 
    ::  FieldMetadata
newFieldMetadata
  = FieldMetadata{primary = Core.Nothing, source = Core.Nothing,
                  sourcePrimary = Core.Nothing, verified = Core.Nothing}
instance Core.FromJSON FieldMetadata where
        parseJSON
          = Core.withObject "FieldMetadata"
              (\ o ->
                 FieldMetadata Core.<$>
                   (o Core..:? "primary") Core.<*> (o Core..:? "source") Core.<*>
                     (o Core..:? "sourcePrimary")
...
newGender 
    ::  Gender
newGender
  = Gender{addressMeAs = Core.Nothing, formattedValue = Core.Nothing,
           metadata = Core.Nothing, value = Core.Nothing}
instance Core.FromJSON Gender where
        parseJSON
          = Core.withObject "Gender"
              (\ o ->
                 Gender Core.<$>
                   (o Core..:? "addressMeAs") Core.<*> (o Core..:? "formattedValue")
                     Core.<*> (o Core..:? "metadata")
                     Core.<*> (o Core..:? "value"))
...
instance Core.FromJSON GetPeopleResponse where
        parseJSON
          = Core.withObject "GetPeopleResponse"
              (\ o -> GetPeopleResponse Core.<$> (o Core..:? "responses"))
...
newGroupClientData 
    ::  GroupClientData
newGroupClientData
  = GroupClientData{key = Core.Nothing, value = Core.Nothing}
instance Core.FromJSON GroupClientData where
        parseJSON
          = Core.withObject "GroupClientData"
              (\ o ->
                 GroupClientData Core.<$>
...
newImClient 
    ::  ImClient
newImClient
  = ImClient{formattedProtocol = Core.Nothing,
             formattedType = Core.Nothing, metadata = Core.Nothing,
             protocol = Core.Nothing, type' = Core.Nothing,
             username = Core.Nothing}
instance Core.FromJSON ImClient where
        parseJSON
          = Core.withObject "ImClient"
              (\ o ->
                 ImClient Core.<$>
                   (o Core..:? "formattedProtocol") Core.<*>
                     (o Core..:? "formattedType")
                     Core.<*> (o Core..:? "metadata")
...
instance Core.ToJSON ImClient where
        toJSON ImClient{..}
          = Core.object
              (Core.catMaybes
                 [("formattedProtocol" Core..=) Core.<$> formattedProtocol,
                  ("formattedType" Core..=) Core.<$> formattedType,
                  ("metadata" Core..=) Core.<$> metadata,
...
newInterest 
    ::  Interest
newInterest
  = Interest{metadata = Core.Nothing, value = Core.Nothing}
instance Core.FromJSON Interest where
        parseJSON
          = Core.withObject "Interest"
              (\ o ->
                 Interest Core.<$>
                   (o Core..:? "metadata") Core.<*> (o Core..:? "value"))
...
newListConnectionsResponse
  = ListConnectionsResponse{connections = Core.Nothing,
                            nextPageToken = Core.Nothing, nextSyncToken = Core.Nothing,
                            totalItems = Core.Nothing, totalPeople = Core.Nothing}
...
newListContactGroupsResponse 
    ::  ListContactGroupsResponse
newListContactGroupsResponse
  = ListContactGroupsResponse{contactGroups = Core.Nothing,
                              nextPageToken = Core.Nothing, nextSyncToken = Core.Nothing,
                              totalItems = Core.Nothing}
instance Core.FromJSON ListContactGroupsResponse where
        parseJSON
          = Core.withObject "ListContactGroupsResponse"
              (\ o ->
                 ListContactGroupsResponse Core.<$>
                   (o Core..:? "contactGroups") Core.<*> (o Core..:? "nextPageToken")
                     Core.<*> (o Core..:? "nextSyncToken")
                     Core.<*> (o Core..:? "totalItems"))
...
newListDirectoryPeopleResponse 
    ::  ListDirectoryPeopleResponse
newListDirectoryPeopleResponse
  = ListDirectoryPeopleResponse{nextPageToken = Core.Nothing,
                                nextSyncToken = Core.Nothing, people = Core.Nothing}
instance Core.FromJSON ListDirectoryPeopleResponse where
        parseJSON
          = Core.withObject "ListDirectoryPeopleResponse"
              (\ o ->
                 ListDirectoryPeopleResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "nextSyncToken")
                     Core.<*> (o Core..:? "people"))
...
newListOtherContactsResponse 
    ::  ListOtherContactsResponse
newListOtherContactsResponse
  = ListOtherContactsResponse{nextPageToken = Core.Nothing,
                              nextSyncToken = Core.Nothing, otherContacts = Core.Nothing,
                              totalSize = Core.Nothing}
instance Core.FromJSON ListOtherContactsResponse where
        parseJSON
          = Core.withObject "ListOtherContactsResponse"
              (\ o ->
                 ListOtherContactsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "nextSyncToken")
...
newLocation 
    ::  Location
newLocation
  = Location{buildingId = Core.Nothing, current = Core.Nothing,
             deskCode = Core.Nothing, floor = Core.Nothing,
             floorSection = Core.Nothing, metadata = Core.Nothing,
             type' = Core.Nothing, value = Core.Nothing}
instance Core.FromJSON Location where
        parseJSON
          = Core.withObject "Location"
              (\ o ->
                 Location Core.<$>
                   (o Core..:? "buildingId") Core.<*> (o Core..:? "current") Core.<*>
                     (o Core..:? "deskCode")
                     Core.<*> (o Core..:? "floor")
...
newMembership 
    ::  Membership
newMembership
  = Membership{contactGroupMembership = Core.Nothing,
               domainMembership = Core.Nothing, metadata = Core.Nothing}
instance Core.FromJSON Membership where
        parseJSON
          = Core.withObject "Membership"
              (\ o ->
                 Membership Core.<$>
                   (o Core..:? "contactGroupMembership") Core.<*>
                     (o Core..:? "domainMembership")
                     Core.<*> (o Core..:? "metadata"))
...
instance Core.ToJSON Membership where
        toJSON Membership{..}
          = Core.object
              (Core.catMaybes
                 [("contactGroupMembership" Core..=) Core.<$>
                    contactGroupMembership,
                  ("domainMembership" Core..=) Core.<$> domainMembership,
                  ("metadata" Core..=) Core.<$> metadata])
...
newMiscKeyword 
    ::  MiscKeyword
newMiscKeyword
  = MiscKeyword{formattedType = Core.Nothing,
                metadata = Core.Nothing, type' = Core.Nothing,
                value = Core.Nothing}
instance Core.FromJSON MiscKeyword where
        parseJSON
          = Core.withObject "MiscKeyword"
              (\ o ->
                 MiscKeyword Core.<$>
                   (o Core..:? "formattedType") Core.<*> (o Core..:? "metadata")
                     Core.<*> (o Core..:? "type")
...
newModifyContactGroupMembersRequest 
    :: 
                                    ModifyContactGroupMembersRequest
newModifyContactGroupMembersRequest
  = ModifyContactGroupMembersRequest{resourceNamesToAdd =
                                       Core.Nothing,
                                     resourceNamesToRemove = Core.Nothing}
instance Core.FromJSON ModifyContactGroupMembersRequest where
        parseJSON
          = Core.withObject "ModifyContactGroupMembersRequest"
              (\ o ->
                 ModifyContactGroupMembersRequest Core.<$>
                   (o Core..:? "resourceNamesToAdd") Core.<*>
                     (o Core..:? "resourceNamesToRemove"))

instance Core.ToJSON ModifyContactGroupMembersRequest where
        toJSON ModifyContactGroupMembersRequest{..}
          = Core.object
              (Core.catMaybes
                 [("resourceNamesToAdd" Core..=) Core.<$> resourceNamesToAdd,
                  ("resourceNamesToRemove" Core..=) Core.<$> resourceNamesToRemove])
...
newModifyContactGroupMembersResponse 
    :: 
                                     ModifyContactGroupMembersResponse
newModifyContactGroupMembersResponse
  = ModifyContactGroupMembersResponse{canNotRemoveLastContactGroupResourceNames
                                        = Core.Nothing,
                                      notFoundResourceNames = Core.Nothing}
instance Core.FromJSON ModifyContactGroupMembersResponse where
        parseJSON
          = Core.withObject "ModifyContactGroupMembersResponse"
              (\ o ->
                 ModifyContactGroupMembersResponse Core.<$>
                   (o Core..:? "canNotRemoveLastContactGroupResourceNames") Core.<*>
                     (o Core..:? "notFoundResourceNames"))

instance Core.ToJSON ModifyContactGroupMembersResponse where
        toJSON ModifyContactGroupMembersResponse{..}
          = Core.object
              (Core.catMaybes
                 [("canNotRemoveLastContactGroupResourceNames" Core..=) Core.<$>
                    canNotRemoveLastContactGroupResourceNames,
                  ("notFoundResourceNames" Core..=) Core.<$> notFoundResourceNames])
...
newName 
    ::  Name
newName
  = Name{displayName = Core.Nothing,
         displayNameLastFirst = Core.Nothing, familyName = Core.Nothing,
         givenName = Core.Nothing, honorificPrefix = Core.Nothing,
         honorificSuffix = Core.Nothing, metadata = Core.Nothing,
         middleName = Core.Nothing, phoneticFamilyName = Core.Nothing,
         phoneticFullName = Core.Nothing, phoneticGivenName = Core.Nothing,
         phoneticHonorificPrefix = Core.Nothing,
         phoneticHonorificSuffix = Core.Nothing,
         phoneticMiddleName = Core.Nothing, unstructuredName = Core.Nothing}
...
instance Core.ToJSON Name where
        toJSON Name{..}
          = Core.object
              (Core.catMaybes
                 [("displayName" Core..=) Core.<$> displayName,
                  ("displayNameLastFirst" Core..=) Core.<$> displayNameLastFirst,
                  ...
                  ("phoneticFamilyName" Core..=) Core.<$> phoneticFamilyName,
                  ("phoneticFullName" Core..=) Core.<$> phoneticFullName,
                  ("phoneticGivenName" Core..=) Core.<$> phoneticGivenName,
                  ("phoneticHonorificPrefix" Core..=) Core.<$>
                    phoneticHonorificPrefix,
                  ("phoneticHonorificSuffix" Core..=) Core.<$>
                    phoneticHonorificSuffix,
                  ("phoneticMiddleName" Core..=) Core.<$> phoneticMiddleName,
                  ("unstructuredName" Core..=) Core.<$> unstructuredName])
...
newNickname 
    ::  Nickname
newNickname
  = Nickname{metadata = Core.Nothing, type' = Core.Nothing,
             value = Core.Nothing}
instance Core.FromJSON Nickname where
        parseJSON
          = Core.withObject "Nickname"
              (\ o ->
                 Nickname Core.<$>
                   (o Core..:? "metadata") Core.<*> (o Core..:? "type") Core.<*>
                     (o Core..:? "value"))
...
newOccupation 
    ::  Occupation
newOccupation
  = Occupation{metadata = Core.Nothing, value = Core.Nothing}
instance Core.FromJSON Occupation where
        parseJSON
          = Core.withObject "Occupation"
              (\ o ->
                 Occupation Core.<$>
                   (o Core..:? "metadata") Core.<*> (o Core..:? "value"))
...
newOrganization 
    ::  Organization
newOrganization
  = Organization{costCenter = Core.Nothing, current = Core.Nothing,
                 department = Core.Nothing, domain = Core.Nothing,
                 endDate = Core.Nothing, formattedType = Core.Nothing,
                 fullTimeEquivalentMillipercent = Core.Nothing,
                 jobDescription = Core.Nothing, location = Core.Nothing,
                 metadata = Core.Nothing, name = Core.Nothing,
                 phoneticName = Core.Nothing, startDate = Core.Nothing,
                 symbol = Core.Nothing, title = Core.Nothing, type' = Core.Nothing}
instance Core.FromJSON Organization where
        parseJSON
          = Core.withObject "Organization"
              (\ o ->
                 Organization Core.<$>
                   (o Core..:? "costCenter") Core.<*> (o Core..:? "current") Core.<*>
                     (o Core..:? "department")
                     Core.<*> (o Core..:? "domain")
                     Core.<*> (o Core..:? "endDate")
                     Core.<*> (o Core..:? "formattedType")
          ...
          = Core.object
              (Core.catMaybes
                 [("costCenter" Core..=) Core.<$> costCenter,
                  ...
                  ("formattedType" Core..=) Core.<$> formattedType,
                  ("fullTimeEquivalentMillipercent" Core..=) Core.<$>
...
newPerson 
    ::  Person
newPerson
  = Person{addresses = Core.Nothing, ageRange = Core.Nothing,
           ageRanges = Core.Nothing, biographies = Core.Nothing,
           birthdays = Core.Nothing, braggingRights = Core.Nothing,
           calendarUrls = Core.Nothing, clientData = Core.Nothing,
           coverPhotos = Core.Nothing, emailAddresses = Core.Nothing,
           etag = Core.Nothing, events = Core.Nothing,
           externalIds = Core.Nothing, fileAses = Core.Nothing,
           genders = Core.Nothing, imClients = Core.Nothing,
           interests = Core.Nothing, locales = Core.Nothing,
           locations = Core.Nothing, memberships = Core.Nothing,
           metadata = Core.Nothing, miscKeywords = Core.Nothing,
           names = Core.Nothing, nicknames = Core.Nothing,
           occupations = Core.Nothing, organizations = Core.Nothing,
           phoneNumbers = Core.Nothing, photos = Core.Nothing,
           relations = Core.Nothing, relationshipInterests = Core.Nothing,
           relationshipStatuses = Core.Nothing, residences = Core.Nothing,
           resourceName = Core.Nothing, sipAddresses = Core.Nothing,
           skills = Core.Nothing, taglines = Core.Nothing,
           urls = Core.Nothing, userDefined = Core.Nothing}
instance Core.FromJSON Person where
        parseJSON
          = Core.withObject "Person"
              (\ o ->
                 Person Core.<$>
                   (o Core..:? "addresses") Core.<*> (o Core..:? "ageRange") Core.<*>
                     (o Core..:? "ageRanges")
          ...
          = Core.object
              (Core.catMaybes
                 [("addresses" Core..=) Core.<$> addresses,
                  ...
                  ("etag" Core..=) Core.<$> etag, ("events" Core..=) Core.<$> events,
                  ...
                  ("relationshipInterests" Core..=) Core.<$> relationshipInterests,
                  ("relationshipStatuses" Core..=) Core.<$> relationshipStatuses,
...
newPersonMetadata 
    ::  PersonMetadata
newPersonMetadata
  = PersonMetadata{deleted = Core.Nothing,
                   linkedPeopleResourceNames = Core.Nothing,
                   objectType = Core.Nothing, previousResourceNames = Core.Nothing,
                   sources = Core.Nothing}
instance Core.FromJSON PersonMetadata where
        parseJSON
          = Core.withObject "PersonMetadata"
              (\ o ->
                 PersonMetadata Core.<$>
                   (o Core..:? "deleted") Core.<*>
                     (o Core..:? "linkedPeopleResourceNames")
...
instance Core.ToJSON PersonMetadata where
        toJSON PersonMetadata{..}
          = Core.object
              (Core.catMaybes
                 [("deleted" Core..=) Core.<$> deleted,
                  ("linkedPeopleResourceNames" Core..=) Core.<$>
                    linkedPeopleResourceNames,
                  ("objectType" Core..=) Core.<$> objectType,
                  ("previousResourceNames" Core..=) Core.<$> previousResourceNames,
                  ("sources" Core..=) Core.<$> sources])
...
newPersonResponse 
    ::  PersonResponse
newPersonResponse
  = PersonResponse{httpStatusCode = Core.Nothing,
                   person = Core.Nothing, requestedResourceName = Core.Nothing,
                   status = Core.Nothing}
instance Core.FromJSON PersonResponse where
        parseJSON
          = Core.withObject "PersonResponse"
              (\ o ->
                 PersonResponse Core.<$>
                   (o Core..:? "httpStatusCode") Core.<*> (o Core..:? "person")
...
newPhoneNumber 
    ::  PhoneNumber
newPhoneNumber
  = PhoneNumber{canonicalForm = Core.Nothing,
                formattedType = Core.Nothing, metadata = Core.Nothing,
                type' = Core.Nothing, value = Core.Nothing}
instance Core.FromJSON PhoneNumber where
        parseJSON
          = Core.withObject "PhoneNumber"
              (\ o ->
                 PhoneNumber Core.<$>
                   (o Core..:? "canonicalForm") Core.<*> (o Core..:? "formattedType")
                     Core.<*> (o Core..:? "metadata")
                     Core.<*> (o Core..:? "type")
                     Core.<*> (o Core..:? "value"))
...
newPhoto 
    ::  Photo
newPhoto
  = Photo{default' = Core.Nothing, metadata = Core.Nothing,
          url = Core.Nothing}
...
newProfileMetadata 
    ::  ProfileMetadata
newProfileMetadata
  = ProfileMetadata{objectType = Core.Nothing,
                    userTypes = Core.Nothing}
instance Core.FromJSON ProfileMetadata where
        parseJSON
          = Core.withObject "ProfileMetadata"
              (\ o ->
                 ProfileMetadata Core.<$>
                   (o Core..:? "objectType") Core.<*> (o Core..:? "userTypes"))
...
newRelation 
    ::  Relation
newRelation
  = Relation{formattedType = Core.Nothing, metadata = Core.Nothing,
             person = Core.Nothing, type' = Core.Nothing}
instance Core.FromJSON Relation where
        parseJSON
          = Core.withObject "Relation"
              (\ o ->
                 Relation Core.<$>
                   (o Core..:? "formattedType") Core.<*> (o Core..:? "metadata")
                     Core.<*> (o Core..:? "person")
...
newRelationshipInterest 
    ::  RelationshipInterest
newRelationshipInterest
  = RelationshipInterest{formattedValue = Core.Nothing,
                         metadata = Core.Nothing, value = Core.Nothing}
instance Core.FromJSON RelationshipInterest where
        parseJSON
          = Core.withObject "RelationshipInterest"
              (\ o ->
                 RelationshipInterest Core.<$>
                   (o Core..:? "formattedValue") Core.<*> (o Core..:? "metadata")
                     Core.<*> (o Core..:? "value"))
...
newRelationshipStatus 
    ::  RelationshipStatus
newRelationshipStatus
  = RelationshipStatus{formattedValue = Core.Nothing,
                       metadata = Core.Nothing, value = Core.Nothing}
instance Core.FromJSON RelationshipStatus where
        parseJSON
          = Core.withObject "RelationshipStatus"
              (\ o ->
                 RelationshipStatus Core.<$>
                   (o Core..:? "formattedValue") Core.<*> (o Core..:? "metadata")
                     Core.<*> (o Core..:? "value"))
...
newResidence 
    ::  Residence
newResidence
  = Residence{current = Core.Nothing, metadata = Core.Nothing,
              value = Core.Nothing}
instance Core.FromJSON Residence where
        parseJSON
          = Core.withObject "Residence"
              (\ o ->
                 Residence Core.<$>
                   (o Core..:? "current") Core.<*> (o Core..:? "metadata") Core.<*>
                     (o Core..:? "value"))
...
newSearchDirectoryPeopleResponse 
    ::  SearchDirectoryPeopleResponse
newSearchDirectoryPeopleResponse
  = SearchDirectoryPeopleResponse{nextPageToken = Core.Nothing,
                                  people = Core.Nothing, totalSize = Core.Nothing}
instance Core.FromJSON SearchDirectoryPeopleResponse where
        parseJSON
          = Core.withObject "SearchDirectoryPeopleResponse"
              (\ o ->
                 SearchDirectoryPeopleResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "people")
                     Core.<*> (o Core..:? "totalSize"))
...
instance Core.FromJSON SearchResponse where
        parseJSON
          = Core.withObject "SearchResponse"
              (\ o -> SearchResponse Core.<$> (o Core..:? "results"))
...
newSipAddress 
    ::  SipAddress
newSipAddress
  = SipAddress{formattedType = Core.Nothing, metadata = Core.Nothing,
               type' = Core.Nothing, value = Core.Nothing}
instance Core.FromJSON SipAddress where
        parseJSON
          = Core.withObject "SipAddress"
              (\ o ->
                 SipAddress Core.<$>
                   (o Core..:? "formattedType") Core.<*> (o Core..:? "metadata")
                     Core.<*> (o Core..:? "type")
...
newSource 
    ::  Source
newSource
  = Source{etag = Core.Nothing, id = Core.Nothing,
           profileMetadata = Core.Nothing, type' = Core.Nothing,
           updateTime = Core.Nothing}
...
newUpdateContactGroupRequest 
    ::  UpdateContactGroupRequest
newUpdateContactGroupRequest
  = UpdateContactGroupRequest{contactGroup = Core.Nothing,
                              readGroupFields = Core.Nothing, updateGroupFields = Core.Nothing}
instance Core.FromJSON UpdateContactGroupRequest where
        parseJSON
          = Core.withObject "UpdateContactGroupRequest"
              (\ o ->
                 UpdateContactGroupRequest Core.<$>
                   (o Core..:? "contactGroup") Core.<*> (o Core..:? "readGroupFields")
        ...
        toJSON UpdateContactGroupRequest{..}
          = Core.object
              (Core.catMaybes
                 [("contactGroup" Core..=) Core.<$> contactGroup,
                  ("readGroupFields" Core..=) Core.<$> readGroupFields,
                  ("updateGroupFields" Core..=) Core.<$> updateGroupFields])
...
newUpdateContactPhotoRequest 
    ::  UpdateContactPhotoRequest
newUpdateContactPhotoRequest
  = UpdateContactPhotoRequest{personFields = Core.Nothing,
                              photoBytes = Core.Nothing, sources = Core.Nothing}
instance Core.FromJSON UpdateContactPhotoRequest where
        parseJSON
          = Core.withObject "UpdateContactPhotoRequest"
              (\ o ->
                 UpdateContactPhotoRequest Core.<$>
                   (o Core..:? "personFields") Core.<*> (o Core..:? "photoBytes")
                     Core.<*> (o Core..:? "sources"))
...
instance Core.FromJSON UpdateContactPhotoResponse where
        parseJSON
          = Core.withObject "UpdateContactPhotoResponse"
              (\ o -> UpdateContactPhotoResponse Core.<$> (o Core..:? "person"))
...
newUrl 
    ::  Url
newUrl
  = Url{formattedType = Core.Nothing, metadata = Core.Nothing,
        type' = Core.Nothing, value = Core.Nothing}
...
newUserDefined 
    ::  UserDefined
newUserDefined
  = UserDefined{key = Core.Nothing, metadata = Core.Nothing,
                value = Core.Nothing}
instance Core.FromJSON UserDefined where
        parseJSON
          = Core.withObject "UserDefined"
              (\ o ->
                 UserDefined Core.<$>
                   (o Core..:? "key") Core.<*> (o Core..:? "metadata") Core.<*>
                     (o Core..:? "value"))
