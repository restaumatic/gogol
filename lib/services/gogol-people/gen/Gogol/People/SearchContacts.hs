               ...
               Core.QueryParam "pageSize" Core.Int32 Core.:>
                 Core.QueryParam "query" Core.Text Core.:>
                   Core.QueryParam "readMask" Core.FieldMask Core.:>
                     Core.QueryParams "sources" PeopleSearchContactsSources Core.:>
...
newPeoplePeopleSearchContacts 
    ::  PeoplePeopleSearchContacts
newPeoplePeopleSearchContacts
  = PeoplePeopleSearchContacts{xgafv = Core.Nothing,
...
instance Core.GoogleRequest PeoplePeopleSearchContacts where
        ...
        type Scopes PeoplePeopleSearchContacts =
             '[Contacts'FullControl, Contacts'Readonly]
        requestClient PeoplePeopleSearchContacts{..}
          = go xgafv accessToken callback pageSize query readMask
