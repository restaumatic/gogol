                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] BatchGetContactGroupsResponse
...
newPeopleContactGroupsBatchGet 
    ::  PeopleContactGroupsBatchGet
newPeopleContactGroupsBatchGet
  = PeopleContactGroupsBatchGet{xgafv = Core.Nothing,
                                accessToken = Core.Nothing, callback = Core.Nothing,
                                groupFields = Core.Nothing, maxMembers = Core.Nothing,
                                resourceNames = Core.Nothing, uploadType = Core.Nothing,
                                uploadProtocol = Core.Nothing}
instance Core.GoogleRequest PeopleContactGroupsBatchGet where
        type Rs PeopleContactGroupsBatchGet = BatchGetContactGroupsResponse
        type Scopes PeopleContactGroupsBatchGet =
             '[Contacts'FullControl, Contacts'Readonly]
        requestClient PeopleContactGroupsBatchGet{..}
          = go xgafv accessToken callback groupFields maxMembers
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy PeopleContactGroupsBatchGetResource)
                      Core.mempty
