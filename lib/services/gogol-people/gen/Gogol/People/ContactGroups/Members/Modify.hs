                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] ModifyContactGroupMembersRequest Core.:>
                         Core.Post '[Core.JSON] ModifyContactGroupMembersResponse
...
newPeopleContactGroupsMembersModify payload resourceName
  = PeopleContactGroupsMembersModify{xgafv = Core.Nothing,
                                     accessToken = Core.Nothing, callback = Core.Nothing,
                                     payload = payload, resourceName = resourceName,
                                     uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest PeopleContactGroupsMembersModify where
        ...
        requestClient PeopleContactGroupsMembersModify{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy PeopleContactGroupsMembersModifyResource)
                      Core.mempty
