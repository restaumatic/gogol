               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] CreateContactGroupRequest Core.:>
                       Core.Post '[Core.JSON] ContactGroup
...
newPeopleContactGroupsCreate payload
  = PeopleContactGroupsCreate{xgafv = Core.Nothing,
                              accessToken = Core.Nothing, callback = Core.Nothing,
                              payload = payload, uploadType = Core.Nothing,
                              uploadProtocol = Core.Nothing}
instance Core.GoogleRequest PeopleContactGroupsCreate where
        type Rs PeopleContactGroupsCreate = ContactGroup
        type Scopes PeopleContactGroupsCreate = '[Contacts'FullControl]
        requestClient PeopleContactGroupsCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy PeopleContactGroupsCreateResource)
                      Core.mempty
