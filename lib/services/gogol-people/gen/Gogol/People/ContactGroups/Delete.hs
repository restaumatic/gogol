...
newPeopleContactGroupsDelete resourceName
  = PeopleContactGroupsDelete{xgafv = Core.Nothing,
                              accessToken = Core.Nothing, callback = Core.Nothing,
                              deleteContacts = Core.Nothing, resourceName = resourceName,
                              uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest PeopleContactGroupsDelete where
        type Rs PeopleContactGroupsDelete = Empty
        type Scopes PeopleContactGroupsDelete = '[Contacts'FullControl]
        requestClient PeopleContactGroupsDelete{..}
          = go resourceName xgafv accessToken callback deleteContacts
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy PeopleContactGroupsDeleteResource)
                      Core.mempty
