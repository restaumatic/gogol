                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] ListContactGroupsResponse
...
newPeopleContactGroupsList 
    ::  PeopleContactGroupsList
newPeopleContactGroupsList
  = PeopleContactGroupsList{xgafv = Core.Nothing,
                            accessToken = Core.Nothing, callback = Core.Nothing,
                            groupFields = Core.Nothing, pageSize = Core.Nothing,
                            pageToken = Core.Nothing, syncToken = Core.Nothing,
                            uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest PeopleContactGroupsList where
        type Rs PeopleContactGroupsList = ListContactGroupsResponse
        type Scopes PeopleContactGroupsList =
             '[Contacts'FullControl, Contacts'Readonly]
        requestClient PeopleContactGroupsList{..}
          = go xgafv accessToken callback groupFields pageSize pageToken
              syncToken
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy PeopleContactGroupsListResource)
                      Core.mempty
