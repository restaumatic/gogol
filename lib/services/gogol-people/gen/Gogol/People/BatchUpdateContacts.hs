...
type PeoplePeopleBatchUpdateContactsResource =
     "v1" Core.:>
       "people:batchUpdateContacts" Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] BatchUpdateContactsRequest Core.:>
                       Core.Post '[Core.JSON] BatchUpdateContactsResponse
...
newPeoplePeopleBatchUpdateContacts payload
  = PeoplePeopleBatchUpdateContacts{xgafv = Core.Nothing,
                                    accessToken = Core.Nothing, callback = Core.Nothing,
                                    payload = payload, uploadType = Core.Nothing,
                                    uploadProtocol = Core.Nothing}
instance Core.GoogleRequest PeoplePeopleBatchUpdateContacts where
        type Rs PeoplePeopleBatchUpdateContacts =
             BatchUpdateContactsResponse
        type Scopes PeoplePeopleBatchUpdateContacts =
        ...
        requestClient PeoplePeopleBatchUpdateContacts{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy PeoplePeopleBatchUpdateContactsResource)
                      Core.mempty
