...
type PeoplePeopleListDirectoryPeopleResource =
     "v1" Core.:>
       "people:listDirectoryPeople" Core.:>
         Core.QueryParam "$.xgafv" Xgafv Core.:>
           Core.QueryParam "access_token" Core.Text Core.:>
             Core.QueryParam "callback" Core.Text Core.:>
               Core.QueryParams "mergeSources"
                   ...
                   Core.QueryParam "pageToken" Core.Text Core.:>
                     Core.QueryParam "readMask" Core.FieldMask Core.:>
                       Core.QueryParam "requestSyncToken" Core.Bool Core.:>
                         Core.QueryParams "sources" PeopleListDirectoryPeopleSources Core.:>
                           Core.QueryParam "syncToken" Core.Text Core.:>
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.Get '[Core.JSON] ListDirectoryPeopleResponse
...
newPeoplePeopleListDirectoryPeople 
    :: 
                                   PeoplePeopleListDirectoryPeople
newPeoplePeopleListDirectoryPeople
  = PeoplePeopleListDirectoryPeople{xgafv = Core.Nothing,
                                    accessToken = Core.Nothing, callback = Core.Nothing,
                                    mergeSources = Core.Nothing, pageSize = Core.Nothing,
                                    pageToken = Core.Nothing, readMask = Core.Nothing,
                                    requestSyncToken = Core.Nothing, sources = Core.Nothing,
                                    syncToken = Core.Nothing, uploadType = Core.Nothing,
                                    uploadProtocol = Core.Nothing}
instance Core.GoogleRequest PeoplePeopleListDirectoryPeople where
        type Rs PeoplePeopleListDirectoryPeople =
             ListDirectoryPeopleResponse
        type Scopes PeoplePeopleListDirectoryPeople = '[Directory'Readonly]
        requestClient PeoplePeopleListDirectoryPeople{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy PeoplePeopleListDirectoryPeopleResource)
                      Core.mempty
