...
type PeoplePeopleUpdateContactResource =
     "v1" Core.:>
       Core.CaptureMode "resourceName" "updateContact" Core.Text Core.:>
         Core.QueryParam "$.xgafv" Xgafv Core.:>
           Core.QueryParam "access_token" Core.Text Core.:>
             Core.QueryParam "callback" Core.Text Core.:>
               Core.QueryParam "personFields" Core.FieldMask Core.:>
                 Core.QueryParams "sources" PeopleUpdateContactSources Core.:>
                   Core.QueryParam "updatePersonFields" Core.FieldMask Core.:>
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] Person Core.:>
                             Core.Patch '[Core.JSON] Person
...
newPeoplePeopleUpdateContact payload resourceName
  = PeoplePeopleUpdateContact{xgafv = Core.Nothing,
                              accessToken = Core.Nothing, callback = Core.Nothing,
                              payload = payload, personFields = Core.Nothing,
                              resourceName = resourceName, sources = Core.Nothing,
                              updatePersonFields = Core.Nothing, uploadType = Core.Nothing,
...
instance Core.GoogleRequest PeoplePeopleUpdateContact where
        ...
        requestClient PeoplePeopleUpdateContact{..}
          = go resourceName xgafv accessToken callback personFields
