...
type PeoplePeopleUpdateContactPhotoResource =
     "v1" Core.:>
       Core.CaptureMode "resourceName" "updateContactPhoto" Core.Text
         Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] UpdateContactPhotoRequest Core.:>
...
newPeoplePeopleUpdateContactPhoto payload resourceName
  = PeoplePeopleUpdateContactPhoto{xgafv = Core.Nothing,
