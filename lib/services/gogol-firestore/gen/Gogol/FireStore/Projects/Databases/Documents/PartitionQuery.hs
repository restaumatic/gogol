...
type FireStoreProjectsDatabasesDocumentsPartitionQueryResource =
     "v1" Core.:>
       Core.CaptureMode "parent" "partitionQuery" Core.Text Core.:>
                 ...
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] PartitionQueryRequest Core.:>
                       Core.Post '[Core.JSON] PartitionQueryResponse
...
newFireStoreProjectsDatabasesDocumentsPartitionQuery parent payload
  = FireStoreProjectsDatabasesDocumentsPartitionQuery{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           FireStoreProjectsDatabasesDocumentsPartitionQuery
         where
        type Rs FireStoreProjectsDatabasesDocumentsPartitionQuery =
             PartitionQueryResponse
        type Scopes FireStoreProjectsDatabasesDocumentsPartitionQuery =
             '[CloudPlatform'FullControl, Datastore'FullControl]
        requestClient FireStoreProjectsDatabasesDocumentsPartitionQuery{..}
