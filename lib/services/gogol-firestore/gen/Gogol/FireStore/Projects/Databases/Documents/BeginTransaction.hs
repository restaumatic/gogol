...
newFireStoreProjectsDatabasesDocumentsBeginTransaction 
    ...
    -> FireStoreProjectsDatabasesDocumentsBeginTransaction
newFireStoreProjectsDatabasesDocumentsBeginTransaction database
  payload
  = FireStoreProjectsDatabasesDocumentsBeginTransaction{xgafv =
                                                          Core.Nothing,
...
instance Core.GoogleRequest
           FireStoreProjectsDatabasesDocumentsBeginTransaction
         where
        type Rs FireStoreProjectsDatabasesDocumentsBeginTransaction =
             BeginTransactionResponse
        type Scopes FireStoreProjectsDatabasesDocumentsBeginTransaction =
