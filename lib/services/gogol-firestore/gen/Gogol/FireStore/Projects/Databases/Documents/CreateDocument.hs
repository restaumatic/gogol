...
newFireStoreProjectsDatabasesDocumentsCreateDocument 
    ...
    -> FireStoreProjectsDatabasesDocumentsCreateDocument
newFireStoreProjectsDatabasesDocumentsCreateDocument collectionId
  parent payload
  = FireStoreProjectsDatabasesDocumentsCreateDocument{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           FireStoreProjectsDatabasesDocumentsCreateDocument
         where
        type Rs FireStoreProjectsDatabasesDocumentsCreateDocument =
             Document
        type Scopes FireStoreProjectsDatabasesDocumentsCreateDocument =
             '[CloudPlatform'FullControl, Datastore'FullControl]
        requestClient FireStoreProjectsDatabasesDocumentsCreateDocument{..}
          = go parent collectionId xgafv accessToken callback documentId
