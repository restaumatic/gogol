...
newFireStoreProjectsDatabasesPatch name payload
  = FireStoreProjectsDatabasesPatch{xgafv = Core.Nothing,
                                    accessToken = Core.Nothing, callback = Core.Nothing,
                                    name = name, payload = payload, updateMask = Core.Nothing,
                                    uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest FireStoreProjectsDatabasesPatch where
        ...
        requestClient FireStoreProjectsDatabasesPatch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy FireStoreProjectsDatabasesPatchResource)
                      Core.mempty
