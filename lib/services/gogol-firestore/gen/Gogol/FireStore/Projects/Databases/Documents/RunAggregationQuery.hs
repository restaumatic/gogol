...
type FireStoreProjectsDatabasesDocumentsRunAggregationQueryResource
     =
     "v1" Core.:>
       Core.CaptureMode "parent" "runAggregationQuery" Core.Text Core.:>
...
newFireStoreProjectsDatabasesDocumentsRunAggregationQuery 
    ...
    -> FireStoreProjectsDatabasesDocumentsRunAggregationQuery
newFireStoreProjectsDatabasesDocumentsRunAggregationQuery parent
  payload
  = FireStoreProjectsDatabasesDocumentsRunAggregationQuery{xgafv =
                                                             Core.Nothing,
...
instance Core.GoogleRequest
           FireStoreProjectsDatabasesDocumentsRunAggregationQuery
         where
        type Rs FireStoreProjectsDatabasesDocumentsRunAggregationQuery =
             RunAggregationQueryResponse
        type Scopes FireStoreProjectsDatabasesDocumentsRunAggregationQuery
