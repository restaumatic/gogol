...
newFireStoreProjectsDatabasesCollectionGroupsIndexesGet name
  = FireStoreProjectsDatabasesCollectionGroupsIndexesGet{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           FireStoreProjectsDatabasesCollectionGroupsIndexesGet
         where
        type Rs FireStoreProjectsDatabasesCollectionGroupsIndexesGet =
             GoogleFirestoreAdminV1Index
        type Scopes FireStoreProjectsDatabasesCollectionGroupsIndexesGet =
