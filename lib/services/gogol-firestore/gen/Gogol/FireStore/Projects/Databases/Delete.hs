...
newFireStoreProjectsDatabasesDelete name
  = FireStoreProjectsDatabasesDelete{xgafv = Core.Nothing,
                                     accessToken = Core.Nothing, callback = Core.Nothing,
                                     etag = Core.Nothing, name = name, uploadType = Core.Nothing,
                                     uploadProtocol = Core.Nothing}
instance Core.GoogleRequest FireStoreProjectsDatabasesDelete where
        ...
        requestClient FireStoreProjectsDatabasesDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy FireStoreProjectsDatabasesDeleteResource)
                      Core.mempty
