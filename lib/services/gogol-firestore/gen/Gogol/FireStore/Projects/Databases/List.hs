                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.Get '[Core.JSON] GoogleFirestoreAdminV1ListDatabasesResponse
...
newFireStoreProjectsDatabasesList parent
  = FireStoreProjectsDatabasesList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest FireStoreProjectsDatabasesList where
        ...
        requestClient FireStoreProjectsDatabasesList{..}
          = go parent xgafv accessToken callback showDeleted uploadType
              uploadProtocol
