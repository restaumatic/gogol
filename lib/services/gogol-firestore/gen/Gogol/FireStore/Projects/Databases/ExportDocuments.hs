...
type FireStoreProjectsDatabasesExportDocumentsResource =
     "v1" Core.:>
       Core.CaptureMode "name" "exportDocuments" Core.Text Core.:>
...
newFireStoreProjectsDatabasesExportDocuments name payload
  = FireStoreProjectsDatabasesExportDocuments{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           FireStoreProjectsDatabasesExportDocuments
         where
        type Rs FireStoreProjectsDatabasesExportDocuments =
             GoogleLongrunningOperation
        type Scopes FireStoreProjectsDatabasesExportDocuments =
             '[CloudPlatform'FullControl, Datastore'FullControl]
        requestClient FireStoreProjectsDatabasesExportDocuments{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy FireStoreProjectsDatabasesExportDocumentsResource)
                      Core.mempty
