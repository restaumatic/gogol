                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] GoogleFirestoreAdminV1ListIndexesResponse
...
newFireStoreProjectsDatabasesCollectionGroupsIndexesList parent
  = FireStoreProjectsDatabasesCollectionGroupsIndexesList{xgafv =
                                                            Core.Nothing,
...
instance Core.GoogleRequest
           FireStoreProjectsDatabasesCollectionGroupsIndexesList
         where
        type Rs FireStoreProjectsDatabasesCollectionGroupsIndexesList =
             GoogleFirestoreAdminV1ListIndexesResponse
        type Scopes FireStoreProjectsDatabasesCollectionGroupsIndexesList =
