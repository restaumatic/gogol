...
newFireStoreProjectsDatabasesDocumentsCommit database payload
  = FireStoreProjectsDatabasesDocumentsCommit{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           FireStoreProjectsDatabasesDocumentsCommit
         where
        type Rs FireStoreProjectsDatabasesDocumentsCommit = CommitResponse
        type Scopes FireStoreProjectsDatabasesDocumentsCommit =
             '[CloudPlatform'FullControl, Datastore'FullControl]
        requestClient FireStoreProjectsDatabasesDocumentsCommit{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy FireStoreProjectsDatabasesDocumentsCommitResource)
                      Core.mempty
