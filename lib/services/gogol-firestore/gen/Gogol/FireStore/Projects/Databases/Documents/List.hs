...
newFireStoreProjectsDatabasesDocumentsList collectionId parent
  = FireStoreProjectsDatabasesDocumentsList{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            collectionId = collectionId,
                                            maskFieldPaths = Core.Nothing, orderBy = Core.Nothing,
                                            pageSize = Core.Nothing, pageToken = Core.Nothing,
                                            parent = parent, readTime = Core.Nothing,
                                            showMissing = Core.Nothing, transaction = Core.Nothing,
                                            uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest FireStoreProjectsDatabasesDocumentsList
         where
        type Rs FireStoreProjectsDatabasesDocumentsList =
             ListDocumentsResponse
        type Scopes FireStoreProjectsDatabasesDocumentsList =
             '[CloudPlatform'FullControl, Datastore'FullControl]
        requestClient FireStoreProjectsDatabasesDocumentsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy FireStoreProjectsDatabasesDocumentsListResource)
                      Core.mempty
