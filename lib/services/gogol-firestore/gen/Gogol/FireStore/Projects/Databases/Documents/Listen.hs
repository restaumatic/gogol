                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] ListenRequest Core.:>
                         Core.Post '[Core.JSON] ListenResponse
...
newFireStoreProjectsDatabasesDocumentsListen database payload
  = FireStoreProjectsDatabasesDocumentsListen{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes FireStoreProjectsDatabasesDocumentsListen =
