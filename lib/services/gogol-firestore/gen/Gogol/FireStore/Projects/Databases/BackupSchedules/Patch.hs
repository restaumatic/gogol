                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] GoogleFirestoreAdminV1BackupSchedule
                         Core.:>
                         Core.Patch '[Core.JSON] GoogleFirestoreAdminV1BackupSchedule
...
newFireStoreProjectsDatabasesBackupSchedulesPatch name payload
  = FireStoreProjectsDatabasesBackupSchedulesPatch{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           FireStoreProjectsDatabasesBackupSchedulesPatch
         where
        type Rs FireStoreProjectsDatabasesBackupSchedulesPatch =
             GoogleFirestoreAdminV1BackupSchedule
        type Scopes FireStoreProjectsDatabasesBackupSchedulesPatch =
