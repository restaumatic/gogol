...
type FireStoreProjectsDatabasesBulkDeleteDocumentsResource =
     "v1" Core.:>
       Core.CaptureMode "name" "bulkDeleteDocuments" Core.Text Core.:>
...
newFireStoreProjectsDatabasesBulkDeleteDocuments name payload
  = FireStoreProjectsDatabasesBulkDeleteDocuments{xgafv =
                                                    Core.Nothing,
...
instance Core.GoogleRequest
           FireStoreProjectsDatabasesBulkDeleteDocuments
         where
        type Rs FireStoreProjectsDatabasesBulkDeleteDocuments =
             GoogleLongrunningOperation
        type Scopes FireStoreProjectsDatabasesBulkDeleteDocuments =
