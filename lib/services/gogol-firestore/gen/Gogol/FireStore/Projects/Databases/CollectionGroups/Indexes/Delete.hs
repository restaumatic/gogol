...
newFireStoreProjectsDatabasesCollectionGroupsIndexesDelete name
  = FireStoreProjectsDatabasesCollectionGroupsIndexesDelete{xgafv =
                                                              Core.Nothing,
...
instance Core.GoogleRequest
           FireStoreProjectsDatabasesCollectionGroupsIndexesDelete
         where
        type Rs FireStoreProjectsDatabasesCollectionGroupsIndexesDelete =
             Empty
        type Scopes FireStoreProjectsDatabasesCollectionGroupsIndexesDelete
