...
-- |
-- Module      : Gogol.FireStore.Projects.Databases.CollectionGroups.Fields.Get
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.Get '[Core.JSON] GoogleFirestoreAdminV1Field
...
newFireStoreProjectsDatabasesCollectionGroupsFieldsGet name
  = FireStoreProjectsDatabasesCollectionGroupsFieldsGet{xgafv =
                                                          Core.Nothing,
...
instance Core.GoogleRequest
           FireStoreProjectsDatabasesCollectionGroupsFieldsGet
         where
        type Rs FireStoreProjectsDatabasesCollectionGroupsFieldsGet =
             GoogleFirestoreAdminV1Field
        type Scopes FireStoreProjectsDatabasesCollectionGroupsFieldsGet =
