                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] GoogleFirestoreAdminV1Index Core.:>
...
newFireStoreProjectsDatabasesCollectionGroupsIndexesCreate 
    ...
    -> FireStoreProjectsDatabasesCollectionGroupsIndexesCreate
newFireStoreProjectsDatabasesCollectionGroupsIndexesCreate parent
  payload
  = FireStoreProjectsDatabasesCollectionGroupsIndexesCreate{xgafv =
                                                              Core.Nothing,
...
instance Core.GoogleRequest
           FireStoreProjectsDatabasesCollectionGroupsIndexesCreate
         where
        type Rs FireStoreProjectsDatabasesCollectionGroupsIndexesCreate =
             GoogleLongrunningOperation
        type Scopes FireStoreProjectsDatabasesCollectionGroupsIndexesCreate
