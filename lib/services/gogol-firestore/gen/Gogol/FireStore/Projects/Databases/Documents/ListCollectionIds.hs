...
type FireStoreProjectsDatabasesDocumentsListCollectionIdsResource =
     "v1" Core.:>
       Core.CaptureMode "parent" "listCollectionIds" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] ListCollectionIdsRequest Core.:>
...
newFireStoreProjectsDatabasesDocumentsListCollectionIds 
    ...
    -> FireStoreProjectsDatabasesDocumentsListCollectionIds
newFireStoreProjectsDatabasesDocumentsListCollectionIds parent
  payload
  = FireStoreProjectsDatabasesDocumentsListCollectionIds{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           FireStoreProjectsDatabasesDocumentsListCollectionIds
         where
        type Rs FireStoreProjectsDatabasesDocumentsListCollectionIds =
