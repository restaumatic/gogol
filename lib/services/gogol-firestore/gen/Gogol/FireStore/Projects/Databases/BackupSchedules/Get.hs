               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.Get '[Core.JSON] GoogleFirestoreAdminV1BackupSchedule
...
newFireStoreProjectsDatabasesBackupSchedulesGet name
  = FireStoreProjectsDatabasesBackupSchedulesGet{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
           FireStoreProjectsDatabasesBackupSchedulesGet
         where
        type Rs FireStoreProjectsDatabasesBackupSchedulesGet =
             GoogleFirestoreAdminV1BackupSchedule
        type Scopes FireStoreProjectsDatabasesBackupSchedulesGet =
