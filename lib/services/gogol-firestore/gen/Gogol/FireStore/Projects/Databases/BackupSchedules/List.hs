...
newFireStoreProjectsDatabasesBackupSchedulesList parent
  = FireStoreProjectsDatabasesBackupSchedulesList{xgafv =
                                                    Core.Nothing,
...
instance Core.GoogleRequest
           FireStoreProjectsDatabasesBackupSchedulesList
         where
        type Rs FireStoreProjectsDatabasesBackupSchedulesList =
             GoogleFirestoreAdminV1ListBackupSchedulesResponse
        type Scopes FireStoreProjectsDatabasesBackupSchedulesList =
