...
newFireStoreProjectsDatabasesBackupSchedulesCreate parent payload
  = FireStoreProjectsDatabasesBackupSchedulesCreate{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           FireStoreProjectsDatabasesBackupSchedulesCreate
         where
        type Rs FireStoreProjectsDatabasesBackupSchedulesCreate =
             GoogleFirestoreAdminV1BackupSchedule
        type Scopes FireStoreProjectsDatabasesBackupSchedulesCreate =
