...
type FireStoreProjectsDatabasesImportDocumentsResource =
     "v1" Core.:>
       Core.CaptureMode "name" "importDocuments" Core.Text Core.:>
...
newFireStoreProjectsDatabasesImportDocuments name payload
  = FireStoreProjectsDatabasesImportDocuments{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           FireStoreProjectsDatabasesImportDocuments
         where
        type Rs FireStoreProjectsDatabasesImportDocuments =
             GoogleLongrunningOperation
        type Scopes FireStoreProjectsDatabasesImportDocuments =
