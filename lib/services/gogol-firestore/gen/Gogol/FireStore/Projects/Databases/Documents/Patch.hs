               ...
               Core.QueryParam "currentDocument.exists" Core.Bool Core.:>
                 Core.QueryParam "currentDocument.updateTime" Core.DateTime Core.:>
                   Core.QueryParams "mask.fieldPaths" Core.Text Core.:>
                     Core.QueryParams "updateMask.fieldPaths" Core.Text Core.:>
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] Document Core.:>
                               Core.Patch '[Core.JSON] Document
...
newFireStoreProjectsDatabasesDocumentsPatch name payload
  = FireStoreProjectsDatabasesDocumentsPatch{xgafv = Core.Nothing,
                                             accessToken = Core.Nothing, callback = Core.Nothing,
                                             currentDocumentExists = Core.Nothing,
                                             currentDocumentUpdateTime = Core.Nothing,
                                             maskFieldPaths = Core.Nothing, name = name,
                                             payload = payload, updateMaskFieldPaths = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes FireStoreProjectsDatabasesDocumentsPatch =
