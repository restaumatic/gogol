...
type FireStoreProjectsDatabasesDocumentsRunQueryResource =
     "v1" Core.:>
       Core.CaptureMode "parent" "runQuery" Core.Text Core.:>
...
newFireStoreProjectsDatabasesDocumentsRunQuery parent payload
  = FireStoreProjectsDatabasesDocumentsRunQuery{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           FireStoreProjectsDatabasesDocumentsRunQuery
         where
        type Rs FireStoreProjectsDatabasesDocumentsRunQuery =
             RunQueryResponse
        type Scopes FireStoreProjectsDatabasesDocumentsRunQuery =
