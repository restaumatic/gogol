...
newFireStoreProjectsDatabasesDocumentsRollback database payload
  = FireStoreProjectsDatabasesDocumentsRollback{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           FireStoreProjectsDatabasesDocumentsRollback
         where
        type Rs FireStoreProjectsDatabasesDocumentsRollback = Empty
        type Scopes FireStoreProjectsDatabasesDocumentsRollback =
             '[CloudPlatform'FullControl, Datastore'FullControl]
        requestClient FireStoreProjectsDatabasesDocumentsRollback{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy FireStoreProjectsDatabasesDocumentsRollbackResource)
                      Core.mempty
