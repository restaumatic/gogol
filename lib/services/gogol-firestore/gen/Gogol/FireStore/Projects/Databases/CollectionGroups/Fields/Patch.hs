                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] GoogleFirestoreAdminV1Field Core.:>
...
newFireStoreProjectsDatabasesCollectionGroupsFieldsPatch 
    ...
    -> FireStoreProjectsDatabasesCollectionGroupsFieldsPatch
newFireStoreProjectsDatabasesCollectionGroupsFieldsPatch name
  payload
  = FireStoreProjectsDatabasesCollectionGroupsFieldsPatch{xgafv =
                                                            Core.Nothing,
...
instance Core.GoogleRequest
           FireStoreProjectsDatabasesCollectionGroupsFieldsPatch
         where
        type Rs FireStoreProjectsDatabasesCollectionGroupsFieldsPatch =
             GoogleLongrunningOperation
        type Scopes FireStoreProjectsDatabasesCollectionGroupsFieldsPatch =
