                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] BatchGetDocumentsRequest Core.:>
...
newFireStoreProjectsDatabasesDocumentsBatchGet database payload
  = FireStoreProjectsDatabasesDocumentsBatchGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes FireStoreProjectsDatabasesDocumentsBatchGet =
             '[CloudPlatform'FullControl, Datastore'FullControl]
        requestClient FireStoreProjectsDatabasesDocumentsBatchGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy FireStoreProjectsDatabasesDocumentsBatchGetResource)
                      Core.mempty
