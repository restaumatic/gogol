                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] GoogleFirestoreAdminV1ListFieldsResponse
...
newFireStoreProjectsDatabasesCollectionGroupsFieldsList parent
  = FireStoreProjectsDatabasesCollectionGroupsFieldsList{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           FireStoreProjectsDatabasesCollectionGroupsFieldsList
         where
        type Rs FireStoreProjectsDatabasesCollectionGroupsFieldsList =
             GoogleFirestoreAdminV1ListFieldsResponse
        type Scopes FireStoreProjectsDatabasesCollectionGroupsFieldsList =
