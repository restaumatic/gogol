...
newFireStoreProjectsDatabasesDocumentsBatchWrite database payload
  = FireStoreProjectsDatabasesDocumentsBatchWrite{xgafv =
                                                    Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Rs FireStoreProjectsDatabasesDocumentsBatchWrite =
             BatchWriteResponse
        type Scopes FireStoreProjectsDatabasesDocumentsBatchWrite =
             '[CloudPlatform'FullControl, Datastore'FullControl]
        requestClient FireStoreProjectsDatabasesDocumentsBatchWrite{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy FireStoreProjectsDatabasesDocumentsBatchWriteResource)
                      Core.mempty
