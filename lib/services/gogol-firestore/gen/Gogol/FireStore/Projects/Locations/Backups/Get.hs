               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.Get '[Core.JSON] GoogleFirestoreAdminV1Backup
...
newFireStoreProjectsLocationsBackupsGet name
  = FireStoreProjectsLocationsBackupsGet{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         name = name, uploadType = Core.Nothing,
                                         uploadProtocol = Core.Nothing}
instance Core.GoogleRequest FireStoreProjectsLocationsBackupsGet
         where
        type Rs FireStoreProjectsLocationsBackupsGet =
             GoogleFirestoreAdminV1Backup
        type Scopes FireStoreProjectsLocationsBackupsGet =
