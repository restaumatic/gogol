...
module Gogol.FireStore.Internal.Product
  (
    ...
    GoogleFirestoreAdminV1CloneDatabaseMetadata (..),
    newGoogleFirestoreAdminV1CloneDatabaseMetadata,

    -- * GoogleFirestoreAdminV1CloneDatabaseRequest
    GoogleFirestoreAdminV1CloneDatabaseRequest (..),
    newGoogleFirestoreAdminV1CloneDatabaseRequest,

    -- * GoogleFirestoreAdminV1CloneDatabaseRequest_Tags
    GoogleFirestoreAdminV1CloneDatabaseRequest_Tags (..),
    newGoogleFirestoreAdminV1CloneDatabaseRequest_Tags,
    ...
    GoogleFirestoreAdminV1PitrSnapshot (..),
    newGoogleFirestoreAdminV1PitrSnapshot,
...
--
-- /See:/ 'newGoogleFirestoreAdminV1CloneDatabaseMetadata' smart constructor.
data GoogleFirestoreAdminV1CloneDatabaseMetadata = GoogleFirestoreAdminV1CloneDatabaseMetadata
    {
   ...
   GoogleFirestoreAdminV1CloneDatabaseMetadata_OperationState)
    ...
    , pitrSnapshot :: (Core.Maybe GoogleFirestoreAdminV1PitrSnapshot)
...
-- | Creates a value of 'GoogleFirestoreAdminV1CloneDatabaseMetadata' with the minimum fields required to make a request.
newGoogleFirestoreAdminV1CloneDatabaseMetadata 
    :: 
                                               GoogleFirestoreAdminV1CloneDatabaseMetadata
newGoogleFirestoreAdminV1CloneDatabaseMetadata
  = GoogleFirestoreAdminV1CloneDatabaseMetadata{database =
                                                  Core.Nothing,
                                                endTime = Core.Nothing,
                                                operationState = Core.Nothing,
                                                pitrSnapshot = Core.Nothing,
                                                progressPercentage = Core.Nothing,
                                                startTime = Core.Nothing}
instance Core.FromJSON GoogleFirestoreAdminV1CloneDatabaseMetadata
         where
        parseJSON
          = Core.withObject "GoogleFirestoreAdminV1CloneDatabaseMetadata"
              (\ o ->
                 GoogleFirestoreAdminV1CloneDatabaseMetadata Core.<$>
                   (o Core..:? "database") Core.<*> (o Core..:? "endTime") Core.<*>
                     (o Core..:? "operationState")
                     Core.<*> (o Core..:? "pitrSnapshot")
                     Core.<*> (o Core..:? "progressPercentage")
                     Core.<*> (o Core..:? "startTime"))

instance Core.ToJSON GoogleFirestoreAdminV1CloneDatabaseMetadata
         where
        toJSON GoogleFirestoreAdminV1CloneDatabaseMetadata{..}
          = Core.object
              (Core.catMaybes
                 [("database" Core..=) Core.<$> database,
                  ("endTime" Core..=) Core.<$> endTime,
                  ("operationState" Core..=) Core.<$> operationState,
                  ("pitrSnapshot" Core..=) Core.<$> pitrSnapshot,
...
--
-- /See:/ 'newGoogleFirestoreAdminV1CloneDatabaseRequest' smart constructor.
data GoogleFirestoreAdminV1CloneDatabaseRequest = GoogleFirestoreAdminV1CloneDatabaseRequest
    {
      ...
      -- | Optional. Encryption configuration for the cloned database. If this field is not specified, the cloned database will use the same encryption configuration as the source database, namely use/source/encryption.
    ...
    , tags :: (Core.Maybe GoogleFirestoreAdminV1CloneDatabaseRequest_Tags)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'GoogleFirestoreAdminV1CloneDatabaseRequest' with the minimum fields required to make a request.
newGoogleFirestoreAdminV1CloneDatabaseRequest 
    :: 
                                              GoogleFirestoreAdminV1CloneDatabaseRequest
newGoogleFirestoreAdminV1CloneDatabaseRequest
  = GoogleFirestoreAdminV1CloneDatabaseRequest{databaseId =
                                                 Core.Nothing,
                                               encryptionConfig = Core.Nothing,
                                               pitrSnapshot = Core.Nothing, tags = Core.Nothing}
instance Core.FromJSON GoogleFirestoreAdminV1CloneDatabaseRequest
         where
        parseJSON
          = Core.withObject "GoogleFirestoreAdminV1CloneDatabaseRequest"
              (\ o ->
                 GoogleFirestoreAdminV1CloneDatabaseRequest Core.<$>
                   (o Core..:? "databaseId") Core.<*> (o Core..:? "encryptionConfig")
                     Core.<*> (o Core..:? "pitrSnapshot")
                     Core.<*> (o Core..:? "tags"))

instance Core.ToJSON GoogleFirestoreAdminV1CloneDatabaseRequest
         where
        toJSON GoogleFirestoreAdminV1CloneDatabaseRequest{..}
          = Core.object
              (Core.catMaybes
...
-- | Optional. Immutable. Tags to be bound to the cloned database. The tags should be provided in the format of @tagKeys\/{tag_key_id} -> tagValues\/{tag_value_id}@.
--
-- /See:/ 'newGoogleFirestoreAdminV1CloneDatabaseRequest_Tags' smart constructor.
newtype GoogleFirestoreAdminV1CloneDatabaseRequest_Tags = GoogleFirestoreAdminV1CloneDatabaseRequest_Tags
    {
...
-- | Creates a value of 'GoogleFirestoreAdminV1CloneDatabaseRequest_Tags' with the minimum fields required to make a request.
newGoogleFirestoreAdminV1CloneDatabaseRequest_Tags 
    :: 
                                                   Core.HashMap Core.Text Core.Text
       -- ^  See 'additional'.
    -> GoogleFirestoreAdminV1CloneDatabaseRequest_Tags
newGoogleFirestoreAdminV1CloneDatabaseRequest_Tags additional
  = GoogleFirestoreAdminV1CloneDatabaseRequest_Tags{additional =
                                                      additional}
instance Core.FromJSON
           GoogleFirestoreAdminV1CloneDatabaseRequest_Tags
         where
        parseJSON
          = Core.withObject "GoogleFirestoreAdminV1CloneDatabaseRequest_Tags"
              (\ o ->
                 GoogleFirestoreAdminV1CloneDatabaseRequest_Tags Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON
           GoogleFirestoreAdminV1CloneDatabaseRequest_Tags
         where
        toJSON GoogleFirestoreAdminV1CloneDatabaseRequest_Tags{..}
          = Core.toJSON additional
...
data GoogleFirestoreAdminV1Database = GoogleFirestoreAdminV1Database
   ...
   GoogleFirestoreAdminV1Database_AppEngineIntegrationMode)
    ...
    , firestoreDataAccessMode :: (Core.Maybe GoogleFirestoreAdminV1Database_FirestoreDataAccessMode)
    ...
    , mongodbCompatibleDataAccessMode :: (Core.Maybe
   ...
   GoogleFirestoreAdminV1Database_PointInTimeRecoveryEnablement)
    ...
    , realtimeUpdatesMode :: (Core.Maybe GoogleFirestoreAdminV1Database_RealtimeUpdatesMode)
...
newGoogleFirestoreAdminV1Database
  = GoogleFirestoreAdminV1Database{appEngineIntegrationMode =
                                   ...
                                   firestoreDataAccessMode = Core.Nothing, freeTier = Core.Nothing,
                                   keyPrefix = Core.Nothing, locationId = Core.Nothing,
                                   mongodbCompatibleDataAccessMode = Core.Nothing,
                                   name = Core.Nothing,
                                   pointInTimeRecoveryEnablement = Core.Nothing,
                                   previousId = Core.Nothing, realtimeUpdatesMode = Core.Nothing,
                                   sourceInfo = Core.Nothing, tags = Core.Nothing,
                                   type' = Core.Nothing, uid = Core.Nothing,
...
newGoogleFirestoreAdminV1Index
  = GoogleFirestoreAdminV1Index{apiScope = Core.Nothing,
                                ...
                                state = Core.Nothing, unique = Core.Nothing}
...
--
-- /See:/ 'newGoogleFirestoreAdminV1PitrSnapshot' smart constructor.
data GoogleFirestoreAdminV1PitrSnapshot = GoogleFirestoreAdminV1PitrSnapshot
    {
      -- | Required. The name of the database that this was a snapshot of. Format: @projects\/{project}\/databases\/{database}@.
      database :: (Core.Maybe Core.Text)
      -- | Output only. Public UUID of the database the snapshot was associated with.
    , databaseUid :: (Core.Maybe Core.Base64)
      -- | Required. Snapshot time of the database.
    , snapshotTime :: (Core.Maybe Core.DateTime)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'GoogleFirestoreAdminV1PitrSnapshot' with the minimum fields required to make a request.
newGoogleFirestoreAdminV1PitrSnapshot 
    :: 
                                      GoogleFirestoreAdminV1PitrSnapshot
newGoogleFirestoreAdminV1PitrSnapshot
  = GoogleFirestoreAdminV1PitrSnapshot{database = Core.Nothing,
                                       databaseUid = Core.Nothing, snapshotTime = Core.Nothing}
instance Core.FromJSON GoogleFirestoreAdminV1PitrSnapshot where
        parseJSON
          = Core.withObject "GoogleFirestoreAdminV1PitrSnapshot"
              (\ o ->
                 GoogleFirestoreAdminV1PitrSnapshot Core.<$>
                   (o Core..:? "database") Core.<*> (o Core..:? "databaseUid")
                     Core.<*> (o Core..:? "snapshotTime"))

instance Core.ToJSON GoogleFirestoreAdminV1PitrSnapshot where
        toJSON GoogleFirestoreAdminV1PitrSnapshot{..}
          = Core.object
              (Core.catMaybes
                 [("database" Core..=) Core.<$> database,
                  ("databaseUid" Core..=) Core.<$> databaseUid,
