...
-- |
-- Module      : Gogol.SecurityCenter.Internal.Product
...
newAssetDiscoveryConfig 
    ::  AssetDiscoveryConfig
newAssetDiscoveryConfig
  = AssetDiscoveryConfig{inclusionMode = Core.Nothing,
                         projectIds = Core.Nothing}
instance Core.FromJSON AssetDiscoveryConfig where
        parseJSON
          = Core.withObject "AssetDiscoveryConfig"
              (\ o ->
                 AssetDiscoveryConfig Core.<$>
                   (o Core..:? "inclusionMode") Core.<*> (o Core..:? "projectIds"))
...
newFinding 
    ::  Finding
newFinding
  = Finding{category = Core.Nothing, createTime = Core.Nothing,
            eventTime = Core.Nothing, externalUri = Core.Nothing,
            name = Core.Nothing, parent = Core.Nothing,
            resourceName = Core.Nothing, securityMarks = Core.Nothing,
            sourceProperties = Core.Nothing, state = Core.Nothing}
instance Core.FromJSON Finding where
        parseJSON
          = Core.withObject "Finding"
              (\ o ->
                 Finding Core.<$>
                   (o Core..:? "category") Core.<*> (o Core..:? "createTime") Core.<*>
                     (o Core..:? "eventTime")
          ...
          = Core.object
              (Core.catMaybes
                 [("category" Core..=) Core.<$> category,
                  ...
                  ("sourceProperties" Core..=) Core.<$> sourceProperties,
...
newFinding_SourceProperties 
    :: 
       ...
       -- ^  See 'additional'.
    -> Finding_SourceProperties
newFinding_SourceProperties additional
  = Finding_SourceProperties{additional = additional}
instance Core.FromJSON Finding_SourceProperties where
        parseJSON
          = Core.withObject "Finding_SourceProperties"
              (\ o -> Finding_SourceProperties Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON Finding_SourceProperties where
        toJSON Finding_SourceProperties{..} = Core.toJSON additional
...
newGoogleCloudSecuritycenterV1NotificationMessage 
    :: 
                                                  GoogleCloudSecuritycenterV1NotificationMessage
newGoogleCloudSecuritycenterV1NotificationMessage
  = GoogleCloudSecuritycenterV1NotificationMessage{finding =
                                                     Core.Nothing,
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "GoogleCloudSecuritycenterV1NotificationMessage"
              (\ o ->
                 GoogleCloudSecuritycenterV1NotificationMessage Core.<$>
                   (o Core..:? "finding") Core.<*>
                     (o Core..:? "notificationConfigName")
                     Core.<*> (o Core..:? "resource"))

instance Core.ToJSON GoogleCloudSecuritycenterV1NotificationMessage
         where
        toJSON GoogleCloudSecuritycenterV1NotificationMessage{..}
          = Core.object
              (Core.catMaybes
                 [("finding" Core..=) Core.<$> finding,
                  ("notificationConfigName" Core..=) Core.<$> notificationConfigName,
...
newGoogleCloudSecuritycenterV1Resource 
    :: 
                                       GoogleCloudSecuritycenterV1Resource
newGoogleCloudSecuritycenterV1Resource
  = GoogleCloudSecuritycenterV1Resource{name = Core.Nothing,
                                        parent = Core.Nothing, parentDisplayName = Core.Nothing,
                                        project = Core.Nothing, projectDisplayName = Core.Nothing}
instance Core.FromJSON GoogleCloudSecuritycenterV1Resource where
        parseJSON
          = Core.withObject "GoogleCloudSecuritycenterV1Resource"
              (\ o ->
                 GoogleCloudSecuritycenterV1Resource Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "parent") Core.<*>
                     (o Core..:? "parentDisplayName")
                     Core.<*> (o Core..:? "project")
                     Core.<*> (o Core..:? "projectDisplayName"))

instance Core.ToJSON GoogleCloudSecuritycenterV1Resource where
        toJSON GoogleCloudSecuritycenterV1Resource{..}
          = Core.object
              (Core.catMaybes
                 [("name" Core..=) Core.<$> name,
                  ("parent" Core..=) Core.<$> parent,
                  ("parentDisplayName" Core..=) Core.<$> parentDisplayName,
                  ("project" Core..=) Core.<$> project,
                  ("projectDisplayName" Core..=) Core.<$> projectDisplayName])
...
newGoogleCloudSecuritycenterV1RunAssetDiscoveryResponse 
    :: 
                                                        GoogleCloudSecuritycenterV1RunAssetDiscoveryResponse
newGoogleCloudSecuritycenterV1RunAssetDiscoveryResponse
  = GoogleCloudSecuritycenterV1RunAssetDiscoveryResponse{duration =
                                                           Core.Nothing,
                                                         state = Core.Nothing}
instance Core.FromJSON
           GoogleCloudSecuritycenterV1RunAssetDiscoveryResponse
        ...
        parseJSON
          = Core.withObject
              "GoogleCloudSecuritycenterV1RunAssetDiscoveryResponse"
              (\ o ->
                 GoogleCloudSecuritycenterV1RunAssetDiscoveryResponse Core.<$>
                   (o Core..:? "duration") Core.<*> (o Core..:? "state"))

instance Core.ToJSON
           GoogleCloudSecuritycenterV1RunAssetDiscoveryResponse
         where
        toJSON GoogleCloudSecuritycenterV1RunAssetDiscoveryResponse{..}
          = Core.object
              (Core.catMaybes
...
newGoogleCloudSecuritycenterV1beta1RunAssetDiscoveryResponse 
    :: 
                                                             GoogleCloudSecuritycenterV1beta1RunAssetDiscoveryResponse
newGoogleCloudSecuritycenterV1beta1RunAssetDiscoveryResponse
  = GoogleCloudSecuritycenterV1beta1RunAssetDiscoveryResponse{duration
                                                                = Core.Nothing,
                                                              state = Core.Nothing}
instance Core.FromJSON
           GoogleCloudSecuritycenterV1beta1RunAssetDiscoveryResponse
        ...
        parseJSON
          = Core.withObject
              "GoogleCloudSecuritycenterV1beta1RunAssetDiscoveryResponse"
              (\ o ->
                 GoogleCloudSecuritycenterV1beta1RunAssetDiscoveryResponse Core.<$>
                   (o Core..:? "duration") Core.<*> (o Core..:? "state"))
...
data GoogleCloudSecuritycenterV1p1beta1Asset = GoogleCloudSecuritycenterV1p1beta1Asset
    ...
    , resourceProperties :: (Core.Maybe
   GoogleCloudSecuritycenterV1p1beta1Asset_ResourceProperties)
      -- | Security Command Center managed properties. These properties are managed by Security Command Center and cannot be modified by the user.
    , securityCenterProperties :: (Core.Maybe
   GoogleCloudSecuritycenterV1p1beta1SecurityCenterProperties)
...
newGoogleCloudSecuritycenterV1p1beta1Asset 
    :: 
                                           GoogleCloudSecuritycenterV1p1beta1Asset
newGoogleCloudSecuritycenterV1p1beta1Asset
  = GoogleCloudSecuritycenterV1p1beta1Asset{createTime =
                                              Core.Nothing,
                                            iamPolicy = Core.Nothing, name = Core.Nothing,
                                            resourceProperties = Core.Nothing,
                                            securityCenterProperties = Core.Nothing,
                                            securityMarks = Core.Nothing, updateTime = Core.Nothing}
instance Core.FromJSON GoogleCloudSecuritycenterV1p1beta1Asset
         where
        parseJSON
          = Core.withObject "GoogleCloudSecuritycenterV1p1beta1Asset"
              (\ o ->
                 GoogleCloudSecuritycenterV1p1beta1Asset Core.<$>
                   (o Core..:? "createTime") Core.<*> (o Core..:? "iamPolicy")
                     Core.<*> (o Core..:? "name")
...
instance Core.ToJSON GoogleCloudSecuritycenterV1p1beta1Asset where
          ...
          = Core.object
              (Core.catMaybes
                 [("createTime" Core..=) Core.<$> createTime,
                  ...
                  ("name" Core..=) Core.<$> name,
                  ("resourceProperties" Core..=) Core.<$> resourceProperties,
                  ("securityCenterProperties" Core..=) Core.<$>
...
newGoogleCloudSecuritycenterV1p1beta1Asset_ResourceProperties
  additional
  = GoogleCloudSecuritycenterV1p1beta1Asset_ResourceProperties{additional
                                                                 = additional}
instance Core.FromJSON
           GoogleCloudSecuritycenterV1p1beta1Asset_ResourceProperties
         where
        parseJSON
          = Core.withObject
              "GoogleCloudSecuritycenterV1p1beta1Asset_ResourceProperties"
              (\ o ->
                 GoogleCloudSecuritycenterV1p1beta1Asset_ResourceProperties Core.<$>
...
newGoogleCloudSecuritycenterV1p1beta1Finding 
    :: 
                                             GoogleCloudSecuritycenterV1p1beta1Finding
newGoogleCloudSecuritycenterV1p1beta1Finding
  = GoogleCloudSecuritycenterV1p1beta1Finding{category =
                                                Core.Nothing,
                                              createTime = Core.Nothing, eventTime = Core.Nothing,
                                              externalUri = Core.Nothing, name = Core.Nothing,
                                              parent = Core.Nothing, resourceName = Core.Nothing,
                                              securityMarks = Core.Nothing, severity = Core.Nothing,
                                              sourceProperties = Core.Nothing, state = Core.Nothing}
instance Core.FromJSON GoogleCloudSecuritycenterV1p1beta1Finding
         where
        parseJSON
          = Core.withObject "GoogleCloudSecuritycenterV1p1beta1Finding"
              (\ o ->
                 GoogleCloudSecuritycenterV1p1beta1Finding Core.<$>
                   (o Core..:? "category") Core.<*> (o Core..:? "createTime") Core.<*>
                     (o Core..:? "eventTime")
                     Core.<*> (o Core..:? "externalUri")
                     Core.<*> (o Core..:? "name")
...
instance Core.ToJSON GoogleCloudSecuritycenterV1p1beta1Finding
         where
...
newGoogleCloudSecuritycenterV1p1beta1Finding_SourceProperties
  additional
  = GoogleCloudSecuritycenterV1p1beta1Finding_SourceProperties{additional
                                                                 = additional}
instance Core.FromJSON
           GoogleCloudSecuritycenterV1p1beta1Finding_SourceProperties
         where
        parseJSON
          = Core.withObject
              "GoogleCloudSecuritycenterV1p1beta1Finding_SourceProperties"
              (\ o ->
                 GoogleCloudSecuritycenterV1p1beta1Finding_SourceProperties Core.<$>
                   (Core.parseJSONObject o))
...
newGoogleCloudSecuritycenterV1p1beta1IamPolicy 
    :: 
                                               GoogleCloudSecuritycenterV1p1beta1IamPolicy
newGoogleCloudSecuritycenterV1p1beta1IamPolicy
  = GoogleCloudSecuritycenterV1p1beta1IamPolicy{policyBlob =
                                                  Core.Nothing}
instance Core.FromJSON GoogleCloudSecuritycenterV1p1beta1IamPolicy
         where
        parseJSON
          = Core.withObject "GoogleCloudSecuritycenterV1p1beta1IamPolicy"
              (\ o ->
                 GoogleCloudSecuritycenterV1p1beta1IamPolicy Core.<$>
                   (o Core..:? "policyBlob"))

instance Core.ToJSON GoogleCloudSecuritycenterV1p1beta1IamPolicy
         where
        toJSON GoogleCloudSecuritycenterV1p1beta1IamPolicy{..}
          = Core.object
              (Core.catMaybes [("policyBlob" Core..=) Core.<$> policyBlob])
...
newGoogleCloudSecuritycenterV1p1beta1NotificationMessage 
    :: 
                                                         GoogleCloudSecuritycenterV1p1beta1NotificationMessage
newGoogleCloudSecuritycenterV1p1beta1NotificationMessage
  = GoogleCloudSecuritycenterV1p1beta1NotificationMessage{finding =
                                                            Core.Nothing,
                                                          notificationConfigName = Core.Nothing,
                                                          resource = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleCloudSecuritycenterV1p1beta1NotificationMessage"
              (\ o ->
                 GoogleCloudSecuritycenterV1p1beta1NotificationMessage Core.<$>
                   (o Core..:? "finding") Core.<*>
                     (o Core..:? "notificationConfigName")
                     Core.<*> (o Core..:? "resource")
...
instance Core.ToJSON
           GoogleCloudSecuritycenterV1p1beta1NotificationMessage
         where
        toJSON GoogleCloudSecuritycenterV1p1beta1NotificationMessage{..}
          = Core.object
              (Core.catMaybes
                 [("finding" Core..=) Core.<$> finding,
                  ("notificationConfigName" Core..=) Core.<$> notificationConfigName,
...
newGoogleCloudSecuritycenterV1p1beta1Resource 
    :: 
                                              GoogleCloudSecuritycenterV1p1beta1Resource
newGoogleCloudSecuritycenterV1p1beta1Resource
  = GoogleCloudSecuritycenterV1p1beta1Resource{name = Core.Nothing,
                                               parent = Core.Nothing,
                                               parentDisplayName = Core.Nothing,
                                               project = Core.Nothing,
                                               projectDisplayName = Core.Nothing}
instance Core.FromJSON GoogleCloudSecuritycenterV1p1beta1Resource
         where
        parseJSON
          = Core.withObject "GoogleCloudSecuritycenterV1p1beta1Resource"
              (\ o ->
                 GoogleCloudSecuritycenterV1p1beta1Resource Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "parent") Core.<*>
                     (o Core..:? "parentDisplayName")
                     Core.<*> (o Core..:? "project")
                     Core.<*> (o Core..:? "projectDisplayName"))

instance Core.ToJSON GoogleCloudSecuritycenterV1p1beta1Resource
         where
...
newGoogleCloudSecuritycenterV1p1beta1RunAssetDiscoveryResponse 
    :: 
                                                               GoogleCloudSecuritycenterV1p1beta1RunAssetDiscoveryResponse
newGoogleCloudSecuritycenterV1p1beta1RunAssetDiscoveryResponse
  = GoogleCloudSecuritycenterV1p1beta1RunAssetDiscoveryResponse{duration
                                                                  = Core.Nothing,
                                                                state = Core.Nothing}
instance Core.FromJSON
           GoogleCloudSecuritycenterV1p1beta1RunAssetDiscoveryResponse
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 GoogleCloudSecuritycenterV1p1beta1RunAssetDiscoveryResponse
                   Core.<$> (o Core..:? "duration") Core.<*> (o Core..:? "state"))
...
newGoogleCloudSecuritycenterV1p1beta1SecurityCenterProperties 
    :: 
                                                              GoogleCloudSecuritycenterV1p1beta1SecurityCenterProperties
newGoogleCloudSecuritycenterV1p1beta1SecurityCenterProperties
  = GoogleCloudSecuritycenterV1p1beta1SecurityCenterProperties{resourceDisplayName
                                                                 = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GoogleCloudSecuritycenterV1p1beta1SecurityCenterProperties"
              (\ o ->
                 GoogleCloudSecuritycenterV1p1beta1SecurityCenterProperties Core.<$>
                   (o Core..:? "resourceDisplayName") Core.<*>
                     (o Core..:? "resourceName")
...
instance Core.ToJSON
        ...
        toJSON
          ...
          = Core.object
              (Core.catMaybes
                 [("resourceDisplayName" Core..=) Core.<$> resourceDisplayName,
                  ("resourceName" Core..=) Core.<$> resourceName,
                  ("resourceOwners" Core..=) Core.<$> resourceOwners,
                  ("resourceParent" Core..=) Core.<$> resourceParent,
                  ("resourceParentDisplayName" Core..=) Core.<$>
                    resourceParentDisplayName,
                  ("resourceProject" Core..=) Core.<$> resourceProject,
                  ("resourceProjectDisplayName" Core..=) Core.<$>
                    resourceProjectDisplayName,
...
newGoogleCloudSecuritycenterV1p1beta1SecurityMarks 
    :: 
                                                   GoogleCloudSecuritycenterV1p1beta1SecurityMarks
newGoogleCloudSecuritycenterV1p1beta1SecurityMarks
  = GoogleCloudSecuritycenterV1p1beta1SecurityMarks{marks =
                                                      Core.Nothing,
                                                    name = Core.Nothing}
instance Core.FromJSON
           GoogleCloudSecuritycenterV1p1beta1SecurityMarks
         where
        parseJSON
          = Core.withObject "GoogleCloudSecuritycenterV1p1beta1SecurityMarks"
              (\ o ->
                 GoogleCloudSecuritycenterV1p1beta1SecurityMarks Core.<$>
                   (o Core..:? "marks") Core.<*> (o Core..:? "name"))

instance Core.ToJSON
           GoogleCloudSecuritycenterV1p1beta1SecurityMarks
         where
        toJSON GoogleCloudSecuritycenterV1p1beta1SecurityMarks{..}
          = Core.object
              (Core.catMaybes
                 [("marks" Core..=) Core.<$> marks, ("name" Core..=) Core.<$> name])
...
newGoogleCloudSecuritycenterV1p1beta1SecurityMarks_Marks 
    :: 
       ...
       -- ^  See 'additional'.
    -> GoogleCloudSecuritycenterV1p1beta1SecurityMarks_Marks
newGoogleCloudSecuritycenterV1p1beta1SecurityMarks_Marks additional
  = GoogleCloudSecuritycenterV1p1beta1SecurityMarks_Marks{additional
                                                            = additional}
instance Core.FromJSON
           GoogleCloudSecuritycenterV1p1beta1SecurityMarks_Marks
         where
        parseJSON
          = Core.withObject
              "GoogleCloudSecuritycenterV1p1beta1SecurityMarks_Marks"
              (\ o ->
                 GoogleCloudSecuritycenterV1p1beta1SecurityMarks_Marks Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON
           GoogleCloudSecuritycenterV1p1beta1SecurityMarks_Marks
         where
        toJSON GoogleCloudSecuritycenterV1p1beta1SecurityMarks_Marks{..}
          = Core.toJSON additional
...
newGoogleCloudSecuritycenterV1p1beta1TemporalAsset 
    :: 
                                                   GoogleCloudSecuritycenterV1p1beta1TemporalAsset
newGoogleCloudSecuritycenterV1p1beta1TemporalAsset
  = GoogleCloudSecuritycenterV1p1beta1TemporalAsset{asset =
                                                      Core.Nothing,
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "GoogleCloudSecuritycenterV1p1beta1TemporalAsset"
              (\ o ->
                 GoogleCloudSecuritycenterV1p1beta1TemporalAsset Core.<$>
                   (o Core..:? "asset") Core.<*> (o Core..:? "changeType"))

instance Core.ToJSON
           GoogleCloudSecuritycenterV1p1beta1TemporalAsset
         where
        toJSON GoogleCloudSecuritycenterV1p1beta1TemporalAsset{..}
          = Core.object
              (Core.catMaybes
...
newGroupAssetsRequest 
    ::  GroupAssetsRequest
newGroupAssetsRequest
  = GroupAssetsRequest{compareDuration = Core.Nothing,
                       filter = Core.Nothing, groupBy = Core.Nothing,
                       pageSize = Core.Nothing, pageToken = Core.Nothing,
                       readTime = Core.Nothing}
instance Core.FromJSON GroupAssetsRequest where
        parseJSON
          = Core.withObject "GroupAssetsRequest"
              (\ o ->
                 GroupAssetsRequest Core.<$>
                   (o Core..:? "compareDuration") Core.<*> (o Core..:? "filter")
                     Core.<*> (o Core..:? "groupBy")
...
instance Core.ToJSON GroupAssetsRequest where
        toJSON GroupAssetsRequest{..}
          = Core.object
              (Core.catMaybes
                 [("compareDuration" Core..=) Core.<$> compareDuration,
...
newGroupAssetsResponse 
    ::  GroupAssetsResponse
newGroupAssetsResponse
  = GroupAssetsResponse{groupByResults = Core.Nothing,
                        nextPageToken = Core.Nothing, readTime = Core.Nothing,
                        totalSize = Core.Nothing}
instance Core.FromJSON GroupAssetsResponse where
        parseJSON
          = Core.withObject "GroupAssetsResponse"
              (\ o ->
                 GroupAssetsResponse Core.<$>
                   (o Core..:? "groupByResults") Core.<*> (o Core..:? "nextPageToken")
                     Core.<*> (o Core..:? "readTime")
...
newGroupFindingsRequest 
    ::  GroupFindingsRequest
newGroupFindingsRequest
  = GroupFindingsRequest{compareDuration = Core.Nothing,
                         filter = Core.Nothing, groupBy = Core.Nothing,
                         pageSize = Core.Nothing, pageToken = Core.Nothing,
                         readTime = Core.Nothing}
instance Core.FromJSON GroupFindingsRequest where
        parseJSON
          = Core.withObject "GroupFindingsRequest"
              (\ o ->
                 GroupFindingsRequest Core.<$>
                   (o Core..:? "compareDuration") Core.<*> (o Core..:? "filter")
                     Core.<*> (o Core..:? "groupBy")
                     Core.<*> (o Core..:? "pageSize")
                     Core.<*> (o Core..:? "pageToken")
...
newGroupFindingsResponse 
    ::  GroupFindingsResponse
newGroupFindingsResponse
  = GroupFindingsResponse{groupByResults = Core.Nothing,
                          nextPageToken = Core.Nothing, readTime = Core.Nothing,
                          totalSize = Core.Nothing}
instance Core.FromJSON GroupFindingsResponse where
        parseJSON
          = Core.withObject "GroupFindingsResponse"
              (\ o ->
                 GroupFindingsResponse Core.<$>
                   (o Core..:? "groupByResults") Core.<*> (o Core..:? "nextPageToken")
                     Core.<*> (o Core..:? "readTime")
                     Core.<*> (o Core..:? "totalSize"))
...
newGroupResult 
    ::  GroupResult
newGroupResult
  = GroupResult{count = Core.Nothing, properties = Core.Nothing}
instance Core.FromJSON GroupResult where
        parseJSON
          = Core.withObject "GroupResult"
              (\ o ->
                 GroupResult Core.<$>
...
newGroupResult_Properties 
    :: 
       ...
       -- ^  See 'additional'.
    -> GroupResult_Properties
newGroupResult_Properties additional
  = GroupResult_Properties{additional = additional}
instance Core.FromJSON GroupResult_Properties where
        parseJSON
          = Core.withObject "GroupResult_Properties"
              (\ o -> GroupResult_Properties Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON GroupResult_Properties where
        toJSON GroupResult_Properties{..} = Core.toJSON additional
...
newListAssetsResponse 
    ::  ListAssetsResponse
newListAssetsResponse
  = ListAssetsResponse{listAssetsResults = Core.Nothing,
                       nextPageToken = Core.Nothing, readTime = Core.Nothing,
                       totalSize = Core.Nothing}
instance Core.FromJSON ListAssetsResponse where
        parseJSON
          = Core.withObject "ListAssetsResponse"
              (\ o ->
                 ListAssetsResponse Core.<$>
                   (o Core..:? "listAssetsResults") Core.<*>
...
instance Core.ToJSON ListAssetsResponse where
        toJSON ListAssetsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("listAssetsResults" Core..=) Core.<$> listAssetsResults,
                  ("nextPageToken" Core..=) Core.<$> nextPageToken,
                  ("readTime" Core..=) Core.<$> readTime,
                  ("totalSize" Core..=) Core.<$> totalSize])
...
newListAssetsResult 
    ::  ListAssetsResult
newListAssetsResult
  = ListAssetsResult{asset = Core.Nothing,
                     stateChange = Core.Nothing}
instance Core.FromJSON ListAssetsResult where
        parseJSON
          = Core.withObject "ListAssetsResult"
              (\ o ->
                 ListAssetsResult Core.<$>
                   (o Core..:? "asset") Core.<*> (o Core..:? "stateChange"))
...
newListFindingsResponse 
    ::  ListFindingsResponse
newListFindingsResponse
  = ListFindingsResponse{listFindingsResults = Core.Nothing,
                         nextPageToken = Core.Nothing, readTime = Core.Nothing,
                         totalSize = Core.Nothing}
instance Core.FromJSON ListFindingsResponse where
        parseJSON
          = Core.withObject "ListFindingsResponse"
              (\ o ->
                 ListFindingsResponse Core.<$>
                   (o Core..:? "listFindingsResults") Core.<*>
                     (o Core..:? "nextPageToken")
                     Core.<*> (o Core..:? "readTime")
                     Core.<*> (o Core..:? "totalSize"))
...
instance Core.ToJSON ListFindingsResponse where
        toJSON ListFindingsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("listFindingsResults" Core..=) Core.<$> listFindingsResults,
                  ("nextPageToken" Core..=) Core.<$> nextPageToken,
                  ("readTime" Core..=) Core.<$> readTime,
                  ("totalSize" Core..=) Core.<$> totalSize])
...
newListFindingsResult 
    ::  ListFindingsResult
newListFindingsResult
  = ListFindingsResult{finding = Core.Nothing,
                       resource = Core.Nothing, stateChange = Core.Nothing}
instance Core.FromJSON ListFindingsResult where
        parseJSON
          = Core.withObject "ListFindingsResult"
              (\ o ->
                 ListFindingsResult Core.<$>
                   (o Core..:? "finding") Core.<*> (o Core..:? "resource") Core.<*>
                     (o Core..:? "stateChange"))
...
newListNotificationConfigsResponse 
    :: 
                                   ListNotificationConfigsResponse
newListNotificationConfigsResponse
  = ListNotificationConfigsResponse{nextPageToken = Core.Nothing,
                                    notificationConfigs = Core.Nothing}
instance Core.FromJSON ListNotificationConfigsResponse where
        parseJSON
          = Core.withObject "ListNotificationConfigsResponse"
              (\ o ->
                 ListNotificationConfigsResponse Core.<$>
...
newListSourcesResponse 
    ::  ListSourcesResponse
newListSourcesResponse
  = ListSourcesResponse{nextPageToken = Core.Nothing,
                        sources = Core.Nothing}
instance Core.FromJSON ListSourcesResponse where
        parseJSON
          = Core.withObject "ListSourcesResponse"
              (\ o ->
                 ListSourcesResponse Core.<$>
...
newNotificationConfig 
    ::  NotificationConfig
newNotificationConfig
  = NotificationConfig{description = Core.Nothing,
                       eventType = Core.Nothing, name = Core.Nothing,
                       pubsubTopic = Core.Nothing, serviceAccount = Core.Nothing,
          ...
          = Core.withObject "NotificationConfig"
              (\ o ->
                 NotificationConfig Core.<$>
                   (o Core..:? "description") Core.<*> (o Core..:? "eventType")
                     Core.<*> (o Core..:? "name")
          ...
          = Core.object
              (Core.catMaybes
                 [("description" Core..=) Core.<$> description,
                  ...
                  ("streamingConfig" Core..=) Core.<$> streamingConfig])
...
newOrganizationSettings 
    ::  OrganizationSettings
newOrganizationSettings
  = OrganizationSettings{assetDiscoveryConfig = Core.Nothing,
                         enableAssetDiscovery = Core.Nothing, name = Core.Nothing}
instance Core.FromJSON OrganizationSettings where
        parseJSON
          = Core.withObject "OrganizationSettings"
              (\ o ->
                 OrganizationSettings Core.<$>
                   (o Core..:? "assetDiscoveryConfig") Core.<*>
                     (o Core..:? "enableAssetDiscovery")
                     Core.<*> (o Core..:? "name"))
...
instance Core.ToJSON OrganizationSettings where
        toJSON OrganizationSettings{..}
          = Core.object
              (Core.catMaybes
                 [("assetDiscoveryConfig" Core..=) Core.<$> assetDiscoveryConfig,
                  ("enableAssetDiscovery" Core..=) Core.<$> enableAssetDiscovery,
                  ("name" Core..=) Core.<$> name])
...
newResource 
    ::  Resource
newResource
  = Resource{name = Core.Nothing, parentDisplayName = Core.Nothing,
             parentName = Core.Nothing, projectDisplayName = Core.Nothing,
...
instance Core.FromJSON Resource where
        parseJSON
          = Core.withObject "Resource"
              (\ o ->
                 Resource Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "parentDisplayName")
...
instance Core.FromJSON RunAssetDiscoveryRequest where
        parseJSON
          = Core.withObject "RunAssetDiscoveryRequest"
...
newSecurityMarks 
    ::  SecurityMarks
newSecurityMarks
  = SecurityMarks{marks = Core.Nothing, name = Core.Nothing}
instance Core.FromJSON SecurityMarks where
        parseJSON
          = Core.withObject "SecurityMarks"
              (\ o ->
                 SecurityMarks Core.<$>
                   (o Core..:? "marks") Core.<*> (o Core..:? "name"))
...
newSecurityMarks_Marks 
    :: 
       ...
       -- ^  See 'additional'.
    -> SecurityMarks_Marks
newSecurityMarks_Marks additional
  = SecurityMarks_Marks{additional = additional}
instance Core.FromJSON SecurityMarks_Marks where
        parseJSON
          = Core.withObject "SecurityMarks_Marks"
              (\ o -> SecurityMarks_Marks Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON SecurityMarks_Marks where
        toJSON SecurityMarks_Marks{..} = Core.toJSON additional
...
newSetFindingStateRequest 
    ::  SetFindingStateRequest
newSetFindingStateRequest
  = SetFindingStateRequest{startTime = Core.Nothing,
                           state = Core.Nothing}
instance Core.FromJSON SetFindingStateRequest where
        parseJSON
          = Core.withObject "SetFindingStateRequest"
              (\ o ->
                 SetFindingStateRequest Core.<$>
                   (o Core..:? "startTime") Core.<*> (o Core..:? "state"))
...
newSource 
    ::  Source
newSource
  = Source{description = Core.Nothing, displayName = Core.Nothing,
           name = Core.Nothing}
...
instance Core.FromJSON StreamingConfig where
        parseJSON
          = Core.withObject "StreamingConfig"
              (\ o -> StreamingConfig Core.<$> (o Core..:? "filter"))
