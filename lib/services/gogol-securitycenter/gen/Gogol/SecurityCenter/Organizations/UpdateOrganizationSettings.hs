                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] OrganizationSettings Core.:>
                         Core.Patch '[Core.JSON] OrganizationSettings
...
newSecurityCenterOrganizationsUpdateOrganizationSettings 
    ...
    -> SecurityCenterOrganizationsUpdateOrganizationSettings
newSecurityCenterOrganizationsUpdateOrganizationSettings name
  payload
  = SecurityCenterOrganizationsUpdateOrganizationSettings{xgafv =
                                                            Core.Nothing,
...
instance Core.GoogleRequest
           SecurityCenterOrganizationsUpdateOrganizationSettings
         where
        type Rs SecurityCenterOrganizationsUpdateOrganizationSettings =
             OrganizationSettings
        type Scopes SecurityCenterOrganizationsUpdateOrganizationSettings =
