...
-- |
-- Module      : Gogol.SecurityCenter.Organizations.GetOrganizationSettings
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.Get '[Core.JSON] OrganizationSettings
...
newSecurityCenterOrganizationsGetOrganizationSettings name
  = SecurityCenterOrganizationsGetOrganizationSettings{xgafv =
                                                         Core.Nothing,
...
instance Core.GoogleRequest
           SecurityCenterOrganizationsGetOrganizationSettings
         where
        type Rs SecurityCenterOrganizationsGetOrganizationSettings =
             OrganizationSettings
        type Scopes SecurityCenterOrganizationsGetOrganizationSettings =
