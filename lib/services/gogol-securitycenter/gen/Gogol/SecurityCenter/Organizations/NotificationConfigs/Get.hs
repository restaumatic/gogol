...
newSecurityCenterOrganizationsNotificationConfigsGet name
  = SecurityCenterOrganizationsNotificationConfigsGet{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           SecurityCenterOrganizationsNotificationConfigsGet
         where
        type Rs SecurityCenterOrganizationsNotificationConfigsGet =
             NotificationConfig
        type Scopes SecurityCenterOrganizationsNotificationConfigsGet =
             '[CloudPlatform'FullControl]
        requestClient SecurityCenterOrganizationsNotificationConfigsGet{..}
