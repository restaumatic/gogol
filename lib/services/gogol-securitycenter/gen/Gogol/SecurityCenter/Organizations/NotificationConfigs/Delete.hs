...
newSecurityCenterOrganizationsNotificationConfigsDelete name
  = SecurityCenterOrganizationsNotificationConfigsDelete{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           SecurityCenterOrganizationsNotificationConfigsDelete
         where
        type Rs SecurityCenterOrganizationsNotificationConfigsDelete =
             Empty
        type Scopes SecurityCenterOrganizationsNotificationConfigsDelete =
