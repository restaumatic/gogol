                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] ListNotificationConfigsResponse
...
newSecurityCenterOrganizationsNotificationConfigsList parent
  = SecurityCenterOrganizationsNotificationConfigsList{xgafv =
                                                         Core.Nothing,
...
instance Core.GoogleRequest
           SecurityCenterOrganizationsNotificationConfigsList
         where
        type Rs SecurityCenterOrganizationsNotificationConfigsList =
             ListNotificationConfigsResponse
        type Scopes SecurityCenterOrganizationsNotificationConfigsList =
