...
newSecurityCenterOrganizationsNotificationConfigsCreate 
    ...
    -> SecurityCenterOrganizationsNotificationConfigsCreate
newSecurityCenterOrganizationsNotificationConfigsCreate parent
  payload
  = SecurityCenterOrganizationsNotificationConfigsCreate{xgafv =
                                                           Core.Nothing,
                                                         accessToken = Core.Nothing,
                                                         callback = Core.Nothing,
                                                         configId = Core.Nothing, parent = parent,
                                                         payload = payload,
...
instance Core.GoogleRequest
           SecurityCenterOrganizationsNotificationConfigsCreate
         where
        type Rs SecurityCenterOrganizationsNotificationConfigsCreate =
             NotificationConfig
        type Scopes SecurityCenterOrganizationsNotificationConfigsCreate =
             '[CloudPlatform'FullControl]
        requestClient
          SecurityCenterOrganizationsNotificationConfigsCreate{..}
          = go parent xgafv accessToken callback configId uploadType
              uploadProtocol
