...
newSecurityCenterOrganizationsNotificationConfigsPatch name payload
  = SecurityCenterOrganizationsNotificationConfigsPatch{xgafv =
                                                          Core.Nothing,
...
instance Core.GoogleRequest
           SecurityCenterOrganizationsNotificationConfigsPatch
         where
        type Rs SecurityCenterOrganizationsNotificationConfigsPatch =
             NotificationConfig
        type Scopes SecurityCenterOrganizationsNotificationConfigsPatch =
