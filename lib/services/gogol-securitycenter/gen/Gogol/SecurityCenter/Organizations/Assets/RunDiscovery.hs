                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] RunAssetDiscoveryRequest Core.:>
...
newSecurityCenterOrganizationsAssetsRunDiscovery parent payload
  = SecurityCenterOrganizationsAssetsRunDiscovery{xgafv =
                                                    Core.Nothing,
...
instance Core.GoogleRequest
           SecurityCenterOrganizationsAssetsRunDiscovery
         where
        type Rs SecurityCenterOrganizationsAssetsRunDiscovery = Operation
        type Scopes SecurityCenterOrganizationsAssetsRunDiscovery =
             '[CloudPlatform'FullControl]
        requestClient SecurityCenterOrganizationsAssetsRunDiscovery{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy SecurityCenterOrganizationsAssetsRunDiscoveryResource)
                      Core.mempty
