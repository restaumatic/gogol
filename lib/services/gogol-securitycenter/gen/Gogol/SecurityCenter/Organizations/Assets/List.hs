           ...
           Core.QueryParam "$.xgafv" Xgafv Core.:>
             Core.QueryParam "access_token" Core.Text Core.:>
               Core.QueryParam "callback" Core.Text Core.:>
                 Core.QueryParam "compareDuration" Core.Duration Core.:>
...
newSecurityCenterOrganizationsAssetsList parent
  = SecurityCenterOrganizationsAssetsList{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          compareDuration = Core.Nothing, fieldMask = Core.Nothing,
                                          filter = Core.Nothing, orderBy = Core.Nothing,
                                          pageSize = Core.Nothing, pageToken = Core.Nothing,
                                          parent = parent, readTime = Core.Nothing,
                                          uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest SecurityCenterOrganizationsAssetsList
         where
        type Rs SecurityCenterOrganizationsAssetsList = ListAssetsResponse
        type Scopes SecurityCenterOrganizationsAssetsList =
             '[CloudPlatform'FullControl]
        requestClient SecurityCenterOrganizationsAssetsList{..}
          = go parent xgafv accessToken callback compareDuration fieldMask
              filter
              orderBy
              pageSize
              pageToken
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy SecurityCenterOrganizationsAssetsListResource)
                      Core.mempty
