...
newSecurityCenterOrganizationsAssetsUpdateSecurityMarks 
    ...
    -> SecurityCenterOrganizationsAssetsUpdateSecurityMarks
newSecurityCenterOrganizationsAssetsUpdateSecurityMarks name
  payload
  = SecurityCenterOrganizationsAssetsUpdateSecurityMarks{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           SecurityCenterOrganizationsAssetsUpdateSecurityMarks
         where
        type Rs SecurityCenterOrganizationsAssetsUpdateSecurityMarks =
             GoogleCloudSecuritycenterV1p1beta1SecurityMarks
        type Scopes SecurityCenterOrganizationsAssetsUpdateSecurityMarks =
             '[CloudPlatform'FullControl]
        requestClient
          SecurityCenterOrganizationsAssetsUpdateSecurityMarks{..}
          = go name xgafv accessToken callback startTime updateMask
              uploadType
              uploadProtocol
