...
newSecurityCenterOrganizationsOperationsList name
  = SecurityCenterOrganizationsOperationsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           SecurityCenterOrganizationsOperationsList
         where
        type Rs SecurityCenterOrganizationsOperationsList =
             ListOperationsResponse
        type Scopes SecurityCenterOrganizationsOperationsList =
             '[CloudPlatform'FullControl]
        requestClient SecurityCenterOrganizationsOperationsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy SecurityCenterOrganizationsOperationsListResource)
                      Core.mempty
