                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] GroupFindingsRequest Core.:>
                         Core.Post '[Core.JSON] GroupFindingsResponse
...
newSecurityCenterOrganizationsSourcesFindingsGroup parent payload
  = SecurityCenterOrganizationsSourcesFindingsGroup{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           SecurityCenterOrganizationsSourcesFindingsGroup
         where
        type Rs SecurityCenterOrganizationsSourcesFindingsGroup =
             GroupFindingsResponse
        type Scopes SecurityCenterOrganizationsSourcesFindingsGroup =
             '[CloudPlatform'FullControl]
        requestClient SecurityCenterOrganizationsSourcesFindingsGroup{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy SecurityCenterOrganizationsSourcesFindingsGroupResource)
                      Core.mempty
