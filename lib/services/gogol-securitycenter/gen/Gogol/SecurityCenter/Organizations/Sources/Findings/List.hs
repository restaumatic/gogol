                               ...
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.Get '[Core.JSON] ListFindingsResponse
...
newSecurityCenterOrganizationsSourcesFindingsList parent
  = SecurityCenterOrganizationsSourcesFindingsList{xgafv =
                                                     Core.Nothing,
                                                   accessToken = Core.Nothing,
                                                   callback = Core.Nothing,
                                                   compareDuration = Core.Nothing,
                                                   fieldMask = Core.Nothing, filter = Core.Nothing,
...
instance Core.GoogleRequest
           SecurityCenterOrganizationsSourcesFindingsList
         where
        type Rs SecurityCenterOrganizationsSourcesFindingsList =
             ListFindingsResponse
        type Scopes SecurityCenterOrganizationsSourcesFindingsList =
             '[CloudPlatform'FullControl]
        requestClient SecurityCenterOrganizationsSourcesFindingsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy SecurityCenterOrganizationsSourcesFindingsListResource)
                      Core.mempty
