               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] SetFindingStateRequest Core.:>
...
newSecurityCenterOrganizationsSourcesFindingsSetState name payload
  = SecurityCenterOrganizationsSourcesFindingsSetState{xgafv =
                                                         Core.Nothing,
...
instance Core.GoogleRequest
           SecurityCenterOrganizationsSourcesFindingsSetState
         where
        type Rs SecurityCenterOrganizationsSourcesFindingsSetState =
             GoogleCloudSecuritycenterV1p1beta1Finding
        type Scopes SecurityCenterOrganizationsSourcesFindingsSetState =
