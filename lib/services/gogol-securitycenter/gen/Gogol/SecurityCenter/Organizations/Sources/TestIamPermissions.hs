...
newSecurityCenterOrganizationsSourcesTestIamPermissions 
    ...
    -> SecurityCenterOrganizationsSourcesTestIamPermissions
newSecurityCenterOrganizationsSourcesTestIamPermissions payload
  resource
  = SecurityCenterOrganizationsSourcesTestIamPermissions{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           SecurityCenterOrganizationsSourcesTestIamPermissions
         where
        type Rs SecurityCenterOrganizationsSourcesTestIamPermissions =
             TestIamPermissionsResponse
        type Scopes SecurityCenterOrganizationsSourcesTestIamPermissions =
