...
newSecurityCenterOrganizationsSourcesCreate parent payload
  = SecurityCenterOrganizationsSourcesCreate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           SecurityCenterOrganizationsSourcesCreate
         where
        type Rs SecurityCenterOrganizationsSourcesCreate = Source
        type Scopes SecurityCenterOrganizationsSourcesCreate =
             '[CloudPlatform'FullControl]
        requestClient SecurityCenterOrganizationsSourcesCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy SecurityCenterOrganizationsSourcesCreateResource)
                      Core.mempty
