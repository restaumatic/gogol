...
newSecurityCenterOrganizationsSourcesGetIamPolicy payload resource
  = SecurityCenterOrganizationsSourcesGetIamPolicy{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           SecurityCenterOrganizationsSourcesGetIamPolicy
         where
        type Rs SecurityCenterOrganizationsSourcesGetIamPolicy = Policy
        type Scopes SecurityCenterOrganizationsSourcesGetIamPolicy =
             '[CloudPlatform'FullControl]
        requestClient SecurityCenterOrganizationsSourcesGetIamPolicy{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy SecurityCenterOrganizationsSourcesGetIamPolicyResource)
                      Core.mempty
