...
-- |
-- Module      : Gogol.SecurityCenter.Organizations.Sources.Findings.Create
           ...
           Core.QueryParam "$.xgafv" Xgafv Core.:>
             Core.QueryParam "access_token" Core.Text Core.:>
               Core.QueryParam "callback" Core.Text Core.:>
                 Core.QueryParam "findingId" Core.Text Core.:>
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] GoogleCloudSecuritycenterV1p1beta1Finding
                           Core.:>
                           Core.Post '[Core.JSON] GoogleCloudSecuritycenterV1p1beta1Finding
...
newSecurityCenterOrganizationsSourcesFindingsCreate parent payload
  = SecurityCenterOrganizationsSourcesFindingsCreate{xgafv =
                                                       Core.Nothing,
                                                     accessToken = Core.Nothing,
                                                     callback = Core.Nothing,
                                                     findingId = Core.Nothing, parent = parent,
                                                     payload = payload, uploadType = Core.Nothing,
                                                     uploadProtocol = Core.Nothing}
instance Core.GoogleRequest
           SecurityCenterOrganizationsSourcesFindingsCreate
         where
        type Rs SecurityCenterOrganizationsSourcesFindingsCreate =
             GoogleCloudSecuritycenterV1p1beta1Finding
        type Scopes SecurityCenterOrganizationsSourcesFindingsCreate =
             '[CloudPlatform'FullControl]
        requestClient SecurityCenterOrganizationsSourcesFindingsCreate{..}
          = go parent xgafv accessToken callback findingId uploadType
              uploadProtocol
