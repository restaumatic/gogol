...
newSecurityCenterOrganizationsSourcesSetIamPolicy payload resource
  = SecurityCenterOrganizationsSourcesSetIamPolicy{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           SecurityCenterOrganizationsSourcesSetIamPolicy
         where
        type Rs SecurityCenterOrganizationsSourcesSetIamPolicy = Policy
        type Scopes SecurityCenterOrganizationsSourcesSetIamPolicy =
             '[CloudPlatform'FullControl]
        requestClient SecurityCenterOrganizationsSourcesSetIamPolicy{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy SecurityCenterOrganizationsSourcesSetIamPolicyResource)
                      Core.mempty
