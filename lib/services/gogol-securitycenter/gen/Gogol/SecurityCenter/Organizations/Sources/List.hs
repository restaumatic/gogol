...
instance Core.GoogleRequest SecurityCenterOrganizationsSourcesList
        ...
        requestClient SecurityCenterOrganizationsSourcesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy SecurityCenterOrganizationsSourcesListResource)
                      Core.mempty
