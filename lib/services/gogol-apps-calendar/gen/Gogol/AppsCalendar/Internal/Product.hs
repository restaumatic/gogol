...
newAcl 
    ::  Acl
newAcl
  = Acl{etag = Core.Nothing, items = Core.Nothing,
        kind = "calendar#acl", nextPageToken = Core.Nothing,
...
newAclRule 
    ::  AclRule
newAclRule
  = AclRule{etag = Core.Nothing, id = Core.Nothing,
            kind = "calendar#aclRule", role' = Core.Nothing,
            scope = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("etag" Core..=) Core.<$> etag, ("id" Core..=) Core.<$> id,
                  Core.Just ("kind" Core..= kind), ("role" Core..=) Core.<$> role',
...
newCalendar 
    ::  Calendar
newCalendar
  = Calendar{conferenceProperties = Core.Nothing,
             description = Core.Nothing, etag = Core.Nothing, id = Core.Nothing,
             kind = "calendar#calendar", location = Core.Nothing,
             summary = Core.Nothing, timeZone = Core.Nothing}
...
newCalendarList 
    ::  CalendarList
newCalendarList
  = CalendarList{etag = Core.Nothing, items = Core.Nothing,
                 kind = "calendar#calendarList", nextPageToken = Core.Nothing,
                 nextSyncToken = Core.Nothing}
...
newCalendarListEntry 
    ::  CalendarListEntry
newCalendarListEntry
  = CalendarListEntry{accessRole = Core.Nothing,
                      backgroundColor = Core.Nothing, colorId = Core.Nothing,
                      conferenceProperties = Core.Nothing,
                      defaultReminders = Core.Nothing, deleted = Core.False,
                      description = Core.Nothing, etag = Core.Nothing,
                      foregroundColor = Core.Nothing, hidden = Core.False,
                      id = Core.Nothing, kind = "calendar#calendarListEntry",
                      location = Core.Nothing, notificationSettings = Core.Nothing,
                      primary = Core.False, selected = Core.False,
                      summary = Core.Nothing, summaryOverride = Core.Nothing,
          ...
          = Core.withObject "CalendarListEntry"
              (\ o ->
                 CalendarListEntry Core.<$>
                   (o Core..:? "accessRole") Core.<*> (o Core..:? "backgroundColor")
                     Core.<*> (o Core..:? "colorId")
          ...
          = Core.object
              (Core.catMaybes
                 [("accessRole" Core..=) Core.<$> accessRole,
                  ...
                  Core.Just ("hidden" Core..= hidden), ("id" Core..=) Core.<$> id,
                  Core.Just ("kind" Core..= kind),
                  ("location" Core..=) Core.<$> location,
...
newCalendarListEntry_NotificationSettings 
    :: 
                                          CalendarListEntry_NotificationSettings
newCalendarListEntry_NotificationSettings
  = CalendarListEntry_NotificationSettings{notifications =
                                             Core.Nothing}
instance Core.FromJSON CalendarListEntry_NotificationSettings where
        parseJSON
          = Core.withObject "CalendarListEntry_NotificationSettings"
              (\ o ->
...
newColorDefinition 
    ::  ColorDefinition
newColorDefinition
  = ColorDefinition{background = Core.Nothing,
          ...
          = Core.withObject "ColorDefinition"
              (\ o ->
                 ColorDefinition Core.<$>
                   (o Core..:? "background") Core.<*> (o Core..:? "foreground"))
...
newColors 
    ::  Colors
newColors
  = Colors{calendar = Core.Nothing, event = Core.Nothing,
           kind = "calendar#colors", updated = Core.Nothing}
instance Core.FromJSON Colors where
        parseJSON
          = Core.withObject "Colors"
              (\ o ->
                 Colors Core.<$>
                   (o Core..:? "calendar") Core.<*> (o Core..:? "event") Core.<*>
          ...
          = Core.object
              (Core.catMaybes
                 [("calendar" Core..=) Core.<$> calendar,
                  ("event" Core..=) Core.<$> event, Core.Just ("kind" Core..= kind),
...
newConferenceData 
    ::  ConferenceData
newConferenceData
  = ConferenceData{conferenceId = Core.Nothing,
                   conferenceSolution = Core.Nothing, createRequest = Core.Nothing,
                   entryPoints = Core.Nothing, notes = Core.Nothing,
                   parameters = Core.Nothing, signature = Core.Nothing}
...
instance Core.FromJSON ConferenceParametersAddOnParameters where
        parseJSON
          = Core.withObject "ConferenceParametersAddOnParameters"
              (\ o ->
...
newConferenceParametersAddOnParameters_Parameters additional
  = ConferenceParametersAddOnParameters_Parameters{additional =
                                                     additional}
instance Core.FromJSON
           ConferenceParametersAddOnParameters_Parameters
         where
        parseJSON
          = Core.withObject "ConferenceParametersAddOnParameters_Parameters"
              (\ o ->
                 ConferenceParametersAddOnParameters_Parameters Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON ConferenceParametersAddOnParameters_Parameters
         where
...
newConferenceSolution 
    ::  ConferenceSolution
newConferenceSolution
  = ConferenceSolution{iconUri = Core.Nothing, key = Core.Nothing,
                       name = Core.Nothing}
          ...
          = Core.withObject "ConferenceSolution"
              (\ o ->
                 ConferenceSolution Core.<$>
                   (o Core..:? "iconUri") Core.<*> (o Core..:? "key") Core.<*>
                     (o Core..:? "name"))
...
newCreateConferenceRequest 
    ::  CreateConferenceRequest
newCreateConferenceRequest
  = CreateConferenceRequest{conferenceSolutionKey = Core.Nothing,
                            requestId = Core.Nothing, status = Core.Nothing}
...
newEntryPoint 
    ::  EntryPoint
newEntryPoint
  = EntryPoint{accessCode = Core.Nothing,
               entryPointFeatures = Core.Nothing, entryPointType = Core.Nothing,
               label = Core.Nothing, meetingCode = Core.Nothing,
               passcode = Core.Nothing, password = Core.Nothing,
               pin = Core.Nothing, regionCode = Core.Nothing, uri = Core.Nothing}
...
newEvent 
    ::  Event
newEvent
  = Event{anyoneCanAddSelf = Core.False, attachments = Core.Nothing,
          attendees = Core.Nothing, attendeesOmitted = Core.False,
          birthdayProperties = Core.Nothing, colorId = Core.Nothing,
          conferenceData = Core.Nothing, created = Core.Nothing,
          creator = Core.Nothing, description = Core.Nothing,
          end = Core.Nothing, endTimeUnspecified = Core.False,
          etag = Core.Nothing, eventType = "default",
          extendedProperties = Core.Nothing,
          focusTimeProperties = Core.Nothing, gadget = Core.Nothing,
          guestsCanInviteOthers = Core.True, guestsCanModify = Core.False,
          guestsCanSeeOtherGuests = Core.True, hangoutLink = Core.Nothing,
          htmlLink = Core.Nothing, iCalUID = Core.Nothing, id = Core.Nothing,
          kind = "calendar#event", location = Core.Nothing,
          locked = Core.False, organizer = Core.Nothing,
          originalStartTime = Core.Nothing,
          outOfOfficeProperties = Core.Nothing, privateCopy = Core.False,
          recurrence = Core.Nothing, recurringEventId = Core.Nothing,
          reminders = Core.Nothing, sequence = Core.Nothing,
          source = Core.Nothing, start = Core.Nothing, status = Core.Nothing,
          summary = Core.Nothing, transparency = "opaque",
          updated = Core.Nothing, visibility = "default",
...
instance Core.FromJSON Event where
        parseJSON
          = Core.withObject "Event"
              (\ o ->
                 Event Core.<$>
                   (o Core..:? "anyoneCanAddSelf" Core..!= Core.False) Core.<*>
                     (o Core..:? "attachments")
          ...
          = Core.object
              (Core.catMaybes
                 [Core.Just ("anyoneCanAddSelf" Core..= anyoneCanAddSelf),
                  ...
                  ("iCalUID" Core..=) Core.<$> iCalUID, ("id" Core..=) Core.<$> id,
                  Core.Just ("kind" Core..= kind),
                  ("location" Core..=) Core.<$> location,
...
newEvent_Creator 
    ::  Event_Creator
newEvent_Creator
  = Event_Creator{displayName = Core.Nothing, email = Core.Nothing,
                  id = Core.Nothing, self = Core.False}
...
newEvent_ExtendedProperties 
    ::  Event_ExtendedProperties
newEvent_ExtendedProperties
  = Event_ExtendedProperties{private = Core.Nothing,
                             shared = Core.Nothing}
          ...
          = Core.withObject "Event_ExtendedProperties"
              (\ o ->
                 Event_ExtendedProperties Core.<$>
                   (o Core..:? "private") Core.<*> (o Core..:? "shared"))
...
newEvent_Gadget 
    ::  Event_Gadget
newEvent_Gadget
  = Event_Gadget{display = Core.Nothing, height = Core.Nothing,
                 iconLink = Core.Nothing, link = Core.Nothing,
                 preferences = Core.Nothing, title = Core.Nothing,
                 type' = Core.Nothing, width = Core.Nothing}
instance Core.FromJSON Event_Gadget where
        parseJSON
          = Core.withObject "Event_Gadget"
              (\ o ->
                 Event_Gadget Core.<$>
                   (o Core..:? "display") Core.<*> (o Core..:? "height") Core.<*>
                     (o Core..:? "iconLink")
                     Core.<*> (o Core..:? "link")
...
newEvent_Organizer 
    ::  Event_Organizer
newEvent_Organizer
  = Event_Organizer{displayName = Core.Nothing, email = Core.Nothing,
                    id = Core.Nothing, self = Core.False}
...
newEvent_Reminders 
    ::  Event_Reminders
newEvent_Reminders
  = Event_Reminders{overrides = Core.Nothing,
          ...
          = Core.withObject "Event_Reminders"
              (\ o ->
                 Event_Reminders Core.<$>
                   (o Core..:? "overrides") Core.<*> (o Core..:? "useDefault"))
...
newEventAttachment 
    ::  EventAttachment
newEventAttachment
  = EventAttachment{fileId = Core.Nothing, fileUrl = Core.Nothing,
                    iconLink = Core.Nothing, mimeType = Core.Nothing,
                    title = Core.Nothing}
          ...
          = Core.withObject "EventAttachment"
              (\ o ->
                 EventAttachment Core.<$>
                   (o Core..:? "fileId") Core.<*> (o Core..:? "fileUrl") Core.<*>
                     (o Core..:? "iconLink")
...
newEventAttendee 
    ::  EventAttendee
newEventAttendee
  = EventAttendee{additionalGuests = 0, comment = Core.Nothing,
                  displayName = Core.Nothing, email = Core.Nothing,
                  id = Core.Nothing, optional = Core.False, organizer = Core.Nothing,
                  resource = Core.False, responseStatus = Core.Nothing,
                  self = Core.False}
...
newEventBirthdayProperties 
    ::  EventBirthdayProperties
newEventBirthdayProperties
  = EventBirthdayProperties{contact = Core.Nothing,
                            customTypeName = Core.Nothing, type' = "birthday"}
instance Core.FromJSON EventBirthdayProperties where
        parseJSON
          = Core.withObject "EventBirthdayProperties"
              (\ o ->
                 EventBirthdayProperties Core.<$>
                   (o Core..:? "contact") Core.<*> (o Core..:? "customTypeName")
...
newEventDateTime 
    ::  EventDateTime
newEventDateTime
  = EventDateTime{date = Core.Nothing, dateTime = Core.Nothing,
                  timeZone = Core.Nothing}
instance Core.FromJSON EventDateTime where
        parseJSON
          = Core.withObject "EventDateTime"
              (\ o ->
                 EventDateTime Core.<$>
                   (o Core..:? "date") Core.<*> (o Core..:? "dateTime") Core.<*>
                     (o Core..:? "timeZone"))
...
newEventFocusTimeProperties 
    ::  EventFocusTimeProperties
newEventFocusTimeProperties
  = EventFocusTimeProperties{autoDeclineMode = Core.Nothing,
                             chatStatus = Core.Nothing, declineMessage = Core.Nothing}
instance Core.FromJSON EventFocusTimeProperties where
        parseJSON
          = Core.withObject "EventFocusTimeProperties"
              (\ o ->
                 EventFocusTimeProperties Core.<$>
                   (o Core..:? "autoDeclineMode") Core.<*> (o Core..:? "chatStatus")
...
newEventOutOfOfficeProperties 
    ::  EventOutOfOfficeProperties
newEventOutOfOfficeProperties
  = EventOutOfOfficeProperties{autoDeclineMode = Core.Nothing,
                               declineMessage = Core.Nothing}
instance Core.FromJSON EventOutOfOfficeProperties where
        parseJSON
          = Core.withObject "EventOutOfOfficeProperties"
              (\ o ->
                 EventOutOfOfficeProperties Core.<$>
                   (o Core..:? "autoDeclineMode") Core.<*>
                     (o Core..:? "declineMessage"))
...
instance Core.FromJSON EventReminder where
        parseJSON
          = Core.withObject "EventReminder"
              (\ o ->
                 EventReminder Core.<$>
                   (o Core..:? "method") Core.<*> (o Core..:? "minutes"))
...
newEventWorkingLocationProperties 
    ::  EventWorkingLocationProperties
newEventWorkingLocationProperties
  = EventWorkingLocationProperties{customLocation = Core.Nothing,
                                   homeOffice = Core.Nothing, officeLocation = Core.Nothing,
                                   type' = Core.Nothing}
          ...
          = Core.withObject "EventWorkingLocationProperties"
              (\ o ->
                 EventWorkingLocationProperties Core.<$>
                   (o Core..:? "customLocation") Core.<*> (o Core..:? "homeOffice")
...
newEventWorkingLocationProperties_CustomLocation 
    :: 
                                                 EventWorkingLocationProperties_CustomLocation
newEventWorkingLocationProperties_CustomLocation
  = EventWorkingLocationProperties_CustomLocation{label =
                                                    Core.Nothing}
instance Core.FromJSON
           EventWorkingLocationProperties_CustomLocation
         where
        parseJSON
          = Core.withObject "EventWorkingLocationProperties_CustomLocation"
              (\ o ->
                 EventWorkingLocationProperties_CustomLocation Core.<$>
                   (o Core..:? "label"))

instance Core.ToJSON EventWorkingLocationProperties_CustomLocation
         where
...
newEventWorkingLocationProperties_OfficeLocation 
    :: 
                                                 EventWorkingLocationProperties_OfficeLocation
newEventWorkingLocationProperties_OfficeLocation
  = EventWorkingLocationProperties_OfficeLocation{buildingId =
                                                    Core.Nothing,
                                                  deskId = Core.Nothing, floorId = Core.Nothing,
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "EventWorkingLocationProperties_OfficeLocation"
              (\ o ->
                 EventWorkingLocationProperties_OfficeLocation Core.<$>
                   (o Core..:? "buildingId") Core.<*> (o Core..:? "deskId") Core.<*>
                     (o Core..:? "floorId")
                     Core.<*> (o Core..:? "floorSectionId")
                     Core.<*> (o Core..:? "label"))

instance Core.ToJSON EventWorkingLocationProperties_OfficeLocation
         where
...
newEvents 
    ::  Events
newEvents
  = Events{accessRole = Core.Nothing,
           defaultReminders = Core.Nothing, description = Core.Nothing,
           etag = Core.Nothing, items = Core.Nothing,
           kind = "calendar#events", nextPageToken = Core.Nothing,
           nextSyncToken = Core.Nothing, summary = Core.Nothing,
           timeZone = Core.Nothing, updated = Core.Nothing}
instance Core.FromJSON Events where
        parseJSON
          = Core.withObject "Events"
              (\ o ->
                 Events Core.<$>
                   (o Core..:? "accessRole") Core.<*> (o Core..:? "defaultReminders")
                     Core.<*> (o Core..:? "description")
                     Core.<*> (o Core..:? "etag")
                     Core.<*> (o Core..:? "items")
...
instance Core.FromJSON FreeBusyGroup where
        parseJSON
          = Core.withObject "FreeBusyGroup"
              (\ o ->
                 FreeBusyGroup Core.<$>
                   (o Core..:? "calendars") Core.<*> (o Core..:? "errors"))
...
newFreeBusyRequest 
    ::  FreeBusyRequest
newFreeBusyRequest
  = FreeBusyRequest{calendarExpansionMax = Core.Nothing,
                    groupExpansionMax = Core.Nothing, items = Core.Nothing,
                    timeMax = Core.Nothing, timeMin = Core.Nothing, timeZone = "UTC"}
...
newFreeBusyResponse 
    ::  FreeBusyResponse
newFreeBusyResponse
  = FreeBusyResponse{calendars = Core.Nothing, groups = Core.Nothing,
                     kind = "calendar#freeBusy", timeMax = Core.Nothing,
          ...
          = Core.withObject "FreeBusyResponse"
              (\ o ->
                 FreeBusyResponse Core.<$>
                   (o Core..:? "calendars") Core.<*> (o Core..:? "groups") Core.<*>
...
newSetting 
    ::  Setting
newSetting
  = Setting{etag = Core.Nothing, id = Core.Nothing,
            kind = "calendar#setting", value = Core.Nothing}
...
instance Core.ToJSON Setting where
        toJSON Setting{..}
          = Core.object
              (Core.catMaybes
                 [("etag" Core..=) Core.<$> etag, ("id" Core..=) Core.<$> id,
                  Core.Just ("kind" Core..= kind), ("value" Core..=) Core.<$> value])
...
newSettings 
    ::  Settings
newSettings
  = Settings{etag = Core.Nothing, items = Core.Nothing,
             kind = "calendar#settings", nextPageToken = Core.Nothing,
             nextSyncToken = Core.Nothing}
