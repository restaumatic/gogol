...
--
-- /See:/ <https://developers.google.com/workspace/calendar/firstapp Calendar API Reference> for @calendar.freebusy.query@.
module Gogol.AppsCalendar.Calendar.Freebusy.Query
    (
    -- * Resource
       ...
       "v3" Core.:>
         "freeBusy" Core.:>
           Core.QueryParam "alt" Core.AltJSON Core.:>
             Core.ReqBody '[Core.JSON] FreeBusyRequest Core.:>
               Core.Post '[Core.JSON] FreeBusyResponse
...
instance Core.GoogleRequest CalendarFreebusyQuery where
        ...
        type Scopes CalendarFreebusyQuery =
             '[Calendar'FullControl, Calendar'Events'Freebusy,
               Calendar'Freebusy, Calendar'Readonly]
