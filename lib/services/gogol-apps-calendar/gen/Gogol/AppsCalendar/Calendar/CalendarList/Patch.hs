...
--
-- /See:/ <https://developers.google.com/workspace/calendar/firstapp Calendar API Reference> for @calendar.calendarList.patch@.
module Gogol.AppsCalendar.Calendar.CalendarList.Patch
    (
    -- * Resource
...
newCalendarCalendarListPatch calendarId payload
  = CalendarCalendarListPatch{calendarId = calendarId,
