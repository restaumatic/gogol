...
--
-- /See:/ <https://developers.google.com/workspace/calendar/firstapp Calendar API Reference> for @calendar.calendarList.delete@.
module Gogol.AppsCalendar.Calendar.CalendarList.Delete
    (
    -- * Resource
...
instance Core.GoogleRequest CalendarCalendarListDelete where
        ...
        type Scopes CalendarCalendarListDelete =
