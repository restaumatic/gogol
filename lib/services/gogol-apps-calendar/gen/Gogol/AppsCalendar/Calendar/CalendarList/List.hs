...
--
-- /See:/ <https://developers.google.com/workspace/calendar/firstapp Calendar API Reference> for @calendar.calendarList.list@.
module Gogol.AppsCalendar.Calendar.CalendarList.List
    (
    -- * Resource
           ...
           "me" Core.:>
             "calendarList" Core.:>
               Core.QueryParam "maxResults" Core.Int32 Core.:>
                 Core.QueryParam "minAccessRole" CalendarListListMinAccessRole
                   Core.:>
                       ...
                       Core.QueryParam "showHidden" Core.Bool Core.:>
                         Core.QueryParam "syncToken" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] CalendarList
...
newCalendarCalendarListList 
    ::  CalendarCalendarListList
newCalendarCalendarListList
  = CalendarCalendarListList{maxResults = Core.Nothing,
                             minAccessRole = Core.Nothing, pageToken = Core.Nothing,
                             showDeleted = Core.Nothing, showHidden = Core.Nothing,
...
instance Core.GoogleRequest CalendarCalendarListList where
        ...
        type Scopes CalendarCalendarListList =
