...
--
-- /See:/ <https://developers.google.com/workspace/calendar/firstapp Calendar API Reference> for @calendar.calendarList.insert@.
module Gogol.AppsCalendar.Calendar.CalendarList.Insert
    (
    -- * Resource
...
newCalendarCalendarListInsert payload
  = CalendarCalendarListInsert{colorRgbFormat = Core.Nothing,
                               payload = payload}
