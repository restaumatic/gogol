...
--
-- /See:/ <https://developers.google.com/workspace/calendar/firstapp Calendar API Reference> for @calendar.calendars.patch@.
module Gogol.AppsCalendar.Calendar.Calendars.Patch
    (
    -- * Resource
...
newCalendarCalendarsPatch calendarId payload
  = CalendarCalendarsPatch{calendarId = calendarId,
                           payload = payload}
