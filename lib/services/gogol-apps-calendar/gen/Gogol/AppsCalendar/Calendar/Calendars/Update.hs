...
--
-- /See:/ <https://developers.google.com/workspace/calendar/firstapp Calendar API Reference> for @calendar.calendars.update@.
module Gogol.AppsCalendar.Calendar.Calendars.Update
    (
    -- * Resource
...
newCalendarCalendarsUpdate calendarId payload
  = CalendarCalendarsUpdate{calendarId = calendarId,
                            payload = payload}
