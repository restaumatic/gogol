...
--
-- /See:/ <https://developers.google.com/workspace/calendar/firstapp Calendar API Reference> for @calendar.calendars.get@.
module Gogol.AppsCalendar.Calendar.Calendars.Get
    (
    -- * Resource
...
instance Core.GoogleRequest CalendarCalendarsGet where
        ...
        type Scopes CalendarCalendarsGet =
             '[Calendar'FullControl, Calendar'App'Created, Calendar'Calendars,
               Calendar'Calendars'Readonly, Calendar'Readonly]
