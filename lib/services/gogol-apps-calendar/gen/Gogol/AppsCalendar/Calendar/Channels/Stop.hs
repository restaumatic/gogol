...
--
-- /See:/ <https://developers.google.com/workspace/calendar/firstapp Calendar API Reference> for @calendar.channels.stop@.
module Gogol.AppsCalendar.Calendar.Channels.Stop
    (
    -- * Resource
         ...
         "channels" Core.:>
           "stop" Core.:>
             Core.QueryParam "alt" Core.AltJSON Core.:>
               Core.ReqBody '[Core.JSON] Channel Core.:> Core.Post '[Core.JSON] ()
...
instance Core.GoogleRequest CalendarChannelsStop where
        ...
        type Scopes CalendarChannelsStop =
             '[Calendar'FullControl, Calendar'Acls, Calendar'Acls'Readonly,
               Calendar'App'Created, Calendar'Calendarlist,
               Calendar'Calendarlist'Readonly, Calendar'Events,
