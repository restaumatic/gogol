...
--
-- /See:/ <https://developers.google.com/workspace/calendar/firstapp Calendar API Reference> for @calendar.colors.get@.
module Gogol.AppsCalendar.Calendar.Colors.Get
    (
    -- * Resource
...
instance Core.GoogleRequest CalendarColorsGet where
        ...
        type Scopes CalendarColorsGet =
             '[Calendar'FullControl, Calendar'App'Created,
