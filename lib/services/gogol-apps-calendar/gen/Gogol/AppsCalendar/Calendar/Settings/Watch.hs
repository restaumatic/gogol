...
--
-- /See:/ <https://developers.google.com/workspace/calendar/firstapp Calendar API Reference> for @calendar.settings.watch@.
module Gogol.AppsCalendar.Calendar.Settings.Watch
    (
    -- * Resource
...
newCalendarSettingsWatch payload
  = CalendarSettingsWatch{maxResults = Core.Nothing,
