...
--
-- /See:/ <https://developers.google.com/workspace/calendar/firstapp Calendar API Reference> for @calendar.acl.patch@.
module Gogol.AppsCalendar.Calendar.Acl.Patch
    (
    -- * Resource
...
newCalendarAclPatch calendarId payload ruleId
  = CalendarAclPatch{calendarId = calendarId, payload = payload,
