...
--
-- /See:/ <https://developers.google.com/workspace/calendar/firstapp Calendar API Reference> for @calendar.acl.list@.
module Gogol.AppsCalendar.Calendar.Acl.List
    (
    -- * Resource
...
newCalendarAclList calendarId
  = CalendarAclList{calendarId = calendarId,
                    maxResults = Core.Nothing, pageToken = Core.Nothing,
                    showDeleted = Core.Nothing, syncToken = Core.Nothing}
