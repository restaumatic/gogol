...
--
-- /See:/ <https://developers.google.com/workspace/calendar/firstapp Calendar API Reference> for @calendar.acl.watch@.
module Gogol.AppsCalendar.Calendar.Acl.Watch
    (
    -- * Resource
...
newCalendarAclWatch calendarId payload
  = CalendarAclWatch{calendarId = calendarId,
