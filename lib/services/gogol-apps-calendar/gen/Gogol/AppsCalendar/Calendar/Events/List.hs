...
--
-- /See:/ <https://developers.google.com/workspace/calendar/firstapp Calendar API Reference> for @calendar.events.list@.
module Gogol.AppsCalendar.Calendar.Events.List
    (
    -- * Resource
           ...
           Core.Capture "calendarId" Core.Text Core.:>
             "events" Core.:>
               Core.QueryParam "alwaysIncludeEmail" Core.Bool Core.:>
                 Core.QueryParams "eventTypes" EventsListEventTypes Core.:>
                                           ...
                                           Core.QueryParam "timeMax" Core.DateTime Core.:>
                                             Core.QueryParam "timeMin" Core.DateTime Core.:>
                                               Core.QueryParam "timeZone" Core.Text Core.:>
                                                 Core.QueryParam "updatedMin" Core.DateTime Core.:>
                                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                                     Core.Get '[Core.JSON] Events
...
newCalendarEventsList calendarId
  = CalendarEventsList{alwaysIncludeEmail = Core.Nothing,
                       ...
                       privateExtendedProperty = Core.Nothing, q = Core.Nothing,
                       sharedExtendedProperty = Core.Nothing, showDeleted = Core.Nothing,
                       showHiddenInvitations = Core.Nothing, singleEvents = Core.Nothing,
                       syncToken = Core.Nothing, timeMax = Core.Nothing,
                       timeMin = Core.Nothing, timeZone = Core.Nothing,
