...
--
-- /See:/ <https://developers.google.com/workspace/calendar/firstapp Calendar API Reference> for @calendar.events.instances@.
module Gogol.AppsCalendar.Calendar.Events.Instances
    (
    -- * Resource
                   ...
                   Core.QueryParam "alwaysIncludeEmail" Core.Bool Core.:>
                     Core.QueryParam "maxAttendees" Core.Int32 Core.:>
                       Core.QueryParam "maxResults" Core.Int32 Core.:>
                         Core.QueryParam "originalStart" Core.Text Core.:>
...
newCalendarEventsInstances calendarId eventId
  = CalendarEventsInstances{alwaysIncludeEmail = Core.Nothing,
                            calendarId = calendarId, eventId = eventId,
                            maxAttendees = Core.Nothing, maxResults = Core.Nothing,
                            originalStart = Core.Nothing, pageToken = Core.Nothing,
                            showDeleted = Core.Nothing, timeMax = Core.Nothing,
...
instance Core.GoogleRequest CalendarEventsInstances where
        ...
        type Scopes CalendarEventsInstances =
        ...
        requestClient CalendarEventsInstances{..}
          = go calendarId eventId alwaysIncludeEmail maxAttendees maxResults
              originalStart
              pageToken
              showDeleted
              timeMax
