...
-- Deletes an event.
--
-- /See:/ <https://developers.google.com/workspace/calendar/firstapp Calendar API Reference> for @calendar.events.delete@.
module Gogol.AppsCalendar.Calendar.Events.Delete
    (
    -- * Resource
             ...
             "events" Core.:>
               Core.Capture "eventId" Core.Text Core.:>
                 Core.QueryParam "sendNotifications" Core.Bool Core.:>
                   Core.QueryParam "sendUpdates" EventsDeleteSendUpdates Core.:>
...
newCalendarEventsDelete calendarId eventId
  = CalendarEventsDelete{calendarId = calendarId, eventId = eventId,
