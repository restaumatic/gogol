...
--
-- /See:/ <https://developers.google.com/workspace/calendar/firstapp Calendar API Reference> for @calendar.events.patch@.
module Gogol.AppsCalendar.Calendar.Events.Patch
    (
    -- * Resource
                   ...
                   Core.QueryParam "conferenceDataVersion" Core.Int32 Core.:>
                     Core.QueryParam "maxAttendees" Core.Int32 Core.:>
                       Core.QueryParam "sendNotifications" Core.Bool Core.:>
                         Core.QueryParam "sendUpdates" EventsPatchSendUpdates Core.:>
...
newCalendarEventsPatch calendarId eventId payload
  = CalendarEventsPatch{alwaysIncludeEmail = Core.Nothing,
