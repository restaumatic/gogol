...
--
-- /See:/ <https://developers.google.com/workspace/calendar/firstapp Calendar API Reference> for @calendar.events.move@.
module Gogol.AppsCalendar.Calendar.Events.Move
    (
    -- * Resource
                 ...
                 "move" Core.:>
                   Core.QueryParam "destination" Core.Text Core.:>
                     Core.QueryParam "sendNotifications" Core.Bool Core.:>
                       Core.QueryParam "sendUpdates" EventsMoveSendUpdates Core.:>
...
newCalendarEventsMove calendarId destination eventId
  = CalendarEventsMove{calendarId = calendarId,
...
instance Core.GoogleRequest CalendarEventsMove where
        ...
        requestClient CalendarEventsMove{..}
          = go calendarId eventId (Core.Just destination) sendNotifications
              sendUpdates
