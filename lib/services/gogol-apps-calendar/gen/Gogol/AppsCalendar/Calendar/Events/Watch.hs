...
--
-- /See:/ <https://developers.google.com/workspace/calendar/firstapp Calendar API Reference> for @calendar.events.watch@.
module Gogol.AppsCalendar.Calendar.Events.Watch
    (
    -- * Resource
       ...
       "v3" Core.:>
         "calendars" Core.:>
           Core.Capture "calendarId" Core.Text Core.:>
             "events" Core.:>
               "watch" Core.:>
                 Core.QueryParam "alwaysIncludeEmail" Core.Bool Core.:>
                   Core.QueryParams "eventTypes" EventsWatchEventTypes Core.:>
                         ...
                         Core.QueryParam "maxResults" Core.Int32 Core.:>
                           Core.QueryParam "orderBy" EventsWatchOrderBy Core.:>
                             Core.QueryParam "pageToken" Core.Text Core.:>
                               Core.QueryParams "privateExtendedProperty" Core.Text Core.:>
                                 Core.QueryParam "q" Core.Text Core.:>
                                   Core.QueryParams "sharedExtendedProperty" Core.Text Core.:>
                                     Core.QueryParam "showDeleted" Core.Bool Core.:>
                                       Core.QueryParam "showHiddenInvitations" Core.Bool Core.:>
                                         Core.QueryParam "singleEvents" Core.Bool Core.:>
                                           Core.QueryParam "syncToken" Core.Text Core.:>
                                             Core.QueryParam "timeMax" Core.DateTime Core.:>
                                               Core.QueryParam "timeMin" Core.DateTime Core.:>
                                                 Core.QueryParam "timeZone" Core.Text Core.:>
                                                   Core.QueryParam "updatedMin" Core.DateTime
                                                     Core.:>
...
newCalendarEventsWatch calendarId payload
  = CalendarEventsWatch{alwaysIncludeEmail = Core.Nothing,
                        calendarId = calendarId, eventTypes = Core.Nothing,
                        iCalUID = Core.Nothing, maxAttendees = Core.Nothing,
                        maxResults = 250, orderBy = Core.Nothing, pageToken = Core.Nothing,
                        payload = payload, privateExtendedProperty = Core.Nothing,
                        q = Core.Nothing, sharedExtendedProperty = Core.Nothing,
                        showDeleted = Core.Nothing, showHiddenInvitations = Core.Nothing,
                        singleEvents = Core.Nothing, syncToken = Core.Nothing,
                        timeMax = Core.Nothing, timeMin = Core.Nothing,
                        timeZone = Core.Nothing, updatedMin = Core.Nothing}
instance Core.GoogleRequest CalendarEventsWatch where
        type Rs CalendarEventsWatch = Channel
        type Scopes CalendarEventsWatch =
             '[Calendar'FullControl, Calendar'App'Created, Calendar'Events,
               Calendar'Events'Freebusy, Calendar'Events'Owned,
               Calendar'Events'Owned'Readonly, Calendar'Events'Public'Readonly,
