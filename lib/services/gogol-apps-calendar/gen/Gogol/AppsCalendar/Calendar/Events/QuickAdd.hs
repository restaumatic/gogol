...
--
-- /See:/ <https://developers.google.com/workspace/calendar/firstapp Calendar API Reference> for @calendar.events.quickAdd@.
module Gogol.AppsCalendar.Calendar.Events.QuickAdd
    (
    -- * Resource
               ...
               "quickAdd" Core.:>
                 Core.QueryParam "text" Core.Text Core.:>
                   Core.QueryParam "sendNotifications" Core.Bool Core.:>
                     Core.QueryParam "sendUpdates" EventsQuickAddSendUpdates Core.:>
...
newCalendarEventsQuickAdd calendarId text
  = CalendarEventsQuickAdd{calendarId = calendarId,
...
instance Core.GoogleRequest CalendarEventsQuickAdd where
        ...
        requestClient CalendarEventsQuickAdd{..}
          = go calendarId (Core.Just text) sendNotifications sendUpdates
