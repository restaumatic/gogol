...
-- Updates an event.
--
-- /See:/ <https://developers.google.com/workspace/calendar/firstapp Calendar API Reference> for @calendar.events.update@.
module Gogol.AppsCalendar.Calendar.Events.Update
    (
    -- * Resource
             ...
             "events" Core.:>
               Core.Capture "eventId" Core.Text Core.:>
                 Core.QueryParam "alwaysIncludeEmail" Core.Bool Core.:>
                   Core.QueryParam "conferenceDataVersion" Core.Int32 Core.:>
                     Core.QueryParam "maxAttendees" Core.Int32 Core.:>
                       Core.QueryParam "sendNotifications" Core.Bool Core.:>
                         Core.QueryParam "sendUpdates" EventsUpdateSendUpdates Core.:>
                           Core.QueryParam "supportsAttachments" Core.Bool Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.ReqBody '[Core.JSON] Event Core.:> Core.Put '[Core.JSON] Event
...
newCalendarEventsUpdate calendarId eventId payload
  = CalendarEventsUpdate{alwaysIncludeEmail = Core.Nothing,
                         calendarId = calendarId, conferenceDataVersion = Core.Nothing,
                         eventId = eventId, maxAttendees = Core.Nothing, payload = payload,
                         sendNotifications = Core.Nothing, sendUpdates = Core.Nothing,
...
instance Core.GoogleRequest CalendarEventsUpdate where
        ...
        requestClient CalendarEventsUpdate{..}
          = go calendarId eventId alwaysIncludeEmail conferenceDataVersion
              maxAttendees
              sendNotifications
              sendUpdates
              supportsAttachments
