           ...
           Core.QueryParam "access_token" Core.Text Core.:>
             Core.QueryParam "androidId" Core.Text Core.:>
               Core.QueryParam "callback" Core.Text Core.:>
                 Core.QueryParam "iosDeviceId" Core.Text Core.:>
...
data CloudIdentityDevicesDeviceUsersLookup = CloudIdentityDevicesDeviceUsersLookup
    ...
    , iosDeviceId :: (Core.Maybe Core.Text)
...
newCloudIdentityDevicesDeviceUsersLookup parent
  = CloudIdentityDevicesDeviceUsersLookup{xgafv = Core.Nothing,
                                          ...
                                          callback = Core.Nothing, iosDeviceId = Core.Nothing,
                                          pageSize = Core.Nothing, pageToken = Core.Nothing,
                                          parent = parent, partner = Core.Nothing,
...
instance Core.GoogleRequest CloudIdentityDevicesDeviceUsersLookup
        ...
        requestClient CloudIdentityDevicesDeviceUsersLookup{..}
          = go parent xgafv accessToken androidId callback iosDeviceId
              pageSize
              pageToken
              partner
              rawResourceId
