...
newCloudIdentityDevicesDeviceUsersList parent
  = CloudIdentityDevicesDeviceUsersList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest CloudIdentityDevicesDeviceUsersList
         where
        type Rs CloudIdentityDevicesDeviceUsersList =
             GoogleAppsCloudidentityDevicesV1ListDeviceUsersResponse
        type Scopes CloudIdentityDevicesDeviceUsersList =
        ...
        requestClient CloudIdentityDevicesDeviceUsersList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudIdentityDevicesDeviceUsersListResource)
                      Core.mempty
