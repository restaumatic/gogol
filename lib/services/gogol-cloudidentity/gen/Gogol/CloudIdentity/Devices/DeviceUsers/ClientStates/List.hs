...
newCloudIdentityDevicesDeviceUsersClientStatesList parent
  = CloudIdentityDevicesDeviceUsersClientStatesList{xgafv =
                                                      Core.Nothing,
                                                    accessToken = Core.Nothing,
                                                    callback = Core.Nothing,
                                                    customer = Core.Nothing, filter = Core.Nothing,
...
instance Core.GoogleRequest
           CloudIdentityDevicesDeviceUsersClientStatesList
         where
        type Rs CloudIdentityDevicesDeviceUsersClientStatesList =
             GoogleAppsCloudidentityDevicesV1ListClientStatesResponse
        type Scopes CloudIdentityDevicesDeviceUsersClientStatesList =
             '[CloudIdentity'Devices, CloudIdentity'Devices'Readonly]
        requestClient CloudIdentityDevicesDeviceUsersClientStatesList{..}
          = go parent xgafv accessToken callback customer filter orderBy
              pageToken
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudIdentityDevicesDeviceUsersClientStatesListResource)
                      Core.mempty
