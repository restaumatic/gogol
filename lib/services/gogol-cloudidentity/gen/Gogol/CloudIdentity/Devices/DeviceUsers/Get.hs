                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.Get '[Core.JSON] GoogleAppsCloudidentityDevicesV1DeviceUser
...
newCloudIdentityDevicesDeviceUsersGet name
  = CloudIdentityDevicesDeviceUsersGet{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       customer = Core.Nothing, name = name,
                                       uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudIdentityDevicesDeviceUsersGet
         where
        ...
        requestClient CloudIdentityDevicesDeviceUsersGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudIdentityDevicesDeviceUsersGetResource)
                      Core.mempty
