...
newCloudIdentityDevicesDeviceUsersApprove name payload
  = CloudIdentityDevicesDeviceUsersApprove{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           name = name, payload = payload,
                                           uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudIdentityDevicesDeviceUsersApprove
         where
        type Rs CloudIdentityDevicesDeviceUsersApprove = Operation
        type Scopes CloudIdentityDevicesDeviceUsersApprove =
             '[CloudIdentity'Devices]
        requestClient CloudIdentityDevicesDeviceUsersApprove{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudIdentityDevicesDeviceUsersApproveResource)
                      Core.mempty
