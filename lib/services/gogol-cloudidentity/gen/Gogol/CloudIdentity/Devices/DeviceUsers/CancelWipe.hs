...
type CloudIdentityDevicesDeviceUsersCancelWipeResource =
     "v1" Core.:>
       Core.CaptureMode "name" "cancelWipe" Core.Text Core.:>
...
newCloudIdentityDevicesDeviceUsersCancelWipe name payload
  = CloudIdentityDevicesDeviceUsersCancelWipe{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           CloudIdentityDevicesDeviceUsersCancelWipe
         where
        type Rs CloudIdentityDevicesDeviceUsersCancelWipe = Operation
        type Scopes CloudIdentityDevicesDeviceUsersCancelWipe =
             '[CloudIdentity'Devices]
        requestClient CloudIdentityDevicesDeviceUsersCancelWipe{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudIdentityDevicesDeviceUsersCancelWipeResource)
                      Core.mempty
