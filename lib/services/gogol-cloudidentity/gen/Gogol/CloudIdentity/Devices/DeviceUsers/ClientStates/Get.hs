                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.Get '[Core.JSON] GoogleAppsCloudidentityDevicesV1ClientState
...
newCloudIdentityDevicesDeviceUsersClientStatesGet name
  = CloudIdentityDevicesDeviceUsersClientStatesGet{xgafv =
                                                     Core.Nothing,
                                                   accessToken = Core.Nothing,
                                                   callback = Core.Nothing, customer = Core.Nothing,
                                                   name = name, uploadType = Core.Nothing,
                                                   uploadProtocol = Core.Nothing}
instance Core.GoogleRequest
           CloudIdentityDevicesDeviceUsersClientStatesGet
         where
        type Rs CloudIdentityDevicesDeviceUsersClientStatesGet =
             GoogleAppsCloudidentityDevicesV1ClientState
        type Scopes CloudIdentityDevicesDeviceUsersClientStatesGet =
             '[CloudIdentity'Devices, CloudIdentity'Devices'Readonly]
        requestClient CloudIdentityDevicesDeviceUsersClientStatesGet{..}
          = go name xgafv accessToken callback customer uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudIdentityDevicesDeviceUsersClientStatesGetResource)
                      Core.mempty
