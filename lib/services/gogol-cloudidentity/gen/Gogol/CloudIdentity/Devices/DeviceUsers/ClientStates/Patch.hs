...
newCloudIdentityDevicesDeviceUsersClientStatesPatch name payload
  = CloudIdentityDevicesDeviceUsersClientStatesPatch{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           CloudIdentityDevicesDeviceUsersClientStatesPatch
         where
        type Rs CloudIdentityDevicesDeviceUsersClientStatesPatch =
             Operation
        type Scopes CloudIdentityDevicesDeviceUsersClientStatesPatch =
             '[CloudIdentity'Devices]
        requestClient CloudIdentityDevicesDeviceUsersClientStatesPatch{..}
          = go name xgafv accessToken callback customer updateMask uploadType
              uploadProtocol
