...
newCloudIdentityDevicesDeviceUsersDelete name
  = CloudIdentityDevicesDeviceUsersDelete{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          customer = Core.Nothing, name = name,
                                          uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudIdentityDevicesDeviceUsersDelete
         where
        type Rs CloudIdentityDevicesDeviceUsersDelete = Operation
        type Scopes CloudIdentityDevicesDeviceUsersDelete =
             '[CloudIdentity'Devices]
        requestClient CloudIdentityDevicesDeviceUsersDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudIdentityDevicesDeviceUsersDeleteResource)
                      Core.mempty
