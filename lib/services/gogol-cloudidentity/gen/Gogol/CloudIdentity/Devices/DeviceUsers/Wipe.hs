...
newCloudIdentityDevicesDeviceUsersWipe name payload
  = CloudIdentityDevicesDeviceUsersWipe{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        name = name, payload = payload, uploadType = Core.Nothing,
                                        uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudIdentityDevicesDeviceUsersWipe
         where
        type Rs CloudIdentityDevicesDeviceUsersWipe = Operation
        ...
        requestClient CloudIdentityDevicesDeviceUsersWipe{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudIdentityDevicesDeviceUsersWipeResource)
                      Core.mempty
