...
newCloudIdentityDevicesCancelWipe name payload
  = CloudIdentityDevicesCancelWipe{xgafv = Core.Nothing,
                                   accessToken = Core.Nothing, callback = Core.Nothing, name = name,
                                   payload = payload, uploadType = Core.Nothing,
                                   uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudIdentityDevicesCancelWipe where
        ...
        requestClient CloudIdentityDevicesCancelWipe{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy CloudIdentityDevicesCancelWipeResource)
                      Core.mempty
