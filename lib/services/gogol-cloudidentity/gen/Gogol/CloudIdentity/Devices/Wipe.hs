...
-- |
-- Module      : Gogol.CloudIdentity.Devices.Wipe
...
newCloudIdentityDevicesWipe name payload
  = CloudIdentityDevicesWipe{xgafv = Core.Nothing,
...
instance Core.GoogleRequest CloudIdentityDevicesWipe where
        ...
        type Scopes CloudIdentityDevicesWipe = '[CloudIdentity'Devices]
        requestClient CloudIdentityDevicesWipe{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy CloudIdentityDevicesWipeResource)
                      Core.mempty
