                       ...
                       Core.QueryParam "pageToken" Core.Text Core.:>
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "view" DevicesListView Core.:>
...
newCloudIdentityDevicesList 
    ::  CloudIdentityDevicesList
newCloudIdentityDevicesList
  = CloudIdentityDevicesList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest CloudIdentityDevicesList where
        type Rs CloudIdentityDevicesList =
             GoogleAppsCloudidentityDevicesV1ListDevicesResponse
        type Scopes CloudIdentityDevicesList =
             '[CloudIdentity'Devices, CloudIdentity'Devices'Readonly]
        requestClient CloudIdentityDevicesList{..}
          = go xgafv accessToken callback customer filter orderBy pageSize
              pageToken
              uploadType
              uploadProtocol
              view
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy CloudIdentityDevicesListResource)
                      Core.mempty
