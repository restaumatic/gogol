                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] ListInboundSsoAssignmentsResponse
...
newCloudIdentityInboundSsoAssignmentsList 
    :: 
                                          CloudIdentityInboundSsoAssignmentsList
newCloudIdentityInboundSsoAssignmentsList
  = CloudIdentityInboundSsoAssignmentsList{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           filter = Core.Nothing, pageSize = Core.Nothing,
                                           pageToken = Core.Nothing, uploadType = Core.Nothing,
                                           uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudIdentityInboundSsoAssignmentsList
         where
        ...
        requestClient CloudIdentityInboundSsoAssignmentsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudIdentityInboundSsoAssignmentsListResource)
                      Core.mempty
