...
newCloudIdentityInboundSsoAssignmentsDelete name
  = CloudIdentityInboundSsoAssignmentsDelete{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           CloudIdentityInboundSsoAssignmentsDelete
         where
        type Rs CloudIdentityInboundSsoAssignmentsDelete = Operation
        type Scopes CloudIdentityInboundSsoAssignmentsDelete =
             '[CloudIdentity'Inboundsso, CloudPlatform'FullControl]
        requestClient CloudIdentityInboundSsoAssignmentsDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudIdentityInboundSsoAssignmentsDeleteResource)
                      Core.mempty
