...
newCloudIdentityInboundSsoAssignmentsGet name
  = CloudIdentityInboundSsoAssignmentsGet{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          name = name, uploadType = Core.Nothing,
                                          uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudIdentityInboundSsoAssignmentsGet
         where
        ...
        requestClient CloudIdentityInboundSsoAssignmentsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudIdentityInboundSsoAssignmentsGetResource)
                      Core.mempty
