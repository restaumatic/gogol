  ...
  (
    ...
    InboundSsoAssignment_SsoMode
      (
        ...
        InboundSsoAssignment_SsoMode_OIDCSSO,
...
pattern InboundSsoAssignment_SsoMode_OIDCSSO :: InboundSsoAssignment_SsoMode
pattern InboundSsoAssignment_SsoMode_OIDCSSO = InboundSsoAssignment_SsoMode "OIDC_SSO"
