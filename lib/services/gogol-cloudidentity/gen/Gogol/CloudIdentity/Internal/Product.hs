...
module Gogol.CloudIdentity.Internal.Product
  (
    ...
    CreateInboundOidcSsoProfileOperationMetadata (..),
    newCreateInboundOidcSsoProfileOperationMetadata,
    ...
    DeleteInboundOidcSsoProfileOperationMetadata (..),
    newDeleteInboundOidcSsoProfileOperationMetadata,
    ...
    ListInboundOidcSsoProfilesResponse (..),
    newListInboundOidcSsoProfilesResponse,
    ...
    UpdateInboundOidcSsoProfileOperationMetadata (..),
    newUpdateInboundOidcSsoProfileOperationMetadata,
...
--
-- /See:/ 'newCreateInboundOidcSsoProfileOperationMetadata' smart constructor.
newtype CreateInboundOidcSsoProfileOperationMetadata = CreateInboundOidcSsoProfileOperationMetadata
    {
      -- | State of this Operation Will be \"awaiting-multi-party-approval\" when the operation is deferred due to the target customer having enabled <https://support.google.com/a/answer/13790448 Multi-party approval for sensitive actions>.
      state :: (Core.Maybe Core.Text)
    }
...
-- | Creates a value of 'CreateInboundOidcSsoProfileOperationMetadata' with the minimum fields required to make a request.
newCreateInboundOidcSsoProfileOperationMetadata 
    :: 
                                                CreateInboundOidcSsoProfileOperationMetadata
newCreateInboundOidcSsoProfileOperationMetadata
  = CreateInboundOidcSsoProfileOperationMetadata{state =
                                                   Core.Nothing}
instance Core.FromJSON CreateInboundOidcSsoProfileOperationMetadata
         where
        parseJSON
          = Core.withObject "CreateInboundOidcSsoProfileOperationMetadata"
              (\ o ->
                 CreateInboundOidcSsoProfileOperationMetadata Core.<$>
                   (o Core..:? "state"))

instance Core.ToJSON CreateInboundOidcSsoProfileOperationMetadata
         where
        toJSON CreateInboundOidcSsoProfileOperationMetadata{..}
          = Core.object (Core.catMaybes [("state" Core..=) Core.<$> state])
...
--
-- /See:/ 'newDeleteInboundOidcSsoProfileOperationMetadata' smart constructor.
data DeleteInboundOidcSsoProfileOperationMetadata = DeleteInboundOidcSsoProfileOperationMetadata
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'DeleteInboundOidcSsoProfileOperationMetadata' with the minimum fields required to make a request.
newDeleteInboundOidcSsoProfileOperationMetadata 
    :: 
                                                DeleteInboundOidcSsoProfileOperationMetadata
newDeleteInboundOidcSsoProfileOperationMetadata
  = DeleteInboundOidcSsoProfileOperationMetadata
instance Core.FromJSON DeleteInboundOidcSsoProfileOperationMetadata
         where
        parseJSON
          = Core.withObject "DeleteInboundOidcSsoProfileOperationMetadata"
              (\ o -> Core.pure DeleteInboundOidcSsoProfileOperationMetadata)

instance Core.ToJSON DeleteInboundOidcSsoProfileOperationMetadata
         where
        toJSON = Core.const Core.emptyObject
...
-- | An <https://openid.net/developers/how-connect-works/ OIDC> federation between a Google enterprise customer and an OIDC identity provider.
--
-- /See:/ 'newInboundOidcSsoProfile' smart constructor.
data InboundOidcSsoProfile = InboundOidcSsoProfile
    {
    ...
    , idpConfig :: (Core.Maybe OidcIdpConfig)
    ...
    , rpConfig :: (Core.Maybe OidcRpConfig)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'InboundOidcSsoProfile' with the minimum fields required to make a request.
newInboundOidcSsoProfile 
    ::  InboundOidcSsoProfile
newInboundOidcSsoProfile
  = InboundOidcSsoProfile{customer = Core.Nothing,
                          displayName = Core.Nothing, idpConfig = Core.Nothing,
                          name = Core.Nothing, rpConfig = Core.Nothing}
instance Core.FromJSON InboundOidcSsoProfile where
        parseJSON
          = Core.withObject "InboundOidcSsoProfile"
              (\ o ->
                 InboundOidcSsoProfile Core.<$>
                   (o Core..:? "customer") Core.<*> (o Core..:? "displayName")
                     Core.<*> (o Core..:? "idpConfig")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "rpConfig"))

instance Core.ToJSON InboundOidcSsoProfile where
        toJSON InboundOidcSsoProfile{..}
          = Core.object
              (Core.catMaybes
                 [("customer" Core..=) Core.<$> customer,
                  ("displayName" Core..=) Core.<$> displayName,
...
data InboundSsoAssignment = InboundSsoAssignment
    ...
    , oidcSsoInfo :: (Core.Maybe OidcSsoInfo)
...
newInboundSsoAssignment
  = InboundSsoAssignment{customer = Core.Nothing,
                         name = Core.Nothing, oidcSsoInfo = Core.Nothing,
                         rank = Core.Nothing, samlSsoInfo = Core.Nothing,
                         signInBehavior = Core.Nothing, ssoMode = Core.Nothing,
                         targetGroup = Core.Nothing, targetOrgUnit = Core.Nothing}
        ...
        toJSON InboundSsoAssignment{..}
          = Core.object
              (Core.catMaybes
                 [("customer" Core..=) Core.<$> customer,
                  ("name" Core..=) Core.<$> name,
                  ("oidcSsoInfo" Core..=) Core.<$> oidcSsoInfo,
                  ("rank" Core..=) Core.<$> rank,
...
--
-- /See:/ 'newListInboundOidcSsoProfilesResponse' smart constructor.
data ListInboundOidcSsoProfilesResponse = ListInboundOidcSsoProfilesResponse
    {
      -- | List of InboundOidcSsoProfiles.
      inboundOidcSsoProfiles :: (Core.Maybe [InboundOidcSsoProfile])
      -- | A token, which can be sent as @page_token@ to retrieve the next page. If this field is omitted, there are no subsequent pages.
    , nextPageToken :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'ListInboundOidcSsoProfilesResponse' with the minimum fields required to make a request.
newListInboundOidcSsoProfilesResponse 
    :: 
                                      ListInboundOidcSsoProfilesResponse
newListInboundOidcSsoProfilesResponse
  = ListInboundOidcSsoProfilesResponse{inboundOidcSsoProfiles =
                                         Core.Nothing,
                                       nextPageToken = Core.Nothing}
instance Core.FromJSON ListInboundOidcSsoProfilesResponse where
        parseJSON
          = Core.withObject "ListInboundOidcSsoProfilesResponse"
              (\ o ->
                 ListInboundOidcSsoProfilesResponse Core.<$>
                   (o Core..:? "inboundOidcSsoProfiles") Core.<*>
                     (o Core..:? "nextPageToken"))

instance Core.ToJSON ListInboundOidcSsoProfilesResponse where
        toJSON ListInboundOidcSsoProfilesResponse{..}
          = Core.object
              (Core.catMaybes
                 [("inboundOidcSsoProfiles" Core..=) Core.<$>
...
--
-- /See:/ 'newOidcIdpConfig' smart constructor.
data OidcIdpConfig = OidcIdpConfig
    {
      ...
      -- | Required. The Issuer identifier for the IdP. Must be a URL. The discovery URL will be derived from this as described in Section 4 of <https://openid.net/specs/openid-connect-discovery-1_0.html the OIDC specification>.
    , issuerUri :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'OidcIdpConfig' with the minimum fields required to make a request.
newOidcIdpConfig 
    ::  OidcIdpConfig
newOidcIdpConfig
  = OidcIdpConfig{changePasswordUri = Core.Nothing,
                  issuerUri = Core.Nothing}
instance Core.FromJSON OidcIdpConfig where
        parseJSON
          = Core.withObject "OidcIdpConfig"
              (\ o ->
                 OidcIdpConfig Core.<$>
                   (o Core..:? "changePasswordUri") Core.<*> (o Core..:? "issuerUri"))

instance Core.ToJSON OidcIdpConfig where
        toJSON OidcIdpConfig{..}
          = Core.object
              (Core.catMaybes
...
--
-- /See:/ 'newOidcRpConfig' smart constructor.
data OidcRpConfig = OidcRpConfig
    {
    ...
    , redirectUris :: (Core.Maybe [Core.Text])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'OidcRpConfig' with the minimum fields required to make a request.
newOidcRpConfig 
    ::  OidcRpConfig
newOidcRpConfig
  = OidcRpConfig{clientId = Core.Nothing,
                 clientSecret = Core.Nothing, redirectUris = Core.Nothing}
instance Core.FromJSON OidcRpConfig where
        parseJSON
          = Core.withObject "OidcRpConfig"
              (\ o ->
                 OidcRpConfig Core.<$>
                   (o Core..:? "clientId") Core.<*> (o Core..:? "clientSecret")
                     Core.<*> (o Core..:? "redirectUris"))

instance Core.ToJSON OidcRpConfig where
        toJSON OidcRpConfig{..}
          = Core.object
              (Core.catMaybes
                 [("clientId" Core..=) Core.<$> clientId,
                  ("clientSecret" Core..=) Core.<$> clientSecret,
                  ("redirectUris" Core..=) Core.<$> redirectUris])


-- | Details that are applicable when @sso_mode@ is set to @OIDC_SSO@.
--
-- /See:/ 'newOidcSsoInfo' smart constructor.
newtype OidcSsoInfo = OidcSsoInfo
    {
      -- | Required. Name of the @InboundOidcSsoProfile@ to use. Must be of the form @inboundOidcSsoProfiles\/{inbound_oidc_sso_profile}@.
      inboundOidcSsoProfile :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'OidcSsoInfo' with the minimum fields required to make a request.
newOidcSsoInfo 
    ::  OidcSsoInfo
newOidcSsoInfo = OidcSsoInfo{inboundOidcSsoProfile = Core.Nothing}
instance Core.FromJSON OidcSsoInfo where
        parseJSON
          = Core.withObject "OidcSsoInfo"
              (\ o -> OidcSsoInfo Core.<$> (o Core..:? "inboundOidcSsoProfile"))

instance Core.ToJSON OidcSsoInfo where
        toJSON OidcSsoInfo{..}
          = Core.object
              (Core.catMaybes
                 [("inboundOidcSsoProfile" Core..=) Core.<$> inboundOidcSsoProfile])
...
--
-- /See:/ 'newUpdateInboundOidcSsoProfileOperationMetadata' smart constructor.
newtype UpdateInboundOidcSsoProfileOperationMetadata = UpdateInboundOidcSsoProfileOperationMetadata
    {
      -- | State of this Operation Will be \"awaiting-multi-party-approval\" when the operation is deferred due to the target customer having enabled <https://support.google.com/a/answer/13790448 Multi-party approval for sensitive actions>.
      state :: (Core.Maybe Core.Text)
    }
...
-- | Creates a value of 'UpdateInboundOidcSsoProfileOperationMetadata' with the minimum fields required to make a request.
newUpdateInboundOidcSsoProfileOperationMetadata 
    :: 
                                                UpdateInboundOidcSsoProfileOperationMetadata
newUpdateInboundOidcSsoProfileOperationMetadata
  = UpdateInboundOidcSsoProfileOperationMetadata{state =
                                                   Core.Nothing}
instance Core.FromJSON UpdateInboundOidcSsoProfileOperationMetadata
         where
        parseJSON
          = Core.withObject "UpdateInboundOidcSsoProfileOperationMetadata"
              (\ o ->
                 UpdateInboundOidcSsoProfileOperationMetadata Core.<$>
                   (o Core..:? "state"))

instance Core.ToJSON UpdateInboundOidcSsoProfileOperationMetadata
         where
        toJSON UpdateInboundOidcSsoProfileOperationMetadata{..}
          = Core.object (Core.catMaybes [("state" Core..=) Core.<$> state])
