                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] ListInboundSamlSsoProfilesResponse
...
newCloudIdentityInboundSamlSsoProfilesList 
    :: 
                                           CloudIdentityInboundSamlSsoProfilesList
newCloudIdentityInboundSamlSsoProfilesList
  = CloudIdentityInboundSamlSsoProfilesList{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            filter = Core.Nothing, pageSize = Core.Nothing,
                                            pageToken = Core.Nothing, uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudIdentityInboundSamlSsoProfilesList
         where
