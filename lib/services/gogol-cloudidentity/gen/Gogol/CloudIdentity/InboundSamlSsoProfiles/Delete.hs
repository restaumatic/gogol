...
newCloudIdentityInboundSamlSsoProfilesDelete name
  = CloudIdentityInboundSamlSsoProfilesDelete{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           CloudIdentityInboundSamlSsoProfilesDelete
         where
        type Rs CloudIdentityInboundSamlSsoProfilesDelete = Operation
        type Scopes CloudIdentityInboundSamlSsoProfilesDelete =
             '[CloudIdentity'Inboundsso, CloudPlatform'FullControl]
        requestClient CloudIdentityInboundSamlSsoProfilesDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudIdentityInboundSamlSsoProfilesDeleteResource)
                      Core.mempty
