...
newCloudIdentityInboundSamlSsoProfilesIdpCredentialsGet name
  = CloudIdentityInboundSamlSsoProfilesIdpCredentialsGet{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           CloudIdentityInboundSamlSsoProfilesIdpCredentialsGet
         where
        type Rs CloudIdentityInboundSamlSsoProfilesIdpCredentialsGet =
             IdpCredential
        type Scopes CloudIdentityInboundSamlSsoProfilesIdpCredentialsGet =
