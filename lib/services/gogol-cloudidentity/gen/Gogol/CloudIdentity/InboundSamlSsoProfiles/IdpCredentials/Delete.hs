...
newCloudIdentityInboundSamlSsoProfilesIdpCredentialsDelete name
  = CloudIdentityInboundSamlSsoProfilesIdpCredentialsDelete{xgafv =
                                                              Core.Nothing,
...
instance Core.GoogleRequest
           CloudIdentityInboundSamlSsoProfilesIdpCredentialsDelete
         where
        type Rs CloudIdentityInboundSamlSsoProfilesIdpCredentialsDelete =
             Operation
        type Scopes CloudIdentityInboundSamlSsoProfilesIdpCredentialsDelete
