                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] AddIdpCredentialRequest Core.:>
...
newCloudIdentityInboundSamlSsoProfilesIdpCredentialsAdd 
    ...
    -> CloudIdentityInboundSamlSsoProfilesIdpCredentialsAdd
newCloudIdentityInboundSamlSsoProfilesIdpCredentialsAdd parent
  payload
  = CloudIdentityInboundSamlSsoProfilesIdpCredentialsAdd{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           CloudIdentityInboundSamlSsoProfilesIdpCredentialsAdd
         where
        type Rs CloudIdentityInboundSamlSsoProfilesIdpCredentialsAdd =
             Operation
        type Scopes CloudIdentityInboundSamlSsoProfilesIdpCredentialsAdd =
