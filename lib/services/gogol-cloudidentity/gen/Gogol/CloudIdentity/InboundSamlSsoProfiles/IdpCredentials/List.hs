...
newCloudIdentityInboundSamlSsoProfilesIdpCredentialsList parent
  = CloudIdentityInboundSamlSsoProfilesIdpCredentialsList{xgafv =
                                                            Core.Nothing,
...
instance Core.GoogleRequest
           CloudIdentityInboundSamlSsoProfilesIdpCredentialsList
         where
        type Rs CloudIdentityInboundSamlSsoProfilesIdpCredentialsList =
             ListIdpCredentialsResponse
        type Scopes CloudIdentityInboundSamlSsoProfilesIdpCredentialsList =
