...
type CloudIdentityCustomersUserinvitationsIsInvitableUserResource =
     "v1" Core.:>
       Core.CaptureMode "name" "isInvitableUser" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.Get '[Core.JSON] IsInvitableUserResponse
...
newCloudIdentityCustomersUserinvitationsIsInvitableUser name
  = CloudIdentityCustomersUserinvitationsIsInvitableUser{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           CloudIdentityCustomersUserinvitationsIsInvitableUser
         where
        type Rs CloudIdentityCustomersUserinvitationsIsInvitableUser =
             IsInvitableUserResponse
        type Scopes CloudIdentityCustomersUserinvitationsIsInvitableUser =
             '[]
        requestClient
          CloudIdentityCustomersUserinvitationsIsInvitableUser{..}
