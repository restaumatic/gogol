                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Get '[Core.JSON] ListUserInvitationsResponse
...
newCloudIdentityCustomersUserinvitationsList parent
  = CloudIdentityCustomersUserinvitationsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           CloudIdentityCustomersUserinvitationsList
         where
        type Rs CloudIdentityCustomersUserinvitationsList =
