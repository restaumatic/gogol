...
type CloudIdentityCustomersUserinvitationsSendResource =
     "v1" Core.:>
       Core.CaptureMode "name" "send" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] SendUserInvitationRequest Core.:>
...
newCloudIdentityCustomersUserinvitationsSend name payload
  = CloudIdentityCustomersUserinvitationsSend{xgafv = Core.Nothing,
