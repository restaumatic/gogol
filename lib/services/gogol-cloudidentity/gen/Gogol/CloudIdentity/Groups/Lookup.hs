           ...
           Core.QueryParam "access_token" Core.Text Core.:>
             Core.QueryParam "callback" Core.Text Core.:>
               Core.QueryParam "groupKey.id" Core.Text Core.:>
                 Core.QueryParam "groupKey.namespace" Core.Text Core.:>
...
newCloudIdentityGroupsLookup 
    ::  CloudIdentityGroupsLookup
newCloudIdentityGroupsLookup
  = CloudIdentityGroupsLookup{xgafv = Core.Nothing,
                              accessToken = Core.Nothing, callback = Core.Nothing,
                              groupKeyId = Core.Nothing, groupKeyNamespace = Core.Nothing,
                              uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudIdentityGroupsLookup where
        type Rs CloudIdentityGroupsLookup = LookupGroupNameResponse
        ...
        requestClient CloudIdentityGroupsLookup{..}
          = go xgafv accessToken callback groupKeyId groupKeyNamespace
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy CloudIdentityGroupsLookupResource)
                      Core.mempty
