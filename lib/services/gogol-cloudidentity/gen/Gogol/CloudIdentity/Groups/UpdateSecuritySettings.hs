                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] SecuritySettings Core.:>
...
newCloudIdentityGroupsUpdateSecuritySettings name payload
  = CloudIdentityGroupsUpdateSecuritySettings{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           CloudIdentityGroupsUpdateSecuritySettings
         where
        type Rs CloudIdentityGroupsUpdateSecuritySettings = Operation
        type Scopes CloudIdentityGroupsUpdateSecuritySettings =
             '[CloudIdentity'Groups, CloudPlatform'FullControl]
        requestClient CloudIdentityGroupsUpdateSecuritySettings{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudIdentityGroupsUpdateSecuritySettingsResource)
                      Core.mempty
