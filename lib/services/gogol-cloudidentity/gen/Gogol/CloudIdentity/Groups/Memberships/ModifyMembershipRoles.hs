...
type CloudIdentityGroupsMembershipsModifyMembershipRolesResource =
     "v1" Core.:>
       Core.CaptureMode "name" "modifyMembershipRoles" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] ModifyMembershipRolesRequest Core.:>
...
newCloudIdentityGroupsMembershipsModifyMembershipRoles name payload
  = CloudIdentityGroupsMembershipsModifyMembershipRoles{xgafv =
                                                          Core.Nothing,
...
instance Core.GoogleRequest
           CloudIdentityGroupsMembershipsModifyMembershipRoles
         where
        type Rs CloudIdentityGroupsMembershipsModifyMembershipRoles =
             ModifyMembershipRolesResponse
        type Scopes CloudIdentityGroupsMembershipsModifyMembershipRoles =
