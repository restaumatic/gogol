...
newCloudIdentityGroupsMembershipsSearchDirectGroups parent
  = CloudIdentityGroupsMembershipsSearchDirectGroups{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           CloudIdentityGroupsMembershipsSearchDirectGroups
         where
        type Rs CloudIdentityGroupsMembershipsSearchDirectGroups =
             SearchDirectGroupsResponse
        type Scopes CloudIdentityGroupsMembershipsSearchDirectGroups =
             '[CloudIdentity'Groups, CloudIdentity'Groups'Readonly,
               CloudPlatform'FullControl]
        requestClient CloudIdentityGroupsMembershipsSearchDirectGroups{..}
          = go parent xgafv accessToken callback orderBy pageSize pageToken
              query
              uploadType
              uploadProtocol
