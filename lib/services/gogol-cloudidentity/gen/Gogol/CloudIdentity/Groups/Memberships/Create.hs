...
newCloudIdentityGroupsMembershipsCreate parent payload
  = CloudIdentityGroupsMembershipsCreate{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         parent = parent, payload = payload,
                                         uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudIdentityGroupsMembershipsCreate
         where
        type Rs CloudIdentityGroupsMembershipsCreate = Operation
        type Scopes CloudIdentityGroupsMembershipsCreate =
