                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.Get '[Core.JSON] CheckTransitiveMembershipResponse
...
newCloudIdentityGroupsMembershipsCheckTransitiveMembership parent
  = CloudIdentityGroupsMembershipsCheckTransitiveMembership{xgafv =
                                                              Core.Nothing,
...
instance Core.GoogleRequest
           CloudIdentityGroupsMembershipsCheckTransitiveMembership
         where
        type Rs CloudIdentityGroupsMembershipsCheckTransitiveMembership =
             CheckTransitiveMembershipResponse
        type Scopes CloudIdentityGroupsMembershipsCheckTransitiveMembership
             =
             '[CloudIdentity'Groups, CloudIdentity'Groups'Readonly,
               CloudPlatform'FullControl]
        requestClient
          CloudIdentityGroupsMembershipsCheckTransitiveMembership{..}
          = go parent xgafv accessToken callback query uploadType
              uploadProtocol
