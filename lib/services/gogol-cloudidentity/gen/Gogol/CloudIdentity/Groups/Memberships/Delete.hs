...
newCloudIdentityGroupsMembershipsDelete name
  = CloudIdentityGroupsMembershipsDelete{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         name = name, uploadType = Core.Nothing,
                                         uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudIdentityGroupsMembershipsDelete
         where
        type Rs CloudIdentityGroupsMembershipsDelete = Operation
        type Scopes CloudIdentityGroupsMembershipsDelete =
             '[CloudIdentity'Groups, CloudPlatform'FullControl]
        requestClient CloudIdentityGroupsMembershipsDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudIdentityGroupsMembershipsDeleteResource)
                      Core.mempty
