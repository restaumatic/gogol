                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] SearchTransitiveMembershipsResponse
...
newCloudIdentityGroupsMembershipsSearchTransitiveMemberships parent
  = CloudIdentityGroupsMembershipsSearchTransitiveMemberships{xgafv =
                                                                Core.Nothing,
...
instance Core.GoogleRequest
           CloudIdentityGroupsMembershipsSearchTransitiveMemberships
         where
        type Rs CloudIdentityGroupsMembershipsSearchTransitiveMemberships =
