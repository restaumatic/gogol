                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] SearchTransitiveGroupsResponse
...
newCloudIdentityGroupsMembershipsSearchTransitiveGroups parent
  = CloudIdentityGroupsMembershipsSearchTransitiveGroups{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           CloudIdentityGroupsMembershipsSearchTransitiveGroups
         where
        type Rs CloudIdentityGroupsMembershipsSearchTransitiveGroups =
             SearchTransitiveGroupsResponse
        type Scopes CloudIdentityGroupsMembershipsSearchTransitiveGroups =
