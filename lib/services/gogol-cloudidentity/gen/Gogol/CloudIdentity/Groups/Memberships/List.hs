                   ...
                   Core.QueryParam "pageToken" Core.Text Core.:>
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "view" GroupsMembershipsListView Core.:>
...
newCloudIdentityGroupsMembershipsList parent
  = CloudIdentityGroupsMembershipsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest CloudIdentityGroupsMembershipsList
         where
        type Rs CloudIdentityGroupsMembershipsList =
             ListMembershipsResponse
        type Scopes CloudIdentityGroupsMembershipsList =
        ...
        requestClient CloudIdentityGroupsMembershipsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudIdentityGroupsMembershipsListResource)
                      Core.mempty
