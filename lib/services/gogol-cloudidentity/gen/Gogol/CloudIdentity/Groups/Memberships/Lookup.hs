             ...
             Core.QueryParam "access_token" Core.Text Core.:>
               Core.QueryParam "callback" Core.Text Core.:>
                 Core.QueryParam "memberKey.id" Core.Text Core.:>
                   Core.QueryParam "memberKey.namespace" Core.Text Core.:>
...
newCloudIdentityGroupsMembershipsLookup parent
  = CloudIdentityGroupsMembershipsLookup{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         memberKeyId = Core.Nothing,
                                         memberKeyNamespace = Core.Nothing, parent = parent,
                                         uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudIdentityGroupsMembershipsLookup
         where
        ...
        requestClient CloudIdentityGroupsMembershipsLookup{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudIdentityGroupsMembershipsLookupResource)
                      Core.mempty
