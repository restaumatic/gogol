...
type CloudIdentityGroupsMembershipsGetMembershipGraphResource =
     "v1" Core.:>
       Core.Capture "parent" Core.Text Core.:>
         "memberships:getMembershipGraph" Core.:>
...
newCloudIdentityGroupsMembershipsGetMembershipGraph parent
  = CloudIdentityGroupsMembershipsGetMembershipGraph{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           CloudIdentityGroupsMembershipsGetMembershipGraph
         where
        type Rs CloudIdentityGroupsMembershipsGetMembershipGraph =
             Operation
        type Scopes CloudIdentityGroupsMembershipsGetMembershipGraph =
             '[CloudIdentity'Groups, CloudIdentity'Groups'Readonly,
               CloudPlatform'FullControl]
        requestClient CloudIdentityGroupsMembershipsGetMembershipGraph{..}
