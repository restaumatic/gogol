...
newCloudIdentityGroupsSearch 
    ::  CloudIdentityGroupsSearch
newCloudIdentityGroupsSearch
  = CloudIdentityGroupsSearch{xgafv = Core.Nothing,
...
instance Core.GoogleRequest CloudIdentityGroupsSearch where
        type Rs CloudIdentityGroupsSearch = SearchGroupsResponse
        ...
        requestClient CloudIdentityGroupsSearch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy CloudIdentityGroupsSearchResource)
                      Core.mempty
