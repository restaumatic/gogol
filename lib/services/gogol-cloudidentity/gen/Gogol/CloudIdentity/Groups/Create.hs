         ...
         Core.QueryParam "$.xgafv" Xgafv Core.:>
           Core.QueryParam "access_token" Core.Text Core.:>
             Core.QueryParam "callback" Core.Text Core.:>
               Core.QueryParam "initialGroupConfig" GroupsCreateInitialGroupConfig
                 Core.:>
...
newCloudIdentityGroupsCreate payload
  = CloudIdentityGroupsCreate{xgafv = Core.Nothing,
                              accessToken = Core.Nothing, callback = Core.Nothing,
                              initialGroupConfig = Core.Nothing, payload = payload,
...
instance Core.GoogleRequest CloudIdentityGroupsCreate where
        ...
        requestClient CloudIdentityGroupsCreate{..}
          = go xgafv accessToken callback initialGroupConfig uploadType
              uploadProtocol
