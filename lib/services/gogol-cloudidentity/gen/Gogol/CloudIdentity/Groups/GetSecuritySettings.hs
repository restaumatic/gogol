                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.Get '[Core.JSON] SecuritySettings
...
newCloudIdentityGroupsGetSecuritySettings name
  = CloudIdentityGroupsGetSecuritySettings{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           name = name, readMask = Core.Nothing,
                                           uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudIdentityGroupsGetSecuritySettings
         where
        type Rs CloudIdentityGroupsGetSecuritySettings = SecuritySettings
        type Scopes CloudIdentityGroupsGetSecuritySettings =
