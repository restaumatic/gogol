...
type HealthcareProjectsLocationsDatasetsConsentStoresCheckDataAccessResource
     =
     "v1" Core.:>
       Core.CaptureMode "consentStore" "checkDataAccess" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] CheckDataAccessRequest Core.:>
...
newHealthcareProjectsLocationsDatasetsConsentStoresCheckDataAccess
  ...
  = HealthcareProjectsLocationsDatasetsConsentStoresCheckDataAccess{xgafv
                                                                      = Core.Nothing,
