               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] ExportResourcesRequest Core.:>
...
newHealthcareProjectsLocationsDatasetsFhirStoresExport name payload
  = HealthcareProjectsLocationsDatasetsFhirStoresExport{xgafv =
                                                          Core.Nothing,
...
instance Core.GoogleRequest
           HealthcareProjectsLocationsDatasetsFhirStoresExport
         where
        type Rs HealthcareProjectsLocationsDatasetsFhirStoresExport =
             Operation
        type Scopes HealthcareProjectsLocationsDatasetsFhirStoresExport =
