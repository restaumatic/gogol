...
data HealthcareProjectsLocationsDatasetsFhirStoresFhirConditionalDelete = HealthcareProjectsLocationsDatasetsFhirStoresFhirConditionalDelete
    ...
    , parent :: Core.Text
      -- | Required. The FHIR resource type to delete, such as Patient or Observation. For a complete list, see the FHIR Resource Index (<https://hl7.org/fhir/DSTU2/resourcelist.html DSTU2>, <https://hl7.org/fhir/STU3/resourcelist.html STU3>, <https://hl7.org/fhir/R4/resourcelist.html R4>, <https://hl7.org/fhir/R5/resourcelist.html R5>).
    , type' :: Core.Text
...
newHealthcareProjectsLocationsDatasetsFhirStoresFhirConditionalDelete 
    ...
    -> Core.Text
       -- ^  Required. The FHIR resource type to delete, such as Patient or Observation. For a complete list, see the FHIR Resource Index (<https://hl7.org/fhir/DSTU2/resourcelist.html DSTU2>, <https://hl7.org/fhir/STU3/resourcelist.html STU3>, <https://hl7.org/fhir/R4/resourcelist.html R4>, <https://hl7.org/fhir/R5/resourcelist.html R5>). See 'type''.
    -> HealthcareProjectsLocationsDatasetsFhirStoresFhirConditionalDelete
newHealthcareProjectsLocationsDatasetsFhirStoresFhirConditionalDelete
  parent type'
  = HealthcareProjectsLocationsDatasetsFhirStoresFhirConditionalDelete{xgafv
                                                                         = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        requestClient
          HealthcareProjectsLocationsDatasetsFhirStoresFhirConditionalDelete{..}
          = go parent type' xgafv accessToken callback uploadType
              uploadProtocol
