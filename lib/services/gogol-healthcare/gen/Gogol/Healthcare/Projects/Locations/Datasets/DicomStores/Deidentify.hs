               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] DeidentifyDicomStoreRequest Core.:>
...
newHealthcareProjectsLocationsDatasetsDicomStoresDeidentify 
    ...
    -> HealthcareProjectsLocationsDatasetsDicomStoresDeidentify
newHealthcareProjectsLocationsDatasetsDicomStoresDeidentify payload
  sourceStore
  = HealthcareProjectsLocationsDatasetsDicomStoresDeidentify{xgafv =
                                                               Core.Nothing,
...
instance Core.GoogleRequest
           HealthcareProjectsLocationsDatasetsDicomStoresDeidentify
         where
        type Rs HealthcareProjectsLocationsDatasetsDicomStoresDeidentify =
             Operation
        type Scopes
               HealthcareProjectsLocationsDatasetsDicomStoresDeidentify
