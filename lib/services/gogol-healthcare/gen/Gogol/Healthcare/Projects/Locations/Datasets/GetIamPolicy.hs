...
newHealthcareProjectsLocationsDatasetsGetIamPolicy resource
  = HealthcareProjectsLocationsDatasetsGetIamPolicy{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           HealthcareProjectsLocationsDatasetsGetIamPolicy
         where
        type Rs HealthcareProjectsLocationsDatasetsGetIamPolicy = Policy
        type Scopes HealthcareProjectsLocationsDatasetsGetIamPolicy =
             '[CloudHealthcare'FullControl, CloudPlatform'FullControl]
        requestClient HealthcareProjectsLocationsDatasetsGetIamPolicy{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy HealthcareProjectsLocationsDatasetsGetIamPolicyResource)
                      Core.mempty
