...
newHealthcareProjectsLocationsDatasetsDicomStoresCreate 
    :: 
                                                        Core.Text
       -- ^  Required. The name of the dataset this DICOM store belongs to. See 'parent'.
    -> DicomStore
       -- ^  Multipart request metadata. See 'payload'.
    -> HealthcareProjectsLocationsDatasetsDicomStoresCreate
newHealthcareProjectsLocationsDatasetsDicomStoresCreate parent
  payload
  = HealthcareProjectsLocationsDatasetsDicomStoresCreate{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           HealthcareProjectsLocationsDatasetsDicomStoresCreate
         where
        type Rs HealthcareProjectsLocationsDatasetsDicomStoresCreate =
             DicomStore
        type Scopes HealthcareProjectsLocationsDatasetsDicomStoresCreate =
             '[CloudHealthcare'FullControl, CloudPlatform'FullControl]
        requestClient
          HealthcareProjectsLocationsDatasetsDicomStoresCreate{..}
          = go parent xgafv accessToken callback dicomStoreId uploadType
              uploadProtocol
