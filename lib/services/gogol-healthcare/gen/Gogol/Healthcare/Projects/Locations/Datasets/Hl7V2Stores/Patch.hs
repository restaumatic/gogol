...
newHealthcareProjectsLocationsDatasetsHl7V2StoresPatch name payload
  = HealthcareProjectsLocationsDatasetsHl7V2StoresPatch{xgafv =
                                                          Core.Nothing,
...
instance Core.GoogleRequest
           HealthcareProjectsLocationsDatasetsHl7V2StoresPatch
         where
        type Rs HealthcareProjectsLocationsDatasetsHl7V2StoresPatch =
             Hl7V2Store
        type Scopes HealthcareProjectsLocationsDatasetsHl7V2StoresPatch =
