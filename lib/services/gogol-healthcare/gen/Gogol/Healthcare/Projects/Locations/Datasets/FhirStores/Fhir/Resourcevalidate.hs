...
--
-- Validates an input FHIR resource\'s conformance to its profiles and the profiles configured on the FHIR store. Implements the FHIR extended operation $validate (<https://hl7.org/fhir/DSTU2/resource-operations.html#validate DSTU2>, <https://hl7.org/fhir/STU3/resource-operations.html#validate STU3>, <https://hl7.org/fhir/R4/resource-operation-validate.html R4>. or <https://hl7.org/fhir/R5/resource-operation-validate.html R5>). The request body must contain a JSON-encoded FHIR resource, and the request headers must contain @Content-Type: application\/fhir+json@. The @Parameters@ input syntax is not supported. The @profile@ query parameter can be used to request that the resource only be validated against a specific profile. If a profile with the given URL cannot be found in the FHIR store then an error is returned. Errors generated by validation contain a JSON-encoded @OperationOutcome@ resource describing the reason for the error. If the request cannot be mapped to a valid API method on a FHIR store, a generic
...
data HealthcareProjectsLocationsDatasetsFhirStoresFhirResourcevalidate = HealthcareProjectsLocationsDatasetsFhirStoresFhirResourcevalidate
    ...
    , profile :: (Core.Maybe Core.Text)
      -- | Required. The FHIR resource type of the resource being validated. For a complete list, see the FHIR Resource Index (<https://hl7.org/fhir/DSTU2/resourcelist.html DSTU2>, <https://hl7.org/fhir/STU3/resourcelist.html STU3>, <https://hl7.org/fhir/R4/resourcelist.html R4>, or <https://hl7.org/fhir/R5/resourcelist.html R5>). Must match the resource type in the provided content.
    , type' :: Core.Text
...
newHealthcareProjectsLocationsDatasetsFhirStoresFhirResourcevalidate 
    ...
    -> Core.Text
       -- ^  Required. The FHIR resource type of the resource being validated. For a complete list, see the FHIR Resource Index (<https://hl7.org/fhir/DSTU2/resourcelist.html DSTU2>, <https://hl7.org/fhir/STU3/resourcelist.html STU3>, <https://hl7.org/fhir/R4/resourcelist.html R4>, or <https://hl7.org/fhir/R5/resourcelist.html R5>). Must match the resource type in the provided content. See 'type''.
    -> HealthcareProjectsLocationsDatasetsFhirStoresFhirResourcevalidate
newHealthcareProjectsLocationsDatasetsFhirStoresFhirResourcevalidate
  parent payload type'
  = HealthcareProjectsLocationsDatasetsFhirStoresFhirResourcevalidate{xgafv
                                                                        = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        requestClient
          HealthcareProjectsLocationsDatasetsFhirStoresFhirResourcevalidate{..}
          = go parent type' xgafv accessToken callback profile uploadType
              uploadProtocol
