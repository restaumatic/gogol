...
type HealthcareProjectsLocationsDatasetsConsentStoresQueryAccessibleDataResource
     =
     "v1" Core.:>
       Core.CaptureMode "consentStore" "queryAccessibleData" Core.Text
         Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] QueryAccessibleDataRequest Core.:>
...
newHealthcareProjectsLocationsDatasetsConsentStoresQueryAccessibleData
  ...
  = HealthcareProjectsLocationsDatasetsConsentStoresQueryAccessibleData{xgafv
                                                                          = Core.Nothing,
