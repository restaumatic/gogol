...
newHealthcareProjectsLocationsDatasetsConsentStoresCreate 
    ...
    -> HealthcareProjectsLocationsDatasetsConsentStoresCreate
newHealthcareProjectsLocationsDatasetsConsentStoresCreate parent
  payload
  = HealthcareProjectsLocationsDatasetsConsentStoresCreate{xgafv =
                                                             Core.Nothing,
...
instance Core.GoogleRequest
           HealthcareProjectsLocationsDatasetsConsentStoresCreate
         where
        type Rs HealthcareProjectsLocationsDatasetsConsentStoresCreate =
             ConsentStore
        type Scopes HealthcareProjectsLocationsDatasetsConsentStoresCreate
             = '[CloudHealthcare'FullControl, CloudPlatform'FullControl]
        requestClient
          HealthcareProjectsLocationsDatasetsConsentStoresCreate{..}
          = go parent xgafv accessToken callback consentStoreId uploadType
              uploadProtocol
