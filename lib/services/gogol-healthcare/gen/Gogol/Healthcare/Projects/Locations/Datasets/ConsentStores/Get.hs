...
newHealthcareProjectsLocationsDatasetsConsentStoresGet name
  = HealthcareProjectsLocationsDatasetsConsentStoresGet{xgafv =
                                                          Core.Nothing,
...
instance Core.GoogleRequest
           HealthcareProjectsLocationsDatasetsConsentStoresGet
         where
        type Rs HealthcareProjectsLocationsDatasetsConsentStoresGet =
             ConsentStore
        type Scopes HealthcareProjectsLocationsDatasetsConsentStoresGet =
