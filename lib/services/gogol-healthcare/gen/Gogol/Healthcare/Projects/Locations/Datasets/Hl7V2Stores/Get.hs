...
newHealthcareProjectsLocationsDatasetsHl7V2StoresGet name
  = HealthcareProjectsLocationsDatasetsHl7V2StoresGet{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           HealthcareProjectsLocationsDatasetsHl7V2StoresGet
         where
        type Rs HealthcareProjectsLocationsDatasetsHl7V2StoresGet =
             Hl7V2Store
        type Scopes HealthcareProjectsLocationsDatasetsHl7V2StoresGet =
