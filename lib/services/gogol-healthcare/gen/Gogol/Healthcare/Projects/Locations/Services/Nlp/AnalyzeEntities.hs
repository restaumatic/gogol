...
type HealthcareProjectsLocationsServicesNlpAnalyzeEntitiesResource
     =
     "v1" Core.:>
       Core.CaptureMode "nlpService" "analyzeEntities" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] AnalyzeEntitiesRequest Core.:>
...
newHealthcareProjectsLocationsServicesNlpAnalyzeEntities 
    ...
    -> HealthcareProjectsLocationsServicesNlpAnalyzeEntities
newHealthcareProjectsLocationsServicesNlpAnalyzeEntities nlpService
  payload
  = HealthcareProjectsLocationsServicesNlpAnalyzeEntities{xgafv =
                                                            Core.Nothing,
...
instance Core.GoogleRequest
           HealthcareProjectsLocationsServicesNlpAnalyzeEntities
         where
        type Rs HealthcareProjectsLocationsServicesNlpAnalyzeEntities =
             AnalyzeEntitiesResponse
        type Scopes HealthcareProjectsLocationsServicesNlpAnalyzeEntities =
