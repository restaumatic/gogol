...
--
-- RetrieveFrames returns instances associated with the given study, series, SOP Instance UID and frame numbers. See [RetrieveTransaction] (https:\/\/dicom.nema.org\/medical\/dicom\/current\/output\/html\/part18.html#sect_10.4}. For details on the implementation of RetrieveFrames, see <https://cloud.google.com/healthcare/docs/dicom#dicom_frames DICOM frames> in the Cloud Healthcare API conformance statement. For samples that show how to call RetrieveFrames, see <https://cloud.google.com/healthcare/docs/how-tos/dicomweb#retrieve-dicom Retrieve DICOM data>.
--
