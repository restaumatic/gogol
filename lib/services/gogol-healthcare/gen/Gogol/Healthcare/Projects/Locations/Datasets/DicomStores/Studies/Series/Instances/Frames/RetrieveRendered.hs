...
--
-- RetrieveRenderedFrames returns instances associated with the given study, series, SOP Instance UID and frame numbers in an acceptable Rendered Media Type. See [RetrieveTransaction] (https:\/\/dicom.nema.org\/medical\/dicom\/current\/output\/html\/part18.html#sect_10.4). For details on the implementation of RetrieveRenderedFrames, see <https://cloud.google.com/healthcare/docs/dicom#rendered_resources Rendered resources> in the Cloud Healthcare API conformance statement. For samples that show how to call RetrieveRenderedFrames, see <https://cloud.google.com/healthcare/docs/how-tos/dicomweb#retrieve-consumer Retrieve consumer image formats>.
--
