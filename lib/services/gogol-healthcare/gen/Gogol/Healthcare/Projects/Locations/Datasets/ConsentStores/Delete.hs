...
newHealthcareProjectsLocationsDatasetsConsentStoresDelete name
  = HealthcareProjectsLocationsDatasetsConsentStoresDelete{xgafv =
                                                             Core.Nothing,
...
instance Core.GoogleRequest
           HealthcareProjectsLocationsDatasetsConsentStoresDelete
         where
        type Rs HealthcareProjectsLocationsDatasetsConsentStoresDelete =
             Empty
        type Scopes HealthcareProjectsLocationsDatasetsConsentStoresDelete
