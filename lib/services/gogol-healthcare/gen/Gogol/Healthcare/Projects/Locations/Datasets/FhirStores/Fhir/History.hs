...
--
-- Lists all the versions of a resource (including the current version and deleted versions) from the FHIR store. Implements the per-resource form of the FHIR standard history interaction (<https://hl7.org/fhir/DSTU2/http.html#history DSTU2>, <https://hl7.org/fhir/STU3/http.html#history STU3>, <https://hl7.org/fhir/R4/http.html#history R4>, <https://hl7.org/fhir/R5/http.html#history R5>). On success, the response body contains a JSON-encoded representation of a @Bundle@ resource of type @history@, containing the version history sorted from most recent to oldest versions. Errors generated by the FHIR store contain a JSON-encoded @OperationOutcome@ resource describing the reason for the error. If the request cannot be mapped to a valid API method on a FHIR store, a generic GCP error might be returned instead. For samples that show how to call @history@, see <https://cloud.google.com/healthcare/docs/how-tos/fhir-resources#listing_fhir_resource_versions Listing FHIR resource versions>.
--
...
newHealthcareProjectsLocationsDatasetsFhirStoresFhirHistory name
  = HealthcareProjectsLocationsDatasetsFhirStoresFhirHistory{xgafv =
                                                               Core.Nothing,
                                                             at = Core.Nothing,
                                                             count = Core.Nothing,
...
instance Core.GoogleRequest
           HealthcareProjectsLocationsDatasetsFhirStoresFhirHistory
         where
        type Rs HealthcareProjectsLocationsDatasetsFhirStoresFhirHistory =
             HttpBody
        type Scopes
               HealthcareProjectsLocationsDatasetsFhirStoresFhirHistory
        ...
        requestClient
          HealthcareProjectsLocationsDatasetsFhirStoresFhirHistory{..}
          = go name xgafv at count pageToken since accessToken callback
              uploadType
              uploadProtocol
