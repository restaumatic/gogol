               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] ExportMessagesRequest Core.:>
...
newHealthcareProjectsLocationsDatasetsHl7V2StoresExport 
    :: 
                                                        Core.Text
       -- ^  Required. The name of the source HL7v2 store, in the format @projects\/{project_id}\/locations\/{location_id}\/datasets\/{dataset_id}\/hl7v2Stores\/{hl7v2_store_id}@ See 'name'.
    -> ExportMessagesRequest
       -- ^  Multipart request metadata. See 'payload'.
    -> HealthcareProjectsLocationsDatasetsHl7V2StoresExport
newHealthcareProjectsLocationsDatasetsHl7V2StoresExport name
  payload
  = HealthcareProjectsLocationsDatasetsHl7V2StoresExport{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           HealthcareProjectsLocationsDatasetsHl7V2StoresExport
         where
        type Rs HealthcareProjectsLocationsDatasetsHl7V2StoresExport =
             Operation
        type Scopes HealthcareProjectsLocationsDatasetsHl7V2StoresExport =
