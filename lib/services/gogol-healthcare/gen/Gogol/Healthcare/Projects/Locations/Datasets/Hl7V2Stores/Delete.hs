...
newHealthcareProjectsLocationsDatasetsHl7V2StoresDelete name
  = HealthcareProjectsLocationsDatasetsHl7V2StoresDelete{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           HealthcareProjectsLocationsDatasetsHl7V2StoresDelete
         where
        type Rs HealthcareProjectsLocationsDatasetsHl7V2StoresDelete =
             Empty
        type Scopes HealthcareProjectsLocationsDatasetsHl7V2StoresDelete =
