...
newHealthcareProjectsLocationsDatasetsOperationsGet name
  = HealthcareProjectsLocationsDatasetsOperationsGet{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           HealthcareProjectsLocationsDatasetsOperationsGet
         where
        type Rs HealthcareProjectsLocationsDatasetsOperationsGet =
             Operation
        type Scopes HealthcareProjectsLocationsDatasetsOperationsGet =
