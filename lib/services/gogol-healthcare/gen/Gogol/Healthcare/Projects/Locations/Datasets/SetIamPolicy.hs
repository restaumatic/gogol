...
newHealthcareProjectsLocationsDatasetsSetIamPolicy payload resource
  = HealthcareProjectsLocationsDatasetsSetIamPolicy{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           HealthcareProjectsLocationsDatasetsSetIamPolicy
         where
        type Rs HealthcareProjectsLocationsDatasetsSetIamPolicy = Policy
        type Scopes HealthcareProjectsLocationsDatasetsSetIamPolicy =
             '[CloudHealthcare'FullControl, CloudPlatform'FullControl]
        requestClient HealthcareProjectsLocationsDatasetsSetIamPolicy{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy HealthcareProjectsLocationsDatasetsSetIamPolicyResource)
                      Core.mempty
