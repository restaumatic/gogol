         ...
         "attributeDefinitions" Core.:>
           Core.QueryParam "$.xgafv" Xgafv Core.:>
             Core.QueryParam "access_token" Core.Text Core.:>
               Core.QueryParam "attributeDefinitionId" Core.Text Core.:>
...
newHealthcareProjectsLocationsDatasetsConsentStoresAttributeDefinitionsCreate
  parent payload
  = HealthcareProjectsLocationsDatasetsConsentStoresAttributeDefinitionsCreate{xgafv
                                                                                 = Core.Nothing,
                                                                               accessToken =
                                                                                 Core.Nothing,
...
instance Core.GoogleRequest
        ...
        requestClient
          HealthcareProjectsLocationsDatasetsConsentStoresAttributeDefinitionsCreate{..}
          = go parent xgafv accessToken attributeDefinitionId callback
              uploadType
              uploadProtocol
