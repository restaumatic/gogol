...
--
-- DeleteStudy deletes all instances within the given study. Delete requests are equivalent to the GET requests specified in the Retrieve transaction. The method returns an Operation which will be marked successful when the deletion is complete. Warning: Instances cannot be inserted into a study that is being deleted by an operation until the operation completes. For samples that show how to call DeleteStudy, see <https://cloud.google.com/healthcare/docs/how-tos/dicomweb#delete-dicom Delete a study, series, or instance>.
--
...
newHealthcareProjectsLocationsDatasetsDicomStoresStudiesDelete 
    :: 
                                                               Core.Text
       -- ^  Required. The path of the DeleteStudy request. For example, @studies\/{study_uid}@. See 'dicomWebPath'.
    -> Core.Text
       -- ^  See 'parent'.
    -> HealthcareProjectsLocationsDatasetsDicomStoresStudiesDelete
newHealthcareProjectsLocationsDatasetsDicomStoresStudiesDelete
  dicomWebPath parent
  = HealthcareProjectsLocationsDatasetsDicomStoresStudiesDelete{xgafv
                                                                  = Core.Nothing,
...
instance Core.GoogleRequest
           HealthcareProjectsLocationsDatasetsDicomStoresStudiesDelete
         where
        type Rs HealthcareProjectsLocationsDatasetsDicomStoresStudiesDelete
             = Operation
        type Scopes
               HealthcareProjectsLocationsDatasetsDicomStoresStudiesDelete
