...
--
-- Gets the FHIR capability statement (<https://hl7.org/fhir/STU3/capabilitystatement.html STU3>, <https://hl7.org/fhir/R4/capabilitystatement.html R4>, <https://hl7.org/fhir/R5/capabilitystatement.html R5>), or the <https://hl7.org/fhir/DSTU2/conformance.html conformance statement> in the DSTU2 case for the store, which contains a description of functionality supported by the server. Implements the FHIR standard capabilities interaction (<https://hl7.org/fhir/STU3/http.html#capabilities STU3>, <https://hl7.org/fhir/R4/http.html#capabilities R4>, <https://hl7.org/fhir/R5/http.html#capabilities R5>), or the <https://hl7.org/fhir/DSTU2/http.html#conformance conformance interaction> in the DSTU2 case. On success, the response body contains a JSON-encoded representation of a @CapabilityStatement@ resource.
--
...
newHealthcareProjectsLocationsDatasetsFhirStoresFhirCapabilities 
    :: 
                                                                 Core.Text
       -- ^  Required. Name of the FHIR store to retrieve the capabilities for. See 'name'.
    -> HealthcareProjectsLocationsDatasetsFhirStoresFhirCapabilities
newHealthcareProjectsLocationsDatasetsFhirStoresFhirCapabilities
  name
  = HealthcareProjectsLocationsDatasetsFhirStoresFhirCapabilities{xgafv
                                                                    = Core.Nothing,
