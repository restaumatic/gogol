...
type HealthcareProjectsLocationsDatasetsDeidentifyResource =
     "v1" Core.:>
       Core.CaptureMode "sourceDataset" "deidentify" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] DeidentifyDatasetRequest Core.:>
...
newHealthcareProjectsLocationsDatasetsDeidentify 
    ...
    -> Core.Text
       -- ^  Required. Source dataset resource name. For example, @projects\/{project_id}\/locations\/{location_id}\/datasets\/{dataset_id}@. R5 FHIR stores are not supported and will be skipped. See 'sourceDataset'.
    -> HealthcareProjectsLocationsDatasetsDeidentify
newHealthcareProjectsLocationsDatasetsDeidentify payload
  sourceDataset
  = HealthcareProjectsLocationsDatasetsDeidentify{xgafv =
                                                    Core.Nothing,
...
instance Core.GoogleRequest
           HealthcareProjectsLocationsDatasetsDeidentify
         where
        type Rs HealthcareProjectsLocationsDatasetsDeidentify = Operation
        type Scopes HealthcareProjectsLocationsDatasetsDeidentify =
             '[CloudHealthcare'FullControl, CloudPlatform'FullControl]
        requestClient HealthcareProjectsLocationsDatasetsDeidentify{..}
          = go sourceDataset xgafv accessToken callback uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy HealthcareProjectsLocationsDatasetsDeidentifyResource)
                      Core.mempty
