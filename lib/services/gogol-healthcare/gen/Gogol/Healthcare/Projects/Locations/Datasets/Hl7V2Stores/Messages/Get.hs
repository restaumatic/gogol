...
newHealthcareProjectsLocationsDatasetsHl7V2StoresMessagesGet 
    :: 
                                                             Core.Text
       -- ^  Required. The resource name of the HL7v2 message to retrieve. See 'name'.
    -> HealthcareProjectsLocationsDatasetsHl7V2StoresMessagesGet
newHealthcareProjectsLocationsDatasetsHl7V2StoresMessagesGet name
  = HealthcareProjectsLocationsDatasetsHl7V2StoresMessagesGet{xgafv =
                                                                Core.Nothing,
...
instance Core.GoogleRequest
           HealthcareProjectsLocationsDatasetsHl7V2StoresMessagesGet
         where
        type Rs HealthcareProjectsLocationsDatasetsHl7V2StoresMessagesGet =
             Message
        type Scopes
               HealthcareProjectsLocationsDatasetsHl7V2StoresMessagesGet
