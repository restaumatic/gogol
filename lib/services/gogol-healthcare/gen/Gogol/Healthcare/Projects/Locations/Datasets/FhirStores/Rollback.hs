               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] RollbackFhirResourcesRequest Core.:>
...
newHealthcareProjectsLocationsDatasetsFhirStoresRollback 
    ...
    -> HealthcareProjectsLocationsDatasetsFhirStoresRollback
newHealthcareProjectsLocationsDatasetsFhirStoresRollback name
  payload
  = HealthcareProjectsLocationsDatasetsFhirStoresRollback{xgafv =
                                                            Core.Nothing,
...
instance Core.GoogleRequest
           HealthcareProjectsLocationsDatasetsFhirStoresRollback
         where
        type Rs HealthcareProjectsLocationsDatasetsFhirStoresRollback =
             Operation
        type Scopes HealthcareProjectsLocationsDatasetsFhirStoresRollback =
