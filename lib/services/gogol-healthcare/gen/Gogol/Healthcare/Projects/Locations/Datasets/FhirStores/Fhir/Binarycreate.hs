...
newHealthcareProjectsLocationsDatasetsFhirStoresFhirBinarycreate
  parent payload
  = HealthcareProjectsLocationsDatasetsFhirStoresFhirBinarycreate{xgafv
                                                                    = Core.Nothing,
