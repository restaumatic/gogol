               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] RollbackHl7V2MessagesRequest Core.:>
...
newHealthcareProjectsLocationsDatasetsHl7V2StoresRollback 
    ...
    -> HealthcareProjectsLocationsDatasetsHl7V2StoresRollback
newHealthcareProjectsLocationsDatasetsHl7V2StoresRollback name
  payload
  = HealthcareProjectsLocationsDatasetsHl7V2StoresRollback{xgafv =
                                                             Core.Nothing,
...
instance Core.GoogleRequest
           HealthcareProjectsLocationsDatasetsHl7V2StoresRollback
         where
        type Rs HealthcareProjectsLocationsDatasetsHl7V2StoresRollback =
             Operation
        type Scopes HealthcareProjectsLocationsDatasetsHl7V2StoresRollback
