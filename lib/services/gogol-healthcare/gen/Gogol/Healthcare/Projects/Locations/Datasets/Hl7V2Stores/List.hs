...
newHealthcareProjectsLocationsDatasetsHl7V2StoresList parent
  = HealthcareProjectsLocationsDatasetsHl7V2StoresList{xgafv =
                                                         Core.Nothing,
...
instance Core.GoogleRequest
           HealthcareProjectsLocationsDatasetsHl7V2StoresList
         where
        type Rs HealthcareProjectsLocationsDatasetsHl7V2StoresList =
             ListHl7V2StoresResponse
        type Scopes HealthcareProjectsLocationsDatasetsHl7V2StoresList =
