...
newHealthcareProjectsLocationsDatasetsDicomStoresDelete name
  = HealthcareProjectsLocationsDatasetsDicomStoresDelete{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           HealthcareProjectsLocationsDatasetsDicomStoresDelete
         where
        type Rs HealthcareProjectsLocationsDatasetsDicomStoresDelete =
             Empty
        type Scopes HealthcareProjectsLocationsDatasetsDicomStoresDelete =
