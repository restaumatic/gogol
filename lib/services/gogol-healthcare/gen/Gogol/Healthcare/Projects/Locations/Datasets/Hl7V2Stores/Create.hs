...
newHealthcareProjectsLocationsDatasetsHl7V2StoresCreate 
    ...
    -> HealthcareProjectsLocationsDatasetsHl7V2StoresCreate
newHealthcareProjectsLocationsDatasetsHl7V2StoresCreate parent
  payload
  = HealthcareProjectsLocationsDatasetsHl7V2StoresCreate{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           HealthcareProjectsLocationsDatasetsHl7V2StoresCreate
         where
        type Rs HealthcareProjectsLocationsDatasetsHl7V2StoresCreate =
             Hl7V2Store
        type Scopes HealthcareProjectsLocationsDatasetsHl7V2StoresCreate =
             '[CloudHealthcare'FullControl, CloudPlatform'FullControl]
        requestClient
          HealthcareProjectsLocationsDatasetsHl7V2StoresCreate{..}
          = go parent xgafv accessToken callback hl7V2StoreId uploadType
              uploadProtocol
