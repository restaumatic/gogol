...
newHealthcareProjectsLocationsDatasetsTestIamPermissions 
    ...
    -> HealthcareProjectsLocationsDatasetsTestIamPermissions
newHealthcareProjectsLocationsDatasetsTestIamPermissions payload
  resource
  = HealthcareProjectsLocationsDatasetsTestIamPermissions{xgafv =
                                                            Core.Nothing,
...
instance Core.GoogleRequest
           HealthcareProjectsLocationsDatasetsTestIamPermissions
         where
        type Rs HealthcareProjectsLocationsDatasetsTestIamPermissions =
             TestIamPermissionsResponse
        type Scopes HealthcareProjectsLocationsDatasetsTestIamPermissions =
