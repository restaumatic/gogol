...
type HealthcareProjectsLocationsDatasetsConsentStoresEvaluateUserConsentsResource
     =
     "v1" Core.:>
       Core.CaptureMode "consentStore" "evaluateUserConsents" Core.Text
         Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] EvaluateUserConsentsRequest Core.:>
...
newHealthcareProjectsLocationsDatasetsConsentStoresEvaluateUserConsents 
    ...
    -> HealthcareProjectsLocationsDatasetsConsentStoresEvaluateUserConsents
newHealthcareProjectsLocationsDatasetsConsentStoresEvaluateUserConsents
  consentStore payload
  = HealthcareProjectsLocationsDatasetsConsentStoresEvaluateUserConsents{xgafv
                                                                           = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        requestClient
          HealthcareProjectsLocationsDatasetsConsentStoresEvaluateUserConsents{..}
          = go consentStore xgafv accessToken callback uploadType
              uploadProtocol
