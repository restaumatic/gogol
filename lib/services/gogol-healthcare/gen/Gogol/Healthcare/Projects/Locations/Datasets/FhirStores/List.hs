...
newHealthcareProjectsLocationsDatasetsFhirStoresList parent
  = HealthcareProjectsLocationsDatasetsFhirStoresList{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           HealthcareProjectsLocationsDatasetsFhirStoresList
         where
        type Rs HealthcareProjectsLocationsDatasetsFhirStoresList =
             ListFhirStoresResponse
        type Scopes HealthcareProjectsLocationsDatasetsFhirStoresList =
