               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] ImportMessagesRequest Core.:>
...
newHealthcareProjectsLocationsDatasetsHl7V2StoresImport 
    :: 
                                                        Core.Text
       -- ^  Required. The name of the target HL7v2 store, in the format @projects\/{project_id}\/locations\/{location_id}\/datasets\/{dataset_id}\/hl7v2Stores\/{hl7v2_store_id}@ See 'name'.
    -> ImportMessagesRequest
       -- ^  Multipart request metadata. See 'payload'.
    -> HealthcareProjectsLocationsDatasetsHl7V2StoresImport
newHealthcareProjectsLocationsDatasetsHl7V2StoresImport name
  payload
  = HealthcareProjectsLocationsDatasetsHl7V2StoresImport{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           HealthcareProjectsLocationsDatasetsHl7V2StoresImport
         where
        type Rs HealthcareProjectsLocationsDatasetsHl7V2StoresImport =
             Operation
        type Scopes HealthcareProjectsLocationsDatasetsHl7V2StoresImport =
