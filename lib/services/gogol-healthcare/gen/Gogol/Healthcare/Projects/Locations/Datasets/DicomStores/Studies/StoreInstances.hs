...
--
-- StoreInstances stores DICOM instances associated with study instance unique identifiers (SUID). See [Store Transaction] (https:\/\/dicom.nema.org\/medical\/dicom\/current\/output\/html\/part18.html#sect_10.5). For details on the implementation of StoreInstances, see <https://cloud.google.com/healthcare/docs/dicom#store_transaction Store transaction> in the Cloud Healthcare API conformance statement. For samples that show how to call StoreInstances, see <https://cloud.google.com/healthcare/docs/how-tos/dicomweb#store-dicom Store DICOM data>.
--
