...
data HealthcareProjectsLocationsDatasetsFhirStoresFhirConditionalUpdate = HealthcareProjectsLocationsDatasetsFhirStoresFhirConditionalUpdate
    ...
    , payload :: HttpBody
      -- | Required. The FHIR resource type to update, such as Patient or Observation. For a complete list, see the FHIR Resource Index (<https://hl7.org/fhir/DSTU2/resourcelist.html DSTU2>, <https://hl7.org/fhir/STU3/resourcelist.html STU3>, <https://hl7.org/fhir/R4/resourcelist.html R4>, <https://hl7.org/fhir/R5/resourcelist.html R5>). Must match the resource type in the provided content.
    , type' :: Core.Text
...
newHealthcareProjectsLocationsDatasetsFhirStoresFhirConditionalUpdate
  parent payload type'
  = HealthcareProjectsLocationsDatasetsFhirStoresFhirConditionalUpdate{xgafv
                                                                         = Core.Nothing,
