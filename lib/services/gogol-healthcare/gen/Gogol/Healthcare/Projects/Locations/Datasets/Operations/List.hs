...
newHealthcareProjectsLocationsDatasetsOperationsList name
  = HealthcareProjectsLocationsDatasetsOperationsList{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           HealthcareProjectsLocationsDatasetsOperationsList
         where
        type Rs HealthcareProjectsLocationsDatasetsOperationsList =
             ListOperationsResponse
        type Scopes HealthcareProjectsLocationsDatasetsOperationsList =
