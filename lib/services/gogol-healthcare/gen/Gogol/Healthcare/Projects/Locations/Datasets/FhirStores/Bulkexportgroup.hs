               ...
               Core.QueryParam "_type" Core.Text Core.:>
                 Core.QueryParam "access_token" Core.Text Core.:>
                   Core.QueryParam "callback" Core.Text Core.:>
                     Core.QueryParam "organizeOutputBy" Core.Text Core.:>
...
newHealthcareProjectsLocationsDatasetsFhirStoresBulkexportgroup
  name
  = HealthcareProjectsLocationsDatasetsFhirStoresBulkexportgroup{xgafv
                                                                   = Core.Nothing,
                                                                 since = Core.Nothing,
                                                                 type' = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        requestClient
          HealthcareProjectsLocationsDatasetsFhirStoresBulkexportgroup{..}
          = go name xgafv since type' accessToken callback organizeOutputBy
              outputFormat
              uploadType
              uploadProtocol
