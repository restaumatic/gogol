                 ...
                 Core.QueryParam "_type" Core.Text Core.:>
                   Core.QueryParam "access_token" Core.Text Core.:>
                     Core.QueryParam "callback" Core.Text Core.:>
                       Core.QueryParam "outputFormat" Core.Text Core.:>
...
newHealthcareProjectsLocationsDatasetsFhirStoresFhirBulkexport name
  = HealthcareProjectsLocationsDatasetsFhirStoresFhirBulkexport{xgafv
                                                                  = Core.Nothing,
                                                                since = Core.Nothing,
                                                                type' = Core.Nothing,
...
instance Core.GoogleRequest
           HealthcareProjectsLocationsDatasetsFhirStoresFhirBulkexport
         where
        type Rs HealthcareProjectsLocationsDatasetsFhirStoresFhirBulkexport
             = HttpBody
        type Scopes
               HealthcareProjectsLocationsDatasetsFhirStoresFhirBulkexport
        ...
        requestClient
          HealthcareProjectsLocationsDatasetsFhirStoresFhirBulkexport{..}
          = go name xgafv since type' accessToken callback outputFormat
              uploadType
              uploadProtocol
