...
type HealthcareProjectsLocationsDatasetsFhirStoresApplyConsentsResource
     =
     "v1" Core.:>
       Core.CaptureMode "name" "applyConsents" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] ApplyConsentsRequest Core.:>
...
newHealthcareProjectsLocationsDatasetsFhirStoresApplyConsents 
    ...
    -> HealthcareProjectsLocationsDatasetsFhirStoresApplyConsents
newHealthcareProjectsLocationsDatasetsFhirStoresApplyConsents name
  payload
  = HealthcareProjectsLocationsDatasetsFhirStoresApplyConsents{xgafv
                                                                 = Core.Nothing,
...
instance Core.GoogleRequest
           HealthcareProjectsLocationsDatasetsFhirStoresApplyConsents
         where
        type Rs HealthcareProjectsLocationsDatasetsFhirStoresApplyConsents
             = Operation
        type Scopes
               HealthcareProjectsLocationsDatasetsFhirStoresApplyConsents
