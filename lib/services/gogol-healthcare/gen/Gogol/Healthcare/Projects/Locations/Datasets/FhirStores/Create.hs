...
newHealthcareProjectsLocationsDatasetsFhirStoresCreate 
    ...
    -> HealthcareProjectsLocationsDatasetsFhirStoresCreate
newHealthcareProjectsLocationsDatasetsFhirStoresCreate parent
  payload
  = HealthcareProjectsLocationsDatasetsFhirStoresCreate{xgafv =
                                                          Core.Nothing,
                                                        accessToken = Core.Nothing,
                                                        callback = Core.Nothing,
                                                        fhirStoreId = Core.Nothing, parent = parent,
                                                        payload = payload,
...
instance Core.GoogleRequest
           HealthcareProjectsLocationsDatasetsFhirStoresCreate
         where
        type Rs HealthcareProjectsLocationsDatasetsFhirStoresCreate =
             FhirStore
        type Scopes HealthcareProjectsLocationsDatasetsFhirStoresCreate =
             '[CloudHealthcare'FullControl, CloudPlatform'FullControl]
        requestClient
          HealthcareProjectsLocationsDatasetsFhirStoresCreate{..}
          = go parent xgafv accessToken callback fhirStoreId uploadType
              uploadProtocol
