...
--
-- Deletes a FHIR resource. Implements the FHIR standard delete interaction (<https://hl7.org/fhir/DSTU2/http.html#delete DSTU2>, <https://hl7.org/fhir/STU3/http.html#delete STU3>, <https://hl7.org/fhir/R4/http.html#delete R4>, <https://hl7.org/fhir/R5/http.html#delete R5>). Note: Unless resource versioning is disabled by setting the disable/resource/versioning flag on the FHIR store, the deleted resources will be moved to a history repository that can still be retrieved through vread and related methods, unless they are removed by the purge method. For samples that show how to call @delete@, see <https://cloud.google.com/healthcare/docs/how-tos/fhir-resources#deleting_a_fhir_resource Deleting a FHIR resource>.
--
...
newHealthcareProjectsLocationsDatasetsFhirStoresFhirDelete 
    :: 
                                                           Core.Text
       -- ^  Required. The name of the resource to delete. See 'name'.
    -> HealthcareProjectsLocationsDatasetsFhirStoresFhirDelete
newHealthcareProjectsLocationsDatasetsFhirStoresFhirDelete name
  = HealthcareProjectsLocationsDatasetsFhirStoresFhirDelete{xgafv =
                                                              Core.Nothing,
...
instance Core.GoogleRequest
           HealthcareProjectsLocationsDatasetsFhirStoresFhirDelete
         where
        type Rs HealthcareProjectsLocationsDatasetsFhirStoresFhirDelete =
             HttpBody
        type Scopes HealthcareProjectsLocationsDatasetsFhirStoresFhirDelete
