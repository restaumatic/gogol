...
newHealthcareProjectsLocationsDatasetsCreate parent payload
  = HealthcareProjectsLocationsDatasetsCreate{xgafv = Core.Nothing,
                                              accessToken = Core.Nothing, callback = Core.Nothing,
                                              datasetId = Core.Nothing, parent = parent,
                                              payload = payload, uploadType = Core.Nothing,
                                              uploadProtocol = Core.Nothing}
instance Core.GoogleRequest
           HealthcareProjectsLocationsDatasetsCreate
         where
        type Rs HealthcareProjectsLocationsDatasetsCreate = Operation
        type Scopes HealthcareProjectsLocationsDatasetsCreate =
             '[CloudHealthcare'FullControl, CloudPlatform'FullControl]
        requestClient HealthcareProjectsLocationsDatasetsCreate{..}
          = go parent xgafv accessToken callback datasetId uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy HealthcareProjectsLocationsDatasetsCreateResource)
                      Core.mempty
