               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] ExportDicomDataRequest Core.:>
...
newHealthcareProjectsLocationsDatasetsDicomStoresExport 
    ...
    -> HealthcareProjectsLocationsDatasetsDicomStoresExport
newHealthcareProjectsLocationsDatasetsDicomStoresExport name
  payload
  = HealthcareProjectsLocationsDatasetsDicomStoresExport{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           HealthcareProjectsLocationsDatasetsDicomStoresExport
         where
        type Rs HealthcareProjectsLocationsDatasetsDicomStoresExport =
             Operation
        type Scopes HealthcareProjectsLocationsDatasetsDicomStoresExport =
