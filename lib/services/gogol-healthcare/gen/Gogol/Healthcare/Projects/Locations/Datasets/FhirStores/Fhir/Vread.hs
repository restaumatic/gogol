...
--
-- Gets the contents of a version (current or historical) of a FHIR resource by version ID. Implements the FHIR standard vread interaction (<https://hl7.org/fhir/DSTU2/http.html#vread DSTU2>, <https://hl7.org/fhir/STU3/http.html#vread STU3>, <https://hl7.org/fhir/R4/http.html#vread R4>, <https://hl7.org/fhir/R5/http.html#vread R5>). On success, the response body contains a JSON-encoded representation of the resource. Errors generated by the FHIR store contain a JSON-encoded @OperationOutcome@ resource describing the reason for the error. If the request cannot be mapped to a valid API method on a FHIR store, a generic GCP error might be returned instead. For samples that show how to call @vread@, see <https://cloud.google.com/healthcare/docs/how-tos/fhir-resources#retrieving_a_fhir_resource_version Retrieving a FHIR resource version>.
--
...
newHealthcareProjectsLocationsDatasetsFhirStoresFhirVread 
    :: 
                                                          Core.Text
       -- ^  Required. The name of the resource version to retrieve. See 'name'.
    -> HealthcareProjectsLocationsDatasetsFhirStoresFhirVread
newHealthcareProjectsLocationsDatasetsFhirStoresFhirVread name
  = HealthcareProjectsLocationsDatasetsFhirStoresFhirVread{xgafv =
                                                             Core.Nothing,
...
instance Core.GoogleRequest
           HealthcareProjectsLocationsDatasetsFhirStoresFhirVread
         where
        type Rs HealthcareProjectsLocationsDatasetsFhirStoresFhirVread =
             HttpBody
        type Scopes HealthcareProjectsLocationsDatasetsFhirStoresFhirVread
