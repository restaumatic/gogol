...
--
-- RetrieveInstanceMetadata returns instance associated with the given study, series, and SOP Instance UID presented as metadata. See [RetrieveTransaction] (https:\/\/dicom.nema.org\/medical\/dicom\/current\/output\/html\/part18.html#sect_10.4). For details on the implementation of RetrieveInstanceMetadata, see <https://cloud.google.com/healthcare/docs/dicom#metadata_resources Metadata resources> in the Cloud Healthcare API conformance statement. For samples that show how to call RetrieveInstanceMetadata, see <https://cloud.google.com/healthcare/docs/how-tos/dicomweb#retrieve-metadata Retrieve metadata>.
--
