...
type HealthcareProjectsLocationsDatasetsDicomStoresDicomWebStudiesGetStudyMetricsResource
     =
     "v1" Core.:>
       Core.CaptureMode "study" "getStudyMetrics" Core.Text Core.:>
...
newHealthcareProjectsLocationsDatasetsDicomStoresDicomWebStudiesGetStudyMetrics
  study
  = HealthcareProjectsLocationsDatasetsDicomStoresDicomWebStudiesGetStudyMetrics{xgafv
                                                                                   = Core.Nothing,
                                                                                 accessToken =
                                                                                   Core.Nothing,
                                                                                 callback =
...
instance Core.GoogleRequest
        ...
        requestClient
          HealthcareProjectsLocationsDatasetsDicomStoresDicomWebStudiesGetStudyMetrics{..}
          = go study xgafv accessToken callback uploadType uploadProtocol
