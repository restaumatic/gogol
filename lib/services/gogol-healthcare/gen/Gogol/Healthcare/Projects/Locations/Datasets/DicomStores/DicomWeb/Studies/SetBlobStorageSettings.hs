...
type HealthcareProjectsLocationsDatasetsDicomStoresDicomWebStudiesSetBlobStorageSettingsResource
     =
     "v1" Core.:>
       Core.CaptureMode "resource" "setBlobStorageSettings" Core.Text
         Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] SetBlobStorageSettingsRequest Core.:>
...
newHealthcareProjectsLocationsDatasetsDicomStoresDicomWebStudiesSetBlobStorageSettings
  payload resource
  = HealthcareProjectsLocationsDatasetsDicomStoresDicomWebStudiesSetBlobStorageSettings{xgafv
                                                                                          =
                                                                                          Core.Nothing,
                                                                                        accessToken
                                                                                          =
