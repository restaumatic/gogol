               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] ImportDicomDataRequest Core.:>
...
newHealthcareProjectsLocationsDatasetsDicomStoresImport 
    :: 
                                                        Core.Text
       -- ^  Required. The name of the DICOM store resource into which the data is imported. For example, @projects\/{project_id}\/locations\/{location_id}\/datasets\/{dataset_id}\/dicomStores\/{dicom_store_id}@. See 'name'.
    -> ImportDicomDataRequest
       -- ^  Multipart request metadata. See 'payload'.
    -> HealthcareProjectsLocationsDatasetsDicomStoresImport
newHealthcareProjectsLocationsDatasetsDicomStoresImport name
  payload
  = HealthcareProjectsLocationsDatasetsDicomStoresImport{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           HealthcareProjectsLocationsDatasetsDicomStoresImport
         where
        type Rs HealthcareProjectsLocationsDatasetsDicomStoresImport =
             Operation
        type Scopes HealthcareProjectsLocationsDatasetsDicomStoresImport =
