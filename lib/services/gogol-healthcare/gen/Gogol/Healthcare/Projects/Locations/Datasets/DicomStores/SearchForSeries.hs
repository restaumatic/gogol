...
--
-- SearchForSeries returns a list of matching series. See [Search Transaction] (https:\/\/dicom.nema.org\/medical\/dicom\/current\/output\/html\/part18.html#sect_10.6). For details on the implementation of SearchForSeries, see <https://cloud.google.com/healthcare/docs/dicom#search_transaction Search transaction> in the Cloud Healthcare API conformance statement. For samples that show how to call SearchForSeries, see <https://cloud.google.com/healthcare/docs/how-tos/dicomweb#search-dicom Search for DICOM data>.
--
