...
newHealthcareProjectsLocationsDatasetsConsentStoresList parent
  = HealthcareProjectsLocationsDatasetsConsentStoresList{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           HealthcareProjectsLocationsDatasetsConsentStoresList
         where
        type Rs HealthcareProjectsLocationsDatasetsConsentStoresList =
             ListConsentStoresResponse
        type Scopes HealthcareProjectsLocationsDatasetsConsentStoresList =
