...
newHealthcareProjectsLocationsDatasetsFhirStoresGet name
  = HealthcareProjectsLocationsDatasetsFhirStoresGet{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           HealthcareProjectsLocationsDatasetsFhirStoresGet
         where
        type Rs HealthcareProjectsLocationsDatasetsFhirStoresGet =
             FhirStore
        type Scopes HealthcareProjectsLocationsDatasetsFhirStoresGet =
