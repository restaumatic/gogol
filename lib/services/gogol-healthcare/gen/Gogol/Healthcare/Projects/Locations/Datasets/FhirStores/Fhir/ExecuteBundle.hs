...
--
-- Executes all the requests in the given Bundle. Implements the FHIR standard batch\/transaction interaction (<https://hl7.org/fhir/DSTU2/http.html#transaction DSTU2>, <https://hl7.org/fhir/STU3/http.html#transaction STU3>, <https://hl7.org/fhir/R4/http.html#transaction R4>, <https://hl7.org/fhir/R5/http.html#transaction R5>). Supports all interactions within a bundle, except search. This method accepts Bundles of type @batch@ and @transaction@, processing them according to the batch processing rules (<https://hl7.org/fhir/DSTU2/http.html#2.1.0.16.1 DSTU2>, <https://hl7.org/fhir/STU3/http.html#2.21.0.17.1 STU3>, <https://hl7.org/fhir/R4/http.html#brules R4>, <https://hl7.org/fhir/R5/http.html#brules R5>) and transaction processing rules (<https://hl7.org/fhir/DSTU2/http.html#2.1.0.16.2 DSTU2>, <https://hl7.org/fhir/STU3/http.html#2.21.0.17.2 STU3>, <https://hl7.org/fhir/R4/http.html#trules R4>, <https://hl7.org/fhir/R5/http.html#trules R5>). The request body must contain a JSON-encoded FHIR @Bundle@ resource,
-- and the request headers must contain @Content-Type: application\/fhir+json@. For a batch bundle or a successful transaction, the response body contains a JSON-encoded representation of a @Bundle@ resource of type @batch-response@ or @transaction-response@ containing one entry for each entry in the request, with the outcome of processing the entry. In the case of an error for a transaction bundle, the response body contains a JSON-encoded @OperationOutcome@ resource describing the reason for the error. If the request cannot be mapped to a valid API method on a FHIR store, a generic GCP error might be returned instead. This method checks permissions for each request in the bundle. The @executeBundle@ permission is required to call this method, but you must also grant sufficient permissions to execute the individual requests in the bundle. For example, if the bundle contains a request to create a FHIR resource, the caller must also have been granted the @healthcare.fhirResources.create@ permission. You can use
-- audit logs to view the permissions for @executeBundle@ and each request in the bundle. For more information, see <https://cloud.google.com/healthcare-api/docs/how-tos/audit-logging Viewing Cloud Audit logs>. For samples that show how to call @executeBundle@, see <https://cloud.google.com/healthcare/docs/how-tos/fhir-bundles Managing FHIR resources using FHIR bundles>.
--
...
newHealthcareProjectsLocationsDatasetsFhirStoresFhirExecuteBundle
  parent payload
  = HealthcareProjectsLocationsDatasetsFhirStoresFhirExecuteBundle{xgafv
                                                                     = Core.Nothing,
