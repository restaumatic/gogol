...
type HealthcareProjectsLocationsDatasetsFhirStoresDeidentifyResource
     =
     "v1" Core.:>
       Core.CaptureMode "sourceStore" "deidentify" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] DeidentifyFhirStoreRequest Core.:>
...
newHealthcareProjectsLocationsDatasetsFhirStoresDeidentify 
    ...
    -> Core.Text
       -- ^  Required. Source FHIR store resource name. For example, @projects\/{project_id}\/locations\/{location_id}\/datasets\/{dataset_id}\/fhirStores\/{fhir_store_id}@. R5 stores are not supported. See 'sourceStore'.
    -> HealthcareProjectsLocationsDatasetsFhirStoresDeidentify
newHealthcareProjectsLocationsDatasetsFhirStoresDeidentify payload
  sourceStore
  = HealthcareProjectsLocationsDatasetsFhirStoresDeidentify{xgafv =
                                                              Core.Nothing,
...
instance Core.GoogleRequest
           HealthcareProjectsLocationsDatasetsFhirStoresDeidentify
         where
        type Rs HealthcareProjectsLocationsDatasetsFhirStoresDeidentify =
             Operation
        type Scopes HealthcareProjectsLocationsDatasetsFhirStoresDeidentify
             = '[CloudHealthcare'FullControl, CloudPlatform'FullControl]
        requestClient
          HealthcareProjectsLocationsDatasetsFhirStoresDeidentify{..}
          = go sourceStore xgafv accessToken callback uploadType
              uploadProtocol
