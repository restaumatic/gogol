...
--
-- DeleteInstance deletes an instance associated with the given study, series, and SOP Instance UID. Delete requests are equivalent to the GET requests specified in the Retrieve transaction. Study and series search results can take a few seconds to be updated after an instance is deleted using DeleteInstance. For samples that show how to call DeleteInstance, see <https://cloud.google.com/healthcare/docs/how-tos/dicomweb#delete-dicom Delete a study, series, or instance>.
--
...
newHealthcareProjectsLocationsDatasetsDicomStoresStudiesSeriesInstancesDelete 
    :: 
                                                                              Core.Text
       -- ^  Required. The path of the DeleteInstance request. For example, @studies\/{study_uid}\/series\/{series_uid}\/instances\/{instance_uid}@. See 'dicomWebPath'.
    -> Core.Text
...
newHealthcareProjectsLocationsDatasetsDicomStoresStudiesSeriesInstancesDelete
  dicomWebPath parent
  = HealthcareProjectsLocationsDatasetsDicomStoresStudiesSeriesInstancesDelete{xgafv
                                                                                 = Core.Nothing,
                                                                               accessToken =
                                                                                 Core.Nothing,
                                                                               callback =
