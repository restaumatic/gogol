...
newHealthcareProjectsLocationsDatasetsHl7V2StoresMessagesPatch 
    ...
    -> HealthcareProjectsLocationsDatasetsHl7V2StoresMessagesPatch
newHealthcareProjectsLocationsDatasetsHl7V2StoresMessagesPatch name
  payload
  = HealthcareProjectsLocationsDatasetsHl7V2StoresMessagesPatch{xgafv
                                                                  = Core.Nothing,
...
instance Core.GoogleRequest
           HealthcareProjectsLocationsDatasetsHl7V2StoresMessagesPatch
         where
        type Rs HealthcareProjectsLocationsDatasetsHl7V2StoresMessagesPatch
             = Message
        type Scopes
               HealthcareProjectsLocationsDatasetsHl7V2StoresMessagesPatch
