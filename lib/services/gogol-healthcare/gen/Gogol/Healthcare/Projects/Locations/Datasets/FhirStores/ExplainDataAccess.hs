...
type HealthcareProjectsLocationsDatasetsFhirStoresExplainDataAccessResource
     =
     "v1" Core.:>
       Core.CaptureMode "name" "explainDataAccess" Core.Text Core.:>
         Core.QueryParam "$.xgafv" Xgafv Core.:>
           Core.QueryParam "access_token" Core.Text Core.:>
             Core.QueryParam "callback" Core.Text Core.:>
               Core.QueryParam "resourceId" Core.Text Core.:>
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.Get '[Core.JSON] ExplainDataAccessResponse
...
newHealthcareProjectsLocationsDatasetsFhirStoresExplainDataAccess
  name
  = HealthcareProjectsLocationsDatasetsFhirStoresExplainDataAccess{xgafv
                                                                     = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        requestClient
          HealthcareProjectsLocationsDatasetsFhirStoresExplainDataAccess{..}
          = go name xgafv accessToken callback resourceId uploadType
              uploadProtocol
