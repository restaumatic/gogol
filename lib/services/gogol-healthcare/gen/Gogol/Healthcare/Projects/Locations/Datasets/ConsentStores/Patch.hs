...
newHealthcareProjectsLocationsDatasetsConsentStoresPatch 
    :: 
                                                         Core.Text
       -- ^  Identifier. Resource name of the consent store, of the form @projects\/{project_id}\/locations\/{location_id}\/datasets\/{dataset_id}\/consentStores\/{consent_store_id}@. Cannot be changed after creation. See 'name'.
    -> ConsentStore
       -- ^  Multipart request metadata. See 'payload'.
    -> HealthcareProjectsLocationsDatasetsConsentStoresPatch
newHealthcareProjectsLocationsDatasetsConsentStoresPatch name
  payload
  = HealthcareProjectsLocationsDatasetsConsentStoresPatch{xgafv =
                                                            Core.Nothing,
...
instance Core.GoogleRequest
           HealthcareProjectsLocationsDatasetsConsentStoresPatch
         where
        type Rs HealthcareProjectsLocationsDatasetsConsentStoresPatch =
             ConsentStore
        type Scopes HealthcareProjectsLocationsDatasetsConsentStoresPatch =
