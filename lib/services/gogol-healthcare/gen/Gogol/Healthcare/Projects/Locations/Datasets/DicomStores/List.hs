...
newHealthcareProjectsLocationsDatasetsDicomStoresList parent
  = HealthcareProjectsLocationsDatasetsDicomStoresList{xgafv =
                                                         Core.Nothing,
...
instance Core.GoogleRequest
           HealthcareProjectsLocationsDatasetsDicomStoresList
         where
        type Rs HealthcareProjectsLocationsDatasetsDicomStoresList =
             ListDicomStoresResponse
        type Scopes HealthcareProjectsLocationsDatasetsDicomStoresList =
