...
type HealthcareProjectsLocationsDatasetsDicomStoresDicomWebStudiesSeriesGetSeriesMetricsResource
     =
     "v1" Core.:>
       Core.CaptureMode "series" "getSeriesMetrics" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.Get '[Core.JSON] SeriesMetrics
...
newHealthcareProjectsLocationsDatasetsDicomStoresDicomWebStudiesSeriesGetSeriesMetrics
  series
  = HealthcareProjectsLocationsDatasetsDicomStoresDicomWebStudiesSeriesGetSeriesMetrics{xgafv
                                                                                          =
                                                                                          Core.Nothing,
                                                                                        accessToken
                                                                                          =
...
instance Core.GoogleRequest
        ...
        requestClient
          HealthcareProjectsLocationsDatasetsDicomStoresDicomWebStudiesSeriesGetSeriesMetrics{..}
          = go series xgafv accessToken callback uploadType uploadProtocol
