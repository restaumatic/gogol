...
newHealthcareProjectsLocationsDatasetsFhirStoresFhirPatienteverything
  name
  = HealthcareProjectsLocationsDatasetsFhirStoresFhirPatienteverything{xgafv
                                                                         = Core.Nothing,
                                                                       count = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        requestClient
          HealthcareProjectsLocationsDatasetsFhirStoresFhirPatienteverything{..}
          = go name xgafv count pageToken since type' accessToken callback
              end
              start
              uploadType
              uploadProtocol
