...
newHealthcareProjectsLocationsGet name
  = HealthcareProjectsLocationsGet{xgafv = Core.Nothing,
                                   accessToken = Core.Nothing, callback = Core.Nothing, name = name,
                                   uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest HealthcareProjectsLocationsGet where
        ...
        requestClient HealthcareProjectsLocationsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy HealthcareProjectsLocationsGetResource)
                      Core.mempty
