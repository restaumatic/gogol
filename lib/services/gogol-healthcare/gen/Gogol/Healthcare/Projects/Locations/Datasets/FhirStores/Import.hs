               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] ImportResourcesRequest Core.:>
...
newHealthcareProjectsLocationsDatasetsFhirStoresImport name payload
  = HealthcareProjectsLocationsDatasetsFhirStoresImport{xgafv =
                                                          Core.Nothing,
...
instance Core.GoogleRequest
           HealthcareProjectsLocationsDatasetsFhirStoresImport
         where
        type Rs HealthcareProjectsLocationsDatasetsFhirStoresImport =
             Operation
        type Scopes HealthcareProjectsLocationsDatasetsFhirStoresImport =
