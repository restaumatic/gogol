...
-- @consent_config.access_enforced@ must be set to true for the FhirStore. FHIR Consent is not supported in DSTU2 or R5.
--
...
type HealthcareProjectsLocationsDatasetsFhirStoresApplyAdminConsentsResource
     =
     "v1" Core.:>
       Core.CaptureMode "name" "applyAdminConsents" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] ApplyAdminConsentsRequest Core.:>
...
newHealthcareProjectsLocationsDatasetsFhirStoresApplyAdminConsents
  name payload
  = HealthcareProjectsLocationsDatasetsFhirStoresApplyAdminConsents{xgafv
                                                                      = Core.Nothing,
