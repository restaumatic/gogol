...
newHealthcareProjectsLocationsDatasetsFhirStoresPatch name payload
  = HealthcareProjectsLocationsDatasetsFhirStoresPatch{xgafv =
                                                         Core.Nothing,
...
instance Core.GoogleRequest
           HealthcareProjectsLocationsDatasetsFhirStoresPatch
         where
        type Rs HealthcareProjectsLocationsDatasetsFhirStoresPatch =
             FhirStore
        type Scopes HealthcareProjectsLocationsDatasetsFhirStoresPatch =
