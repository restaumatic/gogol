...
newHealthcareProjectsLocationsDatasetsDicomStoresPatch name payload
  = HealthcareProjectsLocationsDatasetsDicomStoresPatch{xgafv =
                                                          Core.Nothing,
...
instance Core.GoogleRequest
           HealthcareProjectsLocationsDatasetsDicomStoresPatch
         where
        type Rs HealthcareProjectsLocationsDatasetsDicomStoresPatch =
             DicomStore
        type Scopes HealthcareProjectsLocationsDatasetsDicomStoresPatch =
