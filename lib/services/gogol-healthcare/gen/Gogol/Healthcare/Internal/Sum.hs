...
-- | Remove tags based on DICOM Standard\'s Attribute Confidentiality Basic Profile (DICOM Standard Edition 2018e) https:\/\/dicom.nema.org\/medical\/dicom\/2018e\/output\/chtml\/part15\/chapter_E.html.
