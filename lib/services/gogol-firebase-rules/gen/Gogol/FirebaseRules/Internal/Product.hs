...
instance Core.FromJSON Arg where
        parseJSON
          = Core.withObject "Arg"
              (\ o ->
                 Arg Core.<$>
                   (o Core..:? "anyValue") Core.<*> (o Core..:? "exactValue"))
...
newExpressionReport 
    ::  ExpressionReport
newExpressionReport
  = ExpressionReport{children = Core.Nothing,
                     sourcePosition = Core.Nothing, values = Core.Nothing}
instance Core.FromJSON ExpressionReport where
        parseJSON
          = Core.withObject "ExpressionReport"
              (\ o ->
                 ExpressionReport Core.<$>
                   (o Core..:? "children") Core.<*> (o Core..:? "sourcePosition")
                     Core.<*> (o Core..:? "values"))
...
newFile 
    ::  File
newFile
  = File{content = Core.Nothing, fingerprint = Core.Nothing,
         name = Core.Nothing}
instance Core.FromJSON File where
        parseJSON
          = Core.withObject "File"
              (\ o ->
                 File Core.<$>
                   (o Core..:? "content") Core.<*> (o Core..:? "fingerprint") Core.<*>
                     (o Core..:? "name"))
...
newFunctionMock 
    ::  FunctionMock
newFunctionMock
  = FunctionMock{args = Core.Nothing, function = Core.Nothing,
                 result = Core.Nothing}
instance Core.FromJSON FunctionMock where
        parseJSON
          = Core.withObject "FunctionMock"
              (\ o ->
                 FunctionMock Core.<$>
                   (o Core..:? "args") Core.<*> (o Core..:? "function") Core.<*>
                     (o Core..:? "result"))
...
newGetReleaseExecutableResponse 
    ::  GetReleaseExecutableResponse
newGetReleaseExecutableResponse
  = GetReleaseExecutableResponse{executable = Core.Nothing,
                                 executableVersion = Core.Nothing, language = Core.Nothing,
                                 rulesetName = Core.Nothing, syncTime = Core.Nothing,
          ...
          = Core.withObject "GetReleaseExecutableResponse"
              (\ o ->
                 GetReleaseExecutableResponse Core.<$>
                   (o Core..:? "executable") Core.<*> (o Core..:? "executableVersion")
...
newIssue 
    ::  Issue
newIssue
  = Issue{description = Core.Nothing, severity = Core.Nothing,
...
instance Core.FromJSON Issue where
        parseJSON
          = Core.withObject "Issue"
              (\ o ->
                 Issue Core.<$>
                   (o Core..:? "description") Core.<*> (o Core..:? "severity")
...
newListReleasesResponse 
    ::  ListReleasesResponse
newListReleasesResponse
  = ListReleasesResponse{nextPageToken = Core.Nothing,
          ...
          = Core.withObject "ListReleasesResponse"
              (\ o ->
                 ListReleasesResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "releases"))
...
newListRulesetsResponse 
    ::  ListRulesetsResponse
newListRulesetsResponse
  = ListRulesetsResponse{nextPageToken = Core.Nothing,
          ...
          = Core.withObject "ListRulesetsResponse"
              (\ o ->
                 ListRulesetsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "rulesets"))
...
newRelease 
    ::  Release
newRelease
  = Release{createTime = Core.Nothing, name = Core.Nothing,
            rulesetName = Core.Nothing, updateTime = Core.Nothing}
...
instance Core.FromJSON Result where
        parseJSON
          = Core.withObject "Result"
              (\ o ->
                 Result Core.<$>
                   (o Core..:? "undefined") Core.<*> (o Core..:? "value"))
...
newRuleset 
    ::  Ruleset
newRuleset
  = Ruleset{attachmentPoint = Core.Nothing,
            createTime = Core.Nothing, metadata = Core.Nothing,
...
instance Core.FromJSON Ruleset where
        parseJSON
          = Core.withObject "Ruleset"
              (\ o ->
                 Ruleset Core.<$>
                   (o Core..:? "attachmentPoint") Core.<*> (o Core..:? "createTime")
...
newSourcePosition 
    ::  SourcePosition
newSourcePosition
  = SourcePosition{column = Core.Nothing,
                   currentOffset = Core.Nothing, endOffset = Core.Nothing,
                   fileName = Core.Nothing, line = Core.Nothing}
instance Core.FromJSON SourcePosition where
        parseJSON
          = Core.withObject "SourcePosition"
              (\ o ->
                 SourcePosition Core.<$>
                   (o Core..:? "column") Core.<*> (o Core..:? "currentOffset")
...
newTestCase 
    ::  TestCase
newTestCase
  = TestCase{expectation = Core.Nothing,
             expressionReportLevel = Core.Nothing, functionMocks = Core.Nothing,
             pathEncoding = Core.Nothing, request' = Core.Nothing,
...
newTestResult 
    ::  TestResult
newTestResult
  = TestResult{debugMessages = Core.Nothing,
               errorPosition = Core.Nothing, expressionReports = Core.Nothing,
               functionCalls = Core.Nothing, state = Core.Nothing,
...
instance Core.FromJSON TestResult where
        parseJSON
          = Core.withObject "TestResult"
              (\ o ->
                 TestResult Core.<$>
                   (o Core..:? "debugMessages") Core.<*> (o Core..:? "errorPosition")
...
newTestRulesetRequest 
    ::  TestRulesetRequest
newTestRulesetRequest
  = TestRulesetRequest{source = Core.Nothing,
          ...
          = Core.withObject "TestRulesetRequest"
              (\ o ->
                 TestRulesetRequest Core.<$>
                   (o Core..:? "source") Core.<*> (o Core..:? "testSuite"))
...
newTestRulesetResponse 
    ::  TestRulesetResponse
newTestRulesetResponse
  = TestRulesetResponse{issues = Core.Nothing,
          ...
          = Core.withObject "TestRulesetResponse"
              (\ o ->
                 TestRulesetResponse Core.<$>
                   (o Core..:? "issues") Core.<*> (o Core..:? "testResults"))
...
newUpdateReleaseRequest 
    ::  UpdateReleaseRequest
newUpdateReleaseRequest
  = UpdateReleaseRequest{release = Core.Nothing,
          ...
          = Core.withObject "UpdateReleaseRequest"
              (\ o ->
                 UpdateReleaseRequest Core.<$>
                   (o Core..:? "release") Core.<*> (o Core..:? "updateMask"))
...
newVisitedExpression 
    ::  VisitedExpression
newVisitedExpression
  = VisitedExpression{sourcePosition = Core.Nothing,
                      value = Core.Nothing}
          ...
          = Core.withObject "VisitedExpression"
              (\ o ->
                 VisitedExpression Core.<$>
                   (o Core..:? "sourcePosition") Core.<*> (o Core..:? "value"))
