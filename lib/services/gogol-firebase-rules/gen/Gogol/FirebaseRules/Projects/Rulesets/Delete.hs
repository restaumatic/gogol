...
newFirebaseRulesProjectsRulesetsDelete name
  = FirebaseRulesProjectsRulesetsDelete{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        name = name, uploadType = Core.Nothing,
                                        uploadProtocol = Core.Nothing}
instance Core.GoogleRequest FirebaseRulesProjectsRulesetsDelete
         where
        type Rs FirebaseRulesProjectsRulesetsDelete = Empty
        type Scopes FirebaseRulesProjectsRulesetsDelete =
