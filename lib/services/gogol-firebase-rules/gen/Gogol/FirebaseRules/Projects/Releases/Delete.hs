...
newFirebaseRulesProjectsReleasesDelete name
  = FirebaseRulesProjectsReleasesDelete{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        name = name, uploadType = Core.Nothing,
                                        uploadProtocol = Core.Nothing}
instance Core.GoogleRequest FirebaseRulesProjectsReleasesDelete
         where
        type Rs FirebaseRulesProjectsReleasesDelete = Empty
        type Scopes FirebaseRulesProjectsReleasesDelete =
