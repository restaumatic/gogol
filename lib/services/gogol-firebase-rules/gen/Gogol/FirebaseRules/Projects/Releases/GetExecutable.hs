...
type FirebaseRulesProjectsReleasesGetExecutableResource =
     "v1" Core.:>
       Core.CaptureMode "name" "getExecutable" Core.Text Core.:>
...
newFirebaseRulesProjectsReleasesGetExecutable name
  = FirebaseRulesProjectsReleasesGetExecutable{xgafv = Core.Nothing,
                                               accessToken = Core.Nothing, callback = Core.Nothing,
                                               executableVersion = Core.Nothing, name = name,
...
instance Core.GoogleRequest
        ...
        type Scopes FirebaseRulesProjectsReleasesGetExecutable =
             '[CloudPlatform'FullControl, Firebase'FullControl,
               Firebase'Readonly]
        requestClient FirebaseRulesProjectsReleasesGetExecutable{..}
          = go name xgafv accessToken callback executableVersion uploadType
              uploadProtocol
