             ...
             "comments" Core.:>
               Core.QueryParam "maxResults" Core.Word32 Core.:>
                 Core.QueryParam "pageToken" Core.Text Core.:>
                   Core.QueryParam "sortOrder" CommentsListSortOrder Core.:>
...
newPlusDomainsCommentsList activityId
  = PlusDomainsCommentsList{activityId = activityId, maxResults = 20,
...
instance Core.GoogleRequest PlusDomainsCommentsList where
        ...
        type Scopes PlusDomainsCommentsList =
        ...
        requestClient PlusDomainsCommentsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy PlusDomainsCommentsListResource)
                      Core.mempty
