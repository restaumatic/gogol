...
data Acl = Acl
    ...
    , domainRestricted :: (Core.Maybe Core.Bool)
      -- | The list of access entries.
    , items :: (Core.Maybe [PlusDomainsAclentryResource])
...
newAcl 
    ::  Acl
newAcl
  = Acl{description = Core.Nothing, domainRestricted = Core.Nothing,
        items = Core.Nothing, kind = "plus#acl"}
instance Core.FromJSON Acl where
        parseJSON
          = Core.withObject "Acl"
              (\ o ->
                 Acl Core.<$>
                   (o Core..:? "description") Core.<*> (o Core..:? "domainRestricted")
                     Core.<*> (o Core..:? "items")
          ...
          = Core.object
              (Core.catMaybes
                 [("description" Core..=) Core.<$> description,
                  ("domainRestricted" Core..=) Core.<$> domainRestricted,
...
newActivity 
    ::  Activity
newActivity
  = Activity{access = Core.Nothing, actor = Core.Nothing,
             address = Core.Nothing, annotation = Core.Nothing,
             crosspostSource = Core.Nothing, etag = Core.Nothing,
             geocode = Core.Nothing, id = Core.Nothing, kind = "plus#activity",
             location = Core.Nothing, object = Core.Nothing,
             placeId = Core.Nothing, placeName = Core.Nothing,
             provider = Core.Nothing, published = Core.Nothing,
             radius = Core.Nothing, title = Core.Nothing,
             updated = Core.Nothing, url = Core.Nothing, verb = Core.Nothing}
instance Core.FromJSON Activity where
        parseJSON
          = Core.withObject "Activity"
              (\ o ->
                 Activity Core.<$>
                   (o Core..:? "access") Core.<*> (o Core..:? "actor") Core.<*>
                     (o Core..:? "address")
          ...
          = Core.object
              (Core.catMaybes
                 [("access" Core..=) Core.<$> access,
                  ...
                  ("etag" Core..=) Core.<$> etag,
                  ("geocode" Core..=) Core.<$> geocode, ("id" Core..=) Core.<$> id,
                  ...
                  ("updated" Core..=) Core.<$> updated, ("url" Core..=) Core.<$> url,
                  ("verb" Core..=) Core.<$> verb])
...
newActivity_Actor 
    ::  Activity_Actor
newActivity_Actor
  = Activity_Actor{clientSpecificActorInfo = Core.Nothing,
                   displayName = Core.Nothing, id = Core.Nothing,
                   image = Core.Nothing, name = Core.Nothing, url = Core.Nothing,
...
newActivity_Actor_ClientSpecificActorInfo 
    :: 
                                          Activity_Actor_ClientSpecificActorInfo
newActivity_Actor_ClientSpecificActorInfo
  = Activity_Actor_ClientSpecificActorInfo{youtubeActorInfo =
                                             Core.Nothing}
instance Core.FromJSON Activity_Actor_ClientSpecificActorInfo where
        parseJSON
          = Core.withObject "Activity_Actor_ClientSpecificActorInfo"
              (\ o ->
                 Activity_Actor_ClientSpecificActorInfo Core.<$>
                   (o Core..:? "youtubeActorInfo"))

instance Core.ToJSON Activity_Actor_ClientSpecificActorInfo where
        toJSON Activity_Actor_ClientSpecificActorInfo{..}
          = Core.object
              (Core.catMaybes
                 [("youtubeActorInfo" Core..=) Core.<$> youtubeActorInfo])
...
newActivity_Actor_ClientSpecificActorInfo_YoutubeActorInfo 
    :: 
                                                           Activity_Actor_ClientSpecificActorInfo_YoutubeActorInfo
newActivity_Actor_ClientSpecificActorInfo_YoutubeActorInfo
  = Activity_Actor_ClientSpecificActorInfo_YoutubeActorInfo{channelId
                                                              = Core.Nothing}
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "Activity_Actor_ClientSpecificActorInfo_YoutubeActorInfo"
              (\ o ->
                 Activity_Actor_ClientSpecificActorInfo_YoutubeActorInfo Core.<$>
                   (o Core..:? "channelId"))

instance Core.ToJSON
           Activity_Actor_ClientSpecificActorInfo_YoutubeActorInfo
         where
        toJSON Activity_Actor_ClientSpecificActorInfo_YoutubeActorInfo{..}
          = Core.object
...
instance Core.FromJSON Activity_Actor_Image where
        parseJSON
          = Core.withObject "Activity_Actor_Image"
              (\ o -> Activity_Actor_Image Core.<$> (o Core..:? "url"))
...
newActivity_Actor_Name 
    ::  Activity_Actor_Name
newActivity_Actor_Name
  = Activity_Actor_Name{familyName = Core.Nothing,
...
instance Core.FromJSON Activity_Actor_Verification where
        parseJSON
          = Core.withObject "Activity_Actor_Verification"
              (\ o ->
                 Activity_Actor_Verification Core.<$> (o Core..:? "adHocVerified"))

instance Core.ToJSON Activity_Actor_Verification where
        toJSON Activity_Actor_Verification{..}
          = Core.object
              (Core.catMaybes [("adHocVerified" Core..=) Core.<$> adHocVerified])
...
data Activity_Object = Activity_Object
    ...
    , statusForViewer :: (Core.Maybe Activity_Object_StatusForViewer)
...
newActivity_Object 
    ::  Activity_Object
newActivity_Object
  = Activity_Object{actor = Core.Nothing, attachments = Core.Nothing,
                    content = Core.Nothing, id = Core.Nothing,
                    objectType = Core.Nothing, originalContent = Core.Nothing,
                    plusoners = Core.Nothing, replies = Core.Nothing,
                    resharers = Core.Nothing, statusForViewer = Core.Nothing,
                    url = Core.Nothing}
          ...
          = Core.withObject "Activity_Object"
              (\ o ->
                 Activity_Object Core.<$>
                   (o Core..:? "actor") Core.<*> (o Core..:? "attachments") Core.<*>
                     (o Core..:? "content")
                     Core.<*> (o Core..:? "id")
          ...
          = Core.object
              (Core.catMaybes
                 [("actor" Core..=) Core.<$> actor,
                  ...
                  ("content" Core..=) Core.<$> content, ("id" Core..=) Core.<$> id,
                  ...
                  ("statusForViewer" Core..=) Core.<$> statusForViewer,
                  ("url" Core..=) Core.<$> url])
...
newActivity_Object_Actor 
    ::  Activity_Object_Actor
newActivity_Object_Actor
  = Activity_Object_Actor{clientSpecificActorInfo = Core.Nothing,
                          displayName = Core.Nothing, id = Core.Nothing,
                          image = Core.Nothing, url = Core.Nothing,
                          verification = Core.Nothing}
...
newActivity_Object_Actor_ClientSpecificActorInfo 
    :: 
                                                 Activity_Object_Actor_ClientSpecificActorInfo
newActivity_Object_Actor_ClientSpecificActorInfo
  = Activity_Object_Actor_ClientSpecificActorInfo{youtubeActorInfo =
                                                    Core.Nothing}
instance Core.FromJSON
           Activity_Object_Actor_ClientSpecificActorInfo
         where
        parseJSON
          = Core.withObject "Activity_Object_Actor_ClientSpecificActorInfo"
              (\ o ->
                 Activity_Object_Actor_ClientSpecificActorInfo Core.<$>
                   (o Core..:? "youtubeActorInfo"))

instance Core.ToJSON Activity_Object_Actor_ClientSpecificActorInfo
         where
        toJSON Activity_Object_Actor_ClientSpecificActorInfo{..}
          = Core.object
              (Core.catMaybes
                 [("youtubeActorInfo" Core..=) Core.<$> youtubeActorInfo])
...
newActivity_Object_Actor_ClientSpecificActorInfo_YoutubeActorInfo 
    :: 
                                                                  Activity_Object_Actor_ClientSpecificActorInfo_YoutubeActorInfo
newActivity_Object_Actor_ClientSpecificActorInfo_YoutubeActorInfo
  = Activity_Object_Actor_ClientSpecificActorInfo_YoutubeActorInfo{channelId
                                                                     = Core.Nothing}
instance Core.FromJSON
           Activity_Object_Actor_ClientSpecificActorInfo_YoutubeActorInfo
         where
...
instance Core.FromJSON Activity_Object_Actor_Image where
        parseJSON
          = Core.withObject "Activity_Object_Actor_Image"
              (\ o -> Activity_Object_Actor_Image Core.<$> (o Core..:? "url"))

instance Core.ToJSON Activity_Object_Actor_Image where
...
instance Core.FromJSON Activity_Object_Actor_Verification where
        parseJSON
          = Core.withObject "Activity_Object_Actor_Verification"
              (\ o ->
                 Activity_Object_Actor_Verification Core.<$>
                   (o Core..:? "adHocVerified"))

instance Core.ToJSON Activity_Object_Actor_Verification where
...
newActivity_Object_AttachmentsItem 
    :: 
                                   Activity_Object_AttachmentsItem
newActivity_Object_AttachmentsItem
  = Activity_Object_AttachmentsItem{content = Core.Nothing,
                                    displayName = Core.Nothing, embed = Core.Nothing,
                                    fullImage = Core.Nothing, id = Core.Nothing,
                                    image = Core.Nothing, objectType = Core.Nothing,
                                    previewThumbnails = Core.Nothing, thumbnails = Core.Nothing,
                                    url = Core.Nothing}
instance Core.FromJSON Activity_Object_AttachmentsItem where
        parseJSON
          = Core.withObject "Activity_Object_AttachmentsItem"
              (\ o ->
                 Activity_Object_AttachmentsItem Core.<$>
                   (o Core..:? "content") Core.<*> (o Core..:? "displayName") Core.<*>
                     (o Core..:? "embed")
...
instance Core.ToJSON Activity_Object_AttachmentsItem where
          ...
          = Core.object
              (Core.catMaybes
                 [("content" Core..=) Core.<$> content,
                  ...
                  ("id" Core..=) Core.<$> id, ("image" Core..=) Core.<$> image,
                  ("objectType" Core..=) Core.<$> objectType,
                  ("previewThumbnails" Core..=) Core.<$> previewThumbnails,
...
newActivity_Object_AttachmentsItem_Embed 
    :: 
                                         Activity_Object_AttachmentsItem_Embed
newActivity_Object_AttachmentsItem_Embed
  = Activity_Object_AttachmentsItem_Embed{type' = Core.Nothing,
                                          url = Core.Nothing}
instance Core.FromJSON Activity_Object_AttachmentsItem_Embed where
        parseJSON
          = Core.withObject "Activity_Object_AttachmentsItem_Embed"
              (\ o ->
                 Activity_Object_AttachmentsItem_Embed Core.<$>
                   (o Core..:? "type") Core.<*> (o Core..:? "url"))

instance Core.ToJSON Activity_Object_AttachmentsItem_Embed where
...
newActivity_Object_AttachmentsItem_FullImage 
    :: 
                                             Activity_Object_AttachmentsItem_FullImage
newActivity_Object_AttachmentsItem_FullImage
  = Activity_Object_AttachmentsItem_FullImage{height = Core.Nothing,
                                              type' = Core.Nothing, url = Core.Nothing,
                                              width = Core.Nothing}
instance Core.FromJSON Activity_Object_AttachmentsItem_FullImage
         where
        parseJSON
          = Core.withObject "Activity_Object_AttachmentsItem_FullImage"
              (\ o ->
                 Activity_Object_AttachmentsItem_FullImage Core.<$>
                   (o Core..:? "height") Core.<*> (o Core..:? "type") Core.<*>
                     (o Core..:? "url")
                     Core.<*> (o Core..:? "width"))

instance Core.ToJSON Activity_Object_AttachmentsItem_FullImage
         where
...
newActivity_Object_AttachmentsItem_Image 
    :: 
                                         Activity_Object_AttachmentsItem_Image
newActivity_Object_AttachmentsItem_Image
  = Activity_Object_AttachmentsItem_Image{height = Core.Nothing,
                                          type' = Core.Nothing, url = Core.Nothing,
                                          width = Core.Nothing}
instance Core.FromJSON Activity_Object_AttachmentsItem_Image where
        parseJSON
          = Core.withObject "Activity_Object_AttachmentsItem_Image"
              (\ o ->
...
instance Core.ToJSON Activity_Object_AttachmentsItem_Image where
...
--
-- /See:/ 'newActivity_Object_AttachmentsItem_PreviewThumbnailsItem' smart constructor.
newtype Activity_Object_AttachmentsItem_PreviewThumbnailsItem = Activity_Object_AttachmentsItem_PreviewThumbnailsItem
    {
...
-- | Creates a value of 'Activity_Object_AttachmentsItem_PreviewThumbnailsItem' with the minimum fields required to make a request.
newActivity_Object_AttachmentsItem_PreviewThumbnailsItem 
    :: 
                                                         Activity_Object_AttachmentsItem_PreviewThumbnailsItem
newActivity_Object_AttachmentsItem_PreviewThumbnailsItem
  = Activity_Object_AttachmentsItem_PreviewThumbnailsItem{url =
                                                            Core.Nothing}
instance Core.FromJSON
           Activity_Object_AttachmentsItem_PreviewThumbnailsItem
         where
        parseJSON
          = Core.withObject
              "Activity_Object_AttachmentsItem_PreviewThumbnailsItem"
              (\ o ->
                 Activity_Object_AttachmentsItem_PreviewThumbnailsItem Core.<$>
                   (o Core..:? "url"))

instance Core.ToJSON
           Activity_Object_AttachmentsItem_PreviewThumbnailsItem
         where
        toJSON Activity_Object_AttachmentsItem_PreviewThumbnailsItem{..}
          = Core.object (Core.catMaybes [("url" Core..=) Core.<$> url])
...
newActivity_Object_AttachmentsItem_ThumbnailsItem 
    :: 
                                                  Activity_Object_AttachmentsItem_ThumbnailsItem
newActivity_Object_AttachmentsItem_ThumbnailsItem
  = Activity_Object_AttachmentsItem_ThumbnailsItem{description =
                                                     Core.Nothing,
                                                   image = Core.Nothing, url = Core.Nothing}
instance Core.FromJSON
           Activity_Object_AttachmentsItem_ThumbnailsItem
         where
        parseJSON
          = Core.withObject "Activity_Object_AttachmentsItem_ThumbnailsItem"
              (\ o ->
                 Activity_Object_AttachmentsItem_ThumbnailsItem Core.<$>
                   (o Core..:? "description") Core.<*> (o Core..:? "image") Core.<*>
                     (o Core..:? "url"))

instance Core.ToJSON Activity_Object_AttachmentsItem_ThumbnailsItem
         where
        toJSON Activity_Object_AttachmentsItem_ThumbnailsItem{..}
          = Core.object
              (Core.catMaybes
                 [("description" Core..=) Core.<$> description,
                  ("image" Core..=) Core.<$> image, ("url" Core..=) Core.<$> url])
...
newActivity_Object_AttachmentsItem_ThumbnailsItem_Image 
    :: 
                                                        Activity_Object_AttachmentsItem_ThumbnailsItem_Image
newActivity_Object_AttachmentsItem_ThumbnailsItem_Image
  = Activity_Object_AttachmentsItem_ThumbnailsItem_Image{height =
                                                           Core.Nothing,
                                                         type' = Core.Nothing, url = Core.Nothing,
                                                         width = Core.Nothing}
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "Activity_Object_AttachmentsItem_ThumbnailsItem_Image"
              (\ o ->
                 Activity_Object_AttachmentsItem_ThumbnailsItem_Image Core.<$>
                   (o Core..:? "height") Core.<*> (o Core..:? "type") Core.<*>
                     (o Core..:? "url")
                     Core.<*> (o Core..:? "width"))
...
instance Core.ToJSON
           Activity_Object_AttachmentsItem_ThumbnailsItem_Image
         where
        toJSON Activity_Object_AttachmentsItem_ThumbnailsItem_Image{..}
          = Core.object
              (Core.catMaybes
                 [("height" Core..=) Core.<$> height,
                  ("type" Core..=) Core.<$> type', ("url" Core..=) Core.<$> url,
...
newActivity_Object_Plusoners 
    ::  Activity_Object_Plusoners
newActivity_Object_Plusoners
  = Activity_Object_Plusoners{selfLink = Core.Nothing,
                              totalItems = Core.Nothing}
instance Core.FromJSON Activity_Object_Plusoners where
        parseJSON
          = Core.withObject "Activity_Object_Plusoners"
              (\ o ->
                 Activity_Object_Plusoners Core.<$>
                   (o Core..:? "selfLink") Core.<*> (o Core..:? "totalItems"))
...
newActivity_Object_Replies 
    ::  Activity_Object_Replies
newActivity_Object_Replies
  = Activity_Object_Replies{selfLink = Core.Nothing,
                            totalItems = Core.Nothing}
...
newActivity_Object_Resharers 
    ::  Activity_Object_Resharers
newActivity_Object_Resharers
  = Activity_Object_Resharers{selfLink = Core.Nothing,
                              totalItems = Core.Nothing}
instance Core.FromJSON Activity_Object_Resharers where
        parseJSON
...
-- | Status of the activity as seen by the viewer.
--
-- /See:/ 'newActivity_Object_StatusForViewer' smart constructor.
data Activity_Object_StatusForViewer = Activity_Object_StatusForViewer
    {
      -- | Whether the viewer can comment on the activity.
      canComment :: (Core.Maybe Core.Bool)
      -- | Whether the viewer can +1 the activity.
    , canPlusone :: (Core.Maybe Core.Bool)
      -- | Whether the viewer can edit or delete the activity.
    , canUpdate :: (Core.Maybe Core.Bool)
      -- | Whether the viewer has +1\'d the activity.
    , isPlusOned :: (Core.Maybe Core.Bool)
      -- | Whether reshares are disabled for the activity.
    , resharingDisabled :: (Core.Maybe Core.Bool)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'Activity_Object_StatusForViewer' with the minimum fields required to make a request.
newActivity_Object_StatusForViewer 
    :: 
                                   Activity_Object_StatusForViewer
newActivity_Object_StatusForViewer
  = Activity_Object_StatusForViewer{canComment = Core.Nothing,
                                    canPlusone = Core.Nothing, canUpdate = Core.Nothing,
                                    isPlusOned = Core.Nothing, resharingDisabled = Core.Nothing}
instance Core.FromJSON Activity_Object_StatusForViewer where
        parseJSON
          = Core.withObject "Activity_Object_StatusForViewer"
              (\ o ->
                 Activity_Object_StatusForViewer Core.<$>
                   (o Core..:? "canComment") Core.<*> (o Core..:? "canPlusone")
                     Core.<*> (o Core..:? "canUpdate")
                     Core.<*> (o Core..:? "isPlusOned")
                     Core.<*> (o Core..:? "resharingDisabled"))

instance Core.ToJSON Activity_Object_StatusForViewer where
        toJSON Activity_Object_StatusForViewer{..}
          = Core.object
              (Core.catMaybes
                 [("canComment" Core..=) Core.<$> canComment,
                  ("canPlusone" Core..=) Core.<$> canPlusone,
                  ("canUpdate" Core..=) Core.<$> canUpdate,
                  ("isPlusOned" Core..=) Core.<$> isPlusOned,
                  ("resharingDisabled" Core..=) Core.<$> resharingDisabled])
...
instance Core.FromJSON Activity_Provider where
        parseJSON
          = Core.withObject "Activity_Provider"
              (\ o -> Activity_Provider Core.<$> (o Core..:? "title"))
...
newActivityFeed 
    ::  ActivityFeed
newActivityFeed
  = ActivityFeed{etag = Core.Nothing, id = Core.Nothing,
                 items = Core.Nothing, kind = "plus#activityFeed",
                 nextLink = Core.Nothing, nextPageToken = Core.Nothing,
...
--
-- /See:/ 'newAudience' smart constructor.
data Audience = Audience
    {
      -- | ETag of this response for caching purposes.
      etag :: (Core.Maybe Core.Text)
      -- | The access control list entry.
    , item :: (Core.Maybe PlusDomainsAclentryResource)
    ...
    , memberCount :: (Core.Maybe Core.Word32)
    ...
    , visibility :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newAudience 
    ::  Audience
newAudience
  = Audience{etag = Core.Nothing, item = Core.Nothing,
             kind = "plus#audience", memberCount = Core.Nothing,
             visibility = Core.Nothing}
instance Core.FromJSON Audience where
        parseJSON
          = Core.withObject "Audience"
              (\ o ->
                 Audience Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "item") Core.<*>
                     (o Core..:? "kind" Core..!= "plus#audience")
                     Core.<*> (o Core..:? "memberCount")
                     Core.<*> (o Core..:? "visibility"))

instance Core.ToJSON Audience where
        toJSON Audience{..}
          = Core.object
              (Core.catMaybes
                 [("etag" Core..=) Core.<$> etag, ("item" Core..=) Core.<$> item,
                  Core.Just ("kind" Core..= kind),
...
--
-- /See:/ 'newAudiencesFeed' smart constructor.
data AudiencesFeed = AudiencesFeed
    {
      -- | ETag of this response for caching purposes.
      etag :: (Core.Maybe Core.Text)
      -- | The audiences in this result.
    , items :: (Core.Maybe [Audience])
...
newAudiencesFeed 
    ::  AudiencesFeed
newAudiencesFeed
  = AudiencesFeed{etag = Core.Nothing, items = Core.Nothing,
                  kind = "plus#audiencesFeed", nextPageToken = Core.Nothing,
                  totalItems = Core.Nothing}
instance Core.FromJSON AudiencesFeed where
        parseJSON
          = Core.withObject "AudiencesFeed"
              (\ o ->
                 AudiencesFeed Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "items") Core.<*>
                     (o Core..:? "kind" Core..!= "plus#audiencesFeed")
                     Core.<*> (o Core..:? "nextPageToken")
                     Core.<*> (o Core..:? "totalItems"))

instance Core.ToJSON AudiencesFeed where
...
data Circle = Circle
    ...
    , people :: (Core.Maybe Circle_People)
...
newCircle 
    ::  Circle
newCircle
  = Circle{description = Core.Nothing, displayName = Core.Nothing,
           etag = Core.Nothing, id = Core.Nothing, kind = "plus#circle",
           people = Core.Nothing, selfLink = Core.Nothing}
instance Core.FromJSON Circle where
        parseJSON
          = Core.withObject "Circle"
              (\ o ->
                 Circle Core.<$>
                   (o Core..:? "description") Core.<*> (o Core..:? "displayName")
                     Core.<*> (o Core..:? "etag")
                     Core.<*> (o Core..:? "id")
                     Core.<*> (o Core..:? "kind" Core..!= "plus#circle")
                     Core.<*> (o Core..:? "people")
                     Core.<*> (o Core..:? "selfLink"))
...
-- | The people in this circle.
--
-- /See:/ 'newCircle_People' smart constructor.
newtype Circle_People = Circle_People
    {
...
-- | Creates a value of 'Circle_People' with the minimum fields required to make a request.
newCircle_People 
    ::  Circle_People
newCircle_People = Circle_People{totalItems = Core.Nothing}
instance Core.FromJSON Circle_People where
        parseJSON
          = Core.withObject "Circle_People"
              (\ o -> Circle_People Core.<$> (o Core..:? "totalItems"))

instance Core.ToJSON Circle_People where
        toJSON Circle_People{..}
          = Core.object
              (Core.catMaybes [("totalItems" Core..=) Core.<$> totalItems])


--
-- /See:/ 'newCircleFeed' smart constructor.
data CircleFeed = CircleFeed
    {
      -- | ETag of this response for caching purposes.
      etag :: (Core.Maybe Core.Text)
      -- | The circles in this page of results.
    , items :: (Core.Maybe [Circle])
...
newCircleFeed 
    ::  CircleFeed
newCircleFeed
  = CircleFeed{etag = Core.Nothing, items = Core.Nothing,
               kind = "plus#circleFeed", nextLink = Core.Nothing,
               nextPageToken = Core.Nothing, selfLink = Core.Nothing,
               title = Core.Nothing, totalItems = Core.Nothing}
instance Core.FromJSON CircleFeed where
        parseJSON
          = Core.withObject "CircleFeed"
              (\ o ->
                 CircleFeed Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "items") Core.<*>
                     (o Core..:? "kind" Core..!= "plus#circleFeed")
                     Core.<*> (o Core..:? "nextLink")
                     Core.<*> (o Core..:? "nextPageToken")
                     Core.<*> (o Core..:? "selfLink")
                     Core.<*> (o Core..:? "title")
...
instance Core.ToJSON CircleFeed where
        toJSON CircleFeed{..}
          = Core.object
              (Core.catMaybes
                 [("etag" Core..=) Core.<$> etag, ("items" Core..=) Core.<$> items,
...
newComment 
    ::  Comment
newComment
  = Comment{actor = Core.Nothing, etag = Core.Nothing,
            id = Core.Nothing, inReplyTo = Core.Nothing, kind = "plus#comment",
            object = Core.Nothing, plusoners = Core.Nothing,
            published = Core.Nothing, selfLink = Core.Nothing,
            updated = Core.Nothing, verb = "post"}
...
newComment_Actor 
    ::  Comment_Actor
newComment_Actor
  = Comment_Actor{clientSpecificActorInfo = Core.Nothing,
                  displayName = Core.Nothing, id = Core.Nothing,
                  image = Core.Nothing, url = Core.Nothing,
                  verification = Core.Nothing}
...
newComment_Actor_ClientSpecificActorInfo 
    :: 
                                         Comment_Actor_ClientSpecificActorInfo
newComment_Actor_ClientSpecificActorInfo
  = Comment_Actor_ClientSpecificActorInfo{youtubeActorInfo =
                                            Core.Nothing}
instance Core.FromJSON Comment_Actor_ClientSpecificActorInfo where
        parseJSON
          = Core.withObject "Comment_Actor_ClientSpecificActorInfo"
              (\ o ->
                 Comment_Actor_ClientSpecificActorInfo Core.<$>
                   (o Core..:? "youtubeActorInfo"))

instance Core.ToJSON Comment_Actor_ClientSpecificActorInfo where
...
newComment_Actor_ClientSpecificActorInfo_YoutubeActorInfo 
    :: 
                                                          Comment_Actor_ClientSpecificActorInfo_YoutubeActorInfo
newComment_Actor_ClientSpecificActorInfo_YoutubeActorInfo
  = Comment_Actor_ClientSpecificActorInfo_YoutubeActorInfo{channelId
                                                             = Core.Nothing}
instance Core.FromJSON
           Comment_Actor_ClientSpecificActorInfo_YoutubeActorInfo
         where
        parseJSON
          = Core.withObject
              "Comment_Actor_ClientSpecificActorInfo_YoutubeActorInfo"
              (\ o ->
                 Comment_Actor_ClientSpecificActorInfo_YoutubeActorInfo Core.<$>
                   (o Core..:? "channelId"))

instance Core.ToJSON
           Comment_Actor_ClientSpecificActorInfo_YoutubeActorInfo
         where
        toJSON Comment_Actor_ClientSpecificActorInfo_YoutubeActorInfo{..}
          = Core.object
              (Core.catMaybes [("channelId" Core..=) Core.<$> channelId])
...
instance Core.FromJSON Comment_Actor_Image where
        parseJSON
          = Core.withObject "Comment_Actor_Image"
              (\ o -> Comment_Actor_Image Core.<$> (o Core..:? "url"))
...
instance Core.FromJSON Comment_Actor_Verification where
        parseJSON
          = Core.withObject "Comment_Actor_Verification"
              (\ o ->
                 Comment_Actor_Verification Core.<$> (o Core..:? "adHocVerified"))
...
instance Core.ToJSON Comment_InReplyToItem where
        toJSON Comment_InReplyToItem{..}
          = Core.object
              (Core.catMaybes
                 [("id" Core..=) Core.<$> id, ("url" Core..=) Core.<$> url])
...
newComment_Object 
    ::  Comment_Object
newComment_Object
  = Comment_Object{content = Core.Nothing, objectType = "comment",
...
instance Core.FromJSON Comment_Plusoners where
        parseJSON
          = Core.withObject "Comment_Plusoners"
              (\ o -> Comment_Plusoners Core.<$> (o Core..:? "totalItems"))
...
newCommentFeed 
    ::  CommentFeed
newCommentFeed
  = CommentFeed{etag = Core.Nothing, id = Core.Nothing,
                items = Core.Nothing, kind = "plus#commentFeed",
                nextLink = Core.Nothing, nextPageToken = Core.Nothing,
                title = Core.Nothing, updated = Core.Nothing}
...
data Media = Media
    {
      ...
      author :: (Core.Maybe Media_Author)
      -- | The display name for this media.
    , displayName :: (Core.Maybe Core.Text)
      -- | ETag of this response for caching purposes.
    , etag :: (Core.Maybe Core.Text)
      -- | Exif information of the media item.
    , exif :: (Core.Maybe Media_Exif)
    ...
    , streams :: (Core.Maybe [Videostream])
    ...
    , videoDuration :: (Core.Maybe Core.Int64)
      -- | The encoding status of this video. Possible values are:
      -- - \"UPLOADING\" - Not all the video bytes have been received. - \"PENDING\" - Video not yet processed. - \"FAILED\" - Video processing failed. - \"READY\" - A single video stream is playable. - \"FINAL\" - All video streams are playable.
    , videoStatus :: (Core.Maybe Core.Text)
...
newMedia 
    ::  Media
newMedia
  = Media{author = Core.Nothing, displayName = Core.Nothing,
          etag = Core.Nothing, exif = Core.Nothing, height = Core.Nothing,
          id = Core.Nothing, kind = "plus#media",
          mediaCreatedTime = Core.Nothing, mediaUrl = Core.Nothing,
          published = Core.Nothing, sizeBytes = Core.Nothing,
          streams = Core.Nothing, summary = Core.Nothing,
          updated = Core.Nothing, url = Core.Nothing,
          videoDuration = Core.Nothing, videoStatus = Core.Nothing,
          width = Core.Nothing}
instance Core.FromJSON Media where
        parseJSON
          = Core.withObject "Media"
              (\ o ->
                 Media Core.<$>
                   (o Core..:? "author") Core.<*> (o Core..:? "displayName") Core.<*>
                     (o Core..:? "etag")
                     Core.<*> (o Core..:? "exif")
                     Core.<*> (o Core..:? "height")
                     Core.<*> (o Core..:? "id")
                     Core.<*> (o Core..:? "kind" Core..!= "plus#media")
                     ...
                     Core.<*> (o Core..:? "url")
                     Core.<*>
                     (o Core..:? "videoDuration" Core.<&> Core.fmap Core.fromAsText)
          ...
          = Core.object
              (Core.catMaybes
                 [("author" Core..=) Core.<$> author,
                  ("displayName" Core..=) Core.<$> displayName,
                  ("etag" Core..=) Core.<$> etag, ("exif" Core..=) Core.<$> exif,
                  ("height" Core..=) Core.<$> height, ("id" Core..=) Core.<$> id,
                  Core.Just ("kind" Core..= kind),
                  ("mediaCreatedTime" Core..=) Core.<$> mediaCreatedTime,
                  ("mediaUrl" Core..=) Core.<$> mediaUrl,
                  ("published" Core..=) Core.<$> published,
                  ("sizeBytes" Core..=) Core.. Core.AsText Core.<$> sizeBytes,
                  ("streams" Core..=) Core.<$> streams,
                  ("summary" Core..=) Core.<$> summary,
                  ("updated" Core..=) Core.<$> updated, ("url" Core..=) Core.<$> url,
                  ("videoDuration" Core..=) Core.. Core.AsText Core.<$>
                    videoDuration,
                  ("videoStatus" Core..=) Core.<$> videoStatus,
                  ("width" Core..=) Core.<$> width])


-- | The person who uploaded this media.
--
-- /See:/ 'newMedia_Author' smart constructor.
data Media_Author = Media_Author
    {
      -- | The author\'s name.
      displayName :: (Core.Maybe Core.Text)
      -- | ID of the author.
    ...
    , image :: (Core.Maybe Media_Author_Image)
      -- | A link to the author\'s Google profile.
    , url :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'Media_Author' with the minimum fields required to make a request.
newMedia_Author 
    ::  Media_Author
newMedia_Author
  = Media_Author{displayName = Core.Nothing, id = Core.Nothing,
                 image = Core.Nothing, url = Core.Nothing}
instance Core.FromJSON Media_Author where
        parseJSON
          = Core.withObject "Media_Author"
              (\ o ->
                 Media_Author Core.<$>
                   (o Core..:? "displayName") Core.<*> (o Core..:? "id") Core.<*>
                     (o Core..:? "image")
                     Core.<*> (o Core..:? "url"))

instance Core.ToJSON Media_Author where
        toJSON Media_Author{..}
          = Core.object
              (Core.catMaybes
                 [("displayName" Core..=) Core.<$> displayName,
...
-- | The author\'s Google profile image.
--
-- /See:/ 'newMedia_Author_Image' smart constructor.
newtype Media_Author_Image = Media_Author_Image
    {
...
-- | Creates a value of 'Media_Author_Image' with the minimum fields required to make a request.
newMedia_Author_Image 
    ::  Media_Author_Image
newMedia_Author_Image = Media_Author_Image{url = Core.Nothing}
instance Core.FromJSON Media_Author_Image where
        parseJSON
          = Core.withObject "Media_Author_Image"
              (\ o -> Media_Author_Image Core.<$> (o Core..:? "url"))

instance Core.ToJSON Media_Author_Image where
        toJSON Media_Author_Image{..}
          = Core.object (Core.catMaybes [("url" Core..=) Core.<$> url])
...
-- | Creates a value of 'Media_Exif' with the minimum fields required to make a request.
newMedia_Exif 
    ::  Media_Exif
newMedia_Exif = Media_Exif{time = Core.Nothing}
instance Core.FromJSON Media_Exif where
        parseJSON
          = Core.withObject "Media_Exif"
              (\ o -> Media_Exif Core.<$> (o Core..:? "time"))

instance Core.ToJSON Media_Exif where
        toJSON Media_Exif{..}
          = Core.object (Core.catMaybes [("time" Core..=) Core.<$> time])
...
newPeopleFeed 
    ::  PeopleFeed
newPeopleFeed
  = PeopleFeed{etag = Core.Nothing, items = Core.Nothing,
               kind = "plus#peopleFeed", nextPageToken = Core.Nothing,
               selfLink = Core.Nothing, title = Core.Nothing,
               totalItems = Core.Nothing}
...
newPerson 
    ::  Person
newPerson
  = Person{aboutMe = Core.Nothing, birthday = Core.Nothing,
           braggingRights = Core.Nothing, circledByCount = Core.Nothing,
           cover = Core.Nothing, currentLocation = Core.Nothing,
           displayName = Core.Nothing, domain = Core.Nothing,
           emails = Core.Nothing, etag = Core.Nothing, gender = Core.Nothing,
           id = Core.Nothing, image = Core.Nothing, isPlusUser = Core.Nothing,
           kind = "plus#person", name = Core.Nothing, nickname = Core.Nothing,
           objectType = Core.Nothing, occupation = Core.Nothing,
           organizations = Core.Nothing, placesLived = Core.Nothing,
           plusOneCount = Core.Nothing, relationshipStatus = Core.Nothing,
           skills = Core.Nothing, tagline = Core.Nothing, url = Core.Nothing,
           urls = Core.Nothing, verified = Core.Nothing}
instance Core.FromJSON Person where
        parseJSON
          = Core.withObject "Person"
              (\ o ->
                 Person Core.<$>
                   (o Core..:? "aboutMe") Core.<*> (o Core..:? "birthday") Core.<*>
                     (o Core..:? "braggingRights")
          ...
          = Core.object
              (Core.catMaybes
                 [("aboutMe" Core..=) Core.<$> aboutMe,
                  ...
                  ("gender" Core..=) Core.<$> gender, ("id" Core..=) Core.<$> id,
                  ...
                  ("relationshipStatus" Core..=) Core.<$> relationshipStatus,
                  ("skills" Core..=) Core.<$> skills,
                  ("tagline" Core..=) Core.<$> tagline, ("url" Core..=) Core.<$> url,
                  ("urls" Core..=) Core.<$> urls,
...
newPerson_Cover 
    ::  Person_Cover
newPerson_Cover
  = Person_Cover{coverInfo = Core.Nothing, coverPhoto = Core.Nothing,
                 layout = Core.Nothing}
instance Core.FromJSON Person_Cover where
        parseJSON
          = Core.withObject "Person_Cover"
              (\ o ->
                 Person_Cover Core.<$>
                   (o Core..:? "coverInfo") Core.<*> (o Core..:? "coverPhoto")
                     Core.<*> (o Core..:? "layout"))
...
newPerson_Cover_CoverInfo 
    ::  Person_Cover_CoverInfo
newPerson_Cover_CoverInfo
  = Person_Cover_CoverInfo{leftImageOffset = Core.Nothing,
                           topImageOffset = Core.Nothing}
...
instance Core.ToJSON Person_Cover_CoverInfo where
        toJSON Person_Cover_CoverInfo{..}
          = Core.object
              (Core.catMaybes
                 [("leftImageOffset" Core..=) Core.<$> leftImageOffset,
...
newPerson_Cover_CoverPhoto 
    ::  Person_Cover_CoverPhoto
newPerson_Cover_CoverPhoto
  = Person_Cover_CoverPhoto{height = Core.Nothing,
...
newPerson_Image 
    ::  Person_Image
newPerson_Image
  = Person_Image{isDefault = Core.Nothing, url = Core.Nothing}
...
newPerson_Name 
    ::  Person_Name
newPerson_Name
  = Person_Name{familyName = Core.Nothing, formatted = Core.Nothing,
                givenName = Core.Nothing, honorificPrefix = Core.Nothing,
                honorificSuffix = Core.Nothing, middleName = Core.Nothing}
instance Core.FromJSON Person_Name where
        parseJSON
          = Core.withObject "Person_Name"
              (\ o ->
                 Person_Name Core.<$>
                   (o Core..:? "familyName") Core.<*> (o Core..:? "formatted")
...
newPerson_OrganizationsItem 
    ::  Person_OrganizationsItem
newPerson_OrganizationsItem
  = Person_OrganizationsItem{department = Core.Nothing,
                             description = Core.Nothing, endDate = Core.Nothing,
                             location = Core.Nothing, name = Core.Nothing,
                             primary = Core.Nothing, startDate = Core.Nothing,
          ...
          = Core.withObject "Person_OrganizationsItem"
              (\ o ->
                 Person_OrganizationsItem Core.<$>
                   (o Core..:? "department") Core.<*> (o Core..:? "description")
                     Core.<*> (o Core..:? "endDate")
                     Core.<*> (o Core..:? "location")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "primary")
...
newPerson_PlacesLivedItem 
    ::  Person_PlacesLivedItem
newPerson_PlacesLivedItem
  = Person_PlacesLivedItem{primary = Core.Nothing,
                           value = Core.Nothing}
...
newPerson_UrlsItem 
    ::  Person_UrlsItem
newPerson_UrlsItem
  = Person_UrlsItem{label = Core.Nothing, type' = Core.Nothing,
                    value = Core.Nothing}
          ...
          = Core.withObject "Person_UrlsItem"
              (\ o ->
                 Person_UrlsItem Core.<$>
                   (o Core..:? "label") Core.<*> (o Core..:? "type") Core.<*>
                     (o Core..:? "value"))
...
instance Core.ToJSON Person_UrlsItem where
        toJSON Person_UrlsItem{..}
          = Core.object
              (Core.catMaybes
                 [("label" Core..=) Core.<$> label, ("type" Core..=) Core.<$> type',
                  ("value" Core..=) Core.<$> value])
...
newPlace 
    ::  Place
newPlace
  = Place{address = Core.Nothing, displayName = Core.Nothing,
          id = Core.Nothing, kind = "plus#place", position = Core.Nothing}
instance Core.FromJSON Place where
        parseJSON
          = Core.withObject "Place"
              (\ o ->
                 Place Core.<$>
                   (o Core..:? "address") Core.<*> (o Core..:? "displayName") Core.<*>
                     (o Core..:? "id")
...
instance Core.FromJSON Place_Address where
        parseJSON
          = Core.withObject "Place_Address"
              (\ o -> Place_Address Core.<$> (o Core..:? "formatted"))

instance Core.ToJSON Place_Address where
        toJSON Place_Address{..}
          = Core.object
              (Core.catMaybes [("formatted" Core..=) Core.<$> formatted])
...
--
-- /See:/ 'newPlusDomainsAclentryResource' smart constructor.
...
newPlusDomainsAclentryResource 
    ::  PlusDomainsAclentryResource
newPlusDomainsAclentryResource
  = PlusDomainsAclentryResource{displayName = Core.Nothing,
                                id = Core.Nothing, type' = Core.Nothing}
instance Core.FromJSON PlusDomainsAclentryResource where
        parseJSON
          = Core.withObject "PlusDomainsAclentryResource"
              (\ o ->
                 PlusDomainsAclentryResource Core.<$>
                   (o Core..:? "displayName") Core.<*> (o Core..:? "id") Core.<*>
                     (o Core..:? "type"))

instance Core.ToJSON PlusDomainsAclentryResource where
...
--
-- /See:/ 'newVideostream' smart constructor.
...
newVideostream 
    ::  Videostream
newVideostream
  = Videostream{height = Core.Nothing, type' = Core.Nothing,
                url = Core.Nothing, width = Core.Nothing}
instance Core.FromJSON Videostream where
        parseJSON
          = Core.withObject "Videostream"
              (\ o ->
                 Videostream Core.<$>
                   (o Core..:? "height") Core.<*> (o Core..:? "type") Core.<*>
                     (o Core..:? "url")
...
instance Core.ToJSON Videostream where
        toJSON Videostream{..}
          = Core.object
              (Core.catMaybes
                 [("height" Core..=) Core.<$> height,
