...
newDataprocProjectsRegionsWorkflowTemplatesInstantiateInline 
    ...
    -> DataprocProjectsRegionsWorkflowTemplatesInstantiateInline
newDataprocProjectsRegionsWorkflowTemplatesInstantiateInline parent
  payload
  = DataprocProjectsRegionsWorkflowTemplatesInstantiateInline{xgafv =
                                                                Core.Nothing,
...
instance Core.GoogleRequest
           DataprocProjectsRegionsWorkflowTemplatesInstantiateInline
         where
        type Rs DataprocProjectsRegionsWorkflowTemplatesInstantiateInline =
             Operation
        type Scopes
               DataprocProjectsRegionsWorkflowTemplatesInstantiateInline
