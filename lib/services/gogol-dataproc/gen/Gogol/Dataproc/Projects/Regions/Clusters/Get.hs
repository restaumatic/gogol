...
newDataprocProjectsRegionsClustersGet clusterName projectId region
  = DataprocProjectsRegionsClustersGet{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       clusterName = clusterName, projectId = projectId,
                                       region = region, uploadType = Core.Nothing,
                                       uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DataprocProjectsRegionsClustersGet
         where
        ...
        requestClient DataprocProjectsRegionsClustersGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DataprocProjectsRegionsClustersGetResource)
                      Core.mempty
