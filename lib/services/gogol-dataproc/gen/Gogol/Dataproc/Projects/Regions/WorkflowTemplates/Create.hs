                   ...
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] WorkflowTemplate Core.:>
                         Core.Post '[Core.JSON] WorkflowTemplate
...
newDataprocProjectsRegionsWorkflowTemplatesCreate parent payload
  = DataprocProjectsRegionsWorkflowTemplatesCreate{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           DataprocProjectsRegionsWorkflowTemplatesCreate
         where
        type Rs DataprocProjectsRegionsWorkflowTemplatesCreate =
             WorkflowTemplate
        type Scopes DataprocProjectsRegionsWorkflowTemplatesCreate =
             '[CloudPlatform'FullControl]
        requestClient DataprocProjectsRegionsWorkflowTemplatesCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DataprocProjectsRegionsWorkflowTemplatesCreateResource)
                      Core.mempty
