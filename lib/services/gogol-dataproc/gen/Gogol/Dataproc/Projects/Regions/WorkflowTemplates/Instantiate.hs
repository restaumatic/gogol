...
newDataprocProjectsRegionsWorkflowTemplatesInstantiate name payload
  = DataprocProjectsRegionsWorkflowTemplatesInstantiate{xgafv =
                                                          Core.Nothing,
...
instance Core.GoogleRequest
           DataprocProjectsRegionsWorkflowTemplatesInstantiate
         where
        type Rs DataprocProjectsRegionsWorkflowTemplatesInstantiate =
             Operation
        type Scopes DataprocProjectsRegionsWorkflowTemplatesInstantiate =
