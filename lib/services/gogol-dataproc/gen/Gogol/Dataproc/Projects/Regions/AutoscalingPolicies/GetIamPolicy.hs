...
newDataprocProjectsRegionsAutoscalingPoliciesGetIamPolicy 
    ...
    -> DataprocProjectsRegionsAutoscalingPoliciesGetIamPolicy
newDataprocProjectsRegionsAutoscalingPoliciesGetIamPolicy payload
  resource
  = DataprocProjectsRegionsAutoscalingPoliciesGetIamPolicy{xgafv =
                                                             Core.Nothing,
...
instance Core.GoogleRequest
           DataprocProjectsRegionsAutoscalingPoliciesGetIamPolicy
         where
        type Rs DataprocProjectsRegionsAutoscalingPoliciesGetIamPolicy =
             Policy
        type Scopes DataprocProjectsRegionsAutoscalingPoliciesGetIamPolicy
