...
newDataprocProjectsRegionsJobsSetIamPolicy payload resource
  = DataprocProjectsRegionsJobsSetIamPolicy{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            payload = payload, resource = resource,
                                            uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DataprocProjectsRegionsJobsSetIamPolicy
         where
        type Rs DataprocProjectsRegionsJobsSetIamPolicy = Policy
        type Scopes DataprocProjectsRegionsJobsSetIamPolicy =
