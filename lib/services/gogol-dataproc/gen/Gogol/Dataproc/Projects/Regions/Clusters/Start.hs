         ...
         Core.Capture "projectId" Core.Text Core.:>
           "regions" Core.:>
             Core.Capture "region" Core.Text Core.:>
               "clusters" Core.:>
                 Core.CaptureMode "clusterName" "start" Core.Text Core.:>
                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.ReqBody '[Core.JSON] StartClusterRequest Core.:>
...
newDataprocProjectsRegionsClustersStart 
    ...
    -> DataprocProjectsRegionsClustersStart
newDataprocProjectsRegionsClustersStart clusterName payload
  projectId region
  = DataprocProjectsRegionsClustersStart{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DataprocProjectsRegionsClustersStart
         where
        type Rs DataprocProjectsRegionsClustersStart = Operation
        type Scopes DataprocProjectsRegionsClustersStart =
