...
-- |
-- Module      : Gogol.Dataproc.Projects.Regions.Operations.Cancel
...
newDataprocProjectsRegionsOperationsCancel name
  = DataprocProjectsRegionsOperationsCancel{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            name = name, uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DataprocProjectsRegionsOperationsCancel
         where
        type Rs DataprocProjectsRegionsOperationsCancel = Empty
        type Scopes DataprocProjectsRegionsOperationsCancel =
             '[CloudPlatform'FullControl]
        requestClient DataprocProjectsRegionsOperationsCancel{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DataprocProjectsRegionsOperationsCancelResource)
                      Core.mempty
