...
newDataprocProjectsRegionsJobsDelete jobId projectId region
  = DataprocProjectsRegionsJobsDelete{xgafv = Core.Nothing,
                                      accessToken = Core.Nothing, callback = Core.Nothing,
                                      jobId = jobId, projectId = projectId, region = region,
                                      uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DataprocProjectsRegionsJobsDelete where
        type Rs DataprocProjectsRegionsJobsDelete = Empty
        type Scopes DataprocProjectsRegionsJobsDelete =
