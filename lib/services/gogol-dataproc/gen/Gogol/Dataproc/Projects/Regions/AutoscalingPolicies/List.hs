...
newDataprocProjectsRegionsAutoscalingPoliciesList parent
  = DataprocProjectsRegionsAutoscalingPoliciesList{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           DataprocProjectsRegionsAutoscalingPoliciesList
         where
        type Rs DataprocProjectsRegionsAutoscalingPoliciesList =
             ListAutoscalingPoliciesResponse
        type Scopes DataprocProjectsRegionsAutoscalingPoliciesList =
             '[CloudPlatform'FullControl]
        requestClient DataprocProjectsRegionsAutoscalingPoliciesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DataprocProjectsRegionsAutoscalingPoliciesListResource)
                      Core.mempty
