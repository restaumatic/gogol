                   ...
                   Core.QueryParam "$.xgafv" Xgafv Core.:>
                     Core.QueryParam "access_token" Core.Text Core.:>
                       Core.QueryParam "callback" Core.Text Core.:>
                         Core.QueryParam "gracefulDecommissionTimeout" Core.Duration Core.:>
                           Core.QueryParam "requestId" Core.Text Core.:>
                             Core.QueryParam "updateMask" Core.FieldMask Core.:>
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.ReqBody '[Core.JSON] Cluster Core.:>
...
newDataprocProjectsRegionsClustersPatch 
    ...
    -> DataprocProjectsRegionsClustersPatch
newDataprocProjectsRegionsClustersPatch clusterName payload
  projectId region
  = DataprocProjectsRegionsClustersPatch{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         clusterName = clusterName,
                                         gracefulDecommissionTimeout = Core.Nothing,
                                         payload = payload, projectId = projectId, region = region,
                                         requestId = Core.Nothing, updateMask = Core.Nothing,
                                         uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DataprocProjectsRegionsClustersPatch
         where
        type Rs DataprocProjectsRegionsClustersPatch = Operation
        type Scopes DataprocProjectsRegionsClustersPatch =
             '[CloudPlatform'FullControl]
        requestClient DataprocProjectsRegionsClustersPatch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DataprocProjectsRegionsClustersPatchResource)
                      Core.mempty
