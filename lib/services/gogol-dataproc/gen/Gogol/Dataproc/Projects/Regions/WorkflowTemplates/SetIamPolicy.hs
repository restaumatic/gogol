...
newDataprocProjectsRegionsWorkflowTemplatesSetIamPolicy 
    ...
    -> DataprocProjectsRegionsWorkflowTemplatesSetIamPolicy
newDataprocProjectsRegionsWorkflowTemplatesSetIamPolicy payload
  resource
  = DataprocProjectsRegionsWorkflowTemplatesSetIamPolicy{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           DataprocProjectsRegionsWorkflowTemplatesSetIamPolicy
         where
        type Rs DataprocProjectsRegionsWorkflowTemplatesSetIamPolicy =
             Policy
        type Scopes DataprocProjectsRegionsWorkflowTemplatesSetIamPolicy =
