                 ...
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] WorkflowTemplate Core.:>
                       Core.Put '[Core.JSON] WorkflowTemplate
...
newDataprocProjectsRegionsWorkflowTemplatesUpdate name payload
  = DataprocProjectsRegionsWorkflowTemplatesUpdate{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           DataprocProjectsRegionsWorkflowTemplatesUpdate
         where
        type Rs DataprocProjectsRegionsWorkflowTemplatesUpdate =
             WorkflowTemplate
        type Scopes DataprocProjectsRegionsWorkflowTemplatesUpdate =
             '[CloudPlatform'FullControl]
        requestClient DataprocProjectsRegionsWorkflowTemplatesUpdate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DataprocProjectsRegionsWorkflowTemplatesUpdateResource)
                      Core.mempty
