         ...
         Core.Capture "projectId" Core.Text Core.:>
           "regions" Core.:>
             Core.Capture "region" Core.Text Core.:>
               "clusters" Core.:>
                 Core.CaptureMode "clusterName" "repair" Core.Text Core.:>
                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.ReqBody '[Core.JSON] RepairClusterRequest Core.:>
...
newDataprocProjectsRegionsClustersRepair 
    ...
    -> DataprocProjectsRegionsClustersRepair
newDataprocProjectsRegionsClustersRepair clusterName payload
  projectId region
  = DataprocProjectsRegionsClustersRepair{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DataprocProjectsRegionsClustersRepair
         where
        type Rs DataprocProjectsRegionsClustersRepair = Operation
        type Scopes DataprocProjectsRegionsClustersRepair =
             '[CloudPlatform'FullControl]
        requestClient DataprocProjectsRegionsClustersRepair{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DataprocProjectsRegionsClustersRepairResource)
                      Core.mempty
