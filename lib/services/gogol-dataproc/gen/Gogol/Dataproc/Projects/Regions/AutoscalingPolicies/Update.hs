...
newDataprocProjectsRegionsAutoscalingPoliciesUpdate name payload
  = DataprocProjectsRegionsAutoscalingPoliciesUpdate{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           DataprocProjectsRegionsAutoscalingPoliciesUpdate
         where
        type Rs DataprocProjectsRegionsAutoscalingPoliciesUpdate =
             AutoscalingPolicy
        type Scopes DataprocProjectsRegionsAutoscalingPoliciesUpdate =
             '[CloudPlatform'FullControl]
        requestClient DataprocProjectsRegionsAutoscalingPoliciesUpdate{..}
