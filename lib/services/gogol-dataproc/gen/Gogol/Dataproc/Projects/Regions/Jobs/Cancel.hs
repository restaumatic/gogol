         ...
         Core.Capture "projectId" Core.Text Core.:>
           "regions" Core.:>
             Core.Capture "region" Core.Text Core.:>
               "jobs" Core.:>
                 Core.CaptureMode "jobId" "cancel" Core.Text Core.:>
                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.ReqBody '[Core.JSON] CancelJobRequest Core.:>
...
newDataprocProjectsRegionsJobsCancel jobId payload projectId region
  = DataprocProjectsRegionsJobsCancel{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DataprocProjectsRegionsJobsCancel where
        ...
        type Scopes DataprocProjectsRegionsJobsCancel =
             '[CloudPlatform'FullControl]
        requestClient DataprocProjectsRegionsJobsCancel{..}
          = go projectId region jobId xgafv accessToken callback uploadType
              uploadProtocol
