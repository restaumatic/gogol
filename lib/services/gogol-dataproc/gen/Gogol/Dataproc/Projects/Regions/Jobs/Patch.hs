                           ...
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.ReqBody '[Core.JSON] Job Core.:> Core.Patch '[Core.JSON] Job
...
newDataprocProjectsRegionsJobsPatch jobId payload projectId region
  = DataprocProjectsRegionsJobsPatch{xgafv = Core.Nothing,
                                     accessToken = Core.Nothing, callback = Core.Nothing,
                                     jobId = jobId, payload = payload, projectId = projectId,
                                     region = region, updateMask = Core.Nothing,
                                     uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DataprocProjectsRegionsJobsPatch where
        ...
        requestClient DataprocProjectsRegionsJobsPatch{..}
          = go projectId region jobId xgafv accessToken callback updateMask
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy DataprocProjectsRegionsJobsPatchResource)
                      Core.mempty
