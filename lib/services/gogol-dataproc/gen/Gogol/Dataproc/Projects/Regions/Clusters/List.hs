...
newDataprocProjectsRegionsClustersList projectId region
  = DataprocProjectsRegionsClustersList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DataprocProjectsRegionsClustersList
         where
        type Rs DataprocProjectsRegionsClustersList = ListClustersResponse
        ...
        requestClient DataprocProjectsRegionsClustersList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DataprocProjectsRegionsClustersListResource)
                      Core.mempty
