                 ...
                 Core.QueryParam "$.xgafv" Xgafv Core.:>
                   Core.QueryParam "access_token" Core.Text Core.:>
                     Core.QueryParam "callback" Core.Text Core.:>
                       Core.QueryParam "clusterName" Core.Text Core.:>
                         Core.QueryParam "filter" Core.Text Core.:>
                           Core.QueryParam "jobStateMatcher"
...
newDataprocProjectsRegionsJobsList projectId region
  = DataprocProjectsRegionsJobsList{xgafv = Core.Nothing,
                                    accessToken = Core.Nothing, callback = Core.Nothing,
                                    clusterName = Core.Nothing, filter = Core.Nothing,
                                    jobStateMatcher = Core.Nothing, pageSize = Core.Nothing,
...
instance Core.GoogleRequest DataprocProjectsRegionsJobsList where
        ...
        type Scopes DataprocProjectsRegionsJobsList =
             '[CloudPlatform'FullControl]
        requestClient DataprocProjectsRegionsJobsList{..}
          = go projectId region xgafv accessToken callback clusterName filter
              jobStateMatcher
              pageSize
              pageToken
              uploadType
