...
newDataprocProjectsRegionsClustersTestIamPermissions 
    ...
    -> DataprocProjectsRegionsClustersTestIamPermissions
newDataprocProjectsRegionsClustersTestIamPermissions payload
  resource
  = DataprocProjectsRegionsClustersTestIamPermissions{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           DataprocProjectsRegionsClustersTestIamPermissions
         where
        type Rs DataprocProjectsRegionsClustersTestIamPermissions =
             TestIamPermissionsResponse
        type Scopes DataprocProjectsRegionsClustersTestIamPermissions =
