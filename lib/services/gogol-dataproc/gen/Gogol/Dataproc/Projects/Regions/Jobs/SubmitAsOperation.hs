...
newDataprocProjectsRegionsJobsSubmitAsOperation 
    ...
    -> DataprocProjectsRegionsJobsSubmitAsOperation
newDataprocProjectsRegionsJobsSubmitAsOperation payload projectId
  region
  = DataprocProjectsRegionsJobsSubmitAsOperation{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
           DataprocProjectsRegionsJobsSubmitAsOperation
         where
        type Rs DataprocProjectsRegionsJobsSubmitAsOperation = Operation
        type Scopes DataprocProjectsRegionsJobsSubmitAsOperation =
             '[CloudPlatform'FullControl]
        requestClient DataprocProjectsRegionsJobsSubmitAsOperation{..}
          = go projectId region xgafv accessToken callback uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DataprocProjectsRegionsJobsSubmitAsOperationResource)
                      Core.mempty
