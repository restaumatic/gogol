...
newDataprocProjectsRegionsJobsTestIamPermissions payload resource
  = DataprocProjectsRegionsJobsTestIamPermissions{xgafv =
                                                    Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes DataprocProjectsRegionsJobsTestIamPermissions =
             '[CloudPlatform'FullControl]
        requestClient DataprocProjectsRegionsJobsTestIamPermissions{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DataprocProjectsRegionsJobsTestIamPermissionsResource)
                      Core.mempty
