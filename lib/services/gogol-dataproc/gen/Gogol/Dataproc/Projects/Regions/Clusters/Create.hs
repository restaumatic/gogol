               ...
               "clusters" Core.:>
                 Core.QueryParam "$.xgafv" Xgafv Core.:>
                   Core.QueryParam "access_token" Core.Text Core.:>
                     Core.QueryParam "actionOnFailedPrimaryWorkers"
...
data DataprocProjectsRegionsClustersCreate = DataprocProjectsRegionsClustersCreate
    ...
    , actionOnFailedPrimaryWorkers :: (Core.Maybe
   ProjectsRegionsClustersCreateActionOnFailedPrimaryWorkers)
      -- | JSONP
...
newDataprocProjectsRegionsClustersCreate payload projectId region
  = DataprocProjectsRegionsClustersCreate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DataprocProjectsRegionsClustersCreate
         where
        type Rs DataprocProjectsRegionsClustersCreate = Operation
        type Scopes DataprocProjectsRegionsClustersCreate =
             '[CloudPlatform'FullControl]
        requestClient DataprocProjectsRegionsClustersCreate{..}
          = go projectId region xgafv accessToken
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DataprocProjectsRegionsClustersCreateResource)
                      Core.mempty
