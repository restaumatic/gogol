...
newDataprocProjectsRegionsClustersNodeGroupsGet name
  = DataprocProjectsRegionsClustersNodeGroupsGet{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
           DataprocProjectsRegionsClustersNodeGroupsGet
         where
        type Rs DataprocProjectsRegionsClustersNodeGroupsGet = NodeGroup
        type Scopes DataprocProjectsRegionsClustersNodeGroupsGet =
             '[CloudPlatform'FullControl]
        requestClient DataprocProjectsRegionsClustersNodeGroupsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DataprocProjectsRegionsClustersNodeGroupsGetResource)
                      Core.mempty
