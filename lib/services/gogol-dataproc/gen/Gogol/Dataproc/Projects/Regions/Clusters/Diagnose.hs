         ...
         Core.Capture "projectId" Core.Text Core.:>
           "regions" Core.:>
             Core.Capture "region" Core.Text Core.:>
               "clusters" Core.:>
                 Core.CaptureMode "clusterName" "diagnose" Core.Text Core.:>
                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.ReqBody '[Core.JSON] DiagnoseClusterRequest Core.:>
...
newDataprocProjectsRegionsClustersDiagnose 
    ...
    -> DataprocProjectsRegionsClustersDiagnose
newDataprocProjectsRegionsClustersDiagnose clusterName payload
  projectId region
  = DataprocProjectsRegionsClustersDiagnose{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            clusterName = clusterName, payload = payload,
                                            projectId = projectId, region = region,
                                            uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DataprocProjectsRegionsClustersDiagnose
         where
        type Rs DataprocProjectsRegionsClustersDiagnose = Operation
        type Scopes DataprocProjectsRegionsClustersDiagnose =
             '[CloudPlatform'FullControl]
        requestClient DataprocProjectsRegionsClustersDiagnose{..}
          = go projectId region clusterName xgafv accessToken callback
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DataprocProjectsRegionsClustersDiagnoseResource)
                      Core.mempty
