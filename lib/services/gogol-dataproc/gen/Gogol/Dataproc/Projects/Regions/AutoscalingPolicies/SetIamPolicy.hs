...
newDataprocProjectsRegionsAutoscalingPoliciesSetIamPolicy 
    ...
    -> DataprocProjectsRegionsAutoscalingPoliciesSetIamPolicy
newDataprocProjectsRegionsAutoscalingPoliciesSetIamPolicy payload
  resource
  = DataprocProjectsRegionsAutoscalingPoliciesSetIamPolicy{xgafv =
                                                             Core.Nothing,
...
instance Core.GoogleRequest
           DataprocProjectsRegionsAutoscalingPoliciesSetIamPolicy
         where
        type Rs DataprocProjectsRegionsAutoscalingPoliciesSetIamPolicy =
             Policy
        type Scopes DataprocProjectsRegionsAutoscalingPoliciesSetIamPolicy
