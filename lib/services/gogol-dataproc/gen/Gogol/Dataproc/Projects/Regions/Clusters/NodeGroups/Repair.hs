...
type DataprocProjectsRegionsClustersNodeGroupsRepairResource =
     "v1" Core.:>
       Core.CaptureMode "name" "repair" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] RepairNodeGroupRequest Core.:>
...
newDataprocProjectsRegionsClustersNodeGroupsRepair name payload
  = DataprocProjectsRegionsClustersNodeGroupsRepair{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes DataprocProjectsRegionsClustersNodeGroupsRepair =
