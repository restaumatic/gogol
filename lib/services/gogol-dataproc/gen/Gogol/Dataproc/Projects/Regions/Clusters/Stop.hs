         ...
         Core.Capture "projectId" Core.Text Core.:>
           "regions" Core.:>
             Core.Capture "region" Core.Text Core.:>
               "clusters" Core.:>
                 Core.CaptureMode "clusterName" "stop" Core.Text Core.:>
                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.ReqBody '[Core.JSON] StopClusterRequest Core.:>
...
newDataprocProjectsRegionsClustersStop 
    ...
    -> DataprocProjectsRegionsClustersStop
newDataprocProjectsRegionsClustersStop clusterName payload
  projectId region
  = DataprocProjectsRegionsClustersStop{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DataprocProjectsRegionsClustersStop
         where
        type Rs DataprocProjectsRegionsClustersStop = Operation
        type Scopes DataprocProjectsRegionsClustersStop =
        ...
        requestClient DataprocProjectsRegionsClustersStop{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DataprocProjectsRegionsClustersStopResource)
                      Core.mempty
