...
newDataprocProjectsRegionsWorkflowTemplatesGetIamPolicy 
    ...
    -> DataprocProjectsRegionsWorkflowTemplatesGetIamPolicy
newDataprocProjectsRegionsWorkflowTemplatesGetIamPolicy payload
  resource
  = DataprocProjectsRegionsWorkflowTemplatesGetIamPolicy{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           DataprocProjectsRegionsWorkflowTemplatesGetIamPolicy
         where
        type Rs DataprocProjectsRegionsWorkflowTemplatesGetIamPolicy =
             Policy
        type Scopes DataprocProjectsRegionsWorkflowTemplatesGetIamPolicy =
