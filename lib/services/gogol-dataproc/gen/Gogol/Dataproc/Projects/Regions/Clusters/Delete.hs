                     ...
                     Core.QueryParam "access_token" Core.Text Core.:>
                       Core.QueryParam "callback" Core.Text Core.:>
                         Core.QueryParam "clusterUuid" Core.Text Core.:>
                           Core.QueryParam "gracefulTerminationTimeout" Core.Duration Core.:>
...
newDataprocProjectsRegionsClustersDelete 
    ...
    -> DataprocProjectsRegionsClustersDelete
newDataprocProjectsRegionsClustersDelete clusterName projectId
  region
  = DataprocProjectsRegionsClustersDelete{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          clusterName = clusterName, clusterUuid = Core.Nothing,
...
instance Core.GoogleRequest DataprocProjectsRegionsClustersDelete
         where
