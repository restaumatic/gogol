...
newDataprocProjectsRegionsJobsGet jobId projectId region
  = DataprocProjectsRegionsJobsGet{xgafv = Core.Nothing,
                                   accessToken = Core.Nothing, callback = Core.Nothing,
                                   jobId = jobId, projectId = projectId, region = region,
                                   uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DataprocProjectsRegionsJobsGet where
        type Rs DataprocProjectsRegionsJobsGet = Job
        type Scopes DataprocProjectsRegionsJobsGet =
        ...
        requestClient DataprocProjectsRegionsJobsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy DataprocProjectsRegionsJobsGetResource)
                      Core.mempty
