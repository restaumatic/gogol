...
-- |
-- Module      : Gogol.Dataproc.Projects.Regions.WorkflowTemplates.Get
                 ...
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "version" Core.Int32 Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.Get '[Core.JSON] WorkflowTemplate
...
newDataprocProjectsRegionsWorkflowTemplatesGet name
  = DataprocProjectsRegionsWorkflowTemplatesGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           DataprocProjectsRegionsWorkflowTemplatesGet
         where
        type Rs DataprocProjectsRegionsWorkflowTemplatesGet =
             WorkflowTemplate
        type Scopes DataprocProjectsRegionsWorkflowTemplatesGet =
             '[CloudPlatform'FullControl]
        requestClient DataprocProjectsRegionsWorkflowTemplatesGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DataprocProjectsRegionsWorkflowTemplatesGetResource)
                      Core.mempty
