...
newDataprocProjectsRegionsAutoscalingPoliciesCreate parent payload
  = DataprocProjectsRegionsAutoscalingPoliciesCreate{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           DataprocProjectsRegionsAutoscalingPoliciesCreate
         where
        type Rs DataprocProjectsRegionsAutoscalingPoliciesCreate =
             AutoscalingPolicy
        type Scopes DataprocProjectsRegionsAutoscalingPoliciesCreate =
             '[CloudPlatform'FullControl]
        requestClient DataprocProjectsRegionsAutoscalingPoliciesCreate{..}
