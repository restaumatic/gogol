...
newDataprocProjectsRegionsOperationsList name
  = DataprocProjectsRegionsOperationsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DataprocProjectsRegionsOperationsList
         where
        type Rs DataprocProjectsRegionsOperationsList =
             ListOperationsResponse
        type Scopes DataprocProjectsRegionsOperationsList =
             '[CloudPlatform'FullControl]
        requestClient DataprocProjectsRegionsOperationsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DataprocProjectsRegionsOperationsListResource)
                      Core.mempty
