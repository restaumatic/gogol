     ...
     "v1" Core.:>
       Core.Capture "project" Core.Text Core.:>
         Core.Capture "region" Core.Text Core.:>
           Core.CaptureMode "cluster" "injectCredentials" Core.Text Core.:>
                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] InjectCredentialsRequest Core.:>
...
newDataprocProjectsRegionsClustersInjectCredentials 
    ...
    -> DataprocProjectsRegionsClustersInjectCredentials
newDataprocProjectsRegionsClustersInjectCredentials cluster payload
  project region
  = DataprocProjectsRegionsClustersInjectCredentials{xgafv =
                                                       Core.Nothing,
                                                     accessToken = Core.Nothing,
                                                     callback = Core.Nothing, cluster = cluster,
                                                     payload = payload, project = project,
                                                     region = region, uploadType = Core.Nothing,
                                                     uploadProtocol = Core.Nothing}
instance Core.GoogleRequest
           DataprocProjectsRegionsClustersInjectCredentials
         where
        type Rs DataprocProjectsRegionsClustersInjectCredentials =
             Operation
        type Scopes DataprocProjectsRegionsClustersInjectCredentials =
             '[CloudPlatform'FullControl]
        requestClient DataprocProjectsRegionsClustersInjectCredentials{..}
          = go project region cluster xgafv accessToken callback uploadType
              uploadProtocol
