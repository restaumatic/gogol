               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] ResizeNodeGroupRequest Core.:>
...
newDataprocProjectsRegionsClustersNodeGroupsResize name payload
  = DataprocProjectsRegionsClustersNodeGroupsResize{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           DataprocProjectsRegionsClustersNodeGroupsResize
         where
        type Rs DataprocProjectsRegionsClustersNodeGroupsResize = Operation
        type Scopes DataprocProjectsRegionsClustersNodeGroupsResize =
             '[CloudPlatform'FullControl]
        requestClient DataprocProjectsRegionsClustersNodeGroupsResize{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DataprocProjectsRegionsClustersNodeGroupsResizeResource)
                      Core.mempty
