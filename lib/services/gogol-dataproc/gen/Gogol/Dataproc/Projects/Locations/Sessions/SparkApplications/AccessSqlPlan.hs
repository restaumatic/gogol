...
type DataprocProjectsLocationsSessionsSparkApplicationsAccessSqlPlanResource
     =
     "v1" Core.:>
       Core.CaptureMode "name" "accessSqlPlan" Core.Text Core.:>
...
newDataprocProjectsLocationsSessionsSparkApplicationsAccessSqlPlan
  name
  = DataprocProjectsLocationsSessionsSparkApplicationsAccessSqlPlan{xgafv
                                                                      = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        requestClient
          DataprocProjectsLocationsSessionsSparkApplicationsAccessSqlPlan{..}
          = go name xgafv accessToken callback executionId parent uploadType
              uploadProtocol
