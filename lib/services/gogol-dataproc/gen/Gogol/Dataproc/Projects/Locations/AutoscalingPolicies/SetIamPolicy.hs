...
newDataprocProjectsLocationsAutoscalingPoliciesSetIamPolicy 
    ...
    -> DataprocProjectsLocationsAutoscalingPoliciesSetIamPolicy
newDataprocProjectsLocationsAutoscalingPoliciesSetIamPolicy payload
  resource
  = DataprocProjectsLocationsAutoscalingPoliciesSetIamPolicy{xgafv =
                                                               Core.Nothing,
...
instance Core.GoogleRequest
           DataprocProjectsLocationsAutoscalingPoliciesSetIamPolicy
         where
        type Rs DataprocProjectsLocationsAutoscalingPoliciesSetIamPolicy =
             Policy
        type Scopes
               DataprocProjectsLocationsAutoscalingPoliciesSetIamPolicy
