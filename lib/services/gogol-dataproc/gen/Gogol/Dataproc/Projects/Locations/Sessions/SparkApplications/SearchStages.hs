...
type DataprocProjectsLocationsSessionsSparkApplicationsSearchStagesResource
     =
     "v1" Core.:>
       Core.CaptureMode "name" "searchStages" Core.Text Core.:>
               ...
               Core.QueryParam "pageSize" Core.Int32 Core.:>
                 Core.QueryParam "pageToken" Core.Text Core.:>
                   Core.QueryParam "parent" Core.Text Core.:>
                     Core.QueryParams "stageIds" Core.Int64 Core.:>
                       Core.QueryParam "stageStatus"
                         ProjectsLocationsSessionsSparkApplicationsSearchStagesStageStatus
                         Core.:>
                         Core.QueryParam "summaryMetricsMask" Core.FieldMask Core.:>
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.Get '[Core.JSON] SearchSessionSparkApplicationStagesResponse
...
newDataprocProjectsLocationsSessionsSparkApplicationsSearchStages
  name
  = DataprocProjectsLocationsSessionsSparkApplicationsSearchStages{xgafv
                                                                     = Core.Nothing,
