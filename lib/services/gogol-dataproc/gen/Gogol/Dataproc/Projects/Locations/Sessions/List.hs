...
newDataprocProjectsLocationsSessionsList parent
  = DataprocProjectsLocationsSessionsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DataprocProjectsLocationsSessionsList
         where
        type Rs DataprocProjectsLocationsSessionsList =
             ListSessionsResponse
        type Scopes DataprocProjectsLocationsSessionsList =
