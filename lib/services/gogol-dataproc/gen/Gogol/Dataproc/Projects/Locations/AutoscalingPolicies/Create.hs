...
-- |
-- Module      : Gogol.Dataproc.Projects.Locations.AutoscalingPolicies.Create
                   ...
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] AutoscalingPolicy Core.:>
                         Core.Post '[Core.JSON] AutoscalingPolicy
...
newDataprocProjectsLocationsAutoscalingPoliciesCreate 
    ...
    -> DataprocProjectsLocationsAutoscalingPoliciesCreate
newDataprocProjectsLocationsAutoscalingPoliciesCreate parent
  payload
  = DataprocProjectsLocationsAutoscalingPoliciesCreate{xgafv =
                                                         Core.Nothing,
...
instance Core.GoogleRequest
           DataprocProjectsLocationsAutoscalingPoliciesCreate
         where
        type Rs DataprocProjectsLocationsAutoscalingPoliciesCreate =
             AutoscalingPolicy
        type Scopes DataprocProjectsLocationsAutoscalingPoliciesCreate =
