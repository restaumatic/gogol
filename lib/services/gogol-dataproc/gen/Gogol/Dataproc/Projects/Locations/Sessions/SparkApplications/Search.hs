                               ...
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.Get '[Core.JSON] SearchSessionSparkApplicationsResponse
...
newDataprocProjectsLocationsSessionsSparkApplicationsSearch parent
  = DataprocProjectsLocationsSessionsSparkApplicationsSearch{xgafv =
                                                               Core.Nothing,
...
instance Core.GoogleRequest
           DataprocProjectsLocationsSessionsSparkApplicationsSearch
         where
        type Rs DataprocProjectsLocationsSessionsSparkApplicationsSearch =
