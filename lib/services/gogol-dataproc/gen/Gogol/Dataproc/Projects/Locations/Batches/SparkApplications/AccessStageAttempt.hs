...
type DataprocProjectsLocationsBatchesSparkApplicationsAccessStageAttemptResource
     =
     "v1" Core.:>
       Core.CaptureMode "name" "accessStageAttempt" Core.Text Core.:>
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] AccessSparkApplicationStageAttemptResponse
...
newDataprocProjectsLocationsBatchesSparkApplicationsAccessStageAttempt
  name
  = DataprocProjectsLocationsBatchesSparkApplicationsAccessStageAttempt{xgafv
                                                                          = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        requestClient
          DataprocProjectsLocationsBatchesSparkApplicationsAccessStageAttempt{..}
          = go name xgafv accessToken callback parent stageAttemptId stageId
              summaryMetricsMask
              uploadType
              uploadProtocol
