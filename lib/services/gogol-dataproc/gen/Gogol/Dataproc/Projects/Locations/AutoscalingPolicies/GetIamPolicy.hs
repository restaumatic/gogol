...
newDataprocProjectsLocationsAutoscalingPoliciesGetIamPolicy 
    ...
    -> DataprocProjectsLocationsAutoscalingPoliciesGetIamPolicy
newDataprocProjectsLocationsAutoscalingPoliciesGetIamPolicy payload
  resource
  = DataprocProjectsLocationsAutoscalingPoliciesGetIamPolicy{xgafv =
                                                               Core.Nothing,
...
instance Core.GoogleRequest
           DataprocProjectsLocationsAutoscalingPoliciesGetIamPolicy
         where
        type Rs DataprocProjectsLocationsAutoscalingPoliciesGetIamPolicy =
             Policy
        type Scopes
               DataprocProjectsLocationsAutoscalingPoliciesGetIamPolicy
