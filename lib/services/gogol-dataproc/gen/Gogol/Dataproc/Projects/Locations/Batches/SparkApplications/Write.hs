               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] WriteSparkApplicationContextRequest
...
newDataprocProjectsLocationsBatchesSparkApplicationsWrite 
    ...
    -> DataprocProjectsLocationsBatchesSparkApplicationsWrite
newDataprocProjectsLocationsBatchesSparkApplicationsWrite name
  payload
  = DataprocProjectsLocationsBatchesSparkApplicationsWrite{xgafv =
                                                             Core.Nothing,
...
instance Core.GoogleRequest
           DataprocProjectsLocationsBatchesSparkApplicationsWrite
         where
        type Rs DataprocProjectsLocationsBatchesSparkApplicationsWrite =
             WriteSparkApplicationContextResponse
        type Scopes DataprocProjectsLocationsBatchesSparkApplicationsWrite
