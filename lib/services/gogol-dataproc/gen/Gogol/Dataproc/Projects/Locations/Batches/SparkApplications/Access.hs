                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.Get '[Core.JSON] AccessSparkApplicationResponse
...
newDataprocProjectsLocationsBatchesSparkApplicationsAccess name
  = DataprocProjectsLocationsBatchesSparkApplicationsAccess{xgafv =
                                                              Core.Nothing,
...
instance Core.GoogleRequest
           DataprocProjectsLocationsBatchesSparkApplicationsAccess
         where
        type Rs DataprocProjectsLocationsBatchesSparkApplicationsAccess =
             AccessSparkApplicationResponse
        type Scopes DataprocProjectsLocationsBatchesSparkApplicationsAccess
