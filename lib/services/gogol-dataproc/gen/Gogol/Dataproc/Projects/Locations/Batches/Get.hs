...
newDataprocProjectsLocationsBatchesGet name
  = DataprocProjectsLocationsBatchesGet{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        name = name, uploadType = Core.Nothing,
                                        uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DataprocProjectsLocationsBatchesGet
         where
        type Rs DataprocProjectsLocationsBatchesGet = Batch
        type Scopes DataprocProjectsLocationsBatchesGet =
