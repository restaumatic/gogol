...
newDataprocProjectsLocationsSessionTemplatesCreate parent payload
  = DataprocProjectsLocationsSessionTemplatesCreate{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           DataprocProjectsLocationsSessionTemplatesCreate
         where
        type Rs DataprocProjectsLocationsSessionTemplatesCreate =
             SessionTemplate
        type Scopes DataprocProjectsLocationsSessionTemplatesCreate =
