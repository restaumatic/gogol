...
type DataprocProjectsLocationsSessionsSparkApplicationsAccessStageRddGraphResource
     =
     "v1" Core.:>
       Core.CaptureMode "name" "accessStageRddGraph" Core.Text Core.:>
...
newDataprocProjectsLocationsSessionsSparkApplicationsAccessStageRddGraph
  name
  = DataprocProjectsLocationsSessionsSparkApplicationsAccessStageRddGraph{xgafv
                                                                            = Core.Nothing,
                                                                          accessToken =
                                                                            Core.Nothing,
...
instance Core.GoogleRequest
        ...
        requestClient
          DataprocProjectsLocationsSessionsSparkApplicationsAccessStageRddGraph{..}
          = go name xgafv accessToken callback parent stageId uploadType
              uploadProtocol
