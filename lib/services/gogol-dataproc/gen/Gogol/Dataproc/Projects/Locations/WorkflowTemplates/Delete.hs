...
newDataprocProjectsLocationsWorkflowTemplatesDelete name
  = DataprocProjectsLocationsWorkflowTemplatesDelete{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           DataprocProjectsLocationsWorkflowTemplatesDelete
         where
        type Rs DataprocProjectsLocationsWorkflowTemplatesDelete = Empty
        type Scopes DataprocProjectsLocationsWorkflowTemplatesDelete =
             '[CloudPlatform'FullControl]
        requestClient DataprocProjectsLocationsWorkflowTemplatesDelete{..}
