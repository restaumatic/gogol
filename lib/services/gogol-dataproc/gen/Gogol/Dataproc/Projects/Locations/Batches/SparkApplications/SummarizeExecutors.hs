...
type DataprocProjectsLocationsBatchesSparkApplicationsSummarizeExecutorsResource
     =
     "v1" Core.:>
       Core.CaptureMode "name" "summarizeExecutors" Core.Text Core.:>
                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.Get '[Core.JSON] SummarizeSparkApplicationExecutorsResponse
...
newDataprocProjectsLocationsBatchesSparkApplicationsSummarizeExecutors
  name
  = DataprocProjectsLocationsBatchesSparkApplicationsSummarizeExecutors{xgafv
                                                                          = Core.Nothing,
