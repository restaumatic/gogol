                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.Get '[Core.JSON] AccessSessionSparkApplicationJobResponse
...
newDataprocProjectsLocationsSessionsSparkApplicationsAccessJob name
  = DataprocProjectsLocationsSessionsSparkApplicationsAccessJob{xgafv
                                                                  = Core.Nothing,
                                                                accessToken = Core.Nothing,
                                                                callback = Core.Nothing,
                                                                jobId = Core.Nothing, name = name,
                                                                parent = Core.Nothing,
...
instance Core.GoogleRequest
           DataprocProjectsLocationsSessionsSparkApplicationsAccessJob
         where
        type Rs DataprocProjectsLocationsSessionsSparkApplicationsAccessJob
        ...
        requestClient
          DataprocProjectsLocationsSessionsSparkApplicationsAccessJob{..}
          = go name xgafv accessToken callback jobId parent uploadType
              uploadProtocol
