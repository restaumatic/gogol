...
newDataprocProjectsLocationsWorkflowTemplatesCreate parent payload
  = DataprocProjectsLocationsWorkflowTemplatesCreate{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           DataprocProjectsLocationsWorkflowTemplatesCreate
         where
        type Rs DataprocProjectsLocationsWorkflowTemplatesCreate =
             WorkflowTemplate
        type Scopes DataprocProjectsLocationsWorkflowTemplatesCreate =
