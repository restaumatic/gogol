...
instance Core.GoogleRequest DataprocProjectsLocationsOperationsList
        ...
        requestClient DataprocProjectsLocationsOperationsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DataprocProjectsLocationsOperationsListResource)
                      Core.mempty
