...
type DataprocProjectsLocationsBatchesSparkApplicationsSearchResource
     ...
     "v1" Core.:>
       Core.Capture "parent" Core.Text Core.:>
         "sparkApplications:search" Core.:>
           Core.QueryParam "$.xgafv" Xgafv Core.:>
             Core.QueryParam "access_token" Core.Text Core.:>
               Core.QueryParam "applicationStatus"
                 ProjectsLocationsBatchesSparkApplicationsSearchApplicationStatus
                 Core.:>
                 Core.QueryParam "callback" Core.Text Core.:>
                   Core.QueryParam "maxEndTime" Core.DateTime Core.:>
                     Core.QueryParam "maxTime" Core.DateTime Core.:>
                       Core.QueryParam "minEndTime" Core.DateTime Core.:>
                         Core.QueryParam "minTime" Core.DateTime Core.:>
                           Core.QueryParam "pageSize" Core.Int32 Core.:>
                             Core.QueryParam "pageToken" Core.Text Core.:>
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.Get '[Core.JSON] SearchSparkApplicationsResponse
...
newDataprocProjectsLocationsBatchesSparkApplicationsSearch parent
  = DataprocProjectsLocationsBatchesSparkApplicationsSearch{xgafv =
                                                              Core.Nothing,
...
instance Core.GoogleRequest
           DataprocProjectsLocationsBatchesSparkApplicationsSearch
         where
        type Rs DataprocProjectsLocationsBatchesSparkApplicationsSearch =
             SearchSparkApplicationsResponse
        type Scopes DataprocProjectsLocationsBatchesSparkApplicationsSearch
             = '[CloudPlatform'FullControl]
        requestClient
          DataprocProjectsLocationsBatchesSparkApplicationsSearch{..}
          = go parent xgafv accessToken applicationStatus callback maxEndTime
              maxTime
              minEndTime
              minTime
              pageSize
