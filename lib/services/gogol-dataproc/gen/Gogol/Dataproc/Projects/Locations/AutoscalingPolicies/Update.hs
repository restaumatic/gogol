...
newDataprocProjectsLocationsAutoscalingPoliciesUpdate name payload
  = DataprocProjectsLocationsAutoscalingPoliciesUpdate{xgafv =
                                                         Core.Nothing,
...
instance Core.GoogleRequest
           DataprocProjectsLocationsAutoscalingPoliciesUpdate
         where
        type Rs DataprocProjectsLocationsAutoscalingPoliciesUpdate =
             AutoscalingPolicy
        type Scopes DataprocProjectsLocationsAutoscalingPoliciesUpdate =
