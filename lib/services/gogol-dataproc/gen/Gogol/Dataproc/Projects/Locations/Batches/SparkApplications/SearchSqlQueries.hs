...
type DataprocProjectsLocationsBatchesSparkApplicationsSearchSqlQueriesResource
     =
     "v1" Core.:>
       Core.CaptureMode "name" "searchSqlQueries" Core.Text Core.:>
                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Get '[Core.JSON] SearchSparkApplicationSqlQueriesResponse
...
newDataprocProjectsLocationsBatchesSparkApplicationsSearchSqlQueries
  name
  = DataprocProjectsLocationsBatchesSparkApplicationsSearchSqlQueries{xgafv
                                                                        = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        requestClient
          DataprocProjectsLocationsBatchesSparkApplicationsSearchSqlQueries{..}
          = go name xgafv accessToken callback details pageSize pageToken
              parent
              planDescription
              uploadType
              uploadProtocol
