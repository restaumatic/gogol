         ...
         Core.QueryParam "$.xgafv" Xgafv Core.:>
           Core.QueryParam "access_token" Core.Text Core.:>
             Core.QueryParam "callback" Core.Text Core.:>
               Core.QueryParams "jobIds" Core.Int64 Core.:>
                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Get '[Core.JSON] SearchSessionSparkApplicationJobsResponse
...
newDataprocProjectsLocationsSessionsSparkApplicationsSearchJobs
  name
  = DataprocProjectsLocationsSessionsSparkApplicationsSearchJobs{xgafv
                                                                   = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        requestClient
          DataprocProjectsLocationsSessionsSparkApplicationsSearchJobs{..}
          = go name xgafv accessToken callback (jobIds Core.^. Core._Default)
              jobStatus
              pageSize
              pageToken
              parent
