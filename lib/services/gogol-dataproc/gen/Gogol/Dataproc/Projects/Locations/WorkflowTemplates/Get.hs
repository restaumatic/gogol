...
-- |
-- Module      : Gogol.Dataproc.Projects.Locations.WorkflowTemplates.Get
...
newDataprocProjectsLocationsWorkflowTemplatesGet name
  = DataprocProjectsLocationsWorkflowTemplatesGet{xgafv =
                                                    Core.Nothing,
...
instance Core.GoogleRequest
           DataprocProjectsLocationsWorkflowTemplatesGet
         where
        type Rs DataprocProjectsLocationsWorkflowTemplatesGet =
             WorkflowTemplate
        type Scopes DataprocProjectsLocationsWorkflowTemplatesGet =
             '[CloudPlatform'FullControl]
        requestClient DataprocProjectsLocationsWorkflowTemplatesGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DataprocProjectsLocationsWorkflowTemplatesGetResource)
                      Core.mempty
