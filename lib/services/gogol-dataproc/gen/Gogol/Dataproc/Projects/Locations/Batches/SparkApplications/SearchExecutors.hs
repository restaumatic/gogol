...
type DataprocProjectsLocationsBatchesSparkApplicationsSearchExecutorsResource
     =
     "v1" Core.:>
       Core.CaptureMode "name" "searchExecutors" Core.Text Core.:>
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] SearchSparkApplicationExecutorsResponse
...
newDataprocProjectsLocationsBatchesSparkApplicationsSearchExecutors
  name
  = DataprocProjectsLocationsBatchesSparkApplicationsSearchExecutors{xgafv
                                                                       = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        requestClient
          DataprocProjectsLocationsBatchesSparkApplicationsSearchExecutors{..}
          = go name xgafv accessToken callback executorStatus pageSize
              pageToken
              parent
              uploadType
              uploadProtocol
