...
newDataprocProjectsLocationsWorkflowTemplatesUpdate name payload
  = DataprocProjectsLocationsWorkflowTemplatesUpdate{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           DataprocProjectsLocationsWorkflowTemplatesUpdate
         where
        type Rs DataprocProjectsLocationsWorkflowTemplatesUpdate =
             WorkflowTemplate
        type Scopes DataprocProjectsLocationsWorkflowTemplatesUpdate =
