...
type DataprocProjectsLocationsWorkflowTemplatesInstantiateResource
     =
     "v1" Core.:>
       Core.CaptureMode "name" "instantiate" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] InstantiateWorkflowTemplateRequest
...
newDataprocProjectsLocationsWorkflowTemplatesInstantiate 
    ...
    -> DataprocProjectsLocationsWorkflowTemplatesInstantiate
newDataprocProjectsLocationsWorkflowTemplatesInstantiate name
  payload
  = DataprocProjectsLocationsWorkflowTemplatesInstantiate{xgafv =
                                                            Core.Nothing,
...
instance Core.GoogleRequest
           DataprocProjectsLocationsWorkflowTemplatesInstantiate
         where
        type Rs DataprocProjectsLocationsWorkflowTemplatesInstantiate =
             Operation
        type Scopes DataprocProjectsLocationsWorkflowTemplatesInstantiate =
