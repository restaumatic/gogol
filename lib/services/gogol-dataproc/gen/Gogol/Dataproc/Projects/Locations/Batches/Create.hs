...
-- |
-- Module      : Gogol.Dataproc.Projects.Locations.Batches.Create
         ...
         "batches" Core.:>
           Core.QueryParam "$.xgafv" Xgafv Core.:>
             Core.QueryParam "access_token" Core.Text Core.:>
               Core.QueryParam "batchId" Core.Text Core.:>
                 Core.QueryParam "callback" Core.Text Core.:>
                   Core.QueryParam "requestId" Core.Text Core.:>
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] Batch Core.:>
...
newDataprocProjectsLocationsBatchesCreate parent payload
  = DataprocProjectsLocationsBatchesCreate{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, batchId = Core.Nothing,
...
instance Core.GoogleRequest DataprocProjectsLocationsBatchesCreate
         where
        type Rs DataprocProjectsLocationsBatchesCreate = Operation
        type Scopes DataprocProjectsLocationsBatchesCreate =
             '[CloudPlatform'FullControl]
        requestClient DataprocProjectsLocationsBatchesCreate{..}
          = go parent xgafv accessToken batchId callback requestId uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DataprocProjectsLocationsBatchesCreateResource)
                      Core.mempty
