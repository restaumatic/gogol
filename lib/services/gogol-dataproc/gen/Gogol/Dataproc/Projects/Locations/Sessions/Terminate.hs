               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] TerminateSessionRequest Core.:>
...
newDataprocProjectsLocationsSessionsTerminate name payload
  = DataprocProjectsLocationsSessionsTerminate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           DataprocProjectsLocationsSessionsTerminate
         where
        type Rs DataprocProjectsLocationsSessionsTerminate = Operation
        type Scopes DataprocProjectsLocationsSessionsTerminate =
             '[CloudPlatform'FullControl]
        requestClient DataprocProjectsLocationsSessionsTerminate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DataprocProjectsLocationsSessionsTerminateResource)
                      Core.mempty
