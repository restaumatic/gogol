                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] ListSessionTemplatesResponse
...
newDataprocProjectsLocationsSessionTemplatesList parent
  = DataprocProjectsLocationsSessionTemplatesList{xgafv =
                                                    Core.Nothing,
...
instance Core.GoogleRequest
           DataprocProjectsLocationsSessionTemplatesList
         where
        type Rs DataprocProjectsLocationsSessionTemplatesList =
             ListSessionTemplatesResponse
        type Scopes DataprocProjectsLocationsSessionTemplatesList =
