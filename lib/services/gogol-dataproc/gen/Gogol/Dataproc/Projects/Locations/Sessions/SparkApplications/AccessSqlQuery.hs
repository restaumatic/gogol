...
type DataprocProjectsLocationsSessionsSparkApplicationsAccessSqlQueryResource
     =
     "v1" Core.:>
       Core.CaptureMode "name" "accessSqlQuery" Core.Text Core.:>
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] AccessSessionSparkApplicationSqlQueryResponse
...
newDataprocProjectsLocationsSessionsSparkApplicationsAccessSqlQuery
  name
  = DataprocProjectsLocationsSessionsSparkApplicationsAccessSqlQuery{xgafv
                                                                       = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        requestClient
          DataprocProjectsLocationsSessionsSparkApplicationsAccessSqlQuery{..}
          = go name xgafv accessToken callback details executionId parent
              planDescription
              uploadType
              uploadProtocol
