...
newDataprocProjectsLocationsAutoscalingPoliciesGet name
  = DataprocProjectsLocationsAutoscalingPoliciesGet{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           DataprocProjectsLocationsAutoscalingPoliciesGet
         where
        type Rs DataprocProjectsLocationsAutoscalingPoliciesGet =
             AutoscalingPolicy
        type Scopes DataprocProjectsLocationsAutoscalingPoliciesGet =
             '[CloudPlatform'FullControl]
        requestClient DataprocProjectsLocationsAutoscalingPoliciesGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DataprocProjectsLocationsAutoscalingPoliciesGetResource)
                      Core.mempty
