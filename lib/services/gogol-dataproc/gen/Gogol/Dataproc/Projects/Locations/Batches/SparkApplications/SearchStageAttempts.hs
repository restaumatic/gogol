...
type DataprocProjectsLocationsBatchesSparkApplicationsSearchStageAttemptsResource
     =
     "v1" Core.:>
       Core.CaptureMode "name" "searchStageAttempts" Core.Text Core.:>
                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Get '[Core.JSON] SearchSparkApplicationStageAttemptsResponse
...
newDataprocProjectsLocationsBatchesSparkApplicationsSearchStageAttempts
  name
  = DataprocProjectsLocationsBatchesSparkApplicationsSearchStageAttempts{xgafv
                                                                           = Core.Nothing,
