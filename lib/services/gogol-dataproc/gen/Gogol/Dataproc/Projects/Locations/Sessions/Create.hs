...
newDataprocProjectsLocationsSessionsCreate parent payload
  = DataprocProjectsLocationsSessionsCreate{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            parent = parent, payload = payload,
                                            requestId = Core.Nothing, sessionId = Core.Nothing,
                                            uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DataprocProjectsLocationsSessionsCreate
         where
        type Rs DataprocProjectsLocationsSessionsCreate = Operation
        type Scopes DataprocProjectsLocationsSessionsCreate =
             '[CloudPlatform'FullControl]
        requestClient DataprocProjectsLocationsSessionsCreate{..}
          = go parent xgafv accessToken callback requestId sessionId
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DataprocProjectsLocationsSessionsCreateResource)
                      Core.mempty
