...
newDataprocProjectsLocationsWorkflowTemplatesGetIamPolicy 
    ...
    -> DataprocProjectsLocationsWorkflowTemplatesGetIamPolicy
newDataprocProjectsLocationsWorkflowTemplatesGetIamPolicy payload
  resource
  = DataprocProjectsLocationsWorkflowTemplatesGetIamPolicy{xgafv =
                                                             Core.Nothing,
...
instance Core.GoogleRequest
           DataprocProjectsLocationsWorkflowTemplatesGetIamPolicy
         where
        type Rs DataprocProjectsLocationsWorkflowTemplatesGetIamPolicy =
             Policy
        type Scopes DataprocProjectsLocationsWorkflowTemplatesGetIamPolicy
