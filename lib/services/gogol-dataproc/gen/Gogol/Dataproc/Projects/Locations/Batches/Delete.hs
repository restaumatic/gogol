...
newDataprocProjectsLocationsBatchesDelete name
  = DataprocProjectsLocationsBatchesDelete{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           name = name, uploadType = Core.Nothing,
                                           uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DataprocProjectsLocationsBatchesDelete
         where
        type Rs DataprocProjectsLocationsBatchesDelete = Empty
        type Scopes DataprocProjectsLocationsBatchesDelete =
             '[CloudPlatform'FullControl]
        requestClient DataprocProjectsLocationsBatchesDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DataprocProjectsLocationsBatchesDeleteResource)
                      Core.mempty
