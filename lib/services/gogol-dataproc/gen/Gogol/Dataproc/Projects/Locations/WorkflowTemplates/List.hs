...
newDataprocProjectsLocationsWorkflowTemplatesList parent
  = DataprocProjectsLocationsWorkflowTemplatesList{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           DataprocProjectsLocationsWorkflowTemplatesList
         where
        type Rs DataprocProjectsLocationsWorkflowTemplatesList =
             ListWorkflowTemplatesResponse
        type Scopes DataprocProjectsLocationsWorkflowTemplatesList =
