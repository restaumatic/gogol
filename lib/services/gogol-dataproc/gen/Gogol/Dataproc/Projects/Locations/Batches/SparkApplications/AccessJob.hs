                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.Get '[Core.JSON] AccessSparkApplicationJobResponse
...
newDataprocProjectsLocationsBatchesSparkApplicationsAccessJob name
  = DataprocProjectsLocationsBatchesSparkApplicationsAccessJob{xgafv
                                                                 = Core.Nothing,
...
instance Core.GoogleRequest
           DataprocProjectsLocationsBatchesSparkApplicationsAccessJob
         where
        type Rs DataprocProjectsLocationsBatchesSparkApplicationsAccessJob
