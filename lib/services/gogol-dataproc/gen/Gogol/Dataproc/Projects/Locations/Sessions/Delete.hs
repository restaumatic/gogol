...
newDataprocProjectsLocationsSessionsDelete name
  = DataprocProjectsLocationsSessionsDelete{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            name = name, requestId = Core.Nothing,
                                            uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DataprocProjectsLocationsSessionsDelete
         where
        type Rs DataprocProjectsLocationsSessionsDelete = Operation
        type Scopes DataprocProjectsLocationsSessionsDelete =
