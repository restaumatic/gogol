                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.Get '[Core.JSON] AccessSessionSparkApplicationResponse
...
newDataprocProjectsLocationsSessionsSparkApplicationsAccess name
  = DataprocProjectsLocationsSessionsSparkApplicationsAccess{xgafv =
                                                               Core.Nothing,
...
instance Core.GoogleRequest
           DataprocProjectsLocationsSessionsSparkApplicationsAccess
         where
        type Rs DataprocProjectsLocationsSessionsSparkApplicationsAccess =
