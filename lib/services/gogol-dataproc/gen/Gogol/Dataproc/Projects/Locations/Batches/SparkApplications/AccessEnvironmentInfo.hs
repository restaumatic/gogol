...
type DataprocProjectsLocationsBatchesSparkApplicationsAccessEnvironmentInfoResource
     =
     "v1" Core.:>
       Core.CaptureMode "name" "accessEnvironmentInfo" Core.Text Core.:>
                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.Get '[Core.JSON] AccessSparkApplicationEnvironmentInfoResponse
...
newDataprocProjectsLocationsBatchesSparkApplicationsAccessEnvironmentInfo
  name
  = DataprocProjectsLocationsBatchesSparkApplicationsAccessEnvironmentInfo{xgafv
                                                                             = Core.Nothing,
                                                                           accessToken =
                                                                             Core.Nothing,
