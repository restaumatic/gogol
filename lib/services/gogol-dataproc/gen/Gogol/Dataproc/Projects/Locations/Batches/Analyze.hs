...
type DataprocProjectsLocationsBatchesAnalyzeResource =
     "v1" Core.:>
       Core.CaptureMode "name" "analyze" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] AnalyzeBatchRequest Core.:>
...
newDataprocProjectsLocationsBatchesAnalyze name payload
  = DataprocProjectsLocationsBatchesAnalyze{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            name = name, payload = payload,
                                            uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DataprocProjectsLocationsBatchesAnalyze
         where
        type Rs DataprocProjectsLocationsBatchesAnalyze = Operation
        type Scopes DataprocProjectsLocationsBatchesAnalyze =
