...
newDataprocProjectsLocationsWorkflowTemplatesSetIamPolicy 
    ...
    -> DataprocProjectsLocationsWorkflowTemplatesSetIamPolicy
newDataprocProjectsLocationsWorkflowTemplatesSetIamPolicy payload
  resource
  = DataprocProjectsLocationsWorkflowTemplatesSetIamPolicy{xgafv =
                                                             Core.Nothing,
...
instance Core.GoogleRequest
           DataprocProjectsLocationsWorkflowTemplatesSetIamPolicy
         where
        type Rs DataprocProjectsLocationsWorkflowTemplatesSetIamPolicy =
             Policy
        type Scopes DataprocProjectsLocationsWorkflowTemplatesSetIamPolicy
