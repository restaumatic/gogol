...
data AnalyzeBatchRequest = AnalyzeBatchRequest
    {
    ...
    , requestorId :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newAnalyzeBatchRequest
  = AnalyzeBatchRequest{requestId = Core.Nothing,
                        requestorId = Core.Nothing}
instance Core.FromJSON AnalyzeBatchRequest where
        parseJSON
          = Core.withObject "AnalyzeBatchRequest"
              (\ o ->
                 AnalyzeBatchRequest Core.<$>
                   (o Core..:? "requestId") Core.<*> (o Core..:? "requestorId"))
          ...
          = Core.object
              (Core.catMaybes
                 [("requestId" Core..=) Core.<$> requestId,
                  ("requestorId" Core..=) Core.<$> requestorId])
...
data LifecycleConfig = LifecycleConfig
    ...
    , autoStopTime :: (Core.Maybe Core.DateTime)
    ...
    , autoStopTtl :: (Core.Maybe Core.Duration)
    ...
    , idleStopTtl :: (Core.Maybe Core.Duration)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newLifecycleConfig
  = LifecycleConfig{autoDeleteTime = Core.Nothing,
                    autoDeleteTtl = Core.Nothing, autoStopTime = Core.Nothing,
                    autoStopTtl = Core.Nothing, idleDeleteTtl = Core.Nothing,
                    idleStartTime = Core.Nothing, idleStopTtl = Core.Nothing}
              ...
              (\ o ->
                 LifecycleConfig Core.<$>
                   (o Core..:? "autoDeleteTime") Core.<*> (o Core..:? "autoDeleteTtl")
                     Core.<*> (o Core..:? "autoStopTime")
                     Core.<*> (o Core..:? "autoStopTtl")
                     Core.<*> (o Core..:? "idleDeleteTtl")
                     Core.<*> (o Core..:? "idleStartTime")
                     Core.<*> (o Core..:? "idleStopTtl"))
          ...
          = Core.object
              (Core.catMaybes
                 [("autoDeleteTime" Core..=) Core.<$> autoDeleteTime,
                  ...
                  ("autoStopTime" Core..=) Core.<$> autoStopTime,
                  ("autoStopTtl" Core..=) Core.<$> autoStopTtl,
                  ("idleDeleteTtl" Core..=) Core.<$> idleDeleteTtl,
                  ("idleStartTime" Core..=) Core.<$> idleStartTime,
                  ("idleStopTtl" Core..=) Core.<$> idleStopTtl])
...
data RepairClusterRequest = RepairClusterRequest
    ...
    , dataprocSuperUser :: (Core.Maybe Core.Bool)
...
newRepairClusterRequest
  = RepairClusterRequest{cluster = Core.Nothing,
                         clusterUuid = Core.Nothing, dataprocSuperUser = Core.Nothing,
          ...
          = Core.object
              (Core.catMaybes
                 [("cluster" Core..=) Core.<$> cluster,
                  ("clusterUuid" Core..=) Core.<$> clusterUuid,
                  ("dataprocSuperUser" Core..=) Core.<$> dataprocSuperUser,
                  ("gracefulDecommissionTimeout" Core..=) Core.<$>
                    gracefulDecommissionTimeout,
...
newUsageSnapshot
  = UsageSnapshot{acceleratorType = Core.Nothing,
                  ...
                  milliDcuPremium = Core.Nothing, shuffleStorageGb = Core.Nothing,
