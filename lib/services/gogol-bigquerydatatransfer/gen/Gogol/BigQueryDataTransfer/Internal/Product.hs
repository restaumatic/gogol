...
data DataSourceParameter = DataSourceParameter
    ...
    , maxListSize :: (Core.Maybe Core.Int64)
...
newDataSourceParameter
  = DataSourceParameter{allowedValues = Core.Nothing,
                        ...
                        immutable = Core.Nothing, maxListSize = Core.Nothing,
                        maxValue = Core.Nothing, minValue = Core.Nothing,
                        paramId = Core.Nothing, recurse = Core.Nothing,
                        repeated = Core.Nothing, required = Core.Nothing,
                        type' = Core.Nothing, validationDescription = Core.Nothing,
              ...
              (\ o ->
                 DataSourceParameter Core.<$>
                   (o Core..:? "allowedValues") Core.<*> (o Core..:? "deprecated")
                     ...
                     Core.<*>
                     (o Core..:? "maxListSize" Core.<&> Core.fmap Core.fromAsText)
          ...
          = Core.object
              (Core.catMaybes
                 [("allowedValues" Core..=) Core.<$> allowedValues,
                  ...
                  ("maxListSize" Core..=) Core.. Core.AsText Core.<$> maxListSize,
