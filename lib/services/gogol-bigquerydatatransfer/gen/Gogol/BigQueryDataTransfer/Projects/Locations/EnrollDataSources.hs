...
newBigQueryDataTransferProjectsLocationsEnrollDataSources 
    ...
    -> BigQueryDataTransferProjectsLocationsEnrollDataSources
newBigQueryDataTransferProjectsLocationsEnrollDataSources name
  payload
  = BigQueryDataTransferProjectsLocationsEnrollDataSources{xgafv =
                                                             Core.Nothing,
...
instance Core.GoogleRequest
           BigQueryDataTransferProjectsLocationsEnrollDataSources
         where
        type Rs BigQueryDataTransferProjectsLocationsEnrollDataSources =
             Empty
        type Scopes BigQueryDataTransferProjectsLocationsEnrollDataSources
