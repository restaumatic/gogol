...
newBigQueryDataTransferProjectsLocationsDataSourcesList parent
  = BigQueryDataTransferProjectsLocationsDataSourcesList{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           BigQueryDataTransferProjectsLocationsDataSourcesList
         where
        type Rs BigQueryDataTransferProjectsLocationsDataSourcesList =
             ListDataSourcesResponse
        type Scopes BigQueryDataTransferProjectsLocationsDataSourcesList =
