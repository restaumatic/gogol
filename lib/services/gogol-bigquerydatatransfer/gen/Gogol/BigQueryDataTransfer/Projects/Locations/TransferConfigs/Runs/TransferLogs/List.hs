...
newBigQueryDataTransferProjectsLocationsTransferConfigsRunsTransferLogsList 
    :: 
                                                                            Core.Text
       -- ^  Required. Transfer run name. If you are using the regionless method, the location must be @US@ and the name should be in the following form: * @projects\/{project_id}\/transferConfigs\/{config_id}\/runs\/{run_id}@ If you are using the regionalized method, the name should be in the following form: * @projects\/{project_id}\/locations\/{location_id}\/transferConfigs\/{config_id}\/runs\/{run_id}@ See 'parent'.
    -> BigQueryDataTransferProjectsLocationsTransferConfigsRunsTransferLogsList
newBigQueryDataTransferProjectsLocationsTransferConfigsRunsTransferLogsList
  parent
  = BigQueryDataTransferProjectsLocationsTransferConfigsRunsTransferLogsList{xgafv
                                                                               = Core.Nothing,
                                                                             accessToken =
                                                                               Core.Nothing,
                                                                             callback =
