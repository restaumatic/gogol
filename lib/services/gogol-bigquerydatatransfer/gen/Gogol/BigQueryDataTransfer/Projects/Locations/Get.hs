...
newBigQueryDataTransferProjectsLocationsGet name
  = BigQueryDataTransferProjectsLocationsGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           BigQueryDataTransferProjectsLocationsGet
         where
        type Rs BigQueryDataTransferProjectsLocationsGet = Location
        type Scopes BigQueryDataTransferProjectsLocationsGet =
             '[Bigquery'FullControl, CloudPlatform'FullControl,
               CloudPlatform'ReadOnly]
        requestClient BigQueryDataTransferProjectsLocationsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy BigQueryDataTransferProjectsLocationsGetResource)
                      Core.mempty
