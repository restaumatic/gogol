...
type BigQueryDataTransferProjectsLocationsUnenrollDataSourcesResource
     =
     "v1" Core.:>
       Core.CaptureMode "name" "unenrollDataSources" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] UnenrollDataSourcesRequest Core.:>
...
newBigQueryDataTransferProjectsLocationsUnenrollDataSources 
    ...
    -> BigQueryDataTransferProjectsLocationsUnenrollDataSources
newBigQueryDataTransferProjectsLocationsUnenrollDataSources name
  payload
  = BigQueryDataTransferProjectsLocationsUnenrollDataSources{xgafv =
                                                               Core.Nothing,
...
instance Core.GoogleRequest
           BigQueryDataTransferProjectsLocationsUnenrollDataSources
         where
        type Rs BigQueryDataTransferProjectsLocationsUnenrollDataSources =
             Empty
        type Scopes
               BigQueryDataTransferProjectsLocationsUnenrollDataSources
