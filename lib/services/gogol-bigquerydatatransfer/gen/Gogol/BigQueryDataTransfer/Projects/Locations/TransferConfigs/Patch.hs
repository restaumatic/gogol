...
newBigQueryDataTransferProjectsLocationsTransferConfigsPatch 
    ...
    -> BigQueryDataTransferProjectsLocationsTransferConfigsPatch
newBigQueryDataTransferProjectsLocationsTransferConfigsPatch name
  payload
  = BigQueryDataTransferProjectsLocationsTransferConfigsPatch{xgafv =
                                                                Core.Nothing,
...
instance Core.GoogleRequest
           BigQueryDataTransferProjectsLocationsTransferConfigsPatch
         where
        type Rs BigQueryDataTransferProjectsLocationsTransferConfigsPatch =
             TransferConfig
        type Scopes
               BigQueryDataTransferProjectsLocationsTransferConfigsPatch
