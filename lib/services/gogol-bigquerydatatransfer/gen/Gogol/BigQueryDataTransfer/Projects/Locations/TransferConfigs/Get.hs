...
newBigQueryDataTransferProjectsLocationsTransferConfigsGet name
  = BigQueryDataTransferProjectsLocationsTransferConfigsGet{xgafv =
                                                              Core.Nothing,
...
instance Core.GoogleRequest
           BigQueryDataTransferProjectsLocationsTransferConfigsGet
         where
        type Rs BigQueryDataTransferProjectsLocationsTransferConfigsGet =
             TransferConfig
        type Scopes BigQueryDataTransferProjectsLocationsTransferConfigsGet
             =
