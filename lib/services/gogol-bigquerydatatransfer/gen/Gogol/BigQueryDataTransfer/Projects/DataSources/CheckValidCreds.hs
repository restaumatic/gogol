...
type BigQueryDataTransferProjectsDataSourcesCheckValidCredsResource
     =
     "v1" Core.:>
       Core.CaptureMode "name" "checkValidCreds" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] CheckValidCredsRequest Core.:>
...
newBigQueryDataTransferProjectsDataSourcesCheckValidCreds 
    ...
    -> BigQueryDataTransferProjectsDataSourcesCheckValidCreds
newBigQueryDataTransferProjectsDataSourcesCheckValidCreds name
  payload
  = BigQueryDataTransferProjectsDataSourcesCheckValidCreds{xgafv =
                                                             Core.Nothing,
...
instance Core.GoogleRequest
           BigQueryDataTransferProjectsDataSourcesCheckValidCreds
         where
        type Rs BigQueryDataTransferProjectsDataSourcesCheckValidCreds =
             CheckValidCredsResponse
        type Scopes BigQueryDataTransferProjectsDataSourcesCheckValidCreds
             =
