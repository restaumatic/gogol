...
newBigQueryDataTransferProjectsDataSourcesList parent
  = BigQueryDataTransferProjectsDataSourcesList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           BigQueryDataTransferProjectsDataSourcesList
         where
        type Rs BigQueryDataTransferProjectsDataSourcesList =
             ListDataSourcesResponse
        type Scopes BigQueryDataTransferProjectsDataSourcesList =
             '[Bigquery'FullControl, CloudPlatform'FullControl,
               CloudPlatform'ReadOnly]
        requestClient BigQueryDataTransferProjectsDataSourcesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy BigQueryDataTransferProjectsDataSourcesListResource)
                      Core.mempty
