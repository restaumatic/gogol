...
newBigQueryDataTransferProjectsTransferConfigsDelete name
  = BigQueryDataTransferProjectsTransferConfigsDelete{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           BigQueryDataTransferProjectsTransferConfigsDelete
         where
        type Rs BigQueryDataTransferProjectsTransferConfigsDelete = Empty
        type Scopes BigQueryDataTransferProjectsTransferConfigsDelete =
             '[Bigquery'FullControl, CloudPlatform'FullControl]
        requestClient BigQueryDataTransferProjectsTransferConfigsDelete{..}
