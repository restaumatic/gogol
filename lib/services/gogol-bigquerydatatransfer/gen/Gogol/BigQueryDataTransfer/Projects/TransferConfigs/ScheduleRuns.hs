...
type BigQueryDataTransferProjectsTransferConfigsScheduleRunsResource
     =
     "v1" Core.:>
       Core.CaptureMode "parent" "scheduleRuns" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] ScheduleTransferRunsRequest Core.:>
                       Core.Post '[Core.JSON] ScheduleTransferRunsResponse
...
newBigQueryDataTransferProjectsTransferConfigsScheduleRuns 
    ...
    -> BigQueryDataTransferProjectsTransferConfigsScheduleRuns
newBigQueryDataTransferProjectsTransferConfigsScheduleRuns parent
  payload
  = BigQueryDataTransferProjectsTransferConfigsScheduleRuns{xgafv =
                                                              Core.Nothing,
...
instance Core.GoogleRequest
           BigQueryDataTransferProjectsTransferConfigsScheduleRuns
         where
        type Rs BigQueryDataTransferProjectsTransferConfigsScheduleRuns =
             ScheduleTransferRunsResponse
        type Scopes BigQueryDataTransferProjectsTransferConfigsScheduleRuns
