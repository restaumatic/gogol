...
newBigQueryDataTransferProjectsTransferConfigsRunsDelete 
    :: 
                                                         Core.Text
       -- ^  Required. The name of the resource requested. If you are using the regionless method, the location must be @US@ and the name should be in the following form: * @projects\/{project_id}\/transferConfigs\/{config_id}\/runs\/{run_id}@ If you are using the regionalized method, the name should be in the following form: * @projects\/{project_id}\/locations\/{location_id}\/transferConfigs\/{config_id}\/runs\/{run_id}@ See 'name'.
    -> BigQueryDataTransferProjectsTransferConfigsRunsDelete
newBigQueryDataTransferProjectsTransferConfigsRunsDelete name
  = BigQueryDataTransferProjectsTransferConfigsRunsDelete{xgafv =
                                                            Core.Nothing,
...
instance Core.GoogleRequest
           BigQueryDataTransferProjectsTransferConfigsRunsDelete
         where
        type Rs BigQueryDataTransferProjectsTransferConfigsRunsDelete =
             Empty
        type Scopes BigQueryDataTransferProjectsTransferConfigsRunsDelete =
