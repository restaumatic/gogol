           ...
           Core.QueryParam "access_token" Core.Text Core.:>
             Core.QueryParam "authorizationCode" Core.Text Core.:>
               Core.QueryParam "callback" Core.Text Core.:>
                 Core.QueryParam "serviceAccountName" Core.Text Core.:>
...
newBigQueryDataTransferProjectsTransferConfigsPatch name payload
  = BigQueryDataTransferProjectsTransferConfigsPatch{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           BigQueryDataTransferProjectsTransferConfigsPatch
         where
        type Rs BigQueryDataTransferProjectsTransferConfigsPatch =
             TransferConfig
        type Scopes BigQueryDataTransferProjectsTransferConfigsPatch =
             '[CloudPlatform'FullControl]
        requestClient BigQueryDataTransferProjectsTransferConfigsPatch{..}
          = go name xgafv accessToken authorizationCode callback
              serviceAccountName
              updateMask
              uploadType
              uploadProtocol
