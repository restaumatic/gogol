...
newBigQueryDataTransferProjectsTransferConfigsCreate parent payload
  = BigQueryDataTransferProjectsTransferConfigsCreate{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           BigQueryDataTransferProjectsTransferConfigsCreate
         where
        type Rs BigQueryDataTransferProjectsTransferConfigsCreate =
             TransferConfig
        type Scopes BigQueryDataTransferProjectsTransferConfigsCreate =
             '[CloudPlatform'FullControl]
        requestClient BigQueryDataTransferProjectsTransferConfigsCreate{..}
          = go parent xgafv accessToken authorizationCode callback
              serviceAccountName
              uploadType
              uploadProtocol
              versionInfo
