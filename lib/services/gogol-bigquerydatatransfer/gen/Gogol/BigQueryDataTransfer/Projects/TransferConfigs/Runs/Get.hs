...
newBigQueryDataTransferProjectsTransferConfigsRunsGet name
  = BigQueryDataTransferProjectsTransferConfigsRunsGet{xgafv =
                                                         Core.Nothing,
...
instance Core.GoogleRequest
           BigQueryDataTransferProjectsTransferConfigsRunsGet
         where
        type Rs BigQueryDataTransferProjectsTransferConfigsRunsGet =
             TransferRun
        type Scopes BigQueryDataTransferProjectsTransferConfigsRunsGet =
