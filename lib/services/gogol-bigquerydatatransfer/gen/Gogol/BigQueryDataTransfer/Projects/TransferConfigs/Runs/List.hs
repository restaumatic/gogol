               ...
               Core.QueryParam "callback" Core.Text Core.:>
                 Core.QueryParam "pageSize" Core.Int32 Core.:>
                   Core.QueryParam "pageToken" Core.Text Core.:>
                     Core.QueryParam "runAttempt"
                       ProjectsTransferConfigsRunsListRunAttempt
                       Core.:>
                       Core.QueryParams "states" ProjectsTransferConfigsRunsListStates
                         Core.:>
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Get '[Core.JSON] ListTransferRunsResponse
...
newBigQueryDataTransferProjectsTransferConfigsRunsList parent
  = BigQueryDataTransferProjectsTransferConfigsRunsList{xgafv =
                                                          Core.Nothing,
...
instance Core.GoogleRequest
           BigQueryDataTransferProjectsTransferConfigsRunsList
         where
        type Rs BigQueryDataTransferProjectsTransferConfigsRunsList =
             ListTransferRunsResponse
        type Scopes BigQueryDataTransferProjectsTransferConfigsRunsList =
