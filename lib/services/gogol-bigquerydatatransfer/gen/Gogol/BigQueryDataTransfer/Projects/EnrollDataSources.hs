...
type BigQueryDataTransferProjectsEnrollDataSourcesResource =
     "v1" Core.:>
       Core.CaptureMode "name" "enrollDataSources" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] EnrollDataSourcesRequest Core.:>
...
newBigQueryDataTransferProjectsEnrollDataSources name payload
  = BigQueryDataTransferProjectsEnrollDataSources{xgafv =
                                                    Core.Nothing,
...
instance Core.GoogleRequest
           BigQueryDataTransferProjectsEnrollDataSources
         where
        type Rs BigQueryDataTransferProjectsEnrollDataSources = Empty
        type Scopes BigQueryDataTransferProjectsEnrollDataSources =
             '[Bigquery'FullControl, CloudPlatform'FullControl]
        requestClient BigQueryDataTransferProjectsEnrollDataSources{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy BigQueryDataTransferProjectsEnrollDataSourcesResource)
                      Core.mempty
