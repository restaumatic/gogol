...
newRemoteConfig 
    ::  RemoteConfig
newRemoteConfig
  = RemoteConfig{conditions = Core.Nothing,
                 parameters = Core.Nothing}
instance Core.FromJSON RemoteConfig where
        parseJSON
          = Core.withObject "RemoteConfig"
              (\ o ->
                 RemoteConfig Core.<$>
                   (o Core..:? "conditions") Core.<*> (o Core..:? "parameters"))
...
instance Core.FromJSON RemoteConfig_Parameters where
        parseJSON
          = Core.withObject "RemoteConfig_Parameters"
...
newRemoteConfigCondition 
    ::  RemoteConfigCondition
newRemoteConfigCondition
  = RemoteConfigCondition{description = Core.Nothing,
                          expression = Core.Nothing, name = Core.Nothing,
                          tagColor = Core.Nothing}
instance Core.FromJSON RemoteConfigCondition where
        parseJSON
          = Core.withObject "RemoteConfigCondition"
              (\ o ->
                 RemoteConfigCondition Core.<$>
...
newRemoteConfigParameter 
    ::  RemoteConfigParameter
newRemoteConfigParameter
  = RemoteConfigParameter{conditionalValues = Core.Nothing,
                          defaultValue = Core.Nothing, description = Core.Nothing}
instance Core.FromJSON RemoteConfigParameter where
        parseJSON
          = Core.withObject "RemoteConfigParameter"
              (\ o ->
                 RemoteConfigParameter Core.<$>
                   (o Core..:? "conditionalValues") Core.<*>
                     (o Core..:? "defaultValue")
...
instance Core.FromJSON RemoteConfigParameter_ConditionalValues
         where
        parseJSON
          = Core.withObject "RemoteConfigParameter_ConditionalValues"
              (\ o ->
                 RemoteConfigParameter_ConditionalValues Core.<$>
...
newRemoteConfigParameterValue 
    ::  RemoteConfigParameterValue
newRemoteConfigParameterValue
  = RemoteConfigParameterValue{useInAppDefault = Core.Nothing,
                               value = Core.Nothing}
instance Core.FromJSON RemoteConfigParameterValue where
        parseJSON
          = Core.withObject "RemoteConfigParameterValue"
              (\ o ->
                 RemoteConfigParameterValue Core.<$>
                   (o Core..:? "useInAppDefault") Core.<*> (o Core..:? "value"))
