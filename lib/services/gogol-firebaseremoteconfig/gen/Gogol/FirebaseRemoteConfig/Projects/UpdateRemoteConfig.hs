                       ...
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "validateOnly" Core.Bool Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] RemoteConfig Core.:>
                               Core.Put '[Core.JSON] RemoteConfig
...
newFirebaseRemoteConfigProjectsUpdateRemoteConfig payload project
  = FirebaseRemoteConfigProjectsUpdateRemoteConfig{xgafv =
                                                     Core.Nothing,
                                                   accessToken = Core.Nothing,
                                                   bearerToken = Core.Nothing,
                                                   callback = Core.Nothing, payload = payload,
                                                   pp = Core.True, project = project,
