...
newAccessContextManagerAccessPoliciesDelete name
  = AccessContextManagerAccessPoliciesDelete{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           AccessContextManagerAccessPoliciesDelete
         where
        type Rs AccessContextManagerAccessPoliciesDelete = Operation
        type Scopes AccessContextManagerAccessPoliciesDelete =
             '[CloudPlatform'FullControl]
        requestClient AccessContextManagerAccessPoliciesDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AccessContextManagerAccessPoliciesDeleteResource)
                      Core.mempty
