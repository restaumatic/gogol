...
newAccessContextManagerAccessPoliciesAuthorizedOrgsDescsPatch 
    ...
    -> AccessContextManagerAccessPoliciesAuthorizedOrgsDescsPatch
newAccessContextManagerAccessPoliciesAuthorizedOrgsDescsPatch name
  payload
  = AccessContextManagerAccessPoliciesAuthorizedOrgsDescsPatch{xgafv
                                                                 = Core.Nothing,
...
instance Core.GoogleRequest
           AccessContextManagerAccessPoliciesAuthorizedOrgsDescsPatch
         where
        type Rs AccessContextManagerAccessPoliciesAuthorizedOrgsDescsPatch
             = Operation
        type Scopes
               AccessContextManagerAccessPoliciesAuthorizedOrgsDescsPatch
