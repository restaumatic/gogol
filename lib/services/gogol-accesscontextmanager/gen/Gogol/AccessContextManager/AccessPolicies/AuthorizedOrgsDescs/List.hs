                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] ListAuthorizedOrgsDescsResponse
...
newAccessContextManagerAccessPoliciesAuthorizedOrgsDescsList parent
  = AccessContextManagerAccessPoliciesAuthorizedOrgsDescsList{xgafv =
                                                                Core.Nothing,
...
instance Core.GoogleRequest
           AccessContextManagerAccessPoliciesAuthorizedOrgsDescsList
         where
        type Rs AccessContextManagerAccessPoliciesAuthorizedOrgsDescsList =
