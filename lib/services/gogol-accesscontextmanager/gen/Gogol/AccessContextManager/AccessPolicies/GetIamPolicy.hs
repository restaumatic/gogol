...
newAccessContextManagerAccessPoliciesGetIamPolicy payload resource
  = AccessContextManagerAccessPoliciesGetIamPolicy{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           AccessContextManagerAccessPoliciesGetIamPolicy
         where
        type Rs AccessContextManagerAccessPoliciesGetIamPolicy = Policy
        type Scopes AccessContextManagerAccessPoliciesGetIamPolicy =
             '[CloudPlatform'FullControl]
        requestClient AccessContextManagerAccessPoliciesGetIamPolicy{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AccessContextManagerAccessPoliciesGetIamPolicyResource)
                      Core.mempty
