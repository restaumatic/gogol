...
newAccessContextManagerAccessPoliciesServicePerimetersGet name
  = AccessContextManagerAccessPoliciesServicePerimetersGet{xgafv =
                                                             Core.Nothing,
...
instance Core.GoogleRequest
           AccessContextManagerAccessPoliciesServicePerimetersGet
         where
        type Rs AccessContextManagerAccessPoliciesServicePerimetersGet =
             ServicePerimeter
        type Scopes AccessContextManagerAccessPoliciesServicePerimetersGet
