                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] ListServicePerimetersResponse
...
newAccessContextManagerAccessPoliciesServicePerimetersList parent
  = AccessContextManagerAccessPoliciesServicePerimetersList{xgafv =
                                                              Core.Nothing,
...
instance Core.GoogleRequest
           AccessContextManagerAccessPoliciesServicePerimetersList
         where
        type Rs AccessContextManagerAccessPoliciesServicePerimetersList =
             ListServicePerimetersResponse
        type Scopes AccessContextManagerAccessPoliciesServicePerimetersList
