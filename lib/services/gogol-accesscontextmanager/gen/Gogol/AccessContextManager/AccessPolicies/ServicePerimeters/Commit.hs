                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] CommitServicePerimetersRequest Core.:>
...
newAccessContextManagerAccessPoliciesServicePerimetersCommit 
    ...
    -> AccessContextManagerAccessPoliciesServicePerimetersCommit
newAccessContextManagerAccessPoliciesServicePerimetersCommit parent
  payload
  = AccessContextManagerAccessPoliciesServicePerimetersCommit{xgafv =
                                                                Core.Nothing,
...
instance Core.GoogleRequest
           AccessContextManagerAccessPoliciesServicePerimetersCommit
         where
        type Rs AccessContextManagerAccessPoliciesServicePerimetersCommit =
             Operation
        type Scopes
               AccessContextManagerAccessPoliciesServicePerimetersCommit
