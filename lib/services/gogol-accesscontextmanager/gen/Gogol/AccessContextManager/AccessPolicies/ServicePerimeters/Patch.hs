...
newAccessContextManagerAccessPoliciesServicePerimetersPatch 
    :: 
                                                            Core.Text
       -- ^  Identifier. Resource name for the @ServicePerimeter@. Format: @accessPolicies\/{access_policy}\/servicePerimeters\/{service_perimeter}@. The @service_perimeter@ component must begin with a letter, followed by alphanumeric characters or @_@. After you create a @ServicePerimeter@, you cannot change its @name@. See 'name'.
    -> ServicePerimeter
       -- ^  Multipart request metadata. See 'payload'.
    -> AccessContextManagerAccessPoliciesServicePerimetersPatch
newAccessContextManagerAccessPoliciesServicePerimetersPatch name
  payload
  = AccessContextManagerAccessPoliciesServicePerimetersPatch{xgafv =
                                                               Core.Nothing,
