...
newAccessContextManagerAccessPoliciesServicePerimetersCreate 
    ...
    -> AccessContextManagerAccessPoliciesServicePerimetersCreate
newAccessContextManagerAccessPoliciesServicePerimetersCreate parent
  payload
  = AccessContextManagerAccessPoliciesServicePerimetersCreate{xgafv =
                                                                Core.Nothing,
...
instance Core.GoogleRequest
           AccessContextManagerAccessPoliciesServicePerimetersCreate
         where
        type Rs AccessContextManagerAccessPoliciesServicePerimetersCreate =
             Operation
        type Scopes
               AccessContextManagerAccessPoliciesServicePerimetersCreate
