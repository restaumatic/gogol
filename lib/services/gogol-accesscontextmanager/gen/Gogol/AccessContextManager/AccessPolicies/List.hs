                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] ListAccessPoliciesResponse
...
newAccessContextManagerAccessPoliciesList 
    :: 
                                          AccessContextManagerAccessPoliciesList
newAccessContextManagerAccessPoliciesList
  = AccessContextManagerAccessPoliciesList{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           pageSize = Core.Nothing, pageToken = Core.Nothing,
                                           parent = Core.Nothing, uploadType = Core.Nothing,
                                           uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AccessContextManagerAccessPoliciesList
         where
        type Rs AccessContextManagerAccessPoliciesList =
             ListAccessPoliciesResponse
        type Scopes AccessContextManagerAccessPoliciesList =
             '[CloudPlatform'FullControl]
        requestClient AccessContextManagerAccessPoliciesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AccessContextManagerAccessPoliciesListResource)
                      Core.mempty
