...
newAccessContextManagerAccessPoliciesGet name
  = AccessContextManagerAccessPoliciesGet{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          name = name, uploadType = Core.Nothing,
                                          uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AccessContextManagerAccessPoliciesGet
         where
        type Rs AccessContextManagerAccessPoliciesGet = AccessPolicy
        type Scopes AccessContextManagerAccessPoliciesGet =
             '[CloudPlatform'FullControl]
        requestClient AccessContextManagerAccessPoliciesGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AccessContextManagerAccessPoliciesGetResource)
                      Core.mempty
