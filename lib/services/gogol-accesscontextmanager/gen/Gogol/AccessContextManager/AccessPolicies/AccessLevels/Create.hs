...
-- |
-- Module      : Gogol.AccessContextManager.AccessPolicies.AccessLevels.Create
...
newAccessContextManagerAccessPoliciesAccessLevelsCreate 
    ...
    -> AccessContextManagerAccessPoliciesAccessLevelsCreate
newAccessContextManagerAccessPoliciesAccessLevelsCreate parent
  payload
  = AccessContextManagerAccessPoliciesAccessLevelsCreate{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           AccessContextManagerAccessPoliciesAccessLevelsCreate
         where
        type Rs AccessContextManagerAccessPoliciesAccessLevelsCreate =
             Operation
        type Scopes AccessContextManagerAccessPoliciesAccessLevelsCreate =
