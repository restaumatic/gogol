...
newAccessContextManagerAccessPoliciesAccessLevelsDelete name
  = AccessContextManagerAccessPoliciesAccessLevelsDelete{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           AccessContextManagerAccessPoliciesAccessLevelsDelete
         where
        type Rs AccessContextManagerAccessPoliciesAccessLevelsDelete =
             Operation
        type Scopes AccessContextManagerAccessPoliciesAccessLevelsDelete =
