       ...
       Core.Capture "parent" Core.Text Core.:>
         "accessLevels" Core.:>
           Core.QueryParam "$.xgafv" Xgafv Core.:>
             Core.QueryParam "accessLevelFormat"
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] ListAccessLevelsResponse
...
newAccessContextManagerAccessPoliciesAccessLevelsList parent
  = AccessContextManagerAccessPoliciesAccessLevelsList{xgafv =
                                                         Core.Nothing,
...
instance Core.GoogleRequest
           AccessContextManagerAccessPoliciesAccessLevelsList
         where
        type Rs AccessContextManagerAccessPoliciesAccessLevelsList =
             ListAccessLevelsResponse
        type Scopes AccessContextManagerAccessPoliciesAccessLevelsList =
             '[CloudPlatform'FullControl]
        requestClient
          AccessContextManagerAccessPoliciesAccessLevelsList{..}
          = go parent xgafv accessLevelFormat accessToken callback pageSize
              pageToken
              uploadType
              uploadProtocol
