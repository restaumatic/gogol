                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.Get '[Core.JSON] AccessLevel
...
newAccessContextManagerAccessPoliciesAccessLevelsGet name
  = AccessContextManagerAccessPoliciesAccessLevelsGet{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           AccessContextManagerAccessPoliciesAccessLevelsGet
         where
        type Rs AccessContextManagerAccessPoliciesAccessLevelsGet =
             AccessLevel
        type Scopes AccessContextManagerAccessPoliciesAccessLevelsGet =
             '[CloudPlatform'FullControl]
        requestClient AccessContextManagerAccessPoliciesAccessLevelsGet{..}
          = go name xgafv accessLevelFormat accessToken callback uploadType
              uploadProtocol
