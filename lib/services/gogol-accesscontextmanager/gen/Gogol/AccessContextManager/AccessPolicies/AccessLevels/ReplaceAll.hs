...
-- |
-- Module      : Gogol.AccessContextManager.AccessPolicies.AccessLevels.ReplaceAll
                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] ReplaceAccessLevelsRequest Core.:>
...
newAccessContextManagerAccessPoliciesAccessLevelsReplaceAll 
    ...
    -> AccessContextManagerAccessPoliciesAccessLevelsReplaceAll
newAccessContextManagerAccessPoliciesAccessLevelsReplaceAll parent
  payload
  = AccessContextManagerAccessPoliciesAccessLevelsReplaceAll{xgafv =
                                                               Core.Nothing,
...
instance Core.GoogleRequest
           AccessContextManagerAccessPoliciesAccessLevelsReplaceAll
         where
        type Rs AccessContextManagerAccessPoliciesAccessLevelsReplaceAll =
             Operation
        type Scopes
               AccessContextManagerAccessPoliciesAccessLevelsReplaceAll
