...
newAccessContextManagerAccessPoliciesTestIamPermissions 
    ...
    -> AccessContextManagerAccessPoliciesTestIamPermissions
newAccessContextManagerAccessPoliciesTestIamPermissions payload
  resource
  = AccessContextManagerAccessPoliciesTestIamPermissions{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           AccessContextManagerAccessPoliciesTestIamPermissions
         where
        type Rs AccessContextManagerAccessPoliciesTestIamPermissions =
             TestIamPermissionsResponse
        type Scopes AccessContextManagerAccessPoliciesTestIamPermissions =
