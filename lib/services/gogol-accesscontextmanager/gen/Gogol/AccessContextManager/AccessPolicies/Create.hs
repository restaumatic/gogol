...
newAccessContextManagerAccessPoliciesCreate payload
  = AccessContextManagerAccessPoliciesCreate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           AccessContextManagerAccessPoliciesCreate
         where
        type Rs AccessContextManagerAccessPoliciesCreate = Operation
        type Scopes AccessContextManagerAccessPoliciesCreate =
             '[CloudPlatform'FullControl]
        requestClient AccessContextManagerAccessPoliciesCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AccessContextManagerAccessPoliciesCreateResource)
                      Core.mempty
