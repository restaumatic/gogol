                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] ListGcpUserAccessBindingsResponse
...
newAccessContextManagerOrganizationsGcpUserAccessBindingsList
  parent
  = AccessContextManagerOrganizationsGcpUserAccessBindingsList{xgafv
                                                                 = Core.Nothing,
...
instance Core.GoogleRequest
           AccessContextManagerOrganizationsGcpUserAccessBindingsList
         where
        type Rs AccessContextManagerOrganizationsGcpUserAccessBindingsList
