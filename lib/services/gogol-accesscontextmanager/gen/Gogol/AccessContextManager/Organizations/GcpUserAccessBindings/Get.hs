               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.Get '[Core.JSON] GcpUserAccessBinding
...
newAccessContextManagerOrganizationsGcpUserAccessBindingsGet name
  = AccessContextManagerOrganizationsGcpUserAccessBindingsGet{xgafv =
                                                                Core.Nothing,
...
instance Core.GoogleRequest
           AccessContextManagerOrganizationsGcpUserAccessBindingsGet
         where
        type Rs AccessContextManagerOrganizationsGcpUserAccessBindingsGet =
