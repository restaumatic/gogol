                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] GcpUserAccessBinding Core.:>
...
data AccessContextManagerOrganizationsGcpUserAccessBindingsPatch = AccessContextManagerOrganizationsGcpUserAccessBindingsPatch
    ...
    , payload :: GcpUserAccessBinding
      -- | Required. Only the fields specified in this mask are updated. Because name and group/key cannot be changed, update/mask is required and may only contain the following fields: @access_levels@, @dry_run_access_levels@, @session_settings@, @scoped_access_settings@. update/mask { paths: \"access/levels\" }
...
newAccessContextManagerOrganizationsGcpUserAccessBindingsPatch 
    ...
    -> AccessContextManagerOrganizationsGcpUserAccessBindingsPatch
newAccessContextManagerOrganizationsGcpUserAccessBindingsPatch name
  payload
  = AccessContextManagerOrganizationsGcpUserAccessBindingsPatch{xgafv
                                                                  = Core.Nothing,
...
instance Core.GoogleRequest
           AccessContextManagerOrganizationsGcpUserAccessBindingsPatch
         where
        type Rs AccessContextManagerOrganizationsGcpUserAccessBindingsPatch
             = Operation
        type Scopes
               AccessContextManagerOrganizationsGcpUserAccessBindingsPatch
        ...
        requestClient
          AccessContextManagerOrganizationsGcpUserAccessBindingsPatch{..}
          = go name xgafv accessToken append callback updateMask uploadType
              uploadProtocol
