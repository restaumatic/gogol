...
-- |
-- Module      : Gogol.AccessContextManager.Operations.Get
...
newAccessContextManagerOperationsGet name
  = AccessContextManagerOperationsGet{xgafv = Core.Nothing,
                                      accessToken = Core.Nothing, callback = Core.Nothing,
                                      name = name, uploadType = Core.Nothing,
                                      uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AccessContextManagerOperationsGet where
        type Rs AccessContextManagerOperationsGet = Operation
        type Scopes AccessContextManagerOperationsGet =
