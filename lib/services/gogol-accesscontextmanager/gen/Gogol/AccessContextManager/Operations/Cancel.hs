...
newAccessContextManagerOperationsCancel name payload
  = AccessContextManagerOperationsCancel{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         name = name, payload = payload, uploadType = Core.Nothing,
                                         uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AccessContextManagerOperationsCancel
         where
        type Rs AccessContextManagerOperationsCancel = Empty
        type Scopes AccessContextManagerOperationsCancel =
             '[CloudPlatform'FullControl]
        requestClient AccessContextManagerOperationsCancel{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AccessContextManagerOperationsCancelResource)
                      Core.mempty
