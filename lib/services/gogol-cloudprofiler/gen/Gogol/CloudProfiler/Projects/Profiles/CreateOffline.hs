...
newCloudProfilerProjectsProfilesCreateOffline parent payload
  = CloudProfilerProjectsProfilesCreateOffline{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           CloudProfilerProjectsProfilesCreateOffline
         where
        type Rs CloudProfilerProjectsProfilesCreateOffline = Profile
        type Scopes CloudProfilerProjectsProfilesCreateOffline =
             '[CloudPlatform'FullControl, Monitoring'FullControl,
               Monitoring'Write]
        requestClient CloudProfilerProjectsProfilesCreateOffline{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudProfilerProjectsProfilesCreateOfflineResource)
                      Core.mempty
