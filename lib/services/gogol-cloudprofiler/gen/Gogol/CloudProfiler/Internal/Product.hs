...
newCreateProfileRequest 
    ::  CreateProfileRequest
newCreateProfileRequest
  = CreateProfileRequest{deployment = Core.Nothing,
          ...
          = Core.withObject "CreateProfileRequest"
              (\ o ->
                 CreateProfileRequest Core.<$>
                   (o Core..:? "deployment") Core.<*> (o Core..:? "profileType"))
...
newDeployment 
    ::  Deployment
newDeployment
  = Deployment{labels = Core.Nothing, projectId = Core.Nothing,
               target = Core.Nothing}
instance Core.FromJSON Deployment where
        parseJSON
          = Core.withObject "Deployment"
              (\ o ->
                 Deployment Core.<$>
                   (o Core..:? "labels") Core.<*> (o Core..:? "projectId") Core.<*>
                     (o Core..:? "target"))
...
newListProfilesResponse 
    ::  ListProfilesResponse
newListProfilesResponse
  = ListProfilesResponse{nextPageToken = Core.Nothing,
                         profiles = Core.Nothing, skippedProfiles = Core.Nothing}
instance Core.FromJSON ListProfilesResponse where
        parseJSON
          = Core.withObject "ListProfilesResponse"
              (\ o ->
                 ListProfilesResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "profiles")
...
newProfile 
    ::  Profile
newProfile
  = Profile{deployment = Core.Nothing, duration = Core.Nothing,
            labels = Core.Nothing, name = Core.Nothing,
            profileBytes = Core.Nothing, profileType = Core.Nothing,
...
instance Core.FromJSON Profile where
        parseJSON
          = Core.withObject "Profile"
              (\ o ->
                 Profile Core.<$>
                   (o Core..:? "deployment") Core.<*> (o Core..:? "duration") Core.<*>
                     (o Core..:? "labels")
                     Core.<*> (o Core..:? "name")
