...
newCreateAuthUriResponse 
    ::  CreateAuthUriResponse
newCreateAuthUriResponse
  = CreateAuthUriResponse{allProviders = Core.Nothing,
                          authUri = Core.Nothing, captchaRequired = Core.Nothing,
                          forExistingProvider = Core.Nothing,
                          kind = "identitytoolkit#CreateAuthUriResponse",
                          providerId = Core.Nothing, registered = Core.Nothing,
                          sessionId = Core.Nothing, signinMethods = Core.Nothing}
instance Core.FromJSON CreateAuthUriResponse where
        parseJSON
          = Core.withObject "CreateAuthUriResponse"
              (\ o ->
                 CreateAuthUriResponse Core.<$>
                   (o Core..:? "allProviders") Core.<*> (o Core..:? "authUri")
          ...
          = Core.object
              (Core.catMaybes
                 [("allProviders" Core..=) Core.<$> allProviders,
                  ...
                  ("forExistingProvider" Core..=) Core.<$> forExistingProvider,
...
newDeleteAccountResponse 
    ::  DeleteAccountResponse
newDeleteAccountResponse
  = DeleteAccountResponse{kind =
                            "identitytoolkit#DeleteAccountResponse"}
instance Core.FromJSON DeleteAccountResponse where
        parseJSON
          = Core.withObject "DeleteAccountResponse"
              (\ o ->
                 DeleteAccountResponse Core.<$>
                   (o Core..:? "kind" Core..!=
                      "identitytoolkit#DeleteAccountResponse"))
...
newDownloadAccountResponse 
    ::  DownloadAccountResponse
newDownloadAccountResponse
  = DownloadAccountResponse{kind =
                              "identitytoolkit#DownloadAccountResponse",
                            nextPageToken = Core.Nothing, users = Core.Nothing}
instance Core.FromJSON DownloadAccountResponse where
        parseJSON
          = Core.withObject "DownloadAccountResponse"
              (\ o ->
                 DownloadAccountResponse Core.<$>
                   (o Core..:? "kind" Core..!=
                      "identitytoolkit#DownloadAccountResponse")
...
newEmailTemplate 
    ::  EmailTemplate
newEmailTemplate
  = EmailTemplate{body = Core.Nothing, format = Core.Nothing,
                  from = Core.Nothing, fromDisplayName = Core.Nothing,
                  replyTo = Core.Nothing, subject = Core.Nothing}
instance Core.FromJSON EmailTemplate where
        parseJSON
          = Core.withObject "EmailTemplate"
              (\ o ->
                 EmailTemplate Core.<$>
                   (o Core..:? "body") Core.<*> (o Core..:? "format") Core.<*>
                     (o Core..:? "from")
...
instance Core.ToJSON EmailTemplate where
        toJSON EmailTemplate{..}
          = Core.object
              (Core.catMaybes
                 [("body" Core..=) Core.<$> body,
                  ("format" Core..=) Core.<$> format, ("from" Core..=) Core.<$> from,
...
newGetAccountInfoResponse 
    ::  GetAccountInfoResponse
newGetAccountInfoResponse
  = GetAccountInfoResponse{kind =
                             "identitytoolkit#GetAccountInfoResponse",
                           users = Core.Nothing}
instance Core.FromJSON GetAccountInfoResponse where
        parseJSON
          = Core.withObject "GetAccountInfoResponse"
              (\ o ->
                 GetAccountInfoResponse Core.<$>
                   (o Core..:? "kind" Core..!=
                      "identitytoolkit#GetAccountInfoResponse")
                     Core.<*> (o Core..:? "users"))
...
newGetOobConfirmationCodeResponse 
    ::  GetOobConfirmationCodeResponse
newGetOobConfirmationCodeResponse
  = GetOobConfirmationCodeResponse{email = Core.Nothing,
                                   kind = "identitytoolkit#GetOobConfirmationCodeResponse",
                                   oobCode = Core.Nothing}
instance Core.FromJSON GetOobConfirmationCodeResponse where
        parseJSON
          = Core.withObject "GetOobConfirmationCodeResponse"
              (\ o ->
                 GetOobConfirmationCodeResponse Core.<$>
                   (o Core..:? "email") Core.<*>
                     (o Core..:? "kind" Core..!=
...
instance Core.ToJSON GetOobConfirmationCodeResponse where
        toJSON GetOobConfirmationCodeResponse{..}
          = Core.object
              (Core.catMaybes
                 [("email" Core..=) Core.<$> email, Core.Just ("kind" Core..= kind),
...
newGetRecaptchaParamResponse 
    ::  GetRecaptchaParamResponse
newGetRecaptchaParamResponse
  = GetRecaptchaParamResponse{kind =
                                "identitytoolkit#GetRecaptchaParamResponse",
                              recaptchaSiteKey = Core.Nothing, recaptchaStoken = Core.Nothing}
instance Core.FromJSON GetRecaptchaParamResponse where
        parseJSON
          = Core.withObject "GetRecaptchaParamResponse"
              (\ o ->
                 GetRecaptchaParamResponse Core.<$>
                   (o Core..:? "kind" Core..!=
                      "identitytoolkit#GetRecaptchaParamResponse")
...
instance Core.ToJSON GetRecaptchaParamResponse where
        toJSON GetRecaptchaParamResponse{..}
          = Core.object
              (Core.catMaybes
                 [Core.Just ("kind" Core..= kind),
                  ("recaptchaSiteKey" Core..=) Core.<$> recaptchaSiteKey,
                  ("recaptchaStoken" Core..=) Core.<$> recaptchaStoken])
...
newIdentitytoolkitRelyingpartyCreateAuthUriRequest 
    :: 
                                                   IdentitytoolkitRelyingpartyCreateAuthUriRequest
newIdentitytoolkitRelyingpartyCreateAuthUriRequest
  = IdentitytoolkitRelyingpartyCreateAuthUriRequest{appId =
                                                      Core.Nothing,
                                                    authFlowType = Core.Nothing,
                                                    clientId = Core.Nothing, context = Core.Nothing,
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "IdentitytoolkitRelyingpartyCreateAuthUriRequest"
              (\ o ->
                 IdentitytoolkitRelyingpartyCreateAuthUriRequest Core.<$>
                   (o Core..:? "appId") Core.<*> (o Core..:? "authFlowType") Core.<*>
                     (o Core..:? "clientId")
                     Core.<*> (o Core..:? "context")
          ...
          = Core.object
              (Core.catMaybes
                 [("appId" Core..=) Core.<$> appId,
                  ...
                  ("oauthConsumerKey" Core..=) Core.<$> oauthConsumerKey,
...
newIdentitytoolkitRelyingpartyCreateAuthUriRequest_CustomParameter 
    :: 
       ...
       -- ^  The customized query parameter. See 'additional'.
    -> IdentitytoolkitRelyingpartyCreateAuthUriRequest_CustomParameter
newIdentitytoolkitRelyingpartyCreateAuthUriRequest_CustomParameter
  additional
  = IdentitytoolkitRelyingpartyCreateAuthUriRequest_CustomParameter{additional
                                                                      = additional}
instance Core.FromJSON
           IdentitytoolkitRelyingpartyCreateAuthUriRequest_CustomParameter
         where
...
newIdentitytoolkitRelyingpartyDeleteAccountRequest 
    :: 
                                                   IdentitytoolkitRelyingpartyDeleteAccountRequest
newIdentitytoolkitRelyingpartyDeleteAccountRequest
  = IdentitytoolkitRelyingpartyDeleteAccountRequest{delegatedProjectNumber
                                                      = Core.Nothing,
                                                    idToken = Core.Nothing, localId = Core.Nothing}
instance Core.FromJSON
           IdentitytoolkitRelyingpartyDeleteAccountRequest
         where
        parseJSON
          = Core.withObject "IdentitytoolkitRelyingpartyDeleteAccountRequest"
              (\ o ->
                 IdentitytoolkitRelyingpartyDeleteAccountRequest Core.<$>
                   (o Core..:? "delegatedProjectNumber" Core.<&>
                      Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "idToken")
                     Core.<*> (o Core..:? "localId"))
...
instance Core.ToJSON
        ...
        toJSON IdentitytoolkitRelyingpartyDeleteAccountRequest{..}
          = Core.object
              (Core.catMaybes
                 [("delegatedProjectNumber" Core..=) Core.. Core.AsText Core.<$>
...
newIdentitytoolkitRelyingpartyDownloadAccountRequest 
    :: 
                                                     IdentitytoolkitRelyingpartyDownloadAccountRequest
newIdentitytoolkitRelyingpartyDownloadAccountRequest
  = IdentitytoolkitRelyingpartyDownloadAccountRequest{delegatedProjectNumber
                                                        = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "IdentitytoolkitRelyingpartyDownloadAccountRequest"
              (\ o ->
                 IdentitytoolkitRelyingpartyDownloadAccountRequest Core.<$>
                   (o Core..:? "delegatedProjectNumber" Core.<&>
                      Core.fmap Core.fromAsText)
...
newIdentitytoolkitRelyingpartyEmailLinkSigninRequest 
    :: 
                                                     IdentitytoolkitRelyingpartyEmailLinkSigninRequest
newIdentitytoolkitRelyingpartyEmailLinkSigninRequest
  = IdentitytoolkitRelyingpartyEmailLinkSigninRequest{email =
                                                        Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "IdentitytoolkitRelyingpartyEmailLinkSigninRequest"
              (\ o ->
                 IdentitytoolkitRelyingpartyEmailLinkSigninRequest Core.<$>
                   (o Core..:? "email") Core.<*> (o Core..:? "idToken") Core.<*>
                     (o Core..:? "oobCode"))

instance Core.ToJSON
           IdentitytoolkitRelyingpartyEmailLinkSigninRequest
         where
        toJSON IdentitytoolkitRelyingpartyEmailLinkSigninRequest{..}
          = Core.object
              (Core.catMaybes
                 [("email" Core..=) Core.<$> email,
                  ("idToken" Core..=) Core.<$> idToken,
...
newIdentitytoolkitRelyingpartyGetAccountInfoRequest 
    :: 
                                                    IdentitytoolkitRelyingpartyGetAccountInfoRequest
newIdentitytoolkitRelyingpartyGetAccountInfoRequest
  = IdentitytoolkitRelyingpartyGetAccountInfoRequest{delegatedProjectNumber
                                                       = Core.Nothing,
                                                     email = Core.Nothing, idToken = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "IdentitytoolkitRelyingpartyGetAccountInfoRequest"
              (\ o ->
                 IdentitytoolkitRelyingpartyGetAccountInfoRequest Core.<$>
                   (o Core..:? "delegatedProjectNumber" Core.<&>
                      Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "email")
                     Core.<*> (o Core..:? "idToken")
...
newIdentitytoolkitRelyingpartyGetProjectConfigResponse 
    :: 
                                                       IdentitytoolkitRelyingpartyGetProjectConfigResponse
newIdentitytoolkitRelyingpartyGetProjectConfigResponse
  = IdentitytoolkitRelyingpartyGetProjectConfigResponse{allowPasswordUser
                                                          = Core.Nothing,
                                                        apiKey = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "IdentitytoolkitRelyingpartyGetProjectConfigResponse"
              (\ o ->
                 IdentitytoolkitRelyingpartyGetProjectConfigResponse Core.<$>
                   (o Core..:? "allowPasswordUser") Core.<*> (o Core..:? "apiKey")
...
instance Core.ToJSON
        ...
        toJSON IdentitytoolkitRelyingpartyGetProjectConfigResponse{..}
          = Core.object
              (Core.catMaybes
                 [("allowPasswordUser" Core..=) Core.<$> allowPasswordUser,
                  ("apiKey" Core..=) Core.<$> apiKey,
                  ("authorizedDomains" Core..=) Core.<$> authorizedDomains,
                  ("changeEmailTemplate" Core..=) Core.<$> changeEmailTemplate,
                  ("dynamicLinksDomain" Core..=) Core.<$> dynamicLinksDomain,
                  ("enableAnonymousUser" Core..=) Core.<$> enableAnonymousUser,
                  ("idpConfig" Core..=) Core.<$> idpConfig,
                  ("legacyResetPasswordTemplate" Core..=) Core.<$>
                    legacyResetPasswordTemplate,
                  ("projectId" Core..=) Core.<$> projectId,
                  ("resetPasswordTemplate" Core..=) Core.<$> resetPasswordTemplate,
                  ("useEmailSending" Core..=) Core.<$> useEmailSending,
                  ("verifyEmailTemplate" Core..=) Core.<$> verifyEmailTemplate])
...
newIdentitytoolkitRelyingpartyGetPublicKeysResponse 
    :: 
       ...
       -- ^  See 'additional'.
    -> IdentitytoolkitRelyingpartyGetPublicKeysResponse
newIdentitytoolkitRelyingpartyGetPublicKeysResponse additional
  = IdentitytoolkitRelyingpartyGetPublicKeysResponse{additional =
                                                       additional}
instance Core.FromJSON
           IdentitytoolkitRelyingpartyGetPublicKeysResponse
         where
        parseJSON
          = Core.withObject
              "IdentitytoolkitRelyingpartyGetPublicKeysResponse"
              (\ o ->
                 IdentitytoolkitRelyingpartyGetPublicKeysResponse Core.<$>
...
newIdentitytoolkitRelyingpartyResetPasswordRequest 
    :: 
                                                   IdentitytoolkitRelyingpartyResetPasswordRequest
newIdentitytoolkitRelyingpartyResetPasswordRequest
  = IdentitytoolkitRelyingpartyResetPasswordRequest{email =
                                                      Core.Nothing,
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "IdentitytoolkitRelyingpartyResetPasswordRequest"
              (\ o ->
                 IdentitytoolkitRelyingpartyResetPasswordRequest Core.<$>
                   (o Core..:? "email") Core.<*> (o Core..:? "newPassword") Core.<*>
                     (o Core..:? "oldPassword")
                     Core.<*> (o Core..:? "oobCode"))
...
newIdentitytoolkitRelyingpartySendVerificationCodeRequest 
    :: 
                                                          IdentitytoolkitRelyingpartySendVerificationCodeRequest
newIdentitytoolkitRelyingpartySendVerificationCodeRequest
  = IdentitytoolkitRelyingpartySendVerificationCodeRequest{iosReceipt
                                                             = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "IdentitytoolkitRelyingpartySendVerificationCodeRequest"
              (\ o ->
                 IdentitytoolkitRelyingpartySendVerificationCodeRequest Core.<$>
                   (o Core..:? "iosReceipt") Core.<*> (o Core..:? "iosSecret")
                     Core.<*> (o Core..:? "phoneNumber")
...
instance Core.ToJSON
           IdentitytoolkitRelyingpartySendVerificationCodeRequest
         where
        toJSON IdentitytoolkitRelyingpartySendVerificationCodeRequest{..}
          = Core.object
              (Core.catMaybes
...
newIdentitytoolkitRelyingpartySendVerificationCodeResponse 
    :: 
                                                           IdentitytoolkitRelyingpartySendVerificationCodeResponse
newIdentitytoolkitRelyingpartySendVerificationCodeResponse
  = IdentitytoolkitRelyingpartySendVerificationCodeResponse{sessionInfo
                                                              = Core.Nothing}
instance Core.FromJSON
           IdentitytoolkitRelyingpartySendVerificationCodeResponse
         where
        parseJSON
          = Core.withObject
              "IdentitytoolkitRelyingpartySendVerificationCodeResponse"
              (\ o ->
                 IdentitytoolkitRelyingpartySendVerificationCodeResponse Core.<$>
                   (o Core..:? "sessionInfo"))

instance Core.ToJSON
           IdentitytoolkitRelyingpartySendVerificationCodeResponse
         where
        toJSON IdentitytoolkitRelyingpartySendVerificationCodeResponse{..}
          = Core.object
              (Core.catMaybes [("sessionInfo" Core..=) Core.<$> sessionInfo])
...
newIdentitytoolkitRelyingpartySetAccountInfoRequest 
    :: 
                                                    IdentitytoolkitRelyingpartySetAccountInfoRequest
newIdentitytoolkitRelyingpartySetAccountInfoRequest
  = IdentitytoolkitRelyingpartySetAccountInfoRequest{captchaChallenge
                                                       = Core.Nothing,
                                                     ...
                                                     localId = Core.Nothing, oobCode = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "IdentitytoolkitRelyingpartySetAccountInfoRequest"
              (\ o ->
                 IdentitytoolkitRelyingpartySetAccountInfoRequest Core.<$>
                   (o Core..:? "captchaChallenge") Core.<*>
                     (o Core..:? "captchaResponse")
                     Core.<*>
                     (o Core..:? "createdAt" Core.<&> Core.fmap Core.fromAsText)
                     ...
                     Core.<*>
                     (o Core..:? "lastLoginAt" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "localId")
                     Core.<*> (o Core..:? "oobCode")
                     ...
                     Core.<*>
                     (o Core..:? "validSince" Core.<&> Core.fmap Core.fromAsText))
...
instance Core.ToJSON
        ...
        toJSON IdentitytoolkitRelyingpartySetAccountInfoRequest{..}
          = Core.object
              (Core.catMaybes
                 [("captchaChallenge" Core..=) Core.<$> captchaChallenge,
                  ("captchaResponse" Core..=) Core.<$> captchaResponse,
                  ("createdAt" Core..=) Core.. Core.AsText Core.<$> createdAt,
                  ...
                  ("lastLoginAt" Core..=) Core.. Core.AsText Core.<$> lastLoginAt,
                  ("localId" Core..=) Core.<$> localId,
                  ("oobCode" Core..=) Core.<$> oobCode,
                  ...
                  ("returnSecureToken" Core..=) Core.<$> returnSecureToken,
                  ("upgradeToFederatedLogin" Core..=) Core.<$>
                    upgradeToFederatedLogin,
                  ("validSince" Core..=) Core.. Core.AsText Core.<$> validSince])
...
newIdentitytoolkitRelyingpartySetProjectConfigRequest 
    :: 
                                                      IdentitytoolkitRelyingpartySetProjectConfigRequest
newIdentitytoolkitRelyingpartySetProjectConfigRequest
  = IdentitytoolkitRelyingpartySetProjectConfigRequest{allowPasswordUser
                                                         = Core.Nothing,
                                                       apiKey = Core.Nothing,
                                                       authorizedDomains = Core.Nothing,
                                                       changeEmailTemplate = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "IdentitytoolkitRelyingpartySetProjectConfigRequest"
              (\ o ->
                 IdentitytoolkitRelyingpartySetProjectConfigRequest Core.<$>
                   (o Core..:? "allowPasswordUser") Core.<*> (o Core..:? "apiKey")
                     Core.<*> (o Core..:? "authorizedDomains")
                     Core.<*> (o Core..:? "changeEmailTemplate")
                     Core.<*>
...
newIdentitytoolkitRelyingpartySetProjectConfigResponse 
    :: 
                                                       IdentitytoolkitRelyingpartySetProjectConfigResponse
newIdentitytoolkitRelyingpartySetProjectConfigResponse
  = IdentitytoolkitRelyingpartySetProjectConfigResponse{projectId =
                                                          Core.Nothing}
instance Core.FromJSON
           IdentitytoolkitRelyingpartySetProjectConfigResponse
         where
        parseJSON
          = Core.withObject
              "IdentitytoolkitRelyingpartySetProjectConfigResponse"
              (\ o ->
                 IdentitytoolkitRelyingpartySetProjectConfigResponse Core.<$>
                   (o Core..:? "projectId"))
...
newIdentitytoolkitRelyingpartySignOutUserRequest 
    :: 
                                                 IdentitytoolkitRelyingpartySignOutUserRequest
newIdentitytoolkitRelyingpartySignOutUserRequest
  = IdentitytoolkitRelyingpartySignOutUserRequest{instanceId =
                                                    Core.Nothing,
                                                  localId = Core.Nothing}
instance Core.FromJSON
           IdentitytoolkitRelyingpartySignOutUserRequest
         where
        parseJSON
          = Core.withObject "IdentitytoolkitRelyingpartySignOutUserRequest"
              (\ o ->
                 IdentitytoolkitRelyingpartySignOutUserRequest Core.<$>
                   (o Core..:? "instanceId") Core.<*> (o Core..:? "localId"))

instance Core.ToJSON IdentitytoolkitRelyingpartySignOutUserRequest
         where
...
newIdentitytoolkitRelyingpartySignOutUserResponse 
    :: 
                                                  IdentitytoolkitRelyingpartySignOutUserResponse
newIdentitytoolkitRelyingpartySignOutUserResponse
  = IdentitytoolkitRelyingpartySignOutUserResponse{localId =
                                                     Core.Nothing}
instance Core.FromJSON
           IdentitytoolkitRelyingpartySignOutUserResponse
         where
        parseJSON
          = Core.withObject "IdentitytoolkitRelyingpartySignOutUserResponse"
              (\ o ->
                 IdentitytoolkitRelyingpartySignOutUserResponse Core.<$>
                   (o Core..:? "localId"))

instance Core.ToJSON IdentitytoolkitRelyingpartySignOutUserResponse
         where
        toJSON IdentitytoolkitRelyingpartySignOutUserResponse{..}
          = Core.object
              (Core.catMaybes [("localId" Core..=) Core.<$> localId])
...
newIdentitytoolkitRelyingpartySignupNewUserRequest 
    :: 
                                                   IdentitytoolkitRelyingpartySignupNewUserRequest
newIdentitytoolkitRelyingpartySignupNewUserRequest
  = IdentitytoolkitRelyingpartySignupNewUserRequest{captchaChallenge
                                                      = Core.Nothing,
                                                    captchaResponse = Core.Nothing,
                                                    ...
                                                    idToken = Core.Nothing,
                                                    instanceId = Core.Nothing,
                                                    localId = Core.Nothing, password = Core.Nothing,
                                                    phoneNumber = Core.Nothing,
                                                    photoUrl = Core.Nothing,
                                                    tenantId = Core.Nothing,
                                                    tenantProjectNumber = Core.Nothing}
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "IdentitytoolkitRelyingpartySignupNewUserRequest"
              (\ o ->
                 IdentitytoolkitRelyingpartySignupNewUserRequest Core.<$>
                   (o Core..:? "captchaChallenge") Core.<*>
                     (o Core..:? "captchaResponse")
...
newIdentitytoolkitRelyingpartyUploadAccountRequest 
    :: 
                                                   IdentitytoolkitRelyingpartyUploadAccountRequest
newIdentitytoolkitRelyingpartyUploadAccountRequest
  = IdentitytoolkitRelyingpartyUploadAccountRequest{allowOverwrite =
                                                      Core.Nothing,
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "IdentitytoolkitRelyingpartyUploadAccountRequest"
              (\ o ->
                 IdentitytoolkitRelyingpartyUploadAccountRequest Core.<$>
                   (o Core..:? "allowOverwrite") Core.<*> (o Core..:? "blockSize")
...
newIdentitytoolkitRelyingpartyVerifyAssertionRequest 
    :: 
                                                     IdentitytoolkitRelyingpartyVerifyAssertionRequest
newIdentitytoolkitRelyingpartyVerifyAssertionRequest
  = IdentitytoolkitRelyingpartyVerifyAssertionRequest{autoCreate =
                                                        Core.Nothing,
                                                      delegatedProjectNumber = Core.Nothing,
                                                      idToken = Core.Nothing,
                                                      instanceId = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "IdentitytoolkitRelyingpartyVerifyAssertionRequest"
              (\ o ->
                 IdentitytoolkitRelyingpartyVerifyAssertionRequest Core.<$>
                   (o Core..:? "autoCreate") Core.<*>
                     (o Core..:? "delegatedProjectNumber" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "idToken")
                     Core.<*> (o Core..:? "instanceId")
          ...
          = Core.object
              (Core.catMaybes
                 [("autoCreate" Core..=) Core.<$> autoCreate,
                  ...
                  ("returnIdpCredential" Core..=) Core.<$> returnIdpCredential,
                  ("returnRefreshToken" Core..=) Core.<$> returnRefreshToken,
                  ("returnSecureToken" Core..=) Core.<$> returnSecureToken,
                  ("sessionId" Core..=) Core.<$> sessionId,
                  ("tenantId" Core..=) Core.<$> tenantId,
                  ("tenantProjectNumber" Core..=) Core.. Core.AsText Core.<$>
...
newIdentitytoolkitRelyingpartyVerifyCustomTokenRequest 
    :: 
                                                       IdentitytoolkitRelyingpartyVerifyCustomTokenRequest
newIdentitytoolkitRelyingpartyVerifyCustomTokenRequest
  = IdentitytoolkitRelyingpartyVerifyCustomTokenRequest{delegatedProjectNumber
                                                          = Core.Nothing,
                                                        instanceId = Core.Nothing,
                                                        returnSecureToken = Core.Nothing,
                                                        token = Core.Nothing}
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "IdentitytoolkitRelyingpartyVerifyCustomTokenRequest"
              (\ o ->
                 IdentitytoolkitRelyingpartyVerifyCustomTokenRequest Core.<$>
                   (o Core..:? "delegatedProjectNumber" Core.<&>
                      Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "instanceId")
                     Core.<*> (o Core..:? "returnSecureToken")
...
newIdentitytoolkitRelyingpartyVerifyPasswordRequest 
    :: 
                                                    IdentitytoolkitRelyingpartyVerifyPasswordRequest
newIdentitytoolkitRelyingpartyVerifyPasswordRequest
  = IdentitytoolkitRelyingpartyVerifyPasswordRequest{captchaChallenge
                                                       = Core.Nothing,
                                                     captchaResponse = Core.Nothing,
                                                     delegatedProjectNumber = Core.Nothing,
                                                     email = Core.Nothing, idToken = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "IdentitytoolkitRelyingpartyVerifyPasswordRequest"
              (\ o ->
                 IdentitytoolkitRelyingpartyVerifyPasswordRequest Core.<$>
                   (o Core..:? "captchaChallenge") Core.<*>
                     (o Core..:? "captchaResponse")
                     Core.<*>
                     (o Core..:? "delegatedProjectNumber" Core.<&>
...
newIdentitytoolkitRelyingpartyVerifyPhoneNumberRequest 
    :: 
                                                       IdentitytoolkitRelyingpartyVerifyPhoneNumberRequest
newIdentitytoolkitRelyingpartyVerifyPhoneNumberRequest
  = IdentitytoolkitRelyingpartyVerifyPhoneNumberRequest{code =
                                                          Core.Nothing,
                                                        idToken = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "IdentitytoolkitRelyingpartyVerifyPhoneNumberRequest"
              (\ o ->
                 IdentitytoolkitRelyingpartyVerifyPhoneNumberRequest Core.<$>
                   (o Core..:? "code") Core.<*> (o Core..:? "idToken") Core.<*>
                     (o Core..:? "operation")
                     Core.<*> (o Core..:? "phoneNumber")
...
instance Core.ToJSON
           IdentitytoolkitRelyingpartyVerifyPhoneNumberRequest
         where
        toJSON IdentitytoolkitRelyingpartyVerifyPhoneNumberRequest{..}
          = Core.object
              (Core.catMaybes
                 [("code" Core..=) Core.<$> code,
                  ("idToken" Core..=) Core.<$> idToken,
                  ...
                  ("verificationProof" Core..=) Core.<$> verificationProof])
...
newIdentitytoolkitRelyingpartyVerifyPhoneNumberResponse 
    :: 
                                                        IdentitytoolkitRelyingpartyVerifyPhoneNumberResponse
newIdentitytoolkitRelyingpartyVerifyPhoneNumberResponse
  = IdentitytoolkitRelyingpartyVerifyPhoneNumberResponse{expiresIn =
                                                           Core.Nothing,
                                                         idToken = Core.Nothing,
                                                         isNewUser = Core.Nothing,
                                                         localId = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "IdentitytoolkitRelyingpartyVerifyPhoneNumberResponse"
              (\ o ->
                 IdentitytoolkitRelyingpartyVerifyPhoneNumberResponse Core.<$>
                   (o Core..:? "expiresIn" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "idToken")
                     Core.<*> (o Core..:? "isNewUser")
                     Core.<*> (o Core..:? "localId")
                     ...
                     Core.<*> (o Core..:? "temporaryProof")
                     Core.<*>
                     (o Core..:? "temporaryProofExpiresIn" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "verificationProof")
                     Core.<*>
                     (o Core..:? "verificationProofExpiresIn" Core.<&>
                        Core.fmap Core.fromAsText))

instance Core.ToJSON
           IdentitytoolkitRelyingpartyVerifyPhoneNumberResponse
         where
        toJSON IdentitytoolkitRelyingpartyVerifyPhoneNumberResponse{..}
          = Core.object
              (Core.catMaybes
                 [("expiresIn" Core..=) Core.. Core.AsText Core.<$> expiresIn,
                  ("idToken" Core..=) Core.<$> idToken,
                  ...
                  ("refreshToken" Core..=) Core.<$> refreshToken,
                  ("temporaryProof" Core..=) Core.<$> temporaryProof,
                  ("temporaryProofExpiresIn" Core..=) Core.. Core.AsText Core.<$>
                    temporaryProofExpiresIn,
                  ("verificationProof" Core..=) Core.<$> verificationProof,
                  ("verificationProofExpiresIn" Core..=) Core.. Core.AsText Core.<$>
...
newIdpConfig 
    ::  IdpConfig
newIdpConfig
  = IdpConfig{clientId = Core.Nothing, enabled = Core.Nothing,
              experimentPercent = Core.Nothing, provider = Core.Nothing,
              secret = Core.Nothing, whitelistedAudiences = Core.Nothing}
instance Core.FromJSON IdpConfig where
        parseJSON
          = Core.withObject "IdpConfig"
              (\ o ->
                 IdpConfig Core.<$>
                   (o Core..:? "clientId") Core.<*> (o Core..:? "enabled") Core.<*>
                     (o Core..:? "experimentPercent")
                     Core.<*> (o Core..:? "provider")
                     Core.<*> (o Core..:? "secret")
          ...
          = Core.object
              (Core.catMaybes
                 [("clientId" Core..=) Core.<$> clientId,
                  ...
                  ("experimentPercent" Core..=) Core.<$> experimentPercent,
                  ("provider" Core..=) Core.<$> provider,
                  ("secret" Core..=) Core.<$> secret,
                  ("whitelistedAudiences" Core..=) Core.<$> whitelistedAudiences])
...
newRelyingparty 
    ::  Relyingparty
newRelyingparty
  = Relyingparty{androidInstallApp = Core.Nothing,
                 androidMinimumVersion = Core.Nothing,
                 androidPackageName = Core.Nothing,
                 canHandleCodeInApp = Core.Nothing, captchaResp = Core.Nothing,
                 challenge = Core.Nothing, continueUrl = Core.Nothing,
                 email = Core.Nothing, iOSAppStoreId = Core.Nothing,
                 iOSBundleId = Core.Nothing, idToken = Core.Nothing,
                 kind = "identitytoolkit#relyingparty", newEmail' = Core.Nothing,
                 requestType = Core.Nothing, userIp = Core.Nothing}
instance Core.FromJSON Relyingparty where
        parseJSON
          = Core.withObject "Relyingparty"
              (\ o ->
                 Relyingparty Core.<$>
                   (o Core..:? "androidInstallApp") Core.<*>
                     (o Core..:? "androidMinimumVersion")
                     ...
                     Core.<*> (o Core..:? "idToken")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "identitytoolkit#relyingparty")
...
instance Core.ToJSON Relyingparty where
        toJSON Relyingparty{..}
          = Core.object
              (Core.catMaybes
                 [("androidInstallApp" Core..=) Core.<$> androidInstallApp,
                  ("androidMinimumVersion" Core..=) Core.<$> androidMinimumVersion,
                  ("androidPackageName" Core..=) Core.<$> androidPackageName,
                  ("canHandleCodeInApp" Core..=) Core.<$> canHandleCodeInApp,
...
newResetPasswordResponse 
    ::  ResetPasswordResponse
newResetPasswordResponse
  = ResetPasswordResponse{email = Core.Nothing,
                          kind = "identitytoolkit#ResetPasswordResponse",
                          newEmail' = Core.Nothing, requestType = Core.Nothing}
instance Core.FromJSON ResetPasswordResponse where
        parseJSON
          = Core.withObject "ResetPasswordResponse"
              (\ o ->
                 ResetPasswordResponse Core.<$>
                   (o Core..:? "email") Core.<*>
                     (o Core..:? "kind" Core..!=
...
newSetAccountInfoResponse 
    ::  SetAccountInfoResponse
newSetAccountInfoResponse
  = SetAccountInfoResponse{displayName = Core.Nothing,
                           email = Core.Nothing, emailVerified = Core.Nothing,
                           expiresIn = Core.Nothing, idToken = Core.Nothing,
                           kind = "identitytoolkit#SetAccountInfoResponse",
                           localId = Core.Nothing, newEmail' = Core.Nothing,
                           passwordHash = Core.Nothing, photoUrl = Core.Nothing,
                           providerUserInfo = Core.Nothing, refreshToken = Core.Nothing}
instance Core.FromJSON SetAccountInfoResponse where
        parseJSON
          = Core.withObject "SetAccountInfoResponse"
              (\ o ->
                 SetAccountInfoResponse Core.<$>
                   (o Core..:? "displayName") Core.<*> (o Core..:? "email") Core.<*>
                     (o Core..:? "emailVerified")
                     Core.<*>
                     (o Core..:? "expiresIn" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "idToken")
                     Core.<*>
          ...
          = Core.object
              (Core.catMaybes
                 [("displayName" Core..=) Core.<$> displayName,
                  ...
                  ("photoUrl" Core..=) Core.<$> photoUrl,
                  ("providerUserInfo" Core..=) Core.<$> providerUserInfo,
                  ("refreshToken" Core..=) Core.<$> refreshToken])
...
newSetAccountInfoResponse_ProviderUserInfoItem 
    :: 
                                               SetAccountInfoResponse_ProviderUserInfoItem
newSetAccountInfoResponse_ProviderUserInfoItem
  = SetAccountInfoResponse_ProviderUserInfoItem{displayName =
                                                  Core.Nothing,
                                                federatedId = Core.Nothing, photoUrl = Core.Nothing,
                                                providerId = Core.Nothing}
instance Core.FromJSON SetAccountInfoResponse_ProviderUserInfoItem
         where
        parseJSON
          = Core.withObject "SetAccountInfoResponse_ProviderUserInfoItem"
              (\ o ->
                 SetAccountInfoResponse_ProviderUserInfoItem Core.<$>
                   (o Core..:? "displayName") Core.<*> (o Core..:? "federatedId")
                     Core.<*> (o Core..:? "photoUrl")
                     Core.<*> (o Core..:? "providerId"))

instance Core.ToJSON SetAccountInfoResponse_ProviderUserInfoItem
         where
        toJSON SetAccountInfoResponse_ProviderUserInfoItem{..}
          = Core.object
              (Core.catMaybes
                 [("displayName" Core..=) Core.<$> displayName,
...
newSignupNewUserResponse 
    ::  SignupNewUserResponse
newSignupNewUserResponse
  = SignupNewUserResponse{displayName = Core.Nothing,
                          email = Core.Nothing, expiresIn = Core.Nothing,
                          idToken = Core.Nothing,
                          kind = "identitytoolkit#SignupNewUserResponse",
                          localId = Core.Nothing, refreshToken = Core.Nothing}
instance Core.FromJSON SignupNewUserResponse where
        parseJSON
          = Core.withObject "SignupNewUserResponse"
              (\ o ->
                 SignupNewUserResponse Core.<$>
                   (o Core..:? "displayName") Core.<*> (o Core..:? "email") Core.<*>
                     (o Core..:? "expiresIn" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "idToken")
                     Core.<*>
...
newUploadAccountResponse 
    ::  UploadAccountResponse
newUploadAccountResponse
  = UploadAccountResponse{error = Core.Nothing,
                          kind = "identitytoolkit#UploadAccountResponse"}
instance Core.FromJSON UploadAccountResponse where
        parseJSON
          = Core.withObject "UploadAccountResponse"
              (\ o ->
                 UploadAccountResponse Core.<$>
                   (o Core..:? "error") Core.<*>
                     (o Core..:? "kind" Core..!=
...
newUploadAccountResponse_ErrorItem 
    :: 
                                   UploadAccountResponse_ErrorItem
newUploadAccountResponse_ErrorItem
  = UploadAccountResponse_ErrorItem{index = Core.Nothing,
                                    message = Core.Nothing}
instance Core.FromJSON UploadAccountResponse_ErrorItem where
        parseJSON
          = Core.withObject "UploadAccountResponse_ErrorItem"
              (\ o ->
                 UploadAccountResponse_ErrorItem Core.<$>
                   (o Core..:? "index") Core.<*> (o Core..:? "message"))
...
newUserInfo 
    ::  UserInfo
newUserInfo
  = UserInfo{createdAt = Core.Nothing,
             customAttributes = Core.Nothing, customAuth = Core.Nothing,
             disabled = Core.Nothing, displayName = Core.Nothing,
             email = Core.Nothing, emailVerified = Core.Nothing,
             lastLoginAt = Core.Nothing, localId = Core.Nothing,
             passwordHash = Core.Nothing, passwordUpdatedAt = Core.Nothing,
             phoneNumber = Core.Nothing, photoUrl = Core.Nothing,
             providerUserInfo = Core.Nothing, rawPassword = Core.Nothing,
             salt = Core.Nothing, screenName = Core.Nothing,
             validSince = Core.Nothing, version = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("createdAt" Core..=) Core.. Core.AsText Core.<$> createdAt,
                  ...
                  ("localId" Core..=) Core.<$> localId,
                  ("passwordHash" Core..=) Core.<$> passwordHash,
                  ("passwordUpdatedAt" Core..=) Core.<$> passwordUpdatedAt,
                  ("phoneNumber" Core..=) Core.<$> phoneNumber,
                  ("photoUrl" Core..=) Core.<$> photoUrl,
                  ("providerUserInfo" Core..=) Core.<$> providerUserInfo,
...
newUserInfo_ProviderUserInfoItem 
    ::  UserInfo_ProviderUserInfoItem
newUserInfo_ProviderUserInfoItem
  = UserInfo_ProviderUserInfoItem{displayName = Core.Nothing,
                                  email = Core.Nothing, federatedId = Core.Nothing,
                                  phoneNumber = Core.Nothing, photoUrl = Core.Nothing,
                                  providerId = Core.Nothing, rawId = Core.Nothing,
                                  screenName = Core.Nothing}
instance Core.FromJSON UserInfo_ProviderUserInfoItem where
        parseJSON
          = Core.withObject "UserInfo_ProviderUserInfoItem"
              (\ o ->
                 UserInfo_ProviderUserInfoItem Core.<$>
                   (o Core..:? "displayName") Core.<*> (o Core..:? "email") Core.<*>
                     (o Core..:? "federatedId")
                     Core.<*> (o Core..:? "phoneNumber")
                     Core.<*> (o Core..:? "photoUrl")
...
newVerifyAssertionResponse 
    ::  VerifyAssertionResponse
newVerifyAssertionResponse
  = VerifyAssertionResponse{action = Core.Nothing,
                            appInstallationUrl = Core.Nothing, appScheme = Core.Nothing,
                            context = Core.Nothing, dateOfBirth = Core.Nothing,
                            displayName = Core.Nothing, email = Core.Nothing,
                            emailRecycled = Core.Nothing, emailVerified = Core.Nothing,
                            errorMessage = Core.Nothing, expiresIn = Core.Nothing,
                            federatedId = Core.Nothing, firstName = Core.Nothing,
                            fullName = Core.Nothing, idToken = Core.Nothing,
                            inputEmail = Core.Nothing, isNewUser = Core.Nothing,
                            kind = "identitytoolkit#VerifyAssertionResponse",
                            language = Core.Nothing, lastName = Core.Nothing,
                            localId = Core.Nothing, needConfirmation = Core.Nothing,
                            needEmail = Core.Nothing, nickName = Core.Nothing,
                            oauthAccessToken = Core.Nothing,
                            oauthAuthorizationCode = Core.Nothing,
                            oauthExpireIn = Core.Nothing, oauthIdToken = Core.Nothing,
                            oauthRequestToken = Core.Nothing, oauthScope = Core.Nothing,
                            oauthTokenSecret = Core.Nothing, originalEmail = Core.Nothing,
                            photoUrl = Core.Nothing, providerId = Core.Nothing,
                            rawUserInfo = Core.Nothing, refreshToken = Core.Nothing,
                            screenName = Core.Nothing, timeZone = Core.Nothing,
                            verifiedProvider = Core.Nothing}
instance Core.FromJSON VerifyAssertionResponse where
        parseJSON
          = Core.withObject "VerifyAssertionResponse"
              (\ o ->
                 VerifyAssertionResponse Core.<$>
                   (o Core..:? "action") Core.<*> (o Core..:? "appInstallationUrl")
          ...
          = Core.object
              (Core.catMaybes
                 [("action" Core..=) Core.<$> action,
                  ("appInstallationUrl" Core..=) Core.<$> appInstallationUrl,
                  ...
                  ("localId" Core..=) Core.<$> localId,
                  ("needConfirmation" Core..=) Core.<$> needConfirmation,
                  ("needEmail" Core..=) Core.<$> needEmail,
                  ("nickName" Core..=) Core.<$> nickName,
                  ("oauthAccessToken" Core..=) Core.<$> oauthAccessToken,
                  ("oauthAuthorizationCode" Core..=) Core.<$> oauthAuthorizationCode,
                  ("oauthExpireIn" Core..=) Core.<$> oauthExpireIn,
                  ("oauthIdToken" Core..=) Core.<$> oauthIdToken,
                  ("oauthRequestToken" Core..=) Core.<$> oauthRequestToken,
                  ("oauthScope" Core..=) Core.<$> oauthScope,
                  ("oauthTokenSecret" Core..=) Core.<$> oauthTokenSecret,
                  ...
                  ("verifiedProvider" Core..=) Core.<$> verifiedProvider])
...
newVerifyCustomTokenResponse 
    ::  VerifyCustomTokenResponse
newVerifyCustomTokenResponse
  = VerifyCustomTokenResponse{expiresIn = Core.Nothing,
                              idToken = Core.Nothing, isNewUser = Core.Nothing,
                              kind = "identitytoolkit#VerifyCustomTokenResponse",
                              refreshToken = Core.Nothing}
instance Core.FromJSON VerifyCustomTokenResponse where
        parseJSON
          = Core.withObject "VerifyCustomTokenResponse"
              (\ o ->
                 VerifyCustomTokenResponse Core.<$>
                   (o Core..:? "expiresIn" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "idToken")
                     Core.<*> (o Core..:? "isNewUser")
                     Core.<*>
...
newVerifyPasswordResponse 
    ::  VerifyPasswordResponse
newVerifyPasswordResponse
  = VerifyPasswordResponse{displayName = Core.Nothing,
                           email = Core.Nothing, expiresIn = Core.Nothing,
                           idToken = Core.Nothing,
                           kind = "identitytoolkit#VerifyPasswordResponse",
                           localId = Core.Nothing, oauthAccessToken = Core.Nothing,
                           oauthAuthorizationCode = Core.Nothing,
                           oauthExpireIn = Core.Nothing, photoUrl = Core.Nothing,
                           refreshToken = Core.Nothing, registered = Core.Nothing}
instance Core.FromJSON VerifyPasswordResponse where
        parseJSON
          = Core.withObject "VerifyPasswordResponse"
              (\ o ->
                 VerifyPasswordResponse Core.<$>
                   (o Core..:? "displayName") Core.<*> (o Core..:? "email") Core.<*>
                     (o Core..:? "expiresIn" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "idToken")
                     Core.<*>
