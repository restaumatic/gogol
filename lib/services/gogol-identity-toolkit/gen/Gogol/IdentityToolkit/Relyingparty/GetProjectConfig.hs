       ...
       "v3" Core.:>
         "relyingparty" Core.:>
           "getProjectConfig" Core.:>
             Core.QueryParam "delegatedProjectNumber" Core.Text Core.:>
...
newIdentityToolkitRelyingpartyGetProjectConfig 
    :: 
                                               IdentityToolkitRelyingpartyGetProjectConfig
newIdentityToolkitRelyingpartyGetProjectConfig
  = IdentityToolkitRelyingpartyGetProjectConfig{delegatedProjectNumber
                                                  = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Rs IdentityToolkitRelyingpartyGetProjectConfig =
             IdentitytoolkitRelyingpartyGetProjectConfigResponse
        type Scopes IdentityToolkitRelyingpartyGetProjectConfig =
             '[CloudPlatform'FullControl]
        requestClient IdentityToolkitRelyingpartyGetProjectConfig{..}
          = go delegatedProjectNumber projectNumber (Core.Just Core.AltJSON)
              identityToolkitService
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy IdentityToolkitRelyingpartyGetProjectConfigResource)
                      Core.mempty
