...
newIdentityToolkitRelyingpartySendVerificationCode payload
  = IdentityToolkitRelyingpartySendVerificationCode{payload =
                                                      payload}
instance Core.GoogleRequest
           IdentityToolkitRelyingpartySendVerificationCode
         where
        type Rs IdentityToolkitRelyingpartySendVerificationCode =
             IdentitytoolkitRelyingpartySendVerificationCodeResponse
        type Scopes IdentityToolkitRelyingpartySendVerificationCode =
