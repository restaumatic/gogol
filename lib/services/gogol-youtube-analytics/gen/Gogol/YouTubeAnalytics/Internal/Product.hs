...
newErrorProto 
    ::  ErrorProto
newErrorProto
  = ErrorProto{argument = Core.Nothing, code = Core.Nothing,
               debugInfo = Core.Nothing, domain = Core.Nothing,
               externalErrorMessage = Core.Nothing, location = Core.Nothing,
...
instance Core.FromJSON ErrorProto where
        parseJSON
          = Core.withObject "ErrorProto"
              (\ o ->
                 ErrorProto Core.<$>
                   (o Core..:? "argument") Core.<*> (o Core..:? "code") Core.<*>
                     (o Core..:? "debugInfo")
                     Core.<*> (o Core..:? "domain")
          ...
          = Core.object
              (Core.catMaybes
                 [("argument" Core..=) Core.<$> argument,
                  ...
                  ("externalErrorMessage" Core..=) Core.<$> externalErrorMessage,
...
newErrors 
    ::  Errors
newErrors
  = Errors{code = Core.Nothing, error = Core.Nothing,
...
instance Core.FromJSON Errors where
        parseJSON
          = Core.withObject "Errors"
              (\ o ->
                 Errors Core.<$>
                   (o Core..:? "code") Core.<*> (o Core..:? "error") Core.<*>
                     (o Core..:? "requestId"))
...
instance Core.ToJSON Errors where
        toJSON Errors{..}
          = Core.object
              (Core.catMaybes
                 [("code" Core..=) Core.<$> code, ("error" Core..=) Core.<$> error,
...
newGroup 
    ::  Group
newGroup
  = Group{contentDetails = Core.Nothing, errors = Core.Nothing,
          etag = Core.Nothing, id = Core.Nothing, kind = Core.Nothing,
...
instance Core.FromJSON Group where
        parseJSON
          = Core.withObject "Group"
              (\ o ->
                 Group Core.<$>
                   (o Core..:? "contentDetails") Core.<*> (o Core..:? "errors")
                     Core.<*> (o Core..:? "etag")
                     Core.<*> (o Core..:? "id")
                     Core.<*> (o Core..:? "kind")
                     Core.<*> (o Core..:? "snippet"))
...
newGroupContentDetails 
    ::  GroupContentDetails
newGroupContentDetails
  = GroupContentDetails{itemCount = Core.Nothing,
...
newGroupItem 
    ::  GroupItem
newGroupItem
  = GroupItem{errors = Core.Nothing, etag = Core.Nothing,
              groupId = Core.Nothing, id = Core.Nothing, kind = Core.Nothing,
...
instance Core.FromJSON GroupItem where
        parseJSON
          = Core.withObject "GroupItem"
              (\ o ->
                 GroupItem Core.<$>
                   (o Core..:? "errors") Core.<*> (o Core..:? "etag") Core.<*>
                     (o Core..:? "groupId")
                     Core.<*> (o Core..:? "id")
                     Core.<*> (o Core..:? "kind")
          ...
          = Core.object
              (Core.catMaybes
                 [("errors" Core..=) Core.<$> errors,
                  ("etag" Core..=) Core.<$> etag,
                  ("groupId" Core..=) Core.<$> groupId, ("id" Core..=) Core.<$> id,
                  ("kind" Core..=) Core.<$> kind,
...
instance Core.FromJSON GroupSnippet where
        parseJSON
          = Core.withObject "GroupSnippet"
              (\ o ->
                 GroupSnippet Core.<$>
                   (o Core..:? "publishedAt") Core.<*> (o Core..:? "title"))
...
newListGroupItemsResponse 
    ::  ListGroupItemsResponse
newListGroupItemsResponse
  = ListGroupItemsResponse{errors = Core.Nothing,
...
newListGroupsResponse 
    ::  ListGroupsResponse
newListGroupsResponse
  = ListGroupsResponse{errors = Core.Nothing, etag = Core.Nothing,
                       items = Core.Nothing, kind = Core.Nothing,
...
newQueryResponse 
    ::  QueryResponse
newQueryResponse
  = QueryResponse{columnHeaders = Core.Nothing,
                  errors = Core.Nothing, kind = Core.Nothing, rows = Core.Nothing}
instance Core.FromJSON QueryResponse where
        parseJSON
          = Core.withObject "QueryResponse"
              (\ o ->
                 QueryResponse Core.<$>
                   (o Core..:? "columnHeaders") Core.<*> (o Core..:? "errors")
                     Core.<*> (o Core..:? "kind")
                     Core.<*> (o Core..:? "rows"))
...
newResultTableColumnHeader 
    ::  ResultTableColumnHeader
newResultTableColumnHeader
  = ResultTableColumnHeader{columnType = Core.Nothing,
