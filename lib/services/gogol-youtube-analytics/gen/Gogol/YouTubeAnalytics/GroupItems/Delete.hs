...
newYouTubeAnalyticsGroupItemsDelete 
    :: 
                                    YouTubeAnalyticsGroupItemsDelete
newYouTubeAnalyticsGroupItemsDelete
  = YouTubeAnalyticsGroupItemsDelete{xgafv = Core.Nothing,
                                     accessToken = Core.Nothing, callback = Core.Nothing,
                                     id = Core.Nothing, onBehalfOfContentOwner = Core.Nothing,
                                     uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest YouTubeAnalyticsGroupItemsDelete where
        type Rs YouTubeAnalyticsGroupItemsDelete = EmptyResponse
        type Scopes YouTubeAnalyticsGroupItemsDelete =
        ...
        requestClient YouTubeAnalyticsGroupItemsDelete{..}
          = go xgafv accessToken callback id onBehalfOfContentOwner
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy YouTubeAnalyticsGroupItemsDeleteResource)
                      Core.mempty
