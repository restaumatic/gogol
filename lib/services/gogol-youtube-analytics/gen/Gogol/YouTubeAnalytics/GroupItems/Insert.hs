                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] GroupItem Core.:>
                         Core.Post '[Core.JSON] GroupItem
...
newYouTubeAnalyticsGroupItemsInsert payload
  = YouTubeAnalyticsGroupItemsInsert{xgafv = Core.Nothing,
...
instance Core.GoogleRequest YouTubeAnalyticsGroupItemsInsert where
        ...
        type Scopes YouTubeAnalyticsGroupItemsInsert =
