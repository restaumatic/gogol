...
newYouTubeAnalyticsGroupItemsList 
    ::  YouTubeAnalyticsGroupItemsList
newYouTubeAnalyticsGroupItemsList
  = YouTubeAnalyticsGroupItemsList{xgafv = Core.Nothing,
                                   accessToken = Core.Nothing, callback = Core.Nothing,
                                   groupId = Core.Nothing, onBehalfOfContentOwner = Core.Nothing,
                                   uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest YouTubeAnalyticsGroupItemsList where
        type Rs YouTubeAnalyticsGroupItemsList = ListGroupItemsResponse
        ...
        requestClient YouTubeAnalyticsGroupItemsList{..}
          = go xgafv accessToken callback groupId onBehalfOfContentOwner
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy YouTubeAnalyticsGroupItemsListResource)
                      Core.mempty
