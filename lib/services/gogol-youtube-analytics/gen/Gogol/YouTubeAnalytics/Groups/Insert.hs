...
newYouTubeAnalyticsGroupsInsert payload
  = YouTubeAnalyticsGroupsInsert{xgafv = Core.Nothing,
                                 accessToken = Core.Nothing, callback = Core.Nothing,
                                 onBehalfOfContentOwner = Core.Nothing, payload = payload,
                                 uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest YouTubeAnalyticsGroupsInsert where
        type Rs YouTubeAnalyticsGroupsInsert = Group
        type Scopes YouTubeAnalyticsGroupsInsert =
        ...
        requestClient YouTubeAnalyticsGroupsInsert{..}
          = go xgafv accessToken callback onBehalfOfContentOwner uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy YouTubeAnalyticsGroupsInsertResource)
                      Core.mempty
