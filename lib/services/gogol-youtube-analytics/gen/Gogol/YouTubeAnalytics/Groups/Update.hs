                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] Group Core.:> Core.Put '[Core.JSON] Group
...
instance Core.GoogleRequest YouTubeAnalyticsGroupsUpdate where
        ...
        requestClient YouTubeAnalyticsGroupsUpdate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy YouTubeAnalyticsGroupsUpdateResource)
                      Core.mempty
