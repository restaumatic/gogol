...
instance Core.GoogleRequest YouTubeAnalyticsGroupsDelete where
        ...
        requestClient YouTubeAnalyticsGroupsDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy YouTubeAnalyticsGroupsDeleteResource)
                      Core.mempty
