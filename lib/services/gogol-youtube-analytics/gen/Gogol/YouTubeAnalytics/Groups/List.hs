...
newYouTubeAnalyticsGroupsList 
    ::  YouTubeAnalyticsGroupsList
newYouTubeAnalyticsGroupsList
  = YouTubeAnalyticsGroupsList{xgafv = Core.Nothing,
                               accessToken = Core.Nothing, callback = Core.Nothing,
                               id = Core.Nothing, mine = Core.Nothing,
...
instance Core.GoogleRequest YouTubeAnalyticsGroupsList where
        ...
        type Scopes YouTubeAnalyticsGroupsList =
        ...
        requestClient YouTubeAnalyticsGroupsList{..}
          = go xgafv accessToken callback id mine onBehalfOfContentOwner
              pageToken
              uploadType
              uploadProtocol
