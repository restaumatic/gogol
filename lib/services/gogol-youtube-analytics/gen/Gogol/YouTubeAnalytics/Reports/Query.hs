         ...
         Core.QueryParam "$.xgafv" Xgafv Core.:>
           Core.QueryParam "access_token" Core.Text Core.:>
             Core.QueryParam "callback" Core.Text Core.:>
               Core.QueryParam "currency" Core.Text Core.:>
                 Core.QueryParam "dimensions" Core.Text Core.:>
                   Core.QueryParam "endDate" Core.Text Core.:>
                     Core.QueryParam "filters" Core.Text Core.:>
                       Core.QueryParam "ids" Core.Text Core.:>
                         Core.QueryParam "includeHistoricalChannelData" Core.Bool Core.:>
                           Core.QueryParam "maxResults" Core.Int32 Core.:>
                             Core.QueryParam "metrics" Core.Text Core.:>
                               Core.QueryParam "sort" Core.Text Core.:>
                                 Core.QueryParam "startDate" Core.Text Core.:>
                                   Core.QueryParam "startIndex" Core.Int32 Core.:>
                                     Core.QueryParam "uploadType" Core.Text Core.:>
                                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                                         Core.QueryParam "alt" Core.AltJSON Core.:>
                                           Core.Get '[Core.JSON] QueryResponse
...
newYouTubeAnalyticsReportsQuery 
    ::  YouTubeAnalyticsReportsQuery
newYouTubeAnalyticsReportsQuery
  = YouTubeAnalyticsReportsQuery{xgafv = Core.Nothing,
                                 accessToken = Core.Nothing, callback = Core.Nothing,
                                 currency = Core.Nothing, dimensions = Core.Nothing,
                                 endDate = Core.Nothing, filters = Core.Nothing, ids = Core.Nothing,
...
instance Core.GoogleRequest YouTubeAnalyticsReportsQuery where
        type Rs YouTubeAnalyticsReportsQuery = QueryResponse
        type Scopes YouTubeAnalyticsReportsQuery =
             '[Youtube'FullControl, Youtube'Readonly,
               Youtubepartner'FullControl, YtAnalyticsMonetary'Readonly,
               YtAnalytics'Readonly]
        requestClient YouTubeAnalyticsReportsQuery{..}
          = go xgafv accessToken callback currency dimensions endDate filters
              ids
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy YouTubeAnalyticsReportsQueryResource)
                      Core.mempty
