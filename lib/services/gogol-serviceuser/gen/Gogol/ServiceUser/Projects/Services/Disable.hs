               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] DisableServiceRequest Core.:>
...
newServiceUserProjectsServicesDisable name payload
  = ServiceUserProjectsServicesDisable{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       name = name, payload = payload, uploadType = Core.Nothing,
                                       uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ServiceUserProjectsServicesDisable
         where
        type Rs ServiceUserProjectsServicesDisable = Operation
        ...
        requestClient ServiceUserProjectsServicesDisable{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ServiceUserProjectsServicesDisableResource)
                      Core.mempty
