...
-- |
-- Module      : Gogol.ServiceUser.Projects.Services.List
                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] ListEnabledServicesResponse
...
newServiceUserProjectsServicesList parent
  = ServiceUserProjectsServicesList{xgafv = Core.Nothing,
                                    accessToken = Core.Nothing, callback = Core.Nothing,
                                    pageSize = Core.Nothing, pageToken = Core.Nothing,
                                    parent = parent, uploadType = Core.Nothing,
                                    uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ServiceUserProjectsServicesList where
        type Rs ServiceUserProjectsServicesList =
             ListEnabledServicesResponse
        type Scopes ServiceUserProjectsServicesList =
        ...
        requestClient ServiceUserProjectsServicesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ServiceUserProjectsServicesListResource)
                      Core.mempty
