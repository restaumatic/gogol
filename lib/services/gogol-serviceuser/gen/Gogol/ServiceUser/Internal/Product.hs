...
newBackendRule
  = BackendRule{address = Core.Nothing, deadline = Core.Nothing,
                minDeadline = Core.Nothing, selector = Core.Nothing}
...
newDocumentation 
    ::  Documentation
newDocumentation
  = Documentation{documentationRootUrl = Core.Nothing,
                  overview = Core.Nothing, pages = Core.Nothing,
                  rules = Core.Nothing, summary = Core.Nothing}
...
newDocumentationRule
  = DocumentationRule{deprecationDescription = Core.Nothing,
                      description = Core.Nothing, selector = Core.Nothing}
...
newEndpoint
  = Endpoint{aliases = Core.Nothing, allowCors = Core.Nothing,
             features = Core.Nothing, name = Core.Nothing,
             target = Core.Nothing}
...
newEnum 
    ::  Enum'
newEnum
  = Enum'{enumvalue = Core.Nothing, name = Core.Nothing,
          options = Core.Nothing, sourceContext = Core.Nothing,
          syntax = Core.Nothing}
instance Core.FromJSON Enum' where
        parseJSON
          = Core.withObject "Enum'"
              (\ o ->
                 Enum' Core.<$>
                   (o Core..:? "enumvalue") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "options")
                     Core.<*> (o Core..:? "sourceContext")
                     Core.<*> (o Core..:? "syntax"))
...
instance Core.FromJSON Experimental where
        parseJSON
          = Core.withObject "Experimental"
              (\ o -> Experimental Core.<$> (o Core..:? "authorization"))

instance Core.ToJSON Experimental where
        toJSON Experimental{..}
          = Core.object
              (Core.catMaybes [("authorization" Core..=) Core.<$> authorization])
...
newListEnabledServicesResponse 
    ::  ListEnabledServicesResponse
newListEnabledServicesResponse
  = ListEnabledServicesResponse{nextPageToken = Core.Nothing,
                                services = Core.Nothing}
instance Core.FromJSON ListEnabledServicesResponse where
        parseJSON
...
instance Core.ToJSON ListEnabledServicesResponse where
...
newMetricDescriptor
  = MetricDescriptor{description = Core.Nothing,
                     displayName = Core.Nothing, labels = Core.Nothing,
                     metadata = Core.Nothing, metricKind = Core.Nothing,
...
newSearchServicesResponse 
    ::  SearchServicesResponse
newSearchServicesResponse
  = SearchServicesResponse{nextPageToken = Core.Nothing,
                           services = Core.Nothing}
...
newService 
    ::  Service
newService
  = Service{apis = Core.Nothing, authentication = Core.Nothing,
            backend = Core.Nothing, billing = Core.Nothing,
            configVersion = Core.Nothing, context = Core.Nothing,
            control = Core.Nothing, customError = Core.Nothing,
            documentation = Core.Nothing, endpoints = Core.Nothing,
            enums = Core.Nothing, experimental = Core.Nothing,
            ...
            quota = Core.Nothing, sourceInfo = Core.Nothing,
            systemParameters = Core.Nothing, systemTypes = Core.Nothing,
            title = Core.Nothing, types = Core.Nothing, usage = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("apis" Core..=) Core.<$> apis,
                  ...
                  ("http" Core..=) Core.<$> http, ("id" Core..=) Core.<$> id,
...
newType
  = Type{fields = Core.Nothing, name = Core.Nothing,
         oneofs = Core.Nothing, options = Core.Nothing,
         sourceContext = Core.Nothing, syntax = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("fields" Core..=) Core.<$> fields,
                  ("name" Core..=) Core.<$> name, ("oneofs" Core..=) Core.<$> oneofs,
                  ("options" Core..=) Core.<$> options,
                  ("sourceContext" Core..=) Core.<$> sourceContext,
                  ("syntax" Core..=) Core.<$> syntax])
