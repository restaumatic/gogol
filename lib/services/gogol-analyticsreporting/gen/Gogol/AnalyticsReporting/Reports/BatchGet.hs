               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] GetReportsRequest Core.:>
                       Core.Post '[Core.JSON] GetReportsResponse
...
newAnalyticsReportingReportsBatchGet payload
  = AnalyticsReportingReportsBatchGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest AnalyticsReportingReportsBatchGet where
        ...
        type Scopes AnalyticsReportingReportsBatchGet =
