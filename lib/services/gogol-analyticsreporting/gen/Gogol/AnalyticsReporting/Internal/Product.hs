...
newActivity 
    ::  Activity
newActivity
  = Activity{activityTime = Core.Nothing,
             activityType = Core.Nothing, appview = Core.Nothing,
             campaign = Core.Nothing, channelGrouping = Core.Nothing,
             customDimension = Core.Nothing, ecommerce = Core.Nothing,
             event = Core.Nothing, goals = Core.Nothing,
             hostname = Core.Nothing, keyword = Core.Nothing,
             landingPagePath = Core.Nothing, medium = Core.Nothing,
             pageview = Core.Nothing, source = Core.Nothing}
instance Core.FromJSON Activity where
        parseJSON
          = Core.withObject "Activity"
              (\ o ->
                 Activity Core.<$>
                   (o Core..:? "activityTime") Core.<*> (o Core..:? "activityType")
                     Core.<*> (o Core..:? "appview")
          ...
          = Core.object
              (Core.catMaybes
                 [("activityTime" Core..=) Core.<$> activityTime,
                  ...
                  ("event" Core..=) Core.<$> event, ("goals" Core..=) Core.<$> goals,
...
newCohort 
    ::  Cohort
newCohort
  = Cohort{dateRange = Core.Nothing, name = Core.Nothing,
           type' = Core.Nothing}
instance Core.FromJSON Cohort where
        parseJSON
          = Core.withObject "Cohort"
              (\ o ->
                 Cohort Core.<$>
                   (o Core..:? "dateRange") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "type"))
...
instance Core.FromJSON CohortGroup where
        parseJSON
          = Core.withObject "CohortGroup"
              (\ o ->
                 CohortGroup Core.<$>
                   (o Core..:? "cohorts") Core.<*> (o Core..:? "lifetimeValue"))
...
newColumnHeader 
    ::  ColumnHeader
newColumnHeader
  = ColumnHeader{dimensions = Core.Nothing,
                 metricHeader = Core.Nothing}
instance Core.FromJSON ColumnHeader where
        parseJSON
          = Core.withObject "ColumnHeader"
              (\ o ->
                 ColumnHeader Core.<$>
                   (o Core..:? "dimensions") Core.<*> (o Core..:? "metricHeader"))
          ...
          = Core.withObject "CustomDimension"
              (\ o ->
                 CustomDimension Core.<$>
                   (o Core..:? "index") Core.<*> (o Core..:? "value"))
...
newDateRangeValues 
    ::  DateRangeValues
newDateRangeValues
  = DateRangeValues{pivotValueRegions = Core.Nothing,
                    values = Core.Nothing}
instance Core.FromJSON DateRangeValues where
        parseJSON
          = Core.withObject "DateRangeValues"
              (\ o ->
                 DateRangeValues Core.<$>
                   (o Core..:? "pivotValueRegions") Core.<*> (o Core..:? "values"))
...
instance Core.ToJSON Dimension where
        toJSON Dimension{..}
          = Core.object
              (Core.catMaybes
                 [("histogramBuckets" Core..=) Core.. Core.fmap Core.AsText Core.<$>
                    histogramBuckets,
                  ("name" Core..=) Core.<$> name])
...
newDimensionFilter 
    ::  DimensionFilter
newDimensionFilter
  = DimensionFilter{caseSensitive = Core.Nothing,
                    dimensionName = Core.Nothing, expressions = Core.Nothing,
                    not = Core.Nothing, operator = Core.Nothing}
instance Core.FromJSON DimensionFilter where
        parseJSON
          = Core.withObject "DimensionFilter"
              (\ o ->
                 DimensionFilter Core.<$>
                   (o Core..:? "caseSensitive") Core.<*> (o Core..:? "dimensionName")
...
newDimensionFilterClause 
    ::  DimensionFilterClause
newDimensionFilterClause
  = DimensionFilterClause{filters = Core.Nothing,
                          operator = Core.Nothing}
instance Core.FromJSON DimensionFilterClause where
        parseJSON
          = Core.withObject "DimensionFilterClause"
              (\ o ->
                 DimensionFilterClause Core.<$>
                   (o Core..:? "filters") Core.<*> (o Core..:? "operator"))
...
newDynamicSegment 
    ::  DynamicSegment
newDynamicSegment
  = DynamicSegment{name = Core.Nothing,
                   sessionSegment = Core.Nothing, userSegment = Core.Nothing}
instance Core.FromJSON DynamicSegment where
        parseJSON
          = Core.withObject "DynamicSegment"
              (\ o ->
                 DynamicSegment Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "sessionSegment") Core.<*>
                     (o Core..:? "userSegment"))
...
newEcommerceData 
    ::  EcommerceData
newEcommerceData
  = EcommerceData{actionType = Core.Nothing,
                  ecommerceType = Core.Nothing, products = Core.Nothing,
                  transaction = Core.Nothing}
instance Core.FromJSON EcommerceData where
        parseJSON
          = Core.withObject "EcommerceData"
              (\ o ->
                 EcommerceData Core.<$>
                   (o Core..:? "actionType") Core.<*> (o Core..:? "ecommerceType")
...
newEventData 
    ::  EventData
newEventData
  = EventData{eventAction = Core.Nothing,
              eventCategory = Core.Nothing, eventCount = Core.Nothing,
              eventLabel = Core.Nothing, eventValue = Core.Nothing}
              ...
              (\ o ->
                 EventData Core.<$>
                   (o Core..:? "eventAction") Core.<*> (o Core..:? "eventCategory")
                     Core.<*>
                     (o Core..:? "eventCount" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "eventLabel")
                     Core.<*>
                     (o Core..:? "eventValue" Core.<&> Core.fmap Core.fromAsText))
...
newGetReportsRequest 
    ::  GetReportsRequest
newGetReportsRequest
  = GetReportsRequest{reportRequests = Core.Nothing,
                      useResourceQuotas = Core.Nothing}
instance Core.FromJSON GetReportsRequest where
        parseJSON
          = Core.withObject "GetReportsRequest"
              (\ o ->
                 GetReportsRequest Core.<$>
                   (o Core..:? "reportRequests") Core.<*>
                     (o Core..:? "useResourceQuotas"))
...
newGetReportsResponse 
    ::  GetReportsResponse
newGetReportsResponse
  = GetReportsResponse{queryCost = Core.Nothing,
                       reports = Core.Nothing, resourceQuotasRemaining = Core.Nothing}
instance Core.FromJSON GetReportsResponse where
        parseJSON
          = Core.withObject "GetReportsResponse"
              (\ o ->
                 GetReportsResponse Core.<$>
                   (o Core..:? "queryCost") Core.<*> (o Core..:? "reports") Core.<*>
                     (o Core..:? "resourceQuotasRemaining"))
          ...
          = Core.object
              (Core.catMaybes
                 [("queryCost" Core..=) Core.<$> queryCost,
                  ...
                  ("resourceQuotasRemaining" Core..=) Core.<$>
                    resourceQuotasRemaining])
...
newGoalData 
    ::  GoalData
newGoalData
  = GoalData{goalCompletionLocation = Core.Nothing,
             goalCompletions = Core.Nothing, goalIndex = Core.Nothing,
             goalName = Core.Nothing, goalPreviousStep1 = Core.Nothing,
             goalPreviousStep2 = Core.Nothing, goalPreviousStep3 = Core.Nothing,
             goalValue = Core.Nothing}
instance Core.FromJSON GoalData where
        parseJSON
          = Core.withObject "GoalData"
              (\ o ->
                 GoalData Core.<$>
                   (o Core..:? "goalCompletionLocation") Core.<*>
                     (o Core..:? "goalCompletions" Core.<&> Core.fmap Core.fromAsText)
...
instance Core.ToJSON GoalData where
        toJSON GoalData{..}
          = Core.object
              (Core.catMaybes
                 [("goalCompletionLocation" Core..=) Core.<$>
                    goalCompletionLocation,
                  ("goalCompletions" Core..=) Core.. Core.AsText Core.<$>
                    goalCompletions,
...
newMetric 
    ::  Metric
newMetric
  = Metric{alias = Core.Nothing, expression = Core.Nothing,
...
instance Core.FromJSON Metric where
        parseJSON
          = Core.withObject "Metric"
              (\ o ->
                 Metric Core.<$>
                   (o Core..:? "alias") Core.<*> (o Core..:? "expression") Core.<*>
                     (o Core..:? "formattingType"))
...
newMetricFilter 
    ::  MetricFilter
newMetricFilter
  = MetricFilter{comparisonValue = Core.Nothing,
                 metricName = Core.Nothing, not = Core.Nothing,
                 operator = Core.Nothing}
instance Core.FromJSON MetricFilter where
        parseJSON
          = Core.withObject "MetricFilter"
              (\ o ->
                 MetricFilter Core.<$>
                   (o Core..:? "comparisonValue") Core.<*> (o Core..:? "metricName")
                     Core.<*> (o Core..:? "not")
                     Core.<*> (o Core..:? "operator"))
...
newMetricFilterClause 
    ::  MetricFilterClause
newMetricFilterClause
  = MetricFilterClause{filters = Core.Nothing,
                       operator = Core.Nothing}
instance Core.FromJSON MetricFilterClause where
        parseJSON
          = Core.withObject "MetricFilterClause"
              (\ o ->
                 MetricFilterClause Core.<$>
                   (o Core..:? "filters") Core.<*> (o Core..:? "operator"))
...
newMetricHeader 
    ::  MetricHeader
newMetricHeader
  = MetricHeader{metricHeaderEntries = Core.Nothing,
...
instance Core.FromJSON MetricHeader where
        parseJSON
          = Core.withObject "MetricHeader"
              (\ o ->
                 MetricHeader Core.<$>
                   (o Core..:? "metricHeaderEntries") Core.<*>
                     (o Core..:? "pivotHeaders"))
...
instance Core.FromJSON MetricHeaderEntry where
        parseJSON
          = Core.withObject "MetricHeaderEntry"
              (\ o ->
                 MetricHeaderEntry Core.<$>
...
instance Core.FromJSON OrFiltersForSegment where
        parseJSON
          = Core.withObject "OrFiltersForSegment"
              (\ o ->
...
newOrderBy 
    ::  OrderBy
newOrderBy
  = OrderBy{fieldName = Core.Nothing, orderType = Core.Nothing,
...
instance Core.FromJSON OrderBy where
        parseJSON
          = Core.withObject "OrderBy"
              (\ o ->
                 OrderBy Core.<$>
                   (o Core..:? "fieldName") Core.<*> (o Core..:? "orderType") Core.<*>
                     (o Core..:? "sortOrder"))
...
instance Core.FromJSON PageviewData where
        parseJSON
          = Core.withObject "PageviewData"
              (\ o ->
                 PageviewData Core.<$>
                   (o Core..:? "pagePath") Core.<*> (o Core..:? "pageTitle"))
...
newPivot 
    ::  Pivot
newPivot
  = Pivot{dimensionFilterClauses = Core.Nothing,
          dimensions = Core.Nothing, maxGroupCount = Core.Nothing,
          metrics = Core.Nothing, startGroup = Core.Nothing}
instance Core.FromJSON Pivot where
        parseJSON
          = Core.withObject "Pivot"
              (\ o ->
                 Pivot Core.<$>
                   (o Core..:? "dimensionFilterClauses") Core.<*>
                     (o Core..:? "dimensions")
...
instance Core.ToJSON Pivot where
        toJSON Pivot{..}
          = Core.object
              (Core.catMaybes
                 [("dimensionFilterClauses" Core..=) Core.<$>
...
newPivotHeader 
    ::  PivotHeader
newPivotHeader
  = PivotHeader{pivotHeaderEntries = Core.Nothing,
...
instance Core.FromJSON PivotHeader where
        parseJSON
          = Core.withObject "PivotHeader"
              (\ o ->
                 PivotHeader Core.<$>
                   (o Core..:? "pivotHeaderEntries") Core.<*>
                     (o Core..:? "totalPivotGroupsCount"))
...
newPivotHeaderEntry 
    ::  PivotHeaderEntry
newPivotHeaderEntry
  = PivotHeaderEntry{dimensionNames = Core.Nothing,
                     dimensionValues = Core.Nothing, metric = Core.Nothing}
instance Core.FromJSON PivotHeaderEntry where
        parseJSON
          = Core.withObject "PivotHeaderEntry"
              (\ o ->
                 PivotHeaderEntry Core.<$>
                   (o Core..:? "dimensionNames") Core.<*>
...
instance Core.FromJSON PivotValueRegion where
        parseJSON
          = Core.withObject "PivotValueRegion"
...
newProductData 
    ::  ProductData
newProductData
  = ProductData{itemRevenue = Core.Nothing,
                productName = Core.Nothing, productQuantity = Core.Nothing,
                productSku = Core.Nothing}
instance Core.FromJSON ProductData where
        parseJSON
          = Core.withObject "ProductData"
              (\ o ->
                 ProductData Core.<$>
                   (o Core..:? "itemRevenue") Core.<*> (o Core..:? "productName")
                     Core.<*>
                     (o Core..:? "productQuantity" Core.<&> Core.fmap Core.fromAsText)
          ...
          = Core.object
              (Core.catMaybes
                 [("itemRevenue" Core..=) Core.<$> itemRevenue,
                  ...
                  ("productQuantity" Core..=) Core.. Core.AsText Core.<$>
                    productQuantity,
...
newReport 
    ::  Report
newReport
  = Report{columnHeader = Core.Nothing, data' = Core.Nothing,
...
instance Core.FromJSON Report where
        parseJSON
          = Core.withObject "Report"
              (\ o ->
                 Report Core.<$>
                   (o Core..:? "columnHeader") Core.<*> (o Core..:? "data") Core.<*>
...
newReportData 
    ::  ReportData
newReportData
  = ReportData{dataLastRefreshed = Core.Nothing,
               emptyReason = Core.Nothing, isDataGolden = Core.Nothing,
               maximums = Core.Nothing, minimums = Core.Nothing,
               rowCount = Core.Nothing, rows = Core.Nothing,
               samplesReadCounts = Core.Nothing,
               samplingSpaceSizes = Core.Nothing, totals = Core.Nothing}
instance Core.FromJSON ReportData where
        parseJSON
          = Core.withObject "ReportData"
              (\ o ->
                 ReportData Core.<$>
                   (o Core..:? "dataLastRefreshed") Core.<*>
                     (o Core..:? "emptyReason")
                     ...
                     Core.<*> (o Core..:? "rows")
                     Core.<*>
                     (o Core..:? "samplesReadCounts" Core.<&>
                        Core.fmap (Core.fmap Core.fromAsText))
                     Core.<*>
                     (o Core..:? "samplingSpaceSizes" Core.<&>
                        Core.fmap (Core.fmap Core.fromAsText))
                     Core.<*> (o Core..:? "totals"))
          ...
          = Core.object
              (Core.catMaybes
                 [("dataLastRefreshed" Core..=) Core.<$> dataLastRefreshed,
                  ...
                  ("rows" Core..=) Core.<$> rows,
                  ("samplesReadCounts" Core..=) Core.. Core.fmap Core.AsText Core.<$>
                    samplesReadCounts,
                  ("samplingSpaceSizes" Core..=) Core.. Core.fmap Core.AsText
...
newReportRequest 
    ::  ReportRequest
newReportRequest
  = ReportRequest{cohortGroup = Core.Nothing,
                  dateRanges = Core.Nothing, dimensionFilterClauses = Core.Nothing,
                  dimensions = Core.Nothing, filtersExpression = Core.Nothing,
                  hideTotals = Core.Nothing, hideValueRanges = Core.Nothing,
                  includeEmptyRows = Core.Nothing,
                  metricFilterClauses = Core.Nothing, metrics = Core.Nothing,
                  orderBys = Core.Nothing, pageSize = Core.Nothing,
                  pageToken = Core.Nothing, pivots = Core.Nothing,
                  samplingLevel = Core.Nothing, segments = Core.Nothing,
                  viewId = Core.Nothing}
instance Core.FromJSON ReportRequest where
        parseJSON
          = Core.withObject "ReportRequest"
              (\ o ->
                 ReportRequest Core.<$>
                   (o Core..:? "cohortGroup") Core.<*> (o Core..:? "dateRanges")
...
instance Core.FromJSON ReportRow where
        parseJSON
          = Core.withObject "ReportRow"
              (\ o ->
                 ReportRow Core.<$>
                   (o Core..:? "dimensions") Core.<*> (o Core..:? "metrics"))
...
newResourceQuotasRemaining 
    ::  ResourceQuotasRemaining
newResourceQuotasRemaining
  = ResourceQuotasRemaining{dailyQuotaTokensRemaining = Core.Nothing,
                            hourlyQuotaTokensRemaining = Core.Nothing}
instance Core.FromJSON ResourceQuotasRemaining where
        parseJSON
          = Core.withObject "ResourceQuotasRemaining"
              (\ o ->
                 ResourceQuotasRemaining Core.<$>
                   (o Core..:? "dailyQuotaTokensRemaining") Core.<*>
                     (o Core..:? "hourlyQuotaTokensRemaining"))

instance Core.ToJSON ResourceQuotasRemaining where
        toJSON ResourceQuotasRemaining{..}
          = Core.object
              (Core.catMaybes
                 [("dailyQuotaTokensRemaining" Core..=) Core.<$>
                    dailyQuotaTokensRemaining,
                  ("hourlyQuotaTokensRemaining" Core..=) Core.<$>
...
newScreenviewData 
    ::  ScreenviewData
newScreenviewData
  = ScreenviewData{appName = Core.Nothing,
                   mobileDeviceBranding = Core.Nothing,
                   mobileDeviceModel = Core.Nothing, screenName = Core.Nothing}
instance Core.FromJSON ScreenviewData where
        parseJSON
          = Core.withObject "ScreenviewData"
              (\ o ->
                 ScreenviewData Core.<$>
                   (o Core..:? "appName") Core.<*> (o Core..:? "mobileDeviceBranding")
...
newSearchUserActivityRequest 
    ::  SearchUserActivityRequest
newSearchUserActivityRequest
  = SearchUserActivityRequest{activityTypes = Core.Nothing,
                              dateRange = Core.Nothing, pageSize = Core.Nothing,
                              pageToken = Core.Nothing, user = Core.Nothing,
                              viewId = Core.Nothing}
instance Core.FromJSON SearchUserActivityRequest where
        parseJSON
          = Core.withObject "SearchUserActivityRequest"
              (\ o ->
                 SearchUserActivityRequest Core.<$>
                   (o Core..:? "activityTypes") Core.<*> (o Core..:? "dateRange")
                     Core.<*> (o Core..:? "pageSize")
                     Core.<*> (o Core..:? "pageToken")
                     Core.<*> (o Core..:? "user")
                     Core.<*> (o Core..:? "viewId"))
...
newSearchUserActivityResponse 
    ::  SearchUserActivityResponse
newSearchUserActivityResponse
  = SearchUserActivityResponse{nextPageToken = Core.Nothing,
                               sampleRate = Core.Nothing, sessions = Core.Nothing,
                               totalRows = Core.Nothing}
instance Core.FromJSON SearchUserActivityResponse where
        parseJSON
          = Core.withObject "SearchUserActivityResponse"
              (\ o ->
                 SearchUserActivityResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "sampleRate")
...
instance Core.FromJSON Segment where
        parseJSON
          = Core.withObject "Segment"
              (\ o ->
                 Segment Core.<$>
                   (o Core..:? "dynamicSegment") Core.<*> (o Core..:? "segmentId"))
...
instance Core.FromJSON SegmentDefinition where
        parseJSON
          = Core.withObject "SegmentDefinition"
...
newSegmentDimensionFilter 
    ::  SegmentDimensionFilter
newSegmentDimensionFilter
  = SegmentDimensionFilter{caseSensitive = Core.Nothing,
                           dimensionName = Core.Nothing, expressions = Core.Nothing,
                           maxComparisonValue = Core.Nothing,
                           minComparisonValue = Core.Nothing, operator = Core.Nothing}
instance Core.FromJSON SegmentDimensionFilter where
        parseJSON
          = Core.withObject "SegmentDimensionFilter"
              (\ o ->
                 SegmentDimensionFilter Core.<$>
                   (o Core..:? "caseSensitive") Core.<*> (o Core..:? "dimensionName")
                     Core.<*> (o Core..:? "expressions")
...
newSegmentFilter 
    ::  SegmentFilter
newSegmentFilter
  = SegmentFilter{not = Core.Nothing, sequenceSegment = Core.Nothing,
                  simpleSegment = Core.Nothing}
instance Core.FromJSON SegmentFilter where
        parseJSON
          = Core.withObject "SegmentFilter"
              (\ o ->
                 SegmentFilter Core.<$>
                   (o Core..:? "not") Core.<*> (o Core..:? "sequenceSegment") Core.<*>
                     (o Core..:? "simpleSegment"))
...
newSegmentFilterClause 
    ::  SegmentFilterClause
newSegmentFilterClause
  = SegmentFilterClause{dimensionFilter = Core.Nothing,
                        metricFilter = Core.Nothing, not = Core.Nothing}
instance Core.FromJSON SegmentFilterClause where
        parseJSON
          = Core.withObject "SegmentFilterClause"
              (\ o ->
                 SegmentFilterClause Core.<$>
                   (o Core..:? "dimensionFilter") Core.<*> (o Core..:? "metricFilter")
                     Core.<*> (o Core..:? "not"))
...
newSegmentMetricFilter 
    ::  SegmentMetricFilter
newSegmentMetricFilter
  = SegmentMetricFilter{comparisonValue = Core.Nothing,
                        maxComparisonValue = Core.Nothing, metricName = Core.Nothing,
                        operator = Core.Nothing, scope = Core.Nothing}
instance Core.FromJSON SegmentMetricFilter where
        parseJSON
          = Core.withObject "SegmentMetricFilter"
              (\ o ->
                 SegmentMetricFilter Core.<$>
                   (o Core..:? "comparisonValue") Core.<*>
                     (o Core..:? "maxComparisonValue")
...
newSegmentSequenceStep 
    ::  SegmentSequenceStep
newSegmentSequenceStep
  = SegmentSequenceStep{matchType = Core.Nothing,
                        orFiltersForSegment = Core.Nothing}
instance Core.FromJSON SegmentSequenceStep where
        parseJSON
          = Core.withObject "SegmentSequenceStep"
              (\ o ->
                 SegmentSequenceStep Core.<$>
                   (o Core..:? "matchType") Core.<*>
                     (o Core..:? "orFiltersForSegment"))
...
newSequenceSegment 
    ::  SequenceSegment
newSequenceSegment
  = SequenceSegment{firstStepShouldMatchFirstHit = Core.Nothing,
                    segmentSequenceSteps = Core.Nothing}
instance Core.FromJSON SequenceSegment where
        parseJSON
          = Core.withObject "SequenceSegment"
              (\ o ->
                 SequenceSegment Core.<$>
                   (o Core..:? "firstStepShouldMatchFirstHit") Core.<*>
                     (o Core..:? "segmentSequenceSteps"))

instance Core.ToJSON SequenceSegment where
        toJSON SequenceSegment{..}
          = Core.object
              (Core.catMaybes
                 [("firstStepShouldMatchFirstHit" Core..=) Core.<$>
...
newTransactionData 
    ::  TransactionData
newTransactionData
  = TransactionData{transactionId = Core.Nothing,
                    transactionRevenue = Core.Nothing,
                    transactionShipping = Core.Nothing, transactionTax = Core.Nothing}
instance Core.FromJSON TransactionData where
        parseJSON
          = Core.withObject "TransactionData"
              (\ o ->
                 TransactionData Core.<$>
                   (o Core..:? "transactionId") Core.<*>
                     (o Core..:? "transactionRevenue")
...
newUserActivitySession 
    ::  UserActivitySession
newUserActivitySession
  = UserActivitySession{activities = Core.Nothing,
                        dataSource = Core.Nothing, deviceCategory = Core.Nothing,
                        platform = Core.Nothing, sessionDate = Core.Nothing,
                        sessionId = Core.Nothing}
instance Core.FromJSON UserActivitySession where
        parseJSON
          = Core.withObject "UserActivitySession"
              (\ o ->
                 UserActivitySession Core.<$>
                   (o Core..:? "activities") Core.<*> (o Core..:? "dataSource")
