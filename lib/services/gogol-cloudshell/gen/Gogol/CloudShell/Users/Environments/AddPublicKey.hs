...
type CloudShellUsersEnvironmentsAddPublicKeyResource =
     "v1" Core.:>
       Core.CaptureMode "environment" "addPublicKey" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] AddPublicKeyRequest Core.:>
...
newCloudShellUsersEnvironmentsAddPublicKey environment payload
  = CloudShellUsersEnvironmentsAddPublicKey{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            environment = environment, payload = payload,
                                            uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudShellUsersEnvironmentsAddPublicKey
         where
        type Rs CloudShellUsersEnvironmentsAddPublicKey = Operation
        type Scopes CloudShellUsersEnvironmentsAddPublicKey =
