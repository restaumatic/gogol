...
type CloudShellUsersEnvironmentsRemovePublicKeyResource =
     "v1" Core.:>
       Core.CaptureMode "environment" "removePublicKey" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] RemovePublicKeyRequest Core.:>
...
newCloudShellUsersEnvironmentsRemovePublicKey environment payload
  = CloudShellUsersEnvironmentsRemovePublicKey{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes CloudShellUsersEnvironmentsRemovePublicKey =
