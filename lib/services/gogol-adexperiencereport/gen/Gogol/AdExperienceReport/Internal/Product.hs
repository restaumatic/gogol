...
newPlatformSummary 
    ::  PlatformSummary
newPlatformSummary
  = PlatformSummary{betterAdsStatus = Core.Nothing,
                    enforcementTime = Core.Nothing, filterStatus = Core.Nothing,
                    lastChangeTime = Core.Nothing, region = Core.Nothing,
                    reportUrl = Core.Nothing, underReview = Core.Nothing}
instance Core.FromJSON PlatformSummary where
        parseJSON
          = Core.withObject "PlatformSummary"
              (\ o ->
                 PlatformSummary Core.<$>
                   (o Core..:? "betterAdsStatus") Core.<*>
                     (o Core..:? "enforcementTime")
...
newSiteSummaryResponse 
    ::  SiteSummaryResponse
newSiteSummaryResponse
  = SiteSummaryResponse{desktopSummary = Core.Nothing,
                        mobileSummary = Core.Nothing, reviewedSite = Core.Nothing}
instance Core.FromJSON SiteSummaryResponse where
        parseJSON
          = Core.withObject "SiteSummaryResponse"
              (\ o ->
                 SiteSummaryResponse Core.<$>
                   (o Core..:? "desktopSummary") Core.<*> (o Core..:? "mobileSummary")
...
instance Core.FromJSON ViolatingSitesResponse where
        parseJSON
          = Core.withObject "ViolatingSitesResponse"
              (\ o ->
