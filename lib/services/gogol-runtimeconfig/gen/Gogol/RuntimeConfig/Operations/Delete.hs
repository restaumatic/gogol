...
type RuntimeConfigOperationsDeleteResource =
     "v1" Core.:>
...
-- | Deletes a long-running operation. This method indicates that the client is no longer interested in the operation result. It does not cancel the operation. If the server doesn\'t support this method, it returns @google.rpc.Code.UNIMPLEMENTED@.
--
-- /See:/ 'newRuntimeConfigOperationsDelete' smart constructor.
data RuntimeConfigOperationsDelete = RuntimeConfigOperationsDelete
    {
      -- | V1 error format.
...
-- | Creates a value of 'RuntimeConfigOperationsDelete' with the minimum fields required to make a request.
newRuntimeConfigOperationsDelete 
    :: 
                                 Core.Text
       -- ^  The name of the operation resource to be deleted. See 'name'.
    -> RuntimeConfigOperationsDelete
newRuntimeConfigOperationsDelete name
  = RuntimeConfigOperationsDelete{xgafv = Core.Nothing,
                                  accessToken = Core.Nothing, callback = Core.Nothing, name = name,
                                  uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest RuntimeConfigOperationsDelete where
        type Rs RuntimeConfigOperationsDelete = Empty
        type Scopes RuntimeConfigOperationsDelete =
        ...
        requestClient RuntimeConfigOperationsDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy RuntimeConfigOperationsDeleteResource)
                      Core.mempty
