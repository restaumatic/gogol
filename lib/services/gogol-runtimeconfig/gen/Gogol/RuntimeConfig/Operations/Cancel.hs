...
newRuntimeConfigOperationsCancel name payload
  = RuntimeConfigOperationsCancel{xgafv = Core.Nothing,
                                  accessToken = Core.Nothing, callback = Core.Nothing, name = name,
                                  payload = payload, uploadType = Core.Nothing,
                                  uploadProtocol = Core.Nothing}
instance Core.GoogleRequest RuntimeConfigOperationsCancel where
        type Rs RuntimeConfigOperationsCancel = Empty
        type Scopes RuntimeConfigOperationsCancel =
        ...
        requestClient RuntimeConfigOperationsCancel{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy RuntimeConfigOperationsCancelResource)
                      Core.mempty
