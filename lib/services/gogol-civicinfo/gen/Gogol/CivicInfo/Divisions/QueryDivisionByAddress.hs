                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.Get '[Core.JSON] CivicinfoApiprotosV2DivisionByAddressResponse
...
newCivicInfoDivisionsQueryDivisionByAddress 
    :: 
                                            CivicInfoDivisionsQueryDivisionByAddress
newCivicInfoDivisionsQueryDivisionByAddress
  = CivicInfoDivisionsQueryDivisionByAddress{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        requestClient CivicInfoDivisionsQueryDivisionByAddress{..}
          = go xgafv accessToken address callback uploadType uploadProtocol
