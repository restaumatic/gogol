                 ...
                 Core.QueryParam "callback" Core.Text Core.:>
                   Core.QueryParam "electionId" Core.Int64 Core.:>
                     Core.QueryParam "officialOnly" Core.Bool Core.:>
                       Core.QueryParam "productionDataOnly" Core.Bool Core.:>
                         Core.QueryParam "returnAllAvailableData" Core.Bool Core.:>
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.Get '[Core.JSON] CivicinfoApiprotosV2VoterInfoResponse
...
newCivicInfoElectionsVoterInfoQuery 
    :: 
                                    CivicInfoElectionsVoterInfoQuery
newCivicInfoElectionsVoterInfoQuery
  = CivicInfoElectionsVoterInfoQuery{xgafv = Core.Nothing,
                                     accessToken = Core.Nothing, address = Core.Nothing,
                                     callback = Core.Nothing, electionId = 0,
                                     officialOnly = Core.False, productionDataOnly = Core.True,
                                     returnAllAvailableData = Core.False, uploadType = Core.Nothing,
...
instance Core.GoogleRequest CivicInfoElectionsVoterInfoQuery where
        ...
        requestClient CivicInfoElectionsVoterInfoQuery{..}
          = go xgafv accessToken address callback (Core.Just electionId)
