                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.Get '[Core.JSON] CivicinfoApiprotosV2ElectionsQueryResponse
...
newCivicInfoElectionsElectionQuery 
    :: 
                                   CivicInfoElectionsElectionQuery
newCivicInfoElectionsElectionQuery
  = CivicInfoElectionsElectionQuery{xgafv = Core.Nothing,
                                    accessToken = Core.Nothing, callback = Core.Nothing,
                                    productionDataOnly = Core.True, uploadType = Core.Nothing,
...
instance Core.GoogleRequest CivicInfoElectionsElectionQuery where
        ...
        requestClient CivicInfoElectionsElectionQuery{..}
          = go xgafv accessToken callback (Core.Just productionDataOnly)
              uploadType
              uploadProtocol
