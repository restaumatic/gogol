...
type LibraryAgentShelvesBooksBorrowResource =
     "v1" Core.:>
       Core.CaptureMode "name" "borrow" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.Post '[Core.JSON] GoogleExampleLibraryagentV1Book
...
newLibraryAgentShelvesBooksBorrow name
  = LibraryAgentShelvesBooksBorrow{xgafv = Core.Nothing,
                                   accessToken = Core.Nothing, callback = Core.Nothing, name = name,
                                   uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest LibraryAgentShelvesBooksBorrow where
        type Rs LibraryAgentShelvesBooksBorrow =
             GoogleExampleLibraryagentV1Book
        type Scopes LibraryAgentShelvesBooksBorrow =
        ...
        requestClient LibraryAgentShelvesBooksBorrow{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy LibraryAgentShelvesBooksBorrowResource)
                      Core.mempty
