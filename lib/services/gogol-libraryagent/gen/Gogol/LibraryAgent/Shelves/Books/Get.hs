               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.Get '[Core.JSON] GoogleExampleLibraryagentV1Book
...
newLibraryAgentShelvesBooksGet name
  = LibraryAgentShelvesBooksGet{xgafv = Core.Nothing,
                                accessToken = Core.Nothing, callback = Core.Nothing, name = name,
                                uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest LibraryAgentShelvesBooksGet where
        type Rs LibraryAgentShelvesBooksGet =
             GoogleExampleLibraryagentV1Book
        type Scopes LibraryAgentShelvesBooksGet =
        ...
        requestClient LibraryAgentShelvesBooksGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy LibraryAgentShelvesBooksGetResource)
                      Core.mempty
