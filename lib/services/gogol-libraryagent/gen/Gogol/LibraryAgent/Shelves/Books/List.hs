                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] GoogleExampleLibraryagentV1ListBooksResponse
...
instance Core.GoogleRequest LibraryAgentShelvesBooksList where
        ...
        requestClient LibraryAgentShelvesBooksList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy LibraryAgentShelvesBooksListResource)
                      Core.mempty
