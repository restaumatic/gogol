...
-- |
-- Module      : Gogol.LibraryAgent.Shelves.List
...
newLibraryAgentShelvesList 
    ::  LibraryAgentShelvesList
newLibraryAgentShelvesList
  = LibraryAgentShelvesList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest LibraryAgentShelvesList where
        type Rs LibraryAgentShelvesList =
             GoogleExampleLibraryagentV1ListShelvesResponse
        type Scopes LibraryAgentShelvesList = '[CloudPlatform'FullControl]
        requestClient LibraryAgentShelvesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy LibraryAgentShelvesListResource)
                      Core.mempty
