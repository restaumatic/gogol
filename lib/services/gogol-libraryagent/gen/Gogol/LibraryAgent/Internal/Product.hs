...
newGoogleExampleLibraryagentV1Book 
    :: 
                                   GoogleExampleLibraryagentV1Book
newGoogleExampleLibraryagentV1Book
  = GoogleExampleLibraryagentV1Book{author = Core.Nothing,
                                    name = Core.Nothing, read = Core.Nothing, title = Core.Nothing}
instance Core.FromJSON GoogleExampleLibraryagentV1Book where
        parseJSON
          = Core.withObject "GoogleExampleLibraryagentV1Book"
              (\ o ->
                 GoogleExampleLibraryagentV1Book Core.<$>
                   (o Core..:? "author") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "read")
                     Core.<*> (o Core..:? "title"))

instance Core.ToJSON GoogleExampleLibraryagentV1Book where
        toJSON GoogleExampleLibraryagentV1Book{..}
          = Core.object
              (Core.catMaybes
                 [("author" Core..=) Core.<$> author,
                  ("name" Core..=) Core.<$> name, ("read" Core..=) Core.<$> read,
...
newGoogleExampleLibraryagentV1ListBooksResponse 
    :: 
                                                GoogleExampleLibraryagentV1ListBooksResponse
newGoogleExampleLibraryagentV1ListBooksResponse
  = GoogleExampleLibraryagentV1ListBooksResponse{books =
                                                   Core.Nothing,
                                                 nextPageToken = Core.Nothing}
instance Core.FromJSON GoogleExampleLibraryagentV1ListBooksResponse
         where
        parseJSON
          = Core.withObject "GoogleExampleLibraryagentV1ListBooksResponse"
              (\ o ->
                 GoogleExampleLibraryagentV1ListBooksResponse Core.<$>
                   (o Core..:? "books") Core.<*> (o Core..:? "nextPageToken"))

instance Core.ToJSON GoogleExampleLibraryagentV1ListBooksResponse
         where
        toJSON GoogleExampleLibraryagentV1ListBooksResponse{..}
          = Core.object
              (Core.catMaybes
...
newGoogleExampleLibraryagentV1ListShelvesResponse 
    :: 
                                                  GoogleExampleLibraryagentV1ListShelvesResponse
newGoogleExampleLibraryagentV1ListShelvesResponse
  = GoogleExampleLibraryagentV1ListShelvesResponse{nextPageToken =
                                                     Core.Nothing,
                                                   shelves = Core.Nothing}
instance Core.FromJSON
           GoogleExampleLibraryagentV1ListShelvesResponse
         where
        parseJSON
          = Core.withObject "GoogleExampleLibraryagentV1ListShelvesResponse"
              (\ o ->
                 GoogleExampleLibraryagentV1ListShelvesResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "shelves"))

instance Core.ToJSON GoogleExampleLibraryagentV1ListShelvesResponse
         where
        toJSON GoogleExampleLibraryagentV1ListShelvesResponse{..}
          = Core.object
              (Core.catMaybes
                 [("nextPageToken" Core..=) Core.<$> nextPageToken,
...
newGoogleExampleLibraryagentV1Shelf 
    :: 
                                    GoogleExampleLibraryagentV1Shelf
newGoogleExampleLibraryagentV1Shelf
  = GoogleExampleLibraryagentV1Shelf{name = Core.Nothing,
                                     theme = Core.Nothing}
instance Core.FromJSON GoogleExampleLibraryagentV1Shelf where
        parseJSON
...
instance Core.ToJSON GoogleExampleLibraryagentV1Shelf where
        toJSON GoogleExampleLibraryagentV1Shelf{..}
          = Core.object
              (Core.catMaybes
                 [("name" Core..=) Core.<$> name, ("theme" Core..=) Core.<$> theme])
