...
module Gogol.Storage.Internal.Product
  (
    ...
    Bucket_Encryption_CustomerManagedEncryptionEnforcementConfig (..),
    newBucket_Encryption_CustomerManagedEncryptionEnforcementConfig,

    -- * Bucket_Encryption_CustomerSuppliedEncryptionEnforcementConfig
    Bucket_Encryption_CustomerSuppliedEncryptionEnforcementConfig (..),
    newBucket_Encryption_CustomerSuppliedEncryptionEnforcementConfig,

    -- * Bucket_Encryption_GoogleManagedEncryptionEnforcementConfig
    Bucket_Encryption_GoogleManagedEncryptionEnforcementConfig (..),
    newBucket_Encryption_GoogleManagedEncryptionEnforcementConfig,
    ...
    -- * Object_Contexts_Custom
    Object_Contexts_Custom (..),
    newObject_Contexts_Custom,
...
data Bucket_Encryption = Bucket_Encryption
    {
      ...
      customerManagedEncryptionEnforcementConfig :: (Core.Maybe
   Bucket_Encryption_CustomerManagedEncryptionEnforcementConfig)
    ...
    , customerSuppliedEncryptionEnforcementConfig :: (Core.Maybe
   Bucket_Encryption_CustomerSuppliedEncryptionEnforcementConfig)
    ...
    , googleManagedEncryptionEnforcementConfig :: (Core.Maybe
   Bucket_Encryption_GoogleManagedEncryptionEnforcementConfig)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newBucket_Encryption 
    ::  Bucket_Encryption
newBucket_Encryption
  = Bucket_Encryption{customerManagedEncryptionEnforcementConfig =
                        Core.Nothing,
                      customerSuppliedEncryptionEnforcementConfig = Core.Nothing,
                      defaultKmsKeyName = Core.Nothing,
                      googleManagedEncryptionEnforcementConfig = Core.Nothing}
instance Core.FromJSON Bucket_Encryption where
        parseJSON
          = Core.withObject "Bucket_Encryption"
              (\ o ->
                 Bucket_Encryption Core.<$>
                   (o Core..:? "customerManagedEncryptionEnforcementConfig") Core.<*>
                     (o Core..:? "customerSuppliedEncryptionEnforcementConfig")
                     Core.<*> (o Core..:? "defaultKmsKeyName")
                     Core.<*> (o Core..:? "googleManagedEncryptionEnforcementConfig"))

instance Core.ToJSON Bucket_Encryption where
        toJSON Bucket_Encryption{..}
          = Core.object
              (Core.catMaybes
                 [("customerManagedEncryptionEnforcementConfig" Core..=) Core.<$>
                    customerManagedEncryptionEnforcementConfig,
                  ("customerSuppliedEncryptionEnforcementConfig" Core..=) Core.<$>
                    customerSuppliedEncryptionEnforcementConfig,
                  ("defaultKmsKeyName" Core..=) Core.<$> defaultKmsKeyName,
                  ("googleManagedEncryptionEnforcementConfig" Core..=) Core.<$>
                    googleManagedEncryptionEnforcementConfig])


-- | If set, the new objects created in this bucket must comply with this enforcement config. Changing this has no effect on existing objects; it applies to new objects only. If omitted, the new objects are allowed to be encrypted with Customer Managed Encryption type by default.
--
-- /See:/ 'newBucket_Encryption_CustomerManagedEncryptionEnforcementConfig' smart constructor.
data Bucket_Encryption_CustomerManagedEncryptionEnforcementConfig = Bucket_Encryption_CustomerManagedEncryptionEnforcementConfig
    {
    ...
    , restrictionMode :: (Core.Maybe
   Bucket_Encryption_CustomerManagedEncryptionEnforcementConfig_RestrictionMode)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'Bucket_Encryption_CustomerManagedEncryptionEnforcementConfig' with the minimum fields required to make a request.
newBucket_Encryption_CustomerManagedEncryptionEnforcementConfig 
    :: 
                                                                Bucket_Encryption_CustomerManagedEncryptionEnforcementConfig
newBucket_Encryption_CustomerManagedEncryptionEnforcementConfig
  = Bucket_Encryption_CustomerManagedEncryptionEnforcementConfig{effectiveTime
                                                                   = Core.Nothing,
                                                                 restrictionMode = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("effectiveTime" Core..=) Core.<$> effectiveTime,
                  ("restrictionMode" Core..=) Core.<$> restrictionMode])


-- | If set, the new objects created in this bucket must comply with this enforcement config. Changing this has no effect on existing objects; it applies to new objects only. If omitted, the new objects are allowed to be encrypted with Customer Supplied Encryption type by default.
--
-- /See:/ 'newBucket_Encryption_CustomerSuppliedEncryptionEnforcementConfig' smart constructor.
data Bucket_Encryption_CustomerSuppliedEncryptionEnforcementConfig = Bucket_Encryption_CustomerSuppliedEncryptionEnforcementConfig
    {
      -- | Server-determined value that indicates the time from which configuration was enforced and effective. This value is in RFC 3339 format.
      effectiveTime :: (Core.Maybe Core.DateTime)
...
-- | Creates a value of 'Bucket_Encryption_CustomerSuppliedEncryptionEnforcementConfig' with the minimum fields required to make a request.
newBucket_Encryption_CustomerSuppliedEncryptionEnforcementConfig 
    :: 
                                                                 Bucket_Encryption_CustomerSuppliedEncryptionEnforcementConfig
newBucket_Encryption_CustomerSuppliedEncryptionEnforcementConfig
  = Bucket_Encryption_CustomerSuppliedEncryptionEnforcementConfig{effectiveTime
                                                                    = Core.Nothing,
                                                                  restrictionMode = Core.Nothing}
instance Core.FromJSON
           Bucket_Encryption_CustomerSuppliedEncryptionEnforcementConfig
...
-- | If set, the new objects created in this bucket must comply with this enforcement config. Changing this has no effect on existing objects; it applies to new objects only. If omitted, the new objects are allowed to be encrypted with Google Managed Encryption type by default.
--
-- /See:/ 'newBucket_Encryption_GoogleManagedEncryptionEnforcementConfig' smart constructor.
data Bucket_Encryption_GoogleManagedEncryptionEnforcementConfig = Bucket_Encryption_GoogleManagedEncryptionEnforcementConfig
    {
      -- | Server-determined value that indicates the time from which configuration was enforced and effective. This value is in RFC 3339 format.
      effectiveTime :: (Core.Maybe Core.DateTime)
...
-- | Creates a value of 'Bucket_Encryption_GoogleManagedEncryptionEnforcementConfig' with the minimum fields required to make a request.
newBucket_Encryption_GoogleManagedEncryptionEnforcementConfig 
    :: 
                                                              Bucket_Encryption_GoogleManagedEncryptionEnforcementConfig
newBucket_Encryption_GoogleManagedEncryptionEnforcementConfig
  = Bucket_Encryption_GoogleManagedEncryptionEnforcementConfig{effectiveTime
                                                                 = Core.Nothing,
                                                               restrictionMode = Core.Nothing}
instance Core.FromJSON
           Bucket_Encryption_GoogleManagedEncryptionEnforcementConfig
        ...
        parseJSON
          = Core.withObject
              "Bucket_Encryption_GoogleManagedEncryptionEnforcementConfig"
              (\ o ->
                 Bucket_Encryption_GoogleManagedEncryptionEnforcementConfig Core.<$>
                   (o Core..:? "effectiveTime") Core.<*>
                     (o Core..:? "restrictionMode"))
...
data BulkRestoreObjectsRequest = BulkRestoreObjectsRequest
    ...
    , createdAfterTime :: (Core.Maybe Core.DateTime)
      -- | Restores only the objects that were created before this time.
    , createdBeforeTime :: (Core.Maybe Core.DateTime)
...
newBulkRestoreObjectsRequest
  = BulkRestoreObjectsRequest{allowOverwrite = Core.Nothing,
                              copySourceAcl = Core.Nothing, createdAfterTime = Core.Nothing,
                              createdBeforeTime = Core.Nothing, matchGlobs = Core.Nothing,
              ...
              (\ o ->
                 BulkRestoreObjectsRequest Core.<$>
                   (o Core..:? "allowOverwrite") Core.<*> (o Core..:? "copySourceAcl")
                     Core.<*> (o Core..:? "createdAfterTime")
                     Core.<*> (o Core..:? "createdBeforeTime")
          ...
          = Core.object
              (Core.catMaybes
                 [("allowOverwrite" Core..=) Core.<$> allowOverwrite,
                  ...
                  ("createdAfterTime" Core..=) Core.<$> createdAfterTime,
                  ("createdBeforeTime" Core..=) Core.<$> createdBeforeTime,
...
data Object = Object
    ...
    , contexts :: (Core.Maybe Object_Contexts)
...
newObject
  = Object{acl = Core.Nothing, bucket = Core.Nothing,
           ...
           contexts = Core.Nothing, crc32c = Core.Nothing,
           customTime = Core.Nothing, customerEncryption = Core.Nothing,
           etag = Core.Nothing, eventBasedHold = Core.Nothing,
           generation = Core.Nothing, hardDeleteTime = Core.Nothing,
           id = Core.Nothing, kind = "storage#object",
           kmsKeyName = Core.Nothing, md5Hash = Core.Nothing,
           mediaLink = Core.Nothing, metadata = Core.Nothing,
           metageneration = Core.Nothing, name = Core.Nothing,
           owner = Core.Nothing, restoreToken = Core.Nothing,
           retention = Core.Nothing, retentionExpirationTime = Core.Nothing,
           selfLink = Core.Nothing, size = Core.Nothing,
           softDeleteTime = Core.Nothing, storageClass = Core.Nothing,
           temporaryHold = Core.Nothing, timeCreated = Core.Nothing,
           timeDeleted = Core.Nothing, timeFinalized = Core.Nothing,
...
-- | User-defined or system-defined object contexts. Each object context is a key-payload pair, where the key provides the identification and the payload holds the associated value and additional metadata.
--
-- /See:/ 'newObject_Contexts' smart constructor.
newtype Object_Contexts = Object_Contexts
    {
      -- | User-defined object contexts.
      custom :: (Core.Maybe Object_Contexts_Custom)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'Object_Contexts' with the minimum fields required to make a request.
newObject_Contexts 
    ::  Object_Contexts
newObject_Contexts = Object_Contexts{custom = Core.Nothing}
instance Core.FromJSON Object_Contexts where
        parseJSON
          = Core.withObject "Object_Contexts"
              (\ o -> Object_Contexts Core.<$> (o Core..:? "custom"))

instance Core.ToJSON Object_Contexts where
        toJSON Object_Contexts{..}
          = Core.object (Core.catMaybes [("custom" Core..=) Core.<$> custom])


-- | User-defined object contexts.
--
-- /See:/ 'newObject_Contexts_Custom' smart constructor.
newtype Object_Contexts_Custom = Object_Contexts_Custom
    {
      -- | A single user-defined object context.
      additional :: (Core.HashMap Core.Text ObjectCustomContextPayload)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'Object_Contexts_Custom' with the minimum fields required to make a request.
newObject_Contexts_Custom 
    :: 
                          Core.HashMap Core.Text ObjectCustomContextPayload
       -- ^  A single user-defined object context. See 'additional'.
    -> Object_Contexts_Custom
newObject_Contexts_Custom additional
  = Object_Contexts_Custom{additional = additional}
instance Core.FromJSON Object_Contexts_Custom where
        parseJSON
          = Core.withObject "Object_Contexts_Custom"
              (\ o -> Object_Contexts_Custom Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON Object_Contexts_Custom where
        toJSON Object_Contexts_Custom{..} = Core.toJSON additional
...
--
-- /See:/ 'newObjectCustomContextPayload' smart constructor.
data ObjectCustomContextPayload = ObjectCustomContextPayload
    {
...
-- | Creates a value of 'ObjectCustomContextPayload' with the minimum fields required to make a request.
newObjectCustomContextPayload 
    ::  ObjectCustomContextPayload
newObjectCustomContextPayload
  = ObjectCustomContextPayload{createTime = Core.Nothing,
                               updateTime = Core.Nothing, value = Core.Nothing}
instance Core.FromJSON ObjectCustomContextPayload where
        parseJSON
          = Core.withObject "ObjectCustomContextPayload"
              (\ o ->
                 ObjectCustomContextPayload Core.<$>
                   (o Core..:? "createTime") Core.<*> (o Core..:? "updateTime")
                     Core.<*> (o Core..:? "value"))

instance Core.ToJSON ObjectCustomContextPayload where
        toJSON ObjectCustomContextPayload{..}
          = Core.object
              (Core.catMaybes
                 [("createTime" Core..=) Core.<$> createTime,
                  ("updateTime" Core..=) Core.<$> updateTime,
