               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "userProject" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] Notification Core.:>
                       Core.Post '[Core.JSON] Notification
...
newStorageNotificationsInsert bucket payload
  = StorageNotificationsInsert{bucket = bucket, payload = payload,
...
instance Core.GoogleRequest StorageNotificationsInsert where
        ...
        type Scopes StorageNotificationsInsert =
