...
newStorageObjectAccessControlsInsert bucket object payload
  = StorageObjectAccessControlsInsert{bucket = bucket,
                                      generation = Core.Nothing, object = object, payload = payload,
                                      uploadType = Core.Nothing, userProject = Core.Nothing}
instance Core.GoogleRequest StorageObjectAccessControlsInsert where
        type Rs StorageObjectAccessControlsInsert = ObjectAccessControl
