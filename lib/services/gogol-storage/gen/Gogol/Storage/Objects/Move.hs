                           ...
                           Core.QueryParam "ifMetagenerationMatch" Core.Int64 Core.:>
                             Core.QueryParam "ifMetagenerationNotMatch" Core.Int64 Core.:>
                               Core.QueryParam "ifSourceGenerationMatch" Core.Int64 Core.:>
                                 Core.QueryParam "ifSourceGenerationNotMatch" Core.Int64 Core.:>
                                   Core.QueryParam "ifSourceMetagenerationMatch" Core.Int64 Core.:>
                                     Core.QueryParam "ifSourceMetagenerationNotMatch" Core.Int64
                                       Core.:>
                                       Core.QueryParam "projection" ObjectsMoveProjection Core.:>
...
data StorageObjectsMove = StorageObjectsMove
    ...
    , projection :: (Core.Maybe ObjectsMoveProjection)
...
newStorageObjectsMove bucket destinationObject sourceObject
  = StorageObjectsMove{bucket = bucket,
                       ...
                       projection = Core.Nothing, sourceObject = sourceObject,
...
instance Core.GoogleRequest StorageObjectsMove where
        ...
        type Scopes StorageObjectsMove =
             '[CloudPlatform'FullControl, Devstorage'FullControl,
               Devstorage'ReadWrite]
        requestClient StorageObjectsMove{..}
          = go bucket sourceObject destinationObject ifGenerationMatch
