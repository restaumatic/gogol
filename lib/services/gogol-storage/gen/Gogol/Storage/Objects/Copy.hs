                                         ...
                                         Core.QueryParam "ifSourceGenerationNotMatch" Core.Int64
                                           ...
                                           Core.QueryParam "ifSourceMetagenerationMatch" Core.Int64
                                             ...
                                             Core.QueryParam "ifSourceMetagenerationNotMatch"
                                               Core.Int64
                                               Core.:>
                                               Core.QueryParam "projection" ObjectsCopyProjection
                                                 Core.:>
...
newStorageObjectsCopy 
    ...
    -> StorageObjectsCopy
newStorageObjectsCopy destinationBucket destinationObject payload
  sourceBucket sourceObject
  = StorageObjectsCopy{destinationBucket = destinationBucket,
                       ...
                       ifSourceMetagenerationNotMatch = Core.Nothing, payload = payload,
                       projection = Core.Nothing, sourceBucket = sourceBucket,
                       sourceGeneration = Core.Nothing, sourceObject = sourceObject,
