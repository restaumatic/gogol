                       ...
                       Core.QueryParam "maxResults" Core.Word32 Core.:>
                         Core.QueryParam "pageToken" Core.Text Core.:>
                           Core.QueryParam "prefix" Core.Text Core.:>
                             Core.QueryParam "projection" ObjectsWatchAllProjection Core.:>
...
newStorageObjectsWatchAll bucket payload
  = StorageObjectsWatchAll{bucket = bucket, delimiter = Core.Nothing,
                           endOffset = Core.Nothing, includeTrailingDelimiter = Core.Nothing,
                           maxResults = 1000, pageToken = Core.Nothing, payload = payload,
                           prefix = Core.Nothing, projection = Core.Nothing,
...
instance Core.GoogleRequest StorageObjectsWatchAll where
        ...
        requestClient StorageObjectsWatchAll{..}
          = go bucket delimiter endOffset includeTrailingDelimiter
