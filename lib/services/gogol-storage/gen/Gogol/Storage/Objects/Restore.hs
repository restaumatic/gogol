                         ...
                         Core.QueryParam "ifGenerationNotMatch" Core.Int64 Core.:>
                           Core.QueryParam "ifMetagenerationMatch" Core.Int64 Core.:>
                             Core.QueryParam "ifMetagenerationNotMatch" Core.Int64 Core.:>
                               Core.QueryParam "projection" ObjectsRestoreProjection Core.:>
...
newStorageObjectsRestore bucket generation object
  = StorageObjectsRestore{bucket = bucket,
                          copySourceAcl = Core.Nothing, generation = generation,
...
instance Core.GoogleRequest StorageObjectsRestore where
        ...
        requestClient StorageObjectsRestore{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy StorageObjectsRestoreResource)
                      Core.mempty
