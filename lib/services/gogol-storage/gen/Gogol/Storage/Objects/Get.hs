                     ...
                     Core.QueryParam "ifGenerationNotMatch" Core.Int64 Core.:>
                       Core.QueryParam "ifMetagenerationMatch" Core.Int64 Core.:>
                         Core.QueryParam "ifMetagenerationNotMatch" Core.Int64 Core.:>
                           Core.QueryParam "projection" ObjectsGetProjection Core.:>
                             Core.QueryParam "restoreToken" Core.Text Core.:>
...
newStorageObjectsGet bucket object
  = StorageObjectsGet{bucket = bucket, generation = Core.Nothing,
                      ...
                      projection = Core.Nothing, restoreToken = Core.Nothing,
                      softDeleted = Core.Nothing, uploadType = Core.Nothing,
...
instance Core.GoogleRequest (Core.MediaDownload StorageObjectsGet)
         where
        type Rs (Core.MediaDownload StorageObjectsGet) = Core.Stream
        type Scopes (Core.MediaDownload StorageObjectsGet) =
             Core.Scopes StorageObjectsGet
        requestClient (Core.MediaDownload StorageObjectsGet{..})
          = go bucket object generation ifGenerationMatch
              ifGenerationNotMatch
              ifMetagenerationMatch
              ifMetagenerationNotMatch
