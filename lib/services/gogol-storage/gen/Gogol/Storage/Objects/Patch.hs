                       ...
                       Core.QueryParam "ifMetagenerationMatch" Core.Int64 Core.:>
                         Core.QueryParam "ifMetagenerationNotMatch" Core.Int64 Core.:>
                           Core.QueryParam "overrideUnlockedRetention" Core.Bool Core.:>
                             Core.QueryParam "predefinedAcl" ObjectsPatchPredefinedAcl Core.:>
                               Core.QueryParam "projection" ObjectsPatchProjection Core.:>
...
newStorageObjectsPatch bucket object payload
  = StorageObjectsPatch{bucket = bucket, generation = Core.Nothing,
...
instance Core.GoogleRequest StorageObjectsPatch where
        ...
        requestClient StorageObjectsPatch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy StorageObjectsPatchResource)
                      Core.mempty
