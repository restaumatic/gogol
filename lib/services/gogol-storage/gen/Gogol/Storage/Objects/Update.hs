                     ...
                     Core.QueryParam "ifGenerationNotMatch" Core.Int64 Core.:>
                       Core.QueryParam "ifMetagenerationMatch" Core.Int64 Core.:>
                         Core.QueryParam "ifMetagenerationNotMatch" Core.Int64 Core.:>
                           Core.QueryParam "overrideUnlockedRetention" Core.Bool Core.:>
                             Core.QueryParam "predefinedAcl" ObjectsUpdatePredefinedAcl Core.:>
                               Core.QueryParam "projection" ObjectsUpdateProjection Core.:>
...
data StorageObjectsUpdate = StorageObjectsUpdate
    ...
    , overrideUnlockedRetention :: (Core.Maybe Core.Bool)
...
newStorageObjectsUpdate bucket object payload
  = StorageObjectsUpdate{bucket = bucket, generation = Core.Nothing,
                         ifGenerationMatch = Core.Nothing,
                         ifGenerationNotMatch = Core.Nothing,
                         ifMetagenerationMatch = Core.Nothing,
                         ifMetagenerationNotMatch = Core.Nothing, object = object,
                         overrideUnlockedRetention = Core.Nothing, payload = payload,
...
instance Core.GoogleRequest StorageObjectsUpdate where
        ...
        requestClient StorageObjectsUpdate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy StorageObjectsUpdateResource)
                      Core.mempty
