                     ...
                     Core.Capture "destinationBucket" Core.Text Core.:>
                       "o" Core.:>
                         Core.Capture "destinationObject" Core.Text Core.:>
                           Core.QueryParam "destinationKmsKeyName" Core.Text Core.:>
                                 ...
                                 Core.QueryParam "ifGenerationNotMatch" Core.Int64 Core.:>
                                   Core.QueryParam "ifMetagenerationMatch" Core.Int64 Core.:>
                                     Core.QueryParam "ifMetagenerationNotMatch" Core.Int64 Core.:>
                                       Core.QueryParam "ifSourceGenerationMatch" Core.Int64 Core.:>
                                         Core.QueryParam "ifSourceGenerationNotMatch" Core.Int64
                                           Core.:>
                                           Core.QueryParam "ifSourceMetagenerationMatch" Core.Int64
                                             Core.:>
                                             Core.QueryParam "ifSourceMetagenerationNotMatch"
                                               Core.Int64
                                               Core.:>
                                               Core.QueryParam "maxBytesRewrittenPerCall" Core.Int64
                                                 Core.:>
                                                 Core.QueryParam "projection"
                                                   ObjectsRewriteProjection
                                                   Core.:>
                                                   Core.QueryParam "rewriteToken" Core.Text Core.:>
                                                     Core.QueryParam "sourceGeneration" Core.Int64
                                                       Core.:>
...
newStorageObjectsRewrite 
    ...
    -> StorageObjectsRewrite
newStorageObjectsRewrite destinationBucket destinationObject
  payload sourceBucket sourceObject
  = StorageObjectsRewrite{destinationBucket = destinationBucket,
                          ...
                          maxBytesRewrittenPerCall = Core.Nothing, payload = payload,
                          projection = Core.Nothing, rewriteToken = Core.Nothing,
                          sourceBucket = sourceBucket, sourceGeneration = Core.Nothing,
                          sourceObject = sourceObject, uploadType = Core.Nothing,
...
instance Core.GoogleRequest StorageObjectsRewrite where
        ...
        requestClient StorageObjectsRewrite{..}
          = go sourceBucket sourceObject destinationBucket destinationObject
