...
newStorageBucketsOperationsList bucket
  = StorageBucketsOperationsList{bucket = bucket,
                                 filter = Core.Nothing, pageSize = Core.Nothing,
                                 pageToken = Core.Nothing, uploadType = Core.Nothing}
instance Core.GoogleRequest StorageBucketsOperationsList where
        ...
        requestClient StorageBucketsOperationsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy StorageBucketsOperationsListResource)
                      Core.mempty
