           ...
           Core.Capture "bucket" Core.Text Core.:>
             "operations" Core.:>
               Core.Capture "operationId" Core.Text Core.:>
                 "advanceRelocateBucket" Core.:>
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] AdvanceRelocateBucketOperationRequest
...
newStorageBucketsOperationsAdvanceRelocateBucket 
    ...
    -> StorageBucketsOperationsAdvanceRelocateBucket
newStorageBucketsOperationsAdvanceRelocateBucket bucket operationId
  payload
  = StorageBucketsOperationsAdvanceRelocateBucket{bucket = bucket,
...
instance Core.GoogleRequest
        ...
        type Scopes StorageBucketsOperationsAdvanceRelocateBucket =
             '[CloudPlatform'FullControl, Devstorage'FullControl,
               Devstorage'ReadWrite]
        requestClient StorageBucketsOperationsAdvanceRelocateBucket{..}
          = go bucket operationId uploadType (Core.Just Core.AltJSON) payload
              storageService
          where go
                  = Core.buildClient
                      (Core.Proxy ::
