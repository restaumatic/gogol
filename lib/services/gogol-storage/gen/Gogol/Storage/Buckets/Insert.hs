       ...
       "v1" Core.:>
         "b" Core.:>
           Core.QueryParam "project" Core.Text Core.:>
             Core.QueryParam "enableObjectRetention" Core.Bool Core.:>
               Core.QueryParam "predefinedAcl" BucketsInsertPredefinedAcl Core.:>
                 Core.QueryParam "predefinedDefaultObjectAcl"
                   BucketsInsertPredefinedDefaultObjectAcl
                   Core.:>
                   Core.QueryParam "projection" BucketsInsertProjection Core.:>
...
newStorageBucketsInsert payload project
  = StorageBucketsInsert{enableObjectRetention = Core.False,
                         payload = payload, predefinedAcl = Core.Nothing,
                         predefinedDefaultObjectAcl = Core.Nothing, project = project,
...
instance Core.GoogleRequest StorageBucketsInsert where
        ...
        requestClient StorageBucketsInsert{..}
          = go (Core.Just project) (Core.Just enableObjectRetention)
              predefinedAcl
