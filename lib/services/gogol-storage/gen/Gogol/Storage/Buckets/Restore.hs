           ...
           Core.Capture "bucket" Core.Text Core.:>
             "restore" Core.:>
               Core.QueryParam "generation" Core.Int64 Core.:>
                 Core.QueryParam "projection" BucketsRestoreProjection Core.:>
...
newStorageBucketsRestore bucket generation
  = StorageBucketsRestore{bucket = bucket, generation = generation,
...
instance Core.GoogleRequest StorageBucketsRestore where
        ...
        requestClient StorageBucketsRestore{..}
          = go bucket (Core.Just generation) projection uploadType
              userProject
