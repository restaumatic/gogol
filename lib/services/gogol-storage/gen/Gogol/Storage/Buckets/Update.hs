...
newStorageBucketsUpdate bucket payload
  = StorageBucketsUpdate{bucket = bucket,
                         ifMetagenerationMatch = Core.Nothing,
                         ifMetagenerationNotMatch = Core.Nothing, payload = payload,
...
instance Core.GoogleRequest StorageBucketsUpdate where
        ...
        type Scopes StorageBucketsUpdate =
             '[CloudPlatform'FullControl, Devstorage'FullControl]
        requestClient StorageBucketsUpdate{..}
          = go bucket ifMetagenerationMatch ifMetagenerationNotMatch
              predefinedAcl
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy StorageBucketsUpdateResource)
                      Core.mempty
