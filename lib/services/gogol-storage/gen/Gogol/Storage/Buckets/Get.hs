             ...
             Core.QueryParam "generation" Core.Int64 Core.:>
               Core.QueryParam "ifMetagenerationMatch" Core.Int64 Core.:>
                 Core.QueryParam "ifMetagenerationNotMatch" Core.Int64 Core.:>
                   Core.QueryParam "projection" BucketsGetProjection Core.:>
...
newStorageBucketsGet bucket
  = StorageBucketsGet{bucket = bucket, generation = Core.Nothing,
                      ifMetagenerationMatch = Core.Nothing,
                      ifMetagenerationNotMatch = Core.Nothing, projection = Core.Nothing,
...
instance Core.GoogleRequest StorageBucketsGet where
        ...
        requestClient StorageBucketsGet{..}
          = go bucket generation ifMetagenerationMatch
