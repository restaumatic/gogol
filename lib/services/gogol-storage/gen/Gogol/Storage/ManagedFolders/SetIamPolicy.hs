...
newStorageManagedFoldersSetIamPolicy bucket managedFolder payload
  = StorageManagedFoldersSetIamPolicy{bucket = bucket,
                                      managedFolder = managedFolder, payload = payload,
                                      uploadType = Core.Nothing, userProject = Core.Nothing}
instance Core.GoogleRequest StorageManagedFoldersSetIamPolicy where
