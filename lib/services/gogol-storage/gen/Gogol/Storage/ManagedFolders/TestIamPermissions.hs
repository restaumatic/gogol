...
newStorageManagedFoldersTestIamPermissions 
    ...
    -> StorageManagedFoldersTestIamPermissions
newStorageManagedFoldersTestIamPermissions bucket managedFolder
  permissions
  = StorageManagedFoldersTestIamPermissions{bucket = bucket,
                                            managedFolder = managedFolder,
                                            permissions = permissions, uploadType = Core.Nothing,
                                            userProject = Core.Nothing}
instance Core.GoogleRequest StorageManagedFoldersTestIamPermissions
         where
        type Rs StorageManagedFoldersTestIamPermissions =
             TestIamPermissionsResponse
        type Scopes StorageManagedFoldersTestIamPermissions =
        ...
        requestClient StorageManagedFoldersTestIamPermissions{..}
          = go bucket managedFolder permissions uploadType userProject
