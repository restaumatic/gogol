           ...
           Core.Capture "bucket" Core.Text Core.:>
             "managedFolders" Core.:>
               Core.Capture "managedFolder" Core.Text Core.:>
                 Core.QueryParam "allowNonEmpty" Core.Bool Core.:>
...
newStorageManagedFoldersDelete bucket managedFolder
  = StorageManagedFoldersDelete{allowNonEmpty = Core.Nothing,
                                bucket = bucket, ifMetagenerationMatch = Core.Nothing,
                                ifMetagenerationNotMatch = Core.Nothing,
                                managedFolder = managedFolder, uploadType = Core.Nothing}
instance Core.GoogleRequest StorageManagedFoldersDelete where
        type Rs StorageManagedFoldersDelete = ()
        type Scopes StorageManagedFoldersDelete =
             '[CloudPlatform'FullControl, Devstorage'FullControl,
               Devstorage'ReadWrite]
        requestClient StorageManagedFoldersDelete{..}
          = go bucket managedFolder allowNonEmpty ifMetagenerationMatch
