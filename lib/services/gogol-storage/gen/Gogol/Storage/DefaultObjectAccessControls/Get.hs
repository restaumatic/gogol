...
newStorageDefaultObjectAccessControlsGet bucket entity
  = StorageDefaultObjectAccessControlsGet{bucket = bucket,
                                          entity = entity, uploadType = Core.Nothing,
                                          userProject = Core.Nothing}
instance Core.GoogleRequest StorageDefaultObjectAccessControlsGet
         where
