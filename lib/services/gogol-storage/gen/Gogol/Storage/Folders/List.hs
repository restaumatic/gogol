...
newStorageFoldersList bucket
  = StorageFoldersList{bucket = bucket, delimiter = Core.Nothing,
                       endOffset = Core.Nothing, pageSize = Core.Nothing,
                       pageToken = Core.Nothing, prefix = Core.Nothing,
...
instance Core.GoogleRequest StorageFoldersList where
        ...
        requestClient StorageFoldersList{..}
          = go bucket delimiter endOffset pageSize pageToken prefix
              startOffset
              uploadType
