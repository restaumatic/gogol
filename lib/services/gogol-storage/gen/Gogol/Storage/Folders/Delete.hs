       ...
       "v1" Core.:>
         "b" Core.:>
           Core.Capture "bucket" Core.Text Core.:>
             "folders" Core.:>
               Core.Capture "folder" Core.Text Core.:>
...
newStorageFoldersDelete bucket folder
  = StorageFoldersDelete{bucket = bucket, folder = folder,
                         ifMetagenerationMatch = Core.Nothing,
                         ifMetagenerationNotMatch = Core.Nothing, uploadType = Core.Nothing}
instance Core.GoogleRequest StorageFoldersDelete where
        type Rs StorageFoldersDelete = ()
        type Scopes StorageFoldersDelete =
             '[CloudPlatform'FullControl, Devstorage'FullControl,
               Devstorage'ReadWrite]
        requestClient StorageFoldersDelete{..}
          = go bucket folder ifMetagenerationMatch ifMetagenerationNotMatch
              uploadType
