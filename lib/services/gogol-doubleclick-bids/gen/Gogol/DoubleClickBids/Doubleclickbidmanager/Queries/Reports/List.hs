...
newDoubleclickbidmanagerQueriesReportsList queryId
  = DoubleclickbidmanagerQueriesReportsList{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            orderBy = Core.Nothing, pageSize = Core.Nothing,
                                            pageToken = Core.Nothing, queryId = queryId,
                                            uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DoubleclickbidmanagerQueriesReportsList
         where
        ...
        requestClient DoubleclickbidmanagerQueriesReportsList{..}
          = go queryId xgafv accessToken callback orderBy pageSize pageToken
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DoubleclickbidmanagerQueriesReportsListResource)
                      Core.mempty
