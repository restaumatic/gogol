...
newDoubleclickbidmanagerQueriesDelete 
    :: 
                                      Core.Int64
       -- ^  Required. The ID of the query to delete. See 'queryId'.
    -> DoubleclickbidmanagerQueriesDelete
newDoubleclickbidmanagerQueriesDelete queryId
  = DoubleclickbidmanagerQueriesDelete{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       queryId = queryId, uploadType = Core.Nothing,
                                       uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DoubleclickbidmanagerQueriesDelete
         where
        ...
        requestClient DoubleclickbidmanagerQueriesDelete{..}
          = go queryId xgafv accessToken callback uploadType uploadProtocol
              (Core.Just Core.AltJSON)
              doubleClickBidsService
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DoubleclickbidmanagerQueriesDeleteResource)
                      Core.mempty
