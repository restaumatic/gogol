...
newDoubleclickbidmanagerQueriesReportsGet queryId reportId
  = DoubleclickbidmanagerQueriesReportsGet{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           queryId = queryId, reportId = reportId,
                                           uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DoubleclickbidmanagerQueriesReportsGet
         where
        ...
        requestClient DoubleclickbidmanagerQueriesReportsGet{..}
          = go queryId reportId xgafv accessToken callback uploadType
              uploadProtocol
