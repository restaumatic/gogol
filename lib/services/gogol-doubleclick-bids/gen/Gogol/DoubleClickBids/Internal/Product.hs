...
newDataRange 
    ::  DataRange
newDataRange
  = DataRange{customEndDate = Core.Nothing,
              customStartDate = Core.Nothing, range = Core.Nothing}
...
newListQueriesResponse 
    ::  ListQueriesResponse
newListQueriesResponse
  = ListQueriesResponse{nextPageToken = Core.Nothing,
          ...
          = Core.withObject "ListQueriesResponse"
              (\ o ->
                 ListQueriesResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "queries"))
...
newParameters 
    ::  Parameters
newParameters
  = Parameters{filters = Core.Nothing, groupBys = Core.Nothing,
               metrics = Core.Nothing, options = Core.Nothing,
               type' = Core.Nothing}
instance Core.FromJSON Parameters where
        parseJSON
          = Core.withObject "Parameters"
              (\ o ->
                 Parameters Core.<$>
                   (o Core..:? "filters") Core.<*> (o Core..:? "groupBys") Core.<*>
                     (o Core..:? "metrics")
                     Core.<*> (o Core..:? "options")
                     Core.<*> (o Core..:? "type"))
...
newQuery 
    ::  Query
newQuery
  = Query{metadata = Core.Nothing, params = Core.Nothing,
          queryId = Core.Nothing, schedule = Core.Nothing}
instance Core.FromJSON Query where
        parseJSON
          = Core.withObject "Query"
              (\ o ->
                 Query Core.<$>
                   (o Core..:? "metadata") Core.<*> (o Core..:? "params") Core.<*>
                     (o Core..:? "queryId" Core.<&> Core.fmap Core.fromAsText)
...
newQueryMetadata 
    ::  QueryMetadata
newQueryMetadata
  = QueryMetadata{dataRange = Core.Nothing, format = Core.Nothing,
                  sendNotification = Core.Nothing, shareEmailAddress = Core.Nothing,
                  title = Core.Nothing}
instance Core.FromJSON QueryMetadata where
        parseJSON
          = Core.withObject "QueryMetadata"
              (\ o ->
                 QueryMetadata Core.<$>
                   (o Core..:? "dataRange") Core.<*> (o Core..:? "format") Core.<*>
...
newQuerySchedule 
    ::  QuerySchedule
newQuerySchedule
  = QuerySchedule{endDate = Core.Nothing, frequency = Core.Nothing,
                  nextRunTimezoneCode = Core.Nothing, startDate = Core.Nothing}
instance Core.FromJSON QuerySchedule where
        parseJSON
          = Core.withObject "QuerySchedule"
              (\ o ->
                 QuerySchedule Core.<$>
                   (o Core..:? "endDate") Core.<*> (o Core..:? "frequency") Core.<*>
                     (o Core..:? "nextRunTimezoneCode")
...
newReport 
    ::  Report
newReport
  = Report{key = Core.Nothing, metadata = Core.Nothing,
           params = Core.Nothing}
...
instance Core.FromJSON ReportKey where
        parseJSON
          = Core.withObject "ReportKey"
              (\ o ->
                 ReportKey Core.<$>
                   (o Core..:? "queryId" Core.<&> Core.fmap Core.fromAsText) Core.<*>
                     (o Core..:? "reportId" Core.<&> Core.fmap Core.fromAsText))
...
newReportMetadata 
    ::  ReportMetadata
newReportMetadata
  = ReportMetadata{googleCloudStoragePath = Core.Nothing,
                   reportDataEndDate = Core.Nothing,
                   reportDataStartDate = Core.Nothing, status = Core.Nothing}
...
newReportStatus 
    ::  ReportStatus
newReportStatus
  = ReportStatus{finishTime = Core.Nothing, format = Core.Nothing,
                 state = Core.Nothing}
instance Core.FromJSON ReportStatus where
        parseJSON
          = Core.withObject "ReportStatus"
              (\ o ->
                 ReportStatus Core.<$>
                   (o Core..:? "finishTime") Core.<*> (o Core..:? "format") Core.<*>
                     (o Core..:? "state"))
