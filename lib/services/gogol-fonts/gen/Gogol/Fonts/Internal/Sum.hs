  ...
  (
    ...
    WebfontsListCapability
      (
        ...
        WebfontsListCapability_FAMILYTAGS,
        ..
      ),
...
pattern WebfontsListCapability_FAMILYTAGS :: WebfontsListCapability
pattern WebfontsListCapability_FAMILYTAGS = WebfontsListCapability "FAMILY_TAGS"
