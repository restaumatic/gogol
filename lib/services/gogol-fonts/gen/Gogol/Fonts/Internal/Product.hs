...
newTag 
    ::  Tag
newTag = Tag{name = Core.Nothing, weight = Core.Nothing}
instance Core.FromJSON Tag where
        parseJSON
          = Core.withObject "Tag"
              (\ o ->
                 Tag Core.<$> (o Core..:? "name") Core.<*> (o Core..:? "weight"))
...
newWebfont
  = Webfont{axes = Core.Nothing, category = Core.Nothing,
            ...
            subsets = Core.Nothing, tags = Core.Nothing,
            variants = Core.Nothing, version = Core.Nothing}
