         ...
         Core.QueryParam "$.xgafv" Xgafv Core.:>
           Core.QueryParam "access_token" Core.Text Core.:>
             Core.QueryParam "callback" Core.Text Core.:>
               Core.QueryParams "capability" WebfontsListCapability Core.:>
                 Core.QueryParam "category" Core.Text Core.:>
                   Core.QueryParams "family" Core.Text Core.:>
                     Core.QueryParam "sort" WebfontsListSort Core.:>
                       Core.QueryParam "subset" Core.Text Core.:>
...
newWebfontsWebfontsList 
    ::  WebfontsWebfontsList
newWebfontsWebfontsList
  = WebfontsWebfontsList{xgafv = Core.Nothing,
                         accessToken = Core.Nothing, callback = Core.Nothing,
                         capability = Core.Nothing, category = Core.Nothing,
                         family = Core.Nothing, sort = Core.Nothing, subset = Core.Nothing,
...
instance Core.GoogleRequest WebfontsWebfontsList where
        ...
        requestClient WebfontsWebfontsList{..}
          = go xgafv accessToken callback (capability Core.^. Core._Default)
              category
