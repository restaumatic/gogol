...
type DigitalAssetLinksAssetlinksCheckResource =
     "v1" Core.:>
       "assetlinks:check" Core.:>
         Core.QueryParam "$.xgafv" Xgafv Core.:>
           Core.QueryParam "access_token" Core.Text Core.:>
             Core.QueryParam "callback" Core.Text Core.:>
               Core.QueryParam "relation" Core.Text Core.:>
                 Core.QueryParam "returnRelationExtensions" Core.Bool Core.:>
                   Core.QueryParam "source.androidApp.certificate.sha256Fingerprint"
                     Core.Text
                     Core.:>
                     Core.QueryParam "source.androidApp.packageName" Core.Text Core.:>
                       Core.QueryParam "source.web.site" Core.Text Core.:>
                         Core.QueryParam "target.androidApp.certificate.sha256Fingerprint"
                           Core.Text
                           Core.:>
                           Core.QueryParam "target.androidApp.packageName" Core.Text Core.:>
                             Core.QueryParam "target.web.site" Core.Text Core.:>
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.Get '[Core.JSON] CheckResponse
...
data DigitalAssetLinksAssetlinksCheck = DigitalAssetLinksAssetlinksCheck
    ...
    , relation :: (Core.Maybe Core.Text)
      -- | Whether to return relation/extensions payloads specified in the source Digital Asset Links statements linking the requested source and target assets by the requested relation type. If this is set to @false@ (default), relation/extensions specified will not be returned, even if they are specified in the DAL statement file. If set to @true@, the API will propagate any and all relation_extensions, across statements, linking the source and target assets by the requested relation type, if specified in the DAL statement file.
...
newDigitalAssetLinksAssetlinksCheck 
    :: 
                                    DigitalAssetLinksAssetlinksCheck
newDigitalAssetLinksAssetlinksCheck
  = DigitalAssetLinksAssetlinksCheck{xgafv = Core.Nothing,
                                     accessToken = Core.Nothing, callback = Core.Nothing,
                                     relation = Core.Nothing,
                                     returnRelationExtensions = Core.Nothing,
                                     ...
                                     targetWebSite = Core.Nothing, uploadType = Core.Nothing,
                                     uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DigitalAssetLinksAssetlinksCheck where
        type Rs DigitalAssetLinksAssetlinksCheck = CheckResponse
        type Scopes DigitalAssetLinksAssetlinksCheck = '[]
        requestClient DigitalAssetLinksAssetlinksCheck{..}
          = go xgafv accessToken callback relation returnRelationExtensions
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy DigitalAssetLinksAssetlinksCheckResource)
                      Core.mempty
