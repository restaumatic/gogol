...
newDigitalAssetLinksAssetlinksBulkCheck payload
  = DigitalAssetLinksAssetlinksBulkCheck{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         payload = payload, uploadType = Core.Nothing,
                                         uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DigitalAssetLinksAssetlinksBulkCheck
         where
        type Rs DigitalAssetLinksAssetlinksBulkCheck = BulkCheckResponse
        type Scopes DigitalAssetLinksAssetlinksBulkCheck = '[]
        requestClient DigitalAssetLinksAssetlinksBulkCheck{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DigitalAssetLinksAssetlinksBulkCheckResource)
                      Core.mempty
