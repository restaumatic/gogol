...
newAuthentication 
    ::  Authentication
newAuthentication
  = Authentication{customAccount = Core.Nothing,
                   googleAccount = Core.Nothing, iapCredential = Core.Nothing}
instance Core.FromJSON Authentication where
        parseJSON
          = Core.withObject "Authentication"
              (\ o ->
                 Authentication Core.<$>
                   (o Core..:? "customAccount") Core.<*> (o Core..:? "googleAccount")
...
newCrawledUrl 
    ::  CrawledUrl
newCrawledUrl
  = CrawledUrl{body = Core.Nothing, httpMethod = Core.Nothing,
               url = Core.Nothing}
instance Core.FromJSON CrawledUrl where
        parseJSON
          = Core.withObject "CrawledUrl"
              (\ o ->
                 CrawledUrl Core.<$>
                   (o Core..:? "body") Core.<*> (o Core..:? "httpMethod") Core.<*>
                     (o Core..:? "url"))
...
newCustomAccount 
    ::  CustomAccount
newCustomAccount
  = CustomAccount{loginUrl = Core.Nothing, password = Core.Nothing,
                  username = Core.Nothing}
instance Core.FromJSON CustomAccount where
        parseJSON
          = Core.withObject "CustomAccount"
              (\ o ->
                 CustomAccount Core.<$>
                   (o Core..:? "loginUrl") Core.<*> (o Core..:? "password") Core.<*>
                     (o Core..:? "username"))
...
newFinding 
    ::  Finding
newFinding
  = Finding{body = Core.Nothing, description = Core.Nothing,
            finalUrl = Core.Nothing, findingType = Core.Nothing,
            form = Core.Nothing, frameUrl = Core.Nothing,
            fuzzedUrl = Core.Nothing, httpMethod = Core.Nothing,
            name = Core.Nothing, outdatedLibrary = Core.Nothing,
            reproductionUrl = Core.Nothing, severity = Core.Nothing,
            trackingId = Core.Nothing, violatingResource = Core.Nothing,
            vulnerableHeaders = Core.Nothing,
            vulnerableParameters = Core.Nothing, xss = Core.Nothing,
            xxe = Core.Nothing}
instance Core.FromJSON Finding where
        parseJSON
          = Core.withObject "Finding"
              (\ o ->
                 Finding Core.<$>
                   (o Core..:? "body") Core.<*> (o Core..:? "description") Core.<*>
                     (o Core..:? "finalUrl")
          ...
          = Core.object
              (Core.catMaybes
                 [("body" Core..=) Core.<$> body,
                  ...
                  ("violatingResource" Core..=) Core.<$> violatingResource,
                  ("vulnerableHeaders" Core..=) Core.<$> vulnerableHeaders,
                  ("vulnerableParameters" Core..=) Core.<$> vulnerableParameters,
                  ("xss" Core..=) Core.<$> xss, ("xxe" Core..=) Core.<$> xxe])
...
newFindingTypeStats 
    ::  FindingTypeStats
newFindingTypeStats
  = FindingTypeStats{findingCount = Core.Nothing,
                     findingType = Core.Nothing}
instance Core.FromJSON FindingTypeStats where
        parseJSON
          = Core.withObject "FindingTypeStats"
              (\ o ->
                 FindingTypeStats Core.<$>
                   (o Core..:? "findingCount") Core.<*> (o Core..:? "findingType"))
...
instance Core.FromJSON Form where
        parseJSON
          = Core.withObject "Form"
              (\ o ->
                 Form Core.<$>
                   (o Core..:? "actionUri") Core.<*> (o Core..:? "fields"))
...
instance Core.FromJSON Header where
        parseJSON
          = Core.withObject "Header"
              (\ o ->
                 Header Core.<$> (o Core..:? "name") Core.<*> (o Core..:? "value"))
...
newIapCredential 
    ::  IapCredential
newIapCredential
  = IapCredential{iapTestServiceAccountInfo = Core.Nothing}
instance Core.FromJSON IapCredential where
        parseJSON
          = Core.withObject "IapCredential"
              (\ o ->
                 IapCredential Core.<$> (o Core..:? "iapTestServiceAccountInfo"))

instance Core.ToJSON IapCredential where
        toJSON IapCredential{..}
          = Core.object
              (Core.catMaybes
                 [("iapTestServiceAccountInfo" Core..=) Core.<$>
                    iapTestServiceAccountInfo])
...
newListCrawledUrlsResponse 
    ::  ListCrawledUrlsResponse
newListCrawledUrlsResponse
  = ListCrawledUrlsResponse{crawledUrls = Core.Nothing,
                            nextPageToken = Core.Nothing}
instance Core.FromJSON ListCrawledUrlsResponse where
        parseJSON
          = Core.withObject "ListCrawledUrlsResponse"
              (\ o ->
                 ListCrawledUrlsResponse Core.<$>
                   (o Core..:? "crawledUrls") Core.<*> (o Core..:? "nextPageToken"))
...
instance Core.FromJSON ListFindingTypeStatsResponse where
        parseJSON
          = Core.withObject "ListFindingTypeStatsResponse"
              (\ o ->
                 ListFindingTypeStatsResponse Core.<$>
                   (o Core..:? "findingTypeStats"))

instance Core.ToJSON ListFindingTypeStatsResponse where
        toJSON ListFindingTypeStatsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("findingTypeStats" Core..=) Core.<$> findingTypeStats])
...
newListFindingsResponse 
    ::  ListFindingsResponse
newListFindingsResponse
  = ListFindingsResponse{findings = Core.Nothing,
                         nextPageToken = Core.Nothing}
          ...
          = Core.withObject "ListFindingsResponse"
              (\ o ->
                 ListFindingsResponse Core.<$>
                   (o Core..:? "findings") Core.<*> (o Core..:? "nextPageToken"))
...
newListScanConfigsResponse 
    ::  ListScanConfigsResponse
newListScanConfigsResponse
  = ListScanConfigsResponse{nextPageToken = Core.Nothing,
                            scanConfigs = Core.Nothing}
instance Core.FromJSON ListScanConfigsResponse where
        parseJSON
          = Core.withObject "ListScanConfigsResponse"
              (\ o ->
                 ListScanConfigsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "scanConfigs"))
...
newListScanRunsResponse 
    ::  ListScanRunsResponse
newListScanRunsResponse
  = ListScanRunsResponse{nextPageToken = Core.Nothing,
                         scanRuns = Core.Nothing}
instance Core.FromJSON ListScanRunsResponse where
        parseJSON
          = Core.withObject "ListScanRunsResponse"
              (\ o ->
                 ListScanRunsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "scanRuns"))
...
newOutdatedLibrary 
    ::  OutdatedLibrary
newOutdatedLibrary
  = OutdatedLibrary{learnMoreUrls = Core.Nothing,
                    libraryName = Core.Nothing, version = Core.Nothing}
instance Core.FromJSON OutdatedLibrary where
        parseJSON
          = Core.withObject "OutdatedLibrary"
              (\ o ->
                 OutdatedLibrary Core.<$>
                   (o Core..:? "learnMoreUrls") Core.<*> (o Core..:? "libraryName")
                     Core.<*> (o Core..:? "version"))
...
data ScanConfig = ScanConfig
    ...
    , targetPlatforms :: (Core.Maybe [ScanConfig_TargetPlatformsItem])
...
newScanConfig 
    ::  ScanConfig
newScanConfig
  = ScanConfig{authentication = Core.Nothing,
               blacklistPatterns = Core.Nothing, displayName = Core.Nothing,
               exportToSecurityCommandCenter = Core.Nothing,
               ignoreHttpStatusErrors = Core.Nothing, latestRun = Core.Nothing,
               managedScan = Core.Nothing, maxQps = Core.Nothing,
               name = Core.Nothing, riskLevel = Core.Nothing,
               schedule = Core.Nothing, startingUrls = Core.Nothing,
               staticIpScan = Core.Nothing, targetPlatforms = Core.Nothing,
               userAgent = Core.Nothing}
instance Core.FromJSON ScanConfig where
        parseJSON
          = Core.withObject "ScanConfig"
              (\ o ->
                 ScanConfig Core.<$>
                   (o Core..:? "authentication") Core.<*>
                     (o Core..:? "blacklistPatterns")
                     Core.<*> (o Core..:? "displayName")
                     Core.<*> (o Core..:? "exportToSecurityCommandCenter")
                     Core.<*> (o Core..:? "ignoreHttpStatusErrors")
                     Core.<*> (o Core..:? "latestRun")
          ...
          = Core.object
              (Core.catMaybes
                 [("authentication" Core..=) Core.<$> authentication,
                  ("blacklistPatterns" Core..=) Core.<$> blacklistPatterns,
                  ("displayName" Core..=) Core.<$> displayName,
                  ("exportToSecurityCommandCenter" Core..=) Core.<$>
                    exportToSecurityCommandCenter,
                  ("ignoreHttpStatusErrors" Core..=) Core.<$> ignoreHttpStatusErrors,
                  ("latestRun" Core..=) Core.<$> latestRun,
                  ("managedScan" Core..=) Core.<$> managedScan,
                  ("maxQps" Core..=) Core.<$> maxQps, ("name" Core..=) Core.<$> name,
                  ...
                  ("targetPlatforms" Core..=) Core.<$> targetPlatforms,
...
instance Core.FromJSON ScanConfigError where
        parseJSON
          = Core.withObject "ScanConfigError"
              (\ o ->
                 ScanConfigError Core.<$>
                   (o Core..:? "code") Core.<*> (o Core..:? "fieldName"))
...
newScanRun 
    ::  ScanRun
newScanRun
  = ScanRun{endTime = Core.Nothing, errorTrace = Core.Nothing,
            executionState = Core.Nothing, hasVulnerabilities = Core.Nothing,
            name = Core.Nothing, progressPercent = Core.Nothing,
            resultState = Core.Nothing, startTime = Core.Nothing,
            urlsCrawledCount = Core.Nothing, urlsTestedCount = Core.Nothing,
            warningTraces = Core.Nothing}
instance Core.FromJSON ScanRun where
        parseJSON
          = Core.withObject "ScanRun"
              (\ o ->
                 ScanRun Core.<$>
                   (o Core..:? "endTime") Core.<*> (o Core..:? "errorTrace") Core.<*>
                     (o Core..:? "executionState")
                     ...
                     Core.<*>
                     (o Core..:? "urlsCrawledCount" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "urlsTestedCount" Core.<&> Core.fmap Core.fromAsText)
          ...
          = Core.object
              (Core.catMaybes
                 [("endTime" Core..=) Core.<$> endTime,
                  ...
                  ("hasVulnerabilities" Core..=) Core.<$> hasVulnerabilities,
                  ("name" Core..=) Core.<$> name,
                  ("progressPercent" Core..=) Core.<$> progressPercent,
                  ("resultState" Core..=) Core.<$> resultState,
                  ("startTime" Core..=) Core.<$> startTime,
                  ("urlsCrawledCount" Core..=) Core.. Core.AsText Core.<$>
                    urlsCrawledCount,
                  ("urlsTestedCount" Core..=) Core.. Core.AsText Core.<$>
                    urlsTestedCount,
...
newScanRunErrorTrace 
    ::  ScanRunErrorTrace
newScanRunErrorTrace
  = ScanRunErrorTrace{code = Core.Nothing,
                      mostCommonHttpErrorCode = Core.Nothing,
                      scanConfigError = Core.Nothing}
instance Core.FromJSON ScanRunErrorTrace where
        parseJSON
          = Core.withObject "ScanRunErrorTrace"
              (\ o ->
                 ScanRunErrorTrace Core.<$>
                   (o Core..:? "code") Core.<*> (o Core..:? "mostCommonHttpErrorCode")
...
instance Core.ToJSON ScanRunErrorTrace where
        toJSON ScanRunErrorTrace{..}
          = Core.object
              (Core.catMaybes
                 [("code" Core..=) Core.<$> code,
                  ("mostCommonHttpErrorCode" Core..=) Core.<$>
                    mostCommonHttpErrorCode,
                  ("scanConfigError" Core..=) Core.<$> scanConfigError])
...
instance Core.FromJSON ScanRunWarningTrace where
        parseJSON
          = Core.withObject "ScanRunWarningTrace"
              (\ o -> ScanRunWarningTrace Core.<$> (o Core..:? "code"))
...
newSchedule 
    ::  Schedule
newSchedule
  = Schedule{intervalDurationDays = Core.Nothing,
...
instance Core.FromJSON Schedule where
        parseJSON
          = Core.withObject "Schedule"
              (\ o ->
                 Schedule Core.<$>
                   (o Core..:? "intervalDurationDays") Core.<*>
                     (o Core..:? "scheduleTime"))
...
instance Core.ToJSON Schedule where
        toJSON Schedule{..}
          = Core.object
              (Core.catMaybes
                 [("intervalDurationDays" Core..=) Core.<$> intervalDurationDays,
...
instance Core.FromJSON StartScanRunRequest where
        parseJSON
          = Core.withObject "StartScanRunRequest"
...
instance Core.FromJSON StopScanRunRequest where
        parseJSON
          = Core.withObject "StopScanRunRequest"
...
newViolatingResource 
    ::  ViolatingResource
newViolatingResource
  = ViolatingResource{contentType = Core.Nothing,
                      resourceUrl = Core.Nothing}
instance Core.FromJSON ViolatingResource where
        parseJSON
          = Core.withObject "ViolatingResource"
              (\ o ->
                 ViolatingResource Core.<$>
                   (o Core..:? "contentType") Core.<*> (o Core..:? "resourceUrl"))
...
newVulnerableHeaders 
    ::  VulnerableHeaders
newVulnerableHeaders
  = VulnerableHeaders{headers = Core.Nothing,
                      missingHeaders = Core.Nothing}
instance Core.FromJSON VulnerableHeaders where
        parseJSON
          = Core.withObject "VulnerableHeaders"
              (\ o ->
                 VulnerableHeaders Core.<$>
                   (o Core..:? "headers") Core.<*> (o Core..:? "missingHeaders"))
...
newVulnerableParameters 
    ::  VulnerableParameters
newVulnerableParameters
  = VulnerableParameters{parameterNames = Core.Nothing}
instance Core.FromJSON VulnerableParameters where
        parseJSON
          = Core.withObject "VulnerableParameters"
              (\ o ->
                 VulnerableParameters Core.<$> (o Core..:? "parameterNames"))
...
newXss 
    ::  Xss
newXss
  = Xss{attackVector = Core.Nothing, errorMessage = Core.Nothing,
        stackTraces = Core.Nothing, storedXssSeedingUrl = Core.Nothing}
instance Core.FromJSON Xss where
        parseJSON
          = Core.withObject "Xss"
              (\ o ->
                 Xss Core.<$>
                   (o Core..:? "attackVector") Core.<*> (o Core..:? "errorMessage")
          ...
          = Core.object
              (Core.catMaybes
                 [("attackVector" Core..=) Core.<$> attackVector,
                  ...
                  ("storedXssSeedingUrl" Core..=) Core.<$> storedXssSeedingUrl])
...
newXxe 
    ::  Xxe
newXxe
  = Xxe{payloadLocation = Core.Nothing, payloadValue = Core.Nothing}
instance Core.FromJSON Xxe where
        parseJSON
          = Core.withObject "Xxe"
              (\ o ->
                 Xxe Core.<$>
                   (o Core..:? "payloadLocation") Core.<*>
                     (o Core..:? "payloadValue"))
...
instance Core.ToJSON Xxe where
        toJSON Xxe{..}
          = Core.object
              (Core.catMaybes
                 [("payloadLocation" Core..=) Core.<$> payloadLocation,
