               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] StopScanRunRequest Core.:>
                       Core.Post '[Core.JSON] ScanRun
...
newWebSecurityScannerProjectsScanConfigsScanRunsStop name payload
  = WebSecurityScannerProjectsScanConfigsScanRunsStop{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes WebSecurityScannerProjectsScanConfigsScanRunsStop =
