...
newWebSecurityScannerProjectsScanConfigsScanRunsFindingsGet name
  = WebSecurityScannerProjectsScanConfigsScanRunsFindingsGet{xgafv =
                                                               Core.Nothing,
...
instance Core.GoogleRequest
           WebSecurityScannerProjectsScanConfigsScanRunsFindingsGet
         where
        type Rs WebSecurityScannerProjectsScanConfigsScanRunsFindingsGet =
             Finding
        type Scopes
               WebSecurityScannerProjectsScanConfigsScanRunsFindingsGet
