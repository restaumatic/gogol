                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] ListScanRunsResponse
...
newWebSecurityScannerProjectsScanConfigsScanRunsList parent
  = WebSecurityScannerProjectsScanConfigsScanRunsList{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           WebSecurityScannerProjectsScanConfigsScanRunsList
         where
        type Rs WebSecurityScannerProjectsScanConfigsScanRunsList =
             ListScanRunsResponse
        type Scopes WebSecurityScannerProjectsScanConfigsScanRunsList =
