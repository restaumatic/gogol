                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] ListScanConfigsResponse
...
newWebSecurityScannerProjectsScanConfigsList parent
  = WebSecurityScannerProjectsScanConfigsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           WebSecurityScannerProjectsScanConfigsList
         where
        type Rs WebSecurityScannerProjectsScanConfigsList =
             ListScanConfigsResponse
        type Scopes WebSecurityScannerProjectsScanConfigsList =
             '[CloudPlatform'FullControl]
        requestClient WebSecurityScannerProjectsScanConfigsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy WebSecurityScannerProjectsScanConfigsListResource)
                      Core.mempty
