                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] ScanConfig Core.:>
                         Core.Post '[Core.JSON] ScanConfig
...
newWebSecurityScannerProjectsScanConfigsCreate parent payload
  = WebSecurityScannerProjectsScanConfigsCreate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           WebSecurityScannerProjectsScanConfigsCreate
         where
        type Rs WebSecurityScannerProjectsScanConfigsCreate = ScanConfig
        type Scopes WebSecurityScannerProjectsScanConfigsCreate =
             '[CloudPlatform'FullControl]
        requestClient WebSecurityScannerProjectsScanConfigsCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy WebSecurityScannerProjectsScanConfigsCreateResource)
                      Core.mempty
