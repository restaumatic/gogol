...
newWebSecurityScannerProjectsScanConfigsDelete name
  = WebSecurityScannerProjectsScanConfigsDelete{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           WebSecurityScannerProjectsScanConfigsDelete
         where
        type Rs WebSecurityScannerProjectsScanConfigsDelete = Empty
        type Scopes WebSecurityScannerProjectsScanConfigsDelete =
             '[CloudPlatform'FullControl]
        requestClient WebSecurityScannerProjectsScanConfigsDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy WebSecurityScannerProjectsScanConfigsDeleteResource)
                      Core.mempty
