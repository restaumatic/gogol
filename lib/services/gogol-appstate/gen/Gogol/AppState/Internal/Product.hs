...
newGetResponse 
    ::  GetResponse
newGetResponse
  = GetResponse{currentStateVersion = Core.Nothing,
                data' = Core.Nothing, kind = "appstate#getResponse",
                stateKey = Core.Nothing}
instance Core.FromJSON GetResponse where
        parseJSON
          = Core.withObject "GetResponse"
              (\ o ->
                 GetResponse Core.<$>
                   (o Core..:? "currentStateVersion") Core.<*> (o Core..:? "data")
...
newListResponse 
    ::  ListResponse
newListResponse
  = ListResponse{items = Core.Nothing,
                 kind = "appstate#listResponse", maximumKeyCount = Core.Nothing}
        ...
        parseJSON
          = Core.withObject "ListResponse"
              (\ o ->
                 ListResponse Core.<$>
                   (o Core..:? "items") Core.<*>
                     (o Core..:? "kind" Core..!= "appstate#listResponse")
...
newUpdateRequest 
    ::  UpdateRequest
newUpdateRequest
  = UpdateRequest{data' = Core.Nothing,
                  kind = "appstate#updateRequest"}
instance Core.FromJSON UpdateRequest where
        parseJSON
          = Core.withObject "UpdateRequest"
              (\ o ->
                 UpdateRequest Core.<$>
                   (o Core..:? "data") Core.<*>
                     (o Core..:? "kind" Core..!= "appstate#updateRequest"))
...
newWriteResult 
    ::  WriteResult
newWriteResult
  = WriteResult{currentStateVersion = Core.Nothing,
                kind = "appstate#writeResult", stateKey = Core.Nothing}
instance Core.FromJSON WriteResult where
        parseJSON
          = Core.withObject "WriteResult"
              (\ o ->
                 WriteResult Core.<$>
                   (o Core..:? "currentStateVersion") Core.<*>
                     (o Core..:? "kind" Core..!= "appstate#writeResult")
                     Core.<*> (o Core..:? "stateKey"))
