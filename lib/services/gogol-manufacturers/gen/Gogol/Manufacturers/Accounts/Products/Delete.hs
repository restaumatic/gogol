...
newManufacturersAccountsProductsDelete name parent
  = ManufacturersAccountsProductsDelete{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        name = name, parent = parent, uploadType = Core.Nothing,
                                        uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ManufacturersAccountsProductsDelete
         where
        type Rs ManufacturersAccountsProductsDelete = Empty
        type Scopes ManufacturersAccountsProductsDelete =
        ...
        requestClient ManufacturersAccountsProductsDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ManufacturersAccountsProductsDeleteResource)
                      Core.mempty
