             ...
             Core.QueryParam "$.xgafv" Xgafv Core.:>
               Core.QueryParam "access_token" Core.Text Core.:>
                 Core.QueryParam "callback" Core.Text Core.:>
                   Core.QueryParams "include" AccountsProductsGetInclude Core.:>
...
newManufacturersAccountsProductsGet name parent
  = ManufacturersAccountsProductsGet{xgafv = Core.Nothing,
                                     accessToken = Core.Nothing, callback = Core.Nothing,
                                     include = Core.Nothing, name = name, parent = parent,
                                     uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ManufacturersAccountsProductsGet where
        ...
        requestClient ManufacturersAccountsProductsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ManufacturersAccountsProductsGetResource)
                      Core.mempty
