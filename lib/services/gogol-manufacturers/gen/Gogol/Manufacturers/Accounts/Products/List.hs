           ...
           Core.QueryParam "$.xgafv" Xgafv Core.:>
             Core.QueryParam "access_token" Core.Text Core.:>
               Core.QueryParam "callback" Core.Text Core.:>
                 Core.QueryParams "include" AccountsProductsListInclude Core.:>
                   Core.QueryParam "pageSize" Core.Int32 Core.:>
                     Core.QueryParam "pageToken" Core.Text Core.:>
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] ListProductsResponse
...
newManufacturersAccountsProductsList parent
  = ManufacturersAccountsProductsList{xgafv = Core.Nothing,
                                      accessToken = Core.Nothing, callback = Core.Nothing,
                                      include = Core.Nothing, pageSize = Core.Nothing,
                                      pageToken = Core.Nothing, parent = parent,
                                      uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ManufacturersAccountsProductsList where
        type Rs ManufacturersAccountsProductsList = ListProductsResponse
        type Scopes ManufacturersAccountsProductsList =
