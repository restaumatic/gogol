               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.Get '[Core.JSON] ProductCertification
...
newManufacturersAccountsLanguagesProductCertificationsGet name
  = ManufacturersAccountsLanguagesProductCertificationsGet{xgafv =
                                                             Core.Nothing,
...
instance Core.GoogleRequest
           ManufacturersAccountsLanguagesProductCertificationsGet
         where
        type Rs ManufacturersAccountsLanguagesProductCertificationsGet =
             ProductCertification
        type Scopes ManufacturersAccountsLanguagesProductCertificationsGet
