                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] ListProductCertificationsResponse
...
newManufacturersAccountsLanguagesProductCertificationsList parent
  = ManufacturersAccountsLanguagesProductCertificationsList{xgafv =
                                                              Core.Nothing,
...
instance Core.GoogleRequest
           ManufacturersAccountsLanguagesProductCertificationsList
         where
        type Rs ManufacturersAccountsLanguagesProductCertificationsList =
             ListProductCertificationsResponse
        type Scopes ManufacturersAccountsLanguagesProductCertificationsList
