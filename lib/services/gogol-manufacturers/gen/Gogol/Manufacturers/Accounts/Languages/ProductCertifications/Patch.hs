                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] ProductCertification Core.:>
                         Core.Patch '[Core.JSON] ProductCertification
...
newManufacturersAccountsLanguagesProductCertificationsPatch 
    ...
    -> ManufacturersAccountsLanguagesProductCertificationsPatch
newManufacturersAccountsLanguagesProductCertificationsPatch name
  payload
  = ManufacturersAccountsLanguagesProductCertificationsPatch{xgafv =
                                                               Core.Nothing,
...
instance Core.GoogleRequest
           ManufacturersAccountsLanguagesProductCertificationsPatch
         where
        type Rs ManufacturersAccountsLanguagesProductCertificationsPatch =
             ProductCertification
        type Scopes
               ManufacturersAccountsLanguagesProductCertificationsPatch
