                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.Get '[Core.JSON] ListNamespacesResponse
...
newProximityBeaconNamespacesList 
    ::  ProximityBeaconNamespacesList
newProximityBeaconNamespacesList
  = ProximityBeaconNamespacesList{xgafv = Core.Nothing,
                                  accessToken = Core.Nothing, callback = Core.Nothing,
                                  projectId = Core.Nothing, uploadType = Core.Nothing,
                                  uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ProximityBeaconNamespacesList where
        type Rs ProximityBeaconNamespacesList = ListNamespacesResponse
        type Scopes ProximityBeaconNamespacesList =
             '[Userlocation'Beacon'Registry]
        requestClient ProximityBeaconNamespacesList{..}
          = go xgafv accessToken callback projectId uploadType uploadProtocol
              (Core.Just Core.AltJSON)
              proximityBeaconService
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ProximityBeaconNamespacesListResource)
                      Core.mempty
