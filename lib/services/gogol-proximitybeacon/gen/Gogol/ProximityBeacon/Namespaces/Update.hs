...
type ProximityBeaconNamespacesUpdateResource =
     "v1beta1" Core.:>
       Core.Capture "namespaceName" Core.Text Core.:>
                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] Namespace Core.:>
                         Core.Put '[Core.JSON] Namespace
...
newProximityBeaconNamespacesUpdate namespaceName payload
  = ProximityBeaconNamespacesUpdate{xgafv = Core.Nothing,
                                    accessToken = Core.Nothing, callback = Core.Nothing,
                                    namespaceName = namespaceName, payload = payload,
                                    projectId = Core.Nothing, uploadType = Core.Nothing,
                                    uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ProximityBeaconNamespacesUpdate where
        type Rs ProximityBeaconNamespacesUpdate = Namespace
        type Scopes ProximityBeaconNamespacesUpdate =
             '[Userlocation'Beacon'Registry]
        requestClient ProximityBeaconNamespacesUpdate{..}
          = go namespaceName xgafv accessToken callback projectId uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ProximityBeaconNamespacesUpdateResource)
                      Core.mempty
