               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] GetInfoForObservedBeaconsRequest Core.:>
                       Core.Post '[Core.JSON] GetInfoForObservedBeaconsResponse
...
newProximityBeaconBeaconinfoGetforobserved payload
  = ProximityBeaconBeaconinfoGetforobserved{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            payload = payload, uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ProximityBeaconBeaconinfoGetforobserved
         where
        type Rs ProximityBeaconBeaconinfoGetforobserved =
             GetInfoForObservedBeaconsResponse
        type Scopes ProximityBeaconBeaconinfoGetforobserved = '[]
        requestClient ProximityBeaconBeaconinfoGetforobserved{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ProximityBeaconBeaconinfoGetforobservedResource)
                      Core.mempty
