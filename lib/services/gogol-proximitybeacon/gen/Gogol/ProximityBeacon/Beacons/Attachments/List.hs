...
-- |
-- Module      : Gogol.ProximityBeacon.Beacons.Attachments.List
           ...
           Core.QueryParam "$.xgafv" Xgafv Core.:>
             Core.QueryParam "access_token" Core.Text Core.:>
               Core.QueryParam "callback" Core.Text Core.:>
                 Core.QueryParam "namespacedType" Core.Text Core.:>
                   Core.QueryParam "projectId" Core.Text Core.:>
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] ListBeaconAttachmentsResponse
...
newProximityBeaconBeaconsAttachmentsList beaconName
  = ProximityBeaconBeaconsAttachmentsList{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, beaconName = beaconName,
                                          callback = Core.Nothing, namespacedType = Core.Nothing,
                                          projectId = Core.Nothing, uploadType = Core.Nothing,
                                          uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ProximityBeaconBeaconsAttachmentsList
         where
        type Rs ProximityBeaconBeaconsAttachmentsList =
             ListBeaconAttachmentsResponse
        type Scopes ProximityBeaconBeaconsAttachmentsList =
             '[Userlocation'Beacon'Registry]
        requestClient ProximityBeaconBeaconsAttachmentsList{..}
          = go beaconName xgafv accessToken callback namespacedType projectId
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ProximityBeaconBeaconsAttachmentsListResource)
                      Core.mempty
