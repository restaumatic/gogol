...
-- |
-- Module      : Gogol.ProximityBeacon.Beacons.Attachments.Create
                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] BeaconAttachment Core.:>
                           Core.Post '[Core.JSON] BeaconAttachment
...
newProximityBeaconBeaconsAttachmentsCreate beaconName payload
  = ProximityBeaconBeaconsAttachmentsCreate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ProximityBeaconBeaconsAttachmentsCreate
         where
        type Rs ProximityBeaconBeaconsAttachmentsCreate = BeaconAttachment
        type Scopes ProximityBeaconBeaconsAttachmentsCreate =
             '[Userlocation'Beacon'Registry]
        requestClient ProximityBeaconBeaconsAttachmentsCreate{..}
          = go beaconName xgafv accessToken callback projectId uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ProximityBeaconBeaconsAttachmentsCreateResource)
                      Core.mempty
