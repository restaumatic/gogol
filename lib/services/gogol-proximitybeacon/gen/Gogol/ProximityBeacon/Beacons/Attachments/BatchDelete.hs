                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Post '[Core.JSON] DeleteAttachmentsResponse
...
newProximityBeaconBeaconsAttachmentsBatchDelete beaconName
  = ProximityBeaconBeaconsAttachmentsBatchDelete{xgafv =
                                                   Core.Nothing,
                                                 accessToken = Core.Nothing,
                                                 beaconName = beaconName, callback = Core.Nothing,
...
instance Core.GoogleRequest
           ProximityBeaconBeaconsAttachmentsBatchDelete
         where
        type Rs ProximityBeaconBeaconsAttachmentsBatchDelete =
             DeleteAttachmentsResponse
        type Scopes ProximityBeaconBeaconsAttachmentsBatchDelete =
             '[Userlocation'Beacon'Registry]
        requestClient ProximityBeaconBeaconsAttachmentsBatchDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ProximityBeaconBeaconsAttachmentsBatchDeleteResource)
                      Core.mempty
