...
newProximityBeaconBeaconsDiagnosticsList beaconName
  = ProximityBeaconBeaconsDiagnosticsList{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, alertFilter = Core.Nothing,
...
instance Core.GoogleRequest ProximityBeaconBeaconsDiagnosticsList
         where
        ...
        requestClient ProximityBeaconBeaconsDiagnosticsList{..}
          = go beaconName xgafv accessToken alertFilter callback pageSize
              pageToken
              projectId
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ProximityBeaconBeaconsDiagnosticsListResource)
                      Core.mempty
