...
-- |
-- Module      : Gogol.ProximityBeacon.Beacons.Deactivate
...
type ProximityBeaconBeaconsDeactivateResource =
     "v1beta1" Core.:>
       Core.CaptureMode "beaconName" "deactivate" Core.Text Core.:>
...
newProximityBeaconBeaconsDeactivate beaconName
  = ProximityBeaconBeaconsDeactivate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ProximityBeaconBeaconsDeactivate where
        type Rs ProximityBeaconBeaconsDeactivate = Empty
        type Scopes ProximityBeaconBeaconsDeactivate =
        ...
        requestClient ProximityBeaconBeaconsDeactivate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ProximityBeaconBeaconsDeactivateResource)
                      Core.mempty
