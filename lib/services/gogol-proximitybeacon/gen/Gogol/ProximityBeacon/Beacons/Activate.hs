...
type ProximityBeaconBeaconsActivateResource =
     "v1beta1" Core.:>
       Core.CaptureMode "beaconName" "activate" Core.Text Core.:>
...
newProximityBeaconBeaconsActivate beaconName
  = ProximityBeaconBeaconsActivate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ProximityBeaconBeaconsActivate where
        type Rs ProximityBeaconBeaconsActivate = Empty
        type Scopes ProximityBeaconBeaconsActivate =
        ...
        requestClient ProximityBeaconBeaconsActivate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ProximityBeaconBeaconsActivateResource)
                      Core.mempty
