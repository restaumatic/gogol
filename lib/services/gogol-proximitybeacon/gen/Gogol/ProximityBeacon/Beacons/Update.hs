...
-- |
-- Module      : Gogol.ProximityBeacon.Beacons.Update
                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] Beacon Core.:>
                         Core.Put '[Core.JSON] Beacon
...
newProximityBeaconBeaconsUpdate beaconName payload
  = ProximityBeaconBeaconsUpdate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ProximityBeaconBeaconsUpdate where
        type Rs ProximityBeaconBeaconsUpdate = Beacon
        type Scopes ProximityBeaconBeaconsUpdate =
        ...
        requestClient ProximityBeaconBeaconsUpdate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ProximityBeaconBeaconsUpdateResource)
                      Core.mempty
