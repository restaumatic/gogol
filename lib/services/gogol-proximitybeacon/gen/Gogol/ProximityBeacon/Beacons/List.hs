                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] ListBeaconsResponse
...
newProximityBeaconBeaconsList 
    ::  ProximityBeaconBeaconsList
newProximityBeaconBeaconsList
  = ProximityBeaconBeaconsList{xgafv = Core.Nothing,
                               accessToken = Core.Nothing, callback = Core.Nothing,
                               pageSize = Core.Nothing, pageToken = Core.Nothing,
                               projectId = Core.Nothing, q = Core.Nothing,
                               uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ProximityBeaconBeaconsList where
        type Rs ProximityBeaconBeaconsList = ListBeaconsResponse
        type Scopes ProximityBeaconBeaconsList =
             '[Userlocation'Beacon'Registry]
        requestClient ProximityBeaconBeaconsList{..}
          = go xgafv accessToken callback pageSize pageToken projectId q
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ProximityBeaconBeaconsListResource)
                      Core.mempty
