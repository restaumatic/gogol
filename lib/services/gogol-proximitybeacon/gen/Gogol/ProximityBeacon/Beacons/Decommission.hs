...
type ProximityBeaconBeaconsDecommissionResource =
     "v1beta1" Core.:>
       Core.CaptureMode "beaconName" "decommission" Core.Text Core.:>
...
newProximityBeaconBeaconsDecommission beaconName
  = ProximityBeaconBeaconsDecommission{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ProximityBeaconBeaconsDecommission
         where
        type Rs ProximityBeaconBeaconsDecommission = Empty
        type Scopes ProximityBeaconBeaconsDecommission =
        ...
        requestClient ProximityBeaconBeaconsDecommission{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ProximityBeaconBeaconsDecommissionResource)
                      Core.mempty
