...
newProximityBeaconBeaconsDelete beaconName
  = ProximityBeaconBeaconsDelete{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ProximityBeaconBeaconsDelete where
        type Rs ProximityBeaconBeaconsDelete = Empty
        type Scopes ProximityBeaconBeaconsDelete =
        ...
        requestClient ProximityBeaconBeaconsDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ProximityBeaconBeaconsDeleteResource)
                      Core.mempty
