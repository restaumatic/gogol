...
newProximityBeaconBeaconsRegister payload
  = ProximityBeaconBeaconsRegister{xgafv = Core.Nothing,
                                   accessToken = Core.Nothing, callback = Core.Nothing,
                                   payload = payload, projectId = Core.Nothing,
                                   uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ProximityBeaconBeaconsRegister where
        type Rs ProximityBeaconBeaconsRegister = Beacon
        type Scopes ProximityBeaconBeaconsRegister =
        ...
        requestClient ProximityBeaconBeaconsRegister{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ProximityBeaconBeaconsRegisterResource)
                      Core.mempty
