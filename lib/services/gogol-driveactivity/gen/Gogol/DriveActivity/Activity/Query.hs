...
--
-- /See:/ <https://developers.google.com/workspace/drive/activity/ Drive Activity API Reference> for @driveactivity.activity.query@.
module Gogol.DriveActivity.Activity.Query
    (
    -- * Resource
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] QueryDriveActivityRequest Core.:>
                       Core.Post '[Core.JSON] QueryDriveActivityResponse
...
newDriveActivityActivityQuery payload
  = DriveActivityActivityQuery{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DriveActivityActivityQuery where
        ...
        type Scopes DriveActivityActivityQuery =
