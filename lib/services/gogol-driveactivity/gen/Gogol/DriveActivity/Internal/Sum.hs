  ...
  (
    ...
    RestrictionChange_Feature
      (
        ...
        RestrictionChange_Feature_READERSCANDOWNLOAD,
        RestrictionChange_Feature_WRITERSCANDOWNLOAD,
        ..
      ),
...
-- | Deprecated: Use READERS/CAN/DOWNLOAD instead.
...
pattern RestrictionChange_Feature_READERSCANDOWNLOAD :: RestrictionChange_Feature
pattern RestrictionChange_Feature_READERSCANDOWNLOAD = RestrictionChange_Feature "READERS_CAN_DOWNLOAD"

-- | When restricted, this prevents actions like copy, download, and print for writers.
pattern RestrictionChange_Feature_WRITERSCANDOWNLOAD :: RestrictionChange_Feature
pattern RestrictionChange_Feature_WRITERSCANDOWNLOAD = RestrictionChange_Feature "WRITERS_CAN_DOWNLOAD"
