...
newDataflowProjectsDeleteSnapshots projectId
  = DataflowProjectsDeleteSnapshots{xgafv = Core.Nothing,
                                    accessToken = Core.Nothing, callback = Core.Nothing,
                                    location = Core.Nothing, projectId = projectId,
                                    snapshotId = Core.Nothing, uploadType = Core.Nothing,
...
instance Core.GoogleRequest DataflowProjectsDeleteSnapshots where
        ...
        requestClient DataflowProjectsDeleteSnapshots{..}
          = go projectId xgafv accessToken callback location snapshotId
              uploadType
              uploadProtocol
