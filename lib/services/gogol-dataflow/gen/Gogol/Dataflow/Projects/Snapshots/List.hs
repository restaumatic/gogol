...
newDataflowProjectsSnapshotsList projectId
  = DataflowProjectsSnapshotsList{xgafv = Core.Nothing,
                                  accessToken = Core.Nothing, callback = Core.Nothing,
                                  jobId = Core.Nothing, location = Core.Nothing,
...
instance Core.GoogleRequest DataflowProjectsSnapshotsList where
        ...
        requestClient DataflowProjectsSnapshotsList{..}
          = go projectId xgafv accessToken callback jobId location uploadType
              uploadProtocol
