             ...
             Core.QueryParam "$.xgafv" Xgafv Core.:>
               Core.QueryParam "access_token" Core.Text Core.:>
                 Core.QueryParam "callback" Core.Text Core.:>
                   Core.QueryParam "filter" ProjectsJobsListFilter Core.:>
                           ...
                           Core.QueryParam "pageToken" Core.Text Core.:>
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "view" ProjectsJobsListView Core.:>
...
newDataflowProjectsJobsList projectId
  = DataflowProjectsJobsList{xgafv = Core.Nothing,
                             accessToken = Core.Nothing, callback = Core.Nothing,
                             filter = Core.Nothing, location = Core.Nothing,
...
instance Core.GoogleRequest DataflowProjectsJobsList where
        ...
        requestClient DataflowProjectsJobsList{..}
          = go projectId xgafv accessToken callback filter location name
              pageSize
              pageToken
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy DataflowProjectsJobsListResource)
                      Core.mempty
