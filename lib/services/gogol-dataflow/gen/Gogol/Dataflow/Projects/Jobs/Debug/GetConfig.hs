                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.ReqBody '[Core.JSON] GetDebugConfigRequest Core.:>
...
newDataflowProjectsJobsDebugGetConfig jobId payload projectId
  = DataflowProjectsJobsDebugGetConfig{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       jobId = jobId, payload = payload, projectId = projectId,
                                       uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DataflowProjectsJobsDebugGetConfig
         where
        type Rs DataflowProjectsJobsDebugGetConfig = GetDebugConfigResponse
        ...
        requestClient DataflowProjectsJobsDebugGetConfig{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DataflowProjectsJobsDebugGetConfigResource)
                      Core.mempty
