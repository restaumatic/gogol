...
newDataflowProjectsJobsSnapshot jobId payload projectId
  = DataflowProjectsJobsSnapshot{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DataflowProjectsJobsSnapshot where
        ...
        requestClient DataflowProjectsJobsSnapshot{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy DataflowProjectsJobsSnapshotResource)
                      Core.mempty
