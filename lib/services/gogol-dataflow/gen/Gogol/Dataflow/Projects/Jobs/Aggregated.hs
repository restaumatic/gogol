             ...
             Core.QueryParam "$.xgafv" Xgafv Core.:>
               Core.QueryParam "access_token" Core.Text Core.:>
                 Core.QueryParam "callback" Core.Text Core.:>
                   Core.QueryParam "filter" ProjectsJobsAggregatedFilter Core.:>
                           ...
                           Core.QueryParam "pageToken" Core.Text Core.:>
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "view" ProjectsJobsAggregatedView Core.:>
...
newDataflowProjectsJobsAggregated projectId
  = DataflowProjectsJobsAggregated{xgafv = Core.Nothing,
