                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] LeaseWorkItemRequest Core.:>
...
newDataflowProjectsJobsWorkItemsLease jobId payload projectId
  = DataflowProjectsJobsWorkItemsLease{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       jobId = jobId, payload = payload, projectId = projectId,
                                       uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DataflowProjectsJobsWorkItemsLease
         where
        type Rs DataflowProjectsJobsWorkItemsLease = LeaseWorkItemResponse
        ...
        requestClient DataflowProjectsJobsWorkItemsLease{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DataflowProjectsJobsWorkItemsLeaseResource)
                      Core.mempty
