...
newDataflowProjectsWorkerMessages payload projectId
  = DataflowProjectsWorkerMessages{xgafv = Core.Nothing,
                                   accessToken = Core.Nothing, callback = Core.Nothing,
                                   payload = payload, projectId = projectId,
                                   uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DataflowProjectsWorkerMessages where
        type Rs DataflowProjectsWorkerMessages = SendWorkerMessagesResponse
        ...
        requestClient DataflowProjectsWorkerMessages{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy DataflowProjectsWorkerMessagesResource)
                      Core.mempty
