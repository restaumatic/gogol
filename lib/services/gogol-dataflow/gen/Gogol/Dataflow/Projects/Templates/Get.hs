                     ...
                     Core.QueryParam "location" Core.Text Core.:>
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "view" ProjectsTemplatesGetView Core.:>
...
newDataflowProjectsTemplatesGet projectId
  = DataflowProjectsTemplatesGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DataflowProjectsTemplatesGet where
        ...
        requestClient DataflowProjectsTemplatesGet{..}
          = go projectId xgafv accessToken callback gcsPath location
              uploadType
              uploadProtocol
              view
