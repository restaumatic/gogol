...
newDataflowProjectsLocationsJobsSnapshotsList 
    ...
    -> DataflowProjectsLocationsJobsSnapshotsList
newDataflowProjectsLocationsJobsSnapshotsList jobId location
  projectId
  = DataflowProjectsLocationsJobsSnapshotsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes DataflowProjectsLocationsJobsSnapshotsList =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient DataflowProjectsLocationsJobsSnapshotsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DataflowProjectsLocationsJobsSnapshotsListResource)
                      Core.mempty
