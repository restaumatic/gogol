...
newDataflowProjectsLocationsJobsSnapshot 
    ...
    -> DataflowProjectsLocationsJobsSnapshot
newDataflowProjectsLocationsJobsSnapshot jobId location payload
  projectId
  = DataflowProjectsLocationsJobsSnapshot{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          jobId = jobId, location = location, payload = payload,
                                          projectId = projectId, uploadType = Core.Nothing,
                                          uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DataflowProjectsLocationsJobsSnapshot
         where
        type Rs DataflowProjectsLocationsJobsSnapshot = Snapshot
        type Scopes DataflowProjectsLocationsJobsSnapshot =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient DataflowProjectsLocationsJobsSnapshot{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DataflowProjectsLocationsJobsSnapshotResource)
                      Core.mempty
