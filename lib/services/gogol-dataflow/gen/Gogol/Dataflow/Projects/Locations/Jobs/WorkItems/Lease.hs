...
newDataflowProjectsLocationsJobsWorkItemsLease 
    ...
    -> DataflowProjectsLocationsJobsWorkItemsLease
newDataflowProjectsLocationsJobsWorkItemsLease jobId location
  payload projectId
  = DataflowProjectsLocationsJobsWorkItemsLease{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes DataflowProjectsLocationsJobsWorkItemsLease =
