                           ...
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.ReqBody '[Core.JSON] Job Core.:> Core.Put '[Core.JSON] Job
...
newDataflowProjectsLocationsJobsUpdate 
    ...
    -> DataflowProjectsLocationsJobsUpdate
newDataflowProjectsLocationsJobsUpdate jobId location payload
  projectId
  = DataflowProjectsLocationsJobsUpdate{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        jobId = jobId, location = location, payload = payload,
                                        projectId = projectId, updateMask = Core.Nothing,
                                        uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DataflowProjectsLocationsJobsUpdate
         where
        ...
        requestClient DataflowProjectsLocationsJobsUpdate{..}
          = go projectId location jobId xgafv accessToken callback updateMask
              uploadType
              uploadProtocol
