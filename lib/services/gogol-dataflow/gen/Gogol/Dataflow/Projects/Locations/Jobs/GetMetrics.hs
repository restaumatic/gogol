...
newDataflowProjectsLocationsJobsGetMetrics jobId location projectId
  = DataflowProjectsLocationsJobsGetMetrics{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            jobId = jobId, location = location,
                                            projectId = projectId, startTime = Core.Nothing,
                                            uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DataflowProjectsLocationsJobsGetMetrics
         where
        ...
        requestClient DataflowProjectsLocationsJobsGetMetrics{..}
          = go projectId location jobId xgafv accessToken callback startTime
              uploadType
              uploadProtocol
