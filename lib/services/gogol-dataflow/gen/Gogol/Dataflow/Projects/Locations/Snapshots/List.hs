...
newDataflowProjectsLocationsSnapshotsList location projectId
  = DataflowProjectsLocationsSnapshotsList{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           jobId = Core.Nothing, location = location,
                                           projectId = projectId, uploadType = Core.Nothing,
                                           uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DataflowProjectsLocationsSnapshotsList
         where
        ...
        requestClient DataflowProjectsLocationsSnapshotsList{..}
          = go projectId location xgafv accessToken callback jobId uploadType
              uploadProtocol
