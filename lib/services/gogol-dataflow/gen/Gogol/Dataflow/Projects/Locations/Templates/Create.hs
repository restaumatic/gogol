                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] CreateJobFromTemplateRequest Core.:>
...
newDataflowProjectsLocationsTemplatesCreate 
    ...
    -> DataflowProjectsLocationsTemplatesCreate
newDataflowProjectsLocationsTemplatesCreate location payload
  projectId
  = DataflowProjectsLocationsTemplatesCreate{xgafv = Core.Nothing,
