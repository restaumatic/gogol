                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] LaunchFlexTemplateRequest Core.:>
...
newDataflowProjectsLocationsFlexTemplatesLaunch 
    ...
    -> DataflowProjectsLocationsFlexTemplatesLaunch
newDataflowProjectsLocationsFlexTemplatesLaunch location payload
  projectId
  = DataflowProjectsLocationsFlexTemplatesLaunch{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes DataflowProjectsLocationsFlexTemplatesLaunch =
