                             ...
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.ReqBody '[Core.JSON] SendDebugCaptureRequest Core.:>
...
newDataflowProjectsLocationsJobsDebugSendCapture 
    ...
    -> DataflowProjectsLocationsJobsDebugSendCapture
newDataflowProjectsLocationsJobsDebugSendCapture jobId location
  payload projectId
  = DataflowProjectsLocationsJobsDebugSendCapture{xgafv =
                                                    Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes DataflowProjectsLocationsJobsDebugSendCapture =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient DataflowProjectsLocationsJobsDebugSendCapture{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DataflowProjectsLocationsJobsDebugSendCaptureResource)
                      Core.mempty
