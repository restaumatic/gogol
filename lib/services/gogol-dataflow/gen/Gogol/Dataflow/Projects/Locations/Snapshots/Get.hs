...
newDataflowProjectsLocationsSnapshotsGet 
    ...
    -> DataflowProjectsLocationsSnapshotsGet
newDataflowProjectsLocationsSnapshotsGet location projectId
  snapshotId
  = DataflowProjectsLocationsSnapshotsGet{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          location = location, projectId = projectId,
                                          snapshotId = snapshotId, uploadType = Core.Nothing,
                                          uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DataflowProjectsLocationsSnapshotsGet
         where
