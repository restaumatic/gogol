                 ...
                 Core.QueryParam "$.xgafv" Xgafv Core.:>
                   Core.QueryParam "access_token" Core.Text Core.:>
                     Core.QueryParam "callback" Core.Text Core.:>
                       Core.QueryParam "filter" ProjectsLocationsJobsListFilter Core.:>
                         Core.QueryParam "name" Core.Text Core.:>
                           Core.QueryParam "pageSize" Core.Int32 Core.:>
                             Core.QueryParam "pageToken" Core.Text Core.:>
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "view" ProjectsLocationsJobsListView Core.:>
...
newDataflowProjectsLocationsJobsList location projectId
  = DataflowProjectsLocationsJobsList{xgafv = Core.Nothing,
                                      accessToken = Core.Nothing, callback = Core.Nothing,
                                      filter = Core.Nothing, location = location,
...
instance Core.GoogleRequest DataflowProjectsLocationsJobsList where
        ...
        requestClient DataflowProjectsLocationsJobsList{..}
          = go projectId location xgafv accessToken callback filter name
              pageSize
              pageToken
              uploadType
              uploadProtocol
