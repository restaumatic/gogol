...
newDataflowProjectsLocationsJobsDebugGetConfig 
    ...
    -> DataflowProjectsLocationsJobsDebugGetConfig
newDataflowProjectsLocationsJobsDebugGetConfig jobId location
  payload projectId
  = DataflowProjectsLocationsJobsDebugGetConfig{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes DataflowProjectsLocationsJobsDebugGetConfig =
