...
newDataflowProjectsLocationsSnapshotsDelete 
    ...
    -> DataflowProjectsLocationsSnapshotsDelete
newDataflowProjectsLocationsSnapshotsDelete location projectId
  snapshotId
  = DataflowProjectsLocationsSnapshotsDelete{xgafv = Core.Nothing,
                                             accessToken = Core.Nothing, callback = Core.Nothing,
                                             location = location, projectId = projectId,
                                             snapshotId = snapshotId, uploadType = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        requestClient DataflowProjectsLocationsSnapshotsDelete{..}
          = go projectId location snapshotId xgafv accessToken callback
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DataflowProjectsLocationsSnapshotsDeleteResource)
                      Core.mempty
