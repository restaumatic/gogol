...
newDataflowProjectsLocationsJobsMessagesList 
    ...
    -> DataflowProjectsLocationsJobsMessagesList
newDataflowProjectsLocationsJobsMessagesList jobId location
  projectId
  = DataflowProjectsLocationsJobsMessagesList{xgafv = Core.Nothing,
                                              accessToken = Core.Nothing, callback = Core.Nothing,
                                              endTime = Core.Nothing, jobId = jobId,
                                              location = location, minimumImportance = Core.Nothing,
                                              pageSize = Core.Nothing, pageToken = Core.Nothing,
                                              projectId = projectId, startTime = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        requestClient DataflowProjectsLocationsJobsMessagesList{..}
          = go projectId location jobId xgafv accessToken callback endTime
              minimumImportance
              pageSize
              pageToken
              startTime
