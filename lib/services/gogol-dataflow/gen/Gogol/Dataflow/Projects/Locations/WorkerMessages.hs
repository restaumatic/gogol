                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] SendWorkerMessagesRequest Core.:>
...
newDataflowProjectsLocationsWorkerMessages 
    ...
    -> DataflowProjectsLocationsWorkerMessages
newDataflowProjectsLocationsWorkerMessages location payload
  projectId
  = DataflowProjectsLocationsWorkerMessages{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            location = location, payload = payload,
                                            projectId = projectId, uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DataflowProjectsLocationsWorkerMessages
         where
        type Rs DataflowProjectsLocationsWorkerMessages =
             SendWorkerMessagesResponse
        type Scopes DataflowProjectsLocationsWorkerMessages =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient DataflowProjectsLocationsWorkerMessages{..}
          = go projectId location xgafv accessToken callback uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DataflowProjectsLocationsWorkerMessagesResource)
                      Core.mempty
