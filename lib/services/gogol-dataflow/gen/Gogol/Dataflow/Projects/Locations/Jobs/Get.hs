                       ...
                       Core.QueryParam "callback" Core.Text Core.:>
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "view" ProjectsLocationsJobsGetView Core.:>
...
newDataflowProjectsLocationsJobsGet jobId location projectId
  = DataflowProjectsLocationsJobsGet{xgafv = Core.Nothing,
                                     accessToken = Core.Nothing, callback = Core.Nothing,
                                     jobId = jobId, location = location, projectId = projectId,
                                     uploadType = Core.Nothing, uploadProtocol = Core.Nothing,
                                     view = Core.Nothing}
instance Core.GoogleRequest DataflowProjectsLocationsJobsGet where
        ...
        requestClient DataflowProjectsLocationsJobsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy DataflowProjectsLocationsJobsGetResource)
                      Core.mempty
