...
newDataflowProjectsLocationsJobsGetExecutionDetails 
    ...
    -> DataflowProjectsLocationsJobsGetExecutionDetails
newDataflowProjectsLocationsJobsGetExecutionDetails jobId location
  projectId
  = DataflowProjectsLocationsJobsGetExecutionDetails{xgafv =
                                                       Core.Nothing,
                                                     accessToken = Core.Nothing,
                                                     callback = Core.Nothing, jobId = jobId,
                                                     location = location, pageSize = Core.Nothing,
...
instance Core.GoogleRequest
           DataflowProjectsLocationsJobsGetExecutionDetails
         where
        type Rs DataflowProjectsLocationsJobsGetExecutionDetails =
             JobExecutionDetails
        type Scopes DataflowProjectsLocationsJobsGetExecutionDetails =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient DataflowProjectsLocationsJobsGetExecutionDetails{..}
          = go projectId location jobId xgafv accessToken callback pageSize
              pageToken
              uploadType
              uploadProtocol
