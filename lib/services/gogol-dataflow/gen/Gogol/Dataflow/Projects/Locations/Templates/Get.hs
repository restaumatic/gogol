                       ...
                       Core.QueryParam "gcsPath" Core.Text Core.:>
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "view" ProjectsLocationsTemplatesGetView Core.:>
...
newDataflowProjectsLocationsTemplatesGet location projectId
  = DataflowProjectsLocationsTemplatesGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DataflowProjectsLocationsTemplatesGet
         where
        ...
        requestClient DataflowProjectsLocationsTemplatesGet{..}
          = go projectId location xgafv accessToken callback gcsPath
              uploadType
              uploadProtocol
              view
