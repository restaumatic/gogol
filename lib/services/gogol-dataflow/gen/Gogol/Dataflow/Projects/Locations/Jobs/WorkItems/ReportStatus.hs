...
newDataflowProjectsLocationsJobsWorkItemsReportStatus jobId
  ...
  = DataflowProjectsLocationsJobsWorkItemsReportStatus{xgafv =
                                                         Core.Nothing,
...
instance Core.GoogleRequest
           DataflowProjectsLocationsJobsWorkItemsReportStatus
         where
        type Rs DataflowProjectsLocationsJobsWorkItemsReportStatus =
             ReportWorkItemStatusResponse
        type Scopes DataflowProjectsLocationsJobsWorkItemsReportStatus =
