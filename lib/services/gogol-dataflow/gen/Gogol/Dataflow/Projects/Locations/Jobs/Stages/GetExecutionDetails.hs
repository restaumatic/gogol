                                       ...
                                       Core.QueryParam "uploadType" Core.Text Core.:>
                                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                                           Core.QueryParam "alt" Core.AltJSON Core.:>
                                             Core.Get '[Core.JSON] StageExecutionDetails
...
newDataflowProjectsLocationsJobsStagesGetExecutionDetails 
    ...
    -> DataflowProjectsLocationsJobsStagesGetExecutionDetails
newDataflowProjectsLocationsJobsStagesGetExecutionDetails jobId
  location projectId stageId
  = DataflowProjectsLocationsJobsStagesGetExecutionDetails{xgafv =
                                                             Core.Nothing,
                                                           accessToken = Core.Nothing,
                                                           callback = Core.Nothing,
                                                           endTime = Core.Nothing, jobId = jobId,
                                                           location = location,
...
instance Core.GoogleRequest
           DataflowProjectsLocationsJobsStagesGetExecutionDetails
         where
        type Rs DataflowProjectsLocationsJobsStagesGetExecutionDetails =
             StageExecutionDetails
        type Scopes DataflowProjectsLocationsJobsStagesGetExecutionDetails
             = '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient
          DataflowProjectsLocationsJobsStagesGetExecutionDetails{..}
          = go projectId location jobId stageId xgafv accessToken callback
              endTime
              pageSize
              pageToken
              startTime
