...
newAccount 
    ::  Account
newAccount
  = Account{accountId = Core.Nothing, features = Core.Nothing,
            fingerprint = Core.Nothing, name = Core.Nothing,
            path = Core.Nothing, shareData = Core.Nothing,
...
instance Core.FromJSON Account where
        parseJSON
          = Core.withObject "Account"
              (\ o ->
                 Account Core.<$>
                   (o Core..:? "accountId") Core.<*> (o Core..:? "features") Core.<*>
                     (o Core..:? "fingerprint")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "path")
...
instance Core.FromJSON AccountAccess where
        parseJSON
          = Core.withObject "AccountAccess"
              (\ o -> AccountAccess Core.<$> (o Core..:? "permission"))
...
newAccountFeatures 
    ::  AccountFeatures
newAccountFeatures
  = AccountFeatures{supportMultipleContainers = Core.Nothing,
...
newBuiltInVariable 
    ::  BuiltInVariable
newBuiltInVariable
  = BuiltInVariable{accountId = Core.Nothing,
                    containerId = Core.Nothing, name = Core.Nothing,
                    path = Core.Nothing, type' = Core.Nothing,
          ...
          = Core.withObject "BuiltInVariable"
              (\ o ->
                 BuiltInVariable Core.<$>
                   (o Core..:? "accountId") Core.<*> (o Core..:? "containerId")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "path")
                     Core.<*> (o Core..:? "type")
...
newClient 
    ::  Client
newClient
  = Client{accountId = Core.Nothing, clientId = Core.Nothing,
           containerId = Core.Nothing, fingerprint = Core.Nothing,
           name = Core.Nothing, notes = Core.Nothing,
           parameter = Core.Nothing, parentFolderId = Core.Nothing,
           path = Core.Nothing, priority = Core.Nothing,
           tagManagerUrl = Core.Nothing, type' = Core.Nothing,
           workspaceId = Core.Nothing}
instance Core.FromJSON Client where
        parseJSON
          = Core.withObject "Client"
              (\ o ->
                 Client Core.<$>
                   (o Core..:? "accountId") Core.<*> (o Core..:? "clientId") Core.<*>
                     (o Core..:? "containerId")
...
newCondition 
    ::  Condition
newCondition
  = Condition{parameter = Core.Nothing, type' = Core.Nothing}
instance Core.FromJSON Condition where
        parseJSON
          = Core.withObject "Condition"
              (\ o ->
                 Condition Core.<$>
                   (o Core..:? "parameter") Core.<*> (o Core..:? "type"))
...
newContainer 
    ::  Container
newContainer
  = Container{accountId = Core.Nothing, containerId = Core.Nothing,
              domainName = Core.Nothing, features = Core.Nothing,
              fingerprint = Core.Nothing, name = Core.Nothing,
              notes = Core.Nothing, path = Core.Nothing, publicId = Core.Nothing,
              tagIds = Core.Nothing, tagManagerUrl = Core.Nothing,
              taggingServerUrls = Core.Nothing, usageContext = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("accountId" Core..=) Core.<$> accountId,
                  ...
                  ("tagManagerUrl" Core..=) Core.<$> tagManagerUrl,
                  ("taggingServerUrls" Core..=) Core.<$> taggingServerUrls,
...
newContainerAccess 
    ::  ContainerAccess
newContainerAccess
  = ContainerAccess{containerId = Core.Nothing,
          ...
          = Core.withObject "ContainerAccess"
              (\ o ->
                 ContainerAccess Core.<$>
                   (o Core..:? "containerId") Core.<*> (o Core..:? "permission"))
...
newContainerFeatures 
    ::  ContainerFeatures
newContainerFeatures
  = ContainerFeatures{supportBuiltInVariables = Core.Nothing,
                      supportClients = Core.Nothing, supportEnvironments = Core.Nothing,
                      supportFolders = Core.Nothing, supportGtagConfigs = Core.Nothing,
                      supportTags = Core.Nothing, supportTemplates = Core.Nothing,
                      supportTransformations = Core.Nothing,
                      supportTriggers = Core.Nothing,
                      supportUserPermissions = Core.Nothing,
                      supportVariables = Core.Nothing, supportVersions = Core.Nothing,
                      supportWorkspaces = Core.Nothing, supportZones = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("supportBuiltInVariables" Core..=) Core.<$>
                  ...
                  ("supportEnvironments" Core..=) Core.<$> supportEnvironments,
                  ("supportFolders" Core..=) Core.<$> supportFolders,
                  ("supportGtagConfigs" Core..=) Core.<$> supportGtagConfigs,
                  ("supportTags" Core..=) Core.<$> supportTags,
                  ("supportTemplates" Core..=) Core.<$> supportTemplates,
                  ("supportTransformations" Core..=) Core.<$> supportTransformations,
                  ("supportTriggers" Core..=) Core.<$> supportTriggers,
                  ("supportUserPermissions" Core..=) Core.<$> supportUserPermissions,
                  ("supportVariables" Core..=) Core.<$> supportVariables,
                  ("supportVersions" Core..=) Core.<$> supportVersions,
                  ("supportWorkspaces" Core..=) Core.<$> supportWorkspaces,
...
newContainerVersion 
    ::  ContainerVersion
newContainerVersion
  = ContainerVersion{accountId = Core.Nothing,
                     builtInVariable = Core.Nothing, client = Core.Nothing,
                     container = Core.Nothing, containerId = Core.Nothing,
                     containerVersionId = Core.Nothing, customTemplate = Core.Nothing,
                     deleted = Core.Nothing, description = Core.Nothing,
                     fingerprint = Core.Nothing, folder = Core.Nothing,
                     gtagConfig = Core.Nothing, name = Core.Nothing,
                     path = Core.Nothing, tag = Core.Nothing,
                     tagManagerUrl = Core.Nothing, transformation = Core.Nothing,
                     trigger = Core.Nothing, variable = Core.Nothing,
                     zone = Core.Nothing}
          ...
          = Core.withObject "ContainerVersion"
              (\ o ->
                 ContainerVersion Core.<$>
                   (o Core..:? "accountId") Core.<*> (o Core..:? "builtInVariable")
                     Core.<*> (o Core..:? "client")
          ...
          = Core.object
              (Core.catMaybes
                 [("accountId" Core..=) Core.<$> accountId,
                  ...
                  ("containerId" Core..=) Core.<$> containerId,
                  ("containerVersionId" Core..=) Core.<$> containerVersionId,
...
newContainerVersionHeader 
    ::  ContainerVersionHeader
newContainerVersionHeader
  = ContainerVersionHeader{accountId = Core.Nothing,
                           containerId = Core.Nothing, containerVersionId = Core.Nothing,
                           deleted = Core.Nothing, name = Core.Nothing,
                           numClients = Core.Nothing, numCustomTemplates = Core.Nothing,
                           numGtagConfigs = Core.Nothing, numTags = Core.Nothing,
                           numTransformations = Core.Nothing, numTriggers = Core.Nothing,
                           numVariables = Core.Nothing, numZones = Core.Nothing,
                           path = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("accountId" Core..=) Core.<$> accountId,
                  ...
                  ("numCustomTemplates" Core..=) Core.<$> numCustomTemplates,
                  ("numGtagConfigs" Core..=) Core.<$> numGtagConfigs,
                  ("numTags" Core..=) Core.<$> numTags,
                  ("numTransformations" Core..=) Core.<$> numTransformations,
...
instance Core.FromJSON CreateBuiltInVariableResponse where
        parseJSON
...
newCreateContainerVersionRequestVersionOptions 
    :: 
                                               CreateContainerVersionRequestVersionOptions
newCreateContainerVersionRequestVersionOptions
  = CreateContainerVersionRequestVersionOptions{name = Core.Nothing,
                                                notes = Core.Nothing}
instance Core.FromJSON CreateContainerVersionRequestVersionOptions
         where
        parseJSON
          = Core.withObject "CreateContainerVersionRequestVersionOptions"
              (\ o ->
                 CreateContainerVersionRequestVersionOptions Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "notes"))

instance Core.ToJSON CreateContainerVersionRequestVersionOptions
         where
...
newCreateContainerVersionResponse 
    ::  CreateContainerVersionResponse
newCreateContainerVersionResponse
  = CreateContainerVersionResponse{compilerError = Core.Nothing,
                                   containerVersion = Core.Nothing,
                                   newWorkspacePath' = Core.Nothing, syncStatus = Core.Nothing}
instance Core.FromJSON CreateContainerVersionResponse where
        parseJSON
...
newCustomTemplate 
    ::  CustomTemplate
newCustomTemplate
  = CustomTemplate{accountId = Core.Nothing,
                   containerId = Core.Nothing, fingerprint = Core.Nothing,
                   galleryReference = Core.Nothing, name = Core.Nothing,
                   path = Core.Nothing, tagManagerUrl = Core.Nothing,
                   templateData = Core.Nothing, templateId = Core.Nothing,
                   workspaceId = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("accountId" Core..=) Core.<$> accountId,
                  ("containerId" Core..=) Core.<$> containerId,
                  ("fingerprint" Core..=) Core.<$> fingerprint,
                  ("galleryReference" Core..=) Core.<$> galleryReference,
                  ("name" Core..=) Core.<$> name, ("path" Core..=) Core.<$> path,
                  ("tagManagerUrl" Core..=) Core.<$> tagManagerUrl,
...
newDestination 
    ::  Destination
newDestination
  = Destination{accountId = Core.Nothing, containerId = Core.Nothing,
                destinationId = Core.Nothing, destinationLinkId = Core.Nothing,
                fingerprint = Core.Nothing, name = Core.Nothing,
                path = Core.Nothing, tagManagerUrl = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("accountId" Core..=) Core.<$> accountId,
                  ...
                  ("destinationLinkId" Core..=) Core.<$> destinationLinkId,
                  ("fingerprint" Core..=) Core.<$> fingerprint,
                  ("name" Core..=) Core.<$> name, ("path" Core..=) Core.<$> path,
                  ("tagManagerUrl" Core..=) Core.<$> tagManagerUrl])
...
newEntity 
    ::  Entity
newEntity
  = Entity{builtInVariable = Core.Nothing,
           changeStatus = Core.Nothing, client = Core.Nothing,
           customTemplate = Core.Nothing, folder = Core.Nothing,
           gtagConfig = Core.Nothing, tag = Core.Nothing,
           transformation = Core.Nothing, trigger = Core.Nothing,
           variable = Core.Nothing, zone = Core.Nothing}
instance Core.FromJSON Entity where
        parseJSON
          = Core.withObject "Entity"
              (\ o ->
                 Entity Core.<$>
                   (o Core..:? "builtInVariable") Core.<*> (o Core..:? "changeStatus")
                     Core.<*> (o Core..:? "client")
                     Core.<*> (o Core..:? "customTemplate")
                     Core.<*> (o Core..:? "folder")
                     Core.<*> (o Core..:? "gtagConfig")
...
newEnvironment 
    ::  Environment
newEnvironment
  = Environment{accountId = Core.Nothing,
                authorizationCode = Core.Nothing,
                authorizationTimestamp = Core.Nothing, containerId = Core.Nothing,
                containerVersionId = Core.Nothing, description = Core.Nothing,
                enableDebug = Core.Nothing, environmentId = Core.Nothing,
                fingerprint = Core.Nothing, name = Core.Nothing,
                path = Core.Nothing, tagManagerUrl = Core.Nothing,
...
instance Core.FromJSON Environment where
        parseJSON
          = Core.withObject "Environment"
              (\ o ->
                 Environment Core.<$>
                   (o Core..:? "accountId") Core.<*> (o Core..:? "authorizationCode")
...
instance Core.ToJSON Environment where
        toJSON Environment{..}
          = Core.object
              (Core.catMaybes
                 [("accountId" Core..=) Core.<$> accountId,
                  ("authorizationCode" Core..=) Core.<$> authorizationCode,
                  ("authorizationTimestamp" Core..=) Core.<$> authorizationTimestamp,
                  ("containerId" Core..=) Core.<$> containerId,
                  ("containerVersionId" Core..=) Core.<$> containerVersionId,
                  ("description" Core..=) Core.<$> description,
...
newFolder 
    ::  Folder
newFolder
  = Folder{accountId = Core.Nothing, containerId = Core.Nothing,
           fingerprint = Core.Nothing, folderId = Core.Nothing,
           name = Core.Nothing, notes = Core.Nothing, path = Core.Nothing,
           tagManagerUrl = Core.Nothing, workspaceId = Core.Nothing}
...
newFolderEntities 
    ::  FolderEntities
newFolderEntities
  = FolderEntities{nextPageToken = Core.Nothing, tag = Core.Nothing,
                   trigger = Core.Nothing, variable = Core.Nothing}
instance Core.FromJSON FolderEntities where
        parseJSON
          = Core.withObject "FolderEntities"
              (\ o ->
                 FolderEntities Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "tag") Core.<*>
                     (o Core..:? "trigger")
                     Core.<*> (o Core..:? "variable"))
          ...
          = Core.object
              (Core.catMaybes
                 [("nextPageToken" Core..=) Core.<$> nextPageToken,
                  ("tag" Core..=) Core.<$> tag, ("trigger" Core..=) Core.<$> trigger,
                  ("variable" Core..=) Core.<$> variable])
...
newGalleryReference 
    ::  GalleryReference
newGalleryReference
  = GalleryReference{galleryTemplateId = Core.Nothing,
                     host = Core.Nothing, isModified = Core.Nothing,
                     owner = Core.Nothing, repository = Core.Nothing,
                     signature = Core.Nothing, templateDeveloperId = Core.Nothing,
          ...
          = Core.withObject "GalleryReference"
              (\ o ->
                 GalleryReference Core.<$>
                   (o Core..:? "galleryTemplateId") Core.<*> (o Core..:? "host")
          ...
          = Core.object
              (Core.catMaybes
                 [("galleryTemplateId" Core..=) Core.<$> galleryTemplateId,
                  ...
                  ("templateDeveloperId" Core..=) Core.<$> templateDeveloperId,
...
newGetContainerSnippetResponse 
    ::  GetContainerSnippetResponse
newGetContainerSnippetResponse
  = GetContainerSnippetResponse{containerConfig = Core.Nothing,
          ...
          = Core.withObject "GetContainerSnippetResponse"
              (\ o ->
                 GetContainerSnippetResponse Core.<$>
                   (o Core..:? "containerConfig") Core.<*> (o Core..:? "snippet"))
...
newGetWorkspaceStatusResponse 
    ::  GetWorkspaceStatusResponse
newGetWorkspaceStatusResponse
  = GetWorkspaceStatusResponse{mergeConflict = Core.Nothing,
                               workspaceChange = Core.Nothing}
instance Core.FromJSON GetWorkspaceStatusResponse where
        parseJSON
          ...
          = Core.object
              (Core.catMaybes
                 [("mergeConflict" Core..=) Core.<$> mergeConflict,
                  ("workspaceChange" Core..=) Core.<$> workspaceChange])
...
newGtagConfig 
    ::  GtagConfig
newGtagConfig
  = GtagConfig{accountId = Core.Nothing, containerId = Core.Nothing,
               fingerprint = Core.Nothing, gtagConfigId = Core.Nothing,
               parameter = Core.Nothing, path = Core.Nothing,
               tagManagerUrl = Core.Nothing, type' = Core.Nothing,
               workspaceId = Core.Nothing}
...
newListAccountsResponse 
    ::  ListAccountsResponse
newListAccountsResponse
  = ListAccountsResponse{account = Core.Nothing,
          ...
          = Core.withObject "ListAccountsResponse"
              (\ o ->
                 ListAccountsResponse Core.<$>
                   (o Core..:? "account") Core.<*> (o Core..:? "nextPageToken"))
...
newListClientsResponse 
    ::  ListClientsResponse
newListClientsResponse
  = ListClientsResponse{client = Core.Nothing,
                        nextPageToken = Core.Nothing}
          ...
          = Core.withObject "ListClientsResponse"
              (\ o ->
                 ListClientsResponse Core.<$>
                   (o Core..:? "client") Core.<*> (o Core..:? "nextPageToken"))
...
newListContainerVersionsResponse 
    ::  ListContainerVersionsResponse
newListContainerVersionsResponse
  = ListContainerVersionsResponse{containerVersionHeader =
                                    Core.Nothing,
                                  nextPageToken = Core.Nothing}
instance Core.FromJSON ListContainerVersionsResponse where
        parseJSON
...
instance Core.ToJSON ListContainerVersionsResponse where
...
newListContainersResponse 
    ::  ListContainersResponse
newListContainersResponse
  = ListContainersResponse{container = Core.Nothing,
                           nextPageToken = Core.Nothing}
          ...
          = Core.withObject "ListContainersResponse"
              (\ o ->
                 ListContainersResponse Core.<$>
                   (o Core..:? "container") Core.<*> (o Core..:? "nextPageToken"))
...
newListDestinationsResponse 
    ::  ListDestinationsResponse
newListDestinationsResponse
  = ListDestinationsResponse{destination = Core.Nothing,
                             nextPageToken = Core.Nothing}
          ...
          = Core.withObject "ListDestinationsResponse"
              (\ o ->
                 ListDestinationsResponse Core.<$>
                   (o Core..:? "destination") Core.<*> (o Core..:? "nextPageToken"))
...
newListEnabledBuiltInVariablesResponse 
    :: 
                                       ListEnabledBuiltInVariablesResponse
newListEnabledBuiltInVariablesResponse
  = ListEnabledBuiltInVariablesResponse{builtInVariable =
                                          Core.Nothing,
                                        nextPageToken = Core.Nothing}
instance Core.FromJSON ListEnabledBuiltInVariablesResponse where
        parseJSON
          = Core.withObject "ListEnabledBuiltInVariablesResponse"
              (\ o ->
                 ListEnabledBuiltInVariablesResponse Core.<$>
                   (o Core..:? "builtInVariable") Core.<*>
                     (o Core..:? "nextPageToken"))

instance Core.ToJSON ListEnabledBuiltInVariablesResponse where
...
newListEnvironmentsResponse 
    ::  ListEnvironmentsResponse
newListEnvironmentsResponse
  = ListEnvironmentsResponse{environment = Core.Nothing,
                             nextPageToken = Core.Nothing}
          ...
          = Core.withObject "ListEnvironmentsResponse"
              (\ o ->
                 ListEnvironmentsResponse Core.<$>
                   (o Core..:? "environment") Core.<*> (o Core..:? "nextPageToken"))
...
newListFoldersResponse 
    ::  ListFoldersResponse
newListFoldersResponse
  = ListFoldersResponse{folder = Core.Nothing,
                        nextPageToken = Core.Nothing}
          ...
          = Core.withObject "ListFoldersResponse"
              (\ o ->
                 ListFoldersResponse Core.<$>
                   (o Core..:? "folder") Core.<*> (o Core..:? "nextPageToken"))
...
newListGtagConfigResponse 
    ::  ListGtagConfigResponse
newListGtagConfigResponse
  = ListGtagConfigResponse{gtagConfig = Core.Nothing,
                           nextPageToken = Core.Nothing}
          ...
          = Core.withObject "ListGtagConfigResponse"
              (\ o ->
                 ListGtagConfigResponse Core.<$>
                   (o Core..:? "gtagConfig") Core.<*> (o Core..:? "nextPageToken"))
...
newListTagsResponse 
    ::  ListTagsResponse
newListTagsResponse
  = ListTagsResponse{nextPageToken = Core.Nothing,
                     tag = Core.Nothing}
          ...
          = Core.withObject "ListTagsResponse"
              (\ o ->
                 ListTagsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "tag"))
...
newListTemplatesResponse 
    ::  ListTemplatesResponse
newListTemplatesResponse
  = ListTemplatesResponse{nextPageToken = Core.Nothing,
          ...
          = Core.withObject "ListTemplatesResponse"
              (\ o ->
                 ListTemplatesResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "template"))
...
newListTransformationsResponse 
    ::  ListTransformationsResponse
newListTransformationsResponse
  = ListTransformationsResponse{nextPageToken = Core.Nothing,
                                transformation = Core.Nothing}
instance Core.FromJSON ListTransformationsResponse where
        parseJSON
...
instance Core.ToJSON ListTransformationsResponse where
...
newListTriggersResponse 
    ::  ListTriggersResponse
newListTriggersResponse
  = ListTriggersResponse{nextPageToken = Core.Nothing,
          ...
          = Core.withObject "ListTriggersResponse"
              (\ o ->
                 ListTriggersResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "trigger"))
...
newListUserPermissionsResponse 
    ::  ListUserPermissionsResponse
newListUserPermissionsResponse
  = ListUserPermissionsResponse{nextPageToken = Core.Nothing,
                                userPermission = Core.Nothing}
instance Core.FromJSON ListUserPermissionsResponse where
        parseJSON
...
newListVariablesResponse 
    ::  ListVariablesResponse
newListVariablesResponse
  = ListVariablesResponse{nextPageToken = Core.Nothing,
          ...
          = Core.withObject "ListVariablesResponse"
              (\ o ->
                 ListVariablesResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "variable"))
...
newListWorkspacesResponse 
    ::  ListWorkspacesResponse
newListWorkspacesResponse
  = ListWorkspacesResponse{nextPageToken = Core.Nothing,
          ...
          = Core.withObject "ListWorkspacesResponse"
              (\ o ->
                 ListWorkspacesResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "workspace"))
...
newListZonesResponse 
    ::  ListZonesResponse
newListZonesResponse
  = ListZonesResponse{nextPageToken = Core.Nothing,
                      zone = Core.Nothing}
          ...
          = Core.withObject "ListZonesResponse"
              (\ o ->
                 ListZonesResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "zone"))
...
newMergeConflict 
    ::  MergeConflict
newMergeConflict
  = MergeConflict{entityInBaseVersion = Core.Nothing,
                  entityInWorkspace = Core.Nothing}
...
instance Core.ToJSON MergeConflict where
        toJSON MergeConflict{..}
          = Core.object
              (Core.catMaybes
                 [("entityInBaseVersion" Core..=) Core.<$> entityInBaseVersion,
                  ("entityInWorkspace" Core..=) Core.<$> entityInWorkspace])
...
newParameter 
    ::  Parameter
newParameter
  = Parameter{isWeakReference = Core.Nothing, key = Core.Nothing,
              list = Core.Nothing, map = Core.Nothing, type' = Core.Nothing,
              value = Core.Nothing}
instance Core.FromJSON Parameter where
        parseJSON
          = Core.withObject "Parameter"
              (\ o ->
                 Parameter Core.<$>
                   (o Core..:? "isWeakReference") Core.<*> (o Core..:? "key") Core.<*>
                     (o Core..:? "list")
                     Core.<*> (o Core..:? "map")
                     Core.<*> (o Core..:? "type")
                     Core.<*> (o Core..:? "value"))
...
instance Core.ToJSON Parameter where
        toJSON Parameter{..}
          = Core.object
              (Core.catMaybes
                 [("isWeakReference" Core..=) Core.<$> isWeakReference,
                  ("key" Core..=) Core.<$> key, ("list" Core..=) Core.<$> list,
                  ("map" Core..=) Core.<$> map, ("type" Core..=) Core.<$> type',
...
newPublishContainerVersionResponse 
    :: 
                                   PublishContainerVersionResponse
newPublishContainerVersionResponse
  = PublishContainerVersionResponse{compilerError = Core.Nothing,
                                    containerVersion = Core.Nothing}
instance Core.FromJSON PublishContainerVersionResponse where
        parseJSON
...
instance Core.ToJSON PublishContainerVersionResponse where
...
newQuickPreviewResponse 
    ::  QuickPreviewResponse
newQuickPreviewResponse
  = QuickPreviewResponse{compilerError = Core.Nothing,
                         containerVersion = Core.Nothing, syncStatus = Core.Nothing}
...
instance Core.FromJSON RevertBuiltInVariableResponse where
        parseJSON
          = Core.withObject "RevertBuiltInVariableResponse"
              (\ o ->
                 RevertBuiltInVariableResponse Core.<$> (o Core..:? "enabled"))

instance Core.ToJSON RevertBuiltInVariableResponse where
...
instance Core.FromJSON RevertTagResponse where
        parseJSON
          = Core.withObject "RevertTagResponse"
              (\ o -> RevertTagResponse Core.<$> (o Core..:? "tag"))
...
instance Core.FromJSON RevertTransformationResponse where
        parseJSON
...
instance Core.ToJSON RevertTransformationResponse where
...
instance Core.FromJSON RevertZoneResponse where
        parseJSON
          = Core.withObject "RevertZoneResponse"
              (\ o -> RevertZoneResponse Core.<$> (o Core..:? "zone"))

instance Core.ToJSON RevertZoneResponse where
        toJSON RevertZoneResponse{..}
          = Core.object (Core.catMaybes [("zone" Core..=) Core.<$> zone])
...
newSetupTag 
    ::  SetupTag
newSetupTag
  = SetupTag{stopOnSetupFailure = Core.Nothing,
...
instance Core.FromJSON SetupTag where
        parseJSON
          = Core.withObject "SetupTag"
              (\ o ->
                 SetupTag Core.<$>
                   (o Core..:? "stopOnSetupFailure") Core.<*> (o Core..:? "tagName"))

instance Core.ToJSON SetupTag where
        toJSON SetupTag{..}
          = Core.object
              (Core.catMaybes
                 [("stopOnSetupFailure" Core..=) Core.<$> stopOnSetupFailure,
...
newSyncStatus 
    ::  SyncStatus
newSyncStatus
  = SyncStatus{mergeConflict = Core.Nothing,
               syncError = Core.Nothing}
instance Core.FromJSON SyncStatus where
        parseJSON
          = Core.withObject "SyncStatus"
              (\ o ->
                 SyncStatus Core.<$>
                   (o Core..:? "mergeConflict") Core.<*> (o Core..:? "syncError"))
...
newSyncWorkspaceResponse 
    ::  SyncWorkspaceResponse
newSyncWorkspaceResponse
  = SyncWorkspaceResponse{mergeConflict = Core.Nothing,
          ...
          = Core.withObject "SyncWorkspaceResponse"
              (\ o ->
                 SyncWorkspaceResponse Core.<$>
                   (o Core..:? "mergeConflict") Core.<*> (o Core..:? "syncStatus"))
...
newTag 
    ::  Tag
newTag
  = Tag{accountId = Core.Nothing, blockingTriggerId = Core.Nothing,
        consentSettings = Core.Nothing, containerId = Core.Nothing,
        fingerprint = Core.Nothing, firingTriggerId = Core.Nothing,
        liveOnly = Core.Nothing, monitoringMetadata = Core.Nothing,
        monitoringMetadataTagNameKey = Core.Nothing, name = Core.Nothing,
        notes = Core.Nothing, parameter = Core.Nothing,
        parentFolderId = Core.Nothing, path = Core.Nothing,
        paused = Core.Nothing, priority = Core.Nothing,
        scheduleEndMs = Core.Nothing, scheduleStartMs = Core.Nothing,
        setupTag = Core.Nothing, tagFiringOption = Core.Nothing,
        tagId = Core.Nothing, tagManagerUrl = Core.Nothing,
        teardownTag = Core.Nothing, type' = Core.Nothing,
        workspaceId = Core.Nothing}
instance Core.FromJSON Tag where
        parseJSON
          = Core.withObject "Tag"
              (\ o ->
                 Tag Core.<$>
                   (o Core..:? "accountId") Core.<*> (o Core..:? "blockingTriggerId")
                     ...
                     Core.<*> (o Core..:? "priority")
                     Core.<*>
                     (o Core..:? "scheduleEndMs" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "scheduleStartMs" Core.<&> Core.fmap Core.fromAsText)
...
newTagConsentSetting 
    ::  TagConsentSetting
newTagConsentSetting
  = TagConsentSetting{consentStatus = Core.Nothing,
                      consentType = Core.Nothing}
instance Core.FromJSON TagConsentSetting where
        parseJSON
          = Core.withObject "TagConsentSetting"
              (\ o ->
                 TagConsentSetting Core.<$>
                   (o Core..:? "consentStatus") Core.<*> (o Core..:? "consentType"))
...
newTeardownTag 
    ::  TeardownTag
newTeardownTag
  = TeardownTag{stopTeardownOnFailure = Core.Nothing,
                tagName = Core.Nothing}
...
instance Core.ToJSON TeardownTag where
        toJSON TeardownTag{..}
          = Core.object
              (Core.catMaybes
                 [("stopTeardownOnFailure" Core..=) Core.<$> stopTeardownOnFailure,
                  ("tagName" Core..=) Core.<$> tagName])
...
newTransformation 
    ::  Transformation
newTransformation
  = Transformation{accountId = Core.Nothing,
                   containerId = Core.Nothing, fingerprint = Core.Nothing,
                   name = Core.Nothing, notes = Core.Nothing,
                   parameter = Core.Nothing, parentFolderId = Core.Nothing,
                   path = Core.Nothing, tagManagerUrl = Core.Nothing,
                   transformationId = Core.Nothing, type' = Core.Nothing,
                   workspaceId = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("accountId" Core..=) Core.<$> accountId,
                  ...
                  ("path" Core..=) Core.<$> path,
                  ("tagManagerUrl" Core..=) Core.<$> tagManagerUrl,
                  ("transformationId" Core..=) Core.<$> transformationId,
                  ("type" Core..=) Core.<$> type',
                  ("workspaceId" Core..=) Core.<$> workspaceId])
...
data Trigger = Trigger
    ...
    , waitForTags :: (Core.Maybe Parameter)
      -- | How long to wait (in milliseconds) for tags to fire when \'waits/for/tags\' above evaluates to true. Only valid for Form Submission and Link Click triggers.
...
newTrigger 
    ::  Trigger
newTrigger
  = Trigger{accountId = Core.Nothing, autoEventFilter = Core.Nothing,
            checkValidation = Core.Nothing, containerId = Core.Nothing,
            continuousTimeMinMilliseconds = Core.Nothing,
            customEventFilter = Core.Nothing, eventName = Core.Nothing,
            filter = Core.Nothing, fingerprint = Core.Nothing,
            horizontalScrollPercentageList = Core.Nothing,
            interval = Core.Nothing, intervalSeconds = Core.Nothing,
            limit = Core.Nothing, maxTimerLengthSeconds = Core.Nothing,
            name = Core.Nothing, notes = Core.Nothing,
            parameter = Core.Nothing, parentFolderId = Core.Nothing,
            path = Core.Nothing, selector = Core.Nothing,
            tagManagerUrl = Core.Nothing,
            totalTimeMinMilliseconds = Core.Nothing, triggerId = Core.Nothing,
            type' = Core.Nothing, uniqueTriggerId = Core.Nothing,
            verticalScrollPercentageList = Core.Nothing,
            visibilitySelector = Core.Nothing,
            visiblePercentageMax = Core.Nothing,
            visiblePercentageMin = Core.Nothing, waitForTags = Core.Nothing,
            waitForTagsTimeout = Core.Nothing, workspaceId = Core.Nothing}
instance Core.FromJSON Trigger where
        parseJSON
          = Core.withObject "Trigger"
              (\ o ->
                 Trigger Core.<$>
                   (o Core..:? "accountId") Core.<*> (o Core..:? "autoEventFilter")
          ...
          = Core.object
              (Core.catMaybes
                 [("accountId" Core..=) Core.<$> accountId,
                  ...
                  ("customEventFilter" Core..=) Core.<$> customEventFilter,
                  ...
                  ("maxTimerLengthSeconds" Core..=) Core.<$> maxTimerLengthSeconds,
                  ("name" Core..=) Core.<$> name, ("notes" Core..=) Core.<$> notes,
                  ("parameter" Core..=) Core.<$> parameter,
                  ("parentFolderId" Core..=) Core.<$> parentFolderId,
                  ("path" Core..=) Core.<$> path,
                  ...
                  ("visibilitySelector" Core..=) Core.<$> visibilitySelector,
                  ("visiblePercentageMax" Core..=) Core.<$> visiblePercentageMax,
                  ("visiblePercentageMin" Core..=) Core.<$> visiblePercentageMin,
                  ("waitForTags" Core..=) Core.<$> waitForTags,
                  ("waitForTagsTimeout" Core..=) Core.<$> waitForTagsTimeout,
                  ("workspaceId" Core..=) Core.<$> workspaceId])
...
newUserPermission 
    ::  UserPermission
newUserPermission
  = UserPermission{accountAccess = Core.Nothing,
                   accountId = Core.Nothing, containerAccess = Core.Nothing,
                   emailAddress = Core.Nothing, path = Core.Nothing}
instance Core.FromJSON UserPermission where
        parseJSON
          = Core.withObject "UserPermission"
              (\ o ->
                 UserPermission Core.<$>
                   (o Core..:? "accountAccess") Core.<*> (o Core..:? "accountId")
...
newVariable 
    ::  Variable
newVariable
  = Variable{accountId = Core.Nothing, containerId = Core.Nothing,
             disablingTriggerId = Core.Nothing,
             enablingTriggerId = Core.Nothing, fingerprint = Core.Nothing,
             formatValue = Core.Nothing, name = Core.Nothing,
             notes = Core.Nothing, parameter = Core.Nothing,
             parentFolderId = Core.Nothing, path = Core.Nothing,
             scheduleEndMs = Core.Nothing, scheduleStartMs = Core.Nothing,
             tagManagerUrl = Core.Nothing, type' = Core.Nothing,
             variableId = Core.Nothing, workspaceId = Core.Nothing}
        ...
        toJSON Variable{..}
          = Core.object
              (Core.catMaybes
                 [("accountId" Core..=) Core.<$> accountId,
                  ("containerId" Core..=) Core.<$> containerId,
                  ("disablingTriggerId" Core..=) Core.<$> disablingTriggerId,
                  ("enablingTriggerId" Core..=) Core.<$> enablingTriggerId,
                  ("fingerprint" Core..=) Core.<$> fingerprint,
...
newVariableFormatValue 
    ::  VariableFormatValue
newVariableFormatValue
  = VariableFormatValue{caseConversionType = Core.Nothing,
...
instance Core.ToJSON VariableFormatValue where
        toJSON VariableFormatValue{..}
          = Core.object
              (Core.catMaybes
                 [("caseConversionType" Core..=) Core.<$> caseConversionType,
                  ("convertFalseToValue" Core..=) Core.<$> convertFalseToValue,
                  ("convertNullToValue" Core..=) Core.<$> convertNullToValue,
                  ("convertTrueToValue" Core..=) Core.<$> convertTrueToValue,
...
newWorkspace 
    ::  Workspace
newWorkspace
  = Workspace{accountId = Core.Nothing, containerId = Core.Nothing,
              description = Core.Nothing, fingerprint = Core.Nothing,
...
newZone 
    ::  Zone
newZone
  = Zone{accountId = Core.Nothing, boundary = Core.Nothing,
         childContainer = Core.Nothing, containerId = Core.Nothing,
         fingerprint = Core.Nothing, name = Core.Nothing,
         notes = Core.Nothing, path = Core.Nothing,
         tagManagerUrl = Core.Nothing, typeRestriction = Core.Nothing,
         workspaceId = Core.Nothing, zoneId = Core.Nothing}
instance Core.FromJSON Zone where
        parseJSON
          = Core.withObject "Zone"
              (\ o ->
                 Zone Core.<$>
                   (o Core..:? "accountId") Core.<*> (o Core..:? "boundary") Core.<*>
                     (o Core..:? "childContainer")
                     Core.<*> (o Core..:? "containerId")
                     Core.<*> (o Core..:? "fingerprint")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "notes")
...
newZoneBoundary 
    ::  ZoneBoundary
newZoneBoundary
  = ZoneBoundary{condition = Core.Nothing,
                 customEvaluationTriggerId = Core.Nothing}
...
newZoneChildContainer 
    ::  ZoneChildContainer
newZoneChildContainer
  = ZoneChildContainer{nickname = Core.Nothing,
          ...
          = Core.withObject "ZoneChildContainer"
              (\ o ->
                 ZoneChildContainer Core.<$>
                   (o Core..:? "nickname") Core.<*> (o Core..:? "publicId"))
...
newZoneTypeRestriction 
    ::  ZoneTypeRestriction
newZoneTypeRestriction
  = ZoneTypeRestriction{enable = Core.Nothing,
                        whitelistedTypeId = Core.Nothing}
instance Core.FromJSON ZoneTypeRestriction where
        parseJSON
          = Core.withObject "ZoneTypeRestriction"
              (\ o ->
                 ZoneTypeRestriction Core.<$>
                   (o Core..:? "enable") Core.<*> (o Core..:? "whitelistedTypeId"))
          ...
          = Core.object
              (Core.catMaybes
                 [("enable" Core..=) Core.<$> enable,
                  ("whitelistedTypeId" Core..=) Core.<$> whitelistedTypeId])
