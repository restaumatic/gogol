           ...
           Core.QueryParam "$.xgafv" Xgafv Core.:>
             Core.QueryParam "access_token" Core.Text Core.:>
               Core.QueryParam "callback" Core.Text Core.:>
                 Core.QueryParam "includeGoogleTags" Core.Bool Core.:>
...
newTagManagerAccountsList 
    ::  TagManagerAccountsList
newTagManagerAccountsList
  = TagManagerAccountsList{xgafv = Core.Nothing,
                           accessToken = Core.Nothing, callback = Core.Nothing,
                           includeGoogleTags = Core.Nothing, pageToken = Core.Nothing,
...
instance Core.GoogleRequest TagManagerAccountsList where
        ...
        type Scopes TagManagerAccountsList =
             '[Tagmanager'Edit'Containers, Tagmanager'Manage'Accounts,
               Tagmanager'Readonly]
        requestClient TagManagerAccountsList{..}
          = go xgafv accessToken callback includeGoogleTags pageToken
              uploadType
              uploadProtocol
