                     ...
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] UserPermission Core.:>
                           Core.Post '[Core.JSON] UserPermission
...
newTagManagerAccountsUser_permissionsCreate parent payload
  = TagManagerAccountsUser_permissionsCreate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsUser_permissionsCreate
         where
        type Rs TagManagerAccountsUser_permissionsCreate = UserPermission
        type Scopes TagManagerAccountsUser_permissionsCreate =
             '[Tagmanager'Manage'Users]
        requestClient TagManagerAccountsUser_permissionsCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy TagManagerAccountsUser_permissionsCreateResource)
                      Core.mempty
