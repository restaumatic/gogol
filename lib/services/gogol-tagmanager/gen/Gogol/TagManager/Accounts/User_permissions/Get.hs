...
newTagManagerAccountsUser_permissionsGet path
  = TagManagerAccountsUser_permissionsGet{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          path = path, uploadType = Core.Nothing,
                                          uploadProtocol = Core.Nothing}
instance Core.GoogleRequest TagManagerAccountsUser_permissionsGet
         where
        type Rs TagManagerAccountsUser_permissionsGet = UserPermission
        type Scopes TagManagerAccountsUser_permissionsGet =
             '[Tagmanager'Manage'Users]
        requestClient TagManagerAccountsUser_permissionsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy TagManagerAccountsUser_permissionsGetResource)
                      Core.mempty
