...
newTagManagerAccountsUser_permissionsDelete path
  = TagManagerAccountsUser_permissionsDelete{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        requestClient TagManagerAccountsUser_permissionsDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy TagManagerAccountsUser_permissionsDeleteResource)
                      Core.mempty
