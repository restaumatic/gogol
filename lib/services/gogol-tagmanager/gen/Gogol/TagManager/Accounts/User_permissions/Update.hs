...
-- |
-- Module      : Gogol.TagManager.Accounts.User_permissions.Update
                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] UserPermission Core.:>
                         Core.Put '[Core.JSON] UserPermission
...
newTagManagerAccountsUser_permissionsUpdate 
    :: 
                                            Core.Text
       -- ^  GTM UserPermission\'s API relative path. See 'path'.
    -> UserPermission
       -- ^  Multipart request metadata. See 'payload'.
    -> TagManagerAccountsUser_permissionsUpdate
newTagManagerAccountsUser_permissionsUpdate path payload
  = TagManagerAccountsUser_permissionsUpdate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsUser_permissionsUpdate
         where
        type Rs TagManagerAccountsUser_permissionsUpdate = UserPermission
        type Scopes TagManagerAccountsUser_permissionsUpdate =
             '[Tagmanager'Manage'Users]
        requestClient TagManagerAccountsUser_permissionsUpdate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy TagManagerAccountsUser_permissionsUpdateResource)
                      Core.mempty
