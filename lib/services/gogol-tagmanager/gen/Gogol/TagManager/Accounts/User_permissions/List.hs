                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] ListUserPermissionsResponse
...
newTagManagerAccountsUser_permissionsList 
    :: 
                                          Core.Text
       -- ^  GTM Account\'s API relative path. See 'parent'.
    -> TagManagerAccountsUser_permissionsList
newTagManagerAccountsUser_permissionsList parent
  = TagManagerAccountsUser_permissionsList{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           pageToken = Core.Nothing, parent = parent,
                                           uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest TagManagerAccountsUser_permissionsList
         where
        type Rs TagManagerAccountsUser_permissionsList =
             ListUserPermissionsResponse
        type Scopes TagManagerAccountsUser_permissionsList =
             '[Tagmanager'Manage'Users]
        requestClient TagManagerAccountsUser_permissionsList{..}
          = go parent xgafv accessToken callback pageToken uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy TagManagerAccountsUser_permissionsListResource)
                      Core.mempty
