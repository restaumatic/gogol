                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.Post '[Core.JSON] RevertTransformationResponse
...
newTagManagerAccountsContainersWorkspacesTransformationsRevert path
  = TagManagerAccountsContainersWorkspacesTransformationsRevert{xgafv
                                                                  = Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersWorkspacesTransformationsRevert
         where
        type Rs TagManagerAccountsContainersWorkspacesTransformationsRevert
