                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.Get '[Core.JSON] ContainerVersionHeader
...
newTagManagerAccountsContainersVersion_headersLatest parent
  = TagManagerAccountsContainersVersion_headersLatest{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersVersion_headersLatest
         where
        type Rs TagManagerAccountsContainersVersion_headersLatest =
             ContainerVersionHeader
        type Scopes TagManagerAccountsContainersVersion_headersLatest =
