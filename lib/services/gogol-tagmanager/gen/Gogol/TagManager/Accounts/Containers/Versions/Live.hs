...
newTagManagerAccountsContainersVersionsLive parent
  = TagManagerAccountsContainersVersionsLive{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersVersionsLive
         where
        type Rs TagManagerAccountsContainersVersionsLive = ContainerVersion
        type Scopes TagManagerAccountsContainersVersionsLive =
             '[Tagmanager'Edit'Containers, Tagmanager'Readonly]
        requestClient TagManagerAccountsContainersVersionsLive{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy TagManagerAccountsContainersVersionsLiveResource)
                      Core.mempty
