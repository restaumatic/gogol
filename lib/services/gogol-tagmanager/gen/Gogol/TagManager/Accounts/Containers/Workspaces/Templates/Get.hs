...
newTagManagerAccountsContainersWorkspacesTemplatesGet path
  = TagManagerAccountsContainersWorkspacesTemplatesGet{xgafv =
                                                         Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersWorkspacesTemplatesGet
         where
        type Rs TagManagerAccountsContainersWorkspacesTemplatesGet =
             CustomTemplate
        type Scopes TagManagerAccountsContainersWorkspacesTemplatesGet =
