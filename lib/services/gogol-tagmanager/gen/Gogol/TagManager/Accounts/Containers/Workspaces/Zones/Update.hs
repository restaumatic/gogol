                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] Zone Core.:> Core.Put '[Core.JSON] Zone
...
newTagManagerAccountsContainersWorkspacesZonesUpdate path payload
  = TagManagerAccountsContainersWorkspacesZonesUpdate{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes TagManagerAccountsContainersWorkspacesZonesUpdate =
