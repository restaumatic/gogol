...
newTagManagerAccountsContainersWorkspacesFoldersUpdate path payload
  = TagManagerAccountsContainersWorkspacesFoldersUpdate{xgafv =
                                                          Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersWorkspacesFoldersUpdate
         where
        type Rs TagManagerAccountsContainersWorkspacesFoldersUpdate =
             Folder
        type Scopes TagManagerAccountsContainersWorkspacesFoldersUpdate =
