...
newTagManagerAccountsContainersWorkspacesFoldersCreate 
    ...
    -> TagManagerAccountsContainersWorkspacesFoldersCreate
newTagManagerAccountsContainersWorkspacesFoldersCreate parent
  payload
  = TagManagerAccountsContainersWorkspacesFoldersCreate{xgafv =
                                                          Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersWorkspacesFoldersCreate
         where
        type Rs TagManagerAccountsContainersWorkspacesFoldersCreate =
             Folder
        type Scopes TagManagerAccountsContainersWorkspacesFoldersCreate =
