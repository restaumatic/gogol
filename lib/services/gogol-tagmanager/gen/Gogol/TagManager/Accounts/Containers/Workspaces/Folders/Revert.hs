                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.Post '[Core.JSON] RevertFolderResponse
...
newTagManagerAccountsContainersWorkspacesFoldersRevert 
    :: 
                                                       Core.Text
       -- ^  GTM Folder\'s API relative path. See 'path'.
    -> TagManagerAccountsContainersWorkspacesFoldersRevert
newTagManagerAccountsContainersWorkspacesFoldersRevert path
  = TagManagerAccountsContainersWorkspacesFoldersRevert{xgafv =
                                                          Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersWorkspacesFoldersRevert
         where
        type Rs TagManagerAccountsContainersWorkspacesFoldersRevert =
             RevertFolderResponse
        type Scopes TagManagerAccountsContainersWorkspacesFoldersRevert =
