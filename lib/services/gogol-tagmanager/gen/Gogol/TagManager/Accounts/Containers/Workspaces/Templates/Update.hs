                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] CustomTemplate Core.:>
                           Core.Put '[Core.JSON] CustomTemplate
...
newTagManagerAccountsContainersWorkspacesTemplatesUpdate 
    :: 
                                                         Core.Text
       -- ^  GTM Custom Template\'s API relative path. See 'path'.
    -> CustomTemplate
       -- ^  Multipart request metadata. See 'payload'.
    -> TagManagerAccountsContainersWorkspacesTemplatesUpdate
newTagManagerAccountsContainersWorkspacesTemplatesUpdate path
  payload
  = TagManagerAccountsContainersWorkspacesTemplatesUpdate{xgafv =
                                                            Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersWorkspacesTemplatesUpdate
         where
        type Rs TagManagerAccountsContainersWorkspacesTemplatesUpdate =
             CustomTemplate
        type Scopes TagManagerAccountsContainersWorkspacesTemplatesUpdate =
