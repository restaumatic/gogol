                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] ListTemplatesResponse
...
newTagManagerAccountsContainersWorkspacesTemplatesList parent
  = TagManagerAccountsContainersWorkspacesTemplatesList{xgafv =
                                                          Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersWorkspacesTemplatesList
         where
        type Rs TagManagerAccountsContainersWorkspacesTemplatesList =
             ListTemplatesResponse
        type Scopes TagManagerAccountsContainersWorkspacesTemplatesList =
