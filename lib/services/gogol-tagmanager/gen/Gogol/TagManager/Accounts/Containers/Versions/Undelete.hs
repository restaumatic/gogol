...
type TagManagerAccountsContainersVersionsUndeleteResource =
     "tagmanager" Core.:>
       "v2" Core.:>
         Core.CaptureMode "path" "undelete" Core.Text Core.:>
...
newTagManagerAccountsContainersVersionsUndelete path
  = TagManagerAccountsContainersVersionsUndelete{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersVersionsUndelete
         where
        type Rs TagManagerAccountsContainersVersionsUndelete =
             ContainerVersion
        type Scopes TagManagerAccountsContainersVersionsUndelete =
             '[Tagmanager'Edit'Containerversions]
        requestClient TagManagerAccountsContainersVersionsUndelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy TagManagerAccountsContainersVersionsUndeleteResource)
                      Core.mempty
