                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] Zone Core.:> Core.Post '[Core.JSON] Zone
...
newTagManagerAccountsContainersWorkspacesZonesCreate parent payload
  = TagManagerAccountsContainersWorkspacesZonesCreate{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes TagManagerAccountsContainersWorkspacesZonesCreate =
