...
type TagManagerAccountsContainersMove_tag_idResource =
     "tagmanager" Core.:>
       "v2" Core.:>
         Core.CaptureMode "path" "move_tag_id" Core.Text Core.:>
           Core.QueryParam "$.xgafv" Xgafv Core.:>
             Core.QueryParam "access_token" Core.Text Core.:>
               Core.QueryParam "allowUserPermissionFeatureUpdate" Core.Bool
                 Core.:>
                 Core.QueryParam "callback" Core.Text Core.:>
                   Core.QueryParam "copySettings" Core.Bool Core.:>
                     Core.QueryParam "copyTermsOfService" Core.Bool Core.:>
                       Core.QueryParam "copyUsers" Core.Bool Core.:>
                         Core.QueryParam "tagId" Core.Text Core.:>
                           Core.QueryParam "tagName" Core.Text Core.:>
...
newTagManagerAccountsContainersMove_tag_id 
    :: 
                                           Core.Text
       -- ^  GTM Container\'s API relative path. See 'path'.
    -> TagManagerAccountsContainersMove_tag_id
newTagManagerAccountsContainersMove_tag_id path
  = TagManagerAccountsContainersMove_tag_id{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing,
                                            allowUserPermissionFeatureUpdate = Core.Nothing,
                                            callback = Core.Nothing, copySettings = Core.Nothing,
                                            copyTermsOfService = Core.Nothing,
                                            copyUsers = Core.Nothing, path = path,
                                            tagId = Core.Nothing, tagName = Core.Nothing,
                                            uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest TagManagerAccountsContainersMove_tag_id
         where
        type Rs TagManagerAccountsContainersMove_tag_id = Container
        type Scopes TagManagerAccountsContainersMove_tag_id =
             '[Tagmanager'Edit'Containers]
        requestClient TagManagerAccountsContainersMove_tag_id{..}
          = go path xgafv accessToken allowUserPermissionFeatureUpdate
              callback
              copySettings
              copyTermsOfService
              copyUsers
