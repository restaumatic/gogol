...
newTagManagerAccountsContainersWorkspacesVariablesList parent
  = TagManagerAccountsContainersWorkspacesVariablesList{xgafv =
                                                          Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersWorkspacesVariablesList
         where
        type Rs TagManagerAccountsContainersWorkspacesVariablesList =
             ListVariablesResponse
        type Scopes TagManagerAccountsContainersWorkspacesVariablesList =
