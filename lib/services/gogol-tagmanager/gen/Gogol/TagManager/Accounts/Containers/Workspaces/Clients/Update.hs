...
newTagManagerAccountsContainersWorkspacesClientsUpdate path payload
  = TagManagerAccountsContainersWorkspacesClientsUpdate{xgafv =
                                                          Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersWorkspacesClientsUpdate
         where
        type Rs TagManagerAccountsContainersWorkspacesClientsUpdate =
             Client
        type Scopes TagManagerAccountsContainersWorkspacesClientsUpdate =
