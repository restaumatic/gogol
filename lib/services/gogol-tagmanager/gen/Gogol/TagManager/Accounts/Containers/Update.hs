...
-- |
-- Module      : Gogol.TagManager.Accounts.Containers.Update
                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] Container Core.:>
                           Core.Put '[Core.JSON] Container
...
newTagManagerAccountsContainersUpdate path payload
  = TagManagerAccountsContainersUpdate{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       fingerprint = Core.Nothing, path = path, payload = payload,
                                       uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest TagManagerAccountsContainersUpdate
         where
        type Rs TagManagerAccountsContainersUpdate = Container
        type Scopes TagManagerAccountsContainersUpdate =
             '[Tagmanager'Edit'Containers]
        requestClient TagManagerAccountsContainersUpdate{..}
          = go path xgafv accessToken callback fingerprint uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy TagManagerAccountsContainersUpdateResource)
                      Core.mempty
