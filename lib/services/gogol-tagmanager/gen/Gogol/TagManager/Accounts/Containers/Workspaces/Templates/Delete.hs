...
newTagManagerAccountsContainersWorkspacesTemplatesDelete path
  = TagManagerAccountsContainersWorkspacesTemplatesDelete{xgafv =
                                                            Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersWorkspacesTemplatesDelete
         where
        type Rs TagManagerAccountsContainersWorkspacesTemplatesDelete = ()
        type Scopes TagManagerAccountsContainersWorkspacesTemplatesDelete =
