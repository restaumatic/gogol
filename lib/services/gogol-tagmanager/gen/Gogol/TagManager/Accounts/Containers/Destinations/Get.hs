                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.Get '[Core.JSON] Destination
...
newTagManagerAccountsContainersDestinationsGet 
    :: 
                                               Core.Text
       -- ^  Google Tag Destination\'s API relative path. See 'path'.
    -> TagManagerAccountsContainersDestinationsGet
newTagManagerAccountsContainersDestinationsGet path
  = TagManagerAccountsContainersDestinationsGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes TagManagerAccountsContainersDestinationsGet =
