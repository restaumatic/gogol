...
type TagManagerAccountsContainersVersionsSet_latestResource =
     "tagmanager" Core.:>
       "v2" Core.:>
         Core.CaptureMode "path" "set_latest" Core.Text Core.:>
...
newTagManagerAccountsContainersVersionsSet_latest path
  = TagManagerAccountsContainersVersionsSet_latest{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersVersionsSet_latest
         where
        type Rs TagManagerAccountsContainersVersionsSet_latest =
             ContainerVersion
        type Scopes TagManagerAccountsContainersVersionsSet_latest =
             '[Tagmanager'Edit'Containers]
        requestClient TagManagerAccountsContainersVersionsSet_latest{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy TagManagerAccountsContainersVersionsSet_latestResource)
                      Core.mempty
