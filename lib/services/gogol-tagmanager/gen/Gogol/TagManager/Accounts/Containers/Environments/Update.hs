                     ...
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] Environment Core.:>
                           Core.Put '[Core.JSON] Environment
...
newTagManagerAccountsContainersEnvironmentsUpdate path payload
  = TagManagerAccountsContainersEnvironmentsUpdate{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersEnvironmentsUpdate
         where
        type Rs TagManagerAccountsContainersEnvironmentsUpdate =
             Environment
        type Scopes TagManagerAccountsContainersEnvironmentsUpdate =
