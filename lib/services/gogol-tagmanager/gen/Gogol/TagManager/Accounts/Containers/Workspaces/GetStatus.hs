...
-- |
-- Module      : Gogol.TagManager.Accounts.Containers.Workspaces.GetStatus
                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.Get '[Core.JSON] GetWorkspaceStatusResponse
...
newTagManagerAccountsContainersWorkspacesGetStatus path
  = TagManagerAccountsContainersWorkspacesGetStatus{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersWorkspacesGetStatus
         where
        type Rs TagManagerAccountsContainersWorkspacesGetStatus =
             GetWorkspaceStatusResponse
        type Scopes TagManagerAccountsContainersWorkspacesGetStatus =
             '[Tagmanager'Edit'Containers, Tagmanager'Readonly]
        requestClient TagManagerAccountsContainersWorkspacesGetStatus{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy TagManagerAccountsContainersWorkspacesGetStatusResource)
                      Core.mempty
