                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.Get '[Core.JSON] Transformation
...
newTagManagerAccountsContainersWorkspacesTransformationsGet path
  = TagManagerAccountsContainersWorkspacesTransformationsGet{xgafv =
                                                               Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersWorkspacesTransformationsGet
         where
        type Rs TagManagerAccountsContainersWorkspacesTransformationsGet =
             Transformation
        type Scopes
               TagManagerAccountsContainersWorkspacesTransformationsGet
