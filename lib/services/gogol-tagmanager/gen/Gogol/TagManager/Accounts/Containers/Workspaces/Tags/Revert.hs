                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.Post '[Core.JSON] RevertTagResponse
...
newTagManagerAccountsContainersWorkspacesTagsRevert path
  = TagManagerAccountsContainersWorkspacesTagsRevert{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersWorkspacesTagsRevert
         where
        type Rs TagManagerAccountsContainersWorkspacesTagsRevert =
             RevertTagResponse
        type Scopes TagManagerAccountsContainersWorkspacesTagsRevert =
             '[Tagmanager'Edit'Containers]
        requestClient TagManagerAccountsContainersWorkspacesTagsRevert{..}
