                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] Tag Core.:> Core.Post '[Core.JSON] Tag
...
newTagManagerAccountsContainersWorkspacesTagsCreate parent payload
  = TagManagerAccountsContainersWorkspacesTagsCreate{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersWorkspacesTagsCreate
         where
        type Rs TagManagerAccountsContainersWorkspacesTagsCreate = Tag
        type Scopes TagManagerAccountsContainersWorkspacesTagsCreate =
             '[Tagmanager'Edit'Containers]
        requestClient TagManagerAccountsContainersWorkspacesTagsCreate{..}
