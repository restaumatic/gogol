...
newTagManagerAccountsContainersWorkspacesSync path
  = TagManagerAccountsContainersWorkspacesSync{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes TagManagerAccountsContainersWorkspacesSync =
             '[Tagmanager'Edit'Containers]
        requestClient TagManagerAccountsContainersWorkspacesSync{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy TagManagerAccountsContainersWorkspacesSyncResource)
                      Core.mempty
