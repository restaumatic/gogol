...
newTagManagerAccountsContainersWorkspacesGet path
  = TagManagerAccountsContainersWorkspacesGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersWorkspacesGet
         where
        type Rs TagManagerAccountsContainersWorkspacesGet = Workspace
        type Scopes TagManagerAccountsContainersWorkspacesGet =
             '[Tagmanager'Edit'Containers, Tagmanager'Readonly]
        requestClient TagManagerAccountsContainersWorkspacesGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy TagManagerAccountsContainersWorkspacesGetResource)
                      Core.mempty
