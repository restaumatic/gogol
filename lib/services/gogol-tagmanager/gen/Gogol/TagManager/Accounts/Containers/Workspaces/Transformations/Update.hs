                     ...
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] Transformation Core.:>
                           Core.Put '[Core.JSON] Transformation
...
newTagManagerAccountsContainersWorkspacesTransformationsUpdate 
    :: 
                                                               Core.Text
       -- ^  GTM Transformation\'s API relative path. See 'path'.
    -> Transformation
       -- ^  Multipart request metadata. See 'payload'.
    -> TagManagerAccountsContainersWorkspacesTransformationsUpdate
newTagManagerAccountsContainersWorkspacesTransformationsUpdate path
  payload
  = TagManagerAccountsContainersWorkspacesTransformationsUpdate{xgafv
                                                                  = Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersWorkspacesTransformationsUpdate
         where
        type Rs TagManagerAccountsContainersWorkspacesTransformationsUpdate
             = Transformation
        type Scopes
               TagManagerAccountsContainersWorkspacesTransformationsUpdate
