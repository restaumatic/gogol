...
type TagManagerAccountsContainersWorkspacesFoldersMove_entities_to_folderResource
     ...
     "tagmanager" Core.:>
       "v2" Core.:>
         Core.CaptureMode "path" "move_entities_to_folder" Core.Text Core.:>
                       ...
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParams "variableId" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] Folder Core.:> Core.Post '[Core.JSON] ()
...
newTagManagerAccountsContainersWorkspacesFoldersMove_entities_to_folder
  path payload
  = TagManagerAccountsContainersWorkspacesFoldersMove_entities_to_folder{xgafv
                                                                           = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        requestClient
          TagManagerAccountsContainersWorkspacesFoldersMove_entities_to_folder{..}
          = go path xgafv accessToken callback (tagId Core.^. Core._Default)
