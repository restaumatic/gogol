...
-- |
-- Module      : Gogol.TagManager.Accounts.Containers.Workspaces.Variables.Get
...
newTagManagerAccountsContainersWorkspacesVariablesGet path
  = TagManagerAccountsContainersWorkspacesVariablesGet{xgafv =
                                                         Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersWorkspacesVariablesGet
         where
        type Rs TagManagerAccountsContainersWorkspacesVariablesGet =
             Variable
        type Scopes TagManagerAccountsContainersWorkspacesVariablesGet =
