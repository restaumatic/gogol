...
newTagManagerAccountsContainersWorkspacesZonesDelete path
  = TagManagerAccountsContainersWorkspacesZonesDelete{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersWorkspacesZonesDelete
         where
        type Rs TagManagerAccountsContainersWorkspacesZonesDelete = ()
        type Scopes TagManagerAccountsContainersWorkspacesZonesDelete =
             '[Tagmanager'Edit'Containers]
        requestClient TagManagerAccountsContainersWorkspacesZonesDelete{..}
