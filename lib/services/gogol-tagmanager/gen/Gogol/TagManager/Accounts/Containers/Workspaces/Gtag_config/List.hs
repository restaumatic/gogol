                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] ListGtagConfigResponse
...
newTagManagerAccountsContainersWorkspacesGtag_configList 
    :: 
                                                         Core.Text
       -- ^  Workspace\'s API relative path. See 'parent'.
    -> TagManagerAccountsContainersWorkspacesGtag_configList
newTagManagerAccountsContainersWorkspacesGtag_configList parent
  = TagManagerAccountsContainersWorkspacesGtag_configList{xgafv =
                                                            Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersWorkspacesGtag_configList
         where
        type Rs TagManagerAccountsContainersWorkspacesGtag_configList =
             ListGtagConfigResponse
        type Scopes TagManagerAccountsContainersWorkspacesGtag_configList =
