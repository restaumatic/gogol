...
newTagManagerAccountsContainersWorkspacesTriggersCreate 
    ...
    -> TagManagerAccountsContainersWorkspacesTriggersCreate
newTagManagerAccountsContainersWorkspacesTriggersCreate parent
  payload
  = TagManagerAccountsContainersWorkspacesTriggersCreate{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersWorkspacesTriggersCreate
         where
        type Rs TagManagerAccountsContainersWorkspacesTriggersCreate =
             Trigger
        type Scopes TagManagerAccountsContainersWorkspacesTriggersCreate =
