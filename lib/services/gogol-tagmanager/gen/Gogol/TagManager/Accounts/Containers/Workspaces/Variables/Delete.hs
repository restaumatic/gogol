...
newTagManagerAccountsContainersWorkspacesVariablesDelete path
  = TagManagerAccountsContainersWorkspacesVariablesDelete{xgafv =
                                                            Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersWorkspacesVariablesDelete
         where
        type Rs TagManagerAccountsContainersWorkspacesVariablesDelete = ()
        type Scopes TagManagerAccountsContainersWorkspacesVariablesDelete =
