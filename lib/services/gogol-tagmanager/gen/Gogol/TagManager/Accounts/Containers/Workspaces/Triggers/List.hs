                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] ListTriggersResponse
...
newTagManagerAccountsContainersWorkspacesTriggersList parent
  = TagManagerAccountsContainersWorkspacesTriggersList{xgafv =
                                                         Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersWorkspacesTriggersList
         where
        type Rs TagManagerAccountsContainersWorkspacesTriggersList =
             ListTriggersResponse
        type Scopes TagManagerAccountsContainersWorkspacesTriggersList =
