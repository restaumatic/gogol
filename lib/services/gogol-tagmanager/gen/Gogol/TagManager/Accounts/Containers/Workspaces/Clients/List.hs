...
newTagManagerAccountsContainersWorkspacesClientsList parent
  = TagManagerAccountsContainersWorkspacesClientsList{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersWorkspacesClientsList
         where
        type Rs TagManagerAccountsContainersWorkspacesClientsList =
             ListClientsResponse
        type Scopes TagManagerAccountsContainersWorkspacesClientsList =
