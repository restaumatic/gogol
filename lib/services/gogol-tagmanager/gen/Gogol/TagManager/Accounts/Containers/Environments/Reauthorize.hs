...
type TagManagerAccountsContainersEnvironmentsReauthorizeResource =
     "tagmanager" Core.:>
       "v2" Core.:>
         Core.CaptureMode "path" "reauthorize" Core.Text Core.:>
...
newTagManagerAccountsContainersEnvironmentsReauthorize path payload
  = TagManagerAccountsContainersEnvironmentsReauthorize{xgafv =
                                                          Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersEnvironmentsReauthorize
         where
        type Rs TagManagerAccountsContainersEnvironmentsReauthorize =
             Environment
        type Scopes TagManagerAccountsContainersEnvironmentsReauthorize =
             '[Tagmanager'Publish]
        requestClient
          TagManagerAccountsContainersEnvironmentsReauthorize{..}
