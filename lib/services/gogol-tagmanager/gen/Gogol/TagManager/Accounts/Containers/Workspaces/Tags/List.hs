                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] ListTagsResponse
...
newTagManagerAccountsContainersWorkspacesTagsList parent
  = TagManagerAccountsContainersWorkspacesTagsList{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersWorkspacesTagsList
         where
        type Rs TagManagerAccountsContainersWorkspacesTagsList =
             ListTagsResponse
        type Scopes TagManagerAccountsContainersWorkspacesTagsList =
             '[Tagmanager'Edit'Containers, Tagmanager'Readonly]
        requestClient TagManagerAccountsContainersWorkspacesTagsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy TagManagerAccountsContainersWorkspacesTagsListResource)
                      Core.mempty
