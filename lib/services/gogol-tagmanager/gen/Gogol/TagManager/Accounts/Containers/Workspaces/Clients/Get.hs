...
newTagManagerAccountsContainersWorkspacesClientsGet path
  = TagManagerAccountsContainersWorkspacesClientsGet{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersWorkspacesClientsGet
         where
        type Rs TagManagerAccountsContainersWorkspacesClientsGet = Client
        type Scopes TagManagerAccountsContainersWorkspacesClientsGet =
             '[Tagmanager'Edit'Containers, Tagmanager'Readonly]
        requestClient TagManagerAccountsContainersWorkspacesClientsGet{..}
