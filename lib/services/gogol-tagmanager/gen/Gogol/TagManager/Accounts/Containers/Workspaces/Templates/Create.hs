...
newTagManagerAccountsContainersWorkspacesTemplatesCreate 
    ...
    -> TagManagerAccountsContainersWorkspacesTemplatesCreate
newTagManagerAccountsContainersWorkspacesTemplatesCreate parent
  payload
  = TagManagerAccountsContainersWorkspacesTemplatesCreate{xgafv =
                                                            Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersWorkspacesTemplatesCreate
         where
        type Rs TagManagerAccountsContainersWorkspacesTemplatesCreate =
             CustomTemplate
        type Scopes TagManagerAccountsContainersWorkspacesTemplatesCreate =
