                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] ListContainerVersionsResponse
...
newTagManagerAccountsContainersVersion_headersList 
    :: 
                                                   Core.Text
       -- ^  GTM Container\'s API relative path. See 'parent'.
    -> TagManagerAccountsContainersVersion_headersList
newTagManagerAccountsContainersVersion_headersList parent
  = TagManagerAccountsContainersVersion_headersList{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersVersion_headersList
         where
        type Rs TagManagerAccountsContainersVersion_headersList =
             ListContainerVersionsResponse
        type Scopes TagManagerAccountsContainersVersion_headersList =
             '[Tagmanager'Edit'Containers, Tagmanager'Edit'Containerversions,
               Tagmanager'Readonly]
        requestClient TagManagerAccountsContainersVersion_headersList{..}
          = go parent xgafv accessToken callback includeDeleted pageToken
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy TagManagerAccountsContainersVersion_headersListResource)
                      Core.mempty
