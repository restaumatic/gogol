...
newTagManagerAccountsContainersEnvironmentsList parent
  = TagManagerAccountsContainersEnvironmentsList{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersEnvironmentsList
         where
        type Rs TagManagerAccountsContainersEnvironmentsList =
             ListEnvironmentsResponse
        type Scopes TagManagerAccountsContainersEnvironmentsList =
             '[Tagmanager'Edit'Containers, Tagmanager'Readonly]
        requestClient TagManagerAccountsContainersEnvironmentsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy TagManagerAccountsContainersEnvironmentsListResource)
                      Core.mempty
