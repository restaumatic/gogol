                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] Tag Core.:> Core.Put '[Core.JSON] Tag
...
newTagManagerAccountsContainersWorkspacesTagsUpdate path payload
  = TagManagerAccountsContainersWorkspacesTagsUpdate{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersWorkspacesTagsUpdate
         where
        type Rs TagManagerAccountsContainersWorkspacesTagsUpdate = Tag
        type Scopes TagManagerAccountsContainersWorkspacesTagsUpdate =
             '[Tagmanager'Edit'Containers]
        requestClient TagManagerAccountsContainersWorkspacesTagsUpdate{..}
