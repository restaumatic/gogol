...
type TagManagerAccountsContainersWorkspacesTemplatesRevertResource
     ...
     "tagmanager" Core.:>
       "v2" Core.:>
         Core.CaptureMode "path" "revert" Core.Text Core.:>
                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.Post '[Core.JSON] RevertTemplateResponse
...
newTagManagerAccountsContainersWorkspacesTemplatesRevert path
  = TagManagerAccountsContainersWorkspacesTemplatesRevert{xgafv =
                                                            Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersWorkspacesTemplatesRevert
         where
        type Rs TagManagerAccountsContainersWorkspacesTemplatesRevert =
             RevertTemplateResponse
        type Scopes TagManagerAccountsContainersWorkspacesTemplatesRevert =
