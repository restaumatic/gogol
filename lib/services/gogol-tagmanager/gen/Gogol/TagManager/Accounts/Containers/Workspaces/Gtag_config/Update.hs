...
newTagManagerAccountsContainersWorkspacesGtag_configUpdate 
    :: 
                                                           Core.Text
       -- ^  Google tag config\'s API relative path. See 'path'.
    -> GtagConfig
       -- ^  Multipart request metadata. See 'payload'.
    -> TagManagerAccountsContainersWorkspacesGtag_configUpdate
newTagManagerAccountsContainersWorkspacesGtag_configUpdate path
  payload
  = TagManagerAccountsContainersWorkspacesGtag_configUpdate{xgafv =
                                                              Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersWorkspacesGtag_configUpdate
         where
        type Rs TagManagerAccountsContainersWorkspacesGtag_configUpdate =
             GtagConfig
        type Scopes TagManagerAccountsContainersWorkspacesGtag_configUpdate
