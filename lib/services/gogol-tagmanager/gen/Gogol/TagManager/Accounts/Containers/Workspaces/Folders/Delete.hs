...
newTagManagerAccountsContainersWorkspacesFoldersDelete path
  = TagManagerAccountsContainersWorkspacesFoldersDelete{xgafv =
                                                          Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersWorkspacesFoldersDelete
         where
        type Rs TagManagerAccountsContainersWorkspacesFoldersDelete = ()
        type Scopes TagManagerAccountsContainersWorkspacesFoldersDelete =
