...
type TagManagerAccountsContainersWorkspacesResolve_conflictResource
     ...
     "tagmanager" Core.:>
       "v2" Core.:>
         Core.CaptureMode "path" "resolve_conflict" Core.Text Core.:>
                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] Entity Core.:> Core.Post '[Core.JSON] ()
...
newTagManagerAccountsContainersWorkspacesResolve_conflict 
    ...
    -> TagManagerAccountsContainersWorkspacesResolve_conflict
newTagManagerAccountsContainersWorkspacesResolve_conflict path
  payload
  = TagManagerAccountsContainersWorkspacesResolve_conflict{xgafv =
                                                             Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersWorkspacesResolve_conflict
         where
        type Rs TagManagerAccountsContainersWorkspacesResolve_conflict = ()
        type Scopes TagManagerAccountsContainersWorkspacesResolve_conflict
