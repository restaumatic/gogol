...
type TagManagerAccountsContainersWorkspacesFoldersEntitiesResource
     ...
     "tagmanager" Core.:>
       "v2" Core.:>
         Core.CaptureMode "path" "entities" Core.Text Core.:>
                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.Post '[Core.JSON] FolderEntities
...
newTagManagerAccountsContainersWorkspacesFoldersEntities path
  = TagManagerAccountsContainersWorkspacesFoldersEntities{xgafv =
                                                            Core.Nothing,
                                                          accessToken = Core.Nothing,
                                                          callback = Core.Nothing,
                                                          pageToken = Core.Nothing, path = path,
                                                          uploadType = Core.Nothing,
                                                          uploadProtocol = Core.Nothing}
instance Core.GoogleRequest
           TagManagerAccountsContainersWorkspacesFoldersEntities
         where
        type Rs TagManagerAccountsContainersWorkspacesFoldersEntities =
             FolderEntities
        type Scopes TagManagerAccountsContainersWorkspacesFoldersEntities =
             '[Tagmanager'Edit'Containers, Tagmanager'Readonly]
        requestClient
          TagManagerAccountsContainersWorkspacesFoldersEntities{..}
          = go path xgafv accessToken callback pageToken uploadType
              uploadProtocol
