...
newTagManagerAccountsContainersWorkspacesGtag_configCreate 
    ...
    -> TagManagerAccountsContainersWorkspacesGtag_configCreate
newTagManagerAccountsContainersWorkspacesGtag_configCreate parent
  payload
  = TagManagerAccountsContainersWorkspacesGtag_configCreate{xgafv =
                                                              Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersWorkspacesGtag_configCreate
         where
        type Rs TagManagerAccountsContainersWorkspacesGtag_configCreate =
             GtagConfig
        type Scopes TagManagerAccountsContainersWorkspacesGtag_configCreate
