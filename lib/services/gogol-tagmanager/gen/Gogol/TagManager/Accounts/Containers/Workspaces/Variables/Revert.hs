                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.Post '[Core.JSON] RevertVariableResponse
...
newTagManagerAccountsContainersWorkspacesVariablesRevert path
  = TagManagerAccountsContainersWorkspacesVariablesRevert{xgafv =
                                                            Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersWorkspacesVariablesRevert
         where
        type Rs TagManagerAccountsContainersWorkspacesVariablesRevert =
             RevertVariableResponse
        type Scopes TagManagerAccountsContainersWorkspacesVariablesRevert =
