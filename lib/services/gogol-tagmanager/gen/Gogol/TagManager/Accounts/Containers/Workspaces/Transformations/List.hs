                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] ListTransformationsResponse
...
newTagManagerAccountsContainersWorkspacesTransformationsList parent
  = TagManagerAccountsContainersWorkspacesTransformationsList{xgafv =
                                                                Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersWorkspacesTransformationsList
         where
        type Rs TagManagerAccountsContainersWorkspacesTransformationsList =
