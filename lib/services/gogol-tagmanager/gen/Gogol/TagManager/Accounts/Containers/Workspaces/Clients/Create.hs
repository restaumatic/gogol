...
newTagManagerAccountsContainersWorkspacesClientsCreate 
    ...
    -> TagManagerAccountsContainersWorkspacesClientsCreate
newTagManagerAccountsContainersWorkspacesClientsCreate parent
  payload
  = TagManagerAccountsContainersWorkspacesClientsCreate{xgafv =
                                                          Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersWorkspacesClientsCreate
         where
        type Rs TagManagerAccountsContainersWorkspacesClientsCreate =
             Client
        type Scopes TagManagerAccountsContainersWorkspacesClientsCreate =
