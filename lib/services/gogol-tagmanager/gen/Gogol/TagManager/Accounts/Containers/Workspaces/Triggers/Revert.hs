                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.Post '[Core.JSON] RevertTriggerResponse
...
newTagManagerAccountsContainersWorkspacesTriggersRevert path
  = TagManagerAccountsContainersWorkspacesTriggersRevert{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersWorkspacesTriggersRevert
         where
        type Rs TagManagerAccountsContainersWorkspacesTriggersRevert =
             RevertTriggerResponse
        type Scopes TagManagerAccountsContainersWorkspacesTriggersRevert =
