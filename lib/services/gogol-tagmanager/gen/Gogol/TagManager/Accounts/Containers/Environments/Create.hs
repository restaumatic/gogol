...
newTagManagerAccountsContainersEnvironmentsCreate parent payload
  = TagManagerAccountsContainersEnvironmentsCreate{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersEnvironmentsCreate
         where
        type Rs TagManagerAccountsContainersEnvironmentsCreate =
             Environment
        type Scopes TagManagerAccountsContainersEnvironmentsCreate =
