                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] ListFoldersResponse
...
newTagManagerAccountsContainersWorkspacesFoldersList parent
  = TagManagerAccountsContainersWorkspacesFoldersList{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersWorkspacesFoldersList
         where
        type Rs TagManagerAccountsContainersWorkspacesFoldersList =
             ListFoldersResponse
        type Scopes TagManagerAccountsContainersWorkspacesFoldersList =
             '[Tagmanager'Edit'Containers, Tagmanager'Readonly]
        requestClient TagManagerAccountsContainersWorkspacesFoldersList{..}
