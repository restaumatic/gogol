...
newTagManagerAccountsContainersWorkspacesVariablesCreate 
    ...
    -> TagManagerAccountsContainersWorkspacesVariablesCreate
newTagManagerAccountsContainersWorkspacesVariablesCreate parent
  payload
  = TagManagerAccountsContainersWorkspacesVariablesCreate{xgafv =
                                                            Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersWorkspacesVariablesCreate
         where
        type Rs TagManagerAccountsContainersWorkspacesVariablesCreate =
             Variable
        type Scopes TagManagerAccountsContainersWorkspacesVariablesCreate =
