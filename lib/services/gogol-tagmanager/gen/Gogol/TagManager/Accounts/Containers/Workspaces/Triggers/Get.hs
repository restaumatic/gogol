...
newTagManagerAccountsContainersWorkspacesTriggersGet path
  = TagManagerAccountsContainersWorkspacesTriggersGet{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersWorkspacesTriggersGet
         where
        type Rs TagManagerAccountsContainersWorkspacesTriggersGet = Trigger
        type Scopes TagManagerAccountsContainersWorkspacesTriggersGet =
             '[Tagmanager'Edit'Containers, Tagmanager'Readonly]
        requestClient TagManagerAccountsContainersWorkspacesTriggersGet{..}
