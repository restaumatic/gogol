                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] ContainerVersion Core.:>
                           Core.Put '[Core.JSON] ContainerVersion
...
newTagManagerAccountsContainersVersionsUpdate 
    :: 
                                              Core.Text
       -- ^  GTM ContainerVersion\'s API relative path. See 'path'.
    -> ContainerVersion
       -- ^  Multipart request metadata. See 'payload'.
    -> TagManagerAccountsContainersVersionsUpdate
newTagManagerAccountsContainersVersionsUpdate path payload
  = TagManagerAccountsContainersVersionsUpdate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersVersionsUpdate
         where
        type Rs TagManagerAccountsContainersVersionsUpdate =
             ContainerVersion
        type Scopes TagManagerAccountsContainersVersionsUpdate =
             '[Tagmanager'Edit'Containerversions]
        requestClient TagManagerAccountsContainersVersionsUpdate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy TagManagerAccountsContainersVersionsUpdateResource)
                      Core.mempty
