...
type TagManagerAccountsContainersWorkspacesQuick_previewResource =
     "tagmanager" Core.:>
       "v2" Core.:>
         Core.CaptureMode "path" "quick_preview" Core.Text Core.:>
                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.Post '[Core.JSON] QuickPreviewResponse
...
newTagManagerAccountsContainersWorkspacesQuick_preview path
  = TagManagerAccountsContainersWorkspacesQuick_preview{xgafv =
                                                          Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersWorkspacesQuick_preview
         where
        type Rs TagManagerAccountsContainersWorkspacesQuick_preview =
             QuickPreviewResponse
        type Scopes TagManagerAccountsContainersWorkspacesQuick_preview =
