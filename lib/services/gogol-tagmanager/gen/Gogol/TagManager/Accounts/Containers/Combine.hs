...
newTagManagerAccountsContainersCombine path
  = TagManagerAccountsContainersCombine{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing,
                                        allowUserPermissionFeatureUpdate = Core.Nothing,
                                        callback = Core.Nothing, containerId = Core.Nothing,
                                        path = path, settingSource = Core.Nothing,
                                        uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest TagManagerAccountsContainersCombine
         where
        type Rs TagManagerAccountsContainersCombine = Container
        ...
        requestClient TagManagerAccountsContainersCombine{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy TagManagerAccountsContainersCombineResource)
                      Core.mempty
