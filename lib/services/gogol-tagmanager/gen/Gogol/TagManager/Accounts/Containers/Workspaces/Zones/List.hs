                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] ListZonesResponse
...
newTagManagerAccountsContainersWorkspacesZonesList parent
  = TagManagerAccountsContainersWorkspacesZonesList{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersWorkspacesZonesList
         where
        type Rs TagManagerAccountsContainersWorkspacesZonesList =
             ListZonesResponse
        type Scopes TagManagerAccountsContainersWorkspacesZonesList =
