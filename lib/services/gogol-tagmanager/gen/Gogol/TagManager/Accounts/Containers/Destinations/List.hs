                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.Get '[Core.JSON] ListDestinationsResponse
...
newTagManagerAccountsContainersDestinationsList parent
  = TagManagerAccountsContainersDestinationsList{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersDestinationsList
         where
        type Rs TagManagerAccountsContainersDestinationsList =
             ListDestinationsResponse
        type Scopes TagManagerAccountsContainersDestinationsList =
