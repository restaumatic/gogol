...
newTagManagerAccountsContainersVersionsDelete path
  = TagManagerAccountsContainersVersionsDelete{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes TagManagerAccountsContainersVersionsDelete =
             '[Tagmanager'Edit'Containerversions]
        requestClient TagManagerAccountsContainersVersionsDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy TagManagerAccountsContainersVersionsDeleteResource)
                      Core.mempty
