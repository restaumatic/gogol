...
-- |
-- Module      : Gogol.TagManager.Accounts.Containers.Workspaces.Variables.Update
...
newTagManagerAccountsContainersWorkspacesVariablesUpdate 
    :: 
                                                         Core.Text
       -- ^  GTM Variable\'s API relative path. See 'path'.
    -> Variable
       -- ^  Multipart request metadata. See 'payload'.
    -> TagManagerAccountsContainersWorkspacesVariablesUpdate
newTagManagerAccountsContainersWorkspacesVariablesUpdate path
  payload
  = TagManagerAccountsContainersWorkspacesVariablesUpdate{xgafv =
                                                            Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersWorkspacesVariablesUpdate
         where
        type Rs TagManagerAccountsContainersWorkspacesVariablesUpdate =
             Variable
        type Scopes TagManagerAccountsContainersWorkspacesVariablesUpdate =
