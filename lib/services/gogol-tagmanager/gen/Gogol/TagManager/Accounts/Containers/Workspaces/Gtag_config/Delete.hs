...
newTagManagerAccountsContainersWorkspacesGtag_configDelete path
  = TagManagerAccountsContainersWorkspacesGtag_configDelete{xgafv =
                                                              Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersWorkspacesGtag_configDelete
         where
        type Rs TagManagerAccountsContainersWorkspacesGtag_configDelete =
             ()
        type Scopes TagManagerAccountsContainersWorkspacesGtag_configDelete
