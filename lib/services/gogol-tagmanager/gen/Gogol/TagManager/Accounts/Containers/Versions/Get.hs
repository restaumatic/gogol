           ...
           Core.QueryParam "$.xgafv" Xgafv Core.:>
             Core.QueryParam "access_token" Core.Text Core.:>
               Core.QueryParam "callback" Core.Text Core.:>
                 Core.QueryParam "containerVersionId" Core.Text Core.:>
...
newTagManagerAccountsContainersVersionsGet path
  = TagManagerAccountsContainersVersionsGet{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            containerVersionId = Core.Nothing, path = path,
                                            uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest TagManagerAccountsContainersVersionsGet
         where
        ...
        requestClient TagManagerAccountsContainersVersionsGet{..}
          = go path xgafv accessToken callback containerVersionId uploadType
              uploadProtocol
