...
newTagManagerAccountsContainersWorkspacesClientsDelete path
  = TagManagerAccountsContainersWorkspacesClientsDelete{xgafv =
                                                          Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersWorkspacesClientsDelete
         where
        type Rs TagManagerAccountsContainersWorkspacesClientsDelete = ()
        type Scopes TagManagerAccountsContainersWorkspacesClientsDelete =
