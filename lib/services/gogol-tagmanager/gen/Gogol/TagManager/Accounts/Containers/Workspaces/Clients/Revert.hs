                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.Post '[Core.JSON] RevertClientResponse
...
newTagManagerAccountsContainersWorkspacesClientsRevert 
    :: 
                                                       Core.Text
       -- ^  GTM Client\'s API relative path. See 'path'.
    -> TagManagerAccountsContainersWorkspacesClientsRevert
newTagManagerAccountsContainersWorkspacesClientsRevert path
  = TagManagerAccountsContainersWorkspacesClientsRevert{xgafv =
                                                          Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersWorkspacesClientsRevert
         where
        type Rs TagManagerAccountsContainersWorkspacesClientsRevert =
             RevertClientResponse
        type Scopes TagManagerAccountsContainersWorkspacesClientsRevert =
