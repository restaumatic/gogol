...
type TagManagerAccountsContainersWorkspacesCreate_versionResource =
     "tagmanager" Core.:>
       "v2" Core.:>
         Core.CaptureMode "path" "create_version" Core.Text Core.:>
...
newTagManagerAccountsContainersWorkspacesCreate_version 
    ...
    -> TagManagerAccountsContainersWorkspacesCreate_version
newTagManagerAccountsContainersWorkspacesCreate_version path
  payload
  = TagManagerAccountsContainersWorkspacesCreate_version{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersWorkspacesCreate_version
         where
        type Rs TagManagerAccountsContainersWorkspacesCreate_version =
             CreateContainerVersionResponse
        type Scopes TagManagerAccountsContainersWorkspacesCreate_version =
