...
newTagManagerAccountsContainersDelete path
  = TagManagerAccountsContainersDelete{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       path = path, uploadType = Core.Nothing,
                                       uploadProtocol = Core.Nothing}
instance Core.GoogleRequest TagManagerAccountsContainersDelete
         where
        type Rs TagManagerAccountsContainersDelete = ()
        type Scopes TagManagerAccountsContainersDelete =
