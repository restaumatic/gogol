...
newTagManagerAccountsContainersCreate parent payload
  = TagManagerAccountsContainersCreate{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       parent = parent, payload = payload,
                                       uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest TagManagerAccountsContainersCreate
         where
        type Rs TagManagerAccountsContainersCreate = Container
        type Scopes TagManagerAccountsContainersCreate =
