...
newTagManagerAccountsContainersWorkspacesCreate parent payload
  = TagManagerAccountsContainersWorkspacesCreate{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersWorkspacesCreate
         where
        type Rs TagManagerAccountsContainersWorkspacesCreate = Workspace
        type Scopes TagManagerAccountsContainersWorkspacesCreate =
             '[Tagmanager'Edit'Containers]
        requestClient TagManagerAccountsContainersWorkspacesCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy TagManagerAccountsContainersWorkspacesCreateResource)
                      Core.mempty
