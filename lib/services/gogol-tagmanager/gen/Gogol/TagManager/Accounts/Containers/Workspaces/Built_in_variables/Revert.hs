     ...
     "tagmanager" Core.:>
       "v2" Core.:>
         Core.Capture "path" Core.Text Core.:>
           "built_in_variables:revert" Core.:>
                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Post '[Core.JSON] RevertBuiltInVariableResponse
...
newTagManagerAccountsContainersWorkspacesBuilt_in_variablesRevert 
    :: 
                                                                  Core.Text
       -- ^  GTM BuiltInVariable\'s API relative path. See 'path'.
    -> TagManagerAccountsContainersWorkspacesBuilt_in_variablesRevert
newTagManagerAccountsContainersWorkspacesBuilt_in_variablesRevert
  path
  = TagManagerAccountsContainersWorkspacesBuilt_in_variablesRevert{xgafv
                                                                     = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        requestClient
          TagManagerAccountsContainersWorkspacesBuilt_in_variablesRevert{..}
          = go path xgafv accessToken callback type' uploadType
              uploadProtocol
