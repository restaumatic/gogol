                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.Post '[Core.JSON] RevertZoneResponse
...
newTagManagerAccountsContainersWorkspacesZonesRevert 
    :: 
                                                     Core.Text
       -- ^  GTM Zone\'s API relative path. See 'path'.
    -> TagManagerAccountsContainersWorkspacesZonesRevert
newTagManagerAccountsContainersWorkspacesZonesRevert path
  = TagManagerAccountsContainersWorkspacesZonesRevert{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersWorkspacesZonesRevert
         where
        type Rs TagManagerAccountsContainersWorkspacesZonesRevert =
             RevertZoneResponse
        type Scopes TagManagerAccountsContainersWorkspacesZonesRevert =
