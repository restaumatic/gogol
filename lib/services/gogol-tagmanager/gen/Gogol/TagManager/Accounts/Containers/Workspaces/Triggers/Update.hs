                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] Trigger Core.:>
                           Core.Put '[Core.JSON] Trigger
...
newTagManagerAccountsContainersWorkspacesTriggersUpdate 
    ...
    -> TagManagerAccountsContainersWorkspacesTriggersUpdate
newTagManagerAccountsContainersWorkspacesTriggersUpdate path
  payload
  = TagManagerAccountsContainersWorkspacesTriggersUpdate{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersWorkspacesTriggersUpdate
         where
        type Rs TagManagerAccountsContainersWorkspacesTriggersUpdate =
             Trigger
        type Scopes TagManagerAccountsContainersWorkspacesTriggersUpdate =
