...
newTagManagerAccountsContainersWorkspacesTagsGet path
  = TagManagerAccountsContainersWorkspacesTagsGet{xgafv =
                                                    Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersWorkspacesTagsGet
         where
        type Rs TagManagerAccountsContainersWorkspacesTagsGet = Tag
        type Scopes TagManagerAccountsContainersWorkspacesTagsGet =
             '[Tagmanager'Edit'Containers, Tagmanager'Readonly]
        requestClient TagManagerAccountsContainersWorkspacesTagsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy TagManagerAccountsContainersWorkspacesTagsGetResource)
                      Core.mempty
