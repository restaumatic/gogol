...
newTagManagerAccountsContainersWorkspacesGtag_configGet path
  = TagManagerAccountsContainersWorkspacesGtag_configGet{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           TagManagerAccountsContainersWorkspacesGtag_configGet
         where
        type Rs TagManagerAccountsContainersWorkspacesGtag_configGet =
             GtagConfig
        type Scopes TagManagerAccountsContainersWorkspacesGtag_configGet =
