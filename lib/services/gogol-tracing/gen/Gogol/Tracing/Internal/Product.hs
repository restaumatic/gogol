...
newLink 
    ::  Link
newLink
  = Link{spanId = Core.Nothing, traceId = Core.Nothing,
         type' = Core.Nothing}
instance Core.FromJSON Link where
        parseJSON
          = Core.withObject "Link"
              (\ o ->
                 Link Core.<$>
                   (o Core..:? "spanId") Core.<*> (o Core..:? "traceId") Core.<*>
                     (o Core..:? "type"))
...
newListSpansResponse 
    ::  ListSpansResponse
newListSpansResponse
  = ListSpansResponse{nextPageToken = Core.Nothing,
                      spans = Core.Nothing}
          ...
          = Core.withObject "ListSpansResponse"
              (\ o ->
                 ListSpansResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "spans"))
...
newListTracesResponse 
    ::  ListTracesResponse
newListTracesResponse
  = ListTracesResponse{nextPageToken = Core.Nothing,
                       traces = Core.Nothing}
          ...
          = Core.withObject "ListTracesResponse"
              (\ o ->
                 ListTracesResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "traces"))
...
newNetworkEvent 
    ::  NetworkEvent
newNetworkEvent
  = NetworkEvent{messageId = Core.Nothing,
                 messageSize = Core.Nothing, time = Core.Nothing,
                 type' = Core.Nothing}
instance Core.FromJSON NetworkEvent where
        parseJSON
          = Core.withObject "NetworkEvent"
              (\ o ->
                 NetworkEvent Core.<$>
                   (o Core..:? "messageId" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "messageSize" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "time")
                     Core.<*> (o Core..:? "type"))
...
instance Core.ToJSON NetworkEvent where
        toJSON NetworkEvent{..}
          = Core.object
              (Core.catMaybes
                 [("messageId" Core..=) Core.. Core.AsText Core.<$> messageId,
                  ("messageSize" Core..=) Core.. Core.AsText Core.<$> messageSize,
...
newSpan 
    ::  Span
newSpan
  = Span{attributes = Core.Nothing, displayName = Core.Nothing,
         endTime = Core.Nothing, links = Core.Nothing, name = Core.Nothing,
         parentSpanId = Core.Nothing, spanId = Core.Nothing,
         stackTrace = Core.Nothing, startTime = Core.Nothing,
         status = Core.Nothing, timeEvents = Core.Nothing}
instance Core.FromJSON Span where
        parseJSON
          = Core.withObject "Span"
              (\ o ->
                 Span Core.<$>
                   (o Core..:? "attributes") Core.<*> (o Core..:? "displayName")
                     Core.<*> (o Core..:? "endTime")
                     Core.<*> (o Core..:? "links")
                     Core.<*> (o Core..:? "name")
...
newTimeEvent 
    ::  TimeEvent
newTimeEvent
  = TimeEvent{annotation = Core.Nothing, networkEvent = Core.Nothing,
              time = Core.Nothing}
instance Core.FromJSON TimeEvent where
        parseJSON
          = Core.withObject "TimeEvent"
              (\ o ->
                 TimeEvent Core.<$>
                   (o Core..:? "annotation") Core.<*> (o Core..:? "networkEvent")
                     Core.<*> (o Core..:? "time"))
...
newTimeEvents
  = TimeEvents{droppedAnnotationsCount = Core.Nothing,
               droppedNetworkEventsCount = Core.Nothing, timeEvent = Core.Nothing}
...
newTruncatableString 
    ::  TruncatableString
newTruncatableString
  = TruncatableString{truncatedCharacterCount = Core.Nothing,
                      value = Core.Nothing}
