                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] Span Core.:> Core.Put '[Core.JSON] Span
...
newTracingProjectsTracesSpansCreate name payload
  = TracingProjectsTracesSpansCreate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest TracingProjectsTracesSpansCreate where
        ...
        type Scopes TracingProjectsTracesSpansCreate =
