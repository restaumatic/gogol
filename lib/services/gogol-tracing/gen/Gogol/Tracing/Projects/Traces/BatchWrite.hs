...
newTracingProjectsTracesBatchWrite name payload
  = TracingProjectsTracesBatchWrite{xgafv = Core.Nothing,
...
instance Core.GoogleRequest TracingProjectsTracesBatchWrite where
        ...
        requestClient TracingProjectsTracesBatchWrite{..}
          = go name xgafv accessToken bearerToken callback (Core.Just pp)
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy TracingProjectsTracesBatchWriteResource)
                      Core.mempty
