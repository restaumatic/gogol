                                 ...
                                 Core.QueryParam "uploadType" Core.Text Core.:>
                                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                                     Core.QueryParam "alt" Core.AltJSON Core.:>
                                       Core.Get '[Core.JSON] ListTracesResponse
...
newTracingProjectsTracesList parent
  = TracingProjectsTracesList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest TracingProjectsTracesList where
        ...
        requestClient TracingProjectsTracesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy TracingProjectsTracesListResource)
                      Core.mempty
