...
type CloudAssetOperationsGetResource =
     "v1p7beta1" Core.:>
...
-- | Gets the latest state of a long-running operation. Clients can use this method to poll the operation result at intervals as recommended by the API service.
--
-- /See:/ 'newCloudAssetOperationsGet' smart constructor.
data CloudAssetOperationsGet = CloudAssetOperationsGet
    {
      -- | V1 error format.
...
-- | Creates a value of 'CloudAssetOperationsGet' with the minimum fields required to make a request.
newCloudAssetOperationsGet 
    ::  Core.Text
       -- ^  The name of the operation resource. See 'name'.
    -> CloudAssetOperationsGet
newCloudAssetOperationsGet name
  = CloudAssetOperationsGet{xgafv = Core.Nothing,
                            accessToken = Core.Nothing, callback = Core.Nothing, name = name,
                            uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudAssetOperationsGet where
        type Rs CloudAssetOperationsGet = Operation
        type Scopes CloudAssetOperationsGet = '[CloudPlatform'FullControl]
        requestClient CloudAssetOperationsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy CloudAssetOperationsGetResource)
                      Core.mempty
