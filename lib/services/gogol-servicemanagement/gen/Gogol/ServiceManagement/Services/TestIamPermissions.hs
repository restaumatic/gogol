...
-- |
-- Module      : Gogol.ServiceManagement.Services.TestIamPermissions
...
newServiceManagementServicesTestIamPermissions payload resource
  = ServiceManagementServicesTestIamPermissions{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           ServiceManagementServicesTestIamPermissions
         where
        type Rs ServiceManagementServicesTestIamPermissions =
             TestIamPermissionsResponse
        type Scopes ServiceManagementServicesTestIamPermissions =
             '[CloudPlatform'FullControl, CloudPlatform'ReadOnly,
               Service'Management, Service'Management'Readonly]
        requestClient ServiceManagementServicesTestIamPermissions{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ServiceManagementServicesTestIamPermissionsResource)
                      Core.mempty
