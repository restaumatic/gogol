...
-- |
-- Module      : Gogol.ServiceManagement.Services.Consumers.SetIamPolicy
...
newServiceManagementServicesConsumersSetIamPolicy payload resource
  = ServiceManagementServicesConsumersSetIamPolicy{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           ServiceManagementServicesConsumersSetIamPolicy
         where
        type Rs ServiceManagementServicesConsumersSetIamPolicy = Policy
        type Scopes ServiceManagementServicesConsumersSetIamPolicy =
             '[CloudPlatform'FullControl, Service'Management]
        requestClient ServiceManagementServicesConsumersSetIamPolicy{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ServiceManagementServicesConsumersSetIamPolicyResource)
                      Core.mempty
