...
newServiceManagementServicesConsumersGetIamPolicy payload resource
  = ServiceManagementServicesConsumersGetIamPolicy{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           ServiceManagementServicesConsumersGetIamPolicy
         where
        type Rs ServiceManagementServicesConsumersGetIamPolicy = Policy
        type Scopes ServiceManagementServicesConsumersGetIamPolicy =
             '[CloudPlatform'FullControl, CloudPlatform'ReadOnly,
               Service'Management, Service'Management'Readonly]
        requestClient ServiceManagementServicesConsumersGetIamPolicy{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ServiceManagementServicesConsumersGetIamPolicyResource)
                      Core.mempty
