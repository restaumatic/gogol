...
newServiceManagementServicesConsumersTestIamPermissions 
    ...
    -> ServiceManagementServicesConsumersTestIamPermissions
newServiceManagementServicesConsumersTestIamPermissions payload
  resource
  = ServiceManagementServicesConsumersTestIamPermissions{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           ServiceManagementServicesConsumersTestIamPermissions
         where
        type Rs ServiceManagementServicesConsumersTestIamPermissions =
             TestIamPermissionsResponse
        type Scopes ServiceManagementServicesConsumersTestIamPermissions =
