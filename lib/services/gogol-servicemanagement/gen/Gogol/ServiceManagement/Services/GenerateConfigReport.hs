...
type ServiceManagementServicesGenerateConfigReportResource =
     "v1" Core.:>
       "services:generateConfigReport" Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] GenerateConfigReportRequest Core.:>
                       Core.Post '[Core.JSON] GenerateConfigReportResponse
...
newServiceManagementServicesGenerateConfigReport payload
  = ServiceManagementServicesGenerateConfigReport{xgafv =
                                                    Core.Nothing,
...
instance Core.GoogleRequest
           ServiceManagementServicesGenerateConfigReport
         where
        type Rs ServiceManagementServicesGenerateConfigReport =
             GenerateConfigReportResponse
        type Scopes ServiceManagementServicesGenerateConfigReport =
             '[CloudPlatform'FullControl, Service'Management]
        requestClient ServiceManagementServicesGenerateConfigReport{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ServiceManagementServicesGenerateConfigReportResource)
                      Core.mempty
