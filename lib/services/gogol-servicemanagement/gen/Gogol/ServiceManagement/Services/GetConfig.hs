                   ...
                   Core.QueryParam "configId" Core.Text Core.:>
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "view" ServicesGetConfigView Core.:>
...
newServiceManagementServicesGetConfig serviceName
  = ServiceManagementServicesGetConfig{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       configId = Core.Nothing, serviceName = serviceName,
                                       uploadType = Core.Nothing, uploadProtocol = Core.Nothing,
                                       view = Core.Nothing}
instance Core.GoogleRequest ServiceManagementServicesGetConfig
         where
        type Rs ServiceManagementServicesGetConfig = Service
        type Scopes ServiceManagementServicesGetConfig =
             '[CloudPlatform'FullControl, CloudPlatform'ReadOnly,
               Service'Management, Service'Management'Readonly]
        requestClient ServiceManagementServicesGetConfig{..}
          = go serviceName xgafv accessToken callback configId uploadType
              uploadProtocol
              view
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ServiceManagementServicesGetConfigResource)
                      Core.mempty
