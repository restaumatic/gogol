                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] SubmitConfigSourceRequest Core.:>
...
newServiceManagementServicesConfigsSubmit payload serviceName
  = ServiceManagementServicesConfigsSubmit{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           payload = payload, serviceName = serviceName,
                                           uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ServiceManagementServicesConfigsSubmit
         where
        type Rs ServiceManagementServicesConfigsSubmit = Operation
        type Scopes ServiceManagementServicesConfigsSubmit =
             '[CloudPlatform'FullControl, Service'Management]
        requestClient ServiceManagementServicesConfigsSubmit{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ServiceManagementServicesConfigsSubmitResource)
                      Core.mempty
