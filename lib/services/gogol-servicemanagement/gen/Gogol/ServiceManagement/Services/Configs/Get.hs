...
newServiceManagementServicesConfigsGet configId serviceName
  = ServiceManagementServicesConfigsGet{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        configId = configId, serviceName = serviceName,
                                        uploadType = Core.Nothing, uploadProtocol = Core.Nothing,
                                        view = Core.Nothing}
instance Core.GoogleRequest ServiceManagementServicesConfigsGet
         where
        ...
        requestClient ServiceManagementServicesConfigsGet{..}
          = go serviceName configId xgafv accessToken callback uploadType
              uploadProtocol
              view
