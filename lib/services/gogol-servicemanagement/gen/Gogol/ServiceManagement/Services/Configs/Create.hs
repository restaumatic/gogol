...
newServiceManagementServicesConfigsCreate payload serviceName
  = ServiceManagementServicesConfigsCreate{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           payload = payload, serviceName = serviceName,
                                           uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ServiceManagementServicesConfigsCreate
         where
        type Rs ServiceManagementServicesConfigsCreate = Service
        type Scopes ServiceManagementServicesConfigsCreate =
             '[CloudPlatform'FullControl, Service'Management]
        requestClient ServiceManagementServicesConfigsCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ServiceManagementServicesConfigsCreateResource)
                      Core.mempty
