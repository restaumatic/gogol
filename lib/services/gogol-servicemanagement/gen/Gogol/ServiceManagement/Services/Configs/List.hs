...
newServiceManagementServicesConfigsList serviceName
  = ServiceManagementServicesConfigsList{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         pageSize = Core.Nothing, pageToken = Core.Nothing,
                                         serviceName = serviceName, uploadType = Core.Nothing,
                                         uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ServiceManagementServicesConfigsList
         where
        ...
        requestClient ServiceManagementServicesConfigsList{..}
          = go serviceName xgafv accessToken callback pageSize pageToken
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ServiceManagementServicesConfigsListResource)
                      Core.mempty
