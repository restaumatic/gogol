...
newServiceManagementServicesCreate payload
  = ServiceManagementServicesCreate{xgafv = Core.Nothing,
                                    accessToken = Core.Nothing, callback = Core.Nothing,
                                    payload = payload, uploadType = Core.Nothing,
                                    uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ServiceManagementServicesCreate where
        ...
        requestClient ServiceManagementServicesCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ServiceManagementServicesCreateResource)
                      Core.mempty
