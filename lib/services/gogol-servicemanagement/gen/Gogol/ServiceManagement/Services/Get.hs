...
newServiceManagementServicesGet serviceName
  = ServiceManagementServicesGet{xgafv = Core.Nothing,
                                 accessToken = Core.Nothing, callback = Core.Nothing,
                                 serviceName = serviceName, uploadType = Core.Nothing,
                                 uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ServiceManagementServicesGet where
        ...
        requestClient ServiceManagementServicesGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ServiceManagementServicesGetResource)
                      Core.mempty
