...
-- |
-- Module      : Gogol.ServiceManagement.Services.SetIamPolicy
...
-- 'ServiceManagementServicesSetIamPolicy' request conforms to.
type ServiceManagementServicesSetIamPolicyResource =
     "v1" Core.:>
...
-- | Sets the access control policy on the specified resource. Replaces any existing policy. Can return @NOT_FOUND@, @INVALID_ARGUMENT@, and @PERMISSION_DENIED@ errors.
--
-- /See:/ 'newServiceManagementServicesSetIamPolicy' smart constructor.
data ServiceManagementServicesSetIamPolicy = ServiceManagementServicesSetIamPolicy
    {
      -- | V1 error format.
...
-- | Creates a value of 'ServiceManagementServicesSetIamPolicy' with the minimum fields required to make a request.
newServiceManagementServicesSetIamPolicy 
    :: 
                                         SetIamPolicyRequest
    ...
    -> ServiceManagementServicesSetIamPolicy
newServiceManagementServicesSetIamPolicy payload resource
  = ServiceManagementServicesSetIamPolicy{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          payload = payload, resource = resource,
                                          uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ServiceManagementServicesSetIamPolicy
         where
        type Rs ServiceManagementServicesSetIamPolicy = Policy
        type Scopes ServiceManagementServicesSetIamPolicy =
             '[CloudPlatform'FullControl, Service'Management]
        requestClient ServiceManagementServicesSetIamPolicy{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ServiceManagementServicesSetIamPolicyResource)
                      Core.mempty
