...
newServiceManagementServicesRolloutsList serviceName
  = ServiceManagementServicesRolloutsList{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          filter = Core.Nothing, pageSize = Core.Nothing,
                                          pageToken = Core.Nothing, serviceName = serviceName,
                                          uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ServiceManagementServicesRolloutsList
         where
        ...
        requestClient ServiceManagementServicesRolloutsList{..}
          = go serviceName xgafv accessToken callback filter pageSize
              pageToken
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ServiceManagementServicesRolloutsListResource)
                      Core.mempty
