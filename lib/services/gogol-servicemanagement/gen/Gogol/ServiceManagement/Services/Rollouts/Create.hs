                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] Rollout Core.:>
...
newServiceManagementServicesRolloutsCreate payload serviceName
  = ServiceManagementServicesRolloutsCreate{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            payload = payload, serviceName = serviceName,
                                            uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ServiceManagementServicesRolloutsCreate
         where
        type Rs ServiceManagementServicesRolloutsCreate = Operation
        type Scopes ServiceManagementServicesRolloutsCreate =
             '[CloudPlatform'FullControl, Service'Management]
        requestClient ServiceManagementServicesRolloutsCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ServiceManagementServicesRolloutsCreateResource)
                      Core.mempty
