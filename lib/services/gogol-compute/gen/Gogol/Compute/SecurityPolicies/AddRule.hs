...
newComputeSecurityPoliciesAddRule payload project securityPolicy
  = ComputeSecurityPoliciesAddRule{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeSecurityPoliciesAddRule where
        ...
        type Scopes ComputeSecurityPoliciesAddRule =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeSecurityPoliciesAddRule{..}
          = go project securityPolicy xgafv accessToken callback uploadType
              uploadProtocol
              validateOnly
