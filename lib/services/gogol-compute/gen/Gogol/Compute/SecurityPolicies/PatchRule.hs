...
newComputeSecurityPoliciesPatchRule payload project securityPolicy
  = ComputeSecurityPoliciesPatchRule{xgafv = Core.Nothing,
                                     accessToken = Core.Nothing, callback = Core.Nothing,
                                     payload = payload, priority = Core.Nothing, project = project,
...
instance Core.GoogleRequest ComputeSecurityPoliciesPatchRule where
        ...
        requestClient ComputeSecurityPoliciesPatchRule{..}
          = go project securityPolicy xgafv accessToken callback priority
              updateMask
              uploadType
              uploadProtocol
              validateOnly
