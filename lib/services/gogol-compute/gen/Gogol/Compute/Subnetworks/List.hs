                                 ...
                                 Core.QueryParam "returnPartialSuccess" Core.Bool Core.:>
                                   Core.QueryParam "uploadType" Core.Text Core.:>
                                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                                       Core.QueryParams "views" SubnetworksListViews Core.:>
...
data ComputeSubnetworksList = ComputeSubnetworksList
    ...
    , views :: (Core.Maybe [SubnetworksListViews])
    }
...
newComputeSubnetworksList project region
  = ComputeSubnetworksList{xgafv = Core.Nothing,
                           ...
                           uploadProtocol = Core.Nothing, views = Core.Nothing}
