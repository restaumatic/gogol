                             ...
                             Core.QueryParam "orderBy" Core.Text Core.:>
                               Core.QueryParam "pageToken" Core.Text Core.:>
                                 Core.QueryParam "returnPartialSuccess" Core.Bool Core.:>
                                   Core.QueryParam "serviceProject" Core.Text Core.:>
...
data ComputeSubnetworksListUsable = ComputeSubnetworksListUsable
    ...
    , returnPartialSuccess :: (Core.Maybe Core.Bool)
      -- | The project id or project number in which the subnetwork is intended to be used. Only applied for Shared VPC. See <https://cloud.google.com/vpc/docs/shared-vpc/ Shared VPC documentation>
    , serviceProject :: (Core.Maybe Core.Text)
...
newComputeSubnetworksListUsable project
  = ComputeSubnetworksListUsable{xgafv = Core.Nothing,
                                 ...
                                 returnPartialSuccess = Core.Nothing, serviceProject = Core.Nothing,
