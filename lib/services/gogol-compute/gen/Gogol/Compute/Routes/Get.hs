...
newComputeRoutesGet project route
  = ComputeRoutesGet{xgafv = Core.Nothing,
                     accessToken = Core.Nothing, callback = Core.Nothing,
                     project = project, route = route, uploadType = Core.Nothing,
                     uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeRoutesGet where
        type Rs ComputeRoutesGet = Route
        type Scopes ComputeRoutesGet =
             '[CloudPlatform'FullControl, Compute'FullControl, Compute'Readonly]
        requestClient ComputeRoutesGet{..}
          = go project route xgafv accessToken callback uploadType
              uploadProtocol
