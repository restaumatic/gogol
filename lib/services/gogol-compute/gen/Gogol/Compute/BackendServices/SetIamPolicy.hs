...
newComputeBackendServicesSetIamPolicy payload project resource
  = ComputeBackendServicesSetIamPolicy{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       payload = payload, project = project, resource = resource,
                                       uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeBackendServicesSetIamPolicy
         where
        type Rs ComputeBackendServicesSetIamPolicy = Policy
        type Scopes ComputeBackendServicesSetIamPolicy =
