...
-- |
-- Module      : Gogol.Compute.PreviewFeatures.List
...
--
-- /See:/ <https://cloud.google.com/compute/ Compute Engine API Reference> for @compute.previewFeatures.list@.
module Gogol.Compute.PreviewFeatures.List
    (
    -- * Resource
...
-- | A resource alias for @compute.previewFeatures.list@ method which the
-- 'ComputePreviewFeaturesList' request conforms to.
type ComputePreviewFeaturesListResource =
     "compute" Core.:>
       "v1" Core.:>
         "projects" Core.:>
                                 ...
                                 Core.QueryParam "uploadType" Core.Text Core.:>
                                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                                     Core.QueryParam "alt" Core.AltJSON Core.:>
                                       Core.Get '[Core.JSON] PreviewFeatureList

-- | Returns the details of the given PreviewFeature.
--
-- /See:/ 'newComputePreviewFeaturesList' smart constructor.
data ComputePreviewFeaturesList = ComputePreviewFeaturesList
    {
      -- | V1 error format.
...
-- | Creates a value of 'ComputePreviewFeaturesList' with the minimum fields required to make a request.
newComputePreviewFeaturesList 
    :: 
                              Core.Text
       -- ^  Project ID for this request. See 'project'.
    -> ComputePreviewFeaturesList
newComputePreviewFeaturesList project
  = ComputePreviewFeaturesList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputePreviewFeaturesList where
        type Rs ComputePreviewFeaturesList = PreviewFeatureList
        type Scopes ComputePreviewFeaturesList =
             '[CloudPlatform'FullControl, Compute'FullControl, Compute'Readonly]
        requestClient ComputePreviewFeaturesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ComputePreviewFeaturesListResource)
                      Core.mempty
