...
newComputeFirewallsGet firewall project
  = ComputeFirewallsGet{xgafv = Core.Nothing,
                        accessToken = Core.Nothing, callback = Core.Nothing,
                        firewall = firewall, project = project, uploadType = Core.Nothing,
                        uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeFirewallsGet where
        type Rs ComputeFirewallsGet = Firewall
        type Scopes ComputeFirewallsGet =
             '[CloudPlatform'FullControl, Compute'FullControl, Compute'Readonly]
        requestClient ComputeFirewallsGet{..}
          = go project firewall xgafv accessToken callback uploadType
              uploadProtocol
