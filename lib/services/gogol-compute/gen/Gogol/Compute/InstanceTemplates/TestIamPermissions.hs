...
newComputeInstanceTemplatesTestIamPermissions 
    ...
    -> ComputeInstanceTemplatesTestIamPermissions
newComputeInstanceTemplatesTestIamPermissions payload project
  resource
  = ComputeInstanceTemplatesTestIamPermissions{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           ComputeInstanceTemplatesTestIamPermissions
         where
        type Rs ComputeInstanceTemplatesTestIamPermissions =
             TestPermissionsResponse
        type Scopes ComputeInstanceTemplatesTestIamPermissions =
