...
-- |
-- Module      : Gogol.Compute.CrossSiteNetworks.List
...
--
-- /See:/ <https://cloud.google.com/compute/ Compute Engine API Reference> for @compute.crossSiteNetworks.list@.
module Gogol.Compute.CrossSiteNetworks.List
    (
    -- * Resource
...
-- | A resource alias for @compute.crossSiteNetworks.list@ method which the
-- 'ComputeCrossSiteNetworksList' request conforms to.
type ComputeCrossSiteNetworksListResource =
     "compute" Core.:>
       "v1" Core.:>
         "projects" Core.:>
                                 ...
                                 Core.QueryParam "uploadType" Core.Text Core.:>
                                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                                     Core.QueryParam "alt" Core.AltJSON Core.:>
                                       Core.Get '[Core.JSON] CrossSiteNetworkList

-- | Lists the cross-site networks for a project in the given scope.
--
-- /See:/ 'newComputeCrossSiteNetworksList' smart constructor.
data ComputeCrossSiteNetworksList = ComputeCrossSiteNetworksList
    {
      -- | V1 error format.
...
-- | Creates a value of 'ComputeCrossSiteNetworksList' with the minimum fields required to make a request.
newComputeCrossSiteNetworksList 
    :: 
                                Core.Text
       -- ^  Project ID for this request. See 'project'.
    -> ComputeCrossSiteNetworksList
newComputeCrossSiteNetworksList project
  = ComputeCrossSiteNetworksList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeCrossSiteNetworksList where
        type Rs ComputeCrossSiteNetworksList = CrossSiteNetworkList
        type Scopes ComputeCrossSiteNetworksList =
             '[CloudPlatform'FullControl, Compute'FullControl, Compute'Readonly]
        requestClient ComputeCrossSiteNetworksList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ComputeCrossSiteNetworksListResource)
                      Core.mempty
