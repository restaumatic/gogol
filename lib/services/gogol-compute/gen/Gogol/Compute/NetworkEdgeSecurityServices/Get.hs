                           ...
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.Get '[Core.JSON] NetworkEdgeSecurityService
...
newComputeNetworkEdgeSecurityServicesGet 
    ...
    -> ComputeNetworkEdgeSecurityServicesGet
newComputeNetworkEdgeSecurityServicesGet networkEdgeSecurityService
  project region
  = ComputeNetworkEdgeSecurityServicesGet{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          networkEdgeSecurityService = networkEdgeSecurityService,
                                          project = project, region = region,
                                          uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeNetworkEdgeSecurityServicesGet
         where
        type Rs ComputeNetworkEdgeSecurityServicesGet =
             NetworkEdgeSecurityService
        type Scopes ComputeNetworkEdgeSecurityServicesGet =
