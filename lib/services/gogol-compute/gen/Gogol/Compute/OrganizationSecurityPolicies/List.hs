...
-- |
-- Module      : Gogol.Compute.OrganizationSecurityPolicies.List
...
-- 
-- Use of this API to read firewall policies is deprecated. Use firewallPolicies.list instead.
--
-- /See:/ <https://cloud.google.com/compute/ Compute Engine API Reference> for @compute.organizationSecurityPolicies.list@.
module Gogol.Compute.OrganizationSecurityPolicies.List
    (
    -- * Resource
...
-- | A resource alias for @compute.organizationSecurityPolicies.list@ method which the
-- 'ComputeOrganizationSecurityPoliciesList' request conforms to.
type ComputeOrganizationSecurityPoliciesListResource =
     "compute" Core.:>
       "v1" Core.:>
         "locations" Core.:>
           "global" Core.:>
...
-- Use of this API to read firewall policies is deprecated. Use firewallPolicies.list instead.
--
-- /See:/ 'newComputeOrganizationSecurityPoliciesList' smart constructor.
data ComputeOrganizationSecurityPoliciesList = ComputeOrganizationSecurityPoliciesList
    {
      -- | V1 error format.
...
-- | Creates a value of 'ComputeOrganizationSecurityPoliciesList' with the minimum fields required to make a request.
newComputeOrganizationSecurityPoliciesList 
    :: 
                                           ComputeOrganizationSecurityPoliciesList
newComputeOrganizationSecurityPoliciesList
  = ComputeOrganizationSecurityPoliciesList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeOrganizationSecurityPoliciesList
         where
        type Rs ComputeOrganizationSecurityPoliciesList =
             SecurityPolicyList
        type Scopes ComputeOrganizationSecurityPoliciesList =
             '[CloudPlatform'FullControl, Compute'FullControl, Compute'Readonly]
        requestClient ComputeOrganizationSecurityPoliciesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ComputeOrganizationSecurityPoliciesListResource)
                      Core.mempty
