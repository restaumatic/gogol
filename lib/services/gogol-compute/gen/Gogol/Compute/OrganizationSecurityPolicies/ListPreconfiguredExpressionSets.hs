...
-- |
-- Module      : Gogol.Compute.OrganizationSecurityPolicies.ListPreconfiguredExpressionSets
...
--
-- /See:/ <https://cloud.google.com/compute/ Compute Engine API Reference> for @compute.organizationSecurityPolicies.listPreconfiguredExpressionSets@.
module Gogol.Compute.OrganizationSecurityPolicies.ListPreconfiguredExpressionSets
    (
    -- * Resource
...
-- | A resource alias for @compute.organizationSecurityPolicies.listPreconfiguredExpressionSets@ method which the
-- 'ComputeOrganizationSecurityPoliciesListPreconfiguredExpressionSets' request conforms to.
type ComputeOrganizationSecurityPoliciesListPreconfiguredExpressionSetsResource
     =
     "compute" Core.:>
       "v1" Core.:>
         "locations" Core.:>
...
-- | Gets the current list of preconfigured Web Application Firewall (WAF) expressions.
--
-- /See:/ 'newComputeOrganizationSecurityPoliciesListPreconfiguredExpressionSets' smart constructor.
data ComputeOrganizationSecurityPoliciesListPreconfiguredExpressionSets = ComputeOrganizationSecurityPoliciesListPreconfiguredExpressionSets
    {
      -- | V1 error format.
...
-- | Creates a value of 'ComputeOrganizationSecurityPoliciesListPreconfiguredExpressionSets' with the minimum fields required to make a request.
newComputeOrganizationSecurityPoliciesListPreconfiguredExpressionSets 
    :: 
                                                                      ComputeOrganizationSecurityPoliciesListPreconfiguredExpressionSets
newComputeOrganizationSecurityPoliciesListPreconfiguredExpressionSets
  = ComputeOrganizationSecurityPoliciesListPreconfiguredExpressionSets{xgafv
                                                                         = Core.Nothing,
