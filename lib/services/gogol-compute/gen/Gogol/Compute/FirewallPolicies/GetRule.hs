...
newComputeFirewallPoliciesGetRule firewallPolicy
  = ComputeFirewallPoliciesGetRule{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeFirewallPoliciesGetRule where
        ...
        type Scopes ComputeFirewallPoliciesGetRule =
             '[CloudPlatform'FullControl, Compute'FullControl, Compute'Readonly]
        requestClient ComputeFirewallPoliciesGetRule{..}
          = go firewallPolicy xgafv accessToken callback priority uploadType
              uploadProtocol
