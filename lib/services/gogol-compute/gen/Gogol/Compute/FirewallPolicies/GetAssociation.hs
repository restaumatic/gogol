...
newComputeFirewallPoliciesGetAssociation firewallPolicy
  = ComputeFirewallPoliciesGetAssociation{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          firewallPolicy = firewallPolicy, name = Core.Nothing,
                                          uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeFirewallPoliciesGetAssociation
         where
        ...
        requestClient ComputeFirewallPoliciesGetAssociation{..}
          = go firewallPolicy xgafv accessToken callback name uploadType
              uploadProtocol
