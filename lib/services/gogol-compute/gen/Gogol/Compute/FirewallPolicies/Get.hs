...
newComputeFirewallPoliciesGet firewallPolicy
  = ComputeFirewallPoliciesGet{xgafv = Core.Nothing,
                               accessToken = Core.Nothing, callback = Core.Nothing,
                               firewallPolicy = firewallPolicy, uploadType = Core.Nothing,
...
instance Core.GoogleRequest ComputeFirewallPoliciesGet where
        ...
        requestClient ComputeFirewallPoliciesGet{..}
          = go firewallPolicy xgafv accessToken callback uploadType
              uploadProtocol
