...
newComputeFirewallPoliciesTestIamPermissions payload resource
  = ComputeFirewallPoliciesTestIamPermissions{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           ComputeFirewallPoliciesTestIamPermissions
         where
        type Rs ComputeFirewallPoliciesTestIamPermissions =
             TestPermissionsResponse
        type Scopes ComputeFirewallPoliciesTestIamPermissions =
