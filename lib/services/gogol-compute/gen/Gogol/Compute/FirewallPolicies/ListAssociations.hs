                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Get '[Core.JSON] FirewallPoliciesListAssociationsResponse
...
newComputeFirewallPoliciesListAssociations 
    :: 
                                           ComputeFirewallPoliciesListAssociations
newComputeFirewallPoliciesListAssociations
  = ComputeFirewallPoliciesListAssociations{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            targetResource = Core.Nothing,
                                            uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeFirewallPoliciesListAssociations
         where
        type Rs ComputeFirewallPoliciesListAssociations =
