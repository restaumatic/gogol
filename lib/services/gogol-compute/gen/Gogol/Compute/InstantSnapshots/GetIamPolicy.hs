...
newComputeInstantSnapshotsGetIamPolicy project resource zone
  = ComputeInstantSnapshotsGetIamPolicy{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        optionsRequestedPolicyVersion = Core.Nothing,
                                        project = project, resource = resource,
                                        uploadType = Core.Nothing, uploadProtocol = Core.Nothing,
                                        zone = zone}
instance Core.GoogleRequest ComputeInstantSnapshotsGetIamPolicy
         where
        type Rs ComputeInstantSnapshotsGetIamPolicy = Policy
        type Scopes ComputeInstantSnapshotsGetIamPolicy =
