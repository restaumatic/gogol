...
newComputeInstantSnapshotsSetIamPolicy 
    ...
    -> ComputeInstantSnapshotsSetIamPolicy
newComputeInstantSnapshotsSetIamPolicy payload project resource
  zone
  = ComputeInstantSnapshotsSetIamPolicy{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        payload = payload, project = project, resource = resource,
                                        uploadType = Core.Nothing, uploadProtocol = Core.Nothing,
                                        zone = zone}
instance Core.GoogleRequest ComputeInstantSnapshotsSetIamPolicy
         where
        type Rs ComputeInstantSnapshotsSetIamPolicy = Policy
        type Scopes ComputeInstantSnapshotsSetIamPolicy =
