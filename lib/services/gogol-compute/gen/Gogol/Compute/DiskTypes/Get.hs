           ...
           Core.Capture "project" Core.Text Core.:>
             "zones" Core.:>
               Core.Capture "zone" Core.Text Core.:>
                 "diskTypes" Core.:>
                   Core.Capture "diskType" Core.Text Core.:>
...
newComputeDiskTypesGet diskType project zone
  = ComputeDiskTypesGet{xgafv = Core.Nothing,
                        accessToken = Core.Nothing, callback = Core.Nothing,
                        diskType = diskType, project = project, uploadType = Core.Nothing,
...
instance Core.GoogleRequest ComputeDiskTypesGet where
        ...
        type Scopes ComputeDiskTypesGet =
             '[CloudPlatform'FullControl, Compute'FullControl, Compute'Readonly]
        requestClient ComputeDiskTypesGet{..}
          = go project zone diskType xgafv accessToken callback uploadType
              uploadProtocol
