...
newComputeNetworkProfilesGet networkProfile project
  = ComputeNetworkProfilesGet{xgafv = Core.Nothing,
                              accessToken = Core.Nothing, callback = Core.Nothing,
                              networkProfile = networkProfile, project = project,
...
instance Core.GoogleRequest ComputeNetworkProfilesGet where
        ...
        requestClient ComputeNetworkProfilesGet{..}
          = go project networkProfile xgafv accessToken callback uploadType
              uploadProtocol
