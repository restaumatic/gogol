...
newComputeStoragePoolsTestIamPermissions 
    ...
    -> ComputeStoragePoolsTestIamPermissions
newComputeStoragePoolsTestIamPermissions payload project resource
  zone
  = ComputeStoragePoolsTestIamPermissions{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          payload = payload, project = project, resource = resource,
                                          uploadType = Core.Nothing, uploadProtocol = Core.Nothing,
                                          zone = zone}
instance Core.GoogleRequest ComputeStoragePoolsTestIamPermissions
         where
        type Rs ComputeStoragePoolsTestIamPermissions =
             TestPermissionsResponse
        type Scopes ComputeStoragePoolsTestIamPermissions =
