...
newComputeNetworkEndpointGroupsTestIamPermissions 
    ...
    -> ComputeNetworkEndpointGroupsTestIamPermissions
newComputeNetworkEndpointGroupsTestIamPermissions payload project
  resource zone
  = ComputeNetworkEndpointGroupsTestIamPermissions{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           ComputeNetworkEndpointGroupsTestIamPermissions
         where
        type Rs ComputeNetworkEndpointGroupsTestIamPermissions =
             TestPermissionsResponse
        type Scopes ComputeNetworkEndpointGroupsTestIamPermissions =
