...
newComputeRegionBackendServicesGetHealth 
    ...
    -> ComputeRegionBackendServicesGetHealth
newComputeRegionBackendServicesGetHealth backendService payload
  project region
  = ComputeRegionBackendServicesGetHealth{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeRegionBackendServicesGetHealth
         where
