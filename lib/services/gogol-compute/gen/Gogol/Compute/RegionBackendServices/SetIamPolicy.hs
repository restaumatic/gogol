...
newComputeRegionBackendServicesSetIamPolicy 
    ...
    -> ComputeRegionBackendServicesSetIamPolicy
newComputeRegionBackendServicesSetIamPolicy payload project region
  resource
  = ComputeRegionBackendServicesSetIamPolicy{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes ComputeRegionBackendServicesSetIamPolicy =
