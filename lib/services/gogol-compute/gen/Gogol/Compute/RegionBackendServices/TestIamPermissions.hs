...
newComputeRegionBackendServicesTestIamPermissions 
    ...
    -> ComputeRegionBackendServicesTestIamPermissions
newComputeRegionBackendServicesTestIamPermissions payload project
  region resource
  = ComputeRegionBackendServicesTestIamPermissions{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           ComputeRegionBackendServicesTestIamPermissions
         where
        type Rs ComputeRegionBackendServicesTestIamPermissions =
             TestPermissionsResponse
        type Scopes ComputeRegionBackendServicesTestIamPermissions =
