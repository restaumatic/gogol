                           ...
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.Get '[Core.JSON] TargetInstance
...
newComputeTargetInstancesGet project targetInstance zone
  = ComputeTargetInstancesGet{xgafv = Core.Nothing,
                              accessToken = Core.Nothing, callback = Core.Nothing,
                              project = project, targetInstance = targetInstance,
...
instance Core.GoogleRequest ComputeTargetInstancesGet where
        ...
        type Scopes ComputeTargetInstancesGet =
