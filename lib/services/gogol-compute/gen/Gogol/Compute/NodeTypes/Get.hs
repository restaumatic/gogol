...
newComputeNodeTypesGet nodeType project zone
  = ComputeNodeTypesGet{xgafv = Core.Nothing,
                        accessToken = Core.Nothing, callback = Core.Nothing,
                        nodeType = nodeType, project = project, uploadType = Core.Nothing,
...
instance Core.GoogleRequest ComputeNodeTypesGet where
        ...
        requestClient ComputeNodeTypesGet{..}
          = go project zone nodeType xgafv accessToken callback uploadType
              uploadProtocol
