                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Get '[Core.JSON] BackendBucket
...
newComputeBackendBucketsGet backendBucket project
  = ComputeBackendBucketsGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeBackendBucketsGet where
        ...
        type Scopes ComputeBackendBucketsGet =
             '[CloudPlatform'FullControl, Compute'FullControl, Compute'Readonly]
        requestClient ComputeBackendBucketsGet{..}
          = go project backendBucket xgafv accessToken callback uploadType
              uploadProtocol
