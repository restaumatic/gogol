...
newComputeBackendBucketsTestIamPermissions payload project resource
  = ComputeBackendBucketsTestIamPermissions{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            payload = payload, project = project,
                                            resource = resource, uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeBackendBucketsTestIamPermissions
         where
        type Rs ComputeBackendBucketsTestIamPermissions =
             TestPermissionsResponse
        type Scopes ComputeBackendBucketsTestIamPermissions =
