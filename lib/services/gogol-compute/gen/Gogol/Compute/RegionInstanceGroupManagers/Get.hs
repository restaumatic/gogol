...
newComputeRegionInstanceGroupManagersGet 
    ...
    -> ComputeRegionInstanceGroupManagersGet
newComputeRegionInstanceGroupManagersGet instanceGroupManager
  project region
  = ComputeRegionInstanceGroupManagersGet{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          instanceGroupManager = instanceGroupManager,
                                          project = project, region = region,
                                          uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeRegionInstanceGroupManagersGet
         where
        type Rs ComputeRegionInstanceGroupManagersGet =
             InstanceGroupManager
        type Scopes ComputeRegionInstanceGroupManagersGet =
