                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Get '[Core.JSON] HealthCheck
...
newComputeHealthChecksGet healthCheck project
  = ComputeHealthChecksGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeHealthChecksGet where
        ...
        type Scopes ComputeHealthChecksGet =
             '[CloudPlatform'FullControl, Compute'FullControl, Compute'Readonly]
        requestClient ComputeHealthChecksGet{..}
          = go project healthCheck xgafv accessToken callback uploadType
              uploadProtocol
