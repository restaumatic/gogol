                             ...
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.ReqBody '[Core.JSON] InstanceReference Core.:>
                                     Core.Post '[Core.JSON] TargetPoolInstanceHealth
...
newComputeTargetPoolsGetHealth payload project region targetPool
  = ComputeTargetPoolsGetHealth{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeTargetPoolsGetHealth where
        ...
        type Scopes ComputeTargetPoolsGetHealth =
