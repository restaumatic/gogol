...
newComputeRegionNetworkEndpointGroupsGet 
    ...
    -> ComputeRegionNetworkEndpointGroupsGet
newComputeRegionNetworkEndpointGroupsGet networkEndpointGroup
  project region
  = ComputeRegionNetworkEndpointGroupsGet{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          networkEndpointGroup = networkEndpointGroup,
                                          project = project, region = region,
                                          uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeRegionNetworkEndpointGroupsGet
         where
        type Rs ComputeRegionNetworkEndpointGroupsGet =
             NetworkEndpointGroup
        type Scopes ComputeRegionNetworkEndpointGroupsGet =
