...
newComputeReservationsTestIamPermissions 
    ...
    -> ComputeReservationsTestIamPermissions
newComputeReservationsTestIamPermissions payload project resource
  zone
  = ComputeReservationsTestIamPermissions{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          payload = payload, project = project, resource = resource,
                                          uploadType = Core.Nothing, uploadProtocol = Core.Nothing,
                                          zone = zone}
instance Core.GoogleRequest ComputeReservationsTestIamPermissions
         where
        type Rs ComputeReservationsTestIamPermissions =
             TestPermissionsResponse
        type Scopes ComputeReservationsTestIamPermissions =
