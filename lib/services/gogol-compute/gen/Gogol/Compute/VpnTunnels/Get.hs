...
newComputeVpnTunnelsGet project region vpnTunnel
  = ComputeVpnTunnelsGet{xgafv = Core.Nothing,
                         accessToken = Core.Nothing, callback = Core.Nothing,
                         project = project, region = region, uploadType = Core.Nothing,
                         uploadProtocol = Core.Nothing, vpnTunnel = vpnTunnel}
instance Core.GoogleRequest ComputeVpnTunnelsGet where
        ...
        requestClient ComputeVpnTunnelsGet{..}
          = go project region vpnTunnel xgafv accessToken callback uploadType
              uploadProtocol
