           ...
           Core.Capture "project" Core.Text Core.:>
             "zones" Core.:>
               Core.Capture "zone" Core.Text Core.:>
                 "machineTypes" Core.:>
                   Core.Capture "machineType" Core.Text Core.:>
                           ...
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.Get '[Core.JSON] MachineType
...
newComputeMachineTypesGet machineType project zone
  = ComputeMachineTypesGet{xgafv = Core.Nothing,
                           accessToken = Core.Nothing, callback = Core.Nothing,
                           machineType = machineType, project = project,
...
instance Core.GoogleRequest ComputeMachineTypesGet where
        ...
        type Scopes ComputeMachineTypesGet =
             '[CloudPlatform'FullControl, Compute'FullControl, Compute'Readonly]
        requestClient ComputeMachineTypesGet{..}
          = go project zone machineType xgafv accessToken callback uploadType
              uploadProtocol
