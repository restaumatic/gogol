...
newComputePublicAdvertisedPrefixesGet 
    ...
    -> ComputePublicAdvertisedPrefixesGet
newComputePublicAdvertisedPrefixesGet project
  publicAdvertisedPrefix
  = ComputePublicAdvertisedPrefixesGet{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       project = project,
                                       publicAdvertisedPrefix = publicAdvertisedPrefix,
                                       uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputePublicAdvertisedPrefixesGet
         where
