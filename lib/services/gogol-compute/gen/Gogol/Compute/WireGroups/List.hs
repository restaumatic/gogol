...
-- |
-- Module      : Gogol.Compute.WireGroups.List
...
--
-- /See:/ <https://cloud.google.com/compute/ Compute Engine API Reference> for @compute.wireGroups.list@.
module Gogol.Compute.WireGroups.List
    (
    -- * Resource
...
-- | A resource alias for @compute.wireGroups.list@ method which the
-- 'ComputeWireGroupsList' request conforms to.
type ComputeWireGroupsListResource =
     "compute" Core.:>
       "v1" Core.:>
         "projects" Core.:>
                                     ...
                                     Core.QueryParam "uploadType" Core.Text Core.:>
                                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                                         Core.QueryParam "alt" Core.AltJSON Core.:>
                                           Core.Get '[Core.JSON] WireGroupList

-- | Lists the wire groups for a project in the given scope.
--
-- /See:/ 'newComputeWireGroupsList' smart constructor.
data ComputeWireGroupsList = ComputeWireGroupsList
    {
      -- | V1 error format.
...
-- | Creates a value of 'ComputeWireGroupsList' with the minimum fields required to make a request.
newComputeWireGroupsList 
    :: 
                         Core.Text
    ...
    -> ComputeWireGroupsList
newComputeWireGroupsList crossSiteNetwork project
  = ComputeWireGroupsList{xgafv = Core.Nothing,
                          accessToken = Core.Nothing, callback = Core.Nothing,
                          crossSiteNetwork = crossSiteNetwork, filter = Core.Nothing,
...
instance Core.GoogleRequest ComputeWireGroupsList where
        type Rs ComputeWireGroupsList = WireGroupList
        type Scopes ComputeWireGroupsList =
             '[CloudPlatform'FullControl, Compute'FullControl, Compute'Readonly]
        requestClient ComputeWireGroupsList{..}
          = go project crossSiteNetwork xgafv accessToken callback filter
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ComputeWireGroupsListResource)
                      Core.mempty
