...
newComputeRegionInstantSnapshotsGetIamPolicy 
    ...
    -> ComputeRegionInstantSnapshotsGetIamPolicy
newComputeRegionInstantSnapshotsGetIamPolicy project region
  resource
  = ComputeRegionInstantSnapshotsGetIamPolicy{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes ComputeRegionInstantSnapshotsGetIamPolicy =
