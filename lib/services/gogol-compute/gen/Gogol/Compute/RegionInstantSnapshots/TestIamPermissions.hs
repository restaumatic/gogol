...
newComputeRegionInstantSnapshotsTestIamPermissions 
    ...
    -> ComputeRegionInstantSnapshotsTestIamPermissions
newComputeRegionInstantSnapshotsTestIamPermissions payload project
  region resource
  = ComputeRegionInstantSnapshotsTestIamPermissions{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           ComputeRegionInstantSnapshotsTestIamPermissions
         where
        type Rs ComputeRegionInstantSnapshotsTestIamPermissions =
             TestPermissionsResponse
        type Scopes ComputeRegionInstantSnapshotsTestIamPermissions =
