...
newComputeRegionInstantSnapshotsSetIamPolicy 
    ...
    -> ComputeRegionInstantSnapshotsSetIamPolicy
newComputeRegionInstantSnapshotsSetIamPolicy payload project region
  resource
  = ComputeRegionInstantSnapshotsSetIamPolicy{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes ComputeRegionInstantSnapshotsSetIamPolicy =
