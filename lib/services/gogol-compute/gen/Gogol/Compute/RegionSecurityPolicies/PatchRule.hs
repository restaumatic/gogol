...
newComputeRegionSecurityPoliciesPatchRule 
    ...
    -> ComputeRegionSecurityPoliciesPatchRule
newComputeRegionSecurityPoliciesPatchRule payload project region
  securityPolicy
  = ComputeRegionSecurityPoliciesPatchRule{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeRegionSecurityPoliciesPatchRule
         where
