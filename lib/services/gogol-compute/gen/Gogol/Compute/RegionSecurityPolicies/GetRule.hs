...
newComputeRegionSecurityPoliciesGetRule 
    ...
    -> ComputeRegionSecurityPoliciesGetRule
newComputeRegionSecurityPoliciesGetRule project region
  securityPolicy
  = ComputeRegionSecurityPoliciesGetRule{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeRegionSecurityPoliciesGetRule
         where
        type Rs ComputeRegionSecurityPoliciesGetRule = SecurityPolicyRule
        type Scopes ComputeRegionSecurityPoliciesGetRule =
