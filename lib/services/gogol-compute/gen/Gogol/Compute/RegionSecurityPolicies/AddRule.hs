...
newComputeRegionSecurityPoliciesAddRule 
    ...
    -> ComputeRegionSecurityPoliciesAddRule
newComputeRegionSecurityPoliciesAddRule payload project region
  securityPolicy
  = ComputeRegionSecurityPoliciesAddRule{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeRegionSecurityPoliciesAddRule
         where
