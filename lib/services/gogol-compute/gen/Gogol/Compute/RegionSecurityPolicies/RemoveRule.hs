...
newComputeRegionSecurityPoliciesRemoveRule 
    ...
    -> ComputeRegionSecurityPoliciesRemoveRule
newComputeRegionSecurityPoliciesRemoveRule project region
  securityPolicy
  = ComputeRegionSecurityPoliciesRemoveRule{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            priority = Core.Nothing, project = project,
                                            region = region, securityPolicy = securityPolicy,
                                            uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeRegionSecurityPoliciesRemoveRule
         where
        type Rs ComputeRegionSecurityPoliciesRemoveRule = Operation
        type Scopes ComputeRegionSecurityPoliciesRemoveRule =
