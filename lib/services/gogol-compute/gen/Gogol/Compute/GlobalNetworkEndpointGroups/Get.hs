...
newComputeGlobalNetworkEndpointGroupsGet 
    ...
    -> ComputeGlobalNetworkEndpointGroupsGet
newComputeGlobalNetworkEndpointGroupsGet networkEndpointGroup
  project
  = ComputeGlobalNetworkEndpointGroupsGet{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          networkEndpointGroup = networkEndpointGroup,
                                          project = project, uploadType = Core.Nothing,
                                          uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeGlobalNetworkEndpointGroupsGet
         where
        type Rs ComputeGlobalNetworkEndpointGroupsGet =
             NetworkEndpointGroup
        type Scopes ComputeGlobalNetworkEndpointGroupsGet =
