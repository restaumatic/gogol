                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Get '[Core.JSON] TargetTcpProxy
...
newComputeTargetTcpProxiesGet project targetTcpProxy
  = ComputeTargetTcpProxiesGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeTargetTcpProxiesGet where
        ...
        type Scopes ComputeTargetTcpProxiesGet =
             '[CloudPlatform'FullControl, Compute'FullControl, Compute'Readonly]
        requestClient ComputeTargetTcpProxiesGet{..}
          = go project targetTcpProxy xgafv accessToken callback uploadType
              uploadProtocol
