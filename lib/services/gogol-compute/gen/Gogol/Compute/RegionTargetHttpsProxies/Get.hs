...
newComputeRegionTargetHttpsProxiesGet 
    ...
    -> ComputeRegionTargetHttpsProxiesGet
newComputeRegionTargetHttpsProxiesGet project region
  targetHttpsProxy
  = ComputeRegionTargetHttpsProxiesGet{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       project = project, region = region,
                                       targetHttpsProxy = targetHttpsProxy,
                                       uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeRegionTargetHttpsProxiesGet
         where
