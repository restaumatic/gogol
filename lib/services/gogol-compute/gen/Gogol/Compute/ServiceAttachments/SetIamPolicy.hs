                             ...
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.ReqBody '[Core.JSON] RegionSetPolicyRequest Core.:>
...
newComputeServiceAttachmentsSetIamPolicy 
    ...
    -> ComputeServiceAttachmentsSetIamPolicy
newComputeServiceAttachmentsSetIamPolicy payload project region
  resource
  = ComputeServiceAttachmentsSetIamPolicy{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          payload = payload, project = project, region = region,
                                          resource = resource, uploadType = Core.Nothing,
                                          uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeServiceAttachmentsSetIamPolicy
         where
        type Rs ComputeServiceAttachmentsSetIamPolicy = Policy
        type Scopes ComputeServiceAttachmentsSetIamPolicy =
