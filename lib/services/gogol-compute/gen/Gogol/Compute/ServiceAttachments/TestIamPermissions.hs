...
newComputeServiceAttachmentsTestIamPermissions 
    ...
    -> ComputeServiceAttachmentsTestIamPermissions
newComputeServiceAttachmentsTestIamPermissions payload project
  region resource
  = ComputeServiceAttachmentsTestIamPermissions{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           ComputeServiceAttachmentsTestIamPermissions
         where
        type Rs ComputeServiceAttachmentsTestIamPermissions =
             TestPermissionsResponse
        type Scopes ComputeServiceAttachmentsTestIamPermissions =
