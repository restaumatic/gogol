...
newComputeServiceAttachmentsGetIamPolicy project region resource
  = ComputeServiceAttachmentsGetIamPolicy{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeServiceAttachmentsGetIamPolicy
         where
        type Rs ComputeServiceAttachmentsGetIamPolicy = Policy
        type Scopes ComputeServiceAttachmentsGetIamPolicy =
