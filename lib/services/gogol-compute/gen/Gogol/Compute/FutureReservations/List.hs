...
-- |
-- Module      : Gogol.Compute.FutureReservations.List
...
--
-- /See:/ <https://cloud.google.com/compute/ Compute Engine API Reference> for @compute.futureReservations.list@.
module Gogol.Compute.FutureReservations.List
    (
    -- * Resource
...
-- | A resource alias for @compute.futureReservations.list@ method which the
-- 'ComputeFutureReservationsList' request conforms to.
type ComputeFutureReservationsListResource =
     "compute" Core.:>
       "v1" Core.:>
         "projects" Core.:>
                                   ...
                                   Core.QueryParam "uploadType" Core.Text Core.:>
                                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                                       Core.QueryParam "alt" Core.AltJSON Core.:>
                                         Core.Get '[Core.JSON] FutureReservationsListResponse

-- | A list of all the future reservations that have been configured for the specified project in specified zone.
--
-- /See:/ 'newComputeFutureReservationsList' smart constructor.
data ComputeFutureReservationsList = ComputeFutureReservationsList
    {
      -- | V1 error format.
...
-- | Creates a value of 'ComputeFutureReservationsList' with the minimum fields required to make a request.
newComputeFutureReservationsList 
    :: 
                                 Core.Text
    ...
    -> ComputeFutureReservationsList
newComputeFutureReservationsList project zone
  = ComputeFutureReservationsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeFutureReservationsList where
        type Rs ComputeFutureReservationsList =
             FutureReservationsListResponse
        type Scopes ComputeFutureReservationsList =
             '[CloudPlatform'FullControl, Compute'FullControl, Compute'Readonly]
        requestClient ComputeFutureReservationsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ComputeFutureReservationsListResource)
                      Core.mempty
