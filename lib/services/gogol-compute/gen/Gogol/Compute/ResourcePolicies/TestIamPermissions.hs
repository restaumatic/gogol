...
newComputeResourcePoliciesTestIamPermissions 
    ...
    -> ComputeResourcePoliciesTestIamPermissions
newComputeResourcePoliciesTestIamPermissions payload project region
  resource
  = ComputeResourcePoliciesTestIamPermissions{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           ComputeResourcePoliciesTestIamPermissions
         where
        type Rs ComputeResourcePoliciesTestIamPermissions =
             TestPermissionsResponse
        type Scopes ComputeResourcePoliciesTestIamPermissions =
