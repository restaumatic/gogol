...
newComputeResourcePoliciesGetIamPolicy project region resource
  = ComputeResourcePoliciesGetIamPolicy{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeResourcePoliciesGetIamPolicy
         where
        type Rs ComputeResourcePoliciesGetIamPolicy = Policy
        type Scopes ComputeResourcePoliciesGetIamPolicy =
