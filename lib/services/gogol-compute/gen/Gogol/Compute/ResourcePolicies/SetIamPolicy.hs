...
newComputeResourcePoliciesSetIamPolicy 
    ...
    -> ComputeResourcePoliciesSetIamPolicy
newComputeResourcePoliciesSetIamPolicy payload project region
  resource
  = ComputeResourcePoliciesSetIamPolicy{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        payload = payload, project = project, region = region,
                                        resource = resource, uploadType = Core.Nothing,
                                        uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeResourcePoliciesSetIamPolicy
         where
