...
newComputeRegionHealthCheckServicesGet 
    ...
    -> ComputeRegionHealthCheckServicesGet
newComputeRegionHealthCheckServicesGet healthCheckService project
  region
  = ComputeRegionHealthCheckServicesGet{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        healthCheckService = healthCheckService, project = project,
                                        region = region, uploadType = Core.Nothing,
                                        uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeRegionHealthCheckServicesGet
         where
