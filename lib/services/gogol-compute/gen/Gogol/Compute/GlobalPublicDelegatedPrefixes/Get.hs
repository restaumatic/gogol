                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Get '[Core.JSON] PublicDelegatedPrefix
...
newComputeGlobalPublicDelegatedPrefixesGet 
    ...
    -> ComputeGlobalPublicDelegatedPrefixesGet
newComputeGlobalPublicDelegatedPrefixesGet project
  publicDelegatedPrefix
  = ComputeGlobalPublicDelegatedPrefixesGet{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            project = project,
                                            publicDelegatedPrefix = publicDelegatedPrefix,
                                            uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeGlobalPublicDelegatedPrefixesGet
         where
        type Rs ComputeGlobalPublicDelegatedPrefixesGet =
             PublicDelegatedPrefix
        type Scopes ComputeGlobalPublicDelegatedPrefixesGet =
