...
newComputeRegionSslPoliciesGet project region sslPolicy
  = ComputeRegionSslPoliciesGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeRegionSslPoliciesGet where
        ...
        type Scopes ComputeRegionSslPoliciesGet =
             '[CloudPlatform'FullControl, Compute'FullControl, Compute'Readonly]
        requestClient ComputeRegionSslPoliciesGet{..}
          = go project region sslPolicy xgafv accessToken callback uploadType
              uploadProtocol
