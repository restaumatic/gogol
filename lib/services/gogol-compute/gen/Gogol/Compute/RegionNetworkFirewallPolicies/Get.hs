...
newComputeRegionNetworkFirewallPoliciesGet 
    ...
    -> ComputeRegionNetworkFirewallPoliciesGet
newComputeRegionNetworkFirewallPoliciesGet firewallPolicy project
  region
  = ComputeRegionNetworkFirewallPoliciesGet{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            firewallPolicy = firewallPolicy, project = project,
                                            region = region, uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeRegionNetworkFirewallPoliciesGet
         where
