...
newComputeRegionNetworkFirewallPoliciesGetIamPolicy 
    ...
    -> ComputeRegionNetworkFirewallPoliciesGetIamPolicy
newComputeRegionNetworkFirewallPoliciesGetIamPolicy project region
  resource
  = ComputeRegionNetworkFirewallPoliciesGetIamPolicy{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes ComputeRegionNetworkFirewallPoliciesGetIamPolicy =
             '[CloudPlatform'FullControl, Compute'FullControl, Compute'Readonly]
        requestClient ComputeRegionNetworkFirewallPoliciesGetIamPolicy{..}
          = go project region resource xgafv accessToken callback
