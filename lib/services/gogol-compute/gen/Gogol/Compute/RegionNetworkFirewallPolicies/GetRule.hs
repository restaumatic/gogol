                               ...
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.Get '[Core.JSON] FirewallPolicyRule
...
newComputeRegionNetworkFirewallPoliciesGetRule 
    ...
    -> ComputeRegionNetworkFirewallPoliciesGetRule
newComputeRegionNetworkFirewallPoliciesGetRule firewallPolicy
  project region
  = ComputeRegionNetworkFirewallPoliciesGetRule{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           ComputeRegionNetworkFirewallPoliciesGetRule
         where
        type Rs ComputeRegionNetworkFirewallPoliciesGetRule =
             FirewallPolicyRule
        type Scopes ComputeRegionNetworkFirewallPoliciesGetRule =
