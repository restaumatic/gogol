...
newComputeRegionNetworkFirewallPoliciesGetEffectiveFirewalls
  ...
  = ComputeRegionNetworkFirewallPoliciesGetEffectiveFirewalls{xgafv =
                                                                Core.Nothing,
...
instance Core.GoogleRequest
           ComputeRegionNetworkFirewallPoliciesGetEffectiveFirewalls
         where
        type Rs ComputeRegionNetworkFirewallPoliciesGetEffectiveFirewalls =
             RegionNetworkFirewallPoliciesGetEffectiveFirewallsResponse
        type Scopes
               ComputeRegionNetworkFirewallPoliciesGetEffectiveFirewalls
             =
        ...
        requestClient
          ComputeRegionNetworkFirewallPoliciesGetEffectiveFirewalls{..}
          = go project region (Core.Just network) xgafv accessToken callback
              uploadType
              uploadProtocol
