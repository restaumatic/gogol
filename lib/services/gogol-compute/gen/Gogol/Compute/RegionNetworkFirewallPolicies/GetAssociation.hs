...
newComputeRegionNetworkFirewallPoliciesGetAssociation
  ...
  = ComputeRegionNetworkFirewallPoliciesGetAssociation{xgafv =
                                                         Core.Nothing,
...
instance Core.GoogleRequest
           ComputeRegionNetworkFirewallPoliciesGetAssociation
         where
        type Rs ComputeRegionNetworkFirewallPoliciesGetAssociation =
             FirewallPolicyAssociation
        type Scopes ComputeRegionNetworkFirewallPoliciesGetAssociation =
