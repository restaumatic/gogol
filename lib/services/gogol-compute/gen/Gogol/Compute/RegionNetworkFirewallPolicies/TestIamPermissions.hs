...
newComputeRegionNetworkFirewallPoliciesTestIamPermissions 
    ...
    -> ComputeRegionNetworkFirewallPoliciesTestIamPermissions
newComputeRegionNetworkFirewallPoliciesTestIamPermissions payload
  project region resource
  = ComputeRegionNetworkFirewallPoliciesTestIamPermissions{xgafv =
                                                             Core.Nothing,
...
instance Core.GoogleRequest
           ComputeRegionNetworkFirewallPoliciesTestIamPermissions
         where
        type Rs ComputeRegionNetworkFirewallPoliciesTestIamPermissions =
             TestPermissionsResponse
        type Scopes ComputeRegionNetworkFirewallPoliciesTestIamPermissions
             =
