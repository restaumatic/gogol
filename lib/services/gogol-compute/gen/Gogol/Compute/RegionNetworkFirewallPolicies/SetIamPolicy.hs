...
newComputeRegionNetworkFirewallPoliciesSetIamPolicy 
    ...
    -> ComputeRegionNetworkFirewallPoliciesSetIamPolicy
newComputeRegionNetworkFirewallPoliciesSetIamPolicy payload project
  region resource
  = ComputeRegionNetworkFirewallPoliciesSetIamPolicy{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes ComputeRegionNetworkFirewallPoliciesSetIamPolicy =
