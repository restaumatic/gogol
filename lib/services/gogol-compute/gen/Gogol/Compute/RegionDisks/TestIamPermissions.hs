...
newComputeRegionDisksTestIamPermissions 
    ...
    -> ComputeRegionDisksTestIamPermissions
newComputeRegionDisksTestIamPermissions payload project region
  resource
  = ComputeRegionDisksTestIamPermissions{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         payload = payload, project = project, region = region,
                                         resource = resource, uploadType = Core.Nothing,
                                         uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeRegionDisksTestIamPermissions
         where
        type Rs ComputeRegionDisksTestIamPermissions =
             TestPermissionsResponse
        type Scopes ComputeRegionDisksTestIamPermissions =
