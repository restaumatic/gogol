...
newComputeNodeGroupsTestIamPermissions 
    ...
    -> ComputeNodeGroupsTestIamPermissions
newComputeNodeGroupsTestIamPermissions payload project resource
  zone
  = ComputeNodeGroupsTestIamPermissions{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        payload = payload, project = project, resource = resource,
                                        uploadType = Core.Nothing, uploadProtocol = Core.Nothing,
                                        zone = zone}
instance Core.GoogleRequest ComputeNodeGroupsTestIamPermissions
         where
        type Rs ComputeNodeGroupsTestIamPermissions =
             TestPermissionsResponse
        type Scopes ComputeNodeGroupsTestIamPermissions =
