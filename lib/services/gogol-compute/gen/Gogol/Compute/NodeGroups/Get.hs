...
newComputeNodeGroupsGet nodeGroup project zone
  = ComputeNodeGroupsGet{xgafv = Core.Nothing,
                         accessToken = Core.Nothing, callback = Core.Nothing,
                         nodeGroup = nodeGroup, project = project,
...
instance Core.GoogleRequest ComputeNodeGroupsGet where
        ...
        type Scopes ComputeNodeGroupsGet =
             '[CloudPlatform'FullControl, Compute'FullControl, Compute'Readonly]
        requestClient ComputeNodeGroupsGet{..}
          = go project zone nodeGroup xgafv accessToken callback uploadType
              uploadProtocol
