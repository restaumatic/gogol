                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Get '[Core.JSON] HttpsHealthCheck
...
newComputeHttpsHealthChecksGet httpsHealthCheck project
  = ComputeHttpsHealthChecksGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeHttpsHealthChecksGet where
        ...
        type Scopes ComputeHttpsHealthChecksGet =
             '[CloudPlatform'FullControl, Compute'FullControl, Compute'Readonly]
        requestClient ComputeHttpsHealthChecksGet{..}
          = go project httpsHealthCheck xgafv accessToken callback uploadType
              uploadProtocol
