...
newComputeMachineImagesTestIamPermissions payload project resource
  = ComputeMachineImagesTestIamPermissions{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           payload = payload, project = project,
                                           resource = resource, uploadType = Core.Nothing,
                                           uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeMachineImagesTestIamPermissions
         where
        type Rs ComputeMachineImagesTestIamPermissions =
             TestPermissionsResponse
        type Scopes ComputeMachineImagesTestIamPermissions =
