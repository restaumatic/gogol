...
newComputeGlobalForwardingRulesSetLabels payload project resource
  = ComputeGlobalForwardingRulesSetLabels{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          payload = payload, project = project, resource = resource,
                                          uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeGlobalForwardingRulesSetLabels
         where
        type Rs ComputeGlobalForwardingRulesSetLabels = Operation
        type Scopes ComputeGlobalForwardingRulesSetLabels =
