                               ...
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.Get '[Core.JSON] InstanceGroupManagerResizeRequest
...
newComputeInstanceGroupManagerResizeRequestsGet
  ...
  = ComputeInstanceGroupManagerResizeRequestsGet{xgafv =
                                                   Core.Nothing,
                                                 accessToken = Core.Nothing,
                                                 callback = Core.Nothing,
                                                 instanceGroupManager = instanceGroupManager,
                                                 project = project, resizeRequest = resizeRequest,
...
instance Core.GoogleRequest
        ...
        type Scopes ComputeInstanceGroupManagerResizeRequestsGet =
