...
newComputeDisksGet disk project zone
  = ComputeDisksGet{xgafv = Core.Nothing, accessToken = Core.Nothing,
                    callback = Core.Nothing, disk = disk, project = project,
...
instance Core.GoogleRequest ComputeDisksGet where
        ...
        requestClient ComputeDisksGet{..}
          = go project zone disk xgafv accessToken callback uploadType
              uploadProtocol
