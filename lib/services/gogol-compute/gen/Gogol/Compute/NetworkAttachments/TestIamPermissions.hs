...
newComputeNetworkAttachmentsTestIamPermissions 
    ...
    -> ComputeNetworkAttachmentsTestIamPermissions
newComputeNetworkAttachmentsTestIamPermissions payload project
  region resource
  = ComputeNetworkAttachmentsTestIamPermissions{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           ComputeNetworkAttachmentsTestIamPermissions
         where
        type Rs ComputeNetworkAttachmentsTestIamPermissions =
             TestPermissionsResponse
        type Scopes ComputeNetworkAttachmentsTestIamPermissions =
