...
newComputeNetworkAttachmentsGetIamPolicy project region resource
  = ComputeNetworkAttachmentsGetIamPolicy{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeNetworkAttachmentsGetIamPolicy
         where
        type Rs ComputeNetworkAttachmentsGetIamPolicy = Policy
        type Scopes ComputeNetworkAttachmentsGetIamPolicy =
