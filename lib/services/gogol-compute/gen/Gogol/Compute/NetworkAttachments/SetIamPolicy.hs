...
newComputeNetworkAttachmentsSetIamPolicy 
    ...
    -> ComputeNetworkAttachmentsSetIamPolicy
newComputeNetworkAttachmentsSetIamPolicy payload project region
  resource
  = ComputeNetworkAttachmentsSetIamPolicy{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          payload = payload, project = project, region = region,
                                          resource = resource, uploadType = Core.Nothing,
                                          uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeNetworkAttachmentsSetIamPolicy
         where
