...
newComputeNetworkFirewallPoliciesGetRule firewallPolicy project
  = ComputeNetworkFirewallPoliciesGetRule{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          firewallPolicy = firewallPolicy, priority = Core.Nothing,
                                          project = project, uploadType = Core.Nothing,
                                          uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeNetworkFirewallPoliciesGetRule
         where
        type Rs ComputeNetworkFirewallPoliciesGetRule = FirewallPolicyRule
        type Scopes ComputeNetworkFirewallPoliciesGetRule =
