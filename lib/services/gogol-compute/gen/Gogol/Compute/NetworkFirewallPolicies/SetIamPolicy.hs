...
newComputeNetworkFirewallPoliciesSetIamPolicy 
    ...
    -> ComputeNetworkFirewallPoliciesSetIamPolicy
newComputeNetworkFirewallPoliciesSetIamPolicy payload project
  resource
  = ComputeNetworkFirewallPoliciesSetIamPolicy{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes ComputeNetworkFirewallPoliciesSetIamPolicy =
