...
newComputeNetworkFirewallPoliciesGetAssociation 
    ...
    -> ComputeNetworkFirewallPoliciesGetAssociation
newComputeNetworkFirewallPoliciesGetAssociation firewallPolicy
  project
  = ComputeNetworkFirewallPoliciesGetAssociation{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
           ComputeNetworkFirewallPoliciesGetAssociation
         where
        type Rs ComputeNetworkFirewallPoliciesGetAssociation =
             FirewallPolicyAssociation
        type Scopes ComputeNetworkFirewallPoliciesGetAssociation =
