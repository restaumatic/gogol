...
newComputeNetworkFirewallPoliciesTestIamPermissions 
    ...
    -> ComputeNetworkFirewallPoliciesTestIamPermissions
newComputeNetworkFirewallPoliciesTestIamPermissions payload project
  resource
  = ComputeNetworkFirewallPoliciesTestIamPermissions{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           ComputeNetworkFirewallPoliciesTestIamPermissions
         where
        type Rs ComputeNetworkFirewallPoliciesTestIamPermissions =
             TestPermissionsResponse
        type Scopes ComputeNetworkFirewallPoliciesTestIamPermissions =
