...
newComputeRegionAutoscalersGet autoscaler project region
  = ComputeRegionAutoscalersGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeRegionAutoscalersGet where
        ...
        type Scopes ComputeRegionAutoscalersGet =
             '[CloudPlatform'FullControl, Compute'FullControl, Compute'Readonly]
        requestClient ComputeRegionAutoscalersGet{..}
          = go project region autoscaler xgafv accessToken callback
              uploadType
              uploadProtocol
