                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Get '[Core.JSON] TargetGrpcProxy
...
newComputeTargetGrpcProxiesGet project targetGrpcProxy
  = ComputeTargetGrpcProxiesGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeTargetGrpcProxiesGet where
        ...
        type Scopes ComputeTargetGrpcProxiesGet =
             '[CloudPlatform'FullControl, Compute'FullControl, Compute'Readonly]
        requestClient ComputeTargetGrpcProxiesGet{..}
          = go project targetGrpcProxy xgafv accessToken callback uploadType
              uploadProtocol
