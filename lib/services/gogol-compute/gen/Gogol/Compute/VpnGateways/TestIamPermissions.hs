...
newComputeVpnGatewaysTestIamPermissions 
    ...
    -> ComputeVpnGatewaysTestIamPermissions
newComputeVpnGatewaysTestIamPermissions payload project region
  resource
  = ComputeVpnGatewaysTestIamPermissions{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         payload = payload, project = project, region = region,
                                         resource = resource, uploadType = Core.Nothing,
                                         uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeVpnGatewaysTestIamPermissions
         where
