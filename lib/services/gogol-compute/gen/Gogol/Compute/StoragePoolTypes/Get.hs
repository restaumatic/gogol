...
newComputeStoragePoolTypesGet project storagePoolType zone
  = ComputeStoragePoolTypesGet{xgafv = Core.Nothing,
                               accessToken = Core.Nothing, callback = Core.Nothing,
                               project = project, storagePoolType = storagePoolType,
...
instance Core.GoogleRequest ComputeStoragePoolTypesGet where
        ...
        requestClient ComputeStoragePoolTypesGet{..}
          = go project zone storagePoolType xgafv accessToken callback
              uploadType
              uploadProtocol
