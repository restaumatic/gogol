                             ...
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.ReqBody '[Core.JSON] RegionUrlMapsValidateRequest Core.:>
                                     Core.Post '[Core.JSON] UrlMapsValidateResponse
...
newComputeRegionUrlMapsValidate payload project region urlMap
  = ComputeRegionUrlMapsValidate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeRegionUrlMapsValidate where
        ...
        type Scopes ComputeRegionUrlMapsValidate =
             '[CloudPlatform'FullControl, Compute'FullControl]
        requestClient ComputeRegionUrlMapsValidate{..}
          = go project region urlMap xgafv accessToken callback uploadType
              uploadProtocol
