                           ...
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.Get '[Core.JSON] NetworksGetEffectiveFirewallsResponse
...
newComputeNetworksGetEffectiveFirewalls network project
  = ComputeNetworksGetEffectiveFirewalls{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         network = network, project = project,
                                         uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeNetworksGetEffectiveFirewalls
         where
        ...
        requestClient ComputeNetworksGetEffectiveFirewalls{..}
          = go project network xgafv accessToken callback uploadType
              uploadProtocol
