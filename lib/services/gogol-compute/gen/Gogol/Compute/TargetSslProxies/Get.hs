                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Get '[Core.JSON] TargetSslProxy
...
newComputeTargetSslProxiesGet project targetSslProxy
  = ComputeTargetSslProxiesGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeTargetSslProxiesGet where
        ...
        type Scopes ComputeTargetSslProxiesGet =
             '[CloudPlatform'FullControl, Compute'FullControl, Compute'Readonly]
        requestClient ComputeTargetSslProxiesGet{..}
          = go project targetSslProxy xgafv accessToken callback uploadType
              uploadProtocol
