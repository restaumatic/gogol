               ...
               Core.Capture "zone" Core.Text Core.:>
                 "instances" Core.:>
                   Core.Capture "instance" Core.Text Core.:>
                     "getGuestAttributes" Core.:>
                       Core.QueryParam "$.xgafv" Xgafv Core.:>
                         Core.QueryParam "access_token" Core.Text Core.:>
                           Core.QueryParam "callback" Core.Text Core.:>
                             Core.QueryParam "queryPath" Core.Text Core.:>
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "variableKey" Core.Text Core.:>
                                     Core.QueryParam "alt" Core.AltJSON Core.:>
                                       Core.Get '[Core.JSON] GuestAttributes
...
newComputeInstancesGetGuestAttributes instance' project zone
  = ComputeInstancesGetGuestAttributes{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       instance' = instance', project = project,
                                       queryPath = Core.Nothing, uploadType = Core.Nothing,
                                       uploadProtocol = Core.Nothing, variableKey = Core.Nothing,
                                       zone = zone}
instance Core.GoogleRequest ComputeInstancesGetGuestAttributes
         where
        type Rs ComputeInstancesGetGuestAttributes = GuestAttributes
        type Scopes ComputeInstancesGetGuestAttributes =
             '[CloudPlatform'FullControl, Compute'FullControl, Compute'Readonly]
        requestClient ComputeInstancesGetGuestAttributes{..}
          = go project zone instance' xgafv accessToken callback queryPath
              uploadType
              uploadProtocol
              variableKey
