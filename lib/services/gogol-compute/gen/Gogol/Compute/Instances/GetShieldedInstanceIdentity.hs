               ...
               Core.Capture "zone" Core.Text Core.:>
                 "instances" Core.:>
                   Core.Capture "instance" Core.Text Core.:>
                     "getShieldedInstanceIdentity" Core.:>
                             ...
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.Get '[Core.JSON] ShieldedInstanceIdentity
...
newComputeInstancesGetShieldedInstanceIdentity 
    ...
    -> ComputeInstancesGetShieldedInstanceIdentity
newComputeInstancesGetShieldedInstanceIdentity instance' project
  zone
  = ComputeInstancesGetShieldedInstanceIdentity{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           ComputeInstancesGetShieldedInstanceIdentity
         where
        type Rs ComputeInstancesGetShieldedInstanceIdentity =
             ShieldedInstanceIdentity
        type Scopes ComputeInstancesGetShieldedInstanceIdentity =
             '[CloudPlatform'FullControl, Compute'FullControl, Compute'Readonly]
        requestClient ComputeInstancesGetShieldedInstanceIdentity{..}
          = go project zone instance' xgafv accessToken callback uploadType
              uploadProtocol
