                               ...
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.Get '[Core.JSON] InstancesGetEffectiveFirewallsResponse
...
newComputeInstancesGetEffectiveFirewalls 
    ...
    -> ComputeInstancesGetEffectiveFirewalls
newComputeInstancesGetEffectiveFirewalls instance' networkInterface
  project zone
  = ComputeInstancesGetEffectiveFirewalls{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          instance' = instance',
                                          networkInterface = networkInterface, project = project,
                                          uploadType = Core.Nothing, uploadProtocol = Core.Nothing,
                                          zone = zone}
instance Core.GoogleRequest ComputeInstancesGetEffectiveFirewalls
         where
        type Rs ComputeInstancesGetEffectiveFirewalls =
             InstancesGetEffectiveFirewallsResponse
        type Scopes ComputeInstancesGetEffectiveFirewalls =
