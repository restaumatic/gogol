                           ...
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.Get '[Core.JSON] NotificationEndpoint
...
newComputeRegionNotificationEndpointsGet 
    ...
    -> ComputeRegionNotificationEndpointsGet
newComputeRegionNotificationEndpointsGet notificationEndpoint
  project region
  = ComputeRegionNotificationEndpointsGet{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          notificationEndpoint = notificationEndpoint,
                                          project = project, region = region,
                                          uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeRegionNotificationEndpointsGet
         where
        type Rs ComputeRegionNotificationEndpointsGet =
             NotificationEndpoint
        type Scopes ComputeRegionNotificationEndpointsGet =
