...
newComputeRoutersGetNatIpInfo project region router
  = ComputeRoutersGetNatIpInfo{xgafv = Core.Nothing,
                               accessToken = Core.Nothing, callback = Core.Nothing,
                               natName = Core.Nothing, project = project, region = region,
...
instance Core.GoogleRequest ComputeRoutersGetNatIpInfo where
        ...
        requestClient ComputeRoutersGetNatIpInfo{..}
          = go project region router xgafv accessToken callback natName
              uploadType
              uploadProtocol
