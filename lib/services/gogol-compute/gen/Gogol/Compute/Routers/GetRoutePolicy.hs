                               ...
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.Get '[Core.JSON] RoutersGetRoutePolicyResponse
...
newComputeRoutersGetRoutePolicy project region router
  = ComputeRoutersGetRoutePolicy{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputeRoutersGetRoutePolicy where
        type Rs ComputeRoutersGetRoutePolicy =
             RoutersGetRoutePolicyResponse
        type Scopes ComputeRoutersGetRoutePolicy =
