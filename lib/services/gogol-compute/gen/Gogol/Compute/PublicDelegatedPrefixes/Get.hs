...
newComputePublicDelegatedPrefixesGet 
    ...
    -> ComputePublicDelegatedPrefixesGet
newComputePublicDelegatedPrefixesGet project publicDelegatedPrefix
  region
  = ComputePublicDelegatedPrefixesGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ComputePublicDelegatedPrefixesGet where
        ...
        type Scopes ComputePublicDelegatedPrefixesGet =
