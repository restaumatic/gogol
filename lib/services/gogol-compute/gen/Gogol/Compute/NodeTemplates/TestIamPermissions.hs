...
newComputeNodeTemplatesTestIamPermissions 
    ...
    -> ComputeNodeTemplatesTestIamPermissions
newComputeNodeTemplatesTestIamPermissions payload project region
  resource
  = ComputeNodeTemplatesTestIamPermissions{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           payload = payload, project = project, region = region,
                                           resource = resource, uploadType = Core.Nothing,
                                           uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ComputeNodeTemplatesTestIamPermissions
         where
        type Rs ComputeNodeTemplatesTestIamPermissions =
             TestPermissionsResponse
        type Scopes ComputeNodeTemplatesTestIamPermissions =
