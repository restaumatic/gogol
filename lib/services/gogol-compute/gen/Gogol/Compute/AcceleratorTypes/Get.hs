             ...
             "zones" Core.:>
               Core.Capture "zone" Core.Text Core.:>
                 "acceleratorTypes" Core.:>
                   Core.Capture "acceleratorType" Core.Text Core.:>
...
newComputeAcceleratorTypesGet acceleratorType project zone
  = ComputeAcceleratorTypesGet{xgafv = Core.Nothing,
                               acceleratorType = acceleratorType, accessToken = Core.Nothing,
...
instance Core.GoogleRequest ComputeAcceleratorTypesGet where
        ...
        type Scopes ComputeAcceleratorTypesGet =
             '[CloudPlatform'FullControl, Compute'FullControl, Compute'Readonly]
        requestClient ComputeAcceleratorTypesGet{..}
          = go project zone acceleratorType xgafv accessToken callback
              uploadType
              uploadProtocol
