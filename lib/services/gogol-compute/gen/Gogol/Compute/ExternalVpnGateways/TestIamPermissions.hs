...
newComputeExternalVpnGatewaysTestIamPermissions 
    ...
    -> ComputeExternalVpnGatewaysTestIamPermissions
newComputeExternalVpnGatewaysTestIamPermissions payload project
  resource
  = ComputeExternalVpnGatewaysTestIamPermissions{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes ComputeExternalVpnGatewaysTestIamPermissions =
