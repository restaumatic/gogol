...
newAndroidEnterpriseStorelayoutpagesUpdate 
    ...
    -> AndroidEnterpriseStorelayoutpagesUpdate
newAndroidEnterpriseStorelayoutpagesUpdate enterpriseId pageId
  payload
  = AndroidEnterpriseStorelayoutpagesUpdate{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            enterpriseId = enterpriseId, pageId = pageId,
                                            payload = payload, uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AndroidEnterpriseStorelayoutpagesUpdate
         where
