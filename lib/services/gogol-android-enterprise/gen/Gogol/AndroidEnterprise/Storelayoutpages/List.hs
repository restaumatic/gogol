                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] StoreLayoutPagesListResponse
...
newAndroidEnterpriseStorelayoutpagesList enterpriseId
  = AndroidEnterpriseStorelayoutpagesList{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          enterpriseId = enterpriseId, uploadType = Core.Nothing,
                                          uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AndroidEnterpriseStorelayoutpagesList
         where
        type Rs AndroidEnterpriseStorelayoutpagesList =
             StoreLayoutPagesListResponse
        type Scopes AndroidEnterpriseStorelayoutpagesList =
