...
newAndroidEnterpriseStorelayoutclustersInsert 
    ...
    -> AndroidEnterpriseStorelayoutclustersInsert
newAndroidEnterpriseStorelayoutclustersInsert enterpriseId pageId
  payload
  = AndroidEnterpriseStorelayoutclustersInsert{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes AndroidEnterpriseStorelayoutclustersInsert =
