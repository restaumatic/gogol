                           ...
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.Get '[Core.JSON] StoreLayoutClustersListResponse
...
newAndroidEnterpriseStorelayoutclustersList enterpriseId pageId
  = AndroidEnterpriseStorelayoutclustersList{xgafv = Core.Nothing,
                                             accessToken = Core.Nothing, callback = Core.Nothing,
                                             enterpriseId = enterpriseId, pageId = pageId,
                                             uploadType = Core.Nothing,
                                             uploadProtocol = Core.Nothing}
instance Core.GoogleRequest
           AndroidEnterpriseStorelayoutclustersList
         where
        type Rs AndroidEnterpriseStorelayoutclustersList =
             StoreLayoutClustersListResponse
        type Scopes AndroidEnterpriseStorelayoutclustersList =
             '[Androidenterprise'FullControl]
        requestClient AndroidEnterpriseStorelayoutclustersList{..}
          = go enterpriseId pageId xgafv accessToken callback uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AndroidEnterpriseStorelayoutclustersListResource)
                      Core.mempty
