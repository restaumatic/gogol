                               ...
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.ReqBody '[Core.JSON] StoreCluster Core.:>
                                     Core.Put '[Core.JSON] StoreCluster
...
newAndroidEnterpriseStorelayoutclustersUpdate 
    ...
    -> AndroidEnterpriseStorelayoutclustersUpdate
newAndroidEnterpriseStorelayoutclustersUpdate clusterId
  enterpriseId pageId payload
  = AndroidEnterpriseStorelayoutclustersUpdate{xgafv = Core.Nothing,
                                               accessToken = Core.Nothing, callback = Core.Nothing,
                                               clusterId = clusterId, enterpriseId = enterpriseId,
                                               pageId = pageId, payload = payload,
...
instance Core.GoogleRequest
        ...
        type Scopes AndroidEnterpriseStorelayoutclustersUpdate =
