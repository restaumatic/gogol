                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Get '[Core.JSON] GroupLicenseUsersListResponse
...
newAndroidEnterpriseGrouplicenseusersList 
    ...
    -> AndroidEnterpriseGrouplicenseusersList
newAndroidEnterpriseGrouplicenseusersList enterpriseId
  groupLicenseId
  = AndroidEnterpriseGrouplicenseusersList{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           enterpriseId = enterpriseId,
                                           groupLicenseId = groupLicenseId,
                                           uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AndroidEnterpriseGrouplicenseusersList
         where
        type Rs AndroidEnterpriseGrouplicenseusersList =
             GroupLicenseUsersListResponse
        type Scopes AndroidEnterpriseGrouplicenseusersList =
             '[Androidenterprise'FullControl]
        requestClient AndroidEnterpriseGrouplicenseusersList{..}
          = go enterpriseId groupLicenseId xgafv accessToken callback
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AndroidEnterpriseGrouplicenseusersListResource)
                      Core.mempty
