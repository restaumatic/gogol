...
newAndroidEnterpriseEntitlementsDelete 
    ...
    -> AndroidEnterpriseEntitlementsDelete
newAndroidEnterpriseEntitlementsDelete enterpriseId entitlementId
  userId
  = AndroidEnterpriseEntitlementsDelete{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        enterpriseId = enterpriseId, entitlementId = entitlementId,
                                        uploadType = Core.Nothing, uploadProtocol = Core.Nothing,
                                        userId = userId}
instance Core.GoogleRequest AndroidEnterpriseEntitlementsDelete
         where
        ...
        requestClient AndroidEnterpriseEntitlementsDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AndroidEnterpriseEntitlementsDeleteResource)
                      Core.mempty
