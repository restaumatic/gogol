                           ...
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.Get '[Core.JSON] Entitlement
...
newAndroidEnterpriseEntitlementsGet 
    ...
    -> AndroidEnterpriseEntitlementsGet
newAndroidEnterpriseEntitlementsGet enterpriseId entitlementId
  userId
  = AndroidEnterpriseEntitlementsGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest AndroidEnterpriseEntitlementsGet where
        ...
        type Scopes AndroidEnterpriseEntitlementsGet =
