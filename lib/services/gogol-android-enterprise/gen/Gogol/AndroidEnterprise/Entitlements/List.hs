                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Get '[Core.JSON] EntitlementsListResponse
...
newAndroidEnterpriseEntitlementsList enterpriseId userId
  = AndroidEnterpriseEntitlementsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest AndroidEnterpriseEntitlementsList where
        type Rs AndroidEnterpriseEntitlementsList =
             EntitlementsListResponse
        type Scopes AndroidEnterpriseEntitlementsList =
