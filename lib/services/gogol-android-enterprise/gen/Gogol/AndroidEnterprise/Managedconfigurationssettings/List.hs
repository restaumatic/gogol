                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Get '[Core.JSON] ManagedConfigurationsSettingsListResponse
...
newAndroidEnterpriseManagedconfigurationssettingsList 
    ...
    -> AndroidEnterpriseManagedconfigurationssettingsList
newAndroidEnterpriseManagedconfigurationssettingsList enterpriseId
  productId
  = AndroidEnterpriseManagedconfigurationssettingsList{xgafv =
                                                         Core.Nothing,
...
instance Core.GoogleRequest
           AndroidEnterpriseManagedconfigurationssettingsList
         where
        type Rs AndroidEnterpriseManagedconfigurationssettingsList =
             ManagedConfigurationsSettingsListResponse
        type Scopes AndroidEnterpriseManagedconfigurationssettingsList =
             '[Androidenterprise'FullControl]
        requestClient
          AndroidEnterpriseManagedconfigurationssettingsList{..}
          = go enterpriseId productId xgafv accessToken callback uploadType
              uploadProtocol
