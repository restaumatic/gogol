                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Get '[Core.JSON] ManagedConfigurationsForUserListResponse
...
newAndroidEnterpriseManagedconfigurationsforuserList 
    ...
    -> AndroidEnterpriseManagedconfigurationsforuserList
newAndroidEnterpriseManagedconfigurationsforuserList enterpriseId
  userId
  = AndroidEnterpriseManagedconfigurationsforuserList{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           AndroidEnterpriseManagedconfigurationsforuserList
         where
        type Rs AndroidEnterpriseManagedconfigurationsforuserList =
             ManagedConfigurationsForUserListResponse
        type Scopes AndroidEnterpriseManagedconfigurationsforuserList =
