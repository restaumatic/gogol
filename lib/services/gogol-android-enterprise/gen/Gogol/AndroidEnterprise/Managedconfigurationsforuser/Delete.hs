...
newAndroidEnterpriseManagedconfigurationsforuserDelete 
    ...
    -> AndroidEnterpriseManagedconfigurationsforuserDelete
newAndroidEnterpriseManagedconfigurationsforuserDelete enterpriseId
  managedConfigurationForUserId userId
  = AndroidEnterpriseManagedconfigurationsforuserDelete{xgafv =
                                                          Core.Nothing,
...
instance Core.GoogleRequest
           AndroidEnterpriseManagedconfigurationsforuserDelete
         where
        type Rs AndroidEnterpriseManagedconfigurationsforuserDelete = ()
        type Scopes AndroidEnterpriseManagedconfigurationsforuserDelete =
