...
-- |
-- Module      : Gogol.AndroidEnterprise.Managedconfigurationsforuser.Update
             ...
             "users" Core.:>
               Core.Capture "userId" Core.Text Core.:>
                 "managedConfigurationsForUser" Core.:>
                   Core.Capture "managedConfigurationForUserId" Core.Text Core.:>
                           ...
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.ReqBody '[Core.JSON] ManagedConfiguration Core.:>
                                   Core.Put '[Core.JSON] ManagedConfiguration
...
newAndroidEnterpriseManagedconfigurationsforuserUpdate 
    ...
    -> AndroidEnterpriseManagedconfigurationsforuserUpdate
newAndroidEnterpriseManagedconfigurationsforuserUpdate enterpriseId
  managedConfigurationForUserId payload userId
  = AndroidEnterpriseManagedconfigurationsforuserUpdate{xgafv =
                                                          Core.Nothing,
...
instance Core.GoogleRequest
           AndroidEnterpriseManagedconfigurationsforuserUpdate
         where
        type Rs AndroidEnterpriseManagedconfigurationsforuserUpdate =
             ManagedConfiguration
        type Scopes AndroidEnterpriseManagedconfigurationsforuserUpdate =
             '[Androidenterprise'FullControl]
        requestClient
          AndroidEnterpriseManagedconfigurationsforuserUpdate{..}
          = go enterpriseId userId managedConfigurationForUserId xgafv
              accessToken
              callback
              uploadType
              uploadProtocol
