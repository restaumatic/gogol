...
newAndroidEnterpriseManagedconfigurationsforuserGet 
    ...
    -> AndroidEnterpriseManagedconfigurationsforuserGet
newAndroidEnterpriseManagedconfigurationsforuserGet enterpriseId
  managedConfigurationForUserId userId
  = AndroidEnterpriseManagedconfigurationsforuserGet{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           AndroidEnterpriseManagedconfigurationsforuserGet
         where
        type Rs AndroidEnterpriseManagedconfigurationsforuserGet =
             ManagedConfiguration
        type Scopes AndroidEnterpriseManagedconfigurationsforuserGet =
