...
module Gogol.AndroidEnterprise.Internal.Sum
  (
    ...
    -- * EnrollmentTokenGoogleAuthenticationOptions_AuthenticationRequirement
    EnrollmentTokenGoogleAuthenticationOptions_AuthenticationRequirement
      (
        EnrollmentTokenGoogleAuthenticationOptions_AuthenticationRequirement_AuthenticationRequirementUnspecified,
        EnrollmentTokenGoogleAuthenticationOptions_AuthenticationRequirement_Optional,
        EnrollmentTokenGoogleAuthenticationOptions_AuthenticationRequirement_Required,
        ..
      ),
...
newtype EnrollmentTokenGoogleAuthenticationOptions_AuthenticationRequirement = EnrollmentTokenGoogleAuthenticationOptions_AuthenticationRequirement { fromEnrollmentTokenGoogleAuthenticationOptions_AuthenticationRequirement :: Core.Text }
    deriving stock (Core.Show, Core.Read, Core.Eq, Core.Ord, Core.Generic)
    deriving newtype
      ( Core.Hashable
      , Core.ToHttpApiData
...
-- | The value is unused.
pattern EnrollmentTokenGoogleAuthenticationOptions_AuthenticationRequirement_AuthenticationRequirementUnspecified :: EnrollmentTokenGoogleAuthenticationOptions_AuthenticationRequirement
pattern EnrollmentTokenGoogleAuthenticationOptions_AuthenticationRequirement_AuthenticationRequirementUnspecified = EnrollmentTokenGoogleAuthenticationOptions_AuthenticationRequirement "authenticationRequirementUnspecified"
...
pattern EnrollmentTokenGoogleAuthenticationOptions_AuthenticationRequirement_Optional :: EnrollmentTokenGoogleAuthenticationOptions_AuthenticationRequirement
pattern EnrollmentTokenGoogleAuthenticationOptions_AuthenticationRequirement_Optional = EnrollmentTokenGoogleAuthenticationOptions_AuthenticationRequirement "optional"

-- | Google authentication is required for the user. This means the user must authenticate with a Google account to proceed.
pattern EnrollmentTokenGoogleAuthenticationOptions_AuthenticationRequirement_Required :: EnrollmentTokenGoogleAuthenticationOptions_AuthenticationRequirement
pattern EnrollmentTokenGoogleAuthenticationOptions_AuthenticationRequirement_Required = EnrollmentTokenGoogleAuthenticationOptions_AuthenticationRequirement "required"
