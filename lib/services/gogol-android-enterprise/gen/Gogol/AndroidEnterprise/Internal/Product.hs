...
module Gogol.AndroidEnterprise.Internal.Product
  (
    ...
    EnrollmentTokenGoogleAuthenticationOptions (..),
    newEnrollmentTokenGoogleAuthenticationOptions,
...
data EnrollmentToken = EnrollmentToken
    ...
    , googleAuthenticationOptions :: (Core.Maybe EnrollmentTokenGoogleAuthenticationOptions)
...
newEnrollmentToken
  = EnrollmentToken{duration = Core.Nothing,
                    enrollmentTokenType = Core.Nothing,
                    googleAuthenticationOptions = Core.Nothing, token = Core.Nothing}
              ...
              (\ o ->
                 EnrollmentToken Core.<$>
                   (o Core..:? "duration") Core.<*> (o Core..:? "enrollmentTokenType")
                     Core.<*> (o Core..:? "googleAuthenticationOptions")
                     Core.<*> (o Core..:? "token"))
          ...
          = Core.object
              (Core.catMaybes
                 [("duration" Core..=) Core.<$> duration,
                  ...
                  ("googleAuthenticationOptions" Core..=) Core.<$>
...
--
-- /See:/ 'newEnrollmentTokenGoogleAuthenticationOptions' smart constructor.
data EnrollmentTokenGoogleAuthenticationOptions = EnrollmentTokenGoogleAuthenticationOptions
    {
      ...
      authenticationRequirement :: (Core.Maybe
...
-- | Creates a value of 'EnrollmentTokenGoogleAuthenticationOptions' with the minimum fields required to make a request.
newEnrollmentTokenGoogleAuthenticationOptions 
    :: 
                                              EnrollmentTokenGoogleAuthenticationOptions
newEnrollmentTokenGoogleAuthenticationOptions
  = EnrollmentTokenGoogleAuthenticationOptions{authenticationRequirement
                                                 = Core.Nothing,
                                               requiredAccountEmail = Core.Nothing}
instance Core.FromJSON EnrollmentTokenGoogleAuthenticationOptions
         where
        parseJSON
          = Core.withObject "EnrollmentTokenGoogleAuthenticationOptions"
              (\ o ->
                 EnrollmentTokenGoogleAuthenticationOptions Core.<$>
                   (o Core..:? "authenticationRequirement") Core.<*>
                     (o Core..:? "requiredAccountEmail"))

instance Core.ToJSON EnrollmentTokenGoogleAuthenticationOptions
         where
        toJSON EnrollmentTokenGoogleAuthenticationOptions{..}
          = Core.object
              (Core.catMaybes
                 [("authenticationRequirement" Core..=) Core.<$>
