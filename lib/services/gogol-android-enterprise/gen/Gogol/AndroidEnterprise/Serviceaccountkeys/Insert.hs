...
newAndroidEnterpriseServiceaccountkeysInsert enterpriseId payload
  = AndroidEnterpriseServiceaccountkeysInsert{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        requestClient AndroidEnterpriseServiceaccountkeysInsert{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AndroidEnterpriseServiceaccountkeysInsertResource)
                      Core.mempty
