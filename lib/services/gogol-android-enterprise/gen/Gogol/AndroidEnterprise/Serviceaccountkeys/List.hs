                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] ServiceAccountKeysListResponse
...
newAndroidEnterpriseServiceaccountkeysList enterpriseId
  = AndroidEnterpriseServiceaccountkeysList{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            enterpriseId = enterpriseId, uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AndroidEnterpriseServiceaccountkeysList
         where
        type Rs AndroidEnterpriseServiceaccountkeysList =
             ServiceAccountKeysListResponse
        type Scopes AndroidEnterpriseServiceaccountkeysList =
             '[Androidenterprise'FullControl]
        requestClient AndroidEnterpriseServiceaccountkeysList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AndroidEnterpriseServiceaccountkeysListResource)
                      Core.mempty
