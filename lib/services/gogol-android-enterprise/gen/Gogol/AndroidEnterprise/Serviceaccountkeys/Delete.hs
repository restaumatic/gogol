         ...
         "enterprises" Core.:>
           Core.Capture "enterpriseId" Core.Text Core.:>
             "serviceAccountKeys" Core.:>
               Core.Capture "keyId" Core.Text Core.:>
...
newAndroidEnterpriseServiceaccountkeysDelete enterpriseId keyId
  = AndroidEnterpriseServiceaccountkeysDelete{xgafv = Core.Nothing,
                                              accessToken = Core.Nothing, callback = Core.Nothing,
                                              enterpriseId = enterpriseId, keyId = keyId,
...
instance Core.GoogleRequest
        ...
        requestClient AndroidEnterpriseServiceaccountkeysDelete{..}
          = go enterpriseId keyId xgafv accessToken callback uploadType
              uploadProtocol
