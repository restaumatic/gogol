...
newAndroidEnterpriseWebappsInsert enterpriseId payload
  = AndroidEnterpriseWebappsInsert{xgafv = Core.Nothing,
                                   accessToken = Core.Nothing, callback = Core.Nothing,
                                   enterpriseId = enterpriseId, payload = payload,
                                   uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AndroidEnterpriseWebappsInsert where
        ...
        requestClient AndroidEnterpriseWebappsInsert{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy AndroidEnterpriseWebappsInsertResource)
                      Core.mempty
