...
newAndroidEnterpriseWebappsUpdate enterpriseId payload webAppId
  = AndroidEnterpriseWebappsUpdate{xgafv = Core.Nothing,
                                   accessToken = Core.Nothing, callback = Core.Nothing,
                                   enterpriseId = enterpriseId, payload = payload,
                                   uploadType = Core.Nothing, uploadProtocol = Core.Nothing,
                                   webAppId = webAppId}
instance Core.GoogleRequest AndroidEnterpriseWebappsUpdate where
        type Rs AndroidEnterpriseWebappsUpdate = WebApp
        type Scopes AndroidEnterpriseWebappsUpdate =
        ...
        requestClient AndroidEnterpriseWebappsUpdate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy AndroidEnterpriseWebappsUpdateResource)
                      Core.mempty
