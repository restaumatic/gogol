                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] GroupLicense
...
newAndroidEnterpriseGrouplicensesGet enterpriseId groupLicenseId
  = AndroidEnterpriseGrouplicensesGet{xgafv = Core.Nothing,
                                      accessToken = Core.Nothing, callback = Core.Nothing,
                                      enterpriseId = enterpriseId, groupLicenseId = groupLicenseId,
                                      uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AndroidEnterpriseGrouplicensesGet where
        type Rs AndroidEnterpriseGrouplicensesGet = GroupLicense
        type Scopes AndroidEnterpriseGrouplicensesGet =
