...
newAndroidEnterpriseGrouplicensesList enterpriseId
  = AndroidEnterpriseGrouplicensesList{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       enterpriseId = enterpriseId, uploadType = Core.Nothing,
                                       uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AndroidEnterpriseGrouplicensesList
         where
        ...
        requestClient AndroidEnterpriseGrouplicensesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AndroidEnterpriseGrouplicensesListResource)
                      Core.mempty
