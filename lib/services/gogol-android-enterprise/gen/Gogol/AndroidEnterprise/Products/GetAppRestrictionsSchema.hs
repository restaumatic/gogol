                           ...
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.Get '[Core.JSON] AppRestrictionsSchema
...
newAndroidEnterpriseProductsGetAppRestrictionsSchema 
    ...
    -> AndroidEnterpriseProductsGetAppRestrictionsSchema
newAndroidEnterpriseProductsGetAppRestrictionsSchema enterpriseId
  productId
  = AndroidEnterpriseProductsGetAppRestrictionsSchema{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           AndroidEnterpriseProductsGetAppRestrictionsSchema
         where
        type Rs AndroidEnterpriseProductsGetAppRestrictionsSchema =
             AppRestrictionsSchema
        type Scopes AndroidEnterpriseProductsGetAppRestrictionsSchema =
             '[Androidenterprise'FullControl]
        requestClient AndroidEnterpriseProductsGetAppRestrictionsSchema{..}
          = go enterpriseId productId xgafv accessToken callback language
              uploadType
              uploadProtocol
