...
newAndroidEnterpriseProductsUnapprove enterpriseId productId
  = AndroidEnterpriseProductsUnapprove{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       enterpriseId = enterpriseId, productId = productId,
                                       uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AndroidEnterpriseProductsUnapprove
         where
        type Rs AndroidEnterpriseProductsUnapprove = ()
        type Scopes AndroidEnterpriseProductsUnapprove =
        ...
        requestClient AndroidEnterpriseProductsUnapprove{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AndroidEnterpriseProductsUnapproveResource)
                      Core.mempty
