...
newAndroidEnterpriseProductsList enterpriseId
  = AndroidEnterpriseProductsList{xgafv = Core.Nothing,
                                  accessToken = Core.Nothing, approved = Core.Nothing,
                                  callback = Core.Nothing, enterpriseId = enterpriseId,
                                  language = Core.Nothing, maxResults = Core.Nothing,
                                  query = Core.Nothing, token = Core.Nothing,
                                  uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AndroidEnterpriseProductsList where
        type Rs AndroidEnterpriseProductsList = ProductsListResponse
        type Scopes AndroidEnterpriseProductsList =
             '[Androidenterprise'FullControl]
        requestClient AndroidEnterpriseProductsList{..}
          = go enterpriseId xgafv accessToken approved callback language
              maxResults
              query
              token
              uploadType
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy AndroidEnterpriseProductsListResource)
                      Core.mempty
