...
newAndroidEnterpriseEnterprisesUnenroll enterpriseId
  = AndroidEnterpriseEnterprisesUnenroll{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         enterpriseId = enterpriseId, uploadType = Core.Nothing,
                                         uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AndroidEnterpriseEnterprisesUnenroll
         where
        type Rs AndroidEnterpriseEnterprisesUnenroll = ()
        type Scopes AndroidEnterpriseEnterprisesUnenroll =
             '[Androidenterprise'FullControl]
        requestClient AndroidEnterpriseEnterprisesUnenroll{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AndroidEnterpriseEnterprisesUnenrollResource)
                      Core.mempty
