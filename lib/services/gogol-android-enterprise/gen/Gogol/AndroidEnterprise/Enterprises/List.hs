                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.Get '[Core.JSON] EnterprisesListResponse
...
newAndroidEnterpriseEnterprisesList domain
  = AndroidEnterpriseEnterprisesList{xgafv = Core.Nothing,
                                     accessToken = Core.Nothing, callback = Core.Nothing,
                                     domain = domain, uploadType = Core.Nothing,
                                     uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AndroidEnterpriseEnterprisesList where
        type Rs AndroidEnterpriseEnterprisesList = EnterprisesListResponse
        type Scopes AndroidEnterpriseEnterprisesList =
             '[Androidenterprise'FullControl]
        requestClient AndroidEnterpriseEnterprisesList{..}
          = go (Core.Just domain) xgafv accessToken callback uploadType
              uploadProtocol
              (Core.Just Core.AltJSON)
              androidEnterpriseService
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy AndroidEnterpriseEnterprisesListResource)
                      Core.mempty
