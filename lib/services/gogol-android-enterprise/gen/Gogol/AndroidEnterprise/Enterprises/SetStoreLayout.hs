                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] StoreLayout Core.:>
                             Core.Put '[Core.JSON] StoreLayout
...
newAndroidEnterpriseEnterprisesSetStoreLayout enterpriseId payload
  = AndroidEnterpriseEnterprisesSetStoreLayout{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           AndroidEnterpriseEnterprisesSetStoreLayout
         where
        type Rs AndroidEnterpriseEnterprisesSetStoreLayout = StoreLayout
        type Scopes AndroidEnterpriseEnterprisesSetStoreLayout =
             '[Androidenterprise'FullControl]
        requestClient AndroidEnterpriseEnterprisesSetStoreLayout{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AndroidEnterpriseEnterprisesSetStoreLayoutResource)
                      Core.mempty
