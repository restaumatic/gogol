               ...
               Core.QueryParam "$.xgafv" Xgafv Core.:>
                 Core.QueryParam "access_token" Core.Text Core.:>
                   Core.QueryParam "callback" Core.Text Core.:>
                     Core.QueryParam "keyType" EnterprisesGetServiceAccountKeyType
                       Core.:>
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] ServiceAccount
...
newAndroidEnterpriseEnterprisesGetServiceAccount enterpriseId
  = AndroidEnterpriseEnterprisesGetServiceAccount{xgafv =
                                                    Core.Nothing,
                                                  accessToken = Core.Nothing,
                                                  callback = Core.Nothing,
                                                  enterpriseId = enterpriseId,
                                                  keyType = Core.Nothing, uploadType = Core.Nothing,
                                                  uploadProtocol = Core.Nothing}
instance Core.GoogleRequest
           AndroidEnterpriseEnterprisesGetServiceAccount
         where
        type Rs AndroidEnterpriseEnterprisesGetServiceAccount =
             ServiceAccount
        type Scopes AndroidEnterpriseEnterprisesGetServiceAccount =
             '[Androidenterprise'FullControl]
        requestClient AndroidEnterpriseEnterprisesGetServiceAccount{..}
          = go enterpriseId xgafv accessToken callback keyType uploadType
              uploadProtocol
