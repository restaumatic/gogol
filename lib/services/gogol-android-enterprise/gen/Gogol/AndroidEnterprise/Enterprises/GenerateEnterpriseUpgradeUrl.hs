       ...
       "v1" Core.:>
         "enterprises" Core.:>
           Core.Capture "enterpriseId" Core.Text Core.:>
             "generateEnterpriseUpgradeUrl" Core.:>
               Core.QueryParam "$.xgafv" Xgafv Core.:>
                 Core.QueryParam "access_token" Core.Text Core.:>
                   Core.QueryParam "adminEmail" Core.Text Core.:>
                     Core.QueryParams "allowedDomains" Core.Text Core.:>
                       Core.QueryParam "callback" Core.Text Core.:>
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Post '[Core.JSON] GenerateEnterpriseUpgradeUrlResponse
...
newAndroidEnterpriseEnterprisesGenerateEnterpriseUpgradeUrl
  enterpriseId
  = AndroidEnterpriseEnterprisesGenerateEnterpriseUpgradeUrl{xgafv =
                                                               Core.Nothing,
...
instance Core.GoogleRequest
           AndroidEnterpriseEnterprisesGenerateEnterpriseUpgradeUrl
         where
        type Rs AndroidEnterpriseEnterprisesGenerateEnterpriseUpgradeUrl =
        ...
        requestClient
          AndroidEnterpriseEnterprisesGenerateEnterpriseUpgradeUrl{..}
          = go enterpriseId xgafv accessToken adminEmail
