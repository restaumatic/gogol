...
type AndroidEnterpriseEnterprisesAcknowledgeNotificationSetResource
     ...
     "androidenterprise" Core.:>
       "v1" Core.:>
         "enterprises" Core.:>
           "acknowledgeNotificationSet" Core.:>
             Core.QueryParam "$.xgafv" Xgafv Core.:>
               Core.QueryParam "access_token" Core.Text Core.:>
                 Core.QueryParam "callback" Core.Text Core.:>
                   Core.QueryParam "notificationSetId" Core.Text Core.:>
...
newAndroidEnterpriseEnterprisesAcknowledgeNotificationSet 
    :: 
                                                          AndroidEnterpriseEnterprisesAcknowledgeNotificationSet
newAndroidEnterpriseEnterprisesAcknowledgeNotificationSet
  = AndroidEnterpriseEnterprisesAcknowledgeNotificationSet{xgafv =
                                                             Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes AndroidEnterpriseEnterprisesAcknowledgeNotificationSet
             = '[Androidenterprise'FullControl]
        requestClient
          AndroidEnterpriseEnterprisesAcknowledgeNotificationSet{..}
          = go xgafv accessToken callback notificationSetId uploadType
              uploadProtocol
