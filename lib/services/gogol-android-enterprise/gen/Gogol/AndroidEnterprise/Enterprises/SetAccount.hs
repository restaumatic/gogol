...
-- |
-- Module      : Gogol.AndroidEnterprise.Enterprises.SetAccount
                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] EnterpriseAccount Core.:>
                             Core.Put '[Core.JSON] EnterpriseAccount
...
newAndroidEnterpriseEnterprisesSetAccount enterpriseId payload
  = AndroidEnterpriseEnterprisesSetAccount{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           enterpriseId = enterpriseId, payload = payload,
                                           uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AndroidEnterpriseEnterprisesSetAccount
         where
        type Rs AndroidEnterpriseEnterprisesSetAccount = EnterpriseAccount
        type Scopes AndroidEnterpriseEnterprisesSetAccount =
             '[Androidenterprise'FullControl]
        requestClient AndroidEnterpriseEnterprisesSetAccount{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AndroidEnterpriseEnterprisesSetAccountResource)
                      Core.mempty
