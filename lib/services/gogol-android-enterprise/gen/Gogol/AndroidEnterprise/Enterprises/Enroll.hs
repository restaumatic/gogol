...
newAndroidEnterpriseEnterprisesEnroll payload token
  = AndroidEnterpriseEnterprisesEnroll{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       payload = payload, token = token, uploadType = Core.Nothing,
                                       uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AndroidEnterpriseEnterprisesEnroll
         where
        type Rs AndroidEnterpriseEnterprisesEnroll = Enterprise
        type Scopes AndroidEnterpriseEnterprisesEnroll =
             '[Androidenterprise'FullControl]
        requestClient AndroidEnterpriseEnterprisesEnroll{..}
          = go (Core.Just token) xgafv accessToken callback uploadType
              uploadProtocol
