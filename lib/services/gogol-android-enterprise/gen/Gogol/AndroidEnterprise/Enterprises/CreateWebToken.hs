                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] AdministratorWebTokenSpec Core.:>
...
newAndroidEnterpriseEnterprisesCreateWebToken enterpriseId payload
  = AndroidEnterpriseEnterprisesCreateWebToken{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes AndroidEnterpriseEnterprisesCreateWebToken =
             '[Androidenterprise'FullControl]
        requestClient AndroidEnterpriseEnterprisesCreateWebToken{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AndroidEnterpriseEnterprisesCreateWebTokenResource)
                      Core.mempty
