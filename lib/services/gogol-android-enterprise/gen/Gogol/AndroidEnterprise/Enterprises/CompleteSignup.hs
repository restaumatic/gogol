...
newAndroidEnterpriseEnterprisesCompleteSignup 
    :: 
                                              AndroidEnterpriseEnterprisesCompleteSignup
newAndroidEnterpriseEnterprisesCompleteSignup
  = AndroidEnterpriseEnterprisesCompleteSignup{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           AndroidEnterpriseEnterprisesCompleteSignup
         where
        type Rs AndroidEnterpriseEnterprisesCompleteSignup = Enterprise
        type Scopes AndroidEnterpriseEnterprisesCompleteSignup =
             '[Androidenterprise'FullControl]
        requestClient AndroidEnterpriseEnterprisesCompleteSignup{..}
          = go xgafv accessToken callback completionToken enterpriseToken
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AndroidEnterpriseEnterprisesCompleteSignupResource)
                      Core.mempty
