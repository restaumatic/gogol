                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Post '[Core.JSON] EnterprisesSendTestPushNotificationResponse
...
newAndroidEnterpriseEnterprisesSendTestPushNotification
  enterpriseId
  = AndroidEnterpriseEnterprisesSendTestPushNotification{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           AndroidEnterpriseEnterprisesSendTestPushNotification
         where
        type Rs AndroidEnterpriseEnterprisesSendTestPushNotification =
             EnterprisesSendTestPushNotificationResponse
        type Scopes AndroidEnterpriseEnterprisesSendTestPushNotification =
