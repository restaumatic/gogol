...
newAndroidEnterpriseEnterprisesPullNotificationSet 
    :: 
                                                   AndroidEnterpriseEnterprisesPullNotificationSet
newAndroidEnterpriseEnterprisesPullNotificationSet
  = AndroidEnterpriseEnterprisesPullNotificationSet{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Rs AndroidEnterpriseEnterprisesPullNotificationSet =
             NotificationSet
        type Scopes AndroidEnterpriseEnterprisesPullNotificationSet =
             '[Androidenterprise'FullControl]
        requestClient AndroidEnterpriseEnterprisesPullNotificationSet{..}
          = go xgafv accessToken callback requestMode uploadType
              uploadProtocol
