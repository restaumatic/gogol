                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Post '[Core.JSON] AuthenticationToken
...
newAndroidEnterpriseUsersGenerateAuthenticationToken 
    ...
    -> AndroidEnterpriseUsersGenerateAuthenticationToken
newAndroidEnterpriseUsersGenerateAuthenticationToken enterpriseId
  userId
  = AndroidEnterpriseUsersGenerateAuthenticationToken{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           AndroidEnterpriseUsersGenerateAuthenticationToken
         where
        type Rs AndroidEnterpriseUsersGenerateAuthenticationToken =
             AuthenticationToken
        type Scopes AndroidEnterpriseUsersGenerateAuthenticationToken =
             '[Androidenterprise'FullControl]
        requestClient AndroidEnterpriseUsersGenerateAuthenticationToken{..}
          = go enterpriseId userId xgafv accessToken callback uploadType
              uploadProtocol
