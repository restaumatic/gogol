...
newAndroidEnterpriseUsersUpdate enterpriseId payload userId
  = AndroidEnterpriseUsersUpdate{xgafv = Core.Nothing,
                                 accessToken = Core.Nothing, callback = Core.Nothing,
                                 enterpriseId = enterpriseId, payload = payload,
                                 uploadType = Core.Nothing, uploadProtocol = Core.Nothing,
                                 userId = userId}
instance Core.GoogleRequest AndroidEnterpriseUsersUpdate where
        ...
        requestClient AndroidEnterpriseUsersUpdate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy AndroidEnterpriseUsersUpdateResource)
                      Core.mempty
