       ...
       "v1" Core.:>
         "enterprises" Core.:>
           Core.Capture "enterpriseId" Core.Text Core.:>
             "users" Core.:>
               Core.QueryParam "email" Core.Text Core.:>
...
newAndroidEnterpriseUsersList email enterpriseId
  = AndroidEnterpriseUsersList{xgafv = Core.Nothing,
                               accessToken = Core.Nothing, callback = Core.Nothing, email = email,
...
instance Core.GoogleRequest AndroidEnterpriseUsersList where
        ...
        type Scopes AndroidEnterpriseUsersList =
             '[Androidenterprise'FullControl]
        requestClient AndroidEnterpriseUsersList{..}
          = go enterpriseId (Core.Just email) xgafv accessToken callback
              uploadType
              uploadProtocol
