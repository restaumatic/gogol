...
newAndroidEnterpriseUsersSetAvailableProductSet 
    ...
    -> AndroidEnterpriseUsersSetAvailableProductSet
newAndroidEnterpriseUsersSetAvailableProductSet enterpriseId
  payload userId
  = AndroidEnterpriseUsersSetAvailableProductSet{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
           AndroidEnterpriseUsersSetAvailableProductSet
         where
        type Rs AndroidEnterpriseUsersSetAvailableProductSet = ProductSet
        type Scopes AndroidEnterpriseUsersSetAvailableProductSet =
             '[Androidenterprise'FullControl]
        requestClient AndroidEnterpriseUsersSetAvailableProductSet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AndroidEnterpriseUsersSetAvailableProductSetResource)
                      Core.mempty
