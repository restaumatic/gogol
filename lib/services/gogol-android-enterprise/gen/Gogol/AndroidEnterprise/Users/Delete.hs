...
newAndroidEnterpriseUsersDelete enterpriseId userId
  = AndroidEnterpriseUsersDelete{xgafv = Core.Nothing,
                                 accessToken = Core.Nothing, callback = Core.Nothing,
                                 enterpriseId = enterpriseId, uploadType = Core.Nothing,
                                 uploadProtocol = Core.Nothing, userId = userId}
instance Core.GoogleRequest AndroidEnterpriseUsersDelete where
        ...
        requestClient AndroidEnterpriseUsersDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy AndroidEnterpriseUsersDeleteResource)
                      Core.mempty
