...
newAndroidEnterpriseDevicesForceReportUpload 
    ...
    -> AndroidEnterpriseDevicesForceReportUpload
newAndroidEnterpriseDevicesForceReportUpload deviceId enterpriseId
  userId
  = AndroidEnterpriseDevicesForceReportUpload{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        requestClient AndroidEnterpriseDevicesForceReportUpload{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AndroidEnterpriseDevicesForceReportUploadResource)
                      Core.mempty
