...
-- |
-- Module      : Gogol.AndroidEnterprise.Devices.GetState
                             ...
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.Get '[Core.JSON] DeviceState
...
newAndroidEnterpriseDevicesGetState deviceId enterpriseId userId
  = AndroidEnterpriseDevicesGetState{xgafv = Core.Nothing,
                                     accessToken = Core.Nothing, callback = Core.Nothing,
                                     deviceId = deviceId, enterpriseId = enterpriseId,
                                     uploadType = Core.Nothing, uploadProtocol = Core.Nothing,
                                     userId = userId}
instance Core.GoogleRequest AndroidEnterpriseDevicesGetState where
        type Rs AndroidEnterpriseDevicesGetState = DeviceState
        type Scopes AndroidEnterpriseDevicesGetState =
        ...
        requestClient AndroidEnterpriseDevicesGetState{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy AndroidEnterpriseDevicesGetStateResource)
                      Core.mempty
