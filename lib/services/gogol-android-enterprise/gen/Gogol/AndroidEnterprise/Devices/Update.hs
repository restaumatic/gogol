                     ...
                     Core.QueryParam "$.xgafv" Xgafv Core.:>
                       Core.QueryParam "access_token" Core.Text Core.:>
                         Core.QueryParam "callback" Core.Text Core.:>
                           Core.QueryParam "updateMask" Core.Text Core.:>
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.ReqBody '[Core.JSON] Device Core.:>
                                     Core.Put '[Core.JSON] Device
...
newAndroidEnterpriseDevicesUpdate 
    ...
    -> AndroidEnterpriseDevicesUpdate
newAndroidEnterpriseDevicesUpdate deviceId enterpriseId payload
  userId
  = AndroidEnterpriseDevicesUpdate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest AndroidEnterpriseDevicesUpdate where
        ...
        type Scopes AndroidEnterpriseDevicesUpdate =
