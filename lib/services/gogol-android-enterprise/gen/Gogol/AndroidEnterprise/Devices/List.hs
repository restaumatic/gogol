...
newAndroidEnterpriseDevicesList enterpriseId userId
  = AndroidEnterpriseDevicesList{xgafv = Core.Nothing,
                                 accessToken = Core.Nothing, callback = Core.Nothing,
                                 enterpriseId = enterpriseId, uploadType = Core.Nothing,
                                 uploadProtocol = Core.Nothing, userId = userId}
instance Core.GoogleRequest AndroidEnterpriseDevicesList where
        type Rs AndroidEnterpriseDevicesList = DevicesListResponse
        ...
        requestClient AndroidEnterpriseDevicesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy AndroidEnterpriseDevicesListResource)
                      Core.mempty
