                             ...
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.ReqBody '[Core.JSON] DeviceState Core.:>
                                     Core.Put '[Core.JSON] DeviceState
...
newAndroidEnterpriseDevicesSetState 
    ...
    -> AndroidEnterpriseDevicesSetState
newAndroidEnterpriseDevicesSetState deviceId enterpriseId payload
  userId
  = AndroidEnterpriseDevicesSetState{xgafv = Core.Nothing,
...
instance Core.GoogleRequest AndroidEnterpriseDevicesSetState where
        type Rs AndroidEnterpriseDevicesSetState = DeviceState
        type Scopes AndroidEnterpriseDevicesSetState =
             '[Androidenterprise'FullControl]
        requestClient AndroidEnterpriseDevicesSetState{..}
          = go enterpriseId userId deviceId xgafv accessToken callback
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy AndroidEnterpriseDevicesSetStateResource)
                      Core.mempty
