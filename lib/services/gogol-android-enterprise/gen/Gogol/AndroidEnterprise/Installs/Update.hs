                               ...
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.ReqBody '[Core.JSON] Install Core.:>
                                       Core.Put '[Core.JSON] Install
...
newAndroidEnterpriseInstallsUpdate 
    ...
    -> AndroidEnterpriseInstallsUpdate
newAndroidEnterpriseInstallsUpdate deviceId enterpriseId installId
  payload userId
  = AndroidEnterpriseInstallsUpdate{xgafv = Core.Nothing,
                                    accessToken = Core.Nothing, callback = Core.Nothing,
                                    deviceId = deviceId, enterpriseId = enterpriseId,
                                    installId = installId, payload = payload,
                                    uploadType = Core.Nothing, uploadProtocol = Core.Nothing,
                                    userId = userId}
instance Core.GoogleRequest AndroidEnterpriseInstallsUpdate where
        type Rs AndroidEnterpriseInstallsUpdate = Install
        type Scopes AndroidEnterpriseInstallsUpdate =
        ...
        requestClient AndroidEnterpriseInstallsUpdate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy AndroidEnterpriseInstallsUpdateResource)
                      Core.mempty
