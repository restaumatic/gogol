...
newAndroidEnterpriseInstallsDelete 
    ...
    -> AndroidEnterpriseInstallsDelete
newAndroidEnterpriseInstallsDelete deviceId enterpriseId installId
  userId
  = AndroidEnterpriseInstallsDelete{xgafv = Core.Nothing,
...
instance Core.GoogleRequest AndroidEnterpriseInstallsDelete where
        ...
        requestClient AndroidEnterpriseInstallsDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy AndroidEnterpriseInstallsDeleteResource)
                      Core.mempty
