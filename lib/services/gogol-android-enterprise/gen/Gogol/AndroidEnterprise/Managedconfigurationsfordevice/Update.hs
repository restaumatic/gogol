...
newAndroidEnterpriseManagedconfigurationsfordeviceUpdate 
    ...
    -> AndroidEnterpriseManagedconfigurationsfordeviceUpdate
newAndroidEnterpriseManagedconfigurationsfordeviceUpdate deviceId
  enterpriseId managedConfigurationForDeviceId payload userId
  = AndroidEnterpriseManagedconfigurationsfordeviceUpdate{xgafv =
                                                            Core.Nothing,
...
instance Core.GoogleRequest
           AndroidEnterpriseManagedconfigurationsfordeviceUpdate
         where
        type Rs AndroidEnterpriseManagedconfigurationsfordeviceUpdate =
             ManagedConfiguration
        type Scopes AndroidEnterpriseManagedconfigurationsfordeviceUpdate =
