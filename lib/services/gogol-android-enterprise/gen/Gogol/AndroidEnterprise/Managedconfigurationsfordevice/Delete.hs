...
newAndroidEnterpriseManagedconfigurationsfordeviceDelete 
    ...
    -> AndroidEnterpriseManagedconfigurationsfordeviceDelete
newAndroidEnterpriseManagedconfigurationsfordeviceDelete deviceId
  enterpriseId managedConfigurationForDeviceId userId
  = AndroidEnterpriseManagedconfigurationsfordeviceDelete{xgafv =
                                                            Core.Nothing,
...
instance Core.GoogleRequest
           AndroidEnterpriseManagedconfigurationsfordeviceDelete
         where
        type Rs AndroidEnterpriseManagedconfigurationsfordeviceDelete = ()
        type Scopes AndroidEnterpriseManagedconfigurationsfordeviceDelete =
