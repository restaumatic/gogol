                             ...
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.Get '[Core.JSON] ManagedConfigurationsForDeviceListResponse
...
newAndroidEnterpriseManagedconfigurationsfordeviceList 
    ...
    -> AndroidEnterpriseManagedconfigurationsfordeviceList
newAndroidEnterpriseManagedconfigurationsfordeviceList deviceId
  enterpriseId userId
  = AndroidEnterpriseManagedconfigurationsfordeviceList{xgafv =
                                                          Core.Nothing,
...
instance Core.GoogleRequest
           AndroidEnterpriseManagedconfigurationsfordeviceList
         where
        type Rs AndroidEnterpriseManagedconfigurationsfordeviceList =
             ManagedConfigurationsForDeviceListResponse
        type Scopes AndroidEnterpriseManagedconfigurationsfordeviceList =
