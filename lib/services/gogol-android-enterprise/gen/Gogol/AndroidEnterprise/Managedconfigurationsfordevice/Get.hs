...
-- |
-- Module      : Gogol.AndroidEnterprise.Managedconfigurationsfordevice.Get
                 ...
                 "devices" Core.:>
                   Core.Capture "deviceId" Core.Text Core.:>
                     "managedConfigurationsForDevice" Core.:>
                       Core.Capture "managedConfigurationForDeviceId" Core.Text Core.:>
                               ...
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.Get '[Core.JSON] ManagedConfiguration
...
newAndroidEnterpriseManagedconfigurationsfordeviceGet 
    ...
    -> AndroidEnterpriseManagedconfigurationsfordeviceGet
newAndroidEnterpriseManagedconfigurationsfordeviceGet deviceId
  enterpriseId managedConfigurationForDeviceId userId
  = AndroidEnterpriseManagedconfigurationsfordeviceGet{xgafv =
                                                         Core.Nothing,
                                                       accessToken = Core.Nothing,
                                                       callback = Core.Nothing, deviceId = deviceId,
...
instance Core.GoogleRequest
           AndroidEnterpriseManagedconfigurationsfordeviceGet
         where
        type Rs AndroidEnterpriseManagedconfigurationsfordeviceGet =
             ManagedConfiguration
        type Scopes AndroidEnterpriseManagedconfigurationsfordeviceGet =
             '[Androidenterprise'FullControl]
        requestClient
          AndroidEnterpriseManagedconfigurationsfordeviceGet{..}
          = go enterpriseId userId deviceId managedConfigurationForDeviceId
              xgafv
              accessToken
              callback
              uploadType
