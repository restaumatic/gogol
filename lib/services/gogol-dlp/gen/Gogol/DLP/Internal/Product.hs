...
module Gogol.DLP.Internal.Product
  (
    ...
    GooglePrivacyDlpV2DocumentFallbackLocation (..),
    newGooglePrivacyDlpV2DocumentFallbackLocation,
    ...
    GooglePrivacyDlpV2LocationSupport (..),
    newGooglePrivacyDlpV2LocationSupport,
    ...
    GooglePrivacyDlpV2PublishFindingsToDataplexCatalog (..),
    newGooglePrivacyDlpV2PublishFindingsToDataplexCatalog,
    ...
    GooglePrivacyDlpV2TagFilter (..),
    newGooglePrivacyDlpV2TagFilter,

    -- * GooglePrivacyDlpV2TagFilters
    GooglePrivacyDlpV2TagFilters (..),
    newGooglePrivacyDlpV2TagFilters,
...
data GooglePrivacyDlpV2Action = GooglePrivacyDlpV2Action
    ...
    , publishFindingsToDataplexCatalog :: (Core.Maybe GooglePrivacyDlpV2PublishFindingsToDataplexCatalog)
...
newGooglePrivacyDlpV2Action
  = GooglePrivacyDlpV2Action{deidentify = Core.Nothing,
                             ...
                             publishFindingsToDataplexCatalog = Core.Nothing,
              ...
              (\ o ->
                 GooglePrivacyDlpV2Action Core.<$>
                   (o Core..:? "deidentify") Core.<*>
                     ...
                     Core.<*> (o Core..:? "publishFindingsToDataplexCatalog")
          ...
          = Core.object
              (Core.catMaybes
                 [("deidentify" Core..=) Core.<$> deidentify,
                  ...
                  ("publishFindingsToDataplexCatalog" Core..=) Core.<$>
...
--
-- /See:/ 'newGooglePrivacyDlpV2DocumentFallbackLocation' smart constructor.
data GooglePrivacyDlpV2DocumentFallbackLocation = GooglePrivacyDlpV2DocumentFallbackLocation
    {
...
-- | Creates a value of 'GooglePrivacyDlpV2DocumentFallbackLocation' with the minimum fields required to make a request.
newGooglePrivacyDlpV2DocumentFallbackLocation 
    :: 
                                              GooglePrivacyDlpV2DocumentFallbackLocation
newGooglePrivacyDlpV2DocumentFallbackLocation
  = GooglePrivacyDlpV2DocumentFallbackLocation{globalProcessing =
                                                 Core.Nothing,
                                               multiRegionProcessing = Core.Nothing}
instance Core.FromJSON GooglePrivacyDlpV2DocumentFallbackLocation
         where
        parseJSON
          = Core.withObject "GooglePrivacyDlpV2DocumentFallbackLocation"
              (\ o ->
                 GooglePrivacyDlpV2DocumentFallbackLocation Core.<$>
                   (o Core..:? "globalProcessing") Core.<*>
                     (o Core..:? "multiRegionProcessing"))

instance Core.ToJSON GooglePrivacyDlpV2DocumentFallbackLocation
         where
        toJSON GooglePrivacyDlpV2DocumentFallbackLocation{..}
          = Core.object
              (Core.catMaybes
...
--
-- /See:/ 'newGooglePrivacyDlpV2Domain' smart constructor.
data GooglePrivacyDlpV2Domain = GooglePrivacyDlpV2Domain
    {
      -- | A domain category that this profile is related to.
      category :: (Core.Maybe GooglePrivacyDlpV2Domain_Category)
      -- | The collection of signals that influenced selection of the category.
    , signals :: (Core.Maybe [GooglePrivacyDlpV2Domain_SignalsItem])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'GooglePrivacyDlpV2Domain' with the minimum fields required to make a request.
newGooglePrivacyDlpV2Domain 
    ::  GooglePrivacyDlpV2Domain
newGooglePrivacyDlpV2Domain
  = GooglePrivacyDlpV2Domain{category = Core.Nothing,
                             signals = Core.Nothing}
instance Core.FromJSON GooglePrivacyDlpV2Domain where
        parseJSON
          = Core.withObject "GooglePrivacyDlpV2Domain"
              (\ o ->
                 GooglePrivacyDlpV2Domain Core.<$>
                   (o Core..:? "category") Core.<*> (o Core..:? "signals"))

instance Core.ToJSON GooglePrivacyDlpV2Domain where
        toJSON GooglePrivacyDlpV2Domain{..}
          = Core.object
              (Core.catMaybes
                 [("category" Core..=) Core.<$> category,
                  ("signals" Core..=) Core.<$> signals])
...
data GooglePrivacyDlpV2FileStoreCollection = GooglePrivacyDlpV2FileStoreCollection
    {
    ...
    , includeTags :: (Core.Maybe GooglePrivacyDlpV2TagFilters)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
          ...
          = Core.withObject "GooglePrivacyDlpV2FileStoreCollection"
              (\ o ->
                 GooglePrivacyDlpV2FileStoreCollection Core.<$>
                   (o Core..:? "includeRegexes") Core.<*> (o Core..:? "includeTags"))
...
instance Core.ToJSON GooglePrivacyDlpV2FileStoreCollection where
        toJSON GooglePrivacyDlpV2FileStoreCollection{..}
          = Core.object
              (Core.catMaybes
                 [("includeRegexes" Core..=) Core.<$> includeRegexes,
                  ("includeTags" Core..=) Core.<$> includeTags])
...
data GooglePrivacyDlpV2FileStoreDataProfile = GooglePrivacyDlpV2FileStoreDataProfile
    ...
    , domains :: (Core.Maybe [GooglePrivacyDlpV2Domain])
...
data GooglePrivacyDlpV2InfoTypeDescription = GooglePrivacyDlpV2InfoTypeDescription
    ...
    , locationSupport :: (Core.Maybe GooglePrivacyDlpV2LocationSupport)
...
newGooglePrivacyDlpV2InfoTypeDescription
  = GooglePrivacyDlpV2InfoTypeDescription{categories = Core.Nothing,
                                          description = Core.Nothing, displayName = Core.Nothing,
                                          example = Core.Nothing, locationSupport = Core.Nothing,
                                          name = Core.Nothing, sensitivityScore = Core.Nothing,
          ...
          = Core.object
              (Core.catMaybes
                 [("categories" Core..=) Core.<$> categories,
                  ...
                  ("locationSupport" Core..=) Core.<$> locationSupport,
                  ("name" Core..=) Core.<$> name,
                  ("sensitivityScore" Core..=) Core.<$> sensitivityScore,
...
--
-- /See:/ 'newGooglePrivacyDlpV2LocationSupport' smart constructor.
data GooglePrivacyDlpV2LocationSupport = GooglePrivacyDlpV2LocationSupport
    {
    ...
    , regionalizationScope :: (Core.Maybe GooglePrivacyDlpV2LocationSupport_RegionalizationScope)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'GooglePrivacyDlpV2LocationSupport' with the minimum fields required to make a request.
newGooglePrivacyDlpV2LocationSupport 
    :: 
                                     GooglePrivacyDlpV2LocationSupport
newGooglePrivacyDlpV2LocationSupport
  = GooglePrivacyDlpV2LocationSupport{locations = Core.Nothing,
                                      regionalizationScope = Core.Nothing}
instance Core.FromJSON GooglePrivacyDlpV2LocationSupport where
        parseJSON
          = Core.withObject "GooglePrivacyDlpV2LocationSupport"
              (\ o ->
                 GooglePrivacyDlpV2LocationSupport Core.<$>
                   (o Core..:? "locations") Core.<*>
                     (o Core..:? "regionalizationScope"))

instance Core.ToJSON GooglePrivacyDlpV2LocationSupport where
        toJSON GooglePrivacyDlpV2LocationSupport{..}
          = Core.object
              (Core.catMaybes
                 [("locations" Core..=) Core.<$> locations,
                  ("regionalizationScope" Core..=) Core.<$> regionalizationScope])
...
data GooglePrivacyDlpV2OutputStorageConfig = GooglePrivacyDlpV2OutputStorageConfig
    ...
    , storagePath :: (Core.Maybe GooglePrivacyDlpV2CloudStoragePath)
...
newGooglePrivacyDlpV2OutputStorageConfig
  = GooglePrivacyDlpV2OutputStorageConfig{outputSchema =
                                            Core.Nothing,
                                          storagePath = Core.Nothing, table = Core.Nothing}
          ...
          = Core.withObject "GooglePrivacyDlpV2OutputStorageConfig"
              (\ o ->
                 GooglePrivacyDlpV2OutputStorageConfig Core.<$>
                   (o Core..:? "outputSchema") Core.<*> (o Core..:? "storagePath")
                     Core.<*> (o Core..:? "table"))
          ...
          = Core.object
              (Core.catMaybes
                 [("outputSchema" Core..=) Core.<$> outputSchema,
                  ("storagePath" Core..=) Core.<$> storagePath,
                  ("table" Core..=) Core.<$> table])
...
data GooglePrivacyDlpV2ProcessingLocation = GooglePrivacyDlpV2ProcessingLocation
    {
      -- | Document processing falls back using this configuration.
      documentFallbackLocation :: (Core.Maybe GooglePrivacyDlpV2DocumentFallbackLocation)
...
newGooglePrivacyDlpV2ProcessingLocation 
    :: 
                                        GooglePrivacyDlpV2ProcessingLocation
newGooglePrivacyDlpV2ProcessingLocation
  = GooglePrivacyDlpV2ProcessingLocation{documentFallbackLocation =
                                           Core.Nothing,
                                         imageFallbackLocation = Core.Nothing}
          ...
          = Core.withObject "GooglePrivacyDlpV2ProcessingLocation"
              (\ o ->
                 GooglePrivacyDlpV2ProcessingLocation Core.<$>
                   (o Core..:? "documentFallbackLocation") Core.<*>
...
instance Core.ToJSON GooglePrivacyDlpV2ProcessingLocation where
        toJSON GooglePrivacyDlpV2ProcessingLocation{..}
          = Core.object
              (Core.catMaybes
                 [("documentFallbackLocation" Core..=) Core.<$>
...
-- | Publish findings of a DlpJob to Dataplex Universal Catalog as a @sensitive-data-protection-job-result@ aspect. To learn more about aspects, see <https://cloud.google.com/sensitive-data-protection/docs/add-aspects-inspection-job Send inspection results to Dataplex Universal Catalog as aspects>. Aspects are persisted in Dataplex Universal Catalog storage and are governed by service-specific policies for Dataplex Universal Catalog. For more information, see <https://cloud.google.com/terms/service-terms Service Specific Terms>. Only a single instance of this action can be specified. This action is allowed only if all resources being scanned are BigQuery tables. Compatible with: Inspect
--
-- /See:/ 'newGooglePrivacyDlpV2PublishFindingsToDataplexCatalog' smart constructor.
data GooglePrivacyDlpV2PublishFindingsToDataplexCatalog = GooglePrivacyDlpV2PublishFindingsToDataplexCatalog
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'GooglePrivacyDlpV2PublishFindingsToDataplexCatalog' with the minimum fields required to make a request.
newGooglePrivacyDlpV2PublishFindingsToDataplexCatalog 
    :: 
                                                      GooglePrivacyDlpV2PublishFindingsToDataplexCatalog
newGooglePrivacyDlpV2PublishFindingsToDataplexCatalog
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "GooglePrivacyDlpV2PublishFindingsToDataplexCatalog"
              (\ o ->
                 Core.pure GooglePrivacyDlpV2PublishFindingsToDataplexCatalog)
...
newGooglePrivacyDlpV2TableDataProfile
  = GooglePrivacyDlpV2TableDataProfile{configSnapshot = Core.Nothing,
                                       ...
                                       datasetLocation = Core.Nothing,
                                       datasetProjectId = Core.Nothing, domains = Core.Nothing,
...
--
-- /See:/ 'newGooglePrivacyDlpV2TagFilter' smart constructor.
data GooglePrivacyDlpV2TagFilter = GooglePrivacyDlpV2TagFilter
    {
...
-- | Creates a value of 'GooglePrivacyDlpV2TagFilter' with the minimum fields required to make a request.
newGooglePrivacyDlpV2TagFilter 
    ::  GooglePrivacyDlpV2TagFilter
newGooglePrivacyDlpV2TagFilter
  = GooglePrivacyDlpV2TagFilter{namespacedTagKey = Core.Nothing,
                                namespacedTagValue = Core.Nothing}
instance Core.FromJSON GooglePrivacyDlpV2TagFilter where
        parseJSON
          = Core.withObject "GooglePrivacyDlpV2TagFilter"
              (\ o ->
                 GooglePrivacyDlpV2TagFilter Core.<$>
                   (o Core..:? "namespacedTagKey") Core.<*>
                     (o Core..:? "namespacedTagValue"))

instance Core.ToJSON GooglePrivacyDlpV2TagFilter where
        toJSON GooglePrivacyDlpV2TagFilter{..}
          = Core.object
              (Core.catMaybes
...
--
-- /See:/ 'newGooglePrivacyDlpV2TagFilters' smart constructor.
newtype GooglePrivacyDlpV2TagFilters = GooglePrivacyDlpV2TagFilters
    {
      -- | Required. A resource must match ALL of the specified tag filters to be included in the collection.
      tagFilters :: (Core.Maybe [GooglePrivacyDlpV2TagFilter])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'GooglePrivacyDlpV2TagFilters' with the minimum fields required to make a request.
newGooglePrivacyDlpV2TagFilters 
    ::  GooglePrivacyDlpV2TagFilters
newGooglePrivacyDlpV2TagFilters
  = GooglePrivacyDlpV2TagFilters{tagFilters = Core.Nothing}
instance Core.FromJSON GooglePrivacyDlpV2TagFilters where
        parseJSON
          = Core.withObject "GooglePrivacyDlpV2TagFilters"
              (\ o ->
                 GooglePrivacyDlpV2TagFilters Core.<$> (o Core..:? "tagFilters"))

instance Core.ToJSON GooglePrivacyDlpV2TagFilters where
        toJSON GooglePrivacyDlpV2TagFilters{..}
          = Core.object
              (Core.catMaybes [("tagFilters" Core..=) Core.<$> tagFilters])
