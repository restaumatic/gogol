...
--
-- /See:/ <https://cloud.google.com/sensitive-data-protection/docs/ Sensitive Data Protection (DLP) Reference> for @dlp.projects.dlpJobs.list@.
module Gogol.DLP.Projects.DlpJobs.List
    (
    -- * Resource
                     ...
                     Core.QueryParam "orderBy" Core.Text Core.:>
                       Core.QueryParam "pageSize" Core.Int32 Core.:>
                         Core.QueryParam "pageToken" Core.Text Core.:>
                           Core.QueryParam "type" ProjectsDlpJobsListType Core.:>
...
newDLPProjectsDlpJobsList parent
  = DLPProjectsDlpJobsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DLPProjectsDlpJobsList where
        ...
        type Scopes DLPProjectsDlpJobsList = '[CloudPlatform'FullControl]
        requestClient DLPProjectsDlpJobsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy DLPProjectsDlpJobsListResource)
                      Core.mempty
