...
--
-- /See:/ <https://cloud.google.com/sensitive-data-protection/docs/ Sensitive Data Protection (DLP) Reference> for @dlp.projects.jobTriggers.list@.
module Gogol.DLP.Projects.JobTriggers.List
    (
    -- * Resource
                     ...
                     Core.QueryParam "orderBy" Core.Text Core.:>
                       Core.QueryParam "pageSize" Core.Int32 Core.:>
                         Core.QueryParam "pageToken" Core.Text Core.:>
                           Core.QueryParam "type" ProjectsJobTriggersListType Core.:>
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.Get '[Core.JSON] GooglePrivacyDlpV2ListJobTriggersResponse
...
newDLPProjectsJobTriggersList parent
  = DLPProjectsJobTriggersList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DLPProjectsJobTriggersList where
        ...
        requestClient DLPProjectsJobTriggersList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy DLPProjectsJobTriggersListResource)
                      Core.mempty
