...
--
-- /See:/ <https://cloud.google.com/sensitive-data-protection/docs/ Sensitive Data Protection (DLP) Reference> for @dlp.projects.jobTriggers.create@.
module Gogol.DLP.Projects.JobTriggers.Create
    (
    -- * Resource
                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] GooglePrivacyDlpV2CreateJobTriggerRequest
...
newDLPProjectsJobTriggersCreate parent payload
  = DLPProjectsJobTriggersCreate{xgafv = Core.Nothing,
                                 accessToken = Core.Nothing, callback = Core.Nothing,
                                 parent = parent, payload = payload, uploadType = Core.Nothing,
                                 uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DLPProjectsJobTriggersCreate where
        type Rs DLPProjectsJobTriggersCreate = GooglePrivacyDlpV2JobTrigger
        ...
        requestClient DLPProjectsJobTriggersCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy DLPProjectsJobTriggersCreateResource)
                      Core.mempty
