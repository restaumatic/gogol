...
--
-- /See:/ <https://cloud.google.com/sensitive-data-protection/docs/ Sensitive Data Protection (DLP) Reference> for @dlp.projects.inspectTemplates.get@.
module Gogol.DLP.Projects.InspectTemplates.Get
    (
    -- * Resource
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.Get '[Core.JSON] GooglePrivacyDlpV2InspectTemplate
...
newDLPProjectsInspectTemplatesGet name
  = DLPProjectsInspectTemplatesGet{xgafv = Core.Nothing,
                                   accessToken = Core.Nothing, callback = Core.Nothing, name = name,
                                   uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DLPProjectsInspectTemplatesGet where
        ...
        requestClient DLPProjectsInspectTemplatesGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy DLPProjectsInspectTemplatesGetResource)
                      Core.mempty
