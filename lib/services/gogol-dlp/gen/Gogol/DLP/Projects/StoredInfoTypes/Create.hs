...
--
-- /See:/ <https://cloud.google.com/sensitive-data-protection/docs/ Sensitive Data Protection (DLP) Reference> for @dlp.projects.storedInfoTypes.create@.
module Gogol.DLP.Projects.StoredInfoTypes.Create
    (
    -- * Resource
...
newDLPProjectsStoredInfoTypesCreate parent payload
  = DLPProjectsStoredInfoTypesCreate{xgafv = Core.Nothing,
                                     accessToken = Core.Nothing, callback = Core.Nothing,
                                     parent = parent, payload = payload, uploadType = Core.Nothing,
                                     uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DLPProjectsStoredInfoTypesCreate where
        ...
        requestClient DLPProjectsStoredInfoTypesCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy DLPProjectsStoredInfoTypesCreateResource)
                      Core.mempty
