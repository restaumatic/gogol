...
--
-- /See:/ <https://cloud.google.com/sensitive-data-protection/docs/ Sensitive Data Protection (DLP) Reference> for @dlp.projects.content.deidentify@.
module Gogol.DLP.Projects.Content.Deidentify
    (
    -- * Resource
...
newDLPProjectsContentDeidentify parent payload
  = DLPProjectsContentDeidentify{xgafv = Core.Nothing,
                                 accessToken = Core.Nothing, callback = Core.Nothing,
                                 parent = parent, payload = payload, uploadType = Core.Nothing,
                                 uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DLPProjectsContentDeidentify where
        ...
        requestClient DLPProjectsContentDeidentify{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy DLPProjectsContentDeidentifyResource)
                      Core.mempty
