                     ...
                     Core.QueryParam "orderBy" Core.Text Core.:>
                       Core.QueryParam "pageSize" Core.Int32 Core.:>
                         Core.QueryParam "pageToken" Core.Text Core.:>
                           Core.QueryParam "type" ProjectsLocationsJobTriggersListType Core.:>
...
newDLPProjectsLocationsJobTriggersList parent
  = DLPProjectsLocationsJobTriggersList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DLPProjectsLocationsJobTriggersList
         where
