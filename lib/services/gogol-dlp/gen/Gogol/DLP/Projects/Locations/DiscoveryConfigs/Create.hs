...
newDLPProjectsLocationsDiscoveryConfigsCreate parent payload
  = DLPProjectsLocationsDiscoveryConfigsCreate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           DLPProjectsLocationsDiscoveryConfigsCreate
         where
        type Rs DLPProjectsLocationsDiscoveryConfigsCreate =
             GooglePrivacyDlpV2DiscoveryConfig
        type Scopes DLPProjectsLocationsDiscoveryConfigsCreate =
