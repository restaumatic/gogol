...
newDLPProjectsLocationsStoredInfoTypesList parent
  = DLPProjectsLocationsStoredInfoTypesList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DLPProjectsLocationsStoredInfoTypesList
         where
        type Rs DLPProjectsLocationsStoredInfoTypesList =
             GooglePrivacyDlpV2ListStoredInfoTypesResponse
        type Scopes DLPProjectsLocationsStoredInfoTypesList =
             '[CloudPlatform'FullControl]
        requestClient DLPProjectsLocationsStoredInfoTypesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DLPProjectsLocationsStoredInfoTypesListResource)
                      Core.mempty
