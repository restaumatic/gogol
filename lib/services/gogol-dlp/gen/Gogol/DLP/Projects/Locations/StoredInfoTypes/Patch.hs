...
--
-- /See:/ <https://cloud.google.com/sensitive-data-protection/docs/ Sensitive Data Protection (DLP) Reference> for @dlp.projects.locations.storedInfoTypes.patch@.
module Gogol.DLP.Projects.Locations.StoredInfoTypes.Patch
    (
    -- * Resource
...
newDLPProjectsLocationsStoredInfoTypesPatch name payload
  = DLPProjectsLocationsStoredInfoTypesPatch{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        requestClient DLPProjectsLocationsStoredInfoTypesPatch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DLPProjectsLocationsStoredInfoTypesPatchResource)
                      Core.mempty
