...
newDLPProjectsLocationsJobTriggersDelete name
  = DLPProjectsLocationsJobTriggersDelete{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          name = name, uploadType = Core.Nothing,
                                          uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DLPProjectsLocationsJobTriggersDelete
         where
        type Rs DLPProjectsLocationsJobTriggersDelete = GoogleProtobufEmpty
        type Scopes DLPProjectsLocationsJobTriggersDelete =
             '[CloudPlatform'FullControl]
        requestClient DLPProjectsLocationsJobTriggersDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DLPProjectsLocationsJobTriggersDeleteResource)
                      Core.mempty
