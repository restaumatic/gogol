               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] GooglePrivacyDlpV2UpdateConnectionRequest
...
newDLPProjectsLocationsConnectionsPatch name payload
  = DLPProjectsLocationsConnectionsPatch{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         name = name, payload = payload, uploadType = Core.Nothing,
                                         uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DLPProjectsLocationsConnectionsPatch
         where
        ...
        requestClient DLPProjectsLocationsConnectionsPatch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DLPProjectsLocationsConnectionsPatchResource)
                      Core.mempty
