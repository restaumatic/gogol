...
--
-- /See:/ <https://cloud.google.com/sensitive-data-protection/docs/ Sensitive Data Protection (DLP) Reference> for @dlp.projects.locations.deidentifyTemplates.create@.
module Gogol.DLP.Projects.Locations.DeidentifyTemplates.Create
    (
    -- * Resource
...
newDLPProjectsLocationsDeidentifyTemplatesCreate parent payload
  = DLPProjectsLocationsDeidentifyTemplatesCreate{xgafv =
                                                    Core.Nothing,
...
instance Core.GoogleRequest
        ...
        requestClient DLPProjectsLocationsDeidentifyTemplatesCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DLPProjectsLocationsDeidentifyTemplatesCreateResource)
                      Core.mempty
