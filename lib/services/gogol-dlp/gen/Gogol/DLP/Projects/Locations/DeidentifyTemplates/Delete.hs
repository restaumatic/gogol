...
--
-- /See:/ <https://cloud.google.com/sensitive-data-protection/docs/ Sensitive Data Protection (DLP) Reference> for @dlp.projects.locations.deidentifyTemplates.delete@.
module Gogol.DLP.Projects.Locations.DeidentifyTemplates.Delete
    (
    -- * Resource
...
newDLPProjectsLocationsDeidentifyTemplatesDelete name
  = DLPProjectsLocationsDeidentifyTemplatesDelete{xgafv =
                                                    Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Rs DLPProjectsLocationsDeidentifyTemplatesDelete =
             GoogleProtobufEmpty
        type Scopes DLPProjectsLocationsDeidentifyTemplatesDelete =
             '[CloudPlatform'FullControl]
        requestClient DLPProjectsLocationsDeidentifyTemplatesDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DLPProjectsLocationsDeidentifyTemplatesDeleteResource)
                      Core.mempty
