...
newDLPProjectsLocationsColumnDataProfilesGet name
  = DLPProjectsLocationsColumnDataProfilesGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           DLPProjectsLocationsColumnDataProfilesGet
         where
        type Rs DLPProjectsLocationsColumnDataProfilesGet =
             GooglePrivacyDlpV2ColumnDataProfile
        type Scopes DLPProjectsLocationsColumnDataProfilesGet =
