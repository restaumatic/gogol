                   ...
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON]
                         ...
                         Core.:>
                         Core.Post '[Core.JSON] GooglePrivacyDlpV2ReidentifyContentResponse
...
instance Core.GoogleRequest DLPProjectsLocationsContentReidentify
        ...
        requestClient DLPProjectsLocationsContentReidentify{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DLPProjectsLocationsContentReidentifyResource)
                      Core.mempty
