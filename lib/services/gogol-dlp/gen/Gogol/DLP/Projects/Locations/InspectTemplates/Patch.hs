...
--
-- /See:/ <https://cloud.google.com/sensitive-data-protection/docs/ Sensitive Data Protection (DLP) Reference> for @dlp.projects.locations.inspectTemplates.patch@.
module Gogol.DLP.Projects.Locations.InspectTemplates.Patch
    (
    -- * Resource
...
newDLPProjectsLocationsInspectTemplatesPatch name payload
  = DLPProjectsLocationsInspectTemplatesPatch{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        requestClient DLPProjectsLocationsInspectTemplatesPatch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DLPProjectsLocationsInspectTemplatesPatchResource)
                      Core.mempty
