                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] GooglePrivacyDlpV2SearchConnectionsResponse
...
newDLPProjectsLocationsConnectionsSearch parent
  = DLPProjectsLocationsConnectionsSearch{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DLPProjectsLocationsConnectionsSearch
         where
        type Rs DLPProjectsLocationsConnectionsSearch =
             GooglePrivacyDlpV2SearchConnectionsResponse
        type Scopes DLPProjectsLocationsConnectionsSearch =
