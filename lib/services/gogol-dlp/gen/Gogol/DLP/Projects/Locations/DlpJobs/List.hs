...
--
-- /See:/ <https://cloud.google.com/sensitive-data-protection/docs/ Sensitive Data Protection (DLP) Reference> for @dlp.projects.locations.dlpJobs.list@.
module Gogol.DLP.Projects.Locations.DlpJobs.List
    (
    -- * Resource
                     ...
                     Core.QueryParam "orderBy" Core.Text Core.:>
                       Core.QueryParam "pageSize" Core.Int32 Core.:>
                         Core.QueryParam "pageToken" Core.Text Core.:>
                           Core.QueryParam "type" ProjectsLocationsDlpJobsListType Core.:>
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.Get '[Core.JSON] GooglePrivacyDlpV2ListDlpJobsResponse
...
newDLPProjectsLocationsDlpJobsList parent
  = DLPProjectsLocationsDlpJobsList{xgafv = Core.Nothing,
                                    accessToken = Core.Nothing, callback = Core.Nothing,
                                    filter = Core.Nothing, locationId = Core.Nothing,
                                    orderBy = Core.Nothing, pageSize = Core.Nothing,
                                    pageToken = Core.Nothing, parent = parent, type' = Core.Nothing,
                                    uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DLPProjectsLocationsDlpJobsList where
        ...
        requestClient DLPProjectsLocationsDlpJobsList{..}
          = go parent xgafv accessToken callback filter locationId orderBy
              pageSize
              pageToken
              type'
              uploadType
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy DLPProjectsLocationsDlpJobsListResource)
                      Core.mempty
