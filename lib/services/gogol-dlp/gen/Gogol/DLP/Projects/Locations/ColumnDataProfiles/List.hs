...
newDLPProjectsLocationsColumnDataProfilesList parent
  = DLPProjectsLocationsColumnDataProfilesList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Rs DLPProjectsLocationsColumnDataProfilesList =
             GooglePrivacyDlpV2ListColumnDataProfilesResponse
        type Scopes DLPProjectsLocationsColumnDataProfilesList =
             '[CloudPlatform'FullControl]
        requestClient DLPProjectsLocationsColumnDataProfilesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DLPProjectsLocationsColumnDataProfilesListResource)
                      Core.mempty
