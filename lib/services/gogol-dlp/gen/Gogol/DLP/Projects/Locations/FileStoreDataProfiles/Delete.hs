...
newDLPProjectsLocationsFileStoreDataProfilesDelete name
  = DLPProjectsLocationsFileStoreDataProfilesDelete{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           DLPProjectsLocationsFileStoreDataProfilesDelete
         where
        type Rs DLPProjectsLocationsFileStoreDataProfilesDelete =
             GoogleProtobufEmpty
        type Scopes DLPProjectsLocationsFileStoreDataProfilesDelete =
             '[CloudPlatform'FullControl]
        requestClient DLPProjectsLocationsFileStoreDataProfilesDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DLPProjectsLocationsFileStoreDataProfilesDeleteResource)
                      Core.mempty
