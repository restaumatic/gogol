...
newDLPProjectsLocationsTableDataProfilesList parent
  = DLPProjectsLocationsTableDataProfilesList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           DLPProjectsLocationsTableDataProfilesList
         where
        type Rs DLPProjectsLocationsTableDataProfilesList =
             GooglePrivacyDlpV2ListTableDataProfilesResponse
        type Scopes DLPProjectsLocationsTableDataProfilesList =
