               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.Get '[Core.JSON] GooglePrivacyDlpV2DiscoveryConfig
...
newDLPProjectsLocationsDiscoveryConfigsGet name
  = DLPProjectsLocationsDiscoveryConfigsGet{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            name = name, uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DLPProjectsLocationsDiscoveryConfigsGet
         where
        ...
        requestClient DLPProjectsLocationsDiscoveryConfigsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DLPProjectsLocationsDiscoveryConfigsGetResource)
                      Core.mempty
