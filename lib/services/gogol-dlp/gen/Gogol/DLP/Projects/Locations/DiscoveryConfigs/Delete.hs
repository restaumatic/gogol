...
newDLPProjectsLocationsDiscoveryConfigsDelete name
  = DLPProjectsLocationsDiscoveryConfigsDelete{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Rs DLPProjectsLocationsDiscoveryConfigsDelete =
             GoogleProtobufEmpty
        type Scopes DLPProjectsLocationsDiscoveryConfigsDelete =
             '[CloudPlatform'FullControl]
        requestClient DLPProjectsLocationsDiscoveryConfigsDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DLPProjectsLocationsDiscoveryConfigsDeleteResource)
                      Core.mempty
