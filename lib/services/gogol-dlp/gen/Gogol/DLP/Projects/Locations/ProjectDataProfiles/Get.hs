...
newDLPProjectsLocationsProjectDataProfilesGet name
  = DLPProjectsLocationsProjectDataProfilesGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           DLPProjectsLocationsProjectDataProfilesGet
         where
        type Rs DLPProjectsLocationsProjectDataProfilesGet =
             GooglePrivacyDlpV2ProjectDataProfile
        type Scopes DLPProjectsLocationsProjectDataProfilesGet =
