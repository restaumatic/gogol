...
newDLPProjectsLocationsDiscoveryConfigsPatch name payload
  = DLPProjectsLocationsDiscoveryConfigsPatch{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           DLPProjectsLocationsDiscoveryConfigsPatch
         where
        type Rs DLPProjectsLocationsDiscoveryConfigsPatch =
             GooglePrivacyDlpV2DiscoveryConfig
        type Scopes DLPProjectsLocationsDiscoveryConfigsPatch =
