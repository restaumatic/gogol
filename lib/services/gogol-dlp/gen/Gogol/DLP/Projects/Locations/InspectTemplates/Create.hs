...
newDLPProjectsLocationsInspectTemplatesCreate parent payload
  = DLPProjectsLocationsInspectTemplatesCreate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes DLPProjectsLocationsInspectTemplatesCreate =
             '[CloudPlatform'FullControl]
        requestClient DLPProjectsLocationsInspectTemplatesCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DLPProjectsLocationsInspectTemplatesCreateResource)
                      Core.mempty
