...
newDLPProjectsLocationsDiscoveryConfigsList parent
  = DLPProjectsLocationsDiscoveryConfigsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        requestClient DLPProjectsLocationsDiscoveryConfigsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DLPProjectsLocationsDiscoveryConfigsListResource)
                      Core.mempty
