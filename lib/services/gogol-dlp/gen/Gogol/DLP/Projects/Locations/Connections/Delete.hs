...
newDLPProjectsLocationsConnectionsDelete name
  = DLPProjectsLocationsConnectionsDelete{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          name = name, uploadType = Core.Nothing,
                                          uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DLPProjectsLocationsConnectionsDelete
         where
        type Rs DLPProjectsLocationsConnectionsDelete = GoogleProtobufEmpty
        type Scopes DLPProjectsLocationsConnectionsDelete =
             '[CloudPlatform'FullControl]
        requestClient DLPProjectsLocationsConnectionsDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DLPProjectsLocationsConnectionsDeleteResource)
                      Core.mempty
