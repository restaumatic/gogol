...
-- |
-- Module      : Gogol.DLP.Projects.Locations.FileStoreDataProfiles.List
...
--
-- /See:/ <https://cloud.google.com/sensitive-data-protection/docs/ Sensitive Data Protection (DLP) Reference> for @dlp.projects.locations.fileStoreDataProfiles.list@.
module Gogol.DLP.Projects.Locations.FileStoreDataProfiles.List
    (
    -- * Resource
...
-- | A resource alias for @dlp.projects.locations.fileStoreDataProfiles.list@ method which the
-- 'DLPProjectsLocationsFileStoreDataProfilesList' request conforms to.
type DLPProjectsLocationsFileStoreDataProfilesListResource =
     "v2" Core.:>
...
-- | Lists file store data profiles for an organization.
--
-- /See:/ 'newDLPProjectsLocationsFileStoreDataProfilesList' smart constructor.
data DLPProjectsLocationsFileStoreDataProfilesList = DLPProjectsLocationsFileStoreDataProfilesList
    {
      -- | V1 error format.
...
-- | Creates a value of 'DLPProjectsLocationsFileStoreDataProfilesList' with the minimum fields required to make a request.
newDLPProjectsLocationsFileStoreDataProfilesList 
    :: 
                                                 Core.Text
    ...
    -> DLPProjectsLocationsFileStoreDataProfilesList
newDLPProjectsLocationsFileStoreDataProfilesList parent
  = DLPProjectsLocationsFileStoreDataProfilesList{xgafv =
                                                    Core.Nothing,
...
instance Core.GoogleRequest
           DLPProjectsLocationsFileStoreDataProfilesList
         where
        type Rs DLPProjectsLocationsFileStoreDataProfilesList =
             GooglePrivacyDlpV2ListFileStoreDataProfilesResponse
        type Scopes DLPProjectsLocationsFileStoreDataProfilesList =
             '[CloudPlatform'FullControl]
        requestClient DLPProjectsLocationsFileStoreDataProfilesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DLPProjectsLocationsFileStoreDataProfilesListResource)
                      Core.mempty
