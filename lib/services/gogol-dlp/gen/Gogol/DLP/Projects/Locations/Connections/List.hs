...
newDLPProjectsLocationsConnectionsList parent
  = DLPProjectsLocationsConnectionsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DLPProjectsLocationsConnectionsList
         where
        ...
        requestClient DLPProjectsLocationsConnectionsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DLPProjectsLocationsConnectionsListResource)
                      Core.mempty
