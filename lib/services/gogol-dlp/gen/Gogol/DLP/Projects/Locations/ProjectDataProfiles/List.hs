...
newDLPProjectsLocationsProjectDataProfilesList parent
  = DLPProjectsLocationsProjectDataProfilesList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        requestClient DLPProjectsLocationsProjectDataProfilesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DLPProjectsLocationsProjectDataProfilesListResource)
                      Core.mempty
