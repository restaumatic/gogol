...
newDLPProjectsLocationsFileStoreDataProfilesGet name
  = DLPProjectsLocationsFileStoreDataProfilesGet{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
           DLPProjectsLocationsFileStoreDataProfilesGet
         where
        type Rs DLPProjectsLocationsFileStoreDataProfilesGet =
             GooglePrivacyDlpV2FileStoreDataProfile
        type Scopes DLPProjectsLocationsFileStoreDataProfilesGet =
