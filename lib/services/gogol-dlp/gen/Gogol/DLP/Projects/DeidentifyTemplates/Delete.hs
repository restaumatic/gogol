...
newDLPProjectsDeidentifyTemplatesDelete name
  = DLPProjectsDeidentifyTemplatesDelete{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         name = name, uploadType = Core.Nothing,
                                         uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DLPProjectsDeidentifyTemplatesDelete
         where
        type Rs DLPProjectsDeidentifyTemplatesDelete = GoogleProtobufEmpty
        type Scopes DLPProjectsDeidentifyTemplatesDelete =
             '[CloudPlatform'FullControl]
        requestClient DLPProjectsDeidentifyTemplatesDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DLPProjectsDeidentifyTemplatesDeleteResource)
                      Core.mempty
