...
instance Core.GoogleRequest DLPProjectsDeidentifyTemplatesCreate
        ...
        requestClient DLPProjectsDeidentifyTemplatesCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DLPProjectsDeidentifyTemplatesCreateResource)
                      Core.mempty
