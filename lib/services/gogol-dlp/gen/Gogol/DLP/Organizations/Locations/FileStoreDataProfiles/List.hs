...
newDLPOrganizationsLocationsFileStoreDataProfilesList parent
  = DLPOrganizationsLocationsFileStoreDataProfilesList{xgafv =
                                                         Core.Nothing,
...
instance Core.GoogleRequest
           DLPOrganizationsLocationsFileStoreDataProfilesList
         where
        type Rs DLPOrganizationsLocationsFileStoreDataProfilesList =
             GooglePrivacyDlpV2ListFileStoreDataProfilesResponse
        type Scopes DLPOrganizationsLocationsFileStoreDataProfilesList =
