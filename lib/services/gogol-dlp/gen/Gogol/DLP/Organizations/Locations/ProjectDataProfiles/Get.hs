               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.Get '[Core.JSON] GooglePrivacyDlpV2ProjectDataProfile
...
newDLPOrganizationsLocationsProjectDataProfilesGet name
  = DLPOrganizationsLocationsProjectDataProfilesGet{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           DLPOrganizationsLocationsProjectDataProfilesGet
         where
        type Rs DLPOrganizationsLocationsProjectDataProfilesGet =
             GooglePrivacyDlpV2ProjectDataProfile
        type Scopes DLPOrganizationsLocationsProjectDataProfilesGet =
