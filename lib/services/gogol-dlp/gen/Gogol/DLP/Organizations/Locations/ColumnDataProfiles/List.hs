...
-- |
-- Module      : Gogol.DLP.Organizations.Locations.ColumnDataProfiles.List
...
--
-- /See:/ <https://cloud.google.com/sensitive-data-protection/docs/ Sensitive Data Protection (DLP) Reference> for @dlp.organizations.locations.columnDataProfiles.list@.
module Gogol.DLP.Organizations.Locations.ColumnDataProfiles.List
    (
    -- * Resource
...
-- | A resource alias for @dlp.organizations.locations.columnDataProfiles.list@ method which the
-- 'DLPOrganizationsLocationsColumnDataProfilesList' request conforms to.
type DLPOrganizationsLocationsColumnDataProfilesListResource =
     "v2" Core.:>
...
-- | Lists column data profiles for an organization.
--
-- /See:/ 'newDLPOrganizationsLocationsColumnDataProfilesList' smart constructor.
data DLPOrganizationsLocationsColumnDataProfilesList = DLPOrganizationsLocationsColumnDataProfilesList
    {
      -- | V1 error format.
...
-- | Creates a value of 'DLPOrganizationsLocationsColumnDataProfilesList' with the minimum fields required to make a request.
newDLPOrganizationsLocationsColumnDataProfilesList 
    :: 
                                                   Core.Text
    ...
    -> DLPOrganizationsLocationsColumnDataProfilesList
newDLPOrganizationsLocationsColumnDataProfilesList parent
  = DLPOrganizationsLocationsColumnDataProfilesList{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           DLPOrganizationsLocationsColumnDataProfilesList
         where
        type Rs DLPOrganizationsLocationsColumnDataProfilesList =
             GooglePrivacyDlpV2ListColumnDataProfilesResponse
        type Scopes DLPOrganizationsLocationsColumnDataProfilesList =
             '[CloudPlatform'FullControl]
        requestClient DLPOrganizationsLocationsColumnDataProfilesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DLPOrganizationsLocationsColumnDataProfilesListResource)
                      Core.mempty
