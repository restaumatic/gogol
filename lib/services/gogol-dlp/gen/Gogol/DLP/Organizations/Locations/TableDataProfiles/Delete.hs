...
newDLPOrganizationsLocationsTableDataProfilesDelete name
  = DLPOrganizationsLocationsTableDataProfilesDelete{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           DLPOrganizationsLocationsTableDataProfilesDelete
         where
        type Rs DLPOrganizationsLocationsTableDataProfilesDelete =
             GoogleProtobufEmpty
        type Scopes DLPOrganizationsLocationsTableDataProfilesDelete =
