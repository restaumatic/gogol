                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] GooglePrivacyDlpV2ListConnectionsResponse
...
newDLPOrganizationsLocationsConnectionsList parent
  = DLPOrganizationsLocationsConnectionsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        requestClient DLPOrganizationsLocationsConnectionsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DLPOrganizationsLocationsConnectionsListResource)
                      Core.mempty
