...
newDLPOrganizationsLocationsDiscoveryConfigsGet name
  = DLPOrganizationsLocationsDiscoveryConfigsGet{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
           DLPOrganizationsLocationsDiscoveryConfigsGet
         where
        type Rs DLPOrganizationsLocationsDiscoveryConfigsGet =
             GooglePrivacyDlpV2DiscoveryConfig
        type Scopes DLPOrganizationsLocationsDiscoveryConfigsGet =
