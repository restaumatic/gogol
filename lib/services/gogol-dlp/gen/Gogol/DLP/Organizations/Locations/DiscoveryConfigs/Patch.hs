...
newDLPOrganizationsLocationsDiscoveryConfigsPatch name payload
  = DLPOrganizationsLocationsDiscoveryConfigsPatch{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           DLPOrganizationsLocationsDiscoveryConfigsPatch
         where
        type Rs DLPOrganizationsLocationsDiscoveryConfigsPatch =
             GooglePrivacyDlpV2DiscoveryConfig
        type Scopes DLPOrganizationsLocationsDiscoveryConfigsPatch =
