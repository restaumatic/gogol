...
--
-- /See:/ <https://cloud.google.com/sensitive-data-protection/docs/ Sensitive Data Protection (DLP) Reference> for @dlp.organizations.locations.storedInfoTypes.create@.
module Gogol.DLP.Organizations.Locations.StoredInfoTypes.Create
    (
    -- * Resource
                   ...
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON]
                         ...
                         Core.:> Core.Post '[Core.JSON] GooglePrivacyDlpV2StoredInfoType
...
newDLPOrganizationsLocationsStoredInfoTypesCreate parent payload
  = DLPOrganizationsLocationsStoredInfoTypesCreate{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           DLPOrganizationsLocationsStoredInfoTypesCreate
         where
        type Rs DLPOrganizationsLocationsStoredInfoTypesCreate =
             GooglePrivacyDlpV2StoredInfoType
        type Scopes DLPOrganizationsLocationsStoredInfoTypesCreate =
             '[CloudPlatform'FullControl]
        requestClient DLPOrganizationsLocationsStoredInfoTypesCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DLPOrganizationsLocationsStoredInfoTypesCreateResource)
                      Core.mempty
