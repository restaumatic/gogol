...
newDLPOrganizationsLocationsTableDataProfilesGet name
  = DLPOrganizationsLocationsTableDataProfilesGet{xgafv =
                                                    Core.Nothing,
...
instance Core.GoogleRequest
           DLPOrganizationsLocationsTableDataProfilesGet
         where
        type Rs DLPOrganizationsLocationsTableDataProfilesGet =
             GooglePrivacyDlpV2TableDataProfile
        type Scopes DLPOrganizationsLocationsTableDataProfilesGet =
