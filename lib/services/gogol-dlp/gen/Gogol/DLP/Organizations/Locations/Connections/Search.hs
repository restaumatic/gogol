...
newDLPOrganizationsLocationsConnectionsSearch parent
  = DLPOrganizationsLocationsConnectionsSearch{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           DLPOrganizationsLocationsConnectionsSearch
         where
        type Rs DLPOrganizationsLocationsConnectionsSearch =
             GooglePrivacyDlpV2SearchConnectionsResponse
        type Scopes DLPOrganizationsLocationsConnectionsSearch =
