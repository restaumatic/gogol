...
newDLPOrganizationsLocationsConnectionsCreate parent payload
  = DLPOrganizationsLocationsConnectionsCreate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           DLPOrganizationsLocationsConnectionsCreate
         where
        type Rs DLPOrganizationsLocationsConnectionsCreate =
             GooglePrivacyDlpV2Connection
        type Scopes DLPOrganizationsLocationsConnectionsCreate =
