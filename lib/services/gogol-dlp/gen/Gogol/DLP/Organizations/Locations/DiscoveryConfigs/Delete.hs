...
newDLPOrganizationsLocationsDiscoveryConfigsDelete name
  = DLPOrganizationsLocationsDiscoveryConfigsDelete{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           DLPOrganizationsLocationsDiscoveryConfigsDelete
         where
        type Rs DLPOrganizationsLocationsDiscoveryConfigsDelete =
             GoogleProtobufEmpty
        type Scopes DLPOrganizationsLocationsDiscoveryConfigsDelete =
             '[CloudPlatform'FullControl]
        requestClient DLPOrganizationsLocationsDiscoveryConfigsDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DLPOrganizationsLocationsDiscoveryConfigsDeleteResource)
                      Core.mempty
