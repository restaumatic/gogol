...
--
-- /See:/ <https://cloud.google.com/sensitive-data-protection/docs/ Sensitive Data Protection (DLP) Reference> for @dlp.organizations.locations.jobTriggers.get@.
module Gogol.DLP.Organizations.Locations.JobTriggers.Get
    (
    -- * Resource
...
newDLPOrganizationsLocationsJobTriggersGet name
  = DLPOrganizationsLocationsJobTriggersGet{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            name = name, uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DLPOrganizationsLocationsJobTriggersGet
         where
        type Rs DLPOrganizationsLocationsJobTriggersGet =
             GooglePrivacyDlpV2JobTrigger
        type Scopes DLPOrganizationsLocationsJobTriggersGet =
             '[CloudPlatform'FullControl]
        requestClient DLPOrganizationsLocationsJobTriggersGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DLPOrganizationsLocationsJobTriggersGetResource)
                      Core.mempty
