...
newDLPOrganizationsLocationsInspectTemplatesCreate parent payload
  = DLPOrganizationsLocationsInspectTemplatesCreate{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           DLPOrganizationsLocationsInspectTemplatesCreate
         where
        type Rs DLPOrganizationsLocationsInspectTemplatesCreate =
             GooglePrivacyDlpV2InspectTemplate
        type Scopes DLPOrganizationsLocationsInspectTemplatesCreate =
