...
newDLPOrganizationsLocationsDeidentifyTemplatesDelete name
  = DLPOrganizationsLocationsDeidentifyTemplatesDelete{xgafv =
                                                         Core.Nothing,
...
instance Core.GoogleRequest
           DLPOrganizationsLocationsDeidentifyTemplatesDelete
         where
        type Rs DLPOrganizationsLocationsDeidentifyTemplatesDelete =
             GoogleProtobufEmpty
        type Scopes DLPOrganizationsLocationsDeidentifyTemplatesDelete =
