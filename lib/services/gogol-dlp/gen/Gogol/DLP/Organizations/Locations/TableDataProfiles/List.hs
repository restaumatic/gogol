...
-- |
-- Module      : Gogol.DLP.Organizations.Locations.TableDataProfiles.List
...
--
-- /See:/ <https://cloud.google.com/sensitive-data-protection/docs/ Sensitive Data Protection (DLP) Reference> for @dlp.organizations.locations.tableDataProfiles.list@.
module Gogol.DLP.Organizations.Locations.TableDataProfiles.List
    (
    -- * Resource
...
-- | A resource alias for @dlp.organizations.locations.tableDataProfiles.list@ method which the
-- 'DLPOrganizationsLocationsTableDataProfilesList' request conforms to.
type DLPOrganizationsLocationsTableDataProfilesListResource =
     "v2" Core.:>
       Core.Capture "parent" Core.Text Core.:>
         "tableDataProfiles" Core.:>
...
-- | Lists table data profiles for an organization.
--
-- /See:/ 'newDLPOrganizationsLocationsTableDataProfilesList' smart constructor.
data DLPOrganizationsLocationsTableDataProfilesList = DLPOrganizationsLocationsTableDataProfilesList
    {
      -- | V1 error format.
...
-- | Creates a value of 'DLPOrganizationsLocationsTableDataProfilesList' with the minimum fields required to make a request.
newDLPOrganizationsLocationsTableDataProfilesList 
    :: 
                                                  Core.Text
    ...
    -> DLPOrganizationsLocationsTableDataProfilesList
newDLPOrganizationsLocationsTableDataProfilesList parent
  = DLPOrganizationsLocationsTableDataProfilesList{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           DLPOrganizationsLocationsTableDataProfilesList
         where
        type Rs DLPOrganizationsLocationsTableDataProfilesList =
             GooglePrivacyDlpV2ListTableDataProfilesResponse
        type Scopes DLPOrganizationsLocationsTableDataProfilesList =
             '[CloudPlatform'FullControl]
        requestClient DLPOrganizationsLocationsTableDataProfilesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DLPOrganizationsLocationsTableDataProfilesListResource)
                      Core.mempty
