...
newDLPOrganizationsLocationsDiscoveryConfigsList parent
  = DLPOrganizationsLocationsDiscoveryConfigsList{xgafv =
                                                    Core.Nothing,
                                                  accessToken = Core.Nothing,
                                                  callback = Core.Nothing, orderBy = Core.Nothing,
...
instance Core.GoogleRequest
           DLPOrganizationsLocationsDiscoveryConfigsList
         where
        type Rs DLPOrganizationsLocationsDiscoveryConfigsList =
             GooglePrivacyDlpV2ListDiscoveryConfigsResponse
        type Scopes DLPOrganizationsLocationsDiscoveryConfigsList =
