...
-- |
-- Module      : Gogol.DLP.Organizations.Locations.ProjectDataProfiles.List
...
--
-- /See:/ <https://cloud.google.com/sensitive-data-protection/docs/ Sensitive Data Protection (DLP) Reference> for @dlp.organizations.locations.projectDataProfiles.list@.
module Gogol.DLP.Organizations.Locations.ProjectDataProfiles.List
    (
    -- * Resource
...
-- | A resource alias for @dlp.organizations.locations.projectDataProfiles.list@ method which the
-- 'DLPOrganizationsLocationsProjectDataProfilesList' request conforms to.
type DLPOrganizationsLocationsProjectDataProfilesListResource =
     "v2" Core.:>
...
-- | Lists project data profiles for an organization.
--
-- /See:/ 'newDLPOrganizationsLocationsProjectDataProfilesList' smart constructor.
data DLPOrganizationsLocationsProjectDataProfilesList = DLPOrganizationsLocationsProjectDataProfilesList
    {
      -- | V1 error format.
...
-- | Creates a value of 'DLPOrganizationsLocationsProjectDataProfilesList' with the minimum fields required to make a request.
newDLPOrganizationsLocationsProjectDataProfilesList 
    :: 
                                                    Core.Text
       -- ^  Required. organizations\/{org/id}\/locations\/{loc/id} See 'parent'.
    -> DLPOrganizationsLocationsProjectDataProfilesList
newDLPOrganizationsLocationsProjectDataProfilesList parent
  = DLPOrganizationsLocationsProjectDataProfilesList{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           DLPOrganizationsLocationsProjectDataProfilesList
         where
        type Rs DLPOrganizationsLocationsProjectDataProfilesList =
             GooglePrivacyDlpV2ListProjectDataProfilesResponse
        type Scopes DLPOrganizationsLocationsProjectDataProfilesList =
             '[CloudPlatform'FullControl]
        requestClient DLPOrganizationsLocationsProjectDataProfilesList{..}
