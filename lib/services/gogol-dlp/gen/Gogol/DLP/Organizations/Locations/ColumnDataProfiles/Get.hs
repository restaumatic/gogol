               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.Get '[Core.JSON] GooglePrivacyDlpV2ColumnDataProfile
...
newDLPOrganizationsLocationsColumnDataProfilesGet name
  = DLPOrganizationsLocationsColumnDataProfilesGet{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           DLPOrganizationsLocationsColumnDataProfilesGet
         where
        type Rs DLPOrganizationsLocationsColumnDataProfilesGet =
             GooglePrivacyDlpV2ColumnDataProfile
        type Scopes DLPOrganizationsLocationsColumnDataProfilesGet =
