...
newDLPOrganizationsLocationsDiscoveryConfigsCreate parent payload
  = DLPOrganizationsLocationsDiscoveryConfigsCreate{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           DLPOrganizationsLocationsDiscoveryConfigsCreate
         where
        type Rs DLPOrganizationsLocationsDiscoveryConfigsCreate =
             GooglePrivacyDlpV2DiscoveryConfig
        type Scopes DLPOrganizationsLocationsDiscoveryConfigsCreate =
             '[CloudPlatform'FullControl]
        requestClient DLPOrganizationsLocationsDiscoveryConfigsCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DLPOrganizationsLocationsDiscoveryConfigsCreateResource)
                      Core.mempty
