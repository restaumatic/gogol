...
newDLPOrganizationsLocationsStoredInfoTypesDelete name
  = DLPOrganizationsLocationsStoredInfoTypesDelete{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           DLPOrganizationsLocationsStoredInfoTypesDelete
         where
        type Rs DLPOrganizationsLocationsStoredInfoTypesDelete =
             GoogleProtobufEmpty
        type Scopes DLPOrganizationsLocationsStoredInfoTypesDelete =
