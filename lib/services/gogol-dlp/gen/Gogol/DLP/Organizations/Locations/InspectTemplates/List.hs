...
newDLPOrganizationsLocationsInspectTemplatesList parent
  = DLPOrganizationsLocationsInspectTemplatesList{xgafv =
                                                    Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Rs DLPOrganizationsLocationsInspectTemplatesList =
             GooglePrivacyDlpV2ListInspectTemplatesResponse
        type Scopes DLPOrganizationsLocationsInspectTemplatesList =
             '[CloudPlatform'FullControl]
        requestClient DLPOrganizationsLocationsInspectTemplatesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DLPOrganizationsLocationsInspectTemplatesListResource)
                      Core.mempty
