...
--
-- /See:/ <https://cloud.google.com/sensitive-data-protection/docs/ Sensitive Data Protection (DLP) Reference> for @dlp.organizations.locations.jobTriggers.list@.
module Gogol.DLP.Organizations.Locations.JobTriggers.List
    (
    -- * Resource
                     ...
                     Core.QueryParam "orderBy" Core.Text Core.:>
                       Core.QueryParam "pageSize" Core.Int32 Core.:>
                         Core.QueryParam "pageToken" Core.Text Core.:>
                           Core.QueryParam "type" OrganizationsLocationsJobTriggersListType
                             Core.:>
...
newDLPOrganizationsLocationsJobTriggersList parent
  = DLPOrganizationsLocationsJobTriggersList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        requestClient DLPOrganizationsLocationsJobTriggersList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DLPOrganizationsLocationsJobTriggersListResource)
                      Core.mempty
