                     ...
                     Core.QueryParam "orderBy" Core.Text Core.:>
                       Core.QueryParam "pageSize" Core.Int32 Core.:>
                         Core.QueryParam "pageToken" Core.Text Core.:>
                           Core.QueryParam "type" OrganizationsLocationsDlpJobsListType
                             Core.:>
...
newDLPOrganizationsLocationsDlpJobsList parent
  = DLPOrganizationsLocationsDlpJobsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DLPOrganizationsLocationsDlpJobsList
         where
        type Rs DLPOrganizationsLocationsDlpJobsList =
             GooglePrivacyDlpV2ListDlpJobsResponse
        type Scopes DLPOrganizationsLocationsDlpJobsList =
             '[CloudPlatform'FullControl]
        requestClient DLPOrganizationsLocationsDlpJobsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DLPOrganizationsLocationsDlpJobsListResource)
                      Core.mempty
