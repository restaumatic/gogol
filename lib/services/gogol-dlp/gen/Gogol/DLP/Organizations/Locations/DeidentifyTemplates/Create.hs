...
newDLPOrganizationsLocationsDeidentifyTemplatesCreate 
    ...
    -> DLPOrganizationsLocationsDeidentifyTemplatesCreate
newDLPOrganizationsLocationsDeidentifyTemplatesCreate parent
  payload
  = DLPOrganizationsLocationsDeidentifyTemplatesCreate{xgafv =
                                                         Core.Nothing,
...
instance Core.GoogleRequest
           DLPOrganizationsLocationsDeidentifyTemplatesCreate
         where
        type Rs DLPOrganizationsLocationsDeidentifyTemplatesCreate =
             GooglePrivacyDlpV2DeidentifyTemplate
        type Scopes DLPOrganizationsLocationsDeidentifyTemplatesCreate =
