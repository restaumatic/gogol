               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.Get '[Core.JSON] GooglePrivacyDlpV2FileStoreDataProfile
...
newDLPOrganizationsLocationsFileStoreDataProfilesGet name
  = DLPOrganizationsLocationsFileStoreDataProfilesGet{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           DLPOrganizationsLocationsFileStoreDataProfilesGet
         where
        type Rs DLPOrganizationsLocationsFileStoreDataProfilesGet =
             GooglePrivacyDlpV2FileStoreDataProfile
        type Scopes DLPOrganizationsLocationsFileStoreDataProfilesGet =
             '[CloudPlatform'FullControl]
        requestClient DLPOrganizationsLocationsFileStoreDataProfilesGet{..}
