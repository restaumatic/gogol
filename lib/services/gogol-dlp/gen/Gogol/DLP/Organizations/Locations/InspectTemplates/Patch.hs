...
newDLPOrganizationsLocationsInspectTemplatesPatch name payload
  = DLPOrganizationsLocationsInspectTemplatesPatch{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           DLPOrganizationsLocationsInspectTemplatesPatch
         where
        type Rs DLPOrganizationsLocationsInspectTemplatesPatch =
             GooglePrivacyDlpV2InspectTemplate
        type Scopes DLPOrganizationsLocationsInspectTemplatesPatch =
