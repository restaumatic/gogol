...
--
-- /See:/ <https://cloud.google.com/sensitive-data-protection/docs/ Sensitive Data Protection (DLP) Reference> for @dlp.organizations.storedInfoTypes.list@.
module Gogol.DLP.Organizations.StoredInfoTypes.List
    (
    -- * Resource
...
newDLPOrganizationsStoredInfoTypesList parent
  = DLPOrganizationsStoredInfoTypesList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DLPOrganizationsStoredInfoTypesList
         where
        ...
        requestClient DLPOrganizationsStoredInfoTypesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DLPOrganizationsStoredInfoTypesListResource)
                      Core.mempty
