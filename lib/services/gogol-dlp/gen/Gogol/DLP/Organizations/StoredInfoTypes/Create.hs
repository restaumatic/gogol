...
--
-- /See:/ <https://cloud.google.com/sensitive-data-protection/docs/ Sensitive Data Protection (DLP) Reference> for @dlp.organizations.storedInfoTypes.create@.
module Gogol.DLP.Organizations.StoredInfoTypes.Create
    (
    -- * Resource
...
instance Core.GoogleRequest DLPOrganizationsStoredInfoTypesCreate
        ...
        requestClient DLPOrganizationsStoredInfoTypesCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DLPOrganizationsStoredInfoTypesCreateResource)
                      Core.mempty
