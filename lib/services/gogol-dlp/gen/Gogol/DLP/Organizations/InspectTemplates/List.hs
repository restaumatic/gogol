...
--
-- /See:/ <https://cloud.google.com/sensitive-data-protection/docs/ Sensitive Data Protection (DLP) Reference> for @dlp.organizations.inspectTemplates.list@.
module Gogol.DLP.Organizations.InspectTemplates.List
    (
    -- * Resource
...
newDLPOrganizationsInspectTemplatesList parent
  = DLPOrganizationsInspectTemplatesList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DLPOrganizationsInspectTemplatesList
         where
        type Rs DLPOrganizationsInspectTemplatesList =
             GooglePrivacyDlpV2ListInspectTemplatesResponse
        type Scopes DLPOrganizationsInspectTemplatesList =
             '[CloudPlatform'FullControl]
        requestClient DLPOrganizationsInspectTemplatesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DLPOrganizationsInspectTemplatesListResource)
                      Core.mempty
