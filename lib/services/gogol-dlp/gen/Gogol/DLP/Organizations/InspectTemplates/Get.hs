...
newDLPOrganizationsInspectTemplatesGet name
  = DLPOrganizationsInspectTemplatesGet{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        name = name, uploadType = Core.Nothing,
                                        uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DLPOrganizationsInspectTemplatesGet
         where
        ...
        requestClient DLPOrganizationsInspectTemplatesGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DLPOrganizationsInspectTemplatesGetResource)
                      Core.mempty
