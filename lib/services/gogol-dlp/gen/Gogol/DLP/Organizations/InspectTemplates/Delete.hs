...
--
-- /See:/ <https://cloud.google.com/sensitive-data-protection/docs/ Sensitive Data Protection (DLP) Reference> for @dlp.organizations.inspectTemplates.delete@.
module Gogol.DLP.Organizations.InspectTemplates.Delete
    (
    -- * Resource
...
newDLPOrganizationsInspectTemplatesDelete name
  = DLPOrganizationsInspectTemplatesDelete{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           name = name, uploadType = Core.Nothing,
                                           uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DLPOrganizationsInspectTemplatesDelete
         where
        type Rs DLPOrganizationsInspectTemplatesDelete =
             GoogleProtobufEmpty
        type Scopes DLPOrganizationsInspectTemplatesDelete =
             '[CloudPlatform'FullControl]
        requestClient DLPOrganizationsInspectTemplatesDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DLPOrganizationsInspectTemplatesDeleteResource)
                      Core.mempty
