...
--
-- /See:/ <https://cloud.google.com/sensitive-data-protection/docs/ Sensitive Data Protection (DLP) Reference> for @dlp.organizations.inspectTemplates.create@.
module Gogol.DLP.Organizations.InspectTemplates.Create
    (
    -- * Resource
...
instance Core.GoogleRequest DLPOrganizationsInspectTemplatesCreate
        ...
        requestClient DLPOrganizationsInspectTemplatesCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DLPOrganizationsInspectTemplatesCreateResource)
                      Core.mempty
