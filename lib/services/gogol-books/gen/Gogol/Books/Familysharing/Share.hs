...
newBooksFamilysharingShare 
    ::  BooksFamilysharingShare
newBooksFamilysharingShare
  = BooksFamilysharingShare{xgafv = Core.Nothing,
                            accessToken = Core.Nothing, callback = Core.Nothing,
                            docId = Core.Nothing, source = Core.Nothing,
                            uploadType = Core.Nothing, uploadProtocol = Core.Nothing,
                            volumeId = Core.Nothing}
instance Core.GoogleRequest BooksFamilysharingShare where
        type Rs BooksFamilysharingShare = Empty
        type Scopes BooksFamilysharingShare = '[Books'FullControl]
        requestClient BooksFamilysharingShare{..}
          = go xgafv accessToken callback docId source uploadType
              uploadProtocol
              volumeId
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy BooksFamilysharingShareResource)
                      Core.mempty
