...
newBooksFamilysharingUnshare 
    ::  BooksFamilysharingUnshare
newBooksFamilysharingUnshare
  = BooksFamilysharingUnshare{xgafv = Core.Nothing,
...
instance Core.GoogleRequest BooksFamilysharingUnshare where
        ...
        type Scopes BooksFamilysharingUnshare = '[Books'FullControl]
        requestClient BooksFamilysharingUnshare{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy BooksFamilysharingUnshareResource)
                      Core.mempty
