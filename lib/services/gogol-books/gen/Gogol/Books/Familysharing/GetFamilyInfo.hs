...
newBooksFamilysharingGetFamilyInfo 
    :: 
                                   BooksFamilysharingGetFamilyInfo
newBooksFamilysharingGetFamilyInfo
  = BooksFamilysharingGetFamilyInfo{xgafv = Core.Nothing,
                                    accessToken = Core.Nothing, callback = Core.Nothing,
                                    source = Core.Nothing, uploadType = Core.Nothing,
                                    uploadProtocol = Core.Nothing}
instance Core.GoogleRequest BooksFamilysharingGetFamilyInfo where
        type Rs BooksFamilysharingGetFamilyInfo = FamilyInfo
        type Scopes BooksFamilysharingGetFamilyInfo = '[Books'FullControl]
        requestClient BooksFamilysharingGetFamilyInfo{..}
          = go xgafv accessToken callback source uploadType uploadProtocol
              (Core.Just Core.AltJSON)
              booksService
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy BooksFamilysharingGetFamilyInfoResource)
                      Core.mempty
