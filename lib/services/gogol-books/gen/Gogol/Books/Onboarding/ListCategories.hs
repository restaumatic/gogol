...
newBooksOnboardingListCategories 
    ::  BooksOnboardingListCategories
newBooksOnboardingListCategories
  = BooksOnboardingListCategories{xgafv = Core.Nothing,
                                  accessToken = Core.Nothing, callback = Core.Nothing,
                                  locale = Core.Nothing, uploadType = Core.Nothing,
                                  uploadProtocol = Core.Nothing}
instance Core.GoogleRequest BooksOnboardingListCategories where
        type Rs BooksOnboardingListCategories = Category
        type Scopes BooksOnboardingListCategories = '[Books'FullControl]
        requestClient BooksOnboardingListCategories{..}
          = go xgafv accessToken callback locale uploadType uploadProtocol
              (Core.Just Core.AltJSON)
              booksService
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy BooksOnboardingListCategoriesResource)
                      Core.mempty
