...
newBooksOnboardingListCategoryVolumes 
    :: 
                                      BooksOnboardingListCategoryVolumes
newBooksOnboardingListCategoryVolumes
  = BooksOnboardingListCategoryVolumes{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       categoryId = Core.Nothing, locale = Core.Nothing,
...
instance Core.GoogleRequest BooksOnboardingListCategoryVolumes
         where
        ...
        requestClient BooksOnboardingListCategoryVolumes{..}
          = go xgafv accessToken callback (categoryId Core.^. Core._Default)
              locale
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy BooksOnboardingListCategoryVolumesResource)
                      Core.mempty
