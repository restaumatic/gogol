                             ...
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.Get '[Core.JSON] Layersummaries
...
newBooksLayersList volumeId
  = BooksLayersList{xgafv = Core.Nothing, accessToken = Core.Nothing,
                    callback = Core.Nothing, contentVersion = Core.Nothing,
...
instance Core.GoogleRequest BooksLayersList where
        ...
        requestClient BooksLayersList{..}
          = go volumeId xgafv accessToken callback contentVersion maxResults
              pageToken
              source
              uploadType
              uploadProtocol
