                   ...
                   Core.QueryParam "contentVersion" Core.Text Core.:>
                     Core.QueryParam "$.xgafv" Xgafv Core.:>
                       Core.QueryParam "access_token" Core.Text Core.:>
                         Core.QueryParams "annotationDataId" Core.Text Core.:>
                           Core.QueryParam "callback" Core.Text Core.:>
                             Core.QueryParam "h" Core.Int32 Core.:>
                               Core.QueryParam "locale" Core.Text Core.:>
                                 Core.QueryParam "maxResults" Core.Word32 Core.:>
                                   Core.QueryParam "pageToken" Core.Text Core.:>
                                     Core.QueryParam "scale" Core.Int32 Core.:>
                                           ...
                                           Core.QueryParam "updatedMin" Core.Text Core.:>
                                             Core.QueryParam "uploadType" Core.Text Core.:>
                                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                                 Core.QueryParam "w" Core.Int32 Core.:>
                                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                                     Core.Get '[Core.JSON] Annotationsdata
...
newBooksLayersAnnotationDataList contentVersion layerId volumeId
  = BooksLayersAnnotationDataList{xgafv = Core.Nothing,
                                  accessToken = Core.Nothing, annotationDataId = Core.Nothing,
                                  callback = Core.Nothing, contentVersion = contentVersion,
                                  h = Core.Nothing, layerId = layerId, locale = Core.Nothing,
                                  maxResults = Core.Nothing, pageToken = Core.Nothing,
                                  scale = Core.Nothing, source = Core.Nothing,
                                  updatedMax = Core.Nothing, updatedMin = Core.Nothing,
                                  uploadType = Core.Nothing, uploadProtocol = Core.Nothing,
                                  volumeId = volumeId, w = Core.Nothing}
instance Core.GoogleRequest BooksLayersAnnotationDataList where
        type Rs BooksLayersAnnotationDataList = Annotationsdata
        type Scopes BooksLayersAnnotationDataList = '[Books'FullControl]
        requestClient BooksLayersAnnotationDataList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy BooksLayersAnnotationDataListResource)
                      Core.mempty
