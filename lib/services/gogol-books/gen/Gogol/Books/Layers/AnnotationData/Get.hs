           ...
           Core.Capture "volumeId" Core.Text Core.:>
             "layers" Core.:>
               Core.Capture "layerId" Core.Text Core.:>
                 "data" Core.:>
                   Core.Capture "annotationDataId" Core.Text Core.:>
                     Core.QueryParam "contentVersion" Core.Text Core.:>
                       Core.QueryParam "$.xgafv" Xgafv Core.:>
                         Core.QueryParam "access_token" Core.Text Core.:>
                           Core.QueryParam "allowWebDefinitions" Core.Bool Core.:>
                                         ...
                                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                                           Core.QueryParam "w" Core.Int32 Core.:>
                                             Core.QueryParam "alt" Core.AltJSON Core.:>
                                               Core.Get '[Core.JSON] DictionaryAnnotationdata
...
newBooksLayersAnnotationDataGet 
    ...
    -> BooksLayersAnnotationDataGet
newBooksLayersAnnotationDataGet annotationDataId contentVersion
  layerId volumeId
  = BooksLayersAnnotationDataGet{xgafv = Core.Nothing,
                                 accessToken = Core.Nothing, allowWebDefinitions = Core.Nothing,
                                 annotationDataId = annotationDataId, callback = Core.Nothing,
                                 contentVersion = contentVersion, h = Core.Nothing,
                                 layerId = layerId, locale = Core.Nothing, scale = Core.Nothing,
                                 source = Core.Nothing, uploadType = Core.Nothing,
                                 uploadProtocol = Core.Nothing, volumeId = volumeId,
                                 w = Core.Nothing}
instance Core.GoogleRequest BooksLayersAnnotationDataGet where
        ...
        requestClient BooksLayersAnnotationDataGet{..}
          = go volumeId layerId annotationDataId (Core.Just contentVersion)
              xgafv
              accessToken
              allowWebDefinitions
              callback
