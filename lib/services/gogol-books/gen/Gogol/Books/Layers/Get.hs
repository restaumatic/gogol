       ...
       "v1" Core.:>
         "volumes" Core.:>
           Core.Capture "volumeId" Core.Text Core.:>
             "layersummary" Core.:>
               Core.Capture "summaryId" Core.Text Core.:>
                           ...
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.Get '[Core.JSON] Layersummary
...
newBooksLayersGet summaryId volumeId
  = BooksLayersGet{xgafv = Core.Nothing, accessToken = Core.Nothing,
                   callback = Core.Nothing, contentVersion = Core.Nothing,
                   source = Core.Nothing, summaryId = summaryId,
...
instance Core.GoogleRequest BooksLayersGet where
        ...
        requestClient BooksLayersGet{..}
          = go volumeId summaryId xgafv accessToken callback contentVersion
              source
              uploadType
              uploadProtocol
