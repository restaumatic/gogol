                     ...
                     Core.QueryParam "access_token" Core.Text Core.:>
                       Core.QueryParam "callback" Core.Text Core.:>
                         Core.QueryParam "endOffset" Core.Text Core.:>
                           Core.QueryParam "endPosition" Core.Text Core.:>
                                   ...
                                   Core.QueryParam "showDeleted" Core.Bool Core.:>
                                     Core.QueryParam "source" Core.Text Core.:>
                                       Core.QueryParam "startOffset" Core.Text Core.:>
                                         Core.QueryParam "startPosition" Core.Text Core.:>
                                           Core.QueryParam "updatedMax" Core.Text Core.:>
                                             Core.QueryParam "updatedMin" Core.Text Core.:>
                                               Core.QueryParam "uploadType" Core.Text Core.:>
                                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                                   Core.QueryParam "volumeAnnotationsVersion"
                                                     Core.Text
                                                     Core.:>
                                                     Core.QueryParam "alt" Core.AltJSON Core.:>
                                                       Core.Get '[Core.JSON] Volumeannotations
...
newBooksLayersVolumeAnnotationsList contentVersion layerId volumeId
  = BooksLayersVolumeAnnotationsList{xgafv = Core.Nothing,
                                     accessToken = Core.Nothing, callback = Core.Nothing,
                                     contentVersion = contentVersion, endOffset = Core.Nothing,
                                     endPosition = Core.Nothing, layerId = layerId,
                                     locale = Core.Nothing, maxResults = Core.Nothing,
                                     pageToken = Core.Nothing, showDeleted = Core.Nothing,
                                     source = Core.Nothing, startOffset = Core.Nothing,
                                     startPosition = Core.Nothing, updatedMax = Core.Nothing,
                                     updatedMin = Core.Nothing, uploadType = Core.Nothing,
                                     uploadProtocol = Core.Nothing,
                                     volumeAnnotationsVersion = Core.Nothing, volumeId = volumeId}
instance Core.GoogleRequest BooksLayersVolumeAnnotationsList where
        type Rs BooksLayersVolumeAnnotationsList = Volumeannotations
        type Scopes BooksLayersVolumeAnnotationsList = '[Books'FullControl]
        requestClient BooksLayersVolumeAnnotationsList{..}
          = go volumeId layerId (Core.Just contentVersion) xgafv accessToken
              callback
              endOffset
              endPosition
              locale
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy BooksLayersVolumeAnnotationsListResource)
                      Core.mempty
