...
newBooksLayersVolumeAnnotationsGet annotationId layerId volumeId
  = BooksLayersVolumeAnnotationsGet{xgafv = Core.Nothing,
                                    accessToken = Core.Nothing, annotationId = annotationId,
                                    callback = Core.Nothing, layerId = layerId,
                                    locale = Core.Nothing, source = Core.Nothing,
                                    uploadType = Core.Nothing, uploadProtocol = Core.Nothing,
                                    volumeId = volumeId}
instance Core.GoogleRequest BooksLayersVolumeAnnotationsGet where
        type Rs BooksLayersVolumeAnnotationsGet = Volumeannotation
        type Scopes BooksLayersVolumeAnnotationsGet = '[Books'FullControl]
        requestClient BooksLayersVolumeAnnotationsGet{..}
          = go volumeId layerId annotationId xgafv accessToken callback
              locale
              source
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy BooksLayersVolumeAnnotationsGetResource)
                      Core.mempty
