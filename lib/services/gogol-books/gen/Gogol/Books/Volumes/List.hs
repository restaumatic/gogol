             ...
             Core.QueryParam "$.xgafv" Xgafv Core.:>
               Core.QueryParam "access_token" Core.Text Core.:>
                 Core.QueryParam "callback" Core.Text Core.:>
                   Core.QueryParam "download" VolumesListDownload Core.:>
                     Core.QueryParam "filter" VolumesListFilter Core.:>
                       Core.QueryParam "langRestrict" Core.Text Core.:>
                         Core.QueryParam "libraryRestrict" VolumesListLibraryRestrict
                           Core.:>
                           Core.QueryParam "maxAllowedMaturityRating"
                             VolumesListMaxAllowedMaturityRating
                             Core.:>
                             Core.QueryParam "maxResults" Core.Word32 Core.:>
                               Core.QueryParam "orderBy" VolumesListOrderBy Core.:>
                                 Core.QueryParam "partner" Core.Text Core.:>
                                   Core.QueryParam "printType" VolumesListPrintType Core.:>
                                     Core.QueryParam "projection" VolumesListProjection Core.:>
                                       Core.QueryParam "showPreorders" Core.Bool Core.:>
                                         Core.QueryParam "source" Core.Text Core.:>
                                           Core.QueryParam "startIndex" Core.Word32 Core.:>
                                             Core.QueryParam "uploadType" Core.Text Core.:>
                                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                                   Core.Get '[Core.JSON] Volumes
...
newBooksVolumesList q
  = BooksVolumesList{xgafv = Core.Nothing,
                     accessToken = Core.Nothing, callback = Core.Nothing,
                     download = Core.Nothing, filter = Core.Nothing,
                     langRestrict = Core.Nothing, libraryRestrict = Core.Nothing,
                     maxAllowedMaturityRating = Core.Nothing, maxResults = Core.Nothing,
                     orderBy = Core.Nothing, partner = Core.Nothing,
                     printType = Core.Nothing, projection = Core.Nothing, q = q,
                     showPreorders = Core.Nothing, source = Core.Nothing,
                     startIndex = Core.Nothing, uploadType = Core.Nothing,
...
instance Core.GoogleRequest BooksVolumesList where
        ...
        requestClient BooksVolumesList{..}
          = go (Core.Just q) xgafv accessToken callback download filter
              langRestrict
              libraryRestrict
