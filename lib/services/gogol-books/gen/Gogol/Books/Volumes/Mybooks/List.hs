           ...
           "mybooks" Core.:>
             Core.QueryParam "$.xgafv" Xgafv Core.:>
               Core.QueryParam "access_token" Core.Text Core.:>
                 Core.QueryParams "acquireMethod" VolumesMybooksListAcquireMethod
                   Core.:>
                     ...
                     Core.QueryParam "country" Core.Text Core.:>
                       Core.QueryParam "locale" Core.Text Core.:>
                         Core.QueryParam "maxResults" Core.Word32 Core.:>
                           Core.QueryParams "processingState"
...
newBooksVolumesMybooksList 
    ::  BooksVolumesMybooksList
newBooksVolumesMybooksList
  = BooksVolumesMybooksList{xgafv = Core.Nothing,
                            accessToken = Core.Nothing, acquireMethod = Core.Nothing,
                            callback = Core.Nothing, country = Core.Nothing,
                            locale = Core.Nothing, maxResults = Core.Nothing,
                            processingState = Core.Nothing, source = Core.Nothing,
...
instance Core.GoogleRequest BooksVolumesMybooksList where
        ...
        requestClient BooksVolumesMybooksList{..}
          = go xgafv accessToken (acquireMethod Core.^. Core._Default)
              callback
              country
              locale
              maxResults
