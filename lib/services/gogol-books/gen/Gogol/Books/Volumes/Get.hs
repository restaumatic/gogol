                   ...
                   Core.QueryParam "country" Core.Text Core.:>
                     Core.QueryParam "includeNonComicsSeries" Core.Bool Core.:>
                       Core.QueryParam "partner" Core.Text Core.:>
                         Core.QueryParam "projection" VolumesGetProjection Core.:>
                           Core.QueryParam "source" Core.Text Core.:>
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "user_library_consistent_read" Core.Bool Core.:>
...
newBooksVolumesGet volumeId
  = BooksVolumesGet{xgafv = Core.Nothing, accessToken = Core.Nothing,
                    callback = Core.Nothing, country = Core.Nothing,
                    includeNonComicsSeries = Core.Nothing, partner = Core.Nothing,
                    projection = Core.Nothing, source = Core.Nothing,
                    uploadType = Core.Nothing, uploadProtocol = Core.Nothing,
                    userLibraryConsistentRead = Core.Nothing, volumeId = volumeId}
