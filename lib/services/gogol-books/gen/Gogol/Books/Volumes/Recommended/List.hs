...
newBooksVolumesRecommendedList 
    ::  BooksVolumesRecommendedList
newBooksVolumesRecommendedList
  = BooksVolumesRecommendedList{xgafv = Core.Nothing,
                                accessToken = Core.Nothing, callback = Core.Nothing,
                                locale = Core.Nothing, maxAllowedMaturityRating = Core.Nothing,
                                source = Core.Nothing, uploadType = Core.Nothing,
                                uploadProtocol = Core.Nothing}
instance Core.GoogleRequest BooksVolumesRecommendedList where
        type Rs BooksVolumesRecommendedList = Volumes
        type Scopes BooksVolumesRecommendedList = '[Books'FullControl]
        requestClient BooksVolumesRecommendedList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy BooksVolumesRecommendedListResource)
                      Core.mempty
