             ...
             "associated" Core.:>
               Core.QueryParam "$.xgafv" Xgafv Core.:>
                 Core.QueryParam "access_token" Core.Text Core.:>
                   Core.QueryParam "association" VolumesAssociatedListAssociation
                     Core.:>
...
newBooksVolumesAssociatedList volumeId
  = BooksVolumesAssociatedList{xgafv = Core.Nothing,
                               accessToken = Core.Nothing, association = Core.Nothing,
                               callback = Core.Nothing, locale = Core.Nothing,
                               maxAllowedMaturityRating = Core.Nothing, source = Core.Nothing,
...
instance Core.GoogleRequest BooksVolumesAssociatedList where
        ...
        requestClient BooksVolumesAssociatedList{..}
          = go volumeId xgafv accessToken association callback locale
