...
type BooksNotificationGetResource =
     "books" Core.:>
       "v1" Core.:>
         "notification" Core.:>
           "get" Core.:>
             Core.QueryParam "notification_id" Core.Text Core.:>
...
newBooksNotificationGet notificationId
  = BooksNotificationGet{xgafv = Core.Nothing,
                         accessToken = Core.Nothing, callback = Core.Nothing,
                         locale = Core.Nothing, notificationId = notificationId,
...
instance Core.GoogleRequest BooksNotificationGet where
        ...
        requestClient BooksNotificationGet{..}
          = go (Core.Just notificationId) xgafv accessToken callback locale
              source
              uploadType
              uploadProtocol
