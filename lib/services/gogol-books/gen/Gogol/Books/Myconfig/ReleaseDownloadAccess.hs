                           ...
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.Post '[Core.JSON] DownloadAccesses
...
newBooksMyconfigReleaseDownloadAccess cpksver volumeIds
  = BooksMyconfigReleaseDownloadAccess{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       cpksver = cpksver, locale = Core.Nothing,
                                       source = Core.Nothing, uploadType = Core.Nothing,
                                       uploadProtocol = Core.Nothing, volumeIds = volumeIds}
instance Core.GoogleRequest BooksMyconfigReleaseDownloadAccess
         where
        type Rs BooksMyconfigReleaseDownloadAccess = DownloadAccesses
        type Scopes BooksMyconfigReleaseDownloadAccess =
             '[Books'FullControl]
        requestClient BooksMyconfigReleaseDownloadAccess{..}
          = go (Core.Just cpksver) volumeIds xgafv accessToken callback
              locale
              source
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy BooksMyconfigReleaseDownloadAccessResource)
                      Core.mempty
