               ...
               Core.QueryParam "access_token" Core.Text Core.:>
                 Core.QueryParam "callback" Core.Text Core.:>
                   Core.QueryParam "contentVersion" Core.Text Core.:>
                     Core.QueryParam "layerId" Core.Text Core.:>
                                       ...
                                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                                         Core.QueryParam "volumeId" Core.Text Core.:>
                                           Core.QueryParam "alt" Core.AltJSON Core.:>
                                             Core.Get '[Core.JSON] Annotations
...
newBooksMylibraryAnnotationsList 
    ::  BooksMylibraryAnnotationsList
newBooksMylibraryAnnotationsList
  = BooksMylibraryAnnotationsList{xgafv = Core.Nothing,
                                  accessToken = Core.Nothing, callback = Core.Nothing,
                                  contentVersion = Core.Nothing, layerId = Core.Nothing,
                                  layerIds = Core.Nothing, maxResults = Core.Nothing,
                                  pageToken = Core.Nothing, showDeleted = Core.Nothing,
                                  source = Core.Nothing, updatedMax = Core.Nothing,
                                  updatedMin = Core.Nothing, uploadType = Core.Nothing,
                                  uploadProtocol = Core.Nothing, volumeId = Core.Nothing}
instance Core.GoogleRequest BooksMylibraryAnnotationsList where
        type Rs BooksMylibraryAnnotationsList = Annotations
        type Scopes BooksMylibraryAnnotationsList = '[Books'FullControl]
        requestClient BooksMylibraryAnnotationsList{..}
          = go xgafv accessToken callback contentVersion layerId
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy BooksMylibraryAnnotationsListResource)
                      Core.mempty
