...
newBooksMylibraryAnnotationsInsert payload
  = BooksMylibraryAnnotationsInsert{xgafv = Core.Nothing,
                                    accessToken = Core.Nothing, annotationId = Core.Nothing,
                                    callback = Core.Nothing, country = Core.Nothing,
                                    payload = payload, showOnlySummaryInResponse = Core.Nothing,
                                    source = Core.Nothing, uploadType = Core.Nothing,
                                    uploadProtocol = Core.Nothing}
instance Core.GoogleRequest BooksMylibraryAnnotationsInsert where
        type Rs BooksMylibraryAnnotationsInsert = Annotation
        type Scopes BooksMylibraryAnnotationsInsert = '[Books'FullControl]
        requestClient BooksMylibraryAnnotationsInsert{..}
          = go xgafv accessToken annotationId callback country
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy BooksMylibraryAnnotationsInsertResource)
                      Core.mempty
