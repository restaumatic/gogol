                   ...
                   Core.QueryParam "$.xgafv" Xgafv Core.:>
                     Core.QueryParam "access_token" Core.Text Core.:>
                       Core.QueryParam "callback" Core.Text Core.:>
                         Core.QueryParam "reason" MylibraryBookshelvesAddVolumeReason
                           Core.:>
...
newBooksMylibraryBookshelvesAddVolume shelf volumeId
  = BooksMylibraryBookshelvesAddVolume{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       reason = Core.Nothing, shelf = shelf, source = Core.Nothing,
                                       uploadType = Core.Nothing, uploadProtocol = Core.Nothing,
                                       volumeId = volumeId}
instance Core.GoogleRequest BooksMylibraryBookshelvesAddVolume
         where
        ...
        requestClient BooksMylibraryBookshelvesAddVolume{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy BooksMylibraryBookshelvesAddVolumeResource)
                      Core.mempty
