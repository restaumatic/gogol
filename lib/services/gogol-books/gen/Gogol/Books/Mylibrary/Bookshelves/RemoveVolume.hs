                   ...
                   Core.QueryParam "$.xgafv" Xgafv Core.:>
                     Core.QueryParam "access_token" Core.Text Core.:>
                       Core.QueryParam "callback" Core.Text Core.:>
                         Core.QueryParam "reason" MylibraryBookshelvesRemoveVolumeReason
                           Core.:>
...
newBooksMylibraryBookshelvesRemoveVolume shelf volumeId
  = BooksMylibraryBookshelvesRemoveVolume{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          reason = Core.Nothing, shelf = shelf,
                                          source = Core.Nothing, uploadType = Core.Nothing,
                                          uploadProtocol = Core.Nothing, volumeId = volumeId}
instance Core.GoogleRequest BooksMylibraryBookshelvesRemoveVolume
         where
        type Rs BooksMylibraryBookshelvesRemoveVolume = Empty
        type Scopes BooksMylibraryBookshelvesRemoveVolume =
             '[Books'FullControl]
        requestClient BooksMylibraryBookshelvesRemoveVolume{..}
          = go shelf (Core.Just volumeId) xgafv accessToken callback reason
              source
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy BooksMylibraryBookshelvesRemoveVolumeResource)
                      Core.mempty
