...
newBooksMylibraryBookshelvesClearVolumes shelf
  = BooksMylibraryBookshelvesClearVolumes{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          shelf = shelf, source = Core.Nothing,
                                          uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest BooksMylibraryBookshelvesClearVolumes
         where
        ...
        requestClient BooksMylibraryBookshelvesClearVolumes{..}
          = go shelf xgafv accessToken callback source uploadType
              uploadProtocol
