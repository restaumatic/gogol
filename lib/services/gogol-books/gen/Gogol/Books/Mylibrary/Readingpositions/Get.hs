                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Get '[Core.JSON] ReadingPosition
...
newBooksMylibraryReadingpositionsGet volumeId
  = BooksMylibraryReadingpositionsGet{xgafv = Core.Nothing,
                                      accessToken = Core.Nothing, callback = Core.Nothing,
                                      contentVersion = Core.Nothing, source = Core.Nothing,
                                      uploadType = Core.Nothing, uploadProtocol = Core.Nothing,
                                      volumeId = volumeId}
instance Core.GoogleRequest BooksMylibraryReadingpositionsGet where
        type Rs BooksMylibraryReadingpositionsGet = ReadingPosition
        type Scopes BooksMylibraryReadingpositionsGet =
             '[Books'FullControl]
        requestClient BooksMylibraryReadingpositionsGet{..}
          = go volumeId xgafv accessToken callback contentVersion source
              uploadType
              uploadProtocol
