...
newAnnotation 
    ::  Annotation
newAnnotation
  = Annotation{afterSelectedText = Core.Nothing,
               beforeSelectedText = Core.Nothing,
               clientVersionRanges = Core.Nothing, created = Core.Nothing,
               currentVersionRanges = Core.Nothing, data' = Core.Nothing,
               deleted = Core.Nothing, highlightStyle = Core.Nothing,
               id = Core.Nothing, kind = Core.Nothing, layerId = Core.Nothing,
               layerSummary = Core.Nothing, pageIds = Core.Nothing,
               selectedText = Core.Nothing, selfLink = Core.Nothing,
               updated = Core.Nothing, volumeId = Core.Nothing}
instance Core.FromJSON Annotation where
        parseJSON
          = Core.withObject "Annotation"
              (\ o ->
                 Annotation Core.<$>
                   (o Core..:? "afterSelectedText") Core.<*>
                     (o Core..:? "beforeSelectedText")
...
newAnnotation_ClientVersionRanges 
    ::  Annotation_ClientVersionRanges
newAnnotation_ClientVersionRanges
  = Annotation_ClientVersionRanges{cfiRange = Core.Nothing,
                                   contentVersion = Core.Nothing, gbImageRange = Core.Nothing,
                                   gbTextRange = Core.Nothing, imageCfiRange = Core.Nothing}
instance Core.FromJSON Annotation_ClientVersionRanges where
        parseJSON
          = Core.withObject "Annotation_ClientVersionRanges"
              (\ o ->
                 Annotation_ClientVersionRanges Core.<$>
                   (o Core..:? "cfiRange") Core.<*> (o Core..:? "contentVersion")
...
newAnnotation_CurrentVersionRanges 
    :: 
                                   Annotation_CurrentVersionRanges
newAnnotation_CurrentVersionRanges
  = Annotation_CurrentVersionRanges{cfiRange = Core.Nothing,
                                    contentVersion = Core.Nothing, gbImageRange = Core.Nothing,
                                    gbTextRange = Core.Nothing, imageCfiRange = Core.Nothing}
instance Core.FromJSON Annotation_CurrentVersionRanges where
        parseJSON
          = Core.withObject "Annotation_CurrentVersionRanges"
              (\ o ->
                 Annotation_CurrentVersionRanges Core.<$>
                   (o Core..:? "cfiRange") Core.<*> (o Core..:? "contentVersion")
                     Core.<*> (o Core..:? "gbImageRange")
                     Core.<*> (o Core..:? "gbTextRange")
                     Core.<*> (o Core..:? "imageCfiRange"))
...
newAnnotation_LayerSummary 
    ::  Annotation_LayerSummary
newAnnotation_LayerSummary
  = Annotation_LayerSummary{allowedCharacterCount = Core.Nothing,
                            limitType = Core.Nothing, remainingCharacterCount = Core.Nothing}
instance Core.FromJSON Annotation_LayerSummary where
        parseJSON
          = Core.withObject "Annotation_LayerSummary"
              (\ o ->
                 Annotation_LayerSummary Core.<$>
                   (o Core..:? "allowedCharacterCount") Core.<*>
                     (o Core..:? "limitType")
          ...
          = Core.object
              (Core.catMaybes
                 [("allowedCharacterCount" Core..=) Core.<$> allowedCharacterCount,
                  ...
                  ("remainingCharacterCount" Core..=) Core.<$>
...
newAnnotations 
    ::  Annotations
newAnnotations
  = Annotations{items = Core.Nothing, kind = Core.Nothing,
                nextPageToken = Core.Nothing, totalItems = Core.Nothing}
instance Core.FromJSON Annotations where
        parseJSON
          = Core.withObject "Annotations"
              (\ o ->
                 Annotations Core.<$>
...
instance Core.FromJSON AnnotationsSummary where
        parseJSON
          = Core.withObject "AnnotationsSummary"
              (\ o ->
                 AnnotationsSummary Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "layers"))
...
newAnnotationsSummary_LayersItem 
    ::  AnnotationsSummary_LayersItem
newAnnotationsSummary_LayersItem
  = AnnotationsSummary_LayersItem{allowedCharacterCount =
                                    Core.Nothing,
                                  layerId = Core.Nothing, limitType = Core.Nothing,
                                  remainingCharacterCount = Core.Nothing, updated = Core.Nothing}
instance Core.FromJSON AnnotationsSummary_LayersItem where
        parseJSON
          = Core.withObject "AnnotationsSummary_LayersItem"
              (\ o ->
                 AnnotationsSummary_LayersItem Core.<$>
                   (o Core..:? "allowedCharacterCount") Core.<*>
                     (o Core..:? "layerId")
...
newAnnotationsdata 
    ::  Annotationsdata
newAnnotationsdata
  = Annotationsdata{items = Core.Nothing, kind = Core.Nothing,
                    nextPageToken = Core.Nothing, totalItems = Core.Nothing}
instance Core.FromJSON Annotationsdata where
        parseJSON
          = Core.withObject "Annotationsdata"
              (\ o ->
                 Annotationsdata Core.<$>
                   (o Core..:? "items") Core.<*> (o Core..:? "kind") Core.<*>
                     (o Core..:? "nextPageToken")
                     Core.<*> (o Core..:? "totalItems"))
...
newBooksAnnotationsRange 
    ::  BooksAnnotationsRange
newBooksAnnotationsRange
  = BooksAnnotationsRange{endOffset = Core.Nothing,
                          endPosition = Core.Nothing, startOffset = Core.Nothing,
                          startPosition = Core.Nothing}
instance Core.FromJSON BooksAnnotationsRange where
        parseJSON
          = Core.withObject "BooksAnnotationsRange"
              (\ o ->
                 BooksAnnotationsRange Core.<$>
                   (o Core..:? "endOffset") Core.<*> (o Core..:? "endPosition")
...
newBooksCloudloadingResource 
    ::  BooksCloudloadingResource
newBooksCloudloadingResource
  = BooksCloudloadingResource{author = Core.Nothing,
                              processingState = Core.Nothing, title = Core.Nothing,
                              volumeId = Core.Nothing}
instance Core.FromJSON BooksCloudloadingResource where
        parseJSON
          = Core.withObject "BooksCloudloadingResource"
              (\ o ->
                 BooksCloudloadingResource Core.<$>
                   (o Core..:? "author") Core.<*> (o Core..:? "processingState")
                     Core.<*> (o Core..:? "title")
                     Core.<*> (o Core..:? "volumeId"))
...
newBooksVolumesRecommendedRateResponse 
    :: 
                                       BooksVolumesRecommendedRateResponse
newBooksVolumesRecommendedRateResponse
  = BooksVolumesRecommendedRateResponse{consistencyToken =
                                          Core.Nothing}
instance Core.FromJSON BooksVolumesRecommendedRateResponse where
        parseJSON
          = Core.withObject "BooksVolumesRecommendedRateResponse"
              (\ o ->
                 BooksVolumesRecommendedRateResponse Core.<$>
                   (o Core..:? "consistency_token"))
...
newBookshelf 
    ::  Bookshelf
newBookshelf
  = Bookshelf{access = Core.Nothing, created = Core.Nothing,
              description = Core.Nothing, id = Core.Nothing, kind = Core.Nothing,
              selfLink = Core.Nothing, title = Core.Nothing,
              updated = Core.Nothing, volumeCount = Core.Nothing,
              volumesLastUpdated = Core.Nothing}
instance Core.FromJSON Bookshelf where
        parseJSON
          = Core.withObject "Bookshelf"
              (\ o ->
                 Bookshelf Core.<$>
                   (o Core..:? "access") Core.<*> (o Core..:? "created") Core.<*>
                     (o Core..:? "description")
                     Core.<*> (o Core..:? "id")
                     Core.<*> (o Core..:? "kind")
                     Core.<*> (o Core..:? "selfLink")
...
newCategory_ItemsItem 
    ::  Category_ItemsItem
newCategory_ItemsItem
  = Category_ItemsItem{badgeUrl = Core.Nothing,
                       categoryId = Core.Nothing, name = Core.Nothing}
instance Core.FromJSON Category_ItemsItem where
        parseJSON
          = Core.withObject "Category_ItemsItem"
              (\ o ->
                 Category_ItemsItem Core.<$>
                   (o Core..:? "badgeUrl") Core.<*> (o Core..:? "categoryId") Core.<*>
                     (o Core..:? "name"))
...
newConcurrentAccessRestriction 
    ::  ConcurrentAccessRestriction
newConcurrentAccessRestriction
  = ConcurrentAccessRestriction{deviceAllowed = Core.Nothing,
                                kind = Core.Nothing, maxConcurrentDevices = Core.Nothing,
                                message = Core.Nothing, nonce = Core.Nothing,
                                reasonCode = Core.Nothing, restricted = Core.Nothing,
                                signature = Core.Nothing, source = Core.Nothing,
                                timeWindowSeconds = Core.Nothing, volumeId = Core.Nothing}
instance Core.FromJSON ConcurrentAccessRestriction where
        parseJSON
          = Core.withObject "ConcurrentAccessRestriction"
              (\ o ->
                 ConcurrentAccessRestriction Core.<$>
                   (o Core..:? "deviceAllowed") Core.<*> (o Core..:? "kind") Core.<*>
                     (o Core..:? "maxConcurrentDevices")
                     Core.<*> (o Core..:? "message")
                     Core.<*> (o Core..:? "nonce")
...
newDictionaryAnnotationdata 
    ::  DictionaryAnnotationdata
newDictionaryAnnotationdata
  = DictionaryAnnotationdata{annotationType = Core.Nothing,
                             data' = Core.Nothing, encodedData = Core.Nothing,
                             id = Core.Nothing, kind = Core.Nothing, layerId = Core.Nothing,
                             selfLink = Core.Nothing, updated = Core.Nothing,
                             volumeId = Core.Nothing}
instance Core.FromJSON DictionaryAnnotationdata where
        parseJSON
          = Core.withObject "DictionaryAnnotationdata"
              (\ o ->
                 DictionaryAnnotationdata Core.<$>
                   (o Core..:? "annotationType") Core.<*> (o Core..:? "data") Core.<*>
                     (o Core..:? "encodedData")
                     Core.<*> (o Core..:? "id")
                     Core.<*> (o Core..:? "kind")
                     Core.<*> (o Core..:? "layerId")
...
newDictlayerdata 
    ::  Dictlayerdata
newDictlayerdata
  = Dictlayerdata{common = Core.Nothing, dict = Core.Nothing,
                  kind = Core.Nothing}
instance Core.FromJSON Dictlayerdata where
        parseJSON
          = Core.withObject "Dictlayerdata"
              (\ o ->
                 Dictlayerdata Core.<$>
                   (o Core..:? "common") Core.<*> (o Core..:? "dict") Core.<*>
                     (o Core..:? "kind"))
          ...
          = Core.object
              (Core.catMaybes
                 [("common" Core..=) Core.<$> common,
                  ("dict" Core..=) Core.<$> dict, ("kind" Core..=) Core.<$> kind])
...
instance Core.FromJSON Dictlayerdata_Common where
        parseJSON
          = Core.withObject "Dictlayerdata_Common"
...
instance Core.FromJSON Dictlayerdata_Dict where
        parseJSON
          = Core.withObject "Dictlayerdata_Dict"
              (\ o ->
                 Dictlayerdata_Dict Core.<$>
                   (o Core..:? "source") Core.<*> (o Core..:? "words"))
...
newDictlayerdata_Dict_Source 
    ::  Dictlayerdata_Dict_Source
newDictlayerdata_Dict_Source
  = Dictlayerdata_Dict_Source{attribution = Core.Nothing,
                              url = Core.Nothing}
instance Core.FromJSON Dictlayerdata_Dict_Source where
        parseJSON
          = Core.withObject "Dictlayerdata_Dict_Source"
              (\ o ->
                 Dictlayerdata_Dict_Source Core.<$>
                   (o Core..:? "attribution") Core.<*> (o Core..:? "url"))
...
newDictlayerdata_Dict_WordsItem 
    ::  Dictlayerdata_Dict_WordsItem
newDictlayerdata_Dict_WordsItem
  = Dictlayerdata_Dict_WordsItem{derivatives = Core.Nothing,
                                 examples = Core.Nothing, senses = Core.Nothing,
                                 source = Core.Nothing}
instance Core.FromJSON Dictlayerdata_Dict_WordsItem where
        parseJSON
          = Core.withObject "Dictlayerdata_Dict_WordsItem"
              (\ o ->
                 Dictlayerdata_Dict_WordsItem Core.<$>
                   (o Core..:? "derivatives") Core.<*> (o Core..:? "examples")
                     Core.<*> (o Core..:? "senses")
                     Core.<*> (o Core..:? "source"))
...
newDictlayerdata_Dict_WordsItem_DerivativesItem 
    :: 
                                                Dictlayerdata_Dict_WordsItem_DerivativesItem
newDictlayerdata_Dict_WordsItem_DerivativesItem
  = Dictlayerdata_Dict_WordsItem_DerivativesItem{source =
                                                   Core.Nothing,
                                                 text = Core.Nothing}
instance Core.FromJSON Dictlayerdata_Dict_WordsItem_DerivativesItem
         where
        parseJSON
          = Core.withObject "Dictlayerdata_Dict_WordsItem_DerivativesItem"
              (\ o ->
                 Dictlayerdata_Dict_WordsItem_DerivativesItem Core.<$>
                   (o Core..:? "source") Core.<*> (o Core..:? "text"))

instance Core.ToJSON Dictlayerdata_Dict_WordsItem_DerivativesItem
         where
...
newDictlayerdata_Dict_WordsItem_DerivativesItem_Source 
    :: 
                                                       Dictlayerdata_Dict_WordsItem_DerivativesItem_Source
newDictlayerdata_Dict_WordsItem_DerivativesItem_Source
  = Dictlayerdata_Dict_WordsItem_DerivativesItem_Source{attribution =
                                                          Core.Nothing,
                                                        url = Core.Nothing}
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "Dictlayerdata_Dict_WordsItem_DerivativesItem_Source"
              (\ o ->
                 Dictlayerdata_Dict_WordsItem_DerivativesItem_Source Core.<$>
                   (o Core..:? "attribution") Core.<*> (o Core..:? "url"))
...
newDictlayerdata_Dict_WordsItem_ExamplesItem 
    :: 
                                             Dictlayerdata_Dict_WordsItem_ExamplesItem
newDictlayerdata_Dict_WordsItem_ExamplesItem
  = Dictlayerdata_Dict_WordsItem_ExamplesItem{source = Core.Nothing,
                                              text = Core.Nothing}
instance Core.FromJSON Dictlayerdata_Dict_WordsItem_ExamplesItem
         where
        parseJSON
          = Core.withObject "Dictlayerdata_Dict_WordsItem_ExamplesItem"
              (\ o ->
                 Dictlayerdata_Dict_WordsItem_ExamplesItem Core.<$>
                   (o Core..:? "source") Core.<*> (o Core..:? "text"))

instance Core.ToJSON Dictlayerdata_Dict_WordsItem_ExamplesItem
         where
...
newDictlayerdata_Dict_WordsItem_ExamplesItem_Source 
    :: 
                                                    Dictlayerdata_Dict_WordsItem_ExamplesItem_Source
newDictlayerdata_Dict_WordsItem_ExamplesItem_Source
  = Dictlayerdata_Dict_WordsItem_ExamplesItem_Source{attribution =
                                                       Core.Nothing,
                                                     url = Core.Nothing}
instance Core.FromJSON
           Dictlayerdata_Dict_WordsItem_ExamplesItem_Source
        ...
        parseJSON
          = Core.withObject
              "Dictlayerdata_Dict_WordsItem_ExamplesItem_Source"
              (\ o ->
                 Dictlayerdata_Dict_WordsItem_ExamplesItem_Source Core.<$>
                   (o Core..:? "attribution") Core.<*> (o Core..:? "url"))
...
data Dictlayerdata_Dict_WordsItem_SensesItem = Dictlayerdata_Dict_WordsItem_SensesItem
    {
      ...
      conjugations :: (Core.Maybe
   [Dictlayerdata_Dict_WordsItem_SensesItem_ConjugationsItem])

    , definitions :: (Core.Maybe
   [Dictlayerdata_Dict_WordsItem_SensesItem_DefinitionsItem])
...
newDictlayerdata_Dict_WordsItem_SensesItem 
    :: 
                                           Dictlayerdata_Dict_WordsItem_SensesItem
newDictlayerdata_Dict_WordsItem_SensesItem
  = Dictlayerdata_Dict_WordsItem_SensesItem{conjugations =
                                              Core.Nothing,
                                            definitions = Core.Nothing, partOfSpeech = Core.Nothing,
                                            pronunciation = Core.Nothing,
                                            pronunciationUrl = Core.Nothing, source = Core.Nothing,
                                            syllabification = Core.Nothing, synonyms = Core.Nothing}
instance Core.FromJSON Dictlayerdata_Dict_WordsItem_SensesItem
         where
        parseJSON
          = Core.withObject "Dictlayerdata_Dict_WordsItem_SensesItem"
              (\ o ->
                 Dictlayerdata_Dict_WordsItem_SensesItem Core.<$>
                   (o Core..:? "conjugations") Core.<*> (o Core..:? "definitions")
...
newDictlayerdata_Dict_WordsItem_SensesItem_ConjugationsItem 
    :: 
                                                            Dictlayerdata_Dict_WordsItem_SensesItem_ConjugationsItem
newDictlayerdata_Dict_WordsItem_SensesItem_ConjugationsItem
  = Dictlayerdata_Dict_WordsItem_SensesItem_ConjugationsItem{type' =
                                                               Core.Nothing,
                                                             value = Core.Nothing}
instance Core.FromJSON
           Dictlayerdata_Dict_WordsItem_SensesItem_ConjugationsItem
        ...
        parseJSON
          = Core.withObject
              "Dictlayerdata_Dict_WordsItem_SensesItem_ConjugationsItem"
              (\ o ->
                 Dictlayerdata_Dict_WordsItem_SensesItem_ConjugationsItem Core.<$>
...
newDictlayerdata_Dict_WordsItem_SensesItem_DefinitionsItem 
    :: 
                                                           Dictlayerdata_Dict_WordsItem_SensesItem_DefinitionsItem
newDictlayerdata_Dict_WordsItem_SensesItem_DefinitionsItem
  = Dictlayerdata_Dict_WordsItem_SensesItem_DefinitionsItem{definition
                                                              = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "Dictlayerdata_Dict_WordsItem_SensesItem_DefinitionsItem"
              (\ o ->
                 Dictlayerdata_Dict_WordsItem_SensesItem_DefinitionsItem Core.<$>
                   (o Core..:? "definition") Core.<*> (o Core..:? "examples"))
...
newDictlayerdata_Dict_WordsItem_SensesItem_DefinitionsItem_ExamplesItem 
    :: 
                                                                        Dictlayerdata_Dict_WordsItem_SensesItem_DefinitionsItem_ExamplesItem
newDictlayerdata_Dict_WordsItem_SensesItem_DefinitionsItem_ExamplesItem
  = Dictlayerdata_Dict_WordsItem_SensesItem_DefinitionsItem_ExamplesItem{source
                                                                           = Core.Nothing,
                                                                         text = Core.Nothing}
instance Core.FromJSON
           Dictlayerdata_Dict_WordsItem_SensesItem_DefinitionsItem_ExamplesItem
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 Dictlayerdata_Dict_WordsItem_SensesItem_DefinitionsItem_ExamplesItem
                   Core.<$> (o Core..:? "source") Core.<*> (o Core..:? "text"))
...
newDictlayerdata_Dict_WordsItem_SensesItem_DefinitionsItem_ExamplesItem_Source 
    :: 
                                                                               Dictlayerdata_Dict_WordsItem_SensesItem_DefinitionsItem_ExamplesItem_Source
newDictlayerdata_Dict_WordsItem_SensesItem_DefinitionsItem_ExamplesItem_Source
  = Dictlayerdata_Dict_WordsItem_SensesItem_DefinitionsItem_ExamplesItem_Source{attribution
                                                                                  = Core.Nothing,
                                                                                url = Core.Nothing}
instance Core.FromJSON
           Dictlayerdata_Dict_WordsItem_SensesItem_DefinitionsItem_ExamplesItem_Source
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 Dictlayerdata_Dict_WordsItem_SensesItem_DefinitionsItem_ExamplesItem_Source
                   Core.<$> (o Core..:? "attribution") Core.<*> (o Core..:? "url"))
...
newDictlayerdata_Dict_WordsItem_SensesItem_Source 
    :: 
                                                  Dictlayerdata_Dict_WordsItem_SensesItem_Source
newDictlayerdata_Dict_WordsItem_SensesItem_Source
  = Dictlayerdata_Dict_WordsItem_SensesItem_Source{attribution =
                                                     Core.Nothing,
                                                   url = Core.Nothing}
instance Core.FromJSON
           Dictlayerdata_Dict_WordsItem_SensesItem_Source
         where
        parseJSON
          = Core.withObject "Dictlayerdata_Dict_WordsItem_SensesItem_Source"
              (\ o ->
                 Dictlayerdata_Dict_WordsItem_SensesItem_Source Core.<$>
                   (o Core..:? "attribution") Core.<*> (o Core..:? "url"))

instance Core.ToJSON Dictlayerdata_Dict_WordsItem_SensesItem_Source
         where
...
newDictlayerdata_Dict_WordsItem_SensesItem_SynonymsItem 
    :: 
                                                        Dictlayerdata_Dict_WordsItem_SensesItem_SynonymsItem
newDictlayerdata_Dict_WordsItem_SensesItem_SynonymsItem
  = Dictlayerdata_Dict_WordsItem_SensesItem_SynonymsItem{source =
                                                           Core.Nothing,
                                                         text = Core.Nothing}
instance Core.FromJSON
           Dictlayerdata_Dict_WordsItem_SensesItem_SynonymsItem
        ...
        parseJSON
          = Core.withObject
              "Dictlayerdata_Dict_WordsItem_SensesItem_SynonymsItem"
              (\ o ->
                 Dictlayerdata_Dict_WordsItem_SensesItem_SynonymsItem Core.<$>
                   (o Core..:? "source") Core.<*> (o Core..:? "text"))
...
newDictlayerdata_Dict_WordsItem_SensesItem_SynonymsItem_Source 
    :: 
                                                               Dictlayerdata_Dict_WordsItem_SensesItem_SynonymsItem_Source
newDictlayerdata_Dict_WordsItem_SensesItem_SynonymsItem_Source
  = Dictlayerdata_Dict_WordsItem_SensesItem_SynonymsItem_Source{attribution
                                                                  = Core.Nothing,
                                                                url = Core.Nothing}
instance Core.FromJSON
           Dictlayerdata_Dict_WordsItem_SensesItem_SynonymsItem_Source
...
newDictlayerdata_Dict_WordsItem_Source 
    :: 
                                       Dictlayerdata_Dict_WordsItem_Source
newDictlayerdata_Dict_WordsItem_Source
  = Dictlayerdata_Dict_WordsItem_Source{attribution = Core.Nothing,
                                        url = Core.Nothing}
instance Core.FromJSON Dictlayerdata_Dict_WordsItem_Source where
        parseJSON
          = Core.withObject "Dictlayerdata_Dict_WordsItem_Source"
              (\ o ->
                 Dictlayerdata_Dict_WordsItem_Source Core.<$>
                   (o Core..:? "attribution") Core.<*> (o Core..:? "url"))
...
newDiscoveryclusters 
    ::  Discoveryclusters
newDiscoveryclusters
  = Discoveryclusters{clusters = Core.Nothing, kind = Core.Nothing,
                      totalClusters = Core.Nothing}
instance Core.FromJSON Discoveryclusters where
        parseJSON
          = Core.withObject "Discoveryclusters"
              (\ o ->
                 Discoveryclusters Core.<$>
                   (o Core..:? "clusters") Core.<*> (o Core..:? "kind") Core.<*>
                     (o Core..:? "totalClusters"))
...
data Discoveryclusters_ClustersItem = Discoveryclusters_ClustersItem
    {
      ...
      bannerWithContentContainer :: (Core.Maybe
   Discoveryclusters_ClustersItem_Banner_with_content_container)
...
newDiscoveryclusters_ClustersItem 
    ::  Discoveryclusters_ClustersItem
newDiscoveryclusters_ClustersItem
  = Discoveryclusters_ClustersItem{bannerWithContentContainer =
                                     Core.Nothing,
                                   subTitle = Core.Nothing, title = Core.Nothing,
                                   totalVolumes = Core.Nothing, uid = Core.Nothing,
                                   volumes = Core.Nothing}
instance Core.FromJSON Discoveryclusters_ClustersItem where
        parseJSON
          = Core.withObject "Discoveryclusters_ClustersItem"
              (\ o ->
                 Discoveryclusters_ClustersItem Core.<$>
                   (o Core..:? "banner_with_content_container") Core.<*>
                     (o Core..:? "subTitle")
                     Core.<*> (o Core..:? "title")
...
instance Core.ToJSON Discoveryclusters_ClustersItem where
        toJSON Discoveryclusters_ClustersItem{..}
          = Core.object
              (Core.catMaybes
                 [("banner_with_content_container" Core..=) Core.<$>
...
newDiscoveryclusters_ClustersItem_Banner_with_content_container 
    :: 
                                                                Discoveryclusters_ClustersItem_Banner_with_content_container
newDiscoveryclusters_ClustersItem_Banner_with_content_container
  = Discoveryclusters_ClustersItem_Banner_with_content_container{fillColorArgb
                                                                   = Core.Nothing,
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 Discoveryclusters_ClustersItem_Banner_with_content_container
                   Core.<$>
                   (o Core..:? "fillColorArgb") Core.<*> (o Core..:? "imageUrl")
...
newDownloadAccessRestriction 
    ::  DownloadAccessRestriction
newDownloadAccessRestriction
  = DownloadAccessRestriction{deviceAllowed = Core.Nothing,
                              downloadsAcquired = Core.Nothing, justAcquired = Core.Nothing,
                              kind = Core.Nothing, maxDownloadDevices = Core.Nothing,
                              message = Core.Nothing, nonce = Core.Nothing,
                              reasonCode = Core.Nothing, restricted = Core.Nothing,
                              signature = Core.Nothing, source = Core.Nothing,
                              volumeId = Core.Nothing}
instance Core.FromJSON DownloadAccessRestriction where
        parseJSON
          = Core.withObject "DownloadAccessRestriction"
              (\ o ->
                 DownloadAccessRestriction Core.<$>
                   (o Core..:? "deviceAllowed") Core.<*>
                     (o Core..:? "downloadsAcquired")
...
newDownloadAccesses 
    ::  DownloadAccesses
newDownloadAccesses
  = DownloadAccesses{downloadAccessList = Core.Nothing,
                     kind = Core.Nothing}
instance Core.FromJSON DownloadAccesses where
        parseJSON
          = Core.withObject "DownloadAccesses"
              (\ o ->
                 DownloadAccesses Core.<$>
                   (o Core..:? "downloadAccessList") Core.<*> (o Core..:? "kind"))
...
instance Core.FromJSON FamilyInfo where
        parseJSON
          = Core.withObject "FamilyInfo"
              (\ o ->
                 FamilyInfo Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "membership"))
...
newFamilyInfo_Membership 
    ::  FamilyInfo_Membership
newFamilyInfo_Membership
  = FamilyInfo_Membership{acquirePermission = Core.Nothing,
                          ageGroup = Core.Nothing, allowedMaturityRating = Core.Nothing,
                          isInFamily = Core.Nothing, role' = Core.Nothing}
instance Core.FromJSON FamilyInfo_Membership where
        parseJSON
          = Core.withObject "FamilyInfo_Membership"
              (\ o ->
                 FamilyInfo_Membership Core.<$>
                   (o Core..:? "acquirePermission") Core.<*> (o Core..:? "ageGroup")
...
newGeoAnnotationdata 
    ::  GeoAnnotationdata
newGeoAnnotationdata
  = GeoAnnotationdata{annotationType = Core.Nothing,
                      data' = Core.Nothing, encodedData = Core.Nothing,
                      id = Core.Nothing, kind = Core.Nothing, layerId = Core.Nothing,
                      selfLink = Core.Nothing, updated = Core.Nothing,
                      volumeId = Core.Nothing}
instance Core.FromJSON GeoAnnotationdata where
        parseJSON
          = Core.withObject "GeoAnnotationdata"
              (\ o ->
                 GeoAnnotationdata Core.<$>
                   (o Core..:? "annotationType") Core.<*> (o Core..:? "data") Core.<*>
                     (o Core..:? "encodedData")
                     Core.<*> (o Core..:? "id")
                     Core.<*> (o Core..:? "kind")
...
newGeolayerdata 
    ::  Geolayerdata
newGeolayerdata
  = Geolayerdata{common = Core.Nothing, geo = Core.Nothing,
                 kind = Core.Nothing}
instance Core.FromJSON Geolayerdata where
        parseJSON
          = Core.withObject "Geolayerdata"
              (\ o ->
                 Geolayerdata Core.<$>
                   (o Core..:? "common") Core.<*> (o Core..:? "geo") Core.<*>
                     (o Core..:? "kind"))
...
instance Core.ToJSON Geolayerdata where
        toJSON Geolayerdata{..}
          = Core.object
              (Core.catMaybes
                 [("common" Core..=) Core.<$> common, ("geo" Core..=) Core.<$> geo,
                  ("kind" Core..=) Core.<$> kind])
...
newGeolayerdata_Common 
    ::  Geolayerdata_Common
newGeolayerdata_Common
  = Geolayerdata_Common{lang = Core.Nothing,
                        previewImageUrl = Core.Nothing, snippet = Core.Nothing,
                        snippetUrl = Core.Nothing, title = Core.Nothing}
instance Core.FromJSON Geolayerdata_Common where
        parseJSON
          = Core.withObject "Geolayerdata_Common"
              (\ o ->
                 Geolayerdata_Common Core.<$>
                   (o Core..:? "lang") Core.<*> (o Core..:? "previewImageUrl")
                     Core.<*> (o Core..:? "snippet")
...
newGeolayerdata_Geo 
    ::  Geolayerdata_Geo
newGeolayerdata_Geo
  = Geolayerdata_Geo{boundary = Core.Nothing,
                     cachePolicy = Core.Nothing, countryCode = Core.Nothing,
                     latitude = Core.Nothing, longitude = Core.Nothing,
                     mapType = Core.Nothing, viewport = Core.Nothing,
                     zoom = Core.Nothing}
instance Core.FromJSON Geolayerdata_Geo where
        parseJSON
          = Core.withObject "Geolayerdata_Geo"
              (\ o ->
                 Geolayerdata_Geo Core.<$>
                   (o Core..:? "boundary") Core.<*> (o Core..:? "cachePolicy")
...
instance Core.FromJSON Geolayerdata_Geo_Viewport where
        parseJSON
          = Core.withObject "Geolayerdata_Geo_Viewport"
              (\ o ->
                 Geolayerdata_Geo_Viewport Core.<$>
                   (o Core..:? "hi") Core.<*> (o Core..:? "lo"))
...
newGeolayerdata_Geo_Viewport_Hi 
    ::  Geolayerdata_Geo_Viewport_Hi
newGeolayerdata_Geo_Viewport_Hi
  = Geolayerdata_Geo_Viewport_Hi{latitude = Core.Nothing,
                                 longitude = Core.Nothing}
instance Core.FromJSON Geolayerdata_Geo_Viewport_Hi where
        parseJSON
          = Core.withObject "Geolayerdata_Geo_Viewport_Hi"
              (\ o ->
                 Geolayerdata_Geo_Viewport_Hi Core.<$>
...
newGeolayerdata_Geo_Viewport_Lo 
    ::  Geolayerdata_Geo_Viewport_Lo
newGeolayerdata_Geo_Viewport_Lo
  = Geolayerdata_Geo_Viewport_Lo{latitude = Core.Nothing,
                                 longitude = Core.Nothing}
instance Core.FromJSON Geolayerdata_Geo_Viewport_Lo where
        parseJSON
          = Core.withObject "Geolayerdata_Geo_Viewport_Lo"
              (\ o ->
                 Geolayerdata_Geo_Viewport_Lo Core.<$>
                   (o Core..:? "latitude") Core.<*> (o Core..:? "longitude"))
...
newLayersummaries 
    ::  Layersummaries
newLayersummaries
  = Layersummaries{items = Core.Nothing, kind = Core.Nothing,
                   totalItems = Core.Nothing}
instance Core.FromJSON Layersummaries where
        parseJSON
          = Core.withObject "Layersummaries"
              (\ o ->
                 Layersummaries Core.<$>
                   (o Core..:? "items") Core.<*> (o Core..:? "kind") Core.<*>
                     (o Core..:? "totalItems"))
...
newLayersummary 
    ::  Layersummary
newLayersummary
  = Layersummary{annotationCount = Core.Nothing,
                 annotationTypes = Core.Nothing, annotationsDataLink = Core.Nothing,
                 annotationsLink = Core.Nothing, contentVersion = Core.Nothing,
                 dataCount = Core.Nothing, id = Core.Nothing, kind = Core.Nothing,
                 layerId = Core.Nothing, selfLink = Core.Nothing,
                 updated = Core.Nothing, volumeAnnotationsVersion = Core.Nothing,
                 volumeId = Core.Nothing}
instance Core.FromJSON Layersummary where
        parseJSON
          = Core.withObject "Layersummary"
              (\ o ->
                 Layersummary Core.<$>
                   (o Core..:? "annotationCount") Core.<*>
                     (o Core..:? "annotationTypes")
          ...
          = Core.object
              (Core.catMaybes
                 [("annotationCount" Core..=) Core.<$> annotationCount,
                  ...
                  ("selfLink" Core..=) Core.<$> selfLink,
                  ("updated" Core..=) Core.<$> updated,
                  ("volumeAnnotationsVersion" Core..=) Core.<$>
...
newMetadata_ItemsItem 
    ::  Metadata_ItemsItem
newMetadata_ItemsItem
  = Metadata_ItemsItem{downloadUrl = Core.Nothing,
                       encryptedKey = Core.Nothing, language = Core.Nothing,
                       size = Core.Nothing, version = Core.Nothing}
instance Core.FromJSON Metadata_ItemsItem where
        parseJSON
          = Core.withObject "Metadata_ItemsItem"
              (\ o ->
                 Metadata_ItemsItem Core.<$>
                   (o Core..:? "download_url") Core.<*> (o Core..:? "encrypted_key")
...
newNotification 
    ::  Notification
newNotification
  = Notification{body = Core.Nothing,
                 crmExperimentIds = Core.Nothing, docId = Core.Nothing,
                 docType = Core.Nothing, dontShowNotification = Core.Nothing,
                 iconUrl = Core.Nothing, isDocumentMature = Core.Nothing,
                 kind = Core.Nothing, notificationGroup = Core.Nothing,
                 notificationType = Core.Nothing, pcampaignId = Core.Nothing,
                 reason = Core.Nothing,
                 showNotificationSettingsAction = Core.Nothing,
                 targetUrl = Core.Nothing, timeToExpireMs = Core.Nothing,
                 title = Core.Nothing}
              ...
              (\ o ->
                 Notification Core.<$>
                   (o Core..:? "body") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "timeToExpireMs" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "title"))
...
instance Core.ToJSON Notification where
        toJSON Notification{..}
          = Core.object
              (Core.catMaybes
                 [("body" Core..=) Core.<$> body,
                  ("crmExperimentIds" Core..=) Core.. Core.fmap Core.AsText Core.<$>
                    crmExperimentIds,
                  ...
                  ("show_notification_settings_action" Core..=) Core.<$>
                    showNotificationSettingsAction,
                  ("targetUrl" Core..=) Core.<$> targetUrl,
                  ("timeToExpireMs" Core..=) Core.. Core.AsText Core.<$>
                    timeToExpireMs,
                  ("title" Core..=) Core.<$> title])
...
newOffers_ItemsItem 
    ::  Offers_ItemsItem
newOffers_ItemsItem
  = Offers_ItemsItem{artUrl = Core.Nothing,
                     gservicesKey = Core.Nothing, id = Core.Nothing,
                     items = Core.Nothing}
instance Core.FromJSON Offers_ItemsItem where
        parseJSON
          = Core.withObject "Offers_ItemsItem"
              (\ o ->
                 Offers_ItemsItem Core.<$>
                   (o Core..:? "artUrl") Core.<*> (o Core..:? "gservicesKey") Core.<*>
                     (o Core..:? "id")
                     Core.<*> (o Core..:? "items"))
          ...
          = Core.object
              (Core.catMaybes
                 [("artUrl" Core..=) Core.<$> artUrl,
                  ...
                  ("id" Core..=) Core.<$> id, ("items" Core..=) Core.<$> items])
...
newOffers_ItemsItem_ItemsItem 
    ::  Offers_ItemsItem_ItemsItem
newOffers_ItemsItem_ItemsItem
  = Offers_ItemsItem_ItemsItem{author = Core.Nothing,
                               canonicalVolumeLink = Core.Nothing, coverUrl = Core.Nothing,
                               description = Core.Nothing, title = Core.Nothing,
                               volumeId = Core.Nothing}
instance Core.FromJSON Offers_ItemsItem_ItemsItem where
        parseJSON
          = Core.withObject "Offers_ItemsItem_ItemsItem"
              (\ o ->
                 Offers_ItemsItem_ItemsItem Core.<$>
                   (o Core..:? "author") Core.<*> (o Core..:? "canonicalVolumeLink")
...
newReadingPosition 
    ::  ReadingPosition
newReadingPosition
  = ReadingPosition{epubCfiPosition = Core.Nothing,
                    gbImagePosition = Core.Nothing, gbTextPosition = Core.Nothing,
                    kind = Core.Nothing, pdfPosition = Core.Nothing,
                    updated = Core.Nothing, volumeId = Core.Nothing}
instance Core.FromJSON ReadingPosition where
        parseJSON
          = Core.withObject "ReadingPosition"
              (\ o ->
                 ReadingPosition Core.<$>
                   (o Core..:? "epubCfiPosition") Core.<*>
                     (o Core..:? "gbImagePosition")
...
newRequestAccessData 
    ::  RequestAccessData
newRequestAccessData
  = RequestAccessData{concurrentAccess = Core.Nothing,
                      downloadAccess = Core.Nothing, kind = Core.Nothing}
instance Core.FromJSON RequestAccessData where
        parseJSON
          = Core.withObject "RequestAccessData"
              (\ o ->
                 RequestAccessData Core.<$>
                   (o Core..:? "concurrentAccess") Core.<*>
                     (o Core..:? "downloadAccess")
                     Core.<*> (o Core..:? "kind"))
...
newReview 
    ::  Review
newReview
  = Review{author = Core.Nothing, content = Core.Nothing,
           date = Core.Nothing, fullTextUrl = Core.Nothing,
           kind = Core.Nothing, rating = Core.Nothing, source = Core.Nothing,
...
instance Core.FromJSON Review where
        parseJSON
          = Core.withObject "Review"
              (\ o ->
                 Review Core.<$>
                   (o Core..:? "author") Core.<*> (o Core..:? "content") Core.<*>
                     (o Core..:? "date")
          ...
          = Core.object
              (Core.catMaybes
                 [("author" Core..=) Core.<$> author,
                  ...
                  ("kind" Core..=) Core.<$> kind, ("rating" Core..=) Core.<$> rating,
                  ("source" Core..=) Core.<$> source,
...
newReview_Source 
    ::  Review_Source
newReview_Source
  = Review_Source{description = Core.Nothing,
                  extraDescription = Core.Nothing, url = Core.Nothing}
instance Core.FromJSON Review_Source where
        parseJSON
          = Core.withObject "Review_Source"
              (\ o ->
                 Review_Source Core.<$>
                   (o Core..:? "description") Core.<*> (o Core..:? "extraDescription")
                     Core.<*> (o Core..:? "url"))
...
newSeries_SeriesItem 
    ::  Series_SeriesItem
newSeries_SeriesItem
  = Series_SeriesItem{bannerImageUrl = Core.Nothing,
                      eligibleForSubscription = Core.Nothing, imageUrl = Core.Nothing,
                      isComplete = Core.Nothing, seriesFormatType = Core.Nothing,
                      seriesId = Core.Nothing,
                      seriesSubscriptionReleaseInfo = Core.Nothing,
                      seriesType = Core.Nothing, subscriptionId = Core.Nothing,
                      title = Core.Nothing}
instance Core.FromJSON Series_SeriesItem where
        parseJSON
          = Core.withObject "Series_SeriesItem"
              (\ o ->
                 Series_SeriesItem Core.<$>
                   (o Core..:? "bannerImageUrl") Core.<*>
                     (o Core..:? "eligibleForSubscription")
          ...
          = Core.object
              (Core.catMaybes
                 [("bannerImageUrl" Core..=) Core.<$> bannerImageUrl,
                  ("eligibleForSubscription" Core..=) Core.<$>
                  ...
                  ("seriesSubscriptionReleaseInfo" Core..=) Core.<$>
...
data Series_SeriesItem_SeriesSubscriptionReleaseInfo = Series_SeriesItem_SeriesSubscriptionReleaseInfo
    ...
    , currentReleaseInfo :: (Core.Maybe
   Series_SeriesItem_SeriesSubscriptionReleaseInfo_CurrentReleaseInfo)

    , nextReleaseInfo :: (Core.Maybe
   Series_SeriesItem_SeriesSubscriptionReleaseInfo_NextReleaseInfo)
...
newSeries_SeriesItem_SeriesSubscriptionReleaseInfo 
    :: 
                                                   Series_SeriesItem_SeriesSubscriptionReleaseInfo
newSeries_SeriesItem_SeriesSubscriptionReleaseInfo
  = Series_SeriesItem_SeriesSubscriptionReleaseInfo{cancelTime =
                                                      Core.Nothing,
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "Series_SeriesItem_SeriesSubscriptionReleaseInfo"
              (\ o ->
                 Series_SeriesItem_SeriesSubscriptionReleaseInfo Core.<$>
                   (o Core..:? "cancelTime") Core.<*>
                     (o Core..:? "currentReleaseInfo")
          ...
          = Core.object
              (Core.catMaybes
                 [("cancelTime" Core..=) Core.<$> cancelTime,
                  ...
                  ("seriesSubscriptionType" Core..=) Core.<$>
...
newSeries_SeriesItem_SeriesSubscriptionReleaseInfo_CurrentReleaseInfo 
    :: 
                                                                      Series_SeriesItem_SeriesSubscriptionReleaseInfo_CurrentReleaseInfo
newSeries_SeriesItem_SeriesSubscriptionReleaseInfo_CurrentReleaseInfo
  = Series_SeriesItem_SeriesSubscriptionReleaseInfo_CurrentReleaseInfo{amountInMicros
                                                                         = Core.Nothing,
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 Series_SeriesItem_SeriesSubscriptionReleaseInfo_CurrentReleaseInfo
                   Core.<$>
                   (o Core..:? "amountInMicros") Core.<*> (o Core..:? "currencyCode")
...
newSeries_SeriesItem_SeriesSubscriptionReleaseInfo_NextReleaseInfo 
    :: 
                                                                   Series_SeriesItem_SeriesSubscriptionReleaseInfo_NextReleaseInfo
newSeries_SeriesItem_SeriesSubscriptionReleaseInfo_NextReleaseInfo
  = Series_SeriesItem_SeriesSubscriptionReleaseInfo_NextReleaseInfo{amountInMicros
                                                                      = Core.Nothing,
                                                                    currencyCode = Core.Nothing,
                                                                    releaseNumber = Core.Nothing,
                                                                    releaseTime = Core.Nothing}
...
newSeriesmembership 
    ::  Seriesmembership
newSeriesmembership
  = Seriesmembership{kind = Core.Nothing, member = Core.Nothing,
                     nextPageToken = Core.Nothing}
instance Core.FromJSON Seriesmembership where
        parseJSON
          = Core.withObject "Seriesmembership"
              (\ o ->
                 Seriesmembership Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "member") Core.<*>
                     (o Core..:? "nextPageToken"))
...
newUsersettings 
    ::  Usersettings
newUsersettings
  = Usersettings{kind = Core.Nothing, notesExport = Core.Nothing,
                 notification = Core.Nothing}
instance Core.FromJSON Usersettings where
        parseJSON
          = Core.withObject "Usersettings"
              (\ o ->
                 Usersettings Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "notesExport") Core.<*>
                     (o Core..:? "notification"))
...
newUsersettings_NotesExport 
    ::  Usersettings_NotesExport
newUsersettings_NotesExport
  = Usersettings_NotesExport{folderName = Core.Nothing,
                             isEnabled = Core.Nothing}
instance Core.FromJSON Usersettings_NotesExport where
        parseJSON
          = Core.withObject "Usersettings_NotesExport"
              (\ o ->
                 Usersettings_NotesExport Core.<$>
                   (o Core..:? "folderName") Core.<*> (o Core..:? "isEnabled"))
...
newUsersettings_Notification 
    ::  Usersettings_Notification
newUsersettings_Notification
  = Usersettings_Notification{matchMyInterests = Core.Nothing,
                              moreFromAuthors = Core.Nothing, moreFromSeries = Core.Nothing,
                              priceDrop = Core.Nothing, rewardExpirations = Core.Nothing}
instance Core.FromJSON Usersettings_Notification where
        parseJSON
          = Core.withObject "Usersettings_Notification"
              (\ o ->
                 Usersettings_Notification Core.<$>
                   (o Core..:? "matchMyInterests") Core.<*>
                     (o Core..:? "moreFromAuthors")
...
newUsersettings_Notification_MatchMyInterests 
    :: 
                                              Usersettings_Notification_MatchMyInterests
newUsersettings_Notification_MatchMyInterests
  = Usersettings_Notification_MatchMyInterests{optedState =
                                                 Core.Nothing}
instance Core.FromJSON Usersettings_Notification_MatchMyInterests
         where
        parseJSON
          = Core.withObject "Usersettings_Notification_MatchMyInterests"
              (\ o ->
                 Usersettings_Notification_MatchMyInterests Core.<$>
                   (o Core..:? "opted_state"))

instance Core.ToJSON Usersettings_Notification_MatchMyInterests
         where
...
newUsersettings_Notification_MoreFromAuthors 
    :: 
                                             Usersettings_Notification_MoreFromAuthors
newUsersettings_Notification_MoreFromAuthors
  = Usersettings_Notification_MoreFromAuthors{optedState =
                                                Core.Nothing}
instance Core.FromJSON Usersettings_Notification_MoreFromAuthors
         where
        parseJSON
          = Core.withObject "Usersettings_Notification_MoreFromAuthors"
              (\ o ->
                 Usersettings_Notification_MoreFromAuthors Core.<$>
                   (o Core..:? "opted_state"))

instance Core.ToJSON Usersettings_Notification_MoreFromAuthors
         where
...
newUsersettings_Notification_MoreFromSeries 
    :: 
                                            Usersettings_Notification_MoreFromSeries
newUsersettings_Notification_MoreFromSeries
  = Usersettings_Notification_MoreFromSeries{optedState =
                                               Core.Nothing}
instance Core.FromJSON Usersettings_Notification_MoreFromSeries
         where
        parseJSON
          = Core.withObject "Usersettings_Notification_MoreFromSeries"
              (\ o ->
                 Usersettings_Notification_MoreFromSeries Core.<$>
                   (o Core..:? "opted_state"))
...
instance Core.FromJSON Usersettings_Notification_PriceDrop where
        parseJSON
          = Core.withObject "Usersettings_Notification_PriceDrop"
              (\ o ->
                 Usersettings_Notification_PriceDrop Core.<$>
                   (o Core..:? "opted_state"))
...
newUsersettings_Notification_RewardExpirations 
    :: 
                                               Usersettings_Notification_RewardExpirations
newUsersettings_Notification_RewardExpirations
  = Usersettings_Notification_RewardExpirations{optedState =
                                                  Core.Nothing}
instance Core.FromJSON Usersettings_Notification_RewardExpirations
         where
        parseJSON
          = Core.withObject "Usersettings_Notification_RewardExpirations"
              (\ o ->
                 Usersettings_Notification_RewardExpirations Core.<$>
                   (o Core..:? "opted_state"))

instance Core.ToJSON Usersettings_Notification_RewardExpirations
         where
...
newVolume 
    ::  Volume
newVolume
  = Volume{accessInfo = Core.Nothing, etag = Core.Nothing,
           id = Core.Nothing, kind = Core.Nothing, layerInfo = Core.Nothing,
           recommendedInfo = Core.Nothing, saleInfo = Core.Nothing,
           searchInfo = Core.Nothing, selfLink = Core.Nothing,
           userInfo = Core.Nothing, volumeInfo = Core.Nothing}
instance Core.FromJSON Volume where
        parseJSON
          = Core.withObject "Volume"
              (\ o ->
                 Volume Core.<$>
                   (o Core..:? "accessInfo") Core.<*> (o Core..:? "etag") Core.<*>
                     (o Core..:? "id")
                     Core.<*> (o Core..:? "kind")
...
newVolume_AccessInfo 
    ::  Volume_AccessInfo
newVolume_AccessInfo
  = Volume_AccessInfo{accessViewStatus = Core.Nothing,
                      country = Core.Nothing, downloadAccess = Core.Nothing,
                      driveImportedContentLink = Core.Nothing, embeddable = Core.Nothing,
                      epub = Core.Nothing,
                      explicitOfflineLicenseManagement = Core.Nothing,
                      pdf = Core.Nothing, publicDomain = Core.Nothing,
                      quoteSharingAllowed = Core.Nothing,
                      textToSpeechPermission = Core.Nothing, viewOrderUrl = Core.Nothing,
                      viewability = Core.Nothing, webReaderLink = Core.Nothing}
instance Core.FromJSON Volume_AccessInfo where
        parseJSON
          = Core.withObject "Volume_AccessInfo"
              (\ o ->
                 Volume_AccessInfo Core.<$>
                   (o Core..:? "accessViewStatus") Core.<*> (o Core..:? "country")
          ...
          = Core.object
              (Core.catMaybes
                 [("accessViewStatus" Core..=) Core.<$> accessViewStatus,
                  ...
                  ("downloadAccess" Core..=) Core.<$> downloadAccess,
                  ("driveImportedContentLink" Core..=) Core.<$>
                    driveImportedContentLink,
                  ("embeddable" Core..=) Core.<$> embeddable,
                  ("epub" Core..=) Core.<$> epub,
                  ("explicitOfflineLicenseManagement" Core..=) Core.<$>
...
newVolume_AccessInfo_Epub 
    ::  Volume_AccessInfo_Epub
newVolume_AccessInfo_Epub
  = Volume_AccessInfo_Epub{acsTokenLink = Core.Nothing,
                           downloadLink = Core.Nothing, isAvailable = Core.Nothing}
instance Core.FromJSON Volume_AccessInfo_Epub where
        parseJSON
          = Core.withObject "Volume_AccessInfo_Epub"
              (\ o ->
                 Volume_AccessInfo_Epub Core.<$>
                   (o Core..:? "acsTokenLink") Core.<*> (o Core..:? "downloadLink")
...
newVolume_AccessInfo_Pdf 
    ::  Volume_AccessInfo_Pdf
newVolume_AccessInfo_Pdf
  = Volume_AccessInfo_Pdf{acsTokenLink = Core.Nothing,
                          downloadLink = Core.Nothing, isAvailable = Core.Nothing}
instance Core.FromJSON Volume_AccessInfo_Pdf where
        parseJSON
          = Core.withObject "Volume_AccessInfo_Pdf"
              (\ o ->
                 Volume_AccessInfo_Pdf Core.<$>
                   (o Core..:? "acsTokenLink") Core.<*> (o Core..:? "downloadLink")
                     Core.<*> (o Core..:? "isAvailable"))
...
instance Core.FromJSON Volume_LayerInfo where
        parseJSON
          = Core.withObject "Volume_LayerInfo"
...
newVolume_LayerInfo_LayersItem 
    ::  Volume_LayerInfo_LayersItem
newVolume_LayerInfo_LayersItem
  = Volume_LayerInfo_LayersItem{layerId = Core.Nothing,
                                volumeAnnotationsVersion = Core.Nothing}
instance Core.FromJSON Volume_LayerInfo_LayersItem where
        parseJSON
          = Core.withObject "Volume_LayerInfo_LayersItem"
              (\ o ->
                 Volume_LayerInfo_LayersItem Core.<$>
                   (o Core..:? "layerId") Core.<*>
                     (o Core..:? "volumeAnnotationsVersion"))
...
instance Core.FromJSON Volume_RecommendedInfo where
        parseJSON
          = Core.withObject "Volume_RecommendedInfo"
...
newVolume_SaleInfo 
    ::  Volume_SaleInfo
newVolume_SaleInfo
  = Volume_SaleInfo{buyLink = Core.Nothing, country = Core.Nothing,
                    isEbook = Core.Nothing, listPrice = Core.Nothing,
                    offers = Core.Nothing, onSaleDate = Core.Nothing,
                    retailPrice = Core.Nothing, saleability = Core.Nothing}
instance Core.FromJSON Volume_SaleInfo where
        parseJSON
          = Core.withObject "Volume_SaleInfo"
              (\ o ->
                 Volume_SaleInfo Core.<$>
                   (o Core..:? "buyLink") Core.<*> (o Core..:? "country") Core.<*>
                     (o Core..:? "isEbook")
...
newVolume_SaleInfo_ListPrice 
    ::  Volume_SaleInfo_ListPrice
newVolume_SaleInfo_ListPrice
  = Volume_SaleInfo_ListPrice{amount = Core.Nothing,
                              currencyCode = Core.Nothing}
instance Core.FromJSON Volume_SaleInfo_ListPrice where
        parseJSON
          = Core.withObject "Volume_SaleInfo_ListPrice"
              (\ o ->
                 Volume_SaleInfo_ListPrice Core.<$>
                   (o Core..:? "amount") Core.<*> (o Core..:? "currencyCode"))
...
newVolume_SaleInfo_OffersItem 
    ::  Volume_SaleInfo_OffersItem
newVolume_SaleInfo_OffersItem
  = Volume_SaleInfo_OffersItem{finskyOfferType = Core.Nothing,
                               giftable = Core.Nothing, listPrice = Core.Nothing,
                               rentalDuration = Core.Nothing, retailPrice = Core.Nothing}
instance Core.FromJSON Volume_SaleInfo_OffersItem where
        parseJSON
          = Core.withObject "Volume_SaleInfo_OffersItem"
              (\ o ->
                 Volume_SaleInfo_OffersItem Core.<$>
                   (o Core..:? "finskyOfferType") Core.<*> (o Core..:? "giftable")
                     Core.<*> (o Core..:? "listPrice")
...
newVolume_SaleInfo_OffersItem_ListPrice 
    :: 
                                        Volume_SaleInfo_OffersItem_ListPrice
newVolume_SaleInfo_OffersItem_ListPrice
  = Volume_SaleInfo_OffersItem_ListPrice{amountInMicros =
                                           Core.Nothing,
                                         currencyCode = Core.Nothing}
instance Core.FromJSON Volume_SaleInfo_OffersItem_ListPrice where
        parseJSON
          = Core.withObject "Volume_SaleInfo_OffersItem_ListPrice"
              (\ o ->
                 Volume_SaleInfo_OffersItem_ListPrice Core.<$>
                   (o Core..:? "amountInMicros") Core.<*> (o Core..:? "currencyCode"))
...
newVolume_SaleInfo_OffersItem_RentalDuration 
    :: 
                                             Volume_SaleInfo_OffersItem_RentalDuration
newVolume_SaleInfo_OffersItem_RentalDuration
  = Volume_SaleInfo_OffersItem_RentalDuration{count = Core.Nothing,
                                              unit = Core.Nothing}
instance Core.FromJSON Volume_SaleInfo_OffersItem_RentalDuration
         where
        parseJSON
          = Core.withObject "Volume_SaleInfo_OffersItem_RentalDuration"
              (\ o ->
                 Volume_SaleInfo_OffersItem_RentalDuration Core.<$>
                   (o Core..:? "count") Core.<*> (o Core..:? "unit"))

instance Core.ToJSON Volume_SaleInfo_OffersItem_RentalDuration
         where
...
newVolume_SaleInfo_OffersItem_RetailPrice 
    :: 
                                          Volume_SaleInfo_OffersItem_RetailPrice
newVolume_SaleInfo_OffersItem_RetailPrice
  = Volume_SaleInfo_OffersItem_RetailPrice{amountInMicros =
                                             Core.Nothing,
                                           currencyCode = Core.Nothing}
instance Core.FromJSON Volume_SaleInfo_OffersItem_RetailPrice where
        parseJSON
          = Core.withObject "Volume_SaleInfo_OffersItem_RetailPrice"
              (\ o ->
                 Volume_SaleInfo_OffersItem_RetailPrice Core.<$>
                   (o Core..:? "amountInMicros") Core.<*> (o Core..:? "currencyCode"))
...
newVolume_SaleInfo_RetailPrice 
    ::  Volume_SaleInfo_RetailPrice
newVolume_SaleInfo_RetailPrice
  = Volume_SaleInfo_RetailPrice{amount = Core.Nothing,
                                currencyCode = Core.Nothing}
instance Core.FromJSON Volume_SaleInfo_RetailPrice where
        parseJSON
          = Core.withObject "Volume_SaleInfo_RetailPrice"
              (\ o ->
                 Volume_SaleInfo_RetailPrice Core.<$>
                   (o Core..:? "amount") Core.<*> (o Core..:? "currencyCode"))
...
instance Core.FromJSON Volume_SearchInfo where
        parseJSON
          = Core.withObject "Volume_SearchInfo"
...
newVolume_UserInfo 
    ::  Volume_UserInfo
newVolume_UserInfo
  = Volume_UserInfo{acquiredTime = Core.Nothing,
                    acquisitionType = Core.Nothing, copy = Core.Nothing,
                    entitlementType = Core.Nothing, familySharing = Core.Nothing,
                    ...
                    isInMyBooks = Core.Nothing, isPreordered = Core.Nothing,
                    isPurchased = Core.Nothing, isUploaded = Core.Nothing,
                    readingPosition = Core.Nothing, rentalPeriod = Core.Nothing,
                    rentalState = Core.Nothing, review = Core.Nothing,
                    updated = Core.Nothing, userUploadedVolumeInfo = Core.Nothing}
instance Core.FromJSON Volume_UserInfo where
        parseJSON
          = Core.withObject "Volume_UserInfo"
              (\ o ->
                 Volume_UserInfo Core.<$>
                   (o Core..:? "acquiredTime") Core.<*> (o Core..:? "acquisitionType")
                     Core.<*> (o Core..:? "copy")
          ...
          = Core.object
              (Core.catMaybes
                 [("acquiredTime" Core..=) Core.<$> acquiredTime,
                  ...
                  ("isFamilySharingDisabledByFop" Core..=) Core.<$>
                  ...
                  ("updated" Core..=) Core.<$> updated,
                  ("userUploadedVolumeInfo" Core..=) Core.<$>
...
newVolume_UserInfo_Copy 
    ::  Volume_UserInfo_Copy
newVolume_UserInfo_Copy
  = Volume_UserInfo_Copy{allowedCharacterCount = Core.Nothing,
                         limitType = Core.Nothing, remainingCharacterCount = Core.Nothing,
                         updated = Core.Nothing}
instance Core.FromJSON Volume_UserInfo_Copy where
        parseJSON
          = Core.withObject "Volume_UserInfo_Copy"
              (\ o ->
                 Volume_UserInfo_Copy Core.<$>
                   (o Core..:? "allowedCharacterCount") Core.<*>
                     (o Core..:? "limitType")
                     Core.<*> (o Core..:? "remainingCharacterCount")
                     Core.<*> (o Core..:? "updated"))
...
newVolume_UserInfo_FamilySharing 
    ::  Volume_UserInfo_FamilySharing
newVolume_UserInfo_FamilySharing
  = Volume_UserInfo_FamilySharing{familyRole = Core.Nothing,
...
instance Core.FromJSON Volume_UserInfo_FamilySharing where
        parseJSON
          = Core.withObject "Volume_UserInfo_FamilySharing"
              (\ o ->
                 Volume_UserInfo_FamilySharing Core.<$>
                   (o Core..:? "familyRole") Core.<*> (o Core..:? "isSharingAllowed")
          ...
          = Core.object
              (Core.catMaybes
                 [("familyRole" Core..=) Core.<$> familyRole,
                  ...
                  ("isSharingDisabledByFop" Core..=) Core.<$>
...
newVolume_UserInfo_RentalPeriod 
    ::  Volume_UserInfo_RentalPeriod
newVolume_UserInfo_RentalPeriod
  = Volume_UserInfo_RentalPeriod{endUtcSec = Core.Nothing,
                                 startUtcSec = Core.Nothing}
instance Core.FromJSON Volume_UserInfo_RentalPeriod where
        parseJSON
          = Core.withObject "Volume_UserInfo_RentalPeriod"
              (\ o ->
                 Volume_UserInfo_RentalPeriod Core.<$>
                   (o Core..:? "endUtcSec" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "startUtcSec" Core.<&> Core.fmap Core.fromAsText))
...
newVolume_UserInfo_UserUploadedVolumeInfo 
    :: 
                                          Volume_UserInfo_UserUploadedVolumeInfo
newVolume_UserInfo_UserUploadedVolumeInfo
  = Volume_UserInfo_UserUploadedVolumeInfo{processingState =
                                             Core.Nothing}
instance Core.FromJSON Volume_UserInfo_UserUploadedVolumeInfo where
        parseJSON
          = Core.withObject "Volume_UserInfo_UserUploadedVolumeInfo"
              (\ o ->
                 Volume_UserInfo_UserUploadedVolumeInfo Core.<$>
                   (o Core..:? "processingState"))
...
newVolume_VolumeInfo 
    ::  Volume_VolumeInfo
newVolume_VolumeInfo
  = Volume_VolumeInfo{allowAnonLogging = Core.Nothing,
                      authors = Core.Nothing, averageRating = Core.Nothing,
                      canonicalVolumeLink = Core.Nothing, categories = Core.Nothing,
                      comicsContent = Core.Nothing, contentVersion = Core.Nothing,
                      description = Core.Nothing, dimensions = Core.Nothing,
                      imageLinks = Core.Nothing, industryIdentifiers = Core.Nothing,
                      infoLink = Core.Nothing, language = Core.Nothing,
                      mainCategory = Core.Nothing, maturityRating = Core.Nothing,
                      pageCount = Core.Nothing, panelizationSummary = Core.Nothing,
                      previewLink = Core.Nothing, printType = Core.Nothing,
                      printedPageCount = Core.Nothing, publishedDate = Core.Nothing,
                      publisher = Core.Nothing, ratingsCount = Core.Nothing,
                      readingModes = Core.Nothing, samplePageCount = Core.Nothing,
                      seriesInfo = Core.Nothing, subtitle = Core.Nothing,
                      title = Core.Nothing}
instance Core.FromJSON Volume_VolumeInfo where
        parseJSON
          = Core.withObject "Volume_VolumeInfo"
              (\ o ->
                 Volume_VolumeInfo Core.<$>
                   (o Core..:? "allowAnonLogging") Core.<*> (o Core..:? "authors")
...
newVolume_VolumeInfo_Dimensions 
    ::  Volume_VolumeInfo_Dimensions
newVolume_VolumeInfo_Dimensions
  = Volume_VolumeInfo_Dimensions{height = Core.Nothing,
                                 thickness = Core.Nothing, width = Core.Nothing}
instance Core.FromJSON Volume_VolumeInfo_Dimensions where
        parseJSON
          = Core.withObject "Volume_VolumeInfo_Dimensions"
              (\ o ->
                 Volume_VolumeInfo_Dimensions Core.<$>
                   (o Core..:? "height") Core.<*> (o Core..:? "thickness") Core.<*>
                     (o Core..:? "width"))
...
newVolume_VolumeInfo_ImageLinks 
    ::  Volume_VolumeInfo_ImageLinks
newVolume_VolumeInfo_ImageLinks
  = Volume_VolumeInfo_ImageLinks{extraLarge = Core.Nothing,
                                 large = Core.Nothing, medium = Core.Nothing, small = Core.Nothing,
                                 smallThumbnail = Core.Nothing, thumbnail = Core.Nothing}
instance Core.FromJSON Volume_VolumeInfo_ImageLinks where
        parseJSON
          = Core.withObject "Volume_VolumeInfo_ImageLinks"
              (\ o ->
                 Volume_VolumeInfo_ImageLinks Core.<$>
                   (o Core..:? "extraLarge") Core.<*> (o Core..:? "large") Core.<*>
                     (o Core..:? "medium")
                     Core.<*> (o Core..:? "small")
...
newVolume_VolumeInfo_IndustryIdentifiersItem 
    :: 
                                             Volume_VolumeInfo_IndustryIdentifiersItem
newVolume_VolumeInfo_IndustryIdentifiersItem
  = Volume_VolumeInfo_IndustryIdentifiersItem{identifier =
                                                Core.Nothing,
                                              type' = Core.Nothing}
instance Core.FromJSON Volume_VolumeInfo_IndustryIdentifiersItem
         where
        parseJSON
          = Core.withObject "Volume_VolumeInfo_IndustryIdentifiersItem"
              (\ o ->
                 Volume_VolumeInfo_IndustryIdentifiersItem Core.<$>
                   (o Core..:? "identifier") Core.<*> (o Core..:? "type"))

instance Core.ToJSON Volume_VolumeInfo_IndustryIdentifiersItem
         where
...
newVolume_VolumeInfo_PanelizationSummary 
    :: 
                                         Volume_VolumeInfo_PanelizationSummary
newVolume_VolumeInfo_PanelizationSummary
  = Volume_VolumeInfo_PanelizationSummary{containsEpubBubbles =
                                            Core.Nothing,
...
instance Core.FromJSON Volume_VolumeInfo_PanelizationSummary where
        parseJSON
          = Core.withObject "Volume_VolumeInfo_PanelizationSummary"
              (\ o ->
                 Volume_VolumeInfo_PanelizationSummary Core.<$>
                   (o Core..:? "containsEpubBubbles") Core.<*>
                     (o Core..:? "containsImageBubbles")
...
newVolume_VolumeInfo_ReadingModes 
    ::  Volume_VolumeInfo_ReadingModes
newVolume_VolumeInfo_ReadingModes
  = Volume_VolumeInfo_ReadingModes{image = Core.Nothing,
                                   text = Core.Nothing}
instance Core.FromJSON Volume_VolumeInfo_ReadingModes where
        parseJSON
          = Core.withObject "Volume_VolumeInfo_ReadingModes"
              (\ o ->
                 Volume_VolumeInfo_ReadingModes Core.<$>
                   (o Core..:? "image") Core.<*> (o Core..:? "text"))
...
newVolume2 
    ::  Volume2
newVolume2
  = Volume2{items = Core.Nothing, kind = Core.Nothing,
            nextPageToken = Core.Nothing}
instance Core.FromJSON Volume2 where
        parseJSON
          = Core.withObject "Volume2"
              (\ o ->
                 Volume2 Core.<$>
                   (o Core..:? "items") Core.<*> (o Core..:? "kind") Core.<*>
                     (o Core..:? "nextPageToken"))
...
newVolumeannotation 
    ::  Volumeannotation
newVolumeannotation
  = Volumeannotation{annotationDataId = Core.Nothing,
                     annotationDataLink = Core.Nothing, annotationType = Core.Nothing,
                     contentRanges = Core.Nothing, data' = Core.Nothing,
                     deleted = Core.Nothing, id = Core.Nothing, kind = Core.Nothing,
                     layerId = Core.Nothing, pageIds = Core.Nothing,
                     selectedText = Core.Nothing, selfLink = Core.Nothing,
                     updated = Core.Nothing, volumeId = Core.Nothing}
instance Core.FromJSON Volumeannotation where
        parseJSON
          = Core.withObject "Volumeannotation"
              (\ o ->
                 Volumeannotation Core.<$>
                   (o Core..:? "annotationDataId") Core.<*>
                     (o Core..:? "annotationDataLink")
          ...
          = Core.object
              (Core.catMaybes
                 [("annotationDataId" Core..=) Core.<$> annotationDataId,
                  ...
                  ("data" Core..=) Core.<$> data',
                  ("deleted" Core..=) Core.<$> deleted, ("id" Core..=) Core.<$> id,
                  ("kind" Core..=) Core.<$> kind,
                  ("layerId" Core..=) Core.<$> layerId,
                  ("pageIds" Core..=) Core.<$> pageIds,
                  ("selectedText" Core..=) Core.<$> selectedText,
...
newVolumeannotation_ContentRanges 
    ::  Volumeannotation_ContentRanges
newVolumeannotation_ContentRanges
  = Volumeannotation_ContentRanges{cfiRange = Core.Nothing,
                                   contentVersion = Core.Nothing, gbImageRange = Core.Nothing,
                                   gbTextRange = Core.Nothing}
instance Core.FromJSON Volumeannotation_ContentRanges where
        parseJSON
          = Core.withObject "Volumeannotation_ContentRanges"
              (\ o ->
                 Volumeannotation_ContentRanges Core.<$>
                   (o Core..:? "cfiRange") Core.<*> (o Core..:? "contentVersion")
                     Core.<*> (o Core..:? "gbImageRange")
                     Core.<*> (o Core..:? "gbTextRange"))
...
newVolumeannotations 
    ::  Volumeannotations
newVolumeannotations
  = Volumeannotations{items = Core.Nothing, kind = Core.Nothing,
                      nextPageToken = Core.Nothing, totalItems = Core.Nothing,
                      version = Core.Nothing}
instance Core.FromJSON Volumeannotations where
        parseJSON
          = Core.withObject "Volumeannotations"
              (\ o ->
                 Volumeannotations Core.<$>
                   (o Core..:? "items") Core.<*> (o Core..:? "kind") Core.<*>
                     (o Core..:? "nextPageToken")
                     Core.<*> (o Core..:? "totalItems")
                     Core.<*> (o Core..:? "version"))
...
newVolumes 
    ::  Volumes
newVolumes
  = Volumes{items = Core.Nothing, kind = Core.Nothing,
            totalItems = Core.Nothing}
instance Core.FromJSON Volumes where
        parseJSON
          = Core.withObject "Volumes"
              (\ o ->
                 Volumes Core.<$>
                   (o Core..:? "items") Core.<*> (o Core..:? "kind") Core.<*>
                     (o Core..:? "totalItems"))
...
newVolumeseriesinfo 
    ::  Volumeseriesinfo
newVolumeseriesinfo
  = Volumeseriesinfo{bookDisplayNumber = Core.Nothing,
                     kind = Core.Nothing, shortSeriesBookTitle = Core.Nothing,
                     volumeSeries = Core.Nothing}
instance Core.FromJSON Volumeseriesinfo where
        parseJSON
          = Core.withObject "Volumeseriesinfo"
              (\ o ->
                 Volumeseriesinfo Core.<$>
                   (o Core..:? "bookDisplayNumber") Core.<*> (o Core..:? "kind")
...
newVolumeseriesinfo_VolumeSeriesItem 
    :: 
                                     Volumeseriesinfo_VolumeSeriesItem
newVolumeseriesinfo_VolumeSeriesItem
  = Volumeseriesinfo_VolumeSeriesItem{issue = Core.Nothing,
                                      orderNumber = Core.Nothing, seriesBookType = Core.Nothing,
                                      seriesId = Core.Nothing}
instance Core.FromJSON Volumeseriesinfo_VolumeSeriesItem where
        parseJSON
          = Core.withObject "Volumeseriesinfo_VolumeSeriesItem"
              (\ o ->
                 Volumeseriesinfo_VolumeSeriesItem Core.<$>
                   (o Core..:? "issue") Core.<*> (o Core..:? "orderNumber") Core.<*>
                     (o Core..:? "seriesBookType")
                     Core.<*> (o Core..:? "seriesId"))
...
newVolumeseriesinfo_VolumeSeriesItem_IssueItem 
    :: 
                                               Volumeseriesinfo_VolumeSeriesItem_IssueItem
newVolumeseriesinfo_VolumeSeriesItem_IssueItem
  = Volumeseriesinfo_VolumeSeriesItem_IssueItem{issueDisplayNumber =
                                                  Core.Nothing,
                                                issueOrderNumber = Core.Nothing}
instance Core.FromJSON Volumeseriesinfo_VolumeSeriesItem_IssueItem
         where
        parseJSON
          = Core.withObject "Volumeseriesinfo_VolumeSeriesItem_IssueItem"
              (\ o ->
                 Volumeseriesinfo_VolumeSeriesItem_IssueItem Core.<$>
                   (o Core..:? "issueDisplayNumber") Core.<*>
                     (o Core..:? "issueOrderNumber"))

instance Core.ToJSON Volumeseriesinfo_VolumeSeriesItem_IssueItem
         where
