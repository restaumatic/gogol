...
newBooksDictionaryListOfflineMetadata cpksver
  = BooksDictionaryListOfflineMetadata{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       cpksver = cpksver, uploadType = Core.Nothing,
                                       uploadProtocol = Core.Nothing}
instance Core.GoogleRequest BooksDictionaryListOfflineMetadata
         where
        type Rs BooksDictionaryListOfflineMetadata = Metadata
        type Scopes BooksDictionaryListOfflineMetadata =
             '[Books'FullControl]
        requestClient BooksDictionaryListOfflineMetadata{..}
          = go (Core.Just cpksver) xgafv accessToken callback uploadType
              uploadProtocol
