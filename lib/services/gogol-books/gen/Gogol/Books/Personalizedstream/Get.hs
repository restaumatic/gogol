                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Get '[Core.JSON] Discoveryclusters
...
newBooksPersonalizedstreamGet 
    ::  BooksPersonalizedstreamGet
newBooksPersonalizedstreamGet
  = BooksPersonalizedstreamGet{xgafv = Core.Nothing,
                               accessToken = Core.Nothing, callback = Core.Nothing,
                               locale = Core.Nothing, maxAllowedMaturityRating = Core.Nothing,
                               source = Core.Nothing, uploadType = Core.Nothing,
                               uploadProtocol = Core.Nothing}
instance Core.GoogleRequest BooksPersonalizedstreamGet where
        type Rs BooksPersonalizedstreamGet = Discoveryclusters
        type Scopes BooksPersonalizedstreamGet = '[Books'FullControl]
        requestClient BooksPersonalizedstreamGet{..}
          = go xgafv accessToken callback locale maxAllowedMaturityRating
              source
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy BooksPersonalizedstreamGetResource)
                      Core.mempty
