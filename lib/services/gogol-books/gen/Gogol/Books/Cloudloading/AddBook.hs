...
-- |
-- Module      : Gogol.Books.Cloudloading.AddBook
             ...
             Core.QueryParam "$.xgafv" Xgafv Core.:>
               Core.QueryParam "access_token" Core.Text Core.:>
                 Core.QueryParam "callback" Core.Text Core.:>
                   Core.QueryParam "drive_document_id" Core.Text Core.:>
                     Core.QueryParam "mime_type" Core.Text Core.:>
                       Core.QueryParam "name" Core.Text Core.:>
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_client_token" Core.Text Core.:>
...
newBooksCloudloadingAddBook 
    ::  BooksCloudloadingAddBook
newBooksCloudloadingAddBook
  = BooksCloudloadingAddBook{xgafv = Core.Nothing,
                             accessToken = Core.Nothing, callback = Core.Nothing,
                             driveDocumentId = Core.Nothing, mimeType = Core.Nothing,
                             name = Core.Nothing, uploadType = Core.Nothing,
                             uploadClientToken = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest BooksCloudloadingAddBook where
        type Rs BooksCloudloadingAddBook = BooksCloudloadingResource
        type Scopes BooksCloudloadingAddBook = '[Books'FullControl]
        requestClient BooksCloudloadingAddBook{..}
          = go xgafv accessToken callback driveDocumentId mimeType name
              uploadType
              uploadClientToken
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy BooksCloudloadingAddBookResource)
                      Core.mempty
