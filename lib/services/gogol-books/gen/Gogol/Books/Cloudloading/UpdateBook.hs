                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] BooksCloudloadingResource Core.:>
...
newBooksCloudloadingUpdateBook payload
  = BooksCloudloadingUpdateBook{xgafv = Core.Nothing,
                                accessToken = Core.Nothing, callback = Core.Nothing,
                                payload = payload, uploadType = Core.Nothing,
                                uploadProtocol = Core.Nothing}
instance Core.GoogleRequest BooksCloudloadingUpdateBook where
        type Rs BooksCloudloadingUpdateBook = BooksCloudloadingResource
        type Scopes BooksCloudloadingUpdateBook = '[Books'FullControl]
        requestClient BooksCloudloadingUpdateBook{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy BooksCloudloadingUpdateBookResource)
                      Core.mempty
