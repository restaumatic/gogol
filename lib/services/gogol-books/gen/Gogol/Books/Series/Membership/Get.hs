     ...
     "books" Core.:>
       "v1" Core.:>
         "series" Core.:>
           "membership" Core.:>
             "get" Core.:>
               Core.QueryParam "series_id" Core.Text Core.:>
                 Core.QueryParam "$.xgafv" Xgafv Core.:>
                   Core.QueryParam "access_token" Core.Text Core.:>
                     Core.QueryParam "callback" Core.Text Core.:>
                       Core.QueryParam "page_size" Core.Word32 Core.:>
                         Core.QueryParam "page_token" Core.Text Core.:>
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.Get '[Core.JSON] Seriesmembership
...
instance Core.GoogleRequest BooksSeriesMembershipGet where
        ...
        requestClient BooksSeriesMembershipGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy BooksSeriesMembershipGetResource)
                      Core.mempty
