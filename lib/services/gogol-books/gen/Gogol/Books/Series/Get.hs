...
newBooksSeriesGet seriesId
  = BooksSeriesGet{xgafv = Core.Nothing, accessToken = Core.Nothing,
                   callback = Core.Nothing, seriesId = seriesId,
...
instance Core.GoogleRequest BooksSeriesGet where
        ...
        requestClient BooksSeriesGet{..}
          = go seriesId xgafv accessToken callback uploadType uploadProtocol
