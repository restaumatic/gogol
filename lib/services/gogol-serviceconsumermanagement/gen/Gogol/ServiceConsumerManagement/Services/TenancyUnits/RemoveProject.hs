...
type ServiceConsumerManagementServicesTenancyUnitsRemoveProjectResource
     =
     "v1" Core.:>
       Core.CaptureMode "name" "removeProject" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] RemoveTenantProjectRequest Core.:>
...
newServiceConsumerManagementServicesTenancyUnitsRemoveProject 
    ...
    -> ServiceConsumerManagementServicesTenancyUnitsRemoveProject
newServiceConsumerManagementServicesTenancyUnitsRemoveProject name
  payload
  = ServiceConsumerManagementServicesTenancyUnitsRemoveProject{xgafv
                                                                 = Core.Nothing,
...
instance Core.GoogleRequest
           ServiceConsumerManagementServicesTenancyUnitsRemoveProject
         where
        type Rs ServiceConsumerManagementServicesTenancyUnitsRemoveProject
             = Operation
        type Scopes
               ServiceConsumerManagementServicesTenancyUnitsRemoveProject
