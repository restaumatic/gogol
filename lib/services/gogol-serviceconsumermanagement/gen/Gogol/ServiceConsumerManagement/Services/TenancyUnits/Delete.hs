...
newServiceConsumerManagementServicesTenancyUnitsDelete name
  = ServiceConsumerManagementServicesTenancyUnitsDelete{xgafv =
                                                          Core.Nothing,
...
instance Core.GoogleRequest
           ServiceConsumerManagementServicesTenancyUnitsDelete
         where
        type Rs ServiceConsumerManagementServicesTenancyUnitsDelete =
             Operation
        type Scopes ServiceConsumerManagementServicesTenancyUnitsDelete =
