...
type ServiceConsumerManagementServicesTenancyUnitsUndeleteProjectResource
     =
     "v1" Core.:>
       Core.CaptureMode "name" "undeleteProject" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] UndeleteTenantProjectRequest Core.:>
...
newServiceConsumerManagementServicesTenancyUnitsUndeleteProject
  name payload
  = ServiceConsumerManagementServicesTenancyUnitsUndeleteProject{xgafv
                                                                   = Core.Nothing,
