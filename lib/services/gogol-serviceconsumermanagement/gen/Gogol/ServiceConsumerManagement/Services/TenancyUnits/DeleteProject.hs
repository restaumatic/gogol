...
type ServiceConsumerManagementServicesTenancyUnitsDeleteProjectResource
     =
     "v1" Core.:>
       Core.CaptureMode "name" "deleteProject" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] DeleteTenantProjectRequest Core.:>
...
newServiceConsumerManagementServicesTenancyUnitsDeleteProject 
    ...
    -> ServiceConsumerManagementServicesTenancyUnitsDeleteProject
newServiceConsumerManagementServicesTenancyUnitsDeleteProject name
  payload
  = ServiceConsumerManagementServicesTenancyUnitsDeleteProject{xgafv
                                                                 = Core.Nothing,
...
instance Core.GoogleRequest
           ServiceConsumerManagementServicesTenancyUnitsDeleteProject
         where
        type Rs ServiceConsumerManagementServicesTenancyUnitsDeleteProject
             = Operation
        type Scopes
               ServiceConsumerManagementServicesTenancyUnitsDeleteProject
