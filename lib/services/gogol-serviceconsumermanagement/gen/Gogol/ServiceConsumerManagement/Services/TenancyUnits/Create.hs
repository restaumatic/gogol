                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] CreateTenancyUnitRequest Core.:>
                         Core.Post '[Core.JSON] TenancyUnit
...
newServiceConsumerManagementServicesTenancyUnitsCreate 
    ...
    -> ServiceConsumerManagementServicesTenancyUnitsCreate
newServiceConsumerManagementServicesTenancyUnitsCreate parent
  payload
  = ServiceConsumerManagementServicesTenancyUnitsCreate{xgafv =
                                                          Core.Nothing,
...
instance Core.GoogleRequest
           ServiceConsumerManagementServicesTenancyUnitsCreate
         where
        type Rs ServiceConsumerManagementServicesTenancyUnitsCreate =
             TenancyUnit
        type Scopes ServiceConsumerManagementServicesTenancyUnitsCreate =
