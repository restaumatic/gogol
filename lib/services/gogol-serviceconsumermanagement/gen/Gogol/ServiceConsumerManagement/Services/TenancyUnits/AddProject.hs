...
type ServiceConsumerManagementServicesTenancyUnitsAddProjectResource
     =
     "v1" Core.:>
       Core.CaptureMode "parent" "addProject" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] AddTenantProjectRequest Core.:>
...
newServiceConsumerManagementServicesTenancyUnitsAddProject 
    ...
    -> ServiceConsumerManagementServicesTenancyUnitsAddProject
newServiceConsumerManagementServicesTenancyUnitsAddProject parent
  payload
  = ServiceConsumerManagementServicesTenancyUnitsAddProject{xgafv =
                                                              Core.Nothing,
...
instance Core.GoogleRequest
           ServiceConsumerManagementServicesTenancyUnitsAddProject
         where
        type Rs ServiceConsumerManagementServicesTenancyUnitsAddProject =
             Operation
        type Scopes ServiceConsumerManagementServicesTenancyUnitsAddProject
