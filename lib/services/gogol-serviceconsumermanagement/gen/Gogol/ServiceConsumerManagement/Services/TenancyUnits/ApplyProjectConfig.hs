...
type ServiceConsumerManagementServicesTenancyUnitsApplyProjectConfigResource
     =
     "v1" Core.:>
       Core.CaptureMode "name" "applyProjectConfig" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] ApplyTenantProjectConfigRequest Core.:>
...
newServiceConsumerManagementServicesTenancyUnitsApplyProjectConfig
  name payload
  = ServiceConsumerManagementServicesTenancyUnitsApplyProjectConfig{xgafv
                                                                      = Core.Nothing,
