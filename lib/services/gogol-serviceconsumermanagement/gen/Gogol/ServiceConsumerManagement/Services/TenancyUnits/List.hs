...
newServiceConsumerManagementServicesTenancyUnitsList parent
  = ServiceConsumerManagementServicesTenancyUnitsList{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           ServiceConsumerManagementServicesTenancyUnitsList
         where
        type Rs ServiceConsumerManagementServicesTenancyUnitsList =
             ListTenancyUnitsResponse
        type Scopes ServiceConsumerManagementServicesTenancyUnitsList =
             '[CloudPlatform'FullControl]
        requestClient ServiceConsumerManagementServicesTenancyUnitsList{..}
