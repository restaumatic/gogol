...
type ServiceConsumerManagementServicesTenancyUnitsAttachProjectResource
     =
     "v1" Core.:>
       Core.CaptureMode "name" "attachProject" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] AttachTenantProjectRequest Core.:>
...
newServiceConsumerManagementServicesTenancyUnitsAttachProject 
    ...
    -> ServiceConsumerManagementServicesTenancyUnitsAttachProject
newServiceConsumerManagementServicesTenancyUnitsAttachProject name
  payload
  = ServiceConsumerManagementServicesTenancyUnitsAttachProject{xgafv
                                                                 = Core.Nothing,
...
instance Core.GoogleRequest
           ServiceConsumerManagementServicesTenancyUnitsAttachProject
         where
        type Rs ServiceConsumerManagementServicesTenancyUnitsAttachProject
             = Operation
        type Scopes
               ServiceConsumerManagementServicesTenancyUnitsAttachProject
