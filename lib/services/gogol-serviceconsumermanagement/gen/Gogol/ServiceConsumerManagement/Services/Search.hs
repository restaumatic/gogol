...
type ServiceConsumerManagementServicesSearchResource =
     "v1" Core.:>
       Core.CaptureMode "parent" "search" Core.Text Core.:>
                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] SearchTenancyUnitsResponse
...
newServiceConsumerManagementServicesSearch parent
  = ServiceConsumerManagementServicesSearch{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            pageSize = Core.Nothing, pageToken = Core.Nothing,
                                            parent = parent, query = Core.Nothing,
                                            uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ServiceConsumerManagementServicesSearch
         where
        type Rs ServiceConsumerManagementServicesSearch =
             SearchTenancyUnitsResponse
        type Scopes ServiceConsumerManagementServicesSearch =
             '[CloudPlatform'FullControl]
        requestClient ServiceConsumerManagementServicesSearch{..}
          = go parent xgafv accessToken callback pageSize pageToken query
              uploadType
              uploadProtocol
