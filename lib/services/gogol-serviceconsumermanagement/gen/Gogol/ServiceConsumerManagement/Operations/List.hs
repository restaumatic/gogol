...
instance Core.GoogleRequest ServiceConsumerManagementOperationsList
        ...
        requestClient ServiceConsumerManagementOperationsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ServiceConsumerManagementOperationsListResource)
                      Core.mempty
