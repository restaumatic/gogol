...
-- |
-- Module      : Gogol.ServiceConsumerManagement.Operations.Delete
...
newServiceConsumerManagementOperationsDelete name
  = ServiceConsumerManagementOperationsDelete{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           ServiceConsumerManagementOperationsDelete
         where
        type Rs ServiceConsumerManagementOperationsDelete = Empty
        type Scopes ServiceConsumerManagementOperationsDelete =
             '[CloudPlatform'FullControl]
        requestClient ServiceConsumerManagementOperationsDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ServiceConsumerManagementOperationsDeleteResource)
                      Core.mempty
