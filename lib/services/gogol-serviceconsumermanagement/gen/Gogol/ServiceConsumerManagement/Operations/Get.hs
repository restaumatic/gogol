...
newServiceConsumerManagementOperationsGet name
  = ServiceConsumerManagementOperationsGet{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           name = name, uploadType = Core.Nothing,
                                           uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ServiceConsumerManagementOperationsGet
         where
        type Rs ServiceConsumerManagementOperationsGet = Operation
        type Scopes ServiceConsumerManagementOperationsGet =
             '[CloudPlatform'FullControl]
        requestClient ServiceConsumerManagementOperationsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ServiceConsumerManagementOperationsGetResource)
                      Core.mempty
