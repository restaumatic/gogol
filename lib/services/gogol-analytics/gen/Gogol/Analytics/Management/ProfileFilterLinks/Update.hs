...
newAnalyticsManagementProfileFilterLinksUpdate 
    ...
    -> AnalyticsManagementProfileFilterLinksUpdate
newAnalyticsManagementProfileFilterLinksUpdate accountId linkId
  payload profileId webPropertyId
  = AnalyticsManagementProfileFilterLinksUpdate{accountId =
                                                  accountId,
...
instance Core.GoogleRequest
        ...
        type Rs AnalyticsManagementProfileFilterLinksUpdate =
             ProfileFilterLink
        type Scopes AnalyticsManagementProfileFilterLinksUpdate =
             '[Analytics'Edit]
