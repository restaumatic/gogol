                       ...
                       "profileFilterLinks" Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] ProfileFilterLink Core.:>
                             Core.Post '[Core.JSON] ProfileFilterLink
...
newAnalyticsManagementProfileFilterLinksInsert 
    ...
    -> AnalyticsManagementProfileFilterLinksInsert
newAnalyticsManagementProfileFilterLinksInsert accountId payload
  profileId webPropertyId
  = AnalyticsManagementProfileFilterLinksInsert{accountId =
                                                  accountId,
...
instance Core.GoogleRequest
           AnalyticsManagementProfileFilterLinksInsert
         where
        type Rs AnalyticsManagementProfileFilterLinksInsert =
             ProfileFilterLink
        type Scopes AnalyticsManagementProfileFilterLinksInsert =
             '[Analytics'Edit]
