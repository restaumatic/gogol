...
newAnalyticsManagementProfileFilterLinksDelete 
    ...
    -> AnalyticsManagementProfileFilterLinksDelete
newAnalyticsManagementProfileFilterLinksDelete accountId linkId
  profileId webPropertyId
  = AnalyticsManagementProfileFilterLinksDelete{accountId =
                                                  accountId,
...
instance Core.GoogleRequest
        ...
        type Scopes AnalyticsManagementProfileFilterLinksDelete =
             '[Analytics'Edit]
        requestClient AnalyticsManagementProfileFilterLinksDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AnalyticsManagementProfileFilterLinksDeleteResource)
                      Core.mempty
