...
newAnalyticsManagementProfileFilterLinksPatch 
    ...
    -> AnalyticsManagementProfileFilterLinksPatch
newAnalyticsManagementProfileFilterLinksPatch accountId linkId
  payload profileId webPropertyId
  = AnalyticsManagementProfileFilterLinksPatch{accountId = accountId,
...
instance Core.GoogleRequest
        ...
        type Rs AnalyticsManagementProfileFilterLinksPatch =
             ProfileFilterLink
        type Scopes AnalyticsManagementProfileFilterLinksPatch =
             '[Analytics'Edit]
