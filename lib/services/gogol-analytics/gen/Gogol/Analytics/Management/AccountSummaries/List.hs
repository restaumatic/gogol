             ...
             Core.QueryParam "max-results" Core.Int32 Core.:>
               Core.QueryParam "start-index" Core.Int32 Core.:>
                 Core.QueryParam "alt" Core.AltJSON Core.:>
                   Core.Get '[Core.JSON] AccountSummaries
...
newAnalyticsManagementAccountSummariesList 
    :: 
                                           AnalyticsManagementAccountSummariesList
newAnalyticsManagementAccountSummariesList
  = AnalyticsManagementAccountSummariesList{maxResults =
                                              Core.Nothing,
                                            startIndex = Core.Nothing}
instance Core.GoogleRequest AnalyticsManagementAccountSummariesList
         where
        type Rs AnalyticsManagementAccountSummariesList = AccountSummaries
        type Scopes AnalyticsManagementAccountSummariesList =
