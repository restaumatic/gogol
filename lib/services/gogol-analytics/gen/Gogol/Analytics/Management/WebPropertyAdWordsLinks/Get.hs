                   ...
                   "entityAdWordsLinks" Core.:>
                     Core.Capture "webPropertyAdWordsLinkId" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.Get '[Core.JSON] EntityAdWordsLink
...
newAnalyticsManagementWebPropertyAdWordsLinksGet 
    ...
    -> AnalyticsManagementWebPropertyAdWordsLinksGet
newAnalyticsManagementWebPropertyAdWordsLinksGet accountId
  webPropertyAdWordsLinkId webPropertyId
  = AnalyticsManagementWebPropertyAdWordsLinksGet{accountId =
                                                    accountId,
...
instance Core.GoogleRequest
           AnalyticsManagementWebPropertyAdWordsLinksGet
         where
        type Rs AnalyticsManagementWebPropertyAdWordsLinksGet =
             EntityAdWordsLink
        type Scopes AnalyticsManagementWebPropertyAdWordsLinksGet =
             '[Analytics'Edit, Analytics'Readonly]
        requestClient AnalyticsManagementWebPropertyAdWordsLinksGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AnalyticsManagementWebPropertyAdWordsLinksGetResource)
                      Core.mempty
