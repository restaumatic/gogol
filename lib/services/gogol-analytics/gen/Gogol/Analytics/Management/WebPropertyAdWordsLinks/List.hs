...
newAnalyticsManagementWebPropertyAdWordsLinksList 
    ...
    -> AnalyticsManagementWebPropertyAdWordsLinksList
newAnalyticsManagementWebPropertyAdWordsLinksList accountId
  webPropertyId
  = AnalyticsManagementWebPropertyAdWordsLinksList{accountId =
                                                     accountId,
...
instance Core.GoogleRequest
           AnalyticsManagementWebPropertyAdWordsLinksList
         where
        type Rs AnalyticsManagementWebPropertyAdWordsLinksList =
             EntityAdWordsLinks
