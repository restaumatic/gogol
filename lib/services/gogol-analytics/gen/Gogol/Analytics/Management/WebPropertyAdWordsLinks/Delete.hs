...
newAnalyticsManagementWebPropertyAdWordsLinksDelete 
    ...
    -> AnalyticsManagementWebPropertyAdWordsLinksDelete
newAnalyticsManagementWebPropertyAdWordsLinksDelete accountId
  webPropertyAdWordsLinkId webPropertyId
  = AnalyticsManagementWebPropertyAdWordsLinksDelete{accountId =
                                                       accountId,
...
instance Core.GoogleRequest
           AnalyticsManagementWebPropertyAdWordsLinksDelete
         where
        type Rs AnalyticsManagementWebPropertyAdWordsLinksDelete = ()
        type Scopes AnalyticsManagementWebPropertyAdWordsLinksDelete =
             '[Analytics'Edit]
        requestClient AnalyticsManagementWebPropertyAdWordsLinksDelete{..}
