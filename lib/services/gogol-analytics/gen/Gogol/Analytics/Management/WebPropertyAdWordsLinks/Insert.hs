...
newAnalyticsManagementWebPropertyAdWordsLinksInsert 
    ...
    -> AnalyticsManagementWebPropertyAdWordsLinksInsert
newAnalyticsManagementWebPropertyAdWordsLinksInsert accountId
  payload webPropertyId
  = AnalyticsManagementWebPropertyAdWordsLinksInsert{accountId =
                                                       accountId,
                                                     payload = payload,
...
instance Core.GoogleRequest
           AnalyticsManagementWebPropertyAdWordsLinksInsert
         where
        type Rs AnalyticsManagementWebPropertyAdWordsLinksInsert =
             EntityAdWordsLink
        type Scopes AnalyticsManagementWebPropertyAdWordsLinksInsert =
             '[Analytics'Edit]
