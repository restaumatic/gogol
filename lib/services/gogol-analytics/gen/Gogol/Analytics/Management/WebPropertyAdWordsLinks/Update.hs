...
newAnalyticsManagementWebPropertyAdWordsLinksUpdate 
    ...
    -> AnalyticsManagementWebPropertyAdWordsLinksUpdate
newAnalyticsManagementWebPropertyAdWordsLinksUpdate accountId
  payload webPropertyAdWordsLinkId webPropertyId
  = AnalyticsManagementWebPropertyAdWordsLinksUpdate{accountId =
                                                       accountId,
                                                     payload = payload,
...
instance Core.GoogleRequest
           AnalyticsManagementWebPropertyAdWordsLinksUpdate
         where
        type Rs AnalyticsManagementWebPropertyAdWordsLinksUpdate =
             EntityAdWordsLink
        type Scopes AnalyticsManagementWebPropertyAdWordsLinksUpdate =
             '[Analytics'Edit]
        requestClient AnalyticsManagementWebPropertyAdWordsLinksUpdate{..}
