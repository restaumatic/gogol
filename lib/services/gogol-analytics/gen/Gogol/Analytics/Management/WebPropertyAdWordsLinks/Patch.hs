               ...
               "webproperties" Core.:>
                 Core.Capture "webPropertyId" Core.Text Core.:>
                   "entityAdWordsLinks" Core.:>
                     Core.Capture "webPropertyAdWordsLinkId" Core.Text Core.:>
...
newAnalyticsManagementWebPropertyAdWordsLinksPatch 
    ...
    -> AnalyticsManagementWebPropertyAdWordsLinksPatch
newAnalyticsManagementWebPropertyAdWordsLinksPatch accountId
  payload webPropertyAdWordsLinkId webPropertyId
  = AnalyticsManagementWebPropertyAdWordsLinksPatch{accountId =
                                                      accountId,
                                                    payload = payload,
...
instance Core.GoogleRequest
           AnalyticsManagementWebPropertyAdWordsLinksPatch
         where
        type Rs AnalyticsManagementWebPropertyAdWordsLinksPatch =
             EntityAdWordsLink
        type Scopes AnalyticsManagementWebPropertyAdWordsLinksPatch =
             '[Analytics'Edit]
        requestClient AnalyticsManagementWebPropertyAdWordsLinksPatch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AnalyticsManagementWebPropertyAdWordsLinksPatchResource)
                      Core.mempty
