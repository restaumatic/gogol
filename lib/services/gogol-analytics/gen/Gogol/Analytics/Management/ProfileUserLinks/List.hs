...
newAnalyticsManagementProfileUserLinksList 
    ...
    -> AnalyticsManagementProfileUserLinksList
newAnalyticsManagementProfileUserLinksList accountId profileId
  webPropertyId
  = AnalyticsManagementProfileUserLinksList{accountId = accountId,
                                            maxResults = Core.Nothing, profileId = profileId,
                                            startIndex = Core.Nothing,
                                            webPropertyId = webPropertyId}
instance Core.GoogleRequest AnalyticsManagementProfileUserLinksList
         where
        type Rs AnalyticsManagementProfileUserLinksList = EntityUserLinks
        type Scopes AnalyticsManagementProfileUserLinksList =
