...
newAnalyticsManagementProfileUserLinksDelete 
    ...
    -> AnalyticsManagementProfileUserLinksDelete
newAnalyticsManagementProfileUserLinksDelete accountId linkId
  profileId webPropertyId
  = AnalyticsManagementProfileUserLinksDelete{accountId = accountId,
                                              linkId = linkId, profileId = profileId,
                                              webPropertyId = webPropertyId}
instance Core.GoogleRequest
           AnalyticsManagementProfileUserLinksDelete
         where
        type Rs AnalyticsManagementProfileUserLinksDelete = ()
        type Scopes AnalyticsManagementProfileUserLinksDelete =
             '[Analytics'Manage'Users]
        requestClient AnalyticsManagementProfileUserLinksDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AnalyticsManagementProfileUserLinksDeleteResource)
                      Core.mempty
