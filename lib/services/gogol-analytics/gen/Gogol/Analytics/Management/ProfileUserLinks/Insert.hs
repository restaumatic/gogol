...
newAnalyticsManagementProfileUserLinksInsert 
    ...
    -> AnalyticsManagementProfileUserLinksInsert
newAnalyticsManagementProfileUserLinksInsert accountId payload
  profileId webPropertyId
  = AnalyticsManagementProfileUserLinksInsert{accountId = accountId,
                                              payload = payload, profileId = profileId,
                                              webPropertyId = webPropertyId}
instance Core.GoogleRequest
           AnalyticsManagementProfileUserLinksInsert
         where
        type Rs AnalyticsManagementProfileUserLinksInsert = EntityUserLink
        type Scopes AnalyticsManagementProfileUserLinksInsert =
             '[Analytics'Manage'Users]
        requestClient AnalyticsManagementProfileUserLinksInsert{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AnalyticsManagementProfileUserLinksInsertResource)
                      Core.mempty
