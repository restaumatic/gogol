...
newAnalyticsManagementWebpropertiesPatch 
    ...
    -> AnalyticsManagementWebpropertiesPatch
newAnalyticsManagementWebpropertiesPatch accountId payload
  webPropertyId
  = AnalyticsManagementWebpropertiesPatch{accountId = accountId,
                                          payload = payload, webPropertyId = webPropertyId}
instance Core.GoogleRequest AnalyticsManagementWebpropertiesPatch
         where
