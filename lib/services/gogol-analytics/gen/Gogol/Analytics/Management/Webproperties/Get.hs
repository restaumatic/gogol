               ...
               "webproperties" Core.:>
                 Core.Capture "webPropertyId" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.Get '[Core.JSON] Webproperty
...
newAnalyticsManagementWebpropertiesGet accountId webPropertyId
  = AnalyticsManagementWebpropertiesGet{accountId = accountId,
                                        webPropertyId = webPropertyId}
instance Core.GoogleRequest AnalyticsManagementWebpropertiesGet
         where
        type Rs AnalyticsManagementWebpropertiesGet = Webproperty
        type Scopes AnalyticsManagementWebpropertiesGet =
