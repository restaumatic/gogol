...
newAnalyticsManagementSegmentsList 
    :: 
                                   AnalyticsManagementSegmentsList
newAnalyticsManagementSegmentsList
  = AnalyticsManagementSegmentsList{maxResults = Core.Nothing,
                                    startIndex = Core.Nothing}
instance Core.GoogleRequest AnalyticsManagementSegmentsList where
        ...
        requestClient AnalyticsManagementSegmentsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy AnalyticsManagementSegmentsListResource)
                      Core.mempty
