                       ...
                       "goals" Core.:>
                         Core.Capture "goalId" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] Goal Core.:> Core.Put '[Core.JSON] Goal
...
newAnalyticsManagementGoalsUpdate 
    ...
    -> AnalyticsManagementGoalsUpdate
newAnalyticsManagementGoalsUpdate accountId goalId payload
  profileId webPropertyId
  = AnalyticsManagementGoalsUpdate{accountId = accountId,
                                   goalId = goalId, payload = payload, profileId = profileId,
