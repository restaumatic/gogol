                     ...
                     Core.Capture "profileId" Core.Text Core.:>
                       "goals" Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] Goal Core.:> Core.Post '[Core.JSON] Goal
...
newAnalyticsManagementGoalsInsert 
    ...
    -> AnalyticsManagementGoalsInsert
newAnalyticsManagementGoalsInsert accountId payload profileId
  webPropertyId
  = AnalyticsManagementGoalsInsert{accountId = accountId,
                                   payload = payload, profileId = profileId,
                                   webPropertyId = webPropertyId}
instance Core.GoogleRequest AnalyticsManagementGoalsInsert where
        type Rs AnalyticsManagementGoalsInsert = Goal
        type Scopes AnalyticsManagementGoalsInsert = '[Analytics'Edit]
        requestClient AnalyticsManagementGoalsInsert{..}
          = go accountId webPropertyId profileId (Core.Just Core.AltJSON)
              payload
              analyticsService
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy AnalyticsManagementGoalsInsertResource)
                      Core.mempty
