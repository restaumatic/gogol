                       ...
                       "goals" Core.:>
                         Core.Capture "goalId" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] Goal Core.:> Core.Patch '[Core.JSON] Goal
...
newAnalyticsManagementGoalsPatch 
    ...
    -> AnalyticsManagementGoalsPatch
newAnalyticsManagementGoalsPatch accountId goalId payload profileId
  webPropertyId
  = AnalyticsManagementGoalsPatch{accountId = accountId,
