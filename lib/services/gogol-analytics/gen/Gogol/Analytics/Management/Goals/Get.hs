...
newAnalyticsManagementGoalsGet 
    ...
    -> AnalyticsManagementGoalsGet
newAnalyticsManagementGoalsGet accountId goalId profileId
  webPropertyId
  = AnalyticsManagementGoalsGet{accountId = accountId,
...
instance Core.GoogleRequest AnalyticsManagementGoalsGet where
        ...
        type Scopes AnalyticsManagementGoalsGet =
