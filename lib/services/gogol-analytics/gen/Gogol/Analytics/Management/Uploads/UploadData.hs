                           ...
                           "uploads" Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.QueryParam "uploadType" Core.AltMedia Core.:>
                                 Core.AltMedia Core.:> Core.Post '[Core.JSON] Upload
...
newAnalyticsManagementUploadsUploadData 
    ...
    -> AnalyticsManagementUploadsUploadData
newAnalyticsManagementUploadsUploadData accountId
  customDataSourceId webPropertyId
  = AnalyticsManagementUploadsUploadData{accountId = accountId,
                                         customDataSourceId = customDataSourceId,
                                         webPropertyId = webPropertyId}
instance Core.GoogleRequest AnalyticsManagementUploadsUploadData
         where
        ...
        requestClient AnalyticsManagementUploadsUploadData{..}
          ...
          where go Core.:<|> _
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AnalyticsManagementUploadsUploadDataResource)
                      Core.mempty

instance Core.GoogleRequest
           (Core.MediaUpload AnalyticsManagementUploadsUploadData)
         where
        type Rs (Core.MediaUpload AnalyticsManagementUploadsUploadData) =
             Upload
        type Scopes (Core.MediaUpload AnalyticsManagementUploadsUploadData)
             = Core.Scopes AnalyticsManagementUploadsUploadData
        requestClient
          (Core.MediaUpload AnalyticsManagementUploadsUploadData{..} body)
          = go accountId webPropertyId customDataSourceId
              (Core.Just Core.AltJSON)
