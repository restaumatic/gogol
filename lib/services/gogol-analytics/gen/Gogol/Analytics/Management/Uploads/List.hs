...
newAnalyticsManagementUploadsList 
    ...
    -> AnalyticsManagementUploadsList
newAnalyticsManagementUploadsList accountId customDataSourceId
  webPropertyId
  = AnalyticsManagementUploadsList{accountId = accountId,
...
instance Core.GoogleRequest AnalyticsManagementUploadsList where
        ...
        requestClient AnalyticsManagementUploadsList{..}
          = go accountId webPropertyId customDataSourceId maxResults
              startIndex
