...
newAnalyticsManagementUploadsGet 
    ...
    -> AnalyticsManagementUploadsGet
newAnalyticsManagementUploadsGet accountId customDataSourceId
  uploadId webPropertyId
  = AnalyticsManagementUploadsGet{accountId = accountId,
                                  customDataSourceId = customDataSourceId, uploadId = uploadId,
...
instance Core.GoogleRequest AnalyticsManagementUploadsGet where
        ...
        requestClient AnalyticsManagementUploadsGet{..}
          = go accountId webPropertyId customDataSourceId uploadId
