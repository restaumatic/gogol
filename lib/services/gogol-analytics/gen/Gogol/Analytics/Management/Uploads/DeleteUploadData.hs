...
newAnalyticsManagementUploadsDeleteUploadData 
    ...
    -> AnalyticsManagementUploadsDeleteUploadData
newAnalyticsManagementUploadsDeleteUploadData accountId
  customDataSourceId payload webPropertyId
  = AnalyticsManagementUploadsDeleteUploadData{accountId = accountId,
...
instance Core.GoogleRequest
        ...
        type Scopes AnalyticsManagementUploadsDeleteUploadData =
