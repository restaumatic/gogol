...
newAnalyticsManagementWebpropertyUserLinksDelete 
    ...
    -> AnalyticsManagementWebpropertyUserLinksDelete
newAnalyticsManagementWebpropertyUserLinksDelete accountId linkId
  webPropertyId
  = AnalyticsManagementWebpropertyUserLinksDelete{accountId =
                                                    accountId,
                                                  linkId = linkId, webPropertyId = webPropertyId}
instance Core.GoogleRequest
           AnalyticsManagementWebpropertyUserLinksDelete
         where
        type Rs AnalyticsManagementWebpropertyUserLinksDelete = ()
        type Scopes AnalyticsManagementWebpropertyUserLinksDelete =
             '[Analytics'Manage'Users]
        requestClient AnalyticsManagementWebpropertyUserLinksDelete{..}
          = go accountId webPropertyId linkId (Core.Just Core.AltJSON)
              analyticsService
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AnalyticsManagementWebpropertyUserLinksDeleteResource)
                      Core.mempty
