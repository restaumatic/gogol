...
newAnalyticsManagementWebpropertyUserLinksInsert 
    ...
    -> AnalyticsManagementWebpropertyUserLinksInsert
newAnalyticsManagementWebpropertyUserLinksInsert accountId payload
  webPropertyId
  = AnalyticsManagementWebpropertyUserLinksInsert{accountId =
                                                    accountId,
...
instance Core.GoogleRequest
        ...
        type Rs AnalyticsManagementWebpropertyUserLinksInsert =
             EntityUserLink
        type Scopes AnalyticsManagementWebpropertyUserLinksInsert =
