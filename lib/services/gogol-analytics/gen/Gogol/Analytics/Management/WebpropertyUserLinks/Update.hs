...
newAnalyticsManagementWebpropertyUserLinksUpdate 
    ...
    -> AnalyticsManagementWebpropertyUserLinksUpdate
newAnalyticsManagementWebpropertyUserLinksUpdate accountId linkId
  payload webPropertyId
  = AnalyticsManagementWebpropertyUserLinksUpdate{accountId =
                                                    accountId,
                                                  linkId = linkId, payload = payload,
                                                  webPropertyId = webPropertyId}
instance Core.GoogleRequest
           AnalyticsManagementWebpropertyUserLinksUpdate
         where
        type Rs AnalyticsManagementWebpropertyUserLinksUpdate =
             EntityUserLink
        type Scopes AnalyticsManagementWebpropertyUserLinksUpdate =
             '[Analytics'Manage'Users]
        requestClient AnalyticsManagementWebpropertyUserLinksUpdate{..}
          = go accountId webPropertyId linkId (Core.Just Core.AltJSON)
              payload
              analyticsService
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AnalyticsManagementWebpropertyUserLinksUpdateResource)
                      Core.mempty
