                     ...
                     Core.QueryParam "max-results" Core.Int32 Core.:>
                       Core.QueryParam "start-index" Core.Int32 Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] EntityUserLinks
...
newAnalyticsManagementWebpropertyUserLinksList 
    ...
    -> AnalyticsManagementWebpropertyUserLinksList
newAnalyticsManagementWebpropertyUserLinksList accountId
  webPropertyId
  = AnalyticsManagementWebpropertyUserLinksList{accountId =
                                                  accountId,
...
instance Core.GoogleRequest
           AnalyticsManagementWebpropertyUserLinksList
         where
        type Rs AnalyticsManagementWebpropertyUserLinksList =
             EntityUserLinks
        type Scopes AnalyticsManagementWebpropertyUserLinksList =
             '[Analytics'Manage'Users, Analytics'Manage'Users'Readonly]
        requestClient AnalyticsManagementWebpropertyUserLinksList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AnalyticsManagementWebpropertyUserLinksListResource)
                      Core.mempty
