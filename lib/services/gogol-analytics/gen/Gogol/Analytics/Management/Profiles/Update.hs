...
newAnalyticsManagementProfilesUpdate 
    ...
    -> AnalyticsManagementProfilesUpdate
newAnalyticsManagementProfilesUpdate accountId payload profileId
  webPropertyId
  = AnalyticsManagementProfilesUpdate{accountId = accountId,
                                      payload = payload, profileId = profileId,
                                      webPropertyId = webPropertyId}
instance Core.GoogleRequest AnalyticsManagementProfilesUpdate where
        type Rs AnalyticsManagementProfilesUpdate = Profile
        type Scopes AnalyticsManagementProfilesUpdate = '[Analytics'Edit]
