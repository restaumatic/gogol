...
newAnalyticsManagementProfilesGet accountId profileId webPropertyId
  = AnalyticsManagementProfilesGet{accountId = accountId,
                                   profileId = profileId, webPropertyId = webPropertyId}
instance Core.GoogleRequest AnalyticsManagementProfilesGet where
        ...
        requestClient AnalyticsManagementProfilesGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy AnalyticsManagementProfilesGetResource)
                      Core.mempty
