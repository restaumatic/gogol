...
newAnalyticsManagementProfilesList accountId webPropertyId
  = AnalyticsManagementProfilesList{accountId = accountId,
                                    maxResults = Core.Nothing, startIndex = Core.Nothing,
                                    webPropertyId = webPropertyId}
instance Core.GoogleRequest AnalyticsManagementProfilesList where
        type Rs AnalyticsManagementProfilesList = Profiles
        type Scopes AnalyticsManagementProfilesList =
        ...
        requestClient AnalyticsManagementProfilesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy AnalyticsManagementProfilesListResource)
                      Core.mempty
