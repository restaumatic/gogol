...
newAnalyticsManagementExperimentsPatch 
    ...
    -> AnalyticsManagementExperimentsPatch
newAnalyticsManagementExperimentsPatch accountId experimentId
  payload profileId webPropertyId
  = AnalyticsManagementExperimentsPatch{accountId = accountId,
                                        experimentId = experimentId, payload = payload,
                                        profileId = profileId, webPropertyId = webPropertyId}
instance Core.GoogleRequest AnalyticsManagementExperimentsPatch
         where
        type Rs AnalyticsManagementExperimentsPatch = Experiment
        ...
        requestClient AnalyticsManagementExperimentsPatch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AnalyticsManagementExperimentsPatchResource)
                      Core.mempty
