...
newAnalyticsManagementExperimentsDelete 
    ...
    -> AnalyticsManagementExperimentsDelete
newAnalyticsManagementExperimentsDelete accountId experimentId
  profileId webPropertyId
  = AnalyticsManagementExperimentsDelete{accountId = accountId,
                                         experimentId = experimentId, profileId = profileId,
                                         webPropertyId = webPropertyId}
instance Core.GoogleRequest AnalyticsManagementExperimentsDelete
         where
        ...
        requestClient AnalyticsManagementExperimentsDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AnalyticsManagementExperimentsDeleteResource)
                      Core.mempty
