...
newAnalyticsManagementExperimentsList 
    ...
    -> AnalyticsManagementExperimentsList
newAnalyticsManagementExperimentsList accountId profileId
  webPropertyId
  = AnalyticsManagementExperimentsList{accountId = accountId,
                                       maxResults = Core.Nothing, profileId = profileId,
                                       startIndex = Core.Nothing, webPropertyId = webPropertyId}
instance Core.GoogleRequest AnalyticsManagementExperimentsList
         where
