...
newAnalyticsManagementExperimentsGet 
    ...
    -> AnalyticsManagementExperimentsGet
newAnalyticsManagementExperimentsGet accountId experimentId
  profileId webPropertyId
  = AnalyticsManagementExperimentsGet{accountId = accountId,
                                      experimentId = experimentId, profileId = profileId,
                                      webPropertyId = webPropertyId}
instance Core.GoogleRequest AnalyticsManagementExperimentsGet where
        type Rs AnalyticsManagementExperimentsGet = Experiment
        type Scopes AnalyticsManagementExperimentsGet =
