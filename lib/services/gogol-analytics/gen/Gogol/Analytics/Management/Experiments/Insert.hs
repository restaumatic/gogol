...
newAnalyticsManagementExperimentsInsert 
    ...
    -> AnalyticsManagementExperimentsInsert
newAnalyticsManagementExperimentsInsert accountId payload profileId
  webPropertyId
  = AnalyticsManagementExperimentsInsert{accountId = accountId,
                                         payload = payload, profileId = profileId,
                                         webPropertyId = webPropertyId}
instance Core.GoogleRequest AnalyticsManagementExperimentsInsert
         where
        type Rs AnalyticsManagementExperimentsInsert = Experiment
        type Scopes AnalyticsManagementExperimentsInsert =
             '[Analytics'FullControl, Analytics'Edit]
        requestClient AnalyticsManagementExperimentsInsert{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AnalyticsManagementExperimentsInsertResource)
                      Core.mempty
