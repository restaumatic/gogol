...
newAnalyticsManagementAccountUserLinksUpdate 
    ...
    -> AnalyticsManagementAccountUserLinksUpdate
newAnalyticsManagementAccountUserLinksUpdate accountId linkId
  payload
  = AnalyticsManagementAccountUserLinksUpdate{accountId = accountId,
...
instance Core.GoogleRequest
        ...
        requestClient AnalyticsManagementAccountUserLinksUpdate{..}
          = go accountId linkId (Core.Just Core.AltJSON) payload
              analyticsService
          where go
                  = Core.buildClient
                      (Core.Proxy ::
