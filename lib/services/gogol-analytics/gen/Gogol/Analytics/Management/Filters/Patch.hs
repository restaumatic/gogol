...
newAnalyticsManagementFiltersPatch accountId filterId payload
  = AnalyticsManagementFiltersPatch{accountId = accountId,
                                    filterId = filterId, payload = payload}
instance Core.GoogleRequest AnalyticsManagementFiltersPatch where
        ...
        requestClient AnalyticsManagementFiltersPatch{..}
          = go accountId filterId (Core.Just Core.AltJSON) payload
              analyticsService
          where go
                  = Core.buildClient
