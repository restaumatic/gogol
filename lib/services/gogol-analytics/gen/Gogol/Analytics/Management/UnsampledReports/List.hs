...
newAnalyticsManagementUnsampledReportsList 
    ...
    -> AnalyticsManagementUnsampledReportsList
newAnalyticsManagementUnsampledReportsList accountId profileId
  webPropertyId
  = AnalyticsManagementUnsampledReportsList{accountId = accountId,
                                            maxResults = Core.Nothing, profileId = profileId,
                                            startIndex = Core.Nothing,
                                            webPropertyId = webPropertyId}
instance Core.GoogleRequest AnalyticsManagementUnsampledReportsList
         where
