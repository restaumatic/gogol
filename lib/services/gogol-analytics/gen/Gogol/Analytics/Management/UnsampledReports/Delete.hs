...
newAnalyticsManagementUnsampledReportsDelete 
    ...
    -> AnalyticsManagementUnsampledReportsDelete
newAnalyticsManagementUnsampledReportsDelete accountId profileId
  unsampledReportId webPropertyId
  = AnalyticsManagementUnsampledReportsDelete{accountId = accountId,
                                              profileId = profileId,
...
instance Core.GoogleRequest
        ...
        type Scopes AnalyticsManagementUnsampledReportsDelete =
             '[Analytics'Edit]
