...
newAnalyticsManagementRemarketingAudienceUpdate 
    ...
    -> AnalyticsManagementRemarketingAudienceUpdate
newAnalyticsManagementRemarketingAudienceUpdate accountId payload
  remarketingAudienceId webPropertyId
  = AnalyticsManagementRemarketingAudienceUpdate{accountId =
                                                   accountId,
                                                 payload = payload,
...
instance Core.GoogleRequest
        ...
        type Rs AnalyticsManagementRemarketingAudienceUpdate =
             RemarketingAudience
        type Scopes AnalyticsManagementRemarketingAudienceUpdate =
             '[Analytics'Edit]
        requestClient AnalyticsManagementRemarketingAudienceUpdate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AnalyticsManagementRemarketingAudienceUpdateResource)
                      Core.mempty
