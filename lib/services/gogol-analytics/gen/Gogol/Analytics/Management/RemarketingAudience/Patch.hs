               ...
               "webproperties" Core.:>
                 Core.Capture "webPropertyId" Core.Text Core.:>
                   "remarketingAudiences" Core.:>
                     Core.Capture "remarketingAudienceId" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] RemarketingAudience Core.:>
                           Core.Patch '[Core.JSON] RemarketingAudience
...
newAnalyticsManagementRemarketingAudiencePatch 
    ...
    -> AnalyticsManagementRemarketingAudiencePatch
newAnalyticsManagementRemarketingAudiencePatch accountId payload
  remarketingAudienceId webPropertyId
  = AnalyticsManagementRemarketingAudiencePatch{accountId =
                                                  accountId,
                                                payload = payload,
...
instance Core.GoogleRequest
           AnalyticsManagementRemarketingAudiencePatch
         where
        type Rs AnalyticsManagementRemarketingAudiencePatch =
             RemarketingAudience
        type Scopes AnalyticsManagementRemarketingAudiencePatch =
             '[Analytics'Edit]
        requestClient AnalyticsManagementRemarketingAudiencePatch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AnalyticsManagementRemarketingAudiencePatchResource)
                      Core.mempty
