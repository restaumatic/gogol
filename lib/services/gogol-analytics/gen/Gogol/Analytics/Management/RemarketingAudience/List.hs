...
newAnalyticsManagementRemarketingAudienceList 
    ...
    -> AnalyticsManagementRemarketingAudienceList
newAnalyticsManagementRemarketingAudienceList accountId
  webPropertyId
  = AnalyticsManagementRemarketingAudienceList{accountId = accountId,
                                               maxResults = Core.Nothing, startIndex = Core.Nothing,
                                               type' = "all", webPropertyId = webPropertyId}
instance Core.GoogleRequest
           AnalyticsManagementRemarketingAudienceList
         where
        type Rs AnalyticsManagementRemarketingAudienceList =
             RemarketingAudiences
        type Scopes AnalyticsManagementRemarketingAudienceList =
