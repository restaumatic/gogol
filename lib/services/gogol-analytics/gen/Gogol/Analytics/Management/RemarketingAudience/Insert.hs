...
newAnalyticsManagementRemarketingAudienceInsert 
    ...
    -> AnalyticsManagementRemarketingAudienceInsert
newAnalyticsManagementRemarketingAudienceInsert accountId payload
  webPropertyId
  = AnalyticsManagementRemarketingAudienceInsert{accountId =
                                                   accountId,
...
instance Core.GoogleRequest
        ...
        type Rs AnalyticsManagementRemarketingAudienceInsert =
             RemarketingAudience
        type Scopes AnalyticsManagementRemarketingAudienceInsert =
             '[Analytics'Edit]
        requestClient AnalyticsManagementRemarketingAudienceInsert{..}
          = go accountId webPropertyId (Core.Just Core.AltJSON) payload
              analyticsService
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AnalyticsManagementRemarketingAudienceInsertResource)
                      Core.mempty
