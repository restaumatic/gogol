...
newAnalyticsManagementRemarketingAudienceDelete 
    ...
    -> AnalyticsManagementRemarketingAudienceDelete
newAnalyticsManagementRemarketingAudienceDelete accountId
  remarketingAudienceId webPropertyId
  = AnalyticsManagementRemarketingAudienceDelete{accountId =
                                                   accountId,
...
instance Core.GoogleRequest
        ...
        type Scopes AnalyticsManagementRemarketingAudienceDelete =
             '[Analytics'Edit]
