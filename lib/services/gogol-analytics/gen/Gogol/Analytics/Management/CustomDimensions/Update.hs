                       ...
                       Core.QueryParam "ignoreCustomDataSourceLinks" Core.Bool Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] CustomDimension Core.:>
                             Core.Put '[Core.JSON] CustomDimension
...
newAnalyticsManagementCustomDimensionsUpdate 
    ...
    -> AnalyticsManagementCustomDimensionsUpdate
newAnalyticsManagementCustomDimensionsUpdate accountId
  customDimensionId payload webPropertyId
  = AnalyticsManagementCustomDimensionsUpdate{accountId = accountId,
...
instance Core.GoogleRequest
        ...
        type Scopes AnalyticsManagementCustomDimensionsUpdate =
             '[Analytics'Edit]
