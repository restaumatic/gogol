                     ...
                     Core.QueryParam "max-results" Core.Int32 Core.:>
                       Core.QueryParam "start-index" Core.Int32 Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] CustomDimensions
...
newAnalyticsManagementCustomDimensionsList accountId webPropertyId
  = AnalyticsManagementCustomDimensionsList{accountId = accountId,
                                            maxResults = Core.Nothing, startIndex = Core.Nothing,
                                            webPropertyId = webPropertyId}
instance Core.GoogleRequest AnalyticsManagementCustomDimensionsList
         where
        type Rs AnalyticsManagementCustomDimensionsList = CustomDimensions
        type Scopes AnalyticsManagementCustomDimensionsList =
