...
newAnalyticsManagementCustomMetricsPatch 
    ...
    -> AnalyticsManagementCustomMetricsPatch
newAnalyticsManagementCustomMetricsPatch accountId customMetricId
  payload webPropertyId
  = AnalyticsManagementCustomMetricsPatch{accountId = accountId,
                                          customMetricId = customMetricId,
                                          ignoreCustomDataSourceLinks = Core.False,
                                          payload = payload, webPropertyId = webPropertyId}
instance Core.GoogleRequest AnalyticsManagementCustomMetricsPatch
         where
