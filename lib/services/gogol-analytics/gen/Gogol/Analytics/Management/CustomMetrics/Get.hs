                   ...
                   "customMetrics" Core.:>
                     Core.Capture "customMetricId" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.Get '[Core.JSON] CustomMetric
...
newAnalyticsManagementCustomMetricsGet 
    ...
    -> AnalyticsManagementCustomMetricsGet
newAnalyticsManagementCustomMetricsGet accountId customMetricId
  webPropertyId
  = AnalyticsManagementCustomMetricsGet{accountId = accountId,
                                        customMetricId = customMetricId,
                                        webPropertyId = webPropertyId}
instance Core.GoogleRequest AnalyticsManagementCustomMetricsGet
         where
        type Rs AnalyticsManagementCustomMetricsGet = CustomMetric
        type Scopes AnalyticsManagementCustomMetricsGet =
