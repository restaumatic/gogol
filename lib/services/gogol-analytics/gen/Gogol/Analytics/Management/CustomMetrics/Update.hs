                 ...
                 Core.Capture "webPropertyId" Core.Text Core.:>
                   "customMetrics" Core.:>
                     Core.Capture "customMetricId" Core.Text Core.:>
                       Core.QueryParam "ignoreCustomDataSourceLinks" Core.Bool Core.:>
...
newAnalyticsManagementCustomMetricsUpdate 
    ...
    -> AnalyticsManagementCustomMetricsUpdate
newAnalyticsManagementCustomMetricsUpdate accountId customMetricId
  payload webPropertyId
  = AnalyticsManagementCustomMetricsUpdate{accountId = accountId,
                                           customMetricId = customMetricId,
                                           ignoreCustomDataSourceLinks = Core.False,
                                           payload = payload, webPropertyId = webPropertyId}
instance Core.GoogleRequest AnalyticsManagementCustomMetricsUpdate
         where
        type Rs AnalyticsManagementCustomMetricsUpdate = CustomMetric
        type Scopes AnalyticsManagementCustomMetricsUpdate =
             '[Analytics'Edit]
        requestClient AnalyticsManagementCustomMetricsUpdate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AnalyticsManagementCustomMetricsUpdateResource)
                      Core.mempty
