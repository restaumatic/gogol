                     ...
                     Core.QueryParam "max-results" Core.Int32 Core.:>
                       Core.QueryParam "sort" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] RealtimeData
...
instance Core.GoogleRequest AnalyticsDataRealtimeGet where
        ...
        requestClient AnalyticsDataRealtimeGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy AnalyticsDataRealtimeGetResource)
                      Core.mempty
