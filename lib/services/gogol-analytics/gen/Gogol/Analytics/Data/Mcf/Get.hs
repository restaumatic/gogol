...
newAnalyticsDataMcfGet endDate ids metrics startDate
  = AnalyticsDataMcfGet{dimensions = Core.Nothing, endDate = endDate,
                        filters = Core.Nothing, ids = ids, maxResults = Core.Nothing,
                        metrics = metrics, samplingLevel = Core.Nothing,
...
instance Core.GoogleRequest AnalyticsDataMcfGet where
        ...
        type Scopes AnalyticsDataMcfGet =
