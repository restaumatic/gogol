...
newAccount 
    ::  Account
newAccount
  = Account{childLink = Core.Nothing, created = Core.Nothing,
            id = Core.Nothing, kind = "analytics#account", name = Core.Nothing,
            permissions = Core.Nothing, selfLink = Core.Nothing,
            starred = Core.Nothing, updated = Core.Nothing}
instance Core.FromJSON Account where
        parseJSON
          = Core.withObject "Account"
              (\ o ->
                 Account Core.<$>
                   (o Core..:? "childLink") Core.<*> (o Core..:? "created") Core.<*>
                     (o Core..:? "id")
          ...
          = Core.object
              (Core.catMaybes
                 [("childLink" Core..=) Core.<$> childLink,
                  ("created" Core..=) Core.<$> created, ("id" Core..=) Core.<$> id,
...
newAccount_ChildLink 
    ::  Account_ChildLink
newAccount_ChildLink
  = Account_ChildLink{href = Core.Nothing,
                      type' = "analytics#webproperties"}
instance Core.FromJSON Account_ChildLink where
        parseJSON
          = Core.withObject "Account_ChildLink"
              (\ o ->
                 Account_ChildLink Core.<$>
                   (o Core..:? "href") Core.<*>
                     (o Core..:? "type" Core..!= "analytics#webproperties"))

instance Core.ToJSON Account_ChildLink where
        toJSON Account_ChildLink{..}
          = Core.object
              (Core.catMaybes
                 [("href" Core..=) Core.<$> href, Core.Just ("type" Core..= type')])
...
newAccount_Permissions 
    ::  Account_Permissions
newAccount_Permissions
  = Account_Permissions{effective = Core.Nothing}
instance Core.FromJSON Account_Permissions where
        parseJSON
          = Core.withObject "Account_Permissions"
              (\ o -> Account_Permissions Core.<$> (o Core..:? "effective"))

instance Core.ToJSON Account_Permissions where
        toJSON Account_Permissions{..}
          = Core.object
              (Core.catMaybes [("effective" Core..=) Core.<$> effective])
...
newAccountRef 
    ::  AccountRef
newAccountRef
  = AccountRef{href = Core.Nothing, id = Core.Nothing,
               kind = "analytics#accountRef", name = Core.Nothing}
instance Core.FromJSON AccountRef where
        parseJSON
          = Core.withObject "AccountRef"
              (\ o ->
                 AccountRef Core.<$>
                   (o Core..:? "href") Core.<*> (o Core..:? "id") Core.<*>
                     (o Core..:? "kind" Core..!= "analytics#accountRef")
                     Core.<*> (o Core..:? "name"))
...
instance Core.ToJSON AccountRef where
        toJSON AccountRef{..}
          = Core.object
              (Core.catMaybes
                 [("href" Core..=) Core.<$> href, ("id" Core..=) Core.<$> id,
                  Core.Just ("kind" Core..= kind), ("name" Core..=) Core.<$> name])
...
newAccountSummaries 
    ::  AccountSummaries
newAccountSummaries
  = AccountSummaries{items = Core.Nothing,
                     itemsPerPage = Core.Nothing, kind = "analytics#accountSummaries",
                     nextLink = Core.Nothing, previousLink = Core.Nothing,
                     startIndex = Core.Nothing, totalResults = Core.Nothing,
                     username = Core.Nothing}
instance Core.FromJSON AccountSummaries where
        parseJSON
          = Core.withObject "AccountSummaries"
              (\ o ->
                 AccountSummaries Core.<$>
                   (o Core..:? "items") Core.<*> (o Core..:? "itemsPerPage") Core.<*>
                     (o Core..:? "kind" Core..!= "analytics#accountSummaries")
...
newAccountSummary 
    ::  AccountSummary
newAccountSummary
  = AccountSummary{id = Core.Nothing,
                   kind = "analytics#accountSummary", name = Core.Nothing,
                   starred = Core.Nothing, webProperties = Core.Nothing}
instance Core.FromJSON AccountSummary where
        parseJSON
          = Core.withObject "AccountSummary"
              (\ o ->
                 AccountSummary Core.<$>
                   (o Core..:? "id") Core.<*>
                     (o Core..:? "kind" Core..!= "analytics#accountSummary")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "starred")
...
newAccountTicket 
    ::  AccountTicket
newAccountTicket
  = AccountTicket{account = Core.Nothing, id = Core.Nothing,
                  kind = "analytics#accountTicket", profile = Core.Nothing,
                  redirectUri = Core.Nothing, webproperty = Core.Nothing}
instance Core.FromJSON AccountTicket where
        parseJSON
          = Core.withObject "AccountTicket"
              (\ o ->
                 AccountTicket Core.<$>
                   (o Core..:? "account") Core.<*> (o Core..:? "id") Core.<*>
                     (o Core..:? "kind" Core..!= "analytics#accountTicket")
                     Core.<*> (o Core..:? "profile")
...
instance Core.ToJSON AccountTicket where
        toJSON AccountTicket{..}
          = Core.object
              (Core.catMaybes
                 [("account" Core..=) Core.<$> account, ("id" Core..=) Core.<$> id,
                  Core.Just ("kind" Core..= kind),
...
newAccountTreeRequest 
    ::  AccountTreeRequest
newAccountTreeRequest
  = AccountTreeRequest{accountName = Core.Nothing,
                       kind = "analytics#accountTreeRequest", profileName = Core.Nothing,
                       timezone = Core.Nothing, webpropertyName = Core.Nothing,
                       websiteUrl = Core.Nothing}
instance Core.FromJSON AccountTreeRequest where
        parseJSON
          = Core.withObject "AccountTreeRequest"
              (\ o ->
                 AccountTreeRequest Core.<$>
                   (o Core..:? "accountName") Core.<*>
                     (o Core..:? "kind" Core..!= "analytics#accountTreeRequest")
...
newAccountTreeResponse 
    ::  AccountTreeResponse
newAccountTreeResponse
  = AccountTreeResponse{account = Core.Nothing,
                        kind = "analytics#accountTreeResponse", profile = Core.Nothing,
                        webproperty = Core.Nothing}
instance Core.FromJSON AccountTreeResponse where
        parseJSON
          = Core.withObject "AccountTreeResponse"
              (\ o ->
                 AccountTreeResponse Core.<$>
                   (o Core..:? "account") Core.<*>
                     (o Core..:? "kind" Core..!= "analytics#accountTreeResponse")
                     Core.<*> (o Core..:? "profile")
                     Core.<*> (o Core..:? "webproperty"))
...
newAccounts 
    ::  Accounts
newAccounts
  = Accounts{items = Core.Nothing, itemsPerPage = Core.Nothing,
             kind = "analytics#accounts", nextLink = Core.Nothing,
             previousLink = Core.Nothing, startIndex = Core.Nothing,
             totalResults = Core.Nothing, username = Core.Nothing}
instance Core.FromJSON Accounts where
        parseJSON
          = Core.withObject "Accounts"
              (\ o ->
                 Accounts Core.<$>
                   (o Core..:? "items") Core.<*> (o Core..:? "itemsPerPage") Core.<*>
                     (o Core..:? "kind" Core..!= "analytics#accounts")
                     Core.<*> (o Core..:? "nextLink")
                     Core.<*> (o Core..:? "previousLink")
                     Core.<*> (o Core..:? "startIndex")
                     Core.<*> (o Core..:? "totalResults")
...
newAdWordsAccount 
    ::  AdWordsAccount
newAdWordsAccount
  = AdWordsAccount{autoTaggingEnabled = Core.Nothing,
                   customerId = Core.Nothing, kind = "analytics#adWordsAccount"}
instance Core.FromJSON AdWordsAccount where
        parseJSON
          = Core.withObject "AdWordsAccount"
              (\ o ->
                 AdWordsAccount Core.<$>
                   (o Core..:? "autoTaggingEnabled") Core.<*>
                     (o Core..:? "customerId")
                     Core.<*> (o Core..:? "kind" Core..!= "analytics#adWordsAccount"))

instance Core.ToJSON AdWordsAccount where
        toJSON AdWordsAccount{..}
          = Core.object
              (Core.catMaybes
                 [("autoTaggingEnabled" Core..=) Core.<$> autoTaggingEnabled,
...
newAnalyticsDataimportDeleteUploadDataRequest
  = AnalyticsDataimportDeleteUploadDataRequest{customDataImportUids =
                                                 Core.Nothing}
instance Core.FromJSON AnalyticsDataimportDeleteUploadDataRequest
         where
        parseJSON
          = Core.withObject "AnalyticsDataimportDeleteUploadDataRequest"
              (\ o ->
                 AnalyticsDataimportDeleteUploadDataRequest Core.<$>
                   (o Core..:? "customDataImportUids"))

instance Core.ToJSON AnalyticsDataimportDeleteUploadDataRequest
         where
        toJSON AnalyticsDataimportDeleteUploadDataRequest{..}
          = Core.object
              (Core.catMaybes
                 [("customDataImportUids" Core..=) Core.<$> customDataImportUids])
...
newColumn 
    ::  Column
newColumn
  = Column{attributes = Core.Nothing, id = Core.Nothing,
...
instance Core.FromJSON Column where
        parseJSON
          = Core.withObject "Column"
              (\ o ->
                 Column Core.<$>
                   (o Core..:? "attributes") Core.<*> (o Core..:? "id") Core.<*>
                     (o Core..:? "kind" Core..!= "analytics#column"))
...
newColumn_Attributes 
    :: 
       ...
       -- ^  The name of the attribute. See 'additional'.
    -> Column_Attributes
newColumn_Attributes additional
  = Column_Attributes{additional = additional}
instance Core.FromJSON Column_Attributes where
        parseJSON
          = Core.withObject "Column_Attributes"
              (\ o -> Column_Attributes Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON Column_Attributes where
        toJSON Column_Attributes{..} = Core.toJSON additional
...
newColumns 
    ::  Columns
newColumns
  = Columns{attributeNames = Core.Nothing, etag = Core.Nothing,
            items = Core.Nothing, kind = "analytics#columns",
            totalResults = Core.Nothing}
instance Core.FromJSON Columns where
        parseJSON
          = Core.withObject "Columns"
              (\ o ->
                 Columns Core.<$>
                   (o Core..:? "attributeNames") Core.<*> (o Core..:? "etag") Core.<*>
                     (o Core..:? "items")
...
newCustomDataSource 
    ::  CustomDataSource
newCustomDataSource
  = CustomDataSource{accountId = Core.Nothing,
                     childLink = Core.Nothing, created = Core.Nothing,
                     description = Core.Nothing, id = Core.Nothing,
                     importBehavior = Core.Nothing, kind = "analytics#customDataSource",
                     name = Core.Nothing, parentLink = Core.Nothing,
                     profilesLinked = Core.Nothing, schema = Core.Nothing,
                     selfLink = Core.Nothing, type' = Core.Nothing,
                     updated = Core.Nothing, uploadType = Core.Nothing,
                     webPropertyId = Core.Nothing}
instance Core.FromJSON CustomDataSource where
        parseJSON
          = Core.withObject "CustomDataSource"
              (\ o ->
                 CustomDataSource Core.<$>
                   (o Core..:? "accountId") Core.<*> (o Core..:? "childLink") Core.<*>
                     (o Core..:? "created")
                     Core.<*> (o Core..:? "description")
                     Core.<*> (o Core..:? "id")
                     Core.<*> (o Core..:? "importBehavior")
                     Core.<*> (o Core..:? "kind" Core..!= "analytics#customDataSource")
                     Core.<*> (o Core..:? "name")
...
newCustomDataSource_ChildLink 
    ::  CustomDataSource_ChildLink
newCustomDataSource_ChildLink
  = CustomDataSource_ChildLink{href = Core.Nothing,
                               type' = Core.Nothing}
instance Core.FromJSON CustomDataSource_ChildLink where
        parseJSON
          = Core.withObject "CustomDataSource_ChildLink"
              (\ o ->
                 CustomDataSource_ChildLink Core.<$>
                   (o Core..:? "href") Core.<*> (o Core..:? "type"))

instance Core.ToJSON CustomDataSource_ChildLink where
        toJSON CustomDataSource_ChildLink{..}
          = Core.object
              (Core.catMaybes
                 [("href" Core..=) Core.<$> href, ("type" Core..=) Core.<$> type'])
...
newCustomDataSource_ParentLink 
    ::  CustomDataSource_ParentLink
newCustomDataSource_ParentLink
  = CustomDataSource_ParentLink{href = Core.Nothing,
                                type' = "analytics#webproperty"}
instance Core.FromJSON CustomDataSource_ParentLink where
        parseJSON
          = Core.withObject "CustomDataSource_ParentLink"
              (\ o ->
                 CustomDataSource_ParentLink Core.<$>
                   (o Core..:? "href") Core.<*>
                     (o Core..:? "type" Core..!= "analytics#webproperty"))
...
newCustomDataSources 
    ::  CustomDataSources
newCustomDataSources
  = CustomDataSources{items = Core.Nothing,
                      itemsPerPage = Core.Nothing, kind = "analytics#customDataSources",
                      nextLink = Core.Nothing, previousLink = Core.Nothing,
                      startIndex = Core.Nothing, totalResults = Core.Nothing,
                      username = Core.Nothing}
instance Core.FromJSON CustomDataSources where
        parseJSON
          = Core.withObject "CustomDataSources"
              (\ o ->
                 CustomDataSources Core.<$>
                   (o Core..:? "items") Core.<*> (o Core..:? "itemsPerPage") Core.<*>
                     (o Core..:? "kind" Core..!= "analytics#customDataSources")
                     Core.<*> (o Core..:? "nextLink")
                     Core.<*> (o Core..:? "previousLink")
                     Core.<*> (o Core..:? "startIndex")
                     Core.<*> (o Core..:? "totalResults")
...
newCustomDimension 
    ::  CustomDimension
newCustomDimension
  = CustomDimension{accountId = Core.Nothing, active = Core.Nothing,
                    created = Core.Nothing, id = Core.Nothing, index = Core.Nothing,
                    kind = "analytics#customDimension", name = Core.Nothing,
                    parentLink = Core.Nothing, scope = Core.Nothing,
                    selfLink = Core.Nothing, updated = Core.Nothing,
                    webPropertyId = Core.Nothing}
          ...
          = Core.withObject "CustomDimension"
              (\ o ->
                 CustomDimension Core.<$>
                   (o Core..:? "accountId") Core.<*> (o Core..:? "active") Core.<*>
                     (o Core..:? "created")
                     Core.<*> (o Core..:? "id")
                     Core.<*> (o Core..:? "index")
                     Core.<*> (o Core..:? "kind" Core..!= "analytics#customDimension")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "parentLink")
                     Core.<*> (o Core..:? "scope")
                     Core.<*> (o Core..:? "selfLink")
          ...
          = Core.object
              (Core.catMaybes
                 [("accountId" Core..=) Core.<$> accountId,
                  ...
                  ("created" Core..=) Core.<$> created, ("id" Core..=) Core.<$> id,
                  ("index" Core..=) Core.<$> index, Core.Just ("kind" Core..= kind),
                  ("name" Core..=) Core.<$> name,
                  ("parentLink" Core..=) Core.<$> parentLink,
...
newCustomDimension_ParentLink 
    ::  CustomDimension_ParentLink
newCustomDimension_ParentLink
  = CustomDimension_ParentLink{href = Core.Nothing,
                               type' = "analytics#webproperty"}
instance Core.FromJSON CustomDimension_ParentLink where
        parseJSON
          = Core.withObject "CustomDimension_ParentLink"
              (\ o ->
                 CustomDimension_ParentLink Core.<$>
                   (o Core..:? "href") Core.<*>
                     (o Core..:? "type" Core..!= "analytics#webproperty"))
...
newCustomDimensions 
    ::  CustomDimensions
newCustomDimensions
  = CustomDimensions{items = Core.Nothing,
                     itemsPerPage = Core.Nothing, kind = "analytics#customDimensions",
                     nextLink = Core.Nothing, previousLink = Core.Nothing,
                     startIndex = Core.Nothing, totalResults = Core.Nothing,
                     username = Core.Nothing}
instance Core.FromJSON CustomDimensions where
        parseJSON
          = Core.withObject "CustomDimensions"
              (\ o ->
                 CustomDimensions Core.<$>
                   (o Core..:? "items") Core.<*> (o Core..:? "itemsPerPage") Core.<*>
                     (o Core..:? "kind" Core..!= "analytics#customDimensions")
                     Core.<*> (o Core..:? "nextLink")
                     Core.<*> (o Core..:? "previousLink")
                     Core.<*> (o Core..:? "startIndex")
                     Core.<*> (o Core..:? "totalResults")
...
newCustomMetric 
    ::  CustomMetric
newCustomMetric
  = CustomMetric{accountId = Core.Nothing, active = Core.Nothing,
                 created = Core.Nothing, id = Core.Nothing, index = Core.Nothing,
                 kind = "analytics#customMetric", maxValue = Core.Nothing,
                 minValue = Core.Nothing, name = Core.Nothing,
                 parentLink = Core.Nothing, scope = Core.Nothing,
                 selfLink = Core.Nothing, type' = Core.Nothing,
                 updated = Core.Nothing, webPropertyId = Core.Nothing}
...
newCustomMetric_ParentLink 
    ::  CustomMetric_ParentLink
newCustomMetric_ParentLink
  = CustomMetric_ParentLink{href = Core.Nothing,
                            type' = "analytics#webproperty"}
instance Core.FromJSON CustomMetric_ParentLink where
        parseJSON
          = Core.withObject "CustomMetric_ParentLink"
              (\ o ->
                 CustomMetric_ParentLink Core.<$>
                   (o Core..:? "href") Core.<*>
                     (o Core..:? "type" Core..!= "analytics#webproperty"))
...
newCustomMetrics 
    ::  CustomMetrics
newCustomMetrics
  = CustomMetrics{items = Core.Nothing, itemsPerPage = Core.Nothing,
                  kind = "analytics#customMetrics", nextLink = Core.Nothing,
                  previousLink = Core.Nothing, startIndex = Core.Nothing,
                  totalResults = Core.Nothing, username = Core.Nothing}
instance Core.FromJSON CustomMetrics where
        parseJSON
          = Core.withObject "CustomMetrics"
              (\ o ->
                 CustomMetrics Core.<$>
                   (o Core..:? "items") Core.<*> (o Core..:? "itemsPerPage") Core.<*>
                     (o Core..:? "kind" Core..!= "analytics#customMetrics")
                     Core.<*> (o Core..:? "nextLink")
                     Core.<*> (o Core..:? "previousLink")
                     Core.<*> (o Core..:? "startIndex")
                     Core.<*> (o Core..:? "totalResults")
...
newEntityAdWordsLink 
    ::  EntityAdWordsLink
newEntityAdWordsLink
  = EntityAdWordsLink{adWordsAccounts = Core.Nothing,
                      entity = Core.Nothing, id = Core.Nothing,
                      kind = "analytics#entityAdWordsLink", name = Core.Nothing,
                      profileIds = Core.Nothing, selfLink = Core.Nothing}
instance Core.FromJSON EntityAdWordsLink where
        parseJSON
          = Core.withObject "EntityAdWordsLink"
              (\ o ->
                 EntityAdWordsLink Core.<$>
                   (o Core..:? "adWordsAccounts") Core.<*> (o Core..:? "entity")
                     Core.<*> (o Core..:? "id")
                     Core.<*> (o Core..:? "kind" Core..!= "analytics#entityAdWordsLink")
                     Core.<*> (o Core..:? "name")
...
instance Core.ToJSON EntityAdWordsLink where
        toJSON EntityAdWordsLink{..}
          = Core.object
              (Core.catMaybes
                 [("adWordsAccounts" Core..=) Core.<$> adWordsAccounts,
                  ("entity" Core..=) Core.<$> entity, ("id" Core..=) Core.<$> id,
                  Core.Just ("kind" Core..= kind), ("name" Core..=) Core.<$> name,
...
instance Core.FromJSON EntityAdWordsLink_Entity where
        parseJSON
          = Core.withObject "EntityAdWordsLink_Entity"
              (\ o ->
                 EntityAdWordsLink_Entity Core.<$> (o Core..:? "webPropertyRef"))
...
newEntityAdWordsLinks 
    ::  EntityAdWordsLinks
newEntityAdWordsLinks
  = EntityAdWordsLinks{items = Core.Nothing,
                       itemsPerPage = Core.Nothing, kind = "analytics#entityAdWordsLinks",
                       nextLink = Core.Nothing, previousLink = Core.Nothing,
                       startIndex = Core.Nothing, totalResults = Core.Nothing}
instance Core.FromJSON EntityAdWordsLinks where
        parseJSON
          = Core.withObject "EntityAdWordsLinks"
              (\ o ->
                 EntityAdWordsLinks Core.<$>
                   (o Core..:? "items") Core.<*> (o Core..:? "itemsPerPage") Core.<*>
                     (o Core..:? "kind" Core..!= "analytics#entityAdWordsLinks")
                     Core.<*> (o Core..:? "nextLink")
                     Core.<*> (o Core..:? "previousLink")
                     Core.<*> (o Core..:? "startIndex")
                     Core.<*> (o Core..:? "totalResults"))
...
newEntityUserLink 
    ::  EntityUserLink
newEntityUserLink
  = EntityUserLink{entity = Core.Nothing, id = Core.Nothing,
                   kind = "analytics#entityUserLink", permissions = Core.Nothing,
                   selfLink = Core.Nothing, userRef = Core.Nothing}
instance Core.FromJSON EntityUserLink where
        parseJSON
          = Core.withObject "EntityUserLink"
              (\ o ->
                 EntityUserLink Core.<$>
                   (o Core..:? "entity") Core.<*> (o Core..:? "id") Core.<*>
                     (o Core..:? "kind" Core..!= "analytics#entityUserLink")
                     Core.<*> (o Core..:? "permissions")
                     Core.<*> (o Core..:? "selfLink")
                     Core.<*> (o Core..:? "userRef"))
...
newEntityUserLink_Entity 
    ::  EntityUserLink_Entity
newEntityUserLink_Entity
  = EntityUserLink_Entity{accountRef = Core.Nothing,
                          profileRef = Core.Nothing, webPropertyRef = Core.Nothing}
instance Core.FromJSON EntityUserLink_Entity where
        parseJSON
          = Core.withObject "EntityUserLink_Entity"
              (\ o ->
                 EntityUserLink_Entity Core.<$>
                   (o Core..:? "accountRef") Core.<*> (o Core..:? "profileRef")
...
newEntityUserLink_Permissions 
    ::  EntityUserLink_Permissions
newEntityUserLink_Permissions
  = EntityUserLink_Permissions{effective = Core.Nothing,
                               local = Core.Nothing}
instance Core.FromJSON EntityUserLink_Permissions where
        parseJSON
          = Core.withObject "EntityUserLink_Permissions"
              (\ o ->
                 EntityUserLink_Permissions Core.<$>
                   (o Core..:? "effective") Core.<*> (o Core..:? "local"))
...
newEntityUserLinks 
    ::  EntityUserLinks
newEntityUserLinks
  = EntityUserLinks{items = Core.Nothing,
                    itemsPerPage = Core.Nothing, kind = "analytics#entityUserLinks",
                    nextLink = Core.Nothing, previousLink = Core.Nothing,
                    startIndex = Core.Nothing, totalResults = Core.Nothing}
instance Core.FromJSON EntityUserLinks where
        parseJSON
          = Core.withObject "EntityUserLinks"
              (\ o ->
                 EntityUserLinks Core.<$>
                   (o Core..:? "items") Core.<*> (o Core..:? "itemsPerPage") Core.<*>
                     (o Core..:? "kind" Core..!= "analytics#entityUserLinks")
                     Core.<*> (o Core..:? "nextLink")
                     Core.<*> (o Core..:? "previousLink")
                     Core.<*> (o Core..:? "startIndex")
                     Core.<*> (o Core..:? "totalResults"))
...
newExperiment 
    ::  Experiment
newExperiment
  = Experiment{accountId = Core.Nothing, created = Core.Nothing,
               description = Core.Nothing, editableInGaUi = Core.Nothing,
               endTime = Core.Nothing, equalWeighting = Core.Nothing,
               id = Core.Nothing, internalWebPropertyId = Core.Nothing,
               kind = "analytics#experiment",
               minimumExperimentLengthInDays = Core.Nothing, name = Core.Nothing,
               objectiveMetric = Core.Nothing, optimizationType = Core.Nothing,
               parentLink = Core.Nothing, profileId = Core.Nothing,
               reasonExperimentEnded = Core.Nothing,
               rewriteVariationUrlsAsOriginal = Core.Nothing,
               selfLink = Core.Nothing, servingFramework = Core.Nothing,
               snippet = Core.Nothing, startTime = Core.Nothing,
               status = Core.Nothing, trafficCoverage = Core.Nothing,
               updated = Core.Nothing, variations = Core.Nothing,
               webPropertyId = Core.Nothing, winnerConfidenceLevel = Core.Nothing,
               winnerFound = Core.Nothing}
instance Core.FromJSON Experiment where
        parseJSON
          = Core.withObject "Experiment"
              (\ o ->
                 Experiment Core.<$>
                   (o Core..:? "accountId") Core.<*> (o Core..:? "created") Core.<*>
                     (o Core..:? "description")
          ...
          = Core.object
              (Core.catMaybes
                 [("accountId" Core..=) Core.<$> accountId,
                  ...
                  ("id" Core..=) Core.<$> id,
                  ("internalWebPropertyId" Core..=) Core.<$> internalWebPropertyId,
                  Core.Just ("kind" Core..= kind),
                  ("minimumExperimentLengthInDays" Core..=) Core.<$>
                    minimumExperimentLengthInDays,
                  ("name" Core..=) Core.<$> name,
                  ("objectiveMetric" Core..=) Core.<$> objectiveMetric,
                  ("optimizationType" Core..=) Core.<$> optimizationType,
                  ("parentLink" Core..=) Core.<$> parentLink,
                  ("profileId" Core..=) Core.<$> profileId,
                  ("reasonExperimentEnded" Core..=) Core.<$> reasonExperimentEnded,
                  ("rewriteVariationUrlsAsOriginal" Core..=) Core.<$>
                    rewriteVariationUrlsAsOriginal,
                  ("selfLink" Core..=) Core.<$> selfLink,
                  ("servingFramework" Core..=) Core.<$> servingFramework,
                  ...
                  ("webPropertyId" Core..=) Core.<$> webPropertyId,
                  ("winnerConfidenceLevel" Core..=) Core.<$> winnerConfidenceLevel,
...
newExperiment_ParentLink 
    ::  Experiment_ParentLink
newExperiment_ParentLink
  = Experiment_ParentLink{href = Core.Nothing,
                          type' = "analytics#profile"}
instance Core.FromJSON Experiment_ParentLink where
        parseJSON
          = Core.withObject "Experiment_ParentLink"
              (\ o ->
                 Experiment_ParentLink Core.<$>
                   (o Core..:? "href") Core.<*>
                     (o Core..:? "type" Core..!= "analytics#profile"))
...
newExperiment_VariationsItem 
    ::  Experiment_VariationsItem
newExperiment_VariationsItem
  = Experiment_VariationsItem{name = Core.Nothing,
                              status = Core.Nothing, url = Core.Nothing, weight = Core.Nothing,
                              won = Core.Nothing}
instance Core.FromJSON Experiment_VariationsItem where
        parseJSON
          = Core.withObject "Experiment_VariationsItem"
              (\ o ->
                 Experiment_VariationsItem Core.<$>
          ...
          = Core.object
              (Core.catMaybes
                 [("name" Core..=) Core.<$> name,
                  ...
                  ("weight" Core..=) Core.<$> weight, ("won" Core..=) Core.<$> won])
...
newExperiments 
    ::  Experiments
newExperiments
  = Experiments{items = Core.Nothing, itemsPerPage = Core.Nothing,
                kind = "analytics#experiments", nextLink = Core.Nothing,
                previousLink = Core.Nothing, startIndex = Core.Nothing,
                totalResults = Core.Nothing, username = Core.Nothing}
instance Core.FromJSON Experiments where
        parseJSON
          = Core.withObject "Experiments"
              (\ o ->
                 Experiments Core.<$>
                   (o Core..:? "items") Core.<*> (o Core..:? "itemsPerPage") Core.<*>
                     (o Core..:? "kind" Core..!= "analytics#experiments")
                     Core.<*> (o Core..:? "nextLink")
                     Core.<*> (o Core..:? "previousLink")
                     Core.<*> (o Core..:? "startIndex")
                     Core.<*> (o Core..:? "totalResults")
...
newFilter 
    ::  Filter
newFilter
  = Filter{accountId = Core.Nothing, advancedDetails = Core.Nothing,
           created = Core.Nothing, excludeDetails = Core.Nothing,
           id = Core.Nothing, includeDetails = Core.Nothing,
           kind = "analytics#filter", lowercaseDetails = Core.Nothing,
           name = Core.Nothing, parentLink = Core.Nothing,
           searchAndReplaceDetails = Core.Nothing, selfLink = Core.Nothing,
           type' = Core.Nothing, updated = Core.Nothing,
...
instance Core.FromJSON Filter where
        parseJSON
          = Core.withObject "Filter"
              (\ o ->
                 Filter Core.<$>
                   (o Core..:? "accountId") Core.<*> (o Core..:? "advancedDetails")
                     Core.<*> (o Core..:? "created")
          ...
          = Core.object
              (Core.catMaybes
                 [("accountId" Core..=) Core.<$> accountId,
                  ...
                  Core.Just ("kind" Core..= kind),
                  ("lowercaseDetails" Core..=) Core.<$> lowercaseDetails,
                  ("name" Core..=) Core.<$> name,
                  ("parentLink" Core..=) Core.<$> parentLink,
                  ("searchAndReplaceDetails" Core..=) Core.<$>
                    searchAndReplaceDetails,
                  ("selfLink" Core..=) Core.<$> selfLink,
                  ("type" Core..=) Core.<$> type',
                  ("updated" Core..=) Core.<$> updated,
                  ("uppercaseDetails" Core..=) Core.<$> uppercaseDetails])
...
newFilter_AdvancedDetails 
    ::  Filter_AdvancedDetails
newFilter_AdvancedDetails
  = Filter_AdvancedDetails{caseSensitive = Core.Nothing,
                           extractA = Core.Nothing, extractB = Core.Nothing,
                           fieldA = Core.Nothing, fieldAIndex = Core.Nothing,
                           fieldARequired = Core.Nothing, fieldB = Core.Nothing,
                           fieldBIndex = Core.Nothing, fieldBRequired = Core.Nothing,
                           outputConstructor = Core.Nothing, outputToField = Core.Nothing,
                           outputToFieldIndex = Core.Nothing,
                           overrideOutputField = Core.Nothing}
instance Core.FromJSON Filter_AdvancedDetails where
        parseJSON
          = Core.withObject "Filter_AdvancedDetails"
              (\ o ->
                 Filter_AdvancedDetails Core.<$>
                   (o Core..:? "caseSensitive") Core.<*> (o Core..:? "extractA")
          ...
          = Core.object
              (Core.catMaybes
                 [("caseSensitive" Core..=) Core.<$> caseSensitive,
                  ...
                  ("outputConstructor" Core..=) Core.<$> outputConstructor,
                  ("outputToField" Core..=) Core.<$> outputToField,
                  ("outputToFieldIndex" Core..=) Core.<$> outputToFieldIndex,
                  ("overrideOutputField" Core..=) Core.<$> overrideOutputField])
...
newFilter_LowercaseDetails 
    ::  Filter_LowercaseDetails
newFilter_LowercaseDetails
  = Filter_LowercaseDetails{field = Core.Nothing,
                            fieldIndex = Core.Nothing}
instance Core.FromJSON Filter_LowercaseDetails where
        parseJSON
          = Core.withObject "Filter_LowercaseDetails"
              (\ o ->
                 Filter_LowercaseDetails Core.<$>
                   (o Core..:? "field") Core.<*> (o Core..:? "fieldIndex"))
...
newFilter_ParentLink 
    ::  Filter_ParentLink
newFilter_ParentLink
  = Filter_ParentLink{href = Core.Nothing,
                      type' = "analytics#account"}
instance Core.FromJSON Filter_ParentLink where
        parseJSON
          = Core.withObject "Filter_ParentLink"
              (\ o ->
                 Filter_ParentLink Core.<$>
                   (o Core..:? "href") Core.<*>
                     (o Core..:? "type" Core..!= "analytics#account"))
...
newFilter_SearchAndReplaceDetails 
    ::  Filter_SearchAndReplaceDetails
newFilter_SearchAndReplaceDetails
  = Filter_SearchAndReplaceDetails{caseSensitive = Core.Nothing,
                                   field = Core.Nothing, fieldIndex = Core.Nothing,
                                   replaceString = Core.Nothing, searchString = Core.Nothing}
instance Core.FromJSON Filter_SearchAndReplaceDetails where
        parseJSON
          = Core.withObject "Filter_SearchAndReplaceDetails"
              (\ o ->
                 Filter_SearchAndReplaceDetails Core.<$>
                   (o Core..:? "caseSensitive") Core.<*> (o Core..:? "field") Core.<*>
                     (o Core..:? "fieldIndex")
...
newFilter_UppercaseDetails 
    ::  Filter_UppercaseDetails
newFilter_UppercaseDetails
  = Filter_UppercaseDetails{field = Core.Nothing,
                            fieldIndex = Core.Nothing}
instance Core.FromJSON Filter_UppercaseDetails where
        parseJSON
          = Core.withObject "Filter_UppercaseDetails"
              (\ o ->
                 Filter_UppercaseDetails Core.<$>
                   (o Core..:? "field") Core.<*> (o Core..:? "fieldIndex"))
...
newFilterExpression 
    ::  FilterExpression
newFilterExpression
  = FilterExpression{caseSensitive = Core.Nothing,
                     expressionValue = Core.Nothing, field = Core.Nothing,
                     fieldIndex = Core.Nothing, kind = "analytics#filterExpression",
              ...
              (\ o ->
                 FilterExpression Core.<$>
                   (o Core..:? "caseSensitive") Core.<*>
                     (o Core..:? "expressionValue")
                     Core.<*> (o Core..:? "field")
                     Core.<*> (o Core..:? "fieldIndex")
                     Core.<*> (o Core..:? "kind" Core..!= "analytics#filterExpression")
...
newFilterRef 
    ::  FilterRef
newFilterRef
  = FilterRef{accountId = Core.Nothing, href = Core.Nothing,
              id = Core.Nothing, kind = "analytics#filterRef",
              name = Core.Nothing}
instance Core.FromJSON FilterRef where
        parseJSON
          = Core.withObject "FilterRef"
              (\ o ->
                 FilterRef Core.<$>
                   (o Core..:? "accountId") Core.<*> (o Core..:? "href") Core.<*>
                     (o Core..:? "id")
...
newFilters 
    ::  Filters
newFilters
  = Filters{items = Core.Nothing, itemsPerPage = Core.Nothing,
            kind = "analytics#filters", nextLink = Core.Nothing,
            previousLink = Core.Nothing, startIndex = Core.Nothing,
            totalResults = Core.Nothing, username = Core.Nothing}
instance Core.FromJSON Filters where
        parseJSON
          = Core.withObject "Filters"
              (\ o ->
                 Filters Core.<$>
                   (o Core..:? "items") Core.<*> (o Core..:? "itemsPerPage") Core.<*>
                     (o Core..:? "kind" Core..!= "analytics#filters")
                     Core.<*> (o Core..:? "nextLink")
                     Core.<*> (o Core..:? "previousLink")
                     Core.<*> (o Core..:? "startIndex")
                     Core.<*> (o Core..:? "totalResults")
...
newGaData 
    ::  GaData
newGaData
  = GaData{columnHeaders = Core.Nothing,
           containsSampledData = Core.Nothing,
           dataLastRefreshed = Core.Nothing, dataTable = Core.Nothing,
           id = Core.Nothing, itemsPerPage = Core.Nothing,
           kind = "analytics#gaData", nextLink = Core.Nothing,
           previousLink = Core.Nothing, profileInfo = Core.Nothing,
           query = Core.Nothing, rows = Core.Nothing,
           sampleSize = Core.Nothing, sampleSpace = Core.Nothing,
           selfLink = Core.Nothing, totalResults = Core.Nothing,
           totalsForAllResults = Core.Nothing}
instance Core.FromJSON GaData where
        parseJSON
          = Core.withObject "GaData"
              (\ o ->
                 GaData Core.<$>
                   (o Core..:? "columnHeaders") Core.<*>
                     (o Core..:? "containsSampledData")
                     Core.<*>
                     (o Core..:? "dataLastRefreshed" Core.<&> Core.fmap Core.fromAsText)
                     ...
                     Core.<*> (o Core..:? "rows")
                     Core.<*>
                     (o Core..:? "sampleSize" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "sampleSpace" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "selfLink")
                     Core.<*> (o Core..:? "totalResults")
          ...
          = Core.object
              (Core.catMaybes
                 [("columnHeaders" Core..=) Core.<$> columnHeaders,
                  ("containsSampledData" Core..=) Core.<$> containsSampledData,
                  ("dataLastRefreshed" Core..=) Core.. Core.AsText Core.<$>
                    dataLastRefreshed,
                  ...
                  ("query" Core..=) Core.<$> query, ("rows" Core..=) Core.<$> rows,
                  ("sampleSize" Core..=) Core.. Core.AsText Core.<$> sampleSize,
                  ("sampleSpace" Core..=) Core.. Core.AsText Core.<$> sampleSpace,
                  ("selfLink" Core..=) Core.<$> selfLink,
                  ("totalResults" Core..=) Core.<$> totalResults,
                  ("totalsForAllResults" Core..=) Core.<$> totalsForAllResults])
...
newGaData_ColumnHeadersItem 
    ::  GaData_ColumnHeadersItem
newGaData_ColumnHeadersItem
  = GaData_ColumnHeadersItem{columnType = Core.Nothing,
                             dataType = Core.Nothing, name = Core.Nothing}
instance Core.FromJSON GaData_ColumnHeadersItem where
        parseJSON
          = Core.withObject "GaData_ColumnHeadersItem"
              (\ o ->
                 GaData_ColumnHeadersItem Core.<$>
                   (o Core..:? "columnType") Core.<*> (o Core..:? "dataType") Core.<*>
                     (o Core..:? "name"))
...
instance Core.FromJSON GaData_DataTable where
        parseJSON
          = Core.withObject "GaData_DataTable"
              (\ o ->
                 GaData_DataTable Core.<$>
                   (o Core..:? "cols") Core.<*> (o Core..:? "rows"))

instance Core.ToJSON GaData_DataTable where
        toJSON GaData_DataTable{..}
          = Core.object
              (Core.catMaybes
                 [("cols" Core..=) Core.<$> cols, ("rows" Core..=) Core.<$> rows])
...
newGaData_DataTable_ColsItem 
    ::  GaData_DataTable_ColsItem
newGaData_DataTable_ColsItem
  = GaData_DataTable_ColsItem{id = Core.Nothing,
                              label = Core.Nothing, type' = Core.Nothing}
instance Core.FromJSON GaData_DataTable_ColsItem where
        parseJSON
          = Core.withObject "GaData_DataTable_ColsItem"
              (\ o ->
                 GaData_DataTable_ColsItem Core.<$>
                   (o Core..:? "id") Core.<*> (o Core..:? "label") Core.<*>
                     (o Core..:? "type"))
...
newGaData_DataTable_RowsItem 
    ::  GaData_DataTable_RowsItem
newGaData_DataTable_RowsItem
  = GaData_DataTable_RowsItem{c = Core.Nothing}
instance Core.FromJSON GaData_DataTable_RowsItem where
        parseJSON
          = Core.withObject "GaData_DataTable_RowsItem"
              (\ o -> GaData_DataTable_RowsItem Core.<$> (o Core..:? "c"))

instance Core.ToJSON GaData_DataTable_RowsItem where
        toJSON GaData_DataTable_RowsItem{..}
          = Core.object (Core.catMaybes [("c" Core..=) Core.<$> c])
...
instance Core.FromJSON GaData_DataTable_RowsItem_CItem where
        parseJSON
          = Core.withObject "GaData_DataTable_RowsItem_CItem"
              (\ o -> GaData_DataTable_RowsItem_CItem Core.<$> (o Core..:? "v"))
...
newGaData_ProfileInfo 
    ::  GaData_ProfileInfo
newGaData_ProfileInfo
  = GaData_ProfileInfo{accountId = Core.Nothing,
                       internalWebPropertyId = Core.Nothing, profileId = Core.Nothing,
                       profileName = Core.Nothing, tableId = Core.Nothing,
                       webPropertyId = Core.Nothing}
instance Core.FromJSON GaData_ProfileInfo where
        parseJSON
          = Core.withObject "GaData_ProfileInfo"
              (\ o ->
                 GaData_ProfileInfo Core.<$>
                   (o Core..:? "accountId") Core.<*>
                     (o Core..:? "internalWebPropertyId")
                     Core.<*> (o Core..:? "profileId")
                     Core.<*> (o Core..:? "profileName")
                     Core.<*> (o Core..:? "tableId")
                     Core.<*> (o Core..:? "webPropertyId"))
...
newGaData_Query 
    ::  GaData_Query
newGaData_Query
  = GaData_Query{dimensions = Core.Nothing, endDate = Core.Nothing,
                 filters = Core.Nothing, ids = Core.Nothing,
                 maxResults = Core.Nothing, metrics = Core.Nothing,
                 samplingLevel = Core.Nothing, segment = Core.Nothing,
                 sort = Core.Nothing, startDate = Core.Nothing,
                 startIndex = Core.Nothing}
instance Core.FromJSON GaData_Query where
        parseJSON
          = Core.withObject "GaData_Query"
              (\ o ->
                 GaData_Query Core.<$>
                   (o Core..:? "dimensions") Core.<*> (o Core..:? "end-date") Core.<*>
                     (o Core..:? "filters")
                     Core.<*> (o Core..:? "ids")
          ...
          = Core.object
              (Core.catMaybes
                 [("dimensions" Core..=) Core.<$> dimensions,
                  ...
                  ("filters" Core..=) Core.<$> filters, ("ids" Core..=) Core.<$> ids,
...
newGaData_TotalsForAllResults 
    :: 
                              Core.HashMap Core.Text Core.Text
       -- ^  Key-value pair for the total value of a metric. Key is the metric name and the value is the total value for that metric. See 'additional'.
    -> GaData_TotalsForAllResults
newGaData_TotalsForAllResults additional
  = GaData_TotalsForAllResults{additional = additional}
instance Core.FromJSON GaData_TotalsForAllResults where
        parseJSON
          = Core.withObject "GaData_TotalsForAllResults"
              (\ o ->
                 GaData_TotalsForAllResults Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON GaData_TotalsForAllResults where
        toJSON GaData_TotalsForAllResults{..} = Core.toJSON additional
...
newGoal 
    ::  Goal
newGoal
  = Goal{accountId = Core.Nothing, active = Core.Nothing,
         created = Core.Nothing, eventDetails = Core.Nothing,
         id = Core.Nothing, internalWebPropertyId = Core.Nothing,
         kind = "analytics#goal", name = Core.Nothing,
         parentLink = Core.Nothing, profileId = Core.Nothing,
         selfLink = Core.Nothing, type' = Core.Nothing,
         updated = Core.Nothing, urlDestinationDetails = Core.Nothing,
         value = Core.Nothing, visitNumPagesDetails = Core.Nothing,
         visitTimeOnSiteDetails = Core.Nothing,
         webPropertyId = Core.Nothing}
instance Core.FromJSON Goal where
        parseJSON
          = Core.withObject "Goal"
              (\ o ->
                 Goal Core.<$>
                   (o Core..:? "accountId") Core.<*> (o Core..:? "active") Core.<*>
                     (o Core..:? "created")
          ...
          = Core.object
              (Core.catMaybes
                 [("accountId" Core..=) Core.<$> accountId,
                  ...
                  ("type" Core..=) Core.<$> type',
                  ("updated" Core..=) Core.<$> updated,
                  ("urlDestinationDetails" Core..=) Core.<$> urlDestinationDetails,
                  ("value" Core..=) Core.<$> value,
                  ("visitNumPagesDetails" Core..=) Core.<$> visitNumPagesDetails,
                  ("visitTimeOnSiteDetails" Core..=) Core.<$> visitTimeOnSiteDetails,
                  ("webPropertyId" Core..=) Core.<$> webPropertyId])
...
newGoal_EventDetails 
    ::  Goal_EventDetails
newGoal_EventDetails
  = Goal_EventDetails{eventConditions = Core.Nothing,
                      useEventValue = Core.Nothing}
instance Core.FromJSON Goal_EventDetails where
        parseJSON
          = Core.withObject "Goal_EventDetails"
              (\ o ->
                 Goal_EventDetails Core.<$>
                   (o Core..:? "eventConditions") Core.<*>
                     (o Core..:? "useEventValue"))

instance Core.ToJSON Goal_EventDetails where
        toJSON Goal_EventDetails{..}
          = Core.object
              (Core.catMaybes
                 [("eventConditions" Core..=) Core.<$> eventConditions,
...
newGoal_EventDetails_EventConditionsItem 
    :: 
                                         Goal_EventDetails_EventConditionsItem
newGoal_EventDetails_EventConditionsItem
  = Goal_EventDetails_EventConditionsItem{comparisonType =
                                            Core.Nothing,
                                          comparisonValue = Core.Nothing, expression = Core.Nothing,
                                          matchType = Core.Nothing, type' = Core.Nothing}
instance Core.FromJSON Goal_EventDetails_EventConditionsItem where
        parseJSON
          = Core.withObject "Goal_EventDetails_EventConditionsItem"
              (\ o ->
                 Goal_EventDetails_EventConditionsItem Core.<$>
                   (o Core..:? "comparisonType") Core.<*>
                     (o Core..:? "comparisonValue" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "expression")
                     Core.<*> (o Core..:? "matchType")
                     Core.<*> (o Core..:? "type"))

instance Core.ToJSON Goal_EventDetails_EventConditionsItem where
        toJSON Goal_EventDetails_EventConditionsItem{..}
          = Core.object
              (Core.catMaybes
                 [("comparisonType" Core..=) Core.<$> comparisonType,
                  ("comparisonValue" Core..=) Core.. Core.AsText Core.<$>
                    comparisonValue,
...
instance Core.FromJSON Goal_ParentLink where
        parseJSON
          = Core.withObject "Goal_ParentLink"
              (\ o ->
                 Goal_ParentLink Core.<$>
                   (o Core..:? "href") Core.<*>
                     (o Core..:? "type" Core..!= "analytics#profile"))
...
newGoal_UrlDestinationDetails 
    ::  Goal_UrlDestinationDetails
newGoal_UrlDestinationDetails
  = Goal_UrlDestinationDetails{caseSensitive = Core.Nothing,
                               firstStepRequired = Core.Nothing, matchType = Core.Nothing,
                               steps = Core.Nothing, url = Core.Nothing}
instance Core.FromJSON Goal_UrlDestinationDetails where
        parseJSON
          = Core.withObject "Goal_UrlDestinationDetails"
              (\ o ->
                 Goal_UrlDestinationDetails Core.<$>
                   (o Core..:? "caseSensitive") Core.<*>
                     (o Core..:? "firstStepRequired")
                     Core.<*> (o Core..:? "matchType")
                     Core.<*> (o Core..:? "steps")
                     Core.<*> (o Core..:? "url"))
...
instance Core.ToJSON Goal_UrlDestinationDetails where
        toJSON Goal_UrlDestinationDetails{..}
          = Core.object
              (Core.catMaybes
                 [("caseSensitive" Core..=) Core.<$> caseSensitive,
                  ("firstStepRequired" Core..=) Core.<$> firstStepRequired,
                  ("matchType" Core..=) Core.<$> matchType,
                  ("steps" Core..=) Core.<$> steps, ("url" Core..=) Core.<$> url])
...
newGoal_UrlDestinationDetails_StepsItem 
    :: 
                                        Goal_UrlDestinationDetails_StepsItem
newGoal_UrlDestinationDetails_StepsItem
  = Goal_UrlDestinationDetails_StepsItem{name = Core.Nothing,
                                         number = Core.Nothing, url = Core.Nothing}
instance Core.FromJSON Goal_UrlDestinationDetails_StepsItem where
        parseJSON
          = Core.withObject "Goal_UrlDestinationDetails_StepsItem"
              (\ o ->
                 Goal_UrlDestinationDetails_StepsItem Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "number") Core.<*>
                     (o Core..:? "url"))

instance Core.ToJSON Goal_UrlDestinationDetails_StepsItem where
        toJSON Goal_UrlDestinationDetails_StepsItem{..}
          = Core.object
              (Core.catMaybes
                 [("name" Core..=) Core.<$> name,
                  ("number" Core..=) Core.<$> number, ("url" Core..=) Core.<$> url])
...
newGoal_VisitNumPagesDetails 
    ::  Goal_VisitNumPagesDetails
newGoal_VisitNumPagesDetails
  = Goal_VisitNumPagesDetails{comparisonType = Core.Nothing,
                              comparisonValue = Core.Nothing}
instance Core.FromJSON Goal_VisitNumPagesDetails where
        parseJSON
          = Core.withObject "Goal_VisitNumPagesDetails"
              (\ o ->
                 Goal_VisitNumPagesDetails Core.<$>
                   (o Core..:? "comparisonType") Core.<*>
                     (o Core..:? "comparisonValue" Core.<&> Core.fmap Core.fromAsText))
...
newGoal_VisitTimeOnSiteDetails 
    ::  Goal_VisitTimeOnSiteDetails
newGoal_VisitTimeOnSiteDetails
  = Goal_VisitTimeOnSiteDetails{comparisonType = Core.Nothing,
                                comparisonValue = Core.Nothing}
instance Core.FromJSON Goal_VisitTimeOnSiteDetails where
        parseJSON
          = Core.withObject "Goal_VisitTimeOnSiteDetails"
              (\ o ->
                 Goal_VisitTimeOnSiteDetails Core.<$>
                   (o Core..:? "comparisonType") Core.<*>
                     (o Core..:? "comparisonValue" Core.<&> Core.fmap Core.fromAsText))
...
newGoals 
    ::  Goals
newGoals
  = Goals{items = Core.Nothing, itemsPerPage = Core.Nothing,
          kind = "analytics#goals", nextLink = Core.Nothing,
          previousLink = Core.Nothing, startIndex = Core.Nothing,
          totalResults = Core.Nothing, username = Core.Nothing}
instance Core.FromJSON Goals where
        parseJSON
          = Core.withObject "Goals"
              (\ o ->
                 Goals Core.<$>
                   (o Core..:? "items") Core.<*> (o Core..:? "itemsPerPage") Core.<*>
                     (o Core..:? "kind" Core..!= "analytics#goals")
                     Core.<*> (o Core..:? "nextLink")
                     Core.<*> (o Core..:? "previousLink")
                     Core.<*> (o Core..:? "startIndex")
                     Core.<*> (o Core..:? "totalResults")
...
newHashClientIdRequest 
    ::  HashClientIdRequest
newHashClientIdRequest
  = HashClientIdRequest{clientId = Core.Nothing,
                        kind = "analytics#hashClientIdRequest",
                        webPropertyId = Core.Nothing}
instance Core.FromJSON HashClientIdRequest where
        parseJSON
          = Core.withObject "HashClientIdRequest"
              (\ o ->
                 HashClientIdRequest Core.<$>
                   (o Core..:? "clientId") Core.<*>
                     (o Core..:? "kind" Core..!= "analytics#hashClientIdRequest")
                     Core.<*> (o Core..:? "webPropertyId"))
...
newHashClientIdResponse 
    ::  HashClientIdResponse
newHashClientIdResponse
  = HashClientIdResponse{clientId = Core.Nothing,
                         hashedClientId = Core.Nothing,
                         kind = "analytics#hashClientIdResponse",
                         webPropertyId = Core.Nothing}
instance Core.FromJSON HashClientIdResponse where
        parseJSON
          = Core.withObject "HashClientIdResponse"
              (\ o ->
                 HashClientIdResponse Core.<$>
                   (o Core..:? "clientId") Core.<*> (o Core..:? "hashedClientId")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "analytics#hashClientIdResponse")
                     Core.<*> (o Core..:? "webPropertyId"))
...
newIncludeConditions 
    ::  IncludeConditions
newIncludeConditions
  = IncludeConditions{daysToLookBack = Core.Nothing,
                      isSmartList = Core.Nothing, kind = "analytics#includeConditions",
                      membershipDurationDays = Core.Nothing, segment = Core.Nothing}
instance Core.FromJSON IncludeConditions where
        parseJSON
          = Core.withObject "IncludeConditions"
              (\ o ->
                 IncludeConditions Core.<$>
                   (o Core..:? "daysToLookBack") Core.<*> (o Core..:? "isSmartList")
                     Core.<*> (o Core..:? "kind" Core..!= "analytics#includeConditions")
          ...
          = Core.object
              (Core.catMaybes
                 [("daysToLookBack" Core..=) Core.<$> daysToLookBack,
                  ...
                  Core.Just ("kind" Core..= kind),
                  ("membershipDurationDays" Core..=) Core.<$> membershipDurationDays,
                  ("segment" Core..=) Core.<$> segment])
...
newLinkedForeignAccount 
    ::  LinkedForeignAccount
newLinkedForeignAccount
  = LinkedForeignAccount{accountId = Core.Nothing,
                         eligibleForSearch = Core.Nothing, id = Core.Nothing,
                         internalWebPropertyId = Core.Nothing,
                         kind = "analytics#linkedForeignAccount",
                         linkedAccountId = Core.Nothing,
                         remarketingAudienceId = Core.Nothing, status = Core.Nothing,
                         type' = Core.Nothing, webPropertyId = Core.Nothing}
instance Core.FromJSON LinkedForeignAccount where
        parseJSON
          = Core.withObject "LinkedForeignAccount"
              (\ o ->
                 LinkedForeignAccount Core.<$>
                   (o Core..:? "accountId") Core.<*> (o Core..:? "eligibleForSearch")
                     Core.<*> (o Core..:? "id")
                     Core.<*> (o Core..:? "internalWebPropertyId")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "analytics#linkedForeignAccount")
...
instance Core.ToJSON LinkedForeignAccount where
        toJSON LinkedForeignAccount{..}
          = Core.object
              (Core.catMaybes
                 [("accountId" Core..=) Core.<$> accountId,
                  ("eligibleForSearch" Core..=) Core.<$> eligibleForSearch,
                  ("id" Core..=) Core.<$> id,
                  ("internalWebPropertyId" Core..=) Core.<$> internalWebPropertyId,
                  Core.Just ("kind" Core..= kind),
                  ("linkedAccountId" Core..=) Core.<$> linkedAccountId,
                  ("remarketingAudienceId" Core..=) Core.<$> remarketingAudienceId,
                  ("status" Core..=) Core.<$> status,
                  ("type" Core..=) Core.<$> type',
                  ("webPropertyId" Core..=) Core.<$> webPropertyId])
...
newMcfData 
    ::  McfData
newMcfData
  = McfData{columnHeaders = Core.Nothing,
            containsSampledData = Core.Nothing, id = Core.Nothing,
            itemsPerPage = Core.Nothing, kind = "analytics#mcfData",
            nextLink = Core.Nothing, previousLink = Core.Nothing,
            profileInfo = Core.Nothing, query = Core.Nothing,
            rows = Core.Nothing, sampleSize = Core.Nothing,
            sampleSpace = Core.Nothing, selfLink = Core.Nothing,
            totalResults = Core.Nothing, totalsForAllResults = Core.Nothing}
instance Core.FromJSON McfData where
        parseJSON
          = Core.withObject "McfData"
              (\ o ->
                 McfData Core.<$>
                   (o Core..:? "columnHeaders") Core.<*>
                     (o Core..:? "containsSampledData")
...
newMcfData_ColumnHeadersItem 
    ::  McfData_ColumnHeadersItem
newMcfData_ColumnHeadersItem
  = McfData_ColumnHeadersItem{columnType = Core.Nothing,
                              dataType = Core.Nothing, name = Core.Nothing}
instance Core.FromJSON McfData_ColumnHeadersItem where
        parseJSON
          = Core.withObject "McfData_ColumnHeadersItem"
              (\ o ->
                 McfData_ColumnHeadersItem Core.<$>
                   (o Core..:? "columnType") Core.<*> (o Core..:? "dataType") Core.<*>
                     (o Core..:? "name"))
...
newMcfData_ProfileInfo 
    ::  McfData_ProfileInfo
newMcfData_ProfileInfo
  = McfData_ProfileInfo{accountId = Core.Nothing,
                        internalWebPropertyId = Core.Nothing, profileId = Core.Nothing,
                        profileName = Core.Nothing, tableId = Core.Nothing,
                        webPropertyId = Core.Nothing}
instance Core.FromJSON McfData_ProfileInfo where
        parseJSON
          = Core.withObject "McfData_ProfileInfo"
              (\ o ->
                 McfData_ProfileInfo Core.<$>
                   (o Core..:? "accountId") Core.<*>
                     (o Core..:? "internalWebPropertyId")
                     Core.<*> (o Core..:? "profileId")
                     Core.<*> (o Core..:? "profileName")
...
newMcfData_Query 
    ::  McfData_Query
newMcfData_Query
  = McfData_Query{dimensions = Core.Nothing, endDate = Core.Nothing,
                  filters = Core.Nothing, ids = Core.Nothing,
                  maxResults = Core.Nothing, metrics = Core.Nothing,
                  samplingLevel = Core.Nothing, segment = Core.Nothing,
                  sort = Core.Nothing, startDate = Core.Nothing,
...
newMcfData_RowsItemItem 
    ::  McfData_RowsItemItem
newMcfData_RowsItemItem
  = McfData_RowsItemItem{conversionPathValue = Core.Nothing,
                         primitiveValue = Core.Nothing}
instance Core.FromJSON McfData_RowsItemItem where
        parseJSON
          = Core.withObject "McfData_RowsItemItem"
              (\ o ->
                 McfData_RowsItemItem Core.<$>
                   (o Core..:? "conversionPathValue") Core.<*>
                     (o Core..:? "primitiveValue"))

instance Core.ToJSON McfData_RowsItemItem where
        toJSON McfData_RowsItemItem{..}
          = Core.object
              (Core.catMaybes
                 [("conversionPathValue" Core..=) Core.<$> conversionPathValue,
...
newMcfData_RowsItemItem_ConversionPathValueItem 
    :: 
                                                McfData_RowsItemItem_ConversionPathValueItem
newMcfData_RowsItemItem_ConversionPathValueItem
  = McfData_RowsItemItem_ConversionPathValueItem{interactionType =
                                                   Core.Nothing,
                                                 nodeValue = Core.Nothing}
instance Core.FromJSON McfData_RowsItemItem_ConversionPathValueItem
         where
        parseJSON
          = Core.withObject "McfData_RowsItemItem_ConversionPathValueItem"
              (\ o ->
                 McfData_RowsItemItem_ConversionPathValueItem Core.<$>
                   (o Core..:? "interactionType") Core.<*> (o Core..:? "nodeValue"))

instance Core.ToJSON McfData_RowsItemItem_ConversionPathValueItem
         where
        toJSON McfData_RowsItemItem_ConversionPathValueItem{..}
          = Core.object
              (Core.catMaybes
...
newMcfData_TotalsForAllResults 
    :: 
       ...
       -- ^  Key-value pair for the total value of a metric. Key is the metric name and the value is the total value for that metric. See 'additional'.
    -> McfData_TotalsForAllResults
newMcfData_TotalsForAllResults additional
  = McfData_TotalsForAllResults{additional = additional}
instance Core.FromJSON McfData_TotalsForAllResults where
        parseJSON
          = Core.withObject "McfData_TotalsForAllResults"
              (\ o ->
                 McfData_TotalsForAllResults Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON McfData_TotalsForAllResults where
        toJSON McfData_TotalsForAllResults{..} = Core.toJSON additional
...
newProfile 
    ::  Profile
newProfile
  = Profile{accountId = Core.Nothing,
            botFilteringEnabled = Core.Nothing, childLink = Core.Nothing,
            created = Core.Nothing, currency = Core.Nothing,
            defaultPage = Core.Nothing, eCommerceTracking = Core.Nothing,
            enhancedECommerceTracking = Core.Nothing,
            excludeQueryParameters = Core.Nothing, id = Core.Nothing,
            internalWebPropertyId = Core.Nothing, kind = "analytics#profile",
            name = Core.Nothing, parentLink = Core.Nothing,
            permissions = Core.Nothing, selfLink = Core.Nothing,
            siteSearchCategoryParameters = Core.Nothing,
            siteSearchQueryParameters = Core.Nothing, starred = Core.Nothing,
            stripSiteSearchCategoryParameters = Core.Nothing,
            stripSiteSearchQueryParameters = Core.Nothing,
            timezone = Core.Nothing, type' = Core.Nothing,
            updated = Core.Nothing, webPropertyId = Core.Nothing,
            websiteUrl = Core.Nothing}
...
instance Core.ToJSON Profile where
        toJSON Profile{..}
          = Core.object
              (Core.catMaybes
                 [("accountId" Core..=) Core.<$> accountId,
                  ("botFilteringEnabled" Core..=) Core.<$> botFilteringEnabled,
                  ("childLink" Core..=) Core.<$> childLink,
                  ("created" Core..=) Core.<$> created,
                  ("currency" Core..=) Core.<$> currency,
                  ("defaultPage" Core..=) Core.<$> defaultPage,
                  ("eCommerceTracking" Core..=) Core.<$> eCommerceTracking,
                  ("enhancedECommerceTracking" Core..=) Core.<$>
                    enhancedECommerceTracking,
                  ("excludeQueryParameters" Core..=) Core.<$> excludeQueryParameters,
                  ("id" Core..=) Core.<$> id,
                  ("internalWebPropertyId" Core..=) Core.<$> internalWebPropertyId,
                  Core.Just ("kind" Core..= kind), ("name" Core..=) Core.<$> name,
                  ("parentLink" Core..=) Core.<$> parentLink,
                  ("permissions" Core..=) Core.<$> permissions,
                  ("selfLink" Core..=) Core.<$> selfLink,
                  ("siteSearchCategoryParameters" Core..=) Core.<$>
                    siteSearchCategoryParameters,
                  ("siteSearchQueryParameters" Core..=) Core.<$>
                    siteSearchQueryParameters,
                  ("starred" Core..=) Core.<$> starred,
                  ("stripSiteSearchCategoryParameters" Core..=) Core.<$>
                    stripSiteSearchCategoryParameters,
                  ("stripSiteSearchQueryParameters" Core..=) Core.<$>
...
instance Core.FromJSON Profile_ChildLink where
        parseJSON
          = Core.withObject "Profile_ChildLink"
              (\ o ->
                 Profile_ChildLink Core.<$>
                   (o Core..:? "href") Core.<*>
                     (o Core..:? "type" Core..!= "analytics#goals"))
...
newProfile_ParentLink 
    ::  Profile_ParentLink
newProfile_ParentLink
  = Profile_ParentLink{href = Core.Nothing,
                       type' = "analytics#webproperty"}
instance Core.FromJSON Profile_ParentLink where
        parseJSON
          = Core.withObject "Profile_ParentLink"
              (\ o ->
                 Profile_ParentLink Core.<$>
                   (o Core..:? "href") Core.<*>
                     (o Core..:? "type" Core..!= "analytics#webproperty"))
...
newProfile_Permissions 
    ::  Profile_Permissions
newProfile_Permissions
  = Profile_Permissions{effective = Core.Nothing}
instance Core.FromJSON Profile_Permissions where
        parseJSON
          = Core.withObject "Profile_Permissions"
              (\ o -> Profile_Permissions Core.<$> (o Core..:? "effective"))
...
newProfileFilterLink 
    ::  ProfileFilterLink
newProfileFilterLink
  = ProfileFilterLink{filterRef = Core.Nothing, id = Core.Nothing,
                      kind = "analytics#profileFilterLink", profileRef = Core.Nothing,
                      rank = Core.Nothing, selfLink = Core.Nothing}
instance Core.FromJSON ProfileFilterLink where
        parseJSON
          = Core.withObject "ProfileFilterLink"
              (\ o ->
                 ProfileFilterLink Core.<$>
                   (o Core..:? "filterRef") Core.<*> (o Core..:? "id") Core.<*>
                     (o Core..:? "kind" Core..!= "analytics#profileFilterLink")
...
newProfileFilterLinks 
    ::  ProfileFilterLinks
newProfileFilterLinks
  = ProfileFilterLinks{items = Core.Nothing,
                       itemsPerPage = Core.Nothing, kind = "analytics#profileFilterLinks",
                       nextLink = Core.Nothing, previousLink = Core.Nothing,
                       startIndex = Core.Nothing, totalResults = Core.Nothing,
                       username = Core.Nothing}
instance Core.FromJSON ProfileFilterLinks where
        parseJSON
          = Core.withObject "ProfileFilterLinks"
              (\ o ->
                 ProfileFilterLinks Core.<$>
                   (o Core..:? "items") Core.<*> (o Core..:? "itemsPerPage") Core.<*>
                     (o Core..:? "kind" Core..!= "analytics#profileFilterLinks")
                     Core.<*> (o Core..:? "nextLink")
                     Core.<*> (o Core..:? "previousLink")
                     Core.<*> (o Core..:? "startIndex")
                     Core.<*> (o Core..:? "totalResults")
...
newProfileRef 
    ::  ProfileRef
newProfileRef
  = ProfileRef{accountId = Core.Nothing, href = Core.Nothing,
               id = Core.Nothing, internalWebPropertyId = Core.Nothing,
               kind = "analytics#profileRef", name = Core.Nothing,
               webPropertyId = Core.Nothing}
instance Core.FromJSON ProfileRef where
        parseJSON
          = Core.withObject "ProfileRef"
              (\ o ->
                 ProfileRef Core.<$>
                   (o Core..:? "accountId") Core.<*> (o Core..:? "href") Core.<*>
                     (o Core..:? "id")
...
newProfileSummary 
    ::  ProfileSummary
newProfileSummary
  = ProfileSummary{id = Core.Nothing,
                   kind = "analytics#profileSummary", name = Core.Nothing,
                   starred = Core.Nothing, type' = Core.Nothing}
instance Core.FromJSON ProfileSummary where
        parseJSON
          = Core.withObject "ProfileSummary"
              (\ o ->
                 ProfileSummary Core.<$>
                   (o Core..:? "id") Core.<*>
                     (o Core..:? "kind" Core..!= "analytics#profileSummary")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "starred")
                     Core.<*> (o Core..:? "type"))
...
newProfiles 
    ::  Profiles
newProfiles
  = Profiles{items = Core.Nothing, itemsPerPage = Core.Nothing,
             kind = "analytics#profiles", nextLink = Core.Nothing,
             previousLink = Core.Nothing, startIndex = Core.Nothing,
             totalResults = Core.Nothing, username = Core.Nothing}
instance Core.FromJSON Profiles where
        parseJSON
          = Core.withObject "Profiles"
              (\ o ->
                 Profiles Core.<$>
                   (o Core..:? "items") Core.<*> (o Core..:? "itemsPerPage") Core.<*>
                     (o Core..:? "kind" Core..!= "analytics#profiles")
                     Core.<*> (o Core..:? "nextLink")
                     Core.<*> (o Core..:? "previousLink")
                     Core.<*> (o Core..:? "startIndex")
                     Core.<*> (o Core..:? "totalResults")
...
newRealtimeData 
    ::  RealtimeData
newRealtimeData
  = RealtimeData{columnHeaders = Core.Nothing, id = Core.Nothing,
                 kind = "analytics#realtimeData", profileInfo = Core.Nothing,
                 query = Core.Nothing, rows = Core.Nothing, selfLink = Core.Nothing,
                 totalResults = Core.Nothing, totalsForAllResults = Core.Nothing}
instance Core.FromJSON RealtimeData where
        parseJSON
          = Core.withObject "RealtimeData"
              (\ o ->
                 RealtimeData Core.<$>
                   (o Core..:? "columnHeaders") Core.<*> (o Core..:? "id") Core.<*>
                     (o Core..:? "kind" Core..!= "analytics#realtimeData")
                     Core.<*> (o Core..:? "profileInfo")
                     Core.<*> (o Core..:? "query")
                     Core.<*> (o Core..:? "rows")
                     Core.<*> (o Core..:? "selfLink")
...
newRealtimeData_ColumnHeadersItem 
    ::  RealtimeData_ColumnHeadersItem
newRealtimeData_ColumnHeadersItem
  = RealtimeData_ColumnHeadersItem{columnType = Core.Nothing,
                                   dataType = Core.Nothing, name = Core.Nothing}
instance Core.FromJSON RealtimeData_ColumnHeadersItem where
        parseJSON
          = Core.withObject "RealtimeData_ColumnHeadersItem"
              (\ o ->
                 RealtimeData_ColumnHeadersItem Core.<$>
                   (o Core..:? "columnType") Core.<*> (o Core..:? "dataType") Core.<*>
                     (o Core..:? "name"))
...
newRealtimeData_ProfileInfo 
    ::  RealtimeData_ProfileInfo
newRealtimeData_ProfileInfo
  = RealtimeData_ProfileInfo{accountId = Core.Nothing,
                             internalWebPropertyId = Core.Nothing, profileId = Core.Nothing,
                             profileName = Core.Nothing, tableId = Core.Nothing,
                             webPropertyId = Core.Nothing}
instance Core.FromJSON RealtimeData_ProfileInfo where
        parseJSON
          = Core.withObject "RealtimeData_ProfileInfo"
              (\ o ->
                 RealtimeData_ProfileInfo Core.<$>
                   (o Core..:? "accountId") Core.<*>
                     (o Core..:? "internalWebPropertyId")
                     Core.<*> (o Core..:? "profileId")
                     Core.<*> (o Core..:? "profileName")
...
newRealtimeData_Query 
    ::  RealtimeData_Query
newRealtimeData_Query
  = RealtimeData_Query{dimensions = Core.Nothing,
                       filters = Core.Nothing, ids = Core.Nothing,
                       maxResults = Core.Nothing, metrics = Core.Nothing,
                       sort = Core.Nothing}
instance Core.FromJSON RealtimeData_Query where
        parseJSON
          = Core.withObject "RealtimeData_Query"
              (\ o ->
                 RealtimeData_Query Core.<$>
                   (o Core..:? "dimensions") Core.<*> (o Core..:? "filters") Core.<*>
                     (o Core..:? "ids")
                     Core.<*> (o Core..:? "max-results")
                     Core.<*> (o Core..:? "metrics")
                     Core.<*> (o Core..:? "sort"))
...
newRealtimeData_TotalsForAllResults 
    :: 
       ...
       -- ^  Key-value pair for the total value of a metric. Key is the metric name and the value is the total value for that metric. See 'additional'.
    -> RealtimeData_TotalsForAllResults
newRealtimeData_TotalsForAllResults additional
  = RealtimeData_TotalsForAllResults{additional = additional}
instance Core.FromJSON RealtimeData_TotalsForAllResults where
        parseJSON
          = Core.withObject "RealtimeData_TotalsForAllResults"
              (\ o ->
                 RealtimeData_TotalsForAllResults Core.<$> (Core.parseJSONObject o))
...
newRemarketingAudience 
    ::  RemarketingAudience
newRemarketingAudience
  = RemarketingAudience{accountId = Core.Nothing,
                        audienceDefinition = Core.Nothing, audienceType = Core.Nothing,
                        created = Core.Nothing, description = Core.Nothing,
                        id = Core.Nothing, internalWebPropertyId = Core.Nothing,
                        kind = "analytics#remarketingAudience",
                        linkedAdAccounts = Core.Nothing, linkedViews = Core.Nothing,
                        name = Core.Nothing, stateBasedAudienceDefinition = Core.Nothing,
                        updated = Core.Nothing, webPropertyId = Core.Nothing}
instance Core.FromJSON RemarketingAudience where
        parseJSON
          = Core.withObject "RemarketingAudience"
              (\ o ->
                 RemarketingAudience Core.<$>
                   (o Core..:? "accountId") Core.<*> (o Core..:? "audienceDefinition")
                     ...
                     Core.<*> (o Core..:? "internalWebPropertyId")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "analytics#remarketingAudience")
...
instance Core.ToJSON RemarketingAudience where
        toJSON RemarketingAudience{..}
          = Core.object
              (Core.catMaybes
                 [("accountId" Core..=) Core.<$> accountId,
                  ("audienceDefinition" Core..=) Core.<$> audienceDefinition,
                  ...
                  ("internalWebPropertyId" Core..=) Core.<$> internalWebPropertyId,
                  Core.Just ("kind" Core..= kind),
                  ("linkedAdAccounts" Core..=) Core.<$> linkedAdAccounts,
                  ("linkedViews" Core..=) Core.<$> linkedViews,
                  ("name" Core..=) Core.<$> name,
                  ("stateBasedAudienceDefinition" Core..=) Core.<$>
...
newRemarketingAudience_AudienceDefinition 
    :: 
                                          RemarketingAudience_AudienceDefinition
newRemarketingAudience_AudienceDefinition
  = RemarketingAudience_AudienceDefinition{includeConditions =
                                             Core.Nothing}
instance Core.FromJSON RemarketingAudience_AudienceDefinition where
        parseJSON
          = Core.withObject "RemarketingAudience_AudienceDefinition"
              (\ o ->
                 RemarketingAudience_AudienceDefinition Core.<$>
                   (o Core..:? "includeConditions"))

instance Core.ToJSON RemarketingAudience_AudienceDefinition where
        toJSON RemarketingAudience_AudienceDefinition{..}
          = Core.object
              (Core.catMaybes
                 [("includeConditions" Core..=) Core.<$> includeConditions])
...
newRemarketingAudience_StateBasedAudienceDefinition 
    :: 
                                                    RemarketingAudience_StateBasedAudienceDefinition
newRemarketingAudience_StateBasedAudienceDefinition
  = RemarketingAudience_StateBasedAudienceDefinition{excludeConditions
                                                       = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "RemarketingAudience_StateBasedAudienceDefinition"
              (\ o ->
                 RemarketingAudience_StateBasedAudienceDefinition Core.<$>
                   (o Core..:? "excludeConditions") Core.<*>
                     (o Core..:? "includeConditions"))

instance Core.ToJSON
           RemarketingAudience_StateBasedAudienceDefinition
         where
        toJSON RemarketingAudience_StateBasedAudienceDefinition{..}
          = Core.object
              (Core.catMaybes
                 [("excludeConditions" Core..=) Core.<$> excludeConditions,
                  ("includeConditions" Core..=) Core.<$> includeConditions])
...
newRemarketingAudience_StateBasedAudienceDefinition_ExcludeConditions 
    :: 
                                                                      RemarketingAudience_StateBasedAudienceDefinition_ExcludeConditions
newRemarketingAudience_StateBasedAudienceDefinition_ExcludeConditions
  = RemarketingAudience_StateBasedAudienceDefinition_ExcludeConditions{exclusionDuration
                                                                         = Core.Nothing,
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 RemarketingAudience_StateBasedAudienceDefinition_ExcludeConditions
                   Core.<$>
                   (o Core..:? "exclusionDuration") Core.<*> (o Core..:? "segment"))
...
instance Core.ToJSON
        ...
        toJSON
          ...
          = Core.object
              (Core.catMaybes
                 [("exclusionDuration" Core..=) Core.<$> exclusionDuration,
                  ("segment" Core..=) Core.<$> segment])
...
newRemarketingAudiences 
    ::  RemarketingAudiences
newRemarketingAudiences
  = RemarketingAudiences{items = Core.Nothing,
                         itemsPerPage = Core.Nothing,
                         kind = "analytics#remarketingAudiences", nextLink = Core.Nothing,
                         previousLink = Core.Nothing, startIndex = Core.Nothing,
                         totalResults = Core.Nothing, username = Core.Nothing}
instance Core.FromJSON RemarketingAudiences where
        parseJSON
          = Core.withObject "RemarketingAudiences"
              (\ o ->
                 RemarketingAudiences Core.<$>
                   (o Core..:? "items") Core.<*> (o Core..:? "itemsPerPage") Core.<*>
                     (o Core..:? "kind" Core..!= "analytics#remarketingAudiences")
                     Core.<*> (o Core..:? "nextLink")
                     Core.<*> (o Core..:? "previousLink")
                     Core.<*> (o Core..:? "startIndex")
                     Core.<*> (o Core..:? "totalResults")
...
newSegment 
    ::  Segment
newSegment
  = Segment{created = Core.Nothing, definition = Core.Nothing,
            id = Core.Nothing, kind = "analytics#segment", name = Core.Nothing,
            segmentId = Core.Nothing, selfLink = Core.Nothing,
            type' = Core.Nothing, updated = Core.Nothing}
instance Core.FromJSON Segment where
        parseJSON
          = Core.withObject "Segment"
              (\ o ->
                 Segment Core.<$>
                   (o Core..:? "created") Core.<*> (o Core..:? "definition") Core.<*>
                     (o Core..:? "id")
...
newSegments 
    ::  Segments
newSegments
  = Segments{items = Core.Nothing, itemsPerPage = Core.Nothing,
             kind = "analytics#segments", nextLink = Core.Nothing,
             previousLink = Core.Nothing, startIndex = Core.Nothing,
             totalResults = Core.Nothing, username = Core.Nothing}
        ...
        parseJSON
          = Core.withObject "Segments"
              (\ o ->
                 Segments Core.<$>
                   (o Core..:? "items") Core.<*> (o Core..:? "itemsPerPage") Core.<*>
                     (o Core..:? "kind" Core..!= "analytics#segments")
                     Core.<*> (o Core..:? "nextLink")
                     Core.<*> (o Core..:? "previousLink")
                     Core.<*> (o Core..:? "startIndex")
                     Core.<*> (o Core..:? "totalResults")
...
newUnsampledReport 
    ::  UnsampledReport
newUnsampledReport
  = UnsampledReport{accountId = Core.Nothing,
                    cloudStorageDownloadDetails = Core.Nothing, created = Core.Nothing,
                    dimensions = Core.Nothing, downloadType = Core.Nothing,
                    driveDownloadDetails = Core.Nothing, endDate = Core.Nothing,
                    filters = Core.Nothing, id = Core.Nothing,
                    kind = "analytics#unsampledReport", metrics = Core.Nothing,
                    profileId = Core.Nothing, segment = Core.Nothing,
                    selfLink = Core.Nothing, startDate = Core.Nothing,
                    status = Core.Nothing, title = Core.Nothing,
                    updated = Core.Nothing, webPropertyId = Core.Nothing}
instance Core.FromJSON UnsampledReport where
        parseJSON
          = Core.withObject "UnsampledReport"
              (\ o ->
                 UnsampledReport Core.<$>
                   (o Core..:? "accountId") Core.<*>
                     (o Core..:? "cloudStorageDownloadDetails")
                     Core.<*> (o Core..:? "created")
                     ...
                     Core.<*> (o Core..:? "filters")
                     Core.<*> (o Core..:? "id")
                     Core.<*> (o Core..:? "kind" Core..!= "analytics#unsampledReport")
                     Core.<*> (o Core..:? "metrics")
                     Core.<*> (o Core..:? "profileId")
                     Core.<*> (o Core..:? "segment")
                     Core.<*> (o Core..:? "selfLink")
...
instance Core.ToJSON UnsampledReport where
        toJSON UnsampledReport{..}
          = Core.object
              (Core.catMaybes
                 [("accountId" Core..=) Core.<$> accountId,
                  ("cloudStorageDownloadDetails" Core..=) Core.<$>
                    cloudStorageDownloadDetails,
                  ("created" Core..=) Core.<$> created,
                  ("dimensions" Core..=) Core.<$> dimensions,
                  ("downloadType" Core..=) Core.<$> downloadType,
                  ("driveDownloadDetails" Core..=) Core.<$> driveDownloadDetails,
                  ("end-date" Core..=) Core.<$> endDate,
                  ("filters" Core..=) Core.<$> filters, ("id" Core..=) Core.<$> id,
                  Core.Just ("kind" Core..= kind),
                  ("metrics" Core..=) Core.<$> metrics,
                  ("profileId" Core..=) Core.<$> profileId,
                  ("segment" Core..=) Core.<$> segment,
...
newUnsampledReport_CloudStorageDownloadDetails 
    :: 
                                               UnsampledReport_CloudStorageDownloadDetails
newUnsampledReport_CloudStorageDownloadDetails
  = UnsampledReport_CloudStorageDownloadDetails{bucketId =
                                                  Core.Nothing,
                                                objectId = Core.Nothing}
instance Core.FromJSON UnsampledReport_CloudStorageDownloadDetails
         where
        parseJSON
          = Core.withObject "UnsampledReport_CloudStorageDownloadDetails"
              (\ o ->
                 UnsampledReport_CloudStorageDownloadDetails Core.<$>
                   (o Core..:? "bucketId") Core.<*> (o Core..:? "objectId"))

instance Core.ToJSON UnsampledReport_CloudStorageDownloadDetails
         where
        toJSON UnsampledReport_CloudStorageDownloadDetails{..}
          = Core.object
              (Core.catMaybes
...
instance Core.FromJSON UnsampledReport_DriveDownloadDetails where
        parseJSON
          = Core.withObject "UnsampledReport_DriveDownloadDetails"
              (\ o ->
                 UnsampledReport_DriveDownloadDetails Core.<$>
                   (o Core..:? "documentId"))

instance Core.ToJSON UnsampledReport_DriveDownloadDetails where
        toJSON UnsampledReport_DriveDownloadDetails{..}
          = Core.object
              (Core.catMaybes [("documentId" Core..=) Core.<$> documentId])
...
newUnsampledReports 
    ::  UnsampledReports
newUnsampledReports
  = UnsampledReports{items = Core.Nothing,
                     itemsPerPage = Core.Nothing, kind = "analytics#unsampledReports",
                     nextLink = Core.Nothing, previousLink = Core.Nothing,
                     startIndex = Core.Nothing, totalResults = Core.Nothing,
                     username = Core.Nothing}
instance Core.FromJSON UnsampledReports where
        parseJSON
          = Core.withObject "UnsampledReports"
              (\ o ->
                 UnsampledReports Core.<$>
                   (o Core..:? "items") Core.<*> (o Core..:? "itemsPerPage") Core.<*>
                     (o Core..:? "kind" Core..!= "analytics#unsampledReports")
                     Core.<*> (o Core..:? "nextLink")
                     Core.<*> (o Core..:? "previousLink")
                     Core.<*> (o Core..:? "startIndex")
                     Core.<*> (o Core..:? "totalResults")
...
newUpload 
    ::  Upload
newUpload
  = Upload{accountId = Core.Nothing,
           customDataSourceId = Core.Nothing, errors = Core.Nothing,
           id = Core.Nothing, kind = "analytics#upload",
           status = Core.Nothing, uploadTime = Core.Nothing}
instance Core.FromJSON Upload where
        parseJSON
          = Core.withObject "Upload"
              (\ o ->
                 Upload Core.<$>
          ...
          = Core.object
              (Core.catMaybes
                 [("accountId" Core..=) Core.. Core.AsText Core.<$> accountId,
                  ("customDataSourceId" Core..=) Core.<$> customDataSourceId,
...
newUploads 
    ::  Uploads
newUploads
  = Uploads{items = Core.Nothing, itemsPerPage = Core.Nothing,
            kind = "analytics#uploads", nextLink = Core.Nothing,
            previousLink = Core.Nothing, startIndex = Core.Nothing,
            totalResults = Core.Nothing}
instance Core.FromJSON Uploads where
        parseJSON
          = Core.withObject "Uploads"
              (\ o ->
                 Uploads Core.<$>
                   (o Core..:? "items") Core.<*> (o Core..:? "itemsPerPage") Core.<*>
                     (o Core..:? "kind" Core..!= "analytics#uploads")
                     Core.<*> (o Core..:? "nextLink")
                     Core.<*> (o Core..:? "previousLink")
                     Core.<*> (o Core..:? "startIndex")
                     Core.<*> (o Core..:? "totalResults"))
...
newUserDeletionRequest 
    ::  UserDeletionRequest
newUserDeletionRequest
  = UserDeletionRequest{deletionRequestTime = Core.Nothing,
                        firebaseProjectId = Core.Nothing, id = Core.Nothing,
                        kind = "analytics#userDeletionRequest", propertyId = Core.Nothing,
                        webPropertyId = Core.Nothing}
instance Core.FromJSON UserDeletionRequest where
        parseJSON
          = Core.withObject "UserDeletionRequest"
              (\ o ->
                 UserDeletionRequest Core.<$>
                   (o Core..:? "deletionRequestTime") Core.<*>
                     (o Core..:? "firebaseProjectId")
                     Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "analytics#userDeletionRequest")
...
instance Core.ToJSON UserDeletionRequest where
        toJSON UserDeletionRequest{..}
          = Core.object
              (Core.catMaybes
                 [("deletionRequestTime" Core..=) Core.<$> deletionRequestTime,
                  ("firebaseProjectId" Core..=) Core.<$> firebaseProjectId,
                  ("id" Core..=) Core.<$> id, Core.Just ("kind" Core..= kind),
...
newUserDeletionRequest_Id 
    ::  UserDeletionRequest_Id
newUserDeletionRequest_Id
  = UserDeletionRequest_Id{type' = Core.Nothing,
                           userId = Core.Nothing}
instance Core.FromJSON UserDeletionRequest_Id where
        parseJSON
          = Core.withObject "UserDeletionRequest_Id"
              (\ o ->
                 UserDeletionRequest_Id Core.<$>
                   (o Core..:? "type") Core.<*> (o Core..:? "userId"))
...
newUserRef 
    ::  UserRef
newUserRef
  = UserRef{email = Core.Nothing, id = Core.Nothing,
            kind = "analytics#userRef"}
instance Core.FromJSON UserRef where
        parseJSON
          = Core.withObject "UserRef"
              (\ o ->
                 UserRef Core.<$>
                   (o Core..:? "email") Core.<*> (o Core..:? "id") Core.<*>
                     (o Core..:? "kind" Core..!= "analytics#userRef"))

instance Core.ToJSON UserRef where
        toJSON UserRef{..}
          = Core.object
              (Core.catMaybes
                 [("email" Core..=) Core.<$> email, ("id" Core..=) Core.<$> id,
                  Core.Just ("kind" Core..= kind)])
...
newWebPropertyRef 
    ::  WebPropertyRef
newWebPropertyRef
  = WebPropertyRef{accountId = Core.Nothing, href = Core.Nothing,
                   id = Core.Nothing, internalWebPropertyId = Core.Nothing,
                   kind = "analytics#webPropertyRef", name = Core.Nothing}
instance Core.FromJSON WebPropertyRef where
        parseJSON
          = Core.withObject "WebPropertyRef"
              (\ o ->
                 WebPropertyRef Core.<$>
                   (o Core..:? "accountId") Core.<*> (o Core..:? "href") Core.<*>
                     (o Core..:? "id")
                     Core.<*> (o Core..:? "internalWebPropertyId")
                     Core.<*> (o Core..:? "kind" Core..!= "analytics#webPropertyRef")
                     Core.<*> (o Core..:? "name"))
...
newWebPropertySummary 
    ::  WebPropertySummary
newWebPropertySummary
  = WebPropertySummary{id = Core.Nothing,
                       internalWebPropertyId = Core.Nothing,
                       kind = "analytics#webPropertySummary", level = Core.Nothing,
                       name = Core.Nothing, profiles = Core.Nothing,
                       starred = Core.Nothing, websiteUrl = Core.Nothing}
instance Core.FromJSON WebPropertySummary where
        parseJSON
          = Core.withObject "WebPropertySummary"
              (\ o ->
                 WebPropertySummary Core.<$>
                   (o Core..:? "id") Core.<*> (o Core..:? "internalWebPropertyId")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "analytics#webPropertySummary")
                     Core.<*> (o Core..:? "level")
                     Core.<*> (o Core..:? "name")
        ...
        toJSON WebPropertySummary{..}
          = Core.object
              (Core.catMaybes
                 [("id" Core..=) Core.<$> id,
                  ("internalWebPropertyId" Core..=) Core.<$> internalWebPropertyId,
                  Core.Just ("kind" Core..= kind), ("level" Core..=) Core.<$> level,
                  ("name" Core..=) Core.<$> name,
...
newWebproperties 
    ::  Webproperties
newWebproperties
  = Webproperties{items = Core.Nothing, itemsPerPage = Core.Nothing,
                  kind = "analytics#webproperties", nextLink = Core.Nothing,
                  previousLink = Core.Nothing, startIndex = Core.Nothing,
                  totalResults = Core.Nothing, username = Core.Nothing}
instance Core.FromJSON Webproperties where
        parseJSON
          = Core.withObject "Webproperties"
              (\ o ->
                 Webproperties Core.<$>
                   (o Core..:? "items") Core.<*> (o Core..:? "itemsPerPage") Core.<*>
                     (o Core..:? "kind" Core..!= "analytics#webproperties")
                     Core.<*> (o Core..:? "nextLink")
                     Core.<*> (o Core..:? "previousLink")
                     Core.<*> (o Core..:? "startIndex")
                     Core.<*> (o Core..:? "totalResults")
...
newWebproperty 
    ::  Webproperty
newWebproperty
  = Webproperty{accountId = Core.Nothing, childLink = Core.Nothing,
                created = Core.Nothing,
                dataRetentionResetOnNewActivity = Core.Nothing,
                dataRetentionTtl = Core.Nothing, defaultProfileId = Core.Nothing,
                id = Core.Nothing, industryVertical = Core.Nothing,
                internalWebPropertyId = Core.Nothing,
                kind = "analytics#webproperty", level = Core.Nothing,
                name = Core.Nothing, parentLink = Core.Nothing,
                permissions = Core.Nothing, profileCount = Core.Nothing,
                selfLink = Core.Nothing, starred = Core.Nothing,
                updated = Core.Nothing, websiteUrl = Core.Nothing}
instance Core.FromJSON Webproperty where
        parseJSON
          = Core.withObject "Webproperty"
              (\ o ->
                 Webproperty Core.<$>
                   (o Core..:? "accountId") Core.<*> (o Core..:? "childLink") Core.<*>
                     (o Core..:? "created")
                     ...
                     Core.<*>
                     (o Core..:? "defaultProfileId" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "id")
          ...
          = Core.object
              (Core.catMaybes
                 [("accountId" Core..=) Core.<$> accountId,
                  ("childLink" Core..=) Core.<$> childLink,
                  ("created" Core..=) Core.<$> created,
                  ("dataRetentionResetOnNewActivity" Core..=) Core.<$>
                    dataRetentionResetOnNewActivity,
                  ("dataRetentionTtl" Core..=) Core.<$> dataRetentionTtl,
                  ("defaultProfileId" Core..=) Core.. Core.AsText Core.<$>
                    defaultProfileId,
                  ("id" Core..=) Core.<$> id,
                  ("industryVertical" Core..=) Core.<$> industryVertical,
                  ("internalWebPropertyId" Core..=) Core.<$> internalWebPropertyId,
                  Core.Just ("kind" Core..= kind), ("level" Core..=) Core.<$> level,
                  ("name" Core..=) Core.<$> name,
                  ("parentLink" Core..=) Core.<$> parentLink,
...
newWebproperty_ChildLink 
    ::  Webproperty_ChildLink
newWebproperty_ChildLink
  = Webproperty_ChildLink{href = Core.Nothing,
                          type' = "analytics#profiles"}
instance Core.FromJSON Webproperty_ChildLink where
        parseJSON
          = Core.withObject "Webproperty_ChildLink"
              (\ o ->
                 Webproperty_ChildLink Core.<$>
                   (o Core..:? "href") Core.<*>
                     (o Core..:? "type" Core..!= "analytics#profiles"))
...
newWebproperty_ParentLink 
    ::  Webproperty_ParentLink
newWebproperty_ParentLink
  = Webproperty_ParentLink{href = Core.Nothing,
                           type' = "analytics#account"}
instance Core.FromJSON Webproperty_ParentLink where
        parseJSON
          = Core.withObject "Webproperty_ParentLink"
              (\ o ->
                 Webproperty_ParentLink Core.<$>
                   (o Core..:? "href") Core.<*>
                     (o Core..:? "type" Core..!= "analytics#account"))
...
newWebproperty_Permissions 
    ::  Webproperty_Permissions
newWebproperty_Permissions
  = Webproperty_Permissions{effective = Core.Nothing}
instance Core.FromJSON Webproperty_Permissions where
        parseJSON
          = Core.withObject "Webproperty_Permissions"
              (\ o -> Webproperty_Permissions Core.<$> (o Core..:? "effective"))
