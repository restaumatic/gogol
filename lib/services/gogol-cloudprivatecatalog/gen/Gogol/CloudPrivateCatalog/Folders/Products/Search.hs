...
newCloudPrivateCatalogFoldersProductsSearch resource
  = CloudPrivateCatalogFoldersProductsSearch{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        requestClient CloudPrivateCatalogFoldersProductsSearch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudPrivateCatalogFoldersProductsSearchResource)
                      Core.mempty
