...
type CloudPrivateCatalogFoldersVersionsSearchResource =
     "v1beta1" Core.:>
       Core.Capture "resource" Core.Text Core.:>
         "versions:search" Core.:>
...
-- | Search Version resources that consumers have access to, within the scope of the consumer cloud resource hierarchy context.
--
-- /See:/ 'newCloudPrivateCatalogFoldersVersionsSearch' smart constructor.
data CloudPrivateCatalogFoldersVersionsSearch = CloudPrivateCatalogFoldersVersionsSearch
    {
      -- | V1 error format.
...
-- | Creates a value of 'CloudPrivateCatalogFoldersVersionsSearch' with the minimum fields required to make a request.
newCloudPrivateCatalogFoldersVersionsSearch 
    :: 
                                            Core.Text
       -- ^  Required. The name of the resource context. See SearchCatalogsRequest.resource for details. See 'resource'.
    -> CloudPrivateCatalogFoldersVersionsSearch
newCloudPrivateCatalogFoldersVersionsSearch resource
  = CloudPrivateCatalogFoldersVersionsSearch{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           CloudPrivateCatalogFoldersVersionsSearch
         where
        type Rs CloudPrivateCatalogFoldersVersionsSearch =
             GoogleCloudPrivatecatalogV1beta1SearchVersionsResponse
        type Scopes CloudPrivateCatalogFoldersVersionsSearch =
             '[CloudPlatform'FullControl]
        requestClient CloudPrivateCatalogFoldersVersionsSearch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudPrivateCatalogFoldersVersionsSearchResource)
                      Core.mempty
