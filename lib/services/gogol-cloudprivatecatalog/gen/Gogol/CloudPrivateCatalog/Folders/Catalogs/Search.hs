...
newCloudPrivateCatalogFoldersCatalogsSearch resource
  = CloudPrivateCatalogFoldersCatalogsSearch{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        requestClient CloudPrivateCatalogFoldersCatalogsSearch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudPrivateCatalogFoldersCatalogsSearchResource)
                      Core.mempty
