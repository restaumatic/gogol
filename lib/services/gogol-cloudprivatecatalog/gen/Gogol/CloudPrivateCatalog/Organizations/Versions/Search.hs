...
newCloudPrivateCatalogOrganizationsVersionsSearch resource
  = CloudPrivateCatalogOrganizationsVersionsSearch{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           CloudPrivateCatalogOrganizationsVersionsSearch
         where
        type Rs CloudPrivateCatalogOrganizationsVersionsSearch =
             GoogleCloudPrivatecatalogV1beta1SearchVersionsResponse
        type Scopes CloudPrivateCatalogOrganizationsVersionsSearch =
             '[CloudPlatform'FullControl]
        requestClient CloudPrivateCatalogOrganizationsVersionsSearch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudPrivateCatalogOrganizationsVersionsSearchResource)
                      Core.mempty
