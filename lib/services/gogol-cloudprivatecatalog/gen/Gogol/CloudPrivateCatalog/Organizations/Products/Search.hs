...
newCloudPrivateCatalogOrganizationsProductsSearch resource
  = CloudPrivateCatalogOrganizationsProductsSearch{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           CloudPrivateCatalogOrganizationsProductsSearch
         where
        type Rs CloudPrivateCatalogOrganizationsProductsSearch =
             GoogleCloudPrivatecatalogV1beta1SearchProductsResponse
        type Scopes CloudPrivateCatalogOrganizationsProductsSearch =
             '[CloudPlatform'FullControl]
        requestClient CloudPrivateCatalogOrganizationsProductsSearch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudPrivateCatalogOrganizationsProductsSearchResource)
                      Core.mempty
