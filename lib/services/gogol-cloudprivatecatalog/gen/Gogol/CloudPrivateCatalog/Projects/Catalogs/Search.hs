...
newCloudPrivateCatalogProjectsCatalogsSearch resource
  = CloudPrivateCatalogProjectsCatalogsSearch{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           CloudPrivateCatalogProjectsCatalogsSearch
         where
        type Rs CloudPrivateCatalogProjectsCatalogsSearch =
             GoogleCloudPrivatecatalogV1beta1SearchCatalogsResponse
        type Scopes CloudPrivateCatalogProjectsCatalogsSearch =
             '[CloudPlatform'FullControl]
        requestClient CloudPrivateCatalogProjectsCatalogsSearch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudPrivateCatalogProjectsCatalogsSearchResource)
                      Core.mempty
