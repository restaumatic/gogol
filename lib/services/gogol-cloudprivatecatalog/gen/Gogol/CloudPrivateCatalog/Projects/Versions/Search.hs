...
-- |
-- Module      : Gogol.CloudPrivateCatalog.Projects.Versions.Search
...
newCloudPrivateCatalogProjectsVersionsSearch resource
  = CloudPrivateCatalogProjectsVersionsSearch{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           CloudPrivateCatalogProjectsVersionsSearch
         where
        type Rs CloudPrivateCatalogProjectsVersionsSearch =
             GoogleCloudPrivatecatalogV1beta1SearchVersionsResponse
        type Scopes CloudPrivateCatalogProjectsVersionsSearch =
             '[CloudPlatform'FullControl]
        requestClient CloudPrivateCatalogProjectsVersionsSearch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudPrivateCatalogProjectsVersionsSearchResource)
                      Core.mempty
