                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] RunMobileFriendlyTestRequest Core.:>
...
newSearchConsoleUrlTestingToolsMobileFriendlyTestRun payload
  = SearchConsoleUrlTestingToolsMobileFriendlyTestRun{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           SearchConsoleUrlTestingToolsMobileFriendlyTestRun
         where
        type Rs SearchConsoleUrlTestingToolsMobileFriendlyTestRun =
