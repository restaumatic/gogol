...
--
-- /See:/ <https://developers.google.com/webmaster-tools/about Google Search Console API Reference> for @webmasters.sitemaps.get@.
module Gogol.SearchConsole.Webmasters.Sitemaps.Get
    (
    -- * Resource
...
newWebmastersSitemapsGet feedpath siteUrl
  = WebmastersSitemapsGet{xgafv = Core.Nothing,
