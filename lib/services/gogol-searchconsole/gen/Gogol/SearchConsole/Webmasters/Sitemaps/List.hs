...
--
-- /See:/ <https://developers.google.com/webmaster-tools/about Google Search Console API Reference> for @webmasters.sitemaps.list@.
module Gogol.SearchConsole.Webmasters.Sitemaps.List
    (
    -- * Resource
...
newWebmastersSitemapsList siteUrl
  = WebmastersSitemapsList{xgafv = Core.Nothing,
                           accessToken = Core.Nothing, callback = Core.Nothing,
                           siteUrl = siteUrl, sitemapIndex = Core.Nothing,
...
instance Core.GoogleRequest WebmastersSitemapsList where
        ...
        requestClient WebmastersSitemapsList{..}
          = go siteUrl xgafv accessToken callback sitemapIndex uploadType
              uploadProtocol
              (Core.Just Core.AltJSON)
              searchConsoleService
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy WebmastersSitemapsListResource)
                      Core.mempty
