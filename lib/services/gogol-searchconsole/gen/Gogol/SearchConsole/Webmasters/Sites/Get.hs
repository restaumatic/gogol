...
--
-- /See:/ <https://developers.google.com/webmaster-tools/about Google Search Console API Reference> for @webmasters.sites.get@.
module Gogol.SearchConsole.Webmasters.Sites.Get
    (
    -- * Resource
...
newWebmastersSitesGet siteUrl
  = WebmastersSitesGet{xgafv = Core.Nothing,
