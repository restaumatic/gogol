...
--
-- /See:/ <https://developers.google.com/webmaster-tools/about Google Search Console API Reference> for @webmasters.sites.add@.
module Gogol.SearchConsole.Webmasters.Sites.Add
    (
    -- * Resource
                 ...
                 Core.QueryParam "callback" Core.Text Core.:>
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:> Core.Put '[Core.JSON] ()
...
newWebmastersSitesAdd siteUrl
  = WebmastersSitesAdd{xgafv = Core.Nothing,
