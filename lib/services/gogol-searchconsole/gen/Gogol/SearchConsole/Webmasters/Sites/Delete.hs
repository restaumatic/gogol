...
--
-- /See:/ <https://developers.google.com/webmaster-tools/about Google Search Console API Reference> for @webmasters.sites.delete@.
module Gogol.SearchConsole.Webmasters.Sites.Delete
    (
    -- * Resource
...
newWebmastersSitesDelete siteUrl
  = WebmastersSitesDelete{xgafv = Core.Nothing,
                          accessToken = Core.Nothing, callback = Core.Nothing,
                          siteUrl = siteUrl, uploadType = Core.Nothing,
                          uploadProtocol = Core.Nothing}
instance Core.GoogleRequest WebmastersSitesDelete where
        type Rs WebmastersSitesDelete = ()
        type Scopes WebmastersSitesDelete = '[Webmasters'FullControl]
        requestClient WebmastersSitesDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy WebmastersSitesDeleteResource)
                      Core.mempty
