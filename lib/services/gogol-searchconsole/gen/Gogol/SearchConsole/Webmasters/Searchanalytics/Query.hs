...
--
-- /See:/ <https://developers.google.com/webmaster-tools/about Google Search Console API Reference> for @webmasters.searchanalytics.query@.
module Gogol.SearchConsole.Webmasters.Searchanalytics.Query
    (
    -- * Resource
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] SearchAnalyticsQueryRequest Core.:>
                               Core.Post '[Core.JSON] SearchAnalyticsQueryResponse
...
newWebmastersSearchanalyticsQuery payload siteUrl
  = WebmastersSearchanalyticsQuery{xgafv = Core.Nothing,
                                   accessToken = Core.Nothing, callback = Core.Nothing,
                                   payload = payload, siteUrl = siteUrl, uploadType = Core.Nothing,
...
instance Core.GoogleRequest WebmastersSearchanalyticsQuery where
        ...
        requestClient WebmastersSearchanalyticsQuery{..}
          = go siteUrl xgafv accessToken callback uploadType uploadProtocol
