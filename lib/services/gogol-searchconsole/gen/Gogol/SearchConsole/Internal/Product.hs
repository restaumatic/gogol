...
data Metadata = Metadata
    {
      ...
      firstIncompleteDate :: (Core.Maybe Core.Text)
    ...
    , firstIncompleteHour :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newMetadata 
    ::  Metadata
newMetadata
  = Metadata{firstIncompleteDate = Core.Nothing,
             firstIncompleteHour = Core.Nothing}
instance Core.FromJSON Metadata where
        parseJSON
          = Core.withObject "Metadata"
              (\ o ->
                 Metadata Core.<$>
                   (o Core..:? "firstIncompleteDate") Core.<*>
                     (o Core..:? "firstIncompleteHour"))

instance Core.ToJSON Metadata where
        toJSON Metadata{..}
          = Core.object
              (Core.catMaybes
                 [("firstIncompleteDate" Core..=) Core.<$> firstIncompleteDate,
                  ("firstIncompleteHour" Core..=) Core.<$> firstIncompleteHour])
...
newSearchAnalyticsQueryResponse 
    ::  SearchAnalyticsQueryResponse
newSearchAnalyticsQueryResponse
  = SearchAnalyticsQueryResponse{metadata = Core.Nothing,
              ...
              (\ o ->
                 SearchAnalyticsQueryResponse Core.<$>
                   (o Core..:? "metadata") Core.<*>
                     (o Core..:? "responseAggregationType")
                     Core.<*> (o Core..:? "rows"))
