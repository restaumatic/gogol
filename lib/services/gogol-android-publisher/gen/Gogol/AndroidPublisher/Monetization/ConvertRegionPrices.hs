       ...
       "v3" Core.:>
         "applications" Core.:>
           Core.Capture "packageName" Core.Text Core.:>
             "pricing:convertRegionPrices" Core.:>
                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] ConvertRegionPricesRequest Core.:>
                             Core.Post '[Core.JSON] ConvertRegionPricesResponse
...
newAndroidPublisherMonetizationConvertRegionPrices 
    ...
    -> AndroidPublisherMonetizationConvertRegionPrices
newAndroidPublisherMonetizationConvertRegionPrices packageName
  payload
  = AndroidPublisherMonetizationConvertRegionPrices{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           AndroidPublisherMonetizationConvertRegionPrices
         where
        type Rs AndroidPublisherMonetizationConvertRegionPrices =
             ConvertRegionPricesResponse
        type Scopes AndroidPublisherMonetizationConvertRegionPrices =
