                               ...
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.Get '[Core.JSON] SubscriptionOffer
...
newAndroidPublisherMonetizationSubscriptionsBasePlansOffersGet
  ...
  = AndroidPublisherMonetizationSubscriptionsBasePlansOffersGet{xgafv
                                                                  = Core.Nothing,
...
instance Core.GoogleRequest
           AndroidPublisherMonetizationSubscriptionsBasePlansOffersGet
         where
        type Rs AndroidPublisherMonetizationSubscriptionsBasePlansOffersGet
             = SubscriptionOffer
        type Scopes
               AndroidPublisherMonetizationSubscriptionsBasePlansOffersGet
