...
newAndroidPublisherMonetizationSubscriptionsGet 
    ...
    -> AndroidPublisherMonetizationSubscriptionsGet
newAndroidPublisherMonetizationSubscriptionsGet packageName
  productId
  = AndroidPublisherMonetizationSubscriptionsGet{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes AndroidPublisherMonetizationSubscriptionsGet =
