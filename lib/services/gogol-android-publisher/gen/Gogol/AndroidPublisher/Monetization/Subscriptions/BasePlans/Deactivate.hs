           ...
           Core.Capture "packageName" Core.Text Core.:>
             "subscriptions" Core.:>
               Core.Capture "productId" Core.Text Core.:>
                 "basePlans" Core.:>
                   Core.CaptureMode "basePlanId" "deactivate" Core.Text Core.:>
                           ...
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.ReqBody '[Core.JSON] DeactivateBasePlanRequest Core.:>
...
newAndroidPublisherMonetizationSubscriptionsBasePlansDeactivate
  ...
  = AndroidPublisherMonetizationSubscriptionsBasePlansDeactivate{xgafv
                                                                   = Core.Nothing,
