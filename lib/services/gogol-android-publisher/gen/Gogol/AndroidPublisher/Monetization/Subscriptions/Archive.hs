       ...
       "v3" Core.:>
         "applications" Core.:>
           Core.Capture "packageName" Core.Text Core.:>
             "subscriptions" Core.:>
               Core.CaptureMode "productId" "archive" Core.Text Core.:>
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] ArchiveSubscriptionRequest Core.:>
...
newAndroidPublisherMonetizationSubscriptionsArchive 
    ...
    -> AndroidPublisherMonetizationSubscriptionsArchive
newAndroidPublisherMonetizationSubscriptionsArchive packageName
  payload productId
  = AndroidPublisherMonetizationSubscriptionsArchive{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           AndroidPublisherMonetizationSubscriptionsArchive
         where
        type Rs AndroidPublisherMonetizationSubscriptionsArchive =
             Subscription
        type Scopes AndroidPublisherMonetizationSubscriptionsArchive =
