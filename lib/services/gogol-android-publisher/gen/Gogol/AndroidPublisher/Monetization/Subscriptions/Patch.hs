...
newAndroidPublisherMonetizationSubscriptionsPatch 
    ...
    -> AndroidPublisherMonetizationSubscriptionsPatch
newAndroidPublisherMonetizationSubscriptionsPatch packageName
  payload productId
  = AndroidPublisherMonetizationSubscriptionsPatch{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           AndroidPublisherMonetizationSubscriptionsPatch
         where
        type Rs AndroidPublisherMonetizationSubscriptionsPatch =
             Subscription
        type Scopes AndroidPublisherMonetizationSubscriptionsPatch =
