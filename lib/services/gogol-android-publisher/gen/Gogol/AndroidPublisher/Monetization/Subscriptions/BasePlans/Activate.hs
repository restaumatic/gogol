           ...
           Core.Capture "packageName" Core.Text Core.:>
             "subscriptions" Core.:>
               Core.Capture "productId" Core.Text Core.:>
                 "basePlans" Core.:>
                   Core.CaptureMode "basePlanId" "activate" Core.Text Core.:>
                           ...
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.ReqBody '[Core.JSON] ActivateBasePlanRequest Core.:>
...
newAndroidPublisherMonetizationSubscriptionsBasePlansActivate 
    ...
    -> AndroidPublisherMonetizationSubscriptionsBasePlansActivate
newAndroidPublisherMonetizationSubscriptionsBasePlansActivate
  basePlanId packageName payload productId
  = AndroidPublisherMonetizationSubscriptionsBasePlansActivate{xgafv
                                                                 = Core.Nothing,
...
instance Core.GoogleRequest
           AndroidPublisherMonetizationSubscriptionsBasePlansActivate
         where
        type Rs AndroidPublisherMonetizationSubscriptionsBasePlansActivate
             = Subscription
        type Scopes
               AndroidPublisherMonetizationSubscriptionsBasePlansActivate
        ...
        requestClient
          AndroidPublisherMonetizationSubscriptionsBasePlansActivate{..}
          = go packageName productId basePlanId xgafv accessToken callback
              uploadType
              uploadProtocol
