           ...
           Core.Capture "packageName" Core.Text Core.:>
             "subscriptions" Core.:>
               Core.Capture "productId" Core.Text Core.:>
                 "basePlans:batchMigratePrices" Core.:>
                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.ReqBody '[Core.JSON] BatchMigrateBasePlanPricesRequest Core.:>
                                 Core.Post '[Core.JSON] BatchMigrateBasePlanPricesResponse
...
newAndroidPublisherMonetizationSubscriptionsBasePlansBatchMigratePrices
  ...
  = AndroidPublisherMonetizationSubscriptionsBasePlansBatchMigratePrices{xgafv
                                                                           = Core.Nothing,
