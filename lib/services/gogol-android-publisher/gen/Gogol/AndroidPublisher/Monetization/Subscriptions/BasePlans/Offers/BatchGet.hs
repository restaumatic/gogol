                             ...
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.ReqBody '[Core.JSON] BatchGetSubscriptionOffersRequest
                                     Core.:>
                                     Core.Post '[Core.JSON] BatchGetSubscriptionOffersResponse
...
newAndroidPublisherMonetizationSubscriptionsBasePlansOffersBatchGet
  ...
  = AndroidPublisherMonetizationSubscriptionsBasePlansOffersBatchGet{xgafv
                                                                       = Core.Nothing,
