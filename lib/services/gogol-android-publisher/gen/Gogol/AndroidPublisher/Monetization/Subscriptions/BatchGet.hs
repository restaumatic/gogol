                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] BatchGetSubscriptionsResponse
...
newAndroidPublisherMonetizationSubscriptionsBatchGet packageName
  = AndroidPublisherMonetizationSubscriptionsBatchGet{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           AndroidPublisherMonetizationSubscriptionsBatchGet
         where
        type Rs AndroidPublisherMonetizationSubscriptionsBatchGet =
             BatchGetSubscriptionsResponse
        type Scopes AndroidPublisherMonetizationSubscriptionsBatchGet =
