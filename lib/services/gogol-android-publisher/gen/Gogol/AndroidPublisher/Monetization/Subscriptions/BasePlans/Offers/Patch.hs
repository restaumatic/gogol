                                       ...
                                       Core.QueryParam "uploadType" Core.Text Core.:>
                                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                                           Core.QueryParam "alt" Core.AltJSON Core.:>
                                             Core.ReqBody '[Core.JSON] SubscriptionOffer Core.:>
                                               Core.Patch '[Core.JSON] SubscriptionOffer
...
newAndroidPublisherMonetizationSubscriptionsBasePlansOffersPatch 
    ...
    -> AndroidPublisherMonetizationSubscriptionsBasePlansOffersPatch
newAndroidPublisherMonetizationSubscriptionsBasePlansOffersPatch
  basePlanId offerId packageName payload productId
  = AndroidPublisherMonetizationSubscriptionsBasePlansOffersPatch{xgafv
                                                                    = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        requestClient
          AndroidPublisherMonetizationSubscriptionsBasePlansOffersPatch{..}
          = go packageName productId basePlanId offerId xgafv accessToken
              allowMissing
              callback
              latencyTolerance
              regionsVersionVersion
