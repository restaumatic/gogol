...
newAndroidPublisherMonetizationSubscriptionsDelete 
    ...
    -> AndroidPublisherMonetizationSubscriptionsDelete
newAndroidPublisherMonetizationSubscriptionsDelete packageName
  productId
  = AndroidPublisherMonetizationSubscriptionsDelete{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes AndroidPublisherMonetizationSubscriptionsDelete =
