                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] BatchUpdateSubscriptionsRequest Core.:>
                             Core.Post '[Core.JSON] BatchUpdateSubscriptionsResponse
...
newAndroidPublisherMonetizationSubscriptionsBatchUpdate 
    ...
    -> AndroidPublisherMonetizationSubscriptionsBatchUpdate
newAndroidPublisherMonetizationSubscriptionsBatchUpdate packageName
  payload
  = AndroidPublisherMonetizationSubscriptionsBatchUpdate{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           AndroidPublisherMonetizationSubscriptionsBatchUpdate
         where
        type Rs AndroidPublisherMonetizationSubscriptionsBatchUpdate =
             BatchUpdateSubscriptionsResponse
        type Scopes AndroidPublisherMonetizationSubscriptionsBatchUpdate =
