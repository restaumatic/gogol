...
newAndroidPublisherMonetizationSubscriptionsCreate 
    ...
    -> AndroidPublisherMonetizationSubscriptionsCreate
newAndroidPublisherMonetizationSubscriptionsCreate packageName
  payload
  = AndroidPublisherMonetizationSubscriptionsCreate{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           AndroidPublisherMonetizationSubscriptionsCreate
         where
        type Rs AndroidPublisherMonetizationSubscriptionsCreate =
             Subscription
        type Scopes AndroidPublisherMonetizationSubscriptionsCreate =
