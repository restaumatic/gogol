                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.ReqBody '[Core.JSON] BatchUpdateBasePlanStatesRequest Core.:>
                                 Core.Post '[Core.JSON] BatchUpdateBasePlanStatesResponse
...
newAndroidPublisherMonetizationSubscriptionsBasePlansBatchUpdateStates
  ...
  = AndroidPublisherMonetizationSubscriptionsBasePlansBatchUpdateStates{xgafv
                                                                          = Core.Nothing,
