                   ...
                   Core.QueryParam "access_token" Core.Text Core.:>
                     Core.QueryParam "callback" Core.Text Core.:>
                       Core.QueryParam "endTime" Core.Int64 Core.:>
                         Core.QueryParam "includeQuantityBasedPartialRefund" Core.Bool
                           Core.:>
                                     ...
                                     Core.QueryParam "uploadType" Core.Text Core.:>
                                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                                         Core.QueryParam "alt" Core.AltJSON Core.:>
                                           Core.Get '[Core.JSON] VoidedPurchasesListResponse
...
newAndroidPublisherPurchasesVoidedpurchasesList packageName
  = AndroidPublisherPurchasesVoidedpurchasesList{xgafv =
                                                   Core.Nothing,
                                                 ...
                                                 startTime = Core.Nothing, token = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes AndroidPublisherPurchasesVoidedpurchasesList =
