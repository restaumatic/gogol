             ...
             "purchases" Core.:>
               "products" Core.:>
                 Core.Capture "productId" Core.Text Core.:>
                   "tokens" Core.:>
                     Core.CaptureMode "token" "consume" Core.Text Core.:>
...
newAndroidPublisherPurchasesProductsConsume 
    ...
    -> AndroidPublisherPurchasesProductsConsume
newAndroidPublisherPurchasesProductsConsume packageName productId
  token
  = AndroidPublisherPurchasesProductsConsume{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes AndroidPublisherPurchasesProductsConsume =
