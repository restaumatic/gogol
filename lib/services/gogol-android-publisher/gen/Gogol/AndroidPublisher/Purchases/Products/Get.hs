                             ...
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.Get '[Core.JSON] ProductPurchase
...
newAndroidPublisherPurchasesProductsGet packageName productId token
  = AndroidPublisherPurchasesProductsGet{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         packageName = packageName, productId = productId,
                                         token = token, uploadType = Core.Nothing,
                                         uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AndroidPublisherPurchasesProductsGet
         where
        type Rs AndroidPublisherPurchasesProductsGet = ProductPurchase
        type Scopes AndroidPublisherPurchasesProductsGet =
