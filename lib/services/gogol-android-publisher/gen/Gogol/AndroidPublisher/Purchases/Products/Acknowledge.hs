             ...
             "purchases" Core.:>
               "products" Core.:>
                 Core.Capture "productId" Core.Text Core.:>
                   "tokens" Core.:>
                     Core.CaptureMode "token" "acknowledge" Core.Text Core.:>
                             ...
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.ReqBody '[Core.JSON] ProductPurchasesAcknowledgeRequest
...
newAndroidPublisherPurchasesProductsAcknowledge 
    ...
    -> AndroidPublisherPurchasesProductsAcknowledge
newAndroidPublisherPurchasesProductsAcknowledge packageName payload
  productId token
  = AndroidPublisherPurchasesProductsAcknowledge{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes AndroidPublisherPurchasesProductsAcknowledge =
             '[Androidpublisher'FullControl]
        requestClient AndroidPublisherPurchasesProductsAcknowledge{..}
          = go packageName productId token xgafv accessToken callback
              uploadType
              uploadProtocol
