                             ...
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.ReqBody '[Core.JSON] SubscriptionPurchasesAcknowledgeRequest
...
newAndroidPublisherPurchasesSubscriptionsAcknowledge 
    ...
    -> AndroidPublisherPurchasesSubscriptionsAcknowledge
newAndroidPublisherPurchasesSubscriptionsAcknowledge packageName
  payload subscriptionId token
  = AndroidPublisherPurchasesSubscriptionsAcknowledge{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes AndroidPublisherPurchasesSubscriptionsAcknowledge =
