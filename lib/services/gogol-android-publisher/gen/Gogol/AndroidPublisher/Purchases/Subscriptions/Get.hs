                             ...
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.Get '[Core.JSON] SubscriptionPurchase
...
newAndroidPublisherPurchasesSubscriptionsGet 
    ...
    -> AndroidPublisherPurchasesSubscriptionsGet
newAndroidPublisherPurchasesSubscriptionsGet packageName
  subscriptionId token
  = AndroidPublisherPurchasesSubscriptionsGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           AndroidPublisherPurchasesSubscriptionsGet
         where
        type Rs AndroidPublisherPurchasesSubscriptionsGet =
             SubscriptionPurchase
        type Scopes AndroidPublisherPurchasesSubscriptionsGet =
