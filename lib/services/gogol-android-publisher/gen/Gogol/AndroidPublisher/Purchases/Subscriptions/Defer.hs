             ...
             "purchases" Core.:>
               "subscriptions" Core.:>
                 Core.Capture "subscriptionId" Core.Text Core.:>
                   "tokens" Core.:>
                     Core.CaptureMode "token" "defer" Core.Text Core.:>
                             ...
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.ReqBody '[Core.JSON] SubscriptionPurchasesDeferRequest
                                     Core.:>
                                     Core.Post '[Core.JSON] SubscriptionPurchasesDeferResponse
...
newAndroidPublisherPurchasesSubscriptionsDefer 
    ...
    -> AndroidPublisherPurchasesSubscriptionsDefer
newAndroidPublisherPurchasesSubscriptionsDefer packageName payload
  subscriptionId token
  = AndroidPublisherPurchasesSubscriptionsDefer{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           AndroidPublisherPurchasesSubscriptionsDefer
         where
        type Rs AndroidPublisherPurchasesSubscriptionsDefer =
             SubscriptionPurchasesDeferResponse
        type Scopes AndroidPublisherPurchasesSubscriptionsDefer =
