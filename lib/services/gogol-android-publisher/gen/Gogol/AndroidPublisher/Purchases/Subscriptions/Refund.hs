...
newAndroidPublisherPurchasesSubscriptionsRefund 
    ...
    -> AndroidPublisherPurchasesSubscriptionsRefund
newAndroidPublisherPurchasesSubscriptionsRefund packageName
  subscriptionId token
  = AndroidPublisherPurchasesSubscriptionsRefund{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes AndroidPublisherPurchasesSubscriptionsRefund =
