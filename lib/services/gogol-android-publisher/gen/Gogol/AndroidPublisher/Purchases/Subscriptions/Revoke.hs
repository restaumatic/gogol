...
newAndroidPublisherPurchasesSubscriptionsRevoke 
    ...
    -> AndroidPublisherPurchasesSubscriptionsRevoke
newAndroidPublisherPurchasesSubscriptionsRevoke packageName
  subscriptionId token
  = AndroidPublisherPurchasesSubscriptionsRevoke{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes AndroidPublisherPurchasesSubscriptionsRevoke =
