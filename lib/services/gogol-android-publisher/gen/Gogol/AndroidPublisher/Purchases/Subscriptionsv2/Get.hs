                           ...
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.Get '[Core.JSON] SubscriptionPurchaseV2
...
newAndroidPublisherPurchasesSubscriptionsv2Get packageName token
  = AndroidPublisherPurchasesSubscriptionsv2Get{xgafv = Core.Nothing,
                                                accessToken = Core.Nothing, callback = Core.Nothing,
                                                packageName = packageName, token = token,
                                                uploadType = Core.Nothing,
                                                uploadProtocol = Core.Nothing}
instance Core.GoogleRequest
           AndroidPublisherPurchasesSubscriptionsv2Get
         where
        type Rs AndroidPublisherPurchasesSubscriptionsv2Get =
             SubscriptionPurchaseV2
        type Scopes AndroidPublisherPurchasesSubscriptionsv2Get =
