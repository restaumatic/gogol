                           ...
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.ReqBody '[Core.JSON] RevokeSubscriptionPurchaseRequest Core.:>
                                   Core.Post '[Core.JSON] RevokeSubscriptionPurchaseResponse
...
newAndroidPublisherPurchasesSubscriptionsv2Revoke 
    ...
    -> AndroidPublisherPurchasesSubscriptionsv2Revoke
newAndroidPublisherPurchasesSubscriptionsv2Revoke packageName
  payload token
  = AndroidPublisherPurchasesSubscriptionsv2Revoke{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           AndroidPublisherPurchasesSubscriptionsv2Revoke
         where
        type Rs AndroidPublisherPurchasesSubscriptionsv2Revoke =
             RevokeSubscriptionPurchaseResponse
        type Scopes AndroidPublisherPurchasesSubscriptionsv2Revoke =
