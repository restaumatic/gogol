       ...
       "v3" Core.:>
         "applications" Core.:>
           Core.Capture "packageName" Core.Text Core.:>
             "edits" Core.:>
               Core.CaptureMode "editId" "commit" Core.Text Core.:>
                 Core.QueryParam "$.xgafv" Xgafv Core.:>
                   Core.QueryParam "access_token" Core.Text Core.:>
                     Core.QueryParam "callback" Core.Text Core.:>
                       Core.QueryParam "changesNotSentForReview" Core.Bool Core.:>
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Post '[Core.JSON] AppEdit
...
newAndroidPublisherEditsCommit editId packageName
  = AndroidPublisherEditsCommit{xgafv = Core.Nothing,
                                accessToken = Core.Nothing, callback = Core.Nothing,
                                changesNotSentForReview = Core.Nothing, editId = editId,
...
instance Core.GoogleRequest AndroidPublisherEditsCommit where
        ...
        type Scopes AndroidPublisherEditsCommit =
