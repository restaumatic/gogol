                 ...
                 "bundles" Core.:>
                   Core.QueryParam "$.xgafv" Xgafv Core.:>
                     Core.QueryParam "access_token" Core.Text Core.:>
                       Core.QueryParam "ackBundleInstallationWarning" Core.Bool Core.:>
                         Core.QueryParam "callback" Core.Text Core.:>
                           Core.QueryParam "deviceTierConfigId" Core.Text Core.:>
                                   ...
                                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                                     Core.QueryParam "alt" Core.AltJSON Core.:>
                                       Core.QueryParam "uploadType" Core.AltMedia Core.:>
                                         Core.AltMedia Core.:> Core.Post '[Core.JSON] Bundle
...
newAndroidPublisherEditsBundlesUpload editId packageName
  = AndroidPublisherEditsBundlesUpload{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing,
                                       ackBundleInstallationWarning = Core.Nothing,
                                       callback = Core.Nothing, deviceTierConfigId = Core.Nothing,
                                       editId = editId, packageName = packageName,
                                       uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AndroidPublisherEditsBundlesUpload
         where
...
instance Core.GoogleRequest
         ...
         where
        type Rs (Core.MediaUpload AndroidPublisherEditsBundlesUpload) =
             Bundle
        type Scopes (Core.MediaUpload AndroidPublisherEditsBundlesUpload) =
