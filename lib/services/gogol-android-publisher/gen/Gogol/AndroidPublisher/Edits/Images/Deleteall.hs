               ...
               Core.Capture "editId" Core.Text Core.:>
                 "listings" Core.:>
                   Core.Capture "language" Core.Text Core.:>
                     Core.Capture "imageType" EditsImagesDeleteallImageType Core.:>
                             ...
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.Delete '[Core.JSON] ImagesDeleteAllResponse
...
newAndroidPublisherEditsImagesDeleteall 
    ...
    -> AndroidPublisherEditsImagesDeleteall
newAndroidPublisherEditsImagesDeleteall editId imageType language
  packageName
  = AndroidPublisherEditsImagesDeleteall{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         editId = editId, imageType = imageType,
                                         language = language, packageName = packageName,
                                         uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AndroidPublisherEditsImagesDeleteall
         where
        type Rs AndroidPublisherEditsImagesDeleteall =
             ImagesDeleteAllResponse
        type Scopes AndroidPublisherEditsImagesDeleteall =
