               ...
               Core.Capture "editId" Core.Text Core.:>
                 "listings" Core.:>
                   Core.Capture "language" Core.Text Core.:>
                     Core.Capture "imageType" EditsImagesListImageType Core.:>
                             ...
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.Get '[Core.JSON] ImagesListResponse
...
newAndroidPublisherEditsImagesList 
    ...
    -> AndroidPublisherEditsImagesList
newAndroidPublisherEditsImagesList editId imageType language
  packageName
  = AndroidPublisherEditsImagesList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest AndroidPublisherEditsImagesList where
        ...
        type Scopes AndroidPublisherEditsImagesList =
