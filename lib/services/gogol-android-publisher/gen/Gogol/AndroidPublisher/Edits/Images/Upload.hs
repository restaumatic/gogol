           ...
           Core.Capture "packageName" Core.Text Core.:>
             "edits" Core.:>
               Core.Capture "editId" Core.Text Core.:>
                 "listings" Core.:>
                   Core.Capture "language" Core.Text Core.:>
                     Core.Capture "imageType" EditsImagesUploadImageType Core.:>
                             ...
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.Post '[Core.JSON] ImagesUploadResponse
       Core.:<|>
       "upload" Core.:>
         "androidpublisher" Core.:>
           "v3" Core.:>
...
newAndroidPublisherEditsImagesUpload 
    ...
    -> AndroidPublisherEditsImagesUpload
newAndroidPublisherEditsImagesUpload editId imageType language
  packageName
  = AndroidPublisherEditsImagesUpload{xgafv = Core.Nothing,
                                      accessToken = Core.Nothing, callback = Core.Nothing,
                                      editId = editId, imageType = imageType, language = language,
                                      packageName = packageName, uploadType = Core.Nothing,
...
instance Core.GoogleRequest AndroidPublisherEditsImagesUpload where
        ...
        type Scopes AndroidPublisherEditsImagesUpload =
             '[Androidpublisher'FullControl]
        requestClient AndroidPublisherEditsImagesUpload{..}
          = go packageName editId language imageType xgafv accessToken
              callback
              uploadType
              uploadProtocol
...
instance Core.GoogleRequest
         ...
         where
        type Rs (Core.MediaUpload AndroidPublisherEditsImagesUpload) =
             ImagesUploadResponse
        type Scopes (Core.MediaUpload AndroidPublisherEditsImagesUpload) =
