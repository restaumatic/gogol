               ...
               Core.Capture "editId" Core.Text Core.:>
                 "listings" Core.:>
                   Core.Capture "language" Core.Text Core.:>
                     Core.Capture "imageType" EditsImagesDeleteImageType Core.:>
                       Core.Capture "imageId" Core.Text Core.:>
...
newAndroidPublisherEditsImagesDelete 
    ...
    -> AndroidPublisherEditsImagesDelete
newAndroidPublisherEditsImagesDelete editId imageId imageType
  language packageName
  = AndroidPublisherEditsImagesDelete{xgafv = Core.Nothing,
                                      accessToken = Core.Nothing, callback = Core.Nothing,
                                      editId = editId, imageId = imageId, imageType = imageType,
...
instance Core.GoogleRequest AndroidPublisherEditsImagesDelete where
        ...
        type Scopes AndroidPublisherEditsImagesDelete =
             '[Androidpublisher'FullControl]
        requestClient AndroidPublisherEditsImagesDelete{..}
          = go packageName editId language imageType imageId xgafv
              accessToken
              callback
              uploadType
              uploadProtocol
