                               ...
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.Get '[Core.JSON] ExpansionFile
...
newAndroidPublisherEditsExpansionfilesGet 
    ...
    -> AndroidPublisherEditsExpansionfilesGet
newAndroidPublisherEditsExpansionfilesGet apkVersionCode editId
  expansionFileType packageName
  = AndroidPublisherEditsExpansionfilesGet{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing,
                                           apkVersionCode = apkVersionCode, callback = Core.Nothing,
                                           editId = editId, expansionFileType = expansionFileType,
                                           packageName = packageName, uploadType = Core.Nothing,
                                           uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AndroidPublisherEditsExpansionfilesGet
         where
        type Rs AndroidPublisherEditsExpansionfilesGet = ExpansionFile
        type Scopes AndroidPublisherEditsExpansionfilesGet =
             '[Androidpublisher'FullControl]
        requestClient AndroidPublisherEditsExpansionfilesGet{..}
          = go packageName editId apkVersionCode expansionFileType xgafv
              accessToken
              callback
              uploadType
              uploadProtocol
