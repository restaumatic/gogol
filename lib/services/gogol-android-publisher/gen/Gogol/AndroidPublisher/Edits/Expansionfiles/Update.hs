                               ...
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.ReqBody '[Core.JSON] ExpansionFile Core.:>
...
newAndroidPublisherEditsExpansionfilesUpdate 
    ...
    -> AndroidPublisherEditsExpansionfilesUpdate
newAndroidPublisherEditsExpansionfilesUpdate apkVersionCode editId
  expansionFileType packageName payload
  = AndroidPublisherEditsExpansionfilesUpdate{xgafv = Core.Nothing,
