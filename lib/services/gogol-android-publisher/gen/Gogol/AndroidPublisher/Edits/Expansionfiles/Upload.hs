                               ...
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.Post '[Core.JSON] ExpansionFilesUploadResponse
       Core.:<|>
       "upload" Core.:>
         "androidpublisher" Core.:>
           "v3" Core.:>
...
newAndroidPublisherEditsExpansionfilesUpload 
    ...
    -> AndroidPublisherEditsExpansionfilesUpload
newAndroidPublisherEditsExpansionfilesUpload apkVersionCode editId
  expansionFileType packageName
  = AndroidPublisherEditsExpansionfilesUpload{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           AndroidPublisherEditsExpansionfilesUpload
         where
        type Rs AndroidPublisherEditsExpansionfilesUpload =
             ExpansionFilesUploadResponse
        type Scopes AndroidPublisherEditsExpansionfilesUpload =
