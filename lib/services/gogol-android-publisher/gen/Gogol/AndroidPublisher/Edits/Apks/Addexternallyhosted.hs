                           ...
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.ReqBody '[Core.JSON] ApksAddExternallyHostedRequest Core.:>
                                   Core.Post '[Core.JSON] ApksAddExternallyHostedResponse
...
newAndroidPublisherEditsApksAddexternallyhosted 
    ...
    -> AndroidPublisherEditsApksAddexternallyhosted
newAndroidPublisherEditsApksAddexternallyhosted editId packageName
  payload
  = AndroidPublisherEditsApksAddexternallyhosted{xgafv =
                                                   Core.Nothing,
                                                 accessToken = Core.Nothing,
                                                 callback = Core.Nothing, editId = editId,
...
instance Core.GoogleRequest
           AndroidPublisherEditsApksAddexternallyhosted
         where
        type Rs AndroidPublisherEditsApksAddexternallyhosted =
             ApksAddExternallyHostedResponse
        type Scopes AndroidPublisherEditsApksAddexternallyhosted =
             '[Androidpublisher'FullControl]
        requestClient AndroidPublisherEditsApksAddexternallyhosted{..}
          = go packageName editId xgafv accessToken callback uploadType
              uploadProtocol
