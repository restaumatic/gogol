                               ...
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.QueryParam "uploadType" Core.AltMedia Core.:>
                                     Core.AltMedia Core.:> Core.Post '[Core.JSON] Apk
...
newAndroidPublisherEditsApksUpload editId packageName
  = AndroidPublisherEditsApksUpload{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes (Core.MediaUpload AndroidPublisherEditsApksUpload) =
