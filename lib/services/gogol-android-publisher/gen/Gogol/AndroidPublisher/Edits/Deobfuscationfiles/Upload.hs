                               ...
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.Post '[Core.JSON] DeobfuscationFilesUploadResponse
       Core.:<|>
       "upload" Core.:>
         "androidpublisher" Core.:>
           "v3" Core.:>
...
newAndroidPublisherEditsDeobfuscationfilesUpload 
    ...
    -> AndroidPublisherEditsDeobfuscationfilesUpload
newAndroidPublisherEditsDeobfuscationfilesUpload apkVersionCode
  deobfuscationFileType editId packageName
  = AndroidPublisherEditsDeobfuscationfilesUpload{xgafv =
                                                    Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes AndroidPublisherEditsDeobfuscationfilesUpload =
             '[Androidpublisher'FullControl]
        requestClient AndroidPublisherEditsDeobfuscationfilesUpload{..}
          = go packageName editId apkVersionCode deobfuscationFileType xgafv
              accessToken
              callback
              uploadType
              uploadProtocol
