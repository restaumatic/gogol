...
newAndroidPublisherEditsTracksPatch 
    ...
    -> AndroidPublisherEditsTracksPatch
newAndroidPublisherEditsTracksPatch editId packageName payload
  track
  = AndroidPublisherEditsTracksPatch{xgafv = Core.Nothing,
                                     accessToken = Core.Nothing, callback = Core.Nothing,
                                     editId = editId, packageName = packageName, payload = payload,
...
instance Core.GoogleRequest AndroidPublisherEditsTracksPatch where
        ...
        type Scopes AndroidPublisherEditsTracksPatch =
