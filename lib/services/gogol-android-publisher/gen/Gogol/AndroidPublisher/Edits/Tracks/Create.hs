                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.ReqBody '[Core.JSON] TrackConfig Core.:>
                                 Core.Post '[Core.JSON] Track
...
newAndroidPublisherEditsTracksCreate editId packageName payload
  = AndroidPublisherEditsTracksCreate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest AndroidPublisherEditsTracksCreate where
        ...
        type Scopes AndroidPublisherEditsTracksCreate =
