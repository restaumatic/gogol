                           ...
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.ReqBody '[Core.JSON] Track Core.:> Core.Put '[Core.JSON] Track
...
newAndroidPublisherEditsTracksUpdate 
    ...
    -> AndroidPublisherEditsTracksUpdate
newAndroidPublisherEditsTracksUpdate editId packageName payload
  track
  = AndroidPublisherEditsTracksUpdate{xgafv = Core.Nothing,
