...
newAndroidPublisherEditsTestersUpdate 
    ...
    -> AndroidPublisherEditsTestersUpdate
newAndroidPublisherEditsTestersUpdate editId packageName payload
  track
  = AndroidPublisherEditsTestersUpdate{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       editId = editId, packageName = packageName,
                                       payload = payload, track = track, uploadType = Core.Nothing,
                                       uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AndroidPublisherEditsTestersUpdate
         where
        type Rs AndroidPublisherEditsTestersUpdate = Testers
        type Scopes AndroidPublisherEditsTestersUpdate =
