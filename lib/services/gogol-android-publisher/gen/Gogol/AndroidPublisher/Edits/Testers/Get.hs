...
newAndroidPublisherEditsTestersGet editId packageName track
  = AndroidPublisherEditsTestersGet{xgafv = Core.Nothing,
                                    accessToken = Core.Nothing, callback = Core.Nothing,
                                    editId = editId, packageName = packageName, track = track,
...
instance Core.GoogleRequest AndroidPublisherEditsTestersGet where
        ...
        type Scopes AndroidPublisherEditsTestersGet =
