...
newAndroidPublisherEditsListingsDelete editId language packageName
  = AndroidPublisherEditsListingsDelete{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        editId = editId, language = language,
                                        packageName = packageName, uploadType = Core.Nothing,
                                        uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AndroidPublisherEditsListingsDelete
         where
        type Rs AndroidPublisherEditsListingsDelete = ()
        type Scopes AndroidPublisherEditsListingsDelete =
