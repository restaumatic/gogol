...
newAndroidPublisherEditsListingsPatch 
    ...
    -> AndroidPublisherEditsListingsPatch
newAndroidPublisherEditsListingsPatch editId language packageName
  payload
  = AndroidPublisherEditsListingsPatch{xgafv = Core.Nothing,
...
instance Core.GoogleRequest AndroidPublisherEditsListingsPatch
         where
        type Rs AndroidPublisherEditsListingsPatch = Listing
        type Scopes AndroidPublisherEditsListingsPatch =
