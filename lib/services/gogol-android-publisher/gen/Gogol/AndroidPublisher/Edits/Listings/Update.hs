                           ...
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.ReqBody '[Core.JSON] Listing Core.:>
                                   Core.Put '[Core.JSON] Listing
...
newAndroidPublisherEditsListingsUpdate 
    ...
    -> AndroidPublisherEditsListingsUpdate
newAndroidPublisherEditsListingsUpdate editId language packageName
  payload
  = AndroidPublisherEditsListingsUpdate{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        editId = editId, language = language,
                                        packageName = packageName, payload = payload,
                                        uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AndroidPublisherEditsListingsUpdate
         where
        type Rs AndroidPublisherEditsListingsUpdate = Listing
        type Scopes AndroidPublisherEditsListingsUpdate =
             '[Androidpublisher'FullControl]
        requestClient AndroidPublisherEditsListingsUpdate{..}
          = go packageName editId language xgafv accessToken callback
              uploadType
              uploadProtocol
