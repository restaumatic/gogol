                           ...
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.Get '[Core.JSON] TrackCountryAvailability
...
newAndroidPublisherEditsCountryavailabilityGet 
    ...
    -> AndroidPublisherEditsCountryavailabilityGet
newAndroidPublisherEditsCountryavailabilityGet editId packageName
  track
  = AndroidPublisherEditsCountryavailabilityGet{xgafv = Core.Nothing,
                                                accessToken = Core.Nothing, callback = Core.Nothing,
                                                editId = editId, packageName = packageName,
                                                track = track, uploadType = Core.Nothing,
                                                uploadProtocol = Core.Nothing}
instance Core.GoogleRequest
           AndroidPublisherEditsCountryavailabilityGet
         where
        type Rs AndroidPublisherEditsCountryavailabilityGet =
             TrackCountryAvailability
        type Scopes AndroidPublisherEditsCountryavailabilityGet =
             '[Androidpublisher'FullControl]
        requestClient AndroidPublisherEditsCountryavailabilityGet{..}
          = go packageName editId track xgafv accessToken callback uploadType
              uploadProtocol
