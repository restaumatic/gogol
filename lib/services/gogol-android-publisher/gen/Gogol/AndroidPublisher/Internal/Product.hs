...
--
-- /See:/ 'newActivateOneTimeProductOfferRequest' smart constructor.
data ActivateOneTimeProductOfferRequest = ActivateOneTimeProductOfferRequest
    {
      -- | Optional. The latency tolerance for the propagation of this update. Defaults to latency-sensitive.
      latencyTolerance :: (Core.Maybe ActivateOneTimeProductOfferRequest_LatencyTolerance)
    ...
    , purchaseOptionId :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'ActivateOneTimeProductOfferRequest' with the minimum fields required to make a request.
newActivateOneTimeProductOfferRequest 
    :: 
                                      ActivateOneTimeProductOfferRequest
newActivateOneTimeProductOfferRequest
  = ActivateOneTimeProductOfferRequest{latencyTolerance =
                                         Core.Nothing,
                                       offerId = Core.Nothing, packageName = Core.Nothing,
                                       productId = Core.Nothing, purchaseOptionId = Core.Nothing}
instance Core.FromJSON ActivateOneTimeProductOfferRequest where
        parseJSON
          = Core.withObject "ActivateOneTimeProductOfferRequest"
              (\ o ->
                 ActivateOneTimeProductOfferRequest Core.<$>
                   (o Core..:? "latencyTolerance") Core.<*> (o Core..:? "offerId")
                     Core.<*> (o Core..:? "packageName")
                     Core.<*> (o Core..:? "productId")
                     Core.<*> (o Core..:? "purchaseOptionId"))

instance Core.ToJSON ActivateOneTimeProductOfferRequest where
        toJSON ActivateOneTimeProductOfferRequest{..}
          = Core.object
              (Core.catMaybes
                 [("latencyTolerance" Core..=) Core.<$> latencyTolerance,
                  ...
                  ("packageName" Core..=) Core.<$> packageName,
                  ("productId" Core..=) Core.<$> productId,
                  ("purchaseOptionId" Core..=) Core.<$> purchaseOptionId])


-- | Request message for UpdatePurchaseOptionState.
--
-- /See:/ 'newActivatePurchaseOptionRequest' smart constructor.
data ActivatePurchaseOptionRequest = ActivatePurchaseOptionRequest
    {
      -- | Optional. The latency tolerance for the propagation of this product update. Defaults to latency-sensitive.
      latencyTolerance :: (Core.Maybe ActivatePurchaseOptionRequest_LatencyTolerance)
...
-- | Creates a value of 'ActivatePurchaseOptionRequest' with the minimum fields required to make a request.
newActivatePurchaseOptionRequest 
    ::  ActivatePurchaseOptionRequest
newActivatePurchaseOptionRequest
  = ActivatePurchaseOptionRequest{latencyTolerance = Core.Nothing,
                                  packageName = Core.Nothing, productId = Core.Nothing,
                                  purchaseOptionId = Core.Nothing}
instance Core.FromJSON ActivatePurchaseOptionRequest where
        parseJSON
          = Core.withObject "ActivatePurchaseOptionRequest"
              (\ o ->
                 ActivatePurchaseOptionRequest Core.<$>
                   (o Core..:? "latencyTolerance") Core.<*> (o Core..:? "packageName")
                     Core.<*> (o Core..:? "productId")
                     Core.<*> (o Core..:? "purchaseOptionId"))

instance Core.ToJSON ActivatePurchaseOptionRequest where
        toJSON ActivatePurchaseOptionRequest{..}
          = Core.object
              (Core.catMaybes
                 [("latencyTolerance" Core..=) Core.<$> latencyTolerance,
                  ("packageName" Core..=) Core.<$> packageName,
...
data AutoRenewingPlan = AutoRenewingPlan
    ...
    , priceStepUpConsentDetails :: (Core.Maybe PriceStepUpConsentDetails)
...
newAutoRenewingPlan
  = AutoRenewingPlan{autoRenewEnabled = Core.Nothing,
                     ...
                     priceStepUpConsentDetails = Core.Nothing,
              ...
              (\ o ->
                 AutoRenewingPlan Core.<$>
                   (o Core..:? "autoRenewEnabled") Core.<*>
                     ...
                     Core.<*> (o Core..:? "priceStepUpConsentDetails")
          ...
          = Core.object
              (Core.catMaybes
                 [("autoRenewEnabled" Core..=) Core.<$> autoRenewEnabled,
                  ...
                  ("priceStepUpConsentDetails" Core..=) Core.<$>
                    priceStepUpConsentDetails,
...
--
-- /See:/ 'newBatchDeleteOneTimeProductOffersRequest' smart constructor.
newtype BatchDeleteOneTimeProductOffersRequest = BatchDeleteOneTimeProductOffersRequest
    {
      -- | Required. A list of update requests of up to 100 elements. All requests must correspond to different offers.
      requests :: (Core.Maybe [DeleteOneTimeProductOfferRequest])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'BatchDeleteOneTimeProductOffersRequest' with the minimum fields required to make a request.
newBatchDeleteOneTimeProductOffersRequest 
    :: 
                                          BatchDeleteOneTimeProductOffersRequest
newBatchDeleteOneTimeProductOffersRequest
  = BatchDeleteOneTimeProductOffersRequest{requests = Core.Nothing}
instance Core.FromJSON BatchDeleteOneTimeProductOffersRequest where
        parseJSON
          = Core.withObject "BatchDeleteOneTimeProductOffersRequest"
              (\ o ->
                 BatchDeleteOneTimeProductOffersRequest Core.<$>
                   (o Core..:? "requests"))

instance Core.ToJSON BatchDeleteOneTimeProductOffersRequest where
        toJSON BatchDeleteOneTimeProductOffersRequest{..}
          = Core.object
...
--
-- /See:/ 'newBatchDeleteOneTimeProductsRequest' smart constructor.
newtype BatchDeleteOneTimeProductsRequest = BatchDeleteOneTimeProductsRequest
    {
      -- | Required. A list of delete requests of up to 100 elements. All requests must delete different one-time products.
      requests :: (Core.Maybe [DeleteOneTimeProductRequest])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'BatchDeleteOneTimeProductsRequest' with the minimum fields required to make a request.
newBatchDeleteOneTimeProductsRequest 
    :: 
                                     BatchDeleteOneTimeProductsRequest
newBatchDeleteOneTimeProductsRequest
  = BatchDeleteOneTimeProductsRequest{requests = Core.Nothing}
instance Core.FromJSON BatchDeleteOneTimeProductsRequest where
        parseJSON
          = Core.withObject "BatchDeleteOneTimeProductsRequest"
              (\ o ->
                 BatchDeleteOneTimeProductsRequest Core.<$> (o Core..:? "requests"))

instance Core.ToJSON BatchDeleteOneTimeProductsRequest where
        toJSON BatchDeleteOneTimeProductsRequest{..}
          = Core.object
              (Core.catMaybes [("requests" Core..=) Core.<$> requests])
...
--
-- /See:/ 'newBatchDeletePurchaseOptionsRequest' smart constructor.
newtype BatchDeletePurchaseOptionsRequest = BatchDeletePurchaseOptionsRequest
    {
      ...
      requests :: (Core.Maybe [DeletePurchaseOptionRequest])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'BatchDeletePurchaseOptionsRequest' with the minimum fields required to make a request.
newBatchDeletePurchaseOptionsRequest 
    :: 
                                     BatchDeletePurchaseOptionsRequest
newBatchDeletePurchaseOptionsRequest
  = BatchDeletePurchaseOptionsRequest{requests = Core.Nothing}
instance Core.FromJSON BatchDeletePurchaseOptionsRequest where
        parseJSON
          = Core.withObject "BatchDeletePurchaseOptionsRequest"
              (\ o ->
                 BatchDeletePurchaseOptionsRequest Core.<$> (o Core..:? "requests"))

instance Core.ToJSON BatchDeletePurchaseOptionsRequest where
        toJSON BatchDeletePurchaseOptionsRequest{..}
          = Core.object
              (Core.catMaybes [("requests" Core..=) Core.<$> requests])
...
--
-- /See:/ 'newBatchGetOneTimeProductOffersRequest' smart constructor.
newtype BatchGetOneTimeProductOffersRequest = BatchGetOneTimeProductOffersRequest
    {
      -- | Required. A list of get requests of up to 100 elements. All requests must retrieve different offers.
      requests :: (Core.Maybe [GetOneTimeProductOfferRequest])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'BatchGetOneTimeProductOffersRequest' with the minimum fields required to make a request.
newBatchGetOneTimeProductOffersRequest 
    :: 
                                       BatchGetOneTimeProductOffersRequest
newBatchGetOneTimeProductOffersRequest
  = BatchGetOneTimeProductOffersRequest{requests = Core.Nothing}
instance Core.FromJSON BatchGetOneTimeProductOffersRequest where
        parseJSON
          = Core.withObject "BatchGetOneTimeProductOffersRequest"
              (\ o ->
                 BatchGetOneTimeProductOffersRequest Core.<$>
                   (o Core..:? "requests"))

instance Core.ToJSON BatchGetOneTimeProductOffersRequest where
        toJSON BatchGetOneTimeProductOffersRequest{..}
          = Core.object
              (Core.catMaybes [("requests" Core..=) Core.<$> requests])
...
--
-- /See:/ 'newBatchGetOneTimeProductOffersResponse' smart constructor.
newtype BatchGetOneTimeProductOffersResponse = BatchGetOneTimeProductOffersResponse
    {
      -- | The list of updated one-time product offers, in the same order as the request.
      oneTimeProductOffers :: (Core.Maybe [OneTimeProductOffer])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'BatchGetOneTimeProductOffersResponse' with the minimum fields required to make a request.
newBatchGetOneTimeProductOffersResponse 
    :: 
                                        BatchGetOneTimeProductOffersResponse
newBatchGetOneTimeProductOffersResponse
  = BatchGetOneTimeProductOffersResponse{oneTimeProductOffers =
                                           Core.Nothing}
instance Core.FromJSON BatchGetOneTimeProductOffersResponse where
        parseJSON
          = Core.withObject "BatchGetOneTimeProductOffersResponse"
              (\ o ->
                 BatchGetOneTimeProductOffersResponse Core.<$>
                   (o Core..:? "oneTimeProductOffers"))

instance Core.ToJSON BatchGetOneTimeProductOffersResponse where
        toJSON BatchGetOneTimeProductOffersResponse{..}
          = Core.object
              (Core.catMaybes
                 [("oneTimeProductOffers" Core..=) Core.<$> oneTimeProductOffers])


-- | Response message for the BatchGetOneTimeProducts endpoint.
--
-- /See:/ 'newBatchGetOneTimeProductsResponse' smart constructor.
newtype BatchGetOneTimeProductsResponse = BatchGetOneTimeProductsResponse
    {
      -- | The list of requested one-time products, in the same order as the request.
      oneTimeProducts :: (Core.Maybe [OneTimeProduct])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'BatchGetOneTimeProductsResponse' with the minimum fields required to make a request.
newBatchGetOneTimeProductsResponse 
    :: 
                                   BatchGetOneTimeProductsResponse
newBatchGetOneTimeProductsResponse
  = BatchGetOneTimeProductsResponse{oneTimeProducts = Core.Nothing}
instance Core.FromJSON BatchGetOneTimeProductsResponse where
        parseJSON
          = Core.withObject "BatchGetOneTimeProductsResponse"
              (\ o ->
                 BatchGetOneTimeProductsResponse Core.<$>
                   (o Core..:? "oneTimeProducts"))

instance Core.ToJSON BatchGetOneTimeProductsResponse where
        toJSON BatchGetOneTimeProductsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("oneTimeProducts" Core..=) Core.<$> oneTimeProducts])
...
--
-- /See:/ 'newBatchUpdateOneTimeProductOfferStatesRequest' smart constructor.
newtype BatchUpdateOneTimeProductOfferStatesRequest = BatchUpdateOneTimeProductOfferStatesRequest
    {
      -- | Required. The update request list of up to 100 elements. All requests must update different offers.
      requests :: (Core.Maybe [UpdateOneTimeProductOfferStateRequest])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'BatchUpdateOneTimeProductOfferStatesRequest' with the minimum fields required to make a request.
newBatchUpdateOneTimeProductOfferStatesRequest 
    :: 
                                               BatchUpdateOneTimeProductOfferStatesRequest
newBatchUpdateOneTimeProductOfferStatesRequest
  = BatchUpdateOneTimeProductOfferStatesRequest{requests =
                                                  Core.Nothing}
instance Core.FromJSON BatchUpdateOneTimeProductOfferStatesRequest
         where
        parseJSON
          = Core.withObject "BatchUpdateOneTimeProductOfferStatesRequest"
              (\ o ->
                 BatchUpdateOneTimeProductOfferStatesRequest Core.<$>
                   (o Core..:? "requests"))

instance Core.ToJSON BatchUpdateOneTimeProductOfferStatesRequest
         where
        toJSON BatchUpdateOneTimeProductOfferStatesRequest{..}
          = Core.object
              (Core.catMaybes [("requests" Core..=) Core.<$> requests])
...
--
-- /See:/ 'newBatchUpdateOneTimeProductOfferStatesResponse' smart constructor.
newtype BatchUpdateOneTimeProductOfferStatesResponse = BatchUpdateOneTimeProductOfferStatesResponse
    {
...
-- | Creates a value of 'BatchUpdateOneTimeProductOfferStatesResponse' with the minimum fields required to make a request.
newBatchUpdateOneTimeProductOfferStatesResponse 
    :: 
                                                BatchUpdateOneTimeProductOfferStatesResponse
newBatchUpdateOneTimeProductOfferStatesResponse
  = BatchUpdateOneTimeProductOfferStatesResponse{oneTimeProductOffers
                                                   = Core.Nothing}
instance Core.FromJSON BatchUpdateOneTimeProductOfferStatesResponse
         where
        parseJSON
          = Core.withObject "BatchUpdateOneTimeProductOfferStatesResponse"
              (\ o ->
                 BatchUpdateOneTimeProductOfferStatesResponse Core.<$>
                   (o Core..:? "oneTimeProductOffers"))

instance Core.ToJSON BatchUpdateOneTimeProductOfferStatesResponse
         where
        toJSON BatchUpdateOneTimeProductOfferStatesResponse{..}
          = Core.object
              (Core.catMaybes
                 [("oneTimeProductOffers" Core..=) Core.<$> oneTimeProductOffers])
...
--
-- /See:/ 'newBatchUpdateOneTimeProductOffersRequest' smart constructor.
newtype BatchUpdateOneTimeProductOffersRequest = BatchUpdateOneTimeProductOffersRequest
    {
      -- | Required. A list of update requests of up to 100 elements. All requests must update different offers.
      requests :: (Core.Maybe [UpdateOneTimeProductOfferRequest])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'BatchUpdateOneTimeProductOffersRequest' with the minimum fields required to make a request.
newBatchUpdateOneTimeProductOffersRequest 
    :: 
                                          BatchUpdateOneTimeProductOffersRequest
newBatchUpdateOneTimeProductOffersRequest
  = BatchUpdateOneTimeProductOffersRequest{requests = Core.Nothing}
instance Core.FromJSON BatchUpdateOneTimeProductOffersRequest where
        parseJSON
          = Core.withObject "BatchUpdateOneTimeProductOffersRequest"
              (\ o ->
                 BatchUpdateOneTimeProductOffersRequest Core.<$>
                   (o Core..:? "requests"))

instance Core.ToJSON BatchUpdateOneTimeProductOffersRequest where
        toJSON BatchUpdateOneTimeProductOffersRequest{..}
          = Core.object
              (Core.catMaybes [("requests" Core..=) Core.<$> requests])
...
--
-- /See:/ 'newBatchUpdateOneTimeProductOffersResponse' smart constructor.
newtype BatchUpdateOneTimeProductOffersResponse = BatchUpdateOneTimeProductOffersResponse
    {
      -- | The list of updated one-time product offers, in the same order as the request.
      oneTimeProductOffers :: (Core.Maybe [OneTimeProductOffer])
    }
...
-- | Creates a value of 'BatchUpdateOneTimeProductOffersResponse' with the minimum fields required to make a request.
newBatchUpdateOneTimeProductOffersResponse 
    :: 
                                           BatchUpdateOneTimeProductOffersResponse
newBatchUpdateOneTimeProductOffersResponse
  = BatchUpdateOneTimeProductOffersResponse{oneTimeProductOffers =
                                              Core.Nothing}
instance Core.FromJSON BatchUpdateOneTimeProductOffersResponse
         where
        parseJSON
          = Core.withObject "BatchUpdateOneTimeProductOffersResponse"
              (\ o ->
                 BatchUpdateOneTimeProductOffersResponse Core.<$>
                   (o Core..:? "oneTimeProductOffers"))

instance Core.ToJSON BatchUpdateOneTimeProductOffersResponse where
        toJSON BatchUpdateOneTimeProductOffersResponse{..}
          = Core.object
              (Core.catMaybes
                 [("oneTimeProductOffers" Core..=) Core.<$> oneTimeProductOffers])
...
--
-- /See:/ 'newBatchUpdateOneTimeProductsRequest' smart constructor.
newtype BatchUpdateOneTimeProductsRequest = BatchUpdateOneTimeProductsRequest
    {
      -- | Required. A list of update requests of up to 100 elements. All requests must update different one-time products.
      requests :: (Core.Maybe [UpdateOneTimeProductRequest])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'BatchUpdateOneTimeProductsRequest' with the minimum fields required to make a request.
newBatchUpdateOneTimeProductsRequest 
    :: 
                                     BatchUpdateOneTimeProductsRequest
newBatchUpdateOneTimeProductsRequest
  = BatchUpdateOneTimeProductsRequest{requests = Core.Nothing}
instance Core.FromJSON BatchUpdateOneTimeProductsRequest where
        parseJSON
          = Core.withObject "BatchUpdateOneTimeProductsRequest"
              (\ o ->
                 BatchUpdateOneTimeProductsRequest Core.<$> (o Core..:? "requests"))

instance Core.ToJSON BatchUpdateOneTimeProductsRequest where
        toJSON BatchUpdateOneTimeProductsRequest{..}
          = Core.object
              (Core.catMaybes [("requests" Core..=) Core.<$> requests])
...
--
-- /See:/ 'newBatchUpdateOneTimeProductsResponse' smart constructor.
newtype BatchUpdateOneTimeProductsResponse = BatchUpdateOneTimeProductsResponse
    {
...
-- | Creates a value of 'BatchUpdateOneTimeProductsResponse' with the minimum fields required to make a request.
newBatchUpdateOneTimeProductsResponse 
    :: 
                                      BatchUpdateOneTimeProductsResponse
newBatchUpdateOneTimeProductsResponse
  = BatchUpdateOneTimeProductsResponse{oneTimeProducts =
                                         Core.Nothing}
instance Core.FromJSON BatchUpdateOneTimeProductsResponse where
        parseJSON
          = Core.withObject "BatchUpdateOneTimeProductsResponse"
              (\ o ->
                 BatchUpdateOneTimeProductsResponse Core.<$>
                   (o Core..:? "oneTimeProducts"))

instance Core.ToJSON BatchUpdateOneTimeProductsResponse where
        toJSON BatchUpdateOneTimeProductsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("oneTimeProducts" Core..=) Core.<$> oneTimeProducts])
...
--
-- /See:/ 'newBatchUpdatePurchaseOptionStatesRequest' smart constructor.
newtype BatchUpdatePurchaseOptionStatesRequest = BatchUpdatePurchaseOptionStatesRequest
    {
      -- | Required. The update request list of up to 100 elements. All requests must update different purchase options.
      requests :: (Core.Maybe [UpdatePurchaseOptionStateRequest])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'BatchUpdatePurchaseOptionStatesRequest' with the minimum fields required to make a request.
newBatchUpdatePurchaseOptionStatesRequest 
    :: 
                                          BatchUpdatePurchaseOptionStatesRequest
newBatchUpdatePurchaseOptionStatesRequest
  = BatchUpdatePurchaseOptionStatesRequest{requests = Core.Nothing}
instance Core.FromJSON BatchUpdatePurchaseOptionStatesRequest where
        parseJSON
          = Core.withObject "BatchUpdatePurchaseOptionStatesRequest"
              (\ o ->
                 BatchUpdatePurchaseOptionStatesRequest Core.<$>
                   (o Core..:? "requests"))

instance Core.ToJSON BatchUpdatePurchaseOptionStatesRequest where
        toJSON BatchUpdatePurchaseOptionStatesRequest{..}
          = Core.object
              (Core.catMaybes [("requests" Core..=) Core.<$> requests])
...
--
-- /See:/ 'newBatchUpdatePurchaseOptionStatesResponse' smart constructor.
newtype BatchUpdatePurchaseOptionStatesResponse = BatchUpdatePurchaseOptionStatesResponse
    {
...
-- | Creates a value of 'BatchUpdatePurchaseOptionStatesResponse' with the minimum fields required to make a request.
newBatchUpdatePurchaseOptionStatesResponse 
    :: 
                                           BatchUpdatePurchaseOptionStatesResponse
newBatchUpdatePurchaseOptionStatesResponse
  = BatchUpdatePurchaseOptionStatesResponse{oneTimeProducts =
                                              Core.Nothing}
instance Core.FromJSON BatchUpdatePurchaseOptionStatesResponse
         where
        parseJSON
          = Core.withObject "BatchUpdatePurchaseOptionStatesResponse"
              (\ o ->
                 BatchUpdatePurchaseOptionStatesResponse Core.<$>
                   (o Core..:? "oneTimeProducts"))

instance Core.ToJSON BatchUpdatePurchaseOptionStatesResponse where
        toJSON BatchUpdatePurchaseOptionStatesResponse{..}
          = Core.object
              (Core.catMaybes
                 [("oneTimeProducts" Core..=) Core.<$> oneTimeProducts])
...
--
-- /See:/ 'newCancelOneTimeProductOfferRequest' smart constructor.
data CancelOneTimeProductOfferRequest = CancelOneTimeProductOfferRequest
    {
      -- | Optional. The latency tolerance for the propagation of this update. Defaults to latency-sensitive.
      latencyTolerance :: (Core.Maybe CancelOneTimeProductOfferRequest_LatencyTolerance)
...
-- | Creates a value of 'CancelOneTimeProductOfferRequest' with the minimum fields required to make a request.
newCancelOneTimeProductOfferRequest 
    :: 
                                    CancelOneTimeProductOfferRequest
newCancelOneTimeProductOfferRequest
  = CancelOneTimeProductOfferRequest{latencyTolerance = Core.Nothing,
                                     offerId = Core.Nothing, packageName = Core.Nothing,
                                     productId = Core.Nothing, purchaseOptionId = Core.Nothing}
instance Core.FromJSON CancelOneTimeProductOfferRequest where
        parseJSON
          = Core.withObject "CancelOneTimeProductOfferRequest"
              (\ o ->
                 CancelOneTimeProductOfferRequest Core.<$>
                   (o Core..:? "latencyTolerance") Core.<*> (o Core..:? "offerId")
                     Core.<*> (o Core..:? "packageName")
                     Core.<*> (o Core..:? "productId")
                     Core.<*> (o Core..:? "purchaseOptionId"))

instance Core.ToJSON CancelOneTimeProductOfferRequest where
        toJSON CancelOneTimeProductOfferRequest{..}
          = Core.object
              (Core.catMaybes
                 [("latencyTolerance" Core..=) Core.<$> latencyTolerance,
                  ("offerId" Core..=) Core.<$> offerId,
...
--
-- /See:/ 'newCancelSubscriptionPurchaseRequest' smart constructor.
newtype CancelSubscriptionPurchaseRequest = CancelSubscriptionPurchaseRequest
    {
      -- | Required. Additional details around the subscription revocation.
      cancellationContext :: (Core.Maybe CancellationContext)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'CancelSubscriptionPurchaseRequest' with the minimum fields required to make a request.
newCancelSubscriptionPurchaseRequest 
    :: 
                                     CancelSubscriptionPurchaseRequest
newCancelSubscriptionPurchaseRequest
  = CancelSubscriptionPurchaseRequest{cancellationContext =
                                        Core.Nothing}
instance Core.FromJSON CancelSubscriptionPurchaseRequest where
        parseJSON
          = Core.withObject "CancelSubscriptionPurchaseRequest"
              (\ o ->
                 CancelSubscriptionPurchaseRequest Core.<$>
                   (o Core..:? "cancellationContext"))

instance Core.ToJSON CancelSubscriptionPurchaseRequest where
        toJSON CancelSubscriptionPurchaseRequest{..}
          = Core.object
              (Core.catMaybes
                 [("cancellationContext" Core..=) Core.<$> cancellationContext])


-- | Response for the purchases.subscriptionsv2.cancel API.
--
-- /See:/ 'newCancelSubscriptionPurchaseResponse' smart constructor.
data CancelSubscriptionPurchaseResponse = CancelSubscriptionPurchaseResponse
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'CancelSubscriptionPurchaseResponse' with the minimum fields required to make a request.
newCancelSubscriptionPurchaseResponse 
    :: 
                                      CancelSubscriptionPurchaseResponse
newCancelSubscriptionPurchaseResponse
  = CancelSubscriptionPurchaseResponse
instance Core.FromJSON CancelSubscriptionPurchaseResponse where
        parseJSON
          = Core.withObject "CancelSubscriptionPurchaseResponse"
              (\ o -> Core.pure CancelSubscriptionPurchaseResponse)

instance Core.ToJSON CancelSubscriptionPurchaseResponse where
        toJSON = Core.const Core.emptyObject
...
--
-- /See:/ 'newCancellationContext' smart constructor.
newtype CancellationContext = CancellationContext
    {
      -- | Required. The type of cancellation for the purchased subscription.
      cancellationType :: (Core.Maybe CancellationContext_CancellationType)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'CancellationContext' with the minimum fields required to make a request.
newCancellationContext 
    ::  CancellationContext
newCancellationContext
  = CancellationContext{cancellationType = Core.Nothing}
instance Core.FromJSON CancellationContext where
        parseJSON
          = Core.withObject "CancellationContext"
              (\ o ->
                 CancellationContext Core.<$> (o Core..:? "cancellationType"))

instance Core.ToJSON CancellationContext where
        toJSON CancellationContext{..}
          = Core.object
              (Core.catMaybes
                 [("cancellationType" Core..=) Core.<$> cancellationType])
...
--
-- /See:/ 'newDeactivateOneTimeProductOfferRequest' smart constructor.
data DeactivateOneTimeProductOfferRequest = DeactivateOneTimeProductOfferRequest
    {
      -- | Optional. The latency tolerance for the propagation of this update. Defaults to latency-sensitive.
      latencyTolerance :: (Core.Maybe DeactivateOneTimeProductOfferRequest_LatencyTolerance)
...
-- | Creates a value of 'DeactivateOneTimeProductOfferRequest' with the minimum fields required to make a request.
newDeactivateOneTimeProductOfferRequest 
    :: 
                                        DeactivateOneTimeProductOfferRequest
newDeactivateOneTimeProductOfferRequest
  = DeactivateOneTimeProductOfferRequest{latencyTolerance =
                                           Core.Nothing,
                                         offerId = Core.Nothing, packageName = Core.Nothing,
                                         productId = Core.Nothing, purchaseOptionId = Core.Nothing}
instance Core.FromJSON DeactivateOneTimeProductOfferRequest where
        parseJSON
          = Core.withObject "DeactivateOneTimeProductOfferRequest"
              (\ o ->
                 DeactivateOneTimeProductOfferRequest Core.<$>
                   (o Core..:? "latencyTolerance") Core.<*> (o Core..:? "offerId")
                     Core.<*> (o Core..:? "packageName")
                     Core.<*> (o Core..:? "productId")
                     Core.<*> (o Core..:? "purchaseOptionId"))

instance Core.ToJSON DeactivateOneTimeProductOfferRequest where
        toJSON DeactivateOneTimeProductOfferRequest{..}
          = Core.object
              (Core.catMaybes
                 [("latencyTolerance" Core..=) Core.<$> latencyTolerance,
                  ("offerId" Core..=) Core.<$> offerId,
...
-- | Request message for UpdatePurchaseOptionState.
--
-- /See:/ 'newDeactivatePurchaseOptionRequest' smart constructor.
data DeactivatePurchaseOptionRequest = DeactivatePurchaseOptionRequest
    {
      -- | Optional. The latency tolerance for the propagation of this product update. Defaults to latency-sensitive.
      latencyTolerance :: (Core.Maybe DeactivatePurchaseOptionRequest_LatencyTolerance)
...
-- | Creates a value of 'DeactivatePurchaseOptionRequest' with the minimum fields required to make a request.
newDeactivatePurchaseOptionRequest 
    :: 
                                   DeactivatePurchaseOptionRequest
newDeactivatePurchaseOptionRequest
  = DeactivatePurchaseOptionRequest{latencyTolerance = Core.Nothing,
                                    packageName = Core.Nothing, productId = Core.Nothing,
                                    purchaseOptionId = Core.Nothing}
instance Core.FromJSON DeactivatePurchaseOptionRequest where
        parseJSON
          = Core.withObject "DeactivatePurchaseOptionRequest"
              (\ o ->
                 DeactivatePurchaseOptionRequest Core.<$>
                   (o Core..:? "latencyTolerance") Core.<*> (o Core..:? "packageName")
                     Core.<*> (o Core..:? "productId")
                     Core.<*> (o Core..:? "purchaseOptionId"))

instance Core.ToJSON DeactivatePurchaseOptionRequest where
        toJSON DeactivatePurchaseOptionRequest{..}
          = Core.object
              (Core.catMaybes
                 [("latencyTolerance" Core..=) Core.<$> latencyTolerance,
                  ("packageName" Core..=) Core.<$> packageName,
...
--
-- /See:/ 'newDeferredItemRemoval' smart constructor.
data DeferredItemRemoval = DeferredItemRemoval
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'DeferredItemRemoval' with the minimum fields required to make a request.
newDeferredItemRemoval 
    ::  DeferredItemRemoval
newDeferredItemRemoval = DeferredItemRemoval
instance Core.FromJSON DeferredItemRemoval where
        parseJSON
          = Core.withObject "DeferredItemRemoval"
              (\ o -> Core.pure DeferredItemRemoval)

instance Core.ToJSON DeferredItemRemoval where
        toJSON = Core.const Core.emptyObject
...
--
-- /See:/ 'newDeleteOneTimeProductOfferRequest' smart constructor.
data DeleteOneTimeProductOfferRequest = DeleteOneTimeProductOfferRequest
    {
      -- | Optional. The latency tolerance for the propagation of this product update. Defaults to latency-sensitive.
      latencyTolerance :: (Core.Maybe DeleteOneTimeProductOfferRequest_LatencyTolerance)
...
-- | Creates a value of 'DeleteOneTimeProductOfferRequest' with the minimum fields required to make a request.
newDeleteOneTimeProductOfferRequest 
    :: 
                                    DeleteOneTimeProductOfferRequest
newDeleteOneTimeProductOfferRequest
  = DeleteOneTimeProductOfferRequest{latencyTolerance = Core.Nothing,
                                     offerId = Core.Nothing, packageName = Core.Nothing,
                                     productId = Core.Nothing, purchaseOptionId = Core.Nothing}
instance Core.FromJSON DeleteOneTimeProductOfferRequest where
        parseJSON
          = Core.withObject "DeleteOneTimeProductOfferRequest"
              (\ o ->
                 DeleteOneTimeProductOfferRequest Core.<$>
                   (o Core..:? "latencyTolerance") Core.<*> (o Core..:? "offerId")
                     Core.<*> (o Core..:? "packageName")
                     Core.<*> (o Core..:? "productId")
                     Core.<*> (o Core..:? "purchaseOptionId"))

instance Core.ToJSON DeleteOneTimeProductOfferRequest where
        toJSON DeleteOneTimeProductOfferRequest{..}
          = Core.object
              (Core.catMaybes
                 [("latencyTolerance" Core..=) Core.<$> latencyTolerance,
                  ("offerId" Core..=) Core.<$> offerId,
...
--
-- /See:/ 'newDeleteOneTimeProductRequest' smart constructor.
data DeleteOneTimeProductRequest = DeleteOneTimeProductRequest
    {
      -- | Optional. The latency tolerance for the propagation of this product update. Defaults to latency-sensitive.
      latencyTolerance :: (Core.Maybe DeleteOneTimeProductRequest_LatencyTolerance)
...
-- | Creates a value of 'DeleteOneTimeProductRequest' with the minimum fields required to make a request.
newDeleteOneTimeProductRequest 
    ::  DeleteOneTimeProductRequest
newDeleteOneTimeProductRequest
  = DeleteOneTimeProductRequest{latencyTolerance = Core.Nothing,
                                packageName = Core.Nothing, productId = Core.Nothing}
instance Core.FromJSON DeleteOneTimeProductRequest where
        parseJSON
          = Core.withObject "DeleteOneTimeProductRequest"
              (\ o ->
                 DeleteOneTimeProductRequest Core.<$>
                   (o Core..:? "latencyTolerance") Core.<*> (o Core..:? "packageName")
                     Core.<*> (o Core..:? "productId"))

instance Core.ToJSON DeleteOneTimeProductRequest where
        toJSON DeleteOneTimeProductRequest{..}
          = Core.object
              (Core.catMaybes
                 [("latencyTolerance" Core..=) Core.<$> latencyTolerance,
                  ("packageName" Core..=) Core.<$> packageName,
...
--
-- /See:/ 'newDeletePurchaseOptionRequest' smart constructor.
data DeletePurchaseOptionRequest = DeletePurchaseOptionRequest
    {
      ...
      -- | Optional. The latency tolerance for the propagation of this product update. Defaults to latency-sensitive.
    , latencyTolerance :: (Core.Maybe DeletePurchaseOptionRequest_LatencyTolerance)
...
-- | Creates a value of 'DeletePurchaseOptionRequest' with the minimum fields required to make a request.
newDeletePurchaseOptionRequest 
    ::  DeletePurchaseOptionRequest
newDeletePurchaseOptionRequest
  = DeletePurchaseOptionRequest{force = Core.Nothing,
                                latencyTolerance = Core.Nothing, packageName = Core.Nothing,
                                productId = Core.Nothing, purchaseOptionId = Core.Nothing}
instance Core.FromJSON DeletePurchaseOptionRequest where
        parseJSON
          = Core.withObject "DeletePurchaseOptionRequest"
              (\ o ->
                 DeletePurchaseOptionRequest Core.<$>
                   (o Core..:? "force") Core.<*> (o Core..:? "latencyTolerance")
                     Core.<*> (o Core..:? "packageName")
                     Core.<*> (o Core..:? "productId")
                     Core.<*> (o Core..:? "purchaseOptionId"))

instance Core.ToJSON DeletePurchaseOptionRequest where
        toJSON DeletePurchaseOptionRequest{..}
          = Core.object
              (Core.catMaybes
...
--
-- /See:/ 'newGetOneTimeProductOfferRequest' smart constructor.
data GetOneTimeProductOfferRequest = GetOneTimeProductOfferRequest
    {
...
-- | Creates a value of 'GetOneTimeProductOfferRequest' with the minimum fields required to make a request.
newGetOneTimeProductOfferRequest 
    ::  GetOneTimeProductOfferRequest
newGetOneTimeProductOfferRequest
  = GetOneTimeProductOfferRequest{offerId = Core.Nothing,
                                  packageName = Core.Nothing, productId = Core.Nothing,
                                  purchaseOptionId = Core.Nothing}
instance Core.FromJSON GetOneTimeProductOfferRequest where
        parseJSON
          = Core.withObject "GetOneTimeProductOfferRequest"
              (\ o ->
                 GetOneTimeProductOfferRequest Core.<$>
                   (o Core..:? "offerId") Core.<*> (o Core..:? "packageName") Core.<*>
                     (o Core..:? "productId")
                     Core.<*> (o Core..:? "purchaseOptionId"))

instance Core.ToJSON GetOneTimeProductOfferRequest where
        toJSON GetOneTimeProductOfferRequest{..}
          = Core.object
              (Core.catMaybes
                 [("offerId" Core..=) Core.<$> offerId,
                  ("packageName" Core..=) Core.<$> packageName,
...
--
-- /See:/ 'newListOneTimeProductOffersResponse' smart constructor.
data ListOneTimeProductOffersResponse = ListOneTimeProductOffersResponse
    {
      -- | A token, which can be sent as @page_token@ to retrieve the next page. If this field is omitted, there are no subsequent pages.
      nextPageToken :: (Core.Maybe Core.Text)
      -- | The one/time/product offers from the specified request.
    , oneTimeProductOffers :: (Core.Maybe [OneTimeProductOffer])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'ListOneTimeProductOffersResponse' with the minimum fields required to make a request.
newListOneTimeProductOffersResponse 
    :: 
                                    ListOneTimeProductOffersResponse
newListOneTimeProductOffersResponse
  = ListOneTimeProductOffersResponse{nextPageToken = Core.Nothing,
                                     oneTimeProductOffers = Core.Nothing}
instance Core.FromJSON ListOneTimeProductOffersResponse where
        parseJSON
          = Core.withObject "ListOneTimeProductOffersResponse"
              (\ o ->
                 ListOneTimeProductOffersResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "oneTimeProductOffers"))

instance Core.ToJSON ListOneTimeProductOffersResponse where
        toJSON ListOneTimeProductOffersResponse{..}
          = Core.object
              (Core.catMaybes
                 [("nextPageToken" Core..=) Core.<$> nextPageToken,
                  ("oneTimeProductOffers" Core..=) Core.<$> oneTimeProductOffers])
...
--
-- /See:/ 'newListOneTimeProductsResponse' smart constructor.
data ListOneTimeProductsResponse = ListOneTimeProductsResponse
    {
      -- | A token, which can be sent as @page_token@ to retrieve the next page. If this field is omitted, there are no subsequent pages.
      nextPageToken :: (Core.Maybe Core.Text)
...
-- | Creates a value of 'ListOneTimeProductsResponse' with the minimum fields required to make a request.
newListOneTimeProductsResponse 
    ::  ListOneTimeProductsResponse
newListOneTimeProductsResponse
  = ListOneTimeProductsResponse{nextPageToken = Core.Nothing,
                                oneTimeProducts = Core.Nothing}
instance Core.FromJSON ListOneTimeProductsResponse where
        parseJSON
          = Core.withObject "ListOneTimeProductsResponse"
              (\ o ->
                 ListOneTimeProductsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "oneTimeProducts"))

instance Core.ToJSON ListOneTimeProductsResponse where
        toJSON ListOneTimeProductsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("nextPageToken" Core..=) Core.<$> nextPageToken,
                  ("oneTimeProducts" Core..=) Core.<$> oneTimeProducts])
...
--
-- /See:/ 'newOneTimeProduct' smart constructor.
data OneTimeProduct = OneTimeProduct
    {
      -- | Required. Set of localized title and description data. Must not have duplicate entries with the same language_code.
      listings :: (Core.Maybe [OneTimeProductListing])
    ...
    , purchaseOptions :: (Core.Maybe [OneTimeProductPurchaseOption])
    ...
    , taxAndComplianceSettings :: (Core.Maybe OneTimeProductTaxAndComplianceSettings)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'OneTimeProduct' with the minimum fields required to make a request.
newOneTimeProduct 
    ::  OneTimeProduct
newOneTimeProduct
  = OneTimeProduct{listings = Core.Nothing, offerTags = Core.Nothing,
                   packageName = Core.Nothing, productId = Core.Nothing,
                   purchaseOptions = Core.Nothing, regionsVersion = Core.Nothing,
                   restrictedPaymentCountries = Core.Nothing,
                   taxAndComplianceSettings = Core.Nothing}
instance Core.FromJSON OneTimeProduct where
        parseJSON
          = Core.withObject "OneTimeProduct"
              (\ o ->
                 OneTimeProduct Core.<$>
                   (o Core..:? "listings") Core.<*> (o Core..:? "offerTags") Core.<*>
                     (o Core..:? "packageName")
                     Core.<*> (o Core..:? "productId")
                     Core.<*> (o Core..:? "purchaseOptions")
                     Core.<*> (o Core..:? "regionsVersion")
                     Core.<*> (o Core..:? "restrictedPaymentCountries")
                     Core.<*> (o Core..:? "taxAndComplianceSettings"))

instance Core.ToJSON OneTimeProduct where
        toJSON OneTimeProduct{..}
          = Core.object
              (Core.catMaybes
                 [("listings" Core..=) Core.<$> listings,
                  ("offerTags" Core..=) Core.<$> offerTags,
                  ("packageName" Core..=) Core.<$> packageName,
                  ("productId" Core..=) Core.<$> productId,
                  ("purchaseOptions" Core..=) Core.<$> purchaseOptions,
                  ("regionsVersion" Core..=) Core.<$> regionsVersion,
...
--
-- /See:/ 'newOneTimeProductBuyPurchaseOption' smart constructor.
data OneTimeProductBuyPurchaseOption = OneTimeProductBuyPurchaseOption
    {
    ...
    , multiQuantityEnabled :: (Core.Maybe Core.Bool)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'OneTimeProductBuyPurchaseOption' with the minimum fields required to make a request.
newOneTimeProductBuyPurchaseOption 
    :: 
                                   OneTimeProductBuyPurchaseOption
newOneTimeProductBuyPurchaseOption
  = OneTimeProductBuyPurchaseOption{legacyCompatible = Core.Nothing,
                                    multiQuantityEnabled = Core.Nothing}
instance Core.FromJSON OneTimeProductBuyPurchaseOption where
        parseJSON
          = Core.withObject "OneTimeProductBuyPurchaseOption"
              (\ o ->
                 OneTimeProductBuyPurchaseOption Core.<$>
                   (o Core..:? "legacyCompatible") Core.<*>
                     (o Core..:? "multiQuantityEnabled"))

instance Core.ToJSON OneTimeProductBuyPurchaseOption where
        toJSON OneTimeProductBuyPurchaseOption{..}
          = Core.object
              (Core.catMaybes
                 [("legacyCompatible" Core..=) Core.<$> legacyCompatible,
                  ("multiQuantityEnabled" Core..=) Core.<$> multiQuantityEnabled])


-- | Configuration specific to discounted offers.
--
-- /See:/ 'newOneTimeProductDiscountedOffer' smart constructor.
data OneTimeProductDiscountedOffer = OneTimeProductDiscountedOffer
    {
    ...
    , redemptionLimit :: (Core.Maybe Core.Int64)
      -- | Time when the offer will start being available.
    , startTime :: (Core.Maybe Core.DateTime)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'OneTimeProductDiscountedOffer' with the minimum fields required to make a request.
newOneTimeProductDiscountedOffer 
    ::  OneTimeProductDiscountedOffer
newOneTimeProductDiscountedOffer
  = OneTimeProductDiscountedOffer{endTime = Core.Nothing,
                                  redemptionLimit = Core.Nothing, startTime = Core.Nothing}
instance Core.FromJSON OneTimeProductDiscountedOffer where
        parseJSON
          = Core.withObject "OneTimeProductDiscountedOffer"
              (\ o ->
                 OneTimeProductDiscountedOffer Core.<$>
                   (o Core..:? "endTime") Core.<*>
                     (o Core..:? "redemptionLimit" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "startTime"))

instance Core.ToJSON OneTimeProductDiscountedOffer where
        toJSON OneTimeProductDiscountedOffer{..}
          = Core.object
              (Core.catMaybes
                 [("endTime" Core..=) Core.<$> endTime,
                  ("redemptionLimit" Core..=) Core.. Core.AsText Core.<$>
                    redemptionLimit,
...
--
-- /See:/ 'newOneTimeProductListing' smart constructor.
data OneTimeProductListing = OneTimeProductListing
    {
...
-- | Creates a value of 'OneTimeProductListing' with the minimum fields required to make a request.
newOneTimeProductListing 
    ::  OneTimeProductListing
newOneTimeProductListing
  = OneTimeProductListing{description = Core.Nothing,
                          languageCode = Core.Nothing, title = Core.Nothing}
instance Core.FromJSON OneTimeProductListing where
        parseJSON
          = Core.withObject "OneTimeProductListing"
              (\ o ->
                 OneTimeProductListing Core.<$>
                   (o Core..:? "description") Core.<*> (o Core..:? "languageCode")
                     Core.<*> (o Core..:? "title"))

instance Core.ToJSON OneTimeProductListing where
        toJSON OneTimeProductListing{..}
          = Core.object
              (Core.catMaybes
                 [("description" Core..=) Core.<$> description,
...
--
-- /See:/ 'newOneTimeProductOffer' smart constructor.
data OneTimeProductOffer = OneTimeProductOffer
    {
      -- | A discounted offer.
      discountedOffer :: (Core.Maybe OneTimeProductDiscountedOffer)
    ...
    , packageName :: (Core.Maybe Core.Text)
      -- | A pre-order offer.
    , preOrderOffer :: (Core.Maybe OneTimeProductPreOrderOffer)
    ...
    , regionalPricingAndAvailabilityConfigs :: (Core.Maybe
   [OneTimeProductOfferRegionalPricingAndAvailabilityConfig])
    ...
    , state :: (Core.Maybe OneTimeProductOffer_State)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'OneTimeProductOffer' with the minimum fields required to make a request.
newOneTimeProductOffer 
    ::  OneTimeProductOffer
newOneTimeProductOffer
  = OneTimeProductOffer{discountedOffer = Core.Nothing,
                        offerId = Core.Nothing, offerTags = Core.Nothing,
                        packageName = Core.Nothing, preOrderOffer = Core.Nothing,
                        productId = Core.Nothing, purchaseOptionId = Core.Nothing,
                        regionalPricingAndAvailabilityConfigs = Core.Nothing,
                        regionsVersion = Core.Nothing, state = Core.Nothing}
instance Core.FromJSON OneTimeProductOffer where
        parseJSON
          = Core.withObject "OneTimeProductOffer"
              (\ o ->
                 OneTimeProductOffer Core.<$>
                   (o Core..:? "discountedOffer") Core.<*> (o Core..:? "offerId")
                     Core.<*> (o Core..:? "offerTags")
                     Core.<*> (o Core..:? "packageName")
                     Core.<*> (o Core..:? "preOrderOffer")
                     Core.<*> (o Core..:? "productId")
                     Core.<*> (o Core..:? "purchaseOptionId")
                     Core.<*> (o Core..:? "regionalPricingAndAvailabilityConfigs")
                     Core.<*> (o Core..:? "regionsVersion")
                     Core.<*> (o Core..:? "state"))

instance Core.ToJSON OneTimeProductOffer where
        toJSON OneTimeProductOffer{..}
          = Core.object
              (Core.catMaybes
                 [("discountedOffer" Core..=) Core.<$> discountedOffer,
                  ("offerId" Core..=) Core.<$> offerId,
                  ("offerTags" Core..=) Core.<$> offerTags,
                  ("packageName" Core..=) Core.<$> packageName,
                  ("preOrderOffer" Core..=) Core.<$> preOrderOffer,
                  ("productId" Core..=) Core.<$> productId,
                  ("purchaseOptionId" Core..=) Core.<$> purchaseOptionId,
                  ("regionalPricingAndAvailabilityConfigs" Core..=) Core.<$>
...
--
-- /See:/ 'newOneTimeProductOfferNoPriceOverrideOptions' smart constructor.
data OneTimeProductOfferNoPriceOverrideOptions = OneTimeProductOfferNoPriceOverrideOptions
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'OneTimeProductOfferNoPriceOverrideOptions' with the minimum fields required to make a request.
newOneTimeProductOfferNoPriceOverrideOptions 
    :: 
                                             OneTimeProductOfferNoPriceOverrideOptions
newOneTimeProductOfferNoPriceOverrideOptions
  = OneTimeProductOfferNoPriceOverrideOptions
instance Core.FromJSON OneTimeProductOfferNoPriceOverrideOptions
         where
        parseJSON
          = Core.withObject "OneTimeProductOfferNoPriceOverrideOptions"
              (\ o -> Core.pure OneTimeProductOfferNoPriceOverrideOptions)

instance Core.ToJSON OneTimeProductOfferNoPriceOverrideOptions
         where
        toJSON = Core.const Core.emptyObject
...
--
-- /See:/ 'newOneTimeProductOfferRegionalPricingAndAvailabilityConfig' smart constructor.
data OneTimeProductOfferRegionalPricingAndAvailabilityConfig = OneTimeProductOfferRegionalPricingAndAvailabilityConfig
    {
   ...
   OneTimeProductOfferRegionalPricingAndAvailabilityConfig_Availability)
    ...
    , noOverride :: (Core.Maybe OneTimeProductOfferNoPriceOverrideOptions)
...
-- | Creates a value of 'OneTimeProductOfferRegionalPricingAndAvailabilityConfig' with the minimum fields required to make a request.
newOneTimeProductOfferRegionalPricingAndAvailabilityConfig 
    :: 
                                                           OneTimeProductOfferRegionalPricingAndAvailabilityConfig
newOneTimeProductOfferRegionalPricingAndAvailabilityConfig
  = OneTimeProductOfferRegionalPricingAndAvailabilityConfig{absoluteDiscount
                                                              = Core.Nothing,
                                                            availability = Core.Nothing,
                                                            noOverride = Core.Nothing,
                                                            regionCode = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "OneTimeProductOfferRegionalPricingAndAvailabilityConfig"
              (\ o ->
                 OneTimeProductOfferRegionalPricingAndAvailabilityConfig Core.<$>
                   (o Core..:? "absoluteDiscount") Core.<*>
                     (o Core..:? "availability")
                     Core.<*> (o Core..:? "noOverride")
...
instance Core.ToJSON
           OneTimeProductOfferRegionalPricingAndAvailabilityConfig
         where
        toJSON OneTimeProductOfferRegionalPricingAndAvailabilityConfig{..}
          = Core.object
              (Core.catMaybes
                 [("absoluteDiscount" Core..=) Core.<$> absoluteDiscount,
                  ("availability" Core..=) Core.<$> availability,
                  ("noOverride" Core..=) Core.<$> noOverride,
                  ("regionCode" Core..=) Core.<$> regionCode,
...
--
-- /See:/ 'newOneTimeProductPreOrderOffer' smart constructor.
data OneTimeProductPreOrderOffer = OneTimeProductPreOrderOffer
    {
    ...
    , priceChangeBehavior :: (Core.Maybe OneTimeProductPreOrderOffer_PriceChangeBehavior)
      -- | Required. Time on which the product associated with the pre-order will be released and the pre-order orders fulfilled.
    , releaseTime :: (Core.Maybe Core.DateTime)
      -- | Required. Time when the pre-order will start being available.
    , startTime :: (Core.Maybe Core.DateTime)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'OneTimeProductPreOrderOffer' with the minimum fields required to make a request.
newOneTimeProductPreOrderOffer 
    ::  OneTimeProductPreOrderOffer
newOneTimeProductPreOrderOffer
  = OneTimeProductPreOrderOffer{endTime = Core.Nothing,
                                priceChangeBehavior = Core.Nothing, releaseTime = Core.Nothing,
                                startTime = Core.Nothing}
instance Core.FromJSON OneTimeProductPreOrderOffer where
        parseJSON
          = Core.withObject "OneTimeProductPreOrderOffer"
              (\ o ->
                 OneTimeProductPreOrderOffer Core.<$>
                   (o Core..:? "endTime") Core.<*> (o Core..:? "priceChangeBehavior")
                     Core.<*> (o Core..:? "releaseTime")
                     Core.<*> (o Core..:? "startTime"))

instance Core.ToJSON OneTimeProductPreOrderOffer where
        toJSON OneTimeProductPreOrderOffer{..}
          = Core.object
              (Core.catMaybes
                 [("endTime" Core..=) Core.<$> endTime,
                  ("priceChangeBehavior" Core..=) Core.<$> priceChangeBehavior,
...
--
-- /See:/ 'newOneTimeProductPurchaseOption' smart constructor.
data OneTimeProductPurchaseOption = OneTimeProductPurchaseOption
    {
      -- | A purchase option that can be bought.
      buyOption :: (Core.Maybe OneTimeProductBuyPurchaseOption)
    ...
    , newRegionsConfig' :: (Core.Maybe OneTimeProductPurchaseOptionNewRegionsConfig)
   ...
   [OneTimeProductPurchaseOptionRegionalPricingAndAvailabilityConfig])
    ...
    , rentOption :: (Core.Maybe OneTimeProductRentPurchaseOption)
    ...
    , state :: (Core.Maybe OneTimeProductPurchaseOption_State)
      -- | Optional. Details about taxes and legal compliance.
    , taxAndComplianceSettings :: (Core.Maybe PurchaseOptionTaxAndComplianceSettings)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'OneTimeProductPurchaseOption' with the minimum fields required to make a request.
newOneTimeProductPurchaseOption 
    ::  OneTimeProductPurchaseOption
newOneTimeProductPurchaseOption
  = OneTimeProductPurchaseOption{buyOption = Core.Nothing,
                                 newRegionsConfig' = Core.Nothing, offerTags = Core.Nothing,
                                 purchaseOptionId = Core.Nothing,
                                 regionalPricingAndAvailabilityConfigs = Core.Nothing,
                                 rentOption = Core.Nothing, state = Core.Nothing,
                                 taxAndComplianceSettings = Core.Nothing}
instance Core.FromJSON OneTimeProductPurchaseOption where
        parseJSON
          = Core.withObject "OneTimeProductPurchaseOption"
              (\ o ->
                 OneTimeProductPurchaseOption Core.<$>
                   (o Core..:? "buyOption") Core.<*> (o Core..:? "newRegionsConfig")
                     Core.<*> (o Core..:? "offerTags")
                     Core.<*> (o Core..:? "purchaseOptionId")
                     Core.<*> (o Core..:? "regionalPricingAndAvailabilityConfigs")
                     Core.<*> (o Core..:? "rentOption")
                     Core.<*> (o Core..:? "state")
                     Core.<*> (o Core..:? "taxAndComplianceSettings"))

instance Core.ToJSON OneTimeProductPurchaseOption where
        toJSON OneTimeProductPurchaseOption{..}
          = Core.object
              (Core.catMaybes
                 [("buyOption" Core..=) Core.<$> buyOption,
                  ("newRegionsConfig" Core..=) Core.<$> newRegionsConfig',
                  ("offerTags" Core..=) Core.<$> offerTags,
                  ("purchaseOptionId" Core..=) Core.<$> purchaseOptionId,
                  ("regionalPricingAndAvailabilityConfigs" Core..=) Core.<$>
                    regionalPricingAndAvailabilityConfigs,
                  ("rentOption" Core..=) Core.<$> rentOption,
                  ("state" Core..=) Core.<$> state,
                  ("taxAndComplianceSettings" Core..=) Core.<$>
                    taxAndComplianceSettings])
...
--
-- /See:/ 'newOneTimeProductPurchaseOptionNewRegionsConfig' smart constructor.
data OneTimeProductPurchaseOptionNewRegionsConfig = OneTimeProductPurchaseOptionNewRegionsConfig
    {
...
-- | Creates a value of 'OneTimeProductPurchaseOptionNewRegionsConfig' with the minimum fields required to make a request.
newOneTimeProductPurchaseOptionNewRegionsConfig 
    :: 
                                                OneTimeProductPurchaseOptionNewRegionsConfig
newOneTimeProductPurchaseOptionNewRegionsConfig
  = OneTimeProductPurchaseOptionNewRegionsConfig{availability =
                                                   Core.Nothing,
                                                 eurPrice = Core.Nothing, usdPrice = Core.Nothing}
instance Core.FromJSON OneTimeProductPurchaseOptionNewRegionsConfig
         where
        parseJSON
          = Core.withObject "OneTimeProductPurchaseOptionNewRegionsConfig"
              (\ o ->
                 OneTimeProductPurchaseOptionNewRegionsConfig Core.<$>
                   (o Core..:? "availability") Core.<*> (o Core..:? "eurPrice")
                     Core.<*> (o Core..:? "usdPrice"))

instance Core.ToJSON OneTimeProductPurchaseOptionNewRegionsConfig
         where
        toJSON OneTimeProductPurchaseOptionNewRegionsConfig{..}
          = Core.object
              (Core.catMaybes
                 [("availability" Core..=) Core.<$> availability,
                  ("eurPrice" Core..=) Core.<$> eurPrice,
...
--
-- /See:/ 'newOneTimeProductPurchaseOptionRegionalPricingAndAvailabilityConfig' smart constructor.
data OneTimeProductPurchaseOptionRegionalPricingAndAvailabilityConfig = OneTimeProductPurchaseOptionRegionalPricingAndAvailabilityConfig
    {
...
-- | Creates a value of 'OneTimeProductPurchaseOptionRegionalPricingAndAvailabilityConfig' with the minimum fields required to make a request.
newOneTimeProductPurchaseOptionRegionalPricingAndAvailabilityConfig 
    :: 
                                                                    OneTimeProductPurchaseOptionRegionalPricingAndAvailabilityConfig
newOneTimeProductPurchaseOptionRegionalPricingAndAvailabilityConfig
  = OneTimeProductPurchaseOptionRegionalPricingAndAvailabilityConfig{availability
                                                                       = Core.Nothing,
                                                                     price = Core.Nothing,
                                                                     regionCode = Core.Nothing}
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 OneTimeProductPurchaseOptionRegionalPricingAndAvailabilityConfig
                   Core.<$>
                   (o Core..:? "availability") Core.<*> (o Core..:? "price") Core.<*>
                     (o Core..:? "regionCode"))
...
-- | A purchase option that can be rented.
--
-- /See:/ 'newOneTimeProductRentPurchaseOption' smart constructor.
data OneTimeProductRentPurchaseOption = OneTimeProductRentPurchaseOption
    {
      ...
      expirationPeriod :: (Core.Maybe Core.Text)
    ...
    , rentalPeriod :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'OneTimeProductRentPurchaseOption' with the minimum fields required to make a request.
newOneTimeProductRentPurchaseOption 
    :: 
                                    OneTimeProductRentPurchaseOption
newOneTimeProductRentPurchaseOption
  = OneTimeProductRentPurchaseOption{expirationPeriod = Core.Nothing,
                                     rentalPeriod = Core.Nothing}
instance Core.FromJSON OneTimeProductRentPurchaseOption where
        parseJSON
          = Core.withObject "OneTimeProductRentPurchaseOption"
              (\ o ->
                 OneTimeProductRentPurchaseOption Core.<$>
                   (o Core..:? "expirationPeriod") Core.<*>
                     (o Core..:? "rentalPeriod"))

instance Core.ToJSON OneTimeProductRentPurchaseOption where
        toJSON OneTimeProductRentPurchaseOption{..}
          = Core.object
              (Core.catMaybes
                 [("expirationPeriod" Core..=) Core.<$> expirationPeriod,
                  ("rentalPeriod" Core..=) Core.<$> rentalPeriod])


-- | Details about taxation, Google Play policy and legal compliance for one-time products.
--
-- /See:/ 'newOneTimeProductTaxAndComplianceSettings' smart constructor.
data OneTimeProductTaxAndComplianceSettings = OneTimeProductTaxAndComplianceSettings
    {
      -- | Whether this one-time product is declared as a product representing a tokenized digital asset.
      isTokenizedDigitalAsset :: (Core.Maybe Core.Bool)
      -- | Regional tax configuration.
    , regionalTaxConfigs :: (Core.Maybe [RegionalTaxConfig])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'OneTimeProductTaxAndComplianceSettings' with the minimum fields required to make a request.
newOneTimeProductTaxAndComplianceSettings 
    :: 
                                          OneTimeProductTaxAndComplianceSettings
newOneTimeProductTaxAndComplianceSettings
  = OneTimeProductTaxAndComplianceSettings{isTokenizedDigitalAsset =
                                             Core.Nothing,
                                           regionalTaxConfigs = Core.Nothing}
instance Core.FromJSON OneTimeProductTaxAndComplianceSettings where
        parseJSON
          = Core.withObject "OneTimeProductTaxAndComplianceSettings"
              (\ o ->
                 OneTimeProductTaxAndComplianceSettings Core.<$>
                   (o Core..:? "isTokenizedDigitalAsset") Core.<*>
                     (o Core..:? "regionalTaxConfigs"))

instance Core.ToJSON OneTimeProductTaxAndComplianceSettings where
        toJSON OneTimeProductTaxAndComplianceSettings{..}
          = Core.object
              (Core.catMaybes
                 [("isTokenizedDigitalAsset" Core..=) Core.<$>
                    isTokenizedDigitalAsset,
                  ("regionalTaxConfigs" Core..=) Core.<$> regionalTaxConfigs])
...
data OneTimePurchaseDetails = OneTimePurchaseDetails
    ...
    , rentalDetails :: (Core.Maybe RentalDetails)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newOneTimePurchaseDetails
  = OneTimePurchaseDetails{offerId = Core.Nothing,
                           purchaseOptionId = Core.Nothing, quantity = Core.Nothing,
                           rentalDetails = Core.Nothing}
instance Core.FromJSON OneTimePurchaseDetails where
        parseJSON
          = Core.withObject "OneTimePurchaseDetails"
              (\ o ->
                 OneTimePurchaseDetails Core.<$>
                   (o Core..:? "offerId") Core.<*> (o Core..:? "purchaseOptionId")
                     Core.<*> (o Core..:? "quantity")
                     Core.<*> (o Core..:? "rentalDetails"))
          ...
          = Core.object
              (Core.catMaybes
                 [("offerId" Core..=) Core.<$> offerId,
                  ...
                  ("rentalDetails" Core..=) Core.<$> rentalDetails])
...
--
-- /See:/ 'newPriceStepUpConsentDetails' smart constructor.
data PriceStepUpConsentDetails = PriceStepUpConsentDetails
    {
      ...
      consentDeadlineTime :: (Core.Maybe Core.DateTime)
      -- | The new price which requires user consent.
    , newPrice' :: (Core.Maybe Money)
      -- | Output only. The state of the price step-up consent.
    , state :: (Core.Maybe PriceStepUpConsentDetails_State)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'PriceStepUpConsentDetails' with the minimum fields required to make a request.
newPriceStepUpConsentDetails 
    ::  PriceStepUpConsentDetails
newPriceStepUpConsentDetails
  = PriceStepUpConsentDetails{consentDeadlineTime = Core.Nothing,
                              newPrice' = Core.Nothing, state = Core.Nothing}
instance Core.FromJSON PriceStepUpConsentDetails where
        parseJSON
          = Core.withObject "PriceStepUpConsentDetails"
              (\ o ->
                 PriceStepUpConsentDetails Core.<$>
                   (o Core..:? "consentDeadlineTime") Core.<*> (o Core..:? "newPrice")
                     Core.<*> (o Core..:? "state"))

instance Core.ToJSON PriceStepUpConsentDetails where
        toJSON PriceStepUpConsentDetails{..}
          = Core.object
              (Core.catMaybes
                 [("consentDeadlineTime" Core..=) Core.<$> consentDeadlineTime,
...
--
-- /See:/ 'newProductLineItem' smart constructor.
data ProductLineItem = ProductLineItem
    {
      -- | The purchased product ID (for example, \'monthly001\').
      productId :: (Core.Maybe Core.Text)
      -- | The offer details for this item.
    , productOfferDetails :: (Core.Maybe ProductOfferDetails)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'ProductLineItem' with the minimum fields required to make a request.
newProductLineItem 
    ::  ProductLineItem
newProductLineItem
  = ProductLineItem{productId = Core.Nothing,
                    productOfferDetails = Core.Nothing}
instance Core.FromJSON ProductLineItem where
        parseJSON
          = Core.withObject "ProductLineItem"
              (\ o ->
                 ProductLineItem Core.<$>
                   (o Core..:? "productId") Core.<*>
                     (o Core..:? "productOfferDetails"))

instance Core.ToJSON ProductLineItem where
        toJSON ProductLineItem{..}
          = Core.object
              (Core.catMaybes
                 [("productId" Core..=) Core.<$> productId,
                  ("productOfferDetails" Core..=) Core.<$> productOfferDetails])


-- | Offer details information related to a purchase line item.
--
-- /See:/ 'newProductOfferDetails' smart constructor.
data ProductOfferDetails = ProductOfferDetails
    {
      -- | Output only. The consumption state of the purchase.
      consumptionState :: (Core.Maybe ProductOfferDetails_ConsumptionState)
    ...
    , offerToken :: (Core.Maybe Core.Text)
    ...
    , rentOfferDetails :: (Core.Maybe RentOfferDetails)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'ProductOfferDetails' with the minimum fields required to make a request.
newProductOfferDetails 
    ::  ProductOfferDetails
newProductOfferDetails
  = ProductOfferDetails{consumptionState = Core.Nothing,
                        offerId = Core.Nothing, offerTags = Core.Nothing,
                        offerToken = Core.Nothing, purchaseOptionId = Core.Nothing,
                        quantity = Core.Nothing, refundableQuantity = Core.Nothing,
                        rentOfferDetails = Core.Nothing}
instance Core.FromJSON ProductOfferDetails where
        parseJSON
          = Core.withObject "ProductOfferDetails"
              (\ o ->
                 ProductOfferDetails Core.<$>
                   (o Core..:? "consumptionState") Core.<*> (o Core..:? "offerId")
                     Core.<*> (o Core..:? "offerTags")
                     Core.<*> (o Core..:? "offerToken")
                     Core.<*> (o Core..:? "purchaseOptionId")
                     Core.<*> (o Core..:? "quantity")
                     Core.<*> (o Core..:? "refundableQuantity")
                     Core.<*> (o Core..:? "rentOfferDetails"))

instance Core.ToJSON ProductOfferDetails where
        toJSON ProductOfferDetails{..}
          = Core.object
              (Core.catMaybes
                 [("consumptionState" Core..=) Core.<$> consumptionState,
                  ("offerId" Core..=) Core.<$> offerId,
                  ("offerTags" Core..=) Core.<$> offerTags,
                  ("offerToken" Core..=) Core.<$> offerToken,
                  ("purchaseOptionId" Core..=) Core.<$> purchaseOptionId,
                  ("quantity" Core..=) Core.<$> quantity,
                  ("refundableQuantity" Core..=) Core.<$> refundableQuantity,
                  ("rentOfferDetails" Core..=) Core.<$> rentOfferDetails])
...
--
-- /See:/ 'newProductPurchaseV2' smart constructor.
data ProductPurchaseV2 = ProductPurchaseV2
    {
      -- | Output only. The acknowledgement state of the purchase.
      acknowledgementState :: (Core.Maybe ProductPurchaseV2_AcknowledgementState)
    ...
    , orderId :: (Core.Maybe Core.Text)
      -- | Contains item-level info for a ProductPurchaseV2.
    , productLineItem :: (Core.Maybe [ProductLineItem])
    ...
    , purchaseCompletionTime :: (Core.Maybe Core.DateTime)
      -- | Information about the purchase state of the purchase.
    , purchaseStateContext :: (Core.Maybe PurchaseStateContext)
      -- | ISO 3166-1 alpha-2 billing region code of the user at the time the product was granted.
    , regionCode :: (Core.Maybe Core.Text)
      -- | Information related to test purchases. This will only be set for test purchases.
    , testPurchaseContext :: (Core.Maybe TestPurchaseContext)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'ProductPurchaseV2' with the minimum fields required to make a request.
newProductPurchaseV2 
    ::  ProductPurchaseV2
newProductPurchaseV2
  = ProductPurchaseV2{acknowledgementState = Core.Nothing,
                      kind = Core.Nothing, obfuscatedExternalAccountId = Core.Nothing,
                      obfuscatedExternalProfileId = Core.Nothing, orderId = Core.Nothing,
                      productLineItem = Core.Nothing,
                      purchaseCompletionTime = Core.Nothing,
                      purchaseStateContext = Core.Nothing, regionCode = Core.Nothing,
                      testPurchaseContext = Core.Nothing}
instance Core.FromJSON ProductPurchaseV2 where
        parseJSON
          = Core.withObject "ProductPurchaseV2"
              (\ o ->
                 ProductPurchaseV2 Core.<$>
                   (o Core..:? "acknowledgementState") Core.<*> (o Core..:? "kind")
                     Core.<*> (o Core..:? "obfuscatedExternalAccountId")
                     Core.<*> (o Core..:? "obfuscatedExternalProfileId")
                     Core.<*> (o Core..:? "orderId")
                     Core.<*> (o Core..:? "productLineItem")
                     Core.<*> (o Core..:? "purchaseCompletionTime")
                     Core.<*> (o Core..:? "purchaseStateContext")
                     Core.<*> (o Core..:? "regionCode")
                     Core.<*> (o Core..:? "testPurchaseContext"))

instance Core.ToJSON ProductPurchaseV2 where
        toJSON ProductPurchaseV2{..}
          = Core.object
              (Core.catMaybes
                 [("acknowledgementState" Core..=) Core.<$> acknowledgementState,
                  ("kind" Core..=) Core.<$> kind,
                  ...
                  ("obfuscatedExternalProfileId" Core..=) Core.<$>
                    obfuscatedExternalProfileId,
                  ("orderId" Core..=) Core.<$> orderId,
                  ("productLineItem" Core..=) Core.<$> productLineItem,
                  ("purchaseCompletionTime" Core..=) Core.<$> purchaseCompletionTime,
                  ("purchaseStateContext" Core..=) Core.<$> purchaseStateContext,
                  ("regionCode" Core..=) Core.<$> regionCode,
                  ("testPurchaseContext" Core..=) Core.<$> testPurchaseContext])
...
--
-- /See:/ 'newPurchaseOptionTaxAndComplianceSettings' smart constructor.
newtype PurchaseOptionTaxAndComplianceSettings = PurchaseOptionTaxAndComplianceSettings
    {
      ...
      withdrawalRightType :: (Core.Maybe
   PurchaseOptionTaxAndComplianceSettings_WithdrawalRightType)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'PurchaseOptionTaxAndComplianceSettings' with the minimum fields required to make a request.
newPurchaseOptionTaxAndComplianceSettings 
    :: 
                                          PurchaseOptionTaxAndComplianceSettings
newPurchaseOptionTaxAndComplianceSettings
  = PurchaseOptionTaxAndComplianceSettings{withdrawalRightType =
                                             Core.Nothing}
instance Core.FromJSON PurchaseOptionTaxAndComplianceSettings where
        parseJSON
          = Core.withObject "PurchaseOptionTaxAndComplianceSettings"
              (\ o ->
                 PurchaseOptionTaxAndComplianceSettings Core.<$>
                   (o Core..:? "withdrawalRightType"))

instance Core.ToJSON PurchaseOptionTaxAndComplianceSettings where
        toJSON PurchaseOptionTaxAndComplianceSettings{..}
          = Core.object
              (Core.catMaybes
                 [("withdrawalRightType" Core..=) Core.<$> withdrawalRightType])


-- | Context about the purchase state.
--
-- /See:/ 'newPurchaseStateContext' smart constructor.
newtype PurchaseStateContext = PurchaseStateContext
    {
      -- | Output only. The purchase state of the purchase.
      purchaseState :: (Core.Maybe PurchaseStateContext_PurchaseState)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'PurchaseStateContext' with the minimum fields required to make a request.
newPurchaseStateContext 
    ::  PurchaseStateContext
newPurchaseStateContext
  = PurchaseStateContext{purchaseState = Core.Nothing}
instance Core.FromJSON PurchaseStateContext where
        parseJSON
          = Core.withObject "PurchaseStateContext"
              (\ o -> PurchaseStateContext Core.<$> (o Core..:? "purchaseState"))

instance Core.ToJSON PurchaseStateContext where
        toJSON PurchaseStateContext{..}
          = Core.object
              (Core.catMaybes [("purchaseState" Core..=) Core.<$> purchaseState])
...
--
-- /See:/ 'newRegionalTaxConfig' smart constructor.
data RegionalTaxConfig = RegionalTaxConfig
    {
    ...
    , streamingTaxType :: (Core.Maybe RegionalTaxConfig_StreamingTaxType)
    ...
    , taxTier :: (Core.Maybe RegionalTaxConfig_TaxTier)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'RegionalTaxConfig' with the minimum fields required to make a request.
newRegionalTaxConfig 
    ::  RegionalTaxConfig
newRegionalTaxConfig
  = RegionalTaxConfig{eligibleForStreamingServiceTaxRate =
                        Core.Nothing,
                      regionCode = Core.Nothing, streamingTaxType = Core.Nothing,
                      taxTier = Core.Nothing}
instance Core.FromJSON RegionalTaxConfig where
        parseJSON
          = Core.withObject "RegionalTaxConfig"
              (\ o ->
                 RegionalTaxConfig Core.<$>
                   (o Core..:? "eligibleForStreamingServiceTaxRate") Core.<*>
                     (o Core..:? "regionCode")
                     Core.<*> (o Core..:? "streamingTaxType")
                     Core.<*> (o Core..:? "taxTier"))

instance Core.ToJSON RegionalTaxConfig where
        toJSON RegionalTaxConfig{..}
          = Core.object
              (Core.catMaybes
...
--
-- /See:/ 'newRentOfferDetails' smart constructor.
data RentOfferDetails = RentOfferDetails
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'RentOfferDetails' with the minimum fields required to make a request.
newRentOfferDetails 
    ::  RentOfferDetails
newRentOfferDetails = RentOfferDetails
instance Core.FromJSON RentOfferDetails where
        parseJSON
          = Core.withObject "RentOfferDetails"
              (\ o -> Core.pure RentOfferDetails)

instance Core.ToJSON RentOfferDetails where
        toJSON = Core.const Core.emptyObject


-- | Details of a rental purchase.
--
-- /See:/ 'newRentalDetails' smart constructor.
data RentalDetails = RentalDetails
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'RentalDetails' with the minimum fields required to make a request.
newRentalDetails 
    ::  RentalDetails
newRentalDetails = RentalDetails
instance Core.FromJSON RentalDetails where
        parseJSON
          = Core.withObject "RentalDetails" (\ o -> Core.pure RentalDetails)

instance Core.ToJSON RentalDetails where
        toJSON = Core.const Core.emptyObject
...
data SubscriptionPurchaseLineItem = SubscriptionPurchaseLineItem
    ...
    , deferredItemRemoval :: (Core.Maybe DeferredItemRemoval)
...
newSubscriptionPurchaseLineItem
  = SubscriptionPurchaseLineItem{autoRenewingPlan = Core.Nothing,
                                 deferredItemRemoval = Core.Nothing,
          ...
          = Core.object
              (Core.catMaybes
                 [("autoRenewingPlan" Core..=) Core.<$> autoRenewingPlan,
                  ("deferredItemRemoval" Core..=) Core.<$> deferredItemRemoval,
...
--
-- /See:/ 'newTestPurchaseContext' smart constructor.
newtype TestPurchaseContext = TestPurchaseContext
    {
      -- | The fop type of the test purchase.
      fopType :: (Core.Maybe TestPurchaseContext_FopType)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'TestPurchaseContext' with the minimum fields required to make a request.
newTestPurchaseContext 
    ::  TestPurchaseContext
newTestPurchaseContext
  = TestPurchaseContext{fopType = Core.Nothing}
instance Core.FromJSON TestPurchaseContext where
        parseJSON
          = Core.withObject "TestPurchaseContext"
              (\ o -> TestPurchaseContext Core.<$> (o Core..:? "fopType"))

instance Core.ToJSON TestPurchaseContext where
        toJSON TestPurchaseContext{..}
          = Core.object
              (Core.catMaybes [("fopType" Core..=) Core.<$> fopType])
...
--
-- /See:/ 'newUpdateOneTimeProductOfferRequest' smart constructor.
data UpdateOneTimeProductOfferRequest = UpdateOneTimeProductOfferRequest
    {
      -- | Optional. If set to true, and the offer with the given package/name, product/id, purchase/option/id and offer/id doesn\'t exist, an offer will be created. If a new offer is created, the update/mask is ignored.
      allowMissing :: (Core.Maybe Core.Bool)
      -- | Optional. The latency tolerance for the propagation of this offer update. Defaults to latency-sensitive.
    , latencyTolerance :: (Core.Maybe UpdateOneTimeProductOfferRequest_LatencyTolerance)
      -- | Required. The one-time product offer to update.
    , oneTimeProductOffer :: (Core.Maybe OneTimeProductOffer)
...
-- | Creates a value of 'UpdateOneTimeProductOfferRequest' with the minimum fields required to make a request.
newUpdateOneTimeProductOfferRequest 
    :: 
                                    UpdateOneTimeProductOfferRequest
newUpdateOneTimeProductOfferRequest
  = UpdateOneTimeProductOfferRequest{allowMissing = Core.Nothing,
                                     latencyTolerance = Core.Nothing,
                                     oneTimeProductOffer = Core.Nothing,
                                     regionsVersion = Core.Nothing, updateMask = Core.Nothing}
instance Core.FromJSON UpdateOneTimeProductOfferRequest where
        parseJSON
          = Core.withObject "UpdateOneTimeProductOfferRequest"
              (\ o ->
                 UpdateOneTimeProductOfferRequest Core.<$>
                   (o Core..:? "allowMissing") Core.<*>
                     (o Core..:? "latencyTolerance")
                     Core.<*> (o Core..:? "oneTimeProductOffer")
                     Core.<*> (o Core..:? "regionsVersion")
                     Core.<*> (o Core..:? "updateMask"))

instance Core.ToJSON UpdateOneTimeProductOfferRequest where
        toJSON UpdateOneTimeProductOfferRequest{..}
          = Core.object
              (Core.catMaybes
                 [("allowMissing" Core..=) Core.<$> allowMissing,
                  ("latencyTolerance" Core..=) Core.<$> latencyTolerance,
                  ("oneTimeProductOffer" Core..=) Core.<$> oneTimeProductOffer,
                  ("regionsVersion" Core..=) Core.<$> regionsVersion,
...
--
-- /See:/ 'newUpdateOneTimeProductOfferStateRequest' smart constructor.
data UpdateOneTimeProductOfferStateRequest = UpdateOneTimeProductOfferStateRequest
    {
      -- | Activates an offer. Once activated, the offer is available to users, as long as its conditions are met.
      activateOneTimeProductOfferRequest :: (Core.Maybe ActivateOneTimeProductOfferRequest)
    ...
    , cancelOneTimeProductOfferRequest :: (Core.Maybe CancelOneTimeProductOfferRequest)
    ...
    , deactivateOneTimeProductOfferRequest :: (Core.Maybe DeactivateOneTimeProductOfferRequest)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'UpdateOneTimeProductOfferStateRequest' with the minimum fields required to make a request.
newUpdateOneTimeProductOfferStateRequest 
    :: 
                                         UpdateOneTimeProductOfferStateRequest
newUpdateOneTimeProductOfferStateRequest
  = UpdateOneTimeProductOfferStateRequest{activateOneTimeProductOfferRequest
                                            = Core.Nothing,
                                          cancelOneTimeProductOfferRequest = Core.Nothing,
                                          deactivateOneTimeProductOfferRequest = Core.Nothing}
instance Core.FromJSON UpdateOneTimeProductOfferStateRequest where
        parseJSON
          = Core.withObject "UpdateOneTimeProductOfferStateRequest"
              (\ o ->
                 UpdateOneTimeProductOfferStateRequest Core.<$>
                   (o Core..:? "activateOneTimeProductOfferRequest") Core.<*>
                     (o Core..:? "cancelOneTimeProductOfferRequest")
                     Core.<*> (o Core..:? "deactivateOneTimeProductOfferRequest"))

instance Core.ToJSON UpdateOneTimeProductOfferStateRequest where
        toJSON UpdateOneTimeProductOfferStateRequest{..}
          = Core.object
              (Core.catMaybes
                 [("activateOneTimeProductOfferRequest" Core..=) Core.<$>
                    activateOneTimeProductOfferRequest,
                  ("cancelOneTimeProductOfferRequest" Core..=) Core.<$>
                    cancelOneTimeProductOfferRequest,
                  ("deactivateOneTimeProductOfferRequest" Core..=) Core.<$>
                    deactivateOneTimeProductOfferRequest])


-- | Request message for UpdateOneTimeProduct.
--
-- /See:/ 'newUpdateOneTimeProductRequest' smart constructor.
data UpdateOneTimeProductRequest = UpdateOneTimeProductRequest
    {
      -- | Optional. If set to true, and the one-time product with the given package/name and product/id doesn\'t exist, the one-time product will be created. If a new one-time product is created, update_mask is ignored.
      allowMissing :: (Core.Maybe Core.Bool)
      -- | Optional. The latency tolerance for the propagation of this product upsert. Defaults to latency-sensitive.
    , latencyTolerance :: (Core.Maybe UpdateOneTimeProductRequest_LatencyTolerance)
      -- | Required. The one-time product to upsert.
    , oneTimeProduct :: (Core.Maybe OneTimeProduct)
...
-- | Creates a value of 'UpdateOneTimeProductRequest' with the minimum fields required to make a request.
newUpdateOneTimeProductRequest 
    ::  UpdateOneTimeProductRequest
newUpdateOneTimeProductRequest
  = UpdateOneTimeProductRequest{allowMissing = Core.Nothing,
                                latencyTolerance = Core.Nothing, oneTimeProduct = Core.Nothing,
                                regionsVersion = Core.Nothing, updateMask = Core.Nothing}
instance Core.FromJSON UpdateOneTimeProductRequest where
        parseJSON
          = Core.withObject "UpdateOneTimeProductRequest"
              (\ o ->
                 UpdateOneTimeProductRequest Core.<$>
                   (o Core..:? "allowMissing") Core.<*>
                     (o Core..:? "latencyTolerance")
                     Core.<*> (o Core..:? "oneTimeProduct")
                     Core.<*> (o Core..:? "regionsVersion")
                     Core.<*> (o Core..:? "updateMask"))

instance Core.ToJSON UpdateOneTimeProductRequest where
        toJSON UpdateOneTimeProductRequest{..}
          = Core.object
              (Core.catMaybes
                 [("allowMissing" Core..=) Core.<$> allowMissing,
                  ("latencyTolerance" Core..=) Core.<$> latencyTolerance,
                  ("oneTimeProduct" Core..=) Core.<$> oneTimeProduct,
                  ("regionsVersion" Core..=) Core.<$> regionsVersion,
                  ("updateMask" Core..=) Core.<$> updateMask])
...
--
-- /See:/ 'newUpdatePurchaseOptionStateRequest' smart constructor.
data UpdatePurchaseOptionStateRequest = UpdatePurchaseOptionStateRequest
    {
      -- | Activates a purchase option. Once activated, the purchase option will be available.
      activatePurchaseOptionRequest :: (Core.Maybe ActivatePurchaseOptionRequest)
      -- | Deactivates a purchase option. Once deactivated, the purchase option will become unavailable.
    , deactivatePurchaseOptionRequest :: (Core.Maybe DeactivatePurchaseOptionRequest)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'UpdatePurchaseOptionStateRequest' with the minimum fields required to make a request.
newUpdatePurchaseOptionStateRequest 
    :: 
                                    UpdatePurchaseOptionStateRequest
newUpdatePurchaseOptionStateRequest
  = UpdatePurchaseOptionStateRequest{activatePurchaseOptionRequest =
                                       Core.Nothing,
                                     deactivatePurchaseOptionRequest = Core.Nothing}
instance Core.FromJSON UpdatePurchaseOptionStateRequest where
        parseJSON
          = Core.withObject "UpdatePurchaseOptionStateRequest"
              (\ o ->
                 UpdatePurchaseOptionStateRequest Core.<$>
                   (o Core..:? "activatePurchaseOptionRequest") Core.<*>
                     (o Core..:? "deactivatePurchaseOptionRequest"))

instance Core.ToJSON UpdatePurchaseOptionStateRequest where
        toJSON UpdatePurchaseOptionStateRequest{..}
          = Core.object
              (Core.catMaybes
                 [("activatePurchaseOptionRequest" Core..=) Core.<$>
                    activatePurchaseOptionRequest,
                  ("deactivatePurchaseOptionRequest" Core..=) Core.<$>
                    deactivatePurchaseOptionRequest])
