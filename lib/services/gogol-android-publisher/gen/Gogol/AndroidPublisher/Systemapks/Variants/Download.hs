           ...
           Core.Capture "packageName" Core.Text Core.:>
             "systemApks" Core.:>
               Core.Capture "versionCode" Core.Int64 Core.:>
                 "variants" Core.:>
                   Core.CaptureMode "variantId" "download" Core.Word32 Core.:>
...
newAndroidPublisherSystemapksVariantsDownload 
    ...
    -> AndroidPublisherSystemapksVariantsDownload
newAndroidPublisherSystemapksVariantsDownload packageName variantId
  versionCode
  = AndroidPublisherSystemapksVariantsDownload{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes AndroidPublisherSystemapksVariantsDownload =
