                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.ReqBody '[Core.JSON] Variant Core.:>
                                 Core.Post '[Core.JSON] Variant
...
newAndroidPublisherSystemapksVariantsCreate 
    ...
    -> AndroidPublisherSystemapksVariantsCreate
newAndroidPublisherSystemapksVariantsCreate packageName payload
  versionCode
  = AndroidPublisherSystemapksVariantsCreate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes AndroidPublisherSystemapksVariantsCreate =
             '[Androidpublisher'FullControl]
        requestClient AndroidPublisherSystemapksVariantsCreate{..}
          = go packageName versionCode xgafv accessToken callback uploadType
              uploadProtocol
