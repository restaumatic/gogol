...
newAndroidPublisherSystemapksVariantsList packageName versionCode
  = AndroidPublisherSystemapksVariantsList{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           packageName = packageName, uploadType = Core.Nothing,
                                           uploadProtocol = Core.Nothing, versionCode = versionCode}
instance Core.GoogleRequest AndroidPublisherSystemapksVariantsList
         where
