           ...
           Core.Capture "packageName" Core.Text Core.:>
             "systemApks" Core.:>
               Core.Capture "versionCode" Core.Int64 Core.:>
                 "variants" Core.:>
                   Core.Capture "variantId" Core.Word32 Core.:>
...
newAndroidPublisherSystemapksVariantsGet 
    ...
    -> AndroidPublisherSystemapksVariantsGet
newAndroidPublisherSystemapksVariantsGet packageName variantId
  versionCode
  = AndroidPublisherSystemapksVariantsGet{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          packageName = packageName, uploadType = Core.Nothing,
                                          uploadProtocol = Core.Nothing, variantId = variantId,
                                          versionCode = versionCode}
instance Core.GoogleRequest AndroidPublisherSystemapksVariantsGet
         where
        type Rs AndroidPublisherSystemapksVariantsGet = Variant
        type Scopes AndroidPublisherSystemapksVariantsGet =
             '[Androidpublisher'FullControl]
        requestClient AndroidPublisherSystemapksVariantsGet{..}
          = go packageName versionCode variantId xgafv accessToken callback
              uploadType
              uploadProtocol
