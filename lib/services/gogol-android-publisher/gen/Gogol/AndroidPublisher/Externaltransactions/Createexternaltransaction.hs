             ...
             Core.QueryParam "$.xgafv" Xgafv Core.:>
               Core.QueryParam "access_token" Core.Text Core.:>
                 Core.QueryParam "callback" Core.Text Core.:>
                   Core.QueryParam "externalTransactionId" Core.Text Core.:>
...
newAndroidPublisherExternaltransactionsCreateexternaltransaction
  parent payload
  = AndroidPublisherExternaltransactionsCreateexternaltransaction{xgafv
                                                                    = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        requestClient
          AndroidPublisherExternaltransactionsCreateexternaltransaction{..}
          = go parent xgafv accessToken callback externalTransactionId
              uploadType
              uploadProtocol
