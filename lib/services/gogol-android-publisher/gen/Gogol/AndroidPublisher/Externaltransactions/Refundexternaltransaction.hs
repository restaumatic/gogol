...
type AndroidPublisherExternaltransactionsRefundexternaltransactionResource
     ...
     "androidpublisher" Core.:>
       "v3" Core.:>
         Core.CaptureMode "name" "refund" Core.Text Core.:>
                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] RefundExternalTransactionRequest Core.:>
...
newAndroidPublisherExternaltransactionsRefundexternaltransaction
  name payload
  = AndroidPublisherExternaltransactionsRefundexternaltransaction{xgafv
                                                                    = Core.Nothing,
