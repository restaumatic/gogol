                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.Get '[Core.JSON] ExternalTransaction
...
newAndroidPublisherExternaltransactionsGetexternaltransaction name
  = AndroidPublisherExternaltransactionsGetexternaltransaction{xgafv
                                                                 = Core.Nothing,
...
instance Core.GoogleRequest
           AndroidPublisherExternaltransactionsGetexternaltransaction
         where
        type Rs AndroidPublisherExternaltransactionsGetexternaltransaction
             = ExternalTransaction
        type Scopes
               AndroidPublisherExternaltransactionsGetexternaltransaction
