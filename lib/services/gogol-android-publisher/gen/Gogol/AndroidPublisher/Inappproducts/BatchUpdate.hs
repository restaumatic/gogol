       ...
       "v3" Core.:>
         "applications" Core.:>
           Core.Capture "packageName" Core.Text Core.:>
             "inappproducts:batchUpdate" Core.:>
                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] InappproductsBatchUpdateRequest Core.:>
                             Core.Post '[Core.JSON] InappproductsBatchUpdateResponse
...
newAndroidPublisherInappproductsBatchUpdate packageName payload
  = AndroidPublisherInappproductsBatchUpdate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           AndroidPublisherInappproductsBatchUpdate
         where
        type Rs AndroidPublisherInappproductsBatchUpdate =
             InappproductsBatchUpdateResponse
        type Scopes AndroidPublisherInappproductsBatchUpdate =
