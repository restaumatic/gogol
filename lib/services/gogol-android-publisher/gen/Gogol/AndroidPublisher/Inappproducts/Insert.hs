...
newAndroidPublisherInappproductsInsert packageName payload
  = AndroidPublisherInappproductsInsert{xgafv = Core.Nothing,
...
instance Core.GoogleRequest AndroidPublisherInappproductsInsert
         where
        ...
        requestClient AndroidPublisherInappproductsInsert{..}
          = go packageName xgafv accessToken autoConvertMissingPrices
              callback
              uploadType
              uploadProtocol
