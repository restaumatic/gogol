       ...
       "v3" Core.:>
         "applications" Core.:>
           Core.Capture "packageName" Core.Text Core.:>
             "inappproducts:batchDelete" Core.:>
                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] InappproductsBatchDeleteRequest Core.:>
                             Core.Post '[Core.JSON] ()
...
newAndroidPublisherInappproductsBatchDelete packageName payload
  = AndroidPublisherInappproductsBatchDelete{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes AndroidPublisherInappproductsBatchDelete =
