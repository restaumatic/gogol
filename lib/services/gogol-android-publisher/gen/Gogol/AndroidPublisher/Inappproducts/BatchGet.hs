       ...
       "v3" Core.:>
         "applications" Core.:>
           Core.Capture "packageName" Core.Text Core.:>
             "inappproducts:batchGet" Core.:>
               Core.QueryParam "$.xgafv" Xgafv Core.:>
                 Core.QueryParam "access_token" Core.Text Core.:>
                   Core.QueryParam "callback" Core.Text Core.:>
                     Core.QueryParams "sku" Core.Text Core.:>
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] InappproductsBatchGetResponse
...
newAndroidPublisherInappproductsBatchGet packageName
  = AndroidPublisherInappproductsBatchGet{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          packageName = packageName, sku = Core.Nothing,
                                          uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AndroidPublisherInappproductsBatchGet
         where
        type Rs AndroidPublisherInappproductsBatchGet =
             InappproductsBatchGetResponse
        type Scopes AndroidPublisherInappproductsBatchGet =
