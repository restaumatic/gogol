               ...
               Core.Capture "sku" Core.Text Core.:>
                 Core.QueryParam "$.xgafv" Xgafv Core.:>
                   Core.QueryParam "access_token" Core.Text Core.:>
                     Core.QueryParam "autoConvertMissingPrices" Core.Bool Core.:>
...
newAndroidPublisherInappproductsPatch packageName payload sku
  = AndroidPublisherInappproductsPatch{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing,
                                       autoConvertMissingPrices = Core.Nothing,
                                       callback = Core.Nothing, latencyTolerance = Core.Nothing,
                                       packageName = packageName, payload = payload, sku = sku,
                                       uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AndroidPublisherInappproductsPatch
         where
        ...
        requestClient AndroidPublisherInappproductsPatch{..}
          = go packageName sku xgafv accessToken autoConvertMissingPrices
              callback
              latencyTolerance
              uploadType
              uploadProtocol
