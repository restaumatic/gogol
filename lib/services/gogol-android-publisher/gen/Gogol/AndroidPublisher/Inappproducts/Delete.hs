...
newAndroidPublisherInappproductsDelete packageName sku
  = AndroidPublisherInappproductsDelete{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        latencyTolerance = Core.Nothing, packageName = packageName,
                                        sku = sku, uploadType = Core.Nothing,
                                        uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AndroidPublisherInappproductsDelete
         where
        ...
        requestClient AndroidPublisherInappproductsDelete{..}
          = go packageName sku xgafv accessToken callback latencyTolerance
              uploadType
              uploadProtocol
