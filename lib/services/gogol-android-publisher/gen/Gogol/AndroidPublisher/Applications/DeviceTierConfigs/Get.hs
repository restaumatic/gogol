         ...
         "applications" Core.:>
           Core.Capture "packageName" Core.Text Core.:>
             "deviceTierConfigs" Core.:>
               Core.Capture "deviceTierConfigId" Core.Int64 Core.:>
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] DeviceTierConfig
...
newAndroidPublisherApplicationsDeviceTierConfigsGet
  ...
  = AndroidPublisherApplicationsDeviceTierConfigsGet{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           AndroidPublisherApplicationsDeviceTierConfigsGet
         where
        type Rs AndroidPublisherApplicationsDeviceTierConfigsGet =
             DeviceTierConfig
        type Scopes AndroidPublisherApplicationsDeviceTierConfigsGet =
             '[Androidpublisher'FullControl]
        requestClient AndroidPublisherApplicationsDeviceTierConfigsGet{..}
          = go packageName deviceTierConfigId xgafv accessToken callback
              uploadType
              uploadProtocol
