                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Get '[Core.JSON] ListDeviceTierConfigsResponse
...
newAndroidPublisherApplicationsDeviceTierConfigsList packageName
  = AndroidPublisherApplicationsDeviceTierConfigsList{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           AndroidPublisherApplicationsDeviceTierConfigsList
         where
        type Rs AndroidPublisherApplicationsDeviceTierConfigsList =
             ListDeviceTierConfigsResponse
        type Scopes AndroidPublisherApplicationsDeviceTierConfigsList =
