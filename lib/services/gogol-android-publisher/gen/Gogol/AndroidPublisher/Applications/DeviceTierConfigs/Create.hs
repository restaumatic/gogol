             ...
             "deviceTierConfigs" Core.:>
               Core.QueryParam "$.xgafv" Xgafv Core.:>
                 Core.QueryParam "access_token" Core.Text Core.:>
                   Core.QueryParam "allowUnknownDevices" Core.Bool Core.:>
                     Core.QueryParam "callback" Core.Text Core.:>
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] DeviceTierConfig Core.:>
                               Core.Post '[Core.JSON] DeviceTierConfig
...
newAndroidPublisherApplicationsDeviceTierConfigsCreate 
    ...
    -> AndroidPublisherApplicationsDeviceTierConfigsCreate
newAndroidPublisherApplicationsDeviceTierConfigsCreate packageName
  payload
  = AndroidPublisherApplicationsDeviceTierConfigsCreate{xgafv =
                                                          Core.Nothing,
...
instance Core.GoogleRequest
           AndroidPublisherApplicationsDeviceTierConfigsCreate
         where
        type Rs AndroidPublisherApplicationsDeviceTierConfigsCreate =
             DeviceTierConfig
        type Scopes AndroidPublisherApplicationsDeviceTierConfigsCreate =
             '[Androidpublisher'FullControl]
        requestClient
          AndroidPublisherApplicationsDeviceTierConfigsCreate{..}
          = go packageName xgafv accessToken allowUnknownDevices callback
              uploadType
              uploadProtocol
