...
newAndroidPublisherInternalappsharingartifactsUploadbundle
  packageName
  = AndroidPublisherInternalappsharingartifactsUploadbundle{xgafv =
                                                              Core.Nothing,
...
instance Core.GoogleRequest
           AndroidPublisherInternalappsharingartifactsUploadbundle
         where
        type Rs AndroidPublisherInternalappsharingartifactsUploadbundle =
             InternalAppSharingArtifact
        type Scopes AndroidPublisherInternalappsharingartifactsUploadbundle
...
instance Core.GoogleRequest
        ...
        requestClient
          (Core.MediaUpload
             AndroidPublisherInternalappsharingartifactsUploadbundle{..} body)
          = go packageName xgafv accessToken callback uploadType
              uploadProtocol
              (Core.Just Core.AltJSON)
