...
newAndroidPublisherInternalappsharingartifactsUploadapk packageName
  = AndroidPublisherInternalappsharingartifactsUploadapk{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           AndroidPublisherInternalappsharingartifactsUploadapk
         where
        type Rs AndroidPublisherInternalappsharingartifactsUploadapk =
             InternalAppSharingArtifact
        type Scopes AndroidPublisherInternalappsharingartifactsUploadapk =
...
instance Core.GoogleRequest
        ...
        requestClient
          (Core.MediaUpload
             AndroidPublisherInternalappsharingartifactsUploadapk{..} body)
          = go packageName xgafv accessToken callback uploadType
              uploadProtocol
              (Core.Just Core.AltJSON)
