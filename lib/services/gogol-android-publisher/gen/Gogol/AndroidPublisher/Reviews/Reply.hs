                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] ReviewsReplyRequest Core.:>
...
newAndroidPublisherReviewsReply packageName payload reviewId
  = AndroidPublisherReviewsReply{xgafv = Core.Nothing,
                                 accessToken = Core.Nothing, callback = Core.Nothing,
                                 packageName = packageName, payload = payload, reviewId = reviewId,
...
instance Core.GoogleRequest AndroidPublisherReviewsReply where
        ...
        requestClient AndroidPublisherReviewsReply{..}
          = go packageName reviewId xgafv accessToken callback uploadType
              uploadProtocol
