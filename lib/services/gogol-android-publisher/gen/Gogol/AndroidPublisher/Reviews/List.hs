                     ...
                     Core.QueryParam "maxResults" Core.Word32 Core.:>
                       Core.QueryParam "startIndex" Core.Word32 Core.:>
                         Core.QueryParam "token" Core.Text Core.:>
                           Core.QueryParam "translationLanguage" Core.Text Core.:>
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.Get '[Core.JSON] ReviewsListResponse
...
newAndroidPublisherReviewsList packageName
  = AndroidPublisherReviewsList{xgafv = Core.Nothing,
                                accessToken = Core.Nothing, callback = Core.Nothing,
                                maxResults = Core.Nothing, packageName = packageName,
                                startIndex = Core.Nothing, token = Core.Nothing,
                                translationLanguage = Core.Nothing, uploadType = Core.Nothing,
...
instance Core.GoogleRequest AndroidPublisherReviewsList where
        ...
        type Scopes AndroidPublisherReviewsList =
             '[Androidpublisher'FullControl]
        requestClient AndroidPublisherReviewsList{..}
          = go packageName xgafv accessToken callback maxResults startIndex
              token
              translationLanguage
              uploadType
              uploadProtocol
