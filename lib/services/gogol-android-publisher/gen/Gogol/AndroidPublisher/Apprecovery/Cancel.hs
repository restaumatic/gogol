       ...
       "v3" Core.:>
         "applications" Core.:>
           Core.Capture "packageName" Core.Text Core.:>
             "appRecoveries" Core.:>
               Core.CaptureMode "appRecoveryId" "cancel" Core.Int64 Core.:>
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] CancelAppRecoveryRequest Core.:>
...
newAndroidPublisherApprecoveryCancel 
    ...
    -> AndroidPublisherApprecoveryCancel
newAndroidPublisherApprecoveryCancel appRecoveryId packageName
  payload
  = AndroidPublisherApprecoveryCancel{xgafv = Core.Nothing,
