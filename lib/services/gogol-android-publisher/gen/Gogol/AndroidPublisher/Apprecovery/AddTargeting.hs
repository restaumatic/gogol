       ...
       "v3" Core.:>
         "applications" Core.:>
           Core.Capture "packageName" Core.Text Core.:>
             "appRecoveries" Core.:>
               Core.CaptureMode "appRecoveryId" "addTargeting" Core.Int64 Core.:>
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] AddTargetingRequest Core.:>
...
newAndroidPublisherApprecoveryAddTargeting 
    ...
    -> AndroidPublisherApprecoveryAddTargeting
newAndroidPublisherApprecoveryAddTargeting appRecoveryId
  packageName payload
  = AndroidPublisherApprecoveryAddTargeting{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing,
                                            appRecoveryId = appRecoveryId, callback = Core.Nothing,
                                            packageName = packageName, payload = payload,
                                            uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AndroidPublisherApprecoveryAddTargeting
         where
