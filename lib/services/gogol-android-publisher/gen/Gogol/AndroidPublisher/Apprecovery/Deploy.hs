       ...
       "v3" Core.:>
         "applications" Core.:>
           Core.Capture "packageName" Core.Text Core.:>
             "appRecoveries" Core.:>
               Core.CaptureMode "appRecoveryId" "deploy" Core.Int64 Core.:>
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] DeployAppRecoveryRequest Core.:>
                               Core.Post '[Core.JSON] DeployAppRecoveryResponse
...
newAndroidPublisherApprecoveryDeploy 
    ...
    -> AndroidPublisherApprecoveryDeploy
newAndroidPublisherApprecoveryDeploy appRecoveryId packageName
  payload
  = AndroidPublisherApprecoveryDeploy{xgafv = Core.Nothing,
                                      accessToken = Core.Nothing, appRecoveryId = appRecoveryId,
...
instance Core.GoogleRequest AndroidPublisherApprecoveryDeploy where
        type Rs AndroidPublisherApprecoveryDeploy =
             DeployAppRecoveryResponse
        type Scopes AndroidPublisherApprecoveryDeploy =
             '[Androidpublisher'FullControl]
        requestClient AndroidPublisherApprecoveryDeploy{..}
          = go packageName appRecoveryId xgafv accessToken callback
              uploadType
              uploadProtocol
