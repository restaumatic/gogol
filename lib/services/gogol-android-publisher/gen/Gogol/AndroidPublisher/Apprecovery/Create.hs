                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] CreateDraftAppRecoveryRequest Core.:>
                             Core.Post '[Core.JSON] AppRecoveryAction
...
newAndroidPublisherApprecoveryCreate packageName payload
  = AndroidPublisherApprecoveryCreate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest AndroidPublisherApprecoveryCreate where
        ...
        type Scopes AndroidPublisherApprecoveryCreate =
