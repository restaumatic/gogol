...
newAmpUrl 
    ::  AmpUrl
newAmpUrl
  = AmpUrl{ampUrl = Core.Nothing, cdnAmpUrl = Core.Nothing,
           originalUrl = Core.Nothing}
instance Core.FromJSON AmpUrl where
        parseJSON
          = Core.withObject "AmpUrl"
              (\ o ->
                 AmpUrl Core.<$>
                   (o Core..:? "ampUrl") Core.<*> (o Core..:? "cdnAmpUrl") Core.<*>
                     (o Core..:? "originalUrl"))
...
newAmpUrlError 
    ::  AmpUrlError
newAmpUrlError
  = AmpUrlError{errorCode = Core.Nothing,
                errorMessage = Core.Nothing, originalUrl = Core.Nothing}
instance Core.FromJSON AmpUrlError where
        parseJSON
          = Core.withObject "AmpUrlError"
              (\ o ->
                 AmpUrlError Core.<$>
...
newBatchGetAmpUrlsRequest 
    ::  BatchGetAmpUrlsRequest
newBatchGetAmpUrlsRequest
  = BatchGetAmpUrlsRequest{lookupStrategy = Core.Nothing,
                           urls = Core.Nothing}
instance Core.FromJSON BatchGetAmpUrlsRequest where
        parseJSON
          = Core.withObject "BatchGetAmpUrlsRequest"
              (\ o ->
                 BatchGetAmpUrlsRequest Core.<$>
                   (o Core..:? "lookupStrategy") Core.<*> (o Core..:? "urls"))
...
newBatchGetAmpUrlsResponse 
    ::  BatchGetAmpUrlsResponse
newBatchGetAmpUrlsResponse
  = BatchGetAmpUrlsResponse{ampUrls = Core.Nothing,
                            urlErrors = Core.Nothing}
instance Core.FromJSON BatchGetAmpUrlsResponse where
        parseJSON
          = Core.withObject "BatchGetAmpUrlsResponse"
              (\ o ->
                 BatchGetAmpUrlsResponse Core.<$>
                   (o Core..:? "ampUrls") Core.<*> (o Core..:? "urlErrors"))
