...
-- |
-- Module      : Gogol.OSLogin.Users.SshPublicKeys.Delete
...
newOSLoginUsersSshPublicKeysDelete name
  = OSLoginUsersSshPublicKeysDelete{xgafv = Core.Nothing,
                                    accessToken = Core.Nothing, callback = Core.Nothing,
                                    name = name, uploadType = Core.Nothing,
                                    uploadProtocol = Core.Nothing}
instance Core.GoogleRequest OSLoginUsersSshPublicKeysDelete where
        type Rs OSLoginUsersSshPublicKeysDelete = Empty
        type Scopes OSLoginUsersSshPublicKeysDelete =
        ...
        requestClient OSLoginUsersSshPublicKeysDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy OSLoginUsersSshPublicKeysDeleteResource)
                      Core.mempty
