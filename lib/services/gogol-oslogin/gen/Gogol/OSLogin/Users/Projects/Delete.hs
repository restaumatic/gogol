...
instance Core.GoogleRequest OSLoginUsersProjectsDelete where
        ...
        requestClient OSLoginUsersProjectsDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy OSLoginUsersProjectsDeleteResource)
                      Core.mempty
