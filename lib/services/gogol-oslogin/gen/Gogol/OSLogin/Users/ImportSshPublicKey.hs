...
type OSLoginUsersImportSshPublicKeyResource =
     "v1" Core.:>
       Core.CaptureMode "parent" "importSshPublicKey" Core.Text Core.:>
         Core.QueryParam "$.xgafv" Xgafv Core.:>
           Core.QueryParam "access_token" Core.Text Core.:>
             Core.QueryParam "callback" Core.Text Core.:>
               Core.QueryParam "projectId" Core.Text Core.:>
                 Core.QueryParams "regions" Core.Text Core.:>
...
newOSLoginUsersImportSshPublicKey parent payload
  = OSLoginUsersImportSshPublicKey{xgafv = Core.Nothing,
                                   accessToken = Core.Nothing, callback = Core.Nothing,
                                   parent = parent, payload = payload, projectId = Core.Nothing,
                                   regions = Core.Nothing, uploadType = Core.Nothing,
                                   uploadProtocol = Core.Nothing}
instance Core.GoogleRequest OSLoginUsersImportSshPublicKey where
        type Rs OSLoginUsersImportSshPublicKey = ImportSshPublicKeyResponse
        ...
        requestClient OSLoginUsersImportSshPublicKey{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy OSLoginUsersImportSshPublicKeyResource)
                      Core.mempty
