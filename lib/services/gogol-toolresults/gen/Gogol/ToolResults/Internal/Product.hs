...
instance Core.FromJSON AvailableDeepLinks where
        parseJSON
          = Core.withObject "AvailableDeepLinks"
...
instance Core.FromJSON CrashDialogError where
        parseJSON
          = Core.withObject "CrashDialogError"
...
newEncounteredLoginScreen 
    ::  EncounteredLoginScreen
newEncounteredLoginScreen
  = EncounteredLoginScreen{distinctScreens = Core.Nothing,
                           screenIds = Core.Nothing}
instance Core.FromJSON EncounteredLoginScreen where
        parseJSON
          = Core.withObject "EncounteredLoginScreen"
              (\ o ->
                 EncounteredLoginScreen Core.<$>
                   (o Core..:? "distinctScreens") Core.<*> (o Core..:? "screenIds"))
...
newEncounteredNonAndroidUiWidgetScreen 
    :: 
                                       EncounteredNonAndroidUiWidgetScreen
newEncounteredNonAndroidUiWidgetScreen
  = EncounteredNonAndroidUiWidgetScreen{distinctScreens =
                                          Core.Nothing,
                                        screenIds = Core.Nothing}
instance Core.FromJSON EncounteredNonAndroidUiWidgetScreen where
        parseJSON
          = Core.withObject "EncounteredNonAndroidUiWidgetScreen"
              (\ o ->
                 EncounteredNonAndroidUiWidgetScreen Core.<$>
                   (o Core..:? "distinctScreens") Core.<*> (o Core..:? "screenIds"))
...
instance Core.FromJSON FailedToInstall where
        parseJSON
          = Core.withObject "FailedToInstall"
...
instance Core.FromJSON FatalException where
        parseJSON
          = Core.withObject "FatalException"
...
newInAppPurchasesFound 
    ::  InAppPurchasesFound
newInAppPurchasesFound
  = InAppPurchasesFound{inAppPurchasesFlowsExplored = Core.Nothing,
                        inAppPurchasesFlowsStarted = Core.Nothing}
instance Core.FromJSON InAppPurchasesFound where
        parseJSON
          = Core.withObject "InAppPurchasesFound"
              (\ o ->
                 InAppPurchasesFound Core.<$>
                   (o Core..:? "inAppPurchasesFlowsExplored") Core.<*>
                     (o Core..:? "inAppPurchasesFlowsStarted"))

instance Core.ToJSON InAppPurchasesFound where
        toJSON InAppPurchasesFound{..}
          = Core.object
              (Core.catMaybes
                 [("inAppPurchasesFlowsExplored" Core..=) Core.<$>
                    inAppPurchasesFlowsExplored,
                  ("inAppPurchasesFlowsStarted" Core..=) Core.<$>
...
instance Core.FromJSON InsufficientCoverage where
        parseJSON
          = Core.withObject "InsufficientCoverage"
...
instance Core.FromJSON LauncherActivityNotFound where
        parseJSON
          = Core.withObject "LauncherActivityNotFound"
...
newNonSdkApi 
    ::  NonSdkApi
newNonSdkApi
  = NonSdkApi{apiSignature = Core.Nothing,
              exampleStackTraces = Core.Nothing, insights = Core.Nothing,
              invocationCount = Core.Nothing, list = Core.Nothing}
instance Core.FromJSON NonSdkApi where
        parseJSON
          = Core.withObject "NonSdkApi"
              (\ o ->
                 NonSdkApi Core.<$>
                   (o Core..:? "apiSignature") Core.<*>
                     (o Core..:? "exampleStackTraces")
...
newNonSdkApiInsight 
    ::  NonSdkApiInsight
newNonSdkApiInsight
  = NonSdkApiInsight{exampleTraceMessages = Core.Nothing,
...
instance Core.FromJSON NonSdkApiInsight where
        parseJSON
          = Core.withObject "NonSdkApiInsight"
              (\ o ->
                 NonSdkApiInsight Core.<$>
                   (o Core..:? "exampleTraceMessages") Core.<*>
                     (o Core..:? "matcherId")
          ...
          = Core.object
              (Core.catMaybes
                 [("exampleTraceMessages" Core..=) Core.<$> exampleTraceMessages,
                  ...
                  ("pendingGoogleUpdateInsight" Core..=) Core.<$>
                    pendingGoogleUpdateInsight,
...
newNonSdkApiUsageViolation 
    ::  NonSdkApiUsageViolation
newNonSdkApiUsageViolation
  = NonSdkApiUsageViolation{apiSignatures = Core.Nothing,
                            uniqueApis = Core.Nothing}
instance Core.FromJSON NonSdkApiUsageViolation where
        parseJSON
          = Core.withObject "NonSdkApiUsageViolation"
              (\ o ->
                 NonSdkApiUsageViolation Core.<$>
                   (o Core..:? "apiSignatures") Core.<*> (o Core..:? "uniqueApis"))
...
newNonSdkApiUsageViolationReport 
    ::  NonSdkApiUsageViolationReport
newNonSdkApiUsageViolationReport
  = NonSdkApiUsageViolationReport{exampleApis = Core.Nothing,
                                  minSdkVersion = Core.Nothing, targetSdkVersion = Core.Nothing,
                                  uniqueApis = Core.Nothing}
instance Core.FromJSON NonSdkApiUsageViolationReport where
        parseJSON
          = Core.withObject "NonSdkApiUsageViolationReport"
              (\ o ->
                 NonSdkApiUsageViolationReport Core.<$>
                   (o Core..:? "exampleApis") Core.<*> (o Core..:? "minSdkVersion")
...
newOverlappingUIElements 
    ::  OverlappingUIElements
newOverlappingUIElements
  = OverlappingUIElements{resourceName = Core.Nothing,
                          screenId = Core.Nothing}
instance Core.FromJSON OverlappingUIElements where
        parseJSON
          = Core.withObject "OverlappingUIElements"
              (\ o ->
                 OverlappingUIElements Core.<$>
                   (o Core..:? "resourceName") Core.<*> (o Core..:? "screenId"))
...
instance Core.FromJSON PendingGoogleUpdateInsight where
        parseJSON
          = Core.withObject "PendingGoogleUpdateInsight"
              (\ o ->
                 PendingGoogleUpdateInsight Core.<$>
                   (o Core..:? "nameOfGoogleLibrary"))
...
instance Core.FromJSON PerformedGoogleLogin where
        parseJSON
          = Core.withObject "PerformedGoogleLogin"
...
instance Core.FromJSON PerformedMonkeyActions where
        parseJSON
          = Core.withObject "PerformedMonkeyActions"
              (\ o ->
...
newRoboScriptExecution 
    ::  RoboScriptExecution
newRoboScriptExecution
  = RoboScriptExecution{successfulActions = Core.Nothing,
                        totalActions = Core.Nothing}
instance Core.FromJSON RoboScriptExecution where
        parseJSON
          = Core.withObject "RoboScriptExecution"
              (\ o ->
                 RoboScriptExecution Core.<$>
                   (o Core..:? "successfulActions") Core.<*>
                     (o Core..:? "totalActions"))
...
instance Core.FromJSON StartActivityNotFound where
        parseJSON
          = Core.withObject "StartActivityNotFound"
              (\ o ->
                 StartActivityNotFound Core.<$>
                   (o Core..:? "action") Core.<*> (o Core..:? "uri"))
...
newUIElementTooDeep 
    ::  UIElementTooDeep
newUIElementTooDeep
  = UIElementTooDeep{depth = Core.Nothing, screenId = Core.Nothing,
                     screenStateId = Core.Nothing}
instance Core.FromJSON UIElementTooDeep where
        parseJSON
          = Core.withObject "UIElementTooDeep"
              (\ o ->
                 UIElementTooDeep Core.<$>
                   (o Core..:? "depth") Core.<*> (o Core..:? "screenId") Core.<*>
                     (o Core..:? "screenStateId"))
...
instance Core.FromJSON UnspecifiedWarning where
        parseJSON
          = Core.withObject "UnspecifiedWarning"
...
instance Core.FromJSON UnusedRoboDirective where
        parseJSON
          = Core.withObject "UnusedRoboDirective"
...
instance Core.FromJSON UsedRoboDirective where
        parseJSON
          = Core.withObject "UsedRoboDirective"
...
instance Core.FromJSON UsedRoboIgnoreDirective where
        parseJSON
          = Core.withObject "UsedRoboIgnoreDirective"
              (\ o ->
