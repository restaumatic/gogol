                                 ...
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "waitToken" Core.Text Core.:>
                                     Core.QueryParam "alt" Core.AltJSON Core.:>
                                       Core.Get '[Core.JSON] ListBreakpointsResponse
...
newClouddebuggerDebuggerDebuggeesBreakpointsList debuggeeId
  = ClouddebuggerDebuggerDebuggeesBreakpointsList{xgafv =
                                                    Core.Nothing,
