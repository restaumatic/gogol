...
newClouddebuggerDebuggerDebuggeesBreakpointsSet debuggeeId payload
  = ClouddebuggerDebuggerDebuggeesBreakpointsSet{xgafv =
                                                   Core.Nothing,
                                                 accessToken = Core.Nothing,
                                                 callback = Core.Nothing,
                                                 canaryOption = Core.Nothing,
                                                 clientVersion = Core.Nothing,
                                                 debuggeeId = debuggeeId, payload = payload,
...
instance Core.GoogleRequest
        ...
        type Scopes ClouddebuggerDebuggerDebuggeesBreakpointsSet =
             '[CloudPlatform'FullControl, CloudDebugger'FullControl]
        requestClient ClouddebuggerDebuggerDebuggeesBreakpointsSet{..}
          = go debuggeeId xgafv accessToken callback canaryOption
              clientVersion
              uploadType
              uploadProtocol
