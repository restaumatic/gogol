...
newClouddebuggerDebuggerDebuggeesBreakpointsGet 
    ...
    -> ClouddebuggerDebuggerDebuggeesBreakpointsGet
newClouddebuggerDebuggerDebuggeesBreakpointsGet breakpointId
  debuggeeId
  = ClouddebuggerDebuggerDebuggeesBreakpointsGet{xgafv =
                                                   Core.Nothing,
                                                 accessToken = Core.Nothing,
                                                 breakpointId = breakpointId,
                                                 callback = Core.Nothing,
                                                 clientVersion = Core.Nothing,
                                                 debuggeeId = debuggeeId, uploadType = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes ClouddebuggerDebuggerDebuggeesBreakpointsGet =
             '[CloudPlatform'FullControl, CloudDebugger'FullControl]
        requestClient ClouddebuggerDebuggerDebuggeesBreakpointsGet{..}
          = go debuggeeId breakpointId xgafv accessToken callback
              clientVersion
              uploadType
              uploadProtocol
