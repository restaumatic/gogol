...
newClouddebuggerDebuggerDebuggeesList 
    :: 
                                      ClouddebuggerDebuggerDebuggeesList
newClouddebuggerDebuggerDebuggeesList
  = ClouddebuggerDebuggerDebuggeesList{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       clientVersion = Core.Nothing, includeInactive = Core.Nothing,
                                       project = Core.Nothing, uploadType = Core.Nothing,
                                       uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ClouddebuggerDebuggerDebuggeesList
         where
        ...
        requestClient ClouddebuggerDebuggerDebuggeesList{..}
          = go xgafv accessToken callback clientVersion includeInactive
              project
              uploadType
              uploadProtocol
