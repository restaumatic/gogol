                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] UpdateActiveBreakpointRequest Core.:>
                               Core.Put '[Core.JSON] UpdateActiveBreakpointResponse
...
newClouddebuggerControllerDebuggeesBreakpointsUpdate 
    ...
    -> ClouddebuggerControllerDebuggeesBreakpointsUpdate
newClouddebuggerControllerDebuggeesBreakpointsUpdate debuggeeId id
  payload
  = ClouddebuggerControllerDebuggeesBreakpointsUpdate{xgafv =
                                                        Core.Nothing,
                                                      accessToken = Core.Nothing,
                                                      callback = Core.Nothing,
                                                      debuggeeId = debuggeeId, id = id,
                                                      payload = payload, uploadType = Core.Nothing,
                                                      uploadProtocol = Core.Nothing}
instance Core.GoogleRequest
           ClouddebuggerControllerDebuggeesBreakpointsUpdate
         where
        type Rs ClouddebuggerControllerDebuggeesBreakpointsUpdate =
             UpdateActiveBreakpointResponse
        type Scopes ClouddebuggerControllerDebuggeesBreakpointsUpdate =
             '[CloudPlatform'FullControl, CloudDebugger'FullControl]
        requestClient ClouddebuggerControllerDebuggeesBreakpointsUpdate{..}
          = go debuggeeId id xgafv accessToken callback uploadType
              uploadProtocol
