                           ...
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "waitToken" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.Get '[Core.JSON] ListActiveBreakpointsResponse
...
newClouddebuggerControllerDebuggeesBreakpointsList debuggeeId
  = ClouddebuggerControllerDebuggeesBreakpointsList{xgafv =
                                                      Core.Nothing,
                                                    accessToken = Core.Nothing,
                                                    agentId = Core.Nothing, callback = Core.Nothing,
...
instance Core.GoogleRequest
           ClouddebuggerControllerDebuggeesBreakpointsList
         where
        type Rs ClouddebuggerControllerDebuggeesBreakpointsList =
             ListActiveBreakpointsResponse
        type Scopes ClouddebuggerControllerDebuggeesBreakpointsList =
             '[CloudPlatform'FullControl, CloudDebugger'FullControl]
        requestClient ClouddebuggerControllerDebuggeesBreakpointsList{..}
          = go debuggeeId xgafv accessToken agentId callback successOnTimeout
              uploadType
              uploadProtocol
              waitToken
