...
newBreakpoint 
    ::  Breakpoint
newBreakpoint
  = Breakpoint{action = Core.Nothing,
               canaryExpireTime = Core.Nothing, condition = Core.Nothing,
               createTime = Core.Nothing, evaluatedExpressions = Core.Nothing,
               expressions = Core.Nothing, finalTime = Core.Nothing,
               id = Core.Nothing, isFinalState = Core.Nothing,
               labels = Core.Nothing, location = Core.Nothing,
               logLevel = Core.Nothing, logMessageFormat = Core.Nothing,
               stackFrames = Core.Nothing, state = Core.Nothing,
               status = Core.Nothing, userEmail = Core.Nothing,
               variableTable = Core.Nothing}
instance Core.FromJSON Breakpoint where
        parseJSON
          = Core.withObject "Breakpoint"
              (\ o ->
                 Breakpoint Core.<$>
                   (o Core..:? "action") Core.<*> (o Core..:? "canaryExpireTime")
...
instance Core.FromJSON Breakpoint_Labels where
        parseJSON
          = Core.withObject "Breakpoint_Labels"
...
newCloudRepoSourceContext
  = CloudRepoSourceContext{aliasContext = Core.Nothing,
                           aliasName = Core.Nothing, repoId = Core.Nothing,
          ...
          = Core.withObject "CloudRepoSourceContext"
              (\ o ->
                 CloudRepoSourceContext Core.<$>
                   (o Core..:? "aliasContext") Core.<*> (o Core..:? "aliasName")
                     Core.<*> (o Core..:? "repoId")
...
instance Core.FromJSON CloudWorkspaceId where
        parseJSON
          = Core.withObject "CloudWorkspaceId"
              (\ o ->
                 CloudWorkspaceId Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "repoId"))
...
newCloudWorkspaceSourceContext 
    ::  CloudWorkspaceSourceContext
newCloudWorkspaceSourceContext
  = CloudWorkspaceSourceContext{snapshotId = Core.Nothing,
                                workspaceId = Core.Nothing}
instance Core.FromJSON CloudWorkspaceSourceContext where
        parseJSON
          = Core.withObject "CloudWorkspaceSourceContext"
              (\ o ->
                 CloudWorkspaceSourceContext Core.<$>
                   (o Core..:? "snapshotId") Core.<*> (o Core..:? "workspaceId"))
...
newDebuggee 
    ::  Debuggee
newDebuggee
  = Debuggee{agentVersion = Core.Nothing, canaryMode = Core.Nothing,
             description = Core.Nothing, extSourceContexts = Core.Nothing,
             id = Core.Nothing, isDisabled = Core.Nothing,
             isInactive = Core.Nothing, labels = Core.Nothing,
             project = Core.Nothing, sourceContexts = Core.Nothing,
             status = Core.Nothing, uniquifier = Core.Nothing}
instance Core.FromJSON Debuggee where
        parseJSON
          = Core.withObject "Debuggee"
              (\ o ->
                 Debuggee Core.<$>
                   (o Core..:? "agentVersion") Core.<*> (o Core..:? "canaryMode")
...
instance Core.FromJSON Debuggee_Labels where
        parseJSON
          = Core.withObject "Debuggee_Labels"
...
newExtendedSourceContext 
    ::  ExtendedSourceContext
newExtendedSourceContext
  = ExtendedSourceContext{context = Core.Nothing,
                          labels = Core.Nothing}
instance Core.FromJSON ExtendedSourceContext where
        parseJSON
          = Core.withObject "ExtendedSourceContext"
              (\ o ->
                 ExtendedSourceContext Core.<$>
                   (o Core..:? "context") Core.<*> (o Core..:? "labels"))
...
instance Core.FromJSON ExtendedSourceContext_Labels where
        parseJSON
          = Core.withObject "ExtendedSourceContext_Labels"
              (\ o ->
...
instance Core.FromJSON FormatMessage where
        parseJSON
          = Core.withObject "FormatMessage"
              (\ o ->
                 FormatMessage Core.<$>
                   (o Core..:? "format") Core.<*> (o Core..:? "parameters"))
...
newGerritSourceContext
  = GerritSourceContext{aliasContext = Core.Nothing,
                        aliasName = Core.Nothing, gerritProject = Core.Nothing,
                        hostUri = Core.Nothing, revisionId = Core.Nothing}
...
instance Core.FromJSON GetBreakpointResponse where
        parseJSON
          = Core.withObject "GetBreakpointResponse"
...
newListActiveBreakpointsResponse 
    ::  ListActiveBreakpointsResponse
newListActiveBreakpointsResponse
  = ListActiveBreakpointsResponse{breakpoints = Core.Nothing,
                                  nextWaitToken = Core.Nothing, waitExpired = Core.Nothing}
instance Core.FromJSON ListActiveBreakpointsResponse where
        parseJSON
          = Core.withObject "ListActiveBreakpointsResponse"
              (\ o ->
                 ListActiveBreakpointsResponse Core.<$>
                   (o Core..:? "breakpoints") Core.<*> (o Core..:? "nextWaitToken")
...
newListBreakpointsResponse 
    ::  ListBreakpointsResponse
newListBreakpointsResponse
  = ListBreakpointsResponse{breakpoints = Core.Nothing,
                            nextWaitToken = Core.Nothing}
instance Core.FromJSON ListBreakpointsResponse where
        parseJSON
          = Core.withObject "ListBreakpointsResponse"
              (\ o ->
                 ListBreakpointsResponse Core.<$>
                   (o Core..:? "breakpoints") Core.<*> (o Core..:? "nextWaitToken"))
...
instance Core.FromJSON ListDebuggeesResponse where
        parseJSON
          = Core.withObject "ListDebuggeesResponse"
...
instance Core.FromJSON RegisterDebuggeeRequest where
        parseJSON
          = Core.withObject "RegisterDebuggeeRequest"
...
newRegisterDebuggeeResponse 
    ::  RegisterDebuggeeResponse
newRegisterDebuggeeResponse
  = RegisterDebuggeeResponse{agentId = Core.Nothing,
                             debuggee = Core.Nothing}
instance Core.FromJSON RegisterDebuggeeResponse where
        parseJSON
          = Core.withObject "RegisterDebuggeeResponse"
              (\ o ->
                 RegisterDebuggeeResponse Core.<$>
                   (o Core..:? "agentId") Core.<*> (o Core..:? "debuggee"))
...
instance Core.FromJSON SetBreakpointResponse where
        parseJSON
          = Core.withObject "SetBreakpointResponse"
...
newSourceContext 
    ::  SourceContext
newSourceContext
  = SourceContext{cloudRepo = Core.Nothing,
                  cloudWorkspace = Core.Nothing, gerrit = Core.Nothing,
                  git = Core.Nothing}
instance Core.FromJSON SourceContext where
        parseJSON
          = Core.withObject "SourceContext"
              (\ o ->
                 SourceContext Core.<$>
                   (o Core..:? "cloudRepo") Core.<*> (o Core..:? "cloudWorkspace")
                     Core.<*> (o Core..:? "gerrit")
                     Core.<*> (o Core..:? "git"))
...
newSourceLocation 
    ::  SourceLocation
newSourceLocation
  = SourceLocation{column = Core.Nothing, line = Core.Nothing,
                   path = Core.Nothing}
instance Core.FromJSON SourceLocation where
        parseJSON
          = Core.withObject "SourceLocation"
              (\ o ->
                 SourceLocation Core.<$>
                   (o Core..:? "column") Core.<*> (o Core..:? "line") Core.<*>
                     (o Core..:? "path"))
          ...
          = Core.object
              (Core.catMaybes
                 [("column" Core..=) Core.<$> column,
                  ("line" Core..=) Core.<$> line, ("path" Core..=) Core.<$> path])
...
newStackFrame 
    ::  StackFrame
newStackFrame
  = StackFrame{arguments = Core.Nothing, function = Core.Nothing,
               locals = Core.Nothing, location = Core.Nothing}
instance Core.FromJSON StackFrame where
        parseJSON
          = Core.withObject "StackFrame"
              (\ o ->
                 StackFrame Core.<$>
                   (o Core..:? "arguments") Core.<*> (o Core..:? "function") Core.<*>
                     (o Core..:? "locals")
                     Core.<*> (o Core..:? "location"))
...
newStatusMessage 
    ::  StatusMessage
newStatusMessage
  = StatusMessage{description = Core.Nothing, isError = Core.Nothing,
                  refersTo = Core.Nothing}
instance Core.FromJSON StatusMessage where
        parseJSON
          = Core.withObject "StatusMessage"
              (\ o ->
                 StatusMessage Core.<$>
                   (o Core..:? "description") Core.<*> (o Core..:? "isError") Core.<*>
                     (o Core..:? "refersTo"))
...
instance Core.FromJSON UpdateActiveBreakpointRequest where
        parseJSON
          = Core.withObject "UpdateActiveBreakpointRequest"
              (\ o ->
...
instance Core.FromJSON UpdateActiveBreakpointResponse where
        parseJSON
          = Core.withObject "UpdateActiveBreakpointResponse"
...
newVariable 
    ::  Variable
newVariable
  = Variable{members = Core.Nothing, name = Core.Nothing,
             status = Core.Nothing, type' = Core.Nothing, value = Core.Nothing,
...
instance Core.FromJSON Variable where
        parseJSON
          = Core.withObject "Variable"
              (\ o ->
                 Variable Core.<$>
                   (o Core..:? "members") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "status")
                     Core.<*> (o Core..:? "type")
                     Core.<*> (o Core..:? "value")
