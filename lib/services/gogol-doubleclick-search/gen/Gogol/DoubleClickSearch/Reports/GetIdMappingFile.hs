...
newDoubleClickSearchReportsGetIdMappingFile advertiserId agencyId
  = DoubleClickSearchReportsGetIdMappingFile{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           DoubleClickSearchReportsGetIdMappingFile
         where
        type Rs DoubleClickSearchReportsGetIdMappingFile = IdMappingFile
        type Scopes DoubleClickSearchReportsGetIdMappingFile =
             '[Doubleclicksearch'FullControl]
        requestClient DoubleClickSearchReportsGetIdMappingFile{..}
          = go agencyId advertiserId xgafv accessToken callback uploadType
              uploadProtocol
          ...
          where go Core.:<|> _
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DoubleClickSearchReportsGetIdMappingFileResource)
                      Core.mempty

instance Core.GoogleRequest
           (Core.MediaDownload DoubleClickSearchReportsGetIdMappingFile)
         where
        type Rs
               (Core.MediaDownload DoubleClickSearchReportsGetIdMappingFile)
             = Core.Stream
