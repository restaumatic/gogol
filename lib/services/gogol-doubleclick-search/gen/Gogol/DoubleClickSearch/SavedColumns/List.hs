...
newDoubleClickSearchSavedColumnsList advertiserId agencyId
  = DoubleClickSearchSavedColumnsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DoubleClickSearchSavedColumnsList where
        type Rs DoubleClickSearchSavedColumnsList = SavedColumnList
