                     ...
                     Core.QueryParam "startRow" Core.Word32 Core.:>
                       Core.QueryParam "$.xgafv" Xgafv Core.:>
                         Core.QueryParam "access_token" Core.Text Core.:>
                           Core.QueryParam "adGroupId" Core.Int64 Core.:>
                             Core.QueryParam "adId" Core.Int64 Core.:>
                               Core.QueryParam "advertiserId" Core.Int64 Core.:>
                                 Core.QueryParam "agencyId" Core.Int64 Core.:>
                                   Core.QueryParam "callback" Core.Text Core.:>
                                     Core.QueryParam "campaignId" Core.Int64 Core.:>
                                       Core.QueryParam "criterionId" Core.Int64 Core.:>
                                         Core.QueryParam "engineAccountId" Core.Int64 Core.:>
                                           Core.QueryParam "uploadType" Core.Text Core.:>
                                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                                 Core.Get '[Core.JSON] ConversionList
...
newDoubleClickSearchConversionGetByCustomerId 
    ...
    -> DoubleClickSearchConversionGetByCustomerId
newDoubleClickSearchConversionGetByCustomerId customerId endDate
  rowCount startDate startRow
  = DoubleClickSearchConversionGetByCustomerId{xgafv = Core.Nothing,
                                               accessToken = Core.Nothing, adGroupId = Core.Nothing,
                                               adId = Core.Nothing, advertiserId = Core.Nothing,
                                               agencyId = Core.Nothing, callback = Core.Nothing,
                                               campaignId = Core.Nothing,
                                               criterionId = Core.Nothing, customerId = customerId,
                                               endDate = endDate, engineAccountId = Core.Nothing,
                                               rowCount = rowCount, startDate = startDate,
                                               startRow = startRow, uploadType = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        requestClient DoubleClickSearchConversionGetByCustomerId{..}
          = go customerId (Core.Just endDate) (Core.Just rowCount)
              (Core.Just startDate)
              (Core.Just startRow)
              xgafv
              accessToken
