...
newDoubleClickSearchConversionUpdate payload
  = DoubleClickSearchConversionUpdate{xgafv = Core.Nothing,
                                      accessToken = Core.Nothing, callback = Core.Nothing,
                                      payload = payload, uploadType = Core.Nothing,
                                      uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DoubleClickSearchConversionUpdate where
        type Rs DoubleClickSearchConversionUpdate = ConversionList
