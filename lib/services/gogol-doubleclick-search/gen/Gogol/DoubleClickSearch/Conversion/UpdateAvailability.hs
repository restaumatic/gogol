                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] UpdateAvailabilityRequest Core.:>
                           Core.Post '[Core.JSON] UpdateAvailabilityResponse
...
newDoubleClickSearchConversionUpdateAvailability payload
  = DoubleClickSearchConversionUpdateAvailability{xgafv =
                                                    Core.Nothing,
...
instance Core.GoogleRequest
           DoubleClickSearchConversionUpdateAvailability
         where
        type Rs DoubleClickSearchConversionUpdateAvailability =
             UpdateAvailabilityResponse
        type Scopes DoubleClickSearchConversionUpdateAvailability =
             '[Doubleclicksearch'FullControl]
        requestClient DoubleClickSearchConversionUpdateAvailability{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DoubleClickSearchConversionUpdateAvailabilityResource)
                      Core.mempty
