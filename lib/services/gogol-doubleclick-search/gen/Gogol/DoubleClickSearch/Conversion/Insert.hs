                   ...
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] ConversionList Core.:>
                         Core.Post '[Core.JSON] ConversionList
...
newDoubleClickSearchConversionInsert payload
  = DoubleClickSearchConversionInsert{xgafv = Core.Nothing,
                                      accessToken = Core.Nothing, callback = Core.Nothing,
                                      payload = payload, uploadType = Core.Nothing,
                                      uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DoubleClickSearchConversionInsert where
        type Rs DoubleClickSearchConversionInsert = ConversionList
        type Scopes DoubleClickSearchConversionInsert =
