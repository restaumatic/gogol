...
newDoubleClickSearchConversionGet 
    ...
    -> DoubleClickSearchConversionGet
newDoubleClickSearchConversionGet advertiserId agencyId endDate
  engineAccountId rowCount startDate startRow
  = DoubleClickSearchConversionGet{xgafv = Core.Nothing,
                                   accessToken = Core.Nothing, adGroupId = Core.Nothing,
                                   adId = Core.Nothing, advertiserId = advertiserId,
                                   agencyId = agencyId, callback = Core.Nothing,
                                   campaignId = Core.Nothing, criterionId = Core.Nothing,
                                   customerId = Core.Nothing, endDate = endDate,
                                   engineAccountId = engineAccountId, rowCount = rowCount,
                                   startDate = startDate, startRow = startRow,
...
instance Core.GoogleRequest DoubleClickSearchConversionGet where
        ...
        requestClient DoubleClickSearchConversionGet{..}
          = go agencyId advertiserId engineAccountId (Core.Just endDate)
              (Core.Just rowCount)
              (Core.Just startDate)
              (Core.Just startRow)
              xgafv
