...
newAvailability 
    ::  Availability
newAvailability
  = Availability{advertiserId = Core.Nothing,
                 agencyId = Core.Nothing, availabilityTimestamp = Core.Nothing,
                 customerId = Core.Nothing, segmentationId = Core.Nothing,
                 segmentationName = Core.Nothing, segmentationType = Core.Nothing}
              ...
              (\ o ->
                 Availability Core.<$>
                   (o Core..:? "advertiserId" Core.<&> Core.fmap Core.fromAsText)
                     ...
                     Core.<*>
                     (o Core..:? "segmentationId" Core.<&> Core.fmap Core.fromAsText)
          ...
          = Core.object
              (Core.catMaybes
                 [("advertiserId" Core..=) Core.. Core.AsText Core.<$> advertiserId,
                  ...
                  ("availabilityTimestamp" Core..=) Core.. Core.AsText Core.<$>
                    availabilityTimestamp,
                  ("customerId" Core..=) Core.<$> customerId,
                  ("segmentationId" Core..=) Core.. Core.AsText Core.<$>
                    segmentationId,
                  ("segmentationName" Core..=) Core.<$> segmentationName,
                  ("segmentationType" Core..=) Core.<$> segmentationType])
...
newConversion 
    ::  Conversion
newConversion
  = Conversion{adGroupId = Core.Nothing, adId = Core.Nothing,
               adUserDataConsent = Core.Nothing, advertiserId = Core.Nothing,
               agencyId = Core.Nothing, attributionModel = Core.Nothing,
               campaignId = Core.Nothing, channel = Core.Nothing,
               clickId = Core.Nothing, conversionId = Core.Nothing,
               conversionModifiedTimestamp = Core.Nothing,
               conversionTimestamp = Core.Nothing, countMillis = Core.Nothing,
               criterionId = Core.Nothing, currencyCode = Core.Nothing,
               customDimension = Core.Nothing, customMetric = Core.Nothing,
               customerId = Core.Nothing, deviceType = Core.Nothing,
               dsConversionId = Core.Nothing, engineAccountId = Core.Nothing,
               floodlightOrderId = Core.Nothing,
               inventoryAccountId = Core.Nothing, productCountry = Core.Nothing,
               productGroupId = Core.Nothing, productId = Core.Nothing,
               productLanguage = Core.Nothing, quantityMillis = Core.Nothing,
               revenueMicros = Core.Nothing, segmentationId = Core.Nothing,
               segmentationName = Core.Nothing, segmentationType = Core.Nothing,
               state = Core.Nothing, storeId = Core.Nothing, type' = Core.Nothing}
instance Core.FromJSON Conversion where
        parseJSON
          = Core.withObject "Conversion"
              (\ o ->
                 Conversion Core.<$>
                   (o Core..:? "adGroupId" Core.<&> Core.fmap Core.fromAsText)
                     ...
                     Core.<*>
                     (o Core..:? "countMillis" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "criterionId" Core.<&> Core.fmap Core.fromAsText)
                     ...
                     Core.<*>
                     (o Core..:? "dsConversionId" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "engineAccountId" Core.<&> Core.fmap Core.fromAsText)
                     ...
                     Core.<*>
                     (o Core..:? "productGroupId" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "productId")
                     Core.<*> (o Core..:? "productLanguage")
                     Core.<*>
                     (o Core..:? "quantityMillis" Core.<&> Core.fmap Core.fromAsText)
...
instance Core.ToJSON Conversion where
        toJSON Conversion{..}
          = Core.object
              (Core.catMaybes
                 [("adGroupId" Core..=) Core.. Core.AsText Core.<$> adGroupId,
                  ...
                  ("conversionModifiedTimestamp" Core..=) Core.. Core.AsText Core.<$>
                    conversionModifiedTimestamp,
                  ("conversionTimestamp" Core..=) Core.<$> conversionTimestamp,
                  ("countMillis" Core..=) Core.. Core.AsText Core.<$> countMillis,
                  ("criterionId" Core..=) Core.. Core.AsText Core.<$> criterionId,
                  ...
                  ("dsConversionId" Core..=) Core.. Core.AsText Core.<$>
                    dsConversionId,
                  ("engineAccountId" Core..=) Core.. Core.AsText Core.<$>
                    engineAccountId,
                  ("floodlightOrderId" Core..=) Core.<$> floodlightOrderId,
                  ("inventoryAccountId" Core..=) Core.. Core.AsText Core.<$>
                    inventoryAccountId,
                  ("productCountry" Core..=) Core.<$> productCountry,
                  ("productGroupId" Core..=) Core.. Core.AsText Core.<$>
                    productGroupId,
                  ("productId" Core..=) Core.<$> productId,
                  ("productLanguage" Core..=) Core.<$> productLanguage,
                  ("quantityMillis" Core..=) Core.. Core.AsText Core.<$>
                    quantityMillis,
...
instance Core.FromJSON ConversionList where
        parseJSON
          = Core.withObject "ConversionList"
              (\ o ->
                 ConversionList Core.<$>
                   (o Core..:? "conversion") Core.<*> (o Core..:? "kind"))
...
newCustomDimension 
    ::  CustomDimension
newCustomDimension
  = CustomDimension{name = Core.Nothing, value = Core.Nothing}
...
newCustomMetric 
    ::  CustomMetric
newCustomMetric
  = CustomMetric{name = Core.Nothing, value = Core.Nothing}
...
instance Core.FromJSON IdMappingFile where
        parseJSON
          = Core.withObject "IdMappingFile" (\ o -> Core.pure IdMappingFile)
...
newReport 
    ::  Report
newReport
  = Report{files = Core.Nothing, id = Core.Nothing,
           isReportReady = Core.Nothing, kind = Core.Nothing,
           request' = Core.Nothing, rowCount = Core.Nothing,
           rows = Core.Nothing, statisticsCurrencyCode = Core.Nothing,
...
instance Core.FromJSON Report where
        parseJSON
          = Core.withObject "Report"
              (\ o ->
                 Report Core.<$>
                   (o Core..:? "files") Core.<*> (o Core..:? "id") Core.<*>
                     (o Core..:? "isReportReady")
                     Core.<*> (o Core..:? "kind")
                     Core.<*> (o Core..:? "request")
          ...
          = Core.object
              (Core.catMaybes
                 [("files" Core..=) Core.<$> files, ("id" Core..=) Core.<$> id,
                  ...
                  ("rows" Core..=) Core.<$> rows,
                  ("statisticsCurrencyCode" Core..=) Core.<$> statisticsCurrencyCode,
                  ("statisticsTimeZone" Core..=) Core.<$> statisticsTimeZone])
...
newReportApiColumnSpec 
    ::  ReportApiColumnSpec
newReportApiColumnSpec
  = ReportApiColumnSpec{columnName = Core.Nothing,
                        customDimensionName = Core.Nothing,
                        customMetricName = Core.Nothing, endDate = Core.Nothing,
                        groupByColumn = Core.Nothing, headerText = Core.Nothing,
                        platformSource = Core.Nothing,
                        productReportPerspective = Core.Nothing,
                        savedColumnName = Core.Nothing, startDate = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("columnName" Core..=) Core.<$> columnName,
                  ("customDimensionName" Core..=) Core.<$> customDimensionName,
                  ("customMetricName" Core..=) Core.<$> customMetricName,
...
newReportRequest 
    ::  ReportRequest
newReportRequest
  = ReportRequest{columns = Core.Nothing,
                  downloadFormat = Core.Nothing, filters = Core.Nothing,
                  includeDeletedEntities = Core.Nothing,
                  includeRemovedEntities = Core.Nothing,
                  maxRowsPerFile = Core.Nothing, orderBy = Core.Nothing,
                  reportScope = Core.Nothing, reportType = Core.Nothing,
                  rowCount = Core.Nothing, startRow = Core.Nothing,
                  statisticsCurrency = Core.Nothing, timeRange = Core.Nothing,
...
instance Core.FromJSON ReportRequest where
        parseJSON
          = Core.withObject "ReportRequest"
              (\ o ->
                 ReportRequest Core.<$>
                   (o Core..:? "columns") Core.<*> (o Core..:? "downloadFormat")
                     Core.<*> (o Core..:? "filters")
          ...
          = Core.object
              (Core.catMaybes
                 [("columns" Core..=) Core.<$> columns,
                  ...
                  ("includeDeletedEntities" Core..=) Core.<$> includeDeletedEntities,
                  ("includeRemovedEntities" Core..=) Core.<$> includeRemovedEntities,
                  ...
                  ("statisticsCurrency" Core..=) Core.<$> statisticsCurrency,
                  ("timeRange" Core..=) Core.<$> timeRange,
                  ("verifySingleTimeZone" Core..=) Core.<$> verifySingleTimeZone])
...
newReportRequest_FiltersItem 
    ::  ReportRequest_FiltersItem
newReportRequest_FiltersItem
  = ReportRequest_FiltersItem{column = Core.Nothing,
          ...
          = Core.withObject "ReportRequest_FiltersItem"
              (\ o ->
                 ReportRequest_FiltersItem Core.<$>
                   (o Core..:? "column") Core.<*> (o Core..:? "operator") Core.<*>
                     (o Core..:? "values"))
...
newReportRequest_OrderByItem 
    ::  ReportRequest_OrderByItem
newReportRequest_OrderByItem
  = ReportRequest_OrderByItem{column = Core.Nothing,
          ...
          = Core.withObject "ReportRequest_OrderByItem"
              (\ o ->
                 ReportRequest_OrderByItem Core.<$>
                   (o Core..:? "column") Core.<*> (o Core..:? "sortOrder"))
...
newReportRequest_ReportScope 
    ::  ReportRequest_ReportScope
newReportRequest_ReportScope
  = ReportRequest_ReportScope{adGroupId = Core.Nothing,
                              adId = Core.Nothing, advertiserId = Core.Nothing,
                              agencyId = Core.Nothing, campaignId = Core.Nothing,
                              engineAccountId = Core.Nothing, keywordId = Core.Nothing}
              ...
              (\ o ->
                 ReportRequest_ReportScope Core.<$>
                   (o Core..:? "adGroupId" Core.<&> Core.fmap Core.fromAsText)
                     ...
                     (o Core..:? "engineAccountId" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "keywordId" Core.<&> Core.fmap Core.fromAsText))
          ...
          = Core.object
              (Core.catMaybes
                 [("adGroupId" Core..=) Core.. Core.AsText Core.<$> adGroupId,
                  ...
                  ("engineAccountId" Core..=) Core.. Core.AsText Core.<$>
                    engineAccountId,
                  ("keywordId" Core..=) Core.. Core.AsText Core.<$> keywordId])
...
newReportRequest_TimeRange 
    ::  ReportRequest_TimeRange
newReportRequest_TimeRange
  = ReportRequest_TimeRange{changedAttributesSinceTimestamp =
                              Core.Nothing,
                            changedMetricsSinceTimestamp = Core.Nothing,
                            endDate = Core.Nothing, startDate = Core.Nothing}
instance Core.FromJSON ReportRequest_TimeRange where
        parseJSON
          = Core.withObject "ReportRequest_TimeRange"
              (\ o ->
                 ReportRequest_TimeRange Core.<$>
                   (o Core..:? "changedAttributesSinceTimestamp") Core.<*>
                     (o Core..:? "changedMetricsSinceTimestamp")
                     Core.<*> (o Core..:? "endDate")
                     Core.<*> (o Core..:? "startDate"))
...
newSavedColumn 
    ::  SavedColumn
newSavedColumn
  = SavedColumn{kind = Core.Nothing, savedColumnName = Core.Nothing,
                type' = Core.Nothing}
instance Core.FromJSON SavedColumn where
        parseJSON
          = Core.withObject "SavedColumn"
              (\ o ->
                 SavedColumn Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "savedColumnName")
                     Core.<*> (o Core..:? "type"))
...
newSavedColumnList 
    ::  SavedColumnList
newSavedColumnList
  = SavedColumnList{items = Core.Nothing, kind = Core.Nothing}
...
instance Core.FromJSON UpdateAvailabilityRequest where
        parseJSON
          = Core.withObject "UpdateAvailabilityRequest"
              (\ o ->
                 UpdateAvailabilityRequest Core.<$> (o Core..:? "availabilities"))
...
instance Core.FromJSON UpdateAvailabilityResponse where
        parseJSON
          = Core.withObject "UpdateAvailabilityResponse"
              (\ o ->
                 UpdateAvailabilityResponse Core.<$> (o Core..:? "availabilities"))
