...
newRunProjectsLocationsServicesSetIamPolicy payload resource
  = RunProjectsLocationsServicesSetIamPolicy{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           RunProjectsLocationsServicesSetIamPolicy
         where
        type Rs RunProjectsLocationsServicesSetIamPolicy =
             GoogleIamV1Policy
        type Scopes RunProjectsLocationsServicesSetIamPolicy =
