...
newRunProjectsLocationsJobsTestIamPermissions payload resource
  = RunProjectsLocationsJobsTestIamPermissions{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           RunProjectsLocationsJobsTestIamPermissions
         where
        type Rs RunProjectsLocationsJobsTestIamPermissions =
             GoogleIamV1TestIamPermissionsResponse
        type Scopes RunProjectsLocationsJobsTestIamPermissions =
