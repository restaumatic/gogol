...
newRunProjectsLocationsWorkerPoolsRevisionsGet name
  = RunProjectsLocationsWorkerPoolsRevisionsGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           RunProjectsLocationsWorkerPoolsRevisionsGet
         where
        type Rs RunProjectsLocationsWorkerPoolsRevisionsGet =
             GoogleCloudRunV2Revision
        type Scopes RunProjectsLocationsWorkerPoolsRevisionsGet =
