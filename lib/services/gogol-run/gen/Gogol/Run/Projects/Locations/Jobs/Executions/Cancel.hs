               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] GoogleCloudRunV2CancelExecutionRequest
...
newRunProjectsLocationsJobsExecutionsCancel name payload
  = RunProjectsLocationsJobsExecutionsCancel{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        requestClient RunProjectsLocationsJobsExecutionsCancel{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy RunProjectsLocationsJobsExecutionsCancelResource)
                      Core.mempty
