               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] GoogleIamV1SetIamPolicyRequest Core.:>
                       Core.Post '[Core.JSON] GoogleIamV1Policy
...
newRunProjectsLocationsWorkerPoolsSetIamPolicy payload resource
  = RunProjectsLocationsWorkerPoolsSetIamPolicy{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           RunProjectsLocationsWorkerPoolsSetIamPolicy
         where
        type Rs RunProjectsLocationsWorkerPoolsSetIamPolicy =
             GoogleIamV1Policy
        type Scopes RunProjectsLocationsWorkerPoolsSetIamPolicy =
