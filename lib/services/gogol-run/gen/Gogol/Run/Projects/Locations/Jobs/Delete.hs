...
newRunProjectsLocationsJobsDelete name
  = RunProjectsLocationsJobsDelete{xgafv = Core.Nothing,
                                   accessToken = Core.Nothing, callback = Core.Nothing,
                                   etag = Core.Nothing, name = name, uploadType = Core.Nothing,
                                   uploadProtocol = Core.Nothing, validateOnly = Core.Nothing}
instance Core.GoogleRequest RunProjectsLocationsJobsDelete where
        type Rs RunProjectsLocationsJobsDelete = GoogleLongrunningOperation
        ...
        requestClient RunProjectsLocationsJobsDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy RunProjectsLocationsJobsDeleteResource)
                      Core.mempty
