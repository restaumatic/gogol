                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] GoogleCloudRunV2ListTasksResponse
...
newRunProjectsLocationsJobsExecutionsTasksList parent
  = RunProjectsLocationsJobsExecutionsTasksList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes RunProjectsLocationsJobsExecutionsTasksList =
             '[CloudPlatform'FullControl]
        requestClient RunProjectsLocationsJobsExecutionsTasksList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy RunProjectsLocationsJobsExecutionsTasksListResource)
                      Core.mempty
