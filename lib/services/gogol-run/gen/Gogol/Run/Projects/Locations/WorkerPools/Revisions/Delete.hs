...
newRunProjectsLocationsWorkerPoolsRevisionsDelete name
  = RunProjectsLocationsWorkerPoolsRevisionsDelete{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           RunProjectsLocationsWorkerPoolsRevisionsDelete
         where
        type Rs RunProjectsLocationsWorkerPoolsRevisionsDelete =
             GoogleLongrunningOperation
        type Scopes RunProjectsLocationsWorkerPoolsRevisionsDelete =
