                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] GoogleCloudRunV2ListServicesResponse
...
newRunProjectsLocationsServicesList parent
  = RunProjectsLocationsServicesList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest RunProjectsLocationsServicesList where
        ...
        requestClient RunProjectsLocationsServicesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy RunProjectsLocationsServicesListResource)
                      Core.mempty
