...
newRunProjectsLocationsServicesRevisionsList parent
  = RunProjectsLocationsServicesRevisionsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        requestClient RunProjectsLocationsServicesRevisionsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy RunProjectsLocationsServicesRevisionsListResource)
                      Core.mempty
