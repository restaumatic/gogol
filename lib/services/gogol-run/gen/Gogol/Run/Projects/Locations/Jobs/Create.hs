...
newRunProjectsLocationsJobsCreate parent payload
  = RunProjectsLocationsJobsCreate{xgafv = Core.Nothing,
                                   accessToken = Core.Nothing, callback = Core.Nothing,
                                   jobId = Core.Nothing, parent = parent, payload = payload,
                                   uploadType = Core.Nothing, uploadProtocol = Core.Nothing,
                                   validateOnly = Core.Nothing}
instance Core.GoogleRequest RunProjectsLocationsJobsCreate where
        type Rs RunProjectsLocationsJobsCreate = GoogleLongrunningOperation
        type Scopes RunProjectsLocationsJobsCreate =
             '[CloudPlatform'FullControl]
        requestClient RunProjectsLocationsJobsCreate{..}
          = go parent xgafv accessToken callback jobId uploadType
              uploadProtocol
              validateOnly
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy RunProjectsLocationsJobsCreateResource)
                      Core.mempty
