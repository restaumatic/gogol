...
type RunProjectsLocationsJobsExecutionsExportStatusResource =
     "v2" Core.:>
       Core.Capture "name" Core.Text Core.:>
         Core.CaptureMode "operationId" "exportStatus" Core.Text Core.:>
                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.Get '[Core.JSON] GoogleCloudRunV2ExportStatusResponse
...
newRunProjectsLocationsJobsExecutionsExportStatus name operationId
  = RunProjectsLocationsJobsExecutionsExportStatus{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           RunProjectsLocationsJobsExecutionsExportStatus
         where
        type Rs RunProjectsLocationsJobsExecutionsExportStatus =
             GoogleCloudRunV2ExportStatusResponse
        type Scopes RunProjectsLocationsJobsExecutionsExportStatus =
             '[CloudPlatform'FullControl]
        requestClient RunProjectsLocationsJobsExecutionsExportStatus{..}
          = go name operationId xgafv accessToken callback uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy RunProjectsLocationsJobsExecutionsExportStatusResource)
                      Core.mempty
