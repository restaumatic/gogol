...
newRunProjectsLocationsJobsSetIamPolicy payload resource
  = RunProjectsLocationsJobsSetIamPolicy{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         payload = payload, resource = resource,
                                         uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest RunProjectsLocationsJobsSetIamPolicy
         where
        type Rs RunProjectsLocationsJobsSetIamPolicy = GoogleIamV1Policy
        type Scopes RunProjectsLocationsJobsSetIamPolicy =
