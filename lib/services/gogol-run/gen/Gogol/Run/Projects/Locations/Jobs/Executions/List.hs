                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] GoogleCloudRunV2ListExecutionsResponse
...
newRunProjectsLocationsJobsExecutionsList parent
  = RunProjectsLocationsJobsExecutionsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest RunProjectsLocationsJobsExecutionsList
         where
        ...
        requestClient RunProjectsLocationsJobsExecutionsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy RunProjectsLocationsJobsExecutionsListResource)
                      Core.mempty
