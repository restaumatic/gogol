...
type RunProjectsLocationsExportProjectMetadataResource =
     "v2" Core.:>
       Core.CaptureMode "name" "exportProjectMetadata" Core.Text Core.:>
...
newRunProjectsLocationsExportProjectMetadata name
  = RunProjectsLocationsExportProjectMetadata{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        requestClient RunProjectsLocationsExportProjectMetadata{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy RunProjectsLocationsExportProjectMetadataResource)
                      Core.mempty
