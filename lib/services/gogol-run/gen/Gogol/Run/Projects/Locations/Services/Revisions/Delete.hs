...
newRunProjectsLocationsServicesRevisionsDelete name
  = RunProjectsLocationsServicesRevisionsDelete{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           RunProjectsLocationsServicesRevisionsDelete
         where
        type Rs RunProjectsLocationsServicesRevisionsDelete =
             GoogleLongrunningOperation
        type Scopes RunProjectsLocationsServicesRevisionsDelete =
             '[CloudPlatform'FullControl]
        requestClient RunProjectsLocationsServicesRevisionsDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy RunProjectsLocationsServicesRevisionsDeleteResource)
                      Core.mempty
