                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] GoogleCloudRunV2ListJobsResponse
...
instance Core.GoogleRequest RunProjectsLocationsJobsList where
        ...
        requestClient RunProjectsLocationsJobsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy RunProjectsLocationsJobsListResource)
                      Core.mempty
