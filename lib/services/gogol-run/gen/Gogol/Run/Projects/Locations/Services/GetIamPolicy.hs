...
newRunProjectsLocationsServicesGetIamPolicy resource
  = RunProjectsLocationsServicesGetIamPolicy{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           RunProjectsLocationsServicesGetIamPolicy
         where
        type Rs RunProjectsLocationsServicesGetIamPolicy =
             GoogleIamV1Policy
        type Scopes RunProjectsLocationsServicesGetIamPolicy =
             '[CloudPlatform'FullControl]
        requestClient RunProjectsLocationsServicesGetIamPolicy{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy RunProjectsLocationsServicesGetIamPolicyResource)
                      Core.mempty
