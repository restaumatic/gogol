               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.Get '[Core.JSON] GoogleCloudRunV2Task
...
newRunProjectsLocationsJobsExecutionsTasksGet name
  = RunProjectsLocationsJobsExecutionsTasksGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           RunProjectsLocationsJobsExecutionsTasksGet
         where
        type Rs RunProjectsLocationsJobsExecutionsTasksGet =
             GoogleCloudRunV2Task
        type Scopes RunProjectsLocationsJobsExecutionsTasksGet =
