...
newRunProjectsLocationsServicesDelete name
  = RunProjectsLocationsServicesDelete{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       etag = Core.Nothing, name = name, uploadType = Core.Nothing,
                                       uploadProtocol = Core.Nothing, validateOnly = Core.Nothing}
instance Core.GoogleRequest RunProjectsLocationsServicesDelete
         where
        type Rs RunProjectsLocationsServicesDelete =
             GoogleLongrunningOperation
        type Scopes RunProjectsLocationsServicesDelete =
        ...
        requestClient RunProjectsLocationsServicesDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy RunProjectsLocationsServicesDeleteResource)
                      Core.mempty
