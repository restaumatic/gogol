...
newRunProjectsLocationsServicesRevisionsExportStatus 
    ...
    -> RunProjectsLocationsServicesRevisionsExportStatus
newRunProjectsLocationsServicesRevisionsExportStatus name
  operationId
  = RunProjectsLocationsServicesRevisionsExportStatus{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           RunProjectsLocationsServicesRevisionsExportStatus
         where
        type Rs RunProjectsLocationsServicesRevisionsExportStatus =
             GoogleCloudRunV2ExportStatusResponse
        type Scopes RunProjectsLocationsServicesRevisionsExportStatus =
