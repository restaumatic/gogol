           ...
           Core.QueryParam "$.xgafv" Xgafv Core.:>
             Core.QueryParam "access_token" Core.Text Core.:>
               Core.QueryParam "callback" Core.Text Core.:>
                 Core.QueryParam "serviceId" Core.Text Core.:>
...
newRunProjectsLocationsServicesCreate parent payload
  = RunProjectsLocationsServicesCreate{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       parent = parent, payload = payload, serviceId = Core.Nothing,
                                       uploadType = Core.Nothing, uploadProtocol = Core.Nothing,
                                       validateOnly = Core.Nothing}
instance Core.GoogleRequest RunProjectsLocationsServicesCreate
         where
        type Rs RunProjectsLocationsServicesCreate =
             GoogleLongrunningOperation
        type Scopes RunProjectsLocationsServicesCreate =
             '[CloudPlatform'FullControl]
        requestClient RunProjectsLocationsServicesCreate{..}
          = go parent xgafv accessToken callback serviceId uploadType
              uploadProtocol
              validateOnly
