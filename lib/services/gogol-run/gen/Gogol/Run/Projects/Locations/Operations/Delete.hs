...
newRunProjectsLocationsOperationsDelete name
  = RunProjectsLocationsOperationsDelete{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         name = name, uploadType = Core.Nothing,
                                         uploadProtocol = Core.Nothing}
instance Core.GoogleRequest RunProjectsLocationsOperationsDelete
         where
        type Rs RunProjectsLocationsOperationsDelete = GoogleProtobufEmpty
        type Scopes RunProjectsLocationsOperationsDelete =
             '[CloudPlatform'FullControl]
        requestClient RunProjectsLocationsOperationsDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy RunProjectsLocationsOperationsDeleteResource)
                      Core.mempty
