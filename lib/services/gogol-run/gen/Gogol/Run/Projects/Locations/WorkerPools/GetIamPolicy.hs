...
newRunProjectsLocationsWorkerPoolsGetIamPolicy resource
  = RunProjectsLocationsWorkerPoolsGetIamPolicy{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           RunProjectsLocationsWorkerPoolsGetIamPolicy
         where
        type Rs RunProjectsLocationsWorkerPoolsGetIamPolicy =
             GoogleIamV1Policy
        type Scopes RunProjectsLocationsWorkerPoolsGetIamPolicy =
