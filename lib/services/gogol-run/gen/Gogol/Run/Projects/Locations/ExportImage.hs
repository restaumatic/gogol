...
type RunProjectsLocationsExportImageResource =
     "v2" Core.:>
       Core.CaptureMode "name" "exportImage" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] GoogleCloudRunV2ExportImageRequest
...
newRunProjectsLocationsExportImage name payload
  = RunProjectsLocationsExportImage{xgafv = Core.Nothing,
...
instance Core.GoogleRequest RunProjectsLocationsExportImage where
        type Rs RunProjectsLocationsExportImage =
             GoogleCloudRunV2ExportImageResponse
        type Scopes RunProjectsLocationsExportImage =
