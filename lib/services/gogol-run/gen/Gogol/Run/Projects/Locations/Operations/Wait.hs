               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] GoogleLongrunningWaitOperationRequest
...
newRunProjectsLocationsOperationsWait name payload
  = RunProjectsLocationsOperationsWait{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       name = name, payload = payload, uploadType = Core.Nothing,
                                       uploadProtocol = Core.Nothing}
instance Core.GoogleRequest RunProjectsLocationsOperationsWait
         where
        type Rs RunProjectsLocationsOperationsWait =
             GoogleLongrunningOperation
        type Scopes RunProjectsLocationsOperationsWait =
