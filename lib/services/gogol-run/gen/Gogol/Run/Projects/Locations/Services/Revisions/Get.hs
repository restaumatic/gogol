               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.Get '[Core.JSON] GoogleCloudRunV2Revision
...
newRunProjectsLocationsServicesRevisionsGet name
  = RunProjectsLocationsServicesRevisionsGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           RunProjectsLocationsServicesRevisionsGet
         where
        type Rs RunProjectsLocationsServicesRevisionsGet =
             GoogleCloudRunV2Revision
        type Scopes RunProjectsLocationsServicesRevisionsGet =
             '[CloudPlatform'FullControl]
        requestClient RunProjectsLocationsServicesRevisionsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy RunProjectsLocationsServicesRevisionsGetResource)
                      Core.mempty
