...
type RunProjectsLocationsExportImageMetadataResource =
     "v2" Core.:>
       Core.CaptureMode "name" "exportImageMetadata" Core.Text Core.:>
...
newRunProjectsLocationsExportImageMetadata name
  = RunProjectsLocationsExportImageMetadata{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            name = name, uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest RunProjectsLocationsExportImageMetadata
         where
