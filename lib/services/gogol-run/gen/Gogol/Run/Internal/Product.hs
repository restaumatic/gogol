...
data GoogleCloudRunV2Service = GoogleCloudRunV2Service
    ...
    , multiRegionSettings :: (Core.Maybe GoogleCloudRunV2MultiRegionSettings)
      -- | Identifier. The fully qualified name of this Service. In CreateServiceRequest, this field is ignored, and instead composed from CreateServiceRequest.parent and CreateServiceRequest.service/id. Format: projects\/{project}\/locations\/{location}\/services\/{service/id}
    , name :: (Core.Maybe Core.Text)
...
data GoogleCloudRunV2SubmitBuildRequest = GoogleCloudRunV2SubmitBuildRequest
    ...
    , imageUri :: (Core.Maybe Core.Text)
      -- | Optional. The machine type from default pool to use for the build. If left blank, cloudbuild will use a sensible default. Currently only E2/HIGHCPU/8 is supported. If worker_pool is set, this field will be ignored.
    , machineType :: (Core.Maybe Core.Text)
      -- | Optional. The release track of the client that initiated the build request.
    , releaseTrack :: (Core.Maybe GoogleCloudRunV2SubmitBuildRequest_ReleaseTrack)
...
newGoogleCloudRunV2SubmitBuildRequest
  = GoogleCloudRunV2SubmitBuildRequest{buildpackBuild = Core.Nothing,
                                       client = Core.Nothing, dockerBuild = Core.Nothing,
                                       imageUri = Core.Nothing, machineType = Core.Nothing,
                                       releaseTrack = Core.Nothing, serviceAccount = Core.Nothing,
                                       storageSource = Core.Nothing, tags = Core.Nothing,
                                       workerPool = Core.Nothing}
          ...
          = Core.withObject "GoogleCloudRunV2SubmitBuildRequest"
              (\ o ->
                 GoogleCloudRunV2SubmitBuildRequest Core.<$>
                   (o Core..:? "buildpackBuild") Core.<*> (o Core..:? "client")
                     Core.<*> (o Core..:? "dockerBuild")
                     Core.<*> (o Core..:? "imageUri")
                     Core.<*> (o Core..:? "machineType")
                     Core.<*> (o Core..:? "releaseTrack")
                     Core.<*> (o Core..:? "serviceAccount")
          ...
          = Core.object
              (Core.catMaybes
                 [("buildpackBuild" Core..=) Core.<$> buildpackBuild,
                  ...
                  ("releaseTrack" Core..=) Core.<$> releaseTrack,
                  ("serviceAccount" Core..=) Core.<$> serviceAccount,
...
newGoogleCloudRunV2VolumeMount
  = GoogleCloudRunV2VolumeMount{mountPath = Core.Nothing,
                                name = Core.Nothing, subPath = Core.Nothing}
