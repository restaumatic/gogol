...
-- | Default request referring to version @v2@ of the Cloud Natural Language API. This contains the host and root path used as a starting point for constructing service requests.
languageService :: Core.ServiceConfig
languageService
  = Core.defaultService (Core.ServiceId "language:v2")
      "language.googleapis.com"

-- | Apply machine learning models to reveal the structure and meaning of text
type CloudLanguage'FullControl =
