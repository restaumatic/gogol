...
newAnalyzeEntitiesRequest 
    ::  AnalyzeEntitiesRequest
newAnalyzeEntitiesRequest
  = AnalyzeEntitiesRequest{document = Core.Nothing,
          ...
          = Core.withObject "AnalyzeEntitiesRequest"
              (\ o ->
                 AnalyzeEntitiesRequest Core.<$>
                   (o Core..:? "document") Core.<*> (o Core..:? "encodingType"))
...
newAnalyzeSentimentRequest 
    ::  AnalyzeSentimentRequest
newAnalyzeSentimentRequest
  = AnalyzeSentimentRequest{document = Core.Nothing,
                            encodingType = Core.Nothing}
...
newAnalyzeSentimentResponse 
    ::  AnalyzeSentimentResponse
newAnalyzeSentimentResponse
  = AnalyzeSentimentResponse{documentSentiment = Core.Nothing,
                             languageCode = Core.Nothing, languageSupported = Core.Nothing,
...
newAnnotateTextRequest 
    ::  AnnotateTextRequest
newAnnotateTextRequest
  = AnnotateTextRequest{document = Core.Nothing,
                        encodingType = Core.Nothing, features = Core.Nothing}
...
newAnnotateTextRequestFeatures 
    ::  AnnotateTextRequestFeatures
newAnnotateTextRequestFeatures
  = AnnotateTextRequestFeatures{classifyText = Core.Nothing,
                                extractDocumentSentiment = Core.Nothing,
                                extractEntities = Core.Nothing, moderateText = Core.Nothing}
instance Core.FromJSON AnnotateTextRequestFeatures where
        parseJSON
          = Core.withObject "AnnotateTextRequestFeatures"
              (\ o ->
                 AnnotateTextRequestFeatures Core.<$>
                   (o Core..:? "classifyText") Core.<*>
                     (o Core..:? "extractDocumentSentiment")
...
newAnnotateTextResponse 
    ::  AnnotateTextResponse
newAnnotateTextResponse
  = AnnotateTextResponse{categories = Core.Nothing,
                         documentSentiment = Core.Nothing, entities = Core.Nothing,
                         languageCode = Core.Nothing, languageSupported = Core.Nothing,
                         moderationCategories = Core.Nothing, sentences = Core.Nothing}
instance Core.FromJSON AnnotateTextResponse where
        parseJSON
          = Core.withObject "AnnotateTextResponse"
              (\ o ->
                 AnnotateTextResponse Core.<$>
                   (o Core..:? "categories") Core.<*> (o Core..:? "documentSentiment")
...
newClassificationCategory 
    ::  ClassificationCategory
newClassificationCategory
  = ClassificationCategory{confidence = Core.Nothing,
                           name = Core.Nothing, severity = Core.Nothing}
...
newClassifyTextResponse 
    ::  ClassifyTextResponse
newClassifyTextResponse
  = ClassifyTextResponse{categories = Core.Nothing,
                         languageCode = Core.Nothing, languageSupported = Core.Nothing}
          ...
          = Core.withObject "ClassifyTextResponse"
              (\ o ->
                 ClassifyTextResponse Core.<$>
                   (o Core..:? "categories") Core.<*> (o Core..:? "languageCode")
                     Core.<*> (o Core..:? "languageSupported"))
...
newCpuMetric 
    ::  CpuMetric
newCpuMetric
  = CpuMetric{coreNumber = Core.Nothing, coreSec = Core.Nothing,
              cpuType = Core.Nothing, machineSpec = Core.Nothing,
              trackingLabels = Core.Nothing}
instance Core.FromJSON CpuMetric where
        parseJSON
          = Core.withObject "CpuMetric"
              (\ o ->
                 CpuMetric Core.<$>
                   (o Core..:? "coreNumber" Core.<&> Core.fmap Core.fromAsText)
...
instance Core.FromJSON CpuMetric_TrackingLabels where
        parseJSON
          = Core.withObject "CpuMetric_TrackingLabels"
...
instance Core.FromJSON DiskMetric where
        parseJSON
          = Core.withObject "DiskMetric"
              (\ o ->
                 DiskMetric Core.<$>
                   (o Core..:? "diskType") Core.<*>
                     (o Core..:? "gibSec" Core.<&> Core.fmap Core.fromAsText))
...
newDocument 
    ::  Document
newDocument
  = Document{content = Core.Nothing, gcsContentUri = Core.Nothing,
             languageCode = Core.Nothing, type' = Core.Nothing}
instance Core.FromJSON Document where
        parseJSON
          = Core.withObject "Document"
              (\ o ->
                 Document Core.<$>
                   (o Core..:? "content") Core.<*> (o Core..:? "gcsContentUri")
                     Core.<*> (o Core..:? "languageCode")
                     Core.<*> (o Core..:? "type"))
...
newEntity 
    ::  Entity
newEntity
  = Entity{mentions = Core.Nothing, metadata = Core.Nothing,
           name = Core.Nothing, sentiment = Core.Nothing,
           type' = Core.Nothing}
instance Core.FromJSON Entity where
        parseJSON
          = Core.withObject "Entity"
              (\ o ->
                 Entity Core.<$>
                   (o Core..:? "mentions") Core.<*> (o Core..:? "metadata") Core.<*>
                     (o Core..:? "name")
...
newEntityMention 
    ::  EntityMention
newEntityMention
  = EntityMention{probability = Core.Nothing,
                  sentiment = Core.Nothing, text = Core.Nothing,
                  type' = Core.Nothing}
instance Core.FromJSON EntityMention where
        parseJSON
          = Core.withObject "EntityMention"
              (\ o ->
                 EntityMention Core.<$>
                   (o Core..:? "probability") Core.<*> (o Core..:? "sentiment")
                     Core.<*> (o Core..:? "text")
                     Core.<*> (o Core..:? "type"))
...
newGpuMetric 
    ::  GpuMetric
newGpuMetric
  = GpuMetric{gpuSec = Core.Nothing, gpuType = Core.Nothing,
              machineSpec = Core.Nothing, trackingLabels = Core.Nothing}
instance Core.FromJSON GpuMetric where
        parseJSON
          = Core.withObject "GpuMetric"
              (\ o ->
                 GpuMetric Core.<$>
                   (o Core..:? "gpuSec" Core.<&> Core.fmap Core.fromAsText) Core.<*>
                     (o Core..:? "gpuType")
                     Core.<*> (o Core..:? "machineSpec")
                     Core.<*> (o Core..:? "trackingLabels"))
...
instance Core.FromJSON GpuMetric_TrackingLabels where
        parseJSON
          = Core.withObject "GpuMetric_TrackingLabels"
...
newInfraUsage 
    ::  InfraUsage
newInfraUsage
  = InfraUsage{cpuMetrics = Core.Nothing, diskMetrics = Core.Nothing,
               gpuMetrics = Core.Nothing, ramMetrics = Core.Nothing,
               tpuMetrics = Core.Nothing}
instance Core.FromJSON InfraUsage where
        parseJSON
          = Core.withObject "InfraUsage"
              (\ o ->
                 InfraUsage Core.<$>
                   (o Core..:? "cpuMetrics") Core.<*> (o Core..:? "diskMetrics")
...
newModerateTextRequest 
    ::  ModerateTextRequest
newModerateTextRequest
  = ModerateTextRequest{document = Core.Nothing,
                        modelVersion = Core.Nothing}
instance Core.FromJSON ModerateTextRequest where
        parseJSON
          = Core.withObject "ModerateTextRequest"
              (\ o ->
                 ModerateTextRequest Core.<$>
                   (o Core..:? "document") Core.<*> (o Core..:? "modelVersion"))
...
newRamMetric 
    ::  RamMetric
newRamMetric
  = RamMetric{gibSec = Core.Nothing, machineSpec = Core.Nothing,
              memories = Core.Nothing, ramType = Core.Nothing,
              trackingLabels = Core.Nothing}
instance Core.FromJSON RamMetric where
        parseJSON
          = Core.withObject "RamMetric"
              (\ o ->
                 RamMetric Core.<$>
                   (o Core..:? "gibSec" Core.<&> Core.fmap Core.fromAsText) Core.<*>
                     (o Core..:? "machineSpec")
...
instance Core.FromJSON RamMetric_TrackingLabels where
        parseJSON
          = Core.withObject "RamMetric_TrackingLabels"
...
instance Core.FromJSON Sentiment where
        parseJSON
          = Core.withObject "Sentiment"
              (\ o ->
                 Sentiment Core.<$>
                   (o Core..:? "magnitude") Core.<*> (o Core..:? "score"))
...
instance Core.FromJSON TpuMetric where
        parseJSON
          = Core.withObject "TpuMetric"
              (\ o ->
                 TpuMetric Core.<$>
                   (o Core..:? "tpuSec" Core.<&> Core.fmap Core.fromAsText) Core.<*>
                     (o Core..:? "tpuType"))
...
newXPSArrayStats 
    ::  XPSArrayStats
newXPSArrayStats
  = XPSArrayStats{commonStats = Core.Nothing,
                  memberStats = Core.Nothing}
instance Core.FromJSON XPSArrayStats where
        parseJSON
          = Core.withObject "XPSArrayStats"
              (\ o ->
                 XPSArrayStats Core.<$>
                   (o Core..:? "commonStats") Core.<*> (o Core..:? "memberStats"))
...
instance Core.FromJSON XPSBatchPredictResponse where
        parseJSON
          = Core.withObject "XPSBatchPredictResponse"
...
newXPSBoundingBoxMetricsEntry 
    ::  XPSBoundingBoxMetricsEntry
newXPSBoundingBoxMetricsEntry
  = XPSBoundingBoxMetricsEntry{confidenceMetricsEntries =
                                 Core.Nothing,
                               iouThreshold = Core.Nothing, meanAveragePrecision = Core.Nothing}
instance Core.FromJSON XPSBoundingBoxMetricsEntry where
        parseJSON
          = Core.withObject "XPSBoundingBoxMetricsEntry"
              (\ o ->
                 XPSBoundingBoxMetricsEntry Core.<$>
                   (o Core..:? "confidenceMetricsEntries") Core.<*>
                     (o Core..:? "iouThreshold")
...
instance Core.ToJSON XPSBoundingBoxMetricsEntry where
        toJSON XPSBoundingBoxMetricsEntry{..}
          = Core.object
              (Core.catMaybes
                 [("confidenceMetricsEntries" Core..=) Core.<$>
...
newXPSBoundingBoxMetricsEntryConfidenceMetricsEntry 
    :: 
                                                    XPSBoundingBoxMetricsEntryConfidenceMetricsEntry
newXPSBoundingBoxMetricsEntryConfidenceMetricsEntry
  = XPSBoundingBoxMetricsEntryConfidenceMetricsEntry{confidenceThreshold
                                                       = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "XPSBoundingBoxMetricsEntryConfidenceMetricsEntry"
              (\ o ->
                 XPSBoundingBoxMetricsEntryConfidenceMetricsEntry Core.<$>
                   (o Core..:? "confidenceThreshold") Core.<*> (o Core..:? "f1Score")
...
newXPSCategoryStats 
    ::  XPSCategoryStats
newXPSCategoryStats
  = XPSCategoryStats{commonStats = Core.Nothing,
                     topCategoryStats = Core.Nothing}
instance Core.FromJSON XPSCategoryStats where
        parseJSON
          = Core.withObject "XPSCategoryStats"
              (\ o ->
                 XPSCategoryStats Core.<$>
                   (o Core..:? "commonStats") Core.<*>
                     (o Core..:? "topCategoryStats"))
...
newXPSCategoryStatsSingleCategoryStats 
    :: 
                                       XPSCategoryStatsSingleCategoryStats
newXPSCategoryStatsSingleCategoryStats
  = XPSCategoryStatsSingleCategoryStats{count = Core.Nothing,
                                        value = Core.Nothing}
instance Core.FromJSON XPSCategoryStatsSingleCategoryStats where
        parseJSON
          = Core.withObject "XPSCategoryStatsSingleCategoryStats"
              (\ o ->
                 XPSCategoryStatsSingleCategoryStats Core.<$>
...
newXPSClassificationEvaluationMetrics 
    :: 
                                      XPSClassificationEvaluationMetrics
newXPSClassificationEvaluationMetrics
  = XPSClassificationEvaluationMetrics{auPrc = Core.Nothing,
                                       auRoc = Core.Nothing, baseAuPrc = Core.Nothing,
...
instance Core.FromJSON XPSClassificationEvaluationMetrics where
        parseJSON
          = Core.withObject "XPSClassificationEvaluationMetrics"
              (\ o ->
                 XPSClassificationEvaluationMetrics Core.<$>
                   (o Core..:? "auPrc") Core.<*> (o Core..:? "auRoc") Core.<*>
                     (o Core..:? "baseAuPrc")
...
newXPSColorMap 
    ::  XPSColorMap
newXPSColorMap
  = XPSColorMap{annotationSpecIdToken = Core.Nothing,
                color = Core.Nothing, displayName = Core.Nothing,
                intColor = Core.Nothing}
instance Core.FromJSON XPSColorMap where
        parseJSON
          = Core.withObject "XPSColorMap"
              (\ o ->
                 XPSColorMap Core.<$>
                   (o Core..:? "annotationSpecIdToken") Core.<*> (o Core..:? "color")
...
newXPSColorMapIntColor 
    ::  XPSColorMapIntColor
newXPSColorMapIntColor
  = XPSColorMapIntColor{blue = Core.Nothing, green = Core.Nothing,
                        red = Core.Nothing}
instance Core.FromJSON XPSColorMapIntColor where
        parseJSON
          = Core.withObject "XPSColorMapIntColor"
              (\ o ->
                 XPSColorMapIntColor Core.<$>
...
newXPSColumnSpec 
    ::  XPSColumnSpec
newXPSColumnSpec
  = XPSColumnSpec{columnId = Core.Nothing, dataStats = Core.Nothing,
                  dataType = Core.Nothing, displayName = Core.Nothing,
                  forecastingMetadata = Core.Nothing,
                  topCorrelatedColumns = Core.Nothing}
instance Core.FromJSON XPSColumnSpec where
        parseJSON
          = Core.withObject "XPSColumnSpec"
              (\ o ->
                 XPSColumnSpec Core.<$>
                   (o Core..:? "columnId") Core.<*> (o Core..:? "dataStats") Core.<*>
                     (o Core..:? "dataType")
                     Core.<*> (o Core..:? "displayName")
...
newXPSColumnSpecCorrelatedColumn 
    ::  XPSColumnSpecCorrelatedColumn
newXPSColumnSpecCorrelatedColumn
  = XPSColumnSpecCorrelatedColumn{columnId = Core.Nothing,
                                  correlationStats = Core.Nothing}
instance Core.FromJSON XPSColumnSpecCorrelatedColumn where
        parseJSON
          = Core.withObject "XPSColumnSpecCorrelatedColumn"
              (\ o ->
                 XPSColumnSpecCorrelatedColumn Core.<$>
                   (o Core..:? "columnId") Core.<*> (o Core..:? "correlationStats"))
...
instance Core.FromJSON XPSColumnSpecForecastingMetadata where
        parseJSON
          = Core.withObject "XPSColumnSpecForecastingMetadata"
              (\ o ->
                 XPSColumnSpecForecastingMetadata Core.<$>
                   (o Core..:? "columnType"))
...
newXPSCommonStats 
    ::  XPSCommonStats
newXPSCommonStats
  = XPSCommonStats{distinctValueCount = Core.Nothing,
                   nullValueCount = Core.Nothing, validValueCount = Core.Nothing}
instance Core.FromJSON XPSCommonStats where
        parseJSON
          = Core.withObject "XPSCommonStats"
              (\ o ->
                 XPSCommonStats Core.<$>
                   (o Core..:? "distinctValueCount" Core.<&>
                      Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "nullValueCount" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "validValueCount" Core.<&> Core.fmap Core.fromAsText))

instance Core.ToJSON XPSCommonStats where
        toJSON XPSCommonStats{..}
          = Core.object
              (Core.catMaybes
                 [("distinctValueCount" Core..=) Core.. Core.AsText Core.<$>
                    distinctValueCount,
                  ("nullValueCount" Core..=) Core.. Core.AsText Core.<$>
                    nullValueCount,
                  ("validValueCount" Core..=) Core.. Core.AsText Core.<$>
                    validValueCount])
...
newXPSConfidenceMetricsEntry 
    ::  XPSConfidenceMetricsEntry
newXPSConfidenceMetricsEntry
  = XPSConfidenceMetricsEntry{confidenceThreshold = Core.Nothing,
                              f1Score = Core.Nothing, f1ScoreAt1 = Core.Nothing,
                              ...
                              positionThreshold = Core.Nothing, precision = Core.Nothing,
                              precisionAt1 = Core.Nothing, recall = Core.Nothing,
                              recallAt1 = Core.Nothing, trueNegativeCount = Core.Nothing,
                              truePositiveCount = Core.Nothing}
instance Core.FromJSON XPSConfidenceMetricsEntry where
        parseJSON
          = Core.withObject "XPSConfidenceMetricsEntry"
              (\ o ->
                 XPSConfidenceMetricsEntry Core.<$>
                   (o Core..:? "confidenceThreshold") Core.<*> (o Core..:? "f1Score")
                     Core.<*> (o Core..:? "f1ScoreAt1")
                     Core.<*>
                     (o Core..:? "falseNegativeCount" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "falsePositiveCount" Core.<&>
                        Core.fmap Core.fromAsText)
                     ...
                     Core.<*>
                     (o Core..:? "trueNegativeCount" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "truePositiveCount" Core.<&>
                        Core.fmap Core.fromAsText))
          ...
          = Core.object
              (Core.catMaybes
                 [("confidenceThreshold" Core..=) Core.<$> confidenceThreshold,
                  ...
                  ("falseNegativeCount" Core..=) Core.. Core.AsText Core.<$>
                    falseNegativeCount,
                  ("falsePositiveCount" Core..=) Core.. Core.AsText Core.<$>
                    falsePositiveCount,
                  ...
                  ("trueNegativeCount" Core..=) Core.. Core.AsText Core.<$>
                    trueNegativeCount,
                  ("truePositiveCount" Core..=) Core.. Core.AsText Core.<$>
                    truePositiveCount])
...
newXPSConfusionMatrix 
    ::  XPSConfusionMatrix
newXPSConfusionMatrix
  = XPSConfusionMatrix{annotationSpecIdToken = Core.Nothing,
                       category = Core.Nothing, row = Core.Nothing,
                       sentimentLabel = Core.Nothing}
instance Core.FromJSON XPSConfusionMatrix where
        parseJSON
          = Core.withObject "XPSConfusionMatrix"
              (\ o ->
                 XPSConfusionMatrix Core.<$>
                   (o Core..:? "annotationSpecIdToken") Core.<*>
                     (o Core..:? "category")
                     Core.<*> (o Core..:? "row")
...
newXPSConfusionMatrixRow 
    ::  XPSConfusionMatrixRow
newXPSConfusionMatrixRow
  = XPSConfusionMatrixRow{count = Core.Nothing,
                          exampleCount = Core.Nothing}
instance Core.FromJSON XPSConfusionMatrixRow where
        parseJSON
          = Core.withObject "XPSConfusionMatrixRow"
              (\ o ->
                 XPSConfusionMatrixRow Core.<$>
                   (o Core..:? "count" Core.<&> Core.fmap (Core.fmap Core.fromAsText))
...
instance Core.FromJSON XPSCoreMlFormat where
        parseJSON
          = Core.withObject "XPSCoreMlFormat"
...
instance Core.FromJSON XPSCorrelationStats where
        parseJSON
          = Core.withObject "XPSCorrelationStats"
...
instance Core.FromJSON XPSDataErrors where
        parseJSON
          = Core.withObject "XPSDataErrors"
              (\ o ->
                 XPSDataErrors Core.<$>
                   (o Core..:? "count") Core.<*> (o Core..:? "errorType"))
...
newXPSDataStats 
    ::  XPSDataStats
newXPSDataStats
  = XPSDataStats{arrayStats = Core.Nothing,
                 categoryStats = Core.Nothing, distinctValueCount = Core.Nothing,
                 float64Stats = Core.Nothing, nullValueCount = Core.Nothing,
                 stringStats = Core.Nothing, structStats = Core.Nothing,
                 timestampStats = Core.Nothing, validValueCount = Core.Nothing}
instance Core.FromJSON XPSDataStats where
        parseJSON
          = Core.withObject "XPSDataStats"
              (\ o ->
                 XPSDataStats Core.<$>
                   (o Core..:? "arrayStats") Core.<*> (o Core..:? "categoryStats")
                     Core.<*>
                     (o Core..:? "distinctValueCount" Core.<&>
                        Core.fmap Core.fromAsText)
...
newXPSDataType 
    ::  XPSDataType
newXPSDataType
  = XPSDataType{compatibleDataTypes = Core.Nothing,
                listElementType = Core.Nothing, nullable = Core.Nothing,
                structType = Core.Nothing, timeFormat = Core.Nothing,
                typeCode = Core.Nothing}
instance Core.FromJSON XPSDataType where
        parseJSON
          = Core.withObject "XPSDataType"
              (\ o ->
                 XPSDataType Core.<$>
                   (o Core..:? "compatibleDataTypes") Core.<*>
                     (o Core..:? "listElementType")
...
newXPSDockerFormat 
    ::  XPSDockerFormat
newXPSDockerFormat
  = XPSDockerFormat{cpuArchitecture = Core.Nothing,
                    gpuArchitecture = Core.Nothing}
instance Core.FromJSON XPSDockerFormat where
        parseJSON
          = Core.withObject "XPSDockerFormat"
              (\ o ->
                 XPSDockerFormat Core.<$>
                   (o Core..:? "cpuArchitecture") Core.<*>
                     (o Core..:? "gpuArchitecture"))
...
instance Core.FromJSON XPSEdgeTpuTfLiteFormat where
        parseJSON
          = Core.withObject "XPSEdgeTpuTfLiteFormat"
...
newXPSEvaluationMetrics 
    ::  XPSEvaluationMetrics
newXPSEvaluationMetrics
  = XPSEvaluationMetrics{annotationSpecIdToken = Core.Nothing,
                         category = Core.Nothing, evaluatedExampleCount = Core.Nothing,
                         imageClassificationEvalMetrics = Core.Nothing,
                         imageObjectDetectionEvalMetrics = Core.Nothing,
                         imageSegmentationEvalMetrics = Core.Nothing, label = Core.Nothing,
...
instance Core.FromJSON XPSEvaluationMetrics where
        parseJSON
          = Core.withObject "XPSEvaluationMetrics"
              (\ o ->
                 XPSEvaluationMetrics Core.<$>
                   (o Core..:? "annotationSpecIdToken") Core.<*>
                     (o Core..:? "category")
...
newXPSEvaluationMetricsSet 
    ::  XPSEvaluationMetricsSet
newXPSEvaluationMetricsSet
  = XPSEvaluationMetricsSet{evaluationMetrics = Core.Nothing,
                            fileSpec = Core.Nothing, numEvaluationMetrics = Core.Nothing}
instance Core.FromJSON XPSEvaluationMetricsSet where
        parseJSON
          = Core.withObject "XPSEvaluationMetricsSet"
              (\ o ->
                 XPSEvaluationMetricsSet Core.<$>
                   (o Core..:? "evaluationMetrics") Core.<*> (o Core..:? "fileSpec")
                     Core.<*>
                     (o Core..:? "numEvaluationMetrics" Core.<&>
                        Core.fmap Core.fromAsText))
          ...
          = Core.object
              (Core.catMaybes
                 [("evaluationMetrics" Core..=) Core.<$> evaluationMetrics,
                  ...
                  ("numEvaluationMetrics" Core..=) Core.. Core.AsText Core.<$>
...
newXPSExampleSet 
    ::  XPSExampleSet
newXPSExampleSet
  = XPSExampleSet{fileSpec = Core.Nothing,
                  fingerprint = Core.Nothing, numExamples = Core.Nothing,
                  numInputSources = Core.Nothing}
instance Core.FromJSON XPSExampleSet where
        parseJSON
          = Core.withObject "XPSExampleSet"
              (\ o ->
                 XPSExampleSet Core.<$>
                   (o Core..:? "fileSpec") Core.<*>
                     (o Core..:? "fingerprint" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "numExamples" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "numInputSources" Core.<&> Core.fmap Core.fromAsText))
          ...
          = Core.object
              (Core.catMaybes
                 [("fileSpec" Core..=) Core.<$> fileSpec,
                  ...
                  ("numInputSources" Core..=) Core.. Core.AsText Core.<$>
                    numInputSources])
...
newXPSExportModelOutputConfig 
    ::  XPSExportModelOutputConfig
newXPSExportModelOutputConfig
  = XPSExportModelOutputConfig{coreMlFormat = Core.Nothing,
                               dockerFormat = Core.Nothing, edgeTpuTfLiteFormat = Core.Nothing,
                               exportFirebaseAuxiliaryInfo = Core.Nothing,
                               outputGcrUri = Core.Nothing, outputGcsUri = Core.Nothing,
                               tfJsFormat = Core.Nothing, tfLiteFormat = Core.Nothing,
                               tfSavedModelFormat = Core.Nothing}
instance Core.FromJSON XPSExportModelOutputConfig where
        parseJSON
          = Core.withObject "XPSExportModelOutputConfig"
              (\ o ->
                 XPSExportModelOutputConfig Core.<$>
                   (o Core..:? "coreMlFormat") Core.<*> (o Core..:? "dockerFormat")
          ...
          = Core.object
              (Core.catMaybes
                 [("coreMlFormat" Core..=) Core.<$> coreMlFormat,
                  ...
                  ("exportFirebaseAuxiliaryInfo" Core..=) Core.<$>
...
newXPSFileSpec 
    ::  XPSFileSpec
newXPSFileSpec
  = XPSFileSpec{directoryPath = Core.Nothing,
                fileFormat = Core.Nothing, fileSpec = Core.Nothing,
                singleFilePath = Core.Nothing}
instance Core.FromJSON XPSFileSpec where
        parseJSON
          = Core.withObject "XPSFileSpec"
              (\ o ->
                 XPSFileSpec Core.<$>
                   (o Core..:? "directoryPath") Core.<*> (o Core..:? "fileFormat")
...
newXPSFloat64Stats 
    ::  XPSFloat64Stats
newXPSFloat64Stats
  = XPSFloat64Stats{commonStats = Core.Nothing,
                    histogramBuckets = Core.Nothing, mean = Core.Nothing,
                    quantiles = Core.Nothing, standardDeviation = Core.Nothing}
instance Core.FromJSON XPSFloat64Stats where
        parseJSON
          = Core.withObject "XPSFloat64Stats"
              (\ o ->
                 XPSFloat64Stats Core.<$>
                   (o Core..:? "commonStats") Core.<*> (o Core..:? "histogramBuckets")
                     Core.<*> (o Core..:? "mean")
...
newXPSFloat64StatsHistogramBucket 
    ::  XPSFloat64StatsHistogramBucket
newXPSFloat64StatsHistogramBucket
  = XPSFloat64StatsHistogramBucket{count = Core.Nothing,
                                   max = Core.Nothing, min = Core.Nothing}
instance Core.FromJSON XPSFloat64StatsHistogramBucket where
        parseJSON
          = Core.withObject "XPSFloat64StatsHistogramBucket"
              (\ o ->
                 XPSFloat64StatsHistogramBucket Core.<$>
                   (o Core..:? "count" Core.<&> Core.fmap Core.fromAsText) Core.<*>
                     (o Core..:? "max")
                     Core.<*> (o Core..:? "min"))
...
newXPSImageClassificationTrainResponse 
    :: 
                                       XPSImageClassificationTrainResponse
newXPSImageClassificationTrainResponse
  = XPSImageClassificationTrainResponse{classCount = Core.Nothing,
                                        exportModelSpec = Core.Nothing,
                                        modelArtifactSpec = Core.Nothing,
                                        modelServingSpec = Core.Nothing, stopReason = Core.Nothing,
...
instance Core.FromJSON XPSImageClassificationTrainResponse where
        parseJSON
          = Core.withObject "XPSImageClassificationTrainResponse"
              (\ o ->
                 XPSImageClassificationTrainResponse Core.<$>
                   (o Core..:? "classCount" Core.<&> Core.fmap Core.fromAsText)
                     ...
                     Core.<*>
                     (o Core..:? "trainCostNodeSeconds" Core.<&>
                        Core.fmap Core.fromAsText))
          ...
          = Core.object
              (Core.catMaybes
                 [("classCount" Core..=) Core.. Core.AsText Core.<$> classCount,
                  ...
                  ("trainCostNodeSeconds" Core..=) Core.. Core.AsText Core.<$>
...
instance Core.FromJSON XPSImageExportModelSpec where
        parseJSON
          = Core.withObject "XPSImageExportModelSpec"
              (\ o ->
                 XPSImageExportModelSpec Core.<$>
                   (o Core..:? "exportModelOutputConfig"))

instance Core.ToJSON XPSImageExportModelSpec where
        toJSON XPSImageExportModelSpec{..}
          = Core.object
              (Core.catMaybes
                 [("exportModelOutputConfig" Core..=) Core.<$>
...
newXPSImageModelArtifactSpec 
    ::  XPSImageModelArtifactSpec
newXPSImageModelArtifactSpec
  = XPSImageModelArtifactSpec{checkpointArtifact = Core.Nothing,
                              exportArtifact = Core.Nothing, labelGcsUri = Core.Nothing,
                              servingArtifact = Core.Nothing, tfJsBinaryGcsPrefix = Core.Nothing,
                              tfLiteMetadataGcsUri = Core.Nothing}
instance Core.FromJSON XPSImageModelArtifactSpec where
        parseJSON
          = Core.withObject "XPSImageModelArtifactSpec"
              (\ o ->
                 XPSImageModelArtifactSpec Core.<$>
                   (o Core..:? "checkpointArtifact") Core.<*>
                     (o Core..:? "exportArtifact")
...
newXPSImageModelServingSpec 
    ::  XPSImageModelServingSpec
newXPSImageModelServingSpec
  = XPSImageModelServingSpec{modelThroughputEstimation =
                               Core.Nothing,
                             nodeQps = Core.Nothing, tfRuntimeVersion = Core.Nothing}
instance Core.FromJSON XPSImageModelServingSpec where
        parseJSON
          = Core.withObject "XPSImageModelServingSpec"
              (\ o ->
                 XPSImageModelServingSpec Core.<$>
                   (o Core..:? "modelThroughputEstimation") Core.<*>
                     (o Core..:? "nodeQps")
...
instance Core.ToJSON XPSImageModelServingSpec where
        toJSON XPSImageModelServingSpec{..}
          = Core.object
              (Core.catMaybes
                 [("modelThroughputEstimation" Core..=) Core.<$>
...
data XPSImageModelServingSpecModelThroughputEstimation = XPSImageModelServingSpecModelThroughputEstimation
    {
      ...
      computeEngineAcceleratorType :: (Core.Maybe
   XPSImageModelServingSpecModelThroughputEstimation_ComputeEngineAcceleratorType)
    ...
    , servomaticPartitionType :: (Core.Maybe
...
newXPSImageModelServingSpecModelThroughputEstimation 
    :: 
                                                     XPSImageModelServingSpecModelThroughputEstimation
newXPSImageModelServingSpecModelThroughputEstimation
  = XPSImageModelServingSpecModelThroughputEstimation{computeEngineAcceleratorType
                                                        = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "XPSImageModelServingSpecModelThroughputEstimation"
              (\ o ->
                 XPSImageModelServingSpecModelThroughputEstimation Core.<$>
                   (o Core..:? "computeEngineAcceleratorType") Core.<*>
                     (o Core..:? "latencyInMilliseconds")
                     Core.<*> (o Core..:? "nodeQps")
...
newXPSImageObjectDetectionEvaluationMetrics 
    :: 
                                            XPSImageObjectDetectionEvaluationMetrics
newXPSImageObjectDetectionEvaluationMetrics
  = XPSImageObjectDetectionEvaluationMetrics{boundingBoxMeanAveragePrecision
                                               = Core.Nothing,
                                             boundingBoxMetricsEntries = Core.Nothing,
                                             evaluatedBoundingBoxCount = Core.Nothing}
instance Core.FromJSON XPSImageObjectDetectionEvaluationMetrics
         where
        parseJSON
          = Core.withObject "XPSImageObjectDetectionEvaluationMetrics"
              (\ o ->
                 XPSImageObjectDetectionEvaluationMetrics Core.<$>
                   (o Core..:? "boundingBoxMeanAveragePrecision") Core.<*>
                     (o Core..:? "boundingBoxMetricsEntries")
...
instance Core.ToJSON XPSImageObjectDetectionEvaluationMetrics where
        toJSON XPSImageObjectDetectionEvaluationMetrics{..}
          = Core.object
              (Core.catMaybes
                 [("boundingBoxMeanAveragePrecision" Core..=) Core.<$>
                    boundingBoxMeanAveragePrecision,
                  ("boundingBoxMetricsEntries" Core..=) Core.<$>
                    boundingBoxMetricsEntries,
                  ("evaluatedBoundingBoxCount" Core..=) Core.<$>
...
newXPSImageObjectDetectionModelSpec 
    :: 
                                    XPSImageObjectDetectionModelSpec
newXPSImageObjectDetectionModelSpec
  = XPSImageObjectDetectionModelSpec{classCount = Core.Nothing,
                                     exportModelSpec = Core.Nothing,
...
instance Core.FromJSON XPSImageObjectDetectionModelSpec where
        parseJSON
          = Core.withObject "XPSImageObjectDetectionModelSpec"
              (\ o ->
                 XPSImageObjectDetectionModelSpec Core.<$>
                   (o Core..:? "classCount" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "exportModelSpec")
                     Core.<*>
                     (o Core..:? "maxBoundingBoxCount" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "modelArtifactSpec")
                     Core.<*> (o Core..:? "modelServingSpec")
                     Core.<*> (o Core..:? "stopReason")
        ...
        toJSON XPSImageObjectDetectionModelSpec{..}
          = Core.object
              (Core.catMaybes
                 [("classCount" Core..=) Core.. Core.AsText Core.<$> classCount,
                  ("exportModelSpec" Core..=) Core.<$> exportModelSpec,
                  ("maxBoundingBoxCount" Core..=) Core.. Core.AsText Core.<$>
                    maxBoundingBoxCount,
                  ("modelArtifactSpec" Core..=) Core.<$> modelArtifactSpec,
                  ("modelServingSpec" Core..=) Core.<$> modelServingSpec,
                  ("stopReason" Core..=) Core.<$> stopReason,
...
newtype XPSImageSegmentationEvaluationMetrics = XPSImageSegmentationEvaluationMetrics
    {
      -- | Metrics that have confidence thresholds. Precision-recall curve can be derived from it.
      confidenceMetricsEntries :: (Core.Maybe
   [XPSImageSegmentationEvaluationMetricsConfidenceMetricsEntry])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newXPSImageSegmentationEvaluationMetrics 
    :: 
                                         XPSImageSegmentationEvaluationMetrics
newXPSImageSegmentationEvaluationMetrics
  = XPSImageSegmentationEvaluationMetrics{confidenceMetricsEntries =
                                            Core.Nothing}
instance Core.FromJSON XPSImageSegmentationEvaluationMetrics where
        parseJSON
          = Core.withObject "XPSImageSegmentationEvaluationMetrics"
              (\ o ->
                 XPSImageSegmentationEvaluationMetrics Core.<$>
                   (o Core..:? "confidenceMetricsEntries"))
...
newXPSImageSegmentationEvaluationMetricsConfidenceMetricsEntry 
    :: 
                                                               XPSImageSegmentationEvaluationMetricsConfidenceMetricsEntry
newXPSImageSegmentationEvaluationMetricsConfidenceMetricsEntry
  = XPSImageSegmentationEvaluationMetricsConfidenceMetricsEntry{confidenceThreshold
                                                                  = Core.Nothing,
                                                                confusionMatrix = Core.Nothing,
...
newXPSImageSegmentationTrainResponse 
    :: 
                                     XPSImageSegmentationTrainResponse
newXPSImageSegmentationTrainResponse
  = XPSImageSegmentationTrainResponse{colorMaps = Core.Nothing,
                                      exportModelSpec = Core.Nothing,
                                      modelArtifactSpec = Core.Nothing,
                                      modelServingSpec = Core.Nothing, stopReason = Core.Nothing,
                                      trainCostNodeSeconds = Core.Nothing}
instance Core.FromJSON XPSImageSegmentationTrainResponse where
        parseJSON
          = Core.withObject "XPSImageSegmentationTrainResponse"
              (\ o ->
                 XPSImageSegmentationTrainResponse Core.<$>
                   (o Core..:? "colorMaps") Core.<*> (o Core..:? "exportModelSpec")
                     Core.<*> (o Core..:? "modelArtifactSpec")
                     Core.<*> (o Core..:? "modelServingSpec")
                     Core.<*> (o Core..:? "stopReason")
                     Core.<*>
...
instance Core.FromJSON XPSIntegratedGradientsAttribution where
        parseJSON
          = Core.withObject "XPSIntegratedGradientsAttribution"
              (\ o ->
                 XPSIntegratedGradientsAttribution Core.<$>
                   (o Core..:? "stepCount"))
...
newXPSMetricEntry 
    ::  XPSMetricEntry
newXPSMetricEntry
  = XPSMetricEntry{argentumMetricId = Core.Nothing,
                   doubleValue = Core.Nothing, int64Value = Core.Nothing,
                   metricName = Core.Nothing, systemLabels = Core.Nothing}
instance Core.FromJSON XPSMetricEntry where
        parseJSON
          = Core.withObject "XPSMetricEntry"
              (\ o ->
                 XPSMetricEntry Core.<$>
                   (o Core..:? "argentumMetricId") Core.<*> (o Core..:? "doubleValue")
                     Core.<*>
...
newXPSMetricEntryLabel 
    ::  XPSMetricEntryLabel
newXPSMetricEntryLabel
  = XPSMetricEntryLabel{labelName = Core.Nothing,
                        labelValue = Core.Nothing}
instance Core.FromJSON XPSMetricEntryLabel where
        parseJSON
          = Core.withObject "XPSMetricEntryLabel"
              (\ o ->
                 XPSMetricEntryLabel Core.<$>
                   (o Core..:? "labelName") Core.<*> (o Core..:? "labelValue"))
...
newXPSModelArtifactItem 
    ::  XPSModelArtifactItem
newXPSModelArtifactItem
  = XPSModelArtifactItem{artifactFormat = Core.Nothing,
                         gcsUri = Core.Nothing}
instance Core.FromJSON XPSModelArtifactItem where
        parseJSON
          = Core.withObject "XPSModelArtifactItem"
              (\ o ->
                 XPSModelArtifactItem Core.<$>
                   (o Core..:? "artifactFormat") Core.<*> (o Core..:? "gcsUri"))
...
newXPSPreprocessResponse 
    ::  XPSPreprocessResponse
newXPSPreprocessResponse
  = XPSPreprocessResponse{outputExampleSet = Core.Nothing,
...
instance Core.FromJSON XPSPreprocessResponse where
        parseJSON
          = Core.withObject "XPSPreprocessResponse"
              (\ o ->
                 XPSPreprocessResponse Core.<$>
                   (o Core..:? "outputExampleSet") Core.<*>
                     (o Core..:? "speechPreprocessResp")
          ...
          = Core.object
              (Core.catMaybes
                 [("outputExampleSet" Core..=) Core.<$> outputExampleSet,
                  ...
                  ("tablesPreprocessResponse" Core..=) Core.<$>
                    tablesPreprocessResponse,
                  ("translationPreprocessResp" Core..=) Core.<$>
...
newXPSRegressionEvaluationMetrics 
    ::  XPSRegressionEvaluationMetrics
newXPSRegressionEvaluationMetrics
  = XPSRegressionEvaluationMetrics{meanAbsoluteError = Core.Nothing,
                                   meanAbsolutePercentageError = Core.Nothing,
                                   rSquared = Core.Nothing, regressionMetricsEntries = Core.Nothing,
...
instance Core.FromJSON XPSRegressionEvaluationMetrics where
        parseJSON
          = Core.withObject "XPSRegressionEvaluationMetrics"
              (\ o ->
                 XPSRegressionEvaluationMetrics Core.<$>
                   (o Core..:? "meanAbsoluteError") Core.<*>
                     (o Core..:? "meanAbsolutePercentageError")
...
newXPSRegressionMetricsEntry 
    ::  XPSRegressionMetricsEntry
newXPSRegressionMetricsEntry
  = XPSRegressionMetricsEntry{predictedValue = Core.Nothing,
                              trueValue = Core.Nothing}
instance Core.FromJSON XPSRegressionMetricsEntry where
        parseJSON
          = Core.withObject "XPSRegressionMetricsEntry"
              (\ o ->
                 XPSRegressionMetricsEntry Core.<$>
                   (o Core..:? "predictedValue") Core.<*> (o Core..:? "trueValue"))
...
newXPSReportingMetrics 
    ::  XPSReportingMetrics
newXPSReportingMetrics
  = XPSReportingMetrics{effectiveTrainingDuration = Core.Nothing,
                        metricEntries = Core.Nothing}
instance Core.FromJSON XPSReportingMetrics where
        parseJSON
          = Core.withObject "XPSReportingMetrics"
              (\ o ->
                 XPSReportingMetrics Core.<$>
                   (o Core..:? "effectiveTrainingDuration") Core.<*>
                     (o Core..:? "metricEntries"))

instance Core.ToJSON XPSReportingMetrics where
        toJSON XPSReportingMetrics{..}
          = Core.object
              (Core.catMaybes
                 [("effectiveTrainingDuration" Core..=) Core.<$>
...
newXPSResponseExplanationMetadata 
    ::  XPSResponseExplanationMetadata
newXPSResponseExplanationMetadata
  = XPSResponseExplanationMetadata{inputs = Core.Nothing,
                                   outputs = Core.Nothing}
instance Core.FromJSON XPSResponseExplanationMetadata where
        parseJSON
          = Core.withObject "XPSResponseExplanationMetadata"
              (\ o ->
                 XPSResponseExplanationMetadata Core.<$>
                   (o Core..:? "inputs") Core.<*> (o Core..:? "outputs"))
...
instance Core.FromJSON XPSResponseExplanationMetadata_Inputs where
        parseJSON
          = Core.withObject "XPSResponseExplanationMetadata_Inputs"
              (\ o ->
                 XPSResponseExplanationMetadata_Inputs Core.<$>
...
instance Core.FromJSON XPSResponseExplanationMetadata_Outputs where
        parseJSON
          = Core.withObject "XPSResponseExplanationMetadata_Outputs"
              (\ o ->
                 XPSResponseExplanationMetadata_Outputs Core.<$>
                   (Core.parseJSONObject o))
...
newXPSResponseExplanationMetadataInputMetadata 
    :: 
                                               XPSResponseExplanationMetadataInputMetadata
newXPSResponseExplanationMetadataInputMetadata
  = XPSResponseExplanationMetadataInputMetadata{inputTensorName =
                                                  Core.Nothing,
                                                modality = Core.Nothing,
                                                visualizationConfig = Core.Nothing}
instance Core.FromJSON XPSResponseExplanationMetadataInputMetadata
         where
        parseJSON
          = Core.withObject "XPSResponseExplanationMetadataInputMetadata"
              (\ o ->
                 XPSResponseExplanationMetadataInputMetadata Core.<$>
                   (o Core..:? "inputTensorName") Core.<*> (o Core..:? "modality")
                     Core.<*> (o Core..:? "visualizationConfig"))

instance Core.ToJSON XPSResponseExplanationMetadataInputMetadata
         where
...
newXPSResponseExplanationMetadataOutputMetadata 
    :: 
                                                XPSResponseExplanationMetadataOutputMetadata
newXPSResponseExplanationMetadataOutputMetadata
  = XPSResponseExplanationMetadataOutputMetadata{outputTensorName =
                                                   Core.Nothing}
instance Core.FromJSON XPSResponseExplanationMetadataOutputMetadata
         where
        parseJSON
          = Core.withObject "XPSResponseExplanationMetadataOutputMetadata"
              (\ o ->
                 XPSResponseExplanationMetadataOutputMetadata Core.<$>
                   (o Core..:? "outputTensorName"))

instance Core.ToJSON XPSResponseExplanationMetadataOutputMetadata
         where
...
newXPSResponseExplanationParameters 
    :: 
                                    XPSResponseExplanationParameters
newXPSResponseExplanationParameters
  = XPSResponseExplanationParameters{integratedGradientsAttribution =
                                       Core.Nothing,
                                     xraiAttribution = Core.Nothing}
instance Core.FromJSON XPSResponseExplanationParameters where
        parseJSON
          = Core.withObject "XPSResponseExplanationParameters"
              (\ o ->
                 XPSResponseExplanationParameters Core.<$>
                   (o Core..:? "integratedGradientsAttribution") Core.<*>
                     (o Core..:? "xraiAttribution"))
...
newXPSResponseExplanationSpec 
    ::  XPSResponseExplanationSpec
newXPSResponseExplanationSpec
  = XPSResponseExplanationSpec{explanationType = Core.Nothing,
                               metadata = Core.Nothing, parameters = Core.Nothing}
instance Core.FromJSON XPSResponseExplanationSpec where
        parseJSON
          = Core.withObject "XPSResponseExplanationSpec"
              (\ o ->
                 XPSResponseExplanationSpec Core.<$>
                   (o Core..:? "explanationType") Core.<*> (o Core..:? "metadata")
...
instance Core.FromJSON XPSRow where
        parseJSON
          = Core.withObject "XPSRow"
              (\ o ->
                 XPSRow Core.<$>
                   (o Core..:? "columnIds") Core.<*> (o Core..:? "values"))
...
newXPSSpeechEvaluationMetrics 
    ::  XPSSpeechEvaluationMetrics
newXPSSpeechEvaluationMetrics
  = XPSSpeechEvaluationMetrics{subModelEvaluationMetrics =
                                 Core.Nothing}
instance Core.FromJSON XPSSpeechEvaluationMetrics where
        parseJSON
          = Core.withObject "XPSSpeechEvaluationMetrics"
              (\ o ->
                 XPSSpeechEvaluationMetrics Core.<$>
                   (o Core..:? "subModelEvaluationMetrics"))

instance Core.ToJSON XPSSpeechEvaluationMetrics where
        toJSON XPSSpeechEvaluationMetrics{..}
          = Core.object
              (Core.catMaybes
                 [("subModelEvaluationMetrics" Core..=) Core.<$>
...
newXPSSpeechEvaluationMetricsSubModelEvaluationMetric 
    :: 
                                                      XPSSpeechEvaluationMetricsSubModelEvaluationMetric
newXPSSpeechEvaluationMetricsSubModelEvaluationMetric
  = XPSSpeechEvaluationMetricsSubModelEvaluationMetric{biasingModelType
                                                         = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "XPSSpeechEvaluationMetricsSubModelEvaluationMetric"
              (\ o ->
                 XPSSpeechEvaluationMetricsSubModelEvaluationMetric Core.<$>
                   (o Core..:? "biasingModelType") Core.<*>
                     (o Core..:? "isEnhancedModel")
...
newXPSSpeechModelSpec 
    ::  XPSSpeechModelSpec
newXPSSpeechModelSpec
  = XPSSpeechModelSpec{datasetId = Core.Nothing,
                       language = Core.Nothing, subModelSpecs = Core.Nothing}
instance Core.FromJSON XPSSpeechModelSpec where
        parseJSON
          = Core.withObject "XPSSpeechModelSpec"
              (\ o ->
                 XPSSpeechModelSpec Core.<$>
...
newXPSSpeechModelSpecSubModelSpec 
    ::  XPSSpeechModelSpecSubModelSpec
newXPSSpeechModelSpecSubModelSpec
  = XPSSpeechModelSpecSubModelSpec{biasingModelType = Core.Nothing,
                                   clientId = Core.Nothing, contextId = Core.Nothing,
                                   isEnhancedModel = Core.Nothing}
instance Core.FromJSON XPSSpeechModelSpecSubModelSpec where
        parseJSON
          = Core.withObject "XPSSpeechModelSpecSubModelSpec"
              (\ o ->
                 XPSSpeechModelSpecSubModelSpec Core.<$>
                   (o Core..:? "biasingModelType") Core.<*> (o Core..:? "clientId")
...
newXPSSpeechPreprocessResponse 
    ::  XPSSpeechPreprocessResponse
newXPSSpeechPreprocessResponse
  = XPSSpeechPreprocessResponse{cnsTestDataPath = Core.Nothing,
...
instance Core.FromJSON XPSSpeechPreprocessResponse where
        parseJSON
          = Core.withObject "XPSSpeechPreprocessResponse"
              (\ o ->
                 XPSSpeechPreprocessResponse Core.<$>
                   (o Core..:? "cnsTestDataPath") Core.<*>
                     (o Core..:? "cnsTrainDataPath")
          ...
          = Core.object
              (Core.catMaybes
                 [("cnsTestDataPath" Core..=) Core.<$> cnsTestDataPath,
                  ...
                  ("prebuiltModelEvaluationMetrics" Core..=) Core.<$>
...
newXPSSpeechPreprocessStats 
    ::  XPSSpeechPreprocessStats
newXPSSpeechPreprocessStats
  = XPSSpeechPreprocessStats{dataErrors = Core.Nothing,
                             ...
                             testSentencesCount = Core.Nothing, testWordsCount = Core.Nothing,
                             trainExamplesCount = Core.Nothing,
                             trainSentencesCount = Core.Nothing, trainWordsCount = Core.Nothing}
instance Core.FromJSON XPSSpeechPreprocessStats where
        parseJSON
          = Core.withObject "XPSSpeechPreprocessStats"
              (\ o ->
                 XPSSpeechPreprocessStats Core.<$>
                   (o Core..:? "dataErrors") Core.<*>
                     (o Core..:? "numHumanLabeledExamples")
          ...
          = Core.object
              (Core.catMaybes
                 [("dataErrors" Core..=) Core.<$> dataErrors,
                  ("numHumanLabeledExamples" Core..=) Core.<$>
                    numHumanLabeledExamples,
                  ("numLogsExamples" Core..=) Core.<$> numLogsExamples,
                  ("numMachineTranscribedExamples" Core..=) Core.<$>
...
newXPSStringStats 
    ::  XPSStringStats
newXPSStringStats
  = XPSStringStats{commonStats = Core.Nothing,
                   topUnigramStats = Core.Nothing}
instance Core.FromJSON XPSStringStats where
        parseJSON
          = Core.withObject "XPSStringStats"
              (\ o ->
                 XPSStringStats Core.<$>
                   (o Core..:? "commonStats") Core.<*> (o Core..:? "topUnigramStats"))
...
newXPSStringStatsUnigramStats 
    ::  XPSStringStatsUnigramStats
newXPSStringStatsUnigramStats
  = XPSStringStatsUnigramStats{count = Core.Nothing,
                               value = Core.Nothing}
instance Core.FromJSON XPSStringStatsUnigramStats where
        parseJSON
          = Core.withObject "XPSStringStatsUnigramStats"
              (\ o ->
                 XPSStringStatsUnigramStats Core.<$>
                   (o Core..:? "count" Core.<&> Core.fmap Core.fromAsText) Core.<*>
                     (o Core..:? "value"))
...
newXPSStructStats 
    ::  XPSStructStats
newXPSStructStats
  = XPSStructStats{commonStats = Core.Nothing,
                   fieldStats = Core.Nothing}
instance Core.FromJSON XPSStructStats where
        parseJSON
          = Core.withObject "XPSStructStats"
              (\ o ->
                 XPSStructStats Core.<$>
                   (o Core..:? "commonStats") Core.<*> (o Core..:? "fieldStats"))
...
instance Core.FromJSON XPSStructStats_FieldStats where
        parseJSON
          = Core.withObject "XPSStructStats_FieldStats"
              (\ o ->
...
instance Core.FromJSON XPSStructType_Fields where
        parseJSON
          = Core.withObject "XPSStructType_Fields"
...
newXPSTableSpec 
    ::  XPSTableSpec
newXPSTableSpec
  = XPSTableSpec{columnSpecs = Core.Nothing,
                 importedDataSizeInBytes = Core.Nothing, rowCount = Core.Nothing,
                 timeColumnId = Core.Nothing, validRowCount = Core.Nothing}
instance Core.FromJSON XPSTableSpec where
        parseJSON
          = Core.withObject "XPSTableSpec"
              (\ o ->
                 XPSTableSpec Core.<$>
                   (o Core..:? "columnSpecs") Core.<*>
                     (o Core..:? "importedDataSizeInBytes" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "rowCount" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "timeColumnId")
                     Core.<*>
                     (o Core..:? "validRowCount" Core.<&> Core.fmap Core.fromAsText))
...
instance Core.FromJSON XPSTableSpec_ColumnSpecs where
        parseJSON
          = Core.withObject "XPSTableSpec_ColumnSpecs"
...
instance Core.FromJSON XPSTablesClassificationMetrics where
        parseJSON
          = Core.withObject "XPSTablesClassificationMetrics"
              (\ o ->
                 XPSTablesClassificationMetrics Core.<$>
                   (o Core..:? "curveMetrics"))
...
newXPSTablesClassificationMetricsCurveMetrics 
    :: 
                                              XPSTablesClassificationMetricsCurveMetrics
newXPSTablesClassificationMetricsCurveMetrics
  = XPSTablesClassificationMetricsCurveMetrics{aucPr = Core.Nothing,
                                               aucRoc = Core.Nothing,
                                               confidenceMetricsEntries = Core.Nothing,
                                               logLoss = Core.Nothing,
                                               positionThreshold = Core.Nothing,
                                               value = Core.Nothing}
instance Core.FromJSON XPSTablesClassificationMetricsCurveMetrics
         where
        parseJSON
          = Core.withObject "XPSTablesClassificationMetricsCurveMetrics"
              (\ o ->
                 XPSTablesClassificationMetricsCurveMetrics Core.<$>
                   (o Core..:? "aucPr") Core.<*> (o Core..:? "aucRoc") Core.<*>
                     (o Core..:? "confidenceMetricsEntries")
                     Core.<*> (o Core..:? "logLoss")
                     Core.<*> (o Core..:? "positionThreshold")
                     Core.<*> (o Core..:? "value"))

instance Core.ToJSON XPSTablesClassificationMetricsCurveMetrics
         where
...
newXPSTablesConfidenceMetricsEntry 
    :: 
                                   XPSTablesConfidenceMetricsEntry
newXPSTablesConfidenceMetricsEntry
  = XPSTablesConfidenceMetricsEntry{confidenceThreshold =
                                      Core.Nothing,
                                    f1Score = Core.Nothing, falseNegativeCount = Core.Nothing,
                                    falsePositiveCount = Core.Nothing,
                                    falsePositiveRate = Core.Nothing, precision = Core.Nothing,
                                    recall = Core.Nothing, trueNegativeCount = Core.Nothing,
                                    truePositiveCount = Core.Nothing,
                                    truePositiveRate = Core.Nothing}
instance Core.FromJSON XPSTablesConfidenceMetricsEntry where
        parseJSON
          = Core.withObject "XPSTablesConfidenceMetricsEntry"
              (\ o ->
                 XPSTablesConfidenceMetricsEntry Core.<$>
                   (o Core..:? "confidenceThreshold") Core.<*> (o Core..:? "f1Score")
                     Core.<*>
                     (o Core..:? "falseNegativeCount" Core.<&>
                        Core.fmap Core.fromAsText)
                     ...
                     (o Core..:? "trueNegativeCount" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "truePositiveCount" Core.<&> Core.fmap Core.fromAsText)
...
newXPSTablesDatasetMetadata 
    ::  XPSTablesDatasetMetadata
newXPSTablesDatasetMetadata
  = XPSTablesDatasetMetadata{mlUseColumnId = Core.Nothing,
                             primaryTableSpec = Core.Nothing,
                             targetColumnCorrelations = Core.Nothing,
                             targetColumnId = Core.Nothing, weightColumnId = Core.Nothing}
instance Core.FromJSON XPSTablesDatasetMetadata where
        parseJSON
          = Core.withObject "XPSTablesDatasetMetadata"
              (\ o ->
                 XPSTablesDatasetMetadata Core.<$>
                   (o Core..:? "mlUseColumnId") Core.<*>
                     (o Core..:? "primaryTableSpec")
          ...
          = Core.object
              (Core.catMaybes
                 [("mlUseColumnId" Core..=) Core.<$> mlUseColumnId,
                  ...
                  ("targetColumnCorrelations" Core..=) Core.<$>
...
newXPSTablesDatasetMetadata_TargetColumnCorrelations additional
  = XPSTablesDatasetMetadata_TargetColumnCorrelations{additional =
                                                        additional}
instance Core.FromJSON
           XPSTablesDatasetMetadata_TargetColumnCorrelations
         where
        parseJSON
          = Core.withObject
              "XPSTablesDatasetMetadata_TargetColumnCorrelations"
              (\ o ->
                 XPSTablesDatasetMetadata_TargetColumnCorrelations Core.<$>
                   (Core.parseJSONObject o))
...
newXPSTablesEvaluationMetrics 
    ::  XPSTablesEvaluationMetrics
newXPSTablesEvaluationMetrics
  = XPSTablesEvaluationMetrics{classificationMetrics = Core.Nothing,
                               regressionMetrics = Core.Nothing}
instance Core.FromJSON XPSTablesEvaluationMetrics where
        parseJSON
          = Core.withObject "XPSTablesEvaluationMetrics"
              (\ o ->
                 XPSTablesEvaluationMetrics Core.<$>
                   (o Core..:? "classificationMetrics") Core.<*>
                     (o Core..:? "regressionMetrics"))
...
newXPSTablesModelColumnInfo 
    ::  XPSTablesModelColumnInfo
newXPSTablesModelColumnInfo
  = XPSTablesModelColumnInfo{columnId = Core.Nothing,
                             featureImportance = Core.Nothing}
instance Core.FromJSON XPSTablesModelColumnInfo where
        parseJSON
          = Core.withObject "XPSTablesModelColumnInfo"
              (\ o ->
                 XPSTablesModelColumnInfo Core.<$>
                   (o Core..:? "columnId") Core.<*> (o Core..:? "featureImportance"))
...
instance Core.FromJSON XPSTablesModelStructure where
        parseJSON
          = Core.withObject "XPSTablesModelStructure"
              (\ o ->
...
newXPSTablesModelStructureModelParameters 
    :: 
                                          XPSTablesModelStructureModelParameters
newXPSTablesModelStructureModelParameters
  = XPSTablesModelStructureModelParameters{hyperparameters =
                                             Core.Nothing}
instance Core.FromJSON XPSTablesModelStructureModelParameters where
        parseJSON
          = Core.withObject "XPSTablesModelStructureModelParameters"
              (\ o ->
                 XPSTablesModelStructureModelParameters Core.<$>
                   (o Core..:? "hyperparameters"))
...
newXPSTablesModelStructureModelParametersParameter 
    :: 
                                                   XPSTablesModelStructureModelParametersParameter
newXPSTablesModelStructureModelParametersParameter
  = XPSTablesModelStructureModelParametersParameter{floatValue =
                                                      Core.Nothing,
                                                    intValue = Core.Nothing, name = Core.Nothing,
                                                    stringValue = Core.Nothing}
instance Core.FromJSON
           XPSTablesModelStructureModelParametersParameter
         where
        parseJSON
          = Core.withObject "XPSTablesModelStructureModelParametersParameter"
              (\ o ->
                 XPSTablesModelStructureModelParametersParameter Core.<$>
...
instance Core.FromJSON XPSTablesPreprocessResponse where
        parseJSON
          = Core.withObject "XPSTablesPreprocessResponse"
              (\ o ->
                 XPSTablesPreprocessResponse Core.<$>
                   (o Core..:? "tablesDatasetMetadata"))
...
newXPSTablesRegressionMetrics 
    ::  XPSTablesRegressionMetrics
newXPSTablesRegressionMetrics
  = XPSTablesRegressionMetrics{meanAbsoluteError = Core.Nothing,
                               meanAbsolutePercentageError = Core.Nothing,
                               rSquared = Core.Nothing, regressionMetricsEntries = Core.Nothing,
                               rootMeanSquaredError = Core.Nothing,
                               rootMeanSquaredLogError = Core.Nothing}
instance Core.FromJSON XPSTablesRegressionMetrics where
        parseJSON
          = Core.withObject "XPSTablesRegressionMetrics"
              (\ o ->
                 XPSTablesRegressionMetrics Core.<$>
                   (o Core..:? "meanAbsoluteError") Core.<*>
                     (o Core..:? "meanAbsolutePercentageError")
                     Core.<*> (o Core..:? "rSquared")
                     Core.<*> (o Core..:? "regressionMetricsEntries")
...
newXPSTablesTrainResponse 
    ::  XPSTablesTrainResponse
newXPSTablesTrainResponse
  = XPSTablesTrainResponse{modelStructure = Core.Nothing,
...
instance Core.FromJSON XPSTablesTrainResponse where
        parseJSON
          = Core.withObject "XPSTablesTrainResponse"
              (\ o ->
                 XPSTablesTrainResponse Core.<$>
                   (o Core..:? "modelStructure") Core.<*>
                     (o Core..:? "predictionSampleRows")
                     Core.<*> (o Core..:? "tablesModelColumnInfo")
                     Core.<*>
                     (o Core..:? "trainCostMilliNodeHours" Core.<&>
                        Core.fmap Core.fromAsText))
          ...
          = Core.object
              (Core.catMaybes
                 [("modelStructure" Core..=) Core.<$> modelStructure,
                  ...
                  ("trainCostMilliNodeHours" Core..=) Core.. Core.AsText Core.<$>
...
newXPSTablesTrainingOperationMetadata 
    :: 
                                      XPSTablesTrainingOperationMetadata
newXPSTablesTrainingOperationMetadata
  = XPSTablesTrainingOperationMetadata{createModelStage =
                                         Core.Nothing,
...
instance Core.FromJSON XPSTablesTrainingOperationMetadata where
        parseJSON
          = Core.withObject "XPSTablesTrainingOperationMetadata"
              (\ o ->
                 XPSTablesTrainingOperationMetadata Core.<$>
                   (o Core..:? "createModelStage") Core.<*>
                     (o Core..:? "optimizationObjective")
                     Core.<*> (o Core..:? "topTrials")
                     Core.<*>
                     (o Core..:? "trainBudgetMilliNodeHours" Core.<&>
                        Core.fmap Core.fromAsText)
          ...
          = Core.object
              (Core.catMaybes
                 [("createModelStage" Core..=) Core.<$> createModelStage,
                  ...
                  ("trainBudgetMilliNodeHours" Core..=) Core.. Core.AsText Core.<$>
                    trainBudgetMilliNodeHours,
                  ("trainingObjectivePoints" Core..=) Core.<$>
...
newXPSTextComponentModel 
    ::  XPSTextComponentModel
newXPSTextComponentModel
  = XPSTextComponentModel{batchPredictionModelGcsUri = Core.Nothing,
                          onlinePredictionModelGcsUri = Core.Nothing,
                          partition = Core.Nothing, servingArtifact = Core.Nothing,
                          servoModelName = Core.Nothing, submodelName = Core.Nothing,
                          submodelType = Core.Nothing, tfRuntimeVersion = Core.Nothing,
                          versionNumber = Core.Nothing}
instance Core.FromJSON XPSTextComponentModel where
        parseJSON
          = Core.withObject "XPSTextComponentModel"
              (\ o ->
                 XPSTextComponentModel Core.<$>
                   (o Core..:? "batchPredictionModelGcsUri") Core.<*>
                     (o Core..:? "onlinePredictionModelGcsUri")
                     ...
                     Core.<*> (o Core..:? "tfRuntimeVersion")
                     Core.<*>
                     (o Core..:? "versionNumber" Core.<&> Core.fmap Core.fromAsText))

instance Core.ToJSON XPSTextComponentModel where
        toJSON XPSTextComponentModel{..}
          = Core.object
              (Core.catMaybes
                 [("batchPredictionModelGcsUri" Core..=) Core.<$>
                    batchPredictionModelGcsUri,
                  ("onlinePredictionModelGcsUri" Core..=) Core.<$>
                  ...
                  ("tfRuntimeVersion" Core..=) Core.<$> tfRuntimeVersion,
                  ("versionNumber" Core..=) Core.. Core.AsText Core.<$>
                    versionNumber])
...
data XPSTextExtractionEvaluationMetrics = XPSTextExtractionEvaluationMetrics
    ...
    , perLabelConfidenceMetrics :: (Core.Maybe
   XPSTextExtractionEvaluationMetrics_PerLabelConfidenceMetrics)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newXPSTextExtractionEvaluationMetrics 
    :: 
                                      XPSTextExtractionEvaluationMetrics
newXPSTextExtractionEvaluationMetrics
  = XPSTextExtractionEvaluationMetrics{bestF1ConfidenceMetrics =
                                         Core.Nothing,
                                       confidenceMetricsEntries = Core.Nothing,
                                       confusionMatrix = Core.Nothing,
...
instance Core.FromJSON XPSTextExtractionEvaluationMetrics where
        parseJSON
          = Core.withObject "XPSTextExtractionEvaluationMetrics"
              (\ o ->
                 XPSTextExtractionEvaluationMetrics Core.<$>
                   (o Core..:? "bestF1ConfidenceMetrics") Core.<*>
                     (o Core..:? "confidenceMetricsEntries")
                     Core.<*> (o Core..:? "confusionMatrix")
...
instance Core.ToJSON XPSTextExtractionEvaluationMetrics where
        toJSON XPSTextExtractionEvaluationMetrics{..}
          = Core.object
              (Core.catMaybes
                 [("bestF1ConfidenceMetrics" Core..=) Core.<$>
                    bestF1ConfidenceMetrics,
                  ("confidenceMetricsEntries" Core..=) Core.<$>
                    confidenceMetricsEntries,
                  ("confusionMatrix" Core..=) Core.<$> confusionMatrix,
                  ("perLabelConfidenceMetrics" Core..=) Core.<$>
...
newXPSTextExtractionEvaluationMetrics_PerLabelConfidenceMetrics
  additional
  = XPSTextExtractionEvaluationMetrics_PerLabelConfidenceMetrics{additional
                                                                   = additional}
instance Core.FromJSON
           XPSTextExtractionEvaluationMetrics_PerLabelConfidenceMetrics
         where
...
newXPSTextSentimentEvaluationMetrics 
    :: 
                                     XPSTextSentimentEvaluationMetrics
newXPSTextSentimentEvaluationMetrics
  = XPSTextSentimentEvaluationMetrics{confusionMatrix = Core.Nothing,
                                      f1Score = Core.Nothing, linearKappa = Core.Nothing,
                                      meanAbsoluteError = Core.Nothing,
                                      meanSquaredError = Core.Nothing, precision = Core.Nothing,
                                      quadraticKappa = Core.Nothing, recall = Core.Nothing}
instance Core.FromJSON XPSTextSentimentEvaluationMetrics where
        parseJSON
          = Core.withObject "XPSTextSentimentEvaluationMetrics"
              (\ o ->
                 XPSTextSentimentEvaluationMetrics Core.<$>
                   (o Core..:? "confusionMatrix") Core.<*> (o Core..:? "f1Score")
...
instance Core.FromJSON XPSTextToSpeechTrainResponse where
        parseJSON
          = Core.withObject "XPSTextToSpeechTrainResponse"
...
instance Core.FromJSON XPSTextTrainResponse where
        parseJSON
          = Core.withObject "XPSTextTrainResponse"
              (\ o ->
...
instance Core.FromJSON XPSTfLiteFormat where
        parseJSON
          = Core.withObject "XPSTfLiteFormat"
...
instance Core.FromJSON XPSTfSavedModelFormat where
        parseJSON
          = Core.withObject "XPSTfSavedModelFormat"
...
newXPSTimestampStats 
    ::  XPSTimestampStats
newXPSTimestampStats
  = XPSTimestampStats{commonStats = Core.Nothing,
                      granularStats = Core.Nothing, medianTimestampNanos = Core.Nothing}
instance Core.FromJSON XPSTimestampStats where
        parseJSON
          = Core.withObject "XPSTimestampStats"
              (\ o ->
                 XPSTimestampStats Core.<$>
                   (o Core..:? "commonStats") Core.<*> (o Core..:? "granularStats")
                     Core.<*>
                     (o Core..:? "medianTimestampNanos" Core.<&>
                        Core.fmap Core.fromAsText))
          ...
          = Core.object
              (Core.catMaybes
                 [("commonStats" Core..=) Core.<$> commonStats,
                  ...
                  ("medianTimestampNanos" Core..=) Core.. Core.AsText Core.<$>
...
instance Core.FromJSON XPSTimestampStats_GranularStats where
        parseJSON
          = Core.withObject "XPSTimestampStats_GranularStats"
              (\ o ->
...
instance Core.FromJSON XPSTimestampStatsGranularStats where
        parseJSON
          = Core.withObject "XPSTimestampStatsGranularStats"
              (\ o ->
...
instance Core.FromJSON XPSTimestampStatsGranularStats_Buckets where
        parseJSON
          = Core.withObject "XPSTimestampStatsGranularStats_Buckets"
              (\ o ->
                 XPSTimestampStatsGranularStats_Buckets Core.<$>
                   (Core.parseJSONObject o))
...
newXPSTrackMetricsEntry 
    ::  XPSTrackMetricsEntry
newXPSTrackMetricsEntry
  = XPSTrackMetricsEntry{confidenceMetricsEntries = Core.Nothing,
                         iouThreshold = Core.Nothing, meanBoundingBoxIou = Core.Nothing,
                         meanMismatchRate = Core.Nothing,
                         meanTrackingAveragePrecision = Core.Nothing}
instance Core.FromJSON XPSTrackMetricsEntry where
        parseJSON
          = Core.withObject "XPSTrackMetricsEntry"
              (\ o ->
                 XPSTrackMetricsEntry Core.<$>
                   (o Core..:? "confidenceMetricsEntries") Core.<*>
                     (o Core..:? "iouThreshold")
          ...
          = Core.object
              (Core.catMaybes
                 [("confidenceMetricsEntries" Core..=) Core.<$>
                  ...
                  ("meanTrackingAveragePrecision" Core..=) Core.<$>
...
newXPSTrackMetricsEntryConfidenceMetricsEntry 
    :: 
                                              XPSTrackMetricsEntryConfidenceMetricsEntry
newXPSTrackMetricsEntryConfidenceMetricsEntry
  = XPSTrackMetricsEntryConfidenceMetricsEntry{boundingBoxIou =
                                                 Core.Nothing,
                                               confidenceThreshold = Core.Nothing,
                                               mismatchRate = Core.Nothing,
                                               trackingPrecision = Core.Nothing,
                                               trackingRecall = Core.Nothing}
instance Core.FromJSON XPSTrackMetricsEntryConfidenceMetricsEntry
         where
        parseJSON
          = Core.withObject "XPSTrackMetricsEntryConfidenceMetricsEntry"
              (\ o ->
                 XPSTrackMetricsEntryConfidenceMetricsEntry Core.<$>
                   (o Core..:? "boundingBoxIou") Core.<*>
                     (o Core..:? "confidenceThreshold")
                     Core.<*> (o Core..:? "mismatchRate")
                     Core.<*> (o Core..:? "trackingPrecision")
                     Core.<*> (o Core..:? "trackingRecall"))

instance Core.ToJSON XPSTrackMetricsEntryConfidenceMetricsEntry
         where
...
newXPSTrainResponse 
    ::  XPSTrainResponse
newXPSTrainResponse
  = XPSTrainResponse{deployedModelSizeBytes = Core.Nothing,
                     ...
                     modelToken = Core.Nothing, speechTrainResp = Core.Nothing,
                     tablesTrainResp = Core.Nothing,
                     textToSpeechTrainResp = Core.Nothing, textTrainResp = Core.Nothing,
...
instance Core.FromJSON XPSTrainResponse where
        parseJSON
          = Core.withObject "XPSTrainResponse"
              (\ o ->
                 XPSTrainResponse Core.<$>
                   (o Core..:? "deployedModelSizeBytes" Core.<&>
                      Core.fmap Core.fromAsText)
...
instance Core.ToJSON XPSTrainResponse where
        toJSON XPSTrainResponse{..}
          = Core.object
              (Core.catMaybes
                 [("deployedModelSizeBytes" Core..=) Core.. Core.AsText Core.<$>
                  ...
                  ("imageClassificationTrainResp" Core..=) Core.<$>
                    imageClassificationTrainResp,
                  ("imageObjectDetectionTrainResp" Core..=) Core.<$>
                    imageObjectDetectionTrainResp,
                  ("imageSegmentationTrainResp" Core..=) Core.<$>
                  ...
                  ("videoActionRecognitionTrainResp" Core..=) Core.<$>
                    videoActionRecognitionTrainResp,
                  ("videoClassificationTrainResp" Core..=) Core.<$>
                    videoClassificationTrainResp,
                  ("videoObjectTrackingTrainResp" Core..=) Core.<$>
...
newXPSTrainingObjectivePoint 
    ::  XPSTrainingObjectivePoint
newXPSTrainingObjectivePoint
  = XPSTrainingObjectivePoint{createTime = Core.Nothing,
                              value = Core.Nothing}
instance Core.FromJSON XPSTrainingObjectivePoint where
        parseJSON
          = Core.withObject "XPSTrainingObjectivePoint"
              (\ o ->
                 XPSTrainingObjectivePoint Core.<$>
                   (o Core..:? "createTime") Core.<*> (o Core..:? "value"))
...
newXPSTranslationEvaluationMetrics 
    :: 
                                   XPSTranslationEvaluationMetrics
newXPSTranslationEvaluationMetrics
  = XPSTranslationEvaluationMetrics{baseBleuScore = Core.Nothing,
                                    bleuScore = Core.Nothing}
instance Core.FromJSON XPSTranslationEvaluationMetrics where
        parseJSON
          = Core.withObject "XPSTranslationEvaluationMetrics"
              (\ o ->
                 XPSTranslationEvaluationMetrics Core.<$>
                   (o Core..:? "baseBleuScore") Core.<*> (o Core..:? "bleuScore"))
...
newXPSTranslationPreprocessResponse 
    :: 
                                    XPSTranslationPreprocessResponse
newXPSTranslationPreprocessResponse
  = XPSTranslationPreprocessResponse{parsedExampleCount =
                                       Core.Nothing,
                                     validExampleCount = Core.Nothing}
instance Core.FromJSON XPSTranslationPreprocessResponse where
        parseJSON
          = Core.withObject "XPSTranslationPreprocessResponse"
              (\ o ->
                 XPSTranslationPreprocessResponse Core.<$>
                   (o Core..:? "parsedExampleCount" Core.<&>
                      Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "validExampleCount" Core.<&>
                        Core.fmap Core.fromAsText))
...
instance Core.ToJSON XPSTranslationPreprocessResponse where
        toJSON XPSTranslationPreprocessResponse{..}
          = Core.object
              (Core.catMaybes
                 [("parsedExampleCount" Core..=) Core.. Core.AsText Core.<$>
                    parsedExampleCount,
                  ("validExampleCount" Core..=) Core.. Core.AsText Core.<$>
                    validExampleCount])
...
instance Core.FromJSON XPSTranslationTrainResponse where
        parseJSON
          = Core.withObject "XPSTranslationTrainResponse"
              (\ o ->
...
newXPSTuningTrial 
    ::  XPSTuningTrial
newXPSTuningTrial
  = XPSTuningTrial{modelStructure = Core.Nothing,
                   trainingObjectivePoint = Core.Nothing}
instance Core.FromJSON XPSTuningTrial where
        parseJSON
          = Core.withObject "XPSTuningTrial"
              (\ o ->
                 XPSTuningTrial Core.<$>
                   (o Core..:? "modelStructure") Core.<*>
                     (o Core..:? "trainingObjectivePoint"))
...
instance Core.ToJSON XPSTuningTrial where
        toJSON XPSTuningTrial{..}
          = Core.object
              (Core.catMaybes
                 [("modelStructure" Core..=) Core.<$> modelStructure,
                  ("trainingObjectivePoint" Core..=) Core.<$>
...
newXPSVideoActionMetricsEntry 
    ::  XPSVideoActionMetricsEntry
newXPSVideoActionMetricsEntry
  = XPSVideoActionMetricsEntry{confidenceMetricsEntries =
                                 Core.Nothing,
...
instance Core.FromJSON XPSVideoActionMetricsEntry where
        parseJSON
          = Core.withObject "XPSVideoActionMetricsEntry"
              (\ o ->
                 XPSVideoActionMetricsEntry Core.<$>
                   (o Core..:? "confidenceMetricsEntries") Core.<*>
...
newXPSVideoActionMetricsEntryConfidenceMetricsEntry 
    :: 
                                                    XPSVideoActionMetricsEntryConfidenceMetricsEntry
newXPSVideoActionMetricsEntryConfidenceMetricsEntry
  = XPSVideoActionMetricsEntryConfidenceMetricsEntry{confidenceThreshold
                                                       = Core.Nothing,
                                                     f1Score = Core.Nothing,
                                                     precision = Core.Nothing,
                                                     recall = Core.Nothing}
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "XPSVideoActionMetricsEntryConfidenceMetricsEntry"
              (\ o ->
                 XPSVideoActionMetricsEntryConfidenceMetricsEntry Core.<$>
                   (o Core..:? "confidenceThreshold") Core.<*> (o Core..:? "f1Score")
                     Core.<*> (o Core..:? "precision")
                     Core.<*> (o Core..:? "recall"))
...
newXPSVideoActionRecognitionEvaluationMetrics 
    :: 
                                              XPSVideoActionRecognitionEvaluationMetrics
newXPSVideoActionRecognitionEvaluationMetrics
  = XPSVideoActionRecognitionEvaluationMetrics{evaluatedActionCount =
                                                 Core.Nothing,
                                               videoActionMetricsEntries = Core.Nothing}
instance Core.FromJSON XPSVideoActionRecognitionEvaluationMetrics
         where
        parseJSON
          = Core.withObject "XPSVideoActionRecognitionEvaluationMetrics"
              (\ o ->
                 XPSVideoActionRecognitionEvaluationMetrics Core.<$>
                   (o Core..:? "evaluatedActionCount") Core.<*>
                     (o Core..:? "videoActionMetricsEntries"))

instance Core.ToJSON XPSVideoActionRecognitionEvaluationMetrics
         where
        toJSON XPSVideoActionRecognitionEvaluationMetrics{..}
          = Core.object
              (Core.catMaybes
                 [("evaluatedActionCount" Core..=) Core.<$> evaluatedActionCount,
                  ("videoActionMetricsEntries" Core..=) Core.<$>
...
newXPSVideoActionRecognitionTrainResponse 
    :: 
                                          XPSVideoActionRecognitionTrainResponse
newXPSVideoActionRecognitionTrainResponse
  = XPSVideoActionRecognitionTrainResponse{modelArtifactSpec =
                                             Core.Nothing,
                                           trainCostNodeSeconds = Core.Nothing}
instance Core.FromJSON XPSVideoActionRecognitionTrainResponse where
        parseJSON
          = Core.withObject "XPSVideoActionRecognitionTrainResponse"
              (\ o ->
                 XPSVideoActionRecognitionTrainResponse Core.<$>
                   (o Core..:? "modelArtifactSpec") Core.<*>
                     (o Core..:? "trainCostNodeSeconds" Core.<&>
                        Core.fmap Core.fromAsText))
...
newXPSVideoBatchPredictOperationMetadata 
    :: 
                                         XPSVideoBatchPredictOperationMetadata
newXPSVideoBatchPredictOperationMetadata
  = XPSVideoBatchPredictOperationMetadata{outputExamples =
                                            Core.Nothing}
instance Core.FromJSON XPSVideoBatchPredictOperationMetadata where
        parseJSON
          = Core.withObject "XPSVideoBatchPredictOperationMetadata"
              (\ o ->
                 XPSVideoBatchPredictOperationMetadata Core.<$>
                   (o Core..:? "outputExamples"))
...
newXPSVideoClassificationTrainResponse 
    :: 
                                       XPSVideoClassificationTrainResponse
newXPSVideoClassificationTrainResponse
  = XPSVideoClassificationTrainResponse{modelArtifactSpec =
                                          Core.Nothing,
                                        trainCostNodeSeconds = Core.Nothing}
instance Core.FromJSON XPSVideoClassificationTrainResponse where
        parseJSON
          = Core.withObject "XPSVideoClassificationTrainResponse"
              (\ o ->
                 XPSVideoClassificationTrainResponse Core.<$>
                   (o Core..:? "modelArtifactSpec") Core.<*>
                     (o Core..:? "trainCostNodeSeconds" Core.<&>
                        Core.fmap Core.fromAsText))
...
instance Core.FromJSON XPSVideoExportModelSpec where
        parseJSON
          = Core.withObject "XPSVideoExportModelSpec"
              (\ o ->
                 XPSVideoExportModelSpec Core.<$>
                   (o Core..:? "exportModelOutputConfig"))
...
newXPSVideoModelArtifactSpec 
    ::  XPSVideoModelArtifactSpec
newXPSVideoModelArtifactSpec
  = XPSVideoModelArtifactSpec{exportArtifact = Core.Nothing,
                              servingArtifact = Core.Nothing}
instance Core.FromJSON XPSVideoModelArtifactSpec where
        parseJSON
          = Core.withObject "XPSVideoModelArtifactSpec"
              (\ o ->
                 XPSVideoModelArtifactSpec Core.<$>
                   (o Core..:? "exportArtifact") Core.<*>
                     (o Core..:? "servingArtifact"))
...
newXPSVideoObjectTrackingEvaluationMetrics 
    :: 
                                           XPSVideoObjectTrackingEvaluationMetrics
newXPSVideoObjectTrackingEvaluationMetrics
  = XPSVideoObjectTrackingEvaluationMetrics{boundingBoxMeanAveragePrecision
                                              = Core.Nothing,
                                            boundingBoxMetricsEntries = Core.Nothing,
                                            evaluatedBoundingboxCount = Core.Nothing,
...
instance Core.FromJSON XPSVideoObjectTrackingEvaluationMetrics
         where
        parseJSON
          = Core.withObject "XPSVideoObjectTrackingEvaluationMetrics"
              (\ o ->
                 XPSVideoObjectTrackingEvaluationMetrics Core.<$>
                   (o Core..:? "boundingBoxMeanAveragePrecision") Core.<*>
                     (o Core..:? "boundingBoxMetricsEntries")
                     Core.<*> (o Core..:? "evaluatedBoundingboxCount")
          ...
          = Core.object
              (Core.catMaybes
                 [("boundingBoxMeanAveragePrecision" Core..=) Core.<$>
                  ...
                  ("trackMeanAveragePrecision" Core..=) Core.<$>
                    trackMeanAveragePrecision,
                  ("trackMeanBoundingBoxIou" Core..=) Core.<$>
...
newXPSVideoObjectTrackingTrainResponse 
    :: 
                                       XPSVideoObjectTrackingTrainResponse
newXPSVideoObjectTrackingTrainResponse
  = XPSVideoObjectTrackingTrainResponse{exportModelSpec =
                                          Core.Nothing,
                                        modelArtifactSpec = Core.Nothing,
                                        trainCostNodeSeconds = Core.Nothing}
instance Core.FromJSON XPSVideoObjectTrackingTrainResponse where
        parseJSON
          = Core.withObject "XPSVideoObjectTrackingTrainResponse"
              (\ o ->
                 XPSVideoObjectTrackingTrainResponse Core.<$>
                   (o Core..:? "exportModelSpec") Core.<*>
                     (o Core..:? "modelArtifactSpec")
                     Core.<*>
                     (o Core..:? "trainCostNodeSeconds" Core.<&>
                        Core.fmap Core.fromAsText))
...
newXPSVideoTrainingOperationMetadata 
    :: 
                                     XPSVideoTrainingOperationMetadata
newXPSVideoTrainingOperationMetadata
  = XPSVideoTrainingOperationMetadata{trainCostMilliNodeHour =
                                        Core.Nothing}
instance Core.FromJSON XPSVideoTrainingOperationMetadata where
        parseJSON
          = Core.withObject "XPSVideoTrainingOperationMetadata"
              (\ o ->
                 XPSVideoTrainingOperationMetadata Core.<$>
                   (o Core..:? "trainCostMilliNodeHour" Core.<&>
                      Core.fmap Core.fromAsText))
...
instance Core.ToJSON XPSVideoTrainingOperationMetadata where
        toJSON XPSVideoTrainingOperationMetadata{..}
          = Core.object
              (Core.catMaybes
                 [("trainCostMilliNodeHour" Core..=) Core.. Core.AsText Core.<$>
...
newXPSVisionErrorAnalysisConfig 
    ::  XPSVisionErrorAnalysisConfig
newXPSVisionErrorAnalysisConfig
  = XPSVisionErrorAnalysisConfig{exampleCount = Core.Nothing,
                                 queryType = Core.Nothing}
instance Core.FromJSON XPSVisionErrorAnalysisConfig where
        parseJSON
          = Core.withObject "XPSVisionErrorAnalysisConfig"
              (\ o ->
                 XPSVisionErrorAnalysisConfig Core.<$>
                   (o Core..:? "exampleCount") Core.<*> (o Core..:? "queryType"))
...
newXPSVisionTrainingOperationMetadata 
    :: 
                                      XPSVisionTrainingOperationMetadata
newXPSVisionTrainingOperationMetadata
  = XPSVisionTrainingOperationMetadata{explanationUsage =
                                         Core.Nothing}
instance Core.FromJSON XPSVisionTrainingOperationMetadata where
        parseJSON
          = Core.withObject "XPSVisionTrainingOperationMetadata"
              (\ o ->
                 XPSVisionTrainingOperationMetadata Core.<$>
                   (o Core..:? "explanationUsage"))
...
newXPSVisualization 
    ::  XPSVisualization
newXPSVisualization
  = XPSVisualization{clipPercentLowerbound = Core.Nothing,
                     clipPercentUpperbound = Core.Nothing, colorMap = Core.Nothing,
                     overlayType = Core.Nothing, polarity = Core.Nothing,
                     type' = Core.Nothing}
instance Core.FromJSON XPSVisualization where
        parseJSON
          = Core.withObject "XPSVisualization"
              (\ o ->
                 XPSVisualization Core.<$>
                   (o Core..:? "clipPercentLowerbound") Core.<*>
                     (o Core..:? "clipPercentUpperbound")
...
newXPSXpsOperationMetadata 
    ::  XPSXpsOperationMetadata
newXPSXpsOperationMetadata
  = XPSXpsOperationMetadata{exampleCount = Core.Nothing,
...
instance Core.FromJSON XPSXpsOperationMetadata where
        parseJSON
          = Core.withObject "XPSXpsOperationMetadata"
              (\ o ->
                 XPSXpsOperationMetadata Core.<$>
                   (o Core..:? "exampleCount" Core.<&> Core.fmap Core.fromAsText)
          ...
          = Core.object
              (Core.catMaybes
                 [("exampleCount" Core..=) Core.. Core.AsText Core.<$> exampleCount,
                  ...
                  ("tablesTrainingOperationMetadata" Core..=) Core.<$>
                    tablesTrainingOperationMetadata,
                  ("videoBatchPredictOperationMetadata" Core..=) Core.<$>
                    videoBatchPredictOperationMetadata,
                  ("videoTrainingOperationMetadata" Core..=) Core.<$>
                    videoTrainingOperationMetadata,
                  ("visionTrainingOperationMetadata" Core..=) Core.<$>
...
instance Core.FromJSON XPSXraiAttribution where
        parseJSON
          = Core.withObject "XPSXraiAttribution"
