...
newLanguageDocumentsModerateText payload
  = LanguageDocumentsModerateText{xgafv = Core.Nothing,
                                  accessToken = Core.Nothing, callback = Core.Nothing,
                                  payload = payload, uploadType = Core.Nothing,
                                  uploadProtocol = Core.Nothing}
instance Core.GoogleRequest LanguageDocumentsModerateText where
        type Rs LanguageDocumentsModerateText = ModerateTextResponse
        ...
        requestClient LanguageDocumentsModerateText{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy LanguageDocumentsModerateTextResource)
                      Core.mempty
