                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] ListCustomersResponse
...
newAndroidDeviceProvisioningPartnersCustomersList partnerId
  = AndroidDeviceProvisioningPartnersCustomersList{xgafv =
                                                     Core.Nothing,
                                                   accessToken = Core.Nothing,
                                                   callback = Core.Nothing, pageSize = Core.Nothing,
                                                   pageToken = Core.Nothing, partnerId = partnerId,
                                                   uploadType = Core.Nothing,
                                                   uploadProtocol = Core.Nothing}
instance Core.GoogleRequest
           AndroidDeviceProvisioningPartnersCustomersList
         where
        type Rs AndroidDeviceProvisioningPartnersCustomersList =
             ListCustomersResponse
        type Scopes AndroidDeviceProvisioningPartnersCustomersList = '[]
        requestClient AndroidDeviceProvisioningPartnersCustomersList{..}
          = go partnerId xgafv accessToken callback pageSize pageToken
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AndroidDeviceProvisioningPartnersCustomersListResource)
                      Core.mempty
