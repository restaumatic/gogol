                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] CreateCustomerRequest Core.:>
                         Core.Post '[Core.JSON] Company
...
newAndroidDeviceProvisioningPartnersCustomersCreate parent payload
  = AndroidDeviceProvisioningPartnersCustomersCreate{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           AndroidDeviceProvisioningPartnersCustomersCreate
         where
        type Rs AndroidDeviceProvisioningPartnersCustomersCreate = Company
        type Scopes AndroidDeviceProvisioningPartnersCustomersCreate = '[]
        requestClient AndroidDeviceProvisioningPartnersCustomersCreate{..}
