     ...
     "v1" Core.:>
       "partners" Core.:>
         Core.Capture "partnerId" Core.Int64 Core.:>
           "devices:updateMetadataAsync" Core.:>
                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] UpdateDeviceMetadataInBatchRequest
...
newAndroidDeviceProvisioningPartnersDevicesUpdateMetadataAsync
  partnerId payload
  = AndroidDeviceProvisioningPartnersDevicesUpdateMetadataAsync{xgafv
                                                                  = Core.Nothing,
...
instance Core.GoogleRequest
           AndroidDeviceProvisioningPartnersDevicesUpdateMetadataAsync
         where
        type Rs AndroidDeviceProvisioningPartnersDevicesUpdateMetadataAsync
             = Operation
        type Scopes
               AndroidDeviceProvisioningPartnersDevicesUpdateMetadataAsync
             = '[]
