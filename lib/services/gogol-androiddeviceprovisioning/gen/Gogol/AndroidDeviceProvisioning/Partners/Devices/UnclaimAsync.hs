                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] UnclaimDevicesRequest Core.:>
...
newAndroidDeviceProvisioningPartnersDevicesUnclaimAsync 
    ...
    -> AndroidDeviceProvisioningPartnersDevicesUnclaimAsync
newAndroidDeviceProvisioningPartnersDevicesUnclaimAsync partnerId
  payload
  = AndroidDeviceProvisioningPartnersDevicesUnclaimAsync{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           AndroidDeviceProvisioningPartnersDevicesUnclaimAsync
         where
        type Rs AndroidDeviceProvisioningPartnersDevicesUnclaimAsync =
             Operation
        type Scopes AndroidDeviceProvisioningPartnersDevicesUnclaimAsync =
             '[]
        requestClient
          AndroidDeviceProvisioningPartnersDevicesUnclaimAsync{..}
