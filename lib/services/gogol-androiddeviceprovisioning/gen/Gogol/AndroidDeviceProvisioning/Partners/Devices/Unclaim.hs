                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] UnclaimDeviceRequest Core.:>
...
newAndroidDeviceProvisioningPartnersDevicesUnclaim 
    ...
    -> AndroidDeviceProvisioningPartnersDevicesUnclaim
newAndroidDeviceProvisioningPartnersDevicesUnclaim partnerId
  payload
  = AndroidDeviceProvisioningPartnersDevicesUnclaim{xgafv =
                                                      Core.Nothing,
                                                    accessToken = Core.Nothing,
                                                    callback = Core.Nothing, partnerId = partnerId,
                                                    payload = payload, uploadType = Core.Nothing,
                                                    uploadProtocol = Core.Nothing}
instance Core.GoogleRequest
           AndroidDeviceProvisioningPartnersDevicesUnclaim
         where
        type Rs AndroidDeviceProvisioningPartnersDevicesUnclaim = Empty
        type Scopes AndroidDeviceProvisioningPartnersDevicesUnclaim = '[]
        requestClient AndroidDeviceProvisioningPartnersDevicesUnclaim{..}
          = go partnerId xgafv accessToken callback uploadType uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AndroidDeviceProvisioningPartnersDevicesUnclaimResource)
                      Core.mempty
