                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] FindDevicesByOwnerRequest Core.:>
                           Core.Post '[Core.JSON] FindDevicesByOwnerResponse
...
newAndroidDeviceProvisioningPartnersDevicesFindByOwner 
    ...
    -> AndroidDeviceProvisioningPartnersDevicesFindByOwner
newAndroidDeviceProvisioningPartnersDevicesFindByOwner partnerId
  payload
  = AndroidDeviceProvisioningPartnersDevicesFindByOwner{xgafv =
                                                          Core.Nothing,
                                                        accessToken = Core.Nothing,
                                                        callback = Core.Nothing,
                                                        partnerId = partnerId, payload = payload,
                                                        uploadType = Core.Nothing,
                                                        uploadProtocol = Core.Nothing}
instance Core.GoogleRequest
           AndroidDeviceProvisioningPartnersDevicesFindByOwner
         where
        type Rs AndroidDeviceProvisioningPartnersDevicesFindByOwner =
             FindDevicesByOwnerResponse
        type Scopes AndroidDeviceProvisioningPartnersDevicesFindByOwner =
             '[]
        requestClient
          AndroidDeviceProvisioningPartnersDevicesFindByOwner{..}
