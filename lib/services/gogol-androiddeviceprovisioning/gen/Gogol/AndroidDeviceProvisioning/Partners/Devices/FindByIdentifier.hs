                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] FindDevicesByDeviceIdentifierRequest
                           Core.:>
                           Core.Post '[Core.JSON] FindDevicesByDeviceIdentifierResponse
...
newAndroidDeviceProvisioningPartnersDevicesFindByIdentifier
  partnerId payload
  = AndroidDeviceProvisioningPartnersDevicesFindByIdentifier{xgafv =
                                                               Core.Nothing,
...
instance Core.GoogleRequest
           AndroidDeviceProvisioningPartnersDevicesFindByIdentifier
         where
        type Rs AndroidDeviceProvisioningPartnersDevicesFindByIdentifier =
