                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.ReqBody '[Core.JSON] UpdateDeviceMetadataRequest Core.:>
                               Core.Post '[Core.JSON] DeviceMetadata
...
newAndroidDeviceProvisioningPartnersDevicesMetadata 
    ...
    -> AndroidDeviceProvisioningPartnersDevicesMetadata
newAndroidDeviceProvisioningPartnersDevicesMetadata deviceId
  metadataOwnerId payload
  = AndroidDeviceProvisioningPartnersDevicesMetadata{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           AndroidDeviceProvisioningPartnersDevicesMetadata
         where
        type Rs AndroidDeviceProvisioningPartnersDevicesMetadata =
             DeviceMetadata
        type Scopes AndroidDeviceProvisioningPartnersDevicesMetadata = '[]
        requestClient AndroidDeviceProvisioningPartnersDevicesMetadata{..}
          = go metadataOwnerId deviceId xgafv accessToken callback uploadType
              uploadProtocol
