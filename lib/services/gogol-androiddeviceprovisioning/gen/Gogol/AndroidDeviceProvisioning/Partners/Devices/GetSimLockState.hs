                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] GetDeviceSimLockStateRequest Core.:>
...
newAndroidDeviceProvisioningPartnersDevicesGetSimLockState
  partnerId payload
  = AndroidDeviceProvisioningPartnersDevicesGetSimLockState{xgafv =
                                                              Core.Nothing,
...
instance Core.GoogleRequest
           AndroidDeviceProvisioningPartnersDevicesGetSimLockState
         where
        type Rs AndroidDeviceProvisioningPartnersDevicesGetSimLockState =
             GetDeviceSimLockStateResponse
        type Scopes AndroidDeviceProvisioningPartnersDevicesGetSimLockState
             = '[]
        requestClient
          AndroidDeviceProvisioningPartnersDevicesGetSimLockState{..}
