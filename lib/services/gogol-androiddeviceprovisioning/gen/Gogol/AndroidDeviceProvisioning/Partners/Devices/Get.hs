...
-- |
-- Module      : Gogol.AndroidDeviceProvisioning.Partners.Devices.Get
...
newAndroidDeviceProvisioningPartnersDevicesGet name
  = AndroidDeviceProvisioningPartnersDevicesGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           AndroidDeviceProvisioningPartnersDevicesGet
         where
        type Rs AndroidDeviceProvisioningPartnersDevicesGet = Device
        type Scopes AndroidDeviceProvisioningPartnersDevicesGet = '[]
        requestClient AndroidDeviceProvisioningPartnersDevicesGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AndroidDeviceProvisioningPartnersDevicesGetResource)
                      Core.mempty
