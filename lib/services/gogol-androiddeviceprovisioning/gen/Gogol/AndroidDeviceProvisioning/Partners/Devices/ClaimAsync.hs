                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] ClaimDevicesRequest Core.:>
...
newAndroidDeviceProvisioningPartnersDevicesClaimAsync 
    ...
    -> AndroidDeviceProvisioningPartnersDevicesClaimAsync
newAndroidDeviceProvisioningPartnersDevicesClaimAsync partnerId
  payload
  = AndroidDeviceProvisioningPartnersDevicesClaimAsync{xgafv =
                                                         Core.Nothing,
...
instance Core.GoogleRequest
           AndroidDeviceProvisioningPartnersDevicesClaimAsync
         where
        type Rs AndroidDeviceProvisioningPartnersDevicesClaimAsync =
             Operation
        type Scopes AndroidDeviceProvisioningPartnersDevicesClaimAsync =
             '[]
        requestClient
          AndroidDeviceProvisioningPartnersDevicesClaimAsync{..}
