                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] ListVendorCustomersResponse
...
newAndroidDeviceProvisioningPartnersVendorsCustomersList parent
  = AndroidDeviceProvisioningPartnersVendorsCustomersList{xgafv =
                                                            Core.Nothing,
...
instance Core.GoogleRequest
           AndroidDeviceProvisioningPartnersVendorsCustomersList
         where
        type Rs AndroidDeviceProvisioningPartnersVendorsCustomersList =
             ListVendorCustomersResponse
        type Scopes AndroidDeviceProvisioningPartnersVendorsCustomersList =
             '[]
        requestClient
          AndroidDeviceProvisioningPartnersVendorsCustomersList{..}
