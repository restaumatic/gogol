                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] ListVendorsResponse
...
newAndroidDeviceProvisioningPartnersVendorsList parent
  = AndroidDeviceProvisioningPartnersVendorsList{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
           AndroidDeviceProvisioningPartnersVendorsList
         where
        type Rs AndroidDeviceProvisioningPartnersVendorsList =
             ListVendorsResponse
        type Scopes AndroidDeviceProvisioningPartnersVendorsList = '[]
        requestClient AndroidDeviceProvisioningPartnersVendorsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AndroidDeviceProvisioningPartnersVendorsListResource)
                      Core.mempty
