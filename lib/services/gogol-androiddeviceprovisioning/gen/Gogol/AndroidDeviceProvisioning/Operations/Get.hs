...
newAndroidDeviceProvisioningOperationsGet name
  = AndroidDeviceProvisioningOperationsGet{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           name = name, uploadType = Core.Nothing,
                                           uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AndroidDeviceProvisioningOperationsGet
         where
        type Rs AndroidDeviceProvisioningOperationsGet = Operation
        type Scopes AndroidDeviceProvisioningOperationsGet = '[]
        requestClient AndroidDeviceProvisioningOperationsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AndroidDeviceProvisioningOperationsGetResource)
                      Core.mempty
