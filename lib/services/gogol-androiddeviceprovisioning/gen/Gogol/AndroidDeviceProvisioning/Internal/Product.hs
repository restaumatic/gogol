...
newClaimDeviceRequest 
    ::  ClaimDeviceRequest
newClaimDeviceRequest
  = ClaimDeviceRequest{configurationId = Core.Nothing,
                       customerId = Core.Nothing, deviceIdentifier = Core.Nothing,
                       deviceMetadata = Core.Nothing,
                       googleWorkspaceCustomerId = Core.Nothing,
                       preProvisioningToken = Core.Nothing, sectionType = Core.Nothing,
          ...
          = Core.withObject "ClaimDeviceRequest"
              (\ o ->
                 ClaimDeviceRequest Core.<$>
                   (o Core..:? "configurationId" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "customerId" Core.<&> Core.fmap Core.fromAsText)
                     ...
                     Core.<*>
                     (o Core..:? "simlockProfileId" Core.<&> Core.fmap Core.fromAsText))

instance Core.ToJSON ClaimDeviceRequest where
        toJSON ClaimDeviceRequest{..}
          = Core.object
              (Core.catMaybes
                 [("configurationId" Core..=) Core.. Core.AsText Core.<$>
                    configurationId,
                  ("customerId" Core..=) Core.. Core.AsText Core.<$> customerId,
                  ("deviceIdentifier" Core..=) Core.<$> deviceIdentifier,
                  ("deviceMetadata" Core..=) Core.<$> deviceMetadata,
                  ("googleWorkspaceCustomerId" Core..=) Core.<$>
                    googleWorkspaceCustomerId,
                  ("preProvisioningToken" Core..=) Core.<$> preProvisioningToken,
                  ("sectionType" Core..=) Core.<$> sectionType,
                  ("simlockProfileId" Core..=) Core.. Core.AsText Core.<$>
                    simlockProfileId])
...
newClaimDeviceResponse 
    ::  ClaimDeviceResponse
newClaimDeviceResponse
  = ClaimDeviceResponse{deviceId = Core.Nothing,
          ...
          = Core.withObject "ClaimDeviceResponse"
              (\ o ->
                 ClaimDeviceResponse Core.<$>
                   (o Core..:? "deviceId" Core.<&> Core.fmap Core.fromAsText) Core.<*>
                     (o Core..:? "deviceName"))
...
instance Core.ToJSON ClaimDeviceResponse where
        toJSON ClaimDeviceResponse{..}
          = Core.object
              (Core.catMaybes
                 [("deviceId" Core..=) Core.. Core.AsText Core.<$> deviceId,
...
instance Core.FromJSON ClaimDevicesRequest where
        parseJSON
          = Core.withObject "ClaimDevicesRequest"
              (\ o -> ClaimDevicesRequest Core.<$> (o Core..:? "claims"))

instance Core.ToJSON ClaimDevicesRequest where
        toJSON ClaimDevicesRequest{..}
          = Core.object (Core.catMaybes [("claims" Core..=) Core.<$> claims])
...
newCompany 
    ::  Company
newCompany
  = Company{adminEmails = Core.Nothing, companyId = Core.Nothing,
            companyName = Core.Nothing, googleWorkspaceAccount = Core.Nothing,
            languageCode = Core.Nothing, name = Core.Nothing,
            ownerEmails = Core.Nothing, skipWelcomeEmail = Core.Nothing,
              ...
              (\ o ->
                 Company Core.<$>
                   (o Core..:? "adminEmails") Core.<*>
                     (o Core..:? "companyId" Core.<&> Core.fmap Core.fromAsText)
          ...
          = Core.object
              (Core.catMaybes
                 [("adminEmails" Core..=) Core.<$> adminEmails,
                  ("companyId" Core..=) Core.. Core.AsText Core.<$> companyId,
                  ("companyName" Core..=) Core.<$> companyName,
                  ("googleWorkspaceAccount" Core..=) Core.<$> googleWorkspaceAccount,
                  ("languageCode" Core..=) Core.<$> languageCode,
                  ("name" Core..=) Core.<$> name,
                  ("ownerEmails" Core..=) Core.<$> ownerEmails,
                  ("skipWelcomeEmail" Core..=) Core.<$> skipWelcomeEmail,
...
newConfiguration 
    ::  Configuration
newConfiguration
  = Configuration{companyName = Core.Nothing,
                  configurationId = Core.Nothing, configurationName = Core.Nothing,
                  contactEmail = Core.Nothing, contactPhone = Core.Nothing,
                  customMessage = Core.Nothing, dpcExtras = Core.Nothing,
                  dpcResourcePath = Core.Nothing, forcedResetTime = Core.Nothing,
                  isDefault = Core.Nothing, name = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("companyName" Core..=) Core.<$> companyName,
                  ("configurationId" Core..=) Core.. Core.AsText Core.<$>
                    configurationId,
                  ("configurationName" Core..=) Core.<$> configurationName,
...
newCreateCustomerRequest 
    ::  CreateCustomerRequest
newCreateCustomerRequest
  = CreateCustomerRequest{customer = Core.Nothing}
instance Core.FromJSON CreateCustomerRequest where
        parseJSON
          = Core.withObject "CreateCustomerRequest"
              (\ o -> CreateCustomerRequest Core.<$> (o Core..:? "customer"))
...
newCustomerApplyConfigurationRequest 
    :: 
                                     CustomerApplyConfigurationRequest
newCustomerApplyConfigurationRequest
  = CustomerApplyConfigurationRequest{configuration = Core.Nothing,
                                      device = Core.Nothing}
instance Core.FromJSON CustomerApplyConfigurationRequest where
        parseJSON
          = Core.withObject "CustomerApplyConfigurationRequest"
              (\ o ->
                 CustomerApplyConfigurationRequest Core.<$>
                   (o Core..:? "configuration") Core.<*> (o Core..:? "device"))

instance Core.ToJSON CustomerApplyConfigurationRequest where
...
instance Core.FromJSON CustomerListConfigurationsResponse where
        parseJSON
          = Core.withObject "CustomerListConfigurationsResponse"
              (\ o ->
                 CustomerListConfigurationsResponse Core.<$>
                   (o Core..:? "configurations"))

instance Core.ToJSON CustomerListConfigurationsResponse where
...
newCustomerListCustomersResponse 
    ::  CustomerListCustomersResponse
newCustomerListCustomersResponse
  = CustomerListCustomersResponse{customers = Core.Nothing,
          ...
          = Core.withObject "CustomerListCustomersResponse"
              (\ o ->
                 CustomerListCustomersResponse Core.<$>
                   (o Core..:? "customers") Core.<*> (o Core..:? "nextPageToken"))
...
newCustomerListDevicesResponse 
    ::  CustomerListDevicesResponse
newCustomerListDevicesResponse
  = CustomerListDevicesResponse{devices = Core.Nothing,
                                nextPageToken = Core.Nothing}
...
instance Core.FromJSON CustomerRemoveConfigurationRequest where
        parseJSON
          = Core.withObject "CustomerRemoveConfigurationRequest"
              (\ o ->
                 CustomerRemoveConfigurationRequest Core.<$> (o Core..:? "device"))

instance Core.ToJSON CustomerRemoveConfigurationRequest where
...
instance Core.FromJSON CustomerUnclaimDeviceRequest where
        parseJSON
          = Core.withObject "CustomerUnclaimDeviceRequest"
              (\ o ->
                 CustomerUnclaimDeviceRequest Core.<$> (o Core..:? "device"))
...
newDevice 
    ::  Device
newDevice
  = Device{claims = Core.Nothing, configuration = Core.Nothing,
           deviceId = Core.Nothing, deviceIdentifier = Core.Nothing,
           deviceMetadata = Core.Nothing, name = Core.Nothing}
instance Core.FromJSON Device where
        parseJSON
          = Core.withObject "Device"
              (\ o ->
                 Device Core.<$>
                   (o Core..:? "claims") Core.<*> (o Core..:? "configuration")
                     Core.<*> (o Core..:? "deviceId" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "deviceIdentifier")
                     Core.<*> (o Core..:? "deviceMetadata")
                     Core.<*> (o Core..:? "name"))
...
newDeviceClaim 
    ::  DeviceClaim
newDeviceClaim
  = DeviceClaim{additionalService = Core.Nothing,
                googleWorkspaceCustomerId = Core.Nothing,
                ownerCompanyId = Core.Nothing, resellerId = Core.Nothing,
                sectionType = Core.Nothing, vacationModeExpireTime = Core.Nothing,
              ...
              (\ o ->
                 DeviceClaim Core.<$>
                   (o Core..:? "additionalService") Core.<*>
                     ...
                     Core.<*>
                     (o Core..:? "ownerCompanyId" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "resellerId" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "sectionType")
...
instance Core.ToJSON DeviceClaim where
        toJSON DeviceClaim{..}
          = Core.object
              (Core.catMaybes
                 [("additionalService" Core..=) Core.<$> additionalService,
                  ("googleWorkspaceCustomerId" Core..=) Core.<$>
                    googleWorkspaceCustomerId,
                  ("ownerCompanyId" Core..=) Core.. Core.AsText Core.<$>
                    ownerCompanyId,
                  ("resellerId" Core..=) Core.. Core.AsText Core.<$> resellerId,
                  ("sectionType" Core..=) Core.<$> sectionType,
                  ("vacationModeExpireTime" Core..=) Core.<$> vacationModeExpireTime,
                  ("vacationModeStartTime" Core..=) Core.<$> vacationModeStartTime])
...
newDeviceIdentifier 
    ::  DeviceIdentifier
newDeviceIdentifier
  = DeviceIdentifier{chromeOsAttestedDeviceId = Core.Nothing,
                     deviceType = Core.Nothing, imei = Core.Nothing,
                     imei2 = Core.Nothing, manufacturer = Core.Nothing,
                     meid = Core.Nothing, meid2 = Core.Nothing, model = Core.Nothing,
          ...
          = Core.object
              (Core.catMaybes
                 [("chromeOsAttestedDeviceId" Core..=) Core.<$>
                  ...
                  ("imei" Core..=) Core.<$> imei, ("imei2" Core..=) Core.<$> imei2,
                  ("manufacturer" Core..=) Core.<$> manufacturer,
                  ("meid" Core..=) Core.<$> meid, ("meid2" Core..=) Core.<$> meid2,
...
instance Core.FromJSON DeviceMetadata where
        parseJSON
          = Core.withObject "DeviceMetadata"
              (\ o -> DeviceMetadata Core.<$> (o Core..:? "entries"))
...
instance Core.FromJSON DeviceMetadata_Entries where
        parseJSON
          = Core.withObject "DeviceMetadata_Entries"
              (\ o -> DeviceMetadata_Entries Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON DeviceMetadata_Entries where
        toJSON DeviceMetadata_Entries{..} = Core.toJSON additional
...
newDeviceReference 
    ::  DeviceReference
newDeviceReference
  = DeviceReference{deviceId = Core.Nothing,
...
newDevicesLongRunningOperationMetadata 
    :: 
                                       DevicesLongRunningOperationMetadata
newDevicesLongRunningOperationMetadata
  = DevicesLongRunningOperationMetadata{devicesCount = Core.Nothing,
                                        processingStatus = Core.Nothing, progress = Core.Nothing}
instance Core.FromJSON DevicesLongRunningOperationMetadata where
        parseJSON
          = Core.withObject "DevicesLongRunningOperationMetadata"
              (\ o ->
...
instance Core.ToJSON DevicesLongRunningOperationMetadata where
...
newDevicesLongRunningOperationResponse 
    :: 
                                       DevicesLongRunningOperationResponse
newDevicesLongRunningOperationResponse
  = DevicesLongRunningOperationResponse{perDeviceStatus =
                                          Core.Nothing,
                                        successCount = Core.Nothing}
instance Core.FromJSON DevicesLongRunningOperationResponse where
        parseJSON
          = Core.withObject "DevicesLongRunningOperationResponse"
              (\ o ->
                 DevicesLongRunningOperationResponse Core.<$>
                   (o Core..:? "perDeviceStatus") Core.<*>
                     (o Core..:? "successCount"))

instance Core.ToJSON DevicesLongRunningOperationResponse where
        toJSON DevicesLongRunningOperationResponse{..}
          = Core.object
              (Core.catMaybes
                 [("perDeviceStatus" Core..=) Core.<$> perDeviceStatus,
...
newDpc 
    ::  Dpc
newDpc
  = Dpc{dpcName = Core.Nothing, name = Core.Nothing,
...
instance Core.FromJSON Dpc where
        parseJSON
          = Core.withObject "Dpc"
              (\ o ->
                 Dpc Core.<$>
                   (o Core..:? "dpcName") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "packageName"))
...
newFindDevicesByDeviceIdentifierRequest 
    :: 
                                        FindDevicesByDeviceIdentifierRequest
newFindDevicesByDeviceIdentifierRequest
  = FindDevicesByDeviceIdentifierRequest{deviceIdentifier =
                                           Core.Nothing,
                                         limit = Core.Nothing, pageToken = Core.Nothing}
instance Core.FromJSON FindDevicesByDeviceIdentifierRequest where
        parseJSON
          = Core.withObject "FindDevicesByDeviceIdentifierRequest"
              (\ o ->
                 FindDevicesByDeviceIdentifierRequest Core.<$>
                   (o Core..:? "deviceIdentifier") Core.<*>
                     (o Core..:? "limit" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "pageToken"))

instance Core.ToJSON FindDevicesByDeviceIdentifierRequest where
...
newFindDevicesByDeviceIdentifierResponse 
    :: 
                                         FindDevicesByDeviceIdentifierResponse
newFindDevicesByDeviceIdentifierResponse
  = FindDevicesByDeviceIdentifierResponse{devices = Core.Nothing,
                                          nextPageToken = Core.Nothing, totalSize = Core.Nothing}
instance Core.FromJSON FindDevicesByDeviceIdentifierResponse where
        parseJSON
          = Core.withObject "FindDevicesByDeviceIdentifierResponse"
              (\ o ->
                 FindDevicesByDeviceIdentifierResponse Core.<$>
                   (o Core..:? "devices") Core.<*> (o Core..:? "nextPageToken")
                     Core.<*> (o Core..:? "totalSize"))

instance Core.ToJSON FindDevicesByDeviceIdentifierResponse where
...
newFindDevicesByOwnerRequest 
    ::  FindDevicesByOwnerRequest
newFindDevicesByOwnerRequest
  = FindDevicesByOwnerRequest{customerId = Core.Nothing,
                              googleWorkspaceCustomerId = Core.Nothing, limit = Core.Nothing,
                              pageToken = Core.Nothing, sectionType = Core.Nothing}
...
instance Core.ToJSON FindDevicesByOwnerRequest where
        toJSON FindDevicesByOwnerRequest{..}
          = Core.object
              (Core.catMaybes
                 [("customerId" Core..=) Core.. Core.fmap Core.AsText Core.<$>
                    customerId,
                  ("googleWorkspaceCustomerId" Core..=) Core.<$>
                    googleWorkspaceCustomerId,
                  ("limit" Core..=) Core.. Core.AsText Core.<$> limit,
...
newFindDevicesByOwnerResponse 
    ::  FindDevicesByOwnerResponse
newFindDevicesByOwnerResponse
  = FindDevicesByOwnerResponse{devices = Core.Nothing,
                               nextPageToken = Core.Nothing, totalSize = Core.Nothing}
...
--
-- /See:/ 'newGetDeviceSimLockStateRequest' smart constructor.
newtype GetDeviceSimLockStateRequest = GetDeviceSimLockStateRequest
    {
...
-- | Creates a value of 'GetDeviceSimLockStateRequest' with the minimum fields required to make a request.
newGetDeviceSimLockStateRequest 
    ::  GetDeviceSimLockStateRequest
newGetDeviceSimLockStateRequest
  = GetDeviceSimLockStateRequest{deviceIdentifier = Core.Nothing}
instance Core.FromJSON GetDeviceSimLockStateRequest where
        parseJSON
          = Core.withObject "GetDeviceSimLockStateRequest"
              (\ o ->
                 GetDeviceSimLockStateRequest Core.<$>
                   (o Core..:? "deviceIdentifier"))

instance Core.ToJSON GetDeviceSimLockStateRequest where
        toJSON GetDeviceSimLockStateRequest{..}
          = Core.object
              (Core.catMaybes
                 [("deviceIdentifier" Core..=) Core.<$> deviceIdentifier])
...
--
-- /See:/ 'newGetDeviceSimLockStateResponse' smart constructor.
newtype GetDeviceSimLockStateResponse = GetDeviceSimLockStateResponse
    {

      simLockState :: (Core.Maybe GetDeviceSimLockStateResponse_SimLockState)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'GetDeviceSimLockStateResponse' with the minimum fields required to make a request.
newGetDeviceSimLockStateResponse 
    ::  GetDeviceSimLockStateResponse
newGetDeviceSimLockStateResponse
  = GetDeviceSimLockStateResponse{simLockState = Core.Nothing}
instance Core.FromJSON GetDeviceSimLockStateResponse where
        parseJSON
          = Core.withObject "GetDeviceSimLockStateResponse"
              (\ o ->
                 GetDeviceSimLockStateResponse Core.<$> (o Core..:? "simLockState"))

instance Core.ToJSON GetDeviceSimLockStateResponse where
        toJSON GetDeviceSimLockStateResponse{..}
          = Core.object
              (Core.catMaybes [("simLockState" Core..=) Core.<$> simLockState])
...
newGoogleWorkspaceAccount 
    ::  GoogleWorkspaceAccount
newGoogleWorkspaceAccount
  = GoogleWorkspaceAccount{customerId = Core.Nothing,
          ...
          = Core.object
              (Core.catMaybes
                 [("customerId" Core..=) Core.<$> customerId,
                  ("preProvisioningTokens" Core..=) Core.<$> preProvisioningTokens])
...
newListCustomersResponse 
    ::  ListCustomersResponse
newListCustomersResponse
  = ListCustomersResponse{customers = Core.Nothing,
                          nextPageToken = Core.Nothing, totalSize = Core.Nothing}
...
newListVendorCustomersResponse 
    ::  ListVendorCustomersResponse
newListVendorCustomersResponse
  = ListVendorCustomersResponse{customers = Core.Nothing,
                                nextPageToken = Core.Nothing, totalSize = Core.Nothing}
...
newListVendorsResponse 
    ::  ListVendorsResponse
newListVendorsResponse
  = ListVendorsResponse{nextPageToken = Core.Nothing,
                        totalSize = Core.Nothing, vendors = Core.Nothing}
...
newOperationPerDevice 
    ::  OperationPerDevice
newOperationPerDevice
  = OperationPerDevice{claim = Core.Nothing, result = Core.Nothing,
                       unclaim = Core.Nothing, updateMetadata = Core.Nothing}
instance Core.FromJSON OperationPerDevice where
        parseJSON
          = Core.withObject "OperationPerDevice"
              (\ o ->
                 OperationPerDevice Core.<$>
                   (o Core..:? "claim") Core.<*> (o Core..:? "result") Core.<*>
                     (o Core..:? "unclaim")
...
newPartnerClaim 
    ::  PartnerClaim
newPartnerClaim
  = PartnerClaim{configurationId = Core.Nothing,
                 customerId = Core.Nothing, deviceIdentifier = Core.Nothing,
                 deviceMetadata = Core.Nothing,
                 googleWorkspaceCustomerId = Core.Nothing,
                 preProvisioningToken = Core.Nothing, sectionType = Core.Nothing,
...
newPartnerUnclaim 
    ::  PartnerUnclaim
newPartnerUnclaim
  = PartnerUnclaim{deviceId = Core.Nothing,
                   deviceIdentifier = Core.Nothing, sectionType = Core.Nothing,
          ...
          = Core.object
              (Core.catMaybes
                 [("deviceId" Core..=) Core.. Core.AsText Core.<$> deviceId,
                  ("deviceIdentifier" Core..=) Core.<$> deviceIdentifier,
                  ("sectionType" Core..=) Core.<$> sectionType,
                  ("vacationModeDays" Core..=) Core.<$> vacationModeDays,
...
newPerDeviceStatusInBatch 
    ::  PerDeviceStatusInBatch
newPerDeviceStatusInBatch
  = PerDeviceStatusInBatch{deviceId = Core.Nothing,
                           errorIdentifier = Core.Nothing, errorMessage = Core.Nothing,
                           status = Core.Nothing}
...
newUnclaimDeviceRequest 
    ::  UnclaimDeviceRequest
newUnclaimDeviceRequest
  = UnclaimDeviceRequest{deviceId = Core.Nothing,
                         deviceIdentifier = Core.Nothing, sectionType = Core.Nothing,
                         vacationModeDays = Core.Nothing,
                         vacationModeExpireTime = Core.Nothing}
...
instance Core.FromJSON UpdateDeviceMetadataInBatchRequest where
        parseJSON
          = Core.withObject "UpdateDeviceMetadataInBatchRequest"
              (\ o ->
                 UpdateDeviceMetadataInBatchRequest Core.<$> (o Core..:? "updates"))

instance Core.ToJSON UpdateDeviceMetadataInBatchRequest where
        toJSON UpdateDeviceMetadataInBatchRequest{..}
          = Core.object
              (Core.catMaybes [("updates" Core..=) Core.<$> updates])
...
instance Core.FromJSON UpdateDeviceMetadataRequest where
        parseJSON
          = Core.withObject "UpdateDeviceMetadataRequest"
              (\ o ->
                 UpdateDeviceMetadataRequest Core.<$> (o Core..:? "deviceMetadata"))
...
newUpdateMetadataArguments 
    ::  UpdateMetadataArguments
newUpdateMetadataArguments
  = UpdateMetadataArguments{deviceId = Core.Nothing,
                            deviceIdentifier = Core.Nothing, deviceMetadata = Core.Nothing}
