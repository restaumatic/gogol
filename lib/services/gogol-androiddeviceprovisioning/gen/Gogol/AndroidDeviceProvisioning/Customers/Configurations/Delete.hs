...
newAndroidDeviceProvisioningCustomersConfigurationsDelete name
  = AndroidDeviceProvisioningCustomersConfigurationsDelete{xgafv =
                                                             Core.Nothing,
...
instance Core.GoogleRequest
           AndroidDeviceProvisioningCustomersConfigurationsDelete
         where
        type Rs AndroidDeviceProvisioningCustomersConfigurationsDelete =
             Empty
        type Scopes AndroidDeviceProvisioningCustomersConfigurationsDelete
             = '[]
        requestClient
          AndroidDeviceProvisioningCustomersConfigurationsDelete{..}
