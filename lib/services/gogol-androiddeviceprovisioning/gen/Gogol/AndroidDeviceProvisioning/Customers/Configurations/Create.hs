...
newAndroidDeviceProvisioningCustomersConfigurationsCreate 
    ...
    -> AndroidDeviceProvisioningCustomersConfigurationsCreate
newAndroidDeviceProvisioningCustomersConfigurationsCreate parent
  payload
  = AndroidDeviceProvisioningCustomersConfigurationsCreate{xgafv =
                                                             Core.Nothing,
...
instance Core.GoogleRequest
           AndroidDeviceProvisioningCustomersConfigurationsCreate
         where
        type Rs AndroidDeviceProvisioningCustomersConfigurationsCreate =
             Configuration
        type Scopes AndroidDeviceProvisioningCustomersConfigurationsCreate
             = '[]
        requestClient
          AndroidDeviceProvisioningCustomersConfigurationsCreate{..}
