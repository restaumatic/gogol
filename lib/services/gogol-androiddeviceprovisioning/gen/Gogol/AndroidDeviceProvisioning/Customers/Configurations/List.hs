                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.Get '[Core.JSON] CustomerListConfigurationsResponse
...
newAndroidDeviceProvisioningCustomersConfigurationsList parent
  = AndroidDeviceProvisioningCustomersConfigurationsList{xgafv =
                                                           Core.Nothing,
...
instance Core.GoogleRequest
           AndroidDeviceProvisioningCustomersConfigurationsList
         where
        type Rs AndroidDeviceProvisioningCustomersConfigurationsList =
             CustomerListConfigurationsResponse
        type Scopes AndroidDeviceProvisioningCustomersConfigurationsList =
             '[]
        requestClient
          AndroidDeviceProvisioningCustomersConfigurationsList{..}
