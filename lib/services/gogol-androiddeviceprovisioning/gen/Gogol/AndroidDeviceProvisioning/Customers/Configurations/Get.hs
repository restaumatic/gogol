               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.Get '[Core.JSON] Configuration
...
newAndroidDeviceProvisioningCustomersConfigurationsGet name
  = AndroidDeviceProvisioningCustomersConfigurationsGet{xgafv =
                                                          Core.Nothing,
...
instance Core.GoogleRequest
           AndroidDeviceProvisioningCustomersConfigurationsGet
         where
        type Rs AndroidDeviceProvisioningCustomersConfigurationsGet =
             Configuration
        type Scopes AndroidDeviceProvisioningCustomersConfigurationsGet =
             '[]
        requestClient
          AndroidDeviceProvisioningCustomersConfigurationsGet{..}
