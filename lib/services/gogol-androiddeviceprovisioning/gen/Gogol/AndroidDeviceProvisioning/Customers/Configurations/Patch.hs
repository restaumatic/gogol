                   ...
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] Configuration Core.:>
                         Core.Patch '[Core.JSON] Configuration
...
newAndroidDeviceProvisioningCustomersConfigurationsPatch 
    ...
    -> AndroidDeviceProvisioningCustomersConfigurationsPatch
newAndroidDeviceProvisioningCustomersConfigurationsPatch name
  payload
  = AndroidDeviceProvisioningCustomersConfigurationsPatch{xgafv =
                                                            Core.Nothing,
...
instance Core.GoogleRequest
           AndroidDeviceProvisioningCustomersConfigurationsPatch
         where
        type Rs AndroidDeviceProvisioningCustomersConfigurationsPatch =
             Configuration
        type Scopes AndroidDeviceProvisioningCustomersConfigurationsPatch =
             '[]
        requestClient
          AndroidDeviceProvisioningCustomersConfigurationsPatch{..}
