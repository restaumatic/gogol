                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] CustomerApplyConfigurationRequest Core.:>
...
newAndroidDeviceProvisioningCustomersDevicesApplyConfiguration
  parent payload
  = AndroidDeviceProvisioningCustomersDevicesApplyConfiguration{xgafv
                                                                  = Core.Nothing,
...
instance Core.GoogleRequest
           AndroidDeviceProvisioningCustomersDevicesApplyConfiguration
         where
        type Rs AndroidDeviceProvisioningCustomersDevicesApplyConfiguration
             = Empty
        type Scopes
               AndroidDeviceProvisioningCustomersDevicesApplyConfiguration
             = '[]
