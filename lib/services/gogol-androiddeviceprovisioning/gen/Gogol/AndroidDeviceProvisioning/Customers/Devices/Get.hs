...
newAndroidDeviceProvisioningCustomersDevicesGet name
  = AndroidDeviceProvisioningCustomersDevicesGet{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
           AndroidDeviceProvisioningCustomersDevicesGet
         where
        type Rs AndroidDeviceProvisioningCustomersDevicesGet = Device
        type Scopes AndroidDeviceProvisioningCustomersDevicesGet = '[]
        requestClient AndroidDeviceProvisioningCustomersDevicesGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AndroidDeviceProvisioningCustomersDevicesGetResource)
                      Core.mempty
