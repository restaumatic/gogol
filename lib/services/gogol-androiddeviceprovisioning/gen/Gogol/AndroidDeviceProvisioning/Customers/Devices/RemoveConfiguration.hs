...
type AndroidDeviceProvisioningCustomersDevicesRemoveConfigurationResource
     ...
     "v1" Core.:>
       Core.Capture "parent" Core.Text Core.:>
         "devices:removeConfiguration" Core.:>
                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] CustomerRemoveConfigurationRequest
...
newAndroidDeviceProvisioningCustomersDevicesRemoveConfiguration
  parent payload
  = AndroidDeviceProvisioningCustomersDevicesRemoveConfiguration{xgafv
                                                                   = Core.Nothing,
