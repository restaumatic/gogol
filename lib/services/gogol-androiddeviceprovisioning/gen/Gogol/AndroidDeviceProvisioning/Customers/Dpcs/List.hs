                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.Get '[Core.JSON] CustomerListDpcsResponse
...
newAndroidDeviceProvisioningCustomersDpcsList parent
  = AndroidDeviceProvisioningCustomersDpcsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           AndroidDeviceProvisioningCustomersDpcsList
         where
        type Rs AndroidDeviceProvisioningCustomersDpcsList =
             CustomerListDpcsResponse
        type Scopes AndroidDeviceProvisioningCustomersDpcsList = '[]
        requestClient AndroidDeviceProvisioningCustomersDpcsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AndroidDeviceProvisioningCustomersDpcsListResource)
                      Core.mempty
