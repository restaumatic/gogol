               ...
               Core.QueryParam "access_token" Core.Text Core.:>
                 Core.QueryParam "callback" Core.Text Core.:>
                   Core.QueryParam "captchaToken" Core.Text Core.:>
                     Core.QueryParams "category" PagespeedapiRunpagespeedCategory
                       Core.:>
                       Core.QueryParam "locale" Core.Text Core.:>
                         Core.QueryParam "strategy" PagespeedapiRunpagespeedStrategy Core.:>
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "utm_campaign" Core.Text Core.:>
                                 Core.QueryParam "utm_source" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.Get '[Core.JSON] PagespeedApiPagespeedResponseV5
...
newPagespeedonlinePagespeedapiRunpagespeed url
  = PagespeedonlinePagespeedapiRunpagespeed{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            captchaToken = Core.Nothing, category = Core.Nothing,
                                            locale = Core.Nothing, strategy = Core.Nothing,
                                            uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing, url = url,
                                            utmCampaign = Core.Nothing, utmSource = Core.Nothing}
instance Core.GoogleRequest PagespeedonlinePagespeedapiRunpagespeed
         where
        type Rs PagespeedonlinePagespeedapiRunpagespeed =
             PagespeedApiPagespeedResponseV5
        type Scopes PagespeedonlinePagespeedapiRunpagespeed =
             '[OAuth2'OpenID]
        requestClient PagespeedonlinePagespeedapiRunpagespeed{..}
          = go (Core.Just url) xgafv accessToken callback captchaToken
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy PagespeedonlinePagespeedapiRunpagespeedResource)
                      Core.mempty
