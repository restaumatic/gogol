...
newAuditRefs 
    ::  AuditRefs
newAuditRefs
  = AuditRefs{acronym = Core.Nothing, group' = Core.Nothing,
              id = Core.Nothing, relevantAudits = Core.Nothing,
              weight = Core.Nothing}
instance Core.FromJSON AuditRefs where
        parseJSON
          = Core.withObject "AuditRefs"
              (\ o ->
                 AuditRefs Core.<$>
                   (o Core..:? "acronym") Core.<*> (o Core..:? "group") Core.<*>
                     (o Core..:? "id")
          ...
          = Core.object
              (Core.catMaybes
                 [("acronym" Core..=) Core.<$> acronym,
                  ("group" Core..=) Core.<$> group', ("id" Core..=) Core.<$> id,
...
newBucket 
    ::  Bucket
newBucket
  = Bucket{max = Core.Nothing, min = Core.Nothing,
           proportion = Core.Nothing}
...
newCategories 
    ::  Categories
newCategories
  = Categories{accessibility = Core.Nothing,
               bestPractices = Core.Nothing, performance = Core.Nothing,
               pwa = Core.Nothing, seo = Core.Nothing}
instance Core.FromJSON Categories where
        parseJSON
          = Core.withObject "Categories"
              (\ o ->
                 Categories Core.<$>
                   (o Core..:? "accessibility") Core.<*> (o Core..:? "best-practices")
          ...
          = Core.object
              (Core.catMaybes
                 [("accessibility" Core..=) Core.<$> accessibility,
                  ...
                  ("pwa" Core..=) Core.<$> pwa, ("seo" Core..=) Core.<$> seo])
...
newConfigSettings 
    ::  ConfigSettings
newConfigSettings
  = ConfigSettings{channel = Core.Nothing,
                   emulatedFormFactor = Core.Nothing, formFactor = Core.Nothing,
                   locale = Core.Nothing, onlyCategories = Core.Nothing}
instance Core.FromJSON ConfigSettings where
        parseJSON
          = Core.withObject "ConfigSettings"
              (\ o ->
                 ConfigSettings Core.<$>
                   (o Core..:? "channel") Core.<*> (o Core..:? "emulatedFormFactor")
          ...
          = Core.object
              (Core.catMaybes
                 [("channel" Core..=) Core.<$> channel,
                  ("emulatedFormFactor" Core..=) Core.<$> emulatedFormFactor,
...
newEnvironment 
    ::  Environment
newEnvironment
  = Environment{benchmarkIndex = Core.Nothing,
                credits = Core.Nothing, hostUserAgent = Core.Nothing,
...
instance Core.FromJSON Environment where
        parseJSON
          = Core.withObject "Environment"
              (\ o ->
                 Environment Core.<$>
                   (o Core..:? "benchmarkIndex") Core.<*> (o Core..:? "credits")
          ...
          = Core.object
              (Core.catMaybes
                 [("benchmarkIndex" Core..=) Core.<$> benchmarkIndex,
                  ...
                  ("networkUserAgent" Core..=) Core.<$> networkUserAgent])
...
instance Core.FromJSON Environment_Credits where
        parseJSON
          = Core.withObject "Environment_Credits"
              (\ o -> Environment_Credits Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON Environment_Credits where
        toJSON Environment_Credits{..} = Core.toJSON additional
...
instance Core.FromJSON I18n where
        parseJSON
          = Core.withObject "I18n"
              (\ o -> I18n Core.<$> (o Core..:? "rendererFormattedStrings"))
...
newLhrEntity 
    ::  LhrEntity
newLhrEntity
  = LhrEntity{category = Core.Nothing, homepage = Core.Nothing,
              isFirstParty = Core.Nothing, isUnrecognized = Core.Nothing,
              name = Core.Nothing, origins = Core.Nothing}
instance Core.FromJSON LhrEntity where
        parseJSON
          = Core.withObject "LhrEntity"
              (\ o ->
                 LhrEntity Core.<$>
                   (o Core..:? "category") Core.<*> (o Core..:? "homepage") Core.<*>
                     (o Core..:? "isFirstParty")
...
data LighthouseAuditResultV5 = LighthouseAuditResultV5
    ...
    , metricSavings :: (Core.Maybe MetricSavings)
...
newLighthouseAuditResultV5 
    ::  LighthouseAuditResultV5
newLighthouseAuditResultV5
  = LighthouseAuditResultV5{description = Core.Nothing,
                            details = Core.Nothing, displayValue = Core.Nothing,
                            errorMessage = Core.Nothing, explanation = Core.Nothing,
                            id = Core.Nothing, metricSavings = Core.Nothing,
                            numericUnit = Core.Nothing, numericValue = Core.Nothing,
                            score = Core.Nothing, scoreDisplayMode = Core.Nothing,
                            title = Core.Nothing, warnings = Core.Nothing}
...
instance Core.FromJSON LighthouseAuditResultV5_Details where
        parseJSON
          = Core.withObject "LighthouseAuditResultV5_Details"
              (\ o ->
                 LighthouseAuditResultV5_Details Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON LighthouseAuditResultV5_Details where
        toJSON LighthouseAuditResultV5_Details{..} = Core.toJSON additional
...
newLighthouseCategoryV5 
    ::  LighthouseCategoryV5
newLighthouseCategoryV5
  = LighthouseCategoryV5{auditRefs = Core.Nothing,
                         description = Core.Nothing, id = Core.Nothing,
                         manualDescription = Core.Nothing, score = Core.Nothing,
                         title = Core.Nothing}
          ...
          = Core.withObject "LighthouseCategoryV5"
              (\ o ->
                 LighthouseCategoryV5 Core.<$>
                   (o Core..:? "auditRefs") Core.<*> (o Core..:? "description")
                     Core.<*> (o Core..:? "id")
          ...
          = Core.object
              (Core.catMaybes
                 [("auditRefs" Core..=) Core.<$> auditRefs,
                  ("description" Core..=) Core.<$> description,
                  ("id" Core..=) Core.<$> id,
                  ("manualDescription" Core..=) Core.<$> manualDescription,
                  ("score" Core..=) Core.<$> score,
                  ("title" Core..=) Core.<$> title])
...
newLighthouseResultV5 
    ::  LighthouseResultV5
newLighthouseResultV5
  = LighthouseResultV5{audits = Core.Nothing,
                       categories = Core.Nothing, categoryGroups = Core.Nothing,
                       configSettings = Core.Nothing, entities = Core.Nothing,
                       environment = Core.Nothing, fetchTime = Core.Nothing,
                       finalDisplayedUrl = Core.Nothing, finalUrl = Core.Nothing,
                       fullPageScreenshot = Core.Nothing, i18n = Core.Nothing,
                       lighthouseVersion = Core.Nothing, mainDocumentUrl = Core.Nothing,
                       requestedUrl = Core.Nothing, runWarnings = Core.Nothing,
                       runtimeError = Core.Nothing, stackPacks = Core.Nothing,
                       timing = Core.Nothing, userAgent = Core.Nothing}
instance Core.FromJSON LighthouseResultV5 where
        parseJSON
          = Core.withObject "LighthouseResultV5"
              (\ o ->
                 LighthouseResultV5 Core.<$>
                   (o Core..:? "audits") Core.<*> (o Core..:? "categories") Core.<*>
                     (o Core..:? "categoryGroups")
          ...
          = Core.object
              (Core.catMaybes
                 [("audits" Core..=) Core.<$> audits,
                  ...
                  ("finalDisplayedUrl" Core..=) Core.<$> finalDisplayedUrl,
                  ("finalUrl" Core..=) Core.<$> finalUrl,
                  ("fullPageScreenshot" Core..=) Core.<$> fullPageScreenshot,
                  ("i18n" Core..=) Core.<$> i18n,
                  ("lighthouseVersion" Core..=) Core.<$> lighthouseVersion,
...
instance Core.FromJSON LighthouseResultV5_Audits where
        parseJSON
          = Core.withObject "LighthouseResultV5_Audits"
              (\ o ->
                 LighthouseResultV5_Audits Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON LighthouseResultV5_Audits where
        toJSON LighthouseResultV5_Audits{..} = Core.toJSON additional
...
instance Core.FromJSON LighthouseResultV5_CategoryGroups where
        parseJSON
...
instance Core.ToJSON LighthouseResultV5_CategoryGroups where
...
-- | The metric savings of the audit.
--
-- /See:/ 'newMetricSavings' smart constructor.
data MetricSavings = MetricSavings
    {
      -- | Optional. Optional numeric value representing the audit\'s savings for the CLS metric.
      cLS :: (Core.Maybe Core.Double)
      -- | Optional. Optional numeric value representing the audit\'s savings for the FCP metric.
    , fCP :: (Core.Maybe Core.Double)
      -- | Optional. Optional numeric value representing the audit\'s savings for the INP metric.
    , iNP :: (Core.Maybe Core.Double)
      -- | Optional. Optional numeric value representing the audit\'s savings for the LCP metric.
    , lCP :: (Core.Maybe Core.Double)
      -- | Optional. Optional numeric value representing the audit\'s savings for the TBT metric.
    , tBT :: (Core.Maybe Core.Double)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'MetricSavings' with the minimum fields required to make a request.
newMetricSavings 
    ::  MetricSavings
newMetricSavings
  = MetricSavings{cLS = Core.Nothing, fCP = Core.Nothing,
                  iNP = Core.Nothing, lCP = Core.Nothing, tBT = Core.Nothing}
instance Core.FromJSON MetricSavings where
        parseJSON
          = Core.withObject "MetricSavings"
              (\ o ->
                 MetricSavings Core.<$>
                   (o Core..:? "CLS") Core.<*> (o Core..:? "FCP") Core.<*>
                     (o Core..:? "INP")
                     Core.<*> (o Core..:? "LCP")
                     Core.<*> (o Core..:? "TBT"))

instance Core.ToJSON MetricSavings where
        toJSON MetricSavings{..}
          = Core.object
              (Core.catMaybes
                 [("CLS" Core..=) Core.<$> cLS, ("FCP" Core..=) Core.<$> fCP,
                  ("INP" Core..=) Core.<$> iNP, ("LCP" Core..=) Core.<$> lCP,
                  ("TBT" Core..=) Core.<$> tBT])
...
newPagespeedApiLoadingExperienceV5 
    :: 
                                   PagespeedApiLoadingExperienceV5
newPagespeedApiLoadingExperienceV5
  = PagespeedApiLoadingExperienceV5{id = Core.Nothing,
                                    initialUrl = Core.Nothing, metrics = Core.Nothing,
                                    originFallback = Core.Nothing, overallCategory = Core.Nothing}
instance Core.FromJSON PagespeedApiLoadingExperienceV5 where
        parseJSON
          = Core.withObject "PagespeedApiLoadingExperienceV5"
              (\ o ->
                 PagespeedApiLoadingExperienceV5 Core.<$>
                   (o Core..:? "id") Core.<*> (o Core..:? "initial_url") Core.<*>
                     (o Core..:? "metrics")
          ...
          = Core.object
              (Core.catMaybes
                 [("id" Core..=) Core.<$> id,
                  ...
                  ("overall_category" Core..=) Core.<$> overallCategory])
...
instance Core.FromJSON PagespeedApiLoadingExperienceV5_Metrics
         where
        parseJSON
          = Core.withObject "PagespeedApiLoadingExperienceV5_Metrics"
              (\ o ->
                 PagespeedApiLoadingExperienceV5_Metrics Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON PagespeedApiLoadingExperienceV5_Metrics where
...
newPagespeedApiPagespeedResponseV5 
    :: 
                                   PagespeedApiPagespeedResponseV5
newPagespeedApiPagespeedResponseV5
  = PagespeedApiPagespeedResponseV5{analysisUTCTimestamp =
                                      Core.Nothing,
                                    captchaResult = Core.Nothing, id = Core.Nothing,
                                    kind = Core.Nothing, lighthouseResult = Core.Nothing,
                                    loadingExperience = Core.Nothing,
                                    originLoadingExperience = Core.Nothing, version = Core.Nothing}
instance Core.FromJSON PagespeedApiPagespeedResponseV5 where
        parseJSON
...
instance Core.ToJSON PagespeedApiPagespeedResponseV5 where
        toJSON PagespeedApiPagespeedResponseV5{..}
          = Core.object
              (Core.catMaybes
                 [("analysisUTCTimestamp" Core..=) Core.<$> analysisUTCTimestamp,
                  ("captchaResult" Core..=) Core.<$> captchaResult,
                  ("id" Core..=) Core.<$> id, ("kind" Core..=) Core.<$> kind,
                  ("lighthouseResult" Core..=) Core.<$> lighthouseResult,
                  ("loadingExperience" Core..=) Core.<$> loadingExperience,
...
newRendererFormattedStrings 
    ::  RendererFormattedStrings
newRendererFormattedStrings
  = RendererFormattedStrings{auditGroupExpandTooltip = Core.Nothing,
                             calculatorLink = Core.Nothing, crcInitialNavigation = Core.Nothing,
                             crcLongestDurationLabel = Core.Nothing,
                             dropdownCopyJSON = Core.Nothing, dropdownDarkTheme = Core.Nothing,
                             dropdownPrintExpanded = Core.Nothing,
                             dropdownPrintSummary = Core.Nothing,
                             dropdownSaveGist = Core.Nothing, dropdownSaveHTML = Core.Nothing,
                             dropdownSaveJSON = Core.Nothing, dropdownViewer = Core.Nothing,
                             errorLabel = Core.Nothing, errorMissingAuditInfo = Core.Nothing,
                             footerIssue = Core.Nothing, labDataTitle = Core.Nothing,
                             ...
                             runtimeSettingsUrl = Core.Nothing, runtimeUnknown = Core.Nothing,
                             scorescaleLabel = Core.Nothing, showRelevantAudits = Core.Nothing,
                             ...
                             varianceDisclaimer = Core.Nothing, viewTreemapLabel = Core.Nothing,
          ...
          = Core.object
              (Core.catMaybes
                 [("auditGroupExpandTooltip" Core..=) Core.<$>
                  ...
                  ("crcInitialNavigation" Core..=) Core.<$> crcInitialNavigation,
                  ("crcLongestDurationLabel" Core..=) Core.<$>
                    crcLongestDurationLabel,
                  ("dropdownCopyJSON" Core..=) Core.<$> dropdownCopyJSON,
                  ("dropdownDarkTheme" Core..=) Core.<$> dropdownDarkTheme,
                  ("dropdownPrintExpanded" Core..=) Core.<$> dropdownPrintExpanded,
                  ("dropdownPrintSummary" Core..=) Core.<$> dropdownPrintSummary,
                  ("dropdownSaveGist" Core..=) Core.<$> dropdownSaveGist,
                  ("dropdownSaveHTML" Core..=) Core.<$> dropdownSaveHTML,
                  ("dropdownSaveJSON" Core..=) Core.<$> dropdownSaveJSON,
                  ("dropdownViewer" Core..=) Core.<$> dropdownViewer,
                  ("errorLabel" Core..=) Core.<$> errorLabel,
                  ("errorMissingAuditInfo" Core..=) Core.<$> errorMissingAuditInfo,
                  ("footerIssue" Core..=) Core.<$> footerIssue,
                  ("labDataTitle" Core..=) Core.<$> labDataTitle,
                  ("lsPerformanceCategoryDescription" Core..=) Core.<$>
                    lsPerformanceCategoryDescription,
                  ("manualAuditsGroupTitle" Core..=) Core.<$> manualAuditsGroupTitle,
                  ...
                  ("passedAuditsGroupTitle" Core..=) Core.<$> passedAuditsGroupTitle,
                  ("runtimeDesktopEmulation" Core..=) Core.<$>
                    runtimeDesktopEmulation,
                  ("runtimeMobileEmulation" Core..=) Core.<$> runtimeMobileEmulation,
                  ("runtimeNoEmulation" Core..=) Core.<$> runtimeNoEmulation,
                  ...
                  ("runtimeSettingsChannel" Core..=) Core.<$> runtimeSettingsChannel,
                  ("runtimeSettingsDevice" Core..=) Core.<$> runtimeSettingsDevice,
                  ...
                  ("runtimeSettingsTitle" Core..=) Core.<$> runtimeSettingsTitle,
                  ("runtimeSettingsUA" Core..=) Core.<$> runtimeSettingsUA,
                  ("runtimeSettingsUANetwork" Core..=) Core.<$>
                    runtimeSettingsUANetwork,
                  ("runtimeSettingsUrl" Core..=) Core.<$> runtimeSettingsUrl,
                  ("runtimeUnknown" Core..=) Core.<$> runtimeUnknown,
                  ("scorescaleLabel" Core..=) Core.<$> scorescaleLabel,
                  ("showRelevantAudits" Core..=) Core.<$> showRelevantAudits,
                  ...
                  ("throttlingProvided" Core..=) Core.<$> throttlingProvided,
                  ("toplevelWarningsMessage" Core..=) Core.<$>
                    toplevelWarningsMessage,
                  ("varianceDisclaimer" Core..=) Core.<$> varianceDisclaimer,
                  ("viewTreemapLabel" Core..=) Core.<$> viewTreemapLabel,
...
newRuntimeError 
    ::  RuntimeError
newRuntimeError
  = RuntimeError{code = Core.Nothing, message = Core.Nothing}
...
newStackPack 
    ::  StackPack
newStackPack
  = StackPack{descriptions = Core.Nothing,
              iconDataURL = Core.Nothing, id = Core.Nothing,
              title = Core.Nothing}
instance Core.FromJSON StackPack where
        parseJSON
          = Core.withObject "StackPack"
              (\ o ->
                 StackPack Core.<$>
                   (o Core..:? "descriptions") Core.<*> (o Core..:? "iconDataURL")
                     Core.<*> (o Core..:? "id")
                     Core.<*> (o Core..:? "title"))
...
instance Core.FromJSON StackPack_Descriptions where
        parseJSON
          = Core.withObject "StackPack_Descriptions"
              (\ o -> StackPack_Descriptions Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON StackPack_Descriptions where
        toJSON StackPack_Descriptions{..} = Core.toJSON additional
...
instance Core.ToJSON Timing where
        toJSON Timing{..}
          = Core.object (Core.catMaybes [("total" Core..=) Core.<$> total])
...
newUserPageLoadMetricV5 
    ::  UserPageLoadMetricV5
newUserPageLoadMetricV5
  = UserPageLoadMetricV5{category = Core.Nothing,
                         distributions = Core.Nothing, formFactor = Core.Nothing,
                         median = Core.Nothing, metricId = Core.Nothing,
          ...
          = Core.withObject "UserPageLoadMetricV5"
              (\ o ->
                 UserPageLoadMetricV5 Core.<$>
                   (o Core..:? "category") Core.<*> (o Core..:? "distributions")
                     Core.<*> (o Core..:? "formFactor")
                     Core.<*> (o Core..:? "median")
