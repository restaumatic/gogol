...
newServiceUsageOperationsList 
    ::  ServiceUsageOperationsList
newServiceUsageOperationsList
  = ServiceUsageOperationsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ServiceUsageOperationsList where
        type Rs ServiceUsageOperationsList = ListOperationsResponse
        type Scopes ServiceUsageOperationsList =
        ...
        requestClient ServiceUsageOperationsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ServiceUsageOperationsListResource)
                      Core.mempty
