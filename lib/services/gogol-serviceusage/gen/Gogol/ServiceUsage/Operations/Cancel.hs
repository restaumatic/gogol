...
newServiceUsageOperationsCancel name payload
  = ServiceUsageOperationsCancel{xgafv = Core.Nothing,
                                 accessToken = Core.Nothing, callback = Core.Nothing, name = name,
                                 payload = payload, uploadType = Core.Nothing,
                                 uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ServiceUsageOperationsCancel where
        ...
        requestClient ServiceUsageOperationsCancel{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ServiceUsageOperationsCancelResource)
                      Core.mempty
