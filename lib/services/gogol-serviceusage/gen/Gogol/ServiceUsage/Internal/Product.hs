...
newApi 
    ::  Api
newApi
  = Api{edition = Core.Nothing, methods = Core.Nothing,
        mixins = Core.Nothing, name = Core.Nothing, options = Core.Nothing,
...
instance Core.FromJSON Api where
        parseJSON
          = Core.withObject "Api"
              (\ o ->
                 Api Core.<$>
                   (o Core..:? "edition") Core.<*> (o Core..:? "methods") Core.<*>
                     (o Core..:? "mixins")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "options")
...
--
-- /See:/ 'newContentSecurity' smart constructor.
newtype ContentSecurity = ContentSecurity
    {
      -- | List of content security providers that are enabled for content scanning.
      contentSecurityProviders :: (Core.Maybe [ContentSecurityProvider])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'ContentSecurity' with the minimum fields required to make a request.
newContentSecurity 
    ::  ContentSecurity
newContentSecurity
  = ContentSecurity{contentSecurityProviders = Core.Nothing}
instance Core.FromJSON ContentSecurity where
        parseJSON
          = Core.withObject "ContentSecurity"
              (\ o ->
                 ContentSecurity Core.<$> (o Core..:? "contentSecurityProviders"))

instance Core.ToJSON ContentSecurity where
        toJSON ContentSecurity{..}
          = Core.object
              (Core.catMaybes
                 [("contentSecurityProviders" Core..=) Core.<$>
                    contentSecurityProviders])


-- | ContentSecurityProvider contains the name of content security provider.
--
-- /See:/ 'newContentSecurityProvider' smart constructor.
newtype ContentSecurityProvider = ContentSecurityProvider
    {
...
-- | Creates a value of 'ContentSecurityProvider' with the minimum fields required to make a request.
newContentSecurityProvider 
    ::  ContentSecurityProvider
newContentSecurityProvider
  = ContentSecurityProvider{name = Core.Nothing}
instance Core.FromJSON ContentSecurityProvider where
        parseJSON
          = Core.withObject "ContentSecurityProvider"
              (\ o -> ContentSecurityProvider Core.<$> (o Core..:? "name"))

instance Core.ToJSON ContentSecurityProvider where
        toJSON ContentSecurityProvider{..}
...
data GoSettings = GoSettings
    {
      -- | Some settings.
      common :: (Core.Maybe CommonLanguageSettings)
      -- | Map of service names to renamed services. Keys are the package relative service names and values are the name to be used for the service client and call options. Example: publishing: go/settings: renamed/services: Publisher: TopicAdmin
...
data GoogleApiServiceusageV2betaImpact = GoogleApiServiceusageV2betaImpact
    ...
    , missingDependency :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newGoogleApiServiceusageV2betaImpact
  = GoogleApiServiceusageV2betaImpact{detail = Core.Nothing,
                                      impactType = Core.Nothing, missingDependency = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("detail" Core..=) Core.<$> detail,
                  ...
                  ("missingDependency" Core..=) Core.<$> missingDependency])
...
--
-- /See:/ 'newMcpEnableRule' smart constructor.
newtype McpEnableRule = McpEnableRule
    {
      -- | List of enabled MCP services.
      mcpServices :: (Core.Maybe [McpService])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'McpEnableRule' with the minimum fields required to make a request.
newMcpEnableRule 
    ::  McpEnableRule
newMcpEnableRule = McpEnableRule{mcpServices = Core.Nothing}
instance Core.FromJSON McpEnableRule where
        parseJSON
          = Core.withObject "McpEnableRule"
              (\ o -> McpEnableRule Core.<$> (o Core..:? "mcpServices"))

instance Core.ToJSON McpEnableRule where
        toJSON McpEnableRule{..}
          = Core.object
              (Core.catMaybes [("mcpServices" Core..=) Core.<$> mcpServices])


-- | MCP Consumer Policy is a set of rules that define MCP related policy for a cloud resource hierarchy.
--
-- /See:/ 'newMcpPolicy' smart constructor.
data McpPolicy = McpPolicy
    {
      -- | ContentSecurity contains the content security related fields of a MCP policy.
      contentSecurity :: (Core.Maybe ContentSecurity)
    ...
    , mcpEnableRules :: (Core.Maybe [McpEnableRule])
...
-- | Creates a value of 'McpPolicy' with the minimum fields required to make a request.
newMcpPolicy 
    ::  McpPolicy
newMcpPolicy
  = McpPolicy{contentSecurity = Core.Nothing,
              createTime = Core.Nothing, etag = Core.Nothing,
              mcpEnableRules = Core.Nothing, name = Core.Nothing,
              updateTime = Core.Nothing}
instance Core.FromJSON McpPolicy where
        parseJSON
          = Core.withObject "McpPolicy"
              (\ o ->
                 McpPolicy Core.<$>
                   (o Core..:? "contentSecurity") Core.<*> (o Core..:? "createTime")
                     Core.<*> (o Core..:? "etag")
                     Core.<*> (o Core..:? "mcpEnableRules")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "updateTime"))

instance Core.ToJSON McpPolicy where
        toJSON McpPolicy{..}
          = Core.object
              (Core.catMaybes
                 [("contentSecurity" Core..=) Core.<$> contentSecurity,
                  ("createTime" Core..=) Core.<$> createTime,
                  ("etag" Core..=) Core.<$> etag,
                  ("mcpEnableRules" Core..=) Core.<$> mcpEnableRules,
                  ("name" Core..=) Core.<$> name,
                  ("updateTime" Core..=) Core.<$> updateTime])
...
--
-- /See:/ 'newMcpService' smart constructor.
newtype McpService = McpService
    {
...
-- | Creates a value of 'McpService' with the minimum fields required to make a request.
newMcpService 
    ::  McpService
newMcpService = McpService{service = Core.Nothing}
instance Core.FromJSON McpService where
        parseJSON
          = Core.withObject "McpService"
              (\ o -> McpService Core.<$> (o Core..:? "service"))

instance Core.ToJSON McpService where
        toJSON McpService{..}
          = Core.object
              (Core.catMaybes [("service" Core..=) Core.<$> service])
...
newMethod 
    ::  Method
newMethod
  = Method{edition = Core.Nothing, name = Core.Nothing,
           options = Core.Nothing, requestStreaming = Core.Nothing,
           requestTypeUrl = Core.Nothing, responseStreaming = Core.Nothing,
           responseTypeUrl = Core.Nothing, syntax = Core.Nothing}
instance Core.FromJSON Method where
        parseJSON
          = Core.withObject "Method"
              (\ o ->
                 Method Core.<$>
                   (o Core..:? "edition") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "options")
...
--
-- /See:/ 'newUpdateMcpPolicyMetadata' smart constructor.
data UpdateMcpPolicyMetadata = UpdateMcpPolicyMetadata
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'UpdateMcpPolicyMetadata' with the minimum fields required to make a request.
newUpdateMcpPolicyMetadata 
    ::  UpdateMcpPolicyMetadata
newUpdateMcpPolicyMetadata = UpdateMcpPolicyMetadata
instance Core.FromJSON UpdateMcpPolicyMetadata where
        parseJSON
          = Core.withObject "UpdateMcpPolicyMetadata"
              (\ o -> Core.pure UpdateMcpPolicyMetadata)

instance Core.ToJSON UpdateMcpPolicyMetadata where
        toJSON = Core.const Core.emptyObject
