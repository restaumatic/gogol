                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.Get '[Core.JSON] BatchGetServicesResponse
...
newServiceUsageServicesBatchGet parent
  = ServiceUsageServicesBatchGet{xgafv = Core.Nothing,
                                 accessToken = Core.Nothing, callback = Core.Nothing,
                                 names = Core.Nothing, parent = parent, uploadType = Core.Nothing,
                                 uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ServiceUsageServicesBatchGet where
        type Rs ServiceUsageServicesBatchGet = BatchGetServicesResponse
        type Scopes ServiceUsageServicesBatchGet =
        ...
        requestClient ServiceUsageServicesBatchGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ServiceUsageServicesBatchGetResource)
                      Core.mempty
