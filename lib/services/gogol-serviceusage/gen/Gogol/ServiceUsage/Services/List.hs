...
newServiceUsageServicesList parent
  = ServiceUsageServicesList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ServiceUsageServicesList where
        type Rs ServiceUsageServicesList = ListServicesResponse
        type Scopes ServiceUsageServicesList =
        ...
        requestClient ServiceUsageServicesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ServiceUsageServicesListResource)
                      Core.mempty
