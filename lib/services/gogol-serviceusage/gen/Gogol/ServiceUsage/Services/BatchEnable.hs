                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] BatchEnableServicesRequest Core.:>
...
newServiceUsageServicesBatchEnable parent payload
  = ServiceUsageServicesBatchEnable{xgafv = Core.Nothing,
                                    accessToken = Core.Nothing, callback = Core.Nothing,
                                    parent = parent, payload = payload, uploadType = Core.Nothing,
                                    uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ServiceUsageServicesBatchEnable where
        type Rs ServiceUsageServicesBatchEnable = Operation
        type Scopes ServiceUsageServicesBatchEnable =
        ...
        requestClient ServiceUsageServicesBatchEnable{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ServiceUsageServicesBatchEnableResource)
                      Core.mempty
