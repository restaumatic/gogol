...
newServiceUsageServicesDisable name payload
  = ServiceUsageServicesDisable{xgafv = Core.Nothing,
                                accessToken = Core.Nothing, callback = Core.Nothing, name = name,
                                payload = payload, uploadType = Core.Nothing,
                                uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ServiceUsageServicesDisable where
        ...
        requestClient ServiceUsageServicesDisable{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ServiceUsageServicesDisableResource)
                      Core.mempty
