               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.Get '[Core.JSON] GoogleApiServiceusageV1Service
...
newServiceUsageServicesGet name
  = ServiceUsageServicesGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ServiceUsageServicesGet where
        type Rs ServiceUsageServicesGet = GoogleApiServiceusageV1Service
        type Scopes ServiceUsageServicesGet =
        ...
        requestClient ServiceUsageServicesGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ServiceUsageServicesGetResource)
                      Core.mempty
