...
--
-- /See:/ <https://developers.google.com/games/ Google Play Games Services API Reference> for @games.achievementDefinitions.list@.
module Gogol.Games.AchievementDefinitions.List
    (
    -- * Resource
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] AchievementDefinitionsListResponse
...
newGamesAchievementDefinitionsList 
    :: 
                                   GamesAchievementDefinitionsList
newGamesAchievementDefinitionsList
  = GamesAchievementDefinitionsList{xgafv = Core.Nothing,
                                    accessToken = Core.Nothing, callback = Core.Nothing,
                                    language = Core.Nothing, maxResults = Core.Nothing,
                                    pageToken = Core.Nothing, uploadType = Core.Nothing,
                                    uploadProtocol = Core.Nothing}
instance Core.GoogleRequest GamesAchievementDefinitionsList where
        type Rs GamesAchievementDefinitionsList =
             AchievementDefinitionsListResponse
        type Scopes GamesAchievementDefinitionsList = '[Games'FullControl]
        requestClient GamesAchievementDefinitionsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy GamesAchievementDefinitionsListResource)
                      Core.mempty
