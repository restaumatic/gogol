...
--
-- /See:/ <https://developers.google.com/games/ Google Play Games Services API Reference> for @games.applications.getEndPoint@.
module Gogol.Games.Applications.GetEndPoint
    (
    -- * Resource
               ...
               Core.QueryParam "access_token" Core.Text Core.:>
                 Core.QueryParam "applicationId" Core.Text Core.:>
                   Core.QueryParam "callback" Core.Text Core.:>
                     Core.QueryParam "endPointType" ApplicationsGetEndPointEndPointType
                       Core.:>
...
newGamesApplicationsGetEndPoint 
    ::  GamesApplicationsGetEndPoint
newGamesApplicationsGetEndPoint
  = GamesApplicationsGetEndPoint{xgafv = Core.Nothing,
                                 accessToken = Core.Nothing, applicationId = Core.Nothing,
                                 callback = Core.Nothing, endPointType = Core.Nothing,
                                 uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest GamesApplicationsGetEndPoint where
        type Rs GamesApplicationsGetEndPoint = EndPoint
        type Scopes GamesApplicationsGetEndPoint = '[Games'FullControl]
        requestClient GamesApplicationsGetEndPoint{..}
          = go xgafv accessToken applicationId callback endPointType
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy GamesApplicationsGetEndPointResource)
                      Core.mempty
