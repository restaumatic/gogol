...
--
-- /See:/ <https://developers.google.com/games/ Google Play Games Services API Reference> for @games.applications.verify@.
module Gogol.Games.Applications.Verify
    (
    -- * Resource
                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] ApplicationVerifyResponse
...
newGamesApplicationsVerify applicationId
  = GamesApplicationsVerify{xgafv = Core.Nothing,
