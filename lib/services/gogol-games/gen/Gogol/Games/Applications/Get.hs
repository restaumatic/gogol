...
-- |
-- Module      : Gogol.Games.Applications.Get
...
--
-- /See:/ <https://developers.google.com/games/ Google Play Games Services API Reference> for @games.applications.get@.
module Gogol.Games.Applications.Get
    (
    -- * Resource
               ...
               Core.QueryParam "access_token" Core.Text Core.:>
                 Core.QueryParam "callback" Core.Text Core.:>
                   Core.QueryParam "language" Core.Text Core.:>
                     Core.QueryParam "platformType" ApplicationsGetPlatformType Core.:>
...
newGamesApplicationsGet applicationId
  = GamesApplicationsGet{xgafv = Core.Nothing,
                         accessToken = Core.Nothing, applicationId = applicationId,
                         callback = Core.Nothing, language = Core.Nothing,
                         platformType = Core.Nothing, uploadType = Core.Nothing,
                         uploadProtocol = Core.Nothing}
instance Core.GoogleRequest GamesApplicationsGet where
        type Rs GamesApplicationsGet = Application
        type Scopes GamesApplicationsGet = '[Games'FullControl]
        requestClient GamesApplicationsGet{..}
          = go applicationId xgafv accessToken callback language platformType
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy GamesApplicationsGetResource)
                      Core.mempty
