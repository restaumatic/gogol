...
--
-- /See:/ <https://developers.google.com/games/ Google Play Games Services API Reference> for @games.applications.played@.
module Gogol.Games.Applications.Played
    (
    -- * Resource
...
newGamesApplicationsPlayed 
    ::  GamesApplicationsPlayed
newGamesApplicationsPlayed
  = GamesApplicationsPlayed{xgafv = Core.Nothing,
