...
--
-- /See:/ <https://developers.google.com/games/ Google Play Games Services API Reference> for @games.stats.get@.
module Gogol.Games.Stats.Get
    (
    -- * Resource
                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.Get '[Core.JSON] StatsResponse
...
newGamesStatsGet 
    ::  GamesStatsGet
newGamesStatsGet
  = GamesStatsGet{xgafv = Core.Nothing, accessToken = Core.Nothing,
...
instance Core.GoogleRequest GamesStatsGet where
        ...
        requestClient GamesStatsGet{..}
          = go xgafv accessToken callback uploadType uploadProtocol
              ...
              gamesService
          where go
                  = Core.buildClient (Core.Proxy :: Core.Proxy GamesStatsGetResource)
                      Core.mempty
