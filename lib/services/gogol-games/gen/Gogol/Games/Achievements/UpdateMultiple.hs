...
--
-- /See:/ <https://developers.google.com/games/ Google Play Games Services API Reference> for @games.achievements.updateMultiple@.
module Gogol.Games.Achievements.UpdateMultiple
    (
    -- * Resource
                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] AchievementUpdateMultipleRequest Core.:>
                           Core.Post '[Core.JSON] AchievementUpdateMultipleResponse
