...
--
-- /See:/ <https://developers.google.com/games/ Google Play Games Services API Reference> for @games.achievements.reveal@.
module Gogol.Games.Achievements.Reveal
    (
    -- * Resource
                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Post '[Core.JSON] AchievementRevealResponse
...
newGamesAchievementsReveal achievementId
  = GamesAchievementsReveal{xgafv = Core.Nothing,
