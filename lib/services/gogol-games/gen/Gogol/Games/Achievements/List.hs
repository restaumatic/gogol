...
--
-- /See:/ <https://developers.google.com/games/ Google Play Games Services API Reference> for @games.achievements.list@.
module Gogol.Games.Achievements.List
    (
    -- * Resource
                             ...
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.Get '[Core.JSON] PlayerAchievementListResponse
...
newGamesAchievementsList playerId
  = GamesAchievementsList{xgafv = Core.Nothing,
                          accessToken = Core.Nothing, callback = Core.Nothing,
                          language = Core.Nothing, maxResults = Core.Nothing,
                          pageToken = Core.Nothing, playerId = playerId,
                          state = Core.Nothing, uploadType = Core.Nothing,
                          uploadProtocol = Core.Nothing}
instance Core.GoogleRequest GamesAchievementsList where
        type Rs GamesAchievementsList = PlayerAchievementListResponse
        type Scopes GamesAchievementsList = '[Games'FullControl]
        requestClient GamesAchievementsList{..}
          = go playerId xgafv accessToken callback language maxResults
              pageToken
              state
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy GamesAchievementsListResource)
                      Core.mempty
