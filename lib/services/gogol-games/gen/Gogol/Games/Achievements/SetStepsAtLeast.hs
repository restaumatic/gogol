...
--
-- /See:/ <https://developers.google.com/games/ Google Play Games Services API Reference> for @games.achievements.setStepsAtLeast@.
module Gogol.Games.Achievements.SetStepsAtLeast
    (
    -- * Resource
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Post '[Core.JSON] AchievementSetStepsAtLeastResponse
...
newGamesAchievementsSetStepsAtLeast achievementId steps
  = GamesAchievementsSetStepsAtLeast{xgafv = Core.Nothing,
                                     accessToken = Core.Nothing, achievementId = achievementId,
                                     callback = Core.Nothing, steps = steps,
                                     uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest GamesAchievementsSetStepsAtLeast where
        type Rs GamesAchievementsSetStepsAtLeast =
             AchievementSetStepsAtLeastResponse
        type Scopes GamesAchievementsSetStepsAtLeast = '[Games'FullControl]
        requestClient GamesAchievementsSetStepsAtLeast{..}
          = go achievementId (Core.Just steps) xgafv accessToken callback
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy GamesAchievementsSetStepsAtLeastResource)
                      Core.mempty
