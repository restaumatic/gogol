...
newAchievementDefinition 
    ::  AchievementDefinition
newAchievementDefinition
  = AchievementDefinition{achievementType = Core.Nothing,
                          description = Core.Nothing, experiencePoints = Core.Nothing,
                          formattedTotalSteps = Core.Nothing, id = Core.Nothing,
                          initialState = Core.Nothing,
                          isRevealedIconUrlDefault = Core.Nothing,
                          isUnlockedIconUrlDefault = Core.Nothing, kind = Core.Nothing,
                          name = Core.Nothing, revealedIconUrl = Core.Nothing,
                          totalSteps = Core.Nothing, unlockedIconUrl = Core.Nothing}
instance Core.FromJSON AchievementDefinition where
        parseJSON
          = Core.withObject "AchievementDefinition"
              (\ o ->
                 AchievementDefinition Core.<$>
                   (o Core..:? "achievementType") Core.<*> (o Core..:? "description")
                     Core.<*>
                     (o Core..:? "experiencePoints" Core.<&> Core.fmap Core.fromAsText)
...
instance Core.ToJSON AchievementDefinition where
        toJSON AchievementDefinition{..}
          = Core.object
              (Core.catMaybes
                 [("achievementType" Core..=) Core.<$> achievementType,
                  ("description" Core..=) Core.<$> description,
                  ("experiencePoints" Core..=) Core.. Core.AsText Core.<$>
                    experiencePoints,
                  ("formattedTotalSteps" Core..=) Core.<$> formattedTotalSteps,
                  ("id" Core..=) Core.<$> id,
                  ...
                  ("unlockedIconUrl" Core..=) Core.<$> unlockedIconUrl])
...
newAchievementDefinitionsListResponse 
    :: 
                                      AchievementDefinitionsListResponse
newAchievementDefinitionsListResponse
  = AchievementDefinitionsListResponse{items = Core.Nothing,
                                       kind = Core.Nothing, nextPageToken = Core.Nothing}
instance Core.FromJSON AchievementDefinitionsListResponse where
        parseJSON
          = Core.withObject "AchievementDefinitionsListResponse"
              (\ o ->
                 AchievementDefinitionsListResponse Core.<$>
                   (o Core..:? "items") Core.<*> (o Core..:? "kind") Core.<*>
                     (o Core..:? "nextPageToken"))

instance Core.ToJSON AchievementDefinitionsListResponse where
...
newAchievementIncrementResponse 
    ::  AchievementIncrementResponse
newAchievementIncrementResponse
  = AchievementIncrementResponse{currentSteps = Core.Nothing,
                                 kind = Core.Nothing, newlyUnlocked' = Core.Nothing}
          ...
          = Core.withObject "AchievementIncrementResponse"
              (\ o ->
                 AchievementIncrementResponse Core.<$>
                   (o Core..:? "currentSteps") Core.<*> (o Core..:? "kind") Core.<*>
...
newAchievementRevealResponse 
    ::  AchievementRevealResponse
newAchievementRevealResponse
  = AchievementRevealResponse{currentState = Core.Nothing,
                              kind = Core.Nothing}
          ...
          = Core.withObject "AchievementRevealResponse"
              (\ o ->
                 AchievementRevealResponse Core.<$>
                   (o Core..:? "currentState") Core.<*> (o Core..:? "kind"))
...
newAchievementSetStepsAtLeastResponse 
    :: 
                                      AchievementSetStepsAtLeastResponse
newAchievementSetStepsAtLeastResponse
  = AchievementSetStepsAtLeastResponse{currentSteps = Core.Nothing,
                                       kind = Core.Nothing, newlyUnlocked' = Core.Nothing}
instance Core.FromJSON AchievementSetStepsAtLeastResponse where
        parseJSON
          = Core.withObject "AchievementSetStepsAtLeastResponse"
              (\ o ->
                 AchievementSetStepsAtLeastResponse Core.<$>
                   (o Core..:? "currentSteps") Core.<*> (o Core..:? "kind") Core.<*>
                     (o Core..:? "newlyUnlocked"))

instance Core.ToJSON AchievementSetStepsAtLeastResponse where
...
newAchievementUnlockResponse 
    ::  AchievementUnlockResponse
newAchievementUnlockResponse
  = AchievementUnlockResponse{kind = Core.Nothing,
          ...
          = Core.withObject "AchievementUnlockResponse"
              (\ o ->
                 AchievementUnlockResponse Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "newlyUnlocked"))
...
newAchievementUpdateMultipleRequest 
    :: 
                                    AchievementUpdateMultipleRequest
newAchievementUpdateMultipleRequest
  = AchievementUpdateMultipleRequest{kind = Core.Nothing,
                                     updates = Core.Nothing}
instance Core.FromJSON AchievementUpdateMultipleRequest where
        parseJSON
...
newAchievementUpdateMultipleResponse 
    :: 
                                     AchievementUpdateMultipleResponse
newAchievementUpdateMultipleResponse
  = AchievementUpdateMultipleResponse{kind = Core.Nothing,
                                      updatedAchievements = Core.Nothing}
instance Core.FromJSON AchievementUpdateMultipleResponse where
        parseJSON
          = Core.withObject "AchievementUpdateMultipleResponse"
              (\ o ->
                 AchievementUpdateMultipleResponse Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "updatedAchievements"))

instance Core.ToJSON AchievementUpdateMultipleResponse where
        toJSON AchievementUpdateMultipleResponse{..}
          = Core.object
              (Core.catMaybes
                 [("kind" Core..=) Core.<$> kind,
                  ("updatedAchievements" Core..=) Core.<$> updatedAchievements])
...
newAchievementUpdateRequest 
    ::  AchievementUpdateRequest
newAchievementUpdateRequest
  = AchievementUpdateRequest{achievementId = Core.Nothing,
                             incrementPayload = Core.Nothing, kind = Core.Nothing,
                             setStepsAtLeastPayload = Core.Nothing, updateType = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("achievementId" Core..=) Core.<$> achievementId,
                  ("incrementPayload" Core..=) Core.<$> incrementPayload,
                  ("kind" Core..=) Core.<$> kind,
                  ("setStepsAtLeastPayload" Core..=) Core.<$> setStepsAtLeastPayload,
...
newAchievementUpdateResponse 
    ::  AchievementUpdateResponse
newAchievementUpdateResponse
  = AchievementUpdateResponse{achievementId = Core.Nothing,
                              currentState = Core.Nothing, currentSteps = Core.Nothing,
                              kind = Core.Nothing, newlyUnlocked' = Core.Nothing,
          ...
          = Core.withObject "AchievementUpdateResponse"
              (\ o ->
                 AchievementUpdateResponse Core.<$>
                   (o Core..:? "achievementId") Core.<*> (o Core..:? "currentState")
...
newApplication 
    ::  Application
newApplication
  = Application{achievementCount = Core.Nothing,
                assets = Core.Nothing, author = Core.Nothing,
                category = Core.Nothing, description = Core.Nothing,
                enabledFeatures = Core.Nothing, id = Core.Nothing,
                instances = Core.Nothing, kind = Core.Nothing,
                lastUpdatedTimestamp = Core.Nothing,
                leaderboardCount = Core.Nothing, name = Core.Nothing,
...
instance Core.FromJSON Application where
        parseJSON
          = Core.withObject "Application"
              (\ o ->
                 Application Core.<$>
                   (o Core..:? "achievement_count") Core.<*> (o Core..:? "assets")
                     Core.<*> (o Core..:? "author")
...
instance Core.ToJSON Application where
        toJSON Application{..}
          = Core.object
              (Core.catMaybes
                 [("achievement_count" Core..=) Core.<$> achievementCount,
                  ...
                  ("kind" Core..=) Core.<$> kind,
                  ("lastUpdatedTimestamp" Core..=) Core.. Core.AsText Core.<$>
                    lastUpdatedTimestamp,
                  ("leaderboard_count" Core..=) Core.<$> leaderboardCount,
                  ("name" Core..=) Core.<$> name,
...
newApplicationCategory 
    ::  ApplicationCategory
newApplicationCategory
  = ApplicationCategory{kind = Core.Nothing, primary = Core.Nothing,
          ...
          = Core.withObject "ApplicationCategory"
              (\ o ->
                 ApplicationCategory Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "primary") Core.<*>
                     (o Core..:? "secondary"))
...
newApplicationPlayerId 
    ::  ApplicationPlayerId
newApplicationPlayerId
  = ApplicationPlayerId{applicationId = Core.Nothing,
          ...
          = Core.withObject "ApplicationPlayerId"
              (\ o ->
                 ApplicationPlayerId Core.<$>
                   (o Core..:? "applicationId") Core.<*> (o Core..:? "playerId"))
...
newApplicationVerifyResponse 
    ::  ApplicationVerifyResponse
newApplicationVerifyResponse
  = ApplicationVerifyResponse{alternatePlayerId = Core.Nothing,
                              kind = Core.Nothing, playerId = Core.Nothing}
          ...
          = Core.withObject "ApplicationVerifyResponse"
              (\ o ->
                 ApplicationVerifyResponse Core.<$>
                   (o Core..:? "alternate_player_id") Core.<*> (o Core..:? "kind")
...
instance Core.ToJSON ApplicationVerifyResponse where
        toJSON ApplicationVerifyResponse{..}
          = Core.object
              (Core.catMaybes
                 [("alternate_player_id" Core..=) Core.<$> alternatePlayerId,
                  ("kind" Core..=) Core.<$> kind,
...
newCategory 
    ::  Category
newCategory
  = Category{category = Core.Nothing,
             experiencePoints = Core.Nothing, kind = Core.Nothing}
...
newCategoryListResponse 
    ::  CategoryListResponse
newCategoryListResponse
  = CategoryListResponse{items = Core.Nothing, kind = Core.Nothing,
...
newEventBatchRecordFailure 
    ::  EventBatchRecordFailure
newEventBatchRecordFailure
  = EventBatchRecordFailure{failureCause = Core.Nothing,
                            kind = Core.Nothing, range = Core.Nothing}
instance Core.FromJSON EventBatchRecordFailure where
        parseJSON
          = Core.withObject "EventBatchRecordFailure"
              (\ o ->
                 EventBatchRecordFailure Core.<$>
                   (o Core..:? "failureCause") Core.<*> (o Core..:? "kind") Core.<*>
                     (o Core..:? "range"))
          ...
          = Core.object
              (Core.catMaybes
                 [("failureCause" Core..=) Core.<$> failureCause,
                  ("kind" Core..=) Core.<$> kind, ("range" Core..=) Core.<$> range])
...
newEventChild 
    ::  EventChild
newEventChild
  = EventChild{childId = Core.Nothing, kind = Core.Nothing}
...
newEventDefinition 
    ::  EventDefinition
newEventDefinition
  = EventDefinition{childEvents = Core.Nothing,
                    description = Core.Nothing, displayName = Core.Nothing,
                    id = Core.Nothing, imageUrl = Core.Nothing,
                    isDefaultImageUrl = Core.Nothing, kind = Core.Nothing,
          ...
          = Core.withObject "EventDefinition"
              (\ o ->
                 EventDefinition Core.<$>
                   (o Core..:? "childEvents") Core.<*> (o Core..:? "description")
          ...
          = Core.object
              (Core.catMaybes
                 [("childEvents" Core..=) Core.<$> childEvents,
                  ...
                  ("id" Core..=) Core.<$> id, ("imageUrl" Core..=) Core.<$> imageUrl,
                  ("isDefaultImageUrl" Core..=) Core.<$> isDefaultImageUrl,
                  ("kind" Core..=) Core.<$> kind,
...
newEventDefinitionListResponse 
    ::  EventDefinitionListResponse
newEventDefinitionListResponse
  = EventDefinitionListResponse{items = Core.Nothing,
                                kind = Core.Nothing, nextPageToken = Core.Nothing}
...
newEventPeriodRange 
    ::  EventPeriodRange
newEventPeriodRange
  = EventPeriodRange{kind = Core.Nothing,
                     periodEndMillis = Core.Nothing, periodStartMillis = Core.Nothing}
          ...
          = Core.withObject "EventPeriodRange"
              (\ o ->
                 EventPeriodRange Core.<$>
                   (o Core..:? "kind") Core.<*>
                     (o Core..:? "periodEndMillis" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
...
instance Core.ToJSON EventPeriodRange where
        toJSON EventPeriodRange{..}
          = Core.object
              (Core.catMaybes
                 [("kind" Core..=) Core.<$> kind,
                  ("periodEndMillis" Core..=) Core.. Core.AsText Core.<$>
                    periodEndMillis,
                  ("periodStartMillis" Core..=) Core.. Core.AsText Core.<$>
                    periodStartMillis])
...
newEventPeriodUpdate 
    ::  EventPeriodUpdate
newEventPeriodUpdate
  = EventPeriodUpdate{kind = Core.Nothing, timePeriod = Core.Nothing,
                      updates = Core.Nothing}
          ...
          = Core.withObject "EventPeriodUpdate"
              (\ o ->
                 EventPeriodUpdate Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "timePeriod") Core.<*>
                     (o Core..:? "updates"))
...
newEventRecordFailure 
    ::  EventRecordFailure
newEventRecordFailure
  = EventRecordFailure{eventId = Core.Nothing,
                       failureCause = Core.Nothing, kind = Core.Nothing}
instance Core.FromJSON EventRecordFailure where
        parseJSON
          = Core.withObject "EventRecordFailure"
              (\ o ->
                 EventRecordFailure Core.<$>
                   (o Core..:? "eventId") Core.<*> (o Core..:? "failureCause")
                     Core.<*> (o Core..:? "kind"))
...
newEventRecordRequest 
    ::  EventRecordRequest
newEventRecordRequest
  = EventRecordRequest{currentTimeMillis = Core.Nothing,
                       kind = Core.Nothing, requestId = Core.Nothing,
          ...
          = Core.withObject "EventRecordRequest"
              (\ o ->
                 EventRecordRequest Core.<$>
                   (o Core..:? "currentTimeMillis" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "kind")
                     Core.<*>
                     (o Core..:? "requestId" Core.<&> Core.fmap Core.fromAsText)
...
instance Core.ToJSON EventRecordRequest where
        toJSON EventRecordRequest{..}
          = Core.object
              (Core.catMaybes
                 [("currentTimeMillis" Core..=) Core.. Core.AsText Core.<$>
                    currentTimeMillis,
                  ("kind" Core..=) Core.<$> kind,
                  ("requestId" Core..=) Core.. Core.AsText Core.<$> requestId,
...
newEventUpdateRequest 
    ::  EventUpdateRequest
newEventUpdateRequest
  = EventUpdateRequest{definitionId = Core.Nothing,
                       kind = Core.Nothing, updateCount = Core.Nothing}
instance Core.FromJSON EventUpdateRequest where
        parseJSON
          = Core.withObject "EventUpdateRequest"
              (\ o ->
                 EventUpdateRequest Core.<$>
                   (o Core..:? "definitionId") Core.<*> (o Core..:? "kind") Core.<*>
                     (o Core..:? "updateCount" Core.<&> Core.fmap Core.fromAsText))
          ...
          = Core.object
              (Core.catMaybes
                 [("definitionId" Core..=) Core.<$> definitionId,
                  ("kind" Core..=) Core.<$> kind,
                  ("updateCount" Core..=) Core.. Core.AsText Core.<$> updateCount])
...
newEventUpdateResponse 
    ::  EventUpdateResponse
newEventUpdateResponse
  = EventUpdateResponse{batchFailures = Core.Nothing,
                        eventFailures = Core.Nothing, kind = Core.Nothing,
          ...
          = Core.withObject "EventUpdateResponse"
              (\ o ->
                 EventUpdateResponse Core.<$>
                   (o Core..:? "batchFailures") Core.<*> (o Core..:? "eventFailures")
                     Core.<*> (o Core..:? "kind")
...
--
-- /See:/ 'newGamePlayerToken' smart constructor.
data GamePlayerToken = GamePlayerToken
    {
      -- | The application that this player identifier is for.
      applicationId :: (Core.Maybe Core.Text)
      -- | Recall token data.
    , recallToken :: (Core.Maybe RecallToken)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'GamePlayerToken' with the minimum fields required to make a request.
newGamePlayerToken 
    ::  GamePlayerToken
newGamePlayerToken
  = GamePlayerToken{applicationId = Core.Nothing,
                    recallToken = Core.Nothing}
instance Core.FromJSON GamePlayerToken where
        parseJSON
          = Core.withObject "GamePlayerToken"
              (\ o ->
                 GamePlayerToken Core.<$>
                   (o Core..:? "applicationId") Core.<*> (o Core..:? "recallToken"))

instance Core.ToJSON GamePlayerToken where
        toJSON GamePlayerToken{..}
          = Core.object
              (Core.catMaybes
                 [("applicationId" Core..=) Core.<$> applicationId,
                  ("recallToken" Core..=) Core.<$> recallToken])
...
newGamesAchievementIncrement 
    ::  GamesAchievementIncrement
newGamesAchievementIncrement
  = GamesAchievementIncrement{kind = Core.Nothing,
                              requestId = Core.Nothing, steps = Core.Nothing}
...
newGamesAchievementSetStepsAtLeast 
    :: 
                                   GamesAchievementSetStepsAtLeast
newGamesAchievementSetStepsAtLeast
  = GamesAchievementSetStepsAtLeast{kind = Core.Nothing,
                                    steps = Core.Nothing}
instance Core.FromJSON GamesAchievementSetStepsAtLeast where
        parseJSON
...
instance Core.ToJSON GamesAchievementSetStepsAtLeast where
        toJSON GamesAchievementSetStepsAtLeast{..}
          = Core.object
              (Core.catMaybes
                 [("kind" Core..=) Core.<$> kind, ("steps" Core..=) Core.<$> steps])


-- | Response for the GeneratePlayGroupingApiToken RPC.
--
-- /See:/ 'newGeneratePlayGroupingApiTokenResponse' smart constructor.
newtype GeneratePlayGroupingApiTokenResponse = GeneratePlayGroupingApiTokenResponse
    {
      -- | Token for accessing the Play Grouping API.
      token :: (Core.Maybe PlayGroupingApiToken)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'GeneratePlayGroupingApiTokenResponse' with the minimum fields required to make a request.
newGeneratePlayGroupingApiTokenResponse 
    :: 
                                        GeneratePlayGroupingApiTokenResponse
newGeneratePlayGroupingApiTokenResponse
  = GeneratePlayGroupingApiTokenResponse{token = Core.Nothing}
instance Core.FromJSON GeneratePlayGroupingApiTokenResponse where
        parseJSON
          = Core.withObject "GeneratePlayGroupingApiTokenResponse"
              (\ o ->
                 GeneratePlayGroupingApiTokenResponse Core.<$> (o Core..:? "token"))

instance Core.ToJSON GeneratePlayGroupingApiTokenResponse where
        toJSON GeneratePlayGroupingApiTokenResponse{..}
          = Core.object (Core.catMaybes [("token" Core..=) Core.<$> token])


-- | Response for the GenerateRecallPlayGroupingApiToken RPC.
--
-- /See:/ 'newGenerateRecallPlayGroupingApiTokenResponse' smart constructor.
newtype GenerateRecallPlayGroupingApiTokenResponse = GenerateRecallPlayGroupingApiTokenResponse
    {
      -- | Token for accessing the Play Grouping API.
      token :: (Core.Maybe PlayGroupingApiToken)
    }
...
-- | Creates a value of 'GenerateRecallPlayGroupingApiTokenResponse' with the minimum fields required to make a request.
newGenerateRecallPlayGroupingApiTokenResponse 
    :: 
                                              GenerateRecallPlayGroupingApiTokenResponse
newGenerateRecallPlayGroupingApiTokenResponse
  = GenerateRecallPlayGroupingApiTokenResponse{token = Core.Nothing}
instance Core.FromJSON GenerateRecallPlayGroupingApiTokenResponse
         where
        parseJSON
          = Core.withObject "GenerateRecallPlayGroupingApiTokenResponse"
              (\ o ->
                 GenerateRecallPlayGroupingApiTokenResponse Core.<$>
                   (o Core..:? "token"))

instance Core.ToJSON GenerateRecallPlayGroupingApiTokenResponse
         where
        toJSON GenerateRecallPlayGroupingApiTokenResponse{..}
          = Core.object (Core.catMaybes [("token" Core..=) Core.<$> token])
...
instance Core.FromJSON GetMultipleApplicationPlayerIdsResponse
         where
        parseJSON
          = Core.withObject "GetMultipleApplicationPlayerIdsResponse"
              (\ o ->
                 GetMultipleApplicationPlayerIdsResponse Core.<$>
                   (o Core..:? "playerIds"))

instance Core.ToJSON GetMultipleApplicationPlayerIdsResponse where
        toJSON GetMultipleApplicationPlayerIdsResponse{..}
          = Core.object
              (Core.catMaybes [("playerIds" Core..=) Core.<$> playerIds])
...
newImageAsset 
    ::  ImageAsset
newImageAsset
  = ImageAsset{height = Core.Nothing, kind = Core.Nothing,
               name = Core.Nothing, url = Core.Nothing, width = Core.Nothing}
instance Core.FromJSON ImageAsset where
        parseJSON
          = Core.withObject "ImageAsset"
              (\ o ->
                 ImageAsset Core.<$>
                   (o Core..:? "height") Core.<*> (o Core..:? "kind") Core.<*>
                     (o Core..:? "name")
                     Core.<*> (o Core..:? "url")
                     Core.<*> (o Core..:? "width"))
          ...
          = Core.object
              (Core.catMaybes
                 [("height" Core..=) Core.<$> height,
                  ("kind" Core..=) Core.<$> kind, ("name" Core..=) Core.<$> name,
                  ("url" Core..=) Core.<$> url, ("width" Core..=) Core.<$> width])
...
newInstance 
    ::  Instance
newInstance
  = Instance{acquisitionUri = Core.Nothing,
             androidInstance = Core.Nothing, iosInstance = Core.Nothing,
             kind = Core.Nothing, name = Core.Nothing,
             platformType = Core.Nothing, realtimePlay = Core.Nothing,
             turnBasedPlay = Core.Nothing, webInstance = Core.Nothing}
...
newInstanceAndroidDetails 
    ::  InstanceAndroidDetails
newInstanceAndroidDetails
  = InstanceAndroidDetails{enablePiracyCheck = Core.Nothing,
                           kind = Core.Nothing, packageName = Core.Nothing,
          ...
          = Core.withObject "InstanceAndroidDetails"
              (\ o ->
                 InstanceAndroidDetails Core.<$>
                   (o Core..:? "enablePiracyCheck") Core.<*> (o Core..:? "kind")
...
instance Core.ToJSON InstanceAndroidDetails where
        toJSON InstanceAndroidDetails{..}
          = Core.object
              (Core.catMaybes
                 [("enablePiracyCheck" Core..=) Core.<$> enablePiracyCheck,
                  ("kind" Core..=) Core.<$> kind,
...
newInstanceIosDetails 
    ::  InstanceIosDetails
newInstanceIosDetails
  = InstanceIosDetails{bundleIdentifier = Core.Nothing,
                       itunesAppId = Core.Nothing, kind = Core.Nothing,
                       preferredForIpad = Core.Nothing, preferredForIphone = Core.Nothing,
                       supportIpad = Core.Nothing, supportIphone = Core.Nothing}
instance Core.FromJSON InstanceIosDetails where
        parseJSON
          = Core.withObject "InstanceIosDetails"
              (\ o ->
                 InstanceIosDetails Core.<$>
                   (o Core..:? "bundleIdentifier") Core.<*> (o Core..:? "itunesAppId")
                     Core.<*> (o Core..:? "kind")
...
instance Core.ToJSON InstanceIosDetails where
        toJSON InstanceIosDetails{..}
          = Core.object
              (Core.catMaybes
                 [("bundleIdentifier" Core..=) Core.<$> bundleIdentifier,
                  ("itunesAppId" Core..=) Core.<$> itunesAppId,
                  ("kind" Core..=) Core.<$> kind,
                  ("preferredForIpad" Core..=) Core.<$> preferredForIpad,
                  ("preferredForIphone" Core..=) Core.<$> preferredForIphone,
...
newInstanceWebDetails 
    ::  InstanceWebDetails
newInstanceWebDetails
  = InstanceWebDetails{kind = Core.Nothing, launchUrl = Core.Nothing,
                       preferred = Core.Nothing}
          ...
          = Core.withObject "InstanceWebDetails"
              (\ o ->
                 InstanceWebDetails Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "launchUrl") Core.<*>
                     (o Core..:? "preferred"))
...
newLeaderboard 
    ::  Leaderboard
newLeaderboard
  = Leaderboard{iconUrl = Core.Nothing, id = Core.Nothing,
                isIconUrlDefault = Core.Nothing, kind = Core.Nothing,
                name = Core.Nothing, order = Core.Nothing}
instance Core.FromJSON Leaderboard where
        parseJSON
          = Core.withObject "Leaderboard"
              (\ o ->
                 Leaderboard Core.<$>
                   (o Core..:? "iconUrl") Core.<*> (o Core..:? "id") Core.<*>
                     (o Core..:? "isIconUrlDefault")
                     Core.<*> (o Core..:? "kind")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "order"))
...
instance Core.ToJSON Leaderboard where
        toJSON Leaderboard{..}
          = Core.object
              (Core.catMaybes
                 [("iconUrl" Core..=) Core.<$> iconUrl, ("id" Core..=) Core.<$> id,
                  ("isIconUrlDefault" Core..=) Core.<$> isIconUrlDefault,
                  ("kind" Core..=) Core.<$> kind, ("name" Core..=) Core.<$> name,
...
newLeaderboardEntry 
    ::  LeaderboardEntry
newLeaderboardEntry
  = LeaderboardEntry{formattedScore = Core.Nothing,
                     formattedScoreRank = Core.Nothing, kind = Core.Nothing,
                     player = Core.Nothing, scoreRank = Core.Nothing,
                     scoreTag = Core.Nothing, scoreValue = Core.Nothing,
                     timeSpan = Core.Nothing, writeTimestampMillis = Core.Nothing}
              ...
              (\ o ->
                 LeaderboardEntry Core.<$>
                   (o Core..:? "formattedScore") Core.<*>
                     ...
                     Core.<*> (o Core..:? "player")
                     Core.<*>
                     (o Core..:? "scoreRank" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "scoreTag")
                     Core.<*>
                     (o Core..:? "scoreValue" Core.<&> Core.fmap Core.fromAsText)
          ...
          = Core.object
              (Core.catMaybes
                 [("formattedScore" Core..=) Core.<$> formattedScore,
                  ("formattedScoreRank" Core..=) Core.<$> formattedScoreRank,
                  ("kind" Core..=) Core.<$> kind, ("player" Core..=) Core.<$> player,
                  ("scoreRank" Core..=) Core.. Core.AsText Core.<$> scoreRank,
                  ("scoreTag" Core..=) Core.<$> scoreTag,
                  ("scoreValue" Core..=) Core.. Core.AsText Core.<$> scoreValue,
                  ("timeSpan" Core..=) Core.<$> timeSpan,
                  ("writeTimestampMillis" Core..=) Core.. Core.AsText Core.<$>
...
newLeaderboardListResponse 
    ::  LeaderboardListResponse
newLeaderboardListResponse
  = LeaderboardListResponse{items = Core.Nothing,
                            kind = Core.Nothing, nextPageToken = Core.Nothing}
...
newLeaderboardScoreRank 
    ::  LeaderboardScoreRank
newLeaderboardScoreRank
  = LeaderboardScoreRank{formattedNumScores = Core.Nothing,
                         formattedRank = Core.Nothing, kind = Core.Nothing,
                         numScores = Core.Nothing, rank = Core.Nothing}
              ...
              (\ o ->
                 LeaderboardScoreRank Core.<$>
                   (o Core..:? "formattedNumScores") Core.<*>
                     ...
                     Core.<*> (o Core..:? "kind")
                     Core.<*>
                     (o Core..:? "numScores" Core.<&> Core.fmap Core.fromAsText)
...
instance Core.ToJSON LeaderboardScoreRank where
        toJSON LeaderboardScoreRank{..}
          = Core.object
              (Core.catMaybes
                 [("formattedNumScores" Core..=) Core.<$> formattedNumScores,
                  ("formattedRank" Core..=) Core.<$> formattedRank,
                  ("kind" Core..=) Core.<$> kind,
                  ("numScores" Core..=) Core.. Core.AsText Core.<$> numScores,
...
newLeaderboardScores 
    ::  LeaderboardScores
newLeaderboardScores
  = LeaderboardScores{items = Core.Nothing, kind = Core.Nothing,
                      nextPageToken = Core.Nothing, numScores = Core.Nothing,
                      playerScore = Core.Nothing, prevPageToken = Core.Nothing}
...
--
-- /See:/ 'newLinkPersonaRequest' smart constructor.
data LinkPersonaRequest = LinkPersonaRequest
    {
      -- | Required. Cardinality constraint to observe when linking a persona to a player in the scope of a game.
      cardinalityConstraint :: (Core.Maybe LinkPersonaRequest_CardinalityConstraint)
    ...
    , conflictingLinksResolutionPolicy :: (Core.Maybe LinkPersonaRequest_ConflictingLinksResolutionPolicy)
...
-- | Creates a value of 'LinkPersonaRequest' with the minimum fields required to make a request.
newLinkPersonaRequest 
    ::  LinkPersonaRequest
newLinkPersonaRequest
  = LinkPersonaRequest{cardinalityConstraint = Core.Nothing,
                       conflictingLinksResolutionPolicy = Core.Nothing,
                       expireTime = Core.Nothing, persona = Core.Nothing,
                       sessionId = Core.Nothing, token = Core.Nothing, ttl = Core.Nothing}
instance Core.FromJSON LinkPersonaRequest where
        parseJSON
          = Core.withObject "LinkPersonaRequest"
              (\ o ->
                 LinkPersonaRequest Core.<$>
                   (o Core..:? "cardinalityConstraint") Core.<*>
                     (o Core..:? "conflictingLinksResolutionPolicy")
...
instance Core.ToJSON LinkPersonaRequest where
        toJSON LinkPersonaRequest{..}
          = Core.object
              (Core.catMaybes
                 [("cardinalityConstraint" Core..=) Core.<$> cardinalityConstraint,
                  ("conflictingLinksResolutionPolicy" Core..=) Core.<$>
                    conflictingLinksResolutionPolicy,
                  ("expireTime" Core..=) Core.<$> expireTime,
                  ("persona" Core..=) Core.<$> persona,
                  ("sessionId" Core..=) Core.<$> sessionId,
                  ("token" Core..=) Core.<$> token, ("ttl" Core..=) Core.<$> ttl])


-- | Outcome of a persona linking attempt.
--
-- /See:/ 'newLinkPersonaResponse' smart constructor.
newtype LinkPersonaResponse = LinkPersonaResponse
    {
      -- | Output only. State of a persona linking attempt.
      state :: (Core.Maybe LinkPersonaResponse_State)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'LinkPersonaResponse' with the minimum fields required to make a request.
newLinkPersonaResponse 
    ::  LinkPersonaResponse
newLinkPersonaResponse = LinkPersonaResponse{state = Core.Nothing}
instance Core.FromJSON LinkPersonaResponse where
        parseJSON
          = Core.withObject "LinkPersonaResponse"
              (\ o -> LinkPersonaResponse Core.<$> (o Core..:? "state"))

instance Core.ToJSON LinkPersonaResponse where
        toJSON LinkPersonaResponse{..}
...
newMetagameConfig 
    ::  MetagameConfig
newMetagameConfig
  = MetagameConfig{currentVersion = Core.Nothing,
                   kind = Core.Nothing, playerLevels = Core.Nothing}
instance Core.FromJSON MetagameConfig where
        parseJSON
          = Core.withObject "MetagameConfig"
              (\ o ->
                 MetagameConfig Core.<$>
                   (o Core..:? "currentVersion") Core.<*> (o Core..:? "kind") Core.<*>
                     (o Core..:? "playerLevels"))
...
--
-- /See:/ 'newPlayGroupingApiToken' smart constructor.
newtype PlayGroupingApiToken = PlayGroupingApiToken
    {
      -- | Value of the token.
...
-- | Creates a value of 'PlayGroupingApiToken' with the minimum fields required to make a request.
newPlayGroupingApiToken 
    ::  PlayGroupingApiToken
newPlayGroupingApiToken
  = PlayGroupingApiToken{tokenValue = Core.Nothing}
instance Core.FromJSON PlayGroupingApiToken where
        parseJSON
          = Core.withObject "PlayGroupingApiToken"
              (\ o -> PlayGroupingApiToken Core.<$> (o Core..:? "tokenValue"))

instance Core.ToJSON PlayGroupingApiToken where
        toJSON PlayGroupingApiToken{..}
          = Core.object
              (Core.catMaybes [("tokenValue" Core..=) Core.<$> tokenValue])
...
newPlayer 
    ::  Player
newPlayer
  = Player{avatarImageUrl = Core.Nothing,
           bannerUrlLandscape = Core.Nothing,
           bannerUrlPortrait = Core.Nothing, displayName = Core.Nothing,
           experienceInfo = Core.Nothing, friendStatus = Core.Nothing,
           gamePlayerId = Core.Nothing, kind = Core.Nothing,
           name = Core.Nothing, originalPlayerId = Core.Nothing,
           playerId = Core.Nothing, profileSettings = Core.Nothing,
           title = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("avatarImageUrl" Core..=) Core.<$> avatarImageUrl,
                  ("bannerUrlLandscape" Core..=) Core.<$> bannerUrlLandscape,
                  ("bannerUrlPortrait" Core..=) Core.<$> bannerUrlPortrait,
                  ("displayName" Core..=) Core.<$> displayName,
                  ("experienceInfo" Core..=) Core.<$> experienceInfo,
                  ("friendStatus" Core..=) Core.<$> friendStatus,
                  ("gamePlayerId" Core..=) Core.<$> gamePlayerId,
                  ("kind" Core..=) Core.<$> kind, ("name" Core..=) Core.<$> name,
                  ("originalPlayerId" Core..=) Core.<$> originalPlayerId,
                  ("playerId" Core..=) Core.<$> playerId,
...
instance Core.FromJSON Player_Name where
        parseJSON
          = Core.withObject "Player_Name"
              (\ o ->
                 Player_Name Core.<$>
                   (o Core..:? "familyName") Core.<*> (o Core..:? "givenName"))
...
newPlayerAchievement 
    ::  PlayerAchievement
newPlayerAchievement
  = PlayerAchievement{achievementState = Core.Nothing,
                      currentSteps = Core.Nothing, experiencePoints = Core.Nothing,
                      formattedCurrentStepsString = Core.Nothing, id = Core.Nothing,
                      kind = Core.Nothing, lastUpdatedTimestamp = Core.Nothing}
...
instance Core.ToJSON PlayerAchievement where
        toJSON PlayerAchievement{..}
          = Core.object
              (Core.catMaybes
                 [("achievementState" Core..=) Core.<$> achievementState,
                  ("currentSteps" Core..=) Core.<$> currentSteps,
                  ("experiencePoints" Core..=) Core.. Core.AsText Core.<$>
                    experiencePoints,
...
newPlayerAchievementListResponse 
    ::  PlayerAchievementListResponse
newPlayerAchievementListResponse
  = PlayerAchievementListResponse{items = Core.Nothing,
                                  kind = Core.Nothing, nextPageToken = Core.Nothing}
...
newPlayerEvent 
    ::  PlayerEvent
newPlayerEvent
  = PlayerEvent{definitionId = Core.Nothing,
                formattedNumEvents = Core.Nothing, kind = Core.Nothing,
                numEvents = Core.Nothing, playerId = Core.Nothing}
              ...
              (\ o ->
                 PlayerEvent Core.<$>
                   (o Core..:? "definitionId") Core.<*>
                     ...
                     Core.<*> (o Core..:? "kind")
                     Core.<*>
                     (o Core..:? "numEvents" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "playerId"))
...
instance Core.ToJSON PlayerEvent where
        toJSON PlayerEvent{..}
          = Core.object
              (Core.catMaybes
                 [("definitionId" Core..=) Core.<$> definitionId,
                  ("formattedNumEvents" Core..=) Core.<$> formattedNumEvents,
                  ("kind" Core..=) Core.<$> kind,
                  ("numEvents" Core..=) Core.. Core.AsText Core.<$> numEvents,
                  ("playerId" Core..=) Core.<$> playerId])
...
newPlayerEventListResponse 
    ::  PlayerEventListResponse
newPlayerEventListResponse
  = PlayerEventListResponse{items = Core.Nothing,
                            kind = Core.Nothing, nextPageToken = Core.Nothing}
...
newPlayerExperienceInfo 
    ::  PlayerExperienceInfo
newPlayerExperienceInfo
  = PlayerExperienceInfo{currentExperiencePoints = Core.Nothing,
                         currentLevel = Core.Nothing, kind = Core.Nothing,
...
instance Core.ToJSON PlayerExperienceInfo where
        toJSON PlayerExperienceInfo{..}
          = Core.object
              (Core.catMaybes
                 [("currentExperiencePoints" Core..=) Core.. Core.AsText Core.<$>
                    currentExperiencePoints,
                  ("currentLevel" Core..=) Core.<$> currentLevel,
                  ("kind" Core..=) Core.<$> kind,
                  ("lastLevelUpTimestampMillis" Core..=) Core.. Core.AsText Core.<$>
...
newPlayerLeaderboardScore 
    ::  PlayerLeaderboardScore
newPlayerLeaderboardScore
  = PlayerLeaderboardScore{friendsRank = Core.Nothing,
                           kind = Core.Nothing, leaderboardId = Core.Nothing,
                           publicRank = Core.Nothing, scoreString = Core.Nothing,
                           scoreTag = Core.Nothing, scoreValue = Core.Nothing,
                           socialRank = Core.Nothing, timeSpan = Core.Nothing,
          ...
          = Core.withObject "PlayerLeaderboardScore"
              (\ o ->
                 PlayerLeaderboardScore Core.<$>
                   (o Core..:? "friendsRank") Core.<*> (o Core..:? "kind") Core.<*>
                     (o Core..:? "leaderboard_id")
                     ...
                     Core.<*> (o Core..:? "timeSpan")
                     Core.<*>
                     (o Core..:? "writeTimestamp" Core.<&> Core.fmap Core.fromAsText))
          ...
          = Core.object
              (Core.catMaybes
                 [("friendsRank" Core..=) Core.<$> friendsRank,
                  ...
                  ("timeSpan" Core..=) Core.<$> timeSpan,
                  ("writeTimestamp" Core..=) Core.. Core.AsText Core.<$>
                    writeTimestamp])
...
newPlayerLeaderboardScoreListResponse 
    :: 
                                      PlayerLeaderboardScoreListResponse
newPlayerLeaderboardScoreListResponse
  = PlayerLeaderboardScoreListResponse{items = Core.Nothing,
                                       kind = Core.Nothing, nextPageToken = Core.Nothing,
                                       player = Core.Nothing}
instance Core.FromJSON PlayerLeaderboardScoreListResponse where
        parseJSON
          = Core.withObject "PlayerLeaderboardScoreListResponse"
              (\ o ->
...
instance Core.ToJSON PlayerLeaderboardScoreListResponse where
...
newPlayerLevel 
    ::  PlayerLevel
newPlayerLevel
  = PlayerLevel{kind = Core.Nothing, level = Core.Nothing,
...
instance Core.FromJSON PlayerLevel where
        parseJSON
          = Core.withObject "PlayerLevel"
              (\ o ->
                 PlayerLevel Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "level") Core.<*>
          ...
          = Core.object
              (Core.catMaybes
                 [("kind" Core..=) Core.<$> kind, ("level" Core..=) Core.<$> level,
                  ("maxExperiencePoints" Core..=) Core.. Core.AsText Core.<$>
                    maxExperiencePoints,
                  ("minExperiencePoints" Core..=) Core.. Core.AsText Core.<$>
                    minExperiencePoints])
...
newPlayerListResponse 
    ::  PlayerListResponse
newPlayerListResponse
  = PlayerListResponse{items = Core.Nothing, kind = Core.Nothing,
                       nextPageToken = Core.Nothing}
...
newPlayerScore 
    ::  PlayerScore
newPlayerScore
  = PlayerScore{formattedScore = Core.Nothing, kind = Core.Nothing,
                score = Core.Nothing, scoreTag = Core.Nothing,
...
instance Core.FromJSON PlayerScore where
        parseJSON
          = Core.withObject "PlayerScore"
              (\ o ->
                 PlayerScore Core.<$>
                   (o Core..:? "formattedScore") Core.<*> (o Core..:? "kind") Core.<*>
                     (o Core..:? "score" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "scoreTag")
                     Core.<*> (o Core..:? "timeSpan"))
...
instance Core.ToJSON PlayerScoreListResponse where
        toJSON PlayerScoreListResponse{..}
          = Core.object
              (Core.catMaybes
                 [("kind" Core..=) Core.<$> kind,
                  ("submittedScores" Core..=) Core.<$> submittedScores])
...
newPlayerScoreResponse 
    ::  PlayerScoreResponse
newPlayerScoreResponse
  = PlayerScoreResponse{beatenScoreTimeSpans = Core.Nothing,
                        formattedScore = Core.Nothing, kind = Core.Nothing,
                        leaderboardId = Core.Nothing, scoreTag = Core.Nothing,
...
instance Core.ToJSON PlayerScoreResponse where
        toJSON PlayerScoreResponse{..}
          = Core.object
              (Core.catMaybes
                 [("beatenScoreTimeSpans" Core..=) Core.<$> beatenScoreTimeSpans,
                  ("formattedScore" Core..=) Core.<$> formattedScore,
                  ("kind" Core..=) Core.<$> kind,
...
newPlayerScoreSubmissionList 
    ::  PlayerScoreSubmissionList
newPlayerScoreSubmissionList
  = PlayerScoreSubmissionList{kind = Core.Nothing,
                              scores = Core.Nothing}
...
newProfileSettings 
    ::  ProfileSettings
newProfileSettings
  = ProfileSettings{friendsListVisibility = Core.Nothing,
                    kind = Core.Nothing, profileVisible = Core.Nothing}
instance Core.FromJSON ProfileSettings where
        parseJSON
          = Core.withObject "ProfileSettings"
              (\ o ->
                 ProfileSettings Core.<$>
                   (o Core..:? "friendsListVisibility") Core.<*> (o Core..:? "kind")
...
instance Core.ToJSON ProfileSettings where
        toJSON ProfileSettings{..}
          = Core.object
              (Core.catMaybes
                 [("friendsListVisibility" Core..=) Core.<$> friendsListVisibility,
                  ("kind" Core..=) Core.<$> kind,
...
--
-- /See:/ 'newRecallToken' smart constructor.
data RecallToken = RecallToken
    {
    ...
    , multiPlayerPersona :: (Core.Maybe Core.Bool)
      -- | Required. Value of the Recall token as it is provided by the client via LinkPersona RPC
    , token :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'RecallToken' with the minimum fields required to make a request.
newRecallToken 
    ::  RecallToken
newRecallToken
  = RecallToken{expireTime = Core.Nothing,
                multiPlayerPersona = Core.Nothing, token = Core.Nothing}
instance Core.FromJSON RecallToken where
        parseJSON
          = Core.withObject "RecallToken"
              (\ o ->
                 RecallToken Core.<$>
                   (o Core..:? "expireTime") Core.<*>
                     (o Core..:? "multiPlayerPersona")
                     Core.<*> (o Core..:? "token"))

instance Core.ToJSON RecallToken where
        toJSON RecallToken{..}
          = Core.object
              (Core.catMaybes
                 [("expireTime" Core..=) Core.<$> expireTime,
                  ("multiPlayerPersona" Core..=) Core.<$> multiPlayerPersona,
                  ("token" Core..=) Core.<$> token])


-- | Request to remove all Recall tokens associated with a persona for an app.
--
-- /See:/ 'newResetPersonaRequest' smart constructor.
newtype ResetPersonaRequest = ResetPersonaRequest
    {
...
-- | Creates a value of 'ResetPersonaRequest' with the minimum fields required to make a request.
newResetPersonaRequest 
    ::  ResetPersonaRequest
newResetPersonaRequest
  = ResetPersonaRequest{persona = Core.Nothing}
instance Core.FromJSON ResetPersonaRequest where
        parseJSON
          = Core.withObject "ResetPersonaRequest"
              (\ o -> ResetPersonaRequest Core.<$> (o Core..:? "persona"))

instance Core.ToJSON ResetPersonaRequest where
        toJSON ResetPersonaRequest{..}
          = Core.object
              (Core.catMaybes [("persona" Core..=) Core.<$> persona])


-- | Response for the ResetPersona RPC
--
-- /See:/ 'newResetPersonaResponse' smart constructor.
newtype ResetPersonaResponse = ResetPersonaResponse
    {
      -- | Required. Whether any tokens were unlinked as a result of this request.
      unlinked :: (Core.Maybe Core.Bool)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'ResetPersonaResponse' with the minimum fields required to make a request.
newResetPersonaResponse 
    ::  ResetPersonaResponse
newResetPersonaResponse
  = ResetPersonaResponse{unlinked = Core.Nothing}
instance Core.FromJSON ResetPersonaResponse where
        parseJSON
          = Core.withObject "ResetPersonaResponse"
              (\ o -> ResetPersonaResponse Core.<$> (o Core..:? "unlinked"))

instance Core.ToJSON ResetPersonaResponse where
        toJSON ResetPersonaResponse{..}
          = Core.object
              (Core.catMaybes [("unlinked" Core..=) Core.<$> unlinked])


-- | Recall token data returned from for the RetrieveDeveloperGamesLastPlayerToken RPC
--
-- /See:/ 'newRetrieveDeveloperGamesLastPlayerTokenResponse' smart constructor.
newtype RetrieveDeveloperGamesLastPlayerTokenResponse = RetrieveDeveloperGamesLastPlayerTokenResponse
    {
      ...
      gamePlayerToken :: (Core.Maybe GamePlayerToken)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newRetrieveDeveloperGamesLastPlayerTokenResponse 
    :: 
                                                 RetrieveDeveloperGamesLastPlayerTokenResponse
newRetrieveDeveloperGamesLastPlayerTokenResponse
  = RetrieveDeveloperGamesLastPlayerTokenResponse{gamePlayerToken =
                                                    Core.Nothing}
instance Core.FromJSON
           RetrieveDeveloperGamesLastPlayerTokenResponse
         where
        parseJSON
          = Core.withObject "RetrieveDeveloperGamesLastPlayerTokenResponse"
              (\ o ->
                 RetrieveDeveloperGamesLastPlayerTokenResponse Core.<$>
                   (o Core..:? "gamePlayerToken"))

instance Core.ToJSON RetrieveDeveloperGamesLastPlayerTokenResponse
         where
        toJSON RetrieveDeveloperGamesLastPlayerTokenResponse{..}
          = Core.object
              (Core.catMaybes
                 [("gamePlayerToken" Core..=) Core.<$> gamePlayerToken])


-- | A list of recall token data returned from the RetrieveGamesPlayerTokens RPC
--
-- /See:/ 'newRetrieveGamesPlayerTokensResponse' smart constructor.
newtype RetrieveGamesPlayerTokensResponse = RetrieveGamesPlayerTokensResponse
    {
      ...
      gamePlayerTokens :: (Core.Maybe [GamePlayerToken])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'RetrieveGamesPlayerTokensResponse' with the minimum fields required to make a request.
newRetrieveGamesPlayerTokensResponse 
    :: 
                                     RetrieveGamesPlayerTokensResponse
newRetrieveGamesPlayerTokensResponse
  = RetrieveGamesPlayerTokensResponse{gamePlayerTokens =
                                        Core.Nothing}
instance Core.FromJSON RetrieveGamesPlayerTokensResponse where
        parseJSON
          = Core.withObject "RetrieveGamesPlayerTokensResponse"
              (\ o ->
                 RetrieveGamesPlayerTokensResponse Core.<$>
                   (o Core..:? "gamePlayerTokens"))

instance Core.ToJSON RetrieveGamesPlayerTokensResponse where
        toJSON RetrieveGamesPlayerTokensResponse{..}
          = Core.object
              (Core.catMaybes
                 [("gamePlayerTokens" Core..=) Core.<$> gamePlayerTokens])


-- | Response for the RetrievePlayerTokens RPC
--
-- /See:/ 'newRetrievePlayerTokensResponse' smart constructor.
newtype RetrievePlayerTokensResponse = RetrievePlayerTokensResponse
    {
      -- | Required. Recall tokens associated with the requested PGS Player principal
      tokens :: (Core.Maybe [RecallToken])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'RetrievePlayerTokensResponse' with the minimum fields required to make a request.
newRetrievePlayerTokensResponse 
    ::  RetrievePlayerTokensResponse
newRetrievePlayerTokensResponse
  = RetrievePlayerTokensResponse{tokens = Core.Nothing}
instance Core.FromJSON RetrievePlayerTokensResponse where
        parseJSON
          = Core.withObject "RetrievePlayerTokensResponse"
              (\ o ->
                 RetrievePlayerTokensResponse Core.<$> (o Core..:? "tokens"))

instance Core.ToJSON RetrievePlayerTokensResponse where
        toJSON RetrievePlayerTokensResponse{..}
          = Core.object (Core.catMaybes [("tokens" Core..=) Core.<$> tokens])
...
newRevisionCheckResponse 
    ::  RevisionCheckResponse
newRevisionCheckResponse
  = RevisionCheckResponse{apiVersion = Core.Nothing,
                          kind = Core.Nothing, revisionStatus = Core.Nothing}
instance Core.FromJSON RevisionCheckResponse where
        parseJSON
          = Core.withObject "RevisionCheckResponse"
              (\ o ->
                 RevisionCheckResponse Core.<$>
                   (o Core..:? "apiVersion") Core.<*> (o Core..:? "kind") Core.<*>
                     (o Core..:? "revisionStatus"))
...
newScopedPlayerIds 
    ::  ScopedPlayerIds
newScopedPlayerIds
  = ScopedPlayerIds{developerPlayerKey = Core.Nothing,
...
instance Core.ToJSON ScopedPlayerIds where
        toJSON ScopedPlayerIds{..}
          = Core.object
              (Core.catMaybes
                 [("developerPlayerKey" Core..=) Core.<$> developerPlayerKey,
                  ("gamePlayerId" Core..=) Core.<$> gamePlayerId])
...
newScoreSubmission 
    ::  ScoreSubmission
newScoreSubmission
  = ScoreSubmission{kind = Core.Nothing,
                    leaderboardId = Core.Nothing, score = Core.Nothing,
                    scoreTag = Core.Nothing, signature = Core.Nothing}
instance Core.FromJSON ScoreSubmission where
        parseJSON
          = Core.withObject "ScoreSubmission"
              (\ o ->
                 ScoreSubmission Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "leaderboardId") Core.<*>
                     (o Core..:? "score" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "scoreTag")
...
newSnapshot 
    ::  Snapshot
newSnapshot
  = Snapshot{coverImage = Core.Nothing, description = Core.Nothing,
             driveId = Core.Nothing, durationMillis = Core.Nothing,
             id = Core.Nothing, kind = Core.Nothing,
             lastModifiedMillis = Core.Nothing, progressValue = Core.Nothing,
...
instance Core.FromJSON Snapshot where
        parseJSON
          = Core.withObject "Snapshot"
              (\ o ->
                 Snapshot Core.<$>
                   (o Core..:? "coverImage") Core.<*> (o Core..:? "description")
                     Core.<*> (o Core..:? "driveId")
                     Core.<*>
                     ...
                     (o Core..:? "lastModifiedMillis" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "progressValue" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "title")
                     Core.<*> (o Core..:? "type")
              ...
              (Core.catMaybes
                 [("coverImage" Core..=) Core.<$> coverImage,
                  ...
                  ("durationMillis" Core..=) Core.. Core.AsText Core.<$>
                    durationMillis,
                  ("id" Core..=) Core.<$> id, ("kind" Core..=) Core.<$> kind,
                  ("lastModifiedMillis" Core..=) Core.. Core.AsText Core.<$>
                    lastModifiedMillis,
...
newSnapshotImage 
    ::  SnapshotImage
newSnapshotImage
  = SnapshotImage{height = Core.Nothing, kind = Core.Nothing,
                  mimeType = Core.Nothing, url = Core.Nothing, width = Core.Nothing}
...
newSnapshotListResponse 
    ::  SnapshotListResponse
newSnapshotListResponse
  = SnapshotListResponse{items = Core.Nothing, kind = Core.Nothing,
                         nextPageToken = Core.Nothing}
...
newStatsResponse 
    ::  StatsResponse
newStatsResponse
  = StatsResponse{avgSessionLengthMinutes = Core.Nothing,
                  churnProbability = Core.Nothing,
                  daysSinceLastPlayed = Core.Nothing,
                  highSpenderProbability = Core.Nothing, kind = Core.Nothing,
                  numPurchases = Core.Nothing, numSessions = Core.Nothing,
                  numSessionsPercentile = Core.Nothing,
                  spendPercentile = Core.Nothing, spendProbability = Core.Nothing,
          ...
          = Core.object
              (Core.catMaybes
                 [("avg_session_length_minutes" Core..=) Core.<$>
                  ...
                  ("churn_probability" Core..=) Core.<$> churnProbability,
                  ("days_since_last_played" Core..=) Core.<$> daysSinceLastPlayed,
                  ("high_spender_probability" Core..=) Core.<$>
                    highSpenderProbability,
                  ("kind" Core..=) Core.<$> kind,
                  ("num_purchases" Core..=) Core.<$> numPurchases,
                  ("num_sessions" Core..=) Core.<$> numSessions,
                  ("num_sessions_percentile" Core..=) Core.<$> numSessionsPercentile,
                  ("spend_percentile" Core..=) Core.<$> spendPercentile,
                  ("spend_probability" Core..=) Core.<$> spendProbability,
...
--
-- /See:/ 'newUnlinkPersonaRequest' smart constructor.
data UnlinkPersonaRequest = UnlinkPersonaRequest
    {
      -- | Value of the \'persona\' field as it was provided by the client in LinkPersona RPC
      persona :: (Core.Maybe Core.Text)
      -- | Required. Opaque server-generated string that encodes all the necessary information to identify the PGS player \/ Google user and application.
...
-- | Creates a value of 'UnlinkPersonaRequest' with the minimum fields required to make a request.
newUnlinkPersonaRequest 
    ::  UnlinkPersonaRequest
newUnlinkPersonaRequest
  = UnlinkPersonaRequest{persona = Core.Nothing,
                         sessionId = Core.Nothing, token = Core.Nothing}
instance Core.FromJSON UnlinkPersonaRequest where
        parseJSON
          = Core.withObject "UnlinkPersonaRequest"
              (\ o ->
                 UnlinkPersonaRequest Core.<$>
                   (o Core..:? "persona") Core.<*> (o Core..:? "sessionId") Core.<*>
                     (o Core..:? "token"))

instance Core.ToJSON UnlinkPersonaRequest where
        toJSON UnlinkPersonaRequest{..}
          = Core.object
              (Core.catMaybes
                 [("persona" Core..=) Core.<$> persona,
                  ("sessionId" Core..=) Core.<$> sessionId,
...
--
-- /See:/ 'newUnlinkPersonaResponse' smart constructor.
newtype UnlinkPersonaResponse = UnlinkPersonaResponse
    {
...
-- | Creates a value of 'UnlinkPersonaResponse' with the minimum fields required to make a request.
newUnlinkPersonaResponse 
    ::  UnlinkPersonaResponse
newUnlinkPersonaResponse
  = UnlinkPersonaResponse{unlinked = Core.Nothing}
instance Core.FromJSON UnlinkPersonaResponse where
        parseJSON
          = Core.withObject "UnlinkPersonaResponse"
              (\ o -> UnlinkPersonaResponse Core.<$> (o Core..:? "unlinked"))

instance Core.ToJSON UnlinkPersonaResponse where
        toJSON UnlinkPersonaResponse{..}
          = Core.object
              (Core.catMaybes [("unlinked" Core..=) Core.<$> unlinked])
