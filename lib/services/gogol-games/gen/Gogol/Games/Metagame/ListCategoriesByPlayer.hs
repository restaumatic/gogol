...
--
-- /See:/ <https://developers.google.com/games/ Google Play Games Services API Reference> for @games.metagame.listCategoriesByPlayer@.
module Gogol.Games.Metagame.ListCategoriesByPlayer
    (
    -- * Resource
       ...
       "v1" Core.:>
         "players" Core.:>
           Core.Capture "playerId" Core.Text Core.:>
             "categories" Core.:>
               Core.Capture "collection" MetagameListCategoriesByPlayerCollection
                 Core.:>
                             ...
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.Get '[Core.JSON] CategoryListResponse
...
newGamesMetagameListCategoriesByPlayer collection playerId
  = GamesMetagameListCategoriesByPlayer{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        collection = collection, language = Core.Nothing,
                                        maxResults = Core.Nothing, pageToken = Core.Nothing,
                                        playerId = playerId, uploadType = Core.Nothing,
                                        uploadProtocol = Core.Nothing}
instance Core.GoogleRequest GamesMetagameListCategoriesByPlayer
         where
        type Rs GamesMetagameListCategoriesByPlayer = CategoryListResponse
        type Scopes GamesMetagameListCategoriesByPlayer =
             '[Games'FullControl]
        requestClient GamesMetagameListCategoriesByPlayer{..}
          = go playerId collection xgafv accessToken callback language
              maxResults
              pageToken
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy GamesMetagameListCategoriesByPlayerResource)
                      Core.mempty
