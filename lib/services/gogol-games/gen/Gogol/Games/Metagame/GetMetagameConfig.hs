...
--
-- /See:/ <https://developers.google.com/games/ Google Play Games Services API Reference> for @games.metagame.getMetagameConfig@.
module Gogol.Games.Metagame.GetMetagameConfig
    (
    -- * Resource
...
newGamesMetagameGetMetagameConfig 
    ::  GamesMetagameGetMetagameConfig
newGamesMetagameGetMetagameConfig
  = GamesMetagameGetMetagameConfig{xgafv = Core.Nothing,
                                   accessToken = Core.Nothing, callback = Core.Nothing,
                                   uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest GamesMetagameGetMetagameConfig where
        type Rs GamesMetagameGetMetagameConfig = MetagameConfig
        type Scopes GamesMetagameGetMetagameConfig = '[Games'FullControl]
        requestClient GamesMetagameGetMetagameConfig{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy GamesMetagameGetMetagameConfigResource)
                      Core.mempty
