...
-- | Default request referring to version @v1@ of the Google Play Games Services API. This contains the host and root path used as a starting point for constructing service requests.
