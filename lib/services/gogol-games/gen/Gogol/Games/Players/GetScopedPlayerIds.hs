...
--
-- /See:/ <https://developers.google.com/games/ Google Play Games Services API Reference> for @games.players.getScopedPlayerIds@.
module Gogol.Games.Players.GetScopedPlayerIds
    (
    -- * Resource
...
newGamesPlayersGetScopedPlayerIds 
    ::  GamesPlayersGetScopedPlayerIds
newGamesPlayersGetScopedPlayerIds
  = GamesPlayersGetScopedPlayerIds{xgafv = Core.Nothing,
