...
--
-- /See:/ <https://developers.google.com/games/ Google Play Games Services API Reference> for @games.players.list@.
module Gogol.Games.Players.List
    (
    -- * Resource
     ...
     "games" Core.:>
       "v1" Core.:>
         "players" Core.:>
           "me" Core.:>
             "players" Core.:>
               Core.Capture "collection" PlayersListCollection Core.:>
...
newGamesPlayersList collection
  = GamesPlayersList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest GamesPlayersList where
        ...
        requestClient GamesPlayersList{..}
          = go collection xgafv accessToken callback language maxResults
              pageToken
              uploadType
              uploadProtocol
