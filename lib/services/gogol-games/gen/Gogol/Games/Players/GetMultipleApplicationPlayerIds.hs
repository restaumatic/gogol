...
--
-- /See:/ <https://developers.google.com/games/ Google Play Games Services API Reference> for @games.players.getMultipleApplicationPlayerIds@.
module Gogol.Games.Players.GetMultipleApplicationPlayerIds
    (
    -- * Resource
...
type GamesPlayersGetMultipleApplicationPlayerIdsResource =
     "games" Core.:>
       "v1" Core.:>
         "players" Core.:>
           "me" Core.:>
             "multipleApplicationPlayerIds" Core.:>
               Core.QueryParam "$.xgafv" Xgafv Core.:>
                 Core.QueryParam "access_token" Core.Text Core.:>
                   Core.QueryParams "applicationIds" Core.Text Core.:>
                     Core.QueryParam "callback" Core.Text Core.:>
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] GetMultipleApplicationPlayerIdsResponse
...
newGamesPlayersGetMultipleApplicationPlayerIds 
    :: 
                                               GamesPlayersGetMultipleApplicationPlayerIds
newGamesPlayersGetMultipleApplicationPlayerIds
  = GamesPlayersGetMultipleApplicationPlayerIds{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           GamesPlayersGetMultipleApplicationPlayerIds
         where
        type Rs GamesPlayersGetMultipleApplicationPlayerIds =
             GetMultipleApplicationPlayerIdsResponse
        type Scopes GamesPlayersGetMultipleApplicationPlayerIds =
             '[Games'FullControl]
        requestClient GamesPlayersGetMultipleApplicationPlayerIds{..}
          = go xgafv accessToken (applicationIds Core.^. Core._Default)
              callback
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy GamesPlayersGetMultipleApplicationPlayerIdsResource)
                      Core.mempty
