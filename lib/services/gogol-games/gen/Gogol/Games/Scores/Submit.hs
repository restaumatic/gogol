...
--
-- /See:/ <https://developers.google.com/games/ Google Play Games Services API Reference> for @games.scores.submit@.
module Gogol.Games.Scores.Submit
    (
    -- * Resource
...
newGamesScoresSubmit leaderboardId score
  = GamesScoresSubmit{xgafv = Core.Nothing,
                      accessToken = Core.Nothing, callback = Core.Nothing,
                      language = Core.Nothing, leaderboardId = leaderboardId,
                      score = score, scoreTag = Core.Nothing, uploadType = Core.Nothing,
...
instance Core.GoogleRequest GamesScoresSubmit where
        ...
        requestClient GamesScoresSubmit{..}
          = go leaderboardId (Core.Just score) xgafv accessToken callback
              language
              scoreTag
              uploadType
              uploadProtocol
