...
--
-- /See:/ <https://developers.google.com/games/ Google Play Games Services API Reference> for @games.scores.list@.
module Gogol.Games.Scores.List
    (
    -- * Resource
       ...
       "v1" Core.:>
         "leaderboards" Core.:>
           Core.Capture "leaderboardId" Core.Text Core.:>
             "scores" Core.:>
               Core.Capture "collection" ScoresListCollection Core.:>
...
newGamesScoresList collection leaderboardId timeSpan
  = GamesScoresList{xgafv = Core.Nothing, accessToken = Core.Nothing,
                    callback = Core.Nothing, collection = collection,
                    language = Core.Nothing, leaderboardId = leaderboardId,
                    maxResults = Core.Nothing, pageToken = Core.Nothing,
                    timeSpan = timeSpan, uploadType = Core.Nothing,
