...
--
-- /See:/ <https://developers.google.com/games/ Google Play Games Services API Reference> for @games.scores.get@.
module Gogol.Games.Scores.Get
    (
    -- * Resource
           ...
           Core.Capture "playerId" Core.Text Core.:>
             "leaderboards" Core.:>
               Core.Capture "leaderboardId" Core.Text Core.:>
                 "scores" Core.:>
                   Core.Capture "timeSpan" ScoresGetTimeSpan Core.:>
                     Core.QueryParam "$.xgafv" Xgafv Core.:>
                       Core.QueryParam "access_token" Core.Text Core.:>
                         Core.QueryParam "callback" Core.Text Core.:>
                           Core.QueryParam "includeRankType" ScoresGetIncludeRankType Core.:>
                                   ...
                                   Core.QueryParam "uploadType" Core.Text Core.:>
                                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                                       Core.QueryParam "alt" Core.AltJSON Core.:>
                                         Core.Get '[Core.JSON] PlayerLeaderboardScoreListResponse
...
newGamesScoresGet leaderboardId playerId timeSpan
  = GamesScoresGet{xgafv = Core.Nothing, accessToken = Core.Nothing,
                   callback = Core.Nothing, includeRankType = Core.Nothing,
                   language = Core.Nothing, leaderboardId = leaderboardId,
                   maxResults = Core.Nothing, pageToken = Core.Nothing,
                   playerId = playerId, timeSpan = timeSpan,
                   uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest GamesScoresGet where
        type Rs GamesScoresGet = PlayerLeaderboardScoreListResponse
        type Scopes GamesScoresGet = '[Games'FullControl]
        requestClient GamesScoresGet{..}
          = go playerId leaderboardId timeSpan xgafv accessToken callback
              includeRankType
              language
              maxResults
              pageToken
