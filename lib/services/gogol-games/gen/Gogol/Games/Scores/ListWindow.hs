...
--
-- /See:/ <https://developers.google.com/games/ Google Play Games Services API Reference> for @games.scores.listWindow@.
module Gogol.Games.Scores.ListWindow
    (
    -- * Resource
       ...
       "v1" Core.:>
         "leaderboards" Core.:>
           Core.Capture "leaderboardId" Core.Text Core.:>
             "window" Core.:>
               Core.Capture "collection" ScoresListWindowCollection Core.:>
                 Core.QueryParam "timeSpan" ScoresListWindowTimeSpan Core.:>
                           ...
                           Core.QueryParam "maxResults" Core.Int32 Core.:>
                             Core.QueryParam "pageToken" Core.Text Core.:>
                               Core.QueryParam "resultsAbove" Core.Int32 Core.:>
                                 Core.QueryParam "returnTopIfAbsent" Core.Bool Core.:>
...
newGamesScoresListWindow 
    ...
    -> ScoresListWindowTimeSpan
       -- ^  Required. The time span for the scores and ranks you\'re requesting. See 'timeSpan'.
    -> GamesScoresListWindow
newGamesScoresListWindow collection leaderboardId timeSpan
  = GamesScoresListWindow{xgafv = Core.Nothing,
                          accessToken = Core.Nothing, callback = Core.Nothing,
                          collection = collection, language = Core.Nothing,
                          leaderboardId = leaderboardId, maxResults = Core.Nothing,
                          pageToken = Core.Nothing, resultsAbove = Core.Nothing,
                          returnTopIfAbsent = Core.Nothing, timeSpan = timeSpan,
...
instance Core.GoogleRequest GamesScoresListWindow where
        ...
        type Scopes GamesScoresListWindow = '[Games'FullControl]
        requestClient GamesScoresListWindow{..}
          = go leaderboardId collection (Core.Just timeSpan) xgafv
              accessToken
              callback
              language
              maxResults
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy GamesScoresListWindowResource)
                      Core.mempty
