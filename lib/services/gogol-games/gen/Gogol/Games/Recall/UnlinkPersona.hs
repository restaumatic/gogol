...
--
-- /See:/ <https://developers.google.com/games/ Google Play Games Services API Reference> for @games.recall.unlinkPersona@.
module Gogol.Games.Recall.UnlinkPersona
    (
    -- * Resource
                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] UnlinkPersonaRequest Core.:>
                         Core.Post '[Core.JSON] UnlinkPersonaResponse
...
newGamesRecallUnlinkPersona payload
  = GamesRecallUnlinkPersona{xgafv = Core.Nothing,
