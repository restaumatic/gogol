...
--
-- /See:/ <https://developers.google.com/games/ Google Play Games Services API Reference> for @games.recall.retrieveTokens@.
module Gogol.Games.Recall.RetrieveTokens
    (
    -- * Resource
...
newGamesRecallRetrieveTokens sessionId
  = GamesRecallRetrieveTokens{xgafv = Core.Nothing,
                              accessToken = Core.Nothing, callback = Core.Nothing,
                              sessionId = sessionId, uploadType = Core.Nothing,
                              uploadProtocol = Core.Nothing}
instance Core.GoogleRequest GamesRecallRetrieveTokens where
        type Rs GamesRecallRetrieveTokens = RetrievePlayerTokensResponse
        ...
        requestClient GamesRecallRetrieveTokens{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy GamesRecallRetrieveTokensResource)
                      Core.mempty
