...
--
-- /See:/ <https://developers.google.com/games/ Google Play Games Services API Reference> for @games.recall.gamesPlayerTokens@.
module Gogol.Games.Recall.GamesPlayerTokens
    (
    -- * Resource
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] RetrieveGamesPlayerTokensResponse
...
newGamesRecallGamesPlayerTokens sessionId
  = GamesRecallGamesPlayerTokens{xgafv = Core.Nothing,
                                 accessToken = Core.Nothing, applicationIds = Core.Nothing,
                                 callback = Core.Nothing, sessionId = sessionId,
                                 uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest GamesRecallGamesPlayerTokens where
        type Rs GamesRecallGamesPlayerTokens =
             RetrieveGamesPlayerTokensResponse
        type Scopes GamesRecallGamesPlayerTokens =
             '[Androidpublisher'FullControl]
        requestClient GamesRecallGamesPlayerTokens{..}
          = go sessionId xgafv accessToken
