...
--
-- /See:/ <https://developers.google.com/games/ Google Play Games Services API Reference> for @games.recall.linkPersona@.
module Gogol.Games.Recall.LinkPersona
    (
    -- * Resource
...
newGamesRecallLinkPersona payload
  = GamesRecallLinkPersona{xgafv = Core.Nothing,
                           accessToken = Core.Nothing, callback = Core.Nothing,
                           payload = payload, uploadType = Core.Nothing,
                           uploadProtocol = Core.Nothing}
instance Core.GoogleRequest GamesRecallLinkPersona where
        ...
        requestClient GamesRecallLinkPersona{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy GamesRecallLinkPersonaResource)
                      Core.mempty
