...
-- |
-- Module      : Gogol.Games.Events.Record
...
--
-- /See:/ <https://developers.google.com/games/ Google Play Games Services API Reference> for @games.events.record@.
module Gogol.Games.Events.Record
    (
    -- * Resource
                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] EventRecordRequest Core.:>
                           Core.Post '[Core.JSON] EventUpdateResponse
...
newGamesEventsRecord payload
  = GamesEventsRecord{xgafv = Core.Nothing,
