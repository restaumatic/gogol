...
--
-- /See:/ <https://developers.google.com/games/ Google Play Games Services API Reference> for @games.events.listDefinitions@.
module Gogol.Games.Events.ListDefinitions
    (
    -- * Resource
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] EventDefinitionListResponse
...
newGamesEventsListDefinitions 
    ::  GamesEventsListDefinitions
newGamesEventsListDefinitions
  = GamesEventsListDefinitions{xgafv = Core.Nothing,
                               accessToken = Core.Nothing, callback = Core.Nothing,
                               language = Core.Nothing, maxResults = Core.Nothing,
                               pageToken = Core.Nothing, uploadType = Core.Nothing,
                               uploadProtocol = Core.Nothing}
instance Core.GoogleRequest GamesEventsListDefinitions where
        type Rs GamesEventsListDefinitions = EventDefinitionListResponse
        type Scopes GamesEventsListDefinitions = '[Games'FullControl]
        requestClient GamesEventsListDefinitions{..}
          = go xgafv accessToken callback language maxResults pageToken
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy GamesEventsListDefinitionsResource)
                      Core.mempty
