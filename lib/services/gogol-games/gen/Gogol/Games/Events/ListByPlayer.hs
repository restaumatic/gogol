...
--
-- /See:/ <https://developers.google.com/games/ Google Play Games Services API Reference> for @games.events.listByPlayer@.
module Gogol.Games.Events.ListByPlayer
    (
    -- * Resource
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] PlayerEventListResponse
...
newGamesEventsListByPlayer 
    ::  GamesEventsListByPlayer
newGamesEventsListByPlayer
  = GamesEventsListByPlayer{xgafv = Core.Nothing,
