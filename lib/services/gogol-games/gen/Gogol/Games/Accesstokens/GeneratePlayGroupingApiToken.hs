...
--
-- /See:/ <https://developers.google.com/games/ Google Play Games Services API Reference> for @games.accesstokens.generatePlayGroupingApiToken@.
module Gogol.Games.Accesstokens.GeneratePlayGroupingApiToken
    (
    -- * Resource
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Post '[Core.JSON] GeneratePlayGroupingApiTokenResponse
...
newGamesAccesstokensGeneratePlayGroupingApiToken 
    :: 
                                                 GamesAccesstokensGeneratePlayGroupingApiToken
newGamesAccesstokensGeneratePlayGroupingApiToken
  = GamesAccesstokensGeneratePlayGroupingApiToken{xgafv =
                                                    Core.Nothing,
                                                  accessToken = Core.Nothing,
                                                  callback = Core.Nothing,
                                                  packageName = Core.Nothing,
                                                  persona = Core.Nothing, uploadType = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes GamesAccesstokensGeneratePlayGroupingApiToken =
             '[Games'FullControl]
        requestClient GamesAccesstokensGeneratePlayGroupingApiToken{..}
          = go xgafv accessToken callback packageName persona uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy GamesAccesstokensGeneratePlayGroupingApiTokenResource)
                      Core.mempty
