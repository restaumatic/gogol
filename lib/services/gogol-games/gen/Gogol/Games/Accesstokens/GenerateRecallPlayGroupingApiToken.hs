...
--
-- /See:/ <https://developers.google.com/games/ Google Play Games Services API Reference> for @games.accesstokens.generateRecallPlayGroupingApiToken@.
module Gogol.Games.Accesstokens.GenerateRecallPlayGroupingApiToken
    (
    -- * Resource
...
type GamesAccesstokensGenerateRecallPlayGroupingApiTokenResource =
     "games" Core.:>
       "v1" Core.:>
         "accesstokens" Core.:>
           "generateRecallPlayGroupingApiToken" Core.:>
             Core.QueryParam "$.xgafv" Xgafv Core.:>
               Core.QueryParam "access_token" Core.Text Core.:>
                 Core.QueryParam "callback" Core.Text Core.:>
                   Core.QueryParam "packageName" Core.Text Core.:>
                     Core.QueryParam "persona" Core.Text Core.:>
                       Core.QueryParam "recallSessionId" Core.Text Core.:>
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Post '[Core.JSON] GenerateRecallPlayGroupingApiTokenResponse
...
newGamesAccesstokensGenerateRecallPlayGroupingApiToken 
    :: 
                                                       GamesAccesstokensGenerateRecallPlayGroupingApiToken
newGamesAccesstokensGenerateRecallPlayGroupingApiToken
  = GamesAccesstokensGenerateRecallPlayGroupingApiToken{xgafv =
                                                          Core.Nothing,
...
instance Core.GoogleRequest
           GamesAccesstokensGenerateRecallPlayGroupingApiToken
         where
        type Rs GamesAccesstokensGenerateRecallPlayGroupingApiToken =
             GenerateRecallPlayGroupingApiTokenResponse
        type Scopes GamesAccesstokensGenerateRecallPlayGroupingApiToken =
             '[Androidpublisher'FullControl]
        requestClient
          GamesAccesstokensGenerateRecallPlayGroupingApiToken{..}
          = go xgafv accessToken callback packageName persona recallSessionId
              uploadType
              uploadProtocol
