...
--
-- /See:/ <https://developers.google.com/games/ Google Play Games Services API Reference> for @games.leaderboards.list@.
module Gogol.Games.Leaderboards.List
    (
    -- * Resource
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] LeaderboardListResponse
...
newGamesLeaderboardsList 
    ::  GamesLeaderboardsList
newGamesLeaderboardsList
  = GamesLeaderboardsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest GamesLeaderboardsList where
        type Rs GamesLeaderboardsList = LeaderboardListResponse
        type Scopes GamesLeaderboardsList = '[Games'FullControl]
        requestClient GamesLeaderboardsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy GamesLeaderboardsListResource)
                      Core.mempty
