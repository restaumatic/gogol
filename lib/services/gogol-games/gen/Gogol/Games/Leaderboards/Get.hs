...
--
-- /See:/ <https://developers.google.com/games/ Google Play Games Services API Reference> for @games.leaderboards.get@.
module Gogol.Games.Leaderboards.Get
    (
    -- * Resource
                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] Leaderboard
...
newGamesLeaderboardsGet leaderboardId
  = GamesLeaderboardsGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest GamesLeaderboardsGet where
        ...
        type Scopes GamesLeaderboardsGet = '[Games'FullControl]
        requestClient GamesLeaderboardsGet{..}
          = go leaderboardId xgafv accessToken callback language uploadType
              uploadProtocol
              (Core.Just Core.AltJSON)
              gamesService
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy GamesLeaderboardsGetResource)
                      Core.mempty
