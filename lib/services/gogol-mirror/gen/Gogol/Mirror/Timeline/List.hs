...
newMirrorTimelineList 
    ::  MirrorTimelineList
newMirrorTimelineList
  = MirrorTimelineList{bundleId = Core.Nothing,
                       includeDeleted = Core.Nothing, maxResults = Core.Nothing,
                       orderBy = Core.Nothing, pageToken = Core.Nothing,
                       pinnedOnly = Core.Nothing, sourceItemId = Core.Nothing}
instance Core.GoogleRequest MirrorTimelineList where
        type Rs MirrorTimelineList = TimelineListResponse
        type Scopes MirrorTimelineList = '[Glass'Location, Glass'Timeline]
        requestClient MirrorTimelineList{..}
          = go bundleId includeDeleted maxResults orderBy pageToken
              pinnedOnly
              sourceItemId
