...
-- |
-- Module      : Gogol.Mirror.Internal.Product
...
newAccount 
    ::  Account
newAccount
  = Account{authTokens = Core.Nothing, features = Core.Nothing,
            password = Core.Nothing, userData = Core.Nothing}
instance Core.FromJSON Account where
        parseJSON
          = Core.withObject "Account"
              (\ o ->
                 Account Core.<$>
                   (o Core..:? "authTokens") Core.<*> (o Core..:? "features") Core.<*>
                     (o Core..:? "password")
...
newAttachment 
    ::  Attachment
newAttachment
  = Attachment{contentType = Core.Nothing, contentUrl = Core.Nothing,
               id = Core.Nothing, isProcessingContent = Core.Nothing}
instance Core.FromJSON Attachment where
        parseJSON
          = Core.withObject "Attachment"
              (\ o ->
                 Attachment Core.<$>
                   (o Core..:? "contentType") Core.<*> (o Core..:? "contentUrl")
                     Core.<*> (o Core..:? "id")
          ...
          = Core.object
              (Core.catMaybes
                 [("contentType" Core..=) Core.<$> contentType,
                  ...
                  ("id" Core..=) Core.<$> id,
                  ("isProcessingContent" Core..=) Core.<$> isProcessingContent])
...
newAttachmentsListResponse 
    ::  AttachmentsListResponse
newAttachmentsListResponse
  = AttachmentsListResponse{items = Core.Nothing,
                            kind = "mirror#attachmentsList"}
instance Core.FromJSON AttachmentsListResponse where
        parseJSON
          = Core.withObject "AttachmentsListResponse"
              (\ o ->
                 AttachmentsListResponse Core.<$>
                   (o Core..:? "items") Core.<*>
                     (o Core..:? "kind" Core..!= "mirror#attachmentsList"))
...
newAuthToken 
    ::  AuthToken
newAuthToken
  = AuthToken{authToken = Core.Nothing, type' = Core.Nothing}
instance Core.FromJSON AuthToken where
        parseJSON
          = Core.withObject "AuthToken"
              (\ o ->
                 AuthToken Core.<$>
                   (o Core..:? "authToken") Core.<*> (o Core..:? "type"))
...
newContact 
    ::  Contact
newContact
  = Contact{acceptCommands = Core.Nothing,
            acceptTypes = Core.Nothing, displayName = Core.Nothing,
            id = Core.Nothing, imageUrls = Core.Nothing,
            kind = "mirror#contact", phoneNumber = Core.Nothing,
            priority = Core.Nothing, sharingFeatures = Core.Nothing,
            source = Core.Nothing, speakableName = Core.Nothing,
            type' = Core.Nothing}
instance Core.FromJSON Contact where
        parseJSON
          = Core.withObject "Contact"
              (\ o ->
                 Contact Core.<$>
                   (o Core..:? "acceptCommands") Core.<*> (o Core..:? "acceptTypes")
...
newContactsListResponse 
    ::  ContactsListResponse
newContactsListResponse
  = ContactsListResponse{items = Core.Nothing,
                         kind = "mirror#contacts"}
instance Core.FromJSON ContactsListResponse where
        parseJSON
          = Core.withObject "ContactsListResponse"
              (\ o ->
                 ContactsListResponse Core.<$>
                   (o Core..:? "items") Core.<*>
                     (o Core..:? "kind" Core..!= "mirror#contacts"))
...
newLocation 
    ::  Location
newLocation
  = Location{accuracy = Core.Nothing, address = Core.Nothing,
             displayName = Core.Nothing, id = Core.Nothing,
             kind = "mirror#location", latitude = Core.Nothing,
             longitude = Core.Nothing, timestamp = Core.Nothing}
instance Core.FromJSON Location where
        parseJSON
          = Core.withObject "Location"
              (\ o ->
                 Location Core.<$>
                   (o Core..:? "accuracy") Core.<*> (o Core..:? "address") Core.<*>
                     (o Core..:? "displayName")
                     Core.<*> (o Core..:? "id")
...
newLocationsListResponse 
    ::  LocationsListResponse
newLocationsListResponse
  = LocationsListResponse{items = Core.Nothing,
                          kind = "mirror#locationsList"}
instance Core.FromJSON LocationsListResponse where
        parseJSON
          = Core.withObject "LocationsListResponse"
              (\ o ->
                 LocationsListResponse Core.<$>
                   (o Core..:? "items") Core.<*>
                     (o Core..:? "kind" Core..!= "mirror#locationsList"))
...
newMenuItem 
    ::  MenuItem
newMenuItem
  = MenuItem{action = Core.Nothing, contextualCommand = Core.Nothing,
             id = Core.Nothing, payload = Core.Nothing,
             removeWhenSelected = Core.Nothing, values = Core.Nothing}
instance Core.FromJSON MenuItem where
        parseJSON
          = Core.withObject "MenuItem"
              (\ o ->
                 MenuItem Core.<$>
                   (o Core..:? "action") Core.<*> (o Core..:? "contextual_command")
                     Core.<*> (o Core..:? "id")
                     Core.<*> (o Core..:? "payload")
          ...
          = Core.object
              (Core.catMaybes
                 [("action" Core..=) Core.<$> action,
                  ("contextual_command" Core..=) Core.<$> contextualCommand,
                  ("id" Core..=) Core.<$> id, ("payload" Core..=) Core.<$> payload,
                  ("removeWhenSelected" Core..=) Core.<$> removeWhenSelected,
...
newMenuValue 
    ::  MenuValue
newMenuValue
  = MenuValue{displayName = Core.Nothing, iconUrl = Core.Nothing,
              state = Core.Nothing}
instance Core.FromJSON MenuValue where
        parseJSON
          = Core.withObject "MenuValue"
              (\ o ->
                 MenuValue Core.<$>
                   (o Core..:? "displayName") Core.<*> (o Core..:? "iconUrl") Core.<*>
                     (o Core..:? "state"))
...
newNotification 
    ::  Notification
newNotification
  = Notification{collection = Core.Nothing, itemId = Core.Nothing,
                 operation = Core.Nothing, userActions = Core.Nothing,
                 userToken = Core.Nothing, verifyToken = Core.Nothing}
instance Core.FromJSON Notification where
        parseJSON
          = Core.withObject "Notification"
              (\ o ->
                 Notification Core.<$>
                   (o Core..:? "collection") Core.<*> (o Core..:? "itemId") Core.<*>
                     (o Core..:? "operation")
...
newNotificationConfig 
    ::  NotificationConfig
newNotificationConfig
  = NotificationConfig{deliveryTime = Core.Nothing,
                       level = Core.Nothing}
          ...
          = Core.withObject "NotificationConfig"
              (\ o ->
                 NotificationConfig Core.<$>
                   (o Core..:? "deliveryTime") Core.<*> (o Core..:? "level"))
...
newSetting 
    ::  Setting
newSetting
  = Setting{id = Core.Nothing, kind = "mirror#setting",
            value = Core.Nothing}
        ...
        parseJSON
          = Core.withObject "Setting"
              (\ o ->
                 Setting Core.<$>
                   (o Core..:? "id") Core.<*>
                     (o Core..:? "kind" Core..!= "mirror#setting")
                     Core.<*> (o Core..:? "value"))
...
newSubscription 
    ::  Subscription
newSubscription
  = Subscription{callbackUrl = Core.Nothing,
                 collection = Core.Nothing, id = Core.Nothing,
                 kind = "mirror#subscription", notification = Core.Nothing,
                 operation = Core.Nothing, updated = Core.Nothing,
                 userToken = Core.Nothing, verifyToken = Core.Nothing}
instance Core.FromJSON Subscription where
        parseJSON
          = Core.withObject "Subscription"
              (\ o ->
                 Subscription Core.<$>
                   (o Core..:? "callbackUrl") Core.<*> (o Core..:? "collection")
                     Core.<*> (o Core..:? "id")
...
newSubscriptionsListResponse 
    ::  SubscriptionsListResponse
newSubscriptionsListResponse
  = SubscriptionsListResponse{items = Core.Nothing,
                              kind = "mirror#subscriptionsList"}
instance Core.FromJSON SubscriptionsListResponse where
        parseJSON
          = Core.withObject "SubscriptionsListResponse"
              (\ o ->
                 SubscriptionsListResponse Core.<$>
                   (o Core..:? "items") Core.<*>
                     (o Core..:? "kind" Core..!= "mirror#subscriptionsList"))
...
newTimelineItem 
    ::  TimelineItem
newTimelineItem
  = TimelineItem{attachments = Core.Nothing, bundleId = Core.Nothing,
                 canonicalUrl = Core.Nothing, created = Core.Nothing,
                 creator = Core.Nothing, displayTime = Core.Nothing,
                 etag = Core.Nothing, html = Core.Nothing, id = Core.Nothing,
                 inReplyTo = Core.Nothing, isBundleCover = Core.Nothing,
                 isDeleted = Core.Nothing, isPinned = Core.Nothing,
                 kind = "mirror#timelineItem", location = Core.Nothing,
                 menuItems = Core.Nothing, notification = Core.Nothing,
                 pinScore = Core.Nothing, recipients = Core.Nothing,
                 selfLink = Core.Nothing, sourceItemId = Core.Nothing,
                 speakableText = Core.Nothing, speakableType = Core.Nothing,
                 text = Core.Nothing, title = Core.Nothing, updated = Core.Nothing}
instance Core.FromJSON TimelineItem where
        parseJSON
          = Core.withObject "TimelineItem"
              (\ o ->
                 TimelineItem Core.<$>
                   (o Core..:? "attachments") Core.<*> (o Core..:? "bundleId")
          ...
          = Core.object
              (Core.catMaybes
                 [("attachments" Core..=) Core.<$> attachments,
                  ...
                  ("etag" Core..=) Core.<$> etag, ("html" Core..=) Core.<$> html,
                  ("id" Core..=) Core.<$> id,
                  ...
                  ("text" Core..=) Core.<$> text, ("title" Core..=) Core.<$> title,
                  ("updated" Core..=) Core.<$> updated])
...
newTimelineListResponse 
    ::  TimelineListResponse
newTimelineListResponse
  = TimelineListResponse{items = Core.Nothing,
                         kind = "mirror#timeline", nextPageToken = Core.Nothing}
instance Core.FromJSON TimelineListResponse where
        parseJSON
          = Core.withObject "TimelineListResponse"
              (\ o ->
                 TimelineListResponse Core.<$>
                   (o Core..:? "items") Core.<*>
                     (o Core..:? "kind" Core..!= "mirror#timeline")
...
newUserAction 
    ::  UserAction
newUserAction
  = UserAction{payload = Core.Nothing, type' = Core.Nothing}
instance Core.FromJSON UserAction where
        parseJSON
          = Core.withObject "UserAction"
              (\ o ->
                 UserAction Core.<$>
                   (o Core..:? "payload") Core.<*> (o Core..:? "type"))
...
instance Core.FromJSON UserData where
        parseJSON
          = Core.withObject "UserData"
              (\ o ->
                 UserData Core.<$> (o Core..:? "key") Core.<*> (o Core..:? "value"))
