...
newAbusiveExperienceReportViolatingSitesList 
    :: 
                                             AbusiveExperienceReportViolatingSitesList
newAbusiveExperienceReportViolatingSitesList
  = AbusiveExperienceReportViolatingSitesList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           AbusiveExperienceReportViolatingSitesList
         where
        type Rs AbusiveExperienceReportViolatingSitesList =
             ViolatingSitesResponse
        type Scopes AbusiveExperienceReportViolatingSitesList = '[]
        requestClient AbusiveExperienceReportViolatingSitesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AbusiveExperienceReportViolatingSitesListResource)
                      Core.mempty
