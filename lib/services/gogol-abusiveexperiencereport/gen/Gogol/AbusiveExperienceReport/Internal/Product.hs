...
newSiteSummaryResponse 
    ::  SiteSummaryResponse
newSiteSummaryResponse
  = SiteSummaryResponse{abusiveStatus = Core.Nothing,
                        enforcementTime = Core.Nothing, filterStatus = Core.Nothing,
                        lastChangeTime = Core.Nothing, reportUrl = Core.Nothing,
                        reviewedSite = Core.Nothing, underReview = Core.Nothing}
instance Core.FromJSON SiteSummaryResponse where
        parseJSON
          = Core.withObject "SiteSummaryResponse"
              (\ o ->
                 SiteSummaryResponse Core.<$>
                   (o Core..:? "abusiveStatus") Core.<*>
