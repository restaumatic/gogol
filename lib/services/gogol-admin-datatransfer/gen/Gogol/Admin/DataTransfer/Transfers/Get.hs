...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @datatransfer.transfers.get@.
module Gogol.Admin.DataTransfer.Transfers.Get
    (
    -- * Resource
...
type DatatransferTransfersGetResource =
     "admin" Core.:>
       "datatransfer" Core.:>
         "v1" Core.:>
           "transfers" Core.:>
             Core.Capture "dataTransferId" Core.Text Core.:>
                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] DataTransfer
...
newDatatransferTransfersGet dataTransferId
  = DatatransferTransfersGet{xgafv = Core.Nothing,
                             accessToken = Core.Nothing, callback = Core.Nothing,
                             dataTransferId = dataTransferId, uploadType = Core.Nothing,
                             uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DatatransferTransfersGet where
        type Rs DatatransferTransfersGet = DataTransfer
        type Scopes DatatransferTransfersGet =
             '[Admin'Datatransfer, Admin'Datatransfer'Readonly]
        requestClient DatatransferTransfersGet{..}
          = go dataTransferId xgafv accessToken callback uploadType
              uploadProtocol
              (Core.Just Core.AltJSON)
              adminDataTransferService
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy DatatransferTransfersGetResource)
                      Core.mempty
