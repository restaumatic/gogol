...
--
-- Inserts a data transfer request. See the <https://developers.google.com/workspace/admin/data-transfer/v1/parameters Transfer parameters> reference for specific application requirements.
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @datatransfer.transfers.insert@.
module Gogol.Admin.DataTransfer.Transfers.Insert
    (
    -- * Resource
...
newDatatransferTransfersInsert payload
  = DatatransferTransfersInsert{xgafv = Core.Nothing,
