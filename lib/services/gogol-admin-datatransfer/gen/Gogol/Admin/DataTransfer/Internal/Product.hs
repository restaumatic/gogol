...
data Application = Application
    {
      ...
      -- | The application\'s ID. Retrievable by using the <https://developers.google.com/workspace/admin/data-transfer/reference/rest/v1/applications/list applications.list()> method.
...
newApplication 
    ::  Application
newApplication
  = Application{etag = Core.Nothing, id = Core.Nothing,
                kind = "admin#datatransfer#ApplicationResource",
                name = Core.Nothing, transferParams = Core.Nothing}
...
data ApplicationDataTransfer = ApplicationDataTransfer
    {
      ...
      -- | The transfer parameters for the application. These parameters are used to select the data which will get transferred in context of this application. For more information about the specific values available for each application, see the <https://developers.google.com/workspace/admin/data-transfer/v1/parameters Transfer parameters> reference.
...
newApplicationDataTransfer 
    ::  ApplicationDataTransfer
newApplicationDataTransfer
  = ApplicationDataTransfer{applicationId = Core.Nothing,
...
instance Core.FromJSON ApplicationDataTransfer where
        parseJSON
          = Core.withObject "ApplicationDataTransfer"
              (\ o ->
                 ApplicationDataTransfer Core.<$>
                   (o Core..:? "applicationId" Core.<&> Core.fmap Core.fromAsText)
...
instance Core.ToJSON ApplicationDataTransfer where
        toJSON ApplicationDataTransfer{..}
          = Core.object
              (Core.catMaybes
                 [("applicationId" Core..=) Core.. Core.AsText Core.<$>
                    applicationId,
                  ("applicationTransferParams" Core..=) Core.<$>
                    applicationTransferParams,
                  ("applicationTransferStatus" Core..=) Core.<$>
...
newApplicationTransferParam 
    ::  ApplicationTransferParam
newApplicationTransferParam
  = ApplicationTransferParam{key = Core.Nothing,
                             value = Core.Nothing}
instance Core.FromJSON ApplicationTransferParam where
        parseJSON
          = Core.withObject "ApplicationTransferParam"
              (\ o ->
                 ApplicationTransferParam Core.<$>
...
newApplicationsListResponse 
    ::  ApplicationsListResponse
newApplicationsListResponse
  = ApplicationsListResponse{applications = Core.Nothing,
                             etag = Core.Nothing, kind = "admin#datatransfer#applicationsList",
                             nextPageToken = Core.Nothing}
instance Core.FromJSON ApplicationsListResponse where
        parseJSON
          = Core.withObject "ApplicationsListResponse"
              (\ o ->
                 ApplicationsListResponse Core.<$>
                   (o Core..:? "applications") Core.<*> (o Core..:? "etag") Core.<*>
                     (o Core..:? "kind" Core..!= "admin#datatransfer#applicationsList")
...
newDataTransfer 
    ::  DataTransfer
newDataTransfer
  = DataTransfer{applicationDataTransfers = Core.Nothing,
                 etag = Core.Nothing, id = Core.Nothing,
                 kind = "admin#datatransfer#DataTransfer",
                 newOwnerUserId' = Core.Nothing, oldOwnerUserId = Core.Nothing,
                 overallTransferStatusCode = Core.Nothing,
                 requestTime = Core.Nothing}
instance Core.FromJSON DataTransfer where
        parseJSON
          = Core.withObject "DataTransfer"
              (\ o ->
                 DataTransfer Core.<$>
                   (o Core..:? "applicationDataTransfers") Core.<*>
                     (o Core..:? "etag")
                     Core.<*> (o Core..:? "id")
                     Core.<*>
                     (o Core..:? "kind" Core..!= "admin#datatransfer#DataTransfer")
...
instance Core.ToJSON DataTransfer where
        toJSON DataTransfer{..}
          = Core.object
              (Core.catMaybes
                 [("applicationDataTransfers" Core..=) Core.<$>
                  ...
                  ("overallTransferStatusCode" Core..=) Core.<$>
...
newDataTransfersListResponse 
    ::  DataTransfersListResponse
newDataTransfersListResponse
  = DataTransfersListResponse{dataTransfers = Core.Nothing,
                              etag = Core.Nothing, kind = "admin#datatransfer#dataTransfersList",
                              nextPageToken = Core.Nothing}
instance Core.FromJSON DataTransfersListResponse where
        parseJSON
          = Core.withObject "DataTransfersListResponse"
              (\ o ->
                 DataTransfersListResponse Core.<$>
                   (o Core..:? "dataTransfers") Core.<*> (o Core..:? "etag") Core.<*>
                     (o Core..:? "kind" Core..!= "admin#datatransfer#dataTransfersList")
                     Core.<*> (o Core..:? "nextPageToken"))
