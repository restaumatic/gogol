...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @datatransfer.applications.list@.
module Gogol.Admin.DataTransfer.Applications.List
    (
    -- * Resource
...
newDatatransferApplicationsList 
    ::  DatatransferApplicationsList
newDatatransferApplicationsList
  = DatatransferApplicationsList{xgafv = Core.Nothing,
                                 accessToken = Core.Nothing, callback = Core.Nothing,
                                 customerId = Core.Nothing, maxResults = Core.Nothing,
                                 pageToken = Core.Nothing, uploadType = Core.Nothing,
                                 uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DatatransferApplicationsList where
        type Rs DatatransferApplicationsList = ApplicationsListResponse
        ...
        requestClient DatatransferApplicationsList{..}
          = go xgafv accessToken callback customerId maxResults pageToken
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy DatatransferApplicationsListResource)
                      Core.mempty
