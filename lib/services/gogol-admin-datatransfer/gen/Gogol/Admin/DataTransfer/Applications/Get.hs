...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @datatransfer.applications.get@.
module Gogol.Admin.DataTransfer.Applications.Get
    (
    -- * Resource
...
newDatatransferApplicationsGet applicationId
  = DatatransferApplicationsGet{xgafv = Core.Nothing,
                                accessToken = Core.Nothing, applicationId = applicationId,
                                callback = Core.Nothing, uploadType = Core.Nothing,
                                uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DatatransferApplicationsGet where
        ...
        requestClient DatatransferApplicationsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy DatatransferApplicationsGetResource)
                      Core.mempty
