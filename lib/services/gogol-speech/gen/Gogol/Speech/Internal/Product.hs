...
newLongRunningRecognizeMetadata 
    ::  LongRunningRecognizeMetadata
newLongRunningRecognizeMetadata
  = LongRunningRecognizeMetadata{lastUpdateTime = Core.Nothing,
                                 progressPercent = Core.Nothing, startTime = Core.Nothing,
                                 uri = Core.Nothing}
instance Core.FromJSON LongRunningRecognizeMetadata where
        parseJSON
          = Core.withObject "LongRunningRecognizeMetadata"
              (\ o ->
                 LongRunningRecognizeMetadata Core.<$>
...
instance Core.FromJSON LongRunningRecognizeResponse where
        parseJSON
          = Core.withObject "LongRunningRecognizeResponse"
              (\ o ->
...
newSpeechRecognitionAlternative 
    ::  SpeechRecognitionAlternative
newSpeechRecognitionAlternative
  = SpeechRecognitionAlternative{confidence = Core.Nothing,
                                 transcript = Core.Nothing, words = Core.Nothing}
instance Core.FromJSON SpeechRecognitionAlternative where
        parseJSON
          = Core.withObject "SpeechRecognitionAlternative"
              (\ o ->
                 SpeechRecognitionAlternative Core.<$>
...
newSpeechRecognitionResult 
    ::  SpeechRecognitionResult
newSpeechRecognitionResult
  = SpeechRecognitionResult{alternatives = Core.Nothing,
                            channelTag = Core.Nothing, languageCode = Core.Nothing}
instance Core.FromJSON SpeechRecognitionResult where
        parseJSON
          = Core.withObject "SpeechRecognitionResult"
              (\ o ->
                 SpeechRecognitionResult Core.<$>
                   (o Core..:? "alternatives") Core.<*> (o Core..:? "channelTag")
...
newWordInfo 
    ::  WordInfo
newWordInfo
  = WordInfo{confidence = Core.Nothing, endOffset = Core.Nothing,
             speakerTag = Core.Nothing, startOffset = Core.Nothing,
             word = Core.Nothing}
instance Core.FromJSON WordInfo where
        parseJSON
          = Core.withObject "WordInfo"
              (\ o ->
                 WordInfo Core.<$>
                   (o Core..:? "confidence") Core.<*> (o Core..:? "endOffset")
