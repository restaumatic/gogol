...
newSpeechProjectsLocationsOperationsList name
  = SpeechProjectsLocationsOperationsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest SpeechProjectsLocationsOperationsList
         where
        type Rs SpeechProjectsLocationsOperationsList =
             ListOperationsResponse
        type Scopes SpeechProjectsLocationsOperationsList =
