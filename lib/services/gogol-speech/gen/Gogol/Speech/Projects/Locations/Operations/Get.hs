...
newSpeechProjectsLocationsOperationsGet name
  = SpeechProjectsLocationsOperationsGet{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         name = name, uploadType = Core.Nothing,
                                         uploadProtocol = Core.Nothing}
instance Core.GoogleRequest SpeechProjectsLocationsOperationsGet
         where
        type Rs SpeechProjectsLocationsOperationsGet = Operation
        type Scopes SpeechProjectsLocationsOperationsGet =
