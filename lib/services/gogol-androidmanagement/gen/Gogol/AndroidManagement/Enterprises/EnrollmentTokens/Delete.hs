...
newAndroidManagementEnterprisesEnrollmentTokensDelete name
  = AndroidManagementEnterprisesEnrollmentTokensDelete{xgafv =
                                                         Core.Nothing,
...
instance Core.GoogleRequest
           AndroidManagementEnterprisesEnrollmentTokensDelete
         where
        type Rs AndroidManagementEnterprisesEnrollmentTokensDelete = Empty
        type Scopes AndroidManagementEnterprisesEnrollmentTokensDelete =
