...
newAndroidManagementEnterprisesEnrollmentTokensCreate 
    ...
    -> AndroidManagementEnterprisesEnrollmentTokensCreate
newAndroidManagementEnterprisesEnrollmentTokensCreate parent
  payload
  = AndroidManagementEnterprisesEnrollmentTokensCreate{xgafv =
                                                         Core.Nothing,
...
instance Core.GoogleRequest
           AndroidManagementEnterprisesEnrollmentTokensCreate
         where
        type Rs AndroidManagementEnterprisesEnrollmentTokensCreate =
             EnrollmentToken
        type Scopes AndroidManagementEnterprisesEnrollmentTokensCreate =
