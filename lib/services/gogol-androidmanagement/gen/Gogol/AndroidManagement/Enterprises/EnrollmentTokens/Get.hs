...
newAndroidManagementEnterprisesEnrollmentTokensGet name
  = AndroidManagementEnterprisesEnrollmentTokensGet{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           AndroidManagementEnterprisesEnrollmentTokensGet
         where
        type Rs AndroidManagementEnterprisesEnrollmentTokensGet =
             EnrollmentToken
        type Scopes AndroidManagementEnterprisesEnrollmentTokensGet =
