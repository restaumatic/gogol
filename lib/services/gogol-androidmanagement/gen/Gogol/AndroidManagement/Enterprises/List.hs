                   ...
                   Core.QueryParam "projectId" Core.Text Core.:>
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "view" EnterprisesListView Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] ListEnterprisesResponse
...
newAndroidManagementEnterprisesList 
    :: 
                                    AndroidManagementEnterprisesList
newAndroidManagementEnterprisesList
  = AndroidManagementEnterprisesList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest AndroidManagementEnterprisesList where
        type Rs AndroidManagementEnterprisesList = ListEnterprisesResponse
        type Scopes AndroidManagementEnterprisesList =
             '[Androidmanagement'FullControl]
        requestClient AndroidManagementEnterprisesList{..}
          = go xgafv accessToken callback pageSize pageToken projectId
              uploadType
              uploadProtocol
              view
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy AndroidManagementEnterprisesListResource)
                      Core.mempty
