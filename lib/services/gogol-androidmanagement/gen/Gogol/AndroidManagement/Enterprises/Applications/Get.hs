...
newAndroidManagementEnterprisesApplicationsGet name
  = AndroidManagementEnterprisesApplicationsGet{xgafv = Core.Nothing,
                                                accessToken = Core.Nothing, callback = Core.Nothing,
                                                languageCode = Core.Nothing, name = name,
                                                uploadType = Core.Nothing,
                                                uploadProtocol = Core.Nothing}
instance Core.GoogleRequest
           AndroidManagementEnterprisesApplicationsGet
         where
        type Rs AndroidManagementEnterprisesApplicationsGet = Application
        type Scopes AndroidManagementEnterprisesApplicationsGet =
             '[Androidmanagement'FullControl]
        requestClient AndroidManagementEnterprisesApplicationsGet{..}
          = go name xgafv accessToken callback languageCode uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AndroidManagementEnterprisesApplicationsGetResource)
                      Core.mempty
