...
newAndroidManagementEnterprisesCreate payload
  = AndroidManagementEnterprisesCreate{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, agreementAccepted = Core.Nothing,
                                       callback = Core.Nothing, enterpriseToken = Core.Nothing,
                                       payload = payload, projectId = Core.Nothing,
                                       signupUrlName = Core.Nothing, uploadType = Core.Nothing,
                                       uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AndroidManagementEnterprisesCreate
         where
        type Rs AndroidManagementEnterprisesCreate = Enterprise
        type Scopes AndroidManagementEnterprisesCreate =
             '[Androidmanagement'FullControl]
        requestClient AndroidManagementEnterprisesCreate{..}
          = go xgafv accessToken agreementAccepted callback enterpriseToken
              projectId
              signupUrlName
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AndroidManagementEnterprisesCreateResource)
                      Core.mempty
