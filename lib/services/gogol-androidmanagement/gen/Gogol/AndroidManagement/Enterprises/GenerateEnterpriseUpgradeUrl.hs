...
type AndroidManagementEnterprisesGenerateEnterpriseUpgradeUrlResource
     =
     "v1" Core.:>
       Core.CaptureMode "name" "generateEnterpriseUpgradeUrl" Core.Text
         Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] GenerateEnterpriseUpgradeUrlRequest
...
newAndroidManagementEnterprisesGenerateEnterpriseUpgradeUrl 
    ...
    -> AndroidManagementEnterprisesGenerateEnterpriseUpgradeUrl
newAndroidManagementEnterprisesGenerateEnterpriseUpgradeUrl name
  payload
  = AndroidManagementEnterprisesGenerateEnterpriseUpgradeUrl{xgafv =
                                                               Core.Nothing,
...
instance Core.GoogleRequest
           AndroidManagementEnterprisesGenerateEnterpriseUpgradeUrl
         where
        type Rs AndroidManagementEnterprisesGenerateEnterpriseUpgradeUrl =
