                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] WebToken Core.:>
                         Core.Post '[Core.JSON] WebToken
...
newAndroidManagementEnterprisesWebTokensCreate parent payload
  = AndroidManagementEnterprisesWebTokensCreate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes AndroidManagementEnterprisesWebTokensCreate =
