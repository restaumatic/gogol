...
newAndroidManagementEnterprisesPoliciesGet name
  = AndroidManagementEnterprisesPoliciesGet{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            name = name, uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest AndroidManagementEnterprisesPoliciesGet
         where
        type Rs AndroidManagementEnterprisesPoliciesGet = Policy
        type Scopes AndroidManagementEnterprisesPoliciesGet =
