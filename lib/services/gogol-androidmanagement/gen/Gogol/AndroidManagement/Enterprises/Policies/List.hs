...
newAndroidManagementEnterprisesPoliciesList parent
  = AndroidManagementEnterprisesPoliciesList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           AndroidManagementEnterprisesPoliciesList
         where
        type Rs AndroidManagementEnterprisesPoliciesList =
             ListPoliciesResponse
        type Scopes AndroidManagementEnterprisesPoliciesList =
             '[Androidmanagement'FullControl]
        requestClient AndroidManagementEnterprisesPoliciesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AndroidManagementEnterprisesPoliciesListResource)
                      Core.mempty
