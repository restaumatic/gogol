...
newAndroidManagementEnterprisesDevicesOperationsGet name
  = AndroidManagementEnterprisesDevicesOperationsGet{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           AndroidManagementEnterprisesDevicesOperationsGet
         where
        type Rs AndroidManagementEnterprisesDevicesOperationsGet =
             Operation
        type Scopes AndroidManagementEnterprisesDevicesOperationsGet =
