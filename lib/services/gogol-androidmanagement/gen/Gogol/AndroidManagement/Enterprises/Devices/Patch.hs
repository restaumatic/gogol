...
newAndroidManagementEnterprisesDevicesPatch name payload
  = AndroidManagementEnterprisesDevicesPatch{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           AndroidManagementEnterprisesDevicesPatch
         where
        type Rs AndroidManagementEnterprisesDevicesPatch = Device
        type Scopes AndroidManagementEnterprisesDevicesPatch =
             '[Androidmanagement'FullControl]
        requestClient AndroidManagementEnterprisesDevicesPatch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AndroidManagementEnterprisesDevicesPatchResource)
                      Core.mempty
