...
newAndroidManagementEnterprisesDevicesDelete name
  = AndroidManagementEnterprisesDevicesDelete{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           AndroidManagementEnterprisesDevicesDelete
         where
        type Rs AndroidManagementEnterprisesDevicesDelete = Empty
        type Scopes AndroidManagementEnterprisesDevicesDelete =
             '[Androidmanagement'FullControl]
        requestClient AndroidManagementEnterprisesDevicesDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AndroidManagementEnterprisesDevicesDeleteResource)
                      Core.mempty
