...
type AndroidManagementEnterprisesDevicesIssueCommandResource =
     "v1" Core.:>
       Core.CaptureMode "name" "issueCommand" Core.Text Core.:>
...
newAndroidManagementEnterprisesDevicesIssueCommand name payload
  = AndroidManagementEnterprisesDevicesIssueCommand{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes AndroidManagementEnterprisesDevicesIssueCommand =
