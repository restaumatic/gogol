...
newAndroidManagementEnterprisesMigrationTokensCreate parent payload
  = AndroidManagementEnterprisesMigrationTokensCreate{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           AndroidManagementEnterprisesMigrationTokensCreate
         where
        type Rs AndroidManagementEnterprisesMigrationTokensCreate =
             MigrationToken
        type Scopes AndroidManagementEnterprisesMigrationTokensCreate =
