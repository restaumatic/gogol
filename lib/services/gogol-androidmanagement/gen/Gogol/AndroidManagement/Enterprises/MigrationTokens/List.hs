                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] ListMigrationTokensResponse
...
newAndroidManagementEnterprisesMigrationTokensList parent
  = AndroidManagementEnterprisesMigrationTokensList{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           AndroidManagementEnterprisesMigrationTokensList
         where
        type Rs AndroidManagementEnterprisesMigrationTokensList =
             ListMigrationTokensResponse
        type Scopes AndroidManagementEnterprisesMigrationTokensList =
