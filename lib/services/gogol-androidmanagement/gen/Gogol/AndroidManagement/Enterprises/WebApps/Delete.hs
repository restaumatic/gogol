...
newAndroidManagementEnterprisesWebAppsDelete name
  = AndroidManagementEnterprisesWebAppsDelete{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           AndroidManagementEnterprisesWebAppsDelete
         where
        type Rs AndroidManagementEnterprisesWebAppsDelete = Empty
        type Scopes AndroidManagementEnterprisesWebAppsDelete =
             '[Androidmanagement'FullControl]
        requestClient AndroidManagementEnterprisesWebAppsDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AndroidManagementEnterprisesWebAppsDeleteResource)
                      Core.mempty
