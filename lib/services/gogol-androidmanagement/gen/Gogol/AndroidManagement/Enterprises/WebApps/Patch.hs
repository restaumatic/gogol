...
newAndroidManagementEnterprisesWebAppsPatch name payload
  = AndroidManagementEnterprisesWebAppsPatch{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           AndroidManagementEnterprisesWebAppsPatch
         where
        type Rs AndroidManagementEnterprisesWebAppsPatch = WebApp
        type Scopes AndroidManagementEnterprisesWebAppsPatch =
             '[Androidmanagement'FullControl]
        requestClient AndroidManagementEnterprisesWebAppsPatch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AndroidManagementEnterprisesWebAppsPatchResource)
                      Core.mempty
