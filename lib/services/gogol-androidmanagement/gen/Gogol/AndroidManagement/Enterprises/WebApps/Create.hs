...
newAndroidManagementEnterprisesWebAppsCreate parent payload
  = AndroidManagementEnterprisesWebAppsCreate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           AndroidManagementEnterprisesWebAppsCreate
         where
        type Rs AndroidManagementEnterprisesWebAppsCreate = WebApp
        type Scopes AndroidManagementEnterprisesWebAppsCreate =
             '[Androidmanagement'FullControl]
        requestClient AndroidManagementEnterprisesWebAppsCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AndroidManagementEnterprisesWebAppsCreateResource)
                      Core.mempty
