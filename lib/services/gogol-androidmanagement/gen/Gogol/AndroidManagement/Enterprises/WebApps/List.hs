...
instance Core.GoogleRequest AndroidManagementEnterprisesWebAppsList
        ...
        requestClient AndroidManagementEnterprisesWebAppsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy AndroidManagementEnterprisesWebAppsListResource)
                      Core.mempty
