...
newAndroidManagementSignupUrlsCreate 
    :: 
                                     AndroidManagementSignupUrlsCreate
newAndroidManagementSignupUrlsCreate
  = AndroidManagementSignupUrlsCreate{xgafv = Core.Nothing,
                                      accessToken = Core.Nothing, adminEmail = Core.Nothing,
                                      allowedDomains = Core.Nothing, callback = Core.Nothing,
                                      callbackUrl = Core.Nothing, projectId = Core.Nothing,
...
instance Core.GoogleRequest AndroidManagementSignupUrlsCreate where
        ...
        requestClient AndroidManagementSignupUrlsCreate{..}
          = go xgafv accessToken adminEmail
