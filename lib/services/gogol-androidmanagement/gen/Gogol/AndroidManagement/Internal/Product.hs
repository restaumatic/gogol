...
data ApplicationPolicy = ApplicationPolicy
    ...
    , customAppConfig :: (Core.Maybe CustomAppConfig)
    ...
    , preferentialNetworkId :: (Core.Maybe ApplicationPolicy_PreferentialNetworkId)
      ...
      -- must match one of the signing key certificate fingerprints obtained from Play Store or one of the entries in ApplicationPolicy.signingKeyCerts. Otherwise, a NonComplianceDetail with APP/SIGNING/CERT/MISMATCH is reported.There must not be duplicate roles with the same roleType. Multiple apps cannot hold a role with the same roleType. A role with type ROLE/TYPE_UNSPECIFIED is not allowed.
    ...
    , signingKeyCerts :: (Core.Maybe [ApplicationSigningKeyCert])
...
newApplicationPolicy
  = ApplicationPolicy{accessibleTrackIds = Core.Nothing,
                      ...
                      preferentialNetworkId = Core.Nothing, roles = Core.Nothing,
                      signingKeyCerts = Core.Nothing, userControlSettings = Core.Nothing,
          ...
          = Core.object
              (Core.catMaybes
                 [("accessibleTrackIds" Core..=) Core.<$> accessibleTrackIds,
                  ...
                  ("customAppConfig" Core..=) Core.<$> customAppConfig,
                  ...
                  ("signingKeyCerts" Core..=) Core.<$> signingKeyCerts,
...
--
-- /See:/ 'newApplicationSigningKeyCert' smart constructor.
newtype ApplicationSigningKeyCert = ApplicationSigningKeyCert
    {
      ...
      signingKeyCertFingerprintSha256 :: (Core.Maybe Core.Base64)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'ApplicationSigningKeyCert' with the minimum fields required to make a request.
newApplicationSigningKeyCert 
    ::  ApplicationSigningKeyCert
newApplicationSigningKeyCert
  = ApplicationSigningKeyCert{signingKeyCertFingerprintSha256 =
                                Core.Nothing}
instance Core.FromJSON ApplicationSigningKeyCert where
        parseJSON
          = Core.withObject "ApplicationSigningKeyCert"
              (\ o ->
                 ApplicationSigningKeyCert Core.<$>
                   (o Core..:? "signingKeyCertFingerprintSha256"))

instance Core.ToJSON ApplicationSigningKeyCert where
        toJSON ApplicationSigningKeyCert{..}
          = Core.object
              (Core.catMaybes
                 [("signingKeyCertFingerprintSha256" Core..=) Core.<$>
...
data Command = Command
    ...
    , wipeParams :: (Core.Maybe WipeParams)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newCommand
  = Command{addEsimParams = Core.Nothing,
            ...
            userName = Core.Nothing, wipeParams = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("addEsimParams" Core..=) Core.<$> addEsimParams,
                  ...
                  ("type" Core..=) Core.<$> type',
                  ("userName" Core..=) Core.<$> userName,
                  ("wipeParams" Core..=) Core.<$> wipeParams])
...
--
-- /See:/ 'newCustomAppConfig' smart constructor.
newtype CustomAppConfig = CustomAppConfig
    {
      -- | Optional. User uninstall settings of the custom app.
      userUninstallSettings :: (Core.Maybe CustomAppConfig_UserUninstallSettings)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'CustomAppConfig' with the minimum fields required to make a request.
newCustomAppConfig 
    ::  CustomAppConfig
newCustomAppConfig
  = CustomAppConfig{userUninstallSettings = Core.Nothing}
instance Core.FromJSON CustomAppConfig where
        parseJSON
          = Core.withObject "CustomAppConfig"
              (\ o ->
                 CustomAppConfig Core.<$> (o Core..:? "userUninstallSettings"))

instance Core.ToJSON CustomAppConfig where
        toJSON CustomAppConfig{..}
          = Core.object
              (Core.catMaybes
                 [("userUninstallSettings" Core..=) Core.<$> userUninstallSettings])
...
data ListOperationsResponse = ListOperationsResponse
    ...
    , operations :: (Core.Maybe [Operation])
      -- | Unordered list. Unreachable resources. Populated when the request sets ListOperationsRequest.return/partial/success and reads across collections e.g. when attempting to list all resources across all supported locations.
...
newtype Role = Role
    {
      ...
      roleType :: (Core.Maybe Role_RoleType)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newRole 
    ::  Role
newRole = Role{roleType = Core.Nothing}
instance Core.FromJSON Role where
        parseJSON
          = Core.withObject "Role"
              (\ o -> Role Core.<$> (o Core..:? "roleType"))

instance Core.ToJSON Role where
        toJSON Role{..}
          = Core.object
              (Core.catMaybes [("roleType" Core..=) Core.<$> roleType])
...
--
-- /See:/ 'newWipeParams' smart constructor.
data WipeParams = WipeParams
    {
      -- | Optional. Flags to determine what data to wipe.
      wipeDataFlags :: (Core.Maybe [WipeParams_WipeDataFlagsItem])
    ...
    , wipeReason :: (Core.Maybe UserFacingMessage)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'WipeParams' with the minimum fields required to make a request.
newWipeParams 
    ::  WipeParams
newWipeParams
  = WipeParams{wipeDataFlags = Core.Nothing,
               wipeReason = Core.Nothing}
instance Core.FromJSON WipeParams where
        parseJSON
          = Core.withObject "WipeParams"
              (\ o ->
                 WipeParams Core.<$>
                   (o Core..:? "wipeDataFlags") Core.<*> (o Core..:? "wipeReason"))

instance Core.ToJSON WipeParams where
        toJSON WipeParams{..}
          = Core.object
              (Core.catMaybes
                 [("wipeDataFlags" Core..=) Core.<$> wipeDataFlags,
                  ("wipeReason" Core..=) Core.<$> wipeReason])
