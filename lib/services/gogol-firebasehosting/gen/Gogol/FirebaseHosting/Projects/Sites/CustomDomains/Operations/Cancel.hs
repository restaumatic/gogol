...
newFirebaseHostingProjectsSitesCustomDomainsOperationsCancel 
    ...
    -> FirebaseHostingProjectsSitesCustomDomainsOperationsCancel
newFirebaseHostingProjectsSitesCustomDomainsOperationsCancel name
  payload
  = FirebaseHostingProjectsSitesCustomDomainsOperationsCancel{xgafv =
                                                                Core.Nothing,
...
instance Core.GoogleRequest
           FirebaseHostingProjectsSitesCustomDomainsOperationsCancel
         where
        type Rs FirebaseHostingProjectsSitesCustomDomainsOperationsCancel =
             Empty
        type Scopes
               FirebaseHostingProjectsSitesCustomDomainsOperationsCancel
