...
newAccelerator 
    ::  Accelerator
newAccelerator
  = Accelerator{count = Core.Nothing, type' = Core.Nothing}
...
newAction 
    ::  Action
newAction
  = Action{commands = Core.Nothing, credentials = Core.Nothing,
           encryptedEnvironment = Core.Nothing, entrypoint = Core.Nothing,
           environment = Core.Nothing, flags = Core.Nothing,
           imageUri = Core.Nothing, labels = Core.Nothing,
           mounts = Core.Nothing, name = Core.Nothing,
           pidNamespace = Core.Nothing, portMappings = Core.Nothing,
...
instance Core.FromJSON Action where
        parseJSON
          = Core.withObject "Action"
              (\ o ->
                 Action Core.<$>
                   (o Core..:? "commands") Core.<*> (o Core..:? "credentials")
          ...
          = Core.object
              (Core.catMaybes
                 [("commands" Core..=) Core.<$> commands,
                  ...
                  ("encryptedEnvironment" Core..=) Core.<$> encryptedEnvironment,
                  ("entrypoint" Core..=) Core.<$> entrypoint,
                  ("environment" Core..=) Core.<$> environment,
                  ("flags" Core..=) Core.<$> flags,
                  ("imageUri" Core..=) Core.<$> imageUri,
                  ("labels" Core..=) Core.<$> labels,
                  ("mounts" Core..=) Core.<$> mounts, ("name" Core..=) Core.<$> name,
...
newAction_Environment 
    :: 
       ...
       -- ^  See 'additional'.
    -> Action_Environment
newAction_Environment additional
  = Action_Environment{additional = additional}
instance Core.FromJSON Action_Environment where
        parseJSON
          = Core.withObject "Action_Environment"
              (\ o -> Action_Environment Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON Action_Environment where
        toJSON Action_Environment{..} = Core.toJSON additional
...
newAction_Labels 
    :: 
       ...
       -- ^  See 'additional'.
    -> Action_Labels
newAction_Labels additional
  = Action_Labels{additional = additional}
instance Core.FromJSON Action_Labels where
        parseJSON
          = Core.withObject "Action_Labels"
              (\ o -> Action_Labels Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON Action_Labels where
        toJSON Action_Labels{..} = Core.toJSON additional
...
newAction_PortMappings 
    :: 
       ...
       -- ^  See 'additional'.
    -> Action_PortMappings
newAction_PortMappings additional
  = Action_PortMappings{additional = additional}
instance Core.FromJSON Action_PortMappings where
        parseJSON
          = Core.withObject "Action_PortMappings"
              (\ o -> Action_PortMappings Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON Action_PortMappings where
        toJSON Action_PortMappings{..} = Core.toJSON additional
...
newCheckInRequest 
    ::  CheckInRequest
newCheckInRequest
  = CheckInRequest{deadlineExpired = Core.Nothing,
                   event = Core.Nothing, events = Core.Nothing, result = Core.Nothing,
                   sosReport = Core.Nothing, workerStatus = Core.Nothing}
instance Core.FromJSON CheckInRequest where
        parseJSON
          = Core.withObject "CheckInRequest"
              (\ o ->
                 CheckInRequest Core.<$>
                   (o Core..:? "deadlineExpired") Core.<*> (o Core..:? "event")
                     Core.<*> (o Core..:? "events")
                     Core.<*> (o Core..:? "result")
...
instance Core.ToJSON CheckInRequest where
        toJSON CheckInRequest{..}
          = Core.object
              (Core.catMaybes
                 [("deadlineExpired" Core..=) Core.<$> deadlineExpired,
...
newCheckInRequest_Event 
    ...
    -> CheckInRequest_Event
newCheckInRequest_Event additional
  = CheckInRequest_Event{additional = additional}
instance Core.FromJSON CheckInRequest_Event where
        parseJSON
          = Core.withObject "CheckInRequest_Event"
              (\ o -> CheckInRequest_Event Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON CheckInRequest_Event where
        toJSON CheckInRequest_Event{..} = Core.toJSON additional
...
newCheckInResponse 
    ::  CheckInResponse
newCheckInResponse
  = CheckInResponse{deadline = Core.Nothing, features = Core.Nothing,
                    metadata = Core.Nothing}
instance Core.FromJSON CheckInResponse where
        parseJSON
          = Core.withObject "CheckInResponse"
              (\ o ->
                 CheckInResponse Core.<$>
                   (o Core..:? "deadline") Core.<*> (o Core..:? "features") Core.<*>
                     (o Core..:? "metadata"))
...
newCheckInResponse_Features 
    :: 
       ...
       -- ^  Properties of the object. Contains field \@type with type URL. See 'additional'.
    -> CheckInResponse_Features
newCheckInResponse_Features additional
  = CheckInResponse_Features{additional = additional}
instance Core.FromJSON CheckInResponse_Features where
        parseJSON
          = Core.withObject "CheckInResponse_Features"
              (\ o -> CheckInResponse_Features Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON CheckInResponse_Features where
        toJSON CheckInResponse_Features{..} = Core.toJSON additional
...
newCheckInResponse_Metadata 
    :: 
       ...
       -- ^  Properties of the object. Contains field \@type with type URL. See 'additional'.
    -> CheckInResponse_Metadata
newCheckInResponse_Metadata additional
  = CheckInResponse_Metadata{additional = additional}
instance Core.FromJSON CheckInResponse_Metadata where
        parseJSON
          = Core.withObject "CheckInResponse_Metadata"
              (\ o -> CheckInResponse_Metadata Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON CheckInResponse_Metadata where
        toJSON CheckInResponse_Metadata{..} = Core.toJSON additional
...
newContainerKilledEvent 
    ::  ContainerKilledEvent
newContainerKilledEvent
  = ContainerKilledEvent{actionId = Core.Nothing}
instance Core.FromJSON ContainerKilledEvent where
        parseJSON
          = Core.withObject "ContainerKilledEvent"
              (\ o -> ContainerKilledEvent Core.<$> (o Core..:? "actionId"))

instance Core.ToJSON ContainerKilledEvent where
        toJSON ContainerKilledEvent{..}
          = Core.object
              (Core.catMaybes [("actionId" Core..=) Core.<$> actionId])
...
newContainerStartedEvent 
    ::  ContainerStartedEvent
newContainerStartedEvent
  = ContainerStartedEvent{actionId = Core.Nothing,
                          ipAddress = Core.Nothing, portMappings = Core.Nothing}
instance Core.FromJSON ContainerStartedEvent where
        parseJSON
          = Core.withObject "ContainerStartedEvent"
              (\ o ->
                 ContainerStartedEvent Core.<$>
                   (o Core..:? "actionId") Core.<*> (o Core..:? "ipAddress") Core.<*>
                     (o Core..:? "portMappings"))
...
newContainerStartedEvent_PortMappings 
    :: 
       ...
       -- ^  See 'additional'.
    -> ContainerStartedEvent_PortMappings
newContainerStartedEvent_PortMappings additional
  = ContainerStartedEvent_PortMappings{additional = additional}
instance Core.FromJSON ContainerStartedEvent_PortMappings where
        parseJSON
          = Core.withObject "ContainerStartedEvent_PortMappings"
              (\ o ->
                 ContainerStartedEvent_PortMappings Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON ContainerStartedEvent_PortMappings where
...
newContainerStoppedEvent 
    ::  ContainerStoppedEvent
newContainerStoppedEvent
  = ContainerStoppedEvent{actionId = Core.Nothing,
                          exitStatus = Core.Nothing, stderr = Core.Nothing}
instance Core.FromJSON ContainerStoppedEvent where
        parseJSON
          = Core.withObject "ContainerStoppedEvent"
              (\ o ->
                 ContainerStoppedEvent Core.<$>
                   (o Core..:? "actionId") Core.<*> (o Core..:? "exitStatus") Core.<*>
                     (o Core..:? "stderr"))
...
newDelayedEvent 
    ::  DelayedEvent
newDelayedEvent
  = DelayedEvent{cause = Core.Nothing, metrics = Core.Nothing}
instance Core.FromJSON DelayedEvent where
        parseJSON
          = Core.withObject "DelayedEvent"
              (\ o ->
                 DelayedEvent Core.<$>
                   (o Core..:? "cause") Core.<*> (o Core..:? "metrics"))
...
newDisk 
    ::  Disk
newDisk
  = Disk{name = Core.Nothing, sizeGb = Core.Nothing,
         sourceImage = Core.Nothing, type' = Core.Nothing}
...
newDiskStatus 
    ::  DiskStatus
newDiskStatus
  = DiskStatus{freeSpaceBytes = Core.Nothing,
               totalSpaceBytes = Core.Nothing}
instance Core.FromJSON DiskStatus where
        parseJSON
          = Core.withObject "DiskStatus"
              (\ o ->
                 DiskStatus Core.<$>
                   (o Core..:? "freeSpaceBytes" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "totalSpaceBytes" Core.<&> Core.fmap Core.fromAsText))

instance Core.ToJSON DiskStatus where
        toJSON DiskStatus{..}
          = Core.object
              (Core.catMaybes
                 [("freeSpaceBytes" Core..=) Core.. Core.AsText Core.<$>
                    freeSpaceBytes,
                  ("totalSpaceBytes" Core..=) Core.. Core.AsText Core.<$>
                    totalSpaceBytes])
...
newEvent 
    ::  Event
newEvent
  = Event{description = Core.Nothing, details = Core.Nothing,
...
instance Core.FromJSON Event where
        parseJSON
          = Core.withObject "Event"
              (\ o ->
                 Event Core.<$>
                   (o Core..:? "description") Core.<*> (o Core..:? "details") Core.<*>
                     (o Core..:? "timestamp"))
...
newEvent_Details 
    :: 
       ...
       -- ^  Properties of the object. Contains field \@type with type URL. See 'additional'.
    -> Event_Details
newEvent_Details additional
  = Event_Details{additional = additional}
instance Core.FromJSON Event_Details where
        parseJSON
          = Core.withObject "Event_Details"
              (\ o -> Event_Details Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON Event_Details where
        toJSON Event_Details{..} = Core.toJSON additional
...
instance Core.FromJSON ExistingDisk where
        parseJSON
          = Core.withObject "ExistingDisk"
              (\ o -> ExistingDisk Core.<$> (o Core..:? "disk"))

instance Core.ToJSON ExistingDisk where
        toJSON ExistingDisk{..}
          = Core.object (Core.catMaybes [("disk" Core..=) Core.<$> disk])
...
newFailedEvent 
    ::  FailedEvent
newFailedEvent
  = FailedEvent{cause = Core.Nothing, code = Core.Nothing}
instance Core.FromJSON FailedEvent where
        parseJSON
          = Core.withObject "FailedEvent"
              (\ o ->
                 FailedEvent Core.<$>
                   (o Core..:? "cause") Core.<*> (o Core..:? "code"))

instance Core.ToJSON FailedEvent where
        toJSON FailedEvent{..}
          = Core.object
              (Core.catMaybes
                 [("cause" Core..=) Core.<$> cause, ("code" Core..=) Core.<$> code])
...
newMetadata 
    ::  Metadata
newMetadata
  = Metadata{createTime = Core.Nothing, endTime = Core.Nothing,
             events = Core.Nothing, labels = Core.Nothing,
             pipeline = Core.Nothing, startTime = Core.Nothing}
...
newMetadata_Labels 
    :: 
       ...
       -- ^  See 'additional'.
    -> Metadata_Labels
newMetadata_Labels additional
  = Metadata_Labels{additional = additional}
instance Core.FromJSON Metadata_Labels where
        parseJSON
          = Core.withObject "Metadata_Labels"
              (\ o -> Metadata_Labels Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON Metadata_Labels where
        toJSON Metadata_Labels{..} = Core.toJSON additional
...
newMount 
    ::  Mount
newMount
  = Mount{disk = Core.Nothing, path = Core.Nothing,
          readOnly = Core.Nothing}
instance Core.FromJSON Mount where
        parseJSON
          = Core.withObject "Mount"
              (\ o ->
                 Mount Core.<$>
                   (o Core..:? "disk") Core.<*> (o Core..:? "path") Core.<*>
                     (o Core..:? "readOnly"))
...
instance Core.ToJSON Mount where
        toJSON Mount{..}
          = Core.object
              (Core.catMaybes
                 [("disk" Core..=) Core.<$> disk, ("path" Core..=) Core.<$> path,
...
instance Core.FromJSON NFSMount where
        parseJSON
          = Core.withObject "NFSMount"
              (\ o -> NFSMount Core.<$> (o Core..:? "target"))

instance Core.ToJSON NFSMount where
        toJSON NFSMount{..}
          = Core.object (Core.catMaybes [("target" Core..=) Core.<$> target])
...
newNetwork 
    ::  Network
newNetwork
  = Network{name = Core.Nothing, subnetwork = Core.Nothing,
...
instance Core.FromJSON Network where
        parseJSON
          = Core.withObject "Network"
              (\ o ->
                 Network Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "subnetwork") Core.<*>
                     (o Core..:? "usePrivateAddress"))
          ...
          = Core.object
              (Core.catMaybes
                 [("name" Core..=) Core.<$> name,
                  ...
                  ("usePrivateAddress" Core..=) Core.<$> usePrivateAddress])
...
newPersistentDisk 
    ::  PersistentDisk
newPersistentDisk
  = PersistentDisk{sizeGb = Core.Nothing, sourceImage = Core.Nothing,
                   type' = Core.Nothing}
instance Core.FromJSON PersistentDisk where
        parseJSON
          = Core.withObject "PersistentDisk"
              (\ o ->
                 PersistentDisk Core.<$>
                   (o Core..:? "sizeGb") Core.<*> (o Core..:? "sourceImage") Core.<*>
                     (o Core..:? "type"))
...
newPipeline 
    ::  Pipeline
newPipeline
  = Pipeline{actions = Core.Nothing,
             encryptedEnvironment = Core.Nothing, environment = Core.Nothing,
             resources = Core.Nothing, timeout = Core.Nothing}
instance Core.FromJSON Pipeline where
        parseJSON
          = Core.withObject "Pipeline"
              (\ o ->
                 Pipeline Core.<$>
                   (o Core..:? "actions") Core.<*> (o Core..:? "encryptedEnvironment")
                     Core.<*> (o Core..:? "environment")
...
newPipeline_Environment 
    :: 
       ...
       -- ^  See 'additional'.
    -> Pipeline_Environment
newPipeline_Environment additional
  = Pipeline_Environment{additional = additional}
instance Core.FromJSON Pipeline_Environment where
        parseJSON
          = Core.withObject "Pipeline_Environment"
              (\ o -> Pipeline_Environment Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON Pipeline_Environment where
        toJSON Pipeline_Environment{..} = Core.toJSON additional
...
instance Core.FromJSON PullStartedEvent where
        parseJSON
          = Core.withObject "PullStartedEvent"
              (\ o -> PullStartedEvent Core.<$> (o Core..:? "imageUri"))

instance Core.ToJSON PullStartedEvent where
        toJSON PullStartedEvent{..}
          = Core.object
              (Core.catMaybes [("imageUri" Core..=) Core.<$> imageUri])
...
instance Core.FromJSON PullStoppedEvent where
        parseJSON
          = Core.withObject "PullStoppedEvent"
              (\ o -> PullStoppedEvent Core.<$> (o Core..:? "imageUri"))
...
newResources 
    ::  Resources
newResources
  = Resources{projectId = Core.Nothing, regions = Core.Nothing,
              virtualMachine = Core.Nothing, zones = Core.Nothing}
instance Core.FromJSON Resources where
        parseJSON
          = Core.withObject "Resources"
              (\ o ->
                 Resources Core.<$>
                   (o Core..:? "projectId") Core.<*> (o Core..:? "regions") Core.<*>
                     (o Core..:? "virtualMachine")
                     Core.<*> (o Core..:? "zones"))
...
newRunPipelineRequest 
    ::  RunPipelineRequest
newRunPipelineRequest
  = RunPipelineRequest{labels = Core.Nothing,
                       pipeline = Core.Nothing, pubSubTopic = Core.Nothing}
instance Core.FromJSON RunPipelineRequest where
        parseJSON
          = Core.withObject "RunPipelineRequest"
              (\ o ->
                 RunPipelineRequest Core.<$>
                   (o Core..:? "labels") Core.<*> (o Core..:? "pipeline") Core.<*>
                     (o Core..:? "pubSubTopic"))
...
newRunPipelineRequest_Labels 
    :: 
       ...
       -- ^  See 'additional'.
    -> RunPipelineRequest_Labels
newRunPipelineRequest_Labels additional
  = RunPipelineRequest_Labels{additional = additional}
instance Core.FromJSON RunPipelineRequest_Labels where
        parseJSON
          = Core.withObject "RunPipelineRequest_Labels"
              (\ o ->
                 RunPipelineRequest_Labels Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON RunPipelineRequest_Labels where
        toJSON RunPipelineRequest_Labels{..} = Core.toJSON additional
...
instance Core.FromJSON RunPipelineResponse where
        parseJSON
          = Core.withObject "RunPipelineResponse"
...
newSecret 
    ::  Secret
newSecret
  = Secret{cipherText = Core.Nothing, keyName = Core.Nothing}
instance Core.FromJSON Secret where
        parseJSON
          = Core.withObject "Secret"
              (\ o ->
                 Secret Core.<$>
                   (o Core..:? "cipherText") Core.<*> (o Core..:? "keyName"))
...
newServiceAccount 
    ::  ServiceAccount
newServiceAccount
  = ServiceAccount{email = Core.Nothing, scopes = Core.Nothing}
instance Core.FromJSON ServiceAccount where
        parseJSON
          = Core.withObject "ServiceAccount"
              (\ o ->
                 ServiceAccount Core.<$>
                   (o Core..:? "email") Core.<*> (o Core..:? "scopes"))
...
instance Core.FromJSON TimestampedEvent where
        parseJSON
          = Core.withObject "TimestampedEvent"
              (\ o ->
                 TimestampedEvent Core.<$>
                   (o Core..:? "data") Core.<*> (o Core..:? "timestamp"))
...
newTimestampedEvent_Data 
    :: 
       ...
       -- ^  Properties of the object. Contains field \@type with type URL. See 'additional'.
    -> TimestampedEvent_Data
newTimestampedEvent_Data additional
  = TimestampedEvent_Data{additional = additional}
instance Core.FromJSON TimestampedEvent_Data where
        parseJSON
          = Core.withObject "TimestampedEvent_Data"
              (\ o -> TimestampedEvent_Data Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON TimestampedEvent_Data where
        toJSON TimestampedEvent_Data{..} = Core.toJSON additional
...
newUnexpectedExitStatusEvent 
    ::  UnexpectedExitStatusEvent
newUnexpectedExitStatusEvent
  = UnexpectedExitStatusEvent{actionId = Core.Nothing,
                              exitStatus = Core.Nothing}
instance Core.FromJSON UnexpectedExitStatusEvent where
        parseJSON
          = Core.withObject "UnexpectedExitStatusEvent"
              (\ o ->
                 UnexpectedExitStatusEvent Core.<$>
                   (o Core..:? "actionId") Core.<*> (o Core..:? "exitStatus"))
...
newVirtualMachine 
    ::  VirtualMachine
newVirtualMachine
  = VirtualMachine{accelerators = Core.Nothing,
                   bootDiskSizeGb = Core.Nothing, bootImage = Core.Nothing,
                   cpuPlatform = Core.Nothing, disks = Core.Nothing,
                   dockerCacheImages = Core.Nothing,
                   enableStackdriverMonitoring = Core.Nothing, labels = Core.Nothing,
                   machineType = Core.Nothing, network = Core.Nothing,
                   nvidiaDriverVersion = Core.Nothing, preemptible = Core.Nothing,
                   reservation = Core.Nothing, serviceAccount = Core.Nothing,
                   volumes = Core.Nothing}
instance Core.FromJSON VirtualMachine where
        parseJSON
          = Core.withObject "VirtualMachine"
              (\ o ->
                 VirtualMachine Core.<$>
                   (o Core..:? "accelerators") Core.<*> (o Core..:? "bootDiskSizeGb")
...
newVirtualMachine_Labels 
    :: 
       ...
       -- ^  See 'additional'.
    -> VirtualMachine_Labels
newVirtualMachine_Labels additional
  = VirtualMachine_Labels{additional = additional}
instance Core.FromJSON VirtualMachine_Labels where
        parseJSON
          = Core.withObject "VirtualMachine_Labels"
              (\ o -> VirtualMachine_Labels Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON VirtualMachine_Labels where
        toJSON VirtualMachine_Labels{..} = Core.toJSON additional
...
newVolume 
    ::  Volume
newVolume
  = Volume{existingDisk = Core.Nothing, nfsMount = Core.Nothing,
           persistentDisk = Core.Nothing, volume = Core.Nothing}
instance Core.FromJSON Volume where
        parseJSON
          = Core.withObject "Volume"
              (\ o ->
                 Volume Core.<$>
                   (o Core..:? "existingDisk") Core.<*> (o Core..:? "nfsMount")
...
newWorkerAssignedEvent 
    ::  WorkerAssignedEvent
newWorkerAssignedEvent
  = WorkerAssignedEvent{instance' = Core.Nothing,
                        machineType = Core.Nothing, zone = Core.Nothing}
instance Core.FromJSON WorkerAssignedEvent where
        parseJSON
          = Core.withObject "WorkerAssignedEvent"
              (\ o ->
                 WorkerAssignedEvent Core.<$>
                   (o Core..:? "instance") Core.<*> (o Core..:? "machineType")
                     Core.<*> (o Core..:? "zone"))
...
newWorkerReleasedEvent 
    ::  WorkerReleasedEvent
newWorkerReleasedEvent
  = WorkerReleasedEvent{instance' = Core.Nothing,
                        zone = Core.Nothing}
instance Core.FromJSON WorkerReleasedEvent where
        parseJSON
          = Core.withObject "WorkerReleasedEvent"
              (\ o ->
                 WorkerReleasedEvent Core.<$>
                   (o Core..:? "instance") Core.<*> (o Core..:? "zone"))
...
newWorkerStatus 
    ::  WorkerStatus
newWorkerStatus
  = WorkerStatus{attachedDisks = Core.Nothing,
                 bootDisk = Core.Nothing, freeRamBytes = Core.Nothing,
                 totalRamBytes = Core.Nothing, uptimeSeconds = Core.Nothing}
instance Core.FromJSON WorkerStatus where
        parseJSON
          = Core.withObject "WorkerStatus"
              (\ o ->
                 WorkerStatus Core.<$>
                   (o Core..:? "attachedDisks") Core.<*> (o Core..:? "bootDisk")
                     Core.<*>
                     (o Core..:? "freeRamBytes" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "totalRamBytes" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "uptimeSeconds" Core.<&> Core.fmap Core.fromAsText))
          ...
          = Core.object
              (Core.catMaybes
                 [("attachedDisks" Core..=) Core.<$> attachedDisks,
                  ...
                  ("freeRamBytes" Core..=) Core.. Core.AsText Core.<$> freeRamBytes,
                  ("totalRamBytes" Core..=) Core.. Core.AsText Core.<$>
                    totalRamBytes,
                  ("uptimeSeconds" Core..=) Core.. Core.AsText Core.<$>
                    uptimeSeconds])
...
newtype WorkerStatus_AttachedDisks = WorkerStatus_AttachedDisks
    {
      ...
      additional :: (Core.HashMap Core.Text DiskStatus)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newWorkerStatus_AttachedDisks 
    :: 
       ...
       -- ^  See 'additional'.
    -> WorkerStatus_AttachedDisks
newWorkerStatus_AttachedDisks additional
  = WorkerStatus_AttachedDisks{additional = additional}
instance Core.FromJSON WorkerStatus_AttachedDisks where
        parseJSON
          = Core.withObject "WorkerStatus_AttachedDisks"
              (\ o ->
                 WorkerStatus_AttachedDisks Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON WorkerStatus_AttachedDisks where
        toJSON WorkerStatus_AttachedDisks{..} = Core.toJSON additional
