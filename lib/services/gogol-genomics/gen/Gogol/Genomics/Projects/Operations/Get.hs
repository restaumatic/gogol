...
instance Core.GoogleRequest GenomicsProjectsOperationsGet where
        ...
        requestClient GenomicsProjectsOperationsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy GenomicsProjectsOperationsGetResource)
                      Core.mempty
