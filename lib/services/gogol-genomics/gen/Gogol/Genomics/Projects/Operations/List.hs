...
newGenomicsProjectsOperationsList name
  = GenomicsProjectsOperationsList{xgafv = Core.Nothing,
                                   accessToken = Core.Nothing, callback = Core.Nothing,
                                   filter = Core.Nothing, name = name, pageSize = Core.Nothing,
                                   pageToken = Core.Nothing, uploadType = Core.Nothing,
                                   uploadProtocol = Core.Nothing}
instance Core.GoogleRequest GenomicsProjectsOperationsList where
        type Rs GenomicsProjectsOperationsList = ListOperationsResponse
        type Scopes GenomicsProjectsOperationsList =
        ...
        requestClient GenomicsProjectsOperationsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy GenomicsProjectsOperationsListResource)
                      Core.mempty
