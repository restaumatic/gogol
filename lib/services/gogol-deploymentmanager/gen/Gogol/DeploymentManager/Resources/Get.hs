...
newDeploymentManagerResourcesGet deployment project resource
  = DeploymentManagerResourcesGet{xgafv = Core.Nothing,
                                  accessToken = Core.Nothing, callback = Core.Nothing,
                                  deployment = deployment, headerBypassBillingFilter = Core.Nothing,
                                  project = project, resource = resource, uploadType = Core.Nothing,
...
instance Core.GoogleRequest DeploymentManagerResourcesGet where
        ...
        requestClient DeploymentManagerResourcesGet{..}
          = go project deployment resource xgafv accessToken callback
