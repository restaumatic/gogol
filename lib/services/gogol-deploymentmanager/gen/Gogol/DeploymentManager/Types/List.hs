...
newDeploymentManagerTypesList project
  = DeploymentManagerTypesList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DeploymentManagerTypesList where
        type Rs DeploymentManagerTypesList = TypesListResponse
        ...
        requestClient DeploymentManagerTypesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy DeploymentManagerTypesListResource)
                      Core.mempty
