...
newDeploymentManagerOperationsList project
  = DeploymentManagerOperationsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DeploymentManagerOperationsList where
        type Rs DeploymentManagerOperationsList = OperationsListResponse
        ...
        requestClient DeploymentManagerOperationsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy DeploymentManagerOperationsListResource)
                      Core.mempty
