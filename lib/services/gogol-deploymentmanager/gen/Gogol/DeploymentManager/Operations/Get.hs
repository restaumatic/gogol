...
newDeploymentManagerOperationsGet operation project
  = DeploymentManagerOperationsGet{xgafv = Core.Nothing,
                                   accessToken = Core.Nothing, callback = Core.Nothing,
                                   headerBypassBillingFilter = Core.Nothing, operation = operation,
                                   project = project, uploadType = Core.Nothing,
                                   uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DeploymentManagerOperationsGet where
        ...
        requestClient DeploymentManagerOperationsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy DeploymentManagerOperationsGetResource)
                      Core.mempty
