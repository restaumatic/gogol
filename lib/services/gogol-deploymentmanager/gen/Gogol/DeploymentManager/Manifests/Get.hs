...
newDeploymentManagerManifestsGet deployment manifest project
  = DeploymentManagerManifestsGet{xgafv = Core.Nothing,
                                  accessToken = Core.Nothing, callback = Core.Nothing,
                                  deployment = deployment, headerBypassBillingFilter = Core.Nothing,
                                  manifest = manifest, project = project, uploadType = Core.Nothing,
...
instance Core.GoogleRequest DeploymentManagerManifestsGet where
        ...
        requestClient DeploymentManagerManifestsGet{..}
          = go project deployment manifest xgafv accessToken callback
