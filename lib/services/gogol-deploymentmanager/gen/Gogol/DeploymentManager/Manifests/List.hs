                                   ...
                                   Core.QueryParam "uploadType" Core.Text Core.:>
                                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                                       Core.QueryParam "alt" Core.AltJSON Core.:>
                                         Core.Get '[Core.JSON] ManifestsListResponse
...
newDeploymentManagerManifestsList deployment project
  = DeploymentManagerManifestsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DeploymentManagerManifestsList where
        type Rs DeploymentManagerManifestsList = ManifestsListResponse
        ...
        requestClient DeploymentManagerManifestsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy DeploymentManagerManifestsListResource)
                      Core.mempty
