...
module Gogol.DeploymentManager.Internal.Product
  (
    ...
    -- * SetAutoscalerLinkOperationMetadata_ZoneToIgmIds
    SetAutoscalerLinkOperationMetadata_ZoneToIgmIds (..),
    newSetAutoscalerLinkOperationMetadata_ZoneToIgmIds,
...
data SetAutoscalerLinkOperationMetadata = SetAutoscalerLinkOperationMetadata
    {
    ...
    , zoneToIgmIds :: (Core.Maybe SetAutoscalerLinkOperationMetadata_ZoneToIgmIds)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
          ...
          = Core.object
              (Core.catMaybes
                 [("zonalIgmIds" Core..=) Core.. Core.fmap Core.AsText Core.<$>
                    zonalIgmIds,
                  ("zoneToIgmIds" Core..=) Core.<$> zoneToIgmIds])


-- | Map of zone to an ID of the zonal IGM belonging to the RMIG.
--
-- /See:/ 'newSetAutoscalerLinkOperationMetadata_ZoneToIgmIds' smart constructor.
newtype SetAutoscalerLinkOperationMetadata_ZoneToIgmIds = SetAutoscalerLinkOperationMetadata_ZoneToIgmIds
    {
...
-- | Creates a value of 'SetAutoscalerLinkOperationMetadata_ZoneToIgmIds' with the minimum fields required to make a request.
newSetAutoscalerLinkOperationMetadata_ZoneToIgmIds 
    :: 
                                                   Core.HashMap Core.Text Core.Int64
       -- ^  See 'additional'.
    -> SetAutoscalerLinkOperationMetadata_ZoneToIgmIds
newSetAutoscalerLinkOperationMetadata_ZoneToIgmIds additional
  = SetAutoscalerLinkOperationMetadata_ZoneToIgmIds{additional =
                                                      additional}
instance Core.FromJSON
           SetAutoscalerLinkOperationMetadata_ZoneToIgmIds
         where
        parseJSON
          = Core.withObject "SetAutoscalerLinkOperationMetadata_ZoneToIgmIds"
              (\ o ->
                 SetAutoscalerLinkOperationMetadata_ZoneToIgmIds Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON
           SetAutoscalerLinkOperationMetadata_ZoneToIgmIds
         where
        toJSON SetAutoscalerLinkOperationMetadata_ZoneToIgmIds{..}
          = Core.toJSON additional
