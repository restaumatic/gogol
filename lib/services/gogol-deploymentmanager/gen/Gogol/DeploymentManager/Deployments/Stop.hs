                           ...
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.ReqBody '[Core.JSON] DeploymentsStopRequest Core.:>
...
newDeploymentManagerDeploymentsStop deployment payload project
  = DeploymentManagerDeploymentsStop{xgafv = Core.Nothing,
                                     accessToken = Core.Nothing, callback = Core.Nothing,
                                     deployment = deployment, payload = payload, project = project,
