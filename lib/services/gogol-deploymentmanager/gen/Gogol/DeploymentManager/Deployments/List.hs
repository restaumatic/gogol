                               ...
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.Get '[Core.JSON] DeploymentsListResponse
...
newDeploymentManagerDeploymentsList project
  = DeploymentManagerDeploymentsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest DeploymentManagerDeploymentsList where
        type Rs DeploymentManagerDeploymentsList = DeploymentsListResponse
        ...
        requestClient DeploymentManagerDeploymentsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy DeploymentManagerDeploymentsListResource)
                      Core.mempty
