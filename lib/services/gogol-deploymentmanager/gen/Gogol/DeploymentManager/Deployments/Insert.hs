                 ...
                 Core.QueryParam "$.xgafv" Xgafv Core.:>
                   Core.QueryParam "access_token" Core.Text Core.:>
                     Core.QueryParam "callback" Core.Text Core.:>
                       Core.QueryParam "createPolicy" DeploymentsInsertCreatePolicy
                         Core.:>
...
newDeploymentManagerDeploymentsInsert payload project
  = DeploymentManagerDeploymentsInsert{xgafv = Core.Nothing,
                                       ...
                                       preview = Core.Nothing, project = project,
                                       uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DeploymentManagerDeploymentsInsert
         where
        ...
        requestClient DeploymentManagerDeploymentsInsert{..}
          = go project xgafv accessToken callback (Core.Just createPolicy)
