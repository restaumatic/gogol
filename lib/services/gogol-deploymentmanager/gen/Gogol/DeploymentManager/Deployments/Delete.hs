                   ...
                   Core.QueryParam "$.xgafv" Xgafv Core.:>
                     Core.QueryParam "access_token" Core.Text Core.:>
                       Core.QueryParam "callback" Core.Text Core.:>
                         Core.QueryParam "deletePolicy" DeploymentsDeleteDeletePolicy
                           Core.:>
...
newDeploymentManagerDeploymentsDelete deployment project
  = DeploymentManagerDeploymentsDelete{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       deletePolicy = DeploymentsDeleteDeletePolicy_Delete',
                                       deployment = deployment,
                                       headerBypassBillingFilter = Core.Nothing, project = project,
                                       uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DeploymentManagerDeploymentsDelete
         where
        type Rs DeploymentManagerDeploymentsDelete = Operation
        ...
        requestClient DeploymentManagerDeploymentsDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DeploymentManagerDeploymentsDeleteResource)
                      Core.mempty
