                   ...
                   Core.QueryParam "$.xgafv" Xgafv Core.:>
                     Core.QueryParam "access_token" Core.Text Core.:>
                       Core.QueryParam "callback" Core.Text Core.:>
                         Core.QueryParam "createPolicy" DeploymentsPatchCreatePolicy Core.:>
                           Core.QueryParam "deletePolicy" DeploymentsPatchDeletePolicy Core.:>
...
newDeploymentManagerDeploymentsPatch deployment payload project
  = DeploymentManagerDeploymentsPatch{xgafv = Core.Nothing,
