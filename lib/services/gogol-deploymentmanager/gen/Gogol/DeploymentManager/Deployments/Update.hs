                   ...
                   Core.QueryParam "$.xgafv" Xgafv Core.:>
                     Core.QueryParam "access_token" Core.Text Core.:>
                       Core.QueryParam "callback" Core.Text Core.:>
                         Core.QueryParam "createPolicy" DeploymentsUpdateCreatePolicy
                           Core.:>
                           Core.QueryParam "deletePolicy" DeploymentsUpdateDeletePolicy
                             Core.:>
                             Core.QueryParam "header.bypassBillingFilter" Core.Bool Core.:>
...
newDeploymentManagerDeploymentsUpdate deployment payload project
  = DeploymentManagerDeploymentsUpdate{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       createPolicy = DeploymentsUpdateCreatePolicy_CREATEORACQUIRE,
                                       deletePolicy = DeploymentsUpdateDeletePolicy_Delete',
                                       deployment = deployment,
                                       headerBypassBillingFilter = Core.Nothing, payload = payload,
                                       preview = Core.False, project = project,
                                       uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest DeploymentManagerDeploymentsUpdate
         where
        type Rs DeploymentManagerDeploymentsUpdate = Operation
        ...
        requestClient DeploymentManagerDeploymentsUpdate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy DeploymentManagerDeploymentsUpdateResource)
                      Core.mempty
