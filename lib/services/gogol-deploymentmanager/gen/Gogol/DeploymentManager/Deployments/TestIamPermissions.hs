...
newDeploymentManagerDeploymentsTestIamPermissions 
    ...
    -> DeploymentManagerDeploymentsTestIamPermissions
newDeploymentManagerDeploymentsTestIamPermissions payload project
  resource
  = DeploymentManagerDeploymentsTestIamPermissions{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           DeploymentManagerDeploymentsTestIamPermissions
         where
        type Rs DeploymentManagerDeploymentsTestIamPermissions =
             TestPermissionsResponse
        type Scopes DeploymentManagerDeploymentsTestIamPermissions =
