                           ...
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.ReqBody '[Core.JSON] DeploymentsCancelPreviewRequest Core.:>
...
newDeploymentManagerDeploymentsCancelPreview 
    ...
    -> DeploymentManagerDeploymentsCancelPreview
newDeploymentManagerDeploymentsCancelPreview deployment payload
  project
  = DeploymentManagerDeploymentsCancelPreview{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        requestClient DeploymentManagerDeploymentsCancelPreview{..}
          = go project deployment xgafv accessToken callback uploadType
              uploadProtocol
