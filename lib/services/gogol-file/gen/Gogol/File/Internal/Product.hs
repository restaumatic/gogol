...
data FileShareConfig = FileShareConfig
    ...
    , sourceBackupdrBackup :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newFileShareConfig
  = FileShareConfig{capacityGb = Core.Nothing, name = Core.Nothing,
                    ...
                    sourceBackupdrBackup = Core.Nothing}
              ...
              (\ o ->
                 FileShareConfig Core.<$>
                   (o Core..:? "capacityGb" Core.<&> Core.fmap Core.fromAsText)
                     ...
                     Core.<*> (o Core..:? "sourceBackupdrBackup"))
          ...
          = Core.object
              (Core.catMaybes
                 [("capacityGb" Core..=) Core.. Core.AsText Core.<$> capacityGb,
                  ...
                  ("sourceBackupdrBackup" Core..=) Core.<$> sourceBackupdrBackup])
...
data Instance = Instance
    {
      ...
      capacityStepSizeGb :: (Core.Maybe Core.Int64)
    ...
    , maxCapacityGb :: (Core.Maybe Core.Int64)
      -- | Output only. The min capacity of the instance in GB.
    , minCapacityGb :: (Core.Maybe Core.Int64)
...
newInstance 
    ::  Instance
newInstance
  = Instance{capacityStepSizeGb = Core.Nothing,
             createTime = Core.Nothing,
             ...
             labels = Core.Nothing, maxCapacityGb = Core.Nothing,
             minCapacityGb = Core.Nothing, name = Core.Nothing,
...
instance Core.FromJSON Instance where
        parseJSON
          = Core.withObject "Instance"
              (\ o ->
                 Instance Core.<$>
                   (o Core..:? "capacityStepSizeGb" Core.<&>
                     ...
                     Core.<*> (o Core..:? "labels")
                     Core.<*>
                     (o Core..:? "maxCapacityGb" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "minCapacityGb" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "name")
...
instance Core.ToJSON Instance where
        toJSON Instance{..}
          = Core.object
              (Core.catMaybes
                 [("capacityStepSizeGb" Core..=) Core.. Core.AsText Core.<$>
                    capacityStepSizeGb,
                  ("createTime" Core..=) Core.<$> createTime,
                  ...
                  ("labels" Core..=) Core.<$> labels,
                  ("maxCapacityGb" Core..=) Core.. Core.AsText Core.<$>
                    maxCapacityGb,
                  ("minCapacityGb" Core..=) Core.. Core.AsText Core.<$>
                    minCapacityGb,
                  ("name" Core..=) Core.<$> name,
...
data NetworkConfig = NetworkConfig
    ...
    , network :: (Core.Maybe Core.Text)
      -- | Optional. Private Service Connect configuration. Should only be set when connect/mode is PRIVATE/SERVICE_CONNECT.
...
newNetworkConfig
  = NetworkConfig{connectMode = Core.Nothing,
                  ...
                  network = Core.Nothing, pscConfig = Core.Nothing,
...
newNfsExportOptions
  = NfsExportOptions{accessMode = Core.Nothing,
                     ...
                     ipRanges = Core.Nothing, network = Core.Nothing,
...
newtype PscConfig = PscConfig
    {
      ...
      endpointProject :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newPscConfig 
    ::  PscConfig
newPscConfig = PscConfig{endpointProject = Core.Nothing}
instance Core.FromJSON PscConfig where
        parseJSON
          = Core.withObject "PscConfig"
              (\ o -> PscConfig Core.<$> (o Core..:? "endpointProject"))

instance Core.ToJSON PscConfig where
        toJSON PscConfig{..}
          = Core.object
              (Core.catMaybes
                 [("endpointProject" Core..=) Core.<$> endpointProject])
...
data ReplicaConfig = ReplicaConfig
    ...
    , stateUpdateTime :: (Core.Maybe Core.DateTime)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newReplicaConfig
  = ReplicaConfig{lastActiveSyncTime = Core.Nothing,
                  ...
                  stateReasons = Core.Nothing, stateUpdateTime = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("lastActiveSyncTime" Core..=) Core.<$> lastActiveSyncTime,
                  ...
                  ("stateUpdateTime" Core..=) Core.<$> stateUpdateTime])
