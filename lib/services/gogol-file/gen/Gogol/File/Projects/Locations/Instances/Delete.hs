...
newFileProjectsLocationsInstancesDelete name
  = FileProjectsLocationsInstancesDelete{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         force = Core.Nothing, name = name,
                                         uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest FileProjectsLocationsInstancesDelete
         where
        type Rs FileProjectsLocationsInstancesDelete = Operation
        type Scopes FileProjectsLocationsInstancesDelete =
             '[CloudPlatform'FullControl]
        requestClient FileProjectsLocationsInstancesDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy FileProjectsLocationsInstancesDeleteResource)
                      Core.mempty
