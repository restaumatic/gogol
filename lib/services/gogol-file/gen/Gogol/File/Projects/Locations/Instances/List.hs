...
newFileProjectsLocationsInstancesList parent
  = FileProjectsLocationsInstancesList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest FileProjectsLocationsInstancesList
         where
        type Rs FileProjectsLocationsInstancesList = ListInstancesResponse
        type Scopes FileProjectsLocationsInstancesList =
        ...
        requestClient FileProjectsLocationsInstancesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy FileProjectsLocationsInstancesListResource)
                      Core.mempty
