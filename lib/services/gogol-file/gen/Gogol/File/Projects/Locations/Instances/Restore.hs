               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] RestoreInstanceRequest Core.:>
...
newFileProjectsLocationsInstancesRestore name payload
  = FileProjectsLocationsInstancesRestore{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          name = name, payload = payload, uploadType = Core.Nothing,
                                          uploadProtocol = Core.Nothing}
instance Core.GoogleRequest FileProjectsLocationsInstancesRestore
         where
        type Rs FileProjectsLocationsInstancesRestore = Operation
        type Scopes FileProjectsLocationsInstancesRestore =
             '[CloudPlatform'FullControl]
        requestClient FileProjectsLocationsInstancesRestore{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy FileProjectsLocationsInstancesRestoreResource)
                      Core.mempty
