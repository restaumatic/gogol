...
newFileProjectsLocationsBackupsDelete name
  = FileProjectsLocationsBackupsDelete{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       name = name, uploadType = Core.Nothing,
                                       uploadProtocol = Core.Nothing}
instance Core.GoogleRequest FileProjectsLocationsBackupsDelete
         where
        type Rs FileProjectsLocationsBackupsDelete = Operation
        type Scopes FileProjectsLocationsBackupsDelete =
