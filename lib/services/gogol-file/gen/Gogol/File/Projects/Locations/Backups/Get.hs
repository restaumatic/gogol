...
newFileProjectsLocationsBackupsGet name
  = FileProjectsLocationsBackupsGet{xgafv = Core.Nothing,
                                    accessToken = Core.Nothing, callback = Core.Nothing,
                                    name = name, uploadType = Core.Nothing,
                                    uploadProtocol = Core.Nothing}
instance Core.GoogleRequest FileProjectsLocationsBackupsGet where
        type Rs FileProjectsLocationsBackupsGet = Backup
        type Scopes FileProjectsLocationsBackupsGet =
        ...
        requestClient FileProjectsLocationsBackupsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy FileProjectsLocationsBackupsGetResource)
                      Core.mempty
