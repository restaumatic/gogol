...
newFileProjectsLocationsInstancesSnapshotsCreate parent payload
  = FileProjectsLocationsInstancesSnapshotsCreate{xgafv =
                                                    Core.Nothing,
                                                  accessToken = Core.Nothing,
                                                  callback = Core.Nothing, parent = parent,
                                                  payload = payload, snapshotId = Core.Nothing,
                                                  uploadType = Core.Nothing,
                                                  uploadProtocol = Core.Nothing}
instance Core.GoogleRequest
           FileProjectsLocationsInstancesSnapshotsCreate
         where
        type Rs FileProjectsLocationsInstancesSnapshotsCreate = Operation
        type Scopes FileProjectsLocationsInstancesSnapshotsCreate =
             '[CloudPlatform'FullControl]
        requestClient FileProjectsLocationsInstancesSnapshotsCreate{..}
          = go parent xgafv accessToken callback snapshotId uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy FileProjectsLocationsInstancesSnapshotsCreateResource)
                      Core.mempty
