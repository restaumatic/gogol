...
newFileProjectsLocationsInstancesCreate parent payload
  = FileProjectsLocationsInstancesCreate{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         instanceId = Core.Nothing, parent = parent,
                                         payload = payload, uploadType = Core.Nothing,
                                         uploadProtocol = Core.Nothing}
instance Core.GoogleRequest FileProjectsLocationsInstancesCreate
         where
        type Rs FileProjectsLocationsInstancesCreate = Operation
        type Scopes FileProjectsLocationsInstancesCreate =
             '[CloudPlatform'FullControl]
        requestClient FileProjectsLocationsInstancesCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy FileProjectsLocationsInstancesCreateResource)
                      Core.mempty
