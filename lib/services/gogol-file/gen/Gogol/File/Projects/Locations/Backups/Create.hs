...
newFileProjectsLocationsBackupsCreate parent payload
  = FileProjectsLocationsBackupsCreate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest FileProjectsLocationsBackupsCreate
         where
        type Rs FileProjectsLocationsBackupsCreate = Operation
        ...
        requestClient FileProjectsLocationsBackupsCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy FileProjectsLocationsBackupsCreateResource)
                      Core.mempty
