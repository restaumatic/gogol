...
newFileProjectsLocationsBackupsList parent
  = FileProjectsLocationsBackupsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest FileProjectsLocationsBackupsList where
        type Rs FileProjectsLocationsBackupsList = ListBackupsResponse
        ...
        requestClient FileProjectsLocationsBackupsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy FileProjectsLocationsBackupsListResource)
                      Core.mempty
