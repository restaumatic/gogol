...
type FileProjectsLocationsInstancesPromoteReplicaResource =
     "v1" Core.:>
       Core.CaptureMode "name" "promoteReplica" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] PromoteReplicaRequest Core.:>
...
newFileProjectsLocationsInstancesPromoteReplica name payload
  = FileProjectsLocationsInstancesPromoteReplica{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes FileProjectsLocationsInstancesPromoteReplica =
