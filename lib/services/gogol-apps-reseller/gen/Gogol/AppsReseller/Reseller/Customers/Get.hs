...
newResellerCustomersGet customerId
  = ResellerCustomersGet{xgafv = Core.Nothing,
                         accessToken = Core.Nothing, callback = Core.Nothing,
                         customerId = customerId, uploadType = Core.Nothing,
                         uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ResellerCustomersGet where
        type Rs ResellerCustomersGet = Customer
        type Scopes ResellerCustomersGet =
        ...
        requestClient ResellerCustomersGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ResellerCustomersGetResource)
                      Core.mempty
