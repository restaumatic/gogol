...
--
-- Updates a subscription\'s user license settings. For more information about updating an annual commitment plan or a flexible plan subscription’s licenses, see <https://developers.google.com/workspace/admin/reseller/v1/how-tos/manage_subscriptions#update_subscription_seat Manage Subscriptions>.
--
...
newResellerSubscriptionsChangeSeats 
    ...
    -> ResellerSubscriptionsChangeSeats
newResellerSubscriptionsChangeSeats customerId payload
  subscriptionId
  = ResellerSubscriptionsChangeSeats{xgafv = Core.Nothing,
