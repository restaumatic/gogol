...
--
-- Lists of subscriptions managed by the reseller. The list can be all subscriptions, all of a customer\'s subscriptions, or all of a customer\'s transferable subscriptions. Optionally, this method can filter the response by a @customerNamePrefix@. For more information, see <https://developers.google.com/workspace/admin/reseller/v1/how-tos/manage_subscriptions manage subscriptions>.
--
                 ...
                 Core.QueryParam "callback" Core.Text Core.:>
                   Core.QueryParam "customerAuthToken" Core.Text Core.:>
                     Core.QueryParam "customerId" Core.Text Core.:>
                       Core.QueryParam "customerNamePrefix" Core.Text Core.:>
                         Core.QueryParam "maxResults" Core.Word32 Core.:>
                           Core.QueryParam "pageToken" Core.Text Core.:>
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.Get '[Core.JSON] Subscriptions
...
newResellerSubscriptionsList 
    ::  ResellerSubscriptionsList
newResellerSubscriptionsList
  = ResellerSubscriptionsList{xgafv = Core.Nothing,
                              accessToken = Core.Nothing, callback = Core.Nothing,
                              customerAuthToken = Core.Nothing, customerId = Core.Nothing,
                              customerNamePrefix = Core.Nothing, maxResults = Core.Nothing,
...
instance Core.GoogleRequest ResellerSubscriptionsList where
        ...
        type Scopes ResellerSubscriptionsList =
             '[Apps'Order, Apps'Order'Readonly]
        requestClient ResellerSubscriptionsList{..}
          = go xgafv accessToken callback customerAuthToken customerId
              customerNamePrefix
              maxResults
              pageToken
              uploadType
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ResellerSubscriptionsListResource)
                      Core.mempty
