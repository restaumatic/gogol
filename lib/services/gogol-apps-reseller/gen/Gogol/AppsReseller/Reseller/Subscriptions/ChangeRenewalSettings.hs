...
--
-- Updates a user license\'s renewal settings. This is applicable for accounts with annual commitment plans only. For more information, see the description in <https://developers.google.com/workspace/admin/reseller/v1/how-tos/manage_subscriptions#update_renewal manage subscriptions>.
--
                           ...
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.ReqBody '[Core.JSON] RenewalSettings Core.:>
...
newResellerSubscriptionsChangeRenewalSettings 
    ...
    -> ResellerSubscriptionsChangeRenewalSettings
newResellerSubscriptionsChangeRenewalSettings customerId payload
  subscriptionId
  = ResellerSubscriptionsChangeRenewalSettings{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           ResellerSubscriptionsChangeRenewalSettings
         where
        type Rs ResellerSubscriptionsChangeRenewalSettings = Subscription
        type Scopes ResellerSubscriptionsChangeRenewalSettings =
             '[Apps'Order]
        requestClient ResellerSubscriptionsChangeRenewalSettings{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ResellerSubscriptionsChangeRenewalSettingsResource)
                      Core.mempty
