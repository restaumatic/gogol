             ...
             Core.Capture "customerId" Core.Text Core.:>
               "subscriptions" Core.:>
                 Core.Capture "subscriptionId" Core.Text Core.:>
                   Core.QueryParam "deletionType" SubscriptionsDeleteDeletionType
                     Core.:>
...
newResellerSubscriptionsDelete 
    ...
    -> ResellerSubscriptionsDelete
newResellerSubscriptionsDelete customerId deletionType
  subscriptionId
  = ResellerSubscriptionsDelete{xgafv = Core.Nothing,
                                accessToken = Core.Nothing, callback = Core.Nothing,
                                customerId = customerId, deletionType = deletionType,
...
instance Core.GoogleRequest ResellerSubscriptionsDelete where
        ...
        requestClient ResellerSubscriptionsDelete{..}
          = go customerId subscriptionId (Core.Just deletionType) xgafv
              accessToken
              callback
              uploadType
              uploadProtocol
