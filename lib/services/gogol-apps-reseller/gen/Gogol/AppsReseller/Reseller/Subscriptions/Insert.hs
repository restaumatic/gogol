...
--
-- Creates or transfer a subscription. Create a subscription for a customer\'s account that you ordered using the <https://developers.google.com/workspace/admin/reseller/v1/reference/customers/insert.html Order a new customer account> method. For more information about creating a subscription for different payment plans, see <https://developers.google.com/workspace/admin/reseller/v1/how-tos/manage_subscriptions#create_subscription manage subscriptions>.\\ If you did not order the customer\'s account using the customer insert method, use the customer\'s @customerAuthToken@ when creating a subscription for that customer. If transferring a G Suite subscription with an associated Google Drive or Google Vault subscription, use the <https://developers.google.com/workspace/admin/reseller/v1/how-tos/batch.html batch operation> to transfer all of these subscriptions. For more information, see how to
-- <https://developers.google.com/workspace/admin/reseller/v1/how-tos/manage_subscriptions#transfer_a_subscription transfer subscriptions>.
--
               ...
               "subscriptions" Core.:>
                 Core.QueryParam "$.xgafv" Xgafv Core.:>
                   Core.QueryParam "access_token" Core.Text Core.:>
                     Core.QueryParam "action" SubscriptionsInsertAction Core.:>
...
newResellerSubscriptionsInsert customerId payload
  = ResellerSubscriptionsInsert{xgafv = Core.Nothing,
                                accessToken = Core.Nothing, action = Core.Nothing,
                                callback = Core.Nothing, customerAuthToken = Core.Nothing,
                                customerId = customerId, payload = payload,
                                sourceSkuId = Core.Nothing, uploadType = Core.Nothing,
...
instance Core.GoogleRequest ResellerSubscriptionsInsert where
        ...
        requestClient ResellerSubscriptionsInsert{..}
          = go customerId xgafv accessToken action callback customerAuthToken
              sourceSkuId
              uploadType
              uploadProtocol
