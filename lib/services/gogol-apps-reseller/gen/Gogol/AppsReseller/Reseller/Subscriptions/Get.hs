...
--
-- Gets a specific subscription. The @subscriptionId@ can be found using the <https://developers.google.com/workspace/admin/reseller/v1/how-tos/manage_subscriptions#get_all_subscriptions Retrieve all reseller subscriptions> method. For more information about retrieving a specific subscription, see the information descrived in <https://developers.google.com/workspace/admin/reseller/v1/how-tos/manage_subscriptions#get_subscription manage subscriptions>.
--
...
newResellerSubscriptionsGet customerId subscriptionId
  = ResellerSubscriptionsGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ResellerSubscriptionsGet where
        ...
        requestClient ResellerSubscriptionsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ResellerSubscriptionsGetResource)
                      Core.mempty
