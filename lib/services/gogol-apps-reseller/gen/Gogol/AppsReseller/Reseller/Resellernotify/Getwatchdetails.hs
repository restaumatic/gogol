                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] ResellernotifyGetwatchdetailsResponse
...
newResellerResellernotifyGetwatchdetails 
    :: 
                                         ResellerResellernotifyGetwatchdetails
newResellerResellernotifyGetwatchdetails
  = ResellerResellernotifyGetwatchdetails{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ResellerResellernotifyGetwatchdetails
         where
        type Rs ResellerResellernotifyGetwatchdetails =
             ResellernotifyGetwatchdetailsResponse
        type Scopes ResellerResellernotifyGetwatchdetails =
