...
newResellerResellernotifyUnregister 
    :: 
                                    ResellerResellernotifyUnregister
newResellerResellernotifyUnregister
  = ResellerResellernotifyUnregister{xgafv = Core.Nothing,
                                     accessToken = Core.Nothing, callback = Core.Nothing,
                                     serviceAccountEmailAddress = Core.Nothing,
                                     uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ResellerResellernotifyUnregister where
        type Rs ResellerResellernotifyUnregister = ResellernotifyResource
        type Scopes ResellerResellernotifyUnregister = '[Apps'Order]
        requestClient ResellerResellernotifyUnregister{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ResellerResellernotifyUnregisterResource)
                      Core.mempty
