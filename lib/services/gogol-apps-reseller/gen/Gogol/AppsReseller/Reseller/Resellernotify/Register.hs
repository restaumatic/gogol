               ...
               Core.QueryParam "$.xgafv" Xgafv Core.:>
                 Core.QueryParam "access_token" Core.Text Core.:>
                   Core.QueryParam "callback" Core.Text Core.:>
                     Core.QueryParam "serviceAccountEmailAddress" Core.Text Core.:>
...
newResellerResellernotifyRegister 
    ::  ResellerResellernotifyRegister
newResellerResellernotifyRegister
  = ResellerResellernotifyRegister{xgafv = Core.Nothing,
                                   accessToken = Core.Nothing, callback = Core.Nothing,
                                   serviceAccountEmailAddress = Core.Nothing,
                                   uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ResellerResellernotifyRegister where
        type Rs ResellerResellernotifyRegister = ResellernotifyResource
        type Scopes ResellerResellernotifyRegister = '[Apps'Order]
        requestClient ResellerResellernotifyRegister{..}
          = go xgafv accessToken callback serviceAccountEmailAddress
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ResellerResellernotifyRegisterResource)
                      Core.mempty
