...
newAddress 
    ::  Address
newAddress
  = Address{addressLine1 = Core.Nothing, addressLine2 = Core.Nothing,
            addressLine3 = Core.Nothing, contactName = Core.Nothing,
            countryCode = Core.Nothing, kind = "customers#address",
...
newChangePlanRequest 
    ::  ChangePlanRequest
newChangePlanRequest
  = ChangePlanRequest{dealCode = Core.Nothing,
                      kind = "subscriptions#changePlanRequest", planName = Core.Nothing,
                      purchaseOrderId = Core.Nothing, seats = Core.Nothing}
instance Core.FromJSON ChangePlanRequest where
        parseJSON
          = Core.withObject "ChangePlanRequest"
              (\ o ->
                 ChangePlanRequest Core.<$>
                   (o Core..:? "dealCode") Core.<*>
                     (o Core..:? "kind" Core..!= "subscriptions#changePlanRequest")
...
newCustomer
  = Customer{alternateEmail = Core.Nothing,
             ...
             customerDomainVerified = Core.Nothing, customerId = Core.Nothing,
             customerType = Core.Nothing, kind = "reseller#customer",
             phoneNumber = Core.Nothing, postalAddress = Core.Nothing,
             primaryAdmin = Core.Nothing, resourceUiUrl = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("alternateEmail" Core..=) Core.<$> alternateEmail,
                  ...
                  ("customerDomainVerified" Core..=) Core.<$> customerDomainVerified,
...
instance Core.FromJSON PrimaryAdmin where
        parseJSON
          = Core.withObject "PrimaryAdmin"
              (\ o -> PrimaryAdmin Core.<$> (o Core..:? "primaryEmail"))

instance Core.ToJSON PrimaryAdmin where
        toJSON PrimaryAdmin{..}
          = Core.object
              (Core.catMaybes [("primaryEmail" Core..=) Core.<$> primaryEmail])
...
instance Core.FromJSON RenewalSettings where
        parseJSON
          = Core.withObject "RenewalSettings"
              (\ o ->
                 RenewalSettings Core.<$>
                   (o Core..:? "kind" Core..!= "subscriptions#renewalSettings")
...
newResellernotifyGetwatchdetailsResponse 
    :: 
                                         ResellernotifyGetwatchdetailsResponse
newResellernotifyGetwatchdetailsResponse
  = ResellernotifyGetwatchdetailsResponse{serviceAccountEmailAddresses
                                            = Core.Nothing,
                                          topicName = Core.Nothing}
instance Core.FromJSON ResellernotifyGetwatchdetailsResponse where
        parseJSON
          = Core.withObject "ResellernotifyGetwatchdetailsResponse"
              (\ o ->
                 ResellernotifyGetwatchdetailsResponse Core.<$>
                   (o Core..:? "serviceAccountEmailAddresses") Core.<*>
                     (o Core..:? "topicName"))

instance Core.ToJSON ResellernotifyGetwatchdetailsResponse where
        toJSON ResellernotifyGetwatchdetailsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("serviceAccountEmailAddresses" Core..=) Core.<$>
...
newResellernotifyResource 
    ::  ResellernotifyResource
newResellernotifyResource
  = ResellernotifyResource{topicName = Core.Nothing}
instance Core.FromJSON ResellernotifyResource where
        parseJSON
          = Core.withObject "ResellernotifyResource"
              (\ o -> ResellernotifyResource Core.<$> (o Core..:? "topicName"))
...
data Seats = Seats
    {
      ...
      kind :: Core.Text
      -- | Read-only field containing the current number of users that are assigned a license for the product defined in @skuId@. This field\'s value is equivalent to the numerical count of users returned by the Enterprise License Manager API method: <https://developers.google.com/workspace/admin/licensing/v1/reference/licenseAssignments/listForProductAndSku listForProductAndSku>.
...
newSeats 
    ::  Seats
newSeats
  = Seats{kind = "subscriptions#seats",
          licensedNumberOfSeats = Core.Nothing,
          maximumNumberOfSeats = Core.Nothing, numberOfSeats = Core.Nothing}
instance Core.FromJSON Seats where
        parseJSON
          = Core.withObject "Seats"
              (\ o ->
                 Seats Core.<$>
                   (o Core..:? "kind" Core..!= "subscriptions#seats") Core.<*>
                     (o Core..:? "licensedNumberOfSeats")
...
instance Core.ToJSON Seats where
        toJSON Seats{..}
          = Core.object
              (Core.catMaybes
                 [Core.Just ("kind" Core..= kind),
                  ("licensedNumberOfSeats" Core..=) Core.<$> licensedNumberOfSeats,
                  ("maximumNumberOfSeats" Core..=) Core.<$> maximumNumberOfSeats,
...
newSubscription 
    ::  Subscription
newSubscription
  = Subscription{billingMethod = Core.Nothing,
                 creationTime = Core.Nothing, customerDomain = Core.Nothing,
                 customerId = Core.Nothing, dealCode = Core.Nothing,
                 kind = "reseller#subscription", plan = Core.Nothing,
                 purchaseOrderId = Core.Nothing, renewalSettings = Core.Nothing,
                 resourceUiUrl = Core.Nothing, seats = Core.Nothing,
                 skuId = Core.Nothing, skuName = Core.Nothing,
                 status = Core.Nothing, subscriptionId = Core.Nothing,
                 suspensionReasons = Core.Nothing, transferInfo = Core.Nothing,
          ...
          = Core.object
              (Core.catMaybes
                 [("billingMethod" Core..=) Core.<$> billingMethod,
                  ...
                  ("customerId" Core..=) Core.<$> customerId,
                  ("dealCode" Core..=) Core.<$> dealCode,
                  Core.Just ("kind" Core..= kind), ("plan" Core..=) Core.<$> plan,
                  ("purchaseOrderId" Core..=) Core.<$> purchaseOrderId,
                  ("renewalSettings" Core..=) Core.<$> renewalSettings,
                  ("resourceUiUrl" Core..=) Core.<$> resourceUiUrl,
                  ("seats" Core..=) Core.<$> seats, ("skuId" Core..=) Core.<$> skuId,
...
newSubscription_Plan 
    ::  Subscription_Plan
newSubscription_Plan
  = Subscription_Plan{commitmentInterval = Core.Nothing,
                      isCommitmentPlan = Core.Nothing, planName = Core.Nothing}
instance Core.FromJSON Subscription_Plan where
        parseJSON
          = Core.withObject "Subscription_Plan"
              (\ o ->
                 Subscription_Plan Core.<$>
                   (o Core..:? "commitmentInterval") Core.<*>
                     (o Core..:? "isCommitmentPlan")
                     Core.<*> (o Core..:? "planName"))
...
instance Core.ToJSON Subscription_Plan where
        toJSON Subscription_Plan{..}
          = Core.object
              (Core.catMaybes
                 [("commitmentInterval" Core..=) Core.<$> commitmentInterval,
                  ("isCommitmentPlan" Core..=) Core.<$> isCommitmentPlan,
                  ("planName" Core..=) Core.<$> planName])
...
newSubscription_Plan_CommitmentInterval 
    :: 
                                        Subscription_Plan_CommitmentInterval
newSubscription_Plan_CommitmentInterval
  = Subscription_Plan_CommitmentInterval{endTime = Core.Nothing,
                                         startTime = Core.Nothing}
instance Core.FromJSON Subscription_Plan_CommitmentInterval where
        parseJSON
          = Core.withObject "Subscription_Plan_CommitmentInterval"
              (\ o ->
                 Subscription_Plan_CommitmentInterval Core.<$>
                   (o Core..:? "endTime" Core.<&> Core.fmap Core.fromAsText) Core.<*>
                     (o Core..:? "startTime" Core.<&> Core.fmap Core.fromAsText))

instance Core.ToJSON Subscription_Plan_CommitmentInterval where
...
newSubscription_TransferInfo 
    ::  Subscription_TransferInfo
newSubscription_TransferInfo
  = Subscription_TransferInfo{currentLegacySkuId = Core.Nothing,
...
instance Core.FromJSON Subscription_TransferInfo where
        parseJSON
          = Core.withObject "Subscription_TransferInfo"
              (\ o ->
                 Subscription_TransferInfo Core.<$>
                   (o Core..:? "currentLegacySkuId") Core.<*>
                     (o Core..:? "minimumTransferableSeats")
                     Core.<*>
                     (o Core..:? "transferabilityExpirationTime" Core.<&>
...
instance Core.ToJSON Subscription_TransferInfo where
        toJSON Subscription_TransferInfo{..}
          = Core.object
              (Core.catMaybes
                 [("currentLegacySkuId" Core..=) Core.<$> currentLegacySkuId,
                  ("minimumTransferableSeats" Core..=) Core.<$>
                    minimumTransferableSeats,
                  ("transferabilityExpirationTime" Core..=) Core.. Core.AsText
...
newSubscription_TrialSettings 
    ::  Subscription_TrialSettings
newSubscription_TrialSettings
  = Subscription_TrialSettings{isInTrial = Core.Nothing,
                               trialEndTime = Core.Nothing}
instance Core.FromJSON Subscription_TrialSettings where
        parseJSON
          = Core.withObject "Subscription_TrialSettings"
              (\ o ->
                 Subscription_TrialSettings Core.<$>
                   (o Core..:? "isInTrial") Core.<*>
                     (o Core..:? "trialEndTime" Core.<&> Core.fmap Core.fromAsText))
          ...
          = Core.object
              (Core.catMaybes
                 [("isInTrial" Core..=) Core.<$> isInTrial,
                  ("trialEndTime" Core..=) Core.. Core.AsText Core.<$> trialEndTime])
...
newSubscriptions 
    ::  Subscriptions
newSubscriptions
  = Subscriptions{kind = "reseller#subscriptions",
                  nextPageToken = Core.Nothing, subscriptions = Core.Nothing}
instance Core.FromJSON Subscriptions where
        parseJSON
          = Core.withObject "Subscriptions"
              (\ o ->
                 Subscriptions Core.<$>
                   (o Core..:? "kind" Core..!= "reseller#subscriptions") Core.<*>
