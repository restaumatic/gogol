...
module Gogol.ResourceManager.Internal.Product
  (
    ...
    EffectiveTagBindingCollection (..),
    newEffectiveTagBindingCollection,

    -- * EffectiveTagBindingCollection_EffectiveTags
    EffectiveTagBindingCollection_EffectiveTags (..),
    newEffectiveTagBindingCollection_EffectiveTags,
    ...
    TagBindingCollection (..),
    newTagBindingCollection,

    -- * TagBindingCollection_Tags
    TagBindingCollection_Tags (..),
    newTagBindingCollection_Tags,
...
--
-- /See:/ 'newCapability' smart constructor.
...
-- | Creates a value of 'Capability' with the minimum fields required to make a request.
newCapability 
    ::  Capability
newCapability
  = Capability{name = Core.Nothing, value = Core.Nothing}
instance Core.FromJSON Capability where
        parseJSON
          = Core.withObject "Capability"
              (\ o ->
                 Capability Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "value"))

instance Core.ToJSON Capability where
        toJSON Capability{..}
          = Core.object
              (Core.catMaybes
...
newCloudresourcemanagerGoogleCloudResourcemanagerV2alpha1FolderOperation 
    :: 
                                                                         CloudresourcemanagerGoogleCloudResourcemanagerV2alpha1FolderOperation
newCloudresourcemanagerGoogleCloudResourcemanagerV2alpha1FolderOperation
  = CloudresourcemanagerGoogleCloudResourcemanagerV2alpha1FolderOperation{destinationParent
                                                                            = Core.Nothing,
                                                                          displayName =
                                                                            Core.Nothing,
                                                                          operationType =
...
instance Core.ToJSON
        ...
        toJSON
          ...
          = Core.object
              (Core.catMaybes
                 [("destinationParent" Core..=) Core.<$> destinationParent,
...
newCloudresourcemanagerGoogleCloudResourcemanagerV2beta1FolderOperation 
    :: 
                                                                        CloudresourcemanagerGoogleCloudResourcemanagerV2beta1FolderOperation
newCloudresourcemanagerGoogleCloudResourcemanagerV2beta1FolderOperation
  = CloudresourcemanagerGoogleCloudResourcemanagerV2beta1FolderOperation{destinationParent
                                                                           = Core.Nothing,
...
newCreateFolderMetadata 
    ::  CreateFolderMetadata
newCreateFolderMetadata
  = CreateFolderMetadata{displayName = Core.Nothing,
                         parent = Core.Nothing}
          ...
          = Core.withObject "CreateFolderMetadata"
              (\ o ->
                 CreateFolderMetadata Core.<$>
                   (o Core..:? "displayName") Core.<*> (o Core..:? "parent"))
...
newCreateProjectMetadata 
    ::  CreateProjectMetadata
newCreateProjectMetadata
  = CreateProjectMetadata{createTime = Core.Nothing,
                          gettable = Core.Nothing, ready = Core.Nothing}
instance Core.FromJSON CreateProjectMetadata where
        parseJSON
          = Core.withObject "CreateProjectMetadata"
              (\ o ->
                 CreateProjectMetadata Core.<$>
                   (o Core..:? "createTime") Core.<*> (o Core..:? "gettable") Core.<*>
                     (o Core..:? "ready"))
...
newEffectiveTag 
    ::  EffectiveTag
newEffectiveTag
  = EffectiveTag{inherited = Core.Nothing,
                 namespacedTagKey = Core.Nothing, namespacedTagValue = Core.Nothing,
                 tagKey = Core.Nothing, tagKeyParentName = Core.Nothing,
...
instance Core.FromJSON EffectiveTag where
        parseJSON
          = Core.withObject "EffectiveTag"
              (\ o ->
                 EffectiveTag Core.<$>
                   (o Core..:? "inherited") Core.<*> (o Core..:? "namespacedTagKey")
...
-- | Creates a value of 'EffectiveTagBindingCollection' with the minimum fields required to make a request.
newEffectiveTagBindingCollection 
    ::  EffectiveTagBindingCollection
newEffectiveTagBindingCollection
  = EffectiveTagBindingCollection{effectiveTags = Core.Nothing,
                                  fullResourceName = Core.Nothing, name = Core.Nothing}
instance Core.FromJSON EffectiveTagBindingCollection where
        parseJSON
          = Core.withObject "EffectiveTagBindingCollection"
              (\ o ->
                 EffectiveTagBindingCollection Core.<$>
                   (o Core..:? "effectiveTags") Core.<*>
                     (o Core..:? "fullResourceName")
                     Core.<*> (o Core..:? "name"))

instance Core.ToJSON EffectiveTagBindingCollection where
        toJSON EffectiveTagBindingCollection{..}
          = Core.object
              (Core.catMaybes
...
-- | Tag keys\/values effectively bound to this resource, specified in namespaced format. For example: \"123\/environment\": \"production\"
--
-- /See:/ 'newEffectiveTagBindingCollection_EffectiveTags' smart constructor.
newtype EffectiveTagBindingCollection_EffectiveTags = EffectiveTagBindingCollection_EffectiveTags
    {
...
-- | Creates a value of 'EffectiveTagBindingCollection_EffectiveTags' with the minimum fields required to make a request.
newEffectiveTagBindingCollection_EffectiveTags 
    :: 
                                               Core.HashMap Core.Text Core.Text
       -- ^  See 'additional'.
    -> EffectiveTagBindingCollection_EffectiveTags
newEffectiveTagBindingCollection_EffectiveTags additional
  = EffectiveTagBindingCollection_EffectiveTags{additional =
                                                  additional}
instance Core.FromJSON EffectiveTagBindingCollection_EffectiveTags
         where
        parseJSON
          = Core.withObject "EffectiveTagBindingCollection_EffectiveTags"
              (\ o ->
                 EffectiveTagBindingCollection_EffectiveTags Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON EffectiveTagBindingCollection_EffectiveTags
         where
        toJSON EffectiveTagBindingCollection_EffectiveTags{..}
...
data Folder = Folder
    {
      ...
      configuredCapabilities :: (Core.Maybe [Core.Text])
    ...
    , managementProject :: (Core.Maybe Core.Text)
...
newFolder 
    ::  Folder
newFolder
  = Folder{configuredCapabilities = Core.Nothing,
           createTime = Core.Nothing, deleteTime = Core.Nothing,
           displayName = Core.Nothing, etag = Core.Nothing,
           managementProject = Core.Nothing, name = Core.Nothing,
           parent = Core.Nothing, state = Core.Nothing, tags = Core.Nothing,
...
instance Core.FromJSON Folder where
        parseJSON
          = Core.withObject "Folder"
              (\ o ->
                 Folder Core.<$>
                   (o Core..:? "configuredCapabilities") Core.<*>
                     (o Core..:? "createTime")
                     Core.<*> (o Core..:? "deleteTime")
                     Core.<*> (o Core..:? "displayName")
                     Core.<*> (o Core..:? "etag")
                     Core.<*> (o Core..:? "managementProject")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "parent")
                     Core.<*> (o Core..:? "state")
                     Core.<*> (o Core..:? "tags")
...
instance Core.ToJSON Folder where
        toJSON Folder{..}
          = Core.object
              (Core.catMaybes
                 [("configuredCapabilities" Core..=) Core.<$>
                    configuredCapabilities,
                  ("createTime" Core..=) Core.<$> createTime,
                  ("deleteTime" Core..=) Core.<$> deleteTime,
                  ("displayName" Core..=) Core.<$> displayName,
                  ("etag" Core..=) Core.<$> etag,
                  ("managementProject" Core..=) Core.<$> managementProject,
...
-- | Optional. Input only. Immutable. Tag keys\/values directly bound to this folder. Each item in the map must be expressed as \" : \". For example: \"123\/environment\" : \"production\", \"123\/costCenter\" : \"marketing\" Note: Currently this field is in Preview.
--
-- /See:/ 'newFolder_Tags' smart constructor.
newtype Folder_Tags = Folder_Tags
    {
...
-- | Creates a value of 'Folder_Tags' with the minimum fields required to make a request.
newFolder_Tags 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'additional'.
    -> Folder_Tags
newFolder_Tags additional = Folder_Tags{additional = additional}
instance Core.FromJSON Folder_Tags where
        parseJSON
          = Core.withObject "Folder_Tags"
              (\ o -> Folder_Tags Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON Folder_Tags where
        toJSON Folder_Tags{..} = Core.toJSON additional
...
newFolderOperation 
    ::  FolderOperation
newFolderOperation
  = FolderOperation{destinationParent = Core.Nothing,
                    displayName = Core.Nothing, operationType = Core.Nothing,
...
newFolderOperationError 
    ::  FolderOperationError
newFolderOperationError
  = FolderOperationError{errorMessageId = Core.Nothing}
instance Core.FromJSON FolderOperationError where
        parseJSON
          = Core.withObject "FolderOperationError"
              (\ o ->
                 FolderOperationError Core.<$> (o Core..:? "errorMessageId"))
...
newLien 
    ::  Lien
newLien
  = Lien{createTime = Core.Nothing, name = Core.Nothing,
         origin = Core.Nothing, parent = Core.Nothing,
         reason = Core.Nothing, restrictions = Core.Nothing}
...
newListEffectiveTagsResponse 
    ::  ListEffectiveTagsResponse
newListEffectiveTagsResponse
  = ListEffectiveTagsResponse{effectiveTags = Core.Nothing,
          ...
          = Core.withObject "ListEffectiveTagsResponse"
              (\ o ->
                 ListEffectiveTagsResponse Core.<$>
                   (o Core..:? "effectiveTags") Core.<*> (o Core..:? "nextPageToken"))
...
newListFoldersResponse 
    ::  ListFoldersResponse
newListFoldersResponse
  = ListFoldersResponse{folders = Core.Nothing,
                        nextPageToken = Core.Nothing}
          ...
          = Core.withObject "ListFoldersResponse"
              (\ o ->
                 ListFoldersResponse Core.<$>
                   (o Core..:? "folders") Core.<*> (o Core..:? "nextPageToken"))
...
newListLiensResponse 
    ::  ListLiensResponse
newListLiensResponse
  = ListLiensResponse{liens = Core.Nothing,
                      nextPageToken = Core.Nothing}
          ...
          = Core.withObject "ListLiensResponse"
              (\ o ->
                 ListLiensResponse Core.<$>
                   (o Core..:? "liens") Core.<*> (o Core..:? "nextPageToken"))
...
newListProjectsResponse 
    ::  ListProjectsResponse
newListProjectsResponse
  = ListProjectsResponse{nextPageToken = Core.Nothing,
          ...
          = Core.withObject "ListProjectsResponse"
              (\ o ->
                 ListProjectsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "projects"))
...
newListTagBindingsResponse 
    ::  ListTagBindingsResponse
newListTagBindingsResponse
  = ListTagBindingsResponse{nextPageToken = Core.Nothing,
          ...
          = Core.withObject "ListTagBindingsResponse"
              (\ o ->
                 ListTagBindingsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "tagBindings"))
...
newListTagKeysResponse 
    ::  ListTagKeysResponse
newListTagKeysResponse
  = ListTagKeysResponse{nextPageToken = Core.Nothing,
          ...
          = Core.withObject "ListTagKeysResponse"
              (\ o ->
                 ListTagKeysResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "tagKeys"))
...
newListTagValuesResponse 
    ::  ListTagValuesResponse
newListTagValuesResponse
  = ListTagValuesResponse{nextPageToken = Core.Nothing,
          ...
          = Core.withObject "ListTagValuesResponse"
              (\ o ->
                 ListTagValuesResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "tagValues"))
...
newMoveFolderMetadata 
    ::  MoveFolderMetadata
newMoveFolderMetadata
  = MoveFolderMetadata{destinationParent = Core.Nothing,
                       displayName = Core.Nothing, sourceParent = Core.Nothing}
...
newMoveFolderRequest 
    ::  MoveFolderRequest
newMoveFolderRequest
  = MoveFolderRequest{destinationParent = Core.Nothing}
instance Core.FromJSON MoveFolderRequest where
        parseJSON
          = Core.withObject "MoveFolderRequest"
              (\ o ->
                 MoveFolderRequest Core.<$> (o Core..:? "destinationParent"))
...
newMoveProjectRequest 
    ::  MoveProjectRequest
newMoveProjectRequest
  = MoveProjectRequest{destinationParent = Core.Nothing}
instance Core.FromJSON MoveProjectRequest where
        parseJSON
          = Core.withObject "MoveProjectRequest"
              (\ o ->
                 MoveProjectRequest Core.<$> (o Core..:? "destinationParent"))
...
newOrganization 
    ::  Organization
newOrganization
  = Organization{createTime = Core.Nothing,
                 deleteTime = Core.Nothing, directoryCustomerId = Core.Nothing,
                 displayName = Core.Nothing, etag = Core.Nothing,
        ...
        toJSON Organization{..}
          = Core.object
              (Core.catMaybes
                 [("createTime" Core..=) Core.<$> createTime,
                  ("deleteTime" Core..=) Core.<$> deleteTime,
                  ("directoryCustomerId" Core..=) Core.<$> directoryCustomerId,
                  ("displayName" Core..=) Core.<$> displayName,
...
newProject 
    ::  Project
newProject
  = Project{configuredCapabilities = Core.Nothing,
            createTime = Core.Nothing, deleteTime = Core.Nothing,
            displayName = Core.Nothing, etag = Core.Nothing,
            labels = Core.Nothing, name = Core.Nothing, parent = Core.Nothing,
            projectId = Core.Nothing, state = Core.Nothing,
...
newProject_Labels 
    :: 
       ...
       -- ^  See 'additional'.
    -> Project_Labels
newProject_Labels additional
  = Project_Labels{additional = additional}
instance Core.FromJSON Project_Labels where
        parseJSON
          = Core.withObject "Project_Labels"
              (\ o -> Project_Labels Core.<$> (Core.parseJSONObject o))
...
-- | Optional. Input only. Immutable. Tag keys\/values directly bound to this project. Each item in the map must be expressed as \" : \". For example: \"123\/environment\" : \"production\", \"123\/costCenter\" : \"marketing\" Note: Currently this field is in Preview.
--
-- /See:/ 'newProject_Tags' smart constructor.
newtype Project_Tags = Project_Tags
    {
...
-- | Creates a value of 'Project_Tags' with the minimum fields required to make a request.
newProject_Tags 
    ::  Core.HashMap Core.Text Core.Text
       -- ^  See 'additional'.
    -> Project_Tags
newProject_Tags additional = Project_Tags{additional = additional}
instance Core.FromJSON Project_Tags where
        parseJSON
          = Core.withObject "Project_Tags"
              (\ o -> Project_Tags Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON Project_Tags where
        toJSON Project_Tags{..} = Core.toJSON additional
...
newProjectCreationStatus 
    ::  ProjectCreationStatus
newProjectCreationStatus
  = ProjectCreationStatus{createTime = Core.Nothing,
                          gettable = Core.Nothing, ready = Core.Nothing}
...
newSearchFoldersResponse 
    ::  SearchFoldersResponse
newSearchFoldersResponse
  = SearchFoldersResponse{folders = Core.Nothing,
                          nextPageToken = Core.Nothing}
...
newSearchOrganizationsResponse 
    ::  SearchOrganizationsResponse
newSearchOrganizationsResponse
  = SearchOrganizationsResponse{nextPageToken = Core.Nothing,
          ...
          = Core.withObject "SearchOrganizationsResponse"
              (\ o ->
                 SearchOrganizationsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "organizations"))
...
newSearchProjectsResponse 
    ::  SearchProjectsResponse
newSearchProjectsResponse
  = SearchProjectsResponse{nextPageToken = Core.Nothing,
                           projects = Core.Nothing}
...
newTagBinding 
    ::  TagBinding
newTagBinding
  = TagBinding{name = Core.Nothing, parent = Core.Nothing,
               tagValue = Core.Nothing, tagValueNamespacedName = Core.Nothing}
...
--
-- /See:/ 'newTagBindingCollection' smart constructor.
data TagBindingCollection = TagBindingCollection
    {
    ...
    , tags :: (Core.Maybe TagBindingCollection_Tags)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'TagBindingCollection' with the minimum fields required to make a request.
newTagBindingCollection 
    ::  TagBindingCollection
newTagBindingCollection
  = TagBindingCollection{etag = Core.Nothing,
                         fullResourceName = Core.Nothing, name = Core.Nothing,
                         tags = Core.Nothing}
instance Core.FromJSON TagBindingCollection where
        parseJSON
          = Core.withObject "TagBindingCollection"
              (\ o ->
                 TagBindingCollection Core.<$>
                   (o Core..:? "etag") Core.<*> (o Core..:? "fullResourceName")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "tags"))

instance Core.ToJSON TagBindingCollection where
        toJSON TagBindingCollection{..}
          = Core.object
              (Core.catMaybes
                 [("etag" Core..=) Core.<$> etag,
                  ("fullResourceName" Core..=) Core.<$> fullResourceName,
...
-- | Tag keys\/values directly bound to this resource, specified in namespaced format. For example: \"123\/environment\": \"production\"
--
-- /See:/ 'newTagBindingCollection_Tags' smart constructor.
newtype TagBindingCollection_Tags = TagBindingCollection_Tags
    {
...
-- | Creates a value of 'TagBindingCollection_Tags' with the minimum fields required to make a request.
newTagBindingCollection_Tags 
    :: 
                             Core.HashMap Core.Text Core.Text
       -- ^  See 'additional'.
    -> TagBindingCollection_Tags
newTagBindingCollection_Tags additional
  = TagBindingCollection_Tags{additional = additional}
instance Core.FromJSON TagBindingCollection_Tags where
        parseJSON
          = Core.withObject "TagBindingCollection_Tags"
              (\ o ->
                 TagBindingCollection_Tags Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON TagBindingCollection_Tags where
        toJSON TagBindingCollection_Tags{..} = Core.toJSON additional
...
newTagHold 
    ::  TagHold
newTagHold
  = TagHold{createTime = Core.Nothing, helpLink = Core.Nothing,
            holder = Core.Nothing, name = Core.Nothing, origin = Core.Nothing}
instance Core.FromJSON TagHold where
        parseJSON
          = Core.withObject "TagHold"
              (\ o ->
                 TagHold Core.<$>
                   (o Core..:? "createTime") Core.<*> (o Core..:? "helpLink") Core.<*>
                     (o Core..:? "holder")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "origin"))
          ...
          = Core.object
              (Core.catMaybes
                 [("createTime" Core..=) Core.<$> createTime,
                  ...
                  ("holder" Core..=) Core.<$> holder, ("name" Core..=) Core.<$> name,
...
newTagKey 
    ::  TagKey
newTagKey
  = TagKey{createTime = Core.Nothing, description = Core.Nothing,
           etag = Core.Nothing, name = Core.Nothing,
           namespacedName = Core.Nothing, parent = Core.Nothing,
           purpose = Core.Nothing, purposeData = Core.Nothing,
           shortName = Core.Nothing, updateTime = Core.Nothing}
...
newTagKey_PurposeData 
    :: 
       ...
       -- ^  See 'additional'.
    -> TagKey_PurposeData
newTagKey_PurposeData additional
  = TagKey_PurposeData{additional = additional}
instance Core.FromJSON TagKey_PurposeData where
        parseJSON
          = Core.withObject "TagKey_PurposeData"
              (\ o -> TagKey_PurposeData Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON TagKey_PurposeData where
        toJSON TagKey_PurposeData{..} = Core.toJSON additional
...
newTagValue 
    ::  TagValue
newTagValue
  = TagValue{createTime = Core.Nothing, description = Core.Nothing,
             etag = Core.Nothing, name = Core.Nothing,
             namespacedName = Core.Nothing, parent = Core.Nothing,
             shortName = Core.Nothing, updateTime = Core.Nothing}
