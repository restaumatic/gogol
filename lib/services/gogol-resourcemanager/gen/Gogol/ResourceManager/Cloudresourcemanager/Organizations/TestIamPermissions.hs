...
newCloudresourcemanagerOrganizationsTestIamPermissions 
    ...
    -> CloudresourcemanagerOrganizationsTestIamPermissions
newCloudresourcemanagerOrganizationsTestIamPermissions payload
  resource
  = CloudresourcemanagerOrganizationsTestIamPermissions{xgafv =
                                                          Core.Nothing,
...
instance Core.GoogleRequest
           CloudresourcemanagerOrganizationsTestIamPermissions
         where
        type Rs CloudresourcemanagerOrganizationsTestIamPermissions =
             TestIamPermissionsResponse
        type Scopes CloudresourcemanagerOrganizationsTestIamPermissions =
