...
newCloudresourcemanagerOrganizationsSearch 
    :: 
                                           CloudresourcemanagerOrganizationsSearch
newCloudresourcemanagerOrganizationsSearch
  = CloudresourcemanagerOrganizationsSearch{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            pageSize = Core.Nothing, pageToken = Core.Nothing,
                                            query = Core.Nothing, uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudresourcemanagerOrganizationsSearch
         where
        type Rs CloudresourcemanagerOrganizationsSearch =
             SearchOrganizationsResponse
        type Scopes CloudresourcemanagerOrganizationsSearch =
             '[CloudPlatform'FullControl, CloudPlatform'ReadOnly]
        requestClient CloudresourcemanagerOrganizationsSearch{..}
          = go xgafv accessToken callback pageSize pageToken query uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudresourcemanagerOrganizationsSearchResource)
                      Core.mempty
