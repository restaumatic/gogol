...
-- |
-- Module      : Gogol.ResourceManager.Cloudresourcemanager.Organizations.GetIamPolicy
...
newCloudresourcemanagerOrganizationsGetIamPolicy payload resource
  = CloudresourcemanagerOrganizationsGetIamPolicy{xgafv =
                                                    Core.Nothing,
...
instance Core.GoogleRequest
           CloudresourcemanagerOrganizationsGetIamPolicy
         where
        type Rs CloudresourcemanagerOrganizationsGetIamPolicy = Policy
        type Scopes CloudresourcemanagerOrganizationsGetIamPolicy =
             '[CloudPlatform'FullControl, CloudPlatform'ReadOnly]
        requestClient CloudresourcemanagerOrganizationsGetIamPolicy{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudresourcemanagerOrganizationsGetIamPolicyResource)
                      Core.mempty
