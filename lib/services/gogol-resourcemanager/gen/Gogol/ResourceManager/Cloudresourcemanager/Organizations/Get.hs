               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.Get '[Core.JSON] Organization
...
newCloudresourcemanagerOrganizationsGet name
  = CloudresourcemanagerOrganizationsGet{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         name = name, uploadType = Core.Nothing,
                                         uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudresourcemanagerOrganizationsGet
         where
        type Rs CloudresourcemanagerOrganizationsGet = Organization
        type Scopes CloudresourcemanagerOrganizationsGet =
             '[CloudPlatform'FullControl, CloudPlatform'ReadOnly]
        requestClient CloudresourcemanagerOrganizationsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudresourcemanagerOrganizationsGetResource)
                      Core.mempty
