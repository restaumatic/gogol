...
newCloudresourcemanagerTagBindingsCreate payload
  = CloudresourcemanagerTagBindingsCreate{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          payload = payload, uploadType = Core.Nothing,
                                          uploadProtocol = Core.Nothing,
                                          validateOnly = Core.Nothing}
instance Core.GoogleRequest CloudresourcemanagerTagBindingsCreate
         where
        type Rs CloudresourcemanagerTagBindingsCreate = Operation
        type Scopes CloudresourcemanagerTagBindingsCreate =
             '[CloudPlatform'FullControl]
        requestClient CloudresourcemanagerTagBindingsCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudresourcemanagerTagBindingsCreateResource)
                      Core.mempty
