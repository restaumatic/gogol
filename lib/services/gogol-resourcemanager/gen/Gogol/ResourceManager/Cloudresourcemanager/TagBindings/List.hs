                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] ListTagBindingsResponse
...
newCloudresourcemanagerTagBindingsList 
    :: 
                                       CloudresourcemanagerTagBindingsList
newCloudresourcemanagerTagBindingsList
  = CloudresourcemanagerTagBindingsList{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        pageSize = Core.Nothing, pageToken = Core.Nothing,
                                        parent = Core.Nothing, uploadType = Core.Nothing,
                                        uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudresourcemanagerTagBindingsList
         where
        type Rs CloudresourcemanagerTagBindingsList =
             ListTagBindingsResponse
        type Scopes CloudresourcemanagerTagBindingsList =
        ...
        requestClient CloudresourcemanagerTagBindingsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudresourcemanagerTagBindingsListResource)
                      Core.mempty
