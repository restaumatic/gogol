...
newCloudresourcemanagerOperationsGet name
  = CloudresourcemanagerOperationsGet{xgafv = Core.Nothing,
                                      accessToken = Core.Nothing, callback = Core.Nothing,
                                      name = name, uploadType = Core.Nothing,
                                      uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudresourcemanagerOperationsGet where
        type Rs CloudresourcemanagerOperationsGet = Operation
        type Scopes CloudresourcemanagerOperationsGet =
