...
newCloudresourcemanagerFoldersGetIamPolicy payload resource
  = CloudresourcemanagerFoldersGetIamPolicy{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            payload = payload, resource = resource,
                                            uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudresourcemanagerFoldersGetIamPolicy
         where
        type Rs CloudresourcemanagerFoldersGetIamPolicy = Policy
        type Scopes CloudresourcemanagerFoldersGetIamPolicy =
             '[CloudPlatform'FullControl, CloudPlatform'ReadOnly]
        requestClient CloudresourcemanagerFoldersGetIamPolicy{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudresourcemanagerFoldersGetIamPolicyResource)
                      Core.mempty
