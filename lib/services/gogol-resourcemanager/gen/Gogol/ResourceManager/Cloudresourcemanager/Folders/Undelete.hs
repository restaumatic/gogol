               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] UndeleteFolderRequest Core.:>
...
newCloudresourcemanagerFoldersUndelete name payload
  = CloudresourcemanagerFoldersUndelete{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        name = name, payload = payload, uploadType = Core.Nothing,
                                        uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudresourcemanagerFoldersUndelete
         where
        type Rs CloudresourcemanagerFoldersUndelete = Operation
        ...
        requestClient CloudresourcemanagerFoldersUndelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudresourcemanagerFoldersUndeleteResource)
                      Core.mempty
