...
-- |
-- Module      : Gogol.ResourceManager.Cloudresourcemanager.Folders.Move
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] MoveFolderRequest Core.:>
...
newCloudresourcemanagerFoldersMove name payload
  = CloudresourcemanagerFoldersMove{xgafv = Core.Nothing,
                                    accessToken = Core.Nothing, callback = Core.Nothing,
                                    name = name, payload = payload, uploadType = Core.Nothing,
                                    uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudresourcemanagerFoldersMove where
        type Rs CloudresourcemanagerFoldersMove = Operation
        type Scopes CloudresourcemanagerFoldersMove =
        ...
        requestClient CloudresourcemanagerFoldersMove{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy CloudresourcemanagerFoldersMoveResource)
                      Core.mempty
