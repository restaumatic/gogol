...
-- |
-- Module      : Gogol.ResourceManager.Cloudresourcemanager.Folders.Delete
...
newCloudresourcemanagerFoldersDelete name
  = CloudresourcemanagerFoldersDelete{xgafv = Core.Nothing,
                                      accessToken = Core.Nothing, callback = Core.Nothing,
                                      name = name, uploadType = Core.Nothing,
                                      uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudresourcemanagerFoldersDelete where
        type Rs CloudresourcemanagerFoldersDelete = Operation
        type Scopes CloudresourcemanagerFoldersDelete =
