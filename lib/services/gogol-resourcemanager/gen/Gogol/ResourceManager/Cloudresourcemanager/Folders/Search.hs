...
newCloudresourcemanagerFoldersSearch 
    :: 
                                     CloudresourcemanagerFoldersSearch
newCloudresourcemanagerFoldersSearch
  = CloudresourcemanagerFoldersSearch{xgafv = Core.Nothing,
                                      accessToken = Core.Nothing, callback = Core.Nothing,
                                      pageSize = Core.Nothing, pageToken = Core.Nothing,
                                      query = Core.Nothing, uploadType = Core.Nothing,
                                      uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudresourcemanagerFoldersSearch where
        type Rs CloudresourcemanagerFoldersSearch = SearchFoldersResponse
