...
newCloudresourcemanagerFoldersPatch 
    :: 
                                    Core.Text
       -- ^  Identifier. The resource name of the folder. Its format is @folders\/{folder_id}@, for example: \"folders\/1234\". See 'name'.
    -> Folder
       -- ^  Multipart request metadata. See 'payload'.
    -> CloudresourcemanagerFoldersPatch
newCloudresourcemanagerFoldersPatch name payload
  = CloudresourcemanagerFoldersPatch{xgafv = Core.Nothing,
...
instance Core.GoogleRequest CloudresourcemanagerFoldersPatch where
        ...
        type Scopes CloudresourcemanagerFoldersPatch =
