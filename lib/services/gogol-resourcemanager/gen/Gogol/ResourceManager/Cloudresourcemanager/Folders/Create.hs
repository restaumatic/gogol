...
newCloudresourcemanagerFoldersCreate payload
  = CloudresourcemanagerFoldersCreate{xgafv = Core.Nothing,
                                      accessToken = Core.Nothing, callback = Core.Nothing,
                                      payload = payload, uploadType = Core.Nothing,
                                      uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudresourcemanagerFoldersCreate where
        type Rs CloudresourcemanagerFoldersCreate = Operation
        type Scopes CloudresourcemanagerFoldersCreate =
