...
newCloudresourcemanagerLiensGet name
  = CloudresourcemanagerLiensGet{xgafv = Core.Nothing,
                                 accessToken = Core.Nothing, callback = Core.Nothing, name = name,
                                 uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudresourcemanagerLiensGet where
        ...
        requestClient CloudresourcemanagerLiensGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy CloudresourcemanagerLiensGetResource)
                      Core.mempty
