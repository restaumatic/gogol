               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] Lien Core.:> Core.Post '[Core.JSON] Lien
...
newCloudresourcemanagerLiensCreate payload
  = CloudresourcemanagerLiensCreate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest CloudresourcemanagerLiensCreate where
        ...
        type Scopes CloudresourcemanagerLiensCreate =
