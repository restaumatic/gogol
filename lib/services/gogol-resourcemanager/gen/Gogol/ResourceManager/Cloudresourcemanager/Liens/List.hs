                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] ListLiensResponse
...
newCloudresourcemanagerLiensList 
    ::  CloudresourcemanagerLiensList
newCloudresourcemanagerLiensList
  = CloudresourcemanagerLiensList{xgafv = Core.Nothing,
                                  accessToken = Core.Nothing, callback = Core.Nothing,
                                  pageSize = Core.Nothing, pageToken = Core.Nothing,
                                  parent = Core.Nothing, uploadType = Core.Nothing,
                                  uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudresourcemanagerLiensList where
        type Rs CloudresourcemanagerLiensList = ListLiensResponse
        type Scopes CloudresourcemanagerLiensList =
        ...
        requestClient CloudresourcemanagerLiensList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy CloudresourcemanagerLiensListResource)
                      Core.mempty
