...
newCloudresourcemanagerTagKeysGetIamPolicy payload resource
  = CloudresourcemanagerTagKeysGetIamPolicy{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            payload = payload, resource = resource,
                                            uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudresourcemanagerTagKeysGetIamPolicy
         where
        type Rs CloudresourcemanagerTagKeysGetIamPolicy = Policy
        type Scopes CloudresourcemanagerTagKeysGetIamPolicy =
             '[CloudPlatform'FullControl, CloudPlatform'ReadOnly]
        requestClient CloudresourcemanagerTagKeysGetIamPolicy{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudresourcemanagerTagKeysGetIamPolicyResource)
                      Core.mempty
