...
newCloudresourcemanagerTagKeysSetIamPolicy payload resource
  = CloudresourcemanagerTagKeysSetIamPolicy{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            payload = payload, resource = resource,
                                            uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudresourcemanagerTagKeysSetIamPolicy
         where
        type Rs CloudresourcemanagerTagKeysSetIamPolicy = Policy
        type Scopes CloudresourcemanagerTagKeysSetIamPolicy =
