                   ...
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "validateOnly" Core.Bool Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] TagKey Core.:>
...
instance Core.GoogleRequest CloudresourcemanagerTagKeysPatch where
        ...
        requestClient CloudresourcemanagerTagKeysPatch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy CloudresourcemanagerTagKeysPatchResource)
                      Core.mempty
