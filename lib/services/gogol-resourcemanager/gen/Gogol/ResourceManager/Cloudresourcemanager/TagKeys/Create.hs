...
newCloudresourcemanagerTagKeysCreate payload
  = CloudresourcemanagerTagKeysCreate{xgafv = Core.Nothing,
                                      accessToken = Core.Nothing, callback = Core.Nothing,
                                      payload = payload, uploadType = Core.Nothing,
                                      uploadProtocol = Core.Nothing, validateOnly = Core.Nothing}
instance Core.GoogleRequest CloudresourcemanagerTagKeysCreate where
        type Rs CloudresourcemanagerTagKeysCreate = Operation
        type Scopes CloudresourcemanagerTagKeysCreate =
