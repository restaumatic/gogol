...
-- |
-- Module      : Gogol.ResourceManager.Cloudresourcemanager.TagKeys.Get
...
newCloudresourcemanagerTagKeysGet name
  = CloudresourcemanagerTagKeysGet{xgafv = Core.Nothing,
                                   accessToken = Core.Nothing, callback = Core.Nothing, name = name,
                                   uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudresourcemanagerTagKeysGet where
        type Rs CloudresourcemanagerTagKeysGet = TagKey
        type Scopes CloudresourcemanagerTagKeysGet =
        ...
        requestClient CloudresourcemanagerTagKeysGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy CloudresourcemanagerTagKeysGetResource)
                      Core.mempty
