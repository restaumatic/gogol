...
newCloudresourcemanagerTagKeysTestIamPermissions payload resource
  = CloudresourcemanagerTagKeysTestIamPermissions{xgafv =
                                                    Core.Nothing,
...
instance Core.GoogleRequest
           CloudresourcemanagerTagKeysTestIamPermissions
         where
        type Rs CloudresourcemanagerTagKeysTestIamPermissions =
             TestIamPermissionsResponse
        type Scopes CloudresourcemanagerTagKeysTestIamPermissions =
             '[CloudPlatform'FullControl]
        requestClient CloudresourcemanagerTagKeysTestIamPermissions{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudresourcemanagerTagKeysTestIamPermissionsResource)
                      Core.mempty
