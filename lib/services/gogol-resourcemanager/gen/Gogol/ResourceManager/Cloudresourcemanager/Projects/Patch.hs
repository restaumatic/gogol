                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] Project Core.:>
...
newCloudresourcemanagerProjectsPatch name payload
  = CloudresourcemanagerProjectsPatch{xgafv = Core.Nothing,
                                      accessToken = Core.Nothing, callback = Core.Nothing,
                                      name = name, payload = payload, updateMask = Core.Nothing,
                                      uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudresourcemanagerProjectsPatch where
        type Rs CloudresourcemanagerProjectsPatch = Operation
        type Scopes CloudresourcemanagerProjectsPatch =
