...
newCloudresourcemanagerProjectsGet name
  = CloudresourcemanagerProjectsGet{xgafv = Core.Nothing,
                                    accessToken = Core.Nothing, callback = Core.Nothing,
                                    name = name, uploadType = Core.Nothing,
                                    uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudresourcemanagerProjectsGet where
        ...
        requestClient CloudresourcemanagerProjectsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy CloudresourcemanagerProjectsGetResource)
                      Core.mempty
