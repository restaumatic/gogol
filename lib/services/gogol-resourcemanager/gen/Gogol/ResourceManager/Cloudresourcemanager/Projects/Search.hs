...
newCloudresourcemanagerProjectsSearch 
    :: 
                                      CloudresourcemanagerProjectsSearch
newCloudresourcemanagerProjectsSearch
  = CloudresourcemanagerProjectsSearch{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       pageSize = Core.Nothing, pageToken = Core.Nothing,
                                       query = Core.Nothing, uploadType = Core.Nothing,
                                       uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudresourcemanagerProjectsSearch
         where
        type Rs CloudresourcemanagerProjectsSearch = SearchProjectsResponse
        ...
        requestClient CloudresourcemanagerProjectsSearch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudresourcemanagerProjectsSearchResource)
                      Core.mempty
