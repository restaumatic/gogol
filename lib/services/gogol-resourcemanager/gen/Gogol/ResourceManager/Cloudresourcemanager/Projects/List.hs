...
newCloudresourcemanagerProjectsList 
    :: 
                                    CloudresourcemanagerProjectsList
newCloudresourcemanagerProjectsList
  = CloudresourcemanagerProjectsList{xgafv = Core.Nothing,
                                     accessToken = Core.Nothing, callback = Core.Nothing,
                                     pageSize = Core.Nothing, pageToken = Core.Nothing,
                                     parent = Core.Nothing, showDeleted = Core.Nothing,
                                     uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudresourcemanagerProjectsList where
        type Rs CloudresourcemanagerProjectsList = ListProjectsResponse
        ...
        requestClient CloudresourcemanagerProjectsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy CloudresourcemanagerProjectsListResource)
                      Core.mempty
