...
newCloudresourcemanagerProjectsSetIamPolicy payload resource
  = CloudresourcemanagerProjectsSetIamPolicy{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           CloudresourcemanagerProjectsSetIamPolicy
         where
        type Rs CloudresourcemanagerProjectsSetIamPolicy = Policy
        type Scopes CloudresourcemanagerProjectsSetIamPolicy =
             '[CloudPlatform'FullControl]
        requestClient CloudresourcemanagerProjectsSetIamPolicy{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudresourcemanagerProjectsSetIamPolicyResource)
                      Core.mempty
