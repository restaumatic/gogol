...
newCloudresourcemanagerProjectsCreate payload
  = CloudresourcemanagerProjectsCreate{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       payload = payload, uploadType = Core.Nothing,
                                       uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudresourcemanagerProjectsCreate
         where
        type Rs CloudresourcemanagerProjectsCreate = Operation
        type Scopes CloudresourcemanagerProjectsCreate =
