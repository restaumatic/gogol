...
-- |
-- Module      : Gogol.ResourceManager.Cloudresourcemanager.Projects.Move
...
type CloudresourcemanagerProjectsMoveResource =
     "v3" Core.:>
       Core.CaptureMode "name" "move" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] MoveProjectRequest Core.:>
...
newCloudresourcemanagerProjectsMove name payload
  = CloudresourcemanagerProjectsMove{xgafv = Core.Nothing,
                                     accessToken = Core.Nothing, callback = Core.Nothing,
                                     name = name, payload = payload, uploadType = Core.Nothing,
                                     uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudresourcemanagerProjectsMove where
        type Rs CloudresourcemanagerProjectsMove = Operation
        type Scopes CloudresourcemanagerProjectsMove =
        ...
        requestClient CloudresourcemanagerProjectsMove{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy CloudresourcemanagerProjectsMoveResource)
                      Core.mempty
