...
newCloudresourcemanagerProjectsDelete name
  = CloudresourcemanagerProjectsDelete{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       name = name, uploadType = Core.Nothing,
                                       uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudresourcemanagerProjectsDelete
         where
        type Rs CloudresourcemanagerProjectsDelete = Operation
        type Scopes CloudresourcemanagerProjectsDelete =
        ...
        requestClient CloudresourcemanagerProjectsDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudresourcemanagerProjectsDeleteResource)
                      Core.mempty
