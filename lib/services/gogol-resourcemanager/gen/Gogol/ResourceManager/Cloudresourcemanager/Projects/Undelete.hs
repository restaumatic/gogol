               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] UndeleteProjectRequest Core.:>
...
newCloudresourcemanagerProjectsUndelete name payload
  = CloudresourcemanagerProjectsUndelete{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         name = name, payload = payload, uploadType = Core.Nothing,
                                         uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudresourcemanagerProjectsUndelete
         where
        type Rs CloudresourcemanagerProjectsUndelete = Operation
        type Scopes CloudresourcemanagerProjectsUndelete =
