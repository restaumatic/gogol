                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] ListTagHoldsResponse
...
newCloudresourcemanagerTagValuesTagHoldsList parent
  = CloudresourcemanagerTagValuesTagHoldsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           CloudresourcemanagerTagValuesTagHoldsList
         where
        type Rs CloudresourcemanagerTagValuesTagHoldsList =
             ListTagHoldsResponse
        type Scopes CloudresourcemanagerTagValuesTagHoldsList =
             '[CloudPlatform'FullControl, CloudPlatform'ReadOnly]
        requestClient CloudresourcemanagerTagValuesTagHoldsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudresourcemanagerTagValuesTagHoldsListResource)
                      Core.mempty
