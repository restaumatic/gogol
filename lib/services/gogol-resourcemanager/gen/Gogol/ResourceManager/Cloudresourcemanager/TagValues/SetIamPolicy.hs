...
newCloudresourcemanagerTagValuesSetIamPolicy payload resource
  = CloudresourcemanagerTagValuesSetIamPolicy{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           CloudresourcemanagerTagValuesSetIamPolicy
         where
        type Rs CloudresourcemanagerTagValuesSetIamPolicy = Policy
        type Scopes CloudresourcemanagerTagValuesSetIamPolicy =
             '[CloudPlatform'FullControl]
        requestClient CloudresourcemanagerTagValuesSetIamPolicy{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudresourcemanagerTagValuesSetIamPolicyResource)
                      Core.mempty
