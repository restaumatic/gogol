                   ...
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "validateOnly" Core.Bool Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] TagHold Core.:>
...
newCloudresourcemanagerTagValuesTagHoldsCreate parent payload
  = CloudresourcemanagerTagValuesTagHoldsCreate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           CloudresourcemanagerTagValuesTagHoldsCreate
         where
        type Rs CloudresourcemanagerTagValuesTagHoldsCreate = Operation
        type Scopes CloudresourcemanagerTagValuesTagHoldsCreate =
             '[CloudPlatform'FullControl]
        requestClient CloudresourcemanagerTagValuesTagHoldsCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudresourcemanagerTagValuesTagHoldsCreateResource)
                      Core.mempty
