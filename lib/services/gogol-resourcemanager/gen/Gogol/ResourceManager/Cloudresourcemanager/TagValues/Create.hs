                 ...
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "validateOnly" Core.Bool Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] TagValue Core.:>
...
newCloudresourcemanagerTagValuesCreate payload
  = CloudresourcemanagerTagValuesCreate{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        payload = payload, uploadType = Core.Nothing,
                                        uploadProtocol = Core.Nothing, validateOnly = Core.Nothing}
instance Core.GoogleRequest CloudresourcemanagerTagValuesCreate
         where
        type Rs CloudresourcemanagerTagValuesCreate = Operation
        type Scopes CloudresourcemanagerTagValuesCreate =
