...
newCloudresourcemanagerTagValuesGetIamPolicy payload resource
  = CloudresourcemanagerTagValuesGetIamPolicy{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           CloudresourcemanagerTagValuesGetIamPolicy
         where
        type Rs CloudresourcemanagerTagValuesGetIamPolicy = Policy
        type Scopes CloudresourcemanagerTagValuesGetIamPolicy =
             '[CloudPlatform'FullControl, CloudPlatform'ReadOnly]
        requestClient CloudresourcemanagerTagValuesGetIamPolicy{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudresourcemanagerTagValuesGetIamPolicyResource)
                      Core.mempty
