...
newCloudresourcemanagerTagValuesGet name
  = CloudresourcemanagerTagValuesGet{xgafv = Core.Nothing,
                                     accessToken = Core.Nothing, callback = Core.Nothing,
                                     name = name, uploadType = Core.Nothing,
                                     uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudresourcemanagerTagValuesGet where
        ...
        requestClient CloudresourcemanagerTagValuesGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy CloudresourcemanagerTagValuesGetResource)
                      Core.mempty
