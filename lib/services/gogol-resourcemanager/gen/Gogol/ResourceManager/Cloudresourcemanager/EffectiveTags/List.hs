                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] ListEffectiveTagsResponse
...
newCloudresourcemanagerEffectiveTagsList 
    :: 
                                         CloudresourcemanagerEffectiveTagsList
newCloudresourcemanagerEffectiveTagsList
  = CloudresourcemanagerEffectiveTagsList{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          pageSize = Core.Nothing, pageToken = Core.Nothing,
                                          parent = Core.Nothing, uploadType = Core.Nothing,
                                          uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudresourcemanagerEffectiveTagsList
         where
        type Rs CloudresourcemanagerEffectiveTagsList =
             ListEffectiveTagsResponse
        type Scopes CloudresourcemanagerEffectiveTagsList =
             '[CloudPlatform'FullControl, CloudPlatform'ReadOnly]
        requestClient CloudresourcemanagerEffectiveTagsList{..}
          = go xgafv accessToken callback pageSize pageToken parent
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudresourcemanagerEffectiveTagsListResource)
                      Core.mempty
