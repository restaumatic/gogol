...
module Gogol.ServiceControl.Internal.Product
  (
    ...
    -- * AuthenticationInfo_LoggableShortLivedCredential
    AuthenticationInfo_LoggableShortLivedCredential (..),
    newAuthenticationInfo_LoggableShortLivedCredential,
...
newAuth
  = Auth{accessLevels = Core.Nothing, audiences = Core.Nothing,
         claims = Core.Nothing, oauth = Core.Nothing,
         presenter = Core.Nothing, principal = Core.Nothing}
...
data AuthenticationInfo = AuthenticationInfo
    ...
    , loggableShortLivedCredential :: (Core.Maybe AuthenticationInfo_LoggableShortLivedCredential)
      -- | OAuth authentication information such as the OAuth client ID.
    , oauthInfo :: (Core.Maybe OAuthInfo)
...
newAuthenticationInfo
  = AuthenticationInfo{authoritySelector = Core.Nothing,
                       loggableShortLivedCredential = Core.Nothing,
                       oauthInfo = Core.Nothing, principalEmail = Core.Nothing,
              ...
              (\ o ->
                 AuthenticationInfo Core.<$>
                   (o Core..:? "authoritySelector") Core.<*>
                     (o Core..:? "loggableShortLivedCredential")
                     Core.<*> (o Core..:? "oauthInfo")
          ...
          = Core.object
              (Core.catMaybes
                 [("authoritySelector" Core..=) Core.<$> authoritySelector,
                  ("loggableShortLivedCredential" Core..=) Core.<$>
                    loggableShortLivedCredential,
                  ("oauthInfo" Core..=) Core.<$> oauthInfo,
...
-- | Converted from \"identity_cloudgaia.AuditLoggableShortLivedCredential\" proto. This message will be used by security, detection and response team. For context please refer to go\/cg:short-lived-credential-logging. When the JSON object represented here has a proto equivalent, the proto name will be indicated in the @\@type@ property.
--
-- /See:/ 'newAuthenticationInfo_LoggableShortLivedCredential' smart constructor.
newtype AuthenticationInfo_LoggableShortLivedCredential = AuthenticationInfo_LoggableShortLivedCredential
    {
      -- | Properties of the object.
      additional :: (Core.HashMap Core.Text Core.Value)
    }
...
-- | Creates a value of 'AuthenticationInfo_LoggableShortLivedCredential' with the minimum fields required to make a request.
newAuthenticationInfo_LoggableShortLivedCredential 
    :: 
                                                   Core.HashMap Core.Text Core.Value
       -- ^  Properties of the object. See 'additional'.
    -> AuthenticationInfo_LoggableShortLivedCredential
newAuthenticationInfo_LoggableShortLivedCredential additional
  = AuthenticationInfo_LoggableShortLivedCredential{additional =
                                                      additional}
instance Core.FromJSON
           AuthenticationInfo_LoggableShortLivedCredential
         where
        parseJSON
          = Core.withObject "AuthenticationInfo_LoggableShortLivedCredential"
              (\ o ->
                 AuthenticationInfo_LoggableShortLivedCredential Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON
           AuthenticationInfo_LoggableShortLivedCredential
         where
        toJSON AuthenticationInfo_LoggableShortLivedCredential{..}
...
--
-- /See:/ 'newOAuthInfo' smart constructor.
newtype OAuthInfo = OAuthInfo
    {
...
-- | Creates a value of 'OAuthInfo' with the minimum fields required to make a request.
newOAuthInfo 
    ::  OAuthInfo
newOAuthInfo = OAuthInfo{oauthClientId = Core.Nothing}
instance Core.FromJSON OAuthInfo where
        parseJSON
          = Core.withObject "OAuthInfo"
              (\ o -> OAuthInfo Core.<$> (o Core..:? "oauthClientId"))

instance Core.ToJSON OAuthInfo where
        toJSON OAuthInfo{..}
          = Core.object
              (Core.catMaybes [("oauthClientId" Core..=) Core.<$> oauthClientId])


-- | This message defines attributes associated with OAuth credentials.
--
-- /See:/ 'newOauth' smart constructor.
newtype Oauth = Oauth
    {
...
-- | Creates a value of 'Oauth' with the minimum fields required to make a request.
newOauth 
    ::  Oauth
newOauth = Oauth{clientId = Core.Nothing}
instance Core.FromJSON Oauth where
        parseJSON
          = Core.withObject "Oauth"
              (\ o -> Oauth Core.<$> (o Core..:? "clientId"))

instance Core.ToJSON Oauth where
        toJSON Oauth{..}
          = Core.object
              (Core.catMaybes [("clientId" Core..=) Core.<$> clientId])
