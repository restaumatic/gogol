...
type ServiceControlServicesCheckResource =
     "v2" Core.:>
       "services" Core.:>
         Core.CaptureMode "serviceName" "check" Core.Text Core.:>
                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] CheckRequest Core.:>
                         Core.Post '[Core.JSON] CheckResponse
...
instance Core.GoogleRequest ServiceControlServicesCheck where
        ...
        requestClient ServiceControlServicesCheck{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ServiceControlServicesCheckResource)
                      Core.mempty
