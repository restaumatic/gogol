...
type StreetViewPublishPhotosBatchGetResource =
     "v1" Core.:>
       "photos:batchGet" Core.:>
         Core.QueryParam "$.xgafv" Xgafv Core.:>
           Core.QueryParam "access_token" Core.Text Core.:>
             Core.QueryParam "callback" Core.Text Core.:>
               Core.QueryParam "languageCode" Core.Text Core.:>
                 Core.QueryParams "photoIds" Core.Text Core.:>
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "view" PhotosBatchGetView Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] BatchGetPhotosResponse
...
newStreetViewPublishPhotosBatchGet 
    :: 
                                   StreetViewPublishPhotosBatchGet
newStreetViewPublishPhotosBatchGet
  = StreetViewPublishPhotosBatchGet{xgafv = Core.Nothing,
                                    accessToken = Core.Nothing, callback = Core.Nothing,
                                    languageCode = Core.Nothing, photoIds = Core.Nothing,
                                    uploadType = Core.Nothing, uploadProtocol = Core.Nothing,
                                    view = Core.Nothing}
instance Core.GoogleRequest StreetViewPublishPhotosBatchGet where
        type Rs StreetViewPublishPhotosBatchGet = BatchGetPhotosResponse
        type Scopes StreetViewPublishPhotosBatchGet =
        ...
        requestClient StreetViewPublishPhotosBatchGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy StreetViewPublishPhotosBatchGetResource)
                      Core.mempty
