               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] BatchUpdatePhotosRequest Core.:>
                       Core.Post '[Core.JSON] BatchUpdatePhotosResponse
...
newStreetViewPublishPhotosBatchUpdate payload
  = StreetViewPublishPhotosBatchUpdate{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       payload = payload, uploadType = Core.Nothing,
                                       uploadProtocol = Core.Nothing}
instance Core.GoogleRequest StreetViewPublishPhotosBatchUpdate
         where
        type Rs StreetViewPublishPhotosBatchUpdate =
             BatchUpdatePhotosResponse
        type Scopes StreetViewPublishPhotosBatchUpdate =
