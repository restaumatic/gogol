               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] BatchDeletePhotosRequest Core.:>
...
newStreetViewPublishPhotosBatchDelete payload
  = StreetViewPublishPhotosBatchDelete{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       payload = payload, uploadType = Core.Nothing,
                                       uploadProtocol = Core.Nothing}
instance Core.GoogleRequest StreetViewPublishPhotosBatchDelete
         where
        ...
        requestClient StreetViewPublishPhotosBatchDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy StreetViewPublishPhotosBatchDeleteResource)
                      Core.mempty
