...
instance Core.ToJSON BatchUpdatePhotosRequest where
        toJSON BatchUpdatePhotosRequest{..}
          = Core.object
              (Core.catMaybes
                 [("updatePhotoRequests" Core..=) Core.<$> updatePhotoRequests])
...
instance Core.FromJSON BatchUpdatePhotosResponse where
        parseJSON
          = Core.withObject "BatchUpdatePhotosResponse"
              (\ o -> BatchUpdatePhotosResponse Core.<$> (o Core..:? "results"))
...
newGpsDataGapFailureDetails 
    ::  GpsDataGapFailureDetails
newGpsDataGapFailureDetails
  = GpsDataGapFailureDetails{gapDuration = Core.Nothing,
          ...
          = Core.withObject "GpsDataGapFailureDetails"
              (\ o ->
                 GpsDataGapFailureDetails Core.<$>
                   (o Core..:? "gapDuration") Core.<*> (o Core..:? "gapStartTime"))
...
newImu 
    ::  Imu
newImu
  = Imu{accelMpsps = Core.Nothing, gyroRps = Core.Nothing,
        magUt = Core.Nothing}
instance Core.FromJSON Imu where
        parseJSON
          = Core.withObject "Imu"
              (\ o ->
                 Imu Core.<$>
                   (o Core..:? "accelMpsps") Core.<*> (o Core..:? "gyroRps") Core.<*>
                     (o Core..:? "magUt"))
...
newImuDataGapFailureDetails 
    ::  ImuDataGapFailureDetails
newImuDataGapFailureDetails
  = ImuDataGapFailureDetails{gapDuration = Core.Nothing,
                             gapStartTime = Core.Nothing}
...
instance Core.FromJSON LatLngBounds where
        parseJSON
          = Core.withObject "LatLngBounds"
              (\ o ->
                 LatLngBounds Core.<$>
                   (o Core..:? "northeast") Core.<*> (o Core..:? "southwest"))
...
instance Core.FromJSON Level where
        parseJSON
          = Core.withObject "Level"
              (\ o ->
                 Level Core.<$> (o Core..:? "name") Core.<*> (o Core..:? "number"))
...
newListPhotoSequencesResponse 
    ::  ListPhotoSequencesResponse
newListPhotoSequencesResponse
  = ListPhotoSequencesResponse{nextPageToken = Core.Nothing,
...
newListPhotosResponse 
    ::  ListPhotosResponse
newListPhotosResponse
  = ListPhotosResponse{nextPageToken = Core.Nothing,
                       photos = Core.Nothing}
          ...
          = Core.withObject "ListPhotosResponse"
              (\ o ->
                 ListPhotosResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "photos"))
...
newMeasurement3d 
    ::  Measurement3d
newMeasurement3d
  = Measurement3d{captureTime = Core.Nothing, x = Core.Nothing,
...
instance Core.FromJSON Measurement3d where
        parseJSON
          = Core.withObject "Measurement3d"
              (\ o ->
                 Measurement3d Core.<$>
                   (o Core..:? "captureTime") Core.<*> (o Core..:? "x") Core.<*>
                     (o Core..:? "y")
                     Core.<*> (o Core..:? "z"))
...
newNoOverlapGpsFailureDetails 
    ::  NoOverlapGpsFailureDetails
newNoOverlapGpsFailureDetails
  = NoOverlapGpsFailureDetails{gpsEndTime = Core.Nothing,
                               gpsStartTime = Core.Nothing, videoEndTime = Core.Nothing,
          ...
          = Core.withObject "NoOverlapGpsFailureDetails"
              (\ o ->
                 NoOverlapGpsFailureDetails Core.<$>
                   (o Core..:? "gpsEndTime") Core.<*> (o Core..:? "gpsStartTime")
...
instance Core.FromJSON NotOutdoorsFailureDetails where
        parseJSON
          = Core.withObject "NotOutdoorsFailureDetails"
              (\ o ->
                 NotOutdoorsFailureDetails Core.<$> (o Core..:? "startTime"))
...
newPhoto 
    ::  Photo
newPhoto
  = Photo{captureTime = Core.Nothing, connections = Core.Nothing,
          downloadUrl = Core.Nothing, mapsPublishStatus = Core.Nothing,
          photoId = Core.Nothing, places = Core.Nothing, pose = Core.Nothing,
          shareLink = Core.Nothing, thumbnailUrl = Core.Nothing,
          transferStatus = Core.Nothing, uploadReference = Core.Nothing,
          uploadTime = Core.Nothing, viewCount = Core.Nothing}
instance Core.FromJSON Photo where
        parseJSON
          = Core.withObject "Photo"
              (\ o ->
                 Photo Core.<$>
                   (o Core..:? "captureTime") Core.<*> (o Core..:? "connections")
          ...
          = Core.object
              (Core.catMaybes
                 [("captureTime" Core..=) Core.<$> captureTime,
                  ...
                  ("mapsPublishStatus" Core..=) Core.<$> mapsPublishStatus,
                  ("photoId" Core..=) Core.<$> photoId,
                  ("places" Core..=) Core.<$> places, ("pose" Core..=) Core.<$> pose,
...
newPhotoResponse 
    ::  PhotoResponse
newPhotoResponse
  = PhotoResponse{photo = Core.Nothing, status = Core.Nothing}
...
newPhotoSequence 
    ::  PhotoSequence
newPhotoSequence
  = PhotoSequence{captureTimeOverride = Core.Nothing,
                  distanceMeters = Core.Nothing, failureDetails = Core.Nothing,
                  failureReason = Core.Nothing, filename = Core.Nothing,
                  gpsSource = Core.Nothing, id = Core.Nothing, imu = Core.Nothing,
                  photos = Core.Nothing, processingState = Core.Nothing,
                  rawGpsTimeline = Core.Nothing, sequenceBounds = Core.Nothing,
                  uploadReference = Core.Nothing, uploadTime = Core.Nothing,
...
instance Core.ToJSON PhotoSequence where
        toJSON PhotoSequence{..}
          = Core.object
              (Core.catMaybes
                 [("captureTimeOverride" Core..=) Core.<$> captureTimeOverride,
                  ...
                  ("id" Core..=) Core.<$> id, ("imu" Core..=) Core.<$> imu,
                  ("photos" Core..=) Core.<$> photos,
...
newPlace 
    ::  Place
newPlace
  = Place{languageCode = Core.Nothing, name = Core.Nothing,
...
instance Core.FromJSON Place where
        parseJSON
          = Core.withObject "Place"
              (\ o ->
                 Place Core.<$>
                   (o Core..:? "languageCode") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "placeId"))
...
newPose 
    ::  Pose
newPose
  = Pose{accuracyMeters = Core.Nothing, altitude = Core.Nothing,
         gpsRecordTimestampUnixEpoch = Core.Nothing, heading = Core.Nothing,
         latLngPair = Core.Nothing, level = Core.Nothing,
         pitch = Core.Nothing, roll = Core.Nothing}
instance Core.FromJSON Pose where
        parseJSON
          = Core.withObject "Pose"
              (\ o ->
                 Pose Core.<$>
                   (o Core..:? "accuracyMeters") Core.<*> (o Core..:? "altitude")
          ...
          = Core.object
              (Core.catMaybes
                 [("accuracyMeters" Core..=) Core.<$> accuracyMeters,
                  ...
                  ("level" Core..=) Core.<$> level, ("pitch" Core..=) Core.<$> pitch,
                  ("roll" Core..=) Core.<$> roll])
...
newProcessingFailureDetails 
    ::  ProcessingFailureDetails
newProcessingFailureDetails
  = ProcessingFailureDetails{gpsDataGapDetails = Core.Nothing,
...
instance Core.ToJSON ProcessingFailureDetails where
        toJSON ProcessingFailureDetails{..}
          = Core.object
              (Core.catMaybes
                 [("gpsDataGapDetails" Core..=) Core.<$> gpsDataGapDetails,
                  ("imuDataGapDetails" Core..=) Core.<$> imuDataGapDetails,
                  ("insufficientGpsDetails" Core..=) Core.<$> insufficientGpsDetails,
                  ("noOverlapGpsDetails" Core..=) Core.<$> noOverlapGpsDetails,
                  ("notOutdoorsDetails" Core..=) Core.<$> notOutdoorsDetails])
...
newUpdatePhotoRequest 
    ::  UpdatePhotoRequest
newUpdatePhotoRequest
  = UpdatePhotoRequest{photo = Core.Nothing,
          ...
          = Core.withObject "UpdatePhotoRequest"
              (\ o ->
                 UpdatePhotoRequest Core.<$>
                   (o Core..:? "photo") Core.<*> (o Core..:? "updateMask"))
...
instance Core.ToJSON UploadRef where
        toJSON UploadRef{..}
          = Core.object
              (Core.catMaybes [("uploadUrl" Core..=) Core.<$> uploadUrl])
