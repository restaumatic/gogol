                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] Photo Core.:> Core.Put '[Core.JSON] Photo
...
newStreetViewPublishPhotoUpdate id payload
  = StreetViewPublishPhotoUpdate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest StreetViewPublishPhotoUpdate where
        type Rs StreetViewPublishPhotoUpdate = Photo
        type Scopes StreetViewPublishPhotoUpdate =
        ...
        requestClient StreetViewPublishPhotoUpdate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy StreetViewPublishPhotoUpdateResource)
                      Core.mempty
