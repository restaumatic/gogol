...
type StreetViewPublishPhotoSequenceStartUploadResource =
     "v1" Core.:>
       "photoSequence:startUpload" Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] Empty Core.:>
                       Core.Post '[Core.JSON] UploadRef
...
newStreetViewPublishPhotoSequenceStartUpload payload
  = StreetViewPublishPhotoSequenceStartUpload{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           StreetViewPublishPhotoSequenceStartUpload
         where
        type Rs StreetViewPublishPhotoSequenceStartUpload = UploadRef
        type Scopes StreetViewPublishPhotoSequenceStartUpload =
             '[Streetviewpublish'FullControl]
        requestClient StreetViewPublishPhotoSequenceStartUpload{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy StreetViewPublishPhotoSequenceStartUploadResource)
                      Core.mempty
