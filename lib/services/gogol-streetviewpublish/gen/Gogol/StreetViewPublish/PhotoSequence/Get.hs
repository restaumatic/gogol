...
newStreetViewPublishPhotoSequenceGet sequenceId
  = StreetViewPublishPhotoSequenceGet{xgafv = Core.Nothing,
                                      accessToken = Core.Nothing, callback = Core.Nothing,
                                      filter = Core.Nothing, sequenceId = sequenceId,
                                      uploadType = Core.Nothing, uploadProtocol = Core.Nothing,
                                      view = Core.Nothing}
instance Core.GoogleRequest StreetViewPublishPhotoSequenceGet where
        ...
        requestClient StreetViewPublishPhotoSequenceGet{..}
          = go sequenceId xgafv accessToken callback filter uploadType
              uploadProtocol
              view
