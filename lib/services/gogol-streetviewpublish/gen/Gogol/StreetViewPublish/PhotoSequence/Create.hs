         ...
         Core.QueryParam "$.xgafv" Xgafv Core.:>
           Core.QueryParam "access_token" Core.Text Core.:>
             Core.QueryParam "callback" Core.Text Core.:>
               Core.QueryParam "inputType" PhotoSequenceCreateInputType Core.:>
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] PhotoSequence Core.:>
...
newStreetViewPublishPhotoSequenceCreate payload
  = StreetViewPublishPhotoSequenceCreate{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         inputType = Core.Nothing, payload = payload,
                                         uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest StreetViewPublishPhotoSequenceCreate
         where
        type Rs StreetViewPublishPhotoSequenceCreate = Operation
        type Scopes StreetViewPublishPhotoSequenceCreate =
             '[Streetviewpublish'FullControl]
        requestClient StreetViewPublishPhotoSequenceCreate{..}
          = go xgafv accessToken callback inputType uploadType uploadProtocol
