...
newStreetViewPublishPhotoSequenceDelete sequenceId
  = StreetViewPublishPhotoSequenceDelete{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         sequenceId = sequenceId, uploadType = Core.Nothing,
                                         uploadProtocol = Core.Nothing}
instance Core.GoogleRequest StreetViewPublishPhotoSequenceDelete
         where
        type Rs StreetViewPublishPhotoSequenceDelete = Empty
        type Scopes StreetViewPublishPhotoSequenceDelete =
             '[Streetviewpublish'FullControl]
        requestClient StreetViewPublishPhotoSequenceDelete{..}
          = go sequenceId xgafv accessToken callback uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy StreetViewPublishPhotoSequenceDeleteResource)
                      Core.mempty
