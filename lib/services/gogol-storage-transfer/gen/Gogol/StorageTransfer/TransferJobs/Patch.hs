               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] UpdateTransferJobRequest Core.:>
                       Core.Patch '[Core.JSON] TransferJob
...
newStorageTransferTransferJobsPatch jobName payload
  = StorageTransferTransferJobsPatch{xgafv = Core.Nothing,
                                     accessToken = Core.Nothing, callback = Core.Nothing,
                                     jobName = jobName, payload = payload,
...
instance Core.GoogleRequest StorageTransferTransferJobsPatch where
        ...
        type Scopes StorageTransferTransferJobsPatch =
