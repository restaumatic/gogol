               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] TransferJob Core.:>
                       Core.Post '[Core.JSON] TransferJob
...
newStorageTransferTransferJobsCreate payload
  = StorageTransferTransferJobsCreate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest StorageTransferTransferJobsCreate where
        ...
        type Scopes StorageTransferTransferJobsCreate =
