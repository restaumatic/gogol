...
newStorageTransferTransferJobsList filter
  = StorageTransferTransferJobsList{xgafv = Core.Nothing,
                                    accessToken = Core.Nothing, callback = Core.Nothing,
                                    filter = filter, pageSize = Core.Nothing,
                                    pageToken = Core.Nothing, uploadType = Core.Nothing,
                                    uploadProtocol = Core.Nothing}
instance Core.GoogleRequest StorageTransferTransferJobsList where
        type Rs StorageTransferTransferJobsList = ListTransferJobsResponse
        type Scopes StorageTransferTransferJobsList =
             '[CloudPlatform'FullControl]
        requestClient StorageTransferTransferJobsList{..}
          = go (Core.Just filter) xgafv accessToken callback pageSize
              pageToken
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy StorageTransferTransferJobsListResource)
                      Core.mempty
