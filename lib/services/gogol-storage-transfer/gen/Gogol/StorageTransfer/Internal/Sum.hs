  ...
  (
    ...
    LoggingConfig_LogActionStatesItem
      (
        ...
        LoggingConfig_LogActionStatesItem_Skipped,
        ..
      ),
...
pattern LoggingConfig_LogActionStatesItem_Skipped :: LoggingConfig_LogActionStatesItem
pattern LoggingConfig_LogActionStatesItem_Skipped = LoggingConfig_LogActionStatesItem "SKIPPED"
