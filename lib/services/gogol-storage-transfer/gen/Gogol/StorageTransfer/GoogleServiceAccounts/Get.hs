                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.Get '[Core.JSON] GoogleServiceAccount
...
newStorageTransferGoogleServiceAccountsGet projectId
  = StorageTransferGoogleServiceAccountsGet{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            projectId = projectId, uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest StorageTransferGoogleServiceAccountsGet
         where
        type Rs StorageTransferGoogleServiceAccountsGet =
             GoogleServiceAccount
        type Scopes StorageTransferGoogleServiceAccountsGet =
             '[CloudPlatform'FullControl]
        requestClient StorageTransferGoogleServiceAccountsGet{..}
          = go projectId xgafv accessToken callback uploadType uploadProtocol
              (Core.Just Core.AltJSON)
              storageTransferService
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy StorageTransferGoogleServiceAccountsGetResource)
                      Core.mempty
