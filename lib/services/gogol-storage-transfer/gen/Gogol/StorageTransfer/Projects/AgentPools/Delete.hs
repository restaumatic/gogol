...
newStorageTransferProjectsAgentPoolsDelete name
  = StorageTransferProjectsAgentPoolsDelete{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            name = name, uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest StorageTransferProjectsAgentPoolsDelete
         where
        type Rs StorageTransferProjectsAgentPoolsDelete = Empty
        type Scopes StorageTransferProjectsAgentPoolsDelete =
             '[CloudPlatform'FullControl]
        requestClient StorageTransferProjectsAgentPoolsDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy StorageTransferProjectsAgentPoolsDeleteResource)
                      Core.mempty
