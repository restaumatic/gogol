...
newStorageTransferProjectsAgentPoolsGet name
  = StorageTransferProjectsAgentPoolsGet{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         name = name, uploadType = Core.Nothing,
                                         uploadProtocol = Core.Nothing}
instance Core.GoogleRequest StorageTransferProjectsAgentPoolsGet
         where
        type Rs StorageTransferProjectsAgentPoolsGet = AgentPool
        type Scopes StorageTransferProjectsAgentPoolsGet =
