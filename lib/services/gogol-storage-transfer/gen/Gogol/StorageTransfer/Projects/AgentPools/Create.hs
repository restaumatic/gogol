...
newStorageTransferProjectsAgentPoolsCreate payload projectId
  = StorageTransferProjectsAgentPoolsCreate{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, agentPoolId = Core.Nothing,
                                            callback = Core.Nothing, payload = payload,
                                            projectId = projectId, uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest StorageTransferProjectsAgentPoolsCreate
         where
        type Rs StorageTransferProjectsAgentPoolsCreate = AgentPool
        type Scopes StorageTransferProjectsAgentPoolsCreate =
             '[CloudPlatform'FullControl]
        requestClient StorageTransferProjectsAgentPoolsCreate{..}
          = go projectId xgafv accessToken agentPoolId callback uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy StorageTransferProjectsAgentPoolsCreateResource)
                      Core.mempty
