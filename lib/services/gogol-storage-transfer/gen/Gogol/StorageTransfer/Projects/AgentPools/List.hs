                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Get '[Core.JSON] ListAgentPoolsResponse
...
newStorageTransferProjectsAgentPoolsList projectId
  = StorageTransferProjectsAgentPoolsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest StorageTransferProjectsAgentPoolsList
         where
        type Rs StorageTransferProjectsAgentPoolsList =
             ListAgentPoolsResponse
        type Scopes StorageTransferProjectsAgentPoolsList =
             '[CloudPlatform'FullControl]
        requestClient StorageTransferProjectsAgentPoolsList{..}
          = go projectId xgafv accessToken callback filter pageSize pageToken
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy StorageTransferProjectsAgentPoolsListResource)
                      Core.mempty
