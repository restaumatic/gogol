...
newStorageTransferTransferOperationsCancel name payload
  = StorageTransferTransferOperationsCancel{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            name = name, payload = payload,
                                            uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest StorageTransferTransferOperationsCancel
         where
        type Rs StorageTransferTransferOperationsCancel = Empty
        type Scopes StorageTransferTransferOperationsCancel =
