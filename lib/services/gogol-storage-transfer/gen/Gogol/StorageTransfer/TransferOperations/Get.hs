...
newStorageTransferTransferOperationsGet name
  = StorageTransferTransferOperationsGet{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         name = name, uploadType = Core.Nothing,
                                         uploadProtocol = Core.Nothing}
instance Core.GoogleRequest StorageTransferTransferOperationsGet
         where
        type Rs StorageTransferTransferOperationsGet = Operation
        type Scopes StorageTransferTransferOperationsGet =
