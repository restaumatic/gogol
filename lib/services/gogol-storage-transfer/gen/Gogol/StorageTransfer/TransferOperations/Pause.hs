               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] PauseTransferOperationRequest Core.:>
...
newStorageTransferTransferOperationsPause name payload
  = StorageTransferTransferOperationsPause{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           name = name, payload = payload,
                                           uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest StorageTransferTransferOperationsPause
         where
        type Rs StorageTransferTransferOperationsPause = Empty
        type Scopes StorageTransferTransferOperationsPause =
             '[CloudPlatform'FullControl]
        requestClient StorageTransferTransferOperationsPause{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy StorageTransferTransferOperationsPauseResource)
                      Core.mempty
