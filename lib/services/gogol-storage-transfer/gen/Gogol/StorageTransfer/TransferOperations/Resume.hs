               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] ResumeTransferOperationRequest Core.:>
...
newStorageTransferTransferOperationsResume name payload
  = StorageTransferTransferOperationsResume{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            name = name, payload = payload,
                                            uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest StorageTransferTransferOperationsResume
         where
        type Rs StorageTransferTransferOperationsResume = Empty
        type Scopes StorageTransferTransferOperationsResume =
             '[CloudPlatform'FullControl]
        requestClient StorageTransferTransferOperationsResume{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy StorageTransferTransferOperationsResumeResource)
                      Core.mempty
