                 ...
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] GoogleIamV2Policy Core.:>
                       Core.Put '[Core.JSON] GoogleLongrunningOperation
...
newIAMPoliciesUpdate name payload
  = IAMPoliciesUpdate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest IAMPoliciesUpdate where
        type Rs IAMPoliciesUpdate = GoogleLongrunningOperation
        type Scopes IAMPoliciesUpdate = '[CloudPlatform'FullControl]
