...
newIAMPoliciesCreatePolicy parent payload
  = IAMPoliciesCreatePolicy{xgafv = Core.Nothing,
                            accessToken = Core.Nothing, callback = Core.Nothing,
                            parent = parent, payload = payload, policyId = Core.Nothing,
                            uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest IAMPoliciesCreatePolicy where
        type Rs IAMPoliciesCreatePolicy = GoogleLongrunningOperation
        type Scopes IAMPoliciesCreatePolicy = '[CloudPlatform'FullControl]
        requestClient IAMPoliciesCreatePolicy{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy IAMPoliciesCreatePolicyResource)
                      Core.mempty
