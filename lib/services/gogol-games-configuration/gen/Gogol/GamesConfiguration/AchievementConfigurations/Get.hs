...
--
-- /See:/ <https://developers.google.com/games/ Google Play Games Services Publishing API Reference> for @gamesConfiguration.achievementConfigurations.get@.
module Gogol.GamesConfiguration.AchievementConfigurations.Get
    (
    -- * Resource
                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.Get '[Core.JSON] AchievementConfiguration
...
newGamesConfigurationAchievementConfigurationsGet achievementId
  = GamesConfigurationAchievementConfigurationsGet{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           GamesConfigurationAchievementConfigurationsGet
         where
        type Rs GamesConfigurationAchievementConfigurationsGet =
             AchievementConfiguration
        type Scopes GamesConfigurationAchievementConfigurationsGet =
             '[Androidpublisher'FullControl]
        requestClient GamesConfigurationAchievementConfigurationsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy GamesConfigurationAchievementConfigurationsGetResource)
                      Core.mempty
