...
--
-- /See:/ <https://developers.google.com/games/ Google Play Games Services Publishing API Reference> for @gamesConfiguration.achievementConfigurations.update@.
module Gogol.GamesConfiguration.AchievementConfigurations.Update
    (
    -- * Resource
                     ...
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] AchievementConfiguration Core.:>
                           Core.Put '[Core.JSON] AchievementConfiguration
...
newGamesConfigurationAchievementConfigurationsUpdate 
    ...
    -> GamesConfigurationAchievementConfigurationsUpdate
newGamesConfigurationAchievementConfigurationsUpdate achievementId
  payload
  = GamesConfigurationAchievementConfigurationsUpdate{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           GamesConfigurationAchievementConfigurationsUpdate
         where
        type Rs GamesConfigurationAchievementConfigurationsUpdate =
             AchievementConfiguration
        type Scopes GamesConfigurationAchievementConfigurationsUpdate =
             '[Androidpublisher'FullControl]
        requestClient GamesConfigurationAchievementConfigurationsUpdate{..}
          = go achievementId xgafv accessToken callback uploadType
              uploadProtocol
