...
--
-- /See:/ <https://developers.google.com/games/ Google Play Games Services Publishing API Reference> for @gamesConfiguration.achievementConfigurations.list@.
module Gogol.GamesConfiguration.AchievementConfigurations.List
    (
    -- * Resource
                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Get '[Core.JSON] AchievementConfigurationListResponse
...
newGamesConfigurationAchievementConfigurationsList applicationId
  = GamesConfigurationAchievementConfigurationsList{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           GamesConfigurationAchievementConfigurationsList
         where
        type Rs GamesConfigurationAchievementConfigurationsList =
             AchievementConfigurationListResponse
        type Scopes GamesConfigurationAchievementConfigurationsList =
             '[Androidpublisher'FullControl]
        requestClient GamesConfigurationAchievementConfigurationsList{..}
          = go applicationId xgafv accessToken callback maxResults pageToken
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy GamesConfigurationAchievementConfigurationsListResource)
                      Core.mempty
