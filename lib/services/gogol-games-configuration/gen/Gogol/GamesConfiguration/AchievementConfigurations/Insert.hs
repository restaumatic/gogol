...
--
-- /See:/ <https://developers.google.com/games/ Google Play Games Services Publishing API Reference> for @gamesConfiguration.achievementConfigurations.insert@.
module Gogol.GamesConfiguration.AchievementConfigurations.Insert
    (
    -- * Resource
                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] AchievementConfiguration Core.:>
                             Core.Post '[Core.JSON] AchievementConfiguration
...
newGamesConfigurationAchievementConfigurationsInsert 
    ...
    -> GamesConfigurationAchievementConfigurationsInsert
newGamesConfigurationAchievementConfigurationsInsert applicationId
  payload
  = GamesConfigurationAchievementConfigurationsInsert{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           GamesConfigurationAchievementConfigurationsInsert
         where
        type Rs GamesConfigurationAchievementConfigurationsInsert =
             AchievementConfiguration
        type Scopes GamesConfigurationAchievementConfigurationsInsert =
             '[Androidpublisher'FullControl]
        requestClient GamesConfigurationAchievementConfigurationsInsert{..}
          = go applicationId xgafv accessToken callback uploadType
              uploadProtocol
