...
--
-- /See:/ <https://developers.google.com/games/ Google Play Games Services Publishing API Reference> for @gamesConfiguration.achievementConfigurations.delete@.
module Gogol.GamesConfiguration.AchievementConfigurations.Delete
    (
    -- * Resource
...
newGamesConfigurationAchievementConfigurationsDelete achievementId
  = GamesConfigurationAchievementConfigurationsDelete{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes GamesConfigurationAchievementConfigurationsDelete =
