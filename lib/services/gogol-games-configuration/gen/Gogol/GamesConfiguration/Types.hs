...
-- | Default request referring to version @v1configuration@ of the Google Play Games Services Publishing API. This contains the host and root path used as a starting point for constructing service requests.
