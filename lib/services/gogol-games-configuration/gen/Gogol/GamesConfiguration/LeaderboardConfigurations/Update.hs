...
--
-- /See:/ <https://developers.google.com/games/ Google Play Games Services Publishing API Reference> for @gamesConfiguration.leaderboardConfigurations.update@.
module Gogol.GamesConfiguration.LeaderboardConfigurations.Update
    (
    -- * Resource
                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] LeaderboardConfiguration Core.:>
                           Core.Put '[Core.JSON] LeaderboardConfiguration
...
newGamesConfigurationLeaderboardConfigurationsUpdate 
    ...
    -> GamesConfigurationLeaderboardConfigurationsUpdate
newGamesConfigurationLeaderboardConfigurationsUpdate leaderboardId
  payload
  = GamesConfigurationLeaderboardConfigurationsUpdate{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           GamesConfigurationLeaderboardConfigurationsUpdate
         where
        type Rs GamesConfigurationLeaderboardConfigurationsUpdate =
             LeaderboardConfiguration
        type Scopes GamesConfigurationLeaderboardConfigurationsUpdate =
             '[Androidpublisher'FullControl]
        requestClient GamesConfigurationLeaderboardConfigurationsUpdate{..}
          = go leaderboardId xgafv accessToken callback uploadType
              uploadProtocol
