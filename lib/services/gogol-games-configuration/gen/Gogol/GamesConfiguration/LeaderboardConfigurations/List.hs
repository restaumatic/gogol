...
--
-- /See:/ <https://developers.google.com/games/ Google Play Games Services Publishing API Reference> for @gamesConfiguration.leaderboardConfigurations.list@.
module Gogol.GamesConfiguration.LeaderboardConfigurations.List
    (
    -- * Resource
                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Get '[Core.JSON] LeaderboardConfigurationListResponse
...
newGamesConfigurationLeaderboardConfigurationsList applicationId
  = GamesConfigurationLeaderboardConfigurationsList{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           GamesConfigurationLeaderboardConfigurationsList
         where
        type Rs GamesConfigurationLeaderboardConfigurationsList =
             LeaderboardConfigurationListResponse
        type Scopes GamesConfigurationLeaderboardConfigurationsList =
