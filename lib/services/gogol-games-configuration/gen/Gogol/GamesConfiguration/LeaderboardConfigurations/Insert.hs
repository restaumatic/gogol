...
--
-- /See:/ <https://developers.google.com/games/ Google Play Games Services Publishing API Reference> for @gamesConfiguration.leaderboardConfigurations.insert@.
module Gogol.GamesConfiguration.LeaderboardConfigurations.Insert
    (
    -- * Resource
...
newGamesConfigurationLeaderboardConfigurationsInsert 
    ...
    -> GamesConfigurationLeaderboardConfigurationsInsert
newGamesConfigurationLeaderboardConfigurationsInsert applicationId
  payload
  = GamesConfigurationLeaderboardConfigurationsInsert{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           GamesConfigurationLeaderboardConfigurationsInsert
         where
        type Rs GamesConfigurationLeaderboardConfigurationsInsert =
             LeaderboardConfiguration
        type Scopes GamesConfigurationLeaderboardConfigurationsInsert =
