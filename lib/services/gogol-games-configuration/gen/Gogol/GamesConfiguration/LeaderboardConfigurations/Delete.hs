...
--
-- /See:/ <https://developers.google.com/games/ Google Play Games Services Publishing API Reference> for @gamesConfiguration.leaderboardConfigurations.delete@.
module Gogol.GamesConfiguration.LeaderboardConfigurations.Delete
    (
    -- * Resource
...
newGamesConfigurationLeaderboardConfigurationsDelete leaderboardId
  = GamesConfigurationLeaderboardConfigurationsDelete{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes GamesConfigurationLeaderboardConfigurationsDelete =
