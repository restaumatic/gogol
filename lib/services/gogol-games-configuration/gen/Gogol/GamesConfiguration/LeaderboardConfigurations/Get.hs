...
--
-- /See:/ <https://developers.google.com/games/ Google Play Games Services Publishing API Reference> for @gamesConfiguration.leaderboardConfigurations.get@.
module Gogol.GamesConfiguration.LeaderboardConfigurations.Get
    (
    -- * Resource
...
newGamesConfigurationLeaderboardConfigurationsGet leaderboardId
  = GamesConfigurationLeaderboardConfigurationsGet{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           GamesConfigurationLeaderboardConfigurationsGet
         where
        type Rs GamesConfigurationLeaderboardConfigurationsGet =
             LeaderboardConfiguration
        type Scopes GamesConfigurationLeaderboardConfigurationsGet =
             '[Androidpublisher'FullControl]
        requestClient GamesConfigurationLeaderboardConfigurationsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy GamesConfigurationLeaderboardConfigurationsGetResource)
                      Core.mempty
