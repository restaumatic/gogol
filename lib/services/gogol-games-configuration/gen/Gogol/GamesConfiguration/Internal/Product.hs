...
newAchievementConfiguration 
    ::  AchievementConfiguration
newAchievementConfiguration
  = AchievementConfiguration{achievementType = Core.Nothing,
                             draft = Core.Nothing, id = Core.Nothing,
                             initialState = Core.Nothing, kind = Core.Nothing,
                             published = Core.Nothing, stepsToUnlock = Core.Nothing,
                             token = Core.Nothing}
instance Core.FromJSON AchievementConfiguration where
        parseJSON
          = Core.withObject "AchievementConfiguration"
              (\ o ->
                 AchievementConfiguration Core.<$>
                   (o Core..:? "achievementType") Core.<*> (o Core..:? "draft")
                     Core.<*> (o Core..:? "id")
          ...
          = Core.object
              (Core.catMaybes
                 [("achievementType" Core..=) Core.<$> achievementType,
                  ("draft" Core..=) Core.<$> draft, ("id" Core..=) Core.<$> id,
...
newAchievementConfigurationDetail 
    ::  AchievementConfigurationDetail
newAchievementConfigurationDetail
  = AchievementConfigurationDetail{description = Core.Nothing,
                                   iconUrl = Core.Nothing, kind = Core.Nothing, name = Core.Nothing,
                                   pointValue = Core.Nothing, sortRank = Core.Nothing}
instance Core.FromJSON AchievementConfigurationDetail where
        parseJSON
          = Core.withObject "AchievementConfigurationDetail"
              (\ o ->
                 AchievementConfigurationDetail Core.<$>
                   (o Core..:? "description") Core.<*> (o Core..:? "iconUrl") Core.<*>
                     (o Core..:? "kind")
                     Core.<*> (o Core..:? "name")
...
newAchievementConfigurationListResponse 
    :: 
                                        AchievementConfigurationListResponse
newAchievementConfigurationListResponse
  = AchievementConfigurationListResponse{items = Core.Nothing,
                                         kind = Core.Nothing, nextPageToken = Core.Nothing}
instance Core.FromJSON AchievementConfigurationListResponse where
        parseJSON
          = Core.withObject "AchievementConfigurationListResponse"
              (\ o ->
                 AchievementConfigurationListResponse Core.<$>
                   (o Core..:? "items") Core.<*> (o Core..:? "kind") Core.<*>
                     (o Core..:? "nextPageToken"))

instance Core.ToJSON AchievementConfigurationListResponse where
...
newGamesNumberAffixConfiguration 
    ::  GamesNumberAffixConfiguration
newGamesNumberAffixConfiguration
  = GamesNumberAffixConfiguration{few = Core.Nothing,
                                  many = Core.Nothing, one = Core.Nothing, other = Core.Nothing,
                                  two = Core.Nothing, zero = Core.Nothing}
instance Core.FromJSON GamesNumberAffixConfiguration where
        parseJSON
          = Core.withObject "GamesNumberAffixConfiguration"
              (\ o ->
                 GamesNumberAffixConfiguration Core.<$>
                   (o Core..:? "few") Core.<*> (o Core..:? "many") Core.<*>
                     (o Core..:? "one")
                     Core.<*> (o Core..:? "other")
                     Core.<*> (o Core..:? "two")
                     Core.<*> (o Core..:? "zero"))
...
instance Core.ToJSON GamesNumberAffixConfiguration where
        toJSON GamesNumberAffixConfiguration{..}
          = Core.object
              (Core.catMaybes
                 [("few" Core..=) Core.<$> few, ("many" Core..=) Core.<$> many,
                  ("one" Core..=) Core.<$> one, ("other" Core..=) Core.<$> other,
                  ("two" Core..=) Core.<$> two, ("zero" Core..=) Core.<$> zero])
...
newGamesNumberFormatConfiguration 
    ::  GamesNumberFormatConfiguration
newGamesNumberFormatConfiguration
  = GamesNumberFormatConfiguration{currencyCode = Core.Nothing,
                                   numDecimalPlaces = Core.Nothing, numberFormatType = Core.Nothing,
                                   suffix = Core.Nothing}
instance Core.FromJSON GamesNumberFormatConfiguration where
        parseJSON
          = Core.withObject "GamesNumberFormatConfiguration"
              (\ o ->
                 GamesNumberFormatConfiguration Core.<$>
                   (o Core..:? "currencyCode") Core.<*>
                     (o Core..:? "numDecimalPlaces")
          ...
          = Core.object
              (Core.catMaybes
                 [("currencyCode" Core..=) Core.<$> currencyCode,
                  ("numDecimalPlaces" Core..=) Core.<$> numDecimalPlaces,
                  ("numberFormatType" Core..=) Core.<$> numberFormatType,
...
newLeaderboardConfiguration 
    ::  LeaderboardConfiguration
newLeaderboardConfiguration
  = LeaderboardConfiguration{draft = Core.Nothing, id = Core.Nothing,
                             kind = Core.Nothing, published = Core.Nothing,
                             scoreMax = Core.Nothing, scoreMin = Core.Nothing,
                             scoreOrder = Core.Nothing, token = Core.Nothing}
instance Core.FromJSON LeaderboardConfiguration where
        parseJSON
          = Core.withObject "LeaderboardConfiguration"
              (\ o ->
                 LeaderboardConfiguration Core.<$>
                   (o Core..:? "draft") Core.<*> (o Core..:? "id") Core.<*>
                     (o Core..:? "kind")
                     Core.<*> (o Core..:? "published")
                     Core.<*> (o Core..:? "scoreMax" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "scoreMin" Core.<&> Core.fmap Core.fromAsText)
          ...
          = Core.object
              (Core.catMaybes
                 [("draft" Core..=) Core.<$> draft, ("id" Core..=) Core.<$> id,
                  ("kind" Core..=) Core.<$> kind,
                  ("published" Core..=) Core.<$> published,
                  ("scoreMax" Core..=) Core.. Core.AsText Core.<$> scoreMax,
                  ("scoreMin" Core..=) Core.. Core.AsText Core.<$> scoreMin,
...
newLeaderboardConfigurationDetail 
    ::  LeaderboardConfigurationDetail
newLeaderboardConfigurationDetail
  = LeaderboardConfigurationDetail{iconUrl = Core.Nothing,
                                   kind = Core.Nothing, name = Core.Nothing,
                                   scoreFormat = Core.Nothing, sortRank = Core.Nothing}
instance Core.FromJSON LeaderboardConfigurationDetail where
        parseJSON
          = Core.withObject "LeaderboardConfigurationDetail"
              (\ o ->
                 LeaderboardConfigurationDetail Core.<$>
                   (o Core..:? "iconUrl") Core.<*> (o Core..:? "kind") Core.<*>
                     (o Core..:? "name")
...
newLeaderboardConfigurationListResponse 
    :: 
                                        LeaderboardConfigurationListResponse
newLeaderboardConfigurationListResponse
  = LeaderboardConfigurationListResponse{items = Core.Nothing,
                                         kind = Core.Nothing, nextPageToken = Core.Nothing}
instance Core.FromJSON LeaderboardConfigurationListResponse where
        parseJSON
          = Core.withObject "LeaderboardConfigurationListResponse"
              (\ o ->
                 LeaderboardConfigurationListResponse Core.<$>
                   (o Core..:? "items") Core.<*> (o Core..:? "kind") Core.<*>
                     (o Core..:? "nextPageToken"))

instance Core.ToJSON LeaderboardConfigurationListResponse where
...
newLocalizedString 
    ::  LocalizedString
newLocalizedString
  = LocalizedString{kind = Core.Nothing, locale = Core.Nothing,
                    value = Core.Nothing}
          ...
          = Core.withObject "LocalizedString"
              (\ o ->
                 LocalizedString Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "locale") Core.<*>
                     (o Core..:? "value"))
...
newLocalizedStringBundle 
    ::  LocalizedStringBundle
newLocalizedStringBundle
  = LocalizedStringBundle{kind = Core.Nothing,
                          translations = Core.Nothing}
instance Core.FromJSON LocalizedStringBundle where
        parseJSON
          = Core.withObject "LocalizedStringBundle"
              (\ o ->
                 LocalizedStringBundle Core.<$>
                   (o Core..:? "kind") Core.<*> (o Core..:? "translations"))
