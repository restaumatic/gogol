...
newTextToSpeechOperationsDelete name
  = TextToSpeechOperationsDelete{xgafv = Core.Nothing,
                                 accessToken = Core.Nothing, callback = Core.Nothing, name = name,
                                 uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest TextToSpeechOperationsDelete where
        ...
        requestClient TextToSpeechOperationsDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy TextToSpeechOperationsDeleteResource)
                      Core.mempty
