...
module Gogol.TextToSpeech.Internal.Product
  (
    ...
    MultiSpeakerVoiceConfig (..),
    newMultiSpeakerVoiceConfig,

    -- * MultispeakerPrebuiltVoice
    MultispeakerPrebuiltVoice (..),
    newMultispeakerPrebuiltVoice,
...
--
-- /See:/ 'newMultiSpeakerVoiceConfig' smart constructor.
newtype MultiSpeakerVoiceConfig = MultiSpeakerVoiceConfig
    {
      -- | Required. A list of configurations for the voices of the speakers. Exactly two speaker voice configurations must be provided.
      speakerVoiceConfigs :: (Core.Maybe [MultispeakerPrebuiltVoice])
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'MultiSpeakerVoiceConfig' with the minimum fields required to make a request.
newMultiSpeakerVoiceConfig 
    ::  MultiSpeakerVoiceConfig
newMultiSpeakerVoiceConfig
  = MultiSpeakerVoiceConfig{speakerVoiceConfigs = Core.Nothing}
instance Core.FromJSON MultiSpeakerVoiceConfig where
        parseJSON
          = Core.withObject "MultiSpeakerVoiceConfig"
              (\ o ->
                 MultiSpeakerVoiceConfig Core.<$>
                   (o Core..:? "speakerVoiceConfigs"))

instance Core.ToJSON MultiSpeakerVoiceConfig where
        toJSON MultiSpeakerVoiceConfig{..}
          = Core.object
              (Core.catMaybes
                 [("speakerVoiceConfigs" Core..=) Core.<$> speakerVoiceConfigs])


-- | Configuration for a single speaker in a Gemini TTS multi-speaker setup. Enables dialogue between two speakers.
--
-- /See:/ 'newMultispeakerPrebuiltVoice' smart constructor.
data MultispeakerPrebuiltVoice = MultispeakerPrebuiltVoice
    {
      ...
      speakerAlias :: (Core.Maybe Core.Text)
    ...
    , speakerId :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'MultispeakerPrebuiltVoice' with the minimum fields required to make a request.
newMultispeakerPrebuiltVoice 
    ::  MultispeakerPrebuiltVoice
newMultispeakerPrebuiltVoice
  = MultispeakerPrebuiltVoice{speakerAlias = Core.Nothing,
                              speakerId = Core.Nothing}
instance Core.FromJSON MultispeakerPrebuiltVoice where
        parseJSON
          = Core.withObject "MultispeakerPrebuiltVoice"
              (\ o ->
                 MultispeakerPrebuiltVoice Core.<$>
                   (o Core..:? "speakerAlias") Core.<*> (o Core..:? "speakerId"))

instance Core.ToJSON MultispeakerPrebuiltVoice where
        toJSON MultispeakerPrebuiltVoice{..}
          = Core.object
              (Core.catMaybes
                 [("speakerAlias" Core..=) Core.<$> speakerAlias,
                  ("speakerId" Core..=) Core.<$> speakerId])
...
newSynthesisInput
  = SynthesisInput{customPronunciations = Core.Nothing,
                   ...
                   prompt = Core.Nothing, ssml = Core.Nothing, text = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("customPronunciations" Core..=) Core.<$> customPronunciations,
                  ...
                  ("prompt" Core..=) Core.<$> prompt, ("ssml" Core..=) Core.<$> ssml,
                  ("text" Core..=) Core.<$> text])
...
data VoiceSelectionParams = VoiceSelectionParams
    ...
    , multiSpeakerVoiceConfig :: (Core.Maybe MultiSpeakerVoiceConfig)
...
newVoiceSelectionParams
  = VoiceSelectionParams{customVoice = Core.Nothing,
                         languageCode = Core.Nothing, modelName = Core.Nothing,
                         multiSpeakerVoiceConfig = Core.Nothing, name = Core.Nothing,
              ...
              (\ o ->
                 VoiceSelectionParams Core.<$>
                   (o Core..:? "customVoice") Core.<*> (o Core..:? "languageCode")
                     ...
                     Core.<*> (o Core..:? "multiSpeakerVoiceConfig")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "ssmlGender")
          ...
          = Core.object
              (Core.catMaybes
                 [("customVoice" Core..=) Core.<$> customVoice,
                  ...
                  ("multiSpeakerVoiceConfig" Core..=) Core.<$>
                    multiSpeakerVoiceConfig,
                  ("name" Core..=) Core.<$> name,
                  ("ssmlGender" Core..=) Core.<$> ssmlGender,
