...
type TextToSpeechProjectsLocationsSynthesizeLongAudioResource =
     "v1" Core.:>
       Core.CaptureMode "parent" "synthesizeLongAudio" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] SynthesizeLongAudioRequest Core.:>
...
newTextToSpeechProjectsLocationsSynthesizeLongAudio parent payload
  = TextToSpeechProjectsLocationsSynthesizeLongAudio{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           TextToSpeechProjectsLocationsSynthesizeLongAudio
         where
        type Rs TextToSpeechProjectsLocationsSynthesizeLongAudio =
             Operation
        type Scopes TextToSpeechProjectsLocationsSynthesizeLongAudio =
