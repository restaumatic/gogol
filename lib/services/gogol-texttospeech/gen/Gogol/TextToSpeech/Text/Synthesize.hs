               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] SynthesizeSpeechRequest Core.:>
                       Core.Post '[Core.JSON] SynthesizeSpeechResponse
...
newTextToSpeechTextSynthesize payload
  = TextToSpeechTextSynthesize{xgafv = Core.Nothing,
...
instance Core.GoogleRequest TextToSpeechTextSynthesize where
        ...
        type Scopes TextToSpeechTextSynthesize =
