...
newDirectoryList 
    ::  DirectoryList
newDirectoryList
  = DirectoryList{discoveryVersion = "v1", items = Core.Nothing,
...
instance Core.FromJSON DirectoryList where
        parseJSON
          = Core.withObject "DirectoryList"
              (\ o ->
                 DirectoryList Core.<$>
                   (o Core..:? "discoveryVersion" Core..!= "v1") Core.<*>
                     (o Core..:? "items")
                     Core.<*> (o Core..:? "kind" Core..!= "discovery#directoryList"))

instance Core.ToJSON DirectoryList where
        toJSON DirectoryList{..}
          = Core.object
              (Core.catMaybes
                 [Core.Just ("discoveryVersion" Core..= discoveryVersion),
...
newDirectoryList_ItemsItem 
    ::  DirectoryList_ItemsItem
newDirectoryList_ItemsItem
  = DirectoryList_ItemsItem{description = Core.Nothing,
                            discoveryLink = Core.Nothing, discoveryRestUrl = Core.Nothing,
                            documentationLink = Core.Nothing, icons = Core.Nothing,
                            id = Core.Nothing, kind = "discovery#directoryItem",
                            labels = Core.Nothing, name = Core.Nothing,
                            preferred = Core.Nothing, title = Core.Nothing,
          ...
          = Core.withObject "DirectoryList_ItemsItem"
              (\ o ->
                 DirectoryList_ItemsItem Core.<$>
                   (o Core..:? "description") Core.<*> (o Core..:? "discoveryLink")
                     Core.<*> (o Core..:? "discoveryRestUrl")
                     Core.<*> (o Core..:? "documentationLink")
                     Core.<*> (o Core..:? "icons")
                     Core.<*> (o Core..:? "id")
                     Core.<*> (o Core..:? "kind" Core..!= "discovery#directoryItem")
                     Core.<*> (o Core..:? "labels")
                     Core.<*> (o Core..:? "name")
          ...
          = Core.object
              (Core.catMaybes
                 [("description" Core..=) Core.<$> description,
                  ...
                  ("discoveryRestUrl" Core..=) Core.<$> discoveryRestUrl,
                  ("documentationLink" Core..=) Core.<$> documentationLink,
...
newDirectoryList_ItemsItem_Icons 
    ::  DirectoryList_ItemsItem_Icons
newDirectoryList_ItemsItem_Icons
  = DirectoryList_ItemsItem_Icons{x16 = Core.Nothing,
                                  x32 = Core.Nothing}
...
instance Core.ToJSON DirectoryList_ItemsItem_Icons where
        toJSON DirectoryList_ItemsItem_Icons{..}
          = Core.object
              (Core.catMaybes
                 [("x16" Core..=) Core.<$> x16, ("x32" Core..=) Core.<$> x32])
...
data JsonSchema = JsonSchema
    ...
    , enumDeprecated :: (Core.Maybe [Core.Bool])
...
newJsonSchema 
    ::  JsonSchema
newJsonSchema
  = JsonSchema{ref = Core.Nothing,
               additionalProperties = Core.Nothing, annotations = Core.Nothing,
               default' = Core.Nothing, deprecated = Core.Nothing,
               description = Core.Nothing, enum = Core.Nothing,
               enumDeprecated = Core.Nothing, enumDescriptions = Core.Nothing,
               format = Core.Nothing, id = Core.Nothing, items = Core.Nothing,
               location = Core.Nothing, maximum = Core.Nothing,
               minimum = Core.Nothing, pattern' = Core.Nothing,
               properties = Core.Nothing, readOnly = Core.Nothing,
               repeated = Core.Nothing, required = Core.Nothing,
               type' = Core.Nothing, variant = Core.Nothing}
instance Core.FromJSON JsonSchema where
        parseJSON
          = Core.withObject "JsonSchema"
              (\ o ->
                 JsonSchema Core.<$>
                   (o Core..:? "$ref") Core.<*> (o Core..:? "additionalProperties")
                     Core.<*> (o Core..:? "annotations")
                     Core.<*> (o Core..:? "default")
                     Core.<*> (o Core..:? "deprecated")
                     Core.<*> (o Core..:? "description")
                     Core.<*> (o Core..:? "enum")
                     Core.<*> (o Core..:? "enumDeprecated")
...
instance Core.ToJSON JsonSchema where
        toJSON JsonSchema{..}
          = Core.object
              (Core.catMaybes
                 [("$ref" Core..=) Core.<$> ref,
                  ("additionalProperties" Core..=) Core.<$> additionalProperties,
                  ("annotations" Core..=) Core.<$> annotations,
                  ("default" Core..=) Core.<$> default',
                  ("deprecated" Core..=) Core.<$> deprecated,
                  ("description" Core..=) Core.<$> description,
                  ("enum" Core..=) Core.<$> enum,
                  ("enumDeprecated" Core..=) Core.<$> enumDeprecated,
                  ("enumDescriptions" Core..=) Core.<$> enumDescriptions,
                  ("format" Core..=) Core.<$> format, ("id" Core..=) Core.<$> id,
...
instance Core.FromJSON JsonSchema_Properties where
        parseJSON
          = Core.withObject "JsonSchema_Properties"
              (\ o -> JsonSchema_Properties Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON JsonSchema_Properties where
        toJSON JsonSchema_Properties{..} = Core.toJSON additional
...
newJsonSchema_Variant 
    ::  JsonSchema_Variant
newJsonSchema_Variant
  = JsonSchema_Variant{discriminant = Core.Nothing,
                       map = Core.Nothing}
          ...
          = Core.withObject "JsonSchema_Variant"
              (\ o ->
                 JsonSchema_Variant Core.<$>
                   (o Core..:? "discriminant") Core.<*> (o Core..:? "map"))
...
newJsonSchema_Variant_MapItem 
    ::  JsonSchema_Variant_MapItem
newJsonSchema_Variant_MapItem
  = JsonSchema_Variant_MapItem{ref = Core.Nothing,
                               typeValue = Core.Nothing}
          ...
          = Core.withObject "JsonSchema_Variant_MapItem"
              (\ o ->
                 JsonSchema_Variant_MapItem Core.<$>
                   (o Core..:? "$ref") Core.<*> (o Core..:? "type_value"))
...
data RestDescription = RestDescription
    ...
    , endpoints :: (Core.Maybe [RestDescription_EndpointsItem])
...
newRestDescription 
    ::  RestDescription
newRestDescription
  = RestDescription{auth = Core.Nothing, basePath = Core.Nothing,
                    baseUrl = Core.Nothing, batchPath = Core.Nothing,
                    canonicalName = Core.Nothing, description = Core.Nothing,
                    discoveryVersion = "v1", documentationLink = Core.Nothing,
                    endpoints = Core.Nothing, etag = Core.Nothing,
                    exponentialBackoffDefault = Core.Nothing, features = Core.Nothing,
                    icons = Core.Nothing, id = Core.Nothing,
                    kind = "discovery#restDescription", labels = Core.Nothing,
                    methods = Core.Nothing, name = Core.Nothing,
                    ownerDomain = Core.Nothing, ownerName = Core.Nothing,
                    packagePath = Core.Nothing, parameters = Core.Nothing,
                    protocol = "rest", resources = Core.Nothing,
                    revision = Core.Nothing, rootUrl = Core.Nothing,
                    schemas = Core.Nothing, servicePath = Core.Nothing,
                    title = Core.Nothing, version = Core.Nothing,
          ...
          = Core.withObject "RestDescription"
              (\ o ->
                 RestDescription Core.<$>
                   (o Core..:? "auth") Core.<*> (o Core..:? "basePath") Core.<*>
                     (o Core..:? "baseUrl")
                     ...
                     Core.<*> (o Core..:? "icons")
                     Core.<*> (o Core..:? "id")
                     Core.<*> (o Core..:? "kind" Core..!= "discovery#restDescription")
                     Core.<*> (o Core..:? "labels")
                     Core.<*> (o Core..:? "methods")
                     Core.<*> (o Core..:? "name")
...
instance Core.FromJSON RestDescription_Auth_Oauth2 where
        parseJSON
          = Core.withObject "RestDescription_Auth_Oauth2"
              (\ o -> RestDescription_Auth_Oauth2 Core.<$> (o Core..:? "scopes"))

instance Core.ToJSON RestDescription_Auth_Oauth2 where
        toJSON RestDescription_Auth_Oauth2{..}
          = Core.object (Core.catMaybes [("scopes" Core..=) Core.<$> scopes])
...
instance Core.FromJSON RestDescription_Auth_Oauth2_Scopes where
        parseJSON
          = Core.withObject "RestDescription_Auth_Oauth2_Scopes"
              (\ o ->
                 RestDescription_Auth_Oauth2_Scopes Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON RestDescription_Auth_Oauth2_Scopes where
...
newRestDescription_Auth_Oauth2_ScopesAdditional 
    :: 
                                                RestDescription_Auth_Oauth2_ScopesAdditional
newRestDescription_Auth_Oauth2_ScopesAdditional
  = RestDescription_Auth_Oauth2_ScopesAdditional{description =
                                                   Core.Nothing}
instance Core.FromJSON RestDescription_Auth_Oauth2_ScopesAdditional
         where
        parseJSON
          = Core.withObject "RestDescription_Auth_Oauth2_ScopesAdditional"
              (\ o ->
                 RestDescription_Auth_Oauth2_ScopesAdditional Core.<$>
                   (o Core..:? "description"))

instance Core.ToJSON RestDescription_Auth_Oauth2_ScopesAdditional
         where
        toJSON RestDescription_Auth_Oauth2_ScopesAdditional{..}
          = Core.object
...
--
-- /See:/ 'newRestDescription_EndpointsItem' smart constructor.
data RestDescription_EndpointsItem = RestDescription_EndpointsItem
    {
...
-- | Creates a value of 'RestDescription_EndpointsItem' with the minimum fields required to make a request.
newRestDescription_EndpointsItem 
    ::  RestDescription_EndpointsItem
newRestDescription_EndpointsItem
  = RestDescription_EndpointsItem{deprecated = Core.Nothing,
                                  description = Core.Nothing, endpointUrl = Core.Nothing,
                                  location = Core.Nothing}
instance Core.FromJSON RestDescription_EndpointsItem where
        parseJSON
          = Core.withObject "RestDescription_EndpointsItem"
              (\ o ->
                 RestDescription_EndpointsItem Core.<$>
                   (o Core..:? "deprecated") Core.<*> (o Core..:? "description")
                     Core.<*> (o Core..:? "endpointUrl")
                     Core.<*> (o Core..:? "location"))

instance Core.ToJSON RestDescription_EndpointsItem where
        toJSON RestDescription_EndpointsItem{..}
          = Core.object
              (Core.catMaybes
                 [("deprecated" Core..=) Core.<$> deprecated,
                  ("description" Core..=) Core.<$> description,
                  ("endpointUrl" Core..=) Core.<$> endpointUrl,
                  ("location" Core..=) Core.<$> location])
...
instance Core.FromJSON RestDescription_Methods where
        parseJSON
          = Core.withObject "RestDescription_Methods"
              (\ o -> RestDescription_Methods Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON RestDescription_Methods where
        toJSON RestDescription_Methods{..} = Core.toJSON additional
...
instance Core.FromJSON RestDescription_Parameters where
        parseJSON
          = Core.withObject "RestDescription_Parameters"
              (\ o ->
                 RestDescription_Parameters Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON RestDescription_Parameters where
        toJSON RestDescription_Parameters{..} = Core.toJSON additional
...
instance Core.FromJSON RestDescription_Resources where
        parseJSON
          = Core.withObject "RestDescription_Resources"
              (\ o ->
                 RestDescription_Resources Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON RestDescription_Resources where
        toJSON RestDescription_Resources{..} = Core.toJSON additional
...
instance Core.FromJSON RestDescription_Schemas where
        parseJSON
          = Core.withObject "RestDescription_Schemas"
              (\ o -> RestDescription_Schemas Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON RestDescription_Schemas where
        toJSON RestDescription_Schemas{..} = Core.toJSON additional
...
newRestMethod 
    ::  RestMethod
newRestMethod
  = RestMethod{apiVersion = Core.Nothing, deprecated = Core.Nothing,
               description = Core.Nothing, etagRequired = Core.Nothing,
               flatPath = Core.Nothing, httpMethod = Core.Nothing,
               id = Core.Nothing, mediaUpload = Core.Nothing,
               parameterOrder = Core.Nothing, parameters = Core.Nothing,
               path = Core.Nothing, request' = Core.Nothing,
               response = Core.Nothing, scopes = Core.Nothing,
...
instance Core.FromJSON RestMethod where
        parseJSON
          = Core.withObject "RestMethod"
              (\ o ->
                 RestMethod Core.<$>
                   (o Core..:? "apiVersion") Core.<*> (o Core..:? "deprecated")
                     Core.<*> (o Core..:? "description")
          ...
          = Core.object
              (Core.catMaybes
                 [("apiVersion" Core..=) Core.<$> apiVersion,
                  ...
                  ("supportsMediaDownload" Core..=) Core.<$> supportsMediaDownload,
                  ("supportsMediaUpload" Core..=) Core.<$> supportsMediaUpload,
                  ("supportsSubscription" Core..=) Core.<$> supportsSubscription,
...
newRestMethod_MediaUpload 
    ::  RestMethod_MediaUpload
newRestMethod_MediaUpload
  = RestMethod_MediaUpload{accept = Core.Nothing,
                           maxSize = Core.Nothing, protocols = Core.Nothing}
instance Core.FromJSON RestMethod_MediaUpload where
        parseJSON
          = Core.withObject "RestMethod_MediaUpload"
              (\ o ->
                 RestMethod_MediaUpload Core.<$>
                   (o Core..:? "accept") Core.<*> (o Core..:? "maxSize") Core.<*>
                     (o Core..:? "protocols"))
...
newRestMethod_MediaUpload_Protocols 
    :: 
                                    RestMethod_MediaUpload_Protocols
newRestMethod_MediaUpload_Protocols
  = RestMethod_MediaUpload_Protocols{resumable = Core.Nothing,
                                     simple = Core.Nothing}
instance Core.FromJSON RestMethod_MediaUpload_Protocols where
        parseJSON
          = Core.withObject "RestMethod_MediaUpload_Protocols"
              (\ o ->
                 RestMethod_MediaUpload_Protocols Core.<$>
                   (o Core..:? "resumable") Core.<*> (o Core..:? "simple"))
...
newRestMethod_MediaUpload_Protocols_Resumable 
    :: 
                                              RestMethod_MediaUpload_Protocols_Resumable
newRestMethod_MediaUpload_Protocols_Resumable
  = RestMethod_MediaUpload_Protocols_Resumable{multipart = Core.True,
                                               path = Core.Nothing}
instance Core.FromJSON RestMethod_MediaUpload_Protocols_Resumable
         where
        parseJSON
          = Core.withObject "RestMethod_MediaUpload_Protocols_Resumable"
              (\ o ->
                 RestMethod_MediaUpload_Protocols_Resumable Core.<$>
                   (o Core..:? "multipart" Core..!= Core.True) Core.<*>
                     (o Core..:? "path"))

instance Core.ToJSON RestMethod_MediaUpload_Protocols_Resumable
         where
...
newRestMethod_MediaUpload_Protocols_Simple 
    :: 
                                           RestMethod_MediaUpload_Protocols_Simple
newRestMethod_MediaUpload_Protocols_Simple
  = RestMethod_MediaUpload_Protocols_Simple{multipart = Core.True,
                                            path = Core.Nothing}
instance Core.FromJSON RestMethod_MediaUpload_Protocols_Simple
         where
        parseJSON
          = Core.withObject "RestMethod_MediaUpload_Protocols_Simple"
              (\ o ->
                 RestMethod_MediaUpload_Protocols_Simple Core.<$>
                   (o Core..:? "multipart" Core..!= Core.True) Core.<*>
                     (o Core..:? "path"))

instance Core.ToJSON RestMethod_MediaUpload_Protocols_Simple where
...
instance Core.FromJSON RestMethod_Parameters where
        parseJSON
          = Core.withObject "RestMethod_Parameters"
              (\ o -> RestMethod_Parameters Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON RestMethod_Parameters where
        toJSON RestMethod_Parameters{..} = Core.toJSON additional
...
newRestMethod_Request 
    ::  RestMethod_Request
newRestMethod_Request
  = RestMethod_Request{ref = Core.Nothing,
          ...
          = Core.withObject "RestMethod_Request"
              (\ o ->
                 RestMethod_Request Core.<$>
                   (o Core..:? "$ref") Core.<*> (o Core..:? "parameterName"))
...
instance Core.FromJSON RestMethod_Response where
        parseJSON
          = Core.withObject "RestMethod_Response"
              (\ o -> RestMethod_Response Core.<$> (o Core..:? "$ref"))

instance Core.ToJSON RestMethod_Response where
        toJSON RestMethod_Response{..}
          = Core.object (Core.catMaybes [("$ref" Core..=) Core.<$> ref])
...
newRestResource 
    ::  RestResource
newRestResource
  = RestResource{deprecated = Core.Nothing, methods = Core.Nothing,
...
instance Core.FromJSON RestResource where
        parseJSON
          = Core.withObject "RestResource"
              (\ o ->
                 RestResource Core.<$>
                   (o Core..:? "deprecated") Core.<*> (o Core..:? "methods") Core.<*>
                     (o Core..:? "resources"))
...
instance Core.FromJSON RestResource_Methods where
        parseJSON
          = Core.withObject "RestResource_Methods"
              (\ o -> RestResource_Methods Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON RestResource_Methods where
        toJSON RestResource_Methods{..} = Core.toJSON additional
...
instance Core.FromJSON RestResource_Resources where
        parseJSON
          = Core.withObject "RestResource_Resources"
              (\ o -> RestResource_Resources Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON RestResource_Resources where
        toJSON RestResource_Resources{..} = Core.toJSON additional
