                     ...
                     "replicas" Core.:>
                       Core.Capture "replicaName" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] ReplicasDeleteRequest Core.:>
...
newReplicaPoolReplicasDelete 
    ...
    -> ReplicaPoolReplicasDelete
newReplicaPoolReplicasDelete payload poolName projectName
  replicaName zone
  = ReplicaPoolReplicasDelete{payload = payload, poolName = poolName,
