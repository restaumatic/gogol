...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @reports.entityUsageReports.get@.
module Gogol.Admin.Reports.EntityUsageReports.Get
    (
    -- * Resource
...
type ReportsEntityUsageReportsGetResource =
     "admin" Core.:>
       "reports" Core.:>
         "v1" Core.:>
           "usage" Core.:>
             Core.Capture "entityType" EntityUsageReportsGetEntityType Core.:>
...
newReportsEntityUsageReportsGet date entityKey entityType
  = ReportsEntityUsageReportsGet{xgafv = Core.Nothing,
                                 accessToken = Core.Nothing, callback = Core.Nothing,
                                 customerId = Core.Nothing, date = date, entityKey = entityKey,
                                 entityType = entityType, filters = Core.Nothing, maxResults = 1000,
                                 pageToken = Core.Nothing, parameters = Core.Nothing,
                                 uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ReportsEntityUsageReportsGet where
        ...
        requestClient ReportsEntityUsageReportsGet{..}
          = go entityType entityKey date xgafv accessToken callback
              customerId
              filters
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ReportsEntityUsageReportsGetResource)
                      Core.mempty
