...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @reports.customerUsageReports.get@.
module Gogol.Admin.Reports.CustomerUsageReports.Get
    (
    -- * Resource
...
newReportsCustomerUsageReportsGet date
  = ReportsCustomerUsageReportsGet{xgafv = Core.Nothing,
                                   accessToken = Core.Nothing, callback = Core.Nothing,
                                   customerId = Core.Nothing, date = date, pageToken = Core.Nothing,
                                   parameters = Core.Nothing, uploadType = Core.Nothing,
...
instance Core.GoogleRequest ReportsCustomerUsageReportsGet where
        ...
        requestClient ReportsCustomerUsageReportsGet{..}
          = go date xgafv accessToken callback customerId pageToken
              parameters
              uploadType
              uploadProtocol
