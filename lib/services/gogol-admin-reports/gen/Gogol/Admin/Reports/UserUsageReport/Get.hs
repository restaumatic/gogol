...
--
-- /See:/ <https://developers.google.com/workspace/admin/ Admin SDK API Reference> for @reports.userUsageReport.get@.
module Gogol.Admin.Reports.UserUsageReport.Get
    (
    -- * Resource
...
newReportsUserUsageReportGet date userKey
  = ReportsUserUsageReportGet{xgafv = Core.Nothing,
                              accessToken = Core.Nothing, callback = Core.Nothing,
                              customerId = Core.Nothing, date = date, filters = Core.Nothing,
                              ...
                              userKey = userKey}
instance Core.GoogleRequest ReportsUserUsageReportGet where
        ...
        requestClient ReportsUserUsageReportGet{..}
          = go userKey date xgafv accessToken callback customerId filters
              groupIdFilter
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy ReportsUserUsageReportGetResource)
                      Core.mempty
