                 ...
                 Core.QueryParam "cr" Core.Text Core.:>
                   Core.QueryParam "cx" Core.Text Core.:>
                     Core.QueryParam "dateRestrict" Core.Text Core.:>
                       Core.QueryParam "enableAlternateSearchHandler" Core.Bool Core.:>
                                     ...
                                     Core.QueryParam "highRange" Core.Text Core.:>
                                       Core.QueryParam "hl" Core.Text Core.:>
                                         Core.QueryParam "hq" Core.Text Core.:>
                                           Core.QueryParam "imgColorType" CseListImgColorType
                                             Core.:>
                                             Core.QueryParam "imgDominantColor"
                                               CseListImgDominantColor
                                               Core.:>
                                               Core.QueryParam "imgSize" CseListImgSize Core.:>
                                                 Core.QueryParam "imgType" CseListImgType Core.:>
                                                   Core.QueryParam "linkSite" Core.Text Core.:>
                                                     Core.QueryParam "lowRange" Core.Text Core.:>
                                                       Core.QueryParam "lr" Core.Text Core.:>
                                                         Core.QueryParam "num" Core.Int32 Core.:>
                                                           Core.QueryParam "orTerms" Core.Text
                                                             Core.:>
                                                             Core.QueryParam "q" Core.Text Core.:>
                                                               Core.QueryParam "relatedSite"
                                                                 Core.Text
                                                                 Core.:>
                                                                 Core.QueryParam "rights" Core.Text
                                                                   Core.:>
                                                                   Core.QueryParam "safe"
                                                                     CseListSafe
                                                                     Core.:>
                                                                     Core.QueryParam "searchType"
                                                                       CseListSearchType
                                                                       Core.:>
                                                                       Core.QueryParam "siteSearch"
                                                                         Core.Text
                                                                         Core.:>
                                                                         Core.QueryParam
                                                                           "siteSearchFilter"
...
data SearchCseList = SearchCseList
    ...
    , enableAlternateSearchHandler :: (Core.Maybe Core.Bool)
    ...
    , snippetLength :: (Core.Maybe Core.Int32)
...
newSearchCseList 
    ::  SearchCseList
newSearchCseList
  = SearchCseList{xgafv = Core.Nothing, accessToken = Core.Nothing,
                  c2coff = Core.Nothing, callback = Core.Nothing, cr = Core.Nothing,
                  cx = Core.Nothing, dateRestrict = Core.Nothing,
                  enableAlternateSearchHandler = Core.Nothing,
                  exactTerms = Core.Nothing, excludeTerms = Core.Nothing,
                  fileType = Core.Nothing, filter = Core.Nothing, gl = Core.Nothing,
                  ...
                  imgType = Core.Nothing, linkSite = Core.Nothing,
                  lowRange = Core.Nothing, lr = Core.Nothing, num = Core.Nothing,
                  orTerms = Core.Nothing, q = Core.Nothing,
                  relatedSite = Core.Nothing, rights = Core.Nothing,
                  safe = Core.Nothing, searchType = Core.Nothing,
                  siteSearch = Core.Nothing, siteSearchFilter = Core.Nothing,
                  snippetLength = Core.Nothing, sort = Core.Nothing,
...
instance Core.GoogleRequest SearchCseList where
        ...
        requestClient SearchCseList{..}
          = go xgafv accessToken c2coff callback cr cx dateRestrict
              ...
              customSearchService
          where go
                  = Core.buildClient (Core.Proxy :: Core.Proxy SearchCseListResource)
                      Core.mempty
