...
newSearchCseSiterestrictList 
    ::  SearchCseSiterestrictList
newSearchCseSiterestrictList
  = SearchCseSiterestrictList{xgafv = Core.Nothing,
                              accessToken = Core.Nothing, c2coff = Core.Nothing,
                              callback = Core.Nothing, cr = Core.Nothing, cx = Core.Nothing,
...
instance Core.GoogleRequest SearchCseSiterestrictList where
        ...
        requestClient SearchCseSiterestrictList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy SearchCseSiterestrictListResource)
                      Core.mempty
