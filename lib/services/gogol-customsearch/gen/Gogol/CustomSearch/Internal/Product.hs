...
newPromotion 
    ::  Promotion
newPromotion
  = Promotion{bodyLines = Core.Nothing, displayLink = Core.Nothing,
              htmlTitle = Core.Nothing, image = Core.Nothing,
              link = Core.Nothing, title = Core.Nothing}
instance Core.FromJSON Promotion where
        parseJSON
          = Core.withObject "Promotion"
              (\ o ->
                 Promotion Core.<$>
                   (o Core..:? "bodyLines") Core.<*> (o Core..:? "displayLink")
          ...
          = Core.object
              (Core.catMaybes
                 [("bodyLines" Core..=) Core.<$> bodyLines,
                  ...
                  ("image" Core..=) Core.<$> image, ("link" Core..=) Core.<$> link,
...
newPromotion_BodyLinesItem 
    ::  Promotion_BodyLinesItem
newPromotion_BodyLinesItem
  = Promotion_BodyLinesItem{htmlTitle = Core.Nothing,
                            link = Core.Nothing, title = Core.Nothing, url = Core.Nothing}
instance Core.FromJSON Promotion_BodyLinesItem where
        parseJSON
          = Core.withObject "Promotion_BodyLinesItem"
              (\ o ->
                 Promotion_BodyLinesItem Core.<$>
                   (o Core..:? "htmlTitle") Core.<*> (o Core..:? "link") Core.<*>
                     (o Core..:? "title")
                     Core.<*> (o Core..:? "url"))
...
instance Core.ToJSON Promotion_BodyLinesItem where
        toJSON Promotion_BodyLinesItem{..}
          = Core.object
              (Core.catMaybes
                 [("htmlTitle" Core..=) Core.<$> htmlTitle,
                  ("link" Core..=) Core.<$> link, ("title" Core..=) Core.<$> title,
                  ("url" Core..=) Core.<$> url])
...
newPromotion_Image 
    ::  Promotion_Image
newPromotion_Image
  = Promotion_Image{height = Core.Nothing, source = Core.Nothing,
                    width = Core.Nothing}
instance Core.FromJSON Promotion_Image where
        parseJSON
          = Core.withObject "Promotion_Image"
              (\ o ->
                 Promotion_Image Core.<$>
                   (o Core..:? "height") Core.<*> (o Core..:? "source") Core.<*>
                     (o Core..:? "width"))
...
newResult 
    ::  Result
newResult
  = Result{cacheId = Core.Nothing, displayLink = Core.Nothing,
           fileFormat = Core.Nothing, formattedUrl = Core.Nothing,
           htmlFormattedUrl = Core.Nothing, htmlSnippet = Core.Nothing,
           htmlTitle = Core.Nothing, image = Core.Nothing,
           kind = Core.Nothing, labels = Core.Nothing, link = Core.Nothing,
           mime = Core.Nothing, pagemap = Core.Nothing,
           snippet = Core.Nothing, title = Core.Nothing}
instance Core.FromJSON Result where
        parseJSON
          = Core.withObject "Result"
              (\ o ->
                 Result Core.<$>
                   (o Core..:? "cacheId") Core.<*> (o Core..:? "displayLink") Core.<*>
                     (o Core..:? "fileFormat")
          ...
          = Core.object
              (Core.catMaybes
                 [("cacheId" Core..=) Core.<$> cacheId,
                  ...
                  ("htmlFormattedUrl" Core..=) Core.<$> htmlFormattedUrl,
                  ("htmlSnippet" Core..=) Core.<$> htmlSnippet,
                  ("htmlTitle" Core..=) Core.<$> htmlTitle,
                  ("image" Core..=) Core.<$> image, ("kind" Core..=) Core.<$> kind,
                  ("labels" Core..=) Core.<$> labels, ("link" Core..=) Core.<$> link,
                  ("mime" Core..=) Core.<$> mime,
...
newResult_Image 
    ::  Result_Image
newResult_Image
  = Result_Image{byteSize = Core.Nothing, contextLink = Core.Nothing,
                 height = Core.Nothing, thumbnailHeight = Core.Nothing,
                 thumbnailLink = Core.Nothing, thumbnailWidth = Core.Nothing,
                 width = Core.Nothing}
instance Core.FromJSON Result_Image where
        parseJSON
          = Core.withObject "Result_Image"
              (\ o ->
                 Result_Image Core.<$>
                   (o Core..:? "byteSize") Core.<*> (o Core..:? "contextLink")
                     Core.<*> (o Core..:? "height")
...
newResult_LabelsItem 
    ::  Result_LabelsItem
newResult_LabelsItem
  = Result_LabelsItem{displayName = Core.Nothing,
                      labelWithOp = Core.Nothing, name = Core.Nothing}
instance Core.FromJSON Result_LabelsItem where
        parseJSON
          = Core.withObject "Result_LabelsItem"
              (\ o ->
                 Result_LabelsItem Core.<$>
                   (o Core..:? "displayName") Core.<*> (o Core..:? "label_with_op")
                     Core.<*> (o Core..:? "name"))
...
newResult_Pagemap 
    ...
    -> Result_Pagemap
newResult_Pagemap additional
  = Result_Pagemap{additional = additional}
instance Core.FromJSON Result_Pagemap where
        parseJSON
          = Core.withObject "Result_Pagemap"
              (\ o -> Result_Pagemap Core.<$> (Core.parseJSONObject o))
...
newSearch 
    ::  Search
newSearch
  = Search{context = Core.Nothing, items = Core.Nothing,
           kind = Core.Nothing, promotions = Core.Nothing,
           queries = Core.Nothing, searchInformation = Core.Nothing,
           spelling = Core.Nothing, url = Core.Nothing}
instance Core.FromJSON Search where
        parseJSON
          = Core.withObject "Search"
              (\ o ->
                 Search Core.<$>
                   (o Core..:? "context") Core.<*> (o Core..:? "items") Core.<*>
                     (o Core..:? "kind")
          ...
          = Core.object
              (Core.catMaybes
                 [("context" Core..=) Core.<$> context,
                  ...
                  ("searchInformation" Core..=) Core.<$> searchInformation,
...
newSearch_Context 
    :: 
       ...
       -- ^  Properties of the object. See 'additional'.
    -> Search_Context
newSearch_Context additional
  = Search_Context{additional = additional}
instance Core.FromJSON Search_Context where
        parseJSON
          = Core.withObject "Search_Context"
              (\ o -> Search_Context Core.<$> (Core.parseJSONObject o))
...
newSearch_Queries 
    ::  Search_Queries
newSearch_Queries
  = Search_Queries{nextPage = Core.Nothing,
                   previousPage = Core.Nothing, request' = Core.Nothing}
instance Core.FromJSON Search_Queries where
        parseJSON
          = Core.withObject "Search_Queries"
              (\ o ->
                 Search_Queries Core.<$>
                   (o Core..:? "nextPage") Core.<*> (o Core..:? "previousPage")
                     Core.<*> (o Core..:? "request"))
...
newSearch_Queries_NextPageItem 
    ::  Search_Queries_NextPageItem
newSearch_Queries_NextPageItem
  = Search_Queries_NextPageItem{count = Core.Nothing,
                                cr = Core.Nothing, cx = Core.Nothing, dateRestrict = Core.Nothing,
                                disableCnTwTranslation = Core.Nothing, exactTerms = Core.Nothing,
                                excludeTerms = Core.Nothing, fileType = Core.Nothing,
                                filter = Core.Nothing, gl = Core.Nothing,
                                googleHost = Core.Nothing, highRange = Core.Nothing,
                                hl = Core.Nothing, hq = Core.Nothing, imgColorType = Core.Nothing,
                                imgDominantColor = Core.Nothing, imgSize = Core.Nothing,
                                imgType = Core.Nothing, inputEncoding = Core.Nothing,
                                language = Core.Nothing, linkSite = Core.Nothing,
                                lowRange = Core.Nothing, orTerms = Core.Nothing,
                                outputEncoding = Core.Nothing, relatedSite = Core.Nothing,
                                rights = Core.Nothing, safe = Core.Nothing,
                                searchTerms = Core.Nothing, searchType = Core.Nothing,
                                siteSearch = Core.Nothing, siteSearchFilter = Core.Nothing,
                                sort = Core.Nothing, startIndex = Core.Nothing,
                                startPage = Core.Nothing, title = Core.Nothing,
                                totalResults = Core.Nothing}
instance Core.FromJSON Search_Queries_NextPageItem where
        parseJSON
          = Core.withObject "Search_Queries_NextPageItem"
              (\ o ->
                 Search_Queries_NextPageItem Core.<$>
                   (o Core..:? "count") Core.<*> (o Core..:? "cr") Core.<*>
                     (o Core..:? "cx")
...
newSearch_Queries_PreviousPageItem 
    :: 
                                   Search_Queries_PreviousPageItem
newSearch_Queries_PreviousPageItem
  = Search_Queries_PreviousPageItem{count = Core.Nothing,
                                    cr = Core.Nothing, cx = Core.Nothing,
                                    dateRestrict = Core.Nothing,
                                    disableCnTwTranslation = Core.Nothing,
                                    exactTerms = Core.Nothing, excludeTerms = Core.Nothing,
                                    fileType = Core.Nothing, filter = Core.Nothing,
                                    gl = Core.Nothing, googleHost = Core.Nothing,
                                    highRange = Core.Nothing, hl = Core.Nothing, hq = Core.Nothing,
                                    imgColorType = Core.Nothing, imgDominantColor = Core.Nothing,
                                    imgSize = Core.Nothing, imgType = Core.Nothing,
                                    inputEncoding = Core.Nothing, language = Core.Nothing,
                                    linkSite = Core.Nothing, lowRange = Core.Nothing,
                                    orTerms = Core.Nothing, outputEncoding = Core.Nothing,
                                    relatedSite = Core.Nothing, rights = Core.Nothing,
                                    safe = Core.Nothing, searchTerms = Core.Nothing,
                                    searchType = Core.Nothing, siteSearch = Core.Nothing,
                                    siteSearchFilter = Core.Nothing, sort = Core.Nothing,
                                    startIndex = Core.Nothing, startPage = Core.Nothing,
                                    title = Core.Nothing, totalResults = Core.Nothing}
instance Core.FromJSON Search_Queries_PreviousPageItem where
        parseJSON
          = Core.withObject "Search_Queries_PreviousPageItem"
              (\ o ->
                 Search_Queries_PreviousPageItem Core.<$>
                   (o Core..:? "count") Core.<*> (o Core..:? "cr") Core.<*>
                     (o Core..:? "cx")
                     Core.<*> (o Core..:? "dateRestrict")
                     Core.<*> (o Core..:? "disableCnTwTranslation")
...
newSearch_Queries_RequestItem 
    ::  Search_Queries_RequestItem
newSearch_Queries_RequestItem
  = Search_Queries_RequestItem{count = Core.Nothing,
                               cr = Core.Nothing, cx = Core.Nothing, dateRestrict = Core.Nothing,
                               disableCnTwTranslation = Core.Nothing, exactTerms = Core.Nothing,
                               excludeTerms = Core.Nothing, fileType = Core.Nothing,
                               filter = Core.Nothing, gl = Core.Nothing,
...
instance Core.FromJSON Search_Queries_RequestItem where
        parseJSON
          = Core.withObject "Search_Queries_RequestItem"
              (\ o ->
                 Search_Queries_RequestItem Core.<$>
                   (o Core..:? "count") Core.<*> (o Core..:? "cr") Core.<*>
                     (o Core..:? "cx")
                     Core.<*> (o Core..:? "dateRestrict")
                     Core.<*> (o Core..:? "disableCnTwTranslation")
...
newSearch_SearchInformation 
    ::  Search_SearchInformation
newSearch_SearchInformation
  = Search_SearchInformation{formattedSearchTime = Core.Nothing,
                             formattedTotalResults = Core.Nothing, searchTime = Core.Nothing,
                             totalResults = Core.Nothing}
instance Core.FromJSON Search_SearchInformation where
        parseJSON
          = Core.withObject "Search_SearchInformation"
              (\ o ->
                 Search_SearchInformation Core.<$>
                   (o Core..:? "formattedSearchTime") Core.<*>
                     (o Core..:? "formattedTotalResults")
...
instance Core.ToJSON Search_SearchInformation where
        toJSON Search_SearchInformation{..}
          = Core.object
              (Core.catMaybes
                 [("formattedSearchTime" Core..=) Core.<$> formattedSearchTime,
                  ("formattedTotalResults" Core..=) Core.<$> formattedTotalResults,
...
newSearch_Spelling 
    ::  Search_Spelling
newSearch_Spelling
  = Search_Spelling{correctedQuery = Core.Nothing,
                    htmlCorrectedQuery = Core.Nothing}
instance Core.FromJSON Search_Spelling where
        parseJSON
          = Core.withObject "Search_Spelling"
              (\ o ->
                 Search_Spelling Core.<$>
                   (o Core..:? "correctedQuery") Core.<*>
                     (o Core..:? "htmlCorrectedQuery"))
          ...
          = Core.object
              (Core.catMaybes
                 [("correctedQuery" Core..=) Core.<$> correctedQuery,
                  ("htmlCorrectedQuery" Core..=) Core.<$> htmlCorrectedQuery])
...
newSearch_Url 
    ::  Search_Url
newSearch_Url
  = Search_Url{template = Core.Nothing, type' = Core.Nothing}
instance Core.FromJSON Search_Url where
        parseJSON
          = Core.withObject "Search_Url"
              (\ o ->
                 Search_Url Core.<$>
                   (o Core..:? "template") Core.<*> (o Core..:? "type"))
