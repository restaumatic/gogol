...
newApplicationInfo 
    ::  ApplicationInfo
newApplicationInfo
  = ApplicationInfo{emails = Core.Nothing,
                    instruction = Core.Nothing, uris = Core.Nothing}
instance Core.FromJSON ApplicationInfo where
        parseJSON
          = Core.withObject "ApplicationInfo"
              (\ o ->
                 ApplicationInfo Core.<$>
                   (o Core..:? "emails") Core.<*> (o Core..:? "instruction") Core.<*>
                     (o Core..:? "uris"))
...
newBatchDeleteJobsResponse 
    ::  BatchDeleteJobsResponse
newBatchDeleteJobsResponse
  = BatchDeleteJobsResponse{jobResults = Core.Nothing}
instance Core.FromJSON BatchDeleteJobsResponse where
        parseJSON
          = Core.withObject "BatchDeleteJobsResponse"
              (\ o -> BatchDeleteJobsResponse Core.<$> (o Core..:? "jobResults"))
...
newBatchOperationMetadata 
    ::  BatchOperationMetadata
newBatchOperationMetadata
  = BatchOperationMetadata{createTime = Core.Nothing,
                           endTime = Core.Nothing, failureCount = Core.Nothing,
                           state = Core.Nothing, stateDescription = Core.Nothing,
                           successCount = Core.Nothing, totalCount = Core.Nothing,
          ...
          = Core.object
              (Core.catMaybes
                 [("createTime" Core..=) Core.<$> createTime,
                  ...
                  ("stateDescription" Core..=) Core.<$> stateDescription,
...
newBatchUpdateJobsRequest 
    ::  BatchUpdateJobsRequest
newBatchUpdateJobsRequest
  = BatchUpdateJobsRequest{jobs = Core.Nothing,
          ...
          = Core.withObject "BatchUpdateJobsRequest"
              (\ o ->
                 BatchUpdateJobsRequest Core.<$>
                   (o Core..:? "jobs") Core.<*> (o Core..:? "updateMask"))
...
newBatchUpdateJobsResponse 
    ::  BatchUpdateJobsResponse
newBatchUpdateJobsResponse
  = BatchUpdateJobsResponse{jobResults = Core.Nothing}
instance Core.FromJSON BatchUpdateJobsResponse where
        parseJSON
          = Core.withObject "BatchUpdateJobsResponse"
              (\ o -> BatchUpdateJobsResponse Core.<$> (o Core..:? "jobResults"))
...
newClientEvent 
    ::  ClientEvent
newClientEvent
  = ClientEvent{createTime = Core.Nothing, eventId = Core.Nothing,
                eventNotes = Core.Nothing, jobEvent = Core.Nothing,
...
instance Core.FromJSON ClientEvent where
        parseJSON
          = Core.withObject "ClientEvent"
              (\ o ->
                 ClientEvent Core.<$>
                   (o Core..:? "createTime") Core.<*> (o Core..:? "eventId") Core.<*>
                     (o Core..:? "eventNotes")
...
newCommuteFilter 
    ::  CommuteFilter
newCommuteFilter
  = CommuteFilter{allowImpreciseAddresses = Core.Nothing,
                  commuteMethod = Core.Nothing, departureTime = Core.Nothing,
                  roadTraffic = Core.Nothing, startCoordinates = Core.Nothing,
          ...
          = Core.object
              (Core.catMaybes
                 [("allowImpreciseAddresses" Core..=) Core.<$>
                  ...
                  ("startCoordinates" Core..=) Core.<$> startCoordinates,
...
newCommuteInfo 
    ::  CommuteInfo
newCommuteInfo
  = CommuteInfo{jobLocation = Core.Nothing,
                travelDuration = Core.Nothing}
instance Core.FromJSON CommuteInfo where
        parseJSON
          = Core.withObject "CommuteInfo"
              (\ o ->
                 CommuteInfo Core.<$>
                   (o Core..:? "jobLocation") Core.<*> (o Core..:? "travelDuration"))
...
newCompany 
    ::  Company
newCompany
  = Company{careerSiteUri = Core.Nothing, derivedInfo = Core.Nothing,
            displayName = Core.Nothing, eeoText = Core.Nothing,
            externalId = Core.Nothing, headquartersAddress = Core.Nothing,
            hiringAgency = Core.Nothing, imageUri = Core.Nothing,
            keywordSearchableJobCustomAttributes = Core.Nothing,
            name = Core.Nothing, size = Core.Nothing, suspended = Core.Nothing,
...
instance Core.FromJSON Company where
        parseJSON
          = Core.withObject "Company"
              (\ o ->
                 Company Core.<$>
                   (o Core..:? "careerSiteUri") Core.<*> (o Core..:? "derivedInfo")
          ...
          = Core.object
              (Core.catMaybes
                 [("careerSiteUri" Core..=) Core.<$> careerSiteUri,
                  ...
                  ("headquartersAddress" Core..=) Core.<$> headquartersAddress,
                  ("hiringAgency" Core..=) Core.<$> hiringAgency,
                  ("imageUri" Core..=) Core.<$> imageUri,
                  ("keywordSearchableJobCustomAttributes" Core..=) Core.<$>
                    keywordSearchableJobCustomAttributes,
                  ("name" Core..=) Core.<$> name, ("size" Core..=) Core.<$> size,
...
newCompanyDerivedInfo 
    ::  CompanyDerivedInfo
newCompanyDerivedInfo
  = CompanyDerivedInfo{headquartersLocation = Core.Nothing}
instance Core.FromJSON CompanyDerivedInfo where
        parseJSON
          = Core.withObject "CompanyDerivedInfo"
              (\ o ->
                 CompanyDerivedInfo Core.<$> (o Core..:? "headquartersLocation"))

instance Core.ToJSON CompanyDerivedInfo where
        toJSON CompanyDerivedInfo{..}
          = Core.object
              (Core.catMaybes
                 [("headquartersLocation" Core..=) Core.<$> headquartersLocation])
...
newCompensationEntry 
    ::  CompensationEntry
newCompensationEntry
  = CompensationEntry{amount = Core.Nothing,
                      description = Core.Nothing, expectedUnitsPerYear = Core.Nothing,
                      range = Core.Nothing, type' = Core.Nothing, unit = Core.Nothing}
instance Core.FromJSON CompensationEntry where
        parseJSON
          = Core.withObject "CompensationEntry"
              (\ o ->
                 CompensationEntry Core.<$>
                   (o Core..:? "amount") Core.<*> (o Core..:? "description") Core.<*>
                     (o Core..:? "expectedUnitsPerYear")
                     Core.<*> (o Core..:? "range")
                     Core.<*> (o Core..:? "type")
                     Core.<*> (o Core..:? "unit"))
          ...
          = Core.object
              (Core.catMaybes
                 [("amount" Core..=) Core.<$> amount,
                  ...
                  ("expectedUnitsPerYear" Core..=) Core.<$> expectedUnitsPerYear,
                  ("range" Core..=) Core.<$> range, ("type" Core..=) Core.<$> type',
                  ("unit" Core..=) Core.<$> unit])
...
newCompensationFilter
  = CompensationFilter{includeJobsWithUnspecifiedCompensationRange =
                         Core.Nothing,
                       range = Core.Nothing, type' = Core.Nothing, units = Core.Nothing}
instance Core.FromJSON CompensationFilter where
        parseJSON
          = Core.withObject "CompensationFilter"
              (\ o ->
                 CompensationFilter Core.<$>
                   (o Core..:? "includeJobsWithUnspecifiedCompensationRange") Core.<*>
                     (o Core..:? "range")
                     Core.<*> (o Core..:? "type")
                     Core.<*> (o Core..:? "units"))
...
instance Core.ToJSON CompensationFilter where
        toJSON CompensationFilter{..}
          = Core.object
              (Core.catMaybes
                 [("includeJobsWithUnspecifiedCompensationRange" Core..=) Core.<$>
...
newCompensationInfo 
    ::  CompensationInfo
newCompensationInfo
  = CompensationInfo{annualizedBaseCompensationRange = Core.Nothing,
          ...
          = Core.withObject "CompensationInfo"
              (\ o ->
                 CompensationInfo Core.<$>
                   (o Core..:? "annualizedBaseCompensationRange") Core.<*>
...
newCompensationRange 
    ::  CompensationRange
newCompensationRange
  = CompensationRange{maxCompensation = Core.Nothing,
...
instance Core.ToJSON CompensationRange where
        toJSON CompensationRange{..}
          = Core.object
              (Core.catMaybes
                 [("maxCompensation" Core..=) Core.<$> maxCompensation,
                  ("minCompensation" Core..=) Core.<$> minCompensation])
...
newCompleteQueryResponse 
    ::  CompleteQueryResponse
newCompleteQueryResponse
  = CompleteQueryResponse{completionResults = Core.Nothing,
          ...
          = Core.withObject "CompleteQueryResponse"
              (\ o ->
                 CompleteQueryResponse Core.<$>
                   (o Core..:? "completionResults") Core.<*> (o Core..:? "metadata"))

instance Core.ToJSON CompleteQueryResponse where
        toJSON CompleteQueryResponse{..}
          = Core.object
              (Core.catMaybes
                 [("completionResults" Core..=) Core.<$> completionResults,
...
newCompletionResult 
    ::  CompletionResult
newCompletionResult
  = CompletionResult{imageUri = Core.Nothing,
                     suggestion = Core.Nothing, type' = Core.Nothing}
instance Core.FromJSON CompletionResult where
        parseJSON
          = Core.withObject "CompletionResult"
              (\ o ->
                 CompletionResult Core.<$>
                   (o Core..:? "imageUri") Core.<*> (o Core..:? "suggestion") Core.<*>
                     (o Core..:? "type"))
...
newCustomAttribute 
    ::  CustomAttribute
newCustomAttribute
  = CustomAttribute{filterable = Core.Nothing,
                    keywordSearchable = Core.Nothing, longValues = Core.Nothing,
          ...
          = Core.withObject "CustomAttribute"
              (\ o ->
                 CustomAttribute Core.<$>
                   (o Core..:? "filterable") Core.<*> (o Core..:? "keywordSearchable")
                     Core.<*>
          ...
          = Core.object
              (Core.catMaybes
                 [("filterable" Core..=) Core.<$> filterable,
                  ("keywordSearchable" Core..=) Core.<$> keywordSearchable,
                  ("longValues" Core..=) Core.. Core.fmap Core.AsText Core.<$>
                    longValues,
...
newCustomRankingInfo 
    ::  CustomRankingInfo
newCustomRankingInfo
  = CustomRankingInfo{importanceLevel = Core.Nothing,
...
instance Core.ToJSON CustomRankingInfo where
        toJSON CustomRankingInfo{..}
          = Core.object
              (Core.catMaybes
                 [("importanceLevel" Core..=) Core.<$> importanceLevel,
                  ("rankingExpression" Core..=) Core.<$> rankingExpression])
...
newDeviceInfo 
    ::  DeviceInfo
newDeviceInfo
  = DeviceInfo{deviceType = Core.Nothing, id = Core.Nothing}
...
instance Core.FromJSON HistogramQuery where
        parseJSON
          = Core.withObject "HistogramQuery"
              (\ o -> HistogramQuery Core.<$> (o Core..:? "histogramQuery"))
...
newHistogramQueryResult 
    ::  HistogramQueryResult
newHistogramQueryResult
  = HistogramQueryResult{histogram = Core.Nothing,
                         histogramQuery = Core.Nothing}
instance Core.FromJSON HistogramQueryResult where
        parseJSON
          = Core.withObject "HistogramQueryResult"
              (\ o ->
                 HistogramQueryResult Core.<$>
                   (o Core..:? "histogram") Core.<*> (o Core..:? "histogramQuery"))
...
instance Core.FromJSON HistogramQueryResult_Histogram where
        parseJSON
          = Core.withObject "HistogramQueryResult_Histogram"
              (\ o ->
                 HistogramQueryResult_Histogram Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON HistogramQueryResult_Histogram where
        toJSON HistogramQueryResult_Histogram{..} = Core.toJSON additional
...
newJob 
    ::  Job
newJob
  = Job{addresses = Core.Nothing, applicationInfo = Core.Nothing,
        company = Core.Nothing, companyDisplayName = Core.Nothing,
        compensationInfo = Core.Nothing, customAttributes = Core.Nothing,
        degreeTypes = Core.Nothing, department = Core.Nothing,
        derivedInfo = Core.Nothing, description = Core.Nothing,
        employmentTypes = Core.Nothing, incentives = Core.Nothing,
        jobBenefits = Core.Nothing, jobEndTime = Core.Nothing,
        jobLevel = Core.Nothing, jobStartTime = Core.Nothing,
        languageCode = Core.Nothing, name = Core.Nothing,
        postingCreateTime = Core.Nothing, postingExpireTime = Core.Nothing,
        postingPublishTime = Core.Nothing, postingRegion = Core.Nothing,
        postingUpdateTime = Core.Nothing, processingOptions = Core.Nothing,
        promotionValue = Core.Nothing, qualifications = Core.Nothing,
        requisitionId = Core.Nothing, responsibilities = Core.Nothing,
        title = Core.Nothing, visibility = Core.Nothing}
instance Core.FromJSON Job where
        parseJSON
          = Core.withObject "Job"
              (\ o ->
                 Job Core.<$>
                   (o Core..:? "addresses") Core.<*> (o Core..:? "applicationInfo")
                     Core.<*> (o Core..:? "company")
          ...
          = Core.object
              (Core.catMaybes
                 [("addresses" Core..=) Core.<$> addresses,
                  ...
                  ("companyDisplayName" Core..=) Core.<$> companyDisplayName,
                  ("compensationInfo" Core..=) Core.<$> compensationInfo,
                  ...
                  ("name" Core..=) Core.<$> name,
                  ("postingCreateTime" Core..=) Core.<$> postingCreateTime,
                  ("postingExpireTime" Core..=) Core.<$> postingExpireTime,
                  ("postingPublishTime" Core..=) Core.<$> postingPublishTime,
                  ("postingRegion" Core..=) Core.<$> postingRegion,
                  ("postingUpdateTime" Core..=) Core.<$> postingUpdateTime,
                  ("processingOptions" Core..=) Core.<$> processingOptions,
                  ("promotionValue" Core..=) Core.<$> promotionValue,
                  ("qualifications" Core..=) Core.<$> qualifications,
                  ("requisitionId" Core..=) Core.<$> requisitionId,
                  ("responsibilities" Core..=) Core.<$> responsibilities,
...
instance Core.FromJSON Job_CustomAttributes where
        parseJSON
          = Core.withObject "Job_CustomAttributes"
              (\ o -> Job_CustomAttributes Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON Job_CustomAttributes where
        toJSON Job_CustomAttributes{..} = Core.toJSON additional
...
newJobDerivedInfo 
    ::  JobDerivedInfo
newJobDerivedInfo
  = JobDerivedInfo{jobCategories = Core.Nothing,
...
instance Core.FromJSON JobDerivedInfo where
        parseJSON
          = Core.withObject "JobDerivedInfo"
              (\ o ->
                 JobDerivedInfo Core.<$>
                   (o Core..:? "jobCategories") Core.<*> (o Core..:? "locations"))
...
instance Core.FromJSON JobEvent where
        parseJSON
          = Core.withObject "JobEvent"
              (\ o ->
                 JobEvent Core.<$> (o Core..:? "jobs") Core.<*> (o Core..:? "type"))

instance Core.ToJSON JobEvent where
        toJSON JobEvent{..}
          = Core.object
              (Core.catMaybes
                 [("jobs" Core..=) Core.<$> jobs, ("type" Core..=) Core.<$> type'])
...
newJobQuery 
    ::  JobQuery
newJobQuery
  = JobQuery{commuteFilter = Core.Nothing, companies = Core.Nothing,
             companyDisplayNames = Core.Nothing,
             compensationFilter = Core.Nothing,
             customAttributeFilter = Core.Nothing,
             disableSpellCheck = Core.Nothing, employmentTypes = Core.Nothing,
             excludedJobs = Core.Nothing, jobCategories = Core.Nothing,
             languageCodes = Core.Nothing, locationFilters = Core.Nothing,
             publishTimeRange = Core.Nothing, query = Core.Nothing,
...
instance Core.FromJSON JobQuery where
        parseJSON
          = Core.withObject "JobQuery"
              (\ o ->
                 JobQuery Core.<$>
                   (o Core..:? "commuteFilter") Core.<*> (o Core..:? "companies")
          ...
          = Core.object
              (Core.catMaybes
                 [("commuteFilter" Core..=) Core.<$> commuteFilter,
                  ...
                  ("companyDisplayNames" Core..=) Core.<$> companyDisplayNames,
                  ("compensationFilter" Core..=) Core.<$> compensationFilter,
                  ("customAttributeFilter" Core..=) Core.<$> customAttributeFilter,
                  ("disableSpellCheck" Core..=) Core.<$> disableSpellCheck,
                  ("employmentTypes" Core..=) Core.<$> employmentTypes,
                  ("excludedJobs" Core..=) Core.<$> excludedJobs,
                  ("jobCategories" Core..=) Core.<$> jobCategories,
                  ("languageCodes" Core..=) Core.<$> languageCodes,
                  ("locationFilters" Core..=) Core.<$> locationFilters,
                  ("publishTimeRange" Core..=) Core.<$> publishTimeRange,
                  ("query" Core..=) Core.<$> query,
                  ("queryLanguageCode" Core..=) Core.<$> queryLanguageCode])
...
instance Core.ToJSON JobResult where
        toJSON JobResult{..}
          = Core.object
              (Core.catMaybes
                 [("job" Core..=) Core.<$> job, ("status" Core..=) Core.<$> status])
          ...
          = Core.withObject "ListCompaniesResponse"
              (\ o ->
                 ListCompaniesResponse Core.<$>
                   (o Core..:? "companies") Core.<*> (o Core..:? "metadata") Core.<*>
...
newListJobsResponse 
    ::  ListJobsResponse
newListJobsResponse
  = ListJobsResponse{jobs = Core.Nothing, metadata = Core.Nothing,
          ...
          = Core.withObject "ListJobsResponse"
              (\ o ->
                 ListJobsResponse Core.<$>
                   (o Core..:? "jobs") Core.<*> (o Core..:? "metadata") Core.<*>
                     (o Core..:? "nextPageToken"))
...
newListTenantsResponse 
    ::  ListTenantsResponse
newListTenantsResponse
  = ListTenantsResponse{metadata = Core.Nothing,
                        nextPageToken = Core.Nothing, tenants = Core.Nothing}
instance Core.FromJSON ListTenantsResponse where
        parseJSON
          = Core.withObject "ListTenantsResponse"
              (\ o ->
                 ListTenantsResponse Core.<$>
                   (o Core..:? "metadata") Core.<*> (o Core..:? "nextPageToken")
                     Core.<*> (o Core..:? "tenants"))
...
newLocation 
    ::  Location
newLocation
  = Location{latLng = Core.Nothing, locationType = Core.Nothing,
             postalAddress = Core.Nothing, radiusMiles = Core.Nothing}
instance Core.FromJSON Location where
        parseJSON
          = Core.withObject "Location"
              (\ o ->
                 Location Core.<$>
                   (o Core..:? "latLng") Core.<*> (o Core..:? "locationType") Core.<*>
                     (o Core..:? "postalAddress")
...
newLocationFilter 
    ::  LocationFilter
newLocationFilter
  = LocationFilter{address = Core.Nothing,
                   distanceInMiles = Core.Nothing, latLng = Core.Nothing,
                   regionCode = Core.Nothing, telecommutePreference = Core.Nothing}
instance Core.FromJSON LocationFilter where
        parseJSON
          = Core.withObject "LocationFilter"
              (\ o ->
                 LocationFilter Core.<$>
                   (o Core..:? "address") Core.<*> (o Core..:? "distanceInMiles")
                     Core.<*> (o Core..:? "latLng")
          ...
          = Core.object
              (Core.catMaybes
                 [("address" Core..=) Core.<$> address,
                  ...
                  ("telecommutePreference" Core..=) Core.<$> telecommutePreference])
...
newMatchingJob 
    ::  MatchingJob
newMatchingJob
  = MatchingJob{commuteInfo = Core.Nothing, job = Core.Nothing,
                jobSummary = Core.Nothing, jobTitleSnippet = Core.Nothing,
...
instance Core.FromJSON MatchingJob where
        parseJSON
          = Core.withObject "MatchingJob"
              (\ o ->
                 MatchingJob Core.<$>
                   (o Core..:? "commuteInfo") Core.<*> (o Core..:? "job") Core.<*>
                     (o Core..:? "jobSummary")
          ...
          = Core.object
              (Core.catMaybes
                 [("commuteInfo" Core..=) Core.<$> commuteInfo,
                  ...
                  ("searchTextSnippet" Core..=) Core.<$> searchTextSnippet])
...
newProcessingOptions 
    ::  ProcessingOptions
newProcessingOptions
  = ProcessingOptions{disableStreetAddressResolution = Core.Nothing,
          ...
          = Core.withObject "ProcessingOptions"
              (\ o ->
                 ProcessingOptions Core.<$>
                   (o Core..:? "disableStreetAddressResolution") Core.<*>
                     (o Core..:? "htmlSanitization"))
          ...
          = Core.object
              (Core.catMaybes
                 [("disableStreetAddressResolution" Core..=) Core.<$>
                  ...
                  ("htmlSanitization" Core..=) Core.<$> htmlSanitization])
...
newRequestMetadata 
    ::  RequestMetadata
newRequestMetadata
  = RequestMetadata{allowMissingIds = Core.Nothing,
                    deviceInfo = Core.Nothing, domain = Core.Nothing,
                    sessionId = Core.Nothing, userId = Core.Nothing}
instance Core.FromJSON RequestMetadata where
        parseJSON
          = Core.withObject "RequestMetadata"
              (\ o ->
                 RequestMetadata Core.<$>
                   (o Core..:? "allowMissingIds") Core.<*> (o Core..:? "deviceInfo")
                     Core.<*> (o Core..:? "domain")
...
instance Core.ToJSON RequestMetadata where
        toJSON RequestMetadata{..}
          = Core.object
              (Core.catMaybes
                 [("allowMissingIds" Core..=) Core.<$> allowMissingIds,
...
instance Core.FromJSON ResponseMetadata where
        parseJSON
          = Core.withObject "ResponseMetadata"
              (\ o -> ResponseMetadata Core.<$> (o Core..:? "requestId"))
...
newSearchJobsRequest 
    ::  SearchJobsRequest
newSearchJobsRequest
  = SearchJobsRequest{customRankingInfo = Core.Nothing,
                      disableKeywordMatch = Core.Nothing,
                      diversificationLevel = Core.Nothing,
                      enableBroadening = Core.Nothing, histogramQueries = Core.Nothing,
                      jobQuery = Core.Nothing, jobView = Core.Nothing,
                      keywordMatchMode = Core.Nothing, maxPageSize = Core.Nothing,
                      offset = Core.Nothing, orderBy = Core.Nothing,
                      pageToken = Core.Nothing, relevanceThreshold = Core.Nothing,
                      requestMetadata = Core.Nothing, searchMode = Core.Nothing}
...
instance Core.ToJSON SearchJobsRequest where
        toJSON SearchJobsRequest{..}
          = Core.object
              (Core.catMaybes
                 [("customRankingInfo" Core..=) Core.<$> customRankingInfo,
                  ("disableKeywordMatch" Core..=) Core.<$> disableKeywordMatch,
                  ("diversificationLevel" Core..=) Core.<$> diversificationLevel,
                  ("enableBroadening" Core..=) Core.<$> enableBroadening,
                  ("histogramQueries" Core..=) Core.<$> histogramQueries,
                  ("jobQuery" Core..=) Core.<$> jobQuery,
                  ("jobView" Core..=) Core.<$> jobView,
                  ("keywordMatchMode" Core..=) Core.<$> keywordMatchMode,
...
newSearchJobsResponse 
    ::  SearchJobsResponse
newSearchJobsResponse
  = SearchJobsResponse{broadenedQueryJobsCount = Core.Nothing,
                       histogramQueryResults = Core.Nothing,
                       locationFilters = Core.Nothing, matchingJobs = Core.Nothing,
                       metadata = Core.Nothing, nextPageToken = Core.Nothing,
                       spellCorrection = Core.Nothing, totalSize = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("broadenedQueryJobsCount" Core..=) Core.<$>
                  ...
                  ("histogramQueryResults" Core..=) Core.<$> histogramQueryResults,
                  ("locationFilters" Core..=) Core.<$> locationFilters,
...
newSpellingCorrection 
    ::  SpellingCorrection
newSpellingCorrection
  = SpellingCorrection{corrected = Core.Nothing,
                       correctedHtml = Core.Nothing, correctedText = Core.Nothing}
instance Core.FromJSON SpellingCorrection where
        parseJSON
          = Core.withObject "SpellingCorrection"
              (\ o ->
                 SpellingCorrection Core.<$>
                   (o Core..:? "corrected") Core.<*> (o Core..:? "correctedHtml")
...
instance Core.FromJSON Tenant where
        parseJSON
          = Core.withObject "Tenant"
              (\ o ->
                 Tenant Core.<$>
                   (o Core..:? "externalId") Core.<*> (o Core..:? "name"))
