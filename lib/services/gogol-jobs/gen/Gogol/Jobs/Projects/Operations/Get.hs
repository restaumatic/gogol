...
instance Core.GoogleRequest JobsProjectsOperationsGet where
        ...
        requestClient JobsProjectsOperationsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy JobsProjectsOperationsGetResource)
                      Core.mempty
