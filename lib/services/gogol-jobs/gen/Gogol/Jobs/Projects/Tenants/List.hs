...
-- |
-- Module      : Gogol.Jobs.Projects.Tenants.List
                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] ListTenantsResponse
...
newJobsProjectsTenantsList parent
  = JobsProjectsTenantsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest JobsProjectsTenantsList where
        ...
        type Scopes JobsProjectsTenantsList =
        ...
        requestClient JobsProjectsTenantsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy JobsProjectsTenantsListResource)
                      Core.mempty
