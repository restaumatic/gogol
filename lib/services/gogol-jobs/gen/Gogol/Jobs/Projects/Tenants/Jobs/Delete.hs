...
newJobsProjectsTenantsJobsDelete name
  = JobsProjectsTenantsJobsDelete{xgafv = Core.Nothing,
                                  accessToken = Core.Nothing, callback = Core.Nothing, name = name,
                                  uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest JobsProjectsTenantsJobsDelete where
        type Rs JobsProjectsTenantsJobsDelete = Empty
        type Scopes JobsProjectsTenantsJobsDelete =
        ...
        requestClient JobsProjectsTenantsJobsDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy JobsProjectsTenantsJobsDeleteResource)
                      Core.mempty
