               ...
               Core.QueryParam "callback" Core.Text Core.:>
                 Core.QueryParam "pageSize" Core.Int32 Core.:>
                   Core.QueryParam "pageToken" Core.Text Core.:>
                     Core.QueryParam "requireOpenJobs" Core.Bool Core.:>
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] ListCompaniesResponse
...
newJobsProjectsTenantsCompaniesList parent
  = JobsProjectsTenantsCompaniesList{xgafv = Core.Nothing,
                                     accessToken = Core.Nothing, callback = Core.Nothing,
                                     pageSize = Core.Nothing, pageToken = Core.Nothing,
                                     parent = parent, requireOpenJobs = Core.Nothing,
...
instance Core.GoogleRequest JobsProjectsTenantsCompaniesList where
        ...
        type Scopes JobsProjectsTenantsCompaniesList =
