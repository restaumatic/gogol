...
newJobsProjectsTenantsCompaniesCreate parent payload
  = JobsProjectsTenantsCompaniesCreate{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       parent = parent, payload = payload,
                                       uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest JobsProjectsTenantsCompaniesCreate
         where
        type Rs JobsProjectsTenantsCompaniesCreate = Company
        type Scopes JobsProjectsTenantsCompaniesCreate =
        ...
        requestClient JobsProjectsTenantsCompaniesCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy JobsProjectsTenantsCompaniesCreateResource)
                      Core.mempty
