             ...
             Core.QueryParam "access_token" Core.Text Core.:>
               Core.QueryParam "callback" Core.Text Core.:>
                 Core.QueryParam "filter" Core.Text Core.:>
                   Core.QueryParam "jobView" ProjectsTenantsJobsListJobView Core.:>
...
newJobsProjectsTenantsJobsList parent
  = JobsProjectsTenantsJobsList{xgafv = Core.Nothing,
                                accessToken = Core.Nothing, callback = Core.Nothing,
                                filter = Core.Nothing, jobView = Core.Nothing,
                                pageSize = Core.Nothing, pageToken = Core.Nothing, parent = parent,
                                uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest JobsProjectsTenantsJobsList where
        type Rs JobsProjectsTenantsJobsList = ListJobsResponse
        type Scopes JobsProjectsTenantsJobsList =
             '[CloudPlatform'FullControl, Jobs'FullControl]
        requestClient JobsProjectsTenantsJobsList{..}
          = go parent xgafv accessToken callback filter jobView pageSize
              pageToken
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy JobsProjectsTenantsJobsListResource)
                      Core.mempty
