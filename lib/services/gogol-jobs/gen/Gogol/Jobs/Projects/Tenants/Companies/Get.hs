...
newJobsProjectsTenantsCompaniesGet name
  = JobsProjectsTenantsCompaniesGet{xgafv = Core.Nothing,
                                    accessToken = Core.Nothing, callback = Core.Nothing,
                                    name = name, uploadType = Core.Nothing,
                                    uploadProtocol = Core.Nothing}
instance Core.GoogleRequest JobsProjectsTenantsCompaniesGet where
        ...
        requestClient JobsProjectsTenantsCompaniesGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy JobsProjectsTenantsCompaniesGetResource)
                      Core.mempty
