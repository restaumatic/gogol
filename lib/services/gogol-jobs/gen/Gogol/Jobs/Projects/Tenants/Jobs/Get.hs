...
instance Core.GoogleRequest JobsProjectsTenantsJobsGet where
        ...
        requestClient JobsProjectsTenantsJobsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy JobsProjectsTenantsJobsGetResource)
                      Core.mempty
