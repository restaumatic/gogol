...
type JobsProjectsTenantsCompleteQueryResource =
     "v4" Core.:>
       Core.CaptureMode "tenant" "completeQuery" Core.Text Core.:>
         Core.QueryParam "$.xgafv" Xgafv Core.:>
           Core.QueryParam "access_token" Core.Text Core.:>
             Core.QueryParam "callback" Core.Text Core.:>
               Core.QueryParam "company" Core.Text Core.:>
                 Core.QueryParams "languageCodes" Core.Text Core.:>
                   Core.QueryParam "pageSize" Core.Int32 Core.:>
                     Core.QueryParam "query" Core.Text Core.:>
                       Core.QueryParam "scope" ProjectsTenantsCompleteQueryScope Core.:>
                         Core.QueryParam "type" ProjectsTenantsCompleteQueryType Core.:>
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.Get '[Core.JSON] CompleteQueryResponse
...
newJobsProjectsTenantsCompleteQuery tenant
  = JobsProjectsTenantsCompleteQuery{xgafv = Core.Nothing,
                                     accessToken = Core.Nothing, callback = Core.Nothing,
                                     company = Core.Nothing, languageCodes = Core.Nothing,
                                     pageSize = Core.Nothing, query = Core.Nothing,
                                     scope = Core.Nothing, tenant = tenant, type' = Core.Nothing,
                                     uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest JobsProjectsTenantsCompleteQuery where
        type Rs JobsProjectsTenantsCompleteQuery = CompleteQueryResponse
        type Scopes JobsProjectsTenantsCompleteQuery =
             '[CloudPlatform'FullControl, Jobs'FullControl]
        requestClient JobsProjectsTenantsCompleteQuery{..}
          = go tenant xgafv accessToken callback company
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy JobsProjectsTenantsCompleteQueryResource)
                      Core.mempty
