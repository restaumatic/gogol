...
newJobsProjectsTenantsCompaniesDelete name
  = JobsProjectsTenantsCompaniesDelete{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       name = name, uploadType = Core.Nothing,
                                       uploadProtocol = Core.Nothing}
instance Core.GoogleRequest JobsProjectsTenantsCompaniesDelete
         where
        type Rs JobsProjectsTenantsCompaniesDelete = Empty
        type Scopes JobsProjectsTenantsCompaniesDelete =
        ...
        requestClient JobsProjectsTenantsCompaniesDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy JobsProjectsTenantsCompaniesDeleteResource)
                      Core.mempty
