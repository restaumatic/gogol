...
newJobsProjectsTenantsJobsCreate parent payload
  = JobsProjectsTenantsJobsCreate{xgafv = Core.Nothing,
                                  accessToken = Core.Nothing, callback = Core.Nothing,
                                  parent = parent, payload = payload, uploadType = Core.Nothing,
                                  uploadProtocol = Core.Nothing}
instance Core.GoogleRequest JobsProjectsTenantsJobsCreate where
        type Rs JobsProjectsTenantsJobsCreate = Job
        type Scopes JobsProjectsTenantsJobsCreate =
        ...
        requestClient JobsProjectsTenantsJobsCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy JobsProjectsTenantsJobsCreateResource)
                      Core.mempty
