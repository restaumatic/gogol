...
newJobsProjectsTenantsJobsSearchForAlert parent payload
  = JobsProjectsTenantsJobsSearchForAlert{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          parent = parent, payload = payload,
                                          uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest JobsProjectsTenantsJobsSearchForAlert
         where
        type Rs JobsProjectsTenantsJobsSearchForAlert = SearchJobsResponse
        type Scopes JobsProjectsTenantsJobsSearchForAlert =
             '[CloudPlatform'FullControl, Jobs'FullControl]
        requestClient JobsProjectsTenantsJobsSearchForAlert{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy JobsProjectsTenantsJobsSearchForAlertResource)
                      Core.mempty
