...
newJobsProjectsTenantsClientEventsCreate parent payload
  = JobsProjectsTenantsClientEventsCreate{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          parent = parent, payload = payload,
                                          uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest JobsProjectsTenantsClientEventsCreate
         where
        type Rs JobsProjectsTenantsClientEventsCreate = ClientEvent
        type Scopes JobsProjectsTenantsClientEventsCreate =
             '[CloudPlatform'FullControl, Jobs'FullControl]
        requestClient JobsProjectsTenantsClientEventsCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy JobsProjectsTenantsClientEventsCreateResource)
                      Core.mempty
