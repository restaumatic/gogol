                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] BatchCreateJobsRequest Core.:>
...
newJobsProjectsTenantsJobsBatchCreate parent payload
  = JobsProjectsTenantsJobsBatchCreate{xgafv = Core.Nothing,
                                       accessToken = Core.Nothing, callback = Core.Nothing,
                                       parent = parent, payload = payload,
                                       uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest JobsProjectsTenantsJobsBatchCreate
         where
        type Rs JobsProjectsTenantsJobsBatchCreate = Operation
        ...
        requestClient JobsProjectsTenantsJobsBatchCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy JobsProjectsTenantsJobsBatchCreateResource)
                      Core.mempty
