...
newJobsProjectsTenantsGet name
  = JobsProjectsTenantsGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest JobsProjectsTenantsGet where
        ...
        type Scopes JobsProjectsTenantsGet =
        ...
        requestClient JobsProjectsTenantsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy JobsProjectsTenantsGetResource)
                      Core.mempty
