...
type KgsearchEntitiesSearchResource =
     "v1" Core.:>
       "entities:search" Core.:>
         Core.QueryParam "$.xgafv" Xgafv Core.:>
           Core.QueryParam "access_token" Core.Text Core.:>
             Core.QueryParam "callback" Core.Text Core.:>
               Core.QueryParams "ids" Core.Text Core.:>
                 Core.QueryParam "indent" Core.Bool Core.:>
                   Core.QueryParams "languages" Core.Text Core.:>
                     Core.QueryParam "limit" Core.Int32 Core.:>
                       Core.QueryParam "prefix" Core.Bool Core.:>
                         Core.QueryParam "query" Core.Text Core.:>
                           Core.QueryParams "types" Core.Text Core.:>
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.Get '[Core.JSON] SearchResponse
...
newKgsearchEntitiesSearch 
    ::  KgsearchEntitiesSearch
newKgsearchEntitiesSearch
  = KgsearchEntitiesSearch{xgafv = Core.Nothing,
                           accessToken = Core.Nothing, callback = Core.Nothing,
                           ids = Core.Nothing, indent = Core.Nothing,
                           languages = Core.Nothing, limit = Core.Nothing,
                           prefix = Core.Nothing, query = Core.Nothing, types = Core.Nothing,
...
instance Core.GoogleRequest KgsearchEntitiesSearch where
        ...
        requestClient KgsearchEntitiesSearch{..}
          = go xgafv accessToken callback (ids Core.^. Core._Default) indent
