               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] SuggestCommentScoreRequest Core.:>
                       Core.Post '[Core.JSON] SuggestCommentScoreResponse
...
newCommentAnalyzerCommentsSuggestscore payload
  = CommentAnalyzerCommentsSuggestscore{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        payload = payload, uploadType = Core.Nothing,
                                        uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CommentAnalyzerCommentsSuggestscore
         where
        type Rs CommentAnalyzerCommentsSuggestscore =
             SuggestCommentScoreResponse
        type Scopes CommentAnalyzerCommentsSuggestscore = '[Userinfo'Email]
        requestClient CommentAnalyzerCommentsSuggestscore{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CommentAnalyzerCommentsSuggestscoreResource)
                      Core.mempty
