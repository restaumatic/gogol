...
newAnalyzeCommentRequest 
    ::  AnalyzeCommentRequest
newAnalyzeCommentRequest
  = AnalyzeCommentRequest{clientToken = Core.Nothing,
                          comment = Core.Nothing, communityId = Core.Nothing,
                          context = Core.Nothing, doNotStore = Core.Nothing,
                          languages = Core.Nothing, requestedAttributes = Core.Nothing,
                          sessionId = Core.Nothing, spanAnnotations = Core.Nothing}
instance Core.FromJSON AnalyzeCommentRequest where
        parseJSON
          = Core.withObject "AnalyzeCommentRequest"
              (\ o ->
                 AnalyzeCommentRequest Core.<$>
                   (o Core..:? "clientToken") Core.<*> (o Core..:? "comment") Core.<*>
                     (o Core..:? "communityId")
                     Core.<*> (o Core..:? "context")
          ...
          = Core.object
              (Core.catMaybes
                 [("clientToken" Core..=) Core.<$> clientToken,
                  ...
                  ("requestedAttributes" Core..=) Core.<$> requestedAttributes,
                  ("sessionId" Core..=) Core.<$> sessionId,
                  ("spanAnnotations" Core..=) Core.<$> spanAnnotations])
...
newtype AnalyzeCommentRequest_RequestedAttributes = AnalyzeCommentRequest_RequestedAttributes
    {
      ...
      additional :: (Core.HashMap Core.Text AttributeParameters)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)
...
newAnalyzeCommentRequest_RequestedAttributes 
    :: 
       ...
       -- ^  See 'additional'.
    -> AnalyzeCommentRequest_RequestedAttributes
newAnalyzeCommentRequest_RequestedAttributes additional
  = AnalyzeCommentRequest_RequestedAttributes{additional =
                                                additional}
instance Core.FromJSON AnalyzeCommentRequest_RequestedAttributes
         where
        parseJSON
          = Core.withObject "AnalyzeCommentRequest_RequestedAttributes"
              (\ o ->
                 AnalyzeCommentRequest_RequestedAttributes Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON AnalyzeCommentRequest_RequestedAttributes
         where
...
newAnalyzeCommentResponse 
    ::  AnalyzeCommentResponse
newAnalyzeCommentResponse
  = AnalyzeCommentResponse{attributeScores = Core.Nothing,
                           clientToken = Core.Nothing, detectedLanguages = Core.Nothing,
                           languages = Core.Nothing}
instance Core.FromJSON AnalyzeCommentResponse where
        parseJSON
          = Core.withObject "AnalyzeCommentResponse"
              (\ o ->
                 AnalyzeCommentResponse Core.<$>
                   (o Core..:? "attributeScores") Core.<*> (o Core..:? "clientToken")
...
instance Core.ToJSON AnalyzeCommentResponse where
        toJSON AnalyzeCommentResponse{..}
          = Core.object
              (Core.catMaybes
                 [("attributeScores" Core..=) Core.<$> attributeScores,
                  ("clientToken" Core..=) Core.<$> clientToken,
...
newAnalyzeCommentResponse_AttributeScores 
    :: 
       ...
       -- ^  See 'additional'.
    -> AnalyzeCommentResponse_AttributeScores
newAnalyzeCommentResponse_AttributeScores additional
  = AnalyzeCommentResponse_AttributeScores{additional = additional}
instance Core.FromJSON AnalyzeCommentResponse_AttributeScores where
        parseJSON
          = Core.withObject "AnalyzeCommentResponse_AttributeScores"
              (\ o ->
                 AnalyzeCommentResponse_AttributeScores Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON AnalyzeCommentResponse_AttributeScores where
...
newArticleAndParentComment 
    ::  ArticleAndParentComment
newArticleAndParentComment
  = ArticleAndParentComment{article = Core.Nothing,
                            parentComment = Core.Nothing}
instance Core.FromJSON ArticleAndParentComment where
        parseJSON
          = Core.withObject "ArticleAndParentComment"
              (\ o ->
                 ArticleAndParentComment Core.<$>
                   (o Core..:? "article") Core.<*> (o Core..:? "parentComment"))
...
newAttributeParameters 
    ::  AttributeParameters
newAttributeParameters
  = AttributeParameters{scoreThreshold = Core.Nothing,
                        scoreType = Core.Nothing}
instance Core.FromJSON AttributeParameters where
        parseJSON
          = Core.withObject "AttributeParameters"
              (\ o ->
                 AttributeParameters Core.<$>
                   (o Core..:? "scoreThreshold") Core.<*> (o Core..:? "scoreType"))
...
newAttributeScores 
    ::  AttributeScores
newAttributeScores
  = AttributeScores{spanScores = Core.Nothing,
                    summaryScore = Core.Nothing}
instance Core.FromJSON AttributeScores where
        parseJSON
          = Core.withObject "AttributeScores"
              (\ o ->
                 AttributeScores Core.<$>
                   (o Core..:? "spanScores") Core.<*> (o Core..:? "summaryScore"))
...
newContext 
    ::  Context
newContext
  = Context{articleAndParentComment = Core.Nothing,
...
instance Core.FromJSON Context where
        parseJSON
          = Core.withObject "Context"
              (\ o ->
                 Context Core.<$>
                   (o Core..:? "articleAndParentComment") Core.<*>
                     (o Core..:? "entries"))
...
instance Core.ToJSON Context where
        toJSON Context{..}
          = Core.object
              (Core.catMaybes
                 [("articleAndParentComment" Core..=) Core.<$>
                    articleAndParentComment,
...
instance Core.FromJSON Score where
        parseJSON
          = Core.withObject "Score"
              (\ o ->
                 Score Core.<$> (o Core..:? "type") Core.<*> (o Core..:? "value"))
...
newSpanScore 
    ::  SpanScore
newSpanScore
  = SpanScore{begin = Core.Nothing, end = Core.Nothing,
              score = Core.Nothing}
instance Core.FromJSON SpanScore where
        parseJSON
          = Core.withObject "SpanScore"
              (\ o ->
                 SpanScore Core.<$>
                   (o Core..:? "begin") Core.<*> (o Core..:? "end") Core.<*>
                     (o Core..:? "score"))
...
newSuggestCommentScoreRequest 
    ::  SuggestCommentScoreRequest
newSuggestCommentScoreRequest
  = SuggestCommentScoreRequest{attributeScores = Core.Nothing,
                               clientToken = Core.Nothing, comment = Core.Nothing,
                               communityId = Core.Nothing, context = Core.Nothing,
                               languages = Core.Nothing, sessionId = Core.Nothing}
instance Core.FromJSON SuggestCommentScoreRequest where
        parseJSON
          = Core.withObject "SuggestCommentScoreRequest"
              (\ o ->
                 SuggestCommentScoreRequest Core.<$>
                   (o Core..:? "attributeScores") Core.<*> (o Core..:? "clientToken")
                     Core.<*> (o Core..:? "comment")
...
newSuggestCommentScoreRequest_AttributeScores 
    :: 
       ...
       -- ^  See 'additional'.
    -> SuggestCommentScoreRequest_AttributeScores
newSuggestCommentScoreRequest_AttributeScores additional
  = SuggestCommentScoreRequest_AttributeScores{additional =
                                                 additional}
instance Core.FromJSON SuggestCommentScoreRequest_AttributeScores
         where
        parseJSON
          = Core.withObject "SuggestCommentScoreRequest_AttributeScores"
              (\ o ->
                 SuggestCommentScoreRequest_AttributeScores Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON SuggestCommentScoreRequest_AttributeScores
         where
...
newSuggestCommentScoreResponse 
    ::  SuggestCommentScoreResponse
newSuggestCommentScoreResponse
  = SuggestCommentScoreResponse{clientToken = Core.Nothing,
                                detectedLanguages = Core.Nothing,
                                requestedLanguages = Core.Nothing}
instance Core.FromJSON SuggestCommentScoreResponse where
        parseJSON
          = Core.withObject "SuggestCommentScoreResponse"
              (\ o ->
                 SuggestCommentScoreResponse Core.<$>
                   (o Core..:? "clientToken") Core.<*>
        ...
        toJSON SuggestCommentScoreResponse{..}
          = Core.object
              (Core.catMaybes
                 [("clientToken" Core..=) Core.<$> clientToken,
                  ("detectedLanguages" Core..=) Core.<$> detectedLanguages,
                  ("requestedLanguages" Core..=) Core.<$> requestedLanguages])
