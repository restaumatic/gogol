                             ...
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.Get '[Core.JSON] GetCustomerSearchApplicationStatsResponse
...
newCloudSearchStatsGetSearchapplication 
    :: 
                                        CloudSearchStatsGetSearchapplication
newCloudSearchStatsGetSearchapplication
  = CloudSearchStatsGetSearchapplication{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         endDateDay = Core.Nothing, endDateMonth = Core.Nothing,
                                         endDateYear = Core.Nothing, startDateDay = Core.Nothing,
                                         startDateMonth = Core.Nothing,
                                         startDateYear = Core.Nothing, uploadType = Core.Nothing,
                                         uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudSearchStatsGetSearchapplication
         where
        type Rs CloudSearchStatsGetSearchapplication =
             GetCustomerSearchApplicationStatsResponse
        type Scopes CloudSearchStatsGetSearchapplication =
             '[CloudSearch'FullControl, CloudSearch'Stats,
               CloudSearch'Stats'Indexing]
        requestClient CloudSearchStatsGetSearchapplication{..}
          = go xgafv accessToken callback endDateDay endDateMonth endDateYear
              startDateDay
              startDateMonth
              startDateYear
              uploadType
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudSearchStatsGetSearchapplicationResource)
                      Core.mempty
