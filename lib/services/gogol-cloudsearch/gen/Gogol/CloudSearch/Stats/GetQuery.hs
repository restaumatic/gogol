                             ...
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.Get '[Core.JSON] GetCustomerQueryStatsResponse
...
newCloudSearchStatsGetQuery 
    ::  CloudSearchStatsGetQuery
newCloudSearchStatsGetQuery
  = CloudSearchStatsGetQuery{xgafv = Core.Nothing,
...
instance Core.GoogleRequest CloudSearchStatsGetQuery where
        type Rs CloudSearchStatsGetQuery = GetCustomerQueryStatsResponse
        type Scopes CloudSearchStatsGetQuery =
        ...
        requestClient CloudSearchStatsGetQuery{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy CloudSearchStatsGetQueryResource)
                      Core.mempty
