                               ...
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.Get '[Core.JSON] GetSearchApplicationUserStatsResponse
...
newCloudSearchStatsUserSearchapplicationsGet name
  = CloudSearchStatsUserSearchapplicationsGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           CloudSearchStatsUserSearchapplicationsGet
         where
        type Rs CloudSearchStatsUserSearchapplicationsGet =
             GetSearchApplicationUserStatsResponse
        type Scopes CloudSearchStatsUserSearchapplicationsGet =
