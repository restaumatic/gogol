                               ...
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.Get '[Core.JSON] GetSearchApplicationSessionStatsResponse
...
newCloudSearchStatsSessionSearchapplicationsGet name
  = CloudSearchStatsSessionSearchapplicationsGet{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
           CloudSearchStatsSessionSearchapplicationsGet
         where
        type Rs CloudSearchStatsSessionSearchapplicationsGet =
             GetSearchApplicationSessionStatsResponse
        type Scopes CloudSearchStatsSessionSearchapplicationsGet =
        ...
        requestClient CloudSearchStatsSessionSearchapplicationsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudSearchStatsSessionSearchapplicationsGetResource)
                      Core.mempty
