                             ...
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.Get '[Core.JSON] GetCustomerIndexStatsResponse
...
newCloudSearchStatsGetIndex 
    ::  CloudSearchStatsGetIndex
newCloudSearchStatsGetIndex
  = CloudSearchStatsGetIndex{xgafv = Core.Nothing,
...
instance Core.GoogleRequest CloudSearchStatsGetIndex where
        type Rs CloudSearchStatsGetIndex = GetCustomerIndexStatsResponse
        type Scopes CloudSearchStatsGetIndex =
        ...
        requestClient CloudSearchStatsGetIndex{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy CloudSearchStatsGetIndexResource)
                      Core.mempty
