                               ...
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.Get '[Core.JSON] GetSearchApplicationQueryStatsResponse
...
newCloudSearchStatsQuerySearchapplicationsGet name
  = CloudSearchStatsQuerySearchapplicationsGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           CloudSearchStatsQuerySearchapplicationsGet
         where
        type Rs CloudSearchStatsQuerySearchapplicationsGet =
