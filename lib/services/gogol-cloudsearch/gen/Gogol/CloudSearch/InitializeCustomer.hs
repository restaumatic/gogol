             ...
             Core.QueryParam "uploadType" Core.Text Core.:>
               Core.QueryParam "upload_protocol" Core.Text Core.:>
                 Core.QueryParam "alt" Core.AltJSON Core.:>
                   Core.ReqBody '[Core.JSON] InitializeCustomerRequest Core.:>
...
newCloudSearchInitializeCustomer payload
  = CloudSearchInitializeCustomer{xgafv = Core.Nothing,
                                  accessToken = Core.Nothing, callback = Core.Nothing,
                                  payload = payload, uploadType = Core.Nothing,
                                  uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudSearchInitializeCustomer where
        type Rs CloudSearchInitializeCustomer = Operation
        type Scopes CloudSearchInitializeCustomer =
        ...
        requestClient CloudSearchInitializeCustomer{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy CloudSearchInitializeCustomerResource)
                      Core.mempty
