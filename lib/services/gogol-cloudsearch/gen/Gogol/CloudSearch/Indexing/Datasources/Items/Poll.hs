                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] PollItemsRequest Core.:>
                           Core.Post '[Core.JSON] PollItemsResponse
...
newCloudSearchIndexingDatasourcesItemsPoll name payload
  = CloudSearchIndexingDatasourcesItemsPoll{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            name = name, payload = payload,
                                            uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudSearchIndexingDatasourcesItemsPoll
         where
        type Rs CloudSearchIndexingDatasourcesItemsPoll = PollItemsResponse
        type Scopes CloudSearchIndexingDatasourcesItemsPoll =
             '[CloudSearch'FullControl, CloudSearch'Indexing]
        requestClient CloudSearchIndexingDatasourcesItemsPoll{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudSearchIndexingDatasourcesItemsPollResource)
                      Core.mempty
