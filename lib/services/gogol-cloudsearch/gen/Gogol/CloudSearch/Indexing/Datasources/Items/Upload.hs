...
type CloudSearchIndexingDatasourcesItemsUploadResource =
     "v1" Core.:>
       "indexing" Core.:>
         Core.CaptureMode "name" "upload" Core.Text Core.:>
                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] StartUploadItemRequest Core.:>
                         Core.Post '[Core.JSON] UploadItemRef
...
newCloudSearchIndexingDatasourcesItemsUpload name payload
  = CloudSearchIndexingDatasourcesItemsUpload{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes CloudSearchIndexingDatasourcesItemsUpload =
