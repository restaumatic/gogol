                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] DeleteQueueItemsRequest Core.:>
...
newCloudSearchIndexingDatasourcesItemsDeleteQueueItems name payload
  = CloudSearchIndexingDatasourcesItemsDeleteQueueItems{xgafv =
                                                          Core.Nothing,
...
instance Core.GoogleRequest
           CloudSearchIndexingDatasourcesItemsDeleteQueueItems
         where
        type Rs CloudSearchIndexingDatasourcesItemsDeleteQueueItems =
             Operation
        type Scopes CloudSearchIndexingDatasourcesItemsDeleteQueueItems =
