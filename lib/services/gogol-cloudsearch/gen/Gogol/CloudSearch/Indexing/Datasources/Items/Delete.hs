           ...
           Core.QueryParam "$.xgafv" Xgafv Core.:>
             Core.QueryParam "access_token" Core.Text Core.:>
               Core.QueryParam "callback" Core.Text Core.:>
                 Core.QueryParam "connectorName" Core.Text Core.:>
                   Core.QueryParam "debugOptions.enableDebugging" Core.Bool Core.:>
                     Core.QueryParam "mode" IndexingDatasourcesItemsDeleteMode Core.:>
...
newCloudSearchIndexingDatasourcesItemsDelete name
  = CloudSearchIndexingDatasourcesItemsDelete{xgafv = Core.Nothing,
                                              accessToken = Core.Nothing, callback = Core.Nothing,
                                              connectorName = Core.Nothing,
                                              debugOptionsEnableDebugging = Core.Nothing,
                                              mode = Core.Nothing, name = name,
                                              uploadType = Core.Nothing,
                                              uploadProtocol = Core.Nothing, version = Core.Nothing}
instance Core.GoogleRequest
           CloudSearchIndexingDatasourcesItemsDelete
         where
        type Rs CloudSearchIndexingDatasourcesItemsDelete = Operation
        type Scopes CloudSearchIndexingDatasourcesItemsDelete =
             '[CloudSearch'FullControl, CloudSearch'Indexing]
        requestClient CloudSearchIndexingDatasourcesItemsDelete{..}
          = go name xgafv accessToken callback connectorName
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudSearchIndexingDatasourcesItemsDeleteResource)
                      Core.mempty
