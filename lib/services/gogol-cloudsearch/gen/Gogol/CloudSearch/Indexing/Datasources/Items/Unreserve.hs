                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] UnreserveItemsRequest Core.:>
...
newCloudSearchIndexingDatasourcesItemsUnreserve name payload
  = CloudSearchIndexingDatasourcesItemsUnreserve{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
           CloudSearchIndexingDatasourcesItemsUnreserve
         where
        type Rs CloudSearchIndexingDatasourcesItemsUnreserve = Operation
        type Scopes CloudSearchIndexingDatasourcesItemsUnreserve =
             '[CloudSearch'FullControl, CloudSearch'Indexing]
        requestClient CloudSearchIndexingDatasourcesItemsUnreserve{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudSearchIndexingDatasourcesItemsUnreserveResource)
                      Core.mempty
