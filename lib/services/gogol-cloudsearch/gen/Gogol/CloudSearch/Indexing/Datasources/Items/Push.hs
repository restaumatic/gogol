...
newCloudSearchIndexingDatasourcesItemsPush name payload
  = CloudSearchIndexingDatasourcesItemsPush{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            name = name, payload = payload,
                                            uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudSearchIndexingDatasourcesItemsPush
         where
        type Rs CloudSearchIndexingDatasourcesItemsPush = Item
        type Scopes CloudSearchIndexingDatasourcesItemsPush =
             '[CloudSearch'FullControl, CloudSearch'Indexing]
        requestClient CloudSearchIndexingDatasourcesItemsPush{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudSearchIndexingDatasourcesItemsPushResource)
                      Core.mempty
