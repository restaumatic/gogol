...
type CloudSearchIndexingDatasourcesItemsIndexResource =
     "v1" Core.:>
       "indexing" Core.:>
         Core.CaptureMode "name" "index" Core.Text Core.:>
                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] IndexItemRequest Core.:>
...
newCloudSearchIndexingDatasourcesItemsIndex name payload
  = CloudSearchIndexingDatasourcesItemsIndex{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           CloudSearchIndexingDatasourcesItemsIndex
         where
        type Rs CloudSearchIndexingDatasourcesItemsIndex = Operation
        type Scopes CloudSearchIndexingDatasourcesItemsIndex =
        ...
        requestClient CloudSearchIndexingDatasourcesItemsIndex{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudSearchIndexingDatasourcesItemsIndexResource)
                      Core.mempty
