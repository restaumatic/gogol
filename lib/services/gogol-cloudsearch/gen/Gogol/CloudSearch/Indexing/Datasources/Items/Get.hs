...
newCloudSearchIndexingDatasourcesItemsGet name
  = CloudSearchIndexingDatasourcesItemsGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest CloudSearchIndexingDatasourcesItemsGet
         where
        type Rs CloudSearchIndexingDatasourcesItemsGet = Item
        type Scopes CloudSearchIndexingDatasourcesItemsGet =
        ...
        requestClient CloudSearchIndexingDatasourcesItemsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudSearchIndexingDatasourcesItemsGetResource)
                      Core.mempty
