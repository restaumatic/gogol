           ...
           "items" Core.:>
             Core.QueryParam "$.xgafv" Xgafv Core.:>
               Core.QueryParam "access_token" Core.Text Core.:>
                 Core.QueryParam "brief" Core.Bool Core.:>
                             ...
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.Get '[Core.JSON] ListItemsResponse
...
newCloudSearchIndexingDatasourcesItemsList name
  = CloudSearchIndexingDatasourcesItemsList{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, brief = Core.Nothing,
                                            callback = Core.Nothing, connectorName = Core.Nothing,
                                            debugOptionsEnableDebugging = Core.Nothing, name = name,
                                            pageSize = Core.Nothing, pageToken = Core.Nothing,
                                            uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudSearchIndexingDatasourcesItemsList
         where
        type Rs CloudSearchIndexingDatasourcesItemsList = ListItemsResponse
        type Scopes CloudSearchIndexingDatasourcesItemsList =
             '[CloudSearch'FullControl, CloudSearch'Indexing]
        requestClient CloudSearchIndexingDatasourcesItemsList{..}
          = go name xgafv accessToken brief callback connectorName
