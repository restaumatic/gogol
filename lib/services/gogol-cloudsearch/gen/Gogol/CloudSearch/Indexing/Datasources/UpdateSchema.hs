...
newCloudSearchIndexingDatasourcesUpdateSchema name payload
  = CloudSearchIndexingDatasourcesUpdateSchema{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           CloudSearchIndexingDatasourcesUpdateSchema
         where
        type Rs CloudSearchIndexingDatasourcesUpdateSchema = Operation
        type Scopes CloudSearchIndexingDatasourcesUpdateSchema =
             '[CloudSearch'FullControl, CloudSearch'Settings,
               CloudSearch'Settings'Indexing]
        requestClient CloudSearchIndexingDatasourcesUpdateSchema{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudSearchIndexingDatasourcesUpdateSchemaResource)
                      Core.mempty
