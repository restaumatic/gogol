             ...
             Core.QueryParam "access_token" Core.Text Core.:>
               Core.QueryParam "callback" Core.Text Core.:>
                 Core.QueryParam "pageToken" Core.Text Core.:>
                   Core.QueryParam "requestOptions.debugOptions.enableDebugging"
                     Core.Bool
                     Core.:>
                     Core.QueryParam "requestOptions.languageCode" Core.Text Core.:>
                       Core.QueryParam "requestOptions.searchApplicationId" Core.Text
                         Core.:>
                         Core.QueryParam "requestOptions.timeZone" Core.Text Core.:>
...
newCloudSearchQuerySourcesList 
    ::  CloudSearchQuerySourcesList
newCloudSearchQuerySourcesList
  = CloudSearchQuerySourcesList{xgafv = Core.Nothing,
                                ...
                                requestOptionsTimeZone = Core.Nothing, uploadType = Core.Nothing,
                                uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudSearchQuerySourcesList where
        type Rs CloudSearchQuerySourcesList = ListQuerySourcesResponse
        ...
        requestClient CloudSearchQuerySourcesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy CloudSearchQuerySourcesListResource)
                      Core.mempty
