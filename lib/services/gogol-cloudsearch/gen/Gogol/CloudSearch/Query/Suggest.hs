                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] SuggestRequest Core.:>
                         Core.Post '[Core.JSON] SuggestResponse
...
newCloudSearchQuerySuggest payload
  = CloudSearchQuerySuggest{xgafv = Core.Nothing,
...
instance Core.GoogleRequest CloudSearchQuerySuggest where
        ...
        type Scopes CloudSearchQuerySuggest =
