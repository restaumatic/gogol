...
instance Core.GoogleRequest CloudSearchOperationsGet where
        ...
        requestClient CloudSearchOperationsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy CloudSearchOperationsGetResource)
                      Core.mempty
