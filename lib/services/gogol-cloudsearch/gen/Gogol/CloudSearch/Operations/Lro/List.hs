...
newCloudSearchOperationsLroList name
  = CloudSearchOperationsLroList{xgafv = Core.Nothing,
                                 accessToken = Core.Nothing, callback = Core.Nothing,
                                 filter = Core.Nothing, name = name, pageSize = Core.Nothing,
                                 pageToken = Core.Nothing, uploadType = Core.Nothing,
                                 uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudSearchOperationsLroList where
        type Rs CloudSearchOperationsLroList = ListOperationsResponse
        type Scopes CloudSearchOperationsLroList =
             '[CloudSearch'FullControl, CloudSearch'Debug, CloudSearch'Indexing,
               CloudSearch'Settings, CloudSearch'Settings'Indexing,
        ...
        requestClient CloudSearchOperationsLroList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy CloudSearchOperationsLroListResource)
                      Core.mempty
