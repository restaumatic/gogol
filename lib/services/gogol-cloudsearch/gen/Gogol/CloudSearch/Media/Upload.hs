...
-- |
-- Module      : Gogol.CloudSearch.Media.Upload
...
newCloudSearchMediaUpload payload resourceName
  = CloudSearchMediaUpload{xgafv = Core.Nothing,
                           accessToken = Core.Nothing, callback = Core.Nothing,
                           payload = payload, resourceName = resourceName,
...
instance Core.GoogleRequest CloudSearchMediaUpload where
        ...
        type Scopes CloudSearchMediaUpload =
        ...
        requestClient CloudSearchMediaUpload{..}
          ...
          where go Core.:<|> _
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy CloudSearchMediaUploadResource)
                      Core.mempty

instance Core.GoogleRequest
           (Core.MediaUpload CloudSearchMediaUpload)
         where
        type Rs (Core.MediaUpload CloudSearchMediaUpload) = Media
        type Scopes (Core.MediaUpload CloudSearchMediaUpload) =
             Core.Scopes CloudSearchMediaUpload
        requestClient (Core.MediaUpload CloudSearchMediaUpload{..} body)
          = go resourceName xgafv accessToken callback uploadType
              uploadProtocol
              (Core.Just Core.AltJSON)
