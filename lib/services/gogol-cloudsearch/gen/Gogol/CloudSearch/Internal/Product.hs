...
newAuditLoggingSettings 
    ::  AuditLoggingSettings
newAuditLoggingSettings
  = AuditLoggingSettings{logAdminReadActions = Core.Nothing,
                         logDataReadActions = Core.Nothing,
                         logDataWriteActions = Core.Nothing, project = Core.Nothing}
instance Core.FromJSON AuditLoggingSettings where
        parseJSON
          = Core.withObject "AuditLoggingSettings"
              (\ o ->
                 AuditLoggingSettings Core.<$>
                   (o Core..:? "logAdminReadActions") Core.<*>
                     (o Core..:? "logDataReadActions")
...
newBackgroundColoredText 
    ::  BackgroundColoredText
newBackgroundColoredText
  = BackgroundColoredText{backgroundColor = Core.Nothing,
                          text = Core.Nothing}
instance Core.FromJSON BackgroundColoredText where
        parseJSON
          = Core.withObject "BackgroundColoredText"
              (\ o ->
                 BackgroundColoredText Core.<$>
                   (o Core..:? "backgroundColor") Core.<*> (o Core..:? "text"))
...
instance Core.FromJSON BooleanOperatorOptions where
        parseJSON
          = Core.withObject "BooleanOperatorOptions"
              (\ o ->
...
instance Core.FromJSON BooleanPropertyOptions where
        parseJSON
          = Core.withObject "BooleanPropertyOptions"
              (\ o ->
...
instance Core.FromJSON CheckAccessResponse where
        parseJSON
          = Core.withObject "CheckAccessResponse"
...
newCompositeFilter 
    ::  CompositeFilter
newCompositeFilter
  = CompositeFilter{logicOperator = Core.Nothing,
          ...
          = Core.withObject "CompositeFilter"
              (\ o ->
                 CompositeFilter Core.<$>
                   (o Core..:? "logicOperator") Core.<*> (o Core..:? "subFilters"))
...
newContent 
    ::  Content
newContent
  = Content{actions = Core.Nothing, description = Core.Nothing,
...
instance Core.FromJSON Content where
        parseJSON
          = Core.withObject "Content"
              (\ o ->
                 Content Core.<$>
                   (o Core..:? "actions") Core.<*> (o Core..:? "description") Core.<*>
                     (o Core..:? "subtitle")
                     Core.<*> (o Core..:? "title"))
...
newContext 
    ::  Context
newContext
  = Context{app = Core.Nothing, dayOfWeek = Core.Nothing,
            endDateSec = Core.Nothing, endDayOffsetSec = Core.Nothing,
            locale = Core.Nothing, location = Core.Nothing,
            query = Core.Nothing, startDateSec = Core.Nothing,
            startDayOffsetSec = Core.Nothing, surface = Core.Nothing,
            type' = Core.Nothing}
instance Core.FromJSON Context where
        parseJSON
          = Core.withObject "Context"
              (\ o ->
                 Context Core.<$>
                   (o Core..:? "app") Core.<*> (o Core..:? "dayOfWeek") Core.<*>
                     (o Core..:? "endDateSec" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "endDayOffsetSec" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "locale")
                     Core.<*> (o Core..:? "location")
                     Core.<*> (o Core..:? "query")
                     Core.<*>
                     (o Core..:? "startDateSec" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "startDayOffsetSec" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "surface")
                     Core.<*> (o Core..:? "type"))
          ...
          = Core.object
              (Core.catMaybes
                 [("app" Core..=) Core.<$> app,
                  ...
                  ("endDayOffsetSec" Core..=) Core.. Core.AsText Core.<$>
                    endDayOffsetSec,
                  ("locale" Core..=) Core.<$> locale,
                  ("location" Core..=) Core.<$> location,
                  ("query" Core..=) Core.<$> query,
                  ("startDateSec" Core..=) Core.. Core.AsText Core.<$> startDateSec,
                  ("startDayOffsetSec" Core..=) Core.. Core.AsText Core.<$>
                    startDayOffsetSec,
...
instance Core.FromJSON ContextAttribute where
        parseJSON
          = Core.withObject "ContextAttribute"
              (\ o ->
                 ContextAttribute Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "values"))
...
newCustomerIndexStats 
    ::  CustomerIndexStats
newCustomerIndexStats
  = CustomerIndexStats{date = Core.Nothing,
                       itemCountByStatus = Core.Nothing}
instance Core.FromJSON CustomerIndexStats where
        parseJSON
          = Core.withObject "CustomerIndexStats"
              (\ o ->
                 CustomerIndexStats Core.<$>
                   (o Core..:? "date") Core.<*> (o Core..:? "itemCountByStatus"))
...
newCustomerQueryStats 
    ::  CustomerQueryStats
newCustomerQueryStats
  = CustomerQueryStats{date = Core.Nothing,
                       queryCountByStatus = Core.Nothing}
instance Core.FromJSON CustomerQueryStats where
        parseJSON
          = Core.withObject "CustomerQueryStats"
              (\ o ->
                 CustomerQueryStats Core.<$>
                   (o Core..:? "date") Core.<*> (o Core..:? "queryCountByStatus"))
...
newCustomerSearchApplicationStats 
    ::  CustomerSearchApplicationStats
newCustomerSearchApplicationStats
  = CustomerSearchApplicationStats{count = Core.Nothing,
                                   date = Core.Nothing}
instance Core.FromJSON CustomerSearchApplicationStats where
        parseJSON
          = Core.withObject "CustomerSearchApplicationStats"
              (\ o ->
                 CustomerSearchApplicationStats Core.<$>
...
newCustomerSessionStats 
    ::  CustomerSessionStats
newCustomerSessionStats
  = CustomerSessionStats{date = Core.Nothing,
                         searchSessionsCount = Core.Nothing}
instance Core.FromJSON CustomerSessionStats where
        parseJSON
          = Core.withObject "CustomerSessionStats"
              (\ o ->
                 CustomerSessionStats Core.<$>
                   (o Core..:? "date") Core.<*>
                     (o Core..:? "searchSessionsCount" Core.<&>
...
instance Core.ToJSON CustomerSessionStats where
        toJSON CustomerSessionStats{..}
          = Core.object
              (Core.catMaybes
                 [("date" Core..=) Core.<$> date,
                  ("searchSessionsCount" Core..=) Core.. Core.AsText Core.<$>
                    searchSessionsCount])
...
newCustomerSettings 
    ::  CustomerSettings
newCustomerSettings
  = CustomerSettings{auditLoggingSettings = Core.Nothing,
                     vpcSettings = Core.Nothing}
instance Core.FromJSON CustomerSettings where
        parseJSON
          = Core.withObject "CustomerSettings"
              (\ o ->
                 CustomerSettings Core.<$>
                   (o Core..:? "auditLoggingSettings") Core.<*>
                     (o Core..:? "vpcSettings"))
...
newCustomerUserStats 
    ::  CustomerUserStats
newCustomerUserStats
  = CustomerUserStats{date = Core.Nothing,
...
instance Core.FromJSON CustomerUserStats where
        parseJSON
          = Core.withObject "CustomerUserStats"
              (\ o ->
                 CustomerUserStats Core.<$>
                   (o Core..:? "date") Core.<*>
                     (o Core..:? "oneDayActiveUsersCount" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "sevenDaysActiveUsersCount" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "thirtyDaysActiveUsersCount" Core.<&>
                        Core.fmap Core.fromAsText))
...
instance Core.ToJSON CustomerUserStats where
        toJSON CustomerUserStats{..}
          = Core.object
              (Core.catMaybes
                 [("date" Core..=) Core.<$> date,
                  ("oneDayActiveUsersCount" Core..=) Core.. Core.AsText Core.<$>
                    oneDayActiveUsersCount,
                  ("sevenDaysActiveUsersCount" Core..=) Core.. Core.AsText Core.<$>
                    sevenDaysActiveUsersCount,
                  ("thirtyDaysActiveUsersCount" Core..=) Core.. Core.AsText Core.<$>
...
newDataSource 
    ::  DataSource
newDataSource
  = DataSource{disableModifications = Core.Nothing,
               disableServing = Core.Nothing, displayName = Core.Nothing,
               indexingServiceAccounts = Core.Nothing,
               itemsVisibility = Core.Nothing, name = Core.Nothing,
               operationIds = Core.Nothing, returnThumbnailUrls = Core.Nothing,
...
instance Core.FromJSON DataSource where
        parseJSON
          = Core.withObject "DataSource"
              (\ o ->
                 DataSource Core.<$>
                   (o Core..:? "disableModifications") Core.<*>
                     (o Core..:? "disableServing")
          ...
          = Core.object
              (Core.catMaybes
                 [("disableModifications" Core..=) Core.<$> disableModifications,
                  ...
                  ("indexingServiceAccounts" Core..=) Core.<$>
...
newDataSourceIndexStats 
    ::  DataSourceIndexStats
newDataSourceIndexStats
  = DataSourceIndexStats{date = Core.Nothing,
                         itemCountByStatus = Core.Nothing}
instance Core.FromJSON DataSourceIndexStats where
        parseJSON
          = Core.withObject "DataSourceIndexStats"
              (\ o ->
                 DataSourceIndexStats Core.<$>
                   (o Core..:? "date") Core.<*> (o Core..:? "itemCountByStatus"))
...
newDataSourceRestriction 
    ::  DataSourceRestriction
newDataSourceRestriction
  = DataSourceRestriction{filterOptions = Core.Nothing,
                          source = Core.Nothing}
instance Core.FromJSON DataSourceRestriction where
        parseJSON
          = Core.withObject "DataSourceRestriction"
              (\ o ->
                 DataSourceRestriction Core.<$>
                   (o Core..:? "filterOptions") Core.<*> (o Core..:? "source"))
...
newDateOperatorOptions 
    ::  DateOperatorOptions
newDateOperatorOptions
  = DateOperatorOptions{greaterThanOperatorName = Core.Nothing,
                        lessThanOperatorName = Core.Nothing, operatorName = Core.Nothing}
instance Core.FromJSON DateOperatorOptions where
        parseJSON
          = Core.withObject "DateOperatorOptions"
              (\ o ->
                 DateOperatorOptions Core.<$>
                   (o Core..:? "greaterThanOperatorName") Core.<*>
                     (o Core..:? "lessThanOperatorName")
...
instance Core.ToJSON DateOperatorOptions where
        toJSON DateOperatorOptions{..}
          = Core.object
              (Core.catMaybes
                 [("greaterThanOperatorName" Core..=) Core.<$>
...
instance Core.FromJSON DatePropertyOptions where
        parseJSON
          = Core.withObject "DatePropertyOptions"
              (\ o ->
...
newDebugResponse 
    ::  DebugResponse
newDebugResponse
  = DebugResponse{gsrRequest = Core.Nothing,
                  gsrResponse = Core.Nothing, searchResponse = Core.Nothing}
instance Core.FromJSON DebugResponse where
        parseJSON
          = Core.withObject "DebugResponse"
              (\ o ->
                 DebugResponse Core.<$>
                   (o Core..:? "gsrRequest") Core.<*> (o Core..:? "gsrResponse")
...
newDeleteQueueItemsRequest 
    ::  DeleteQueueItemsRequest
newDeleteQueueItemsRequest
  = DeleteQueueItemsRequest{connectorName = Core.Nothing,
                            debugOptions = Core.Nothing, queue = Core.Nothing}
instance Core.FromJSON DeleteQueueItemsRequest where
        parseJSON
          = Core.withObject "DeleteQueueItemsRequest"
              (\ o ->
                 DeleteQueueItemsRequest Core.<$>
                   (o Core..:? "connectorName") Core.<*> (o Core..:? "debugOptions")
                     Core.<*> (o Core..:? "queue"))
...
instance Core.FromJSON DisplayedProperty where
        parseJSON
          = Core.withObject "DisplayedProperty"
...
instance Core.FromJSON DoubleOperatorOptions where
        parseJSON
          = Core.withObject "DoubleOperatorOptions"
...
instance Core.FromJSON DoublePropertyOptions where
        parseJSON
          = Core.withObject "DoublePropertyOptions"
              (\ o ->
...
instance Core.FromJSON DriveFollowUpRestrict where
        parseJSON
          = Core.withObject "DriveFollowUpRestrict"
...
instance Core.FromJSON DriveLocationRestrict where
        parseJSON
          = Core.withObject "DriveLocationRestrict"
...
instance Core.FromJSON DriveMimeTypeRestrict where
        parseJSON
          = Core.withObject "DriveMimeTypeRestrict"
...
instance Core.FromJSON DriveTimeSpanRestrict where
        parseJSON
          = Core.withObject "DriveTimeSpanRestrict"
...
newEmailAddress 
    ::  EmailAddress
newEmailAddress
  = EmailAddress{customType = Core.Nothing,
                 emailAddress = Core.Nothing, emailUrl = Core.Nothing,
                 primary = Core.Nothing, type' = Core.Nothing}
instance Core.FromJSON EmailAddress where
        parseJSON
          = Core.withObject "EmailAddress"
              (\ o ->
                 EmailAddress Core.<$>
                   (o Core..:? "customType") Core.<*> (o Core..:? "emailAddress")
...
newEnterpriseTopazFrontendTeamsLink 
    :: 
                                    EnterpriseTopazFrontendTeamsLink
newEnterpriseTopazFrontendTeamsLink
  = EnterpriseTopazFrontendTeamsLink{type' = Core.Nothing,
                                     url = Core.Nothing}
instance Core.FromJSON EnterpriseTopazFrontendTeamsLink where
        parseJSON
          = Core.withObject "EnterpriseTopazFrontendTeamsLink"
              (\ o ->
                 EnterpriseTopazFrontendTeamsLink Core.<$>
...
newEnterpriseTopazFrontendTeamsPersonCorePhoneNumber 
    :: 
                                                     EnterpriseTopazFrontendTeamsPersonCorePhoneNumber
newEnterpriseTopazFrontendTeamsPersonCorePhoneNumber
  = EnterpriseTopazFrontendTeamsPersonCorePhoneNumber{phoneNumber =
                                                        Core.Nothing,
                                                      phoneUrl = Core.Nothing, type' = Core.Nothing}
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "EnterpriseTopazFrontendTeamsPersonCorePhoneNumber"
              (\ o ->
                 EnterpriseTopazFrontendTeamsPersonCorePhoneNumber Core.<$>
                   (o Core..:? "phoneNumber") Core.<*> (o Core..:? "phoneUrl")
                     Core.<*> (o Core..:? "type"))
...
data EnterpriseTopazSidekickAgendaEntry = EnterpriseTopazSidekickAgendaEntry
    ...
    , currentUserAttendingStatus :: (Core.Maybe
...
newEnterpriseTopazSidekickAgendaEntry 
    :: 
                                      EnterpriseTopazSidekickAgendaEntry
newEnterpriseTopazSidekickAgendaEntry
  = EnterpriseTopazSidekickAgendaEntry{agendaItemUrl = Core.Nothing,
                                       chronology = Core.Nothing, creator = Core.Nothing,
                                       currentUserAttendingStatus = Core.Nothing,
                                       description = Core.Nothing, document = Core.Nothing,
                                       endDate = Core.Nothing, endTime = Core.Nothing,
                                       endTimeMs = Core.Nothing, eventId = Core.Nothing,
                                       guestsCanInviteOthers = Core.Nothing,
                                       guestsCanModify = Core.Nothing,
                                       guestsCanSeeGuests = Core.Nothing, hangoutId = Core.Nothing,
                                       hangoutUrl = Core.Nothing, invitee = Core.Nothing,
                                       isAllDay = Core.Nothing,
                                       lastModificationTimeMs = Core.Nothing,
                                       location = Core.Nothing, notifyToUser = Core.Nothing,
                                       otherAttendeesExcluded = Core.Nothing,
                                       requesterIsOwner = Core.Nothing,
                                       showFullEventDetailsToUse = Core.Nothing,
                                       startDate = Core.Nothing, startTime = Core.Nothing,
                                       startTimeMs = Core.Nothing, timeZone = Core.Nothing,
                                       title = Core.Nothing}
instance Core.FromJSON EnterpriseTopazSidekickAgendaEntry where
        parseJSON
          = Core.withObject "EnterpriseTopazSidekickAgendaEntry"
              (\ o ->
                 EnterpriseTopazSidekickAgendaEntry Core.<$>
                   (o Core..:? "agendaItemUrl") Core.<*> (o Core..:? "chronology")
                     Core.<*> (o Core..:? "creator")
                     ...
                     Core.<*>
                     (o Core..:? "lastModificationTimeMs" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "location")
          ...
          = Core.object
              (Core.catMaybes
                 [("agendaItemUrl" Core..=) Core.<$> agendaItemUrl,
                  ...
                  ("currentUserAttendingStatus" Core..=) Core.<$>
                  ...
                  ("lastModificationTimeMs" Core..=) Core.. Core.AsText Core.<$>
                  ...
                  ("showFullEventDetailsToUse" Core..=) Core.<$>
...
newEnterpriseTopazSidekickAgendaGroupCardProto 
    :: 
                                               EnterpriseTopazSidekickAgendaGroupCardProto
newEnterpriseTopazSidekickAgendaGroupCardProto
  = EnterpriseTopazSidekickAgendaGroupCardProto{agendaItem =
                                                  Core.Nothing,
                                                context = Core.Nothing,
                                                currentAgendaItem = Core.Nothing}
instance Core.FromJSON EnterpriseTopazSidekickAgendaGroupCardProto
         where
        parseJSON
          = Core.withObject "EnterpriseTopazSidekickAgendaGroupCardProto"
              (\ o ->
                 EnterpriseTopazSidekickAgendaGroupCardProto Core.<$>
                   (o Core..:? "agendaItem") Core.<*> (o Core..:? "context") Core.<*>
                     (o Core..:? "currentAgendaItem"))

instance Core.ToJSON EnterpriseTopazSidekickAgendaGroupCardProto
         where
...
newEnterpriseTopazSidekickAgendaGroupCardProtoContext 
    :: 
                                                      EnterpriseTopazSidekickAgendaGroupCardProtoContext
newEnterpriseTopazSidekickAgendaGroupCardProtoContext
  = EnterpriseTopazSidekickAgendaGroupCardProtoContext{context =
                                                         Core.Nothing,
                                                       date = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "EnterpriseTopazSidekickAgendaGroupCardProtoContext"
              (\ o ->
                 EnterpriseTopazSidekickAgendaGroupCardProtoContext Core.<$>
                   (o Core..:? "context") Core.<*> (o Core..:? "date") Core.<*>
                     (o Core..:? "eventsRestrict"))
...
newEnterpriseTopazSidekickAgendaItem 
    :: 
                                     EnterpriseTopazSidekickAgendaItem
newEnterpriseTopazSidekickAgendaItem
  = EnterpriseTopazSidekickAgendaItem{conflictedGroup = Core.Nothing,
                                      gapBefore = Core.Nothing, meeting = Core.Nothing}
instance Core.FromJSON EnterpriseTopazSidekickAgendaItem where
        parseJSON
          = Core.withObject "EnterpriseTopazSidekickAgendaItem"
              (\ o ->
                 EnterpriseTopazSidekickAgendaItem Core.<$>
                   (o Core..:? "conflictedGroup") Core.<*> (o Core..:? "gapBefore")
                     Core.<*> (o Core..:? "meeting"))
...
newEnterpriseTopazSidekickAnswerAnswerList 
    :: 
                                           EnterpriseTopazSidekickAnswerAnswerList
newEnterpriseTopazSidekickAnswerAnswerList
  = EnterpriseTopazSidekickAnswerAnswerList{labeledAnswer =
                                              Core.Nothing,
                                            type' = Core.Nothing}
instance Core.FromJSON EnterpriseTopazSidekickAnswerAnswerList
         where
        parseJSON
          = Core.withObject "EnterpriseTopazSidekickAnswerAnswerList"
              (\ o ->
                 EnterpriseTopazSidekickAnswerAnswerList Core.<$>
                   (o Core..:? "labeledAnswer") Core.<*> (o Core..:? "type"))
...
newEnterpriseTopazSidekickAnswerAnswerListLabeledAnswer 
    :: 
                                                        EnterpriseTopazSidekickAnswerAnswerListLabeledAnswer
newEnterpriseTopazSidekickAnswerAnswerListLabeledAnswer
  = EnterpriseTopazSidekickAnswerAnswerListLabeledAnswer{answer =
                                                           Core.Nothing,
                                                         label = Core.Nothing}
instance Core.FromJSON
           EnterpriseTopazSidekickAnswerAnswerListLabeledAnswer
        ...
        parseJSON
          = Core.withObject
              "EnterpriseTopazSidekickAnswerAnswerListLabeledAnswer"
              (\ o ->
                 EnterpriseTopazSidekickAnswerAnswerListLabeledAnswer Core.<$>
                   (o Core..:? "answer") Core.<*> (o Core..:? "label"))
...
newEnterpriseTopazSidekickAnswerSuggestedQueryAnswerCard 
    :: 
                                                         EnterpriseTopazSidekickAnswerSuggestedQueryAnswerCard
newEnterpriseTopazSidekickAnswerSuggestedQueryAnswerCard
  = EnterpriseTopazSidekickAnswerSuggestedQueryAnswerCard{suggestedQueryCategory
                                                            = Core.Nothing}
instance Core.FromJSON
           EnterpriseTopazSidekickAnswerSuggestedQueryAnswerCard
         where
        parseJSON
          = Core.withObject
              "EnterpriseTopazSidekickAnswerSuggestedQueryAnswerCard"
              (\ o ->
                 EnterpriseTopazSidekickAnswerSuggestedQueryAnswerCard Core.<$>
                   (o Core..:? "suggestedQueryCategory"))
...
instance Core.ToJSON
        ...
        toJSON EnterpriseTopazSidekickAnswerSuggestedQueryAnswerCard{..}
          = Core.object
              (Core.catMaybes
                 [("suggestedQueryCategory" Core..=) Core.<$>
...
newEnterpriseTopazSidekickAnswerSuggestedQueryCategory 
    :: 
                                                       EnterpriseTopazSidekickAnswerSuggestedQueryCategory
newEnterpriseTopazSidekickAnswerSuggestedQueryCategory
  = EnterpriseTopazSidekickAnswerSuggestedQueryCategory{category =
                                                          Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "EnterpriseTopazSidekickAnswerSuggestedQueryCategory"
              (\ o ->
                 EnterpriseTopazSidekickAnswerSuggestedQueryCategory Core.<$>
                   (o Core..:? "category") Core.<*> (o Core..:? "isEnabled") Core.<*>
                     (o Core..:? "query"))
...
data EnterpriseTopazSidekickAssistCardProto = EnterpriseTopazSidekickAssistCardProto
    ...
    , relatedPeopleAnswerCard :: (Core.Maybe
   EnterpriseTopazSidekickPeopleAnswerRelatedPeopleAnswerCard)
...
newEnterpriseTopazSidekickAssistCardProto 
    :: 
                                          EnterpriseTopazSidekickAssistCardProto
newEnterpriseTopazSidekickAssistCardProto
  = EnterpriseTopazSidekickAssistCardProto{agendaGroupCardProto =
                                             Core.Nothing,
                                           cardMetadata = Core.Nothing, cardType = Core.Nothing,
                                           ...
                                           meeting = Core.Nothing, meetingNotesCard = Core.Nothing,
...
instance Core.FromJSON EnterpriseTopazSidekickAssistCardProto where
        parseJSON
          = Core.withObject "EnterpriseTopazSidekickAssistCardProto"
              (\ o ->
                 EnterpriseTopazSidekickAssistCardProto Core.<$>
                   (o Core..:? "agendaGroupCardProto") Core.<*>
                     (o Core..:? "cardMetadata")
          ...
          = Core.object
              (Core.catMaybes
                 [("agendaGroupCardProto" Core..=) Core.<$> agendaGroupCardProto,
                  ...
                  ("conflictingMeetingsCard" Core..=) Core.<$>
                  ...
                  ("meetingNotesCardRequest" Core..=) Core.<$>
                    meetingNotesCardRequest,
                  ("peopleDisambiguationCard" Core..=) Core.<$>
...
newEnterpriseTopazSidekickCardMetadata 
    :: 
                                       EnterpriseTopazSidekickCardMetadata
newEnterpriseTopazSidekickCardMetadata
  = EnterpriseTopazSidekickCardMetadata{cardCategory = Core.Nothing,
                                        cardId = Core.Nothing, chronology = Core.Nothing,
                                        debugInfo = Core.Nothing, nlpMetadata = Core.Nothing,
                                        rankingParams = Core.Nothing, renderMode = Core.Nothing}
instance Core.FromJSON EnterpriseTopazSidekickCardMetadata where
        parseJSON
          = Core.withObject "EnterpriseTopazSidekickCardMetadata"
              (\ o ->
                 EnterpriseTopazSidekickCardMetadata Core.<$>
                   (o Core..:? "cardCategory") Core.<*> (o Core..:? "cardId") Core.<*>
                     (o Core..:? "chronology")
...
instance Core.FromJSON EnterpriseTopazSidekickCommonDebugInfo where
        parseJSON
          = Core.withObject "EnterpriseTopazSidekickCommonDebugInfo"
              (\ o ->
                 EnterpriseTopazSidekickCommonDebugInfo Core.<$>
                   (o Core..:? "message"))
...
data EnterpriseTopazSidekickCommonDocument = EnterpriseTopazSidekickCommonDocument
    ...
    , driveDocumentMetadata :: (Core.Maybe
   EnterpriseTopazSidekickCommonDocumentDriveDocumentMetadata)
...
newEnterpriseTopazSidekickCommonDocument 
    :: 
                                         EnterpriseTopazSidekickCommonDocument
newEnterpriseTopazSidekickCommonDocument
  = EnterpriseTopazSidekickCommonDocument{accessType = Core.Nothing,
                                          debugInfo = Core.Nothing, documentId = Core.Nothing,
                                          driveDocumentMetadata = Core.Nothing,
                                          genericUrl = Core.Nothing, justification = Core.Nothing,
                                          mimeType = Core.Nothing, provenance = Core.Nothing,
                                          reason = Core.Nothing, snippet = Core.Nothing,
...
instance Core.FromJSON EnterpriseTopazSidekickCommonDocument where
        parseJSON
          = Core.withObject "EnterpriseTopazSidekickCommonDocument"
              (\ o ->
                 EnterpriseTopazSidekickCommonDocument Core.<$>
                   (o Core..:? "accessType") Core.<*> (o Core..:? "debugInfo")
...
newEnterpriseTopazSidekickCommonDocumentDriveDocumentMetadata 
    :: 
                                                              EnterpriseTopazSidekickCommonDocumentDriveDocumentMetadata
newEnterpriseTopazSidekickCommonDocumentDriveDocumentMetadata
  = EnterpriseTopazSidekickCommonDocumentDriveDocumentMetadata{documentId
                                                                 = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "EnterpriseTopazSidekickCommonDocumentDriveDocumentMetadata"
              (\ o ->
                 EnterpriseTopazSidekickCommonDocumentDriveDocumentMetadata Core.<$>
                   (o Core..:? "documentId") Core.<*> (o Core..:? "isPrivate")
                     Core.<*>
                     (o Core..:? "lastCommentTimeMs" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "lastEditTimeMs" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "lastModificationTimeMillis" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "lastUpdatedTimeMs" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "lastViewTimeMs" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "owner")
                     Core.<*> (o Core..:? "scope"))
          ...
          = Core.object
              (Core.catMaybes
                 [("documentId" Core..=) Core.<$> documentId,
                  ...
                  ("lastCommentTimeMs" Core..=) Core.. Core.AsText Core.<$>
                    lastCommentTimeMs,
                  ("lastEditTimeMs" Core..=) Core.. Core.AsText Core.<$>
                    lastEditTimeMs,
                  ("lastModificationTimeMillis" Core..=) Core.. Core.AsText Core.<$>
                    lastModificationTimeMillis,
                  ("lastUpdatedTimeMs" Core..=) Core.. Core.AsText Core.<$>
                    lastUpdatedTimeMs,
                  ("lastViewTimeMs" Core..=) Core.. Core.AsText Core.<$>
                    lastViewTimeMs,
...
newEnterpriseTopazSidekickCommonDocumentJustification 
    :: 
                                                      EnterpriseTopazSidekickCommonDocumentJustification
newEnterpriseTopazSidekickCommonDocumentJustification
  = EnterpriseTopazSidekickCommonDocumentJustification{justification
                                                         = Core.Nothing,
                                                       reason = Core.Nothing}
instance Core.FromJSON
           EnterpriseTopazSidekickCommonDocumentJustification
        ...
        parseJSON
          = Core.withObject
              "EnterpriseTopazSidekickCommonDocumentJustification"
              (\ o ->
                 EnterpriseTopazSidekickCommonDocumentJustification Core.<$>
                   (o Core..:? "justification") Core.<*> (o Core..:? "reason"))
...
newEnterpriseTopazSidekickCommonPerson 
    :: 
                                       EnterpriseTopazSidekickCommonPerson
newEnterpriseTopazSidekickCommonPerson
  = EnterpriseTopazSidekickCommonPerson{birthday = Core.Nothing,
                                        cellPhone = Core.Nothing, department = Core.Nothing,
                                        deskLocation = Core.Nothing, deskPhone = Core.Nothing,
                                        displayName = Core.Nothing, email = Core.Nothing,
                                        familyName = Core.Nothing, fullAddress = Core.Nothing,
                                        gaiaId = Core.Nothing, givenName = Core.Nothing,
                                        jobTitle = Core.Nothing, manager = Core.Nothing,
                                        obfuscatedId = Core.Nothing, photoUrl = Core.Nothing,
                                        streetAddress = Core.Nothing}
instance Core.FromJSON EnterpriseTopazSidekickCommonPerson where
        parseJSON
          = Core.withObject "EnterpriseTopazSidekickCommonPerson"
              (\ o ->
                 EnterpriseTopazSidekickCommonPerson Core.<$>
                   (o Core..:? "birthday") Core.<*> (o Core..:? "cellPhone") Core.<*>
                     (o Core..:? "department")
...
instance Core.FromJSON EnterpriseTopazSidekickCommonPersonBirthday
         where
        parseJSON
          = Core.withObject "EnterpriseTopazSidekickCommonPersonBirthday"
              (\ o ->
                 EnterpriseTopazSidekickCommonPersonBirthday Core.<$>
                   (o Core..:? "value"))

instance Core.ToJSON EnterpriseTopazSidekickCommonPersonBirthday
         where
...
newEnterpriseTopazSidekickConflictingEventsCardProto 
    :: 
                                                     EnterpriseTopazSidekickConflictingEventsCardProto
newEnterpriseTopazSidekickConflictingEventsCardProto
  = EnterpriseTopazSidekickConflictingEventsCardProto{conflictingEvent
                                                        = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "EnterpriseTopazSidekickConflictingEventsCardProto"
              (\ o ->
                 EnterpriseTopazSidekickConflictingEventsCardProto Core.<$>
                   (o Core..:? "conflictingEvent") Core.<*> (o Core..:? "mainEvent"))
...
newEnterpriseTopazSidekickDocumentGroup 
    :: 
                                        EnterpriseTopazSidekickDocumentGroup
newEnterpriseTopazSidekickDocumentGroup
  = EnterpriseTopazSidekickDocumentGroup{groupType = Core.Nothing,
                                         personalizedDocument = Core.Nothing}
instance Core.FromJSON EnterpriseTopazSidekickDocumentGroup where
        parseJSON
          = Core.withObject "EnterpriseTopazSidekickDocumentGroup"
              (\ o ->
                 EnterpriseTopazSidekickDocumentGroup Core.<$>
                   (o Core..:? "groupType") Core.<*>
                     (o Core..:? "personalizedDocument"))
...
newEnterpriseTopazSidekickDocumentPerCategoryList 
    :: 
                                                  EnterpriseTopazSidekickDocumentPerCategoryList
newEnterpriseTopazSidekickDocumentPerCategoryList
  = EnterpriseTopazSidekickDocumentPerCategoryList{documents =
                                                     Core.Nothing,
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "EnterpriseTopazSidekickDocumentPerCategoryList"
              (\ o ->
                 EnterpriseTopazSidekickDocumentPerCategoryList Core.<$>
                   (o Core..:? "documents") Core.<*> (o Core..:? "helpMessage")
                     Core.<*> (o Core..:? "listType")
                     Core.<*> (o Core..:? "listTypeDescription")
                     Core.<*> (o Core..:? "responseMessage"))

instance Core.ToJSON EnterpriseTopazSidekickDocumentPerCategoryList
         where
...
newEnterpriseTopazSidekickDocumentPerCategoryListDocumentPerCategoryListEntry 
    :: 
                                                                              EnterpriseTopazSidekickDocumentPerCategoryListDocumentPerCategoryListEntry
newEnterpriseTopazSidekickDocumentPerCategoryListDocumentPerCategoryListEntry
  = EnterpriseTopazSidekickDocumentPerCategoryListDocumentPerCategoryListEntry{category
                                                                                 = Core.Nothing,
                                                                               document =
                                                                                 Core.Nothing,
                                                                               rationale =
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 EnterpriseTopazSidekickDocumentPerCategoryListDocumentPerCategoryListEntry
                   Core.<$>
                   (o Core..:? "category") Core.<*> (o Core..:? "document") Core.<*>
                     (o Core..:? "rationale"))
...
newEnterpriseTopazSidekickFindMeetingTimeCardProto 
    :: 
                                                   EnterpriseTopazSidekickFindMeetingTimeCardProto
newEnterpriseTopazSidekickFindMeetingTimeCardProto
  = EnterpriseTopazSidekickFindMeetingTimeCardProto{commonAvailableTimeSlots
                                                      = Core.Nothing,
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "EnterpriseTopazSidekickFindMeetingTimeCardProto"
              (\ o ->
                 EnterpriseTopazSidekickFindMeetingTimeCardProto Core.<$>
                   (o Core..:? "commonAvailableTimeSlots") Core.<*>
                     (o Core..:? "invitees")
...
instance Core.ToJSON
        ...
        toJSON EnterpriseTopazSidekickFindMeetingTimeCardProto{..}
          = Core.object
              (Core.catMaybes
                 [("commonAvailableTimeSlots" Core..=) Core.<$>
...
newEnterpriseTopazSidekickGap 
    ::  EnterpriseTopazSidekickGap
newEnterpriseTopazSidekickGap
  = EnterpriseTopazSidekickGap{displayRemainingTime = Core.Nothing,
                               endTime = Core.Nothing, endTimeMs = Core.Nothing,
                               remainingTime = Core.Nothing, startTime = Core.Nothing,
                               startTimeMs = Core.Nothing}
instance Core.FromJSON EnterpriseTopazSidekickGap where
        parseJSON
          = Core.withObject "EnterpriseTopazSidekickGap"
              (\ o ->
                 EnterpriseTopazSidekickGap Core.<$>
                   (o Core..:? "displayRemainingTime") Core.<*> (o Core..:? "endTime")
                     Core.<*>
                     (o Core..:? "endTimeMs" Core.<&> Core.fmap Core.fromAsText)
...
newEnterpriseTopazSidekickGenericAnswerCard 
    :: 
                                            EnterpriseTopazSidekickGenericAnswerCard
newEnterpriseTopazSidekickGenericAnswerCard
  = EnterpriseTopazSidekickGenericAnswerCard{answer = Core.Nothing,
                                             title = Core.Nothing}
instance Core.FromJSON EnterpriseTopazSidekickGenericAnswerCard
         where
        parseJSON
          = Core.withObject "EnterpriseTopazSidekickGenericAnswerCard"
              (\ o ->
                 EnterpriseTopazSidekickGenericAnswerCard Core.<$>
                   (o Core..:? "answer") Core.<*> (o Core..:? "title"))
...
newEnterpriseTopazSidekickGetAndKeepAheadCardProto 
    :: 
                                                   EnterpriseTopazSidekickGetAndKeepAheadCardProto
newEnterpriseTopazSidekickGetAndKeepAheadCardProto
  = EnterpriseTopazSidekickGetAndKeepAheadCardProto{declinedEvents =
                                                      Core.Nothing,
...
instance Core.FromJSON
         ...
         where
        parseJSON
          = Core.withObject "EnterpriseTopazSidekickGetAndKeepAheadCardProto"
              (\ o ->
                 EnterpriseTopazSidekickGetAndKeepAheadCardProto Core.<$>
                   (o Core..:? "declinedEvents") Core.<*>
                     (o Core..:? "mentionedDocuments")
                     Core.<*> (o Core..:? "sharedDocuments"))
...
newEnterpriseTopazSidekickGetAndKeepAheadCardProtoDeclinedEvents 
    :: 
                                                                 EnterpriseTopazSidekickGetAndKeepAheadCardProtoDeclinedEvents
newEnterpriseTopazSidekickGetAndKeepAheadCardProtoDeclinedEvents
  = EnterpriseTopazSidekickGetAndKeepAheadCardProtoDeclinedEvents{events
                                                                    = Core.Nothing}
instance Core.FromJSON
           EnterpriseTopazSidekickGetAndKeepAheadCardProtoDeclinedEvents
         where
...
newEnterpriseTopazSidekickMeetingNotesCardError 
    :: 
                                                EnterpriseTopazSidekickMeetingNotesCardError
newEnterpriseTopazSidekickMeetingNotesCardError
  = EnterpriseTopazSidekickMeetingNotesCardError{description =
                                                   Core.Nothing,
                                                 event = Core.Nothing, reason = Core.Nothing}
instance Core.FromJSON EnterpriseTopazSidekickMeetingNotesCardError
         where
        parseJSON
          = Core.withObject "EnterpriseTopazSidekickMeetingNotesCardError"
              (\ o ->
                 EnterpriseTopazSidekickMeetingNotesCardError Core.<$>
                   (o Core..:? "description") Core.<*> (o Core..:? "event") Core.<*>
                     (o Core..:? "reason"))

instance Core.ToJSON EnterpriseTopazSidekickMeetingNotesCardError
         where
...
newEnterpriseTopazSidekickMeetingNotesCardProto 
    :: 
                                                EnterpriseTopazSidekickMeetingNotesCardProto
newEnterpriseTopazSidekickMeetingNotesCardProto
  = EnterpriseTopazSidekickMeetingNotesCardProto{event =
                                                   Core.Nothing,
                                                 fileId = Core.Nothing, title = Core.Nothing,
                                                 url = Core.Nothing}
instance Core.FromJSON EnterpriseTopazSidekickMeetingNotesCardProto
         where
        parseJSON
          = Core.withObject "EnterpriseTopazSidekickMeetingNotesCardProto"
              (\ o ->
                 EnterpriseTopazSidekickMeetingNotesCardProto Core.<$>
                   (o Core..:? "event") Core.<*> (o Core..:? "fileId") Core.<*>
                     (o Core..:? "title")
                     Core.<*> (o Core..:? "url"))

instance Core.ToJSON EnterpriseTopazSidekickMeetingNotesCardProto
         where
...
newEnterpriseTopazSidekickMeetingNotesCardRequest 
    :: 
                                                  EnterpriseTopazSidekickMeetingNotesCardRequest
newEnterpriseTopazSidekickMeetingNotesCardRequest
  = EnterpriseTopazSidekickMeetingNotesCardRequest{canCreateFor =
                                                     Core.Nothing,
                                                   error = Core.Nothing, event = Core.Nothing}
instance Core.FromJSON
           EnterpriseTopazSidekickMeetingNotesCardRequest
         where
        parseJSON
          = Core.withObject "EnterpriseTopazSidekickMeetingNotesCardRequest"
              (\ o ->
                 EnterpriseTopazSidekickMeetingNotesCardRequest Core.<$>
                   (o Core..:? "canCreateFor") Core.<*> (o Core..:? "error") Core.<*>
                     (o Core..:? "event"))

instance Core.ToJSON EnterpriseTopazSidekickMeetingNotesCardRequest
         where
...
instance Core.FromJSON EnterpriseTopazSidekickNlpMetadata where
        parseJSON
          = Core.withObject "EnterpriseTopazSidekickNlpMetadata"
              (\ o ->
                 EnterpriseTopazSidekickNlpMetadata Core.<$>
                   (o Core..:? "confidence"))
...
newEnterpriseTopazSidekickPeopleAnswerDisambiguationInfo 
    :: 
                                                         EnterpriseTopazSidekickPeopleAnswerDisambiguationInfo
newEnterpriseTopazSidekickPeopleAnswerDisambiguationInfo
  = EnterpriseTopazSidekickPeopleAnswerDisambiguationInfo{disambiguation
                                                            = Core.Nothing,
                                                          name = Core.Nothing}
instance Core.FromJSON
           EnterpriseTopazSidekickPeopleAnswerDisambiguationInfo
        ...
        parseJSON
          = Core.withObject
              "EnterpriseTopazSidekickPeopleAnswerDisambiguationInfo"
              (\ o ->
                 EnterpriseTopazSidekickPeopleAnswerDisambiguationInfo Core.<$>
                   (o Core..:? "disambiguation") Core.<*> (o Core..:? "name"))
...
newEnterpriseTopazSidekickPeopleAnswerDisambiguationInfoDisambiguationPerson 
    :: 
                                                                             EnterpriseTopazSidekickPeopleAnswerDisambiguationInfoDisambiguationPerson
newEnterpriseTopazSidekickPeopleAnswerDisambiguationInfoDisambiguationPerson
  = EnterpriseTopazSidekickPeopleAnswerDisambiguationInfoDisambiguationPerson{person
                                                                                = Core.Nothing,
                                                                              query = Core.Nothing}
instance Core.FromJSON
           EnterpriseTopazSidekickPeopleAnswerDisambiguationInfoDisambiguationPerson
        ...
        parseJSON
          = Core.withObject
              ...
              (\ o ->
                 EnterpriseTopazSidekickPeopleAnswerDisambiguationInfoDisambiguationPerson
                   Core.<$> (o Core..:? "person") Core.<*> (o Core..:? "query"))
...
newEnterpriseTopazSidekickPeopleAnswerPeopleAnswerCardHeader 
    :: 
                                                             EnterpriseTopazSidekickPeopleAnswerPeopleAnswerCardHeader
newEnterpriseTopazSidekickPeopleAnswerPeopleAnswerCardHeader
  = EnterpriseTopazSidekickPeopleAnswerPeopleAnswerCardHeader{title =
                                                                Core.Nothing}
instance Core.FromJSON
           EnterpriseTopazSidekickPeopleAnswerPeopleAnswerCardHeader
         where
        parseJSON
          = Core.withObject
              "EnterpriseTopazSidekickPeopleAnswerPeopleAnswerCardHeader"
              (\ o ->
                 EnterpriseTopazSidekickPeopleAnswerPeopleAnswerCardHeader Core.<$>
                   (o Core..:? "title"))
...
newEnterpriseTopazSidekickPeopleAnswerPersonAnswerCard 
    :: 
                                                       EnterpriseTopazSidekickPeopleAnswerPersonAnswerCard
newEnterpriseTopazSidekickPeopleAnswerPersonAnswerCard
  = EnterpriseTopazSidekickPeopleAnswerPersonAnswerCard{answer =
                                                          Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "EnterpriseTopazSidekickPeopleAnswerPersonAnswerCard"
              (\ o ->
                 EnterpriseTopazSidekickPeopleAnswerPersonAnswerCard Core.<$>
                   (o Core..:? "answer") Core.<*> (o Core..:? "answerText") Core.<*>
                     (o Core..:? "disambiguationInfo")
                     Core.<*> (o Core..:? "header")
...
newEnterpriseTopazSidekickPeopleAnswerRelatedPeopleAnswerCard 
    :: 
                                                              EnterpriseTopazSidekickPeopleAnswerRelatedPeopleAnswerCard
newEnterpriseTopazSidekickPeopleAnswerRelatedPeopleAnswerCard
  = EnterpriseTopazSidekickPeopleAnswerRelatedPeopleAnswerCard{disambiguationInfo
                                                                 = Core.Nothing,
                                                               header = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "EnterpriseTopazSidekickPeopleAnswerRelatedPeopleAnswerCard"
              (\ o ->
                 EnterpriseTopazSidekickPeopleAnswerRelatedPeopleAnswerCard Core.<$>
                   (o Core..:? "disambiguationInfo") Core.<*> (o Core..:? "header")
...
newEnterpriseTopazSidekickPeopleDisambiguationCard 
    :: 
                                                   EnterpriseTopazSidekickPeopleDisambiguationCard
newEnterpriseTopazSidekickPeopleDisambiguationCard
  = EnterpriseTopazSidekickPeopleDisambiguationCard{person =
                                                      Core.Nothing}
instance Core.FromJSON
           EnterpriseTopazSidekickPeopleDisambiguationCard
         where
        parseJSON
          = Core.withObject "EnterpriseTopazSidekickPeopleDisambiguationCard"
              (\ o ->
                 EnterpriseTopazSidekickPeopleDisambiguationCard Core.<$>
                   (o Core..:? "person"))
...
newEnterpriseTopazSidekickPerson 
    ::  EnterpriseTopazSidekickPerson
newEnterpriseTopazSidekickPerson
  = EnterpriseTopazSidekickPerson{affinityLevel = Core.Nothing,
                                  attendingStatus = Core.Nothing, email = Core.Nothing,
                                  gaiaId = Core.Nothing, isGroup = Core.Nothing,
                                  name = Core.Nothing, obfuscatedGaiaId = Core.Nothing,
                                  photoUrl = Core.Nothing}
instance Core.FromJSON EnterpriseTopazSidekickPerson where
        parseJSON
          = Core.withObject "EnterpriseTopazSidekickPerson"
              (\ o ->
                 EnterpriseTopazSidekickPerson Core.<$>
                   (o Core..:? "affinityLevel") Core.<*>
                     (o Core..:? "attendingStatus")
                     Core.<*> (o Core..:? "email")
                     Core.<*> (o Core..:? "gaiaId" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "isGroup")
                     Core.<*> (o Core..:? "name")
...
newEnterpriseTopazSidekickPersonProfileCard 
    :: 
                                            EnterpriseTopazSidekickPersonProfileCard
newEnterpriseTopazSidekickPersonProfileCard
  = EnterpriseTopazSidekickPersonProfileCard{relatedPeople =
                                               Core.Nothing,
                                             subject = Core.Nothing}
instance Core.FromJSON EnterpriseTopazSidekickPersonProfileCard
         where
        parseJSON
          = Core.withObject "EnterpriseTopazSidekickPersonProfileCard"
              (\ o ->
                 EnterpriseTopazSidekickPersonProfileCard Core.<$>
                   (o Core..:? "relatedPeople") Core.<*> (o Core..:? "subject"))
...
newEnterpriseTopazSidekickPersonProfileCardRelatedPeople 
    :: 
                                                         EnterpriseTopazSidekickPersonProfileCardRelatedPeople
newEnterpriseTopazSidekickPersonProfileCardRelatedPeople
  = EnterpriseTopazSidekickPersonProfileCardRelatedPeople{relatedPerson
                                                            = Core.Nothing,
...
instance Core.FromJSON
        ...
        parseJSON
          = Core.withObject
              "EnterpriseTopazSidekickPersonProfileCardRelatedPeople"
              (\ o ->
                 EnterpriseTopazSidekickPersonProfileCardRelatedPeople Core.<$>
                   (o Core..:? "relatedPerson") Core.<*> (o Core..:? "relation"))
...
newEnterpriseTopazSidekickPersonalizedDocsCardProto 
    :: 
                                                    EnterpriseTopazSidekickPersonalizedDocsCardProto
newEnterpriseTopazSidekickPersonalizedDocsCardProto
  = EnterpriseTopazSidekickPersonalizedDocsCardProto{documentGroup =
                                                       Core.Nothing}
instance Core.FromJSON
           EnterpriseTopazSidekickPersonalizedDocsCardProto
         where
        parseJSON
          = Core.withObject
              "EnterpriseTopazSidekickPersonalizedDocsCardProto"
              (\ o ->
                 EnterpriseTopazSidekickPersonalizedDocsCardProto Core.<$>
                   (o Core..:? "documentGroup"))
...
newEnterpriseTopazSidekickRankingParams 
    :: 
                                        EnterpriseTopazSidekickRankingParams
newEnterpriseTopazSidekickRankingParams
  = EnterpriseTopazSidekickRankingParams{endTimeMs = Core.Nothing,
                                         priority = Core.Nothing, score = Core.Nothing,
                                         spanMs = Core.Nothing, startTimeMs = Core.Nothing,
                                         type' = Core.Nothing}
instance Core.FromJSON EnterpriseTopazSidekickRankingParams where
        parseJSON
          = Core.withObject "EnterpriseTopazSidekickRankingParams"
              (\ o ->
                 EnterpriseTopazSidekickRankingParams Core.<$>
                   (o Core..:? "endTimeMs" Core.<&> Core.fmap Core.fromAsText)
...
newEnterpriseTopazSidekickRecentDocumentsCardProto 
    :: 
                                                   EnterpriseTopazSidekickRecentDocumentsCardProto
newEnterpriseTopazSidekickRecentDocumentsCardProto
  = EnterpriseTopazSidekickRecentDocumentsCardProto{document =
                                                      Core.Nothing}
instance Core.FromJSON
           EnterpriseTopazSidekickRecentDocumentsCardProto
         where
        parseJSON
          = Core.withObject "EnterpriseTopazSidekickRecentDocumentsCardProto"
              (\ o ->
                 EnterpriseTopazSidekickRecentDocumentsCardProto Core.<$>
                   (o Core..:? "document"))
...
newEnterpriseTopazSidekickScheduledMeeting 
    :: 
                                           EnterpriseTopazSidekickScheduledMeeting
newEnterpriseTopazSidekickScheduledMeeting
  = EnterpriseTopazSidekickScheduledMeeting{meetingLocation =
                                              Core.Nothing,
                                            meetingTime = Core.Nothing, meetingTitle = Core.Nothing}
instance Core.FromJSON EnterpriseTopazSidekickScheduledMeeting
         where
        parseJSON
          = Core.withObject "EnterpriseTopazSidekickScheduledMeeting"
              (\ o ->
                 EnterpriseTopazSidekickScheduledMeeting Core.<$>
                   (o Core..:? "meetingLocation") Core.<*> (o Core..:? "meetingTime")
...
newEnterpriseTopazSidekickShareMeetingDocsCardProto 
    :: 
                                                    EnterpriseTopazSidekickShareMeetingDocsCardProto
newEnterpriseTopazSidekickShareMeetingDocsCardProto
  = EnterpriseTopazSidekickShareMeetingDocsCardProto{document =
                                                       Core.Nothing,
                                                     event = Core.Nothing}
instance Core.FromJSON
           EnterpriseTopazSidekickShareMeetingDocsCardProto
        ...
        parseJSON
          = Core.withObject
              "EnterpriseTopazSidekickShareMeetingDocsCardProto"
              (\ o ->
                 EnterpriseTopazSidekickShareMeetingDocsCardProto Core.<$>
                   (o Core..:? "document") Core.<*> (o Core..:? "event"))
...
newEnterpriseTopazSidekickTimeSlot 
    :: 
                                   EnterpriseTopazSidekickTimeSlot
newEnterpriseTopazSidekickTimeSlot
  = EnterpriseTopazSidekickTimeSlot{endTimeDay = Core.Nothing,
                                    endTimeHourAndMinute = Core.Nothing,
                                    endTimeInMillis = Core.Nothing, startTimeDay = Core.Nothing,
...
instance Core.FromJSON EnterpriseTopazSidekickTimeSlot where
        parseJSON
          = Core.withObject "EnterpriseTopazSidekickTimeSlot"
              (\ o ->
                 EnterpriseTopazSidekickTimeSlot Core.<$>
                   (o Core..:? "endTimeDay") Core.<*>
                     (o Core..:? "endTimeHourAndMinute")
                     Core.<*>
                     (o Core..:? "endTimeInMillis" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "startTimeDay")
                     Core.<*> (o Core..:? "startTimeHourAndMinute")
                     Core.<*>
                     (o Core..:? "startTimeInMillis" Core.<&>
                        Core.fmap Core.fromAsText))
...
instance Core.FromJSON EnumOperatorOptions where
        parseJSON
          = Core.withObject "EnumOperatorOptions"
...
newEnumPropertyOptions 
    ::  EnumPropertyOptions
newEnumPropertyOptions
  = EnumPropertyOptions{operatorOptions = Core.Nothing,
                        orderedRanking = Core.Nothing, possibleValues = Core.Nothing}
instance Core.FromJSON EnumPropertyOptions where
        parseJSON
          = Core.withObject "EnumPropertyOptions"
              (\ o ->
                 EnumPropertyOptions Core.<$>
                   (o Core..:? "operatorOptions") Core.<*>
                     (o Core..:? "orderedRanking")
...
newEnumValuePair 
    ::  EnumValuePair
newEnumValuePair
  = EnumValuePair{integerValue = Core.Nothing,
                  stringValue = Core.Nothing}
instance Core.FromJSON EnumValuePair where
        parseJSON
          = Core.withObject "EnumValuePair"
              (\ o ->
                 EnumValuePair Core.<$>
                   (o Core..:? "integerValue") Core.<*> (o Core..:? "stringValue"))
...
instance Core.FromJSON ErrorMessage where
        parseJSON
          = Core.withObject "ErrorMessage"
              (\ o ->
                 ErrorMessage Core.<$>
                   (o Core..:? "errorMessage") Core.<*> (o Core..:? "source"))
...
newFacetBucket 
    ::  FacetBucket
newFacetBucket
  = FacetBucket{count = Core.Nothing, filter = Core.Nothing,
                percentage = Core.Nothing, value = Core.Nothing}
instance Core.FromJSON FacetBucket where
        parseJSON
          = Core.withObject "FacetBucket"
              (\ o ->
                 FacetBucket Core.<$>
                   (o Core..:? "count") Core.<*> (o Core..:? "filter") Core.<*>
                     (o Core..:? "percentage")
                     Core.<*> (o Core..:? "value"))
...
newFacetOptions 
    ::  FacetOptions
newFacetOptions
  = FacetOptions{integerFacetingOptions = Core.Nothing,
                 numFacetBuckets = Core.Nothing, objectType = Core.Nothing,
                 operatorName = Core.Nothing, sourceName = Core.Nothing}
instance Core.FromJSON FacetOptions where
        parseJSON
          = Core.withObject "FacetOptions"
              (\ o ->
                 FacetOptions Core.<$>
                   (o Core..:? "integerFacetingOptions") Core.<*>
                     (o Core..:? "numFacetBuckets")
...
instance Core.ToJSON FacetOptions where
        toJSON FacetOptions{..}
          = Core.object
              (Core.catMaybes
                 [("integerFacetingOptions" Core..=) Core.<$>
                    integerFacetingOptions,
...
newFacetResult 
    ::  FacetResult
newFacetResult
  = FacetResult{buckets = Core.Nothing, objectType = Core.Nothing,
                operatorName = Core.Nothing, sourceName = Core.Nothing}
instance Core.FromJSON FacetResult where
        parseJSON
          = Core.withObject "FacetResult"
              (\ o ->
                 FacetResult Core.<$>
                   (o Core..:? "buckets") Core.<*> (o Core..:? "objectType") Core.<*>
                     (o Core..:? "operatorName")
                     Core.<*> (o Core..:? "sourceName"))
...
instance Core.FromJSON FieldViolation where
        parseJSON
          = Core.withObject "FieldViolation"
              (\ o ->
                 FieldViolation Core.<$>
                   (o Core..:? "description") Core.<*> (o Core..:? "field"))
...
instance Core.FromJSON Filter where
        parseJSON
          = Core.withObject "Filter"
              (\ o ->
                 Filter Core.<$>
                   (o Core..:? "compositeFilter") Core.<*> (o Core..:? "valueFilter"))
...
instance Core.FromJSON FilterOptions where
        parseJSON
          = Core.withObject "FilterOptions"
              (\ o ->
                 FilterOptions Core.<$>
                   (o Core..:? "filter") Core.<*> (o Core..:? "objectType"))
...
newFreshnessOptions 
    ::  FreshnessOptions
newFreshnessOptions
  = FreshnessOptions{freshnessDuration = Core.Nothing,
                     freshnessProperty = Core.Nothing}
instance Core.FromJSON FreshnessOptions where
        parseJSON
          = Core.withObject "FreshnessOptions"
              (\ o ->
                 FreshnessOptions Core.<$>
                   (o Core..:? "freshnessDuration") Core.<*>
                     (o Core..:? "freshnessProperty"))
...
newGSuitePrincipal 
    ::  GSuitePrincipal
newGSuitePrincipal
  = GSuitePrincipal{gsuiteDomain = Core.Nothing,
                    gsuiteGroupEmail = Core.Nothing, gsuiteUserEmail = Core.Nothing}
instance Core.FromJSON GSuitePrincipal where
        parseJSON
          = Core.withObject "GSuitePrincipal"
              (\ o ->
                 GSuitePrincipal Core.<$>
                   (o Core..:? "gsuiteDomain") Core.<*>
                     (o Core..:? "gsuiteGroupEmail")
...
newGetCustomerIndexStatsResponse 
    ::  GetCustomerIndexStatsResponse
newGetCustomerIndexStatsResponse
  = GetCustomerIndexStatsResponse{averageIndexedItemCount =
                                    Core.Nothing,
                                  stats = Core.Nothing}
instance Core.FromJSON GetCustomerIndexStatsResponse where
        parseJSON
          = Core.withObject "GetCustomerIndexStatsResponse"
              (\ o ->
                 GetCustomerIndexStatsResponse Core.<$>
                   (o Core..:? "averageIndexedItemCount" Core.<&>
                      Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "stats"))
...
instance Core.ToJSON GetCustomerIndexStatsResponse where
        toJSON GetCustomerIndexStatsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("averageIndexedItemCount" Core..=) Core.. Core.AsText Core.<$>
...
newGetCustomerQueryStatsResponse 
    ::  GetCustomerQueryStatsResponse
newGetCustomerQueryStatsResponse
  = GetCustomerQueryStatsResponse{stats = Core.Nothing,
                                  totalQueryCount = Core.Nothing}
instance Core.FromJSON GetCustomerQueryStatsResponse where
        parseJSON
          = Core.withObject "GetCustomerQueryStatsResponse"
              (\ o ->
                 GetCustomerQueryStatsResponse Core.<$>
                   (o Core..:? "stats") Core.<*>
                     (o Core..:? "totalQueryCount" Core.<&> Core.fmap Core.fromAsText))
...
instance Core.ToJSON GetCustomerQueryStatsResponse where
        toJSON GetCustomerQueryStatsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("stats" Core..=) Core.<$> stats,
                  ("totalQueryCount" Core..=) Core.. Core.AsText Core.<$>
                    totalQueryCount])
...
newGetCustomerSearchApplicationStatsResponse 
    :: 
                                             GetCustomerSearchApplicationStatsResponse
newGetCustomerSearchApplicationStatsResponse
  = GetCustomerSearchApplicationStatsResponse{averageSearchApplicationCount
                                                = Core.Nothing,
                                              stats = Core.Nothing}
instance Core.FromJSON GetCustomerSearchApplicationStatsResponse
         where
        parseJSON
          = Core.withObject "GetCustomerSearchApplicationStatsResponse"
              (\ o ->
                 GetCustomerSearchApplicationStatsResponse Core.<$>
                   (o Core..:? "averageSearchApplicationCount" Core.<&>
                      Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "stats"))

instance Core.ToJSON GetCustomerSearchApplicationStatsResponse
         where
        toJSON GetCustomerSearchApplicationStatsResponse{..}
          = Core.object
              (Core.catMaybes
                 [("averageSearchApplicationCount" Core..=) Core.. Core.AsText
...
instance Core.FromJSON GetCustomerSessionStatsResponse where
        parseJSON
          = Core.withObject "GetCustomerSessionStatsResponse"
              (\ o ->
...
instance Core.FromJSON GetCustomerUserStatsResponse where
        parseJSON
          = Core.withObject "GetCustomerUserStatsResponse"
...
newGetDataSourceIndexStatsResponse 
    :: 
                                   GetDataSourceIndexStatsResponse
newGetDataSourceIndexStatsResponse
  = GetDataSourceIndexStatsResponse{averageIndexedItemCount =
                                      Core.Nothing,
                                    stats = Core.Nothing}
instance Core.FromJSON GetDataSourceIndexStatsResponse where
        parseJSON
          = Core.withObject "GetDataSourceIndexStatsResponse"
              (\ o ->
                 GetDataSourceIndexStatsResponse Core.<$>
                   (o Core..:? "averageIndexedItemCount" Core.<&>
                      Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "stats"))
...
newGetSearchApplicationQueryStatsResponse 
    :: 
                                          GetSearchApplicationQueryStatsResponse
newGetSearchApplicationQueryStatsResponse
  = GetSearchApplicationQueryStatsResponse{stats = Core.Nothing,
                                           totalQueryCount = Core.Nothing}
instance Core.FromJSON GetSearchApplicationQueryStatsResponse where
        parseJSON
          = Core.withObject "GetSearchApplicationQueryStatsResponse"
              (\ o ->
                 GetSearchApplicationQueryStatsResponse Core.<$>
                   (o Core..:? "stats") Core.<*>
                     (o Core..:? "totalQueryCount" Core.<&> Core.fmap Core.fromAsText))
...
instance Core.FromJSON GetSearchApplicationSessionStatsResponse
         where
        parseJSON
          = Core.withObject "GetSearchApplicationSessionStatsResponse"
              (\ o ->
                 GetSearchApplicationSessionStatsResponse Core.<$>
                   (o Core..:? "stats"))
...
instance Core.FromJSON GetSearchApplicationUserStatsResponse where
        parseJSON
          = Core.withObject "GetSearchApplicationUserStatsResponse"
              (\ o ->
                 GetSearchApplicationUserStatsResponse Core.<$>
                   (o Core..:? "stats"))
...
instance Core.FromJSON HtmlOperatorOptions where
        parseJSON
          = Core.withObject "HtmlOperatorOptions"
...
newHtmlPropertyOptions 
    ::  HtmlPropertyOptions
newHtmlPropertyOptions
  = HtmlPropertyOptions{operatorOptions = Core.Nothing,
                        retrievalImportance = Core.Nothing}
instance Core.FromJSON HtmlPropertyOptions where
        parseJSON
          = Core.withObject "HtmlPropertyOptions"
              (\ o ->
                 HtmlPropertyOptions Core.<$>
                   (o Core..:? "operatorOptions") Core.<*>
                     (o Core..:? "retrievalImportance"))
...
instance Core.FromJSON IndexItemOptions where
        parseJSON
          = Core.withObject "IndexItemOptions"
              (\ o ->
                 IndexItemOptions Core.<$>
                   (o Core..:? "allowUnknownGsuitePrincipals"))

instance Core.ToJSON IndexItemOptions where
        toJSON IndexItemOptions{..}
          = Core.object
              (Core.catMaybes
                 [("allowUnknownGsuitePrincipals" Core..=) Core.<$>
...
newIndexItemRequest 
    ::  IndexItemRequest
newIndexItemRequest
  = IndexItemRequest{connectorName = Core.Nothing,
                     debugOptions = Core.Nothing, indexItemOptions = Core.Nothing,
                     item = Core.Nothing, mode = Core.Nothing}
instance Core.FromJSON IndexItemRequest where
        parseJSON
          = Core.withObject "IndexItemRequest"
              (\ o ->
                 IndexItemRequest Core.<$>
                   (o Core..:? "connectorName") Core.<*> (o Core..:? "debugOptions")
          ...
          = Core.object
              (Core.catMaybes
                 [("connectorName" Core..=) Core.<$> connectorName,
                  ...
                  ("item" Core..=) Core.<$> item, ("mode" Core..=) Core.<$> mode])
...
instance Core.FromJSON InitializeCustomerRequest where
        parseJSON
          = Core.withObject "InitializeCustomerRequest"
...
instance Core.FromJSON IntegerFacetingOptions where
        parseJSON
          = Core.withObject "IntegerFacetingOptions"
              (\ o ->
                 IntegerFacetingOptions Core.<$>
                   (o Core..:? "integerBuckets" Core.<&>
...
instance Core.ToJSON IntegerFacetingOptions where
        toJSON IntegerFacetingOptions{..}
          = Core.object
              (Core.catMaybes
                 [("integerBuckets" Core..=) Core.. Core.fmap Core.AsText Core.<$>
                    integerBuckets])
...
newIntegerOperatorOptions 
    ::  IntegerOperatorOptions
newIntegerOperatorOptions
  = IntegerOperatorOptions{greaterThanOperatorName = Core.Nothing,
                           lessThanOperatorName = Core.Nothing, operatorName = Core.Nothing}
instance Core.FromJSON IntegerOperatorOptions where
        parseJSON
          = Core.withObject "IntegerOperatorOptions"
              (\ o ->
                 IntegerOperatorOptions Core.<$>
                   (o Core..:? "greaterThanOperatorName") Core.<*>
                     (o Core..:? "lessThanOperatorName")
                     Core.<*> (o Core..:? "operatorName"))
...
newIntegerPropertyOptions 
    ::  IntegerPropertyOptions
newIntegerPropertyOptions
  = IntegerPropertyOptions{integerFacetingOptions = Core.Nothing,
                           maximumValue = Core.Nothing, minimumValue = Core.Nothing,
                           operatorOptions = Core.Nothing, orderedRanking = Core.Nothing}
instance Core.FromJSON IntegerPropertyOptions where
        parseJSON
          = Core.withObject "IntegerPropertyOptions"
              (\ o ->
                 IntegerPropertyOptions Core.<$>
                   (o Core..:? "integerFacetingOptions") Core.<*>
                     (o Core..:? "maximumValue" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "minimumValue" Core.<&> Core.fmap Core.fromAsText)
...
newInteraction 
    ::  Interaction
newInteraction
  = Interaction{interactionTime = Core.Nothing,
                principal = Core.Nothing, type' = Core.Nothing}
instance Core.FromJSON Interaction where
        parseJSON
          = Core.withObject "Interaction"
              (\ o ->
                 Interaction Core.<$>
                   (o Core..:? "interactionTime") Core.<*> (o Core..:? "principal")
                     Core.<*> (o Core..:? "type"))
...
newItem 
    ::  Item
newItem
  = Item{acl = Core.Nothing, content = Core.Nothing,
         itemType = Core.Nothing, metadata = Core.Nothing,
         name = Core.Nothing, payload = Core.Nothing, queue = Core.Nothing,
         status = Core.Nothing, structuredData = Core.Nothing,
...
instance Core.FromJSON Item where
        parseJSON
          = Core.withObject "Item"
              (\ o ->
                 Item Core.<$>
                   (o Core..:? "acl") Core.<*> (o Core..:? "content") Core.<*>
                     (o Core..:? "itemType")
...
newItemAcl 
    ::  ItemAcl
newItemAcl
  = ItemAcl{aclInheritanceType = Core.Nothing,
            deniedReaders = Core.Nothing, inheritAclFrom = Core.Nothing,
            owners = Core.Nothing, readers = Core.Nothing}
instance Core.FromJSON ItemAcl where
        parseJSON
          = Core.withObject "ItemAcl"
              (\ o ->
                 ItemAcl Core.<$>
                   (o Core..:? "aclInheritanceType") Core.<*>
                     (o Core..:? "deniedReaders")
...
newItemContent 
    ::  ItemContent
newItemContent
  = ItemContent{contentDataRef = Core.Nothing,
                contentFormat = Core.Nothing, hash = Core.Nothing,
                inlineContent = Core.Nothing}
instance Core.FromJSON ItemContent where
        parseJSON
          = Core.withObject "ItemContent"
              (\ o ->
                 ItemContent Core.<$>
                   (o Core..:? "contentDataRef") Core.<*> (o Core..:? "contentFormat")
                     Core.<*> (o Core..:? "hash")
...
newItemCountByStatus 
    ::  ItemCountByStatus
newItemCountByStatus
  = ItemCountByStatus{count = Core.Nothing,
                      indexedItemsCount = Core.Nothing, statusCode = Core.Nothing}
instance Core.FromJSON ItemCountByStatus where
        parseJSON
          = Core.withObject "ItemCountByStatus"
              (\ o ->
                 ItemCountByStatus Core.<$>
                   (o Core..:? "count" Core.<&> Core.fmap Core.fromAsText) Core.<*>
                     (o Core..:? "indexedItemsCount" Core.<&> Core.fmap Core.fromAsText)
...
instance Core.ToJSON ItemCountByStatus where
        toJSON ItemCountByStatus{..}
          = Core.object
              (Core.catMaybes
                 [("count" Core..=) Core.. Core.AsText Core.<$> count,
                  ("indexedItemsCount" Core..=) Core.. Core.AsText Core.<$>
                    indexedItemsCount,
...
newItemMetadata 
    ::  ItemMetadata
newItemMetadata
  = ItemMetadata{containerName = Core.Nothing,
                 contentLanguage = Core.Nothing, contextAttributes = Core.Nothing,
                 createTime = Core.Nothing, hash = Core.Nothing,
                 interactions = Core.Nothing, keywords = Core.Nothing,
                 mimeType = Core.Nothing, objectType = Core.Nothing,
                 searchQualityMetadata = Core.Nothing,
                 sourceRepositoryUrl = Core.Nothing, title = Core.Nothing,
                 updateTime = Core.Nothing}
instance Core.FromJSON ItemMetadata where
        parseJSON
          = Core.withObject "ItemMetadata"
              (\ o ->
                 ItemMetadata Core.<$>
...
newItemStatus 
    ::  ItemStatus
newItemStatus
  = ItemStatus{code = Core.Nothing, processingErrors = Core.Nothing,
               repositoryErrors = Core.Nothing}
instance Core.FromJSON ItemStatus where
        parseJSON
          = Core.withObject "ItemStatus"
              (\ o ->
                 ItemStatus Core.<$>
                   (o Core..:? "code") Core.<*> (o Core..:? "processingErrors")
...
instance Core.FromJSON ItemStructuredData where
        parseJSON
          = Core.withObject "ItemStructuredData"
              (\ o ->
                 ItemStructuredData Core.<$>
                   (o Core..:? "hash") Core.<*> (o Core..:? "object"))
...
newListDataSourceResponse 
    ::  ListDataSourceResponse
newListDataSourceResponse
  = ListDataSourceResponse{nextPageToken = Core.Nothing,
                           sources = Core.Nothing}
instance Core.FromJSON ListDataSourceResponse where
        parseJSON
          = Core.withObject "ListDataSourceResponse"
              (\ o ->
                 ListDataSourceResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "sources"))
...
newListItemNamesForUnmappedIdentityResponse 
    :: 
                                            ListItemNamesForUnmappedIdentityResponse
newListItemNamesForUnmappedIdentityResponse
  = ListItemNamesForUnmappedIdentityResponse{itemNames =
                                               Core.Nothing,
                                             nextPageToken = Core.Nothing}
instance Core.FromJSON ListItemNamesForUnmappedIdentityResponse
         where
        parseJSON
          = Core.withObject "ListItemNamesForUnmappedIdentityResponse"
              (\ o ->
                 ListItemNamesForUnmappedIdentityResponse Core.<$>
                   (o Core..:? "itemNames") Core.<*> (o Core..:? "nextPageToken"))
...
instance Core.FromJSON ListItemsResponse where
        parseJSON
          = Core.withObject "ListItemsResponse"
              (\ o ->
                 ListItemsResponse Core.<$>
                   (o Core..:? "items") Core.<*> (o Core..:? "nextPageToken"))
...
newListQuerySourcesResponse 
    ::  ListQuerySourcesResponse
newListQuerySourcesResponse
  = ListQuerySourcesResponse{nextPageToken = Core.Nothing,
                             sources = Core.Nothing}
instance Core.FromJSON ListQuerySourcesResponse where
        parseJSON
          = Core.withObject "ListQuerySourcesResponse"
              (\ o ->
                 ListQuerySourcesResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*> (o Core..:? "sources"))
...
newListSearchApplicationsResponse 
    ::  ListSearchApplicationsResponse
newListSearchApplicationsResponse
  = ListSearchApplicationsResponse{nextPageToken = Core.Nothing,
                                   searchApplications = Core.Nothing}
instance Core.FromJSON ListSearchApplicationsResponse where
        parseJSON
          = Core.withObject "ListSearchApplicationsResponse"
              (\ o ->
                 ListSearchApplicationsResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "searchApplications"))
...
newListUnmappedIdentitiesResponse 
    ::  ListUnmappedIdentitiesResponse
newListUnmappedIdentitiesResponse
  = ListUnmappedIdentitiesResponse{nextPageToken = Core.Nothing,
                                   unmappedIdentities = Core.Nothing}
instance Core.FromJSON ListUnmappedIdentitiesResponse where
        parseJSON
          = Core.withObject "ListUnmappedIdentitiesResponse"
              (\ o ->
                 ListUnmappedIdentitiesResponse Core.<$>
                   (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "unmappedIdentities"))
...
newMapInfo 
    ::  MapInfo
newMapInfo
  = MapInfo{lat = Core.Nothing, locationUrl = Core.Nothing,
            long = Core.Nothing, mapTile = Core.Nothing, zoom = Core.Nothing}
instance Core.FromJSON MapInfo where
        parseJSON
          = Core.withObject "MapInfo"
              (\ o ->
                 MapInfo Core.<$>
                   (o Core..:? "lat") Core.<*> (o Core..:? "locationUrl") Core.<*>
                     (o Core..:? "long")
                     Core.<*> (o Core..:? "mapTile")
                     Core.<*> (o Core..:? "zoom"))
...
newMapTile 
    ::  MapTile
newMapTile
  = MapTile{imageUrl = Core.Nothing, tileX = Core.Nothing,
            tileY = Core.Nothing}
instance Core.FromJSON MapTile where
        parseJSON
          = Core.withObject "MapTile"
              (\ o ->
                 MapTile Core.<$>
                   (o Core..:? "imageUrl") Core.<*> (o Core..:? "tileX") Core.<*>
                     (o Core..:? "tileY"))
...
newMetadata 
    ::  Metadata
newMetadata
  = Metadata{createTime = Core.Nothing,
             displayOptions = Core.Nothing, fields = Core.Nothing,
             mimeType = Core.Nothing, objectType = Core.Nothing,
             owner = Core.Nothing, source = Core.Nothing,
             thumbnailUrl = Core.Nothing, updateTime = Core.Nothing}
instance Core.FromJSON Metadata where
        parseJSON
          = Core.withObject "Metadata"
              (\ o ->
                 Metadata Core.<$>
                   (o Core..:? "createTime") Core.<*> (o Core..:? "displayOptions")
                     Core.<*> (o Core..:? "fields")
                     Core.<*> (o Core..:? "mimeType")
                     Core.<*> (o Core..:? "objectType")
                     Core.<*> (o Core..:? "owner")
...
newNamedProperty 
    ::  NamedProperty
newNamedProperty
  = NamedProperty{booleanValue = Core.Nothing,
                  dateValues = Core.Nothing, doubleValues = Core.Nothing,
                  enumValues = Core.Nothing, htmlValues = Core.Nothing,
                  integerValues = Core.Nothing, name = Core.Nothing,
                  objectValues = Core.Nothing, textValues = Core.Nothing,
                  timestampValues = Core.Nothing}
instance Core.FromJSON NamedProperty where
        parseJSON
          = Core.withObject "NamedProperty"
              (\ o ->
                 NamedProperty Core.<$>
                   (o Core..:? "booleanValue") Core.<*> (o Core..:? "dateValues")
...
newObjectDefinition 
    ::  ObjectDefinition
newObjectDefinition
  = ObjectDefinition{name = Core.Nothing, options = Core.Nothing,
                     propertyDefinitions = Core.Nothing}
instance Core.FromJSON ObjectDefinition where
        parseJSON
          = Core.withObject "ObjectDefinition"
              (\ o ->
                 ObjectDefinition Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "options") Core.<*>
                     (o Core..:? "propertyDefinitions"))
...
newObjectDisplayOptions 
    ::  ObjectDisplayOptions
newObjectDisplayOptions
  = ObjectDisplayOptions{metalines = Core.Nothing,
                         objectDisplayLabel = Core.Nothing}
instance Core.FromJSON ObjectDisplayOptions where
        parseJSON
          = Core.withObject "ObjectDisplayOptions"
              (\ o ->
                 ObjectDisplayOptions Core.<$>
                   (o Core..:? "metalines") Core.<*>
                     (o Core..:? "objectDisplayLabel"))
...
newObjectOptions 
    ::  ObjectOptions
newObjectOptions
  = ObjectOptions{displayOptions = Core.Nothing,
                  freshnessOptions = Core.Nothing,
                  suggestionFilteringOperators = Core.Nothing}
instance Core.FromJSON ObjectOptions where
        parseJSON
          = Core.withObject "ObjectOptions"
              (\ o ->
                 ObjectOptions Core.<$>
                   (o Core..:? "displayOptions") Core.<*>
                     (o Core..:? "freshnessOptions")
          ...
          = Core.object
              (Core.catMaybes
                 [("displayOptions" Core..=) Core.<$> displayOptions,
                  ...
                  ("suggestionFilteringOperators" Core..=) Core.<$>
...
instance Core.FromJSON ObjectPropertyOptions where
        parseJSON
          = Core.withObject "ObjectPropertyOptions"
              (\ o ->
...
instance Core.FromJSON PeoplePromotionCard where
        parseJSON
          = Core.withObject "PeoplePromotionCard"
...
instance Core.FromJSON PeopleSuggestion where
        parseJSON
          = Core.withObject "PeopleSuggestion"
...
newPerson 
    ::  Person
newPerson
  = Person{emailAddresses = Core.Nothing, name = Core.Nothing,
           obfuscatedId = Core.Nothing, personNames = Core.Nothing,
           phoneNumbers = Core.Nothing, photos = Core.Nothing}
instance Core.FromJSON Person where
        parseJSON
          = Core.withObject "Person"
              (\ o ->
                 Person Core.<$>
                   (o Core..:? "emailAddresses") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "obfuscatedId")
...
newPersonCore 
    ::  PersonCore
newPersonCore
  = PersonCore{addressMeAs = Core.Nothing, adminTo = Core.Nothing,
               admins = Core.Nothing, availabilityStatus = Core.Nothing,
               birthday = Core.Nothing, calendarUrl = Core.Nothing,
               chatUrl = Core.Nothing, costCenter = Core.Nothing,
               department = Core.Nothing, directReports = Core.Nothing,
               dottedLineManagers = Core.Nothing,
               dottedLineReports = Core.Nothing, emails = Core.Nothing,
               employeeId = Core.Nothing, fingerprint = Core.Nothing,
               ftePermille = Core.Nothing, geoLocation = Core.Nothing,
               gmailUrl = Core.Nothing, jobTitle = Core.Nothing,
               keywordTypes = Core.Nothing, keywords = Core.Nothing,
               links = Core.Nothing, location = Core.Nothing,
               managers = Core.Nothing, mission = Core.Nothing,
               name = Core.Nothing, officeLocation = Core.Nothing,
               personId = Core.Nothing, phoneNumbers = Core.Nothing,
               photoUrl = Core.Nothing, postalAddress = Core.Nothing,
               totalDirectReportsCount = Core.Nothing,
               totalDlrCount = Core.Nothing, totalFteCount = Core.Nothing,
               username = Core.Nothing, waldoComeBackTime = Core.Nothing}
instance Core.FromJSON PersonCore where
        parseJSON
          = Core.withObject "PersonCore"
              (\ o ->
                 PersonCore Core.<$>
                   (o Core..:? "addressMeAs") Core.<*> (o Core..:? "adminTo") Core.<*>
                     (o Core..:? "admins")
                     ...
                     Core.<*>
                     (o Core..:? "ftePermille" Core.<&> Core.fmap Core.fromAsText)
                     ...
                     Core.<*>
                     (o Core..:? "totalFteCount" Core.<&> Core.fmap Core.fromAsText)
          ...
          = Core.object
              (Core.catMaybes
                 [("addressMeAs" Core..=) Core.<$> addressMeAs,
                  ...
                  ("totalDirectReportsCount" Core..=) Core.<$>
                    totalDirectReportsCount,
                  ("totalDlrCount" Core..=) Core.<$> totalDlrCount,
                  ("totalFteCount" Core..=) Core.. Core.AsText Core.<$>
                    totalFteCount,
...
instance Core.FromJSON PersonCore_Keywords where
        parseJSON
          = Core.withObject "PersonCore_Keywords"
...
instance Core.FromJSON PhoneNumber where
        parseJSON
          = Core.withObject "PhoneNumber"
              (\ o ->
                 PhoneNumber Core.<$>
                   (o Core..:? "phoneNumber") Core.<*> (o Core..:? "type"))
...
newPollItemsRequest 
    ::  PollItemsRequest
newPollItemsRequest
  = PollItemsRequest{connectorName = Core.Nothing,
                     debugOptions = Core.Nothing, limit = Core.Nothing,
                     queue = Core.Nothing, statusCodes = Core.Nothing}
instance Core.FromJSON PollItemsRequest where
        parseJSON
          = Core.withObject "PollItemsRequest"
              (\ o ->
                 PollItemsRequest Core.<$>
                   (o Core..:? "connectorName") Core.<*> (o Core..:? "debugOptions")
                     Core.<*> (o Core..:? "limit")
                     Core.<*> (o Core..:? "queue")
        ...
        toJSON PollItemsRequest{..}
          = Core.object
              (Core.catMaybes
                 [("connectorName" Core..=) Core.<$> connectorName,
                  ("debugOptions" Core..=) Core.<$> debugOptions,
                  ("limit" Core..=) Core.<$> limit, ("queue" Core..=) Core.<$> queue,
...
instance Core.FromJSON PollItemsResponse where
        parseJSON
          = Core.withObject "PollItemsResponse"
...
newPrincipal 
    ::  Principal
newPrincipal
  = Principal{groupResourceName = Core.Nothing,
              gsuitePrincipal = Core.Nothing, userResourceName = Core.Nothing}
instance Core.FromJSON Principal where
        parseJSON
          = Core.withObject "Principal"
              (\ o ->
                 Principal Core.<$>
                   (o Core..:? "groupResourceName") Core.<*>
                     (o Core..:? "gsuitePrincipal")
...
newProcessingError 
    ::  ProcessingError
newProcessingError
  = ProcessingError{code = Core.Nothing, errorMessage = Core.Nothing,
                    fieldViolations = Core.Nothing}
instance Core.FromJSON ProcessingError where
        parseJSON
          = Core.withObject "ProcessingError"
              (\ o ->
                 ProcessingError Core.<$>
                   (o Core..:? "code") Core.<*> (o Core..:? "errorMessage") Core.<*>
                     (o Core..:? "fieldViolations"))
...
newPropertyDefinition 
    ::  PropertyDefinition
newPropertyDefinition
  = PropertyDefinition{booleanPropertyOptions = Core.Nothing,
                       datePropertyOptions = Core.Nothing, displayOptions = Core.Nothing,
                       doublePropertyOptions = Core.Nothing,
                       enumPropertyOptions = Core.Nothing,
                       htmlPropertyOptions = Core.Nothing,
                       integerPropertyOptions = Core.Nothing, isFacetable = Core.Nothing,
                       isRepeatable = Core.Nothing, isReturnable = Core.Nothing,
                       isSortable = Core.Nothing, isSuggestable = Core.Nothing,
                       isWildcardSearchable = Core.Nothing, name = Core.Nothing,
...
instance Core.FromJSON PropertyDefinition where
        parseJSON
          = Core.withObject "PropertyDefinition"
              (\ o ->
                 PropertyDefinition Core.<$>
                   (o Core..:? "booleanPropertyOptions") Core.<*>
                     (o Core..:? "datePropertyOptions")
...
instance Core.ToJSON PropertyDefinition where
        toJSON PropertyDefinition{..}
          = Core.object
              (Core.catMaybes
                 [("booleanPropertyOptions" Core..=) Core.<$>
                    booleanPropertyOptions,
                  ...
                  ("timestampPropertyOptions" Core..=) Core.<$>
                    timestampPropertyOptions])
...
instance Core.FromJSON PropertyDisplayOptions where
        parseJSON
          = Core.withObject "PropertyDisplayOptions"
              (\ o ->
...
newPushItem 
    ::  PushItem
newPushItem
  = PushItem{contentHash = Core.Nothing, metadataHash = Core.Nothing,
             payload = Core.Nothing, queue = Core.Nothing,
             repositoryError = Core.Nothing, structuredDataHash = Core.Nothing,
             type' = Core.Nothing}
instance Core.FromJSON PushItem where
        parseJSON
          = Core.withObject "PushItem"
              (\ o ->
                 PushItem Core.<$>
                   (o Core..:? "contentHash") Core.<*> (o Core..:? "metadataHash")
                     Core.<*> (o Core..:? "payload")
                     Core.<*> (o Core..:? "queue")
...
newPushItemRequest 
    ::  PushItemRequest
newPushItemRequest
  = PushItemRequest{connectorName = Core.Nothing,
                    debugOptions = Core.Nothing, item = Core.Nothing}
instance Core.FromJSON PushItemRequest where
        parseJSON
          = Core.withObject "PushItemRequest"
              (\ o ->
                 PushItemRequest Core.<$>
                   (o Core..:? "connectorName") Core.<*> (o Core..:? "debugOptions")
                     Core.<*> (o Core..:? "item"))
...
newQueryCountByStatus 
    ::  QueryCountByStatus
newQueryCountByStatus
  = QueryCountByStatus{count = Core.Nothing,
                       statusCode = Core.Nothing}
instance Core.FromJSON QueryCountByStatus where
        parseJSON
          = Core.withObject "QueryCountByStatus"
              (\ o ->
...
newQueryInterpretation 
    ::  QueryInterpretation
newQueryInterpretation
  = QueryInterpretation{interpretationType = Core.Nothing,
                        interpretedQuery = Core.Nothing, reason = Core.Nothing}
instance Core.FromJSON QueryInterpretation where
        parseJSON
          = Core.withObject "QueryInterpretation"
              (\ o ->
                 QueryInterpretation Core.<$>
                   (o Core..:? "interpretationType") Core.<*>
                     (o Core..:? "interpretedQuery")
                     Core.<*> (o Core..:? "reason"))
...
newQueryInterpretationConfig 
    ::  QueryInterpretationConfig
newQueryInterpretationConfig
  = QueryInterpretationConfig{forceDisableSupplementalResults =
                                Core.Nothing,
                              forceVerbatimMode = Core.Nothing}
instance Core.FromJSON QueryInterpretationConfig where
        parseJSON
          = Core.withObject "QueryInterpretationConfig"
              (\ o ->
                 QueryInterpretationConfig Core.<$>
                   (o Core..:? "forceDisableSupplementalResults") Core.<*>
                     (o Core..:? "forceVerbatimMode"))

instance Core.ToJSON QueryInterpretationConfig where
        toJSON QueryInterpretationConfig{..}
          = Core.object
              (Core.catMaybes
                 [("forceDisableSupplementalResults" Core..=) Core.<$>
...
instance Core.FromJSON QueryInterpretationOptions where
        parseJSON
          = Core.withObject "QueryInterpretationOptions"
              (\ o ->
                 QueryInterpretationOptions Core.<$>
                   (o Core..:? "disableNlInterpretation") Core.<*>
                     (o Core..:? "disableSupplementalResults")
...
instance Core.ToJSON QueryInterpretationOptions where
        toJSON QueryInterpretationOptions{..}
          = Core.object
              (Core.catMaybes
                 [("disableNlInterpretation" Core..=) Core.<$>
                    disableNlInterpretation,
                  ("disableSupplementalResults" Core..=) Core.<$>
...
newQueryOperator 
    ::  QueryOperator
newQueryOperator
  = QueryOperator{displayName = Core.Nothing,
                  enumValues = Core.Nothing, greaterThanOperatorName = Core.Nothing,
                  isFacetable = Core.Nothing, isRepeatable = Core.Nothing,
                  isReturnable = Core.Nothing, isSortable = Core.Nothing,
                  isSuggestable = Core.Nothing, lessThanOperatorName = Core.Nothing,
                  objectType = Core.Nothing, operatorName = Core.Nothing,
                  type' = Core.Nothing}
instance Core.FromJSON QueryOperator where
        parseJSON
          = Core.withObject "QueryOperator"
              (\ o ->
                 QueryOperator Core.<$>
                   (o Core..:? "displayName") Core.<*> (o Core..:? "enumValues")
...
newQuerySource 
    ::  QuerySource
newQuerySource
  = QuerySource{displayName = Core.Nothing, operators = Core.Nothing,
                shortName = Core.Nothing, source = Core.Nothing}
instance Core.FromJSON QuerySource where
        parseJSON
          = Core.withObject "QuerySource"
              (\ o ->
                 QuerySource Core.<$>
                   (o Core..:? "displayName") Core.<*> (o Core..:? "operators")
                     Core.<*> (o Core..:? "shortName")
                     Core.<*> (o Core..:? "source"))
...
instance Core.FromJSON QuerySuggestion where
        parseJSON
          = Core.withObject "QuerySuggestion"
...
newRemoveActivityRequest 
    ::  RemoveActivityRequest
newRemoveActivityRequest
  = RemoveActivityRequest{requestOptions = Core.Nothing,
                          userActivity = Core.Nothing}
instance Core.FromJSON RemoveActivityRequest where
        parseJSON
          = Core.withObject "RemoveActivityRequest"
              (\ o ->
                 RemoveActivityRequest Core.<$>
                   (o Core..:? "requestOptions") Core.<*> (o Core..:? "userActivity"))
...
instance Core.FromJSON RemoveActivityResponse where
        parseJSON
          = Core.withObject "RemoveActivityResponse"
...
newRepositoryError 
    ::  RepositoryError
newRepositoryError
  = RepositoryError{errorMessage = Core.Nothing,
                    httpStatusCode = Core.Nothing, type' = Core.Nothing}
instance Core.FromJSON RepositoryError where
        parseJSON
          = Core.withObject "RepositoryError"
              (\ o ->
                 RepositoryError Core.<$>
                   (o Core..:? "errorMessage") Core.<*> (o Core..:? "httpStatusCode")
                     Core.<*> (o Core..:? "type"))
...
newRequestOptions 
    ::  RequestOptions
newRequestOptions
  = RequestOptions{debugOptions = Core.Nothing,
                   languageCode = Core.Nothing, searchApplicationId = Core.Nothing,
...
instance Core.FromJSON RequestOptions where
        parseJSON
          = Core.withObject "RequestOptions"
              (\ o ->
                 RequestOptions Core.<$>
                   (o Core..:? "debugOptions") Core.<*> (o Core..:? "languageCode")
...
instance Core.FromJSON ResetSearchApplicationRequest where
        parseJSON
          = Core.withObject "ResetSearchApplicationRequest"
              (\ o ->
...
instance Core.FromJSON ResponseDebugInfo where
        parseJSON
          = Core.withObject "ResponseDebugInfo"
              (\ o ->
...
newRestrictItem 
    ::  RestrictItem
newRestrictItem
  = RestrictItem{driveFollowUpRestrict = Core.Nothing,
...
instance Core.FromJSON RestrictItem where
        parseJSON
          = Core.withObject "RestrictItem"
              (\ o ->
                 RestrictItem Core.<$>
                   (o Core..:? "driveFollowUpRestrict") Core.<*>
                     (o Core..:? "driveLocationRestrict")
...
instance Core.FromJSON ResultDebugInfo where
        parseJSON
          = Core.withObject "ResultDebugInfo"
...
newResultDisplayField 
    ::  ResultDisplayField
newResultDisplayField
  = ResultDisplayField{label = Core.Nothing,
                       operatorName = Core.Nothing, property = Core.Nothing}
instance Core.FromJSON ResultDisplayField where
        parseJSON
          = Core.withObject "ResultDisplayField"
              (\ o ->
                 ResultDisplayField Core.<$>
                   (o Core..:? "label") Core.<*> (o Core..:? "operatorName") Core.<*>
                     (o Core..:? "property"))
...
instance Core.FromJSON ResultDisplayLine where
        parseJSON
          = Core.withObject "ResultDisplayLine"
...
newResultDisplayMetadata 
    ::  ResultDisplayMetadata
newResultDisplayMetadata
  = ResultDisplayMetadata{metalines = Core.Nothing,
                          objectTypeLabel = Core.Nothing}
instance Core.FromJSON ResultDisplayMetadata where
        parseJSON
          = Core.withObject "ResultDisplayMetadata"
              (\ o ->
                 ResultDisplayMetadata Core.<$>
                   (o Core..:? "metalines") Core.<*> (o Core..:? "objectTypeLabel"))
...
instance Core.FromJSON RetrievalImportance where
        parseJSON
          = Core.withObject "RetrievalImportance"
...
newSafeHtmlProto 
    ::  SafeHtmlProto
newSafeHtmlProto
  = SafeHtmlProto{privateDoNotAccessOrElseSafeHtmlWrappedValue =
                    Core.Nothing}
instance Core.FromJSON SafeHtmlProto where
        parseJSON
          = Core.withObject "SafeHtmlProto"
              (\ o ->
                 SafeHtmlProto Core.<$>
                   (o Core..:? "privateDoNotAccessOrElseSafeHtmlWrappedValue"))

instance Core.ToJSON SafeHtmlProto where
        toJSON SafeHtmlProto{..}
          = Core.object
              (Core.catMaybes
                 [("privateDoNotAccessOrElseSafeHtmlWrappedValue" Core..=) Core.<$>
...
newSafeUrlProto 
    ::  SafeUrlProto
newSafeUrlProto
  = SafeUrlProto{privateDoNotAccessOrElseSafeUrlWrappedValue =
                   Core.Nothing}
instance Core.FromJSON SafeUrlProto where
        parseJSON
          = Core.withObject "SafeUrlProto"
              (\ o ->
                 SafeUrlProto Core.<$>
                   (o Core..:? "privateDoNotAccessOrElseSafeUrlWrappedValue"))

instance Core.ToJSON SafeUrlProto where
        toJSON SafeUrlProto{..}
          = Core.object
              (Core.catMaybes
                 [("privateDoNotAccessOrElseSafeUrlWrappedValue" Core..=) Core.<$>
...
newSchema 
    ::  Schema
newSchema
  = Schema{objectDefinitions = Core.Nothing,
...
newScoringConfig 
    ::  ScoringConfig
newScoringConfig
  = ScoringConfig{disableFreshness = Core.Nothing,
                  disablePersonalization = Core.Nothing}
instance Core.FromJSON ScoringConfig where
        parseJSON
          = Core.withObject "ScoringConfig"
              (\ o ->
                 ScoringConfig Core.<$>
                   (o Core..:? "disableFreshness") Core.<*>
                     (o Core..:? "disablePersonalization"))
          ...
          = Core.object
              (Core.catMaybes
                 [("disableFreshness" Core..=) Core.<$> disableFreshness,
                  ("disablePersonalization" Core..=) Core.<$>
...
newSearchApplication 
    ::  SearchApplication
newSearchApplication
  = SearchApplication{dataSourceRestrictions = Core.Nothing,
                      defaultFacetOptions = Core.Nothing,
                      defaultSortOptions = Core.Nothing, displayName = Core.Nothing,
                      enableAuditLog = Core.Nothing, name = Core.Nothing,
                      operationIds = Core.Nothing,
                      queryInterpretationConfig = Core.Nothing,
                      returnResultThumbnailUrls = Core.Nothing,
                      scoringConfig = Core.Nothing, sourceConfig = Core.Nothing}
instance Core.FromJSON SearchApplication where
        parseJSON
          = Core.withObject "SearchApplication"
              (\ o ->
                 SearchApplication Core.<$>
                   (o Core..:? "dataSourceRestrictions") Core.<*>
                     (o Core..:? "defaultFacetOptions")
...
instance Core.ToJSON SearchApplication where
        toJSON SearchApplication{..}
          = Core.object
              (Core.catMaybes
                 [("dataSourceRestrictions" Core..=) Core.<$>
                  ...
                  ("name" Core..=) Core.<$> name,
                  ("operationIds" Core..=) Core.<$> operationIds,
                  ("queryInterpretationConfig" Core..=) Core.<$>
                    queryInterpretationConfig,
                  ("returnResultThumbnailUrls" Core..=) Core.<$>
...
newSearchApplicationQueryStats 
    ::  SearchApplicationQueryStats
newSearchApplicationQueryStats
  = SearchApplicationQueryStats{date = Core.Nothing,
                                queryCountByStatus = Core.Nothing}
instance Core.FromJSON SearchApplicationQueryStats where
        parseJSON
          = Core.withObject "SearchApplicationQueryStats"
              (\ o ->
                 SearchApplicationQueryStats Core.<$>
                   (o Core..:? "date") Core.<*> (o Core..:? "queryCountByStatus"))
...
newSearchApplicationSessionStats 
    ::  SearchApplicationSessionStats
newSearchApplicationSessionStats
  = SearchApplicationSessionStats{date = Core.Nothing,
                                  searchSessionsCount = Core.Nothing}
instance Core.FromJSON SearchApplicationSessionStats where
        parseJSON
          = Core.withObject "SearchApplicationSessionStats"
              (\ o ->
                 SearchApplicationSessionStats Core.<$>
                   (o Core..:? "date") Core.<*>
                     (o Core..:? "searchSessionsCount" Core.<&>
                        Core.fmap Core.fromAsText))
...
newSearchApplicationUserStats 
    ::  SearchApplicationUserStats
newSearchApplicationUserStats
  = SearchApplicationUserStats{date = Core.Nothing,
                               oneDayActiveUsersCount = Core.Nothing,
                               sevenDaysActiveUsersCount = Core.Nothing,
                               thirtyDaysActiveUsersCount = Core.Nothing}
instance Core.FromJSON SearchApplicationUserStats where
        parseJSON
          = Core.withObject "SearchApplicationUserStats"
              (\ o ->
                 SearchApplicationUserStats Core.<$>
                   (o Core..:? "date") Core.<*>
                     (o Core..:? "oneDayActiveUsersCount" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
...
newSearchItemsByViewUrlRequest 
    ::  SearchItemsByViewUrlRequest
newSearchItemsByViewUrlRequest
  = SearchItemsByViewUrlRequest{debugOptions = Core.Nothing,
                                pageToken = Core.Nothing, viewUrl = Core.Nothing}
instance Core.FromJSON SearchItemsByViewUrlRequest where
        parseJSON
          = Core.withObject "SearchItemsByViewUrlRequest"
              (\ o ->
                 SearchItemsByViewUrlRequest Core.<$>
                   (o Core..:? "debugOptions") Core.<*> (o Core..:? "pageToken")
                     Core.<*> (o Core..:? "viewUrl"))
...
newSearchItemsByViewUrlResponse 
    ::  SearchItemsByViewUrlResponse
newSearchItemsByViewUrlResponse
  = SearchItemsByViewUrlResponse{items = Core.Nothing,
                                 nextPageToken = Core.Nothing}
instance Core.FromJSON SearchItemsByViewUrlResponse where
        parseJSON
          = Core.withObject "SearchItemsByViewUrlResponse"
              (\ o ->
                 SearchItemsByViewUrlResponse Core.<$>
                   (o Core..:? "items") Core.<*> (o Core..:? "nextPageToken"))
...
instance Core.FromJSON SearchQualityMetadata where
        parseJSON
          = Core.withObject "SearchQualityMetadata"
...
newSearchRequest 
    ::  SearchRequest
newSearchRequest
  = SearchRequest{contextAttributes = Core.Nothing,
                  dataSourceRestrictions = Core.Nothing, facetOptions = Core.Nothing,
                  pageSize = Core.Nothing, query = Core.Nothing,
                  queryInterpretationOptions = Core.Nothing,
                  requestOptions = Core.Nothing, sortOptions = Core.Nothing,
                  start = Core.Nothing}
instance Core.FromJSON SearchRequest where
        parseJSON
          = Core.withObject "SearchRequest"
              (\ o ->
                 SearchRequest Core.<$>
                   (o Core..:? "contextAttributes") Core.<*>
                     (o Core..:? "dataSourceRestrictions")
          ...
          = Core.object
              (Core.catMaybes
                 [("contextAttributes" Core..=) Core.<$> contextAttributes,
                  ...
                  ("query" Core..=) Core.<$> query,
                  ("queryInterpretationOptions" Core..=) Core.<$>
                    queryInterpretationOptions,
                  ("requestOptions" Core..=) Core.<$> requestOptions,
...
newSearchResponse 
    ::  SearchResponse
newSearchResponse
  = SearchResponse{debugInfo = Core.Nothing,
                   errorInfo = Core.Nothing, facetResults = Core.Nothing,
                   hasMoreResults = Core.Nothing, queryInterpretation = Core.Nothing,
                   resultCountEstimate = Core.Nothing,
                   resultCountExact = Core.Nothing, resultCounts = Core.Nothing,
                   results = Core.Nothing, spellResults = Core.Nothing,
...
instance Core.FromJSON SearchResponse where
        parseJSON
          = Core.withObject "SearchResponse"
              (\ o ->
                 SearchResponse Core.<$>
                   (o Core..:? "debugInfo") Core.<*> (o Core..:? "errorInfo") Core.<*>
                     (o Core..:? "facetResults")
                     Core.<*> (o Core..:? "hasMoreResults")
                     Core.<*> (o Core..:? "queryInterpretation")
                     Core.<*>
                     (o Core..:? "resultCountEstimate" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "resultCountExact" Core.<&> Core.fmap Core.fromAsText)
          ...
          = Core.object
              (Core.catMaybes
                 [("debugInfo" Core..=) Core.<$> debugInfo,
                  ...
                  ("resultCountEstimate" Core..=) Core.. Core.AsText Core.<$>
                    resultCountEstimate,
                  ("resultCountExact" Core..=) Core.. Core.AsText Core.<$>
                    resultCountExact,
...
newSearchResult 
    ::  SearchResult
newSearchResult
  = SearchResult{clusteredResults = Core.Nothing,
                 debugInfo = Core.Nothing, metadata = Core.Nothing,
                 snippet = Core.Nothing, title = Core.Nothing, url = Core.Nothing}
instance Core.FromJSON SearchResult where
        parseJSON
          = Core.withObject "SearchResult"
              (\ o ->
                 SearchResult Core.<$>
                   (o Core..:? "clusteredResults") Core.<*> (o Core..:? "debugInfo")
                     Core.<*> (o Core..:? "metadata")
                     Core.<*> (o Core..:? "snippet")
                     Core.<*> (o Core..:? "title")
                     Core.<*> (o Core..:? "url"))
...
instance Core.FromJSON Snippet where
        parseJSON
          = Core.withObject "Snippet"
              (\ o ->
                 Snippet Core.<$>
                   (o Core..:? "matchRanges") Core.<*> (o Core..:? "snippet"))
...
newSortOptions 
    ::  SortOptions
newSortOptions
  = SortOptions{operatorName = Core.Nothing,
                sortOrder = Core.Nothing}
instance Core.FromJSON SortOptions where
        parseJSON
          = Core.withObject "SortOptions"
              (\ o ->
                 SortOptions Core.<$>
                   (o Core..:? "operatorName") Core.<*> (o Core..:? "sortOrder"))
...
instance Core.FromJSON Source where
        parseJSON
          = Core.withObject "Source"
              (\ o ->
                 Source Core.<$>
                   (o Core..:? "name") Core.<*> (o Core..:? "predefinedSource"))
...
newSourceConfig 
    ::  SourceConfig
newSourceConfig
  = SourceConfig{crowdingConfig = Core.Nothing,
                 scoringConfig = Core.Nothing, source = Core.Nothing}
instance Core.FromJSON SourceConfig where
        parseJSON
          = Core.withObject "SourceConfig"
              (\ o ->
                 SourceConfig Core.<$>
                   (o Core..:? "crowdingConfig") Core.<*> (o Core..:? "scoringConfig")
                     Core.<*> (o Core..:? "source"))
...
newSourceCrowdingConfig 
    ::  SourceCrowdingConfig
newSourceCrowdingConfig
  = SourceCrowdingConfig{numResults = Core.Nothing,
                         numSuggestions = Core.Nothing}
instance Core.FromJSON SourceCrowdingConfig where
        parseJSON
          = Core.withObject "SourceCrowdingConfig"
              (\ o ->
                 SourceCrowdingConfig Core.<$>
                   (o Core..:? "numResults") Core.<*> (o Core..:? "numSuggestions"))
...
newSourceResultCount 
    ::  SourceResultCount
newSourceResultCount
  = SourceResultCount{hasMoreResults = Core.Nothing,
                      resultCountEstimate = Core.Nothing,
                      resultCountExact = Core.Nothing, source = Core.Nothing}
instance Core.FromJSON SourceResultCount where
        parseJSON
          = Core.withObject "SourceResultCount"
              (\ o ->
                 SourceResultCount Core.<$>
                   (o Core..:? "hasMoreResults") Core.<*>
                     (o Core..:? "resultCountEstimate" Core.<&>
                        Core.fmap Core.fromAsText)
                     Core.<*>
                     (o Core..:? "resultCountExact" Core.<&> Core.fmap Core.fromAsText)
...
instance Core.FromJSON SourceScoringConfig where
        parseJSON
          = Core.withObject "SourceScoringConfig"
              (\ o ->
...
newSpellResult 
    ::  SpellResult
newSpellResult
  = SpellResult{suggestedQuery = Core.Nothing,
                suggestedQueryHtml = Core.Nothing, suggestionType = Core.Nothing}
instance Core.FromJSON SpellResult where
        parseJSON
          = Core.withObject "SpellResult"
              (\ o ->
                 SpellResult Core.<$>
...
newStartUploadItemRequest 
    ::  StartUploadItemRequest
newStartUploadItemRequest
  = StartUploadItemRequest{connectorName = Core.Nothing,
                           debugOptions = Core.Nothing}
instance Core.FromJSON StartUploadItemRequest where
        parseJSON
          = Core.withObject "StartUploadItemRequest"
              (\ o ->
                 StartUploadItemRequest Core.<$>
                   (o Core..:? "connectorName") Core.<*> (o Core..:? "debugOptions"))
...
instance Core.FromJSON StructuredDataObject where
        parseJSON
          = Core.withObject "StructuredDataObject"
...
instance Core.FromJSON StructuredResult where
        parseJSON
          = Core.withObject "StructuredResult"
...
newSuggestRequest 
    ::  SuggestRequest
newSuggestRequest
  = SuggestRequest{dataSourceRestrictions = Core.Nothing,
                   query = Core.Nothing, requestOptions = Core.Nothing}
instance Core.FromJSON SuggestRequest where
        parseJSON
          = Core.withObject "SuggestRequest"
              (\ o ->
                 SuggestRequest Core.<$>
                   (o Core..:? "dataSourceRestrictions") Core.<*> (o Core..:? "query")
                     Core.<*> (o Core..:? "requestOptions"))
...
instance Core.FromJSON SuggestResponse where
        parseJSON
          = Core.withObject "SuggestResponse"
...
newSuggestResult 
    ::  SuggestResult
newSuggestResult
  = SuggestResult{peopleSuggestion = Core.Nothing,
                  querySuggestion = Core.Nothing, source = Core.Nothing,
                  suggestedQuery = Core.Nothing}
instance Core.FromJSON SuggestResult where
        parseJSON
          = Core.withObject "SuggestResult"
              (\ o ->
                 SuggestResult Core.<$>
                   (o Core..:? "peopleSuggestion") Core.<*>
                     (o Core..:? "querySuggestion")
                     Core.<*> (o Core..:? "source")
...
newTextOperatorOptions 
    ::  TextOperatorOptions
newTextOperatorOptions
  = TextOperatorOptions{exactMatchWithOperator = Core.Nothing,
                        operatorName = Core.Nothing}
instance Core.FromJSON TextOperatorOptions where
        parseJSON
          = Core.withObject "TextOperatorOptions"
              (\ o ->
                 TextOperatorOptions Core.<$>
                   (o Core..:? "exactMatchWithOperator") Core.<*>
                     (o Core..:? "operatorName"))
...
instance Core.ToJSON TextOperatorOptions where
        toJSON TextOperatorOptions{..}
          = Core.object
              (Core.catMaybes
                 [("exactMatchWithOperator" Core..=) Core.<$>
...
newTextPropertyOptions 
    ::  TextPropertyOptions
newTextPropertyOptions
  = TextPropertyOptions{operatorOptions = Core.Nothing,
                        retrievalImportance = Core.Nothing}
instance Core.FromJSON TextPropertyOptions where
        parseJSON
          = Core.withObject "TextPropertyOptions"
              (\ o ->
...
newThirdPartyGenericCard 
    ::  ThirdPartyGenericCard
newThirdPartyGenericCard
  = ThirdPartyGenericCard{cardId = Core.Nothing,
                          category = Core.Nothing, content = Core.Nothing,
                          context = Core.Nothing, isDismissible = Core.Nothing,
                          priority = Core.Nothing}
instance Core.FromJSON ThirdPartyGenericCard where
        parseJSON
          = Core.withObject "ThirdPartyGenericCard"
              (\ o ->
                 ThirdPartyGenericCard Core.<$>
                   (o Core..:? "cardId") Core.<*> (o Core..:? "category") Core.<*>
                     (o Core..:? "content")
                     Core.<*> (o Core..:? "context")
...
newTimestampOperatorOptions 
    ::  TimestampOperatorOptions
newTimestampOperatorOptions
  = TimestampOperatorOptions{greaterThanOperatorName = Core.Nothing,
                             lessThanOperatorName = Core.Nothing, operatorName = Core.Nothing}
instance Core.FromJSON TimestampOperatorOptions where
        parseJSON
          = Core.withObject "TimestampOperatorOptions"
              (\ o ->
                 TimestampOperatorOptions Core.<$>
                   (o Core..:? "greaterThanOperatorName") Core.<*>
                     (o Core..:? "lessThanOperatorName")
                     Core.<*> (o Core..:? "operatorName"))
...
instance Core.FromJSON TimestampPropertyOptions where
        parseJSON
          = Core.withObject "TimestampPropertyOptions"
              (\ o ->
...
instance Core.FromJSON TimestampValues where
        parseJSON
          = Core.withObject "TimestampValues"
...
newUnmappedIdentity 
    ::  UnmappedIdentity
newUnmappedIdentity
  = UnmappedIdentity{externalIdentity = Core.Nothing,
                     resolutionStatusCode = Core.Nothing}
instance Core.FromJSON UnmappedIdentity where
        parseJSON
          = Core.withObject "UnmappedIdentity"
              (\ o ->
                 UnmappedIdentity Core.<$>
                   (o Core..:? "externalIdentity") Core.<*>
                     (o Core..:? "resolutionStatusCode"))
...
newUnreserveItemsRequest 
    ::  UnreserveItemsRequest
newUnreserveItemsRequest
  = UnreserveItemsRequest{connectorName = Core.Nothing,
                          debugOptions = Core.Nothing, queue = Core.Nothing}
instance Core.FromJSON UnreserveItemsRequest where
        parseJSON
          = Core.withObject "UnreserveItemsRequest"
              (\ o ->
                 UnreserveItemsRequest Core.<$>
                   (o Core..:? "connectorName") Core.<*> (o Core..:? "debugOptions")
                     Core.<*> (o Core..:? "queue"))
...
newUpdateDataSourceRequest 
    ::  UpdateDataSourceRequest
newUpdateDataSourceRequest
  = UpdateDataSourceRequest{debugOptions = Core.Nothing,
                            source = Core.Nothing, updateMask = Core.Nothing}
instance Core.FromJSON UpdateDataSourceRequest where
        parseJSON
          = Core.withObject "UpdateDataSourceRequest"
              (\ o ->
                 UpdateDataSourceRequest Core.<$>
                   (o Core..:? "debugOptions") Core.<*> (o Core..:? "source") Core.<*>
                     (o Core..:? "updateMask"))
...
newUpdateSchemaRequest 
    ::  UpdateSchemaRequest
newUpdateSchemaRequest
  = UpdateSchemaRequest{debugOptions = Core.Nothing,
                        schema = Core.Nothing, validateOnly = Core.Nothing}
instance Core.FromJSON UpdateSchemaRequest where
        parseJSON
          = Core.withObject "UpdateSchemaRequest"
              (\ o ->
                 UpdateSchemaRequest Core.<$>
                   (o Core..:? "debugOptions") Core.<*> (o Core..:? "schema") Core.<*>
                     (o Core..:? "validateOnly"))
...
newValue 
    ::  Value
newValue
  = Value{booleanValue = Core.Nothing, dateValue = Core.Nothing,
          doubleValue = Core.Nothing, integerValue = Core.Nothing,
          stringValue = Core.Nothing, timestampValue = Core.Nothing}
...
instance Core.FromJSON ValueFilter where
        parseJSON
          = Core.withObject "ValueFilter"
              (\ o ->
                 ValueFilter Core.<$>
                   (o Core..:? "operatorName") Core.<*> (o Core..:? "value"))
