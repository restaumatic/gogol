...
newCloudSearchSettingsDatasourcesDelete name
  = CloudSearchSettingsDatasourcesDelete{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         debugOptionsEnableDebugging = Core.Nothing, name = name,
                                         uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudSearchSettingsDatasourcesDelete
         where
        type Rs CloudSearchSettingsDatasourcesDelete = Operation
        type Scopes CloudSearchSettingsDatasourcesDelete =
             '[CloudSearch'FullControl, CloudSearch'Settings,
               CloudSearch'Settings'Indexing]
        requestClient CloudSearchSettingsDatasourcesDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudSearchSettingsDatasourcesDeleteResource)
                      Core.mempty
