...
newCloudSearchSettingsDatasourcesGet 
    :: 
                                     Core.Text
       -- ^  The name of the datasource resource. Format: datasources\/{source_id}. See 'name'.
    -> CloudSearchSettingsDatasourcesGet
newCloudSearchSettingsDatasourcesGet name
  = CloudSearchSettingsDatasourcesGet{xgafv = Core.Nothing,
                                      accessToken = Core.Nothing, callback = Core.Nothing,
                                      debugOptionsEnableDebugging = Core.Nothing, name = name,
                                      uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudSearchSettingsDatasourcesGet where
        type Rs CloudSearchSettingsDatasourcesGet = DataSource
        type Scopes CloudSearchSettingsDatasourcesGet =
