                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] ListDataSourceResponse
...
newCloudSearchSettingsDatasourcesList 
    :: 
                                      CloudSearchSettingsDatasourcesList
newCloudSearchSettingsDatasourcesList
  = CloudSearchSettingsDatasourcesList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest CloudSearchSettingsDatasourcesList
         where
        type Rs CloudSearchSettingsDatasourcesList = ListDataSourceResponse
        type Scopes CloudSearchSettingsDatasourcesList =
        ...
        requestClient CloudSearchSettingsDatasourcesList{..}
          = go xgafv accessToken callback debugOptionsEnableDebugging
              pageSize
              pageToken
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudSearchSettingsDatasourcesListResource)
                      Core.mempty
