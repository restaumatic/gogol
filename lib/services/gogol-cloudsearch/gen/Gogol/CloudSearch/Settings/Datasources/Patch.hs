...
newCloudSearchSettingsDatasourcesPatch name payload
  = CloudSearchSettingsDatasourcesPatch{xgafv = Core.Nothing,
...
instance Core.GoogleRequest CloudSearchSettingsDatasourcesPatch
         where
        type Rs CloudSearchSettingsDatasourcesPatch = Operation
        ...
        requestClient CloudSearchSettingsDatasourcesPatch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudSearchSettingsDatasourcesPatchResource)
                      Core.mempty
