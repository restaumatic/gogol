...
newCloudSearchSettingsDatasourcesCreate payload
  = CloudSearchSettingsDatasourcesCreate{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         payload = payload, uploadType = Core.Nothing,
                                         uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudSearchSettingsDatasourcesCreate
         where
        type Rs CloudSearchSettingsDatasourcesCreate = Operation
        ...
        requestClient CloudSearchSettingsDatasourcesCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudSearchSettingsDatasourcesCreateResource)
                      Core.mempty
