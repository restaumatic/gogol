                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.Get '[Core.JSON] SearchApplication
...
newCloudSearchSettingsSearchapplicationsGet name
  = CloudSearchSettingsSearchapplicationsGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           CloudSearchSettingsSearchapplicationsGet
         where
        type Rs CloudSearchSettingsSearchapplicationsGet =
             SearchApplication
        type Scopes CloudSearchSettingsSearchapplicationsGet =
             '[CloudSearch'FullControl, CloudSearch'Settings,
               CloudSearch'Settings'Query]
        requestClient CloudSearchSettingsSearchapplicationsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudSearchSettingsSearchapplicationsGetResource)
                      Core.mempty
