...
newCloudSearchSettingsSearchapplicationsPatch name payload
  = CloudSearchSettingsSearchapplicationsPatch{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           CloudSearchSettingsSearchapplicationsPatch
         where
        type Rs CloudSearchSettingsSearchapplicationsPatch = Operation
        type Scopes CloudSearchSettingsSearchapplicationsPatch =
             '[CloudSearch'FullControl, CloudSearch'Settings,
               CloudSearch'Settings'Query]
        requestClient CloudSearchSettingsSearchapplicationsPatch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudSearchSettingsSearchapplicationsPatchResource)
                      Core.mempty
