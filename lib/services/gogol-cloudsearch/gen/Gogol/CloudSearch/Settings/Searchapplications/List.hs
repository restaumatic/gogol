                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] ListSearchApplicationsResponse
...
newCloudSearchSettingsSearchapplicationsList 
    :: 
                                             CloudSearchSettingsSearchapplicationsList
newCloudSearchSettingsSearchapplicationsList
  = CloudSearchSettingsSearchapplicationsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           CloudSearchSettingsSearchapplicationsList
         where
        type Rs CloudSearchSettingsSearchapplicationsList =
        ...
        requestClient CloudSearchSettingsSearchapplicationsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudSearchSettingsSearchapplicationsListResource)
                      Core.mempty
