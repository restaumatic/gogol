...
newCloudSearchSettingsSearchapplicationsDelete name
  = CloudSearchSettingsSearchapplicationsDelete{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           CloudSearchSettingsSearchapplicationsDelete
         where
        type Rs CloudSearchSettingsSearchapplicationsDelete = Operation
        type Scopes CloudSearchSettingsSearchapplicationsDelete =
             '[CloudSearch'FullControl, CloudSearch'Settings,
               CloudSearch'Settings'Query]
        requestClient CloudSearchSettingsSearchapplicationsDelete{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudSearchSettingsSearchapplicationsDeleteResource)
                      Core.mempty
