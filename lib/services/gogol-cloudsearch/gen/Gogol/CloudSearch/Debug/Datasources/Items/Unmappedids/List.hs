...
newCloudSearchDebugDatasourcesItemsUnmappedidsList parent
  = CloudSearchDebugDatasourcesItemsUnmappedidsList{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           CloudSearchDebugDatasourcesItemsUnmappedidsList
         where
        type Rs CloudSearchDebugDatasourcesItemsUnmappedidsList =
             ListUnmappedIdentitiesResponse
        type Scopes CloudSearchDebugDatasourcesItemsUnmappedidsList =
