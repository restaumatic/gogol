...
type CloudSearchDebugDatasourcesItemsCheckAccessResource =
     "v1" Core.:>
       "debug" Core.:>
         Core.CaptureMode "name" "checkAccess" Core.Text Core.:>
                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] Principal Core.:>
                           Core.Post '[Core.JSON] CheckAccessResponse
...
newCloudSearchDebugDatasourcesItemsCheckAccess name payload
  = CloudSearchDebugDatasourcesItemsCheckAccess{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           CloudSearchDebugDatasourcesItemsCheckAccess
         where
        type Rs CloudSearchDebugDatasourcesItemsCheckAccess =
             CheckAccessResponse
        type Scopes CloudSearchDebugDatasourcesItemsCheckAccess =
             '[CloudSearch'FullControl, CloudSearch'Debug]
        requestClient CloudSearchDebugDatasourcesItemsCheckAccess{..}
          = go name xgafv accessToken callback debugOptionsEnableDebugging
              uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudSearchDebugDatasourcesItemsCheckAccessResource)
                      Core.mempty
