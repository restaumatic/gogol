                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] SearchItemsByViewUrlRequest Core.:>
...
newCloudSearchDebugDatasourcesItemsSearchByViewUrl name payload
  = CloudSearchDebugDatasourcesItemsSearchByViewUrl{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           CloudSearchDebugDatasourcesItemsSearchByViewUrl
         where
        type Rs CloudSearchDebugDatasourcesItemsSearchByViewUrl =
             SearchItemsByViewUrlResponse
        type Scopes CloudSearchDebugDatasourcesItemsSearchByViewUrl =
