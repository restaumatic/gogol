                           ...
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.Get '[Core.JSON] ListUnmappedIdentitiesResponse
...
newCloudSearchDebugIdentitysourcesUnmappedidsList parent
  = CloudSearchDebugIdentitysourcesUnmappedidsList{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           CloudSearchDebugIdentitysourcesUnmappedidsList
         where
        type Rs CloudSearchDebugIdentitysourcesUnmappedidsList =
             ListUnmappedIdentitiesResponse
        type Scopes CloudSearchDebugIdentitysourcesUnmappedidsList =
             '[CloudSearch'FullControl, CloudSearch'Debug]
        requestClient CloudSearchDebugIdentitysourcesUnmappedidsList{..}
          = go parent xgafv accessToken callback debugOptionsEnableDebugging
              pageSize
              pageToken
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudSearchDebugIdentitysourcesUnmappedidsListResource)
                      Core.mempty
