     ...
     "v1" Core.:>
       "debug" Core.:>
         Core.Capture "parent" Core.Text Core.:>
           "items:forunmappedidentity" Core.:>
             Core.QueryParam "$.xgafv" Xgafv Core.:>
               Core.QueryParam "access_token" Core.Text Core.:>
                 Core.QueryParam "callback" Core.Text Core.:>
                   Core.QueryParam "debugOptions.enableDebugging" Core.Bool Core.:>
                     Core.QueryParam "groupResourceName" Core.Text Core.:>
                       Core.QueryParam "pageSize" Core.Int32 Core.:>
                         Core.QueryParam "pageToken" Core.Text Core.:>
                           Core.QueryParam "uploadType" Core.Text Core.:>
                             Core.QueryParam "upload_protocol" Core.Text Core.:>
                               Core.QueryParam "userResourceName" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.Get '[Core.JSON] ListItemNamesForUnmappedIdentityResponse
...
newCloudSearchDebugIdentitysourcesItemsListForunmappedidentity
  parent
  = CloudSearchDebugIdentitysourcesItemsListForunmappedidentity{xgafv
                                                                  = Core.Nothing,
...
instance Core.GoogleRequest
           CloudSearchDebugIdentitysourcesItemsListForunmappedidentity
         where
        type Rs CloudSearchDebugIdentitysourcesItemsListForunmappedidentity
