...
newIAPGetIamPolicy payload resource
  = IAPGetIamPolicy{xgafv = Core.Nothing, accessToken = Core.Nothing,
                    callback = Core.Nothing, payload = payload, resource = resource,
...
instance Core.GoogleRequest IAPGetIamPolicy where
        ...
        type Scopes IAPGetIamPolicy = '[CloudPlatform'FullControl]
