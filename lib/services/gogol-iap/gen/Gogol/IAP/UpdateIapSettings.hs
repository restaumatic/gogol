...
type IAPUpdateIapSettingsResource =
     "v1" Core.:>
       Core.CaptureMode "name" "iapSettings" Core.Text Core.:>
                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] IapSettings Core.:>
                         Core.Patch '[Core.JSON] IapSettings
...
newIAPUpdateIapSettings name payload
  = IAPUpdateIapSettings{xgafv = Core.Nothing,
...
instance Core.GoogleRequest IAPUpdateIapSettings where
        ...
        type Scopes IAPUpdateIapSettings = '[CloudPlatform'FullControl]
        requestClient IAPUpdateIapSettings{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy IAPUpdateIapSettingsResource)
                      Core.mempty
