               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.Get '[Core.JSON] TunnelDestGroup
...
newIAPProjectsIap_tunnelLocationsDestGroupsGet name
  = IAPProjectsIap_tunnelLocationsDestGroupsGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           IAPProjectsIap_tunnelLocationsDestGroupsGet
         where
        type Rs IAPProjectsIap_tunnelLocationsDestGroupsGet =
             TunnelDestGroup
        type Scopes IAPProjectsIap_tunnelLocationsDestGroupsGet =
