                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] ListTunnelDestGroupsResponse
...
newIAPProjectsIap_tunnelLocationsDestGroupsList parent
  = IAPProjectsIap_tunnelLocationsDestGroupsList{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
           IAPProjectsIap_tunnelLocationsDestGroupsList
         where
        type Rs IAPProjectsIap_tunnelLocationsDestGroupsList =
             ListTunnelDestGroupsResponse
        type Scopes IAPProjectsIap_tunnelLocationsDestGroupsList =
