           ...
           Core.QueryParam "$.xgafv" Xgafv Core.:>
             Core.QueryParam "access_token" Core.Text Core.:>
               Core.QueryParam "callback" Core.Text Core.:>
                 Core.QueryParam "tunnelDestGroupId" Core.Text Core.:>
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] TunnelDestGroup Core.:>
                           Core.Post '[Core.JSON] TunnelDestGroup
...
newIAPProjectsIap_tunnelLocationsDestGroupsCreate parent payload
  = IAPProjectsIap_tunnelLocationsDestGroupsCreate{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           IAPProjectsIap_tunnelLocationsDestGroupsCreate
         where
        type Rs IAPProjectsIap_tunnelLocationsDestGroupsCreate =
             TunnelDestGroup
        type Scopes IAPProjectsIap_tunnelLocationsDestGroupsCreate =
             '[CloudPlatform'FullControl]
        requestClient IAPProjectsIap_tunnelLocationsDestGroupsCreate{..}
          = go parent xgafv accessToken callback tunnelDestGroupId uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy IAPProjectsIap_tunnelLocationsDestGroupsCreateResource)
                      Core.mempty
