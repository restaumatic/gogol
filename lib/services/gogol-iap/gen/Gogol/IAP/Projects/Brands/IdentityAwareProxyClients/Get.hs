               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.Get '[Core.JSON] IdentityAwareProxyClient
...
newIAPProjectsBrandsIdentityAwareProxyClientsGet name
  = IAPProjectsBrandsIdentityAwareProxyClientsGet{xgafv =
                                                    Core.Nothing,
...
instance Core.GoogleRequest
           IAPProjectsBrandsIdentityAwareProxyClientsGet
         where
        type Rs IAPProjectsBrandsIdentityAwareProxyClientsGet =
             IdentityAwareProxyClient
        type Scopes IAPProjectsBrandsIdentityAwareProxyClientsGet =
             '[CloudPlatform'FullControl]
        requestClient IAPProjectsBrandsIdentityAwareProxyClientsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy IAPProjectsBrandsIdentityAwareProxyClientsGetResource)
                      Core.mempty
