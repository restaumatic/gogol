                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.Get '[Core.JSON] ListBrandsResponse
...
newIAPProjectsBrandsList parent
  = IAPProjectsBrandsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest IAPProjectsBrandsList where
        ...
        type Scopes IAPProjectsBrandsList = '[CloudPlatform'FullControl]
        requestClient IAPProjectsBrandsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy IAPProjectsBrandsListResource)
                      Core.mempty
