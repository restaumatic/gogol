                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] Brand Core.:>
                         Core.Post '[Core.JSON] Brand
...
newIAPProjectsBrandsCreate parent payload
  = IAPProjectsBrandsCreate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest IAPProjectsBrandsCreate where
        ...
        type Scopes IAPProjectsBrandsCreate = '[CloudPlatform'FullControl]
        requestClient IAPProjectsBrandsCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy IAPProjectsBrandsCreateResource)
                      Core.mempty
