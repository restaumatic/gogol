                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] IdentityAwareProxyClient Core.:>
                         Core.Post '[Core.JSON] IdentityAwareProxyClient
...
newIAPProjectsBrandsIdentityAwareProxyClientsCreate parent payload
  = IAPProjectsBrandsIdentityAwareProxyClientsCreate{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           IAPProjectsBrandsIdentityAwareProxyClientsCreate
         where
        type Rs IAPProjectsBrandsIdentityAwareProxyClientsCreate =
             IdentityAwareProxyClient
        type Scopes IAPProjectsBrandsIdentityAwareProxyClientsCreate =
             '[CloudPlatform'FullControl]
        requestClient IAPProjectsBrandsIdentityAwareProxyClientsCreate{..}
