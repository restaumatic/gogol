                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.Get '[Core.JSON] ListIdentityAwareProxyClientsResponse
...
newIAPProjectsBrandsIdentityAwareProxyClientsList parent
  = IAPProjectsBrandsIdentityAwareProxyClientsList{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           IAPProjectsBrandsIdentityAwareProxyClientsList
         where
        type Rs IAPProjectsBrandsIdentityAwareProxyClientsList =
             ListIdentityAwareProxyClientsResponse
        type Scopes IAPProjectsBrandsIdentityAwareProxyClientsList =
