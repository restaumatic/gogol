...
type IAPProjectsBrandsIdentityAwareProxyClientsResetSecretResource
     =
     "v1" Core.:>
       Core.CaptureMode "name" "resetSecret" Core.Text Core.:>
...
newIAPProjectsBrandsIdentityAwareProxyClientsResetSecret 
    ...
    -> IAPProjectsBrandsIdentityAwareProxyClientsResetSecret
newIAPProjectsBrandsIdentityAwareProxyClientsResetSecret name
  payload
  = IAPProjectsBrandsIdentityAwareProxyClientsResetSecret{xgafv =
                                                            Core.Nothing,
...
instance Core.GoogleRequest
           IAPProjectsBrandsIdentityAwareProxyClientsResetSecret
         where
        type Rs IAPProjectsBrandsIdentityAwareProxyClientsResetSecret =
             IdentityAwareProxyClient
        type Scopes IAPProjectsBrandsIdentityAwareProxyClientsResetSecret =
