...
newAccessDeniedPageSettings 
    ::  AccessDeniedPageSettings
newAccessDeniedPageSettings
  = AccessDeniedPageSettings{accessDeniedPageUri = Core.Nothing,
          ...
          = Core.object
              (Core.catMaybes
                 [("accessDeniedPageUri" Core..=) Core.<$> accessDeniedPageUri,
                  ...
                  ("remediationTokenGenerationEnabled" Core..=) Core.<$>
...
newAccessSettings 
    ::  AccessSettings
newAccessSettings
  = AccessSettings{allowedDomainsSettings = Core.Nothing,
                   corsSettings = Core.Nothing, gcipSettings = Core.Nothing,
                   identitySources = Core.Nothing, oauthSettings = Core.Nothing,
          ...
          = Core.object
              (Core.catMaybes
                 [("allowedDomainsSettings" Core..=) Core.<$>
                  ...
                  ("workforceIdentitySettings" Core..=) Core.<$>
                    workforceIdentitySettings])
...
newAllowedDomainsSettings 
    ::  AllowedDomainsSettings
newAllowedDomainsSettings
  = AllowedDomainsSettings{domains = Core.Nothing,
                           enable = Core.Nothing}
          ...
          = Core.withObject "AllowedDomainsSettings"
              (\ o ->
                 AllowedDomainsSettings Core.<$>
                   (o Core..:? "domains") Core.<*> (o Core..:? "enable"))
...
newApplicationSettings 
    ::  ApplicationSettings
newApplicationSettings
  = ApplicationSettings{accessDeniedPageSettings = Core.Nothing,
                        attributePropagationSettings = Core.Nothing,
                        cookieDomain = Core.Nothing, csmSettings = Core.Nothing}
...
newAttributePropagationSettings 
    ::  AttributePropagationSettings
newAttributePropagationSettings
  = AttributePropagationSettings{enable = Core.Nothing,
                                 expression = Core.Nothing, outputCredentials = Core.Nothing}
          ...
          = Core.withObject "AttributePropagationSettings"
              (\ o ->
                 AttributePropagationSettings Core.<$>
                   (o Core..:? "enable") Core.<*> (o Core..:? "expression") Core.<*>
                     (o Core..:? "outputCredentials"))
...
newBrand 
    ::  Brand
newBrand
  = Brand{applicationTitle = Core.Nothing, name = Core.Nothing,
          orgInternalOnly = Core.Nothing, supportEmail = Core.Nothing}
instance Core.FromJSON Brand where
        parseJSON
          = Core.withObject "Brand"
              (\ o ->
                 Brand Core.<$>
                   (o Core..:? "applicationTitle") Core.<*> (o Core..:? "name")
...
newGcipSettings 
    ::  GcipSettings
newGcipSettings
  = GcipSettings{loginPageUri = Core.Nothing,
...
instance Core.FromJSON GcipSettings where
        parseJSON
          = Core.withObject "GcipSettings"
              (\ o ->
                 GcipSettings Core.<$>
                   (o Core..:? "loginPageUri") Core.<*> (o Core..:? "tenantIds"))
...
newIapSettings 
    ::  IapSettings
newIapSettings
  = IapSettings{accessSettings = Core.Nothing,
                applicationSettings = Core.Nothing, name = Core.Nothing}
...
newIdentityAwareProxyClient 
    ::  IdentityAwareProxyClient
newIdentityAwareProxyClient
  = IdentityAwareProxyClient{displayName = Core.Nothing,
                             name = Core.Nothing, secret = Core.Nothing}
          ...
          = Core.withObject "IdentityAwareProxyClient"
              (\ o ->
                 IdentityAwareProxyClient Core.<$>
                   (o Core..:? "displayName") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "secret"))
...
instance Core.FromJSON ListIdentityAwareProxyClientsResponse where
        parseJSON
          = Core.withObject "ListIdentityAwareProxyClientsResponse"
              (\ o ->
...
newListTunnelDestGroupsResponse 
    ::  ListTunnelDestGroupsResponse
newListTunnelDestGroupsResponse
  = ListTunnelDestGroupsResponse{nextPageToken = Core.Nothing,
...
newNextStateOfTags 
    ::  NextStateOfTags
newNextStateOfTags
  = NextStateOfTags{tagsFullState = Core.Nothing,
                    tagsFullStateForChildResource = Core.Nothing,
                    tagsPartialState = Core.Nothing}
instance Core.FromJSON NextStateOfTags where
        parseJSON
          = Core.withObject "NextStateOfTags"
              (\ o ->
                 NextStateOfTags Core.<$>
                   (o Core..:? "tagsFullState") Core.<*>
                     (o Core..:? "tagsFullStateForChildResource")
          ...
          = Core.object
              (Core.catMaybes
                 [("tagsFullState" Core..=) Core.<$> tagsFullState,
                  ("tagsFullStateForChildResource" Core..=) Core.<$>
                    tagsFullStateForChildResource,
...
newOAuth2 
    ::  OAuth2
newOAuth2
  = OAuth2{clientId = Core.Nothing, clientSecret = Core.Nothing,
           clientSecretSha256 = Core.Nothing}
instance Core.FromJSON OAuth2 where
        parseJSON
          = Core.withObject "OAuth2"
              (\ o ->
                 OAuth2 Core.<$>
...
newOAuthSettings 
    ::  OAuthSettings
newOAuthSettings
  = OAuthSettings{loginHint = Core.Nothing,
...
instance Core.FromJSON OAuthSettings where
        parseJSON
          = Core.withObject "OAuthSettings"
              (\ o ->
                 OAuthSettings Core.<$>
                   (o Core..:? "loginHint") Core.<*>
                     (o Core..:? "programmaticClients"))
...
newPolicyDelegationSettings 
    ::  PolicyDelegationSettings
newPolicyDelegationSettings
  = PolicyDelegationSettings{iamPermission = Core.Nothing,
                             iamServiceName = Core.Nothing, policyName = Core.Nothing,
          ...
          = Core.withObject "PolicyDelegationSettings"
              (\ o ->
                 PolicyDelegationSettings Core.<$>
                   (o Core..:? "iamPermission") Core.<*> (o Core..:? "iamServiceName")
...
newPolicyName 
    ::  PolicyName
newPolicyName
  = PolicyName{id = Core.Nothing, region = Core.Nothing,
               type' = Core.Nothing}
instance Core.FromJSON PolicyName where
        parseJSON
          = Core.withObject "PolicyName"
              (\ o ->
                 PolicyName Core.<$>
                   (o Core..:? "id") Core.<*> (o Core..:? "region") Core.<*>
                     (o Core..:? "type"))
...
instance Core.ToJSON PolicyName where
        toJSON PolicyName{..}
          = Core.object
              (Core.catMaybes
                 [("id" Core..=) Core.<$> id, ("region" Core..=) Core.<$> region,
                  ("type" Core..=) Core.<$> type'])
...
newReauthSettings 
    ::  ReauthSettings
newReauthSettings
  = ReauthSettings{maxAge = Core.Nothing, method = Core.Nothing,
...
instance Core.FromJSON ReauthSettings where
        parseJSON
          = Core.withObject "ReauthSettings"
              (\ o ->
                 ReauthSettings Core.<$>
                   (o Core..:? "maxAge") Core.<*> (o Core..:? "method") Core.<*>
                     (o Core..:? "policyType"))
...
newResetIdentityAwareProxyClientSecretRequest
  = ResetIdentityAwareProxyClientSecretRequest
instance Core.FromJSON ResetIdentityAwareProxyClientSecretRequest
         where
        parseJSON
          = Core.withObject "ResetIdentityAwareProxyClientSecretRequest"
              (\ o -> Core.pure ResetIdentityAwareProxyClientSecretRequest)

instance Core.ToJSON ResetIdentityAwareProxyClientSecretRequest
         where
        toJSON = Core.const Core.emptyObject
...
newResource 
    ::  Resource
newResource
  = Resource{expectedNextState = Core.Nothing, labels = Core.Nothing,
             locations = Core.Nothing, name = Core.Nothing,
             nextStateOfTags = Core.Nothing, service = Core.Nothing,
             type' = Core.Nothing}
instance Core.FromJSON Resource where
        parseJSON
          = Core.withObject "Resource"
              (\ o ->
                 Resource Core.<$>
                   (o Core..:? "expectedNextState") Core.<*> (o Core..:? "labels")
...
instance Core.FromJSON Resource_ExpectedNextState where
        parseJSON
          = Core.withObject "Resource_ExpectedNextState"
              (\ o ->
...
instance Core.FromJSON TagsFullState_Tags where
        parseJSON
          = Core.withObject "TagsFullState_Tags"
...
instance Core.FromJSON TagsFullStateForChildResource where
        parseJSON
          = Core.withObject "TagsFullStateForChildResource"
...
instance Core.FromJSON TagsFullStateForChildResource_Tags where
        parseJSON
          = Core.withObject "TagsFullStateForChildResource_Tags"
              (\ o ->
                 TagsFullStateForChildResource_Tags Core.<$>
...
newTagsPartialState 
    ::  TagsPartialState
newTagsPartialState
  = TagsPartialState{tagKeysToRemove = Core.Nothing,
                     tagsToUpsert = Core.Nothing}
instance Core.FromJSON TagsPartialState where
        parseJSON
          = Core.withObject "TagsPartialState"
              (\ o ->
                 TagsPartialState Core.<$>
                   (o Core..:? "tagKeysToRemove") Core.<*>
                     (o Core..:? "tagsToUpsert"))
...
instance Core.FromJSON TagsPartialState_TagsToUpsert where
        parseJSON
          = Core.withObject "TagsPartialState_TagsToUpsert"
              (\ o ->
...
newTunnelDestGroup 
    ::  TunnelDestGroup
newTunnelDestGroup
  = TunnelDestGroup{cidrs = Core.Nothing, fqdns = Core.Nothing,
                    name = Core.Nothing}
          ...
          = Core.withObject "TunnelDestGroup"
              (\ o ->
                 TunnelDestGroup Core.<$>
                   (o Core..:? "cidrs") Core.<*> (o Core..:? "fqdns") Core.<*>
                     (o Core..:? "name"))
          ...
          = Core.object
              (Core.catMaybes
                 [("cidrs" Core..=) Core.<$> cidrs,
                  ("fqdns" Core..=) Core.<$> fqdns, ("name" Core..=) Core.<$> name])
...
instance Core.FromJSON ValidateIapAttributeExpressionResponse where
        parseJSON
          = Core.withObject "ValidateIapAttributeExpressionResponse"
...
newWorkforceIdentitySettings 
    ::  WorkforceIdentitySettings
newWorkforceIdentitySettings
  = WorkforceIdentitySettings{oauth2 = Core.Nothing,
                              workforcePools = Core.Nothing}
instance Core.FromJSON WorkforceIdentitySettings where
        parseJSON
          = Core.withObject "WorkforceIdentitySettings"
              (\ o ->
                 WorkforceIdentitySettings Core.<$>
                   (o Core..:? "oauth2") Core.<*> (o Core..:? "workforcePools"))
