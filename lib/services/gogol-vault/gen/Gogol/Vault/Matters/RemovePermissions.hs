...
--
-- /See:/ <https://developers.google.com/workspace/vault Google Vault API Reference> for @vault.matters.removePermissions@.
module Gogol.Vault.Matters.RemovePermissions
    (
    -- * Resource
...
type VaultMattersRemovePermissionsResource =
     "v1" Core.:>
       "matters" Core.:>
         Core.CaptureMode "matterId" "removePermissions" Core.Text Core.:>
                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] RemoveMatterPermissionsRequest Core.:>
...
newVaultMattersRemovePermissions matterId payload
  = VaultMattersRemovePermissions{xgafv = Core.Nothing,
                                  accessToken = Core.Nothing, callback = Core.Nothing,
                                  matterId = matterId, payload = payload, uploadType = Core.Nothing,
                                  uploadProtocol = Core.Nothing}
instance Core.GoogleRequest VaultMattersRemovePermissions where
        type Rs VaultMattersRemovePermissions = Empty
        type Scopes VaultMattersRemovePermissions =
        ...
        requestClient VaultMattersRemovePermissions{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy VaultMattersRemovePermissionsResource)
                      Core.mempty
