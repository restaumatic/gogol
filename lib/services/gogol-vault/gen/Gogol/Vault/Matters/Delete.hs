...
--
-- /See:/ <https://developers.google.com/workspace/vault Google Vault API Reference> for @vault.matters.delete@.
module Gogol.Vault.Matters.Delete
    (
    -- * Resource
...
newVaultMattersDelete matterId
  = VaultMattersDelete{xgafv = Core.Nothing,
                       accessToken = Core.Nothing, callback = Core.Nothing,
                       matterId = matterId, uploadType = Core.Nothing,
