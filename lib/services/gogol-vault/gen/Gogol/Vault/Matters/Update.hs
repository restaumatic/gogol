...
--
-- /See:/ <https://developers.google.com/workspace/vault Google Vault API Reference> for @vault.matters.update@.
module Gogol.Vault.Matters.Update
    (
    -- * Resource
...
newVaultMattersUpdate matterId payload
  = VaultMattersUpdate{xgafv = Core.Nothing,
