...
-- Deletes an export.
--
-- /See:/ <https://developers.google.com/workspace/vault Google Vault API Reference> for @vault.matters.exports.delete@.
module Gogol.Vault.Matters.Exports.Delete
    (
    -- * Resource
...
newVaultMattersExportsDelete exportId matterId
  = VaultMattersExportsDelete{xgafv = Core.Nothing,
