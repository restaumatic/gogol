...
-- Creates an export.
--
-- /See:/ <https://developers.google.com/workspace/vault Google Vault API Reference> for @vault.matters.exports.create@.
module Gogol.Vault.Matters.Exports.Create
    (
    -- * Resource
                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] Export Core.:>
                           Core.Post '[Core.JSON] Export
...
newVaultMattersExportsCreate matterId payload
  = VaultMattersExportsCreate{xgafv = Core.Nothing,
