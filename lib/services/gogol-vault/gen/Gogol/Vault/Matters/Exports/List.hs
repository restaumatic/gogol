...
--
-- /See:/ <https://developers.google.com/workspace/vault Google Vault API Reference> for @vault.matters.exports.list@.
module Gogol.Vault.Matters.Exports.List
    (
    -- * Resource
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] ListExportsResponse
...
newVaultMattersExportsList matterId
  = VaultMattersExportsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest VaultMattersExportsList where
        ...
        type Scopes VaultMattersExportsList =
        ...
        requestClient VaultMattersExportsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy VaultMattersExportsListResource)
                      Core.mempty
