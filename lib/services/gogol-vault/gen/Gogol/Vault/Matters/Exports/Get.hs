...
-- Gets an export.
--
-- /See:/ <https://developers.google.com/workspace/vault Google Vault API Reference> for @vault.matters.exports.get@.
module Gogol.Vault.Matters.Exports.Get
    (
    -- * Resource
     ...
     "v1" Core.:>
       "matters" Core.:>
         Core.Capture "matterId" Core.Text Core.:>
           "exports" Core.:>
             Core.Capture "exportId" Core.Text Core.:>
...
newVaultMattersExportsGet exportId matterId
  = VaultMattersExportsGet{xgafv = Core.Nothing,
                           accessToken = Core.Nothing, callback = Core.Nothing,
                           exportId = exportId, matterId = matterId,
...
instance Core.GoogleRequest VaultMattersExportsGet where
        ...
        type Scopes VaultMattersExportsGet =
             '[Ediscovery'FullControl, Ediscovery'Readonly]
        requestClient VaultMattersExportsGet{..}
          = go matterId exportId xgafv accessToken callback uploadType
              uploadProtocol
