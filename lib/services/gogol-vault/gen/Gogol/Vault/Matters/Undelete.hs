...
--
-- /See:/ <https://developers.google.com/workspace/vault Google Vault API Reference> for @vault.matters.undelete@.
module Gogol.Vault.Matters.Undelete
    (
    -- * Resource
...
type VaultMattersUndeleteResource =
     "v1" Core.:>
       "matters" Core.:>
         Core.CaptureMode "matterId" "undelete" Core.Text Core.:>
                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] UndeleteMatterRequest Core.:>
...
newVaultMattersUndelete matterId payload
  = VaultMattersUndelete{xgafv = Core.Nothing,
