...
--
-- /See:/ <https://developers.google.com/workspace/vault Google Vault API Reference> for @vault.matters.savedQueries.create@.
module Gogol.Vault.Matters.SavedQueries.Create
    (
    -- * Resource
...
newVaultMattersSavedQueriesCreate matterId payload
  = VaultMattersSavedQueriesCreate{xgafv = Core.Nothing,
                                   accessToken = Core.Nothing, callback = Core.Nothing,
                                   matterId = matterId, payload = payload,
                                   uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest VaultMattersSavedQueriesCreate where
        ...
        requestClient VaultMattersSavedQueriesCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy VaultMattersSavedQueriesCreateResource)
                      Core.mempty
