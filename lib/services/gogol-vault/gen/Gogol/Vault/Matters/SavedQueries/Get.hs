...
--
-- /See:/ <https://developers.google.com/workspace/vault Google Vault API Reference> for @vault.matters.savedQueries.get@.
module Gogol.Vault.Matters.SavedQueries.Get
    (
    -- * Resource
...
instance Core.GoogleRequest VaultMattersSavedQueriesGet where
        ...
        requestClient VaultMattersSavedQueriesGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy VaultMattersSavedQueriesGetResource)
                      Core.mempty
