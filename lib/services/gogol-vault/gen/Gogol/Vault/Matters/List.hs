...
--
-- /See:/ <https://developers.google.com/workspace/vault Google Vault API Reference> for @vault.matters.list@.
module Gogol.Vault.Matters.List
    (
    -- * Resource
             ...
             Core.QueryParam "callback" Core.Text Core.:>
               Core.QueryParam "pageSize" Core.Int32 Core.:>
                 Core.QueryParam "pageToken" Core.Text Core.:>
                   Core.QueryParam "state" MattersListState Core.:>
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "view" MattersListView Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] ListMattersResponse
...
newVaultMattersList 
    ::  VaultMattersList
newVaultMattersList
  = VaultMattersList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest VaultMattersList where
        ...
        type Scopes VaultMattersList =
             '[Ediscovery'FullControl, Ediscovery'Readonly]
        requestClient VaultMattersList{..}
          = go xgafv accessToken callback pageSize pageToken state uploadType
              uploadProtocol
              view
