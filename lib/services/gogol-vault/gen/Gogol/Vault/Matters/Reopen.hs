...
--
-- /See:/ <https://developers.google.com/workspace/vault Google Vault API Reference> for @vault.matters.reopen@.
module Gogol.Vault.Matters.Reopen
    (
    -- * Resource
...
type VaultMattersReopenResource =
     "v1" Core.:>
       "matters" Core.:>
         Core.CaptureMode "matterId" "reopen" Core.Text Core.:>
...
newVaultMattersReopen matterId payload
  = VaultMattersReopen{xgafv = Core.Nothing,
