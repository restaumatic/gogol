...
--
-- /See:/ <https://developers.google.com/workspace/vault Google Vault API Reference> for @vault.matters.holds.removeHeldAccounts@.
module Gogol.Vault.Matters.Holds.RemoveHeldAccounts
    (
    -- * Resource
     ...
     "v1" Core.:>
       "matters" Core.:>
         Core.Capture "matterId" Core.Text Core.:>
           "holds" Core.:>
             Core.CaptureMode "holdId" "removeHeldAccounts" Core.Text Core.:>
                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] RemoveHeldAccountsRequest Core.:>
                             Core.Post '[Core.JSON] RemoveHeldAccountsResponse
...
newVaultMattersHoldsRemoveHeldAccounts holdId matterId payload
  = VaultMattersHoldsRemoveHeldAccounts{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        holdId = holdId, matterId = matterId, payload = payload,
                                        uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest VaultMattersHoldsRemoveHeldAccounts
         where
        type Rs VaultMattersHoldsRemoveHeldAccounts =
             RemoveHeldAccountsResponse
        type Scopes VaultMattersHoldsRemoveHeldAccounts =
             '[Ediscovery'FullControl]
        requestClient VaultMattersHoldsRemoveHeldAccounts{..}
          = go matterId holdId xgafv accessToken callback uploadType
              uploadProtocol
