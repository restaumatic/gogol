...
--
-- /See:/ <https://developers.google.com/workspace/vault Google Vault API Reference> for @vault.matters.holds.list@.
module Gogol.Vault.Matters.Holds.List
    (
    -- * Resource
                     ...
                     Core.QueryParam "pageToken" Core.Text Core.:>
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "view" MattersHoldsListView Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Get '[Core.JSON] ListHoldsResponse
...
newVaultMattersHoldsList matterId
  = VaultMattersHoldsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest VaultMattersHoldsList where
        ...
        type Scopes VaultMattersHoldsList =
