...
--
-- /See:/ <https://developers.google.com/workspace/vault Google Vault API Reference> for @vault.matters.holds.get@.
module Gogol.Vault.Matters.Holds.Get
    (
    -- * Resource
                   ...
                   Core.QueryParam "callback" Core.Text Core.:>
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "view" MattersHoldsGetView Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] Hold
...
newVaultMattersHoldsGet holdId matterId
  = VaultMattersHoldsGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest VaultMattersHoldsGet where
        ...
        type Scopes VaultMattersHoldsGet =
