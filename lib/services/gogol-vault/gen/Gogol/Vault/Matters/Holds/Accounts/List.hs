...
--
-- /See:/ <https://developers.google.com/workspace/vault Google Vault API Reference> for @vault.matters.holds.accounts.list@.
module Gogol.Vault.Matters.Holds.Accounts.List
    (
    -- * Resource
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] ListHeldAccountsResponse
...
newVaultMattersHoldsAccountsList holdId matterId
  = VaultMattersHoldsAccountsList{xgafv = Core.Nothing,
                                  accessToken = Core.Nothing, callback = Core.Nothing,
                                  holdId = holdId, matterId = matterId, uploadType = Core.Nothing,
...
instance Core.GoogleRequest VaultMattersHoldsAccountsList where
        ...
        type Scopes VaultMattersHoldsAccountsList =
