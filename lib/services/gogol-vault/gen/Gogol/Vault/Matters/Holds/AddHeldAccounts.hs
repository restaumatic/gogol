...
--
-- /See:/ <https://developers.google.com/workspace/vault Google Vault API Reference> for @vault.matters.holds.addHeldAccounts@.
module Gogol.Vault.Matters.Holds.AddHeldAccounts
    (
    -- * Resource
     ...
     "v1" Core.:>
       "matters" Core.:>
         Core.Capture "matterId" Core.Text Core.:>
           "holds" Core.:>
             Core.CaptureMode "holdId" "addHeldAccounts" Core.Text Core.:>
                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] AddHeldAccountsRequest Core.:>
                             Core.Post '[Core.JSON] AddHeldAccountsResponse
...
newVaultMattersHoldsAddHeldAccounts holdId matterId payload
  = VaultMattersHoldsAddHeldAccounts{xgafv = Core.Nothing,
...
instance Core.GoogleRequest VaultMattersHoldsAddHeldAccounts where
        ...
        type Scopes VaultMattersHoldsAddHeldAccounts =
