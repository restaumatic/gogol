...
--
-- /See:/ <https://developers.google.com/workspace/vault Google Vault API Reference> for @vault.matters.holds.update@.
module Gogol.Vault.Matters.Holds.Update
    (
    -- * Resource
                     ...
                     Core.QueryParam "uploadType" Core.Text Core.:>
                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                         Core.QueryParam "alt" Core.AltJSON Core.:>
                           Core.ReqBody '[Core.JSON] Hold Core.:> Core.Put '[Core.JSON] Hold
...
newVaultMattersHoldsUpdate holdId matterId payload
  = VaultMattersHoldsUpdate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest VaultMattersHoldsUpdate where
        ...
        type Scopes VaultMattersHoldsUpdate = '[Ediscovery'FullControl]
        requestClient VaultMattersHoldsUpdate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy VaultMattersHoldsUpdateResource)
                      Core.mempty
