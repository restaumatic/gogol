...
--
-- /See:/ <https://developers.google.com/workspace/vault Google Vault API Reference> for @vault.matters.holds.create@.
module Gogol.Vault.Matters.Holds.Create
    (
    -- * Resource
                   ...
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] Hold Core.:> Core.Post '[Core.JSON] Hold
...
newVaultMattersHoldsCreate matterId payload
  = VaultMattersHoldsCreate{xgafv = Core.Nothing,
