...
--
-- /See:/ <https://developers.google.com/workspace/vault Google Vault API Reference> for @vault.matters.holds.accounts.create@.
module Gogol.Vault.Matters.Holds.Accounts.Create
    (
    -- * Resource
...
newVaultMattersHoldsAccountsCreate holdId matterId payload
  = VaultMattersHoldsAccountsCreate{xgafv = Core.Nothing,
