...
--
-- /See:/ <https://developers.google.com/workspace/vault Google Vault API Reference> for @vault.matters.holds.accounts.delete@.
module Gogol.Vault.Matters.Holds.Accounts.Delete
    (
    -- * Resource
...
newVaultMattersHoldsAccountsDelete accountId holdId matterId
  = VaultMattersHoldsAccountsDelete{xgafv = Core.Nothing,
                                    accessToken = Core.Nothing, accountId = accountId,
                                    callback = Core.Nothing, holdId = holdId, matterId = matterId,
...
instance Core.GoogleRequest VaultMattersHoldsAccountsDelete where
        ...
        requestClient VaultMattersHoldsAccountsDelete{..}
          = go matterId holdId accountId xgafv accessToken callback
              uploadType
              uploadProtocol
