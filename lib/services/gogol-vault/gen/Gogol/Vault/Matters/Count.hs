...
--
-- /See:/ <https://developers.google.com/workspace/vault Google Vault API Reference> for @vault.matters.count@.
module Gogol.Vault.Matters.Count
    (
    -- * Resource
                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] CountArtifactsRequest Core.:>
...
newVaultMattersCount matterId payload
  = VaultMattersCount{xgafv = Core.Nothing,
...
instance Core.GoogleRequest VaultMattersCount where
        ...
        type Scopes VaultMattersCount = '[Ediscovery'FullControl]
