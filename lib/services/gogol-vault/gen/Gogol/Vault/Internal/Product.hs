...
newAccountCountError 
    ::  AccountCountError
newAccountCountError
  = AccountCountError{account = Core.Nothing,
          ...
          = Core.withObject "AccountCountError"
              (\ o ->
                 AccountCountError Core.<$>
                   (o Core..:? "account") Core.<*> (o Core..:? "errorType"))
...
newAddHeldAccountResult 
    ::  AddHeldAccountResult
newAddHeldAccountResult
  = AddHeldAccountResult{account = Core.Nothing,
                         status = Core.Nothing}
          ...
          = Core.withObject "AddHeldAccountResult"
              (\ o ->
                 AddHeldAccountResult Core.<$>
                   (o Core..:? "account") Core.<*> (o Core..:? "status"))
...
newAddHeldAccountsRequest 
    ::  AddHeldAccountsRequest
newAddHeldAccountsRequest
  = AddHeldAccountsRequest{accountIds = Core.Nothing,
                           emails = Core.Nothing}
          ...
          = Core.withObject "AddHeldAccountsRequest"
              (\ o ->
                 AddHeldAccountsRequest Core.<$>
                   (o Core..:? "accountIds") Core.<*> (o Core..:? "emails"))
...
newAddMatterPermissionsRequest 
    ::  AddMatterPermissionsRequest
newAddMatterPermissionsRequest
  = AddMatterPermissionsRequest{ccMe = Core.Nothing,
                                matterPermission = Core.Nothing, sendEmails = Core.Nothing}
          ...
          = Core.withObject "AddMatterPermissionsRequest"
              (\ o ->
                 AddMatterPermissionsRequest Core.<$>
                   (o Core..:? "ccMe") Core.<*> (o Core..:? "matterPermission")
...
instance Core.FromJSON CalendarExportOptions where
        parseJSON
          = Core.withObject "CalendarExportOptions"
...
newCalendarOptions 
    ::  CalendarOptions
newCalendarOptions
  = CalendarOptions{locationQuery = Core.Nothing,
                    minusWords = Core.Nothing, peopleQuery = Core.Nothing,
                    responseStatuses = Core.Nothing, versionDate = Core.Nothing}
instance Core.FromJSON CalendarOptions where
        parseJSON
          = Core.withObject "CalendarOptions"
              (\ o ->
                 CalendarOptions Core.<$>
                   (o Core..:? "locationQuery") Core.<*> (o Core..:? "minusWords")
...
newCloudStorageFile 
    ::  CloudStorageFile
newCloudStorageFile
  = CloudStorageFile{bucketName = Core.Nothing,
                     md5Hash = Core.Nothing, objectName = Core.Nothing,
                     size = Core.Nothing}
          ...
          = Core.withObject "CloudStorageFile"
              (\ o ->
                 CloudStorageFile Core.<$>
                   (o Core..:? "bucketName") Core.<*> (o Core..:? "md5Hash") Core.<*>
                     (o Core..:? "objectName")
...
newCorpusQuery 
    ::  CorpusQuery
newCorpusQuery
  = CorpusQuery{calendarQuery = Core.Nothing,
                driveQuery = Core.Nothing, groupsQuery = Core.Nothing,
                hangoutsChatQuery = Core.Nothing, mailQuery = Core.Nothing,
...
instance Core.FromJSON CorpusQuery where
        parseJSON
          = Core.withObject "CorpusQuery"
              (\ o ->
                 CorpusQuery Core.<$>
                   (o Core..:? "calendarQuery") Core.<*> (o Core..:? "driveQuery")
...
newCountArtifactsMetadata 
    ::  CountArtifactsMetadata
newCountArtifactsMetadata
  = CountArtifactsMetadata{endTime = Core.Nothing,
                           matterId = Core.Nothing, query = Core.Nothing,
          ...
          = Core.withObject "CountArtifactsMetadata"
              (\ o ->
                 CountArtifactsMetadata Core.<$>
                   (o Core..:? "endTime") Core.<*> (o Core..:? "matterId") Core.<*>
                     (o Core..:? "query")
...
newCountArtifactsResponse 
    ::  CountArtifactsResponse
newCountArtifactsResponse
  = CountArtifactsResponse{groupsCountResult = Core.Nothing,
                           mailCountResult = Core.Nothing, totalCount = Core.Nothing}
...
instance Core.FromJSON DriveDocumentIds where
        parseJSON
          = Core.withObject "DriveDocumentIds"
...
instance Core.FromJSON DriveDocumentInfo where
        parseJSON
          = Core.withObject "DriveDocumentInfo"
...
data DriveOptions = DriveOptions
    ...
    , includeTeamDrives :: (Core.Maybe Core.Bool)
      -- | Optional. Options to include or exclude documents in shared drives. We recommend using this field over include/shared/drives. This field overrides include/shared/drives and include/team/drives when set.
    , sharedDrivesOption :: (Core.Maybe DriveOptions_SharedDrivesOption)
...
newDriveOptions 
    ::  DriveOptions
newDriveOptions
  = DriveOptions{clientSideEncryptedOption = Core.Nothing,
                 includeSharedDrives = Core.Nothing,
                 includeTeamDrives = Core.Nothing,
                 sharedDrivesOption = Core.Nothing, versionDate = Core.Nothing}
              ...
              (\ o ->
                 DriveOptions Core.<$>
                   (o Core..:? "clientSideEncryptedOption") Core.<*>
                     ...
                     Core.<*> (o Core..:? "sharedDrivesOption")
                     Core.<*> (o Core..:? "versionDate"))
          ...
          = Core.object
              (Core.catMaybes
                 [("clientSideEncryptedOption" Core..=) Core.<$>
                  ...
                  ("sharedDrivesOption" Core..=) Core.<$> sharedDrivesOption,
                  ("versionDate" Core..=) Core.<$> versionDate])
...
newExport 
    ::  Export
newExport
  = Export{cloudStorageSink = Core.Nothing,
           createTime = Core.Nothing, exportOptions = Core.Nothing,
           id = Core.Nothing, matterId = Core.Nothing, name = Core.Nothing,
           parentExportId = Core.Nothing, query = Core.Nothing,
           requester = Core.Nothing, stats = Core.Nothing,
           status = Core.Nothing}
instance Core.FromJSON Export where
        parseJSON
          = Core.withObject "Export"
              (\ o ->
                 Export Core.<$>
                   (o Core..:? "cloudStorageSink") Core.<*> (o Core..:? "createTime")
          ...
          = Core.object
              (Core.catMaybes
                 [("cloudStorageSink" Core..=) Core.<$> cloudStorageSink,
                  ...
                  ("id" Core..=) Core.<$> id, ("matterId" Core..=) Core.<$> matterId,
                  ("name" Core..=) Core.<$> name,
...
newExportOptions 
    ::  ExportOptions
newExportOptions
  = ExportOptions{calendarOptions = Core.Nothing,
                  driveOptions = Core.Nothing, geminiOptions = Core.Nothing,
                  groupsOptions = Core.Nothing, hangoutsChatOptions = Core.Nothing,
                  mailOptions = Core.Nothing, region = Core.Nothing,
...
instance Core.FromJSON ExportOptions where
        parseJSON
          = Core.withObject "ExportOptions"
              (\ o ->
                 ExportOptions Core.<$>
                   (o Core..:? "calendarOptions") Core.<*> (o Core..:? "driveOptions")
...
newExportStats 
    ::  ExportStats
newExportStats
  = ExportStats{exportedArtifactCount = Core.Nothing,
                sizeInBytes = Core.Nothing, totalArtifactCount = Core.Nothing}
              ...
              (\ o ->
                 ExportStats Core.<$>
                   (o Core..:? "exportedArtifactCount" Core.<&>
                     ...
                     Core.<*>
                     (o Core..:? "sizeInBytes" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*>
...
instance Core.ToJSON ExportStats where
        toJSON ExportStats{..}
          = Core.object
              (Core.catMaybes
                 [("exportedArtifactCount" Core..=) Core.. Core.AsText Core.<$>
                    exportedArtifactCount,
                  ("sizeInBytes" Core..=) Core.. Core.AsText Core.<$> sizeInBytes,
                  ("totalArtifactCount" Core..=) Core.. Core.AsText Core.<$>
                    totalArtifactCount])
...
instance Core.FromJSON GeminiExportOptions where
        parseJSON
          = Core.withObject "GeminiExportOptions"
...
newGroupsCountResult 
    ::  GroupsCountResult
newGroupsCountResult
  = GroupsCountResult{accountCountErrors = Core.Nothing,
                      accountCounts = Core.Nothing, matchingAccountsCount = Core.Nothing,
          ...
          = Core.object
              (Core.catMaybes
                 [("accountCountErrors" Core..=) Core.<$> accountCountErrors,
                  ...
                  ("matchingAccountsCount" Core..=) Core.. Core.AsText Core.<$>
                    matchingAccountsCount,
                  ("nonQueryableAccounts" Core..=) Core.<$> nonQueryableAccounts,
                  ("queriedAccountsCount" Core..=) Core.. Core.AsText Core.<$>
...
newtype HangoutsChatInfo = HangoutsChatInfo
    {
      -- | A list of Chat spaces IDs, as provided by the <https://developers.google.com/workspace/chat Chat API>. There is a limit of exporting from 500 Chat spaces per request.
...
newHeldAccount 
    ::  HeldAccount
newHeldAccount
  = HeldAccount{accountId = Core.Nothing, email = Core.Nothing,
                firstName = Core.Nothing, holdTime = Core.Nothing,
...
instance Core.FromJSON HeldAccount where
        parseJSON
          = Core.withObject "HeldAccount"
              (\ o ->
                 HeldAccount Core.<$>
                   (o Core..:? "accountId") Core.<*> (o Core..:? "email") Core.<*>
                     (o Core..:? "firstName")
...
instance Core.FromJSON HeldCalendarQuery where
        parseJSON
          = Core.withObject "HeldCalendarQuery"
...
newHeldDriveQuery 
    ::  HeldDriveQuery
newHeldDriveQuery
  = HeldDriveQuery{includeSharedDriveFiles = Core.Nothing,
...
newHeldGroupsQuery 
    ::  HeldGroupsQuery
newHeldGroupsQuery
  = HeldGroupsQuery{endTime = Core.Nothing, startTime = Core.Nothing,
                    terms = Core.Nothing}
...
newHeldMailQuery 
    ::  HeldMailQuery
newHeldMailQuery
  = HeldMailQuery{endTime = Core.Nothing, startTime = Core.Nothing,
                  terms = Core.Nothing}
...
instance Core.FromJSON HeldOrgUnit where
        parseJSON
          = Core.withObject "HeldOrgUnit"
              (\ o ->
                 HeldOrgUnit Core.<$>
                   (o Core..:? "holdTime") Core.<*> (o Core..:? "orgUnitId"))
...
newHold 
    ::  Hold
newHold
  = Hold{accounts = Core.Nothing, corpus = Core.Nothing,
         holdId = Core.Nothing, name = Core.Nothing, orgUnit = Core.Nothing,
         query = Core.Nothing, updateTime = Core.Nothing}
instance Core.FromJSON Hold where
        parseJSON
          = Core.withObject "Hold"
              (\ o ->
                 Hold Core.<$>
                   (o Core..:? "accounts") Core.<*> (o Core..:? "corpus") Core.<*>
                     (o Core..:? "holdId")
                     Core.<*> (o Core..:? "name")
                     Core.<*> (o Core..:? "orgUnit")
                     Core.<*> (o Core..:? "query")
          ...
          = Core.object
              (Core.catMaybes
                 [("accounts" Core..=) Core.<$> accounts,
                  ...
                  ("holdId" Core..=) Core.<$> holdId, ("name" Core..=) Core.<$> name,
          ...
          = Core.withObject "ListExportsResponse"
              (\ o ->
                 ListExportsResponse Core.<$>
                   (o Core..:? "exports") Core.<*> (o Core..:? "nextPageToken"))
...
newListHoldsResponse 
    ::  ListHoldsResponse
newListHoldsResponse
  = ListHoldsResponse{holds = Core.Nothing,
                      nextPageToken = Core.Nothing}
          ...
          = Core.withObject "ListHoldsResponse"
              (\ o ->
                 ListHoldsResponse Core.<$>
                   (o Core..:? "holds") Core.<*> (o Core..:? "nextPageToken"))
...
newListMattersResponse 
    ::  ListMattersResponse
newListMattersResponse
  = ListMattersResponse{matters = Core.Nothing,
                        nextPageToken = Core.Nothing}
          ...
          = Core.withObject "ListMattersResponse"
              (\ o ->
                 ListMattersResponse Core.<$>
                   (o Core..:? "matters") Core.<*> (o Core..:? "nextPageToken"))
...
newMailCountResult 
    ::  MailCountResult
newMailCountResult
  = MailCountResult{accountCountErrors = Core.Nothing,
                    accountCounts = Core.Nothing, matchingAccountsCount = Core.Nothing,
                    nonQueryableAccounts = Core.Nothing,
                    queriedAccountsCount = Core.Nothing}
...
newMailExportOptions 
    ::  MailExportOptions
newMailExportOptions
  = MailExportOptions{exportFormat = Core.Nothing,
...
newMailOptions 
    ::  MailOptions
newMailOptions
  = MailOptions{clientSideEncryptedOption = Core.Nothing,
...
newMatter 
    ::  Matter
newMatter
  = Matter{description = Core.Nothing, matterId = Core.Nothing,
           matterPermissions = Core.Nothing, matterRegion = Core.Nothing,
...
instance Core.FromJSON Matter where
        parseJSON
          = Core.withObject "Matter"
              (\ o ->
                 Matter Core.<$>
                   (o Core..:? "description") Core.<*> (o Core..:? "matterId")
          ...
          = Core.withObject "MatterPermission"
              (\ o ->
                 MatterPermission Core.<$>
                   (o Core..:? "accountId") Core.<*> (o Core..:? "role"))
...
newQuery 
    ::  Query
newQuery
  = Query{accountInfo = Core.Nothing, calendarOptions = Core.Nothing,
          corpus = Core.Nothing, dataScope = Core.Nothing,
          driveDocumentInfo = Core.Nothing, driveOptions = Core.Nothing,
          endTime = Core.Nothing, geminiOptions = Core.Nothing,
          hangoutsChatInfo = Core.Nothing,
          hangoutsChatOptions = Core.Nothing, mailOptions = Core.Nothing,
          method = Core.Nothing, orgUnitInfo = Core.Nothing,
          searchMethod = Core.Nothing, sharedDriveInfo = Core.Nothing,
          sitesUrlInfo = Core.Nothing, startTime = Core.Nothing,
          teamDriveInfo = Core.Nothing, terms = Core.Nothing,
          timeZone = Core.Nothing, voiceOptions = Core.Nothing}
instance Core.FromJSON Query where
        parseJSON
          = Core.withObject "Query"
              (\ o ->
                 Query Core.<$>
                   (o Core..:? "accountInfo") Core.<*> (o Core..:? "calendarOptions")
                     Core.<*> (o Core..:? "corpus")
...
newSavedQuery 
    ::  SavedQuery
newSavedQuery
  = SavedQuery{createTime = Core.Nothing, displayName = Core.Nothing,
               matterId = Core.Nothing, query = Core.Nothing,
...
instance Core.FromJSON UserInfo where
        parseJSON
          = Core.withObject "UserInfo"
              (\ o ->
                 UserInfo Core.<$>
                   (o Core..:? "displayName") Core.<*> (o Core..:? "email"))
