...
--
-- /See:/ <https://developers.google.com/workspace/vault Google Vault API Reference> for @vault.operations.get@.
module Gogol.Vault.Operations.Get
    (
    -- * Resource
...
newVaultOperationsGet name
  = VaultOperationsGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest VaultOperationsGet where
        ...
        type Scopes VaultOperationsGet =
