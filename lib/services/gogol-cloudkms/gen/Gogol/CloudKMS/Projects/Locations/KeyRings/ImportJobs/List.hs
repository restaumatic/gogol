                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Get '[Core.JSON] ListImportJobsResponse
...
newCloudKMSProjectsLocationsKeyRingsImportJobsList parent
  = CloudKMSProjectsLocationsKeyRingsImportJobsList{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           CloudKMSProjectsLocationsKeyRingsImportJobsList
         where
        type Rs CloudKMSProjectsLocationsKeyRingsImportJobsList =
             ListImportJobsResponse
        type Scopes CloudKMSProjectsLocationsKeyRingsImportJobsList =
             '[CloudPlatform'FullControl, Cloudkms'FullControl]
        requestClient CloudKMSProjectsLocationsKeyRingsImportJobsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudKMSProjectsLocationsKeyRingsImportJobsListResource)
                      Core.mempty
