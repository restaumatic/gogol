...
-- |
-- Module      : Gogol.CloudKMS.Projects.Locations.KeyRings.CryptoKeys.GetIamPolicy
...
-- 'CloudKMSProjectsLocationsKeyRingsCryptoKeysGetIamPolicy' request conforms to.
type CloudKMSProjectsLocationsKeyRingsCryptoKeysGetIamPolicyResource
     =
     "v1" Core.:>
...
-- | Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
--
-- /See:/ 'newCloudKMSProjectsLocationsKeyRingsCryptoKeysGetIamPolicy' smart constructor.
data CloudKMSProjectsLocationsKeyRingsCryptoKeysGetIamPolicy = CloudKMSProjectsLocationsKeyRingsCryptoKeysGetIamPolicy
    {
      -- | V1 error format.
...
-- | Creates a value of 'CloudKMSProjectsLocationsKeyRingsCryptoKeysGetIamPolicy' with the minimum fields required to make a request.
newCloudKMSProjectsLocationsKeyRingsCryptoKeysGetIamPolicy 
    :: 
                                                           Core.Text
    ...
    -> CloudKMSProjectsLocationsKeyRingsCryptoKeysGetIamPolicy
newCloudKMSProjectsLocationsKeyRingsCryptoKeysGetIamPolicy resource
  = CloudKMSProjectsLocationsKeyRingsCryptoKeysGetIamPolicy{xgafv =
                                                              Core.Nothing,
...
instance Core.GoogleRequest
           CloudKMSProjectsLocationsKeyRingsCryptoKeysGetIamPolicy
         where
        type Rs CloudKMSProjectsLocationsKeyRingsCryptoKeysGetIamPolicy =
             Policy
        type Scopes CloudKMSProjectsLocationsKeyRingsCryptoKeysGetIamPolicy
