...
-- |
-- Module      : Gogol.CloudKMS.Projects.Locations.KeyRings.ImportJobs.GetIamPolicy
...
-- 'CloudKMSProjectsLocationsKeyRingsImportJobsGetIamPolicy' request conforms to.
type CloudKMSProjectsLocationsKeyRingsImportJobsGetIamPolicyResource
     =
     "v1" Core.:>
...
-- | Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set.
--
-- /See:/ 'newCloudKMSProjectsLocationsKeyRingsImportJobsGetIamPolicy' smart constructor.
data CloudKMSProjectsLocationsKeyRingsImportJobsGetIamPolicy = CloudKMSProjectsLocationsKeyRingsImportJobsGetIamPolicy
    {
      -- | V1 error format.
...
-- | Creates a value of 'CloudKMSProjectsLocationsKeyRingsImportJobsGetIamPolicy' with the minimum fields required to make a request.
newCloudKMSProjectsLocationsKeyRingsImportJobsGetIamPolicy 
    :: 
                                                           Core.Text
    ...
    -> CloudKMSProjectsLocationsKeyRingsImportJobsGetIamPolicy
newCloudKMSProjectsLocationsKeyRingsImportJobsGetIamPolicy resource
  = CloudKMSProjectsLocationsKeyRingsImportJobsGetIamPolicy{xgafv =
                                                              Core.Nothing,
...
instance Core.GoogleRequest
           CloudKMSProjectsLocationsKeyRingsImportJobsGetIamPolicy
         where
        type Rs CloudKMSProjectsLocationsKeyRingsImportJobsGetIamPolicy =
             Policy
        type Scopes CloudKMSProjectsLocationsKeyRingsImportJobsGetIamPolicy
