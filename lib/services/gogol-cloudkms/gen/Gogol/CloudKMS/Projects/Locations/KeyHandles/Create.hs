           ...
           Core.QueryParam "$.xgafv" Xgafv Core.:>
             Core.QueryParam "access_token" Core.Text Core.:>
               Core.QueryParam "callback" Core.Text Core.:>
                 Core.QueryParam "keyHandleId" Core.Text Core.:>
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] KeyHandle Core.:>
...
newCloudKMSProjectsLocationsKeyHandlesCreate parent payload
  = CloudKMSProjectsLocationsKeyHandlesCreate{xgafv = Core.Nothing,
                                              accessToken = Core.Nothing, callback = Core.Nothing,
                                              keyHandleId = Core.Nothing, parent = parent,
...
instance Core.GoogleRequest
        ...
        type Scopes CloudKMSProjectsLocationsKeyHandlesCreate =
             '[CloudPlatform'FullControl, Cloudkms'FullControl]
        requestClient CloudKMSProjectsLocationsKeyHandlesCreate{..}
          = go parent xgafv accessToken callback keyHandleId uploadType
              uploadProtocol
