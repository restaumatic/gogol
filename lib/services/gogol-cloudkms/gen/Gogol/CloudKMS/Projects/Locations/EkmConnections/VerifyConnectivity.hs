...
type CloudKMSProjectsLocationsEkmConnectionsVerifyConnectivityResource
     =
     "v1" Core.:>
       Core.CaptureMode "name" "verifyConnectivity" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.Get '[Core.JSON] VerifyConnectivityResponse
...
newCloudKMSProjectsLocationsEkmConnectionsVerifyConnectivity name
  = CloudKMSProjectsLocationsEkmConnectionsVerifyConnectivity{xgafv =
                                                                Core.Nothing,
...
instance Core.GoogleRequest
           CloudKMSProjectsLocationsEkmConnectionsVerifyConnectivity
         where
        type Rs CloudKMSProjectsLocationsEkmConnectionsVerifyConnectivity =
