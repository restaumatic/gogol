...
type CloudKMSProjectsLocationsKeyRingsCryptoKeysCryptoKeyVersionsMacSignResource
     =
     "v1" Core.:>
       Core.CaptureMode "name" "macSign" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] MacSignRequest Core.:>
                       Core.Post '[Core.JSON] MacSignResponse
...
newCloudKMSProjectsLocationsKeyRingsCryptoKeysCryptoKeyVersionsMacSign
  name payload
  = CloudKMSProjectsLocationsKeyRingsCryptoKeysCryptoKeyVersionsMacSign{xgafv
                                                                          = Core.Nothing,
