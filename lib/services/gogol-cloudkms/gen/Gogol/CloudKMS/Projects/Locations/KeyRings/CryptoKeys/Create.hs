             ...
             Core.QueryParam "access_token" Core.Text Core.:>
               Core.QueryParam "callback" Core.Text Core.:>
                 Core.QueryParam "cryptoKeyId" Core.Text Core.:>
                   Core.QueryParam "skipInitialVersionCreation" Core.Bool Core.:>
...
newCloudKMSProjectsLocationsKeyRingsCryptoKeysCreate parent payload
  = CloudKMSProjectsLocationsKeyRingsCryptoKeysCreate{xgafv =
                                                        Core.Nothing,
                                                      accessToken = Core.Nothing,
                                                      callback = Core.Nothing,
                                                      cryptoKeyId = Core.Nothing, parent = parent,
                                                      payload = payload,
...
instance Core.GoogleRequest
           CloudKMSProjectsLocationsKeyRingsCryptoKeysCreate
         where
        type Rs CloudKMSProjectsLocationsKeyRingsCryptoKeysCreate =
             CryptoKey
        type Scopes CloudKMSProjectsLocationsKeyRingsCryptoKeysCreate =
             '[CloudPlatform'FullControl, Cloudkms'FullControl]
        requestClient CloudKMSProjectsLocationsKeyRingsCryptoKeysCreate{..}
