...
type CloudKMSProjectsLocationsKeyRingsCryptoKeysCryptoKeyVersionsMacVerifyResource
     =
     "v1" Core.:>
       Core.CaptureMode "name" "macVerify" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] MacVerifyRequest Core.:>
                       Core.Post '[Core.JSON] MacVerifyResponse
...
newCloudKMSProjectsLocationsKeyRingsCryptoKeysCryptoKeyVersionsMacVerify
  name payload
  = CloudKMSProjectsLocationsKeyRingsCryptoKeysCryptoKeyVersionsMacVerify{xgafv
                                                                            = Core.Nothing,
                                                                          accessToken =
                                                                            Core.Nothing,
