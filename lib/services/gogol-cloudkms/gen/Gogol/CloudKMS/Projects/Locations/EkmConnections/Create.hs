...
newCloudKMSProjectsLocationsEkmConnectionsCreate parent payload
  = CloudKMSProjectsLocationsEkmConnectionsCreate{xgafv =
                                                    Core.Nothing,
                                                  accessToken = Core.Nothing,
                                                  callback = Core.Nothing,
                                                  ekmConnectionId = Core.Nothing, parent = parent,
...
instance Core.GoogleRequest
        ...
        type Rs CloudKMSProjectsLocationsEkmConnectionsCreate =
             EkmConnection
        type Scopes CloudKMSProjectsLocationsEkmConnectionsCreate =
             '[CloudPlatform'FullControl, Cloudkms'FullControl]
        requestClient CloudKMSProjectsLocationsEkmConnectionsCreate{..}
          = go parent xgafv accessToken callback ekmConnectionId uploadType
              uploadProtocol
