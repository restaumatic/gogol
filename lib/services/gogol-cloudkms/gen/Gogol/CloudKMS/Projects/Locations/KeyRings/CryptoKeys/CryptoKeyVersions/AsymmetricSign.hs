...
type CloudKMSProjectsLocationsKeyRingsCryptoKeysCryptoKeyVersionsAsymmetricSignResource
     =
     "v1" Core.:>
       Core.CaptureMode "name" "asymmetricSign" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] AsymmetricSignRequest Core.:>
                       Core.Post '[Core.JSON] AsymmetricSignResponse
...
newCloudKMSProjectsLocationsKeyRingsCryptoKeysCryptoKeyVersionsAsymmetricSign
  name payload
  = CloudKMSProjectsLocationsKeyRingsCryptoKeysCryptoKeyVersionsAsymmetricSign{xgafv
                                                                                 = Core.Nothing,
                                                                               accessToken =
                                                                                 Core.Nothing,
                                                                               callback =
