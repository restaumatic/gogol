                       ...
                       Core.QueryParam "pageToken" Core.Text Core.:>
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "versionView"
                               ProjectsLocationsKeyRingsCryptoKeysListVersionView
                               Core.:>
                               Core.QueryParam "alt" Core.AltJSON Core.:>
                                 Core.Get '[Core.JSON] ListCryptoKeysResponse
...
newCloudKMSProjectsLocationsKeyRingsCryptoKeysList parent
  = CloudKMSProjectsLocationsKeyRingsCryptoKeysList{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           CloudKMSProjectsLocationsKeyRingsCryptoKeysList
         where
        type Rs CloudKMSProjectsLocationsKeyRingsCryptoKeysList =
             ListCryptoKeysResponse
        type Scopes CloudKMSProjectsLocationsKeyRingsCryptoKeysList =
             '[CloudPlatform'FullControl, Cloudkms'FullControl]
        requestClient CloudKMSProjectsLocationsKeyRingsCryptoKeysList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudKMSProjectsLocationsKeyRingsCryptoKeysListResource)
                      Core.mempty
