...
newCloudKMSProjectsLocationsKeyRingsCryptoKeysGet name
  = CloudKMSProjectsLocationsKeyRingsCryptoKeysGet{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           CloudKMSProjectsLocationsKeyRingsCryptoKeysGet
         where
        type Rs CloudKMSProjectsLocationsKeyRingsCryptoKeysGet = CryptoKey
        type Scopes CloudKMSProjectsLocationsKeyRingsCryptoKeysGet =
             '[CloudPlatform'FullControl, Cloudkms'FullControl]
        requestClient CloudKMSProjectsLocationsKeyRingsCryptoKeysGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudKMSProjectsLocationsKeyRingsCryptoKeysGetResource)
                      Core.mempty
