...
newCloudKMSProjectsLocationsKeyHandlesList parent
  = CloudKMSProjectsLocationsKeyHandlesList{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            filter = Core.Nothing, pageSize = Core.Nothing,
                                            pageToken = Core.Nothing, parent = parent,
                                            uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudKMSProjectsLocationsKeyHandlesList
         where
        ...
        requestClient CloudKMSProjectsLocationsKeyHandlesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudKMSProjectsLocationsKeyHandlesListResource)
                      Core.mempty
