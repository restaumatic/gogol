...
newCloudKMSProjectsLocationsKeyRingsImportJobsCreate parent payload
  = CloudKMSProjectsLocationsKeyRingsImportJobsCreate{xgafv =
                                                        Core.Nothing,
                                                      accessToken = Core.Nothing,
                                                      callback = Core.Nothing,
                                                      importJobId = Core.Nothing, parent = parent,
                                                      payload = payload, uploadType = Core.Nothing,
                                                      uploadProtocol = Core.Nothing}
instance Core.GoogleRequest
           CloudKMSProjectsLocationsKeyRingsImportJobsCreate
         where
        type Rs CloudKMSProjectsLocationsKeyRingsImportJobsCreate =
             ImportJob
        type Scopes CloudKMSProjectsLocationsKeyRingsImportJobsCreate =
             '[CloudPlatform'FullControl, Cloudkms'FullControl]
        requestClient CloudKMSProjectsLocationsKeyRingsImportJobsCreate{..}
          = go parent xgafv accessToken callback importJobId uploadType
              uploadProtocol
