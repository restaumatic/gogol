...
-- |
-- Module      : Gogol.CloudKMS.Projects.Locations.KeyRings.TestIamPermissions
...
-- 'CloudKMSProjectsLocationsKeyRingsTestIamPermissions' request conforms to.
type CloudKMSProjectsLocationsKeyRingsTestIamPermissionsResource =
     "v1" Core.:>
...
-- | Returns permissions that a caller has on the specified resource. If the resource does not exist, this will return an empty set of permissions, not a @NOT_FOUND@ error. Note: This operation is designed to be used for building permission-aware UIs and command-line tools, not for authorization checking. This operation may \"fail open\" without warning.
--
-- /See:/ 'newCloudKMSProjectsLocationsKeyRingsTestIamPermissions' smart constructor.
data CloudKMSProjectsLocationsKeyRingsTestIamPermissions = CloudKMSProjectsLocationsKeyRingsTestIamPermissions
    {
      -- | V1 error format.
...
-- | Creates a value of 'CloudKMSProjectsLocationsKeyRingsTestIamPermissions' with the minimum fields required to make a request.
newCloudKMSProjectsLocationsKeyRingsTestIamPermissions 
    :: 
    ...
    -> CloudKMSProjectsLocationsKeyRingsTestIamPermissions
newCloudKMSProjectsLocationsKeyRingsTestIamPermissions payload
  resource
  = CloudKMSProjectsLocationsKeyRingsTestIamPermissions{xgafv =
                                                          Core.Nothing,
...
instance Core.GoogleRequest
           CloudKMSProjectsLocationsKeyRingsTestIamPermissions
         where
        type Rs CloudKMSProjectsLocationsKeyRingsTestIamPermissions =
             TestIamPermissionsResponse
        type Scopes CloudKMSProjectsLocationsKeyRingsTestIamPermissions =
