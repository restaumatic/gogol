           ...
           Core.QueryParam "$.xgafv" Xgafv Core.:>
             Core.QueryParam "access_token" Core.Text Core.:>
               Core.QueryParam "callback" Core.Text Core.:>
                 Core.QueryParam "keyRingId" Core.Text Core.:>
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] KeyRing Core.:>
                           Core.Post '[Core.JSON] KeyRing
...
newCloudKMSProjectsLocationsKeyRingsCreate parent payload
  = CloudKMSProjectsLocationsKeyRingsCreate{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            keyRingId = Core.Nothing, parent = parent,
                                            payload = payload, uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudKMSProjectsLocationsKeyRingsCreate
         where
        type Rs CloudKMSProjectsLocationsKeyRingsCreate = KeyRing
        type Scopes CloudKMSProjectsLocationsKeyRingsCreate =
             '[CloudPlatform'FullControl, Cloudkms'FullControl]
        requestClient CloudKMSProjectsLocationsKeyRingsCreate{..}
          = go parent xgafv accessToken callback keyRingId uploadType
              uploadProtocol
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudKMSProjectsLocationsKeyRingsCreateResource)
                      Core.mempty
