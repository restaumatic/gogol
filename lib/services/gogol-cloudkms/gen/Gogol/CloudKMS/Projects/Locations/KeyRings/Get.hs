...
newCloudKMSProjectsLocationsKeyRingsGet name
  = CloudKMSProjectsLocationsKeyRingsGet{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         name = name, uploadType = Core.Nothing,
                                         uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudKMSProjectsLocationsKeyRingsGet
         where
        type Rs CloudKMSProjectsLocationsKeyRingsGet = KeyRing
        type Scopes CloudKMSProjectsLocationsKeyRingsGet =
             '[CloudPlatform'FullControl, Cloudkms'FullControl]
        requestClient CloudKMSProjectsLocationsKeyRingsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudKMSProjectsLocationsKeyRingsGetResource)
                      Core.mempty
