                         ...
                         Core.QueryParam "uploadType" Core.Text Core.:>
                           Core.QueryParam "upload_protocol" Core.Text Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.Get '[Core.JSON] ListEkmConnectionsResponse
...
newCloudKMSProjectsLocationsEkmConnectionsList parent
  = CloudKMSProjectsLocationsEkmConnectionsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           CloudKMSProjectsLocationsEkmConnectionsList
         where
        type Rs CloudKMSProjectsLocationsEkmConnectionsList =
             ListEkmConnectionsResponse
        type Scopes CloudKMSProjectsLocationsEkmConnectionsList =
