...
newCloudKMSProjectsLocationsKeyRingsCryptoKeysPatch name payload
  = CloudKMSProjectsLocationsKeyRingsCryptoKeysPatch{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           CloudKMSProjectsLocationsKeyRingsCryptoKeysPatch
         where
        type Rs CloudKMSProjectsLocationsKeyRingsCryptoKeysPatch =
             CryptoKey
        type Scopes CloudKMSProjectsLocationsKeyRingsCryptoKeysPatch =
             '[CloudPlatform'FullControl, Cloudkms'FullControl]
        requestClient CloudKMSProjectsLocationsKeyRingsCryptoKeysPatch{..}
