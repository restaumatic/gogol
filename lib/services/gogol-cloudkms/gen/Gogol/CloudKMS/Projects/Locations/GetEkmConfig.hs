...
newCloudKMSProjectsLocationsGetEkmConfig name
  = CloudKMSProjectsLocationsGetEkmConfig{xgafv = Core.Nothing,
                                          accessToken = Core.Nothing, callback = Core.Nothing,
                                          name = name, uploadType = Core.Nothing,
                                          uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudKMSProjectsLocationsGetEkmConfig
         where
        type Rs CloudKMSProjectsLocationsGetEkmConfig = EkmConfig
        type Scopes CloudKMSProjectsLocationsGetEkmConfig =
