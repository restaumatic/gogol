                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] EkmConfig Core.:>
                         Core.Patch '[Core.JSON] EkmConfig
...
newCloudKMSProjectsLocationsUpdateEkmConfig name payload
  = CloudKMSProjectsLocationsUpdateEkmConfig{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           CloudKMSProjectsLocationsUpdateEkmConfig
         where
        type Rs CloudKMSProjectsLocationsUpdateEkmConfig = EkmConfig
        type Scopes CloudKMSProjectsLocationsUpdateEkmConfig =
             '[CloudPlatform'FullControl, Cloudkms'FullControl]
        requestClient CloudKMSProjectsLocationsUpdateEkmConfig{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudKMSProjectsLocationsUpdateEkmConfigResource)
                      Core.mempty
