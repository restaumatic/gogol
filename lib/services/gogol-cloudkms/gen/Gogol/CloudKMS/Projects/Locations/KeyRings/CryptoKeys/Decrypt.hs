...
type CloudKMSProjectsLocationsKeyRingsCryptoKeysDecryptResource =
     "v1" Core.:>
       Core.CaptureMode "name" "decrypt" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] DecryptRequest Core.:>
                       Core.Post '[Core.JSON] DecryptResponse
...
newCloudKMSProjectsLocationsKeyRingsCryptoKeysDecrypt name payload
  = CloudKMSProjectsLocationsKeyRingsCryptoKeysDecrypt{xgafv =
                                                         Core.Nothing,
...
instance Core.GoogleRequest
           CloudKMSProjectsLocationsKeyRingsCryptoKeysDecrypt
         where
        type Rs CloudKMSProjectsLocationsKeyRingsCryptoKeysDecrypt =
             DecryptResponse
        type Scopes CloudKMSProjectsLocationsKeyRingsCryptoKeysDecrypt =
