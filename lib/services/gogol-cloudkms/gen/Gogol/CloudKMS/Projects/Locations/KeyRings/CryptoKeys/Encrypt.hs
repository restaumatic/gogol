...
type CloudKMSProjectsLocationsKeyRingsCryptoKeysEncryptResource =
     "v1" Core.:>
       Core.CaptureMode "name" "encrypt" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] EncryptRequest Core.:>
                       Core.Post '[Core.JSON] EncryptResponse
...
newCloudKMSProjectsLocationsKeyRingsCryptoKeysEncrypt name payload
  = CloudKMSProjectsLocationsKeyRingsCryptoKeysEncrypt{xgafv =
                                                         Core.Nothing,
