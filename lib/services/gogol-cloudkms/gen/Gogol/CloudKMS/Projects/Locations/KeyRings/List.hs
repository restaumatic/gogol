...
newCloudKMSProjectsLocationsKeyRingsList parent
  = CloudKMSProjectsLocationsKeyRingsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest CloudKMSProjectsLocationsKeyRingsList
         where
        type Rs CloudKMSProjectsLocationsKeyRingsList =
             ListKeyRingsResponse
        type Scopes CloudKMSProjectsLocationsKeyRingsList =
             '[CloudPlatform'FullControl, Cloudkms'FullControl]
        requestClient CloudKMSProjectsLocationsKeyRingsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudKMSProjectsLocationsKeyRingsListResource)
                      Core.mempty
