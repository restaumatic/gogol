...
type CloudKMSProjectsLocationsKeyRingsCryptoKeysUpdatePrimaryVersionResource
     =
     "v1" Core.:>
       Core.CaptureMode "name" "updatePrimaryVersion" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] UpdateCryptoKeyPrimaryVersionRequest
...
newCloudKMSProjectsLocationsKeyRingsCryptoKeysUpdatePrimaryVersion
  name payload
  = CloudKMSProjectsLocationsKeyRingsCryptoKeysUpdatePrimaryVersion{xgafv
                                                                      = Core.Nothing,
