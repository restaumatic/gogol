...
type CloudKMSProjectsLocationsKeyRingsCryptoKeysCryptoKeyVersionsAsymmetricDecryptResource
     =
     "v1" Core.:>
       Core.CaptureMode "name" "asymmetricDecrypt" Core.Text Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] AsymmetricDecryptRequest Core.:>
                       Core.Post '[Core.JSON] AsymmetricDecryptResponse
...
newCloudKMSProjectsLocationsKeyRingsCryptoKeysCryptoKeyVersionsAsymmetricDecrypt
  name payload
  = CloudKMSProjectsLocationsKeyRingsCryptoKeysCryptoKeyVersionsAsymmetricDecrypt{xgafv
                                                                                    = Core.Nothing,
                                                                                  accessToken =
                                                                                    Core.Nothing,
                                                                                  callback =
