...
newCloudKMSProjectsLocationsKeyRingsSetIamPolicy payload resource
  = CloudKMSProjectsLocationsKeyRingsSetIamPolicy{xgafv =
                                                    Core.Nothing,
...
instance Core.GoogleRequest
           CloudKMSProjectsLocationsKeyRingsSetIamPolicy
         where
        type Rs CloudKMSProjectsLocationsKeyRingsSetIamPolicy = Policy
        type Scopes CloudKMSProjectsLocationsKeyRingsSetIamPolicy =
             '[CloudPlatform'FullControl, Cloudkms'FullControl]
        requestClient CloudKMSProjectsLocationsKeyRingsSetIamPolicy{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudKMSProjectsLocationsKeyRingsSetIamPolicyResource)
                      Core.mempty
