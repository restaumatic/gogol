...
newCloudKMSProjectsLocationsKeyRingsImportJobsSetIamPolicy 
    ...
    -> CloudKMSProjectsLocationsKeyRingsImportJobsSetIamPolicy
newCloudKMSProjectsLocationsKeyRingsImportJobsSetIamPolicy payload
  resource
  = CloudKMSProjectsLocationsKeyRingsImportJobsSetIamPolicy{xgafv =
                                                              Core.Nothing,
...
instance Core.GoogleRequest
           CloudKMSProjectsLocationsKeyRingsImportJobsSetIamPolicy
         where
        type Rs CloudKMSProjectsLocationsKeyRingsImportJobsSetIamPolicy =
             Policy
        type Scopes CloudKMSProjectsLocationsKeyRingsImportJobsSetIamPolicy
