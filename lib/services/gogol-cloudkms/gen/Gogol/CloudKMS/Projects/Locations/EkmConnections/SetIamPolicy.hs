...
newCloudKMSProjectsLocationsEkmConnectionsSetIamPolicy 
    ...
    -> CloudKMSProjectsLocationsEkmConnectionsSetIamPolicy
newCloudKMSProjectsLocationsEkmConnectionsSetIamPolicy payload
  resource
...
instance Core.GoogleRequest
           CloudKMSProjectsLocationsEkmConnectionsSetIamPolicy
         where
        type Rs CloudKMSProjectsLocationsEkmConnectionsSetIamPolicy =
             Policy
        type Scopes CloudKMSProjectsLocationsEkmConnectionsSetIamPolicy =
