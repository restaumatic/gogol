               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.Get '[Core.JSON] EkmConnection
...
newCloudKMSProjectsLocationsEkmConnectionsGet name
  = CloudKMSProjectsLocationsEkmConnectionsGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           CloudKMSProjectsLocationsEkmConnectionsGet
         where
        type Rs CloudKMSProjectsLocationsEkmConnectionsGet = EkmConnection
        type Scopes CloudKMSProjectsLocationsEkmConnectionsGet =
             '[CloudPlatform'FullControl, Cloudkms'FullControl]
        requestClient CloudKMSProjectsLocationsEkmConnectionsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudKMSProjectsLocationsEkmConnectionsGetResource)
                      Core.mempty
