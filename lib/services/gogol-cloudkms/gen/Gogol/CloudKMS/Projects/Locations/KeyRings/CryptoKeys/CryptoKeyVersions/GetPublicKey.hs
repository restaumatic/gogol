           ...
           Core.QueryParam "$.xgafv" Xgafv Core.:>
             Core.QueryParam "access_token" Core.Text Core.:>
               Core.QueryParam "callback" Core.Text Core.:>
                 Core.QueryParam "publicKeyFormat"
...
newCloudKMSProjectsLocationsKeyRingsCryptoKeysCryptoKeyVersionsGetPublicKey
  name
  = CloudKMSProjectsLocationsKeyRingsCryptoKeysCryptoKeyVersionsGetPublicKey{xgafv
                                                                               = Core.Nothing,
                                                                             accessToken =
                                                                               Core.Nothing,
                                                                             callback =
...
instance Core.GoogleRequest
        ...
        requestClient
          CloudKMSProjectsLocationsKeyRingsCryptoKeysCryptoKeyVersionsGetPublicKey{..}
          = go name xgafv accessToken callback publicKeyFormat uploadType
              uploadProtocol
