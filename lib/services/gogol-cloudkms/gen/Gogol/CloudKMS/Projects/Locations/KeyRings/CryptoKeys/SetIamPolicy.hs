...
newCloudKMSProjectsLocationsKeyRingsCryptoKeysSetIamPolicy 
    ...
    -> CloudKMSProjectsLocationsKeyRingsCryptoKeysSetIamPolicy
newCloudKMSProjectsLocationsKeyRingsCryptoKeysSetIamPolicy payload
  resource
  = CloudKMSProjectsLocationsKeyRingsCryptoKeysSetIamPolicy{xgafv =
                                                              Core.Nothing,
...
instance Core.GoogleRequest
           CloudKMSProjectsLocationsKeyRingsCryptoKeysSetIamPolicy
         where
        type Rs CloudKMSProjectsLocationsKeyRingsCryptoKeysSetIamPolicy =
             Policy
        type Scopes CloudKMSProjectsLocationsKeyRingsCryptoKeysSetIamPolicy
