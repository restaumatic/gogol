...
type CloudKMSProjectsShowEffectiveAutokeyConfigResource =
     "v1" Core.:>
       Core.CaptureMode "parent" "showEffectiveAutokeyConfig" Core.Text
         Core.:>
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.Get '[Core.JSON] ShowEffectiveAutokeyConfigResponse
...
newCloudKMSProjectsShowEffectiveAutokeyConfig parent
  = CloudKMSProjectsShowEffectiveAutokeyConfig{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        requestClient CloudKMSProjectsShowEffectiveAutokeyConfig{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy CloudKMSProjectsShowEffectiveAutokeyConfigResource)
                      Core.mempty
