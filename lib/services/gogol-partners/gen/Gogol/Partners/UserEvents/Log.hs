               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] LogUserEventRequest Core.:>
                       Core.Post '[Core.JSON] LogUserEventResponse
...
newPartnersUserEventsLog payload
  = PartnersUserEventsLog{xgafv = Core.Nothing,
...
instance Core.GoogleRequest PartnersUserEventsLog where
        ...
        requestClient PartnersUserEventsLog{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy PartnersUserEventsLogResource)
                      Core.mempty
