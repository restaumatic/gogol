           ...
           Core.QueryParam "$.xgafv" Xgafv Core.:>
             Core.QueryParam "access_token" Core.Text Core.:>
               Core.QueryParam "callback" Core.Text Core.:>
                 Core.QueryParam "entireCompany" Core.Bool Core.:>
                             ...
                             Core.QueryParam "requestMetadata.partnersSessionId" Core.Text
                               ...
                               Core.QueryParam "requestMetadata.trafficSource.trafficSourceId"
                                 ...
                                 Core.QueryParam "requestMetadata.trafficSource.trafficSubId"
                                   Core.Text
                                   Core.:>
                                   Core.QueryParam "requestMetadata.userOverrides.ipAddress"
                                     Core.Text
                                     Core.:>
                                     Core.QueryParam "requestMetadata.userOverrides.userId"
                                       Core.Text
                                       Core.:>
                                       Core.QueryParam "uploadType" Core.Text Core.:>
                                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                                           Core.QueryParam "alt" Core.AltJSON Core.:>
                                             Core.Get '[Core.JSON] ListOffersHistoryResponse
...
newPartnersOffersHistoryList 
    ::  PartnersOffersHistoryList
newPartnersOffersHistoryList
  = PartnersOffersHistoryList{xgafv = Core.Nothing,
                              accessToken = Core.Nothing, callback = Core.Nothing,
                              entireCompany = Core.Nothing, orderBy = Core.Nothing,
...
instance Core.GoogleRequest PartnersOffersHistoryList where
        type Rs PartnersOffersHistoryList = ListOffersHistoryResponse
        type Scopes PartnersOffersHistoryList = '[]
        requestClient PartnersOffersHistoryList{..}
          = go xgafv accessToken callback entireCompany orderBy pageSize
              pageToken
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy PartnersOffersHistoryListResource)
                      Core.mempty
