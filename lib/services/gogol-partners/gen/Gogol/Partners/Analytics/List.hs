...
-- |
-- Module      : Gogol.Partners.Analytics.List
                                 ...
                                 Core.QueryParam "uploadType" Core.Text Core.:>
                                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                                     Core.QueryParam "alt" Core.AltJSON Core.:>
                                       Core.Get '[Core.JSON] ListAnalyticsResponse
...
newPartnersAnalyticsList 
    ::  PartnersAnalyticsList
newPartnersAnalyticsList
  = PartnersAnalyticsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest PartnersAnalyticsList where
        ...
        requestClient PartnersAnalyticsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy PartnersAnalyticsListResource)
                      Core.mempty
