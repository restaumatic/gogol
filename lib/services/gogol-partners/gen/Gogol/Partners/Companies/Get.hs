...
-- |
-- Module      : Gogol.Partners.Companies.Get
                                   ...
                                   Core.QueryParam "requestMetadata.userOverrides.userId" Core.Text
                                     ...
                                     Core.QueryParam "uploadType" Core.Text Core.:>
                                       Core.QueryParam "upload_protocol" Core.Text Core.:>
                                         Core.QueryParam "view" Core.Text Core.:>
                                           Core.QueryParam "alt" Core.AltJSON Core.:>
                                             Core.Get '[Core.JSON] GetCompanyResponse
...
newPartnersCompaniesGet companyId
  = PartnersCompaniesGet{xgafv = Core.Nothing,
                         accessToken = Core.Nothing, address = Core.Nothing,
                         callback = Core.Nothing, companyId = companyId,
                         currencyCode = Core.Nothing, orderBy = Core.Nothing,
...
instance Core.GoogleRequest PartnersCompaniesGet where
        ...
        requestClient PartnersCompaniesGet{..}
          = go companyId xgafv accessToken address callback currencyCode
              orderBy
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy PartnersCompaniesGetResource)
                      Core.mempty
