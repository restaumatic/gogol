                   ...
                   Core.QueryParams "gpsMotivations" Core.Text Core.:>
                     Core.QueryParams "industries" Core.Text Core.:>
                       Core.QueryParams "languageCodes" Core.Text Core.:>
                         Core.QueryParam "maxMonthlyBudget.currencyCode" Core.Text Core.:>
                           Core.QueryParam "maxMonthlyBudget.nanos" Core.Int32 Core.:>
                             Core.QueryParam "maxMonthlyBudget.units" Core.Int64 Core.:>
                               Core.QueryParam "minMonthlyBudget.currencyCode" Core.Text Core.:>
                                 Core.QueryParam "minMonthlyBudget.nanos" Core.Int32 Core.:>
                                   Core.QueryParam "minMonthlyBudget.units" Core.Int64 Core.:>
                                                   ...
                                                   Core.QueryParam
                                                     ...
                                                     Core.QueryParam
                                                       ...
                                                       Core.QueryParam
                                                         ...
                                                         Core.Text
                                                         Core.:>
                                                         Core.QueryParams "services" Core.Text
                                                           Core.:>
                                                           Core.QueryParams "specializations"
                                                             Core.Text
                                                             Core.:>
                                                             Core.QueryParam "uploadType" Core.Text
                                                               ...
                                                               Core.QueryParam "upload_protocol"
                                                                 Core.Text
                                                                 Core.:>
                                                                 Core.QueryParam "view" Core.Text
                                                                   Core.:>
                                                                   Core.QueryParam "websiteUrl"
                                                                     Core.Text
                                                                     Core.:>
                                                                     Core.QueryParam "alt"
                                                                       Core.AltJSON
...
newPartnersCompaniesList 
    ::  PartnersCompaniesList
newPartnersCompaniesList
  = PartnersCompaniesList{xgafv = Core.Nothing,
                          accessToken = Core.Nothing, address = Core.Nothing,
                          callback = Core.Nothing, companyName = Core.Nothing,
                          gpsMotivations = Core.Nothing, industries = Core.Nothing,
                          ...
                          minMonthlyBudgetUnits = Core.Nothing, orderBy = Core.Nothing,
                          ...
                          services = Core.Nothing, specializations = Core.Nothing,
                          uploadType = Core.Nothing, uploadProtocol = Core.Nothing,
                          view = Core.Nothing, websiteUrl = Core.Nothing}
instance Core.GoogleRequest PartnersCompaniesList where
        ...
        requestClient PartnersCompaniesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy PartnersCompaniesListResource)
                      Core.mempty
