...
newAdWordsManagerAccountInfo 
    ::  AdWordsManagerAccountInfo
newAdWordsManagerAccountInfo
  = AdWordsManagerAccountInfo{customerName = Core.Nothing,
                              id = Core.Nothing}
instance Core.FromJSON AdWordsManagerAccountInfo where
        parseJSON
          = Core.withObject "AdWordsManagerAccountInfo"
              (\ o ->
                 AdWordsManagerAccountInfo Core.<$>
                   (o Core..:? "customerName") Core.<*>
...
newAnalytics 
    ::  Analytics
newAnalytics
  = Analytics{contacts = Core.Nothing, eventDate = Core.Nothing,
              profileViews = Core.Nothing, searchViews = Core.Nothing}
instance Core.FromJSON Analytics where
        parseJSON
          = Core.withObject "Analytics"
              (\ o ->
                 Analytics Core.<$>
                   (o Core..:? "contacts") Core.<*> (o Core..:? "eventDate") Core.<*>
                     (o Core..:? "profileViews")
...
newAnalyticsDataPoint 
    ::  AnalyticsDataPoint
newAnalyticsDataPoint
  = AnalyticsDataPoint{eventCount = Core.Nothing,
                       eventLocations = Core.Nothing}
instance Core.FromJSON AnalyticsDataPoint where
        parseJSON
          = Core.withObject "AnalyticsDataPoint"
              (\ o ->
                 AnalyticsDataPoint Core.<$>
                   (o Core..:? "eventCount") Core.<*> (o Core..:? "eventLocations"))
...
newAnalyticsSummary 
    ::  AnalyticsSummary
newAnalyticsSummary
  = AnalyticsSummary{contactsCount = Core.Nothing,
                     profileViewsCount = Core.Nothing, searchViewsCount = Core.Nothing}
instance Core.FromJSON AnalyticsSummary where
        parseJSON
          = Core.withObject "AnalyticsSummary"
              (\ o ->
                 AnalyticsSummary Core.<$>
                   (o Core..:? "contactsCount") Core.<*>
                     (o Core..:? "profileViewsCount")
          ...
          = Core.object
              (Core.catMaybes
                 [("contactsCount" Core..=) Core.<$> contactsCount,
                  ("profileViewsCount" Core..=) Core.<$> profileViewsCount,
                  ("searchViewsCount" Core..=) Core.<$> searchViewsCount])
...
newAvailableOffer 
    ::  AvailableOffer
newAvailableOffer
  = AvailableOffer{available = Core.Nothing,
                   countryOfferInfos = Core.Nothing, description = Core.Nothing,
                   id = Core.Nothing, maxAccountAge = Core.Nothing,
                   name = Core.Nothing, offerLevel = Core.Nothing,
                   offerType = Core.Nothing, qualifiedCustomer = Core.Nothing,
                   qualifiedCustomersComplete = Core.Nothing,
                   showSpecialOfferCopy = Core.Nothing, terms = Core.Nothing}
instance Core.FromJSON AvailableOffer where
        parseJSON
          = Core.withObject "AvailableOffer"
              (\ o ->
                 AvailableOffer Core.<$>
                   (o Core..:? "available") Core.<*> (o Core..:? "countryOfferInfos")
          ...
          = Core.object
              (Core.catMaybes
                 [("available" Core..=) Core.<$> available,
                  ("countryOfferInfos" Core..=) Core.<$> countryOfferInfos,
                  ...
                  ("qualifiedCustomer" Core..=) Core.<$> qualifiedCustomer,
                  ("qualifiedCustomersComplete" Core..=) Core.<$>
                    qualifiedCustomersComplete,
                  ("showSpecialOfferCopy" Core..=) Core.<$> showSpecialOfferCopy,
...
newCertification 
    ::  Certification
newCertification
  = Certification{achieved = Core.Nothing,
                  certificationType = Core.Nothing, expiration = Core.Nothing,
                  lastAchieved = Core.Nothing, warning = Core.Nothing}
instance Core.FromJSON Certification where
        parseJSON
          = Core.withObject "Certification"
              (\ o ->
                 Certification Core.<$>
                   (o Core..:? "achieved") Core.<*> (o Core..:? "certificationType")
          ...
          = Core.object
              (Core.catMaybes
                 [("achieved" Core..=) Core.<$> achieved,
                  ("certificationType" Core..=) Core.<$> certificationType,
...
newCertificationExamStatus 
    ::  CertificationExamStatus
newCertificationExamStatus
  = CertificationExamStatus{numberUsersPass = Core.Nothing,
                            type' = Core.Nothing}
instance Core.FromJSON CertificationExamStatus where
        parseJSON
          = Core.withObject "CertificationExamStatus"
              (\ o ->
                 CertificationExamStatus Core.<$>
                   (o Core..:? "numberUsersPass") Core.<*> (o Core..:? "type"))

instance Core.ToJSON CertificationExamStatus where
        toJSON CertificationExamStatus{..}
          = Core.object
              (Core.catMaybes
                 [("numberUsersPass" Core..=) Core.<$> numberUsersPass,
                  ("type" Core..=) Core.<$> type'])
...
newCertificationStatus 
    ::  CertificationStatus
newCertificationStatus
  = CertificationStatus{examStatuses = Core.Nothing,
                        isCertified = Core.Nothing, type' = Core.Nothing,
                        userCount = Core.Nothing}
instance Core.FromJSON CertificationStatus where
        parseJSON
          = Core.withObject "CertificationStatus"
              (\ o ->
                 CertificationStatus Core.<$>
                   (o Core..:? "examStatuses") Core.<*> (o Core..:? "isCertified")
                     Core.<*> (o Core..:? "type")
...
newCompany 
    ::  Company
newCompany
  = Company{additionalWebsites = Core.Nothing,
            autoApprovalEmailDomains = Core.Nothing,
            badgeAuthorityInAwn = Core.Nothing, badgeTier = Core.Nothing,
            certificationStatuses = Core.Nothing, companyTypes = Core.Nothing,
            convertedMinMonthlyBudget = Core.Nothing, id = Core.Nothing,
            industries = Core.Nothing, localizedInfos = Core.Nothing,
            locations = Core.Nothing, name = Core.Nothing,
            originalMinMonthlyBudget = Core.Nothing,
            primaryAdwordsManagerAccountId = Core.Nothing,
            primaryLanguageCode = Core.Nothing, primaryLocation = Core.Nothing,
            profileStatus = Core.Nothing, publicProfile = Core.Nothing,
            ranks = Core.Nothing, services = Core.Nothing,
            specializationStatus = Core.Nothing, websiteUrl = Core.Nothing}
instance Core.FromJSON Company where
        parseJSON
          = Core.withObject "Company"
              (\ o ->
                 Company Core.<$>
                   (o Core..:? "additionalWebsites") Core.<*>
                     (o Core..:? "autoApprovalEmailDomains")
                     ...
                     Core.<*>
                     (o Core..:? "primaryAdwordsManagerAccountId" Core.<&>
...
instance Core.ToJSON Company where
        toJSON Company{..}
          = Core.object
              (Core.catMaybes
                 [("additionalWebsites" Core..=) Core.<$> additionalWebsites,
                  ("autoApprovalEmailDomains" Core..=) Core.<$>
                    autoApprovalEmailDomains,
                  ("badgeAuthorityInAwn" Core..=) Core.<$> badgeAuthorityInAwn,
                  ("badgeTier" Core..=) Core.<$> badgeTier,
                  ("certificationStatuses" Core..=) Core.<$> certificationStatuses,
                  ("companyTypes" Core..=) Core.<$> companyTypes,
                  ("convertedMinMonthlyBudget" Core..=) Core.<$>
                  ...
                  ("name" Core..=) Core.<$> name,
                  ("originalMinMonthlyBudget" Core..=) Core.<$>
                    originalMinMonthlyBudget,
                  ("primaryAdwordsManagerAccountId" Core..=) Core.. Core.AsText
                  ...
                  ("specializationStatus" Core..=) Core.<$> specializationStatus,
...
newCompanyRelation 
    ::  CompanyRelation
newCompanyRelation
  = CompanyRelation{address = Core.Nothing, badgeTier = Core.Nothing,
                    companyAdmin = Core.Nothing, companyId = Core.Nothing,
                    creationTime = Core.Nothing, internalCompanyId = Core.Nothing,
                    isPending = Core.Nothing, logoUrl = Core.Nothing,
                    managerAccount = Core.Nothing, name = Core.Nothing,
                    phoneNumber = Core.Nothing, primaryAddress = Core.Nothing,
                    primaryCountryCode = Core.Nothing,
                    primaryLanguageCode = Core.Nothing,
                    resolvedTimestamp = Core.Nothing, segment = Core.Nothing,
                    specializationStatus = Core.Nothing, state = Core.Nothing,
                    website = Core.Nothing}
instance Core.FromJSON CompanyRelation where
        parseJSON
          = Core.withObject "CompanyRelation"
              (\ o ->
                 CompanyRelation Core.<$>
                   (o Core..:? "address") Core.<*> (o Core..:? "badgeTier") Core.<*>
                     (o Core..:? "companyAdmin")
                     ...
                     Core.<*> (o Core..:? "logoUrl")
                     Core.<*>
                     (o Core..:? "managerAccount" Core.<&> Core.fmap Core.fromAsText)
                     Core.<*> (o Core..:? "name")
          ...
          = Core.object
              (Core.catMaybes
                 [("address" Core..=) Core.<$> address,
                  ...
                  ("internalCompanyId" Core..=) Core.<$> internalCompanyId,
                  ("isPending" Core..=) Core.<$> isPending,
                  ("logoUrl" Core..=) Core.<$> logoUrl,
                  ("managerAccount" Core..=) Core.. Core.AsText Core.<$>
                    managerAccount,
                  ("name" Core..=) Core.<$> name,
                  ("phoneNumber" Core..=) Core.<$> phoneNumber,
                  ("primaryAddress" Core..=) Core.<$> primaryAddress,
                  ("primaryCountryCode" Core..=) Core.<$> primaryCountryCode,
                  ("primaryLanguageCode" Core..=) Core.<$> primaryLanguageCode,
                  ("resolvedTimestamp" Core..=) Core.<$> resolvedTimestamp,
...
newCountryOfferInfo 
    ::  CountryOfferInfo
newCountryOfferInfo
  = CountryOfferInfo{getYAmount = Core.Nothing,
                     offerCountryCode = Core.Nothing, offerType = Core.Nothing,
                     spendXAmount = Core.Nothing}
instance Core.FromJSON CountryOfferInfo where
        parseJSON
          = Core.withObject "CountryOfferInfo"
              (\ o ->
                 CountryOfferInfo Core.<$>
                   (o Core..:? "getYAmount") Core.<*> (o Core..:? "offerCountryCode")
                     Core.<*> (o Core..:? "offerType")
          ...
          = Core.object
              (Core.catMaybes
                 [("getYAmount" Core..=) Core.<$> getYAmount,
                  ("offerCountryCode" Core..=) Core.<$> offerCountryCode,
                  ("offerType" Core..=) Core.<$> offerType,
...
newCreateLeadRequest 
    ::  CreateLeadRequest
newCreateLeadRequest
  = CreateLeadRequest{lead = Core.Nothing,
                      recaptchaChallenge = Core.Nothing, requestMetadata = Core.Nothing}
instance Core.FromJSON CreateLeadRequest where
        parseJSON
          = Core.withObject "CreateLeadRequest"
              (\ o ->
                 CreateLeadRequest Core.<$>
                   (o Core..:? "lead") Core.<*> (o Core..:? "recaptchaChallenge")
...
instance Core.ToJSON CreateLeadRequest where
        toJSON CreateLeadRequest{..}
          = Core.object
              (Core.catMaybes
                 [("lead" Core..=) Core.<$> lead,
                  ("recaptchaChallenge" Core..=) Core.<$> recaptchaChallenge,
...
newCreateLeadResponse 
    ::  CreateLeadResponse
newCreateLeadResponse
  = CreateLeadResponse{lead = Core.Nothing,
                       recaptchaStatus = Core.Nothing, responseMetadata = Core.Nothing}
instance Core.FromJSON CreateLeadResponse where
        parseJSON
          = Core.withObject "CreateLeadResponse"
              (\ o ->
                 CreateLeadResponse Core.<$>
                   (o Core..:? "lead") Core.<*> (o Core..:? "recaptchaStatus")
          ...
          = Core.object
              (Core.catMaybes
                 [("lead" Core..=) Core.<$> lead,
                  ...
                  ("responseMetadata" Core..=) Core.<$> responseMetadata])
...
newDebugInfo 
    ::  DebugInfo
newDebugInfo
  = DebugInfo{serverInfo = Core.Nothing,
              serverTraceInfo = Core.Nothing, serviceUrl = Core.Nothing}
instance Core.FromJSON DebugInfo where
        parseJSON
          = Core.withObject "DebugInfo"
              (\ o ->
                 DebugInfo Core.<$>
                   (o Core..:? "serverInfo") Core.<*> (o Core..:? "serverTraceInfo")
...
instance Core.FromJSON EventData where
        parseJSON
          = Core.withObject "EventData"
              (\ o ->
                 EventData Core.<$>
                   (o Core..:? "key") Core.<*> (o Core..:? "values"))
...
newExamStatus 
    ::  ExamStatus
newExamStatus
  = ExamStatus{examType = Core.Nothing, expiration = Core.Nothing,
               lastPassed = Core.Nothing, passed = Core.Nothing,
               taken = Core.Nothing, warning = Core.Nothing}
instance Core.FromJSON ExamStatus where
        parseJSON
          = Core.withObject "ExamStatus"
              (\ o ->
                 ExamStatus Core.<$>
                   (o Core..:? "examType") Core.<*> (o Core..:? "expiration") Core.<*>
                     (o Core..:? "lastPassed")
                     Core.<*> (o Core..:? "passed")
                     Core.<*> (o Core..:? "taken")
                     Core.<*> (o Core..:? "warning"))
...
newGetCompanyResponse 
    ::  GetCompanyResponse
newGetCompanyResponse
  = GetCompanyResponse{company = Core.Nothing,
                       responseMetadata = Core.Nothing}
instance Core.FromJSON GetCompanyResponse where
        parseJSON
          = Core.withObject "GetCompanyResponse"
              (\ o ->
                 GetCompanyResponse Core.<$>
                   (o Core..:? "company") Core.<*> (o Core..:? "responseMetadata"))
...
instance Core.FromJSON GetPartnersStatusResponse where
        parseJSON
          = Core.withObject "GetPartnersStatusResponse"
              (\ o ->
                 GetPartnersStatusResponse Core.<$> (o Core..:? "responseMetadata"))
...
newHistoricalOffer 
    ::  HistoricalOffer
newHistoricalOffer
  = HistoricalOffer{adwordsUrl = Core.Nothing,
                    clientEmail = Core.Nothing, clientId = Core.Nothing,
                    clientName = Core.Nothing, creationTime = Core.Nothing,
                    expirationTime = Core.Nothing, lastModifiedTime = Core.Nothing,
                    offerCode = Core.Nothing, offerCountryCode = Core.Nothing,
                    offerType = Core.Nothing, senderName = Core.Nothing,
                    status = Core.Nothing}
instance Core.FromJSON HistoricalOffer where
        parseJSON
          = Core.withObject "HistoricalOffer"
              (\ o ->
                 HistoricalOffer Core.<$>
                   (o Core..:? "adwordsUrl") Core.<*> (o Core..:? "clientEmail")
                     Core.<*> (o Core..:? "clientId" Core.<&> Core.fmap Core.fromAsText)
          ...
          = Core.object
              (Core.catMaybes
                 [("adwordsUrl" Core..=) Core.<$> adwordsUrl,
                  ...
                  ("clientId" Core..=) Core.. Core.AsText Core.<$> clientId,
...
newLead 
    ::  Lead
newLead
  = Lead{adwordsCustomerId = Core.Nothing, comments = Core.Nothing,
         createTime = Core.Nothing, email = Core.Nothing,
         familyName = Core.Nothing, givenName = Core.Nothing,
         gpsMotivations = Core.Nothing, id = Core.Nothing,
         languageCode = Core.Nothing, marketingOptIn = Core.Nothing,
         minMonthlyBudget = Core.Nothing, phoneNumber = Core.Nothing,
         state = Core.Nothing, type' = Core.Nothing,
         websiteUrl = Core.Nothing}
instance Core.FromJSON Lead where
        parseJSON
          = Core.withObject "Lead"
              (\ o ->
                 Lead Core.<$>
                   (o Core..:? "adwordsCustomerId" Core.<&> Core.fmap Core.fromAsText)
...
instance Core.ToJSON Lead where
        toJSON Lead{..}
          = Core.object
              (Core.catMaybes
                 [("adwordsCustomerId" Core..=) Core.. Core.AsText Core.<$>
                    adwordsCustomerId,
                  ...
                  ("minMonthlyBudget" Core..=) Core.<$> minMonthlyBudget,
                  ("phoneNumber" Core..=) Core.<$> phoneNumber,
...
newListAnalyticsResponse 
    ::  ListAnalyticsResponse
newListAnalyticsResponse
  = ListAnalyticsResponse{analytics = Core.Nothing,
                          analyticsSummary = Core.Nothing, nextPageToken = Core.Nothing,
                          responseMetadata = Core.Nothing}
instance Core.FromJSON ListAnalyticsResponse where
        parseJSON
          = Core.withObject "ListAnalyticsResponse"
              (\ o ->
                 ListAnalyticsResponse Core.<$>
                   (o Core..:? "analytics") Core.<*> (o Core..:? "analyticsSummary")
          ...
          = Core.object
              (Core.catMaybes
                 [("analytics" Core..=) Core.<$> analytics,
                  ("analyticsSummary" Core..=) Core.<$> analyticsSummary,
...
newListCompaniesResponse 
    ::  ListCompaniesResponse
newListCompaniesResponse
  = ListCompaniesResponse{companies = Core.Nothing,
                          nextPageToken = Core.Nothing, responseMetadata = Core.Nothing}
instance Core.FromJSON ListCompaniesResponse where
        parseJSON
          = Core.withObject "ListCompaniesResponse"
              (\ o ->
                 ListCompaniesResponse Core.<$>
                   (o Core..:? "companies") Core.<*> (o Core..:? "nextPageToken")
                     Core.<*> (o Core..:? "responseMetadata"))
...
newListLeadsResponse 
    ::  ListLeadsResponse
newListLeadsResponse
  = ListLeadsResponse{leads = Core.Nothing,
                      nextPageToken = Core.Nothing, responseMetadata = Core.Nothing,
                      totalSize = Core.Nothing}
instance Core.FromJSON ListLeadsResponse where
        parseJSON
          = Core.withObject "ListLeadsResponse"
              (\ o ->
                 ListLeadsResponse Core.<$>
                   (o Core..:? "leads") Core.<*> (o Core..:? "nextPageToken") Core.<*>
                     (o Core..:? "responseMetadata")
...
newListOffersHistoryResponse 
    ::  ListOffersHistoryResponse
newListOffersHistoryResponse
  = ListOffersHistoryResponse{canShowEntireCompany = Core.Nothing,
                              nextPageToken = Core.Nothing, offers = Core.Nothing,
                              responseMetadata = Core.Nothing,
                              showingEntireCompany = Core.Nothing, totalResults = Core.Nothing}
instance Core.FromJSON ListOffersHistoryResponse where
        parseJSON
          = Core.withObject "ListOffersHistoryResponse"
              (\ o ->
                 ListOffersHistoryResponse Core.<$>
                   (o Core..:? "canShowEntireCompany") Core.<*>
...
instance Core.ToJSON ListOffersHistoryResponse where
        toJSON ListOffersHistoryResponse{..}
          = Core.object
              (Core.catMaybes
                 [("canShowEntireCompany" Core..=) Core.<$> canShowEntireCompany,
                  ("nextPageToken" Core..=) Core.<$> nextPageToken,
                  ("offers" Core..=) Core.<$> offers,
                  ("responseMetadata" Core..=) Core.<$> responseMetadata,
                  ("showingEntireCompany" Core..=) Core.<$> showingEntireCompany,
...
newListOffersResponse 
    ::  ListOffersResponse
newListOffersResponse
  = ListOffersResponse{availableOffers = Core.Nothing,
                       noOfferReason = Core.Nothing, responseMetadata = Core.Nothing}
instance Core.FromJSON ListOffersResponse where
        parseJSON
          = Core.withObject "ListOffersResponse"
              (\ o ->
                 ListOffersResponse Core.<$>
                   (o Core..:? "availableOffers") Core.<*>
                     (o Core..:? "noOfferReason")
                     Core.<*> (o Core..:? "responseMetadata"))
...
instance Core.ToJSON ListOffersResponse where
        toJSON ListOffersResponse{..}
          = Core.object
              (Core.catMaybes
                 [("availableOffers" Core..=) Core.<$> availableOffers,
...
newListUserStatesResponse 
    ::  ListUserStatesResponse
newListUserStatesResponse
  = ListUserStatesResponse{responseMetadata = Core.Nothing,
                           userStates = Core.Nothing}
instance Core.FromJSON ListUserStatesResponse where
        parseJSON
          = Core.withObject "ListUserStatesResponse"
              (\ o ->
                 ListUserStatesResponse Core.<$>
                   (o Core..:? "responseMetadata") Core.<*> (o Core..:? "userStates"))
...
newLocalizedCompanyInfo 
    ::  LocalizedCompanyInfo
newLocalizedCompanyInfo
  = LocalizedCompanyInfo{countryCodes = Core.Nothing,
                         displayName = Core.Nothing, languageCode = Core.Nothing,
                         overview = Core.Nothing}
instance Core.FromJSON LocalizedCompanyInfo where
        parseJSON
          = Core.withObject "LocalizedCompanyInfo"
              (\ o ->
                 LocalizedCompanyInfo Core.<$>
                   (o Core..:? "countryCodes") Core.<*> (o Core..:? "displayName")
                     Core.<*> (o Core..:? "languageCode")
...
newLocation 
    ::  Location
newLocation
  = Location{address = Core.Nothing, addressLine = Core.Nothing,
             administrativeArea = Core.Nothing,
             dependentLocality = Core.Nothing, languageCode = Core.Nothing,
             latLng = Core.Nothing, locality = Core.Nothing,
             postalCode = Core.Nothing, regionCode = Core.Nothing,
...
instance Core.FromJSON Location where
        parseJSON
          = Core.withObject "Location"
              (\ o ->
                 Location Core.<$>
                   (o Core..:? "address") Core.<*> (o Core..:? "addressLine") Core.<*>
          ...
          = Core.object
              (Core.catMaybes
                 [("address" Core..=) Core.<$> address,
                  ...
                  ("dependentLocality" Core..=) Core.<$> dependentLocality,
                  ("languageCode" Core..=) Core.<$> languageCode,
...
newLogMessageRequest 
    ::  LogMessageRequest
newLogMessageRequest
  = LogMessageRequest{clientInfo = Core.Nothing,
                      details = Core.Nothing, level = Core.Nothing,
                      requestMetadata = Core.Nothing}
instance Core.FromJSON LogMessageRequest where
        parseJSON
          = Core.withObject "LogMessageRequest"
              (\ o ->
                 LogMessageRequest Core.<$>
                   (o Core..:? "clientInfo") Core.<*> (o Core..:? "details") Core.<*>
                     (o Core..:? "level")
                     Core.<*> (o Core..:? "requestMetadata"))
...
instance Core.FromJSON LogMessageRequest_ClientInfo where
        parseJSON
          = Core.withObject "LogMessageRequest_ClientInfo"
              (\ o ->
                 LogMessageRequest_ClientInfo Core.<$> (Core.parseJSONObject o))

instance Core.ToJSON LogMessageRequest_ClientInfo where
        toJSON LogMessageRequest_ClientInfo{..} = Core.toJSON additional
...
newLogMessageResponse 
    ::  LogMessageResponse
newLogMessageResponse
  = LogMessageResponse{responseMetadata = Core.Nothing}
instance Core.FromJSON LogMessageResponse where
        parseJSON
          = Core.withObject "LogMessageResponse"
              (\ o ->
                 LogMessageResponse Core.<$> (o Core..:? "responseMetadata"))
...
newLogUserEventRequest 
    ::  LogUserEventRequest
newLogUserEventRequest
  = LogUserEventRequest{eventAction = Core.Nothing,
                        eventCategory = Core.Nothing, eventDatas = Core.Nothing,
                        eventScope = Core.Nothing, lead = Core.Nothing,
                        requestMetadata = Core.Nothing, url = Core.Nothing}
instance Core.FromJSON LogUserEventRequest where
        parseJSON
          = Core.withObject "LogUserEventRequest"
              (\ o ->
                 LogUserEventRequest Core.<$>
                   (o Core..:? "eventAction") Core.<*> (o Core..:? "eventCategory")
...
newLogUserEventResponse 
    ::  LogUserEventResponse
newLogUserEventResponse
  = LogUserEventResponse{responseMetadata = Core.Nothing}
instance Core.FromJSON LogUserEventResponse where
        parseJSON
          = Core.withObject "LogUserEventResponse"
              (\ o ->
                 LogUserEventResponse Core.<$> (o Core..:? "responseMetadata"))
...
newOfferCustomer 
    ::  OfferCustomer
newOfferCustomer
  = OfferCustomer{adwordsUrl = Core.Nothing,
                  countryCode = Core.Nothing, creationTime = Core.Nothing,
                  eligibilityDaysLeft = Core.Nothing, externalCid = Core.Nothing,
                  getYAmount = Core.Nothing, name = Core.Nothing,
                  offerType = Core.Nothing, spendXAmount = Core.Nothing}
instance Core.FromJSON OfferCustomer where
        parseJSON
          = Core.withObject "OfferCustomer"
              (\ o ->
                 OfferCustomer Core.<$>
                   (o Core..:? "adwordsUrl") Core.<*> (o Core..:? "countryCode")
                     Core.<*> (o Core..:? "creationTime")
                     Core.<*> (o Core..:? "eligibilityDaysLeft")
                     Core.<*>
                     (o Core..:? "externalCid" Core.<&> Core.fmap Core.fromAsText)
          ...
          = Core.object
              (Core.catMaybes
                 [("adwordsUrl" Core..=) Core.<$> adwordsUrl,
                  ...
                  ("creationTime" Core..=) Core.<$> creationTime,
                  ("eligibilityDaysLeft" Core..=) Core.<$> eligibilityDaysLeft,
                  ("externalCid" Core..=) Core.. Core.AsText Core.<$> externalCid,
                  ("getYAmount" Core..=) Core.<$> getYAmount,
                  ("name" Core..=) Core.<$> name,
                  ("offerType" Core..=) Core.<$> offerType,
                  ("spendXAmount" Core..=) Core.<$> spendXAmount])
...
newOptIns 
    ::  OptIns
newOptIns
  = OptIns{marketComm = Core.Nothing,
           performanceSuggestions = Core.Nothing, phoneContact = Core.Nothing,
           physicalMail = Core.Nothing, specialOffers = Core.Nothing}
instance Core.FromJSON OptIns where
        parseJSON
          = Core.withObject "OptIns"
              (\ o ->
                 OptIns Core.<$>
                   (o Core..:? "marketComm") Core.<*>
                     (o Core..:? "performanceSuggestions")
          ...
          = Core.object
              (Core.catMaybes
                 [("marketComm" Core..=) Core.<$> marketComm,
                  ("performanceSuggestions" Core..=) Core.<$> performanceSuggestions,
...
newPublicProfile 
    ::  PublicProfile
newPublicProfile
  = PublicProfile{displayImageUrl = Core.Nothing,
                  displayName = Core.Nothing, id = Core.Nothing,
                  profileImage = Core.Nothing, url = Core.Nothing}
instance Core.FromJSON PublicProfile where
        parseJSON
          = Core.withObject "PublicProfile"
              (\ o ->
                 PublicProfile Core.<$>
                   (o Core..:? "displayImageUrl") Core.<*> (o Core..:? "displayName")
                     Core.<*> (o Core..:? "id")
...
instance Core.ToJSON PublicProfile where
        toJSON PublicProfile{..}
          = Core.object
              (Core.catMaybes
                 [("displayImageUrl" Core..=) Core.<$> displayImageUrl,
                  ("displayName" Core..=) Core.<$> displayName,
                  ("id" Core..=) Core.<$> id,
...
instance Core.FromJSON Rank where
        parseJSON
          = Core.withObject "Rank"
              (\ o ->
                 Rank Core.<$> (o Core..:? "type") Core.<*> (o Core..:? "value"))
...
instance Core.FromJSON RecaptchaChallenge where
        parseJSON
          = Core.withObject "RecaptchaChallenge"
              (\ o ->
                 RecaptchaChallenge Core.<$>
                   (o Core..:? "id") Core.<*> (o Core..:? "response"))
...
newRequestMetadata 
    ::  RequestMetadata
newRequestMetadata
  = RequestMetadata{experimentIds = Core.Nothing,
                    locale = Core.Nothing, partnersSessionId = Core.Nothing,
                    trafficSource = Core.Nothing, userOverrides = Core.Nothing}
instance Core.FromJSON RequestMetadata where
        parseJSON
          = Core.withObject "RequestMetadata"
              (\ o ->
                 RequestMetadata Core.<$>
                   (o Core..:? "experimentIds") Core.<*> (o Core..:? "locale")
          ...
          = Core.object
              (Core.catMaybes
                 [("experimentIds" Core..=) Core.<$> experimentIds,
                  ...
                  ("partnersSessionId" Core..=) Core.<$> partnersSessionId,
...
instance Core.FromJSON ResponseMetadata where
        parseJSON
          = Core.withObject "ResponseMetadata"
              (\ o -> ResponseMetadata Core.<$> (o Core..:? "debugInfo"))

instance Core.ToJSON ResponseMetadata where
        toJSON ResponseMetadata{..}
          = Core.object
              (Core.catMaybes [("debugInfo" Core..=) Core.<$> debugInfo])
...
newSpecializationStatus 
    ::  SpecializationStatus
newSpecializationStatus
  = SpecializationStatus{badgeSpecialization = Core.Nothing,
                         badgeSpecializationState = Core.Nothing}
instance Core.FromJSON SpecializationStatus where
        parseJSON
          = Core.withObject "SpecializationStatus"
              (\ o ->
                 SpecializationStatus Core.<$>
                   (o Core..:? "badgeSpecialization") Core.<*>
                     (o Core..:? "badgeSpecializationState"))

instance Core.ToJSON SpecializationStatus where
        toJSON SpecializationStatus{..}
          = Core.object
              (Core.catMaybes
                 [("badgeSpecialization" Core..=) Core.<$> badgeSpecialization,
                  ("badgeSpecializationState" Core..=) Core.<$>
...
newTrafficSource 
    ::  TrafficSource
newTrafficSource
  = TrafficSource{trafficSourceId = Core.Nothing,
                  trafficSubId = Core.Nothing}
instance Core.FromJSON TrafficSource where
        parseJSON
          = Core.withObject "TrafficSource"
              (\ o ->
                 TrafficSource Core.<$>
                   (o Core..:? "trafficSourceId") Core.<*>
                     (o Core..:? "trafficSubId"))
...
instance Core.ToJSON TrafficSource where
        toJSON TrafficSource{..}
          = Core.object
              (Core.catMaybes
                 [("trafficSourceId" Core..=) Core.<$> trafficSourceId,
...
newUser 
    ::  User
newUser
  = User{afaInfoShared = Core.Nothing,
         availableAdwordsManagerAccounts = Core.Nothing,
         certificationStatus = Core.Nothing, company = Core.Nothing,
         companyVerificationEmail = Core.Nothing, examStatus = Core.Nothing,
         id = Core.Nothing, internalId = Core.Nothing,
         lastAccessTime = Core.Nothing, primaryEmails = Core.Nothing,
         profile = Core.Nothing, publicProfile = Core.Nothing}
instance Core.FromJSON User where
        parseJSON
          = Core.withObject "User"
              (\ o ->
                 User Core.<$>
                   (o Core..:? "afaInfoShared") Core.<*>
                     (o Core..:? "availableAdwordsManagerAccounts")
          ...
          = Core.object
              (Core.catMaybes
                 [("afaInfoShared" Core..=) Core.<$> afaInfoShared,
                  ("availableAdwordsManagerAccounts" Core..=) Core.<$>
                    availableAdwordsManagerAccounts,
                  ("certificationStatus" Core..=) Core.<$> certificationStatus,
                  ("company" Core..=) Core.<$> company,
                  ("companyVerificationEmail" Core..=) Core.<$>
...
instance Core.FromJSON UserOverrides where
        parseJSON
          = Core.withObject "UserOverrides"
              (\ o ->
                 UserOverrides Core.<$>
                   (o Core..:? "ipAddress") Core.<*> (o Core..:? "userId"))
...
newUserProfile 
    ::  UserProfile
newUserProfile
  = UserProfile{address = Core.Nothing,
                adwordsManagerAccount = Core.Nothing, channels = Core.Nothing,
                emailAddress = Core.Nothing, emailOptIns = Core.Nothing,
                familyName = Core.Nothing, givenName = Core.Nothing,
                industries = Core.Nothing, jobFunctions = Core.Nothing,
                languages = Core.Nothing, markets = Core.Nothing,
                migrateToAfa = Core.Nothing, phoneNumber = Core.Nothing,
                primaryCountryCode = Core.Nothing, profilePublic = Core.Nothing}
        ...
        parseJSON
          = Core.withObject "UserProfile"
              (\ o ->
                 UserProfile Core.<$>
                   (o Core..:? "address") Core.<*>
                     (o Core..:? "adwordsManagerAccount" Core.<&>
                        Core.fmap Core.fromAsText)
...
instance Core.ToJSON UserProfile where
        toJSON UserProfile{..}
          = Core.object
              (Core.catMaybes
                 [("address" Core..=) Core.<$> address,
                  ("adwordsManagerAccount" Core..=) Core.. Core.AsText Core.<$>
