...
-- |
-- Module      : Gogol.Partners.UpdateLeads
                               ...
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.ReqBody '[Core.JSON] Lead Core.:>
                                       Core.Patch '[Core.JSON] Lead
...
newPartnersUpdateLeads payload
  = PartnersUpdateLeads{xgafv = Core.Nothing,
...
instance Core.GoogleRequest PartnersUpdateLeads where
        ...
        requestClient PartnersUpdateLeads{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy PartnersUpdateLeadsResource)
                      Core.mempty
