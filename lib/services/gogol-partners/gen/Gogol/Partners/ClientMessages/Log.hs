...
newPartnersClientMessagesLog payload
  = PartnersClientMessagesLog{xgafv = Core.Nothing,
                              accessToken = Core.Nothing, callback = Core.Nothing,
                              payload = payload, uploadType = Core.Nothing,
                              uploadProtocol = Core.Nothing}
instance Core.GoogleRequest PartnersClientMessagesLog where
        type Rs PartnersClientMessagesLog = LogMessageResponse
        ...
        requestClient PartnersClientMessagesLog{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy PartnersClientMessagesLogResource)
                      Core.mempty
