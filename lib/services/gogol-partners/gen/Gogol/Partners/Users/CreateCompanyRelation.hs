                                 ...
                                 Core.QueryParam "uploadType" Core.Text Core.:>
                                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                                     Core.QueryParam "alt" Core.AltJSON Core.:>
                                       Core.ReqBody '[Core.JSON] CompanyRelation Core.:>
                                         Core.Put '[Core.JSON] CompanyRelation
...
newPartnersUsersCreateCompanyRelation payload userId
  = PartnersUsersCreateCompanyRelation{xgafv = Core.Nothing,
                                       ...
                                       userId = userId}
instance Core.GoogleRequest PartnersUsersCreateCompanyRelation
         where
