...
newPartnersUsersDeleteCompanyRelation userId
  = PartnersUsersDeleteCompanyRelation{xgafv = Core.Nothing,
                                       ...
                                       userId = userId}
instance Core.GoogleRequest PartnersUsersDeleteCompanyRelation
         where
        ...
        requestClient PartnersUsersDeleteCompanyRelation{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy PartnersUsersDeleteCompanyRelationResource)
                      Core.mempty
