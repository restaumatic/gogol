...
-- |
-- Module      : Gogol.Partners.Users.UpdateProfile
                               ...
                               Core.QueryParam "uploadType" Core.Text Core.:>
                                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                                   Core.QueryParam "alt" Core.AltJSON Core.:>
                                     Core.ReqBody '[Core.JSON] UserProfile Core.:>
                                       Core.Patch '[Core.JSON] UserProfile
...
newPartnersUsersUpdateProfile payload
  = PartnersUsersUpdateProfile{xgafv = Core.Nothing,
                               accessToken = Core.Nothing, callback = Core.Nothing,
                               payload = payload, requestMetadataExperimentIds = Core.Nothing,
...
instance Core.GoogleRequest PartnersUsersUpdateProfile where
        ...
        requestClient PartnersUsersUpdateProfile{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy PartnersUsersUpdateProfileResource)
                      Core.mempty
