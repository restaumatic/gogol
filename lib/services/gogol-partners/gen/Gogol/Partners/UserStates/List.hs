...
-- |
-- Module      : Gogol.Partners.UserStates.List
                             ...
                             Core.QueryParam "uploadType" Core.Text Core.:>
                               Core.QueryParam "upload_protocol" Core.Text Core.:>
                                 Core.QueryParam "alt" Core.AltJSON Core.:>
                                   Core.Get '[Core.JSON] ListUserStatesResponse
...
newPartnersUserStatesList 
    ::  PartnersUserStatesList
newPartnersUserStatesList
  = PartnersUserStatesList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest PartnersUserStatesList where
        type Rs PartnersUserStatesList = ListUserStatesResponse
        ...
        requestClient PartnersUserStatesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy PartnersUserStatesListResource)
                      Core.mempty
