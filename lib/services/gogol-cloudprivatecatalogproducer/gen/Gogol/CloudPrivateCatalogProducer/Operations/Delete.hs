...
newCloudPrivateCatalogProducerOperationsDelete name
  = CloudPrivateCatalogProducerOperationsDelete{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           CloudPrivateCatalogProducerOperationsDelete
         where
        type Rs CloudPrivateCatalogProducerOperationsDelete =
             GoogleProtobufEmpty
        type Scopes CloudPrivateCatalogProducerOperationsDelete =
