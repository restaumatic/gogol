...
newCloudPrivateCatalogProducerOperationsCancel name payload
  = CloudPrivateCatalogProducerOperationsCancel{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           CloudPrivateCatalogProducerOperationsCancel
         where
        type Rs CloudPrivateCatalogProducerOperationsCancel =
             GoogleProtobufEmpty
        type Scopes CloudPrivateCatalogProducerOperationsCancel =
