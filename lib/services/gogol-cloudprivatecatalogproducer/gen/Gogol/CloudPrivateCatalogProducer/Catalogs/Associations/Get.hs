...
newCloudPrivateCatalogProducerCatalogsAssociationsGet name
  = CloudPrivateCatalogProducerCatalogsAssociationsGet{xgafv =
                                                         Core.Nothing,
...
instance Core.GoogleRequest
           CloudPrivateCatalogProducerCatalogsAssociationsGet
         where
        type Rs CloudPrivateCatalogProducerCatalogsAssociationsGet =
             GoogleCloudPrivatecatalogproducerV1beta1Association
        type Scopes CloudPrivateCatalogProducerCatalogsAssociationsGet =
