...
newCloudPrivateCatalogProducerCatalogsAssociationsDelete name
  = CloudPrivateCatalogProducerCatalogsAssociationsDelete{xgafv =
                                                            Core.Nothing,
...
instance Core.GoogleRequest
           CloudPrivateCatalogProducerCatalogsAssociationsDelete
         where
        type Rs CloudPrivateCatalogProducerCatalogsAssociationsDelete =
             GoogleProtobufEmpty
        type Scopes CloudPrivateCatalogProducerCatalogsAssociationsDelete =
