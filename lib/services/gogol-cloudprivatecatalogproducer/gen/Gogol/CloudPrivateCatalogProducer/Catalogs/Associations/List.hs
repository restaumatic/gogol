...
newCloudPrivateCatalogProducerCatalogsAssociationsList parent
  = CloudPrivateCatalogProducerCatalogsAssociationsList{xgafv =
                                                          Core.Nothing,
...
instance Core.GoogleRequest
           CloudPrivateCatalogProducerCatalogsAssociationsList
         where
        type Rs CloudPrivateCatalogProducerCatalogsAssociationsList =
             GoogleCloudPrivatecatalogproducerV1beta1ListAssociationsResponse
        type Scopes CloudPrivateCatalogProducerCatalogsAssociationsList =
