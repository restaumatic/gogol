...
newCloudPrivateCatalogProducerCatalogsAssociationsCreate 
    ...
    -> CloudPrivateCatalogProducerCatalogsAssociationsCreate
newCloudPrivateCatalogProducerCatalogsAssociationsCreate parent
  payload
  = CloudPrivateCatalogProducerCatalogsAssociationsCreate{xgafv =
                                                            Core.Nothing,
...
instance Core.GoogleRequest
           CloudPrivateCatalogProducerCatalogsAssociationsCreate
         where
        type Rs CloudPrivateCatalogProducerCatalogsAssociationsCreate =
             GoogleCloudPrivatecatalogproducerV1beta1Association
        type Scopes CloudPrivateCatalogProducerCatalogsAssociationsCreate =
