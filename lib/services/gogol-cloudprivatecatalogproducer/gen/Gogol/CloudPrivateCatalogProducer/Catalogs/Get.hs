...
newCloudPrivateCatalogProducerCatalogsGet name
  = CloudPrivateCatalogProducerCatalogsGet{xgafv = Core.Nothing,
                                           accessToken = Core.Nothing, callback = Core.Nothing,
                                           name = name, uploadType = Core.Nothing,
                                           uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudPrivateCatalogProducerCatalogsGet
         where
        type Rs CloudPrivateCatalogProducerCatalogsGet =
             GoogleCloudPrivatecatalogproducerV1beta1Catalog
        type Scopes CloudPrivateCatalogProducerCatalogsGet =
