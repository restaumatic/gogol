...
newCloudPrivateCatalogProducerCatalogsProductsVersionsPatch 
    ...
    -> CloudPrivateCatalogProducerCatalogsProductsVersionsPatch
newCloudPrivateCatalogProducerCatalogsProductsVersionsPatch name
  payload
  = CloudPrivateCatalogProducerCatalogsProductsVersionsPatch{xgafv =
                                                               Core.Nothing,
...
instance Core.GoogleRequest
           CloudPrivateCatalogProducerCatalogsProductsVersionsPatch
         where
        type Rs CloudPrivateCatalogProducerCatalogsProductsVersionsPatch =
             GoogleCloudPrivatecatalogproducerV1beta1Version
        type Scopes
               CloudPrivateCatalogProducerCatalogsProductsVersionsPatch
