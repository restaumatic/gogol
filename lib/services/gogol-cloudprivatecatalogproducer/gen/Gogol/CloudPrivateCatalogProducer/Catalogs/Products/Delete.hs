...
newCloudPrivateCatalogProducerCatalogsProductsDelete name
  = CloudPrivateCatalogProducerCatalogsProductsDelete{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           CloudPrivateCatalogProducerCatalogsProductsDelete
         where
        type Rs CloudPrivateCatalogProducerCatalogsProductsDelete =
             GoogleProtobufEmpty
        type Scopes CloudPrivateCatalogProducerCatalogsProductsDelete =
