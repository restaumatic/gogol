...
newCloudPrivateCatalogProducerCatalogsProductsIconsUpload 
    ...
    -> CloudPrivateCatalogProducerCatalogsProductsIconsUpload
newCloudPrivateCatalogProducerCatalogsProductsIconsUpload payload
  product
  = CloudPrivateCatalogProducerCatalogsProductsIconsUpload{xgafv =
                                                             Core.Nothing,
...
instance Core.GoogleRequest
           CloudPrivateCatalogProducerCatalogsProductsIconsUpload
         where
        type Rs CloudPrivateCatalogProducerCatalogsProductsIconsUpload =
             GoogleProtobufEmpty
        type Scopes CloudPrivateCatalogProducerCatalogsProductsIconsUpload
             = '[CloudPlatform'FullControl]
        requestClient
          CloudPrivateCatalogProducerCatalogsProductsIconsUpload{..}
          = go product xgafv accessToken callback uploadType uploadProtocol
