...
newCloudPrivateCatalogProducerCatalogsProductsVersionsCreate 
    ...
    -> CloudPrivateCatalogProducerCatalogsProductsVersionsCreate
newCloudPrivateCatalogProducerCatalogsProductsVersionsCreate parent
  payload
  = CloudPrivateCatalogProducerCatalogsProductsVersionsCreate{xgafv =
                                                                Core.Nothing,
...
instance Core.GoogleRequest
           CloudPrivateCatalogProducerCatalogsProductsVersionsCreate
         where
        type Rs CloudPrivateCatalogProducerCatalogsProductsVersionsCreate =
