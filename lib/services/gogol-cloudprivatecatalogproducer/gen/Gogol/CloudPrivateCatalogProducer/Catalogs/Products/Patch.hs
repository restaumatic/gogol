...
newCloudPrivateCatalogProducerCatalogsProductsPatch name payload
  = CloudPrivateCatalogProducerCatalogsProductsPatch{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           CloudPrivateCatalogProducerCatalogsProductsPatch
         where
        type Rs CloudPrivateCatalogProducerCatalogsProductsPatch =
             GoogleCloudPrivatecatalogproducerV1beta1Product
        type Scopes CloudPrivateCatalogProducerCatalogsProductsPatch =
