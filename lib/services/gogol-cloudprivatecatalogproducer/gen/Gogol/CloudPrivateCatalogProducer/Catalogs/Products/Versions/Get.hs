...
newCloudPrivateCatalogProducerCatalogsProductsVersionsGet name
  = CloudPrivateCatalogProducerCatalogsProductsVersionsGet{xgafv =
                                                             Core.Nothing,
...
instance Core.GoogleRequest
           CloudPrivateCatalogProducerCatalogsProductsVersionsGet
         where
        type Rs CloudPrivateCatalogProducerCatalogsProductsVersionsGet =
             GoogleCloudPrivatecatalogproducerV1beta1Version
        type Scopes CloudPrivateCatalogProducerCatalogsProductsVersionsGet
