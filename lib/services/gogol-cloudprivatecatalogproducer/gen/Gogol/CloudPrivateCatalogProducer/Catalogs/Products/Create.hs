...
newCloudPrivateCatalogProducerCatalogsProductsCreate parent payload
  = CloudPrivateCatalogProducerCatalogsProductsCreate{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           CloudPrivateCatalogProducerCatalogsProductsCreate
         where
        type Rs CloudPrivateCatalogProducerCatalogsProductsCreate =
             GoogleCloudPrivatecatalogproducerV1beta1Product
        type Scopes CloudPrivateCatalogProducerCatalogsProductsCreate =
