...
newCloudPrivateCatalogProducerCatalogsProductsCopy name payload
  = CloudPrivateCatalogProducerCatalogsProductsCopy{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           CloudPrivateCatalogProducerCatalogsProductsCopy
         where
        type Rs CloudPrivateCatalogProducerCatalogsProductsCopy =
             GoogleLongrunningOperation
        type Scopes CloudPrivateCatalogProducerCatalogsProductsCopy =
