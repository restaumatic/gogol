...
newCloudPrivateCatalogProducerCatalogsProductsVersionsList parent
  = CloudPrivateCatalogProducerCatalogsProductsVersionsList{xgafv =
                                                              Core.Nothing,
...
instance Core.GoogleRequest
           CloudPrivateCatalogProducerCatalogsProductsVersionsList
         where
        type Rs CloudPrivateCatalogProducerCatalogsProductsVersionsList =
             GoogleCloudPrivatecatalogproducerV1beta1ListVersionsResponse
        type Scopes CloudPrivateCatalogProducerCatalogsProductsVersionsList
