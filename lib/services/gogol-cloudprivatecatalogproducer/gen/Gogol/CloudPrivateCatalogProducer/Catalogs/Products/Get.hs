...
newCloudPrivateCatalogProducerCatalogsProductsGet name
  = CloudPrivateCatalogProducerCatalogsProductsGet{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           CloudPrivateCatalogProducerCatalogsProductsGet
         where
        type Rs CloudPrivateCatalogProducerCatalogsProductsGet =
             GoogleCloudPrivatecatalogproducerV1beta1Product
        type Scopes CloudPrivateCatalogProducerCatalogsProductsGet =
