...
newCloudPrivateCatalogProducerCatalogsProductsList parent
  = CloudPrivateCatalogProducerCatalogsProductsList{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           CloudPrivateCatalogProducerCatalogsProductsList
         where
        type Rs CloudPrivateCatalogProducerCatalogsProductsList =
             GoogleCloudPrivatecatalogproducerV1beta1ListProductsResponse
        type Scopes CloudPrivateCatalogProducerCatalogsProductsList =
