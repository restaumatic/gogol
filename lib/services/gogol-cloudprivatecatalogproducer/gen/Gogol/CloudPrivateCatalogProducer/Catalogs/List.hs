...
newCloudPrivateCatalogProducerCatalogsList 
    :: 
                                           CloudPrivateCatalogProducerCatalogsList
newCloudPrivateCatalogProducerCatalogsList
  = CloudPrivateCatalogProducerCatalogsList{xgafv = Core.Nothing,
                                            accessToken = Core.Nothing, callback = Core.Nothing,
                                            pageSize = Core.Nothing, pageToken = Core.Nothing,
                                            parent = Core.Nothing, uploadType = Core.Nothing,
                                            uploadProtocol = Core.Nothing}
instance Core.GoogleRequest CloudPrivateCatalogProducerCatalogsList
         where
        type Rs CloudPrivateCatalogProducerCatalogsList =
             GoogleCloudPrivatecatalogproducerV1beta1ListCatalogsResponse
        type Scopes CloudPrivateCatalogProducerCatalogsList =
