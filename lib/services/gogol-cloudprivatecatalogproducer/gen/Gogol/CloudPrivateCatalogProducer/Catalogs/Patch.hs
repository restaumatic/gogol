...
newCloudPrivateCatalogProducerCatalogsPatch name payload
  = CloudPrivateCatalogProducerCatalogsPatch{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           CloudPrivateCatalogProducerCatalogsPatch
         where
        type Rs CloudPrivateCatalogProducerCatalogsPatch =
             GoogleCloudPrivatecatalogproducerV1beta1Catalog
        type Scopes CloudPrivateCatalogProducerCatalogsPatch =
