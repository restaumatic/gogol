...
newCloudPrivateCatalogProducerCatalogsDelete name
  = CloudPrivateCatalogProducerCatalogsDelete{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           CloudPrivateCatalogProducerCatalogsDelete
         where
        type Rs CloudPrivateCatalogProducerCatalogsDelete =
             GoogleCloudPrivatecatalogproducerV1beta1Catalog
        type Scopes CloudPrivateCatalogProducerCatalogsDelete =
