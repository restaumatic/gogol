...
newCloudPrivateCatalogProducerCatalogsSetIamPolicy payload resource
  = CloudPrivateCatalogProducerCatalogsSetIamPolicy{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           CloudPrivateCatalogProducerCatalogsSetIamPolicy
         where
        type Rs CloudPrivateCatalogProducerCatalogsSetIamPolicy =
             GoogleIamV1Policy
        type Scopes CloudPrivateCatalogProducerCatalogsSetIamPolicy =
