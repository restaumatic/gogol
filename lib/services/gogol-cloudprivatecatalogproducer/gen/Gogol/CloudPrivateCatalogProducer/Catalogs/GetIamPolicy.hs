...
newCloudPrivateCatalogProducerCatalogsGetIamPolicy resource
  = CloudPrivateCatalogProducerCatalogsGetIamPolicy{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           CloudPrivateCatalogProducerCatalogsGetIamPolicy
         where
        type Rs CloudPrivateCatalogProducerCatalogsGetIamPolicy =
             GoogleIamV1Policy
        type Scopes CloudPrivateCatalogProducerCatalogsGetIamPolicy =
