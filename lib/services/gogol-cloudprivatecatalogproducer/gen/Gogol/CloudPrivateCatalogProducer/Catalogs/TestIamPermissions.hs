...
newCloudPrivateCatalogProducerCatalogsTestIamPermissions 
    ...
    -> CloudPrivateCatalogProducerCatalogsTestIamPermissions
newCloudPrivateCatalogProducerCatalogsTestIamPermissions payload
  resource
  = CloudPrivateCatalogProducerCatalogsTestIamPermissions{xgafv =
                                                            Core.Nothing,
...
instance Core.GoogleRequest
           CloudPrivateCatalogProducerCatalogsTestIamPermissions
         where
        type Rs CloudPrivateCatalogProducerCatalogsTestIamPermissions =
             GoogleIamV1TestIamPermissionsResponse
        type Scopes CloudPrivateCatalogProducerCatalogsTestIamPermissions =
