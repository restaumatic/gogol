...
--
-- /See:/ <https://developers.google.com/workspace/admin/alertcenter/ Google Workspace Alert Center API Reference> for @alertcenter.getSettings@.
module Gogol.AlertCenter.GetSettings
    (
    -- * Resource
...
newAlertCenterGetSettings 
    ::  AlertCenterGetSettings
newAlertCenterGetSettings
  = AlertCenterGetSettings{xgafv = Core.Nothing,
                           accessToken = Core.Nothing, callback = Core.Nothing,
                           customerId = Core.Nothing, uploadType = Core.Nothing,
