...
--
-- /See:/ <https://developers.google.com/workspace/admin/alertcenter/ Google Workspace Alert Center API Reference> for @alertcenter.alerts.delete@.
module Gogol.AlertCenter.Alerts.Delete
    (
    -- * Resource
...
newAlertCenterAlertsDelete alertId
  = AlertCenterAlertsDelete{xgafv = Core.Nothing,
