...
--
-- /See:/ <https://developers.google.com/workspace/admin/alertcenter/ Google Workspace Alert Center API Reference> for @alertcenter.alerts.batchUndelete@.
module Gogol.AlertCenter.Alerts.BatchUndelete
    (
    -- * Resource
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] BatchUndeleteAlertsRequest Core.:>
...
newAlertCenterAlertsBatchUndelete payload
  = AlertCenterAlertsBatchUndelete{xgafv = Core.Nothing,
