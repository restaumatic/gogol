...
-- Lists the alerts.
--
-- /See:/ <https://developers.google.com/workspace/admin/alertcenter/ Google Workspace Alert Center API Reference> for @alertcenter.alerts.list@.
module Gogol.AlertCenter.Alerts.List
    (
    -- * Resource
...
data AlertCenterAlertsList = AlertCenterAlertsList
    ...
    , customerId :: (Core.Maybe Core.Text)
      -- | Optional. A query string for filtering alert results. For more details, see <https://developers.google.com/workspace/admin/alertcenter/guides/query-filters Query filters> and <https://developers.google.com/workspace/admin/alertcenter/reference/filter-fields#alerts.list Supported query filter fields>.
...
newAlertCenterAlertsList 
    ::  AlertCenterAlertsList
newAlertCenterAlertsList
  = AlertCenterAlertsList{xgafv = Core.Nothing,
                          accessToken = Core.Nothing, callback = Core.Nothing,
                          customerId = Core.Nothing, filter = Core.Nothing,
...
instance Core.GoogleRequest AlertCenterAlertsList where
        ...
        requestClient AlertCenterAlertsList{..}
          = go xgafv accessToken callback customerId filter orderBy pageSize
              pageToken
              uploadType
              uploadProtocol
