...
--
-- /See:/ <https://developers.google.com/workspace/admin/alertcenter/ Google Workspace Alert Center API Reference> for @alertcenter.alerts.feedback.list@.
module Gogol.AlertCenter.Alerts.Feedback.List
    (
    -- * Resource
                       ...
                       Core.QueryParam "uploadType" Core.Text Core.:>
                         Core.QueryParam "upload_protocol" Core.Text Core.:>
                           Core.QueryParam "alt" Core.AltJSON Core.:>
                             Core.Get '[Core.JSON] ListAlertFeedbackResponse
...
data AlertCenterAlertsFeedbackList = AlertCenterAlertsFeedbackList
    ...
    , customerId :: (Core.Maybe Core.Text)
      -- | Optional. A query string for filtering alert feedback results. For more details, see <https://developers.google.com/workspace/admin/alertcenter/guides/query-filters Query filters> and <https://developers.google.com/workspace/admin/alertcenter/reference/filter-fields#alerts.feedback.list Supported query filter fields>.
...
newAlertCenterAlertsFeedbackList alertId
  = AlertCenterAlertsFeedbackList{xgafv = Core.Nothing,
                                  accessToken = Core.Nothing, alertId = alertId,
                                  callback = Core.Nothing, customerId = Core.Nothing,
                                  filter = Core.Nothing, uploadType = Core.Nothing,
...
instance Core.GoogleRequest AlertCenterAlertsFeedbackList where
        ...
        requestClient AlertCenterAlertsFeedbackList{..}
          = go alertId xgafv accessToken callback customerId filter
              uploadType
              uploadProtocol
