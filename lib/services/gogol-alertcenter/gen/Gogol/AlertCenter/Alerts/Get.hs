...
--
-- /See:/ <https://developers.google.com/workspace/admin/alertcenter/ Google Workspace Alert Center API Reference> for @alertcenter.alerts.get@.
module Gogol.AlertCenter.Alerts.Get
    (
    -- * Resource
...
newAlertCenterAlertsGet alertId
  = AlertCenterAlertsGet{xgafv = Core.Nothing,
...
instance Core.GoogleRequest AlertCenterAlertsGet where
        ...
        requestClient AlertCenterAlertsGet{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy AlertCenterAlertsGetResource)
                      Core.mempty
