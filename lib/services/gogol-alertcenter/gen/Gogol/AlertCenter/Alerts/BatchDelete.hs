...
--
-- /See:/ <https://developers.google.com/workspace/admin/alertcenter/ Google Workspace Alert Center API Reference> for @alertcenter.alerts.batchDelete@.
module Gogol.AlertCenter.Alerts.BatchDelete
    (
    -- * Resource
               ...
               Core.QueryParam "uploadType" Core.Text Core.:>
                 Core.QueryParam "upload_protocol" Core.Text Core.:>
                   Core.QueryParam "alt" Core.AltJSON Core.:>
                     Core.ReqBody '[Core.JSON] BatchDeleteAlertsRequest Core.:>
                       Core.Post '[Core.JSON] BatchDeleteAlertsResponse
...
newAlertCenterAlertsBatchDelete payload
  = AlertCenterAlertsBatchDelete{xgafv = Core.Nothing,
