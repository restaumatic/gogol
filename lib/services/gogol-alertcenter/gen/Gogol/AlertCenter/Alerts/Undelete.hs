...
--
-- /See:/ <https://developers.google.com/workspace/admin/alertcenter/ Google Workspace Alert Center API Reference> for @alertcenter.alerts.undelete@.
module Gogol.AlertCenter.Alerts.Undelete
    (
    -- * Resource
...
type AlertCenterAlertsUndeleteResource =
     "v1beta1" Core.:>
       "alerts" Core.:>
         Core.CaptureMode "alertId" "undelete" Core.Text Core.:>
                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] UndeleteAlertRequest Core.:>
                         Core.Post '[Core.JSON] Alert
...
newAlertCenterAlertsUndelete alertId payload
  = AlertCenterAlertsUndelete{xgafv = Core.Nothing,
...
instance Core.GoogleRequest AlertCenterAlertsUndelete where
        ...
        type Scopes AlertCenterAlertsUndelete = '[Apps'Alerts]
        requestClient AlertCenterAlertsUndelete{..}
          = go alertId xgafv accessToken callback uploadType uploadProtocol
              (Core.Just Core.AltJSON)
              payload
              alertCenterService
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy AlertCenterAlertsUndeleteResource)
                      Core.mempty
