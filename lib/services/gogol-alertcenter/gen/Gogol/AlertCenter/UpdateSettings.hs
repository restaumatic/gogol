...
--
-- /See:/ <https://developers.google.com/workspace/admin/alertcenter/ Google Workspace Alert Center API Reference> for @alertcenter.updateSettings@.
module Gogol.AlertCenter.UpdateSettings
    (
    -- * Resource
...
newAlertCenterUpdateSettings payload
  = AlertCenterUpdateSettings{xgafv = Core.Nothing,
                              accessToken = Core.Nothing, callback = Core.Nothing,
                              customerId = Core.Nothing, payload = payload,
