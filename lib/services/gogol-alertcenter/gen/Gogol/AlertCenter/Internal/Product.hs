...
newAbuseDetected 
    ::  AbuseDetected
newAbuseDetected
  = AbuseDetected{additionalDetails = Core.Nothing,
                  product = Core.Nothing, subAlertId = Core.Nothing,
...
instance Core.FromJSON AbuseDetected where
        parseJSON
          = Core.withObject "AbuseDetected"
              (\ o ->
                 AbuseDetected Core.<$>
                   (o Core..:? "additionalDetails") Core.<*> (o Core..:? "product")
...
newAccessApproval 
    ::  AccessApproval
newAccessApproval
  = AccessApproval{justificationReason = Core.Nothing,
                   officeLocation = Core.Nothing, products = Core.Nothing,
                   requestId = Core.Nothing, scope = Core.Nothing,
                   tickets = Core.Nothing}
instance Core.FromJSON AccessApproval where
        parseJSON
          = Core.withObject "AccessApproval"
              (\ o ->
                 AccessApproval Core.<$>
                   (o Core..:? "justificationReason") Core.<*>
                     (o Core..:? "officeLocation")
...
newAccountSuspensionDetails 
    ::  AccountSuspensionDetails
newAccountSuspensionDetails
  = AccountSuspensionDetails{abuseReason = Core.Nothing,
          ...
          = Core.withObject "AccountSuspensionDetails"
              (\ o ->
                 AccountSuspensionDetails Core.<$>
                   (o Core..:? "abuseReason") Core.<*> (o Core..:? "productName"))
...
newAccountSuspensionWarning 
    ::  AccountSuspensionWarning
newAccountSuspensionWarning
  = AccountSuspensionWarning{appealWindow = Core.Nothing,
                             state = Core.Nothing, suspensionDetails = Core.Nothing}
          ...
          = Core.withObject "AccountSuspensionWarning"
              (\ o ->
                 AccountSuspensionWarning Core.<$>
                   (o Core..:? "appealWindow") Core.<*> (o Core..:? "state") Core.<*>
                     (o Core..:? "suspensionDetails"))
...
instance Core.FromJSON AccountWarning where
        parseJSON
          = Core.withObject "AccountWarning"
              (\ o ->
                 AccountWarning Core.<$>
                   (o Core..:? "email") Core.<*> (o Core..:? "loginDetails"))
...
newActivityRule 
    ::  ActivityRule
newActivityRule
  = ActivityRule{actionNames = Core.Nothing,
                 createTime = Core.Nothing, description = Core.Nothing,
                 displayName = Core.Nothing, name = Core.Nothing,
                 query = Core.Nothing, supersededAlerts = Core.Nothing,
                 supersedingAlert = Core.Nothing, threshold = Core.Nothing,
                 triggerSource = Core.Nothing, updateTime = Core.Nothing,
...
instance Core.FromJSON ActivityRule where
        parseJSON
          = Core.withObject "ActivityRule"
              (\ o ->
                 ActivityRule Core.<$>
                   (o Core..:? "actionNames") Core.<*> (o Core..:? "createTime")
          ...
          = Core.object
              (Core.catMaybes
                 [("actionNames" Core..=) Core.<$> actionNames,
                  ...
                  ("name" Core..=) Core.<$> name, ("query" Core..=) Core.<$> query,
...
data Alert = Alert
    ...
    , startTime :: (Core.Maybe Core.DateTime)
      -- | Required. The type of the alert. This is output only after alert is created. For a list of available alert types see <https://developers.google.com/workspace/admin/alertcenter/reference/alert-types Google Workspace Alert types>.
...
newAlert 
    ::  Alert
newAlert
  = Alert{alertId = Core.Nothing, createTime = Core.Nothing,
          customerId = Core.Nothing, data' = Core.Nothing,
          deleted = Core.Nothing, endTime = Core.Nothing,
          etag = Core.Nothing, metadata = Core.Nothing,
...
instance Core.FromJSON Alert where
        parseJSON
          = Core.withObject "Alert"
              (\ o ->
                 Alert Core.<$>
                   (o Core..:? "alertId") Core.<*> (o Core..:? "createTime") Core.<*>
                     (o Core..:? "customerId")
                     Core.<*> (o Core..:? "data")
                     Core.<*> (o Core..:? "deleted")
                     Core.<*> (o Core..:? "endTime")
...
newAlertFeedback 
    ::  AlertFeedback
newAlertFeedback
  = AlertFeedback{alertId = Core.Nothing, createTime = Core.Nothing,
                  customerId = Core.Nothing, email = Core.Nothing,
                  feedbackId = Core.Nothing, type' = Core.Nothing}
...
newAlertMetadata 
    ::  AlertMetadata
newAlertMetadata
  = AlertMetadata{alertId = Core.Nothing, assignee = Core.Nothing,
                  customerId = Core.Nothing, etag = Core.Nothing,
...
instance Core.FromJSON AlertMetadata where
        parseJSON
          = Core.withObject "AlertMetadata"
              (\ o ->
                 AlertMetadata Core.<$>
                   (o Core..:? "alertId") Core.<*> (o Core..:? "assignee") Core.<*>
                     (o Core..:? "customerId")
                     Core.<*> (o Core..:? "etag")
...
newApnsCertificateExpirationInfo 
    ::  ApnsCertificateExpirationInfo
newApnsCertificateExpirationInfo
  = ApnsCertificateExpirationInfo{appleId = Core.Nothing,
                                  expirationTime = Core.Nothing, uid = Core.Nothing}
          ...
          = Core.withObject "ApnsCertificateExpirationInfo"
              (\ o ->
                 ApnsCertificateExpirationInfo Core.<$>
                   (o Core..:? "appleId") Core.<*> (o Core..:? "expirationTime")
                     Core.<*> (o Core..:? "uid"))
...
newAppSettingsChanged 
    ::  AppSettingsChanged
newAppSettingsChanged
  = AppSettingsChanged{alertDetails = Core.Nothing,
                       name = Core.Nothing}
          ...
          = Core.withObject "AppSettingsChanged"
              (\ o ->
                 AppSettingsChanged Core.<$>
                   (o Core..:? "alertDetails") Core.<*> (o Core..:? "name"))
...
newAppsOutage 
    ::  AppsOutage
newAppsOutage
  = AppsOutage{dashboardUri = Core.Nothing,
               incidentTrackingId = Core.Nothing, mergeInfo = Core.Nothing,
               nextUpdateTime = Core.Nothing, products = Core.Nothing,
               resolutionTime = Core.Nothing, status = Core.Nothing}
...
newBadWhitelist 
    ::  BadWhitelist
newBadWhitelist
  = BadWhitelist{domainId = Core.Nothing,
                 maliciousEntity = Core.Nothing, messages = Core.Nothing,
...
instance Core.FromJSON BadWhitelist where
        parseJSON
          = Core.withObject "BadWhitelist"
              (\ o ->
                 BadWhitelist Core.<$>
                   (o Core..:? "domainId") Core.<*> (o Core..:? "maliciousEntity")
...
newBatchDeleteAlertsRequest 
    ::  BatchDeleteAlertsRequest
newBatchDeleteAlertsRequest
  = BatchDeleteAlertsRequest{alertId = Core.Nothing,
          ...
          = Core.withObject "BatchDeleteAlertsRequest"
              (\ o ->
                 BatchDeleteAlertsRequest Core.<$>
                   (o Core..:? "alertId") Core.<*> (o Core..:? "customerId"))
...
newBatchDeleteAlertsResponse 
    ::  BatchDeleteAlertsResponse
newBatchDeleteAlertsResponse
  = BatchDeleteAlertsResponse{failedAlertStatus = Core.Nothing,
...
newBatchDeleteAlertsResponse_FailedAlertStatus additional
  = BatchDeleteAlertsResponse_FailedAlertStatus{additional =
                                                  additional}
instance Core.FromJSON BatchDeleteAlertsResponse_FailedAlertStatus
         where
        parseJSON
          = Core.withObject "BatchDeleteAlertsResponse_FailedAlertStatus"
              (\ o ->
                 BatchDeleteAlertsResponse_FailedAlertStatus Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON BatchDeleteAlertsResponse_FailedAlertStatus
         where
...
newBatchUndeleteAlertsRequest 
    ::  BatchUndeleteAlertsRequest
newBatchUndeleteAlertsRequest
  = BatchUndeleteAlertsRequest{alertId = Core.Nothing,
                               customerId = Core.Nothing}
...
newBatchUndeleteAlertsResponse 
    ::  BatchUndeleteAlertsResponse
newBatchUndeleteAlertsResponse
  = BatchUndeleteAlertsResponse{failedAlertStatus = Core.Nothing,
                                successAlertIds = Core.Nothing}
...
newBatchUndeleteAlertsResponse_FailedAlertStatus additional
  = BatchUndeleteAlertsResponse_FailedAlertStatus{additional =
                                                    additional}
instance Core.FromJSON
           BatchUndeleteAlertsResponse_FailedAlertStatus
         where
        parseJSON
          = Core.withObject "BatchUndeleteAlertsResponse_FailedAlertStatus"
              (\ o ->
                 BatchUndeleteAlertsResponse_FailedAlertStatus Core.<$>
                   (Core.parseJSONObject o))

instance Core.ToJSON BatchUndeleteAlertsResponse_FailedAlertStatus
         where
...
newCloudPubsubTopic 
    ::  CloudPubsubTopic
newCloudPubsubTopic
  = CloudPubsubTopic{payloadFormat = Core.Nothing,
          ...
          = Core.withObject "CloudPubsubTopic"
              (\ o ->
                 CloudPubsubTopic Core.<$>
                   (o Core..:? "payloadFormat") Core.<*> (o Core..:? "topicName"))
...
instance Core.FromJSON Csv where
        parseJSON
          = Core.withObject "Csv"
              (\ o ->
                 Csv Core.<$>
                   (o Core..:? "dataRows") Core.<*> (o Core..:? "headers"))
...
newDeviceCompromisedSecurityDetail 
    :: 
                                   DeviceCompromisedSecurityDetail
newDeviceCompromisedSecurityDetail
  = DeviceCompromisedSecurityDetail{deviceCompromisedState =
                                      Core.Nothing,
                                    deviceId = Core.Nothing, deviceModel = Core.Nothing,
                                    deviceType = Core.Nothing, iosVendorId = Core.Nothing,
                                    resourceId = Core.Nothing, serialNumber = Core.Nothing}
...
newDeviceManagementRule 
    ::  DeviceManagementRule
newDeviceManagementRule
  = DeviceManagementRule{deviceId = Core.Nothing,
                         deviceModel = Core.Nothing, deviceType = Core.Nothing,
                         email = Core.Nothing, id = Core.Nothing,
                         iosVendorId = Core.Nothing, ownerId = Core.Nothing,
                         resourceId = Core.Nothing, ruleAction = Core.Nothing,
                         serialNumber = Core.Nothing}
instance Core.FromJSON DeviceManagementRule where
        parseJSON
          = Core.withObject "DeviceManagementRule"
              (\ o ->
                 DeviceManagementRule Core.<$>
                   (o Core..:? "deviceId") Core.<*> (o Core..:? "deviceModel")
                     Core.<*> (o Core..:? "deviceType")
                     Core.<*> (o Core..:? "email")
                     Core.<*> (o Core..:? "id")
                     Core.<*> (o Core..:? "iosVendorId")
...
newDomainWideTakeoutInitiated 
    ::  DomainWideTakeoutInitiated
newDomainWideTakeoutInitiated
  = DomainWideTakeoutInitiated{email = Core.Nothing,
          ...
          = Core.withObject "DomainWideTakeoutInitiated"
              (\ o ->
                 DomainWideTakeoutInitiated Core.<$>
                   (o Core..:? "email") Core.<*> (o Core..:? "takeoutRequestId"))
...
newEntity 
    ::  Entity
newEntity
  = Entity{link = Core.Nothing, name = Core.Nothing,
           values = Core.Nothing}
instance Core.FromJSON Entity where
        parseJSON
          = Core.withObject "Entity"
              (\ o ->
                 Entity Core.<$>
                   (o Core..:? "link") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "values"))
...
instance Core.ToJSON Entity where
        toJSON Entity{..}
          = Core.object
              (Core.catMaybes
                 [("link" Core..=) Core.<$> link, ("name" Core..=) Core.<$> name,
...
newEntityList 
    ::  EntityList
newEntityList
  = EntityList{entities = Core.Nothing, headers = Core.Nothing,
               name = Core.Nothing}
instance Core.FromJSON EntityList where
        parseJSON
          = Core.withObject "EntityList"
              (\ o ->
                 EntityList Core.<$>
                   (o Core..:? "entities") Core.<*> (o Core..:? "headers") Core.<*>
                     (o Core..:? "name"))
...
newGmailMessageInfo 
    ::  GmailMessageInfo
newGmailMessageInfo
  = GmailMessageInfo{attachmentsSha256Hash = Core.Nothing,
                     date = Core.Nothing, md5HashMessageBody = Core.Nothing,
                     md5HashSubject = Core.Nothing, messageBodySnippet = Core.Nothing,
                     messageId = Core.Nothing, recipient = Core.Nothing,
                     sentTime = Core.Nothing, subjectText = Core.Nothing}
instance Core.FromJSON GmailMessageInfo where
        parseJSON
          = Core.withObject "GmailMessageInfo"
              (\ o ->
                 GmailMessageInfo Core.<$>
                   (o Core..:? "attachmentsSha256Hash") Core.<*> (o Core..:? "date")
...
newGoogleOperations 
    ::  GoogleOperations
newGoogleOperations
  = GoogleOperations{affectedUserEmails = Core.Nothing,
                     attachmentData = Core.Nothing, description = Core.Nothing,
                     domain = Core.Nothing, header = Core.Nothing, title = Core.Nothing}
...
newListAlertsResponse 
    ::  ListAlertsResponse
newListAlertsResponse
  = ListAlertsResponse{alerts = Core.Nothing,
          ...
          = Core.withObject "ListAlertsResponse"
              (\ o ->
                 ListAlertsResponse Core.<$>
                   (o Core..:? "alerts") Core.<*> (o Core..:? "nextPageToken"))
...
instance Core.FromJSON LoginDetails where
        parseJSON
          = Core.withObject "LoginDetails"
              (\ o ->
                 LoginDetails Core.<$>
                   (o Core..:? "ipAddress") Core.<*> (o Core..:? "loginTime"))
...
newMailPhishing 
    ::  MailPhishing
newMailPhishing
  = MailPhishing{domainId = Core.Nothing, isInternal = Core.Nothing,
                 maliciousEntity = Core.Nothing, messages = Core.Nothing,
...
instance Core.FromJSON MailPhishing where
        parseJSON
          = Core.withObject "MailPhishing"
              (\ o ->
                 MailPhishing Core.<$>
                   (o Core..:? "domainId") Core.<*> (o Core..:? "isInternal") Core.<*>
...
newMaliciousEntity 
    ::  MaliciousEntity
newMaliciousEntity
  = MaliciousEntity{displayName = Core.Nothing,
                    entity = Core.Nothing, fromHeader = Core.Nothing}
instance Core.FromJSON MaliciousEntity where
        parseJSON
          = Core.withObject "MaliciousEntity"
              (\ o ->
                 MaliciousEntity Core.<$>
                   (o Core..:? "displayName") Core.<*> (o Core..:? "entity") Core.<*>
                     (o Core..:? "fromHeader"))
...
newMandatoryServiceAnnouncement 
    ::  MandatoryServiceAnnouncement
newMandatoryServiceAnnouncement
  = MandatoryServiceAnnouncement{description = Core.Nothing,
                                 title = Core.Nothing}
...
newMatchInfo 
    ::  MatchInfo
newMatchInfo
  = MatchInfo{predefinedDetector = Core.Nothing,
...
newMergeInfo 
    ::  MergeInfo
newMergeInfo
  = MergeInfo{newAlertId' = Core.Nothing,
...
-- | Settings for callback notifications. For more details see <https://developers.google.com/workspace/admin/alertcenter/guides/notifications Google Workspace Alert Notification>.
--
...
-- | Alert for a spike in user reported phishing. /Warning/: This type has been deprecated. Use <https://developers.google.com/workspace/admin/alertcenter/reference/rest/v1beta1/MailPhishing MailPhishing> instead.
--
...
newPhishingSpike 
    ::  PhishingSpike
newPhishingSpike
  = PhishingSpike{domainId = Core.Nothing, isInternal = Core.Nothing,
                  maliciousEntity = Core.Nothing, messages = Core.Nothing}
...
newPrimaryAdminChangedEvent 
    ::  PrimaryAdminChangedEvent
newPrimaryAdminChangedEvent
  = PrimaryAdminChangedEvent{domain = Core.Nothing,
          ...
          = Core.withObject "PrimaryAdminChangedEvent"
              (\ o ->
                 PrimaryAdminChangedEvent Core.<$>
                   (o Core..:? "domain") Core.<*> (o Core..:? "previousAdminEmail")
...
newReportingRule 
    ::  ReportingRule
newReportingRule
  = ReportingRule{alertDetails = Core.Nothing, name = Core.Nothing,
                  query = Core.Nothing}
instance Core.FromJSON ReportingRule where
        parseJSON
          = Core.withObject "ReportingRule"
              (\ o ->
                 ReportingRule Core.<$>
                   (o Core..:? "alertDetails") Core.<*> (o Core..:? "name") Core.<*>
                     (o Core..:? "query"))
...
newRequestInfo 
    ::  RequestInfo
newRequestInfo
  = RequestInfo{appDeveloperEmail = Core.Nothing,
                appKey = Core.Nothing, numberOfRequests = Core.Nothing}
instance Core.FromJSON RequestInfo where
        parseJSON
          = Core.withObject "RequestInfo"
              (\ o ->
                 RequestInfo Core.<$>
                   (o Core..:? "appDeveloperEmail") Core.<*> (o Core..:? "appKey")
                     Core.<*>
                     (o Core..:? "numberOfRequests" Core.<&> Core.fmap Core.fromAsText))
          ...
          = Core.object
              (Core.catMaybes
                 [("appDeveloperEmail" Core..=) Core.<$> appDeveloperEmail,
                  ...
                  ("numberOfRequests" Core..=) Core.. Core.AsText Core.<$>
                    numberOfRequests])
...
newResourceInfo 
    ::  ResourceInfo
newResourceInfo
  = ResourceInfo{chatAttachmentId = Core.Nothing,
                 chatMessageId = Core.Nothing, deviceId = Core.Nothing,
                 documentId = Core.Nothing, resourceTitle = Core.Nothing}
instance Core.FromJSON ResourceInfo where
        parseJSON
          = Core.withObject "ResourceInfo"
              (\ o ->
                 ResourceInfo Core.<$>
                   (o Core..:? "chatAttachmentId") Core.<*>
                     (o Core..:? "chatMessageId")
...
instance Core.FromJSON RuleInfo where
        parseJSON
          = Core.withObject "RuleInfo"
              (\ o ->
                 RuleInfo Core.<$>
                   (o Core..:? "displayName") Core.<*> (o Core..:? "resourceName"))
...
newRuleViolationInfo 
    ::  RuleViolationInfo
newRuleViolationInfo
  = RuleViolationInfo{dataSource = Core.Nothing,
                      eventType = Core.Nothing, matchInfo = Core.Nothing,
                      recipients = Core.Nothing, resourceInfo = Core.Nothing,
                      ruleInfo = Core.Nothing, suppressedActionTypes = Core.Nothing,
                      trigger = Core.Nothing, triggeredActionInfo = Core.Nothing,
          ...
          = Core.withObject "RuleViolationInfo"
              (\ o ->
                 RuleViolationInfo Core.<$>
                   (o Core..:? "dataSource") Core.<*> (o Core..:? "eventType")
...
newSSOProfileUpdatedEvent 
    ::  SSOProfileUpdatedEvent
newSSOProfileUpdatedEvent
  = SSOProfileUpdatedEvent{inboundSsoProfileChanges = Core.Nothing,
...
newSensitiveAdminAction 
    ::  SensitiveAdminAction
newSensitiveAdminAction
  = SensitiveAdminAction{actorEmail = Core.Nothing,
                         eventTime = Core.Nothing, primaryAdminChangedEvent = Core.Nothing,
          ...
          = Core.withObject "SensitiveAdminAction"
              (\ o ->
                 SensitiveAdminAction Core.<$>
                   (o Core..:? "actorEmail") Core.<*> (o Core..:? "eventTime")
...
instance Core.FromJSON SupportTicket where
        parseJSON
          = Core.withObject "SupportTicket"
              (\ o ->
                 SupportTicket Core.<$>
                   (o Core..:? "ticketId") Core.<*> (o Core..:? "ticketUrl"))
...
newSuspiciousActivitySecurityDetail 
    :: 
                                    SuspiciousActivitySecurityDetail
newSuspiciousActivitySecurityDetail
  = SuspiciousActivitySecurityDetail{deviceId = Core.Nothing,
                                     deviceModel = Core.Nothing, deviceProperty = Core.Nothing,
                                     deviceType = Core.Nothing, iosVendorId = Core.Nothing,
                                     newValue' = Core.Nothing, oldValue = Core.Nothing,
                                     resourceId = Core.Nothing, serialNumber = Core.Nothing}
...
newTransferError 
    ::  TransferError
newTransferError
  = TransferError{email = Core.Nothing, entityType = Core.Nothing,
                  id = Core.Nothing, invalidReason = Core.Nothing,
                  name = Core.Nothing}
instance Core.FromJSON TransferError where
        parseJSON
          = Core.withObject "TransferError"
              (\ o ->
                 TransferError Core.<$>
                   (o Core..:? "email") Core.<*> (o Core..:? "entityType") Core.<*>
                     (o Core..:? "id")
...
newUserDefinedDetectorInfo 
    ::  UserDefinedDetectorInfo
newUserDefinedDetectorInfo
  = UserDefinedDetectorInfo{displayName = Core.Nothing,
...
--
-- /See:/ 'newVaultAcceleratedDeletion' smart constructor.
data VaultAcceleratedDeletion = VaultAcceleratedDeletion
    {
      -- | The action can be one of create and cancel
      actionType :: (Core.Maybe VaultAcceleratedDeletion_ActionType)
      -- | Currentlty only Gmail is supported as app type
    , appType :: (Core.Maybe VaultAcceleratedDeletion_AppType)
    ...
    , deletionRequestId :: (Core.Maybe Core.Text)
...
-- | Creates a value of 'VaultAcceleratedDeletion' with the minimum fields required to make a request.
newVaultAcceleratedDeletion 
    ::  VaultAcceleratedDeletion
newVaultAcceleratedDeletion
  = VaultAcceleratedDeletion{actionType = Core.Nothing,
                             appType = Core.Nothing, createTime = Core.Nothing,
                             deletionRequestId = Core.Nothing, matterId = Core.Nothing}
instance Core.FromJSON VaultAcceleratedDeletion where
        parseJSON
          = Core.withObject "VaultAcceleratedDeletion"
              (\ o ->
                 VaultAcceleratedDeletion Core.<$>
                   (o Core..:? "actionType") Core.<*> (o Core..:? "appType") Core.<*>
                     (o Core..:? "createTime")
                     Core.<*> (o Core..:? "deletionRequestId")
                     Core.<*> (o Core..:? "matterId"))

instance Core.ToJSON VaultAcceleratedDeletion where
        toJSON VaultAcceleratedDeletion{..}
          = Core.object
              (Core.catMaybes
                 [("actionType" Core..=) Core.<$> actionType,
                  ("appType" Core..=) Core.<$> appType,
                  ("createTime" Core..=) Core.<$> createTime,
                  ("deletionRequestId" Core..=) Core.<$> deletionRequestId,
...
newVoiceMisconfiguration 
    ::  VoiceMisconfiguration
newVoiceMisconfiguration
  = VoiceMisconfiguration{entityName = Core.Nothing,
                          entityType = Core.Nothing, fixUri = Core.Nothing,
          ...
          = Core.withObject "VoiceMisconfiguration"
              (\ o ->
                 VoiceMisconfiguration Core.<$>
                   (o Core..:? "entityName") Core.<*> (o Core..:? "entityType")
                     Core.<*> (o Core..:? "fixUri")
...
newVoicemailRecipientError 
    ::  VoicemailRecipientError
newVoicemailRecipientError
  = VoicemailRecipientError{email = Core.Nothing,
          ...
          = Core.withObject "VoicemailRecipientError"
              (\ o ->
                 VoicemailRecipientError Core.<$>
                   (o Core..:? "email") Core.<*> (o Core..:? "invalidReason"))
