                           ...
                           Core.QueryParam "startLine" Core.Int32 Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.QueryParam "uploadType" Core.AltMedia Core.:>
                                 Core.AltMedia Core.:> Core.Post '[Core.JSON] Task
...
newFusionTablesTableReplaceRows tableId
  = FusionTablesTableReplaceRows{delimiter = Core.Nothing,
                                 encoding = Core.Nothing, endLine = Core.Nothing,
                                 isStrict = Core.Nothing, startLine = Core.Nothing,
                                 tableId = tableId}
instance Core.GoogleRequest FusionTablesTableReplaceRows where
        type Rs FusionTablesTableReplaceRows = Task
        type Scopes FusionTablesTableReplaceRows =
             '[Fusiontables'FullControl]
        requestClient FusionTablesTableReplaceRows{..}
          = go tableId delimiter encoding endLine isStrict startLine
...
instance Core.GoogleRequest
        ...
        type Scopes (Core.MediaUpload FusionTablesTableReplaceRows) =
