                           ...
                           Core.QueryParam "startLine" Core.Int32 Core.:>
                             Core.QueryParam "alt" Core.AltJSON Core.:>
                               Core.QueryParam "uploadType" Core.AltMedia Core.:>
                                 Core.AltMedia Core.:> Core.Post '[Core.JSON] Import
...
newFusionTablesTableImportRows tableId
  = FusionTablesTableImportRows{delimiter = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes (Core.MediaUpload FusionTablesTableImportRows) =
