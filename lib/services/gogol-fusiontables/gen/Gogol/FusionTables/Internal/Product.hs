...
newBucket 
    ::  Bucket
newBucket
  = Bucket{color = Core.Nothing, icon = Core.Nothing,
           max = Core.Nothing, min = Core.Nothing, opacity = Core.Nothing,
           weight = Core.Nothing}
instance Core.FromJSON Bucket where
        parseJSON
          = Core.withObject "Bucket"
              (\ o ->
                 Bucket Core.<$>
                   (o Core..:? "color") Core.<*> (o Core..:? "icon") Core.<*>
                     (o Core..:? "max")
                     Core.<*> (o Core..:? "min")
                     Core.<*> (o Core..:? "opacity")
                     Core.<*> (o Core..:? "weight"))
...
instance Core.ToJSON Bucket where
        toJSON Bucket{..}
          = Core.object
              (Core.catMaybes
                 [("color" Core..=) Core.<$> color, ("icon" Core..=) Core.<$> icon,
...
newColumn 
    ::  Column
newColumn
  = Column{baseColumn = Core.Nothing, columnId = Core.Nothing,
           columnJsonSchema = Core.Nothing,
           columnPropertiesJson = Core.Nothing, description = Core.Nothing,
           formatPattern = Core.Nothing, graphPredicate = Core.Nothing,
           kind = "fusiontables#column", name = Core.Nothing,
           type' = Core.Nothing, validValues = Core.Nothing,
...
instance Core.FromJSON Column where
        parseJSON
          = Core.withObject "Column"
              (\ o ->
                 Column Core.<$>
                   (o Core..:? "baseColumn") Core.<*> (o Core..:? "columnId") Core.<*>
                     (o Core..:? "columnJsonSchema")
...
newColumn_BaseColumn 
    ::  Column_BaseColumn
newColumn_BaseColumn
  = Column_BaseColumn{columnId = Core.Nothing,
          ...
          = Core.withObject "Column_BaseColumn"
              (\ o ->
                 Column_BaseColumn Core.<$>
                   (o Core..:? "columnId") Core.<*> (o Core..:? "tableIndex"))
...
newColumnList 
    ::  ColumnList
newColumnList
  = ColumnList{items = Core.Nothing,
               kind = "fusiontables#columnList", nextPageToken = Core.Nothing,
        ...
        parseJSON
          = Core.withObject "ColumnList"
              (\ o ->
                 ColumnList Core.<$>
                   (o Core..:? "items") Core.<*>
                     (o Core..:? "kind" Core..!= "fusiontables#columnList")
...
newGeometry 
    ::  Geometry
newGeometry
  = Geometry{geometries = Core.Nothing, geometry = Core.Nothing,
...
instance Core.FromJSON Geometry where
        parseJSON
          = Core.withObject "Geometry"
              (\ o ->
                 Geometry Core.<$>
                   (o Core..:? "geometries") Core.<*> (o Core..:? "geometry") Core.<*>
...
newImport 
    ::  Import
newImport
  = Import{kind = "fusiontables#import",
...
instance Core.FromJSON Import where
        parseJSON
          = Core.withObject "Import"
              (\ o ->
                 Import Core.<$>
                   (o Core..:? "kind" Core..!= "fusiontables#import") Core.<*>
                     (o Core..:? "numRowsReceived" Core.<&> Core.fmap Core.fromAsText))
          ...
          = Core.object
              (Core.catMaybes
                 [Core.Just ("kind" Core..= kind),
                  ("numRowsReceived" Core..=) Core.. Core.AsText Core.<$>
                    numRowsReceived])
...
instance Core.FromJSON Line where
        parseJSON
          = Core.withObject "Line"
              (\ o ->
                 Line Core.<$>
                   (o Core..:? "coordinates") Core.<*>
                     (o Core..:? "type" Core..!= "LineString"))
...
newLineStyle 
    ::  LineStyle
newLineStyle
  = LineStyle{strokeColor = Core.Nothing,
              strokeColorStyler = Core.Nothing, strokeOpacity = Core.Nothing,
              strokeWeight = Core.Nothing, strokeWeightStyler = Core.Nothing}
...
instance Core.FromJSON PointStyle where
        parseJSON
          = Core.withObject "PointStyle"
              (\ o ->
                 PointStyle Core.<$>
                   (o Core..:? "iconName") Core.<*> (o Core..:? "iconStyler"))
...
newPolygonStyle 
    ::  PolygonStyle
newPolygonStyle
  = PolygonStyle{fillColor = Core.Nothing,
                 fillColorStyler = Core.Nothing, fillOpacity = Core.Nothing,
                 strokeColor = Core.Nothing, strokeColorStyler = Core.Nothing,
                 strokeOpacity = Core.Nothing, strokeWeight = Core.Nothing,
...
instance Core.FromJSON PolygonStyle where
        parseJSON
          = Core.withObject "PolygonStyle"
              (\ o ->
                 PolygonStyle Core.<$>
                   (o Core..:? "fillColor") Core.<*> (o Core..:? "fillColorStyler")
...
newSqlresponse 
    ::  Sqlresponse
newSqlresponse
  = Sqlresponse{columns = Core.Nothing,
                kind = "fusiontables#sqlresponse", rows = Core.Nothing}
        ...
        parseJSON
          = Core.withObject "Sqlresponse"
              (\ o ->
                 Sqlresponse Core.<$>
                   (o Core..:? "columns") Core.<*>
                     (o Core..:? "kind" Core..!= "fusiontables#sqlresponse")
                     Core.<*> (o Core..:? "rows"))
...
newStyleFunction 
    ::  StyleFunction
newStyleFunction
  = StyleFunction{buckets = Core.Nothing, columnName = Core.Nothing,
                  gradient = Core.Nothing, kind = Core.Nothing}
instance Core.FromJSON StyleFunction where
        parseJSON
          = Core.withObject "StyleFunction"
              (\ o ->
                 StyleFunction Core.<$>
                   (o Core..:? "buckets") Core.<*> (o Core..:? "columnName") Core.<*>
                     (o Core..:? "gradient")
                     Core.<*> (o Core..:? "kind"))
...
newStyleFunction_Gradient 
    ::  StyleFunction_Gradient
newStyleFunction_Gradient
  = StyleFunction_Gradient{colors = Core.Nothing, max = Core.Nothing,
                           min = Core.Nothing}
          ...
          = Core.withObject "StyleFunction_Gradient"
              (\ o ->
                 StyleFunction_Gradient Core.<$>
                   (o Core..:? "colors") Core.<*> (o Core..:? "max") Core.<*>
                     (o Core..:? "min"))
...
instance Core.ToJSON StyleFunction_Gradient where
        toJSON StyleFunction_Gradient{..}
          = Core.object
              (Core.catMaybes
                 [("colors" Core..=) Core.<$> colors, ("max" Core..=) Core.<$> max,
                  ("min" Core..=) Core.<$> min])
...
newStyleFunction_Gradient_ColorsItem 
    :: 
                                     StyleFunction_Gradient_ColorsItem
newStyleFunction_Gradient_ColorsItem
  = StyleFunction_Gradient_ColorsItem{color = Core.Nothing,
...
newStyleSetting 
    ::  StyleSetting
newStyleSetting
  = StyleSetting{kind = "fusiontables#styleSetting",
                 markerOptions = Core.Nothing, name = Core.Nothing,
                 polygonOptions = Core.Nothing, polylineOptions = Core.Nothing,
                 styleId = Core.Nothing, tableId = Core.Nothing}
instance Core.FromJSON StyleSetting where
        parseJSON
          = Core.withObject "StyleSetting"
              (\ o ->
                 StyleSetting Core.<$>
                   (o Core..:? "kind" Core..!= "fusiontables#styleSetting") Core.<*>
                     (o Core..:? "markerOptions")
                     Core.<*> (o Core..:? "name")
...
newStyleSettingList 
    ::  StyleSettingList
newStyleSettingList
  = StyleSettingList{items = Core.Nothing,
          ...
          = Core.withObject "StyleSettingList"
              (\ o ->
                 StyleSettingList Core.<$>
                   (o Core..:? "items") Core.<*>
                     (o Core..:? "kind" Core..!= "fusiontables#styleSettingList")
                     Core.<*> (o Core..:? "nextPageToken")
                     Core.<*> (o Core..:? "totalItems"))
...
newTable 
    ::  Table
newTable
  = Table{attribution = Core.Nothing, attributionLink = Core.Nothing,
          baseTableIds = Core.Nothing,
          columnPropertiesJsonSchema = Core.Nothing, columns = Core.Nothing,
          description = Core.Nothing, isExportable = Core.Nothing,
          kind = "fusiontables#table", name = Core.Nothing,
          sql = Core.Nothing, tableId = Core.Nothing,
...
instance Core.FromJSON Table where
        parseJSON
          = Core.withObject "Table"
              (\ o ->
                 Table Core.<$>
                   (o Core..:? "attribution") Core.<*> (o Core..:? "attributionLink")
          ...
          = Core.object
              (Core.catMaybes
                 [("attribution" Core..=) Core.<$> attribution,
                  ...
                  Core.Just ("kind" Core..= kind), ("name" Core..=) Core.<$> name,
                  ("sql" Core..=) Core.<$> sql, ("tableId" Core..=) Core.<$> tableId,
...
newTableList 
    ::  TableList
newTableList
  = TableList{items = Core.Nothing, kind = "fusiontables#tableList",
...
newTask 
    ::  Task
newTask
  = Task{kind = "fusiontables#task", progress = Core.Nothing,
         started = Core.Nothing, taskId = Core.Nothing,
         type' = Core.Nothing}
instance Core.FromJSON Task where
        parseJSON
          = Core.withObject "Task"
              (\ o ->
                 Task Core.<$>
                   (o Core..:? "kind" Core..!= "fusiontables#task") Core.<*>
                     (o Core..:? "progress")
                     Core.<*> (o Core..:? "started")
...
newTaskList 
    ::  TaskList
newTaskList
  = TaskList{items = Core.Nothing, kind = "fusiontables#taskList",
             nextPageToken = Core.Nothing, totalItems = Core.Nothing}
...
newTemplate 
    ::  Template
newTemplate
  = Template{automaticColumnNames = Core.Nothing,
             body = Core.Nothing, kind = "fusiontables#template",
             name = Core.Nothing, tableId = Core.Nothing,
...
instance Core.FromJSON Template where
        parseJSON
          = Core.withObject "Template"
              (\ o ->
                 Template Core.<$>
                   (o Core..:? "automaticColumnNames") Core.<*> (o Core..:? "body")
          ...
          = Core.object
              (Core.catMaybes
                 [("automaticColumnNames" Core..=) Core.<$> automaticColumnNames,
                  ("body" Core..=) Core.<$> body, Core.Just ("kind" Core..= kind),
                  ("name" Core..=) Core.<$> name,
                  ("tableId" Core..=) Core.<$> tableId,
...
newTemplateList 
    ::  TemplateList
newTemplateList
  = TemplateList{items = Core.Nothing,
                 kind = "fusiontables#templateList", nextPageToken = Core.Nothing,
                 totalItems = Core.Nothing}
        ...
        parseJSON
          = Core.withObject "TemplateList"
              (\ o ->
                 TemplateList Core.<$>
                   (o Core..:? "items") Core.<*>
                     (o Core..:? "kind" Core..!= "fusiontables#templateList")
                     Core.<*> (o Core..:? "nextPageToken")
                     Core.<*> (o Core..:? "totalItems"))
