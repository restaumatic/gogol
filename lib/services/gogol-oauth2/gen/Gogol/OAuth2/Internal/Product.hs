...
newTokeninfo 
    ::  Tokeninfo
newTokeninfo
  = Tokeninfo{audience = Core.Nothing, email = Core.Nothing,
              expiresIn = Core.Nothing, issuedTo = Core.Nothing,
              scope = Core.Nothing, userId = Core.Nothing,
              verifiedEmail = Core.Nothing}
instance Core.FromJSON Tokeninfo where
        parseJSON
          = Core.withObject "Tokeninfo"
              (\ o ->
                 Tokeninfo Core.<$>
                   (o Core..:? "audience") Core.<*> (o Core..:? "email") Core.<*>
                     (o Core..:? "expires_in")
...
newUserinfo 
    ::  Userinfo
newUserinfo
  = Userinfo{email = Core.Nothing, familyName = Core.Nothing,
             gender = Core.Nothing, givenName = Core.Nothing, hd = Core.Nothing,
             id = Core.Nothing, link = Core.Nothing, locale = Core.Nothing,
             name = Core.Nothing, picture = Core.Nothing,
...
instance Core.FromJSON Userinfo where
        parseJSON
          = Core.withObject "Userinfo"
              (\ o ->
                 Userinfo Core.<$>
                   (o Core..:? "email") Core.<*> (o Core..:? "family_name") Core.<*>
                     (o Core..:? "gender")
          ...
          = Core.object
              (Core.catMaybes
                 [("email" Core..=) Core.<$> email,
                  ...
                  ("hd" Core..=) Core.<$> hd, ("id" Core..=) Core.<$> id,
                  ("link" Core..=) Core.<$> link, ("locale" Core..=) Core.<$> locale,
                  ("name" Core..=) Core.<$> name,
