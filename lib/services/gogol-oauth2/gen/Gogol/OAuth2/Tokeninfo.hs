       ...
       "v2" Core.:>
         "tokeninfo" Core.:>
           Core.QueryParam "access_token" Core.Text Core.:>
             Core.QueryParam "id_token" Core.Text Core.:>
               Core.QueryParam "alt" Core.AltJSON Core.:>
                 Core.Post '[Core.JSON] Tokeninfo
...
newOAuth2Tokeninfo 
    ::  OAuth2Tokeninfo
newOAuth2Tokeninfo
  = OAuth2Tokeninfo{accessToken = Core.Nothing,
...
instance Core.GoogleRequest OAuth2Tokeninfo where
        ...
        requestClient OAuth2Tokeninfo{..}
          = go accessToken idToken (Core.Just Core.AltJSON) oAuth2Service
          where go
                  = Core.buildClient (Core.Proxy :: Core.Proxy OAuth2TokeninfoMethod)
                      Core.mempty
