...
module Gogol.ContainerAnalysis.Internal.Product
  (
    ...
    CISAKnownExploitedVulnerabilities (..),
    newCISAKnownExploitedVulnerabilities,
    ...
    ExploitPredictionScoringSystem (..),
    newExploitPredictionScoringSystem,
...
data BuildStep = BuildStep
    ...
    , remoteConfig :: (Core.Maybe Core.Text)
...
newBuildStep
  = BuildStep{allowExitCodes = Core.Nothing,
              ...
              pullTiming = Core.Nothing, remoteConfig = Core.Nothing,
              results = Core.Nothing, script = Core.Nothing,
              secretEnv = Core.Nothing, status = Core.Nothing,
              timeout = Core.Nothing, timing = Core.Nothing,
              volumes = Core.Nothing, waitFor = Core.Nothing}
          ...
          = Core.object
              (Core.catMaybes
                 [("allowExitCodes" Core..=) Core.<$> allowExitCodes,
                  ...
                  ("remoteConfig" Core..=) Core.<$> remoteConfig,
...
--
-- /See:/ 'newCISAKnownExploitedVulnerabilities' smart constructor.
newtype CISAKnownExploitedVulnerabilities = CISAKnownExploitedVulnerabilities
    {
      -- | Whether the vulnerability is known to have been leveraged as part of a ransomware campaign.
      knownRansomwareCampaignUse :: (Core.Maybe Core.Text)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'CISAKnownExploitedVulnerabilities' with the minimum fields required to make a request.
newCISAKnownExploitedVulnerabilities 
    :: 
                                     CISAKnownExploitedVulnerabilities
newCISAKnownExploitedVulnerabilities
  = CISAKnownExploitedVulnerabilities{knownRansomwareCampaignUse =
                                        Core.Nothing}
instance Core.FromJSON CISAKnownExploitedVulnerabilities where
        parseJSON
          = Core.withObject "CISAKnownExploitedVulnerabilities"
              (\ o ->
                 CISAKnownExploitedVulnerabilities Core.<$>
                   (o Core..:? "knownRansomwareCampaignUse"))

instance Core.ToJSON CISAKnownExploitedVulnerabilities where
        toJSON CISAKnownExploitedVulnerabilities{..}
          = Core.object
              (Core.catMaybes
                 [("knownRansomwareCampaignUse" Core..=) Core.<$>
...
--
-- /See:/ 'newExploitPredictionScoringSystem' smart constructor.
data ExploitPredictionScoringSystem = ExploitPredictionScoringSystem
    {
      -- | The percentile of the current score, the proportion of all scored vulnerabilities with the same or a lower EPSS score
      percentile :: (Core.Maybe Core.Double)
...
-- | Creates a value of 'ExploitPredictionScoringSystem' with the minimum fields required to make a request.
newExploitPredictionScoringSystem 
    ::  ExploitPredictionScoringSystem
newExploitPredictionScoringSystem
  = ExploitPredictionScoringSystem{percentile = Core.Nothing,
                                   score = Core.Nothing}
instance Core.FromJSON ExploitPredictionScoringSystem where
        parseJSON
          = Core.withObject "ExploitPredictionScoringSystem"
              (\ o ->
                 ExploitPredictionScoringSystem Core.<$>
                   (o Core..:? "percentile") Core.<*> (o Core..:? "score"))

instance Core.ToJSON ExploitPredictionScoringSystem where
        toJSON ExploitPredictionScoringSystem{..}
          = Core.object
              (Core.catMaybes
...
data Risk = Risk
    ...
    , epss :: (Core.Maybe ExploitPredictionScoringSystem)
    }
    deriving (Core.Eq, Core.Show, Core.Generic)

-- | Creates a value of 'Risk' with the minimum fields required to make a request.
newRisk 
    ::  Risk
newRisk = Risk{cisaKev = Core.Nothing, epss = Core.Nothing}
instance Core.FromJSON Risk where
        parseJSON
          = Core.withObject "Risk"
              (\ o ->
                 Risk Core.<$> (o Core..:? "cisaKev") Core.<*> (o Core..:? "epss"))

instance Core.ToJSON Risk where
        toJSON Risk{..}
          = Core.object
              (Core.catMaybes
                 [("cisaKev" Core..=) Core.<$> cisaKev,
                  ("epss" Core..=) Core.<$> epss])
...
newVulnerabilityOccurrence
  = VulnerabilityOccurrence{cvssScore = Core.Nothing,
                            ...
                            relatedUrls = Core.Nothing, risk = Core.Nothing,
                            severity = Core.Nothing, shortDescription = Core.Nothing,
                            type' = Core.Nothing, vexAssessment = Core.Nothing}
