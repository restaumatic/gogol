...
newContainerAnalysisProjectsOccurrencesTestIamPermissions 
    ...
    -> ContainerAnalysisProjectsOccurrencesTestIamPermissions
newContainerAnalysisProjectsOccurrencesTestIamPermissions payload
  resource
  = ContainerAnalysisProjectsOccurrencesTestIamPermissions{xgafv =
                                                             Core.Nothing,
...
instance Core.GoogleRequest
           ContainerAnalysisProjectsOccurrencesTestIamPermissions
         where
        type Rs ContainerAnalysisProjectsOccurrencesTestIamPermissions =
