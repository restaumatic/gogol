...
newContainerAnalysisProjectsOccurrencesGetIamPolicy 
    ...
    -> ContainerAnalysisProjectsOccurrencesGetIamPolicy
newContainerAnalysisProjectsOccurrencesGetIamPolicy payload
  resource
  = ContainerAnalysisProjectsOccurrencesGetIamPolicy{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           ContainerAnalysisProjectsOccurrencesGetIamPolicy
         where
        type Rs ContainerAnalysisProjectsOccurrencesGetIamPolicy = Policy
        type Scopes ContainerAnalysisProjectsOccurrencesGetIamPolicy =
             '[CloudPlatform'FullControl]
        requestClient ContainerAnalysisProjectsOccurrencesGetIamPolicy{..}
