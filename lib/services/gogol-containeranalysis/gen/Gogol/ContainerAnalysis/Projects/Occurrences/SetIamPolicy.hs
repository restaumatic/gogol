...
newContainerAnalysisProjectsOccurrencesSetIamPolicy 
    ...
    -> ContainerAnalysisProjectsOccurrencesSetIamPolicy
newContainerAnalysisProjectsOccurrencesSetIamPolicy payload
  resource
  = ContainerAnalysisProjectsOccurrencesSetIamPolicy{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes ContainerAnalysisProjectsOccurrencesSetIamPolicy =
