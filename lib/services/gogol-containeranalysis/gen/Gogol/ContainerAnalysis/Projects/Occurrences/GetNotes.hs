...
newContainerAnalysisProjectsOccurrencesGetNotes name
  = ContainerAnalysisProjectsOccurrencesGetNotes{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
           ContainerAnalysisProjectsOccurrencesGetNotes
         where
        type Rs ContainerAnalysisProjectsOccurrencesGetNotes = Note
        type Scopes ContainerAnalysisProjectsOccurrencesGetNotes =
             '[CloudPlatform'FullControl]
        requestClient ContainerAnalysisProjectsOccurrencesGetNotes{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ContainerAnalysisProjectsOccurrencesGetNotesResource)
                      Core.mempty
