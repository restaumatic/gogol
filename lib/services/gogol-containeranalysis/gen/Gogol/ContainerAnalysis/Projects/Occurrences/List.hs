...
newContainerAnalysisProjectsOccurrencesList parent
  = ContainerAnalysisProjectsOccurrencesList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           ContainerAnalysisProjectsOccurrencesList
         where
        type Rs ContainerAnalysisProjectsOccurrencesList =
             ListOccurrencesResponse
        type Scopes ContainerAnalysisProjectsOccurrencesList =
