...
newContainerAnalysisProjectsOccurrencesPatch name payload
  = ContainerAnalysisProjectsOccurrencesPatch{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           ContainerAnalysisProjectsOccurrencesPatch
         where
        type Rs ContainerAnalysisProjectsOccurrencesPatch = Occurrence
        type Scopes ContainerAnalysisProjectsOccurrencesPatch =
             '[CloudPlatform'FullControl]
        requestClient ContainerAnalysisProjectsOccurrencesPatch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ContainerAnalysisProjectsOccurrencesPatchResource)
                      Core.mempty
