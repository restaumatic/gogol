...
-- |
-- Module      : Gogol.ContainerAnalysis.Projects.Occurrences.BatchCreate
                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] BatchCreateOccurrencesRequest Core.:>
                         Core.Post '[Core.JSON] BatchCreateOccurrencesResponse
...
newContainerAnalysisProjectsOccurrencesBatchCreate parent payload
  = ContainerAnalysisProjectsOccurrencesBatchCreate{xgafv =
                                                      Core.Nothing,
...
instance Core.GoogleRequest
           ContainerAnalysisProjectsOccurrencesBatchCreate
         where
        type Rs ContainerAnalysisProjectsOccurrencesBatchCreate =
             BatchCreateOccurrencesResponse
        type Scopes ContainerAnalysisProjectsOccurrencesBatchCreate =
             '[CloudPlatform'FullControl]
        requestClient ContainerAnalysisProjectsOccurrencesBatchCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ContainerAnalysisProjectsOccurrencesBatchCreateResource)
                      Core.mempty
