...
newContainerAnalysisProjectsLocationsNotesSetIamPolicy 
    ...
    -> ContainerAnalysisProjectsLocationsNotesSetIamPolicy
newContainerAnalysisProjectsLocationsNotesSetIamPolicy payload
  resource
  = ContainerAnalysisProjectsLocationsNotesSetIamPolicy{xgafv =
                                                          Core.Nothing,
...
instance Core.GoogleRequest
           ContainerAnalysisProjectsLocationsNotesSetIamPolicy
         where
        type Rs ContainerAnalysisProjectsLocationsNotesSetIamPolicy =
             Policy
        type Scopes ContainerAnalysisProjectsLocationsNotesSetIamPolicy =
