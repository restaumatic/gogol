...
newContainerAnalysisProjectsLocationsOccurrencesPatch name payload
  = ContainerAnalysisProjectsLocationsOccurrencesPatch{xgafv =
                                                         Core.Nothing,
...
instance Core.GoogleRequest
           ContainerAnalysisProjectsLocationsOccurrencesPatch
         where
        type Rs ContainerAnalysisProjectsLocationsOccurrencesPatch =
             Occurrence
        type Scopes ContainerAnalysisProjectsLocationsOccurrencesPatch =
