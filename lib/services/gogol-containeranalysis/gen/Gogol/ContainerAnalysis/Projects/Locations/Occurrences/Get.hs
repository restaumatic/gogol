...
newContainerAnalysisProjectsLocationsOccurrencesGet name
  = ContainerAnalysisProjectsLocationsOccurrencesGet{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           ContainerAnalysisProjectsLocationsOccurrencesGet
         where
        type Rs ContainerAnalysisProjectsLocationsOccurrencesGet =
             Occurrence
        type Scopes ContainerAnalysisProjectsLocationsOccurrencesGet =
             '[CloudPlatform'FullControl]
        requestClient ContainerAnalysisProjectsLocationsOccurrencesGet{..}
