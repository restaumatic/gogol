...
type ContainerAnalysisProjectsLocationsResourcesExportSBOMResource
     =
     "v1" Core.:>
       Core.CaptureMode "name" "exportSBOM" Core.Text Core.:>
...
newContainerAnalysisProjectsLocationsResourcesExportSBOM 
    ...
    -> ContainerAnalysisProjectsLocationsResourcesExportSBOM
newContainerAnalysisProjectsLocationsResourcesExportSBOM name
  payload
  = ContainerAnalysisProjectsLocationsResourcesExportSBOM{xgafv =
                                                            Core.Nothing,
...
instance Core.GoogleRequest
           ContainerAnalysisProjectsLocationsResourcesExportSBOM
         where
        type Rs ContainerAnalysisProjectsLocationsResourcesExportSBOM =
             ExportSBOMResponse
        type Scopes ContainerAnalysisProjectsLocationsResourcesExportSBOM =
