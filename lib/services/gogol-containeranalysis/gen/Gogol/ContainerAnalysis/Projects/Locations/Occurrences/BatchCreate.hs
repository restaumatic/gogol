...
newContainerAnalysisProjectsLocationsOccurrencesBatchCreate 
    ...
    -> ContainerAnalysisProjectsLocationsOccurrencesBatchCreate
newContainerAnalysisProjectsLocationsOccurrencesBatchCreate parent
  payload
  = ContainerAnalysisProjectsLocationsOccurrencesBatchCreate{xgafv =
                                                               Core.Nothing,
...
instance Core.GoogleRequest
           ContainerAnalysisProjectsLocationsOccurrencesBatchCreate
         where
        type Rs ContainerAnalysisProjectsLocationsOccurrencesBatchCreate =
