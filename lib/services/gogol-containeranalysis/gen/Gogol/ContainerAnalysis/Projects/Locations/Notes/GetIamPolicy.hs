...
newContainerAnalysisProjectsLocationsNotesGetIamPolicy 
    ...
    -> ContainerAnalysisProjectsLocationsNotesGetIamPolicy
newContainerAnalysisProjectsLocationsNotesGetIamPolicy payload
  resource
  = ContainerAnalysisProjectsLocationsNotesGetIamPolicy{xgafv =
                                                          Core.Nothing,
...
instance Core.GoogleRequest
           ContainerAnalysisProjectsLocationsNotesGetIamPolicy
         where
        type Rs ContainerAnalysisProjectsLocationsNotesGetIamPolicy =
             Policy
        type Scopes ContainerAnalysisProjectsLocationsNotesGetIamPolicy =
