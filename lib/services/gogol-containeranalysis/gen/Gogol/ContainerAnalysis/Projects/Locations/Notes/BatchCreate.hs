...
newContainerAnalysisProjectsLocationsNotesBatchCreate 
    ...
    -> ContainerAnalysisProjectsLocationsNotesBatchCreate
newContainerAnalysisProjectsLocationsNotesBatchCreate parent
  payload
  = ContainerAnalysisProjectsLocationsNotesBatchCreate{xgafv =
                                                         Core.Nothing,
...
instance Core.GoogleRequest
           ContainerAnalysisProjectsLocationsNotesBatchCreate
         where
        type Rs ContainerAnalysisProjectsLocationsNotesBatchCreate =
             BatchCreateNotesResponse
        type Scopes ContainerAnalysisProjectsLocationsNotesBatchCreate =
