...
newContainerAnalysisProjectsLocationsOccurrencesList parent
  = ContainerAnalysisProjectsLocationsOccurrencesList{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           ContainerAnalysisProjectsLocationsOccurrencesList
         where
        type Rs ContainerAnalysisProjectsLocationsOccurrencesList =
             ListOccurrencesResponse
        type Scopes ContainerAnalysisProjectsLocationsOccurrencesList =
             '[CloudPlatform'FullControl]
        requestClient ContainerAnalysisProjectsLocationsOccurrencesList{..}
