...
newContainerAnalysisProjectsLocationsNotesList parent
  = ContainerAnalysisProjectsLocationsNotesList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Rs ContainerAnalysisProjectsLocationsNotesList =
             ListNotesResponse
        type Scopes ContainerAnalysisProjectsLocationsNotesList =
             '[CloudPlatform'FullControl]
        requestClient ContainerAnalysisProjectsLocationsNotesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ContainerAnalysisProjectsLocationsNotesListResource)
                      Core.mempty
