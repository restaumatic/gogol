...
newContainerAnalysisProjectsLocationsNotesOccurrencesList name
  = ContainerAnalysisProjectsLocationsNotesOccurrencesList{xgafv =
                                                             Core.Nothing,
...
instance Core.GoogleRequest
           ContainerAnalysisProjectsLocationsNotesOccurrencesList
         where
        type Rs ContainerAnalysisProjectsLocationsNotesOccurrencesList =
             ListNoteOccurrencesResponse
        type Scopes ContainerAnalysisProjectsLocationsNotesOccurrencesList
