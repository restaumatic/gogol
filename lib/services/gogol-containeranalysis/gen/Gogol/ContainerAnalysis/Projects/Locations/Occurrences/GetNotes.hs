...
newContainerAnalysisProjectsLocationsOccurrencesGetNotes name
  = ContainerAnalysisProjectsLocationsOccurrencesGetNotes{xgafv =
                                                            Core.Nothing,
...
instance Core.GoogleRequest
           ContainerAnalysisProjectsLocationsOccurrencesGetNotes
         where
        type Rs ContainerAnalysisProjectsLocationsOccurrencesGetNotes =
             Note
        type Scopes ContainerAnalysisProjectsLocationsOccurrencesGetNotes =
