...
newContainerAnalysisProjectsResourcesExportSBOM name payload
  = ContainerAnalysisProjectsResourcesExportSBOM{xgafv =
                                                   Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Rs ContainerAnalysisProjectsResourcesExportSBOM =
             ExportSBOMResponse
        type Scopes ContainerAnalysisProjectsResourcesExportSBOM =
             '[CloudPlatform'FullControl]
        requestClient ContainerAnalysisProjectsResourcesExportSBOM{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ContainerAnalysisProjectsResourcesExportSBOMResource)
                      Core.mempty
