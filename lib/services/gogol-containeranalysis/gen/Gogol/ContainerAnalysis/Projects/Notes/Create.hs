           ...
           Core.QueryParam "$.xgafv" Xgafv Core.:>
             Core.QueryParam "access_token" Core.Text Core.:>
               Core.QueryParam "callback" Core.Text Core.:>
                 Core.QueryParam "noteId" Core.Text Core.:>
                   Core.QueryParam "uploadType" Core.Text Core.:>
                     Core.QueryParam "upload_protocol" Core.Text Core.:>
                       Core.QueryParam "alt" Core.AltJSON Core.:>
                         Core.ReqBody '[Core.JSON] Note Core.:> Core.Post '[Core.JSON] Note
...
newContainerAnalysisProjectsNotesCreate parent payload
  = ContainerAnalysisProjectsNotesCreate{xgafv = Core.Nothing,
                                         accessToken = Core.Nothing, callback = Core.Nothing,
                                         noteId = Core.Nothing, parent = parent, payload = payload,
                                         uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ContainerAnalysisProjectsNotesCreate
         where
        type Rs ContainerAnalysisProjectsNotesCreate = Note
        type Scopes ContainerAnalysisProjectsNotesCreate =
             '[CloudPlatform'FullControl]
        requestClient ContainerAnalysisProjectsNotesCreate{..}
          = go parent xgafv accessToken callback noteId uploadType
              uploadProtocol
