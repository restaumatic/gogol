...
-- |
-- Module      : Gogol.ContainerAnalysis.Projects.Notes.Get
...
newContainerAnalysisProjectsNotesGet name
  = ContainerAnalysisProjectsNotesGet{xgafv = Core.Nothing,
                                      accessToken = Core.Nothing, callback = Core.Nothing,
                                      name = name, uploadType = Core.Nothing,
                                      uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ContainerAnalysisProjectsNotesGet where
        type Rs ContainerAnalysisProjectsNotesGet = Note
        type Scopes ContainerAnalysisProjectsNotesGet =
