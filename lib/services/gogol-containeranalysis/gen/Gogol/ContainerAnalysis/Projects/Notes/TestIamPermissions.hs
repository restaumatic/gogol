...
-- 'ContainerAnalysisProjectsNotesTestIamPermissions' request conforms to.
type ContainerAnalysisProjectsNotesTestIamPermissionsResource =
     "v1" Core.:>
...
-- | Returns the permissions that a caller has on the specified note or occurrence. Requires list permission on the project (for example, @containeranalysis.notes.list@). The resource takes the format @projects\/[PROJECT_ID]\/notes\/[NOTE_ID]@ for notes and @projects\/[PROJECT_ID]\/occurrences\/[OCCURRENCE_ID]@ for occurrences.
--
-- /See:/ 'newContainerAnalysisProjectsNotesTestIamPermissions' smart constructor.
data ContainerAnalysisProjectsNotesTestIamPermissions = ContainerAnalysisProjectsNotesTestIamPermissions
    {
      -- | V1 error format.
...
-- | Creates a value of 'ContainerAnalysisProjectsNotesTestIamPermissions' with the minimum fields required to make a request.
newContainerAnalysisProjectsNotesTestIamPermissions 
    :: 
    ...
    -> ContainerAnalysisProjectsNotesTestIamPermissions
newContainerAnalysisProjectsNotesTestIamPermissions payload
  resource
  = ContainerAnalysisProjectsNotesTestIamPermissions{xgafv =
                                                       Core.Nothing,
...
instance Core.GoogleRequest
           ContainerAnalysisProjectsNotesTestIamPermissions
         where
        type Rs ContainerAnalysisProjectsNotesTestIamPermissions =
             TestIamPermissionsResponse
        type Scopes ContainerAnalysisProjectsNotesTestIamPermissions =
             '[CloudPlatform'FullControl]
        requestClient ContainerAnalysisProjectsNotesTestIamPermissions{..}
