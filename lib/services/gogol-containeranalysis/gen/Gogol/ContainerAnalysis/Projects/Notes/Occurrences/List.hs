...
newContainerAnalysisProjectsNotesOccurrencesList name
  = ContainerAnalysisProjectsNotesOccurrencesList{xgafv =
                                                    Core.Nothing,
...
instance Core.GoogleRequest
        ...
        type Scopes ContainerAnalysisProjectsNotesOccurrencesList =
             '[CloudPlatform'FullControl]
        requestClient ContainerAnalysisProjectsNotesOccurrencesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ContainerAnalysisProjectsNotesOccurrencesListResource)
                      Core.mempty
