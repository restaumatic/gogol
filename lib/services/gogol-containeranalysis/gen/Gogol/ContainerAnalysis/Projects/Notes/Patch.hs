                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] Note Core.:> Core.Patch '[Core.JSON] Note
...
newContainerAnalysisProjectsNotesPatch name payload
  = ContainerAnalysisProjectsNotesPatch{xgafv = Core.Nothing,
                                        accessToken = Core.Nothing, callback = Core.Nothing,
                                        name = name, payload = payload, updateMask = Core.Nothing,
                                        uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest ContainerAnalysisProjectsNotesPatch
         where
        type Rs ContainerAnalysisProjectsNotesPatch = Note
        type Scopes ContainerAnalysisProjectsNotesPatch =
        ...
        requestClient ContainerAnalysisProjectsNotesPatch{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ContainerAnalysisProjectsNotesPatchResource)
                      Core.mempty
