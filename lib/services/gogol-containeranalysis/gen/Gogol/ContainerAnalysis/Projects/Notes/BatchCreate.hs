...
-- |
-- Module      : Gogol.ContainerAnalysis.Projects.Notes.BatchCreate
                 ...
                 Core.QueryParam "uploadType" Core.Text Core.:>
                   Core.QueryParam "upload_protocol" Core.Text Core.:>
                     Core.QueryParam "alt" Core.AltJSON Core.:>
                       Core.ReqBody '[Core.JSON] BatchCreateNotesRequest Core.:>
...
newContainerAnalysisProjectsNotesBatchCreate parent payload
  = ContainerAnalysisProjectsNotesBatchCreate{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           ContainerAnalysisProjectsNotesBatchCreate
         where
        type Rs ContainerAnalysisProjectsNotesBatchCreate =
             BatchCreateNotesResponse
        type Scopes ContainerAnalysisProjectsNotesBatchCreate =
             '[CloudPlatform'FullControl]
        requestClient ContainerAnalysisProjectsNotesBatchCreate{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ContainerAnalysisProjectsNotesBatchCreateResource)
                      Core.mempty
