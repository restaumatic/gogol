...
newContainerAnalysisProjectsNotesSetIamPolicy payload resource
  = ContainerAnalysisProjectsNotesSetIamPolicy{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           ContainerAnalysisProjectsNotesSetIamPolicy
         where
        type Rs ContainerAnalysisProjectsNotesSetIamPolicy = Policy
        type Scopes ContainerAnalysisProjectsNotesSetIamPolicy =
             '[CloudPlatform'FullControl]
        requestClient ContainerAnalysisProjectsNotesSetIamPolicy{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ContainerAnalysisProjectsNotesSetIamPolicyResource)
                      Core.mempty
