...
newContainerAnalysisProjectsNotesList parent
  = ContainerAnalysisProjectsNotesList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest ContainerAnalysisProjectsNotesList
         where
        type Rs ContainerAnalysisProjectsNotesList = ListNotesResponse
        ...
        requestClient ContainerAnalysisProjectsNotesList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy ContainerAnalysisProjectsNotesListResource)
                      Core.mempty
